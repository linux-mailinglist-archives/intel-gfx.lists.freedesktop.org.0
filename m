...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5342365EB6D
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Jan 2023 13:59:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83F6210E718;
	Thu,  5 Jan 2023 12:59:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3620310E717
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Jan 2023 12:59:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672923586; x=1704459586;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=guaMD5VbZqH8TaVYtVZa7DXloikDsa1PJsCi4RgmvfQ=;
 b=LSjwC0NkQ3o9msblRkv2mYiRh4N91TQTo5dTR4fJGSBhGg7+cdDJdXUM
 czczGCHEAnxdTwXs4HsPydLmU9olih9tVGhQYLu4e82VsyChjyaWmTeK9
 l5KsXts1r4rEBELwI+CHffpXHdTuDsw7zvzGc90/HrtsSSjJp3EbDRbJc
 Ct4EaSlsz/OMJbPIQItbgumICnirvDPFSZwkZy76ZAdpuuqk+TyRa/BG4
 61NqExT2nqorpTeXX/2VhKfefZyBm1eV4wXINzXJNZOqC9D66x9ZtqkiV
 g2o/Fv3xb8is2lf6Cm2M0T07vAGtrwJiI5bhDp3FNQYrTvTa+A9TWQm/1 Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="305697735"
X-IronPort-AV: E=Sophos;i="5.96,303,1665471600"; d="scan'208";a="305697735"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jan 2023 04:59:46 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="829540956"
X-IronPort-AV: E=Sophos;i="5.96,303,1665471600"; d="scan'208";a="829540956"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by orsmga005.jf.intel.com with ESMTP; 05 Jan 2023 04:59:43 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Jan 2023 14:54:30 +0200
Message-Id: <20230105125446.960504-6-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 05/21] drm/i915/mtl: Add C10 phy programming
 for HDMI

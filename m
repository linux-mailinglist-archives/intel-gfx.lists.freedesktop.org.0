...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D8E04AEA53
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Feb 2022 07:30:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74E1C10E3DB;
...
Subject: [Intel-gfx] [PATCH v7 2/6] drm/i915/gt: Re-work

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DBA8C5AC789
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:48:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E8CA10E389;
...
Subject: [Intel-gfx] [PATCH v6 46/57] dyndbg: drop site-> in add-module,
 more needed

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 93BC743C1B0
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Oct 2021 06:38:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 930BE892A0;
...
Subject: [Intel-gfx] [PATCH v9 01/10] dyndbg: add
 DEFINE_DYNAMIC_DEBUG_CATEGORIES macro and callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D67D95F60DA
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Oct 2022 08:00:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DFF810E7EB;
	Thu,  6 Oct 2022 06:00:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D566810E7EB
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=qciE5c3cCyPymEEk2V5+cZ4R2Uy+IO55ijJlmSnr4Cw=;
 b=m9z6FRyKNONe+DhUWNgOxV7OlvzFYyNEn18k5vPrklVNbPgR1vmlm0yR
 jlWb+Bm8Y9+hd2BPrD5d19G0wdJlyFmqGBpcAOEI0vyhsceO438jhyJwM
 538r7P5NnS9fT1IKuiBywepmTz4iUgej5vbNJe7Vr606bf010Xaajj7cY
 AOkIQ8spFU12mTEtnkXxYTtr7p/aU+5y3Bv54fRaJaO13E1txIPm57lO1
 5wzhyOnycZg/KMeqOZLuwMt1KwoTi5L08c6z6snqDQCbSg4UzTB/EQDLG
 JMNM6WCkciglzjA/O/ILSdIoqezrbb3JRS+kfVGO0Ar/hP6c6k7n3+ceh Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10491"; a="304932249"
X-IronPort-AV: E=Sophos;i="5.95,163,1661842800"; d="scan'208";a="304932249"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2022 23:00:22 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10491"; a="713712988"
X-IronPort-AV: E=Sophos;i="5.95,163,1661842800"; d="scan'208";a="713712988"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by FMSMGA003.fm.intel.com with ESMTP; 05 Oct 2022 23:00:21 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  5 Oct 2022 23:02:24 -0700
Message-Id: <20221006060224.691844-2-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/1] drm/i915/guc: Delay disabling guc_id
...
index 693b07a97789..c2cca6440b94 100644
...
@@ -344,11 +370,6 @@ static inline void decr_context_blocked(struct intel_context *ce)
...
-
 ...
 {
 	lockdep_assert_held(&ce->guc_state.lock);
@@ -1068,6 +1089,12 @@ static void scrub_guc_desc_for_outstanding_g2h(struct intel_guc *guc)
...
+
 		...
 		/*
@@ -1995,6 +2022,9 @@ static int new_guc_id(struct intel_guc *guc, struct intel_context *ce)
 	if (unlikely(ret < 0))
 		return ret;
...
@@ -2004,14 +2034,16 @@ static void __release_guc_id(struct intel_guc *guc, struct intel_context *ce)
...
@@ -2999,41 +3031,104 @@ guc_context_revoke(struct intel_context *ce, struct i915_request *rq,
 	}
 }

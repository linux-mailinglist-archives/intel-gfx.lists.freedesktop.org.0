...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D2F83B5917
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Jun 2021 08:23:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1630E89D83;
...
Subject: Re: [Intel-gfx] [PATCH v4 05/27] drm/armada: Don't set struct
...
Content-Type: multipart/mixed; boundary="===============1837043697=="

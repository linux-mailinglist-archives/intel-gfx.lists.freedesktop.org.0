...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FB05933EED
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jul 2024 17:01:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A230E10E1C4;
	Wed, 17 Jul 2024 15:01:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="TIJXJp2V";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-f45.google.com (mail-io1-f45.google.com
 [209.85.166.45])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DB3B710E2C5;
 Tue, 16 Jul 2024 18:58:44 +0000 (UTC)
Received: by mail-io1-f45.google.com with SMTP id
 ca18e2360f4ac-7f684710ff5so2518739f.1; 
 Tue, 16 Jul 2024 11:58:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1721156324; x=1721761124; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=6XXQ6l1oOPeMlE1QjUtDI8xPnpcIZhmlmrXVidtP2qM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1721156324; x=1721761124;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=6XXQ6l1oOPeMlE1QjUtDI8xPnpcIZhmlmrXVidtP2qM=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXA3S/tp6ExVpDpzykOGqcM4Np2vATc7BDJSwc5FYmJdNYGjueceMVtNacv6YJYB4f7nhi/vV6qqI22fhH0u5DRb285269JzBUdVVOQFaVGx5JP188dop82zbmk+ZcNrcW+iThbgRfMsxaziLSASulCLqbPBl0zE6x0zGjZJsC+AdrXw8Su1qy+oR9TOwRv7HkdnQrj1B0KCn5rnWcQw1JUoXHmDTD4m26DIelcetLdvvyopZ8=
X-Gm-Message-State: AOJu0Yw8zTcTJURZfeO+N8dtgMRdU7lZrV8Vh3QE/g01X4BPvHVIBExc
 HdLC57J4+zB1xSqwZidvpoon0oA6mEZpxEJUg5GKNepa0JsdS+RH
X-Google-Smtp-Source: AGHT+IHo2pn2vyUsXCSA134r/IefiC9B4yGZNZoDXQFBbpecjyQnYOtVi5G3mP3X1REzvnPEO6ORoQ==
X-Received: by 2002:a5e:c114:0:b0:7fb:c0c8:2fc7 with SMTP id
 ca18e2360f4ac-816c2ef3741mr24683639f.3.1721156323852; 
 Tue, 16 Jul 2024 11:58:43 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 8926c6da1cb9f-4c210f23f1csm75301173.102.2024.07.16.11.58.42
...
Subject: [PATCH v9-resend 15/54] dyndbg-API: fix DECLARE_DYNDBG_CLASSMAP
Date: Tue, 16 Jul 2024 12:57:27 -0600
Message-ID: <20240716185806.1572048-16-jim.cromie@gmail.com>
X-Mailer: git-send-email 2.45.2
In-Reply-To: <20240716185806.1572048-1-jim.cromie@gmail.com>
References: <20240716185806.1572048-1-jim.cromie@gmail.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Mailman-Approved-At: Wed, 17 Jul 2024 15:01:12 +0000
...
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -7684,7 +7684,7 @@ M:	Jim Cromie <jim.cromie@gmail.com>
 S:	Maintained
...
index d18a94b973e1..49329ca1df93 100644
--- a/kernel/module/main.c
+++ b/kernel/module/main.c
@@ -2235,6 +2235,9 @@ static int find_module_sections(struct module *mod, struct load_info *info)
...
index 59b6765d86b8..8662e26aceac 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
@@ -2831,12 +2831,26 @@ config TEST_STATIC_KEYS
 	  If unsure, say N.
...
index 30337431d10e..81afaa5b756e 100644
--- a/lib/Makefile
+++ b/lib/Makefile
...
@@ -224,6 +225,8 @@ obj-$(CONFIG_ARCH_NEED_CMPXCHG_1_EMU) += cmpxchg-emu.o

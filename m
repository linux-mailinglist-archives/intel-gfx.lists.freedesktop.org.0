...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB966655C1C
	for <lists+intel-gfx@lfdr.de>; Sun, 25 Dec 2022 02:43:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8236D10E057;
	Sun, 25 Dec 2022 01:43:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BAFC710E02E;
 Sun, 25 Dec 2022 01:42:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671932579; x=1703468579;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=VVSNG8JyhA74riq7KADTnj17a9dyhVEHUoJza4FokEU=;
 b=HfedCTbT9VyGuJrRfcuwnOgkz/LEAKF6IAhZrElVL9KpW18tr6n4sQNo
 WOhdBKgKz+SqjZU9Lhx+fLcG3XPFhkmMzdhH9uhA+Dmp2lhKoSpcOyAoV
 uY9xdEmBdZHbLL0iokPy2TfqOHuGsf57buCw1yc7dhFxG4IT7vZnu47dx
 ChTd37V+EXVR16I8fS1LPlc6CTNkEnckw8I4tx6rwCT5uA2yk2zgXjExd
 BhUC9gMiB0JNKKBlMjTpNNSyjsgBQ55W3ilfQeqCG81GPNERAe/Y7OK2M
 msRfVsjgWYXNQ24rE57b12zcWvC7Im9ojD4mJq+L9Kz+Y7fvCroelSpPQ A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10571"; a="300805732"
X-IronPort-AV: E=Sophos;i="5.96,272,1665471600"; d="scan'208";a="300805732"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Dec 2022 17:42:56 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10571"; a="897826081"
X-IronPort-AV: E=Sophos;i="5.96,272,1665471600"; d="scan'208";a="897826081"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
 by fmsmga006.fm.intel.com with ESMTP; 24 Dec 2022 17:42:52 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1p9G2O-000Dfn-0T;
 Sun, 25 Dec 2022 01:42:52 +0000
Date: Sun, 25 Dec 2022 09:42:28 +0800
...
Message-ID: <202212250910.DilqIg0K-lkp@intel.com>
References: <Y6d0EDmyqJILVoRw@qemulion>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="la4MSc3s50oUmunn"
Content-Disposition: inline
In-Reply-To: <Y6d0EDmyqJILVoRw@qemulion>
Subject: Re: [Intel-gfx] [PATCH] drm/i915: convert i915_active.count from

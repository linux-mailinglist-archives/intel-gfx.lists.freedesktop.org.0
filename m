...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CA1D03904A2
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 17:09:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90F936E3FC;
	Tue, 25 May 2021 15:08:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x329.google.com (mail-wm1-x329.google.com
 [IPv6:2a00:1450:4864:20::329])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 555186E3A0
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 May 2021 15:08:57 +0000 (UTC)
Received: by mail-wm1-x329.google.com with SMTP id
 f75-20020a1c1f4e0000b0290171001e7329so13017968wmf.1
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 May 2021 08:08:57 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :in-reply-to;
 bh=GWcHUmtRoBbBVQFv/cG8c0UyohsWnVM1GgM0jUZFR+s=;
 b=
X-Gm-Message-State: AOAM5336MbIK4NKzwd5CzMjYH/PD1vh984onS7AFDtj91WU7VFQHQARb
 /Bpbn/y0YW6CRzUwVzVoFxt15A==
...
Subject: Re: [Intel-gfx] [PATCH 4/6] dma-buf: Add an API for exporting sync
 files (v9)
...
> +		fence =3D dma_resv_get_singleton_unlocked(dmabuf->resv);
> +		if (IS_ERR(fence)) {
> +			ret =3D PTR_ERR(fence);
> +			goto err_put_fd;
> +		}
> +	} else if (arg.flags & DMA_BUF_SYNC_READ) {
> +		fence =3D dma_resv_get_excl_unlocked(dmabuf->resv);
> +	}
> +
> +	if (!fence)
...
> + * current set of fences on a dma-buf file descriptor as a sync_file.  C=
PU
> + * waits via poll() or other driver-specific mechanisms typically wait on
> + * whatever fences are on the dma-buf at the time the wait begins.  This
> + * is similar except that it takes a snapshot of the current fences on t=
he
...
> +#define DMA_BUF_IOCTL_EXPORT_SYNC_FILE	_IOWR(DMA_BUF_BASE, 2, struct dma=
_buf_sync_file)
>  =

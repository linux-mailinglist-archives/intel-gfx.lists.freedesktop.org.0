...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DC0B546FF7
	for <lists+intel-gfx@lfdr.de>; Sat, 11 Jun 2022 01:21:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2C1511AFAF;
...
Subject: [Intel-gfx] [PATCH 2/3] iosys-map: Add per-word write

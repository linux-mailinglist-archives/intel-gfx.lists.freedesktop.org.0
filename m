...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8673622FB86
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Jul 2020 23:35:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A385E6E07D;
...
Subject: [Intel-gfx] [PATCH 3/6] vga-switcheroo: notify clients of
 pending/completed switch events

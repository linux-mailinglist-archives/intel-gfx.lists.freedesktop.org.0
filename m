...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BEF570174A
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 15:29:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7798310E0F0;
	Sat, 13 May 2023 13:29:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E605C10E0D8;
 Sat, 13 May 2023 13:28:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683984530; x=1715520530;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=VWt5zF1nt9Fj37LFFlT2jbyv12uVL637wpwXBKtnXm0=;
 b=Z+a3wax4fj3t81woy3L2OVB/QaHYpTKX9ps7BP0uc1raETK8W8uJTugu
 4X7kW1aDBrVBz6hpovR6VOS41+MC0NkTpNSgRbbbj3/SveoFi/1Zq0D/9
 NOz+AZ9mmHW14lZ2x3oBRyUsHdDil2/2fGMDK5EQOoPCOJsmb1Iid2icn
 WbOuXLCpfaJz9MrXBGQo/MaCGIz6hy8oM9z8aGCcmbomwaw/gc/CAXHFQ
 /MKzRJzrRqSPLh3gQe6VOUfwY/+7BeDY4O2v4qe6lhZgbH5iJYWxqYA02
 aINlW+B85U4wiCr/MKMSID/q9wfo5pIjtmcF1K09QbJn/JqbiuoKNNeFY w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="354100777"
X-IronPort-AV: E=Sophos;i="5.99,272,1677571200"; d="scan'208";a="354100777"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2023 06:28:50 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="703459505"
X-IronPort-AV: E=Sophos;i="5.99,272,1677571200"; d="scan'208";a="703459505"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga007.fm.intel.com with ESMTP; 13 May 2023 06:28:49 -0700
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Sat, 13 May 2023 06:28:18 -0700
Message-Id: <20230513132827.39066-15-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230513132827.39066-1-yi.l.liu@intel.com>
References: <20230513132827.39066-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v11 14/23] iommufd/device: Add

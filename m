...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB4A657BA6A
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 17:36:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64FA58F526;
...
Subject: [Intel-gfx] [PATCH v4 36/41] dyndbg/drm: POC add tracebits
 sysfs-knob

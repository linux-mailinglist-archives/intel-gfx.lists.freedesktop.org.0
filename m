...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F22502C2DA8
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Nov 2020 18:02:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A34856E4C1;
	Tue, 24 Nov 2020 17:02:49 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 14/17] drm/i915/hdcp: Pass connector to
 check_2_2_link

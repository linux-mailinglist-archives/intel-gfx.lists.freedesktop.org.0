...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B0624BD298
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Feb 2022 00:31:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C31BD10E46C;
	Sun, 20 Feb 2022 23:31:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ed1-x535.google.com (mail-ed1-x535.google.com
 [IPv6:2a00:1450:4864:20::535])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EF2A610E468;
 Sun, 20 Feb 2022 23:31:08 +0000 (UTC)
Received: by mail-ed1-x535.google.com with SMTP id c6so23065091edk.12;
 Sun, 20 Feb 2022 15:31:08 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc:content-transfer-encoding;
 bh=Rts3NarOqKT5gAxfrWHxNn1yiJrDEEoeqwx3Oec8Krs=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=Rts3NarOqKT5gAxfrWHxNn1yiJrDEEoeqwx3Oec8Krs=;
 b=
X-Gm-Message-State: AOAM531JF3LnvpDKKyFbvfpuaV0sZpY590yh3ywz1qYmVR3nVf9aAaNY
 +y9tVEG4a/ba/PSKbdnsy3S+TSG8E5kr/YW5N2Zq/QOiP7o=
X-Google-Smtp-Source: ABdhPJyebuRRD+huw7avBo/29VIprtjyluP8Hunq4PVOVVWyUuAk6zQFgiQrJPcNZJYr2gEc9nKddy8h0sNfyjmg/YE=
X-Received: by 2002:a50:8e17:0:b0:407:ce95:d740 with SMTP id
 23-20020a508e17000000b00407ce95d740mr18918663edw.96.1645399867104; Sun, 20
 Feb 2022 15:31:07 -0800 (PST)
MIME-Version: 1.0
References: <Yg4i2aCZvvee5Eai@jlahtine-mobl.ger.corp.intel.com>
In-Reply-To: <Yg4i2aCZvvee5Eai@jlahtine-mobl.ger.corp.intel.com>
From: Dave Airlie <airlied@gmail.com>
Date: Mon, 21 Feb 2022 09:30:55 +1000
Message-ID: <CAPM=9tz7HpbshsbeG4JChmMGy--2h1FzJePwzwGhxdPvNkD2Kg@mail.gmail.com>
...
/home/airlied/devel/kernel/dim/src/drivers/gpu/drm/i915/gt/intel_workaround=
s.c:
In function =E2=80=98rcs_engine_wa_init=E2=80=99:
/home/airlied/devel/kernel/dim/src/drivers/gpu/drm/i915/gt/intel_workaround=
s.c:2051:40:
error: =E2=80=98XEHP_DIS_BBL_SYSPIPE=E2=80=99 undeclared (first use in this=
 function)
...
> - Use PM timestamp instead of RING TIMESTAMP for reference in PMU with Gu=
C (Umesh)
...
> - Coding style and compiler warning fixes (Matt B., Jasmine, Andi, Colin,=
 Gustavo, Dan)
>
> The following changes since commit 53dbee4926d3706ca9e03f3928fa85b5ec3bc0=
cc:
>
>   Merge tag 'drm-misc-next-2022-01-27' of git://anongit.freedesktop.org/d=
rm/drm-misc into drm-next (2022-02-01 19:02:41 +1000)
>
> are available in the Git repository at:
>
>   git://anongit.freedesktop.org/drm/drm-intel tags/drm-intel-gt-next-2022=
-02-17
>
...
>       drm/i915/guc: Update guc shim control programming on newer platform=
s
>
> Gustavo A. R. Silva (1):
...
>
> Maarten Lankhorst (8):
>       drm/i915: Call i915_gem_evict_vm in vm_fault_gtt to prevent new ENO=
SPC errors, v2.
>       drm/i915: Add locking to i915_gem_evict_vm(), v3.
>       drm/i915: Add object locking to i915_gem_evict_for_node and i915_ge=
m_evict_something, v2.
>       drm/i915: Add i915_vma_unbind_unlocked, and take obj lock for i915_=
vma_unbind, v2.
...
>       drm/i915/selftests: Add a cancel request selftest that triggers a r=
eset
...
>       drm/i915: Lock timeline mutex directly in error path of eb_pin_time=
line
...
>       drm/i915: Use the vma resource as argument for gtt binding / unbind=
ing
...
>       drm/i915/pmu: Use PM timestamp instead of RING TIMESTAMP for refere=
nce

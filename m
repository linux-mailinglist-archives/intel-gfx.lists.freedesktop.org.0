...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 47E9E719BE2
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 14:20:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC85710E55E;
	Thu,  1 Jun 2023 12:20:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4F56510E237
 for <intel-gfx@lists.freedesktop.org>; Thu,  1 Jun 2023 12:20:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685622013; x=1717158013;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=hvhkfG//ZECMLs1frAWJdIGd85yKQiux7IGJAMYSm+8=;
 b=fJ3EHE3MdUa2SW4F/k+wtsP19Rqt/WuFjFY5k5t9k6KTNbdWuEY17pwH
 Rv3hnTYCk//9KDmjEHol4FxD35ZW2U9MI6YlxOdKgM4UBR/GwfMB2abNI
 Ei7z7+Cc7hs8g+pi4E8UG/AXxla9ZJWrrQdmohhPLDQrzHX/VNdjKsDEz
 EkCGHJp4oR1QxEidHTZzbLfG4/TOhHzBu9PJ0LPqJ1eNUEpwm2nwBxrvt
 jEWYXzycmv7lfkCZEwwOGsQiSshJUxC1BTkr2cNyi51ZWfEWzdoft49J4
 DwppkHkw26l7oSA76g+CVWnjRTGuVTpRaOMz7tryyKV1F2kRkXk4r2ij3 g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="419040111"
X-IronPort-AV: E=Sophos;i="6.00,210,1681196400"; d="scan'208";a="419040111"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2023 05:20:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="740336269"
X-IronPort-AV: E=Sophos;i="6.00,210,1681196400"; d="scan'208";a="740336269"
Received: from unknown (HELO vgovind2-mobl3.fi.intel.com) ([10.237.66.43])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2023 05:20:09 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  1 Jun 2023 15:19:23 +0300
Message-Id: <20230601121923.19775-8-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 7/7] drm/i915/mtl: Add support for PM DEMAND

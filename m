...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DCBD673635
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Jan 2023 11:59:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD40610E908;
	Thu, 19 Jan 2023 10:58:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D7DA10E908
 for <intel-gfx@lists.freedesktop.org>; Thu, 19 Jan 2023 10:58:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1674125936; x=1705661936;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=+wpsVJ01j89rEmkj3XwVT5QeFF3bzHcVgHOxOOpZ5LY=;
 b=IhsBjbk+ruBD2R7rBgAkuQpUJBbalJWmvb+cRznztoT+/505DXp8KZr7
 DLOqtRAyQRo/bPBfp3rB4ML+9W+rT2JUPhXn2nKcmNC/2IMXZbBajOet/
 NHW4rNm3LkZJB3A04gG5LhoeN99WjSrVUVGg/RHoOON4jrt8WX+IVrNpv
 QIWICugX02Zh+lNRK0equuyDQS/ziR4tK7trSgJYX22osyziRST2t7hSi
 c2peRkOphjL0yxrZi1rAxe/DK5lSnekNi+INuBC9E8dkYSUKAMujGtu2G
 soglQ+k/LYccGdoOGeIOwGcwUTcD+aC0F6umONJ27L4BzNq5fIO2R0goJ g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10594"; a="304938473"
X-IronPort-AV: E=Sophos;i="5.97,228,1669104000"; d="scan'208";a="304938473"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2023 02:58:55 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10594"; a="768174079"
X-IronPort-AV: E=Sophos;i="5.97,228,1669104000"; d="scan'208";a="768174079"
Received: from unknown (HELO localhost) ([10.237.66.157])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2023 02:58:52 -0800
...
Date: Thu, 19 Jan 2023 12:58:47 +0200
Message-ID: <87k01iaizc.fsf@intel.com>
MIME-Version: 1.0

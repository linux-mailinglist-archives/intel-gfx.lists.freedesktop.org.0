...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 00E7B4D8A7C
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Mar 2022 18:07:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3CC0110E99F;
	Mon, 14 Mar 2022 17:07:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C988E10E68A
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=mHxkxHbTo7+aHR3b3AM/7TmO47CWgnw0GCci+TSa7Uw=;
 b=f0EgwNAxtI4v5O2sgEEtagwvMVq5Q2+ZxEoJ/fJF7TS7UGFbxvHq9yqG
 sq2R/d1pVcEmJuwBxT4k47dHkngJ8vkLflpY4yOkkar6z1ooET66a8dFR
 9F/5Dbyg+4K0G3iQ0SaOy6wAc9JpD2M5vWplXz7r3PkE7E9xsj6gm/dMW
 ZK96rZ3Oe0EXVt1ZRc/LtiLC2Mzkm8yiceXby2jiug+6loIsexZ2UnTCt
 qSO56956nrff9GohyqCsKmqLOiOJFWd5HGhrnPvANef9aIykGGmefN5iL
 BSc8dVuuHp87KkZq6m/aoQ1EMyTr1mZMe6kTjuOo4BV5s/3xZaRW4c5EG A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10285"; a="243536044"
X-IronPort-AV: E=Sophos;i="5.90,181,1643702400"; d="scan'208";a="243536044"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Mar 2022 10:07:29 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,181,1643702400"; d="scan'208";a="597977087"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga008.fm.intel.com with ESMTP; 14 Mar 2022 10:07:28 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 14 Mar 2022 10:09:53 -0700
Message-Id: <20220314170954.1537154-13-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 12/13] drm/i915/guc: Plumb GuC-capture into
 gpu_coredump
...
index 866d485f47c2..2015093fea62 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E65A27BB4EE
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Oct 2023 12:11:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D173B10E06B;
	Fri,  6 Oct 2023 10:11:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3C08C10E06B
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Oct 2023 10:11:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1696587108; x=1728123108;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=iDgGr9iVW18FllIEU34pWAl010TZ5a2E5XBpbwqedtI=;
 b=kmRFKMwRK0SMi93ENg/OekQGVuaT1677nsG9W893pS3YwP9VhLfn5ra/
 vzt/Q9ok9MEMjGHl1uPTAcK5PQhVhuUan43uQQZap6EFe/t1Oa635L1KK
 ZElgzBwcSaTnV2w6DQueho59u85lAsab67SLsSCQJq+lOG+MbiQrfZmdi
 zvh8n9AZ51ccUD8Yejl8fLfr8zwAGUm8teq1fM0Xj0G8dyKYUveShU1rh
 d1iNnL+VLfo313/yRozAnioAbrpM1ZFFJTHquprgZtfjhXix7V9rGIbwe
 LPDVLm9feLdN6q5/rFGcTknZprvEhs57yy/cx/NhdYZJtSndPvJ6HlBoP w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10854"; a="447909216"
X-IronPort-AV: E=Sophos;i="6.03,203,1694761200"; d="scan'208";a="447909216"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2023 03:11:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10854"; a="781607340"
X-IronPort-AV: E=Sophos;i="6.03,203,1694761200"; d="scan'208";a="781607340"
Received: from stevegr-mobl3.ger.corp.intel.com (HELO [10.213.210.79])
 ([10.213.210.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2023 03:11:44 -0700
Message-ID: <4f9ddf13-d779-e2ff-2baa-73d5d35c5009@linux.intel.com>
Date: Fri, 6 Oct 2023 11:11:42 +0100
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C01F7B1814
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Sep 2023 12:09:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5491A10E0AB;
	Thu, 28 Sep 2023 10:09:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
X-Greylist: delayed 424 seconds by postgrey-1.36 at gabe;
 Thu, 28 Sep 2023 10:09:19 UTC
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5765410E0AB
 for <intel-gfx@lists.freedesktop.org>; Thu, 28 Sep 2023 10:09:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1695895759; x=1727431759;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=ocHrUy5b89/Riw6KtjQGI5LAwZRipKfzSErUUdLDB0g=;
 b=PoSRG8maO3QH7EeCo7i1PUKbmGjMyC8tPR9OWCh7wtqhMvj0Tbv3UFXo
 25C3eDXc180XQ9hIRvFkW6WrBPWx9BjjQV0m2I2A6P4FHUwtL2usjmh/W
 Q+LMKm+qdS3hDiflBwtlWfuMYdAG4co1OtWzu5JQkmyPnvGuvebxpu7eN
 1GVJM5xyqT3HeAaEK7m6Ut6/2tC8/zhkc3j+fWoCneg3xgw9ojyu24CGc
 tgapDehhIx37SnFCxIOacieOk+dGTipA8qTrF6ftoiSAozJ5BYpmcl4Sy
 lwg2K1zC4/gUfMA50wyUWEWCxFwlMUkeW7ByNQopJtwiIbmdX5XerjmQ0 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10846"; a="3583477"
X-IronPort-AV: E=Sophos;i="6.03,183,1694761200"; 
   d="scan'208";a="3583477"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Sep 2023 03:02:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10846"; a="873240273"
X-IronPort-AV: E=Sophos;i="6.03,183,1694761200"; d="scan'208";a="873240273"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Sep 2023 03:02:10 -0700
Date: Thu, 28 Sep 2023 13:02:33 +0300
...
Message-ID: <ZRVPOUKE+w5vIfU8@ideak-desk.fi.intel.com>
References: <20230921195159.2646027-1-imre.deak@intel.com>
 <169545300499.3502.8542751184257983993@emeril.freedesktop.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <169545300499.3502.8542751184257983993@emeril.freedesktop.org>
...
On Sat, Sep 23, 2023 at 07:10:04AM +0000, Patchwork wrote:
> == Series Details ==
> 
...
Patchset is pushed, thanks for the reviews.

While pushing I amended the commit log in patch 10, to reflect the

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 49016C27647
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:05:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4AC510EC22;
	Sat,  1 Nov 2025 03:05:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="fsXqbABP";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ED12610EC22;
 Sat,  1 Nov 2025 03:05:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761966330; x=1793502330;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lXErV8h5Z9kB/cMMWCpuw5wu0Qf+4aeNxOHiE12B8cw=;
 b=fsXqbABPxFRjCTj7Vgzu3dsA47db0vibLepd/i2gplwb+3ba2e5PXZYA
 ikyRByLUchiV9Vyi0SMdwRhRXmtIXamNYUesleoNTgPkvq90EhWsARjft
 UwKv4s00K7GpMvTpQvxlcYc+XlFWKPxE0unSbHMnC0Fig7QQ0pQ8CnKUP
 RZWppxDjJVdhGoZTt+uyFHBsIv4GePeqQyW3iq6SrDywKXfredcCGQfln
 ooB1x1XiXHfIpm//n73OgZYq0cOQd4HPnQiokSIlKD8jRw4FM7FyVKjCt
 BjZGf7tw0qtQkfWsp8r/iZBeKdLLNH3MGQL/AF2sEHPG3PcGZBgTYp2jS w==;
X-CSE-ConnectionGUID: 4g6qwagRRQGemjWweCN6UQ==
X-CSE-MsgGUID: BjIj4mLZTtiezPByI/MaIQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="81759538"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="81759538"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:05:30 -0700
X-CSE-ConnectionGUID: e3nJBeVfRFqKk7kpRwWufw==
X-CSE-MsgGUID: 4VeZUJxmQ6SJdhsnUXy1zg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217222765"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa001.fm.intel.com with ESMTP; 31 Oct 2025 20:05:26 -0700
...
Subject: [PATCH v4 18/25] drm/i915/ddi: Define LT Phy Swing tables
Date: Sat,  1 Nov 2025 08:34:27 +0530
Message-Id: <20251101030434.4159839-19-suraj.kandpal@intel.com>

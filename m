...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF54CCD3AF
	for <lists+intel-gfx@lfdr.de>; Sun,  6 Oct 2019 18:50:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C1C689FCE;
	Sun,  6 Oct 2019 16:50:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8AE1F8999C
 for <intel-gfx@lists.freedesktop.org>; Sun,  6 Oct 2019 16:50:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18742849-1500050 
 for multiple; Sun, 06 Oct 2019 17:50:06 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sun,  6 Oct 2019 17:50:01 +0100
Message-Id: <20191006165002.30312-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/12] drm/i915: Replace hangcheck by heartbeats
...

...
CmluZGV4IDA1ZmI2NzJhMDBiOS4uZTVhMWYzY2RhZTdkIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dw
dS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYworKysgYi9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYwpAQCAtMTQzMzcsNyArMTQzMzcsNyBAQCBzdGF0
...

...
ZWxfZW5naW5lX3R5cGVzLmgKaW5kZXggNmFmOWIwMDk2OTc1Li5hZDNiZTJmYmQ3MWEgMTAwNjQ0
...
CXN0cnVjdCBpOTE1X3ZtYSAqdm1hOwpAQCAtMzMwLDYgKzMyMywxMSBAQCBzdHJ1Y3QgaW50ZWxf
...
ZXJpYWw7CkBAIC00ODAsOCArNDc4LDYgQEAgc3RydWN0IGludGVsX2VuZ2luZV9jcyB7CiAJLyog
...
RU1QVElPTiAgIEJJVCgyKQpAQCAtNTQ5LDYgKzU0NSw3IEBAIHN0cnVjdCBpbnRlbF9lbmdpbmVf
...
L2k5MTUvZ3QvaW50ZWxfZ3QuYwppbmRleCA4ZjQ0Y2Y4Yzc5YjIuLmQ3ZjQ5NWJmMjkyOSAxMDA2
...
cHUvZHJtL2k5MTUvZ3QvaW50ZWxfcmVzZXQuYwppbmRleCA3YjNkOWQ0NTE3YTAuLmRkMzcyYjM3
MmVlNiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfcmVzZXQuYwor
...
bmlzaDoKIAlyZXNldF9maW5pc2goZ3QsIGF3YWtlKTsKIHVubG9jazoKQEAgLTEzNDcsNCArMTM0
NSw1IEBAIHZvaWQgX19pbnRlbF9maW5pX3dlZGdlKHN0cnVjdCBpbnRlbF93ZWRnZV9tZSAqdykK
...

...
Z3B1X3Jlc2V0KGd0KSkKQEAgLTE2OTYsMTIgKzE2OTUsOSBAQCBpbnQgaW50ZWxfaGFuZ2NoZWNr
...

...
ZHJtX2k5MTVfcHJpdmF0ZSAqaTkxNSA9IG5vZGVfdG9faTkxNShtLT5wcml2YXRlKTsKQEAgLTQy
OTYsNyArNDIxMCw2IEBAIHN0YXRpYyBjb25zdCBzdHJ1Y3QgZHJtX2luZm9fbGlzdCBpOTE1X2Rl
...
NV9kcnYuYwppbmRleCA5MzU0OTI0NTc2YzQuLjEzNDEyZTYxNDgzMiAxMDA2NDQKLS0tIGEvZHJp
dmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9p
OTE1X2Rydi5jCkBAIC0xNTQ2LDEwICsxNTQ2LDcgQEAgdm9pZCBpOTE1X2RyaXZlcl9yZW1vdmUo
...


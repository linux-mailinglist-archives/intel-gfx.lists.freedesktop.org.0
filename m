...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GLiAHfZfqWlc6QAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 05 Mar 2026 11:50:30 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED55B20FFB8
	for <lists+intel-gfx@lfdr.de>; Thu, 05 Mar 2026 11:50:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 21B3010E26F;
	Thu,  5 Mar 2026 10:50:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; secure) header.d=linutronix.de header.i=@linutronix.de header.b="Q2pS+r/2";
	dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="TJjXlSOL";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8DDF810E268;
 Thu,  5 Mar 2026 10:50:26 +0000 (UTC)
Date: Thu, 5 Mar 2026 11:50:22 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
 s=2020; t=1772707824;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 in-reply-to:in-reply-to:references:references;
 bh=DDg2UJxc5VzW285Ko+uegoDs9MrRKsQNSmmAYtPOK+w=;
 b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
 s=2020e; t=1772707824;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 in-reply-to:in-reply-to:references:references;
 bh=DDg2UJxc5VzW285Ko+uegoDs9MrRKsQNSmmAYtPOK+w=;
 b=TJjXlSOLyv8TRQNb/oxgBcrEV+zKx6/XnnhmOydF5eKI4aRbW/A5i3MceYcgeGyVJ4odIL
 lLwY9gh9EBoCMFAw==
...
Message-ID: <20260305105022.cc1qAMoO@linutronix.de>
...
X-Spamd-Result: default: False [-1.31 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[linutronix.de:dkim,linutronix.de:mid,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo]

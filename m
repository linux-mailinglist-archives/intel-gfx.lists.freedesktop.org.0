...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 827F59FF459
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Jan 2025 16:50:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26D1310E20B;
	Wed,  1 Jan 2025 15:50:57 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="CYdEeq5f";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3006010E210;
 Wed,  1 Jan 2025 15:50:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1735746656; x=1767282656;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=SP3Z0+GAukkpx2kwae816pqN7mnkygMkYaC59LTklb0=;
 b=CYdEeq5f0adKpZ0jEVJCJZbPlLIJO36UfkY+y3WU666vgrpMIuh3G3na
 BwIwd9JzSgKoHgBxOR3v59P9zfNYTYAdPGC4pLSPVmwfDXRgufTaQ7eAN
 1rmPSUayFQClrv5YouPxiLkZ/jJie7QyGktdK73F1tokD0VSDp+pJEeQ1
 pBkMzHqXuEFa4QkeoXAe+y7PZZ+L7BnQxVSvN3rQf9yl7dhpo4pGCTF6V
 FIB/po1oBajPnUgNY76l2QOTzmvQGzSZA3JBobEOVdwP5JhDGr5Rd+6n2
 wIsuEisgoHXmSNfyyMT6pEE9dYTak0ySZdDNtKBg0VFkuCrIlV4Fvb4Ux A==;
X-CSE-ConnectionGUID: +Ts1vM4pSSSQbiFy/0Z2Iw==
X-CSE-MsgGUID: Cb8UNLPUSLSmR/OaOnzZog==
X-IronPort-AV: E=McAfee;i="6700,10204,11302"; a="46485590"
X-IronPort-AV: E=Sophos;i="6.12,282,1728975600"; d="scan'208";a="46485590"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jan 2025 07:50:56 -0800
X-CSE-ConnectionGUID: 5dMVCGsqQwOwg9pn2cTycg==
X-CSE-MsgGUID: utLTRBUnTAmP8Wz4RWGKXQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,282,1728975600"; d="scan'208";a="132138962"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by orviesa002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jan 2025 07:50:51 -0800
...
Subject: [PATCH v4 04/11] mtd: intel-dg: implement access functions
Date: Wed,  1 Jan 2025 17:39:18 +0200
Message-ID: <20250101153925.865703-5-alexander.usyskin@intel.com>

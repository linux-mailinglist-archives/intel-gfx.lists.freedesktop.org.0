...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB5187D2B8D
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Oct 2023 09:41:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 225DD10E15E;
	Mon, 23 Oct 2023 07:41:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ADE5E10E15D
 for <intel-gfx@lists.freedesktop.org>; Mon, 23 Oct 2023 07:41:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1698046906; x=1729582906;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=wsXN3q0+6gt97V8wj/96RM+KlmsAwzhZ+JTRere4Yh8=;
 b=VSt7FeoT/GT+6+nZVi2l6ry/4ysKFjEjR1vVvsX3Wg55a1hGNKC8pfOQ
 yliCDjvGdzC3QU8xRLc53gtUKypkqm0ctEQeAL8DJZnFlxvR4B3crwxmH
 zkWA2CUOGF8ZlZqf13tHEcGm05Q8x8voi2qwblLbydoPz1lQSyTaxkw7+
 nShbl9TiC3MMxg4tI3WNZ+7hSlvp12ezycw3HZgTxY+pYPqLZjpTVwd7V
 fHSViV5upq+Fpu6P0KK3euJkQhKZXpawNIi81WzkYFtNajoGHva4wadVD
 mi/WBfvtq0CoMuNIBr8tU3fYIf3yxp0LkUK0qPV63IVTEWY1sq0pD+skU g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10871"; a="473000646"
X-IronPort-AV: E=Sophos;i="6.03,244,1694761200"; d="scan'208";a="473000646"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Oct 2023 00:41:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10871"; a="848716417"
X-IronPort-AV: E=Sophos;i="6.03,244,1694761200"; d="scan'208";a="848716417"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Oct 2023 00:41:44 -0700
From: Andrzej Hajda <andrzej.hajda@intel.com>
Date: Mon, 23 Oct 2023 09:41:21 +0200
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20231023-wabb-v3-3-1a4fbc632440@intel.com>
References: <20231023-wabb-v3-0-1a4fbc632440@intel.com>
In-Reply-To: <20231023-wabb-v3-0-1a4fbc632440@intel.com>
To: intel-gfx@lists.freedesktop.org
X-Mailer: b4 0.12.3
X-Developer-Signature: v=1; a=openpgp-sha256; l=11688;
 i=andrzej.hajda@intel.com; h=from:subject:message-id;
 bh=0NNAHD5hOwer8AxTCtQTj/BHs5tKA8mgK9mozy+7+hE=;
 b=
X-Developer-Key: i=andrzej.hajda@intel.com; a=openpgp;
 fpr=FCA8443134DDBF5DE17F034D2362B293DE10FDD7
Subject: [Intel-gfx] [PATCH v3 3/4] drm/i915: Add WABB blit for

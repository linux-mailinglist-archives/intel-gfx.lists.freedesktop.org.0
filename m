...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F30E6E80E5
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Apr 2023 20:08:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 58BEB10EA63;
	Wed, 19 Apr 2023 18:08:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EA94C10EA39;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=+48469cIbPtGLBcjSSK13uYdj6Hf9sX4hkkhV3vpQlM=;
 b=YmAJv0xRdtAIVpReuX9uvjomiWHxjFpqtdB/GknatTwwTsbxHSzXf85B
 qrAuTvIOYrEKzIrwMePYsyu9I6ZN5LehJNiHjbML818Ldwk2lqmcp6Ac9
 BwZ4iNdXBb9XdlRfTqm5Imd/p6g8067K8opSUDfHzv9vm0C7D8/EMc383
 DisaaQPTtcg+8zy0hArAugIXrkh1pLdCPhsLKYIYdeMosJ1p3WEqYcd8K
 FtVv5ARMT0Dnog1mSFpOm5KcsWaQnOfflR+WeFDps5KyZ7Zftvvq8/IiK
 0PoXT9PDec+nuyqvtA9ltv6w/f6tGmCAA2vNakk2cgqbaIVmU9Tb34QQd A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="329695027"
X-IronPort-AV: E=Sophos;i="5.99,208,1677571200"; d="scan'208";a="329695027"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2023 11:08:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="724139440"
X-IronPort-AV: E=Sophos;i="5.99,208,1677571200"; d="scan'208";a="724139440"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2023 11:08:29 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Wed, 19 Apr 2023 11:09:40 -0700
Message-Id: <20230419180942.2494156-7-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH 6/8] drm/i915: preparation for using PAT index
...
index 6d51dee67c91..f812ad89e8d3 100644

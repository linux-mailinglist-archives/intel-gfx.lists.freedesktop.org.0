...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 310466EE909
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 22:29:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7006A10E7EE;
	Tue, 25 Apr 2023 20:29:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7278110E7EE
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Apr 2023 20:28:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682454538; x=1713990538;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ZUrwjaaFZ5p7OzWW3r9jnjDO6KiM4rwFpSM9P4Wdlzw=;
 b=jgWya5Hnlmow9RPOdAx67X7c129tFrSkMlMxgEOvDyf9WSV9mJSVFIkE
 ZC61oQP5qdxmO/UGJ8/NA68bPxZOIy/NyAKzqochFrDpqazFsEQHu7o6N
 l8C+4qP/+BCg22VoWCyqKOIRc4PRgv5l7SzE6xaJ2vcmGGvtbR3OuyLOw
 DYPpjN79q8M6Bzo3BhJBJ/RVyWHMwWJSLLUVUAv7RANZOHB2QY4ooJSdx
 BjntIDUV1BIFP4PcKiCsktQtm0euIMoKKeB3dmrLFEpFYbPouLenR7VYG
 UzhCcx4QBhLMjRh5o9NetwG7RgI0rZbhfyxpB7PDQUQTL613cmtYFFBhn w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="345651700"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; 
 d="scan'208,223";a="345651700"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:28:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="724141274"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; 
 d="scan'208,223";a="724141274"
Received: from aazuev-mobl.ccr.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.252.59.124])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:28:55 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:28:24 +0300
Message-Id: <20230425202826.1144429-7-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 6/8] drm/i915/mtl: find best QGV point and
 configure sagv

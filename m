...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 712DC7A29DE
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Sep 2023 23:57:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E106810E6A1;
...
Subject: [Intel-gfx] [PATCH 4/4] drm/i915/guc: Enable Wa_14019159160

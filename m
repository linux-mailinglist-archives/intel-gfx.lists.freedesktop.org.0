...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83C4A5737E8
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 15:51:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 179A69AC73;
...
Subject: [Intel-gfx] [PATCH v11 07/10] drm/i915/ttm: add buffer pin on alloc
 flag

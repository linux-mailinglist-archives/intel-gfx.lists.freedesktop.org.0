...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 773F7AB8861
	for <lists+intel-gfx@lfdr.de>; Thu, 15 May 2025 15:48:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB66F10E888;
	Thu, 15 May 2025 13:48:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="U6iGXbbW";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6FBED10E886;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=Pl/lP9rXzHandzd44Xns+rlwR3M6+HYvl9HrhG324EU=;
 b=U6iGXbbWXJKf/cnemkf6KhUIMnjgCJvhPRO6GRcJyPJWaQu+T2SXS+P+
 Zhb5xaqiabWOy8BNHYdKvigO5sPMZBUOB9A1IDvCABmvDsyOYlDpohLJy
 1Efu80P6q2o8jxU6TZfRzgMCMxqGkeCqNtQ+StARpKvcNB3wcfzMatU0C
 7ytbW4JJYdGUUaV8NWG9GrJ4JSmEg9wisvhgHWNkj82XGJyrWxSK3D4GI
 M5tAAoK5KGVBIHgl7N89oqI1UABPGsA26JQ9aN2+Bd0+DGlXDe7hdZyE4
 AUv9W1EbrOzlpqa50FNA4CUuNrXeDxnrYPPLTcQFEVRDy5Cn2obeVXTe5 w==;
X-CSE-ConnectionGUID: m40ZnDc+TVC2EzboyO1lRw==
X-CSE-MsgGUID: ZuDu7rCPTX+6I6IRANdc/A==
X-IronPort-AV: E=McAfee;i="6700,10204,11434"; a="66660618"
X-IronPort-AV: E=Sophos;i="6.15,291,1739865600"; d="scan'208";a="66660618"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2025 06:47:53 -0700
X-CSE-ConnectionGUID: RGoUBvLvRH+EXgwI2HLHPA==
X-CSE-MsgGUID: YpzGYYfUQlOil/Fn0VtWmA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,291,1739865600"; d="scan'208";a="138428297"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2025 06:47:47 -0700
...
Subject: [PATCH v10 01/10] mtd: add driver for intel graphics non-volatile
 memory device
Date: Thu, 15 May 2025 16:33:36 +0300
Message-ID: <20250515133345.2805031-2-alexander.usyskin@intel.com>

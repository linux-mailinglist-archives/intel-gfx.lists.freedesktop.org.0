...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4856E7922AD
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Sep 2023 14:33:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9176C10E4D6;
	Tue,  5 Sep 2023 12:33:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1202C10E4DC
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 Sep 2023 12:33:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1693917190;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=2Slvmjn5iaKcyAIEaAiPIhtko6OZCu6rmVWnSBvHXbo=;
 b=JW3s9HxaFMGV9HLJipWgTmZqAoXXsFQOCApdiFXxYVeoUeWM0ybaDsulIAy36mdVqLuWAg
 lndjnAMhzoFhTahspoxToq36zOrwesKwpVBU+nTB80nJBcrkws1cdrSTlN8R/i/glPTsCS
 xR/F+bW7eMBpsbYkU43Dgl6z8i2Rayk=
Received: from mail-ej1-f70.google.com (mail-ej1-f70.google.com
 [209.85.218.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-298-jmHRTVlHOemigTCSgI2qYQ-1; Tue, 05 Sep 2023 08:33:08 -0400
X-MC-Unique: jmHRTVlHOemigTCSgI2qYQ-1
Received: by mail-ej1-f70.google.com with SMTP id
 a640c23a62f3a-9a6501f1dd5so149365666b.0
 for <intel-gfx@lists.freedesktop.org>; Tue, 05 Sep 2023 05:33:08 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=2Slvmjn5iaKcyAIEaAiPIhtko6OZCu6rmVWnSBvHXbo=;
 b=
X-Gm-Message-State: AOJu0Yy4ClZY1po7GNK2IStZ+h7lXpYksygPV299tmpmg5mbA8HV/adW
 FNNWcCm/e7l5HObHYvvjSGs8Nnm71x7L+JuFjY1kQa5wT7GlotPN6U4sIDoo3u+M0hXfNNjgkC5
 gOPzXFpTVCeXP4nlC/ETWxFGDA0ndrdtS214yG8w=
X-Received: by 2002:a17:906:30c1:b0:9a1:f521:c404 with SMTP id
 b1-20020a17090630c100b009a1f521c404mr9478130ejb.52.1693917187311; 

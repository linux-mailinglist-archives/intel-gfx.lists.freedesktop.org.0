...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 87C8D4020D4
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Sep 2021 23:01:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B92B89CDE;
...
Subject: [Intel-gfx] [RFC v2 04/22] drm: Add Plane Degamma Lut property

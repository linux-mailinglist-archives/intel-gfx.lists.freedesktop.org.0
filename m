...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA7C4543DD8
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 22:53:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EF0911A094;
...
Subject: [Intel-gfx] [PATCH v2 4/8] drm/i915: allow volatile buffers to use
 ttm pool allocator

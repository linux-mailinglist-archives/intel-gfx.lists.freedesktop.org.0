...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45D186F61A6
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 01:01:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF5D010E060;
	Wed,  3 May 2023 23:01:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6A57E10E060;
 Wed,  3 May 2023 23:01:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683154897; x=1714690897;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=pVixhrCjkmhY43hl1nJClj9amOPsMrOM9tmbmYu1VCo=;
 b=DsiUhwvODsM6CG+vqjqANDORnYqSWAT3ztGsRjA2tvbvfTQ2qGumY1jl
 Jaq2CJBlMm66JzsLyazJqyZzw0sWEnLPKzAJHaUh7nOE6PKdWs7ITg5jo
 y3TT60JrrOTCP8oo/wYzih1czFDX/8/2+9kGmlx9JpSzkNNLOBh5IKws4
 kMdw1314xLGNHLWIHfM82oS1xus4qsV2k3ak91AFvhiANJnfDflaaYFRz
 y64630Rnndidoxfz6hnaTYhnc1yXKtZ4L2QM9cPXWKJCA/B2hPiHzpb4O
 LjBVEUOksr0k6/GMHMsaMRpNN3QPWWzaWQOA1PjPxS5Zt0skxyVr6BeIp Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="350868540"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="350868540"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 16:01:11 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="943061845"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="943061845"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 16:01:10 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 May 2023 16:02:07 -0700
Message-Id: <20230503230211.2834340-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 1/5] drm/i915: preparation for using PAT index
...
index 5fcc9cfed671..f7677cc95435 100644
...
@@ -1152,9 +1211,11 @@ static const struct intel_device_info mtl_info = {
 	.has_llc = 0,

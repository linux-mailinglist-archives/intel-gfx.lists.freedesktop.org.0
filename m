...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C596C64EE63
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Dec 2022 17:02:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B205810E5F6;
	Fri, 16 Dec 2022 16:01:36 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 07/12] drm/edid: add separate

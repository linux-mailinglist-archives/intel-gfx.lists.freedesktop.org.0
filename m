...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C0F1A6A8F0
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Mar 2025 15:46:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C047710E63A;
	Thu, 20 Mar 2025 14:46:33 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="g3bSEYdW";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0936210E640;
 Thu, 20 Mar 2025 14:46:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1742481993; x=1774017993;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=yG6BEOw0V6sycfGCkIc3s8vJGPcg6vB36JVk4s7810Q=;
 b=g3bSEYdWXjOi9PvgaGIhMrUx+j1Seigl9iFDdHbEQbY3Cu/TxBQ7xPtd
 W4CIUN2K1KTGCXWO3PmfMZl3/OeAXytZQ2gHfjrWED0M768dU9QHwsWVD
 iqcfGPlllJB0xyb/T0tnm1BUlIewlKcuDrjYRzq4syLaz8LLgugPB6FBZ
 tiXzY48nH4hxICi6fp+DClHJUaabaOWnvJz0jiD5XvS0QIVgoLfrIpusX
 DzD8nbnQUEwSZZrnkpOBFgvmzu5PgeW0k7B2ftqAlq1M8qD38G3XHR/YV
 VZx7OSQkhwTvJIh82YppfWNMrua2FqkcuU/oqdj1tW8n3PvcorlLscAYS Q==;
X-CSE-ConnectionGUID: BAf1PmxvQ3asjlS0y7XW3w==
X-CSE-MsgGUID: Uu9X46mAT4ykHt7Z5R8MvQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11379"; a="43599904"
X-IronPort-AV: E=Sophos;i="6.14,261,1736841600"; d="scan'208";a="43599904"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Mar 2025 07:46:32 -0700
X-CSE-ConnectionGUID: WREyTdLbSQC0ys2Or2fEOw==
X-CSE-MsgGUID: OXLEaUvBQZGYKpXghpkpoA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,261,1736841600"; d="scan'208";a="146326826"
Received: from unknown (HELO localhost) ([10.237.66.160])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Mar 2025 07:46:31 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, Uma Shankar <uma.shankar@intel.com>,
 =?UTF-8?q?Ville=20Syrj=C3=A4l=C3=A4?= <ville.syrjala@linux.intel.com>
Subject: [CI 5/9] drm/i915/hotplug: convert hotplug irq handling to
 intel_de_*()
Date: Thu, 20 Mar 2025 16:46:01 +0200
Message-Id: <cd1149b3ebcb7a9f73830b99957f09e468cd5fd9.1742481923.git.jani.nikula@intel.com>

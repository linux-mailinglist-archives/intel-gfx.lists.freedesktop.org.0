...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 93F8FC27690
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:25:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0AE4D10EC42;
	Sat,  1 Nov 2025 03:25:32 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="g8MbezKJ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E62FE10EC3D;
 Sat,  1 Nov 2025 03:25:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761967531; x=1793503531;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Aaqd77iLsTHPmBDUZTYon1fS4nNZB6GB6sjJ+z2kFPQ=;
 b=g8MbezKJVlGCSe8UqlKeKt2A5r+cub+9E4+QlAD05d2ZVOtgfakkyFei
 c7en5MHvndGT5IGi/s94F6j5eSJh33iuWQaaL+IV5f/RP0l6gFQM4QDcj
 Mg6obk86JO0hXf0z8B9NHZOeGH0YkVyFJb+luVqqy1Qae0CUAIGLOTGfq
 eMAyfDY0kRkaS5QL8S/oN+oR06QJNpruRuvkHvYACTVap9wkHkWfGE3a/
 A3Xd8+IaeHB5vzRfL45bLcwaxBswdeLl6bHhpTTWLHqS7T+yJhGtV1giD
 qEXahDUI7FlnF9KJNusvYPK7s3+lC8LGqUXWFKueGUl7fF3uuvnP+/p/2 Q==;
X-CSE-ConnectionGUID: VX1onvXLTYqLFdzl+knbug==
X-CSE-MsgGUID: AjkDjjtfRhuOJijDxEF5Nw==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="64019850"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="64019850"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:25:30 -0700
X-CSE-ConnectionGUID: oLQjiCTESL+c3FMHRMXHxg==
X-CSE-MsgGUID: bVZ193Q0SZGOTWbNVVjx9w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217037958"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa002.jf.intel.com with ESMTP; 31 Oct 2025 20:25:29 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-xe@lists.freedesktop.org,
	intel-gfx@lists.freedesktop.org
Cc: Suraj Kandpal <suraj.kandpal@intel.com>,
 Arun R Murthy <arun.r.murthy@intel.com>
Subject: [PATCH v5 07/25] drm/i915/ltphy: Read PHY_VDR_0_CONFIG register
Date: Sat,  1 Nov 2025 08:54:55 +0530
Message-Id: <20251101032513.4171255-8-suraj.kandpal@intel.com>
...
index 233fefe89eec..bfa3b3eab8cb 100644

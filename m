...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 51E1A6EC419
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 05:43:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4DEA10E26C;
	Mon, 24 Apr 2023 03:42:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A21D210E15A;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=UWkT0wz/+EUUmOQBTmxNyKiVi/F8XuHvg5gPKq3tKm88jg8s8KVWe6wR
 2arMVr2htVNksctzjJoPSF1k1uyoMzkVe4MRt8EBrXKovNR5N01QZog1X
 7FmENfmx/3l97qz9gxzRiQ3fKjRa9mg6I2D9aA7TEbWMUPGFCPI7Oxi5q
 7AU5SBojXepsOx4EZkV284nZPKFy+AQBbO4bdaMuJlCVMH8J3OaVfzn3x
 uLo9nJwL1oN+ayJP2B6JNJXvW/R0hLHKmLzT0/AxAfamFI3YeQ5CH3Px8
 7CqBtnkPJhEoKjaKN7C+njN0wy+T27NpzJoa57fI/5KbP9PyPJR7sUzEu g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="349149202"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="349149202"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 20:42:54 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="817096676"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="817096676"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 20:42:54 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Sun, 23 Apr 2023 20:44:01 -0700
Message-Id: <20230424034403.3390144-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 2/4] drm/i915: preparation for using PAT index

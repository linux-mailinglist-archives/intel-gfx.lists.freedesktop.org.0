...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 753B547AC5D
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Dec 2021 15:43:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B7CBC12B2D8;
...
Subject: Re: [Intel-gfx] [PATCH 1/4] drm/i915/guc: Speed up GuC log dumps

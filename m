...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E2506BE2A6
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 09:08:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF6CB10E346;
	Fri, 17 Mar 2023 08:08:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D823010E346;
 Fri, 17 Mar 2023 08:08:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1679040480; x=1710576480;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 in-reply-to:mime-version;
 bh=E/phxLDUicnD0ZatVmeTVWylFn/8Cni7fbQpafmdByo=;
 b=PP5eV3B5ZdZYHKZYAqZk4tqwY5XvrQ4WJF/wnM3B7plMw1qnqvKeoaTt
 O2GN6m6dftU5w++AOhgaxjicOK7650IZeEBizjlhfRS8bdETEcG/E56Qp
 7acRkUldCQfyYaxTeRRVlBNJpGG7sTG6zsvxyz51sYLQz4ikQb7AYxG34
 gDxxWTl+3ZoJTP/bwhLq9wrm4RzDsp3C3qbg5NlSBxRBimmubBt4QL66z
 WAC48InORiIzaz6yfNM0oY+rizyOa25Z/mBCY6OUz0/UtPvMewvBSMgLB
 XoBDJC0fHC3RbkGTw3BFRduaWXnltP+zGRpv55PGWXWhnnqxzH6+1Fhum A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="326570940"
X-IronPort-AV: E=Sophos;i="5.98,268,1673942400"; d="scan'208";a="326570940"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Mar 2023 01:08:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="657472881"
X-IronPort-AV: E=Sophos;i="5.98,268,1673942400"; d="scan'208";a="657472881"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230025)(376002)(396003)(366004)(136003)(346002)(39860400002)(451199018)(82960400001)(2906002)(41300700001)(8676002)(38100700002)(316002)(66556008)(54906003)(4326008)(6916009)(86362001)(66946007)(66476007)(478600001)(3450700001)(5660300002)(6486002)(26005)(6506007)(6512007)(186003)(6666004)(8936002)(83380400001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 17 Mar 2023 08:07:55.3641 (UTC)

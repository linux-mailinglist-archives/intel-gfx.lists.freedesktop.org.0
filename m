...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 687B3A05DF8
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jan 2025 15:05:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56EC910E8BC;
	Wed,  8 Jan 2025 14:05:10 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="KxvQyA7K";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1126410E8B7;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=Ch7G39pTUDrDKrJqIsafnXyHM/nU5mvdDqVXxNEcQSE=;
 b=KxvQyA7KNT4POjzexT+v0CbGiVFxnTwoKttLpsa1QDdWlQhtAYB9lIec
 GyLcelBIutxkYFxfhyGR8oY2aAcsJxCPCo1TkExLp95iM83G3CK8GKKsY
 uUstvdR8PEBP6hUaoOiS5Fn1fykYuNqtTeRw/O4TZ4cUIsB9alRa0Y/A8
 pIJg6p97QgKZbRN+qW+0VYzdShBQyn+NBZoM/cvtc17H6OSQf1xbzU78z
 W9LXptpz547aPe0GikPOt8P7TRej/hNaJAFA4FgwMOKsjHo7jsvkm6o/0
 ZTM4vxs57LVxtMGcwlZZCPHFxLidJL9mi4PZ6yImgIvu68FhdGbas/HzT g==;
X-CSE-ConnectionGUID: Cc/NPd3SQxStaj86YB4jnQ==
X-CSE-MsgGUID: C4a3gCZ+ShODj0seoRBkrg==
X-IronPort-AV: E=McAfee;i="6700,10204,11309"; a="47146063"
X-IronPort-AV: E=Sophos;i="6.12,298,1728975600"; d="scan'208";a="47146063"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by fmvoesa105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jan 2025 06:04:26 -0800
X-CSE-ConnectionGUID: Jl6NjMJ0TjuuiE89zB2Cpg==
X-CSE-MsgGUID: e/rmAOF0R+qMggoiKgkgVg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="108153968"
Received: from klitkey1-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.152])
 by ORVIESA003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jan 2025 06:04:24 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 1/3] drm/i915/audio: convert to struct intel_display
Date: Wed,  8 Jan 2025 16:04:13 +0200
Message-Id: <4ddcc2e704fc6b1592a878c80e15fadd82c63550.1736345025.git.jani.nikula@intel.com>

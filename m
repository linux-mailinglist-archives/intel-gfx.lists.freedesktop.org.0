...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B78095F2F8
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Aug 2024 15:34:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D1DF10E1DB;
	Mon, 26 Aug 2024 13:33:59 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RGb0l5Xm";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 474E210E142;
 Mon, 26 Aug 2024 13:33:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1724679237; x=1756215237;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=riStfHwx/1OlDOAOlNPJbCEO+YYGKJSzpREHvukTHUg=;
 b=RGb0l5Xm9xJRQEpaorHZNHpUIdTdv2waxCs4KFjv3dx8RIhKlNXfPbpz
 jO8jc/Mclm3TZi9Off+Zycj65OElAXGOORBTx16IXzSJ+X0wfnwL/s7b8
 Rz/2E6Y+GVMW+2QsYQHnD/e0UjDEhrtd2VvZIh78fCznMdGH+2TD8+S0S
 fSbbyrPO6EjGubmiS8XSZsMBle1v7+YMfVqUf1iJzNN2LHa9330sc4EFi
 7Qn7ZQ+LLzWqZR1LS9C2OakHb0/q9VGMCG5z8lNZZowbhmvGmOZLSyOzN
 XAPhSOYjxR9RZq5UkQ2CnLODrlGvPgWw40I9HLhQ7fqYsQIoyHdTK4j6g g==;
X-CSE-ConnectionGUID: zux3z9NGSCi83qu6tZKhxQ==
X-CSE-MsgGUID: dimQuejnT12xaYWcloOwzg==
X-IronPort-AV: E=McAfee;i="6700,10204,11176"; a="22695347"
X-IronPort-AV: E=Sophos;i="6.10,177,1719903600"; d="scan'208";a="22695347"
Received: from fmviesa009.fm.intel.com ([10.60.135.149])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Aug 2024 06:33:57 -0700
X-CSE-ConnectionGUID: LDLctk8bRLuNTaTno31RDw==
X-CSE-MsgGUID: DAaUaHeJSgSa7mw4zaKrIg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,177,1719903600"; d="scan'208";a="62572672"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by fmviesa009-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Aug 2024 06:33:55 -0700
Date: Mon, 26 Aug 2024 16:34:15 +0300
...
Subject: Re: =?utf-8?B?4pyXIEZpLkNJLklHVDogZmFpbHVy?= =?utf-8?Q?e?= for
 drm/i915/dp_mst: Fix MST state after a sink reset (rev3)
Message-ID: <ZsyEVyBEUTpD-3Pq@ideak-desk.fi.intel.com>
References: <20240724161223.2291853-1-imre.deak@intel.com>
 <172452021921.765660.7460553309737480709@2413ebb6fbb6>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <172452021921.765660.7460553309737480709@2413ebb6fbb6>

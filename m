...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A30E174115
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Feb 2020 21:36:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB6D46F4CC;
...
Subject: Re: [Intel-gfx] [PATCH 48/51] drm/mipi-dbi: Drop explicit

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A506643679F
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Oct 2021 18:24:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B9FC6ECCC;
	Thu, 21 Oct 2021 16:24:43 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 01/10] vfio/ccw: Remove unneeded GFP_DMA

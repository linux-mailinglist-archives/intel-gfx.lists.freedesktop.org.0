...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 65B6D3D02CF
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 22:40:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB04C6E542;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 03/42] drm/i915/guc: Connect the number of
 guc_ids to debugfs

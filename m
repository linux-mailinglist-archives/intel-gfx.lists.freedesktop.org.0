...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E69A4CB8F70
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Dec 2025 15:35:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B44610E88B;
	Fri, 12 Dec 2025 14:35:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=lankhorst.se header.i=@lankhorst.se header.b="jQ2x1x81";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (lankhorst.se [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4297A10E31D;
 Fri, 12 Dec 2025 14:35:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1765550115;
 bh=9gCKnMzauq1EgDlxj5/d0ncxaLvtKEm7MmnJ4+bl8G8=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH v2 03/12] drm/i915/display: Use intel_de_write_fw in
 intel_pipe_fastset
Date: Fri, 12 Dec 2025 15:35:07 +0100
Message-ID: <20251212143504.973839-17-dev@lankhorst.se>

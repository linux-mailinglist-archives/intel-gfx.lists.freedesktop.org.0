...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F067C470C02
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 21:44:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0097C10EAB4;
	Fri, 10 Dec 2021 20:44:23 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm/i915: Don't disable interrupts and

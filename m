...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qKuUCLQJD2rREQYAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 21 May 2026 15:33:40 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73D5D5A5E7E
	for <lists+intel-gfx@lfdr.de>; Thu, 21 May 2026 15:33:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F50910F310;
	Thu, 21 May 2026 13:33:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=kernel.org header.i=@kernel.org header.b="QtvQupsg";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sea.source.kernel.org (sea.source.kernel.org [172.234.252.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 317A910F309;
 Thu, 21 May 2026 13:33:30 +0000 (UTC)
Received: from smtp.kernel.org (quasi.space.kernel.org [100.103.45.18])
 by sea.source.kernel.org (Postfix) with ESMTP id 0146C44618;
 Thu, 21 May 2026 13:33:27 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id A9E6A1F0157A;
 Thu, 21 May 2026 13:33:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel.org;
 s=k20260515; t=1779370406;
 bh=tKkpPR3jQHJlzhq8UmH+Jth3VGTLnlZlrxb+8EBuqYs=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References;
 b=
...
Subject: [PATCH 04/11] treewide: Convert struct kernel_param_ops initializers
 to DEFINE_KERNEL_PARAM_OPS
Date: Thu, 21 May 2026 06:33:17 -0700
Message-Id: <20260521133326.2465264-4-kees@kernel.org>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20260521133315.work.845-kees@kernel.org>
References: <20260521133315.work.845-kees@kernel.org>
MIME-Version: 1.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=100902; i=kees@kernel.org;
 h=from:subject; bh=9nJnN7vrgJpqZdKF/5O22XWp9DJoNxTLeW7z3BumQ9k=;
 b=owGbwMvMwCVmps19z/KJym7G02pJDFn8nAt/zXg/6+XCuQI5lxd9XTZhzoInBze5Ju7467v1h
 Da/AkPct45SFgYxLgZZMUWWIDv3OBePt+3h7nMVYeawMoEMYeDiFICJSHsw/A9qDHV9wtDlmKv0
 SmbmNuk/HkZRf6I/3lZoC26+W3fbYwMjw9F5t0zn9zuulmj7YXHnqd7FJ/tUp77WZ7Kf5cs4eeP
 lJ5wA

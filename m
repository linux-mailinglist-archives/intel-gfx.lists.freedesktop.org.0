...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F7C5562CBE
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Jul 2022 09:34:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF8A010E408;
	Fri,  1 Jul 2022 07:34:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B24E510EC3A
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 Jul 2022 07:34:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656660870; x=1688196870;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=cwEHwlg+j3Hl2LFSRX/xD/QY8fDQHMGehqYaO8zvfaQ=;
 b=G2P42c1P2wTfq4o3f+o3C6Kxp2PYN4TWTkAR6+7WZcfCncSbzWeDf+Zh
 7Hq2TDFlEWCT7obb1rXbTlzgRFS1ox0xJXkeLgeenaxqv/xdJo6BPIIPG
 k/WIGVzIhRkoplYCxDGt3u8WR75h9k7dzaYgM1VpHjRJm01HpZ/z3VrA1
 bTTzojec9clYo1LXZOwU3o4P3jVfR/IhWZDtgjsCKV4S034mLXMT3r3fc
 yZb7+kJcjd3YXctiuca2THS6fdR17wxDiuxoCelGZIJRM67kPXIn3b29w
 f8AMfSe0IgeDTD+7/LoPYcvYlo1eOizHuBgKRytGcInAg1h3O/ASM4oR2 w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10394"; a="308091147"
X-IronPort-AV: E=Sophos;i="5.92,236,1650956400"; d="scan'208";a="308091147"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jul 2022 00:34:30 -0700
X-IronPort-AV: E=Sophos;i="5.92,236,1650956400"; d="scan'208";a="681302242"
Received: from vibhutes-mobl.ger.corp.intel.com (HELO [10.213.192.227])
 ([10.213.192.227])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jul 2022 00:34:28 -0700
Message-ID: <963ee174-79d1-ac84-7be3-331f30c735a3@linux.intel.com>
Date: Fri, 1 Jul 2022 08:34:27 +0100
MIME-Version: 1.0

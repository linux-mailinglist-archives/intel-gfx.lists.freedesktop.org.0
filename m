...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84C90A30913
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Feb 2025 11:49:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1509410E660;
	Tue, 11 Feb 2025 10:49:20 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="C96GFTYB";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1DBE910E64F;
 Tue, 11 Feb 2025 10:49:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739270958; x=1770806958;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lSFpEWffsEXgXYW3/tFCOUUhLN1EOsQnkW3cFoe7LGE=;
 b=C96GFTYB23LhKvS9AU+STks73QqV1Bkh8mm/SwPN4dlTtiEyFy/pmbaJ
 86qMpXzbsxatZoQ4HzjBA5geoWrH+syUD7+rmgrP1Q4WCaVdwUDTqzARY
 CHzYo2T3aQAp+Xstgk89CZluKVLvCgjbgq37NVVDDA8ZJr/OIYESk7zp7
 gT+kLEeLy6LCZedIPbhRAIP/0aqOzJvadw7+OUd/OMLLWMrBBpUzL1VKW
 PbMy9nhGn/jdR6dvUFDpSxtBy7JDVIyqNBS9JRy2ZU6GWnZUaf962lcSH
 3qOJOxauWGrNO+DGt+uqUqTJn6Av3jsCoQUv5BCzqCKilH1Pm74+ac2tu w==;
X-CSE-ConnectionGUID: r/N5kl5BQ++CbFwrk1BEsg==
X-CSE-MsgGUID: sg3gonJwQKusTODWHCSbug==
X-IronPort-AV: E=McAfee;i="6700,10204,11341"; a="57293184"
X-IronPort-AV: E=Sophos;i="6.13,277,1732608000"; d="scan'208";a="57293184"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Feb 2025 02:49:18 -0800
X-CSE-ConnectionGUID: vvcXyMP/QRSjKACZrhTjNQ==
X-CSE-MsgGUID: x12Rjmt7QAqs0EtwZh0PkQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,277,1732608000"; d="scan'208";a="112991394"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa010.fm.intel.com with ESMTP; 11 Feb 2025 02:49:15 -0800
...
Date: Tue, 11 Feb 2025 16:18:53 +0530
Message-Id: <20250211104857.3501566-6-suraj.kandpal@intel.com>

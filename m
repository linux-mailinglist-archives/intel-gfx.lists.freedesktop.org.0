...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DB5467BCE0
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:38:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C939210E873;
...
Subject: [Intel-gfx] [PATCH v3 07/19] dyndbg: reduce verbose/debug clutter

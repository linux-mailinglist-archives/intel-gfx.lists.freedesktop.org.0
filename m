...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 845971397B3
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jan 2020 18:31:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AAD9F6E11B;
...
Subject: [Intel-gfx] [PATCH] drm/i915/dsi: Fix implicit declaration of
 function 'acpi_dev*' in 'mipi_exec_i2c'

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2CE7CD64D6
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Dec 2025 15:00:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6853010E699;
	Mon, 22 Dec 2025 14:00:39 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="nUe02kro";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qv1-f65.google.com (mail-qv1-f65.google.com
 [209.85.219.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D266A10E1BA
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Dec 2025 10:29:44 +0000 (UTC)
Received: by mail-qv1-f65.google.com with SMTP id
 6a1803df08f44-88a2f2e5445so46900186d6.1
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Dec 2025 02:29:44 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1766399384; x=1767004184; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=e8CoeuIT6T7KRUSr6GvWlQoN5V/Cu+i3G5ywMuIlPBE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1766399384; x=1767004184;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=e8CoeuIT6T7KRUSr6GvWlQoN5V/Cu+i3G5ywMuIlPBE=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCU30JWAZEy9s/VWp77x98VDY6nA6s/VJ0gkav8KDZV0mhnuLXSKqiS7z0+99RXc5IkUuDXW30ItqEY=@lists.freedesktop.org
X-Gm-Message-State: AOJu0Yy30raJDRivYt1ChhocBwto9WzsJCdkt8ML6vPcf6CKKRPYLyYF
 gja6a7KRqgjZLG7mEsWV7IKrH6NweQ46bYCbc6/B6m4/3r5ZAmgPbzoGwYOQhpZPS3rmwQ==
X-Gm-Gg: 
 8a0JI979vw

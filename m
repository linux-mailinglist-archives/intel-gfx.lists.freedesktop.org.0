...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32D254FC946
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 02:31:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 48AFE10FA95;
...
Subject: Re: [Intel-gfx] [PATCH v5 10/10] drm/msm: Implement HDCP 1.x using

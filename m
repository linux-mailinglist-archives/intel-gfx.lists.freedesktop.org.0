...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 680A3147F63
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Jan 2020 12:03:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 091E672A25;
	Fri, 24 Jan 2020 11:03:04 +0000 (UTC)
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v5 1/3] drm/i915: Move the code to populate
 ACPI device ID into intel_acpi

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96E8F79AC67
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Sep 2023 01:09:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF82710E38D;
...
Subject: [Intel-gfx] [PATCH v6 17/22] dyndbg-doc: add classmap info to howto

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CB6C702A59
	for <lists+intel-gfx@lfdr.de>; Mon, 15 May 2023 12:17:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 743EA10E1A3;
	Mon, 15 May 2023 10:17:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CE25110E1A3
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 May 2023 10:17:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684145873; x=1715681873;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=190JPC/nSPvwUaClzh+KABuvHGEw9p4xrp/XGsRUvn4=;
 b=UJLA63yR6nL6MWcbgglHEZrY5zFOYn69L7wsNDTyIwC1e9akFGoNq0EJ
 lQ3jajO137OfQx9KblksOUaRIuXBwUOgshrM5HQd93AcDLOUUL5fTjL7x
 VOU/sIXHqqWMBAkSqXRHUt28sPjVU+pKuAVE1CQlYNVJs67KqqkgI0wQL
 2Zf2jJDGS6nYoC1ya4it/e1W2c8a09xXGi0ihPaDj2Z18MvhK1nd/gPmj
 z9CfKi3T8FKzRIko/AWhtIAcetxqp3AIeeWKOPcJQy8eHOkuTG1DqE0Ui
 7FbBoeIWNZegpt0XWb3DJG19zkECUEbZlG9O4IRgDw9wzJsYWGOWlWNrg A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="330782989"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="330782989"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2023 03:17:53 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="700911979"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="700911979"
Received: from lveltman-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.42.56])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2023 03:17:50 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 15 May 2023 13:17:38 +0300
Message-Id: <20230515101738.2399816-3-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 3/3] drm/i915/irq: split out display irq
 handling
...
index ecae9bf05269..93c3226b98c9 100644
...
index f6f760e59c9e..110401aab038 100644
...
@@ -1246,353 +486,8 @@ static irqreturn_t ilk_irq_handler(int irq, void *arg)
...
@@ -1645,29 +540,6 @@ static irqreturn_t gen8_irq_handler(int irq, void *arg)
 	return IRQ_HANDLED;
 }
...
@@ -1686,25 +558,6 @@ static inline void gen11_master_intr_enable(void __iomem * const regs)
...
@@ -1806,184 +659,6 @@ static irqreturn_t dg1_irq_handler(int irq, void *arg)
 	return IRQ_HANDLED;
 }
...
-
 ...
 {
 	struct intel_uncore *uncore = &dev_priv->uncore;
@@ -1997,55 +672,6 @@ static void ibx_irq_reset(struct drm_i915_private *dev_priv)
...
@@ -2081,26 +707,6 @@ static void valleyview_irq_reset(struct drm_i915_private *dev_priv)
 	spin_unlock_irq(&dev_priv->irq_lock);
 }
...
-
 ...
 {
 	struct intel_uncore *uncore = &dev_priv->uncore;
@@ -2116,53 +722,6 @@ static void gen8_irq_reset(struct drm_i915_private *dev_priv)
...
@@ -2194,52 +753,6 @@ static void dg1_irq_reset(struct drm_i915_private *dev_priv)
...
-
 ...
 {
 	struct intel_uncore *uncore = &dev_priv->uncore;
@@ -2257,35 +770,6 @@ static void cherryview_irq_reset(struct drm_i915_private *dev_priv)
 	spin_unlock_irq(&dev_priv->irq_lock);
 }
...
-
 ...
 {
 	struct intel_uncore *uncore = &dev_priv->uncore;
@@ -2329,35 +813,6 @@ static void ilk_irq_postinstall(struct drm_i915_private *dev_priv)
...
@@ -2371,108 +826,6 @@ static void valleyview_irq_postinstall(struct drm_i915_private *dev_priv)
...
-
 ...
 {
 	if (INTEL_PCH_TYPE(dev_priv) >= PCH_ICP)
@@ -2486,17 +839,6 @@ static void gen8_irq_postinstall(struct drm_i915_private *dev_priv)

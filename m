...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F0F0D6541E0
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Dec 2022 14:31:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5635810E165;
	Thu, 22 Dec 2022 13:31:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4C4FC10E160
 for <intel-gfx@lists.freedesktop.org>; Thu, 22 Dec 2022 13:31:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671715883; x=1703251883;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=8xlHHFhIaKgXAWPf78EcMJrmldX9HJizImdcpXXuhlA=;
 b=QIzJJF93Kg+lOW74NzpCUjmTMXQECjcgDNPm4WJvkbah3lowFNd279G1
 vkKMIs6BeXMoLegx8WwZW9ylUXFDJbTk+3zXCQ1LTp99VwKJD9ClkkeMG
 TgZf8bVvKvKyPCXb+HPObRriL/e5fGyyH4fM/xae8FNvAFQFn4lwwM7Fe
 W1T0BzRLFStPAUuI7ehTVxd0rIuLlY9/y5THZ0Gj3IGA5tkfOtu6UEQ9l
 Jyz6OPQH1nqEtMwjcuIUOPvCuqq8qUw2YoqmK1NvbFNuuExqIViVXzhp8
 vWQZg4wo0VGuX/hP8kOW2Kw95Rqf7d55A2Ne9cBkHBaqRkRaX0JisdxMR A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10568"; a="299795792"
X-IronPort-AV: E=Sophos;i="5.96,265,1665471600"; d="scan'208";a="299795792"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2022 05:31:23 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10568"; a="980598132"
X-IronPort-AV: E=Sophos;i="5.96,265,1665471600"; d="scan'208";a="980598132"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2022 05:31:20 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 22 Dec 2022 14:31:02 +0100
Message-Id: <20221222133102.1434965-2-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 2/2] drm/i915/display/misc: use intel_de_rmw
 if possible
...
index 69595cbb276651..5f08fec75fadb1 100644

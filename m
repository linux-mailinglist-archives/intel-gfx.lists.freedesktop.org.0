...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 55E2714E666
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jan 2020 01:13:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F3AA6E934;
	Fri, 31 Jan 2020 00:13:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 589A66E0E6;
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,383,1574150400"; d="scan'208";a="218453691"
...
Date: Thu, 30 Jan 2020 08:57:20 -0800
Message-Id: <20200130165721.20342-2-akeem.g.abodunrin@intel.com>
...
@@ -1460,7 +1462,7 @@ static inline int mi_set_context(struct i915_request *rq, u32 flags)
...
@@ -1575,13 +1577,56 @@ static int switch_mm(struct i915_request *rq, struct i915_address_space *vm)
...
@@ -1794,6 +1853,11 @@ static void ring_release(struct intel_engine_cs *engine)
...
@@ -1941,6 +2005,60 @@ static void setup_vecs(struct intel_engine_cs *engine)
...
@@ -1994,11 +2112,19 @@ int intel_ring_submission_setup(struct intel_engine_cs *engine)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F0346E3FAD
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Apr 2023 08:23:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2719C10E122;
	Mon, 17 Apr 2023 06:23:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8F0E710E26F;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=FCtgq0ubkC7bTrWy6l2uyhQ0Y5egDzpYTqL+SQWfkMPRHSvr0zFT5nvV
 We9GLED2Cun9A/4tEaFajaRoTWvWj0lLGyJvrfFJjPm3XrZ0de5l7yRHz
 BobcraZgIhXtBiySw0e4rRyv+IZuiVUKSRr6U7504tZRDhusjPmioGFZU
 6uDlXeAJfJXU3S78YVysNKp4YytyGIj2XP2E5QYfbTivAMQm9sIKsR33s
 3iVA8zwL5I0CCmND20UzCfz7sfDFGgvfF/AJ+kxbpMQ8R6OPp/HERx3Sk
 gJ7nhu/G20uRspvoStpXoR42jDXu9tL5KDr5e9qTu+9zmWyjY/1c7QmCZ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10682"; a="347552378"
X-IronPort-AV: E=Sophos;i="5.99,203,1677571200"; d="scan'208";a="347552378"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Apr 2023 23:23:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10682"; a="721007615"
X-IronPort-AV: E=Sophos;i="5.99,203,1677571200"; d="scan'208";a="721007615"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Apr 2023 23:23:48 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Sun, 16 Apr 2023 23:24:59 -0700
Message-Id: <20230417062503.1884465-5-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH 4/8] drm/i915/mtl: workaround coherency issue
 for Media

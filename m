...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1506BC869
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2019 15:00:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E8996EA26;
...
Subject: [Intel-gfx] [PATCH v2 7/9] drm/nouveau: use drm_debug_enabled() to

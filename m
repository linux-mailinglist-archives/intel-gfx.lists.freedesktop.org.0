...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E57E64DBAC
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Dec 2022 13:53:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E56A10E055;
	Thu, 15 Dec 2022 12:53:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BF82010E09F
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Dec 2022 12:53:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671108782; x=1702644782;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=cF4Fqd/k4EiR/mWIGTDwP8Xih5NFTz0YFk83JjEp6v4=;
 b=S3ZIcc8wXmNjpelJkTA4oIL6R5jGb7ilQletHr1wUiabiWGnZFEoDBat
 SVdQsExoL4dUuIfVfYv8xHUzO57rFuwI5MtQoTGoLsQF22KWU8x0wLoMZ
 Mth3HwbnU36rul/dzNZiJha1nX8acLoKXTEVSSzOPvRlvTOal6SpnG4C5
 rcEsG9dutyZYZp3dPh+dA++glV9dLj6Z/JVtYnNH4vrKgyyQtLg0iI6pE
 filltgEHztth5cxHZFPG+9/BbdvmbKI3rxn34F6ufYWuVGx33pNG5oSZL
 89hls6vv+9BQroLX0/a6rjxo5ez4gpUIOF/uSKVlB9A2VAv267vAaJj+r w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10561"; a="382973989"
X-IronPort-AV: E=Sophos;i="5.96,247,1665471600"; d="scan'208";a="382973989"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Dec 2022 04:53:01 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10561"; a="627174655"
X-IronPort-AV: E=Sophos;i="5.96,247,1665471600"; d="scan'208";a="627174655"
Received: from jd-work.ger.corp.intel.com (HELO paris.ger.corp.intel.com)
 ([10.249.137.168])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Dec 2022 04:52:58 -0800
From: Gwan-gyeong Mun <gwan-gyeong.mun@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 15 Dec 2022 14:52:21 +0200
Message-Id: <20221215125227.1165037-2-gwan-gyeong.mun@intel.com>
...
Subject: [Intel-gfx] [PATCH v15 1/7] overflow: Introduce overflows_type()

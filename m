...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF75657D9D2
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Jul 2022 07:47:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B04D8AA9D;
	Fri, 22 Jul 2022 05:47:40 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/drm_edid: Refactor HFVSDB parsing for DSC1.2

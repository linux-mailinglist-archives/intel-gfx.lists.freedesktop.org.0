...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDAA13B2931
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:30:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C251E6EAC8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 19/27] drm/stm: Don't set struct

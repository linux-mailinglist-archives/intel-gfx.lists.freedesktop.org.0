...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE32561EDE
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 14:53:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F2C989D40;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 04/19] drm/i915: Replace is_planar_yuv_format()

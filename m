...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F0B41425C41
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Oct 2021 21:39:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C26506F4D1;
	Thu,  7 Oct 2021 19:39:21 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 18/20] drm/amd: cleanup:
 drm_modeset_lock_all() --> DRM_MODESET_LOCK_ALL_BEGIN() [part 3]

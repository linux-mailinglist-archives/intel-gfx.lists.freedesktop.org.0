...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BBBE2D53E8
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 07:40:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87F026E9E1;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 06/18] drm/i915/hdcp: Move HDCP enc status
 timeout to header

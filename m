...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D19766A2FC
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 20:30:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E3CEA10EABA;
	Fri, 13 Jan 2023 19:30:39 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 00/20] DRM_USE_DYNAMIC_DEBUG regression

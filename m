...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C388F3D4917
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Jul 2021 20:14:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBF78734E0;
...
Subject: Re: [Intel-gfx] [PATCH 05/30] drm/i915/display: remove explicit CNL

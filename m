...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 50D3DFB0D6
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Nov 2019 13:53:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 617CD6E0F3;
	Wed, 13 Nov 2019 12:52:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5C7C6891B9;
 Wed, 13 Nov 2019 12:52:52 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19187132-1500050 
 for multiple; Wed, 13 Nov 2019 12:52:42 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 13 Nov 2019 12:52:35 +0000
Message-Id: <20191113125240.3781-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH i-g-t 4/9] i915: Start putting the mmio_base to
 wider use
...
bV9jdHhfc2hhcmVkLmMKaW5kZXggYTZlZWUxNmRkLi45NDllMWYzZDQgMTAwNjQ0Ci0tLSBhL3Rl
...
ICJpZ3RfdmdlbS5oIgogI2luY2x1ZGUgInN5bmNfZmlsZS5oIgpAQCAtNTU2LDYgKzU1NywxNCBA
...
ewogCWNvbnN0IGludCBUSU1FU1RBTVAgPSAxMDIzOwpAQCAtNTYzLDMzICs1NzIsOCBAQCBzdGF0
...
YwppbmRleCAzZDk5MTgyYTAuLmQyMTU5ZjMxNyAxMDA2NDQKLS0tIGEvdGVzdHMvaTkxNS9nZW1f
...
MzI7CkBAIC0yNjYsMTEgKzI2OCwxNCBAQCBzdGF0aWMgdm9pZCBsYXRlbmN5X2Zyb21fcmluZyhp
...


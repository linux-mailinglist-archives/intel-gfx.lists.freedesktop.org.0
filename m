...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B082DCB0B8
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Oct 2019 23:01:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B8576EA8C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/5] drm/i915/execlists: Skip redundant
 resubmission

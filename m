...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 56EB35311C0
	for <lists+intel-gfx@lfdr.de>; Mon, 23 May 2022 17:57:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DBACA1122BC;
	Mon, 23 May 2022 15:57:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1DE2F1122AC
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=fA29RjkqkCzqkO/gUK4bTZhxJzjnk/1krpO5BXbEi2w=;
 b=UIEiavksl4q2QNZoh/fWg+vSnJOgtwutKv201tSdQ0Vk1Hf+ioBwXCat
 26jdm+4z1qgw0KI3EeBnJzAJaOB9BLSg3uxciuvOM6jTHFlzn0WzOC69Q
 dnPcar7dJPjdPOWBrR1ZpC77dAUxhbJcpwoLLy05LGKDE+w1ZhgF8EGnx
 ZbyVt4C+h4mDxU8cTpXPoLQPQesP2vkP95Dd/eGIulfPAo/VpxE2fZ/iu
 a6nKqWdFjxmmBJebDINeyOnJgIHLGeqWyaWn0SytdbtmjieNGvf9qsunQ
 Itwmo5w//V5QBWVS8nsX4CnVKNUWipX+57GBnj7igl72ymXIH9TxMyloP Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10356"; a="273381638"
X-IronPort-AV: E=Sophos;i="5.91,246,1647327600"; d="scan'208";a="273381638"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2022 08:57:24 -0700
X-IronPort-AV: E=Sophos;i="5.91,246,1647327600"; d="scan'208";a="548040675"
Received: from orsosgc001.jf.intel.com ([10.165.21.154])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2022 08:57:23 -0700
From: Ashutosh Dixit <ashutosh.dixit@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 23 May 2022 08:57:14 -0700
Message-Id: <3f3651d5beb7d88ea405533cc483775a6aba437f.1653321034.git.ashutosh.dixit@intel.com>
...
Subject: [Intel-gfx] [PATCH 1/4] drm/i915/gt: Add media freq factor to
 per-gt sysfs

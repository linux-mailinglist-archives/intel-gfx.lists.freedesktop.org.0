...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 39DC92404C8
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Aug 2020 12:33:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EFDCD6E3FB;
	Mon, 10 Aug 2020 10:33:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 67DA96E3DB
 for <intel-gfx@lists.freedesktop.org>; Mon, 10 Aug 2020 10:33:29 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 10 Aug 2020 12:30:54 +0200
Message-Id: <20200810103103.303818-16-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 15/24] drm/i915: Make sure execbuffer always
...
index f4390559a3d5..df4688d4d264 100644
...
index 05a2624116a1..4fc14923e5a8 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1788,11 +1788,18 @@ static inline void i915_gem_drain_workqueue(struct drm_i915_private *i915)
 }
...
index 8066f167d6b9..52f2af31a7db 100644
...
index 4b325a670a04..5345ba10b64f 100644
--- a/drivers/gpu/drm/i915/i915_vma.h
+++ b/drivers/gpu/drm/i915/i915_vma.h
@@ -240,8 +240,17 @@ static inline void i915_vma_unlock(struct i915_vma *vma)
 }

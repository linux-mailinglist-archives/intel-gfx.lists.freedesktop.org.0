...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20D327BE9BD
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Oct 2023 20:38:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4073810E2C7;
	Mon,  9 Oct 2023 18:38:29 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915: More use of GT specific print
 helpers

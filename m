...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C00B57BA60
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 17:35:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4EDA08F4F8;
...
Subject: [Intel-gfx] [PATCH v4 37/41] nouveau: adapt NV_DEBUG,

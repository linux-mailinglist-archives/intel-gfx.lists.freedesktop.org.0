...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F8591030F
	for <lists+intel-gfx@lfdr.de>; Wed,  1 May 2019 01:06:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 30414891EB;
	Tue, 30 Apr 2019 23:06:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 604B4890BD
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.60,415,1549958400"; d="scan'208";a="320394800"
...
Date: Tue, 30 Apr 2019 16:06:06 -0700
Message-Id: <20190430230606.8421-7-stuart.summers@intel.com>
...
dC9pbnRlbF9lbmdpbmVfY3MuYwppbmRleCBmNzMwODQ3OWQ1MTEuLmU0MzhkMzY2ODc0ZiAxMDA2
NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZW5naW5lX2NzLmMKKysrIGIv
ZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZW5naW5lX2NzLmMKQEAgLTkwOCw3ICs5MDgs
...
IC05ODQsNiArOTg0LDcgQEAgdm9pZCBpbnRlbF9lbmdpbmVfZ2V0X2luc3Rkb25lKHN0cnVjdCBp
...
Y2U7CkBAIC0xMDAxLDcgKzEwMDIsOCBAQCB2b2lkIGludGVsX2VuZ2luZV9nZXRfaW5zdGRvbmUo
...
OTE1L2d0L2ludGVsX2VuZ2luZV90eXBlcy5oCmluZGV4IGQ5NzJjMzM5MzA5Yy4uZmE3MDUyODk2
M2E0IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9lbmdpbmVfdHlw
...
cy5jCmluZGV4IDU3NTE0NDZhNGIwYi4uNTFkZjg4ODczZmY1IDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9ndC9pbnRlbF93b3JrYXJvdW5kcy5jCisrKyBiL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2d0L2ludGVsX3dvcmthcm91bmRzLmMKQEAgLTc3MSw3ICs3NzEsNyBAQCB3YV9pbml0
...
ZWJ1Z2ZzLmMKaW5kZXggMjBhYzc4MmM1MGM4Li5hNDUyOTljZDY5ODkgMTAwNjQ0Ci0tLSBhL2Ry
aXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZGVidWdmcy5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9p
OTE1L2k5MTVfZGVidWdmcy5jCkBAIC0xMjU2LDYgKzEyNTYsNyBAQCBzdGF0aWMgdm9pZCBpOTE1
...
MSwxMSArMTI3MiwxMSBAQCBzdGF0aWMgdm9pZCBpOTE1X2luc3Rkb25lX2luZm8oc3RydWN0IGRy
...
IC00MDY1LDcgKzQwNjYsOSBAQCBzdGF0aWMgdm9pZCBnZW4xMF9zc2V1X2RldmljZV9zdGF0dXMo
...
X3N1YnNsaWNlczsgc3MrKykgewogCQkJdW5zaWduZWQgaW50IGV1X2NudDsKQEAgLTQxMTYsMTgg
KzQxMTksMjIgQEAgc3RhdGljIHZvaWQgZ2VuOV9zc2V1X2RldmljZV9zdGF0dXMoc3RydWN0IGRy
...
CiAJCQlldV9jbnQgPSAyICogaHdlaWdodDMyKGV1X3JlZ1syKnMgKyBzcy8yXSAmCkBAIC00MTQ0
LDI1ICs0MTUxLDI0IEBAIHN0YXRpYyB2b2lkIGdlbjlfc3NldV9kZXZpY2Vfc3RhdHVzKHN0cnVj
...
fQpAQCAtNDIwOSw2ICs0MjE1LDcgQEAgc3RhdGljIHZvaWQgaTkxNV9wcmludF9zc2V1X2luZm8o
...
dCB3YWtlcmVmOwogCkBAIC00MjE2LDE0ICs0MjIzLDEzIEBAIHN0YXRpYyBpbnQgaTkxNV9zc2V1
...

...

...

...


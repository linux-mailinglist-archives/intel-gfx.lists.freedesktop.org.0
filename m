...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 77211562F2F
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Jul 2022 10:55:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 706B810EFE2;
	Fri,  1 Jul 2022 08:55:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5A6D310EFE2;
 Fri,  1 Jul 2022 08:55:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656665754; x=1688201754;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=mXH6/aEN61Gh+F38QqKoNf9ADPqeQ8tDdw/54PdXxNc=;
 b=E97ZB7LTDhZnhjp3qTcD2vFZYn5rwnNdUaSBVC7RsXPqFhPJWkJsLEvR
 oVbuNRvHFlTbysZqhE22fmDd7N7INNRMfQNc/1XiX4DEAt0K2lgP+BPe4
 7/H90xG94MDWhgHOmlSQmj06+F4bbpFoDT7fdjP47CeZ3TuE6hiYp77TS
 dL6soRBJVyL2e7BdgK1BYLa4DsZEkJIWMNrazefkGZr5Hgf1tolCLapSg
 3+1cbt+vfbxmaExI6UjGeaF5/trk95yIpkcdCESThjbxLtvjdpdZJlDwO
 Q9vUxJGOJqb+bDBhaBw6EVDEwedqyD14vWefzxsFS0bhOWyDeJKn+blJq g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10394"; a="282630708"
X-IronPort-AV: E=Sophos;i="5.92,236,1650956400"; d="scan'208";a="282630708"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jul 2022 01:55:53 -0700
X-IronPort-AV: E=Sophos;i="5.92,236,1650956400"; d="scan'208";a="648265770"
Received: from bachaue1-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.33.184])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jul 2022 01:55:51 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  1 Jul 2022 11:55:38 +0300
Message-Id: <368510f2fe8ef8651c54b3512eb366da1fcef2b2.1656665533.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/2] drm/i915/edid: convert DP,

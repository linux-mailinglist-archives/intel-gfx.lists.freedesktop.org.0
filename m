...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4CD067BAA99
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Oct 2023 21:46:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB84310E499;
	Thu,  5 Oct 2023 19:46:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3214710E491
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=t6RDp2slYTUcn6Ktve9zymb+cRCAjgegDRjAfDrVj3Q=;
 b=VL8bEoAjXCpMYVD/gN2IG3EaaQeUZ0XI2hS1Ra4aAWDqQ5sheZE+mD5P
 EW1ht+LJFnz61uBk6NQpXz7AbJqcMOzgsS3qPrbW8xG7sS7jG5dnWQiBz
 Mbtpk1L2FQmc2LAN2dSjTWb5TcxnirfwADdbmXaMEHxP09RBBhzVG2vOn
 KJN3rCuHgwtD6u1sUpVNF5VhTmm18GTDvDOc/NfCRi/LaaPFSBcxiWZkL
 gYFo3vmBwDkMg2O5OEWi+vxL5Ck4DaV3ZMPjekG1/Slu9bVyEAwUbkfj6
 RT9VVQnAIzjK3VSHYv2e74uqDLM38MEo1rOtpqMw02kZYP+FfT15yihvM Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10854"; a="380875997"
X-IronPort-AV: E=Sophos;i="6.03,203,1694761200"; d="scan'208";a="380875997"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2023 12:46:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10854"; a="787107104"
X-IronPort-AV: E=Sophos;i="6.03,203,1694761200"; d="scan'208";a="787107104"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2023 12:46:18 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Oct 2023 12:35:33 -0700
Message-Id: <20231005193536.1463159-4-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 2/5] drm/i915: Define and use GuC and CTB TLB

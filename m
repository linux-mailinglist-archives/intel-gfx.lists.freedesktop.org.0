...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E89C927F3
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Aug 2019 17:07:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00D6A6E1B6;
...
Subject: Re: [Intel-gfx] [PATCH v14 13/33] drm/i915: Implement the HDCP2.2
 support for DP

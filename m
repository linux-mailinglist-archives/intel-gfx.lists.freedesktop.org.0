...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 738536A510F
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Feb 2023 03:22:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D93A10E4A1;
...
Subject: [Intel-gfx] [PATCH v6 1/8] drm/i915/pxp: Add GSC-CS back-end

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1C0B8D4C65
	for <lists+intel-gfx@lfdr.de>; Thu, 30 May 2024 15:19:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D950310F1C9;
	Thu, 30 May 2024 13:19:31 +0000 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A8246AB2C6
	for <lists+intel-gfx@lfdr.de>; Sun,  5 Mar 2023 23:11:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 417C010E04B;
...
Subject: [Intel-gfx] [PATCH v12 00/11] Add generic memory shrinker to

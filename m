...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 951B1668907
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 02:19:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5129210E975;
...
Subject: [Intel-gfx] [PATCH v5 6/6] drm/i915/pxp: Pxp hw init should be in
 resume_complete

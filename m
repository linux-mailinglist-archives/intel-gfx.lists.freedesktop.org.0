...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4819D5327FE
	for <lists+intel-gfx@lfdr.de>; Tue, 24 May 2022 12:40:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDFBA10F51E;
...
Subject: [Intel-gfx] [PATCH v1 09/13] drm/i915/edid: convert DP,

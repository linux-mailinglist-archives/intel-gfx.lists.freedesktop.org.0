...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3000A67A983
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 05:11:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59F7010E366;
	Wed, 25 Jan 2023 04:11:11 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v6 2/6] drm/i915/pxp: add device link

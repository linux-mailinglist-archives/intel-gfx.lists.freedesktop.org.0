...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 89EEB650FA4
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:05:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC3BC10E2B5;
...
Subject: [Intel-gfx] [PATCH 04/18] drm/i915: Do not set struct
 fb_info.apertures

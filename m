...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D14483D7E56
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jul 2021 21:17:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 902CE6E19A;
	Tue, 27 Jul 2021 19:17:00 +0000 (UTC)
...
> +					min_freq +=3D step) {
> +			err =3D set_min_freq(slpc, min_freq);
> +			if (err)
> +				break;
> +
...
> +					max_freq -=3D step) {
> +			err =3D set_max_freq(slpc, max_freq);
> +			if (err)
> +				break;
> +
> +			st_engine_heartbeat_disable(engine);
...
> +}
> diff --git a/drivers/gpu/drm/i915/gt/selftest_slpc.h b/drivers/gpu/drm/i9=
15/gt/selftest_slpc.h
> new file mode 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76946F2941
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2019 09:36:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9FCC56EF00;
	Thu,  7 Nov 2019 08:36:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x442.google.com (mail-wr1-x442.google.com
 [IPv6:2a00:1450:4864:20::442])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A7B716EF01
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 Nov 2019 08:36:11 +0000 (UTC)
Received: by mail-wr1-x442.google.com with SMTP id e6so2027897wrw.1
 for <intel-gfx@lists.freedesktop.org>; Thu, 07 Nov 2019 00:36:11 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:sender:date:from:to:cc:subject:message-id
 :references:mime-version:content-disposition:in-reply-to:user-agent;
 bh=HWIoT8goX9nWw4xqk3N22AuY4QSVAqESsGvxOoiE4Sg=;
 b=
X-Gm-Message-State: APjAAAWmQ9OMt1gZb9JYRdMCo2OliYE2lv2WsHgIeY5+Ixd9Pnu1Zz+r
 YunCHJof1nq6CGmrdxYMLRXGQA==
...
Subject: Re: [Intel-gfx] [PATCH v3 2/5] drm: Expose a method for creating

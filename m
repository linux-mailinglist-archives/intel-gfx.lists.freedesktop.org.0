...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A0D73493DCE
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jan 2022 16:58:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E86DB10E242;
	Wed, 19 Jan 2022 15:58:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EC32510E242
 for <intel-gfx@lists.freedesktop.org>; Wed, 19 Jan 2022 15:58:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642607917; x=1674143917;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=B4v1ILs3cwHuB7c9aIbNOF5J3PXj3gsTHCBR6G7h8oM=;
 b=l2VUTeRLtgOA0FyAhuQLA5DcBC6UIHENrXr60ayAfZ70mq7DKcnVzkx7
 nUIGjM1Au1wh1zQDdVFDjQlV6jk4VEiXuEbWP2ZSmDXSHTv/bcieiyRhJ
 tp8R9FscvwiOiIAkxD8Jfz63w9mxD4TLzhKTLMSJC1jW/Y7ykE/Xw+Nlt
 af3lnp/gPnC0mMmdss+cGeBxnn+GFzDsvw4Mn31CFhznLtFOyHcAXxZnR
 NtogeqOUHSODD4cShnUMxis6mmoQA4RsFO9LNT8WWBelpib8U7EN3N0dh
 BnXcv5R6IIyZGcOlxYXJZD4YrgcDISNEYtqGBp7RdvjGRYqzM6SVIseyA w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10231"; a="269489056"
X-IronPort-AV: E=Sophos;i="5.88,299,1635231600"; d="scan'208";a="269489056"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2022 07:58:37 -0800
X-IronPort-AV: E=Sophos;i="5.88,299,1635231600"; d="scan'208";a="477420136"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2022 07:58:33 -0800
...
Date: Wed, 19 Jan 2022 17:58:03 +0200
Message-Id: <20220119155807.222657-2-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/5] drm/i915/gsc: add gsc as a mei auxiliary
 device
...
index 000000000000..3fb1018dfe2d
--- /dev/null
...
index 4814453ab5ab..218c2bf2cc0f 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt.c
@@ -436,6 +436,8 @@ void intel_gt_chipset_flush(struct intel_gt *gt)
...
@@ -756,6 +758,7 @@ void intel_gt_driver_unregister(struct intel_gt *gt)
...
index 290dfd40c7b3..88da2e6f017b 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1496,6 +1496,14 @@ IS_SUBPLATFORM(const struct drm_i915_private *i915,
...
index 960c358990bc..51961b8456b2 100644
...
index 5e57652b7807..45dbe0b18832 100644
...
index 2a4e32b4ebfd..cb9bae0f2117 100644
--- a/drivers/gpu/drm/i915/intel_device_info.h
+++ b/drivers/gpu/drm/i915/intel_device_info.h
@@ -133,6 +133,8 @@ enum intel_ppgtt_type {

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44AD1991DA
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Aug 2019 13:15:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F68B6EADE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 2/6] drm: port definition is moved back into
 i915 header

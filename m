...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6B6A4AD783
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 12:37:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBD6A10E634;
	Tue,  8 Feb 2022 11:37:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1414410E327
 for <intel-gfx@lists.freedesktop.org>; Tue,  8 Feb 2022 11:37:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644320238; x=1675856238;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=pbcxeCln1EhllWEEnNb9VurLFSSRKcaOIn0YfYYqUDs=;
 b=CuAKXuBprAx3g74WhhKNvsFLOQUgWgH62o9n8rLVllBh2oZPnWyLKz2m
 LThlArSMMhBUNr5H6fOgfYJMFhdurv020fU/hGd22lFh6tJ9qjd05x1Qt
 9oywb0RUnNXgXxY6Zo9/aFXrMZ9hHUNegnSCfftTt70CSjxPzjMjmCDLO
 i/agzT8349h8tWS4b3NtxzHRbgashe+4/A8vpoSJv4Noivq/miLFikyn9
 g2wyCRcVMTDfIldfJ+WxvR6qx+JnNvnXDTdbIrF2zOq43aUTUk3nb/NoS
 7uqVxiT0cjoSgKnrgC2ZI7hSbRmP23CymvmIMMOdci7mwbd7j+x1FKgkg g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10251"; a="232495987"
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="232495987"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:17 -0800
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="481915303"
Received: from ideak-desk.fi.intel.com ([10.237.68.141])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:17 -0800
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  8 Feb 2022 13:36:44 +0200
Message-Id: <20220208113656.179823-15-imre.deak@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 14/26] drm/i915: Rename the power domain
...
index 354b08d6f81d0..a4784f98d7d37 100644
--- a/drivers/gpu/drm/i915/display/intel_ddi.c
+++ b/drivers/gpu/drm/i915/display/intel_ddi.c
@@ -4477,7 +4477,7 @@ void intel_ddi_init(struct drm_i915_private *dev_priv, enum port port)
 	}
...
index 7f512f9e9e5c7..e2f1e9415415e 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -2304,23 +2304,23 @@ enum intel_display_power_domain intel_port_to_power_domain(enum port port)
 {
 	switch (port) {
 	case PORT_A:
...
@@ -2333,22 +2333,22 @@ intel_aux_power_domain(struct intel_digital_port *dig_port)
...
index 769e620b191e1..a0db3dcecd006 100644
--- a/drivers/gpu/drm/i915/display/intel_display_power.c
+++ b/drivers/gpu/drm/i915/display/intel_display_power.c
@@ -41,14 +41,14 @@ intel_display_power_domain_str(enum intel_display_power_domain domain)
 		return "PIPE_C";
...
@@ -65,42 +65,42 @@ intel_display_power_domain_str(enum intel_display_power_domain domain)
...
@@ -133,20 +133,20 @@ intel_display_power_domain_str(enum intel_display_power_domain domain)
 		return "AUX_I";
...
index a3d48c47f0acd..1aa695387de5d 100644
...
index a098699d1c52c..df076816a92c3 100644

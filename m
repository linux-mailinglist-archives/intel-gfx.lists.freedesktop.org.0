...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E86C85AC764
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:47:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78E5E10E279;
	Sun,  4 Sep 2022 21:43:28 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 36/57] dyndbg: add write-events-to-tracefs
 code
...
Cc: Jim Cromie <jim.cromie@gmail.com>, daniel.vetter@ffwll.ch,
 vincent.whitchurch@axis.com, linux@rasmusvillemoes.dk, seanpaul@chromium.org,
 joe@perches.com

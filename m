...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B8F83B27A1
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EC806EA18;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/47] drm/i915/guc: Add bypass tasklet

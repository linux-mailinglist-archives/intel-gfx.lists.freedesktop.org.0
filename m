...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 013C785B208
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Feb 2024 05:58:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49A9710E0E6;
	Tue, 20 Feb 2024 04:58:20 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="duspgpXG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5ED9F10E12E
 for <intel-gfx@lists.freedesktop.org>; Tue, 20 Feb 2024 04:58:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1708405099; x=1739941099;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+xUgGKb0GB6RKvpKwe9Dls8mW9jDs9AgeJDMex1eJWA=;
 b=duspgpXGg3uRlXu9PmcMit7pw/JuTEuTQCkrFlu/sBL9e+2Wuhr8O0TW
 TVeSbTz5cfHttSZPwqfhXOERJ2g5K2OgaHFpQQ5Td1C2nGIR7Nj1eerZD
 ZDV8KXPvYYRG3p7Lnn5hLXhVeVFr+sZYxhi0Adm5oUtKV93tpg+KMWLrj
 jTXzKbp8AwPinasqSVBTTbVuK3Fo4JzjJAvgfwiZZRZKMa4VvBghl0ai+
 /LAEMiRCMDvu10lP6Fy3myujaNhsNQeJZi4ykMcNgMQBRmCTEAeNwldqt
 bKHb6O5Kbjl8R3rWFUYNb/D0vFA5X6cRPRT9/FuvOSfufUev/6hmq/auh g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10989"; a="2359118"
X-IronPort-AV: E=Sophos;i="6.06,171,1705392000"; 
   d="scan'208";a="2359118"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orvoesa112.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Feb 2024 20:58:19 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10989"; a="913007103"
X-IronPort-AV: E=Sophos;i="6.06,171,1705392000"; d="scan'208";a="913007103"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga002.fm.intel.com with ESMTP; 19 Feb 2024 20:58:17 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: uma.shankar@intel.com, ankit.k.nautiyal@intel.com,
 Suraj Kandpal <suraj.kandpal@intel.com>
Subject: [PATCH 12/13] drm/i915/hdcp: Allocate stream id after HDCP AKE stage
Date: Tue, 20 Feb 2024 10:26:00 +0530
Message-ID: <20240220045559.1516464-2-suraj.kandpal@intel.com>
X-Mailer: git-send-email 2.43.2
In-Reply-To: <20240215105919.1439549-13-suraj.kandpal@intel.com>
References: <20240215105919.1439549-13-suraj.kandpal@intel.com>
MIME-Version: 1.0

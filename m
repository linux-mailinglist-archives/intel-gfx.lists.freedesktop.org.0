...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0057890CD
	for <lists+intel-gfx@lfdr.de>; Sun, 11 Aug 2019 10:58:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 445256E2FD;
	Sun, 11 Aug 2019 08:58:35 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 1/4] dma-fence: Propagate errors to

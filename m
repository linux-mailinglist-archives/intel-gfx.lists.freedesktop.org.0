...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47017390AD6
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 22:58:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 792966E43D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/17] drm/i915/guc: enable only the user

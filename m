...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 408113DA067
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 11:39:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9939F6ED0A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH rdma-next v3 2/3] lib/scatterlist: Fix wrong

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 09ADC65D04A
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Jan 2023 11:06:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20B2D10E554;
...
Subject: [Intel-gfx] [PATCH v7 14/22] drm/edid: merge ELD handling to
 update_display_info()

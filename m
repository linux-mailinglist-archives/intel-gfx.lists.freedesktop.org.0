...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A5DCF14BFDC
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Jan 2020 19:30:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43F6A6F388;
	Tue, 28 Jan 2020 18:30:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E910E6F385;
 Tue, 28 Jan 2020 18:30:19 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga106.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 28 Jan 2020 10:30:19 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,374,1574150400"; 
 d="scan'208,217";a="310826512"
Received: from plaxmina-desktop.iind.intel.com ([10.145.162.62])
 by fmsmga001.fm.intel.com with ESMTP; 28 Jan 2020 10:30:15 -0800
...
Date: Tue, 28 Jan 2020 23:46:03 +0530
Message-Id: <20200128181603.27767-22-pankaj.laxminarayan.bharadiya@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 21/21] drm/i915/gvt: Make WARN* drm specific
...
index 11accd3e1023..b15db048df93 100644
...
@@ -340,7 +343,9 @@ static void update_upstream_irq(struct intel_vgpu *vgpu,
 		if (!up_irq_info)
...
@@ -350,7 +355,7 @@ static void update_upstream_irq(struct intel_vgpu *vgpu,
 			clear_bits |= (1 << bit);
 	}
...
@@ -618,13 +623,14 @@ static struct intel_gvt_irq_ops gen8_irq_ops = {

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8644C3FC272
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Aug 2021 08:14:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C59289B38;
...
Subject: [Intel-gfx] [PATCH v9 0/4] drm: update locking for modesetting

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED4655293EC
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:57:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6413310E6FF;
...
Subject: [Intel-gfx] [PATCH v2 01/27] dyndbg: fix static_branch manipulation

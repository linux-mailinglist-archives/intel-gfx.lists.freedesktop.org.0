...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4063B81B4FF
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Dec 2023 12:35:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF9AA10E34F;
	Thu, 21 Dec 2023 11:35:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 95C0A10E34D
 for <intel-gfx@lists.freedesktop.org>; Thu, 21 Dec 2023 11:35:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1703158517; x=1734694517;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=2z4WLjlbQy4KE5cNG4nnchNmSsTekMXfXRyE33iEycY=;
 b=kDf0nuQqVCU4Op2JGiPiMcf2Jt81xMa/xhpUny334ASwO6zI30J7udt4
 bGOaERIRmnsNCgouYZm+Gn33UKlKx8N7TOe49vtjTHs147tq5kAXIE+31
 uPIilI0gHIDCcqZqVDKRA/k7r8G3XycOxip5lnu2Qrz5JoL/t4hG3UlUc
 IHPpbkZd1Cx70oHxtMcJaA7AzTjIfa26oN20I2ruJOy+01379lmkj59Hr
 8tZ7zZa1M42mFiaOOJny4OQe2mc/kfaiZTrRg4dr8zFsDZMxycNopXJMn
 BjYQZNprNKjpqEE2nA3Qi4GdvQv1sLRotf3gX/88xj7KCtFYBGS/OF8J+ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10930"; a="394854259"
X-IronPort-AV: E=Sophos;i="6.04,293,1695711600"; d="scan'208";a="394854259"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Dec 2023 03:35:17 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10930"; a="842605954"
X-IronPort-AV: E=Sophos;i="6.04,293,1695711600"; d="scan'208";a="842605954"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by fmsmga008.fm.intel.com with ESMTP; 21 Dec 2023 03:35:15 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH v2 2/3] drm/i915/display: Store hw clock for C20
Date: Thu, 21 Dec 2023 13:28:42 +0200
Message-Id: <20231221112843.27519-3-mika.kahola@intel.com>

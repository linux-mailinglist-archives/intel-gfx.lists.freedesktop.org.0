...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34F9E47DD60
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Dec 2021 02:31:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6688B10E1D9;
...
Subject: [Intel-gfx] [PATCH] drm/i915/guc: Report error on invalid reset
 notification

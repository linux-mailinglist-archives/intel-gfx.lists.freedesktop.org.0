...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F8D6494762
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jan 2022 07:38:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9884010E661;
	Thu, 20 Jan 2022 06:38:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 474D310E691
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=PX4gyvRh3qU32wzFA4+Jsyd/94lOcsZWNTahXa3VnoE=;
 b=FtvOpJfXC0GJFluOVHMDygluY9snm+LWfslVHbkMwDHy1W6Gm/eOPF51
 98nXlFBIJIW165+wxKk5P3R4qLRGGA+JpN682IMqzFbxab7wjPCKVl0Up
 +dA9jvAlAQGDCQ0BmgXdIuB6qNtLLWVu+D2hfhZLIeOAaACE8oMPrJbZE
 xvgLg4mTn9Uk3I8x5HJ4WxVOpYRxiHdiodenX4ED8oNMj6rteFF4FqDts
 cJUbdmkfDaVZgjElMSzL++n8PZFNfS1O09O170dIbOD8CDxclhmipQpKv
 mtB/9eSctOmGPQb0siedeZE6pD0hVwUE+kA5IgEzJySxz3ELPbGOGvGHx w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10232"; a="232647499"
X-IronPort-AV: E=Sophos;i="5.88,301,1635231600"; d="scan'208";a="232647499"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2022 22:38:37 -0800
X-IronPort-AV: E=Sophos;i="5.88,301,1635231600"; d="scan'208";a="530898167"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2022 22:38:36 -0800
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 19 Jan 2022 22:38:05 -0800
Message-Id: <20220120063809.1020633-3-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/6] drm/i915/perf: Express OA register ranges
 with i915_range

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A3B5C7D6EC6
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Oct 2023 16:35:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C59F10E67C;
...
Subject: [Intel-gfx] [PATCH v2 3/5] drm/i915/guc: Use the new gt_to_guc()
 wrapper

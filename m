...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56AFB28F0EA
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Oct 2020 13:26:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A28756EC73;
	Thu, 15 Oct 2020 11:26:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0E2966EC6E
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Oct 2020 11:26:32 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 15 Oct 2020 13:25:28 +0200
Message-Id: <20201015112627.1142745-5-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 04/63] drm/i915: Pin timeline map after first
 timeline pin, v3.
...
index e96742d93ee6..8473d53a3b2a 100644
--- a/drivers/gpu/drm/i915/gt/intel_timeline.c
+++ b/drivers/gpu/drm/i915/gt/intel_timeline.c
@@ -51,13 +51,28 @@ static int __timeline_active(struct i915_active *active)
 	return 0;
 }
...
@@ -73,13 +88,8 @@ static int intel_timeline_init(struct intel_timeline *timeline,
 			return PTR_ERR(hwsp);
...
-
-	timeline->hwsp_map = vaddr;
-	timeline->hwsp_seqno = memset(vaddr + timeline->hwsp_offset, 0, CACHELINE_BYTES);
+	timeline->hwsp_map = NULL;
+	timeline->hwsp_seqno = (void *)(long)timeline->hwsp_offset;
 
 	GEM_BUG_ON(timeline->hwsp_offset >= hwsp->size);
 
@@ -110,7 +120,8 @@ static void intel_timeline_fini(struct intel_timeline *timeline)

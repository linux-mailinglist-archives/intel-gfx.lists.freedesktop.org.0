...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE8986F1E67
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 20:58:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A08110EDB8;
	Fri, 28 Apr 2023 18:58:34 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 8/8] drm/i915/huc: define HuC FW version for
 MTL

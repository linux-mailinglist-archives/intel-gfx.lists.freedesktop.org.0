...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE7D82F5F91
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jan 2021 12:14:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E72BD6E217;
	Thu, 14 Jan 2021 11:14:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6C9F96E217
 for <intel-gfx@lists.freedesktop.org>; Thu, 14 Jan 2021 11:14:21 +0000 (UTC)
IronPort-SDR: Y+kwdPMNqMihmHmwtl8530I9ysI/Wow/I6Y4pQtnClllkFQ8nidzBOu53A7w3VeD9aXfZtGa9B
 ENCGS2gaWdWw==
X-IronPort-AV: E=McAfee;i="6000,8403,9863"; a="263138920"
X-IronPort-AV: E=Sophos;i="5.79,347,1602572400"; d="scan'208";a="263138920"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jan 2021 03:14:20 -0800
IronPort-SDR: aitCrTaSYkXi9/1yvJMi+n3sDFMZx+3eW0mPTnTkiYMjCQy83tRDXWvrOpFM5ChHHGrr8k6pps
 dIUbL+MbUxow==
X-IronPort-AV: E=Sophos;i="5.79,347,1602572400"; d="scan'208";a="353864713"
Received: from dforourk-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.213.254.146])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jan 2021 03:14:16 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 14 Jan 2021 13:13:46 +0200
Message-Id: <74b58e0572858b5d1734818ca594a23040d7d44f.1610622609.git.jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <cover.1610622609.git.jani.nikula@intel.com>
References: <cover.1610622609.git.jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/11] drm/i915: refactor pll code out into
 intel_dpll.c
...
aTkxNS9NYWtlZmlsZQppbmRleCA0NGI0ZjA1MmRjMGIuLjI0NzlhYjJmZmIwOSAxMDA2NDQKLS0t
IGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvTWFrZWZpbGUKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvTWFrZWZpbGUKQEAgLTIwNiw2ICsyMDYsNyBAQCBpOTE1LXkgKz0gXAogCWRpc3BsYXkvaW50
...
aW5kZXggZGZlYzkxNzBkNjlkLi5mNGQ5Y2NhYWZjYjMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1
...
CQkgICAgZW51bSBwaXBlIHBpcGUpCiB7CkBAIC01MjM1LDcgKzQ0ODMsNyBAQCBzdGF0aWMgdm9p
...
CSAgIGNvbnN0IHN0cnVjdCBpbnRlbF9jcnRjX3N0YXRlICpjcnRjX3N0YXRlKQogewpAQCAtNzkw
Myw1MSArNzE1MSw2IEBAIHN0YXRpYyB2b2lkIGludGVsX3BhbmVsX3Nhbml0aXplX3NzYyhzdHJ1
...
diwgZW51bSBwaXBlCiAJCXBpcGUpCiB7CkBAIC04MDcyLDM5ICs3Mjc1LDYgQEAgdm9pZCBpbnRl
...
aXBlX2NvbmZpZykKIHsKQEAgLTgzNjQsMTI4ICs3NTM0LDcgQEAgdm9pZCB2bHZfZm9yY2VfcGxs
...
dGNfc3RhdGUtPmRwbGw7Ci0KLQlpOXh4X3VwZGF0ZV9wbGxfZGl2aWRlcnMoY3J0YywgY3J0Y19z
...
cGxsID0gRFBMTF9WR0FfTU9ERV9ESVM7CiAKLQlpZiAoaW50ZWxfY3J0Y19oYXNfdHlwZShjcnRj
...
dGF0ZSkKIHsKQEAgLTg2OTEsMjA3ICs3NzQwLDYgQEAgc3RhdGljIHZvaWQgaTl4eF9zZXRfcGlw
...
X3ByaXZhdGUgKmRldl9wcml2KQogewpAQCAtOTkwMiwxNzIgKzg3NTAsNiBAQCBpbnQgaWxrX2dl
...
Y3J0YywKIAkJCQkJIHN0cnVjdCBpbnRlbF9saW5rX21fbiAqbV9uKQogewpAQCAtMTA0ODAsMjkg
KzkxNjIsNiBAQCBzdGF0aWMgYm9vbCBpbGtfZ2V0X3BpcGVfY29uZmlnKHN0cnVjdCBpbnRlbF9j
...
YXRlICpwaXBlX2NvbmZpZykKIHsKQEAgLTE2NDM3LDY5ICsxNTA5NiwyNyBAQCB2b2lkIGludGVs
...
Ci0JfSBlbHNlIGlmIChJU19DSEVSUllWSUVXKGRldl9wcml2KSkgewotCQlkZXZfcHJpdi0+ZGlz
...

...
Y2s7CiAJCWRldl9wcml2LT5kaXNwbGF5LmNydGNfZW5hYmxlID0gdmFsbGV5dmlld19jcnRjX2Vu
YWJsZTsKIAkJZGV2X3ByaXYtPmRpc3BsYXkuY3J0Y19kaXNhYmxlID0gaTl4eF9jcnRjX2Rpc2Fi
...
ZGlzYWJsZSA9IGk5eHhfY3J0Y19kaXNhYmxlOwogCX0KQEAgLTE2NTEzLDEwICsxNTEzMCwxMyBA
...

...
aW5kZXggNTg1YmIxZWRlYTA0Li5lZDEyOWY4MDVhMjEgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGlzcGxheV90eXBlcy5oCisrKyBiL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGlzcGxheV90eXBlcy5oCkBAIC0xODM5LDQgKzE4Mzks
...
X3N0YXRlICpwaXBlX2NvbmZpZyk7CisKKyNlbmRpZgotLSAKMi4yMC4xCgpfX19fX19fX19fX19f

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 926A6285BFF
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Oct 2020 11:45:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A0B506E2A3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/jsl: Split EHL/JSL platform info and
 PCI ids

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FD2C4F9C36
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Apr 2022 20:03:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD53B10E78A;
...
Subject: [Intel-gfx] [PATCH 1/3] drm/i915/guc: Update context registration
 to new GuC API

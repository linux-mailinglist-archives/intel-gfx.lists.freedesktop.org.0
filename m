...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E87440CAB6
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 18:41:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E16C6E9AE;
...
Subject: [Intel-gfx] [PATCH v8 08/16] dyndbg: add
 DEFINE_DYNAMIC_DEBUG_CATEGORIES bitmap and callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 49BD92AC5C3
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Nov 2020 21:10:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4645289350;
	Mon,  9 Nov 2020 20:10:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CD2B389338
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Nov 2020 20:10:37 +0000 (UTC)
IronPort-SDR: XiLfn3Cy3phl67DsAHTUq8kfoApBRPD5fTLDiiqhr7DhTs+HHeRF/jAEvehxXk6YmXPZVkmUXr
 XQFvzfLXpDSg==
X-IronPort-AV: E=McAfee;i="6000,8403,9800"; a="157647100"
X-IronPort-AV: E=Sophos;i="5.77,464,1596524400"; d="scan'208";a="157647100"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Nov 2020 12:10:37 -0800
IronPort-SDR: cjl3oOYT4wJaYmDLziIDGQmLzV4Pgvp6DTnROhcDFQZbfaoq2tRx+eosXIDX5caG1WtIdoQBNu
 qD7XZywaCieQ==
X-IronPort-AV: E=Sophos;i="5.77,464,1596524400"; d="scan'208";a="355830360"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 09 Nov 2020 12:10:37 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  9 Nov 2020 12:12:44 -0800
Message-Id: <20201109201246.17117-5-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 5/7] drm/i915: Pass intel_atomic_state
...

...
bmNvZGVyKQogewpAQCAtMTI2OTQsNyArMTI2OTQsNyBAQCBzdGF0aWMgYm9vbCBjaGVja19zaW5n
...
ZS0+Y3J0YyAhPSAmY3J0Yy0+YmFzZSkKIAkJCWNvbnRpbnVlOwogCkBAIC0xMzQ3MywxMyArMTM0
NzMsMTUgQEAgc3RhdGljIGJvb2wgY2hlY2tfZGlnaXRhbF9wb3J0X2NvbmZsaWN0cyhzdHJ1Y3Qg
...
aXZlID0gY3J0Y19zdGF0ZS0+dWFwaS5hY3RpdmU7CkBAIC0xMzQ4Nyw3ICsxMzQ4OSw3IEBAIGlu
...
YXRlKHN0cnVjdCBpbnRlbF9jcnRjX3N0YXRlICpjcnRjX3N0YXRlKQpAQCAtMTM1MTAsNyArMTM1
MTIsOCBAQCBzdGF0aWMgdm9pZCBpbnRlbF9jcnRjX2NvcHlfaHdfdG9fdWFwaV9zdGF0ZShzdHJ1
...
OTE1KGNydGMtPmJhc2UuZGV2KTsKQEAgLTEzNTQyLDE2ICsxMzU0NSwxNiBAQCBpbnRlbF9jcnRj
...
b3Jfc3RhdGUgKmNvbm5lY3Rvcl9zdGF0ZTsKQEAgLTEzNTkzLDcgKzEzNTk2LDcgQEAgaW50ZWxf
...
ZGVyKGNvbm5lY3Rvcl9zdGF0ZS0+YmVzdF9lbmNvZGVyKTsKIApAQCAtMTM2MzEsNyArMTM2MzQs
...
ZWN0b3JfaW5fc3RhdGUoJnN0YXRlLT5iYXNlLCBjb25uZWN0b3IsIGNvbm5lY3Rvcl9zdGF0ZSwg
aSkgewogCQlzdHJ1Y3QgaW50ZWxfZW5jb2RlciAqZW5jb2RlciA9CiAJCQl0b19pbnRlbF9lbmNv
ZGVyKGNvbm5lY3Rvcl9zdGF0ZS0+YmVzdF9lbmNvZGVyKTsKIApAQCAtMTUyNDcsMTkgKzE1MjUw

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4CD0167B44F
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 15:25:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B2DA310E7CE;
	Wed, 25 Jan 2023 14:25:08 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 4/4] drm/amdgpu: Support allocate of

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D12891993BA
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2020 12:42:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 130BB6E7E6;
	Tue, 31 Mar 2020 10:42:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 825386E7DA
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Mar 2020 10:42:14 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 31 Mar 2020 12:41:59 +0200
Message-Id: <20200331104209.432176-13-maarten.lankhorst@linux.intel.com>
...
index c873ae2b97e4..55d1ce7ed2ed 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3090,7 +3090,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3452,7 +3453,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}

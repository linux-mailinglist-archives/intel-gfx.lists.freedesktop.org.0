...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A420F993FE
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Aug 2019 14:40:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F33A6E45C;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] Merge in the drm-intel tree

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FA6C84F364
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Feb 2024 11:25:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C95C810F314;
	Fri,  9 Feb 2024 10:25:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="b9SDadBI";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-oo1-f50.google.com (mail-oo1-f50.google.com
 [209.85.161.50])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1699A10EF22;
 Tue,  6 Feb 2024 19:44:22 +0000 (UTC)
Received: by mail-oo1-f50.google.com with SMTP id
 006d021491bc7-59505514213so492702eaf.0; 
 Tue, 06 Feb 2024 11:44:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1707248661; x=1707853461; darn=lists.freedesktop.org;
 h=cc:to:subject:message-id:date:from:in-reply-to:references
 :mime-version:from:to:cc:subject:date:message-id:reply-to;
 bh=oB9kLooiOl4Pvgl95VtNGFMxurGhBgbmYJJ1jlPtk8c=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :reply-to;
 bh=oB9kLooiOl4Pvgl95VtNGFMxurGhBgbmYJJ1jlPtk8c=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCU+oPhmuzlw/YStwI8ONd82hdyKwgGLfgTHNFAvI2G5BkN2SXOZln/lZzG0bmsrVASjQWzRLuKy16WrZqx31JNJyrCStwlzoldpP9epMU9FW5c+YCrGtyCXJaR5OzKFRLBjTb/edZ+O7IMUE0LCAre7J1dEFoE7rmDiKJ2iDLz+xdnGt7AGEh6gm326zBfxW4Q0XzbXiQ==
X-Gm-Message-State: AOJu0YxCZdof68OVPyev3QrsEzYgigqaF6bunS7XbPcRU8W4LkJqb0N5
 SxVpmQ4FO1vx17i3K9aVFvAWAV3+1auM0IwuQbFHzasJsYpBWCedpUeA/2PAMgN8gyJ3hLPZb5l
 08kfngDDgeVn26VQtYGi91sNOP7k=

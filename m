...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 29159872235
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Mar 2024 15:59:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D623112B8F;
	Tue,  5 Mar 2024 14:59:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="EfW+8DfX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 66D60112B8F;
 Tue,  5 Mar 2024 14:59:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709650781; x=1741186781;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to;
 bh=9tBBkFpt85yb0R8tCrgfYVjVoVGjOTgKm3SZ8Mq4APA=;
 b=EfW+8DfXLLj/3YFQPvlE1LTeQp7oeLNnZMBWrx7+gywS4dysIF14KUNf
 Y2vBu/0HsiTMByOiEiEqpJ6tWYVK72CORE4s7nN7dJfpHpwnC94KHuLuE
 asZnFNL0SGIHj/YPft1XKUHq4enIWMZUiBYYWbTy/F5NzwBzP0FSFAxuQ
 OVS1/+hzSVtwLQaY3k60NyEchI2EygDnMq6oTpi95kYVqm0pzWXpKTywl
 lezxhG8rLEXJW5WXfXGbDkhGM2eTGqj2EM0rxIzSY5//EzUsTugzR4yB1
 TtJueqfNSrPrHq8fmAlXzrKVFlgC8ePovG9PuBzxw5CqYuqIkIjex4tgH Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11003"; a="7150009"
X-IronPort-AV: E=Sophos;i="6.06,205,1705392000"; d="scan'208,217";a="7150009"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Mar 2024 06:59:40 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,205,1705392000"; d="scan'208,217";a="9345749"
Received: from nirmoyda-mobl.ger.corp.intel.com (HELO [10.246.48.164])
 ([10.246.48.164])
 by fmviesa010-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Mar 2024 06:59:37 -0800
Content-Type: multipart/alternative;
 boundary="------------1Rd7COSv44o1oIHUA9aFILXI"
Message-ID: <1d952215-d88c-46d2-8c1b-b7293797baaa@linux.intel.com>
Date: Tue, 5 Mar 2024 15:59:36 +0100
MIME-Version: 1.0
User-Agent: Mozilla Thunderbird
Subject: Re: [PATCH v7 1/3] drm/i915/vma: Fix UAF on destroy against retire
 race
...
References: <20240305143747.335367-5-janusz.krzysztofik@linux.intel.com>
 <20240305143747.335367-6-janusz.krzysztofik@linux.intel.com>
From: Nirmoy Das <nirmoy.das@linux.intel.com>
In-Reply-To: <20240305143747.335367-6-janusz.krzysztofik@linux.intel.com>
...
cite="mid:20240305143747.335367-6-janusz.krzysztofik@linux.intel.com">
      <pre class="moz-quote-pre" wrap="">Object debugging tools were sporadically reporting illegal attempts to
free a still active i915 VMA object when parking a GT believed to be idle.
...
Fixes: d93939730347 ("drm/i915: Remove the vma refcount")
Closes: <a class="moz-txt-link-freetext" href="https://gitlab.freedesktop.org/drm/intel/issues/8875">https://gitlab.freedesktop.org/drm/intel/issues/8875</a>
...
Cc: <a class="moz-txt-link-abbreviated" href="mailto:stable@vger.kernel.org">stable@vger.kernel.org</a> # v5.19+</pre>
    </blockquote>
    <br>

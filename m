...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F5291C8C51
	for <lists+intel-gfx@lfdr.de>; Thu,  7 May 2020 15:27:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A2966E9A3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 12/14] drm/i915: Stop sending DP SDPs on ddi
 disable

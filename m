...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E2D194C742A
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Feb 2022 18:43:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79F5F10E57B;
...
Subject: [Intel-gfx] [PATCH v2 05/13] drm/i915/xehp: CCS should use RCS
 setup functions

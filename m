...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E27F839FE02
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Jun 2021 19:43:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFF916E819;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 5/7] drm/uAPI: Add "active color format" drm

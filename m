...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DAF491A0CF5
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Apr 2020 13:35:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C2576E83E;
	Tue,  7 Apr 2020 11:35:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x342.google.com (mail-wm1-x342.google.com
 [IPv6:2a00:1450:4864:20::342])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 617C66E83D
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Apr 2020 11:35:22 +0000 (UTC)
Received: by mail-wm1-x342.google.com with SMTP id j19so1465137wmi.2
 for <intel-gfx@lists.freedesktop.org>; Tue, 07 Apr 2020 04:35:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:date:to:cc:subject:in-reply-to:message-id:references
 :user-agent:mime-version;
 bh=JKGJETs5SqhXY4OOU77Q+NvRuK3w4ko6pZNa1qiDQ0k=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=JKGJETs5SqhXY4OOU77Q+NvRuK3w4ko6pZNa1qiDQ0k=;
 b=
X-Gm-Message-State: AGi0PuYwf8WXe7ykLPmtQQN+k0yk1e/OkIcXDZVmaFDEq4bf8BgMLLPq
 wrCeoHTK4Tq8S8FpqgoyH4k=
X-Google-Smtp-Source: APiQypLXFKt9e79x7TfhEi8wbqsPhvsY2/X5xvh9SiGMCcF5yK6huyeOdf47SVyEXhoO6oMngHtGLA==
X-Received: by 2002:a7b:c343:: with SMTP id l3mr2043424wmj.38.1586259320321;
 Tue, 07 Apr 2020 04:35:20 -0700 (PDT)
Received: from wambui.local ([197.237.61.225])
 by smtp.googlemail.com with ESMTPSA id p5sm32409971wrg.49.2020.04.07.04.35.05
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 07 Apr 2020 04:35:19 -0700 (PDT)
From: Wambui Karuga <wambui.karugax@gmail.com>
X-Google-Original-From: Wambui Karuga <wambui@wambui>
Date: Tue, 7 Apr 2020 14:35:02 +0300 (EAT)
To: Jani Nikula <jani.nikula@intel.com>
In-Reply-To: <20200402114819.17232-4-jani.nikula@intel.com>
Message-ID: <alpine.LNX.2.21.99999.375.2004071432110.77089@wambui>

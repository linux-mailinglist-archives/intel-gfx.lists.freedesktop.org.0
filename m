...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E87B4409B75
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Sep 2021 19:58:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8AA336ECE6;
	Mon, 13 Sep 2021 17:58:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qv1-xf2c.google.com (mail-qv1-xf2c.google.com
 [IPv6:2607:f8b0:4864:20::f2c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 01FE26ECE5
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Sep 2021 17:58:27 +0000 (UTC)
Received: by mail-qv1-xf2c.google.com with SMTP id a12so6598539qvz.4
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Sep 2021 10:58:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=6Bx1ceBGj7SuoGdIFCm/5Y8BFZMbAYnZXo7glWE+lwg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=6Bx1ceBGj7SuoGdIFCm/5Y8BFZMbAYnZXo7glWE+lwg=;
 b=
X-Gm-Message-State: AOAM532GTwsb5+tSUmq3c1CyUYCuzkKN1H05shsDCwNQhgKGj7Bb83gW
 c9onXiNvdXUkmTRYD/w0SHHZlMk3IXRs8Q==
X-Google-Smtp-Source: ABdhPJwbz3ZmK2OafBuwU9zS6fcviPAnKfKdng2p3PFBRWCpOkGyg1VfzwJyPP9GNTlroNk+TWaytw==
X-Received: by 2002:a05:6214:d8a:: with SMTP id
 e10mr789167qve.52.1631555906770; 
 Mon, 13 Sep 2021 10:58:26 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id 69sm6111072qke.55.2021.09.13.10.58.26
...
Date: Mon, 13 Sep 2021 13:57:38 -0400
Message-Id: <20210913175747.47456-8-sean@poorly.run>
X-Mailer: git-send-email 2.31.0
In-Reply-To: <20210913175747.47456-1-sean@poorly.run>
References: <20210913175747.47456-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 07/14] drm/i915/hdcp: Use HDCP helpers for i915
...
index 540a669e01dd..e2aec4ed92c0 100644
...
+			          struct intel_connector *connector)
 {
 	...
 	int ret;
@@ -778,45 +629,83 @@ int intel_dp_mst_hdcp2_check_link(struct intel_digital_port *dig_port,
 }
...
+		ret = intel_hdcp_init(connector, dig_port,
+				      &intel_dp_mst_hdcp_shim);
+	else
+		ret = intel_hdcp_init(connector, dig_port,
+				      &intel_dp_hdcp_shim);

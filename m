...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DAB361ADE7D
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 15:39:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 050046EBF9;
	Fri, 17 Apr 2020 13:39:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 32D736EBEC
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Apr 2020 13:39:44 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 17 Apr 2020 15:39:22 +0200
Message-Id: <20200417133937.1980239-9-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/24] drm/i915: Use ww locking in
 intel_renderstate.
...
index 342a9558751c..b5f216bb266d 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt.c
@@ -408,21 +408,20 @@ static int __engines_record_defaults(struct intel_gt *gt)
...
@@ -436,9 +435,13 @@ static int __engines_record_defaults(struct intel_gt *gt)
 err_rq:
...
@@ -238,16 +259,24 @@ int intel_renderstate_emit(struct intel_renderstate *so,
 			return err;
 	}

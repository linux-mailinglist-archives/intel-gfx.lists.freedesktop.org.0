...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7437C2C249D
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Nov 2020 12:39:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8545C6E439;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/15] drm/hibmc: Remove references to struct
 drm_device.pdev

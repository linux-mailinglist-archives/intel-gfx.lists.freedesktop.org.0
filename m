...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 272AE42CCCC
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 23:26:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8ED6F6E118;
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/i915/dp: use new link training
 delay helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5901D3D037E
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 22:57:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9CBFF6E566;
	Tue, 20 Jul 2021 20:57:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6F9DD6E542
 for <intel-gfx@lists.freedesktop.org>; Tue, 20 Jul 2021 20:57:44 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10051"; a="208209894"
X-IronPort-AV: E=Sophos;i="5.84,256,1620716400"; d="scan'208";a="208209894"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2021 13:57:43 -0700
X-IronPort-AV: E=Sophos;i="5.84,256,1620716400"; d="scan'208";a="432304496"
...
Message-ID: <20210720205729.GB32707@msatwood-mobl>
References: <20210714031540.3539704-1-matthew.d.roper@intel.com>
 <20210714031540.3539704-10-matthew.d.roper@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20210714031540.3539704-10-matthew.d.roper@intel.com>
Subject: Re: [Intel-gfx] [PATCH v2 09/50] drm/i915/xehp: Xe_HP forcewake
 support
...
On Tue, Jul 13, 2021 at 08:14:59PM -0700, Matt Roper wrote:
...
> index 56e25090da67..cf1ac0010056 100644
> --- a/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
> +++ b/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
> @@ -3306,6 +3306,10 @@ int intel_execlists_submission_setup(struct intel_engine_cs *engine)

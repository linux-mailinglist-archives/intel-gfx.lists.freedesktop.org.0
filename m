...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 890F3757F1D
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 16:13:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0441310E34A;
...
Subject: Re: [Intel-gfx] [PATCH v5 7/9] drm/i915/gt: Ensure memory quiesced

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BBD97720195
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Jun 2023 14:17:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E837510E68B;
...
Subject: [Intel-gfx] [PATCH v12 13/24] vfio-iommufd: Add detach_ioas support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36297495452
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jan 2022 19:42:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E623F10ECFA;
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/guc: Print CT descriptor status in
 CT debug function

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB83B4FC20F
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 18:16:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3ED6910E241;
...
Subject: Re: [Intel-gfx] [PATCH 13/34] drm/i915/gvt: devirtualize ->{read,
 write}_gpa

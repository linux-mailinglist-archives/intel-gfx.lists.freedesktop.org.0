...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 631904F387A
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 16:34:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29A6810E70A;
	Tue,  5 Apr 2022 14:34:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8538910E6F5;
 Tue,  5 Apr 2022 14:34:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1649169253; x=1680705253;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=b0JQ8nwkBzNoQ8uotPUYMhFyJhn8jMd8eYx0G5tzSRA=;
 b=GzOyR4Sq607gj2x1hG3+jX/x6bKgTd4EfagjBcFEaaWT4wzOoljPGnf2
 zJWOXYR1bs407gDcxPkbHCj9H6yRrCSUA+IScYWqm9f2hp1gkWAuCSRP4
 Js05ybbCqXk/jvy0XydEQjUOjh/HlG4YWOrU2XGw/URZ5cz47iz5QlaYu
 7qv4/vh/lTCj1q/HsFpUWfwca7JYjX/Ea+KVUm3SlKdy+0x2b5L5EdALV
 3ipDktYLqGYIb/Jjh0HnJilsjbFp9pCVVkA5sb7nrd4KZuhhdNlAsiOOo
 boLz6WdJliCe4yUXacdwzZWF03DiQe2Q+qvZuMk771MHqCzRdTkWfWv5Q Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10307"; a="285722176"
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="285722176"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Apr 2022 07:34:13 -0700
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="657958974"
Received: from ramaling-i9x.iind.intel.com ([10.203.144.108])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Apr 2022 07:34:12 -0700
From: Ramalingam C <ramalingam.c@intel.com>
To: intel-gfx <intel-gfx@lists.freedesktop.org>,
 dri-devel <dri-devel@lists.freedesktop.org>
Date: Tue,  5 Apr 2022 20:04:47 +0530
Message-Id: <20220405143454.16358-3-ramalingam.c@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 2/9] drm/i915/gt: Use XY_FAST_COLOR_BLT to
 clear obj on graphics ver 12+

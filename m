...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 46C646A5842
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Feb 2023 12:34:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 256FC10E21C;
	Tue, 28 Feb 2023 11:33:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-lf1-x134.google.com (mail-lf1-x134.google.com
 [IPv6:2a00:1450:4864:20::134])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D654E10E054
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Feb 2023 11:33:47 +0000 (UTC)
Received: by mail-lf1-x134.google.com with SMTP id f41so12665921lfv.13
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Feb 2023 03:33:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=+SoOUZGrrkQV0/Yn0M35SOcEWBgYqFXAu2T1EYXAc6A=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=+SoOUZGrrkQV0/Yn0M35SOcEWBgYqFXAu2T1EYXAc6A=;
 b=
X-Gm-Message-State: AO0yUKUjQg2n6Mt6mEmlZByPUlnWtQ+zJ0hJM4gUz1+XuVs8XjhhksDW
 WMsRzBnPL2+tryD5PExj8n5DNg==
X-Google-Smtp-Source: AK7set+cysoY9TlB7yzceWiTrfOoWDak7UekzL6xEjmeBDJHdUjwnlm+VMiVMBIKOK7tVbaARMnrww==
X-Received: by 2002:a05:6512:3ba6:b0:4d8:86c1:477b with SMTP id
 g38-20020a0565123ba600b004d886c1477bmr4350776lfv.16.1677584026006; 
 Tue, 28 Feb 2023 03:33:46 -0800 (PST)
Received: from eriador.lan (dzccz6yyyyyyyyyyybcwt-3.rev.dnainternet.fi.
 [2001:14ba:a085:4d00::8a5]) by smtp.gmail.com with ESMTPSA id
 h20-20020ac25974000000b004dd0bbc89a1sm1288472lfp.244.2023.02.28.03.33.45
...
Date: Tue, 28 Feb 2023 13:33:35 +0200
Message-Id: <20230228113342.2051425-4-dmitry.baryshkov@linaro.org>
...
Subject: [Intel-gfx] [PATCH 03/10] drm/i915/dsc: move DSC tables to DRM DSC
 helper

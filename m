...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 832DC4A5AEA
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Feb 2022 12:10:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5083B10E3DC;
	Tue,  1 Feb 2022 11:10:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3695B10E3CC
 for <intel-gfx@lists.freedesktop.org>; Tue,  1 Feb 2022 11:10:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643713825; x=1675249825;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=ngQR8dh6hyRRe3D4eqakOJastijvZPiNQ8NzUFkcGos=;
 b=isgrmnNAChZWlvqiZydypkH1gntUX83m+2XL4uoZ0H15tBGZtXLBD/7I
 9eM2sibUPxMJo5bCP9gsSY2Oflzr+IoCsL5x8a+gMuPAslIJLbBJUW3dL
 Cer4asuK42KgkR4Q2mzIqGgOAOTl38WZ9pTdWe18hCRy7xhL6Ay55g8Bs
 +mcsDMeigoQasg8VI32yu7Dn2R2F7GvKv2EejGSS44kJfgpqwV0rr0FsQ
 JhwDLLsO5Rjq1v/GojuxDsD7RZ3hx9RgRCF2/QP3exprN67BZdL6ezDQB
 MziQG22CTjQMrgfgVS0kEd5SHCQGAwKpgByQvFM37YI1JPdE/ZUfsQSIm A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10244"; a="231240017"
X-IronPort-AV: E=Sophos;i="5.88,333,1635231600"; d="scan'208";a="231240017"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2022 03:10:24 -0800
X-IronPort-AV: E=Sophos;i="5.88,333,1635231600"; d="scan'208";a="565560056"
Received: from ehanosko-mobl.ger.corp.intel.com (HELO localhost) ([10.252.6.3])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2022 03:10:21 -0800
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>, intel-gfx@lists.freedesktop.org
In-Reply-To: <20220128114914.2339526-10-imre.deak@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20220128114914.2339526-1-imre.deak@intel.com>
 <20220128114914.2339526-10-imre.deak@intel.com>
Date: Tue, 01 Feb 2022 13:10:18 +0200
Message-ID: <87fsp2vo4l.fsf@intel.com>
MIME-Version: 1.0

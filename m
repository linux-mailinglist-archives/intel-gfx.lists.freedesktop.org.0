...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7932042C86A
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 20:12:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 989EB6E105;
	Wed, 13 Oct 2021 18:12:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x82d.google.com (mail-qt1-x82d.google.com
 [IPv6:2607:f8b0:4864:20::82d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3FE7689EEB
 for <intel-gfx@lists.freedesktop.org>; Wed, 13 Oct 2021 18:12:41 +0000 (UTC)
Received: by mail-qt1-x82d.google.com with SMTP id w2so3488576qtn.0
 for <intel-gfx@lists.freedesktop.org>; Wed, 13 Oct 2021 11:12:41 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=d6D5/IzB04/sRINqDPyMaeFU8sU1rQ5pGr4cDho+SKQ=;
 b=
X-Gm-Message-State: AOAM530pEbZYHzJjR2p8ny/eXIp8IKnAOcAMwa1b8DuFmuQpLuvNXb+n
 E8gU1S4+EX8JctdezdgvthlIaw==
...
Subject: [Intel-gfx] [PATCH 1/2] drm: Add Gamma and Degamma LUT sizes props
 to drm_crtc to validate.

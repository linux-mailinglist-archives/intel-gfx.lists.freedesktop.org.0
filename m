...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 670B9428141
	for <lists+intel-gfx@lfdr.de>; Sun, 10 Oct 2021 14:34:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 15B2E6E2F2;
...
Subject: [Intel-gfx] [PATCH v3 3/5] drm/i915/panelreplay: Initializaton and

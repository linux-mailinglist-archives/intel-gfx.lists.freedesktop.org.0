...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 67B332DE924
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Dec 2020 19:46:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 65EEB89DD3;
	Fri, 18 Dec 2020 18:46:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 184B589DD5
 for <intel-gfx@lists.freedesktop.org>; Fri, 18 Dec 2020 18:46:51 +0000 (UTC)
IronPort-SDR: sji7TnVgYGejkQcuwmRLuQOWIpOcnVKX2Osh/SmDpn1Hjk/0dJvJNsZO4vyfvt0R98dUvwg/Zv
 MsWIR3nwqedA==
X-IronPort-AV: E=McAfee;i="6000,8403,9839"; a="172919179"
X-IronPort-AV: E=Sophos;i="5.78,431,1599548400"; d="scan'208";a="172919179"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Dec 2020 10:46:50 -0800
IronPort-SDR: x0hOYMlPAn6JJwaqV3rZQBuZMyy7CUnLHxVMA0QQZMRLl/M9DTsXrPGGqGeGZAJps3cXqQySkq
 J3tvpdWp8ybw==
X-IronPort-AV: E=Sophos;i="5.78,431,1599548400"; d="scan'208";a="343429161"
Received: from svasud1x-mobl3.amr.corp.intel.com (HELO
 josouza-mobl2.intel.com) ([10.254.182.238])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Dec 2020 10:46:49 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 18 Dec 2020 10:46:59 -0800
Message-Id: <20201218184701.111857-3-jose.souza@intel.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <20201218184701.111857-1-jose.souza@intel.com>
References: <20201218184701.111857-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 3/5] drm/i915/display: Split and export main

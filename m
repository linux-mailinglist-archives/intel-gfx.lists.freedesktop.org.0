...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B9AAB9D162
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Aug 2019 16:09:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00F086E08A;
	Mon, 26 Aug 2019 14:09:30 +0000 (UTC)
...
X-Mailman-Original-Authentication-Results: spf=none (sender IP is
 ...
 header.from=amd.com;
Subject: [Intel-gfx] [PATCH v6 1/6] drm/dp_mst: Add PBN calculation for DSC
 modes

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 67897A5CD04
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Mar 2025 19:01:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E8AE210E65B;
	Tue, 11 Mar 2025 18:01:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="WyAFZC6s";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3556910E657;
 Tue, 11 Mar 2025 18:01:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1741716084; x=1773252084;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=sMzAqgpk0n4+8swd0pFaUij3lMcFDqgiN/gJImLEiQE=;
 b=WyAFZC6syMnEb0uWrhpaxXl/wC1V9otL1nftUQZ1aa6DZTnwO9YWeRFZ
 SSnL0ZH0BuowewIDXLm1mERXxhP+A2UvfwTF4KFp5HSBgJZBuZzCN2urW
 lD3Y+8Nttq2QOE8++Ogt79kzHGNixlTm3A8FRN2kVyYyPrnEqYqdcEOC3
 UQZEwSCBIEDbeOsf0+OQx+EPRm1TGs2KqJs2UPkEV9vm36CK0fBE0NndI
 SFUZD7kqFZeGDiaLcvjKdKdeo/oP664+IpmrVqcm0K0oDqEMV/jUEVTXz
 YxpwjAjTm09LxQm8XcUrRj84575pRCzkhGlm0qyWiyOwNpYhuc4FhEPdp g==;
X-CSE-ConnectionGUID: RsWbsD0gTfKdcUfO9KscEA==
X-CSE-MsgGUID: /dQ0pHQwQCCoMWBRmb0yWg==
X-IronPort-AV: E=McAfee;i="6700,10204,11370"; a="53763141"
X-IronPort-AV: E=Sophos;i="6.14,239,1736841600"; d="scan'208";a="53763141"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2025 11:01:23 -0700
X-CSE-ConnectionGUID: G4VLcMDAQD6YrF6mn0hkGw==
X-CSE-MsgGUID: ezzmyHqmQSGQBQOcYZrI+A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,239,1736841600"; d="scan'208";a="120342722"
Received: from carterle-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.184])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2025 11:01:21 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 7/9] drm/i915/irq: convert intel_display_irq.[ch] interfaces
 to struct intel_display
Date: Tue, 11 Mar 2025 20:00:41 +0200
Message-Id: <df68cf79674a31bb55b641e29976052d380274a4.1741715981.git.jani.nikula@intel.com>

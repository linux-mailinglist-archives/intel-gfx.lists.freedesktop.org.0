...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 487861ADCAC
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 13:58:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 607E76EBB8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v10 09/14] drm/i915: Add state readout for DP
 VSC SDP

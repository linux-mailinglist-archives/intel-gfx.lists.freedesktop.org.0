...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 853FF157333
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Feb 2020 12:02:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D61ED6EBED;
	Mon, 10 Feb 2020 11:02:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 15FFA6EBED
 for <intel-gfx@lists.freedesktop.org>; Mon, 10 Feb 2020 11:02:18 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga102.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 10 Feb 2020 03:02:17 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,424,1574150400"; d="scan'208";a="226168387"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO intel.com)
 ([10.165.21.211])
 by fmsmga007.fm.intel.com with ESMTP; 10 Feb 2020 03:02:17 -0800
Date: Mon, 10 Feb 2020 03:03:35 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20200210110335.GB5808@intel.com>
References: <20200203074756.10549-1-manasi.d.navare@intel.com>
 <20200203074756.10549-3-manasi.d.navare@intel.com>
 <20200205143248.GI13686@intel.com>
MIME-Version: 1.0
...
On Wed, Feb 05, 2020 at 04:32:48PM +0200, Ville Syrj=E4l=E4 wrote:
...
> > @@ -14669,76 +14669,6 @@ static bool intel_cpu_transcoders_need_modeset=
...
> >   * @dev: drm device
> > @@ -14767,21 +14697,6 @@ static int intel_atomic_check(struct drm_devic=
e *dev,
> >  	if (ret)
> >  		goto fail;
> >  =
...
Okay will make that change so just call intel_atomic_get_new_crtc_state() a=
nd no
...
> > @@ -6598,7 +6738,7 @@ static const struct drm_connector_helper_funcs in=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 94D776DD2D1
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Apr 2023 08:31:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5480110E4BD;
	Tue, 11 Apr 2023 06:30:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4363A10E4BA;
 Tue, 11 Apr 2023 06:30:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 OJcBO3VYvUfHGVh3vz3Xok8f0gP4sMvMro+boj6w9Gm1k8xhHKr/Lhj2+ A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10676"; a="342301595"
X-IronPort-AV: E=Sophos;i="5.98,336,1673942400"; d="scan'208";a="342301595"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Apr 2023 23:30:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10676"; a="777796898"
X-IronPort-AV: E=Sophos;i="5.98,336,1673942400"; d="scan'208";a="777796898"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230028)(39860400002)(346002)(376002)(136003)(396003)(366004)(451199021)(31686004)(478600001)(86362001)(31696002)(36756003)(83380400001)(38100700002)(82960400001)(2616005)(6666004)(6486002)(2906002)(316002)(6506007)(53546011)(186003)(54906003)(6512007)(26005)(66476007)(8676002)(66556008)(8936002)(5660300002)(41300700001)(4326008)(66946007)(43740500002)(45980500001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Apr 2023 06:30:45.3827 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 3/5] drm/i915: Create the locked version

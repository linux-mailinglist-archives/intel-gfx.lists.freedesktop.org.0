...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E3A26440EB
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Dec 2022 11:05:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E0BE110E314;
	Tue,  6 Dec 2022 10:05:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D9FE410E314
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Dec 2022 10:05:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670321100; x=1701857100;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=E65yEDiqGRwIfq79IP36B+M38qHhp0/2L2fSMD24lgU=;
 b=HaCh4L4zozpGG8yjzKk8Myz+hKXCUkRUs7sYtylQM6yVYZzakHaLPtSX
 2AANX0dckJJ8LHx4CQsLhLKWvbTQsYpCovUZeEprpV8F1Rs3m809hEo9L
 k04RTsAweu3o5+Xogz/FjQUFvTbQyiZ4pwzlyxyx8szB7/JTwM3vOHkY7
 7TXSsHlq+zQNRyONETLHe1FixEWOEOUMJQJ48Gg3WCmxYRnT6Xp53AgpF
 j3sHPZzxuIb+rTKqhSRU/XVmka0FhlEEWiygeGyQi0pFwAlwrlOP+EUTd
 R0zBPknfp89+iEZWo5X9v4K+1h7toSuxciAtow9hk4UFHT2oKQVmhNASh w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="343611938"
X-IronPort-AV: E=Sophos;i="5.96,222,1665471600"; d="scan'208";a="343611938"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Dec 2022 02:04:55 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="678696393"
X-IronPort-AV: E=Sophos;i="5.96,222,1665471600"; d="scan'208";a="678696393"
Received: from kflahert-mobl.ger.corp.intel.com (HELO [10.213.212.142])
 ([10.213.212.142])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Dec 2022 02:04:53 -0800
Message-ID: <5f79eccd-f843-8738-98c9-e9400c55ead0@linux.intel.com>
Date: Tue, 6 Dec 2022 10:04:50 +0000
MIME-Version: 1.0

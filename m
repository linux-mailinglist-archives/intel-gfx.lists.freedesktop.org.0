...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E6AD5B300D
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:36:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8538710EC23;
...
Subject: [Intel-gfx] [PATCH v3 17/37] drm/i915: i915_gem_wait.c: fix a
 kernel-doc markup

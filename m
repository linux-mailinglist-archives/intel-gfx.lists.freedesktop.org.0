...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D86DB4C3A11
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 01:06:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC14310E673;
...
Subject: [Intel-gfx] [PATCH v2 1/8] drm/i915/guc: Do not conflate lrc_desc

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 536F4700E7C
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 20:17:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8081F10E221;
	Fri, 12 May 2023 18:17:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0E6C610E221
 for <intel-gfx@lists.freedesktop.org>; Fri, 12 May 2023 18:17:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683915429; x=1715451429;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=xEJyNTasZAsSeaR5YsZ0m0Tb/gMIppNdRgNvvo2+cWU=;
 b=BU9WMfTyYNm4q8fsnAL/dMEBYnI1hLpuqK0xxPNGw9N1mDwi1+PqSGiI
 5ipJ0SyVfWAGyGySdqumk0XJj9ul1QN6dVP8/Xgp3oXgfn8mNyP/mDdvv
 oojX/h1H0bR6DJExquDxqBPHqDVSfLQvgDYl6kzelzGAp/TTiLRSQDCDm
 k0GL864aPr28tejQaW8INfBhWTdbY9FXK8ppkA2KfgsE3wUEdwCVo+a/z
 7YEYkeXJ/pxjyPpPHPaD19+aaGNqTvxiTCDaXc0xUonI/rKEMIbKT95xW
 V2jksilqNnHI0CPBiGMn8UFkQgVwrvYauTnFIyiyaxeaVJZckoRY3F5C6 g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="416491660"
X-IronPort-AV: E=Sophos;i="5.99,269,1677571200"; d="scan'208";a="416491660"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 11:17:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="650722884"
X-IronPort-AV: E=Sophos;i="5.99,269,1677571200"; d="scan'208";a="650722884"
Received: from tsavina-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.252.63.51])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 11:17:06 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: Jani Nikula <jani.nikula@intel.com>,
	intel-gfx@lists.freedesktop.org
Date: Fri, 12 May 2023 21:16:58 +0300
Message-Id: <20230512181658.1735594-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.39.2
In-Reply-To: <20230512110444.1448231-4-jani.nikula@intel.com>
References: <20230512110444.1448231-4-jani.nikula@intel.com>
MIME-Version: 1.0
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2] drm/i915/display: add i915 parameter to
 I915_STATE_WARN()

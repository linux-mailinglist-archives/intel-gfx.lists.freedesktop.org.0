...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 441875FF774
	for <lists+intel-gfx@lfdr.de>; Sat, 15 Oct 2022 02:03:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB52510E1E9;
...
Subject: Re: [Intel-gfx] [PATCH v2 7/7] drm/i915/guc: handle interrupts from
 media GuC

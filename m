...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1846E6B9187
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Mar 2023 12:22:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 99E4510E0D2;
	Tue, 14 Mar 2023 11:22:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from www262.sakura.ne.jp (www262.sakura.ne.jp [202.181.97.72])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4250410E0D2;
 Tue, 14 Mar 2023 11:22:20 +0000 (UTC)
Received: from fsav115.sakura.ne.jp (fsav115.sakura.ne.jp [27.133.134.242])
 by www262.sakura.ne.jp (8.15.2/8.15.2) with ESMTP id 32EBLLwc097423;
 Tue, 14 Mar 2023 20:21:21 +0900 (JST)
...
Received: from [192.168.1.6] (M106072142033.v4.enabler.ne.jp [106.72.142.33])
 ...
 by www262.sakura.ne.jp (8.15.2/8.15.2) with ESMTPSA id 32EBLLbe097418
 (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=NO);
 Tue, 14 Mar 2023 20:21:21 +0900 (JST)
 (envelope-from penguin-kernel@I-love.SAKURA.ne.jp)
Message-ID: <5bbe7093-791e-5653-850b-aea343db3f3f@I-love.SAKURA.ne.jp>
Date: Tue, 14 Mar 2023 20:21:19 +0900
MIME-Version: 1.0
...
Subject: [Intel-gfx] [PATCH v2] drm/i915: avoid flush_scheduled_work() usage
...
Changes in v2:
 ...
 24 files changed, 64 insertions(+), 52 deletions(-)

diff --git a/drivers/gpu/drm/i915/display/intel_display.c b/drivers/gpu/drm/i915/display/intel_display.c
index 410c84fd905c..2ae7b9ed559e 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -7605,7 +7605,7 @@ intel_atomic_commit_ready(struct i915_sw_fence *fence,
...
@@ -8833,7 +8833,7 @@ void intel_modeset_driver_remove_noirq(struct drm_i915_private *i915)
...
index 8e16745275f6..a90abc28e16f 100644
--- a/drivers/gpu/drm/i915/display/intel_dp.c
+++ b/drivers/gpu/drm/i915/display/intel_dp.c
@@ -5085,7 +5085,7 @@ static void intel_dp_oob_hotplug_event(struct drm_connector *connector)
...
index 673bcdfb7ff6..9be091d12685 100644
--- a/drivers/gpu/drm/i915/display/intel_fbdev.c
+++ b/drivers/gpu/drm/i915/display/intel_fbdev.c
@@ -679,7 +679,7 @@ void intel_fbdev_set_suspend(struct drm_device *dev, int state, bool synchronous
...
index 2984d2810e42..72c38d036948 100644
--- a/drivers/gpu/drm/i915/display/intel_hdcp.c
+++ b/drivers/gpu/drm/i915/display/intel_hdcp.c
@@ -1029,7 +1029,7 @@ static void intel_hdcp_update_value(struct intel_connector *connector,
 	hdcp->value = value;
 	if (update_property) {
...
@@ -2128,11 +2128,11 @@ static void intel_hdcp_check_work(struct work_struct *work)
 		return;
...
@@ -2369,7 +2369,7 @@ int intel_hdcp_enable(struct intel_connector *connector,
 	}
...
+		queue_delayed_work(i915_wq, &hdcp->check_work, check_link_interval);
 		intel_hdcp_update_value(connector,
 					...
 					true);
@@ -2444,7 +2444,7 @@ void intel_hdcp_update_pipe(struct intel_atomic_state *state,
...
@@ -2461,7 +2461,7 @@ void intel_hdcp_update_pipe(struct intel_atomic_state *state,
 		 */
...
@@ -2579,5 +2579,5 @@ void intel_hdcp_handle_cp_irq(struct intel_connector *connector)
...
index 24b5b12f7732..95af3df6b530 100644
--- a/drivers/gpu/drm/i915/display/intel_pps.c
+++ b/drivers/gpu/drm/i915/display/intel_pps.c
@@ -881,7 +881,7 @@ static void edp_panel_vdd_schedule_off(struct intel_dp *intel_dp)
 	 * operations.
 	 */
...
index 44610b20cd29..c60ef4e77d64 100644
--- a/drivers/gpu/drm/i915/display/intel_psr.c
+++ b/drivers/gpu/drm/i915/display/intel_psr.c
@@ -257,7 +257,7 @@ void intel_psr_irq_handler(struct intel_dp *intel_dp, u32 psr_iir)
 		 */
...
@@ -2313,7 +2313,7 @@ tgl_dc3co_flush_locked(struct intel_dp *intel_dp, unsigned int frontbuffer_bits,
 		return;
...
@@ -2352,7 +2352,7 @@ static void _psr_flush_handle(struct intel_dp *intel_dp)
...
index 40413bcff7a1..8f4cb5c6c20a 100644
...
index e68a38b1dfb2..8b6a0f89018c 100644
...
@@ -1898,7 +1898,7 @@ void gen11_rps_irq_handler(struct intel_rps *rps, u32 pm_iir)
...
@@ -1915,7 +1915,7 @@ void gen6_rps_irq_handler(struct intel_rps *rps, u32 pm_iir)
 		gen6_gt_pm_mask_irq(gt, events);
 		rps->pm_iir |= events;
...
index 6254aa977398..298f0b443936 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -934,4 +934,5 @@ mkwrite_device_info(struct drm_i915_private *dev_priv)

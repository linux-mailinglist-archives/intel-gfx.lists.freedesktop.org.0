...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 796F652024D
	for <lists+intel-gfx@lfdr.de>; Mon,  9 May 2022 18:24:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A6C310E266;
	Mon,  9 May 2022 16:23:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 3/4] module: set holders when symbol_get() is
 used

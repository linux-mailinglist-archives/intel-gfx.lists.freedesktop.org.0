...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A0786CD306
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 09:25:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CBF9E10EA2C;
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v6 3/8] lib/ref_tracker: add printing to memory
 buffer

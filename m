...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E593B3FE6E3
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Sep 2021 02:53:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56C856E450;
...
Subject: [Intel-gfx] [PATCH v5 19/25] drm/i915/guc: Rework and simplify
 locking

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 88364A9AF4C
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Apr 2025 15:37:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DFCA10E80B;
	Thu, 24 Apr 2025 13:37:47 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Zs4flqjH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ED6F810E80A;
 Thu, 24 Apr 2025 13:37:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 FAtqwEiqusdBBXb1B8JzemmyNh8+Tz7A7PGelJYQB4qPY1rvF1aeeATJ1 w==;
X-CSE-ConnectionGUID: QNB5dlUxRPO0mGt1jpYYJw==
X-CSE-MsgGUID: hZPpT4nFRV2yX8a5r3aj3Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11413"; a="46368040"
X-IronPort-AV: E=Sophos;i="6.15,236,1739865600"; d="scan'208";a="46368040"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2025 06:37:45 -0700
X-CSE-ConnectionGUID: nkio1CLvSty89RkYAx1C4Q==
X-CSE-MsgGUID: VLCeTWXRRxGhojFwBLtuOA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,236,1739865600"; d="scan'208";a="136701354"
...
Subject: [PATCH v9 02/12] mtd: add driver for intel graphics non-volatile
 memory device

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DD73767BBDA
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:04:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02FF210E87A;
...
Subject: [Intel-gfx] [PATCH v3 03/10] drm/fb-helper: Introduce

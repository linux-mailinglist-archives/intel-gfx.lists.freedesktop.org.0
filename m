...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 258EA6F906A
	for <lists+intel-gfx@lfdr.de>; Sat,  6 May 2023 10:03:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A03E10E0B6;
	Sat,  6 May 2023 08:03:11 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 2/5] drm/i915: use pat_index instead of
 cache_level

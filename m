...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFE38395702
	for <lists+intel-gfx@lfdr.de>; Mon, 31 May 2021 10:32:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D99326E497;
	Mon, 31 May 2021 08:32:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-oi1-x235.google.com (mail-oi1-x235.google.com
 [IPv6:2607:f8b0:4864:20::235])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2867F6E051
 for <intel-gfx@lists.freedesktop.org>; Mon, 31 May 2021 08:32:07 +0000 (UTC)
Received: by mail-oi1-x235.google.com with SMTP id v22so11610320oic.2
 for <intel-gfx@lists.freedesktop.org>; Mon, 31 May 2021 01:32:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc:content-transfer-encoding;
 bh=00/TVPrSmX+KWTcxyRfUbepZkRatJk0Jy9RtPYifMi4=;
 b=UdZaKwx/cDQKGk9A/tbW7wdW5pUZlAh/8CVkS/KcsJZx/ynsqT8fDP8Jo3/c36eCZL
 peuG3nL4Ia4gn0X/TaajJPb8SeV+Rrdr06sRw95NspQ+fThB/pJTPRvTYdD6VzAy+e1O
 zBfrNZqxFr8/VnS2xe3qTzOVBjVHLuaY5GWrw=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc:content-transfer-encoding;
 bh=00/TVPrSmX+KWTcxyRfUbepZkRatJk0Jy9RtPYifMi4=;
 b=
X-Gm-Message-State: AOAM533qu2PRY/l2dHsaCCp0JKhdmj859EBQaTgGC5RgclX9jdXHhXjC
 WlExzbqzNXdwOyP0Jk81vVJ/sUjFIJvQFZvt70+Lng==
X-Google-Smtp-Source: ABdhPJx+KqwKQuQvhDqJyLwdziwK3kKf/yw6BWa37tkzgL0QqJEHUrFnVkic+tzv00eSQ77dbaQXQZ9CiLqaK0acdyI=
X-Received: by 2002:aca:ac13:: with SMTP id v19mr3604946oie.128.1622449925254; 
 Mon, 31 May 2021 01:32:05 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <20210527141215.GA21305@sdutt-i7>
From: Daniel Vetter <daniel@ffwll.ch>
Date: Mon, 31 May 2021 10:31:53 +0200
Message-ID: <CAKMK7uHacuLjqPZvH7rErtACiOjzEzJ9BTUjuh6LAYj_00i5Ww@mail.gmail.com>
...
On Thu, May 27, 2021 at 4:19 PM Matthew Brost <matthew.brost@intel.com> wrote:
>
...
> >
> > It looks like pretty much the same concept Chris implemented in upstream(*) before they got removed. Both series move the scheduling lists into a new object, be it i915_sched, or i915_sched_engine. There probably are some differences but without looking much deeper it is hard to say if they are important.
> >
...
> > Because there do appear to be some extra advantages in the dropped work, like consolidating finding of active request and moving some other bits to be backend agnostic.
> >
>
...
> > >   }
> > >   /*
> > > @@ -526,7 +530,7 @@ static inline void queue_request(struct intel_engine_cs *engine,
> > >   {
> > >     GEM_BUG_ON(!list_empty(&rq->sched.link));
> > >     list_add_tail(&rq->sched.link,
...
> > >     set_bit(I915_FENCE_FLAG_PQUEUE, &rq->fence.flags);
> > >   }
> > > @@ -536,16 +540,16 @@ static void guc_submit_request(struct i915_request *rq)
> > >     unsigned long flags;
> > >     /* Will be called from irq-context when using foreign fences. */
> > > -   spin_lock_irqsave(&engine->active.lock, flags);
> > > +   spin_lock_irqsave(&engine->sched_engine->lock, flags);
...
> > > @@ -623,7 +627,7 @@ static void guc_release(struct intel_engine_cs *engine)
> > >   {
...
> > > @@ -638,7 +642,7 @@ static void guc_default_vfuncs(struct intel_engine_cs *engine)
...
> > > @@ -702,7 +706,8 @@ int intel_guc_submission_setup(struct intel_engine_cs *engine)
> > >      */

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 91A53197DEC
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Mar 2020 16:09:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A7AD6E3AC;
	Mon, 30 Mar 2020 14:09:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DE4C06E3A8
 for <intel-gfx@lists.freedesktop.org>; Mon, 30 Mar 2020 14:09:30 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 30 Mar 2020 16:09:15 +0200
Message-Id: <20200330140925.3972034-12-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/22] drm/i915: Make sure execbuffer always
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	void *vaddr;
@@ -1084,10 +1085,13 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 		if (err)
 			return ERR_PTR(err);
...
@@ -1123,9 +1127,10 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	if (cache->page == page) {
@@ -1133,7 +1138,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 	} else {
 		vaddr = NULL;
...
@@ -1216,7 +1221,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 		goto err_unmap;
 	}
...
@@ -1370,7 +1375,7 @@ relocate_entry(struct i915_vma *vma,
 	}
...
@@ -1788,6 +1793,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2057,7 +2063,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2068,7 +2075,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2180,16 +2187,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2214,7 +2238,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2225,7 +2249,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2237,20 +2261,36 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2406,7 +2446,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -2851,33 +2891,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2950,9 +2964,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
-err_parse:
 ...
 err_vma:
@@ -3035,7 +3046,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3113,8 +3126,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index 4000eaf414fb..6fbbb2696c1d 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3056,7 +3056,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3418,7 +3419,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index 2ee2a2b301ef..8c350bd17ef2 100644
...
index 18069df2a9e5..e3d82be503dc 100644
...
@@ -1018,7 +1024,8 @@ static void flush_idle_contexts(struct intel_gt *gt)
...
+		  u32 align, unsigned int flags)
 {
 	...
 	int err;
@@ -1026,7 +1033,7 @@ int i915_ggtt_pin(struct i915_vma *vma, u32 align, unsigned int flags)

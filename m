...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E99459AE4CD
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Oct 2024 14:34:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7BC9C10E922;
	Thu, 24 Oct 2024 12:34:14 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="R5nE/EHk";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7D03E10E90B;
 Thu, 24 Oct 2024 12:34:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729773252; x=1761309252;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=UhHmJJMojca9VbjvlKsRAWYKXp2Dc8C489eU0vfOi+4=;
 b=R5nE/EHk8SB0gf4rRmtmumbychmBrkE7RVDrM9NJNWTof3VCKnstx/xL
 eM8w9dPgUAiGZ/HuS0wYryz/gawmG428VtVkZmT3ozCCRZS+0/M4hOLIz
 6vTssvBnd/vwUFNPn42yIXDitj+ohJqavIovUkp6c5cCY6nXuVSSpWCMB
 VAhFIuj60IrzLM5U1pcHYhXFRUDHOhSyH4N5Dk8z5uiIU0DZUjAgnwI1y
 rudq5pg+QqI6o6HaEqAANtyfsJrotBhewcTC3PporjNvhvmtOVToEQBGd
 WyIALCw2qVUmOn+OOE9jdJyLiquMcU/wQLLfws0XuvRlMwJuSeN3ciwM2 Q==;
X-CSE-ConnectionGUID: Dh+c0f/xS7C6PoOJoWTjcg==
X-CSE-MsgGUID: hqYYkXpkQm6n5JS3yPbKuQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11235"; a="17026294"
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="17026294"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 05:34:12 -0700
X-CSE-ConnectionGUID: eEf4Uy7LQLiJC5+tTwLp7Q==
X-CSE-MsgGUID: yM6evoIBRwuKE1hnL3I/bA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="80872347"
Received: from unknown (HELO localhost) ([10.237.66.160])
 by fmviesa010-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 05:34:10 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, rodrigo.vivi@intel.com, lucas.demarchi@intel.com,
 maarten.lankhorst@linux.intel.com
Subject: [CI v4 v4 05/16] drm/i915/display: convert display platforms to lower
 case
Date: Thu, 24 Oct 2024 15:33:31 +0300
Message-Id: <8966b84582622358423ad8de9dd08c92ea12030b.1729773149.git.jani.nikula@intel.com>

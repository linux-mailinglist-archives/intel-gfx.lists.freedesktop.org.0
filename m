...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73D24972D0D
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Sep 2024 11:12:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E28D310E0C8;
	Tue, 10 Sep 2024 09:12:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="dBhPMmfX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 889D210E718;
 Tue, 10 Sep 2024 09:11:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1725959519; x=1757495519;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=/5bQEfYcS6pM/H2XB5ZHUVltCsnU6uHUuvLIYyro28E=;
 b=dBhPMmfXWKclIjcOf/cwWsh8vNyNDHB4dJWB3c+ezLCt2XBUCYVbA/LD
 HfESUB3QlflAofPM9sgiquIhaSgTfa70Ti4H2TpjKyQau35PwB025Ps9M
 jt98hVffSdAUGXqpveqGo0xEjyIQ8zMk/UKOP5vf2bIwR1AuEo1+FTul7
 naCU1A++zWxzXOUU0ldNuu7SOP+kEWS3ME9XM0LzfaRv95esy+cOztmaG
 A/utgnvFFWiYWHNKVRDrzncDLMoeUdhkncqTYBstZitL8dAlWDV5NenjE
 lkAsWaaSdBKkyd2yCICsgFqDwiEclNRk9WflDTGm8KBTYPOag6amTDgE6 Q==;
X-CSE-ConnectionGUID: E9XQqivlR+is2Mzwa73iQA==
X-CSE-MsgGUID: 7itLUHjIRH+29x9JzRRG9A==
X-IronPort-AV: E=McAfee;i="6700,10204,11190"; a="27615522"
X-IronPort-AV: E=Sophos;i="6.10,216,1719903600"; d="scan'208";a="27615522"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2024 02:11:59 -0700
X-CSE-ConnectionGUID: KXuTG8X7SR+lyq3vFQgpWg==
X-CSE-MsgGUID: +AEjUw8qQAyo80g9Giro/Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,216,1719903600"; d="scan'208";a="71562440"
Received: from hrotuna-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.245.246.43])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2024 02:11:56 -0700
...
Subject: Re: [PATCH 1/2] drm/i915/hdcp: Move to using intel_display in
 intel_hdcp
In-Reply-To: <20240910074712.544007-2-suraj.kandpal@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20240910074712.544007-1-suraj.kandpal@intel.com>
 <20240910074712.544007-2-suraj.kandpal@intel.com>
Date: Tue, 10 Sep 2024 12:11:53 +0300
Message-ID: <878qvzlvom.fsf@intel.com>
MIME-Version: 1.0

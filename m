...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 07C528D2AF2
	for <lists+intel-gfx@lfdr.de>; Wed, 29 May 2024 04:41:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42016112EA6;
	Wed, 29 May 2024 02:41:52 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=collabora.com header.i=@collabora.com header.b="uc59kPwY";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from madrid.collaboradmins.com (madrid.collaboradmins.com
 [46.235.227.194])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 097C7112EA6;
 Wed, 29 May 2024 02:41:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
 s=mail; t=1716950502;
 bh=HCSbiHuCaxRuHd+a2Zg0TTqKsp6RitAwYsx3igcixRA=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
Received: from localhost.localdomain (cola.collaboradmins.com [195.201.22.229])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested) (Authenticated sender: vignesh)
 by madrid.collaboradmins.com (Postfix) with ESMTPSA id 8511E378215E;
 Wed, 29 May 2024 02:41:38 +0000 (UTC)
...
Subject: [PATCH v3 1/6] drm/ci: uprev mesa version
Date: Wed, 29 May 2024 08:10:44 +0530
Message-Id: <20240529024049.356327-2-vignesh.raman@collabora.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DD1EF6665B7
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Jan 2023 22:42:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8053B10E11C;
...
Subject: [Intel-gfx] [PATCH v2 5/9] drm/i915/pxp: Add GSC-CS backend to send
 GSC fw messages

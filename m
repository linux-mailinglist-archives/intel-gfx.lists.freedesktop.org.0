...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28CED2DE155
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Dec 2020 11:44:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3119C6E0E6;
...
Subject: [Intel-gfx] [PATCH v7 10/15] drm/i915: Check for FRL training

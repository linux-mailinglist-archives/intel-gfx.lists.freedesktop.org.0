...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EA444BA26F
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 15:05:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A8CD110EB84;
	Thu, 17 Feb 2022 14:05:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1006610EB84;
 Thu, 17 Feb 2022 14:05:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645106720; x=1676642720;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qlFqLRfrfrx4mNRF6vVIBqvEiaofH2gyPUSV1nRx1WA=;
 b=VfWcCXBZLWKfEUArI2vqn+3rTebLr72FAAOKstq/OFOc7JbpqarYsof4
 suitPhrx3LCaqWwc2QtBB+FEGFX/+HzgqXo0C+WmNz8v2BZjJp1kzQlDM
 sRu4davmdVMXkx1E0rd3uO8YCn2TMs8zoTqu/PYmcwXKJaVXX5ZhbpXGd
 YzW12c0wTZsvdoBXRBH/ZUctRlAvH+kggSnAAe+/o/fu0jeKgEGFuZyrn
 r+uJgeGPIVi/kcHplobEO0P/h24ljzl0kCjwPoBu8+gCaCLulJinIm1FJ
 +xvCUlPWl5jU+cO1N3r6QG9Z/r874KzFtU8+nSGle0AqUoo1mGMMp/LO1 Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10260"; a="230840878"
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="230840878"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 06:05:19 -0800
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="530241367"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 06:05:16 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: linux-kernel@vger.kernel.org, intel-gfx@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org, netdev <netdev@vger.kernel.org>
Date: Thu, 17 Feb 2022 15:04:39 +0100
Message-Id: <20220217140441.1218045-8-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH 7/9] drm/i915: Track leaked gt->wakerefs

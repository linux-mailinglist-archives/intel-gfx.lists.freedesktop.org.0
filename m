...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34708552134
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jun 2022 17:37:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1059A10E613;
	Mon, 20 Jun 2022 15:37:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x431.google.com (mail-wr1-x431.google.com
 [IPv6:2a00:1450:4864:20::431])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E512B10E6DB;
 Mon, 20 Jun 2022 15:37:11 +0000 (UTC)
Received: by mail-wr1-x431.google.com with SMTP id i10so11462791wrc.0;
 Mon, 20 Jun 2022 08:37:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=FJvCXKhdkws+QebqfjSJ9lTBILHOuu4EaUF0pfopKBc=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=FJvCXKhdkws+QebqfjSJ9lTBILHOuu4EaUF0pfopKBc=;
 b=
X-Gm-Message-State: AJIora8AIy9GxtL50vo84yHWE4+9LbB6sfYZYv319NCzq9kOsmB0jl0M
 a+Xt9gCR/VaNU6cYIaf6FcBI25wB8IwZz0if51w=
X-Google-Smtp-Source: AGRyM1uJcMSk4+sToxjNugR6ltbzMELtNaFVYXJpfpK4CjjW58jwTcJD8FzBO5paELmPogW04GuUhHNnITUTzkvQri0=
X-Received: by 2002:a5d:6d46:0:b0:21b:933d:7950 with SMTP id
 k6-20020a5d6d46000000b0021b933d7950mr2754551wri.679.1655739430181; Mon, 20
 Jun 2022 08:37:10 -0700 (PDT)
MIME-Version: 1.0
...
Date: Mon, 20 Jun 2022 08:37:15 -0700
Message-ID: <CAF6AEGt=EqeF+3UaYjxQCCFEabRFJwLbiWN9brGveYoHTYyZ7w@mail.gmail.com>

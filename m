...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 39E2B62D6D7
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Nov 2022 10:29:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7394510E59E;
...
Subject: [Intel-gfx] [PATCH v10 04/19] drm/connector: Rename

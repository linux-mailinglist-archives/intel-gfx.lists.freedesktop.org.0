...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DB7B222FB82
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Jul 2020 23:35:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B98BD6E063;
...
Subject: [Intel-gfx] [PATCH 2/6] vga-switcheroo: Add a way to test for the
 active client

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 100EB976C1E
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Sep 2024 16:30:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A469D10EB81;
	Thu, 12 Sep 2024 14:30:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SIYiv0NT";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F295510EB81
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 Sep 2024 14:30:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1726151425; x=1757687425;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=vo/Orwd/5X2Qzcfy25MQXdc7/E8lQ2sJ8JOS0CszMUk=;
 b=SIYiv0NTgSDjlH0b4FbhfC88tOBTBXiAsQov/lS/6AFCILC5mgzOu9U+
 5Z8xtjRHG5Ir6RRW4Tv8E8ncohyD5rZUEjhPF4iQn1/gYkQkD1MSdm3Zr
 5MR18pe7LNK5XkjLKLPbxfcq5qDKAjIMrHH3tDkiuN/NS89jKFzd61fBA
 lC6BKPJU2FI0GRHhFo8/Yes8wcJNq0+6G11SRlsO9ZxhFmN+a6WbdK0PJ
 RLC0XatqS6bpJxNEk14t0JaEF8LgaYM5W3fUcumgNL8qfsf3OvfNgIdur
 Ddul6QDCkIMQlalJW7+IvUaTiUGnMfzEPjLfSmrWxdtdgLMeOwHU11y+M w==;
X-CSE-ConnectionGUID: ybnOB4SbQs+RiRUZTjO0lg==
X-CSE-MsgGUID: +ImSrdLvSuyjW05R3y+ptw==
X-IronPort-AV: E=McAfee;i="6700,10204,11193"; a="36357318"
X-IronPort-AV: E=Sophos;i="6.10,223,1719903600"; d="scan'208";a="36357318"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Sep 2024 07:29:50 -0700
X-CSE-ConnectionGUID: qDjWBRt5TAeUIpeW/8b/Fw==
X-CSE-MsgGUID: SAfY3D40T+yti63D0f1WEg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,223,1719903600"; d="scan'208";a="67810423"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by fmviesa008.fm.intel.com with SMTP; 12 Sep 2024 07:29:46 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 12 Sep 2024 17:29:42 +0300
Date: Thu, 12 Sep 2024 17:29:42 +0300
...
Message-ID: <ZuL61l8-0M9LDVhG@intel.com>
References: <20240912114330.1244982-3-ankit.k.nautiyal@intel.com>
 <20240912130758.1315131-1-ankit.k.nautiyal@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20240912130758.1315131-1-ankit.k.nautiyal@intel.com>
...
On Thu, Sep 12, 2024 at 06:37:58PM +0530, Ankit Nautiyal wrote:

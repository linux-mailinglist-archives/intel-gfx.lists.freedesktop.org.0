...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DBDE42C8D4
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 20:37:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BEB46EA82;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/uapi: Add comment clarifying
 purpose of I915_TILING_* values

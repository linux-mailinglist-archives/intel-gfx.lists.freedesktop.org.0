...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B027E1B2441
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Apr 2020 12:46:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC1E96E91B;
	Tue, 21 Apr 2020 10:46:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 56F256E2C4
 for <intel-gfx@lists.freedesktop.org>; Tue, 21 Apr 2020 10:46:29 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 21 Apr 2020 12:46:06 +0200
Message-Id: <20200421104626.1480208-4-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 04/24] drm/i915: Add an implementation for
...
@@ -16958,7 +16958,7 @@ static int intel_framebuffer_init(struct intel_framebuffer *intel_fb,
...
index 40a6bc89c2b8..bc5371d8da0a 100644
...
index d4f94ca9ae0d..8f7d7a06b5bb 100644
...
index 8ae37ea38389..342a9558751c 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt.c
@@ -487,7 +487,7 @@ static int __engines_record_defaults(struct intel_gt *gt)
 		if (err)
 			goto out;

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 003832C658E
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C32206EDB7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 156/162] drm/i915: Use a ww transaction in

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FE176F1170
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 07:46:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 66D0C10EC56;
	Fri, 28 Apr 2023 05:46:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 58AC510E058;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=N/u/LlvgAqi/0x2qK5vOt4b9ZTCpd5OTD1hMVM75jmo=;
 b=BlxfVTYsEMQWJp8ADQWmxDabtl9vqfwgvgt85cIp4Q/sa9j7pHvRm0mC
 Nsv9QbG4lSE6xm7Hx1fIBGV0lOqBMG4JT/IoDTE4q+9tpSRuZ0khVaW/3
 55N4g4GN0dfWTcy0yoxse9yfJCk9esu+2Ka2VM/ZNVxzndRxJUBzQtolo
 n8gES1hNPWN3hyT13Qp6NrMfm0o31aHXWn/4ovDpPfPY3LvC+VqQuKgEQ
 QEIkgAfNau6upC6GnWJBcc8iJwnf/B8KhUwXuDrX0Slyn5K1Hy8XWa1ar
 Kyh0S+uTOHgtWXqqmPTSD/EwoTubrd/s7MVL3796FrLhFaxV6oMoJhEe0 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="413040413"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="413040413"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:46:32 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="806251811"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="806251811"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:46:31 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Apr 2023 22:47:34 -0700
Message-Id: <20230428054737.1765778-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 2/5] drm/i915: use pat_index instead of
 cache_level
...
index d2d5a24301b2..17375935ce1e 100644
...
@@ -306,20 +304,21 @@ int i915_gem_get_caching_ioctl(struct drm_device *dev, void *data,
 		goto out;
 	}
...
-	}
 out:
 	rcu_read_unlock();
 	return err;
@@ -364,6 +363,14 @@ int i915_gem_set_caching_ioctl(struct drm_device *dev, void *data,
 	if (!obj)
 		return -ENOENT;
...
index 4c6b760d4774..ee52e5833c50 100644

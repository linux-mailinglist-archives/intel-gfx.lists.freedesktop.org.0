...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 38126297654
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Oct 2020 20:00:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8DCA06E16D;
	Fri, 23 Oct 2020 18:00:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 183736E16D
 for <intel-gfx@lists.freedesktop.org>; Fri, 23 Oct 2020 18:00:29 +0000 (UTC)
IronPort-SDR: lxsM/mp7AfGjQonqBl4XDNRAS1K2P+qlbFChis+Di62yGNurUDQxDXUv+AKmY6ssIAyoMJyDQs
 nq5WObvR8GIg==
X-IronPort-AV: E=McAfee;i="6000,8403,9783"; a="155496423"
X-IronPort-AV: E=Sophos;i="5.77,409,1596524400"; d="scan'208";a="155496423"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Oct 2020 11:00:28 -0700
IronPort-SDR: ImwtHerGiGiEwM63fSxckkFUJ94fmk5FgI8aZMvqGQHpQPm1gWhyX34GP/F7MQqo2mTdI9GAcy
 0B7C442brtJw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,409,1596524400"; d="scan'208";a="321815213"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 23 Oct 2020 11:00:26 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 23 Oct 2020 21:00:25 +0300
Date: Fri, 23 Oct 2020 21:00:25 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Manasi Navare <manasi.d.navare@intel.com>
Message-ID: <20201023180025.GZ6112@intel.com>
...
> @@ -1492,8 +1492,6 @@ static void gen11_dsi_get_config(struct intel_encod=
er *encoder,
...
> @@ -4408,20 +4408,14 @@ static void bdw_get_trans_port_sync_config(struct=
...
> @@ -4515,6 +4509,29 @@ void intel_ddi_get_config(struct intel_encoder *en=
coder,
>  	default:
>  		break;
>  	}
...
> @@ -4540,7 +4557,8 @@ void intel_ddi_get_config(struct intel_encoder *enc=
oder,
...
> @@ -3631,6 +3631,8 @@ intel_find_initial_plane_obj(struct intel_crtc *int=
el_crtc,
...
> @@ -3653,7 +3655,7 @@ intel_find_initial_plane_obj(struct intel_crtc *int=
el_crtc,
...
> @@ -3675,6 +3677,11 @@ intel_find_initial_plane_obj(struct intel_crtc *in=
tel_crtc,
...
> @@ -8272,6 +8279,30 @@ static u32 ilk_pipe_pixel_rate(const struct intel_=
...
v);
> @@ -9186,20 +9217,22 @@ static void intel_get_pipe_src_size(struct intel_=
crtc *crtc,
...
> @@ -11366,6 +11407,8 @@ static void hsw_get_ddi_port_state(struct intel_c=
rtc *crtc,
>  	} else {
...
>  		else
> @@ -11439,10 +11482,19 @@ static bool hsw_get_pipe_config(struct intel_cr=
tc *crtc,
>  		active =3D true;
>  	}
>  =
...
> @@ -11517,7 +11569,10 @@ static bool hsw_get_pipe_config(struct intel_crt=
c *crtc,
>  		}
>  	}
>  =
...
> @@ -13540,13 +13595,15 @@ intel_crtc_copy_uapi_to_hw_state(struct intel_a=
tomic_state *state,
...
> @@ -14183,21 +14240,42 @@ intel_pipe_config_compare(const struct intel_cr=
...
> @@ -14207,24 +14285,11 @@ intel_pipe_config_compare(const struct intel_cr=
tc_state *current_config,
...
> @@ -14250,7 +14315,8 @@ intel_pipe_config_compare(const struct intel_crtc=
...
> @@ -14271,48 +14337,50 @@ intel_pipe_config_compare(const struct intel_cr=
tc_state *current_config,
...
> @@ -14324,6 +14392,9 @@ intel_pipe_config_compare(const struct intel_crtc=
_state *current_config,
>  =
...
> @@ -18543,7 +18618,7 @@ int intel_modeset_init_nogem(struct drm_i915_priv=
ate *i915)
...
>  		/*
> @@ -18856,7 +18931,8 @@ static void intel_sanitize_crtc(struct intel_crtc=
 *crtc,
>  =
...
> @@ -19067,9 +19143,19 @@ static void intel_modeset_readout_hw_state(struc=
t drm_device *dev)
...
>  		}
> @@ -19125,16 +19211,15 @@ static void intel_modeset_readout_hw_state(stru=
ct drm_device *dev)
...
> @@ -19149,11 +19234,18 @@ static void intel_modeset_readout_hw_state(stru=
ct drm_device *dev)
...
> @@ -19199,6 +19291,39 @@ static void intel_modeset_readout_hw_state(struc=
t drm_device *dev)
...
>  	 * accordingly.
>  	 */
>  #define PIPE_CONFIG_QUIRK_MODE_SYNC_FLAGS	(1<<0) /* unreliable sync mode=
.flags */

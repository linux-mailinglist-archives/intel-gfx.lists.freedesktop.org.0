...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3468C2755E2
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:22:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4BCE6E921;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 03/22] drm/etnaviv: Introduce GEM object
 functions

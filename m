...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E8D320FF2A
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:31:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E31A56E4B3;
...
Subject: [Intel-gfx] [PATCH 41/59] drm/kmb: Changes for LCD to Mipi

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC26546EEF4
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Dec 2021 17:59:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECD3510EA0C;
...
Subject: Re: [Intel-gfx] [PATCH v2 14/16] drm/i915: Remove

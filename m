...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 97F14402D9C
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Sep 2021 19:19:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 034DE6E091;
...
Subject: [Intel-gfx] [PATCH 1/8] drm/i915/xehp: Define compute class and
 engine

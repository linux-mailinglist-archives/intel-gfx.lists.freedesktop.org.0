...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C2146ED77E
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 00:06:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B8BE10E638;
	Mon, 24 Apr 2023 22:06:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D2F4010E62F;
 Mon, 24 Apr 2023 22:06:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682373976; x=1713909976;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=e0eOMTekkDOu9lX+wxTyqCu8zuxpKBliVs1N5+Ykyps=;
 b=MgMeYXxM06fLbR61cIFPbrQV94yFQYzxKVysZ6hw7MngBeMGAhrFegFE
 riGhPH/uPPgIh3b9rX7zO//PEeFvM/HWFpDptSAggMmYw6EjbZMo98Rkx
 bqOX0kcilGBymUiEUogUvpRpCFyJDQ7D9/SYgkEuVHo4oJUYvc+uu2u3T
 /ckXC8VfeM1BmAMXgjH1muAOaWzGhXp5aiOYQQEUfV79rdj/KV9dMGn/w
 aJsTwZiIi5U+VOpOLZUAfk7TDU5orVnuy4cLJSZtLxWpAutxEE2zeO82+
 fF5dM4eIC/Z8MQ2Kw+DV/2HdwJGoGy6R+yMBqLrB43PQya9RDMiWD8qRj g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10690"; a="335473764"
X-IronPort-AV: E=Sophos;i="5.99,223,1677571200"; d="scan'208";a="335473764"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2023 15:06:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10690"; a="939500413"
X-IronPort-AV: E=Sophos;i="5.99,223,1677571200"; d="scan'208";a="939500413"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2023 15:06:10 -0700
From: Andrzej Hajda <andrzej.hajda@intel.com>
Date: Tue, 25 Apr 2023 00:05:43 +0200
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230224-track_gt-v8-6-4b6517e61be6@intel.com>
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v8 6/7] drm/i915: Replace custom intel
...
@@ -407,7 +407,7 @@ print_async_put_domains_state(struct i915_power_domains *power_domains)
...
index dfd87d08221807..48c62fee1f4ede 100644
--- a/drivers/gpu/drm/i915/intel_wakeref.c
+++ b/drivers/gpu/drm/i915/intel_wakeref.c
@@ -187,3 +187,31 @@ void intel_wakeref_auto_fini(struct intel_wakeref_auto *wf)
...
index 0b6b4852ab236a..439d8b172748ad 100644

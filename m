...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3EEE1A1418
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Apr 2020 20:38:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0185A6E8D3;
...
Subject: Re: [Intel-gfx] [PATCH v2 06/17] drm: Shrink mode->type to u8

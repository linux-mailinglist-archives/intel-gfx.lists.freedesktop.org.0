...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C2286BCDF6
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 12:19:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47F1410ECB2;
	Thu, 16 Mar 2023 11:19:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0D1F910ECB2
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Mar 2023 11:19:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678965549; x=1710501549;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Bky8J1feEGRZ7ZHu3AGX5LgR9A1a0XLRPJzQN4MK+xk=;
 b=MafQWGF4FRYSU9vLVUPiNMVTDCKJsuLXqVLsrcW1iQhUFw3A/GzTmsn3
 Thqn0twAudClnpA1gsVM2bgN8Nkp4BO1qkBkrUmXQe8ilWYzHIdDFZTLh
 aJ3YACgGnKXXr1x5EOyOxMTQiO+G1qW788XE/CbmUQDGtSV9E18ipRPdh
 h7Xc+3u+lttM4VFmER2QHY0Uae47xsCXB+JMEpxkLXoYTQOlbKgLAtBKx
 tZjO6yoTpq3UtcKiYGbSd1hJ+kZkze++C19iYnXLoe36CEHd36JtxxhbT
 7cAbrzvUEdJnTZYXWfTuzXlrp948WOJHVEC2M+4I3QjtKGVq8ddQoF8rm Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="339485888"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="339485888"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 04:19:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="744083196"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="744083196"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by fmsmga008.fm.intel.com with ESMTP; 16 Mar 2023 04:19:07 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 16 Mar 2023 13:13:22 +0200
Message-Id: <20230316111335.66915-10-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 09/22] drm/i915/mtl: C20 HW readout

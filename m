...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DDFD91ED881
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Jun 2020 00:19:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C47C06E0D4;
	Wed,  3 Jun 2020 22:19:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CAD986E0CE;
 Wed,  3 Jun 2020 22:19:01 +0000 (UTC)
IronPort-SDR: Sb22RI84r/6+IJLfcetAxOhPdcZHpHosPQUxiPsUgLnuoZIbZsY5jrywxTm0TB5qUmdkK+MWRT
 2JSHP+jwEF3g==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2020 15:19:01 -0700
IronPort-SDR: wtwsjQk8aHEVZ4I2094MM8iUI+FQsjVM1hDoGkJrE5YR5zCjLVgrTHOYQqdDSumC6GTcustaCp
 6663f4J7JrlA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,470,1583222400"; d="scan'208";a="269217435"
Received: from ideak-desk.fi.intel.com ([10.237.72.183])
 by orsmga003.jf.intel.com with ESMTP; 03 Jun 2020 15:19:00 -0700
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Thu,  4 Jun 2020 01:18:59 +0300
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 3/3] drm/i915/dp_mst: Work around out-of-spec

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 69E946F0CEB
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Apr 2023 22:15:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 014C110E0CD;
	Thu, 27 Apr 2023 20:15:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1639510E0CD
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Apr 2023 20:15:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1682626539;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=wl/J1rdCc6nkbkS/7/gIiAE1ID11G6DWdBaUMdDfhBg=;
 b=b8aP0epNWJuJLs0LskvhlOx7I2N3CNG5bl5FS3zOZzRtV9GfEIUaM65zLqCstieIWfY65j
 xaACh6G9lKKfJeps1CY+PD1BoWv2fsoiP08siko8lIDKjeYCMfWKgA/pqsjEwsxnqbFOYL
 SHMuXJwzOsHeYY/ezPnDTE9QXNBhdQM=
Received: from mail-io1-f70.google.com (mail-io1-f70.google.com
 [209.85.166.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-599-g_rJqo3zM1ud5TFpqgs4vw-1; Thu, 27 Apr 2023 16:15:36 -0400
X-MC-Unique: g_rJqo3zM1ud5TFpqgs4vw-1
Received: by mail-io1-f70.google.com with SMTP id
 ca18e2360f4ac-76353eb51acso1380370839f.0
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Apr 2023 13:15:36 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=wl/J1rdCc6nkbkS/7/gIiAE1ID11G6DWdBaUMdDfhBg=;
 b=
X-Gm-Message-State: AC+VfDw86qesCLnpjxj6QgOpkdev1L3oFgeIHWak23iZ65s07hRsw/8E
 ABu6Lj1Qm8WYmSrwogBLB28EIqzm7EanhOuVvelUdA73cK7i/JrtqCenSe5MT6pz5W3i8zHW36n
 o6SzAiaiFIp/0D2/kQG6qWlfq8Xec
X-Received: by 2002:a5d:8585:0:b0:760:ee5e:848c with SMTP id
 f5-20020a5d8585000000b00760ee5e848cmr1684050ioj.13.1682626535871; 

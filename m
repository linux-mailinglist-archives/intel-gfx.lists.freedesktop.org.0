...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A68D9CA0D
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Aug 2019 09:22:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DEABC6E194;
	Mon, 26 Aug 2019 07:22:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C68926E1CE
 for <intel-gfx@lists.freedesktop.org>; Mon, 26 Aug 2019 07:22:16 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18262680-1500050 
 for multiple; Mon, 26 Aug 2019 08:21:53 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 26 Aug 2019 08:21:26 +0100
Message-Id: <20190826072149.9447-5-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/28] drm/i915/gtt: Downgrade Cherryview back
 to aliasing-ppgtt
...
dGVsX2xyYy5jCmluZGV4IGQ0MjU4NDQzOWY1MS4uMWExZDY4ZDE2ZmQ5IDEwMDY0NAotLS0gYS9k
...
SVRfSU5WQUxJREFURSk7CiAJaWYgKHJldCkKIAkJcmV0dXJuIHJldDsKIApAQCAtMzE0OSwxMiAr
MzA5MiwyMCBAQCBzdGF0aWMgdTMyIGludGVsX2xyX2luZGlyZWN0X2N0eF9vZmZzZXQoc3RydWN0
...
Yi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3BjaS5jCmluZGV4IDRjMTIwYTJlOTJhZi4uZGY1
MTgxOTlmYmZhIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3BjaS5jCisr

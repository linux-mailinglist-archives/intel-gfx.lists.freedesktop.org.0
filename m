...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DBCB13B3EF6
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Jun 2021 10:23:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C7166ED88;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 18/27] drm/sti: Don't set struct

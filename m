...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 12A62610A9E
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Oct 2022 08:44:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20A9110E78B;
	Fri, 28 Oct 2022 06:44:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A853A10E77B
 for <intel-gfx@lists.freedesktop.org>; Fri, 28 Oct 2022 06:44:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666939474; x=1698475474;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=tmLKN7HCptzQHQvscT0FeeUUtfHbSOLw5oXbG/nqt0A=;
 b=gDkpNBMucbgf5fmHcQl9WDWy3lqefWBIv8LoaoaZ432OpqtHif+Etr/2
 Hkc6gxQSfE1uqG5GcziMf29D7rsS9s6eHYlHYd1iQonzVi1ctjF+B0mGY
 ph4ocS0nEfZqAoHTYKhKgcjOYYXFK2HcI6v+NoqyYMPKqM0GnX/E65SGs
 ugOdLJf9oCWV4XUm6emds1FZNWAPdvfWppvrmw4+tMmMSqH9FOZhq+QZy
 IBhzdiGZxQU3HoB5VyoptFNkCeU/f3PFDg2PD+X0zLnUl+GdTkK9cDe0E
 FKBf+5TbcFged9CL5WTmHetw0JLHoTrqanfScflrwnOyrbjw+sW/lhjZ3 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="335063987"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="335063987"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2022 23:44:34 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="757984458"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="757984458"
...
To: "Dixit, Ashutosh" <ashutosh.dixit@intel.com>, Nick Desaulniers
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230022)(376002)(136003)(366004)(346002)(39860400002)(396003)(451199015)(82960400001)(110136005)(316002)(54906003)(8936002)(41300700001)(8676002)(5660300002)(4326008)(66946007)(30864003)(66556008)(66476007)(6486002)(478600001)(966005)(186003)(86362001)(26005)(6512007)(2616005)(31696002)(6666004)(53546011)(6506007)(83380400001)(38100700002)(36756003)(2906002)(31686004)(43740500002)(45980500001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 28 Oct 2022 06:44:31.1658 (UTC)

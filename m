...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2D1677FBD3
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Aug 2023 18:16:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0197310E526;
...
Subject: [Intel-gfx] [PATCH 12/17] drm/dp_mst: Factor out a helper to check
 the atomic state of a topology manager

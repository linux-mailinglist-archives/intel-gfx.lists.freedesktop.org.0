...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D8B619A0BC
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2020 23:26:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A85F96E88F;
	Tue, 31 Mar 2020 21:26:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9D9426E362
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Mar 2020 21:26:09 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20757496-1500050 
 for multiple; Tue, 31 Mar 2020 22:26:02 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 31 Mar 2020 22:25:58 +0100
Message-Id: <20200331212600.16654-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/10] drm/i915/gem: Teach execbuf how to wait
 on future syncobj
...
index cda35e6dfc44..c367b1aa52f5 100644
...
@@ -2318,8 +2319,24 @@ await_fence_array(struct i915_execbuffer *eb,
 			continue;

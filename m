...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 54D2CA6C9D
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Sep 2019 17:12:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8BEA890DF;
	Tue,  3 Sep 2019 15:12:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ed1-x543.google.com (mail-ed1-x543.google.com
 [IPv6:2a00:1450:4864:20::543])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B64E0890DF
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Sep 2019 15:12:54 +0000 (UTC)
Received: by mail-ed1-x543.google.com with SMTP id r12so18887722edo.5
 for <intel-gfx@lists.freedesktop.org>; Tue, 03 Sep 2019 08:12:54 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:sender:date:from:to:cc:subject:message-id
 :references:mime-version:content-disposition:in-reply-to:user-agent;
 bh=yKP9+ivBiH1sw4eee6URddpzOtbPKdq9Qfu2yu3aBow=;
 b=
X-Gm-Message-State: APjAAAXJ8Q5XGF9ol2vHLBQia2fXpur6XJ+gMkojQl9hP5LZ5oMA+LWy
 h1ZQzWKpS/TJdqX7vZvikQ3sFQ==
...
Subject: Re: [Intel-gfx] [PATCH 2/3] drm/vkms: Use wait_for_flip_done

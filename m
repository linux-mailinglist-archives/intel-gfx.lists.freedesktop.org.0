...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A220F19F637
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Apr 2020 14:57:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DFB46E237;
	Mon,  6 Apr 2020 12:57:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EBCB36E237
 for <intel-gfx@lists.freedesktop.org>; Mon,  6 Apr 2020 12:57:42 +0000 (UTC)
IronPort-SDR: Y2PTo6fKcp2CGrexpKmyjapM4wdihQH7hhCn4n9g55vYGnsHWeGR5WSQRVWZgMMXHsAQkT6NzH
 /hG7XVFAvQWw==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Apr 2020 05:57:42 -0700
IronPort-SDR: 9k1KVKjg1qrFt0cAcsCe0kkwBSnqsr4Nh0xgUHjftwJbLxXaqnaknU1ngmroZwYUEF1kTBLTCX
 tfSMu5Vv/p5w==
X-IronPort-AV: E=Sophos;i="5.72,351,1580803200"; d="scan'208";a="424348486"
Received: from ideak-desk.fi.intel.com ([10.237.72.183])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Apr 2020 05:57:41 -0700
Date: Mon, 6 Apr 2020 15:57:31 +0300
From: Imre Deak <imre.deak@intel.com>
To: "Souza, Jose" <jose.souza@intel.com>
Message-ID: <20200406125731.GA1299@ideak-desk.fi.intel.com>
References: <20200401004120.408586-1-jose.souza@intel.com>
 ...
 <90f5ef9bc48895c34fe374886aaab93ed0835df0.camel@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <90f5ef9bc48895c34fe374886aaab93ed0835df0.camel@intel.com>
...
<3> [428.836598] [drm:tc_port_live_status_mask [i915]] *ERROR* Port D/TC#2:=
 live status 00000004 mismatches the legacy port flag, fix flag

which is a known buggy VBT issue and

i915 0000:00:02.0: drm_WARN_ON(!power_well->desc->hsw.is_tc_tbt || !(((&(de=
v_priv)->__info)->gen) =3D=3D 11 && dig_port->tc_legacy_port))
...
> > > > > +	if (INTEL_GEN(i915) =3D=3D 11 && dig_port->tc_link_refcount =
...
> > > > > +	intel_wakeref_t tc_cold_wakeref;
> > > > > +
> > > > > +	if (INTEL_GEN(i915) !=3D 11 || dig_port->tc_link_refcount =

> > > > > > 0)
> > > > > +		return;
> > > > > +
> > > > > +	tc_cold_wakeref =3D fetch_and_zero(&dig_port-
> > > > > >tc_cold_wakeref);

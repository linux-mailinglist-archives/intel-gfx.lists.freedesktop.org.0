...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DD8E9153460
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2020 16:42:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4CD4C6F645;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 13/17] drm/i915: Add state readout for DP VSC
 SDP

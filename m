...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C9514F7B4A
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Apr 2022 11:15:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E19910E799;
...
Subject: [Intel-gfx] [PATCH 05/12] drm/edid: pass struct edid to
 connector_bad_edid()

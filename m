...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C3B473AC6EF
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Jun 2021 11:12:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2461F6E9CC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 08/17] drm/i915/display: Add handling for new

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 06C7920FEC2
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:28:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 998226E2E5;
	Tue, 30 Jun 2020 21:28:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 24CBA89D1D;
 Tue, 30 Jun 2020 21:28:36 +0000 (UTC)
IronPort-SDR: aOSxhWjgdrOeGvzsofWq8GDmqDM+D7krEYJPE2ILhY4icEp1IJgBSBd4iZ7kkG7oh4JgfKfOPb
 xXLPwUkK2gXw==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="146386937"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="146386937"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2020 14:28:35 -0700
IronPort-SDR: 0jOEjuSSpf/HzapCsVGmsKTtXiRUFb+PODGWsyh0lFAqOlGICSenw0PFhsrAR68VnS6XJSOwmW
 ba/nz4VFVPYQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="481066613"
...
Date: Tue, 30 Jun 2020 14:27:16 -0700
Message-Id: <1593552491-23698-5-git-send-email-anitha.chrisanthus@intel.com>
X-Mailer: git-send-email 2.7.4
In-Reply-To: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
References: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
Subject: [Intel-gfx] [PATCH 04/59] drm/kmb: Use biwise operators for

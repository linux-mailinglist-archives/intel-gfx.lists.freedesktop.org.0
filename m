...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9419C5327E7
	for <lists+intel-gfx@lfdr.de>; Tue, 24 May 2022 12:39:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 66BEB10F065;
	Tue, 24 May 2022 10:39:57 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v1 00/13] drm/edid: expand on struct drm_edid
 usage
...
Cc: amd-gfx@lists.freedesktop.org, Karol Herbst <kherbst@redhat.com>,
 ...
 Maxime Ripard <mripard@kernel.org>, Adam Jackson <ajax@redhat.com>,
 Ben Skeggs <bskeggs@redhat.com>, Andrzej Hajda <andrzej.hajda@intel.com>,
 Thomas Zimmermann <tzimmermann@suse.de>,
 Alex Deucher <alexander.deucher@amd.com>, Dave Airlie <airlied@redhat.com>,
 nouveau@lists.freedesktop.org, Harry Wentland <harry.wentland@amd.com>,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2C8C20FECE
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:29:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D86036E34B;
...
Subject: [Intel-gfx] [PATCH 07/59] drm/kmb: Set OUT_FORMAT_CFG register

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D97B17528B8
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jul 2023 18:37:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB6EA10E750;
...
Subject: [Intel-gfx] [PATCH v4 14/21] dyndbg: refactor

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EB9A57309B
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 10:14:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A6AD95FE3;
...
Subject: [Intel-gfx] [PATCH v2 39/39] drm/i915: add GuC functions to the
 documentation

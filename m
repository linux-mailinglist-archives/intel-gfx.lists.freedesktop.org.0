...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED2D33B4C0B
	for <lists+intel-gfx@lfdr.de>; Sat, 26 Jun 2021 04:41:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D66C6E9C0;
...
Subject: Re: [Intel-gfx] [PATCH v4 25/27] drm/vmwgfx: Don't set struct
 drm_device.irq_enabled

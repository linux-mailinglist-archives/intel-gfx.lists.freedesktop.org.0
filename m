...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C4B85E0C9
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jul 2019 11:17:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86AFE6E109;
	Wed,  3 Jul 2019 09:17:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 439CF6E109
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jul 2019 09:17:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17110508-1500050 
 for multiple; Wed, 03 Jul 2019 10:17:29 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 Jul 2019 10:17:17 +0100
Message-Id: <20190703091726.11690-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/15] drm/i915/gem: Free pages before
...
L2k5MTVfZHJ2LmgKaW5kZXggMDllMDlkMjZlNjdkLi45ZDEzMmM5ZDE3YjAgMTAwNjQ0Ci0tLSBh
L2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZHJ2LmgKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvaTkxNV9kcnYuaApAQCAtMjQ0NCwxOCArMjQ0NCwxNyBAQCBpbnQgaTkxNV9nZW1fZnJlZXpl
...
OTE1X3ByaXZhdGUgKmk5MTUpCkBAIC0yNDg2LDcgKzI0ODUsOSBAQCBpOTE1X2dlbV9vYmplY3Rf

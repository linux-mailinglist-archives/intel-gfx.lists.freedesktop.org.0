...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D71CE275615
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:23:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 012796E968;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 11/22] drm/omapdrm: Introduce GEM object
 functions

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B9832849BE
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Oct 2020 11:54:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BC636E441;
...
Subject: [Intel-gfx] [RFC 4/8] drm/i915: Capture max frl rate for PCON in
 dfp cap structure

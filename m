...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1149B257815
	for <lists+intel-gfx@lfdr.de>; Mon, 31 Aug 2020 13:17:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3376F6E0CA;
...
Subject: Re: [Intel-gfx] [PATCH v8 12/17] pwm: crc: Implement apply() method
...
Content-Type: multipart/mixed; boundary="===============1441783875=="

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C80886AD7B8
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Mar 2023 07:55:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0BC010E372;
	Tue,  7 Mar 2023 06:54:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4A63810E372
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Mar 2023 06:54:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678172098; x=1709708098;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=j/C//rZ4OA3CNi69xWU6rH9z8Ppp6kgCuYMXXT46uv0=;
 b=lef0FTsPj5TOPnSn1MyRKpmlLNMRAyNG+s2QowCzPHZBrSzLAsfM7Tz8
 UPZJbMhzjIYtOJkFADBXgx/Xgqn+VEtmyl1C1QM/fr/D3wW6HxR9uMTB7
 3C8/7YOUD6u2W+zU5jbpebDBBLpKNdY/qid8A0fa+jyYCagW5m0CuO6ug
 PHNsKdAOGeBjgvar+G4JoyyK4t1+W0zcZUST7/A9QlgENl+PKdICDox42
 Y5+NRmR//CrYrYT0IqOk87RN1r4O1jbxvw5OOnm73M43BgducmjleQVZE
 m5WzK/RTJ+WOP86HfJMWl0z+Nau2sOU9u41w/3GmqreDM+HuvfPqFQ7p3 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10641"; a="319609534"
X-IronPort-AV: E=Sophos;i="5.98,240,1673942400"; d="scan'208";a="319609534"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Mar 2023 22:54:57 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10641"; a="786579606"
X-IronPort-AV: E=Sophos;i="5.98,240,1673942400"; d="scan'208";a="786579606"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga002.fm.intel.com with ESMTP; 06 Mar 2023 22:54:54 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  7 Mar 2023 12:23:54 +0530
Message-Id: <20230307065356.181278-5-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 4/6] drm/i915/hdcp: Refactor HDCP API
 structures

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4665030E068
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Feb 2021 18:02:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C0226EB49;
	Wed,  3 Feb 2021 17:02:22 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 607716EB49;
 Wed,  3 Feb 2021 17:02:20 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 23778272-1500050 for multiple; Wed, 03 Feb 2021 17:02:15 +0000
MIME-Version: 1.0
In-Reply-To: <c3f9a058-307b-3fee-526b-a17a871f8fb3@linux.intel.com>
References: <20210201115756.876351-1-tvrtko.ursulin@linux.intel.com>
 ...
 <c3f9a058-307b-3fee-526b-a17a871f8fb3@linux.intel.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>,
 igt-dev@lists.freedesktop.org
Date: Wed, 03 Feb 2021 17:02:15 +0000
Message-ID: <161237173596.21832.14019693292338425493@build.alporthouse.com>
User-Agent: alot/0.9

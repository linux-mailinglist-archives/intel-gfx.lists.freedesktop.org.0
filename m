...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id eLRfN0zpiWlnEAAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Feb 2026 15:03:56 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4390D110020
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Feb 2026 15:03:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B73910E1BA;
	Mon,  9 Feb 2026 14:03:54 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=oracle.com header.i=@oracle.com header.b="o1DQZhys";
	dkim=pass (1024-bit key; unprotected) header.d=oracle.onmicrosoft.com header.i=@oracle.onmicrosoft.com header.b="KQd3tGRj";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx0b-00069f02.pphosted.com (mx0b-00069f02.pphosted.com
 [205.220.177.32])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BC86610E1BA;
 Mon,  9 Feb 2026 14:03:52 +0000 (UTC)
Received: from pps.filterd (m0246630.ppops.net [127.0.0.1])
 by mx0b-00069f02.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id
 619BusYo1719735; Mon, 9 Feb 2026 14:02:51 GMT
...
Received: from pps.filterd
 ...
 with ESMTP id 619CubqJ030924; Mon, 9 Feb 2026 14:02:50 GMT
...
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?1NCUfVdqYcPxuaDHPZi4VZGuIfv2F60XFKZ3Bt8E+7TxcONAnP8RBqd1Rg1L?=
...
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?y7HsoJ08kygkghmCFBOy4+ys0thUoA7G7GcBT6gbDbWcLTF73ofQxsjBr/eS?=
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[nvidia.com:email,oracle.com:email,oracle.com:dkim,suse.de:email,oracle.onmicrosoft.com:dkim,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns];
	MISSING_XM_UA(0.00)[];

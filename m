...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DE7FB269565
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Sep 2020 21:18:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9CB36E546;
	Mon, 14 Sep 2020 19:18:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D1086E546
 for <intel-gfx@lists.freedesktop.org>; Mon, 14 Sep 2020 19:18:06 +0000 (UTC)
IronPort-SDR: vwU880LGVTN3uh22sInkLaU5TW5ogcH/HNzwdfIeUFHezfUr/yMXT7fAt09qIo4c9Xr05wCd1z
 hBTTQF4AJ4zg==
X-IronPort-AV: E=McAfee;i="6000,8403,9744"; a="159194873"
X-IronPort-AV: E=Sophos;i="5.76,427,1592895600"; d="scan'208";a="159194873"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2020 12:18:01 -0700
IronPort-SDR: ePqgpPBLac/ixJ20hESCLjq7Pv5WUCa6JJBGc7lfpHI7vAXCxppkIMMyxhAHZ71u8XyHds4Fua
 vEY0DGVfsJWA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.76,427,1592895600"; d="scan'208";a="338392072"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by fmsmga002.fm.intel.com with SMTP; 14 Sep 2020 12:17:58 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Mon, 14 Sep 2020 22:17:57 +0300
Date: Mon, 14 Sep 2020 22:17:57 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Navare, Manasi" <manasi.d.navare@intel.com>
Message-ID: <20200914191757.GX6112@intel.com>
...
In-Reply-To: <20200914190026.GB28760@labuser-Z97X-UD5H>
...
> > > @@ -17400,7 +17400,7 @@ intel_mode_valid_max_plane_size(struct drm_i9=
15_private *dev_priv,
> > >  	 * too big for that.
> > >  	 */
...
> Hmm, so the caller of intel_mode_valid_max_plane_size() should check on t=
he bigjoiner
> flag and perhaps if bigjoiner is true then increase the plane_width_max t=
o 7680?
> =
...
> > >  	return max_dotclk;
> > >  }
> > > @@ -527,7 +539,8 @@ small_joiner_ram_size_bits(struct drm_i915_privat=
e *i915)
> > >  =
...
> > >  	int i;
> > > @@ -545,6 +558,10 @@ static u16 intel_dp_dsc_get_output_bpp(struct dr=
m_i915_private *i915,
...
> > > @@ -554,6 +571,15 @@ static u16 intel_dp_dsc_get_output_bpp(struct dr=
m_i915_private *i915,
> > >  	 */
...
> > > @@ -576,7 +602,8 @@ static u16 intel_dp_dsc_get_output_bpp(struct drm=
_i915_private *i915,
> > >  }
> > >  =
...
> > > @@ -603,12 +630,20 @@ static u8 intel_dp_dsc_get_slice_count(struct i=
ntel_dp *intel_dp,
> > >  =
...
> > > @@ -648,11 +683,15 @@ intel_dp_mode_valid(struct drm_connector *conne=
ctor,
> > >  	int max_dotclk;
...
> > > @@ -664,6 +703,21 @@ intel_dp_mode_valid(struct drm_connector *connec=
tor,
...
> > > @@ -691,23 +745,28 @@ intel_dp_mode_valid(struct drm_connector *conne=
ctor,
> > >  							    max_link_clock,
> > >  							    max_lanes,
> > >  							    target_clock,
...
> > > -	if ((mode_rate > max_rate && !(dsc_max_output_bpp && dsc_slice_coun=
t)) ||
> > > -	    target_clock > max_dotclk)
> > > +	/* big joiner configuration needs DSC */
> > > +	if (bigjoiner && !dsc) {
> > > +		DRM_DEBUG_KMS("Link clock needs bigjoiner, but DSC or FEC not avai=
lable\n");
> > >  		return MODE_CLOCK_HIGH;
> > > +	}
> > >  =
...
> > >  }
> > > @@ -2204,11 +2263,13 @@ static int intel_dp_dsc_compute_config(struct=
 intel_dp *intel_dp,

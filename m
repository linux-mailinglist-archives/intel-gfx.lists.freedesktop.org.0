...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F24A92D6A8F
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 23:39:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1133D6EB8C;
	Thu, 10 Dec 2020 22:39:56 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 50C2B89D39
 for <Intel-gfx@lists.freedesktop.org>; Thu, 10 Dec 2020 22:39:37 +0000 (UTC)
IronPort-SDR: e7E3O2rc4ORXlO7I7MONK5jrRMmTsfE+Qx9CjHDC3xqTJYma+td4+qm9faUo8uZRkHXFGM/dxp
 M4rh+zHRTQhQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9831"; a="192676659"
X-IronPort-AV: E=Sophos;i="5.78,409,1599548400"; d="scan'208";a="192676659"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2020 14:39:32 -0800
IronPort-SDR: mw6NVV3uNmd6W+HBWIfDzRDIC6HMPiI4jOm+BOhxq9sq2hwb8/tEH4LnJMWNSegBdPTjbchrv6
 B73+Wp+Ik2xw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,409,1599548400"; d="scan'208";a="544016887"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga005.fm.intel.com with ESMTP; 10 Dec 2020 14:39:32 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 10 Dec 2020 14:38:41 -0800
Message-Id: <20201210223859.23882-4-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201210223859.23882-1-sean.z.huang@intel.com>
References: <20201210223859.23882-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v6 03/21] drm/i915/pxp: Implement funcs to create
 the TEE channel

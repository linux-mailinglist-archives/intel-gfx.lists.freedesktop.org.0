...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 65FB1BA25E
	for <lists+intel-gfx@lfdr.de>; Sun, 22 Sep 2019 14:06:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 830186E886;
	Sun, 22 Sep 2019 12:04:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2979D6E06D
 for <intel-gfx@lists.freedesktop.org>; Sat, 21 Sep 2019 09:55:55 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18568191-1500050 
 for multiple; Sat, 21 Sep 2019 10:55:48 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sat, 21 Sep 2019 10:55:41 +0100
Message-Id: <20190921095542.23205-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/5] drm/i915: Fixup preempt-to-busy vs reset of
 a virtual request
...
cm0vaTkxNS9ndC9pbnRlbF9scmMuYwppbmRleCAxYjJiYWNjNjAzMDAuLjNlYWRkMjk0YmNkNyAx
MDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMKKysrIGIvZHJp
dmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMKQEAgLTIzMjYsMTEgKzIzMjYsMTQgQEAg

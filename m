...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EBA80484E7
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jun 2019 16:07:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF49D8926B;
...
Subject: Re: [Intel-gfx] [PATCH 15/59] drm/fsl-dcu: Drop

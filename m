...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 77169164FFD
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Feb 2020 21:35:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4EE3D6EC9C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 01/12] drm: Nuke mode->hsync

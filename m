...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7BDF13D0305
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 22:41:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF0E76E4DE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 35/42] drm/i915: Allow callers of

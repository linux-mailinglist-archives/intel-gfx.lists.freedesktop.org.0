...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E1E642734B
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Oct 2021 23:57:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3234089B22;
...
Subject: [Intel-gfx] [PATCH 07/11] drm/i915/xehp: Determine which tile
 raised an interrupt

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A4F83F32C6
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2019 16:18:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C8066F6F3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/12] drm/i915: Fix readout of PIPEGCMAX

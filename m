...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 31C2633C79D
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Mar 2021 21:20:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7118C6E176;
	Mon, 15 Mar 2021 20:20:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E33B86E176
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Mar 2021 20:20:00 +0000 (UTC)
IronPort-SDR: jUfueaWld/0acemw9/FGdxhyWDG9qaCrVF93J+Gs62h+gD0hO9fUqga8k9cL/TAGwcm/a6/ygs
 EzIim0fLCP+w==
X-IronPort-AV: E=McAfee;i="6000,8403,9924"; a="274192520"
X-IronPort-AV: E=Sophos;i="5.81,251,1610438400"; d="scan'208";a="274192520"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2021 13:19:58 -0700
IronPort-SDR: QNEqPLXJpTfY03BWTfU0vDzMRUbDeg/wdarwXz5CgLX+uoOWj+Ez17yeofahhObvuB2NvB5Gu9
 MQ1T3ZN2fqkg==
X-IronPort-AV: E=Sophos;i="5.81,251,1610438400"; d="scan'208";a="388213828"
Received: from jhou13-mobl.amr.corp.intel.com (HELO ldmartin-desk2)
 ([10.212.152.93])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2021 13:19:57 -0700
Date: Mon, 15 Mar 2021 13:19:57 -0700
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: Matt Roper <matthew.d.roper@intel.com>
Message-ID: <20210315201957.v2twunotva56ifna@ldmartin-desk2>
References: <20210311153415.3024607-1-matthew.d.roper@intel.com>
 <20210311153415.3024607-6-matthew.d.roper@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20210311153415.3024607-6-matthew.d.roper@intel.com>
Subject: Re: [Intel-gfx] [PATCH v2 05/23] drm/i915: Convert INTEL_GEN() to
...
On Thu, Mar 11, 2021 at 07:33:57AM -0800, Matt Roper wrote:
...
+1, particularly the hotplug part

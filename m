...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C01BA4C3A0E
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 01:06:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1955510E63B;
...
Subject: [Intel-gfx] [PATCH v2 5/8] drm/i915/guc: Move lrc desc setup to
 where it is needed

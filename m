...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F01094946E
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2024 17:23:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE78110E3A0;
	Tue,  6 Aug 2024 15:23:47 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="HLOd0IsY";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 453EC10E0B9;
 Tue,  6 Aug 2024 15:23:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1722957825; x=1754493825;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=1a+BhXYAu/Lm7+CCX4Vm0OQ4TFb73fliSrp3nsI3cCw=;
 b=HLOd0IsYKMg718hODmXs1ZSELCqFkFl4KDCoov1Xd7KXtkxGJFawgjPr
 ORCyJD/hz7Vqhvrc5StdqgakIDgHtBjPhIEQQAzk6LU5TItkxe334gaRh
 gSdaTkwHrfRmuYR9ycse99O8zSFQJFSjIlqppEGYboFP0v7EAVE+mx/nc
 u0WvmfNG86KESirGq9rxwTF0prTaPU8JNsgmq0SNh212ihT7238aMa4Vl
 xfeSyF3r0LgOx67vdyZt1JjZ8oC6HFtUcbUO8V1ltY4u6D35P6/j3ZXfq
 BWuW7uFwzxCpJK0lItI/UKRuIFtn7SMbhBuujqSvqjO2F7HKpMyTV+XvA w==;
X-CSE-ConnectionGUID: AogihCHjRJW6wVSrB3B7FQ==
X-CSE-MsgGUID: 2h1e6MiNT0GugA/EsChiaw==
X-IronPort-AV: E=McAfee;i="6700,10204,11156"; a="38489572"
X-IronPort-AV: E=Sophos;i="6.09,268,1716274800"; d="scan'208";a="38489572"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Aug 2024 08:23:45 -0700
X-CSE-ConnectionGUID: 5uf/sk+HR9WiQcLLTd5sxA==
X-CSE-MsgGUID: sApn7E3yST60Nse7ZkrPzA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,268,1716274800"; d="scan'208";a="87193387"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orviesa002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Aug 2024 08:23:42 -0700
Date: Tue, 6 Aug 2024 18:23:59 +0300
From: Imre Deak <imre.deak@intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org
Subject: Re: [PATCH 4/4] drm/i915/bios: convert to struct intel_display
Message-ID: <ZrJAD5GNEVuESsqw@ideak-desk.fi.intel.com>
References: <cover.1722444150.git.jani.nikula@intel.com>
 <eb5fe5495dbf6c687a0a861e375c0fe5fa88eb17.1722444150.git.jani.nikula@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <eb5fe5495dbf6c687a0a861e375c0fe5fa88eb17.1722444150.git.jani.nikula@intel.com>

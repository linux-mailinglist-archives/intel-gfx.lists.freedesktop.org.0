...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E8A764C99F0
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Mar 2022 01:34:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 14B5A10E91A;
...
Subject: [Intel-gfx] [PATCH v3 1/8] drm/i915/guc: Do not conflate lrc_desc

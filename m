...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F57A3B8614
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 17:11:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A63696EA39;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 11/17] drm/i915/display: Add handling for new

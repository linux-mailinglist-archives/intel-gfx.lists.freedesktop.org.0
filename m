...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D35C84EE960
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Apr 2022 09:55:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F3C110F522;
	Fri,  1 Apr 2022 07:55:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 21C3610F522;
 Fri,  1 Apr 2022 07:55:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1648799727; x=1680335727;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=vmNWGukdxce+NiJ9ZJij9VRTmINQ4D2gWY7bR6wcGeM=;
 b=USkqIOusw64e+2jjL1VnLL5rET3k8kLVU4wBSC4pvmoppHNpHT1W82l3
 fF0brnhXf569l8amTpbpkT6vYQ5UlYVIj8T5Rnztehd9ds6qsJ1Ot+xUu
 q2W4+Yqxm08hXheGb9MH2DFu08dcwt3inm6UBoSylFK1zBitN9bU11Rv1
 hMR12skcw9byyAaCbF6MML1TJiQOn0IDuZRqze8qhy4Knq0o6oV+wymqv
 VXueHPqEupgEaflP7Zt3yhV38AwTE3J0SUNSGe1jUmkKb9l3wUEAbUCdJ
 6n0c720AnPF9gVZH5Au6VNi9hJQLMdqx5NefND5no53uliwfUjB17SPId w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10303"; a="346509619"
X-IronPort-AV: E=Sophos;i="5.90,226,1643702400"; d="scan'208";a="346509619"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Apr 2022 00:55:26 -0700
X-IronPort-AV: E=Sophos;i="5.90,226,1643702400"; d="scan'208";a="522680643"
Received: from ewanhaye-mobl.ger.corp.intel.com (HELO [10.213.217.32])
 ([10.213.217.32])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Apr 2022 00:55:24 -0700
Message-ID: <9f22a5fc-ab2e-1ad2-6035-34907ad6b004@linux.intel.com>
Date: Fri, 1 Apr 2022 08:55:19 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220330232858.3204283-15-matthew.d.roper@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B2A15B81C6
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Sep 2022 09:07:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AA0110E5C7;
	Wed, 14 Sep 2022 07:07:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BBEA310E5C7
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Sep 2022 07:07:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663139261; x=1694675261;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Dt7iz2rnLV6NqyYax90pkJ1hBTdGNeZKbL12jU9Wd+c=;
 b=WS6qYIxKMSArH5FfR8XpNU11IoYUCX3Z9TOer6NApk9tzDvku/kSJm/Z
 tk93VyypGIFbDwNBbBKTLQpQe1Ktlz/W+4pPlpVOjSBnuh+0PK9l/oQGr
 vr0yGrjNbHUsQfdncbisyI4IqcLw4qt/YI2Xs9KGbqZaMywSl3Tk41c1r
 jrsU7fDNAcBWZxS7xtOEXiDp7NRdYzxpMHLubqECkLhmlBWoJjpcegVKq
 zQ+OnHDr8zj2IjdMtECKgxBPwVLHja3QiRBP1OF0Qgb3eKTzab9HczbnN
 YU0houKIL1oUPNL5W9Zd00JbJu6hhthKA1WHh8k9mfGWkBQEDF887D39N g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10469"; a="281389549"
X-IronPort-AV: E=Sophos;i="5.93,313,1654585200"; d="scan'208";a="281389549"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2022 00:07:41 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,313,1654585200"; d="scan'208";a="685202119"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga004.fm.intel.com with ESMTP; 14 Sep 2022 00:07:39 -0700
From: "Kandpal, Suraj" <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 14 Sep 2022 12:36:32 +0530
Message-Id: <20220914070634.1595778-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/3] drm/i915: Define WD trancoder for i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 49E0E426685
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Oct 2021 11:17:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C3C16E86C;
...
Subject: [Intel-gfx] [PATCH 1/5] dri: cleanup debugfs error handling

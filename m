...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A085E68B819
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Feb 2023 10:06:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 65B6D10E34B;
...
Subject: [Intel-gfx] [PATCH v2 11/14] vfio: Make vfio_device_open()

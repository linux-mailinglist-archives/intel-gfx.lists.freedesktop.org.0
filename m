...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17EBAA167B4
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2025 08:54:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A444A10E35A;
	Mon, 20 Jan 2025 07:54:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="M83lOMEd";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2855F10E35A
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Jan 2025 07:53:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1737359639; x=1768895639;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+PsplhKTjcw0iDSZq4EdxxO7DvtYqaP4BMHYdvmONUI=;
 b=M83lOMEdITIZWYHAG7t8kRCVog3ShnaqhyzzNymoE8MrzdwXq767urxK
 m73FxLn2RTbjuPI5hBwrgvV4fXUOJ/FASVacofNC69JYO09+7Ry0wuvYb
 dU5C7ryP/w2AisVseTFJV3gc5PE4slEdepx83jXMesPHdoNhFWeUAIpD+
 q/7eeeUXPajc8R0/VWhdnnYT7t245CLmQAZ63zM894huqh62monUacT/c
 FVfQIHwX2YuvgXMmbi5d13nim/iZjsz+KOxJpFPlfmmy5bUEBbpYLGZ0S
 albS+Yw3Qx5SmXSlih+taMI6rikHAOksAKCE6LUsf0zH7HiUvcaNGs+nM A==;
X-CSE-ConnectionGUID: x1ujf+dfTASEdgIAATiqpQ==
X-CSE-MsgGUID: y2RgDVejS2+0oB/OJTdlXQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11320"; a="25325834"
X-IronPort-AV: E=Sophos;i="6.13,218,1732608000"; d="scan'208";a="25325834"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2025 23:53:59 -0800
X-CSE-ConnectionGUID: lq0zp3JoTc+SG6EN1LEDjw==
X-CSE-MsgGUID: Z3/vGpRFQgmCr2Y0tPUJxA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="137317997"
Received: from nitin-super-server.iind.intel.com ([10.145.169.70])
 by fmviesa001.fm.intel.com with ESMTP; 19 Jan 2025 23:53:56 -0800
...
Subject: [PATCH v4 7/8] drm/i915/display: fix typos in i915/display files
Date: Mon, 20 Jan 2025 13:45:16 +0530
Message-Id: <20250120081517.3237326-8-nitin.r.gote@intel.com>

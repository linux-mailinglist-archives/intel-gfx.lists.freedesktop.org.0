...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 551AE6B35BE
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Mar 2023 05:50:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8405110E943;
...
Subject: Re: [Intel-gfx] [PATCH v6 07/24] vfio: Block device access via

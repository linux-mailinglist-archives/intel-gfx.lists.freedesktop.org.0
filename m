...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FE203CBD24
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jul 2021 22:00:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B16776EA17;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 25/51] drm/i915: Move active request tracking to
 a vfunc

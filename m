...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C67E416BA68
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Feb 2020 08:16:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D4BAE6E9E2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC][PATCH 1/5] drm: Introduce scaling filter property

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A47BF535B2B
	for <lists+intel-gfx@lfdr.de>; Fri, 27 May 2022 10:10:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A98610EECD;
	Fri, 27 May 2022 08:10:29 +0000 (UTC)
...
Subject: [Intel-gfx] [CI] Revert "drm/i915: Add relocation exceptions for
 two other platforms"

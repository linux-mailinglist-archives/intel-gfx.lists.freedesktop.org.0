...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A082667D77C
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Jan 2023 22:15:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 111E110E3BF;
...
Subject: [Intel-gfx] [PATCH] [v2] vfio-mdev: add back CONFIG_VFIO dependency
...
Cc: dri-devel@lists.freedesktop.org, Arnd Bergmann <arnd@arndb.de>,
 ...
 David Airlie <airlied@gmail.com>, Tomas Winkler <tomas.winkler@intel.com>,

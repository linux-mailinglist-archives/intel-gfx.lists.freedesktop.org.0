...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A8D12C6553
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:13:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 518D86EC9A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 126/162] drm/i915/gem: Update shmem
 available memory

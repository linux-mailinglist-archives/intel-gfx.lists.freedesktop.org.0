...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6649E01A6
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Oct 2019 12:10:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F018C6E558;
	Tue, 22 Oct 2019 10:10:11 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 2/5] drm/dsi: add missing DSI data types

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7617F93F03F
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Jul 2024 10:52:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09ECC10E347;
	Mon, 29 Jul 2024 08:52:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="bkayDoUA";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7F17510E33E;
 Mon, 29 Jul 2024 08:52:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1722243137; x=1753779137;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GABW/H87S38DagxO4mykHzFZC7UrdYF4tnXI5Tu9G9E=;
 b=bkayDoUAw9pp8O3GMLOh8fZOEi4ffrm44KytCrR/Z+wJcXcZYP7AqUVz
 48Q9/tGP4qBenqhPnd/MoFp9NHPo7xXgHmGQfqz0S0R26O78ZhoE7k9Ke
 KGDaohwm833maanyQLsqmGS3j0XIamw2tY/vFLeWpQwnyTIISFG8AhCT6
 NcY6pPbdKPBWeHyRhkgVPVvunataCon/gPhz4xOi1IUWCg1jM+98YMs/9
 1RkiYIFNDjiCMWC/YihcD/efbJBw3WhO6/XS+QFIyDzs2NqFRKgaRA4Vt
 /N+Hy4feM7iwzDeUuo/AjXeqM/aGLasW2jeeBUVZN4WvNVhq7l0wIs74n A==;
X-CSE-ConnectionGUID: xfETKnpORIWmbGr04SE+rg==
X-CSE-MsgGUID: DlfK7c4eQ9WsZ/VUu4mjKQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11147"; a="20129836"
X-IronPort-AV: E=Sophos;i="6.09,245,1716274800"; d="scan'208";a="20129836"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,245,1716274800"; d="scan'208";a="54708433"

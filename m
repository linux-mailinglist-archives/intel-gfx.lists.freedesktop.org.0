...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84078304B9E
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Jan 2021 22:44:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BF3889AC6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 1/9] cgroup: Introduce cgroup for drm
 subsystem

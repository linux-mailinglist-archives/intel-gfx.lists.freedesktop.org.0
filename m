...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 844DD3E44DE
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Aug 2021 13:29:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE46B89991;
...
Subject: Re: [Intel-gfx] [PATCH 04/21] drm/i915/gvt: move the gvt code into
 kvmgt.ko

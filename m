...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D1B76EB0AB
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 19:37:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7532F10EE9F;
	Fri, 21 Apr 2023 17:36:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5863810EE73;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=PblLXsKbBGhU3VCfozS7eVLnxh6gZJxLqhADz/N2RJ0=;
 b=lHr+dNi0yQymP9wVPvv21FXZlDC6702wlkRgyCEg+wQVJj7vOuUKZRFm
 ncV+xV28vxSk6RV0Q4t5e6nV2IBjrJNqBQv4EYHg5IgW6kdOQA79dl6sp
 Sxk1Z/67aj9D0LVbEJOzzsWbamo1G1AZFhodXe+kND1uqKt/4HgHr/cHI
 XQlI84Ve89unhxWzpGdWnoOrTeFwcNW96Y1Uwk+vZa9vcihcWsK1N8DRl
 u7hsoOUHnhvpPT8uxn3I7OmmM4AzswVm1gt1br2Q5XErqWZ6yzk5hcax+
 BFuV8J404tCH1dk/GJI0JAJYbjUe/DKkwK25R8RxOzUMu/SwIDIbuK6eI w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10687"; a="347949461"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="347949461"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 10:36:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10687"; a="669794800"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="669794800"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 10:36:49 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Fri, 21 Apr 2023 10:37:57 -0700
Message-Id: <20230421173801.3369303-5-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 4/8] drm/i915: preparation for using PAT index

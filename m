...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B1A86F5977
	for <lists+intel-gfx@lfdr.de>; Wed,  3 May 2023 16:01:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4CD0110E16F;
	Wed,  3 May 2023 14:01:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from www262.sakura.ne.jp (www262.sakura.ne.jp [202.181.97.72])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EB58510E0CB;
 Wed,  3 May 2023 14:01:02 +0000 (UTC)
Received: from fsav315.sakura.ne.jp (fsav315.sakura.ne.jp [153.120.85.146])
 by www262.sakura.ne.jp (8.15.2/8.15.2) with ESMTP id 343E0mUO016993;
 Wed, 3 May 2023 23:00:49 +0900 (JST)
 (envelope-from penguin-kernel@I-love.SAKURA.ne.jp)
Received: from www262.sakura.ne.jp (202.181.97.72)
 by fsav315.sakura.ne.jp (F-Secure/fsigk_smtp/550/fsav315.sakura.ne.jp);
 Wed, 03 May 2023 23:00:48 +0900 (JST)
X-Virus-Status: clean(F-Secure/fsigk_smtp/550/fsav315.sakura.ne.jp)
Received: from [192.168.1.6] (M106072142033.v4.enabler.ne.jp [106.72.142.33])
 (authenticated bits=0)
 by www262.sakura.ne.jp (8.15.2/8.15.2) with ESMTPSA id 343E0mQv016987
 (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=NO);
 Wed, 3 May 2023 23:00:48 +0900 (JST)
 (envelope-from penguin-kernel@I-love.SAKURA.ne.jp)
Message-ID: <87a0ab95-d3d2-91b3-1e89-aca3f86a99f5@I-love.SAKURA.ne.jp>
Date: Wed, 3 May 2023 23:00:47 +0900
MIME-Version: 1.0
...
Subject: [Intel-gfx] [PATCH v3] drm/i915: avoid flush_scheduled_work() usage
...
@@ -5158,7 +5158,7 @@ static void intel_dp_oob_hotplug_event(struct drm_connector *connector)
...
index e92c62bcc9b8..91e949f985fa 100644
--- a/drivers/gpu/drm/i915/display/intel_dp_link_training.c
+++ b/drivers/gpu/drm/i915/display/intel_dp_link_training.c
@@ -1144,7 +1144,7 @@ static void intel_dp_schedule_fallback_link_training(struct intel_dp *intel_dp,
 	}
...
index 650232c4892b..e5355b71765c 100644
--- a/drivers/gpu/drm/i915/display/intel_hdcp.c
+++ b/drivers/gpu/drm/i915/display/intel_hdcp.c
@@ -1037,7 +1037,7 @@ static void intel_hdcp_update_value(struct intel_connector *connector,
 	hdcp->value = value;
 	if (update_property) {
...
@@ -2137,11 +2137,11 @@ static void intel_hdcp_check_work(struct work_struct *work)
 		return;
...
@@ -2386,7 +2386,7 @@ int intel_hdcp_enable(struct intel_connector *connector,
 	}
...
@@ -2478,7 +2478,7 @@ void intel_hdcp_update_pipe(struct intel_atomic_state *state,
 		 */
...
@@ -2599,5 +2599,5 @@ void intel_hdcp_handle_cp_irq(struct intel_connector *connector)
...
index b12900446828..922b44876cff 100644
...
+		queue_delayed_work(i915_wq, &dev_priv->display.hotplug.hotplug_work, 0);
 ...
 /**
@@ -686,7 +686,7 @@ void intel_hpd_poll_enable(struct drm_i915_private *dev_priv)
...
+	queue_work(i915_wq, &dev_priv->display.hotplug.poll_init_work);
 ...
 /**
@@ -714,7 +714,7 @@ void intel_hpd_poll_disable(struct drm_i915_private *dev_priv)
 		return;
...
index 4f0b0cca03cc..125eb48427b8 100644
...
index c0f3ff4746ad..9705affdfdb1 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt_irq.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt_irq.c
@@ -359,7 +359,7 @@ static void gen7_parity_error_irq_handler(struct intel_gt *gt, u32 iir)
...
index 80968e49e2c3..b2292c2b3db1 100644
--- a/drivers/gpu/drm/i915/gt/intel_rps.c
+++ b/drivers/gpu/drm/i915/gt/intel_rps.c
@@ -132,12 +132,12 @@ static void rps_timer(struct timer_list *t)
...
@@ -972,7 +972,7 @@ static int rps_set_boost_freq(struct intel_rps *rps, u32 val)
 	}
...
@@ -1024,7 +1024,7 @@ void intel_rps_boost(struct i915_request *rq)
...
+				queue_work(i915_wq, &slpc->boost_work);
 			...
 			return;
@@ -1040,7 +1040,7 @@ void intel_rps_boost(struct i915_request *rq)
 			 rq->fence.context, rq->fence.seqno);
...
@@ -1899,7 +1899,7 @@ void gen11_rps_irq_handler(struct intel_rps *rps, u32 pm_iir)
...
@@ -1916,7 +1916,7 @@ void gen6_rps_irq_handler(struct intel_rps *rps, u32 pm_iir)
 		gen6_gt_pm_mask_irq(gt, events);
 		rps->pm_iir |= events;

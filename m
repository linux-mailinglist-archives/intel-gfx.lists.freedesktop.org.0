...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75F471A26C6
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Apr 2020 18:08:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43DDD6EA86;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 0/5] Introduce drm scaling filter property

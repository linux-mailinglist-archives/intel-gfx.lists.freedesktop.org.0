...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45C4F2A48AE
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Nov 2020 15:54:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4CBA6ECCA;
	Tue,  3 Nov 2020 14:54:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8CA7F6ECCA
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Nov 2020 14:54:30 +0000 (UTC)
IronPort-SDR: 2CYX+3Z3MeJsZnNyBvxrn8lRmQOlXkVo5yQwZTN6LS/0CEeOxXpqlnZ1/O9cko8ziedH4gcpTD
 uYONFRurv30w==
X-IronPort-AV: E=McAfee;i="6000,8403,9793"; a="230690855"
X-IronPort-AV: E=Sophos;i="5.77,448,1596524400"; d="scan'208";a="230690855"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Nov 2020 06:54:30 -0800
IronPort-SDR: HTDp7Tbirf5Qg288PHizLac4LqPz23i5usiUV5b3HeRAjk+uAb8C7xir9bccPk83YV5QNAYztX
 qXZmEv8i9ExQ==
X-IronPort-AV: E=Sophos;i="5.77,448,1596524400"; d="scan'208";a="470824365"
Received: from linux-desktop.iind.intel.com ([10.223.34.173])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Nov 2020 06:54:28 -0800
From: Uma Shankar <uma.shankar@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  3 Nov 2020 20:58:32 +0530
Message-Id: <20201103152834.12727-11-uma.shankar@intel.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20201103152834.12727-1-uma.shankar@intel.com>
References: <20201103152834.12727-1-uma.shankar@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [v9 10/12] drm/i915/lspcon: Create separate
...
ZWxfZGRpLmMKaW5kZXggMTliMTY1MTdhNTAyLi5kNTBkZDFmMTI5MmEgMTAwNjQ0Ci0tLSBhL2Ry
...
Yi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2xzcGNvbi5jCmluZGV4IDhhNGZk
OGNhODAxNi4uOWM4ZGZkMmZiOTQ5IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9k
...
QCAtNjY3LDYgKzY2OCwyMyBAQCBib29sIGxzcGNvbl9pbml0KHN0cnVjdCBpbnRlbF9kaWdpdGFs
...


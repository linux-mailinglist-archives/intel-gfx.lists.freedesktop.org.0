...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A3C6B7A995
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jul 2019 15:31:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 276BE6E50D;
	Tue, 30 Jul 2019 13:30:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EB3616E50E
 for <intel-gfx@lists.freedesktop.org>; Tue, 30 Jul 2019 13:30:55 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17730643-1500050 
 for multiple; Tue, 30 Jul 2019 14:30:38 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 30 Jul 2019 14:30:26 +0100
Message-Id: <20190730133035.1977-9-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/17] drm/i915: Remove lrc default desc from
 GEM context
...
L2k5MTUvZ3QvaW50ZWxfbHJjLmMKaW5kZXggNTE4MWQyOWQyNzJlLi4yMzJmNDBmY2I0OTAgMTAw
NjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2xyYy5jCisrKyBiL2RyaXZl
cnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2xyYy5jCkBAIC00MTcsMTMgKzQxNywxNyBAQCBscmNf
...
L2k5MTUvZ3Z0L3NjaGVkdWxlci5jCmluZGV4IGY0MDUyNGIwZTMwMC4uMzJhZTZiNWI3ZTE2IDEw

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A0FB3182E48
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Mar 2020 11:51:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03FEE6EA65;
	Thu, 12 Mar 2020 10:51:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C92626E141;
 Thu, 12 Mar 2020 10:51:35 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga102.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 12 Mar 2020 03:51:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,544,1574150400"; 
 d="gz'50?scan'50,208,50";a="443884860"
Received: from lkp-server01.sh.intel.com (HELO lkp-server01) ([10.239.97.150])
 by fmsmga006.fm.intel.com with ESMTP; 12 Mar 2020 03:51:33 -0700
Received: from kbuild by lkp-server01 with local (Exim 4.89)
 (envelope-from <lkp@intel.com>)
 id 1jCLR6-0001kY-Ij; Thu, 12 Mar 2020 18:51:32 +0800
Date: Thu, 12 Mar 2020 18:50:52 +0800
From: kbuild test robot <lkp@intel.com>
Message-ID: <202003121839.n6ANEZ0C%lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="82I3+IH0IqGh5yIs"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
User-Agent: Mutt/1.10.1 (2018-07-13)
Subject: [Intel-gfx] [drm-tip:drm-tip 1296/1354] include/linux/list.h:132:
 undefined reference to `drm_dev_printk'
...
commit: d3bd37f587b4438d47751d0f1d5aaae3d39bd416 [1296/1354] Merge v5.6-rc5 into drm-next
config: riscv-randconfig-a001-20200312 (attached as .config)
compiler: riscv32-linux-gcc (GCC) 9.2.0
reproduce:
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        git checkout d3bd37f587b4438d47751d0f1d5aaae3d39bd416
...
vim +132 include/linux/list.h

c8af5cd75e2411 Toke Høiland-Jørgensen 2019-06-28  129  
3c18d4de86e4a7 Linus Torvalds         2011-02-18  130  static inline void __list_del_entry(struct list_head *entry)
3c18d4de86e4a7 Linus Torvalds         2011-02-18  131  {
0cd340dcb05c4a Kees Cook              2016-08-17 @132  	if (!__list_del_entry_valid(entry))
0cd340dcb05c4a Kees Cook              2016-08-17  133  		return;
0cd340dcb05c4a Kees Cook              2016-08-17  134  
3c18d4de86e4a7 Linus Torvalds         2011-02-18  135  	__list_del(entry->prev, entry->next);
3c18d4de86e4a7 Linus Torvalds         2011-02-18  136  }
...
H4sICB4Kal4AAy5jb25maWcAlFzdc9u2sn/vX6FJX86ZM2klO3Gbe8cPIAhSqEiCAUDJ8gvH

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DF9B2DBAB8
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Dec 2020 06:37:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75E2A89DE5;
...
Subject: [Intel-gfx] [PATCH v5 05/15] drm/dp_helper: Add support for link
 failure detection

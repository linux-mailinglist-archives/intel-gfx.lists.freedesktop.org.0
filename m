...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7617D445E41
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Nov 2021 04:05:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B7766E52E;
	Fri,  5 Nov 2021 03:05:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x832.google.com (mail-qt1-x832.google.com
 [IPv6:2607:f8b0:4864:20::832])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 33CC26E529
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 Nov 2021 03:05:00 +0000 (UTC)
Received: by mail-qt1-x832.google.com with SMTP id v4so6087923qtw.8
 for <intel-gfx@lists.freedesktop.org>; Thu, 04 Nov 2021 20:05:00 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=DK7UwuojytY42/n2WBNpPwwQYXGNlPVbSvvDhtACYyk=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=DK7UwuojytY42/n2WBNpPwwQYXGNlPVbSvvDhtACYyk=;
 b=
X-Gm-Message-State: AOAM530jrgY+fPHIPj0wFyZFydPVNFQ7d5COmXpmrPdFuZ7Y5Gn989qJ
 kw7eUtSBARyfElke5e7r0lCD5qI5RyRBlA==
X-Google-Smtp-Source: ABdhPJzc7evTphTGJuIPNsE+xX6AF3dQkZ+c1MMZBMjQdT1C3FbvSDW5CFyCgMhlW/auUFu4o/YHcw==
X-Received: by 2002:a05:622a:15d2:: with SMTP id
 d18mr1421464qty.145.1636081499020; 
 Thu, 04 Nov 2021 20:04:59 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id i67sm4681092qkd.90.2021.11.04.20.04.58
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 04 Nov 2021 20:04:58 -0700 (PDT)
From: Sean Paul <sean@poorly.run>
To: dri-devel@lists.freedesktop.org, intel-gfx@lists.freedesktop.org,
 freedreno@lists.freedesktop.org
Date: Thu,  4 Nov 2021 23:04:21 -0400
Message-Id: <20211105030434.2828845-5-sean@poorly.run>
X-Mailer: git-send-email 2.33.1
In-Reply-To: <20211105030434.2828845-1-sean@poorly.run>
References: <20211105030434.2828845-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v4 04/14] drm/hdcp: Expand HDCP helper library

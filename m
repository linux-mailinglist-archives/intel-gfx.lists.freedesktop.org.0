...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4781A71F6C
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Jul 2019 20:39:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D4056E397;
	Tue, 23 Jul 2019 18:39:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 916BE6E397
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Jul 2019 18:39:00 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17542611-1500050 
 for multiple; Tue, 23 Jul 2019 19:38:44 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 Jul 2019 19:38:26 +0100
Message-Id: <20190723183842.20372-7-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/23] drm/i915/gt: Move the [class][inst]
...
IDE4YjIyNmJjNWUzYS4uZTMxNDMxZmExNDFlIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
...
Y2x1ZGUgImk5MTVfZ2xvYmFscy5oIgpAQCAtMTc0MCw3ICsxNzQxLDcgQEAgZ2V0X2VuZ2luZXMo
...
Z2luZV9jcy5jCmluZGV4IDY1Y2JmMWQ5MTE4ZC4uZWQ1YzRlMTYxZTZlIDEwMDY0NAotLS0gYS9k
...
OTE1LT5ndCwgaSk7CiAJCWlmIChlcnIpCiAJCQlnb3RvIGNsZWFudXA7CiAKQEAgLTE1MDEsMjkg
KzE1MDMsNiBAQCB2b2lkIGludGVsX2VuZ2luZV9kdW1wKHN0cnVjdCBpbnRlbF9lbmdpbmVfY3Mg
...
ZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuaAppbmRleCAyNjlhMWIzMmI0OGIuLjEyYTdm
ZGFiYzJmMCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuaAorKysg
...


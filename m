...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BA447CE3B1
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:06:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BA6410E41F;
...
Subject: [Intel-gfx] [PATCH v7c 12/24] dyndbg: reduce verbose=3 messages in
 ddebug_add_module

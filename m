...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B49F4E5697
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Mar 2022 17:36:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C10D510E6E9;
...
Subject: Re: [Intel-gfx] [RFC 19/19] drm/edid: sunset

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FB302E64B3
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Dec 2020 16:53:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E746589B55;
	Mon, 28 Dec 2020 15:53:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7B20E899F2
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Dec 2020 15:52:52 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23448202-1500050 
 for multiple; Mon, 28 Dec 2020 15:52:36 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Dec 2020 15:51:59 +0000
Message-Id: <20201228155229.9516-24-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 24/54] drm/i915: Extract request submission from
 execlists
...
index 9eaa3dc47af3..198e5a9eb6fd 100644
--- a/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
@@ -2366,59 +2366,6 @@ static void execlists_preempt(struct timer_list *timer)
...
-
 static int execlists_context_pre_pin(struct intel_context *ce,
 				     ...
 				     void **vaddr)
@@ -3047,7 +2994,7 @@ static void execlists_park(struct intel_engine_cs *engine)

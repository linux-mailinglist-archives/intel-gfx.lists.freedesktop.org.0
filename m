...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DF0C436744D
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Apr 2021 22:48:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CAFC189EAC;
	Wed, 21 Apr 2021 20:48:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9192B89EAC
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Apr 2021 20:48:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1619038100;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=oTEm1YXuZr+fTIidrGX5xV4gZuwXWTzwVM8yjhpC2tQ=;
 b=cNqW/xg0ZHrcCkYW/eOs8YP4YqEBETem/AsXEoTID0wQyWOJgqgsRuV4Rr302piWII2iPZ
 zQMTLsMn21PgzCjJVL+EG/KtEJwdkStdTcdmuqJAmUpRqTcgwEF3Hj469Bw031IgJYNsgM
 xPmTFFSUNyTQoSd+T6byzMtPj312q5g=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-599--o8aPW3MOVexv9hEdrFFcg-1; Wed, 21 Apr 2021 16:48:16 -0400
X-MC-Unique: -o8aPW3MOVexv9hEdrFFcg-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com
 [10.5.11.15])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 5A296107ACC7;
 Wed, 21 Apr 2021 20:48:13 +0000 (UTC)
Received: from x1.localdomain (ovpn-112-17.ams2.redhat.com [10.36.112.17])
 by smtp.corp.redhat.com (Postfix) with ESMTP id E1D255D736;
...
Date: Wed, 21 Apr 2021 22:47:56 +0200
Message-Id: <20210421204804.589962-2-hdegoede@redhat.com>
In-Reply-To: <20210421204804.589962-1-hdegoede@redhat.com>
References: <20210421204804.589962-1-hdegoede@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.15
Subject: [Intel-gfx] [PATCH v2 1/9] drm/connector: Add support for

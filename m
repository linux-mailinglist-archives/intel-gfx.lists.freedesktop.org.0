...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 506684E99C5
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 16:35:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2793D10E665;
...
Subject: [Intel-gfx] [PATCH v3 09/12] drm/edid: constify struct edid passed
 to detailed blocks

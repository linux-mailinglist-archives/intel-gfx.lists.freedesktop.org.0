...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0737A3D43DC
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Jul 2021 02:12:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3FBDE6FD46;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 28/30] drm/i915: rename/remove CNL registers

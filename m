...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19359885C62
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Mar 2024 16:45:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36AB710EE00;
	Thu, 21 Mar 2024 15:45:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Ah/02rcs";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7CB1810EE08
 for <intel-gfx@lists.freedesktop.org>; Thu, 21 Mar 2024 15:44:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1711035899; x=1742571899;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=nVu2F5U0ydMo+OyVkUSSqAf/Q0FpfKAQvXOllcxjubA=;
 b=Ah/02rcskDmKUmhZ48/uWhHHdPaw7k3lA0Df0J5PKym8HDEf5kgdcMvb
 lwEWQ1rR2i6u8zZPC0XXdqYkvlIqicvrJyW7EFAJpq/QvRjWFnBHGllWP
 2QPNte2njsKiUbPuO8HnScH5SXMDMzHcPDPvpkGooeSE7O6tvs96sdHAM
 cB/3PQqgoCtpzL9YEc7isvr6zMojdVJaEI9r/jPFjdpLDCDzvl8Xxm5Rh
 Ntn2O/cSGUPlJefHPJxS6HO6W6CuxGxERkftEXD3uvjKXfuWbC0BTL959
 9lPScxBfgQNXNde47vrLAsAvUfMLUfIBxpph9OSIjsB9zuQ/1Cql6NGp6 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,11020"; a="5867559"
X-IronPort-AV: E=Sophos;i="6.07,143,1708416000"; 
   d="scan'208";a="5867559"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Mar 2024 08:44:59 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,143,1708416000"; d="scan'208";a="19018748"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmviesa005.fm.intel.com with ESMTP; 21 Mar 2024 08:44:57 -0700
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>,
 Ankit Nautiyal <ankit.k.nautiyal@intel.com>
Subject: [PATCH v18 2/9] drm: Add Adaptive Sync SDP logging
Date: Thu, 21 Mar 2024 21:08:16 +0530
Message-Id: <20240321153828.3815870-3-mitulkumar.ajitkumar.golani@intel.com>

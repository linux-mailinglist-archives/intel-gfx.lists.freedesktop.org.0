...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66F621465A8
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 11:23:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B19336FBC8;
...
Subject: [Intel-gfx] [PATCH v2 2/6] drm/i915/ddi: convert to struct

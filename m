...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 674BF23462F
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jul 2020 14:51:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 721BD6EA82;
...
Subject: [Intel-gfx] [PATCH 3/6] drm/xen-front: Add YUYV to supported formats

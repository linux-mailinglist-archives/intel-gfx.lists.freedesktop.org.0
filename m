...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FB55298467
	for <lists+intel-gfx@lfdr.de>; Sun, 25 Oct 2020 23:23:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E5C8C6E0EE;
...
Subject: Re: [Intel-gfx] [PATCH] drm/<drivers>: Constify struct drm_driver

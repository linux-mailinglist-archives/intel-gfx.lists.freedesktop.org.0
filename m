...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF9E21594B9
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Feb 2020 17:22:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 533C26EEAB;
	Tue, 11 Feb 2020 16:22:13 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 0/7] drm: Try to fix encoder

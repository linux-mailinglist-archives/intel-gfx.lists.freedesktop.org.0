...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2635D3A069
	for <lists+intel-gfx@lfdr.de>; Sat,  8 Jun 2019 17:27:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 934368925D;
...
Subject: [Intel-gfx] [PATCH v8 4/5] drm/client: Hack: Add bootsplash example

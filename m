...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 642E14DD4C7
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Mar 2022 07:41:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2592010E93E;
...
Subject: [Intel-gfx] [PATCH v12 07/13] drm/i915/guc: Update GuC-log relay
 function names

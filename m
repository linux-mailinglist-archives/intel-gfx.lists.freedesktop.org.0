...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 513B64E6163
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Mar 2022 10:57:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AA3F10E2FB;
...
Subject: Re: [Intel-gfx] [v3] drm/edid: check basic audio support on CEA
 extension block

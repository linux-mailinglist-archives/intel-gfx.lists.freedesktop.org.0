...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FA621F0DEE
	for <lists+intel-gfx@lfdr.de>; Sun,  7 Jun 2020 20:19:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 92E2C6E25D;
	Sun,  7 Jun 2020 18:19:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-1.mimecast.com
 [207.211.31.81])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 07F606E21A
 for <intel-gfx@lists.freedesktop.org>; Sun,  7 Jun 2020 18:19:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1591553973;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=aD0U0nj+eoOBxkRm+vQR3prqd59NNlNzFOHiBlv90gk=;
 b=UpxIkpidwSlrcoatHnUjtOBq2+G2h1GCSRhMdaS6i/lHrq/ToroRnv0VEZCHsHXUL/ring
 sttsWrAzXdVl8E0QyjaKIz1dKcbPXJw/feuQzKw8bdGwtqpwxoEF7CNyLM8dOKr5iSYgR1
 zs82gjyilMe4bRFdrqIh7sXWy9Q8D0s=
...
Subject: [Intel-gfx] [PATCH v2 14/15] drm/i915: panel: Honor the VBT PWM min

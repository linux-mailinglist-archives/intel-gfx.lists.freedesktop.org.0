...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D37595F98DC
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Oct 2022 09:00:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 72C6B10E6E0;
	Mon, 10 Oct 2022 06:59:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 283C310E633;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=Y4g4KDlAfuMfl5ya1x+XINcLM3XHjB+OpkE1/pYqOEw=;
 b=PZpU9auvF+Uf2w4rvxgtBnOOrjk3yjfPrI+WX/p7jy71K6q7hdfOS/NO
 yXpbiPkKQ8ILqANccgafK0pNtj+cXovkqTXZREMZXgSOYRfru/aMI8ze+
 wPQXf3CuaoQi0LHDEB1BFHWCJcFLN5Nlr47rwJ2c2Lkum8NVkOBh7kyQx
 yR59pdUxRn3FYisS42JAbN46nX/5FRpfRY5111e1IKrtJirTVSX/GBiJr
 /0l0REZsmDcNeLplslv2lI+c3mbibACSwPJrYtFgRpT6WjsYNxQ8stRgJ
 FIFuSgXfkEFiB6Uy+QY+q98YLHCQpEOqS1Qf5IIt0vLYhIERUQQTIcyi3 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10495"; a="305753016"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="305753016"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2022 23:58:56 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10495"; a="576947164"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="576947164"
...
Date: Sun,  9 Oct 2022 23:58:20 -0700
Message-Id: <20221010065826.32037-12-niranjana.vishwanathapura@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 11/17] drm/i915/vm_bind: Use common execbuf

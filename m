...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 687F861EF4
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 14:54:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6854C890BB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 15/19] drm/i915: Simplify skl_max_scale()

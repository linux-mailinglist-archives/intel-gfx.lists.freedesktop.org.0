...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A14134083D7
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Sep 2021 07:35:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D15A6E0DB;
	Mon, 13 Sep 2021 05:35:17 +0000 (UTC)
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v2 3/6] drm/edid: abstract OUI conversion to
 24-bit int

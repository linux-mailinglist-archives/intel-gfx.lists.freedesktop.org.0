...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B2F5A58EEB5
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Aug 2022 16:46:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE9DF9B3A2;
	Wed, 10 Aug 2022 14:46:24 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/drm_edid: Refactor HFVSDB parsing for
 DSC1.2

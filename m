...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0E6B29A4F8
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Oct 2020 07:57:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 10A5C6EB18;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v3 13/16] drm/i915/hdcp: Pass connector to
 check_2_2_link

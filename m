...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02AEA144304
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Jan 2020 18:20:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E6F356EDE7;
...
Subject: [Intel-gfx] [PATCH 0/6] conversion to struct drm_device logging
 macros.

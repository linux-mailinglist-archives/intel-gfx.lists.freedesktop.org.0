...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BBC7B3AAC55
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Jun 2021 08:31:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 076EC6E88D;
	Thu, 17 Jun 2021 06:31:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 45A546E887;
 Thu, 17 Jun 2021 06:30:56 +0000 (UTC)
IronPort-SDR: jB20jkkAUT1eHB/BfGmfCCvGEfwcNO2RK4qBkIIfZfjdoTjfgQFczLWh72ElfY7P+DSWrCMZHO
 GvNuIFky6p2w==
X-IronPort-AV: E=McAfee;i="6200,9189,10017"; a="203287865"
X-IronPort-AV: E=Sophos;i="5.83,278,1616482800"; d="scan'208";a="203287865"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2021 23:30:55 -0700
IronPort-SDR: /KrcR/QFH3cGPXi8e3QBHrHvtTlZIwcHoylCmPGFo79gurOU6t+Eb6cj9r2v7tF5L67IEcLhst
 U4foInYfvqnQ==
X-IronPort-AV: E=Sophos;i="5.83,278,1616482800"; d="scan'208";a="554302764"
Received: from vanderss-mobl.ger.corp.intel.com (HELO thellst-mobl1.intel.com)
 ([10.249.254.193])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2021 23:30:54 -0700
From: =?UTF-8?q?Thomas=20Hellstr=C3=B6m?= <thomas.hellstrom@linux.intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Thu, 17 Jun 2021 08:30:18 +0200
Message-Id: <20210617063018.92802-13-thomas.hellstrom@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 12/12] drm/i915/gem: Zap the
...
cm0vaTkxNS9NYWtlZmlsZQppbmRleCBmZmExNDA4NDQzMmMuLjAxZjI4YWQ1ZWE1NyAxMDA2NDQK
...
eCAxMThhNjZjMjk2OTUuLmVjYzNiOWU2YzIyYiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJt
L2k5MTUvc2VsZnRlc3RzL2ludGVsX21lbW9yeV9yZWdpb24uYworKysgYi9kcml2ZXJzL2dwdS9k
cm0vaTkxNS9zZWxmdGVzdHMvaW50ZWxfbWVtb3J5X3JlZ2lvbi5jCkBAIC0xNSwxMiArMTUsMTMg
...
dXNlci5oIgogI2luY2x1ZGUgImd0L2ludGVsX2d0LmgiCiAjaW5jbHVkZSAiaTkxNV9idWRkeS5o
IgorI2luY2x1ZGUgImd0L2ludGVsX21pZ3JhdGUuaCIKICNpbmNsdWRlICJpOTE1X21lbWNweS5o
...

...
cHV0KGVuZ2luZSk7CisJaWYgKCFlcnIpCisJCWVyciA9IGk5MTVfZ2VtX29iamVjdF9zZXRfdG9f
d2NfZG9tYWluKG9iaiwgdHJ1ZSk7CiAJaTkxNV9nZW1fb2JqZWN0X3VubG9jayhvYmopOwogCWlm
IChlcnIpCiAJCWdvdG8gb3V0X3VucGluOwotLSAKMi4zMS4xCgpfX19fX19fX19fX19fX19fX19f

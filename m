...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B5C37ADCD7B
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Jun 2025 15:36:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CB2610E6EC;
	Tue, 17 Jun 2025 13:36:11 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=ibm.com header.i=@ibm.com header.b="Ahc5gu2x";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx0a-001b2d01.pphosted.com (mx0a-001b2d01.pphosted.com
 [148.163.156.1])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EF29510E0CD;
 Mon, 16 Jun 2025 23:25:14 +0000 (UTC)
...
CC: "xiang@kernel.org" <xiang@kernel.org>, "codalist@coda.cs.cmu.edu"
 ...
 "miklos@szeredi.hu" <miklos@szeredi.hu>, "linux-unionfs@vger.kernel.org"
 <linux-unionfs@vger.kernel.org>, "amir73il@gmail.com" <amir73il@gmail.com>,
 "slava@dubeyko.com" <slava@dubeyko.com>,
 Hans De Goede <hdegoede@redhat.com>,
 "asmadeus@codewreck.org" <asmadeus@codewreck.org>, "simona@ffwll.ch"
 <simona@ffwll.ch>, "jth@kernel.org" <jth@kernel.org>, "shaggy@kernel.org"
 <shaggy@kernel.org>, "willy@infradead.org" <willy@infradead.org>,
 "linux-erofs@lists.ozlabs.org" <linux-erofs@lists.ozlabs.org>,
 "jaharkes@cs.cmu.edu" <jaharkes@cs.cmu.edu>, "tursulin@ursulin.net"
 <tursulin@ursulin.net>, "trondmy@kernel.org" <trondmy@kernel.org>,
 "ecryptfs@vger.kernel.org" <ecryptfs@vger.kernel.org>, "ericvh@kernel.org"
 <ericvh@kernel.org>, "joonas.lahtinen@linux.intel.com"
 <joonas.lahtinen@linux.intel.com>, "hirofumi@mail.parknet.co.jp"
 <hirofumi@mail.parknet.co.jp>, "linux-nilfs@vger.kernel.org"
 <linux-nilfs@vger.kernel.org>, Xiubo Li <xiubli@redhat.com>,
 "aivazian.tigran@gmail.com" <aivazian.tigran@gmail.com>,
 "hubcap@omnibond.com" <hubcap@omnibond.com>, "linux-kernel@vger.kernel.org"
 <linux-kernel@vger.kernel.org>, "intel-gfx@lists.freedesktop.org"
 <intel-gfx@lists.freedesktop.org>, "sfrench@samba.org" <sfrench@samba.org>,
 "jfs-discussion@lists.sourceforge.net"
 <jfs-discussion@lists.sourceforge.net>,
 "clm@fb.com" <clm@fb.com>, "jlbec@evilplan.org" <jlbec@evilplan.org>,
 "lihongbo22@huawei.com" <lihongbo22@huawei.com>, "ronniesahlberg@gmail.com"
 <ronniesahlberg@gmail.com>, "lucho@ionkov.net" <lucho@ionkov.net>,
 ...
 "tom@talpey.com" <tom@talpey.com>, "mikulas@artax.karlin.mff.cuni.cz"
 <mikulas@artax.karlin.mff.cuni.cz>, "bcrl@kvack.org" <bcrl@kvack.org>,
 "linux-afs@lists.infradead.org" <linux-afs@lists.infradead.org>,
 "mark@fasheh.com" <mark@fasheh.com>, "linux-mtd@lists.infradead.org"
 <linux-mtd@lists.infradead.org>, "linux-nfs@vger.kernel.org"
 <linux-nfs@vger.kernel.org>, "bharathsm@microsoft.com"
 <bharathsm@microsoft.com>, "linux-ext4@vger.kernel.org"
 <linux-ext4@vger.kernel.org>, "linux-f2fs-devel@lists.sourceforge.net"
 <linux-f2fs-devel@lists.sourceforge.net>, "tytso@mit.edu" <tytso@mit.edu>,
 "martin@omnibond.com" <martin@omnibond.com>, "jefflexu@linux.alibaba.com"
 <jefflexu@linux.alibaba.com>,
 "naohiro.aota@wdc.com" <naohiro.aota@wdc.com>,
 "frank.li@vivo.com" <frank.li@vivo.com>, "nvdimm@lists.linux.dev"
 <nvdimm@lists.linux.dev>, "dsterba@suse.com" <dsterba@suse.com>,
 "pc@manguebit.org" <pc@manguebit.org>, "dwmw2@infradead.org"
 <dwmw2@infradead.org>, "code@tyhicks.com" <code@tyhicks.com>,
 "ocfs2-devel@lists.linux.dev" <ocfs2-devel@lists.linux.dev>,
 "linux-aio@kvack.org" <linux-aio@kvack.org>, "idryomov@gmail.com"
 <idryomov@gmail.com>, "dlemoal@kernel.org" <dlemoal@kernel.org>,
 "linux-btrfs@vger.kernel.org" <linux-btrfs@vger.kernel.org>,
 "viro@zeniv.linux.org.uk" <viro@zeniv.linux.org.uk>, "zbestahu@gmail.com"
 <zbestahu@gmail.com>, "linux-cifs@vger.kernel.org"
 <linux-cifs@vger.kernel.org>, "johannes@sipsolutions.net"
 <johannes@sipsolutions.net>, David Howells <dhowells@redhat.com>,
 "linux-fsdevel@vger.kernel.org" <linux-fsdevel@vger.kernel.org>,
 "ntfs3@lists.linux.dev" <ntfs3@lists.linux.dev>, "richard@nod.at"
 <richard@nod.at>, "yuezhang.mo@sony.com" <yuezhang.mo@sony.com>,
 "joseph.qi@linux.alibaba.com" <joseph.qi@linux.alibaba.com>,
 "axboe@kernel.dk" <axboe@kernel.dk>,
 "linux-karma-devel@lists.sourceforge.net"
 <linux-karma-devel@lists.sourceforge.net>, "kent.overstreet@linux.dev"
 <kent.overstreet@linux.dev>, "ceph-devel@vger.kernel.org"
 <ceph-devel@vger.kernel.org>, "samba-technical@lists.samba.org"
 <samba-technical@lists.samba.org>,
 "dhavale@google.com" <dhavale@google.com>,
 "devel@lists.orangefs.org" <devel@lists.orangefs.org>,
 "konishi.ryusuke@gmail.com" <konishi.ryusuke@gmail.com>,
 "linux_oss@crudebyte.com" <linux_oss@crudebyte.com>, "jaegeuk@kernel.org"
 <jaegeuk@kernel.org>, "sprasad@microsoft.com" <sprasad@microsoft.com>,
 "linux-um@lists.infradead.org" <linux-um@lists.infradead.org>,
 "jani.nikula@linux.intel.com" <jani.nikula@linux.intel.com>,
 "brauner@kernel.org" <brauner@kernel.org>, "rodrigo.vivi@intel.com"
 <rodrigo.vivi@intel.com>, "adilger.kernel@dilger.ca"
 <adilger.kernel@dilger.ca>, "airlied@gmail.com" <airlied@gmail.com>,
 "chao@kernel.org" <chao@kernel.org>, "coda@cs.cmu.edu" <coda@cs.cmu.edu>,
 "jannh@google.com" <jannh@google.com>, "kees@kernel.org" <kees@kernel.org>,
 "me@bobcopeland.com" <me@bobcopeland.com>, "chengzhihao1@huawei.com"
 <chengzhihao1@huawei.com>, "linux-bcachefs@vger.kernel.org"
 <linux-bcachefs@vger.kernel.org>, "marc.dionne@auristor.com"
 <marc.dionne@auristor.com>, "almaz.alexandrovich@paragon-software.com"
...
X-Authority-Analysis: v=2.4 cv=KaDSsRYD c=1 sm=1 tr=0 ts=6850a7b4 cx=c_pps
 ...
 a=QEXdDO2ut3YA:10
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjUwNjE2MDE2NyBTYWx0ZWRfX3b5A12nu+ZXM
 

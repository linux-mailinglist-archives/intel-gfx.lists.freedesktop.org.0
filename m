...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E32438C1596
	for <lists+intel-gfx@lfdr.de>; Thu,  9 May 2024 21:42:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BED110F1A9;
	Thu,  9 May 2024 19:42:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 8e613ede5ea5 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DA4A310F1AE;
 Thu,  9 May 2024 19:42:05 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============0415341136188610341=="
MIME-Version: 1.0
...
Date: Thu, 09 May 2024 19:42:05 -0000
Message-ID: <171528372587.2038404.10867759141339831138@8e613ede5ea5>
...
#### Possible regressions ####
  ...
  * igt@core_getversion@basic:
   ...
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_126443v8/shard-dg1-14/igt@core_getversion@basic.html
...
#### Warnings ####
  ...
  * igt@kms_frontbuffer_tracking@psr-1p-offscren-pri-shrfb-draw-mmap-cpu:
   ...
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_14737/shard-snb5/igt@kms_frontbuffer_tracking@psr-1p-offscren-pri-shrfb-draw-mmap-cpu.html
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_126443v8/shard-snb5/igt@kms_frontbuffer_tracking@psr-1p-offscren-pri-shrfb-draw-mmap-cpu.html
...
#### Issues hit ####
  ...
  * igt@api_intel_bb@blit-reloc-keep-cache:
   ...
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_126443v8/shard-mtlp-1/igt@api_intel_bb@blit-reloc-keep-cache.html

  * igt@api_intel_bb@blit-reloc-purge-cache:
    - shard-dg2:          NOTRUN -> [SKIP][21] ([i915#8411])
   [21]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_126443v8/shard-dg2-11/igt@api_intel_bb@blit-reloc-purge-cache.html

  * igt@api_intel_bb@crc32:
    - shard-dg1:          NOTRUN -> [SKIP][22] ([i915#6230])
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_126443v8/shard-dg1-14/igt@api_intel_bb@crc32.html

  * igt@api_intel_bb@object-reloc-purge-cache:
    - shard-dg1:          NOTRUN -> [SKIP][23] ([i915#8411])
   [23]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_126443v8/shard-dg1-15/igt@api_intel_bb@object-reloc-purge-cache.html
...
<h4>Possible regressions</h4>
<ul>
<li>igt@core_getversion@basic:<ul>

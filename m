...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BE9AE52596D
	for <lists+intel-gfx@lfdr.de>; Fri, 13 May 2022 03:37:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2CBBD10FA83;
	Fri, 13 May 2022 01:37:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BF82210FA7C
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=1/nOELM4X13emTZ6csGqGb7Kfv66E2dikFZeUkirdo0=;
 b=n/qtCR5kLufv9KBocMruPaYuLqItRnRlzmz/SDxSfEelm92DkI+UQ8qE
 LToe0179H6tiYol38EklLj/cVpbdY1T728z1uHsAuy8/bbLeYEtgbtaSI
 NITYgRWAvOer2ys/igBYWpi8hk6FcLRdglbJlUMw4FxV3zv7S49VhFzot
 v9p8rXVNwe2pwjdYUbvFANFkBMayDxmMJKpN/1tj+EYpYh/LunuKIIFyT
 WwcMAttdvkpqOiTcqezVmoJodg31LRxbyxxL8KKjjgmWrAq6boSIahWme
 RuflAIjwo/c4w13tapWpsHrINuIHMFL9014VXrcFQrPeB9Cno5dwjHYXN Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10345"; a="257728757"
X-IronPort-AV: E=Sophos;i="5.91,221,1647327600"; d="scan'208";a="257728757"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2022 18:37:04 -0700
X-IronPort-AV: E=Sophos;i="5.91,221,1647327600"; d="scan'208";a="671111017"
Received: from orsosgc001.jf.intel.com ([10.165.21.154])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2022 18:37:04 -0700
From: Ashutosh Dixit <ashutosh.dixit@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 12 May 2022 18:36:54 -0700
Message-Id: <466dd1be3b016561a3f3a0abdc457775f720a854.1652405421.git.ashutosh.dixit@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/7] drm/i915/gt: Add media freq factor to
 per-gt sysfs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22A02605629
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Oct 2022 05:58:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA08110E349;
	Thu, 20 Oct 2022 03:57:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A3D0310E047;
 Thu, 20 Oct 2022 03:57:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666238267; x=1697774267;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=o/Q/RJILx7Xk77M0xlbFZdY1Hlaj3ZrpBBpp8Y++DDU=;
 b=I+3jcFEcbiTwiq9GkA8Unitj8AeNiSPotSaRtIl1lVPcWvHl5H0Jbeyi
 kb5EuSlXizbrBqRcVZs7tLbN7oilI7c5qXASukmPJXS5wWnfmE0AlMP0G
 2GY060T2hCpi5Udn9ia4OlpsSxUhWQ53MILVWV8UPYe/oCMq3OYsOG2MB
 cXk4jFpnJa/gsOYqV1t1FAAjArx+QmjzpWi7fo14MrnjAUwXO71FPD5Mh
 +SxSgKzKP+FN24uqJZd3zMC75rZbRlSwZoxQhbiQZ74lpF0OSRh5oHftc
 4b1mW6Vlxa+TpO6C7qTX5mX+QFQSbYRNI3qJVYNW+ibRDSytkT4YpzZyG g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="370808121"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="370808121"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Oct 2022 20:57:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="958674237"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="958674237"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
 by fmsmga005.fm.intel.com with ESMTP; 19 Oct 2022 20:57:42 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1olMgg-0000nv-0g;
 Thu, 20 Oct 2022 03:57:42 +0000
Date: Thu, 20 Oct 2022 11:56:56 +0800
From: kernel test robot <lkp@intel.com>
To: Somalapuram Amaranath <Amaranath.Somalapuram@amd.com>,
 dri-devel@lists.freedesktop.org, amd-gfx@lists.freedesktop.org,
 intel-gfx@lists.freedesktop.org, nouveau@lists.freedesktop.org
Message-ID: <202210201140.pf72KtaL-lkp@intel.com>
References: <20221019152736.654451-1-Amaranath.Somalapuram@amd.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="ewqx4rJs0ojc8g8B"
...
Cc: kbuild-all@lists.01.org, arunpravin.paneerselvam@amd.com,
...
[also build test WARNING on drm-intel/for-linux-next drm-tip/drm-tip linus/master v6.1-rc1 next-20221019]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Somalapuram-Amaranath/drm-ttm-rework-on-ttm_resource-to-use-size_t-type/20221020-101841
base:   git://anongit.freedesktop.org/drm/drm-misc drm-misc-next
patch link:    https://lore.kernel.org/r/20221019152736.654451-1-Amaranath.Somalapuram%40amd.com
patch subject: [PATCH 1/6] drm/ttm: rework on ttm_resource to use size_t type
config: parisc-allyesconfig
compiler: hppa-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/aa558465ffd2b2cae041fc5806bbfd9bcfe9462d
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Somalapuram-Amaranath/drm-ttm-rework-on-ttm_resource-to-use-size_t-type/20221020-101841
        git checkout aa558465ffd2b2cae041fc5806bbfd9bcfe9462d
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=parisc SHELL=/bin/bash drivers/gpu/drm/ttm/
...
>> drivers/gpu/drm/ttm/ttm_bo.c:54:44: warning: format '%lu' expects argument of type 'long unsigned int', but argument 4 has type 'size_t' {aka 'unsigned int'} [-Wformat=]
      54 |         drm_printf(&p, "No space for %p (%lu size, %zuK, %zuM)\n",
         |                                          ~~^
         |                                            |
         |                                            long unsigned int
         |                                          %u
      55 |                    bo, bo->resource->size, bo->base.size >> 10,
         |                        ~~~~~~~~~~~~~~~~~~   
         |                                    |
         |                                    size_t {aka unsigned int}


vim +54 drivers/gpu/drm/ttm/ttm_bo.c

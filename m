...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 62B29193E42
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Mar 2020 12:49:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE2B26E8B8;
	Thu, 26 Mar 2020 11:49:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B72936E311
 for <intel-gfx@lists.freedesktop.org>; Thu, 26 Mar 2020 11:49:29 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 26 Mar 2020 12:49:12 +0100
Message-Id: <20200326114922.1820274-11-maarten.lankhorst@linux.intel.com>
...
index dff0bbe9e1a6..c31af4b6ed6f 100644
--- a/drivers/gpu/drm/i915/gt/intel_engine_cs.c
+++ b/drivers/gpu/drm/i915/gt/intel_engine_cs.c
@@ -546,7 +546,7 @@ static int pin_ggtt_status_page(struct intel_engine_cs *engine,
 	else
 		flags = PIN_HIGH;
...
index c7f60fd89d3a..b192949e52b6 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3036,7 +3036,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3398,7 +3399,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index b09a1c929c94..1724b361867e 100644
...
index 191577a98390..a566dc9b9730 100644

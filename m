...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E41391473B4
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 23:21:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD0156E15C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2] drm: Release filp before global lock

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D47AC11E209
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2019 11:35:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E87B6E40A;
	Fri, 13 Dec 2019 10:34:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7FA376E422
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Dec 2019 10:34:56 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 13 Dec 2019 02:34:56 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,309,1571727600"; d="scan'208";a="220896309"
Received: from slisovsk-lenovo-ideapad-720s-13ikb.fi.intel.com ([10.237.72.89])
 by fmsmga001.fm.intel.com with ESMTP; 13 Dec 2019 02:34:54 -0800
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 13 Dec 2019 12:31:57 +0200
Message-Id: <20191213103158.29520-4-stanislav.lisovskiy@intel.com>
...
index 7d3405dea4f6..59dbc6b85144 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -13413,12 +13413,12 @@ static void verify_wm_state(struct intel_crtc *crtc,
...
+			  dev_priv->enabled_dbuf_slices_mask,
 	...
 	/* planes */
@@ -14640,22 +14640,23 @@ static void intel_update_trans_port_sync_crtcs(struct intel_crtc *crtc,
...
index 01922492be3c..31977f65cdd6 100644
...
index 42a7f9785e47..60179f9c0008 100644
...
index ad4404411fb3..5881752286a1 100644
--- a/drivers/gpu/drm/i915/intel_pm.c
+++ b/drivers/gpu/drm/i915/intel_pm.c
@@ -3599,26 +3599,22 @@ bool ilk_disable_lp_wm(struct drm_device *dev)
...
+	dev_priv->enabled_dbuf_slices_mask = intel_enabled_dbuf_slices_mask(dev_priv);
 ...
 /*
@@ -5187,7 +5166,7 @@ skl_compute_ddb(struct intel_atomic_state *state)

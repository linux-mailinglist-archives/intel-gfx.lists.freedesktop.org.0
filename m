...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6855C546D47
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 21:30:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 890FF11382F;
	Fri, 10 Jun 2022 19:30:08 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 12/15] drm/edid: do invalid block
 filtering in-place

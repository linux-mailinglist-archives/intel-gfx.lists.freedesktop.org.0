...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B83EAB1015
	for <lists+intel-gfx@lfdr.de>; Fri,  9 May 2025 12:13:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 52ACF10E9FC;
	Fri,  9 May 2025 10:13:17 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="NG0Rz0C2";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9D52210E9FA;
 Fri,  9 May 2025 10:13:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1746785596; x=1778321596;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=UsK7zKaz7vCC8IYcDUOZVd3GkOBk+ybTPuqRFjSAOVU=;
 b=NG0Rz0C28AzuQh6sSl0mThJprfwfulUwb1haZnfEcKvSI55ZTbDRXHZ4
 IrNZdzOc++x48RX0j5gjm0z99zaZBjVzoEs4Bbbt2otorbuFNpdhiyX+X
 VYIXdKfDZrvxYdwWCkPq4WwDVnDscLRwlOR87XFtqw6coFUSIEnSscX98
 FKFo+2rlBW6WayMg1oHL2TlKqTTf+Umq7k5KS8lDxRHqb8qMJmxbtGfaj
 oyYZxn+jxKedG6UgPZ3bw3QHDwra3bEqqipVxlbMEpV2MdD6GHs3uFEAK
 JVd0jmI5BCNj7Ht1kvNH1ZTfNbEdpmHbs8vQU2ntO18v9c8VD6lsKyKd4 Q==;
X-CSE-ConnectionGUID: j3Pyf4FLQg6kn7Sa9ceASQ==
X-CSE-MsgGUID: R9LCrDD6SO+kMl5HPw4AfA==
X-IronPort-AV: E=McAfee;i="6700,10204,11427"; a="59236746"
X-IronPort-AV: E=Sophos;i="6.15,275,1739865600"; d="scan'208";a="59236746"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by fmvoesa105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2025 03:13:15 -0700
X-CSE-ConnectionGUID: McjGuM0XTC2/wNlY8hNEiA==
X-CSE-MsgGUID: sYBYEkyQRXyt5wa4WJ5yyg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,274,1739865600"; d="scan'208";a="136531500"
Received: from pgcooper-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.244.201])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2025 03:13:12 -0700
...
In-Reply-To: <20250509042729.1152004-7-suraj.kandpal@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20250509042729.1152004-1-suraj.kandpal@intel.com>
 <20250509042729.1152004-7-suraj.kandpal@intel.com>
Date: Fri, 09 May 2025 13:13:09 +0300
Message-ID: <87v7qaks7e.fsf@intel.com>
MIME-Version: 1.0

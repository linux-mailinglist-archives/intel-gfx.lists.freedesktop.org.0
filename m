...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F48048728F
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jan 2022 06:31:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 012BC113275;
...
Subject: [Intel-gfx] [PATCH v11 18/19] dyndbg: add
 DEFINE_DYNAMIC_DEBUG_CLASSBITS macro and callbacks

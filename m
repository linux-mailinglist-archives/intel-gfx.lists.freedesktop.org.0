...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DC24C104C4
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Oct 2025 19:56:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E3D0810E55B;
	Mon, 27 Oct 2025 18:56:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 97596180aaec (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3761B10E556;
 Mon, 27 Oct 2025 18:56:32 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============5601839879579620271=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=97_i915=2ECI=2EBAT=3A_failure_for_drm/i915/x3p=5Flpd=3A_FBC?=
 =?utf-8?q?_related_patches?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Vinod Govindapillai" <vinod.govindapillai@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Mon, 27 Oct 2025 18:56:32 -0000
Message-ID: <176159139221.59660.17281568208923561001@97596180aaec>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_156588v1 absolutely need to be
  verified manually.
  
  If you think the reported changes have nothing to do with the changes
  introduced in Patchwork_156588v1, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_156588v1:
...
#### Possible regressions ####
  ...
  * igt@kms_flip@basic-flip-vs-wf_vblank:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/fi-bsw-n3050/igt@kms_flip@basic-flip-vs-wf_vblank.html
...
#### Issues hit ####
  ...
  * igt@dmabuf@all-tests:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17430/bat-apl-1/igt@dmabuf@all-tests.html
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/bat-apl-1/igt@dmabuf@all-tests.html

  * igt@i915_module_load@load:
    - bat-mtlp-9:         [PASS][4] -> [DMESG-WARN][5] ([i915#13494])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17430/bat-mtlp-9/igt@i915_module_load@load.html
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/bat-mtlp-9/igt@i915_module_load@load.html

  * igt@i915_selftest@live@client:
    - fi-kbl-7567u:       [PASS][6] -> [DMESG-WARN][7] ([i915#13735]) +13 other tests dmesg-warn
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17430/fi-kbl-7567u/igt@i915_selftest@live@client.html
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/fi-kbl-7567u/igt@i915_selftest@live@client.html

  * igt@i915_selftest@live@sanitycheck:
    - bat-apl-1:          [PASS][8] -> [DMESG-WARN][9] ([i915#13735]) +39 other tests dmesg-warn
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17430/bat-apl-1/igt@i915_selftest@live@sanitycheck.html
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/bat-apl-1/igt@i915_selftest@live@sanitycheck.html

  * igt@i915_selftest@live@workarounds:
    - bat-mtlp-9:         [PASS][10] -> [DMESG-FAIL][11] ([i915#12061]) +1 other test dmesg-fail
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17430/bat-mtlp-9/igt@i915_selftest@live@workarounds.html
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/bat-mtlp-9/igt@i915_selftest@live@workarounds.html
...
<p>Serious unknown changes coming with Patchwork_156588v1 absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_156588v1, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them<br />
  to document this new failure mode, which will reduce false positives in CI.</p>
<p>External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/index.html</p>
<h2>Participating hosts (45 -&gt; 44)</h2>
<p>Missing    (1): fi-snb-2520m </p>
<h2>Possible new issues</h2>
<p>Here are the unknown changes that may have been introduced in Patchwork_156588v1:</p>
<h3>IGT changes</h3>
<h4>Possible regressions</h4>
<ul>
<li>igt@kms_flip@basic-flip-vs-wf_vblank:<ul>
<li>fi-bsw-n3050:       NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_156588v1/fi-bsw-n3050/igt@kms_flip@basic-flip-vs-wf_vblank.html">DMESG-WARN</a> +5 other tests dmesg-warn</li>
</ul>
</li>
</ul>
<h2>Known issues</h2>

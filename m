...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E40E149240F
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jan 2022 11:46:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6F43112A4F;
	Tue, 18 Jan 2022 10:46:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from NAM10-BN7-obe.outbound.protection.outlook.com
 (mail-bn7nam10on2086.outbound.protection.outlook.com [40.107.92.86])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CCD6F112A20;
 Tue, 18 Jan 2022 10:46:11 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=w/YKOjbuhANKVNehVYc/ftc1OyA8ydQqzaPuiFDeFxo=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1; 
 ...
 bh=w/YKOjbuhANKVNehVYc/ftc1OyA8ydQqzaPuiFDeFxo=;
 b=eM6CZ8BxudXVfRK4ViQiGpGg8zmpU5MgbrLBEgUlXoXOhkeL+DcEZO6hWX6FbVy0SpIlzVlSYLTdVmRA8xddm5el4yW42OyVN1HO4c7q1sFXdirL6PEKzdUNmPLmkRzokyT2ILNWcvbdD7jS14qbjfYWFw5l5P1zLKGm+9T97Uo=
Received: from DS7PR06CA0047.namprd06.prod.outlook.com (2603:10b6:8:54::27) by
 BN8PR12MB4787.namprd12.prod.outlook.com (2603:10b6:408:a1::11) with
 Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.4888.11; Tue, 18 Jan 2022 10:46:08 +0000
Received: from DM6NAM11FT051.eop-nam11.prod.protection.outlook.com
 (2603:10b6:8:54:cafe::22) by DS7PR06CA0047.outlook.office365.com
 ...
 Transport; Tue, 18 Jan 2022 10:46:08 +0000
...
Received: from SATLEXMB04.amd.com (165.204.84.17) by
 ...
 15.20.4888.9 via Frontend Transport; Tue, 18 Jan 2022 10:46:08 +0000
...
Date: Tue, 18 Jan 2022 16:15:04 +0530
Message-ID: <20220118104504.2349-6-Arunpravin.PaneerSelvam@amd.com>
...
X-MS-Office365-Filtering-Correlation-Id: cddf5353-df1f-47ef-c7de-08d9da6fbc16
X-MS-TrafficTypeDiagnostic: BN8PR12MB4787:EE_
X-Microsoft-Antispam-PRVS: <BN8PR12MB47873BC44323EFB264B7E96BE4589@BN8PR12MB4787.namprd12.prod.outlook.com>
X-MS-Oob-TLC-OOBClassifiers: OLM:2150;
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:165.204.84.17; CTRY:US; LANG:en; SCL:1; SRV:;
 IPV:CAL; SFV:NSPM; H:SATLEXMB04.amd.com; PTR:InfoDomainNonexistent; CAT:NONE;
 SFS:(4636009)(40470700002)(36840700001)(46966006)(83380400001)(54906003)(426003)(316002)(81166007)(336012)(30864003)(16526019)(4326008)(110136005)(186003)(2616005)(36756003)(26005)(356005)(2906002)(5660300002)(1076003)(508600001)(70206006)(86362001)(8676002)(40460700001)(70586007)(82310400004)(47076005)(8936002)(7696005)(36860700001)(36900700001);
 DIR:OUT; SFP:1101; 
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Jan 2022 10:46:08.0376 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: cddf5353-df1f-47ef-c7de-08d9da6fbc16
...
Subject: [Intel-gfx] [PATCH v9 6/6] drm/amdgpu: add drm buddy support to
 amdgpu
...
index 7346ecff4438..4f3e10c4ff61 100644
...
index 7b2b0980ec41..0682d5e97cb8 100644

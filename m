...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9085877D4A
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Mar 2024 10:49:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D66010EC18;
	Mon, 11 Mar 2024 09:49:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SEp3z90P";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3FBE910EEF9;
 Mon, 11 Mar 2024 09:49:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710150573; x=1741686573;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=97skoEGy7U3knZPeWtnchaMr71KSjvS9vKdH+pqU5Fs=;
 b=SEp3z90Pkko9a1waPCgRHEb/yot0u6w4H5LavlmaaVCn3MDPRGfN+8H9
 4HnzHo6SM18QgRTeoKc1I9mBXd+vbE52VyFApfqhlseTJkO9eH6cyAFVi
 BQIsgJFHabYq9YDEJnFwW9l1ZtCiSaNQxcK8flVkssqj9NIDQaVmmwTq0
 WbodOmTix6PHoiqCqSXOnMYt+PlyLlJz+RKhtfRbsfIoOFhi8YWNq0KlU
 5aENkEiwdUA6rsDDhjPgIGa84166ZR4T8iuPaT74n0DBVhsCc9KBh14y2
 9I11yjXuREpWB5czAZCMKp843k1jHRL2x/X3DOFBWLAesTkP1p57K2eKj Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11009"; a="8619219"
X-IronPort-AV: E=Sophos;i="6.07,116,1708416000"; 
   d="scan'208";a="8619219"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2024 02:49:33 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,116,1708416000"; d="scan'208";a="11198055"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmviesa006.fm.intel.com with ESMTP; 11 Mar 2024 02:49:30 -0700
...
Subject: [PATCH v17 8/9] drm/i915/display: Compute vrr_vsync params
Date: Mon, 11 Mar 2024 15:12:37 +0530
Message-Id: <20240311094238.3320888-9-mitulkumar.ajitkumar.golani@intel.com>
...
index 9bda3a24cd94..c7fdde9387eb 100644

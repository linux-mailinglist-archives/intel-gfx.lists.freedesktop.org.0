...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74F5A5E74A6
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Sep 2022 09:15:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DDA910E450;
	Fri, 23 Sep 2022 07:15:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F1E8A10E450;
 Fri, 23 Sep 2022 07:15:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663917348; x=1695453348;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=d7g/fMujOhi7gahMLrwbTdoYQI5tK+HrOGHUq/yZfa4=;
 b=a2muVizp8dlChSaYVnoMKY5y2dNVpOI3q057Ivf0xy+YHwY6i3iTwuNa
 xsn6kRFcugZoLcdDHl9P3WdP7Fq/XM17UBj+I3KQ24cgqGqtDFx1rEP2s
 XYHjZ26+c9qGHZgjTdSl6ZFV0triiZxOy7lOPPvu7WPhpDYezR0yqsfLw
 EXlKc07/IYPxA7LfgwYSu3WFefshv6I842/suCSh1N8yyiME5Ui6J2WvW
 B7Zvo3EWkfL57qTSkW1VjHxYYg5rzEwElFN8bCgBU+7guqNOyqkgbk9ph
 0pNCNU4ZnBCGCKmowbHyzQWTayfheJTVUmzS2l0DAGmcvzwaGEBlEl4JQ g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10478"; a="362340412"
X-IronPort-AV: E=Sophos;i="5.93,337,1654585200"; d="scan'208";a="362340412"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2022 00:15:46 -0700
X-IronPort-AV: E=Sophos;i="5.93,337,1654585200"; d="scan'208";a="724025948"
Received: from lukereyx-mobl.ger.corp.intel.com (HELO [10.213.225.140])
 ([10.213.225.140])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2022 00:15:43 -0700
Message-ID: <ef1ea124-f017-2ab0-3e6a-fe000969429f@linux.intel.com>
Date: Fri, 23 Sep 2022 08:15:41 +0100
MIME-Version: 1.0

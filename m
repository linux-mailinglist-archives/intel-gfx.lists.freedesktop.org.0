...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA6D441F3E2
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Oct 2021 19:53:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7196D6EEA3;
...
Subject: [Intel-gfx] [PATCH v3 02/10] vfio/ccw: Use functions for alloc/free
 of the vfio_ccw_private

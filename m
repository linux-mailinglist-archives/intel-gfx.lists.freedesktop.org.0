...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9209824FD56
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Aug 2020 14:02:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4012F6EC7E;
	Mon, 24 Aug 2020 12:02:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-1.mimecast.com
 [205.139.110.61])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D08CD6EC82
 for <intel-gfx@lists.freedesktop.org>; Mon, 24 Aug 2020 12:02:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1598270544;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=pl9KVfD+7YlWJlLk8Ot+a3gHE/6VBv99WiVsPiXEvhY=;
 b=RfMJdhiVB9AaHjA/MT04IdvE6e32nORqCne7gD54PE1RQvrZ7IRvIi2PsBoHlwawVFNDdx
 EOEK6OkrHvilQLlb0nAdTPUTTUyNCujwWio+kYu29TDROzS3721H+iqXRjU7gx55UkK4rW
 9wEdHdW5VdeTnQLIw7cXM/+4rUXkhkY=
...
Subject: [Intel-gfx] [PATCH v6 12/16] pwm: crc: Implement get_state() method

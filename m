...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 14E91645FF6
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Dec 2022 18:18:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3EF6D89811;
	Wed,  7 Dec 2022 17:18:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 337A910E40C
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Dec 2022 17:18:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670433499; x=1701969499;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=iFXgLPnDXLeMfKfOoLSd9lQGZAhtjjbcbCuNZLywra8=;
 b=ToSN5YOYpc+7jD7EXKhEsKArV9T+ZPQUUds+1NEpLawcyu5ZKu5c4pFv
 Ct5CccNbp+k4zSa53tbtDe3xT3rCOUYh3TgoKNud/ASq0NZTjFsZ3Qur+
 d6J2YNUkLR2/CMh5LglIAfA0tUi7/wWrCg71WClC1yyCpHZqSDJJ281vX
 /Tab2hS6E/mztI7WsTsrAmj6hZOqf6bm4YzlhJbWKq/TO0Nrt0g5UDJDt
 Q3zuKUf6KoVJCLcUH7X7xGVdKKmYsHEMsi4pWX+OlL5Fh1lPdX37gEXJl
 nMGSoqOtVn2a8dycLFgvck0oikOVB86G4xc603bMDNaiYqGqA1dfDSu74 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10554"; a="318087586"
X-IronPort-AV: E=Sophos;i="5.96,225,1665471600"; d="scan'208";a="318087586"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Dec 2022 09:18:18 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10554"; a="715260919"
X-IronPort-AV: E=Sophos;i="5.96,225,1665471600"; d="scan'208";a="715260919"
Received: from fbackhou-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.36.192])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Dec 2022 09:18:16 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  7 Dec 2022 19:17:26 +0200
Message-Id: <588815fc60752b6470ee4067246698d478309fa1.1670433372.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 09/11] drm/i915/wm: switch to intel_de_*

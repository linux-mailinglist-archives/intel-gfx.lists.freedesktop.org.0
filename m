...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B2E35E8C24
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Sep 2022 14:16:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E3D8B10E604;
	Sat, 24 Sep 2022 12:16:16 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 06/15] mei: pxp: support matching with a
 gfx discrete card

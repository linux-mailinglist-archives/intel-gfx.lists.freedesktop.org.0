...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7776D7603C9
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jul 2023 02:20:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6854A10E10C;
...
Subject: [Intel-gfx] [PATCH v9 1/7] drm/i915/gt: Cleanup aux invalidation
 registers

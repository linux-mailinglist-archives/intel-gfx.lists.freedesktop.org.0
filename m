...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 718CE67945B
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 10:42:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C459E10E252;
...
Subject: [Intel-gfx] [PATCH 1/3] drm/edid: reverse display info

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 42CA12433EB
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Aug 2020 08:21:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 584926E286;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 3/5] drm/xen-front: Add YUYV to supported
 formats

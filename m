...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1CF439BCA2A
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Nov 2024 11:18:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 45B0610E555;
	Tue,  5 Nov 2024 10:17:57 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ign01xN1";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7EC6C10E55A;
 Tue,  5 Nov 2024 10:17:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1730801874; x=1762337874;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=JX1DnlumrZt6J1AshK/v6f7zw67AJVqRXSh68BQx7o8=;
 b=ign01xN1oNiZs2TEBuXoKuvnGbUgErTU+pgD9J7DQWRtIVo/Zks/xPZl
 6KBW/AIfjIG7QGMDELSk95U/EOHexCVw9M5F328rfRf8RotX5/bpUE8eU
 KqObt4qAe56PeMx9ThcnVMrka/oeu82HunGmdm/mF9k6gbk6GD/tr3kbh
 Lb7p/BxSmFStGIn5ffVcqvN8rhhTN+VdwCNlH7KGLDxqiQN0pmk0kLetE
 NAr7+BhJh/5EAOpCvtkGdUSnwUmgqJ2szSlnI/g3b4V/BuQc+0vdtNl3X
 YYUKNTK2TimOZI+yz3As7pewA6q4wAvRkJfjWMJPrmmpLwbYsG6aXi7O8 w==;
X-CSE-ConnectionGUID: tFj0sIwnQOaFSMIc3t8KWQ==
X-CSE-MsgGUID: AmQAwylHT1moqsFicbUEJg==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="30702369"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="30702369"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Nov 2024 02:17:53 -0800
X-CSE-ConnectionGUID: 2PgXoVX/RSqQ2Iq4RopelA==
X-CSE-MsgGUID: L2PZEJ0LRCKuosjfGJB7vg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,259,1725346800"; d="scan'208";a="89095111"
...
Subject: [PATCH v2] drm/i915/display: convert display device identification to
 struct intel_display
Date: Tue,  5 Nov 2024 12:17:49 +0200
Message-Id: <20241105101749.3446140-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.39.5
In-Reply-To: <abbeb081ef8e8e19cf8d6b97c48bf945d9fa0b52.1730740629.git.jani.nikula@intel.com>

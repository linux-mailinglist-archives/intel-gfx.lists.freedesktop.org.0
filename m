...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DB7A928C029
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Oct 2020 21:00:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA9426E566;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 1/5] drm: Introduce plane and CRTC scaling
 filter properties

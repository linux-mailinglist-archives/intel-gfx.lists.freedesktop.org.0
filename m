...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC54B604B0A
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Oct 2022 17:18:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 441BC10F261;
	Wed, 19 Oct 2022 15:17:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 02AA310F261;
 Wed, 19 Oct 2022 15:17:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666192675; x=1697728675;
 h=date:from:to:cc:subject:message-id:mime-version;
 bh=UPGINaG5MbEsPvBret+VdiFDPHAWP5WSY+baB4wtPlI=;
 b=WOz922uC45ujCqLsSSr3a4csmGcN8wrI3EEcJUvYYmhuSCkIECVXq6hl
 qxpMAp//D1wIJ8LTQgt/6giPLLLeiKwHVk7ul2EgutjmYddzZjc7hfIA+
 d6dt31Wnwx5FkZrGUTmM2YTBakd96JkwRZG0tLRda7LFA1wBM6ODUp4tW
 RvqDeGucjY1HFVXGvkY+cfvzohjGV6Ua79pF5yDgEWl+PaxvwU5f8USV6
 fGl+fIdu3DlJhbFhf9H67vZMXpWJZ78vkZKW4+6j30UX3d2Gc8bXpUvFa
 /ILb22mqAsfgIVlef2iIUvss3ujT/7ncELMLkb1lb1xJb34CWUsT0ANgF w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="307546776"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="307546776"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Oct 2022 08:17:54 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="607142559"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="607142559"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
 by orsmga006.jf.intel.com with ESMTP; 19 Oct 2022 08:17:51 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1olApK-00008E-2q;
 Wed, 19 Oct 2022 15:17:50 +0000
Date: Wed, 19 Oct 2022 23:16:57 +0800
From: kernel test robot <lkp@intel.com>
To: Thomas Zimmermann <tzimmermann@suse.de>
Message-ID: <202210192208.D888I6X7-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="QcvmB1k7fWCsiOhO"
Content-Disposition: inline
Subject: [Intel-gfx] [drm-tip:drm-tip 213/322]
 drivers/gpu/drm/tiny/ofdrm.c:169:17: sparse: sparse: restricted __be32
 degrades to integer
...
commit: f496834e167451afc5f0c699ada143a7641b4e85 [213/322] drm/ofdrm: Add per-model device function
...
reproduce:
        ...
        git checkout f496834e167451afc5f0c699ada143a7641b4e85
...
>> drivers/gpu/drm/tiny/ofdrm.c:169:17: sparse: sparse: restricted __be32 degrades to integer
   drivers/gpu/drm/tiny/ofdrm.c:170:18: sparse: sparse: restricted __be32 degrades to integer
   drivers/gpu/drm/tiny/ofdrm.c:170:54: sparse: sparse: restricted __be32 degrades to integer

vim +169 drivers/gpu/drm/tiny/ofdrm.c

   165	
   166	static bool is_avivo(__be32 vendor, __be32 device)
   167	{
   168		/* This will match most R5xx */
 > 169		return (vendor == PCI_VENDOR_ID_ATI) &&
   170		       ((device >= PCI_VENDOR_ID_ATI_R520 && device < 0x7800) ||
   171			(PCI_VENDOR_ID_ATI_R600 >= 0x9400));
   172	}
   173	

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEDCE54E072
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Jun 2022 14:02:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF02211A4BC;
...
Subject: [Intel-gfx] [PATCH v2 5/9] drm/i915/dgfx: Add has_lmem_sr

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AABB4832C1A
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Jan 2024 16:08:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4636C10EA2F;
	Fri, 19 Jan 2024 15:07:26 +0000 (UTC)

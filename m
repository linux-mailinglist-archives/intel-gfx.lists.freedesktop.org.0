...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 63D6B18B9A4
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Mar 2020 15:42:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A85306EA1C;
	Thu, 19 Mar 2020 14:42:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BED0E6EA1C
 for <intel-gfx@lists.freedesktop.org>; Thu, 19 Mar 2020 14:42:55 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20618524-1500050 
 for multiple; Thu, 19 Mar 2020 14:42:30 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 19 Mar 2020 14:42:28 +0000
Message-Id: <20200319144228.7455-2-chris@chris-wilson.co.uk>
...
index 18efad255124..da877495352c 100644
...
index f09dd87324b9..ac7ad5f7bceb 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3053,7 +3053,7 @@ static int execlists_context_alloc(struct intel_context *ce)

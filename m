...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34342500B1E
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Apr 2022 12:30:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AF0510FFA3;
	Thu, 14 Apr 2022 10:30:17 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 1/2] drm/dp: Factor out a function to
 probe a DPCD address

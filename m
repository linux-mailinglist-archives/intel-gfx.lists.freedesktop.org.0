...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44ABBB1C9F
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Sep 2019 13:52:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 790026EF38;
...
Subject: [Intel-gfx] [PATCH 6/9] drm/msm: use drm_debug_enabled() to check

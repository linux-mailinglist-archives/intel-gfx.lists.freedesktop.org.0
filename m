...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B3AD275595
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:22:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DCDF6E91F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 01/22] drm/amdgpu: Introduce GEM object
 functions

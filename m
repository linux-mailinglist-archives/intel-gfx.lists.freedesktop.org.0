...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 10E7530FD20
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Feb 2021 20:44:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F7966EE53;
	Thu,  4 Feb 2021 19:44:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 452D26EE53
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Feb 2021 19:44:35 +0000 (UTC)
IronPort-SDR: MFT9rYHaPrt/LuWa4jZRAf+TYOfHTQ8I0xQPvlCdp9n6NhfqEDdO1RLq/KRNYTMMVBdHZbk/cz
 bKBfL1Fiaa2g==
X-IronPort-AV: E=McAfee;i="6000,8403,9885"; a="161072677"
X-IronPort-AV: E=Sophos;i="5.81,153,1610438400"; d="scan'208";a="161072677"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2021 11:44:34 -0800
IronPort-SDR: /fOdt0sHCZcR2kKgpan4lbhCTcPmcQg2OfIrw11qScFQGXi7VXPqJyxxC83Ygr2vIPsqlAqmzO
 DObatIPLxHyA==
X-IronPort-AV: E=Sophos;i="5.81,153,1610438400"; d="scan'208";a="415296531"
Received: from dbmayer-mobl.ger.corp.intel.com (HELO localhost) ([10.252.53.1])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2021 11:44:32 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  4 Feb 2021 21:43:25 +0200
Message-Id: <9f0cf421e2c73e67decde7b44c8d45799a8d3679.1612467466.git.jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <cover.1612467466.git.jani.nikula@intel.com>
References: <cover.1612467466.git.jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 08/10] drm/i915: migrate i9xx plane get
 config
...
CmluZGV4IDAwOWYzOGNiZDNjNS4uZWYxZTBmMDcyZDhmIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dw

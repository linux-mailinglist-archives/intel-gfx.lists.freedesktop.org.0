...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B57C81F7F68
	for <lists+intel-gfx@lfdr.de>; Sat, 13 Jun 2020 01:03:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A167C6E201;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 1/3] drm/dp: DRM DP helper for reading Ignore
 MSA from DPCD

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8848654285D
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 09:51:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B309E10EE17;
...
Subject: [Intel-gfx] [PATCH v2 01/15] drm/edid: fix CTA data block

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2AA5D5F07B0
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Sep 2022 11:32:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADA2510EC12;
	Fri, 30 Sep 2022 09:32:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5E47610EC0B
 for <intel-gfx@lists.freedesktop.org>; Fri, 30 Sep 2022 09:32:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664530327; x=1696066327;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=1O1qKpg//8pP+Q3P3dxrgT3ZM0MpYoBzuebJgJQIw2s=;
 b=lokzu0KmxLSK2Kt5xGZPS052wEmmlYoZ4XMkZsrYwgT657hQT8trkKT3
 EQJJB1C4z/iLh6ZbkMK25XlJ/Q9oUUyh0u1qTBAl55gxUrL+2Vn91jcvz
 /toSSgpJnQSvcR+BnQlvXB0/UBXJIEErN+/Hkj3xy+QZgJULE2gh/kyi4
 v0noALRyG4/2WTm6IIxHtYUO4LUY71rLxZw+MGcijLZJRQKLart2H21Jq
 3rISRVP6NI5SsnxmFGBiRt8DSomLgIzh8YUWPvK9P3+PW/yI8eA5uJ3h5
 cUkSNc9fjTv32oVOowhBYsgddHy5Z78AjZ1E1wNUujr5RIz0nWDCG5ON8 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="302123650"
X-IronPort-AV: E=Sophos;i="5.93,358,1654585200"; d="scan'208";a="302123650"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Sep 2022 02:32:06 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="653475602"
X-IronPort-AV: E=Sophos;i="5.93,358,1654585200"; d="scan'208";a="653475602"
Received: from rrogov-mobl1.ccr.corp.intel.com (HELO localhost)
 ([10.252.37.237])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Sep 2022 02:32:04 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Mika Kahola <mika.kahola@intel.com>, intel-gfx@lists.freedesktop.org
In-Reply-To: <20220929131747.2592092-4-mika.kahola@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20220929131747.2592092-1-mika.kahola@intel.com>
 <20220929131747.2592092-4-mika.kahola@intel.com>
Date: Fri, 30 Sep 2022 12:32:01 +0300
Message-ID: <87k05lw6lq.fsf@intel.com>
MIME-Version: 1.0

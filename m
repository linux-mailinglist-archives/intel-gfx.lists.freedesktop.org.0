...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22CFA4E99B4
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 16:34:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8CC6710E1EA;
	Mon, 28 Mar 2022 14:34:55 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 02/12] drm/edid: fix reduced blanking support
 check

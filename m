...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0450E577B51
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:39:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 094CBA9CD6;
...
Subject: [Intel-gfx] [PATCH v3 11/41] dyndbg: add __pr_debug_cls for testing

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A855C67B050
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 11:49:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 699A710E789;
	Wed, 25 Jan 2023 10:49:23 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 3/4] drm/amdgpu: Movie the amdgpu_gtt_mgr

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A05C36D05C
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jul 2019 16:51:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 498936E3EC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/12] drm/i915: Fix HSW+ DP MSA YCbCr

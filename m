...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EC9070FF6B
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 22:47:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7375210E68B;
...
Subject: Re: [Intel-gfx] [v4,
 01/13] fbdev: Add Kconfig options to select different fb_ops helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FE8D6CF3D1
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 21:57:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7891310EC0B;
	Wed, 29 Mar 2023 19:57:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B9F9F10EC0B
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Mar 2023 19:57:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1680119844;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=mlzNdSqBUq7hFdpaURYUAN0/X+/m9jx/CyLubt4sDCs=;
 b=QWyjAqz2MTJdXlSM+BjJ0pMPKsqvgSU5Iuw44gTdls348E6WZBYe73zwnnF3m8NzBPIPFA
 HmpikWIgSbBw2fpLubNe5n5o2YjZJUuHvLRHHkLoWdEFLJ3qZpLJrgXSBhUUlIHtDeNo0C
 wMUXy5XePniIfkb1QdFhDPy1p5wGdGQ=
Received: from mail-il1-f197.google.com (mail-il1-f197.google.com
 [209.85.166.197]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-454-58a5noIyNWeQb1aWK8mMGg-1; Wed, 29 Mar 2023 15:57:23 -0400
X-MC-Unique: 58a5noIyNWeQb1aWK8mMGg-1
Received: by mail-il1-f197.google.com with SMTP id
 d11-20020a056e020c0b00b00326156e3a8bso5422989ile.3
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Mar 2023 12:57:23 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=mlzNdSqBUq7hFdpaURYUAN0/X+/m9jx/CyLubt4sDCs=;
 b=
X-Gm-Message-State: AAQBX9fZL6LmR1lDGrJPwfO8+PQNQR0vcQzZBSXEu+08qeMSn1pS4TK9
 WObB15PlwkVgR7OOmoxn23fG/oGh5P2+t5yYfgLZu8xpaJTtaYJ3i17SCLPSgaQ8nKT+qAMIGgi
 JPeKxo1g9p9T1hmrzQZ2zBdIFAHGH
X-Received: by 2002:a92:6f04:0:b0:326:2025:84e4 with SMTP id
 k4-20020a926f04000000b00326202584e4mr4998923ilc.3.1680119842375; 
...
Subject: Re: [Intel-gfx] [PATCH v8 20/24] vfio: Add cdev for vfio_device

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 69D3D234EC6
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Aug 2020 01:58:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F12D86E122;
	Fri, 31 Jul 2020 23:58:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 25CD96E0FB
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Jul 2020 23:58:50 +0000 (UTC)
IronPort-SDR: vPcF8F9g2Q6kXCkTErYKMo7/InywJJ/0bdwXhKf4PZGeg2ILnqkQCU2iawKKGGZ7aJ6lcmX44c
 u+me9kMM+Lyw==
X-IronPort-AV: E=McAfee;i="6000,8403,9699"; a="131458110"
X-IronPort-AV: E=Sophos;i="5.75,420,1589266800"; d="scan'208";a="131458110"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jul 2020 16:58:49 -0700
IronPort-SDR: eC+sbCgGUY0riNEjd8KhEgCCyyj9fFN/k1fYeUx16xSIqWSrRYR/KMzQGAUp2LLr+k3/1Bslkz
 870XagZCgrKw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,420,1589266800"; d="scan'208";a="395475550"
Received: from orsosgc001.ra.intel.com ([10.23.184.150])
 by fmsmga001.fm.intel.com with ESMTP; 31 Jul 2020 16:58:49 -0700
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 31 Jul 2020 16:58:46 -0700
Message-Id: <20200731235848.40971-3-umesh.nerlige.ramappa@intel.com>
...
+		return;
 	...
 	wal->wa_count++;
@@ -1586,6 +1630,8 @@ void intel_engine_init_whitelist(struct intel_engine_cs *engine)
...
+
 	...
 	if (IS_GEN(i915, 12))
@@ -1620,11 +1666,14 @@ void intel_engine_apply_whitelist(struct intel_engine_cs *engine)
...
@@ -1635,6 +1684,8 @@ void intel_engine_apply_whitelist(struct intel_engine_cs *engine)
 		intel_uncore_write(uncore,
 				   RING_FORCE_TO_NONPRIV(base, i),

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1B0917CCEA
	for <lists+intel-gfx@lfdr.de>; Sat,  7 Mar 2020 09:42:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 14A2F6E0E8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/5] drm: Remove dp mst register connector
 callbacks

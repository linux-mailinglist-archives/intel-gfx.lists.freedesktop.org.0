...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACBBD142EF1
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2020 16:40:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECC296E9CE;
...
Subject: Re: [Intel-gfx] [PATCH v3 22/22] drm: Remove legacy version of

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 680DD3F731C
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Aug 2021 12:26:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7CFD06E1B7;
...
Subject: [Intel-gfx] [PATCH v6 5/7] drm: avoid circular locks in

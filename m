...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41A3E58FEF9
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Aug 2022 17:14:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0530E8BD1F;
	Thu, 11 Aug 2022 15:14:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A1344B3D7C
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Aug 2022 15:14:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1660230855; x=1691766855;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=gpdOppUp8AZkbF8vzOHUB+1asTRrArRp1/3djFT01qw=;
 b=aDLz83ej9Y76zgbzY/99e2Eugccg0O7ZtJKHyW8yyp0ooalQXTtPD1E1
 dHefrvzZlzvuB024vnossGRkvJfuQAPErnxCTOlTIahPoOZRaYrlP+5fj
 6z+DvP3atT5s8sz4kV0RBhSSw5XdyN+dzPuVfL+vqSg02YqwuQm2w7ypP
 LZUyX5ZfVR2wHq1bj9MQ0hMvRfkR+1WblvFfRM7zGHzUAaEj9X5ckSg3P
 D/RipWn3w1oxSmGPTnf9NYYkqoowKQegpq3jo4KzLNkIFvK9Hy977fTs9
 O4h3m3HxT5eblEJeHRdIdjCZeokvviyjoe46BUR1rmsnRX+jV0OtDR+D0 g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10436"; a="355376637"
X-IronPort-AV: E=Sophos;i="5.93,230,1654585200"; d="scan'208";a="355376637"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2022 08:09:54 -0700
X-IronPort-AV: E=Sophos;i="5.93,230,1654585200"; d="scan'208";a="708646529"
Received: from gdogaru-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.48.102])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2022 08:09:52 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 11 Aug 2022 18:07:36 +0300
Message-Id: <f9f1467cfefdbed01fdb8873ded9d9f687f328db.1660230121.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 25/39] drm/i915: move vbt to display.vbt

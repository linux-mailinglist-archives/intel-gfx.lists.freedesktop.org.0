...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27EDF4756BA
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Dec 2021 11:43:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A9EE10E496;
...
Subject: [Intel-gfx] [PATCH v2 3/5] drm/dp: Move DisplayPort helpers into

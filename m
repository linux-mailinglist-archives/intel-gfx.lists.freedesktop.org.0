...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B7AF414AC6D
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Jan 2020 00:09:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20A896EC20;
	Mon, 27 Jan 2020 23:09:14 +0000 (UTC)
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] linux-next: manual merge of the generic-ioremap
 tree with the drm-intel tree
...
Cc: Daniel Vetter <daniel.vetter@ffwll.ch>,
 ...
 DRI <dri-devel@lists.freedesktop.org>, Christoph Hellwig <hch@lst.de>,
 Matthew Auld <matthew.auld@intel.com>
Content-Type: multipart/mixed; boundary="===============1850853847=="

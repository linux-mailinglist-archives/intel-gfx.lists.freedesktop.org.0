...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C4DE7D6EC3
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Oct 2023 16:35:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4A72B10E679;
	Wed, 25 Oct 2023 14:35:48 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 1/5] drm/i915/guc: Create the guc_to_i915()
 wrapper

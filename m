...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A27DBA80C8B
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Apr 2025 15:38:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A63C10E696;
	Tue,  8 Apr 2025 13:38:58 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="nNIEljUM";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6CBB310E690;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=KO4mfm+oqD8yHMGROpnLh6QuS1uPhprxpNK0Dkru5VI=;
 b=nNIEljUMuNiLl5h0ZTrYHz0Ga2UhhxFh1s8dTOh0QI/bX3xaUG+LpU0A
 3Hd6paesPU5tVUOpZHOYkk4YU6XmCZwB88rpvlr3oCC7dyUPdiMURk8PM
 sG7CU3k9EM744pRjIyOEi6fR5G4MRkxJZNzG2d/O82HF/3XMH/dkOHogS
 exKIchSP6pKwWzP4mtt8CLSqd3/aOWOJITr5imRPb47I+zNWlloHMeFkj
 qPssJEUCFrOIk8aQ9rjdSG2n8l8yGCD6na7fUvkOCARGKCg9NvrJQKbpf
 ztpyHRBLpCdJpff+55BBdDXSNkSsQWr5EVinMsJDfFay/nWlvufzuIDHN g==;
X-CSE-ConnectionGUID: 8RqYCj4nTPiTbF6e2bjZxQ==
X-CSE-MsgGUID: Vl5k/lFWQKuJo3Dc4ANQBQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11397"; a="45712015"
X-IronPort-AV: E=Sophos;i="6.15,198,1739865600"; d="scan'208";a="45712015"
Received: from fmviesa009.fm.intel.com ([10.60.135.149])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Apr 2025 06:38:50 -0700
X-CSE-ConnectionGUID: htaZc6WhT4W5hCtCwFsZMg==
X-CSE-MsgGUID: qYnXqjAhSZ6QRol3UJUmgQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,198,1739865600"; d="scan'208";a="129122696"
Received: from klitkey1-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.137])
 by fmviesa009-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Apr 2025 06:38:48 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH v2 1/7] drm/i915/wm: convert intel_wm.h external interfaces to
 struct intel_display
Date: Tue,  8 Apr 2025 16:38:35 +0300
Message-Id: <1085900b4e46bbb514e6918c321639ac380331ce.1744119460.git.jani.nikula@intel.com>
...
index 16fd7c00ba01..16c4e25f958a 100644
...
index 2dc641da0c3b..9e963bce340f 100644
...
index 9381aec797c9..9ca86f44f365 100644

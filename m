...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E0D6168EC08
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Feb 2023 10:49:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C87A610E728;
	Wed,  8 Feb 2023 09:49:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3E11C10E728
 for <intel-gfx@lists.freedesktop.org>; Wed,  8 Feb 2023 09:49:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675849744; x=1707385744;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=G0TedXy8pHxsXGX8F0wCyLYbbtvMiAUgZua/9L12/r4=;
 b=M3uNRwF3JphalevH6n8z0lrSlet6yOoh4UnGAMHDWJkpmxfwSW74dxPr
 dpgikblcyFYN0llAZTbHvVkRrgGHJuMc+MmRbAHcNqUOHH+UDMM8kzRAS
 Wo7/Sxi462K1Hfe/050FzLgd+yv8BDofcUgL7GewTuAo/2Hosqo8yVJ/9
 VZaFNseDkCSIRJGIYvPSKnNZEVHoLtC7TDvuzZNwE5nXcVhEdBcOAoIPL
 /7Nm1UDtbW1i+LkAsDkAay8Vx71X2tUeKHWauStZrmK92BcV6fE3gsJV8
 Gaky6+8iElHnC+9ZRv/Gk4PSbn2ziNnH299oow5JxKUlKTMlf3ykw6rwP Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10614"; a="357145990"
X-IronPort-AV: E=Sophos;i="5.97,280,1669104000"; d="scan'208";a="357145990"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2023 01:49:03 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10614"; a="755990496"
X-IronPort-AV: E=Sophos;i="5.97,280,1669104000"; d="scan'208";a="755990496"
Received: from joergber-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.48.82])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2023 01:49:00 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  8 Feb 2023 11:48:40 +0200
Message-Id: <2f6fa8f3215b7a9f71a2b21d4eccd0bca526dbce.1675849634.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 02/10] drm/i915/wm: move remaining watermark

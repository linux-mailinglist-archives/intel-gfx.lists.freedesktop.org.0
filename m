...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8320211F7CD
	for <lists+intel-gfx@lfdr.de>; Sun, 15 Dec 2019 13:52:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E04E89CBC;
	Sun, 15 Dec 2019 12:52:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8973189CBC
 for <intel-gfx@lists.freedesktop.org>; Sun, 15 Dec 2019 12:52:43 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19585709-1500050 
 for <intel-gfx@lists.freedesktop.org>; Sun, 15 Dec 2019 12:52:39 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 15 Dec 2019 12:52:38 +0000
Message-Id: <20191215125238.2335503-1-chris@chris-wilson.co.uk>
...
index 30ba67c9abe9..910ae7288479 100644
--- a/drivers/gpu/drm/i915/gt/intel_ring_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_ring_submission.c
@@ -1371,22 +1371,26 @@ static int load_pd_dir(struct i915_request *rq,

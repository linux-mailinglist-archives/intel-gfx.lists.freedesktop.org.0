...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C067142CBAB
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 22:49:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFB606EB33;
...
Subject: [Intel-gfx] [PATCH v4 08/20] drm/radeon: cleanup:

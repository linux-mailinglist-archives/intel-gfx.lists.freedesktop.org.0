...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FE1030614A
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Jan 2021 17:53:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34FDE6E85B;
	Wed, 27 Jan 2021 16:53:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 313976E85A
 for <intel-gfx@lists.freedesktop.org>; Wed, 27 Jan 2021 16:52:58 +0000 (UTC)
IronPort-SDR: OtKCDmkqhEbBfs4RCtLtdks9hVXhtl3fa6VQjbnjgL9u63nLOQD/NlNqp5M3VEQTRRWlg0RDaE
 cx6I7bMkEPGA==
X-IronPort-AV: E=McAfee;i="6000,8403,9877"; a="180176959"
X-IronPort-AV: E=Sophos;i="5.79,380,1602572400"; d="scan'208";a="180176959"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jan 2021 08:52:57 -0800
IronPort-SDR: py2vYacTbKw1pcCUFGS+a5aGXepqjy16o3UKWOEznn1vcveyx9cAv6tpPhbetHwHk81bN6kY3i
 vxBdVOfTGxZQ==
X-IronPort-AV: E=Sophos;i="5.79,380,1602572400"; d="scan'208";a="578211832"
...
Date: Wed, 27 Jan 2021 08:54:01 -0800
Message-Id: <20210127165402.117829-3-jose.souza@intel.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <20210127165402.117829-1-jose.souza@intel.com>
References: <20210127165402.117829-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 3/4] drm/i915: Fail driver probe when unable
 to load DRAM information
...
cnMvZ3B1L2RybS9pOTE1L2k5MTVfZHJ2LmMKaW5kZXggYWVjMGU4NzBkYzI1Li43ZmY1OGVhMzBj
N2MgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZHJ2LmMKKysrIGIvZHJp
dmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuYwpAQCAtNjIyLDEyICs2MjIsMTYgQEAgc3RhdGlj
...
bS5jCmluZGV4IDRkNWFiMjA2ZWFjYi4uNmNlNTZlZWRhZjEyIDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9pbnRlbF9kcmFtLmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvaW50
ZWxfZHJhbS5jCkBAIC00ODQsNyArNDg0LDcgQEAgc3RhdGljIGludCBnZW4xMl9nZXRfZHJhbV9p
...
ID0gJmk5MTUtPmRyYW1faW5mbzsKIAlpbnQgcmV0OwpAQCAtNDk3LDcgKzQ5Nyw3IEBAIHZvaWQg
...
IAogCWlmIChJTlRFTF9HRU4oaTkxNSkgPj0gMTIpCiAJCXJldCA9IGdlbjEyX2dldF9kcmFtX2lu
Zm8oaTkxNSk7CkBAIC01MDcsMTMgKzUwNywxOCBAQCB2b2lkIGludGVsX2RyYW1fZGV0ZWN0KHN0

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GOefGiVtBGprIQIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2026 14:23:01 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C998532FD1
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2026 14:23:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 24C6710EE1E;
	Wed, 13 May 2026 12:22:59 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="I3967fje";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4235210EE15;
 Wed, 13 May 2026 12:22:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1778674977; x=1810210977;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=/WnhDjpM+YRL3dabn/rbFg9SDUBgPQQybY8uepth0CU=;
 b=I3967fjenRXQ4ngTn57v193ihqOOWI966qoicmnpaK/F/yLOjedtocS4
 TRX2Vpu3yv1ebh0WFxREg+RHxySipl2ZYMFcMEsfM4S4w482AmZZ9pl2/
 dq40XYm2aZ4Y0Vgdpw6FfCnoxV2rD2/rjWMO0LAMgll+murgnLokyR6hB
 rga3Jd0vn23DaU3GZ6KAaJR6wUAExk9kRnapABYZ7/esAI8y/8jBUCYnc
 n54Op6Y121EikarpWJykmrTiDXoxSBNOqczjOvHfNJ061D4zp8d6TnAtU
 Rg1dNvdSRSWU+lY9uP94Dki6AiYR1O5lMTzA3tC5+sVk+YMHgT2cgcNaP A==;
X-CSE-ConnectionGUID: VMW5VTpMTzSroffRMolnPg==
X-CSE-MsgGUID: tR/X6crIS5K1BiJlJ36u4g==
X-IronPort-AV: E=McAfee;i="6800,10657,11784"; a="90701438"
X-IronPort-AV: E=Sophos;i="6.23,232,1770624000"; d="scan'208";a="90701438"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2026 05:22:57 -0700
X-CSE-ConnectionGUID: 0lwTsbuSSqqJ5T6xTxJSLA==
X-CSE-MsgGUID: JCku/40iS1+Z/glctlbS0Q==
X-ExtLoop1: 1
Received: from amilburn-desk.amilburn-desk (HELO localhost) ([10.245.244.10])
 by fmviesa003-auth.fm.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 May 2026 05:22:54 -0700
Date: Wed, 13 May 2026 15:22:51 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org
Subject: Re: [RESEND 5/6] drm/i915/display: stop passing i to
 for_each_*_intel_crtc_in_state() macros
Message-ID: <agRtG-DAT6rpWIYU@intel.com>
References: <cover.1778659089.git.jani.nikula@intel.com>
 <edb9dc76cb9cad50622a1f425abaf076d1509888.1778659089.git.jani.nikula@intel.com>
MIME-Version: 1.0

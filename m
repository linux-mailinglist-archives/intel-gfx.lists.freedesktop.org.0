...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 151AE3CBD13
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jul 2021 22:00:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9CB16E9F6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 16/51] drm/i915/guc: Update GuC debugfs to
 support new GuC

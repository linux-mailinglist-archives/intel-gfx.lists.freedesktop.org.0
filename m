...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 695ED925FC1
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jul 2024 14:10:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF83510E7CB;
	Wed,  3 Jul 2024 12:10:04 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Iju8lXXf";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9D19310E7CB
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jul 2024 12:10:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1720008604; x=1751544604;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=OOTbCK8DENAo1Hlkx0mqm/U4cDMtqpVw+okoFctDVEE=;
 b=Iju8lXXfUnXoeOYONf4sFYLNHsCNrUaV8aJpwuIO6IvW6N9+UtVAUspq
 xziNJmVKAxXzvbOz2mG07u+6bGCxBAnXTGhTOjPPia20XwVAMeEZEtbFU
 W6bGB0HWc/Bqyrnqw1q0xE/YFTZGkZZCjiQfae5wyDXUwRY4vmQ9jJtLE
 BOq8RxLxwJ4sp2O3mYxZuhQu5YPaaV9oopcrraKOQ+UEOVdZIAPuc8GyT
 8XyUHvc8ZySu0dzWXGU9xzUMtGyODRu2eIg8JXtrJ7/yvSfdnZKrtKpnC
 dQywRDnJNHkQIJs9jbW1FzlZ8P2wbvdbHHGrGeuF+2wxfUWB7oeESIPQc g==;
X-CSE-ConnectionGUID: rI2Z8pWqTGSuv7bbiSrcrg==
X-CSE-MsgGUID: n2voNem2TZyR0DRf/XA5Aw==
X-IronPort-AV: E=McAfee;i="6700,10204,11121"; a="17069535"
X-IronPort-AV: E=Sophos;i="6.09,182,1716274800"; d="scan'208";a="17069535"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jul 2024 05:10:04 -0700
X-CSE-ConnectionGUID: GBHrXcF1S9myjzT073ZXIQ==
X-CSE-MsgGUID: FU+WWaMhSmWXvKSSKqImhg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,182,1716274800"; d="scan'208";a="46211341"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by fmviesa008.fm.intel.com with SMTP; 03 Jul 2024 05:10:01 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 03 Jul 2024 15:10:00 +0300
Date: Wed, 3 Jul 2024 15:10:00 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Manna, Animesh" <animesh.manna@intel.com>
Cc: "intel-gfx@lists.freedesktop.org" <intel-gfx@lists.freedesktop.org>
Subject: Re: [PATCH 09/14] drm/i915/dsb: Introduce
 intel_dsb_wait_scanline_{in, out}()
Message-ID: <ZoU_mFGYoi4yYPKo@intel.com>

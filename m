...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 54C5443B171
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Oct 2021 13:41:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 229396E83E;
...
Subject: [Intel-gfx] [PATCH 8/9] drm/i915: Disable tracing points on
 PREEMPT_RT

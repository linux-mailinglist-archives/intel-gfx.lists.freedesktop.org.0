...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 05264507A49
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Apr 2022 21:33:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D36E89D2F;
	Tue, 19 Apr 2022 19:33:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6F37C89C28
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 Apr 2022 19:33:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1650396804; x=1681932804;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=tBG+bwYrFLzfe5Nzqn8bhsmLa9FEWabZLWHRaLTOdmQ=;
 b=E4/uSyCyxljVL80NWDGoh3Jh8BaDxfqiKkrJHMbgISwOoE6kkw/okv7i
 Sh7S9E/rSmEcd+nHv3oIxpgHyUplTdMsRbLxjlHdATzSv3L5NCWINMKeg
 KUN4uLDawHSNkuCUk+CwADSwb6jOX7WGLk0btsK6CrvSMX1OggdiAqR9u
 MT0ZV61nmQ1V+DhK0ssTYOputnUSDDSQjUTrPuu9704plVpW7qPZ1Mumh
 Vdjm2UxKtUI88a55nkWiYpuJSWGgAGHIVbIbLZoxbqA/ITQixo514MdpO
 xtb5bzO7hyeg7aGKXxh7QfmexpEnvnV8N5dohhz6+lylMPh+vqwT9GR/p g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10322"; a="244437965"
X-IronPort-AV: E=Sophos;i="5.90,273,1643702400"; d="scan'208";a="244437965"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2022 12:33:24 -0700
X-IronPort-AV: E=Sophos;i="5.90,273,1643702400"; d="scan'208";a="554868568"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2022 12:33:23 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 19 Apr 2022 12:33:08 -0700
Message-Id: <20220419193314.526966-2-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/7] drm/i915/gsc: add gsc as a mei auxiliary
 device
...
index 64bd2b098c695..163f50eed9691 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -9997,6 +9997,7 @@ S:	Supported

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E03A3472482
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Dec 2021 10:37:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB5FC10E707;
...
Subject: [Intel-gfx] [PATCH 0/3] drm/dp: Move DisplayPort helpers into own
 module

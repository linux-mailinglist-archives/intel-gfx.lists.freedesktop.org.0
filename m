...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 553617DCA8D
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Oct 2023 11:17:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A8B810E458;
	Tue, 31 Oct 2023 10:17:11 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 3/6] drm/edid: include drm_eld.h only where
 required

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17BF729CBCF
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Oct 2020 23:11:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 40E5F6E20B;
	Tue, 27 Oct 2020 22:11:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2A01E6E20B
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Oct 2020 22:11:24 +0000 (UTC)
IronPort-SDR: sU/x2VdUU++pDaKbWho0DYOAq1JidU8841TrMKLkbu3sbu/0ZWI0f7aCGJsIMRddBNtuyOp62h
 nUChiqZkJ74A==
X-IronPort-AV: E=McAfee;i="6000,8403,9787"; a="168299460"
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="168299460"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2020 15:11:23 -0700
IronPort-SDR: 1DEbX8k/69RBg0UztS4OkXwAfQ5LLLDZqscgDIBKeaiKZbrwWoFMQsnoFBMskbBg4kpLMF55TP
 K1DSpcRd8xNg==
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="323114111"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 27 Oct 2020 15:11:23 -0700
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 27 Oct 2020 15:13:08 -0700
Message-Id: <20201027221312.16518-1-manasi.d.navare@intel.com>
X-Mailer: git-send-email 2.19.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 1/5] drm/i915/dp: Some reshuffling in

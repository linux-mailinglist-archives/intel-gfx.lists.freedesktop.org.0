...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6B16910E6
	for <lists+intel-gfx@lfdr.de>; Sat, 17 Aug 2019 16:48:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 954456E50B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/6] dma-fence: Simply wrap

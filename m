...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 31EAD3C3A02
	for <lists+intel-gfx@lfdr.de>; Sun, 11 Jul 2021 05:53:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EB8A6EB7E;
	Sun, 11 Jul 2021 03:53:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ot1-x331.google.com (mail-ot1-x331.google.com
 [IPv6:2607:f8b0:4864:20::331])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B1F5F6EB7B
 for <intel-gfx@lists.freedesktop.org>; Sun, 11 Jul 2021 03:53:43 +0000 (UTC)
Received: by mail-ot1-x331.google.com with SMTP id
 h24-20020a9d64180000b029036edcf8f9a6so14444300otl.3
 for <intel-gfx@lists.freedesktop.org>; Sat, 10 Jul 2021 20:53:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=jlekstrand-net.20150623.gappssmtp.com; s=20150623;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=pgm8tWnP9Qw+fFMlHWQM7xvSAA4M6kZ/Omvo2MoNcBo=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=pgm8tWnP9Qw+fFMlHWQM7xvSAA4M6kZ/Omvo2MoNcBo=;
 b=
X-Gm-Message-State: AOAM533rQQl3wu9AfoT5TgG+qt6QE4PNwIYCj/US3TCIasNmTn8V0MaP
 Oh1Ix/PCqHD2b1oKcprspTJvcNDxwCLoYQ==
X-Google-Smtp-Source: ABdhPJw6Ngcc4jOYsN6CI4EPSd7bWPxQdI2aODVacDAXAn0AGHZwsCm5Ukft81kSbCdcfw6eNz/KBQ==
X-Received: by 2002:a9d:651a:: with SMTP id i26mr5388184otl.148.1625975622706; 
 Sat, 10 Jul 2021 20:53:42 -0700 (PDT)
Received: from omlet.lan ([68.203.99.148])
 by smtp.gmail.com with ESMTPSA id a11sm2310188otr.48.2021.07.10.20.53.41
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sat, 10 Jul 2021 20:53:42 -0700 (PDT)
From: Jason Ekstrand <jason@jlekstrand.net>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Sat, 10 Jul 2021 22:53:32 -0500
Message-Id: <20210711035336.803025-2-jason@jlekstrand.net>
X-Mailer: git-send-email 2.31.1
In-Reply-To: <20210711035336.803025-1-jason@jlekstrand.net>
References: <20210711035336.803025-1-jason@jlekstrand.net>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/5] drm/i915: Revert "drm/i915/gem:
...
index d14cda2ff9230..5351376333b42 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1951,17 +1951,12 @@ const char *i915_cache_level_str(struct drm_i915_private *i915, int type);

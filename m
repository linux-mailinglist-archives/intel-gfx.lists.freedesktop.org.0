...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7D2EBBECF
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2019 01:09:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0C256E9B2;
	Mon, 23 Sep 2019 23:09:14 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 4/6] virtio: introduce a mdev based transport

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CEEA154F31
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jun 2019 14:47:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BFB46E0F0;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 ce4A==
Subject: [Intel-gfx] [PATCH 1/6] dma-buf: add dynamic DMA-buf handling v12

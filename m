...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F7D12CBFB0
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Dec 2020 15:31:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9B2356EA3F;
...
Subject: [Intel-gfx] [PATCH v3 03/13] drm/edid: Parse DSC1.2 cap fields from
 HFVSDB block

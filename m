...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D795859FD07
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Aug 2022 16:16:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 542F712BC93;
	Wed, 24 Aug 2022 14:15:41 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 0/9] Move all drivers to a common dma-buf
 locking convention

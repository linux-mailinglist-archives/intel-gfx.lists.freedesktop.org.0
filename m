...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28B8842CBC3
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 22:49:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0AE566EB37;
...
Subject: [Intel-gfx] [PATCH v4 09/20] drm/omapdrm: cleanup:

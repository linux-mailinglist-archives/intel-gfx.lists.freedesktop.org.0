...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F1FB8604974
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Oct 2022 16:39:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DD3E10F248;
	Wed, 19 Oct 2022 14:39:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B98EA10F250
 for <intel-gfx@lists.freedesktop.org>; Wed, 19 Oct 2022 14:39:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666190354; x=1697726354;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=M5qJ4eDwv+LRMRvji2s9KStRPwo/IUfkigKwissm5Pc=;
 b=RuaTvI1NGIu1sX8UL95tTLycKaEcH5rWRjOt1qiDMRE56F4kK9hVuTad
 +oBSGTmPg6gDCykG6bsdH/sNUrvIvl5cQkBp+80Xeba5O+si4vQmHyMI3
 FzLLCOzRLgM2WUJSNi6NcSSp5CnrGjTiq3Ykl2vy2v0iAbtnUy9Fs87ux
 TW8VKwKEjsrmCOY6A/pGSG44i8h7TwJx5mt3pAiHLY2uWxFPGDV1Rvwjx
 MK2EWjgocdWllQOZoyIjPWp/YITnUWzuDtfqeUvQGtakniUW3dt97SKet
 e6zoZpilTgNybWU5OQBHHdlEzJdr1LM8f3bewV1vB83OXcxr3QrQcn33U Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="392729570"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="392729570"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Oct 2022 07:38:36 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="631697361"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="631697361"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Oct 2022 07:38:33 -0700
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 19 Oct 2022 16:38:17 +0200
Message-Id: <20221019143818.244339-1-andrzej.hajda@intel.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Organization: Intel Technology Poland sp. z o.o. - ul. Slowackiego 173,
 80-298 Gdansk - KRS 101882 - NIP 957-07-52-316
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915: use intel_uncore_rmw when
 appropriate

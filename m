...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E8BDE136F16
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 15:13:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DAED89FDD;
	Fri, 10 Jan 2020 14:13:19 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5698889FD4
 for <Intel-gfx@lists.freedesktop.org>; Fri, 10 Jan 2020 14:13:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 19835091-1500050 for multiple; Fri, 10 Jan 2020 14:12:48 +0000
MIME-Version: 1.0
To: Intel-gfx@lists.freedesktop.org,
 Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
In-Reply-To: <aacea301-9bed-424e-42a7-c398bf242b1d@linux.intel.com>
References: <20200110133049.2705-1-tvrtko.ursulin@linux.intel.com>
 ...
 <aacea301-9bed-424e-42a7-c398bf242b1d@linux.intel.com>
Message-ID: <157866556720.10140.3743718088985504485@skylake-alporthouse-com>
User-Agent: alot/0.6
Date: Fri, 10 Jan 2020 14:12:47 +0000

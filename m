...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 317B6349921
	for <lists+intel-gfx@lfdr.de>; Thu, 25 Mar 2021 19:08:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E1D6B6EE2E;
	Thu, 25 Mar 2021 18:08:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0324D6EE23
 for <intel-gfx@lists.freedesktop.org>; Thu, 25 Mar 2021 18:07:32 +0000 (UTC)
IronPort-SDR: igndVAeomHAGzd6qwhjhyJ3Za6jgj5HiXEBBCPE8HTVKWmBftiqEbwDainbs7ty7urKIqtqbrO
 m0PGpFjQXVRg==
X-IronPort-AV: E=McAfee;i="6000,8403,9934"; a="178112550"
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="178112550"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:32 -0700
IronPort-SDR: A/zD+auJgr4+RVKGQxj6GyKEA8oyNpDVG1IhRVhAJfIohYNTMwqmm7SAgHzX9szNXVe9IErX42
 itM74N464H1A==
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="453176656"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.168])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:32 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 25 Mar 2021 11:06:58 -0700
Message-Id: <20210325180720.401410-29-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 28/50] drm/i915/adl_p: Implement TC sequences
...
IGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF90Yy5jCmluZGV4IGMwMDc4MDNj
ZmQzMC4uN2JhZTAxOTNhYTBmIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNw
...
bS9pOTE1L2k5MTVfcmVnLmgKQEAgLTEwMTUxLDYgKzEwMTUxLDcgQEAgZW51bSBza2xfcG93ZXJf
...
UE9SVF9XSURUSF9NQVNLCQkJKDcgPDwgMSkKQEAgLTEyNTgzLDYgKzEyNTg0LDE1IEBAIGVudW0g

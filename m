...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C66BACB6747
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Dec 2025 17:28:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57E8E10E83D;
	Thu, 11 Dec 2025 16:28:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=lankhorst.se header.i=@lankhorst.se header.b="j2LJOGbp";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (lankhorst.se [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B3BDF10E83D;
 Thu, 11 Dec 2025 16:28:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1765470526;
 bh=9gCKnMzauq1EgDlxj5/d0ncxaLvtKEm7MmnJ4+bl8G8=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH 3/9] drm/i915/display: Use intel_de_write_fw in
 intel_pipe_fastset
Date: Thu, 11 Dec 2025 17:19:26 +0100
Message-ID: <20251211161923.843758-14-dev@lankhorst.se>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B4C98A22967
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Jan 2025 09:08:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB9CB10E288;
	Thu, 30 Jan 2025 08:08:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ZOtl1uy4";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4923E10E27A;
 Thu, 30 Jan 2025 08:08:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1738224514; x=1769760514;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=J0QalXACFolXtez4Y/NBWes5/IURYGLpgj0yc0b26qs=;
 b=ZOtl1uy40KNMYNALc4HxoEpujaLvLot5RH5x9mDxyeSKNlo24GSxqB47
 no2BrHPsSnO6RGUHv43qrMaw6RaUD5ZjDZBqp3Oj0N0OjoaJSXcOI1ztU
 e+z5JQ3N+0KlOqSmVR66OIOzwjUINewEv5JlN0V47vVmppHOJGuKQo13n
 bbTdGc0TQTP1z33gankyiS2xpMCVTlwJ3v5pLuo53xfgWHYQ0IKjjvM6V
 f8jHCMPqfi3VV0bI/qZxxJmDZcegD6/AYtp68CT7rkulucuZbhCZ37Kyn
 dREFh6yKJUMN7VBoOqBVDPVc60tYEjkCWoAARclLPe0F8lGEjTKz02ua+ A==;
X-CSE-ConnectionGUID: /2zSIOLXQfi7Nfs985BbZQ==
X-CSE-MsgGUID: +WMmE5H9Tp6NEt4kAzY+4Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11330"; a="38926131"
X-IronPort-AV: E=Sophos;i="6.13,244,1732608000"; d="scan'208";a="38926131"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jan 2025 00:08:34 -0800
X-CSE-ConnectionGUID: 1rtmxHTHTyuWwui0+6ozJg==
X-CSE-MsgGUID: fTYK2B5BQvGRrb74yowO1w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="110169762"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 30 Jan 2025 08:08:30.5939 (UTC)

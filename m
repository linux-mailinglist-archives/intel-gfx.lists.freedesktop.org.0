...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D1554065F0
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 05:18:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2062A6E958;
	Fri, 10 Sep 2021 03:17:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [205.139.111.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A492C6E957
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Sep 2021 03:17:55 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-104-7Tm8ErezPqaPNn58ncP2jA-1; Thu, 09 Sep 2021 23:17:51 -0400
X-MC-Unique: 7Tm8ErezPqaPNn58ncP2jA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 3DE7E1006AA1;
 Fri, 10 Sep 2021 03:17:50 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 9CE7C100EBC1;
 Fri, 10 Sep 2021 03:17:48 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com, Dave Airlie <airlied@redhat.com>,
 Jani Nikula <jani.nikula@intel.com>
Date: Fri, 10 Sep 2021 13:17:18 +1000
Message-Id: <20210910031741.3292388-3-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 02/25] drm/i915/uncore: constify the register
 vtables.
...
@@ -2092,22 +2084,70 @@ void intel_uncore_init_early(struct intel_uncore *u=
ncore,
...
@@ -2122,38 +2162,29 @@ static int uncore_forcewake_init(struct intel_uncor=
e *uncore)
=20
...
ier;
@@ -2196,8 +2227,8 @@ int intel_uncore_init_mmio(struct intel_uncore *uncor=
e)
=20
...
@@ -2536,10 +2567,10 @@ intel_uncore_forcewake_for_reg(struct intel_uncore =
*uncore,
 =09=09return 0;
=20
 =09if (op & FW_REG_READ)

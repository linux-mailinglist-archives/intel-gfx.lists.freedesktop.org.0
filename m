...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 139AA4AD787
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 12:37:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD82610E639;
	Tue,  8 Feb 2022 11:37:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0076710E607
 for <intel-gfx@lists.freedesktop.org>; Tue,  8 Feb 2022 11:37:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644320242; x=1675856242;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=DmTKA2/f3Aa8onetX41f4/kcV95y0g+FhPKsVYpJz7M=;
 b=QQtNL7U4gl/MfqybiSwHFITjPgJ8KPxpAfJFx7JhJDu1gtd6iF79hyFQ
 rmcsOzve/5FSJS9CxioOHcjsjPmabcZLr3h/edZv/fFAYwXBNfP3RybdE
 BsIMmWCrjrqMzB6hdsX3Ft8xmBQOJb716lEKPK4PzDJyVV7cShibs0fIX
 BdZ5j+/0tCXWXEQZd+yZrlPNdxrAKYgggNnpsa8gC2K6mYO53s+I+8EwW
 pqRwLqV5DLzjfPldPtAJ4nIFYvjQxph7nn8PFUnOX1RWwc/KmWQBO1h5Y
 31nO++HEZqlnSBz6zvkByNC+BA5Nt0oOISC9UyEGSubFLJ8laEcyQKJqU w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10251"; a="232496000"
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="232496000"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:22 -0800
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="481915351"
Received: from ideak-desk.fi.intel.com ([10.237.68.141])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:21 -0800
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  8 Feb 2022 13:36:48 +0200
Message-Id: <20220208113656.179823-19-imre.deak@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 18/26] drm/i915: Simplify power well
 definitions by adding power well instances
...
index 2bf1bdfd6467d..3fcc9226a7ac3 100644

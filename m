...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E3DB05E629D
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Sep 2022 14:41:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D047210E31C;
	Thu, 22 Sep 2022 12:40:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3F61F10E32F
 for <intel-gfx@lists.freedesktop.org>; Thu, 22 Sep 2022 12:40:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663850450; x=1695386450;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=twjIN/9xdvdaOkvMLMozxYV7QDBxNsKizeJ+ODhInnc=;
 b=PxPrI9kgH37iwrRkJ7niH/fmt4Ot3gZTZwFd1b3Ztr2ceTqcxZmwCtqM
 utId2nRRPF9vgRIodx5ubQMCYvlG3MjFwt4/EFrOv7WHM+n5CG7LriyZx
 0VYTkHNbngRIBSamUjFpYkg/ZKppGH9x5krLBrVfOEn1bUCWKgjMjcRKF
 q8snVRjYFSPpAC25Fzr9A1Nozp/RvJKoirizBl/N3lcNTqvLZPX9Pi81s
 QMx1T+b9xtbf+oPN1MsNb/10IFx9FBgiHZeJMm+9p1isRIPr9cUPN1IkY
 jiRD1D2D7xb/iyAUi279o8JmiZ568+QmTvfbY7PJbDdVARshKi/mDSKMu A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10478"; a="280003502"
X-IronPort-AV: E=Sophos;i="5.93,335,1654585200"; d="scan'208";a="280003502"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Sep 2022 05:40:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,335,1654585200"; d="scan'208";a="864838776"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 22 Sep 2022 12:40:47.2467 (UTC)
...
Cc: "Nikula, Jani" <jani.nikula@intel.com>,
 ...
 Daniel J Blueman <daniel@quora.org>, "Wysocki,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 51673B9B685
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Sep 2025 20:19:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4EA410E20D;
	Wed, 24 Sep 2025 18:19:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 1538d3639d33 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9266F10E0B8;
 Wed, 24 Sep 2025 18:19:56 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============5937946691327359080=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=93_i915=2ECI=2EFull=3A_success_for_drm/i915/vrr=3A_Refactor?=
 =?utf-8?q?_VRR_live_status_wait_into_common_helper_=28rev2=29?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Ankit Nautiyal" <ankit.k.nautiyal@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Wed, 24 Sep 2025 18:19:56 -0000
Message-ID: <175873799658.363593.2534623922040058657@1538d3639d33>
...
#### Issues hit ####
  ...
  * igt@fbdev@nullptr:
    - shard-dg2:          NOTRUN -> [SKIP][1] ([i915#2582])
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-dg2-11/igt@fbdev@nullptr.html

  * igt@gem_create@create-ext-set-pat:
    - shard-rkl:          NOTRUN -> [SKIP][2] ([i915#14544] / [i915#8562])
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_create@create-ext-set-pat.html

  * igt@gem_ctx_sseu@invalid-sseu:
    - shard-rkl:          NOTRUN -> [SKIP][3] ([i915#14544] / [i915#280])
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_ctx_sseu@invalid-sseu.html

  * igt@gem_exec_balancer@parallel-dmabuf-import-out-fence:
    - shard-rkl:          NOTRUN -> [SKIP][4] ([i915#14544] / [i915#4525])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_exec_balancer@parallel-dmabuf-import-out-fence.html

  * igt@gem_exec_reloc@basic-gtt-read:
    - shard-rkl:          NOTRUN -> [SKIP][5] ([i915#14544] / [i915#3281]) +2 other tests skip
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_exec_reloc@basic-gtt-read.html

  * igt@gem_lmem_swapping@heavy-multi:
    - shard-dg2:          NOTRUN -> [SKIP][6] ([i915#14964]) +1 other test skip
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-dg2-11/igt@gem_lmem_swapping@heavy-multi.html

  * igt@gem_lmem_swapping@parallel-random-verify:
    - shard-rkl:          NOTRUN -> [SKIP][7] ([i915#14544] / [i915#4613])
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_lmem_swapping@parallel-random-verify.html

  * igt@gem_mmap_gtt@basic-small-bo:
    - shard-dg2:          NOTRUN -> [SKIP][8] ([i915#2575]) +77 other tests skip
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-dg2-11/igt@gem_mmap_gtt@basic-small-bo.html

  * igt@gem_partial_pwrite_pread@reads:
    - shard-rkl:          NOTRUN -> [SKIP][9] ([i915#14544] / [i915#3282]) +1 other test skip
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_partial_pwrite_pread@reads.html

  * igt@gem_pwrite@basic-exhaustion:
    - shard-glk10:        NOTRUN -> [WARN][10] ([i915#14702] / [i915#2658])
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-glk10/igt@gem_pwrite@basic-exhaustion.html

  * igt@gem_pxp@create-valid-protected-context:
    - shard-rkl:          NOTRUN -> [TIMEOUT][11] ([i915#12964])
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_pxp@create-valid-protected-context.html

  * igt@gem_render_copy@y-tiled-mc-ccs-to-yf-tiled-ccs:
    - shard-dg2:          NOTRUN -> [SKIP][12] ([i915#2575] / [i915#5190]) +2 other tests skip
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-dg2-11/igt@gem_render_copy@y-tiled-mc-ccs-to-yf-tiled-ccs.html

  * igt@gem_userptr_blits@stress-purge:
    - shard-rkl:          NOTRUN -> [DMESG-WARN][13] ([i915#12964])
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_userptr_blits@stress-purge.html

  * igt@gem_userptr_blits@unsync-unmap:
    - shard-rkl:          NOTRUN -> [SKIP][14] ([i915#14544] / [i915#3297])
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gem_userptr_blits@unsync-unmap.html

  * igt@gen9_exec_parse@bb-chained:
    - shard-rkl:          NOTRUN -> [SKIP][15] ([i915#14544] / [i915#2527])
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-rkl-6/igt@gen9_exec_parse@bb-chained.html

  * igt@i915_drm_fdinfo@busy:
    - shard-dg2:          NOTRUN -> [SKIP][16] ([i915#14959]) +8 other tests skip
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-dg2-11/igt@i915_drm_fdinfo@busy.html

  * igt@i915_pm_rpm@gem-execbuf-stress-pc8:
    - shard-dg2:          NOTRUN -> [SKIP][17] ([i915#14962]) +1 other test skip
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-dg2-11/igt@i915_pm_rpm@gem-execbuf-stress-pc8.html

  * igt@i915_suspend@basic-s3-without-i915:
    - shard-dg2:          NOTRUN -> [WARN][18] ([i915#15037])
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153874v2/shard-dg2-11/igt@i915_suspend@basic-s3-without-i915.html
...
#### Warnings ####
  ...
  * igt@kms_rotation_crc@primary-y-tiled-reflect-x-270:
  ...
  [i915#15037]: https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/15037
...
nel/-/issues/14964">i915#14964</a>) +1 other test skip</li>
</ul>
</li>
<li>
...
5/kernel/-/issues/14962">i915#14962</a>) +1 other test skip</li>
</ul>
</li>
<li>
...
hout-i915.html">WARN</a> (<a href=3D"https://gitlab.freedesktop.org/drm/i91=
5/kernel/-/issues/15037">i915#15037</a>)</li>
</ul>
</li>
<li>

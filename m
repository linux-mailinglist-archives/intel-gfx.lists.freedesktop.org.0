...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC44F7CE380
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:06:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3829810E406;
...
Subject: [Intel-gfx] [PATCH v7c 02/24] dyndbg: reword "class unknown,
 " to "class:_UNKNOWN_"

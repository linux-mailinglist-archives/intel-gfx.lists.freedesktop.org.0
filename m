...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DEA91B8678
	for <lists+intel-gfx@lfdr.de>; Sat, 25 Apr 2020 14:24:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A45DB6E1BA;
	Sat, 25 Apr 2020 12:24:18 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 46/59] drm/arc: Align with simple pipe
 helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1C1738F706
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 02:39:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D04B6E2E1;
	Tue, 25 May 2021 00:39:06 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [RFC PATCH 06/97] drm/i915/guc: enable only the
 user interrupt when using GuC submission

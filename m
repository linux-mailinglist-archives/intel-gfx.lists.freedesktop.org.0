...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BBD806462EE
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Dec 2022 22:05:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B912310E420;
	Wed,  7 Dec 2022 21:05:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C091910E41F
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Dec 2022 21:05:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670447112; x=1701983112;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=xkRIEZsfPNHm1we9jUTmjADIkuib8dcV8mLBeChD95I=;
 b=IWYYnlvHc9mF1KoOku7LxGUsWMvaXTVJLFDuVh8tGXXWUBHQ0sPIQ3eo
 Wve3jpPjHE4K5omC8hG4lTHxSDZ3canRok3fPtZfXDHcq6xzau4J14OqP
 VQw2K7OS+BAv3/hwOfiW7LeocDT2EbPuhDveX1ZjkuhGtoNWMjvVBGi6z
 qmU8S2mc0cvV6uj6XqrqavcIym/2m4RqcIrxh5R24EpNmcy26IC8CbK09
 wkfA65Zb8Lhz3UY1XBXLQ2hok5/SP92k0jHID45krdM+zqfMEX7KW496z
 QfT9j1xRINR9i6hgZJcZuvdf8qYdic50NUsNPxHe62Gg4VjkQvtkLArM1 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10554"; a="379172001"
X-IronPort-AV: E=Sophos;i="5.96,225,1665471600"; d="scan'208";a="379172001"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Dec 2022 13:04:59 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10554"; a="597104632"
X-IronPort-AV: E=Sophos;i="5.96,225,1665471600"; d="scan'208";a="597104632"
Received: from mdnavare-mobl1.jf.intel.com ([10.165.21.203])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Dec 2022 13:04:59 -0800
Date: Wed, 7 Dec 2022 13:05:15 -0800
From: "Navare, Manasi" <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20221207210515.GA1306246@mdnavare-mobl1.jf.intel.com>
...
In-Reply-To: <Y5Cs/tILCmsuizzK@intel.com>

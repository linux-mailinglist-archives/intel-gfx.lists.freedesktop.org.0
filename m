...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 582B2ACC5D8
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Jun 2025 13:53:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E182D10E713;
	Tue,  3 Jun 2025 11:53:51 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Ck6eac5i";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1ED7F10E65E;
 Tue,  3 Jun 2025 11:53:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1748951631; x=1780487631;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=1rWZu6zk+/8Dn/O0RQ+wvJF7YY6eB0G1xr7Z4PhkCPE=;
 b=Ck6eac5iwMmKjLEWFzOYb38yBNBvdYnDMp2KzcwtwLu3wFlj/q7mhg9f
 qugS1avbzxme6CvYJNA5OCb+40HaU7x6VVOUtxEWuQslzHGUhveyZb9gj
 FmWWNOGlIIq9tQPl6B9YDQHaEML3RL1fBN9Vgx+JUtL+Pq6BXb1rnIuIm
 baLyPCbTxxJQ2JLQ5ZE43KB8r/Gb7XbNVum/YowoMWrlhP3TXLt/Vhozm
 J+mZVvXd5ULchpMt2jaJyHIiSWPzMTeSHgqMswZ4WMxNek/SY606GFaZb
 Jsumm0vI3BTODZEyqUUE26y9GyNLzDjtFKVXtAawGIhqkow9k85rM+Ltq w==;
X-CSE-ConnectionGUID: ks9rgosnTdi1j7mIz4QVkA==
X-CSE-MsgGUID: A7V6SpoITxedx4kWkSzERw==
X-IronPort-AV: E=McAfee;i="6700,10204,11451"; a="53616469"
X-IronPort-AV: E=Sophos;i="6.16,206,1744095600"; d="scan'208";a="53616469"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2025 04:53:50 -0700
X-CSE-ConnectionGUID: zc8PVXCqQFSz6+98yJLfQQ==
X-CSE-MsgGUID: cczEwOWMTZ2mBHmdAgQHRw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,206,1744095600"; d="scan'208";a="149993337"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2025 04:53:44 -0700
...
Subject: [PATCH v12 04/10] mtd: intel-dg: register with mtd
Date: Tue,  3 Jun 2025 14:39:47 +0300
Message-ID: <20250603113953.3599816-5-alexander.usyskin@intel.com>

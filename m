...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C40CF7C8317
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Oct 2023 12:32:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3B0C10E5D4;
	Fri, 13 Oct 2023 10:32:01 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915: Flush WC GGTT only on required
 platforms

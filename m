...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 955C44F76A3
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Apr 2022 08:59:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5095A10E4BB;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: consider min_page_size when
 migrating

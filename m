...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F2DC1249BB
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Dec 2019 15:31:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A5FE26E4AB;
	Wed, 18 Dec 2019 14:31:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C34926E46F
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Dec 2019 14:31:35 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19622421-1500050 
 for multiple; Wed, 18 Dec 2019 14:31:14 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 18 Dec 2019 14:31:09 +0000
Message-Id: <20191218143111.3852266-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 6/8] drm/i915/gt: Pull GT initialisation under
 intel_gt_init()
...
---
 ...
 14 files changed, 326 insertions(+), 320 deletions(-)

diff --git a/drivers/gpu/drm/i915/display/intel_overlay.c b/drivers/gpu/drm/i915/display/intel_overlay.c
index 6097594468a9..243d2b6b36fa 100644
...
index 0926ecea9147..974077e45952 100644
...
@@ -277,8 +279,8 @@ gen8_emit_ggtt_write(u32 *cs, u32 value, u32 gtt_offset, u32 flags)
...
index 8389b7b5010c..1564301e4359 100644
...
index cde629eda5fa..62cd07884677 100644
...
@@ -3777,13 +3777,12 @@ static void execlists_shutdown(struct intel_engine_cs *engine)
...
-	kfree(engine);
 ...
 static void
@@ -3791,13 +3790,9 @@ logical_ring_default_vfuncs(struct intel_engine_cs *engine)
 {
...
index 05d3fcf015e9..9e02ff9a650d 100644
...
index 9d399e8e2688..2bfd092ad118 100644
...
index 83f549d203a0..8bb5acf7199e 100644
...
index a9e0ee37dcc0..983755bec76b 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B67E58752D
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:16:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CFFA16EDAB;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 llJw==
Subject: [Intel-gfx] [PATCH 1/4] dma-buf: add reservation_object_fences
 helper

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A47C02C2476
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Nov 2020 12:39:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9CFED6E3F0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/15] drm/i915: Remove references to struct
 drm_device.pdev

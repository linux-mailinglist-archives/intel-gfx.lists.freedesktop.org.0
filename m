...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC074420D4
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Jun 2019 11:31:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF97389487;
	Wed, 12 Jun 2019 09:31:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A5B7889458
 for <intel-gfx@lists.freedesktop.org>; Wed, 12 Jun 2019 09:31:19 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16873862-1500050 
 for multiple; Wed, 12 Jun 2019 10:31:12 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 12 Jun 2019 10:31:05 +0100
Message-Id: <20190612093111.11684-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/8] drm/i915: Stop retiring along engine
...
ZGV4IDllZmY5ZGU3ZmExMC4uOWM1OGFlNmU0YWZiIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9k

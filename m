...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 465A9A71A8F
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Mar 2025 16:37:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C452410E703;
	Wed, 26 Mar 2025 15:37:22 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="MpOxv31Z";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6EC6C10E703;
 Wed, 26 Mar 2025 15:37:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1743003442; x=1774539442;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=l70KLgYLIyv4aSEcSxo3W5vkTl81a0q5W5XdNZ8aaR8=;
 b=MpOxv31ZhPzNx5qD0uxPc690wDnnRCU3e5Dh16Etm+S7HRxKStImUspI
 GW3ED7NVjhLrzYF9PeYm1ksr7qqAK79KHH585f0KKAiZrmY79SobwKU0n
 uuUoBi9Nj50QxQ+oEYnW2yY7vg1Z9Sgl+8pvtolPdzFiQQzHeA+Ddmamg
 XLcfOn17D6r6478l8SKBGtx+VMRTs3QtkPho6Tw/dz9hVMjFK4oShkkR8
 KUTr3GmbFy43qBsvEnKl8ziiA7vDWs3PtLJyJbRr3bBUw8XcQ7ftNQ6Dw
 CXfAyU7hMBaa5nFRlB7tTaBC/SBzU6fldwq0DSTfO7SVjno1Hy+ii8Z4L Q==;
X-CSE-ConnectionGUID: WJTfcxheQi+cKSuJeSKiuw==
X-CSE-MsgGUID: SukarQ91Tqa4FaErlI56vw==
X-IronPort-AV: E=McAfee;i="6700,10204,11385"; a="55665442"
X-IronPort-AV: E=Sophos;i="6.14,278,1736841600"; d="scan'208";a="55665442"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Mar 2025 08:37:21 -0700
X-CSE-ConnectionGUID: hNUVRTa+T1ylH3jMudsTHg==
X-CSE-MsgGUID: CaLVDnYeTVeJxfgBjeODrw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,278,1736841600"; d="scan'208";a="129923408"
...
Subject: [PATCH v7 01/12] mtd: core: always create master device
Date: Wed, 26 Mar 2025 17:26:12 +0200
Message-ID: <20250326152623.3897204-2-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 269CE5AD8AA
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Sep 2022 20:00:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0391210E476;
	Mon,  5 Sep 2022 18:00:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C7D8E10E477
 for <intel-gfx@lists.freedesktop.org>; Mon,  5 Sep 2022 18:00:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1662400805; x=1693936805;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=DDXVRQxUGhSiT5X+2iC2xoiceZ+AWiVlNbPQtK0v8Rc=;
 b=grTl0ACmh1DrNxnILKbKK632OKOHFUWTAlicOvSAj1YZm/Zu46FiFK5H
 /faCboVa+fcZqyeOHsvgHTK1DnTWG3qiTxlZbMqYlbzVxnTyE0foSetQs
 r6+DrzBXGAPjvPUsjqvCUavZU3XWKudfyggGyOfbhuq+QFLgR+kAUv3bQ
 SXZ/TjnYDXin2WVAToCanFNk5bAYj1eYPcmq6NhatgPZMuVjaJjN4JTWL
 2uHhv8vCdhMzhBFe9YbPpi2ysE0GK//nWr7DkE6M/90JQEPiC64iT0roH
 DegmqkWpj+84EiuqbG+EtfohIL4Id6N0I5kdETD5kXnJMnFr23nC3/Y07 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10461"; a="295171017"
X-IronPort-AV: E=Sophos;i="5.93,291,1654585200"; d="scan'208";a="295171017"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Sep 2022 11:00:05 -0700
X-IronPort-AV: E=Sophos;i="5.93,291,1654585200"; d="scan'208";a="942178939"
Received: from bnilawar-desk1.iind.intel.com ([10.145.169.158])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Sep 2022 11:00:03 -0700
From: Badal Nilawar <badal.nilawar@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  5 Sep 2022 23:32:15 +0530
Message-Id: <20220905180219.1971119-2-badal.nilawar@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AAE542F6E03
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jan 2021 23:17:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 04CD26E043;
	Thu, 14 Jan 2021 22:17:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6D7066E043
 for <intel-gfx@lists.freedesktop.org>; Thu, 14 Jan 2021 22:17:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1610662674;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=rOlM2DoJHt+QmfSlQZPQQjANmGY9fNaxSm/x2NOIXng=;
 b=KmdfL9qWtTu9lDM5eHUr/sUmKuzA2RJtqarthFWZPpdnjawWzhl2bL1x3l1RI0QwWkPwou
 OX0KaNfZcks/pBNLU5joSkFDh7IDcHYO7F2ifyJgjLau3bqushmGsg5TZPzAi0z2xOj2Vm
 WaovnYU41BnZaoxJ0jZYAYuK4pnD3vE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-301-ZDfOjTA_P9a8_v9VGZfxjA-1; Thu, 14 Jan 2021 17:17:50 -0500
X-MC-Unique: ZDfOjTA_P9a8_v9VGZfxjA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id AB83BB8104;
 Thu, 14 Jan 2021 22:17:47 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-115-182.rdu2.redhat.com
 [10.10.115.182])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 00E0910023AF;
 Thu, 14 Jan 2021 22:17:41 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Thu, 14 Jan 2021 17:17:06 -0500
Message-Id: <20210114221709.2261452-3-lyude@redhat.com>
In-Reply-To: <20210114221709.2261452-1-lyude@redhat.com>
References: <20210114221709.2261452-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.22
Subject: [Intel-gfx] [PATCH v7 2/5] drm/i915: Keep track of pwm-related

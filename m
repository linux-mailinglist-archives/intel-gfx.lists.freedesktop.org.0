...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F0AF62D7710
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Dec 2020 14:56:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 083B66EE02;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 07/19] drm/i915/hdcp: HDCP stream encryption
 support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DF0D6EE352
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 15:42:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5EB0110E2C4;
	Tue, 25 Apr 2023 13:42:07 +0000 (UTC)
...
Subject: [Intel-gfx] IOCTL feature detection (Was: Re: [PATCH 8/8] drm/i915:

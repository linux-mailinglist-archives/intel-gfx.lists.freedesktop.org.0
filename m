...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 52EA050A866
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 20:50:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A148B10E97F;
...
Subject: [Intel-gfx] [PATCH v4 4/6] drm/i915: ttm backend dont provide

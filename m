...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F5F5364E3C
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Apr 2021 00:57:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E4A36E503;
	Mon, 19 Apr 2021 22:57:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2A30E6E4D2
 for <intel-gfx@lists.freedesktop.org>; Mon, 19 Apr 2021 22:57:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1618873067;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=cTxDov8fqFDGgM20Fpmb8o7MyA69axtJ6Ag7INVRohE=;
 b=HKVPAOvxlnsxQ/WILgszLbmOuuyvNvCwrb0EMyThRPLeIb2/nkHJk2yBKsDJkOAO5+dUKd
 U8SFOFGPEQZyznUZUHyaqgsSzN3FI/la1t47zYyLU5k8PsxbO5nmX6jdNvTEFdeH9NOddi
 m6T1ypwg0WPE2B/w7iNq+xkExm/bJp0=
...
Subject: [Intel-gfx] [PATCH v3 18/20] drm/dp: Convert drm_dp_helper.c to

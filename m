...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 60E705014D
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jun 2019 07:45:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02EDB89950;
	Mon, 24 Jun 2019 05:45:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CDFB3898F5
 for <intel-gfx@lists.freedesktop.org>; Mon, 24 Jun 2019 05:45:06 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17000420-1500050 
 for multiple; Mon, 24 Jun 2019 06:43:22 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 24 Jun 2019 06:43:13 +0100
Message-Id: <20190624054315.18910-17-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/19] drm/i915/gt: Drop stale commentary for
 timeline density
...
L2ludGVsX3RpbWVsaW5lLmMKaW5kZXggMDMwYmNkMjI0OWU5Li45OTU0MDZiZGUyN2UgMTAwNjQ0

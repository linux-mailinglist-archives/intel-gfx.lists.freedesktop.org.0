...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 548A38757A
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:17:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 552246EDE1;
	Fri,  9 Aug 2019 09:16:28 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 zJVg==
Subject: [Intel-gfx] [PATCH v2 18/34] fbdev/pvr2fb: convert put_page() to
 put_user_page*()

...
Received: from mail.lfdr.de
	...
	id Ck+VClocPGogkAgAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Jun 2026 20:05:14 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED4356C09AA
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Jun 2026 20:05:13 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=lankhorst.se header.s=default header.b=MXDlsdJe;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org;
	dmarc=pass (policy=none) header.from=lankhorst.se
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A67810F009;
	Wed, 24 Jun 2026 18:04:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (unknown [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 640BC10F05D;
 Wed, 24 Jun 2026 18:04:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1782324291;
 bh=Smwtu6CwhUCwK5agwnez+Jaqs++M2OVTTW4z7GIcls4=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH v10 25/30] drm/i915/gt: Add a spinlock to prevent starvation
 of irq_work.
Date: Wed, 24 Jun 2026 20:04:52 +0200
Message-ID: <20260624180459.1024068-26-dev@lankhorst.se>
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.freedesktop.org:from_smtp,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,lankhorst.se:dkim,lankhorst.se:email,lankhorst.se:mid,lankhorst.se:from_mime,linutronix.de:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: ED4356C09AA

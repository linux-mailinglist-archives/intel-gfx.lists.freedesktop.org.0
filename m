...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A5E29AD004E
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Jun 2025 12:23:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C406910EA47;
	Fri,  6 Jun 2025 10:23:06 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="lEfoGUhD";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1EFE210EA3D;
 Fri,  6 Jun 2025 10:23:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1749205385; x=1780741385;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=8mLoobmGRSl3V7aWIAz8c0yr7OO6MSXvKHkSp0buFNk=;
 b=lEfoGUhDzRW5N5/TkkPLVZ27UQ5qhjjsZUfnwjHLEbIKM+qrLS58IvUz
 okGj6pe5z5Macy7VjxOeu2BsB699I/ujRVQNDW5tBp8qIwihULYPI74pG
 pDL4v0jTcqj/rh44LBh09Ammt/nXve//QwEaZewbq5D3e5YAy+I7UzxG5
 szBw7cMo97Z92QBtmZxrcoEZbsZi6ITHcrn18bhyByQUcdK2BMGKYhdUr
 EDRB/ewuZVm6i7HPJxggGLt1kQ57cX9kzsdiJHw+oIyP3AM4tkyaj0Cfr
 dlH5UeEE7BGhMeMPlGdPG/ghJ4p0F4XHC144WNt89fo5UE2peFtPPq0Hj g==;
X-CSE-ConnectionGUID: gkDvB7qoT1CBTZ7FzLfPzw==
X-CSE-MsgGUID: B/V21LLHQd+e4qYyY1Yc2g==
X-IronPort-AV: E=McAfee;i="6800,10657,11455"; a="53976938"
X-IronPort-AV: E=Sophos;i="6.16,214,1744095600"; d="scan'208";a="53976938"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2025 03:23:05 -0700
X-CSE-ConnectionGUID: 2nAtUPtLTSO9j8c5gzX5FQ==
X-CSE-MsgGUID: t8vWSMd2Rju9gSEbvIaEhw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,214,1744095600"; d="scan'208";a="145717393"
Received: from pgcooper-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.245.33])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2025 03:23:01 -0700
...
Subject: [PATCH v4] drm/i915: split out display register macros to a separate
 file
Date: Fri,  6 Jun 2025 13:22:56 +0300
Message-Id: <20250606102256.2080073-1-jani.nikula@intel.com>
...
---
 ...
 .../gpu/drm/i915/display/intel_display_regs.h | 2935 +++++++++++++++++
 ...
 drivers/gpu/drm/i915/i915_reg.h               | 2924 ----------------
 drivers/gpu/drm/i915/intel_gvt_mmio_table.c   |    1 +
 drivers/gpu/drm/xe/display/xe_plane_initial.c |    1 +
 73 files changed, 3020 insertions(+), 2934 deletions(-)
...
index 97aef729f7d4..6c2ab2e0dc91 100644
...
index 8e8c3a2f401b..fe3a8e90b97a 100644
...
index 0282c0b2440b..339c5c50eb67 100644
...
index 88494bd4f968..0d73f32fe7f1 100644
...
index 4719d270e31b..d3c5255bf1a8 100644
...
index 9cbfddb8556a..9a1603138297 100644
...
index 817939f6d4dd..2c2371574d6f 100644
...
index 1d2d6f851d98..f446f73f0fe2 100644
...
index 85fdcc53f368..52a902532e6f 100644
...
-
 ...
 enum skl_power_gate {
 	SKL_PG0,
@@ -3403,652 +1214,6 @@ enum skl_power_gate {
 	ICL_PG4,
 };
...
@@ -4056,30 +1221,6 @@ enum skl_power_gate {
...
@@ -4094,45 +1235,6 @@ enum skl_power_gate {
...
@@ -4141,37 +1243,11 @@ enum skl_power_gate {
...
index f5a98c3cafee..87ac4446d306 100644

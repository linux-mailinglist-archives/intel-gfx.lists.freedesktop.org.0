...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B27443D0088
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 19:43:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C84576E4D0;
...
Subject: [Intel-gfx] [PATCH v2 14/14] vfio: Remove struct vfio_device_ops
 open/release

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id MF7XA2V3gGmo8gIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 02 Feb 2026 11:07:33 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A9B16CA83F
	for <lists+intel-gfx@lfdr.de>; Mon, 02 Feb 2026 11:07:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E426610E3F4;
	Mon,  2 Feb 2026 10:07:30 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="dp0cySoY";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 749EF10E3F2;
 Mon,  2 Feb 2026 10:07:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1770026850; x=1801562850;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=uIkaLuaLr8kEpOMOX3Q4kck24KvzFqhZWCFj4H81FK8=;
 b=dp0cySoYsIk9hEqYHjtVorXT/DqDdkfItJDKKgey1gtPN1LVAY6IXmB/
 1pGNnwrvUUm2n8fnZcj4JOg919/iMjjGcLX1ZD2GNvv+D11fe4hRC7uGt
 AfWsusmGwoX5KAMsO0TtdMjWPXfkgYRcyKWtgXd2VSbvl067sUdaBaIwe
 pGrS+cPgbwfuvQcd6axGwcku7d98yg4hv6ueargryatY8hRLncCJz76NH
 qagoLKohHFO/rD01uOEHQuK3uvi8lP4gbBEz1JiLdWnVyl5MKQf09BGuO
 yqbpJCInVXvOusAB0hevQv38a2NZeokWAWtgV1IEItjaXxc1tyg6XGsgn Q==;
X-CSE-ConnectionGUID: +0OxoMfERdSKEppEY+cBIA==
X-CSE-MsgGUID: nEvpG1/+TOWFxMaeyexVmQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11689"; a="71163351"
X-IronPort-AV: E=Sophos;i="6.21,268,1763452800"; d="scan'208";a="71163351"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Feb 2026 02:07:29 -0800
X-CSE-ConnectionGUID: RfkVyrjIRdybrhBPPMrXYQ==
X-CSE-MsgGUID: +g84m+d+RFWG4ky4t124jw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,268,1763452800"; d="scan'208";a="208984823"
Received: from dut-2a59.iind.intel.com ([10.190.239.113])
 by fmviesa007.fm.intel.com with ESMTP; 02 Feb 2026 02:07:24 -0800
...
Subject: [RESEND 2/9] drm: Allow driver-managed destruction of colorop objects
Date: Mon,  2 Feb 2026 15:11:55 +0530
Message-Id: <20260202094202.2871478-3-chaitanya.kumar.borah@intel.com>

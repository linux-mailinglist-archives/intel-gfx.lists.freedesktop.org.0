...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F168F17E49C
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Mar 2020 17:19:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B22F06E4AF;
	Mon,  9 Mar 2020 16:19:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 183D76E4AD
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Mar 2020 16:19:36 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 20497632-1500050 for multiple; Mon, 09 Mar 2020 16:19:34 +0000
MIME-Version: 1.0
In-Reply-To: <87eeu135kf.fsf@gaia.fi.intel.com>
References: <20200309112431.13903-1-chris@chris-wilson.co.uk>
 <87eeu135kf.fsf@gaia.fi.intel.com>
To: Mika Kuoppala <mika.kuoppala@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
From: Chris Wilson <chris@chris-wilson.co.uk>
Message-ID: <158377077310.4769.2840055823228121182@build.alporthouse.com>
User-Agent: alot/0.8.1
Date: Mon, 09 Mar 2020 16:19:33 +0000

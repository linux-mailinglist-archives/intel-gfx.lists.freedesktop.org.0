...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C194E3D9A80
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 02:50:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E07A06EC26;
...
Subject: [Intel-gfx] [PATCH v3 06/14] vfio/fsl: Move to the device set
 infrastructure

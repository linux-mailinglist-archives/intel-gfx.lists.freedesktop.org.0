...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BBE4C618CBD
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Nov 2022 00:24:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B16AE10E6DB;
	Thu,  3 Nov 2022 23:24:45 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 5/7] vfio/ccw: remove release completion

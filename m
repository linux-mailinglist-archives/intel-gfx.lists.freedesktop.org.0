...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E4E222D12F
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Jul 2020 23:39:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 44F0C6EA12;
	Fri, 24 Jul 2020 21:39:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A9B6C6E162
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Jul 2020 21:39:24 +0000 (UTC)
IronPort-SDR: P63z6mbE2l/ql62Kpv23FAv11FgWh6Q73kx2xG8Hf+vUCfgXHo9Yns8qzW5ppWs+vc+laLWubW
 DTTDN3ubMGlQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9692"; a="149970013"
X-IronPort-AV: E=Sophos;i="5.75,392,1589266800"; d="scan'208";a="149970013"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2020 14:39:23 -0700
IronPort-SDR: T6/wp5IVsRMAuF9dUUxndACp2VZFMuq1Y580K0E3H4YdeRrb9TNod9C6wQqNRp8winV8Fe/Lmu
 nvSaI2TDeBRQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,392,1589266800"; d="scan'208";a="329041973"
Received: from ldmartin1-desk.jf.intel.com ([10.165.21.151])
 by orsmga007.jf.intel.com with ESMTP; 24 Jul 2020 14:39:23 -0700
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 24 Jul 2020 14:39:13 -0700
Message-Id: <20200724213918.27424-18-lucas.demarchi@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 17/22] drm/i915/dg1: map/unmap pll clocks
...
L2Rpc3BsYXkvaW50ZWxfZGRpLmMKaW5kZXggYzE5ZDVhMzc1ZWJhLi44YmM4OTcxMTM0OWIgMTAw
NjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGRpLmMKKysrIGIv
ZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kZGkuYwpAQCAtMjg5Myw2ICsyODkz
...
dWN0IGludGVsX2NydGNfc3RhdGUgKmNydGNfc3RhdGUpCiB7CkBAIC0yOTQwLDYgKzI5NzIsMTkg
...
CkBAIC0yOTU1LDYgKzMwMDAsNDAgQEAgc3RhdGljIHZvaWQgaWNsX3VubWFwX3BsbHNfdG9fcG9y
...
X2Nsa19uZWVkZWQpCiB7CkBAIC0zMDM3LDcgKzMxMTYsMTAgQEAgdm9pZCBpY2xfc2FuaXRpemVf
...
X2Nsa19zZWxlY3Qoc3RydWN0IGludGVsX2VuY29kZXIgKmVuY29kZXIsCkBAIC0zNTYyLDcgKzM2
NDQsOSBAQCBzdGF0aWMgdm9pZCBpbnRlbF9kZGlfcHJlX2VuYWJsZShzdHJ1Y3QgaW50ZWxfYXRv
...
NDgsNyArMzgzMiw5IEBAIHN0YXRpYyB2b2lkIGludGVsX2RkaV9wb3N0X2Rpc2FibGUoc3RydWN0
...
bmRleCAxZDQ2YzU3MTJiM2IuLmI4ODcwYmMzODE0ZCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKQEAgLTEwNzgyLDYgKzEwNzgyLDI3IEBAIHN0YXRp
...
IC0xMTA5MCw3ICsxMTExMSw5IEBAIHN0YXRpYyB2b2lkIGhzd19nZXRfZGRpX3BvcnRfc3RhdGUo
...
LmggYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlZy5oCmluZGV4IGJiYWE2NDMzNmFkYS4u
NzllZGFkYTI1Y2UxIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlZy5o
...
LCAuLi4pCQkJX1BJQ0socGh5LCBfX1ZBX0FSR1NfXykKIApAQCAtMTAzMTAsNiArMTAzMTIsNyBA
...
R19CSVQoKHBoeSkgKyAxMCkKQEAgLTEwMzI1LDYgKzEwMzI4LDE4IEBAIGVudW0gc2tsX3Bvd2Vy
...
MTAKICNkZWZpbmUgRFBMTDFfRU5BQkxFCQkweDQ2MDE0Ci0tIAoyLjI2LjIKCl9fX19fX19fX19f

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26F382DFA3E
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Dec 2020 10:05:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4A9616E483;
	Mon, 21 Dec 2020 09:05:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD5766E483
 for <intel-gfx@lists.freedesktop.org>; Mon, 21 Dec 2020 09:05:17 +0000 (UTC)
IronPort-SDR: /8ax3auppc4bwj5PqpqRFmhNFn5VJB2hPHSD9Qx7HC+akHcUn22V+sv/Nb1eDzsK2WoE5+1Wwb
 0JepXQKU6YAw==
X-IronPort-AV: E=McAfee;i="6000,8403,9841"; a="154915648"
X-IronPort-AV: E=Sophos;i="5.78,436,1599548400"; d="scan'208";a="154915648"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Dec 2020 01:05:17 -0800
IronPort-SDR: aqBpB2wJMrwjD+FK0MX6UknEOYWz7olHeHg1MtM3LzSIYLUJESqlFVQ0qDYcMhDIumLkyH2iYv
 5uWAkiuakbGA==
X-IronPort-AV: E=Sophos;i="5.78,436,1599548400"; d="scan'208";a="391061122"
Received: from mlesiews-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.213.22.241])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Dec 2020 01:05:14 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 21 Dec 2020 11:04:48 +0200
Message-Id: <20201221090449.8288-4-jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20201221090449.8288-1-jani.nikula@intel.com>
References: <20201221090449.8288-1-jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 4/5] drm/i915: refactor cursor code out of
 i915_display.c
...
YXkvaW50ZWxfZGlzcGxheS5jCmluZGV4IGVjOWEyOGI2OWUwOS4uYzgyMmUxMWRmMWJkIDEwMDY0

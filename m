...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FE5C3D6A29
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jul 2021 01:21:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB0FD6E8F7;
...
Subject: Re: [Intel-gfx] [PATCH 23/30] drm/i915/gt: remove explicit CNL
 handling from intel_sseu.c

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5791E4D5724
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Mar 2022 02:08:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E3A3810E5C6;
...
Subject: [Intel-gfx] [v6 0/5] enhanced edid driver compatibility

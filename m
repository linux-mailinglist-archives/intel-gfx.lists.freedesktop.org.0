...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F17120CDD2
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Jun 2020 12:13:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 14898898A7;
	Mon, 29 Jun 2020 10:13:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7CF7389885
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Jun 2020 10:13:06 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21647667-1500050 
 for multiple; Mon, 29 Jun 2020 11:12:59 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 29 Jun 2020 11:12:56 +0100
Message-Id: <20200629101256.13039-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 6/6] drm/i915: Switch to object allocations for
 page directories
...
---
Remaining problem here is coordinating the final free of objects from
the ppgtt which is later than we shut down the GEM uAPI layer.
---
 ...
 15 files changed, 182 insertions(+), 414 deletions(-)

diff --git a/drivers/gpu/drm/i915/gem/i915_gem_object_types.h b/drivers/gpu/drm/i915/gem/i915_gem_object_types.h
index 0fd677ad8ec8..b23895873926 100644
...
index dfde5fd452f1..909da7f36d18 100644
...
+			if (!pd->entry[pde]) {
 				...
 				pd->entry[pde] = pt;
@@ -227,24 +227,21 @@ static void gen6_alloc_va_range(struct i915_address_space *vm,
...
@@ -252,13 +249,11 @@ static int gen6_ppgtt_init_scratch(struct gen6_ppgtt *ppgtt)
...
@@ -298,7 +293,7 @@ static void pd_vma_bind(struct i915_address_space *vm,
...
@@ -308,8 +303,6 @@ static void pd_vma_unbind(struct i915_address_space *vm, struct i915_vma *vma)
 {
 	struct gen6_ppgtt *ppgtt = vma->private;
 	struct i915_page_directory * const pd = ppgtt->base.pd;
-	struct i915_page_dma * const scratch =
...
@@ -318,11 +311,11 @@ static void pd_vma_unbind(struct i915_address_space *vm, struct i915_vma *vma)
...
@@ -442,6 +435,7 @@ struct i915_ppgtt *gen6_ppgtt_create(struct intel_gt *gt)
...
index 58f5fd05f1e5..251a17c136fd 100644
...
@@ -357,16 +357,6 @@ static void gen8_ppgtt_alloc(struct i915_address_space *vm,
...
@@ -383,8 +373,7 @@ gen8_ppgtt_insert_pte(struct i915_ppgtt *ppgtt,
...
@@ -407,10 +396,12 @@ gen8_ppgtt_insert_pte(struct i915_ppgtt *ppgtt,
...
+	clflush_cache_range(vaddr, PAGE_SIZE);
 	...
 	return idx;
@@ -466,7 +457,7 @@ static void gen8_ppgtt_insert_huge(struct i915_vma *vma,
...
+			vaddr[index++] = encode | iter->dma;
 			...
 			start += page_size;
 			iter->dma += page_size;
@@ -491,6 +482,7 @@ static void gen8_ppgtt_insert_huge(struct i915_vma *vma,
 			}
...
+		clflush_cache_range(vaddr, PAGE_SIZE);
 		...
 		/*
@@ -522,7 +514,7 @@ static void gen8_ppgtt_insert_huge(struct i915_vma *vma,
...
@@ -576,27 +568,31 @@ static int gen8_init_scratch(struct i915_address_space *vm)
...
+		vm->scratch[i] = obj;
 	...
 	return 0;
@@ -622,7 +618,7 @@ static int gen8_preallocate_top_level_pdp(struct i915_ppgtt *ppgtt)
 		if (IS_ERR(pde))
 			return PTR_ERR(pde);
...
@@ -643,12 +639,13 @@ gen8_alloc_top_pd(struct i915_address_space *vm)
 	if (unlikely(!pd))
...
@@ -682,12 +679,7 @@ struct i915_ppgtt *gen8_ppgtt_create(struct intel_gt *gt)
 	 */
...
index e87568838034..cfba55c6050d 100644
...
@@ -721,18 +719,11 @@ static void ggtt_cleanup_hw(struct i915_ggtt *ggtt)
...
@@ -795,7 +786,7 @@ static int ggtt_probe_common(struct i915_ggtt *ggtt, u64 size)
 		return -ENOMEM;
 	}
...
@@ -803,8 +794,8 @@ static int ggtt_probe_common(struct i915_ggtt *ggtt, u64 size)
 		return ret;
 	}
...
+		ggtt->vm.pte_encode(px_dma(ggtt->vm.scratch[0]),
 	...
 	return 0;
@@ -830,7 +821,7 @@ static void gen6_gmch_remove(struct i915_address_space *vm)
 	struct i915_ggtt *ggtt = i915_vm_to_ggtt(vm);
...
@@ -858,6 +849,8 @@ static int gen8_gmch_probe(struct i915_ggtt *ggtt)
 	else
...
@@ -1006,6 +999,8 @@ static int gen6_gmch_probe(struct i915_ggtt *ggtt)
...
@@ -1056,6 +1051,8 @@ static int i915_gmch_probe(struct i915_ggtt *ggtt)
 	ggtt->gmadr =
...
index 0e3827868e50..ab586ab160bb 100644
...
@@ -194,14 +56,7 @@ void __i915_vm_close(struct i915_address_space *vm)
...
@@ -246,8 +101,6 @@ void i915_address_space_init(struct i915_address_space *vm, int subclass)
...
@@ -266,64 +119,47 @@ void clear_pages(struct i915_vma *vma)
...
@@ -340,21 +176,19 @@ int setup_scratch_page(struct i915_address_space *vm, gfp_t gfp)
 	 */
...
+
 		 ...
 		 *
@@ -364,61 +198,28 @@ int setup_scratch_page(struct i915_address_space *vm, gfp_t gfp)
...
index 9a80d15b2879..df36508e86df 100644
...
@@ -216,13 +199,6 @@ struct i915_vma_ops {
...
-
 struct i915_address_space {
 	struct kref ref;
 	struct rcu_work rcu;
@@ -259,7 +235,7 @@ struct i915_address_space {
...
@@ -268,17 +244,15 @@ struct i915_address_space {
 	 */
...
@@ -494,9 +468,9 @@ i915_pd_entry(const struct i915_page_directory * const pdp,
...
@@ -521,13 +495,10 @@ struct i915_ppgtt *i915_ppgtt_create(struct intel_gt *gt);
...
@@ -535,37 +506,36 @@ fill_page_dma(const struct i915_page_dma *p, const u64 val, unsigned int count);
...
index e017351b8d03..54b8edf8c247 100644
...
index 9aad3ec979bd..7fcc406b5597 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -588,11 +588,6 @@ struct i915_gem_mm {
 	 */
 	atomic_t free_count;
...
index 779ddcba101c..dc7ef2682fe8 100644
--- a/drivers/gpu/drm/i915/selftests/mock_gtt.c
+++ b/drivers/gpu/drm/i915/selftests/mock_gtt.c
@@ -77,6 +77,8 @@ struct i915_ppgtt *mock_ppgtt(struct drm_i915_private *i915, const char *name)

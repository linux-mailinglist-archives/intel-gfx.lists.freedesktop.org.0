...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D92DC35BF8D
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Apr 2021 11:09:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A47C6E2E1;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/19] drm/i915/dg1: Fix mapping type for

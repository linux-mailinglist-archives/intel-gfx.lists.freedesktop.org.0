...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF7FF5B0E45
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 22:40:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 362C410E885;
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915/gt: Use MEDIA_VER() when handling
 media fuses

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AEE6E43C1A5
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Oct 2021 06:37:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6DBC891BE;
...
Subject: [Intel-gfx] [PATCH v9 03/10] amdgpu: use dyndbg.CATEGORIES to
 control existing pr_dbgs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EE82486E52
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jan 2022 01:06:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B12D710E4DB;
	Fri,  7 Jan 2022 00:06:30 +0000 (UTC)
X-Original-To: Intel-GFX@lists.freedesktop.org
Delivered-To: Intel-GFX@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E073C10E4C8;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=+feJuVyLw1QFV2ztRkKOGNfQGNGyaNsqeRrIEMEhoYg=;
 b=nFpIr5zov0yayQ04DfoiRje1EdBokiez0KIQFYZMH0H200pRcNWeMUOg
 GrVR+Aa9P75NnCODqsxf0d0fHG6rF/kEGLrww8eUxqCFYYPsJSAkIaOs8
 QGZLMHIVqlTMPXptKSewze0Lo8pwDNoVtAz9bTJxdrW4H+y2IuZiF32ti
 2factmiW8r48up4g09hopmY059UQJeqcvhBm15EAKl2QJITg8mvofvCG/
 gFVoS9el/mh0SgowKAllJqPHu8hDcSWPXmmMUtrfh1K2XvF5fxQHSGFTG
 6F2g+AQWmh0nLMENFk/S7H5xuobiyEKAD0ao1s5zvnQhF2Xq5zGUaiZl3 w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10217"; a="306132702"
X-IronPort-AV: E=Sophos;i="5.88,268,1635231600"; d="scan'208";a="306132702"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jan 2022 16:06:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,268,1635231600"; d="scan'208";a="489110653"
Received: from relo-linux-5.jf.intel.com ([10.165.21.134])
 by orsmga002.jf.intel.com with ESMTP; 06 Jan 2022 16:06:22 -0800
From: John.C.Harrison@Intel.com
To: Intel-GFX@Lists.FreeDesktop.Org
Date: Thu,  6 Jan 2022 16:06:21 -0800
Message-Id: <20220107000622.292081-3-John.C.Harrison@Intel.com>
...
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915/guc: Update to GuC version
 69.0.3
...
index 9989d121127d..c13f123ae16e 100644

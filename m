...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED75326C449
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Sep 2020 17:35:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0817A6EA44;
	Wed, 16 Sep 2020 15:35:12 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 3/8] drm/i915: Add checks specific to async
 flips

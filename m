...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E45165990D8
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Aug 2022 01:04:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1026110E67A;
	Thu, 18 Aug 2022 23:03:44 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 05/15] mei: pxp: add command streamer API to
 the PXP driver

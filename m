...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0EFC3E097B
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Aug 2021 22:42:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 770596E497;
...
Subject: [Intel-gfx] [PATCH -next] drm/i915: fix i915_globals_exit() section
 mismatch error

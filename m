...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F344C679FB0
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 18:06:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E9F710E6E1;
...
Subject: [Intel-gfx] [PATCH v2 4/8] drm/i915/guc: Update GuC messages in
 intel_guc_ct.c

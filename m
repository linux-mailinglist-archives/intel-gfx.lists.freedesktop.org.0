...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E820549E1FA
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jan 2022 13:06:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7F8F810EEC9;
	Thu, 27 Jan 2022 12:06:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5DEB310EEBB;
 Thu, 27 Jan 2022 12:06:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643285168; x=1674821168;
 h=message-id:subject:from:to:cc:date:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=wL2Z2NgcpPoTknmljt1mcXmtEzhRVcXNrcQ5uKPEjHA=;
 b=UCAalFFrzpAtJ+YkP+wyqDLTOnoFTIbd9+N6ydXBCyj54lE4pjvl2UbC
 TcZni1StsIrytttVaDigAOjy8qxWrNwMtWhclqClu5Gc3qraHBlTqD4bA
 +0hJJIoy2dP9bDZQQgSG3qOIpN+hVRs7/1rQdbt3BOioW4m17lCNum6tW
 C0uiXr0PF8qpCT4MwfhBFJMvy6gqI2zi6XAqocZfIn3mFg9CG80wBbtiK
 2s1KhoxSQ3G0rPra2fK/+uzMyw8fFjEm3l2NkB/sHdPDmU+naTJKctsf2
 XJ4kd3WMdt4qHcDT2wlUr3fcLZyKQCUJeeCIzgBryN67QvKEMFaYTQ6sr Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10239"; a="333184707"
X-IronPort-AV: E=Sophos;i="5.88,320,1635231600"; d="scan'208";a="333184707"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jan 2022 04:06:07 -0800
X-IronPort-AV: E=Sophos;i="5.88,320,1635231600"; d="scan'208";a="618304505"
Received: from cmathias-mobl1.ger.corp.intel.com (HELO [10.249.254.207])
 ([10.249.254.207])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jan 2022 04:06:04 -0800
Message-ID: <27506ac8eff06662f063d563662555cb08f2ce64.camel@linux.intel.com>
From: Thomas =?ISO-8859-1?Q?Hellstr=F6m?= <thomas.hellstrom@linux.intel.com>
To: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>, Gwan-gyeong Mun
 <gwan-gyeong.mun@intel.com>, intel-gfx@lists.freedesktop.org
Date: Thu, 27 Jan 2022 13:05:40 +0100
In-Reply-To: <83aec5cf-2e5c-77ec-b716-0416551c3f2a@linux.intel.com>

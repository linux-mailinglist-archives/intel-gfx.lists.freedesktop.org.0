...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id eG4wJTw1tGn4igAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Mar 2026 17:03:08 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 464D9286915
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Mar 2026 17:03:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9C4110EB98;
	Fri, 13 Mar 2026 16:03:06 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="P44sGn1N";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EB08310E45B;
 Fri, 13 Mar 2026 16:03:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1773417785; x=1804953785;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Q6kzTiBZ3MzfVfX4DGp9ExsYYT3ZjaMXXhf78b28wRo=;
 b=P44sGn1N6Q1a3ySje3WDNH980ZhhuqjycT29WvrKfLS6WhNMFBV6M/3g
 oi2pu4Vqp+U1lIVRCY99p0QKDOEPgYMdbTUcestbcDaLQApUUSjDm6+s1
 ge4s/NieqsYz7maJ+fopI5lDoaxRLX5e+PClalXCQbaI3fyExYBGwAn2A
 6tH/7zRxPnT3QeyOUee/R98kbnXQsw/k4EPeM6IxITnEpinrLCoqLwiee
 lJri6keaEQhlOQgyboK8xYEFRF/WO6lpzOlPJTR/COvfO/yfIfI5OIkbv
 tdedormLa1CUuGr0M+/E+Ibm6X1dpU/H13fCi6h1wVqNwYKp78kv0Ia1+ Q==;
X-CSE-ConnectionGUID: xDIwaFk5Q4C4VBET+5Nk/Q==
X-CSE-MsgGUID: lFqf04dbQymWFUJb4++3zQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11728"; a="74715323"
X-IronPort-AV: E=Sophos;i="6.23,118,1770624000"; d="scan'208";a="74715323"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Mar 2026 09:03:05 -0700
X-CSE-ConnectionGUID: 1nzgal2yTNqhX7hsQlGepA==
X-CSE-MsgGUID: /ZgTtPPnQWy7xvQM9VVABA==
X-ExtLoop1: 1
Received: from srr4-3-linux-101-amanna.iind.intel.com ([10.223.74.76])
 by fmviesa003.fm.intel.com with ESMTP; 13 Mar 2026 09:03:03 -0700
...
Date: Fri, 13 Mar 2026 21:02:52 +0530
Message-Id: <20260313153300.3530695-5-animesh.manna@intel.com>

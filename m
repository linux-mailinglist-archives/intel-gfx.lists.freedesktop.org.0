...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0B1560D406
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Oct 2022 20:51:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9F80F10E1E9;
...
Subject: [Intel-gfx] [PATCH 10/10] iommufd: Allow iommufd to supply
 /dev/vfio/vfio

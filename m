...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 458C264EE6E
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Dec 2022 17:02:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3F9010E5FB;
	Fri, 16 Dec 2022 16:01:56 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 11/12] drm/i915/opregion: convert

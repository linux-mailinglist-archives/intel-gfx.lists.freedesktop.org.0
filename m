...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2001D6EA972
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 13:40:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D77FC10E319;
	Fri, 21 Apr 2023 11:40:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C3BCC10E2F6;
 Fri, 21 Apr 2023 11:40:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682077201; x=1713613201;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=huVBvg18KVoKU147n5d14MfagB2asX5HPec8abw0Ur0=;
 b=NZ23MHCZCvkHNUT3IvPVeWfQQMhgWS03KWIX67iqRfCoRUecViDNuexe
 VAax8on4tdfKAKz9KFMrAZsebfNoh5olVYzgUk3rywLCFJKgP4VgsUV7B
 OPL6HM6u+9cb7R85FFY65iEqg9oZshGcyQoohR6AEO9WfmljwvpfIxyDv
 NPPvJIx+vcFpbxShQfZ7BXHJG6+2hNTK3IJ5a0FrR2TIkwhuhcGGtx815
 +x5jV9eIj7sOC0NJyvmsveoW62oSMlidEslOhnadlTsTw2j4U+i9Lh1AU
 y+qiUajzHnmfMq4bvzxZcD4t8mD1Fep+j6ZZ70VG0at6JyQ/hbLTBVXxd w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="325573954"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="325573954"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 04:40:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="756880870"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="756880870"
Received: from vhavelx-mobl2.ger.corp.intel.com (HELO [10.213.192.37])
 ([10.213.192.37])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 04:39:59 -0700
Message-ID: <3405a3c8-8ad4-958f-c1dd-4b3105daca31@linux.intel.com>
Date: Fri, 21 Apr 2023 12:39:57 +0100
MIME-Version: 1.0

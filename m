...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ADC58A59B66
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Mar 2025 17:48:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F66610E423;
	Mon, 10 Mar 2025 16:48:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ADP2+VQV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1798110E420;
 Mon, 10 Mar 2025 16:48:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1741625281; x=1773161281;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=7Cjzk7ocPlKMZP3AlimscFy6gWQ4wLqDoLqA0i1lQbg=;
 b=ADP2+VQVDiNekk1YTilL3DC+Vm+LCayKrgDiuyHLzZMNcfWkHr9cAMbS
 2YJJTE5g7yz80NSeV4EKVY93fyGfBm9OTMPB3fgUkPEhoOa+t/opK+4H+
 8SrdZGkDLuZmse0+MoWVRaZQluvg9Yyv2+MfOl7vIwCc2VV/wdM28uQD8
 VbT5ZMUxIY27AHAAhe8ZaUkflOuedYTfoZI9nRmIOvyNmJKE5JIO5qMci
 jA4poSbxQ5Ds3GQsmnEpaSPuE+yrX8IW+jdPRXasEqnZcHxZxosP/RTP+
 6Lktywv0Horfthd2PPg52Q3SaKiqQpGW677loWtKk+7axLDWKpNHEAwnm w==;
X-CSE-ConnectionGUID: LEwgOXctTn+AnsvmxgBAkg==
X-CSE-MsgGUID: PYmZA8hzTN+bMLQdBqx6Eg==
X-IronPort-AV: E=McAfee;i="6700,10204,11369"; a="52839286"
X-IronPort-AV: E=Sophos;i="6.14,236,1736841600"; d="scan'208";a="52839286"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Mar 2025 09:48:00 -0700
X-CSE-ConnectionGUID: QgYBh5f2TcSgF7ZnOQJChg==
X-CSE-MsgGUID: /UZWyfjPTGGJF2zWg5mYJw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,236,1736841600"; d="scan'208";a="125270001"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orviesa005.jf.intel.com with SMTP; 10 Mar 2025 09:47:58 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Mon, 10 Mar 2025 18:47:57 +0200
Date: Mon, 10 Mar 2025 18:47:57 +0200
...
Subject: Re: [PATCH v3 1/3] drm/i915/display: Convert intel_bw.c internally
 to intel_display
Message-ID: <Z88XvVp-rEzrsmzv@intel.com>
...
In-Reply-To: <20250307-xe3lpd-bandwidth-update-v3-1-58bbe81f65bf@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 084CA6F0F4C
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 01:49:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 91C4A10EBFF;
...
Subject: [Intel-gfx] [PATCH v9 7/8] drm/i915/pxp: On MTL,

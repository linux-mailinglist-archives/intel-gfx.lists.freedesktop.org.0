...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C7A01DAA4C
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Oct 2019 12:49:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8723B6EA49;
...
Subject: [Intel-gfx] [PATCH V4 0/6] mdev based hardware virtio offloading
 support

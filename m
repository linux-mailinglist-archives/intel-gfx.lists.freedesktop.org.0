...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21AAB9E3663
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Dec 2024 10:23:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCFE110EC95;
	Wed,  4 Dec 2024 09:23:19 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="KOCycIW7";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A332210E4BE;
 Wed,  4 Dec 2024 09:23:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1733304199; x=1764840199;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=BWbXJDFaI8EgLty7YFvm7ppdf4GZ7oJgBPeaxZsl3yU=;
 b=KOCycIW7jNMWUhaEYJN5Elsbj9hAQwRKRUGT2MKofhrbnad4kRHh4sZe
 hqrEKRkCi95dJrofIeo1jQClT/GjLe1TEPEVnbqpr6p6RThWjKUR9snfN
 xOxrfMy0Zek2CBWeThgW5Fd7AHUfWNCmo8pTXJvhYWCdrXiLh9cEQ+xW+
 Ll/HRehMU9z61oJL2X/GQr5WaszaR7m/WnqUq82bHUuE36ZkbVnCM4Uy2
 +QlwPHvTrpL0PQmToCM0f7Ip5hoHvCdyqC195cjbvLdttxjpDwnItjx/5
 Q1HxTFxw3ofbnAJk/hdpM9JP78BFSeXLtWThCO144CX5MOJstLA4JrJ1k g==;
X-CSE-ConnectionGUID: wv2Ob7H1TVmofe0gKX+UUw==
X-CSE-MsgGUID: gtpYVIwvRhSCfazgKnwadg==
X-IronPort-AV: E=McAfee;i="6700,10204,11275"; a="50977936"
X-IronPort-AV: E=Sophos;i="6.12,207,1728975600"; d="scan'208";a="50977936"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Dec 2024 01:23:19 -0800
X-CSE-ConnectionGUID: xC3LvTocSFKz5nyzjgXt6Q==
X-CSE-MsgGUID: RIuRbvCDTeaBd0Ph9fTK3Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,207,1728975600"; d="scan'208";a="97770729"
Received: from kuha.fi.intel.com ([10.237.72.152])
 by fmviesa003.fm.intel.com with SMTP; 04 Dec 2024 01:23:15 -0800
Received: by kuha.fi.intel.com (sSMTP sendmail emulation);
 Wed, 04 Dec 2024 11:23:14 +0200

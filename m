...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D5E6B2536D2
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Aug 2020 20:25:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC97E6EA9D;
	Wed, 26 Aug 2020 18:25:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-2.mimecast.com
 [205.139.110.61])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 798016EAA8
 for <intel-gfx@lists.freedesktop.org>; Wed, 26 Aug 2020 18:25:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 ...
 b=XfOd/7cL0oqPrC/6OgJdYOrVjPHJ0wWYPI0Z5ddTlEsy3pmsZS3lMc0B+uYE5g1SnapptV
 N0xuJd+l1m6Hat/iDVFN9FwzbhmWPEDPW7c0NgLywKJe0VjdW6rDAN0NtsJAH8mUiMkI2X
 WOaHfndv0oyBRk3mmXtm30D93Pprplw=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-346-7fga3h_mPzikwQp_r-tuPQ-1; Wed, 26 Aug 2020 14:25:33 -0400
X-MC-Unique: 7fga3h_mPzikwQp_r-tuPQ-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B3CD8800C78;
 Wed, 26 Aug 2020 18:25:30 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-119-77.rdu2.redhat.com
 [10.10.119.77])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 868DA100238E;
 Wed, 26 Aug 2020 18:25:28 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: dri-devel@lists.freedesktop.org, intel-gfx@lists.freedesktop.org,
 nouveau@lists.freedesktop.org
Date: Wed, 26 Aug 2020 14:24:42 -0400
Message-Id: <20200826182456.322681-7-lyude@redhat.com>
In-Reply-To: <20200826182456.322681-1-lyude@redhat.com>
References: <20200826182456.322681-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.22
Subject: [Intel-gfx] [PATCH v5 06/20] drm/nouveau/kms: Search for encoders'
 connectors properly

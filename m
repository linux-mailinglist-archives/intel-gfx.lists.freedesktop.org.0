...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2B742466D8
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Aug 2020 15:02:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD4286E108;
...
Subject: [Intel-gfx] [PATCH] drivers: ntb: convert tasklets to use new
 tasklet_setup() API

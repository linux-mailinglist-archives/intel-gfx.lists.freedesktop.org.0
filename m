...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1363862DC7E
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Nov 2022 14:19:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74F0A10E1D3;
	Thu, 17 Nov 2022 13:19:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7E26810E1D3
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Nov 2022 13:19:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1668691159; x=1700227159;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=UyuHxZnFNXy/T0azkwemDaq6GNYt/3/PqX0vKCMOPKc=;
 b=bqXxCvt96oejVw+I+vwf5hhsbPd+aaehHVUtGPa+zYNVs3FH+T1g/PDF
 KRMdKOBCKV97dITAoNvGAEKnVPJ6wXJ2djawCPVWJ+LzuhhNhmHSS7Ihm
 IGeeIyNCx3Uk957D3teyl8HWDAwsJbhevVsgFwOawzn6MKg8tB4LhtMyp
 zD8EdI8i80cK03iZbD8M/FlV3QTkUrmDCGwspdDFoh/1G8FT+hbBJZE+e
 s8wXD7ZmDIUS6mBmJJ3eEnIjfoVah/b5SgvoYeV6l/FeHaNd3dIYwUTOc
 SQKk8r2kiGmXWze645ie2D3BTA0MO5VFoim2okJtTWjU6Mj+hYxy/N6Ym A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10533"; a="296210293"
X-IronPort-AV: E=Sophos;i="5.96,171,1665471600"; d="scan'208";a="296210293"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Nov 2022 05:18:39 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10533"; a="745530590"
X-IronPort-AV: E=Sophos;i="5.96,171,1665471600"; d="scan'208";a="745530590"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.191])
 by fmsmga002.fm.intel.com with SMTP; 17 Nov 2022 05:18:37 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 17 Nov 2022 15:18:36 +0200
Date: Thu, 17 Nov 2022 15:18:36 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Message-ID: <Y3Y0rDpgIn2F15fd@intel.com>

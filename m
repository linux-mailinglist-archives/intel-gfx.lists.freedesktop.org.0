...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 066213B1E86
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Jun 2021 18:20:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B78336E955;
	Wed, 23 Jun 2021 16:20:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ed1-x52e.google.com (mail-ed1-x52e.google.com
 [IPv6:2a00:1450:4864:20::52e])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2213E89BF8
 for <intel-gfx@lists.freedesktop.org>; Wed, 23 Jun 2021 16:20:03 +0000 (UTC)
Received: by mail-ed1-x52e.google.com with SMTP id r7so4230245edv.12
 for <intel-gfx@lists.freedesktop.org>; Wed, 23 Jun 2021 09:20:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=18nsKlNRPeSGzK/GtnkV65GHuS4sYhXYKk8mOhr9KfE=;
 b=TuPLi5hS5A53DBo+f8uhcVE1txIOQXShrAJF3YLB8j0FAHlj1BRP3LogkRA3DiBVjU
 JMzxb7oAOUi87Hr6V3vp8P3KZWvxYY7DEhTClRYkoFWpLiC5vy+s78mGKg7eivhTEidY
 KJ4TvOQ4DGB26WELxg8qT5ukAtQIRSPiMmEco=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=18nsKlNRPeSGzK/GtnkV65GHuS4sYhXYKk8mOhr9KfE=;
 b=
X-Gm-Message-State: AOAM530r166xd6i+5B6HY8bNQalEbnfiFX6SRaIN0BzTwx2xY3H/3Vaw
 t6iGvnHHCfiso0U62dWljmKFJA==
X-Google-Smtp-Source: ABdhPJwjxcIdheXhNHV4FNEf4j5HbPzwCWsR0AfvzJdQN1VDjWxSlGzeIsVeQ3oXGvUYSFzYSxfLGg==
X-Received: by 2002:a50:85cd:: with SMTP id q13mr759508edh.216.1624465201697; 
 Wed, 23 Jun 2021 09:20:01 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id h6sm296018edj.91.2021.06.23.09.20.00
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 23 Jun 2021 09:20:01 -0700 (PDT)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Wed, 23 Jun 2021 18:19:55 +0200
Message-Id: <20210623161955.3371466-1-daniel.vetter@ffwll.ch>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] dma-buf: Document dma-buf implicit fencing/resv
 fencing rules
...
Cc: Rob Clark <robdclark@chromium.org>, linaro-mm-sig@lists.linaro.org,
 Daniel Stone <daniels@collabora.com>, Daniel Vetter <daniel.vetter@intel.com>,
...

...

...
aW51eC9kbWEtYnVmLmgKaW5kZXggODFjZWJmNDE0NTA1Li40OTRmNjM5ZWU0ODYgMTAwNjQ0Ci0t
LSBhL2luY2x1ZGUvbGludXgvZG1hLWJ1Zi5oCisrKyBiL2luY2x1ZGUvbGludXgvZG1hLWJ1Zi5o
CkBAIC0zODYsNiArMzg2LDQ1IEBAIHN0cnVjdCBkbWFfYnVmIHsKIAkgKiBAcmVzdjoKIAkgKgog
...

...


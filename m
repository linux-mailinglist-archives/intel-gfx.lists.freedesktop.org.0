...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCCBC46F375
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Dec 2021 19:53:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA62810E248;
...
Subject: [Intel-gfx] [PATCH] drm/i915/guc: Use correct context lock when

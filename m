...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A49BA4FE54A
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 17:53:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38BDF10E6CA;
...
Subject: [Intel-gfx] [PATCH 2/9] vfio/ccw: Remove mdev from struct
 channel_program

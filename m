...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2592F87B8A0
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Mar 2024 08:38:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F9E810F917;
	Thu, 14 Mar 2024 07:38:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="KeyOPaPF";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DBBC110F8D5;
 Thu, 14 Mar 2024 07:38:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710401904; x=1741937904;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=TTs3r2W1f6SZlyGfywU7wopeYTqpRSascNRbPT6RlWY=;
 b=KeyOPaPFWcixQqEeA+B4IGMlfqVgr3Fsvl3OZ2EBrcMjK6JyEjEyRZnV
 sPRcZtCKZ3RpQC0Y4HwL7sg2Am5AcMJnQ/A3wZfqvJ1zVRxadmMSu/G4p
 uqyQyDd8zgp7+KGVF1SSubK7WAzh+ueXtHMSw5OxsRCBqNdWAr0kMcEKa
 ILIuBjezepHBrz7RYXUVtwg2Ey1z3TuJxuvAEA/FeVaKhlRuth4W13Q4K
 0ULrOEccDR2AjFB22BsOETT/Khw9248SqrotAOjC+rOOaNA2YiRh1U/io
 du1GmMeIiff5z/w0/OSYkvx+GSkg1bAOQHagzVyf7VIr5h5xRMWZ3Llrz g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11012"; a="5330858"
X-IronPort-AV: E=Sophos;i="6.07,124,1708416000"; 
   d="scan'208";a="5330858"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Mar 2024 00:38:24 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,124,1708416000"; d="scan'208";a="12216652"
...
Subject: [PATCH v2 1/4] drm/i915/display: add support for DMC wakelocks
Date: Thu, 14 Mar 2024 09:37:49 +0200
Message-Id: <20240314073752.1245879-2-luciano.coelho@intel.com>
...
index 000000000000..7e5d325f5d55
--- /dev/null
...
new file mode 100644
index 000000000000..a421d5d95036
--- /dev/null

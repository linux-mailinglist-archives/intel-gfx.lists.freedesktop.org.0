...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1AC4E8C6B11
	for <lists+intel-gfx@lfdr.de>; Wed, 15 May 2024 18:57:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEC7F10E5BF;
	Wed, 15 May 2024 16:57:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="XeEfTCG7";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8B1A910E354
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 May 2024 16:57:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1715792221; x=1747328221;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=/BeQk+AXto90VH9TGptIX4O/PR7hEiY5/mIlngitOL0=;
 b=XeEfTCG74NmpyMCnCseURsmSrZSOZpLqg6hfQHaIHggVi/hMIhqfsHT9
 w1T4vpotjmo1DUU8Xt+FI37/DRduZTyqBVeVZPNasUAKGwpJ+5g+xyRqZ
 GO+8s62j051P2Fq+m6gFh3kw4qy7wozt+JAbaHt9GF5GehAQ8BTZTgyUH
 /Vi1EtPAPbElMlRfUVu5CPoRRqjIHfwSWtpmUqE4pLWlN3RMQTxhVzJwu
 DAm4pa115FpPUWEomj08R7xu4WMnYmG7e0u3OyMewHehBplu+080JvppL
 YgejnZWrO/1OlR444oxIdD/ZK4aSVV+29eu1VhKTJJnprqiDtJCBEC82S Q==;
X-CSE-ConnectionGUID: Et5e0HuiT+WaxN0hBBd2Sw==
X-CSE-MsgGUID: s/lNvmibS02gJanhVm6i5w==
X-IronPort-AV: E=McAfee;i="6600,9927,11074"; a="22461277"
X-IronPort-AV: E=Sophos;i="6.08,162,1712646000"; d="scan'208";a="22461277"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2024 09:57:00 -0700
X-CSE-ConnectionGUID: nmieuTyLR/W7+lSX5AVl1Q==
X-CSE-MsgGUID: BaosZLoQSnWaEADhbSz3AQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,162,1712646000"; d="scan'208";a="62317710"
Received: from mwiniars-desk2.ger.corp.intel.com (HELO localhost)
 ([10.245.246.141])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2024 09:56:57 -0700
...
Subject: [PATCH 1/2] drm/i915/pciids: switch to xe driver style PCI ID macros
Date: Wed, 15 May 2024 19:56:50 +0300
Message-Id: <20240515165651.1230465-1-jani.nikula@intel.com>

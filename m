...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF6181F6E8
	for <lists+intel-gfx@lfdr.de>; Wed, 15 May 2019 16:51:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BF3F892DB;
	Wed, 15 May 2019 14:51:09 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 05/11] drm/fb-helper: Remove
 drm_fb_helper_crtc

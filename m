...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 40CB0520DA8
	for <lists+intel-gfx@lfdr.de>; Tue, 10 May 2022 08:15:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ABFA410F221;
	Tue, 10 May 2022 06:15:35 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 05/25] drm/edid: keep propagating
 drm_edid to display info

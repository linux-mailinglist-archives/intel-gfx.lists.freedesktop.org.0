...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56D7A9F0867
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2024 10:48:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED35310EE0C;
	Fri, 13 Dec 2024 09:48:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="h8TDCIvR";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2362710E51E;
 Fri, 13 Dec 2024 09:48:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1734083330; x=1765619330;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=uWDuRb43jCEyVhE+nnjU80S0Bkc05N4sm3P8Y7b1078=;
 b=h8TDCIvRsE8aZ7e5bK5kbm/UsmTw4c1O6bg/PAG7J0mZ8x474+43YDau
 TKRNPMatVR2TLaTXuD9j/lt+0SUpE5n3QglTTYzp/ESKb4ix6W+oulE6h
 PR+u5rVRKMLcFhPKSstz5JQVY8vcn6x6jq3Z/DkwJPFxbSUuZc7OHaLip
 RP98xU89/o+eOgdnfuOAnpswwUY3X8vBSLsFUJN90WnukA7X9mzu9JOFN
 cPfrLQkRzgz1Ac4/2AxyQwkKeBFI6cuYZW95oATbbL3k3Qae2/fHC4+5b
 UwUa/zWroA6UfmgS8M8WZpCxiiPTmGOWroJXlH14Yhm5Z9kVU+6I1ODsT w==;
X-CSE-ConnectionGUID: Vc+nW1lUStCulrX0PXFICQ==
X-CSE-MsgGUID: 33keXuL8S0SerNLygTDYQQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11284"; a="34671938"
X-IronPort-AV: E=Sophos;i="6.12,230,1728975600"; d="scan'208";a="34671938"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2024 01:48:50 -0800
X-CSE-ConnectionGUID: pg1fcJcjQD63Zu7qcHKuBA==
X-CSE-MsgGUID: XzPkUIj9RDeCLLSJQ/Fggg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,230,1728975600"; d="scan'208";a="96378434"
Received: from kniemiec-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.159])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2024 01:48:46 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	Luca Coelho <luciano.coelho@intel.com>
Subject: [PATCH v3 3/5] drm/i915/dp: convert to struct intel_display
Date: Fri, 13 Dec 2024 11:48:23 +0200
Message-Id: <d712a2894addde5fd7a8b593fbea87314df37e1f.1734083244.git.jani.nikula@intel.com>

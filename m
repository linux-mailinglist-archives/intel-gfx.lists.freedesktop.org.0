...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 556F8650FC4
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:06:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DE0810E2B4;
...
Subject: [Intel-gfx] [PATCH 08/18] fbdev/hyperv-fb: Do not set struct
 fb_info.apertures

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFF71546CCD
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 20:57:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E7AE10E421;
...
Subject: Re: [Intel-gfx] [PATCH v2 01/15] drm/edid: fix CTA data block
 collection size for CTA version 3

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90EFAA298E8
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2025 19:25:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 13C1610E399;
	Wed,  5 Feb 2025 18:25:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RsG30JkR";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1C62910E399;
 Wed,  5 Feb 2025 18:25:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1738779952; x=1770315952;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=dmIwJbMhbaTZlihEqzQzAu6uH9skxYaWWJwSydhPuGs=;
 b=RsG30JkRPoV16ZXqJT+Ot9WjkezA2lUzDkVTMOEeA+Nwq0kJUiYc8nKL
 gn5+ihLiQkATCyfLePj6qkvH86OQtlKE6bNE2Bv78Ak0FacdkvI6co6FR
 GOYrQKQWg62ppi1D/0U6KkRCckHNSJcUvp3TfojWsewdAeaNwkOhNpvNh
 Lf+8WxpZuMnyk2zetAs5gyAcjtQymxmz+MmhZtAjjKwRJKCZ4pZyIzsh/
 Kv2hq0AyL7qlmZAgdmOp8Wl2thIc2ob+fje8fyFsN8Okms6YKM6YUrf2y
 IHKvOkp2wd0wSHoOiWAK7tnak84LbVy55np1eBo1KL36Rt5CY2QKL4tey Q==;
X-CSE-ConnectionGUID: RQdvQvAnSb2pOqZUcEahww==
X-CSE-MsgGUID: fnfWIU6zRm23QgZliH1y7w==
X-IronPort-AV: E=McAfee;i="6700,10204,11336"; a="26963233"
X-IronPort-AV: E=Sophos;i="6.13,262,1732608000"; d="scan'208";a="26963233"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Feb 2025 10:25:52 -0800
X-CSE-ConnectionGUID: bs+2LAksTViD4pXHP9/XEg==
X-CSE-MsgGUID: PQNJFQgsS4mcAClHu2Q2pg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,262,1732608000"; d="scan'208";a="111512145"
Received: from vbelgaum-ubuntu.fm.intel.com ([10.1.39.141])
 by fmviesa010.fm.intel.com with ESMTP; 05 Feb 2025 10:25:52 -0800
From: Vinay Belgaumkar <vinay.belgaumkar@intel.com>
To: intel-gfx@lists.freedesktop.org,
	igt-dev@lists.freedesktop.org
Cc: Vinay Belgaumkar <vinay.belgaumkar@intel.com>
Subject: [PATCH i-g-t v9 1/3] lib/igt_core: Add tolerance and measured_usleep
 utils
Date: Wed,  5 Feb 2025 10:22:12 -0800
Message-Id: <20250205182214.1650169-2-vinay.belgaumkar@intel.com>

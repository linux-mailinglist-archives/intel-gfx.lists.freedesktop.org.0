...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D234646386D
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Nov 2021 15:58:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A01226E47B;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/gem: Fix a NULL pointer
 dereference in igt_request_rewind()

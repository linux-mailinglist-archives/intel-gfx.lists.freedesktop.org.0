...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D2C77DA7C
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Aug 2019 13:41:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6851F6E512;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 4/6] drm/hdcp: update content protection

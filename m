...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9983286E442
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Mar 2024 16:26:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1156510E1C4;
	Fri,  1 Mar 2024 15:26:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="TBSB8gLE";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D1A9510E1C4
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 Mar 2024 15:26:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709306787; x=1740842787;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=o8GvFLoK4DCPPuGrIowmOf+RUfcaHoNWBCea1txstDI=;
 b=TBSB8gLEkxv/hUCMLHN4cAoh7xj0wQAcRkvNRX9hR9TrXVSdc6JkMh4g
 vV8UQbedjBu7C8RYuQ7fGYkxlDKUcW9xnR5UBAIJgvEpdJAAoDb6vuMTA
 9yO/OAjHETcVkgr+9YVT9HfZZnl80BDoMRyHPpGw0VEy7hVyKB3EhKiRS
 XINGaNvOa2Ph6GWKsY9mqqSYnunQGKpXqQfBZcqYg/SaPtPPMeeOEc/D3
 0GYBkPmTFXXz1ftLGaZNFNHY2egO/yEEUiGBUbobuPkdqKzTEllp8ZNhX
 KJ0+59cqMzzfqRqMsReuUKXmilTMoDTliXBiOk2rTU9IUWMRIGKMTbxaC Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11000"; a="14550940"
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="14550940"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 07:26:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,11000"; a="827772013"
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="827772013"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga001.jf.intel.com with SMTP; 01 Mar 2024 07:26:19 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 01 Mar 2024 17:26:19 +0200
Date: Fri, 1 Mar 2024 17:26:19 +0200
...
Message-ID: <ZeHzmx4nWMLpQhL0@intel.com>
...
In-Reply-To: <ZeHxlcUi+oYpvc/b@intel.com>

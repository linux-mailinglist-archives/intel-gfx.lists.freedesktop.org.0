...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 140D390C6FC
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jun 2024 12:31:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AB1810E628;
	Tue, 18 Jun 2024 10:31:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from a6498e030952 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E750F10E624;
 Tue, 18 Jun 2024 10:31:38 +0000 (UTC)
Content-Type: text/plain; charset="utf-8"
MIME-Version: 1.0
Content-Transfer-Encoding: 7bit
Subject: =?utf-8?q?=E2=9C=97_Fi=2ECI=2ECHECKPATCH=3A_warning_for_drm/i915=3A_PREEMPT?=
 =?utf-8?q?=5FRT_related_fixups=2E_=28rev11=29?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Sebastian Andrzej Siewior" <bigeasy@linutronix.de>
Cc: intel-gfx@lists.freedesktop.org
Date: Tue, 18 Jun 2024 10:31:38 -0000
Message-ID: <171870669894.102746.15388391640952398104@a6498e030952>
...
a7627296e305 drm/i915: Don't disable interrupts on PREEMPT_RT during atomic updates
...
27a9526d1665 drm/i915: Don't check for atomic context on PREEMPT_RT
-:10: WARNING:COMMIT_LOG_LONG_LINE: Prefer a maximum 75 chars per line (possible unwrapped commit description?)
#10: 
> > If so would cant_migrate() work? It requires CONFIG_DEBUG_ATOMIC_SLEEP=y

total: 0 errors, 1 warnings, 0 checks, 15 lines checked
319ae847eac6 drm/i915: Disable tracing points on PREEMPT_RT
...
655111c9cf59 drm/i915/gt: Use spin_lock_irq() instead of local_irq_disable() + spin_lock()
...
f705fb6d6706 drm/i915: Drop the irqs_disabled() check
...
af7b4ceb0382 drm/i915/guc: Consider also RCU depth in busy loop.
...
008c8b42205e Revert "drm/i915: Depend on !PREEMPT_RT."

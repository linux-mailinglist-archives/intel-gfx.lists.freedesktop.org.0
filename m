...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DCBB2EAF24
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Jan 2021 16:46:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42D146E153;
	Tue,  5 Jan 2021 15:45:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AFF456E14C
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 Jan 2021 15:45:40 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  5 Jan 2021 16:35:18 +0100
Message-Id: <20210105153558.134272-25-maarten.lankhorst@linux.intel.com>
X-Mailer: git-send-email 2.30.0.rc1
In-Reply-To: <20210105153558.134272-1-maarten.lankhorst@linux.intel.com>
References: <20210105153558.134272-1-maarten.lankhorst@linux.intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 24/64] drm/i915: Move pinning to inside
...
IGMyMWE5NzI2MzI2YS4uNGExOWY4MDliNTI5IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF93b3JrYXJvdW5kcy5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0
L2ludGVsX3dvcmthcm91bmRzLmMKQEAgLTIyMDUsMTAgKzIyMDUsMTUgQEAgc3RhdGljIGludCBl
...
YWl0X29iamVjdChycSwgdm1hLT5vYmosIHRydWUpOwpAQCAtMjI0OSw2ICsyMjU0LDggQEAgc3Rh
...
CkBAIC0yMjU5LDcgKzIyNjYsNiBAQCBzdGF0aWMgaW50IGVuZ2luZV93YV9saXN0X3ZlcmlmeShz
...

...
IDM0ODVjYjdjNDMxZC4uMTQ3NDMwMGExYTllIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
...

...

...
X0VSUihzY3JhdGNoKSkKIAkJcmV0dXJuIFBUUl9FUlIoc2NyYXRjaCk7CiAKQEAgLTEwMzAsMTQg
KzEwMzAsMTQgQEAgc3RhdGljIGludCBsaXZlX2lzb2xhdGVkX3doaXRlbGlzdCh2b2lkICphcmcp
...
ZWFzZSgmY2xpZW50W2ldLnNjcmF0Y2hbMF0sIDApOwotLSAKMi4zMC4wLnJjMQoKX19fX19fX19f

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 291A0B58034
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Sep 2025 17:17:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4ED810E4E4;
	Mon, 15 Sep 2025 15:17:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="BlIvbxcu";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8C63E10E4E4
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Sep 2025 15:17:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1757949423; x=1789485423;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=jBmrZ/h/ltnpAMcBQI0q0C1gL5SB0sJeqaSkQZDE/Qo=;
 b=BlIvbxcu44Lz5jeXapEfU2d2Rn/R0+j5XIhMlCcfjycJMSG6ZRizBpbw
 TqKUTrX1TX01fQ0Iuv0qGGRpHE5fOFy/SS1i+BNYsR+BhV2KptpLEUpam
 udWheZ5DLWR4UHAAs8VdLZ0Lcuut4M0jDHkoczqQxa+65JiOREvA4igKI
 YCeewjcV1HXwAMt4nUGvKSyOopfG5AvXc1QiL6WE3cZhSPTeISin8yLAg
 W2t2IMppq5CZlI6iksfSRGFnheBkKbnPtM/rxorcsdl2V0xcqKvvB0fpm
 F5BM/2bdoFQszOGAxCGnnPLGYBRYrB5Nlsjfyj2KPi7hq8ybHfbA57iaf w==;
X-CSE-ConnectionGUID: dPkZSoG0TCaXQd0W9ldctA==
X-CSE-MsgGUID: x5V8cap8QXquJoB5YbCDVQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11531"; a="60157164"
X-IronPort-AV: E=Sophos;i="6.17,312,1747724400"; d="scan'208";a="60157164"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Sep 2025 08:17:02 -0700
X-CSE-ConnectionGUID: IrpG3Ie3TNqBM5aieX3ldA==
X-CSE-MsgGUID: zh6dL2IOQyuC4p2S2S1/YA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,266,1751266800"; d="scan'208";a="178656082"
Received: from bergbenj-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.245.90])
 by ORVIESA003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Sep 2025 08:17:00 -0700
Date: Mon, 15 Sep 2025 18:16:57 +0300
...
Message-ID: <aMgt6ZwVR2DcyO9u@intel.com>
...
In-Reply-To: <CH0PR11MB5444745443F2BBB579122BD1E515A@CH0PR11MB5444.namprd11.prod.outlook.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE7ED5A8E77
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 08:43:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ABA8610E600;
...
Subject: Re: [Intel-gfx] [PATCH v4 05/21] drm/armada: Prepare to dynamic

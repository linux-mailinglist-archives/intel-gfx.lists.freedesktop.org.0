...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 379B7522F4E
	for <lists+intel-gfx@lfdr.de>; Wed, 11 May 2022 11:24:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7579410F9B0;
...
Subject: [Intel-gfx] [PATCH v3] drm/edid: propagate drm_edid to
 drm_edid_to_eld()

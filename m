...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44CD520FF1C
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:30:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 343296E48F;
...
Subject: [Intel-gfx] [PATCH 24/59] drm/kmb: Add ADV7535 bridge

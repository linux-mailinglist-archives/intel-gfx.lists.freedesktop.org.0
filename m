...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3563540CA9B
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 18:40:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 043AF6E993;
...
Subject: [Intel-gfx] [PATCH v8 03/16] dyndbg: rationalize verbosity

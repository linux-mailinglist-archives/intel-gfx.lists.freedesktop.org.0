...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EAEA21819D3
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Mar 2020 14:31:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3FF36E984;
	Wed, 11 Mar 2020 13:31:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 66A2F6E97E
 for <intel-gfx@lists.freedesktop.org>; Wed, 11 Mar 2020 13:31:11 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20521934-1500050 
 for multiple; Wed, 11 Mar 2020 13:30:51 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 11 Mar 2020 13:30:47 +0000
Message-Id: <20200311133047.30696-12-chris@chris-wilson.co.uk>
...
index 8eeec87b7d72..81b97e7b1e8a 100644
...
index 1c68b4f4e33d..2e37110d57b1 100644
...
@@ -4459,6 +4486,7 @@ logical_ring_default_irqs(struct intel_engine_cs *engine)
...
index 79ae9654dac9..eb54f57e3ecb 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F6AB7EAE45
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Nov 2023 11:45:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28D5B10E1F4;
	Tue, 14 Nov 2023 10:45:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C6F1E10E1F4
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Nov 2023 10:45:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699958744; x=1731494744;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=0sO3yxH1ZIyxyz9Wabr+LXnZV6BWUoe2jNC8xXMw8Fs=;
 b=YOnM72/XvA/S12YtJWbbHh0lDFgXPmhnhqiqlDCuBqag7+hsl2wejOG2
 CvW5DMfx4LaVmAgAAo0CIQau1agWlk7bQE+zlOQ8yHfe1m04ZHgdlSKYw
 OKFe7D1j5bVeLNlA5jootQSd4MvipEDt42vg5mcEMpLlWY3gLpFhX86jb
 /QIVIb3/03YHQ6+8QxLtLmpsAvt4bkEHD/Rv39HFhE6IsxMAIOSV0d7fP
 tC0S7ELFMEYsxZwLmL+NBwmqK3un/vTHhtDvoSj5tX0DvA5NzW+7cUoso
 /MNJ180td7ODrzOSNWECFTE8/QGp0aAXsqvQeVhCRf6I1q4gKnukjSuhZ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10893"; a="457125339"
X-IronPort-AV: E=Sophos;i="6.03,301,1694761200"; d="scan'208";a="457125339"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2023 02:45:44 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.03,301,1694761200"; d="scan'208";a="12398712"
Received: from hatran1-mobl1.ccr.corp.intel.com (HELO localhost)
 ([10.252.56.145])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2023 02:45:39 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Nov 2023 12:45:32 +0200
Message-Id: <20231114104534.4180144-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.39.2
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 1/3] drm/i915: move *_crtc_clock_get() to
 intel_dpll.c

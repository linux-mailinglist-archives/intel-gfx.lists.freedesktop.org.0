...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FFFD5907DB
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Aug 2022 23:08:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CED114A3A3;
	Thu, 11 Aug 2022 21:08:41 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915/guc: clear stalled request after a
 reset

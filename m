...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F074C6CF001
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 18:57:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C26DB10EBBA;
...
Subject: [Intel-gfx] [PATCH 4/4] drm/i915/gsc: add support for GSC proxy
 interrupt

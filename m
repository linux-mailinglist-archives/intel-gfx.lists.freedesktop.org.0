...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E685A430493
	for <lists+intel-gfx@lfdr.de>; Sat, 16 Oct 2021 21:18:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2FB26E4D7;
...
Subject: [Intel-gfx] [PATCH v2 06/13] drm/exynos: replace

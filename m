...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6AEE249472
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jun 2019 23:39:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B7B0C89FD9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 1/2] drm/i915: Introduce async plane update
 to i915

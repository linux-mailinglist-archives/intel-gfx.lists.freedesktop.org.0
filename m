...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 335C5331F1
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Jun 2019 16:20:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 866F78925A;
	Mon,  3 Jun 2019 14:20:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3DE6A89240
 for <intel-gfx@lists.freedesktop.org>; Mon,  3 Jun 2019 14:20:15 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16775792-1500050 
 for multiple; Mon, 03 Jun 2019 14:59:16 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  3 Jun 2019 14:59:08 +0100
Message-Id: <20190603135910.15979-13-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 13/15] drm/i915/execlists: Minimalistic
 timeslicing
...
OTE1L2d0L2ludGVsX2xyYy5jCmluZGV4IDFhMTJkMDNmMmM4ZS4uNjNhM2Q5NTgzODc4IDEwMDY0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F80E819CD
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Aug 2019 14:44:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2ECF6E501;
...
Subject: [Intel-gfx] [PATCH v5 14/18] drm/amdgpu: switch driver from

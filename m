...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 85A49695224
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Feb 2023 21:49:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F0B0E10E0C4;
	Mon, 13 Feb 2023 20:49:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7E0CE10E0C4
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Feb 2023 20:49:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1676321345; x=1707857345;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=KVbUybI2vAnPmRWcMPD8ZQy0wj9d3SofJ0/eS/OBaxQ=;
 b=HR8usMMjhAkApjK0WVH8Uw5emM3cPuzYhh5RCFmFXxLVGolVaVy4R5bS
 E3NUFNMte8GyyYL1HZooZVWWeopv9+E6o/2Ak0WCQuZqCDJ7OQRz9WYj9
 Y6YkRmabiFgQOtjJ6JWa4uBmpuvSQs2tvFxFsPBVzjzT8zULswJYg6nO8
 uiItX2Feas899Y7STH/vFuzwg+8i0EO8UnYOUN08DDLxay44vmCtmk1R+
 GRSnQt+moDVAXXe9hNt3xgzt11ElIHQhqJFGikcK0ZtmT3qHHj93XP4h2
 ZrorLIEWjL/9NGFVhV23+Ko4H2Y1cfH7KZCHdmriwVQKfhb+C823cxNkY A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10620"; a="332310462"
X-IronPort-AV: E=Sophos;i="5.97,294,1669104000"; d="scan'208";a="332310462"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2023 12:49:04 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10620"; a="757737832"
X-IronPort-AV: E=Sophos;i="5.97,294,1669104000"; d="scan'208";a="757737832"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.55])
 by FMSMGA003.fm.intel.com with SMTP; 13 Feb 2023 12:49:02 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Mon, 13 Feb 2023 22:49:01 +0200
Date: Mon, 13 Feb 2023 22:49:01 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Message-ID: <Y+qiPTnHIflK5JOF@intel.com>
...
In-Reply-To: <6da32831e40606cc8b90491b83196917f2ce36ab.1676317696.git.jani.nikula@intel.com>

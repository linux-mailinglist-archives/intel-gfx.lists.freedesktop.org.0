...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA4FD500D6B
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Apr 2022 14:30:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0671C10FC42;
	Thu, 14 Apr 2022 12:30:48 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 1/1] module: add enum module parameter type to
 map names to values

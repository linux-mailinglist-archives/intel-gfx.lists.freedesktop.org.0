...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C39421EFB7
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 13:46:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B79B66E95E;
	Tue, 14 Jul 2020 11:46:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 263C16E418
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Jul 2020 11:45:22 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Jul 2020 13:45:07 +0200
Message-Id: <20200714114516.3073222-14-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/23] drm/i915: Make sure execbuffer always
...
+	err = i915_vma_pin_ww(vma, &eb->ww,
 	...
 	if (err)
@@ -1121,9 +1122,10 @@ static void *reloc_kmap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	void *vaddr;
@@ -1145,10 +1147,13 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 		if (err)
 			return ERR_PTR(err);
...
@@ -1184,9 +1189,10 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	if (cache->page == page) {
@@ -1194,7 +1200,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 	} else {
 		vaddr = NULL;
...
@@ -1281,7 +1287,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 		goto err_unmap;
 	}
...
@@ -1302,7 +1308,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 			eb->reloc_context = ce;
 		}
...
@@ -1525,8 +1531,7 @@ relocate_entry(struct i915_vma *vma,
 		void *vaddr;
...
@@ -1942,6 +1947,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2224,7 +2230,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2235,7 +2242,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2385,16 +2392,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2422,7 +2446,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2447,19 +2471,34 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -3037,33 +3076,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -3072,7 +3085,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
+		goto err_vma;
 	...
 	if (in_fence) {
@@ -3134,9 +3147,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	}
...
-		i915_vma_unpin(batch);
 err_vma:
 	...
 	if (eb.trampoline)
@@ -3222,7 +3232,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3300,8 +3312,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index cdc0b9c54305..78c010a6486f 100644
--- a/drivers/gpu/drm/i915/gt/gen6_ppgtt.c
+++ b/drivers/gpu/drm/i915/gt/gen6_ppgtt.c
@@ -380,7 +380,7 @@ static struct i915_vma *pd_vma_create(struct gen6_ppgtt *ppgtt, int size)
 	return vma;
 }
...
+int gen6_ppgtt_pin(struct i915_ppgtt *base, struct i915_gem_ww_ctx *ww)
 {
 	...
 	int err;
@@ -406,7 +406,7 @@ int gen6_ppgtt_pin(struct i915_ppgtt *base)
 	 */
 	err = 0;
...
index dd1a42c4d344..872f5126aa09 100644
--- a/drivers/gpu/drm/i915/gt/intel_engine_cs.c
+++ b/drivers/gpu/drm/i915/gt/intel_engine_cs.c
@@ -634,7 +634,7 @@ static int pin_ggtt_status_page(struct intel_engine_cs *engine,
 	else
 		flags = PIN_HIGH;
...
index e5dd900d135b..5428ad834681 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3474,7 +3474,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3893,7 +3894,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index fa34f2cc4f98..9588c9ddac8c 100644
...
index 3fc5de961280..df6fd472cb78 100644
...
index 7f668a49b03d..ef4b41c353df 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1789,11 +1789,18 @@ static inline void i915_gem_drain_workqueue(struct drm_i915_private *i915)
 }
...
index bc64f773dcdb..e6ebf82bb7a1 100644
--- a/drivers/gpu/drm/i915/i915_vma.c
+++ b/drivers/gpu/drm/i915/i915_vma.c
@@ -853,13 +853,19 @@ static void vma_unbind_pages(struct i915_vma *vma)
...
@@ -989,7 +995,8 @@ static void flush_idle_contexts(struct intel_gt *gt)
...
+		  u32 align, unsigned int flags)
 {
 	...
 	int err;
@@ -997,7 +1004,7 @@ int i915_ggtt_pin(struct i915_vma *vma, u32 align, unsigned int flags)

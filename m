...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CD4D186A49
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Mar 2020 12:43:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77B9C6E425;
	Mon, 16 Mar 2020 11:43:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 561346E41B
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Mar 2020 11:42:50 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20574778-1500050 
 for multiple; Mon, 16 Mar 2020 11:42:38 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 16 Mar 2020 11:42:33 +0000
Message-Id: <20200316114237.5436-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/15] drm/i915: Export a preallocate variant of
 i915_active_acquire()
...
index c4048628188a..6bb09f3020e2 100644
...
+
 ...
 {
 	debug_active_assert(ref);
@@ -748,7 +837,7 @@ int i915_active_acquire_preallocate_barrier(struct i915_active *ref,
 			 */
...
index b3282ae7913c..65a9c560483b 100644
...
+
 int i915_active_ref(struct i915_active *ref,
 		    ...
 		    struct dma_fence *fence);
@@ -192,7 +195,9 @@ int i915_request_await_active(struct i915_request *rq,

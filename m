...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D7023B27DE
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:49:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03F836EA4A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 35/47] drm/i915/guc: Handle context reset
 notification

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E3CB5E80FB
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Sep 2022 19:41:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BF5A10E401;
	Fri, 23 Sep 2022 17:41:23 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v6 1/3] drm/i915: Read

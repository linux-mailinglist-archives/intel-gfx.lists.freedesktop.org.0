...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F19B67BCE8
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:38:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A92F10E863;
...
Subject: [Intel-gfx] [PATCH v3 08/19] dyndbg: tighten ddebug_class_name()
 1st arg

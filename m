...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CB70DEFA31
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Nov 2019 10:55:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D5296E98B;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 wq6A==
Subject: Re: [Intel-gfx] [PATCH v2 5/5] drm/dsi: add helpers for DSI
 compression mode and PPS packets
...
Content-Type: multipart/mixed; boundary="===============0871092192=="

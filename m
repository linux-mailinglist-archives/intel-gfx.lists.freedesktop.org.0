...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D0A358D8BA
	for <lists+intel-gfx@lfdr.de>; Tue,  9 Aug 2022 14:27:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A561BD2FF0;
	Tue,  9 Aug 2022 12:23:08 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [Linaro-mm-sig] [PATCH v2 2/5] drm/gem: Take

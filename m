...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D2F93A8233
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Jun 2021 16:14:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F82C6E3CE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 02/14] drm/amd/display: Add missing cases

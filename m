...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EF021102A7
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 17:40:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00A406EA0B;
...
Subject: [Intel-gfx] [PATCH v3 11/12] samples: vfio-mdev: constify fb ops

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FD6A2987D
	for <lists+intel-gfx@lfdr.de>; Fri, 24 May 2019 15:06:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B93FE6E10C;
	Fri, 24 May 2019 13:06:13 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915/dsi: Use a fuzzy check for burst mode
 clock check

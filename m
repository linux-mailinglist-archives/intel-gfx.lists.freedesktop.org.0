...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C5935FE53C
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Oct 2022 00:28:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 266378951B;
	Thu, 13 Oct 2022 22:28:24 +0000 (UTC)

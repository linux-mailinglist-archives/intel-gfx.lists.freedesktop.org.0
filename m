...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E752512E6C
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Apr 2022 10:28:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46CCA10E385;
...
Subject: Re: [Intel-gfx] [PATCH 1/2] drm/i915/gvt: Make
 intel_gvt_match_device() static

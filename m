...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E4FC45AF833
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 01:02:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9F98E10E035;
	Tue,  6 Sep 2022 23:02:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6EA2B10E035
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Sep 2022 23:02:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1662505346; x=1694041346;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=L3NxiuJTX+nJ4zdUZPrtbQER2cQmNnyZmb7/k8LgGZs=;
 b=O66mw1lZ8rh7hjp4p06RCImRiAQ4CrvKwVtSFjilMDwVhJV0IehOavqj
 VdpXNz3lAca9+Je/lAwpmWLcsVRIdAdkcdu3l3uAKbOqxKjbQLb2DDDSz
 8FG1L2c7Y0RQfMHqSUcy+JX0UU1sRgYDbfm+aAi1yjICtpiSF/dkEzo9N
 xsvP6/37zzdz+H+kjZJrep3BIQqdSfZ2M7wisZUV2/VyQiq2HDUW3pdZb
 y0IVbVKRHNszLlavSZhzoeV7C4V9+8vkmr6tL8oi7I8mN9zXGjkmsh9J/
 zyAEsE2uV+DGs2k99niqPRTy3tJIAGhXMy/VeGvTBo7Nqy3d7cXkuRgOy g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10462"; a="276469756"
X-IronPort-AV: E=Sophos;i="5.93,294,1654585200"; d="scan'208";a="276469756"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Sep 2022 16:02:04 -0700
X-IronPort-AV: E=Sophos;i="5.93,294,1654585200"; d="scan'208";a="565280777"
...
Message-Id: <20220906230147.479945-2-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [CI 2/2] drm/i915/uc: Add patch level version number
 support
...
index 344763c942e3..cb586f7df270 100644

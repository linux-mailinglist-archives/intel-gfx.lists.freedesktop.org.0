...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E702BFB367
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Oct 2025 11:48:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 48B3810E72F;
	Wed, 22 Oct 2025 09:48:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="lXz1RlBv";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2907D10E725;
 Wed, 22 Oct 2025 09:48:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761126529; x=1792662529;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Q8wHSwBO+1TNomtxZy1RfU2+FaIzx8VOlFXIib+e5mg=;
 b=lXz1RlBvxMnLXXivXTSnUlxutLOQX6C9+zziqQfb02+Jl34PTRgv3Fjg
 PNeAUP2fk3rlcK8EoxUbs+9eS8IfBIFxpGD94HIGRH9emealixM9UO0oz
 vkEVWYxlB/G4Np+6ovQt4mYhEzcHJFcCzu81q2wn0bLdmOpdUy1wg74gR
 pEfWZxlAqMHEF+OPB7uG6bd+GOish2HtIlTS8YSJ+JJpLhdX8kVggfPwt
 vwoK9FuiT2ioyU2dzats0pAFLSQ6xFTdxhy4W/sC+aFSUSddLC2uEXIhk
 OSOVzrGtxVqD/hSLdaASYhqSfA5IALpCQGPzOCJ7TWfEp6sukNKFcbS6o w==;
X-CSE-ConnectionGUID: ia+TYj26RS+0oB5TSxp0Uw==
X-CSE-MsgGUID: 3o4a3OwiS/OXNmZ0t+U+KQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11586"; a="67133802"
X-IronPort-AV: E=Sophos;i="6.19,246,1754982000"; d="scan'208";a="67133802"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2025 02:48:49 -0700
X-CSE-ConnectionGUID: YJmsdBmWSn6A4htm0+Ts3Q==
X-CSE-MsgGUID: rJc/bxWKQNShLf+95t9Y2g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,246,1754982000"; d="scan'208";a="214772729"
Received: from fdefranc-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.246.104])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2025 02:48:45 -0700
...
Subject: [PATCH v2 1/3] drm/mm: replace drm_print.h include with a forward
 declaration
Date: Wed, 22 Oct 2025 12:48:31 +0300
Message-ID: <3bf65a9954aa60446427506fc2965a17912f6eb9.1761126446.git.jani.nikula@intel.com>

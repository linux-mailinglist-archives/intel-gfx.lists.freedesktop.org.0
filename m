...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC0E21C4F04
	for <lists+intel-gfx@lfdr.de>; Tue,  5 May 2020 09:25:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4FA9F6E525;
	Tue,  5 May 2020 07:25:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 363E16E525
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 May 2020 07:25:52 +0000 (UTC)
IronPort-SDR: Tenme3gziUW9T+pk9whe6eWKyEhqBRkqPuRMeBDwnfF99+U/CDSwe0hpxWAjqK+zTlC3UBupyX
 3AOzfLi0/y1A==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2020 00:25:51 -0700
IronPort-SDR: DRaXKaMhMSe9FiQ8ux/oPk7dh1XCQlQjni+5jTobVreC0drT8yqU1OS7QSdEFq4PkJjF7trQEC
 ZrTDG7ldbIGQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,354,1583222400"; d="scan'208";a="263069832"
Received: from unknown (HELO slisovsk-Lenovo-ideapad-720S-13IKB.fi.intel.com)
 ([10.237.72.89])
 by orsmga006.jf.intel.com with ESMTP; 05 May 2020 00:25:49 -0700
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  5 May 2020 10:21:38 +0300
Message-Id: <20200505072138.9201-1-stanislav.lisovskiy@intel.com>
X-Mailer: git-send-email 2.24.1.485.gad05a3d8e5
In-Reply-To: <20200423075902.21892-7-stanislav.lisovskiy@intel.com>
References: <20200423075902.21892-7-stanislav.lisovskiy@intel.com>
MIME-Version: 1.0
...
dmVycy9ncHUvZHJtL2k5MTUvaTkxNV9yZWcuaAppbmRleCA0YTE5NjU0NjczNzQuLjgxMThkMWUz
OWY2YSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9yZWcuaAorKysgYi9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlZy5oCkBAIC05MDg2LDYgKzkwODYsNyBAQCBlbnVt
...
ZSAgIEdFTjZfUENPREVfUkVBRF9SQzZWSURTCQkweDUKQEAgLTkxMDcsNiArOTEwOCw5IEBAIGVu
...
L2RyaXZlcnMvZ3B1L2RybS9pOTE1L2ludGVsX3NpZGViYW5kLmMKaW5kZXggMTRkYWY2YWY2ODU0
Li41OWVmMzY0NTQ5Y2YgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2ludGVsX3Np

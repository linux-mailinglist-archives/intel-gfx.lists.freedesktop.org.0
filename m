...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D5745A3695
	for <lists+intel-gfx@lfdr.de>; Sat, 27 Aug 2022 11:51:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F96110EBF9;
...
Subject: [Intel-gfx] [PATCH 07/15] vfio/mbochs: Use the new device life
 cycle helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4081C675A43
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Jan 2023 17:41:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DF3810EAB5;
...
Subject: [Intel-gfx] [PATCH 6/8] drm/i915/guc: Update GuC messages in
 intel_guc_log.c

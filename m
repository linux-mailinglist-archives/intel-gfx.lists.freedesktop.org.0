...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 292175ED030
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Sep 2022 00:22:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34E7C10E16A;
	Tue, 27 Sep 2022 22:22:18 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3] drm/i915/mtl: enable local stolen memory

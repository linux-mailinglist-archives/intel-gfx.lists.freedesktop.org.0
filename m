...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AFA456F3C96
	for <lists+intel-gfx@lfdr.de>; Tue,  2 May 2023 06:11:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8DB7D10E3C4;
	Tue,  2 May 2023 04:11:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CACD310E19E;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=CvX7u1eseKg9QyuC1/RPoRJXy2mUS/8oPURZypKLy+0=;
 b=HUZgjCiWD64wmc0v8i5wOtWahuq8uW8FiTXVmHwJkS3EcoPYlZmDi/1w
 LywAbxANQUIoGL6OgWyzbsFs4FjCtX0NtZPsJTsL5HjrPHdz87IY0yw9f
 IY5oXUvm2rYqwjuttwMNi5AmEVDY77Nu71sHJIbGnJ2Fzmvw5IU/LYmzk
 RaEWibZnqq4cSaqfZBxZoIkapDrsTZSAEv1Q+TvvJB72mY1hEOJRveRPx
 LNqlqmzQjgfktCKAqcSXZPVJpCT7Pbe5ridZjr5xc22PzBY5QD+63NveU
 UOQ7LuZtjWwAkQrUiNH5ETebaCHyNK8d3tkuLCV6VNSjTlCBibscNt3Fa g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="351280165"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="351280165"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:11:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="785518096"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="785518096"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:11:01 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  1 May 2023 21:11:59 -0700
Message-Id: <20230502041200.2170424-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 2/3] drm/i915: use pat_index instead of
 cache_level

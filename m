...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F1A68728D55
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Jun 2023 03:54:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36E6810E62D;
	Fri,  9 Jun 2023 01:54:33 +0000 (UTC)
...
X-Coremail-Antispam: 1Uk129KBj93XoW7trW8GryUXFy8Gw45ZFy8CrX_yoW8Xw4xp3
 ...
 UUU
Subject: Re: [Intel-gfx] [PATCH v3 1/4] PCI/VGA: tidy up the code and
 comment format

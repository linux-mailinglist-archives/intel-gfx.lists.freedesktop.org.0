...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 280BC5105E4
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Apr 2022 19:47:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 502AD10E03E;
	Tue, 26 Apr 2022 17:47:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from NAM02-DM3-obe.outbound.protection.outlook.com
 (mail-dm3nam07on2055.outbound.protection.outlook.com [40.107.95.55])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EBD6E10E69D
 for <intel-gfx@lists.freedesktop.org>; Tue, 26 Apr 2022 17:47:41 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=eLTIa6JntmSWXviYbQ+A6k5fm+t18oixS2g8TbFlVWw=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1; 
 ...
 bh=eLTIa6JntmSWXviYbQ+A6k5fm+t18oixS2g8TbFlVWw=;
 b=WHCcifQtP/20PKzBoAKJUI59sP3TXAoonxCHHkW502hhvlR7A+gXuifW3i13zPvHapI9cV8JB6ywoKXiL58ZGzJKJk4DW/+DmysDKezCgGVtvtyO1fjY47Er7bH1qzbyAYi6nQ8fNXyn3J7+bfC9BRuVjAZij0GRa4Yi5ftf480=
...
Thread-Index: AQHYWOD5GSmgX3OMYkO52XyW8YHuEq0BFZ0wgAEdsAaAAB0eEIAAKMZD
Date: Tue, 26 Apr 2022 17:47:38 +0000
Message-ID: <BN9PR12MB5145023F8A59FE949BE7A74C8DFB9@BN9PR12MB5145.namprd12.prod.outlook.com>
...
In-Reply-To: <ba541bbcc44344749aabc115fc8a325d@intel.com>
...
x-ms-office365-filtering-correlation-id: da9ac016-8af6-4a6e-f418-08da27acdb37
x-ms-traffictypediagnostic: BYAPR12MB4790:EE_
x-microsoft-antispam-prvs: <BYAPR12MB4790CB23054D1A0897BA7C288DFB9@BYAPR12MB4790.namprd12.prod.outlook.com>
x-ms-exchange-senderadcheck: 1
x-ms-exchange-antispam-relay: 0
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:BN9PR12MB5145.namprd12.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230001)(4636009)(366004)(2906002)(53546011)(5660300002)(7696005)(966005)(6506007)(8936002)(186003)(19627405001)(26005)(9686003)(83380400001)(55016003)(4326008)(508600001)(110136005)(33656002)(316002)(19627235002)(54906003)(52536014)(122000001)(91956017)(66946007)(38070700005)(166002)(71200400001)(38100700002)(8676002)(66556008)(66476007)(66446008)(99936003)(76116006)(86362001)(64756008);
 DIR:OUT; SFP:1101; 
x-ms-exchange-antispam-messagedata-chunkcount: 1
x-ms-exchange-antispam-messagedata-0: =?Windows-1252?Q?iQzLnJy0YrXUfULIrnIgTy+qMRhhjzIm2/3Ra3QQYFE8OSdvxYTT3Uel?=
 =?Windows-1252?Q?9HsOGcs/+Ps4ZAeaRs09yBUgiW6+OlVAyYa6SArJ9XQcdNwZz7l/GR3z?=
 =?Windows-1252?Q?5OL788Ux7WjHacCHGtlCsqMqs0GDYLe8Q3wFFvdyTKl0GC1cqeuzssp/?=
 =?Windows-1252?Q?HA1kR1NGs5SXlbv70gdR6UFGJg4GlmQ5szOIxbqBb2B2MsIFn+7bc3il?=
 =?Windows-1252?Q?caUrP16+LnedJNMFcUMqbOJDsBcK/gAdKoWj1h4pBo5z2UaQ4hzUh4nY?=
 =?Windows-1252?Q?6igomLbI6j3TaDopvEV9vhhbZ9V9I44mnDVSTzW+GCqMF4ywjIe1QRsl?=
 =?Windows-1252?Q?FTS/9oBGQUWKEKVXbcngP0MDjruAZFYTQrhcw7AfcqH31PabuXqDvUgh?=
 =?Windows-1252?Q?N3yFPKDXBGjz7q4gUAvusVcY3TzxKDpeJR3zePMfN+50x/8N0uMVJj/0?=
 =?Windows-1252?Q?TC2NERGqqk9QM9OpVCnpvYLHxdIcFnG1uhAsKDEDMh8GEe0tKWh/KMLm?=
 =?Windows-1252?Q?6L7WPbGx0Yy/ND/05dvSqKEH/0orZKiqMsdgnQeiH4gyDN6mncFBsAXB?=
 =?Windows-1252?Q?HNPT8+uOTCRzUsXcHNBUuFUOh+krrcNkvjPNSVnAQW0GI7qD4/e+dL4u?=
 =?Windows-1252?Q?ALWC6g8KWiR8afxd9iYEVRDkmoublN35WovmivEZGSVfz/qaGbM+uZz7?=
 =?Windows-1252?Q?LXfcvm8F+eHf1rxB3HU+UEMkkesjT5lMOg+B3oqm6AXISdJ5gPgAAQeU?=
 =?Windows-1252?Q?/xWmj/1Mr7FtQ/BP1+q8T0V9qED/TNM8lpeurtui3vFO6K4x5066rve4?=
 =?Windows-1252?Q?rKXLK1ZVOEd1wZSBM6M2q95enCRf+23N8jy+BQY3Ddtq1Y/TGgXL+jRx?=
 =?Windows-1252?Q?cbrzmxjoMV6d79xqChKwKum5t9uC+vwBx6VDdz2zZQcVZZK0qKfvtYuD?=
 =?Windows-1252?Q?HRSj1uyWjQqFpb64B4VIMoC0L6FUEpUzyBS131WADDFoh6RGAXb2Sxno?=
 =?Windows-1252?Q?YwOlUszUBOnekDkyehUHN9kb7G5wToZTbRez8r1zvXRiUArY2a8jtdSm?=
 =?Windows-1252?Q?z9Rwjk4RpK421YZvj6YEnuUwxJhEn7fVjEcBHdSSC69yy8fDErRq894I?=
 =?Windows-1252?Q?LhDfzhtHD4jWJBs2fHUETxl3G6s28Z2ue7T1knA55PncfATBzOZsPZsP?=
 =?Windows-1252?Q?4t4oOl/Px+AV3QefxuZSOM3900zcG/fgkCHPgARTFReMqo3cEewZrJeZ?=
 =?Windows-1252?Q?QD1XH/PRgwRNejqZNoXVk7BzwzMH5kDTzPhg5VMqGYKndh4ZlHXMZGL8?=
 =?Windows-1252?Q?B8xaS6tPRnoqYOFGCQqMow/J2/HjtlVUAgch0NhvGZXMBWK3v2y+j7g5?=
 =?Windows-1252?Q?VUdfokGzLzR7GBmYQCEqYHIjQl+R3XWZ/jERSb31gbRw6dQbtavABFZC?=
 =?Windows-1252?Q?CFhDnaxGq2jx95isvIdysxFVjt/sFtqbypVjzyLluKJR85+MasgCIUXm?=
 =?Windows-1252?Q?9sReHwAtyjbdeGC4onDaLOU1lPXKwSdBtOc66Le6YIhNmkWh1FhqMBxH?=
 =?Windows-1252?Q?eyNgby92VQgTVhk7MWvJMyQemeFQX3w/LHxDBV7pcy+SLWUSnUqZLfs9?=
 =?Windows-1252?Q?aHvsvsixMlLdb8J3Jq85RPQpyFw/qqdyNYVpKFTVxZkvxaOK/dRTx0k4?=
 =?Windows-1252?Q?4tP8knmPBDPZDUazT5iDkB19sGSQ2i4IF8ZYd7kJugTfVm2FGQIgVmsl?=
 =?Windows-1252?Q?Fvu9H1yUXxwpnAhRDMzElyeNxSkHQwuby7D1SIEwNMfmRadGQw69JvmU?=
 =?Windows-1252?Q?Re0t03NrZhmZjFubLWH2msrp2Iq+b2+xeEAfWa7hcdGG8Qvj?=
Content-Type: multipart/related;
 boundary="_007_BN9PR12MB5145023F8A59FE949BE7A74C8DFB9BN9PR12MB5145namp_";
 type="multipart/alternative"
MIME-Version: 1.0
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-AuthSource: BN9PR12MB5145.namprd12.prod.outlook.com
X-MS-Exchange-CrossTenant-Network-Message-Id: da9ac016-8af6-4a6e-f418-08da27acdb37
X-MS-Exchange-CrossTenant-originalarrivaltime: 26 Apr 2022 17:47:38.7864 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 3dd8961f-e488-4e60-8e11-a82d994e183d
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: 2N3FsCGY1CHeanXCjaY1DoC2AwsASmy3qwwAE6RwjsHIBVl6xGKj/9hP5J4em0Ye7ZupgDdvOfIHJsL4VEpOzg==
...
--_007_BN9PR12MB5145023F8A59FE949BE7A74C8DFB9BN9PR12MB5145namp_
Content-Type: multipart/alternative;
	boundary="_000_BN9PR12MB5145023F8A59FE949BE7A74C8DFB9BN9PR12MB5145namp_"

--_000_BN9PR12MB5145023F8A59FE949BE7A74C8DFB9BN9PR12MB5145namp_
...
[cid:877ce845-7081-43b3-9463-96116d57e9cf]
[cid:2adba0d7-8f9c-48ca-800f-b0e1e2a6799b]
...
Anyways, re-reporting doesn=92t really help as we will get results from rev=
5.
...
-%2Fpipelines%2F569071&data=3D05%7C01%7CDingchen.Zhang%40amd.com%7C8305d0dc=
fdc14eb5043408da27991099%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C0%7C63786=
5835617158995%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiL=
CJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&sdata=3DjWURD6tVB5TSi9Rn2iOHS=
VrOOJtgywyvH%2BJ719VgJcI%3D&reserved=3D0>
...
: 12pt; color: rgb(0, 0, 0);">
Thanks for the clarification and now the rev5 CI build reports issue again =
which is false-positive (as below)<br>
<a href=3D"https://patchwork.freedesktop.org/series/102886/" id=3D"LPlnk625=
805">https://patchwork.freedesktop.org/series/102886/</a><br>
<img style=3D"max-width:100%" class=3D"w-353 h-56" size=3D"3489" contenttyp=
e=3D"image/png" data-outlook-trace=3D"F:1|T:1" src=3D"cid:877ce845-7081-43b=
3-9463-96116d57e9cf"><br>
<img style=3D"max-width:100%" class=3D"w-548 h-176" size=3D"21626" contentt=
ype=3D"image/png" data-outlook-trace=3D"F:1|T:1" src=3D"cid:2adba0d7-8f9c-4=
8ca-800f-b0e1e2a6799b"><br>
</div>
<div style=3D"font-family: Calibri, Arial, Helvetica, sans-serif; font-size=
: 12pt; color: rgb(0, 0, 0);">
<br>
...
<p class=3D"x_MsoNormal">I have re-opened <a href=3D"https://nam11.safelink=
s.protection.outlook.com/?url=3Dhttps%3A%2F%2Fgitlab.freedesktop.org%2Fdrm%=
2Fintel%2F-%2Fissues%2F5302&amp;data=3D05%7C01%7CDingchen.Zhang%40amd.com%7=
C8305d0dcfdc14eb5043408da27991099%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C=
0%7C637865835617158995%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoi=
V2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&amp;sdata=3DyxB2PcUI=
WOfFOotlCMvSyzUYy4lYG7iurxSc1%2FiXSVo%3D&amp;reserved=3D0" originalsrc=3D"h=
ttps://gitlab.freedesktop.org/drm/intel/-/issues/5302" shash=3D"ox0rD6+xuqE=
oGDYwbhmv/VICiywD8r1eII/BiOBnBCeQZJcEI2aIZmZCvqzcsianhAerXUDDpUZ1kx0gXKx8sP=
luG0o5X7oujIg8s+w9ObmjBQZrqET4FEuZlEljPCN/KzDpPaxcGV8kD044mi9hyc0R1/qSAUlLt=
yUDO7DipeA=3D">
https://gitlab.freedesktop.org/drm/intel/-/issues/5302</a></p>
<p class=3D"x_MsoNormal">igt@i915_module_load@reload-with-fault-injection -=
 dmesg-warn - WARNING: .* at drivers/gpu/drm/i915/i915_vma.c:\d+ i915_ggtt_=
pin</p>
<p class=3D"x_MsoNormal">&nbsp;</p>
<p class=3D"x_MsoNormal">Other sounds is not totally new, I have seen simil=
ar signature few months ago on a different test but to me this sounds like =
a sporadic issue. So filed a new issue</p>
<p class=3D"x_MsoNormal"><a href=3D"https://nam11.safelinks.protection.outl=
ook.com/?url=3Dhttps%3A%2F%2Fgitlab.freedesktop.org%2Fdrm%2Fintel%2F-%2Fiss=
ues%2F5844&amp;data=3D05%7C01%7CDingchen.Zhang%40amd.com%7C8305d0dcfdc14eb5=
043408da27991099%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C0%7C6378658356171=
58995%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6I=
k1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&amp;sdata=3DgliMh56K68thW3KnSp9prTIEP=
IsNNQiSZvXRNNNRGos%3D&amp;reserved=3D0" originalsrc=3D"https://gitlab.freed=
esktop.org/drm/intel/-/issues/5844" shash=3D"h/qa78ChP6KR35SFGbaY4JncOOtFLV=
q6e5gdhDeaXDl+ryiThdHj7k6jn6S0t61Vfwf4pkYfRd7V6CPmGw6UtQjYI5QMVqcrF3E39NBIp=
U6RKIU/LX1YYTX/nmH9fGvAcd5Li3QfXN5zu511Bq5ttDCToQPw9xTjrsJEyen0ruQ=3D">http=
s://gitlab.freedesktop.org/drm/intel/-/issues/5844</a></p>
<p class=3D"x_MsoNormal">igt@kms_fbcon_fbt@psr-suspend - incomplete - pstor=
e logs - is trying to acquire lock at: down_trylock, but task is already ho=
lding lock at: raw_spin_rq_lock_nested</p>
<p class=3D"x_MsoNormal">&nbsp;</p>
<p class=3D"x_MsoNormal">Anyways, re-reporting doesn=92t really help as we =
will get results from rev5.</p>
<p class=3D"x_MsoNormal">&nbsp;</p>
...
<b>Cc:</b> Siqueira, Rodrigo &lt;Rodrigo.Siqueira@amd.com&gt;; Pillai, Aura=
bindo &lt;Aurabindo.Pillai@amd.com&gt;<br>
<b>Subject:</b> Re: False-positive of CI issue w/ AMDGPU patch set</p>
</div>
</div>
<p class=3D"x_MsoNormal">&nbsp;</p>
...
<div>
<div>
<p class=3D"x_MsoNormal"><span style=3D"font-size:12.0pt; color:black">Hi L=
akshmi,</span></p>
</div>
<div>
...
ks for your reply and could you please clear another false-positive CI issu=
e below? (link&nbsp;<a href=3D"https://nam11.safelinks.protection.outlook.c=
om/?url=3Dhttps%3A%2F%2Fpatchwork.freedesktop.org%2Fseries%2F102886%2F&amp;=
data=3D05%7C01%7CDingchen.Zhang%40amd.com%7C8305d0dcfdc14eb5043408da2799109=
9%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C0%7C637865835617158995%7CUnknown=
%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6=
Mn0%3D%7C3000%7C%7C%7C&amp;sdata=3D3bT4vEBbsQL3vFhWTyryZph7TQ3VwAe1%2Fdce%2=
FQG02uE%3D&amp;reserved=3D0" originalsrc=3D"https://patchwork.freedesktop.o=
rg/series/102886/" shash=3D"XljWElG5hYEk9XCnQ004qvks850Xt1fLUGd/xybIvo/6+rU=
T0CMD6vuY/otKuyJv7inipVe/nLMBR6yHjGrlBQ6S46iyUzmsOnDAUHBEH/rVZbogB2+fpxdcSM=
LuJ1qtxmkqEOsCnAo811uiISBwVZ7+CewGhxxJnBAcqt2D02w=3D">https://patchwork.fre=
edesktop.org/series/102886/</a>).
 The possible regression is not correlated to the amdgpu patch set.<br>
<br>
<img border=3D"0" width=3D"682" height=3D"300" id=3D"x_Picture_x0020_1" sty=
le=3D"width:7.1041in; height:3.125in" data-outlook-trace=3D"F:1|T:1" src=3D=
"cid:image001.png@01D85947.3E2D5CE0"></span></p>
</div>
<div>
<p class=3D"x_MsoNormal"><span style=3D"font-size:12.0pt; color:black">&nbs=
p;</span></p>
...
an style=3D"color:black"> Vudum, Lakshminarayana &lt;<a href=3D"mailto:laks=
hminarayana.vudum@intel.com">lakshminarayana.vudum@intel.com</a>&gt;<br>
...
<div>
<div>
<p class=3D"x_xmsonormal">I am not sure if I can take any action here. <a i=
d=3D"OWAAM57EF498B3D784C4BA5D0D08AE4B9E703" href=3D"mailto:petri.latvala@in=
tel.com">
...
<p class=3D"x_xmsonormal">Lakshmi.</p>
<p class=3D"x_xmsonormal">&nbsp;</p>
<div>
<div style=3D"border:none; border-top:solid #E1E1E1 1.0pt; padding:3.0pt 0i=
n 0in 0in">
<p class=3D"x_xmsonormal"><b>From:</b> Zhang, Dingchen (David) &lt;<a href=
...
<div>
<p class=3D"x_xmsonormal"><span style=3D"font-size:12.0pt; color:black">Cou=
ld you help clear the CI pipeline issue of below patch w/ the ARMHF failure=
, which is a false-positive that is uncorrelated to the amdgpu patch set?</=
span></p>
</div>
<div>
<p class=3D"x_xmsonormal"><span style=3D"font-size:12.0pt; color:black"><a =
href=3D"https://nam11.safelinks.protection.outlook.com/?url=3Dhttps%3A%2F%2=
Fgitlab.freedesktop.org%2Fgfx-ci%2Figt-ci-tags%2F-%2Fpipelines%2F569071&amp=
;data=3D05%7C01%7CDingchen.Zhang%40amd.com%7C8305d0dcfdc14eb5043408da279910=
99%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C0%7C637865835617158995%7CUnknow=
n%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI=
6Mn0%3D%7C3000%7C%7C%7C&amp;sdata=3DjWURD6tVB5TSi9Rn2iOHSVrOOJtgywyvH%2BJ71=
9VgJcI%3D&amp;reserved=3D0" originalsrc=3D"https://gitlab.freedesktop.org/g=
fx-ci/igt-ci-tags/-/pipelines/569071" shash=3D"Qi25kRJyFWTUe17KqaVmNVG1b/FA=
0DJ1rslWjMhwYOTIW5hS7jxjX6HE3v4ekQnMSeqodot9mhWamz8yZ0jJg+swvI6ewRjBV77IDzg=
1rfI3sVVgsDp5CIhdIbG8v+SW0ink2ZN3YaW/EfHW6bGR4YDpSTtmeLyOqSxEComVQd0=3D">ht=
tps://gitlab.freedesktop.org/gfx-ci/igt-ci-tags/-/pipelines/569071</a></spa=
n></p>
</div>
<div>
...
dden">
<p class=3D"x_xmsonormal"><a href=3D"https://nam11.safelinks.protection.out=
look.com/?url=3Dhttps%3A%2F%2Fgitlab.freedesktop.org%2Fgfx-ci%2Figt-ci-tags=
%2F-%2Fpipelines%2F569071&amp;data=3D05%7C01%7CDingchen.Zhang%40amd.com%7C8=
305d0dcfdc14eb5043408da27991099%7C3dd8961fe4884e608e11a82d994e183d%7C0%7C0%=
7C637865835617158995%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiLCJQIjoiV2=
luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&amp;sdata=3DjWURD6tVB5=
TSi9Rn2iOHSVrOOJtgywyvH%2BJ719VgJcI%3D&amp;reserved=3D0" originalsrc=3D"htt=
ps://gitlab.freedesktop.org/gfx-ci/igt-ci-tags/-/pipelines/569071" shash=3D=
"Qi25kRJyFWTUe17KqaVmNVG1b/FA0DJ1rslWjMhwYOTIW5hS7jxjX6HE3v4ekQnMSeqodot9mh=
Wamz8yZ0jJg+swvI6ewRjBV77IDzg1rfI3sVVgsDp5CIhdIbG8v+SW0ink2ZN3YaW/EfHW6bGR4=
YDpSTtmeLyOqSxEComVQd0=3D" target=3D"_blank"><span style=3D"border:solid wi=
ndowtext 1.0pt; padding:0in; text-decoration:none"><img border=3D"0" width=
...
=3D"F:1|T:1" src=3D"cid:image002.jpg@01D85947.3E2D5CE0"></span></a></p>
</div>
</td>
...
>
<p class=3D"x_xmsonormal"><span style=3D"font-size:16.0pt; font-family:&quo=
t;Segoe UI Light&quot;,sans-serif"><a href=3D"https://nam11.safelinks.prote=
ction.outlook.com/?url=3Dhttps%3A%2F%2Fgitlab.freedesktop.org%2Fgfx-ci%2Fig=
t-ci-tags%2F-%2Fpipelines%2F569071&amp;data=3D05%7C01%7CDingchen.Zhang%40am=
d.com%7C8305d0dcfdc14eb5043408da27991099%7C3dd8961fe4884e608e11a82d994e183d=
%7C0%7C0%7C637865835617158995%7CUnknown%7CTWFpbGZsb3d8eyJWIjoiMC4wLjAwMDAiL=
CJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&amp;sdata=3Dj=
WURD6tVB5TSi9Rn2iOHSVrOOJtgywyvH%2BJ719VgJcI%3D&amp;reserved=3D0" originals=
rc=3D"https://gitlab.freedesktop.org/gfx-ci/igt-ci-tags/-/pipelines/569071"=
 shash=3D"Qi25kRJyFWTUe17KqaVmNVG1b/FA0DJ1rslWjMhwYOTIW5hS7jxjX6HE3v4ekQnMS=
eqodot9mhWamz8yZ0jJg+swvI6ewRjBV77IDzg1rfI3sVVgsDp5CIhdIbG8v+SW0ink2ZN3YaW/=
EfHW6bGR4YDpSTtmeLyOqSxEComVQd0=3D" target=3D"_blank"><span style=3D"text-d=
ecoration:none">Pipeline
...
<p class=3D"x_xmsonormal"><span style=3D"font-size:10.5pt; font-family:&quo=
t;Segoe UI&quot;,sans-serif; color:#666666">CI tags for IGT GPU tools. WARN=
ING: This repo's master branch will not be updated. Use
...
0" originalsrc=3D"https://gitlab.freedesktop.org/drm/igt-gpu-tools" shash=
=3D"iC0QUxvn8/3Vvy3+cDPkz8wURKx+q3VdW9/whdCbQnfdB6xeIdCN2utsJ3CHaxs9kgWersI=
sCNjNxqyHzABZ0rJ5ODIYjUrU/o0hWQPiHW5VX2EJKc0kL7BAv/hRxS/+F3VjbiEjYEuwOg8sQ6=
ye14xLpCsFeNS1QGtSjyjqFL8=3D">
https://gitlab.freedesktop.org/drm/igt-gpu-tools</a> for this purpose.</spa=
n></p>
</div>
<div id=3D"LPMetadata535359">
<p class=3D"x_xmsonormal"><span style=3D"font-size:10.5pt; font-family:&quo=
t;Segoe UI&quot;,sans-serif; color:#A6A6A6">gitlab.freedesktop.org</span></=
p>
</div>
</td>
</tr>
...
<p class=3D"x_xmsonormal"><span style=3D"font-size:12.0pt; color:black"><a =
href=3D"https://nam11.safelinks.protection.outlook.com/?url=3Dhttps%3A%2F%2=
Fpatchwork.freedesktop.org%2Fseries%2F102886%2F&amp;data=3D05%7C01%7CDingch=
en.Zhang%40amd.com%7C8305d0dcfdc14eb5043408da27991099%7C3dd8961fe4884e608e1=
1a82d994e183d%7C0%7C0%7C637865835617158995%7CUnknown%7CTWFpbGZsb3d8eyJWIjoi=
MC4wLjAwMDAiLCJQIjoiV2luMzIiLCJBTiI6Ik1haWwiLCJXVCI6Mn0%3D%7C3000%7C%7C%7C&=
amp;sdata=3D3bT4vEBbsQL3vFhWTyryZph7TQ3VwAe1%2Fdce%2FQG02uE%3D&amp;reserved=
=3D0" originalsrc=3D"https://patchwork.freedesktop.org/series/102886/" shas=
h=3D"XljWElG5hYEk9XCnQ004qvks850Xt1fLUGd/xybIvo/6+rUT0CMD6vuY/otKuyJv7inipV=
e/nLMBR6yHjGrlBQ6S46iyUzmsOnDAUHBEH/rVZbogB2+fpxdcSMLuJ1qtxmkqEOsCnAo811uiI=
SBwVZ7+CewGhxxJnBAcqt2D02w=3D">https://patchwork.freedesktop.org/series/102=
886/</a></span></p>
</div>
<div>
<p class=3D"x_xmsonormal"><span style=3D"font-size:12.0pt; color:black">&nb=
...
<div>
<p class=3D"x_xmsonormal"><span style=3D"font-size:12.0pt; color:black">Tha=
nks</span></p>
</div>
<div>
<p class=3D"x_xmsonormal"><span style=3D"font-size:12.0pt; color:black">Dav=
id&nbsp;</span></p>
</div>
</div>
</div>
...
Content-Disposition: inline; filename="image001.png"; size=36678;
	...
	modification-date="Tue, 26 Apr 2022 17:45:53 GMT"
...
Content-Disposition: inline; filename="image.png"; size=3489;
	creation-date="Tue, 26 Apr 2022 17:46:56 GMT";
	modification-date="Tue, 26 Apr 2022 17:46:56 GMT"
Content-ID: <877ce845-7081-43b3-9463-96116d57e9cf>
Content-Transfer-Encoding: base64
...
Content-Type: image/png; name="image.png"
Content-Description: image.png
Content-Disposition: inline; filename="image.png"; size=21626;
	creation-date="Tue, 26 Apr 2022 17:47:09 GMT";
	modification-date="Tue, 26 Apr 2022 17:47:09 GMT"
Content-ID: <2adba0d7-8f9c-48ca-800f-b0e1e2a6799b>
Content-Transfer-Encoding: base64

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B26C3375E
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Jun 2019 19:59:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA4EA89304;
	Mon,  3 Jun 2019 17:59:44 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt;
 ...
 nK53Q09w==;
Subject: [Intel-gfx] [PATCH 12/22] gpu: i915.rst: Fix references to renamed
 files

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B23F6C97783
	for <lists+intel-gfx@lfdr.de>; Mon, 01 Dec 2025 14:06:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 480B210E3D1;
	Mon,  1 Dec 2025 13:06:25 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="DDAQr9A/";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pg1-f182.google.com (mail-pg1-f182.google.com
 [209.85.215.182])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 57B3710E138
 for <intel-gfx@lists.freedesktop.org>; Mon,  1 Dec 2025 13:06:24 +0000 (UTC)
Received: by mail-pg1-f182.google.com with SMTP id
 41be03b00d2f7-bc29d64b39dso2483586a12.3
 for <intel-gfx@lists.freedesktop.org>; Mon, 01 Dec 2025 05:06:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1764594383; x=1765199183; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=ITWhguaUC98QYy5pkBWdIVw0/sOWPxITgfp9NKDf+OY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1764594383; x=1765199183;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=ITWhguaUC98QYy5pkBWdIVw0/sOWPxITgfp9NKDf+OY=;
 b=
X-Gm-Message-State: AOJu0YzBjWFQksbkDaWUBlXs+ptN1qCD0OKWEw94xjQo3qgCqf0JJ8PE
 AfCAS2uj11psfcinpg2Rr7pvXsWzmf5/1+kHKbkRu+WueI8+73D6G+vdd+9M4AYb
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IF9NspVQv/E7Mz5eDw6tCmF3gnr8lMgg8r8Ua84ux1IEcs1O8O0MiNn9fAWFzJdqT3YQdaesA==
X-Received: by 2002:a05:7022:4184:b0:11b:b3a1:714a with SMTP id
 a92af1059eb24-11c9d811fabmr23583512c88.12.1764594374220; 
 Mon, 01 Dec 2025 05:06:14 -0800 (PST)
Received: from localhost ([192.55.54.43]) by smtp.gmail.com with ESMTPSA id
 a92af1059eb24-11dcb067088sm40758295c88.10.2025.12.01.05.06.12
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 01 Dec 2025 05:06:13 -0800 (PST)
From: Juha-Pekka Heikkila <juhapekka.heikkila@gmail.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Juha-Pekka Heikkila <juhapekka.heikkila@gmail.com>
Subject: [PATCH 1/2] drm/i915: switch to use kernel standard error injection
Date: Mon,  1 Dec 2025 15:05:58 +0200
Message-ID: <20251201130559.731361-2-juhapekka.heikkila@gmail.com>

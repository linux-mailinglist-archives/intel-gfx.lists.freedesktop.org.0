...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E1B9184C4E
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Mar 2020 17:21:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C94246EC14;
	Fri, 13 Mar 2020 16:21:15 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/9] drm/edid: Move validate_displayid()

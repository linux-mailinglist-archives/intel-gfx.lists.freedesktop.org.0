...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4566C2854CE
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Oct 2020 00:59:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCF0A6E5D2;
	Tue,  6 Oct 2020 22:59:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 83E0A6E5CF;
 Tue,  6 Oct 2020 22:59:26 +0000 (UTC)
IronPort-SDR: WTRWLLORCFNps21ozuV493OePgqf2bIosDcG6/Qa7vNUxIG+sY0KgRzZMXneX2HetPbpFZLJ9p
 2scYe9z452hA==
X-IronPort-AV: E=McAfee;i="6000,8403,9766"; a="152503548"
X-IronPort-AV: E=Sophos;i="5.77,344,1596524400"; d="scan'208";a="152503548"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2020 15:59:25 -0700
IronPort-SDR: SuxKtcOrSIliYmnoMZiH9sidi4BiSMjGPhNeUtxTeNP6Cu7uhm0RhVWzJK3if4G9LktAcicAoE
 WPL76ok+Sd0A==
X-IronPort-AV: E=Sophos;i="5.77,344,1596524400"; d="scan'208";a="518534437"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.168])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2020 15:59:24 -0700
Date: Tue, 6 Oct 2020 15:59:23 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: Tejas Upadhyay <tejaskumarx.surendrakumar.upadhyay@intel.com>
Message-ID: <20201006225923.GC2784854@mdroper-desk1.amr.corp.intel.com>
References: <20201005172450.24483-1-tejaskumarx.surendrakumar.upadhyay@intel.com>
 <20201005172450.24483-2-tejaskumarx.surendrakumar.upadhyay@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20201005172450.24483-2-tejaskumarx.surendrakumar.upadhyay@intel.com>
Subject: Re: [Intel-gfx] [PATCH v4 1/2] drm/i915/jsl: Split EHL/JSL platform
 info and PCI ids
...
Arguably we could also pull everything out to a separate FEATURES macro
here too.  E.g.,

        #define JSL_EHL_FEATURES \
                GEN11_FEATURES, \
                .require_force_probe = 1, \
                .platform_engine_mask = BIT(RCS0) | BIT(BCS0) | BIT(VCS0) | BIT(VECS0), \
                .ppgtt_size = 36, \
...
to help prevent them from getting out of sync.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F8A94BFB36
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 15:52:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B7F6510E8AC;
...
Subject: [Intel-gfx] [PATCH 6/7] drm/i915/gt: Avoid direct dereferencing of
 io memory

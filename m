...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4686406ABB
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 13:31:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E047C6E9E6;
...
Subject: Re: [Intel-gfx] [PATCH RESEND] drm/i915: Mark GPU wedging on driver

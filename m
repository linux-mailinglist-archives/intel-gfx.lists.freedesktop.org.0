...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AD88F17B2A7
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 01:10:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49CBE6EC35;
	Fri,  6 Mar 2020 00:10:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C0C7F6EC3A
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Mar 2020 00:10:01 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20460971-1500050 
 for <intel-gfx@lists.freedesktop.org>; Fri, 06 Mar 2020 00:09:57 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  6 Mar 2020 00:09:56 +0000
Message-Id: <20200306000957.2836150-1-chris@chris-wilson.co.uk>
...
dC9zZWxmdGVzdF9yaW5nX3N1Ym1pc3Npb24uYyAgICB8IDI5MCArKysrKysrKysrKysrKysrKysK
IC4uLi9kcm0vaTkxNS9zZWxmdGVzdHMvaTkxNV9saXZlX3NlbGZ0ZXN0cy5oICB8ICAgMSArCiAz
IGZpbGVzIGNoYW5nZWQsIDQyNSBpbnNlcnRpb25zKCspLCA0IGRlbGV0aW9ucygtKQogY3JlYXRl
...
c3Npb24uYwpuZXcgZmlsZSBtb2RlIDEwMDY0NAppbmRleCAwMDAwMDAwMDAwMDAuLjZmNDJkZDU1
NDNiNgotLS0gL2Rldi9udWxsCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L3NlbGZ0ZXN0
X3Jpbmdfc3VibWlzc2lvbi5jCkBAIC0wLDAgKzEsMjkwIEBACisvLyBTUERYLUxpY2Vuc2UtSWRl
...

...


...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C215E577B9E
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:41:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B6B7A9D9F;
...
Subject: [Intel-gfx] [PATCH v3 37/41] nouveau: adapt NV_DEBUG,

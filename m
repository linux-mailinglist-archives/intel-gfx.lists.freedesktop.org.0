...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F197C286581
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Oct 2020 19:11:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5634E6E96C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 4/6] drm/dp: Add LTTPR helpers

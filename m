...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FD9A2002B
	for <lists+intel-gfx@lfdr.de>; Thu, 16 May 2019 09:23:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C16A89385;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [v10 12/12] drm/i915: Add state readout for DRM
 infoframe

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C9F553F731E
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Aug 2021 12:27:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 202B16E1D3;
...
Subject: [Intel-gfx] [PATCH v6 6/7] drm: avoid circular locks with

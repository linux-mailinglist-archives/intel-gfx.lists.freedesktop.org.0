...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90934C27626
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:05:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A13310E0AE;
	Sat,  1 Nov 2025 03:05:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="b6B4yeZH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 47F9710E331;
 Sat,  1 Nov 2025 03:05:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761966300; x=1793502300;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GBh4a9JUcKdfCu0QtQGj3e5UshwpVeIpyibo56MY/Wc=;
 b=b6B4yeZHfaAWO5zfR26TYSCtGvQeO61QeveAp6wd2gRBhdFYMIsNcwTT
 7QS9dvI15svf4VXzawWtSoSBym/A2CDdDL7WsKCHyfbCoETUc1xyzNLu1
 NFIetYxRA43hRkJwCnZZ4/ht/seL25/ZkUS5W46F2StKHHFtDOmIUESn3
 X6QOPWIm1/To0A4VgfZueA9VQ7QbnT9nqFMDhe8YR54oWMcjSXWwBhMcO
 C+7DAk+0HAqE6eh3QdbVIowjfTrtX4GRY2TBu5RL/RZcH2WGVWhtYy21F
 jdsX51MinU+nlpuu3quqk/3kR9sSSsJKYY0V0dZyK6LFfAw1Y1qKDNjgq w==;
X-CSE-ConnectionGUID: zYn+eCM+QR6mtcp9Ju/UXA==
X-CSE-MsgGUID: 2s82XIlWS56Rvl/56Pq1+w==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="81759510"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="81759510"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:05:00 -0700
X-CSE-ConnectionGUID: 6jKuZI6uQWmHnh33nMJeiw==
X-CSE-MsgGUID: OumNuWh3RE6AoiAMYgVk8Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217222588"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa001.fm.intel.com with ESMTP; 31 Oct 2025 20:04:56 -0700
...
Subject: [PATCH v4 07/25] drm/i915/ltphy: Read PHY_VDR_0_CONFIG register
Date: Sat,  1 Nov 2025 08:34:16 +0530
Message-Id: <20251101030434.4159839-8-suraj.kandpal@intel.com>
...
---
V1 -> V2:
-Update the commit message (Arun)

V2 -> V3:
-Make functions fit in single line if they can (Jani)

 drivers/gpu/drm/i915/display/intel_cx0_phy.c |   3 +-
 drivers/gpu/drm/i915/display/intel_cx0_phy.h |   1 +
 drivers/gpu/drm/i915/display/intel_lt_phy.c  | 144 ++++++++++++++++---
 3 files changed, 123 insertions(+), 25 deletions(-)

diff --git a/drivers/gpu/drm/i915/display/intel_cx0_phy.c b/drivers/gpu/drm/i915/display/intel_cx0_phy.c
index 3d79f3be1ccd..d87334137cd3 100644
...
index 8c9b97f0922d..948fd626846d 100644
...
index 239f7cdd373b..768b14a9914a 100644

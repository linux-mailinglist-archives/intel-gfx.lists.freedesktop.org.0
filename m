...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4885577869E
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Aug 2023 06:43:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B2D1310E642;
	Fri, 11 Aug 2023 04:43:16 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915/pxp/mtl: Update pxp-firmware
 packet size

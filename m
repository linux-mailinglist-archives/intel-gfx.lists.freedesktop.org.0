...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E72EE71F76
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Jul 2019 20:40:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0993A8922A;
	Tue, 23 Jul 2019 18:40:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D96989219
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Jul 2019 18:40:30 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17542606-1500050 
 for multiple; Tue, 23 Jul 2019 19:38:43 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 Jul 2019 19:38:21 +0100
Message-Id: <20190723183842.20372-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/23] drm/i915/gt: Provide a local
 intel_context.vm
...
dS9kcm0vaTkxNS9ndC9pbnRlbF9jb250ZXh0LmMKaW5kZXggOTI5MmI2Y2E1ZTljLi45ZTRmNTFj
ZTUyZmYgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2NvbnRleHQu
...
MTUvZ3QvaW50ZWxfbHJjLmMKaW5kZXggODg0ZGZjMWNiMDMzLi42MzIzNDRjMTYzYTggMTAwNjQ0
Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2xyYy5jCisrKyBiL2RyaXZlcnMv
Z3B1L2RybS9pOTE1L2d0L2ludGVsX2xyYy5jCkBAIC0xNjA2LDggKzE2MDYsNiBAQCBfX2V4ZWNs
...
dCkKIAkJZ290byBlcnI7CkBAIC0xNzE3LDggKzE3MTUsNyBAQCBzdGF0aWMgaW50IGdlbjhfZW1p
...
cS0+aHdfY29udGV4dC0+dm0pOwogCWludCBlcnIsIGk7CiAJdTMyICpjczsKIApAQCAtMTc5MSw3
ICsxNzg4LDcgQEAgc3RhdGljIGludCBleGVjbGlzdHNfcmVxdWVzdF9hbGxvYyhzdHJ1Y3QgaTkx
...
Mjk0MSw3ICsyOTM4LDcgQEAgc3RhdGljIHZvaWQgZXhlY2xpc3RzX2luaXRfcmVnX3N0YXRlKHUz

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 951C94AFD9
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jun 2019 04:08:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBBB16E27A;
	Wed, 19 Jun 2019 02:08:01 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 c7Dg==
Subject: [Intel-gfx] [PATCH V4] drm/drm_vblank: Change EINVAL by the correct
 errno

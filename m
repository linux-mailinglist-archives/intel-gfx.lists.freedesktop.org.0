...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 14AF111E95D
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2019 18:44:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3FF56EBB1;
	Fri, 13 Dec 2019 17:44:10 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 4/4] drm/edid: Make sure the CEA mode arrays

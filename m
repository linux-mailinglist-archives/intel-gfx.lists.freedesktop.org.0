...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F336A46008
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Feb 2025 14:03:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 939C410E8F5;
	Wed, 26 Feb 2025 13:03:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="R8RRgpxi";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9258E10E8F5;
 Wed, 26 Feb 2025 13:03:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 U5RKHi6687J80IBxlInll4ygqI6MX8p2xhEyUZ/ya6MYGbubeONuXfygY g==;
X-CSE-ConnectionGUID: tFzMWi1jSEKj1n8VxzYTRQ==
X-CSE-MsgGUID: Vcu+zgmsQLaphhpRJ0Z9qg==
X-IronPort-AV: E=McAfee;i="6700,10204,11357"; a="41341504"
X-IronPort-AV: E=Sophos;i="6.13,317,1732608000"; d="scan'208";a="41341504"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa113.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Feb 2025 05:03:07 -0800
X-CSE-ConnectionGUID: sfzqUCNlSYuPax1xXRAVQg==
X-CSE-MsgGUID: x4ZAdKQiQGGTMQte+F7DTw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,317,1732608000"; d="scan'208";a="121690516"
...
Subject: [PATCH v5 02/11] mtd: add driver for intel graphics non-volatile
 memory device

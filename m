...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BE694FC43F
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 20:41:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2E0B10E1FD;
...
Subject: Re: [Intel-gfx] [PATCH 27/34] drm/i915/gvt: remove
 kvmgt_guest_{init, exit}

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED6A870C17A
	for <lists+intel-gfx@lfdr.de>; Mon, 22 May 2023 16:52:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6015710E346;
...
Subject: Re: [Intel-gfx] [PATCH 1/4] drm/i915: Move setting of rps
 thresholds to init

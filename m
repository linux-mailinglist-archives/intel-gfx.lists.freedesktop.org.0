...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F06B6584888
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Jul 2022 01:07:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E0EE10EC7A;
...
Subject: [Intel-gfx] [PATCH 0/1] Move DG2 to GuC v70.4.1

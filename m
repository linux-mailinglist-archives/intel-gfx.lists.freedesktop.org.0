...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8D9F742EA7
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jun 2023 22:42:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D2E810E3EC;
...
Subject: [Intel-gfx] [PATCH v3] drm/i915/selftest/gsc: Ensure GSC Proxy init

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F22A868CEAB
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Feb 2023 06:07:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 545CD10E2F2;
...
Subject: [Intel-gfx] [PATCH v2 6/6] drm/i915/guc: More debug print updates -
 GuC logging

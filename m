...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CAF437EAE46
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Nov 2023 11:45:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B7D0B10E20F;
	Tue, 14 Nov 2023 10:45:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B521810E1FD
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Nov 2023 10:45:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699958749; x=1731494749;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=suozJfZeFhW4KeEaQJQDssWtP18GO0jy1Lc5Vxe6h5Q=;
 b=FsXgqdQ8EzjEBAyHgGXmuAXMg3UgYalyfqst9cYspUX0zTjRWnPeov61
 1Stj2hrxyRNEdcIqlYw2GQL261KTHuOd5uUpJZgAPWfIh4diSSZVeF7US
 oz8o9PfvblFMe0PtDb+A6Wme3GFJIy6mx7KUTSolklD3r0S95pUgUw7BQ
 S+YgnLdPhZ3Kw+xLGGluLk36UwphYXKC3TMFlO8dbMqY8aHHI+BAcDlls
 xDamBirQ9kqb82xkVY1ttY1tvg7p9tvswtyL5KGoUNofHwv001pRu2H+V
 bqPGWVh7hk0jzktW7P5OFAAJ7HZlHu+2MV6ANDoY7mxw/iBJm92yjY4ly w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10893"; a="389487556"
X-IronPort-AV: E=Sophos;i="6.03,301,1694761200"; d="scan'208";a="389487556"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2023 02:45:49 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10893"; a="830543017"
X-IronPort-AV: E=Sophos;i="6.03,301,1694761200"; d="scan'208";a="830543017"
Received: from hatran1-mobl1.ccr.corp.intel.com (HELO localhost)
 ([10.252.56.145])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2023 02:45:47 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Nov 2023 12:45:34 +0200
Message-Id: <20231114104534.4180144-3-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 3/3] drm/i915: convert

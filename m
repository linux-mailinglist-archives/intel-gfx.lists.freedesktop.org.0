...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 888A926A822
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 17:01:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 331BE6E8D5;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 15/21] drm/vc4: Introduce GEM object functions

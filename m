...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 873E35800E5
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Jul 2022 16:42:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F26BB88A5;
	Mon, 25 Jul 2022 14:42:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7E115B88A5
 for <intel-gfx@lists.freedesktop.org>; Mon, 25 Jul 2022 14:42:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1658760153; x=1690296153;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=PH04kaCePrAYEn6A9pLwyVCHRhLivF+ikbHtlXq4Vlo=;
 b=WoqKsULUzJgFksgO5mxxnxHuAm7bGPiKZkQyW+HILhGkox9VpvDAJSZP
 6mQbX5h2W/CSB6ma3G0qSeiJrdsy3OdTDUmn8i4WoZGqmpFv7Vak9ijla
 Nx/A9x5Lf0i+frQkTuw2+/ZHp3LAAMiYhz7ABxzHANT05mr1AEAVkH9Uj
 O3/nsLYuFozz40bR5yXcMZbVQojTgLU6JUj2pACgAMKzAO/VtBgtcIZ3n
 4vEMbuuYpHUxlKdIQQR/DZz8x/iLPh/N638hwukf6e9oHi2EMSpuN9sk9
 zoqu9wpvUxzC11aLsF3ssKdDNsn4joMTpe2u4DonxipwuwpToR7r2REPA A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10419"; a="270748679"
X-IronPort-AV: E=Sophos;i="5.93,193,1654585200"; d="scan'208";a="270748679"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Jul 2022 07:42:32 -0700
X-IronPort-AV: E=Sophos;i="5.93,193,1654585200"; d="scan'208";a="575078026"
Received: from ngobrien-mobl1.ger.corp.intel.com (HELO [10.213.204.5])
 ([10.213.204.5])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Jul 2022 07:42:31 -0700
Message-ID: <6d0d72da-229c-2630-fdf9-d366dea1298f@linux.intel.com>
Date: Mon, 25 Jul 2022 15:42:29 +0100
MIME-Version: 1.0
...
References: <20220722151204.1534489-1-bob.beckett@collabora.com>
 ...
 <c4b687c6-f79d-3ac9-a2ec-b56f7906397a@linux.intel.com>
 <4f9d6583-4ac9-df2e-4ce1-f50c074dacfa@collabora.com>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
In-Reply-To: <4f9d6583-4ac9-df2e-4ce1-f50c074dacfa@collabora.com>

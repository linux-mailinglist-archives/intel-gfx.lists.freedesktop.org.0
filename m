...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19CDDA9D319
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Apr 2025 22:37:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8053110E9D2;
	Fri, 25 Apr 2025 20:37:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="gh22MLo1";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D0EA110E9D2
 for <intel-gfx@lists.freedesktop.org>; Fri, 25 Apr 2025 20:37:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1745613423;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=CpUFuT49QYK3fR0dsNMkxP3fgvhL7PUWCGb2oz6iPXc=;
 b=gh22MLo1IZGQCahD4B5xpcWYO38fxDYt9M5F5tQ2lfvOQB0RW2Ot2LiNmJmUJJ5V92m8Qm
 SA/lEdXtJYG1ZJ9yo3q3DIDRhnZ2oIDsHgUGUiAFs47orwCHeyVtMoa1+tkiISa3iXXjqG
 pBBuGnCYLoGv7rWUiFPS1AzQMBzbbCg=
Received: from mail-wm1-f69.google.com (mail-wm1-f69.google.com
 [209.85.128.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-304-QVIvuieHPq6atAAFuXBrKw-1; Fri, 25 Apr 2025 16:36:59 -0400
X-MC-Unique: QVIvuieHPq6atAAFuXBrKw-1
X-Mimecast-MFC-AGG-ID: QVIvuieHPq6atAAFuXBrKw_1745613418
Received: by mail-wm1-f69.google.com with SMTP id
 5b1f17b1804b1-43ceeaf1524so11536745e9.1
 for <intel-gfx@lists.freedesktop.org>; Fri, 25 Apr 2025 13:36:59 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=CpUFuT49QYK3fR0dsNMkxP3fgvhL7PUWCGb2oz6iPXc=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCVaOXLnbd2LHvqKUddQtNqeH+cyfpWRdkvjT7h8X8r1gR97XdoEkzZrSvj7kYmsyx82rn7jQeI8Rl8=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YwDYMqAdbRmRrZMtAjLMkyqIdCyiZWdGiwxd6YQ+AT4CZ4QgSO5
 VveHeASmxNEKBagCvY0fIl1I/a/FD9n8/mVQM+rjVpk1Wjq378K3ciYoI7UT3SuDwtA3RTR+Wd3
 Vf8eGVx5XU9063AB21mQ86hXkFiNCfgPtRmnJdik5Fdwbq297e33KNKiMWN2mD1Lq7w==
X-Gm-Gg: 
 2n0W+B1T10Yc7yvBS4r7DEk6Gl0sPyl9sKbey
X-Received: by 2002:a05:600c:c88:b0:439:5f04:4f8d with SMTP id
 5b1f17b1804b1-440a6693e9fmr30390405e9.12.1745613418373; 
...
X-Mimecast-MFC-PROC-ID: ry1LBnQd9qqszqljUmnvi9Y4pTCdZOhup0AcG6d_pXw_1745613418

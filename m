...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 641296F0750
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Apr 2023 16:26:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF29B10EB5E;
	Thu, 27 Apr 2023 14:26:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 111D510EB59
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Apr 2023 14:26:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682605600; x=1714141600;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=8f1LKn8VGuBv/QoSADYp/2a0YlvdK/q8h5KF7+pg5XM=;
 b=HGA+5UvbH/8lKZEtCbUMswC5TJ3/OrTIYJqR6W4HPIfTavGGJ3YHIxTA
 ZFz4C/yORQND0MAMVuoV5wi0CQ0Lt3fK0JjcaSOfa7DxyCDK7tWprmIKC
 V/uUXVus0KCRLJrzrfpNLsvHqLlaCqLgCDG9mDqlEwz+zhzAYzjX1Ubmg
 5dc6mULuAOd/pMp55ER7VDcbxrSlKA6h89O5f7oU1eb3rWJFlSVRPpXf8
 2ZCyFp4vFoL5s6utjnTgtb4wlkejP2JcUvzMKora/Q9rsHfKI36MwPQet
 H1zHs9hT2gg7OLLSK9blfLcG68k/dUX3QUmDq4PdrUfqF788wGIUQPpkp g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="375438679"
X-IronPort-AV: E=Sophos;i="5.99,230,1677571200"; d="scan'208";a="375438679"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 07:26:39 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="838403846"
X-IronPort-AV: E=Sophos;i="5.99,230,1677571200"; d="scan'208";a="838403846"
Received: from jfedorov-mobl2.ccr.corp.intel.com (HELO
 vgovind2-mobl3.intel.com) ([10.251.216.111])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 07:26:37 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Apr 2023 17:26:03 +0300
Message-Id: <20230427142604.1565580-8-vinod.govindapillai@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A604F6D740E
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Apr 2023 08:01:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F36710E2FF;
	Wed,  5 Apr 2023 06:00:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4C50610E2FF
 for <intel-gfx@lists.freedesktop.org>; Wed,  5 Apr 2023 06:00:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680674458; x=1712210458;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=hYP9AK0lC9blnheEYIo6o+gTLMTcuC6HwpSA+TQSdH0=;
 b=MkoOpAo5oeV3CFkF36F/RzXk/8CHSJLhtpSmBqwW3ZdUzV3XRcp5BGgv
 7m0uj0q7yRwEaweTrr/cL/OY4tXhAEsRHp51Q6jBkmtcw9LiCHv4efhUJ
 9rg54TZxrfx9URBPnQy3pAcMtpbpm667g6Ii8ddMxL8MUA6AiKxXTzYxN
 2PjGKdBfV8DfQfhBzB76eXt4zn2L543xohfHLMvwcp2rs5hzhQXa1fbad
 ObPigx4Dsu/19KDcJBjIiAqkzfgXlltdsJemTD2sQgzd78Q4KyeDuEsbL
 TzdE6WQxOJrOT5JGCEuyA/AGllmvrax+9/F6go4lMIRyriVO2BJRovgX0 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10670"; a="326412523"
X-IronPort-AV: E=Sophos;i="5.98,319,1673942400"; d="scan'208";a="326412523"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Apr 2023 23:00:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10670"; a="860849610"
X-IronPort-AV: E=Sophos;i="5.98,319,1673942400"; d="scan'208";a="860849610"
Received: from rtauro-desk.iind.intel.com ([10.190.239.41])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Apr 2023 23:00:43 -0700
From: Riana Tauro <riana.tauro@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  5 Apr 2023 11:30:28 +0530
Message-Id: <20230405060029.3574262-4-riana.tauro@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 3/4] drm/i915/selftests: Add hwmon support in
 libpower for dgfx

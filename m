...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id QMhLFUijBGogMQIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2026 18:14:00 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 01B53536DA6
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2026 18:13:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56A8410EF50;
	Wed, 13 May 2026 16:13:58 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VWWde9E9";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 79BEB10EF50;
 Wed, 13 May 2026 16:13:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1778688837; x=1810224837;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=wCrsHlXWWNEMNZqNdLGFEDYvdtaiAm8h505usTEXPTg=;
 b=VWWde9E92RZAnpc4aOiVuqPcoqr5To+69R0n8RIBb2G36T56Tl9QJWoZ
 8XkQGoVSFqEB98T+HMlYKqQCEAgNDmH7yPJfvRYsqZ2qFPWSobUnT2Ejk
 9PZuA+9SEEyNrmFW0149vnjiifXr/cImsxImkZbQAfCgQJCSKjWHQsDOC
 Kf3y8HW6tDa47POPyeHtxHyg1ymLiR406PaFpGUeyvXJauBu44MQoInhY
 CVEMoT+vyckpBfoY5q6EQSLQKyzr9IO9haTiTbgT9AM7cIYBJaW7Zx95Q
 qwynE353RF29FSuJGMGSxa64Ge0TukezNiTVxrnhc+p96F14+dME29AdL Q==;
X-CSE-ConnectionGUID: eozjTIEdRI6C3Zt3kxTWSA==
X-CSE-MsgGUID: a88X+abRSAaJ4CE939jPIQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11785"; a="79517161"
X-IronPort-AV: E=Sophos;i="6.23,233,1770624000"; d="scan'208";a="79517161"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa113.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2026 09:13:56 -0700
X-CSE-ConnectionGUID: mk4VbdcBR/m7b9E23DZg1g==
X-CSE-MsgGUID: R9VMyz6aSJCByDcKGGUX5w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,233,1770624000"; d="scan'208";a="261631836"
Received: from kniemiec-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.244.124])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2026 09:13:55 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH v4 5/8] drm/i915/irq: add platform specific display irq ack
 functions
Date: Wed, 13 May 2026 19:13:28 +0300
Message-ID: <30d2f1c0c6acd997b841f0dfc538f703e064998d.1778688699.git.jani.nikula@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B65D64AB76
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Dec 2022 00:18:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFBE710E2DA;
...
Subject: [Intel-gfx] [PATCH v9 18/23] drm/i915/vm_bind: Limit vm_bind mode

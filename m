...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 078F05A4DFD
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:26:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8101010F34A;
...
Subject: [Intel-gfx] [PATCH v2 26/41] drm/vc4: vec: Refactor VEC TV mode
 setting

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 992C313C042
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 13:18:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 992C76E954;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 16/21] drm/sti: Convert to CRTC VBLANK
 callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 72E7F46EFDB
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Dec 2021 18:02:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87F7E10EF4B;
...
Subject: [Intel-gfx] [PATCH v4 01/16] drm/i915/xehpsdv: enforce min GTT
 alignment

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD92C65D038
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Jan 2023 11:06:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06A7510E541;
...
Subject: [Intel-gfx] [PATCH v7 07/22] drm/edid: refactor CTA Y420CMDB parsing

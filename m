...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CAB272AD4D8
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Nov 2020 12:25:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2B4A899A5;
	Tue, 10 Nov 2020 11:25:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5151C899FF
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 Nov 2020 11:25:56 +0000 (UTC)
IronPort-SDR: 0KOTa8ng3zPT8zK6GHqgASftB1/0wZxVb3UIgODACtp7GrcqYKIx9cemqGiXdNbRL0yYkKzwRt
 JzQHqAMr4hvQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9800"; a="149806463"
X-IronPort-AV: E=Sophos;i="5.77,466,1596524400"; d="scan'208";a="149806463"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2020 03:25:50 -0800
IronPort-SDR: 7Amx5C7keHHUTMEtRPXBw6i7Mpuv5Y14XfXMWoAW5lLunf+8wdksqPMENtGK7hw3acVt3zZ/aU
 /hGJUuux8Rvw==
X-IronPort-AV: E=Sophos;i="5.77,466,1596524400"; d="scan'208";a="473387619"
Received: from ideak-desk.fi.intel.com ([10.237.68.141])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2020 03:25:48 -0800
Date: Tue, 10 Nov 2020 13:25:45 +0200
From: Imre Deak <imre.deak@intel.com>
To: Ville Syrjala <ville.syrjala@linux.intel.com>
Message-ID: <20201110112545.GC425411@ideak-desk.fi.intel.com>
...
> @@ -11346,9 +11348,9 @@ static void hsw_get_ddi_port_state(struct intel_c=
rtc *crtc,
>  =
...
> -	active =3D pll->info->funcs->get_hw_state(dev_priv, pll, &dpll_hw_state=
);
...
> @@ -141,7 +141,7 @@ void assert_shared_dpll(struct drm_i915_private *dev_=
priv,
...
> @@ -400,6 +400,9 @@ void intel_update_active_dpll(struct intel_atomic_sta=
te *state,

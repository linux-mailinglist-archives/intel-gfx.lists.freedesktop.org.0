...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E854AADE738
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jun 2025 11:40:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7EF9910E7C5;
	Wed, 18 Jun 2025 09:40:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="W/urjQOg";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5F0BB10E7C4
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Jun 2025 09:40:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1750239648;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=7zgUFcNjP45KVFN7fvEt+xKxva7ecAlvU3lfLilVE+Q=;
 b=W/urjQOgDr82J65Zf07miR9vTO9fju9GzCd62kzkweklvCcdHwcMQKtei9xUxPlwKYZ6r4
 ikQR+3OOPjaOTExsElKL0b+dFOs79BZlbpGE3sUYtaanDKkomnBDHD57H8jnCqArglbS/d
 AtQ2cLTQ4Sxu/BDQdkbuoiKUn9hLTSI=
Received: from mx-prod-mc-02.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-259-L81n2H4DM2GOCck79-Yayg-1; Wed,
 18 Jun 2025 05:40:44 -0400
X-MC-Unique: L81n2H4DM2GOCck79-Yayg-1
X-Mimecast-MFC-AGG-ID: L81n2H4DM2GOCck79-Yayg_1750239642
Received: from mx-prod-int-04.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 3FF821956089; Wed, 18 Jun 2025 09:40:42 +0000 (UTC)
Received: from hydra.redhat.com (unknown [10.45.225.137])
 by mx-prod-int-04.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id 5438319560A3; Wed, 18 Jun 2025 09:40:36 +0000 (UTC)
...
Subject: [PATCH v10 02/10] drm/i915/fbdev: Add intel_fbdev_get_map()
Date: Wed, 18 Jun 2025 11:31:20 +0200
Message-ID: <20250618094011.238154-3-jfalempe@redhat.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B665A4C6F4E
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Feb 2022 15:26:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 65A1B10E61B;
...
Subject: [Intel-gfx] [PATCH 4/6] drivers: remove unnecessary use of list
 iterator variable

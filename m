...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2817C63B5ED
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Nov 2022 00:31:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D231D10E352;
	Mon, 28 Nov 2022 23:30:42 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 5/5] drm/i915/mtl: Hold forcewake and MCR

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9ED20854880
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Feb 2024 12:36:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 31B5810E303;
	Wed, 14 Feb 2024 11:36:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RTQfMa63";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1A02410E16B
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Feb 2024 11:36:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1707910605; x=1739446605;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=Ajk19LEq7P+yE/spdzH8ox9Gfx2Wcw+X9KU/CZvKFaY=;
 b=RTQfMa63jJupilo7348yAjtA0zf90f0tH8z7Gq7c8rNnYg5CMoKu79M0
 FlgA6DRfkL4Uq2huadgQzS9spx46H47Vbh/BFiTvF4ix3Zof+1Xm4F0OE
 jbw376sTnLtC7fNaHFY3fJL4ZoObX9/ztJS/YH/9BvAjxN/bsqeZAfqYk
 jMqfAYXdEP7evgbZDTJ4pCTgIKfFCLGH8dexw7s3lmhU5WQ2/J6sOJPpV
 XYzRKjWi8kJkc4DG2T1JPefVUxyWGAmVCGOcnQKTnSWxcsnYgk1O9c6Cy
 6ZDHuiMnZ1/grNcNIz3bT4z9osKgVk5c1oOc6ETU4U5q0psf3i0pwsrxB g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10982"; a="27396336"
X-IronPort-AV: E=Sophos;i="6.06,159,1705392000"; d="scan'208";a="27396336"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Feb 2024 03:36:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,159,1705392000"; 
   d="scan'208";a="7743037"
Received: from kwszolek-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.63.190])
 by fmviesa003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Feb 2024 03:36:40 -0800
...
Subject: RE: [RFC 3/4] drm/i915/dp: use link rate and lane count in intel_dp
 struct
In-Reply-To: <IA0PR11MB7307ABD8E940873FF0A01685BA4E2@IA0PR11MB7307.namprd11.prod.outlook.com>
...
Date: Wed, 14 Feb 2024 13:36:36 +0200
Message-ID: <87frxv6zwb.fsf@intel.com>
MIME-Version: 1.0

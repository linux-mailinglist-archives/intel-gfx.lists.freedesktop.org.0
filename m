...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D63AE97A351
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Sep 2024 15:57:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 544E410E331;
	Mon, 16 Sep 2024 13:57:27 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="BSIYzuOw";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B96F710E331;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 QZzQx1QBZERNuNGpVc+cUCS/htBFI9apf0a30JtGk6fxa3fFz8MBzRDgM w==;
X-CSE-ConnectionGUID: OUtrVWsiQTGuL9GILBrQ4A==
X-CSE-MsgGUID: QiucEUywT66nSrXZPiqekw==
X-IronPort-AV: E=McAfee;i="6700,10204,11197"; a="36666760"
X-IronPort-AV: E=Sophos;i="6.10,233,1719903600"; d="scan'208";a="36666760"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Sep 2024 06:57:26 -0700
X-CSE-ConnectionGUID: 8rFvBAisQHyRLlMS4ifOPg==
X-CSE-MsgGUID: F63mo3PfQhOn9+q/J4uBWg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,233,1719903600"; d="scan'208";a="68837268"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Sep 2024 06:57:22 -0700

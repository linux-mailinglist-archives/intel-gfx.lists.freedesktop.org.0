...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1C30439989
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Oct 2021 17:02:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C73C489ACC;
	Mon, 25 Oct 2021 15:02:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x829.google.com (mail-qt1-x829.google.com
 [IPv6:2607:f8b0:4864:20::829])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B216B89A5D;
 Mon, 25 Oct 2021 15:02:29 +0000 (UTC)
Received: by mail-qt1-x829.google.com with SMTP id w2so10580898qtn.0;
 Mon, 25 Oct 2021 08:02:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=IIW9FbxR8lT9oXtS8TL9x1GWhrc2gaK5mV0KPz+OYJI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=IIW9FbxR8lT9oXtS8TL9x1GWhrc2gaK5mV0KPz+OYJI=;
 b=
X-Gm-Message-State: AOAM5324oTlRvqgmp3zxMxk1A+6gYWlvdwchmUtIUmmJEBZjnU1e9+Ju
 yC9DaU2HDcJ3HUw1EK1yK4IEt93caXOSsBCVuDzcAicssi8=
X-Google-Smtp-Source: ABdhPJy8UktjecMTghpPkVthWVb6hGmiuw2aSfXwMVny1AvqtPtF9hsobuHRoh63RlauKN43HGGPTTJD4Zh/KrGqT70=
X-Received: by 2002:ac8:7f52:: with SMTP id g18mr18131344qtk.196.1635174148387; 
 Mon, 25 Oct 2021 08:02:28 -0700 (PDT)
MIME-Version: 1.0
References: <20211021103605.735002-1-maarten.lankhorst@linux.intel.com>
 <20211021103605.735002-28-maarten.lankhorst@linux.intel.com>
In-Reply-To: <20211021103605.735002-28-maarten.lankhorst@linux.intel.com>
From: Matthew Auld <matthew.william.auld@gmail.com>
Date: Mon, 25 Oct 2021 16:02:00 +0100
Message-ID: <CAM0jSHNJsgP4_8b_5nsncjZ69smjizzUCm7u82xdbseRARvJDA@mail.gmail.com>
To: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
Cc: Intel Graphics Development <intel-gfx@lists.freedesktop.org>, 
 ML dri-devel <dri-devel@lists.freedesktop.org>
Content-Type: text/plain; charset="UTF-8"
Subject: Re: [Intel-gfx] [PATCH 28/28] drm/i915: Remove short-term pins from
 execbuf, v4.

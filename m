...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2588611028B
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 17:39:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46D0A6E9F7;
...
Subject: [Intel-gfx] [PATCH v3 04/12] video: fbdev: uvesafb: modify the

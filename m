...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 137C964EE5E
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Dec 2022 17:01:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A0AF10E5EE;
...
Subject: [Intel-gfx] [PATCH v6 04/12] drm/edid: merge ELD handling to
 update_display_info()

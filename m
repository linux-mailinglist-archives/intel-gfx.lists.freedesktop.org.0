...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE915368D2D
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Apr 2021 08:25:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 036C96EB43;
...
Subject: Re: [Intel-gfx] [PATCH v4] drm/doc/rfc: i915 DG1 uAPI

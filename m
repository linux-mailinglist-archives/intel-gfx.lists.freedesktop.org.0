...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 11CD2757E6C
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 15:56:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D834E10E365;
	Tue, 18 Jul 2023 13:56:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BAD0510E34C;
 Tue, 18 Jul 2023 13:55:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689688556; x=1721224556;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=9aWbJMv4eIbjmWozjpBiUlpb0XzIi2U7UEGv7aeoPoE=;
 b=WONd7mGB+YEf5CwzO/ZTke0jB5MgawuwsDyBa+UGuL5LoK6mQjuHcb5a
 WTTd2LjK6h4TgfVFGqnmZtVGAof6NDOH5KqONCPxC6PVBUmJJFdg8JMFM
 zIch1UUABvzm1t8172zHdqi+28KjLzR9M8/NEpz/MV7w0TMzI4W+DSE+s
 DaOXc1Gn1sbloIwh2k29GTWt7CURniV7PGOjOV9YcP//0ZqVEGEMGcHOA
 Gm3RciJlumMCcRFLlOcojhAhxwAK3GSpJ7imItIyPWdq86cFdgMJmZrEr
 QA+0zdtJgirNE9+KC493Txl7vZE0T3MHZfwBg3/+CZHk/MYoLdm4aJ6dB w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="452590578"
X-IronPort-AV: E=Sophos;i="6.01,214,1684825200"; d="scan'208";a="452590578"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Jul 2023 06:55:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="970250948"
X-IronPort-AV: E=Sophos;i="6.01,214,1684825200"; d="scan'208";a="970250948"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga006.fm.intel.com with ESMTP; 18 Jul 2023 06:55:55 -0700
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Tue, 18 Jul 2023 06:55:29 -0700
Message-Id: <20230718135551.6592-5-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230718135551.6592-1-yi.l.liu@intel.com>
References: <20230718135551.6592-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v15 04/26] kvm/vfio: Prepare for accepting vfio
 device fd

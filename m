...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SDs8NiLyFWp7fQcAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 26 May 2026 21:18:58 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DF975DBE7C
	for <lists+intel-gfx@lfdr.de>; Tue, 26 May 2026 21:18:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 955C410E536;
	Tue, 26 May 2026 19:18:56 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="hMeXts/R";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4EE9510E536;
 Tue, 26 May 2026 19:18:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1779823135; x=1811359135;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=OVtJifa0+KDX7ogA8pjB+t+51zrz9rxPDdWGmcWFBGs=;
 b=hMeXts/R48LBBz+YkvteUGpSJCkSO2oevBvkynMEU4TVt5UmHyfwT1vC
 /eYkvcvdIqfS9gmWCDocq+1QwIUwZwia3vuk3wcK9p2TvvWuUyvfBKKfI
 6L7uiTkHYGZ+umptjvS/YfULimlFHbCn5l2KGNpwi9o4uot6adYKtetWa
 nVLrkQ/+MAC8wR6bQBLz8h+bc2raK35NX5qYXnt6a5OJMH4f+QSyhM2oz
 tuUFNxAu6AjxSWE0+yPn12XLX27Qg8Tiw9iz8P3rE8M4gFeelCSEv1f5V
 8c6sLy3U7d0GVa8/hLU1awT6rSTbFfO9eTZcUzobZrl8Ev/SqyIDh245x Q==;
X-CSE-ConnectionGUID: lvoRJSVBSXe5cdU/4ayttQ==
X-CSE-MsgGUID: Gg4NZiXaQb6sf7qgGUTIIA==
X-IronPort-AV: E=McAfee;i="6800,10657,11798"; a="83226278"
X-IronPort-AV: E=Sophos;i="6.24,170,1774335600"; d="scan'208";a="83226278"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2026 12:18:55 -0700
X-CSE-ConnectionGUID: HElzSTG8Ttu+9henMcLgMA==
X-CSE-MsgGUID: dIH4EU8VTjWwddGuIVBsyA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.24,170,1774335600"; d="scan'208";a="237841838"
...
Date: Wed, 27 May 2026 00:48:14 +0530
Message-ID: <20260526191826.3786009-2-dibin.moolakadan.subrahmanian@intel.com>
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,intel.com:email,intel.com:mid,intel.com:dkim,dc3co_work.work:url]
X-Rspamd-Queue-Id: 4DF975DBE7C

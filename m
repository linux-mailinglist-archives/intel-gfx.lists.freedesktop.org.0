...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A1404065FF
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 05:18:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29FF56E96B;
	Fri, 10 Sep 2021 03:18:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [205.139.111.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F34976E96B
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Sep 2021 03:18:25 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-416-8dVKaiceNhO_Ko6y6LT7xw-1; Thu, 09 Sep 2021 23:18:23 -0400
X-MC-Unique: 8dVKaiceNhO_Ko6y6LT7xw-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id EB5FA801A92;
 Fri, 10 Sep 2021 03:18:22 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 8C24A100EBC1;
 Fri, 10 Sep 2021 03:18:19 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com, Dave Airlie <airlied@redhat.com>,
 Jani Nikula <jani.nikula@intel.com>
Date: Fri, 10 Sep 2021 13:17:29 +1000
Message-Id: <20210910031741.3292388-14-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 13/25] drm/i915: split irq hotplug function from
 display vtable

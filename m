...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DAF237CCA80
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Oct 2023 20:18:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9143010E312;
	Tue, 17 Oct 2023 18:18:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7430710E312
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=l2d+vQa/g4L8icC+nrxIpu/9vWFvWOCq+L1ZasMmZ+s=;
 b=Z6l+j3aehKeZ9MHJ/g/FUlNLBLbLffFbLtnif9thXDPDyhTtJyVZ064Q
 B+wayDuoIcuum9imhWYMNgRRSiOKFApC0OIheuJDZzD4xl7ppftICuiaz
 8YkmemTEXn21RZhaOA5vidmfSxM40E018bOicrLYyRy09UtqEmlmWOFpI
 w/vI9UM1UcrkL08TQRZ4fqKxPtDLj0dCaOWv9tDRVWC6qFjnxlwOZJV8l
 Ilj0EyH/yYPvmT6zOXDBnf3cfKT2SJMOjiNK63z9O6EiAdYAJ8NwdjXuX
 x7BwKTxQQs9qpfwUED/kHENc6CuTNQbXyGZcvc3EgnNSxi+a51faGPq3R Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10866"; a="472078880"
X-IronPort-AV: E=Sophos;i="6.03,232,1694761200"; d="scan'208";a="472078880"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Oct 2023 11:18:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.03,232,1694761200"; 
   d="scan'208";a="4037622"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Oct 2023 11:17:43 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 17 Oct 2023 11:07:59 -0700
Message-Id: <20231017180806.3054290-1-jonathan.cavitt@intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v17 0/7] drm/i915: Define and use GuC and CTB

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F02D63919A7
	for <lists+intel-gfx@lfdr.de>; Wed, 26 May 2021 16:15:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 411C56ED16;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 00/12] Catchup with a few dropped patches

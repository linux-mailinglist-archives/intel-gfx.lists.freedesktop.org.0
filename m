...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D1EE27A0EAB
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Sep 2023 22:04:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC06E10E0D7;
	Thu, 14 Sep 2023 20:04:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 96A7510E2B2
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=y4nodO5GXsC3crFlxCBlRxcV5CWZ8eEOudPp9tJx+mE=;
 b=JUhsmsDVntMzXYLzdKt14rih2JjAJP+5e2NRz1BjQ2cZFI6XGWwP1orA
 e6IigVDGgrjL6CQ17YY/GlAP+kGxXoVBDYApgQCNavl5K/P0DP/KJdMde
 CXXTsLeyjvEiFYfe36m5eGR6/ytuBKf2CIwxswyTB/MKePcyotFw8cOUO
 uzRZiUqilMCYnTcPl3TtiJa0XYW53KqTHg53G1ZbL/SyAe+/cYT8vz8AX
 C/1IXBSyfsS3xKoKILo15tDRFPFOc3lZTkFg9JxFbC2C0IEOR3K65Z/1i
 TJNeZqRt8z56paUbCIx07B/TsY3xUiIueiTz87qOxqgXzLNxXHgM41cjW Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10833"; a="364109011"
X-IronPort-AV: E=Sophos;i="6.02,146,1688454000"; d="scan'208";a="364109011"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2023 13:04:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10833"; a="744671018"
X-IronPort-AV: E=Sophos;i="6.02,146,1688454000"; d="scan'208";a="744671018"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2023 13:04:16 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 14 Sep 2023 12:53:34 -0700
Message-Id: <20230914195335.2607636-3-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 2/3] drm/i915: Add WABB blit for

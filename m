...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3820414430B
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Jan 2020 18:20:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28AC26EE02;
	Tue, 21 Jan 2020 17:20:41 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 4/5] drm/i915/bw: convert to drm_device based
 logging macros

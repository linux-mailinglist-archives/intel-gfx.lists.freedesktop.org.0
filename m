...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 104D657B330
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 10:45:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D46F11AF67;
...
Subject: Re: [Intel-gfx] [PATCH 4/4] drm/ttm: Switch to using the new
 intersect callback

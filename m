...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 36CC766B58
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Jul 2019 13:06:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E49556E351;
...
Subject: Re: [Intel-gfx] [PATCH v4 01/23] drm: Include ddc adapter pointer
...
Cc: Thomas Gleixner <>, "Y.C. Chen" <yc_chen@aspeedtech.com>,
 ...
 Dave Airlie <airlied@redhat.com>, Philipp Zabel <p.zabel@pengutronix.de>,
 Jonas Karlman <jonas@kwiboo.se>, Sascha Hauer <s.hauer@pengutronix.de>,
 Inki Dae <inki.dae@samsung.com>, Jyri Sarha <jsarha@ti.com>,

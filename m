...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 68765437192
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Oct 2021 08:12:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD5BA89B78;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/selftests: Update live.evict to
 wait on requests / idle GPU after each loop

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DC68617C01B
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 15:22:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 259E16ED31;
	Fri,  6 Mar 2020 14:22:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6172F6ED31
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Mar 2020 14:22:22 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 06 Mar 2020 06:22:21 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,522,1574150400"; d="scan'208";a="287983544"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by FMSMGA003.fm.intel.com with SMTP; 06 Mar 2020 06:22:19 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 06 Mar 2020 16:22:18 +0200
Date: Fri, 6 Mar 2020 16:22:18 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Souza, Jose" <jose.souza@intel.com>
Message-ID: <20200306142218.GR13686@intel.com>
References: <20200219014230.145601-1-jose.souza@intel.com>
 ...
 <b56518c3ca01b6bd07ee8a9c8a64e6ec924e3b1c.camel@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <b56518c3ca01b6bd07ee8a9c8a64e6ec924e3b1c.camel@intel.com>
...
> On Wed, 2020-02-19 at 20:52 +0200, Ville Syrj=E4l=E4 wrote:
...
> > > > > transcoder: <invalid>
> > > > > i915 0000:00:02.0: [drm:intel_dump_pipe_config [i915]]
> > > > > [PLANE:31:plane 1A] fb: [FB:262] 1920x1080 format =3D XR24
> > > > > little-
...
> crtc_state->enable_fbc=3Dtrue is backed by intel_fbc_can_enable() and
> later we have:
> intel_update_crtc()
> 	...

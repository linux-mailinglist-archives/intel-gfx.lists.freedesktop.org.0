...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qH+mIvxF/Gn9NgAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 07 May 2026 09:57:48 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D41654E4554
	for <lists+intel-gfx@lfdr.de>; Thu, 07 May 2026 09:57:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 267D010EFC2;
	Thu,  7 May 2026 07:57:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="AEwZFj+A";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="M5U34HeF";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="AEwZFj+A";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="M5U34HeF";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C72FB10EFC2
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 May 2026 07:57:44 +0000 (UTC)
Received: from imap1.dmz-prg2.suse.org (unknown [10.150.64.97])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-out2.suse.de (Postfix) with ESMTPS id 47D605D5F9;
 Thu,  7 May 2026 07:57:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1778140653; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=eNeCPQUsEYNlHViXBqpQr0SoCiWvkrKBErHUHG2/hRw=;
 b=AEwZFj+A0n4o6nx3y5iv1YNTfTOqauiE/9f6v+G5IkN+jdHBusaYvOFMfgAeZuIAzv0Aqx
 B1s3JM/lagWjHiOOnbxFO0QrQOR2W36cHH9HwxPDcpD21mBQPyUYaQKBcZpiIKeYi7LwQx
 LRD1U3FbNOMiY44cymGvnRy5BHEi0cM=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 s=susede2_ed25519; t=1778140653;
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=eNeCPQUsEYNlHViXBqpQr0SoCiWvkrKBErHUHG2/hRw=;
 b=M5U34HeFpaRO8kXSFw8+fn/VctSL90Jf31u6laEk7tkjOKrdPw0NE3A5tEipfvreCKMsJL
 CWrWvx3B7zkacWCw==
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id C6AB8593A7;
 Thu,  7 May 2026 07:57:32 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id CDgOL+xF/GnZJAAAD6G6ig
...
Subject: [PATCH 06/10] drm/damage-helper: Remove old state from
 drm_atomic_helper_damage_iter_init()
Date: Thu,  7 May 2026 09:12:25 +0200
Message-ID: <20260507075725.29738-7-tzimmermann@suse.de>
...
index 91b83ec00e9c..4500aef841fd 100644
...
index ba169d48c25f..42a6e645afaf 100644
...
index 495804e1d200..a8debba0d2e6 100644
...
index 7978f8c8108c..67aca026f13e 100644
...
index bd346b828773..02e7956127db 100644
...
index 5fd575d972a2..c1ccf183d9ca 100644
...
index 18fe7a28ed07..6075c0acf236 100644
...
index c77455b1834d..bc472ad54315 100644
...
index 808b1eda871a..d050cb774d9c 100644
...
index a7eba6880ba5..c954168a1715 100644
...
index 222e4ae1abbd..62b7452d83c1 100644
...
index 9ba0eab489bb..88cd6680219e 100644
...
index 1ca073a4ecb2..9ecbe073a253 100644
...
index e7bddf840a79..94cfcc2b3ea4 100644
...
index 3b18634ebd1c..e092995c3646 100644

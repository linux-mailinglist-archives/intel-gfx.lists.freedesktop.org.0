...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A42817DF351
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Nov 2023 14:11:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A21AC10E88D;
...
Subject: [Intel-gfx] [PATCH v6 7/7] drm/i915: Implement fbdev emulation as
 in-kernel client

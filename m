...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7169D1ADE76
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 15:39:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6B616EBE7;
	Fri, 17 Apr 2020 13:39:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 922F46EBE7
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Apr 2020 13:39:43 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 17 Apr 2020 15:39:20 +0200
Message-Id: <20200417133937.1980239-7-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/24] Revert "drm/i915/gem: Split eb_vma into
 its own allocation"
...
@@ -1951,15 +1928,19 @@ static int eb_move_to_gpu(struct i915_execbuffer *eb)
...
+
 	...
 	return 0;
@@ -2211,7 +2192,6 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2735,6 +2715,8 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2920,6 +2902,8 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	if (batch->private)
...
+		eb_release_vmas(&eb);
 	...
 	eb_unpin_engine(&eb);
@@ -2939,7 +2923,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2995,7 +2979,7 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 1, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3073,7 +3057,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E71E12BABD
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Dec 2019 20:26:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC24F6E046;
	Fri, 27 Dec 2019 19:26:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 550E56E046
 for <intel-gfx@lists.freedesktop.org>; Fri, 27 Dec 2019 19:26:01 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga102.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 27 Dec 2019 11:26:00 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,364,1571727600"; d="scan'208";a="250731318"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO intel.com) ([10.54.75.49])
 by fmsmga002.fm.intel.com with ESMTP; 27 Dec 2019 11:26:00 -0800
Date: Fri, 27 Dec 2019 11:27:50 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: Matt Roper <matthew.d.roper@intel.com>
Message-ID: <20191227192750.GA26435@intel.com>
References: <20191223224429.5151-1-manasi.d.navare@intel.com>
 <20191227183652.GJ2877816@mdroper-desk1.amr.corp.intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20191227183652.GJ2877816@mdroper-desk1.amr.corp.intel.com>
...
> > @@ -14304,6 +14304,118 @@ static bool intel_cpu_transcoder_needs_modese=
t(struct intel_atomic_state *state,
> >  	return false;
> >  }
> >  =
...
previously synced crtcs through new crtc state master slave assignments fro=
m previous
modeset.
...
Yes definitely can eventually make this a drm helper even though the whole =
master slave
...
> >   * @dev: drm device
> > @@ -14331,6 +14443,10 @@ static int intel_atomic_check(struct drm_devic=
e *dev,
> >  	if (ret)
> >  		goto fail;
> >  =
...
> > @@ -14378,6 +14494,13 @@ static int intel_atomic_check(struct drm_devic=
e *dev,
> >  		}
> >  	}
> >  =
...
We are setting the mode hanged to true directly in our function so yes it m=
akes
...
since our function is essentially checking modeset based on the tiled condi=
tions

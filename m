...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F2670650FDD
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:07:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 239C510E2D0;
...
Subject: [Intel-gfx] [PATCH 07/18] fbdev/clps711x-fb: Do not set struct
 fb_info.apertures

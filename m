...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FDB1876586
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Mar 2024 14:43:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D4A5010E6AD;
	Fri,  8 Mar 2024 13:43:47 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Sd+ciBi/";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D3CD10E6AD
 for <intel-gfx@lists.freedesktop.org>; Fri,  8 Mar 2024 13:43:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709905426; x=1741441426;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=Si6eDHQ0gORe4w3ibWhBZkprm1LJie1z7MrJVtPeHgU=;
 b=Sd+ciBi/FP3Djq5MRedxc1p8QWO0ppataPtwhRq8XtjCwPlM/Hzv4tZg
 M2S4Fv7pCykKDMDVEUR4/AaeDQQNjLiBzlWLuQx7ASlUDE0GC1FKalw6Z
 obvRyCD/MT1YNUK1ZaItoNNkAHaA2AccSvugRHB2jLQRuIQJunOAw6smg
 wwacr8Cdyl5BZsZ7xsboyn1wan7WQaB22k7ruo9Sevg7Cjft+AqvopnYk
 clezPeJJfsqmyh9RhpZ9jYU66mAUIygnCscaIQ/u9fywPWMfMbIXQ7v6H
 ViRfsARbH3S6r8DIFQSXhn8bOCFxB5CBVNAVPbB27U0WhCgYdM1jELQOJ g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11006"; a="16031995"
X-IronPort-AV: E=Sophos;i="6.07,109,1708416000"; d="scan'208";a="16031995"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Mar 2024 05:43:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,109,1708416000"; d="scan'208";a="10369938"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Mar 2024 05:43:44 -0800
Date: Fri, 8 Mar 2024 15:43:35 +0200
From: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Cc: intel-gfx@lists.freedesktop.org, jani.saarinen@intel.com
Subject: Re: [PATCH 2/2] drm/i915: Implement vblank synchronized MBUS join
 changes
Message-ID: <ZesWB7CpU3b9X28J@intel.com>
References: <20240228080213.17441-1-stanislav.lisovskiy@intel.com>
 <20240228080213.17441-3-stanislav.lisovskiy@intel.com>
 <ZerjV9jnlUp-GTwP@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <ZerjV9jnlUp-GTwP@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E377287963A
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Mar 2024 15:29:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6882C112E6D;
	Tue, 12 Mar 2024 14:29:43 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="MOHp2jxt";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ED215112E6E
 for <intel-gfx@lists.freedesktop.org>; Tue, 12 Mar 2024 14:29:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710253782; x=1741789782;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=z3k2AlNAUgjL2z05pPwb0HU9GOy+jCVjHyBvcCmDw6k=;
 b=MOHp2jxtGGaqwHRkXqhCbwPDYBLnKbs8WDmTGDUte7yu9VZ4rIhZfOFj
 Or/j3jK7iLh0kLOrqeGZ1ToUIfOwyfKqe9NK10S+cDRYGvImOd/c+70Us
 0AuYrhJdoU1GJhMTquf1yaEXhoxyGyqSvZt2VFuIzs4B7uEyZii+ulxiy
 Ci/wtuMygWY36ydHKxRo4vl0WwGd5/mcZUsmwKwgw4EY5MzZIWVtubT3A
 t402suQ174aM5FqiC1qvgpaq8BXie9IKaxeVGbUgjm0rqJjv7aRJMyB8q
 Wlfw6HIpIuz+e10HplyjEoaDh86mk4O6GqC4AYzPHlBC/wZXx3yQ9En1H g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="4818364"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="4818364"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 07:29:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="11612498"
Received: from rfreedx-mobl.amr.corp.intel.com (HELO localhost)
 ([10.252.35.216])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 07:29:39 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@intel.com, ville.syrjala@linux.intel.com, imre.deak@intel.com
Subject: [RFC 7/7] drm/i915/cx0: pass encoder instead of i915 and port around
Date: Tue, 12 Mar 2024 16:29:02 +0200
Message-Id: <a7f4388860c2bb2bdb4cc9f49f66085ec02a79db.1710253533.git.jani.nikula@intel.com>

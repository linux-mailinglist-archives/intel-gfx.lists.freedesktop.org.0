...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B791C51FC03
	for <lists+intel-gfx@lfdr.de>; Mon,  9 May 2022 14:04:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C03B210EE80;
	Mon,  9 May 2022 12:04:07 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 07/25] drm/edid: convert

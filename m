...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A6A8F399981
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jun 2021 06:59:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3FB1F6F3DF;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/20] drm/i915/guc: Don't repeat CTB layout
 calculations

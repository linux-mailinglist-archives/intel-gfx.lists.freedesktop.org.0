...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CCA772823A
	for <lists+intel-gfx@lfdr.de>; Thu,  8 Jun 2023 16:07:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17DF710E5CC;
	Thu,  8 Jun 2023 14:06:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 389FE10E0B1
 for <intel-gfx@lists.freedesktop.org>; Thu,  8 Jun 2023 14:06:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686233213; x=1717769213;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=KHK/FxZ/WSeFPTDrqTosuvpvsGcf/Q5GwKfMZuq+DxA=;
 b=QLXNHAHjdHaiLam26G4mlsrkHXR2NjGkyv5pQTZgy5RpcVZGXbA2oOyE
 6g5Dee0aPSOym35/Zg/NFI9upcv/JEz61MvPGdPxfQd3OuenehEKSd2ij
 2Hl5XrCZD6bLJA50+PX3lCTEd+Iafna2ysVN34dZP94WJyueYq6SbydEU
 cAIWnbhgV+iNe/77xrmUn+WQFCiiBWxct4tc7Aq/NTqUTnwiOOlfapaWA
 rKEC9f8Gp+N9k7TqxLiBsRQBxHze+oel012BzSAqVhkPfg4n1ovji6O1R
 cukDMT5My/B71RMXO6mOMOqYP+uk9oK474SWjC4hVzXNCLakkvfIRdrkB g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10734"; a="423176092"
X-IronPort-AV: E=Sophos;i="6.00,226,1681196400"; d="scan'208";a="423176092"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jun 2023 06:36:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10734"; a="660379107"
X-IronPort-AV: E=Sophos;i="6.00,226,1681196400"; d="scan'208";a="660379107"
Received: from unknown (HELO localhost) ([10.237.66.162])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jun 2023 06:36:00 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  8 Jun 2023 16:35:45 +0300
Message-Id: <c816ebe17ef08d363981942a096a586a7658a65e.1686231190.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 2/3] drm/i915: add a dedicated workqueue

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1AC511A947D
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Apr 2020 09:41:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 175F56E87B;
	Wed, 15 Apr 2020 07:40:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x434.google.com (mail-wr1-x434.google.com
 [IPv6:2a00:1450:4864:20::434])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 098E46E884
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Apr 2020 07:40:52 +0000 (UTC)
Received: by mail-wr1-x434.google.com with SMTP id x18so13583730wrq.2
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Apr 2020 00:40:51 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=Zbhj3wziim9ahiRkyNQJ93bw45CX+Cwkp+nTCWfpnZE=;
 b=VyqFipYPle08dl27CtHgYpsqMi0+tHMDkGUc5WPrVKJ6gSlyTco2uOAJyjjGPYVW9N
 Dz9TFspBDDSvNi7rrfMci6DwGr8aXPoJC4Ffk0VfDaCf/3x93S+BEm16CKeMFOtpXofk
 cm/Tc7t5mUSPjISE9ijXgG36JmwxSuNWclFiI=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=Zbhj3wziim9ahiRkyNQJ93bw45CX+Cwkp+nTCWfpnZE=;
 b=
X-Gm-Message-State: AGi0PuYHXBFmCKeJmp16m7AYDu8//KAfT8UMNqbyQGEPrVBL+orJlMNl
 cgIBppOEvTc99YMkwQXlGPqtMXHgtIA=
X-Google-Smtp-Source: APiQypLE24LF0MZ/cldBX+9xVnZmDf9bdBN32vE3E9zP1TBFN9ZocnhUXbP087YeCe02QLn5YWNUGw==
X-Received: by 2002:adf:fe03:: with SMTP id n3mr26844036wrr.315.1586936449965; 
 Wed, 15 Apr 2020 00:40:49 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id u30sm1878552wru.13.2020.04.15.00.40.49
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 15 Apr 2020 00:40:49 -0700 (PDT)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: Intel Graphics Development <intel-gfx@lists.freedesktop.org>
Date: Wed, 15 Apr 2020 09:39:44 +0200
Message-Id: <20200415074034.175360-10-daniel.vetter@ffwll.ch>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20200415074034.175360-1-daniel.vetter@ffwll.ch>
References: <20200415074034.175360-1-daniel.vetter@ffwll.ch>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/59] drm/v3d: Delete v3d_dev->dev

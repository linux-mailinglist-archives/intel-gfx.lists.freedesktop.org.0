...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6056D42C63D
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 18:24:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 987D66EA78;
...
Subject: [Intel-gfx] [PATCH v3] component: do not leave master devres group
 open after bind

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF477A167B0
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2025 08:53:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E84710E34A;
	Mon, 20 Jan 2025 07:53:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="dLrncdVW";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6B9DD10E356
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Jan 2025 07:53:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1737359629; x=1768895629;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=vj7O+j0ALgctUFPtvuo/1cmVyn/m8o3xJhBcYnBpyw8=;
 b=dLrncdVWyT4QSECHqBrEvTNcz4U7o9vG1NHIl1kZjCju2TZShnBTOgxT
 67WEv6zCDbYpSW8NyEsYaWsnx9DxjR1eM/g8Kj6bDHoODqGo33yzK+45w
 +4KgDHXNN7w+NTEaXIOxVVNYbRAOLI2rsV4Vd6q7NwVDCkSlKJaU2j8Wc
 GaHtKwk6a9jbZDy3+ffVtIn9CnEsGY1CmwgQ2S34SUo49Vkw0H3GneBYv
 KShqdlx5LHZtMuxR+JeVBjJo7Uw5qA3SzwgSWhj3blw047+UjYOlcgCNu
 puINKYyZ6fWeaLpTLARb7hqML39m5cgjWYTgy8Fj2PGIcT8GfWSA2wpJ7 w==;
X-CSE-ConnectionGUID: nxu2dfIOQlyKgveTB5v+vg==
X-CSE-MsgGUID: E6sQNZynRvi7Rv+7UkoX0A==
X-IronPort-AV: E=McAfee;i="6700,10204,11320"; a="25325792"
X-IronPort-AV: E=Sophos;i="6.13,218,1732608000"; d="scan'208";a="25325792"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2025 23:53:49 -0800
X-CSE-ConnectionGUID: sIG8lw2mR7ihCMJLGsp97g==
X-CSE-MsgGUID: qBdmduf+TlaFtvd69ADh/g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="137317985"
Received: from nitin-super-server.iind.intel.com ([10.145.169.70])
 by fmviesa001.fm.intel.com with ESMTP; 19 Jan 2025 23:53:46 -0800
...
Subject: [PATCH v4 3/8] drm/i915/gem: fix typos in i915/gem files
Date: Mon, 20 Jan 2025 13:45:12 +0530
Message-Id: <20250120081517.3237326-4-nitin.r.gote@intel.com>

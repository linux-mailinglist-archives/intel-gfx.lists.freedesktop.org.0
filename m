...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F20632CEF40
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Dec 2020 15:03:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CABD6E195;
	Fri,  4 Dec 2020 14:03:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DB9C46E17E
 for <intel-gfx@lists.freedesktop.org>; Fri,  4 Dec 2020 14:03:32 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23215314-1500050 
 for multiple; Fri, 04 Dec 2020 14:03:19 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  4 Dec 2020 14:02:57 +0000
Message-Id: <20201204140315.24341-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/24] drm/i915/gt: Replace direct submit with
...
index 0c7f1e3dee5c..c8c0493cb0b1 100644
...
+
 ...
 {
@@ -2776,16 +2783,6 @@ static void process_csb(struct intel_engine_cs *engine)
...
-
 ...
 {
 	LIST_HEAD(list);
@@ -3177,7 +3174,7 @@ static bool preempt_timeout(const struct intel_engine_cs *const engine)
 	if (!timer_expired(t))
 		return false;
...
+	return engine->execlists.pending[0];
 ...
 /*
@@ -3187,10 +3184,14 @@ static bool preempt_timeout(const struct intel_engine_cs *const engine)
...
@@ -3199,6 +3200,8 @@ static void execlists_submission_tasklet(unsigned long data)
...
@@ -3206,19 +3209,8 @@ static void execlists_submission_tasklet(unsigned long data)
...
@@ -3249,26 +3241,16 @@ static void queue_request(struct intel_engine_cs *engine,
...
@@ -3278,25 +3260,11 @@ static bool ancestor_on_hold(const struct intel_engine_cs *engine,
...
@@ -3310,7 +3278,8 @@ static void execlists_submit_request(struct i915_request *request)
...
+			__execlists_kick(&engine->execlists);
 	...
 	spin_unlock_irqrestore(&engine->active.lock, flags);
@@ -4224,7 +4193,6 @@ static int execlists_resume(struct intel_engine_cs *engine)
...
@@ -4241,10 +4209,6 @@ static void execlists_reset_prepare(struct intel_engine_cs *engine)
...
@@ -4489,12 +4453,12 @@ static void execlists_reset_finish(struct intel_engine_cs *engine)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E72B22AB67
	for <lists+intel-gfx@lfdr.de>; Sun, 26 May 2019 19:35:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1170489395;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 aKoA==
Subject: [Intel-gfx] [PATCH v2 1/7] drm: make drm/drm_auth.h self contained

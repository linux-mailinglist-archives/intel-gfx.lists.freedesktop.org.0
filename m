...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2C7634D164
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Mar 2021 15:37:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE5B96E420;
	Mon, 29 Mar 2021 13:37:53 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 4/8] drm/edid: use the new displayid iterator
 for detailed modes

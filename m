...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59FD761F53B
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Nov 2022 15:17:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20C9410E328;
...
Subject: [Intel-gfx] [PATCH v7 02/23] drm/connector: Rename legacy TV
 property

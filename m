...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 57696700324
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 10:59:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BCCD10E643;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/pmu: Turn off the timer to sample

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59D5D6544A6
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Dec 2022 16:55:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0F16910E0E3;
	Thu, 22 Dec 2022 15:55:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B4FE810E0E3;
 Thu, 22 Dec 2022 15:55:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671724548; x=1703260548;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=pVU+thcA+rbXoRjbEic1/h3A9qU9YbTUDaoEaLfmlNU=;
 b=kSI05LkUwDEAhV83+325+OnuoWURlsMgeGJN5kzc2pQkq0JF5uDEvP7x
 ZFpn0dtfHMqke44AyI28oz2N9AfOIwdOPMBcRdrk1HXvaHwY5jZrbiDwc
 D+0SGZWwwxDWYduGG3M/ookO+ioj0/PrvFzIZniFPVJAV4m3PToPgeJYF
 BvS3oA/3q67CBhemVZ7JGXbql9DV0CibM5N3t9pCmpHOASyoSJMXN3MsE
 Bt5l4vXTEy10UDEQ7XrU6gQzALTAJUxPM7x2rebQBxFqJBLZ5c9hlpT6N
 jEZjTPU6feyUeVpFt3tA2/seH29EFVtI2X6+mjfa+TVPPLcxc/Fj7mN4c w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10569"; a="322065726"
X-IronPort-AV: E=Sophos;i="5.96,265,1665471600"; d="scan'208";a="322065726"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2022 07:55:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10569"; a="826004243"
X-IronPort-AV: E=Sophos;i="5.96,265,1665471600"; d="scan'208";a="826004243"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
 by orsmga005.jf.intel.com with ESMTP; 22 Dec 2022 07:55:47 -0800
Received: from fmsmsx611.amr.corp.intel.com (10.18.126.91) by
 fmsmsx602.amr.corp.intel.com (10.18.126.82) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.16; Thu, 22 Dec 2022 07:55:47 -0800
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 fmsmsx611.amr.corp.intel.com (10.18.126.91) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.16; Thu, 22 Dec 2022 07:55:46 -0800
Received: from fmsedg601.ED.cps.intel.com (10.1.192.135) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.16 via Frontend Transport; Thu, 22 Dec 2022 07:55:46 -0800
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (104.47.55.170)
 by edgegateway.intel.com (192.55.55.70) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.16; Thu, 22 Dec 2022 07:55:46 -0800
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=wwKflflxEx8PERQDYsxfaK7ebmWVVYSOVQELZXlpVwo=;
 b=
...
Received: from CY5PR11MB6139.namprd11.prod.outlook.com
 ...
 15:55:38 +0000
Date: Thu, 22 Dec 2022 07:55:35 -0800
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Message-ID: <20221222155535.gmih2rurxlo2xuo5@ldmartin-desk2.lan>
...
In-Reply-To: <2cfeee8a-7b7e-c203-37b4-f7a502123a5a@linux.intel.com>
X-ClientProxiedBy: BYAPR06CA0027.namprd06.prod.outlook.com
 (2603:10b6:a03:d4::40) To CY5PR11MB6139.namprd11.prod.outlook.com
 (2603:10b6:930:29::17)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: CY5PR11MB6139:EE_|IA1PR11MB7199:EE_
X-MS-Office365-Filtering-Correlation-Id: a9fc7124-c1ad-427e-90e8-08dae434f81a
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:CY5PR11MB6139.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230022)(346002)(136003)(376002)(366004)(39860400002)(396003)(451199015)(1076003)(19627235002)(5660300002)(86362001)(6512007)(186003)(26005)(9686003)(36756003)(478600001)(30864003)(6486002)(316002)(83380400001)(54906003)(6916009)(66574015)(6506007)(38100700002)(66946007)(82960400001)(66476007)(66556008)(8936002)(2906002)(4326008)(41300700001)(8676002)(6666004)(21314003)(559001)(579004);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?dWPbmVs7TQO2j03sQ9A0jZDnSH8JRuM7PyYw0Q56TvO6rbd0fPrf1TD/Xu0M?=
 =?us-ascii?Q?WM3Nkh13OBs+Nk6jKoHfdX0KQ2wlfOrT6x8cFmtSIZLuDGWzAJzXUnjDqP5k?=
 =?us-ascii?Q?oSCaYy7Gc/JxaZgzSJjQ5BGRdGxFrApVBtg2tbm6kA8RMjwObPFbZu0Unis2?=
 =?us-ascii?Q?yy3uNops4cNCu7bvXTUR0tSSFUNTOUMYpX+IY2zybk+72e26tcvLlIVbEPiu?=
 =?us-ascii?Q?ssHhwJJjatjYXgShAqWGFKPxK4VWa71Ol9K1/ejRQGmDSLKq7jErlSkM9r04?=
 =?us-ascii?Q?OO0ioXsfH6WO2IJATofbtThlFK8cD9Z6T6xlQSmriFqsczkewQ7yc0PrXbgY?=
 =?us-ascii?Q?cXzNJzyCgsnOGCbWkLUVAFHD+Ig05+Fc8KdXxQy5TIprPYys3vQu/TdBlRR7?=
 =?us-ascii?Q?U8bVxxMKMvF44MKiJR94H7gtM23KkNbFJ7inhJrA0u6YUo3kMLjfhhGEKTbg?=
 =?us-ascii?Q?YIc6Vw1jyoyKhsadhFEM/DZogVrSJ/mTZBDnegAJjcXvfNYr85Dxgt6kn4ue?=
 =?us-ascii?Q?qToX/32rpVdGvR4wzjhPUSKMCUNCaPiW3i1O529uVowxJEVA8Wmc0ZA/mkfx?=
 =?us-ascii?Q?3ZGUaRVNlDrrPkiQUAxJfKhT59g1zC1p8S2ItAZEii143w2PdcQdPHaEqR2O?=
 =?us-ascii?Q?oysDD7wswB/4eP0rkDcOO/496hdMOn6N1/cNPyAU7upPWcMnPj25JEFlkvoF?=
 =?us-ascii?Q?yWNNuatS2R9VwfRiGc5p07/I/4uyAy+srT9rx3PFiXFWEzKSunspwi2aY+aQ?=
 =?us-ascii?Q?OG82gdYD3Hng8gwTrn+lQt5e0HjeYR3RSYhOrze1ITbvkNMOX9SDI43gwmIu?=
 =?us-ascii?Q?pTrAp45Wj15Bs2+o+dW4wqPnm+pHo6nRFkmSkPuFrrbJExAYHuDTDFzaMPsb?=
 =?us-ascii?Q?q9mxWD2oOdKX+8hC2+Fg3Kh+gnRyxrPyhR5BtgP/Xnz7BDullmm+HrPSBkUw?=
 =?us-ascii?Q?gXArOBwEzu27k4ieRrZkMUa57sjo3r1jNhtTAyY6HFHscnzTyn/kwbWRN9bx?=
 =?us-ascii?Q?gL4OjmwgjhXAmeEkZbPR5oZNsVSNzB7OCaw9urHuK3Oovo7ZJM85Wq/PzGWO?=
 =?us-ascii?Q?ym3DZc/TwMj4DRv2EO9XdHq9MSstvHtRBpMb59OMH0GH0tgs8I277dXa57BP?=
 =?us-ascii?Q?iUVYjZzO7haBg4dWZvJZoSNg7gmI5/jg33sdK+o/oTlz9IJvSsIwcsjGV8fV?=
 =?us-ascii?Q?2a+fonZNqgShkU03BJjLR5NwvaLYH3YAtp5X9TP20EYSDwWMBwRY891bqVfh?=
 =?us-ascii?Q?snntTrnC2oYYGnVVylxdLHjGJJOMkjt3CEDtaqRS5GPEavA93+wvWDnUCa8I?=
 =?us-ascii?Q?JNJdLAKk60ta9zYP70og/XFFrqMDVk50JqJe6p71BLec+IxhU6U9SXyE7fx7?=
 =?us-ascii?Q?7QCKm+doqlNZ9oOVDuyGYGfyBmVFxDhKEtR6l5YGhX/xYnB2t62XYTzOJPkf?=
 =?us-ascii?Q?OsouKhuk9QqnJ3kbqJluYOYMUsp8WceSwpvIc9od48aw0N90Vvbibz8JDHF2?=
 =?us-ascii?Q?l+CuxonPTvgdWCfrybEl92A5Fakj9qQX7gAwSDtN+D8rggMu6EIzZNhV4Eip?=
 =?us-ascii?Q?JBQwOeXBgM99aUCmotT1N1elpdKMkkG2jz4gdmlhAQngNk5ZyQWD1g/kZJaK?=
 =?us-ascii?Q?6Q=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: a9fc7124-c1ad-427e-90e8-08dae434f81a
X-MS-Exchange-CrossTenant-AuthSource: CY5PR11MB6139.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Dec 2022 15:55:38.1080 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: mSVk+mmCa0CpKkRGXedZjrJ4DYHzBbt0HtIPnUf9BL/kRRb1/O5iQKyKNL+3Vvb4YuoZooCscweFUwfwi4pzzJ7n8sicAsISmezPDLuDV7k=

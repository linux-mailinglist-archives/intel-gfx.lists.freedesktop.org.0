...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C673577BC0
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:41:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82DD9A9E06;
...
Subject: [Intel-gfx] [PATCH v3 33/39] dyndbg/drm: POC add tracebits
 sysfs-knob

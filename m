...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 420BB3C9517
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jul 2021 02:21:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC10D6E52C;
...
Subject: [Intel-gfx] [PATCH 08/13] vfio/pci: Change vfio_pci_try_bus_reset()
 to use the dev_set

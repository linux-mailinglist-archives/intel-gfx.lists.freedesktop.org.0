...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1119A60A660
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Oct 2022 14:34:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3B5110E4E3;
...
Subject: [Intel-gfx] [PATCH v2 08/16] drm/edid: add function for checking
 drm_edid validity

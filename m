...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 27ADF2AFD7F
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Nov 2020 03:37:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 319816E0F2;
	Thu, 12 Nov 2020 02:37:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E55796E0CC
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 Nov 2020 02:37:41 +0000 (UTC)
IronPort-SDR: CLi/42YSynSRqdNjQL1AepzskK8K1a+b+7T+Vk6QKDrtFdYk8aYHx5bSmfTCoPfBgqvpSYLerc
 dB9VretqisvA==
X-IronPort-AV: E=McAfee;i="6000,8403,9802"; a="188239727"
X-IronPort-AV: E=Sophos;i="5.77,471,1596524400"; d="scan'208";a="188239727"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2020 18:37:40 -0800
IronPort-SDR: ciLl5zhe1VXkWzsBUK3nWUZnZhtjsLv7lVKrg4GexLR0YkVpZz8/zPhcCyoJpQ9XuLydnF17hc
 C6WGsu7B5YhA==
X-IronPort-AV: E=Sophos;i="5.77,471,1596524400"; d="scan'208";a="323474503"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 11 Nov 2020 18:37:40 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 11 Nov 2020 18:39:54 -0800
Message-Id: <20201112023954.12301-6-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI v10 6/6] drm/i915/dp: Allow big joiner modes in
...
index 2e8c32700963..ff8d10ef1ff0 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -17701,7 +17701,8 @@ intel_mode_valid(struct drm_device *dev,
...
@@ -17718,7 +17719,7 @@ intel_mode_valid_max_plane_size(struct drm_i915_private *dev_priv,
 	 * too big for that.
 	 */

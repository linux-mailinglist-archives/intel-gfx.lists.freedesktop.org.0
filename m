...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A61A2EAF3A
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Jan 2021 16:46:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 671706E19C;
	Tue,  5 Jan 2021 15:45:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E0FF06E199
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 Jan 2021 15:45:43 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  5 Jan 2021 16:35:05 +0100
Message-Id: <20210105153558.134272-12-maarten.lankhorst@linux.intel.com>
X-Mailer: git-send-email 2.30.0.rc1
In-Reply-To: <20210105153558.134272-1-maarten.lankhorst@linux.intel.com>
References: <20210105153558.134272-1-maarten.lankhorst@linux.intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 11/64] drm/i915: Disable userptr pread/pwrite
 support.
...
aXZlcnMvZ3B1L2RybS9pOTE1L2dlbS9pOTE1X2dlbV91c2VycHRyLmMKaW5kZXggMzBlZGM1YTBh
NTRlLi44YzNkMWViMmY5NmEgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2dlbS9p
...
OTE1X2dlbS5jCmluZGV4IDIwOWQyNDRlOTg3OS4uODRlYjJhNTc0ODEzIDEwMDY0NAotLS0gYS9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1
L2k5MTVfZ2VtLmMKQEAgLTUwMiw2ICs1MDIsMTEgQEAgaTkxNV9nZW1fcHJlYWRfaW9jdGwoc3Ry
...
RVY7CiAJaWYgKG9iai0+b3BzLT5wcmVhZCkKLS0gCjIuMzAuMC5yYzEKCl9fX19fX19fX19fX19f

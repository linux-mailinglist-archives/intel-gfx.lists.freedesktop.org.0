...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D24ED1282C3
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Dec 2019 20:35:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 150466E13B;
	Fri, 20 Dec 2019 19:35:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CAD056E13B
 for <intel-gfx@lists.freedesktop.org>; Fri, 20 Dec 2019 19:35:47 +0000 (UTC)
X-Amp-Result: UNSCANNABLE
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 20 Dec 2019 11:35:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,336,1571727600"; d="scan'208";a="222548131"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by fmsmga001.fm.intel.com with SMTP; 20 Dec 2019 11:35:44 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 20 Dec 2019 21:35:43 +0200
Date: Fri, 20 Dec 2019 21:35:43 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Manasi Navare <manasi.d.navare@intel.com>
Message-ID: <20191220193543.GB1208@intel.com>
...
In-Reply-To: <20191220190531.GA1329@intel.com>
...
> And then if the crtcs in state are in sync mode and their cpu_trans match=
es the master trans
...
> Well we do need this for handling the hotplug cases correctly so that the=

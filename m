...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DCE536C8D4
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Apr 2021 17:41:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0FBE36E987;
	Tue, 27 Apr 2021 15:41:13 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 2/8] drm/arm/malidp: Always list modifiers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 134BC86B22C
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Feb 2024 15:45:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EFAC810E96C;
	Wed, 28 Feb 2024 14:45:21 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Ggu/wGjt";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C8E8910E213;
 Wed, 28 Feb 2024 14:45:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709131515; x=1740667515;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=mTCqURFp7fd1S19a2ArbKoWaYv4bKp+GJ4YDgt/t81k=;
 b=Ggu/wGjtjpwWdtYXrz6/K22/1cqB+MxfbCZmfPTtD+FbATTcAKW9jkAQ
 fsZO7idnEHuklGdFKxWpmqMtIZ4FktmalIgTGlMJ+mVFzQopytPk//FXI
 OkpFCUIz3w9sy3IW5q9qEasJa4b3ozIuuzu7mNqttGwu0jbB5jl3fTPQ7
 PiRBKr2Y1M5/jdh4mcXUHQ8j6/bdz49QJxoO+rye4ljTnslE1MWu+h4oQ
 Rb+e4B9HYoAg3nEAbaxNWmvjIez4aeNNhQKIg7l9HQZgA61/C9qmhp0eB
 +Sol0BytSzjw0aIVdgz6jb4/+Q58jPH75sS54KT16GpV7s+HaCb7Zt137 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10998"; a="7356129"
X-IronPort-AV: E=Sophos;i="6.06,190,1705392000"; 
   d="scan'208";a="7356129"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Feb 2024 06:45:14 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,190,1705392000"; 
   d="scan'208";a="7663136"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmviesa006.fm.intel.com with ESMTP; 28 Feb 2024 06:45:12 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: dri-devel@lists.freedesktop.org, jani.nikula@intel.com,
 ankit.k.nautiyal@intel.com,
 Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
Subject: [PATCH v12 2/8] drm: Add Adaptive Sync SDP logging
Date: Wed, 28 Feb 2024 20:08:17 +0530
Message-Id: <20240228143823.2762595-3-mitulkumar.ajitkumar.golani@intel.com>

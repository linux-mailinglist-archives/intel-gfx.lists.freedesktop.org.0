...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7E783CADC
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Jun 2019 14:15:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 554E7890D8;
	Tue, 11 Jun 2019 12:15:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E43C0890D3
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Jun 2019 12:15:38 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16863531-1500050 
 for multiple; Tue, 11 Jun 2019 13:15:29 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 11 Jun 2019 13:15:28 +0100
Message-Id: <20190611121528.25824-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/2] drm/i915: Track ggtt fence reservations
 under its own mutex
...

...

...

...
KQpAQCAtMzE5LDcgKzMyOCw3IEBAIHN0YXRpYyBzdHJ1Y3QgaTkxNV9mZW5jZV9yZWcgKmZlbmNl
...
dGludWU7CiAKIAkJcmV0dXJuIGZlbmNlOwpAQCAtMzMyLDYgKzM0MSw0OCBAQCBzdGF0aWMgc3Ry
...
cCB0aHJvdWdoIGEgZmVuY2UgcmVnCkBAIC0zNTIsOCArNDAzLDYgQEAgc3RhdGljIHN0cnVjdCBp
...
IAogCS8qCkBAIC0zNjEsMzkgKzQxMCwxNiBAQCBpbnQgaTkxNV92bWFfcGluX2ZlbmNlKHN0cnVj
...
LTsKIAlyZXR1cm4gZXJyOwogfQogCkBAIC00MDYsMTYgKzQzMiwxNyBAQCBpbnQgaTkxNV92bWFf
...

...
cm0vaTkxNS9pOTE1X3ZtYS5oCmluZGV4IDRiNzY5ZGI2NDliZi4uOTA4MTE4YWRlNDQxIDEwMDY0
NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3ZtYS5oCisrKyBiL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2k5MTVfdm1hLmgKQEAgLTQxOSw4ICs0MTksOCBAQCBpbnQgX19tdXN0X2NoZWNr

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F658643F3A
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Dec 2022 10:02:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE77610E02A;
	Tue,  6 Dec 2022 09:02:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 926A610E02A;
 Tue,  6 Dec 2022 09:02:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670317321; x=1701853321;
 h=date:from:to:cc:subject:message-id:mime-version;
 bh=aNpkB+sogkESilDNuuEW52EXZHNdNNJH2qf9nIq+Oi4=;
 b=c2x+wF68sfBPt/gsIIVHk1mZIC5MHMOI3qAPsu36l4M6JUi+sF2ppzWk
 UCxtISeckBNtgyHJa3FyCecUCcH71fagjDnp/unmJCMRMHxMuxynAerJJ
 Q6uKElobeHnUIiPQ/8+5+FQ8++ZbWFke3lZ7dkAYCmrJWZy5g2w+wRPq4
 q3y+TLbM05XnSEyJFCGIOGOXTTOuykpeyIauE0m6M9611k153ZG8ycQBn
 ik55HDNslofHab0rLqPuzzpcqC+40AwAlsjwVDNpcycmxdTI+Y5HZrutT
 DxItefvBn4KIsDZ2ohq08NDVsB+fCxw9p0J7/wAPZ2owfrCNTEcxMXHye g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="314217618"
X-IronPort-AV: E=Sophos;i="5.96,220,1665471600"; d="scan'208";a="314217618"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Dec 2022 01:01:59 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="891304745"
X-IronPort-AV: E=Sophos;i="5.96,220,1665471600"; d="scan'208";a="891304745"
Received: from lkp-server01.sh.intel.com (HELO b3c45e08cbc1) ([10.239.97.150])
 by fmsmga006.fm.intel.com with ESMTP; 06 Dec 2022 01:01:55 -0800
Received: from kbuild by b3c45e08cbc1 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1p2Tpr-0000mb-0M;
 Tue, 06 Dec 2022 09:01:55 +0000
Date: Tue, 6 Dec 2022 17:01:42 +0800
From: kernel test robot <lkp@intel.com>
To: Matt Roper <matthew.d.roper@intel.com>
Message-ID: <202212061613.jlamPX3V-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="yHtMzAZkzaXebPiC"
Content-Disposition: inline
Subject: [Intel-gfx] [drm-intel:drm-intel-gt-next 3/3]
 drivers/gpu/drm/i915/gt/intel_gt_mcr.c:370:29: error: result of comparison
 of constant 3142 with expression of type 'u8' (aka 'unsigned char') is
 always false
...
head:   f2053d346615f2c6bb4c0663276274b2da3f6871
commit: 3100240bf846ead1a2dbd6ae62bf48c687b9f5be [3/3] drm/i915/mtl: Add hardware-level lock for steering
...
reproduce (this is a W=1 build):
        ...
        git checkout 3100240bf846ead1a2dbd6ae62bf48c687b9f5be
...
Note: the drm-intel/drm-intel-gt-next HEAD f2053d346615f2c6bb4c0663276274b2da3f6871 builds fine.
      It only hurts bisectability.

All errors (new ones prefixed by >>):

>> drivers/gpu/drm/i915/gt/intel_gt_mcr.c:370:29: error: result of comparison of constant 3142 with expression of type 'u8' (aka 'unsigned char') is always false [-Werror,-Wtautological-constant-out-of-range-compare]
           if (GRAPHICS_VER(gt->i915) >= IP_VER(12, 70))
               ~~~~~~~~~~~~~~~~~~~~~~ ^  ~~~~~~~~~~~~~~
   drivers/gpu/drm/i915/gt/intel_gt_mcr.c:410:29: error: result of comparison of constant 3142 with expression of type 'u8' (aka 'unsigned char') is always false [-Werror,-Wtautological-constant-out-of-range-compare]
           if (GRAPHICS_VER(gt->i915) >= IP_VER(12, 70))
               ~~~~~~~~~~~~~~~~~~~~~~ ^  ~~~~~~~~~~~~~~
   2 errors generated.


vim +370 drivers/gpu/drm/i915/gt/intel_gt_mcr.c

   343	
   344	/**
   345	 * intel_gt_mcr_lock - Acquire MCR steering lock
   346	 * @gt: GT structure
   347	 * @flags: storage to save IRQ flags to
   348	 *
   349	 * Performs locking to protect the steering for the duration of an MCR
   350	 * operation.  On MTL and beyond, a hardware lock will also be taken to
   351	 * serialize access not only for the driver, but also for external hardware and
   352	 * firmware agents.
   353	 *
   354	 * Context: Takes gt->mcr_lock.  uncore->lock should *not* be held when this
   355	 *          function is called, although it may be acquired after this
   356	 *          function call.
   357	 */
   358	void intel_gt_mcr_lock(struct intel_gt *gt, unsigned long *flags)
   359	{
   360		unsigned long __flags;
   361		int err = 0;
   362	
   363		lockdep_assert_not_held(&gt->uncore->lock);
   364	
   365		/*
   366		 * Starting with MTL, we need to coordinate not only with other
   367		 * driver threads, but also with hardware/firmware agents.  A dedicated
   368		 * locking register is used.
   369		 */
 > 370		if (GRAPHICS_VER(gt->i915) >= IP_VER(12, 70))
   371			err = wait_for(intel_uncore_read_fw(gt->uncore,
   372							    MTL_STEER_SEMAPHORE) == 0x1, 100);
   373	
   374		/*
   375		 * Even on platforms with a hardware lock, we'll continue to grab
   376		 * a software spinlock too for lockdep purposes.  If the hardware lock
   377		 * was already acquired, there should never be contention on the
   378		 * software lock.
   379		 */
   380		spin_lock_irqsave(&gt->mcr_lock, __flags);
   381	
   382		*flags = __flags;
   383	
   384		/*
   385		 * In theory we should never fail to acquire the HW semaphore; this
   386		 * would indicate some hardware/firmware is misbehaving and not
   387		 * releasing it properly.
   388		 */
   389		if (err == -ETIMEDOUT) {
   390			drm_err_ratelimited(&gt->i915->drm,
   391					    "GT%u hardware MCR steering semaphore timed out",
   392					    gt->info.id);
   393			add_taint_for_CI(gt->i915, TAINT_WARN);  /* CI is now unreliable */
   394		}
   395	}
   396	

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 048586082C0
	for <lists+intel-gfx@lfdr.de>; Sat, 22 Oct 2022 02:09:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2D7110E4DC;
	Sat, 22 Oct 2022 00:08:11 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 1/7] drm/i915/huc: only load HuC on GTs that
 have VCS engines

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FF971369E4
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE93F6E9EB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 20/23] drm/vc4: Convert to CRTC VBLANK callbacks

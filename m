...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B08C5E0CE
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jul 2019 11:17:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E20426E10E;
	Wed,  3 Jul 2019 09:17:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 136E56E10A
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jul 2019 09:17:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17110518-1500050 
 for multiple; Wed, 03 Jul 2019 10:17:31 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 Jul 2019 10:17:26 +0100
Message-Id: <20190703091726.11690-15-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 15/15] drm/i915: Replace struct_mutex for batch
 pool serialisation
...
L2k5MTUvTWFrZWZpbGUKaW5kZXggODJjNDlhZDE2MzYxLi5jZThkYjdiMDE5ZjkgMTAwNjQ0Ci0t
...
X29iamVjdC5jCmluZGV4IGQzZTk2ZjA5YzZiNy4uZTU4MGVhNGM3MzRkIDEwMDY0NAotLS0gYS9k

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 69A645A36A8
	for <lists+intel-gfx@lfdr.de>; Sat, 27 Aug 2022 11:51:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4D8C10EBCB;
	Sat, 27 Aug 2022 09:51:40 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 12/15] vfio/amba: Use the new device life cycle
 helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80A4265AD48
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Jan 2023 06:42:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC70E10E189;
	Mon,  2 Jan 2023 05:42:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98AB110E189
 for <intel-gfx@lists.freedesktop.org>; Mon,  2 Jan 2023 05:42:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672638139; x=1704174139;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=bdc+/yP+ZIDMBgXmxgtK/xbcAjYhal7L0/hNxkSmPVU=;
 b=Igm0qxh0pd/wGxGR+jIj6B9D6LH490Ke41QMo9XI0DjvYa2ip/84GF8A
 55aPHWaIj+prT7AHXfzpddK6FOeklfeA+XrZLEKABDW7y+OfIGAxegKFI
 mWqLuNdmkFZu9GLlPd9F7/xbOBnQcdCvEig7V+c9DlaDMpoqp765uqyna
 /urLKJoqVNB3hvmmRqVQDq3a6fjT5wzusCQPzkbCXuEofW4LzcwGXAN5a
 L/jIQT9KQ56VoF+l9p90L2wdCebcdrxcCXjOlxpIDrzZDQghJJbHbSz3G
 jpObY4yTmy9dAkHKoVT9z5UTImLhVcou/9tvfM92XZWW4xczpPIxIWsBU w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10577"; a="301124353"
X-IronPort-AV: E=Sophos;i="5.96,293,1665471600"; d="scan'208";a="301124353"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jan 2023 21:42:19 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10577"; a="828472844"
X-IronPort-AV: E=Sophos;i="5.96,293,1665471600"; d="scan'208";a="828472844"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga005.jf.intel.com with ESMTP; 01 Jan 2023 21:42:16 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  2 Jan 2023 11:10:45 +0530
Message-Id: <20230102054047.124624-6-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 5/7] drm/i915/hdcp: Fill wired_cmd_in

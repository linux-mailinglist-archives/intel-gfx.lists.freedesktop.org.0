...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4F423A6BA1
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Jun 2021 18:26:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 607AA89E32;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 02/12] drm/i915: Break out dma_resv ww

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0395663BAA0
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Nov 2022 08:27:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA19710E38E;
...
Subject: [Intel-gfx] [PATCH v8 19/22] drm/i915/vm_bind: Render VM_BIND
 documentation

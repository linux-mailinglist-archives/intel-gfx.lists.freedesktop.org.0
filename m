...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 634E04FB818
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 11:48:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ABC0E10EC1E;
...
Subject: [Intel-gfx] [CI v2 08/12] drm/edid: use EDID block read helper in
 drm_do_get_edid()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EA9C127F4D
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Dec 2019 16:30:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F5CC6EC59;
	Fri, 20 Dec 2019 15:30:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 312436EC59
 for <intel-gfx@lists.freedesktop.org>; Fri, 20 Dec 2019 15:30:22 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 20 Dec 2019 07:30:22 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,336,1571727600"; d="scan'208";a="206571096"
Received: from kitaracr-mobl.amr.corp.intel.com (HELO
 josouza-MOBL.amr.corp.intel.com) ([10.252.207.149])
 by orsmga007.jf.intel.com with ESMTP; 20 Dec 2019 07:30:19 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 20 Dec 2019 07:29:52 -0800
Message-Id: <20191220152954.83276-5-jose.souza@intel.com>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20191220152954.83276-1-jose.souza@intel.com>
References: <20191220152954.83276-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 5/7] drm/i915/dp: Fix MST disable sequence
...
ZXggYTYyMzdkYTlhYzUyLi5kMzA2MDIzNzBkMzYgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2Rpc3BsYXkvaW50ZWxfZHBfbXN0LmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUv
ZGlzcGxheS9pbnRlbF9kcF9tc3QuYwpAQCAtMzQ0LDYgKzM0NCw3IEBAIHN0YXRpYyB2b2lkIGlu
...
bmtzID09IDA7CkBAIC0zNTQsNiArMzU1LDE5IEBAIHN0YXRpYyB2b2lkIGludGVsX21zdF9wb3N0
...
aXYpID49IDkpCkBAIC0zNjEsNiArMzc1LDEyIEBAIHN0YXRpYyB2b2lkIGludGVsX21zdF9wb3N0
...
c2NvZGVyIgpAQCAtMzcxLDE5ICszOTEsNiBAQCBzdGF0aWMgdm9pZCBpbnRlbF9tc3RfcG9zdF9k

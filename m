...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC27A573A0B
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 17:24:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2C8C9B62D;
...
Subject: [Intel-gfx] [PATCH v3 3/3] drm/i915/display: add hotplug.suspended
 flag

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 00ABB59E94B
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Aug 2022 19:26:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E809910ED9E;
	Tue, 23 Aug 2022 17:26:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4094510E47A
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Aug 2022 17:26:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1661275567;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=338GRy4rKLcaRqHS2Ttvfi7Hu0ihyjMIY/aQ2p+vkZk=;
 b=T3A1LQJhITkZP8knHdnNjaUcz3ZKjslmQ/KRejJZjeZWAhqweRn8A/A5Yape+a9/76IPtH
 mOJhe+cOe2CxZ9dsOa0/PhMiWCD6QFyh3/T+Lh2VY1vagTJeN8OpI06OFNUSmKR2d4OKGA
 YG9Z4KDuuFWjjEbv/tS9JPXAC0kCZTE=
Received: from mail-qt1-f198.google.com (mail-qt1-f198.google.com
 [209.85.160.198]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_128_GCM_SHA256) id
 us-mta-515-ul602jyDPpq9weJttBs_rQ-1; Tue, 23 Aug 2022 13:26:06 -0400
X-MC-Unique: ul602jyDPpq9weJttBs_rQ-1
Received: by mail-qt1-f198.google.com with SMTP id
 b10-20020a05622a020a00b003437e336ca7so11104550qtx.16
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Aug 2022 10:26:05 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=338GRy4rKLcaRqHS2Ttvfi7Hu0ihyjMIY/aQ2p+vkZk=;
 b=
X-Gm-Message-State: ACgBeo2gcMdaFIR91J4YY1z15FQGWqDhd9rJtCKtRyGFoCepaGKcuWsP
 jqZyiPC8TVmdPweJyw3Ikwg0qdFOn5S7tb+8AhXVzCmcQs4tnSxARzQfyzN4VNI6WkiLkxuOuRC
 jiLqwZYU4bNwBDf9IWYJI3NaKLbSr
X-Received: by 2002:a0c:f1c7:0:b0:474:725e:753e with SMTP id
 u7-20020a0cf1c7000000b00474725e753emr20886411qvl.49.1661275565267; 

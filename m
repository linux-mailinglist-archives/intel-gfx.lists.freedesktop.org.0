...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E9DD823F20C
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Aug 2020 19:40:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25C846E9D2;
	Fri,  7 Aug 2020 17:40:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7AB386E15F
 for <intel-gfx@lists.freedesktop.org>; Fri,  7 Aug 2020 17:40:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 22064282-1500050 
 for <intel-gfx@lists.freedesktop.org>; Fri, 07 Aug 2020 18:40:43 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  7 Aug 2020 18:40:42 +0100
Message-Id: <20200807174043.21594-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 3/4] drm/i915/gt: Track signaled breadcrumbs
...
index 6c321419441f..4ff2cf493cca 100644
...
@@ -352,7 +361,8 @@ static void insert_breadcrumb(struct i915_request *rq,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EF3855ADE7
	for <lists+intel-gfx@lfdr.de>; Sun, 26 Jun 2022 03:08:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 148F310ECDE;
	Sun, 26 Jun 2022 01:08:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4001910ED4D;
 Sun, 26 Jun 2022 01:08:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656205721; x=1687741721;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=zyNm9bo4vLLZxE8EQu5/prem0XyCmge7e5aL8f2kVI0=;
 b=PbgIBB8RL5Z/jTtKObjUEwuMGwJGlZIngEylgEGYFVplK/G8PSdcQPUB
 K9ijpipGaopV2gUooIEp2N5xb0wKjv5hJG2kNBygcCzH/3MR+AatPT/pz
 htPrE5Uve3304NUZg95kNiAO+UdepiIdH0s9VfiG7wXf5DWUuIpTVbSMD
 wR+7760b1lBxf70CY+H6Srai8yikXfQre5vTWX87OOsMWEGapCjfoETeU
 4TxXW2FBagL1AIKPxnVNMS0CIUZ0kNDtW7YKZBkLB0YOSET2tK5HiagEJ
 bPMkbUjI2JP4xMhkjVfDYRMKRL8N/WS1aBDjlVm5m6PNW6ubl3TqQ86jJ w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10389"; a="342920622"
X-IronPort-AV: E=Sophos;i="5.92,223,1650956400"; d="scan'208";a="342920622"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Jun 2022 18:08:40 -0700
X-IronPort-AV: E=Sophos;i="5.92,223,1650956400"; d="scan'208";a="593769434"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Jun 2022 18:08:40 -0700
Date: Sat, 25 Jun 2022 18:08:21 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Daniel Vetter <daniel@ffwll.ch>
Message-ID: <20220626010820.GH376@nvishwa1-DESK>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 584F4756336
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jul 2023 14:52:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7795810E23C;
	Mon, 17 Jul 2023 12:52:25 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 5/5] drm/i915/gt: Support aux invalidation on
 all engines

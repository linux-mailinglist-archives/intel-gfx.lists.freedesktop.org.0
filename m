...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A36042C6447
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:08:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7FFD36EC06;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 007/162] drm/i915: split wa_bb code to its
 own file

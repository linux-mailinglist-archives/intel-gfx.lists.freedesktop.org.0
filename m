...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 82EF7874F1
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:15:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E1D86ED3E;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 YuMQ==
Subject: [Intel-gfx] [PATCH 3/5] dma-buf: further relax

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7281F9AE63B
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Oct 2024 15:27:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BFBB10E93C;
	Thu, 24 Oct 2024 13:27:55 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="iuP/Fe1K";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5CD5F10E93C;
 Thu, 24 Oct 2024 13:27:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729776473; x=1761312473;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=aQNxFMlxS/yfCgvbmnDAjRk95o0+k5MCiSmRDTYrUiA=;
 b=iuP/Fe1KlYQLASPbdbQvzDdCs99jRd6F8G4daekjvcfUvKjYyWIcgSE8
 ZFUj7Nni50FaKvZhAW4jNIwOtkJg70pQQwOLOaIm/eeM5T0QYJ+z4iCbI
 DMjEZZ0duwdvRud7zah86sRd4ztK3P5GyUySZihDdKZTYCvb2kA7afbkZ
 /vvzwg1MV0WQGauJE2Z2E4OYnKzn0bX1tIrJjdHhdotfOhhYUQoeaW/pt
 Oo8sd4WRnX6ygPRv8RQ4jNxJlk6AGXH9dHTeibydyc1EICkfyj8cZsH0b
 f7ITAB5igJ8Nzm/P2munDtwAAmBkod/YlcU6l6vT1763RVnkasfXWu+O4 w==;
X-CSE-ConnectionGUID: izi/ziDBSS6l0WvHhg6mtA==
X-CSE-MsgGUID: bvdVrvToStS2uFIOSuL5mg==
X-IronPort-AV: E=McAfee;i="6700,10204,11235"; a="29305909"
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="29305909"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 06:27:53 -0700
X-CSE-ConnectionGUID: bQ+UgKe2QU2Rx1xid0AxwQ==
X-CSE-MsgGUID: 9QLjeEjDTuCIF9FG3Cx9rw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="85196035"
Received: from unknown (HELO localhost) ([10.237.66.160])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 06:27:50 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: rodrigo.vivi@intel.com,
	jani.nikula@intel.com
Subject: [PATCH v2 01/12] drm/i915/gmbus: convert to struct intel_display
Date: Thu, 24 Oct 2024 16:27:31 +0300
Message-Id: <1832a020dc512b6dfe3c643f31463564180d4192.1729776384.git.jani.nikula@intel.com>
...
index 6a16194b1105..37b61f05bd73 100644
...
index 5d022b4215ee..6d7637ad980a 100644
--- a/drivers/gpu/drm/i915/display/intel_lvds.c
+++ b/drivers/gpu/drm/i915/display/intel_lvds.c
@@ -901,7 +901,7 @@ void intel_lvds_init(struct drm_i915_private *i915)
 	drm_connector_init_with_ddc(&i915->drm, &connector->base,

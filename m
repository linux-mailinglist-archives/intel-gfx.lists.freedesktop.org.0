...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25698830475
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jan 2024 12:24:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D35A10E103;
	Wed, 17 Jan 2024 11:23:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BBFCC10E103
 for <intel-gfx@lists.freedesktop.org>; Wed, 17 Jan 2024 11:23:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1705490617; x=1737026617;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=jQScoGK+wmHg1fUzMuAqegZsGbLIIjrxuWXbB7dU/pA=;
 b=ezBk3CX9oPHnqx0iQSnbt+MCEz+QfqifJ5PCa+b5MZgkcAC9qz4UuCyK
 sojUA3FdZf5aTaaBy0wP9xz4akA2mkUGA2RgOwjOJHVHKlsnGOpsrJGP5
 CjTx10ORfq6c5Q8WIcKWj5xUUnwF/sRooTWpGB3ksPLj4o0W9iU6O6nJk
 rJowJDwpIxJYdp+iha9Y+VLkrepjiC8yx2rnuyW7Jvv9X1Tg5khnquiW1
 zxpbusTQFrD/UVNCiGD2Dc1mfs1ivagD/6iRKHuGMnppB7sQ96DGYERLy
 Lj6WUqgZ4BtRb+PN4I8q7KCtooZ0C/4A1fJNilYGulnUxCAr58Ok/ZwVM A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10955"; a="403901994"
X-IronPort-AV: E=Sophos;i="6.05,200,1701158400"; d="scan'208";a="403901994"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2024 03:23:36 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,200,1701158400"; d="scan'208";a="18816607"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2024 03:23:35 -0800
Date: Wed, 17 Jan 2024 13:23:28 +0200
From: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Subject: Re: [PATCH 2/3] drm/i915: Extract code required to calculate max
 qgv/psf gv point
Message-ID: <Zae4sLxA0QV/z68I@intel.com>

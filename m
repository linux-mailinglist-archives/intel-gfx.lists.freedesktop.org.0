...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE4FB550AE8
	for <lists+intel-gfx@lfdr.de>; Sun, 19 Jun 2022 15:38:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 54C0B10E68D;
	Sun, 19 Jun 2022 13:38:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6E36110E68D
 for <intel-gfx@lists.freedesktop.org>; Sun, 19 Jun 2022 13:38:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655645882; x=1687181882;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WYxp2v2Xzg7RLJ1gVPRnPY7krYlzG3f5IJzXkiu/QyU=;
 b=KHEAcBrlNb7z5vtV1lV7MzIqZZchPbjNMNomUVIjf/jvukisLHNIgHeB
 p6wJy6r9/jjbzmYQ00kO4y9/BTfyRrDFMjXkdT98zKgtSMV7iAD0zdmxm
 HwvU96tPIvOG/E1cC26wFUYQvZDyT52HR1N2AqT5ZXSfKrXkj/cdszZ6S
 XabwSBHIv4CDPop4tEyZ1bvysDx9fiyFCXGOULOhawL5I3wOYj6j94KT4
 M8K4XQ4PotDxUVEwGqoEg+N50e3CWreKQZBLrsw9stdB5voXmkDe2pY1E
 4lvXdo4rkOTraKUhLLDzlLM2ZlvfqZ51jXuRsxQxyei9BTGEUQenU3oCs Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10380"; a="259552684"
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="259552684"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jun 2022 06:38:02 -0700
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="676158541"
...
Date: Sun, 19 Jun 2022 16:37:15 +0300
Message-Id: <20220619133721.523546-9-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 08/14] mei: extend timeouts on slow devices.

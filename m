...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D0D961F7621
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Jun 2020 11:40:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A0CD6E0A6;
	Fri, 12 Jun 2020 09:40:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 38A426E0A6
 for <intel-gfx@lists.freedesktop.org>; Fri, 12 Jun 2020 09:40:35 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 21473329-1500050 for multiple; Fri, 12 Jun 2020 10:40:33 +0100
MIME-Version: 1.0
In-Reply-To: <159195381083.1506.15524005315925573285@build.alporthouse.com>
References: <20200611160529.9558-1-chris@chris-wilson.co.uk>
 <87eeqk8x2o.fsf@gaia.fi.intel.com>
 <159195381083.1506.15524005315925573285@build.alporthouse.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
To: Mika Kuoppala <mika.kuoppala@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
Message-ID: <159195483208.1506.5377359247926167271@build.alporthouse.com>
User-Agent: alot/0.8.1
Date: Fri, 12 Jun 2020 10:40:32 +0100

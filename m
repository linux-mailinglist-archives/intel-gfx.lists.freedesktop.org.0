...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0583B9406B3
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jul 2024 07:06:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A09EF10E4C3;
	Tue, 30 Jul 2024 05:06:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 2413ebb6fbb6 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 325C610E4C0;
 Tue, 30 Jul 2024 05:06:26 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============7547744417379491359=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=97_Fi=2ECI=2EBAT=3A_failure_for_i915/display/dp=3A_Compute_?=
 =?utf-8?q?AS_SDP_when_vrr_is_also_enabled_=28rev3=29?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Mitul Golani" <mitulkumar.ajitkumar.golani@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Tue, 30 Jul 2024 05:06:26 -0000
Message-ID: <172231598619.427093.11837536768003020636@2413ebb6fbb6>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_136498v3 absolutely need to be
  verified manually.
...
#### Possible regressions ####
  ...
  * igt@runner@aborted:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-elk-e7500/igt@runner@aborted.html
    - fi-tgl-1115g4:      NOTRUN -> [FAIL][2]
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-tgl-1115g4/igt@runner@aborted.html
...
#### Warnings ####
  ...
  * igt@runner@aborted:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-kbl-x1275/igt@runner@aborted.html
   ...
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-cfl-8109u/igt@runner@aborted.html
   ...
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-ivb-3770/igt@runner@aborted.html
   ...
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-kbl-guc/igt@runner@aborted.html
   ...
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-ilk-650/igt@runner@aborted.html
   ...
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-blb-e6850/igt@runner@aborted.html
   ...
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-bsw-n3050/igt@runner@aborted.html
   ...
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-pnv-d510/igt@runner@aborted.html
   ...
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-glk-j4005/igt@runner@aborted.html
   ...
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-kbl-7567u/igt@runner@aborted.html
   ...
   [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/bat-apl-1/igt@runner@aborted.html
   ...
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/bat-atsm-1/igt@runner@aborted.html
   ...
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-cfl-guc/igt@runner@aborted.html
...
#### Issues hit ####
  ...
  * igt@i915_selftest@live@hangcheck:
   ...
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/bat-arls-2/igt@i915_selftest@live@hangcheck.html
    - bat-mtlp-8:         [PASS][31] -> [DMESG-WARN][32] ([i915#11349] / [i915#11378])
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_15151/bat-mtlp-8/igt@i915_selftest@live@hangcheck.html
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/bat-mtlp-8/igt@i915_selftest@live@hangcheck.html
...
#### Possible fixes ####
  ...
  * igt@i915_selftest@live@gt_mocs:
    - {bat-arlh-3}:       [INCOMPLETE][35] -> [PASS][36]
...
<p>Serious unknown changes coming with Patchwork_136498v3 absolutely need to be<br />
  verified manually.</p>
...
<li>fi-elk-e7500:       NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-elk-e7500/igt@runner@aborted.html">FAIL</a></li>
<li>fi-tgl-1115g4:      NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/fi-tgl-1115g4/igt@runner@aborted.html">FAIL</a></li>
</ul>
</li>
</ul>
<h4>Warnings</h4>
...
<ul>
<li>{bat-arlh-3}:       <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_15151/bat-arlh-3/igt@i915_selftest@live@gt_mocs.html">INCOMPLETE</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_136498v3/bat-arlh-3/igt@i915_selftest@live@gt_mocs.html">PASS</a></li>
</ul>
</li>
</ul>

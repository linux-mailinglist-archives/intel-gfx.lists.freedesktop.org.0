...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 379454941E0
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jan 2022 21:35:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3BCA10E177;
...
Subject: [Intel-gfx] [PATCH v3 1/2] drm/i915/guc: Add fetch of hwconfig table

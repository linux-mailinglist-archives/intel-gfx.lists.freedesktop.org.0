...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A195554A9F4
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jun 2022 09:04:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F65210E835;
	Tue, 14 Jun 2022 07:04:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 715AE10E0FD;
 Tue, 14 Jun 2022 07:04:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655190246; x=1686726246;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=Tv7R496S75yN5qsr2CVtM0ICtqJLf60+Etr0MQo+Ttg=;
 b=YY7C8S4luGF7+c7qMtxdb8WTuxH0Siu9tQOupEvBPELzBk+ZWq6Ommcj
 lCMXGUmfwMY8Cj8e8Ml1MGqBwmcjhoLdSYRY2acSevubnCnRiprjPVDv/
 XioZTZZTyklKlsRE9nmjZ+YEoHcbptiFciBGH0wj1PtHoaQmlMpDKx4QE
 1pG3Hh7RveWbab6BdSYVSMuc2OLHXnJkflwgSj4zWrjNp5w7sIt4viAu0
 JO9M/9kCjFPhxG2mSNwInNBI9tkW3x2FeQt/iEoI7xs2y+CN8S8+oafT4
 mGxIQ3q7tjiCfsHdvarDyxQbCRS2oMbka+mMnihSA8VjlirIOeRagp4fq w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10377"; a="258980325"
X-IronPort-AV: E=Sophos;i="5.91,299,1647327600"; d="scan'208";a="258980325"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2022 00:04:04 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.91,299,1647327600"; d="scan'208";a="686507979"
Received: from linux.intel.com ([10.54.29.200])
 by fmsmga002.fm.intel.com with ESMTP; 14 Jun 2022 00:04:04 -0700
Received: from [10.249.142.55] (rkamins1-mobl.ger.corp.intel.com
 [10.249.142.55])
 by linux.intel.com (Postfix) with ESMTP id AE63C58097E;
 Tue, 14 Jun 2022 00:04:01 -0700 (PDT)
Message-ID: <e028b21b-a2bb-9649-06b0-9139462d107a@intel.com>
Date: Tue, 14 Jun 2022 10:04:00 +0300
MIME-Version: 1.0
...
In-Reply-To: <20220613180237.GJ376@nvishwa1-DESK>

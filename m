...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D2AC709BA3
	for <lists+intel-gfx@lfdr.de>; Fri, 19 May 2023 17:50:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED20210E5AD;
	Fri, 19 May 2023 15:49:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5CE6610E5A6
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=RI+Y5t5q9yJ/Ejn6DvnpKgAdrS/PFMtRXNLrfDoazP8=;
 b=n6hD50DS7Esjzr/oSqYAwD+DJcc/0RUQlmQCtJTJJHGGMBUq+DE09d8q
 41jn1WwwoBUp5ZMW1OgVWPm32hr40CY3+b5q2zaTsHdQLSrDDlBuXDdfE
 YzcyOYdcbUle7TDJ+8IRXElTiLcbWgAYew8j3y12pRikPZT9hqA9gC6KQ
 jq94/sf1vqrqdgBKbhoIAyD8PvSW+2nzfVzoDx4Slih5CF+QLovNrQcXR
 ychdXC1Oyq1t+w+fhBrW7Esf4M5BzuXW2A85rWN2Qv45Ok9CXDv5Ju8B9
 WG/rwkiaUYBwNpQmId4L0+9mkCVSbz6Supo4qEGbHgzPjPv4nK4EUKFh6 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10715"; a="354759571"
X-IronPort-AV: E=Sophos;i="6.00,177,1681196400"; d="scan'208";a="354759571"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 May 2023 08:49:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10715"; a="1032652191"
X-IronPort-AV: E=Sophos;i="6.00,177,1681196400"; d="scan'208";a="1032652191"
...
Message-Id: <20230519154946.3751971-7-umesh.nerlige.ramappa@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 6/7] drm/i915/pmu: Prepare for multi-tile
 non-engine counters

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 87E553A8A0B
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Jun 2021 22:16:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7272B6E491;
	Tue, 15 Jun 2021 20:16:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F280A6E457
 for <intel-gfx@lists.freedesktop.org>; Tue, 15 Jun 2021 20:16:05 +0000 (UTC)
IronPort-SDR: bT4IpCLGP2juJOqJc7kwYCC6mjNCqu9Bya1B08ImV58zqC6wxaiW+QNXPBCV13eqSWrXivHvTC
 4SjGv/6t/Ejg==
X-IronPort-AV: E=McAfee;i="6200,9189,10016"; a="206098899"
X-IronPort-AV: E=Sophos;i="5.83,276,1616482800"; d="scan'208";a="206098899"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Jun 2021 13:16:05 -0700
IronPort-SDR: lXtA7Lt0OhskIQH5dATnJPIjVJJKeUewhTdtWbe9zdrLa5GRHGmAh/++DxmcIKVHSEMYEO2Gex
 SmEmPidFYwgg==
X-IronPort-AV: E=Sophos;i="5.83,276,1616482800"; d="scan'208";a="553797643"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Jun 2021 13:16:05 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 15 Jun 2021 13:15:57 -0700
Message-Id: <20210615201558.1668315-3-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915: Add GT support for multiple
...
index b62d1e31a645..df63baad254e 100644
...
@@ -1279,28 +1283,39 @@ wa_list_apply(struct intel_uncore *uncore, const struct i915_wa_list *wal)
...
+	return wa_list_verify(gt, &gt->i915->gt_wa_list, from);
 ...
 __maybe_unused
@@ -2081,7 +2096,7 @@ void intel_engine_init_workarounds(struct intel_engine_cs *engine)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 86E337603D4
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jul 2023 02:20:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C625910E03D;
	Tue, 25 Jul 2023 00:20:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B046210E39E;
 Tue, 25 Jul 2023 00:20:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690244443; x=1721780443;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=IxRjGTHYl4c0z3i+Di/YrbPs/L6uTLIhhR8ue4SrIZQ=;
 b=bIff1O73LsljMBv8QVrBcvlDnUuyXZ+l/mel0FpMbMvXNhPTExjtY1cU
 WF8hECC6UN3Bjex3YlEb5ASEW/f5SnwIdlPqoOf+md4kpKDtMg+7v+EJB
 YgowZcEEqqOYNKYK1jjm3nozVEpzEG3ClYeHItys0CoC4439EDfM2jKrG
 za7ttUhTyJcaJAxsW5ql9dWZqDPkO9s7Vmj2gd59tzhSXxDJbhD/gWPHJ
 ifXB+bwSzDefR+XSfQIUuwUCPEmAz0DBDEkwRjbEsrTxcHBfl8mK1j9U8
 j/H5PTTXOihPxZ5ysGOKH7GjbjpYU+UQwk/drVWPn7Us+Awfx7sHBc3u4 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="365043844"
X-IronPort-AV: E=Sophos;i="6.01,229,1684825200"; d="scan'208";a="365043844"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2023 17:20:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="791160068"
X-IronPort-AV: E=Sophos;i="6.01,229,1684825200"; d="scan'208";a="791160068"
Received: from gionescu-mobl2.ger.corp.intel.com (HELO intel.com)
 ([10.252.34.175])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2023 17:20:39 -0700
...
Message-Id: <20230725001950.1014671-5-andi.shyti@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH v9 4/7] drm/i915/gt: Rename flags with
...
index 58b448708e750..d872aea8c9d54 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A4A714F3F8
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jan 2020 22:47:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F41E96E213;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 01/18] drm: add DP 1.4 VSC SDP Payload related
 enums

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B2A1C2E8AC3
	for <lists+intel-gfx@lfdr.de>; Sun,  3 Jan 2021 06:41:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B60789A9F;
	Sun,  3 Jan 2021 05:41:39 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5BCC689A88
 for <Intel-gfx@lists.freedesktop.org>; Sun,  3 Jan 2021 05:41:37 +0000 (UTC)
IronPort-SDR: ekesc680Cfkx/Ky3AgSYAB4EtYIHw4JhophzD4JMfFjpC34VJjjiN6Ybd4hcjdq3ayTTv1xfNb
 0qyqiVC/PvnA==
X-IronPort-AV: E=McAfee;i="6000,8403,9852"; a="163916495"
X-IronPort-AV: E=Sophos;i="5.78,471,1599548400"; d="scan'208";a="163916495"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jan 2021 21:41:35 -0800
IronPort-SDR: jx2kYrhFQ3QCOgLVBUQtHzrioPp1mmzUPelHAMGnfnkjyJ+CHN+TaFS9QL556GYvVVZ9tohw3+
 ZVDkvK+1CNcg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,471,1599548400"; d="scan'208";a="461562843"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga001.fm.intel.com with ESMTP; 02 Jan 2021 21:41:34 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Sat,  2 Jan 2021 21:41:31 -0800
Message-Id: <20210103054134.10148-11-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210103054134.10148-1-sean.z.huang@intel.com>
References: <20210103054134.10148-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v17 10/13] mei: pxp: export pavp client to me
 client bus

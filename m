...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BB3A3A8257
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Jun 2021 16:15:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6FD246E41B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 12/14] drm/uAPI: Add "preferred color format"

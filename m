...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 280AF5297D0
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 05:20:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BB2510E5E3;
...
Subject: [Intel-gfx] [PATCH v2 1/6] drm/i915/xehp: Use separate sseu init
 function

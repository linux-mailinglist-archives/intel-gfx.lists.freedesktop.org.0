...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 044B38143FF
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Dec 2023 09:53:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A77310E208;
	Fri, 15 Dec 2023 08:53:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CBF1510E208
 for <intel-gfx@lists.freedesktop.org>; Fri, 15 Dec 2023 08:53:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702630407; x=1734166407;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=YhswJf2We8EGO9vXpBgjxhoE/b4yWd8qbV2Kgcm3lY0=;
 b=TSEDyYQ4yNQOR1xPJQ7xml+FkjO3tt8SIWoxq6ntFS9r80uC7TTXzO5T
 dSnfGqEGB0M1mKerE9dSZmptVIdqfPmPTVPly+fVGyKLVoWcNI/+xy9hC
 ppzdG2gvNYgX7JrY4HmiAZTrvXj2g4MpecLqhQkJrUrX6260KUn7g6Dyx
 4Bv9FZAqBZvd2fcU5CiOVFsg5dhfZwILcmW1FLatcjyn74JMvMAE3Mssq
 m7xj0n1JhqiGmx1ofcUamoeVXUvf9UBo0SUfMU/N++Dpos6km7hIZQpG3
 3whDmjtbLy0apu3hSGTp3iX9EnxOTs4/NfqoG4Q5+etNd4mTJqJvuj4Xc A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10924"; a="2102723"
X-IronPort-AV: E=Sophos;i="6.04,278,1695711600"; 
   d="scan'208";a="2102723"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Dec 2023 00:53:26 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10924"; a="865339680"
X-IronPort-AV: E=Sophos;i="6.04,278,1695711600"; d="scan'208";a="865339680"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Dec 2023 00:53:25 -0800
Date: Fri, 15 Dec 2023 10:53:31 +0200
From: Imre Deak <imre.deak@intel.com>
To: Mika Kahola <mika.kahola@intel.com>
Subject: Re: [PATCH] drm/i915/display: C20 clock state verification
Message-ID: <ZXwUC0RMKLeH9PDe@ideak-desk.fi.intel.com>

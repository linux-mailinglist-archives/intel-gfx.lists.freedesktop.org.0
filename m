...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D78706C2283
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Mar 2023 21:24:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 40A0310E65E;
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: Sanitycheck MMIO access early in
 driver load

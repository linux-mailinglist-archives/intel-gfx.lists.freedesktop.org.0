...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFA1C6261A
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 18:21:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D4C76E027;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 11/14] drm/i915: Simplfy LVDS crtc_mask setup

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C62803CBD2B
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jul 2021 22:00:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12CB76EA43;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 34/51] drm/i915/guc: Don't complain about reset
 races

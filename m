...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 99C6F3EB437
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Aug 2021 12:43:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4EC8B6E5C6;
...
Subject: [Intel-gfx] [PATCH 4/4] drm/dp: add helper for extracting adjust

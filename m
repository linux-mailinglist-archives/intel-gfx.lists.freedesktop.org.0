...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 13D31AC6B44
	for <lists+intel-gfx@lfdr.de>; Wed, 28 May 2025 16:05:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A333210E621;
	Wed, 28 May 2025 14:05:33 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="WuDCD0IM";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5BC8810E619;
 Wed, 28 May 2025 14:05:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1748441133; x=1779977133;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=H1b7SLKQ9nZnC9EGLA4fx2BneF/NmYFhOwbTjSbPXOQ=;
 b=WuDCD0IMw5q6YR5sk3vqDxiG87qyEpRpth+m2P/fHguj9RqZLKTcVUHS
 8wOjb+pLbnPFNhl2S6nin31VDnq63iE9ug895qarP1lEoowBsK14/YNkh
 zE42ZULW2rtPbdys10V1+rDsqFxllPT/LddUz4B8FlUsjmnaUkfylyiuX
 lsyu9WNAbCcroJcjTSSwM5f5KIWLXFYuoMzEDZv3F+MGeUNUP06s2rudt
 j5VdGBiiqTuT8+XKaaAjfH5kp9at8T5FVUqXOpgV18NLxAEFcTc8UVX7A
 i8KpSMCR8OBQ3b/NO+RtQr9Bx8iDguRPQ4z9BQuTUxXH4u7aPSUeaXjtt w==;
X-CSE-ConnectionGUID: ocAXRPgzTHeF55U6lGRwuA==
X-CSE-MsgGUID: C0a7uVXaQcWZxnmtCzCONw==
X-IronPort-AV: E=McAfee;i="6700,10204,11447"; a="61525036"
X-IronPort-AV: E=Sophos;i="6.15,321,1739865600"; d="scan'208";a="61525036"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 May 2025 07:05:32 -0700
X-CSE-ConnectionGUID: SR8mWKfJRfKljODEljL+pg==
X-CSE-MsgGUID: JDjZarNeQMa1hpZSUk3UsA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,321,1739865600"; d="scan'208";a="143238964"
...
Message-ID: <20250528135115.2512429-5-alexander.usyskin@intel.com>

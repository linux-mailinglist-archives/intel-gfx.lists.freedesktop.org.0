...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F90C75ABA9
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jul 2023 12:08:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 111C910E0CE;
	Thu, 20 Jul 2023 10:08:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 877BF10E0CE
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jul 2023 10:08:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689847682; x=1721383682;
 h=message-id:date:mime-version:subject:from:to:cc:
 references:in-reply-to:content-transfer-encoding;
 bh=GgYyrqHzeDQy9+XzRPMnO593HqBFNIffVrXRjyo1VJs=;
 b=Cc6dmAj6ap/fMKvKWDeW+Cg7zuhfR5fyAerrYXJhEpSUr1YeqyP42NS9
 hFUVtb3c3FjecrJyCjhgSLlXk2i6QQ+aWOaBPv34SP+IuFLP/uTFVhwUG
 HjOUrjhgiYo/btK3s9N9NE3dzrhTL5HipRrWTlDrzukouB5ryYXBX8gk2
 AuJCxf6DWpkg8wu7uROwHp8vwwLKmV7fZnJYtNs0ozD/tI4jtqgnf3yNn
 X1PdNbjkZfJ6vXPE9pMajVe7adB3j0aW/cim7fvmIhnMn3lqJhwF0LkEb
 XbyYWOMmiWGA+HqvjZvwEy2fDD2Ntf52OumGHbmYcVXd15NIiPPnehYuE g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="356654778"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="356654778"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 03:08:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="674635926"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="674635926"
Received: from ctuohy-mobl1.ger.corp.intel.com (HELO [10.213.193.21])
 ([10.213.193.21])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 03:08:00 -0700
Message-ID: <5d394917-a4fc-cb57-ea79-25e2bd9e007f@linux.intel.com>
...
In-Reply-To: <ae48594e-7ac1-9f0c-513d-ce95213bc5b7@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6391A48CE4E
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Jan 2022 23:21:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D8D3310E8D9;
	Wed, 12 Jan 2022 22:21:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EADF910E453;
 Wed, 12 Jan 2022 22:20:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642026058; x=1673562058;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=NJ5MqVeWiSYKwCm1d8sMrI0XNqpLRjr7OZlIw9JZoSw=;
 b=hjMtongN18WkZOxeLrRwuYPcxBN2V94PdfNgP/uq+oBoVTqhWXbXrn47
 XZ4NTO8H2vJHweWltTa5JCLjs+XYY5TJyxzPjMMamnRQL8m8c1KsWVMfU
 aJ+Ltgm1rgglTTRQ4zRfvgz5akjop4x1sCWC5JR653M+LWPuoHiAGCQma
 LGkV63zVpaPFbsgcimdMzpp7wx2HDdW7oiobBRidv2SDr08A67zBwekVt
 18FGaOvn/gmU425zXzdi2CbLJ5JVKbgfnkcfcXQD3R2zthzgqGnwnMjt5
 3wxmHrthYWknrGJ8bhzqbssufB2j/NpaWOZZL+hBUgOsTyZr6cldK7P2o g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10225"; a="330214374"
X-IronPort-AV: E=Sophos;i="5.88,284,1635231600"; d="scan'208";a="330214374"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Jan 2022 14:20:58 -0800
X-IronPort-AV: E=Sophos;i="5.88,284,1635231600"; d="scan'208";a="475078856"
Received: from erozenmx-mobl1.ger.corp.intel.com (HELO intel.com)
 ([10.251.217.143])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Jan 2022 14:20:53 -0800
From: Andi Shyti <andi.shyti@linux.intel.com>
To: Intel GFX <intel-gfx@lists.freedesktop.org>,
 DRI Devel <dri-devel@lists.freedesktop.org>
Date: Thu, 13 Jan 2022 00:20:30 +0200
Message-Id: <20220112222031.82883-2-andi.shyti@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915: Prepare for multiple GTs

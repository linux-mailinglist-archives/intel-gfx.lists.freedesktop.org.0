...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0E6A3D02FA
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 22:41:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2CA966E593;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 15/42] drm/i915: Expose logical engine
 instance to user

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DDE3625AA9
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Nov 2022 13:47:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B3B4C10E170;
	Fri, 11 Nov 2022 12:47:44 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v1 1/6] dma-buf: Move
 dma_buf_mmap_internal() to dynamic locking specification

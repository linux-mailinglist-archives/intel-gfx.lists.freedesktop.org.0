...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A125954DE6D
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Jun 2022 11:49:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6D03113DD7;
	Thu, 16 Jun 2022 09:49:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 18BC4113DD7
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Jun 2022 09:49:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655372945; x=1686908945;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PbAdIYYuzgo48aNu4slxDK5Sa9sOW5nmEfcU8ujI+SU=;
 b=g2OC+M+bg1+Tv2C5Qv/GUi9uUapsHmd+YQKb0DqOqy+StXDDc7yhaUkC
 rlz4dNNYBwJlBhyF32nPxVusuzvNOfJ0EGj5Pc5GMT6owGFNQQae31/4i
 Rzb8lxJX9BFTIGKjcWCTtS1tb28CAlvyz3JsAtY7rGxqNQdcDJ9dS0Iho
 M2Q7si5rhhZo1KljdIG1J2lJSTj2ltfyzJx7Y+GGXxM4xr7KbYtAMelwi
 MMohgPNKI8KUMlkPbucfiM4SfkgTAVhwKB1vBlz5YOWtWkRoy8luftFxM
 gv8c0kV1796OuNvCjxmaPYbRbRl3bqcDjrATqFJB6dNs2kypCtZ6HC1yX Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10379"; a="304653153"
X-IronPort-AV: E=Sophos;i="5.91,304,1647327600"; d="scan'208";a="304653153"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2022 02:49:04 -0700
X-IronPort-AV: E=Sophos;i="5.91,304,1647327600"; d="scan'208";a="674952879"
Received: from malashi-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.252.57.133])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2022 02:49:02 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 16 Jun 2022 12:48:19 +0300
Message-Id: <b43133b2198c498c392ae8b0df43f91f4bd93006.1655372759.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 09/11] drm/i915/display: split out hw state
...
---
 ...
 drivers/gpu/drm/i915/display/intel_display.c  | 730 +-----------------
 drivers/gpu/drm/i915/display/intel_display.h  |  12 +
 .../drm/i915/display/intel_modeset_setup.c    | 727 +++++++++++++++++
 .../drm/i915/display/intel_modeset_setup.h    |  15 +
 5 files changed, 769 insertions(+), 716 deletions(-)
...
index 3e014bd08188..a80dd408210a 100644
...
@@ -9060,567 +8919,6 @@ void i830_disable_pipe(struct drm_i915_private *dev_priv, enum pipe pipe)
...
index 000000000000..75aa314279c9
--- /dev/null

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFBF917BCB8
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 13:31:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 015436E434;
	Fri,  6 Mar 2020 12:31:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD12989CB5
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Mar 2020 12:30:59 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  6 Mar 2020 13:30:38 +0100
Message-Id: <20200306123046.2797797-9-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/17] drm/i915: Rework intel_context pinning to
...
@@ -93,74 +93,6 @@ static void intel_context_active_release(struct intel_context *ce)
...
+
 ...
 {
@@ -230,43 +289,35 @@ static void __intel_context_retire(struct i915_active *active)
...
index 11278343b9b5..2a27b96546b7 100644
...
index 13941d1c0a4a..c85b901f0c44 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -2977,7 +2977,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3007,20 +3010,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3028,9 +3034,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3056,8 +3062,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -4850,13 +4858,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -4889,8 +4897,10 @@ static void virtual_context_exit(struct intel_context *ce)
...
index 6881317a747e..23b0641688ed 100644
--- a/drivers/gpu/drm/i915/gt/intel_ring_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_ring_submission.c
@@ -1203,6 +1203,10 @@ static void __context_unpin_ppgtt(struct intel_context *ce)
 }
...
@@ -1300,11 +1304,16 @@ static int ring_context_alloc(struct intel_context *ce)
 	return 0;
 }
...
@@ -1313,8 +1322,10 @@ static void ring_context_reset(struct intel_context *ce)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02D20991DF
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Aug 2019 13:15:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D5E66EAF8;
	Thu, 22 Aug 2019 11:15:57 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 6/6] drm/i915/hdcp: Enable HDCP 1.4 and 2.2
 on Gen12+

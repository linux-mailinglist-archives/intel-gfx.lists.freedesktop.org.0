...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 361E9622E20
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Nov 2022 15:41:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC6C110E0FB;
	Wed,  9 Nov 2022 14:41:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0272010E5E5;
 Wed,  9 Nov 2022 14:41:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1668004907; x=1699540907;
 h=date:from:to:cc:subject:message-id:mime-version;
 bh=YivM0TNxtTWwBEUaxih0vdRXtvwWc7P7kELrvkE8RJU=;
 b=gvVwuNr/3LtfxnOaW31v6khutDJKtnXe2APYB1xBm9mzNTFFX78S85dO
 cGufF14PyMbuX3Hv4a0H/sKv7BNI3YM6Y7KakFmfv3evBDyos8SvEL/Y8
 uCZtZccIerdYUeDMrTsIw6JsIpriux5gmle4vYlRBSr64Lk71rPXtQZwi
 Pb0FqFGooUmCj2KlC1ucrYCwWqsC3TnMgiF7tgoTaGVaJEw45RFC/D5rw
 L6x2kYUpJCWsPf9iwfberwt65Bh96kL3Tvu7KSfI7BYx4eS0juvhWqfCS
 m7Gq+8G26SrTpXT/M96d/ZFU3txehT0kecglwMcJKPsmvHn9g0ejVkfQ6 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10525"; a="290707379"
X-IronPort-AV: E=Sophos;i="5.96,150,1665471600"; d="scan'208";a="290707379"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Nov 2022 06:41:46 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10525"; a="639214729"
X-IronPort-AV: E=Sophos;i="5.96,150,1665471600"; d="scan'208";a="639214729"
Received: from lkp-server01.sh.intel.com (HELO e783503266e8) ([10.239.97.150])
 by fmsmga007.fm.intel.com with ESMTP; 09 Nov 2022 06:41:43 -0800
Received: from kbuild by e783503266e8 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1osmGt-0001kX-0m;
 Wed, 09 Nov 2022 14:41:43 +0000
Date: Wed, 9 Nov 2022 22:41:37 +0800
From: kernel test robot <lkp@intel.com>
To: Ben Skeggs <bskeggs@redhat.com>
Message-ID: <202211092214.VCxjGLUg-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="wAQb3xavzRk7yaP/"
Content-Disposition: inline
Subject: [Intel-gfx] [drm-tip:drm-tip 870/956]
 drivers/gpu/drm/nouveau/nvkm/engine/fifo/gf100.c:178:1: warning: no
 previous prototype for 'gf100_fifo_nonstall_block'
...
head:   83ef9bf841a2427c464cc3a9f5a6e57948a12963
commit: d67f3b96462922713e77cddb9d6f4965606918fc [870/956] drm/nouveau/fifo: tidy up non-stall intr handling
...
reproduce (this is a W=1 build):
        ...
        git checkout d67f3b96462922713e77cddb9d6f4965606918fc
...
>> drivers/gpu/drm/nouveau/nvkm/engine/fifo/gf100.c:178:1: warning: no previous prototype for 'gf100_fifo_nonstall_block' [-Wmissing-prototypes]
     178 | gf100_fifo_nonstall_block(struct nvkm_event *event, int type, int index)
         | ^~~~~~~~~~~~~~~~~~~~~~~~~


vim +/gf100_fifo_nonstall_block +178 drivers/gpu/drm/nouveau/nvkm/engine/fifo/gf100.c

   176	
   177	void
 > 178	gf100_fifo_nonstall_block(struct nvkm_event *event, int type, int index)
   179	{
   180		struct nvkm_fifo *fifo = container_of(event, typeof(*fifo), nonstall.event);
   181		unsigned long flags;
   182	
   183		spin_lock_irqsave(&fifo->lock, flags);
   184		nvkm_mask(fifo->engine.subdev.device, 0x002140, 0x80000000, 0x00000000);
   185		spin_unlock_irqrestore(&fifo->lock, flags);
   186	}
   187	

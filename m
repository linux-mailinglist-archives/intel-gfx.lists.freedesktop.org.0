...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E10C4E32C7
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Mar 2022 23:44:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5697A10E4A7;
...
Subject: [Intel-gfx] [PATCH v5 4/9] drm/i915/selftest_migrate: Consider the

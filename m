...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E39686FCBAD
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 18:51:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4E4910E39D;
	Tue,  9 May 2023 16:51:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2BFA110E39B;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=8XK9uM7YcVb57NAtLQP+yZs/SzVU06Tv33E1Emh+HNM=;
 b=aIhY2ls1p1uf7NrK2N0r+BxAXaYx8vdqcyG7cGGeC0j8H6cRTLo8sS92
 0et20ThHYnaHOh0uNHfdg8pFJFfXWznDneVjWolQ7Br/RvDP469QE9Qs2
 /fEk0A108UUYu5FyaBK8kcYVI3lS2Z3JqgBc1SpleVN12YxSqjOuD2MiW
 Zeb4N9lyB6szCsLbKcZxiUEGTThNL47GKwf+jGGgIAQw7MOmFmYP+oM7o
 tzuq+bNc4jz91TdDtWLejlFRsSkDdZ2Gxdzb1e3LCsIh6lqae1g97aRh3
 9aka1RxqL6m/yyFzdEobaI+B/lUML9/jTytXhCN71UXCYlREKcEhcwiEr w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="347450583"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="347450583"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:51:05 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="649407030"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="649407030"
...
Message-Id: <20230509165200.1740-3-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230509165200.1740-1-fei.yang@intel.com>
References: <20230509165200.1740-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v8 2/2] drm/i915: use pat_index instead of
 cache_level

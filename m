...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FB4562EB89
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Nov 2022 02:59:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D574410E6E4;
...
Subject: [Intel-gfx] [PATCH v2 2/5] drm/i915/huc: Add HuC specific debug
 print wrappers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96C9F4065FB
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 05:18:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B44CB6E95A;
	Fri, 10 Sep 2021 03:18:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [205.139.111.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 761546E964
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Sep 2021 03:18:17 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-604-LE2j9zw3M3OKbnQQ3G1V9A-1; Thu, 09 Sep 2021 23:18:11 -0400
X-MC-Unique: LE2j9zw3M3OKbnQQ3G1V9A-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 788F51084680;
 Fri, 10 Sep 2021 03:18:10 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id E2C041045E80;
 Fri, 10 Sep 2021 03:18:08 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com, Dave Airlie <airlied@redhat.com>,
 Jani Nikula <jani.nikula@intel.com>
Date: Fri, 10 Sep 2021 13:17:26 +1000
Message-Id: <20210910031741.3292388-11-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 10/25] drm/i915: split color functions from
 display vtable

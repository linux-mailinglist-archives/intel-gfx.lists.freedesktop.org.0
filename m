...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 168017974A5
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Sep 2023 17:40:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 566D010E825;
	Thu,  7 Sep 2023 15:40:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E2BBE10E813;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=dLtJUCJzS1dMNu+hud10jexCICAQ+7pBb+P/L4Ky/70=;
 b=SusaIFf08CzeZUJCmsnJsmOVvWm33HfmzEtCu+K2zm65QkG1UKaB7F4f
 M+60NIk66gAKTwRjQoK3tYbkndvjEN/Bbc0tMrb/HilWOXUo4kS3x8iSS
 hRf5/3JbLrWyRcVIZEvBiTjx+Lo/ozUakU2J/r/Hru+3CQoxG8PXS3yvy
 JsqlzO3KD9qAoPRObH8AP+qBrybxEV6nqLd6r2LQBIyMTAj+F5eLjZ7Jt
 DVL0CPih04OUL4ncYFnifN2qvzvv+tbzMLjkaKwQhUPXYlW1z/0WBpOlx
 jegZ8YBxtJhNnY9rxX3hoFY3ABIyj0Or77QYGeGcXtGf/VsCEmbZxQZob g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10826"; a="362445766"
X-IronPort-AV: E=Sophos;i="6.02,235,1688454000"; d="scan'208";a="362445766"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2023 08:38:15 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10826"; a="1072930252"
X-IronPort-AV: E=Sophos;i="6.02,235,1688454000"; d="scan'208";a="1072930252"
...
Date: Thu,  7 Sep 2023 08:37:39 -0700
Message-Id: <20230907153757.2249452-10-lucas.demarchi@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 09/27] drm/i915/xe2lpd: Move registers to PICA

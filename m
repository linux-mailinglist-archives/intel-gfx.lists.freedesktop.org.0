...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2D8A7CE3B0
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:06:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64BF410E40E;
...
Subject: [Intel-gfx] [PATCH v7c 10/24] dyndbg: tighten ddebug_class_name()
 1st arg type

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63DF399C9A5
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Oct 2024 14:04:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6B8C10E289;
	Mon, 14 Oct 2024 12:04:20 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="lYGImFOK";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 15F1910E289
 for <intel-gfx@lists.freedesktop.org>; Mon, 14 Oct 2024 12:04:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1728907459; x=1760443459;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=y/R+KSHBbzZd0jtDAxZQmShD90TfE/EbYryWysBU6ZE=;
 b=lYGImFOK4FanlBuN2Tm0Yylz3BKFATkSERTO9Gf709A+AikPybK7/LDo
 B7cynQ5RbN5854OIQI0cOLiW5ov9eSiYturB8VfH2KBA5h/s+yhVr+VEt
 B6J9u6WA5OWvhC8LoNRuHXpOmPb00t4mOWy5K5ZhWzb0S1PY9+6mjnwF0
 XigQjnv8oAVdW6nwrcS1aj5Zv45YmGLwKvfE/qSVfiSdfmxHLLybrX2Dg
 0teeGsDNcaxg9ZoFGnw2wAE6EYr344L8AJbHLDCaY5JRYuWGByUETgYck
 Bq8JapwOILUZkWndJ+SGNKG5UST8pQgS2e/RQ+x4o1uknTT4XjO1CUxXx Q==;
X-CSE-ConnectionGUID: QPLufY0yQjWlY/Hw0k9jWg==
X-CSE-MsgGUID: efdFKK+BTaSEqvvtW+DvMg==
X-IronPort-AV: E=McAfee;i="6700,10204,11224"; a="32049444"
X-IronPort-AV: E=Sophos;i="6.11,203,1725346800"; d="scan'208";a="32049444"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2024 05:04:18 -0700
X-CSE-ConnectionGUID: CI1DPwW9TFG2dcZ4OMjIbw==
X-CSE-MsgGUID: +hvyJZaqT3ChMOl/ZzHM1Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,203,1725346800"; d="scan'208";a="81543824"
Received: from spottumu-desk.iind.intel.com ([10.145.152.200])
 by fmviesa003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2024 05:04:15 -0700
From: Sai Teja Pottumuttu <sai.teja.pottumuttu@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: matthew.d.roper@intel.com, ville.syrjala@intel.com,
 balasubramani.vivekanandan@intel.com,
 Sai Teja Pottumuttu <sai.teja.pottumuttu@intel.com>
Subject: [PATCH] drm/i915: Remove unused underrun irq/reporting bits
Date: Mon, 14 Oct 2024 17:22:00 +0530
Message-Id: <20241014115200.2574895-1-sai.teja.pottumuttu@intel.com>

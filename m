...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OHK9EJG1+WlKBAMAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 05 May 2026 11:17:05 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 93C1F4C96DE
	for <lists+intel-gfx@lfdr.de>; Tue, 05 May 2026 11:17:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B16F410E9FD;
	Tue,  5 May 2026 09:17:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="XNWNQJ0T";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 515CD10E9FD;
 Tue,  5 May 2026 09:17:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1777972621; x=1809508621;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=g01GFNz7vBVcxRxMGhAfr0APq4C/Wglqe5IbJQtiVjQ=;
 b=XNWNQJ0TGrMXiAdOFqcltAvJxdHiYEmF32L9zc74U3vSdgK8wO2H7FMc
 22I5FPAuwpyvNs9t8J0PkykGsNLCq90+sSChUXSEbfI8DuQsNZGoS7vy/
 MsujnyPWD6VZwc06t53sEhh9KtJ/aTPAziUtVlYPNo14L25q1BcCumZ3/
 G9d61D9/Dqze9n2rWTpRN3WeYR1Xhc00kwhNPfdBpUYdWyPQYoSoQa0eB
 MGq39fjcL79vwj53qRrX3jfNSWfbElDpYBO/3wtEzo4Fix+yLn7vmam4h
 n4ssRJEajHNbQK4r47p9sY6GQJmVBHpCef0BVXS+LPPGSphKhwtCPWNka w==;
X-CSE-ConnectionGUID: Zs1pQnpXRuOrdMzR/0y5kg==
X-CSE-MsgGUID: 83BYUgEFSEGTSmdKJZQi6Q==
X-IronPort-AV: E=McAfee;i="6800,10657,11776"; a="78887962"
X-IronPort-AV: E=Sophos;i="6.23,217,1770624000"; d="scan'208";a="78887962"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2026 02:17:01 -0700
X-CSE-ConnectionGUID: fAo2+6WYSk68w+BLQhDlgw==
X-CSE-MsgGUID: 2qPXTj2mRlGxnnYHw3oeAw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,217,1770624000"; d="scan'208";a="234752558"
Received: from amilburn-desk.amilburn-desk (HELO localhost) ([10.245.244.55])
 by orviesa006-auth.jf.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 May 2026 02:16:58 -0700
...
Subject: [RESEND 1/4] drm/i915/display: add typedef for intel_reg_t and use it
Date: Tue,  5 May 2026 12:16:45 +0300
Message-ID: <f5bb0122143c39ce7f9ce8a1605a7637e569f7f8.1777972548.git.jani.nikula@intel.com>

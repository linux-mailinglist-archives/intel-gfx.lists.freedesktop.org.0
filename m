...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B14405E63CB
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Sep 2022 15:37:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC51C10EB24;
	Thu, 22 Sep 2022 13:37:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D38810EB24
 for <intel-gfx@lists.freedesktop.org>; Thu, 22 Sep 2022 13:37:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663853845; x=1695389845;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Up2i4DBCaHMlSoeORCo9hnhdlHvVhwIl5ycGnd35OpU=;
 b=RJUgKba5MIRiWk6EAWTnW6WM6U3xZaYh1XvAY/cF22ZyvYMP8BvH4cj4
 f3ghvxpxgvT4OibY9Q3yIct8NkJVwbyaV8eJ+bgTJYprwyebdzBoRH7F3
 9Yf2+CP7O/8JtvwbO5onGZRjno6Uhu3uH2lze+bFyx0zzMN3PEAJdG4Fb
 7DXowk88QeBjhzbxL8UXviQoSD6mKygZN60bSPfv+z372yYw1rPDVj2oi
 pAQiebKhT12/TV19b87bloZq8Nvr+y2ZnmbFlMLlGwzQpH8wZd/cmV/kq
 nEgYIjU1ZRN/Te4F7duW9KMBwtRQxC0f4hl5agXkJwAyl6IUZENDiDd2F Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10478"; a="297894502"
X-IronPort-AV: E=Sophos;i="5.93,335,1654585200"; d="scan'208";a="297894502"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Sep 2022 06:37:24 -0700
X-IronPort-AV: E=Sophos;i="5.93,335,1654585200"; d="scan'208";a="864856875"
Received: from jkrzyszt-mobl1.ger.corp.intel.com ([10.213.3.25])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Sep 2022 06:37:22 -0700
From: Janusz Krzysztofik <janusz.krzysztofik@linux.intel.com>
To: Lucas De Marchi <lucas.demarchi@intel.com>,
 Robin Murphy <robin.murphy@arm.com>
Date: Thu, 22 Sep 2022 15:37:19 +0200
Message-ID: <22794888.6Emhk5qWAg@jkrzyszt-mobl1.ger.corp.intel.com>
...
To be clear, the intention behind this revert was to unblock intel-gfx-ci, not 
to propose a solution.  I've CC-ed IOMMU and mainstream just for your 
awareness.

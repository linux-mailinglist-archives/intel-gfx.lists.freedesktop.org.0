...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB0AD3FCE63
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Aug 2021 22:22:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 595566E08E;
...
Subject: [Intel-gfx] [PATCH v7 2/8] dyndbg: remove spaces in pr_debug "gvt:
 core:" etc prefixes

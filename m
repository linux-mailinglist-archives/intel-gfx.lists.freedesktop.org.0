...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 82A446C286
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jul 2019 23:25:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F226A6E2A9;
	Wed, 17 Jul 2019 21:25:10 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CD7C96E2A9
 for <Intel-gfx@lists.freedesktop.org>; Wed, 17 Jul 2019 21:25:09 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga103.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 17 Jul 2019 14:25:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,275,1559545200"; 
 d="p7s'?scan'208";a="170372229"
Received: from fmsmsx108.amr.corp.intel.com ([10.18.124.206])
 by orsmga003.jf.intel.com with ESMTP; 17 Jul 2019 14:25:09 -0700
Received: from fmsmsx126.amr.corp.intel.com (10.18.125.43) by
 FMSMSX108.amr.corp.intel.com (10.18.124.206) with Microsoft SMTP Server (TLS)
 id 14.3.439.0; Wed, 17 Jul 2019 14:25:08 -0700
Received: from fmsmsx106.amr.corp.intel.com ([169.254.5.248]) by
 ...
 Wed, 17 Jul 2019 14:25:08 -0700
From: "Summers, Stuart" <stuart.summers@intel.com>
To: "Intel-gfx@lists.freedesktop.org" <Intel-gfx@lists.freedesktop.org>,
 "tvrtko.ursulin@linux.intel.com" <tvrtko.ursulin@linux.intel.com>
Thread-Topic: [Intel-gfx] [PATCH 1/6] drm/i915: Fix GEN8_MCR_SELECTOR
 programming
Thread-Index: AQHVPMpt/LHo9Q1pDUmMgX46TkSjWqbPx/eA
Date: Wed, 17 Jul 2019 21:25:07 +0000
Message-ID: <73a927cb41628e942dec6457d8573884a7cab527.camel@intel.com>
References: <20190717180624.20354-1-tvrtko.ursulin@linux.intel.com>
 <20190717180624.20354-2-tvrtko.ursulin@linux.intel.com>
In-Reply-To: <20190717180624.20354-2-tvrtko.ursulin@linux.intel.com>
...
Content-Type: multipart/mixed; boundary="===============0178391885=="
...
Content-Type: multipart/signed; micalg=sha-1;
	protocol="application/x-pkcs7-signature"; boundary="=-cdUotvaqobcNsspP//4+"
...

E+Q+LvQPKjImxaCjybZ0AAAAAAAA

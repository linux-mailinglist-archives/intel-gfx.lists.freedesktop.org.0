...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C73BA58FEFD
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Aug 2022 17:15:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D5845B3DC9;
	Thu, 11 Aug 2022 15:14:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D94A1B3D75
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Aug 2022 15:14:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1660230863; x=1691766863;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=LOWzf+g4mMVTuS8ike70RjkUCLCblim/U9Uro0IMGFU=;
 b=WEGJ4mZE+vC4x0U4xuGlnTuwNjmfqkAcEPEzwRUXnbXWz0LkPUBjB9HC
 QscAYJKibmeO4ATdjuUVlO2W3nQulg065u1icUy+r1qEUR26R6aCiZtBn
 BhaWp7NHQSSkv048l7wH+r8BFeeZGwjFOz0VRIoIfCn+umQTVCTgr3KO2
 8ag+N82BwOruSfSMnjn+O2QbTH1lT9LI3XmolKgYGOmTtnJPe+4DhH07a
 ekHMtzKTmev6nNHIrHpT8HP6eC/0g2xSjgxOb7nA/0HwSeIeOPdktlmSt
 MlFUYG4z86dhsMZqsp+olKGYsnZNN5tt4ZWpV7k7run2XlSWTKGFf/k9l w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10436"; a="278319386"
X-IronPort-AV: E=Sophos;i="5.93,230,1654585200"; d="scan'208";a="278319386"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2022 08:09:01 -0700
X-IronPort-AV: E=Sophos;i="5.93,230,1654585200"; d="scan'208";a="605575640"
Received: from gdogaru-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.48.102])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2022 08:08:58 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 11 Aug 2022 18:07:24 +0300
Message-Id: <32be38d0fcf6dd695b1488c0b78fd6fc09280d62.1660230121.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 13/39] drm/i915: move dpll under display.dpll

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C508C6D13C2
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Mar 2023 01:52:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4A05410F0AC;
	Thu, 30 Mar 2023 23:52:35 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v8 10/24] vfio: Make vfio_device_open()

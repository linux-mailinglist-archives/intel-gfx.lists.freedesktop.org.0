...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C6C73A0DEC
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Jun 2021 09:42:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17B876E3A0;
	Wed,  9 Jun 2021 07:42:25 +0000 (UTC)
...
The following changes since commit 2e290c8d8d29278b9a20e2765ab8f6df02f2e707:
  ...
  drm: document minimum kernel version for DRM_CLIENT_CAP_* (2021-05-31 18:=
57:22 +0200)
...
for you to fetch changes up to 5b7a2c92b6102447a973f2f1ef19d660ec329881:
  ...
  drm/vmwgfx: use ttm_bo_move_null() when there is nothing to move (2021-06=
-09 09:10:22 +0200)
...
format
      ...
      drm/mediatek/mtk_disp_gamma: Strip and demote non-conformant kernel-d=
oc header
      drm/mediatek/mtk_disp_ovl: Strip and demote non-conformant header
      drm/mediatek/mtk_disp_rdma: Strip and demote non-conformant kernel-do=
c header
      drm/sti/sti_hdmi_tx3g4c28phy: Provide function names for kernel-doc h=
eaders
...
static
      ...
      drm/exynos/exynos7_drm_decon: Fix incorrect naming of 'decon_shadow_p=
rotect_win()'
      drm/exynos/exynos_drm_ipp: Fix documentation for 'exynos_drm_ipp_get_=
{caps,res}_ioctl()'
...
Marek Vasut (4):
      dt-bindings: drm/bridge: ti-sn65dsi83: Add TI SN65DSI83 and SN65DSI84=
 bindings
...
++++
 ...
 create mode 100644 Documentation/devicetree/bindings/display/bridge/ti,sn6=
5dsi83.yaml

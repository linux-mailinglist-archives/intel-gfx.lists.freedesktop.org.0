...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 71074426688
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Oct 2021 11:17:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 832D06E871;
...
Subject: [Intel-gfx] [PATCH 4/5] drm/armada: check dri/crtc root before
 debugfs init

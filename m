...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B0743FE6DD
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Sep 2021 02:53:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F83A6E44A;
...
Subject: [Intel-gfx] [PATCH v5 17/25] drm/i915/guc: Release submit fence
 from an irq_work

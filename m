...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 853E729C4F
	for <lists+intel-gfx@lfdr.de>; Fri, 24 May 2019 18:30:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7EBB76E12D;
	Fri, 24 May 2019 16:30:48 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 4/4] drm/i915/dsi: Read back pclk set by GOP and
 use that as pclk (v3)

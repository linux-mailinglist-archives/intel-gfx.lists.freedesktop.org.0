...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DA62B52A3CE
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 15:48:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8658910E09E;
	Tue, 17 May 2022 13:48:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3C09D10E1EA;
 Tue, 17 May 2022 13:48:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1652795332; x=1684331332;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=7Zk9aUPbFbaFWtkIqavFxi3aOdRVxxhmbYvJ0/fDwNM=;
 b=WvD6i1vRoBVwiQ46/cVSE+gMXUUFCTqQAxHGtAAVgKl5htEM2IWAgHkT
 ItcITHOCuWCMfba6rQrXnEPMPqPwmyXT4IYr9Nyc2gHHuAUiTnyYO1kGV
 CkF0B3ns3ogJ34zTn0uEi9z07Cw15PP+ZvcBgxahlUIOviYkIvj5V4eph
 Mhs/CDiEq++lkcmEMB3Qq1ctevnwVXtF21IMIiX+TBxLjnyvIFWByp6Ad
 3+AbAL6yXeKGJevQNXciBy7BjowrIrBmks7SZd7HC6Kfh6ZXA21eMFnPq
 7RNwDt6pi9PxQSDvgLXzuFvG8QPoFZZqmnZP7zOdPSf0bhwzApDC30XCg Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10349"; a="331804241"
X-IronPort-AV: E=Sophos;i="5.91,233,1647327600"; d="scan'208";a="331804241"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 May 2022 06:48:51 -0700
X-IronPort-AV: E=Sophos;i="5.91,233,1647327600"; d="scan'208";a="597134916"
Received: from aghafar-mobl1.ger.corp.intel.com (HELO [10.213.210.37])
 ([10.213.210.37])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 May 2022 06:48:48 -0700
Message-ID: <4eac73ec-5884-4d3f-9938-8ea3dfe5a309@linux.intel.com>
Date: Tue, 17 May 2022 14:48:47 +0100
MIME-Version: 1.0
...
Subject: Re: [Intel-gfx] [PATCH v4] drm/doc: add rfc section for small BAR
 uapi

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7108575AC4F
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jul 2023 12:48:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E11ED10E5A9;
	Thu, 20 Jul 2023 10:48:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7974910E5A9
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jul 2023 10:48:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689850105; x=1721386105;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=wBXjY7VHr7DiT8Mj8NGO4e6EM8yyViWiQ58+tNOdOM8=;
 b=WNrBUoCyPbFjphKrQWtGLw34ATJVZMoZeCMTX4yHUVoz+NkKPwonGaBn
 xHstvVVne6wzgvYtDiD1VTFOEX0UuVKKeSrATBTqpz4vnL9bbNjI19ZwE
 soSjII3+G+1D5ZHskQzy4HXXqtgINXUzQAyp2TTfNQjwPu8PXT216lpvT
 Va6VOSsbpGAlOL+dce9vaNH4DB6d8HO86VfK+3vErbjUL8MtC2aIGrc+8
 7Mvc/OZhg0pvXF5FUQaUQQV/TGkzYnn0gTxNNvdPA9L8vB5pnugzCrdLS
 BNFQqSqqIFQOMgFzVJRaT8GxS/1SR4C4pUY20Utc62iMvf3520+ZRNj6I g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="430465455"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="430465455"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 03:48:25 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="718349211"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="718349211"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.20.19])
 ([10.213.20.19])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 03:48:15 -0700
Message-ID: <ca1022f2-5859-ac35-2aa4-ba7ce35c7ec3@intel.com>
Date: Thu, 20 Jul 2023 12:48:10 +0200
MIME-Version: 1.0
...
References: <20230719150739.1505220-1-andrzej.hajda@intel.com>
 <ae48594e-7ac1-9f0c-513d-ce95213bc5b7@linux.intel.com>
 <5d394917-a4fc-cb57-ea79-25e2bd9e007f@linux.intel.com>
From: Andrzej Hajda <andrzej.hajda@intel.com>
Organization: Intel Technology Poland sp. z o.o. - ul. Slowackiego 173, 80-298
 Gdansk - KRS 101882 - NIP 957-07-52-316
In-Reply-To: <5d394917-a4fc-cb57-ea79-25e2bd9e007f@linux.intel.com>

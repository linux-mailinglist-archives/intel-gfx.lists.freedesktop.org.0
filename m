...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB6E83D1303
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Jul 2021 17:57:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09C9E6E9A5;
...
Subject: [Intel-gfx] [PATCH 10/21] drm/i915/gvt: remove vgpu->handle

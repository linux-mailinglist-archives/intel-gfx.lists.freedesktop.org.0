...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 869E86EEE3D
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Apr 2023 08:23:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9EB2110E8C4;
	Wed, 26 Apr 2023 06:23:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7F1F510E8BF;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=BuKwByXmwWMZxhQmsQzYLoAB5fQaj/Z59l6PtqHvenJvtoU47xCQhpyK
 zT6fHBSknSidYVueclRImFhyHqaUclqobVLcGPmh/PnUMyE87AE1rRcRp
 6wd6Xgn+cklYSfBCvaCpukgOnepA6Zkh7npgz9hT6XtRgqFIme9XTzgil
 fJFNHhdbu6r29PmsRz4aGhnMMlkxhxrp/IR91XzaeMQw/RrSNNIeX4cPW
 vE5VXqfn1v9nGFRhL5xDuU+J6spa5SWQASa2IIq7LoIzAy1NvgyushfT8
 UuZkjUcF5MN5YAdltcHSDe3UtzAgTsdey2YkPFywk+wz3jpsk1hUW+OJ6 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="326622689"
X-IronPort-AV: E=Sophos;i="5.99,227,1677571200"; d="scan'208";a="326622689"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 23:23:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="817990921"
X-IronPort-AV: E=Sophos;i="5.99,227,1677571200"; d="scan'208";a="817990921"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 23:23:16 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:24:20 -0700
Message-Id: <20230426062423.320519-3-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230426062423.320519-1-fei.yang@intel.com>
References: <20230426062423.320519-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 2/5] drm/i915: use pat_index instead of
 cache_level

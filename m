...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 320165684E2
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Jul 2022 12:12:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43C66113414;
	Wed,  6 Jul 2022 10:12:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C9F2A113414;
 Wed,  6 Jul 2022 10:12:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1657102365; x=1688638365;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=wBcsvK0sjJixZQVAACywWSj1W5F/Mz9aWUoCU+SGgLQ=;
 b=Zs1WEJio6d4KjxwwuWf0Uq56fTqfJLmFBCUVghLPFAiJNQ5NGeK7R/Uc
 ndIN+kGuvuenILGNa6BB6ROUee/UlLOHTQTLah4oAX5kiwFzYT0BZlUk5
 vQqfKpJAhqfUo/OevU6ejWQNhXlWQERfzbRa0Wu/Ey9wnWCzbfc34Ay08
 RHLhPeDpSJu5fK49WXaxNOAMcpD7tw2J7S0hQMVlokrFiDFaVv0UqyOaL
 O/DhAWopOTvAHaW6SYfJ9crB1Q7hIGSYJhqy2CuQOotsiK9h33B9jUkQN
 ZFwNeJZ+sCjZFe1VMxDdzY01FYdS8sUxdsV5Jfn6i32B0ZEbVtvWSe0ak g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10399"; a="309252664"
X-IronPort-AV: E=Sophos;i="5.92,249,1650956400"; d="scan'208";a="309252664"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jul 2022 03:12:45 -0700
X-IronPort-AV: E=Sophos;i="5.92,249,1650956400"; d="scan'208";a="735511075"
Received: from nirmoyda-mobl.ger.corp.intel.com (HELO [10.252.17.138])
 ([10.252.17.138])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jul 2022 03:12:44 -0700
Message-ID: <50128ba7-a3a7-c6f9-b4d4-08c8b7d23fb0@linux.intel.com>
Date: Wed, 6 Jul 2022 12:12:42 +0200
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:91.0) Gecko/20100101
 Thunderbird/91.11.0
Content-Language: en-US
To: Matthew Auld <matthew.auld@intel.com>, igt-dev@lists.freedesktop.org
References: <20220706093802.203189-1-matthew.auld@intel.com>
From: "Das, Nirmoy" <nirmoy.das@linux.intel.com>
In-Reply-To: <20220706093802.203189-1-matthew.auld@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
Subject: Re: [Intel-gfx] [PATCH i-g-t v2] tests/i915_query: tweak the

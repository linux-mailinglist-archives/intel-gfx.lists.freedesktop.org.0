...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0D3D6E56C
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Jul 2019 14:13:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 879486E81E;
	Fri, 19 Jul 2019 12:13:31 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 2/5] drm/edid: Abstract away
 cea_edid_modes[]

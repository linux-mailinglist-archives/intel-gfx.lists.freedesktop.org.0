...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B79422D25A
	for <lists+intel-gfx@lfdr.de>; Wed, 29 May 2019 01:20:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34B1289B12;
	Tue, 28 May 2019 23:20:33 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 3/3][V2] lib: re-introduce new match_string()
 helper/macro

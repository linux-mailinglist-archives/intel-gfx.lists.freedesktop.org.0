...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 167A8702901
	for <lists+intel-gfx@lfdr.de>; Mon, 15 May 2023 11:40:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 19D2A10E18E;
...
Subject: [Intel-gfx] [PATCH v2 02/12] drm/armada: Use regular fbdev I/O
 helpers

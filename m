...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B96A7C9081
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 00:48:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0497810E644;
...
Subject: [Intel-gfx] [PATCH v7b 02/25] dyndbg: reword "class unknown,
 " to "class:_UNKNOWN_"

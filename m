...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AD2655224A
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jun 2022 18:30:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D7FE210E14D;
	Mon, 20 Jun 2022 16:30:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 01EE210E09F;
 Mon, 20 Jun 2022 16:30:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655742615; x=1687278615;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=NkEhSfab4o2ypBKD9fuSOW1b0IqNWSginE4MLm2LdBo=;
 b=Ave7HPJLN17AbtkLNTLfWxwnOHEIEuazZ7xf1p8O3AlhbKWpxZud7+kv
 X70zOgSw7Tcjxgc5Cvv1CbL8Ua3lcOvwhqwm3Lo//depo9ioVXtke0Fq8
 Eddcto7I/dx7fq13Ytn6hATiJMfMavCbaajGotdD55nfCGNXvYwcEXW4Z
 czycG7OeJRdJUA51dnlibC3K9hiUCMaUCkzGN/+RV8NCOUWYZ6TJ59UlK
 W68alcsDd0JN2MlGjkBo6nwvD+Gx6tE3SX+kNKGo/ktDPU3Y2u8ln6s01
 NMndZhA39V1HQfW17OGRUR8qedmPZTPx3vSPmuTcjLY+s82BWLN7t+tOf g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10384"; a="280991148"
X-IronPort-AV: E=Sophos;i="5.92,207,1650956400"; d="scan'208";a="280991148"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jun 2022 09:30:14 -0700
X-IronPort-AV: E=Sophos;i="5.92,207,1650956400"; d="scan'208";a="729458986"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jun 2022 09:30:04 -0700
Date: Mon, 20 Jun 2022 09:29:45 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Message-ID: <20220620162944.GW376@nvishwa1-DESK>
...
In-Reply-To: <c153dc07-f44d-ba83-cad6-2005a497a519@linux.intel.com>

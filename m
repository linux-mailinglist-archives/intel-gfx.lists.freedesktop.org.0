...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 970536648CF
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Jan 2023 19:15:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC37110E134;
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915/display: Avoid full proxy f_ops

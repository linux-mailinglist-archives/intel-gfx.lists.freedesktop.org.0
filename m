...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 376838C6744
	for <lists+intel-gfx@lfdr.de>; Wed, 15 May 2024 15:23:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8013010E896;
	Wed, 15 May 2024 13:23:15 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="TomHrwIa";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CC89610E877
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 May 2024 13:23:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1715779394; x=1747315394;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=fDIFudGbeEy4/P3OA/b+SfeYWJ3gP+M84pnelwOhpH0=;
 b=TomHrwIa1/4jxwJSZqYcs3mGC/qsYc3ypX/zuT1lkR3eXNakI635DEbJ
 lVgX0YN/qJKfLzE2ybfav8G5HQHX15GNnve0l+hnIyb+PhYKLzsGn6KOP
 fbrjrlxDl2nZLevuldkcfm1i0ndav/odpF0xjHMqu/tbYNhz8t0lQfSmx
 OC93AHBh1w6V6DUg6JlCoJxlaTEKkoME84AHV3V6m6cQPlDJRdbLhVvm5
 LjkyXuOvwwlvvMMsdDvso0u0wBKyaq0RdSKUw1NDLdNpbMPsMMVnXYx/1
 8mm6MrChz9ayTMy0j+uLzzEl435ADaaWCdKAijXahFgPsixEDft3CSOeK A==;
X-CSE-ConnectionGUID: vlVZs8TiSg+3ErNi2dTCtw==
X-CSE-MsgGUID: 5WbIyu4JQ+iwCXfXU4NcaQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11073"; a="29348279"
X-IronPort-AV: E=Sophos;i="6.08,161,1712646000"; d="scan'208";a="29348279"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2024 06:23:13 -0700
X-CSE-ConnectionGUID: D934dRe/RaKa5a4P40mtbw==
X-CSE-MsgGUID: JNYKtbswS3q2IJh0wwwHZw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,161,1712646000"; d="scan'208";a="31180548"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2024 06:23:13 -0700
Date: Wed, 15 May 2024 16:23:14 +0300
From: Imre Deak <imre.deak@intel.com>
To: Jani Nikula <jani.nikula@linux.intel.com>
Cc: intel-gfx@lists.freedesktop.org
Subject: Re: [PATCH 17/20] drm/i915/dp: Add debugfs entries to set a target
 link rate/lane count
Message-ID: <ZkS3Qji96jnJh+fn@ideak-desk.fi.intel.com>
References: <20240514191418.2863344-1-imre.deak@intel.com>
 <20240514191418.2863344-18-imre.deak@intel.com>
 <87bk57cjcs.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <87bk57cjcs.fsf@intel.com>

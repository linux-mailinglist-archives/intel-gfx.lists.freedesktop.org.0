...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 30F5B627FB2
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 14:01:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D7F010E237;
...
Subject: [Intel-gfx] [PATCH v9 03/25] drm/connector: Rename legacy TV
 property

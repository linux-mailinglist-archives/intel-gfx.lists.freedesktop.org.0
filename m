...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 772D86DCB85
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Apr 2023 21:26:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D620310E214;
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/guc: Dump error capture to dmesg
 on CTB error

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4556D80F38B
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Dec 2023 17:50:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B5FF10E631;
	Tue, 12 Dec 2023 16:50:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id 42AD910E61E;
 Tue, 12 Dec 2023 16:50:13 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 0545BA0078;
 Tue, 12 Dec 2023 16:50:13 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============2886877725139905614=="
MIME-Version: 1.0
...
Date: Tue, 12 Dec 2023 16:50:12 -0000
Message-ID: <170239981299.31292.13526141988416427315@emeril.freedesktop.org>
...
<p>Serious unknown changes coming with Patchwork_127680v2 absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_127680v2, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them<br />
...
<p>Here are the unknown changes that may have been introduced in Patchwork_127680v2:</p>
<h3>IGT changes</h3>
...
<ul>
<li>bat-adlp-11:        <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_14010/bat-adlp-11/igt@kms_cursor_legacy@basic-flip-after-cursor-atomic.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_127680v2/bat-adlp-11/igt@kms_cursor_legacy@basic-flip-after-cursor-atomic.html">SKIP</a> +5 other tests skip</li>
</ul>
</li>
<li>
<p>igt@kms_pipe_crc_basic@read-crc:</p>
<ul>
<li>bat-adlp-11:        NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_127680v2/bat-adlp-11/igt@kms_pipe_crc_basic@read-crc.html">SKIP</a> +8 other tests skip</li>
</ul>
</li>
</ul>
<h4>Warnings</h4>

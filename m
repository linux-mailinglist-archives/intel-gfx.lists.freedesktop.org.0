...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4EBC3EB79A
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Aug 2021 17:19:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9AD86E862;
	Fri, 13 Aug 2021 15:19:29 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 4/9] i915/gvt: remove spaces in pr_debug

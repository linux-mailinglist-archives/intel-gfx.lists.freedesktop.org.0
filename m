...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0D7160CA05
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Oct 2022 12:27:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 96E7C10E345;
	Tue, 25 Oct 2022 10:27:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3E9E010E33C
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=FUvbx97Ibe6Rj67vCW6g5ysmVbhvsgg12xgkyKmG0Gw=;
 b=Eg43CfPgQmK6+1RlPNMDV0+60FFvgFlIIqCASnWLb3VUJzWJpujmPTlB
 KTYdvoK8biU4sBE4+nLXJ4atpftAmtHtJ7+STY67BpuHNmOEZ4krkcbxg
 kvbkR6AYSpUKoafXkHWLD+gcvll/ofNGi5etsr1ZYmN9jmjMtnBM056SG
 HHguYR8t4YM7eA7rui94hlkOp9DagB7g0el74UPLXvntindjT2T8uMiLy
 qdWeVk1hQYwxhdTHtNDjjiafeppCZX+f9+22xcvu4BHekZN+wAaV8NWdD
 urVItsB98HtD7ZfthSlv1P7NdASTVgMQda8D9Jz6z2bwoQrOgIaEr2Nq4 Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10510"; a="305253716"
X-IronPort-AV: E=Sophos;i="5.95,211,1661842800"; d="scan'208";a="305253716"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Oct 2022 03:26:55 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10510"; a="720806801"
X-IronPort-AV: E=Sophos;i="5.95,211,1661842800"; d="scan'208";a="720806801"
Received: from ideak-desk.fi.intel.com ([10.237.68.144])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Oct 2022 03:26:54 -0700
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Oct 2022 13:26:44 +0300
Message-Id: <20221025102644.2123988-5-imre.deak@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 4/4] drm/i915/tgl+: Sanitize DKL PHY register
 definitions
...
index 189201278f590..ab6f676f356ae 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 30DEA495092
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jan 2022 15:54:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A9A610E4E5;
	Thu, 20 Jan 2022 14:54:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6026F10E3E0
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jan 2022 14:54:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642690451; x=1674226451;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=KouDzCGiAefRsyUw/NL0wuckYFXtWMkazvBlpSx3e3Q=;
 b=LpHfYrqj5xyT87wXNoOznsxbF/ISJfg3wX4yIRLbfPyBXwcInIt0FoxO
 PpB6oGtE9jSNmP/JuBWUtUfZEM2iK3dE71cdH7+o6xKV66GEI3J1mKW2y
 4xRt+Ov6RRevl33viVzWQeBpfUPcuoFAHbggRuY0ySgU2aOrK36Mapg1U
 A5T0B6Py4IeWLhgz0shthb6DjogD6tnWg8NLkAP8PySpy8T6FjNydxeOD
 e3jickFoKPu6VFh2LihpAVf940ylqFWsGmEiivWypPeH9YcBtGui27Lqh
 6K97zculvuGGkJ/z+9q0tlgtmVISDYSJai/AX4CeV8HRiJNTkcpFeyTWk A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10232"; a="306098895"
X-IronPort-AV: E=Sophos;i="5.88,302,1635231600"; d="scan'208";a="306098895"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2022 06:54:11 -0800
X-IronPort-AV: E=Sophos;i="5.88,302,1635231600"; d="scan'208";a="532797582"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2022 06:54:07 -0800
...
Date: Thu, 20 Jan 2022 16:53:47 +0200
Message-Id: <20220120145351.520555-2-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/5] drm/i915/gsc: add gsc as a mei auxiliary
 device

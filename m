...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2352D243692
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Aug 2020 10:37:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A56C6E99B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/20] drm/omapdrm: Introduce GEM object
 functions

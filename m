...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EA24D4E32CE
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Mar 2022 23:44:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B31F10E4C5;
...
Subject: [Intel-gfx] [PATCH v5 6/9] drm/i915/gt: offset handling for

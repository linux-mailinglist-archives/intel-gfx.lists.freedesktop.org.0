...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC7A3AC1C9C
	for <lists+intel-gfx@lfdr.de>; Fri, 23 May 2025 07:48:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDDF310E6EC;
	Fri, 23 May 2025 05:48:45 +0000 (UTC)

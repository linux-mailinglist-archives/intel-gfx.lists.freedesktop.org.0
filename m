...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C85A021FF63
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D9D26EA0C;
...
Subject: [Intel-gfx] [PATCH v2 29/59] drm/kmb: Defer Probe

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A65734AC96
	for <lists+intel-gfx@lfdr.de>; Fri, 26 Mar 2021 17:33:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5AD66E237;
	Fri, 26 Mar 2021 16:33:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4625B6E237
 for <intel-gfx@lists.freedesktop.org>; Fri, 26 Mar 2021 16:33:47 +0000 (UTC)
IronPort-SDR: lDFoZBg2zkIouoFGv+FMtnzjNi8R6SUm08VbSolRzmd0Ni39O0HKNptMtFSUCkSuhdLA/FYw4Q
 rCKKlu3x/bXw==
X-IronPort-AV: E=McAfee;i="6000,8403,9935"; a="252531799"
X-IronPort-AV: E=Sophos;i="5.81,281,1610438400"; d="scan'208";a="252531799"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Mar 2021 09:33:46 -0700
IronPort-SDR: BHCJDEcvRx/m8uvK54w2uHuSJOCnisKOfhmEWr3iw1X9NEOrwSrj51Eox57z2ZJHxHeX4j1Vj5
 BrBKVO6OUmzQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,281,1610438400"; d="scan'208";a="382698672"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.171])
 by fmsmga007.fm.intel.com with SMTP; 26 Mar 2021 09:33:44 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 26 Mar 2021 18:33:43 +0200
Date: Fri, 26 Mar 2021 18:33:43 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <YF4M53Gs4U9HaeA0@intel.com>
...
> @@ -271,7 +271,7 @@ int i9xx_check_plane_surface(struct intel_plane_state=
 *plane_state)
...
\n");
> @@ -311,9 +311,9 @@ int i9xx_check_plane_surface(struct intel_plane_state=
 *plane_state)
...
>  	return 0;
>  }
> @@ -424,8 +424,8 @@ static void i9xx_update_plane(struct intel_plane *pla=
ne,
...
> @@ -439,14 +439,14 @@ static void i9xx_update_plane(struct intel_plane *p=
lane,
...
> @@ -45,7 +45,7 @@ static u32 intel_cursor_base(const struct intel_plane_s=
tate *plane_state)
>  	else
...
tate)
> @@ -125,9 +125,9 @@ static int intel_cursor_check_surface(struct intel_pl=
...
>  	return 0;
>  }
> @@ -194,7 +194,7 @@ static u32 i845_cursor_ctl(const struct intel_crtc_st=
ate *crtc_state,
>  {
...
ate)
> @@ -233,7 +233,7 @@ static int i845_check_cursor(struct intel_crtc_state =
*crtc_state,
>  	}
>  =
...
> @@ -1013,7 +1013,7 @@ static bool intel_plane_uses_fence(const struct int=
...
> @@ -1680,9 +1680,9 @@ intel_find_initial_plane_obj(struct intel_crtc *int=
el_crtc,
>  =
...
>  	__i915_vma_pin(vma);
> @@ -1723,7 +1723,7 @@ intel_plane_fence_y_offset(const struct intel_plane=
_state *plane_state)
>  	int x =3D 0, y =3D 0;
>  =
...
>  	return y;
>  }
> @@ -6787,8 +6787,6 @@ static int icl_check_nv12_planes(struct intel_crtc_=
state *crtc_state)
...
> @@ -9320,8 +9318,8 @@ static int intel_atomic_check_async(struct intel_at=
omic_state *state)
>  			return -EINVAL;
>  		}
>  =
...
> @@ -423,8 +423,8 @@ static int intel_fb_check_ccs_xy(const struct drm_fra=
...
> +	main_x =3D intel_fb->normal_view.color_plane[main_plane].x % tile_width;
> +	main_y =3D intel_fb->normal_view.color_plane[main_plane].y % tile_heigh=
t;
>  =

>  	/*
>  	 * CCS doesn't have its own x/y offset register, so the intra CCS tile
> @@ -435,8 +435,8 @@ static int intel_fb_check_ccs_xy(const struct drm_fra=
mebuffer *fb, int ccs_plane
...
>  		return -EINVAL;
>  	}
> @@ -487,7 +487,7 @@ static bool intel_plane_can_remap(const struct intel_=
...
>  }
> @@ -584,7 +584,7 @@ static u32 setup_fb_rotation(int plane, const struct =
...
> +	struct intel_rotation_info *rot_info =3D &intel_fb->rotated_view.gtt.ro=
tated;
>  	unsigned int pitch_tiles;
>  	struct drm_rect r;
>  =

> @@ -598,7 +598,7 @@ static u32 setup_fb_rotation(int plane, const struct =
intel_remapped_plane_info *
>  =
...
> +	intel_fb->rotated_view.color_plane[plane].pitch =3D plane_info->height =
* tile_height;
>  =

>  	/* rotate the x/y offsets to match the GTT view */
>  	drm_rect_init(&r, x, y, width, height);
> @@ -610,7 +610,7 @@ static u32 setup_fb_rotation(int plane, const struct =
intel_remapped_plane_info *
>  	y =3D r.y1;
>  =
...
> +	pitch_tiles =3D intel_fb->rotated_view.color_plane[plane].pitch / tile_=
height;
>  	swap(tile_width, tile_height);
>  =

>  	/*
> @@ -626,8 +626,8 @@ static u32 setup_fb_rotation(int plane, const struct =
intel_remapped_plane_info *
...
>  }
> @@ -742,8 +742,8 @@ int intel_fill_fb_info(struct drm_i915_private *i915,=
 struct drm_framebuffer *fb
>  		 * First pixel of the framebuffer from
...
> @@ -785,7 +785,7 @@ static void intel_plane_remap_gtt(struct intel_plane_=
state *plane_state)
...
> @@ -793,8 +793,8 @@ static void intel_plane_remap_gtt(struct intel_plane_=
state *plane_state)
...
> @@ -835,8 +835,8 @@ static void intel_plane_remap_gtt(struct intel_plane_=
state *plane_state)
...
> @@ -860,13 +860,13 @@ static void intel_plane_remap_gtt(struct intel_plan=
e_state *plane_state)
>  			y =3D r.y1;
>  =
...
> +			plane_state->view.color_plane[i].pitch =3D pitch_tiles * tile_height;
>  =
...
>  		/*
> @@ -880,9 +880,9 @@ static void intel_plane_remap_gtt(struct intel_plane_=
state *plane_state)
>  =
...
> @@ -895,7 +895,7 @@ void intel_fill_fb_ggtt_view(struct i915_ggtt_view *v=
iew,
...
> @@ -917,7 +917,7 @@ static int intel_plane_check_stride(const struct inte=
...
> @@ -955,18 +955,18 @@ int intel_plane_compute_gtt(struct intel_plane_stat=
e *plane_state)
...
> @@ -716,8 +716,8 @@ static void intel_fbc_update_state_cache(struct intel=
_crtc *crtc,
>  	 */
...
> @@ -725,7 +725,7 @@ static void intel_fbc_update_state_cache(struct intel=
_crtc *crtc,
...
> @@ -1298,7 +1298,7 @@ g4x_sprite_check_scaling(struct intel_crtc_state *c=
rtc_state,
...
> @@ -582,7 +582,7 @@ static u32 skl_plane_stride(const struct intel_plane_=
state *plane_state,
>  {
...
> +		aux_dist =3D plane_state->view.color_plane[aux_plane].offset - surf_ad=
dr;
>  =
...
> @@ -1269,9 +1270,9 @@ skl_check_main_ccs_coordinates(struct intel_plane_s=
tate *plane_state,
>  			       int ccs_plane)
>  {
>  	const struct drm_framebuffer *fb =3D plane_state->hw.fb;
...
>  	int hsub;
>  	int vsub;
> @@ -1301,9 +1302,9 @@ skl_check_main_ccs_coordinates(struct intel_plane_s=
tate *plane_state,
...
>  	return true;
>  }
> @@ -1316,7 +1317,7 @@ int skl_calc_main_surface_offset(const struct intel=
...
> @@ -1344,7 +1345,7 @@ int skl_calc_main_surface_offset(const struct intel=
_plane_state *plane_state,
...
>  					    "Unable to find suitable display surface offset due to X-tiling=
\n");
> @@ -1403,8 +1404,8 @@ static int skl_check_main_surface(struct intel_plan=
e_state *plane_state)
...
>  			return -EINVAL;
> @@ -1413,9 +1414,9 @@ static int skl_check_main_surface(struct intel_plan=
e_state *plane_state)
>  =
...
> @@ -1456,7 +1457,7 @@ static int skl_check_nv12_aux_surface(struct intel_=
plane_state *plane_state)
>  =
...
> @@ -1477,8 +1478,8 @@ static int skl_check_nv12_aux_surface(struct intel_=
plane_state *plane_state)
>  								   offset, offset - alignment);
>  		}
>  =
...
>  				    "Unable to find suitable display surface offset due to CCS\n");
>  			return -EINVAL;
> @@ -1487,9 +1488,9 @@ static int skl_check_nv12_aux_surface(struct intel_=
plane_state *plane_state)
>  =
...
>  	return 0;
>  }
> @@ -1526,13 +1527,9 @@ static int skl_check_ccs_aux_surface(struct intel_=
plane_state *plane_state)
>  							    plane_state,
>  							    ccs_plane);
>  =
...
> +		plane_state->view.color_plane[ccs_plane].x =3D (x * hsub + src_x % hsu=
b) / main_hsub;
> +		plane_state->view.color_plane[ccs_plane].y =3D (y * vsub + src_y % vsu=
b) / main_vsub;
>  	}
>  =

>  	return 0;
> @@ -1567,10 +1564,10 @@ static int skl_check_plane_surface(struct intel_p=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E4E26B0DAB
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 16:54:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 19A9A10E682;
...
Subject: [Intel-gfx] [PATCH v10 14/15] drm/msm/atomic: Switch to
 vblank_start helper
...
Cc: Rob Clark <robdclark@chromium.org>, Vinod Koul <vkoul@kernel.org>,
 ...
 Liu Shixin <liushixin2@huawei.com>, Luben Tuikov <luben.tuikov@amd.com>,

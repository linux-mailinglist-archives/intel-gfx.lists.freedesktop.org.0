...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DBD7C79870F
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Sep 2023 14:34:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09C0A10E8AA;
	Fri,  8 Sep 2023 12:34:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8DF8D10E8A4;
 Fri,  8 Sep 2023 12:34:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1694176461; x=1725712461;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=hacE+i7chgQ9114zsM+ng4i72J6Nk9+HDDsyzr7orsU=;
 b=S2Ph+m2IYd0gGKKt6JHOLwd804aVM3aC+TaKwDJ56yaonP8kEVNlyPXq
 fUS1ZncY+VD51PORFU4GSMtP7qHSwBOGpgmJ27/VPDaEc5zhZl5TQYbde
 GASGpBxgnxorVzWGC5fVAjciTsdi32q+CLOwrMzJl93Y+AVhtXcRITHz7
 TW2mIp2At/ADQ4/SqoWTAlmqJCKNZ1QEG1O+UsSBOW/YCmhityGObo4zi
 dLT12qcvGOh4bp+owYLmmoYKdbMMh5CXQ5PCOq51Xt03GKHbO5e8WtAFS
 43Iuwu/H0kjLgVYofZua+0mw/bKevDXNMPYjZqppU+pndCC3WLwRCMkG8 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10827"; a="375014943"
X-IronPort-AV: E=Sophos;i="6.02,237,1688454000"; d="scan'208";a="375014943"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Sep 2023 05:34:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10827"; a="857381904"
X-IronPort-AV: E=Sophos;i="6.02,237,1688454000"; d="scan'208";a="857381904"
Received: from jkrzyszt-mobl2.ger.corp.intel.com ([10.213.28.201])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Sep 2023 05:34:19 -0700
From: Janusz Krzysztofik <janusz.krzysztofik@linux.intel.com>
To: igt-dev@lists.freedesktop.org
Date: Fri,  8 Sep 2023 14:32:35 +0200
Message-ID: <20230908123233.137134-20-janusz.krzysztofik@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH i-g-t v2 01/17] lib/kunit: Drop unused file
 stream

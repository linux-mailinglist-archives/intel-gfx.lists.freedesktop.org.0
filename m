...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE6E27E0A28
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Nov 2023 21:19:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B07F10EA99;
...
Subject: [Intel-gfx] [PATCH v4 14/16] drm/i915/dsi: Replace poking of CHV

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B64346BCADB
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 10:30:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D22F310E0BD;
	Thu, 16 Mar 2023 09:30:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B1AA710E0BD
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Mar 2023 09:30:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678959033; x=1710495033;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=31QXUp4Ea+FuK3F8mxEJHeNCKa4vr8SjaqGafyBbb5g=;
 b=FgBDsanhi9oqeAVQmoQlpECqYKJKh/MXkaTKiGLFbxBQJNEg9WJwp+XQ
 E74shUMLTGy3wku0gzyclU5lEWt7/XtoqdTsGcACxgj8sezEFtzMkjgr3
 if6pNZWZsQRDX3ZK9KJ944+Z88jS9snArBN7Nivh7cI0QyX1xi1C5mo8q
 yZHlnRa/ilm0a4S+QmoV0et6B5PftGCNOVq7e6WWV55hn8iiE6EKp26Sr
 53oxC8jTFUtXQ/rxZt1831/IUN0jOpn+64Cy1JAUQHpwdWQXBYzOOfrqy
 9kw3l31h223I4q5EIb30/Fyi+tE7Ny4VbnL2axpH3yTCKFddVcIfYSdU5 Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="317587706"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="317587706"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 02:30:33 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="853942509"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="853942509"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga005.jf.intel.com with ESMTP; 16 Mar 2023 02:30:30 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 16 Mar 2023 14:59:27 +0530
Message-Id: <20230316092927.668980-7-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v13 6/6] drm/i915/mtl: Add HDCP GSC interface

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6540E48727C
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jan 2022 06:30:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A33F211324B;
...
Subject: [Intel-gfx] [PATCH v11 09/19] drm_print: add

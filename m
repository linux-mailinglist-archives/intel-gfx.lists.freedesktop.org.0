...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id +G7KFIbKAWqfjwEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 11 May 2026 14:24:38 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB46450D9F0
	for <lists+intel-gfx@lfdr.de>; Mon, 11 May 2026 14:24:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF72710E6FA;
	Mon, 11 May 2026 12:24:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="1TliH582";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="7tQo485y";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="1TliH582";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="7tQo485y";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4A12910E6F9
 for <intel-gfx@lists.freedesktop.org>; Mon, 11 May 2026 12:24:34 +0000 (UTC)
Received: from imap1.dmz-prg2.suse.org (unknown [10.150.64.97])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-out2.suse.de (Postfix) with ESMTPS id 0492E67DFC;
 Mon, 11 May 2026 12:24:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1778502267; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=uAYse+Ps61+kDgO4XkZV97cS1iTBoGPx4O/MZSrB+Z8=;
 b=1TliH582DmTvHR1uJ4nn/OQgHjDmjmT+/YF5kLSzN5/92V2f1c+yZZlEMGRn0todO2LCUD
 c1RozhFP61LIVIEc0ER+tBZSkxzlZsXWsZFzrDBT2/JUTf4Vayd70NqldMruOUPpGzR/ZB
 jLERSk2f5H04uY4k0XVHDVWm7QkpoTo=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 s=susede2_ed25519; t=1778502267;
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=uAYse+Ps61+kDgO4XkZV97cS1iTBoGPx4O/MZSrB+Z8=;
 b=7tQo485yt123uCG2fjtVmM0hUknGqp5BweC+J4hgrqyk2lLrDFOFmaOjJe4PSMAc9ozIeG
 xs+2YCN4ffdMz2Aw==
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 8AFC4593A9;
 Mon, 11 May 2026 12:24:26 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id wGLLIHrKAWolYwAAD6G6ig
...
Subject: [PATCH v2 05/10] drm/appletbdrm: Allocate request/response buffers in
 begin_fb_access
Date: Mon, 11 May 2026 14:22:29 +0200
Message-ID: <20260511122421.114014-6-tzimmermann@suse.de>
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[suse.de:email,suse.de:mid,suse.de:dkim,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,proton.me:email]

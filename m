...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE3172B8B27
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Nov 2020 06:55:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D58089F19;
	Thu, 19 Nov 2020 05:55:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 902F589F19
 for <intel-gfx@lists.freedesktop.org>; Thu, 19 Nov 2020 05:55:30 +0000 (UTC)
IronPort-SDR: +vgZQslzqZgOngGyuHUWus+sIY3yB6XC/AoO8Ads2wYOlqbDf/t6Kn2wSwEIKI6sfmiHhm9h99
 6EDJOVm5eTuw==
X-IronPort-AV: E=McAfee;i="6000,8403,9809"; a="168665317"
X-IronPort-AV: E=Sophos;i="5.77,489,1596524400"; d="scan'208";a="168665317"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Nov 2020 21:55:30 -0800
IronPort-SDR: MlrohF2HIB71nYs9JSq6rYsK2lu/IoLuzamLJf74xr5wuCcLvOcheHT0Wfji17U7KNeK3R0BrR
 yWeUkNMlOOMw==
X-IronPort-AV: E=Sophos;i="5.77,489,1596524400"; d="scan'208";a="544867186"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO labuser-Z97X-UD5H)
 ([10.165.21.211])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Nov 2020 21:55:29 -0800
Date: Wed, 18 Nov 2020 21:58:03 -0800
From: "Navare, Manasi" <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Message-ID: <20201119055803.GA28088@labuser-Z97X-UD5H>
...
<1>[   44.315382] BUG: unable to handle page fault for address: ffffc90049e=
02100
...
<4>[   44.315552] Hardware name: Intel Corporation Tiger Lake Client Platfo=
rm/TigerLake Y LPDDR4x T4 Crb, BIOS TGLSFWI1.R00.2527.A03.2001170231 01/17/=
2020
<4>[   44.315981] RIP: 0010:gen12_fwtable_read32+0x6f/0x2f0 [i915]
<4>[   44.316016] Code: c6 48 8b 43 08 8b b0 98 0d 00 00 85 f6 0f 85 53 01 =
00 00 89 ee 48 89 df e8 fe a6 ff ff 85 c0 0f 85 bc 00 00 00 89 e8 48 03 03 =
<44> 8b 38 48 8b 43 08 8b 90 98 0d 00 00 85 d2 0f 85 a8 01 00 00 4c
...
89 ca 4d 89 c2 4d 89 c8 4c 8b 4c 24 08 0f 05 <48> 3d 01 f0 ff ff 73 01 c3 4=
8 8b 0d 1f f6 2c 00 f7 d8 64 89 01 48
<4>[   44.321749] RSP: 002b:00007ffda8ea9358 EFLAGS: 00000246 ORIG_RAX: 000=
0000000000139
<4>[   44.321782] RAX: ffffffffffffffda RBX: 000056004d10ffc0 RCX: 00007fad=
885f5839
<4>[   44.321808] RDX: 0000000000000000 RSI: 000056004d0f5490 RDI: 00000000=
0000000f
<4>[   44.321834] RBP: 000056004d0f5490 R08: 0000000000000000 R09: 00007ffd=
a8ea9470
<4>[   44.321859] R10: 000000000000000f R11: 0000000000000246 R12: 00000000=
00000000
<4>[   44.321884] R13: 000056004d0f20c0 R14: 0000000000020000 R15: 00000000=
00000000
<4>[   44.321921] Modules linked in: i915(+) mei_hdcp x86_pkg_temp_thermal =
coretemp crct10dif_pclmul crc32_pclmul snd_hda_intel snd_intel_dspcfg ghash=
_clmulni_intel snd_hda_codec cdc_ether snd_hwdep usbnet snd_hda_core mii e1=
000e ptp snd_pcm pps_core mei_me mei prime_numbers intel_lpss_pci(+)

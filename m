...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EA1E11029B
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 17:40:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F417C6E9FF;
	Tue,  3 Dec 2019 16:40:02 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 09/12] HID: picoLCD: constify fb ops

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2864150CFA
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jun 2019 15:58:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D9B689B57;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 NgVw==
Subject: [Intel-gfx] [PATCH 1/6] dma-buf: add dynamic DMA-buf handling v11

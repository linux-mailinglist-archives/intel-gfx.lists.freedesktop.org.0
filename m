...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D75359C3C1C
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Nov 2024 11:35:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78D6710E47A;
	Mon, 11 Nov 2024 10:35:22 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PTEo6AAL";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 205FA10E47A;
 Mon, 11 Nov 2024 10:35:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1731321321; x=1762857321;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=poavXy2JBKNz9Rb6+kbCvVgLEXqj9lAgUHgctlC7yp0=;
 b=PTEo6AALhcRvx3nLRG0EJ/sod5pPbLNJYBiND/nTvde/JOGlAVQgrZyq
 NeH24QtIZa44NqgvCqHH6TQxSkYSon382SC/pPyerkzUMukGJgzIuw5v+
 CCvjsrl3VqOHgExM1VqHXUQy+1js7CMJLDLOswNNA1aU7xm4SfIHySVPk
 2el3nfh/o1vSxYcvZUUEhnwNpeCuxbMFWJzv6K7alzmP+pau5Kih8o1lN
 sQx3BY+2PXD/KS9CQf5BU/TwLTibphnvg8pszIys2WigneCI6uJVr/5i/
 6bMxcRvD6MDqb/LL3pMb+/zxiyl9I7R57L3OU14MIKoWFZDj8RAmoCt0w A==;
X-CSE-ConnectionGUID: 4bCZLWI9Rs2QFdLEDQBgag==
X-CSE-MsgGUID: pBeSXPtYQcWiJfytS8W3CQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11252"; a="42507763"
X-IronPort-AV: E=Sophos;i="6.12,144,1728975600"; d="scan'208";a="42507763"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2024 02:35:21 -0800
X-CSE-ConnectionGUID: qsg5utyzQiytO/8PolzHNA==
X-CSE-MsgGUID: gzyO4Ko6Ti6a5YF3c29/cQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,144,1728975600"; d="scan'208";a="87009805"
Received: from carterle-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.75])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2024 02:35:18 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, Vinod Govindapillai <vinod.govindapillai@intel.com>
Subject: [CI v3 13/15] drm/i915/display: convert display device identification
 to struct intel_display
Date: Mon, 11 Nov 2024 12:34:02 +0200
Message-Id: <865b27b66f599e707081d46fca9f679e19a4e8aa.1731321183.git.jani.nikula@intel.com>
...
index d941603230de..3773d3cf7692 100644
...
index a1b3e9f6d0cb..b40964d65497 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D245601B5
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Jul 2019 09:47:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0115C6E41F;
	Fri,  5 Jul 2019 07:47:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E5D6B6E417
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 Jul 2019 07:47:46 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17137011-1500050 
 for multiple; Fri, 05 Jul 2019 08:46:08 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  5 Jul 2019 08:45:59 +0100
Message-Id: <20190705074604.16496-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/8] drm/i915/gt: Track timeline activeness in
 enter/exit
...
IGUxYWUxMzk5YzcyYi4uNDczYzlhZTg4MThjIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF9scmMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9s
cmMuYwpAQCAtMzE4OCw2ICszMTg4LDggQEAgc3RhdGljIHZvaWQgdmlydHVhbF9jb250ZXh0X2Vu
...
LTMxOTUsNiArMzE5Nyw4IEBAIHN0YXRpYyB2b2lkIHZpcnR1YWxfY29udGV4dF9leGl0KHN0cnVj
...
aW5kZXggZWFlM2IxOTYzYmY3Li45ZjMxMDAxMzU1OTAgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 849AA2C245D
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Nov 2020 12:38:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64D716E39B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/15] drm/bochs: Remove references to struct
 drm_device.pdev

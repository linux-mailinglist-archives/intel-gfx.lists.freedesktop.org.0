...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFDC22C7E5
	for <lists+intel-gfx@lfdr.de>; Tue, 28 May 2019 15:38:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D92A89CC4;
	Tue, 28 May 2019 13:38:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7DABB89CC4
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 May 2019 13:38:18 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16706666-1500050 
 for multiple; Tue, 28 May 2019 14:37:57 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 28 May 2019 14:37:43 +0100
Message-Id: <20190528133750.12775-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/9] drm/i915: Keep contexts pinned until after
...
bV9wbS5jIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ2VtL2k5MTVfZ2VtX3BtLmMKaW5kZXggMTE4
OTBlOTZlZDY1Li44Y2ZjOGI5NjBlOTUgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1
...
aXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2VuZ2luZS5oCmluZGV4IDFjMGRiMTUxZjBiMS4u
ZmU5NDU0ZmFhYzcwIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9l
...

...
bmUpOwogCWlmIChlcnIpCiAJCXJldHVybiBlcnI7CkBAIC04NzAsNiArODcyLDcgQEAgdm9pZCBp
...
IC0xMjAwLDI2ICsxMjAzLDYgQEAgdm9pZCBpbnRlbF9lbmdpbmVzX3Jlc2V0X2RlZmF1bHRfc3Vi
...
aCBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2VuZ2luZV90eXBlcy5oCmluZGV4IDAx
MjIzODY0MjM3YS4uMzNhMzFhYTJkMmFlIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkx
...
ICNpbmNsdWRlICJpOTE1X2dlbS5oIgpAQCAtMjg4LDYgKzI4OSw3IEBAIHN0cnVjdCBpbnRlbF9l
...
CkBAIC00MzUsMTcgKzQzNyw2IEBAIHN0cnVjdCBpbnRlbF9lbmdpbmVfY3MgewogCiAJc3RydWN0
...
Yi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCmluZGV4IDhkY2NmMWRmNWNlNy4uYTk0
ODY4Mjg1MTllIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCisr
KyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZ2VtLmMKQEAgLTExNzcsMTAgKzExNzcsNiBA

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE89A2849BD
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Oct 2020 11:54:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A730B6E442;
	Tue,  6 Oct 2020 09:54:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 42D026E441;
 Tue,  6 Oct 2020 09:54:39 +0000 (UTC)
IronPort-SDR: hM/+lsmwH1jEcWEZhiK814283aWSlFk1tIVnE76bfdi70pt4DAOOv5S7QcvJr4ViPOmDvZlUQV
 aZ8ZfY/omQ3Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9765"; a="151361693"
X-IronPort-AV: E=Sophos;i="5.77,342,1596524400"; d="scan'208";a="151361693"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2020 02:54:38 -0700
IronPort-SDR: IOIQn/brO+HTAzdbpn4b9JdUGGlDsgzcOe9Zd4FOk+VNw08TlJjhMPNDw+zS8+dxyv4bPsTGfB
 X7JjLc8kQM2Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,342,1596524400"; d="scan'208";a="342171766"
Received: from unknown (HELO linux-akn.iind.intel.com) ([10.223.34.148])
 by fmsmga004.fm.intel.com with ESMTP; 06 Oct 2020 02:54:35 -0700
From: Ankit Nautiyal <ankit.k.nautiyal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Oct 2020 15:17:14 +0530
Message-Id: <20201006094719.24119-4-ankit.k.nautiyal@intel.com>
...
Subject: [Intel-gfx] [RFC 3/8] drm/dp_helper: Add FRL training support for a
 DP-HDMI2.1 PCON
...
index 478dd51f738d..39d8e4d665b7 100644
...
index 159191c1ae75..82fa75f6cc86 100644
...
@@ -1905,4 +1971,18 @@ int drm_dp_get_phy_test_pattern(struct drm_dp_aux *aux,

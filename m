...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B55EB4E7369
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Mar 2022 13:26:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 95EF410E70A;
	Fri, 25 Mar 2022 12:26:22 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 9/9] drm/edid: add more general struct edid

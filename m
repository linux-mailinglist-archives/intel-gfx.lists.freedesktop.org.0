...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA4B35FA983
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Oct 2022 02:56:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0FE1D10E769;
	Tue, 11 Oct 2022 00:56:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0955410E28D;
 Tue, 11 Oct 2022 00:55:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665449758; x=1696985758;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=Bmownshefc1BP5WO1WeW3C3o5zTwQM5Oi84wqPT6JEs=;
 b=YrewysyR2ay4bqCe79cUvE+FhsZM3I3B7KwvWxlpVRbJ7NPtTe/Kw+Jy
 ambVEuloxDF6416QDLIjhQl2j1FWWlPMvAD9a17l+LXlEztYeMi8lvJtw
 MwEx3LbL43f6RGzPwAciVVw+aHNbJinJ+uTsYwXF12xAnqS/UxKF5DDlH
 NG0SXwyOufH/BCVgTPBmhZyI1XEk6ITBbwz7DGGaZ7Ov2S7KK8mp0MPLa
 zAmEvXnF/1C6A8GjDXXjKn9aOvV7dzkCG9ocpd3sIYXBsbhL82qQ/yDzT
 IKCrkBIPsJuEf/VSt34SsTTCb3SEciOaZcWXfGMoHZ+KBeL9WEkfP6KWo g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="287636643"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="287636643"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2022 17:55:57 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="955136298"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="955136298"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2022 17:55:55 -0700
Date: Mon, 10 Oct 2022 17:55:32 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Matthew Auld <matthew.auld@intel.com>
Message-ID: <20221011005531.GG1773@nvishwa1-DESK>
References: <20221010065826.32037-1-niranjana.vishwanathapura@intel.com>
 ...
 <20221011004345.GF1773@nvishwa1-DESK>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1; format=flowed
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20221011004345.GF1773@nvishwa1-DESK>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A11C05B5806
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Sep 2022 12:17:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6125010E362;
	Mon, 12 Sep 2022 10:17:51 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v7 1/9] drm_print: condense enum
 drm_debug_category

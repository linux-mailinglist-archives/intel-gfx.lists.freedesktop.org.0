...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3CC07E0A0E
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Nov 2023 21:18:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5284910EA94;
...
Subject: [Intel-gfx] [PATCH v4 03/16] drm/i915/dsi: clarify GPIO exec
 sequence

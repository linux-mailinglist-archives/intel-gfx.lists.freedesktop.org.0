...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 38DE16FCBAA
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 18:51:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3D5610E39A;
	Tue,  9 May 2023 16:51:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0EA7210E39A;
 Tue,  9 May 2023 16:51:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683651066; x=1715187066;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=pKlEKH85QvGiaOe0C9yal2aOLmxqm5L/HDR8iidsJqo=;
 b=cwaL47oogDAgsnpGWborvmkGm18XXZ1Ct4yyuP6Mt7/C6S4qCgnCcaWr
 tSk+1ujsxFlOPqp6956mszbYjP9KbxciWkxmtWuRXi5ss6Cy/i6OE+/jO
 WIIWF35VDtGircl6CcZhq2SYy7xoUI+A4QWKglB03eLGKmR1DJUlWI4xD
 i1ZwI+o5p9bRSfPSJfzT6B0fyGxO+RMY8jjEDFLj+jo6HXdi/G6AICLcC
 rKgCRlT5mzVjWKfAa/1++jZXzri5jxvnUixAnxJiTmU2Fx5EsDHs6JaJA
 +6Ki7dN2hpDzYD7IMlY/xbEoB3eciHYgbixvmYObFleO7cn7m9UqhbBfd g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="347450582"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="347450582"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:51:05 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="649407027"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="649407027"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:51:04 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Tue,  9 May 2023 09:51:59 -0700
Message-Id: <20230509165200.1740-2-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230509165200.1740-1-fei.yang@intel.com>
References: <20230509165200.1740-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v8 1/2] drm/i915: preparation for using PAT index

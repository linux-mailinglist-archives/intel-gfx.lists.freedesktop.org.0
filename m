...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D55676CBEF
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Aug 2023 13:43:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5374310E081;
...
Subject: Re: [Intel-gfx] [PATCH 08/20] drm/display/dp: Fix the DP DSC
 Receiver cap size

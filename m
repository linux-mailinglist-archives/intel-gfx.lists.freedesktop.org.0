...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83E306DA945
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Apr 2023 09:11:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 66AB810EDB7;
	Fri,  7 Apr 2023 07:11:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3793010ED7C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=DATO/LtKDueMGZa8dBY/6HcTfxKEJr8wwIee4MYV2nU=;
 b=mSxF1080Vr7RaLSteSrCi7q96+usPSaYx3iXF5vBRk5nE/y1lpXiJGbt
 Y7rs9lkueloqNdo2SehzadXN0a1Zux6G2sEsqrTP4sbqRkEm1GnVu2zAw
 StudUJ9DKQwLl+2NJ7/TM9rigXSzCATDHjlqMnmDpSoKNS8L+KxWBvqub
 fUoYKerItWDMNtDUry3Qe8CwVwA0wEFv/y3bC7WSs7fyOEKU/fpnmVJ8P
 VuXhvvCspT5R2BRJKUjqosP4TaIcHcxo1SbgAnUs3HKPItO3v20ofjN+j
 07JghJ7Gcg7O9lqsgkgO768C7rhHMAmmBd3j9d6HDdIvDKPg2w9q69QqW g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10672"; a="344711198"
X-IronPort-AV: E=Sophos;i="5.98,326,1673942400"; d="scan'208";a="344711198"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2023 00:11:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10672"; a="680953429"
X-IronPort-AV: E=Sophos;i="5.98,326,1673942400"; d="scan'208";a="680953429"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2023 00:11:12 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Fri,  7 Apr 2023 00:12:34 -0700
Message-Id: <20230407071236.1960642-7-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH 6/8] drm/i915: use pat_index instead of
 cache_level
...
index 890f3ad497c5..862b5c1d2d21 100644
...
+	I915_CACHE_INVAL,
 ...
 enum i915_map_type {
@@ -351,10 +352,28 @@ struct drm_i915_gem_object {
...
index dd188dfcc423..dffd4a8f2dde 100644

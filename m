...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C619918B172
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Mar 2020 11:31:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E54316E9EA;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 4/5] drm/i915/display: Add Nearest-neighbor

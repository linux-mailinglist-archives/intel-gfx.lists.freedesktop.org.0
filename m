...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE131B34618
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Aug 2025 17:42:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DEA510E266;
	Mon, 25 Aug 2025 15:42:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="EytJjY0c";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CCB8210E038
 for <intel-gfx@lists.freedesktop.org>; Mon, 25 Aug 2025 15:42:41 +0000 (UTC)
...
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 ...
 us-mta-44-2rpBcnJ8P3ijrFRrmSdxzQ-1; Mon, 25 Aug 2025 11:42:39 -0400
X-MC-Unique: 2rpBcnJ8P3ijrFRrmSdxzQ-1
X-Mimecast-MFC-AGG-ID: 2rpBcnJ8P3ijrFRrmSdxzQ_1756136558
Received: by mail-wm1-f71.google.com with SMTP id
 5b1f17b1804b1-45a1b0d221aso22974975e9.3
 for <intel-gfx@lists.freedesktop.org>; Mon, 25 Aug 2025 08:42:38 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :reply-to;
 bh=5rvZAalDayw76mXlaVcK2G8fQoANSfCHvdaqQVOogfc=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCWBxmCBbHR5ynh9hS4EtySHMqRDY7rt/mkwbYpajoAtiJkczXH057plP7Nt8wrgQ45X4nPeGoEJzew=@lists.freedesktop.org
X-Gm-Message-State: AOJu0Yy3RxD2sQkLvxkHaUdIt0VDO7guSaD9hiODYOTVUw8je/RmC2fq
 EI4nBQgLBTXpgPS6jCze+W0JXfMLszFcH3ZaoYhoL0PzxikkF6eNwvnwMcwB5wu6F9QHwHHrK+o
 awQODBZmQhtCJ2BAz0s0RCCG3LsUiDHa8UzY6omZaf2z9ICkjtUpkLlapXTT13mwEFyemSA==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:a344:b0:459:443e:b180 with SMTP id
 5b1f17b1804b1-45b51f30f97mr116842565e9.8.1756136557867; 
...
X-Received: by 2002:a05:600c:a344:b0:459:443e:b180 with SMTP id
 5b1f17b1804b1-45b51f30f97mr116841885e9.8.1756136557395; 
 Mon, 25 Aug 2025 08:42:37 -0700 (PDT)
Received: from ?IPV6:2003:d8:2f4f:1300:42f1:98e5:ddf8:3a76?
 ...
 5b1f17b1804b1-45b57444958sm113196675e9.2.2025.08.25.08.42.34
...
X-Mimecast-MFC-PROC-ID: -nZPhLPSHRs-2zHAqBl9PIEAJXjaMQG5QFTpxMwP6jI_1756136558

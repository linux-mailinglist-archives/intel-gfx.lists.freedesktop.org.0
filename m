...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC3743C2B78
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Jul 2021 00:48:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC17C6E9AF;
	Fri,  9 Jul 2021 22:48:18 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 15/47] drm/i915/guc: Defer context unpin

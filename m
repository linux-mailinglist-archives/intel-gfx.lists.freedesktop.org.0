...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9824F671AE6
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 12:43:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5835810E6B5;
...
Subject: Re: [Intel-gfx] [PATCH v5 1/6] mei: mei-me: resume device in prepare

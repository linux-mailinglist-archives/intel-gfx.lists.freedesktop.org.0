...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E06A73B9789
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 22:26:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC2AF6EC47;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 44/53] drm/i915/dg2: Add vswing programming for
 SNPS phys

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C20CF5AA4A7
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Sep 2022 02:48:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC25110E42D;
...
Subject: [Intel-gfx] [PATCH 4/7] drm/i915/gt: Correct prefix on a few
 registers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 711B221C42
	for <lists+intel-gfx@lfdr.de>; Fri, 17 May 2019 19:11:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD78A8993B;
	Fri, 17 May 2019 17:11:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E889E8993B
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 May 2019 17:11:47 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 16592576-1500050 for multiple; Fri, 17 May 2019 18:11:40 +0100
MIME-Version: 1.0
...
Message-ID: <155811309885.1890.11861258173349936208@skylake-alporthouse-com>
User-Agent: alot/0.6
Date: Fri, 17 May 2019 18:11:38 +0100
...


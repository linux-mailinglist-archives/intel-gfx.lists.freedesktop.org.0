...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 40690430479
	for <lists+intel-gfx@lfdr.de>; Sat, 16 Oct 2021 21:17:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 11E5A6E4AF;
...
Subject: [Intel-gfx] [PATCH v2 04/13] drm/tegra: replace

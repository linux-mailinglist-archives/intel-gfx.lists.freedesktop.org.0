...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCD3F3327C9
	for <lists+intel-gfx@lfdr.de>; Tue,  9 Mar 2021 14:54:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F91F6E8F8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC v1 1/6] drm/edid: make a number of functions,

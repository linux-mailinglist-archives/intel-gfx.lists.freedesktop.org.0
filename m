...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DDC2F81816C
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Dec 2023 07:19:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0160710E3FA;
	Tue, 19 Dec 2023 06:19:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F066610E3FA
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 Dec 2023 06:19:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702966750; x=1734502750;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=aVAAA/Ef/W7EuyRQ9MD1cqBaANDXuzMvqqmV2z/Kmfo=;
 b=JFla7qj8CEmWCCzOFZJ82g9KTaHAIAhmrvpI1i99ftDVOhX4TEqTluQV
 y6E+c/N2SVd7ogbFTAuZKNPNdHjNefwFdszRs+XrhP/tP5QM6wZcHTQrv
 6XaS1rooIPc8bO1J3tLC7a3rw2QQce0mSqam7lmXUsJT06BdH4KUjcGUf
 oUVvjFlKT5mwWT/nB9Id8a6cYUwlGW4c/WWJ+oTGRoKYKyZk/Box8LtAq
 FyP6YA+c1zItp+yxVpLySwXh89Na5S2BsQ5a3+iWEXIj/EqkPk6D9BgjV
 plgzJD3jFSJLMpKfV+emyMzt2K227EjFwpPF6NU3kfQQc913be33VVx00 g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="14301613"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="14301613"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Dec 2023 22:19:09 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="775852249"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="775852249"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orsmga002.jf.intel.com with ESMTP; 18 Dec 2023 22:19:07 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH 1/3] drm: Add Adaptive Sync SDP logging
Date: Tue, 19 Dec 2023 11:44:24 +0530
Message-Id: <20231219061426.1205337-2-mitulkumar.ajitkumar.golani@intel.com>

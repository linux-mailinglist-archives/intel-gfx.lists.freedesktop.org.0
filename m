...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A8B37E8E64
	for <lists+intel-gfx@lfdr.de>; Sun, 12 Nov 2023 05:54:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17CEA10E115;
...
Subject: Re: [Intel-gfx] [PATCH 09/11] drm/i915/dp_mst: Use precision of
 1/16 for computing bpp

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C6823FC98F
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Aug 2021 16:18:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E053E6E062;
...
Subject: [Intel-gfx] [PATCH v2 4/6] drm/edid: parse the DisplayID v2.0 VESA

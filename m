...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C1EA57309D
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 10:14:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86DE395FB5;
...
Subject: [Intel-gfx] [PATCH v2 25/39] drm/i915: i915_vma_resource.c: fix

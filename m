...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 637B74A5A2A
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Feb 2022 11:38:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8042F10ED95;
...
Subject: Re: [Intel-gfx] [PATCH 08/20] drm/i915/buddy: adjust res->start

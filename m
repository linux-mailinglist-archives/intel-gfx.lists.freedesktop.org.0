...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC7DD4D572B
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Mar 2022 02:09:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59C5110E5E7;
...
Subject: [Intel-gfx] [v6 3/5] drm/edid: read HF-EEODB ext block

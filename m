...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8A488D7B1F
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Jun 2024 07:59:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D985E10E295;
	Mon,  3 Jun 2024 05:59:30 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ewr7Jc0k";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 939B610E10B;
 Mon,  3 Jun 2024 05:59:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1717394368; x=1748930368;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=CTHTXNDq1UjDGexgfT/VXL71EiVgibuqTX/UFYZKb2c=;
 b=ewr7Jc0kZ9RdSzVGx7Q6EFUu9C0o4cdq42RVaqm+d1KNc/eCv51/ZEya
 L4AIoPRA1vJe9Z5KjX0Vv9MUl0dMIR0gh2bsN5+NUa6wptkEzK6eog6Gt
 6pMzmD9aQ7qGgfnrteq4XjOunj5fR7xK2zFuXQDESGiCFnhmJeDkakSV0
 TFt7eRlnFRfIHJJPj+NLHzvV2tzJNFna2ITsgFfTR66Pswtr5Y2KXP+H0
 GmkCN/I2xL8RdeVfpX7+wV1ulWL7j7mRiKrqBoVah8SET0eUdXsVb6wMi
 L+IlTfFN8SPyxq0+uQ1R7PXGF5iPwVppcZXe0S7dNW+ZRnOjS381/ma3z A==;
X-CSE-ConnectionGUID: Jl9Px1HrTXmtSKW70ZI9Kg==
X-CSE-MsgGUID: YuCZ4T/5RD63zQKk9WvzUQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11091"; a="24527516"
X-IronPort-AV: E=Sophos;i="6.08,210,1712646000"; d="scan'208";a="24527516"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jun 2024 22:59:28 -0700
X-CSE-ConnectionGUID: 9oMRDgqcRWib7AJR1qBdKA==
X-CSE-MsgGUID: FjiNDhqgSDio7ZIxqc9jDQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,210,1712646000"; d="scan'208";a="67616486"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orviesa002.jf.intel.com with ESMTP; 02 Jun 2024 22:59:27 -0700
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: dri-devel@lists.freedesktop.org, ankit.k.nautiyal@intel.com,
 jani.nikula@intel.com
Subject: [PATCH v11 2/8] drm/i915: Define and compute Transcoder CMRR registers
Date: Mon,  3 Jun 2024 11:18:58 +0530
Message-Id: <20240603054904.222589-3-mitulkumar.ajitkumar.golani@intel.com>

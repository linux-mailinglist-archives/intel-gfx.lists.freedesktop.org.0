...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73B5721FF09
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:58:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E7476E972;
...
Subject: [Intel-gfx] [PATCH v2 03/59] drm/kmb: Set correct values in the
 LAYERn_CFG register

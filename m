...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C3842D28E1
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Dec 2020 11:29:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF3A96E955;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 7/8] drm/i915/gvt: make scheduler.h
 self-contained

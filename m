...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 85D1D72270A
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Jun 2023 15:11:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E9F810E29D;
...
Subject: [Intel-gfx] [PATCH] drm/i915/selftests: Add some missing error
 propagation

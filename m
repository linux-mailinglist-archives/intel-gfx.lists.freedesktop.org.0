...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9196E26C44B
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Sep 2020 17:35:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ACA216EA45;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 4/8] drm/i915: Do not call

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E3214EEDA7
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Apr 2022 15:02:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8338C10E2ED;
...
Subject: [Intel-gfx] [PATCH v8 2/3] i915/gvt: Save the initial HW state
 snapshot in i915

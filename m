...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C647C86DDA3
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Mar 2024 09:52:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1CEA210EC1C;
	Fri,  1 Mar 2024 08:52:12 +0000 (UTC)

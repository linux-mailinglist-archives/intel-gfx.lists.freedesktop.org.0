...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8CCBC4E62AA
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Mar 2022 12:48:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79ADD10E898;
	Thu, 24 Mar 2022 11:48:54 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D21FD10E898;
 Thu, 24 Mar 2022 11:48:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1648122533; x=1679658533;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=rfFxZsg/ByfZ9HWx3L0wFmumTPZd81ZDY33W7UO6oaU=;
 b=UA5oYjC3CfdWaNNk353NmIs0vH5v4cbCeTdPhS03mdH8PI3yJAa2iAcY
 gOD8po3qQ/F8PnbIV3jsaERF66Qczn+vpfmDPcz/bst1+Um3e3hAI929Y
 seYdFJOIhXllmcw2+RUAXyPnJRz9Na/7XUtieulz3hIv94GtOpcErMyYa
 93PWIIEPgcI2HXQyC6FokmqLndq/DQfmT2HaaITqMF5lD3SnKxkld1D3Q
 HRK7DlzgM6couHpdu1HBxAiNJln3dW2+jcErCBcWEWxFVN/zi/8vlsaqv
 /8A7UFxUnUia0IcW4BOuvrNpj3reunbHt0Un2yp2GcXaXTVbEwjsAHhKp w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10295"; a="238960330"
X-IronPort-AV: E=Sophos;i="5.90,207,1643702400"; d="scan'208";a="238960330"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2022 04:48:53 -0700
X-IronPort-AV: E=Sophos;i="5.90,207,1643702400"; d="scan'208";a="501364604"
Received: from keithgra-mobl.ger.corp.intel.com (HELO [10.213.230.179])
 ([10.213.230.179])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2022 04:48:51 -0700
Message-ID: <0078dd11-c958-7a60-19d1-e32446f0d9da@linux.intel.com>
Date: Thu, 24 Mar 2022 11:48:48 +0000
MIME-Version: 1.0

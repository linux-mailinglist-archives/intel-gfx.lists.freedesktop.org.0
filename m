...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45B0B2C2497
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Nov 2020 12:39:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C76BF6E446;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 13/15] drm/virtgpu: Remove references to struct
 drm_device.pdev

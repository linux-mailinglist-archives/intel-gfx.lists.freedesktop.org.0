...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C335A7662E5
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jul 2023 06:15:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD01710E64D;
...
Subject: [Intel-gfx] [PATCH 13/20] drm/i915/dp: Rename helper to get DSC max
 pipe_bpp

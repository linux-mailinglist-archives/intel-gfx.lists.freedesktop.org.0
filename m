...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE4B02F0E11
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jan 2021 09:26:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BF5C89FBC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 11/19] drm/i915/hdcp: Encapsulate

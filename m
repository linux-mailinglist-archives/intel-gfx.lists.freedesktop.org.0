...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6978CB20EAC
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Aug 2025 17:26:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 083D410E503;
	Mon, 11 Aug 2025 15:26:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VxpacMSC";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A2A6F10E502;
 Mon, 11 Aug 2025 15:26:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1754925961; x=1786461961;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=rUSs++oGXdQ12edIhwzjg7M7PZlHqW/mK84Sw5dTZgw=;
 b=VxpacMSCCvmWUOsy87nTLUsRrPS2ALJDmSV/xgAbnla2naCQn/vkuYfY
 ElcQkptcQouyftOPkWGwL8egMLyXYuQ8PoTOG2+MRXZZNEJqhhWxOqIW+
 JyLjsWOnfBR2RujAvFZ3Mcon0TvnJOcMhdXWSvBlo3ZoVhv+CHhl0BG14
 cunQit1IhyT2iqwBnm6GdHUWVDztnwrd7w6F9t/02JwQuLlrYUzpM6W0L
 eHvjlxOe5xdR9xRzrhUHwfnuC95bctfqZfd377TG4Jpyq5eChOcUZXcWv
 ZKkcnT3xe9Jb6IMfSnYvuR8GAQET2YkBR7XhSVKt+DKT6Gx+c3sb0USgv Q==;
X-CSE-ConnectionGUID: qt2PFV2MSWewKVpjP6bi0g==
X-CSE-MsgGUID: a8LkKEraQI67y920LPq0tw==
X-IronPort-AV: E=McAfee;i="6800,10657,11518"; a="57086302"
X-IronPort-AV: E=Sophos;i="6.17,278,1747724400"; d="scan'208";a="57086302"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by orvoesa113.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2025 08:26:01 -0700
X-CSE-ConnectionGUID: 3oCAVbk/T+WJ4RTS04/jog==
X-CSE-MsgGUID: eSMOidiAQKuCo45TMKhMaA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.17,278,1747724400"; d="scan'208";a="171294164"
Received: from mjarzebo-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.226])
 by orviesa005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2025 08:25:58 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 1/4] drm/i915/vbt: split up DSI VBT defs to a separate file
Date: Mon, 11 Aug 2025 18:25:47 +0300
Message-ID: <84417e0141f98ae8f8c7a66e9002c3e99c9ed3db.1754925923.git.jani.nikula@intel.com>

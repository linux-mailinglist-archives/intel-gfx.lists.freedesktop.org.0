...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EEFA6EB0A3
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 19:37:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47DE410EE73;
...
Subject: [Intel-gfx] [PATCH v4 3/8] drm/i915/mtl: Add PTE encode function

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A1966EA337
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 07:34:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DBD910EDA7;
	Fri, 21 Apr 2023 05:34:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C52DD10E2FD;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=SoGKv1DSBvFQoTgyfo29uoMEuWV/a4D36xJQHfLCBqY=;
 b=eUZYIc6NNl0OXUAQzT/PqI3Arul84VhZqebBfattFJQXmIsqFXWb3eHh
 8uGtkq+IJbSnm3aSDKHpqHYMgwDUWwBD8RV5yPFhjqOeCot9i43cWSdKg
 CZDrDUNqxLEv+8G8HHCjIhslb5t77Uq3QOhvgr4OVYiHaSvEBBHogGIs+
 Q3x9VxjJpwvRInkFMcLRTiAuSPca3ag5oZs6sukgWgLs3lbqm6hBZMb0x
 t4JnR9JPfH7qqznFHIrBcngBbNduxg78GpbuZbXGVnB9tsJlpq7J5A3+n
 4L/wuvfLb3EjyddDLZaAkPl/gsOpZHm58ncE5dPYFG7QBphKrqp4Q3lZI Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="411186938"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="411186938"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Apr 2023 22:34:15 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="669612110"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="669612110"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga006.jf.intel.com with ESMTP; 20 Apr 2023 22:34:15 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 20 Apr 2023 22:34:06 -0700
Message-Id: <20230421053410.1836241-6-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 5/8] drm/i915/pxp: Add ARB session creation
 and cleanup

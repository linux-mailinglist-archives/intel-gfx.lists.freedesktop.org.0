...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DE3B6D09F0
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Mar 2023 17:40:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF03310EEE1;
...
Subject: [Intel-gfx] [PATCH 01/12] drm/edid: parse display info has_audio
 similar to is_hdmi

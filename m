...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFFF488260
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 20:25:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8C6F6EE75;
	Fri,  9 Aug 2019 18:25:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AC8196EE72
 for <intel-gfx@lists.freedesktop.org>; Fri,  9 Aug 2019 18:25:24 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17947102-1500050 
 for <intel-gfx@lists.freedesktop.org>; Fri, 09 Aug 2019 19:25:20 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  9 Aug 2019 19:25:17 +0100
Message-Id: <20190809182518.20486-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 3/4] drm/i915: Push the ring creation flags to the
 backend
...
IGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMKaW5kZXggYTk4NmVhODdmYmQ5
Li5mYzVmY2MyZDAzYWMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVs
...
dWZmZXIuYwppbmRleCA2YTI4OTIwMzM0NTcuLmQ1YjdlNGRkZTc2MiAxMDA2NDQKLS0tIGEvZHJp

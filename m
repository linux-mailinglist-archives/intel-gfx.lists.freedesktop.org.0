...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB3651580C9
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Feb 2020 18:11:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46A8F6ECE6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 10/18] drm/i915: Include DP VSC SDP in the
 crtc state dump

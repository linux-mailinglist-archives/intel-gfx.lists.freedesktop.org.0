...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFE2874B662
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jul 2023 20:34:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 05EF310E5D4;
	Fri,  7 Jul 2023 18:34:31 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v1] drm/i915/pxp/mtl: Update gsc-heci cmd size
 and timeout

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B78AA6D2EA2
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 08:37:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A9FB10F3A8;
...
Subject: [Intel-gfx] [PATCH 4/7] drm/i915: preparation for using PAT index

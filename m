...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF8431FB6AE
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Jun 2020 17:39:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D76C6E8CD;
	Tue, 16 Jun 2020 15:39:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4A74D6E8CD
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Jun 2020 15:39:36 +0000 (UTC)
IronPort-SDR: 8XJCnj2Z6PJfchGoH9vPs9niqMVF3y74922H9sNlqGtpXxJDCGDuBktSlFpJL1zlyQMfTp6OR5
 eIEU7q26GU0A==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2020 08:39:34 -0700
IronPort-SDR: Ygor1tGRJIAFJvLBXiYi5VjkFHAkkNxe5MglND9J2eVJd1r+z+kU75q1CD2H2PxLZ6zC/Ls93/
 Zr339zhn7XLQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,518,1583222400"; d="scan'208";a="309151188"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by fmsmga002.fm.intel.com with SMTP; 16 Jun 2020 08:39:31 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 16 Jun 2020 18:39:30 +0300
Date: Tue, 16 Jun 2020 18:39:30 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <20200616153930.GX6112@intel.com>
...
In-Reply-To: <20200616153055.GA21389@ideak-desk.fi.intel.com>
...
MST
> > > links for now, until the MST compute config can deal with changing li=
nk
> > > parameters.
> > > =
...
> > > @@ -468,6 +468,13 @@ int intel_dp_get_link_train_fallback_values(stru=
...
> > > +	/*
> > > +	 * TODO: Enable fallback on MST links once MST link compute can han=
dle
> > > +	 * the fallback params.
> > > +	 */
> > > +	if (intel_dp->is_mst)
...
> > >  				    link_rate);
> > > @@ -6163,7 +6170,17 @@ intel_dp_detect(struct drm_connector *connecto=
r,
> > >  		goto out;
> > >  	}
> > >  =
...
> > > @@ -6175,12 +6192,6 @@ intel_dp_detect(struct drm_connector *connecto=
r,
> > >  =

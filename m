...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 137F84E4D66
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Mar 2022 08:34:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1482F10E5E0;
	Wed, 23 Mar 2022 07:34:51 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm: add a check to verify the size alignment

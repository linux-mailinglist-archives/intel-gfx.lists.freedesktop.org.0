...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C21E6C85FF
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Mar 2023 20:34:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6347910EC5D;
	Fri, 24 Mar 2023 19:34:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x42f.google.com (mail-wr1-x42f.google.com
 [IPv6:2a00:1450:4864:20::42f])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6FD2210EC5F
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 19:34:33 +0000 (UTC)
Received: by mail-wr1-x42f.google.com with SMTP id i9so2873134wrp.3
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 12:34:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1679686472;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:from:to:cc:subject:date
 :message-id:reply-to;
 bh=hwoWnM+P+5Y3vSdidrB72dW9vMS9M1fQSJiKvYZ9s5Y=;
 b=AqqdwLoVTC1w+/RjGJstiZQn3qavitv2citGymqli2vb+q5jxJZXBLM5/7pjGvclEL
 Zrne58bt0cOFJYF8ZipbOdyQgMwSiKwx+UGed/qXSZREulqcBd4RhYh/FZscrXiwFqlK
 kIst4zs+xgMjG9rsMOteNt3lPTuaqyHf9C0Pg=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1679686472;
 h=content-transfer-encoding:cc:to:subject:message-id:date:from
 :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=hwoWnM+P+5Y3vSdidrB72dW9vMS9M1fQSJiKvYZ9s5Y=;
 b=
X-Gm-Message-State: AAQBX9e2QoiKcj7K930we+91OCOBDKRx1+oBg3jOl/dnuX9xK2QeV/qV
 kzqmdO8qtsP515in05AXf6/atNcKfcbSf7UC+xhkOg==

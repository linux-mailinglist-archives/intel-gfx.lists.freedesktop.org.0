...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C2BC78A0B3
	for <lists+intel-gfx@lfdr.de>; Sun, 27 Aug 2023 19:57:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D46810E1F8;
	Sun, 27 Aug 2023 17:57:00 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v15 19/23] drm/shmem-helper: Export

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74B5787517
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:16:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B236B6EDB3;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 QO3A==
Subject: [Intel-gfx] [PATCH v3 02/41] drivers/gpu/drm/via: convert

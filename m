...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9723BB84E6F
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Sep 2025 15:47:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 05E4710E8BE;
	Thu, 18 Sep 2025 13:47:09 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Tp1ubM6A";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BCDA210E8BE;
 Thu, 18 Sep 2025 13:47:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1758203228; x=1789739228;
 h=date:from:to:cc:subject:message-id:references:
 content-transfer-encoding:in-reply-to:mime-version;
 bh=ygjEhwLz6zQw/g1ABIay+5M5ZUH0B4ErZye1qcIPOjg=;
 b=Tp1ubM6AH/S6ju2l82dSV6OB5wjhB+/+Tk7NM+rJQf6SM2xffm5jHiz6
 iWqKjllOtSyKbeE2HdZiwTeX3KQVN4F5U2VDcrLICAFcyp2vsqPq1x/Sp
 oT9UWtCEkFQBWZ8lOvUQEQASeinD9iZT8kwSW7Wz3L9EKJrgnrr5HaLum
 pfpZLsPN+lsmNccdg3hsEuVGoDUDSOzQyaRYKVURjz5y992/s9cnDr5C3
 ScaZC46QCXd164Q3XSXQb8rXNsg0JI0mNeygmqWrMAmW9845zHXpSie+B
 K6OEosmie7RckbuCZtyGep+h7excGglS9JViJRUIGL+LthlwM8v2F4PBO A==;
X-CSE-ConnectionGUID: dWQkgc3xSxyg+0aWRjTEcw==
X-CSE-MsgGUID: EMPTE60AR7yDv13tWvNMeg==
X-IronPort-AV: E=McAfee;i="6800,10657,11557"; a="77974140"
X-IronPort-AV: E=Sophos;i="6.18,275,1751266800"; d="scan'208";a="77974140"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2025 06:47:05 -0700
X-CSE-ConnectionGUID: W8x0SITiTbO1Z3UJ4PRXXQ==
X-CSE-MsgGUID: rVIZB6CpRfaY0k2UwXTt4g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,275,1751266800"; d="scan'208";a="180657650"
Received: from orsmsx903.amr.corp.intel.com ([10.22.229.25])
 by orviesa005.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2025 06:47:04 -0700
Received: from ORSMSX903.amr.corp.intel.com (10.22.229.25) by
 ORSMSX903.amr.corp.intel.com (10.22.229.25) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17; Thu, 18 Sep 2025 06:47:02 -0700
Received: from ORSEDG903.ED.cps.intel.com (10.7.248.13) by
 ORSMSX903.amr.corp.intel.com (10.22.229.25) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17 via Frontend Transport; Thu, 18 Sep 2025 06:47:02 -0700
Received: from BN1PR04CU002.outbound.protection.outlook.com (52.101.56.55) by
 edgegateway.intel.com (134.134.137.113) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17; Thu, 18 Sep 2025 06:47:02 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=s9HGZL/gDNY/C2N5a2w2valrKZcNJuKuDffyc/N4+50=;
 b=
...
Received: from CYYPR11MB8430.namprd11.prod.outlook.com
 ...
 13:46:54 +0000
Date: Thu, 18 Sep 2025 09:46:47 -0400
...
Message-ID: <aMwNR8QFm-DKU_PD@intel.com>
References: <aMQhwrCa_5mgfl4X@intel.com>
Content-Type: text/plain; charset="iso-8859-1"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <aMQhwrCa_5mgfl4X@intel.com>
...
X-MS-Office365-Filtering-Correlation-Id: a5ed2484-2273-4004-04ae-08ddf6b9d347
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230040|366016|7416014|376014|1800799024;
X-Microsoft-Antispam-Message-Info: =?iso-8859-1?Q?zAU+WQcBjpbj1W2tS9nPb40+LOBz6ko/U6dxaVrkbVUpIBhQuRcJVYZwMz?=
 =?iso-8859-1?Q?nMHUgLshp2tEQbhGrIuR77OIeuJHejJPelwwF9EtoXrxQs7llUa9RJlKpb?=
 =?iso-8859-1?Q?EAGQegjitm/zAk1w53IIv1ToMwTucEMS1sP/sNc6iK5udijsAU9vsB0gbs?=
 =?iso-8859-1?Q?TjnUswBgq2wOxsd7VAmZ21rdmP4gnM7I4msBnAkG7GsLs9fCDe1CdxncVZ?=
 =?iso-8859-1?Q?b5wIiMggTZmWAK4Ek6ZbInde854snQkbEa0FdnV2855pLYcKiigeR2htKB?=
 =?iso-8859-1?Q?sj3POUNfvVj1eZVefFDBy/D2463bXYQYIBAp5XtdGLR0Bzkqph9s5imsk2?=
 =?iso-8859-1?Q?e7AIRJYDY9odfLE3yU82pcbPciTvWe58Agr0qg7IQo9rfUxMQPWpXya3wC?=
 =?iso-8859-1?Q?Hu8kj+SXLjh7ykyYzbOLRKaWwfb9I+IgVJHzgzehhXJDoQ7FGzZzCrbQjx?=
 =?iso-8859-1?Q?dtSFFb6WruRahyeIN3SxskeFcPzXctwdZyOPwinzIGjIDpCGwU+M6+Ynjy?=
 =?iso-8859-1?Q?GfNQUpPGh5IYV8AiQ7myRoLkiOx+C++uQPykss1T0izkQfEuVf2bVz+IaX?=
 =?iso-8859-1?Q?LlLw3T/qg0XwGW/Bc074+9mnloH+1n0KCy3l9M0a0fGcl/+8a/NHiNciQz?=
 =?iso-8859-1?Q?3UNJW3pSfArYxx88MuXvMqanGDP0mXkldM2GOXVKPaQ+H0Zr+tUtqML4JI?=
 =?iso-8859-1?Q?KRWFD+Xx+b7SVjFwzkczs6nYPrrN26S0vYo+LCfyjQgDOCOYq2UJA7x7pD?=
 =?iso-8859-1?Q?op7pAa1Dj3LxCHY7jkxk/R1gM+ebnzxE/K4wZsOHkErMozYVhl86sT3L96?=
 =?iso-8859-1?Q?mdOB3xlugE9nIlBFyFExHNpF90+aoQdDLVzSPfe5qs8bC6YhLYPEdniNBm?=
 =?iso-8859-1?Q?PxWMWBqa9C3GlasBOE7rTKPp0QLiaQLfLEutTiG2hYBrQ8nqTuevbdwBlF?=
 =?iso-8859-1?Q?rywWVlqZrEJDDkM8RqFJA6aQmmwdQs6GsujUZzR65/P2fPrPxu60KpsbfE?=
 =?iso-8859-1?Q?z9e4ynicjXvLgn3CnfLDOSKkzHIqbaXmX3ilUCsdRltIXl/Qh6TwgQCpJM?=
 =?iso-8859-1?Q?uGsMNpBXYipSgGB9t01BQBxRIIke85L9MSObAyeGxSmHWFMlwxZbfQ+6U1?=
 =?iso-8859-1?Q?Wx6lypLNGrfJzVxnik3AeZ/mteXB7WgA+AsDPaAEMvcUtY9imUBzV6RIpZ?=
 =?iso-8859-1?Q?FlblrbA7D9MVfBHuH5xmx6v9v3guz87rVn61Vo8IZ6K8D7fezkjUT2HDpi?=
 =?iso-8859-1?Q?MBubYygsEdtfYE/kIm3rb0X2pCoO4GuYK1HSsK94xacz5V58IuTMiLgoRZ?=
 =?iso-8859-1?Q?BGas0bWRcVQ5m5k4USE1AkRpBKwIl4knW3Vcr1i6vTz3B6frQei8AJqjtb?=
 =?iso-8859-1?Q?dfxSYYY92pMGq2/d24vK4fZYu49CluPsnJeaITPKeWiPaxRLglByw=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:CYYPR11MB8430.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(366016)(7416014)(376014)(1800799024); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?gdfQJoJTfbU6mThCRndLPBh132jFztoTLk6Qywzdvgvp+EpJU8D/TRSzMS?=
 =?iso-8859-1?Q?8NpgIjlGeWO1vxvtnDRKuPtz5ggwivkY6lnzEZYx8UHmwMfpuLLFl/CQlI?=
 =?iso-8859-1?Q?siJc8InRL624gYygQG227hnrEw/li1qh09xoKSabPNiG9prMbu4J+pRobA?=
 =?iso-8859-1?Q?eQAuwVZeVTV2CBvAsgvTidYIFgaiDqHGfwUmQe3jfGLf4/67qtzpoWWvyO?=
 =?iso-8859-1?Q?soB2q9pNuL7vcweqyTKTBeN2sD1d/YtxNKp7GKNeNe+NH8FfcgagwGysdX?=
 =?iso-8859-1?Q?Rdcx/HTDMCRVXnuxW3S6hj/cjEwgtIFL7C0Ec6s1Np/vXsEognjHUJNa0p?=
 =?iso-8859-1?Q?ChzK+rMC/s1aeS1ri5v19B33Tk9PqhLxIwF5DwpTO9jLH8H3jWFsNA7x6W?=
 =?iso-8859-1?Q?LGUmDVwP/SPEch9E3GEaUeAXFVAc7UoQr771IdibJsdebrt66Inhz1x0Hq?=
 =?iso-8859-1?Q?55DeibCv8+CemtWl2GrpS0DTTktT9j+cPccAGCLj7Aj9xoyV2XYDW0BOdC?=
 =?iso-8859-1?Q?msdtuY+HAQkNV0QV0KvIqceCfe9g4A65GKq24A1Bc3zlSEwur800iOGqlq?=
 =?iso-8859-1?Q?tbQoZDYgB2vmp74STE2rYqJCjTJ78l8CAc4uuXVZhJ+VyHvoIx1b+NR6op?=
 =?iso-8859-1?Q?af8DDHnCpGELNTORFGp4i0hO5fwDOJQoN7lZX3LyGk7yu14jTJ/C0L/tBT?=
 =?iso-8859-1?Q?VfvPKPxB5cOtRp+ZcjAorkrmumAVRh+g05h8523hj/H9X0TIjHfh23i7K5?=
 =?iso-8859-1?Q?DwToxmybN7N7kQTjRFQXujXrmBAKRn+AOeQ/cFoIrs2LI51yC4X24hATGG?=
 =?iso-8859-1?Q?cCml6W/btE+v2H0Mq4q8KOVYfRTDoJoQA453p9oKtwYLR+cNw8zjOKIdix?=
 =?iso-8859-1?Q?z25maWxpLJjA7AfBzcjMJJU41bPdfYubwbO9kux3zkJoaCbTa/09H81rsV?=
 =?iso-8859-1?Q?4lUG7FiuCCc1LxHpISj08CwDhdgB2hCGCmsvzzK5kE4Ys/BxDql4eoUu9w?=
 =?iso-8859-1?Q?FRFsdnljanJj7GQWdrYKOdtwE+ZpnZjMvV9dd3Uk6h+bm9jCsZQyC4MNvh?=
 =?iso-8859-1?Q?JDWX2iwZN2J0IVKtQdURiy9Mbmqxo1Pj4/9FBf62SN+NizSxQ2uRhNe3WL?=
 =?iso-8859-1?Q?Se5aR5X62kA7uh3douxA4KabY/JQr31bSjatV+VSfyO6o4h+6WLkahdduU?=
 =?iso-8859-1?Q?e3+A5VhhZdE9WRfw0gMBjR3teeYtGFmVMCFpmU5KCh8Ln11+F5stNOR3Pf?=
 =?iso-8859-1?Q?M7gwNWcy8bAKcHkGiklVYsJ1T7xVSbPfwu5CfkgEgJQGeZm5Y+XENpBAZK?=
 =?iso-8859-1?Q?aEcR5ujDduM8vHEhBEbRYzgjInzFYH6R/0qM6nhWjyKCSJCg6pg3/rthFP?=
 =?iso-8859-1?Q?z0NquRlRAb8Gi9HUD2DAxtedHMut8WeUkheR+ZtTJ6vJvczwwTrFbm6i95?=
 =?iso-8859-1?Q?CT3wmk1WvqaAX9qwLR5PKSLLU2eoiyLhKbthTmXuFjLNNxWD6lxKRVM+LS?=
 =?iso-8859-1?Q?bRPCvUkYUgVTRM8+t1s3MuzBnZ6jg2CSCNDUrAusR2YXZ8EpWDBFpiAAmA?=
 =?iso-8859-1?Q?w881QnC8ARHQRgEPuePhEVOQcaCHNcJ4ejToyuxgP6ysIdCf44mmaLHH97?=
 =?iso-8859-1?Q?TanEKiIApVxsD6sCg1AGnO3mo962QVVfiiXWN4Xh7ujV5483Sv690egw?=
 =?iso-8859-1?Q?=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: a5ed2484-2273-4004-04ae-08ddf6b9d347
X-MS-Exchange-CrossTenant-AuthSource: CYYPR11MB8430.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Sep 2025 13:46:54.0987 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: supfqlzjxYKE7dy+UMQ+I2GRfD0V0fsivn0O5cF3Wecr96B0jzkuGSAY1O9ZILS1VBZxbtAltLBc+fpjVE4o7w==

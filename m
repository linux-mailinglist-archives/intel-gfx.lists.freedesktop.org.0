...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 79F495A4E50
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:38:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 27A0210F274;
	Mon, 29 Aug 2022 13:38:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9F59B10F274
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Aug 2022 13:38:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661780301; x=1693316301;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=aWtFa9aF5HDpKjgBRB+afx4OevrcvW0prqsKJhF5mO4=;
 b=g4I0qrP1BFWcQS8S0jLGJ09XAJHaxQd5/PoKO+dJ83PuSFgQ4rjSATqh
 eRa3dkZRJySp94+XMMI432N6an+G9Cin543qAO4Ghr9mDjWK3aObG82ox
 N/zD9kkm0jLwtc+ZgTUFiK3d2LUEGQP+msXS0kOGhvC3YkpQ/y3S499Rj
 pWDgS+VY0QfJ/SkclrZk4jI6I5RsYzSoOsEy9OWzyf5YAMo7rG3TqEyJo
 QWA427TUDbvRz/IK3bjQoHv5F+57l1askgyJhXZvT8DToLY6h0jV4Xh4W
 4L8khVPkiStHxjEkaYIJFsEeYGkuZiMe/A+4rpmsCCqSyVPwfzV+1bfZy Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10454"; a="358856814"
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="358856814"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:38:21 -0700
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="607447944"
Received: from idecesar-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.53.198])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:38:19 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
In-Reply-To: <20220823090128.488008-2-maarten.lankhorst@linux.intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20220823090128.488008-1-maarten.lankhorst@linux.intel.com>
 <20220823090128.488008-2-maarten.lankhorst@linux.intel.com>
Date: Mon, 29 Aug 2022 16:38:12 +0300
Message-ID: <878rn7f9vf.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain
Subject: Re: [Intel-gfx] [PATCH 1/4] drm/i915: Move display pcode requests
 to intel_de

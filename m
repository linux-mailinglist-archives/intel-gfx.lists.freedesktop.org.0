...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BBFA1DDF8B
	for <lists+intel-gfx@lfdr.de>; Sun, 20 Oct 2019 18:43:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B16368991D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/3] dma-buf: Exercise dma-fence-chain under
 selftests

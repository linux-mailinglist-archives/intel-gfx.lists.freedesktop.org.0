...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B3526E00E3
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Apr 2023 23:30:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEDCC10E99F;
...
Subject: [Intel-gfx] [PATCH v6 1/2] drm/i915: Migrate platform-dependent

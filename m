...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 471F5B1CA0
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Sep 2019 13:52:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D9546EF35;
...
Subject: [Intel-gfx] [PATCH 7/9] drm/nouveau: use drm_debug_enabled() to

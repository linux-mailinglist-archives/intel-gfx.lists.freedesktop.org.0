...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1C7937F43A
	for <lists+intel-gfx@lfdr.de>; Thu, 13 May 2021 10:37:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A86BF6E82F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2] drm/i915/gvt: Move mdev attribute groups
 into kvmgt module

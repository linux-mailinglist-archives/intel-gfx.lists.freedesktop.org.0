...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8DAE6EA335
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 07:34:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC4EB10EDA1;
	Fri, 21 Apr 2023 05:34:27 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v8 6/8] drm/i915/uapi/pxp: Add a GET_PARAM for
 PXP

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10E09B2D604
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Aug 2025 10:19:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8E9B910E6C2;
	Wed, 20 Aug 2025 08:19:04 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="XPegGJip";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E796410E6C4;
 Wed, 20 Aug 2025 08:19:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1755677944; x=1787213944;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=yjGQjnICII9QDeDprmgkIKyyzu4bdrsxH5KqZEuzjLs=;
 b=XPegGJipCX7ehoQb1e6eCggEwKxRekcLy3nZz2FYs66iMGB3eQHe7znp
 fq8cJXfl7d6RcGa6JpQPSWiSB0639k0pqp9de+ZFUqYhVXwUmpsVPUauA
 uMM70kTJz/lc3nB/xMwQ06eyo54tl1dVzJkGcJoH2A2CZsdCcCsdd0pdb
 JFLQmIJWY3QYoE4SXiBe71bDJKnNTbXwcAmrtyCoVGNAgny7Et+N7kN15
 3r76mr+MxC941DP6fwneQURG5jbGukqxe5v6FiY0Cr3UKe+cBptrXw4uu
 KtrYGYdFqFFpd44ecQ5ETnkpPV4qH3i4QwmaaWCNh0+dQP5wRJVgJSYgq w==;
X-CSE-ConnectionGUID: 7pntTh4fR8a5RN9utScvNQ==
X-CSE-MsgGUID: 8hI0w5aKQTKsPmuvA7HJnw==
X-IronPort-AV: E=McAfee;i="6800,10657,11527"; a="69316827"
X-IronPort-AV: E=Sophos;i="6.17,302,1747724400"; d="scan'208";a="69316827"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Aug 2025 01:19:03 -0700
X-CSE-ConnectionGUID: khqKLzU1S7GhlKsvQeLICw==
X-CSE-MsgGUID: femgkNf7Sv2+zbS/CWMFgg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.17,302,1747724400"; d="scan'208";a="172292862"
...
Date: Wed, 20 Aug 2025 13:34:50 +0530
Message-ID: <20250820080451.2634888-13-ankit.k.nautiyal@intel.com>

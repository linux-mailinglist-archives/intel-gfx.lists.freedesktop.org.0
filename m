...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 63DB36439BD
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Dec 2022 01:00:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDC7C10E0DD;
	Tue,  6 Dec 2022 00:00:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4D67710E0DD
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Dec 2022 00:00:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670284844; x=1701820844;
 h=from:to:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=xD3AJEdZTNm7l2Rr2OYOKpniCe4SbblE0fDtuNkg9Z8=;
 b=Y81ikoE5hYusOMcmGYIhzzrr47F0jB7ffffAQZPsi/5osrJ//KXMDQga
 TkujSOqhKtJsKDHaVHeZC9Ht87tq1SbtspQEj7muOIlOng6YZZOwDHYcz
 KHM6s3pSqS1DBoSJE3rihx3T57G7Ikx7bFGYhxaiKdzxHB6JreGT+9oZ1
 AyA72ueJfKM6i8+nIYgcw01z80GbMroJQGB9l8CbNJEMtm42bx7OPsd8Z
 bo0EGd7WOJbDGC2ibP+OZCyeicJijdm64t0zSPixKqK4cJHCJyIdIpUH+
 dzkdfkN71JZ6kMXWauKQwT9HR+yBajtvDclV84K2kxI+jdSXaj9EkOshe g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="402769816"
X-IronPort-AV: E=Sophos;i="5.96,220,1665471600"; d="scan'208";a="402769816"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Dec 2022 16:00:43 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="596378706"
X-IronPort-AV: E=Sophos;i="5.96,220,1665471600"; d="scan'208";a="596378706"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga003.jf.intel.com with ESMTP; 05 Dec 2022 16:00:42 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  5 Dec 2022 16:03:32 -0800
Message-Id: <20221206000332.134137-1-alan.previn.teres.alexis@intel.com>

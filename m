...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E82A461541
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Nov 2021 13:38:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25CAE6E89F;
...
Subject: [Intel-gfx] [PATCH v4 2/2] i915/gvt: save the MMIO snapshot in the
 early init of GVT-g

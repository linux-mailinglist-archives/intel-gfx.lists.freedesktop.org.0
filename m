...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 69F3E4DA77F
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Mar 2022 02:48:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4CB1E10E4ED;
	Wed, 16 Mar 2022 01:48:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DF9BE10E4E3
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=nEIitdNSPIAtfBSoqgsTEbdrSgSdc3R1hNCoNZ1Q8d3MtRuliBKj+s1Q
 VOFq8VlLM3nqISHVx5kb6ycepdwTzahOP3o3adcWZcP5Ysux0Wk6zRIjB
 KEpa0Z5lsbST4mAhSSo6oCOuopXKHHIumUXNUX0Wy9rjW87oyr4UGzgPZ
 teo/Es1ZCdG3RspqOY85+GkxwMYrKP8VcNqgDxxA/eQEMdwQJZikBnwhL
 R1uXD2l8pYBhpN4lqcurAnKSoOlPQrnR7YkJ/iWOUMz3/7RVLAGdMdC6H
 zs2Qtc1oNO7xPnJaGD+NZ63C+DkWpLmVV3h7Nwv954m6kqedE/zVr2EXb A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10286"; a="255294154"
X-IronPort-AV: E=Sophos;i="5.90,185,1643702400"; d="scan'208";a="255294154"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2022 18:47:59 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,185,1643702400"; d="scan'208";a="634804837"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by FMSMGA003.fm.intel.com with ESMTP; 15 Mar 2022 18:47:59 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 15 Mar 2022 18:50:25 -0700
Message-Id: <20220316015025.1664860-14-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 13/13] drm/i915/guc: Print the GuC error

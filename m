...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A9F16CEFFE
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 18:57:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6452710EBB4;
...
Subject: [Intel-gfx] [PATCH 0/4] drm/i915: Add support for MTL GSC SW Proxy

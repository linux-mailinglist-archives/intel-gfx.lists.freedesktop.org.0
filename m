...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D49A6EE90A
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 22:29:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E201610E7E9;
	Tue, 25 Apr 2023 20:29:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CC46E10E7F5
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Apr 2023 20:29:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682454542; x=1713990542;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=yHjUhc9oQyikWPMUh9a2sOw6idUPgAAYMHWFy6a05Kg=;
 b=iXLKYUnQDJioHiL/SGsTAYmhBfA0fR7eDDcnHfBY4peg9NA9Upd8z2pV
 TeKqwVxtk17vcD7E7qytrxvxkfSUaAVRLIOhnhg3t1wL0SYV3/TDg/u0K
 YN15/n/1TyH0uGrj7Xo0pVTQJmu1YQxp6aJp+edg3C6F+tuZfjLgRmSj9
 Skp6kAE1LW/BCxQtIUl+Sji8dN7LjBekMk0ZIqbmu4yA0R85CrIs9X2rM
 G4ZvCQUPCggCPZ/7d0RNng94lKvJHGSQ8kXXuQU5mBozvo0FvUFLtk0Q5
 V/5fHnEynPVQO5H0ZCnkIjalF5vCcdIUAhvUKcF0eo9Nfv/0Iq2MrYuqa w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="345651714"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="345651714"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:29:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="724141278"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="724141278"
Received: from aazuev-mobl.ccr.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.252.59.124])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:28:59 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:28:25 +0300
Message-Id: <20230425202826.1144429-8-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 7/8] drm/i915/mtl: Add support for PM DEMAND

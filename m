...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 270888A6CA4
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Apr 2024 15:40:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBC72112CB1;
	Tue, 16 Apr 2024 13:40:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="XJbaCl6d";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 19254112CAE
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Apr 2024 13:40:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1713274829;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 in-reply-to:in-reply-to:references:references;
 bh=NQ7H/T5YUrT6vdAR0+Y8w0vPF9BXY+KQPJv3cNEis70=;
 b=XJbaCl6dmtn8kZ1szV3pnc7vArmrqx4c6QkeZCF6DkZVZgch2Yv14RLRd3lCln0AQObwPr
 22dWV/AsCXobbK2tr+DC1Un6aLQ1/9d8ql+cuIpY+mKIjJgX+8VKse23UtcllD+pvHbefl
 gTsvttdTshK0McEnpxt232V1PqXext8=
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 [209.85.128.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-183-i438_8McMtOvUSa_81jHZw-1; Tue, 16 Apr 2024 09:40:26 -0400
X-MC-Unique: i438_8McMtOvUSa_81jHZw-1
Received: by mail-wm1-f70.google.com with SMTP id
 5b1f17b1804b1-41485831b2dso28039775e9.3
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Apr 2024 06:40:26 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1713274825; x=1713879625;
 h=in-reply-to:content-disposition:mime-version:references:message-id
 :subject:cc:to:from:date:x-gm-message-state:from:to:cc:subject:date
 :message-id:reply-to;
 bh=NQ7H/T5YUrT6vdAR0+Y8w0vPF9BXY+KQPJv3cNEis70=;
 b=
X-Gm-Message-State: AOJu0YwkTxc8dlTPKw+9/zRppFxZms4IG502CvbwhNpUHtTwTcJAYrf2
 juUXw4z0g/YU5YVoqr/xDasM8rf95ig5Ho9uGsLQ0L+0Ax+3lZZTqAdGm98rQLSAxfWymakqtxe
 TfI/FyGpZSkAwjlmKT9zMwo+4OMgGkKWfq1ByNfpODflAsAg/68T3xEqagA4GTiXEaYjP8pLKXg
 ==
X-Received: by 2002:a05:600c:4449:b0:417:e60b:91f6 with SMTP id
 v9-20020a05600c444900b00417e60b91f6mr12299474wmn.4.1713274824897; 
 Tue, 16 Apr 2024 06:40:24 -0700 (PDT)
X-Google-Smtp-Source: AGHT+IHN9+fg7rs28Vk/Xn5FIgULbLm3Cs5eaCzsiSDeyLubFaBYaeLUQjAshv6itf13xFAceV53Qw==
X-Received: by 2002:a05:600c:4449:b0:417:e60b:91f6 with SMTP id
 v9-20020a05600c444900b00417e60b91f6mr12299443wmn.4.1713274824428; 
 Tue, 16 Apr 2024 06:40:24 -0700 (PDT)
Received: from toolbox ([2001:9e8:8995:3500:cfb8:300d:e7d3:9e6c])
 by smtp.gmail.com with ESMTPSA id
 l35-20020a05600c1d2300b004161af729f4sm20426611wms.31.2024.04.16.06.40.23
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 16 Apr 2024 06:40:24 -0700 (PDT)
Date: Tue, 16 Apr 2024 15:40:22 +0200
...
Message-ID: <20240416134022.GA40393@toolbox>
References: <20240411060925.475456-6-suraj.kandpal@intel.com>
MIME-Version: 1.0
In-Reply-To: <20240411060925.475456-6-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 782E91466F7
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 12:41:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 019D16F9F0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 2/4] drm/i915/display: Make WARN* drm

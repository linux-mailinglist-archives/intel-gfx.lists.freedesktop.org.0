...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11093AA386
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Sep 2019 14:52:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7F6E56E0C5;
	Thu,  5 Sep 2019 12:52:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-oi1-x244.google.com (mail-oi1-x244.google.com
 [IPv6:2607:f8b0:4864:20::244])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 731FF89237
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Sep 2019 01:45:00 +0000 (UTC)
Received: by mail-oi1-x244.google.com with SMTP id 7so459226oip.5
 for <intel-gfx@lists.freedesktop.org>; Wed, 04 Sep 2019 18:45:00 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=kOF+ZPHpYR3Xq1yEKnmzXHsOmTQNpIQkThMXvnUhVnc=;
 b=
X-Gm-Message-State: APjAAAVbaraNhtNnkYoBrX4NybbMYsmSNFeemDOnjSOXZzdkNCMl62MY
 vhMLtfTntUsbu5t2GvOdD+J8+QXhLJIhNs0LkNqVHA==
...
Cc: Arnd Bergmann <arnd@arndb.de>, airlied@linux.ie,
 ...
 "# 3.4.x" <stable@vger.kernel.org>, dri-devel@lists.freedesktop.org,

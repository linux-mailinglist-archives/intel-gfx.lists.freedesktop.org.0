...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CEJtEVVkwWkjSwQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2026 17:03:33 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6CBB2F7560
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2026 17:03:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49CD710E4F5;
	Mon, 23 Mar 2026 16:03:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=permerror (0-bit key) header.d=gmail.com header.i=@gmail.com header.b="mcwqpuSG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-oi1-f181.google.com (mail-oi1-f181.google.com
 [209.85.167.181])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C675B10EC00
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Mar 2026 13:23:33 +0000 (UTC)
Received: by mail-oi1-f181.google.com with SMTP id
 5614622812f47-46708149af2so1223074b6e.0
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Mar 2026 06:23:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1773408213; x=1774013013; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=1Wq1T+ME15CeT+ENLeTMFVu27KuUi0eR6wJ/aa9tW5E=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20251104; t=1773408213; x=1774013013;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=1Wq1T+ME15CeT+ENLeTMFVu27KuUi0eR6wJ/aa9tW5E=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXeBp9BNuKMfUqPwDM7/7eBMSz+Syl+NzfshKxkPyd2iS8Ys3yVLXkMv9jnAsnX4pkHB2J7xxO+XSs=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YxbgCBa8Vr6HECfEd1ZrYVaVbGyqUwP1x6rqobPLLeXVs9Ni+cz
 3QC7pVLVvIAXgyZtoIVXUF7km1ElEc3aoG6SByP/uZ2A6XhM9zvd1K9e
X-Gm-Gg: 
 YwR5gjHW/VPofbb7uhzfM5yRoBpbqlXSC1sLzcTJwLP9wPTYt3
X-Received: by 2002:a05:6808:2386:b0:450:89ee:922c with SMTP id
 5614622812f47-467570dd9e9mr1671520b6e.27.1773408212826; 
 Fri, 13 Mar 2026 06:23:32 -0700 (PDT)
Received: from frodo (c-98-38-17-99.hsd1.co.comcast.net. [98.38.17.99])
 by smtp.googlemail.com with ESMTPSA id
 5614622812f47-4673434a35csm4795987b6e.20.2026.03.13.06.23.31
...
Subject: [PATCH v11 18/65] dyndbg: move mod_name down from struct ddebug_table
 to _ddebug_info
Date: Fri, 13 Mar 2026 07:19:43 -0600
Message-ID: <20260313132103.2529746-19-jim.cromie@gmail.com>
...
index df7223532cf5..34297f658bc8 100644

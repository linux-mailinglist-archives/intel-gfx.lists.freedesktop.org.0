...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C74B9B3B1C
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Oct 2024 21:08:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 314FC10E570;
	Mon, 28 Oct 2024 20:08:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AIs1vm+k";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9081110E572;
 Mon, 28 Oct 2024 20:08:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1730146113; x=1761682113;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Hab1cMW5eARhPbgO7ryF8/+kTnoAujpu/kyaloHnJ/s=;
 b=AIs1vm+kVx4YztZopHL5oMm930Vkh3Ru3xLm5YYtJdx4tcXbs2ZTOzFo
 9yFBoU6SO7C06Rg4QF81VVmvhB87GImKk49CNpl/xXSlmcp0DUZmWvmYD
 hULeXCW9QR0DiyY6YxJ0Exz++W1wUod78guIBMpWAzjYV4buDPZYquG1t
 BcdTV2tqCJFNb5WAf6vLdyd/dOhqJLkCoKnuXEH7eIQevxt6A+tRUoU2x
 h/Z1OI8T6u+oTimDzxPt/mMJ2adJ6KRv4Iupg+vlOx6aicNHmJO82B/fJ
 4hSUJyF9yzoGsqtswtLLCm0rxh6WvEEboKNwCk1NRb35LznuHgbwsk9t0 Q==;
X-CSE-ConnectionGUID: GWZKPnnWRp+Cr/NZp+iS+Q==
X-CSE-MsgGUID: qAMvvR3zQ+SWw0Ld8edVjQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="33456896"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="33456896"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2024 13:08:33 -0700
X-CSE-ConnectionGUID: 7bC4/QqLRwa3Wz1mIrpwpw==
X-CSE-MsgGUID: 3IJNege5QkKH3Jm/Z2IYdQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,239,1725346800"; d="scan'208";a="81628640"
Received: from fdefranc-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.246.21])
 by orviesa010-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2024 13:08:30 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	Rodrigo Vivi <rodrigo.vivi@intel.com>
Subject: [CI v2 v2 11/12] drm/i915/dsi: convert to struct intel_display
Date: Mon, 28 Oct 2024 22:07:29 +0200
Message-Id: <f62a3616ef15e02cf19c5d041656fc6e09b37f6a.1730146000.git.jani.nikula@intel.com>

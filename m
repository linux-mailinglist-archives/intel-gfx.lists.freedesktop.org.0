...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 52B739C0FC7
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2024 21:32:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E4AED10E8DF;
	Thu,  7 Nov 2024 20:32:55 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="kp/Cyd//";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D39D410E8DE;
 Thu,  7 Nov 2024 20:32:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1731011574; x=1762547574;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=eeEDQizXV1jX+2tRV5n5fN8KTMW0Gad0xseG+FUUuNA=;
 b=kp/Cyd//Dz+S6rCfNf0ESsRzliSg8Dw+5VFvbGzUtWlQ6O9sFROPOlbJ
 iHiW3A/fo9iM57YiPD6PFx+jWa2HaP3n7W27eaiXfGkNxW2C3motxZQhe
 4lYJQ0EXB1y9b97tSs159rEFSlISU7In3vxulqp77svNif4hFRES8BRkO
 cZ0nlFlg4KDAzn8rAY2tamfgf19SBP4E3BVGYVWsnYLwvLjfji3TZgZU/
 MIxp+rB8HqyVHWH8GpLcFw7Rt7FXpkU0x3Qac9ppX/sWe8iRxK00EV/jD
 t+7f693iIXPQGAMn5OhzALplcLXjoY9U2rPEIiaRW1jPSth/lyiubemAz w==;
X-CSE-ConnectionGUID: mq/KbPujTxGhDWsysR2xpw==
X-CSE-MsgGUID: 31tLxm9mSxC0coTGTow56A==
X-IronPort-AV: E=McAfee;i="6700,10204,11249"; a="30298081"
X-IronPort-AV: E=Sophos;i="6.12,136,1728975600"; d="scan'208";a="30298081"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 12:32:54 -0800
X-CSE-ConnectionGUID: bLOxp3BISqqF/veCOvvH8g==
X-CSE-MsgGUID: jZWeRZOvRiKIWw/KQhb45A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,136,1728975600"; d="scan'208";a="108493852"
Received: from klitkey1-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.233])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 12:32:52 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, imre.deak@intel.com, ville.syrjala@linux.intel.com
Subject: [PATCH 5/8] drm/i915/display: make CHICKEN_TRANS() display version
 aware
Date: Thu,  7 Nov 2024 22:32:18 +0200
Message-Id: <547599ac740ffb71bc83f4ac44c88f0b572e9c7e.1731011435.git.jani.nikula@intel.com>

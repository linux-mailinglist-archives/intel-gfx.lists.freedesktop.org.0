...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E5235493F66
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jan 2022 18:53:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2AF0210E261;
	Wed, 19 Jan 2022 17:53:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x336.google.com (mail-wm1-x336.google.com
 [IPv6:2a00:1450:4864:20::336])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C156910E170;
 Wed, 19 Jan 2022 07:23:42 +0000 (UTC)
Received: by mail-wm1-x336.google.com with SMTP id
 q141-20020a1ca793000000b00347b48dfb53so3930312wme.0; 
 Tue, 18 Jan 2022 23:23:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=subject:to:cc:references:from:message-id:date:user-agent
 :mime-version:in-reply-to:content-transfer-encoding:content-language;
 bh=cUENkJnSwQkEO7H4GicwQpdjIXchiMO/0LPN8H33zlQ=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-language;
 bh=cUENkJnSwQkEO7H4GicwQpdjIXchiMO/0LPN8H33zlQ=;
 b=
X-Gm-Message-State: AOAM531Q91a/cv79APp5wv6CyP3thnncqtvLsQsZ9WwmPNacQNdeJxt4
 OKnrAUPMRdmFmJom/QVFmqBcalvW+/8=
X-Google-Smtp-Source: ABdhPJwdZFL1UKMmN1jkXAw+nDptFmFEiwHXQ/o1xYZkX8nH1P3JHEZNITvkGaqwfFAHvxQptLuUcQ==
X-Received: by 2002:a05:6000:1c1e:: with SMTP id
 ba30mr2137170wrb.699.1642577020813; 
 Tue, 18 Jan 2022 23:23:40 -0800 (PST)
Received: from [192.168.178.21] (p57b0bff8.dip0.t-ipconnect.de.
 [87.176.191.248])
 by smtp.gmail.com with ESMTPSA id e13sm18369498wrw.3.2022.01.18.23.23.38
...
Message-ID: <d127ff60-30d5-9cb3-4e0b-273baa6d63db@gmail.com>
Date: Wed, 19 Jan 2022 08:23:38 +0100
...
Subject: Re: [Intel-gfx] [PATCH v9 1/6] drm: move the buddy allocator from

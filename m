...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB2C954588D
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 01:21:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1EB712B1E1;
	Thu,  9 Jun 2022 23:21:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B417E12B07D
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=nNs92xM7ObK84y2wdlN3xyzUjP2T4UlDuU8P97R9s7o=;
 b=lEmzEg4BKLKI98csPTWIL1WSRp1L9dNxXREK2jBabF+mD+gcyiMpqkYZ
 un2wazB9wBoL9bhZ4cGS1YaDe5zc5nOj+sIW0rZMDz9aHO4RvMrNfHNnQ
 jVcTDNndvQsV599KhtWO97y1u2uGEvqMyuvQ+S01RhXCHqOw4YIGIERa3
 h9edEyqMOry9+VYBvRRRVhRRHJMM9kU7+Lqqbvi8bEIowsN1+g8WsxnfK
 zdnVblajSt0WVtssEbUw+lBuoz9wjfMvQJZyGuVdgdC3Nqiswhq+n+XZQ
 kGGjg8PeMFvQyvLyexgvkUOrDndv3EnXnA96XNvSiinOO6T+S2EHcbnn6 A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10373"; a="278257629"
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="278257629"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2022 16:21:07 -0700
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="908586450"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2022 16:21:06 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  9 Jun 2022 16:19:48 -0700
Message-Id: <20220609231955.3632596-9-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH 08/15] drm/i915/pxp: implement function for

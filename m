...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 761501A09BD
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Apr 2020 11:07:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CFC0F6E7D5;
	Tue,  7 Apr 2020 09:07:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6C4D66E7D5
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Apr 2020 09:07:17 +0000 (UTC)
IronPort-SDR: WzEEKYUNqm/ZRYGrXgTsix0q0RCGumpPW69y5QwgNXT/fBtB08I4WqM75nwIya8ok+KvwD1Nfx
 HFb923lYGJ/A==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2020 02:07:16 -0700
IronPort-SDR: SfqqR8GmzBpKYEwS5m15Khe65SRMJJTKhcZsV9vqY9qtC9QQeWlZ/oTfOojtDGZALdvNs66nly
 GgWl4jdx96KQ==
X-IronPort-AV: E=Sophos;i="5.72,353,1580803200"; d="scan'208";a="254396544"
Received: from vkazinx-mobl2.ger.corp.intel.com (HELO [10.251.172.173])
 ([10.251.172.173])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2020 02:07:14 -0700
To: Chris Wilson <chris@chris-wilson.co.uk>, intel-gfx@lists.freedesktop.org
References: <20200403091300.14734-1-chris@chris-wilson.co.uk>
 <20200403091300.14734-2-chris@chris-wilson.co.uk>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
Message-ID: <063fc269-6491-9f3d-2cd3-a6dbe912694e@linux.intel.com>
Date: Tue, 7 Apr 2020 10:07:11 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <20200403091300.14734-2-chris@chris-wilson.co.uk>
Content-Language: en-US
Subject: Re: [Intel-gfx] [PATCH 02/10] drm/i915/gt: Yield the timeslice if

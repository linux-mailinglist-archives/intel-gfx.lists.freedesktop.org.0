...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34A04D0A3AC
	for <lists+intel-gfx@lfdr.de>; Fri, 09 Jan 2026 14:09:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C07C810E8BA;
	Fri,  9 Jan 2026 13:09:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from a3b018990fe9 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 68EC710E8BA;
 Fri,  9 Jan 2026 13:09:05 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============4451465132806128019=="
MIME-Version: 1.0
...
Date: Fri, 09 Jan 2026 13:09:05 -0000
Message-ID: <176796414538.140724.11997064327881178805@a3b018990fe9>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_159261v2_full absolutely need to be
  verified manually.
  
  If you think the reported changes have nothing to do with the changes
  introduced in Patchwork_159261v2_full, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_159261v2_full:
...
#### Possible regressions ####
  ...
  * igt@gem_exec_gttfill@engines@vecs0:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-7/igt@gem_exec_gttfill@engines@vecs0.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-3/igt@gem_exec_gttfill@engines@vecs0.html
...
#### Issues hit ####
  ...
  * igt@api_intel_bb@blit-reloc-purge-cache:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@api_intel_bb@blit-reloc-purge-cache.html

  * igt@api_intel_bb@crc32:
    - shard-tglu-1:       NOTRUN -> [SKIP][4] ([i915#6230])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@api_intel_bb@crc32.html

  * igt@device_reset@cold-reset-bound:
    - shard-tglu-1:       NOTRUN -> [SKIP][5] ([i915#11078])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@device_reset@cold-reset-bound.html

  * igt@gem_basic@multigpu-create-close:
    - shard-rkl:          NOTRUN -> [SKIP][6] ([i915#7697])
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@gem_basic@multigpu-create-close.html
    - shard-dg1:          NOTRUN -> [SKIP][7] ([i915#7697])
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@gem_basic@multigpu-create-close.html
    - shard-tglu:         NOTRUN -> [SKIP][8] ([i915#7697])
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_basic@multigpu-create-close.html

  * igt@gem_ccs@block-copy-compressed:
    - shard-tglu:         NOTRUN -> [SKIP][9] ([i915#3555] / [i915#9323])
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_ccs@block-copy-compressed.html

  * igt@gem_ccs@ctrl-surf-copy:
    - shard-rkl:          NOTRUN -> [SKIP][10] ([i915#3555] / [i915#9323])
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@gem_ccs@ctrl-surf-copy.html

  * igt@gem_ccs@large-ctrl-surf-copy:
    - shard-tglu:         NOTRUN -> [SKIP][11] ([i915#13008])
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_ccs@large-ctrl-surf-copy.html

  * igt@gem_ccs@suspend-resume:
    - shard-dg2:          [PASS][12] -> [INCOMPLETE][13] ([i915#13356]) +3 other tests incomplete
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-8/igt@gem_ccs@suspend-resume.html
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-4/igt@gem_ccs@suspend-resume.html
    - shard-rkl:          NOTRUN -> [SKIP][14] ([i915#9323])
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@gem_ccs@suspend-resume.html
    - shard-dg1:          NOTRUN -> [SKIP][15] ([i915#9323])
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@gem_ccs@suspend-resume.html
    - shard-tglu:         NOTRUN -> [SKIP][16] ([i915#9323])
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_ccs@suspend-resume.html

  * igt@gem_create@create-ext-cpu-access-sanity-check:
    - shard-rkl:          NOTRUN -> [SKIP][17] ([i915#6335])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@gem_create@create-ext-cpu-access-sanity-check.html

  * igt@gem_create@create-ext-set-pat:
    - shard-rkl:          NOTRUN -> [SKIP][18] ([i915#8562])
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_create@create-ext-set-pat.html

  * igt@gem_ctx_sseu@invalid-sseu:
    - shard-tglu:         NOTRUN -> [SKIP][19] ([i915#280])
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_ctx_sseu@invalid-sseu.html

  * igt@gem_exec_balancer@parallel:
    - shard-tglu:         NOTRUN -> [SKIP][20] ([i915#4525]) +1 other test skip
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_exec_balancer@parallel.html

  * igt@gem_exec_balancer@parallel-balancer:
    - shard-tglu-1:       NOTRUN -> [SKIP][21] ([i915#4525]) +1 other test skip
   [21]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@gem_exec_balancer@parallel-balancer.html

  * igt@gem_exec_capture@capture-recoverable:
    - shard-tglu:         NOTRUN -> [SKIP][22] ([i915#6344])
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_exec_capture@capture-recoverable.html

  * igt@gem_exec_gttfill@engines:
    - shard-dg2:          [PASS][23] -> [DMESG-FAIL][24] ([i915#15319])
   [23]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-7/igt@gem_exec_gttfill@engines.html
   [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-3/igt@gem_exec_gttfill@engines.html

  * igt@gem_exec_reloc@basic-scanout:
    - shard-rkl:          NOTRUN -> [SKIP][25] ([i915#3281]) +8 other tests skip
   [25]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@gem_exec_reloc@basic-scanout.html

  * igt@gem_exec_reloc@basic-write-gtt:
    - shard-dg1:          NOTRUN -> [SKIP][26] ([i915#3281]) +2 other tests skip
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@gem_exec_reloc@basic-write-gtt.html

  * igt@gem_huc_copy@huc-copy:
    - shard-rkl:          NOTRUN -> [SKIP][27] ([i915#2190])
   [27]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@gem_huc_copy@huc-copy.html

  * igt@gem_lmem_evict@dontneed-evict-race:
    - shard-rkl:          NOTRUN -> [SKIP][28] ([i915#4613] / [i915#7582])
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@gem_lmem_evict@dontneed-evict-race.html

  * igt@gem_lmem_swapping@heavy-multi:
    - shard-rkl:          NOTRUN -> [SKIP][29] ([i915#4613]) +2 other tests skip
   [29]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_lmem_swapping@heavy-multi.html
    - shard-tglu-1:       NOTRUN -> [SKIP][30] ([i915#4613]) +1 other test skip
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@gem_lmem_swapping@heavy-multi.html

  * igt@gem_lmem_swapping@massive:
    - shard-tglu:         NOTRUN -> [SKIP][31] ([i915#4613]) +1 other test skip
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_lmem_swapping@massive.html

  * igt@gem_lmem_swapping@verify-ccs:
    - shard-glk:          NOTRUN -> [SKIP][32] ([i915#4613]) +2 other tests skip
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk9/igt@gem_lmem_swapping@verify-ccs.html

  * igt@gem_media_vme:
    - shard-rkl:          NOTRUN -> [SKIP][33] ([i915#284])
   [33]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_media_vme.html
    - shard-tglu-1:       NOTRUN -> [SKIP][34] ([i915#284])
   [34]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@gem_media_vme.html

  * igt@gem_pread@exhaustion:
    - shard-tglu:         NOTRUN -> [WARN][35] ([i915#2658])
   [35]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gem_pread@exhaustion.html

  * igt@gem_pwrite@basic-exhaustion:
    - shard-rkl:          NOTRUN -> [SKIP][36] ([i915#3282]) +8 other tests skip
   [36]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_pwrite@basic-exhaustion.html
    - shard-tglu-1:       NOTRUN -> [WARN][37] ([i915#2658])
   [37]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@gem_pwrite@basic-exhaustion.html

  * igt@gem_pxp@hw-rejects-pxp-buffer:
    - shard-tglu-1:       NOTRUN -> [SKIP][38] ([i915#13398]) +1 other test skip
   [38]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@gem_pxp@hw-rejects-pxp-buffer.html

  * igt@gem_pxp@protected-raw-src-copy-not-readible:
    - shard-rkl:          NOTRUN -> [SKIP][39] ([i915#4270]) +1 other test skip
   [39]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@gem_pxp@protected-raw-src-copy-not-readible.html

  * igt@gem_pxp@verify-pxp-execution-after-suspend-resume:
    - shard-dg1:          NOTRUN -> [SKIP][40] ([i915#4270])
   [40]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@gem_pxp@verify-pxp-execution-after-suspend-resume.html

  * igt@gem_userptr_blits@access-control:
    - shard-tglu-1:       NOTRUN -> [SKIP][41] ([i915#3297]) +1 other test skip
   [41]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@gem_userptr_blits@access-control.html

  * igt@gem_userptr_blits@readonly-unsync:
    - shard-rkl:          NOTRUN -> [SKIP][42] ([i915#3297])
   [42]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@gem_userptr_blits@readonly-unsync.html

  * igt@gem_workarounds@suspend-resume-fd:
    - shard-rkl:          [PASS][43] -> [INCOMPLETE][44] ([i915#13356])
   [43]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-2/igt@gem_workarounds@suspend-resume-fd.html
   [44]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_workarounds@suspend-resume-fd.html
    - shard-glk:          NOTRUN -> [INCOMPLETE][45] ([i915#13356] / [i915#14586])
   [45]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk5/igt@gem_workarounds@suspend-resume-fd.html

  * igt@gen9_exec_parse@allowed-single:
    - shard-tglu-1:       NOTRUN -> [SKIP][46] ([i915#2527] / [i915#2856])
   [46]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@gen9_exec_parse@allowed-single.html

  * igt@gen9_exec_parse@batch-invalid-length:
    - shard-tglu:         NOTRUN -> [SKIP][47] ([i915#2527] / [i915#2856]) +1 other test skip
   [47]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@gen9_exec_parse@batch-invalid-length.html

  * igt@gen9_exec_parse@batch-without-end:
    - shard-dg1:          NOTRUN -> [SKIP][48] ([i915#2527])
   [48]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@gen9_exec_parse@batch-without-end.html

  * igt@gen9_exec_parse@secure-batches:
    - shard-rkl:          NOTRUN -> [SKIP][49] ([i915#2527]) +2 other tests skip
   [49]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@gen9_exec_parse@secure-batches.html

  * igt@i915_drm_fdinfo@busy-idle@bcs0:
    - shard-dg1:          NOTRUN -> [SKIP][50] ([i915#14073]) +5 other tests skip
   [50]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@i915_drm_fdinfo@busy-idle@bcs0.html

  * igt@i915_module_load@fault-injection:
    - shard-rkl:          NOTRUN -> [ABORT][51] ([i915#15342] / [i915#15481])
   [51]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@i915_module_load@fault-injection.html

  * igt@i915_module_load@fault-injection@i915_driver_hw_probe:
    - shard-rkl:          NOTRUN -> [ABORT][52] ([i915#15481])
   [52]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@i915_module_load@fault-injection@i915_driver_hw_probe.html

  * igt@i915_module_load@fault-injection@intel_connector_register:
    - shard-rkl:          NOTRUN -> [DMESG-WARN][53] ([i915#15342])
   [53]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@i915_module_load@fault-injection@intel_connector_register.html

  * igt@i915_module_load@fault-injection@intel_gt_init-enodev:
    - shard-rkl:          NOTRUN -> [SKIP][54] ([i915#15479]) +4 other tests skip
   [54]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@i915_module_load@fault-injection@intel_gt_init-enodev.html

  * igt@i915_module_load@resize-bar:
    - shard-rkl:          NOTRUN -> [SKIP][55] ([i915#6412])
   [55]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@i915_module_load@resize-bar.html

  * igt@i915_pm_freq_api@freq-suspend:
    - shard-tglu-1:       NOTRUN -> [SKIP][56] ([i915#8399]) +1 other test skip
   [56]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@i915_pm_freq_api@freq-suspend.html

  * igt@i915_pm_rc6_residency@rc6-fence:
    - shard-tglu:         [PASS][57] -> [WARN][58] ([i915#13790] / [i915#2681]) +1 other test warn
   [57]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-tglu-6/igt@i915_pm_rc6_residency@rc6-fence.html
   [58]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-5/igt@i915_pm_rc6_residency@rc6-fence.html

  * igt@i915_pm_sseu@full-enable:
    - shard-tglu-1:       NOTRUN -> [SKIP][59] ([i915#4387])
   [59]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@i915_pm_sseu@full-enable.html

  * igt@i915_power@sanity:
    - shard-mtlp:         [PASS][60] -> [SKIP][61] ([i915#7984])
   [60]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-7/igt@i915_power@sanity.html
   [61]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-7/igt@i915_power@sanity.html

  * igt@i915_query@hwconfig_table:
    - shard-tglu:         NOTRUN -> [SKIP][62] ([i915#6245])
   [62]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@i915_query@hwconfig_table.html

  * igt@i915_suspend@fence-restore-untiled:
    - shard-rkl:          [PASS][63] -> [ABORT][64] ([i915#15131])
   [63]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-4/igt@i915_suspend@fence-restore-untiled.html
   [64]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-1/igt@i915_suspend@fence-restore-untiled.html
    - shard-glk:          NOTRUN -> [INCOMPLETE][65] ([i915#4817])
   [65]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk1/igt@i915_suspend@fence-restore-untiled.html

  * igt@intel_hwmon@hwmon-read:
    - shard-rkl:          NOTRUN -> [SKIP][66] ([i915#7707])
   [66]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@intel_hwmon@hwmon-read.html

  * igt@kms_atomic@plane-primary-overlay-mutable-zpos:
    - shard-rkl:          NOTRUN -> [SKIP][67] ([i915#9531])
   [67]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_atomic@plane-primary-overlay-mutable-zpos.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-internal-panels:
    - shard-rkl:          NOTRUN -> [SKIP][68] ([i915#1769] / [i915#3555])
   [68]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_atomic_transition@plane-all-modeset-transition-internal-panels.html

  * igt@kms_big_fb@4-tiled-16bpp-rotate-180:
    - shard-rkl:          NOTRUN -> [SKIP][69] ([i915#5286]) +6 other tests skip
   [69]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_big_fb@4-tiled-16bpp-rotate-180.html

  * igt@kms_big_fb@4-tiled-32bpp-rotate-270:
    - shard-tglu:         NOTRUN -> [SKIP][70] ([i915#5286]) +2 other tests skip
   [70]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_big_fb@4-tiled-32bpp-rotate-270.html

  * igt@kms_big_fb@4-tiled-8bpp-rotate-180:
    - shard-tglu-1:       NOTRUN -> [SKIP][71] ([i915#5286]) +3 other tests skip
   [71]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_big_fb@4-tiled-8bpp-rotate-180.html

  * igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-180-hflip:
    - shard-mtlp:         [PASS][72] -> [FAIL][73] ([i915#5138])
   [72]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-2/igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-180-hflip.html
   [73]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-7/igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-180-hflip.html

  * igt@kms_big_fb@linear-8bpp-rotate-270:
    - shard-rkl:          NOTRUN -> [SKIP][74] ([i915#3638]) +3 other tests skip
   [74]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_big_fb@linear-8bpp-rotate-270.html

  * igt@kms_big_fb@yf-tiled-64bpp-rotate-270:
    - shard-dg1:          NOTRUN -> [SKIP][75] ([i915#4538])
   [75]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_big_fb@yf-tiled-64bpp-rotate-270.html

  * igt@kms_ccs@bad-aux-stride-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-4:
    - shard-dg1:          NOTRUN -> [SKIP][76] ([i915#6095]) +228 other tests skip
   [76]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-19/igt@kms_ccs@bad-aux-stride-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-4.html

  * igt@kms_ccs@bad-aux-stride-y-tiled-gen12-rc-ccs-cc@pipe-d-hdmi-a-1:
    - shard-dg2:          NOTRUN -> [SKIP][77] ([i915#10307] / [i915#10434] / [i915#6095]) +2 other tests skip
   [77]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-4/igt@kms_ccs@bad-aux-stride-y-tiled-gen12-rc-ccs-cc@pipe-d-hdmi-a-1.html

  * igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][78] ([i915#6095]) +71 other tests skip
   [78]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-3/igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@bad-rotation-90-yf-tiled-ccs@pipe-a-hdmi-a-1:
    - shard-tglu:         NOTRUN -> [SKIP][79] ([i915#6095]) +34 other tests skip
   [79]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_ccs@bad-rotation-90-yf-tiled-ccs@pipe-a-hdmi-a-1.html

  * igt@kms_ccs@ccs-on-another-bo-4-tiled-mtl-mc-ccs@pipe-c-hdmi-a-2:
    - shard-glk:          NOTRUN -> [SKIP][80] +161 other tests skip
   [80]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk6/igt@kms_ccs@ccs-on-another-bo-4-tiled-mtl-mc-ccs@pipe-c-hdmi-a-2.html

  * igt@kms_ccs@crc-primary-basic-4-tiled-bmg-ccs:
    - shard-tglu-1:       NOTRUN -> [SKIP][81] ([i915#12313])
   [81]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_ccs@crc-primary-basic-4-tiled-bmg-ccs.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-dg2-rc-ccs@pipe-c-hdmi-a-1:
    - shard-dg2:          NOTRUN -> [SKIP][82] ([i915#6095]) +35 other tests skip
   [82]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-4/igt@kms_ccs@crc-primary-rotation-180-4-tiled-dg2-rc-ccs@pipe-c-hdmi-a-1.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-rc-ccs-cc@pipe-b-hdmi-a-1:
    - shard-tglu-1:       NOTRUN -> [SKIP][83] ([i915#6095]) +24 other tests skip
   [83]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-rc-ccs-cc@pipe-b-hdmi-a-1.html

  * igt@kms_ccs@crc-primary-suspend-4-tiled-lnl-ccs:
    - shard-rkl:          NOTRUN -> [SKIP][84] ([i915#12805]) +1 other test skip
   [84]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_ccs@crc-primary-suspend-4-tiled-lnl-ccs.html

  * igt@kms_ccs@crc-primary-suspend-yf-tiled-ccs:
    - shard-glk:          NOTRUN -> [INCOMPLETE][85] ([i915#12796]) +1 other test incomplete
   [85]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk9/igt@kms_ccs@crc-primary-suspend-yf-tiled-ccs.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-c-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][86] ([i915#14098] / [i915#6095]) +47 other tests skip
   [86]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-3/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-c-hdmi-a-2.html

  * igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs:
    - shard-tglu:         NOTRUN -> [SKIP][87] ([i915#12313])
   [87]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs.html

  * igt@kms_ccs@random-ccs-data-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-1:
    - shard-dg2:          NOTRUN -> [SKIP][88] ([i915#10307] / [i915#6095]) +76 other tests skip
   [88]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-4/igt@kms_ccs@random-ccs-data-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-1.html

  * igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][89] ([i915#13781]) +3 other tests skip
   [89]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-3/igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-3.html

  * igt@kms_chamelium_color@degamma:
    - shard-dg1:          NOTRUN -> [SKIP][90] +2 other tests skip
   [90]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_chamelium_color@degamma.html

  * igt@kms_chamelium_frames@dp-crc-fast:
    - shard-glk10:        NOTRUN -> [SKIP][91] +12 other tests skip
   [91]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk10/igt@kms_chamelium_frames@dp-crc-fast.html

  * igt@kms_chamelium_frames@dp-crc-single:
    - shard-tglu-1:       NOTRUN -> [SKIP][92] ([i915#11151] / [i915#7828]) +3 other tests skip
   [92]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_chamelium_frames@dp-crc-single.html

  * igt@kms_chamelium_hpd@dp-hpd-fast:
    - shard-tglu:         NOTRUN -> [SKIP][93] ([i915#11151] / [i915#7828]) +3 other tests skip
   [93]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_chamelium_hpd@dp-hpd-fast.html

  * igt@kms_chamelium_hpd@vga-hpd-for-each-pipe:
    - shard-rkl:          NOTRUN -> [SKIP][94] ([i915#11151] / [i915#7828]) +6 other tests skip
   [94]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_chamelium_hpd@vga-hpd-for-each-pipe.html

  * igt@kms_color@deep-color:
    - shard-rkl:          [PASS][95] -> [SKIP][96] ([i915#12655] / [i915#3555])
   [95]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-1/igt@kms_color@deep-color.html
   [96]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_color@deep-color.html

  * igt@kms_color_pipeline@plane-lut3d-green-only@pipe-b-hdmi-a-1:
    - shard-dg1:          NOTRUN -> [SKIP][97] ([i915#15523]) +3 other tests skip
   [97]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-14/igt@kms_color_pipeline@plane-lut3d-green-only@pipe-b-hdmi-a-1.html

  * igt@kms_content_protection@atomic:
    - shard-tglu:         NOTRUN -> [SKIP][98] ([i915#6944] / [i915#7116] / [i915#7118] / [i915#9424])
   [98]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_content_protection@atomic.html

  * igt@kms_content_protection@atomic-dpms-hdcp14:
    - shard-tglu-1:       NOTRUN -> [SKIP][99] ([i915#6944])
   [99]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_content_protection@atomic-dpms-hdcp14.html

  * igt@kms_content_protection@content-type-change:
    - shard-rkl:          NOTRUN -> [SKIP][100] ([i915#6944] / [i915#9424])
   [100]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_content_protection@content-type-change.html

  * igt@kms_content_protection@dp-mst-suspend-resume:
    - shard-rkl:          NOTRUN -> [SKIP][101] ([i915#15330])
   [101]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_content_protection@dp-mst-suspend-resume.html

  * igt@kms_content_protection@dp-mst-type-1:
    - shard-rkl:          NOTRUN -> [SKIP][102] ([i915#15330] / [i915#3116]) +1 other test skip
   [102]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_content_protection@dp-mst-type-1.html
    - shard-tglu-1:       NOTRUN -> [SKIP][103] ([i915#15330] / [i915#3116] / [i915#3299])
   [103]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_content_protection@dp-mst-type-1.html

  * igt@kms_content_protection@legacy-hdcp14:
    - shard-tglu:         NOTRUN -> [SKIP][104] ([i915#6944])
   [104]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_content_protection@legacy-hdcp14.html

  * igt@kms_content_protection@srm:
    - shard-tglu:         NOTRUN -> [SKIP][105] ([i915#6944] / [i915#7116] / [i915#7118])
   [105]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_content_protection@srm.html

  * igt@kms_cursor_crc@cursor-offscreen-32x32:
    - shard-tglu-1:       NOTRUN -> [SKIP][106] ([i915#3555]) +4 other tests skip
   [106]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_cursor_crc@cursor-offscreen-32x32.html

  * igt@kms_cursor_crc@cursor-offscreen-512x170:
    - shard-tglu-1:       NOTRUN -> [SKIP][107] ([i915#13049])
   [107]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_cursor_crc@cursor-offscreen-512x170.html

  * igt@kms_cursor_crc@cursor-random-128x42:
    - shard-tglu:         [PASS][108] -> [FAIL][109] ([i915#13566]) +5 other tests fail
   [108]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-tglu-10/igt@kms_cursor_crc@cursor-random-128x42.html
   [109]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-8/igt@kms_cursor_crc@cursor-random-128x42.html

  * igt@kms_cursor_crc@cursor-rapid-movement-32x32:
    - shard-tglu:         NOTRUN -> [SKIP][110] ([i915#3555]) +1 other test skip
   [110]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_cursor_crc@cursor-rapid-movement-32x32.html

  * igt@kms_cursor_crc@cursor-sliding-128x42:
    - shard-tglu:         NOTRUN -> [FAIL][111] ([i915#13566]) +1 other test fail
   [111]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_cursor_crc@cursor-sliding-128x42.html

  * igt@kms_cursor_crc@cursor-sliding-128x42@pipe-a-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [FAIL][112] ([i915#13566])
   [112]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@kms_cursor_crc@cursor-sliding-128x42@pipe-a-hdmi-a-1.html

  * igt@kms_cursor_crc@cursor-sliding-32x10:
    - shard-rkl:          NOTRUN -> [SKIP][113] ([i915#3555]) +6 other tests skip
   [113]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_cursor_crc@cursor-sliding-32x10.html

  * igt@kms_cursor_crc@cursor-sliding-512x512:
    - shard-rkl:          NOTRUN -> [SKIP][114] ([i915#13049]) +1 other test skip
   [114]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_cursor_crc@cursor-sliding-512x512.html

  * igt@kms_cursor_crc@cursor-suspend:
    - shard-glk:          NOTRUN -> [INCOMPLETE][115] ([i915#12358] / [i915#14152] / [i915#7882])
   [115]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk5/igt@kms_cursor_crc@cursor-suspend.html

  * igt@kms_cursor_crc@cursor-suspend@pipe-a-hdmi-a-1:
    - shard-glk:          NOTRUN -> [INCOMPLETE][116] ([i915#12358] / [i915#14152])
   [116]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk5/igt@kms_cursor_crc@cursor-suspend@pipe-a-hdmi-a-1.html

  * igt@kms_cursor_crc@cursor-suspend@pipe-a-hdmi-a-2:
    - shard-rkl:          [PASS][117] -> [INCOMPLETE][118] ([i915#12358] / [i915#14152]) +1 other test incomplete
   [117]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_cursor_crc@cursor-suspend@pipe-a-hdmi-a-2.html
   [118]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_cursor_crc@cursor-suspend@pipe-a-hdmi-a-2.html

  * igt@kms_cursor_legacy@basic-busy-flip-before-cursor-varying-size:
    - shard-rkl:          NOTRUN -> [SKIP][119] ([i915#4103])
   [119]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_cursor_legacy@basic-busy-flip-before-cursor-varying-size.html

  * igt@kms_cursor_legacy@flip-vs-cursor-atomic-transitions-varying-size:
    - shard-glk:          [PASS][120] -> [FAIL][121] ([i915#2346])
   [120]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-glk6/igt@kms_cursor_legacy@flip-vs-cursor-atomic-transitions-varying-size.html
   [121]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk1/igt@kms_cursor_legacy@flip-vs-cursor-atomic-transitions-varying-size.html

  * igt@kms_dirtyfb@psr-dirtyfb-ioctl:
    - shard-rkl:          NOTRUN -> [SKIP][122] ([i915#9723]) +1 other test skip
   [122]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_dirtyfb@psr-dirtyfb-ioctl.html
    - shard-tglu-1:       NOTRUN -> [SKIP][123] ([i915#9723])
   [123]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_dirtyfb@psr-dirtyfb-ioctl.html

  * igt@kms_dither@fb-8bpc-vs-panel-6bpc@pipe-a-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [SKIP][124] ([i915#3804])
   [124]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_dither@fb-8bpc-vs-panel-6bpc@pipe-a-hdmi-a-1.html

  * igt@kms_dp_aux_dev:
    - shard-dg2:          [PASS][125] -> [SKIP][126] ([i915#1257])
   [125]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-11/igt@kms_dp_aux_dev.html
   [126]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-7/igt@kms_dp_aux_dev.html

  * igt@kms_dp_link_training@non-uhbr-sst:
    - shard-tglu:         NOTRUN -> [SKIP][127] ([i915#13749])
   [127]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_dp_link_training@non-uhbr-sst.html

  * igt@kms_dp_link_training@uhbr-mst:
    - shard-tglu:         NOTRUN -> [SKIP][128] ([i915#13748])
   [128]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_dp_link_training@uhbr-mst.html

  * igt@kms_dsc@dsc-with-output-formats:
    - shard-rkl:          NOTRUN -> [SKIP][129] ([i915#3555] / [i915#3840])
   [129]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_dsc@dsc-with-output-formats.html

  * igt@kms_feature_discovery@chamelium:
    - shard-tglu-1:       NOTRUN -> [SKIP][130] ([i915#2065] / [i915#4854])
   [130]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_feature_discovery@chamelium.html

  * igt@kms_feature_discovery@display-4x:
    - shard-tglu-1:       NOTRUN -> [SKIP][131] ([i915#1839])
   [131]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_feature_discovery@display-4x.html

  * igt@kms_feature_discovery@psr2:
    - shard-dg1:          NOTRUN -> [SKIP][132] ([i915#658])
   [132]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_feature_discovery@psr2.html
    - shard-snb:          NOTRUN -> [SKIP][133] +21 other tests skip
   [133]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-snb4/igt@kms_feature_discovery@psr2.html
    - shard-tglu:         NOTRUN -> [SKIP][134] ([i915#658])
   [134]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_feature_discovery@psr2.html
    - shard-rkl:          NOTRUN -> [SKIP][135] ([i915#658])
   [135]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@kms_feature_discovery@psr2.html

  * igt@kms_flip@2x-flip-vs-dpms-off-vs-modeset-interruptible:
    - shard-rkl:          NOTRUN -> [SKIP][136] ([i915#9934]) +10 other tests skip
   [136]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_flip@2x-flip-vs-dpms-off-vs-modeset-interruptible.html

  * igt@kms_flip@2x-flip-vs-dpms-on-nop:
    - shard-tglu:         NOTRUN -> [SKIP][137] ([i915#9934])
   [137]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_flip@2x-flip-vs-dpms-on-nop.html

  * igt@kms_flip@2x-flip-vs-fences-interruptible:
    - shard-tglu-1:       NOTRUN -> [SKIP][138] ([i915#3637] / [i915#9934]) +2 other tests skip
   [138]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_flip@2x-flip-vs-fences-interruptible.html

  * igt@kms_flip@2x-flip-vs-modeset:
    - shard-tglu:         NOTRUN -> [SKIP][139] ([i915#3637] / [i915#9934]) +4 other tests skip
   [139]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_flip@2x-flip-vs-modeset.html

  * igt@kms_flip@2x-flip-vs-suspend:
    - shard-glk10:        NOTRUN -> [INCOMPLETE][140] ([i915#12745] / [i915#4839])
   [140]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk10/igt@kms_flip@2x-flip-vs-suspend.html

  * igt@kms_flip@2x-flip-vs-suspend@ab-hdmi-a1-hdmi-a2:
    - shard-glk10:        NOTRUN -> [INCOMPLETE][141] ([i915#4839])
   [141]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk10/igt@kms_flip@2x-flip-vs-suspend@ab-hdmi-a1-hdmi-a2.html

  * igt@kms_flip@2x-plain-flip-interruptible:
    - shard-dg1:          NOTRUN -> [SKIP][142] ([i915#9934]) +1 other test skip
   [142]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_flip@2x-plain-flip-interruptible.html

  * igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling:
    - shard-tglu-1:       NOTRUN -> [SKIP][143] ([i915#2672] / [i915#3555]) +2 other tests skip
   [143]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling@pipe-a-valid-mode:
    - shard-tglu-1:       NOTRUN -> [SKIP][144] ([i915#2587] / [i915#2672]) +2 other tests skip
   [144]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-32bpp-ytileccs-to-64bpp-ytile-upscaling:
    - shard-tglu:         NOTRUN -> [SKIP][145] ([i915#2587] / [i915#2672] / [i915#3555])
   [145]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_flip_scaled_crc@flip-32bpp-ytileccs-to-64bpp-ytile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-32bpp-4tile-downscaling@pipe-a-valid-mode:
    - shard-tglu:         NOTRUN -> [SKIP][146] ([i915#2587] / [i915#2672]) +2 other tests skip
   [146]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-32bpp-4tile-downscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-downscaling:
    - shard-tglu:         NOTRUN -> [SKIP][147] ([i915#2672] / [i915#3555]) +1 other test skip
   [147]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-downscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling:
    - shard-rkl:          NOTRUN -> [SKIP][148] ([i915#2672] / [i915#3555]) +5 other tests skip
   [148]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling@pipe-a-valid-mode:
    - shard-rkl:          NOTRUN -> [SKIP][149] ([i915#2672]) +5 other tests skip
   [149]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling@pipe-a-valid-mode.html

  * igt@kms_frontbuffer_tracking@basic:
    - shard-dg1:          [PASS][150] -> [DMESG-WARN][151] ([i915#4423])
   [150]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg1-16/igt@kms_frontbuffer_tracking@basic.html
   [151]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-13/igt@kms_frontbuffer_tracking@basic.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-indfb-draw-mmap-wc:
    - shard-rkl:          NOTRUN -> [SKIP][152] ([i915#15102]) +2 other tests skip
   [152]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-indfb-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-shrfb-fliptrack-mmap-gtt:
    - shard-rkl:          NOTRUN -> [SKIP][153] +16 other tests skip
   [153]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-2p-shrfb-fliptrack-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-pwrite:
    - shard-rkl:          NOTRUN -> [SKIP][154] ([i915#15102] / [i915#3023]) +15 other tests skip
   [154]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-pwrite.html

  * igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-wc:
    - shard-tglu-1:       NOTRUN -> [SKIP][155] ([i915#15102]) +14 other tests skip
   [155]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbcpsr-tiling-4:
    - shard-tglu-1:       NOTRUN -> [SKIP][156] ([i915#5439])
   [156]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_frontbuffer_tracking@fbcpsr-tiling-4.html

  * igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-render:
    - shard-tglu:         NOTRUN -> [SKIP][157] ([i915#15102]) +10 other tests skip
   [157]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-render.html

  * igt@kms_frontbuffer_tracking@psr-2p-primscrn-spr-indfb-draw-render:
    - shard-tglu:         NOTRUN -> [SKIP][158] +32 other tests skip
   [158]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_frontbuffer_tracking@psr-2p-primscrn-spr-indfb-draw-render.html

  * igt@kms_frontbuffer_tracking@psr-2p-scndscrn-indfb-msflip-blt:
    - shard-rkl:          NOTRUN -> [SKIP][159] ([i915#1825]) +28 other tests skip
   [159]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_frontbuffer_tracking@psr-2p-scndscrn-indfb-msflip-blt.html

  * igt@kms_frontbuffer_tracking@psr-2p-scndscrn-pri-indfb-draw-mmap-wc:
    - shard-tglu-1:       NOTRUN -> [SKIP][160] +28 other tests skip
   [160]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_frontbuffer_tracking@psr-2p-scndscrn-pri-indfb-draw-mmap-wc.html

  * igt@kms_hdr@bpc-switch:
    - shard-tglu-1:       NOTRUN -> [SKIP][161] ([i915#3555] / [i915#8228]) +1 other test skip
   [161]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_hdr@bpc-switch.html

  * igt@kms_hdr@invalid-hdr:
    - shard-rkl:          NOTRUN -> [SKIP][162] ([i915#3555] / [i915#8228])
   [162]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_hdr@invalid-hdr.html

  * igt@kms_multipipe_modeset@basic-max-pipe-crc-check:
    - shard-rkl:          NOTRUN -> [SKIP][163] ([i915#1839] / [i915#4816])
   [163]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_multipipe_modeset@basic-max-pipe-crc-check.html

  * igt@kms_pipe_crc_basic@suspend-read-crc:
    - shard-glk10:        NOTRUN -> [INCOMPLETE][164] ([i915#12756] / [i915#13409] / [i915#13476])
   [164]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk10/igt@kms_pipe_crc_basic@suspend-read-crc.html

  * igt@kms_pipe_crc_basic@suspend-read-crc@pipe-b-hdmi-a-2:
    - shard-glk10:        NOTRUN -> [INCOMPLETE][165] ([i915#13409] / [i915#13476])
   [165]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk10/igt@kms_pipe_crc_basic@suspend-read-crc@pipe-b-hdmi-a-2.html

  * igt@kms_plane@plane-panning-bottom-right-suspend@pipe-a:
    - shard-rkl:          [PASS][166] -> [INCOMPLETE][167] ([i915#14412]) +1 other test incomplete
   [166]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_plane@plane-panning-bottom-right-suspend@pipe-a.html
   [167]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_plane@plane-panning-bottom-right-suspend@pipe-a.html

  * igt@kms_plane_multiple@2x-tiling-yf:
    - shard-tglu-1:       NOTRUN -> [SKIP][168] ([i915#13958])
   [168]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_plane_multiple@2x-tiling-yf.html

  * igt@kms_plane_scaling@intel-max-src-size:
    - shard-rkl:          [PASS][169] -> [SKIP][170] ([i915#6953])
   [169]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-1/igt@kms_plane_scaling@intel-max-src-size.html
   [170]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_plane_scaling@intel-max-src-size.html

  * igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation:
    - shard-rkl:          NOTRUN -> [SKIP][171] ([i915#15329] / [i915#3555])
   [171]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation.html
    - shard-dg1:          NOTRUN -> [SKIP][172] ([i915#15329] / [i915#3555])
   [172]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation.html
    - shard-tglu:         NOTRUN -> [SKIP][173] ([i915#15329] / [i915#3555])
   [173]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation.html

  * igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-b:
    - shard-rkl:          NOTRUN -> [SKIP][174] ([i915#15329]) +2 other tests skip
   [174]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-b.html
    - shard-dg1:          NOTRUN -> [SKIP][175] ([i915#15329]) +3 other tests skip
   [175]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-b.html
    - shard-tglu:         NOTRUN -> [SKIP][176] ([i915#15329]) +3 other tests skip
   [176]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-b.html

  * igt@kms_pm_backlight@fade-with-suspend:
    - shard-tglu-1:       NOTRUN -> [SKIP][177] ([i915#9812])
   [177]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_pm_backlight@fade-with-suspend.html

  * igt@kms_pm_dc@dc5-psr:
    - shard-rkl:          NOTRUN -> [SKIP][178] ([i915#9685]) +2 other tests skip
   [178]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_pm_dc@dc5-psr.html
    - shard-tglu-1:       NOTRUN -> [SKIP][179] ([i915#9685])
   [179]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_pm_dc@dc5-psr.html

  * igt@kms_pm_dc@dc5-retention-flops:
    - shard-tglu-1:       NOTRUN -> [SKIP][180] ([i915#3828])
   [180]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_pm_dc@dc5-retention-flops.html

  * igt@kms_pm_lpsp@screens-disabled:
    - shard-tglu:         NOTRUN -> [SKIP][181] ([i915#8430])
   [181]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_pm_lpsp@screens-disabled.html

  * igt@kms_pm_rpm@dpms-non-lpsp:
    - shard-dg2:          [PASS][182] -> [SKIP][183] ([i915#15073])
   [182]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-8/igt@kms_pm_rpm@dpms-non-lpsp.html
   [183]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-4/igt@kms_pm_rpm@dpms-non-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp:
    - shard-tglu:         NOTRUN -> [SKIP][184] ([i915#15073])
   [184]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_pm_rpm@modeset-non-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait:
    - shard-rkl:          [PASS][185] -> [SKIP][186] ([i915#15073]) +1 other test skip
   [185]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-1/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html
   [186]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html
    - shard-dg1:          [PASS][187] -> [SKIP][188] ([i915#15073]) +3 other tests skip
   [187]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg1-19/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html
   [188]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-14/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html

  * igt@kms_prime@basic-crc-hybrid:
    - shard-dg1:          NOTRUN -> [SKIP][189] ([i915#6524])
   [189]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_prime@basic-crc-hybrid.html
    - shard-tglu:         NOTRUN -> [SKIP][190] ([i915#6524])
   [190]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_prime@basic-crc-hybrid.html

  * igt@kms_prime@basic-modeset-hybrid:
    - shard-rkl:          NOTRUN -> [SKIP][191] ([i915#6524]) +2 other tests skip
   [191]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_prime@basic-modeset-hybrid.html

  * igt@kms_prime@d3hot:
    - shard-tglu-1:       NOTRUN -> [SKIP][192] ([i915#6524])
   [192]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_prime@d3hot.html

  * igt@kms_psr2_sf@fbc-pr-overlay-plane-move-continuous-exceed-sf:
    - shard-glk:          NOTRUN -> [SKIP][193] ([i915#11520]) +6 other tests skip
   [193]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-glk5/igt@kms_psr2_sf@fbc-pr-overlay-plane-move-continuous-exceed-sf.html

  * igt@kms_psr2_sf@fbc-pr-overlay-plane-move-continuous-sf:
    - shard-tglu:         NOTRUN -> [SKIP][194] ([i915#11520]) +3 other tests skip
   [194]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_psr2_sf@fbc-pr-overlay-plane-move-continuous-sf.html

  * igt@kms_psr2_sf@fbc-psr2-overlay-plane-update-sf-dmg-area:
    - shard-tglu-1:       NOTRUN -> [SKIP][195] ([i915#11520]) +2 other tests skip
   [195]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_psr2_sf@fbc-psr2-overlay-plane-update-sf-dmg-area.html

  * igt@kms_psr2_sf@fbc-psr2-overlay-primary-update-sf-dmg-area:
    - shard-rkl:          NOTRUN -> [SKIP][196] ([i915#11520]) +6 other tests skip
   [196]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_psr2_sf@fbc-psr2-overlay-primary-update-sf-dmg-area.html

  * igt@kms_psr2_sf@pr-overlay-plane-move-continuous-exceed-fully-sf:
    - shard-snb:          NOTRUN -> [SKIP][197] ([i915#11520]) +1 other test skip
   [197]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-snb4/igt@kms_psr2_sf@pr-overlay-plane-move-continuous-exceed-fully-sf.html

  * igt@kms_psr2_sf@psr2-overlay-plane-move-continuous-sf:
    - shard-dg1:          NOTRUN -> [SKIP][198] ([i915#11520]) +1 other test skip
   [198]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_psr2_sf@psr2-overlay-plane-move-continuous-sf.html

  * igt@kms_psr2_su@page_flip-p010:
    - shard-rkl:          NOTRUN -> [SKIP][199] ([i915#9683]) +1 other test skip
   [199]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_psr2_su@page_flip-p010.html

  * igt@kms_psr2_su@page_flip-xrgb8888:
    - shard-tglu-1:       NOTRUN -> [SKIP][200] ([i915#9683]) +1 other test skip
   [200]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_psr2_su@page_flip-xrgb8888.html

  * igt@kms_psr@fbc-psr-sprite-plane-move:
    - shard-tglu:         NOTRUN -> [SKIP][201] ([i915#9732]) +9 other tests skip
   [201]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_psr@fbc-psr-sprite-plane-move.html

  * igt@kms_psr@fbc-psr2-sprite-render:
    - shard-rkl:          NOTRUN -> [SKIP][202] ([i915#1072] / [i915#9732]) +18 other tests skip
   [202]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_psr@fbc-psr2-sprite-render.html

  * igt@kms_psr@psr2-primary-mmap-gtt:
    - shard-dg1:          NOTRUN -> [SKIP][203] ([i915#1072] / [i915#9732]) +2 other tests skip
   [203]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_psr@psr2-primary-mmap-gtt.html

  * igt@kms_psr@psr2-sprite-blt:
    - shard-tglu-1:       NOTRUN -> [SKIP][204] ([i915#9732]) +9 other tests skip
   [204]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_psr@psr2-sprite-blt.html

  * igt@kms_rotation_crc@primary-yf-tiled-reflect-x-270:
    - shard-tglu:         NOTRUN -> [SKIP][205] ([i915#5289]) +1 other test skip
   [205]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-4/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-270.html

  * igt@kms_rotation_crc@primary-yf-tiled-reflect-x-90:
    - shard-tglu-1:       NOTRUN -> [SKIP][206] ([i915#5289]) +1 other test skip
   [206]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-90.html

  * igt@kms_selftest@drm_framebuffer:
    - shard-tglu-1:       NOTRUN -> [ABORT][207] ([i915#13179]) +1 other test abort
   [207]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_selftest@drm_framebuffer.html

  * igt@kms_tiled_display@basic-test-pattern:
    - shard-rkl:          NOTRUN -> [SKIP][208] ([i915#8623])
   [208]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_tiled_display@basic-test-pattern.html

  * igt@kms_vrr@negative-basic:
    - shard-mtlp:         [PASS][209] -> [FAIL][210] ([i915#15420]) +1 other test fail
   [209]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-8/igt@kms_vrr@negative-basic.html
   [210]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-5/igt@kms_vrr@negative-basic.html

  * igt@kms_vrr@seamless-rr-switch-drrs:
    - shard-tglu-1:       NOTRUN -> [SKIP][211] ([i915#9906])
   [211]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@kms_vrr@seamless-rr-switch-drrs.html

  * igt@prime_vgem@basic-write:
    - shard-rkl:          NOTRUN -> [SKIP][212] ([i915#3291] / [i915#3708])
   [212]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@prime_vgem@basic-write.html
    - shard-dg1:          NOTRUN -> [SKIP][213] ([i915#3708])
   [213]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@prime_vgem@basic-write.html

  * igt@prime_vgem@coherency-gtt:
    - shard-rkl:          NOTRUN -> [SKIP][214] ([i915#3708])
   [214]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@prime_vgem@coherency-gtt.html

  * igt@sriov_basic@enable-vfs-bind-unbind-each:
    - shard-rkl:          NOTRUN -> [SKIP][215] ([i915#9917])
   [215]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@sriov_basic@enable-vfs-bind-unbind-each.html

  * igt@sriov_basic@enable-vfs-bind-unbind-each@numvfs-2:
    - shard-tglu-1:       NOTRUN -> [FAIL][216] ([i915#12910]) +8 other tests fail
   [216]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-1/igt@sriov_basic@enable-vfs-bind-unbind-each@numvfs-2.html
...
#### Possible fixes ####
  ...
  * igt@gem_workarounds@suspend-resume:
   ...
   [217]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@gem_workarounds@suspend-resume.html
   [218]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_workarounds@suspend-resume.html

  * igt@i915_module_load@load:
    - shard-mtlp:         ([PASS][219], [PASS][220], [PASS][221], [PASS][222], [PASS][223], [PASS][224], [PASS][225], [PASS][226], [PASS][227], [PASS][228], [PASS][229], [PASS][230], [PASS][231], [PASS][232], [PASS][233], [PASS][234], [SKIP][235], [PASS][236], [PASS][237], [PASS][238], [PASS][239], [PASS][240], [PASS][241], [PASS][242]) ([i915#14785]) -> ([PASS][243], [PASS][244], [PASS][245], [PASS][246], [PASS][247], [PASS][248], [PASS][249], [PASS][250], [PASS][251], [PASS][252], [PASS][253], [PASS][254], [PASS][255], [PASS][256], [PASS][257], [PASS][258], [PASS][259], [PASS][260], [PASS][261], [PASS][262], [PASS][263], [PASS][264], [PASS][265], [PASS][266], [PASS][267])
   ...
   [221]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-3/igt@i915_module_load@load.html
   ...
   [226]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-2/igt@i915_module_load@load.html
   [227]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-4/igt@i915_module_load@load.html
   [228]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-5/igt@i915_module_load@load.html
   [229]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-5/igt@i915_module_load@load.html
   [230]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-5/igt@i915_module_load@load.html
   ...
   [233]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-6/igt@i915_module_load@load.html
   [234]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-6/igt@i915_module_load@load.html
   [235]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-7/igt@i915_module_load@load.html
   [236]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-7/igt@i915_module_load@load.html
   [237]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-3/igt@i915_module_load@load.html
   [238]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-7/igt@i915_module_load@load.html
   ...
   [241]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-8/igt@i915_module_load@load.html
   [242]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-mtlp-8/igt@i915_module_load@load.html
   [243]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-6/igt@i915_module_load@load.html
   [244]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-3/igt@i915_module_load@load.html
   [245]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-8/igt@i915_module_load@load.html
   [246]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-5/igt@i915_module_load@load.html
   [247]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-3/igt@i915_module_load@load.html
   [248]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-6/igt@i915_module_load@load.html
   [249]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-2/igt@i915_module_load@load.html
   [250]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-8/igt@i915_module_load@load.html
   [251]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-4/igt@i915_module_load@load.html
   [252]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-3/igt@i915_module_load@load.html
   [253]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-6/igt@i915_module_load@load.html
   [254]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-7/igt@i915_module_load@load.html
   [255]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-8/igt@i915_module_load@load.html
   [256]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-5/igt@i915_module_load@load.html
   [257]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-6/igt@i915_module_load@load.html
   [258]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-2/igt@i915_module_load@load.html
   [259]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-8/igt@i915_module_load@load.html
   [260]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-7/igt@i915_module_load@load.html
   [261]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-7/igt@i915_module_load@load.html
   [262]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-4/igt@i915_module_load@load.html
   [263]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-4/igt@i915_module_load@load.html
   [264]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-3/igt@i915_module_load@load.html
   [265]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-2/igt@i915_module_load@load.html
   [266]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-5/igt@i915_module_load@load.html
   [267]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-mtlp-7/igt@i915_module_load@load.html

  * igt@i915_suspend@sysfs-reader:
    - shard-rkl:          [INCOMPLETE][268] ([i915#4817]) -> [PASS][269]
   [268]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-4/igt@i915_suspend@sysfs-reader.html
   [269]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@i915_suspend@sysfs-reader.html

  * igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1:
    - shard-snb:          [TIMEOUT][270] ([i915#14033]) -> [PASS][271] +1 other test pass
   [270]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-snb4/igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1.html
   [271]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-snb7/igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1.html

  * igt@kms_flip@flip-vs-expired-vblank:
    - shard-dg1:          [FAIL][272] ([i915#13027]) -> [PASS][273]
   [272]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg1-12/igt@kms_flip@flip-vs-expired-vblank.html
   [273]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-19/igt@kms_flip@flip-vs-expired-vblank.html

  * igt@kms_frontbuffer_tracking@fbc-suspend:
    - shard-rkl:          [INCOMPLETE][274] ([i915#10056]) -> [PASS][275]
   [274]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-suspend.html
   [275]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_frontbuffer_tracking@fbc-suspend.html

  * igt@kms_hdr@static-swap:
    - shard-rkl:          [SKIP][276] ([i915#3555] / [i915#8228]) -> [PASS][277]
   [276]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_hdr@static-swap.html
   [277]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_hdr@static-swap.html

  * igt@kms_pipe_crc_basic@suspend-read-crc:
    - shard-rkl:          [INCOMPLETE][278] ([i915#12756] / [i915#13476]) -> [PASS][279]
   [278]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_pipe_crc_basic@suspend-read-crc.html
   [279]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_pipe_crc_basic@suspend-read-crc.html

  * igt@kms_pipe_crc_basic@suspend-read-crc@pipe-b-hdmi-a-1:
    - shard-snb:          [INCOMPLETE][280] -> [PASS][281]
   [280]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-snb4/igt@kms_pipe_crc_basic@suspend-read-crc@pipe-b-hdmi-a-1.html
   [281]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-snb7/igt@kms_pipe_crc_basic@suspend-read-crc@pipe-b-hdmi-a-1.html

  * igt@kms_pm_rpm@dpms-lpsp:
    - shard-dg2:          [SKIP][282] ([i915#15073]) -> [PASS][283]
   [282]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-8/igt@kms_pm_rpm@dpms-lpsp.html
   [283]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-4/igt@kms_pm_rpm@dpms-lpsp.html

  * igt@kms_pm_rpm@dpms-mode-unset-non-lpsp:
    - shard-dg1:          [SKIP][284] ([i915#15073]) -> [PASS][285]
   [284]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg1-15/igt@kms_pm_rpm@dpms-mode-unset-non-lpsp.html
   [285]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-16/igt@kms_pm_rpm@dpms-mode-unset-non-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress:
    - shard-rkl:          [SKIP][286] ([i915#15073]) -> [PASS][287] +2 other tests pass
   [286]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-2/igt@kms_pm_rpm@modeset-non-lpsp-stress.html
   [287]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_pm_rpm@modeset-non-lpsp-stress.html

  * igt@kms_vblank@ts-continuation-suspend:
    - shard-rkl:          [INCOMPLETE][288] ([i915#12276]) -> [PASS][289]
   [288]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_vblank@ts-continuation-suspend.html
   [289]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-2/igt@kms_vblank@ts-continuation-suspend.html

  * igt@kms_vrr@negative-basic:
    - shard-dg2:          [SKIP][290] ([i915#3555] / [i915#9906]) -> [PASS][291]
   [290]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-4/igt@kms_vrr@negative-basic.html
   [291]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-11/igt@kms_vrr@negative-basic.html
...
#### Warnings ####
  ...
  * igt@gem_bad_reloc@negative-reloc-bltcopy:
   ...
   [292]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@gem_bad_reloc@negative-reloc-bltcopy.html
   [293]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_bad_reloc@negative-reloc-bltcopy.html

  * igt@gem_close_race@multigpu-basic-process:
    - shard-rkl:          [SKIP][294] ([i915#7697]) -> [SKIP][295] ([i915#14544] / [i915#7697])
   [294]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@gem_close_race@multigpu-basic-process.html
   [295]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_close_race@multigpu-basic-process.html

  * igt@gem_ctx_sseu@engines:
    - shard-rkl:          [SKIP][296] ([i915#14544] / [i915#280]) -> [SKIP][297] ([i915#280])
   [296]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@gem_ctx_sseu@engines.html
   [297]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_ctx_sseu@engines.html

  * igt@gem_ctx_sseu@mmap-args:
    - shard-rkl:          [SKIP][298] ([i915#280]) -> [SKIP][299] ([i915#14544] / [i915#280])
   [298]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@gem_ctx_sseu@mmap-args.html
   [299]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_ctx_sseu@mmap-args.html

  * igt@gem_exec_balancer@parallel-out-fence:
    - shard-rkl:          [SKIP][300] ([i915#14544] / [i915#4525]) -> [SKIP][301] ([i915#4525])
   [300]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@gem_exec_balancer@parallel-out-fence.html
   [301]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_exec_balancer@parallel-out-fence.html

  * igt@gem_exec_reloc@basic-wc-cpu:
    - shard-rkl:          [SKIP][302] ([i915#14544] / [i915#3281]) -> [SKIP][303] ([i915#3281]) +2 other tests skip
   [302]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@gem_exec_reloc@basic-wc-cpu.html
   [303]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gem_exec_reloc@basic-wc-cpu.html

  * igt@gem_exec_schedule@semaphore-power:
    - shard-rkl:          [SKIP][304] ([i915#7276]) -> [SKIP][305] ([i915#14544] / [i915#7276])
   [304]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@gem_exec_schedule@semaphore-power.html
   [305]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_exec_schedule@semaphore-power.html

  * igt@gem_exec_suspend@basic-s3:
    - shard-rkl:          [ABORT][306] ([i915#15131]) -> [INCOMPLETE][307] ([i915#13356]) +1 other test incomplete
   [306]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-1/igt@gem_exec_suspend@basic-s3.html
   [307]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-3/igt@gem_exec_suspend@basic-s3.html

  * igt@gem_lmem_swapping@heavy-verify-multi:
    - shard-rkl:          [SKIP][308] ([i915#14544] / [i915#4613]) -> [SKIP][309] ([i915#4613])
   [308]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@gem_lmem_swapping@heavy-verify-multi.html
   [309]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@gem_lmem_swapping@heavy-verify-multi.html

  * igt@gem_lmem_swapping@parallel-random-verify-ccs:
    - shard-rkl:          [SKIP][310] ([i915#4613]) -> [SKIP][311] ([i915#14544] / [i915#4613]) +2 other tests skip
   [310]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@gem_lmem_swapping@parallel-random-verify-ccs.html
   [311]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_lmem_swapping@parallel-random-verify-ccs.html

  * igt@gem_partial_pwrite_pread@reads:
    - shard-rkl:          [SKIP][312] ([i915#3282]) -> [SKIP][313] ([i915#14544] / [i915#3282]) +5 other tests skip
   [312]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@gem_partial_pwrite_pread@reads.html
   [313]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_partial_pwrite_pread@reads.html

  * igt@gem_pxp@hw-rejects-pxp-buffer:
    - shard-rkl:          [SKIP][314] ([i915#13717] / [i915#14544]) -> [SKIP][315] ([i915#13717])
   [314]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@gem_pxp@hw-rejects-pxp-buffer.html
   [315]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@gem_pxp@hw-rejects-pxp-buffer.html

  * igt@gem_set_tiling_vs_blt@tiled-to-tiled:
    - shard-rkl:          [SKIP][316] ([i915#8411]) -> [SKIP][317] ([i915#14544] / [i915#8411])
   [316]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@gem_set_tiling_vs_blt@tiled-to-tiled.html
   [317]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gem_set_tiling_vs_blt@tiled-to-tiled.html

  * igt@gen7_exec_parse@basic-rejected:
    - shard-rkl:          [SKIP][318] ([i915#14544]) -> [SKIP][319] +1 other test skip
   [318]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@gen7_exec_parse@basic-rejected.html
   [319]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@gen7_exec_parse@basic-rejected.html

  * igt@gen9_exec_parse@bb-chained:
    - shard-rkl:          [SKIP][320] ([i915#2527]) -> [SKIP][321] ([i915#14544] / [i915#2527]) +2 other tests skip
   [320]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@gen9_exec_parse@bb-chained.html
   [321]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@gen9_exec_parse@bb-chained.html

  * igt@i915_pm_freq_api@freq-suspend:
    - shard-rkl:          [SKIP][322] ([i915#14544] / [i915#8399]) -> [SKIP][323] ([i915#8399])
   [322]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@i915_pm_freq_api@freq-suspend.html
   [323]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@i915_pm_freq_api@freq-suspend.html

  * igt@i915_pm_rc6_residency@rc6-idle:
    - shard-rkl:          [SKIP][324] ([i915#14498]) -> [SKIP][325] ([i915#14498] / [i915#14544])
   [324]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@i915_pm_rc6_residency@rc6-idle.html
   [325]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@i915_pm_rc6_residency@rc6-idle.html

  * igt@i915_suspend@forcewake:
    - shard-rkl:          [INCOMPLETE][326] ([i915#4817]) -> [ABORT][327] ([i915#15140])
   [326]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@i915_suspend@forcewake.html
   [327]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-1/igt@i915_suspend@forcewake.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels:
    - shard-rkl:          [SKIP][328] ([i915#1769] / [i915#3555]) -> [SKIP][329] ([i915#14544] / [i915#1769] / [i915#3555])
   [328]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html
   [329]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html

  * igt@kms_big_fb@4-tiled-64bpp-rotate-270:
    - shard-rkl:          [SKIP][330] ([i915#5286]) -> [SKIP][331] ([i915#14544] / [i915#5286]) +2 other tests skip
   [330]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_big_fb@4-tiled-64bpp-rotate-270.html
   [331]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_big_fb@4-tiled-64bpp-rotate-270.html

  * igt@kms_big_fb@4-tiled-8bpp-rotate-90:
    - shard-rkl:          [SKIP][332] ([i915#14544] / [i915#5286]) -> [SKIP][333] ([i915#5286]) +1 other test skip
   [332]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_big_fb@4-tiled-8bpp-rotate-90.html
   [333]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_big_fb@4-tiled-8bpp-rotate-90.html

  * igt@kms_big_fb@x-tiled-16bpp-rotate-270:
    - shard-rkl:          [SKIP][334] ([i915#3638]) -> [SKIP][335] ([i915#14544] / [i915#3638])
   [334]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_big_fb@x-tiled-16bpp-rotate-270.html
   [335]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_big_fb@x-tiled-16bpp-rotate-270.html

  * igt@kms_ccs@bad-pixel-format-4-tiled-mtl-rc-ccs-cc:
    - shard-rkl:          [SKIP][336] ([i915#14098] / [i915#14544] / [i915#6095]) -> [SKIP][337] ([i915#14098] / [i915#6095]) +7 other tests skip
   [336]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_ccs@bad-pixel-format-4-tiled-mtl-rc-ccs-cc.html
   [337]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_ccs@bad-pixel-format-4-tiled-mtl-rc-ccs-cc.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-lnl-ccs:
    - shard-rkl:          [SKIP][338] ([i915#12313]) -> [SKIP][339] ([i915#12313] / [i915#14544]) +1 other test skip
   [338]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_ccs@crc-primary-rotation-180-4-tiled-lnl-ccs.html
   [339]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_ccs@crc-primary-rotation-180-4-tiled-lnl-ccs.html

  * igt@kms_ccs@missing-ccs-buffer-y-tiled-ccs:
    - shard-rkl:          [SKIP][340] ([i915#14098] / [i915#6095]) -> [SKIP][341] ([i915#14098] / [i915#14544] / [i915#6095]) +9 other tests skip
   [340]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_ccs@missing-ccs-buffer-y-tiled-ccs.html
   [341]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_ccs@missing-ccs-buffer-y-tiled-ccs.html

  * igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2:
    - shard-rkl:          [SKIP][342] ([i915#6095]) -> [SKIP][343] ([i915#14544] / [i915#6095]) +8 other tests skip
   [342]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2.html
   [343]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2.html

  * igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          [SKIP][344] ([i915#14544] / [i915#6095]) -> [SKIP][345] ([i915#6095]) +5 other tests skip
   [344]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html
   [345]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_cdclk@plane-scaling:
    - shard-rkl:          [SKIP][346] ([i915#14544] / [i915#3742]) -> [SKIP][347] ([i915#3742])
   [346]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_cdclk@plane-scaling.html
   [347]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_cdclk@plane-scaling.html

  * igt@kms_chamelium_edid@dp-mode-timings:
    - shard-rkl:          [SKIP][348] ([i915#11151] / [i915#14544] / [i915#7828]) -> [SKIP][349] ([i915#11151] / [i915#7828]) +1 other test skip
   [348]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_chamelium_edid@dp-mode-timings.html
   [349]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_chamelium_edid@dp-mode-timings.html

  * igt@kms_chamelium_hpd@dp-hpd:
    - shard-rkl:          [SKIP][350] ([i915#11151] / [i915#7828]) -> [SKIP][351] ([i915#11151] / [i915#14544] / [i915#7828]) +2 other tests skip
   [350]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_chamelium_hpd@dp-hpd.html
   [351]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_chamelium_hpd@dp-hpd.html

  * igt@kms_chamelium_hpd@hdmi-hpd-storm:
    - shard-dg1:          [SKIP][352] ([i915#11151] / [i915#7828]) -> [SKIP][353] ([i915#11151] / [i915#4423] / [i915#7828])
   [352]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg1-16/igt@kms_chamelium_hpd@hdmi-hpd-storm.html
   [353]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-13/igt@kms_chamelium_hpd@hdmi-hpd-storm.html

  * igt@kms_color_pipeline@plane-lut3d-green-only@pipe-c-hdmi-a-2:
    - shard-rkl:          [SKIP][354] ([i915#15523]) -> [SKIP][355] ([i915#14544] / [i915#15523]) +2 other tests skip
   [354]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_color_pipeline@plane-lut3d-green-only@pipe-c-hdmi-a-2.html
   [355]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_color_pipeline@plane-lut3d-green-only@pipe-c-hdmi-a-2.html

  * igt@kms_content_protection@dp-mst-type-0-hdcp14:
    - shard-rkl:          [SKIP][356] ([i915#15330]) -> [SKIP][357] ([i915#14544] / [i915#15330])
   [356]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_content_protection@dp-mst-type-0-hdcp14.html
   [357]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_content_protection@dp-mst-type-0-hdcp14.html

  * igt@kms_content_protection@lic-type-0:
    - shard-dg2:          [FAIL][358] ([i915#7173]) -> [SKIP][359] ([i915#6944] / [i915#9424])
   [358]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-11/igt@kms_content_protection@lic-type-0.html
   [359]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-7/igt@kms_content_protection@lic-type-0.html

  * igt@kms_cursor_crc@cursor-onscreen-32x32:
    - shard-rkl:          [SKIP][360] ([i915#3555]) -> [SKIP][361] ([i915#14544] / [i915#3555]) +1 other test skip
   [360]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_cursor_crc@cursor-onscreen-32x32.html
   [361]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_cursor_crc@cursor-onscreen-32x32.html

  * igt@kms_cursor_legacy@2x-flip-vs-cursor-legacy:
    - shard-rkl:          [SKIP][362] -> [SKIP][363] ([i915#14544]) +8 other tests skip
   [362]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_cursor_legacy@2x-flip-vs-cursor-legacy.html
   [363]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_cursor_legacy@2x-flip-vs-cursor-legacy.html

  * igt@kms_display_modes@extended-mode-basic:
    - shard-rkl:          [SKIP][364] ([i915#13691]) -> [SKIP][365] ([i915#13691] / [i915#14544])
   [364]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_display_modes@extended-mode-basic.html
   [365]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_display_modes@extended-mode-basic.html

  * igt@kms_dsc@dsc-with-bpc-formats:
    - shard-rkl:          [SKIP][366] ([i915#14544] / [i915#3555] / [i915#3840]) -> [SKIP][367] ([i915#3555] / [i915#3840])
   [366]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_dsc@dsc-with-bpc-formats.html
   [367]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_dsc@dsc-with-bpc-formats.html

  * igt@kms_dsc@dsc-with-output-formats-with-bpc:
    - shard-rkl:          [SKIP][368] ([i915#3840] / [i915#9053]) -> [SKIP][369] ([i915#14544] / [i915#3840] / [i915#9053])
   [368]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-2/igt@kms_dsc@dsc-with-output-formats-with-bpc.html
   [369]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_dsc@dsc-with-output-formats-with-bpc.html

  * igt@kms_flip@2x-blocking-wf_vblank:
    - shard-rkl:          [SKIP][370] ([i915#14544] / [i915#9934]) -> [SKIP][371] ([i915#9934])
   [370]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_flip@2x-blocking-wf_vblank.html
   [371]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_flip@2x-blocking-wf_vblank.html

  * igt@kms_flip@2x-flip-vs-dpms:
    - shard-rkl:          [SKIP][372] ([i915#9934]) -> [SKIP][373] ([i915#14544] / [i915#9934]) +1 other test skip
   [372]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_flip@2x-flip-vs-dpms.html
   [373]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_flip@2x-flip-vs-dpms.html

  * igt@kms_flip@2x-flip-vs-fences:
    - shard-dg1:          [SKIP][374] ([i915#8381]) -> [SKIP][375] ([i915#4423] / [i915#8381])
   [374]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg1-17/igt@kms_flip@2x-flip-vs-fences.html
   [375]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg1-12/igt@kms_flip@2x-flip-vs-fences.html

  * igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-upscaling:
    - shard-rkl:          [SKIP][376] ([i915#2672] / [i915#3555]) -> [SKIP][377] ([i915#14544] / [i915#2672] / [i915#3555])
   [376]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-upscaling.html
   [377]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-upscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-upscaling@pipe-a-valid-mode:
    - shard-rkl:          [SKIP][378] ([i915#2672]) -> [SKIP][379] ([i915#14544] / [i915#2672])
   [378]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-upscaling@pipe-a-valid-mode.html
   [379]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-upscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling:
    - shard-rkl:          [SKIP][380] ([i915#14544] / [i915#2672] / [i915#3555]) -> [SKIP][381] ([i915#2672] / [i915#3555])
   [380]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling.html
   [381]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling@pipe-a-valid-mode:
    - shard-rkl:          [SKIP][382] ([i915#14544] / [i915#2672]) -> [SKIP][383] ([i915#2672])
   [382]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling@pipe-a-valid-mode.html
   [383]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-64bpp-yftile-upscaling@pipe-a-valid-mode.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-indfb-draw-mmap-cpu:
    - shard-rkl:          [SKIP][384] ([i915#14544] / [i915#15102]) -> [SKIP][385] ([i915#15102])
   [384]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-indfb-draw-mmap-cpu.html
   [385]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-indfb-draw-mmap-cpu.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-pri-indfb-draw-blt:
    - shard-dg2:          [SKIP][386] ([i915#15102] / [i915#3458]) -> [SKIP][387] ([i915#10433] / [i915#15102] / [i915#3458]) +2 other tests skip
   [386]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-8/igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-pri-indfb-draw-blt.html
   [387]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-4/igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-pri-indfb-draw-blt.html
    - shard-rkl:          [SKIP][388] ([i915#15102] / [i915#3023]) -> [SKIP][389] ([i915#14544] / [i915#15102] / [i915#3023]) +6 other tests skip
   [388]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-pri-indfb-draw-blt.html
   [389]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-pri-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-tiling-4:
    - shard-rkl:          [SKIP][390] ([i915#14544] / [i915#5439]) -> [SKIP][391] ([i915#5439])
   [390]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-tiling-4.html
   [391]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_frontbuffer_tracking@fbcpsr-tiling-4.html

  * igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-blt:
    - shard-rkl:          [SKIP][392] ([i915#15102]) -> [SKIP][393] ([i915#14544] / [i915#15102]) +1 other test skip
   [392]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-blt.html
   [393]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-move:
    - shard-rkl:          [SKIP][394] ([i915#14544] / [i915#15102] / [i915#3023]) -> [SKIP][395] ([i915#15102] / [i915#3023]) +1 other test skip
   [394]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-move.html
   [395]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-move.html

  * igt@kms_frontbuffer_tracking@psr-2p-primscrn-pri-shrfb-draw-pwrite:
    - shard-rkl:          [SKIP][396] ([i915#14544] / [i915#1825]) -> [SKIP][397] ([i915#1825]) +5 other tests skip
   [396]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-2p-primscrn-pri-shrfb-draw-pwrite.html
   [397]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_frontbuffer_tracking@psr-2p-primscrn-pri-shrfb-draw-pwrite.html

  * igt@kms_frontbuffer_tracking@psr-2p-scndscrn-shrfb-plflip-blt:
    - shard-rkl:          [SKIP][398] ([i915#1825]) -> [SKIP][399] ([i915#14544] / [i915#1825]) +13 other tests skip
   [398]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_frontbuffer_tracking@psr-2p-scndscrn-shrfb-plflip-blt.html
   [399]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-2p-scndscrn-shrfb-plflip-blt.html

  * igt@kms_frontbuffer_tracking@psr-rgb565-draw-mmap-cpu:
    - shard-dg2:          [SKIP][400] ([i915#10433] / [i915#15102] / [i915#3458]) -> [SKIP][401] ([i915#15102] / [i915#3458]) +2 other tests skip
   [400]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-dg2-4/igt@kms_frontbuffer_tracking@psr-rgb565-draw-mmap-cpu.html
   [401]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-dg2-7/igt@kms_frontbuffer_tracking@psr-rgb565-draw-mmap-cpu.html

  * igt@kms_hdr@brightness-with-hdr:
    - shard-rkl:          [SKIP][402] ([i915#1187] / [i915#12713]) -> [SKIP][403] ([i915#13331] / [i915#14544])
   [402]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_hdr@brightness-with-hdr.html
   [403]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_hdr@brightness-with-hdr.html

  * igt@kms_joiner@invalid-modeset-ultra-joiner:
    - shard-rkl:          [SKIP][404] ([i915#15458]) -> [SKIP][405] ([i915#14544] / [i915#15458])
   [404]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_joiner@invalid-modeset-ultra-joiner.html
   [405]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_joiner@invalid-modeset-ultra-joiner.html

  * igt@kms_panel_fitting@atomic-fastset:
    - shard-rkl:          [SKIP][406] ([i915#6301]) -> [SKIP][407] ([i915#14544] / [i915#6301])
   [406]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_panel_fitting@atomic-fastset.html
   [407]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_panel_fitting@atomic-fastset.html

  * igt@kms_panel_fitting@legacy:
    - shard-rkl:          [SKIP][408] ([i915#14544] / [i915#6301]) -> [SKIP][409] ([i915#6301])
   [408]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_panel_fitting@legacy.html
   [409]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_panel_fitting@legacy.html

  * igt@kms_pm_backlight@basic-brightness:
    - shard-rkl:          [SKIP][410] ([i915#14544] / [i915#5354]) -> [SKIP][411] ([i915#5354])
   [410]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_pm_backlight@basic-brightness.html
   [411]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-8/igt@kms_pm_backlight@basic-brightness.html

  * igt@kms_pm_backlight@fade:
    - shard-rkl:          [SKIP][412] ([i915#5354]) -> [SKIP][413] ([i915#14544] / [i915#5354])
   [412]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_pm_backlight@fade.html
   [413]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_pm_backlight@fade.html

  * igt@kms_pm_dc@dc5-retention-flops:
    - shard-rkl:          [SKIP][414] ([i915#14544] / [i915#3828]) -> [SKIP][415] ([i915#3828])
   [414]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_pm_dc@dc5-retention-flops.html
   [415]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_pm_dc@dc5-retention-flops.html

  * igt@kms_pm_dc@dc6-dpms:
    - shard-tglu:         [SKIP][416] ([i915#15128]) -> [FAIL][417] ([i915#9295])
   [416]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-tglu-6/igt@kms_pm_dc@dc6-dpms.html
   [417]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-tglu-5/igt@kms_pm_dc@dc6-dpms.html

  * igt@kms_pm_dc@dc9-dpms:
    - shard-rkl:          [SKIP][418] ([i915#14544] / [i915#4281]) -> [SKIP][419] ([i915#4281])
   [418]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_pm_dc@dc9-dpms.html
   [419]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_pm_dc@dc9-dpms.html

  * igt@kms_pm_rpm@dpms-lpsp:
    - shard-rkl:          [SKIP][420] ([i915#15073]) -> [SKIP][421] ([i915#14544] / [i915#15073])
   [420]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_pm_rpm@dpms-lpsp.html
   [421]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_pm_rpm@dpms-lpsp.html

  * igt@kms_psr2_sf@fbc-pr-overlay-primary-update-sf-dmg-area:
    - shard-rkl:          [SKIP][422] ([i915#11520]) -> [SKIP][423] ([i915#11520] / [i915#14544]) +4 other tests skip
   [422]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_psr2_sf@fbc-pr-overlay-primary-update-sf-dmg-area.html
   [423]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_psr2_sf@fbc-pr-overlay-primary-update-sf-dmg-area.html

  * igt@kms_psr2_sf@fbc-psr2-cursor-plane-update-sf:
    - shard-rkl:          [SKIP][424] ([i915#11520] / [i915#14544]) -> [SKIP][425] ([i915#11520]) +1 other test skip
   [424]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_psr2_sf@fbc-psr2-cursor-plane-update-sf.html
   [425]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_psr2_sf@fbc-psr2-cursor-plane-update-sf.html

  * igt@kms_psr2_su@frontbuffer-xrgb8888:
    - shard-rkl:          [SKIP][426] ([i915#14544] / [i915#9683]) -> [SKIP][427] ([i915#9683])
   [426]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_psr2_su@frontbuffer-xrgb8888.html
   [427]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_psr2_su@frontbuffer-xrgb8888.html

  * igt@kms_psr@fbc-pr-suspend:
    - shard-rkl:          [SKIP][428] ([i915#1072] / [i915#9732]) -> [SKIP][429] ([i915#1072] / [i915#14544] / [i915#9732]) +7 other tests skip
   [428]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_psr@fbc-pr-suspend.html
   [429]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_psr@fbc-pr-suspend.html

  * igt@kms_psr@psr-sprite-plane-onoff:
    - shard-rkl:          [SKIP][430] ([i915#1072] / [i915#14544] / [i915#9732]) -> [SKIP][431] ([i915#1072] / [i915#9732]) +1 other test skip
   [430]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_psr@psr-sprite-plane-onoff.html
   [431]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-7/igt@kms_psr@psr-sprite-plane-onoff.html

  * igt@kms_psr_stress_test@flip-primary-invalidate-overlay:
    - shard-rkl:          [SKIP][432] ([i915#9685]) -> [SKIP][433] ([i915#14544] / [i915#9685])
   [432]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-7/igt@kms_psr_stress_test@flip-primary-invalidate-overlay.html
   [433]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_psr_stress_test@flip-primary-invalidate-overlay.html

  * igt@kms_rotation_crc@primary-yf-tiled-reflect-x-0:
    - shard-rkl:          [SKIP][434] ([i915#14544] / [i915#5289]) -> [SKIP][435] ([i915#5289])
   [434]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-0.html
   [435]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-0.html

  * igt@kms_setmode@invalid-clone-single-crtc:
    - shard-rkl:          [SKIP][436] ([i915#14544] / [i915#3555]) -> [SKIP][437] ([i915#3555])
   [436]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_setmode@invalid-clone-single-crtc.html
   [437]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-4/igt@kms_setmode@invalid-clone-single-crtc.html

  * igt@kms_vrr@flip-basic:
    - shard-rkl:          [SKIP][438] ([i915#15243] / [i915#3555]) -> [SKIP][439] ([i915#14544] / [i915#15243] / [i915#3555])
   [438]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@kms_vrr@flip-basic.html
   [439]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@kms_vrr@flip-basic.html

  * igt@kms_vrr@negative-basic:
    - shard-rkl:          [SKIP][440] ([i915#14544] / [i915#3555] / [i915#9906]) -> [SKIP][441] ([i915#3555] / [i915#9906])
   [440]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-6/igt@kms_vrr@negative-basic.html
   [441]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-5/igt@kms_vrr@negative-basic.html

  * igt@perf_pmu@rc6-all-gts:
    - shard-rkl:          [SKIP][442] ([i915#8516]) -> [SKIP][443] ([i915#14544] / [i915#8516])
   [442]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@perf_pmu@rc6-all-gts.html
   [443]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@perf_pmu@rc6-all-gts.html

  * igt@prime_vgem@fence-read-hang:
    - shard-rkl:          [SKIP][444] ([i915#3708]) -> [SKIP][445] ([i915#14544] / [i915#3708])
   [444]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17792/shard-rkl-3/igt@prime_vgem@fence-read-hang.html
   [445]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/shard-rkl-6/igt@prime_vgem@fence-read-hang.html
...
<p>Serious unknown changes coming with Patchwork_159261v2_full absolutely n=
eed to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br=
 />
  introduced in Patchwork_159261v2_full, please notify your bug team (I915-=
...
v2/shard-dg2-3/igt@gem_exec_gttfill@engines@vecs0.html">DMESG-FAIL</a></li>
</ul>
</li>
</ul>
<h2>Known issues</h2>
...
<ul>
<li>shard-dg2:          <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip=
/CI_DRM_17792/shard-dg2-7/igt@gem_exec_gttfill@engines.html">PASS</a> -&gt;=
 <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v2/sha=
rd-dg2-3/igt@gem_exec_gttfill@engines.html">DMESG-FAIL</a> (<a href=3D"http=
s://gitlab.freedesktop.org/drm/i915/kernel/-/issues/15319">i915#15319</a>)<=
/li>
</ul>
</li>
<li>

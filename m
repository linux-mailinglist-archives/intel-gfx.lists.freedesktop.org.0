...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32A682E64AF
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Dec 2020 16:53:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F2A9D89AC2;
	Mon, 28 Dec 2020 15:52:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9397C899C7
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Dec 2020 15:52:53 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23448198-1500050 
 for multiple; Mon, 28 Dec 2020 15:52:35 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Dec 2020 15:51:55 +0000
Message-Id: <20201228155229.9516-20-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 20/54] drm/i915: Restructure priority inheritance
...
index 8391841d927d..d3d60fb8caf5 100644
...
-		INIT_LIST_HEAD(&dep->dfs_link);
 		...
 		dep->flags = flags;
@@ -504,7 +582,7 @@ void i915_request_show_with_schedule(struct drm_printer *m,

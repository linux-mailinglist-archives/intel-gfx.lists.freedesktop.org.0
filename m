...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 800C05A8FF1
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 09:20:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1129510E63C;
...
Subject: [Intel-gfx] [PATCH v2 15/15] vfio: Add struct device to vfio_device

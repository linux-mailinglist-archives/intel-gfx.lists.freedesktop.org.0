...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 67C632C852F
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Nov 2020 14:32:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34AD86E4A6;
	Mon, 30 Nov 2020 13:32:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A38186E4A6
 for <intel-gfx@lists.freedesktop.org>; Mon, 30 Nov 2020 13:32:53 +0000 (UTC)
IronPort-SDR: mWZLHEy7e6RzKcMtr8zdjS5ZNG1gKBF0w93uEYd/UVAGzoZm05X3+c25iVRQmzbvxenVkFaCzz
 mS1fF4bWzbTw==
X-IronPort-AV: E=McAfee;i="6000,8403,9820"; a="190815146"
X-IronPort-AV: E=Sophos;i="5.78,381,1599548400"; d="scan'208";a="190815146"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Nov 2020 05:32:52 -0800
IronPort-SDR: 4Rm4tm9U6g6CcjpuIf3BQKEVDe7MsIAcFZTQkhmG+Dm839JDDkLoNZfSbv55khQ3M8whv9TYcd
 AuBar/qgfV5A==
X-IronPort-AV: E=Sophos;i="5.78,381,1599548400"; d="scan'208";a="538596974"
Received: from ekiperwa-mobl.ger.corp.intel.com (HELO
 mwauld-desk1.ger.corp.intel.com) ([10.252.22.113])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Nov 2020 05:32:49 -0800
From: Matthew Auld <matthew.auld@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 30 Nov 2020 13:32:39 +0000
Message-Id: <20201130133239.51798-1-matthew.auld@intel.com>
X-Mailer: git-send-email 2.26.2
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2] drm/i915/lmem: Limit block size to 4G
...
index 0aeba8e3af28..f0819033951c 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E940A6E25
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Sep 2019 18:25:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A70E89561;
...
Subject: [Intel-gfx] [PATCH AUTOSEL 5.2 14/23] drm/i915: Make sure cdclk is
 high enough for DP audio on VLV/CHV

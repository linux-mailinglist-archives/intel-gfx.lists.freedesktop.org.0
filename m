...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AC3F84A9EEA
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Feb 2022 19:25:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF78410E130;
	Fri,  4 Feb 2022 18:25:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0B59110E130
 for <intel-gfx@lists.freedesktop.org>; Fri,  4 Feb 2022 18:25:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643999124; x=1675535124;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=SFVwZ+vyx2QKFx39K0PmBbrDWb4vyjz5qevqV08l7tE=;
 b=HxqlV5F/+7U+DI7nwUTuhfC+O2D4Mi4t/9/bsjE/vb420SDldjKsrUSD
 BCyX2OnxRWQgUXYSQGST+55FFma4L2vOkj25yJZ1Ev/7huinL1dK235B1
 SZ0080rcC90MtGWOuiz9zf8QThoqs2Y1lcd5n9qLQg4nL8IiyI27VqNHZ
 HPmh5un5O9Hd071n/S6vgIutoDmdvcRtX1w0+JHCXpYI1R6aMjofkdL5+
 sJiqQP5CsIgLqwiYNvvZxfz3a6/fRlkEMa1tE+hjrR4+GjWaxy2G7Ndaa
 eQL9BnvnM9JBwXYgGqKoptfr6woNz+Z6mX/tPY1w6B3jSfZVkSoYMF2ZG g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10248"; a="272920857"
X-IronPort-AV: E=Sophos;i="5.88,343,1635231600"; d="scan'208";a="272920857"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2022 10:25:23 -0800
X-IronPort-AV: E=Sophos;i="5.88,343,1635231600"; d="scan'208";a="699756653"
Received: from jons-linux-dev-box.fm.intel.com (HELO jons-linux-dev-box)
 ([10.1.27.20])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2022 10:25:23 -0800
Date: Fri, 4 Feb 2022 10:19:24 -0800
From: Matthew Brost <matthew.brost@intel.com>
To: Alan Previn <alan.previn.teres.alexis@intel.com>
Message-ID: <20220204181924.GA18242@jons-linux-dev-box>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B2FCF65203
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Jul 2019 08:52:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82BD489C2C;
	Thu, 11 Jul 2019 06:52:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0391E89DFA
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Jul 2019 06:52:26 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17214637-1500050 
 for multiple; Thu, 11 Jul 2019 07:52:18 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 11 Jul 2019 07:52:05 +0100
Message-Id: <20190711065215.4004-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/18] drm/i915/gt: Track timeline activeness in
 enter/exit
...
LmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9jb250ZXh0LmMKaW5kZXggYjFlMmU0
YjYwMDI3Li5iMGE2YmM4OWNlZjIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0
...
IGZhOTE4YzE5YTZhZi4uZjQzYWRjZjRmMGRiIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CE6B34D1B9
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Mar 2021 15:48:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4ACF76E429;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] i915: Fix uninitialized variable err

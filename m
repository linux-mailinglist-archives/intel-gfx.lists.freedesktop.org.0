...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0AECD43E1CA
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Oct 2021 15:14:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82A956E96C;
...
Subject: [Intel-gfx] [PATCH 05/11] drm/i915: Create a full object for
 mock_ring, v2.

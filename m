...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ECB102C658F
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0F5146EDAC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 157/162] drm/i915: Improve accuracy of
 eviction stats

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C51AA43C187
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Oct 2021 06:37:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38F1C6E511;
...
Subject: [Intel-gfx] [PATCH v9 00/10] use DYNAMIC_DEBUG to implement
 DRM.debug & DRM.trace

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 218CB6EB0AE
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 19:37:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42D5610EEAC;
	Fri, 21 Apr 2023 17:37:01 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 7/8] drm/i915/mtl: end support for set
 caching ioctl

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6EEDA79FB8
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Apr 2025 11:12:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67D4E10E978;
	Thu,  3 Apr 2025 09:12:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="FVx000OE";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 061A010E976;
 Thu,  3 Apr 2025 09:12:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1743671565; x=1775207565;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ib78om5YgPp2+l+HN2cyWclbs9FHzagvioILFgrd3do=;
 b=FVx000OEt1QY5fLV8JrAoQAFT1JCaeOqbGRNwamGmsqajei4+Rvl3NZh
 p8ahiUmtUmHJhM29iQjBM6wuO6iAJM9ErL9cO7ZMI3Iaj4QThEyrl+Zo3
 B6JGdDnXBx3CLOZSsBaa0enJIeTec4JJvfOYvb/KJR531R3TT5wTfQi7W
 QSXZsQdEfSJCAAyfk6U/WKmyh9JTnqG5yTXJF2eW3s7Gpex31qwrmRuik
 sQOApy5kY4xbYmKR+fG6ns7+5oDyWWcUHD8xD/KnN10rUBBAUL4yk0wZs
 TvVblVHiuVyRmvH2cQ6KJ70h+etH3CPtpDBZXQI8AtDwLYM+kJEEgYTXe g==;
X-CSE-ConnectionGUID: JE4+9whpTHu05pVUafiKnA==
X-CSE-MsgGUID: yIsspO1ETqSqN7hHsrbQ7A==
X-IronPort-AV: E=McAfee;i="6700,10204,11392"; a="45206910"
X-IronPort-AV: E=Sophos;i="6.15,184,1739865600"; d="scan'208";a="45206910"
Received: from fmviesa009.fm.intel.com ([10.60.135.149])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2025 02:12:18 -0700
X-CSE-ConnectionGUID: 91y+rW2DTp2UeKI1wENutA==
X-CSE-MsgGUID: YgbGa4lATki7V7DqIp5jew==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,184,1739865600"; d="scan'208";a="127806518"
Received: from mjarzebo-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.158])
 by fmviesa009-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2025 02:12:16 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 7/7] drm/i915/wm: convert i9xx_wm.c internally to struct
 intel_display
Date: Thu,  3 Apr 2025 12:11:39 +0300
Message-Id: <b4c85a4b9cfa23e82777205dcf2d9afbef9e7866.1743671373.git.jani.nikula@intel.com>

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id yApkKLLjD2rGRAYAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 07:03:46 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C8C55AEE21
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 07:03:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9618010F4AA;
	Fri, 22 May 2026 05:03:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="U0SAma0s";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 05E6B10F49C;
 Fri, 22 May 2026 05:03:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1779426224; x=1810962224;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=jupyWpMTvcrf1l0fBOVskyph+hrMfteQly8uob6k2i0=;
 b=U0SAma0s9jzlyVNPrd0funxwFy/656pd2aBUMwtjuvTAHCcUnzBMw9NR
 5tE1ijbNU1nIR2iq/GUyotBUHSGJjjN9y6eaUubAPYnsNiuk9VYVEV9Yg
 FJIAjPa/Aox7Wc32lhoYH8NqZVeUgDXV2+WL6Wyfn8okoR6YFhoS3ni3H
 cWJzo2OmDz8Zb+ris1BnxQo4fahOWrhAzlNHT6o5CBdC4XPvHLSmCM9eV
 0hcRpeRbrQzZAiMX90P1ijRV5maEJkkvis1yPfNxbjpuuAUowrKGlx4Pc
 6sep9/6aZn9yTOwKeGbKMbWBo5TBL/2S0v3yyLXVC0vEGaZwNZ/wofYEA Q==;
X-CSE-ConnectionGUID: rUWFshbHRDOKyUc1a/HM+g==
X-CSE-MsgGUID: kYsdqzErT9yWaiTvYTj5eg==
X-IronPort-AV: E=McAfee;i="6800,10657,11793"; a="90651700"
X-IronPort-AV: E=Sophos;i="6.24,161,1774335600"; d="scan'208";a="90651700"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 May 2026 22:03:43 -0700
X-CSE-ConnectionGUID: Ys4KQwImSgO3YupVNaIQXA==
X-CSE-MsgGUID: K/OTXY2hRzy/wi8M5Wb46Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.24,161,1774335600"; d="scan'208";a="239946246"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa010.jf.intel.com with ESMTP; 21 May 2026 22:03:35 -0700
...
Subject: [PATCH v5 1/7] drm: writeback: Refactor drm_writeback_connector
 structure
Date: Fri, 22 May 2026 10:33:07 +0530
Message-Id: <20260522050313.1800378-2-suraj.kandpal@intel.com>
...
X-Spamd-Result: default: False [1.69 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[encoder.base:url,bootlin.com:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,intel.com:email,intel.com:mid,intel.com:dkim,connector.base:url,arm.com:email]
X-Rspamd-Queue-Id: 3C8C55AEE21

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 00D5A21FF64
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D6BC6EA07;
...
Subject: [Intel-gfx] [PATCH v2 58/59] drm/kmb: Get System Clock from SCMI

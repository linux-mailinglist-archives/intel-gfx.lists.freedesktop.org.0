...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 440B069E49E
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Feb 2023 17:27:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B5C0210E881;
	Tue, 21 Feb 2023 16:27:42 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 3/4] drm/displayid: provide access to
 DisplayID version and primary use case

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B61C3F8124
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Aug 2021 05:30:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1CFB6E520;
...
Subject: [Intel-gfx] [PATCH 21/27] drm/i915/guc: Proper xarray usage for
 contexts_lookup

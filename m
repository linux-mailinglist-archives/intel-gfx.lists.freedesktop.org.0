...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 051E031BAE0
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Feb 2021 15:22:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64F1389D4B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v1 1/3] string: Consolidate yesno() helpers
 under string.h hood

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DB3737A999
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jul 2019 15:31:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDFFF6E512;
	Tue, 30 Jul 2019 13:31:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C87866E512
 for <intel-gfx@lists.freedesktop.org>; Tue, 30 Jul 2019 13:30:56 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17730642-1500050 
 for multiple; Tue, 30 Jul 2019 14:30:38 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 30 Jul 2019 14:30:25 +0100
Message-Id: <20190730133035.1977-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/17] drm/i915/gt: Provide a local
 intel_context.vm
...
aTkxNV9nZW1fZXhlY2J1ZmZlci5jCmluZGV4IDAxOTAxZGFkMzNmNy4uNGRiNDQ2MzA4OWNlIDEw
...
MTUvZ3QvaW50ZWxfbHJjLmMKaW5kZXggODZkZDFlZGRjZWFjLi41MTgxZDI5ZDI3MmUgMTAwNjQ0
...
MjkwOSw3ICsyOTA2LDcgQEAgc3RhdGljIHZvaWQgZXhlY2xpc3RzX2luaXRfcmVnX3N0YXRlKHUz

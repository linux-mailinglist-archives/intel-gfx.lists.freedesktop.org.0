...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D0A517BCC2
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 13:31:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E8D506ECF9;
	Fri,  6 Mar 2020 12:31:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B679C89C6B
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Mar 2020 12:30:59 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  6 Mar 2020 13:30:39 +0100
Message-Id: <20200306123046.2797797-10-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/17] drm/i915: Make sure execbuffer always
...
@@ -1102,7 +1102,7 @@ static int context_barrier_task(struct i915_gem_context *ctx,
...
@@ -1195,7 +1195,7 @@ static int pin_ppgtt_update(struct intel_context *ce, struct i915_gem_ww_ctx *ww
...
@@ -535,7 +535,7 @@ static inline int use_cpu_reloc(const struct reloc_cache *cache,
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	void *vaddr;
@@ -1057,10 +1058,13 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 		if (err)
 			return ERR_PTR(err);
...
@@ -1096,9 +1100,10 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	if (cache->page == page) {
@@ -1106,7 +1111,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 	} else {
 		vaddr = NULL;
...
@@ -1189,7 +1194,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 		goto err_unmap;
 	}
...
@@ -1343,7 +1348,7 @@ relocate_entry(struct i915_vma *vma,
 	}
...
@@ -1758,6 +1763,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2031,7 +2037,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2042,7 +2049,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2154,16 +2161,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2188,7 +2212,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2199,7 +2223,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2211,20 +2235,36 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2380,7 +2420,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -2821,33 +2861,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2920,9 +2934,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
-err_parse:
 ...
 err_vma:
@@ -3005,7 +3016,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3083,8 +3096,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index f304fab1b619..9baf967c16bd 100644
...
@@ -259,6 +269,23 @@ int __intel_context_do_pin(struct intel_context *ce)
 	return err;
 }
...
@@ -297,18 +324,14 @@ __i915_active_call
...
@@ -317,12 +340,6 @@ static int __intel_context_active(struct i915_active *active)
 	}
...
index 53ac3f00909a..dbfc9fa1d89a 100644
--- a/drivers/gpu/drm/i915/gt/intel_engine_cs.c
+++ b/drivers/gpu/drm/i915/gt/intel_engine_cs.c
@@ -545,7 +545,7 @@ static int pin_ggtt_status_page(struct intel_engine_cs *engine,
 	else
 		flags = PIN_HIGH;
...
index c85b901f0c44..e30cedcc3d3c 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3010,7 +3010,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3372,7 +3373,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index 23b0641688ed..7d06070681e5 100644
--- a/drivers/gpu/drm/i915/gt/intel_ring_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_ring_submission.c
@@ -1181,14 +1181,16 @@ static void ring_context_destroy(struct kref *ref)
...
@@ -1304,11 +1306,6 @@ static int ring_context_alloc(struct intel_context *ce)
 	return 0;
 }
...
-
 ...
 {
 	return 0;
@@ -2075,7 +2072,7 @@ int intel_ring_submission_setup(struct intel_engine_cs *engine)
 	}
...
@@ -2085,7 +2082,7 @@ int intel_ring_submission_setup(struct intel_engine_cs *engine)
...
index c081f4ec87df..ea4ee71f4c95 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1721,11 +1721,18 @@ static inline void i915_gem_drain_workqueue(struct drm_i915_private *i915)
 }
...
index db9aa56a7db0..532dab77c3f4 100644
--- a/drivers/gpu/drm/i915/i915_gem.c
+++ b/drivers/gpu/drm/i915/i915_gem.c
@@ -945,11 +945,10 @@ void i915_gem_runtime_suspend(struct drm_i915_private *i915)
 }
...
@@ -1017,7 +1016,7 @@ i915_gem_object_ggtt_pin(struct drm_i915_gem_object *obj,
 			return ERR_PTR(ret);
 	}
...
index 3dde671145f7..e15e9b6e8c8c 100644
--- a/drivers/gpu/drm/i915/i915_vma.c
+++ b/drivers/gpu/drm/i915/i915_vma.c
@@ -881,13 +881,19 @@ static void vma_unbind_pages(struct i915_vma *vma)
...
@@ -999,7 +1005,8 @@ static void flush_idle_contexts(struct intel_gt *gt)
...
+		  u32 align, unsigned int flags)
 {
 	...
 	int err;
@@ -1007,7 +1014,7 @@ int i915_ggtt_pin(struct i915_vma *vma, u32 align, unsigned int flags)

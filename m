...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EA4645552
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jun 2019 09:10:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 519398934F;
	Fri, 14 Jun 2019 07:10:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 20C0788F1E
 for <intel-gfx@lists.freedesktop.org>; Fri, 14 Jun 2019 07:10:41 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16897509-1500050 
 for multiple; Fri, 14 Jun 2019 08:10:27 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 14 Jun 2019 08:09:50 +0100
Message-Id: <20190614071023.17929-7-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/39] drm/i915: Stop retiring along engine
...
ZGV4IGFmNzU3YTk1ODU1My4uMTRhOWM1YTk2OWU5IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9k

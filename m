...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C33E12684CA
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Sep 2020 08:23:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA7E66E1A8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 6/8] drm/i915: WA for platforms with double
 buffered adress update enable bit

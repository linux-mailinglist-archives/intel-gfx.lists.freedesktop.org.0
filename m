...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 010EB170663
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Feb 2020 18:44:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6435A6EB4D;
	Wed, 26 Feb 2020 17:44:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B30216EB4D
 for <intel-gfx@lists.freedesktop.org>; Wed, 26 Feb 2020 17:44:45 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20360728-1500050 
 for multiple; Wed, 26 Feb 2020 17:44:32 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 26 Feb 2020 17:44:28 +0000
Message-Id: <20200226174430.1568897-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/3] drm/i915/gem: Consolidate ctx->engines[]
 release
...
index b24ee8e104cf..859274b4558c 100644
...
-	free_engines(rcu_access_pointer(ctx->engines));
 	...
 	if (ctx->timeline)
@@ -493,30 +493,104 @@ static void kill_engines(struct i915_gem_engines *engines)
...
@@ -540,11 +614,16 @@ static void context_close(struct i915_gem_context *ctx)
 {
...
+
 	...
 	if (vm)
 		i915_vm_close(vm);
@@ -1628,77 +1707,6 @@ static const i915_user_extension_fn set_engines__extensions[] = {
...
@@ -1741,8 +1749,6 @@ set_engines(struct i915_gem_context *ctx,
 	if (!set.engines)
 		return -ENOMEM;
...
@@ -1795,6 +1801,11 @@ set_engines(struct i915_gem_context *ctx,
...
@@ -1803,7 +1814,7 @@ set_engines(struct i915_gem_context *ctx,
 	mutex_unlock(&ctx->engines_mutex);
...
@@ -2079,8 +2090,6 @@ static int clone_engines(struct i915_gem_context *dst,
 	if (!clone)
 		goto err_unlock;
...
@@ -2123,8 +2132,7 @@ static int clone_engines(struct i915_gem_context *dst,
...
@@ -2555,6 +2563,9 @@ i915_gem_engines_iter_next(struct i915_gem_engines_iter *it)

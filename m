...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 905411BE25D
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 17:17:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F13546E11A;
	Wed, 29 Apr 2020 15:17:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6F3966E11A
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 15:17:20 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21059924-1500050 
 for multiple; Wed, 29 Apr 2020 16:17:06 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 16:17:04 +0100
Message-Id: <20200429151704.2561-1-chris@chris-wilson.co.uk>
...
index 7fc4081c34fe..7873c74a549f 100644
...
@@ -4200,7 +4197,7 @@ static void __execlists_reset(struct intel_engine_cs *engine, bool stalled)
 	 * to recreate its own state.
 	 */
 	GEM_BUG_ON(!intel_context_is_pinned(ce));
-	restore_default_state(ce, engine);
+	execlists_init_reg_state(ce->lrc_reg_state, ce, engine, ce->ring, true);

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 48492644E0B
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Dec 2022 22:37:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2086F10E155;
	Tue,  6 Dec 2022 21:37:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B391B10E076;
 Tue,  6 Dec 2022 21:37:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670362661; x=1701898661;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=k2ZGa7HKkFh8xwHSQttZrc3ZRNdtL4uy02CRWgDqe78=;
 b=F4X5eF1EjMUPn5InA9ClAgZ89sfGzrfi01tiQvKKH76scDX6T88kkOh5
 X1Tt7aKpVGL8mV9GdBrJJChb8QgLuVxynlmGKESmYjtDuYo7/l+dOMgD+
 p2Fy3N4rg/MeKUrpnfdmBm0psB9xv4J+aybIefDHQFbRnY1KuzLuFOGsQ
 Z4r0OatDTbsGKcENyyunlomE8EMDaIvP3+h4ZiaHp9AAuUicuZj4IpkFd
 Ap5ki7HWgkboyrA3YvGeT2+b14LOW7vgNtlh7QAszRHMT+QSK79+WySJJ
 eKJFF3M4p8yaFrBaxW3FhtpeMSfxhELxVXtGTOUQKrdJlrZnXgxsjTR5g A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10553"; a="296430273"
X-IronPort-AV: E=Sophos;i="5.96,223,1665471600"; d="scan'208";a="296430273"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Dec 2022 13:37:41 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10553"; a="714949615"
X-IronPort-AV: E=Sophos;i="5.96,223,1665471600"; d="scan'208";a="714949615"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga004.fm.intel.com with ESMTP; 06 Dec 2022 13:37:40 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Dec 2022 13:40:31 -0800
Message-Id: <20221206214031.345560-1-alan.previn.teres.alexis@intel.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v10 1/1] drm/i915/pxp: Promote pxp subsystem to
 top-level of i915
...
---
 ...
 drivers/gpu/drm/i915/pxp/intel_pxp.c          | 108 +++++++++++++-----
 ...
 23 files changed, 192 insertions(+), 114 deletions(-)
...
index 5efe61f67546..ce65fadebaa1 100644
...
+	return pxp && pxp->arb_is_valid;
 }
 
 /* KCR register definitions */
@@ -74,7 +82,7 @@ static void kcr_pxp_disable(struct intel_gt *gt)
...
+	struct intel_gt *gt = pxp->ctrl_gt;
 	...
 	int i;
@@ -109,7 +117,7 @@ static void destroy_vcs_context(struct intel_pxp *pxp)
...
+	struct intel_gt *gt = pxp->ctrl_gt;
 	...
 	/*
@@ -138,31 +146,79 @@ static void pxp_init_full(struct intel_pxp *pxp)
...
+		/*
+		 * There can be only one GT with a GSC-CS
+		 * which is needed to support PXP
+		 */
...
+
+	/*
+	 * Else we rely on mei-pxp module but that is only on
+	 * legacy platforms prior to having separate media GTs.
+	 */
...
+}
+
+static bool pxp_backend_tee_is_needed(struct intel_pxp *pxp)
+{
+	/* PXP's backend framework is needed for DG2's HuC authentication */
+	return intel_huc_is_loaded_by_gsc(&pxp->ctrl_gt->uc.huc) &&
...
@@ -173,7 +229,7 @@ void intel_pxp_mark_termination_in_progress(struct intel_pxp *pxp)
...
@@ -238,13 +294,13 @@ int intel_pxp_start(struct intel_pxp *pxp)
...
@@ -278,7 +334,7 @@ int intel_pxp_key_check(struct intel_pxp *pxp,

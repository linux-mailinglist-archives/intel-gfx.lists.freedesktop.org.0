...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DD95A110286
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 17:39:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B0FD6E9F3;
	Tue,  3 Dec 2019 16:39:17 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 02/12] video: fbdev: mb862xx: modify the

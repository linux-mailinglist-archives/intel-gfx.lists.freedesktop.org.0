...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F133066797D
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Jan 2023 16:38:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A99E410E187;
	Thu, 12 Jan 2023 15:38:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pj1-x102f.google.com (mail-pj1-x102f.google.com
 [IPv6:2607:f8b0:4864:20::102f])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F353510E186
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 Jan 2023 15:38:30 +0000 (UTC)
Received: by mail-pj1-x102f.google.com with SMTP id
 m7-20020a17090a730700b00225ebb9cd01so23952063pjk.3
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 Jan 2023 07:38:30 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=cc:to:subject:message-id:date:from:in-reply-to:references
 :mime-version:from:to:cc:subject:date:message-id:reply-to;
 bh=8l+ucVTom/lB5RFDq7k3iNEnfhgzw2dVvryJDjoq84w=;
 b=Bl9H8hBHSHqXhRBKAet0ZJNkp4rRjwkMnjo4blr1w2duJLNz0uUJjicp9mmAyc6wz/
 7WADWzo5x5RRwTGHzS8EavglPeXzQU3yIdkEBwilzmvj+x0tLkGNKE/kPJLAqqR1Vtsc
 C+16pQ1FwPojNaufH40WpgnOCuER/8rG736WU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :reply-to;
 bh=8l+ucVTom/lB5RFDq7k3iNEnfhgzw2dVvryJDjoq84w=;
 b=
X-Gm-Message-State: AFqh2kqff73m3ichiHUwAj8yMJLJPGhSoOCG9PbFCRH5yD+oHVlz/+qy
 OpT+aEF5o4GOOj5aZK4c9bHMTPX7c55N9+7whMPYsV0opi3TTw==
X-Google-Smtp-Source: AMrXdXsKh0P8B1kLDQbXOmuqOW14+9cIMCtkNnDPYPDhOFsEsNuK8Q8B2DMt0oF6FS4LvysI+aCiAf32eO4exTV7IUU=
X-Received: by 2002:a17:902:b902:b0:190:e27b:b554 with SMTP id
 bf2-20020a170902b90200b00190e27bb554mr5185844plb.148.1673537910277; Thu, 12
 Jan 2023 07:38:30 -0800 (PST)
MIME-Version: 1.0
References: <Y7cns9bpfIslkCPu@DUT025-TGLU.fm.intel.com>
 ...
 <20230112101053.393e0717@collabora.com> <Y7/Tolh8SGLtybs0@phenom.ffwll.local>
 <20230112111103.324abb3c@collabora.com>
 <20230112112553.324ffa05@collabora.com>
 <Y7/kMa1Jz+4+YIvv@phenom.ffwll.local> <20230112130818.220edc62@collabora.com>
In-Reply-To: <20230112130818.220edc62@collabora.com>
From: Daniel Vetter <daniel@ffwll.ch>
Date: Thu, 12 Jan 2023 16:38:18 +0100
Message-ID: <CAKMK7uGPFVjkugw-W+o6C514x8ZPJs3L1A_QCB69aF0WAfHZjw@mail.gmail.com>

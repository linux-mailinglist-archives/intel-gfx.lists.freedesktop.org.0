...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E724D288BC9
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Oct 2020 16:46:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49AEA6ED00;
	Fri,  9 Oct 2020 14:46:58 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] ALSA: hda/i915 - fix list corruption with
 concurrent probes
...
Cc: alsa-devel@alsa-project.org, airlied@linux.ie,
 ...
 jani.nikula@intel.com, mripard@kernel.org, tzimmermann@suse.de

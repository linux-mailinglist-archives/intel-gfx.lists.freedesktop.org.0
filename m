...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 070C2195204
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2020 08:29:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F5766E9AC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 10/14] drm/i915: Fix enabled infoframe states
 of lspcon

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E75E959FB19
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Aug 2022 15:19:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A273B5263;
	Wed, 24 Aug 2022 13:18:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3FD47B51B4
 for <intel-gfx@lists.freedesktop.org>; Wed, 24 Aug 2022 13:18:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661347084; x=1692883084;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=rysL9H2mYcDCz/8WQ/7vd1pFLUZPeVDozaQ6ZjieOKk=;
 b=igDES6ap1akSf8RyiJa2ws4qu6dxDBXY882zlesx5H51Qz8mb16fhXVL
 21GyVHLWvWnaXcw6HVtDkJd/tn5pjVuYATwkz4omb3mE1iMlYUMptB3fv
 XVEA7AUJYVvy8RtTp1hkaxBqLHV8co/lPgwRAuTrTipkFJgPg+gVuoBZL
 CBRw13RdFfGlGCa2JnHnWHacqhrbu6SN4Vb2I5XW75dv+wnoivgSSGC/1
 JKi5dy2T3DCM28cxeDFcSQd/SH1R3+6xW1W+7ArD+UP30b0a06hNrdv8n
 1SQ006Tqo2uXOD8+rH4wNOfwfkjpLQJmZ57ZCBuWx34GHKmrjRpCOhIjL Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10448"; a="380255190"
X-IronPort-AV: E=Sophos;i="5.93,260,1654585200"; d="scan'208";a="380255190"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2022 06:17:52 -0700
X-IronPort-AV: E=Sophos;i="5.93,260,1654585200"; d="scan'208";a="937905307"
Received: from zlim2-mobl.gar.corp.intel.com (HELO localhost) ([10.252.52.23])
 by fmsmga005-auth.fm.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Aug 2022 06:17:50 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 24 Aug 2022 16:15:49 +0300
Message-Id: <5e51a36c0e24565e96188a852de1ed55a51866ae.1661346845.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 23/38] drm/i915: move mipi_mmio_base to
 display.dsi
...
index cc54793ae9bf..63ff660b9479 100644
...
index 784ae52059d1..233d0a8902ec 100644
...
index 7496c1e22bf1..a6b2a1ae124c 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -298,9 +298,6 @@ struct drm_i915_private {

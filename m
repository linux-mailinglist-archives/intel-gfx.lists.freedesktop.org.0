...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D4936C131F
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Mar 2023 14:19:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E0F610E538;
...
Subject: Re: [Intel-gfx] [PATCH 1/7] drm: remove drm_dev_set_unique

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0AAACB8F6F
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Dec 2025 15:35:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B127910E835;
	Fri, 12 Dec 2025 14:35:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=lankhorst.se header.i=@lankhorst.se header.b="pUshf8L1";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (lankhorst.se [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 970A210E835;
 Fri, 12 Dec 2025 14:35:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1765550116;
 bh=2aCiPoFqv7jsKoKMUTTeKMoP2aYeHLiqbGHc/wFB9+A=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH v2 04/12] drm/i915/display: Make set_pipeconf use the fw
 variants
Date: Fri, 12 Dec 2025 15:35:08 +0100
Message-ID: <20251212143504.973839-18-dev@lankhorst.se>

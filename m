...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B5B6ABBDCA
	for <lists+intel-gfx@lfdr.de>; Mon, 19 May 2025 14:31:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83C4210E043;
	Mon, 19 May 2025 12:31:52 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="gROePP2N";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A40BD10E043;
 Mon, 19 May 2025 12:31:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1747657912; x=1779193912;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qwwz1qzQ9G3py7ZJBGnaicQBH35pPzuVyDrfr7IJNfs=;
 b=gROePP2NJwzURQ2JuMt2ZBSpd4wPxIh6yaO6Z2gTh3mFYO3X5AJ34Uxo
 qPw3+9sUdZtNmSSW/6gQi6JyHAo2vnlKVe9C1af1H91G2ExW5TWMdpsZx
 DcVzIOg0tKWgGme/oZb2ASDoBSbB7YNP2KgurSSQMP16OAH3kvsWcUP2A
 1TFBTECYVbnR67snImMMirPcyZPTHaxJaUZYpFALJOM6ToJmBb5lH+UhA
 J7sbaiicRiA1vxJTV2bkIshrSwDbvtn5D5RThPfC6WJ5ilpfW2FGDiz9O
 2FeyK2cGSx/ZgWwJI0McmgzsuUlifPu5oIhgxpxnSOyDI87HtZUovUxkq Q==;
X-CSE-ConnectionGUID: 5pggbaKESkqNItJdj2R2SQ==
X-CSE-MsgGUID: L2UaWqDZQtu6TmezEFin1Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11438"; a="49709981"
X-IronPort-AV: E=Sophos;i="6.15,300,1739865600"; d="scan'208";a="49709981"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 May 2025 05:31:52 -0700
X-CSE-ConnectionGUID: jBCpxDWCS96k1wTp6ARfmA==
X-CSE-MsgGUID: wDjOap9HSqm1aVeysuUdxg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,300,1739865600"; d="scan'208";a="144358062"
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by orviesa004.jf.intel.com with ESMTP; 19 May 2025 05:31:50 -0700
From: Nemesa Garg <nemesa.garg@intel.com>
To: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org
Cc: Nemesa Garg <nemesa.garg@intel.com>
Subject: [PATCH 01/10] drm/i915/display: Introduce sharpness strength property
Date: Mon, 19 May 2025 17:56:35 +0530
Message-Id: <20250519122644.3685679-2-nemesa.garg@intel.com>

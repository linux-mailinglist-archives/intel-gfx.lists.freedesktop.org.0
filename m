...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6486BB4B4C
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Sep 2019 11:54:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 145A16EB99;
...
Subject: Re: [Intel-gfx] [PATCH v10 5/9] drm/i915: vgpu context submission
 pv optimization

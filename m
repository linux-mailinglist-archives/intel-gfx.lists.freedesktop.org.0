...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E5F3C1D2727
	for <lists+intel-gfx@lfdr.de>; Thu, 14 May 2020 08:08:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 399D189F24;
	Thu, 14 May 2020 06:07:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3B80B892FF;
 Thu, 14 May 2020 06:07:52 +0000 (UTC)
IronPort-SDR: o2Leo094zD/Mx+Gfe+mjIKuGYXLlDs9IEuVsoL3g2fapS3Ef2tM22wq6BPzkZG8WdZ/ugwxOpA
 6/pRxXs+jLSA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2020 23:07:51 -0700
IronPort-SDR: yFKl1FHvWfWzR4XbgEHJlyfiJQKZtiywXt4HmpJCDBq1mh+DRLhi+cZ61bEb678/z9q8+oXZXO
 /akjP1Dqjcsg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,390,1583222400"; d="scan'208";a="409957003"
Received: from bgodonne-mobl.amr.corp.intel.com (HELO
 helsinki.ger.corp.intel.com) ([10.252.18.167])
 by orsmga004.jf.intel.com with ESMTP; 13 May 2020 23:07:49 -0700
From: Gwan-gyeong Mun <gwan-gyeong.mun@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 14 May 2020 09:07:25 +0300
Message-Id: <20200514060732.3378396-8-gwan-gyeong.mun@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 07/14] drm/i915: Program DP SDPs with
 computed configs
...
aXNwbGF5L2ludGVsX2RkaS5jCmluZGV4IDc5ODg4OWY3MjQ5NS4uNzVjN2ZmYjE4NzRjIDEwMDY0
NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2RkaS5jCisrKyBiL2Ry
aXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGRpLmMKQEAgLTM2ODEsOCArMzY4MSw3
...
eS9pbnRlbF9kcC5jCmluZGV4IDg0YzAxMDViZTYxYi4uNGNjZDZiN2EzZDgzIDEwMDY0NAotLS0g
YS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2RwLmMKKysrIGIvZHJpdmVycy9n
cHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kcC5jCkBAIC01MTU4LDIzNSArNTE1OCw2IEBAIHZv

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 58D7E9AA068
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Oct 2024 12:53:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C568F10E650;
	Tue, 22 Oct 2024 10:53:54 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="i2bN6dVA";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3506910E653;
 Tue, 22 Oct 2024 10:53:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729594433; x=1761130433;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=05NEm/cuEBpmnXh9CyxiGPPmN1qTCD2GNPoi0OYmyD4=;
 b=i2bN6dVA5+h6pgTFZ+Fj/ENOnea3rtrDSQnszaNvYJwyHaVECLMmNKu3
 ZFwbbdtSPkFDHmNxwoMiroW8LrxmC5wKevB0U8rkChJVKzBjE/mSOBi1i
 Ogxx7wiMV6WJrA0UPAZSP4wIu6mdYTQnY9ihZmKpRDI7I1FjVevkweWGd
 pl6vosT4ntuHJjBDzYA++6k6GjGy0iu/hv+L//l0BUgbBr9xvltFC979n
 XCrR04S37baidEXIRoU9q9OA4I/0AvyMBz9gg1dfm7AOcP3th+ENqdi84
 ZxCwp5zXsCiujlj6Jl/HMWmyh1Og9IzIPHsdvlqvO7ZqLHBlB0UQAFx/9 w==;
X-CSE-ConnectionGUID: O1o7Kjs6TZWUkodQRBMsAA==
X-CSE-MsgGUID: Y1rufgrfTWqITca5na9Ttw==
X-IronPort-AV: E=McAfee;i="6700,10204,11232"; a="39705006"
X-IronPort-AV: E=Sophos;i="6.11,223,1725346800"; d="scan'208";a="39705006"
Received: from fmviesa009.fm.intel.com ([10.60.135.149])
 by fmvoesa105.fm.intel.com with ESMTP; 22 Oct 2024 03:53:44 -0700
X-CSE-ConnectionGUID: b6UrEQ/aTeuO0xaNMwAgcw==
X-CSE-MsgGUID: sCZ1zmc+SR6EgR5/5xsx8A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,223,1725346800"; d="scan'208";a="79847619"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa009-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2024 03:53:20 -0700
...
Subject: [PATCH 03/10] mtd: intel-dg: implement access functions
Date: Tue, 22 Oct 2024 13:41:12 +0300
Message-ID: <20241022104119.3149051-4-alexander.usyskin@intel.com>

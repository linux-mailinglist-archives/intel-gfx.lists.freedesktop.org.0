...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F19BF61D7AA
	for <lists+intel-gfx@lfdr.de>; Sat,  5 Nov 2022 07:01:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA97710E0DC;
...
Subject: [Intel-gfx] [PATCH v4a 00/38] timers: Use timer_shutdown*() before
 freeing timers

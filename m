...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 733002F6E04
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jan 2021 23:18:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3C826E044;
	Thu, 14 Jan 2021 22:18:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [63.128.21.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 690F56E045
 for <intel-gfx@lists.freedesktop.org>; Thu, 14 Jan 2021 22:18:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1610662680;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=mLNYfBwqsNRc1p3TeRFr2iKKLH8Q7mt2UZQHY6k15nY=;
 b=gf1vyMTUid0kkW0GNEjRugb5na1dETowhRI7a2ZixxNWer2dI7ofbyoCpMUZNICG98Vb0Q
 6Cy5vyG6BuRaOVIIYVP04pKiRev7LaxSM9Zhtxs6ebMfw1TYJ5JAxgiOdF/bT3sDknaBf6
 0uGycyxv8eX6qz1YujY9edqKQ1VnNhg=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-518-CFO3RZM3Ns6e_th-YBKPbA-1; Thu, 14 Jan 2021 17:17:58 -0500
X-MC-Unique: CFO3RZM3Ns6e_th-YBKPbA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CE2A8100C660;
 Thu, 14 Jan 2021 22:17:55 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-115-182.rdu2.redhat.com
 [10.10.115.182])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 30A5610016F6;
 Thu, 14 Jan 2021 22:17:53 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Thu, 14 Jan 2021 17:17:07 -0500
Message-Id: <20210114221709.2261452-4-lyude@redhat.com>
In-Reply-To: <20210114221709.2261452-1-lyude@redhat.com>
References: <20210114221709.2261452-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.22
Subject: [Intel-gfx] [PATCH v7 3/5] drm/i915/dp: Enable Intel's HDR
...
index cc2386ef6219..6b1e53664d3d 100644
...
+u32 intel_panel_invert_pwm_level(struct intel_connector *connector, u32 val)
 {
 	struct drm_i915_private *dev_priv = to_i915(connector->base.dev);
 	struct intel_panel *panel = &connector->panel;
@@ -539,6 +539,36 @@ void intel_panel_set_pwm_level(const struct drm_connector_state *conn_state, u32
...
+
 ...
 {
 	struct drm_i915_private *dev_priv = to_i915(connector->base.dev);
@@ -2132,10 +2162,6 @@ intel_panel_init_backlight_funcs(struct intel_panel *panel)
...
-
 	if (connector->base.connector_type == DRM_MODE_CONNECTOR_DSI &&
 		...
 		return;
@@ -2163,6 +2189,10 @@ intel_panel_init_backlight_funcs(struct intel_panel *panel)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C70B0A87C33
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Apr 2025 11:49:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43B0910E518;
	Mon, 14 Apr 2025 09:49:34 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="a/CkO73y";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0452010E519;
 Mon, 14 Apr 2025 09:49:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1744624173; x=1776160173;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=a0B7fMkJxt2Wb7bBeMVZwsKjEvvl5x89e9KqNreoDzc=;
 b=a/CkO73yOy9Zn7QNBw8nE4e7MIpW/ikwyPMduC58JyVbDPcEtgA+VVgJ
 oQDQ8sXKh+8kJwZ2ndNydMRK6emmEbsCnIYt4AlBUqQAPJm3i/H0A5TRp
 srofX/WvdnRyrY75Q5w9T1Sycac5Z5nn7jNSBeXuGUU0X1C6rCSlIsNXO
 cmxyexzGN2F7brbOPA6rc7Lhk7ZNuSSS+12FV9a+wSGS1lbfYDS6czo4L
 cqSztgILpqxGZjJHbnLeEbefLCAl6e1YbUPKANwDXTdrisVb04NJWKUM2
 O08aaSNSiaTAmT14Z3EdYKDJg2yCyP8Y0hWhb/uIrnGuO+WXcxd5DXEYT A==;
X-CSE-ConnectionGUID: TehsAF+aQEecdfadRkNxiA==
X-CSE-MsgGUID: OBUMMrxwSEG0GaUoUi6YPg==
X-IronPort-AV: E=McAfee;i="6700,10204,11402"; a="45222652"
X-IronPort-AV: E=Sophos;i="6.15,212,1739865600"; d="scan'208";a="45222652"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Apr 2025 02:49:32 -0700
X-CSE-ConnectionGUID: SjRXcjm0S3W/nCb+dQyXUA==
X-CSE-MsgGUID: HfkOO8VdQwOWHNJkimIZWw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,212,1739865600"; d="scan'208";a="152954895"
...
Subject: [PATCH v8 03/12] mtd: intel-dg: implement region enumeration
Date: Mon, 14 Apr 2025 12:37:54 +0300
Message-ID: <20250414093803.2133463-4-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1D9165C14D
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Jan 2023 14:56:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F0AAA10E260;
	Tue,  3 Jan 2023 13:56:54 +0000 (UTC)

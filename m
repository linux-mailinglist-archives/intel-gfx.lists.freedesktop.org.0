...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DEA23A4E1B
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Sep 2019 06:03:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A92689B06;
	Mon,  2 Sep 2019 04:03:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0EEBB89A92
 for <intel-gfx@lists.freedesktop.org>; Mon,  2 Sep 2019 04:03:24 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18339020-1500050 
 for multiple; Mon, 02 Sep 2019 05:03:07 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  2 Sep 2019 05:02:57 +0100
Message-Id: <20190902040303.14195-15-chris@chris-wilson.co.uk>
...
ICAgIHwgMzE4ICsrKystLS0tLS0tLS0tLS0tLQogZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9h
...
MTVfYWN0aXZlLmMgIHwgIDM2ICstCiAyNiBmaWxlcyBjaGFuZ2VkLCAyNzQgaW5zZXJ0aW9ucygr
KSwgNTgwIGRlbGV0aW9ucygtKQoKZGlmZiAtLWdpdCBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rp
...
bV9jb250ZXh0LmMKaW5kZXggNGYzMDNjYjk0Njk4Li5iOGRkY2Y3ODk5YTEgMTAwNjQ0Ci0tLSBh
...
L2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfYWN0aXZlLmgKaW5kZXggYWYzZDUzNmUyNmZkLi5l
MTkxMmQ1MzkwMTQgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfYWN0aXZl
...
LDQxICsxNjEsMzQgQEAgaTkxNV9hY3RpdmVfcmVxdWVzdF9yZXRpcmUoc3RydWN0IGk5MTVfYWN0
...

...


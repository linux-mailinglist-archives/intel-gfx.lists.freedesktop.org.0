...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D9537E0A0D
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Nov 2023 21:18:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E98DB10EA84;
...
Subject: [Intel-gfx] [PATCH v4 02/16] drm/i915/dsi: switch mipi_exec_gpio()

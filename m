...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D21B757B9F3
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 17:33:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE8728EF80;
...
Subject: [Intel-gfx] [PATCH v4 13/41] kernel/module: add __dyndbg_classes
 section

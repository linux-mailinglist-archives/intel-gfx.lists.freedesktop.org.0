...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E68B90659A
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jun 2024 09:49:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7F30910E97D;
	Thu, 13 Jun 2024 07:49:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="KdI2HrtW";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8335F10E22F
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Jun 2024 07:49:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1718264966;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type;
 bh=1CiLCm+pCW3IJKtEh6+/HenFU1/k8IrIRP3mdRFM3nY=;
 b=KdI2HrtWrETYffPdpc9x+lZofm77NCeKWko7+4hRzWzQmUXiMrNY3v5ZdeYBPSHUBiABxM
 zhqsB5cE3u41U86w3kajWblm9+2gBvmsotHLDuLwWeGspBWil6GPMLbnNGbRUBVg+cx6+e
 ni1LHrEX+XFR3W0QKTXXSr/WYmTH/SQ=
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 [209.85.128.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-563-vF18rT3rPiK-XyIZ8mUw3w-1; Thu, 13 Jun 2024 03:49:22 -0400
X-MC-Unique: vF18rT3rPiK-XyIZ8mUw3w-1
Received: by mail-wm1-f70.google.com with SMTP id
 5b1f17b1804b1-421292df2adso4970655e9.3
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Jun 2024 00:49:22 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1718264961; x=1718869761;
 h=content-disposition:mime-version:message-id:subject:cc:to:from:date
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=1CiLCm+pCW3IJKtEh6+/HenFU1/k8IrIRP3mdRFM3nY=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXTAkFBHaUc3ktlmpTAn0og7pVOArxC2WolHDTLxqkWC4k5vc2PiDAmXJsrYKcLvqLvwQZYcinT7BgmKHHUVF2x+tocw7hPcodNU9CCvuiA
X-Gm-Message-State: AOJu0YyQw7lC3e/YD0uDPLGEK42k27cxS7IW1OE5vuXz/13TvvUxOUhS
 73KP8k5nAmYJp3K1uOC2UUR023/WI/Lut2uRY/6nms81CN9ReYRAKcQjgJ+85QNyxmAWpERtQUQ
 8jz1P37RItOiavrPQX/11sDhoFg0ZKUxQsOpmirn3k+WjwZKAPQL/B0oJ/Pm6aOLcTw==
X-Received: by 2002:a05:600c:310f:b0:421:b79:93fd with SMTP id
 5b1f17b1804b1-422863b875amr31497285e9.21.1718264960787; 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED8572AB6F
	for <lists+intel-gfx@lfdr.de>; Sun, 26 May 2019 19:36:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A605C897F0;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 03jg==
Subject: [Intel-gfx] [PATCH v2 3/7] drm: make drm_crtc_internal.h
 self-contained

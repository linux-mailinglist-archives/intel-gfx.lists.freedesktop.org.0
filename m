...
Received: from gabe.freedesktop.org (unknown [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BADDB5EEE40
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 09:02:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A07D10E919;
	Thu, 29 Sep 2022 07:02:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1306B10E91E;
 Thu, 29 Sep 2022 07:02:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664434943; x=1695970943;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=4sqgF0AOOumnWxP5iChRDkTMn6K/yxGYvJnPQymBg4Q=;
 b=XK3FRlxim5ylY6QBAaA96fby4YMF0sxy64oCiHnWAvynnqBj4m/MeNfa
 PxJJsNJ9XlTGiPH+L+7Y3wqAvpSh5VzrwcqsYqCwn+j4QuE6Fp2bFwKf+
 xwD8gDsahvXU6j/xKLpSb9NZZ/DSvUsYi8vH66uoclSIAAhER3VsaTBvE
 xHLWfrQzza2cxAP2rGB6NUuFhq06liiWNQVGzA5aC+dv8T3CKuR2+MMfW
 EjasbDjzrwFoHRJCvM009J0DcX5l1a5+SwvhAlvWPPsomc0dqj4Fj1TAJ
 7tjFiLDlqr4JSLRnOiowEV1lbb4jSvu8QgmXRGNk7T7RDi2bM5oeLSGoc w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="299413505"
X-IronPort-AV: E=Sophos;i="5.93,354,1654585200"; d="scan'208";a="299413505"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2022 00:02:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="690704071"
X-IronPort-AV: E=Sophos;i="5.93,354,1654585200"; d="scan'208";a="690704071"
Received: from lkp-server01.sh.intel.com (HELO 6126f2790925) ([10.239.97.150])
 by fmsmga004.fm.intel.com with ESMTP; 29 Sep 2022 00:02:10 -0700
Received: from kbuild by 6126f2790925 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1odnYg-0000lt-0t;
 Thu, 29 Sep 2022 07:02:10 +0000
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="cGF/4bO9FnPcs+L1"
Content-Disposition: inline
In-Reply-To: <20220926153953.3836470-4-gwan-gyeong.mun@intel.com>
Subject: Re: [Intel-gfx] [PATCH v12 3/9] overflow: Introduce
 overflows_type() and __castable_to_type()
...
Cc: trix@redhat.com, dlatypov@google.com, llvm@lists.linux.dev,
 linux@rasmusvillemoes.dk, dri-devel@lists.freedesktop.org,
 chris@chris-wilson.co.uk, linux-hardening@vger.kernel.org,
 andrzej.hajda@intel.com, linux-sparse@vger.kernel.org, matthew.auld@intel.com,
 airlied@redhat.com, thomas.hellstrom@linux.intel.com, keescook@chromium.org,
 jani.nikula@intel.com, nathan@kernel.org, mchehab@kernel.org,
 kbuild-all@lists.01.org, ndesaulniers@google.com, gustavoars@kernel.org,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FDB876BA99
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 19:04:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BCFA10E447;
...
Subject: [Intel-gfx] [PATCH v5 19/22] drm: restore

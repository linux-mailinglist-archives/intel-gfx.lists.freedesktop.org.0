...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6423F4F8FB1
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Apr 2022 09:39:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A0C3810E119;
	Fri,  8 Apr 2022 07:39:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id 2DB4410E0AA;
 Fri,  8 Apr 2022 07:39:12 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 29DD2A01BB;
 Fri,  8 Apr 2022 07:39:12 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============0737634632215691568=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Souza, Jose" <jose.souza@intel.com>
Date: Fri, 08 Apr 2022 07:39:12 -0000
Message-ID: <164940355213.22680.6416714445257290859@emeril.freedesktop.org>
...
#### Warnings ####
  ...
  * igt@gem_lmem_swapping@basic:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11472/fi-kbl-7567u/igt@gem_lmem_swapping@basic.html
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-kbl-7567u/igt@gem_lmem_swapping@basic.html
...
#### Suppressed ####
  ...
  * igt@perf_pmu@busy-start:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/shard-dg1-15/igt@perf_pmu@busy-start.html

  * igt@runner@aborted:
    - {bat-hsw-1}:        NOTRUN -> [FAIL][5]
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/bat-hsw-1/igt@runner@aborted.html
...
#### Issues hit ####
  ...
  * boot:
   ...
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-bwr-2160/boot.html
...
#### Issues hit ####
  ...
  * igt@core_auth@basic-auth:
   ...
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-kbl-8809g/igt@core_auth@basic-auth.html

  * igt@fbdev@eof:
    - bat-dg1-5:          NOTRUN -> [SKIP][8] ([i915#2582]) +4 similar issues
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/bat-dg1-5/igt@fbdev@eof.html
    - fi-kbl-8809g:       NOTRUN -> [INCOMPLETE][9] ([i915#5557])
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-kbl-8809g/igt@fbdev@eof.html

  * igt@gem_basic@create-close:
    - fi-ivb-3770:        NOTRUN -> [SKIP][10] ([fdo#109271]) +146 similar issues
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-ivb-3770/igt@gem_basic@create-close.html

  * igt@gem_lmem_swapping@basic:
    - bat-dg1-5:          NOTRUN -> [SKIP][11] ([i915#5602])
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/bat-dg1-5/igt@gem_lmem_swapping@basic.html

  * igt@i915_pm_rpm@basic-pci-d3-state:
    - bat-dg1-5:          NOTRUN -> [SKIP][12] ([i915#5174]) +1 similar issue
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/bat-dg1-5/igt@i915_pm_rpm@basic-pci-d3-state.html

  * igt@kms_addfb_basic@addfb25-x-tiled-mismatch-legacy:
    - fi-kbl-soraka:      NOTRUN -> [SKIP][13] ([fdo#109271]) +146 similar issues
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-kbl-soraka/igt@kms_addfb_basic@addfb25-x-tiled-mismatch-legacy.html

  * igt@kms_pipe_crc_basic@compare-crc-sanitycheck-pipe-c:
    - fi-ivb-3770:        NOTRUN -> [SKIP][14] ([fdo#109271] / [i915#5341])
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-ivb-3770/igt@kms_pipe_crc_basic@compare-crc-sanitycheck-pipe-c.html
  ...
  * igt@kms_pipe_crc_basic@read-crc-pipe-b:
    - fi-cfl-8109u:       NOTRUN -> [SKIP][18] ([fdo#109271]) +145 similar issues
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-cfl-8109u/igt@kms_pipe_crc_basic@read-crc-pipe-b.html
...
#### Warnings ####
  ...
  * igt@runner@aborted:
   ...
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-kbl-soraka/igt@runner@aborted.html
   ...
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-hsw-4770/igt@runner@aborted.html
   ...
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-ivb-3770/igt@runner@aborted.html
    - fi-tgl-1115g4:      [FAIL][31] ([i915#4312] / [i915#5257]) -> [FAIL][32] ([i915#3690] / [i915#4312])
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11472/fi-tgl-1115g4/igt@runner@aborted.html
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-tgl-1115g4/igt@runner@aborted.html
   ...
   [34]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-bsw-n3050/igt@runner@aborted.html
    - fi-rkl-11600:       [FAIL][35] ([i915#4312]) -> [FAIL][36] ([i915#5602])
   [35]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11472/fi-rkl-11600/igt@runner@aborted.html
   [36]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-rkl-11600/igt@runner@aborted.html
    - bat-dg1-5:          [FAIL][37] -> [FAIL][38] ([i915#4312])
   [37]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11472/bat-dg1-5/igt@runner@aborted.html
   [38]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/bat-dg1-5/igt@runner@aborted.html
   ...
   [40]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-kbl-8809g/igt@runner@aborted.html
    - fi-kbl-guc:         [FAIL][41] ([i915#4312] / [i915#5257]) -> [FAIL][42] ([i915#5602])
   [41]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11472/fi-kbl-guc/igt@runner@aborted.html
   [42]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-kbl-guc/igt@runner@aborted.html
...
<ul>
<li>bat-dg1-5:          NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/bat-dg1-5/igt@i915_pm_rpm@basic-pci-d3-state.html">SKIP</a> (<a href="https://gitlab.freedesktop.org/drm/intel/issues/5174">i915#5174</a>) +1 similar issue</li>
</ul>
</li>
<li>
...
<li>
<p>fi-rkl-11600:       <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11472/fi-rkl-11600/igt@runner@aborted.html">FAIL</a> (<a href="https://gitlab.freedesktop.org/drm/intel/issues/4312">i915#4312</a>) -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_22818/fi-rkl-11600/igt@runner@aborted.html">FAIL</a> (<a href="https://gitlab.freedesktop.org/drm/intel/issues/5602">i915#5602</a>)</p>
</li>
<li>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6ADAA295243
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Oct 2020 20:31:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C90D86E0E5;
	Wed, 21 Oct 2020 18:31:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C17266E0E5
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Oct 2020 18:31:17 +0000 (UTC)
IronPort-SDR: +YNqAaCnZYfPRLpDyGHAft6TFYm9zFTZbxPv4ioLIhOrHX8gIYcn4m/g/3NLlmuPMVPLOROBzH
 MGPVPA/NLMkw==
X-IronPort-AV: E=McAfee;i="6000,8403,9780"; a="166638649"
X-IronPort-AV: E=Sophos;i="5.77,401,1596524400"; d="scan'208";a="166638649"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Oct 2020 11:31:17 -0700
IronPort-SDR: i/YzQ6Eg/DhbHF10o2NJaMH9cZpNc3fL4RluAk2jTbZfrjN9I2PmwkQLoS7hjMauLlZnyQZJD+
 d0KIl7Csxm+g==
X-IronPort-AV: E=Sophos;i="5.77,401,1596524400"; d="scan'208";a="348422914"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 21 Oct 2020 11:31:17 -0700
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 21 Oct 2020 11:32:52 -0700
Message-Id: <20201021183252.4765-1-manasi.d.navare@intel.com>
X-Mailer: git-send-email 2.19.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915: Add hw.pipe_mode to allow bigjoiner
...
index 130303e0298a..0efdd839086f 100644

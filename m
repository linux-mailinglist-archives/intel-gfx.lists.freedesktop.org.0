...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CFAC74E4A5
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Jul 2023 04:59:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B965510E2F5;
	Tue, 11 Jul 2023 02:59:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 27C9510E2E1;
 Tue, 11 Jul 2023 02:59:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689044373; x=1720580373;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=75yOAnfFQYXol7+/zRc9bLgt67cNmgu3dtj/juK5NKk=;
 b=HaZSY7dkfttWuXvD0nqg1AJ1Mk1MTkaeeZbPoC9rXYO2xaZuY1991ZBQ
 LDStOzfFm6/7IKH5IT7T2EjZIr8un1tLkNamLPMDAK8iO/h9pXNuFL8SE
 AqSla6MmddmYR20CnkeIykZ1TgqaeihWHsIo9mufGn1iG8K57v/EmCJ/V
 6mfvOFiXZuKQ7OzT0zq70DJT997DHCg50zdNnvyJuTEo7tu+rO1ur1RiR
 gUaFN5uW2lDixEfLBWMb0E/2fsywXIP1ulPPZwQeHsDqmJrzkTLfVDc7L
 If/0Wo1pMFn2TF0nDRMvmNsR1sUb9cDn9x79TcHuYCwHOE9smoEdkEUZM Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10767"; a="361972950"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="361972950"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jul 2023 19:59:32 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10767"; a="724250756"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="724250756"
...
Subject: [Intel-gfx] [PATCH v14 02/26] vfio: Refine vfio file kAPIs for KVM

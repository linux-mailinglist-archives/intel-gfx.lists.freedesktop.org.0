...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 37FD09AB2EA
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Oct 2024 17:58:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB25C10E6B5;
	Tue, 22 Oct 2024 15:58:06 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="E4mPeQmN";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0CF1210E6B5;
 Tue, 22 Oct 2024 15:58:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729612686; x=1761148686;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GGxaDYglcJ9CqFwXugH0VBLczCPbNk+m66jWtwUIkdg=;
 b=E4mPeQmN/wNhRlxrqAyEbPPxzQiEzPJZ9H1h/bsUrWHAS1WLVfL7pBcB
 a5KvzLCxWEMsds+QoYWScynxwzesXyruyJ9bJ3LbqAGZgm4F2PX/TTIoE
 mrJln6XltAY3+sWVRXxjpNCnObaW2wBNW/IgCweVkuhFMv+x5lDJiMdKx
 T5PoURma/j4tKzOhPajf9HsxVH4faK+DjWPr3raSFN8BmNg6r2YHeLhdQ
 XIY8gPAaW+5940CnTfU6JfHSzaSmvR17LVRJ2YY9dA7NV0Gv1g4n/KvR5
 XCVigjyGDY++73344nBKKui4WBJCvXY9XukZIcjNRqYVP8GigIdvP/67r Q==;
X-CSE-ConnectionGUID: QyC21DIxQ9qpAObU18r7NA==
X-CSE-MsgGUID: zl6W173hRUCzpiKXi6Pgag==
X-IronPort-AV: E=McAfee;i="6700,10204,11233"; a="28612870"
X-IronPort-AV: E=Sophos;i="6.11,223,1725346800"; d="scan'208";a="28612870"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2024 08:58:06 -0700
X-CSE-ConnectionGUID: H1Rb9AuDS5abedfQn4BTJg==
X-CSE-MsgGUID: +bHUF/1eTZy9fg3QNc5AWg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,223,1725346800"; d="scan'208";a="83891865"
Received: from mjarzebo-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.58])
 by fmviesa003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2024 08:58:04 -0700
...
Message-Id: <d68d73aa5a0ba43eca7f1ee6c5f921f5f30aa284.1729612605.git.jani.nikula@intel.com>

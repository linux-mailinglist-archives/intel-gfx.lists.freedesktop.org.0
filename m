...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28605391EF
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jun 2019 18:26:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C00589DE3;
	Fri,  7 Jun 2019 16:26:19 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/4] drm: Refuse to create zero width/height
 cmdline modes

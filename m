...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59E505A55BF
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 22:46:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8CCC10EE8A;
...
Subject: [Intel-gfx] [PATCH v2 4/8] drm/i915: Prepare more multi-GT
 initialization

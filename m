...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BB5A4A6CAD
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Feb 2022 09:08:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B730C10F9B6;
...
Subject: [Intel-gfx] [PATCH v2 5/6] drm/rcar_du: changes to rcar-du driver

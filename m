...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F10EA1B9AD3
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Apr 2020 10:54:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 411E26E128;
	Mon, 27 Apr 2020 08:54:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3BCCE6E122
 for <intel-gfx@lists.freedesktop.org>; Mon, 27 Apr 2020 08:54:19 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21032265-1500050 
 for multiple; Mon, 27 Apr 2020 09:54:11 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 27 Apr 2020 09:54:06 +0100
Message-Id: <20200427085408.13879-7-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 7/9] drm/i915/gt: Switch to manual evaluation of
 RPS
...
index 0ce6a0e492ea..3e83b65eb3c6 100644
--- a/drivers/gpu/drm/i915/gt/intel_rps.h
+++ b/drivers/gpu/drm/i915/gt/intel_rps.h
@@ -80,5 +80,19 @@ static inline void intel_rps_clear_interrupts(struct intel_rps *rps)
 {

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DAAD521217
	for <lists+intel-gfx@lfdr.de>; Tue, 10 May 2022 12:21:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6ED3510F6D5;
...
Subject: Re: [Intel-gfx] [PATCH v2 21/25] drm/edid: convert

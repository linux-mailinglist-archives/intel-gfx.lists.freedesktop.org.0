...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B11F2D2B1B
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Dec 2020 13:34:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 641B36E97B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/6] drm/i915/dsc: make rc_model_size an encoder
 defined value

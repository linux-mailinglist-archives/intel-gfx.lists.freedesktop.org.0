...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4494513D3EB
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Jan 2020 06:50:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A181A6EBD9;
...
Subject: [Intel-gfx] [PATCH 4/5] drm/i915/bw: convert to new drm_device

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18D763CBD3B
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jul 2021 22:00:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9C966E9E7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 42/51] drm/i915/guc: Implement banned contexts
 for GuC submission

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 426E83B9770
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 22:26:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB4556EB9B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 29/53] drm/i915/dg2: Add new LRI reg offsets

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A3F4C9A42C
	for <lists+intel-gfx@lfdr.de>; Tue, 02 Dec 2025 07:26:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E6EF10E53A;
	Tue,  2 Dec 2025 06:26:52 +0000 (UTC)

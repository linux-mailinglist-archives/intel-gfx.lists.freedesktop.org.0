...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 64F31CA72A3
	for <lists+intel-gfx@lfdr.de>; Fri, 05 Dec 2025 11:30:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47B0410EAAA;
	Fri,  5 Dec 2025 10:30:52 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="h5EB5fFr";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0934C10EAA8;
 Fri,  5 Dec 2025 10:30:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764930651; x=1796466651;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=oafwIgzpPLtmVLPTySaPMLq/dslqlGgmUr3COELfTno=;
 b=h5EB5fFr84PxGTcRn29/LAttxyoBh2quCQ55oxQ0gs38ubtFaXiK7UIE
 RK+gDXB32NZSVSzGb3LT3kQg4zQ6FxymphPVBEitWbAcUeoUvfXx0eKnw
 JVo6hh28MiZIXQs4kuO7B6TaR7K2qzW5+4YhpRch+gOnhFjKjGADyUBMd
 1TRO1HQKLeQn6F8oLlyKDIPSBSBEgW8/ilXdx6+YJhO1xaATOVjIW/bsz
 t5XN92W7uxAzn6UQ7qc5umRW13M9jw8TFPVeuuG0f0L7BqOOMOInIglOo
 i6achWsJzYXM2ji0BgpXAs79O/4dXRU8bLNDcriAwSn4sVtRlHXY2DOHV A==;
X-CSE-ConnectionGUID: 4odtt19MSP6CtUnaYmZxbw==
X-CSE-MsgGUID: OocXxsPHSsqr7x/dQXR5Tg==
X-IronPort-AV: E=McAfee;i="6800,10657,11632"; a="67001169"
X-IronPort-AV: E=Sophos;i="6.20,251,1758610800"; d="scan'208";a="67001169"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Dec 2025 02:30:50 -0800
X-CSE-ConnectionGUID: 8b6ytpXvRAWoTN2yR/eHPg==
X-CSE-MsgGUID: 9i6xKcdjT1ypdpAkboc5kg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,251,1758610800"; d="scan'208";a="194562956"
Received: from ettammin-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.65])
 by orviesa010-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Dec 2025 02:30:49 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH v2 3/4] drm/{i915,
 xe}/stolen: move stolen memory handling to display parent interface
Date: Fri,  5 Dec 2025 12:30:29 +0200
Message-ID: <350c82c49fe40f6319d14d309180e2e2752145ac.1764930576.git.jani.nikula@intel.com>

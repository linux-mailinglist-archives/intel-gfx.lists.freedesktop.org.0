...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 206FF49356A
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jan 2022 08:24:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57ED310E2B1;
	Wed, 19 Jan 2022 07:24:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2ABE710E1EB;
 Wed, 19 Jan 2022 07:24:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 NKLEL+E73uu4YCEeQvKnFLnTbYsVtlw2ihCOZDK2uc6Dln2/oFv53MmpF Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10231"; a="244799933"
X-IronPort-AV: E=Sophos;i="5.88,299,1635231600"; d="scan'208";a="244799933"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Jan 2022 23:24:27 -0800
X-IronPort-AV: E=Sophos;i="5.88,299,1635231600"; d="scan'208";a="530544516"
...
Subject: [Intel-gfx] [PATCH 3/3] drm: Convert open yes/no strings to yesno()
...
Cc: Emma Anholt <emma@anholt.net>, David Airlie <airlied@linux.ie>,
 ...
 Leo Li <sunpeng.li@amd.com>, Julia Lawall <julia.lawall@lip6.fr>,
 Rahul Lakkireddy <rahul.lakkireddy@chelsio.com>,
 Steven Rostedt <rostedt@goodmis.org>, Mikita Lipski <mikita.lipski@amd.com>,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25BD32CBFB9
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Dec 2020 15:31:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C84B26EA5B;
...
Subject: [Intel-gfx] [PATCH v3 07/13] drm/i915: Capture max frl rate for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB2E82D2B19
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Dec 2020 13:34:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E704D6E97A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/6] drm/i915/dsc: configure hardware using

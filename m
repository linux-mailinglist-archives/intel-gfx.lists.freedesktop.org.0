...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 203793253ED
	for <lists+intel-gfx@lfdr.de>; Thu, 25 Feb 2021 17:48:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C7EE6ECDE;
...
Subject: Re: [Intel-gfx] [PATCH] drm/compat: more dummy implementations
...
Content-Type: multipart/mixed; boundary="===============0254902859=="

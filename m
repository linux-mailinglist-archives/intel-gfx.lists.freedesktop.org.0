...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C4495F5921
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Oct 2022 19:34:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0912810E72E;
	Wed,  5 Oct 2022 17:34:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 257C410E2AF;
 Wed,  5 Oct 2022 17:34:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664991256; x=1696527256;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=D/D9b0a9iF5GKl+v30R7UWJ4OOj4g7H04dVG44Pmopk=;
 b=BuEHcYjo1vrfO+3mVG3bCmJDiNUSsOSdmkjnmj1YcnNjNLfvyhee1aMU
 7Mtb3GRhbuAtsu/nL48uYK6xXdXx7mt5SYX7iwxpCvKmY1a3TdLxKZFhS
 6R1hg8E6Na/rXxCUOx3ad2zo/vHX9n3PyJK5IljwFxZ/FjhPp3+j0B8i7
 KMLkOCS6kwh7upEQo1IjlZvInqqBySV8nANU5I4scXcUG9CZLdoHf7R8c
 XqdF4TQKeU5RNwojMo9fawasFhgeo4E3+4Q4BupFZxfoXxeEPKwtLDFjc
 n4yV3x1ObFfKaVIc2QBmlg31sjSPlr7QZa1V/jjj2wCntCSCswpcpv5KA w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10491"; a="365143016"
X-IronPort-AV: E=Sophos;i="5.95,161,1661842800"; d="scan'208";a="365143016"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2022 10:34:12 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10491"; a="799564477"
X-IronPort-AV: E=Sophos;i="5.95,161,1661842800"; d="scan'208";a="799564477"
Received: from gionescu-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.252.39.173])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2022 10:34:10 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Vinay Belgaumkar <vinay.belgaumkar@intel.com>,
 intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org
In-Reply-To: <20221005155943.34747-2-vinay.belgaumkar@intel.com>
...
Date: Wed, 05 Oct 2022 20:34:08 +0300
Message-ID: <87ilkyqinj.fsf@intel.com>
MIME-Version: 1.0

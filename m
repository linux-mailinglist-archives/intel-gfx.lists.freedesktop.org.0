...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FB6A54F9D
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jun 2019 15:03:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 07BAF6E0FA;
	Tue, 25 Jun 2019 13:03:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8B0006E0FF
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Jun 2019 13:03:18 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17018174-1500050 
 for multiple; Tue, 25 Jun 2019 14:01:34 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Jun 2019 14:01:19 +0100
Message-Id: <20190625130128.11009-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/20] drm/i915/gt: Track timeline activeness in
 enter/exit
...
IDQ3MWUxMzRkZTE4Ni4uMmJjMjVlM2Y4M2U2IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF9scmMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9s
cmMuYwpAQCAtMzE2Niw2ICszMTY2LDggQEAgc3RhdGljIHZvaWQgdmlydHVhbF9jb250ZXh0X2Vu
...
LTMxNzMsNiArMzE3NSw4IEBAIHN0YXRpYyB2b2lkIHZpcnR1YWxfY29udGV4dF9leGl0KHN0cnVj

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDEE255C03D
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Jun 2022 12:34:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D404911AAB8;
...
Subject: Re: [Intel-gfx] [PATCH 09/14] drm/radeon: use drm_oom_badness

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9EF759F96B
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Aug 2022 14:18:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A59118B3D8;
	Wed, 24 Aug 2022 12:16:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5E8B211AD0C
 for <intel-gfx@lists.freedesktop.org>; Wed, 24 Aug 2022 12:16:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1661343389;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=odfSBCZPzbhtIghrqB9jKxIVVOwBiMpifs1qKmZ4b0A=;
 b=Q+av9p4Eq2+MN4lWU6uEpcBxA1xDe4WcMHoRhZ31nPc8+Ov393iGivKmianRvp+2yOlBPq
 YAKVOVFs53rZZynuazaceorjlQU4TZqsSdFPewohYeARwE7x2GfN1EkwG2oYmeL8RfrM+V
 ajRPqhG0mcs5IllFICda4vwxGzzd7kg=
...
Subject: [Intel-gfx] [PATCH v4 10/31] ACPI: video: Remove code to unregister
 acpi_video backlight when a native backlight registers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A039B61056B
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Oct 2022 00:13:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D592F10E027;
...
Subject: [Intel-gfx] [PATCH 0/5] Introduce the GSC CS

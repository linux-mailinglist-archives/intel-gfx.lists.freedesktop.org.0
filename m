...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BE28965301A
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Dec 2022 12:20:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0584A10E18C;
	Wed, 21 Dec 2022 11:20:07 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 2/2] drm/fbdev: Move damage clip check to higher
 level

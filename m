...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B97325D83F
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Sep 2020 14:00:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EFD8A6EB8F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 3/7] drm/i915: Add checks specific to async
 flips

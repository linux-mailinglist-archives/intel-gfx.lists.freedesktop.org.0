...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C49D94BEDC2
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:18:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A8C110E544;
	Mon, 21 Feb 2022 23:18:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D990B10E53A;
 Mon, 21 Feb 2022 23:18:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485498; x=1677021498;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=mmpDbho6EFBReIp+UJ+Rf409yBMByOTa3FwPx9dN22o=;
 b=TTTBUE7o/au9ml6OdzqqUykeO2YyIuGNJElKLhx1Xbe+IP3tqDgEV0IA
 NE8nARhyY5xx4tP6Oqc9w5LOy/T3PG/zEJ6Wo6ka8LoYzi9gPQWy2du2G
 cUkiGzEIsEggkbIKJA8OHtDXr/5kZ07g0qnbT+E9TciIh24/eq7TFg/9R
 Dw1hsd5GOTMhamWCH0an8rvdmH8btuChxfMnd4dGoI+Cgk5Q2I0Q0GyPq
 gb38JzRTyBWY84cc06O57XFJLaxV8HRQPOKn2IIS0gpOzUiikTHtUDaQ3
 1jspF+sCpqkvdcx7cauEtxvGMapDoFINCtkM+tvoa0JaTNhwfC/c6ZCRc g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="238996049"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="238996049"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:18:18 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="638694599"
...
Date: Tue, 22 Feb 2022 00:17:01 +0100
Message-Id: <20220221231705.1481059-20-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 08/11] drm/i915: Separate wakeref tracking

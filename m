...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mFMtHvMonmk7TwQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Feb 2026 23:40:51 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5428218D886
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Feb 2026 23:40:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDC8710E625;
	Tue, 24 Feb 2026 22:40:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=Nvidia.com header.i=@Nvidia.com header.b="DJzyKRdP";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from BYAPR05CU005.outbound.protection.outlook.com
 (mail-westusazon11010065.outbound.protection.outlook.com [52.101.85.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0468810E340;
 Tue, 24 Feb 2026 22:40:47 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=On68GUi7IYDricIQ9WRvB5IuoNnm6w4u9DMdbJReF1E=;
 b=
...
Subject: [reference PATCH v11 2/4] gpu: Move DRM buddy allocator one level up
 (part two)
Date: Tue, 24 Feb 2026 17:40:03 -0500
Message-Id: <20260224224005.3232841-3-joelagnelf@nvidia.com>
...
X-ClientProxiedBy: MN0PR05CA0025.namprd05.prod.outlook.com
 (2603:10b6:208:52c::13) To DS0PR12MB6486.namprd12.prod.outlook.com
 (2603:10b6:8:c5::21)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: DS0PR12MB6486:EE_|PH0PR12MB7816:EE_
X-MS-Office365-Filtering-Correlation-Id: 8943b040-dd16-4249-b50f-08de73f5ada2
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
 ARA:13230040|1800799024|7416014|376014|366016|13003099007; 
X-Microsoft-Antispam-Message-Info: =?utf-8?B?NVo0SUJVVkpiSFBSTDhWSWM5dTZNMlcyQWk5SS9UdWJOb0ZCTHA0djNnMzI2?=
 =?utf-8?B?WlQrSGRSVGJ2Z1R2T01mN0JKemhKeDJ6MWpMdGVGSWFvMWxXc2lpSThPMEVt?=
 =?utf-8?B?M2MyRDZhcTlyMnFnNCs5ZFVjZG9la0NYbUJ4eGFaZ3pLeVJBTzZ5MkxobDF6?=
 =?utf-8?B?VkxFbzZZTDMwcEUzM040Y1BhRXppUFdQSzJ6RUpjeHdwakt0alJlRTFWWUVV?=
 =?utf-8?B?RU1RNmFaNHdhcUVqTWNNZ1VQNmVsejBRcTZsdHc3U0d1d2E4bXhZRitLdkph?=
 =?utf-8?B?c1A5VDNqRHpTdTJaS3VSb2xUNEQvTzFhT2VxR29NeHJaQVFkcm1veUF0Q0k3?=
 =?utf-8?B?QkxybjFxYm9HTWdnTDNZczA1MHRkdFRna3M3L1ZET25VRnFvSHJkbEhtSWs3?=
 =?utf-8?B?bVJhQ1RBYU1rNXhVUGkwdTFKVGpDUlRLcEduV080dUVUcHh1VEsyNFlBQnc2?=
 =?utf-8?B?VmllQnVsQ1NQdXd2SDlEOE5Gd2NvdFNCbGRFdGVvWTY1OUpxNWVHM09rQmk2?=
 =?utf-8?B?cGxxS05mWStZVWNFTVcyUG9JNXJsSXcwRkhGenIwTnBhd3pjS2VkUW44VFU4?=
 =?utf-8?B?MXVVS2N4TjRsS1RsT2pqVDdUbElPcWZ2T0FGaHEyazE4dVBIUjNyNHl3UUFV?=
 =?utf-8?B?aVlBZEcvS1Q2OU5Qb1NFbFRjei8xVGM4c0N0eDVPNm01S29LZWF4UFNVRkhi?=
 =?utf-8?B?QTlhSURFOXp2OFlYdzd2cVNCSjVwdTltWUJGK0cxcFExVVQ1ZGIvWmtxVlpx?=
 =?utf-8?B?WWRwWDNkbm85YlQ5UEIyeWhmZWFVUmwxeVpycm15SnNQQUdtN2dpS3lvSHFD?=
 =?utf-8?B?c2I0ZUR6L203M2poTHlvaFZURzMvUGU4TWtsNzhsbUk5UHpicFVzd21ZUnZX?=
 =?utf-8?B?TFRpaHZtY2xGbzJxVVptN1lPcUhGSjlocFk2Y3BHZUlobG15M2F1ekkrT08v?=
 =?utf-8?B?VU9tMGlSUTZZV2RCdWdMUGNRTXdxMm01WnNUNytGRkdFQnJLZlFHbUZRMHdO?=
 =?utf-8?B?NGplM0Fyd0lFRGQ0Y0dGU3ZNRGUxNitIeWhDWW9UT0F6THhMYWY2RlI0Zzc2?=
 =?utf-8?B?czA4S2xFdmtRNS9YOFE0RTE2MmJYdjlSMUhMdGF6bWNDRGtUSFpMT1Y5Nzdw?=
 =?utf-8?B?OVg5bTVGS2xUTjlmaGxIUE5ZbXd4NWxqRW1NbTRJeFhjb0NNMzJXS1luZzJ2?=
 =?utf-8?B?M1JCL2wyQjBqS1ErRkxRQzhNME1kUEJGRnlLR3V3WVFnKzZ6ZitsZmxIelI0?=
 =?utf-8?B?V1g1WUFYYlhEckRZdzNkR2VSRXcvM1BUU2hab2xNMVM1WFhKc0hxVGt4NE41?=
 =?utf-8?B?MmxRcXN6YmVxWXdGVzE4bkFZS2hOTmZjc2lIcktwMGkvdTAyb3l5UDZoQ2Rh?=
 ...
 =?utf-8?B?OEFIcmkrckgxMU1oeTliK2Fxd1B0Kzk5Y3VaRVBka0tBVjBHbkJkR2dvT2ZP?=
 =?utf-8?B?NHZONThYSDF3Mk5GTVdHa2JYU1NzQ0pFMXdjQUh6MjJ1NTM2SXQxaDl3bFE2?=
 =?utf-8?B?bjJPU2F6T0hGcVZ0WUFJOFovRm93ZkdvNi9ZMzZvNVlCYTZPcDFjV2RpTllI?=
 =?utf-8?B?ZTJZVVlwNTRzTUg0TkVnOFg3dG8veWZRY2piSTEvampST1o3RU9ETHl6ODdr?=
 =?utf-8?B?cGZpcUhoQ0ptRmp3OWVvdWRYc2FzdGg3bU9rbFMvNUFMZGRqK3Y3ZU5nVm1q?=
 =?utf-8?B?QWlsWlJGa0g4UGo4QkdrYldzSVdob0J4WUp5L1lUY08xZ1U1NGQ0UGRpWDBl?=
 =?utf-8?B?dTZXbFlWT3FmUXBqdUVrNzNZNEZWd2JmY3RPemtnNERyN1IzWjhSSlkxMnRa?=
...
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?ZFJFbTlmL0hGYkNLV3dRUGhHUVVjclZubWRwck9LMUUwSmRVanhSYUdDLzV1?=
 =?utf-8?B?L0VtVHVqMytQV201Zll4WWpiRzFzN1hqS1NXVWJsOUUraXhIZ3k1S0NaQ0Fs?=
 =?utf-8?B?VXlnQ2g2QVovVUJ5Z3U3Q3pWODMzRUxJVXdvcWZOZzJsV0ZUMzE5ejdOSFFK?=
 =?utf-8?B?S1QvTXF5US9PRFowbnpZVlhyNGtzRW9aWHBDdzkxdzVPQnExanBxTXc3T0Qw?=
 ...
 =?utf-8?B?b3hDMEF1VDRFQjhLZGdzd2thcEdPaHB4d1UwMWpOd2QrUDJTOGxHSTVreG1q?=
 =?utf-8?B?QWp6ODFNVWdyYlZLejkreFhkVDBwcTZzWVdGVmo0Y0ZURzcreFE2MFhEVzJB?=
 =?utf-8?B?YVFyNmx4M1hmbUJEQkpsS0JnU1Q3dVI1Y3ZnRUpTMXgwZGtqM255dG9ZRkZn?=
 =?utf-8?B?bkJxdlRqM05sVStwYmlOMFlNNmJibTZXdTBCanhGYWEzaktEc2d5R2RudUhs?=
 =?utf-8?B?RWExZ3VaV1RSQ1piZGF2M3UzQWc2KzFXT2NBOHB6VGxyZFRsOHpvUDRlSUd0?=
 =?utf-8?B?dm1Db3JlSjVlYWtLZ1ovK0lBa0xMdUxIZjBjYkprK2xsUEwyaVpnRlhQV2Zq?=
 =?utf-8?B?Y1ZOT0hpM0dDd2lQcG0xbGUyTE9HeWgzZVJnd3hCMS9OTkpOVUpwNzJPTkhT?=
 =?utf-8?B?cmVIVUkzOCt6UnhHeVhRZHBOcHNvR2VxTmhiUkV4clNrdWhtNTVnN05YUW5o?=
 =?utf-8?B?RHNhMkNMZENIcXV2VFJrLzdOOThRbm9LdFBMcVZSZ21oekltdmVKbFQrNVZ2?=
 =?utf-8?B?a2RyNjdvanNhTnNaWXRnSXRDVitoVXRhTkc1cmRvTmQzSUZYbkJJdGxGQi94?=
 =?utf-8?B?V0lJZmNVOWNqUVdmK3JTaVBxcHBTakJRalcvZnJqY1dHcWR1NlA3c2VqeFl4?=
 =?utf-8?B?T2tYaWtWTXQrZEJCUjFHUS8zMHpFWkdOVUlqM1JwL1FEUnVaUlI2VTdQVVND?=
 =?utf-8?B?Y3pIWHYrOXBySmU3UFMwZ3U0L053TVZYK296L014SEVxbHdvNXVrMEhyd0pH?=
 =?utf-8?B?c1RMalBhbDRMcXg3ZDZQWVNieHgzckZGTC8vUkM4cytDUklSaW9CeVh4OW0w?=
 ...
 =?utf-8?B?cEdHeDA1R20yNFV3RFR3enhXb0Zxcy9jVXRFdFQxNWM2c3EyL2lVenV2VkpO?=
 =?utf-8?B?WmsxQllOYjhWeWVJY21xa3dPZkRaalNXdjBLWUdlRW1WT1JUWTFLclNIVkh2?=
 ...
 =?utf-8?B?RFRKU3BrRjZxTCtIdSthS0VwWWs0WjJ2aHFaU2pBZDhxMzJTREF5bGlabnZF?=
 =?utf-8?B?bVR1RFZxZ09VOU83em56SEdVa2dyUXMxLytVVGJUbmYxS0pVMFNaQVdPSVdm?=
 =?utf-8?B?SGxKTXdHb0REblRKeE1Lb3lidUJ0RHdhUW0zZWliQVdEYUp3eGtDNE1PTWJC?=
 =?utf-8?B?SndOY0xhMkRYLzRXNWsxbzdUZ1o0cStYbjZ6ZW9UWmp5RFdqVU1BOGIrQVQ5?=
 =?utf-8?B?cWt0cFBNNG9STGhZSXpMV0V3OVhtd0dIQnNWNFpBajg5OVl1cHRxUEpHTHRK?=
 ...
 =?utf-8?B?N3VRUEJheC96aWFVZmpUcmJrRURHNUswZ1lWSW1HTzJrZWYxZnI4ZU02ODdS?=
 =?utf-8?B?N3JnNko5N2Z1YXdXbE1PY2l0NHVLbjMwSlB1ZWxMMklrT0tycWMyUT09?=
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 8943b040-dd16-4249-b50f-08de73f5ada2
X-MS-Exchange-CrossTenant-AuthSource: DS0PR12MB6486.namprd12.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 Feb 2026 22:40:15.3292 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 43083d15-7273-40c1-b7db-39efd9ccc17a
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: A9Gj8ZgvCZ6E8HgFuB3Quf/p6n/NolSzsfHut/yozx6Bj5/dTLUZI/dmAfyUoC2KEn/NhsC7HYbeQ3OhK5EmPQ==
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[Nvidia.com:dkim,intel.com:email,nvidia.com:mid,nvidia.com:email,lists.freedesktop.org:email]
X-Rspamd-Queue-Id: 5428218D886

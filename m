...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5439D76606A
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jul 2023 01:58:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 14DFA10E634;
	Thu, 27 Jul 2023 23:58:01 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 181CC10E634;
 Thu, 27 Jul 2023 23:57:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690502279; x=1722038279;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=yAvxc5o0MUSgnqGuahFdmKyIB1lTHf7l+iWAVkpWajY=;
 b=H9HQLRMGJr8b/ewsAeALC7pd9eNwuy062fTd53yg/gbFt7v8bHCG2Luj
 lSCg2Ih5hluGAP8s0iJxGkae7lptveo+6R+sKv4JNooaFksafETgM1cMu
 Vc9oH4b2My4HNhks3QvSRA0W8h0BN/sLlYsf4BLeTAjKxjOqGaipaaGG2
 RwMB5lF7otLZ/S3XyLppwpD/JVW/plxX3PFHJnipbYtwWhQAZIfYi477l
 BFLVZFJB3myZqbulTRQ+RXZ9f+8CnrNXRWSkRIC903xkb+Vh7EChjw5p1
 GylK3kFauA+uSGXp5JQUyOAmD7W6xTpgZrOxKT0nz2D3Mukq0MEmIykV7 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="372087825"
X-IronPort-AV: E=Sophos;i="6.01,236,1684825200"; d="scan'208";a="372087825"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jul 2023 16:57:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; d="scan'208";a="870635142"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
 by fmsmga001.fm.intel.com with ESMTP; 27 Jul 2023 16:57:59 -0700
Received: from orsmsx610.amr.corp.intel.com (10.22.229.23) by
 ORSMSX602.amr.corp.intel.com (10.22.229.15) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27; Thu, 27 Jul 2023 16:57:57 -0700
Received: from orsmsx610.amr.corp.intel.com (10.22.229.23) by
...
Received: from ORSEDG602.ED.cps.intel.com (10.7.248.7) by
 orsmsx610.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27 via Frontend Transport; Thu, 27 Jul 2023 16:57:57 -0700
Received: from NAM10-MW2-obe.outbound.protection.outlook.com (104.47.55.103)
 by edgegateway.intel.com (134.134.137.103) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.27; Thu, 27 Jul 2023 16:57:57 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=Rn5DwD0kVeME/0yKZ0MXI5wuW+AADj9bz6YrmD1L03M=;
 b=
...
Received: from DS7PR11MB7859.namprd11.prod.outlook.com
 ...
 23:57:53 +0000
Date: Thu, 27 Jul 2023 16:57:50 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Message-ID: <20230727235750.GD138014@mdroper-desk1.amr.corp.intel.com>
...
X-ClientProxiedBy: SJ0PR03CA0114.namprd03.prod.outlook.com
 (2603:10b6:a03:333::29) To DS7PR11MB7859.namprd11.prod.outlook.com
 (2603:10b6:8:da::22)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: DS7PR11MB7859:EE_|IA0PR11MB8353:EE_
X-MS-Office365-Filtering-Correlation-Id: db3d78f9-b380-4f04-3eb9-08db8efd4a7a
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DS7PR11MB7859.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230028)(39860400002)(346002)(376002)(396003)(136003)(366004)(451199021)(83380400001)(66946007)(66476007)(82960400001)(4326008)(966005)(66556008)(316002)(6916009)(2906002)(186003)(38100700002)(54906003)(6486002)(26005)(6506007)(6512007)(1076003)(30864003)(33656002)(86362001)(41300700001)(8936002)(478600001)(8676002)(5660300002)(559001)(579004);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?8cU5H2T5ijt/s263nVutclX7OzlIbyD8TqDuvh/tBMmpMG8m/zv059vNPTTE?=
 =?us-ascii?Q?TMu8E3BLHBjmagOcDUM3GteZ5hRVa5EGaUpnU7lXIOG2sKrupWjy2mL6d3yJ?=
 =?us-ascii?Q?VFQYn64reguiNJvCabNBvZ5QE+guAlpzyiP+CMBq9zGWpHWPW8eSmXSwe1cI?=
 =?us-ascii?Q?R9t0Z0KVNRVBT8i9pzZai8YdN5+O+no/BBcq38ILR82nmX7uQT+7vYkCKxF/?=
 =?us-ascii?Q?QrGpIFkcW0hbr4xV7e0rBtqV5x7ynrtwJHOLF5TE9UOj7PlLXDxyUhyuUDpb?=
 =?us-ascii?Q?jR9rojVvHoKjV216VMTaEvD+NZdQu9SbpclLb2xS+6yJSstzC0N7nSEe1R/T?=
 =?us-ascii?Q?yEofL4MisN9vDHnr6Z+Tdxni2M5HB62AnL6tDWI1REb//jAGmMfzyYlcsw6M?=
 =?us-ascii?Q?X68CfoLHWITG/4CWx1++VIyvZ3xKn4F3n0K95tZN4patN5YCgEfAzS35Ya6+?=
 =?us-ascii?Q?AwoXZ6FCgpJoJWa87ql3PBSsbirf/EG6ogIJnZ1oJOIVeNa7fkSAYz2yADrj?=
 =?us-ascii?Q?OBJq5n3ssT9jorwkP3Upy3Dk6o380jF+nQ9nxRyZLMLYFPxeGd0h0u9/VFZR?=
 =?us-ascii?Q?zgpbxiEvjH29gSmlnk8nc+SNkBKnfioEA00S6r6yK4/c92tQ6GSi9FnZnwsx?=
 =?us-ascii?Q?4x+sXX6/uQzpBHdX7ZJ/atHYwPC3ySxSz1McULAVMakmq9iAWySeYBqVcglQ?=
 =?us-ascii?Q?wwjnrAoDbGZxWjSBaRjT35wkuEEVICViF3hdzUSHEJUeXC5udAxRrqb7u7AS?=
 =?us-ascii?Q?d9IlmSCQkAAiG+Dp2bJxGINthdhOdXd0EeiwFaXa1RYq+IGSJQSirb7Ssl80?=
 =?us-ascii?Q?Ic4S41qXGtthuQMX0v19/47hyXxBXgHMx18UBYj7fvdPh8W6dDMqpTfp06iq?=
 =?us-ascii?Q?Ajm8oyaPN4JLIKjh+j/U+RYjyRndYzy0B87Eqrj6d4Pa7b5yN7JtcI/HnuEX?=
 =?us-ascii?Q?A5xGik96U2t3s49A274DO0HCfmubSkplJn30NcfcP8aHnzXlMTgx/5OvyvCI?=
 =?us-ascii?Q?8rOTqD7OHYeJc2JrW2E3uFxJfApVXNSH4JLeXzihraO838FInEQOEOGYSQHC?=
 =?us-ascii?Q?R1svpS6j3QhJNQ9DXnQoVQaIeVG7J2FmkltejecTkSgQtL+pIrvTDjd+SlGm?=
 =?us-ascii?Q?AQWRkmkqJH0z6WnVMAWurdN1STP6Fq7DJ/SRymybUyOAfion/d9o2ehJmLp6?=
 =?us-ascii?Q?50T6mfw1HQM8ytD7jb01tD8eFpnkQ+cZDdHpSv4v1L4rvPbUYBuWK2AGnYD7?=
 =?us-ascii?Q?yG3UL9WjbeDIoLWeEhhjd0EhTciPsnakjEY8PDBZMPj9+aCIKouPY2UoZbVm?=
 =?us-ascii?Q?1K5CgK0l3R5K9eWILyO14hPFMiR64D1SA4145+zkqZoojYQmKRRDOl1UoHIH?=
 =?us-ascii?Q?93eHRtcsQEXIWuox2o0P4eQ0AB4/ifYewpa4KDyFNXLbVk/Q/r5qnKDa/8on?=
 =?us-ascii?Q?reUSAmwIW+iSE57ai9eOXTGHAI+YVo1lnxobSw7eYTK7QEj2xks1ulHbstin?=
 =?us-ascii?Q?powQF25x2+sw17Sw9M3Zkkwg2iFlPTE5R+6h9PMF0/3qGJxf3EdmADDBIRjO?=
 =?us-ascii?Q?f3Fw+r9lAwileqBPPwVvvabHvzK2Uvxw5Zbqitc/kV05U8pAS9sjeu/u7DQN?=
 =?us-ascii?Q?uQ=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: db3d78f9-b380-4f04-3eb9-08db8efd4a7a
X-MS-Exchange-CrossTenant-AuthSource: DS7PR11MB7859.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jul 2023 23:57:53.2813 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: 0t0GGDGYfnRcKslEw5usN6lBCjVNdqafKtSEnsTvgOK5CY8h/aIEAiMJzW2TJ2mlx2KhWBGwqPXeTm61ZXrYh2piWz/7OVMDRpkB5WqNJbo=

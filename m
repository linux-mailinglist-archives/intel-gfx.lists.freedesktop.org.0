...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C2DEC3B8613
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 17:11:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0E7C6EA30;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 16/17] drm/i915/display: Use the general

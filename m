...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CD9E513C6A
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Apr 2022 22:12:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1ED6A10E9C2;
...
Subject: [Intel-gfx] [PATCH v5 4/6] drm/i915: ttm backend dont provide

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 15EB970FA86
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 17:38:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E3C810E3A4;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Fix clang -Wimplicit-fallthrough in

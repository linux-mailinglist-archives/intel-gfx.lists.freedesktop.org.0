...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D8B76BB9D8
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Sep 2019 18:45:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBA946E974;
...
Subject: [Intel-gfx] [PATCH trivial] gpu: Fix Kconfig indentation

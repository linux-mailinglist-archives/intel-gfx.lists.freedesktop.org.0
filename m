...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C9802D98E7
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Dec 2020 14:35:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ACB766E167;
...
Subject: Re: [Intel-gfx] [PATCH v8 18/19] drm/i915/hdcp: Configure HDCP2.2
 MST steram encryption status

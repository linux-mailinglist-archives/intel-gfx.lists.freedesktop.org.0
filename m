...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5AC3470EA1
	for <lists+intel-gfx@lfdr.de>; Sat, 11 Dec 2021 00:24:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 23D6010E5B7;
...
Subject: [Intel-gfx] [PATCH 4/7] drm/radeon: Replace kmap() with
 kmap_local_page()

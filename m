...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04D7978A555
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Aug 2023 07:44:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B549810E0C7;
	Mon, 28 Aug 2023 05:44:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F14A810E0C7
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Aug 2023 05:44:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1693201483; x=1724737483;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PhAALNdpcGxKxSw8Jk1CGZDSIMaT/yP4ekSzOHeERpI=;
 b=dmQbwl8arKli9VG/PdTXLIdW8flVxoBbp169OPoCiC/LgOrYJD4Z5p8G
 ieLe6aGFvI0NBK6D4yf8CSzt3japRcUwBHlNKlPxTGwZnpOfBBr3eyf2A
 TylzUBxwyIP87g0zW8o4e04ja7RHOriwAFEc/VpU5o9paS4B47Vv+k8/y
 3I6HuW1WCFfuv4MOuSkKFIpqBgkImWnAjHhR+vycYNUeBw12B90kmYDSt
 m4qaCf0wwTeKlUvTMYsdDbGAflHo1Riry2lFHEXhdbQvVOanXdy2ThhCZ
 eeyCMazREaFBgkykz24/iQN9CybrhDaXcSO5kh+6YUku8+MxJLdRWvpkn g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10815"; a="373906594"
X-IronPort-AV: E=Sophos;i="6.02,206,1688454000"; d="scan'208";a="373906594"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Aug 2023 22:44:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10815"; a="738128535"
X-IronPort-AV: E=Sophos;i="6.02,206,1688454000"; d="scan'208";a="738128535"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga002.jf.intel.com with ESMTP; 27 Aug 2023 22:44:41 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Aug 2023 11:12:54 +0530
Message-Id: <20230828054300.560559-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 1/8] drm/i915/vdsc: Refactor dsc register
 field macro

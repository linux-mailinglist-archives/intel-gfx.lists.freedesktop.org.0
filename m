...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A4FC2755C2
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:22:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9EC066E925;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 00/22] Convert all remaining drivers to GEM
 object functions

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF5C01D0666
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2020 07:33:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CCA526E1AA;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 1/3] drm/dp: DRM DP helper for reading Ignore
 MSA from DPCD

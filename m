...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4BFF5B5380
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Sep 2022 07:30:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D38010E139;
	Mon, 12 Sep 2022 05:29:19 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v7 8/9] drm_print: prefer bare printk KERN_DEBUG
 on generic fn

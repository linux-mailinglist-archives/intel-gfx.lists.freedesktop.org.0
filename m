...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1193136C7E1
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Apr 2021 16:40:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9E1B6E2B8;
...
Subject: Re: [Intel-gfx] [PATCH v2 3/7] drm/i915/gtt: map the PD up front

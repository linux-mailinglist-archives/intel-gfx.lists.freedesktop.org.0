...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 00DA25AA4A4
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Sep 2022 02:48:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 499C510E421;
...
Subject: [Intel-gfx] [PATCH 6/7] drm/i915/gt: Always use MCR functions on
 multicast registers

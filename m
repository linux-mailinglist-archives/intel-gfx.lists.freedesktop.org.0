...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DFE1C4733A8
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Dec 2021 19:11:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9736010E6E8;
	Mon, 13 Dec 2021 18:10:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C9C5710E6E8;
 Mon, 13 Dec 2021 18:10:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1639419056; x=1670955056;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=2k4ulkUclfCSC1sSVLPKc41Hk584Dy+ftDG3Qe/6jQE=;
 b=kycp2sRJUMs8SMjbDrVbyvVc8/BIt3Zra/3KlUklmDgvXS/92PlvhCmM
 4xa8X22xIGcQielHZhGAsMjiIljp2eLCe46r+ZVqVnQyoxx721XJZqMYL
 HDdL+dyZzwKkqc/pghz6+4GDrPEm6R/hnZB6o9155F199Mq/sNdRqy+Hv
 zu1HxljaFz8OLAARKqxid3l0tWZ9mfDINclSc97J+FbIIqqcWqrA/bwEu
 QTRONfzI+mxPoLl+KfKI4xi7boSu0X1u2Vnua2nKGK3fby67WQ0soJg1x
 GTux4/tG1ekN76+RR4rhod3J/ASXkdFuHLAl55/BKC4JJ6T2cpJcJXe1H g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10197"; a="302174387"
X-IronPort-AV: E=Sophos;i="5.88,203,1635231600"; d="scan'208";a="302174387"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2021 10:10:56 -0800
X-IronPort-AV: E=Sophos;i="5.88,203,1635231600"; d="scan'208";a="681728368"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2021 10:10:55 -0800
Date: Mon, 13 Dec 2021 10:10:53 -0800
From: Matt Roper <matthew.d.roper@intel.com>
To: Andi Shyti <andi.shyti@linux.intel.com>
Message-ID: <20211213181053.GJ2219399@mdroper-desk1.amr.corp.intel.com>
...
In-Reply-To: <20211212152117.118428-12-andi.shyti@linux.intel.com>
...
> index ba90ab47d838..55cc96b1f2b3 100644
...
> index ef4d0f7dc118..6bea0b180c89 100644
...
> index 059642738f6c..2c8f6c5298bd 100644
...
> index 8ba2119092f2..abd8d13833b3 100644
...
>  	int ret;
>  
> @@ -1101,7 +1101,7 @@ int i915_gem_init(struct drm_i915_private *dev_priv)
>  
...
>  	}
>  
> @@ -1124,7 +1124,7 @@ void i915_gem_driver_unregister(struct drm_i915_private *i915)
>  
...
> index 13bb0c3c3f0d..82867424d203 100644

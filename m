...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FDB342CBE9
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 22:50:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 310E46EB58;
...
Subject: [Intel-gfx] [PATCH v4 18/20] drm/amd: cleanup:

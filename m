...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D77D251904
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jun 2019 18:51:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57E4789C6B;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt;
 ...
 5lIXxw8g==;
Subject: [Intel-gfx] [RFC][PATCH] wake_up_var() memory ordering

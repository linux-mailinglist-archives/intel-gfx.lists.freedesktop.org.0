...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 380213EB783
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Aug 2021 17:17:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 454A66E851;
...
Subject: [Intel-gfx] [PATCH v5 0/9] dyndbg: add
 DEFINE_DYNAMIC_DEBUG_CATEGORIES and use in DRM

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B5772518552
	for <lists+intel-gfx@lfdr.de>; Tue,  3 May 2022 15:22:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DDA810FFFC;
...
Subject: [Intel-gfx] [PATCH 2/2] x86/pat: add functions to query specific

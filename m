...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC06467A7FD
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 01:49:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D255B10E28B;
...
Subject: [Intel-gfx] [PATCH] drm/i915/guc: Fix missing ecodes

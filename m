...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D55A5BF47D
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Sep 2022 05:27:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8168C10E581;
	Wed, 21 Sep 2022 03:27:09 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 05/15] vfio/mdpy: Use the new device life
 cycle helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A38316C236B
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Mar 2023 22:11:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2A8610E323;
	Mon, 20 Mar 2023 21:10:57 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: limit double GT reset to pre-MTL

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A9FB7AEE60
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Sep 2023 16:15:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C92610E3F2;
	Tue, 26 Sep 2023 14:15:43 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 2/2] drm: Replace drm_framebuffer plane size

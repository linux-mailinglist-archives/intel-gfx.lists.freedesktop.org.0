...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 544419C35D9
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Nov 2024 02:18:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3CA3B10E3F5;
	Mon, 11 Nov 2024 01:18:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="EGUU+gPt";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7FE7910E3F5
 for <intel-gfx@lists.freedesktop.org>; Mon, 11 Nov 2024 01:18:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 xPem4XAfrPKtFaxs4JtoGed6i3afVuB+7poRpLUFcQ5LXIehFpPGnl2P7 w==;
X-CSE-ConnectionGUID: YjvRg4YWSwW7FrYOX88n3w==
X-CSE-MsgGUID: YjfKsW4ZTamtyiXNcByRuA==
X-IronPort-AV: E=McAfee;i="6700,10204,11252"; a="41713918"
X-IronPort-AV: E=Sophos;i="6.12,144,1728975600"; d="scan'208";a="41713918"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2024 17:18:41 -0800
X-CSE-ConnectionGUID: 6eW+UiEnSSCtCAi537p7WQ==
X-CSE-MsgGUID: 4D64gkvNSRqcIizxj4oMKw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,144,1728975600"; d="scan'208";a="86761864"
Received: from allen-sbox.sh.intel.com (HELO [10.239.159.30]) ([10.239.159.30])
 by fmviesa008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2024 17:18:39 -0800

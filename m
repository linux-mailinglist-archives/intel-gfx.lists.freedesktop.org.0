...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D5D6146598
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 11:23:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3416D6FBB5;
...
Subject: [Intel-gfx] [PATCH v2 4/6] drm/i915/dp: conversion to struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 131C216C41D
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Feb 2020 15:38:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DBE226EAFD;
	Tue, 25 Feb 2020 14:38:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A0B6D6EAFD
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Feb 2020 14:38:31 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Feb 2020 15:38:16 +0100
Message-Id: <20200225143824.1858038-12-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/20] drm/i915: Rework intel_context pinning to
...
+
 ...
 {
@@ -225,43 +284,35 @@ static void __intel_context_retire(struct i915_active *active)
...
index 47561dc29304..538ae4a7216f 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -2948,7 +2948,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -2977,20 +2980,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -2998,9 +3004,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3026,8 +3032,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -4816,13 +4824,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -4855,8 +4863,10 @@ static void virtual_context_exit(struct intel_context *ce)
...
index 5633515c12e9..f3d766f9f4e7 100644

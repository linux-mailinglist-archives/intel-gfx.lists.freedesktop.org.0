...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 24E9523B72B
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Aug 2020 11:00:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 760826E451;
	Tue,  4 Aug 2020 09:00:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 128C96E450
 for <intel-gfx@lists.freedesktop.org>; Tue,  4 Aug 2020 09:00:06 +0000 (UTC)
IronPort-SDR: p0bX2VD1fjcW4LEVZXaPPVxPaFDHtgyV4YegCM7AFKsFLmbaoxCUVNeu5WFGaRMotJ3qJTFgG7
 l7fTNnzpPceQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9702"; a="153442626"
X-IronPort-AV: E=Sophos;i="5.75,433,1589266800"; d="scan'208";a="153442626"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Aug 2020 02:00:05 -0700
IronPort-SDR: FG7FJg3PA0pQkjbRe5F12oVE5zwaKvwPjEo+jtFHe+2IC0o/P9NmOGcxfzBgyVzHWwUlhF8yEn
 V746HH3pxYNw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,433,1589266800"; d="scan'208";a="315261490"
Received: from wrottner-mobl1.ger.corp.intel.com (HELO
 delly.ger.corp.intel.com) ([10.252.61.120])
 by fmsmga004.fm.intel.com with ESMTP; 04 Aug 2020 02:00:03 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  4 Aug 2020 11:59:53 +0300
Message-Id: <20200804085954.350343-2-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: introduce a mechanism to extend
 execbuf2

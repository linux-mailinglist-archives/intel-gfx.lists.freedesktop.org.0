...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 026DA729937
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Jun 2023 14:12:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7360710E6A7;
...
Subject: [Intel-gfx] [PATCH 2/8] drm/i915: Track buffer objects belonging to
 clients

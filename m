...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A806F4EE0ED
	for <lists+intel-gfx@lfdr.de>; Thu, 31 Mar 2022 20:45:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E3B9510F47A;
...
Subject: [Intel-gfx] [PATCH v2 08/12] drm/edid: use a better variable name
 for EDID block read retries

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1B8C633E98
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Nov 2022 15:13:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0FB9910E3E3;
	Tue, 22 Nov 2022 14:13:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B032110E3E3
 for <intel-gfx@lists.freedesktop.org>; Tue, 22 Nov 2022 14:13:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669126380; x=1700662380;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=z6Jtffpvd4t5J35Sqm/SRtFRrhxM1U5TmZsT8CQCvp4=;
 b=IDMfHEPzwHIX6MajjVHU7rStUEUOxYpXT3bWxQF67VfnUHzoeJGXHNYl
 dug0q6D0w7XK/C7WcyA0cZaKrxb/FUfqJmWdB7GS/0IZ4AkwUskUxrk+z
 4jzcunsoWnah31uaRuOW0tjtYSB5EgAaIRQJ4vC875KSAXhd5uEqXK1rD
 PN9KzXZIp0r08nD5+EG4h86DT/vQYJuSPQvF4jlazAr/bYemd7lf3emGF
 MbcOHGp5MT9SVKfEvSBMmChlDWFQkT2QsCZ2SUoD+JzXYziKOj/WAAmIG
 uRq3cQiCeSsCIKHPpArpwHXFE935xPsS7qfJv+i+LYaaAQ52Qw1QLSpAD A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10539"; a="314971346"
X-IronPort-AV: E=Sophos;i="5.96,184,1665471600"; d="scan'208";a="314971346"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Nov 2022 06:13:00 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10539"; a="641430695"
X-IronPort-AV: E=Sophos;i="5.96,184,1665471600"; d="scan'208";a="641430695"
Received: from sfflynn-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.18.151])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Nov 2022 06:12:58 -0800
...
Date: Tue, 22 Nov 2022 16:12:56 +0200
Message-ID: <8735abxel3.fsf@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2ABFD74433C
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Jun 2023 22:35:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 44F8910E4E8;
...
Subject: [Intel-gfx] [PATCH v3 5/7] drm/i915/gt: Enable read back on
 XEHP_FF_MODE2

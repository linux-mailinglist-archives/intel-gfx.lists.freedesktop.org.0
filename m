...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C71964EE76
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Dec 2022 17:03:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A55D10E5FA;
	Fri, 16 Dec 2022 16:01:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8E5BF10E5F5;
 Fri, 16 Dec 2022 16:01:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671206493; x=1702742493;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lb1x609d+PZ1fGOzwWy8KPeN6h/hhIZanXYkka89gGM=;
 b=bpNU7ABZDmavJfRewZuFlLYjHNny+mlGF4KWAm/avI+chj4ZG46rhL9H
 4nK+Rh0HrL9vaycoFB8UvLQK6H0ieB3On/sSxkwlzK6jWgHPAptc/G50J
 t8lHpS00Yiz1d0Jj2LsLdam3cpZieTHAl4CAax4dJJ+9iYAvr+kSYgyud
 NMdzCsh9Z5dp9HPq078IxKGw6etqoUf7VJ6M5dzSWCTWcMOkTUEgLbCmh
 Ttuiad85j63t4B2B1Y8MQDDg7x2bKrFjIN6pdoXWpu3O6P3CgA9UmHs+N
 ZbNrGmmO7SBAMRt8Ndp5WihnGQ4hgyQ6Pp6Zgf+8tRstSDdBXya5YtxGJ Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10563"; a="346076682"
X-IronPort-AV: E=Sophos;i="5.96,249,1665471600"; d="scan'208";a="346076682"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Dec 2022 08:01:20 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10563"; a="713301267"
X-IronPort-AV: E=Sophos;i="5.96,249,1665471600"; d="scan'208";a="713301267"
Received: from fbielich-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.252.62.38])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Dec 2022 08:01:11 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Fri, 16 Dec 2022 18:00:23 +0200
Message-Id: <616ac872294a407444b7136c664da22298fdc2d7.1671206131.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 09/12] drm/i915/edid: convert DP,

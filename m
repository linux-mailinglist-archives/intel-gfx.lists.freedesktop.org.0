...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB1C254B8E6
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jun 2022 20:42:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67D2410F66A;
...
Subject: [Intel-gfx] [PATCH 2/3] Revert "drm/i915: Hold reference to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0554112857F
	for <lists+intel-gfx@lfdr.de>; Sat, 21 Dec 2019 00:24:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B535B6ECD1;
	Fri, 20 Dec 2019 23:24:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 57E6C6ECD1
 for <intel-gfx@lists.freedesktop.org>; Fri, 20 Dec 2019 23:24:25 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19651965-1500050 
 for <intel-gfx@lists.freedesktop.org>; Fri, 20 Dec 2019 23:24:22 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 20 Dec 2019 23:24:21 +0000
Message-Id: <20191220232421.686442-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.24.1
MIME-Version: 1.0
Subject: [Intel-gfx] [CI] drm/i915: Remove i915->kernel_context
...
---
 ...
 32 files changed, 309 insertions(+), 487 deletions(-)
...
index 6e7010089e23..7b7b2bd9708a 100644
...
+		ce = intel_context_create(engine);
 		if (IS_ERR(ce)) {
 			err = PTR_ERR(ce);
 			goto out;
@@ -1168,6 +1167,8 @@ static int __intel_engines_record_defaults(struct intel_gt *gt)
 		if (!rq)
 			continue;
...
+
 		...
 		if (!state)
@@ -1284,6 +1285,7 @@ int i915_gem_init(struct drm_i915_private *dev_priv)
 	}
...
+	i915_gem_init__contexts(dev_priv);
 	...
 	if (ret) {
@@ -1291,16 +1293,10 @@ int i915_gem_init(struct drm_i915_private *dev_priv)
 		goto err_unlock;
 	}
...
@@ -1364,9 +1360,6 @@ int i915_gem_init(struct drm_i915_private *dev_priv)
...
-		i915_gem_driver_release__contexts(dev_priv);
 ...
 err_unlock:
@@ -1431,7 +1424,6 @@ void i915_gem_driver_remove(struct drm_i915_private *dev_priv)
...
@@ -1439,6 +1431,8 @@ void i915_gem_driver_release(struct drm_i915_private *dev_priv)

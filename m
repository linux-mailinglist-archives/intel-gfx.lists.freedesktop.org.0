...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9942F7FE4BA
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Nov 2023 01:20:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D68110E69F;
...
Subject: [Intel-gfx] [PATCH v7 1/2] drm/i915/guc: Flush context destruction
 worker at suspend

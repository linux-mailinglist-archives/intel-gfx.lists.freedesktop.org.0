...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CCFFC6F1E6D
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 20:58:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9787310EDC8;
	Fri, 28 Apr 2023 18:58:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9769E10EDB5;
 Fri, 28 Apr 2023 18:58:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682708308; x=1714244308;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=5s9Jib8wWGSUagl/OJOSxzQbWzyu6j0wqdKu5BeqrLE=;
 b=g8ATiUqTfEVgWxZdzAbO5OVchivuPXxfJE9MzyXJ0PWMEkgDvNfklHHf
 S66ryZccxxdYyBCtEo5+8d8xfuwcN9xtrGIA5dvou4m4S0bUpLRVazZ4E
 Ir0dpvX/06ci/CJ4Ee5xOjhP8bqpur5z3aKB7jyn7txoZGX62GCYHzaiQ
 Y7SAurHdgGrbtAH3wkdYn1yfU7BrgWFnHk6xRW4L6cxAz80jQxSZivfLg
 rt6vgv0TbcJnukHn+6EvOkLPlMI2+J7wzD1UDX2PBlEY1DvU1lSopK5id
 +8TRhPp3w2fAAT03JF2xfEU8qbX02RLpP12Er6K2LlD9MndSZWJvVgoe6 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10694"; a="350747174"
X-IronPort-AV: E=Sophos;i="5.99,235,1677571200"; d="scan'208";a="350747174"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Apr 2023 11:58:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10694"; a="645254606"
X-IronPort-AV: E=Sophos;i="5.99,235,1677571200"; d="scan'208";a="645254606"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Apr 2023 11:58:28 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 28 Apr 2023 11:58:08 -0700
Message-Id: <20230428185810.4127234-7-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 6/8] drm/i915/mtl/huc: auth HuC via GSC

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EAB4C4F3875
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 16:34:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4043D10E641;
...
Subject: [Intel-gfx] [PATCH v8 0/9] drm/i915/ttm: Evict and restore of
 compressed object

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E4A5567284E
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 20:30:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D29C10E829;
	Wed, 18 Jan 2023 19:30:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x834.google.com (mail-qt1-x834.google.com
 [IPv6:2607:f8b0:4864:20::834])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CC4AA10E822
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Jan 2023 19:30:46 +0000 (UTC)
Received: by mail-qt1-x834.google.com with SMTP id a25so23517036qto.10
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Jan 2023 11:30:46 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=chromium.org; s=google;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=xlQweLnofINt83WPU/o8+OCqjw85B48zFdd3kJHFssM=;
 b=SkCKHCPiZt8bxkYxT9izCMW6vAj7ipcshp3cWlHxOrgKqkY01jtBzoWuww5OGl6/JI
 aJwaTToScvvudtrCfx6kd6yvFceDW/00FdR8wkU1SGjipQMaPiKR1A1/c2RAmSW7Uzui
 ESJIqMleaovNS4Y7XjXycbVTgEgMukM1Fbx+0=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=xlQweLnofINt83WPU/o8+OCqjw85B48zFdd3kJHFssM=;
 b=
X-Gm-Message-State: AFqh2kp669W2MnwaP5UTxEqZNGYlQeyjmhj4uPLRdEmk6OhmPLRwK4iP
 6/l9jAQtX6N5qDeBNDXuNTuSxA==
X-Google-Smtp-Source: AMrXdXuPG7YY6UtK7IzlMqueHZMg8pyFhCbuLcbF2bgJZZCef6YNhhD/GGY8/Sxozqut21XMOsQltw==
X-Received: by 2002:ac8:7a93:0:b0:3b5:87db:f99e with SMTP id
 x19-20020ac87a93000000b003b587dbf99emr12667122qtr.39.1674070245943; 
 Wed, 18 Jan 2023 11:30:45 -0800 (PST)
Received: from localhost (29.46.245.35.bc.googleusercontent.com.
 [35.245.46.29]) by smtp.gmail.com with UTF8SMTPSA id
 bk14-20020a05620a1a0e00b006ce580c2663sm22916664qkb.35.2023.01.18.11.30.44
...
Date: Wed, 18 Jan 2023 19:30:12 +0000
Message-Id: <20230118193015.911074-8-markyacoub@google.com>
X-Mailer: git-send-email 2.39.0.246.g2a6d74b583-goog
In-Reply-To: <20230118193015.911074-1-markyacoub@google.com>
References: <20230118193015.911074-1-markyacoub@google.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v6 07/10] drm/i915/hdcp: Use HDCP helpers for
 i915

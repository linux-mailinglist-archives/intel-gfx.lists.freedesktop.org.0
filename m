...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4089A3B2921
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:30:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6156B6EAA4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 12/27] drm/imx/dcss: Don't set struct

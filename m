...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1DF252241A
	for <lists+intel-gfx@lfdr.de>; Tue, 10 May 2022 20:33:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C130410E038;
...
Subject: [Intel-gfx] [PATCH v3 0/3] Fixes for selective fetch area
 calculation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 52B565FF682
	for <lists+intel-gfx@lfdr.de>; Sat, 15 Oct 2022 01:04:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A840910E155;
...
Subject: [Intel-gfx] [PATCH v3 05/14] drm/i915/gt: Add

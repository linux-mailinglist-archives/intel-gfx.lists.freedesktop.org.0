...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BAB006BE17D
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 07:46:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06F4610E127;
	Fri, 17 Mar 2023 06:46:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3E13C10E096;
 Fri, 17 Mar 2023 06:46:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 x9Zc/591EUwVT6VwsELqB20Y1m4nDYLWtDs76jSzCRZd+oErzk1diyUYN w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="339736123"
X-IronPort-AV: E=Sophos;i="5.98,268,1673942400"; d="scan'208";a="339736123"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 23:46:11 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="657453567"
X-IronPort-AV: E=Sophos;i="5.98,268,1673942400"; d="scan'208";a="657453567"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230025)(39860400002)(346002)(366004)(136003)(396003)(376002)(451199018)(5660300002)(8936002)(2906002)(41300700001)(3450700001)(316002)(8676002)(66476007)(66556008)(54906003)(478600001)(6486002)(6916009)(6666004)(83380400001)(186003)(26005)(6512007)(6506007)(4326008)(66946007)(86362001)(82960400001)(38100700002);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 17 Mar 2023 06:46:07.0609 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 10/27] drm/i915/gvt: Protect gfn hash
 table with vgpu_lock

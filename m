...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C78B78504D
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Aug 2023 08:01:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8444010E2C4;
	Wed, 23 Aug 2023 06:01:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 25F0810E2C4
 for <intel-gfx@lists.freedesktop.org>; Wed, 23 Aug 2023 06:01:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692770466; x=1724306466;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=YLZJZGRsRZMiBrpQg4PK+lFkxr81/8ny6AGnNCa7F1I=;
 b=WFcXlYQ9VSJZb4wOEies3vYwjViocQ6Yxu6GsyzSN5c23J3gFk7zxVoh
 0V92QcFuzwlrqASpJ9X1mCogdzmu2Rge2OuCVNG/UXEQA+izKW9/sdK85
 KHJdj8whtKaxFwY5zWVpMX9t39PvhHwQQ3ttWrkqAdFQFPsOdeif/bQi6
 fK24gYpzvrH9xYl1Y+7k+NYtZdss2d/l1++kjTbIPpsvWp4L0PDVgMqEz
 VyfdPJojNdFMD3idAIqW2X7EQBrxNbxO23qkiLpUW1cIbM5PdOjGDv8CZ
 bjCveoxm++7FFbuXm/zvdqzt1IHAWEVPMqROSe3dMaLEpYW8dIl5vIATr g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10810"; a="364253997"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="364253997"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Aug 2023 23:01:05 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10810"; a="860199681"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="860199681"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga004.jf.intel.com with ESMTP; 22 Aug 2023 23:01:03 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 23 Aug 2023 11:28:19 +0530
Message-Id: <20230823055821.460045-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/4] drm/i915/hdcp: Use intel_connector

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 22CC3391D94
	for <lists+intel-gfx@lfdr.de>; Wed, 26 May 2021 19:09:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BE4C6ED25;
	Wed, 26 May 2021 17:09:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x62c.google.com (mail-ej1-x62c.google.com
 [IPv6:2a00:1450:4864:20::62c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6DC076ED25
 for <intel-gfx@lists.freedesktop.org>; Wed, 26 May 2021 17:09:34 +0000 (UTC)
Received: by mail-ej1-x62c.google.com with SMTP id z16so2982809ejr.4
 for <intel-gfx@lists.freedesktop.org>; Wed, 26 May 2021 10:09:34 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :in-reply-to;
 bh=HzOsaV8uPz4RvAniacpVMtfVF7njsV6EGs/QV53jdxI=;
 b=
X-Gm-Message-State: AOAM531C/7N8Lg0dDbt805oh8Q493paJ1bz9x79R12dZvEFVd7YmVFA0
 ZmxPunnMBMEsRDfVb2r1wQHelA==
...
Subject: Re: [Intel-gfx] [PATCH 7/7] RFC: dma-buf: Add an API for importing
 sync files (v7)
...
> +	struct dma_fence *fence, *singleton =3D NULL;
> +	int ret =3D 0;
> +
...
> +
> +	singleton =3D dma_resv_get_singleton_unlocked(dmabuf->resv, fence);
> +	if (IS_ERR(singleton)) {
> +		ret =3D PTR_ERR(singleton);
> +	} else if (singleton) {
...
_buf_export_sync_file)
> +#define DMA_BUF_IOCTL_IMPORT_SYNC_FILE	_IOW(DMA_BUF_BASE, 3, struct dma_=
buf_import_sync_file)
>  =

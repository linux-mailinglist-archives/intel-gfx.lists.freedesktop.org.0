...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB84C270C5D
	for <lists+intel-gfx@lfdr.de>; Sat, 19 Sep 2020 11:50:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 250166E202;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch RFC 06/15] csky/mm/highmem: Switch to generic
 kmap atomic

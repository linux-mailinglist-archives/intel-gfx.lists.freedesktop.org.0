...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C8EE944B10
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Aug 2024 14:14:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E4C5410E102;
	Thu,  1 Aug 2024 12:14:10 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="U1xYEAfD";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="dhDDlM/U";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="U1xYEAfD";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="dhDDlM/U";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.223.130])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B86CE10E039;
 Thu,  1 Aug 2024 12:14:09 +0000 (UTC)
Received: from imap1.dmz-prg2.suse.org (imap1.dmz-prg2.suse.org
 [IPv6:2a07:de40:b281:104:10:150:64:97])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-out1.suse.de (Postfix) with ESMTPS id 06775219DF;
 Thu,  1 Aug 2024 12:14:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1722514448; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding;
 bh=0GS0Ln3WUL+LaEkdNU76GhEGHyhlaHcU8IKhLo9JKjY=;
 b=U1xYEAfDKPAQDMKlVNh2rJS4NXOwxtMrjqPkenxBcnB3FWUC2ttGiTTlnFcG2LA5+k34D7
 QAYrdE1bRK61aWHSUM3ByeZT5DY2eod6lyXi85GWn8hcG9VjFqXTM3rGCqyFiBikxG/ebs
 hTsUwEZDDuas6idu2LGg8BRbeQ7NKKg=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 s=susede2_ed25519; t=1722514448;
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding;
 bh=0GS0Ln3WUL+LaEkdNU76GhEGHyhlaHcU8IKhLo9JKjY=;
 b=dhDDlM/UZy6D99pJ1WxgSO48JI4HnbBC/+j6Ktma1z90vrtMmn6cZGSplzreUDAcEAf8wj
 5IR6j3sxLXBu5dDA==
Authentication-Results: smtp-out1.suse.de;
 dkim=pass header.d=suse.de header.s=susede2_rsa header.b=U1xYEAfD;
 dkim=pass header.d=suse.de header.s=susede2_ed25519 header.b="dhDDlM/U"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1722514448; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding;
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 8CD0913946;
 Thu,  1 Aug 2024 12:14:07 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id AEYOIQ98q2aYWQAAD6G6ig
 (envelope-from <tzimmermann@suse.de>); Thu, 01 Aug 2024 12:14:07 +0000
Date: Thu, 1 Aug 2024 14:14:06 +0200
...
Message-ID: <20240801121406.GA102996@linux.fritz.box>
MIME-Version: 1.0

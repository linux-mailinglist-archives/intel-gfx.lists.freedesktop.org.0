...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F28D53CCC1
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jun 2022 17:55:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F502113AD3;
	Fri,  3 Jun 2022 15:55:49 +0000 (UTC)
X-Original-To: Intel-GFX@lists.freedesktop.org
Delivered-To: Intel-GFX@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EE5A8113AC4;
 Fri,  3 Jun 2022 15:55:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654271748; x=1685807748;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=JJIIT3wXfo61SIDl0+/6447iM1Y33tboksnvm9J5v6o=;
 b=aKHl2Koy2vT/1tbQEuF5D+9EEWWi/qN6OMxZ+JHMGcgLXfX3z1fvndcg
 bkM6zfvEz33ON55QJ09OPyJO7KVuTR9oPbtSlAFxSm5Ma/HRlhLVxnI1M
 JU4dmsE37nmtfQOEz2cGbmY0govU7JwlCoYYrApo0WcW9paRtnXeaIW8V
 MAFzEhacY4fust3jIyVR7A66nUOwc4ieepGfoKDfAPLIG+SrXBCJqTyc+
 lzfe1i0pfyFPeohXHcFmEWL8pZsaBYgkGILaXbulpQPj/LaVAhDFFSENH
 01OG+BWl5JehePZPRq1Ynbcc09FJx4ci3MHsvxos3e+Lm5SfryJ1T9oLE A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10367"; a="275081303"
X-IronPort-AV: E=Sophos;i="5.91,274,1647327600"; d="scan'208";a="275081303"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2022 08:55:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.91,274,1647327600"; d="scan'208";a="607455247"
Received: from relo-linux-5.jf.intel.com ([10.165.21.134])
 by orsmga008.jf.intel.com with ESMTP; 03 Jun 2022 08:55:46 -0700
From: John.C.Harrison@Intel.com
To: IGT-Dev@Lists.FreeDesktop.Org
Date: Fri,  3 Jun 2022 08:55:46 -0700
Message-Id: <20220603155546.2248816-3-John.C.Harrison@Intel.com>
X-Mailer: git-send-email 2.36.0
In-Reply-To: <20220603155546.2248816-1-John.C.Harrison@Intel.com>
...
Subject: [Intel-gfx] [PATCH v4 i-g-t 2/2] tests/i915/query: Query,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B1D3764024
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jul 2023 22:07:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EA1A10E4C9;
	Wed, 26 Jul 2023 20:07:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0A8ED10E4C7
 for <intel-gfx@lists.freedesktop.org>; Wed, 26 Jul 2023 20:07:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690402033; x=1721938033;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=aI878OUronYdu23zLc/glL8c4iUaoq7XR75onLoaCD8=;
 b=FB0c9TQoeaLLjOEo77ev9UGIIaFNUmZQB2BvR5P0hiWlDam0Ghidg5Eo
 RsytMF9hXPtYfaEyDDC7BPK3PhlfNMTfcMx5OmedBx8ACeYkYX7Brhxpe
 L2RqebjgzqJaWJ5zeSxHQg5pakWOrlm+px5UNAoMTsqnjNDtPNRRpkIbo
 2pTSjwJiCuc1R6FpejYhVz0KvCKSDs8F8ccCCT2QcBvmUPC+KGFbKiOL7
 5n+QvY3EHph7i6+pyVzI/t5Pp0mEHdAlFA6TXi80u/eFuGh3sX7hAr3LT
 /JoT+puLCEAE6XwpKx1Om0b12fFBec8gBYRu88oRNCXJaJ30iFMY7HfFN A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10783"; a="399057763"
X-IronPort-AV: E=Sophos;i="6.01,232,1684825200"; d="scan'208";a="399057763"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Jul 2023 13:07:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10783"; a="720614525"
X-IronPort-AV: E=Sophos;i="6.01,232,1684825200"; d="scan'208";a="720614525"
Received: from pltuser2-ms-7d25.iind.intel.com ([10.190.239.58])
 by orsmga007.jf.intel.com with ESMTP; 26 Jul 2023 13:07:11 -0700
From: Dnyaneshwar Bhadane <dnyaneshwar.bhadane@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Jul 2023 01:36:47 +0530
Message-Id: <20230726200657.2773903-5-dnyaneshwar.bhadane@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 051D8ADD0E4
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Jun 2025 17:05:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 80F7E10E760;
	Tue, 17 Jun 2025 15:05:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="bhificOU";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0613510E75F;
 Tue, 17 Jun 2025 15:05:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1750172743; x=1781708743;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GFube+gC6502VTBuZaY4++giPU/6FLO2ZUzV5+IsC6Q=;
 b=bhificOU6t8AAMLO9b/IPby9mhVCYqTLT+Z/a6+FxP6HPOBBb0eEqc0C
 oiR9fMbDGaAOHvDADbfsg8qHt6G0HVy/OJNuzfQkFMBdA4bARIjyFrVb1
 +sK6RCO/kubTquqzsErNheRvh1YXazRyS71clZjKpn5lH87aOgQko9W5Z
 OEewZnDlsiPglM1CrsVYeEKiwx1KO/uM3PROzixRVEgkokA9sorHTGd9M
 wgxWFtdsOsYIxJc9fjs3bf3ze5R6FSUpHg77SIMzsRN0AE/dvqVAftZWp
 L1TegBeWySKcUrX85DhsBD9yA5Ves3eOCFO5wVFzfJHsqZp0CO/DM9y/K Q==;
X-CSE-ConnectionGUID: 0i70jw2+QXmW1+8oNGfbyA==
X-CSE-MsgGUID: fq2mAdU0R4mYEYQqt6KGaA==
X-IronPort-AV: E=McAfee;i="6800,10657,11467"; a="63008769"
X-IronPort-AV: E=Sophos;i="6.16,243,1744095600"; d="scan'208";a="63008769"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2025 08:05:43 -0700
X-CSE-ConnectionGUID: EJ7WXqzzR1ecdIUmyyWTpg==
X-CSE-MsgGUID: aBHDY+fJR4uaJ6JRwNCzPA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,243,1744095600"; d="scan'208";a="152672208"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2025 08:05:36 -0700
...
Subject: [PATCH v14 2/8] mtd: intel-dg: implement region enumeration
Date: Tue, 17 Jun 2025 17:51:52 +0300
Message-ID: <20250617145159.3803852-3-alexander.usyskin@intel.com>

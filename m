...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F8C31916F3
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Mar 2020 17:52:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE2F36E4D0;
	Tue, 24 Mar 2020 16:51:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D92E6E4C9
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Mar 2020 16:51:52 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 24 Mar 2020 17:51:36 +0100
Message-Id: <20200324165146.1032624-11-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/21] drm/i915: Make sure execbuffer always
...
@@ -1145,7 +1145,7 @@ static int context_barrier_task(struct i915_gem_context *ctx,
...
@@ -1238,7 +1238,7 @@ static int pin_ppgtt_update(struct intel_context *ce, struct i915_gem_ww_ctx *ww
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	void *vaddr;
@@ -1086,10 +1087,13 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 		if (err)
 			return ERR_PTR(err);
...
@@ -1125,9 +1129,10 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	if (cache->page == page) {
@@ -1135,7 +1140,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 	} else {
 		vaddr = NULL;
...
@@ -1218,7 +1223,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 		goto err_unmap;
 	}
...
@@ -1372,7 +1377,7 @@ relocate_entry(struct i915_vma *vma,
 	}
...
@@ -1790,6 +1795,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2059,7 +2065,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2070,7 +2077,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2182,16 +2189,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2216,7 +2240,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2227,7 +2251,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2239,20 +2263,36 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2408,7 +2448,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -2853,33 +2893,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2952,9 +2966,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
-err_parse:
 ...
 err_vma:
@@ -3037,7 +3048,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3115,8 +3128,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index bc0ed268ccb8..113d0bda1bcf 100644
...
@@ -302,18 +329,14 @@ __i915_active_call
...
@@ -322,12 +345,6 @@ static int __intel_context_active(struct i915_active *active)
 	}
...
index 3aa8a652c16d..6577b1fc2609 100644
--- a/drivers/gpu/drm/i915/gt/intel_engine_cs.c
+++ b/drivers/gpu/drm/i915/gt/intel_engine_cs.c
@@ -550,7 +550,7 @@ static int pin_ggtt_status_page(struct intel_engine_cs *engine,
 	else
 		flags = PIN_HIGH;
...
index 08efadf616a0..5d42bb195d7d 100644
...
index 310cfc2d5ed8..f4c09a476cab 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3019,7 +3019,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3381,7 +3382,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index 7714de594f5a..c39d73142950 100644
...
index a7ea1d855359..e75d7564963a 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1726,11 +1726,18 @@ static inline void i915_gem_drain_workqueue(struct drm_i915_private *i915)
 }
...
index 1effd4b96459..66e9f4ac9e93 100644
...
index 08699fa069aa..ebec7a12a581 100644
...
index b958ad07f212..da577729931f 100644

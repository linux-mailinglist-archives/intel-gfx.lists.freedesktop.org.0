...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7737F12CFC
	for <lists+intel-gfx@lfdr.de>; Fri,  3 May 2019 13:54:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBCA989D6C;
	Fri,  3 May 2019 11:54:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 733DA89D73
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 May 2019 11:54:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16440750-1500050 
 for multiple; Fri, 03 May 2019 12:52:27 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 May 2019 12:52:21 +0100
Message-Id: <20190503115225.30831-9-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/13] drm/i915/execlists: Don't apply priority
 boost for resets
...
Yy5jCmluZGV4IGFmY2RmYzQ0MGJiZC4uNjQxOWJjYWYxZWNjIDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9n
dC9pbnRlbF9scmMuYwpAQCAtMzcxLDExICszNzEsMTEgQEAgc3RhdGljIHZvaWQgdW53aW5kX3dh
...
Y2tkZXBfYXNzZXJ0X2hlbGQoJmVuZ2luZS0+dGltZWxpbmUubG9jayk7CiAKQEAgLTQxOSw4ICs0
MTksOSBAQCBfX3Vud2luZF9pbmNvbXBsZXRlX3JlcXVlc3RzKHN0cnVjdCBpbnRlbF9lbmdpbmVf
...
IHByaW8pKTsKQEAgLTQzNSw3ICs0MzYsNyBAQCBleGVjbGlzdHNfdW53aW5kX2luY29tcGxldGVf
...
KGVuZ2luZSwgMCk7CiB9CiAKIHN0YXRpYyBpbmxpbmUgdm9pZApAQCAtNjU2LDcgKzY1Nyw4IEBA
...
ICplbmdpbmUpCkBAIC0xOTA5LDcgKzE5MTEsNyBAQCBzdGF0aWMgdm9pZCBfX2V4ZWNsaXN0c19y

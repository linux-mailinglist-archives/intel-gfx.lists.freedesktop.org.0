...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ECEE5C852B0
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Nov 2025 14:25:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5ABCA10E3F0;
	Tue, 25 Nov 2025 13:25:09 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RG/y5asl";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 93E9B10E3F9;
 Tue, 25 Nov 2025 13:25:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764077107; x=1795613107;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=5umhOt5RX5QcYrW1DPcPvVUtzqZXmZLGrUiwn7UE7zo=;
 b=RG/y5aslaGeYqBVbeoORzaR++8kwkaYDiDvbYX0DYfVOyPvwpufYGvX+
 SFtvttTF6qv/BFhs+pVKl+iN1UaO7xyB6cDdie5FdZftv7k3W7LNAyAOq
 QNWX7s6kNMiW1hRpgDfDjb2jCRlxrToypigasTMVP7YZjHFxsq6M9yt5E
 CElOVhCYGHiPLKgCQSfwjxDxPqpelx45PFQZsKBIyMHTw/GRXJJrblNy0
 wmdygLT2YKoMB9AI8YIJxwp5QO8MUc0P8XLc7jMl4irtXZsiwp6XG0OxQ
 L7DfVPG56B2LmTea6axpz1Q5Q671Ib15GnkqA13qcZvGrN+kz2XJH374c g==;
X-CSE-ConnectionGUID: cXNzE/cXRL+RTso1Dj/8Xg==
X-CSE-MsgGUID: 6XMHgxPIQW+8w9jfUxL46A==
X-IronPort-AV: E=McAfee;i="6800,10657,11623"; a="53662843"
X-IronPort-AV: E=Sophos;i="6.20,225,1758610800"; d="scan'208";a="53662843"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2025 05:25:07 -0800
X-CSE-ConnectionGUID: f75ZOF3yQceYHxbVJTrY0g==
X-CSE-MsgGUID: gev7LgIWSRGcZJzbz6MFZw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,225,1758610800"; d="scan'208";a="197117926"
Received: from ettammin-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.213])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2025 05:25:05 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH v2 4/5] drm/i915/power: convert intel_wakeref_t to struct
 ref_tracker *
Date: Tue, 25 Nov 2025 15:24:42 +0200
Message-ID: <f182bd26d5f9a00e843246d4aac8b25ff7531c51.1764076995.git.jani.nikula@intel.com>

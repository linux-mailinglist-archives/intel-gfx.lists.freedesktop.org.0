...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36D25465876
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Dec 2021 22:40:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6787B6E911;
...
Subject: [Intel-gfx] [PATCH v4 2/6] drm: improve drm_buddy_alloc function

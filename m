...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C1C44B872B
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Feb 2022 12:54:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38A1A10EA34;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/guc: Initialize GuC submission
 locks and queues early

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A27DC9F271
	for <lists+intel-gfx@lfdr.de>; Wed, 03 Dec 2025 14:36:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E89B310E123;
	Wed,  3 Dec 2025 13:36:16 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="HDR5n6w3";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6A72410E123;
 Wed,  3 Dec 2025 13:36:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764768976; x=1796304976;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=D4wpFHPA+FGGUzUx1VmzoaeL9TkCmQVcOmbY0jYZGiM=;
 b=HDR5n6w3PxqHrqWzl2eMRVDlgqUABvJLOEbloR/cnCQy58Ai5iG+du+A
 Wy/bLEkmHwySBNDI1KehRmEdx6uD+DNhbrYQvSR2G/7SfPoYT8vtH1jTF
 zdK0PTTdoXT6QfJhdwJyia2T8JdSE65rV2e0tGnJb+a32AJrM1P7XaUMf
 gT1t4iVh1N94+Sn9hUzSGuuhtnqXhCHo9n2bWaNhNnuTOXhBuCd/Sm/0b
 H96eENI4i4giXAz+k/U75tRjx438Wiw9IwaBvFQmF5Op/u6cI6fazAPFX
 H8bcc/ZRe3rLk29IExowyqB/iH3VcceME4+/hgT68kvuZdfUS/vC5bO/w A==;
X-CSE-ConnectionGUID: UNAiyBGLT5az4DTLbSsiIQ==
X-CSE-MsgGUID: kyCkoBE/RZqpqmcvfj8Gvg==
X-IronPort-AV: E=McAfee;i="6800,10657,11631"; a="84353553"
X-IronPort-AV: E=Sophos;i="6.20,246,1758610800"; d="scan'208";a="84353553"
Received: from orviesa007.jf.intel.com ([10.64.159.147])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Dec 2025 05:36:16 -0800
X-CSE-ConnectionGUID: ZSt/L78JTma6XSExcNMW/A==
X-CSE-MsgGUID: 72Zg5L9nQfmljVMQepAE/g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,246,1758610800"; d="scan'208";a="194707155"
Received: from mjarzebo-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.226])
 by orviesa007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Dec 2025 05:36:12 -0800

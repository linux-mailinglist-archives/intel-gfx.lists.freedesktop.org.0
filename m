...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BDD84DA77C
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Mar 2022 02:48:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F387E10E4EB;
	Wed, 16 Mar 2022 01:48:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B6C2D10E4AA
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=2Zd1jc7CEGYgAw1LWQWykbY/gCSQ5+Q31Ls91hZGc6A=;
 b=Ylne3irsx05ZxZUPSiuHixLZdI3/LXkI+YYP8aYNLmTzgXgwkWWRqpIH
 tgW+wHne7SDcd/n6D3WbRlOC1x9ZH7kqh4mkcz1nhT7G5vZ6NobdRllnN
 flGuNCXL2viIGOLIod7EIMopqod4ykrqwdDQ0dkFQ8ViHOKObU+x0U7z9
 r8/rVL62UljsHCT2w80qXXG/K1seQam5VSCp2JjY9TIk/pCHqMk8SGlRX
 gWPnMQEf9sru/zzGz2by6p/W1cOg46yRNdrC5gWW+Qr3OxnLqvzwSI9xQ
 KOI5P6V+OsVzy/9NMf5Ay6ZFTtMhJj5qC6OweTALkFc0Lzbl/9a47Yphj Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10286"; a="255294151"
X-IronPort-AV: E=Sophos;i="5.90,185,1643702400"; d="scan'208";a="255294151"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2022 18:47:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,185,1643702400"; d="scan'208";a="634804827"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by FMSMGA003.fm.intel.com with ESMTP; 15 Mar 2022 18:47:58 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 15 Mar 2022 18:50:22 -0700
Message-Id: <20220316015025.1664860-11-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 10/13] drm/i915/guc: Extract GuC error

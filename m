...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7894124ED9
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Dec 2019 18:10:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01C9F894FF;
	Wed, 18 Dec 2019 17:10:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9B2E4894FF
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Dec 2019 17:10:23 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga102.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 18 Dec 2019 09:10:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,330,1571727600"; d="scan'208";a="227944912"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga002.jf.intel.com with SMTP; 18 Dec 2019 09:10:20 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 18 Dec 2019 19:10:20 +0200
Date: Wed, 18 Dec 2019 19:10:20 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: =?iso-8859-1?Q?Jos=E9?= Roberto de Souza <jose.souza@intel.com>
Message-ID: <20191218171020.GP1208@intel.com>
References: <20191216220742.34332-1-jose.souza@intel.com>
 <20191216220742.34332-10-jose.souza@intel.com>
 <20191218170019.GO1208@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20191218170019.GO1208@intel.com>
...
On Wed, Dec 18, 2019 at 07:00:19PM +0200, Ville Syrj=E4l=E4 wrote:
...
> > @@ -13941,19 +13941,6 @@ static void intel_crtc_check_fastset(const str=
...
tate,
> > @@ -14121,6 +14108,56 @@ static int intel_atomic_check(struct drm_devic=
e *dev,
> >  			any_ms =3D true;
> >  	}
> >  =

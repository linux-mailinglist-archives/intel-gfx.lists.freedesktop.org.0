...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D68358B58B
	for <lists+intel-gfx@lfdr.de>; Sat,  6 Aug 2022 14:34:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EB0CBF3AB;
	Sat,  6 Aug 2022 12:32:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6DD4FC180F
 for <intel-gfx@lists.freedesktop.org>; Sat,  6 Aug 2022 12:27:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1659788872; x=1691324872;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=bsHTh1or5oUlcUiLU0Rwr68aJ84RgrbD6+nBhXY2h2Q=;
 b=N6N4vu9BqQKnzoQ9+H8+XgfekBAOhhKgG+/9/hf82R90paMzToXermoP
 7sVL1sqaXKq9s1xT30TgHFXPnvjxNX0bF+JGxZ139d34fHdvtMPHYeAeB
 OdihTr8NlfBMLlB5eeV5C0A33WAFjIezYh95D15kRaPyvLfM94l7Hqufb
 IRgRUrXdYw8gmkHHlQn+ytqx1OF3WLSWOPfEohgwBwvR2Mn0/aQDILOMo
 BLC9B/wOwJKSHyj0gXPeJDcu6NMu40w4RS0uVACClgmMr028JXbum57uz
 DpD/vpSDJp7DCMluycqxlLYm91mmIoS93MJVYBV0giRppP3IEKck1FtXM Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10430"; a="376658394"
X-IronPort-AV: E=Sophos;i="5.93,217,1654585200"; d="scan'208";a="376658394"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Aug 2022 05:27:51 -0700
X-IronPort-AV: E=Sophos;i="5.93,217,1654585200"; d="scan'208";a="632329127"
...
Date: Sat,  6 Aug 2022 15:26:32 +0300
Message-Id: <20220806122636.43068-12-tomas.winkler@intel.com>
X-Mailer: git-send-email 2.37.1
In-Reply-To: <20220806122636.43068-1-tomas.winkler@intel.com>
References: <20220806122636.43068-1-tomas.winkler@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v7 11/15] mei: gsc: setup gsc extended
 operational memory

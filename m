...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C916529434
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:57:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C1EF10EB2B;
...
Subject: [Intel-gfx] [PATCH v2 12/27] dyndbg: change zero-or-one classes-map
 to maps list

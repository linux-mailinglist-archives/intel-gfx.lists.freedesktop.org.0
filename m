...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0E4A12E99E
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Jan 2020 19:00:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 58A1E6E126;
...
Subject: [Intel-gfx] [PATCH] drm/i915: remove boolean comparisons in
 conditionals.

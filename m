...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E9DA70F707
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 14:58:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF48410E673;
	Wed, 24 May 2023 12:58:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5AF2010E673;
 Wed, 24 May 2023 12:58:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684933129; x=1716469129;
 h=date:from:to:cc:subject:message-id:references:
 content-transfer-encoding:in-reply-to:mime-version;
 bh=qP2S/8LmAC6zT/JQPGj+Brg0SRXvvB22oAeD3sziXLk=;
 b=YC0jr0SZ08NHtHEqU6Y+bnfpH+NqiPCxbNq9nLBsbZ7HBYzATBubj9QL
 Y9seg23BWeMBgFAztnb/FEECPwTwrO1c9Dlai1XTcCUQLghlEyCwKp54/
 Och5TVLFfiU08EMUFfjuNguG6oNV2V5yW2Bo3X8NeiqQ0Tyxu6HLQIk5T
 l/Cu8Jum0dwS/MxsM/snFyaHKMVLN3IG+TpxN3QPs6Lb2MRgke8WhdLAo
 eLuQIoDCzB9CETCAylqskUdz62FKaicfZefoFA1/bs04ewa09mu4ESSxk
 YwGqgiEvv7Nh1eT7e+8fpC/Pd/hfDgoYieqHXkmxjRBo3BgZzb1X5KBvT w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="333177604"
X-IronPort-AV: E=Sophos;i="6.00,189,1681196400"; d="scan'208";a="333177604"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 05:58:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="704337566"
X-IronPort-AV: E=Sophos;i="6.00,189,1681196400"; d="scan'208";a="704337566"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
 by orsmga002.jf.intel.com with ESMTP; 24 May 2023 05:58:12 -0700
Received: from fmsmsx611.amr.corp.intel.com (10.18.126.91) by
 fmsmsx601.amr.corp.intel.com (10.18.126.81) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.23; Wed, 24 May 2023 05:58:12 -0700
Received: from fmsmsx603.amr.corp.intel.com (10.18.126.83) by
 fmsmsx611.amr.corp.intel.com (10.18.126.91) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.23; Wed, 24 May 2023 05:58:11 -0700
Received: from fmsedg602.ED.cps.intel.com (10.1.192.136) by
 fmsmsx603.amr.corp.intel.com (10.18.126.83) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.23 via Frontend Transport; Wed, 24 May 2023 05:58:11 -0700
Received: from NAM10-BN7-obe.outbound.protection.outlook.com (104.47.70.102)
 by edgegateway.intel.com (192.55.55.71) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.23; Wed, 24 May 2023 05:58:09 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=Ln32pxJk2yjyl7h/qesCNwadyooG1Gcv3N0ONihIuIg=;
 b=
...
Received: from MN0PR11MB6059.namprd11.prod.outlook.com
 ...
 ([fe80::f7ec:aae9:1e7b:e004%6]) with mapi id 15.20.6411.028; Wed, 24 May 2023
 12:57:50 +0000
Date: Wed, 24 May 2023 08:57:41 -0400
From: Rodrigo Vivi <rodrigo.vivi@intel.com>
To: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
Message-ID: <ZG4JxY51Lg3QxEvC@intel.com>
References: <d19f748c-2c5b-8140-5b05-a8282dfef73e@linux.intel.com>
Content-Type: text/plain; charset="iso-8859-1"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <d19f748c-2c5b-8140-5b05-a8282dfef73e@linux.intel.com>
...
X-MS-TrafficTypeDiagnostic: MN0PR11MB6059:EE_|SJ0PR11MB5895:EE_
X-MS-Office365-Filtering-Correlation-Id: ccf4fb20-e425-49fe-ba4d-08db5c567900
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:MN0PR11MB6059.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230028)(366004)(396003)(346002)(136003)(39860400002)(376002)(451199021)(19627235002)(86362001)(8936002)(8676002)(54906003)(478600001)(6666004)(41300700001)(6486002)(5660300002)(316002)(7416002)(44832011)(6512007)(6506007)(45080400002)(66476007)(66556008)(66946007)(6916009)(4326008)(26005)(83380400001)(2616005)(186003)(30864003)(2906002)(38100700002)(66574015)(36756003)(82960400001)(95444003)(559001)(579004);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?Qz3oKM2qXJGQGk5bQZZIgmqhmxHlpFcPE8hwEe5ygzFu8Se0aUAZN62evr?=
 =?iso-8859-1?Q?L8Q3CxRzYb5V1nYBuIVoATFkWyZ05a9RywQTO+9Y1Y4TvOR+Z/MGAkTD1f?=
 =?iso-8859-1?Q?ba02xui3yWsJ10ScZWtU7meBwNVqe9wvMOZSC7ktybg6jDImPBNrYty7KF?=
 =?iso-8859-1?Q?PdotKQUmarS60OLt35/UxWhbpZ/FmOHKe6HyBLARTiT2EMMbqlxBFhkYkO?=
 =?iso-8859-1?Q?jtBIWd8lxpNAlifzxSL3b6RPupsec4IWy/Mo9l2qCC9UF8q01h1i93uldv?=
 =?iso-8859-1?Q?SaUij0O9+HKoDkS7kDDAEw8L7QgM8jOjuKPS03rTWiwL1YVpg1kQxqAK9M?=
 =?iso-8859-1?Q?czsRWseOMjuMWtagyxWsBhYvDxLWEEjnlZtF2ifhPGP/nXboH5DwgvEezg?=
 =?iso-8859-1?Q?Pp/Nw7d8vFN14ePxyRCCX6ZI4q6jv6L6sEn6DTN7X3n1l51dxodWTSx8YY?=
 =?iso-8859-1?Q?DZoNeCx/bK28cPQ1dzF/sgl0eliuKFwVh7VK8+SIxHoUC2OYipaccH0GY9?=
 =?iso-8859-1?Q?FMDMEUH4rur9KMbmLodoWVlYFJTgfjMZ/5ptoiYvChf+GjrgznWAlqq8/o?=
 =?iso-8859-1?Q?Ui0ttONVSIPyraW6lMUuUE8kuFO75XMo+haGpYLaEgpwVA7STDV3+zuvS/?=
 =?iso-8859-1?Q?Ld+1rtkuZZfOu13+vmTIFkpTiTvKnFDj/bS1Gydf1oufhQnZha6syubrHS?=
 =?iso-8859-1?Q?AJxys3bgoIYrLmtSVvOIyHy7O4gsw0EwvxdKCMCdwUELPWrnTHDd+DA8Of?=
 =?iso-8859-1?Q?P98sUXvl6DoQnViE5VxivYicGW/IkEp+Zh3pGxPvAUc88H8rTz1xS+7SUi?=
 =?iso-8859-1?Q?OUD4mQAnOF6zY5GEI6MibeaQQKSD5qkF4F6Vr19mYJW6QSn6cxjpDWnmLI?=
 =?iso-8859-1?Q?cSJCRqoN2d8RXYGu3QppR9UDYghppJXoOg+c8jEXoEbP2nyabyyW1Ktaj5?=
 =?iso-8859-1?Q?5chj7Nok34pUMuQayXo9zmDAbov2/o4nxC7nHmAJD0DQaGsYfGVZdoZcaT?=
 =?iso-8859-1?Q?cn9seNZrqT+SodPWBrMr9lHYEwam/Rh9kLcPdMvqU07+HOWJT2NYYZQV91?=
 =?iso-8859-1?Q?4W2VfJ+Zcte/CxereFWiDJdkVuDFXuwMy4xXNCXuQg4Zbhm3/Ku75AgWzc?=
 =?iso-8859-1?Q?J6aakTbn/zucKKGJnmqQgbri5rVQPkuweZF4An/jqi+UC8G+lXatKUncVm?=
 =?iso-8859-1?Q?D052HDfamijfci0LUPlh8/YOy3vq0Z7oez9Fs07J+sgoLJI6LquDXTv7T8?=
 =?iso-8859-1?Q?NozJjo5biDKjH+w6uNN3i1HSMWVC7Am2iC8t1VYwn/URKnFcgiC006kiEB?=
 =?iso-8859-1?Q?0EIZ7CExZS+i2kD5cuS+2Sh2xQfRKjvqaXbPAdluJBAbnRuYNwruRqclgF?=
 =?iso-8859-1?Q?iamz+sBOtbtDt3dIUPc+XQx6OaxXU/527N7+0972CkvLYgQacKN5Qf5zCs?=
 =?iso-8859-1?Q?N4ooOo7UhQvPVK31mHiej5h7E2IHEaQBwPm+04tTf8ywV3valuH5/yQj16?=
 =?iso-8859-1?Q?sV5xJeFTJvUmVXxC7Pd2J3inc+ufAxIdwUpUa01v/7JeSt2uf0brZanhhx?=
 =?iso-8859-1?Q?8oOBAlrn27pI6h38AegrgmEMZYKFGY3D6MhFbKP6UDVnkLb1SOR1pGL3Jh?=
 =?iso-8859-1?Q?Iqfe3igULosERaMl8R6i3/sHoXlTXEdgja?=
X-MS-Exchange-CrossTenant-Network-Message-Id: ccf4fb20-e425-49fe-ba4d-08db5c567900
X-MS-Exchange-CrossTenant-AuthSource: MN0PR11MB6059.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 May 2023 12:57:50.5528 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: BpLDtQy8RkvN9OGq9lEpr06j1vqziC75nUkx6H3yDkvcuZlRb1A0Mi5f7lrxWDboxc+qeyEThey1E6riKZusmQ==

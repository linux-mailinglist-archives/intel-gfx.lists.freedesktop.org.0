...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0802A6D3248
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 17:19:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D607E10E2D1;
...
Subject: [Intel-gfx] [PATCH v9 24/25] vfio: Compile group optionally

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EE8C40EC7C
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Sep 2021 23:26:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8ACEB6E994;
...
Subject: [Intel-gfx] [PATCH 14/15] drm/amd: cleanup: drm_modeset_lock_all()

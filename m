...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EE992D6AD6
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 23:56:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DC276EB8F;
...
Subject: Re: [Intel-gfx] [patch 18/30] PCI: xilinx-nwl: Use

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D6EB0716A57
	for <lists+intel-gfx@lfdr.de>; Tue, 30 May 2023 19:01:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A83A10E39E;
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/selftest/gsc: Ensure GSC Proxy init

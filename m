...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36A8D6240E6
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Nov 2022 12:09:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 08CFB10E6F8;
...
Subject: [Intel-gfx] [PATCH v8 12/24] drm/connector: Add a function to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E1E1918F355
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2020 12:04:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46B6589F6F;
	Mon, 23 Mar 2020 11:04:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4A7E789F6F
 for <intel-gfx@lists.freedesktop.org>; Mon, 23 Mar 2020 11:04:43 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20659065-1500050 
 for multiple; Mon, 23 Mar 2020 11:04:36 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 23 Mar 2020 11:04:35 +0000
Message-Id: <20200323110435.22558-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20200323092841.22240-7-chris@chris-wilson.co.uk>
References: <20200323092841.22240-7-chris@chris-wilson.co.uk>
MIME-Version: 1.0

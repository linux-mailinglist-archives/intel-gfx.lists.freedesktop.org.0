...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D181C76C27C
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Aug 2023 03:50:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B474610E47F;
...
Subject: Re: [Intel-gfx] [PATCH v4.1] drm/i915/gvt: Explicitly check that

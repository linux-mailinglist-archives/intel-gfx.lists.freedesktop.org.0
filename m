...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 429EC2DDB05
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Dec 2020 22:49:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0376F894D7;
	Thu, 17 Dec 2020 21:49:46 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3E6B089A35
 for <Intel-gfx@lists.freedesktop.org>; Thu, 17 Dec 2020 21:49:35 +0000 (UTC)
IronPort-SDR: a1A0ATvVuioeH8XTkGA8BnvqkZqJmUhYPeCYEtsppJgD5Ep8qqkV0mbMnhz6CBJ0WXkZXIpZzx
 PNckBt5jNYjw==
X-IronPort-AV: E=McAfee;i="6000,8403,9838"; a="236906274"
X-IronPort-AV: E=Sophos;i="5.78,428,1599548400"; d="scan'208";a="236906274"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Dec 2020 13:49:31 -0800
IronPort-SDR: PxOLYoixoRLFhni1p4qKJw4E+d8SPNQ8CtgPMwC4bxV742MSAaZ9y9cL23uzGoEYm1PMQHVkIs
 mxXBkSuw62ow==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,428,1599548400"; d="scan'208";a="342780460"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga006.jf.intel.com with ESMTP; 17 Dec 2020 13:49:31 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 17 Dec 2020 13:49:25 -0800
Message-Id: <20201217214931.13340-8-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201217214931.13340-1-sean.z.huang@intel.com>
References: <20201217214931.13340-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v11 07/13] drm/i915/pxp: Destroy arb session upon
 teardown
...
@@ -157,3 +178,102 @@ int intel_pxp_cmd_submit(struct intel_pxp *pxp, u32 *cmd, int cmd_size_in_dw)

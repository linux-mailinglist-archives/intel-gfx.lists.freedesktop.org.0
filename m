...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC7146FC60A
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 14:15:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 668A810E0A5;
	Tue,  9 May 2023 12:15:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1315410E021;
 Tue,  9 May 2023 12:15:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683634511; x=1715170511;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=Y7V+gv9Ern9QRl8YohLXgK4kAQd/jZlgzeQ4znT6Tko=;
 b=ODxY7JKvN5MPSZzvTbpgzTGvKPMrpPTqNQnnHn6Uiv6Jk7KU4D0tn9iL
 boeJZ/cOZ5iYPtsE/03+nckJi1CdDMdccOIDZtrFER5dv6RbqIApfrxJ0
 rAkj/Xr6p2iUeUvOFl+1hX1dFhCPblG6KUMKxs+AvGy8Yr1L3Bo6tLwwD
 +90FJgDpKMxo3q7ShpAc3VTf5V3tvQZLqjJJSndjx3cFw4rvIeJjXtfrN
 wrtEkVoSp4+gZSwb5M2t0MtS1llH5YRtbenkuOyOPQmXcLAZTWnCCFwvc
 CfsEhGpkSdv4CrcS+YpP3X8gSFtRibH2e4n2jYOJAuHXA6lUOC9PopcA2 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="436224745"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="436224745"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 05:15:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="701822180"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="701822180"
Received: from ttmorgan-mobl.ger.corp.intel.com (HELO [10.213.213.191])
 ([10.213.213.191])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 05:15:06 -0700
Message-ID: <1eba1d94-427e-c8fe-9d58-69b52d1545e4@linux.intel.com>
Date: Tue, 9 May 2023 13:15:04 +0100
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 30B627A59EA
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Sep 2023 08:25:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2CFD10E251;
	Tue, 19 Sep 2023 06:25:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98BF710E112;
 Tue, 19 Sep 2023 06:25:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1695104728; x=1726640728;
 h=date:from:to:cc:subject:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=TWFXfU0+hHGGo8PgAZavkRd/ygKdBTHNxxMy3sDREac=;
 b=lvO7IwgtqF4oSSVfK4MB8IErABrSz1zG3YXhLaMVOx/BoFlGHssQSwnk
 b7rQo+C1rzsnABGYYAI3D5AxvsqwQLxYGVbpcWfwewSSi0SDnlYwNDFvM
 m6xAcOK0/yDLnskeqsrFQjkxb6rg3+qgRafKd8xG7xpdMRNMb6Zc/BqZO
 CXGA+X4wjZ0bxra6hRD9ZitLt4+TFdOMeUyUKcm/PbeF5Lrpp0mmjt++Z
 ooanw5kOaxMU4d9rJU8WO+YFLCxhN5tfijzcP46oChzvrlw84GN94CkgF
 EScEO9uC3J5H7eHXLVviJaFJGkZhaz92qrH2iECqvDJxpoKysfCdX2KiR w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10837"; a="466193843"
X-IronPort-AV: E=Sophos;i="6.02,158,1688454000"; d="scan'208";a="466193843"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2023 23:25:27 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10837"; a="919746313"
X-IronPort-AV: E=Sophos;i="6.02,158,1688454000"; d="scan'208";a="919746313"
Received: from linux.intel.com ([10.54.29.200])
 by orsmga005.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2023 23:25:26 -0700
Received: from maurocar-mobl2 (aalfero-mobl2.ger.corp.intel.com
 [10.252.25.249])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by linux.intel.com (Postfix) with ESMTPS id 427E8580DAE;
 Mon, 18 Sep 2023 23:25:25 -0700 (PDT)
Date: Tue, 19 Sep 2023 08:25:22 +0200
From: Mauro Carvalho Chehab <mauro.chehab@linux.intel.com>
To: Janusz Krzysztofik <janusz.krzysztofik@linux.intel.com>
Message-ID: <20230919082522.5fc80c25@maurocar-mobl2>
In-Reply-To: <20230918134249.31645-24-janusz.krzysztofik@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DABABA33DFE
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Feb 2025 12:27:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7086510EA7A;
	Thu, 13 Feb 2025 11:27:13 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="GkxNKkmn";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9399410EA86
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Feb 2025 11:27:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1739446031;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=1wqsTTOvQM7BrWYKS6CkT4Uf08xeE2cALApyEMlXy3Q=;
 b=GkxNKkmnOqSitLRdNSS9qO4wcYyJJXUZ7WSiJw3t3ukZKTWdtU/Sb3rSOnMoAy501IHlzP
 4a5tASLycUNkkdOpVLJ7h28VSobJLUL3J7uby1WfA0KGB3ij3QIDFZhe7+b0lWwo82Hasm
 TEZcW1mX6drSzBHyCRxhwSTfJDgiriQ=
...
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 4ADD618D95DC; Thu, 13 Feb 2025 11:27:06 +0000 (UTC)
Received: from hydra.redhat.com (unknown [10.45.225.79])
 by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id C0185300018D; Thu, 13 Feb 2025 11:27:02 +0000 (UTC)

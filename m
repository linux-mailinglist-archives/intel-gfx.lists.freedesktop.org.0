...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BD66525D847
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Sep 2020 14:01:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C219A6E26C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 7/7] drm/i915: Enable async flips in i915

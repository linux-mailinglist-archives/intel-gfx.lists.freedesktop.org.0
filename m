...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFA494A80DC
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Feb 2022 10:04:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C689210E9BA;
...
Subject: [Intel-gfx] [PATCH v2 2/8] drm/dp: add 128b/132b link status
 helpers from DP 2.0 E11

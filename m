...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FC7B3C8A2B
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Jul 2021 19:52:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C5276E466;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 2/5] drm_print.h: rewrap

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 775425B5143
	for <lists+intel-gfx@lfdr.de>; Sun, 11 Sep 2022 23:17:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A02010E530;
	Sun, 11 Sep 2022 21:17:21 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 0/3] drm: Use full allocated minor range for
 DRM

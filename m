...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BB9D14F7FBB
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Apr 2022 15:00:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18C9110EB18;
	Thu,  7 Apr 2022 13:00:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2F45410EB0E
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 Apr 2022 13:00:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1649336413; x=1680872413;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PNb+/xiehX/7uIkJ1zKWm+EG1KxQy+hDFZDfI5dC5F4=;
 b=AWXLOkBVGKHog2FQWJdkZTRnKl1KGgyKONqTwUH8fGEGehZqvxZHclAB
 DQvGufiHuCDvwiUl0UriIQkH5A16MIsGOyke1pL/AjWHWgQgCZf+Qs4AP
 42IotJYrHW1WDYBusgKFOt5D4vDK8GcTCBGDukYrjQ8ecs/zmvE2susC1
 STIfTHWxx+ed87hvp+8v1a43YLgshneZHuUcYP6d/XkQkxwkNXqsXceEe
 WmHBaDi/AGZn3G4/oMbYzRzUl1FAxOU/onlTy9EiDNGfXYkG60dW2TEih
 enJO15Ai0dkXBZeCCyfQasDdTaZpHn2gndEmwXFecOYjJL+vySRizWOcZ w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10309"; a="324475917"
X-IronPort-AV: E=Sophos;i="5.90,242,1643702400"; d="scan'208";a="324475917"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2022 06:00:10 -0700
X-IronPort-AV: E=Sophos;i="5.90,242,1643702400"; d="scan'208";a="571041028"
Received: from sannilnx.jer.intel.com ([10.12.231.73])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2022 06:00:01 -0700
...
Date: Thu,  7 Apr 2022 15:58:30 +0300
Message-Id: <20220407125839.1479249-12-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH 11/20] mei: gsc: use polling instead of
 interrupts

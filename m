...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EF736FCC12
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 18:59:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCD9710E3AA;
	Tue,  9 May 2023 16:58:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 46DED10E3A7;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=PE5SuZAowEi4+4VcjTrPa3U4q8b2dZ5bTSAE7+7hc/xA1F6260ME9Wx9
 wwhZFoP/3B/Bq1U7/EP74vSw+QSzWuAvAYKQshpwV+24vH9jIy/Q5e5QB
 mbsYm6Jc+denV+TBVEgbcT299kaHFzdhcyUMp2u1Wd1jN9EtJPcPF92k+
 HBA7eZbSGzlK37XkMHsBOG/Yg2i4Y4XLxz/wC3UmLWnbGOomzrmEAdEtS
 hMiHxmt0QBTsIJmlN7tawgcWsNTGoRZ40ZvgmQ7yQYeDQ7QSLUPYy5x59
 aDy6eWJ4aMl0e6/2TegC5tW5qhqM7LhkxaFiy1KQ50Tg+pRM92EetO7Zk w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="350021116"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="350021116"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:58:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="649408808"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="649408808"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:58:47 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Tue,  9 May 2023 09:59:39 -0700
Message-Id: <20230509165942.2155-2-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230509165942.2155-1-fei.yang@intel.com>
References: <20230509165942.2155-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v7 1/4] drm/i915: preparation for using PAT index

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B4FC7149F87
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Jan 2020 09:10:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0591C6EA1F;
	Mon, 27 Jan 2020 08:10:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 681B06EA21;
 Mon, 27 Jan 2020 08:10:25 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 27 Jan 2020 00:10:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,369,1574150400"; 
 d="scan'208,217";a="304560146"
Received: from plaxmina-desktop.iind.intel.com ([10.145.162.62])
 by fmsmga001.fm.intel.com with ESMTP; 27 Jan 2020 00:09:58 -0800
...
To: jani.nikula@linux.intel.com, daniel@ffwll.ch,
 ...
 Daniel Drake <drake@endlessm.com>, Mahesh Kumar <mahesh1.kumar@intel.com>,
 Ramalingam C <ramalingam.c@intel.com>,
 Juha-Pekka Heikkila <juhapekka.heikkila@gmail.com>,
 Rajat Jain <rajatja@google.com>, Wambui Karuga <wambui.karugax@gmail.com>,
 Matthew Auld <matthew.auld@intel.com>,
 Dhinakaran Pandiyan <dhinakaran.pandiyan@intel.com>,
 Harry Wentland <harry.wentland@amd.com>,
 David Francis <David.Francis@amd.com>
Date: Mon, 27 Jan 2020 13:26:51 +0530
Message-Id: <20200127075653.8523-3-pankaj.laxminarayan.bharadiya@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 2/4] drm/i915/display: Make WARN* drm
...
---
 ...
 35 files changed, 524 insertions(+), 403 deletions(-)
...
index f9f4460136b0..09881eeeca4c 100644
--- a/drivers/gpu/drm/i915/display/intel_audio.c
+++ b/drivers/gpu/drm/i915/display/intel_audio.c
@@ -569,7 +569,7 @@ static void ilk_audio_codec_disable(struct intel_encoder *encoder,
...
@@ -620,7 +620,7 @@ static void ilk_audio_codec_enable(struct intel_encoder *encoder,
 		    encoder->base.base.id, encoder->base.name,
...
+	if (drm_WARN_ON(&dev_priv->drm, port == PORT_A))
 	...
 	/*
@@ -815,7 +815,7 @@ static void glk_force_audio_cdclk(struct drm_i915_private *dev_priv,
...
@@ -836,7 +836,7 @@ static void glk_force_audio_cdclk(struct drm_i915_private *dev_priv,
 		goto retry;
 	}
...
@@ -924,7 +924,7 @@ static int i915_audio_component_get_cdclk_freq(struct device *kdev)
 {
...
@@ -947,7 +947,8 @@ static struct intel_encoder *get_saved_enc(struct drm_i915_private *dev_priv,
...
@@ -1066,10 +1067,12 @@ static int i915_audio_component_bind(struct device *i915_kdev,
...
index 1e675aa55938..6ae6216c13f9 100644
...
+		drm_WARN_ON(&dev_priv->drm, ret > 0xf);
 		...
 		drm_dbg_kms(&dev_priv->drm, "Panel type: %d (OpRegion)\n",
 			    panel_type);
@@ -1246,7 +1246,8 @@ static int get_init_otp_deassert_fragment_len(struct drm_i915_private *dev_priv)
...
@@ -2303,7 +2304,8 @@ bool intel_bios_is_port_present(struct drm_i915_private *dev_priv, enum port por
 	}
...
@@ -2553,7 +2555,7 @@ intel_bios_is_port_hpd_inverted(const struct drm_i915_private *i915,
...
index 50d235d037a1..ed5bb9391f9e 100644
...
@@ -841,15 +844,16 @@ static void skl_dpll0_update(struct drm_i915_private *dev_priv,
...
@@ -951,7 +955,7 @@ static void skl_dpll0_enable(struct drm_i915_private *dev_priv, int vco)
 {
 	u32 val;
...
@@ -1014,7 +1018,8 @@ static void skl_set_cdclk(struct drm_i915_private *dev_priv,
...
@@ -1029,8 +1034,9 @@ static void skl_set_cdclk(struct drm_i915_private *dev_priv,
...
+		drm_WARN_ON(&dev_priv->drm, vco != 0);
 	...
 	case 308571:
 	case 337500:
@@ -1232,8 +1238,9 @@ static int bxt_calc_cdclk(struct drm_i915_private *dev_priv, int min_cdclk)
...
@@ -1250,8 +1257,8 @@ static int bxt_calc_cdclk_pll_vco(struct drm_i915_private *dev_priv, int cdclk)
 		    table[i].cdclk == cdclk)
...
@@ -1384,15 +1391,17 @@ static void bxt_get_cdclk(struct drm_i915_private *dev_priv,
 		div = 2;
 		break;
...
+			 "Unsupported divider\n");
 		...
 		break;
 	default:
@@ -1532,22 +1541,25 @@ static void bxt_set_cdclk(struct drm_i915_private *dev_priv,
...
@@ -1861,15 +1873,16 @@ static void intel_set_cdclk(struct drm_i915_private *dev_priv,
...
@@ -2475,7 +2488,7 @@ void intel_update_max_cdclk(struct drm_i915_private *dev_priv)
 		int max_cdclk, vco;
...
@@ -2728,8 +2741,8 @@ void intel_init_cdclk_hooks(struct drm_i915_private *dev_priv)
...
index 6659e9aed6ff..6357637d3caa 100644
...
@@ -3500,9 +3506,10 @@ static void hsw_ddi_pre_enable_dp(struct intel_encoder *encoder,
...
@@ -3638,7 +3645,7 @@ static void intel_ddi_pre_enable(struct intel_encoder *encoder,
...
@@ -3908,9 +3915,9 @@ gen9_chicken_trans_reg_by_port(struct drm_i915_private *dev_priv,
 		[PORT_E] = TRANSCODER_A,
 	};
...
@@ -4230,7 +4237,7 @@ void intel_ddi_get_config(struct intel_encoder *encoder,
 	u32 temp, flags = 0;
...
@@ -4527,7 +4534,8 @@ static int intel_hdmi_reset_link(struct intel_encoder *encoder,
...
+		    !intel_crtc_has_type(crtc_state, INTEL_OUTPUT_HDMI));
 	...
 	if (!crtc_state->hw.active)
 		return 0;
@@ -4776,7 +4784,7 @@ void intel_ddi_init(struct drm_i915_private *dev_priv, enum port port)
...
index 07052f81b0d1..a9d3061b7251 100644
...
+		    I915_READ(FDI_RX_CTL(PIPE_C)) & FDI_RX_ENABLE);
 	...
 	if (enable)
@@ -6196,7 +6202,8 @@ static void skl_pfit_enable(const struct intel_crtc_state *crtc_state)
...
@@ -6806,7 +6813,7 @@ static void ilk_crtc_enable(struct intel_atomic_state *state,
...
+	if (drm_WARN_ON(&dev_priv->drm, crtc->active))
 	...
 	/*
@@ -6952,7 +6959,7 @@ static void hsw_crtc_enable(struct intel_atomic_state *state,
...
@@ -7145,7 +7152,7 @@ static void i9xx_pfit_enable(const struct intel_crtc_state *crtc_state)
...
@@ -7340,7 +7347,7 @@ static void valleyview_crtc_enable(struct intel_atomic_state *state,
 	struct drm_i915_private *dev_priv = to_i915(crtc->base.dev);
 	enum pipe pipe = crtc->pipe;
...
@@ -7404,7 +7411,7 @@ static void i9xx_crtc_enable(struct intel_atomic_state *state,
 	struct drm_i915_private *dev_priv = to_i915(crtc->base.dev);
 	enum pipe pipe = crtc->pipe;
...
@@ -7548,7 +7555,7 @@ static void intel_crtc_disable_noatomic(struct intel_crtc *crtc,
...
@@ -7561,7 +7568,8 @@ static void intel_crtc_disable_noatomic(struct intel_crtc *crtc,
 	crtc->active = false;
...
@@ -9264,7 +9272,8 @@ bdw_get_pipemisc_output_format(struct intel_crtc *crtc)
...
@@ -9687,10 +9696,11 @@ static void lpt_enable_clkout_dp(struct drm_i915_private *dev_priv,
 {
 	u32 reg, tmp;
...
@@ -9784,10 +9794,10 @@ static void lpt_bend_clkout_dp(struct drm_i915_private *dev_priv, int steps)
 	u32 tmp;
...
+	if (drm_WARN_ON(&dev_priv->drm, idx >= ARRAY_SIZE(sscdivintphase)))
 	...
 	mutex_lock(&dev_priv->sb_lock);
@@ -9955,8 +9965,8 @@ static void ilk_set_pipeconf(const struct intel_crtc_state *crtc_state)
...
@@ -10646,7 +10656,7 @@ static void cnl_get_ddi_pll(struct drm_i915_private *dev_priv, enum port port,
...
@@ -10673,12 +10683,13 @@ static void icl_get_ddi_pll(struct drm_i915_private *dev_priv, enum port port,
 								    port));
...
@@ -10721,7 +10732,7 @@ static void skl_get_ddi_pll(struct drm_i915_private *dev_priv, enum port port,
...
+	if (drm_WARN_ON(&dev_priv->drm, id < SKL_DPLL0 || id > SKL_DPLL3))
 	...
 	pipe_config->shared_dpll = intel_get_shared_dpll_by_id(dev_priv, id);
@@ -10950,8 +10961,9 @@ static void hsw_get_ddi_port_state(struct intel_crtc *crtc,
...
+					    &pipe_config->dpll_hw_state));
 	...
 	/*
@@ -11020,8 +11032,9 @@ static void icl_get_trans_port_sync_config(struct intel_crtc_state *crtc_state)
...
@@ -11051,7 +11064,7 @@ static bool hsw_get_pipe_config(struct intel_crtc *crtc,
...
@@ -11109,7 +11122,7 @@ static bool hsw_get_pipe_config(struct intel_crtc *crtc,
...
+	drm_WARN_ON(&dev_priv->drm, power_domain_mask & BIT_ULL(power_domain));
 	...
 	if (wf) {
@@ -11354,8 +11367,8 @@ static int i845_check_cursor(struct intel_crtc_state *crtc_state,
 		return -EINVAL;
 	}
...
+		    plane_state->color_plane[0].stride != fb->pitches[0]);
 	...
 	switch (fb->pitches[0]) {
 	case 256:
@@ -11571,8 +11584,8 @@ static int i9xx_check_cursor(struct intel_crtc_state *crtc_state,
 		return -EINVAL;
 	}
...
@@ -12233,7 +12246,7 @@ int intel_plane_atomic_calc_changes(const struct intel_crtc_state *old_crtc_stat
...
+	if (!was_crtc_enabled && drm_WARN_ON(&dev_priv->drm, was_visible))
 	...
 	/*
@@ -12627,7 +12640,7 @@ static int intel_crtc_atomic_check(struct intel_atomic_state *state,
...
+	    !drm_WARN_ON(&dev_priv->drm, crtc_state->shared_dpll)) {
 		...
 		if (ret)
 			return ret;
@@ -12658,7 +12671,8 @@ static int intel_crtc_atomic_check(struct intel_atomic_state *state,
 	}
...
+				!dev_priv->display.compute_pipe_wm))
 		...
 		/*
@@ -13336,7 +13350,8 @@ intel_modeset_pipe_config(struct intel_crtc_state *pipe_config)
 	}
...
@@ -13865,9 +13880,10 @@ static void intel_pipe_config_sanity_check(struct drm_i915_private *dev_priv,
...
@@ -15041,7 +15057,8 @@ static struct intel_crtc *intel_get_slave_crtc(const struct intel_crtc_state *ne
...
@@ -15209,8 +15226,8 @@ static void intel_update_trans_port_sync_crtcs(struct intel_crtc *crtc,
...
@@ -15331,8 +15348,8 @@ static void skl_commit_modeset_enables(struct intel_atomic_state *state)
...
@@ -15366,8 +15383,8 @@ static void skl_commit_modeset_enables(struct intel_atomic_state *state)
...
+									entries, num_pipes, pipe));
 		...
 		entries[pipe] = new_crtc_state->wm.skl.ddb;
 		modeset_pipes &= ~BIT(pipe);
@@ -15375,7 +15392,7 @@ static void skl_commit_modeset_enables(struct intel_atomic_state *state)
...
@@ -16635,7 +16652,7 @@ static int intel_crtc_init(struct drm_i915_private *dev_priv, enum pipe pipe)
...
@@ -17787,7 +17804,8 @@ void i830_enable_pipe(struct drm_i915_private *dev_priv, enum pipe pipe)
 	u32 dpll, fp;
 	int i;
...
@@ -17851,11 +17869,14 @@ void i830_disable_pipe(struct drm_i915_private *dev_priv, enum pipe pipe)
...
@@ -18637,7 +18658,7 @@ void intel_modeset_driver_remove(struct drm_i915_private *i915)
...
index a59c362d6c9c..1d35d0c75e27 100644
...
@@ -2674,8 +2683,8 @@ static  u32 ilk_get_pp_control(struct intel_dp *intel_dp)
 	lockdep_assert_held(&dev_priv->pps_mutex);
...
@@ -2773,7 +2782,7 @@ static void edp_panel_vdd_off_sync(struct intel_dp *intel_dp)
...
+	drm_WARN_ON(&dev_priv->drm, intel_dp->want_panel_vdd);
 	...
 	if (!edp_have_panel_vdd(intel_dp))
 		return;
@@ -2869,10 +2878,10 @@ static void edp_panel_on(struct intel_dp *intel_dp)
...
@@ -2930,8 +2939,9 @@ static void edp_panel_off(struct intel_dp *intel_dp)
...
@@ -3573,7 +3583,7 @@ static void intel_enable_dp(struct intel_encoder *encoder,
 	enum pipe pipe = crtc->pipe;
...
@@ -3644,9 +3654,9 @@ static void vlv_detach_power_sequencer(struct intel_dp *intel_dp)
...
@@ -3680,10 +3690,10 @@ static void vlv_steal_power_sequencer(struct drm_i915_private *dev_priv,
 	for_each_intel_dp(&dev_priv->drm, encoder) {
 		struct intel_dp *intel_dp = enc_to_intel_dp(encoder);
...
+			 encoder->base.name);
 		...
 		if (intel_dp->pps_pipe != pipe)
 			continue;
@@ -3707,7 +3717,7 @@ static void vlv_init_panel_power_sequencer(struct intel_encoder *encoder,
...
@@ -4235,7 +4245,8 @@ intel_dp_link_down(struct intel_encoder *encoder,
...
+			(I915_READ(intel_dp->output_reg) & DP_PORT_EN) == 0))
 	...
 	drm_dbg_kms(&dev_priv->drm, "\n");
@@ -4397,7 +4408,7 @@ intel_edp_init_dpcd(struct intel_dp *intel_dp)
...
+	drm_WARN_ON(&dev_priv->drm, intel_dp->dpcd[DP_DPCD_REV] != 0);
 	...
 	if (!intel_dp_read_dpcd(intel_dp))
 		return false;
@@ -5153,7 +5164,7 @@ int intel_dp_retrain_link(struct intel_encoder *encoder,
...
+	drm_WARN_ON(&dev_priv->drm, !intel_crtc_has_dp_encoder(crtc_state));
 	...
 	if (!crtc_state->hw.active)
 		return 0;
@@ -5688,7 +5699,8 @@ intel_dp_detect(struct drm_connector *connector,
...
@@ -6901,7 +6913,8 @@ intel_dp_init_panel_power_sequencer_registers(struct intel_dp *intel_dp,
...
index d7bed6df2d6c..ea5d942d130c 100644
...
index 505ec89459fa..673d80916ad4 100644
...
+	if (drm_WARN_ON(&dev_priv->drm, idle_frames > 0xf))
 	...
 	return idle_frames;
@@ -624,7 +624,7 @@ tgl_dc3co_exitline_compute_config(struct intel_dp *intel_dp,
 	exit_scanlines =
...
@@ -764,10 +764,14 @@ static void intel_psr_activate(struct intel_dp *intel_dp)
...
@@ -841,7 +845,7 @@ static void intel_psr_enable_locked(struct drm_i915_private *dev_priv,
...
@@ -898,10 +902,10 @@ void intel_psr_enable(struct intel_dp *intel_dp,
...
@@ -923,11 +927,11 @@ static void intel_psr_exit(struct drm_i915_private *dev_priv)
...
@@ -935,12 +939,12 @@ static void intel_psr_exit(struct drm_i915_private *dev_priv)
...
@@ -1000,7 +1004,7 @@ void intel_psr_disable(struct intel_dp *intel_dp,

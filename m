...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C2A952E703A
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Dec 2020 13:02:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B49B892F0;
	Tue, 29 Dec 2020 12:02:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 023AC8914E
 for <intel-gfx@lists.freedesktop.org>; Tue, 29 Dec 2020 12:02:01 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23455187-1500050 
 for multiple; Tue, 29 Dec 2020 12:01:51 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 29 Dec 2020 12:01:21 +0000
Message-Id: <20201229120145.26045-32-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 32/56] drm/i915: Move scheduler queue
...
index 0fe7986ac204..3b86cb3350df 100644
...
@@ -1050,11 +1050,11 @@ static bool needs_timeslice(const struct intel_engine_cs *engine,
 		return false;
...
@@ -1273,7 +1273,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -1341,7 +1341,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 			break;
 	}
...
@@ -1442,7 +1442,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
+	execlists->queue_priority_hint = queue_prio(&engine->active);
 	...
 	/*
@@ -2676,7 +2676,7 @@ static void execlists_reset_cancel(struct intel_engine_cs *engine)
...
@@ -2684,9 +2684,10 @@ static void execlists_reset_cancel(struct intel_engine_cs *engine)
...
@@ -2717,7 +2718,7 @@ static void execlists_reset_cancel(struct intel_engine_cs *engine)
...
@@ -2950,7 +2951,7 @@ int intel_execlists_submission_setup(struct intel_engine_cs *engine)
...
@@ -3541,7 +3542,7 @@ void intel_execlists_show_requests(struct intel_engine_cs *engine,

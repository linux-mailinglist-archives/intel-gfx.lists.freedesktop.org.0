...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEF4B195752
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2020 13:42:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A6EF6EA15;
	Fri, 27 Mar 2020 12:42:54 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH RESEND 3/7] drm/amd/display: use
 drm_dsc_dp_rc_buffer_size() to get rc buffer size

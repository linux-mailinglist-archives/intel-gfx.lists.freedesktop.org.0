...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 58EAF416C53
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 08:52:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A05EF6EE73;
...
Subject: [Intel-gfx] [PATCH v2 13/17] drm/i915: cleanup:

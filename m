...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CD624DEABC
	for <lists+intel-gfx@lfdr.de>; Sat, 19 Mar 2022 21:42:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C7C3E10EDCE;
...
Subject: [Intel-gfx] [PATCH v4 4/8] drm/i915/selftest_migrate: Check CCS
 meta data clear

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 12F5776E956
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Aug 2023 15:05:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90E7910E60B;
	Thu,  3 Aug 2023 13:05:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0A90010E607
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Aug 2023 13:05:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1691067925; x=1722603925;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PhAALNdpcGxKxSw8Jk1CGZDSIMaT/yP4ekSzOHeERpI=;
 b=eTrWtGP7v+lvlwXx7ysfqNGWa0NBVhnbcxWjL50Wv7oW3m5bmY7GhT+K
 TGfEuXUJLdvmgt1JkjpNK635yWwb/6J6FJjZGDjDBjV7TLL+SqC/5324n
 xUrBs4E/fjv7uq8UuM6Nr/DRDLWQ3em9QhIZsI5hkiSg6qCASdMXncLNW
 mbYqoD/OnbGeGEN29GkZ+EFMsqnyFIGB7O9iUUazczyFyehLH1bNufZXB
 P+VTTAUBvQQuW95SZT2VaAef3VcByKgWtBamjScVItJG27CGseX8rbZMf
 em2ZcAfpuXbba6JKonyQPoMaYD3txh9Odd10JZ2Je8AvHG5qaREob6gQL Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10791"; a="359906476"
X-IronPort-AV: E=Sophos;i="6.01,252,1684825200"; d="scan'208";a="359906476"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Aug 2023 06:05:24 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10791"; a="843585782"
X-IronPort-AV: E=Sophos;i="6.01,252,1684825200"; d="scan'208";a="843585782"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga002.fm.intel.com with ESMTP; 03 Aug 2023 06:05:22 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  3 Aug 2023 18:33:31 +0530
Message-Id: <20230803130337.3784597-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 1/8] drm/i915/vdsc: Refactor dsc register
 field macro

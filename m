...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2896B4B6EAA
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Feb 2022 15:17:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B884C10E610;
...
Subject: [Intel-gfx] [PATCH V3 6/13] input: serio: use

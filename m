...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28D5C78A0B4
	for <lists+intel-gfx@lfdr.de>; Sun, 27 Aug 2023 19:57:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5639510E1FA;
...
Subject: [Intel-gfx] [PATCH v15 18/23] drm/shmem-helper: Add memory shrinker

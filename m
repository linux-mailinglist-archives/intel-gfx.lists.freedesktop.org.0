...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F861470E99
	for <lists+intel-gfx@lfdr.de>; Sat, 11 Dec 2021 00:24:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1352910E594;
...
Subject: [Intel-gfx] [PATCH 5/7] drm/msm: Alter comment to use
 kmap_local_page()

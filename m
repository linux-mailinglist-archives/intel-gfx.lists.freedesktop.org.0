...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D298718F30
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 01:54:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E97910E0E5;
...
Subject: [Intel-gfx] [PATCH v5 0/7] drm/i915: HuC loading and authentication
 for MTL

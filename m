...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26F2C573F6D
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jul 2022 00:08:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DEA8110EA0F;
	Wed, 13 Jul 2022 22:08:34 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 07/39] drm/i915: gvt: fix kernel-doc
 trivial warnings

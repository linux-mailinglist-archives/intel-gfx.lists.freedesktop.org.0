...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B00C19DFA7
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Apr 2020 22:41:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43FD76EC98;
	Fri,  3 Apr 2020 20:41:03 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 12/17] drm/mcde: Use mode->clock instead of

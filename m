...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0E2D4F387D
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 16:34:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CFF5710E715;
	Tue,  5 Apr 2022 14:34:18 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v8 4/9] drm/i915/gt: Pass the -EINVAL when

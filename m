...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D3236F1313
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 10:15:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C84810EC66;
...
Subject: [Intel-gfx] [RFC 1/4] drm/i915: Move setting of rps thresholds to
 init

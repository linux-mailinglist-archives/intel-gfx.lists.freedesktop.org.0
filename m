...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2561926264
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jul 2024 15:57:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3362410E86B;
	Wed,  3 Jul 2024 13:57:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="Ue60Ahpw";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-f45.google.com (mail-io1-f45.google.com
 [209.85.166.45])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 48AB810E6D7;
 Tue,  2 Jul 2024 21:58:36 +0000 (UTC)
Received: by mail-io1-f45.google.com with SMTP id
 ca18e2360f4ac-7f64f66fdd7so60610139f.0; 
 Tue, 02 Jul 2024 14:58:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1719957515; x=1720562315; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=ixqe2fvQ+p3xJowFXczfx5KdZEaC8a1vzuHPaRlFrmw=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=ixqe2fvQ+p3xJowFXczfx5KdZEaC8a1vzuHPaRlFrmw=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCWE0tK8KsV6+fgvHOGma02BsDYSEXnNGxbouFMUWtlaLagTBFo4jhP98laikxWpgl+0xG2JJmEsaEB5lMAZTA+y3ZVfqDsKa2xEBz70B5tp8DktPLe82I2JjhRKRuvYYE9sDxig+okK8FEsiyl5j25j1PpfKLbjsNbkDfzUrpeptMKYnAhEvjzCL8iJJRzqDlmwPNPphaFBRdZibxUHg0Lm5oBY3BU052hIHItVtv+BHwvkJWc=
X-Gm-Message-State: AOJu0Yyb4q/Vex/iWQoTV8mqEYdsKuUUG6ndPUdz6wvYc3pazypaCsmF
 L20HaHa11IeLblmec5Ai4DGkY/jehfCbmpyIL1V1pKci70/fVR+O
X-Google-Smtp-Source: AGHT+IGuF3X4wd/Q+QiMc/SNYxya2QDBND8SXs2NtMYBQ3/4cpFsTf5QXlJhmfj13W/6t+FhpK5Wug==
X-Received: by 2002:a6b:6f02:0:b0:7f6:1f4c:96d2 with SMTP id
 ca18e2360f4ac-7f62ed42fbamr1056411939f.0.1719957515370; 
 Tue, 02 Jul 2024 14:58:35 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 ca18e2360f4ac-7f61d207fcesm279944739f.51.2024.07.02.14.58.34

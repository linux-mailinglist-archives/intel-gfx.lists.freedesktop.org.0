...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EC753D3EF9
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Jul 2021 19:43:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF5F06FB9B;
	Fri, 23 Jul 2021 17:43:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A69536FB98
 for <intel-gfx@lists.freedesktop.org>; Fri, 23 Jul 2021 17:42:55 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10054"; a="199127512"
X-IronPort-AV: E=Sophos;i="5.84,264,1620716400"; d="scan'208";a="199127512"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jul 2021 10:42:50 -0700
X-IronPort-AV: E=Sophos;i="5.84,264,1620716400"; d="scan'208";a="463229067"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jul 2021 10:42:49 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 23 Jul 2021 10:42:19 -0700
Message-Id: <20210723174239.1551352-11-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 10/30] drm/i915/xehpsdv: Add compute DSS type
...
index 897238ca54e1..3d37ffec7b56 100644
...
index 975087553ea0..13328db8a671 100644
--- a/include/uapi/drm/i915_drm.h
+++ b/include/uapi/drm/i915_drm.h
@@ -2580,9 +2580,6 @@ struct drm_i915_query {
  *                 Z / 8] >> (Z % 8)) & 1
  */

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C232D349926
	for <lists+intel-gfx@lfdr.de>; Thu, 25 Mar 2021 19:08:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 373CB6EE34;
	Thu, 25 Mar 2021 18:08:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 775C46EE23
 for <intel-gfx@lists.freedesktop.org>; Thu, 25 Mar 2021 18:07:35 +0000 (UTC)
IronPort-SDR: sVjo9mVHjPpclabNDR57ivI25YhkL4fRpVzE3B98u92LUPnJemschMf6mbdXxOfVeaFOCY5axw
 7cgUDrILu9tQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9934"; a="178112565"
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="178112565"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:35 -0700
IronPort-SDR: Lt9gMYKom66MRdJ4/GgRu4SozgXGmf6kO3Z7EHaOIHoJjS8NTGbqTikP+NqBWGkmeL6oJ0JgTC
 FJoBdrH6J20A==
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="453176726"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.168])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:34 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 25 Mar 2021 11:07:10 -0700
Message-Id: <20210325180720.401410-41-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 40/50] drm/i915/adl_p: Add PLL Support
...
L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZHBsbF9tZ3IuYwppbmRleCAyNjhlY2YxYzAwMGYuLjYx
OGM2MWQ0ZDNiNiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRl
...
OTMwNzFjZGU2ZDQuLjAxN2JkNDgxN2M1YiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5
MTUvaTkxNV9yZWcuaAorKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlZy5oCkBAIC0x
MDUzOSw2ICsxMDUzOSwxNCBAQCBlbnVtIHNrbF9wb3dlcl9nYXRlIHsKICNkZWZpbmUgREcxX0RQ

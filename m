...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8F401F7F6A
	for <lists+intel-gfx@lfdr.de>; Sat, 13 Jun 2020 01:03:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29D8C6E252;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 2/3] drm/i915/dp: Attach and set drm

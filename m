...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E31540D4FE
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Sep 2021 10:49:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B03FC6EB10;
	Thu, 16 Sep 2021 08:49:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6BA766EB10
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Sep 2021 08:49:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1631782166;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=Uk+pxAug/D4PD6XSrOOk26bOAHf8m7uQP2fQrMNsLUM=;
 b=e+DZl7KvsyBWChhNo2CJKJAkS5/Zod+Y+4Pn7NVEWm0p8zZzCmDQOZaWbMDdvF1+WrBdlp
 2OI2RsfhMR5hpkyhIsKMCsZq8leqskBGiHS6l2WB/86G8qi9ts8gDkAprzQu9ezEdbK0tb
 bxd6XQSpLo9/uYadONpWL/GQoGC+jJY=
Received: from mail-ed1-f72.google.com (mail-ed1-f72.google.com
 [209.85.208.72]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-589-k3XUe1tTOMeDF2BSqbruQg-1; Thu, 16 Sep 2021 04:49:23 -0400
X-MC-Unique: k3XUe1tTOMeDF2BSqbruQg-1
Received: by mail-ed1-f72.google.com with SMTP id
 n5-20020a05640206c500b003cf53f7cef2so1905200edy.12
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Sep 2021 01:49:23 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=Uk+pxAug/D4PD6XSrOOk26bOAHf8m7uQP2fQrMNsLUM=;
 b=
X-Gm-Message-State: AOAM533GmD4tHf0T1CCyLOwcgab02vuNhwe3d0A6ySYin+29fqIbByEJ
 l+Sx18PAbJofBSQ5TqQaLBL/h2gjyPbcZKCnATjPRWdfTngqhWBy96ebH9Rt3BJf7/yrlcxJU3N
 osCmaNsSdOwCHkSqzV8CZVe3wLFWr
X-Received: by 2002:a05:6402:847:: with SMTP id
 b7mr5335404edz.242.1631782161876; 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B269A40A569
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Sep 2021 06:30:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46DF86E3D2;
	Tue, 14 Sep 2021 04:29:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 111926E3BB;
 Tue, 14 Sep 2021 04:29:52 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10106"; a="218696858"
X-IronPort-AV: E=Sophos;i="5.85,291,1624345200"; d="scan'208";a="218696858"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Sep 2021 21:29:52 -0700
X-IronPort-AV: E=Sophos;i="5.85,291,1624345200"; d="scan'208";a="543660552"
...
Date: Mon, 13 Sep 2021 21:24:43 -0700
Message-Id: <20210914042445.29466-3-matthew.brost@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915/guc: Do error capture
 asynchronously
...
index c0292a94f4c3..842df190ee67 100644
--- a/drivers/gpu/drm/i915/gt/uc/intel_guc.h
+++ b/drivers/gpu/drm/i915/gt/uc/intel_guc.h
@@ -84,6 +84,16 @@ struct intel_guc {
 		 * refs
 		 */

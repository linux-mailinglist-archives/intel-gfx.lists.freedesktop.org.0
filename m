...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1FFE59DAD4
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Aug 2022 13:07:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6AB9B10FC3A;
	Tue, 23 Aug 2022 11:07:16 +0000 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19B6B5FA40F
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Oct 2022 21:18:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC96B10E6D6;
	Mon, 10 Oct 2022 19:18:12 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 3/7] drm/i915/uc: use different ggtt pin

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1951863B6C0
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Nov 2022 01:46:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 055DC10E35C;
	Tue, 29 Nov 2022 00:46:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C52E010E35C
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=QpuV7S1ih7yw7O0jZ9GCaRAMQuzrUTj0CvuBkxNHYJQ=;
 b=Y/Pfo7crYf1xE/FODXaNJGqVLNdjcjU2lJCqNoW68bGrfilZaRMShXZx
 a+SRNvNt8UC0q4HGsFmLQOJ70KPfWxyvkQpGwD+Tf8zSx7FJ+EuRX3XE5
 iVp4aTnZ/6nVwHger8CERaAzMirk9zD3OZCJ1pqeRMjd9njfo07MpYFep
 bGSJHWIhQSMXzUnUctiB4GFgxtpMhrJJ0VsIx2PtbNjn4hCMqGjujNyAL
 PAB/c0sRuEqDZEPpAenmPlbUbAsvvQjs+x21C69cHZ48LagVIdleYouzt
 sE03LmZq9Eoi9+wmiUC19fiAR19FTgBSg8nyvp1IpGaIIc3YvOjIQCjqf w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10545"; a="401271778"
X-IronPort-AV: E=Sophos;i="5.96,201,1665471600"; d="scan'208";a="401271778"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2022 16:46:02 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10545"; a="676243287"
X-IronPort-AV: E=Sophos;i="5.96,201,1665471600"; d="scan'208";a="676243287"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga001.jf.intel.com with ESMTP; 28 Nov 2022 16:46:02 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Nov 2022 16:48:30 -0800
Message-Id: <20221129004832.3735764-2-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/3] drm/i915/pxp: Invalidate all PXP fw
...
@@ -309,3 +309,38 @@ int intel_pxp_tee_cmd_create_arb_session(struct intel_pxp *pxp,

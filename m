...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47CFC577B58
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:39:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C670A9CF2;
...
Subject: [Intel-gfx] [PATCH v3 24/39] drm-print: include dyndbg header
 indirectly

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B68F84BC190
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Feb 2022 22:13:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFBA710E12F;
...
Subject: Re: [Intel-gfx] [PATCH v3 15/16] drm/i915/guc: Convert
 __guc_ads_init to iosys_map

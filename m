...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A81C24231C0
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Oct 2021 22:24:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9FC16EC50;
	Tue,  5 Oct 2021 20:24:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 85EA26EC50
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 Oct 2021 20:24:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1633465444;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=stxg+QCwzzTsWVuzL7lAQiLgXzVr16s2tIh/+dsFcbI=;
 b=HfDaMUGSJokSgz2c7BQ507vF9pPcIolsTBMAUidnSUCZrQ6Kcjeq7SXevCc0m2rFrpSVJW
 4fKDS6vHqvUSsSIPN6gAVJ8C5krLTNuQAHO+rBSHpyMD34Md2Ec/2/UvC1PdZXniZhApMQ
 AZeN8rOe+a3zePdMgIBGcNlk0jUL5EU=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-385-muQ4csg4P6e7kjRZTNqEJw-1; Tue, 05 Oct 2021 16:24:03 -0400
X-MC-Unique: muQ4csg4P6e7kjRZTNqEJw-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com
 [10.5.11.12])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id D18D319251D5;
 Tue,  5 Oct 2021 20:24:00 +0000 (UTC)
Received: from x1.localdomain (unknown [10.39.192.128])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 3730F60C05;
 Tue,  5 Oct 2021 20:23:51 +0000 (UTC)
...
Message-Id: <20211005202322.700909-6-hdegoede@redhat.com>
...
Subject: [Intel-gfx] [PATCH 05/10] drm/connector: Add a drm_connector

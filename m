...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5566E550AEB
	for <lists+intel-gfx@lfdr.de>; Sun, 19 Jun 2022 15:38:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1245E10E6FD;
	Sun, 19 Jun 2022 13:38:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5FAC610E6FD
 for <intel-gfx@lists.freedesktop.org>; Sun, 19 Jun 2022 13:38:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655645893; x=1687181893;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=SuHhKloRFvglX9zFGdP7Nu+8Y1f8MGBa3hFTJEwSwKI=;
 b=Duywn+zs5UnViB4BOAYqGuRjuBLa8d1B8H0QfrjUY38cHVdSzUxcFmrm
 QIboHdEIP32AzIpdNp6C1+aR0D0vareiXMOYiV5DAoMYKeKSDE8MI94Mj
 V2WkDGqXYmhILdXoNiUmciulfoMUGGUgOyH4Yl/pyUe0FIV7oUfcc8TDD
 gRqqVdsTUbT35kKpXJTRBsXGODJ298+ujGXEAmoTkn53A/wVE8rKjN69y
 BKtNhcwZzDAsqzmzxq9i9PX9y7uLp0oefm82OY+YSdu+LgGVNpt0ahLDa
 PiPYQ+f6maY+w4Hta3VJ1uVfwKCgd+KhiwnxCroMOChE7hti4/IxXOqPX Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10380"; a="259552699"
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="259552699"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jun 2022 06:38:12 -0700
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="676158571"
Received: from sannilnx.jer.intel.com ([10.12.26.157])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jun 2022 06:38:09 -0700
...
Date: Sun, 19 Jun 2022 16:37:18 +0300
Message-Id: <20220619133721.523546-12-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 11/14] mei: gsc: setup gsc extended
 operational memory

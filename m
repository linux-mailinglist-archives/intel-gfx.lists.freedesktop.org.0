...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BCF35BACD7
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Sep 2022 13:57:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D775B10ED11;
	Fri, 16 Sep 2022 11:57:45 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v1 1/4] drm/i915: Move dsm assignment to be
 after adjustment

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C93EC4A66F0
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Feb 2022 22:21:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3489710E223;
	Tue,  1 Feb 2022 21:21:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E74D410E1D1;
 Tue,  1 Feb 2022 21:21:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643750485; x=1675286485;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=ubsoS7BsMkbM/h2ImghwXfdPiiiv2Ar113GmICMr2Nc=;
 b=fQBpdq2SZsBqEOLZQzWDbj+rtpLEz8xteSNlQIIRCNIW2frtNxp4iMcL
 PNj1TGb7kBV/RXDcRxqpT7Ec3+DNBeLrAOtcbj9eZ4Uxn/EId5aTDdJ3p
 ABuEnD/XhNPZVyJbS8Why2DGVWOyV7lJCv9YyRHRLztyQOZmUpk9/2Yp0
 ep7b1V/X4QcLyjNRnSZlSg6qM/P/eyjkn3+xm74QNqLLjqBDTnZYEQv6e
 2sgs8RKGdmgr1ODsmrtN9H8rQ1JU5oGYrXXDz05Re03JW+myiWPZbdi2w
 YWo2SyUtQOQnqv/K6YF9grSn/9+v8NRgdqfVMnqss6GYFP4tuZRx8AiK+ w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10245"; a="248016951"
X-IronPort-AV: E=Sophos;i="5.88,334,1635231600"; d="scan'208";a="248016951"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2022 13:21:24 -0800
X-IronPort-AV: E=Sophos;i="5.88,334,1635231600"; d="scan'208";a="583184395"
...
Subject: Re: [Intel-gfx] [PATCH v2 05/11] drm/i915: Use

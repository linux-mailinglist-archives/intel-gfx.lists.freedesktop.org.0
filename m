...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 929CD60DEE0
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Oct 2022 12:32:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4259210E26A;
	Wed, 26 Oct 2022 10:32:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 23BFB10E26A
 for <intel-gfx@lists.freedesktop.org>; Wed, 26 Oct 2022 10:32:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666780358; x=1698316358;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=l0wUVBEnhXZ6fRlPL3Q2Z/5X5anQUewU9kTtEHEvwhQ=;
 b=DOj+EQg4B9pfOwHstILXtPcakIORABKFbN4+T7XWtYHWm7+1dRXeZC6W
 lJt3K0Y0TuKTXiQIhl/IHrlTJyz0VrNSzah2Ijy5tA5Sfbx4svAVq+1kI
 maQ0rlFkGyMNWMtAHFFi8G2Jt4Xf5KqJDr+IKiVVNvV2YJKAG5GQNfdeW
 a7WALY3+DmCcQhnlkU0ZlcUe3xWUiWcrbKu89l7EoPr4lyAwmsE2ZD5tb
 AAOZTt+S/9PIt60djT2Xhd7rOeLjkri3PFK8rnJ39VAQ3pX6uQMAy0LrH
 w0HOhB23jXy8x+RcK8qknhRh4+dSEKgwy1v5tD5YwW1dkyMKm0T0AZKUJ A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10511"; a="306642318"
X-IronPort-AV: E=Sophos;i="5.95,214,1661842800"; d="scan'208";a="306642318"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Oct 2022 03:32:37 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10511"; a="634440985"
X-IronPort-AV: E=Sophos;i="5.95,214,1661842800"; d="scan'208";a="634440985"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.191])
 by fmsmga007.fm.intel.com with SMTP; 26 Oct 2022 03:32:32 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 26 Oct 2022 13:32:31 +0300

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 58F0D548479
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jun 2022 12:23:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 693EE10E06C;
...
Subject: [Intel-gfx] [PATCH] drm/i915/display: Re-add check for low voltage

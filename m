...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05E5E4FC245
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 18:27:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D944C10E687;
...
Subject: Re: [Intel-gfx] [PATCH 15/34] drm/i915/gvt: devirtualize ->set_edid
 and ->set_opregion

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 067776721A8
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 16:45:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1356210E775;
...
Subject: [Intel-gfx] [PATCH v5 2/7] linux/include: add non-atomic version of
 xchg

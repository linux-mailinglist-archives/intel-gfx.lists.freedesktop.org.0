...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BBEAF28D6
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2019 09:13:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF0EE6EECD;
	Thu,  7 Nov 2019 08:13:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A03FB6EEBF
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 Nov 2019 08:13:03 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19110684-1500050 
 for multiple; Thu, 07 Nov 2019 08:12:58 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  7 Nov 2019 08:12:51 +0000
Message-Id: <20191107081252.10542-27-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 27/28] drm/i915: Allow userspace to specify
...

...
dGljIHN0cnVjdCBpOTE1X2FkZHJlc3Nfc3BhY2UgKgpAQCAtNjA5LDkgKzYxNiwxMCBAQCBzdGF0
...
ZXh0ICpjdHgsCkBAIC0xMTY3LDYgKzExNzUsMTA0IEBAIHN0YXRpYyBpbnQgc2V0X3BwZ3R0KHN0
...
CkBAIC0xODAyLDEzICsxOTA4LDE1IEBAIHNldF9wZXJzaXN0ZW5jZShzdHJ1Y3QgaTkxNV9nZW1f
...
LApAQCAtMTkwMSw2ICsyMDA5LDEwIEBAIHN0YXRpYyBpbnQgY3R4X3NldHBhcmFtKHN0cnVjdCBk
...
QCAtMTk3MSw2ICsyMDgzLDE5IEBAIHN0YXRpYyBpbnQgY2xvbmVfZW5naW5lcyhzdHJ1Y3QgaTkx
...
aW5lcyA9IG47CiAKQEAgLTIzMzQsNiArMjQ1OSwxMCBAQCBpbnQgaTkxNV9nZW1fY29udGV4dF9n
...
dGVsX2xyYy5jCmluZGV4IDY2ODhmYmZkNDliNy4uMmM5NGI5Y2U2NTA3IDEwMDY0NAotLS0gYS9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF9scmMuYwpAQCAtMjQxNCw2ICsyNDE0LDcgQEAgX19leGVjbGlzdHNfdXBk

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AC6110D409
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Nov 2019 11:30:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C505A6E8B8;
...
Subject: [Intel-gfx] [PATCH v2 05/14] video: fbdev: vesafb: modify the

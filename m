...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EF5C4C7441
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Feb 2022 18:43:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85DCE10E859;
...
Subject: [Intel-gfx] [PATCH v2 08/13] drm/i915/xehp/guc: enable compute
 engine inside GuC

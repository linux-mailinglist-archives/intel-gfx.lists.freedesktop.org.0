...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0E55618253
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Nov 2022 16:18:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBB2810E66F;
...
Subject: [Intel-gfx] [PATCH v3 16/23] drm/fb-helper: Call fb_sync in I/O
 functions

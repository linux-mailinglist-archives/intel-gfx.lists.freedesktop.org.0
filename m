...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E43F36FFD31
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 01:18:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B3C210E61E;
	Thu, 11 May 2023 23:18:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7107210E620
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 May 2023 23:18:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683847114; x=1715383114;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=65iztkJ6nTCnNOOIF8ujkzFUHw2dA5wcIr8NY5qa0+4=;
 b=anH0eaeQpmY6gpotY/i3GJOCzhfN0ka1XonwCSCOZih65sAuFKaJe70R
 SQMdAji3cm2yRL7UX/SfmBayA9E5idoIbxxdgUVUlmEf9IwROKgGRPqiM
 xtUXJUC6uYYmVYMQkhSNJCuBDZ9KQzw3/QehAXAM6PAS4v6bQA/lzgd7M
 DQZzN/MceS1C/iVd0ClHzt+2VD3hUTUjFMjj6YEvq5An8eIG9JYDG/JYB
 sAc6fIgxInHpIPHnFnvijMwnusnXLseZqz4V3vImRwQ58qlpb8JICO8c8
 RpLxkKeaxCh4eiof56MWFtLqgb+koP+FlzVCDK7uCB/idHnGeV0ExDiQZ g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="352897357"
X-IronPort-AV: E=Sophos;i="5.99,268,1677571200"; d="scan'208";a="352897357"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2023 16:18:33 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="694012994"
X-IronPort-AV: E=Sophos;i="5.99,268,1677571200"; d="scan'208";a="694012994"
Received: from ptorre-mobl1.ger.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.252.61.205])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2023 16:18:30 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 12 May 2023 02:17:49 +0300
Message-Id: <20230511231750.313467-8-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 7/8] drm/i915/mtl: Add support for PM DEMAND

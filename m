...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 75253701462
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 06:42:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D24F10E03E;
	Sat, 13 May 2023 04:42:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3929610E039
 for <intel-gfx@lists.freedesktop.org>; Sat, 13 May 2023 04:42:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683952923; x=1715488923;
 h=date:message-id:from:to:cc:subject:in-reply-to:
 references:mime-version;
 bh=RYwWByNGCnDvY0HYDy1e1p+rlzS/XOiVIQYZIVtP82A=;
 b=GOmqi/3QC/PSBiJxdb5HB5fT6ZEhPwKEVTPX5WwaIGyKKtzeJ1HgunIx
 qL0ilJc9gn5IAtpn2m18JOKFJbZTRRl7w/qfYL1kIbReZIOsUvhkIrMnv
 PzNTQQox0lgZR5C+CZp5mQtIl/DJxA2poTx8Tnf9oNzwRmKMYV41Js7uM
 0o+cCbPrcR1+t6bu/6bSArRANh0Hf5cOmZ1UTKnUzrJYN5hj8OtXMpbB0
 zgMMoAnYPlxHkw4i2Lbb4RK1KcrPaEixtjkYx92h1tH0J8Y0MmmJxZgq2
 yZ9UQeya0pZDnzR4vWNo33vT6MZKBQdY+CtW3YxzkrotP9Jqey5ver6du w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="379070637"
X-IronPort-AV: E=Sophos;i="5.99,271,1677571200"; d="scan'208";a="379070637"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 21:42:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="703384804"
X-IronPort-AV: E=Sophos;i="5.99,271,1677571200"; d="scan'208";a="703384804"
Received: from adixit-mobl.amr.corp.intel.com (HELO adixit-arch.intel.com)
 ([10.212.239.47])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 21:42:02 -0700
Date: Fri, 12 May 2023 21:41:56 -0700
Message-ID: <875y8wetbf.wl-ashutosh.dixit@intel.com>
From: "Dixit, Ashutosh" <ashutosh.dixit@intel.com>
To: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
In-Reply-To: <20230513015545.2807282-6-umesh.nerlige.ramappa@intel.com>

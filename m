...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C7B15AF887
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 01:50:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2866910E086;
...
Subject: [Intel-gfx] [PATCH v3 00/14] i915: Add "standalone media" support
 for MTL

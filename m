...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D155471F70
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Jul 2019 20:39:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C87B8892A8;
	Tue, 23 Jul 2019 18:39:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8A6E06E394
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Jul 2019 18:39:00 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17542612-1500050 
 for multiple; Tue, 23 Jul 2019 19:38:44 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 Jul 2019 19:38:27 +0100
Message-Id: <20190723183842.20372-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/23] drm/i915: Introduce for_each_user_engine()
...
ZXggZWQ1YzRlMTYxZTZlLi4zZWEwYjVkZWJlOTQgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
...
ZiAoZW5naW5lLT5zY2hlZHVsZSkKQEAgLTExOTUsMTEgKzExOTQsMTAgQEAgYm9vbCBpbnRlbF9l
...
ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2RlYnVnZnMuYwppbmRleCBkZWZhOThjM2IzMjMuLmY5YTlm
NTg5ZDYzMSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kZWJ1Z2ZzLmMK
...
ZS0+YmF0Y2hfcG9vbC5jYWNoZV9saXN0W2pdLApAQCAtMzkxLDcgKzM5MCw2IEBAIHN0YXRpYyBp
...
OwogCkBAIC0zOTksNyArMzk3LDcgQEAgc3RhdGljIGludCBpOTE1X2dlbV9iYXRjaF9wb29sX2lu
...
bnQ7CiAKQEAgLTQ4Niw3ICs0ODQsNiBAQCBzdGF0aWMgaW50IGk5MTVfaW50ZXJydXB0X2luZm8o
...
ZXJlZl90IHdha2VyZWY7CiAJaW50IGksIHBpcGU7CiAKQEAgLTY4OSw3ICs2ODYsNyBAQCBzdGF0
...
LCBSSU5HX0lNUikpOwpAQCAtMTA4Myw3ICsxMDgwLDYgQEAgc3RhdGljIGludCBpOTE1X2hhbmdj
...
ZiAodGVzdF9iaXQoSTkxNV9XRURHRUQsICZndC0+cmVzZXQuZmxhZ3MpKQpAQCAtMTEwOCw3ICsx
MTA0LDcgQEAgc3RhdGljIGludCBpOTE1X2hhbmdjaGVja19pbmZvKHN0cnVjdCBzZXFfZmlsZSAq
...
MTk2NCw3ICsxOTYwLDYgQEAgc3RhdGljIHZvaWQgaTkxNV9ndWNfY2xpZW50X2luZm8oc3RydWN0
...
dGFnZSBpbmRleDogJXUsIFBEIG9mZnNldCAweCV4XG4iLApAQCAtMTk3Miw4ICsxOTY3LDggQEAg
...
bnM6ICVsbHUgJXNcbiIsCiAJCQkJc3VibWlzc2lvbnMsIGVuZ2luZS0+bmFtZSk7CkBAIC0yMDEz
LDcgKzIwMDgsNiBAQCBzdGF0aWMgaW50IGk5MTVfZ3VjX3N0YWdlX3Bvb2woc3RydWN0IHNlcV9m
...
bnQgaW5kZXg7CiAKIAlpZiAoIVVTRVNfR1VDX1NVQk1JU1NJT04oZGV2X3ByaXYpKQpAQCAtMjA0
Miw3ICsyMDM2LDcgQEAgc3RhdGljIGludCBpOTE1X2d1Y19zdGFnZV9wb29sKHN0cnVjdCBzZXFf
...
QCAtMjg3NSw3ICsyODY5LDYgQEAgc3RhdGljIGludCBpOTE1X2VuZ2luZV9pbmZvKHN0cnVjdCBz
...
ZV9wbV9nZXQoJmRldl9wcml2LT5ydW50aW1lX3BtKTsKQEAgLTI4ODcsNyArMjg4MCw3IEBAIHN0
...
ZWYpOwpAQCAtMjk2OCw5ICsyOTYxLDggQEAgc3RhdGljIGludCBpOTE1X3dhX3JlZ2lzdGVycyhz
...
cy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuaAppbmRleCAxMmE3ZmRhYmMyZjAuLmI4MzYzYzQ4M2Nh
ZiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuaAorKysgYi9kcml2

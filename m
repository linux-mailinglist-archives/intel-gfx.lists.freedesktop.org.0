...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACE744C7DA9
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Feb 2022 23:45:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DE51D10E52E;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/guc: Fix flag query helper
 function to not modify state

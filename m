...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1843E3C6697
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Jul 2021 00:59:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D082F89EB1;
...
Subject: Re: [Intel-gfx] [PATCH 36/47] drm/i915/guc: Handle engine reset

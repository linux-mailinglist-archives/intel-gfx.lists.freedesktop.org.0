...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B215E424C2B
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Oct 2021 05:17:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57D846E829;
	Thu,  7 Oct 2021 03:17:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8A7EB6E821
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 Oct 2021 03:16:58 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-125-QGVDr1otMbSCCOkCZOao6w-1; Wed, 06 Oct 2021 23:16:55 -0400
X-MC-Unique: QGVDr1otMbSCCOkCZOao6w-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com
 [10.5.11.14])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 964681808311;
 Thu,  7 Oct 2021 03:16:54 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id CB97E5D9C6;
 Thu,  7 Oct 2021 03:16:52 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@intel.com, ville.syrjala@linux.intel.com,
 Dave Airlie <airlied@redhat.com>
Date: Thu,  7 Oct 2021 13:13:14 +1000
Message-Id: <20211007031318.3088987-5-airlied@gmail.com>
...
+#include "intel_plane_initial.h"
 ...
 #include "intel_pps.h"
 #include "intel_psr.h"
@@ -1228,123 +1229,6 @@ u32 intel_plane_fb_max_stride(struct drm_i915_priva=
te *dev_priv,
...
@@ -1380,8 +1264,8 @@ static void fixup_plane_bitmasks(struct intel_crtc_st=
ate *crtc_state)
 =09}
 }
=20
...
@@ -1426,123 +1310,6 @@ static void intel_plane_disable_noatomic(struct int=
el_crtc *crtc,
...
-
 ...
 {
@@ -11363,22 +11130,6 @@ static void intel_mode_config_cleanup(struct drm_i=
915_private *i915)
...
-
 ...
 {
@@ -11450,30 +11201,6 @@ int intel_modeset_init_noirq(struct drm_i915_priva=
te *i915)
 =09return ret;
 }
=20
...
index a08903bb7647..de9c414063d1 100644
--- a/drivers/gpu/drm/i915/display/intel_display.h
+++ b/drivers/gpu/drm/i915/display/intel_display.h
@@ -624,6 +624,8 @@ void intel_plane_unpin_fb(struct intel_plane_state *old=
_plane_state);

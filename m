...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1245F3F19EF
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Aug 2021 15:04:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E3AE6E90F;
	Thu, 19 Aug 2021 13:04:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id BE92C6E908;
 Thu, 19 Aug 2021 13:04:22 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id B31FEAADDD;
 Thu, 19 Aug 2021 13:04:22 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============2984746891001347030=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Matthew Auld" <matthew.auld@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Thu, 19 Aug 2021 13:04:22 -0000
Message-ID: <162937826268.747.12676970171860091710@emeril.freedesktop.org>
...
#### Issues hit ####
  ...
  * igt@gem_exec_fair@basic-throttle@rcs0:
   ...
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20853/shard-glk4/igt@gem_exec_fair@basic-throttle@rcs0.html

  * igt@gem_pread@exhaustion:
    - shard-apl:          NOTRUN -> [WARN][17] ([i915#2658])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20853/shard-apl3/igt@gem_pread@exhaustion.html

  * igt@gem_pwrite@basic-exhaustion:
    - shard-skl:          NOTRUN -> [WARN][18] ([i915#2658])
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20853/shard-skl3/igt@gem_pwrite@basic-exhaustion.html
...
<p>Serious unknown changes coming with Patchwork_20853_full absolutely need=
 to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br=
 />
  introduced in Patchwork_20853_full, please notify your bug team to allow =
them<br />
...
rd-snb7/igt@gem_ppgtt@blt-vs-render-ctxn.html">FAIL</a></li>
</ul>
</li>
<li>
...
d-tglb7/igt@gem_spin_batch@legacy@bsd1.html">INCOMPLETE</a></li>
</ul>
</li>
</ul>
<h2>Known issues</h2>
...
ow_bug.cgi?id=3D109271">fdo#109271</a> / <a href=3D"https:">i915#658</a>) +=
2 similar issues</li>
</ul>
</li>
<li>
...
sf-dmg-area-2.html">SKIP</a> (<a href=3D"https:">i915#658</a>)</li>
</ul>
</li>
<li>
...
5.html">SKIP</a> (<a href=3D"https:">i915#658</a>) -&gt; <a href=3D"https:/=
/intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20853/shard-iclb2/igt@kms_psr2_=
sf@primary-plane-update-sf-dmg-area-5.html">SKIP</a> (<a href=3D"https://gi=
tlab.freedesktop.org/drm/intel/issues/2920">i915#2920</a>) +1 similar issue=
</li>
</ul>
</li>
<li>
...
>FAIL</a>, <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20=
853/shard-apl1/igt@runner@aborted.html">FAIL</a>) (<a href=3D"https://bugs.=

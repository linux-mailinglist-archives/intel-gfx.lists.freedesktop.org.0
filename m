...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D313527F7C
	for <lists+intel-gfx@lfdr.de>; Mon, 16 May 2022 10:20:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B00210E974;
	Mon, 16 May 2022 08:20:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9887510E974
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 May 2022 08:20:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1652689235; x=1684225235;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=kseI/43c2PNYMOb/C4jbJEfEDM+sgd6pkFnQFlwJE4I=;
 b=dj0FDr7G5MS78HuYZ5/y5UE2/pveX2dGMHIODSqJJbrGYbDkJG4aYSAC
 eAzgAx75qSY5/oGUeLKxOQfbvSqSTi6TvWhFveYuzzrPuA++u/49U3/ha
 rLid7VUu67MRiJ8uSkz9r3qf4yRq6pdLc02QiJySeFN7ns0O2ew4FdYC3
 sF2YGKoaC5AVz9gUrKi8B/Aqniv0rwTtE+N6Av1u7vpq73vXn7pi+MB+r
 1A0kOhqN5635fzOuiCU7JV/i4qi35iy7apas2WBILarkAebeYKSHqo4Te
 ifT0wWILnxFtKxqhgo7WEVqnV7uRfDZCcSYpzOrd0Xnc/GMJDVOIapG6d A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10348"; a="333827377"
X-IronPort-AV: E=Sophos;i="5.91,229,1647327600"; d="scan'208";a="333827377"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 May 2022 01:20:24 -0700
X-IronPort-AV: E=Sophos;i="5.91,229,1647327600"; d="scan'208";a="596412704"
Received: from nirmoyda-desk.igk.intel.com ([10.102.13.19])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 May 2022 01:20:22 -0700
From: Nirmoy Das <nirmoy.das@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 16 May 2022 10:20:15 +0200
Message-Id: <20220516082015.32020-1-nirmoy.das@intel.com>
X-Mailer: git-send-email 2.35.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH] drm/i915: Update tiled blits selftest

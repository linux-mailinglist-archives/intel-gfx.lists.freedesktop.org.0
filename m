...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C3A17195758
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2020 13:43:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D7C16EA19;
	Fri, 27 Mar 2020 12:43:05 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH RESEND 5/7] drm/i915/dsc: make rc_model_size an
 encoder defined value

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A440F4B3A5A
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Feb 2022 09:53:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 954D210F37D;
...
Subject: [Intel-gfx] [PATCH v12 2/5] drm: implement top-down allocation
 method

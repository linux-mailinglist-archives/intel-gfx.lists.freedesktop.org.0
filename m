...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFBA711029F
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 17:40:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89EEA6EA0A;
	Tue,  3 Dec 2019 16:40:09 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 10/12] media: constify fb ops across all
 drivers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A99C62602
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 18:20:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 23FBA89FA7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 01/14] drm: Include the encoder itself in
 possible_clones

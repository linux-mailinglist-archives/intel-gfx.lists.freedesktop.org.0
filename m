...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9C9635DBBE
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Apr 2021 11:49:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0F886E3DF;
	Tue, 13 Apr 2021 09:49:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x334.google.com (mail-wm1-x334.google.com
 [IPv6:2a00:1450:4864:20::334])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DCBE16E3D8
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 Apr 2021 09:49:45 +0000 (UTC)
Received: by mail-wm1-x334.google.com with SMTP id
 y124-20020a1c32820000b029010c93864955so10260658wmy.5
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 Apr 2021 02:49:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=sEeO5ZX5Shslop3lkF7k9ATcZkPxYW1hnx+6Q435sRQ=;
 b=J04Z53ohcQmPaWQNKqGV0YGViiGPD+79H6mn51x1zyp0FYSdWAcCoM2VGUF80oe3lt
 hwiwAbocN8xL7888LGWsYS6pIG5nZ3BXZIikqafZZTU2y8acxOJjRjgC8FuiL2g7KlbO
 03hdcADdQHQkGbOFUdfZGMCVta/OuUimFDW0M=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=sEeO5ZX5Shslop3lkF7k9ATcZkPxYW1hnx+6Q435sRQ=;
 b=
X-Gm-Message-State: AOAM532vnYw+aK4zq47LautZaAfIq1Cfv8iXUqrNVSK0kJpnDp4m9aWE
 gk81xrjuz1WPmMES4KsWT1GA8g==
X-Google-Smtp-Source: ABdhPJyXRQQlg/VlP9dHtGsnIBUmij8Y0hpj+V1FBDtgwK0qm3hD0UkUrCs2/32/O8T0UNC4QhImbg==
X-Received: by 2002:a05:600c:2f9a:: with SMTP id
 t26mr3126114wmn.111.1618307384583; 
 Tue, 13 Apr 2021 02:49:44 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id x15sm1945964wmi.41.2021.04.13.02.49.43
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 13 Apr 2021 02:49:44 -0700 (PDT)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Tue, 13 Apr 2021 11:49:36 +0200
Message-Id: <20210413094937.3736541-2-daniel.vetter@ffwll.ch>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/3] drm/vgem: use shmem helpers
...
ZHJpdmVycy9ncHUvZHJtL0tjb25maWcKaW5kZXggM2MxNmJkMWFmZDg3Li40ZTQxYWY1MGJjOGMg
MTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9LY29uZmlnCisrKyBiL2RyaXZlcnMvZ3B1L2Ry
bS9LY29uZmlnCkBAIC0yNzUsNiArMjc1LDcgQEAgc291cmNlICJkcml2ZXJzL2dwdS9kcm0va21i

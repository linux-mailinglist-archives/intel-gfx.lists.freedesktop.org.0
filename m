...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F23A173C8
	for <lists+intel-gfx@lfdr.de>; Wed,  8 May 2019 10:28:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D8EA8981B;
	Wed,  8 May 2019 08:28:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6F5C389728
 for <intel-gfx@lists.freedesktop.org>; Wed,  8 May 2019 08:28:25 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16485936-1500050 
 for multiple; Wed, 08 May 2019 09:07:12 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  8 May 2019 09:07:00 +0100
Message-Id: <20190508080704.24223-36-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 36/40] drm/i915: Stop retiring along engine
...
ZGV4IGFlNGM5NmJhMDJhOS4uYzZmYzBlOGMzODc2IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9k
...
X2V4ZWN1dGVfY2Ioc3RydWN0IGlycV93b3JrICp3cmspCkBAIC02MDUsMTIgKzU3NSw5IEBAIHN0
...
CiB9CiAKIHN0YXRpYyBub2lubGluZSBzdHJ1Y3QgaTkxNV9yZXF1ZXN0ICoKQEAgLTYyNSw2ICs1
OTIsMTUgQEAgcmVxdWVzdF9hbGxvY19zbG93KHN0cnVjdCBpbnRlbF9jb250ZXh0ICpjZSwgZ2Zw

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0B7C624EC2
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Nov 2022 01:15:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C94FF10E156;
	Fri, 11 Nov 2022 00:15:27 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915/guc: add the GSC CS to the GuC capture
 list

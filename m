...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F816410360
	for <lists+intel-gfx@lfdr.de>; Sat, 18 Sep 2021 06:20:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01AC46F3A5;
	Sat, 18 Sep 2021 04:20:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8E5BE6F3A5
 for <intel-gfx@lists.freedesktop.org>; Sat, 18 Sep 2021 04:19:48 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10110"; a="222948832"
X-IronPort-AV: E=Sophos;i="5.85,303,1624345200"; d="scan'208";a="222948832"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Sep 2021 21:19:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.85,303,1624345200"; d="scan'208";a="652066443"
...
Date: Fri, 17 Sep 2021 21:20:02 -0700
Message-Id: <20210918042008.29468-12-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 11/17] drm/i915/pxp: start the arb session
 on demand
...
@@ -125,7 +126,7 @@ void intel_pxp_mark_termination_in_progress(struct intel_pxp *pxp)
...
@@ -144,31 +145,41 @@ static void intel_pxp_queue_termination(struct intel_pxp *pxp)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CF6F178A643
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Aug 2023 09:09:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84FC910E21D;
	Mon, 28 Aug 2023 07:09:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id 56E6F10E21D;
 Mon, 28 Aug 2023 07:09:46 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 4F7F2AADF2;
 Mon, 28 Aug 2023 07:09:46 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============5250014581483698209=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Suraj Kandpal" <suraj.kandpal@intel.com>
Date: Mon, 28 Aug 2023 07:09:46 -0000
Message-ID: <169320658629.20017.9428472002239452585@emeril.freedesktop.org>
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_120456v12:
...
#### Possible regressions ####
  ...
  * igt@dmabuf@all-tests@sanitycheck:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_13569/bat-kbl-2/igt@dmabuf@all-tests@sanitycheck.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_120456v12/bat-kbl-2/igt@dmabuf@all-tests@sanitycheck.html
...
#### Issues hit ####
  ...
  * igt@dmabuf@all-tests@dma_fence:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_13569/bat-kbl-2/igt@dmabuf@all-tests@dma_fence.html
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_120456v12/bat-kbl-2/igt@dmabuf@all-tests@dma_fence.html
...
<p>Serious unknown changes coming with Patchwork_120456v12 absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_120456v12, please notify your bug team to allow them<br />
...
<p>Here are the unknown changes that may have been introduced in Patchwork_120456v12:</p>
<h3>IGT changes</h3>
<h4>Possible regressions</h4>
<ul>
<li>igt@dmabuf@all-tests@sanitycheck:<ul>
<li>bat-kbl-2:          <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_13569/bat-kbl-2/igt@dmabuf@all-tests@sanitycheck.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_120456v12/bat-kbl-2/igt@dmabuf@all-tests@sanitycheck.html">ABORT</a></li>
</ul>
</li>
</ul>
<h2>Known issues</h2>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B84D47AA9
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jun 2019 09:19:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAF6A891AD;
	Mon, 17 Jun 2019 07:19:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5389D8919C
 for <intel-gfx@lists.freedesktop.org>; Mon, 17 Jun 2019 07:19:37 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16923045-1500050 
 for multiple; Mon, 17 Jun 2019 08:19:14 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 17 Jun 2019 08:18:59 +0100
Message-Id: <20190617071912.20256-9-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/22] drm/i915: Make the semaphore saturation
 mask global
...
Cc: Dmitry Ermilov <dmitry.ermilov@intel.com>, matthew.auld@intel.com,
...
YyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2NvbnRleHQuYwppbmRleCA0MmY0NTc0
NGQ4NTkuLjJjNDU0ZjIyN2MyZSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3Qv
...
Z3QvaW50ZWxfZW5naW5lX3BtLmMKaW5kZXggZDE0ZTM1MmIwYjE3Li4yY2UwMGQzZGM0MmEgMTAw
...
LmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlcXVlc3QuYwppbmRleCA5OGU0NzQzYjAz
YmUuLjI3Yjk4OTNmYThlMyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9y
...
UFRIX05FU1RJTkcpOwpAQCAtNzk4LDcgKzc5OCw3IEBAIGFscmVhZHlfYnVzeXdhaXRpbmcoc3Ry

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 901404B3A53
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Feb 2022 09:52:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BDC610F369;
...
Subject: [Intel-gfx] [PATCH v12 1/5] drm: improve drm_buddy_alloc function

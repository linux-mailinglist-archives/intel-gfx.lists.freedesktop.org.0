...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DD40849CDE5
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jan 2022 16:22:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A07F310E747;
	Wed, 26 Jan 2022 15:22:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9A4C410E5DD;
 Wed, 26 Jan 2022 15:22:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643210526; x=1674746526;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=efH+68cun8HAkERBxl9DrfE+YmZTA2D08glErv7i46s=;
 b=JPpvVQ0HkL/t+NaOipjv1zPou6x/wLOLQi9ZAJK+y/mNSLFCDF9FR9+z
 /yoVmkC8dL6RCSjgY4/eTwQL3o+tNjaqqFX3JiJ56yP+Aa6IXEkQEYEtF
 WHaWzLfgBlQ7pESMEd+FCj0vG8bjwCxjbai+qeXVxCgk4tmjPAvMyWwAM
 Z+MN7Ye5fvvrViWHzxEgS57UTTTSYOhPzM2+UU//28mBtUH69XmV1/Z2W
 mZeO3TElIDO4mfI6aQarH7niQtvf4tZpmM/eNfHIpCfjBIAsz11WAJLC9
 SpJpeXFsI5cgGU6uifjST9DOc/iPk5duO3zr8Nj+sz5Auh34+yYbBKfvB A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10238"; a="309885192"
X-IronPort-AV: E=Sophos;i="5.88,318,1635231600"; d="scan'208";a="309885192"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Jan 2022 07:22:06 -0800
X-IronPort-AV: E=Sophos;i="5.88,318,1635231600"; d="scan'208";a="674386219"
...
Date: Wed, 26 Jan 2022 15:21:36 +0000
Message-Id: <20220126152155.3070602-2-matthew.auld@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20220126152155.3070602-1-matthew.auld@intel.com>
References: <20220126152155.3070602-1-matthew.auld@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 01/20] drm: improve drm_buddy_alloc function

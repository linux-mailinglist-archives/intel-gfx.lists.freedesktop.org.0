...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E71BDD581A
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Oct 2019 22:30:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E0E5989F0A;
	Sun, 13 Oct 2019 20:30:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EDEB189F0A
 for <intel-gfx@lists.freedesktop.org>; Sun, 13 Oct 2019 20:30:34 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18824631-1500050 
 for multiple; Sun, 13 Oct 2019 21:30:13 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 13 Oct 2019 21:30:12 +0100
Message-Id: <20191013203012.25208-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.23.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/execlists: Tweak virtual unsubmission
...
L2d0L2ludGVsX2xyYy5jCmluZGV4IGU2YmY2MzNiNDhkNS4uMDM3MzJlM2Y1ZWM3IDEwMDY0NAot
LS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYworKysgYi9kcml2ZXJzL2dw
dS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYwpAQCAtODk1LDcgKzg5NSw2IEBAIF9fdW53aW5kX2lu
...
dWU7IC8qIFhYWCAqLwpAQCAtOTEwLDggKzkwOSw3IEBAIF9fdW53aW5kX2luY29tcGxldGVfcmVx
...
cmlvKSB7CiAJCQkJcHJpbyA9IHJxX3ByaW8ocnEpOwpAQCAtOTIyLDYgKzkyMCw4IEBAIF9fdW53

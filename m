...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C398C6E7ED0
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Apr 2023 17:47:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5CFC110E9F9;
	Wed, 19 Apr 2023 15:47:05 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 4/5] drm/i915/uc: Split firmware table
 validation to a separate function

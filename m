...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 183AB5F98BF
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Oct 2022 08:59:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 870EE10E668;
...
Subject: [Intel-gfx] [PATCH v3 00/17] drm/i915/vm_bind: Add VM_BIND
 functionality

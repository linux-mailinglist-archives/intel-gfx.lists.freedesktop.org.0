...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F6454A6CA7
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Feb 2022 09:08:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E40210F9A8;
...
Subject: [Intel-gfx] [PATCH v2 2/6] drm/arm/komeda : change driver to use

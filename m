...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 80CDE21790C
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Jul 2020 22:14:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB8E689CA0;
	Tue,  7 Jul 2020 20:13:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x344.google.com (mail-wm1-x344.google.com
 [IPv6:2a00:1450:4864:20::344])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 837F989137
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Jul 2020 20:13:09 +0000 (UTC)
Received: by mail-wm1-x344.google.com with SMTP id 22so479315wmg.1
 for <intel-gfx@lists.freedesktop.org>; Tue, 07 Jul 2020 13:13:09 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=J/s3MmMboTlzjq+8NZ+kuHYErla2b65vDUsaQSqJLtQ=;
 b=
X-Gm-Message-State: AOAM530PMjp++mDyeTVxvvmucTzq86mlM/zxD5A2B8euh4Rw5CcAnDwB
 qR7NwvCC6QoFhJVvHFiyn5b/bw==
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 22/25] drm/scheduler: use dma-fence annotations
 in tdr work

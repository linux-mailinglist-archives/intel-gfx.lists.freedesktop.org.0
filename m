...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 39C236A1F97
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Feb 2023 17:26:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B13C10EC6D;
	Fri, 24 Feb 2023 16:26:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3207C10EC6D;
 Fri, 24 Feb 2023 16:26:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1677255996; x=1708791996;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=lPUDOnAmX565DHDLMcFs36/ULrY7H4Fr0xrY7II2sxI=;
 b=bsgq7DfGep2cQ5DMNQlV3Ww034XLtgiV49Gba4NvvYpLC0TQ5TgdFxAZ
 DZ6fgRDDyvExz+HR1VPIvutMuJKsrus5tt7vPok9RgOgIpLE5ehYrPTdz
 5Vg4xxVPO8dq7cRRFLjC8qEssDvaq6gWH+i+T+x0j5CCgYliFrY0o7j1S
 Lu5XP5d8+QdevKl+edYuhNADGViS9Q9YyiN8urVJUIwcpQTysRHJeCJY3
 seB5yPcDYRAaYDqVP71sGf/KhcD14zCf7TxKB7xPrOzngltcJ4Bj0pb0T
 r4rH9qQTkmphBSnx8MUblYlhuVq36KjGl4xMoButWqBpj9UT3FnH3RSvM A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10631"; a="317273396"
X-IronPort-AV: E=Sophos;i="5.97,325,1669104000"; d="scan'208";a="317273396"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Feb 2023 08:26:22 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10631"; a="705321902"
X-IronPort-AV: E=Sophos;i="5.97,325,1669104000"; d="scan'208";a="705321902"
Received: from lab-ah.igk.intel.com ([10.102.42.211])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Feb 2023 08:26:18 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
Date: Fri, 24 Feb 2023 17:25:41 +0100
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230224-track_gt-v1-2-0222096fcdc6@intel.com>
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH 2/3] drm/i915: Track leaked gt->wakerefs

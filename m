...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D5D44B3A7D
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Feb 2022 10:15:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 53D8810F4BE;
	Sun, 13 Feb 2022 09:15:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5629C10F4BE
 for <intel-gfx@lists.freedesktop.org>; Sun, 13 Feb 2022 09:15:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644743716; x=1676279716;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=yx4apeihRJA8rpx703O/6tqHMvLMf7P1ttNBudtZe2E=;
 b=VzzxLWGKbUJtvNqd334JDIeCz+FV2qkzGcegpavPMCmlJ+7ZuwYgktR5
 b7EddXEpLdUXHlgGXKyKkEwMhyP9e779cnift+EepPGhQaG9gxRx7/2xa
 93qCdrqvyGqoUuVuvkBLJhIE+BqUFGzp+mRDLiltZth4LvGjo55Qo2t3T
 Cxet/1j82oJGlrzhyfiQTe4ysKZdaCBXrpp7epTunoRuEztdNcDZ0OEeF
 arI2jc3wRlUdYXfX77Re9L77kGn92dOCMy3x1IadsbhwrQz5QmhdfHV8U
 wGf5+aP8kz1P9X28oDHDh1Dg76cYLACnNbFof5fh3PZHy3Zp+sJbuA8S6 w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10256"; a="247528784"
X-IronPort-AV: E=Sophos;i="5.88,365,1635231600"; d="scan'208";a="247528784"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2022 01:15:16 -0800
X-IronPort-AV: E=Sophos;i="5.88,365,1635231600"; d="scan'208";a="702568973"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2022 01:15:12 -0800
...
Date: Sun, 13 Feb 2022 11:14:54 +0200
Message-Id: <20220213091458.2364014-2-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 1/5] drm/i915/gsc: add gsc as a mei auxiliary
 device

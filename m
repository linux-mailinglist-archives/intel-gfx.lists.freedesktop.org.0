...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C3EDE879634
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Mar 2024 15:29:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D6F4112E6A;
	Tue, 12 Mar 2024 14:29:33 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SbBDpHWJ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3DC0010F3DC
 for <intel-gfx@lists.freedesktop.org>; Tue, 12 Mar 2024 14:29:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710253772; x=1741789772;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=b0n4kgeMWYT8AdSoDSNob0uwJDPCz4vqxQjIOYBOW1o=;
 b=SbBDpHWJv40t8T7JekeBiW1xHU1Y/ugwvj3eLWGxvBTPFyANjyoxaprO
 xjm+KPd3/bq7k5s2o+TwO5si/ZUFIGB5qwRR18x32rsMsXDB7R8P1qJSF
 hCexX5a29VYhMrPLbW48ayhHrP+CTTYSar2IoFCgSYOz1yxCSVdPhmd50
 /8Pd8oVYehQ9Nyq8IjmfbjJMsza3fxeUK/TMxgkEARMXJbcRqb3BlUClu
 Bq1yh1sB3SvpaRNdbXuY1wGcy+xSsFC8luFbV1jF75gcb7lgHHFfXyOtf
 Yc4ouFoK4zjTwYoPqzKgHBbF2SKbpjqr30Be7cTn6nS2lK9pBJyEAHDXD w==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="4818350"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="4818350"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 07:29:32 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="11612492"
Received: from rfreedx-mobl.amr.corp.intel.com (HELO localhost)
 ([10.252.35.216])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 07:29:29 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@intel.com, ville.syrjala@linux.intel.com, imre.deak@intel.com
Subject: [RFC 5/7] drm/i915/display: use intel_encoder_is/to_* functions
Date: Tue, 12 Mar 2024 16:29:00 +0200
Message-Id: <c89bda48806a4473215321d2816d51d501c12ddc.1710253533.git.jani.nikula@intel.com>
...
index fe00c34b5127..79ef7ca83de5 100644
...
index f98ef4b42a44..eaad8b00d956 100644
...
index ff480f171f75..393b8f921f4d 100644
--- a/drivers/gpu/drm/i915/display/intel_dpll_mgr.c
+++ b/drivers/gpu/drm/i915/display/intel_dpll_mgr.c
@@ -3389,7 +3389,6 @@ static int icl_get_tc_phy_dplls(struct intel_atomic_state *state,
...
@@ -3408,8 +3407,7 @@ static int icl_get_tc_phy_dplls(struct intel_atomic_state *state,
...
+	dpll_id = icl_tc_port_to_pll_id(intel_encoder_to_tc(encoder));
 	port_dpll->pll = intel_find_shared_dpll(state, crtc,
 						&port_dpll->hw_state,
 						BIT(dpll_id));
@@ -3435,15 +3433,12 @@ static int icl_compute_dplls(struct intel_atomic_state *state,
 			     struct intel_crtc *crtc,
 			     struct intel_encoder *encoder)
 {
-	struct drm_i915_private *i915 = to_i915(state->base.dev);
...
@@ -3452,15 +3447,12 @@ static int icl_get_dplls(struct intel_atomic_state *state,
 			 struct intel_crtc *crtc,
 			 struct intel_encoder *encoder)
 {
-	struct drm_i915_private *i915 = to_i915(state->base.dev);

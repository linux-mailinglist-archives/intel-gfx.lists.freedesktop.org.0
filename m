...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B1B1F305BBC
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Jan 2021 13:41:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3141B6E7E6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 4/5] drm/i915: Don't assign to struct
 drm_device.pdev

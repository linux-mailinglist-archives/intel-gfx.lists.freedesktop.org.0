...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F30E3F802E
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Aug 2021 04:02:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D2556E483;
...
Subject: [Intel-gfx] [PATCH v8 1/7] drm: fix null ptr dereference in
 drm_master_release

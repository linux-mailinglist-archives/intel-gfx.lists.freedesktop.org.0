...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6201D6EA088
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 02:17:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9CF3B10ED67;
	Fri, 21 Apr 2023 00:17:32 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 4/4] drm/i915/gsc: add support for GSC proxy
 interrupt
...
Cc: "gregkh@linuxfoundation.org" <gregkh@linuxfoundation.org>, "Usyskin,

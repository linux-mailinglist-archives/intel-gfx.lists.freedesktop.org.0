...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A730E723EC5
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Jun 2023 12:01:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 100D410E32B;
	Tue,  6 Jun 2023 10:01:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6A74C10E31C;
 Tue,  6 Jun 2023 10:01:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686045670; x=1717581670;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PL/gmou32nKKbBBVAN/tX+mvKEnpb0P5aKJ/w+x9CrY=;
 b=FUypATJUfKjLqvC47dY7Bw3FO4+/NFzRxUwz16Aa0knnXIzlhnnxngOM
 r1fIlajYbNfPmw0bm4ZtKTxdchtHU9jISOMkHWhe6XA77rKR2NBvffNvS
 hXCQIpkG7aXnP4w1tWLxHaRxPo7VgOwSDePmju8aPOR2gYaW7rEbyhHsT
 E+/9+9B7sCdchi4ZuPuL9urd5fCNlTCvybK0eHYJojQbvZyVSJQXEnqaa
 2vw+I5cTkRFAn4oPAHEwBuff+qkSaA9p86cJ3zHMYJ3OZKBeHJgnzqdAF
 IuUX12VesfbDTMuU/XCSG9GxYizslhobpxXPJpf5RHe9QrlIZAU76g7us g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="356632521"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="356632521"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2023 03:01:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="709021161"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="709021161"
Received: from yuguen-mobl2.ger.corp.intel.com (HELO intel.com)
 ([10.252.57.68])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2023 03:01:05 -0700
From: Andi Shyti <andi.shyti@linux.intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>,
 Fei Yang <fei.yang@intel.com>
Date: Tue,  6 Jun 2023 12:00:42 +0200
Message-Id: <20230606100042.482345-2-andi.shyti@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH v17 1/1] drm/i915: Allow user to set cache at BO
 creation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BB591562B2
	for <lists+intel-gfx@lfdr.de>; Sat,  8 Feb 2020 03:17:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF18C6E15A;
...
Subject: Re: [Intel-gfx] [PATCH v3] drm/hdcp: optimizing the srm handling

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F4F23B85EE
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 17:10:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 010106EA21;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 06/17] drm/uAPI: Add "active color format"

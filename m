...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 639ACACDC42
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Jun 2025 13:02:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D37410E712;
	Wed,  4 Jun 2025 11:02:39 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="H9HNBU5U";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 40C0F10E712;
 Wed,  4 Jun 2025 11:02:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1749034957; x=1780570957;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=QF6LPfb/aJwgi5moq9xyBLIxbOzpfUyh5QIrFnfip7w=;
 b=H9HNBU5UKdOP0ZoSKshab0a8kn9ArSl8KvfgCM9yEqto0aHLzECOGLh6
 t9E/KY52hZvJ5mkCjb0lpr/mCb9qvub/RazJ45ZDGunI7Dio+4JySglJ5
 wgaXHqGQUOiw6M9Jjw9+gLb0HFml9PkXp+uB4pSpdEQ2932Kx307CLBKX
 OZzZFzytkMlhPdeBYTxPQJcI8iffn/ATit0Gcr0tuwCMsPUB7GpGG9NeV
 UYyoiTICyRY1YQuA0Er5Isb5qbkaBra86NsRgo4kBr5SUAtVzEuPXm4aO
 tMWXRASXB68F/2pedngsIOr5W6//3TlVLZmQlC1NLKwZwd64Vh61g+ZFe g==;
X-CSE-ConnectionGUID: nqWmPak/RyK/qk2eSrPE/A==
X-CSE-MsgGUID: BHJ0N9TWToKbU2NXMd/mUA==
X-IronPort-AV: E=McAfee;i="6700,10204,11453"; a="51252567"
X-IronPort-AV: E=Sophos;i="6.16,209,1744095600"; d="scan'208";a="51252567"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jun 2025 04:02:36 -0700
X-CSE-ConnectionGUID: sNXEpaiyT8extocmKiiiFQ==
X-CSE-MsgGUID: gnNX+/4+SziqkEU64tX26A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,209,1744095600"; d="scan'208";a="176107500"
Received: from abityuts-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.245.101])
 by orviesa002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jun 2025 04:02:32 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, Suraj Kandpal <suraj.kandpal@intel.com>,
 =?UTF-8?q?Ville=20Syrj=C3=A4l=C3=A4?= <ville.syrjala@linux.intel.com>
Subject: [PATCH v3] drm/i915: split out display register macros to a separate
 file
Date: Wed,  4 Jun 2025 14:02:25 +0300
Message-Id: <20250604110225.993638-1-jani.nikula@intel.com>
...
---
 ...
 .../gpu/drm/i915/display/intel_display_regs.h | 2959 +++++++++++++++++
 ...
 drivers/gpu/drm/i915/i915_reg.h               | 2948 ----------------
 drivers/gpu/drm/i915/intel_gvt_mmio_table.c   |    1 +
 drivers/gpu/drm/xe/display/xe_plane_initial.c |    1 +
 73 files changed, 3042 insertions(+), 2959 deletions(-)
...
index 8e4e938f1ee5..1f9db5118777 100644
...
index 026361354e6f..a825dbe0a46e 100644
...
index f0c673e40ce5..38b3094b37d7 100644
...
index 82606ebae1de..d98b47a07451 100644
...
index 04ef729dae0b..6a1c5a4326fe 100644
...
index 4c845dd410a2..cbd1060e9664 100644
...
index 06f58c062b29..b0c7c46ffbe2 100644
...
index b671b4ea1a24..ce3f9810c42d 100644
...
index 1d8c2036d967..a4070f40e26f 100644
...
index 0c9fff26653b..8d0dcf252bed 100644
...
index d7f5d3dbb8a1..92f44c1ddce9 100644
...
index b4c302544909..8c9a637b9407 100644
...
index 02e3c22be21e..cba96f920fd2 100644
...
index 000000000000..9d17f1685bc3
--- /dev/null
...
index a7ba17361d63..a10e56e7cf31 100644
...
index 208a953b04a2..d04609460e8c 100644
...
index cc00a73898f1..7d13f9e3f4c5 100644
...
index 552dd984ade9..1dc12772d0c8 100644
...
index db98e2758271..fa6a7d2b7075 100644
...
index 28b3f5ea4219..2bcbeb7232d7 100644
...
index ce5aa0ca0fa5..6914aac6a8f5 100644
...
index a4a996018a82..1a03c0ef2054 100644
...
index 29c920983413..6e1a23cc0aad 100644
...
index b1d2ba9b7295..8039a84671cc 100644
...
index d55cc77650b7..a86fcf0cb178 100644
...
index 98033471902c..2fc8a75f96f6 100644
...
index 22c5302e3798..05e1b309ba2c 100644
...
index ca85596dfc9e..3456c794e0e7 100644
...
index 9f6102d7c7be..9710ecb08c77 100644
...
index 1253376c7654..d93773f943db 100644
...
index db7111374293..8bee2f592ae7 100644
...
index 8a38df2c0283..b217fc5c87b1 100644
...
index acf0b3733908..3b9801a3ad04 100644
...
index c55b8144e234..9c2c1881ea13 100644
...
index c855426544cf..1101982f6c11 100644
...
index c7b336359a5e..7acba42499b7 100644
...
index 5eb81f1d2f97..2ec78dc8765e 100644
...
index 62d744363598..a91e23c22ea1 100644
...
index 6fed71f8198f..74197e337585 100644
...
index 112f6723c427..a8079cfa8e1d 100644
...
index 9b001776a960..b67a247c4738 100644
...
index 8822c639a4f4..ba786327836d 100644
...
-
 ...
 enum skl_power_gate {
 	SKL_PG0,
@@ -3403,193 +1214,6 @@ enum skl_power_gate {
 	ICL_PG4,
 };
...
@@ -3607,489 +1231,6 @@ enum skl_power_gate {
...
@@ -4097,30 +1238,6 @@ enum skl_power_gate {
...
@@ -4135,45 +1252,6 @@ enum skl_power_gate {
...
@@ -4182,37 +1260,11 @@ enum skl_power_gate {
...
index e83dc30e658d..3e535c58bcec 100644
...
index fada6f877bca..ea54c8a98602 100644

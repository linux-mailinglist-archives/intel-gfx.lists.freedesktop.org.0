...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1E5836E130
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Apr 2021 23:53:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A7D026EC5F;
	Wed, 28 Apr 2021 21:53:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2E46D6EC5C
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 Apr 2021 21:53:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1619646798;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=w7Y9JD2dvmt6EyGfKJs2omyWpv63r+TiGZAW3mPzPS0=;
 b=Srt8+WKW7HkgmvJTVbne8dLZ4VqeKmfrFEv2OWAJxNTkdSK+ittc17tcbKQxhmxFKaLJqW
 b+TZ06Q0IW+Yu8yotbOvVcMCrlWhk129dLfgcK5IYmOlE5aURpuIjjneyqEit1oA+RuM2R
 lueI4IjIiUItkx2NL2liUoAfGd8CNwQ=
...
Subject: [Intel-gfx] [PATCH 2/9] drm/connector: Add a fwnode pointer to
 drm_connector and register with ACPI

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9297A766D21
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jul 2023 14:23:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1977710E1FB;
	Fri, 28 Jul 2023 12:23:31 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 70EAC10E1FB;
 Fri, 28 Jul 2023 12:23:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690547009; x=1722083009;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=40j1reglk4U5D3eiJtnAxw7PeItahT7KQdd+o5xDR7k=;
 b=kClfCqvZ9pRw/uaohog3vUM4RVOhIxjQNCwN7Njht+O/U0BvoMLeFmFs
 ulMoqjczxThO5VUGoNs5217ybZdPcNbL0boeSkUUC1kSnyyo3jZFSRdXL
 1AxRCT3BZmGmPQw4p2MkhCU8CfC4VWdKpzij7HxhwCKO0LY5czE2L8ygX
 H15Ljg7gk24UxJaS+ToY2hr+4uksBvRSw3h14YG3U51PodY4ecM+m9csS
 zp4BLB5RJ+lLGzhf3tNznwmeo++AIdKI8/+/7Bwt2NnEkZGffAUrxBy0E
 KFcRVU8F8AKqJzHLBgJZQ/k50UIODeCd8Zz/V2zit2Cmu2uv+xInwvpeU A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="353488039"
X-IronPort-AV: E=Sophos;i="6.01,237,1684825200"; d="scan'208";a="353488039"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 05:23:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="792925872"
X-IronPort-AV: E=Sophos;i="6.01,237,1684825200"; d="scan'208";a="792925872"
Received: from atoomey-mobl.amr.corp.intel.com (HELO [10.213.197.30])
 ([10.213.197.30])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 05:23:26 -0700
Message-ID: <891f5f58-16c5-509d-2903-1c149d3dc2d3@linux.intel.com>
Date: Fri, 28 Jul 2023 13:23:24 +0100
MIME-Version: 1.0

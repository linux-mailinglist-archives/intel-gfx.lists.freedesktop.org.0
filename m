...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 35EF55E8F0F
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Sep 2022 19:52:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 201F010E023;
	Sat, 24 Sep 2022 17:52:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 772B810E023
 for <intel-gfx@lists.freedesktop.org>; Sat, 24 Sep 2022 17:52:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664041947; x=1695577947;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=wlS4ayZnyHgEiwHOJrfI2yFWy8aB8EJXZxAFnr/YWQc=;
 b=mcZyyCm9uMxW37ypA9FFCu2fpWb+vhKIiqCj7hDo71meKuGfn3EsAq4u
 LfHIrTG0Ip3fnyHIXyQugA3PmxNt5tc/8LERJhmXVjQy1TvziFHk5zeep
 nc3mYDRrKM8AgDrX99jG/tL2lGgR72CdokIWxOC5nsldZTMpC93UE6lA0
 12yedy2CB7n+SZc36vh34mduc2sthp4sKGaG1v6E/FjEc0CpeehKAVh3k
 t6iYy73aR3h4Ob4ouZ+SBkonDI8vu5zE57fF0nXbCUxD34vQ/OqgeO2tn
 gG3dZeboSN8sXjG3UMpz3Z3zplbK3ghI6oZM8M+PWb53hdqhR5BSlCvfb Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10480"; a="283910927"
X-IronPort-AV: E=Sophos;i="5.93,342,1654585200"; d="scan'208";a="283910927"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Sep 2022 10:52:26 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,342,1654585200"; d="scan'208";a="724524757"
...
To: "Vivi, Rodrigo" <rodrigo.vivi@intel.com>, "tvrtko.ursulin@linux.intel.com"
 <tvrtko.ursulin@linux.intel.com>, "Gupta, Anshuman"
...
X-ClientProxiedBy: BEXP281CA0011.DEUP281.PROD.OUTLOOK.COM (2603:10a6:b10::21)
 To MW5PR11MB5810.namprd11.prod.outlook.com
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230022)(39860400002)(366004)(376002)(346002)(396003)(136003)(451199015)(38100700002)(82960400001)(6486002)(478600001)(83380400001)(53546011)(2906002)(36756003)(5660300002)(36916002)(110136005)(86362001)(186003)(31696002)(6506007)(66556008)(316002)(66946007)(6666004)(31686004)(66476007)(8936002)(41300700001)(26005)(8676002)(6512007)(4326008)(54906003)(2616005)(6636002)(45980500001)(43740500002);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 Sep 2022 17:52:21.7875 (UTC)

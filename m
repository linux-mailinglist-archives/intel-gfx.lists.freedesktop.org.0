...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FABE6D1B2
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jul 2019 18:15:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34BE06E43F;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 1F0g==
Subject: [Intel-gfx] [PATCH v1 05/11] drm/vblank: drop use of DRM_WAIT_ON()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EBA814C9E21
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Mar 2022 08:03:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4119F10ED99;
	Wed,  2 Mar 2022 07:03:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3D54A10ED9B
 for <intel-gfx@lists.freedesktop.org>; Wed,  2 Mar 2022 07:03:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1646204633; x=1677740633;
 h=message-id:subject:from:to:cc:date:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=AJsWiuHt+5a2alWYfcuOVqSTwjn017fRmVmPeONbo24=;
 b=INOUdGNukItvogGCvtU3h0hp0TNNPr/PzGnhs+nTztxHoNgw9l/VBCzW
 9jLYoGfGjUqsUHYsItIVVYLCCthwsf5jyy0wy9Q9YkQ3xUp91N+2whuwj
 Ra+har5rCYOW6yLAN2TGjGSxk+S2lO7nOObpCX0tPOjC0KXza2CVGJpKe
 0sXXk9ZZ2RhYG9nkyg8Fqnls7Z6YD8/T+y3MjZd6wSykpvpgraWTkNamR
 lKrnZgKq3smiV1qHTMO3LbkOxsBx0WyJcqMmOXGn1gkQ/bNzD9jdSSdJe
 5/99DylyX1mTZ4aFVZsrndz6ZS461/Xu8quldjBl184yyH5xweGXov6bB g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10273"; a="250902900"
X-IronPort-AV: E=Sophos;i="5.90,148,1643702400"; d="scan'208";a="250902900"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2022 23:03:52 -0800
X-IronPort-AV: E=Sophos;i="5.90,148,1643702400"; d="scan'208";a="593909401"
Received: from ccrisan-mobl3.ger.corp.intel.com (HELO [10.249.254.224])
 ([10.249.254.224])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2022 23:03:51 -0800
Message-ID: <c1963c308a4ce2c6e2de0dea37f76353e3f57c5b.camel@linux.intel.com>
From: Thomas =?ISO-8859-1?Q?Hellstr=F6m?= <thomas.hellstrom@linux.intel.com>
To: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
Date: Wed, 02 Mar 2022 08:03:20 +0100
In-Reply-To: <20220302031326.GD25117@nvishwa1-DESK>
References: <20220222171030.690214-1-thomas.hellstrom@linux.intel.com>
 <20220302031326.GD25117@nvishwa1-DESK>
Content-Type: text/plain; charset="UTF-8"
User-Agent: Evolution 3.40.4 (3.40.4-2.fc34) 
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: Re: [Intel-gfx] [PATCH 1/2] HAX: drm/i915: Clarify vma lifetime

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FDAF391ED
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jun 2019 18:26:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E68989DD2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/4] drm/fb-helper: Do not assume

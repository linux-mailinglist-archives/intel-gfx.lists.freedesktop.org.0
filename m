...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5996F393156
	for <lists+intel-gfx@lfdr.de>; Thu, 27 May 2021 16:47:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E6E2A6F3C9;
	Thu, 27 May 2021 14:47:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5817C6ED82;
 Thu, 27 May 2021 14:47:30 +0000 (UTC)
IronPort-SDR: AfIe94mhxp6hLQ9EdgwFLB2wpNF4LpJ4oG/SDjgtPq914+SIxhZkJMKPZbDkVosZAHH5jEhhnJ
 AAlvKWxumpLg==
X-IronPort-AV: E=McAfee;i="6200,9189,9996"; a="202515574"
X-IronPort-AV: E=Sophos;i="5.82,334,1613462400"; d="scan'208";a="202515574"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 May 2021 07:47:29 -0700
IronPort-SDR: Wb39/iqavLYjX+SaZTYkjBqEhdVlzzuOZjq7Zx2rBGM7/lGVQGxSC49UrhEefXd+uID4mOXgpt
 lFlQl4Cq2pvQ==
X-IronPort-AV: E=Sophos;i="5.82,334,1613462400"; d="scan'208";a="443597873"
...
Message-Id: <20210527144710.1975553-5-thomas.hellstrom@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 04/15] drm/i915/ttm Initialize the ttm device
 and memory managers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DFE7588B2A
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 13:58:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9949A6E3DB;
...
Subject: Re: [Intel-gfx] [PATCH v3 36/37] drm/i915/query: Expose memory

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 39DE53D136A
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Jul 2021 18:11:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C8BE6E88A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 00/14] drm/i915/guc: Enable GuC based power
 management features

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EFBEA41F0C8
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Oct 2021 17:12:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C78576EE17;
	Fri,  1 Oct 2021 15:12:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qk1-x736.google.com (mail-qk1-x736.google.com
 [IPv6:2607:f8b0:4864:20::736])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C6AC16EE1C
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 Oct 2021 15:12:22 +0000 (UTC)
Received: by mail-qk1-x736.google.com with SMTP id q81so9454239qke.5
 for <intel-gfx@lists.freedesktop.org>; Fri, 01 Oct 2021 08:12:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=jHYsW5SDwsxwixxkeHCMzoTK5RAaQvtRbdnEIObmcNA=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=jHYsW5SDwsxwixxkeHCMzoTK5RAaQvtRbdnEIObmcNA=;
 b=
X-Gm-Message-State: AOAM533UpyxDe+6eRaZ7EjwPkq/2RHtOD7Uk8g1gXMQ3X1stscMDDAB0
 WOECg93XPPqFWoyaf7Og7oXCexFglGO4ag==
X-Google-Smtp-Source: ABdhPJx+IcZb8gyC4qL84WABKFUplEQADuTFpUlD92ZLNs/k4MAWZR7FxTwxBNFGDV8frU8Ouzabjg==
X-Received: by 2002:a37:bfc3:: with SMTP id p186mr9793180qkf.479.1633101141444; 
 Fri, 01 Oct 2021 08:12:21 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id r139sm3194821qke.84.2021.10.01.08.12.20
...
Date: Fri,  1 Oct 2021 11:11:36 -0400
Message-Id: <20211001151145.55916-8-sean@poorly.run>
X-Mailer: git-send-email 2.31.0
In-Reply-To: <20211001151145.55916-1-sean@poorly.run>
References: <20211001151145.55916-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v3 07/14] drm/i915/hdcp: Use HDCP helpers for
 i915
...
@@ -3143,6 +3144,9 @@ static void intel_enable_ddi(struct intel_atomic_state *state,
...
@@ -3159,12 +3163,10 @@ static void intel_enable_ddi(struct intel_atomic_state *state,
 	else
...
@@ -3224,7 +3226,13 @@ static void intel_disable_ddi(struct intel_atomic_state *state,
...
@@ -3254,13 +3262,18 @@ void intel_ddi_update_pipe(struct intel_atomic_state *state,
 			   const struct intel_crtc_state *crtc_state,
 			   const struct drm_connector_state *conn_state)
 {
+	struct intel_connector *connector = to_intel_connector(conn_state->connector);
...
index 88e71aeb88a2..377399e1e83d 100644
...
index 632391197937..abf4046a54ac 100644
...
index fd0a31bc3dcd..d6f2de84eb56 100644
...
index d2e61f6c6e08..5421cfbfb811 100644
...
@@ -1346,120 +1354,6 @@ int intel_hdmi_hdcp_write_an_aksv(struct intel_digital_port *dig_port,
 	return 0;
 }
...
+			        struct intel_connector *connector)
 {
 	...
 	int ret;
@@ -1738,12 +1619,18 @@ int intel_hdmi_hdcp2_check_link(struct intel_digital_port *dig_port,
 }
...
@@ -1754,23 +1641,30 @@ int intel_hdmi_hdcp2_capable(struct intel_digital_port *dig_port,
 }

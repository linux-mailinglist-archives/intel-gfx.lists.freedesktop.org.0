...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B7DB6A6C5B
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Mar 2023 13:30:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2180D10E246;
	Wed,  1 Mar 2023 12:30:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 18B4B10E25A
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 Mar 2023 12:30:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1677673802; x=1709209802;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ESNqLPRiRhZIvMITsSHwOGbR6yX1uA3e1ta+KWAAhPc=;
 b=XuXMY2Ml7PjLTdrf2JFy8IZZdaXia7Txm9Br90fE8h10bTe/mx24GIED
 zNAEIKK0EkykXs2KwXuIo/mGUih44vnxvMxS3W7FwyKxgFslfMVq3NdkG
 xU3GYm5JYEPsKV1kVxGfu7MrLxiCPIdfpfao5XETlxMTTf7rz8GCMBcyI
 JQQ+TvfsQr+aOaktdFdQKT0fX8V74nChvZL/r8YJsnpZg1IrrBjWcNDac
 Gi6fZIu1ip2Y/5AhkO7wr2taTrhTFpOrIpjuF0Tnluhaj6QDYvUx07T2h
 44ecbSZmPEamVIrGZoHg2lSyNqsr5+wq/u6c50lgBN37FX34WoYPRIaDD Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10635"; a="318195906"
X-IronPort-AV: E=Sophos;i="5.98,224,1673942400"; d="scan'208";a="318195906"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2023 04:30:01 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10635"; a="676739593"
X-IronPort-AV: E=Sophos;i="5.98,224,1673942400"; d="scan'208";a="676739593"
Received: from dsvarnas-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.46.249])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2023 04:30:00 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  1 Mar 2023 14:29:43 +0200
Message-Id: <20230301122944.1298929-4-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 4/5] drm/i915/dmc: allocate dmc structure
 dynamically

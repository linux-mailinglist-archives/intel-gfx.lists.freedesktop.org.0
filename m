...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AA3973F29CA
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Aug 2021 12:03:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 998F56EA54;
	Fri, 20 Aug 2021 10:03:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pl1-x62d.google.com (mail-pl1-x62d.google.com
 [IPv6:2607:f8b0:4864:20::62d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 811E66EA51;
 Fri, 20 Aug 2021 10:03:44 +0000 (UTC)
Received: by mail-pl1-x62d.google.com with SMTP id a5so5684406plh.5;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=bkFQht7vR3ZjKExLOYXZei3qepyeU4QeAm6JOJ26wAc=;
 b=
X-Gm-Message-State: AOAM531XD5bwVLPbuhPCUNhc7/iaaAfnUZ21/8MfxfVXgHGx/3XKwWzn
 0zoXXl6WFfbGRfOlPyNqB0k=
...
X-Received: by 2002:a17:90a:c8b:: with SMTP id
 v11mr3735062pja.114.1629453823927; 
...
Subject: [Intel-gfx] [PATCH v4 2/5] drm: convert drm_device.master_mutex
 into a rwsem

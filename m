...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 244166E8F9C
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Apr 2023 12:13:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8508810E293;
	Thu, 20 Apr 2023 10:13:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CC70B10E27B;
 Thu, 20 Apr 2023 10:13:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1681985602; x=1713521602;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=RQ4EC3NRD7nUNIKWrSFUYXDVJTru00DdQtO9TYd9gnc=;
 b=HZM8RGSwos1vtL+XXNXPpi2gfL4kNuyALztusduXP2nct+eT+W9c1qQg
 BnU109REI6lfGPVOe6yh4c0ZsGInICvqQwlnCU0ug57d4+Wht0Jp0KIkf
 H3If0+sKxRIR8M4IA6XjvtQiUZAr8naGMSn7FqQyGfrCTozpbL0N0gUKx
 T9/Z2/5I8730/8T2sIT8MyZAv5L9aKkjLl8updobl4hnoO0xc1F4qWsrk
 FRExWiAtgfBFEs39Dv7ex6jBl424/xCy9cAJo+xiw3FCB0amxOIId+KJK
 PpcKdtqHOVAcn6aueX+2N+TMaDav0Bi8rHVxTJNm121NIvVYVJ/xwFjLS Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="326022280"
X-IronPort-AV: E=Sophos;i="5.99,212,1677571200"; d="scan'208";a="326022280"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Apr 2023 03:13:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="938005161"
X-IronPort-AV: E=Sophos;i="5.99,212,1677571200"; d="scan'208";a="938005161"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.17.32])
 ([10.213.17.32])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Apr 2023 03:13:19 -0700
Message-ID: <c78e153d-7656-5f74-c91d-68269bda62ac@intel.com>
Date: Thu, 20 Apr 2023 12:13:17 +0200
MIME-Version: 1.0

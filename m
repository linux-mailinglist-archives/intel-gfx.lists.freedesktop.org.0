...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D12E66C8667
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Mar 2023 20:56:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C81B10ECA3;
	Fri, 24 Mar 2023 19:56:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yw1-x112d.google.com (mail-yw1-x112d.google.com
 [IPv6:2607:f8b0:4864:20::112d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 969EB10ECA5
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 19:56:33 +0000 (UTC)
Received: by mail-yw1-x112d.google.com with SMTP id
 00721157ae682-544787916d9so51992547b3.13
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 12:56:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1679687793;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=5aRftEAJRy1MKc/62HnbajfdCPUgR0HCzpY0DMqWFuo=;
 b=dqj4yCFFQN9PFcrpD2T9a3+K60JgKT6ytBWTRt3iEyQMrW+X+jw9K6Sk6LTvaETzNA
 fvMDVlmNchmY0kVX4I9bwnQsuNIGjBKttaZI6O7yv2QjoxQjW71WnN41/bMss/8SQtlm
 ZYLUxxUrmHxhasrck5QBtd8ov/k2GYqq55Qi0=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1679687793;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=5aRftEAJRy1MKc/62HnbajfdCPUgR0HCzpY0DMqWFuo=;
 b=
X-Gm-Message-State: AAQBX9frDqV9rmfSbYDEo6BywN6Q0jqBRCiJ7UY1k9psaZCJz8Ixmfxx
 AxSM2yh89SlB/lX3kWije1kZAA==
X-Google-Smtp-Source: AKy350YkOey7Cqucgrl7Nzm68T49apOhuu6BEvc09Fzsh0B448Ve6K55s7r02M2+jfZ78e/jih9ETQ==
X-Received: by 2002:a81:5483:0:b0:541:9b48:523a with SMTP id
 i125-20020a815483000000b005419b48523amr3397618ywb.15.1679687793056; 
 Fri, 24 Mar 2023 12:56:33 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:5509:ec45:2b32:b39f])
 by smtp.gmail.com with UTF8SMTPSA id
 k30-20020a81ac1e000000b00545a08184b1sm579288ywh.65.2023.03.24.12.56.31
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Fri, 24 Mar 2023 12:56:32 -0700 (PDT)
...
Date: Fri, 24 Mar 2023 15:55:54 -0400
Message-Id: <20230324195555.3921170-11-markyacoub@google.com>
...
Subject: [Intel-gfx] [PATCH v7 10/10] drm/msm: Implement HDCP 1.x using the

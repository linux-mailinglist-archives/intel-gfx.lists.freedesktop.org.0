...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC9FB3001BB
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Jan 2021 12:39:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 93AC989EB4;
	Fri, 22 Jan 2021 11:39:03 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v1 1/2] drm/gma500: Convert to use new SCU IPC
 API

...
Received: from mail.lfdr.de
	...
	id PtCeDg56VGq2mQMAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jul 2026 07:39:26 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FE7B747474
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jul 2026 07:39:25 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=intel.com header.s=Intel header.b="RP31l6x/";
	dmarc=pass (policy=none) header.from=intel.com;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 22A5810E6F5;
	Mon, 13 Jul 2026 05:39:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 27EFD10E6F5;
 Mon, 13 Jul 2026 05:39:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1783921161; x=1815457161;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=fBXxsREueBqvcO0OpJttEV+aOshSYyfNFSEvI39D1q4=;
 b=RP31l6x/i0VptGZ9PAzuWIAgb2NjJT7hzXkF+2l3NGdD7+eMVnsZvSsq
 wChZLXwzHLtGHvyywisWT0q142zVZ1nj+ncvawJLohlUyGqKWLJsrZM7w
 L8ReL3OMeUfuTLXxoI6LK0kStnFbC6T1PjIZSbov3Gbu8kZy4WAwLRdPN
 pAK6HNXpCbE+MCGox4UwdAFncPWp19gfHhF3k9sbbcsNZnzcM86sTCcfH
 lLICuuVPzyD++OThOftRPzpBvRXoEIkZF8PARJ2gQ0u/vsxcbWlBtkv8V
 4uBiwEaHEoHIh70sWqaoRU03UEUOv59oUsnHDUBSAoxF5X1E0th2/AxV8 A==;
X-CSE-ConnectionGUID: RvBZ9JqDSgielBWDx+FzeA==
X-CSE-MsgGUID: Ke6H0WxMS5G8FxbD1RklJg==
X-IronPort-AV: E=McAfee;i="6800,10657,11841"; a="95669986"
X-IronPort-AV: E=Sophos;i="6.25,154,1779174000"; d="scan'208";a="95669986"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Jul 2026 22:39:21 -0700
X-CSE-ConnectionGUID: InaQrrAmRHafIdJsH96tdA==
X-CSE-MsgGUID: xrPtsz9HQt6IYGkfXJ/g2g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.25,154,1779174000"; d="scan'208";a="252066306"
Received: from dut-2a59.iind.intel.com ([10.190.239.113])
 by fmviesa007.fm.intel.com with ESMTP; 12 Jul 2026 22:39:19 -0700
From: Chaitanya Kumar Borah <chaitanya.kumar.borah@intel.com>
To: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org
Cc: Chaitanya Kumar Borah <chaitanya.kumar.borah@intel.com>,
 Melissa Wen <mwen@igalia.com>, Harry Wentland <harry.wentland@amd.com>
Subject: [CI v4 01/14] drm/colorop: Add DRM_COLOROP_FIXED_MATRIX
Date: Mon, 13 Jul 2026 10:45:03 +0530
Message-Id: <20260713051516.4087420-2-chaitanya.kumar.borah@intel.com>
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,lists.freedesktop.org:from_smtp,intel.com:from_mime,intel.com:email,intel.com:mid,intel.com:dkim,igalia.com:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 8FE7B747474

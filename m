...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C2DF83B95BE
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 19:56:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A8926EB7E;
	Thu,  1 Jul 2021 17:55:57 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v7 3/5] drm: add a locked version of

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DDD56520EE8
	for <lists+intel-gfx@lfdr.de>; Tue, 10 May 2022 09:43:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 11E9710E154;
	Tue, 10 May 2022 07:43:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 086C410E154
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 May 2022 07:43:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1652168615; x=1683704615;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=x9v+1gJlvvN7qjr/Yp6DlTCmuyLTnjbclKH8nAKrmOg=;
 b=GVcWs/TEM97m3qhDtZXwbWkribhtABT0xChlm+h/pM+BoIE0Rw8lHo+Z
 nti78GipZgNCS+5yZEr4Eq8FMAy1d/9FcubLGKoDhIkji0Wb6Ubt9hVr9
 UU4LVVh2VVfkXvWKKwupg+GLfr9s7U1kUMAQCIjzC8CS7Bov8FT8H4HD1
 OTdrui8sg854sUbXZyBuCZ4+34j6htfkbLe4Of2tZ7+4+pOPoqVeIqrjg
 scehAT/k/JXIvJPycusgDj2eEzkJWYjtk3rVOzAfokFzfqL1UGrcYIzBL
 RGGz/OBtbJZ7lax+MFTYFzbGdM5DSQmRPbNb/IV3AVGnxIccYQMIpxI1A Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10342"; a="256833618"
X-IronPort-AV: E=Sophos;i="5.91,213,1647327600"; d="scan'208";a="256833618"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 May 2022 00:43:34 -0700
X-IronPort-AV: E=Sophos;i="5.91,213,1647327600"; d="scan'208";a="565509397"
Received: from akulikow-mobl.ger.corp.intel.com (HELO localhost)
 ([10.249.144.37])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 May 2022 00:43:32 -0700
...
In-Reply-To: <57e2a444-714d-13bc-133b-0cb3e6cc9fdc@linux.intel.com>
...
Date: Tue, 10 May 2022 10:43:29 +0300
Message-ID: <87a6bpkf32.fsf@intel.com>
MIME-Version: 1.0

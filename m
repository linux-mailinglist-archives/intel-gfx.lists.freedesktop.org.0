...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D0A1D48AD6F
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Jan 2022 13:16:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4EE8010EC6D;
	Tue, 11 Jan 2022 12:16:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8589710EBA7;
 Tue, 11 Jan 2022 12:16:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1641903373; x=1673439373;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ywcPPUFF6nYOBLv3z5MBI4qeENxeHWOBRYkJQkzjrqc=;
 b=GXKF+zQvg51Qol3bV0oWf6WQwuVWZuy6rakR1k/OawAdPrD6dXc231Fq
 jhOUpUr0x/l3XotvLF5BdlLs+FqUsFo7FSUiBj6Ako59tD0/3+ADiKilB
 FP2TtpbaeXYGiTL0aJ2utuzCENcjnJMPM9B/VQrzkiMrL6I9EZZV3dBOX
 YbGwOkFfX0k/Tmo4dTlUJJ0URv/USjKh4UsuoSG3tHzwjC4Ziz6HVprIF
 wOLHy23jJOaluL+NZrdptdOsSWTWb6mayMmH9h9J6iJj6Sml0xX8GXE89
 eXlvDkbp9hky9nzKFMGJ7PoUJD7vm1vfdt4v2FwDjmtDz5YygUskxwVO/ Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10223"; a="243268504"
X-IronPort-AV: E=Sophos;i="5.88,279,1635231600"; d="scan'208";a="243268504"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Jan 2022 04:16:13 -0800
X-IronPort-AV: E=Sophos;i="5.88,279,1635231600"; d="scan'208";a="515075125"
Received: from gkodinet-mobl1.ger.corp.intel.com (HELO intel.com)
 ([10.251.221.50])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Jan 2022 04:16:09 -0800
From: Andi Shyti <andi.shyti@linux.intel.com>
To: Intel GFX <intel-gfx@lists.freedesktop.org>,
 DRI Devel <dri-devel@lists.freedesktop.org>
Date: Tue, 11 Jan 2022 14:15:51 +0200
Message-Id: <20220111121552.35679-2-andi.shyti@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: Prepare for multiple GTs

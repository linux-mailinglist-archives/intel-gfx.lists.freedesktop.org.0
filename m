...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6896DB44AC
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Sep 2019 01:43:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C12616EAAE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm: Handle connector tile support only for

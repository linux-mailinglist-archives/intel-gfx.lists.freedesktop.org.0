...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ADFD470D5FE
	for <lists+intel-gfx@lfdr.de>; Tue, 23 May 2023 09:50:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECA7410E3E1;
	Tue, 23 May 2023 07:50:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7D7C310E3DA;
 Tue, 23 May 2023 07:50:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684828228; x=1716364228;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=wzSTpdy05vvbEgQMzOpRcTXywpH4epd4wsE91ra/bz4=;
 b=OFVGwq5lbCHvgyNm+4iNaR0gX1aTyN7ExfDJALwVYAPvwOIbVlkzRkQI
 j5Xf6bQGmnIiCDm8JL/ErS1p5ZZpuSsO+jWxD6jQrt/eYeO5pw8f7TDOu
 fIbW8OXvt/+MX5X+Asbib5zfseVH12ksQExf0T3R8hFti+pGaXGJw8jTz
 aSJdE9HA2ZlWh8UZkcOUX8GOl2Ol6V5x015pXgCiyWQX/7HI6JMTC1f+y
 pB60jsyz+pGXn9WZ0er3K4EfA4uzTAdCVXyMS/BP84VmguO7/UZ702ChB
 dOfh4JuKaxMtyCUePicNHFy3HFgkWNR+5Rx3LZl1mPAcLkXZ25Gjx/psU g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="416628553"
X-IronPort-AV: E=Sophos;i="6.00,185,1681196400"; d="scan'208";a="416628553"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2023 00:50:27 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="681295953"
X-IronPort-AV: E=Sophos;i="6.00,185,1681196400"; d="scan'208";a="681295953"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.31.10])
 ([10.213.31.10])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2023 00:50:15 -0700
Message-ID: <7c9f3e33-9a94-368f-6afb-7a91821ce74e@intel.com>
Date: Tue, 23 May 2023 09:50:12 +0200
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 57BD947F8E4
	for <lists+intel-gfx@lfdr.de>; Sun, 26 Dec 2021 21:53:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A064710F231;
	Sun, 26 Dec 2021 20:53:40 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 6/6] drm/amdgpu: add drm buddy support to
 amdgpu

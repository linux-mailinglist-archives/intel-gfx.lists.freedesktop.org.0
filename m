...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C445519BDE4
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Apr 2020 10:48:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2224C6EA0F;
	Thu,  2 Apr 2020 08:48:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A52A16EA0F
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Apr 2020 08:48:22 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 20773225-1500050 for multiple; Thu, 02 Apr 2020 09:48:18 +0100
MIME-Version: 1.0
In-Reply-To: <878sjep98u.fsf@gaia.fi.intel.com>
References: <20200402080805.20292-1-chris@chris-wilson.co.uk>
 <878sjep98u.fsf@gaia.fi.intel.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
To: Mika Kuoppala <mika.kuoppala@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
Message-ID: <158581729847.5852.13108776295550519649@build.alporthouse.com>
User-Agent: alot/0.8.1
Date: Thu, 02 Apr 2020 09:48:18 +0100

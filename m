...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D9DEB749869
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Jul 2023 11:29:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E67C210E4B5;
...
Subject: [Intel-gfx] [drm-rerere] nightly.conf: drop sound tree from drm-tip
 altogether

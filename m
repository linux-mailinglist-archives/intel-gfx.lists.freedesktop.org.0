...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AA5BFAFA24
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Sep 2019 12:15:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3AD16EA6F;
	Wed, 11 Sep 2019 10:15:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 819BB6E21D;
 Wed, 11 Sep 2019 10:15:12 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18449163-1500050 
 for multiple; Wed, 11 Sep 2019 11:15:02 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 11 Sep 2019 11:15:01 +0100
Message-Id: <20190911101501.7182-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH i-g-t 3/3] kms_busy: Replace fiddling with
 hangcheck modparam with explicit fence
...
L2ttc19idXN5LmMgYi90ZXN0cy9rbXNfYnVzeS5jCmluZGV4IDdlNWFiM2QxOS4uYmZiMzg1N2Y0
...
LiAqLwogCQlpZ3RfcGlwZV9yZWZyZXNoKGRweSwgcGlwZSwgdHJ1ZSk7Ci0tIAoyLjIzLjAKCl9f

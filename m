...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B098A7A6A9D
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Sep 2023 20:23:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89FFC10E1D9;
...
Subject: [Intel-gfx] [PATCH] MAINTAINERS: drm/ci: add entries for xfail files
...
Cc: mripard@kernel.org, neil.armstrong@linaro.org, heiko@sntech.de,

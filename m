...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B5C93B9776
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 22:26:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1DC3A6EC07;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/53] drm/i915: Fork DG1 interrupt handler

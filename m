...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DA587DD9A3
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Nov 2023 01:26:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90E2F10E5E6;
...
Subject: [Intel-gfx] [PATCH v7d 00/23] fix DRM_USE_DYNAMIC_DEBUG=y regression

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D2FF232924
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Jul 2020 02:48:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 020006E823;
	Thu, 30 Jul 2020 00:48:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 25D876E820
 for <intel-gfx@lists.freedesktop.org>; Thu, 30 Jul 2020 00:48:29 +0000 (UTC)
IronPort-SDR: l9OLngAASbsaqSzmvli9krLRbVW8l35F8lqP0hGzbhZb0LGbD5yZeG9uzrTJ8hV2DU3kf7Bn29
 B24HAautWgwA==
X-IronPort-AV: E=McAfee;i="6000,8403,9697"; a="152751071"
X-IronPort-AV: E=Sophos;i="5.75,412,1589266800"; d="scan'208";a="152751071"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jul 2020 17:48:28 -0700
IronPort-SDR: iZXkxph88fMcGCZsWvH+sCUBQfL1HE31s++SsZud3cjF2GCzsaH2KCPSSGJYMQidmeUBznbLUC
 5UzjH8bTZeOQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,412,1589266800"; d="scan'208";a="274032932"
Received: from orsosgc001.ra.intel.com ([10.23.184.150])
 by fmsmga008.fm.intel.com with ESMTP; 29 Jul 2020 17:48:28 -0700
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Jul 2020 17:48:25 -0700
Message-Id: <20200730004826.8415-6-umesh.nerlige.ramappa@intel.com>
...
index e096282ad547..f4bd15d6b75f 100644
--- a/drivers/gpu/drm/i915/gt/intel_workarounds.c
+++ b/drivers/gpu/drm/i915/gt/intel_workarounds.c
@@ -1677,9 +1677,17 @@ struct i915_oa_wl {
 } gen9_oa_regs[] = {
...
index 0e2313d50c91..9b55521cb09b 100644
--- a/drivers/gpu/drm/i915/i915_perf.c
+++ b/drivers/gpu/drm/i915/i915_perf.c
@@ -4472,8 +4472,16 @@ int i915_perf_ioctl_version(void)
...
index 9cc3e312b6b7..6b30f076d8eb 100644

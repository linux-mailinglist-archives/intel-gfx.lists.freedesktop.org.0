...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19ABD46F9EA
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 05:40:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C97910E27C;
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915/guc: Speed up GuC log dumps

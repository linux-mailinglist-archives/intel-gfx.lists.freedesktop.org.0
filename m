...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 71EE7175B3F
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Mar 2020 14:09:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9B2D6E3A4;
	Mon,  2 Mar 2020 13:09:30 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 6/9] drm/nouveau: Fix unused variable warning

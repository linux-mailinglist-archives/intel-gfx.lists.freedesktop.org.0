...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3707E176630
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Mar 2020 22:42:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 822AD89CE3;
...
Subject: Re: [Intel-gfx] [PATCH 4/9] drm/i915/display: Remove

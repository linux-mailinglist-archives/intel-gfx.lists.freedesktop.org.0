...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3313455FE93
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jun 2022 13:29:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 63609113600;
	Wed, 29 Jun 2022 11:29:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 12404113600
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Jun 2022 11:29:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656502194; x=1688038194;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lXgMuR8sPrajA+PKyAeEX+NjbEOER6A/JVw4GpN6+mc=;
 b=cQaS/P3Zr6ibgzsb/IZ3n1M5hIWAcUFC6eTcDdC3yL9LSVsmTDDVQOjr
 evq/yR8xi/jbEFySsn6iSEKFyCzyEDcvVSBJcha4YxSGydvzY5kveVEBf
 SnQ5aohQHW7vSm6RDBAulgIm4iurnow8XpN4Mh68mHu1hBcHkK9jSMD+6
 TdmYug3N+4oBxnjcQYDXWbrIGurxzWx6+/ZSJsWt13aoLQFG8Gv9eZn5h
 WeoAe378wXT4TDA7CnrdYJ3UPtQza2naR5+WfE2Nmb+DMeR1KnQFYogfW
 PVwFkuFuVsz2ivxK/T/0L5eIOdkWqqCYstsxbbsi70RwYzMQvdxMyqlqE Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10392"; a="368319300"
X-IronPort-AV: E=Sophos;i="5.92,231,1650956400"; d="scan'208";a="368319300"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jun 2022 04:29:53 -0700
X-IronPort-AV: E=Sophos;i="5.92,231,1650956400"; d="scan'208";a="647353160"
...
Date: Wed, 29 Jun 2022 14:29:07 +0300
Message-Id: <20220629112913.1210933-9-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 08/14] mei: extend timeouts on slow devices.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9805F3659C7
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Apr 2021 15:19:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97EA56E50E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/5] drm/i915: Create stolen memory region from
 local memory

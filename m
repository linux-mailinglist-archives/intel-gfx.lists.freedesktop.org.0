...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0516473FDB1
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jun 2023 16:21:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D7A5A10E2EB;
...
X-Coremail-Antispam: 1Uk129KBj93XoWxuw1UtrW3tryktry5GFyUArc_yoW7tr1UpF
 ...
 nYUUUUU
Subject: Re: [Intel-gfx] [PATCH v7 5/8] video/aperture: Add a helper to

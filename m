...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3041365505
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Jul 2019 13:14:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 059696E182;
	Thu, 11 Jul 2019 11:14:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qk1-x74a.google.com (mail-qk1-x74a.google.com
 [IPv6:2607:f8b0:4864:20::74a])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C577789C1A
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Jul 2019 00:43:23 +0000 (UTC)
Received: by mail-qk1-x74a.google.com with SMTP id e18so3611914qkl.17
 for <intel-gfx@lists.freedesktop.org>; Wed, 10 Jul 2019 17:43:23 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:in-reply-to:message-id:mime-version
 :references:subject:from:to:cc:content-transfer-encoding;
 bh=v60MlM4AZO2gEMLJWxdbYZ7IvOFMVV2k6kZce0avAZg=;
 b=
X-Gm-Message-State: APjAAAUZl6S6QqKgJDn7X5OJylNw8y8dNq7JSn9ibgBiwxbeU2MVgkve
 BmpM/4gwZO35zYh3Ka7Li3xU1Ugv9VIq
...
X-Mailman-Approved-At: Thu, 11 Jul 2019 11:14:06 +0000
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 nZBQ==
Subject: [Intel-gfx] [PATCH v2] i915: intel_dp_aux_backlight: Fix max

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D3EDB58B18C
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Aug 2022 23:55:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4995512AACB;
...
Subject: [Intel-gfx] [PATCH v5 02/33] dyndbg: fix module.dyndbg handling
...
Cc: Jim Cromie <jim.cromie@gmail.com>, daniel.vetter@ffwll.ch,
 seanpaul@chromium.org, Rasmus Villemoes <linux@rasmusvillemoes.dk>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EAFB041591A
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Sep 2021 09:35:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3F306ECF9;
	Thu, 23 Sep 2021 07:35:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 061846ECF6
 for <intel-gfx@lists.freedesktop.org>; Thu, 23 Sep 2021 07:34:58 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10115"; a="203282509"
X-IronPort-AV: E=Sophos;i="5.85,316,1624345200"; d="scan'208";a="203282509"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2021 00:34:57 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.85,316,1624345200"; d="scan'208";a="558167436"
...
Date: Thu, 23 Sep 2021 00:35:17 -0700
Message-Id: <20210923073529.1058204-6-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 05/17] drm/i915/pxp: Implement funcs to
...
index c94fce9c8ddf..5f1734ff3d26 100644
...
index 5031ba589d95..5e74b2af2647 100644
...
@@ -57,7 +58,16 @@ void intel_pxp_init(struct intel_pxp *pxp)
 	if (ret)
 		return;
...
@@ -65,5 +75,8 @@ void intel_pxp_fini(struct intel_pxp *pxp)

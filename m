...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9787971B45
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Sep 2024 15:40:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A6A010E580;
	Mon,  9 Sep 2024 13:40:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aebdv42g";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 03E1810E580
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Sep 2024 13:40:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1725889253; x=1757425253;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=drw1Rz18BhYgCxMsclszpItb36ny8Hb8wjcBfb2nYIo=;
 b=aebdv42geq+43w22rpMhckaLXtGnLWh4Q6Lhcf3fDvRm6z3L4elWlz+Q
 Uo5wdUGtFjCTRQKOz4QrtmyUiQB1UGN7QCzkffbhLjZrlNLCbMVjMtDzL
 5u7cfmYc7kFDPhIsnkUeCw74t5p79aLRC5xg9pHA8XzPgjSazNdbttK5d
 lF3oJXScdNxw+M0+F8I7ig7YxjSSVGMZVoJnBxDGHBPrwIfPGUVVaN03p
 Sv2KxsCLvr11Ct4IZzS2slcbd+y+HZereFTc5eZohbye4vgkiDiWsz1eZ
 AGg95T/8L475IgnyggzRlIc94dwUQlTIYc1TpgsLXMnNkWkcp3Z+vMvS4 Q==;
X-CSE-ConnectionGUID: lOoJX6olQeOt4qeuHtX5/w==
X-CSE-MsgGUID: iKdgmaskTsmDny+n1zz4Ww==
X-IronPort-AV: E=McAfee;i="6700,10204,11190"; a="24451449"
X-IronPort-AV: E=Sophos;i="6.10,214,1719903600"; d="scan'208";a="24451449"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Sep 2024 06:40:36 -0700
X-CSE-ConnectionGUID: dRC+6hL9QMah4U86lE64ug==
X-CSE-MsgGUID: wjqSjiH2TbWAIer+AFji5w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,214,1719903600"; d="scan'208";a="66733720"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by fmviesa008.fm.intel.com with SMTP; 09 Sep 2024 06:40:34 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Mon, 09 Sep 2024 16:40:33 +0300
Date: Mon, 9 Sep 2024 16:40:33 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Nautiyal, Ankit K" <ankit.k.nautiyal@intel.com>
Cc: intel-gfx@lists.freedesktop.org, jani.saarinen@intel.com
Subject: Re: [PATCH 01/14] drm/i915/display: Modify debugfs for joiner to
 force n pipes
Message-ID: <Zt760UZiDGIvQGth@intel.com>

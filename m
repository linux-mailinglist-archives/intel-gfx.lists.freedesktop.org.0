...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73539474909
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Dec 2021 18:14:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8DC6F10E1DC;
...
Subject: [Intel-gfx] [PATCH 2/7] drm/i915/guc: Only assign guc_id.id when
 stealing guc_id

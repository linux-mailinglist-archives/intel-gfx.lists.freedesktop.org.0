...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47E55634AFA
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Nov 2022 00:17:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8325C10E495;
...
Subject: Re: [Intel-gfx] [PATCH 2/3] drm/i915/uc: More refactoring of UC
 version numbers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 602652D3AAB
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Dec 2020 06:37:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C4306E0F7;
	Wed,  9 Dec 2020 05:37:08 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F0FC96E0F4
 for <Intel-gfx@lists.freedesktop.org>; Wed,  9 Dec 2020 05:37:03 +0000 (UTC)
IronPort-SDR: LFf+0vXaAeoqEvb+rrH644uNwZeRjTDo35MjwIaf4D1Tu0CLGfLaQzAS4BHls47jq8orLyxPdB
 dGpT//Z+Q8Qw==
X-IronPort-AV: E=McAfee;i="6000,8403,9829"; a="171449795"
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="171449795"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2020 21:37:02 -0800
IronPort-SDR: 7XI4lEz0MQoAF8jIMZafMWeuMV6qfEmq0mNj4KiHxZCRX8tYkmbVDGLbYLQZbW11AauVSowK0O
 xW4vGvo79dJw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="318670173"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga007.fm.intel.com with ESMTP; 08 Dec 2020 21:37:02 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Tue,  8 Dec 2020 21:36:25 -0800
Message-Id: <20201209053628.22584-11-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201209053628.22584-1-sean.z.huang@intel.com>
References: <20201209053628.22584-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v2 10/13] mei: pxp: export pavp client to me
 client bus

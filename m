...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 048E65AC6D8
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:44:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D71AA10E1C3;
...
Subject: [Intel-gfx] [PATCH v6 03/57] dyndbg: show both old and new in
 change-info

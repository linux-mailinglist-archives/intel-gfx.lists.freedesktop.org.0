...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E4C344277C
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 08:06:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 999CC6FAAA;
	Tue,  2 Nov 2021 07:06:27 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 03/29] drm/i915/gvt: remove module refcounting
 in intel_gvt_{, un}register_hypervisor

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F306C1D8C27
	for <lists+intel-gfx@lfdr.de>; Tue, 19 May 2020 02:22:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70CE96E4D4;
...
Subject: [Intel-gfx] [PATCH 2/4] mm/gup: refactor and de-duplicate
 gup_fast() code

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 42105B35781
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Aug 2025 10:46:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D415610E2EE;
	Tue, 26 Aug 2025 08:46:17 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="gGin9uTT";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0F04F10E2EC
 for <intel-gfx@lists.freedesktop.org>; Tue, 26 Aug 2025 08:46:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1756197975;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=FCQ3vkE6TMoU0hruNEfZc09a6cr/NttsBsCnt+Bnw9Y=;
 b=gGin9uTTGYMFEbkO5P7CJNPEZ5FrBWNI8RHtUBMvyv8FwGRebl8ctOQVdsGYSvWrh0L0o4
 K1Dm/OvI2pszg6MWncBrh5rxsTCUdbfW/TMKrCNhXv+vZi3eKzii0roy6wX+Meb1jgNdjf
 cL40Ae/5d3qo/yEMKvz8WF5qv6u7LDY=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-2-A_f9Nl3_O8mhjSBD1QxH_Q-1; Tue, 26 Aug 2025 04:46:13 -0400
X-MC-Unique: A_f9Nl3_O8mhjSBD1QxH_Q-1
X-Mimecast-MFC-AGG-ID: A_f9Nl3_O8mhjSBD1QxH_Q_1756197972
Received: by mail-wr1-f71.google.com with SMTP id
 ffacd0b85a97d-3cbe70a7861so72384f8f.3
 for <intel-gfx@lists.freedesktop.org>; Tue, 26 Aug 2025 01:46:13 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :reply-to;
 bh=FCQ3vkE6TMoU0hruNEfZc09a6cr/NttsBsCnt+Bnw9Y=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCW3Xyy0UVdfkvNdCp93shUc0Bs1h2rVKFxKf6+Scs1trX0DTOCdojNzV04P/7sK9zf94isTUKLdk9E=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YyBM368EOXeCy69sfDP293oG1uhpj+4TYQSWwxLlRyPgiULwPt+
 mg4Nrg99mTVE85Btzk1WRKbB+f83Z2EBVvsw9dg26RXsN6pRQiF8cgpAt7Ih58/A9LWXfEwXZ6z
 XlFKecdzGFiR7+oVhEbQfqgYfNNBP5XdDoqfjx4VBBvswYgNuPZGeex2XhbKHhNVh14ecoQ==
X-Gm-Gg: 
 =
X-Received: by 2002:a05:6000:40cd:b0:3b7:8da6:1bb4 with SMTP id
 ffacd0b85a97d-3c5dcefcf18mr13727506f8f.58.1756197971988; 
...
X-Mimecast-MFC-PROC-ID: xz_ZmovsQVwDKDuxvSYzn_JM2ZUw0QHQUCRx-DPjXaQ_1756197972

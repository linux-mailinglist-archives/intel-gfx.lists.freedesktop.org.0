...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A9B3B13C048
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 13:18:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 795046E96B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 12/21] drm/msm: Convert to struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1721C4DB4F
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jun 2019 22:38:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64F786E58E;
	Thu, 20 Jun 2019 20:38:38 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6BF006E58E
 for <Intel-gfx@lists.freedesktop.org>; Thu, 20 Jun 2019 20:38:37 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga102.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 20 Jun 2019 13:38:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.63,398,1557212400"; d="scan'208";a="186938657"
Received: from yyosef-mobl.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.252.23.42])
 by fmsmga002.fm.intel.com with ESMTP; 20 Jun 2019 13:38:36 -0700
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 20 Jun 2019 21:38:03 +0100
Message-Id: <20190620203835.1421-1-tvrtko.ursulin@linux.intel.com>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 01/33] drm/i915: Convert intel_vgt_(de)balloon to
 uncore
...
ZW1fZ3R0LmMKaW5kZXggOGFiODIwMTQ1ZWE2Li42YjQ5ZGEyZDgxMDEgMTAwNjQ0Ci0tLSBhL2Ry
aXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZ2VtX2d0dC5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9p
OTE1L2k5MTVfZ2VtX2d0dC5jCkBAIC0yODU1LDcgKzI4NTUsNyBAQCBpbnQgaTkxNV9nZW1faW5p
...
CQlyZXR1cm4gcmV0OwogCkBAIC0yOTI2LDcgKzI5MjYsNyBAQCB2b2lkIGk5MTVfZ2d0dF9jbGVh
...
ZHJtL2k5MTUvaTkxNV92Z3B1LmMKaW5kZXggMWE4ZjdjNzMxMTI2Li45OTE2YmM2MTU5YjYgMTAw
NjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfdmdwdS5jCisrKyBiL2RyaXZlcnMv
Z3B1L2RybS9pOTE1L2k5MTVfdmdwdS5jCkBAIC0xMzYsMTcgKzEzNiwxNyBAQCBzdGF0aWMgdm9p
...
IC0yMTQsMjIgKzIxNCwyNiBAQCBzdGF0aWMgaW50IHZndF9iYWxsb29uX3NwYWNlKHN0cnVjdCBp
...
NS9pOTE1X3ZncHUuaAppbmRleCBhOTE5NzM1ZmI2Y2UuLjhkZDc0OTdlZGExNSAxMDA2NDQKLS0t

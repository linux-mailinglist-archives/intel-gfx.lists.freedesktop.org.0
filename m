...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84C612D66EB
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 20:42:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42EAB6EB3A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch 14/30] drm/i915/pmu: Replace open coded
 kstat_irqs() copy

...
Received: from mail.lfdr.de
	...
	id UyD/JeFvVWqwoQAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2026 01:08:17 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F33F974FA16
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2026 01:08:16 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=fail ("headers rsa verify failed") header.d=igalia.com header.s=20170329 header.b=L5u1mou1;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org;
	dmarc=fail reason="SPF not aligned (relaxed)" header.from=igalia.com (policy=none)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82B8410EB7E;
	Mon, 13 Jul 2026 23:08:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fanzine2.igalia.com (fanzine2.igalia.com [213.97.179.56])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DDCB310EB7D;
 Mon, 13 Jul 2026 23:08:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=igalia.com; 
 ...
 bh=+tg9dlhEHHqwfrhhDFo1lwzWM4tV6Ypa5QR5gmWEPjs=; b=L5u1mou1qi9SWO+E4zS9aXaRbl
 ;
Received: from c-73-157-168-91.hsd1.or.comcast.net ([73.157.168.91]
 helo=localhost.localdomain) by fanzine2.igalia.com with esmtpsa 
 (Cipher TLS1.3:ECDHE_X25519__RSA_PSS_RSAE_SHA256__AES_256_GCM:256) (Exim)
 id 1wjPkw-00EiHA-Ec; Tue, 14 Jul 2026 01:08:11 +0200
...
Subject: [PATCH v7 5/9] drm/mali: use drmm_writeback_connector_init()
Date: Mon, 13 Jul 2026 16:07:21 -0700
Message-ID: <20260713230726.3738290-6-John.Harrison@Igalia.com>
...
X-Spamd-Result: default: False [1.99 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,Igalia.com:from_mime,Igalia.com:mid,igalia.com:email,arm.com:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: F33F974FA16

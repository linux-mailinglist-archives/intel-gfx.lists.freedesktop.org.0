...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D454697585
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Feb 2023 05:45:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 367C710EA25;
	Wed, 15 Feb 2023 04:45:46 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915: move a Kconfig symbol to unbreak the
 menu presentation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F5D159A8CB
	for <lists+intel-gfx@lfdr.de>; Sat, 20 Aug 2022 00:53:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A0B710E4E5;
...
Subject: [Intel-gfx] [PATCH v3 00/15] drm/i915: HuC loading for DG2

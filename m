...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90B9D38F879
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 05:04:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0EAD6E5CA;
...
Subject: Re: [Intel-gfx] [RFC PATCH 14/97] drm/i915/guc: Update sizes of CTB
 buffers

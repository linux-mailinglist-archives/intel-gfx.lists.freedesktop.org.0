...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C75C4E9DA4
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 19:37:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3FCB10E73E;
...
Subject: Re: [Intel-gfx] [PATCH v3 08/12] drm/edid: constify struct

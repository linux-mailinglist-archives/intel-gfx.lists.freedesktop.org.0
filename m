...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D3D1166A32B
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 20:31:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C5BE10EADD;
...
Subject: [Intel-gfx] [PATCH v2 10/20] dyndbg-API: split

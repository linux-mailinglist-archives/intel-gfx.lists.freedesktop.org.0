...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 71E33554581
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 12:59:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7578C10E8E8;
...
Subject: [Intel-gfx] [PATCH v3 04/13] drm/edid: abstract debugfs override
 EDID set/reset

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D4D9F25D810
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Sep 2020 13:54:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9745C6EB6D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 15/18] drm/i915: Extract
 intel_hdmi_has_audio()

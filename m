...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DC5B56F6173
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 00:50:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E863510E102;
	Wed,  3 May 2023 22:50:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F1C5010E0F2;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=Kg/h7in9Nb1XpbTXlmSC4Xe+7ZmBgG4Tsz00LwMXDwHHKXAZHrdESHJw
 JKSDUZqJLTKhw775V9L4rLt3gYFBddYIBI2v8zhDRUsUnrnb16m+40iAC
 IVkwOvptutx6KB49bQQoKkUBaHmhnQ2xzKnAuXy2JRkU77xtnzTc+ZHaj
 AhdbmngyKUcTD21MXJ4V2G/Hj+FmznZP6fLazbmpmZxeWa4jHiqqXoWn9
 vzER2ttWQYgZUsbROAx0wqF0rRw/pP7MfcM+J//SSu1OtmVw8Nn1bjkLu
 S9ORfPIM+tpnpfosLNioHFlwFycsuiTVSgGzpevW3EsHpqXmsErQ8riXe Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="347604360"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="347604360"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 15:50:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="871121283"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="871121283"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 15:49:59 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 May 2023 15:50:59 -0700
Message-Id: <20230503225100.2834222-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 2/3] drm/i915: use pat_index instead of
 cache_level

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 270374EA297
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 23:59:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3D9A10EDC2;
	Mon, 28 Mar 2022 21:59:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E1AFE10EDC1
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Mar 2022 21:59:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1648504746; x=1680040746;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=QaUz3RcoVDSGW/vqM4OvkIs1s8ny9E1MdQDXN4wCUzM=;
 b=h7SBAFhGPrdkN8+8ko9TUDSLU7T4qLOxphI0FObYkfISOozanhc5bAZh
 gey6qm5yFq+dBcker0FaHDeyxdUyGMhIm0QimViW1uoK6r/ri9WDqmk62
 XU1YU6WnDqLXqn5fkHV5MT9nMJXK9yIvpNVuDeB5MZtUnWS8pBGSIi6fM
 UHeca5e2W4WD8UepuVseJdGgg0juMNIIEu039Pv7L/Ak0CgRPKHhnXwNK
 rpx4UYk2P3VCO0VTN6AWloyp9eAIKWVtGEeiaCWjckCi1kYfC505F5ywv
 SdJRCwoJDDecMrs0rjQPk+p5lsFaQ2F4Yw2rc47pmOGGpFQYGBZqIpixh g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10300"; a="246599318"
X-IronPort-AV: E=Sophos;i="5.90,218,1643702400"; d="scan'208";a="246599318"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Mar 2022 14:59:06 -0700
X-IronPort-AV: E=Sophos;i="5.90,218,1643702400"; d="scan'208";a="546129265"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Mar 2022 14:59:06 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Mar 2022 14:53:53 -0700
Message-Id: <20220328215358.2866707-2-daniele.ceraolospurio@intel.com>
...
index 10476280acb84..b234ed14aaa0c 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index c1d5540f60529..fdfa480370f45 100644
--- a/drivers/gpu/drm/i915/Makefile
+++ b/drivers/gpu/drm/i915/Makefile
@@ -200,6 +200,9 @@ i915-y += gt/uc/intel_uc.o \
...
index 62e0f075b1de7..57fe4f67f566e 100644
...
index 217c09422711b..cd83a01ae7cc8 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1315,6 +1315,14 @@ IS_SUBPLATFORM(const struct drm_i915_private *i915,
...
index 67b89769f577c..a948f566bd3da 100644
...
index a0d652f19ff93..72663a7ef6295 100644

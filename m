...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C7B392D8F50
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Dec 2020 19:39:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17AC289E06;
	Sun, 13 Dec 2020 18:39:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7138689E5A
 for <intel-gfx@lists.freedesktop.org>; Sun, 13 Dec 2020 18:39:35 +0000 (UTC)
IronPort-SDR: cAO1Dgp5Sc2hkGmkPHdY0WPg2Ftiny4iRXCDfVUbP2XX73JN45SbVhavInijH/YhT3+hY6D0a1
 CMfwQLrKEcvQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9834"; a="192978493"
X-IronPort-AV: E=Sophos;i="5.78,416,1599548400"; d="scan'208";a="192978493"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2020 10:39:35 -0800
IronPort-SDR: 0JpvhZJtwlFcEIasxPMNMEV9HaobIjZA+ETdK6qy1n5LQEbTm/qx96kiPfaT8SPB2yB1quliUc
 kdrhq21fbAjw==
X-IronPort-AV: E=Sophos;i="5.78,416,1599548400"; d="scan'208";a="410650094"
...
Date: Sun, 13 Dec 2020 10:39:28 -0800
Message-Id: <20201213183930.349592-4-jose.souza@intel.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <20201213183930.349592-1-jose.souza@intel.com>
References: <20201213183930.349592-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 4/6] drm/i915/display: Split and export main

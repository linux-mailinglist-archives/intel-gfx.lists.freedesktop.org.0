...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 833EF2C9F75
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Dec 2020 11:36:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF5BA6E57A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 02/20] drm/amdgpu: Remove references to

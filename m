...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C2D5542AE6A
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Oct 2021 23:01:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E0966E9CF;
	Tue, 12 Oct 2021 21:01:36 +0000 (UTC)
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [RFC v2 00/22] Add Support for Plane Color Lut and
 CSC features

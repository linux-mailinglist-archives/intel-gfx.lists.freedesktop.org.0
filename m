...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 85F9F99A329
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Oct 2024 14:03:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6237910EAD7;
	Fri, 11 Oct 2024 12:03:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="DmpC0Shv";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5A95310EAD0;
 Fri, 11 Oct 2024 12:03:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1728648182; x=1760184182;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=ecq/G18zA1CKJJ9UYlLvgEWmp1TULxkVZP636WYt0UE=;
 b=DmpC0Shvkjskon1xiNeyFMiJpkrTtFGVYx1ldqsa+VmM98jwZNPgg3Uz
 MwkOe/fJxyCFQmOwF4+X3hnRw5tnl6ESt8o4g+RKQ27QJqxpYli6FmsBU
 3sRV2vP3RsQWeh9w24OHBHLS+PbtiLi4eXSGTLd7vTfZL/ZUo+t5O0LcL
 LCWVUH8uRZb1UhOKFNs7v6/PsB+UGz9WwUziP/KNKYmL+mKjDn4Y9Hgzi
 QCpzZQJF7kAlImnU+68fXTudFQTTtOHoT4EIuR3F84uHZeD/9F7Bz4VEN
 Um/Lusrx+XusDQ1bavUWLDgGkd4Cq43z/tfDatE9F+vnwGFXkIQNzatrP g==;
X-CSE-ConnectionGUID: f8ePGuJESkupVonzpLvLwA==
X-CSE-MsgGUID: 6S2iCEM5SgCIgvEKMvma5Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11221"; a="28135397"
X-IronPort-AV: E=Sophos;i="6.11,195,1725346800"; d="scan'208";a="28135397"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2024 05:02:18 -0700
X-CSE-ConnectionGUID: cyGc6pMXTnmRhYfMgMKTRw==
X-CSE-MsgGUID: GhrsnzwnQMqPTA3b7Qxs8g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,195,1725346800"; d="scan'208";a="81679075"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orviesa005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2024 05:02:16 -0700
Date: Fri, 11 Oct 2024 15:02:45 +0300
...
Message-ID: <ZwkT5VzNVoEYdjH_@ideak-desk.fi.intel.com>
References: <20241009194358.1321200-1-imre.deak@intel.com>
 <172861829480.1238512.1284637869406260681@2413ebb6fbb6>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <172861829480.1238512.1284637869406260681@2413ebb6fbb6>
...
On Fri, Oct 11, 2024 at 03:44:54AM +0000, Patchwork wrote:
> == Series Details ==
> 
...
There is only an HDMI output connected, so neither the eDP polling or
the short HPD handling changes are relevant here. This test has failed
previously many times on lnl.

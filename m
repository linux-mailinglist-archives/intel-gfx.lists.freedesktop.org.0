...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 345641B2484
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Apr 2020 13:05:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D4A066E2D8;
...
Subject: Re: [Intel-gfx] [PATCH 24/59] drm/tidss: Don't use

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 656D967BFC7
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 23:15:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A24B489C7F;
	Wed, 25 Jan 2023 22:15:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9408610E1D5
 for <intel-gfx@lists.freedesktop.org>; Wed, 25 Jan 2023 22:15:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1674684935; x=1706220935;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=XLCfpo7A4frE2Z9scFMs7Bi9CJ+/+ifSi5Pg4hdRxvM=;
 b=PHRN8Dp8saSpvTnoodVioWuv5JOVsezsFg5/pVW7zFuNbuoMnGJOTjaJ
 aDWKoSqPDdGdYxLeBuq58tltzb/+luZU/Qx1ymDoPj/qIeKPljnNERrsI
 REKv1599RZgOUY9d/JwP8CX5yqqrXJPKA/9pN4B7nDdiWgs02BhRNsKaJ
 0A6kk744fx5nzzIyRtJew/vzllEpQEn4R6S5O9Xoscj7DiPuS7QneouJI
 YdSiapHiigbE4jo4gzc5/Cu5XXFiPK1TjtXXA6iJ7QoeBA0VDKL9ciXHw
 EQ9sgYJ1hQIRTVo3CFn/MpVeaVJF7nZqkZLG9G2V5JUPlBAUFXJ0E1hL4 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10601"; a="327943091"
X-IronPort-AV: E=Sophos;i="5.97,246,1669104000"; d="scan'208";a="327943091"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Jan 2023 14:15:33 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10601"; a="751372083"
X-IronPort-AV: E=Sophos;i="5.97,246,1669104000"; d="scan'208";a="751372083"
Received: from lab-ah.igk.intel.com ([10.102.42.211])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Jan 2023 14:15:31 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 25 Jan 2023 23:15:17 +0100
Message-Id: <20230125221517.1880083-1-andrzej.hajda@intel.com>
...
index 00000000000000..e77b817738cbfc
--- /dev/null

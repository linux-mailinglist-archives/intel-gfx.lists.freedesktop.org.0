...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6AFF84F3AFC
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 17:08:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A05310E8E1;
...
Subject: [Intel-gfx] [PATCH v9 1/9] drm/i915/gt: use engine instance
 directly for offset

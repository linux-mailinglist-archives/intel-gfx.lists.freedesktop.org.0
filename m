...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17AE34BA359
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 15:44:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E245C10E902;
...
Subject: [Intel-gfx] [PATCH v5 7/7] drm/i915/gt: Adding new sysfs frequency
 attributes

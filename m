...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D37EF6FCC0F
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 18:58:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E8B710E3A9;
	Tue,  9 May 2023 16:58:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6211E10E3A6;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=WHXQ67kEsiVJH7xuMYZbgpNQKRFjy43UwLqfaYmNqN/7Bj4bVjIH0/vc
 NpUfU+OmfzD9dyNqlCO+jWD5MZtegtjeEECK2tdNzxsdSpVVMaSKsRlTa
 wqGpac/Ahagl4gY1c6w2fN5Fvc4aJwddS4I3R01bYJqeWwaZRYPGDL8kB
 eQtkDDi17gJ+ngEQGmud7IeAOy7Q417qkCKZFoy3z7NRi30X5Fvhmsux2
 3PjCTACwwiGvk+mCnSj4NAincGiCTU9dSyLPAdG/WjrTvGiuiUG5+StR6
 35e1iwEdAukFPi3IPcyvJT6G3MSmll2r5In0N0Rlz56HZpAjqap8Epgbc Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="350021118"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="350021118"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:58:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="649408812"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="649408812"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:58:47 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Tue,  9 May 2023 09:59:40 -0700
Message-Id: <20230509165942.2155-3-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230509165942.2155-1-fei.yang@intel.com>
References: <20230509165942.2155-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v7 2/4] drm/i915: use pat_index instead of
 cache_level

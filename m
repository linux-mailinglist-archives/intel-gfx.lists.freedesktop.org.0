...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A36513C049
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 13:18:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCA496E996;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 15/21] drm/stm: Convert to CRTC VBLANK
 callbacks

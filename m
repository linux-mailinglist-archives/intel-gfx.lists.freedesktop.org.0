...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 61E9D36B5B3
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Apr 2021 17:24:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 887D16E835;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3] drm/i915: Invoke another _DSM to enable MUX

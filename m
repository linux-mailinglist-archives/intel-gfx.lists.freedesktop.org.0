...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E5F32684C0
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Sep 2020 08:23:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9213B6E190;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 1/8] drm/i915: Add enable/disable flip done

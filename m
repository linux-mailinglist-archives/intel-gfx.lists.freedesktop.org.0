...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC09A4E7363
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Mar 2022 13:26:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B1DB310E5A4;
...
Subject: [Intel-gfx] [PATCH 6/9] drm/edid: constify struct detailed_timing

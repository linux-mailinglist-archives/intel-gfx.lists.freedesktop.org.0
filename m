...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C3907E1D29
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Nov 2023 10:26:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C91B910E140;
	Mon,  6 Nov 2023 09:26:52 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 36E9810E299
 for <Intel-gfx@lists.freedesktop.org>; Mon,  6 Nov 2023 09:26:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699262810; x=1730798810;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=Pibfe//OpdCsiB90bnFBLYCezHdegUva8h5RFN5PfFo=;
 b=amf8Qy0x8EupWfDvAGq20pDlXWCdTur9RLVIyDvahh4M8dlvz07SUJkk
 C+oT4MAZrPDzLG5+AjUrSwjKmETnAhoAxMFN32c7PPaLkNs2xF7W1xUlt
 KjSTAF/QeURvxmmYypvqzQmQiRWtwaDgrzUno8W3lL3yHfODXEy+Bsdgg
 yoYe1CaKnbTjdYa3riWiz15MLWBlQi4IxF70w5WS1c3PjCRisDCxPX0+E
 EKSob47pvlWZQjoZuL6n3EVyfG+jnK0Qw8qLhdCYZfSSVYV2l8Rin6bzR
 c5zFde0VvkBJCC/YIyplGp9uGznKsrEpA9+EYgoGJ75ewkTZbKJ7je7Fr Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="455722692"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="455722692"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 01:26:49 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="935747851"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="935747851"
...
Date: Mon,  6 Nov 2023 09:26:34 +0000
Message-Id: <20231106092634.481749-2-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [CI 2/2] drm/i915: Remove xehpsdv support
...
index 9de41703fae5..68355ee405f0 100644
...
index ac1abf18eb99..3feec04a2b1c 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -552,7 +552,6 @@ IS_SUBPLATFORM(const struct drm_i915_private *i915,
...
@@ -628,9 +627,6 @@ IS_SUBPLATFORM(const struct drm_i915_private *i915,

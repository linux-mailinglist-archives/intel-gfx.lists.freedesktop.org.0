...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DE71B4796A
	for <lists+intel-gfx@lfdr.de>; Sun,  7 Sep 2025 09:47:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18BA210E444;
	Sun,  7 Sep 2025 07:46:37 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aowSXqk1";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4712710E197;
 Sun,  7 Sep 2025 07:46:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1757231192; x=1788767192;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6pjb5kfGeXnADkle8Ccmz4Z8tkjILdlOCg8qrvdmiIM=;
 b=aowSXqk1Q2G+g8UPoQaH1azA1dkgZWUiO/yVEEpGIZmzO8Jk48hQTwtf
 +dyF/f6B8lASRSRsh6xxGBcg+VeiLe+lSSpzgPJdfZ3VRqi8T4GIHmsdV
 CPxmpuymTjTmMztS2cjMPpTwnqj8FhQcyQqisuwBxpWGEKNl0rZR3kHCs
 7U6rsumJSsMM5npgchGYHRCX44NO4rNRMfrpoQUvHhIznscNZjZoT9x0p
 0zEFzyzVcvaYtcx3rfF7nr67xSnovQ06UbvyxQ+5FNTK8tOaOCiksDEs0
 pSNqJwjGgqX2Q7WOt6iDJZRmZiSyXfgVlBDt1yHg3OdSsER22usQfsyKh Q==;
X-CSE-ConnectionGUID: UFKLAjt1TJGVuKOgwUV+Jw==
X-CSE-MsgGUID: m4S1fN6FRjCccGb+vGCfxw==
X-IronPort-AV: E=McAfee;i="6800,10657,11545"; a="70220296"
X-IronPort-AV: E=Sophos;i="6.18,246,1751266800"; d="scan'208";a="70220296"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2025 00:46:32 -0700
X-CSE-ConnectionGUID: g19BGU9vSqKoJctPaSezDg==
X-CSE-MsgGUID: EQIiC3ZzTwmjR64E6fS5bw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,246,1751266800"; d="scan'208";a="176874011"
...
Subject: [PATCH 09/14] drm/i915/display: Add guardband check for feature
 latencies
Date: Sun,  7 Sep 2025 13:02:36 +0530
Message-ID: <20250907073241.19632-10-ankit.k.nautiyal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D19464BFB2F
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 15:51:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB6B910E853;
...
Subject: [Intel-gfx] [PATCH 3/7] drm/i915: use the memcpy_from_wc call from
 the drm

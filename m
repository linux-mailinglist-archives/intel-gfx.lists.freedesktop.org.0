...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 196CA5AC736
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:46:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8E9E10E2A6;
...
Subject: [Intel-gfx] [PATCH v6 22/57] drm_print: condense enum
 drm_debug_category

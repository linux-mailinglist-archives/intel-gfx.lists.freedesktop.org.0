...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF5024C7D9
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jun 2019 09:06:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E77096E3DB;
	Thu, 20 Jun 2019 07:06:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DAD256E3DB
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jun 2019 07:06:13 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16961336-1500050 
 for multiple; Thu, 20 Jun 2019 08:05:57 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 20 Jun 2019 08:05:59 +0100
Message-Id: <20190620070559.30076-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/3] drm/i915/execlists: Force preemption
...
ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYwppbmRleCBmY2E3OWFkYjRhYTMuLmU4ZDdk
ZWJhM2U0OSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMK
KysrIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMKQEAgLTg4OSw2ICs4ODks
...
Y2xpc3RzID0gJmVuZ2luZS0+ZXhlY2xpc3RzOwpAQCAtMTIyMCw2ICsxMjI5LDkgQEAgc3RhdGlj
...
PnRpbWVyLCBwcmVlbXB0X2V4cGlyZXMoKSk7CiAJfQogfQogCkBAIC0xMzc2LDEzICsxMzg4LDQ4
...
cy50aW1lcik7CiB9CiAKIC8qCkBAIC0xMzk1LDcgKzE0NDIsMTAgQEAgc3RhdGljIHZvaWQgZXhl

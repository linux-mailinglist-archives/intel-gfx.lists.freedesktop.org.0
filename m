...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74E43BB4C6
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Sep 2019 15:04:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 408C86E8EF;
...
Subject: [Intel-gfx] [PATCH 2/6] mdev: introduce device specific ops

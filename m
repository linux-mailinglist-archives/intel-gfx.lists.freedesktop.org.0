...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DBF24ECA3D
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Mar 2022 19:04:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 69E5C89D46;
...
Subject: [Intel-gfx] [PATCH] drm/edid: fix invalid EDID extension block
 filtering

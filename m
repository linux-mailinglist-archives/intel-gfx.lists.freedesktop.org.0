...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1068D627FC8
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 14:02:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EBAA10E2AB;
...
Subject: [Intel-gfx] [PATCH v9 12/25] drm/connector: Add pixel clock to
 cmdline mode

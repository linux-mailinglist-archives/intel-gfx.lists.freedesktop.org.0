...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8422396E1C1
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Sep 2024 20:17:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B2F410E928;
	Thu,  5 Sep 2024 18:17:54 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Ob04R2iq";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A545110E928
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Sep 2024 18:17:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1725560272; x=1757096272;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=q9Aywq/2qRW07LVhQ5iSxPWJaPH+GCNWhMuyFqDv/KQ=;
 b=Ob04R2iqZOsf/WwF3OJHC/My7EcQ4WNPrF05Z72TAUCqmQwxCVUlr2Qd
 E+CSgLOyrEOHV2KyqlA2mty6IalLEoIpRm/ivJleSvw7fC89vbHZwdeIW
 +qUHxur7z44Btsl99K4rXorzBUD1Mii/Mj4DxWypfIGKq0kFzPhjOrzj2
 IlQO3Q5om/3tP9WXACUad56YUd3B11KImNYD4q6BMxZyOuTtRjNM67Vel
 5Q5yR2iaMwpfQBVsZwKJae0j4139A/qSQx0vpW3QW0yP+O+mfxtvEBOdf
 FSwJ4M/U/XjyKjhLG/+ls27EG/XqONELvZguTQB76l/FuzEUANi/0kYX/ w==;
X-CSE-ConnectionGUID: Uk4cIJwLRVyTUpHgWJp0hg==
X-CSE-MsgGUID: Pnv2A8V1REqLADOClOeptA==
X-IronPort-AV: E=McAfee;i="6700,10204,11186"; a="24462045"
X-IronPort-AV: E=Sophos;i="6.10,205,1719903600"; d="scan'208";a="24462045"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Sep 2024 11:17:52 -0700
X-CSE-ConnectionGUID: /Owl0T3aT66r0j5GhRCsbg==
X-CSE-MsgGUID: yZWb3bFUTEui6mSHJjezXg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,205,1719903600"; d="scan'208";a="66031952"
Received: from fdefranc-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.246.216])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Sep 2024 11:17:51 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: "Dixit, Ashutosh" <ashutosh.dixit@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Subject: Re: [PATCH] drm/i915: use IS_ENABLED() instead of defined() on
 config options
In-Reply-To: <87zfonxvh4.wl-ashutosh.dixit@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20240904145218.3902145-1-jani.nikula@intel.com>
 <87zfonxvh4.wl-ashutosh.dixit@intel.com>
Date: Thu, 05 Sep 2024 21:17:47 +0300
Message-ID: <871q1yoth0.fsf@intel.com>
MIME-Version: 1.0

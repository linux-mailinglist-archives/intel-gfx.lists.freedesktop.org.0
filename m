...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B53F3577B81
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:40:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26A98A9D6A;
...
Subject: [Intel-gfx] [PATCH v3 29/41] nouveau: change nvkm_debug/trace to
 use dev_dbg POC

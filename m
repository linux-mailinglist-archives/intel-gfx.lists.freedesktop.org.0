...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DAA514FE89
	for <lists+intel-gfx@lfdr.de>; Sun,  2 Feb 2020 18:16:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D5336EB11;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/5] drm: Remove the dma_alloc_coherent wrapper
 for internal usage

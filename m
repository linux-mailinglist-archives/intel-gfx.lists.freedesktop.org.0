...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 884915928CC
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Aug 2022 06:31:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D917BA760E;
	Mon, 15 Aug 2022 04:30:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 296F5A75F3
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Aug 2022 04:30:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1660537838; x=1692073838;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=HEYupRZImFmLasv09ZuuZpH17+Fio98uzY3X5qBx9CM=;
 b=E33RHQlojf/t7eBPteFwqZiGhPF2QSmVLcKn/Pny2/orbiadLNSkVTnW
 nuToMq3mr9SgJlrVUKHDnbowEWC5q8jiqFqkmm5zV1/iUdiuwDbiyxNXn
 wRmXkUc0h0Gs6MjnGAg0nsFJnIr2kACalVgQDWpuk/esAYZv9m9UPh3OT
 /R5432xOV2DAdYusXoJ0qtXvfh1dl/Pekp7TYdaWnTovwyxtn/6VJ0+oZ
 ns7X5zI0oT6x+kK3P9fb8kz7oAh4lU10+NITjwX1edWQQ+Z3DnyV4/vts
 YWL2I2Q37MqPCAyVdK1UT2YlkdKjT1FS7P9i5qYIw5urGXEnlwrlgWhZ+ g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10439"; a="274943009"
X-IronPort-AV: E=Sophos;i="5.93,237,1654585200"; d="scan'208";a="274943009"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Aug 2022 21:30:37 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,237,1654585200"; d="scan'208";a="582752635"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga006.jf.intel.com with ESMTP; 14 Aug 2022 21:30:37 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 14 Aug 2022 21:31:57 -0700
Message-Id: <20220815043157.1506623-3-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [Intel-gfx v4 2/2] drm/i915/guc: Add delay to disable

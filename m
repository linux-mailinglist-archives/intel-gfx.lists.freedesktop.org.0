...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0ECB8974DFA
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Sep 2024 11:08:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 640B110E927;
	Wed, 11 Sep 2024 09:08:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="frDRKt6Y";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0266410E908;
 Wed, 11 Sep 2024 09:08:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1726045732; x=1757581732;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=KOOBEeKAlppUmb279J6hEUy6pvbqisgME0nIz5XQjQI=;
 b=frDRKt6YRoDcPeedHwTUJ9lYGP4Ibk49nSHZvZA8JvJeezzyth6n0gXx
 dxd4qaC+zw8H+4Y4ZJx7oKZV3ycRr2Ko15z4+5pLd8KQqv6WSVqVU+YFW
 iNH18RjprTkiDSAIQCjG0RR+eRAlaBH/3lwE/fkPl1PQ/GPqrjM9znXTW
 SchLN3XKHAUzn9mzHaboG2vuG8Cre82Frcpxu5YC8Wa5EUvnPcv4VeOa9
 OrxSzHcRnm8wJm5L4x65mtqCHRikMO8/pSFe28U4eggPMjimO/iZAOP/y
 i0klc+K39Cb5M2hGGp24EqLHoZSA6Uk2mBODTRu1wPweyD1iPAbECt2Ua A==;
X-CSE-ConnectionGUID: IIlqbLEoS4uT/jKv+ytQuA==
X-CSE-MsgGUID: sp4hUi5cQnKHUPjb7ZIvUA==
X-IronPort-AV: E=McAfee;i="6700,10204,11191"; a="50245712"
X-IronPort-AV: E=Sophos;i="6.10,219,1719903600"; d="scan'208";a="50245712"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Sep 2024 02:08:50 -0700
X-CSE-ConnectionGUID: Kqq3Zyc6TsyjkO3pIhqSOg==
X-CSE-MsgGUID: dmtUdN2ZRDOvz39KyJ9Rdg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,219,1719903600"; d="scan'208";a="67253312"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orviesa009.jf.intel.com with ESMTP; 11 Sep 2024 02:08:47 -0700
...
Date: Wed, 11 Sep 2024 14:35:39 +0530
Message-ID: <20240911090540.643155-2-suraj.kandpal@intel.com>
...
index ebec03bc88e9..b964af7425cf 100644
...
@@ -470,8 +472,8 @@ int intel_hdcp_validate_v_prime(struct intel_connector *connector,
...
@@ -712,15 +714,15 @@ int intel_hdcp_validate_v_prime(struct intel_connector *connector,
 static
...
+	drm_dbg_kms(display->drm, "HDCP is enabled (%d downstream devices)\n",
 	...
 	ret = 0;
 err:
@@ -795,8 +797,8 @@ int intel_hdcp_auth_downstream(struct intel_connector *connector)
...
@@ -1073,20 +1075,20 @@ static struct intel_connector *intel_hdcp_to_connector(struct intel_hdcp *hdcp)
...
+		if (!drm_WARN_ON(display->drm, dig_port->num_hdcp_streams == 0))
 		...
 		dig_port->num_hdcp_streams++;
@@ -1102,8 +1104,8 @@ static void intel_hdcp_update_value(struct intel_connector *connector,
...
@@ -1229,17 +1231,17 @@ hdcp2_verify_rx_cert_prepare_km(struct intel_connector *connector,
...
@@ -1257,24 +1259,24 @@ hdcp2_verify_rx_cert_prepare_km(struct intel_connector *connector,
...
@@ -1363,25 +1365,25 @@ hdcp2_verify_lprime(struct intel_connector *connector,
...
@@ -1392,17 +1394,17 @@ hdcp2_verify_rep_topology_prepare_ack(struct intel_connector *connector,
 								*rep_topology,
...
@@ -1691,8 +1693,8 @@ int _hdcp2_propagate_stream_management_info(struct intel_connector *connector)
 static
...
@@ -1818,17 +1820,17 @@ static int hdcp2_authenticate_sink(struct intel_connector *connector)
...
+		drm_dbg_kms(display->drm, "Port deauth failed.\n");
 	...
 	data->k = 0;
@@ -1859,35 +1861,35 @@ static int hdcp2_enable_stream_encryption(struct intel_connector *connector)
...
+				    HDCP2_STATUS(display, cpu_transcoder,
 				    ...
 				    LINK_ENCRYPTION_STATUS,
 				    HDCP_ENCRYPT_STATUS_CHANGE_TIMEOUT_MS);
@@ -1898,32 +1900,33 @@ static int hdcp2_enable_encryption(struct intel_connector *connector)
...
@@ -1965,8 +1968,8 @@ hdcp2_propagate_stream_management_info(struct intel_connector *connector)
...
@@ -2054,23 +2057,23 @@ static int _intel_hdcp2_enable(struct intel_atomic_state *state,
 static int
...
+		drm_dbg_kms(display->drm, "Port deauth failed.\n");
 	...
 	dig_port->hdcp_auth_status = false;
@@ -2092,8 +2095,8 @@ _intel_hdcp2_disable(struct intel_connector *connector, bool hdcp2_link_recovery
...
+		drm_err(display->drm,
 		...
 		intel_hdcp_update_value(connector,
@@ -2169,7 +2172,8 @@ static void intel_hdcp_check_work(struct work_struct *work)
 					       struct intel_hdcp,
 					       check_work);
 	struct intel_connector *connector = intel_hdcp_to_connector(hdcp);
-	struct drm_i915_private *i915 = to_i915(connector->base.dev);
...
+	struct drm_i915_private *i915 = to_i915(display->drm);
 	...
 	if (drm_connector_is_unregistered(&connector->base))
 		return;
@@ -2186,13 +2190,12 @@ static int i915_hdcp_component_bind(struct device *drv_kdev,
...
@@ -2201,12 +2204,11 @@ static void i915_hdcp_component_unbind(struct device *drv_kdev,
 				       struct device *mei_kdev, void *data)
 {
 	struct intel_display *display = to_intel_display(drv_kdev);
-	struct drm_i915_private *i915 = to_i915(display->drm);
...
@@ -2240,11 +2242,11 @@ static int initialize_hdcp_port_data(struct intel_connector *connector,
 				     struct intel_digital_port *dig_port,
 				     const struct intel_hdcp_shim *shim)
 {
-	struct drm_i915_private *i915 = to_i915(connector->base.dev);
...
+	if (DISPLAY_VER(display) < 12)
 		...
 		/*
@@ -2264,11 +2266,11 @@ static int initialize_hdcp_port_data(struct intel_connector *connector,
...
@@ -2277,13 +2279,15 @@ static int initialize_hdcp_port_data(struct intel_connector *connector,
...
+	return (DISPLAY_VER(display) >= 10 ||
 		...
 		IS_COFFEELAKE(i915) ||
 		IS_COMETLAKE(i915));
@@ -2291,28 +2295,29 @@ static bool is_hdcp2_supported(struct drm_i915_private *i915)
...
@@ -2321,13 +2326,13 @@ static void intel_hdcp2_init(struct intel_connector *connector,
 			     struct intel_digital_port *dig_port,
 			     const struct intel_hdcp_shim *shim)
 {
-	struct drm_i915_private *i915 = to_i915(connector->base.dev);
...
@@ -2371,7 +2376,8 @@ static int _intel_hdcp_enable(struct intel_atomic_state *state,
...
+	struct drm_i915_private *i915 = to_i915(display->drm);
 	...
 	struct intel_digital_port *dig_port = intel_attached_dig_port(connector);
@@ -2383,14 +2389,14 @@ static int _intel_hdcp_enable(struct intel_atomic_state *state,
 		return -ENOENT;
...
@@ -2552,19 +2558,21 @@ void intel_hdcp_update_pipe(struct intel_atomic_state *state,
...
@@ -2654,7 +2662,8 @@ void intel_hdcp_atomic_check(struct drm_connector *connector,

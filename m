...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3ABD06D1811
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Mar 2023 09:05:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84C2210F108;
	Fri, 31 Mar 2023 07:05:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B631910F108
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Mar 2023 07:05:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680246322; x=1711782322;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=TO5ui8+sdfq9sxUepo1JRSpd4fwTmX/xNRkcG0uneUQ=;
 b=dKXeAPqb8yzos3Kl2sP3C3lrby9fvfyNcuz0oY52pWgYWrnCF8WsTsNi
 GjFlyscLxAJDm2qtvXZcfCrWvwjHaxgDBZeKIH5fQ4L4HEQg/ZVEdvnkC
 EUTl3NkRRCV1Ry1Req4KeRPXgEqSipUOkCdHjhQs17MzemVPpN4yOtbuF
 kTELOPaN1OKe/m4qMnfeN42b/Wjge+8yhqelTqmnEawQKkPCJXY12EwDQ
 4/t+aJs088K4i5dgp9oCh8rNanv9IlrG5VF/FhNQbDL5m889YzyMgsEiq
 p/MGoZysn5mjFzhYpmsDarhSecu8KSXjphzEN8CPocKrcA/LciZ6u+4R0 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10665"; a="341391158"
X-IronPort-AV: E=Sophos;i="5.98,307,1673942400"; d="scan'208";a="341391158"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2023 00:05:22 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10665"; a="717600276"
X-IronPort-AV: E=Sophos;i="5.98,307,1673942400"; d="scan'208";a="717600276"
...
To: Lionel Landwerlin <lionel.g.landwerlin@intel.com>, Matt Atwood
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230028)(39860400002)(376002)(366004)(136003)(346002)(396003)(451199021)(316002)(6512007)(186003)(6666004)(53546011)(6506007)(110136005)(26005)(31686004)(2616005)(83380400001)(38100700002)(6486002)(478600001)(8936002)(86362001)(5660300002)(31696002)(66556008)(66946007)(41300700001)(8676002)(66476007)(2906002)(4326008)(36756003)(82960400001)(43740500002)(45980500001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 31 Mar 2023 07:05:18.7566 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2822E65AD47
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Jan 2023 06:42:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB98610E193;
	Mon,  2 Jan 2023 05:42:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 727E010E189
 for <intel-gfx@lists.freedesktop.org>; Mon,  2 Jan 2023 05:42:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672638137; x=1704174137;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6d/cxNZWSXnEPwQypt5ioFi3OGHCwX+eLNG0ZS61j38=;
 b=Pf+67DteXAehGki5K4X2YFF+JtO8oPB5KxTOt72Z6s1OGgI45zWkbwlm
 BdFchBBlHKajkzUQbcHZtx//CpulgtbVN/WcEK9vWocVyA1JpxLHSID0N
 UanEVjzjXw4arXFR+fnY93IbbhtlWpliEBwaOjbf+tt1dvUXxqfpn2QSp
 kZlK+doif9GJhlWNGMjjNXoQj+ph6W8XtRXDUjINTJjp63v1/eH7ibW3L
 oHP90F5tLf1V0/YmiqrY2H8mrwBxF+JxmKmPO7CByDfMAkII07Z4bUVrK
 4WSpGXbF/l1+oC2fr0IYCLhiGuasR0wcuLVa1jBduelfburSjeOIOArhQ Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10577"; a="301124345"
X-IronPort-AV: E=Sophos;i="5.96,293,1665471600"; d="scan'208";a="301124345"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jan 2023 21:42:17 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10577"; a="828472838"
X-IronPort-AV: E=Sophos;i="5.96,293,1665471600"; d="scan'208";a="828472838"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga005.jf.intel.com with ESMTP; 01 Jan 2023 21:42:11 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  2 Jan 2023 11:10:44 +0530
Message-Id: <20230102054047.124624-5-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 4/7] drm/i915/hdcp: Refactor HDCP API
 structures

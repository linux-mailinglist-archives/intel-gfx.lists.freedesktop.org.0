...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 142DE810BAF
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Dec 2023 08:41:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C99D410E707;
	Wed, 13 Dec 2023 07:41:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 67BA510E709;
 Wed, 13 Dec 2023 07:41:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702453279; x=1733989279;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=hH3Fb41UmMhywgRlHiQjIBzk0QHpv37KjhuE2eTaY7I=;
 b=UCg9LAcndFikjcYhfGPRoPoNCd9wCRd8TWsh8xH1n/Yhdath7nsqNaLX
 NwipRHxMUm+uU6iLvOavsv7YTqwGe/3gMCSL58FsmrZkrjlgmy6WMKFLJ
 z9PNomxG/HjTXHTcFXA0Llp7V18uQoQVVCVqu0YUhZlcljQnFrh/zVAZV
 s7w0gepcOfc9OFTrivMpeK2V2197Bh7LwuA9t5tVSoJAVSMak5I3TNXKJ
 vk1zJEYXls+7OuetqfwNLf5SrBcxSLPkI0IHSmaRjSr354a9ui6XHq+A5
 3vSGxp4AHmO04LD5qKu749miQtCNdbE4595E3X/NtF1mqIK/CyI/OTgXa w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10922"; a="397710934"
X-IronPort-AV: E=Sophos;i="6.04,272,1695711600"; d="scan'208";a="397710934"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Dec 2023 23:41:10 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10922"; a="767116472"
X-IronPort-AV: E=Sophos;i="6.04,272,1695711600"; d="scan'208";a="767116472"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga007.jf.intel.com with SMTP; 12 Dec 2023 23:41:06 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 13 Dec 2023 09:41:06 +0200
Date: Wed, 13 Dec 2023 09:41:06 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Subject: Re: =?utf-8?B?4pyXIEZpLkNJLklHVA==?= =?utf-8?Q?=3A?= failure for
 drm/i915/dmc: DMC event stuff
Message-ID: <ZXlgEl-yWDNHVY3c@intel.com>
References: <20231211213750.27109-1-ville.syrjala@linux.intel.com>
 ...
 <ZXle2h3XQ8l2JQ4c@ideak-desk.fi.intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <ZXle2h3XQ8l2JQ4c@ideak-desk.fi.intel.com>

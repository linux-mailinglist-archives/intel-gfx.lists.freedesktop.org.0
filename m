...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8C5C4D014A
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Mar 2022 15:32:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3AEE10E190;
	Mon,  7 Mar 2022 14:32:33 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 2/6] drm/i915/gt: Clear compress metadata

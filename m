...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A17F543EA9
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 23:32:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 878241137D9;
	Wed,  8 Jun 2022 21:32:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9AB481137B6;
 Wed,  8 Jun 2022 21:32:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654723952; x=1686259952;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=Tcudh4aL3r1RKm7ODKKJE6v6LtbmZRMgaPw384UPbpM=;
 b=PGuX9D6AqJgJYCtRXhjW57Diwe6PlBPCcVrwKcNrbvW8zFMVlGC8k9Pg
 rLwOfVTX/0SyRZwS4EKPvAk0vlGFWcAIVubBg0YHpStFnJlGf1bXxKMOY
 N/3czIkx6zfPnted/bmdwpC08U3Djv8Yfv4dBGJcAN/YAzVReFSSUi+c5
 s2Qo0ObMeu8YkdmqxR4DP8bq8x0fYyXLQBfKy1h1uiW6Sm5IKiE39sQzK
 /XfoJJDgwbiozRXXHZQixIIe1MggLIrcIyca4Ulp6joG/k/eeBKgnpKuu
 BuOp2f0IZwUyY4IEnbJFpKQsufnaDwckYqRfSiXgAH0wVo/ZK2uUsPEdJ Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10372"; a="260195995"
X-IronPort-AV: E=Sophos;i="5.91,286,1647327600"; d="scan'208";a="260195995"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jun 2022 14:32:31 -0700
X-IronPort-AV: E=Sophos;i="5.91,286,1647327600"; d="scan'208";a="683579789"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jun 2022 14:32:31 -0700
Date: Wed, 8 Jun 2022 14:32:13 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Matthew Auld <matthew.auld@intel.com>
Message-ID: <20220608213212.GC4461@nvishwa1-DESK>
...
In-Reply-To: <d2d642e0-184c-2c77-2287-2c48e734c671@intel.com>

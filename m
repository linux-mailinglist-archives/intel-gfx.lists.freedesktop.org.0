...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E98F6FFD1E
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 01:18:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5971F10E60B;
	Thu, 11 May 2023 23:17:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 648EA10E12C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=oDhrl9/c5rFrMXIuC1m1gOOu/F76ffamF9VCH/EyJ+C+8zXhLBWOXFI+
 dgSnmCFCEDj43H3vqOHYz9kINbPz+lJXz0VFweYKGdIq2DyNr+fwnI3Yx
 4s0rQuUoQq/ydDJ+YXKyZkSDpoVLxC8KmVecJpJoPExGSI98TBI5q2bXU
 pVMHXnejQdh6mAJAJcrADTiKMIDIBtARRfXJkoowyRs4AfcVxJopY1ziw
 ojf8mlsmoqNEbNlzFgoPOFIIbu87bgOzpFj0a5ZXEEo6VZnAc7/Y1a8tv
 XY/RmA5PzxofpF0KVLTDIdorw/VKJboyPi6L14to2+gBSuGVK5tUxViEc w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="378794000"
X-IronPort-AV: E=Sophos;i="5.99,268,1677571200"; d="scan'208";a="378794000"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2023 16:17:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="874164384"
X-IronPort-AV: E=Sophos;i="5.99,268,1677571200"; d="scan'208";a="874164384"
...
Message-Id: <20230511231738.1077674-6-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 5/8] drm/i915/pxp: Add ARB session creation
 and cleanup

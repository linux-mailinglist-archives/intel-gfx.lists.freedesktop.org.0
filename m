...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC49251B9C8
	for <lists+intel-gfx@lfdr.de>; Thu,  5 May 2022 10:13:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 21B6E10F7C8;
	Thu,  5 May 2022 08:04:06 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/i915: Don't use DRM_DEBUG_WARN_ON
 for ring unexpectedly not idle

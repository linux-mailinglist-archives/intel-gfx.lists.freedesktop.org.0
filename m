...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BE23C41F3E9
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Oct 2021 19:53:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17AA06EEB7;
...
Subject: [Intel-gfx] [PATCH v3 09/10] vfio: Export vfio_device_try_get()

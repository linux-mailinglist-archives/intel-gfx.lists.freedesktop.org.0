...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B27271401A2
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jan 2020 02:58:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 902E16F374;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/4] drm/mst: Some style improvements in

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CE1A53E20EB
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Aug 2021 03:21:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 400056EB68;
...
Subject: [Intel-gfx] [PATCH v4 08/14] vfio/pci: Move to the device set
 infrastructure

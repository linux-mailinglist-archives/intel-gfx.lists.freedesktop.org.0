...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E1AE4E32C6
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Mar 2022 23:44:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D330910E4A1;
	Mon, 21 Mar 2022 22:44:33 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 3/9] drm/i915/gt: Clear compress metadata for
 Flat-ccs objects

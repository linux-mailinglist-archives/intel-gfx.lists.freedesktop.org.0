...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EA24668C3D0
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Feb 2023 17:51:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43ADE10E420;
...
Subject: Re: [Intel-gfx] [PATCH 1/3] drm/i915/doc: Escape wildcard in method
 names
...
Cc: Luben Tuikov <luben.tuikov@amd.com>,
 ...
 Linus Walleij <linus.walleij@linaro.org>, DRI
 ...
 Andrey Grodzovsky <andrey.grodzovsky@amd.com>, Daniel
 Vetter <daniel@ffwll.ch>,
 Intel Graphics Development List <intel-gfx@lists.freedesktop.org>,
 Lucas De Marchi <lucas.demarchi@intel.com>,
 Hans de Goede <hdegoede@redhat.com>, Mauro
 Carvalho Chehab <mchehab@kernel.org>, Linux Kernel Mailing

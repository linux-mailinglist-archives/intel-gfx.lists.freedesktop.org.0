...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C198261F55B
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Nov 2022 15:17:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C80E10E339;
...
Subject: [Intel-gfx] [PATCH v7 08/23] drm/modes: Move named modes parsing to
 a separate function

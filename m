...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7978E1A26D0
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Apr 2020 18:09:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C19B56EA8C;
	Wed,  8 Apr 2020 16:09:06 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 5/5] drm/i915: Enable scaling filter for
 plane and CRTC

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F36A9A33DF6
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Feb 2025 12:27:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6276710EA6B;
	Thu, 13 Feb 2025 11:27:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="ET0iSuSE";
	dkim-atps=neutral
...
Received: from us-smtp-delivery-124.mimecast.com
 ...
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Feb 2025 11:27:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1739446022;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=+vkuXSpIUHTDHSrs1Umi3GC7kTah6gvJvklDFfkYRyo=;
 b=ET0iSuSEV2M0dF2Yc+KedP8LrqYO/vFgMzcYa4RBbuwtCozwebkzrxnHnQ4+jkJvMJirNM
 GLOUb1psZFSnyms92ud0LddvdaZGLOoBQmyvpCZHSop/ngVH/el1sCUkeX41ZLfjXh1BLG
 nkoupaQ13YVRVvjJAveoz+dIeO/UM30=

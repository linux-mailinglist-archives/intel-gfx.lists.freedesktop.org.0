...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E6D64D59E3
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Mar 2022 05:48:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9E4310E7FC;
...
Subject: [Intel-gfx] [PATCH 4/5] dyndbg: drop EXPORTed

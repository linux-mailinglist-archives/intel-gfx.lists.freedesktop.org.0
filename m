...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5249A2466D2
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Aug 2020 15:02:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3A3A6E11D;
...
Subject: [Intel-gfx] [PATCH] char: ipmi: convert tasklets to use new
 tasklet_setup() API

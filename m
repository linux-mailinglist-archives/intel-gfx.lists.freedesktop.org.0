...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C87C37D579B
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Oct 2023 18:12:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C15FF10E40A;
...
Subject: [Intel-gfx] [RFC 3/8] drm/cgroup: Add ability to query drm cgroup
 GPU time

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E833F167A6A
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Feb 2020 11:17:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C047889F77;
	Fri, 21 Feb 2020 10:17:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AF82D89F77
 for <intel-gfx@lists.freedesktop.org>; Fri, 21 Feb 2020 10:17:49 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20299675-1500050 
 for multiple; Fri, 21 Feb 2020 10:17:27 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 21 Feb 2020 10:17:23 +0000
Message-Id: <20200221101724.2602426-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/3] drm/i915/gem: Extract transient execbuf
 flags from i915_vma
...
index 87fa5f42c39a..3ccd3a096486 100644
...
@@ -1794,27 +1785,19 @@ static int eb_move_to_gpu(struct i915_execbuffer *eb)
...
-			vma->exec_flags = &eb->flags[0];
 			...
 			err = ww_mutex_lock_slow_interruptible(&vma->resv->lock,
 							       &acquire);
@@ -1825,8 +1808,9 @@ static int eb_move_to_gpu(struct i915_execbuffer *eb)
...
+		unsigned int flags = ev->flags;
 		...
 		assert_vma_held(vma);
@@ -1870,10 +1854,10 @@ static int eb_move_to_gpu(struct i915_execbuffer *eb)
 		i915_vma_unlock(vma);
...
@@ -2008,7 +1992,7 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	if (!pw)
 		return -ENOMEM;
...
@@ -2025,7 +2009,7 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
...
+	pw->batch = eb->batch->vma;
 	...
 	pw->shadow = shadow;
@@ -2067,7 +2051,7 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 err_shadow:
...
+	i915_active_release(&eb->batch->vma->active);
 err_free:
 	kfree(pw);
 	return err;
@@ -2130,15 +2114,13 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err_trampoline;
...
-	eb->batch = shadow;
 	...
 	shadow->private = pool;
 	return 0;
@@ -2165,7 +2147,7 @@ add_to_client(struct i915_request *rq, struct drm_file *file)
...
@@ -2192,7 +2174,7 @@ static int eb_submit(struct i915_execbuffer *eb)
 	}
...
+					batch->node.start +
 					...
 					eb->batch_len,
 					eb->batch_flags);
@@ -2572,6 +2554,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2586,9 +2569,8 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2673,21 +2655,23 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 		goto err_vma;
 	}
...
+		eb.batch_len = eb.batch->vma->size - eb.batch_start_offset;
 	...
 	err = eb_parse(&eb);
 	if (err)
@@ -2697,6 +2681,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2710,13 +2695,13 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2763,12 +2748,12 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2791,9 +2776,9 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
+		intel_engine_pool_put(batch->private);
 err_vma:
 	if (eb.exec)
 		eb_release_vmas(&eb);
@@ -2818,9 +2803,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B44A46337
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jun 2019 17:46:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6904089A62;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 mZyA==
Subject: Re: [Intel-gfx] [BUG] lockdep splat with kernfs lockdep annotations
 and slab mutex from drm patch??

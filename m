...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E49275C696
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jul 2023 14:09:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E723910E668;
	Fri, 21 Jul 2023 12:09:23 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [v7,
 5/9] drm/i915/gt: Enable the CCS_FLUSH bit in the pipe control

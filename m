...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5AB982ECAD
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Jan 2024 11:23:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34ED710E45D;
	Tue, 16 Jan 2024 10:23:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 839FD10E45D
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Jan 2024 10:23:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1705400584; x=1736936584;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=YYV+mLh0piQgfiU/WzjGFjlY877VNFgf/KUvPsHKT4M=;
 b=kiKKwvWiWDxI2Cwc8+crf3NjvbMMfjxbqiggbXoXkc3xn7F7uZ3cXH1b
 0vEHaCNdwNKxb+dbeLJO/HqBItONL05AVuj3mfbt3pQsXv1ceBjh3okqA
 2B6AO2i09EeVKb7GWL/4Pbnw4VLILEVKqfwhKj68klIopSYFTKCli9Rh5
 ORCHV83HgskR11SfaY59lUEOdr7WaVock54OvDJfoGvdivQqgpps+IL32
 2lGMEKMy6U7sd3b0p2zdjAI6AEHxRMlUoxsinwKJ6B+Uo7utgQmHBa1Oo
 JYnEDePhpIL2AgWVEyp8xPNj9JBBwN4Y9ybS5LOQsiQ+rfm1wzTxVq/so g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10954"; a="13174293"
X-IronPort-AV: E=Sophos;i="6.04,198,1695711600"; d="scan'208";a="13174293"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jan 2024 02:23:04 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10954"; a="784082262"
X-IronPort-AV: E=Sophos;i="6.04,198,1695711600"; d="scan'208";a="784082262"
Received: from nirmoyda-mobl.ger.corp.intel.com (HELO [10.246.32.218])
 ([10.246.32.218])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jan 2024 02:23:02 -0800
Message-ID: <d9566696-3e6e-4382-b0ba-0995cbb001ab@linux.intel.com>
Date: Tue, 16 Jan 2024 11:23:00 +0100
MIME-Version: 1.0
...
In-Reply-To: <20240116075636.6121-2-ville.syrjala@linux.intel.com>

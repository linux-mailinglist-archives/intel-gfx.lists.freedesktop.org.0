...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AAC775F4E4B
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Oct 2022 05:25:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 37BD010E053;
	Wed,  5 Oct 2022 03:24:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5A4AC10E053;
 Wed,  5 Oct 2022 03:24:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664940295; x=1696476295;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=vZmoGmcC3s4jdgkmQaaldUzq6aWYFfrh0AFMRwVo+mg=;
 b=CE4aKdBqt9r9kfEECzX0LfDpe25aWqdrhGfjW54MJa0ogZ4th2lZHiaz
 /+JyhqyBiG/gD1Z0w0sTCXQghtoguSMonELkRPA3hsJrc2l23AkOXA0LW
 XEBSZbg70+RYe4cgurFzHL+37enPoLipJP3FyRrGOq/X2RZOX4zSyyxhx
 BQNomRT3woZInlWRbNLQLYbZ+0MyMb3FZcqS6u7tWKtxedAXBrosIIdsx
 rX/55UXmteSq8gQOehZJ2aIrkw+jWHq0qr37oXHNTdrtBTy9kg+1rE/e+
 oxPA00Bwk3BklKh99OInXe3Nr5AP/b09/E0/LwNVtW0bmTJTE+fZsFGmX g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10490"; a="365001759"
X-IronPort-AV: E=Sophos;i="5.95,159,1661842800"; d="scan'208";a="365001759"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Oct 2022 20:24:54 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10490"; a="953038996"
X-IronPort-AV: E=Sophos;i="5.95,159,1661842800"; d="scan'208";a="953038996"
Received: from lkp-server01.sh.intel.com (HELO d4f44333118a) ([10.239.97.150])
 by fmsmga005.fm.intel.com with ESMTP; 04 Oct 2022 20:24:51 -0700
Received: from kbuild by d4f44333118a with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1ofv1f-0000pZ-0h;
 Wed, 05 Oct 2022 03:24:51 +0000
Date: Wed, 5 Oct 2022 11:24:26 +0800
From: kernel test robot <lkp@intel.com>
To: Vinay Belgaumkar <vinay.belgaumkar@intel.com>,
 intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org
Message-ID: <202210051130.2Ac1wES2-lkp@intel.com>
References: <20221004222903.23898-3-vinay.belgaumkar@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="vlwYh63BnsLahYPZ"

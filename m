...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A2751732BF9
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 11:39:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C1E210E592;
	Fri, 16 Jun 2023 09:39:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C133B10E58E;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=KKrXRDApZaCmE5tN8MwZxV4+eG7irwO+S/OjdbPa4DYe3IdZdP34klyk
 bfiNlKh+8i1AsaPZWMF68tyRt4VvucysfoRNfGez0qskK3caWAbA2tBJ1
 ciPbA66na97KXuvtQsXQrKmgOXtSV06H5tX50KLOKBJO5LZyQ7RqUuaRS
 3hqXGc55H42qowx0p2NPM3oVixjBmRSicoZy3ipCje12VSTLUjfH+QxhM
 xOZ8RAFhyzNyOUl/3xJiE05SOKHD8t8auObWMlLg/q6cx4VFiyX6NVt1O
 gQVB7BmdyJavP7lMbSSV7u8ZebOzOjKGfns5UFq20Z3l6w+lSnyBPDVfc w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="361700122"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="361700122"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2023 02:39:50 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="715950988"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="715950988"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga007.fm.intel.com with ESMTP; 16 Jun 2023 02:39:48 -0700
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Fri, 16 Jun 2023 02:39:25 -0700
Message-Id: <20230616093946.68711-2-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230616093946.68711-1-yi.l.liu@intel.com>
References: <20230616093946.68711-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v13 01/22] vfio: Allocate per device file
 structure

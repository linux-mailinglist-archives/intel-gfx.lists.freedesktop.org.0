...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF64967C112
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Jan 2023 00:42:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 781A510E3AF;
	Wed, 25 Jan 2023 23:42:29 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 3/3] drm/i915/xehp: Annotate a couple more
 workaround registers as MCR

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C5DF292A5C
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Oct 2020 17:27:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79A896E9F6;
	Mon, 19 Oct 2020 15:27:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3EF866E9F6
 for <intel-gfx@lists.freedesktop.org>; Mon, 19 Oct 2020 15:27:07 +0000 (UTC)
IronPort-SDR: h25SWoR2/6BR9g1Pz/Lqmk8FY5+ofXnbr3mKa/RWouXYzxMd3gebrFYEMBATvf+NrF3uSLH3lQ
 eMFNg0kMGs6A==
X-IronPort-AV: E=McAfee;i="6000,8403,9778"; a="228686912"
X-IronPort-AV: E=Sophos;i="5.77,394,1596524400"; d="scan'208";a="228686912"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Oct 2020 08:27:06 -0700
IronPort-SDR: cK1Wysskx2vXcQo738QTW2aHLtfprMgBdgdbmqRBpT1xabP9a9/1OhNJh7FGg38MQBv5odthjz
 Ig3AXtdxQkPg==
X-IronPort-AV: E=Sophos;i="5.77,394,1596524400"; d="scan'208";a="532666903"
Received: from ideak-desk.fi.intel.com ([10.237.68.141])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Oct 2020 08:27:05 -0700
Date: Mon, 19 Oct 2020 18:27:01 +0300
From: Imre Deak <imre.deak@intel.com>
To: Ville Syrjala <ville.syrjala@linux.intel.com>
Message-ID: <20201019152701.GE3199870@ideak-desk.fi.intel.com>
...
>  		 * time to wake up.
> @@ -6782,14 +6784,11 @@ void intel_dp_encoder_reset(struct drm_encoder *e=
ncoder)
>  {

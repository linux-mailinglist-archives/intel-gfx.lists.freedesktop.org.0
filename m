...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 112371A26CF
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Apr 2020 18:08:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B78F76EA92;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 4/5] drm/i915/display: Add Nearest-neighbor

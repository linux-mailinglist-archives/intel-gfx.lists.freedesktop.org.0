...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A82C06F4DB9
	for <lists+intel-gfx@lfdr.de>; Wed,  3 May 2023 01:40:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0282310E12E;
...
Subject: [Intel-gfx] [PATCH v3 3/6] drm/i915/uc: Track patch level versions

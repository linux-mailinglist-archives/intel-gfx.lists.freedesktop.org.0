...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B9ED3D43CA
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Jul 2021 02:12:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8435C6FD49;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/30] drm/i915/display: remove explicit CNL

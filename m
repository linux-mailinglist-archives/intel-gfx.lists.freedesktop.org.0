...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E3E86BAC8B
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Mar 2023 10:50:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1228010E98D;
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/i915/pmu: Remove fallback to
 requested freq for SLPC

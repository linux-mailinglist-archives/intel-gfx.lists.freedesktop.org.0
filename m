...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10411913AD
	for <lists+intel-gfx@lfdr.de>; Sun, 18 Aug 2019 01:25:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 772BB6E02A;
	Sat, 17 Aug 2019 23:25:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E7F256E02A
 for <intel-gfx@lists.freedesktop.org>; Sat, 17 Aug 2019 23:25:15 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18175820-1500050 
 for <intel-gfx@lists.freedesktop.org>; Sun, 18 Aug 2019 00:25:12 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 18 Aug 2019 00:25:11 +0100
Message-Id: <20190817232511.11391-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.23.0.rc1
MIME-Version: 1.0
Subject: [Intel-gfx] [CI] drm/i915: Propagate fence errors
...

...
aXRzIGhvdHBsdWdnaW5nIHBlcmZvcm1lZCBkdXJpbmcgYW4gZW1lcmdlbmN5CkBAIC0xMDQ4LDYg
KzEwNTIsOSBAQCB2b2lkIGk5MTVfcmVxdWVzdF9za2lwKHN0cnVjdCBpOTE1X3JlcXVlc3QgKnJx
...
b3V0IGFsbCB0aGUgdXNlciBvcGVyYXRpb25zIGxlYXZpbmcgdGhlCkBAIC0xMDU5LDYgKzEwNjYs
...
MzYyZTRlMDBiNGM2Li42YTg4ZGIyOTEyNTIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9p
...
aAppbmRleCA4Y2YzNTNlOGMzZTAuLmFiN2Q1OGJkMGI5ZCAxMDA2NDQKLS0tIGEvZHJpdmVycy9n
...
LT5mbGFncyA9ICh1bnNpZ25lZCBsb25nKW5vcF9mZW5jZV9ub3RpZnk7CiB9CiAKLS0gCjIuMjMu

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 95AAC58B1A4
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Aug 2022 23:55:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A25C9BBB8;
...
Subject: [Intel-gfx] [PATCH v5 05/33] dyndbg: reverse module.callsite walk
 in cat control

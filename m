...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B453BCAF29
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Oct 2019 21:25:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2ED16EA5E;
	Thu,  3 Oct 2019 19:25:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 084366EA5B
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Oct 2019 19:25:08 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 03 Oct 2019 12:25:07 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.67,253,1566889200"; d="scan'208";a="191358429"
Received: from bkokkula-mobl1.ger.corp.intel.com (HELO
 mwahaha-bdw.ger.corp.intel.com) ([10.252.7.77])
 by fmsmga008.fm.intel.com with ESMTP; 03 Oct 2019 12:25:06 -0700
From: Matthew Auld <matthew.auld@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  3 Oct 2019 20:24:34 +0100
Message-Id: <20191003192444.10113-13-matthew.auld@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20191003192444.10113-1-matthew.auld@intel.com>
References: <20191003192444.10113-1-matthew.auld@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 12/22] drm/i915: treat shmem as a region
...
aW5kZXggNGM0OTU0ZThjZTBhLi41NTQ1MDQzNDllYjAgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1
...
LT5iYXNlLmZpbHApOwogfQogCkBAIC00MzQsNyArNDM5LDcgQEAgY29uc3Qgc3RydWN0IGRybV9p
...
emVfdCBzaXplKQogewpAQCAtNDU1LDMxICs0NjAsMjMgQEAgc3RhdGljIGludCBjcmVhdGVfc2ht
...
YXNlLCBzaXplKTsKIAlpZiAocmV0KQogCQlnb3RvIGZhaWw7CiAKQEAgLTUxOCw3ICs1MTUsNyBA
...
dXJuIG9iajsKIApAQCAtNTI3LDYgKzUyNCwxMyBAQCBpOTE1X2dlbV9vYmplY3RfY3JlYXRlX3No
...
NTc3LDMgKzU4MSwzMyBAQCBpOTE1X2dlbV9vYmplY3RfY3JlYXRlX3NobWVtX2Zyb21fZGF0YShz
...

...
OTE1L2k5MTVfZ2VtLmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCmluZGV4IDE0
MjZlNTA2NzAwZC4uYTEwYmY3M2UzMzljIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkx
...
IgpAQCAtMTUzOCwxNiArMTUzNywxMCBAQCBzdGF0aWMgdm9pZCBpOTE1X2dlbV9pbml0X19tbShz
...
YXJseShzdHJ1Y3QgZHJtX2k5MTVfcHJpdmF0ZSAqZGV2X3ByaXYpCkBAIC0xNTU2LDggKzE1NDks
...
X2dlbV9ndHQuYyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZ2VtX2d0dC5jCmluZGV4IGYx
ZTQyYzJlMThkNy4uZDA1YWZmNzY3N2MyIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkx
...

...
RVMgXAogCUdFTigyKSwgXAogCS5pc19tb2JpbGUgPSAxLCBcCkBAIC0xNjgsNyArMTcxLDggQEAK
...
TigyKSwgXApAQCAtMTg1LDcgKzE4OSw4IEBACiAJSTg0NV9QSVBFX09GRlNFVFMsIFwKIAlJODQ1
...
CiAJSTgzMF9GRUFUVVJFUywKQEAgLTIxOSw3ICsyMjQsOCBAQCBzdGF0aWMgY29uc3Qgc3RydWN0
...
OTE1Z19pbmZvID0gewogCUdFTjNfRkVBVFVSRVMsCkBAIC0zMDQsNyArMzEwLDggQEAgc3RhdGlj
...
ZXZpY2VfaW5mbyBpbnRlbF9pOTY1Z19pbmZvID0gewogCUdFTjRfRkVBVFVSRVMsCkBAIC0zNTQs
NyArMzYxLDggQEAgc3RhdGljIGNvbnN0IHN0cnVjdCBpbnRlbF9kZXZpY2VfaW5mbyBpbnRlbF9n
...
QVRVUkVTLApAQCAtMzg0LDcgKzM5Miw4IEBAIHN0YXRpYyBjb25zdCBzdHJ1Y3QgaW50ZWxfZGV2
...
TlMKIAogI2RlZmluZSBTTkJfRF9QTEFURk9STSBcCiAJR0VONl9GRUFUVVJFUywgXApAQCAtNDMy
LDcgKzQ0MSw4IEBAIHN0YXRpYyBjb25zdCBzdHJ1Y3QgaW50ZWxfZGV2aWNlX2luZm8gaW50ZWxf
...
aW5lIElWQl9EX1BMQVRGT1JNIFwKIAlHRU43X0ZFQVRVUkVTLCBcCkBAIC00OTMsNiArNTAzLDcg
...
NV9GRUFUVVJFUyAgXApAQCAtNTg3LDYgKzU5OCw3IEBAIHN0YXRpYyBjb25zdCBzdHJ1Y3QgaW50
...
NjYxLDcgKzY3Myw4IEBAIHN0YXRpYyBjb25zdCBzdHJ1Y3QgaW50ZWxfZGV2aWNlX2luZm8gaW50
...
bW9ja19nZW1fZGV2aWNlLmMKaW5kZXggNGNlYWFhNTI5ZGE3Li5jZjU0OTFmZTRmZDAgMTAwNjQ0
...
MTUpOwogCWludGVsX2d0X2luaXRfZWFybHkoJmk5MTUtPmd0LCBpOTE1KTsKQEAgLTIxOCw4ICsy
MTgsNiBAQCBzdHJ1Y3QgZHJtX2k5MTVfcHJpdmF0ZSAqbW9ja19nZW1fZGV2aWNlKHZvaWQpCiAJ

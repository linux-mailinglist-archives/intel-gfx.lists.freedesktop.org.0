...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 221C521FF48
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEB5C6E9DD;
...
Subject: [Intel-gfx] [PATCH v2 43/59] drm/kmb: Changed name of driver to
 kmb-drm

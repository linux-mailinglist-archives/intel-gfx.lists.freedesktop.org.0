...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 677E64E4FF8
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Mar 2022 11:05:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 63E7D10E65C;
...
Subject: [Intel-gfx] [PATCH] drm/edid: fix CEA extension byte #3 parsing

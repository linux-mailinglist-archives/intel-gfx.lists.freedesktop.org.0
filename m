...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 34BCE5EFC3A
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 19:49:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3357610EBA1;
	Thu, 29 Sep 2022 17:49:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B26FE10EB9F;
 Thu, 29 Sep 2022 17:49:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664473771; x=1696009771;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=mWfUKUhn7QKJ4tVnvhEpCjWFNVPM2n8bIx6U2efhtEk=;
 b=HXofNq7ayziFoSmgfFimngghZauAkmvtRgfPNWskcVYi5/6KlfSHZPYU
 IAQcRZ6Ae4cp5B7R7BSESXh+Mgs0nphQwDlsGv4pJJdB6rbIrktN92ETa
 7738fsMrgTawauuH+tbYtH3Cdi9Ap/+KEjH+YG5bu27Pe1omPGwC0KxVs
 7fIIQYULTCeuiCgCVpqtgDLbdFg7SKD5yVfO/1ld/ufb1UlS2sv6OiwYv
 7Qhyd5efR2WxeGgLgD8mG9J0AsxEFLfGGKaGiPVUH9SBplXhuBc7gsBvp
 h+gIHhTkm1AQ0BDKNtV+N0DJqnmheFKEaY2uXYWF3epgFqEKeYDtEjkni A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="300695053"
X-IronPort-AV: E=Sophos;i="5.93,355,1654585200"; d="scan'208";a="300695053"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2022 10:49:31 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="573553460"
X-IronPort-AV: E=Sophos;i="5.93,355,1654585200"; d="scan'208";a="573553460"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2022 10:49:30 -0700
Date: Thu, 29 Sep 2022 10:49:08 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Matthew Auld <matthew.auld@intel.com>
Message-ID: <20220929174907.GE22224@nvishwa1-DESK>
References: <20220928061918.6340-1-niranjana.vishwanathapura@intel.com>
 ...
 <7183f3e9-22cd-6d15-0b3b-d8e7d1a8b986@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1; format=flowed
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <7183f3e9-22cd-6d15-0b3b-d8e7d1a8b986@intel.com>
...
>>>>+ *
>>>>+ * 1) vm_bind_lock mutex will protect vm_bind lists. This lock 
>>>>is taken in
...
>
>Yeah, so that stops the object from disappearing, but what about the 
>vma itself, when chasing the pointer? Can that only happen if the 
>entire vm is nuked? So is it actually only safe since we are holding 
>the vm ref here, and not the object ref?
>

Yah, a persistent vma can only be destroyed by either by vm_unbind
call or when the VM itself is released (as we hold object reference).
As we hold the VM reference here, it is safe to access the vma.
...
>>>>+        return ret;
>>>
>>>IIUC we have already called bind_remove() above, so 
>>>vm_bind_lookup() can't find it any more? Is the user meant to call 
>>>this again, if we can't grab the object lock? Are we not leaking 
>>>the below object_put() until the entire driver fd is nuked? Can we 
>>>not grab the vm_bind_lock and then object_lock, before calling the 
>>>bind_remove()? And then on lock error userspace can just call this 
>>>again? Sorry if I'm misunderstanding something here.
>>
...
>>>>obj->base.size)) {
>>>
>>>Nit: could maybe split this into multiple different checks for 
>>>better readability.
>>>
>>
>>Ok, let me see.
...
>>>
>>>va->start for sure needs some sanity checking first. Evil user 
>>>could be setting the low bits here (0-11), which would cause havoc 
>>>with our vma flags.
>>>
>>
>>Ok, will do.

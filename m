...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B4C79C4432
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Nov 2024 18:53:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2FD810E4FC;
	Mon, 11 Nov 2024 17:53:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ioBomHiv";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0843D10E4FB;
 Mon, 11 Nov 2024 17:53:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1731347625; x=1762883625;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=kfcEFKl7n3sZna/Se8ujXF1Ku06oYcO0uLOuPwNEnnY=;
 b=ioBomHivZhnTBLAfprnaXLMw59x9i0sxzBmw7HHFXKLxHt6Nw/yeGvaS
 XKuWpO0lR6f2IKgINXBLL64XP2HOAvdRsBV0bwyOHn3UGSygSc37no9CO
 q8TB6QLpmoJFmbpRyrmC+6oc+RF3wZ4Gwdyo027ED8vT/hl60bsobhT5J
 WBBWFNH04Apdcps6fg+2TkxxcB8Gily+V+hhmBoviWSm2IZ8lbwZEXila
 RZWFMwn+L5tx+4U4N2Qcj/BJsWhQ3mWvE8mVBab3hggtriKpPd9ClTCHF
 /p7H1fmi2MmeJvX3bXJkfmPjLosiQO4Gyoa7oZrF2DBF12/Be6csyiqAB g==;
X-CSE-ConnectionGUID: y4iBAd+4Qv2GNM8JyOvKtg==
X-CSE-MsgGUID: vQFUSn0PQU61JXWqpOV0iw==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="31317353"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="31317353"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2024 09:53:45 -0800
X-CSE-ConnectionGUID: nV2bwljEQNOW9NCX4RStxA==
X-CSE-MsgGUID: MYIV/q6WS2KJgvYfEuvHDw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,145,1728975600"; d="scan'208";a="86985810"
Received: from carterle-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.75])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2024 09:53:43 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 1/5] drm/i915/overlay: convert to struct intel_display
Date: Mon, 11 Nov 2024 19:53:30 +0200
Message-Id: <873690f374729d7479e2d7f6adeefddf90f53fc0.1731347547.git.jani.nikula@intel.com>

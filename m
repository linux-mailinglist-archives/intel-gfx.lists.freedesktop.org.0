...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA70257D3A
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jun 2019 09:37:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFAD06E811;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 rWdQ==
Subject: Re: [Intel-gfx] [RFC][PATCH 1/2] drm: Improve PATH prop docs
...
Content-Type: multipart/mixed; boundary="===============1970538782=="

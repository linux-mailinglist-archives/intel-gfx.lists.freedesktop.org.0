...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 709136ED23D
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 18:12:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9F5610E563;
...
Subject: [Intel-gfx] [PATCH 2/2] Revert "drm/i915/mtl: Define MOCS and PAT
 tables for MTL"

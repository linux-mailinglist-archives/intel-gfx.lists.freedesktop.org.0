...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7B2B5A4CF9
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:06:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 998FA10F1F2;
...
Subject: [Intel-gfx] [PATCH v3 7/9] dma-buf: Document dynamic locking
 convention

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 694E1732BFF
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 11:40:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59B9310E5C9;
	Fri, 16 Jun 2023 09:40:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0C6DF10E5AB;
 Fri, 16 Jun 2023 09:39:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686908398; x=1718444398;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lw+vwvdxEdp9BEWzE4GXkpHsjk6zyDUEhjLk1tCdoGw=;
 b=POeBgT4JfjkWI827eVyY+h9XuYXt0F5EFZCOQ+OjrXPiSjcQB3vrUnGP
 Od0L06uejmXUJogPFy4hJWJJnDW1MMuU3cj62JuSKR5ogIjk1x4haxLuA
 gD0uEHMgzUiFivSSkS1u6ONn4LgsuW4Hy06bwi6suys1fDBMSsg1jSyGu
 Q5RqpCEr2FaHWw4ZLNfHQ+Pw2/F+JzOxguDQPL6ooq0wnK0MT4T/ieWS6
 YRQ5bDXejqt/U4Q3Nq3mVgkL9pvQCGTtKKd8UWIT9N2qc/4myWZ1EU3dy
 QC0a0JNUzJZNRE0rKnXJ7KGt1lva5EBSgAd5L9sK70zgqxEJlP4DSFK9p Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="361700179"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="361700179"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2023 02:39:57 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="715951032"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="715951032"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga007.fm.intel.com with ESMTP; 16 Jun 2023 02:39:56 -0700
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Fri, 16 Jun 2023 02:39:28 -0700
Message-Id: <20230616093946.68711-5-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230616093946.68711-1-yi.l.liu@intel.com>
References: <20230616093946.68711-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v13 04/22] kvm/vfio: Prepare for accepting vfio
 device fd

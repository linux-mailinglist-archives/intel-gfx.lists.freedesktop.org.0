...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D97C5813F0
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Jul 2022 15:12:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1CFA214A4D9;
...
Subject: Re: [Intel-gfx] [PATCH v4] drm/i915: stop using swiotlb

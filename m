...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1932D9DE8DE
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Nov 2024 15:45:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B386210E4DA;
	Fri, 29 Nov 2024 14:45:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AVnZ9EYp";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8604A10E4D6;
 Fri, 29 Nov 2024 14:45:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1732891551; x=1764427551;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=zWU7Jgr4Y6TUlTThgrCboJ5ExezR71E9q1hKavxMgU4=;
 b=AVnZ9EYp9aaPXZaW+3Zy2tFGaH0D1+ocVLnTkd3l26cL5G8xsESaCNHf
 ECbvGLgUXEmEKBLbiTYBWiUXThCsHYwhZaDMyYc/1PQrooFyfqXv1f46U
 WpdKnk+yCA3sAxtaTCVuYp7GPWrrq8HGmHzX75gzcjK/qrl9sVhvm1lDE
 6cRPgnBLpU4FbFb7QoeBiZ3csBvqXjAhV9DsiwwJ+i7i3jkTkwQJLrys/
 cj/xSHXHXDiiRhWVwnGEGdIgB8n4nbBaSRoPKHWuxtdtmabZz2xcHuW2R
 oXuPlFn0fdvwZdh9OLDBCdU/rl3qQSuJ5HjBXs2K/wVGSAo6eCVx1aJfv g==;
X-CSE-ConnectionGUID: zSV/QrhBSselgMDDl+y6WA==
X-CSE-MsgGUID: nQp3l48MSkaMqtLAWzv2VQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11271"; a="50650255"
X-IronPort-AV: E=Sophos;i="6.12,195,1728975600"; d="scan'208";a="50650255"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Nov 2024 06:45:51 -0800
X-CSE-ConnectionGUID: eDilUCa/SXq/HDYyrH8LLQ==
X-CSE-MsgGUID: ILtQXIeRQN6skLsg8FUZyw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,195,1728975600"; d="scan'208";a="93346740"
Received: from mwiniars-desk2.ger.corp.intel.com (HELO localhost)
 ([10.245.246.241])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Nov 2024 06:45:49 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 2/5] drm/i915/dp: s/intel_connector/connector/
Date: Fri, 29 Nov 2024 16:45:30 +0200
Message-Id: <e8008ef8d8b223d82fa6646ca0a34f30b200d4cd.1732891498.git.jani.nikula@intel.com>
...
index b33c1544a120..a566c7c5672c 100644
...
@@ -5793,30 +5793,31 @@ intel_dp_force(struct drm_connector *connector)
 	intel_dp_set_edid(intel_dp);
 }
...
@@ -6286,11 +6287,10 @@ static void intel_edp_backlight_setup(struct intel_dp *intel_dp,
 }
...
-	struct drm_connector *connector = &intel_connector->base;
 	...
 	bool has_dpcd;
@@ -6314,7 +6314,7 @@ static bool intel_edp_init_connector(struct intel_dp *intel_dp,
 		return false;
 	}
...
@@ -6341,7 +6341,7 @@ static bool intel_edp_init_connector(struct intel_dp *intel_dp,
...
@@ -6391,19 +6391,19 @@ static bool intel_edp_init_connector(struct intel_dp *intel_dp,
 	}
...
@@ -6411,34 +6411,34 @@ static bool intel_edp_init_connector(struct intel_dp *intel_dp,
...
@@ -6448,34 +6448,32 @@ static bool intel_edp_init_connector(struct intel_dp *intel_dp,
...
@@ -6486,10 +6484,9 @@ void intel_dp_init_modeset_retry_work(struct intel_connector *connector)
...
@@ -6498,7 +6495,7 @@ intel_dp_init_connector(struct intel_digital_port *dig_port,
 	int type;
...
@@ -6510,7 +6507,7 @@ intel_dp_init_connector(struct intel_digital_port *dig_port,
...
+	intel_dp->attached_connector = connector;
 	...
 	if (_intel_dp_is_port_edp(dev_priv, encoder->devdata, port)) {
 		/*
@@ -6538,33 +6535,33 @@ intel_dp_init_connector(struct intel_digital_port *dig_port,
...
@@ -6574,13 +6571,12 @@ intel_dp_init_connector(struct intel_digital_port *dig_port,
...
@@ -6595,7 +6591,7 @@ intel_dp_init_connector(struct intel_digital_port *dig_port,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCAA647EE0
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jun 2019 11:54:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D938891B4;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 yPTw==
Subject: Re: [Intel-gfx] [PATCH 09/59] drm/prime: Align gem_prime_export
 with obj_funcs.export
...
Cc: Kate Stewart <kstewart@linuxfoundation.org>,
 ...
 Mikulas Patocka <mpatocka@redhat.com>, Junwei Zhang <Jerry.Zhang@amd.com>,
...
Content-Type: multipart/mixed; boundary="===============0670429102=="

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63F4A4DD4C6
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Mar 2022 07:41:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BD0B10E93D;
...
Subject: [Intel-gfx] [PATCH v12 06/13] drm/i915/guc: Add GuC's error state

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDBB81980FF
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Mar 2020 18:23:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BCC86E450;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 05/14] drm/i915: Include DP HDR Metadata

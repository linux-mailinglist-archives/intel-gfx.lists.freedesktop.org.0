...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E4FCD5EFB68
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 18:55:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7719710EB3C;
	Thu, 29 Sep 2022 16:55:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 52D8410EB3A
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Sep 2022 16:55:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1664470526;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=RQjiwvr6S5lV8usREpdzXKjDN4TlUL9iWSrNpQhtESA=;
 b=Cn0ZuAE+c0IiuMtW7U6RI2VK8tPGbtvZAJkzYyQ3XNvKMjJIOgQhZ5Kou9kgR3Y5mHIjr4
 pnMj/BO7gYuruKdbX005ifvETc61cJ2dfCAt+kzgVZIaCsLk84kHAJ1MUf8exZGI7t7UP0
 7hyX67UK+hFS7CX2bhhH+QoHa4ZUauE=
Received: from mail-il1-f197.google.com (mail-il1-f197.google.com
 [209.85.166.197]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_128_GCM_SHA256) id
 us-mta-380-fLE52E-2O8KveFxOouhk8w-1; Thu, 29 Sep 2022 12:55:25 -0400
X-MC-Unique: fLE52E-2O8KveFxOouhk8w-1
Received: by mail-il1-f197.google.com with SMTP id
 g1-20020a92cda1000000b002f612391d5bso1523023ild.2
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Sep 2022 09:55:25 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=RQjiwvr6S5lV8usREpdzXKjDN4TlUL9iWSrNpQhtESA=;
 b=
X-Gm-Message-State: ACrzQf2itvNksnPdhyXbT9lSsNTM0a0SRLJH9abbuJolOJREDiSJp2HY
 VOzAnZBt8GtNdekaSe3SpB17eNQwtIn/C9vFbTtJJljzfbWjuROk5m2ehvnlBQJKuzboOoswmEE
 5RJon/s7Ez7aGx6qUj8U4IpfTFG+i
X-Received: by 2002:a05:6638:1315:b0:35a:7c96:9737 with SMTP id
 r21-20020a056638131500b0035a7c969737mr2295862jad.302.1664470523415; 

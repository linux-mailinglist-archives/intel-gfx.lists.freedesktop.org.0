...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C2544765683
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jul 2023 16:55:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36DDC10E5B4;
	Thu, 27 Jul 2023 14:55:31 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 19FA810E5A6;
 Thu, 27 Jul 2023 14:55:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690469724; x=1722005724;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=m+mC4xmMFddeehuXIv5a4rjAzZF9/o7Q4U9kXemInrw=;
 b=GDgBSG5UOEuv4G30Ryn7+zDlz66MQ310o4v8sO5zHO7T5Z6pHFAIdUOz
 jLh8A5z2gNFLRLKNrxlKdDdgrYlhF7rtdo/fLtx3x/rwuMaUVsRnFSguY
 lpDjhwpEEOAxYsNBmaOE/3rWIx5pzab4P+AsTV8xu9KWeLi93Hu4de9vr
 ikcAZM145kTeLIGta12jlyUwjLVkH3gcRlTA/kPLgraSUssyjPKckWaBQ
 WdQ9/UBKxTQjNhccfDEijvP96tUE8hUYcLSt/bmrVHKJ0pMYWDTwNHBLT
 ZIHumPKyW92tHXyz/Urg92AN83f/WmVpvP1okfiXQjPz6Og9fzX2Rkt+I g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="399268405"
X-IronPort-AV: E=Sophos;i="6.01,235,1684825200"; d="scan'208";a="399268405"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jul 2023 07:55:23 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; d="scan'208";a="870433734"
...
Date: Thu, 27 Jul 2023 15:55:00 +0100
Message-Id: <20230727145504.1919316-5-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [RFC 4/8] drm/i915: Refactor PAT/object cache handling

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 546F71ED2BA
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jun 2020 16:57:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB1AE89C83;
	Wed,  3 Jun 2020 14:57:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1DDC389C03
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jun 2020 14:57:18 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 Jun 2020 16:56:57 +0200
Message-Id: <20200603145713.3835124-8-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/24] drm/i915: Use ww locking in
 intel_renderstate.
...
@@ -222,11 +244,9 @@ int intel_renderstate_emit(struct intel_renderstate *so,
 	if (!so->vma)
 		return 0;
...
@@ -247,7 +267,17 @@ int intel_renderstate_emit(struct intel_renderstate *so,
 	return 0;
 }

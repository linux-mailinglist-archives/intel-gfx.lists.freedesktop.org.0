...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7208A8405DB
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Jan 2024 13:58:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E71EF10F70F;
	Mon, 29 Jan 2024 12:57:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 74F5010F70F
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Jan 2024 12:57:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1706533049; x=1738069049;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=L7gBKiVfgi5PwJJTvuXFh6SbRlQHXwAfMnPhdW2hR4s=;
 b=IOLzrlsAVGCh3A6R/X/SlxOyiSNTyiOQxcXG4KuednOtuEr8i3F9KtxU
 59EASA0zHQAWPzl7/eO9EV8XHs2tTyllAuo0ykW/V2FzQxroMnfTQnvyN
 tYP7xYRaP38I/zKkD8frocClw2RZ/NYyZnEJV5SLvXRnV/MTtbapoBaTP
 tvGavddB8OCqWJmeQKnOk7UPAgCge3N2HTC6N1W8o3H4Eds6u1MiVzP1k
 tRt9e8ZkExV+lccTtxkjiz1hrIENnaDm1YogeooQKDVyZFDXwFXqY2QxF
 0xF0ZP9j6bl0nPjLUXgexYijP1NABWMzcrI1ZgZF29e/wizH613hkydN7 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10967"; a="9613796"
X-IronPort-AV: E=Sophos;i="6.05,227,1701158400"; 
   d="scan'208";a="9613796"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jan 2024 04:57:28 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,227,1701158400"; d="scan'208";a="29769685"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jan 2024 04:57:27 -0800
Date: Mon, 29 Jan 2024 14:57:20 +0200
From: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Subject: Re: [PATCH 3/3] Start separating pipe vs transcoder set logic for
 bigjoiner during modeset
Message-ID: <ZbegsCz3mzVxYnr5@intel.com>

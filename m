...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2AC19511C75
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Apr 2022 18:56:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5182010F6B1;
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/dg2: Define GuC firmware version
 for DG2

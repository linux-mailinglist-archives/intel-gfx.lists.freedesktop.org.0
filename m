...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 15F6AA022B1
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Jan 2025 11:09:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B12D210E604;
	Mon,  6 Jan 2025 10:09:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Q19uHsxN";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E116D10E601
 for <intel-gfx@lists.freedesktop.org>; Mon,  6 Jan 2025 10:09:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1736158174; x=1767694174;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=dtvI4ijFKrMV9xF4MBMmRyXiZWfUZtY1XCfjyK8P1Fw=;
 b=Q19uHsxNF99Bs3l+rRv6W0JQi8/HEo3Q5cCc8ibLlS4mOdkVYt7nkgV0
 qt+Vj/+sTYRq0Zdx6oS3rQph/2lwj8zkkMaY5bxc4OhKbIrwD9AqaEzry
 Ar1XSBkQDKmAkYBLHJZqS73UIx079+qFvp+lVtkCI7wb3T0QOLU50jQwu
 Nj3PwasM7NsjEA+MJxBumCJ2GhvMRzRRyz3TSEgYR89I38IPgEPWrmQSn
 4ismM3Aqwm0ObWtASX9hpzCixKRCoQKkgEkszORtv5HtMNDvA9Lq93Xxu
 k5fqgf9rqk6j6sTlQs0aNiGr8x5qA1j+7yDcSDChMi9fQPwBYivlo9zpE g==;
X-CSE-ConnectionGUID: uhFZ01rXR7mRfquTlaLKBw==
X-CSE-MsgGUID: V/LuT5zFS5mEBo3vbilPGw==
X-IronPort-AV: E=McAfee;i="6700,10204,11306"; a="36459659"
X-IronPort-AV: E=Sophos;i="6.12,292,1728975600"; d="scan'208";a="36459659"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jan 2025 02:09:34 -0800
X-CSE-ConnectionGUID: oyrryA/mSiuDF2cmWpilaA==
X-CSE-MsgGUID: Q2tfJTIPTVOp2Clp4Ti6Fg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,292,1728975600"; d="scan'208";a="107370528"
Received: from nitin-super-server.iind.intel.com ([10.145.169.70])
 by orviesa004.jf.intel.com with ESMTP; 06 Jan 2025 02:09:32 -0800
From: Nitin Gote <nitin.r.gote@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: andi.shyti@intel.com,
	Nitin Gote <nitin.r.gote@intel.com>
Subject: [PATCH v1 7/8] drm/i915/display: fix typos in i915/display files
Date: Mon,  6 Jan 2025 16:00:36 +0530
Message-Id: <20250106103037.1401847-8-nitin.r.gote@intel.com>
...
---
 ...
 48 files changed, 105 insertions(+), 101 deletions(-)
...
index 4271da219b41..c140ade0a280 100644
...
index 0d74adae2ec9..07f556fb882f 100644
...
index ca30fff61876..6c893868f767 100644

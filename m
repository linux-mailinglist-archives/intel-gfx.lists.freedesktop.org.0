...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C26B5729F0
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 01:31:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BCDA976C7;
...
Subject: [Intel-gfx] [PATCH 00/12] Random assortment of (mostly) GuC related
 patches

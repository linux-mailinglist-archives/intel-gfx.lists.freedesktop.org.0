...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 08DB9546353
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 12:16:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C617110E094;
	Fri, 10 Jun 2022 10:16:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BA9F410E094;
 Fri, 10 Jun 2022 10:16:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654856192; x=1686392192;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=Y0maX2kmbg14ELolxkmt05uHA6xZrtwYLtLADqfwGno=;
 b=dtquW/5XcdyTVsCvRgb73Q39LTYrIMvBwAVclgOEKceOoP13NZGHQWa7
 5M2wtEfCX7KwQWIF43RgHBTMkV6Nq+T+gTDCKFJAr4QW8vTTIoAij/PXB
 u6M1n7gyFIA9zrJGz0CUTdTQCi6ej12cm+336nTwKGuKdmlE2R9znXfNc
 q72N3oxwYV2dqQUZSdrXuE/upbxt0IVTZabgLz2YNe46UDEInE6OaMz5T
 K4RAyg60zUHNr8y9VC2fzHE3EVP+AITawlQrztAJuNKvHklb8XLy5j/4p
 abqNw9uMDuUaHaDhHfFEoo9Efawtrx9/wbb/iLH2l46mm9W/QHhkBvKzR g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10373"; a="266352489"
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="266352489"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 03:16:32 -0700
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="581012148"
Received: from rmamun-mobl.amr.corp.intel.com (HELO [10.212.89.139])
 ([10.212.89.139])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 03:16:30 -0700
Message-ID: <341bf9b4-54a3-c1d0-2f0c-1764dd9d00a7@linux.intel.com>
Date: Fri, 10 Jun 2022 11:16:28 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220609185302.GF4461@nvishwa1-DESK>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A9F4E799C7F
	for <lists+intel-gfx@lfdr.de>; Sun, 10 Sep 2023 05:59:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 99A1310E129;
...
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915/guc: Close deregister-context

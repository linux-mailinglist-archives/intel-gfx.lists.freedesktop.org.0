...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 43F5E897E02
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Apr 2024 05:32:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5127A1131AA;
	Thu,  4 Apr 2024 03:32:15 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PrU7CrjP";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4CDA31131A7
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Apr 2024 03:32:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1712201532; x=1743737532;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=2cFKxeevOACoKMU29nQT0WQp/mgnEUA/k11uNOYTtys=;
 b=PrU7CrjPzKcfXy1oe1C5fz4vBCJa63bTwIpC5HyklQEnOkkGX1xFuXqD
 vMzKh6s3O0lwCpJC8Hx52zOcNRn+rzH+MD0J8bkntlgS6vjqXLwqKeLLt
 EgW9KxchpvdWBjE4o5dY+NLcaP7F7FMAQ4Xu5HbfefmVKrMPka/z7rB3V
 R4PvUYxI8EASauI1FmktUTM+DO6k9VOExuEFweTwjrNB2M2UIGnYCb1H4
 HeAQWLeyUSLX/w7NkZ5LcPGJkkk4jA+J7U3eV3Vbh9UDG87RR1rCKMqsg
 jdxtRg6UhyTbgi9BEtTeA0LZAXuQu0brcVdZy+r+p1GTF4k8dEA/EnWW3 Q==;
X-CSE-ConnectionGUID: CZx3zP3oR0GOU70OGAOjUg==
X-CSE-MsgGUID: iqN7BxKlRi2t8dKTcprLRQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11033"; a="11282636"
X-IronPort-AV: E=Sophos;i="6.07,178,1708416000"; d="scan'208";a="11282636"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2024 20:32:12 -0700
X-CSE-ConnectionGUID: Ty1WuxvPTaepx0X3/IEh8g==
X-CSE-MsgGUID: BA7j3QSJQGmt7NGqfD/0rQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,178,1708416000"; d="scan'208";a="18747743"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmviesa007.fm.intel.com with ESMTP; 03 Apr 2024 20:32:09 -0700
...
Subject: [PATCH 5/7] drm/i915/dp: Enable AUX based backlight for HDR
Date: Thu,  4 Apr 2024 08:59:29 +0530
Message-ID: <20240404032931.380887-7-suraj.kandpal@intel.com>

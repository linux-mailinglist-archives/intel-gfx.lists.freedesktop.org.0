...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EB26C2AE49A
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Nov 2020 01:06:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4731689D79;
	Wed, 11 Nov 2020 00:06:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 73B3E89D79
 for <intel-gfx@lists.freedesktop.org>; Wed, 11 Nov 2020 00:06:05 +0000 (UTC)
IronPort-SDR: Q+yUFqsRh/NGGPVZSNnncID5+1+xzMqS3q1EV1Qz1ofOey3+9CsrlP0MQMgG8j+bjIGyzICkz/
 VXhBhhQTCpPw==
X-IronPort-AV: E=McAfee;i="6000,8403,9801"; a="170177794"
X-IronPort-AV: E=Sophos;i="5.77,467,1596524400"; d="scan'208";a="170177794"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2020 16:06:04 -0800
IronPort-SDR: hzTj8rPoqJTXPtBe4j03ijgk3Tx3cPQCTSR+0kOKdUx5ftHEbjUmvT+hwlODybXkH+XqgM5Pw9
 hAbiDyHz4S9w==
X-IronPort-AV: E=Sophos;i="5.77,467,1596524400"; d="scan'208";a="473633320"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 10 Nov 2020 16:06:04 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Nov 2020 16:08:15 -0800
Message-Id: <20201111000819.29809-3-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 3/7] drm/i915/dp: Add a wrapper function
...

...
dGUgKmRldl9wcml2ID0KQEAgLTEyMzk3LDcgKzEyNDA1LDcgQEAgaW50ZWxfZW5jb2Rlcl9jdXJy
...
VUxMOwpAQCAtMTQ0MTcsNyArMTQ0MjUsNyBAQCB2ZXJpZnlfY3J0Y19zdGF0ZShzdHJ1Y3QgaW50
...
aWctPmh3LmFjdGl2ZSkKQEAgLTE4NzMwLDcgKzE4NzM4LDcgQEAgc3RhdGljIHZvaWQgaW50ZWxf

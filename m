...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73F28732C08
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 11:40:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64FF510E5CD;
...
Subject: [Intel-gfx] [PATCH v13 09/22] vfio: Make vfio_df_open() single open
 for device cdev path

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C09A7772426
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Aug 2023 14:35:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E9B7510E289;
...
Subject: Re: [Intel-gfx] [PATCH 16/20] drm/i915/dp: Separate out function to
 get compressed bpp with joiner

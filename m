...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id oIbJMm5CimmwIwAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Feb 2026 21:24:14 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 254021146AF
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Feb 2026 21:24:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4FB8210E441;
	Mon,  9 Feb 2026 20:24:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=oracle.com header.i=@oracle.com header.b="juaLs9vk";
	dkim=pass (1024-bit key; unprotected) header.d=oracle.onmicrosoft.com header.i=@oracle.onmicrosoft.com header.b="ZNxaTlBU";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx0a-00069f02.pphosted.com (mx0a-00069f02.pphosted.com
 [205.220.165.32])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6067C10E441;
 Mon,  9 Feb 2026 20:24:11 +0000 (UTC)
Received: from pps.filterd (m0246627.ppops.net [127.0.0.1])
 by mx0b-00069f02.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id
 619ECtTv1229245; Mon, 9 Feb 2026 20:23:29 GMT
...
Received: from pps.filterd
 ...
 with ESMTP id 619JbAlR033811; Mon, 9 Feb 2026 20:23:28 GMT
...
Received: from PH0PR10MB5777.namprd10.prod.outlook.com (2603:10b6:510:128::16)
 by CH3PR10MB7960.namprd10.prod.outlook.com (2603:10b6:610:1c2::15)
...
X-Microsoft-Antispam: BCL:0;
 ARA:13230040|1800799024|376014|7416014|366016|27256017; 
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?pPz2pM/ME0/rmxFncv9Wgh8JmWR/vbt5gRYX0gMilpgjeZhrxlV5diTFmPR2?=
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230040)(1800799024)(376014)(7416014)(366016)(27256017); DIR:OUT;
 SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?BeqbMu0yUF0fwxbKabUk9AfXUot/63QsvMe8RwJIjX33KbCwp6zamqtz0TEW?=
...
X-Spamd-Result: default: False [-0.31 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[oracle.com:email,oracle.com:dkim,oracle.onmicrosoft.com:dkim,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns];
	MIME_TRACE(0.00)[0:+];

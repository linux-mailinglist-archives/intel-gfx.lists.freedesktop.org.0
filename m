...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AFF16EC418
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 05:43:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6193510E24C;
	Mon, 24 Apr 2023 03:42:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EDA8F10E1E3;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=ZhNCjkYowfsXII+E4ikvGNo83PA0+kbClIgjMZwCCqMzF0w9Q3lnGLTg
 wRU8BQT5ALeHGVGfkXP6pFOEyUjq0v3NDVW9wdetwkwf3y2p4wudIGe4B
 0LeRZnfRc2bHVtjVgCphZQbgJi84+jEMp/lC8vfUvQeIMGEWeFyKfCIJw
 leiGcbWafJR423u2yNnKNdqIJ2hGorCsvAGKlQpMHqbVP4kIa055LwFj0
 +2wO1HNwtndiU744yI6sgnUWJNNnQ3H4DkK154IvhRs8u6BWyWRhm7lrn
 tv4WbPrZEarSBEnUeo00Vr8RnJPiX72cpIcoqpn1PIpxwClCEqmSWTXaQ g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="349149204"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="349149204"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 20:42:54 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="817096680"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="817096680"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 20:42:54 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Sun, 23 Apr 2023 20:44:02 -0700
Message-Id: <20230424034403.3390144-4-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 3/4] drm/i915: use pat_index instead of
 cache_level

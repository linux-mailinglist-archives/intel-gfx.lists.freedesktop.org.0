...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DA8B5315A2
	for <lists+intel-gfx@lfdr.de>; Mon, 23 May 2022 21:05:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCFD110E7F7;
	Mon, 23 May 2022 19:05:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5DD8B10E7C1;
 Mon, 23 May 2022 19:05:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1653332723; x=1684868723;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=rmRItd/Hjp1EL+fdJZ0BBgGobO+moPvWXTTLTcmumj8=;
 b=eQ7syClxg9MsBKvyRkxGqpFAEkoSYYFAkxVMUJTiWprk8H2Uf3oMgGcs
 lN+vBgA7kS9tws+rNHfLIpooERwCrLmqHv5H4lPZ6esoEq5B60Hqogi5C
 GxA5UT1EHgk9K25amv+PEytIHYdhkTD9tTzHNyOH/mE+YW7XX4Frun4nK
 dhpEAcZAlvBdSd6nu+tdEm1baQVO/M+kbTdepNzlen/Bf/h4BUzC2YIra
 zaCzjyhIVETOG8Kk9nhf6r/6CZFGCFMpQavdGrJ0/JoJQuV7GKtuzF54T
 J6OaIpthivX4MtduAs4upxRA3OOTCkcKJAv5wtYeEsjnQXC+GtXbw/eTL w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10356"; a="270899042"
X-IronPort-AV: E=Sophos;i="5.91,246,1647327600"; d="scan'208";a="270899042"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2022 12:05:22 -0700
X-IronPort-AV: E=Sophos;i="5.91,246,1647327600"; d="scan'208";a="676012189"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2022 12:05:22 -0700
Date: Mon, 23 May 2022 12:05:05 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: "Zanoni, Paulo R" <paulo.r.zanoni@intel.com>
Message-ID: <20220523190503.GF4461@nvishwa1-DESK>

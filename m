...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 05658766D4E
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jul 2023 14:35:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 581BC10E205;
	Fri, 28 Jul 2023 12:35:17 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 56C8110E206;
 Fri, 28 Jul 2023 12:35:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690547715; x=1722083715;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=xdyq+nE+9eFPYdambb0jMySHdDeq04v91UnDMowPg1k=;
 b=WXWMuGorL9hrjLnEsTkhXEoiMuUgK6gDRZ95vWBn86yybQF+nGK6t/EJ
 IZzws4VtOPwHfWaEpvnE43NBEYe+LF8b58lqKlexNO+LAaeKBNmd4gaP8
 nQ+Lgylhx8Q46hcThUXp9QKyAIfZLQw5F9An+TI89ELaiiGrzws8MMk2R
 6V/yU4WYi+PE6NMr7BimhzxjHPugnqUSgDLmyMfDXHpxDILuM7SDemDNP
 2f/mIz6GT3TGM5BkfOCZ/spxsk1TJG3QBQbuxB6C052Dis3GuROX+1G1y
 fGeK3ANVB1qFfyybxEucHFLeQTMMYmHhe3KHXio0ACFdA+d3OsRAKGQHe g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="353489598"
X-IronPort-AV: E=Sophos;i="6.01,237,1684825200"; d="scan'208";a="353489598"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 05:35:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="757155386"
X-IronPort-AV: E=Sophos;i="6.01,237,1684825200"; d="scan'208";a="757155386"
Received: from atoomey-mobl.amr.corp.intel.com (HELO [10.213.197.30])
 ([10.213.197.30])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 05:35:12 -0700
Message-ID: <6c5f3b55-847c-4f48-0920-b5510575095f@linux.intel.com>
Date: Fri, 28 Jul 2023 13:35:10 +0100
MIME-Version: 1.0
...
References: <20230727145504.1919316-1-tvrtko.ursulin@linux.intel.com>
 ...
 <20230728001748.GH138014@mdroper-desk1.amr.corp.intel.com>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
In-Reply-To: <20230728001748.GH138014@mdroper-desk1.amr.corp.intel.com>

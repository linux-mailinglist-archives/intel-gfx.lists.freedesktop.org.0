...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 14B4EA3090F
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Feb 2025 11:49:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4DC810E655;
	Tue, 11 Feb 2025 10:49:09 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="S3JTOGpb";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B4ACE10E653;
 Tue, 11 Feb 2025 10:49:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739270948; x=1770806948;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Zb8nS/cEh787VsDEkrclsf4KSIRk6z5vVbFzrpKJAZo=;
 b=S3JTOGpb6EqB/kD+/qp8Nu5h1SemWevRoPLx4zcGF7cxkJo6LHYLM60r
 T8fP1Ee7VCHiLDyT8CRLDoh6+Qxa2KXSm59u6fkHvV+cRaynrnsgEzhz8
 WihETjsKp0hfmd46tOeuP+4XebuWxfc5yQgYKBLpNv4RS+5pSxooK9voj
 orILBGI8qFHDOMkjl8w4GkCkpsoeLJsGdLRbBF00BXp+q25uQ7T6ayvOo
 lq56Daqo6MhjrLFjSA+2orj4uPjfcVyD6fOSRz5my/toiFt6vtWTOc5iE
 e8AO/V6KkdwlgyN0htvoL0paZkulICHcI7PzBknX/H05fVM7KmJzqpoS0 A==;
X-CSE-ConnectionGUID: PJgy8+ssQP6TLnTm7W8FAA==
X-CSE-MsgGUID: G9+ddUvpRxWQQ42ljjxCqw==
X-IronPort-AV: E=McAfee;i="6700,10204,11341"; a="57293165"
X-IronPort-AV: E=Sophos;i="6.13,277,1732608000"; d="scan'208";a="57293165"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Feb 2025 02:49:07 -0800
X-CSE-ConnectionGUID: FlH2xklgTuqr8kOJk0Odhw==
X-CSE-MsgGUID: 8j3lk3H+RFGSNhLf3FoPag==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,277,1732608000"; d="scan'208";a="112991330"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa010.fm.intel.com with ESMTP; 11 Feb 2025 02:49:05 -0800
...
Subject: [PATCH 1/9] drm/i915/display_debug_fs: Use intel_display wherever
 possible
Date: Tue, 11 Feb 2025 16:18:49 +0530
Message-Id: <20250211104857.3501566-2-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FBE58750D
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:16:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DBDFD6ED77;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 1iug==
Subject: [Intel-gfx] [PATCH 15/34] staging/vc04_services: convert put_page()
 to put_user_page*()

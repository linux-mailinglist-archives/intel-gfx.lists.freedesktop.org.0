...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41A9D5B536B
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Sep 2022 07:29:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D15610E0C9;
...
Subject: [Intel-gfx] [PATCH v7 1/9] drm_print: condense enum
 drm_debug_category

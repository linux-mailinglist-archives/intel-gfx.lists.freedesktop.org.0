...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 770BB5EFAB8
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 18:33:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7EC410EAEE;
	Thu, 29 Sep 2022 16:32:13 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 08/30] drm/connector: Only register TV mode
 property if present

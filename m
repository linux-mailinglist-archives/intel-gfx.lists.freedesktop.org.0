...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F5CB67BCE7
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:38:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB52810E86C;
...
Subject: [Intel-gfx] [PATCH v3 05/19] dyndbg: split param_set_dyndbg_classes
 to inner/outer fns

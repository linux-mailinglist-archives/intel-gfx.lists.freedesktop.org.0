...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F45AA167AE
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2025 08:53:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1770710E34C;
	Mon, 20 Jan 2025 07:53:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="oB3AT0+J";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 14F2510E353
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Jan 2025 07:53:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1737359624; x=1768895624;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Ik9EvERy5VJJtRau6E5gd4sS9nJzQnkGQi7Inc0Vr/Y=;
 b=oB3AT0+J/rDrswf8BWesWEkpsMRU+xDTNOreCEAwkeZ0zyHxe7bdrYji
 SWJwJs4FHoT6MOxtt0dfk0pDxYmPocs4vFj98guSbHOvssRKlF6dejWc5
 +Yy9xxOOZM41VJLKu+wyiTIKOgrssBmXfD4iiqGTruWhwJBWmLX2ubvWC
 Ve411rSlFHGlYuxe7L/IoV5KSZY1JckvG0GA0q/nHWQlw+lSoZ00d2RDF
 YC7eKjI4LpFRMi2ooZnk7ifz8jl4RP632qViDOGO+kjjFgfvMtKMZft8t
 5h1iCSdySawyFhIsbFNs6rhzJGQn2VYLU7NM9iEhJV5JK0qRJDD33O5p9 w==;
X-CSE-ConnectionGUID: 0EeGQeP5S2KhlSl41cxMzg==
X-CSE-MsgGUID: iLMcCRl4RQONoybvzoQ+Yw==
X-IronPort-AV: E=McAfee;i="6700,10204,11320"; a="25325766"
X-IronPort-AV: E=Sophos;i="6.13,218,1732608000"; d="scan'208";a="25325766"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2025 23:53:44 -0800
X-CSE-ConnectionGUID: M+1/xDRuTJuzbhihf3yz5A==
X-CSE-MsgGUID: wygIgfuSS4+5QNuwvWztGg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="137317979"
Received: from nitin-super-server.iind.intel.com ([10.145.169.70])
 by fmviesa001.fm.intel.com with ESMTP; 19 Jan 2025 23:53:41 -0800
...
Subject: [PATCH v4 1/8] drm/i915/gt: fix typos in i915/gt files.
Date: Mon, 20 Jan 2025 13:45:10 +0530
Message-Id: <20250120081517.3237326-2-nitin.r.gote@intel.com>

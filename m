...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C69BB6B0D08
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 16:40:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2195F10E616;
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v5 1/4] drm/i915/gt: make nop_clear_range public

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B7CC45544
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jun 2019 09:10:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FEE488FB2;
	Fri, 14 Jun 2019 07:10:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D41889333
 for <intel-gfx@lists.freedesktop.org>; Fri, 14 Jun 2019 07:10:31 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16897524-1500050 
 for multiple; Fri, 14 Jun 2019 08:10:29 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 14 Jun 2019 08:10:03 +0100
Message-Id: <20190614071023.17929-20-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 19/39] drm/i915: Provide an i915_active.acquire
 callback
...
dGV4dC5jCmluZGV4IDNkNjYwYzhjZTQxNC4uMmVhMDVkY2RiOTlmIDEwMDY0NAotLS0gYS9kcml2
...
NWNjZjYxODA2ZDllLi5iZWFkNWFmYWViMTMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9p
...
eCBkNTVkMzc2NzM5NDQuLjZmYTkyNjNjYTQwNyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJt
...
cm0vaTkxNS9pOTE1X2dlbV9ndHQuYwppbmRleCA3YmU3MjM4OGIwNTIuLjYxMWNlZDc5ZmQwOSAx
MDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9nZW1fZ3R0LmMKKysrIGIvZHJp
dmVycy9ncHUvZHJtL2k5MTUvaTkxNV9nZW1fZ3R0LmMKQEAgLTIwNjEsNyArMjA2MSw3IEBAIHN0
...
ZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV92bWEuYwppbmRleCBmNzgyOTE5ZmYxOWIuLmYwMjEy
ODY1ODA1NSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV92bWEuYworKysg
...
ZXN0cy9pOTE1X2FjdGl2ZS5jCmluZGV4IGNjMWNhNGJlMWEwMC4uM2IzY2E1NjU4MTIyIDEwMDY0

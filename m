...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C9742E64AB
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Dec 2020 16:53:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF9BD89A8C;
	Mon, 28 Dec 2020 15:52:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BC9238925D
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Dec 2020 15:52:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23448243-1500050 
 for multiple; Mon, 28 Dec 2020 15:52:41 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Dec 2020 15:52:25 +0000
Message-Id: <20201228155229.9516-50-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 50/54] drm/i915/gt: Infrastructure for ring
 scheduling
...
MWM3YzMyNDYyMjYuLmYxNGEzZDkxNDVkYyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5
MTUvTWFrZWZpbGUKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvTWFrZWZpbGUKQEAgLTExMiw2
ICsxMTIsNyBAQCBndC15ICs9IFwKIAlndC9pbnRlbF9yZW5kZXJzdGF0ZS5vIFwKIAlndC9pbnRl
...
X3Jpbmdfc3VibWlzc2lvbi5jCmluZGV4IGNhYjc3NWE3ODkxMi4uMTlkN2VkZGEyYTQ4IDEwMDY0
...
bmUtPm1taW9fYmFzZTsKQEAgLTQ2Myw3ICs0NjQsNyBAQCBzdGF0aWMgdm9pZCByZXNldF9yZXdp
...
Y3MgKmVuZ2luZSkKIHsKIH0KIApAQCAtMTEwNCwxMyArMTEwNSwxMyBAQCBzdGF0aWMgdm9pZCBz

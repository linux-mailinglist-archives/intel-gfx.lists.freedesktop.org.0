...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63920659B69
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Dec 2022 19:35:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26D5910E478;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Use "%zu" to format size_t
...
Cc: dri-devel@lists.freedesktop.org, chris@chris-wilson.co.uk,
 andrzej.hajda@intel.com, rodrigo.vivi@intel.com, mchehab@kernel.org,

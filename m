...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DA46879FD7
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Mar 2024 00:51:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2FBCB10F252;
	Tue, 12 Mar 2024 23:51:20 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="eJyuc18O";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0E3E510F24A
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=T9oPtNd66ZJLAHqAmMs3emiSbPtS+0dfPgnt7c6YiXw=;
 b=eJyuc18O2buCuQBFsQH5uvVuAxZ8cL9HV0ws4Tq6xRscfgXiH+SICnst
 PdFvK80ZK/pqTNJaEg/dgvLEm7Nv4gEYyjFe/9uAygGwqrOPXOH/5gdLS
 imMmMS2dap+WJEL0zjdT2rvYcHHjs/XnmaVLv4z4jLVDnte3KHZWNb8fI
 Ddnj4CGTocIApYemNNGXO+KkQXEBnPVC+5dkUIoEJPhtgjV6e/HlIJfUG
 +VtwOJ1QKnA1g4o6oC7UZMtwDY3m1d19s2Vs2HNzjvn6RamZSs8QqurRr
 S89t26yq+ePxxhUsP4JA4N9vRg6tuc5tc2FVtYHJBJRUhB5ZCE41laDVW w==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="8848045"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="8848045"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 16:51:15 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="42715884"
...
Subject: [PATCH v2 5/6] drm/i915: Drop dead code for pvc
Date: Tue, 12 Mar 2024 16:51:44 -0700
Message-ID: <20240312235145.2443975-6-lucas.demarchi@intel.com>
...
index 1788db4376e5..c9cb2a391942 100644
...
index ba502c0be9b1..631011c33757 100644
...
index 6c87be2684e6..8745188a4451 100644
...
index e34e1aabe6f8..7e70ee4fbd84 100644
...
index 4d2b15dbe9ac..729409a4bada 100644

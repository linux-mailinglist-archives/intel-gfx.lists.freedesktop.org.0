...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C3DD31966A
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Feb 2021 00:14:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 519536E44E;
	Thu, 11 Feb 2021 23:14:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BF1086E44E
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Feb 2021 23:14:18 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.69.177; 
Received: from build.alporthouse.com (unverified [78.156.69.177]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23843908-1500050 
 for multiple; Thu, 11 Feb 2021 23:14:07 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 11 Feb 2021 23:14:05 +0000
Message-Id: <20210211231405.7386-1-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5] drm/i915/gt: Ratelimit heartbeat completion
 probing
...
@@ -106,13 +165,8 @@ static void heartbeat(struct work_struct *wrk)
...
@@ -152,8 +212,10 @@ static void heartbeat(struct work_struct *wrk)
 			attr.priority = 0;
...
@@ -166,6 +228,7 @@ static void heartbeat(struct work_struct *wrk)
 			ENGINE_TRACE(engine,
...
@@ -220,7 +288,7 @@ void intel_engine_unpark_heartbeat(struct intel_engine_cs *engine)

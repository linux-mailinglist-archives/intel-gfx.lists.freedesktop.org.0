...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A517C1369AE
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E44636E9C3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/23] drm/amdgpu: Convert to struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D911778A0B2
	for <lists+intel-gfx@lfdr.de>; Sun, 27 Aug 2023 19:57:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED6A710E1F7;
...
Subject: [Intel-gfx] [PATCH v15 17/23] drm/shmem-helper: Add and use

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UFptECsd+WlB5wIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 05 May 2026 00:26:51 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CEF6E4C4606
	for <lists+intel-gfx@lfdr.de>; Tue, 05 May 2026 00:26:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F3F410E899;
	Mon,  4 May 2026 22:26:49 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="evcD5YNZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98FD410E8A0;
 Mon,  4 May 2026 22:26:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1777933607; x=1809469607;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=hX+pA7TssZSzb4bhugDIc72Be4O9M+iS4RaaVU34AWg=;
 b=evcD5YNZNcth8mk42WUSKWIRn6XNApq9RLtFhbS7xtySgDeoosfW3wNQ
 cXJ5jBwxjJQa2weUAo9Jcdt2mph52aPxlGquk9A+TqftcjqVoCgxILXxV
 Mohoi77F7L+CFISZxYQPOg4zBNZnOZeUxYk1DrWiR0mUAG54Zs97ufUkF
 TwVm8lzUbIORn1wj0twQY/0s/sOt573f79S6I9Qfl9QjKETRjiXPpXIOX
 CKEUnkJDjXVGWPttQW6Wjjn3fuLic/riL7e2rht4PMFbxafpEp35hr3p5
 0gAvx/EsN3ql5S3VTAmuYh4fzKM1qUF6JBSZ7LmByyqYnQgiGVC0VPEhW w==;
X-CSE-ConnectionGUID: dUawXCDBRQCrzh+lptNwBQ==
X-CSE-MsgGUID: dyojAsJSRXiDno/qUbZXSA==
X-IronPort-AV: E=McAfee;i="6800,10657,11776"; a="77820297"
X-IronPort-AV: E=Sophos;i="6.23,216,1770624000"; d="scan'208";a="77820297"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 May 2026 15:26:47 -0700
X-CSE-ConnectionGUID: N/Q4CGIkRTSW/mSgoWdm0Q==
X-CSE-MsgGUID: HPBNR955TXGdYSCPZR0uDQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,216,1770624000"; d="scan'208";a="235509400"
Received: from pgcooper-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.245.157])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 May 2026 15:26:46 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH v2 6/6] drm/i915/irq: add intel_display_irq_handler() to irq
 funcs
Date: Tue,  5 May 2026 01:26:13 +0300
Message-ID: <13f72c23f976f38e470e52e72b10585ea8663daf.1777933454.git.jani.nikula@intel.com>

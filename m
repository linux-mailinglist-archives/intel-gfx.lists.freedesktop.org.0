...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F0D35EFA8A
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 18:31:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3031D10EAC7;
...
Subject: [Intel-gfx] [PATCH v4 02/30] drm/tests: Order Kunit tests in
 Makefile

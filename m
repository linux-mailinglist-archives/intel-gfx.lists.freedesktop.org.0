...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EEAF409B6B
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Sep 2021 19:58:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E51C6ECD4;
	Mon, 13 Sep 2021 17:58:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qv1-xf36.google.com (mail-qv1-xf36.google.com
 [IPv6:2607:f8b0:4864:20::f36])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2096F6ECDE
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Sep 2021 17:58:14 +0000 (UTC)
Received: by mail-qv1-xf36.google.com with SMTP id a13so2770664qvo.9
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Sep 2021 10:58:13 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=WgUf1AXkxLqX+yf9zkVtTzFNGIYqkFT6Ykb+z6p/q4Q=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=WgUf1AXkxLqX+yf9zkVtTzFNGIYqkFT6Ykb+z6p/q4Q=;
 b=
X-Gm-Message-State: AOAM531L6Pc71pZHBTX+S2IDF9x+aCnU9lpTE9CxLqIFYbphp6BFMzZv
 epC93CL+tRjlMYN72Q5fWW53Aw==
X-Google-Smtp-Source: ABdhPJzKzkAMHt4ll4y9TWSWAHYYxmiG/1FmWPo39sTBX2YyFrxEkeAdu7eaL8hAgjg7qxnqIVpgAA==
X-Received: by 2002:a0c:f58a:: with SMTP id k10mr896451qvm.62.1631555892818;
 Mon, 13 Sep 2021 10:58:12 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id b19sm5806570qkc.7.2021.09.13.10.58.12
...
Date: Mon, 13 Sep 2021 13:57:35 -0400
Message-Id: <20210913175747.47456-5-sean@poorly.run>
X-Mailer: git-send-email 2.31.0
In-Reply-To: <20210913175747.47456-1-sean@poorly.run>
References: <20210913175747.47456-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 04/14] drm/hdcp: Expand HDCP helper library for
...
@@ -513,3 +518,1102 @@ bool drm_hdcp_atomic_check(struct drm_connector *connector,

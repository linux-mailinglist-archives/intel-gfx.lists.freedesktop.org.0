...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C5ED405D95
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Sep 2021 21:39:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67EFE6E921;
...
Subject: [Intel-gfx] [PATCH v2 3/9] vfio/ccw: Convert to use

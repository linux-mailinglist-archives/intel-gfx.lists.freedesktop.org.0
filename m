...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E53F577B6D
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:39:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9AE2A9CFF;
...
Subject: [Intel-gfx] [PATCH v3 26/41] drm_print: refine drm_debug_enabled
 for jump-label

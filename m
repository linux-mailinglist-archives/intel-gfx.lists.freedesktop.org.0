...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D4B2E463472
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Nov 2021 13:36:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 105546EA54;
...
Subject: Re: [Intel-gfx] [RFC PATCH 0/2] Attempt to avoid

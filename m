...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B2194EB383
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Mar 2022 20:42:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3F5110E66C;
	Tue, 29 Mar 2022 18:42:44 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 03/12] drm/edid: add edid_block_tag() helper to
 get the EDID extension tag

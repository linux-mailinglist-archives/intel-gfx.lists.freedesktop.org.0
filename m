...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4120C6F3C9F
	for <lists+intel-gfx@lfdr.de>; Tue,  2 May 2023 06:14:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A8DA110E489;
	Tue,  2 May 2023 04:14:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B042910E3FD;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=NFy61kVibUxV/w4OsrWDwtNGIJa0G0V5d4fatevY3Hv2dutSVqZK8Bil
 uz15OZAtMC/PKES5aB+ssvkVz+mgJUMbOCTyfAyJ6Sd4pfZRgDxs59Kjd
 GEoaORKr/kGg5hYOJAUYkZLsY4RMYgG6rd5IVcqyDnkSvb2uakYkNfbjd
 9IhQTBXFMuhG1G3ZWCrBFsH/flfnyA7+WGlT3ZZFhJtY4lFk5dd9d/JXn
 bSp7A05Wd7FMyWCRgoFajw/RNTT5TLWlfllgbCixqn/l8AlbAnMhYjcvq
 OijwcMF2ORHKYcZiPcwvidzzeEbFjODLr47Qc5zvMYBcXjXr+MUgRs4RE g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="347116758"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="347116758"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:14:25 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="726593797"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="726593797"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:14:25 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  1 May 2023 21:15:22 -0700
Message-Id: <20230502041526.2170497-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/5] drm/i915: preparation for using PAT index

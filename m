...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F114C1CDD3C
	for <lists+intel-gfx@lfdr.de>; Mon, 11 May 2020 16:30:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 154BC6E4A5;
	Mon, 11 May 2020 14:30:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 635F2891BB
 for <intel-gfx@lists.freedesktop.org>; Mon, 11 May 2020 14:29:48 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 11 May 2020 16:29:25 +0200
Message-Id: <20200511142938.1041006-10-maarten.lankhorst@linux.intel.com>
...
index 3d99bde4530a..1142682df950 100644
...
+		idx = eb_select_legacy_ring(eb);
 	...
 	if (IS_ERR(ce))
@@ -3025,7 +3022,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	if (unlikely(err))
 		goto err_destroy;

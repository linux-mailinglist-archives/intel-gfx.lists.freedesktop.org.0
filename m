...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B9A126ED233
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 18:11:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D13B910E55C;
...
Subject: [Intel-gfx] [PATCH 0/2] Restore MTL boot

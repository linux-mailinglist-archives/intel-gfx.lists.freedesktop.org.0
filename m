...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC9ED71724C
	for <lists+intel-gfx@lfdr.de>; Wed, 31 May 2023 02:11:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5241F10E459;
	Wed, 31 May 2023 00:11:44 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 2/7] drm/i915/huc: Parse the GSC-enabled
 HuC binary

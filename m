...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A1A031B1291
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Apr 2020 19:06:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C86506E822;
	Mon, 20 Apr 2020 17:06:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 471536E17E
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2020 11:54:05 +0000 (UTC)
Received: from quaco.ghostprotocols.net (unknown [179.97.37.151])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id 1D525221F4;
 Mon, 20 Apr 2020 11:53:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1587383645;
 bh=umG+YWaiExRXDnhNmpqcQ9lrrT+f4USJnNtIo1+UQgI=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=WXBIjllUt77fRSm6WW7EQl2ahuQBeHlt0BWzowwNO31l6OIrPh4aRriHVnxSk9Dpr
 HqzsrCzK2lGK/USKttN4Ma9dnN7tUxcFoszzIm/MrC4VhXoGSm26MTqHPBe/jD7gEL
 qvObofntHnBNrRImPy/eGPdC8Fcv+6wh2NlAWdjw=
From: Arnaldo Carvalho de Melo <acme@kernel.org>
To: Ingo Molnar <mingo@kernel.org>,
	Thomas Gleixner <tglx@linutronix.de>
Date: Mon, 20 Apr 2020 08:52:24 -0300
Message-Id: <20200420115316.18781-9-acme@kernel.org>
X-Mailer: git-send-email 2.21.1
In-Reply-To: <20200420115316.18781-1-acme@kernel.org>
References: <20200420115316.18781-1-acme@kernel.org>
MIME-Version: 1.0
X-Mailman-Approved-At: Mon, 20 Apr 2020 17:06:15 +0000
Subject: [Intel-gfx] [PATCH 08/60] perf tools: Support CAP_PERFMON capability

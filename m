...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DDEA283992
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2019 21:24:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38D84898C4;
	Tue,  6 Aug 2019 19:24:47 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 7/8] dma-buf: add reservation_object_fences
 helper

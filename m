...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0D8C1916EB
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Mar 2020 17:52:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 420416E4D4;
	Tue, 24 Mar 2020 16:51:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 848B16E4BB
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Mar 2020 16:51:50 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 24 Mar 2020 17:51:27 +0100
Message-Id: <20200324165146.1032624-2-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/21] drm/i915: Add an implementation for
...
@@ -17136,7 +17136,7 @@ static int intel_framebuffer_init(struct intel_framebuffer *intel_fb,
...
index 248b0889416b..28d5a0ce79e8 100644
--- a/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
+++ b/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
@@ -754,7 +754,7 @@ static int __eb_add_lut(struct i915_execbuffer *eb,
...
@@ -1040,7 +1040,7 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
...
index 54b86cf7f5d2..e0ea3e48f2b0 100644
...
index d09f7596cb98..2f8d790a6a23 100644
...
index 9e065ad0658f..dd2961715fe1 100644
--- a/drivers/gpu/drm/i915/gvt/cmd_parser.c
+++ b/drivers/gpu/drm/i915/gvt/cmd_parser.c
@@ -2957,7 +2957,7 @@ static int shadow_indirect_ctx(struct intel_shadow_wa_ctx *wa_ctx)
 		goto put_obj;
 	}
...
index 762b50b08d73..cb311a6349cc 100644
...
@@ -1269,7 +1269,7 @@ int i915_gem_freeze_late(struct drm_i915_private *i915)
...
+		i915_gem_object_lock(obj, NULL);
 		...
 		i915_gem_object_unlock(obj);
@@ -1323,6 +1323,52 @@ int i915_gem_open(struct drm_i915_private *i915, struct drm_file *file)
 	return ret;
 }

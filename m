...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BB70B4F3884
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 16:34:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5809810E8F1;
	Tue,  5 Apr 2022 14:34:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9F24D10E8EC;
 Tue,  5 Apr 2022 14:34:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1649169262; x=1680705262;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=Z8cL7sSXIWoLnYTQXrRog7pSrLmf0C6XHEdiF6j31ZU=;
 b=B0Dfm8XU9bA1i2CRGIJIF9yquLoGh0EGdxzI0zWxYy2Mp2BrpiTrtF5z
 cpCsPKKuBE8BuhqJJUqWyYGD4H0+VxmbQI8aHIIamTNfMQImaH3FGtcfn
 TXd36bBQsGjOpFYha2FW1hlKn2zNp8cE7xSB7OrwDwbiEfpWv0Cbb9NZ0
 N9P7C94Kg8sZ6LOFCP+RICLA3KIpJf4xxHWfxfuukX0ALp9DJ0mCN9Twj
 WLLq16B+uwkFibC1HZofMDJzM+4ZVqU3uJZl1jGBYNg+TeFw+zaSz6Y15
 Pv6zQij0H/oMd0LVMy10bT6ECnDAddhrLiUktNzySNdtDW5nglTNMHmeM w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10307"; a="285722215"
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="285722215"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Apr 2022 07:34:22 -0700
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="657959036"
Received: from ramaling-i9x.iind.intel.com ([10.203.144.108])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Apr 2022 07:34:21 -0700
From: Ramalingam C <ramalingam.c@intel.com>
To: intel-gfx <intel-gfx@lists.freedesktop.org>,
 dri-devel <dri-devel@lists.freedesktop.org>
Date: Tue,  5 Apr 2022 20:04:53 +0530
Message-Id: <20220405143454.16358-9-ramalingam.c@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 8/9] drm/i915/gem: Add extra pages in ttm_tt
 for ccs data

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 657BF545889
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 01:21:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB5EF12AFFE;
	Thu,  9 Jun 2022 23:21:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D06A712AFFE
 for <intel-gfx@lists.freedesktop.org>; Thu,  9 Jun 2022 23:21:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654816860; x=1686352860;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Jdn8KW7eG1x6Mt9vvHLGtwhbbjMhYCNpJlhdXExqN4M=;
 b=EJwoU41RAC4+GdPGYBcjM6/Ay/VkPxmX8FGvbrC2Hn4nJDrWCXPscNjs
 nFc4AAtLCiLJlaroffEFzCzRLNs7FBZu+tnc7SGfEbp6rg4+Bklv4t5Oa
 I/9wQokjU0QVaZnRTTj2k3av9Mu4ecW7hIjuh64skVuDfcwQlOyUu/0sO
 qRCLij+XBA+AJpZkS/ZoYTAn5rpQvCxvCSJPWbZQrkuiu1MC4P2jrDU5S
 pbPgJ0+s+8mHrCDK2yfzRAwmxfIkN4ewd8zVgnsNBIFsMMDxJGrb4CSgG
 z9xWSrRzdP86Svt7ooXCBHnb0n97eyybyb5Cqvxtq3Wr6NdK2GJnh6V2g Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10373"; a="363778906"
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="363778906"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2022 16:21:00 -0700
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="908586384"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2022 16:20:59 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  9 Jun 2022 16:19:41 -0700
Message-Id: <20220609231955.3632596-2-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH 01/15] HAX: mei: GSC support for XeHP SDV and
 DG2 platform

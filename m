...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E524146A41
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 15:00:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B14816FCDA;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 06/22] drm/gma500: Convert to CRTC VBLANK
 callbacks

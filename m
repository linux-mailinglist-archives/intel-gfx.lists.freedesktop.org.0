...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2974144306
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Jan 2020 18:20:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 469776EDEE;
...
Subject: [Intel-gfx] [PATCH v2 2/5] drm/i915/bios: convert to struct

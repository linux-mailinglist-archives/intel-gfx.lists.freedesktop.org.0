...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E67473FCE61
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Aug 2021 22:22:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA0498997C;
...
Subject: [Intel-gfx] [PATCH v7 0/8] use DYNAMIC_DEBUG to implement DRM.debug

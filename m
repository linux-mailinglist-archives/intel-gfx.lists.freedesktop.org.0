...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FAAE3B3EE0
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Jun 2021 10:23:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DF306ED18;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 11/27] drm/imx: Don't set struct

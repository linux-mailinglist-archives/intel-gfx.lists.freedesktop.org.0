...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46A8F6D9D14
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Apr 2023 18:07:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84B9C10EC56;
...
Subject: [Intel-gfx] [PATCH v2 2/7] dma-buf/heaps: Don't assert held

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3092A573042
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 10:13:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D05479553A;
...
Subject: [Intel-gfx] [PATCH v2 05/39] drm/i915: display: fix kernel-doc
 markup warnings

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D346357C792
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Jul 2022 11:29:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 15A278BE95;
	Thu, 21 Jul 2022 09:29:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DD3D58BE7F;
 Thu, 21 Jul 2022 09:29:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1658395780; x=1689931780;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=PXfuzV6HryLCoSLrlh6AJwqgLeg22hx2nB4ujSkK8q8=;
 b=MrscCsNw9a3U5ysGgh/jneGnT8jJQxv2hRCb3VyOIBhwgXStms4FEXS9
 CdpqoJ9+sAxEpUA+8ynDHZBzreyABQH/RQOMQz9hVLMa9orgUJRLDbRie
 nLO5P81ySOKfv4c7gr839Xtumfvy+hVTfaKVIOqyXttaU1Jl1dn2RRWMe
 rbJcN1hVrsAHNGMmPbJPJfZajpsr6BYNQPxUqzmhd3XB+rhlKUQkq+guz
 C9I6HsBXBg8li1e12D+FhwWcc2LZ8uupsnsOseHkS5sn6gBhoxscjKvhV
 qst//jWsRtYmfef7C2l6CAjety0If975lw75Akxs11JLrXKQe0vO+Cy/e w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10414"; a="270029135"
X-IronPort-AV: E=Sophos;i="5.92,289,1650956400"; d="scan'208";a="270029135"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Jul 2022 02:29:40 -0700
X-IronPort-AV: E=Sophos;i="5.92,289,1650956400"; d="scan'208";a="740612376"
Received: from gpreetix-mobl1.amr.corp.intel.com (HELO [10.209.165.170])
 ([10.209.165.170])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Jul 2022 02:29:38 -0700
Message-ID: <80cff06a-8e2f-05db-c6f4-5dd9c241cfdc@linux.intel.com>
Date: Thu, 21 Jul 2022 10:29:36 +0100
MIME-Version: 1.0
...
In-Reply-To: <d6bd0330-c569-4f58-08f9-42f6eb48fae0@intel.com>
...
i915.enable_guc=<load huc only>, maybe on the media driver site, or 

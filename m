...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C83E36B0D6
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Apr 2021 11:43:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 945006E1B6;
	Mon, 26 Apr 2021 09:42:58 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/9] drm/i915/query: Expose memory regions

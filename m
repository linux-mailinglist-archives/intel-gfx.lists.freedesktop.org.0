...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 125A349C6A6
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jan 2022 10:40:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD83110E86B;
...
Subject: [Intel-gfx] [PATCH v2 11/11] cxgb4: Use str_yes_no()

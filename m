...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C13665A77A6
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Aug 2022 09:39:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 857DC10E218;
	Wed, 31 Aug 2022 07:38:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CD48410E25D;
 Wed, 31 Aug 2022 07:38:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661931533; x=1693467533;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=iKK+eAtXdTURbyWI1P53fezliotvCzXj6bIiVqT2BVQ=;
 b=GoSqd+07tueHkPANPcEC8cxLdOCaaqhbnfrvcsOCH+UIQjOcIpJ5Fp2E
 S/t8qOy8dYqjVfWYWW1Beq/9mirPtoYWUKNlx6isRGYvY3vkZLNlhVjm8
 UkQ9nqcOTUrXgStfZ+WaR0yVhKl7Q5oCvCXd0+cZQS/GRxkefzLvjKNRA
 GPcfZGmxz7vJmM/je/IvadQ94jQPwKb+dhkBCmAegEmSu4kdwCjlTVSoQ
 +mTgW+hOXuSN58eIaSkcJshU3FxgcwGiyVgIoWKCQXOKF24dlH+aT550f
 v/UFq1dRmCLGtcdjL+buSCS+yf6DTiZ+TwPFJCSWpEyTA8osRbu0He6+m w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10455"; a="295399078"
X-IronPort-AV: E=Sophos;i="5.93,277,1654585200"; d="scan'208";a="295399078"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Aug 2022 00:38:53 -0700
X-IronPort-AV: E=Sophos;i="5.93,277,1654585200"; d="scan'208";a="715609934"
Received: from rishidub-mobl.amr.corp.intel.com (HELO [10.209.163.109])
 ([10.209.163.109])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Aug 2022 00:38:49 -0700
Message-ID: <8ecb0b8f-f253-1318-444a-8370960c6140@linux.intel.com>
Date: Wed, 31 Aug 2022 08:38:48 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220827194403.6495-11-andi.shyti@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 72FE52DE91F
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Dec 2020 19:45:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B026B89D57;
	Fri, 18 Dec 2020 18:45:53 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5544B898C0
 for <Intel-gfx@lists.freedesktop.org>; Fri, 18 Dec 2020 18:45:29 +0000 (UTC)
IronPort-SDR: 1+aNKjNzktDEYmbjUSxUhuOLo/lUa8ezrd4KefZadEOf0oZC95xPnJiZT80b7JNmGBKjXCGERa
 DO0/UaQXmMzw==
X-IronPort-AV: E=McAfee;i="6000,8403,9839"; a="193894748"
X-IronPort-AV: E=Sophos;i="5.78,431,1599548400"; d="scan'208";a="193894748"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Dec 2020 10:45:20 -0800
IronPort-SDR: a5OQJt5iFE991O4Z2UHW8PYYc6aiZOYbnRDUxOrsXcyne2hvTv9EVLrAiBSes1DyAiArdZGp4C
 hTQtHM+G7mlg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,431,1599548400"; d="scan'208";a="340645782"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga008.fm.intel.com with ESMTP; 18 Dec 2020 10:45:20 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Fri, 18 Dec 2020 10:45:10 -0800
Message-Id: <20201218184520.8697-4-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201218184520.8697-1-sean.z.huang@intel.com>
References: <20201218184520.8697-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v13 03/13] drm/i915/pxp: Implement funcs to create
 the TEE channel

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FBE7627C9E
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 12:44:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7873610E03F;
...
Subject: Re: [Intel-gfx] [PATCH v2] drm/i915/mtl: Add Wa_14017073508 for
 SAMedia

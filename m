...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EF826B38B5
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Mar 2023 09:32:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A998D10E97C;
...
Subject: Re: [Intel-gfx] [PATCH v6 17/24] vfio-iommufd: Make
 vfio_iommufd_bind() selectively return devid

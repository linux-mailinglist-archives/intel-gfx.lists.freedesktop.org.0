...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 498224C9913
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Mar 2022 00:17:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C15310E867;
...
Subject: [Intel-gfx] [PATCH v3 10/13] drm/i915/xehp: Don't support parallel

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B37B6579440
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Jul 2022 09:34:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6602610ED1D;
	Tue, 19 Jul 2022 07:34:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2C92F10EC73;
 Tue, 19 Jul 2022 07:34:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1658216077; x=1689752077;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=QbKD/LVIXuSElatBuzP2Hd9M8ImHjzhmj4A0ATga9BE=;
 b=UR4aXzdb9g1O9wtK/b4i5jWqJjhIzffnlk+hKltz3wqvA6vji4Ey0ak1
 nfQpAsfCavVxe1ZSnulEEKC7uzaIGMUvnEKQOG70hCwVOdPlFY/BEZPmC
 TbcVqujKMi0KSjYZbVVtT4oJhpund1b4HdGye4oc2gNbUtlj4RbEvp+It
 wQi0HiLQvlQI1Ssj+P6mtmzntT5JDYquRE/zCYDSQzQ/zXPvL/HCsoyKP
 jl6BfVoIVlnFghijygpXsYojGICyOnjuqxnO7MTS+HAE/IwtxLjx1Yo9Q
 us31uIJVVQrdppkr9D+MDTT4oda/j30heqqVlqXA0d0bWht84e5HHgCdv g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10412"; a="266198471"
X-IronPort-AV: E=Sophos;i="5.92,283,1650956400"; d="scan'208";a="266198471"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jul 2022 00:34:36 -0700
X-IronPort-AV: E=Sophos;i="5.92,283,1650956400"; d="scan'208";a="601496281"
Received: from ssherida-mobl.ger.corp.intel.com (HELO [10.213.201.170])
 ([10.213.201.170])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jul 2022 00:34:35 -0700
Message-ID: <c1edb871-07d8-244a-9144-0c26cbe6a401@linux.intel.com>
Date: Tue, 19 Jul 2022 08:34:33 +0100
MIME-Version: 1.0
...
In-Reply-To: <1651bac8-f88f-7166-3037-40889537e166@intel.com>

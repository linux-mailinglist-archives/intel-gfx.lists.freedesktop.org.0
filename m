...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CA1C6C48D
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jul 2019 03:45:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 274C86E2E8;
...
Subject: [Intel-gfx] [PATCH 24/26] drm/dp_mst: Add basic topology reprobing
 when resuming
...
Cc: Maxime Ripard <maxime.ripard@bootlin.com>, nouveau@lists.freedesktop.org,
 ...
 intel-gfx@lists.freedesktop.org, Karol Herbst <karolherbst@gmail.com>,

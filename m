...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A1BA7577B8F
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:40:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C98AA9D83;
...
Subject: [Intel-gfx] [PATCH v3 25/41] drm-print: include dyndbg header
 indirectly

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 70643643A1C
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Dec 2022 01:36:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8054610E2DB;
...
Subject: [Intel-gfx] [RFC PATCH 03/17] dyndbg: fix readback value on
 LEVEL_NAMES interfaces

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4AF3F3C5DB8
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Jul 2021 15:50:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38EA289B65;
...
Subject: [Intel-gfx] [RFC PATCH v2 0/4] Allow using dyndbg to replace
 drm_debug_enabled

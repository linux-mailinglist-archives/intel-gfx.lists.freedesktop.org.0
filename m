...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E24D5875AD
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:18:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 440CB6EDC8;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 zqKQ==
Subject: [Intel-gfx] [PATCH v2 05/34] drm/etnaviv: convert release_pages()
 to put_user_pages()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A3D062A1D17
	for <lists+intel-gfx@lfdr.de>; Sun,  1 Nov 2020 11:13:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6295C6EA86;
...
Subject: [Intel-gfx] [PATCH v2 02/13] drm/edid: Parse MAX_FRL field from
 HFVSDB block

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D812B7CE3D4
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:07:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EFBDB10E44A;
...
Subject: [Intel-gfx] [PATCH v7c 17/24] dyndbg-doc: add classmap info to howto

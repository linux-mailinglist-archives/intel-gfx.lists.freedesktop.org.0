...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59BC8B84E73
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Sep 2025 15:47:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDDCB10E8C3;
	Thu, 18 Sep 2025 13:47:55 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="P81ArTzO";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DB2EE10E8C1;
 Thu, 18 Sep 2025 13:47:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1758203274; x=1789739274;
 h=resent-from:resent-date:resent-message-id:resent-to:date:
 from:to:cc:subject:message-id:content-transfer-encoding:
 mime-version; bh=3s3dsFuiAPA3ImbOa4SJVmNkx7AE2XGSvqS2bbobrcY=;
 b=P81ArTzOMWAzDlrvIHGmSiA/C9reFShEXRIKuR5dKSdG56nbCu91JzF/
 IgeGmKmDIyMvMZeSXDwHgof44jAdNMPy/lyBeRT4/IMJWQTf7rC+VDVxd
 5Y9WxLeJE80vAWjcwwgO1s7+pUK4JqWFOhRQ9dXRmi5vWPWKou/ExiPy/
 RuYTouqhvtlXR1N4aou1VK9L0BxM7jR4uz6r3YStgnhT2PVpXEB5edvCD
 pv5Ry/262a+Id8wCeT4vFO9W6izxKp/RIpWx3GV17FnDsamkRkRpFdeJV
 D2q3HdaokvcASV5nvxRPcv5UpcfoONEKgsoROaFy9J9oV/dg7q24VLg0Y w==;
X-CSE-ConnectionGUID: 0pYTlAEBS3m5LqxY+Jl53A==
X-CSE-MsgGUID: TIyD8594TsOndcvlpHaYXA==
X-IronPort-AV: E=McAfee;i="6800,10657,11557"; a="59752609"
X-IronPort-AV: E=Sophos;i="6.18,275,1751266800"; d="scan'208";a="59752609"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2025 06:47:52 -0700
X-CSE-ConnectionGUID: rQ1l3O/kRBerUgxD2y8rjA==
X-CSE-MsgGUID: nda0yMfBQCqMT9fp9gQ7TQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,275,1751266800"; d="scan'208";a="175118640"
Received: from fmsmsx903.amr.corp.intel.com ([10.18.126.92])
 by orviesa009.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2025 06:47:51 -0700
Received: from FMSMSX901.amr.corp.intel.com (10.18.126.90) by
 fmsmsx903.amr.corp.intel.com (10.18.126.92) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17; Thu, 18 Sep 2025 06:47:49 -0700
Received: from fmsedg901.ED.cps.intel.com (10.1.192.143) by
 FMSMSX901.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17 via Frontend Transport; Thu, 18 Sep 2025 06:47:49 -0700
Received: from SN4PR2101CU001.outbound.protection.outlook.com (40.93.195.13)
 by edgegateway.intel.com (192.55.55.81) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17; Thu, 18 Sep 2025 06:47:49 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=0v5VmkAVnl7qcPsWMib4726hQsWzhzXlumxaKD/Q36A=;
 b=
...
Resent-Date: Thu, 18 Sep 2025 09:47:38 -0400
Resent-Message-ID: <aMwNeix6wyO_Qh7U@intel.com>
...
X-ClientProxiedBy: BY5PR13CA0017.namprd13.prod.outlook.com
 ...
 (2603:10b6:930:c6::19)
X-MS-TrafficTypeDiagnostic: CYYPR11MB8430:EE_|MW5PR11MB5932:EE_|CYYPR11MB8430:EE_|CO1PR11MB5204:EE_
X-MS-Office365-Filtering-Correlation-Id: ab81f137-1cf5-4ce6-2c77-08ddf6b9f017
...
X-MS-Exchange-Transport-EndToEndLatency: 00:00:07.7911029
X-MS-Exchange-Processed-By-BccFoldering: 15.20.9115.005
...
X-Microsoft-Antispam-Message-Info: =?iso-8859-1?Q?YSjESTx0Sm0wcbA/TmvKXHOB/x86ceSzb7Cv3ta+qPvgDotlcqjBqTDbY2?=
 =?iso-8859-1?Q?PG1ld4b44NXUSWKtIAOtqot1YnUQY91hQVFMQ4eykqQwrwYtVnYbf7g4Em?=
 =?iso-8859-1?Q?cFc5wEZG3l76jHn8imvJXZBfeUjF+R14AbwHn+SqN+es1+HnebLlLW4CJ8?=
 =?iso-8859-1?Q?uQ5rFf4s8xOeg2Ox7q434p4bobBNjbjdY6f+X2KySexPjrTcwwi7HHiDhz?=
 =?iso-8859-1?Q?6jEjSBFrcBwB4jNQDIo1VvzrrYo/WV3aMId6qpjrF+bU/jmc395gwhDKsa?=
 =?iso-8859-1?Q?Wzl5dPcmtQuwRSeXzeX1q09lTz+AFHHl7zxEfxFvxpH762y3DHESCXS6zw?=
 =?iso-8859-1?Q?GxGASUtSKZ6RkwiHCJiRPi73NiVVMg8lt3ZREd2NCiC2E/LR8AuwxUgpmE?=
 =?iso-8859-1?Q?+A/8GmTnHRnT1izxEtbzW5lceo2GmgxQOrSX5nXJ4IeeluYv7DzyVfHpHA?=
 =?iso-8859-1?Q?bPv6fpFvyDxHUTvK3W3dbHGw7aTeq/HfYuqOCvOaxC3q0sSNBrT4kqxvdS?=
 =?iso-8859-1?Q?DM5IQbyFI7pHDvButNJbg8IyTrdNRlE1IwHx2esCwEDgTkZxQtfHYrEhzm?=
 =?iso-8859-1?Q?Whezin12Fb0d/cnW9tkbqrqFXRo8/TuAjCkA/hfXKFaXRk/2AyIV9FBfxm?=
 =?iso-8859-1?Q?QmuU2uHfdM9ljgKVjgfnUISiX41NZCXt63Qf+xmGt3SekJMVnJpFD3/hHH?=
 =?iso-8859-1?Q?VJCZc8mBcPvAOysSyUKYUqCN2G4EklUTqvZJFBv9uFqCKXMMyImVwmePD4?=
 =?iso-8859-1?Q?3OiZ7qMU1llrEX45VemWoFDKWOtnxhKRGZxEEmJMae3OVY0GmQOilPVXqf?=
 =?iso-8859-1?Q?YfSE2Dcswq/+KcxSTayGGpCMzHwe8k9Kj0gF0qoYUcZgZpbzvdYATV8051?=
 =?iso-8859-1?Q?yIAjzq4VHy7chjEaci9ixgRCGiwjO2wgEhQcPbrWngd077fJVxRCClygZT?=
 =?iso-8859-1?Q?V70Pxh//eGAhMJcOHlWGv9ZT4qStffCpuOV8eTF1205MbybtAnzdWb1N+r?=
 =?iso-8859-1?Q?p5htvrZ+ofe0wJSOt3ZnWSOhQBj7gL0VW/gS4zrhYsdj/XOiGr3nCe2sB/?=
 =?iso-8859-1?Q?DSwjXHAf9+4eERLOqWBjKA49cFBUb14UMs3dA7ZbNsqUG9GEb1z+3Fvi4E?=
 =?iso-8859-1?Q?RQAz2DuOcmVKF5zM+QU/aL2EPpn9XOkH0jwSNl4COBDXAJBYI1aErM9Kyh?=
 =?iso-8859-1?Q?oVIpOn1xI8nF2UPOd4q7IjZ0XBxvAwmlMPNyaLDbL0e0gSR6HIPstCR2HS?=
 =?iso-8859-1?Q?LD5qTOqFa8vFyfP2NAOUpO5YDqXqeXVC2NvfmyEVrB0c1x5lfAJfigy5rP?=
 =?iso-8859-1?Q?gvofA3P4DbS8/FVCXcLPLinDFTSGq3+m+nOVBrNV+ya7ggqc8uc/jiWaXP?=
 =?iso-8859-1?Q?neqzMlvPisQ25tX7zhzxaW6qw28O2mePVNPuoR05v/7bKBKGDqK+8=3D?=
X-ClientProxiedBy: BY3PR03CA0016.namprd03.prod.outlook.com
 (2603:10b6:a03:39a::21) To CYYPR11MB8430.namprd11.prod.outlook.com
 (2603:10b6:930:c6::19)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id-Prvs: 002af02f-e968-45c0-33c8-08ddf20154b1
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?kp+v096D7INzjt62dDf015WtHTzYA8Gh4quvozBrBry2TgFUJNQRw/hV5c?=
 =?iso-8859-1?Q?2fr+I403h429ZtVG+wjhmJgm2c8Vksz9sbCbVF2M9G41JySWHIrwiemdjW?=
 =?iso-8859-1?Q?IDD1hIUU60O/UCpkV5CjnEL1qR9uA3PfJlrQvi/8gyd4RQoLzPwjiMmChF?=
 =?iso-8859-1?Q?Mi3tAp6mZRg4H+mJpYVmB/NEzCU2HurZ9iEZ9Wiy0ei0BqGGAbvkQYvqsr?=
 =?iso-8859-1?Q?GUzh+f5lKdXKbae7+Rp24bXwb8+a0YOCih0LEd+jk2aOdHTXv4elz4NAJT?=
 =?iso-8859-1?Q?TT9bTbRCud7ctu1ZVBzJuQhLlAZ+78icOsMcwI1EUJFvN51JU2OZvULbNC?=
 =?iso-8859-1?Q?bSpDa96hOkcVzV5FNJRJbnE6VDZELy0oRaqltNjpKLDlf7FPAZugBzXYeb?=
 =?iso-8859-1?Q?bhe/8c9g5/2aYrFVW/uD4Gk2c0xb0Dr9Nq5dEvXFUsqYomcjtUuAR5hl3K?=
 =?iso-8859-1?Q?bQoxfrLeq02006xA6i6sp73n8FQi3Ys1CIvQlmWK7Kiis0vUm30EanDIaJ?=
 =?iso-8859-1?Q?4MlZlyqAGD6UZazsrI2s2VZcI18CQMHkIJ77iJojWqVKQzrXLST9KVbogL?=
 =?iso-8859-1?Q?ySu2d+aJtUwdNWoRCC+LjL85A6xJI+T79bxV53kvgr2kPWKI3E52hjvva+?=
 =?iso-8859-1?Q?AMZ5ooYz46sBuZn61K8bL0WKUxEJsRBBYoLNXg6d5qgDDPx+pEQlKgWXk5?=
 =?iso-8859-1?Q?KdEC/RRW8Idg4LmZx0iEOywNOTLrhcFGNBh2gBVXvVU2AxFORbaqW5s4JV?=
 =?iso-8859-1?Q?r7CoCQ9oVr5d7nAEr/rOuYv3Ug6F209ZxPeXsAn9exxxTWQcRD7RFL6Sgk?=
 =?iso-8859-1?Q?RKWO4Tb7NRO+/NlYpMiLJjxRPuy4LFMWY/4fonOCWqfYj9Wst859aR5jJj?=
 =?iso-8859-1?Q?8oSoFvmIu9vzB1BaGGcF/GVqd0fy+k6oNOTrZ7I1ZhSEnxc6Lk47REUdCV?=
 =?iso-8859-1?Q?VYT0Q0jm+cBxQ0FdflFUJXr26eraPp8iL+B7BkOqyfsn4vfmvY7T1RiNml?=
 =?iso-8859-1?Q?hk9HQbRAnhButlmi6ABoS9YN18lT4LdLFx5PKC55TnXt4AaZQKWLon/QgD?=
 =?iso-8859-1?Q?NEHK8cZCyCA2qUd5drfe2VkVtj+mxmhVBv1+23r9jY7VGmDImKXrZR/RVV?=
 =?iso-8859-1?Q?4NVJww48GXwepJErzvLT4uCqGivLDTgqfW0+2zbQRKuWqAi95UVKu87nVV?=
 =?iso-8859-1?Q?dNTyKB5HAUs+ldS9rOCd4lhebDoGeiYPiIhF6KYSmz9I4xyBAu2LYe3ktV?=
 =?iso-8859-1?Q?IL/fVQXzWvHDn2t4LWdN9uaDGMZbcRB/Fwa7FaP4BKe0kPzSutj/3bB3pR?=
 =?iso-8859-1?Q?rnGu8D8xvVN+8CTp0/ADWugplbUsX9NrgakTn132q42qxAN+qBO4N+PoCN?=
 =?iso-8859-1?Q?IQ/UgBEcrIciSYlipfj9QB/wW0ceOkeW3+lsU2x3vS4rcZiPjdw5Czp13q?=
 =?iso-8859-1?Q?xKHVdqX8fQgn7kNGQQGF8CbObADa35rsMDswfuChFO/8UGNHBkgcZRBVB7?=
 =?iso-8859-1?Q?869PoSFrbSWUpGUOIVWzQVdbhdkdu/pU35FbZVw2c0uIXRO+iU7CzV32oz?=
 =?iso-8859-1?Q?rO1dfFbUKS7XG3xcXy6TGIB3R/OVGR4pTNHauKzz8VwNoZM67uiJ10r3mf?=
 =?iso-8859-1?Q?X8b0YBjVGijTJI5oujbRts6YyajM+pn1TX?=
X-MS-Exchange-CrossTenant-Network-Message-Id: ab81f137-1cf5-4ce6-2c77-08ddf6b9f017
X-MS-Exchange-CrossTenant-AuthSource: CYYPR11MB8430.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Sep 2025 13:47:42.3699 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: kWeGLSO3suOmcD7FGQQX8jwkaszmxgBy9Jez7Vtpn7voUjMso9CDS5gzdHcwCe3svMUxRPCHZM4W5YYzKCJjgA==

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11FF62139F7
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jul 2020 14:22:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 415F66EB72;
	Fri,  3 Jul 2020 12:22:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C9E646EB55
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 Jul 2020 12:22:25 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 Jul 2020 14:22:01 +0200
Message-Id: <20200703122221.591656-4-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/23] Revert "drm/i915/gem: Drop relocation
 slowpath".
...
index 1af2be78f6fd..f5b98cf03347 100644
...
-
 		...
 		case 0:
 			break;
@@ -1603,7 +1596,9 @@ static int eb_relocate_vma(struct i915_execbuffer *eb, struct eb_vma *ev)
...
+		pagefault_enable();
 		if (unlikely(copied)) {
 			remain = -EFAULT;
 			goto out;
@@ -1651,6 +1646,251 @@ static int eb_relocate_vma(struct i915_execbuffer *eb, struct eb_vma *ev)
 	return remain;
 }
...
+
 ...
 {
 	int err;
@@ -1672,8 +1912,11 @@ static int eb_relocate(struct i915_execbuffer *eb)
 		list_for_each_entry(ev, &eb->relocs, reloc_link) {
 			err = eb_relocate_vma(eb, ev);
 			if (err)
-				return err;

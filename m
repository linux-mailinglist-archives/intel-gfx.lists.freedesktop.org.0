...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CF461573AAB
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 17:57:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B258B9B9AD;
...
Subject: Re: [Intel-gfx] [PATCH v3 2/7] drm: Add drm_memcpy_from_wc()
 variant which accepts destination address
...
Cc: Thomas Hellstr_m <thomas.hellstrom@linux.intel.com>,
 ...
 Maxime Ripard <mripard@kernel.org>, siva.mullati@intel.com,
 dri-devel@lists.freedesktop.org, Thomas Zimmermann <tzimmermann@suse.de>,
 christian.koenig@amd.com, Nirmoy Das <nirmoy.das@intel.com>

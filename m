...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CA47828138B
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Oct 2020 15:00:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 948C46E9A5;
	Fri,  2 Oct 2020 13:00:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 03E1F6E97A
 for <intel-gfx@lists.freedesktop.org>; Fri,  2 Oct 2020 12:59:51 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  2 Oct 2020 14:59:38 +0200
Message-Id: <20201002125939.50817-61-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 60/61] drm/i915: Finally remove obj->mm.lock.
...
@@ -311,7 +311,7 @@ int __i915_gem_object_get_pages(struct drm_i915_gem_object *obj);
...
@@ -112,9 +112,7 @@ int __i915_gem_object_get_pages(struct drm_i915_gem_object *obj)
 {
 	int err;
...
@@ -123,15 +121,13 @@ int __i915_gem_object_get_pages(struct drm_i915_gem_object *obj)
...
@@ -218,7 +214,7 @@ __i915_gem_object_unset_pages(struct drm_i915_gem_object *obj)
 	return pages;
 }
...
@@ -249,21 +245,6 @@ int __i915_gem_object_put_pages_locked(struct drm_i915_gem_object *obj)
 	return 0;
 }
...
-
 static inline pte_t iomap_pte(resource_size_t base,
 			      dma_addr_t offset,
 			      pgprot_t prot)
@@ -380,9 +361,7 @@ void *i915_gem_object_pin_map(struct drm_i915_gem_object *obj,
...
@@ -424,15 +403,12 @@ void *i915_gem_object_pin_map(struct drm_i915_gem_object *obj,
...
index 55aa6fc3b518..327f01b04f21 100644
...
@@ -243,7 +243,6 @@ static int i915_gem_object_userptr_unbind(struct drm_i915_gem_object *obj, bool
...
index 4b5afb85efd1..7e4fa1cad82c 100644
...
-out_ww:
 ...
 out:
 	i915_gem_object_put(obj);
@@ -1335,7 +1329,7 @@ int i915_gem_freeze_late(struct drm_i915_private *i915)

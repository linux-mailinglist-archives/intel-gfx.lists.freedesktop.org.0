...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B7550310A06
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Feb 2021 12:16:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 111B66F40F;
	Fri,  5 Feb 2021 11:16:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B6D2B6F40F
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 Feb 2021 11:16:01 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.69.177; 
Received: from build.alporthouse.com (unverified [78.156.69.177]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23796670-1500050 
 for multiple; Fri, 05 Feb 2021 11:15:50 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  5 Feb 2021 11:15:49 +0000
Message-Id: <20210205111549.14946-1-chris@chris-wilson.co.uk>
...
@@ -189,8 +264,8 @@ void intel_engine_unpark_heartbeat(struct intel_engine_cs *engine)
...
index b2c369317bf1..429cfca6fb28 100644

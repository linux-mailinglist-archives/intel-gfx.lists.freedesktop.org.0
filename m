...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C283F5A1BFB
	for <lists+intel-gfx@lfdr.de>; Fri, 26 Aug 2022 00:12:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F02C10E3C9;
	Thu, 25 Aug 2022 22:12:08 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 15/31] platform/x86:
 nvidia-wmi-ec-backlight: Move fw interface definitions to a header (v2)

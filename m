...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FB2952942E
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:57:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60E7610F013;
...
Subject: [Intel-gfx] [PATCH v2 11/27] dyndbg: support symbolic class-names
 in bitmap

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 971CF6FB699
	for <lists+intel-gfx@lfdr.de>; Mon,  8 May 2023 21:02:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A529110E2EB;
...
Subject: Re: [Intel-gfx] [PATCH v5 7/8] drm/display/dsc: include the rest of
 pre-SCR parameters

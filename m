...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FC6D52943F
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:58:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36A9E10F1DB;
...
Subject: [Intel-gfx] [PATCH v2 17/27] drm_print: condense enum
 drm_debug_category

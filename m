...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 924439FBBE
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Aug 2019 09:29:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB57689C56;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 5/6] drm/i915/hdcp: update current

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E590C23CA8A
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Aug 2020 14:23:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46D556E5A2;
	Wed,  5 Aug 2020 12:22:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 266D56E580
 for <intel-gfx@lists.freedesktop.org>; Wed,  5 Aug 2020 12:22:49 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 22039488-1500050 
 for multiple; Wed, 05 Aug 2020 13:22:35 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  5 Aug 2020 13:22:23 +0100
Message-Id: <20200805122231.23313-30-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 29/37] drm/i915/gem: Replace
...
@@ -124,19 +124,19 @@ static int i915_gem_begin_cpu_access(struct dma_buf *dma_buf, enum dma_data_dire
...
@@ -145,19 +145,12 @@ static int i915_gem_end_cpu_access(struct dma_buf *dma_buf, enum dma_data_direct
...
index 94ec3536cac4..64861157e153 100644
--- a/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
+++ b/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
@@ -954,6 +954,13 @@ static int best_hole(struct drm_mm *mm, struct drm_mm_node *node,
 	} while (1);
 }
...
@@ -1065,7 +1072,6 @@ static int eb_reserve_vma(struct eb_vm_work *work, struct eb_bind_vma *bind)
 		if (unlikely(err))
 			return err;
...
@@ -1172,9 +1178,14 @@ static void __eb_bind_vma(struct eb_vm_work *work)
...
@@ -1191,7 +1202,6 @@ static void __eb_bind_vma(struct eb_vm_work *work)
...
@@ -1304,8 +1314,24 @@ static int eb_prepare_vma(struct eb_vm_work *work,
 		if (err)
 			return err;
 	}
+	return 0;
...
@@ -1445,6 +1471,10 @@ static int eb_reserve_vm(struct i915_execbuffer *eb)
 			}
 		}
...
+
 		...
 		if (err)
 			return eb_vm_work_cancel(work, err);
@@ -2752,7 +2782,7 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	if (!pw)
 		return -ENOMEM;
...
+	ptr = __i915_gem_object_pin_map_locked(shadow->obj, I915_MAP_FORCE_WB);
 	if (IS_ERR(ptr)) {
 		err = PTR_ERR(ptr);
 		goto err_free;
@@ -2760,7 +2790,7 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
...
index 7050519c87a4..14822bd12ffd 100644
...
@@ -361,23 +338,51 @@ void *i915_gem_object_pin_map(struct drm_i915_gem_object *obj,
...
+	might_lock(&obj->base.resv->lock.base);
+
+	/* Try to reuse an existing mapping, common with shared globals */
+	if (atomic_inc_not_zero(&obj->mm.pages_pin_count)) {
+		enum i915_map_type has_type;
+
+		ptr = page_unpack_bits(obj->mm.mapping, &has_type);
+		if (ptr && has_type == (type & ~I915_MAP_OVERRIDE))
+			return ptr;
+
+		i915_gem_object_unpin_pages(obj);
+	}
...
@@ -434,7 +439,9 @@ i915_gem_object_get_sg(struct drm_i915_gem_object *obj,
...
index dd723d9832b9..fae75830494d 100644
...
-	mutex_init(&vma->pages_mutex);
 	...
 	vma->ops = &pd_vma_ops;
 	vma->private = ppgtt;
@@ -437,7 +436,6 @@ struct i915_ppgtt *gen6_ppgtt_create(struct intel_gt *gt)
...
index ca25e751a023..384777805e72 100644
--- a/drivers/gpu/drm/i915/gt/gen8_ppgtt.c
+++ b/drivers/gpu/drm/i915/gt/gen8_ppgtt.c
@@ -716,7 +716,6 @@ struct i915_ppgtt *gen8_ppgtt_create(struct intel_gt *gt)
 			goto err_free_pd;
 	}
...
index 2bf514a5a2ca..92b6cc754d5b 100644
...
index b0629de490a3..cfd8ac7c2f0f 100644
--- a/drivers/gpu/drm/i915/gt/intel_gtt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gtt.c
@@ -24,7 +24,7 @@ int __map_pt_dma_locked(struct i915_address_space *vm,
 {
 	void *vaddr;
 
-	vaddr = i915_gem_object_pin_map(obj, I915_MAP_WB);
+	vaddr = __i915_gem_object_pin_map_locked(obj, I915_MAP_WB);
 	if (IS_ERR(vaddr))
 		return PTR_ERR(vaddr);
 
@@ -37,7 +37,9 @@ int map_pt_dma(struct i915_address_space *vm, struct drm_i915_gem_object *obj)
 	int err;
...
index b4e1519e4028..b9f91b6bf31c 100644
--- a/drivers/gpu/drm/i915/gt/intel_gtt.h
+++ b/drivers/gpu/drm/i915/gt/intel_gtt.h
@@ -229,8 +229,6 @@ struct i915_address_space {
...
index ada894885795..19f6a8d02595 100644
--- a/drivers/gpu/drm/i915/gt/intel_ppgtt.c
+++ b/drivers/gpu/drm/i915/gt/intel_ppgtt.c
@@ -315,6 +315,7 @@ void i915_vm_free_pt_stash(struct i915_address_space *vm,
...
index 0420a49f876c..c4f9267306f1 100644
...
index d6f5a3381821..40e38b533b59 100644
...
@@ -770,74 +786,6 @@ bool i915_vma_pin_inplace(struct i915_vma *vma, unsigned int flags)
 	return true;
 }
...
@@ -859,9 +807,11 @@ int i915_vma_pin(struct i915_vma *vma, u64 size, u64 alignment, u64 flags)
...
@@ -870,25 +820,21 @@ int i915_vma_pin(struct i915_vma *vma, u64 size, u64 alignment, u64 flags)
 	if (err)
 		goto err_rpm;
...
+			goto err_fence;
 	...
 	/*
@@ -953,16 +899,12 @@ int i915_vma_pin(struct i915_vma *vma, u64 size, u64 alignment, u64 flags)
...
@@ -981,12 +923,12 @@ int i915_vma_pin(struct i915_vma *vma, u64 size, u64 alignment, u64 flags)
 err_unlock:
...
@@ -1247,6 +1189,8 @@ int i915_vma_move_to_active(struct i915_vma *vma,
...
@@ -1281,11 +1225,19 @@ void __i915_vma_evict(struct i915_vma *vma)
...
index 9fe29a5aaad6..e0ac38b5096e 100644

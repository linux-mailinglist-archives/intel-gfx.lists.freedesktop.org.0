...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0AB0F563C81
	for <lists+intel-gfx@lfdr.de>; Sat,  2 Jul 2022 00:51:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED23C11257A;
...
Subject: [Intel-gfx] [RFC 00/10] drm/i915/vm_bind: Add VM_BIND functionality

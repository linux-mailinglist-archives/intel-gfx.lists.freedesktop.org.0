...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17511574CE3
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jul 2022 14:07:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 13F091129BE;
...
Subject: [Intel-gfx] [PATCH v2 06/21] drm/i915/gt: Batch TLB invalidations

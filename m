...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D49C14ACED2
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 03:21:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E1DFE10E545;
...
Subject: [Intel-gfx] [PATCH 8/8] drm/i915/guc: Fix potential invalid pointer

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 975964E2E4D
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Mar 2022 17:43:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8817310E42A;
...
Subject: [Intel-gfx] [PATCH v13 07/13] drm/i915/guc: Update GuC-log relay
 function names

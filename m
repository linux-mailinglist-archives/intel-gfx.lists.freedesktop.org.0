...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D87F4FE487
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 17:19:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB54B10E587;
...
Subject: [Intel-gfx] [PATCH v2 2/5] drm/i915: sanitize mem_flags for stolen
 buffers

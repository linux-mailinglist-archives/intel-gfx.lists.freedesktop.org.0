...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF8852FA0FF
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jan 2021 14:14:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 522076E222;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 4/6] drm/i915/gvt: Remove references to

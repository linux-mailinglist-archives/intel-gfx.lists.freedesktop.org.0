...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EFA725F14C
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Sep 2020 02:56:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBEBE6E0DD;
...
Subject: [Intel-gfx] [PATCH v1 12/12] drm/i915/gvt: GVTg support pv workload
 submssion

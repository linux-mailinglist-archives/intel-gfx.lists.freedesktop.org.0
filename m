...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 651CB60452D
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Oct 2022 14:23:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFC4610EC29;
	Wed, 19 Oct 2022 12:23:02 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] ACPI: PCI: Fix device reference counting in
 acpi_get_pci_dev()

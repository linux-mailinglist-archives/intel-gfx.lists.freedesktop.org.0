...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2DD6570B71
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:26:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9343C90B54;
...
Subject: [Intel-gfx] [PATCH 28/32] docs: gpu: i915.rst: GuC: add more
 kernel-doc markups

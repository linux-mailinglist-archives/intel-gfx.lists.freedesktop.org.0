...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ECDD0650FA5
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:05:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 96EF210E2B0;
...
Subject: [Intel-gfx] [PATCH 05/18] drm/radeon: Do not set struct
 fb_info.apertures

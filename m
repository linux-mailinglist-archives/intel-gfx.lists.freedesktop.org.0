...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CA77397118
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Jun 2021 12:16:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFFE06E9E9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/21] drm/i915/xelpd: Add register definitions
 for Plane Degamma

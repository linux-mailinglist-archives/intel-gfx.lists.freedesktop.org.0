...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 29CA86BDE86
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 03:17:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84CBC10E239;
...
Subject: Re: [Intel-gfx] [PATCH v7 17/22] vfio-iommufd: Add detach_ioas

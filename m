...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0451F633575
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Nov 2022 07:47:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5F2F10E07C;
	Tue, 22 Nov 2022 06:47:03 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4] drm/i915/mtl: Media GT and Render GT share
 common GGTT

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1092B39C00C
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Jun 2021 21:00:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56DA26F8B0;
	Fri,  4 Jun 2021 19:00:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yb1-xb31.google.com (mail-yb1-xb31.google.com
 [IPv6:2607:f8b0:4864:20::b31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B5F4E6F8B0
 for <intel-gfx@lists.freedesktop.org>; Fri,  4 Jun 2021 19:00:46 +0000 (UTC)
Received: by mail-yb1-xb31.google.com with SMTP id g38so15050019ybi.12
 for <intel-gfx@lists.freedesktop.org>; Fri, 04 Jun 2021 12:00:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=jlekstrand-net.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=o/sw0famdhMXZJzWzNXN9ScGF21RN0JU1ZXlp1H75y4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=o/sw0famdhMXZJzWzNXN9ScGF21RN0JU1ZXlp1H75y4=;
 b=
X-Gm-Message-State: AOAM531ywjAPLCBHMNqtru0LRij815Do5raR7AAbYw4NJ02wkugE1GVJ
 jOeukcHaxuvOF/rKAajtvIwt4yeLSdXjQKVEw+DtOw==
X-Google-Smtp-Source: ABdhPJzoOjhInWOs40JTDil80yiVsc5VxMvX20qmF+0mOnSWOWPfy00D5azw2gAlwGrR/OYQY3G3IQjjuoTsRYAPUes=
X-Received: by 2002:a25:e045:: with SMTP id x66mr6960572ybg.287.1622833245325; 
 Fri, 04 Jun 2021 12:00:45 -0700 (PDT)
MIME-Version: 1.0
References: <20210603212722.59719-1-matthew.brost@intel.com>
 <20210603212722.59719-5-matthew.brost@intel.com>
In-Reply-To: <20210603212722.59719-5-matthew.brost@intel.com>
From: Jason Ekstrand <jason@jlekstrand.net>
Date: Fri, 4 Jun 2021 14:00:33 -0500
Message-ID: <CAOFGe96kCkqYWffhy9TJa1m=jRd1jLVBs-VQtP+bVfxmAZm=Kw@mail.gmail.com>
To: Matthew Brost <matthew.brost@intel.com>
Subject: Re: [Intel-gfx] [PATCH 4/9] drm/i915: Move active tracking to
 i915_sched_engine

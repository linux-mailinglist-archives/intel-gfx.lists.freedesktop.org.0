...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 92F615B537E
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Sep 2022 07:30:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1CA1110E14B;
...
Subject: [Intel-gfx] [PATCH v7 5/9] drm-print.h: include dyndbg header

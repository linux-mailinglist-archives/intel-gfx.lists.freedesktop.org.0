...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B94301BBAC1
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Apr 2020 12:08:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BA976E1D8;
	Tue, 28 Apr 2020 10:08:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E87366E1D8
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Apr 2020 10:08:26 +0000 (UTC)
IronPort-SDR: lmXIcqNP2d3w8jwn7VjgdAo5dGvQ6V0a7D/wYKDXxr5OLF6IRITLIAY58AKpM4SrlxBANjrGBR
 4qc8s3VOFLbQ==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Apr 2020 03:08:26 -0700
IronPort-SDR: RhE2rx/0WUczm7Pv/I9MT0l8SikHxVvzzJeXzaWPhLGxbg45qbwKfwGvOBKwtUJRcGEAarIp5Y
 Z71Q/36Rwlzw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,327,1583222400"; d="scan'208";a="432128925"
Received: from pbooyens-mobl1.ger.corp.intel.com (HELO
 delly.ger.corp.intel.com) ([10.252.37.143])
 by orsmga005.jf.intel.com with ESMTP; 28 Apr 2020 03:08:25 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 28 Apr 2020 13:08:13 +0300
Message-Id: <20200428100816.951014-2-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 1/4] drm/i915/perf: break OA config buffer
 object in 2

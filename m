...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8DA215179B
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Feb 2020 10:19:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A1ED6EE06;
	Tue,  4 Feb 2020 09:19:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x444.google.com (mail-wr1-x444.google.com
 [IPv6:2a00:1450:4864:20::444])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B8BC96EE06
 for <intel-gfx@lists.freedesktop.org>; Tue,  4 Feb 2020 09:19:13 +0000 (UTC)
Received: by mail-wr1-x444.google.com with SMTP id z7so21895921wrl.13
 for <intel-gfx@lists.freedesktop.org>; Tue, 04 Feb 2020 01:19:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=DxUeVHZUkslJRF3YJwYTDJ4JwIYeX3ifc5q95FenCpM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=DxUeVHZUkslJRF3YJwYTDJ4JwIYeX3ifc5q95FenCpM=;
 b=
X-Gm-Message-State: APjAAAWgznleTQUpocwMiRYNVF944Vb2NoiSgnbajVVLGr0CT1YkviU+
 IY3zWswbZRF423FmQkWqWqY=
X-Google-Smtp-Source: APXvYqzyI5cKWe+NNh/Y4MH7Is0w6HIoC5IELV03yB2zRqfvJznp6w6mLlIAK1+Pw9G9g7RuGhITMQ==
X-Received: by 2002:adf:f886:: with SMTP id u6mr21296666wrp.409.1580807951980; 
 Tue, 04 Feb 2020 01:19:11 -0800 (PST)
Received: from wambui.zuku.co.ke ([197.237.61.225])
 by smtp.googlemail.com with ESMTPSA id f189sm3094968wmf.16.2020.02.04.01.19.08
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 04 Feb 2020 01:19:11 -0800 (PST)
From: Wambui Karuga <wambui.karugax@gmail.com>
To: jani.nikula@linux.intel.com, joonas.lahtinen@linux.intel.com,
 rodrigo.vivi@intel.com, airlied@linux.ie, daniel@ffwll.ch
Date: Tue,  4 Feb 2020 12:18:44 +0300
Message-Id: <20200204091855.24259-2-wambui.karugax@gmail.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 01/12] drm/i915/dp: convert to struct drm_device

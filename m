...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 24BA31EE2A2
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Jun 2020 12:38:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B08A6E334;
	Thu,  4 Jun 2020 10:38:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4E3AC89AA6
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Jun 2020 10:38:05 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21393767-1500050 
 for multiple; Thu, 04 Jun 2020 11:37:58 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  4 Jun 2020 11:37:50 +0100
Message-Id: <20200604103751.18816-21-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 21/22] drm/i915: Unpeel awaits on a proxy fence
...
index 3bb7320249ae..70c07c13794c 100644
...
+	case -EDEADLK: /* cyclic fence lockup (await_proxy)  */
 	...
 	default:
 		return true;
@@ -1241,6 +1243,138 @@ i915_request_await_external(struct i915_request *rq, struct dma_fence *fence)
 	return err;
 }
...
+
 ...
 i915_request_await_execution(struct i915_request *rq,
 			     struct dma_fence *fence,
@@ -1339,6 +1473,24 @@ i915_request_await_request(struct i915_request *to, struct i915_request *from)
 	return 0;
 }
...
+
 ...
 {
@@ -1346,6 +1498,9 @@ i915_request_await_dma_fence(struct i915_request *rq, struct dma_fence *fence)
...
@@ -1385,6 +1540,8 @@ i915_request_await_dma_fence(struct i915_request *rq, struct dma_fence *fence)

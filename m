...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id kIbTEA2XeGnmrAEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jan 2026 11:44:29 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E32B39309C
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jan 2026 11:44:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0EFA10E51B;
...
X-Spamd-Result: default: False [1.69 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[qualcomm.com:email,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,lava-submit.sh:url]
X-Rspamd-Queue-Id: E32B39309C

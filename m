...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B864F860D2E
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Feb 2024 09:51:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB87E10E08A;
	Fri, 23 Feb 2024 08:51:17 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Wc//zoWu";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4126110E08A;
 Fri, 23 Feb 2024 08:51:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1708678276; x=1740214276;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=9/2BMzWceV9QcXUcp2uaLL6oyAU5Kd6kT0wYQ85lQ84=;
 b=Wc//zoWuKAxN4y52gd7yl1wbSW8uqYzu08OWasG8wILFYHOz+yhNzbMF
 K1Y/vSkLZfA6NNm0kibRhRkKW/bJl6eAtgKd8WgP6ugMHbDlGl2RtpwEq
 egup9GEtHmQf26s8KBWl/TxEHgLSUF8ai1/ym+HMM5lL9uX9OEiyoFD+v
 sdFlU+WJSCKU5qXm25G9O7ybJLh7NAlj9tiGyFsfH99QeovFfsZG4v7MI
 zd3wZz5gfRFAquwU5c6xgUrZtx6y+De/h8X+2FzvzzPw0z0W9ZT0w6lJh
 t/1GL6GCibvTU6knGi4AV/fAE1ID0orIm8ybZQyIZwKuN084j9hfv3HhX w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10992"; a="14394757"
X-IronPort-AV: E=Sophos;i="6.06,179,1705392000"; d="scan'208";a="14394757"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Feb 2024 00:51:15 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,179,1705392000"; 
   d="scan'208";a="5850316"
Received: from mboland-mobl.ger.corp.intel.com (HELO [10.213.232.98])
 ([10.213.232.98])
 by fmviesa010-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Feb 2024 00:51:14 -0800
Message-ID: <9702f85a-17f2-4c45-bd17-fc0a07beb635@linux.intel.com>
Date: Fri, 23 Feb 2024 08:51:12 +0000
MIME-Version: 1.0
...
In-Reply-To: <166befb6-a667-4c24-85ed-efb18bd3b7d7@intel.com>

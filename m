...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A2065F6FB5
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Oct 2022 22:49:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3C4610E67D;
	Thu,  6 Oct 2022 20:49:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 29A8910E67D
 for <intel-gfx@lists.freedesktop.org>; Thu,  6 Oct 2022 20:49:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665089365; x=1696625365;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=k4SxlXmAsiGcxo9vVWHK8HYn7VOG/YXmFsyVvMkwOYc=;
 b=mcDP5J3AsLmcUIz8EDfFNtPH6nEV+vo5eMMq05KNAVX7nuhxCt/+Iwuc
 CwP7dZ1BIMOHklNF67ZDHKHNrfdRj7Dm3hM73ucPuw13bX5ibD7p34lwW
 QaojgXDByDZ7AZJD+DGu6ztiWCqxeD5xMs4t3zjMu3jRFlPHQZHnH9obo
 qMY2dP7hgNG29kGJIjGEVjkoI+5VuDVVNzST5Z2BaFYeZJhUHPWavx9s0
 rumWvvCdp6qSsJo/R+WiO11DI0dyTvZ4/rAWal8+oB0N/hZ0zCbHFSoTt
 AtomvdcIGeu7ItKJZm690fhhzFijxSuve1UjFWAE8uyKm6GtscpoQ/AcV g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10492"; a="329999971"
X-IronPort-AV: E=Sophos;i="5.95,164,1661842800"; d="scan'208";a="329999971"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2022 13:49:24 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10492"; a="800036900"
X-IronPort-AV: E=Sophos;i="5.95,164,1661842800"; d="scan'208";a="800036900"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2022 13:49:21 -0700
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  6 Oct 2022 22:48:44 +0200
Message-Id: <20221006204844.2831303-1-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/4] drm/i915/display: remove drm_device
 aliases

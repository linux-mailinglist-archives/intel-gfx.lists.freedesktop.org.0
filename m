...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E65044D7576
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Mar 2022 14:33:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E076510E0E6;
...
Subject: [Intel-gfx] [v7 1/5] drm/edid: seek for available CEA and DisplayID
 block from specific EDID block index

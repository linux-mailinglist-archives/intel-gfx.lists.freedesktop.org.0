...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74E67A6DB89
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Mar 2025 14:31:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFBB610E403;
	Mon, 24 Mar 2025 13:31:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="emRxP14S";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 33D9010E402;
 Mon, 24 Mar 2025 13:31:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1742823061; x=1774359061;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=AJK6ea4Xsjf2ytS2pyg23oNywyBBHMaSfUDKO3MljCc=;
 b=emRxP14Sk/xeYmmhhiyOh94q0p+QY8+B+p3uN4rTW1YpD6UFPmobPILL
 qMS9mvfE03c5EkgFodZYRfMkLFrCm3xSNIbYujJJFSgo7mjn3cJiipTw9
 EzQf5z18p1yEzGU/J41SbogNZZVia9FCD65EdaEOX0al1B3H3N+EYlqbR
 L+pX8sb6Kpl82h2LURhMYlvOmxIQz00EtxuOMuKAJVLjMuC4F1GISHFNq
 ZQXre7opvsT1/ozUdejDtKxP0hAWDy7OCCpuyToGQBzbJa8khMTJEtTqZ
 BVlEpWm+EIMvZ319hHsM8PWT1yLdTauR7iEsYT3cfwmcb6aR0LW5CBYVw Q==;
X-CSE-ConnectionGUID: mDwtd34uRxSHJHgoSLoNfw==
X-CSE-MsgGUID: U7YJJywBTQ+5S8wfdLbfBg==
X-IronPort-AV: E=McAfee;i="6700,10204,11383"; a="44134005"
X-IronPort-AV: E=Sophos;i="6.14,272,1736841600"; d="scan'208";a="44134005"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2025 06:31:01 -0700
X-CSE-ConnectionGUID: gbsC7mv7TxymVrF3xJ6BAw==
X-CSE-MsgGUID: 6DGmxlLeTvqPGi/vOaQpqA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,272,1736841600"; d="scan'208";a="124209254"
Received: from slindbla-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.252])
 by fmviesa008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2025 06:30:56 -0700
...
Subject: [PATCH v4 06/15] drm/i915/gt: Introduce for_each_enabled_engine() and
 apply it in selftests
Date: Mon, 24 Mar 2025 14:29:42 +0100
Message-ID: <20250324132952.1075209-7-andi.shyti@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BD37226A7FD
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 17:01:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 54DF26E8C4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 11/21] drm/pl111: Introduce GEM object
 functions

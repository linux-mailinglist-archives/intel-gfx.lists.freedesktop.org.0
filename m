...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D37651149E6
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Dec 2019 00:30:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2408B6F934;
	Thu,  5 Dec 2019 23:30:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pf1-x44a.google.com (mail-pf1-x44a.google.com
 [IPv6:2607:f8b0:4864:20::44a])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D75896F629
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Dec 2019 09:33:53 +0000 (UTC)
Received: by mail-pf1-x44a.google.com with SMTP id e62so1463852pfh.14
 for <intel-gfx@lists.freedesktop.org>; Thu, 05 Dec 2019 01:33:53 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:message-id:mime-version:subject:from:to:cc;
 bh=/GeYmoG/7NTjUEQywAj5h8GTNVXMhkcKjW49aWwmapg=;
 b=
X-Gm-Message-State: APjAAAWi1sReYWM45E9XIya+fzkMqOdmv7wEt/oItnJYofYR6CWsJUvY
 +U350qhj6XoMlhGcJ0EKepKa5nI29QYg
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 KkEg==
Subject: [Intel-gfx] [PATCH v3 1/3] drm/i915: Move the code to populate ACPI

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CBC833809E
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Mar 2021 23:37:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85DED6F38F;
	Thu, 11 Mar 2021 22:36:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E9B1D6EEAB
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Mar 2021 22:36:49 +0000 (UTC)
IronPort-SDR: b3ZCLJBKvbDjwzrkq1wuxNILy9boR8e9qgrUVtBcnP2pfX7IauNx5OlAtREb2Q1WS3uOeY54bI
 I/RHrcWVdjDw==
X-IronPort-AV: E=McAfee;i="6000,8403,9920"; a="175865724"
X-IronPort-AV: E=Sophos;i="5.81,241,1610438400"; d="scan'208";a="175865724"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2021 14:36:47 -0800
IronPort-SDR: xNoFlKBtNyXEy9IFXj0S0M3TLHIgKwM1SJ0ZylPC9gOrEspXd7AJ2vav2m0/1ut1k83hko5K8B
 qqUxkM7TVP9w==
X-IronPort-AV: E=Sophos;i="5.81,241,1610438400"; d="scan'208";a="438852766"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.168])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2021 14:36:45 -0800
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 11 Mar 2021 14:36:15 -0800
Message-Id: <20210311223632.3191939-40-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 39/56] drm/i915: Move intel_modeset_all_pipes()
...
eS9pbnRlbF9jZGNsay5jCmluZGV4IGM1ZmRmNjg4ZmM4OS4uNDJjNDYyY2FlMDMyIDEwMDY0NAot
LS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2NkY2xrLmMKKysrIGIvZHJp
dmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9jZGNsay5jCkBAIC0yNDEwLDQ0ICsyNDEw
...
ZWxfZGlzcGxheS5jCmluZGV4IDBmODA5MmNkM2EyZC4uY2JhZDc1ZGVhZGQwIDEwMDY0NAotLS0g
YS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYworKysgYi9kcml2
ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYwpAQCAtOTU2Niw2ICs5NTY2
...
ZGlzcGxheS9pbnRlbF9kaXNwbGF5LmgKaW5kZXggMTNkNWQ3OTA5NDExLi4zNWU5Mjc0N2I3YTkg
...
NzAsNiArNjcwLDcgQEAgdm9pZCBpbnRlbF9tb2Rlc2V0X2RyaXZlcl9yZW1vdmVfbm9pcnEoc3Ry

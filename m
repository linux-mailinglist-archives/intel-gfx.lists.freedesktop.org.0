...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BE2E62428A
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Nov 2022 13:46:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DAEF910E76D;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Simplify internal helper function
 signature

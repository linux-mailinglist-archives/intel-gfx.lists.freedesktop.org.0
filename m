...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E37B43B95BD
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 19:56:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4874B6EB7D;
...
Subject: [Intel-gfx] [PATCH v7 2/5] drm: separate locks in

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A5F2344E3F
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Mar 2021 19:17:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A6A76E573;
...
Subject: [Intel-gfx] [PATCH 01/11] x86: compressed: avoid gcc-11

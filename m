...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 87E3E3B2935
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:30:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8ECC56EAAF;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 21/27] drm/tegra: Don't set struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E13A26240C1
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Nov 2022 12:08:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 111E210E6D3;
...
Subject: [Intel-gfx] [PATCH v8 01/24] drm/tests: Add Kunit Helpers

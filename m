...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EB4B375AD7
	for <lists+intel-gfx@lfdr.de>; Thu,  6 May 2021 20:59:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3EB16ED24;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 68/97] drm/i915/guc: Handle context reset
 notification

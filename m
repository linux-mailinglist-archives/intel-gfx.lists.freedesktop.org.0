...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3ACFB67A7E2
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 01:39:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3A0D10E09E;
	Wed, 25 Jan 2023 00:39:44 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 3/7] drm/i915: Allow error capture
 without a request

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CC3D079EC06
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Sep 2023 17:04:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F00810E4A0;
	Wed, 13 Sep 2023 15:04:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out1.suse.de (smtp-out1.suse.de [IPv6:2001:67c:2178:6::1c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 51B2410E0D9;
 Wed, 13 Sep 2023 15:04:31 +0000 (UTC)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
 (No client certificate requested)
 by smtp-out1.suse.de (Postfix) with ESMTPS id 08C3A218DF;
 Wed, 13 Sep 2023 15:04:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1694617470; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=cWCcD+60VZvnhTVZ1AqClrtU8gi5Q0+Q1zmPY8kI4yY=;
 b=whyNHt6yffl6uQmDWDGBrlRvyRJpRUms1MUcBJNrozNxusGKcm0pr9xw0TIxkNKRYG/rtN
 N7bs85e7gFIJg9sDFF9OGRcCtu/kKrMkoeOq+Hm/1l9GqYpHVwfrZ6MQQmmthIup9X4jNg
 mNknQuFK1Y2WSaXzthp13hIhZ55kbik=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 s=susede2_ed25519; t=1694617470;
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=cWCcD+60VZvnhTVZ1AqClrtU8gi5Q0+Q1zmPY8kI4yY=;
 b=MBrNpKSakHvD8Z6BH8oQ48xn9FN9eFIFHOIYy2WDHbursFGBatNqTr5D+jUNp+vbzpC7uP
 zuMmePBXC5yYyyAQ==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
 (No client certificate requested)
 by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id A3E8713440;
 Wed, 13 Sep 2023 15:04:29 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
 by imap2.suse-dmz.suse.de with ESMTPSA id QGjvJn3PAWXEdAAAMHmgww
...
To: jani.nikula@linux.intel.com, joonas.lahtinen@linux.intel.com,
 ...
 daniel@ffwll.ch
Date: Wed, 13 Sep 2023 16:58:44 +0200
Message-ID: <20230913150425.5742-5-tzimmermann@suse.de>
X-Mailer: git-send-email 2.42.0
In-Reply-To: <20230913150425.5742-1-tzimmermann@suse.de>
References: <20230913150425.5742-1-tzimmermann@suse.de>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 4/4] drm/i915: Implement fbdev emulation as
 in-kernel client

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1507B416C32
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 08:51:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0D4E6EDFF;
...
Subject: [Intel-gfx] [PATCH v2 03/17] drm/msm: cleanup:

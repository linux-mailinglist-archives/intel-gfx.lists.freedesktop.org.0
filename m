...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE41E19E4AF
	for <lists+intel-gfx@lfdr.de>; Sat,  4 Apr 2020 13:31:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 332666E119;
...
Subject: [Intel-gfx] [drm-tip:drm-tip 9/10]
 drivers/staging/rtl8712/rtl8712_xmit.c:360:18: error: incompatible pointer
 types initializing 'struct tx_desc *' with an expression of type 'u8 *'
 (aka 'unsigned char *')

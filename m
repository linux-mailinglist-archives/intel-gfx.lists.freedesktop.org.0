...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A46D140144
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jan 2020 02:03:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D19186EF2F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH v3 1/2] drm/i915: Add mechanism to submit a

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B8568688886
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Feb 2023 21:48:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 41F1C10E632;
	Thu,  2 Feb 2023 20:48:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6EC0E10E632
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Feb 2023 20:47:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675370878; x=1706906878;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=igA997Zw008m8QtlnNKqKKAy2yYTktgC+bFRF2aCsHo=;
 b=X/VlTl9DhlSFrFjrVSVYOafMBTZpDIQZIh6lcwzAaXjIc3ZZggabcVMa
 6FyvUrHrPDMJ2AVr+roUTMutvD1UWkLZOrl0jtWxtK83nbwcVV7szO37v
 8/Ko7/3KxB/4g/PYzgh4qDFk7P9EfLgp6W6SK6bRnl+SmLRTTMJmmJKOS
 eQfkdnMb0l3OdcsQ6rLTDxz4U2CS5oHFoTXN7xbRrpTYr+EIKyxcWgDD6
 bHDEPtreOCOAXKUMTv5FnztpyTvEwbdZs/yQthPAh/TmtJIMbz54jy9+s
 XF303Vkourn7pEeKPxWHH9csp+/3AeBH15LDDpwRhTkFRi4ioViSMFepQ g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10609"; a="414774223"
X-IronPort-AV: E=Sophos;i="5.97,268,1669104000"; d="scan'208";a="414774223"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Feb 2023 12:47:57 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10609"; a="789427304"
X-IronPort-AV: E=Sophos;i="5.97,268,1669104000"; d="scan'208";a="789427304"
Received: from skopplex-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.34.132])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Feb 2023 12:47:55 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  2 Feb 2023 22:47:46 +0200
Message-Id: <2bff992c6db17dabe4470d3babf1fc1144ad4d83.1675370801.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [RFC 1/3] drm/i915/power: move dc state members to

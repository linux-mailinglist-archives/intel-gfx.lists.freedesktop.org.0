...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C53A43B979C
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 22:27:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A53C76EC65;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 36/53] drm/i915/dg2: Don't wait for AUX power
 well enable ACKs

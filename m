...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BA07B665548
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Jan 2023 08:45:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A41AA10E133;
	Wed, 11 Jan 2023 07:45:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D1E8F10E133;
 Wed, 11 Jan 2023 07:45:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1673423107; x=1704959107;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=CGShxO90bOfdHnRg1zosfZYkeramt62pS7+wBoExotI=;
 b=nF4Tnot4+o8w3MCIysFktQc86uNWjAq/G3epmS/Dl78R+8mNF7NheIx4
 nml6roejCK50f5lVOzfldstqf7lDDGLtt8+aMpr3wOYGzhlfRAxHrk5sA
 K1KK7GA/jrLcJMDtUjTvj6+v2/snqq0k5t0JwRqJyVh33Iz2tojZWxWJV
 QIi0X7DuNWNoKgiJaZc4esl2SWS/BCjt+mN9ll8rJxBBgvFjQYSPnc3Rc
 1NziqSfdYfBL0GuS55vmmZnDMWpccbHn0B4rh/Mxkhsb9kM+ZmVP/GDqj
 ELS73j/+q7PigaMgpUnQViBUhKroR3mqX98WZJidlcro2eM1jlllriUep A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10586"; a="303051054"
X-IronPort-AV: E=Sophos;i="5.96,315,1665471600"; d="scan'208";a="303051054"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2023 23:45:06 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10586"; a="659274921"
X-IronPort-AV: E=Sophos;i="5.96,315,1665471600"; d="scan'208";a="659274921"
Received: from lkp-server02.sh.intel.com (HELO f1920e93ebb5) ([10.239.97.151])
 by fmsmga007.fm.intel.com with ESMTP; 10 Jan 2023 23:45:04 -0800
Received: from kbuild by f1920e93ebb5 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1pFVnD-0008u8-17;
 Wed, 11 Jan 2023 07:45:03 +0000
Date: Wed, 11 Jan 2023 15:44:37 +0800
From: kernel test robot <lkp@intel.com>
To: Alan Previn <alan.previn.teres.alexis@intel.com>,
 intel-gfx@lists.freedesktop.org
Message-ID: <202301111502.rkwbhxRZ-lkp@intel.com>
References: <20230111005642.300761-6-alan.previn.teres.alexis@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="1G3Xf9QZe+CWwXId"
Content-Disposition: inline
In-Reply-To: <20230111005642.300761-6-alan.previn.teres.alexis@intel.com>
Subject: Re: [Intel-gfx] [PATCH 5/9] drm/i915/pxp: Add GSC-CS
 backend-teelink for send-message function
...
patch link:    https://lore.kernel.org/r/20230111005642.300761-6-alan.previn.teres.alexis%40intel.com
patch subject: [Intel-gfx] [PATCH 5/9] drm/i915/pxp: Add GSC-CS backend-teelink for send-message function
config: i386-allyesconfig
compiler: gcc-11 (Debian 11.3.0-8) 11.3.0
reproduce (this is a W=1 build):
        # https://github.com/intel-lab-lkp/linux/commit/b3a566b139d02e25dd05bc553375402a97ecf9c0
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Alan-Previn/drm-i915-pxp-Add-MTL-PXP-GSC-CS-back-end-skeleton/20230111-085853
        git checkout b3a566b139d02e25dd05bc553375402a97ecf9c0
...
>> include/drm/drm_print.h:456:39: error: format '%ld' expects argument of type 'long int', but argument 4 has type 'size_t' {aka 'unsigned int'} [-Werror=format=]
   ...
   include/drm/drm_print.h:466:9: note: in expansion of macro '__drm_printk'
     466 |         __drm_printk((drm), warn,, fmt, ##__VA_ARGS__)
         |         ^~~~~~~~~~~~
   drivers/gpu/drm/i915/pxp/intel_pxp_gsccs.c:116:17: note: in expansion of macro 'drm_warn'
     116 |                 drm_warn(&i915->drm, "caller with insufficient PXP reply size %u (%ld)\n",
         |                 ^~~~~~~~
   In file included from include/drm/ttm/ttm_resource.h:34,
                    ...
                    from drivers/gpu/drm/i915/pxp/intel_pxp_gsccs.c:8:
>> drivers/gpu/drm/i915/pxp/intel_pxp_gsccs.c:120:37: error: format '%ld' expects argument of type 'long int', but argument 6 has type 'size_t' {aka 'unsigned int'} [-Werror=format=]
     120 |                 drm_dbg(&i915->drm, "caller unexpected PXP reply size %u (%ld)\n",
         |                                     ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   include/drm/drm_print.h:510:33: note: in expansion of macro 'drm_dbg_driver'
     510 | #define drm_dbg(drm, fmt, ...)  drm_dbg_driver(drm, fmt, ##__VA_ARGS__)
         |                                 ^~~~~~~~~~~~~~
   drivers/gpu/drm/i915/pxp/intel_pxp_gsccs.c:120:17: note: in expansion of macro 'drm_dbg'
     120 |                 drm_dbg(&i915->drm, "caller unexpected PXP reply size %u (%ld)\n",
         |                 ^~~~~~~
   drivers/gpu/drm/i915/pxp/intel_pxp_gsccs.c:120:77: note: format string is defined here
     120 |                 drm_dbg(&i915->drm, "caller unexpected PXP reply size %u (%ld)\n",
         |                                                                           ~~^
         |                                                                             |
         |                                                                             long int
         |                                                                           %d
   At top level:
   drivers/gpu/drm/i915/pxp/intel_pxp_gsccs.c:43:12: error: 'gsccs_send_message' defined but not used [-Werror=unused-function]
      43 | static int gsccs_send_message(struct intel_pxp *pxp,
         |            ^~~~~~~~~~~~~~~~~~
   cc1: all warnings being treated as errors


vim +120 drivers/gpu/drm/i915/pxp/intel_pxp_gsccs.c

    42	
    43	static int gsccs_send_message(struct intel_pxp *pxp,
    44				      void *msg_in, size_t msg_in_size,
    45				      void *msg_out, size_t msg_out_size_max,
    46				      size_t *msg_out_len)
    47	{
    48		struct intel_gt *gt = pxp->ctrl_gt;
    49		struct drm_i915_private *i915 = gt->i915;
    50		struct gsccs_session_resources *exec = &pxp_to_gsccs_priv(pxp)->arb_exec_res;
    51		struct intel_gsc_mtl_header *header = exec->pkt_vaddr;
    52		struct intel_gsc_heci_non_priv_pkt pkt;
    53		size_t max_msg_size;
    54		u32 reply_size;
    55		int ret;
    56	
    57		if (!intel_uc_uses_gsc_uc(&gt->uc))
    58			return -ENODEV;
    59	
    60		if (!exec->ce)
    61			return -ENODEV;
    62	
    63		max_msg_size = PXP43_MAX_HECI_IN_SIZE - sizeof(*header);
    64	
    65		if (msg_in_size > max_msg_size || msg_out_size_max > max_msg_size)
    66			return -ENOSPC;
    67	
    68		mutex_lock(&exec->cmd_mutex);
    69	
    70		if (!exec->pkt_vma || !exec->bb_vma)
    71			return -ENOENT;
    72	
    73		memset(header, 0, sizeof(*header));
    74		intel_gsc_uc_heci_cmd_emit_mtl_header(header, MTL_HECI_CLIENT_PXP, msg_in_size,
    75						      exec->host_session_handle, 0);
    76	
    77		memcpy(exec->pkt_vaddr + sizeof(*header), msg_in, msg_in_size);
    78	
    79		pkt.addr_in = i915_vma_offset(exec->pkt_vma);
    80		pkt.size_in = header->message_size;
    81		pkt.addr_out = pkt.addr_in + PXP43_MAX_HECI_IN_SIZE;
    82		pkt.size_out = msg_out_size_max + sizeof(*header);
    83		pkt.heci_pkt_vma = exec->pkt_vma;
    84		pkt.bb_vma = exec->bb_vma;
    85	
    86		ret = intel_gsc_uc_heci_cmd_submit_nonpriv(&pxp->ctrl_gt->uc.gsc,
    87							   exec->ce, &pkt, exec->bb_vaddr, 500);
    88		if (ret) {
    89			drm_err(&i915->drm, "failed to send gsc PXP msg (%d)\n", ret);
    90			goto unlock;
    91		}
    92	
    93		/* we keep separate location for reply, so get the response header loc first */
    94		header = exec->pkt_vaddr + PXP43_MAX_HECI_IN_SIZE;
    95	
    96		/* Response validity marker, status and busyness */
    97		if (header->validity_marker != MTL_HECI_VALIDITY_MARKER) {
    98			drm_err(&i915->drm, "gsc PXP reply with invalid validity marker\n");
    99			ret = -EINVAL;
   100			goto unlock;
   101		}
   102		if (header->status != 0) {
   103			drm_dbg(&i915->drm, "gsc PXP reply status has error = 0x%08x\n",
   104				header->status);
   105			ret = -EINVAL;
   106			goto unlock;
   107		}
   108		if (header->flags & MTL_GSC_HDR_FLAG_MSG_PENDING) {
   109			drm_dbg(&i915->drm, "gsc PXP reply is busy\n");
   110			ret = -EAGAIN;
   111			goto unlock;
   112		}
   113	
   114		reply_size = header->message_size - sizeof(*header);
   115		if (reply_size > msg_out_size_max) {
 > 116			drm_warn(&i915->drm, "caller with insufficient PXP reply size %u (%ld)\n",
   117				 reply_size, msg_out_size_max);
   118			reply_size = msg_out_size_max;
   119		} else if (reply_size != msg_out_size_max) {
 > 120			drm_dbg(&i915->drm, "caller unexpected PXP reply size %u (%ld)\n",
   121				reply_size, msg_out_size_max);
   122		}
   123	
   124		memcpy(msg_out, exec->pkt_vaddr + PXP43_MAX_HECI_IN_SIZE + sizeof(*header),
   125		       reply_size);
   126		if (msg_out_len)
   127			*msg_out_len = reply_size;
   128	
   129	unlock:
   130		mutex_unlock(&exec->cmd_mutex);
   131		return ret;
   132	}
   133	

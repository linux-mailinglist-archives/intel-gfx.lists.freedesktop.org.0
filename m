...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id cEGHEqQqzWn7aQYAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 01 Apr 2026 16:24:36 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7569237C188
	for <lists+intel-gfx@lfdr.de>; Wed, 01 Apr 2026 16:24:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A89C10E1F7;
	Wed,  1 Apr 2026 14:24:33 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="W5laloGD";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1163F10E010;
 Wed,  1 Apr 2026 14:24:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1775053472; x=1806589472;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=TG6R0Okg2YkUbsh3YiyV1gqvpsR7pJR89KtMevMDW7M=;
 b=W5laloGDFMu/Yd3M1RPWUXXN+ornLpgC4VHcirElqGMUdKf8zVgmws+R
 fERAG/UJ66qr0rEDwOzSNWrEwjKuFpEAgYQfLPcVF3t+0h9tSxtso9HB4
 fELW8EO1WnZ/IaGTDEDZt1dGBWvmIS1O2AsMdd9bhZJWKQZ7Medp1I2HG
 pj6CmN0WYubEzIQ573g2yIBrv9Dcv2wIBX62zXiHfHGBt7dpRS1sCVgBr
 b6E3DiBd0TAR5oPopCd12jDG7y3yJ9OaAvftyG2/DU2K05WFFSzUUY6Ou
 mDMNCsOzFIwdHtwhYVY++sJYjM36zTifJqSE0FrAjR+ABa9E1z7XezSZO g==;
X-CSE-ConnectionGUID: /s+NiyxvROiwP57RWf88pg==
X-CSE-MsgGUID: LnvJdnV+QpKx8+xr44UoSA==
X-IronPort-AV: E=McAfee;i="6800,10657,11745"; a="75268434"
X-IronPort-AV: E=Sophos;i="6.23,153,1770624000"; d="scan'208";a="75268434"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Apr 2026 07:24:31 -0700
X-CSE-ConnectionGUID: SNf9buULQP6IxoXbmF++jA==
X-CSE-MsgGUID: 6EF7fvO5SfaSwp53TBggkg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,153,1770624000"; d="scan'208";a="226673118"
Received: from pgcooper-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.244.199])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Apr 2026 07:24:29 -0700
Date: Wed, 1 Apr 2026 17:24:26 +0300

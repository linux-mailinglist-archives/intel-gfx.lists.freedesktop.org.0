...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 285CE811862
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Dec 2023 16:53:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0463810E7B6;
	Wed, 13 Dec 2023 15:53:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1E81E10E7C7
 for <intel-gfx@lists.freedesktop.org>; Wed, 13 Dec 2023 15:52:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702482778; x=1734018778;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=UTSV9bfIBnob6KWR4OZS+/nc+L5dk+Nj8aTBZGwZbw8=;
 b=lYPSXoAvsVN7WjnG8RpOMvwFmkwZHoah/lgMqPG4Z45TdsA4yPpLq5v/
 BPsvDUfYxadeusYniC2z7H9BAcMuAGtFW2o67WYd53rJR7MfI4rBo6X9I
 Bk0WoZmWNS/j/gqQ+EvMRpOkkF+FVJapx04o7DfYjlerNixzc8alBNfwz
 OiXYn4R4KCwjSQPSGFV6kSwsF6u5VIdUiDdof9oTqEh3wtObzhhG4ogs0
 WodWF0DLaLVp+nNZDGXDOBdWrXHUjs6vuQfY4C4lVh0THF/AmRp16R/n0
 JRfBNSljRN2mLwwmxTg/laRslbR5nypdiG+tYLshXbSpnVwL4HnMmwsoR A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10923"; a="426107312"
X-IronPort-AV: E=Sophos;i="6.04,273,1695711600"; d="scan'208";a="426107312"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2023 07:52:57 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10923"; a="1105345687"
X-IronPort-AV: E=Sophos;i="6.04,273,1695711600"; d="scan'208";a="1105345687"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.24.31])
 ([10.213.24.31])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2023 07:52:56 -0800
Message-ID: <a2a9702d-4f1e-40eb-8d01-53ddc3eeb976@intel.com>
Date: Wed, 13 Dec 2023 16:52:54 +0100
MIME-Version: 1.0

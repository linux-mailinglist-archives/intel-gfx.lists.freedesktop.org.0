...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1615C21FF66
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 405B86EA11;
...
Subject: [Intel-gfx] [PATCH v2 40/59] drm/kmb: Added LCD_TEST config

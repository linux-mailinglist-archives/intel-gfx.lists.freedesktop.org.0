...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F734223CE5
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jul 2020 15:38:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 55A126EDB2;
	Fri, 17 Jul 2020 13:38:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-1.mimecast.com
 [205.139.110.61])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 486216EDB2
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Jul 2020 13:38:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1594993089;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=/gPKngnvzgVzWE2GaHMS110IozFoJNDcY5HjY8Agmjc=;
 b=aUiwmYdGhXaLgdFR5j4z6L+YslirH692XClyfPnIOlkssppOSKDFPbnkfhzUdMKgQOENLS
 ZwSlucrw1H5Ayt7MdE9INI+zBccFvhDKjHxxUTA7SZhZSHjH6SoHl3CyvzdVoJa1QSMUEZ
 rhJbmnMXqnJTr7exsuspVxXPUwJXKHk=
...
Subject: [Intel-gfx] [PATCH v5 02/16] ACPI / LPSS: Save Cherry Trail PWM ctx

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B19E96165A1
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Nov 2022 16:02:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A26D110E4B7;
...
Subject: [Intel-gfx] [PATCH v2 7/7] vfio: Remove vfio_free_device

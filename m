...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B939C424C46
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Oct 2021 05:49:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A38666E81D;
...
Subject: Re: [Intel-gfx] [PATCH 04/26] drm/i915/guc: Don't call

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 55B567CA670
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Oct 2023 13:17:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC9D910E1BB;
	Mon, 16 Oct 2023 11:17:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D412210E1BE
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Oct 2023 11:17:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1697455041; x=1728991041;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=MCNYtt0HySSqOlYy8japIMBf9NutAejVKjK6XpMfX+g=;
 b=c7ov7XtBdfelSj3XRx+gdB1ohJpG7UTbZrjd158rJ1A+c9YQBeEqoAHp
 X7Smf1O7cJoqpgXTTIqv0LPJ9vtgUyqgnvIQCPOC2nyyEJrumw08K0lUP
 QjrMrhK2lHsf+3NCVH5V/6iJAbxsMxNBVb2t3YLsb0fRTzV5lFFTPxrZG
 g1M/l87r2SUTmniRhGYQPJo+WUKpKWwEb3wV1fwF4mWBsw1+gWE8ldTBG
 rzSWg7Ou/lbKzcsAlr2rRW1nxBuKOtpWbCSE4MCheMg9Q8PvHvb2xj4+j
 WnVIle/9bEuhufkLX52CVXiVMcLKD3OndSMMkDu8h2aetuXAFrc+ODkUl w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10863"; a="385341348"
X-IronPort-AV: E=Sophos;i="6.03,229,1694761200"; d="scan'208";a="385341348"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Oct 2023 04:17:20 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10863"; a="821532546"
X-IronPort-AV: E=Sophos;i="6.03,229,1694761200"; d="scan'208";a="821532546"
...
Date: Mon, 16 Oct 2023 14:16:38 +0300
Message-Id: <20231016111658.3432581-5-jouni.hogander@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 04/24] drm/i915/display: Move psr related

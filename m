...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 299A21D3502
	for <lists+intel-gfx@lfdr.de>; Thu, 14 May 2020 17:26:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2FBD76EB66;
	Thu, 14 May 2020 15:25:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F228A6EB68
 for <intel-gfx@lists.freedesktop.org>; Thu, 14 May 2020 15:25:55 +0000 (UTC)
IronPort-SDR: VEYXZTW7Qa5RLxptbyXjf1m0qKbnlT8FZw74AuVoAUFk7A/b8Nnx//hZ2Xlq7VxoSnY2wI6JmV
 ku3HLBkk7l8A==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 May 2020 08:25:55 -0700
IronPort-SDR: 9zNJx5jlGDUu3vjTVeqJ15S8XeCHLkUcBQnPLHbEgKrGikub/cbbCnIxAwxaBGJOE7RH4nk8rU
 jC2fN8qxhzAw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,391,1583222400"; d="scan'208";a="410112407"
Received: from unknown (HELO slisovsk-Lenovo-ideapad-720S-13IKB.fi.intel.com)
 ([10.237.72.89])
 by orsmga004.jf.intel.com with ESMTP; 14 May 2020 08:25:53 -0700
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 14 May 2020 18:21:39 +0300
Message-Id: <20200514152145.2449-2-stanislav.lisovskiy@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 1/7] drm/i915: Decouple cdclk calculation
 from modeset checks
...
ZXggNDMyYjRlZWFmOWY2Li4wMDVlMzI0ZDA1ODIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 86F584AB901
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Feb 2022 11:49:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8607810F715;
	Mon,  7 Feb 2022 10:49:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CF95010F49E
 for <intel-gfx@lists.freedesktop.org>; Mon,  7 Feb 2022 10:49:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644230961; x=1675766961;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=PprCnOgURgby3uZeuygSVaIAJ8dITDf5jKTPJkqvpaQ=;
 b=mYHPGC5O+On59lUs5efGvIyWdYjkUwJWm+JElveejDsrLabvRX1AKpk3
 AVWb4BejIg5qDE18r6Q1h5TVOgJknEnXdsheagSTrN8VGGJIn0aFWsTaA
 7HHVcZjz8taym3lNodKL6sQsTmyEDb9kJJUARNXgfJCVsvWt/udvCkbXZ
 fKax7lD+kJYZkx+/UrDZnESBRdmKANrGywxf7nJyup7pTRYr4j/ePhdMc
 k8gqPopt9AoOHdgjP932ck3lzeBN9c6pQ0p3mJ6pYqsFOwsSmCn2l4S20
 8GL9cigz5dRpkwHbWUO+bHrOB/HfGcVathGKAj4xs0VTRJ0+lRbRQxhGP A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10250"; a="335094467"
X-IronPort-AV: E=Sophos;i="5.88,349,1635231600"; d="scan'208";a="335094467"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Feb 2022 02:49:21 -0800
X-IronPort-AV: E=Sophos;i="5.88,349,1635231600"; d="scan'208";a="481545533"
Received: from conroyco-mobl2.ger.corp.intel.com (HELO [10.213.251.21])
 ([10.213.251.21])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Feb 2022 02:49:19 -0800
Message-ID: <7e1820b6-36a0-1fd4-cda0-9828a940ab58@linux.intel.com>
Date: Mon, 7 Feb 2022 10:49:18 +0000
MIME-Version: 1.0

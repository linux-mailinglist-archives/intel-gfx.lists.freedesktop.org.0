...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 757A41369D2
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 88BF96E9C9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/23] drm/i915: Convert to CRTC VBLANK callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D9AE61F590
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Nov 2022 15:19:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A58410E351;
...
Subject: [Intel-gfx] [PATCH v7 17/23] drm/atomic-helper: Add a TV properties
 reset helper

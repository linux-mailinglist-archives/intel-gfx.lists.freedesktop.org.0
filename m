...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E1122CF6D9
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Dec 2020 23:36:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 737FC6EC88;
	Fri,  4 Dec 2020 22:36:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 219376EC88
 for <intel-gfx@lists.freedesktop.org>; Fri,  4 Dec 2020 22:36:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1607121400;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=WlfJcWQH4+BVAPRDB1lM9yp++1goOAVKrrUL7KVYXuo=;
 b=MHYmp+XM2XY80Z1qJ/fjljtBwC1WJ0Ep7GQHtvuMSMJYajEWOp1xvg7EQvlQor4Ey8Ioqv
 5KudSh0vQ+pDU2YFDCb9iJEfvgBCQMfpIp0pbX8p63bwDdD8tfo13D14YqXMK2sYkQAHrM
 12SiLV0cd93Ti28DXVCKuclzH+gxrEY=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-491-y1XfTdPxOQKaEnUL8gPV-w-1; Fri, 04 Dec 2020 17:36:38 -0500
X-MC-Unique: y1XfTdPxOQKaEnUL8gPV-w-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
 [10.5.11.11])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B0845180A093;
 Fri,  4 Dec 2020 22:36:35 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-112-159.rdu2.redhat.com
 [10.10.112.159])
 by smtp.corp.redhat.com (Postfix) with ESMTP id C9AC91962F;
 Fri,  4 Dec 2020 22:36:33 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: Rodrigo Vivi <rodrigo.vivi@intel.com>,
 Jani Nikula <jani.nikula@linux.intel.com>, Dave Airlie <airlied@gmail.com>,
 intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org
Date: Fri,  4 Dec 2020 17:35:58 -0500
Message-Id: <20201204223603.249878-5-lyude@redhat.com>
In-Reply-To: <20201204223603.249878-1-lyude@redhat.com>
References: <20201204223603.249878-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.11
Subject: [Intel-gfx] [PATCH v3 4/9] drm/i915: Keep track of pwm-related
...
@@ -1942,6 +1912,61 @@ static int ext_pwm_setup_backlight(struct intel_connector *connector,
 	return 0;
 }
...
@@ -2015,7 +2040,7 @@ static void intel_panel_destroy_backlight(struct intel_panel *panel)
...
@@ -2068,7 +2093,7 @@ static const struct intel_panel_bl_funcs ext_pwm_funcs = {
...
@@ -2103,36 +2136,39 @@ intel_panel_init_backlight_funcs(struct intel_panel *panel)

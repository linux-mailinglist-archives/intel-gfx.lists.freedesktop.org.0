...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A25415A65C
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Feb 2020 11:29:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEA1A6F4AD;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 2/5] drm/hdcp: fix

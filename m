...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D9C3C1CA96
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Oct 2025 19:04:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DFE110E823;
	Wed, 29 Oct 2025 18:04:27 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UnlvZffC";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5E31810E82B;
 Wed, 29 Oct 2025 18:04:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761761065; x=1793297065;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 in-reply-to:mime-version;
 bh=cGFetEAT221p8d3jIsy6Q+B8tI6Rz4V8U2Jm+E8Rfoo=;
 b=UnlvZffCj4vrKAHpvKpi0ElTjX7QzNay7q0pg04A3jLazGwUaicXpm+j
 Ts9NBOcY7BiNeto75FWuKdPq7X44pV2TTbjCXj1dsbot+ooigpvMArLh/
 wefuzdAw/Fl+Esnq5NnaRpDJgVaIdx2Vh1+2Q6/SReYwWieQq9cKqCHZj
 xxIylTC4OgLz9ZBAd7VhcZibeyDlNnX06Sm303wRfdy+DRQa4P84htCdq
 odyhHKh29exYg7vF6SZwza2iHGCb7nKD5umdhiXkDvjnccq28vHuz0zT7
 fnbgjCBkuH8yqJ893tWtaJgJ7NC9Tu7Zwt9V06j26SmB14b9O4QIn3U9M Q==;
X-CSE-ConnectionGUID: Bq2iuZzUTVKlzGwEzS+lpw==
X-CSE-MsgGUID: UQQdMbaITNabT/FkYUVWWA==
X-IronPort-AV: E=McAfee;i="6800,10657,11597"; a="63593196"
X-IronPort-AV: E=Sophos;i="6.19,264,1754982000"; d="scan'208";a="63593196"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by orvoesa112.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Oct 2025 11:04:25 -0700
X-CSE-ConnectionGUID: OYe1aL/pTWm7JtGZINauVw==
X-CSE-MsgGUID: TVp/EUfaQ82AMKTnNhRlYg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,264,1754982000"; d="scan'208";a="189804654"
Received: from orsmsx901.amr.corp.intel.com ([10.22.229.23])
 by orviesa003.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Oct 2025 11:04:24 -0700
Received: from ORSMSX903.amr.corp.intel.com (10.22.229.25) by
 ORSMSX901.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.27; Wed, 29 Oct 2025 11:04:24 -0700
Received: from ORSEDG903.ED.cps.intel.com (10.7.248.13) by
 ORSMSX903.amr.corp.intel.com (10.22.229.25) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.27 via Frontend Transport; Wed, 29 Oct 2025 11:04:24 -0700
Received: from PH0PR06CU001.outbound.protection.outlook.com (40.107.208.61) by
 edgegateway.intel.com (134.134.137.113) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.27; Wed, 29 Oct 2025 11:04:23 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=Qy4muyrHdcaTPWcaPCaQtucyYBU2DL7qzBqJUfbvoOc=;
 b=
...
Received: from SJ0PR11MB4845.namprd11.prod.outlook.com
 ...
 18:04:15 +0000
Date: Wed, 29 Oct 2025 20:04:10 +0200
...
Subject: Re: =?utf-8?B?4pyXIGk5MTUuQ0kuRnVsbDogZmFp?=
 =?utf-8?Q?lure_for_drm=2Fi915=2Fdp=5Fmst?= =?utf-8?Q?=3A?= Fix check for FEC
 support for an uncompressed stream
Message-ID: <aQJXGl_avXvjQm1w@ideak-desk>
References: <20251028113536.602352-1-imre.deak@intel.com>
 <176168728834.64512.17116269051028952538@97596180aaec>
Content-Type: text/plain; charset="us-ascii"
Content-Disposition: inline
In-Reply-To: <176168728834.64512.17116269051028952538@97596180aaec>
X-ClientProxiedBy: DU6P191CA0027.EURP191.PROD.OUTLOOK.COM
 (2603:10a6:10:53f::27) To SJ0PR11MB4845.namprd11.prod.outlook.com
 (2603:10b6:a03:2d1::10)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: SJ0PR11MB4845:EE_|DS7PR11MB8805:EE_
X-MS-Office365-Filtering-Correlation-Id: 15d69777-0b31-43f1-272f-08de17159206
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0; ARA:13230040|1800799024|376014|366016|10070799003;
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?NRe00/rZ7uAnho0qyKCupdXPbruN7HQZ/INWgP5fIOXurGA68SSuINr3JoUP?=
 =?us-ascii?Q?O+z2UmtD1TqP71nVpm4OrRPcqidRE0Zi9+crx1n86HouMncarXNbN8dHj0S4?=
 =?us-ascii?Q?mP5jguhhUKFow5nklyaUZJI6wCROkKlBGmQqVZM9GAWN6NpUwv83ZqAvOCas?=
 =?us-ascii?Q?3IVyphjaLhwXY/fbNquO1tUac/N8P21z/1ApjGndoRMu+6yUDBLiFcTOCHEc?=
 =?us-ascii?Q?oqymUQi/GKF3mGf4VGmreG+epVUBULd8Oh9rcJXKFIpKhxPKd6pEVhWA2L+m?=
 =?us-ascii?Q?MN0ImCuj1VVrHvt5rcyeaN2XgJXSON/2aGHQbnMaKpODNC0S3p6cKxmre8f+?=
 =?us-ascii?Q?O4g79vUwHryxhMf6Dz+K6jE3Ndhh6GDEd2faPcnl/6WXSQX7cYrFWYZwkXkf?=
 =?us-ascii?Q?DGJ3izhXmXNom871PHnRJJxcF3csQmpeRjUECFD+sk9Bh4HKPWoazQ8kLvU6?=
 =?us-ascii?Q?cVNvlpTxlyZGeteSrvIl0hWCBlhSckJwC6x5bKTecDh1SltgsmD271oUOv36?=
 =?us-ascii?Q?Kdi4Xg0JFLSzhlr7VzjZKKI0g5gJhPbvrnSIwUcAW6lGfW23EvpnalJlY23O?=
 =?us-ascii?Q?q2coFbTmkTpGoRLk1V7+XzX8OL9MeQv9K6Sqj4jLojWEjZYIAdqJSlvTDf5K?=
 =?us-ascii?Q?MM5jMYpV3cmwxpowL0R7cvZ9Zt7HUFuWWiSADLFr7uyA1+pg4akSgPW0y4hL?=
 =?us-ascii?Q?geXRFIkd4cTJGmd0zJblNpQ7MM62xNK+Z05exv6fCvbNEUvFkKC2Vk2sEbcQ?=
 =?us-ascii?Q?fRCQaUQ9PfyJbOkQgUwTUaNnCHgx5X39F+Wbzko8NiNo9piBmRHbk8fdCIuP?=
 =?us-ascii?Q?oAu3jBqUa4VcR7cW1OZOd7TLYo8efswZDvmq/qP4q4LKqsc/2BE30QuTpG0a?=
 =?us-ascii?Q?3L/UkouVaulOwtvWO3nuCqco9QcrgKb/oj5N0nQbKBKg5iIp7phe2JPHPHuS?=
 =?us-ascii?Q?3QWxK3ZhRIrKG9DaAr6SpzEkuNCDpOeLFeobmlXQdSU5SzdxAdxmXr5B6Gbk?=
 =?us-ascii?Q?fPfBmJPpl5JYGB+6xjjDy4pQ4wFOs6QoDhvBYJhbFeA/sqz0qArcmD3vi/D3?=
 =?us-ascii?Q?nD33FyVgLhqmotfR9RP+0O1PE5YZYV1luHuHPMAUtnJLBqHHMA0M6A6QpIxr?=
 =?us-ascii?Q?GO4HthN5Vdb/HdsyjCylJMfzg5a+kee9cxwALueMHvA7Gl/ayGMHZjaHOZeX?=
 =?us-ascii?Q?Xu65uqsiPxCzHT4Mj5j2vNmWffK5FP7ztG/ujcQ2lT//XbkQsCe9aZbeUYCu?=
 =?us-ascii?Q?u4CtANYbZeWUUoYAUXIdoOxLJrw1KdEF+E749y8XYOqKxj9/eRQDar05KiXN?=
 =?us-ascii?Q?4kzUR6rlYTm8VEAa/nqZNDwJj6Tdapv8BgVJFjjQ7+Xt5IDJugrpnC4zR+Sp?=
 =?us-ascii?Q?rAS2GEf+ng4G0FXD2hTcjt4kdXvpWYlr9d5h03xoptGl68PKcg=3D=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:SJ0PR11MB4845.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(1800799024)(376014)(366016)(10070799003); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?XasEGOx88l1A3RSw38KjVj1NfS0I8iyLFwHMsIjd1xcGnaysKTslFNGXub26?=
 =?us-ascii?Q?QteBYD+L85EUe9Msr/vTNA9ApDo9p3ETNOwxABB9uL/8x1ESdLIdHWhRTV2Y?=
 =?us-ascii?Q?sz227zTl6heO49lnDZHMCFtn2jWBXw1M+Uw3r4XsEnjyeJrYubWEs49BJfd3?=
 =?us-ascii?Q?7M2aB/rRN0ZEqaq328+O8QvdqvWy/z0XSyAiZjAMputcFZ6oZyvTmaSQ1l/o?=
 =?us-ascii?Q?sO8paxqQmAuhiKtr3HMjTN6BH+s9BdVaRlHe+71/tt7rVXd8Y72NznBFjqSS?=
 =?us-ascii?Q?/fbGN8q3vdSBpXThcJl+Eo5tLuIvnOeIeEz9OioMDCzBKPfhlj/MoX/EuIKn?=
 =?us-ascii?Q?ImNQB0N79H9pmfcsIU4h97lh9u0weBDNkh2PrjpKiLPAGg/gUQn3LnfVEBVw?=
 =?us-ascii?Q?6L4pTxF0Qx79ICiKagReht+QOH/QAux4o3M+G3dq/q/qHQhdtlD2iN+iryT8?=
 =?us-ascii?Q?f+f1uNAmYt60v3aLLzF04nRFNFSrMQ02drWXwvgAKUiUnQ8WqASi8L5dnFzR?=
 =?us-ascii?Q?UiHZCDxh/rRowzuT/7xhMT5qjnanvzOBhtBdmB4cr9Qy6Y/M/fEKjlIVcgZ3?=
 =?us-ascii?Q?vYplXCliwVuSBPvPTr/K3oLdjPOcH7nhnStfCBkSb8dQ0WIzxHIEcA2fjfnP?=
 =?us-ascii?Q?EQ8zfv0CrSJBeRoPTXD+MgGGTMPZuveY8itehhrXpcrVRY13HZfxEUlOlHXG?=
 =?us-ascii?Q?/USrYPCSLFpvO7f3e/Q1EHGP5F6mdFY7THYEojFXR4Nn+jpYKw52vjRbXY27?=
 =?us-ascii?Q?htglFAhjfmE1jTKZ002Om3VIx7Mn+2SoD+r+m+CW7xEmjEfGaUkuBiriUNCv?=
 =?us-ascii?Q?c0GFt5O/rwM5poyBgJZXvvVHENcRxVn9ylQldGHaXg2USTSBwaqg5eCPXqOY?=
 =?us-ascii?Q?NI84gVIPtczFFHsRdVtslJSBoncYS8c+ao/QXfF3saSDwbnuW1js0i+5bkRb?=
 =?us-ascii?Q?sr3ou+GILzvkcys+x7yfUpDXKlIB8lgjm5thD6Urn34LKG/p6mIicW8Jq8/k?=
 =?us-ascii?Q?A8EvA9Cmb169vvtoUKJmlJBqhtiiuNFKwwC/xmzU623w7wtdkLgR7XIyHrlI?=
 =?us-ascii?Q?lX0219ViS3KCauyX1iY37ROtxHIwMu0XuyU1Xf7kW7rvsAMyBP6PPG0oJq3P?=
 =?us-ascii?Q?BBGODfgMk81glBzz0Vx6FTlpTLiCRvS6yikcH9JMLNG+3mZSY21uDef5Pti/?=
 =?us-ascii?Q?FfksuJpPT9IC7xxX3ObquqD0nj9syDi9m+uXWcNJBkKjkcJHfKenVABnuhji?=
 =?us-ascii?Q?NB2uRUlDIGr04ICMUkRD7LA4uVrUK5xV55bJjqLS8Sl7Yk4nNBUBeyOPgOiL?=
 =?us-ascii?Q?+7Miw7yfg4IzLNcnUl2UtjEGNkkXND3taFAZc6A98PU6MtAjqgbAn2ZmBY13?=
 =?us-ascii?Q?wP8cMCIQEJXUASBkUYFKL/mMvpOnUXgPGGYssAJHgv9dmXwYMjDbrBTJfqGZ?=
 =?us-ascii?Q?6zE716uGLpHsEc040m9KHOoQ9tIYT44dsgFvYW6ONeng/egJPWCb8x44cmCn?=
 =?us-ascii?Q?9JNLj663Lk97qlOYd+RaN78rSQStdHRL1jZoYx2GEonQfYMWD50CKqyyVPDg?=
 =?us-ascii?Q?Uv76bzi/eKCYys32F4DCJKjRkdUZDnWkHqI9QHgB1v/jijnwLZ3P7h112Lo2?=
 =?us-ascii?Q?wm2sJ9LuR4HLzJngiUuw8lnJL+2GhO3Edl5flFoIk5DT?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 15d69777-0b31-43f1-272f-08de17159206
X-MS-Exchange-CrossTenant-AuthSource: SJ0PR11MB4845.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 29 Oct 2025 18:04:15.0884 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: mERTlY3i97pxk71ucj6GK3T6bfxwldiGpmmdPp6I8S54ARv9iXTYrUGCljNKvIaKnsOlGDg99Ibvv+ZwxE0Iug==
...
On Tue, Oct 28, 2025 at 09:34:48PM +0000, Patchwork wrote:
> == Series Details ==
> 
...
The patch is pushed, thanks for the review.
...
No DP outputs on any of the above hosts, so the DP-MST specific change
in the patch are unrelated to the failures.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FEFE702A58
	for <lists+intel-gfx@lfdr.de>; Mon, 15 May 2023 12:17:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84C3B10E193;
	Mon, 15 May 2023 10:17:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 810E110E193
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 May 2023 10:17:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684145869; x=1715681869;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=QjLHCmeNC6xVIrZe3Mw1u9uPxjakba3/Z0jG4EXu2AU=;
 b=CoQCqkPmTJ7MgdfCOVQ8pJYgDhGNEJgFwyPVb8KruEYKlsBNntncT+qB
 wm4K2FOlH/ZAZB5o9w50q0oClkjoCfGYORZPGWVZvwGU5JUgYlpGTjZSP
 Pik7Vqlu0+OfVIoidotWLotQbG/X4iF8SOhs4nG0DOczolu+96x4N2w+x
 +a0mHSijuZaNl1pXk9NpWNONzKtgvLH51/i/J6McNHHWiMLVbyOiy3U8R
 Ox33IlOb37cFfellBkhOJg8CCli9/ua2b54y4dMpbJkqIl0EV8v6Id/qP
 4GHf63bRrd5loZOTggM24G5LrCko4aXrbb6/FDPK+X+d4wiALWNiKJV0Z A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="350002651"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="350002651"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2023 03:17:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="733824635"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="733824635"
Received: from lveltman-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.42.56])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2023 03:17:45 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 15 May 2023 13:17:37 +0300
Message-Id: <20230515101738.2399816-2-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915/irq: split out hotplug irq
 handling
...
index 7587fe856e67..7f7569c5f9a9 100644
...
index f0f4897b3c3c..673c03646696 100644
...
index 0cc57681dc4d..b35ab251f543 100644

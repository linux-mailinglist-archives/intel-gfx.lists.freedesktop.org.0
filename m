...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28E1B756AAE
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jul 2023 19:33:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 69DF010E294;
...
Subject: Re: [Intel-gfx] [PATCH v3 1/5] drm/i915/gt: Cleanup aux

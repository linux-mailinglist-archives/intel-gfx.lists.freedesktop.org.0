...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEC6D26A6CB
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 16:07:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0313A8920E;
...
Subject: Re: [Intel-gfx] [PATCH v8 4/8] drm/i915: Do not call

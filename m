...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B7C63304BB3
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Jan 2021 22:45:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 073236E4D0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 6/9] drmcg: Add memory.total file

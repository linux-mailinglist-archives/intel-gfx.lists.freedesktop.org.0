...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wEBCHMYboGmzfgQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Feb 2026 11:09:10 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 021831A4078
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Feb 2026 11:09:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 828A010E8CF;
	Thu, 26 Feb 2026 10:09:08 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="fB+KBcag";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AB99510E8CD;
 Thu, 26 Feb 2026 10:09:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1772100547; x=1803636547;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=YCYGbfwWG5MSDBBry9z02BVg1Bh9gsLwVSYAwGsa2ow=;
 b=fB+KBcagdEEVqvPTnRjLvGIBu5GAIQbMWknvqSc8DDB92CK/NtgQNT1Z
 6NUnK4LQL9TerZ757iXy3eRQ7jc+vLmIb3Pw7pG+8gvH0k47PvYn5kbUN
 DVP83GdNE3Q/RhufqOh+OxgqEdOV+kKp1JL94PI06WD3VUwWkOkn5wfS3
 N8mGNPbsgE+ePQ52hFALSk45U7JKwgQHLaDZR5LzJLHWJBxi33yL7Pl7V
 ugK3QTpSJ7CP/ucYVLf51kXtS2TJm272yRW+DiHyO3bol0YBQdeq2cp4p
 WlipUZn6VA5B38TZKQowoxVneQvahurBKyXZh5AFAtpnQ0Ebfdf+gC+Vm g==;
X-CSE-ConnectionGUID: +BpQvBElT+6cmKPNa/joKQ==
X-CSE-MsgGUID: +UE4uD1wScacXIk/uoywpg==
X-IronPort-AV: E=McAfee;i="6800,10657,11712"; a="90738903"
X-IronPort-AV: E=Sophos;i="6.21,312,1763452800"; d="scan'208";a="90738903"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Feb 2026 02:09:07 -0800
X-CSE-ConnectionGUID: SiEgL49TRIyxuMoqH1qlaA==
X-CSE-MsgGUID: 29BJImMVQ+2ZDCMyczuJsw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,312,1763452800"; d="scan'208";a="247057866"
Received: from egrumbac-mobl6.ger.corp.intel.com (HELO localhost)
 ([10.245.244.224])
 by orviesa002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Feb 2026 02:09:05 -0800
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: intel-xe@lists.freedesktop.org,
	Jani Nikula <jani.nikula@intel.com>
Subject: [PATCH v2 19/19] drm/i915/overlay: Convert overlay to parent interface
Date: Thu, 26 Feb 2026 12:07:38 +0200
Message-ID: <20260226100738.29997-20-ville.syrjala@linux.intel.com>

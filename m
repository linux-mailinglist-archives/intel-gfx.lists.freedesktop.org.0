...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 245C9150956
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Feb 2020 16:14:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C2FF6EC29;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/26] drm/dp: Include the AUX CH name in the
 debug messages

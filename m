...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5BD7E310CB0
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Feb 2021 15:49:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A64996F45B;
	Fri,  5 Feb 2021 14:49:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B60D06F45B
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 Feb 2021 14:49:22 +0000 (UTC)
IronPort-SDR: z64+LN6g9sP5XF7+4Z/WPK9K4ZJy4D8C4E+VFg/n8eWdxYYWrUElxqFNxOtMIhF0LMAFOiHPdo
 2DPdsWMLKiTg==
X-IronPort-AV: E=McAfee;i="6000,8403,9885"; a="181588271"
X-IronPort-AV: E=Sophos;i="5.81,155,1610438400"; d="scan'208";a="181588271"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Feb 2021 06:49:21 -0800
IronPort-SDR: f+X1wMwd0OJdzyi1epneZg/CTIW9JmS0jopstgEnvnSff62Q5vMbvhzWytWLtDj0Li+hiX1782
 q6v+ywiAIjVQ==
X-IronPort-AV: E=Sophos;i="5.81,155,1610438400"; d="scan'208";a="373415553"
Received: from fuhrberg-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.33.102])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Feb 2021 06:49:17 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  5 Feb 2021 16:48:40 +0200
Message-Id: <7fa8c76b0f07f3ede9efd7c1f989f33fbc8c53a3.1612536383.git.jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <cover.1612536383.git.jani.nikula@intel.com>
References: <cover.1612536383.git.jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 5/8] drm/i915: migrate pll enable/disable
...
L2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGlzcGxheS5jCmluZGV4IGFjNjUy
MjgzYWJmZS4uYWM4Zjg5ODQ5NTEwIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9k
...
ZGlzcGxheS5oCmluZGV4IDJiYmQyZWU5MTQ3ZS4uYzgwZTVhMzM1NmVmIDEwMDY0NAotLS0gYS9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuaAorKysgYi9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuaApAQCAtNTk0LDkgKzU5NCw2IEBA
...
Z3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZHAuYwppbmRleCA5Njc4OWZiZDRjMDYuLjRmODll
MGRlNWRkZSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9k

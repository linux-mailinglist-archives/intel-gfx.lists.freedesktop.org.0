...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 178CD60705
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Jul 2019 15:59:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4D526E4C9;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 AY1A==
Subject: Re: [Intel-gfx] [PATCH v7 10/11] drm/hdcp: update content
...
Content-Type: multipart/mixed; boundary="===============1666152042=="

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C436445E66
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Nov 2021 04:05:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A4BF6E84D;
	Fri,  5 Nov 2021 03:05:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qv1-xf2a.google.com (mail-qv1-xf2a.google.com
 [IPv6:2607:f8b0:4864:20::f2a])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D25766E84D
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 Nov 2021 03:05:48 +0000 (UTC)
Received: by mail-qv1-xf2a.google.com with SMTP id u16so6618861qvk.4
 for <intel-gfx@lists.freedesktop.org>; Thu, 04 Nov 2021 20:05:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=zmFoQ5U9hW/gImBZ5dC8qQ06Hi9CQ0elrHq2vaB8wPY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=zmFoQ5U9hW/gImBZ5dC8qQ06Hi9CQ0elrHq2vaB8wPY=;
 b=
X-Gm-Message-State: AOAM532se85Q6jF41D/PCSm77N6+WiSLBzPRcFxJTgXM/keItuQfS74t
 f9pmYY9synP2siFwn/jT8CMyaA==
X-Google-Smtp-Source: ABdhPJzQbiSbAZMoM6wPsGbUmZ7XnXTVlyoycqrsf+D1krPcix5assU/qy0pbyT6R7SnIJYcUJwl5w==
X-Received: by 2002:a05:6214:529e:: with SMTP id
 kj30mr1441274qvb.50.1636081547857; 
 Thu, 04 Nov 2021 20:05:47 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id m7sm698145qkn.93.2021.11.04.20.05.47
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 04 Nov 2021 20:05:47 -0700 (PDT)
From: Sean Paul <sean@poorly.run>
To: dri-devel@lists.freedesktop.org, intel-gfx@lists.freedesktop.org,
 freedreno@lists.freedesktop.org
Date: Thu,  4 Nov 2021 23:04:31 -0400
Message-Id: <20211105030434.2828845-15-sean@poorly.run>
X-Mailer: git-send-email 2.33.1
In-Reply-To: <20211105030434.2828845-1-sean@poorly.run>
References: <20211105030434.2828845-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v4 14/14] drm/msm: Implement HDCP 1.x using the
 new drm HDCP helpers

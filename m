...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BEBC46FFE01
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 02:32:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 45EDD10E05C;
	Fri, 12 May 2023 00:32:45 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v11 0/8] drm/i915/pxp: Add MTL PXP Support

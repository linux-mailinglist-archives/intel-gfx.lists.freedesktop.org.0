...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 393DD5460BD
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 11:03:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B72C12B1D1;
	Fri, 10 Jun 2022 09:03:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 92F9512B168;
 Fri, 10 Jun 2022 09:03:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654851797; x=1686387797;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=ErvOZ0dByXBFwoA+CRWZxGeWAhuVQmCu9tbFLhiFzlo=;
 b=BlZ5muLx4KxhlzZWNowQE/L6stMSWfRfMn7zb+LOAmU0QKa4Qx/KJMrw
 pmrFrLQy+MNsbXpAM0KpmPUCdZbw70BlrQ27D87Yu1pufF5c+nai32lev
 5wM5+y8MLmM1ykR0PQAh/MjmjWPtnze36pJb3CrkWWm5aaPHrLJCtqbzB
 7d7eCYFDUH3zwkpTC61Oh0+kpOr+/EtOPbC/wX32k0tzoybRMO1+QNJ5x
 LABjVpNlNg408FOABv7zT+mKyPL9xUI+uTXxORwh4YYwGjleOrbxuXraA
 yWU4RsMrA9HXqVqm7qauY9UXcWzRpdJYlbEik6+lKRK+WT12giqfV+pmS w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10373"; a="363896775"
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="363896775"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 02:03:17 -0700
X-IronPort-AV: E=Sophos;i="5.91,288,1647327600"; d="scan'208";a="908815162"
Received: from jons-linux-dev-box.fm.intel.com (HELO jons-linux-dev-box)
 ([10.1.27.20])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 02:03:17 -0700
Date: Fri, 10 Jun 2022 01:56:58 -0700
From: Matthew Brost <matthew.brost@intel.com>
To: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
Message-ID: <20220610085658.GB20978@jons-linux-dev-box>

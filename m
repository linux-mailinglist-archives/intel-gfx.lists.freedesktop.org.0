...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA76B44AEBD
	for <lists+intel-gfx@lfdr.de>; Tue,  9 Nov 2021 14:29:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4FB166E8AA;
...
Subject: [Intel-gfx] [PATCH 2/3] i915/gvt: save the initial HW state
 snapshot in i915.

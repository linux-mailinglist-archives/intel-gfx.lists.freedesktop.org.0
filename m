...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id cIGwOiWjCmop4gQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 18 May 2026 07:27:01 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6831856628C
	for <lists+intel-gfx@lfdr.de>; Mon, 18 May 2026 07:27:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2AB210E677;
	Mon, 18 May 2026 05:26:59 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="i4ssnv+4";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 572CE10E5A4;
 Mon, 18 May 2026 05:26:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1779082018; x=1810618018;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=JuZrmx0OfG84mmFRedaM36a/dchID4NZU0IGSEgjvFc=;
 b=i4ssnv+4OPnb/cRqS73Q6QfJXbu2fFpIcHmPJJSC6+ruZvKSJ5b3lWd0
 xCl1lxIFFrfKiFOFjssW9zXX9FHRPjAfLPLj7Dw3OSKEcmAHkP4EqqwfV
 ZRDiSJqwppzZoq3IBgP1048WjFcJh48b9yZCmQF/2dVrnPxz2LT986QWN
 YllNKHIzRGyTGWVdXzyO3wvTRupWFFtMtBr3BCd/8FJ5hJpYBR9QzluqE
 CdWwUTLwMFYCafaFU+9aGkArlQf3LXMvLFC77SFiVnlTwX4vnYP1/PWzC
 L9YfuCP5y2pKnxA6ky1P00U+/Rjv9XpJ5Docl6dxuL7hR7BvvvFRqsWei w==;
X-CSE-ConnectionGUID: ojM7C6i+ROyYjkMROgBoDA==
X-CSE-MsgGUID: ZtazaPtNSkW0oXZeMvGNGw==
X-IronPort-AV: E=McAfee;i="6800,10657,11789"; a="79064931"
X-IronPort-AV: E=Sophos;i="6.23,241,1770624000"; d="scan'208";a="79064931"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 May 2026 22:26:58 -0700
X-CSE-ConnectionGUID: k9ia/bB2Q1WGEPr1OeCfQQ==
X-CSE-MsgGUID: YXquFQPtQ3m6qsjtXXb96A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,241,1770624000"; d="scan'208";a="243606203"
Received: from srr4-3-linux-103-aknautiy.iind.intel.com ([10.223.34.160])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 May 2026 22:26:56 -0700
...
Subject: [PATCH 07/12] drm/i915/dp: Set relevant Downspread Ctrl DPCD bits for
 PR + Auxless ALPM
Date: Mon, 18 May 2026 10:42:10 +0530
Message-ID: <20260518051216.2936634-8-ankit.k.nautiyal@intel.com>

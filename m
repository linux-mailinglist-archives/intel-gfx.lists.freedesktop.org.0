...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E3D663C81B1
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Jul 2021 11:35:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E51D66E1EC;
	Wed, 14 Jul 2021 09:35:28 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 08/18] drm/v3d: Move drm_sched_job_init
 to v3d_job_init
...
Content-Type: multipart/mixed; boundary="===============0085998354=="

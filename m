...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 925AB34D167
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Mar 2021 15:38:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC3EE6E426;
	Mon, 29 Mar 2021 13:37:59 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 5/8] drm/edid: use the new displayid iterator
 for finding CEA extension

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E7E547C45E6
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Oct 2023 02:13:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B1BC10E406;
	Wed, 11 Oct 2023 00:13:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C6F8910E407
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=7YkWu73Yq+KnicSEzMQoRDb+p4ZS6yno/ARYKUa3/yk=;
 b=ROcEfMn8y3eaYo9wfVwwZdLrNi6sC400f9jt73g8T8Ums90MkejFl+K5
 T0toxW7fLOW7bjAMaVTzJuwT+QQlWw+NBpSCnW+rSu1oj++hdSX3SSLom
 5AUw2x0uo8ujIh9iTvJf9wnix6lOn0MiBaXgk4LVfDz5za6iEHazbRPe/
 5pwckjnJVhI9u1p0GcO7S0/j6lRzxYA+AYv6xpCXoBPR4kpaaF0qZNdc7
 50ccOo1SOSpB1afihUTHPFPtHPTrMEviPuX7AQWRu5aB8gd8S3xv6Hue5
 uf6MkrZ4EmLRVhnkPe1BfNHjIFjNTgcAII1NK11462fB2x4AztL2od5Jp w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="363903220"
X-IronPort-AV: E=Sophos;i="6.03,214,1694761200"; d="scan'208";a="363903220"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 17:13:31 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="753626313"
X-IronPort-AV: E=Sophos;i="6.03,214,1694761200"; d="scan'208";a="753626313"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 17:13:30 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Oct 2023 17:02:44 -0700
Message-Id: <20231011000248.2181018-4-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 3/7] drm/i915: Define and use GuC and CTB

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 77B963E48DF
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Aug 2021 17:31:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4801E895C3;
	Mon,  9 Aug 2021 15:31:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x431.google.com (mail-wr1-x431.google.com
 [IPv6:2a00:1450:4864:20::431])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E36B6895E7
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Aug 2021 15:31:42 +0000 (UTC)
Received: by mail-wr1-x431.google.com with SMTP id i4so4552196wru.0
 for <intel-gfx@lists.freedesktop.org>; Mon, 09 Aug 2021 08:31:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=ra5YP8H2PRyfcr9uqebXON/mYTQQRujW5x9kEgvlMn0=;
 b=cr/NMN7086A3NQlHR8+qShfPQOfhe4eEFzPNVFYdj9aCQrD3vyIO9a3ZT6ea3f9j3l
 49yAfJ72YG3JqbSi1384NlAEj/FX9dV2WwC3HxBPi/b0w08eElP2n2nNyhYCi4wXos8S
 gRXbED5ML4y9S9lOch3Yw+42JbubksPpJak7s=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=ra5YP8H2PRyfcr9uqebXON/mYTQQRujW5x9kEgvlMn0=;
 b=
X-Gm-Message-State: AOAM532zbDobeAziPw/c89+GsevLDr97S5xNHj0S9MjRDZR58gxxAbgL
 dyCAIkDtoiOXn6+1GRL3qXOeSg==
X-Google-Smtp-Source: ABdhPJx09jKsiiKWeM06rjsD2K7Ym77oL5yYIXGi7ogVxMWt7+c7s+VGDpGqfGawktHUtvmTqOA6AA==
X-Received: by 2002:adf:e3d2:: with SMTP id k18mr25684849wrm.212.1628523101175; 
 Mon, 09 Aug 2021 08:31:41 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id j36sm20138582wms.16.2021.08.09.08.31.40
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 09 Aug 2021 08:31:40 -0700 (PDT)
Date: Mon, 9 Aug 2021 17:31:38 +0200
From: Daniel Vetter <daniel@ffwll.ch>
To: Matthew Brost <matthew.brost@intel.com>
Cc: intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org
Message-ID: <YRFKWv6h3FWwEcAH@phenom.ffwll.local>
References: <20210803222943.27686-1-matthew.brost@intel.com>
 <20210803222943.27686-20-matthew.brost@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20210803222943.27686-20-matthew.brost@intel.com>

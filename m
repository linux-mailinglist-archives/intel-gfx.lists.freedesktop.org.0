...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E3A0914FE1D
	for <lists+intel-gfx@lfdr.de>; Sun,  2 Feb 2020 16:50:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB29C6EAEC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 14/18] drm/i915: Add state readout for DP VSC
 SDP

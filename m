...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0269128AA4
	for <lists+intel-gfx@lfdr.de>; Sat, 21 Dec 2019 18:31:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC1206E48E;
	Sat, 21 Dec 2019 17:31:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0267F6E110
 for <intel-gfx@lists.freedesktop.org>; Sat, 21 Dec 2019 17:31:20 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19657534-1500050 
 for <intel-gfx@lists.freedesktop.org>; Sat, 21 Dec 2019 17:31:14 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sat, 21 Dec 2019 17:31:11 +0000
Message-Id: <20191221173113.1153688-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 2/4] drm/i915/gt: Pull GT initialisation under
 intel_gt_init()
...
---
 ...
 drivers/gpu/drm/i915/gt/intel_gt.c            | 255 +++++++++++++++++-
 ...
 16 files changed, 349 insertions(+), 346 deletions(-)
...
index b21c20ee9e23..6fa49d3f7fa7 100644
...
index 0c4c07072473..ee0eebe9a9d3 100644
...
index af4f8c810009..eea9e753500c 100644
...
+#include "intel_renderstate.h"
 ...
 #include "intel_pm.h"
@@ -372,32 +374,274 @@ static struct i915_address_space *kernel_vm(struct intel_gt *gt)
...
@@ -423,4 +667,5 @@ void intel_gt_driver_late_release(struct intel_gt *gt)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 792341369C2
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADA566E9E0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/23] drm: Evaluate struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F9C36406D9
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Dec 2022 13:30:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 96E7E10E18B;
	Fri,  2 Dec 2022 12:30:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7018E10E188
 for <intel-gfx@lists.freedesktop.org>; Fri,  2 Dec 2022 12:30:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669984229; x=1701520229;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=C3TneCwm7mR+l93sj8QjCTjqXXgO2AsvmUePhfNUGX8=;
 b=gmxtj9e0o9BetuVH57A1KwcZPBM4E+h1ryKiHzZ0wi//X6ZqKFlfoBy+
 sBNFTahESQLFxXNa89EJE+QQTV2hjLkKknorr1o5UWBbH2Zlp7ZJiWc4d
 S0u9dPKTG7L56keatOaLLBSU0xr6gW+mxyVjrhuE4hcLml1QpbexztE4o
 7eN735XeJfJ/+VASpOOnXlWfhfrdxhheB5j23fLdQtA82a+9KvGfKoTjs
 VaY3ajSSVFwzwvxhocTjHixSL8c81WIzkxfyjxLoru96bhN7WusXgxDUj
 f0S9q4BzF4de9vKp0AkQXDRlOkWGagVYDS3jga+9RXFdK9t1MF9j8k1+t g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10548"; a="402223818"
X-IronPort-AV: E=Sophos;i="5.96,212,1665471600"; d="scan'208";a="402223818"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Dec 2022 04:30:29 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10548"; a="733797925"
X-IronPort-AV: E=Sophos;i="5.96,212,1665471600"; d="scan'208";a="733797925"
...
Date: Fri,  2 Dec 2022 12:28:44 +0000
Message-Id: <20221202122844.428006-3-matthew.auld@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 3/3] drm/i915/selftests: exercise emit_pte()
...
index b783f6f740c8..e08a739b7091 100644

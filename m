...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36AAE48DCFE
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jan 2022 18:36:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9FFD10E2C6;
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/i915/guc: Remove hacks for reset
 and schedule disable G2H being received out of order

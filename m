...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 38AEB8B576B
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Apr 2024 14:08:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA7BE10F538;
	Mon, 29 Apr 2024 12:08:21 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RbEVyaJV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A0B0010F3E4
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Apr 2024 12:08:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1714392498; x=1745928498;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=wjFS1+NbG2Vvr7sQVgcyDtGvUeFHdIugMx1Q11+bLFs=;
 b=RbEVyaJV/oTa1a5AXMBoxNAsavOD2AnsybR/nVnxmwQNxgj75MwmoyxA
 Wfh8LalZQgw8ZcAwvTbjX5QGB/4FgdUOitKyv693JiySJb3jvpyYZMo/G
 uBOpQcXXxJr0D573KvA9pdo6k8DB8Wj1E2D4R2OI0/Ngf734DEgkqJwtu
 Nw8sLdm6wT517Q9KLHXKwqMbVPf8BjTbjB0bSZ2Zrga+mVPs0qfd/1n1H
 1SGEBe3ekcPdPXiCKsqxEdDMR5yTtd4IB7P98OwVVeS2i3JVUYjgPPRWo
 rDBqqdBC51nucL4v3vXgjRO3VyB7frowRvcCAdtOFcSLTcU27twOEGPKE w==;
X-CSE-ConnectionGUID: fY6I1zBaTfmnZ6BpyjzmfQ==
X-CSE-MsgGUID: Gy9bLPkTRPqMFtMdd2gwLw==
X-IronPort-AV: E=McAfee;i="6600,9927,11057"; a="21455442"
X-IronPort-AV: E=Sophos;i="6.07,239,1708416000"; d="scan'208";a="21455442"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Apr 2024 05:08:18 -0700
X-CSE-ConnectionGUID: LD7HADprRH2Ui3JQGi0cCg==
X-CSE-MsgGUID: A5q3232CQ6uzBD7sSFGchg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,239,1708416000"; d="scan'208";a="26074435"
...
Subject: [PATCH v8 03/11] drm/i915/psr: Rename psr2_enabled as
 sel_update_enabled
Date: Mon, 29 Apr 2024 15:07:47 +0300
Message-Id: <20240429120755.3990652-4-jouni.hogander@intel.com>

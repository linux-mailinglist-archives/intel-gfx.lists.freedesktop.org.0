...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C060D501AF3
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Apr 2022 20:19:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86C4510EB63;
...
Subject: [Intel-gfx] [PATCH v2 0/1] Drop wbinvd_on_all_cpus usage

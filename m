...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C7C0ABBDE0
	for <lists+intel-gfx@lfdr.de>; Mon, 19 May 2025 14:32:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 52C4C10E3B6;
	Mon, 19 May 2025 12:32:10 +0000 (UTC)

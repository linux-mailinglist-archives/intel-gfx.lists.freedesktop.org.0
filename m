...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AFC411B6328
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Apr 2020 20:20:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B8F9F6E962;
	Thu, 23 Apr 2020 18:20:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 25CB06E962
 for <intel-gfx@lists.freedesktop.org>; Thu, 23 Apr 2020 18:20:03 +0000 (UTC)
IronPort-SDR: 0/Yvm6GqvHBtI9jPnJWxrNiG2rvCHIUKMLs5052MRCshnlrqWvnjLJMruueSupumU1dXWFGuGc
 qaO54dczY95Q==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2020 11:20:01 -0700
IronPort-SDR: Rbx5FIoaXUg8LqpcEWU2RvqcLCP6FR8IYx6wvP23fSKAR2a0kkw+xQm8H6CkEC74ZhljasW1gw
 h1kpzYMNCw3g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,307,1583222400"; d="scan'208";a="256071333"
Received: from ideak-desk.fi.intel.com ([10.237.72.183])
 by orsmga003.jf.intel.com with ESMTP; 23 Apr 2020 11:20:00 -0700
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 23 Apr 2020 21:19:37 +0300
Message-Id: <20200423181937.25176-1-imre.deak@intel.com>
X-Mailer: git-send-email 2.23.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/icl+: Prevent using non-TypeC AUX

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34AC5BDBA5
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Sep 2019 12:01:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 351C86EB6F;
	Wed, 25 Sep 2019 10:01:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3209B6EB66
 for <intel-gfx@lists.freedesktop.org>; Wed, 25 Sep 2019 10:01:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18609387-1500050 
 for multiple; Wed, 25 Sep 2019 11:01:48 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 25 Sep 2019 11:01:36 +0100
Message-Id: <20190925100137.17956-27-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 26/27] drm/i915/selftests: Drop vestigal
 struct_mutex guards
...

...
CiAJaWYgKElTX0VSUihwcGd0dCkpIHsKIAkJZXJyID0gUFRSX0VSUihwcGd0dCk7CkBAIC0xNjU5
LDkgKzE2NTgsNyBAQCBpbnQgaTkxNV9nZW1faHVnZV9wYWdlX21vY2tfc2VsZnRlc3RzKHZvaWQp
...
cm0pOwotCiAJcmV0dXJuIGVycjsKIH0KIApAQCAtMTY3Nyw3ICsxNjc0LDYgQEAgaW50IGk5MTVf
...
U19QUEdUVChpOTE1KSkgewpAQCAtMTY5MiwxMyArMTY4OCwxMCBAQCBpbnQgaTkxNV9nZW1faHVn
...
dHgtPnZtKSkKQEAgLTE3MDYsMTEgKzE2OTksNyBAQCBpbnQgaTkxNV9nZW1faHVnZV9wYWdlX2xp
...

...
bmRleCBlMzNjMmY2NmM2ODMuLjg5YWZmYzk1OGQwMSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv
...
IC05NjYsOSArOTE3LDYgQEAgc3RhdGljIGludCBsaXZlX3N1cHByZXNzX3NlbGZfcHJlZW1wdCh2
...
dHJ1Y3RfbXV0ZXgpOwogCXJldHVybiBlcnI7CiAKIGVycl93ZWRnZWQ6CkBAIC0xMDM4LDcgKzk4
...
YWtlcmVmOwogCWludCBlcnIgPSAtRU5PTUVNOwogCWludCBpOwogCkBAIC0xMDUxLDExICs5OTgs
...
bGllbnRfaW5pdChpOTE1LCAmY2xpZW50WzJdKSkgLyogaGVhZCBvZiBxdWV1ZSAqLwpAQCAtMTE0
MSw5ICsxMDg1LDYgQEAgc3RhdGljIGludCBsaXZlX3N1cHByZXNzX3dhaXRfcHJlZW1wdCh2b2lk
...
QCAtMTE2MCw3ICsxMTAxLDYgQEAgc3RhdGljIGludCBsaXZlX2NoYWluX3ByZWVtcHQodm9pZCAq
...
dCB3YWtlcmVmOwogCWludCBlcnIgPSAtRU5PTUVNOwogCiAJLyoKQEAgLTExNzIsMTEgKzExMTIs
...
Mjg3LDkgKzEyMjQsNiBAQCBzdGF0aWMgaW50IGxpdmVfY2hhaW5fcHJlZW1wdCh2b2lkICphcmcp
...
bXV0ZXgpOwogCXJldHVybiBlcnI7CiAKIGVycl93ZWRnZWQ6CkBAIC0xMzA3LDcgKzEyNDEsNiBA
...
OTE1KSkKQEAgLTEzMTYsMTEgKzEyNDksOCBAQCBzdGF0aWMgaW50IGxpdmVfcHJlZW1wdF9oYW5n
...
dCkpCiAJCWdvdG8gZXJyX3NwaW5faGk7CkBAIC0xNDEyLDkgKzEzNDIsNiBAQCBzdGF0aWMgaW50
...
CkBAIC0xNTA0LDExICsxNDMxLDkgQEAgc3RhdGljIGludCBzbW9rZV9jcmVzY2VuZG9fdGhyZWFk
...
CXJldHVybiBlcnI7CiAKQEAgLTE1MjksOCArMTQ1NCw2IEBAIHN0YXRpYyBpbnQgc21va2VfY3Jl
...
ZSA9IGVuZ2luZTsKQEAgLTE1NjMsOCArMTQ4Niw2IEBAIHN0YXRpYyBpbnQgc21va2VfY3Jlc2Nl
...
ZS0+bmNvbnRleHQpOwpAQCAtMTYwNyw3ICsxNTI4LDYgQEAgc3RhdGljIGludCBsaXZlX3ByZWVt
...
KmNzOwpAQCAtMTYyMiwxMyArMTU0MiwxMCBAQCBzdGF0aWMgaW50IGxpdmVfcHJlZW1wdF9zbW9r
...
IC0xNjc1LDkgKzE1OTIsNyBAQCBzdGF0aWMgaW50IGxpdmVfcHJlZW1wdF9zbW9rZSh2b2lkICph
...
MTgxNSwxOSArMTczMCwxNyBAQCBzdGF0aWMgaW50IGxpdmVfdmlydHVhbF9lbmdpbmUodm9pZCAq
...
ODQ4LDE3ICsxNzYxLDE1IEBAIHN0YXRpYyBpbnQgbGl2ZV92aXJ0dWFsX2VuZ2luZSh2b2lkICph
...
LApAQCAtMTkzNyw5ICsxODQ4LDYgQEAgc3RhdGljIGludCBtYXNrX3ZpcnR1YWxfZW5naW5lKHN0
...
dGVzdChpOTE1KSkKIAkJZXJyID0gLUVJTzsKQEAgLTE5NjIsMTMgKzE4NzAsMTEgQEAgc3RhdGlj
...
IGludCBuc2libGluZzsKIApAQCAtMTk4NCwxMiArMTg5MCwxMCBAQCBzdGF0aWMgaW50IGxpdmVf
...
QEAgLTIxNDAsMTMgKzIwNDQsMTEgQEAgc3RhdGljIGludCBsaXZlX3ZpcnR1YWxfYm9uZCh2b2lk
...
aW5nOwpAQCAtMjE2OSwxNCArMjA3MSwxMiBAQCBzdGF0aWMgaW50IGxpdmVfdmlydHVhbF9ib25k
...
cy5jCmluZGV4IGVkNDQzMzNkOWUyMC4uYTEwOTkwYjFhNzJjIDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9ndC9zZWxmdGVzdF93b3JrYXJvdW5kcy5jCisrKyBiL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2d0L3NlbGZ0ZXN0X3dvcmthcm91bmRzLmMKQEAgLTcwNCw5ICs3MDQsNyBAQCBz
...
CQllcnIgPSBQVFJfRVJSKGZpbGUpOwogCQlnb3RvIG91dF9ycG07CkBAIC03MjgsOSArNzI2LDcg
...
ZXJlZik7CiAJcmV0dXJuIGVycjsKQEAgLTEyNjQsMTQgKzEyNjAsOSBAQCBpbnQgaW50ZWxfd29y

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4338248B7FC
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Jan 2022 21:15:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C964410E88A;
...
Subject: [Intel-gfx] [PATCH v8 3/6] drm: implement top-down allocation method

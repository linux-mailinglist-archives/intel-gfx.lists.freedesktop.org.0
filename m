...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FA8770F1CE
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 11:09:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60AFD10E5C3;
	Wed, 24 May 2023 09:09:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3276710E5BF
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=C2LWsSaG/anpW81sfnV51Vpy+ZfmwV3TfK5OtnuKU0s=;
 b=esc5mzqJmoqP1XqmBB/Y8q8bwGZlEM94Javr22/BQ2mbrabgzaqAvv8q
 hJSbCxaoRcZIJqgkvs8bzG+vR2C0mbta2Ftt5JD1cHI/NSdRglze5t8Jq
 Wiul4TirF6GdwG8G/3IbUKD/uYHtA7KiGGZxkKPhTsGgU2AWcetzoALdO
 eOSM6Y+phKL1fRXRSFQ8uMATziYeshsbmmnmOdElKkgbKpR/itD2towqC
 nT/9+/eMe+BF2ZLjn9bCVoQ7XadlBd9LZzNZx7SW+j0GVwBrQsV5uQp+r
 VAHZPLlGrfFmT8qB5sPqSLSp4RW+bhvmlSsk5aUQok+FJGTs1LcOrHqir Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10719"; a="439862996"
X-IronPort-AV: E=Sophos;i="6.00,188,1681196400"; d="scan'208";a="439862996"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 02:09:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10719"; a="681821451"
X-IronPort-AV: E=Sophos;i="6.00,188,1681196400"; d="scan'208";a="681821451"
Received: from johnbyrn-mobl1.ger.corp.intel.com (HELO
 hazy.ger.corp.intel.com) ([10.249.39.102])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 02:05:44 -0700
From: Luca Coelho <luciano.coelho@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 24 May 2023 12:05:19 +0300
Message-Id: <20230524090521.596399-2-luciano.coelho@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/3] drm/i915: use pointer to i915 instead of
 rpm in wakeref

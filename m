...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EEE3427C18C
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Sep 2020 11:46:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F2C0A89C83;
	Tue, 29 Sep 2020 09:46:19 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v10 0/8] Asynchronous flip implementation
 for i915

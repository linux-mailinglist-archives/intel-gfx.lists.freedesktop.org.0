...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C080F466E4A
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Dec 2021 01:06:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9F2C6FCFB;
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915/guc: Request RP0 before loading
 firmware

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A83B5175CE
	for <lists+intel-gfx@lfdr.de>; Mon,  2 May 2022 19:31:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2930C10F010;
...
Subject: [Intel-gfx] [PATCH v3 2/7] vfio/ccw: Remove mdev from struct
 channel_program

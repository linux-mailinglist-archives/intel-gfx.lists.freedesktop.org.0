...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA6436F7147
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 19:41:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DAF810E052;
	Thu,  4 May 2023 17:41:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D995510E052
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 May 2023 17:41:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683222112; x=1714758112;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=JHMCBjmPT/pB/KGq5wc2UzdXQZC5r9ISkVB/lDisZ4M=;
 b=EV3UjXyA/yrsVcc0bUFjmXBiPHTukIhS1Q+ZQsZDIg8MR6BHtE38N27O
 wWYxh/KodtEK32GP7Rr/YvrddFx/Q5tMTElAJD5UW9BKnhK7XjRwx1KaE
 56wNj2mr74arnAvM0KTFCtuxcr3c4TovwLjhGPORe23dUU6EhUbdLbrSC
 eHIKFINLMv9C2nOcLyq52sNhDXYfgloxLj15shCd109p8hX8tpXxt46la
 DtiAl7e62BCKDDPaZClvg+LMv9AZbwc+jYdv1wIKCcF4g0h44cScjY4Us
 XhKRbSYzgx2q6JUFrgk5y4YcSBH0NgY9sX9JhLOH4xlRuUnt9bJDpE9Rb Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10700"; a="349050729"
X-IronPort-AV: E=Sophos;i="5.99,250,1677571200"; d="scan'208";a="349050729"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 May 2023 10:41:52 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10700"; a="762029456"
X-IronPort-AV: E=Sophos;i="5.99,250,1677571200"; d="scan'208";a="762029456"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.70])
 by fmsmga008.fm.intel.com with SMTP; 04 May 2023 10:41:49 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 04 May 2023 20:41:49 +0300
Date: Thu, 4 May 2023 20:41:49 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <ZFPuXX5CvMEaye6e@intel.com>

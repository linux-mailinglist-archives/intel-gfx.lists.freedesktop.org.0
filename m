...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BCDBC11B89C
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Dec 2019 17:23:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 061B16EB82;
	Wed, 11 Dec 2019 16:23:47 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH][next] drm/i915/display: remove duplicated

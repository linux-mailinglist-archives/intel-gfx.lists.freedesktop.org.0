...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EDB6E18A988
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Mar 2020 00:59:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3842D6E99F;
	Wed, 18 Mar 2020 23:59:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F09806E94A
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Mar 2020 23:58:50 +0000 (UTC)
IronPort-SDR: 9sSE5eNRrNIvliOQnXpJfJJwOSRanx8vHPzDaFJTDzECOkH20dzmebc1d9kO5zlLPkTG74OBOz
 Vufbbs/i5LXw==
...
IronPort-SDR: VHzQspODRuiarzIpRJqmeWuef1upMWTJQ8+wlS7p2yGV0LVAyMC4FmD/Ie3jtAj7ImdFaclPVg
 ztX41Vj0BRJw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,569,1574150400"; d="scan'208";a="324346282"
Received: from josouza-mobl2.jf.intel.com (HELO josouza-MOBL2.intel.com)
 ([10.24.15.8])
 by orsmga001.jf.intel.com with ESMTP; 18 Mar 2020 16:58:49 -0700
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 18 Mar 2020 16:59:54 -0700
Message-Id: <20200318235956.118409-4-jose.souza@intel.com>
X-Mailer: git-send-email 2.25.2
In-Reply-To: <20200318235956.118409-1-jose.souza@intel.com>
References: <20200318235956.118409-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/6] drm/i915/display: Add
...
ZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKaW5kZXggOGYyM2M0ZDUxYzMzLi4xNTFl
NDllZTYxNjEgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxf
...
Y3J0Y19hcm1fZmlmb191bmRlcnJ1bihzdHJ1Y3QgaW50ZWxfY3J0YyAqY3J0YywKLS0gCjIuMjUu

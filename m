...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E52EF577B53
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:39:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18635A9CDF;
...
Subject: [Intel-gfx] [PATCH v3 13/41] kernel/module: add __dyndbg_classes
 section

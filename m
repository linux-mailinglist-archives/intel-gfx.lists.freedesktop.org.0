...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 05A4F2A3798
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Nov 2020 01:17:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 982206E5B0;
	Tue,  3 Nov 2020 00:17:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D3C076E563
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Nov 2020 00:17:34 +0000 (UTC)
IronPort-SDR: rPp94XN6+7IsHVXxuMkmW8fMykCTOkGpX+QXqZqHjWiZX+o8mHdKfv9QudtpgDhKGl7eep78kP
 cGb4kwQC3UWA==
X-IronPort-AV: E=McAfee;i="6000,8403,9793"; a="155962133"
X-IronPort-AV: E=Sophos;i="5.77,446,1596524400"; d="scan'208";a="155962133"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Nov 2020 16:17:33 -0800
IronPort-SDR: m1Xk/0S9HkTjfcrHeGEDX8nFVKXRyPwq+HH6iDzudYzUoAGP17ladkQx1xAzBt0XxWB8jeJmbh
 UDL8aU4mOHWQ==
X-IronPort-AV: E=Sophos;i="5.77,446,1596524400"; d="scan'208";a="470573468"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 02 Nov 2020 16:17:32 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  2 Nov 2020 16:19:28 -0800
Message-Id: <20201103001932.11286-10-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v14 09/13] drm/i915/dp: Master/Slave
...
index 93a367d915e8..d37b3ee0939a 100644
...
+
 	...
 	if (psl_clkgate_wa) {
@@ -15704,6 +15753,9 @@ static void intel_enable_crtc(struct intel_atomic_state *state,
...
@@ -15766,8 +15818,21 @@ static void intel_old_crtc_state_disables(struct intel_atomic_state *state,
 {
...
@@ -15796,7 +15861,7 @@ static void intel_commit_modeset_disables(struct intel_atomic_state *state)

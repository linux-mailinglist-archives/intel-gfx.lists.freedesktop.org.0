...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E7965A4CE8
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:04:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA26D10F1C6;
...
Subject: [Intel-gfx] [PATCH v3 6/9] dma-buf: Move dma-buf attachment to

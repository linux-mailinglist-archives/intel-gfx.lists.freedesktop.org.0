...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C929A9C422
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Apr 2025 11:50:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8011A10E8FA;
	Fri, 25 Apr 2025 09:50:29 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="XjDA7y3q";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AC44C10E8F8
 for <intel-gfx@lists.freedesktop.org>; Fri, 25 Apr 2025 09:50:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1745574626;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=EbypdOKYVBO2i2DAQkV7KvVJRvn0St3K5ELKslBqBe8=;
 b=XjDA7y3qijXVbwnbDVTWPGQsxWOVipjnEV88ozzhMTk2oFBYJMmhwMBG7rIDb2800S4kTF
 9o4u8yvlEDSz9Gbhj1V1ECJyTWPH+MqaVu2HOpncc2pDAoXtb6fXIkoicd7EqFKDD6wLyd
 lqWABCdG7mJSUv0TI6ZwDtqDRi54INw=
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-652-l-wq1SowP2aSYBw2rXWqrw-1; Fri,
 25 Apr 2025 05:50:23 -0400
X-MC-Unique: l-wq1SowP2aSYBw2rXWqrw-1
X-Mimecast-MFC-AGG-ID: l-wq1SowP2aSYBw2rXWqrw_1745574621
Received: from mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 18E931800874; Fri, 25 Apr 2025 09:50:21 +0000 (UTC)
Received: from hydra.redhat.com (unknown [10.44.34.172])
 by mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id C6AC4195608D; Fri, 25 Apr 2025 09:50:16 +0000 (UTC)
...
Subject: [PATCH v7 1/8] drm/i915/fbdev: Add intel_fbdev_get_map()
Date: Fri, 25 Apr 2025 11:37:47 +0200
Message-ID: <20250425094949.473060-2-jfalempe@redhat.com>

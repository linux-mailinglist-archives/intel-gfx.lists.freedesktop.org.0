...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F8FE4E7358
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Mar 2022 13:25:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1E9510E238;
	Fri, 25 Mar 2022 12:25:44 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 1/9] drm/edid: don't modify EDID while parsing

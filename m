...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DA60686622
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Feb 2023 13:43:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3852B10E402;
	Wed,  1 Feb 2023 12:42:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1388D10E402;
 Wed,  1 Feb 2023 12:42:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675255376; x=1706791376;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=lf+2pXSq6CCdMWj17wZPH9hZ1TZAinWyzd8+y+fd4ZA=;
 b=KdUh3588Wk2rwqwxkQSuWwT+aJW8Qne6a4PI7zQe73TSn7CtDhxWsuts
 4EdxEuAqopzuOds6YtrEbS+YvduFPLeRfDd6WS6uUtIv+SqcJz3iVo5hQ
 lVegt+T3RFXZ8HfH19M7zgfcZPCZ6RdyLOEWUswckOXwMTB0yyellAymc
 jiIAwOGBvvUGfZRDs8b7MO74V5vIu0KJoxNgU6cAVd0YjApfJjQg5rrmD
 b+8GfBCeP+WPH+keC6z8wssY3cPClJznRczINbONDYeO3d13rvDzXia/V
 Q5RvlkkzMQDz9bfDUmGHwknXDgu6N78tZYniPQo2Q2WrgScVZXiLgdB5O A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10607"; a="390518563"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="390518563"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 04:42:54 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10607"; a="773421108"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="773421108"
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230025)(136003)(346002)(39850400004)(366004)(396003)(376002)(451199018)(41300700001)(478600001)(186003)(9686003)(38070700005)(86362001)(26005)(6506007)(66476007)(4326008)(66946007)(66446008)(66556008)(64756008)(76116006)(8676002)(316002)(8936002)(7416002)(54906003)(5660300002)(110136005)(71200400001)(33656002)(2906002)(52536014)(7696005)(55016003)(38100700002)(83380400001)(82960400001)(122000001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 01 Feb 2023 12:42:45.4642 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E82B84D8A6D
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Mar 2022 18:07:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6893510E709;
...
Subject: [Intel-gfx] [PATCH v9 00/13] Add GuC Error Capture Support

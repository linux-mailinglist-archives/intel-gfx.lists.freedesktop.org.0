...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3790C6F1E4A
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 20:56:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 982D610E17C;
...
Subject: [Intel-gfx] [PATCH v2 2/4] drm/i915/guc: Consolidate duplicated
 capture list code

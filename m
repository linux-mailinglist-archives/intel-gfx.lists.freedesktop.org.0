...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 700FE58EAF1
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Aug 2022 13:11:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4A0BFB1A16;
	Wed, 10 Aug 2022 11:10:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0DCAEAF8C9
 for <intel-gfx@lists.freedesktop.org>; Wed, 10 Aug 2022 11:10:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1660129844; x=1691665844;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=QDvm4nQAEPrbK7KszTJE/Yx4jh6HtrGf/KAjVxU+LhI=;
 b=KVceHTea1L7Uuv/LmID/anfbVLqyAGZAJ5axvmBaudBthNYfEgs55t8Y
 L1VtmtmqeRd4TNUR3ifiP//2qAWePzKud+mj1g3oANq3ui9X824PbhGKP
 IZrj/rphVyemZ9lWfyENpGc/PpkD9iAaqjAM6sTqirNvL4MhPt55YPYV7
 IjMrtYSMQw2/lYM7uGQLcAlIThVSsX9NWOJ4U8oziwXlXSK/mAomxt/Sm
 xYTeWPaHU+4wE+rT/GIFwMCEam4s9sIFh3MWIaxQ9sPg0mYgZwC51HaEn
 YX0dPiqjkAQJqTUT/ETPS4bwAc+A2xk/HZix92cQZU14FybeGcP93GItH A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10434"; a="291845745"
X-IronPort-AV: E=Sophos;i="5.93,227,1654585200"; d="scan'208";a="291845745"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Aug 2022 04:10:42 -0700
X-IronPort-AV: E=Sophos;i="5.93,227,1654585200"; d="scan'208";a="633738694"
Received: from iefimov-mobl1.ccr.corp.intel.com (HELO localhost)
 ([10.252.49.172])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Aug 2022 04:10:41 -0700
...
References: <20220728013420.3750388-1-radhakrishna.sripada@intel.com>
 ...
 <87a68cuzh5.fsf@intel.com>
Date: Wed, 10 Aug 2022 14:10:38 +0300
Message-ID: <877d3guzf5.fsf@intel.com>
MIME-Version: 1.0

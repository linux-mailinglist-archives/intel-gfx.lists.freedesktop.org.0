...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76F4C756330
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jul 2023 14:52:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4BF910E23A;
...
Subject: [Intel-gfx] [PATCH v3 1/5] drm/i915/gt: Cleanup aux invalidation
 registers

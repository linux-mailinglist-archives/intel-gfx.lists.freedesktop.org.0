...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A245F849039
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Feb 2024 20:59:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28FCD10E87A;
	Sun,  4 Feb 2024 19:58:59 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ENegF2oD";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9ED7710E87A
 for <intel-gfx@lists.freedesktop.org>; Sun,  4 Feb 2024 19:58:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1707076738; x=1738612738;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WoAnVrBPfkFEeKxpHZPuK1liFX9FXzdebad4asuYSAQ=;
 b=ENegF2oDIaQ/3syELPfh8aMSxicrcggHjHQf803TT+qGVEpkfaKV1wVE
 XngFhn4CaHbHMQss/zcPe6LJ/3NDpj69heRHyP/7uEDfTDHnbeKY+FEWK
 V/baSIH4LQGcSJCMCYYjuVFOjy35GD9nDWNb3nT5P5xsgwGNW8njLpKb1
 n7cAvmlil1fJAaFEGQXEgjfVsck2aYJabPvSjzBPOQS0+M7YFcO7qy+XG
 7SP9Tk/EXNIZxnTTOeHgT6AuZo89fquvIAgaJhnLgZt02b0pqF03XXQKV
 Vit7pkpA1pk0cDy4fK1KM4nh53JXwAqYCV0nLKETHQgmSEnmM6kJSYFud A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10973"; a="311181"
X-IronPort-AV: E=Sophos;i="6.05,242,1701158400"; 
   d="scan'208";a="311181"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2024 11:58:57 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,242,1701158400"; 
   d="scan'208";a="5160730"
Received: from dut-2a59.iind.intel.com ([10.190.239.113])
 by fmviesa005.fm.intel.com with ESMTP; 04 Feb 2024 11:58:55 -0800
...
Subject: [PATCH 2/5] drm/i915: Use the same vblank worker for atomic unpin
Date: Mon,  5 Feb 2024 01:22:04 +0530
Message-Id: <20240204195207.3616932-3-chaitanya.kumar.borah@intel.com>

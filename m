...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED7D0654882
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Dec 2022 23:30:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 68B0510E5BF;
...
Subject: [Intel-gfx] [RFC PATCH 18/20] drm/i915/display: Remaining changes
 to make xe compile

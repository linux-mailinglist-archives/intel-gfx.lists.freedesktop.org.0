...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 074D41BDAC1
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 13:33:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5EE9F6E45F;
	Wed, 29 Apr 2020 11:33:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0D4E96E45F
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 11:33:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21057188-1500050 
 for multiple; Wed, 29 Apr 2020 12:33:11 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 12:33:09 +0100
Message-Id: <20200429113309.13403-1-chris@chris-wilson.co.uk>
...
index 5ed323254ee1..a6e404f51bb7 100644
--- a/drivers/gpu/drm/i915/gt/selftest_workarounds.c
+++ b/drivers/gpu/drm/i915/gt/selftest_workarounds.c
@@ -1122,6 +1122,10 @@ verify_wa_lists(struct i915_gem_context *ctx, struct wa_lists *lists,
 	for_each_gem_engine(ce, i915_gem_context_engines(ctx), it) {
 		enum intel_engine_id id = ce->engine->id;
 
+		/* Check if we banned the context while resetting an engine */

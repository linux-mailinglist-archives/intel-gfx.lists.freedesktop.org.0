...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5934D2FA34A
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jan 2021 15:41:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57EE36E437;
	Mon, 18 Jan 2021 14:41:01 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 2/8] drm/amdgpu: Remove references to
...
Content-Type: multipart/mixed; boundary="===============0161685132=="

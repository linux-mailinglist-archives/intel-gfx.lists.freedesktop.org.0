...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EB48D59FB1C
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Aug 2022 15:19:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5582AB5231;
	Wed, 24 Aug 2022 13:18:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0D423B50CE
 for <intel-gfx@lists.freedesktop.org>; Wed, 24 Aug 2022 13:17:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661347040; x=1692883040;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=I/fKAR2+vxdbUYw7QSKj/YTHs8pkfmIwCUlarvqTrqc=;
 b=V7ETI4l8C79rdzDxxqUtlbitguJS1HcEFrWcru6fty668ROk0qU5ybMB
 AOkgvE540mTIcksHZjJWQ5DRDQA7453B82RTQSUJ5l2IlWjZQpEFS2NsR
 zbzFcdZ/SDA2gJ30n4fMGslN5ZL28Qw1kslTjtRCSVO4kFBsBF1Y3w86l
 TMNPJLTynRRkn6c3DZ5Apq/8mUDdUoW/WxqvwfT0iQ6FGZoGno7J1BN8u
 GD+peS5aFQ2GkwVeDZp8LzMPQc1H0G6CMf5LbCiRxuROd1LlGqOTK0Wyp
 0RGhtv5TsgLfa5v3LNiy+oh3Y3JqjKX6wqcdJ9h6+uoS5n8BukDNun/7a w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10448"; a="292706888"
X-IronPort-AV: E=Sophos;i="5.93,260,1654585200"; d="scan'208";a="292706888"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2022 06:17:17 -0700
X-IronPort-AV: E=Sophos;i="5.93,260,1654585200"; d="scan'208";a="609754359"
Received: from zlim2-mobl.gar.corp.intel.com (HELO localhost) ([10.252.52.23])
 by orsmga002-auth.jf.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Aug 2022 06:17:15 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 24 Aug 2022 16:15:41 +0300
Message-Id: <4cdb8b0152c99e3e07b3dc6ea81847e1d86e4148.1661346845.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 15/38] drm/i915: move and group hdcp under
 display.hdcp
...
index 72133893dfb1..13403ab70a3f 100644
...
@@ -191,6 +192,14 @@ struct intel_display {
...
index c5bcf036c09e..d6fe6e8a868b 100644
...
index c85119533a8d..4803e28b8aa5 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -592,12 +592,6 @@ struct drm_i915_private {

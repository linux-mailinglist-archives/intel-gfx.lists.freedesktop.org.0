...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 06F2F5B93CC
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Sep 2022 07:03:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D601510E28F;
	Thu, 15 Sep 2022 05:02:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 08A8B10E28F
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Sep 2022 05:02:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663218171; x=1694754171;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=dOVndyTdTz9uLXpsjxTOR5IRPS+/6HF2tTM1PDi9GbE=;
 b=SviR9wazsV7Xc4Ak8MVYgetZ02gDTp/DCb//Giqef3wqLNJdZAAuS2Z9
 YMSpW+hCqPdPUifG2lOC5j+z/SsFH3cfikzJZGIE0wvy5zlWYd7FSJOVJ
 GlECpxOwxnbss8PRNB61vH3pYKkYedVQ8kTRmdW5MnHlYBqTSguEdSPMy
 7HFAXTPczjw3eI6gjPq3TaV5J/wQ4VgHFKohHzbqfr7EUEWdnADd1sdG+
 Kt8kxLAJeVGx/AoCrrL9OSBaiSvj82aoczEXdpyhTmaacWp9qUa9nVVpd
 R5WVgwW/MfanBO5nu0eY9eEkPrYHvIQJ1wHJZdijUrgzV44tdKKC36lTI w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10470"; a="324872689"
X-IronPort-AV: E=Sophos;i="5.93,317,1654585200"; d="scan'208";a="324872689"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2022 22:02:41 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,317,1654585200"; d="scan'208";a="650336132"
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 15 Sep 2022 05:02:32.8709 (UTC)

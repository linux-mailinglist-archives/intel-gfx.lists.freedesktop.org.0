...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 555937B01D1
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Sep 2023 12:28:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A832310E062;
...
Subject: [Intel-gfx] [PATCH v5 2/7] drm/client: Do not acquire module
 reference

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4721182F10
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Mar 2020 12:25:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E52826E16B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/5] drm/i915/display: Add Nearest-neighbor

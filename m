...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D8322EA651
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Jan 2021 09:10:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0839A6E041;
...
Content-Type: multipart/mixed; boundary="===============1229574798=="

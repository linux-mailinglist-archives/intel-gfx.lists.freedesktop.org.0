...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 72E5A701739
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 15:28:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E95D210E0E9;
...
Subject: [Intel-gfx] [PATCH v11 13/23] vfio-iommufd: Add detach_ioas support

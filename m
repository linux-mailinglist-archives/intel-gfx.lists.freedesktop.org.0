...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D36658ADD2
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Aug 2022 18:02:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2ABC511A6CC;
	Fri,  5 Aug 2022 16:01:48 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 2/2] drm/i915: Sanitycheck PCI BARs

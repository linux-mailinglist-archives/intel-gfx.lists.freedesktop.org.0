...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8FC549AF7A
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jan 2022 10:12:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2935B10EEF4;
...
Subject: [Intel-gfx] [PATCH 3/3] drm/i915/display: Simplify helpers for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0806376889C
	for <lists+intel-gfx@lfdr.de>; Sun, 30 Jul 2023 23:58:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2874310E147;
...
Subject: [Intel-gfx] [PATCH 1/5] drm_dbg: add trailing newlines to remaining
 callsites
...
Cc: Jim Cromie <jim.cromie@gmail.com>, Edmund Dea <edmund.j.dea@intel.com>,

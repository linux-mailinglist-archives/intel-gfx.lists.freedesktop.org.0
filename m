...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CD5E704C84
	for <lists+intel-gfx@lfdr.de>; Tue, 16 May 2023 13:40:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DAEB010E21A;
	Tue, 16 May 2023 11:40:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D37BF10E21A;
 Tue, 16 May 2023 11:40:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684237232; x=1715773232;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=uIYbeXvm+a+P36e4mEuCXEzGiPfGWF5JWiAzMtztwn0=;
 b=NTNAgW4/hqIzSpEx31YMoh37jZQyRKqnmdWmgAf2XS2SJRSFgJZwxTJx
 WDkmY0xTWkkqJ8prZC64u9cp208ivzI70ipUEPAOrhqhjZ+eQspjwQD8t
 gYBXOFkQUFVP2PqdlC5MrSwrFdoaB8Ok5qVLGT0GldyiGU2JH4LJF+DDO
 /kXq76mT/TuMCkGDe7ntcvWrY4wLVErztss58lfLl9CkO9rBxzfqCG9Cm
 KINaiZRvhfi1zUChaS+bwBicfzClT1ia807HvohJ90IvYJtmKs+04WWjt
 iLndXJQoAA6UTXCdhH7AYRzeFno5RaiIO0YT3n7XRRe+XCATDKZNio600 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10711"; a="354619843"
X-IronPort-AV: E=Sophos;i="5.99,278,1677571200"; d="scan'208";a="354619843"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 May 2023 04:40:31 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10711"; a="695418818"
X-IronPort-AV: E=Sophos;i="5.99,278,1677571200"; d="scan'208";a="695418818"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.70])
 by orsmga007.jf.intel.com with SMTP; 16 May 2023 04:40:28 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 16 May 2023 14:40:27 +0300
Date: Tue, 16 May 2023 14:40:27 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
Message-ID: <ZGNrq9lG85tkh2Ym@intel.com>
References: <20230512062417.2584427-1-ankit.k.nautiyal@intel.com>
 <20230512062417.2584427-13-ankit.k.nautiyal@intel.com>
 <ZGNeYFSFzInncdQm@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <ZGNeYFSFzInncdQm@intel.com>

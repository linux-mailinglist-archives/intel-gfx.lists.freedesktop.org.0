...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFE2D4AD789
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 12:37:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8579910E628;
	Tue,  8 Feb 2022 11:37:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2264C10E628
 for <intel-gfx@lists.freedesktop.org>; Tue,  8 Feb 2022 11:37:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644320244; x=1675856244;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=IahdYebohSg0jQojhWZDACrjde72SinabcOz9h/rG7Y=;
 b=JqyWB+Kd1RDJFugP+ugtbGXtI+8K9Ld3dhyzhllEIcX5/X2LpzD5aOWV
 b5qPcxm7tqY+icVUmCewYYCIntQS+VpOBO60UX8CIRF92g8f3LqWPgV5U
 bjLD51FQP/HXzL3PmIjFn4Xzx6Wkdt5DwQl/hBYlCp/0vV+QN23zgvf2X
 i0k3fGMPaQ7epVsv9TP9pWaGZIlTQTbEq7qmtzsPz9yQC2+uuanXCx3oo
 UM8gsqM/UJMFyd6UzIWDPU+RP5u8USE96AABg0WVMXv6t5HRM14tOMWJF
 WGTPwcog+NU1O+8RbZGvHmt3mAwe2eZddKyNOlsM3A4R66zUCmedfWHiH g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10251"; a="232496001"
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="232496001"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:23 -0800
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="481915354"
Received: from ideak-desk.fi.intel.com ([10.237.68.141])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:23 -0800
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  8 Feb 2022 13:36:49 +0200
Message-Id: <20220208113656.179823-20-imre.deak@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 19/26] drm/i915: Allow platforms to share
...
@@ -1549,7 +1512,7 @@ int intel_init_power_wells(struct i915_power_domains *power_domains)

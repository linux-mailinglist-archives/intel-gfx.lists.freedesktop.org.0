...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C65D4E90F6
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 11:17:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 21EDC10EAEA;
	Mon, 28 Mar 2022 09:17:53 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 03/11] drm/edid: slightly restructure timing
 and non-timing descriptor structs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 118111993BD
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2020 12:42:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3219A6E7EA;
	Tue, 31 Mar 2020 10:42:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7B72C6E7D9
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Mar 2020 10:42:14 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 31 Mar 2020 12:41:58 +0200
Message-Id: <20200331104209.432176-12-maarten.lankhorst@linux.intel.com>
...
index 9fff4e02cee6..c873ae2b97e4 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3057,7 +3057,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3087,20 +3090,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3108,9 +3114,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3136,8 +3142,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -4915,13 +4923,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -4954,8 +4962,10 @@ static void virtual_context_exit(struct intel_context *ce)

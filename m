...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC1D73966E0
	for <lists+intel-gfx@lfdr.de>; Mon, 31 May 2021 19:23:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B9686E96F;
	Mon, 31 May 2021 17:22:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0BCFA6E969;
 Mon, 31 May 2021 17:22:51 +0000 (UTC)
IronPort-SDR: n5tz6ZezfdFY3UKCCUls1jX+xgrzUpt70f/7biDsgvOr+xXUtFPzvl7whMonz/1RdTZKr/J0Xu
 nEXeICA7Xm8w==
X-IronPort-AV: E=McAfee;i="6200,9189,10001"; a="201520212"
X-IronPort-AV: E=Sophos;i="5.83,237,1616482800"; d="scan'208";a="201520212"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2021 10:22:50 -0700
IronPort-SDR: EX/bc2uX24p/hw6Y25XBZvUYbx1PMFt65yJlR/5ZvgvJe2+QBL7+80UVye4tGYmqOn0FRovIjc
 dG8YYWag4MPw==
X-IronPort-AV: E=Sophos;i="5.83,237,1616482800"; d="scan'208";a="416210999"
Received: from fnygreen-mobl1.ger.corp.intel.com (HELO
 thellst-mobl1.intel.com) ([10.249.254.142])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2021 10:22:49 -0700
From: =?UTF-8?q?Thomas=20Hellstr=C3=B6m?= <thomas.hellstrom@linux.intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Mon, 31 May 2021 19:22:20 +0200
Message-Id: <20210531172228.70846-8-thomas.hellstrom@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 07/15] drm: Add a prefetching memcpy_from_wc

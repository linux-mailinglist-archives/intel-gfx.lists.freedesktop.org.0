...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B3AC07DD9F7
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Nov 2023 01:27:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FDDE10E622;
	Wed,  1 Nov 2023 00:26:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-xd2c.google.com (mail-io1-xd2c.google.com
 [IPv6:2607:f8b0:4864:20::d2c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ABA3C10E612;
 Wed,  1 Nov 2023 00:26:37 +0000 (UTC)
Received: by mail-io1-xd2c.google.com with SMTP id
 ca18e2360f4ac-7a69a1b51baso9266039f.1; 
 Tue, 31 Oct 2023 17:26:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1698798397; x=1699403197; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=AZEiV7lYqRH/SfkjkGmwPC+//ERNTF6StucghHh7NUE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1698798397; x=1699403197;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=AZEiV7lYqRH/SfkjkGmwPC+//ERNTF6StucghHh7NUE=;
 b=
X-Gm-Message-State: AOJu0Yz5MRm8/q68JK4QOlA7GwUtlSffvGa8fTxQAbo1J2d3AX3YaANx
 +q6b7udJ6Hj7ZaDlMp1K2xE=
X-Google-Smtp-Source: AGHT+IE0P1qR/715TEa3Zzt2WyKUi0wE5yvDVVxWI8/F7v/m/gq+DBQVuz2c9KIPUjFh+z79azMGpQ==
X-Received: by 2002:a92:cbd0:0:b0:359:3294:91a9 with SMTP id
 s16-20020a92cbd0000000b00359329491a9mr2919025ilq.14.1698798396807; 
 Tue, 31 Oct 2023 17:26:36 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 t1-20020a92c901000000b00357cc8df1d5sm141701ilp.68.2023.10.31.17.26.35
...
Date: Tue, 31 Oct 2023 18:26:00 -0600
Message-ID: <20231101002609.3533731-15-jim.cromie@gmail.com>
...
Subject: [Intel-gfx] [PATCH v7d 14/23] dyndbg-API: fix
...
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -7321,7 +7321,7 @@ M:	Jim Cromie <jim.cromie@gmail.com>
 S:	Maintained
...
index 91c8b67fd8f8..7d3261dede77 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B07623B5B5D
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Jun 2021 11:31:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 305A36E400;
...
Subject: [Intel-gfx] [PATCH v4 0/2] drm: address potential UAF bugs with
 drm_master ptrs

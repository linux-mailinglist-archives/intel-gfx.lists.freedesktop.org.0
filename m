...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCC64AB8869
	for <lists+intel-gfx@lfdr.de>; Thu, 15 May 2025 15:48:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 702B010E8A8;
	Thu, 15 May 2025 13:48:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VIkCycqf";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 960ED10E8A9;
 Thu, 15 May 2025 13:48:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1747316903; x=1778852903;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=vwloMlT29iZTBRzeF9KgToMA/vQ27A3cZYZiIl3YXwU=;
 b=VIkCycqfX8I6Bu+x1gGQXtK6atMexTWDIv1f9rv1OtA0QwZmhREZPMg8
 VZFFuALmtszeEXqC3Bg6+ilnTl6YQ4JvjKlupKZpXhS6D6cH65SD/nkhy
 dA/oZEuUVtsxZiEPzW/omqg7Kls09gWemvYzTcHBF7db8zOr/nGxuFa51
 JqiukVXxOjO6znvRbaZ5pscLQuvjxG84jCC0EFDSGnCtr9YzqLjgJKv2n
 TCP83qpjXyqGxYIwWZRMY2LlZLiNB9W/OoOZVl3nVAxQ/UmseyJvcLE+S
 1L2LRmkRxkl+MViA/BDX4cE/q2M5MtJYYDv81mzu0ktLD0vIdXOqcUiOI A==;
X-CSE-ConnectionGUID: YsJugHWyTmKpGYL2U2rPUg==
X-CSE-MsgGUID: qmjLFXGcTjqrkBHnD4DYvw==
X-IronPort-AV: E=McAfee;i="6700,10204,11434"; a="66660799"
X-IronPort-AV: E=Sophos;i="6.15,291,1739865600"; d="scan'208";a="66660799"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2025 06:48:23 -0700
X-CSE-ConnectionGUID: BxhC7chBR8aGSlAD385D+w==
X-CSE-MsgGUID: XViOe7Z0SdesHa6s9N9dmg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,291,1739865600"; d="scan'208";a="138428342"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2025 06:48:16 -0700
...
Subject: [PATCH v10 06/10] drm/i915/nvm: add nvm device for discrete graphics
Date: Thu, 15 May 2025 16:33:41 +0300
Message-ID: <20250515133345.2805031-7-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5F4D70F6B7
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 14:42:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 16E0110E679;
	Wed, 24 May 2023 12:42:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BA40C10E67F
 for <intel-gfx@lists.freedesktop.org>; Wed, 24 May 2023 12:42:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684932137; x=1716468137;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=gxecV9otpMeDnbywZLF57yBR6QN1FuvXQGG8GBLJG8w=;
 b=WREGpkwNZrNBeYmQDaRpU2+OWoFoABcGDhqQAiom0XFTAGyxH1wqn4t5
 2+iH7GVlfAzpD5rhHSfmyk5N6bh2pv/XIq37ryqqpUt/ZtN1PEO6TUNyL
 0i17byySW5uSlPmJNlg+06t1T06xWDNPLLDA4V4T59NQVj1+eA3G52klu
 w0gfTX9zB0siVjPfhczmNDq1rc2wZGMtYjWNxyPRDi4rpXhUgTmBNm1V9
 IxLTWvzyMSBIyOAGlxCwO621PkMWYzFwDs984AMOyGGH3Iuah1N2Sb5uy
 uNZpya9pwIsFrYxUxcbg//hI11mKcJl1Y+rtO1wk8yMhkLI7S4F1rLWdc w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="353575764"
X-IronPort-AV: E=Sophos;i="6.00,189,1681196400"; 
 d="scan'208,223";a="353575764"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 05:42:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="828562015"
X-IronPort-AV: E=Sophos;i="6.00,189,1681196400"; 
 d="scan'208,223";a="828562015"
...
Date: Wed, 24 May 2023 15:41:23 +0300
Message-Id: <20230524124124.378194-7-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 6/7] drm/i915/mtl: find the best QGV point

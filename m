...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1AAFF713102
	for <lists+intel-gfx@lfdr.de>; Sat, 27 May 2023 02:53:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ACDBF10E6FA;
...
Subject: [Intel-gfx] [PATCH v3 3/7] drm/i915/huc: Load GSC-enabled HuC via

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C69E1076E2
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Nov 2019 19:01:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B81BE6F53D;
	Fri, 22 Nov 2019 18:01:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6819F6F53D
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 Nov 2019 18:00:58 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19304958-1500050 
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 Nov 2019 18:00:54 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 22 Nov 2019 18:00:53 +0000
Message-Id: <20191122180053.770825-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 2/2] drm/i915/gt: Schedule request retirement when
 timeline idles
...
cm0vaTkxNS9ndC9pbnRlbF9scmMuYwppbmRleCAwZTIwNjVhMTNmMjQuLjA2MmRkOGFjNDcyYSAx

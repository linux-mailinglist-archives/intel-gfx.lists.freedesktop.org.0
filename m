...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9AC19510479
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Apr 2022 18:49:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B84D210E880;
...
Subject: [Intel-gfx] [PATCH v3 2/7] drm: Add drm_memcpy_from_wc() variant

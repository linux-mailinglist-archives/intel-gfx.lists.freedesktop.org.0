...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5858C794373
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Sep 2023 21:02:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A348B10E70E;
...
Subject: [Intel-gfx] [PATCH v3 2/5] drm/kmb: add trailing newlines to
 drm_dbg msgs

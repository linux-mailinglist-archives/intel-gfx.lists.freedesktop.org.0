...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F2C18618235
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Nov 2022 16:18:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 80A9310E6FE;
...
Subject: [Intel-gfx] [PATCH v3 19/23] drm/fb-helper: Always initialize

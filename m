...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EDC0D3F49C2
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Aug 2021 13:29:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D7F389D9B;
	Mon, 23 Aug 2021 11:29:28 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4714B89D83;
 Mon, 23 Aug 2021 11:29:26 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10084"; a="197331609"
X-IronPort-AV: E=Sophos;i="5.84,344,1620716400"; d="scan'208";a="197331609"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Aug 2021 04:29:25 -0700
X-IronPort-AV: E=Sophos;i="5.84,344,1620716400"; d="scan'208";a="525910318"
Received: from mhartley-mobl1.ger.corp.intel.com (HELO tursulin-mobl2.home)
 ([10.213.253.18])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Aug 2021 04:29:17 -0700
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org
Cc: dri-devel@lists.freedesktop.org, Tvrtko Ursulin <tvrtko.ursulin@intel.com>,
 Aravind Iddamsetty <aravind.iddamsetty@intel.com>,
 Chris Wilson <chris@chris-wilson.co.uk>
Date: Mon, 23 Aug 2021 12:28:56 +0100
Message-Id: <20210823112859.103561-6-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [RFC 5/8] drm/i915: Track context current active time
...
index 745e84c72c90..003864354cb5 100644
...
index e54351a170e2..b53dabf5dc9e 100644
...
index de5f9c86b9a4..d52cef9802df 100644
...
index bb4af4977920..702d594b18fa 100644
...
index b9f66dbd46bb..7657ae32c9ad 100644
...
@@ -1308,8 +1305,8 @@ static bool record_context(struct i915_gem_context_coredump *e,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 346AA3D21FC
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Jul 2021 12:17:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DEF436EEA6;
	Thu, 22 Jul 2021 10:17:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x42c.google.com (mail-wr1-x42c.google.com
 [IPv6:2a00:1450:4864:20::42c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2005E6EEA2
 for <intel-gfx@lists.freedesktop.org>; Thu, 22 Jul 2021 10:16:59 +0000 (UTC)
Received: by mail-wr1-x42c.google.com with SMTP id i94so5325243wri.4
 for <intel-gfx@lists.freedesktop.org>; Thu, 22 Jul 2021 03:16:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=bmNXUrrtIYl59tjbl21KncCUy1BrgNQJjEnd/wuOlJk=;
 b=T3RcYPgcwELV3LPkKJhI3lB1Lbw1Lg79F704agxtaI8g+5+WqKioi9G7jubYQQz4tu
 IlnexrYtLhslq21YqwphGlMdpZ0DV0h0ZsonnhMemA4Rp76Q5ahKcUftxwO+jRlIypiA
 OwZIBm/tUMV6ZXUGIJOB8C7CzIiyiEm6avTvg=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=bmNXUrrtIYl59tjbl21KncCUy1BrgNQJjEnd/wuOlJk=;
 b=
X-Gm-Message-State: AOAM532TscoDaSIT8A5hAUzyB/2XtnSJZxThD0rlUIkyBCNeftvutvwM
 P99l0lDs+dxuO6zYGY3noiNAvA==
X-Google-Smtp-Source: ABdhPJw9ZIn5BP+1yJb8fleWofH2s7Yxanu6cFIzyMf2j7FFgDrWoaSqiaVQjIpa4D10fKkThziiTQ==
X-Received: by 2002:adf:f74f:: with SMTP id z15mr47695776wrp.54.1626949017491; 
 Thu, 22 Jul 2021 03:16:57 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id d15sm29874513wri.39.2021.07.22.03.16.56
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 22 Jul 2021 03:16:57 -0700 (PDT)
Date: Thu, 22 Jul 2021 12:16:55 +0200
From: Daniel Vetter <daniel@ffwll.ch>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Message-ID: <YPlFl0KZYNbtU2El@phenom.ffwll.local>
References: <20210721183229.4136488-1-daniel.vetter@ffwll.ch>
 <591fb3fc-ca96-da18-a280-37304f5f920d@linux.intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <591fb3fc-ca96-da18-a280-37304f5f920d@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BF805E6529
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Sep 2022 16:26:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6004B10EB50;
	Thu, 22 Sep 2022 14:26:08 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 04/33] drm/connector: Rename subconnector
 state variable

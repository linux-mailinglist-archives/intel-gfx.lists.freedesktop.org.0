...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 80F3E40242E
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Sep 2021 09:26:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 73A4B89D53;
	Tue,  7 Sep 2021 07:26:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 397E589D4D
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Sep 2021 07:26:03 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-151-P2DVksuwOpmkN56zNMCwLg-1; Tue, 07 Sep 2021 03:26:00 -0400
X-MC-Unique: P2DVksuwOpmkN56zNMCwLg-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com
 [10.5.11.13])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id DF23F801A92;
 Tue,  7 Sep 2021 07:25:59 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 991CF60936;
 Tue,  7 Sep 2021 07:25:58 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Tue,  7 Sep 2021 17:25:27 +1000
Message-Id: <20210907072549.2962226-4-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 03/25] drm/i915: move more pll/clocks into
 display struct.
...
+=09if (dev_priv->display->cdclk.hw.cdclk >=3D dev_priv->display->czclk_fre=
q) {
...
+=09dev_priv->display->max_dotclk_freq =3D intel_compute_max_dotclk(dev_pri=
v);
=20
...
+=09hpll =3D vlv_get_cck_clock(dev_priv, name, reg, dev_priv->display->hpll=
_freq);
=20
...
+=09dev_priv->display->czclk_freq =3D vlv_get_cck_clock_hpll(dev_priv, "czc=
lk",

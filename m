...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04E6B67AB52
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 09:07:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 023A310E74B;
...
Subject: [Intel-gfx] [PATCH v3 4/8] drm/i915/pxp: Add GSC-CS backend to send
 GSC fw messages

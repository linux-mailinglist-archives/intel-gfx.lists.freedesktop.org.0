...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7DF9334B5A
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Mar 2021 23:18:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B38D6EA7C;
	Wed, 10 Mar 2021 22:17:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E38C86EA8A
 for <intel-gfx@lists.freedesktop.org>; Wed, 10 Mar 2021 22:17:51 +0000 (UTC)
IronPort-SDR: 218oHWq+bkZdJEmUieVrmAbSf37mTaWWCOTRsv6ZnPiL92870Y7X/1me5A9p2tONeRMj1gJ7pm
 +a6qC8Vq7pvQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9919"; a="252592075"
X-IronPort-AV: E=Sophos;i="5.81,238,1610438400"; d="scan'208";a="252592075"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Mar 2021 14:17:50 -0800
IronPort-SDR: 0jMeOmlPh0T6VFJ35jaM9kTgjO38Pw4z5TeFJZ3W8Tzo0/y2p9oKbbRY0Bt/Ot54rPPugX4Aek
 7tu9eSUe0vvg==
X-IronPort-AV: E=Sophos;i="5.81,238,1610438400"; d="scan'208";a="403852235"
Received: from ideak-desk.fi.intel.com ([10.237.68.141])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Mar 2021 14:17:49 -0800
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 11 Mar 2021 00:17:24 +0200
Message-Id: <20210310221736.2963264-12-imre.deak@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20210310221736.2963264-1-imre.deak@intel.com>
References: <20210310221736.2963264-1-imre.deak@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/23] drm/i915/intel_fb: Pull FB plane

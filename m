...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 40482546D2B
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 21:21:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3DD21135B0;
	Fri, 10 Jun 2022 19:21:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98EC21135AC;
 Fri, 10 Jun 2022 19:21:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654888907; x=1686424907;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=2ooeSRI1xi4oDDxUXsLDopwkvUUwWHDmwo2YZoV2hoc=;
 b=BSOGWTaI/10ZNtxOQt4gxaZw6/oL8+CXsgooH/qHmfZtPHckMPhyAB+z
 pWsqZ+z/MkYZRI1LfTVCFOQd8bNS1+Tfm6jfO2PCwmbWrabhrdxayDItY
 /8ynpddFHa6Mqdne6MC0xYEsjHEepX8+to0BVL8KLiXZOlVydRp/vGXIp
 sp4+Z9DjWAeeLLZ3aamwcJM5HdC4Tr7PCzNOu9xKLiDouEsPwOyyZJx1g
 XhW3dht73P3aP3hyG6OcMKW7KC80WzttKAoTiDZ4pdxVL5CEld2pLikQm
 49Ydm9ugvFo8vIWhgXghjp2zLDZaALA7wdwI69gOA+/Np+b6sQF9/I4+E Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10374"; a="275253990"
X-IronPort-AV: E=Sophos;i="5.91,291,1647327600"; d="scan'208";a="275253990"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 12:21:38 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.91,291,1647327600"; d="scan'208";a="725100043"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.163])
 by fmsmga001.fm.intel.com with SMTP; 10 Jun 2022 12:21:35 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 10 Jun 2022 22:21:34 +0300
Date: Fri, 10 Jun 2022 22:21:34 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Message-ID: <YqOZvuNazgREu9RR@intel.com>
References: <cover.1654674560.git.jani.nikula@intel.com>
 <0a387d53820ee82948018648d0c0fbd465ed01a2.1654674560.git.jani.nikula@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <0a387d53820ee82948018648d0c0fbd465ed01a2.1654674560.git.jani.nikula@intel.com>
X-Patchwork-Hint: comment
Subject: Re: [Intel-gfx] [PATCH v2 10/15] drm/i915/edid: convert DP,

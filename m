...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D76617C705
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 21:27:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4C3F6ED6B;
	Fri,  6 Mar 2020 20:27:29 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 16/51] drm/ingenic: Use drmm_add_final_kfree

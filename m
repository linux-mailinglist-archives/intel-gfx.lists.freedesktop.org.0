...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BE344BDAFA
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Feb 2022 17:46:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1881910E786;
	Mon, 21 Feb 2022 16:46:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from NAM04-DM6-obe.outbound.protection.outlook.com
 (mail-dm6nam08on2057.outbound.protection.outlook.com [40.107.102.57])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D602D10E78D;
 Mon, 21 Feb 2022 16:46:30 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=X699jAmhyVAJVUoq/foZpwQqlchmsl0f3XocBkCJDtc=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1; 
 ...
 bh=X699jAmhyVAJVUoq/foZpwQqlchmsl0f3XocBkCJDtc=;
 b=QjGfIep69kq9NAEubBO7TFyqUeUcw3sBFxcjL6ZLS3c7MBD5qCDBt/Ro+TXMwn74wKXfSu37UVUBH0nldT+sgyIhZ2C9KpmB/f2tMqqbwqYgR97TV/G9NPSMYK34lajfknCz8T3BohZet55xYhy2T99ndlTv+TxBnNl38OvkKXc=
...
Received: from BN8NAM11FT008.eop-nam11.prod.protection.outlook.com
 (2603:10b6:408:139:cafe::40) by BN9PR03CA0478.outlook.office365.com
 (2603:10b6:408:139::33) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.4995.16 via Frontend
 Transport; Mon, 21 Feb 2022 16:46:26 +0000
...
Received: from SATLEXMB04.amd.com (165.204.84.17) by
 ...
 15.20.4995.20 via Frontend Transport; Mon, 21 Feb 2022 16:46:26 +0000
...
Date: Mon, 21 Feb 2022 22:15:52 +0530
Message-ID: <20220221164552.2434-5-Arunpravin.PaneerSelvam@amd.com>
...
X-MS-Office365-Filtering-Correlation-Id: 7a6c39a3-5b3b-4148-93e2-08d9f559b3c3
X-MS-TrafficTypeDiagnostic: BL0PR12MB2337:EE_
X-Microsoft-Antispam-PRVS: <BL0PR12MB2337BA290FFD5C0C1EEE8757E43A9@BL0PR12MB2337.namprd12.prod.outlook.com>
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:165.204.84.17; CTRY:US; LANG:en; SCL:1; SRV:;
 IPV:CAL; SFV:NSPM; H:SATLEXMB04.amd.com; PTR:InfoDomainNonexistent; CAT:NONE;
 SFS:(13230001)(4636009)(46966006)(40470700004)(36840700001)(5660300002)(8936002)(26005)(16526019)(186003)(426003)(336012)(81166007)(2616005)(356005)(70586007)(82310400004)(1076003)(8676002)(4326008)(30864003)(6666004)(316002)(47076005)(70206006)(36756003)(110136005)(54906003)(83380400001)(36860700001)(86362001)(40460700003)(2906002)(508600001)(7696005)(36900700001);
 DIR:OUT; SFP:1101; 
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 21 Feb 2022 16:46:26.5688 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 7a6c39a3-5b3b-4148-93e2-08d9f559b3c3
...
Subject: [Intel-gfx] [PATCH v13 5/5] drm/amdgpu: add drm buddy support to
 amdgpu

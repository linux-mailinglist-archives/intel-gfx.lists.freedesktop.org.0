...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 787C06833CC
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Jan 2023 18:24:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CE2010E2A4;
	Tue, 31 Jan 2023 17:24:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7C45210E151;
 Tue, 31 Jan 2023 17:24:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675185844; x=1706721844;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=DomKQwx1y3AwT7I9kREMAcQlesmrS/4bgkoR3KzQ7aU=;
 b=Jmh6Lpbrt/3Zr36wBttQAwSn7sHk90/NfCiHvxjZAJRIy6NElqaHYWxT
 zxpEkPUPd3mvaVCZscxSSJjISEY9tW2V6iIc2lHFj7QKK06bpqFnfHFu4
 rVL6A8QYImnLtizKz3QI6mMk8rfEQpxniLUhch/zsJkQQqcyzbkrn+9Ru
 u9cOGgeKkcaJK9RvOxz8qVTWFrShMqZ4v5PHXtqCzxj7N1XVevtD/xmkW
 s+BswprOFTbnOfQHBxZblzQGBegjWEyRaDvm00ETDTLMUQvRFzj1Q2ZPt
 oipFpxA2wJ6HfsvUVzlUiFX6t3GWsEjaFB7QfRklQPPmpiotvDDQw+bqq Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10607"; a="308243625"
X-IronPort-AV: E=Sophos;i="5.97,261,1669104000"; d="scan'208";a="308243625"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jan 2023 09:24:02 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10607"; a="614538587"
X-IronPort-AV: E=Sophos;i="5.97,261,1669104000"; d="scan'208";a="614538587"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
 by orsmga003.jf.intel.com with ESMTP; 31 Jan 2023 09:24:02 -0800
Received: from orsmsx610.amr.corp.intel.com (10.22.229.23) by
 ORSMSX602.amr.corp.intel.com (10.22.229.15) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.16; Tue, 31 Jan 2023 09:24:01 -0800
Received: from ORSEDG602.ED.cps.intel.com (10.7.248.7) by
 orsmsx610.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.16 via Frontend Transport; Tue, 31 Jan 2023 09:24:01 -0800
Received: from NAM04-BN8-obe.outbound.protection.outlook.com (104.47.74.43) by
 edgegateway.intel.com (134.134.137.103) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.16; Tue, 31 Jan 2023 09:24:01 -0800
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=vZEwBw/vwahBvhlyAP9uv3NFr23Js/VOZCjV6wbwK/8=;
 b=
...
Received: from PH7PR11MB6053.namprd11.prod.outlook.com
 ...
 17:23:50 +0000
Date: Tue, 31 Jan 2023 12:23:41 -0500
From: Rodrigo Vivi <rodrigo.vivi@intel.com>
To: Mark Yacoub <markyacoub@chromium.org>, Suraj Kandpal
 <suraj.kandpal@intel.com>
Message-ID: <Y9lOnSQ+EIOET7Rv@intel.com>
References: <20230118193015.911074-1-markyacoub@google.com>
 <20230118193015.911074-8-markyacoub@google.com>
 <Y9lM/Ck3bHYQWNF3@intel.com>
Content-Type: text/plain; charset="us-ascii"
Content-Disposition: inline
In-Reply-To: <Y9lM/Ck3bHYQWNF3@intel.com>
X-ClientProxiedBy: BY3PR04CA0012.namprd04.prod.outlook.com
 (2603:10b6:a03:217::17) To PH7PR11MB6053.namprd11.prod.outlook.com
 (2603:10b6:510:1d1::8)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: PH7PR11MB6053:EE_|PH0PR11MB7586:EE_
X-MS-Office365-Filtering-Correlation-Id: 2ea2f471-4495-4271-79af-08db03afeae1
X-LD-Processed: 46c98d88-e344-4ed4-8496-4ed7712e255d,ExtAddr
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:PH7PR11MB6053.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230025)(346002)(366004)(376002)(39860400002)(396003)(136003)(451199018)(66899018)(66556008)(66476007)(8676002)(4326008)(8936002)(41300700001)(66946007)(83380400001)(86362001)(478600001)(82960400001)(316002)(2906002)(6666004)(6506007)(6486002)(26005)(38100700002)(966005)(186003)(6636002)(5660300002)(6512007)(44832011)(30864003)(7416002)(7406005)(36756003)(110136005)(2616005)(67856001)(579004)(559001);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?u3Byaha11phtQvQ5Dprlmy7qDBBEGVctmSIUNnkUPKA7yVqENVTjIgAFf3he?=
 =?us-ascii?Q?aGZ2E4bFwIdlUPrKsAY/QOIVaqxA5CirAb1rJrkyOfCK3LB4iacGr+vKGSC6?=
 =?us-ascii?Q?2BMTx4Nos3ZgY97vvxQYP7KneCCBIeGddNa4d/UlCypeg7fuN5XD4zRMw9ZU?=
 =?us-ascii?Q?eIa+RApwSZhAb1+VjFR8iO2SyTmTvqNzUraTcKnWhtvN6PkS2z0+OVL/+nuF?=
 =?us-ascii?Q?+dHBhbqhO4/Ym+izKZf2etJjYXBWfDAlzyRy4Q0M2gnm867k9335f6w2OBzZ?=
 =?us-ascii?Q?nEABjmmit6J/gwbYuSh00RiUFclwR+J0gODbG5DMNa2ZKSX1lCKm0axJiSd9?=
 =?us-ascii?Q?GnVf12pbW9cuWefsbY56YAvxcmephSmhwjvl/ylgtT6BcamxRB8x9TfHIGBh?=
 =?us-ascii?Q?HLRkL/9IOC82pNU6MToE9RJTk+N7dgrgSKe6N1aoUIsYlggcayN5jXn70MHx?=
 =?us-ascii?Q?p/hUnMRUg8DKjvPNJ0aJvR6UtaHo8fipp9hC5QpnEZ/QkdlKszE799H58XS2?=
 =?us-ascii?Q?QovkmgCXU4cWrPcWZxiMa0qDVmTT9XFgU5VFK4CnepoDBYAMNF1Yw09bUGPq?=
 =?us-ascii?Q?Q9KeapoyOn1I7pLAw6wOXdYYmRJV2ZwijGhPEk3jvxOOhQL+h0y2qDVEX+9A?=
 =?us-ascii?Q?w7SZsP8LLjR1PJHyjNridqYRh+rpM9iSCBU8XuMfv4TGzke8/LSIuftei56x?=
 =?us-ascii?Q?gl/30KbQA7NNaTsgwfeW2x9wiLKV5L+ZokBfCezm+pkcVRYsk4pndIUINFIV?=
 =?us-ascii?Q?/EM0+UfRIZMY8gEQrQ4FS+8RsFN0mxdmE3v6NsH23GOdpTuNXYd1+bq0NLEN?=
 =?us-ascii?Q?3+7BtfngMC4BvN/xBMQ5E+VjVSXc8POCm+TITvYJqUUJPpMLOohcCod4Yo8i?=
 =?us-ascii?Q?jqtyeHS9RKmVxJwwjwgDvAJ0Hi2AlRRc98ShKafxmPCXuJNFlf2EsJd9cDzZ?=
 =?us-ascii?Q?8mA5cYxoFBkTO+thYaMzaSj45Ygqe9HQLOSOukHC8gAFTj5OR57bu+wuLIpo?=
 =?us-ascii?Q?wHQpsF3hwkQ49sVLoKNNvMIKZY14TTBZtZIXCkJ8Zajnw+sQWURFdISBeAOr?=
 =?us-ascii?Q?LT3HvQ3Zb1AtqnpCL7gDxi2/XzTe2t/LVaKHuFW4fYpW0MPPrQrfoEd/suJ7?=
 =?us-ascii?Q?LA3oLGH4Zm0UBItHVRqFC4YK+32pSTtBm5KzTI/vyuGNJaaBI/zQdXb7svfA?=
 =?us-ascii?Q?xUip/7LKd2im4JnmyVocUNBrz700Nk231i1iuisKV9gBcP/QSeC4YlfO8hjz?=
 =?us-ascii?Q?a4eE/Dh3R405Ew3kLp55kLbtMcxAGASOJgF11vCs1zC7dHxMa8emnLPvHX1z?=
 =?us-ascii?Q?zhrAn7aVPHMrG19ihBEjoNYvsi2IQOPp2Cxp5LyGcS2pfPKKoMFiGwVkIETd?=
 =?us-ascii?Q?YLJ/jgWYB06Xm/xgTOj6x049m5JxjhR1Eq4BOnGwZgk2yS5d9aLipP/5tH0f?=
 =?us-ascii?Q?fKIlBwII/6AZF2qK5WhKt/gqdQi+D4EcrRrYhFgBY26530MOfConR+TiiEQG?=
 =?us-ascii?Q?zOu+62HKah9QFJYXFomeeh+KWQDr70OBb98hYtFcbI9ANBQlcUxAjjA2NZ9r?=
 =?us-ascii?Q?fjVcRd+iaBwkov0pOCbsnu0ZoRS9T1gX+pj7okVTzffxZchHUA2gX920+x5v?=
 =?us-ascii?Q?xQ=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 2ea2f471-4495-4271-79af-08db03afeae1
X-MS-Exchange-CrossTenant-AuthSource: PH7PR11MB6053.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 31 Jan 2023 17:23:50.5530 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: nOvtqUV3nl/4wqEceF7xQNV+qnidiIJUzqrX7UifhYQ4IIYa5C7Hv4ApGKlo31Fl/7RVv8xfLgRhHiQm7dr4BA==
...
Cc: quic_sbillaka@quicinc.com, konrad.dybcio@somainline.org,
 ...
 marex@denx.de, javierm@redhat.com, quic_khsieh@quicinc.com, agross@kernel.org,
 quic_jesszhan@quicinc.com, devicetree@vger.kernel.org, daniel@ffwll.ch,
 Jani Nikula <jani.nikula@intel.com>, linux-arm-msm@vger.kernel.org,
 intel-gfx@lists.freedesktop.org, lucas.demarchi@intel.com,
 quic_abhinavk@quicinc.com, abhinavk@codeaurora.org, swboyd@chromium.org,
 ...
 linux-kernel@vger.kernel.org, tzimmermann@suse.de, dmitry.baryshkov@linaro.org,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0852419F4B9
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Apr 2020 13:37:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2630C6E348;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/18] drm/i915/display/ddi: Prefer drm_WARN*
 over WARN*

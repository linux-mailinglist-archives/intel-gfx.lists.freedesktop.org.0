...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 799202F0E01
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jan 2021 09:26:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B22989EB4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 03/19] drm/i915/hotplug: Handle CP_IRQ for
 DP-MST

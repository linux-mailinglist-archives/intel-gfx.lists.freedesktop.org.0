...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF59C80602
	for <lists+intel-gfx@lfdr.de>; Sat,  3 Aug 2019 13:26:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9519D6E4A1;
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/syncobj: Lookup the syncobj with
 RCU protection

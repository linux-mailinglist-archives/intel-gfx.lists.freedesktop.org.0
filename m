...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B7E3E1BFAB6
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Apr 2020 15:55:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 111DF6E8DE;
	Thu, 30 Apr 2020 13:55:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EE2F66E8F6
 for <intel-gfx@lists.freedesktop.org>; Thu, 30 Apr 2020 13:55:46 +0000 (UTC)
IronPort-SDR: QWBWY5EtlWW4y0aHFCVQAXSRXL4FUzi7pAOsX94hadHVp2U9WnXngUpvyMW/lXK8+90U05in38
 MFeVK3LULF0g==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Apr 2020 06:55:46 -0700
IronPort-SDR: SzDuCVewnrZjJ/wmd+RcQkwT2dcnPAeiIzOPzi4U1a/ymVXhIWAZjjnBatxuzeQD8hjijW4ypX
 ri7LdhoZ8zxg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,336,1583222400"; d="scan'208";a="294514730"
Received: from pbukanox-mobl.ccr.corp.intel.com (HELO
 delly.ger.corp.intel.com) ([10.252.55.69])
 by orsmga008.jf.intel.com with ESMTP; 30 Apr 2020 06:55:44 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 30 Apr 2020 16:55:35 +0300
Message-Id: <20200430135536.1141443-4-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v10 3/4] drm/i915/perf: prepare driver to
...
---
 ...
 2 files changed, 379 insertions(+), 242 deletions(-)

diff --git a/drivers/gpu/drm/i915/i915_perf.c b/drivers/gpu/drm/i915/i915_perf.c
index 44148b705a5a..1d5a7d31516a 100644
...
@@ -1389,10 +1459,13 @@ static void i915_oa_stream_destroy(struct i915_perf_stream *stream)
...
@@ -1403,8 +1476,7 @@ static void i915_oa_stream_destroy(struct i915_perf_stream *stream)
...
@@ -1496,7 +1568,7 @@ static void gen8_init_oa_buffer(struct i915_perf_stream *stream)
...
@@ -1550,7 +1622,7 @@ static void gen12_init_oa_buffer(struct i915_perf_stream *stream)
 	 * reports we will forward to userspace while filtering for a single
 	 * context.
 	 */
-	stream->oa_buffer.last_ctx_id = INVALID_CTX_ID;
...
@@ -2273,11 +2345,10 @@ static int gen8_configure_context(struct i915_perf_stream *stream,
 	return err;
 }
...
+	int i;
 	...
 	struct flex regs_context[] = {
 		{
@@ -2298,7 +2369,7 @@ static int gen12_configure_oar_context(struct i915_perf_stream *stream,
...
+			RING_CONTEXT_CONTROL(stream->engine->mmio_base),
 			...
 			_MASKED_FIELD(GEN12_CTX_CTRL_OAR_CONTEXT_ENABLE,
 				      active ?
@@ -2307,18 +2378,28 @@ static int gen12_configure_oar_context(struct i915_perf_stream *stream,
 		},
 	};
...
+	return 0;
 ...
 /*
@@ -2586,11 +2667,9 @@ gen12_enable_metric_set(struct i915_perf_stream *stream,
...
@@ -2631,8 +2710,7 @@ static void gen12_disable_metric_set(struct i915_perf_stream *stream,
...
@@ -2641,8 +2719,7 @@ static void gen12_disable_metric_set(struct i915_perf_stream *stream,
...
@@ -2664,7 +2741,7 @@ static void gen7_oa_enable(struct i915_perf_stream *stream)
...
@@ -2881,7 +2958,7 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 	}
...
@@ -2929,12 +3006,10 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 	if (stream->periodic)
...
@@ -2971,21 +3046,14 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
...
-	stream->config_context->timeline = timeline;
 	...
 	if (ret)
@@ -3000,6 +3068,8 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 		goto err_enable;
 	}
...
@@ -3020,7 +3090,7 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 err_context_pin:
...
+err_context:
 ...
 err_oa_buf_alloc:
@@ -3033,8 +3103,7 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 	free_noa_wait(stream);
...
@@ -3227,8 +3296,12 @@ static void i915_perf_enable_locked(struct i915_perf_stream *stream)
...
+	}
 ...
 /**
@@ -3253,8 +3326,12 @@ static void i915_perf_disable_locked(struct i915_perf_stream *stream)
...
@@ -3272,36 +3349,46 @@ static long i915_perf_config_locked(struct i915_perf_stream *stream,
 		return -EINVAL;
...
@@ -3382,9 +3469,10 @@ static void i915_perf_destroy_locked(struct i915_perf_stream *stream)
...
@@ -3459,25 +3547,12 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
...
@@ -3498,17 +3573,16 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
...
@@ -3529,23 +3603,43 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
 	if (privileged_op &&
...
@@ -3580,12 +3674,11 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
 err_flags:
 	if (stream->ops->destroy)
 		stream->ops->destroy(stream);
-err_alloc:
...
@@ -3617,7 +3710,7 @@ static int read_properties_unlocked(struct i915_perf *perf,
 {
...
@@ -3651,23 +3744,36 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+			props->n_ctx_handles = 1;
 		...
 		case DRM_I915_PERF_PROP_SAMPLE_OA:
 			if (value)
@@ -3676,7 +3782,8 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+				goto error;
 			...
 			break;
@@ -3684,12 +3791,14 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+				goto error;
 			...
 			break;
@@ -3697,7 +3806,8 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
@@ -3726,7 +3836,8 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
@@ -3742,13 +3853,14 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+				goto error;
 			...
 			props->has_sseu = true;
 			break;
@@ -3757,19 +3869,25 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+	return err;
 ...
 /**
@@ -3829,6 +3947,8 @@ int i915_perf_open_ioctl(struct drm_device *dev, void *data,

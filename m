...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4CC7066A328
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 20:31:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2FD8810EADB;
...
Subject: [Intel-gfx] [PATCH v2 11/20] dyndbg-API: specialize

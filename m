...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 548F2153457
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2020 16:42:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6416A6F63C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 11/17] drm/i915: Program DP SDPs with
 computed configs

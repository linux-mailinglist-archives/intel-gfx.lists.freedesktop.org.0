...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF09313B514
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jan 2020 23:07:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1ED396E593;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 1/2] drm/i915: Add mechanism to submit a

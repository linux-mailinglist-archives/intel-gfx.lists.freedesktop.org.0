...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C1363A86C1
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Jun 2021 18:45:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E69896E42D;
	Tue, 15 Jun 2021 16:44:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B64366E42D;
 Tue, 15 Jun 2021 16:44:58 +0000 (UTC)
IronPort-SDR: 49PpGoAOT0kA15F2lqW8j9RgD9RpM5rUGsS2+Pr4YS8pdjQnhElZg9bzywPybu9hwG/tWmqaap
 Qwecqgc4papw==
X-IronPort-AV: E=McAfee;i="6200,9189,10016"; a="227502594"
X-IronPort-AV: E=Sophos;i="5.83,275,1616482800"; d="scan'208";a="227502594"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Jun 2021 09:44:57 -0700
IronPort-SDR: xAZ1uWojT+L1lUuvEa0GcM6H7ZS21hg8VVFlN+EGkMUqOFY5dOMP5kci6msCDncLXk/R/3TDOh
 vvvPt2C/8TEA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.83,275,1616482800"; d="scan'208";a="478772969"
Received: from irvmail001.ir.intel.com ([10.43.11.63])
 by FMSMGA003.fm.intel.com with ESMTP; 15 Jun 2021 09:44:43 -0700
Received: from [10.249.155.84] (mwajdecz-MOBL.ger.corp.intel.com
 [10.249.155.84])
 by irvmail001.ir.intel.com (8.14.3/8.13.6/MailSET/Hub) with ESMTP id
 15FGicBR024281; Tue, 15 Jun 2021 17:44:39 +0100
To: Matthew Brost <matthew.brost@intel.com>
References: <20210614194253.16192-1-matthew.brost@intel.com>
 <20210614194253.16192-3-matthew.brost@intel.com>
 <648fe306-392c-ac04-c7d6-a55a174c32b2@intel.com>
 <20210615155232.GA14359@sdutt-i7>
From: Michal Wajdeczko <michal.wajdeczko@intel.com>
Message-ID: <7e8acdfb-910a-e389-b7b3-df61a6faf417@intel.com>
Date: Tue, 15 Jun 2021 18:44:38 +0200
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:78.0) Gecko/20100101
 Thunderbird/78.10.2
MIME-Version: 1.0
In-Reply-To: <20210615155232.GA14359@sdutt-i7>
...
>>
> 
> The below define 'GUC_ACTION_HOST2GUC_REGISTER_CTB' still exists,
> right?. Isn't it better to have this defined in a single place. 

it's not a doxygen so below define will not show up in rendered rst
documentation
...
>>
> 
> For consistency we likely should delete these values too.
> 
> Matt
> 
...
>>> index d38935f47ecf..93d3e423fba6 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 400C31993BB
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2020 12:42:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C06E96E7E2;
	Tue, 31 Mar 2020 10:42:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4EFBD6E2DE
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Mar 2020 10:42:14 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 31 Mar 2020 12:41:52 +0200
Message-Id: <20200331104209.432176-6-maarten.lankhorst@linux.intel.com>
...
@@ -926,13 +885,31 @@ eb_get_vma(const struct i915_execbuffer *eb, unsigned long handle)
 	}
 }
...
@@ -1925,15 +1902,19 @@ static int eb_move_to_gpu(struct i915_execbuffer *eb)
...
+
 	...
 	return 0;
@@ -2185,7 +2166,6 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2709,6 +2689,8 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2894,6 +2876,8 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	if (batch->private)
...
+		eb_release_vmas(&eb);
 	...
 	eb_unpin_engine(&eb);
@@ -2913,7 +2897,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2969,7 +2953,7 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 1, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3047,7 +3031,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 739CD534AC8
	for <lists+intel-gfx@lfdr.de>; Thu, 26 May 2022 09:29:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4EAE10E013;
	Thu, 26 May 2022 07:29:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [IPv6:2610:10:20:722:a800:ff:feee:56cf])
 by gabe.freedesktop.org (Postfix) with ESMTP id 1393910E013;
 Thu, 26 May 2022 07:29:54 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 0A4CCAADD1;
 Thu, 26 May 2022 07:29:54 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============1624394284620757836=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Ashutosh Dixit" <ashutosh.dixit@intel.com>
Date: Thu, 26 May 2022 07:29:54 -0000
Message-ID: <165355019403.19748.10152620386707919982@emeril.freedesktop.org>
...
#### Possible regressions ####
  ...
  * igt@kms_ccs@pipe-b-crc-primary-basic-4_tiled_dg2_rc_ccs:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@kms_ccs@pipe-b-crc-primary-basic-4_tiled_dg2_rc_ccs.html
...
#### Suppressed ####
  ...
  * {igt@kms_plane_scaling@plane-downscale-with-pixel-format-factor-0-5@pipe-b-edp-1}:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-rkl-6/igt@kms_plane_scaling@plane-downscale-with-pixel-format-factor-0-5@pipe-b-edp-1.html

  * {igt@kms_plane_scaling@plane-downscale-with-rotation-factor-0-75@pipe-d-hdmi-a-1}:
    - {shard-tglu}:       NOTRUN -> [SKIP][3] +44 similar issues
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglu-5/igt@kms_plane_scaling@plane-downscale-with-rotation-factor-0-75@pipe-d-hdmi-a-1.html

  * {igt@kms_plane_scaling@planes-unity-scaling-downscale-factor-0-25@pipe-b-hdmi-a-1}:
    - {shard-dg1}:        NOTRUN -> [SKIP][4] +31 similar issues
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-dg1-15/igt@kms_plane_scaling@planes-unity-scaling-downscale-factor-0-25@pipe-b-hdmi-a-1.html
...
#### Issues hit ####
  ...
  * igt@gem_ctx_param@set-priority-not-supported:
   ...
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@gem_ctx_param@set-priority-not-supported.html

  * igt@gem_exec_fair@basic-none@vcs0:
    - shard-apl:          [PASS][6] -> [FAIL][7] ([i915#2842])
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11698/shard-apl1/igt@gem_exec_fair@basic-none@vcs0.html
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-apl8/igt@gem_exec_fair@basic-none@vcs0.html

  * igt@gem_exec_fair@basic-throttle@rcs0:
    - shard-iclb:         [PASS][8] -> [FAIL][9] ([i915#2849])
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11698/shard-iclb7/igt@gem_exec_fair@basic-throttle@rcs0.html
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-iclb8/igt@gem_exec_fair@basic-throttle@rcs0.html

  * igt@gem_exec_flush@basic-wb-ro-before-default:
    - shard-snb:          [PASS][10] -> [SKIP][11] ([fdo#109271]) +1 similar issue
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11698/shard-snb2/igt@gem_exec_flush@basic-wb-ro-before-default.html
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-snb6/igt@gem_exec_flush@basic-wb-ro-before-default.html

  * igt@gem_lmem_swapping@heavy-verify-multi:
    - shard-kbl:          NOTRUN -> [SKIP][12] ([fdo#109271] / [i915#4613])
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-kbl6/igt@gem_lmem_swapping@heavy-verify-multi.html

  * igt@gem_lmem_swapping@random-engines:
    - shard-apl:          NOTRUN -> [SKIP][13] ([fdo#109271] / [i915#4613])
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-apl6/igt@gem_lmem_swapping@random-engines.html

  * igt@gem_lmem_swapping@verify-random-ccs:
    - shard-skl:          NOTRUN -> [SKIP][14] ([fdo#109271] / [i915#4613])
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-skl3/igt@gem_lmem_swapping@verify-random-ccs.html

  * igt@gem_media_vme:
    - shard-tglb:         NOTRUN -> [SKIP][15] ([i915#284])
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@gem_media_vme.html

  * igt@gem_pxp@create-valid-protected-context:
    - shard-tglb:         NOTRUN -> [SKIP][16] ([i915#4270])
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@gem_pxp@create-valid-protected-context.html

  * igt@gem_spin_batch@spin-each:
    - shard-apl:          [PASS][17] -> [FAIL][18] ([i915#2898])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11698/shard-apl6/igt@gem_spin_batch@spin-each.html
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-apl2/igt@gem_spin_batch@spin-each.html

  * igt@gem_userptr_blits@vma-merge:
    - shard-skl:          NOTRUN -> [FAIL][19] ([i915#3318])
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-skl1/igt@gem_userptr_blits@vma-merge.html

  * igt@gem_workarounds@suspend-resume-context:
    - shard-skl:          [PASS][20] -> [INCOMPLETE][21] ([i915#4939] / [i915#5129])
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11698/shard-skl7/igt@gem_workarounds@suspend-resume-context.html
  ...
  * igt@gen7_exec_parse@basic-rejected:
   ...
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@gen7_exec_parse@basic-rejected.html

  * igt@i915_pm_lpsp@screens-disabled:
    - shard-tglb:         NOTRUN -> [SKIP][23] ([i915#1902])
   [23]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@i915_pm_lpsp@screens-disabled.html

  * igt@i915_pm_rc6_residency@rc6-fence:
    - shard-iclb:         NOTRUN -> [WARN][24] ([i915#2684])
   [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-iclb7/igt@i915_pm_rc6_residency@rc6-fence.html

  * igt@kms_big_fb@4-tiled-addfb-size-overflow:
    - shard-tglb:         NOTRUN -> [SKIP][25] ([i915#5286]) +1 similar issue
   [25]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@kms_big_fb@4-tiled-addfb-size-overflow.html

  * igt@kms_big_fb@x-tiled-32bpp-rotate-90:
    - shard-iclb:         NOTRUN -> [SKIP][26] ([fdo#110725] / [fdo#111614])
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-iclb7/igt@kms_big_fb@x-tiled-32bpp-rotate-90.html

  * igt@kms_big_fb@y-tiled-max-hw-stride-32bpp-rotate-0-async-flip:
    - shard-skl:          NOTRUN -> [FAIL][27] ([i915#3743])
   [27]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-skl7/igt@kms_big_fb@y-tiled-max-hw-stride-32bpp-rotate-0-async-flip.html

  * igt@kms_big_fb@yf-tiled-max-hw-stride-64bpp-rotate-180:
    - shard-tglb:         NOTRUN -> [SKIP][28] ([fdo#111615]) +1 similar issue
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@kms_big_fb@yf-tiled-max-hw-stride-64bpp-rotate-180.html

  * igt@kms_big_joiner@invalid-modeset:
    - shard-tglb:         NOTRUN -> [SKIP][29] ([i915#2705])
   [29]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@kms_big_joiner@invalid-modeset.html

  * igt@kms_ccs@pipe-a-missing-ccs-buffer-y_tiled_gen12_mc_ccs:
    - shard-glk:          NOTRUN -> [SKIP][30] ([fdo#109271] / [i915#3886])
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-glk7/igt@kms_ccs@pipe-a-missing-ccs-buffer-y_tiled_gen12_mc_ccs.html
    - shard-apl:          NOTRUN -> [SKIP][31] ([fdo#109271] / [i915#3886])
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102665v10/shard-apl3/igt@kms_ccs@pipe-a-missing-ccs-buffer-y_tiled_gen12_mc_ccs.html
...
<p>Serious unknown changes coming with Patchwork_102665v10_full absolutely =
need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br=
 />
  introduced in Patchwork_102665v10_full, please notify your bug team to al=
low them<br />
...
<ul>
<li>igt@kms_ccs@pipe-b-crc-primary-basic-4_tiled_dg2_rc_ccs:<ul>
<li>shard-tglb:         NOTRUN -&gt; <a href=3D"https://intel-gfx-ci.01.org=
/tree/drm-tip/Patchwork_102665v10/shard-tglb7/igt@kms_ccs@pipe-b-crc-primar=
y-basic-4_tiled_dg2_rc_ccs.html">SKIP</a></li>
</ul>
</li>
</ul>
<h4>Suppressed</h4>
...
/tree/drm-tip/Patchwork_102665v10/shard-rkl-6/igt@kms_plane_scaling@plane-d=
ownscale-with-pixel-format-factor-0-5@pipe-b-edp-1.html">SKIP</a> +3 simila=
r issues</li>
</ul>
</li>
<li>
...
/tree/drm-tip/Patchwork_102665v10/shard-tglu-5/igt@kms_plane_scaling@plane-=
downscale-with-rotation-factor-0-75@pipe-d-hdmi-a-1.html">SKIP</a> +44 simi=
lar issues</li>
</ul>
</li>
<li>
...
-unity-scaling-downscale-factor-0-25@pipe-b-hdmi-a-1.html">SKIP</a> +31 sim=
ilar issues</li>
</ul>
</li>
</ul>

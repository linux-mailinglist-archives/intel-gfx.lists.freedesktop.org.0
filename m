...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D219A32039
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Feb 2025 08:46:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1031F10E7DE;
	Wed, 12 Feb 2025 07:46:04 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="YjTKzsun";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CCF2C10E7DD;
 Wed, 12 Feb 2025 07:46:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739346362; x=1770882362;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/r5qThd50z2Y3YwWEx3SYbLK8amWZkVts+uN8jspHjY=;
 b=YjTKzsunDnRPQEB1gVX+m5bsqt5RyTbvJt/Y64RTzxUtD8wqltPpbhw8
 99zffvqZ9DVmLRrupeJKZ+PGATTzGM1nc04NnAHuPOUEA/HeaTI8v5/IF
 YXX8/QuI72+giFz9LAdwxLAEAM1a+l06I1mw4plD2TkGofvmINiM6OnaQ
 WNz9C5SIY5caJRqLDch92N9nqEc0Zydxtu0SQXNiS/wAQNv4HNjbJnbyn
 BCoJGUTiLgms29m+qFRLAUfsnYGhJe/NXG4fqXhg+cgWpzGZcZ2pqg2sO
 plIOD5gq73WJDZ92TSVJ2TIRV1nc2Z79SG+BfT02Ote1UgdpOhwW8kFum w==;
X-CSE-ConnectionGUID: AAEss62XTaCXv2SQCz+zVQ==
X-CSE-MsgGUID: 6PS68oLkQ8aScodJLtbN2Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11342"; a="39906738"
X-IronPort-AV: E=Sophos;i="6.13,279,1732608000"; d="scan'208";a="39906738"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa113.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Feb 2025 23:46:02 -0800
X-CSE-ConnectionGUID: n6kc+Gc1SvyaI5lQI4bWCA==
X-CSE-MsgGUID: kqJCqXaDRXmJPc41hP78wQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="112601100"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa010.jf.intel.com with ESMTP; 11 Feb 2025 23:45:59 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-xe@lists.freedesktop.org,
	intel-gfx@lists.freedesktop.org
Cc: Suraj Kandpal <suraj.kandpal@intel.com>,
 Jani Nikula <jani.nikula@intel.com>
Subject: [PATCH 4/8] drm/i915/dpll: Use intel_display possible in
 shared_dpll_mgr hooks
Date: Wed, 12 Feb 2025 13:15:38 +0530
Message-Id: <20250212074542.3569452-5-suraj.kandpal@intel.com>
...
index 8e319399205a..2c05742d8fd1 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 92857286897
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Oct 2020 21:50:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E3C096E98B;
	Wed,  7 Oct 2020 19:50:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7018D6E98B
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Oct 2020 19:50:16 +0000 (UTC)
IronPort-SDR: 5GfxLNj2wkeoD6jdTRZoIH5kZxXsvbEBdFcEghFhesgsSxHjckSdC15KlDmqolTHwHbVOABhEZ
 /5o3r6iw/bpg==
X-IronPort-AV: E=McAfee;i="6000,8403,9767"; a="144457288"
X-IronPort-AV: E=Sophos;i="5.77,348,1596524400"; d="scan'208";a="144457288"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Oct 2020 12:49:20 -0700
IronPort-SDR: d253ryKnE3FwNr/KvzOcRDirRutT+zxDOSuW7rY/B40kUi/8ENg/KYAvqlSEa6d6gown+3W4x0
 xXKvqt09zCBQ==
X-IronPort-AV: E=Sophos;i="5.77,348,1596524400"; d="scan'208";a="528129163"
...
Message-Id: <20201007195238.53955-2-jose.souza@intel.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <20201007195238.53955-1-jose.souza@intel.com>
References: <20201007195238.53955-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 2/3] drm/i915/display: Check PSR parameter

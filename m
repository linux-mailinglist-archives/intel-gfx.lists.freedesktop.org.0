...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2290A12F80F
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jan 2020 13:15:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E53589DBC;
	Fri,  3 Jan 2020 12:15:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D119689FC8
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 Jan 2020 12:15:25 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19759415-1500050 
 for multiple; Fri, 03 Jan 2020 12:15:07 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 Jan 2020 12:15:05 +0000
Message-Id: <20200103121505.1862904-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/selftests: Extend fault handler
...
@@ -887,32 +1005,24 @@ static int prefault_range(u64 start, u64 len)
...
+		return addr;
 	...
 	if (err)
@@ -922,8 +1032,10 @@ static int igt_mmap_revoke(void *arg, enum i915_mmap_type type)
...
@@ -947,24 +1059,44 @@ static int igt_mmap_revoke(void *arg, enum i915_mmap_type type)
 	}
...
@@ -973,10 +1105,8 @@ int i915_gem_mman_live_selftests(struct drm_i915_private *i915)

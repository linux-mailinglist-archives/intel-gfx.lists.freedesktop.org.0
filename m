...
Received: from mail.lfdr.de
	...
	id dffyEyffRGqt2QoAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 01 Jul 2026 11:34:31 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A3B576EBA09
	for <lists+intel-gfx@lfdr.de>; Wed, 01 Jul 2026 11:34:30 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=intel.com header.s=Intel header.b=LGMgNlq2;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org;
	dmarc=pass (policy=none) header.from=intel.com
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18C9C10E23A;
	Wed,  1 Jul 2026 09:34:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E7B73890C7;
 Wed,  1 Jul 2026 09:34:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1782898467; x=1814434467;
 h=date:from:to:cc:subject:in-reply-to:message-id:
 references:mime-version;
 bh=D5CDx1QwQ+MPTtsjiw+GbQRoOnJ2N/YZU/57WHZJVQg=;
 b=LGMgNlq2nk2wgmM4ZRdnCKU6PNlqBRnCPydv/8Vbyfo4SOwdSq/I1LM2
 Wa+wUVHzLI4CrZosG95cw/XXRYnvhU7+IH+DOYHy3eAvczH8Lm1q1iTwp
 /a0nBU4f1AABcktcoZU/B9BCHJC1VNDXpvDyEA/BZy+l2beuMavtCaXoP
 I7+CVrFE635r1OU443K8fUJuPkuCtZoKUOifZikDqKfmniHz8+N6dGwIq
 KqmCmd7uvctoJPaSy6LPOTw6E1k+nlUMzKXWopYjKkZUxwSKLMJQzrdL7
 rn7yoIIEGcHx/RyI0fspfllTkfAGyqr3KsM4gqtMccubLijogkHew0joo Q==;
X-CSE-ConnectionGUID: gpmT25zQQDeNgNFjA9elbw==
X-CSE-MsgGUID: 48gNvwFZSVSecJl8Bma5FQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11833"; a="94780176"
X-IronPort-AV: E=Sophos;i="6.24,235,1774335600"; d="scan'208";a="94780176"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jul 2026 02:34:26 -0700
X-CSE-ConnectionGUID: 47VQFFIPSZWNNVgloEG+SQ==
X-CSE-MsgGUID: DkZ9b8HZTR+94pT6oZCxVw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.24,235,1774335600"; d="scan'208";a="248538002"
Received: from dev-417.igk.intel.com ([10.91.214.181])
 by fmviesa010.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jul 2026 02:34:24 -0700
Date: Wed, 1 Jul 2026 11:34:22 +0200 (CEST)
...
In-Reply-To: <DS4PPFE901A304F32A1305578BC68609A2AE3F62@DS4PPFE901A304F.namprd11.prod.outlook.com>
Message-ID: <33a597bb-b844-1a7a-2c50-5d83252a6ee9@intel.com>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="8323329-1169446020-1782898465=:605841"
...
X-Rspamd-Queue-Id: A3B576EBA09

  This message is in MIME format.  The first part should be readable text,
  while the remaining parts are likely unreadable without MIME-aware tools.

--8323329-1169446020-1782898465=:605841
...
>> ddi_buf_trans_entry on intel_bios_init() and overwrites it with deparsed data
>> from VBT#57 on each encoder->get_buf_trans() call. Remove const qualifier
>> from definition of struct intel_ddi_buf_trans_entry in order to avoid discarding
>> const qualifier by casting to (void *). Doing so requires deconstifying DDI tables
>> as well.
>
> These are predefined tables and we don’t want them changing which is why we kept them as const.
> What was the issue we were facing with the previous way of doing things in the previous revisions.
> Currently I don’t think it’s the best thing to remove const here.
...
[1] https://lore.kernel.org/intel-gfx/e60ee78abc4044c8ecf33c2e85e89aa638bfdaaf@intel.com/
...
>>  	{ .hsw = { 0x00C30FFF, 0x00040006, 0x0 } }, @@ -33,7 +33,7 @@ static
>> const struct intel_ddi_buf_trans hsw_trans_dp = {
...
>>  	{ .hsw = { 0x00C30FFF, 0x00060006, 0x0 } }, @@ -50,7 +50,7 @@ static
>> const struct intel_ddi_buf_trans hsw_trans_fdi = {
...
>>  							/* Idx	NT mV d
>> 	T mV d	db	*/
>>  	{ .hsw = { 0x00FFFFFF, 0x0006000E, 0x0 } },	/* 0:	400	400
>> 	0	*/
...
>>  	{ .hsw = { 0x00C71FFF, 0x0006000F, 0x0 } }, @@ -89,7 +89,7 @@ static
>> const struct intel_ddi_buf_trans bdw_trans_edp = {
...
>>  	{ .hsw = { 0x00BEFFFF, 0x00140006, 0x0 } }, @@ -106,7 +106,7 @@
...
>>  	{ .hsw = { 0x00C30FFF, 0x00070006, 0x0 } }, @@ -123,7 +123,7 @@
...
>>  							/* Idx	NT mV d
>> 	T mV df	db	*/
>>  	{ .hsw = { 0x00FFFFFF, 0x0007000E, 0x0 } },	/* 0:	400	400
>> 	0	*/
>>  	{ .hsw = { 0x00D75FFF, 0x000E000A, 0x0 } },	/* 1:	400	600
>> 	3.5	*/
...
>>  	{ .hsw = { 0x00007011, 0x00000088, 0x0 } }, @@ -162,7 +162,7 @@
...
>>  	{ .hsw = { 0x80007011, 0x000000CD, 0x1 } }, @@ -180,7 +180,7 @@
...
>>  	{ .hsw = { 0x00005012, 0x00000088, 0x0 } },
>>  	{ .hsw = { 0x80007011, 0x000000CD, 0x3 } }, @@ -198,7 +198,7 @@
...
>>  	{ .hsw = { 0x00002016, 0x000000A0, 0x0 } },
>>  	{ .hsw = { 0x00005012, 0x0000009B, 0x0 } },
>>  	{ .hsw = { 0x00007011, 0x00000088, 0x0 } }, @@ -216,7 +216,7 @@
...
>>  	{ .hsw = { 0x00005012, 0x00000088, 0x0 } },
>>  	{ .hsw = { 0x80007011, 0x000000CD, 0x3 } }, @@ -234,7 +234,7 @@
...
>>  	{ .hsw = { 0x00005012, 0x00000088, 0x0 } },
>>  	{ .hsw = { 0x80007011, 0x000000CD, 0x3 } }, @@ -255,7 +255,7 @@
...
>>  	{ .hsw = { 0x00007011, 0x000000A2, 0x0 } }, @@ -277,7 +277,7 @@
...
>>  	{ .hsw = { 0x00000018, 0x000000A8, 0x0 } },
>>  	{ .hsw = { 0x00004013, 0x000000A9, 0x0 } },
>>  	{ .hsw = { 0x00007011, 0x000000A2, 0x0 } }, @@ -299,7 +299,7 @@
...
>>  	{ .hsw = { 0x00007011, 0x000000A4, 0x0 } }, @@ -318,7 +318,7 @@
...
>>  	{ .hsw = { 0x00007011, 0x00000088, 0x0 } }, @@ -339,7 +339,7 @@
...
>>  	{ .hsw = { 0x80007011, 0x000000CB, 0x3 } }, @@ -359,7 +359,7 @@
...
>> ehl_combo_phy_trans_dp = {
>>  	.num_entries = ARRAY_SIZE(_ehl_combo_phy_trans_dp),
>>  };
>>
>> -static const union intel_ddi_buf_trans_entry
>> _ehl_combo_phy_trans_edp_hbr2[] = {
...
>> ehl_combo_phy_trans_edp_hbr2 = {
>>  	.num_entries = ARRAY_SIZE(_ehl_combo_phy_trans_edp_hbr2),
>>  };
>>
>> -static const union intel_ddi_buf_trans_entry
>> _jsl_combo_phy_trans_edp_hbr[] = {
...
>> jsl_combo_phy_trans_edp_hbr = {
>>  	.num_entries = ARRAY_SIZE(_jsl_combo_phy_trans_edp_hbr),
>>  };
>>
>> -static const union intel_ddi_buf_trans_entry
>> _jsl_combo_phy_trans_edp_hbr2[] = {
...
>> dg1_combo_phy_trans_dp_rbr_hbr = {
>>  	.num_entries = ARRAY_SIZE(_dg1_combo_phy_trans_dp_rbr_hbr),
>>  };
>>
>> -static const union intel_ddi_buf_trans_entry
>> _dg1_combo_phy_trans_dp_hbr2_hbr3[] = {
>> +static union intel_ddi_buf_trans_entry
>> +_dg1_combo_phy_trans_dp_hbr2_hbr3[] = {
>>  							/* NT mV Trans mV db
>> */
...
>> dg1_combo_phy_trans_dp_hbr2_hbr3 = {
...
>>   */
>> -static const union intel_ddi_buf_trans_entry
>> _tgl_combo_phy_trans_edp_hbr2_hobl[] = {
>> +static union intel_ddi_buf_trans_entry
>> +_tgl_combo_phy_trans_edp_hbr2_hobl[] = {
>>  							/* VS	pre-emp
>> 	*/
...
>>
>> -static const union intel_ddi_buf_trans_entry
>> _rkl_combo_phy_trans_dp_hbr2_hbr3[] = {
>> +static union intel_ddi_buf_trans_entry
>> +_rkl_combo_phy_trans_dp_hbr2_hbr3[] = {
>>  							/* NT mV Trans mV db
>> */
...
>>
>> -static const union intel_ddi_buf_trans_entry
>> _adls_combo_phy_trans_dp_hbr2_hbr3[] = {
>> +static union intel_ddi_buf_trans_entry
>> +_adls_combo_phy_trans_dp_hbr2_hbr3[] = {
>>  							/* NT mV Trans mV db
>> */
...
>>
>> -static const union intel_ddi_buf_trans_entry
>> _adls_combo_phy_trans_edp_hbr2[] = {
...
>>
>> -static const union intel_ddi_buf_trans_entry
>> _adls_combo_phy_trans_edp_hbr3[] = {
...
>>
>> -static const union intel_ddi_buf_trans_entry
>> _adlp_dkl_phy_trans_dp_hbr2_hbr3[] = {
>> +static union intel_ddi_buf_trans_entry
>> +_adlp_dkl_phy_trans_dp_hbr2_hbr3[] = {
>>  					/* VS	pre-emp	Non-trans mV
>> 	Pre-emph dB */

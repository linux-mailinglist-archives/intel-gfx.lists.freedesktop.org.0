...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 026773B8616
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 17:11:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 22DE06EA49;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 15/17] drm/uAPI: Move "Broadcast RGB"

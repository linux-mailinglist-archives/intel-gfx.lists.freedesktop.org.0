...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0685555458A
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 13:00:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D6D810EAF3;
...
Subject: [Intel-gfx] [PATCH v3 09/13] drm/i915/bios: convert

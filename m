...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 18CF33EB7FA
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Aug 2021 17:25:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B6886E85A;
	Fri, 13 Aug 2021 15:24:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98A506E85A;
 Fri, 13 Aug 2021 15:24:57 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10075"; a="215569304"
X-IronPort-AV: E=Sophos;i="5.84,319,1620716400"; d="scan'208";a="215569304"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Aug 2021 08:24:51 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.84,319,1620716400"; d="scan'208";a="508292356"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
 by fmsmga004.fm.intel.com with ESMTP; 13 Aug 2021 08:24:51 -0700
Received: from orsmsx607.amr.corp.intel.com (10.22.229.20) by
 ORSMSX602.amr.corp.intel.com (10.22.229.15) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2242.10; Fri, 13 Aug 2021 08:24:50 -0700
...
Received: from ORSEDG602.ED.cps.intel.com (10.7.248.7) by
 ...
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2242.10 via Frontend Transport; Fri, 13 Aug 2021 08:24:49 -0700
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (104.47.58.173)
 by edgegateway.intel.com (134.134.137.103) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2242.10; Fri, 13 Aug 2021 08:24:49 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=yRuPsAvVL7ABiw4XaDJl9zgEz/Y62nW5hgfo9wk+11Y=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=intel.onmicrosoft.com; 
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=yRuPsAvVL7ABiw4XaDJl9zgEz/Y62nW5hgfo9wk+11Y=;
 b=y/9gcME8z2m1nTrQ0CO4GFXWBCDU0vuWs3ckV1K3EWD7xm2zNmqzN72v5dzxPegnz/TKQNFCY+QhQC/hh4PB1BcNJGFFywNCawPO7JkLzZbuCkyuelLc90jG5ni1Hp5Prswr6yV5jtH8K8fSruOCGyuTUQTb/2dI2kR2TBrP2Fc=
Authentication-Results: intel.com; dkim=none (message not signed)
 header.d=none;intel.com; dmarc=none action=none header.from=intel.com;
Received: from DM4PR11MB5488.namprd11.prod.outlook.com (2603:10b6:5:39d::5) by
 DM5PR11MB1708.namprd11.prod.outlook.com (2603:10b6:3:d::16) with
 Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.4415.16; Fri, 13 Aug 2021 15:24:47 +0000
...
References: <20210729020106.18346-1-daniele.ceraolospurio@intel.com>
 ...
 <YRaDwS+dUMjbgd+z@phenom.ffwll.local> <YRaEwdeP4U2W+q5i@phenom.ffwll.local>
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
Message-ID: <3abe466f-3c7f-da5b-9ea0-de686bddf749@intel.com>
Date: Fri, 13 Aug 2021 08:24:44 -0700
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:78.0) Gecko/20100101
 Firefox/78.0 Thunderbird/78.12.0
In-Reply-To: <YRaEwdeP4U2W+q5i@phenom.ffwll.local>
Content-Type: text/plain; charset=utf-8; format=flowed
Content-Transfer-Encoding: 7bit
Content-Language: en-US
X-ClientProxiedBy: MWHPR2001CA0009.namprd20.prod.outlook.com
 (2603:10b6:301:15::19) To DM4PR11MB5488.namprd11.prod.outlook.com
 (2603:10b6:5:39d::5)
MIME-Version: 1.0
X-MS-Exchange-MessageSentRepresentingType: 1
Received: from [192.168.1.65] (99.72.232.53) by
 MWHPR2001CA0009.namprd20.prod.outlook.com (2603:10b6:301:15::19) with
 Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.4415.13 via Frontend
 Transport; Fri, 13 Aug 2021 15:24:46 +0000
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: d59bdbaf-63b9-4ac7-6c00-08d95e6e7c5a
X-MS-TrafficTypeDiagnostic: DM5PR11MB1708:
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <DM5PR11MB17086D562867D50EE2B72F72F4FA9@DM5PR11MB1708.namprd11.prod.outlook.com>
X-MS-Oob-TLC-OOBClassifiers: OLM:10000;
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DM4PR11MB5488.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(4636009)(39860400002)(376002)(346002)(366004)(136003)(396003)(66556008)(31696002)(6486002)(66476007)(8936002)(66946007)(8676002)(36756003)(966005)(956004)(38100700002)(31686004)(30864003)(4326008)(83380400001)(5660300002)(53546011)(2616005)(107886003)(54906003)(2906002)(6916009)(26005)(316002)(86362001)(16576012)(478600001)(186003)(43740500002)(45980500001);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?VXhWdkIyM1NRdnFCdUY4WFVGVXhPWFBWSUNGTzJqUkEwYzkrcHJpTkFJUERG?=
 =?utf-8?B?Qm9kWDNWOUVpWFdVUTZURW03NW1Ca3FHU1pjd0Y1djNBNHg0d3dQbHREV3hU?=
 =?utf-8?B?UG1tSmJLWEtueEk5bTBtSTBWWVdTTXpaR2MzL092QWJQdms5cDJERitFNUR1?=
 =?utf-8?B?SHlKcDZWUDBKS2ZCQ0VnTm9aNmRBc0FMRjFKSnZjRFlQckVmNXBXOEtJM09W?=
 =?utf-8?B?a0VVMEpxcTRJTE9UbGhtQ3ZZcWtTRzVJbVo0TzU1OXZLalVrckVuc1ZpODB3?=
 =?utf-8?B?ZU9ZcGNCU2N2Q3RoakpFazgxZDRYTVFLbzZsS3ZqaEY5U3A4WFN2VlZmcjdK?=
 =?utf-8?B?L2hGTUtnRlpVcmJDalNTbG5abGN3bDhGalQwOHVPL28xRHBocFozbFhZK21v?=
 =?utf-8?B?TTZQQW5KTlVmNDYvMitYWkxxZVUwaDRIRGpXT1BQOUtRSFVMcW4wc2k5WENK?=
 =?utf-8?B?K2tsTzlkSXJvdmhrU2lyZks4RDk2VkI4c0tTcEYxaW5rWXJqeHJvNzA3cjBN?=
 =?utf-8?B?dFZmY0hzRXB1TkpRV2FGMHlHbmozTHM1bFNDeFRhSHU5dWZJaHl5YkpJMHBw?=
 =?utf-8?B?NGRuKzBKRXR4TG1zTi94WkhidlJHM0s5Qi85dThIRExWZTZ4T2JOM2NTQTRy?=
 =?utf-8?B?ZVhlWVhKOU5FeVV3Q1hFeVpXOXJLM2ZlUjVzQmpPTHBYNEgvdEM2alVFYlVu?=
 =?utf-8?B?NlNnNnhlNGFIdkozaGpRM2lFWWQyUnJGVWNNS2FQR3RFTW9yNnF6TG43bGZs?=
 =?utf-8?B?QWY0Y0ttYzVYUVdUeWQ4aFpOMDZmTGN0eTEzcEpkNGRQL2V4bTRkdU9oMWNS?=
 =?utf-8?B?VXpoOFMxK0taVmQ0dWtPc3NOWWwyaGorejVCTjR4K2JXaTF2dzdiK09CbFZw?=
 =?utf-8?B?K3VPMVc2NXFlSEFwS2ZlZHNGNkUzUEFEdE13WnQrSW9RUHowZkNhVVNvT29Y?=
 =?utf-8?B?dHFrVFFhTEtXSzhsVzFKYVN2clhsMG9wQVlTbUhsbDZ0emZWVGVwWWhubEhU?=
 =?utf-8?B?eXdsRkVEUlFmYlE4ZWZNYzJGRnowTmo0cFVma1dUL1RJYTk2NGtMcDQ1NWVC?=
 =?utf-8?B?NW5UQ3ZZdk8zemlUL0FUUjY0QlpLSUFsTU51MWRIKzl0RklSOGhVMFBVSmlw?=
 =?utf-8?B?ODcxNmZLU3NUZHpVUEFIYTJKZEtWdjNOWm9qc2hPZzh3cVBwaWoyT3plb0VI?=
 =?utf-8?B?aC8wR1ZnTmFuNTE3SlZMM2hyZEd4QllVcmMzcVZYSTdabVRON2djb0dzdlpv?=
 =?utf-8?B?b2YvTTFJNlVCK0syNFU3bDhzc1VyNmgzeGV0RmY4VjNuc0tzd05MZ1VQS3ZL?=
 =?utf-8?B?Zm4zb3RJRGN6UGxXaEFoR2lmbmN6aTJIcytXVmh4dmV3TDdHMXV1b2JGYlB3?=
 =?utf-8?B?NlNkSk0zVGhQS1R3eDdEQmt6OW1FQXRtMVd6TmxNUTZhK1J1bzh6MjdzQTRP?=
 =?utf-8?B?N3ZZZ2N4Rm5PbXVWM1ZzU2F3S1RZWlZ1cjA4Rk1JcU0rOHd0bW1wV0ZvWUE3?=
 =?utf-8?B?V2cwQ1B0aWU0K2tVUEwxK1BtUkVKOEtzZWt3ZGtURzlpbnhCQ29oamd6cVZ2?=
 =?utf-8?B?T04yTlVKVXNhdWJyMG01NmFNcjcydWFaNUNwYzg3Y1ZNZmtodDFrMFI5V2wx?=
 =?utf-8?B?dGdBNDNaTVZPTEMraWwzTVppYlpNMXBXUTNJTG9ISW5yL3E1WWhVZ1F4UE03?=
 =?utf-8?B?Q1lsdGVWQWJSL3hDTlE2bzYxZnAxZGdyK3hrUjRqbnpFZ2Z3RWVWU1pOK3Fy?=
 =?utf-8?Q?Pl5+dyCdicth6oYSLaiIbTfpZnBhpJcQM/sNoPc?=
X-MS-Exchange-CrossTenant-Network-Message-Id: d59bdbaf-63b9-4ac7-6c00-08d95e6e7c5a
X-MS-Exchange-CrossTenant-AuthSource: DM4PR11MB5488.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 13 Aug 2021 15:24:47.7162 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: 4/7ROam0LvS2f4rOeAlKKXcY7AR10bs+m7v2K+6mJHypkKYecH5LoXtsZqvUN666DWnNo/S1OXz9BL0QImDTziA54bKr5XfYE2wjfM8z7V0=

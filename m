...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A704139711A
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Jun 2021 12:16:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 700076E9ED;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/21] drm/i915/xelpd: Enable plane color
 features

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F5004A8CE1
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Feb 2022 21:04:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4ABE610E22B;
...
Subject: [Intel-gfx] [PATCH v4 2/4] drm/i915/gt: Drop invalidate_csb_entries

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DDEEA656CEC
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Dec 2022 17:33:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFB2210E157;
...
Subject: [Intel-gfx] [PATCH] drm/i915: convert i915_active.count from

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCDAF4BEDC4
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:18:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD0DF10E543;
	Mon, 21 Feb 2022 23:18:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 17F8210E540;
 Mon, 21 Feb 2022 23:18:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485505; x=1677021505;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qlFqLRfrfrx4mNRF6vVIBqvEiaofH2gyPUSV1nRx1WA=;
 b=KASM6Y9KMQfRjnCeyC7ZVti2V9eDMvR55IoMg4ABayZ6rBah4sUnF3h3
 v19FQV5Fs6ap/VbUf+GmMkyqO8u4XIeg3XeLxuNk0wg+W6mc2dKmvekQs
 Pu8U5o73IodlePrQDqmEGxDNjQ20XiNo9FOznHs1Prb2l6bCW7hhyjlX5
 dn/Bggs3v3dXYHDbs9olOBrJzJ8oD6e8Vthnn9iCSp2cbsCc2hEx4r71u
 8TWoUuEJSqLJKY0wBfzfwC8NLyOGHbsUnnAHIwxg2MxodOCk5gnsFKlBA
 kY8TtNoB0JSMu8JQI4ClVqPfFbVXyY+ZAqy2fS3elXJZRiKx28jl/pZkl Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="238996059"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="238996059"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:18:24 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="638694621"
...
Subject: [Intel-gfx] [PATCH v2 09/11] drm/i915: Track leaked gt->wakerefs

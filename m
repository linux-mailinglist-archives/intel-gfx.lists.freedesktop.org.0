...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4669C6A9AD8
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Mar 2023 16:41:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 88EFB10E6C6;
...
Subject: Re: [Intel-gfx] [Freedreno] [PATCH v9 15/15] drm/i915: Add deadline
 based boost support
...
Cc: dri-devel@lists.freedesktop.org, David Airlie <airlied@gmail.com>,
 Sumit Semwal <sumit.semwal@linaro.org>, Rob Clark <robdclark@chromium.org>,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FB4A21FF76
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD8146EA02;
...
Subject: [Intel-gfx] [PATCH v2 54/59] drm/kmb: Initialize uninitialized
 variables

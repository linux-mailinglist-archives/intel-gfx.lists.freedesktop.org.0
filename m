...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 53E55B3C48C
	for <lists+intel-gfx@lfdr.de>; Sat, 30 Aug 2025 00:01:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D8C510EC3D;
	Fri, 29 Aug 2025 22:01:15 +0000 (UTC)

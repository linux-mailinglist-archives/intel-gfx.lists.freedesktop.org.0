...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 087F158B20F
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Aug 2022 23:58:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 50319A71D1;
...
Subject: [Intel-gfx] [PATCH v5 22/33] drm_print: condense enum
 drm_debug_category

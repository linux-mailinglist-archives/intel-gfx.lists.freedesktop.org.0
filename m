...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C915153A99A
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Jun 2022 17:08:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A8AA510EC4E;
...
Subject: [Intel-gfx] [PATCH v5 4/6] drm/i915/sseu: Don't try to store EU

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B4A54C540C
	for <lists+intel-gfx@lfdr.de>; Sat, 26 Feb 2022 06:53:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4383C10ED12;
	Sat, 26 Feb 2022 05:53:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A25FC10ECFE
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=C+1R4IU0DPTBW/wImrL2dRe7Q1wiNFc0StEVNUCXHxk=;
 b=HnbOjfFzBUFw5L5oTpCuTGLxDyeEQ+XxNkBKw4qSfApkWr7GaIaZ4UMy
 H0mqDNZXU1MPREZmW95/ucD+GcK8v4zEKVCFeCmk6r2fXEq9UYzK29cZf
 jBPDowbsoUUnlzSPl0QNCi8IhX8XkndSC49BtmxHdFuNVGPEJLGIszkmc
 PJXnFyeATXyifq3q212CEjI+DBiDjMdAWoM2tukDeScRhQkFACicZpI0Z
 kLB1FTjuuovnf2RQFBiW8WRYIs/X9a7X3jygYUEk8Wue1gjTz+MaSiz1R
 4eEq195GkfZdfM6USj6CPad82aXYAUm7oFK/OKb1iYh9NsKWSXiftZmvA Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10269"; a="277274593"
X-IronPort-AV: E=Sophos;i="5.90,138,1643702400"; d="scan'208";a="277274593"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Feb 2022 21:53:16 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,138,1643702400"; d="scan'208";a="574817091"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga001.jf.intel.com with ESMTP; 25 Feb 2022 21:53:16 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 25 Feb 2022 21:55:23 -0800
Message-Id: <20220226055526.665514-11-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 10/13] drm/i915/guc: Extract GuC error
...
index 734164e72e33..7c4f1e4ae0a5 100644
...
+
  ...
  *
@@ -139,6 +185,16 @@ struct __guc_state_capture_priv {
...
index 3bca38753c6b..492719137bd5 100644
...
@@ -642,6 +644,9 @@ int intel_guc_capture_output_min_size_est(struct intel_guc *guc)
...
@@ -660,7 +665,7 @@ int intel_guc_capture_output_min_size_est(struct intel_guc *guc)
...
+					 (3 * sizeof(struct guc_state_capture_header_t));
 		...
 		if (!intel_guc_capture_getlistsize(guc, 0, GUC_CAPTURE_LIST_TYPE_GLOBAL, 0, &tmp))
 			num_regs += tmp;
@@ -680,6 +685,541 @@ int intel_guc_capture_output_min_size_est(struct intel_guc *guc)
...
+
 ...
 {
@@ -704,6 +1244,8 @@ void intel_guc_capture_destroy(struct intel_guc *guc)
...
@@ -721,5 +1263,7 @@ int intel_guc_capture_init(struct intel_guc *guc)
...
index 0eadd27119e5..6b73a0ea8df1 100644
...
index b3a429a92c0d..c089244e7455 100644
...
+#include "intel_guc_capture.h"
 ...
 #include "i915_drv.h"
@@ -4067,17 +4068,18 @@ int intel_guc_context_reset_process_msg(struct intel_guc *guc,

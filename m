...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76A6F12A00B
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Dec 2019 11:21:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2016F89E3F;
...
Subject: Re: [Intel-gfx] [PATCH 6/8] iommu: allow the dma-iommu api to use
 bounce buffers

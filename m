...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 801B93E4AAB
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Aug 2021 19:17:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DBE1B89BFF;
	Mon,  9 Aug 2021 17:17:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x435.google.com (mail-wr1-x435.google.com
 [IPv6:2a00:1450:4864:20::435])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 84A3189C27
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Aug 2021 17:17:31 +0000 (UTC)
Received: by mail-wr1-x435.google.com with SMTP id b13so22436149wrs.3
 for <intel-gfx@lists.freedesktop.org>; Mon, 09 Aug 2021 10:17:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=56hgnoAhzHdDc1cs1XVk2H6+sv2Sz+YDCei80cOwmMA=;
 b=WLvb5u2Rfe+5bsepCteXy6TasOSHOjltDjVDU7UFx4uubj1bzBmcIBGoi+V0w4b2fj
 nD/0Z63ngylSpPpF+hximpwIvekvRiM6z5uY7re2aupFpcR1olkeXXdTG0MuGWGAB4Jx
 IGPlecUnWmyr6wKwc/IW14wIRWadN7XCCtbD8=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=56hgnoAhzHdDc1cs1XVk2H6+sv2Sz+YDCei80cOwmMA=;
 b=
X-Gm-Message-State: AOAM531ipTmonMZto+GYd13NIloXLFC0PXYkS3kCe2IRNi6UAM2jausK
 oZVHNB+iL6hyN4ZLrfCH+OeLTQ==
X-Google-Smtp-Source: ABdhPJxk7AlU3wcf7Nr+gRtEfYPU/qsSXA9JaaD5mcF6v6cVaP4f27Ri9sY2bsEtCtqTAiv26rJCGw==
X-Received: by 2002:adf:dd47:: with SMTP id u7mr8727537wrm.425.1628529449817; 
 Mon, 09 Aug 2021 10:17:29 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id g6sm8536319wmq.42.2021.08.09.10.17.29
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 09 Aug 2021 10:17:29 -0700 (PDT)
Date: Mon, 9 Aug 2021 19:17:27 +0200
From: Daniel Vetter <daniel@ffwll.ch>
To: Matthew Brost <matthew.brost@intel.com>
Cc: intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org
Message-ID: <YRFjJy/7eWLo/eaL@phenom.ffwll.local>
References: <20210803222943.27686-1-matthew.brost@intel.com>
 <20210803222943.27686-47-matthew.brost@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20210803222943.27686-47-matthew.brost@intel.com>

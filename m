...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 48A1A605A17
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Oct 2022 10:41:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9793110E48C;
	Thu, 20 Oct 2022 08:41:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CD5D110E45E;
 Thu, 20 Oct 2022 08:41:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666255261; x=1697791261;
 h=date:from:to:cc:subject:message-id:mime-version;
 bh=uZ7D7GmHnKnuInxz+byT/LywDD8QHWF6OFK/OY3iQqc=;
 b=JM5yZtBKErwmM6DKpaz7z+bHkn6rjfqdcChiEi59ciYaweYPmn9DURJn
 5vb83tBHenTL0uY504bCHBtgwLvlazRbvibSHSb9y5ECQoafqJH2OWZ/d
 eJsxAUkpChGdNlWBz6gUPengXavkJIeMt0LnljKABhkGh+gFe2bElK5Jy
 n8qKs5IMrNeCXa0z8Qp1mI33pDxkZax5w+zomAB7PsXfFtWKm3qqN/MfC
 d9Jltgf5g33O1ZF6iPM4lCzWJ7AWhofGVbCrPsrfbJ2lEx8ZghcDSjZmD
 snJ6PcLl4aKLfa4dDaayiUXk7g0dOSIzvRzekYpAjoA1KNexjwJLO/RRx w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="392953934"
X-IronPort-AV: E=Sophos;i="5.95,198,1661842800"; d="scan'208";a="392953934"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Oct 2022 01:41:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="718931441"
X-IronPort-AV: E=Sophos;i="5.95,198,1661842800"; d="scan'208";a="718931441"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
 by FMSMGA003.fm.intel.com with ESMTP; 20 Oct 2022 01:40:57 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1olR6n-00014B-14;
 Thu, 20 Oct 2022 08:40:57 +0000
Date: Thu, 20 Oct 2022 16:39:58 +0800
From: kernel test robot <lkp@intel.com>
To: "Rafael J. Wysocki" <rjw@rjwysocki.net>
Message-ID: <202210201607.z9XGZ4q2-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="4Fhtlp8OnLRApL3H"
Content-Disposition: inline
Subject: [Intel-gfx] [drm-intel:topic/core-for-CI 27/28]
 drivers/rtc/rtc-cmos.c:1482:2: error: call to undeclared function
 'rtc_wake_setup';
...
>> drivers/rtc/rtc-cmos.c:1482:2: error: call to undeclared function 'rtc_wake_setup'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
           rtc_wake_setup(&pdev->dev);
           ^
   drivers/rtc/rtc-cmos.c:1482:2: note: did you mean 'cmos_wake_setup'?
   drivers/rtc/rtc-cmos.c:1340:13: note: 'cmos_wake_setup' declared here
   static void cmos_wake_setup(struct device *dev)
               ^
   1 error generated.


vim +/rtc_wake_setup +1482 drivers/rtc/rtc-cmos.c

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 80B01F1686
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Nov 2019 14:04:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7019F6ED22;
	Wed,  6 Nov 2019 13:04:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E2D516E228
 for <intel-gfx@lists.freedesktop.org>; Wed,  6 Nov 2019 13:04:24 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19102015-1500050 
 for multiple; Wed, 06 Nov 2019 13:04:18 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  6 Nov 2019 13:04:15 +0000
Message-Id: <20191106130416.23076-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/4] drm/i915/selftests: Wrap vm_mmap() around
 GEM objects
...
LmY1YmM4MGU5MjU3MwotLS0gL2Rldi9udWxsCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L3Nl
...
Y2FyZDAiKSAqLworCWZpbGUgPSBhbm9uX2RybV9nZXRmaWxlKGk5MTUtPmRybS5wcmltYXJ5LCBP

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDC033D0093
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 19:43:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA6AF6E4FE;
...
Subject: [Intel-gfx] [PATCH v2 06/14] vfio/fsl: Move to the device set
 infrastructure

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 379C74B9BE0
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 10:19:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B0AC10E8D7;
...
Subject: Re: [Intel-gfx] [PATCH v2 3/3] drm/i915/gem: Don't try to map and
 fence large scanout buffers (v8)

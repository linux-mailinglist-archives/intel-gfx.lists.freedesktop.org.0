...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D9B2738F75E
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 03:09:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9B84889C82;
...
Subject: Re: [Intel-gfx] [RFC PATCH 28/97] drm/i915/guc: Kill
 guc_clients.ct_pool

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A5B34AB4EDB
	for <lists+intel-gfx@lfdr.de>; Tue, 13 May 2025 11:10:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17AC910E4F5;
	Tue, 13 May 2025 09:10:56 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="MI0x/0Ih";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BF16810E4F5
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 May 2025 09:10:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1747127453;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=xRw8K0GCG9Y9Bw/zOLR2bmWzH8I8Xdc1bw9RZcjFhAY=;
 b=MI0x/0IhtK6rY3xvHUaUISg2VQP6I+76+q4SU9llQcRO8z8x6KwldXMn79xkM+D9C6jpFD
 U9Sp2W/AB7YiFx92i1ma61yxpamEidlQL0tEbqKvoMHuE/eYJsaDYAuuIXkr0J/ZOm9erR
 YGhYHqHnSE12zKRyHrrG7dZsXB24w2w=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-331-zKERFj37Ofuh5kxWvlsZpg-1; Tue, 13 May 2025 05:10:49 -0400
X-MC-Unique: zKERFj37Ofuh5kxWvlsZpg-1
X-Mimecast-MFC-AGG-ID: zKERFj37Ofuh5kxWvlsZpg_1747127448
Received: by mail-wr1-f71.google.com with SMTP id
 ffacd0b85a97d-3a0b9bbfb0fso2949216f8f.1
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 May 2025 02:10:49 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=xRw8K0GCG9Y9Bw/zOLR2bmWzH8I8Xdc1bw9RZcjFhAY=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCUZhf0emVsTpyout48JbS4exITBDxCWZ5blhaclHd7CcOmJl9Dqq/czMfZg4fJ5HseMCvNbAdR23no=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YzSTE25hJhLdXoWGrf2p/Hlb1MbrFJS8gPSAgNEvZkMMhXLQKx/
 VFxZOW+FQjUnnyfJAKzSNaPYUPw/wNt/cP5d8j+oWgWg5Bv2B1bk/kEbb1tHZneaQCdj/iBVVAt
 maL/3LkbWB9yzPElro+7dd8fTvOorQE0YHNNR4PSSDUh2pK64useZr5G6YtbJp37c+Q==
X-Gm-Gg: 
X-Received: by 2002:a05:6000:3102:b0:39c:cd5:4bc0 with SMTP id
 ffacd0b85a97d-3a1f64ae7bamr14020826f8f.52.1747127448203; 
...
X-Mimecast-MFC-PROC-ID: Mv8rld8FmUocwyqcZ1-IByi7-ixgul1xrMkEgRKhWLY_1747127448

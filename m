...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 92A954756C4
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Dec 2021 11:43:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B3FBD10E4A9;
...
Subject: [Intel-gfx] [PATCH v2 5/5] drm/dp: Move DisplayPort AUX bus helpers
 into dp/

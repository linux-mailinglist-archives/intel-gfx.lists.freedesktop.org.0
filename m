...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F22E7B4DF4
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Oct 2023 10:53:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09DF310E246;
...
Subject: [Intel-gfx] [PATCH v2 01/15] cdrom: Remove now superfluous sentinel

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5709A9CF6B8
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Nov 2024 22:09:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67F8210E8DC;
	Fri, 15 Nov 2024 21:09:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=linaro.org header.i=@linaro.org header.b="hXqeUNEg";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-f54.google.com (mail-ej1-f54.google.com
 [209.85.218.54])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A229D10E8E2
 for <intel-gfx@lists.freedesktop.org>; Fri, 15 Nov 2024 21:09:52 +0000 (UTC)
Received: by mail-ej1-f54.google.com with SMTP id
 a640c23a62f3a-a9a0ef5179dso413509066b.1
 for <intel-gfx@lists.freedesktop.org>; Fri, 15 Nov 2024 13:09:52 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1731704991; x=1732309791; darn=lists.freedesktop.org;
 h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
 :mime-version:subject:date:from:from:to:cc:subject:date:message-id
 :reply-to; bh=Nu64AEZrjbknvhhTh6WFsfM0fkcdr4a9mTjzq6Bqf6s=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1731704991; x=1732309791;
 h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
 :mime-version:subject:date:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=Nu64AEZrjbknvhhTh6WFsfM0fkcdr4a9mTjzq6Bqf6s=;
 b=
X-Gm-Message-State: AOJu0Yw7wnZYQDHh/AS3I7d1WgHmir9EiTjuGUdPYqqctSHN70giJ3aJ
 qacEWAdRVdFAuWbkk1JkeDxGwI+8DgUBpCbVWjmmw3S5+f8LxUDavtUakFdquPE=
X-Google-Smtp-Source: AGHT+IGo1PFlokT/XwCwFaL9cUfoDPKZYKDvZS3UAJXbF1dVGLOXgZscGaImMexCpnSZXSj8Dc4OWQ==
X-Received: by 2002:a17:906:fd88:b0:a9a:55dd:bc23 with SMTP id
 a640c23a62f3a-aa4833f6558mr326157866b.8.1731704990580; 
 Fri, 15 Nov 2024 13:09:50 -0800 (PST)
Received: from umbar.lan ([192.130.178.90]) by smtp.gmail.com with ESMTPSA id
 a640c23a62f3a-aa20df51648sm219626366b.62.2024.11.15.13.09.47
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 15 Nov 2024 13:09:50 -0800 (PST)
From: Dmitry Baryshkov <dmitry.baryshkov@linaro.org>
Date: Fri, 15 Nov 2024 23:09:30 +0200
Subject: [PATCH 5/5] drm/connector: make mode_valid accept const struct
 drm_display_mode
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20241115-drm-connector-mode-valid-const-v1-5-b1b523156f71@linaro.org>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=50179;
 ...
 bh=v8aJE9Wa4ZWRQmtZTJUR8Oawd8mzp1KBeUyMr52nIaw=;
 b=
 YKmI2xSyLmlGSEy3pXK78HpUgwPgpyVArJbj/Vz6p75T2D8S

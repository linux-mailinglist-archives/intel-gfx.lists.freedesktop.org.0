...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B6CF86FBB84
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 01:48:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 837AA10E172;
	Mon,  8 May 2023 23:48:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AD55710E0F2;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=gnCJCFjitHmKA1MoRoA0ZKmasLkcoIFnJMqP0lgDOqg=;
 b=PZgXnUOUAVN9mNeo25bnshed+S/P6D1eFUbClh1UggM6xi+FiTIKTFRH
 uegNYyz+ApF9kXMqHk0ipxN/pbFjl7oIwQr1G8ki466Qc3bbvZU444SQl
 hB01NsV5M1gD1uWMF/ZV5wPV5kBq/PGd0rFKZfEwdmgCRO8I0CwpGUmbq
 MPjrnZL5HtK9X6ab1UCmb83p74okCzHAWyR0h4XgfolW1a9QM1hnl11du
 EcvemW4Gyq1ieOSW0FkU9CQlNsDW1/q97V6Hu1YkGJj5u9IPwL0rKmvT/
 bo1iKGCKw1zoKwmPxQxtrmQ+/KkB9y97spKXMmz9jB9UnQWSlC8b+lJ5h Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="330135877"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="330135877"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:48:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="768246554"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="768246554"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:48:01 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  8 May 2023 16:48:53 -0700
Message-Id: <20230508234854.4028658-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 1/2] drm/i915: preparation for using PAT index

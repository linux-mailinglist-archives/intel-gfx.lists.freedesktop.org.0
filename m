...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDBAB57303E
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 10:13:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E0B9C95239;
...
Subject: [Intel-gfx] [PATCH v2 18/39] drm/i915: intel_pm.c: fix some ascii
 artwork at kernel-doc

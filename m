...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FF644C990D
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Mar 2022 00:16:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6070310E85D;
...
Subject: [Intel-gfx] [PATCH v3 04/13] drm/i915/xehp: compute engine
 pipe_control

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7198794379
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Sep 2023 21:02:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1FA9E10E716;
...
Subject: [Intel-gfx] [PATCH v3 4/5] drm/vc4: add trailing newlines to
 drm_dbg msgs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C34934ABD20
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Feb 2022 12:57:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C860D10F957;
...
Subject: Re: [Intel-gfx] [PATCH v5 2/5] drm/i915/gt: Drop

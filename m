...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45DE75A36A7
	for <lists+intel-gfx@lfdr.de>; Sat, 27 Aug 2022 11:51:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1AE4C10EBE7;
	Sat, 27 Aug 2022 09:51:36 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 11/15] vfio/platform: Use the new device life
 cycle helpers

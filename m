...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4B49181C0C
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Mar 2020 16:08:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF7936E9A2;
...
Subject: Re: [Intel-gfx] [PATCH 5/6] drm/amdgpu: add support for exporting
 VRAM using DMA-buf v2

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A8F956B08B5
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BC4210E5D3;
	Wed,  8 Mar 2023 13:29:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 906D710E5D3;
 Wed,  8 Mar 2023 13:29:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678282148; x=1709818148;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=FMM5X18RLC+uCAkDceiTtJ8A5U1bc1jKPTXVv6mvnxw=;
 b=ZqqO1TzNYtPbP0sA6S9+wT9Ow8XMZO2G621P5ydSB75lUhUSgJjFbmZX
 X3sqeVx7kfC2+Mrge7w6RoEqNiXZSOEKvBJDwhIRjSQnorBDG6mza9xoV
 CLB3IyKtZVyGVNXExKoaLDCXVPrMH8V63DBBUApRLMj2EvvlR24SBkJ+3
 xOsiN3Rd0kWTHGrEmvFH13UW6s7qjoaKJOEdsXYzC7gn4o3jUJpI9Gx5G
 rW3/EuMuJh2+U3DH+rWq/8c2WK1Fu69aE+C4rAFkfytqPm6+mZPYL4fZk
 b2gpctDht3QbJJ3ZD86SllCaaVxXybu9qpRIPRMhbO6/Vc9tTSHDHIGdx g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10642"; a="336165083"
X-IronPort-AV: E=Sophos;i="5.98,244,1673942400"; d="scan'208";a="336165083"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Mar 2023 05:29:08 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10642"; a="922789224"
X-IronPort-AV: E=Sophos;i="5.98,244,1673942400"; d="scan'208";a="922789224"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga006.fm.intel.com with ESMTP; 08 Mar 2023 05:29:07 -0800
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Wed,  8 Mar 2023 05:28:40 -0800
Message-Id: <20230308132903.465159-2-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230308132903.465159-1-yi.l.liu@intel.com>
References: <20230308132903.465159-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v6 01/24] vfio: Allocate per device file
 structure

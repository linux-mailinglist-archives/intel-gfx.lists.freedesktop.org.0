...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5683D40CAD1
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 18:41:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6BE46E9BE;
...
Subject: [Intel-gfx] [PATCH v8 13/16] drm_print: add choice to use dynamic
 debug in drm-debug

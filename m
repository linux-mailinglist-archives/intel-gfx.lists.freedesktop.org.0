...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8F4367946D
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 10:43:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E09C10E63F;
	Tue, 24 Jan 2023 09:43:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1F0CD10E63A
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Jan 2023 09:43:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1674553423; x=1706089423;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+j9xM18Wr1Bj7cKkoHygncsgifJdNo1JCa1Spw2pctw=;
 b=jp4UWQvnu7ezZLwMHqQddoIq3lB1hLEGvFYgHqyL6XtemWS8VsAPDtkt
 T4dltc08heiX5oNsc2dbwWydy/FdERZVUVnT+oVcZWX1naXvwe3xWQR06
 zx2PkC6KdHqwN0oP08IayJPjq59pMp4fLPDVyaBiAO5dggG4qaZt1amxp
 VHtE53hNqLcm/wQz9Xby8agfMtR/nhxiGwm5IlulyqskJyl+xOrhRVred
 /AOHUj0lWZBxg0c1EiKPf2hofSLBzNhjajbFqbTwIeZVe2WRT1vQEbCHb
 1HUJ0Ogy8Qet4DEI9qTg/0jtCf3CEMeLxEdBnhojpk6YnNswC7ArvJkB1 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10599"; a="309835444"
X-IronPort-AV: E=Sophos;i="5.97,242,1669104000"; d="scan'208";a="309835444"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jan 2023 01:43:42 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10599"; a="730618290"
X-IronPort-AV: E=Sophos;i="5.97,242,1669104000"; d="scan'208";a="730618290"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga004.fm.intel.com with ESMTP; 24 Jan 2023 01:43:39 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 24 Jan 2023 15:12:20 +0530
Message-Id: <20230124094224.2714023-3-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 2/6] drm/i915/hdcp: Keep hdcp agonstic naming
 convention

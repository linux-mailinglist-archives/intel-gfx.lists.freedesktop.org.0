...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8E374070A3
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 19:45:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E7E86EA58;
	Fri, 10 Sep 2021 17:44:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 54D266EA57
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Sep 2021 17:44:56 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10103"; a="306698134"
X-IronPort-AV: E=Sophos;i="5.85,283,1624345200"; d="scan'208";a="306698134"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2021 10:44:52 -0700
X-IronPort-AV: E=Sophos;i="5.85,283,1624345200"; d="scan'208";a="540740369"
Received: from bwparris-mobl.amr.corp.intel.com (HELO rdvivi-mobl4.intel.com)
 ([10.255.36.148])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2021 10:44:51 -0700
From: Rodrigo Vivi <rodrigo.vivi@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Rodrigo Vivi <rodrigo.vivi@intel.com>, Imre Deak <imre.deak@intel.com>,
 Tilak Tangudu <tilak.tangudu@intel.com>
Date: Fri, 10 Sep 2021 13:44:45 -0400
Message-Id: <20210910174447.289750-1-rodrigo.vivi@intel.com>
X-Mailer: git-send-email 2.31.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 1/3] drm/i915/runtime_pm: Consolidate runtime_pm
 functions

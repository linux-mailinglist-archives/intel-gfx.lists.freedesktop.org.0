...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 04AAA2B29F6
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Nov 2020 01:37:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE86E6E8B1;
	Sat, 14 Nov 2020 00:37:37 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AFD216E8A1
 for <Intel-gfx@lists.freedesktop.org>; Sat, 14 Nov 2020 00:37:27 +0000 (UTC)
IronPort-SDR: cY0xVgAlK2c8GV6PnfeZPQSh5A1tIDPMjWfO9qNVQyQLdLNS8m8nylws6pX82cZPFNJvCcNWa/
 nxE7o+zI+4kw==
X-IronPort-AV: E=McAfee;i="6000,8403,9804"; a="169768623"
X-IronPort-AV: E=Sophos;i="5.77,477,1596524400"; d="scan'208";a="169768623"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Nov 2020 16:37:19 -0800
IronPort-SDR: 10TJdBFiZVAiClGf+x6qhnFnNwr3kkQUa2Z9Ly5z+dRpDACzPgukoq8x8HFbiAljlBVONuqpKf
 oAjcuSxy4hIg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,477,1596524400"; d="scan'208";a="474848559"
...
Date: Fri, 13 Nov 2020 16:37:07 -0800
Message-Id: <20201114003716.4875-18-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201114003716.4875-1-sean.z.huang@intel.com>
References: <20201114003716.4875-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PXP CLEAN PATCH v06 18/27] drm/i915/pxp: Implement
 funcs to create the TEE channel

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F9BDB0DEC
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Sep 2019 13:34:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2E026ECDA;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 6/7] drm/i915/dp: Program an Infoframe SDP

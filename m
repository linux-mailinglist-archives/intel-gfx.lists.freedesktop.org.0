...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5708FADCE81
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Jun 2025 15:59:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D1D3E10E70A;
	Tue, 17 Jun 2025 13:59:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="IJozCQbV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1F5BB10E702;
 Tue, 17 Jun 2025 13:59:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1750168757; x=1781704757;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GFube+gC6502VTBuZaY4++giPU/6FLO2ZUzV5+IsC6Q=;
 b=IJozCQbV3qNnkcb5Qb068ldJSe/AYOUpzMSCyaY5Zzhcc3XiGegxVS1C
 hSWk/qgllcjAz8koByymrUBfMKl0TLphTiXuGRwOZlSTDZNPE3Tbdzcc0
 ymnhGW6EbzESeK5tfzYXD4+iRnnB9fVZOJosTLWIsKMzDrGRJsKQGiBe7
 64C0GBLdMl31RgoCv4evXMWPGDlm24qjOAm1Fg85gfT9PVCxD/YspduFJ
 PxYc89fUGCNjBRCRRWMeWZwR2ogqa53vtaMG24d74LOSLMEL+8cfpXUUO
 8ipwProdo1TJffhGaB8L02O75WLfztRXnT4kwWMioXC+eMDnW7gjpR6aB A==;
X-CSE-ConnectionGUID: c9b7WRrKR4u5LfYuGm1VZw==
X-CSE-MsgGUID: Um/kQwr5QoOOkm596HATFQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11467"; a="56026493"
X-IronPort-AV: E=Sophos;i="6.16,243,1744095600"; d="scan'208";a="56026493"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2025 06:59:17 -0700
X-CSE-ConnectionGUID: qN/VHkQ4RgeYMjlPcwMFEg==
X-CSE-MsgGUID: h9U9nX62RE+eBay1bLLo0g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,243,1744095600"; d="scan'208";a="153739465"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2025 06:59:10 -0700
...
Subject: [PATCH v13 02/10] mtd: intel-dg: implement region enumeration
Date: Tue, 17 Jun 2025 16:45:24 +0300
Message-ID: <20250617134532.3768283-3-alexander.usyskin@intel.com>

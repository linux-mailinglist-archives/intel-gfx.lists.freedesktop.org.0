...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6569054F494
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jun 2022 11:48:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 72F6210F35C;
	Fri, 17 Jun 2022 09:48:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8BC9010F35C
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Jun 2022 09:48:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655459303; x=1686995303;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=W+Va1LrLEwwGd2yb2fBNKErBxB+4PHPJNaG7PYqc8xk=;
 b=kfcQni5t0knHZZrQFy5UQX9gLZcdnXJvMW9fqbcuAOCO5XVdnFLNZOOp
 RVdloI9NmFWRgASfQu+tO6ovID6a5Yjxll9v0Wi2RaPLzR3vUt9+HC/CB
 mbAJBb3NACyJjSpVXRfHYd5d3HEUAFl+RsA9osBM268oHxiHJBd5lDwXo
 Dte3m8+R+G21JDem2Etnz/9pLReuOOqzY2z0aB6x/t7daxY+MHg8YP9AV
 FjiZAgGx0/e+FUS0Pm+M8LH+QeAHqkEuNVYF0wCtc2/N0D4nnal4eaw/X
 f2PFYNole8n2olnrehCC+MI+TCV1sYu0dUvw79M8fq1FJf9f5t1IjyBXc A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10380"; a="280179152"
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="280179152"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2022 02:48:22 -0700
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="641974576"
Received: from dfischbe-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.34.67])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2022 02:48:20 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 17 Jun 2022 12:48:16 +0300
Message-Id: <20220617094817.3466584-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.30.2
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 1/2] drm/i915/display: split out hw state

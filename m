...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7516969EE5C
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Feb 2023 06:33:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B5A610E3ED;
...
Subject: [Intel-gfx] [PATCH 6/7] drm/i915/vdsc: Check slice design
 requirement

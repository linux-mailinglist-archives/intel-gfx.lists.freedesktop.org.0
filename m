...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B24B162782
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Feb 2020 14:57:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB4D56EA0B;
	Tue, 18 Feb 2020 13:57:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 86D866EA0B
 for <intel-gfx@lists.freedesktop.org>; Tue, 18 Feb 2020 13:57:24 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20264097-1500050 
 for multiple; Tue, 18 Feb 2020 13:57:16 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 18 Feb 2020 13:57:16 +0000
Message-Id: <20200218135716.1256096-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.25.0
In-Reply-To: <20200218125145.1252559-1-chris@chris-wilson.co.uk>
References: <20200218125145.1252559-1-chris@chris-wilson.co.uk>
MIME-Version: 1.0

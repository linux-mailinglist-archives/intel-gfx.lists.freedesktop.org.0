...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 902C6172C6F
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Feb 2020 00:42:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA65C6ED8F;
	Thu, 27 Feb 2020 23:42:46 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 13.5/14] drm/i915: Print HDCP version
 info for all connectors

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0ECDA1D725E
	for <lists+intel-gfx@lfdr.de>; Mon, 18 May 2020 09:58:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5CF406E12E;
	Mon, 18 May 2020 07:58:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3C9526E143
 for <intel-gfx@lists.freedesktop.org>; Mon, 18 May 2020 07:58:18 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21226015-1500050 
 for multiple; Mon, 18 May 2020 08:57:52 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 18 May 2020 08:57:50 +0100
Message-Id: <20200518075750.17223-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 8/8] drm/i915/gt: Resubmit the virtual engine on
 schedule-out
...
index 0710ddbcf85f..75079f098750 100644
...
+		active = rq;
 	...
 	return active;
@@ -1395,12 +1366,44 @@ execlists_schedule_in(struct i915_request *rq, int idx)
...
+		resubmit_virtual_request(rq, ve);
 ...
 static inline void
@@ -1646,6 +1649,20 @@ assert_pending_valid(const struct intel_engine_execlists *execlists,
 			return false;
 		}
...
+
 		...
 		if (!spin_trylock_irqsave(&rq->lock, flags))
 			continue;
@@ -2353,6 +2370,15 @@ static void execlists_dequeue(struct intel_engine_cs *engine)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BBE411BDC53
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 14:33:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D18D6EE9B;
	Wed, 29 Apr 2020 12:33:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 281326ED2A
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 12:33:19 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 14:32:53 +0200
Message-Id: <20200429123307.1449297-11-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/25] drm/i915: Add ww context handling to
...
+				   mock_barrier_task, &counter);
 	if (err) {
 		...
 		goto out;
@@ -1915,11 +1915,8 @@ static int mock_context_barrier(void *arg)
 	}
...
+				   NULL, NULL, mock_barrier_task, &counter);
 	if (err) {
 		pr_err("Failed at line %d, err=%d\n", __LINE__, err);
 		goto out;
@@ -1939,8 +1936,8 @@ static int mock_context_barrier(void *arg)
...
+				   mock_barrier_task, &counter);
 	...
 	if (err == -ENXIO)
 		err = 0;
@@ -1954,11 +1951,8 @@ static int mock_context_barrier(void *arg)
 		goto out;

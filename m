...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CABD0D11CA
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Oct 2019 16:52:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 279AA6E9CC;
	Wed,  9 Oct 2019 14:52:42 +0000 (UTC)
...
X-Linutronix-Spam-Status: No , -1.0 points, 5.0 required, ALL_TRUSTED=-1,
 SHORTCIRCUIT=-0.0001
X-Mailman-Approved-At: Wed, 09 Oct 2019 14:52:40 +0000
Subject: [Intel-gfx] [tip: locking/core] locking/lockdep: Remove unused
...
Cc: juri.lelli@redhat.com, "Peter Zijlstra \(Intel\)" <peterz@infradead.org>,
 ...
 daniel@iogearbox.net, mark@fasheh.com, Ingo Molnar <mingo@kernel.org>,
 airlied@linux.ie, vdavydov.dev@gmail.com, jslaby@suse.com,
 intel-gfx@lists.freedesktop.org, jack@suse.com, mripard@kernel.org,
 Qian Cai <cai@lca.pw>, viro@zeniv.linux.org.uk,
 Thomas Gleixner <tglx@linutronix.de>, tytso@mit.edu,
 gregkh@linuxfoundation.org, linux-kernel@vger.kernel.org, jlbec@evilplan.or,
 hannes@cmpxchg.org, tj@kernel.org, Borislav Petkov <bp@alien8.de>,

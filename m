...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AAAF355FE96
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jun 2022 13:30:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6797511AF7A;
	Wed, 29 Jun 2022 11:30:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DBD3511AF7A
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Jun 2022 11:30:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656502204; x=1688038204;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=HmXS2/fYlvGR3rkPiVvxpMT6bE4EmySeW2KyH3a1ORI=;
 b=dVNwW3JTp+2uOgdok/YQbz5LmDlngAqP1dIel2VyK/kM0O6HQJXyf78U
 2mj/P3YlRr9MmRQ+uQuPdZY8SSk/Kf9KJHyAYTwParhSyF/sj3eN1LELV
 afJolZMTy2yBSKezi/OVgWtoVVUIv20AV8DfdYpGiPHeWwpcaVgsyqita
 0dSbbXrLKTegdnUCmsU6YqTh9LnPS0rA6oLu197F0yMka7fWPyxJX8vu8
 f65RbcPCj56sxI2Ucutymf/nZ3R8TDAc/HtqHcAetMj6kCZBd8ruLAiOB
 yogNVrB+0ApoJG/So0WT3ynk2MhQDuxPQkacIxgqV4X6C9d33Kxdmh8gr g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10392"; a="368319334"
X-IronPort-AV: E=Sophos;i="5.92,231,1650956400"; d="scan'208";a="368319334"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jun 2022 04:30:03 -0700
X-IronPort-AV: E=Sophos;i="5.92,231,1650956400"; d="scan'208";a="647353317"
...
Date: Wed, 29 Jun 2022 14:29:10 +0300
Message-Id: <20220629112913.1210933-12-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 11/14] mei: gsc: setup gsc extended
 operational memory

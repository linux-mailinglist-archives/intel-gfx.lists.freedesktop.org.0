...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D61546D3204
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 17:18:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77E5C10E1BE;
...
Subject: [Intel-gfx] [PATCH v9 10/25] vfio: Make vfio_device_open() single

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BD2DB1AF8DF
	for <lists+intel-gfx@lfdr.de>; Sun, 19 Apr 2020 11:06:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6623C6E44E;
	Sun, 19 Apr 2020 09:06:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 52B386E180
 for <intel-gfx@lists.freedesktop.org>; Sun, 19 Apr 2020 09:06:36 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20948796-1500050 
 for <intel-gfx@lists.freedesktop.org>; Sun, 19 Apr 2020 10:06:32 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 19 Apr 2020 10:06:31 +0100
Message-Id: <20200419090631.12321-3-chris@chris-wilson.co.uk>
...
index 67c287282d38..932c643e28e3 100644
...
@@ -273,10 +433,7 @@ static int __rps_up_interrupt(struct intel_rps *rps,
 	if (!intel_engine_can_store_dword(engine))
 		return 0;
...
+	rps_set_check(rps, rps->min_freq);
 	...
 	if (IS_ERR(rq))
@@ -348,10 +505,7 @@ static int __rps_down_interrupt(struct intel_rps *rps,
...
@@ -484,16 +638,10 @@ static u64 measure_power_at(struct intel_rps *rps, int *freq)
 	u64 x[5];
 	int i;

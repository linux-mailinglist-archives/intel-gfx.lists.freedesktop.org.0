...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B2992576F4F
	for <lists+intel-gfx@lfdr.de>; Sat, 16 Jul 2022 16:43:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7DB501124A0;
	Sat, 16 Jul 2022 14:36:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3629710E091;
 Sat, 16 Jul 2022 03:02:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1657940521; x=1689476521;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=h/lSd2YEQ+C/DIDmVZldvJEd+dmA43QSkJ74P1fFj40=;
 b=leNNsRKgpK86lcDPTlZXfaohUYagSuT5FUNDSeEB0AQlKNzr8CZW0GE7
 Y36ItcMLnPIV1CPTnTq0VK8AAeMcWFUYb/YvxjIPWe4QOkBKeLS/u5nY6
 HDGHXuVyvPle36IfD1tlnexcK4cFwJP+y1dNheSaPKsNK8TzVfXT0tZOH
 8zwYo5h3GRVHt6vN2JxJf7Cr0z1Ji3RZDjpzgZBlPf+gnNgsxDqm1wwnk
 i2dDaI88wz8Yhw256WaszMoXDjCMK51FAOCIEdXMFFWyWiYRS0bzFP96d
 eeafQiEn1G2ANH1MsgDIQbGO16jxwS7TSDH8nWbFtUqEayB+RmISqoySq Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10409"; a="286676601"
X-IronPort-AV: E=Sophos;i="5.92,275,1650956400"; d="scan'208";a="286676601"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Jul 2022 20:01:59 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,275,1650956400"; d="scan'208";a="699425491"
Received: from lkp-server02.sh.intel.com (HELO ff137eb26ff1) ([10.239.97.151])
 by fmsmga002.fm.intel.com with ESMTP; 15 Jul 2022 20:01:55 -0700
Received: from kbuild by ff137eb26ff1 with local (Exim 4.95)
 (envelope-from <lkp@intel.com>) id 1oCY43-00014W-3n;
 Sat, 16 Jul 2022 03:01:55 +0000
Date: Sat, 16 Jul 2022 11:01:41 +0800
From: kernel test robot <lkp@intel.com>
To: Gwan-gyeong Mun <gwan-gyeong.mun@intel.com>,
 intel-gfx@lists.freedesktop.org
Message-ID: <202207161028.vJEWBR0G-lkp@intel.com>
References: <20220714090807.2340818-6-gwan-gyeong.mun@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="SB3PozJR36/SdAYj"
...
#
CONFIG_CC_VERSION_TEXT="clang version 15.0.0 (git://gitmirror/llvm_project 07022e6cf9b5b3baa642be53d0b3c3f1c403dbfd)"

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7CA88718E7C
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 00:28:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE39B10E1EC;
	Wed, 31 May 2023 22:28:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D0B1010E1EC
 for <intel-gfx@lists.freedesktop.org>; Wed, 31 May 2023 22:28:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685572080; x=1717108080;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=nmRyrmvOaozDB0FX39fI5GlyBgeDkIXTKiBjPeeQ9uw=;
 b=aQzV470QWPzTvmSoKVZNo3YBj08+c6XEtBv6IcC8eS5bAxCCRplz7ghH
 3Q0eMDEdvb8KlNlP6hW/xKmoCOaJnM5CjX1vye11me2oaAY1E8adnrvgx
 grYTGHwBj7FUb3y/MLYR5pe810E8oBcnOf6bebfjBOLsEPa5wcOZTGd4l
 +hek/DqvHR5GbvFo458YDFQqqHEPA+5mgznavn+ezz+FdfdLPfkX7epZh
 BGndO0uMetGGjymqnKO6wZVW9va+pA4iyaxclHp1a67SIBj/UoucmeoXL
 WRwjx3/V6Ij854+RaSDC5se2MAjTjXSo9ooyW88jQkMqFx6wnsKb69Trx g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="383651676"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; d="scan'208";a="383651676"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2023 15:28:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="1037222177"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; d="scan'208";a="1037222177"
Received: from gliakhov-mobl.ger.corp.intel.com (HELO
 vgovind2-mobl3.intel.com) ([10.252.47.114])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2023 15:27:56 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  1 Jun 2023 01:27:14 +0300
Message-Id: <20230531222714.439313-8-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 7/7] drm/i915/mtl: Add support for PM DEMAND
...
+#include "intel_pmdemand.h"
 ...
 #include "intel_wm.h"
@@ -153,6 +154,8 @@ static void intel_crtc_disable_noatomic_complete(struct intel_crtc *crtc)
...
index 000000000000..dd50d0854b7e
--- /dev/null
...
+}
+
+static bool intel_pmdemand_phys_needs_update(struct intel_atomic_state *state)
+{
+	struct drm_connector *connector;
+	int i;
+	struct drm_connector_state *old_conn_state, *new_conn_state;
...
+		old_crtc_state = intel_atomic_get_old_crtc_state(state,
+								 new_crtc);
+		new_crtc_state = intel_atomic_get_old_crtc_state(state,
+								 new_crtc);
...
new file mode 100644
index 000000000000..d29d18a99eb8
--- /dev/null

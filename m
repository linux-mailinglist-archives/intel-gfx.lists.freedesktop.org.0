...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED52A4BEDC9
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:18:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A63810E53D;
	Mon, 21 Feb 2022 23:18:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E79D910E53D;
 Mon, 21 Feb 2022 23:18:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485511; x=1677021511;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+cYQCtajtLHF13wD1Ab8Zm6c/BiUXjG1ZHacvq+QS4Q=;
 b=HMKMcLFj2dH3B3kF6q5hYKdTHkvmboFZOFwtLB1dO66aQgVi4HLKy7Ab
 /ogBJePt9Trgzsdmc4j3bTuFsLPKxDcFHBVR5lkrAv4RuaoVCtayrFG4u
 4FufyOuXAFAJDp1vkByh4Daatku4/X/eT4vA6mfa6XRLZcrJtBnzYXWsI
 n+xSdO5vH9wJmI14P0Apv35cm4aHMHLMkmh9126pIwarlWZngUOWfqfHQ
 5SYF2E2o7U6BM/wvXS1lRijbXMU30fI+bYBa746lUmn0jDMOS+H6A0ulH
 +19coGiRX2ej4RxQSB9hEDAw1Lkln37scEp2CS5E6/ougE3yAYuUe6NL4 g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="238996070"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="238996070"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:18:30 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="638694648"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:18:28 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: linux-kernel@vger.kernel.org, intel-gfx@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org, netdev <netdev@vger.kernel.org>
Date: Tue, 22 Feb 2022 00:17:05 +0100
Message-Id: <20220221231705.1481059-24-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 11/11] drm/i915: replace Intel internal

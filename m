...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C44C72D252F
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Dec 2020 08:58:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BDE596E96E;
...
Subject: [Intel-gfx] [PATCH v4 13/16] drm/i915: Add helper functions for

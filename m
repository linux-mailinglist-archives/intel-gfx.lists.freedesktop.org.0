...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 09BB46FBB85
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 01:48:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D47110E31A;
	Mon,  8 May 2023 23:48:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CCB8C10E0F5;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=ucYN+jVxuw+jU2dwG+HNlgp0DIQ6ctKZrQRpbzIKNM0=;
 b=OPZz21jAo8AgLkq0283q89vk4zyCnOvGisNpqWfLgWUKX32Vn5VpHQgo
 paP6LwU45tQQsYnelPGqt0TdRuqhpOkiES7GTvyvKr8Acr6xeQG25jlb5
 VVMgfJlO2p6rKAGO3LOepDgl3rRqe5C+U9j16nm2ZwiVomW3rt8JiDNIh
 TEqY0MxxCOxzcZJYaYyJm5OfhCoHT00nTX5FDAKvI7EHmSTcdco/edRNS
 b4wAIXppHMu1g1BxJo35m5/vnEmTZUq1FPiu+IzSc8QdDj6poNsoSUf9D
 aI87xno8/ulbyr6UyZ1lJ+Pxg1ndubEYSnY+jnfxU2K+uzlkircvbby9s g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="330135879"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="330135879"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:48:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="768246561"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="768246561"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:48:01 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  8 May 2023 16:48:54 -0700
Message-Id: <20230508234854.4028658-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 2/2] drm/i915: use pat_index instead of
 cache_level

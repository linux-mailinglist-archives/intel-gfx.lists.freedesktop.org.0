...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 146C350DF86
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Apr 2022 13:57:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D25AB10E5A5;
...
Subject: [Intel-gfx] [PATCH v2 3/4] drm/i915/selftest: Always cancel
 semaphore on error

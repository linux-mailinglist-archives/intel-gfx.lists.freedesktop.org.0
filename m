...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D046E378FC8
	for <lists+intel-gfx@lfdr.de>; Mon, 10 May 2021 15:56:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDEB66E48B;
...
> judgement on whether or not this is a good thing.=A0 I'm just reading the =
...
> GuC?" may soon be, "you get to use your GPU."=A0 We're not there yet and, =
...
>> issues found in this new codepath (too many users run with enable_guc=3D=
3,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7931678C93C
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Aug 2023 18:01:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 166A710E43A;
	Tue, 29 Aug 2023 16:00:19 +0000 (UTC)
...
Subject: [Intel-gfx] [RFC 33/33] drm/i915/color: Add example implementation
 for vendor specific color operation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EDE6568CC4
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Jul 2022 17:29:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C393D10E5D1;
	Wed,  6 Jul 2022 15:29:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B3B3E10E51C;
 Wed,  6 Jul 2022 15:29:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1657121373; x=1688657373;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=6U34xwyNnuQ0U9WpJZP5vYYcELQl1p89Pg/cD7GAXa4=;
 b=Y08eHE7wql/LxnM674w77DcuiZjVGnXKfzr0a3tdgP9m5vBsWcUcjILp
 HRg22wGxF1wruNn6iLYpkeutE7FtFBPwye9EDcpa0j82vEfgyo347nqYo
 XyfKXmu40xA8J0sbbHqymE4isbtEB2m1o0GEj6N1buQtyeTboEaUaE26u
 klFHBg00rNeIxkvig9TxrfiAUo13rosdtCwKv9gpsgPttiXpMrj2tvMqd
 vACMX6Br5jADbnhAP+siLrh21Kv3q2p1BLH+8VOyu3z0ZDxpk+p4pAq6h
 Dlfgu+O02gSp7ItlA5zs1iFzC3Lqo7cNRSM78zWRogzQ0MFTuKKsd0otf A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10400"; a="370093176"
X-IronPort-AV: E=Sophos;i="5.92,250,1650956400"; d="scan'208";a="370093176"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jul 2022 08:29:32 -0700
X-IronPort-AV: E=Sophos;i="5.92,250,1650956400"; d="scan'208";a="650708915"
Received: from mropara-mobl1.ger.corp.intel.com (HELO intel.com)
 ([10.252.49.154])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jul 2022 08:29:29 -0700
...
Subject: [Intel-gfx] [PATCH] drm/i915/gem: Really move i915_gem_context.link

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 403716B8890
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Mar 2023 03:28:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7572710E6D7;
	Tue, 14 Mar 2023 02:28:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from madras.collabora.co.uk (madras.collabora.co.uk [46.235.227.172])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6115310E6D6;
...
Received: from workpc.. (109-252-120-116.nat.spd-mgts.ru [109.252.120.116])
 ...
 by madras.collabora.co.uk (Postfix) with ESMTPSA id 840B2660220B;
 Tue, 14 Mar 2023 02:28:16 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
 s=mail; t=1678760898;
 bh=9K5G/CJg1JdrApZ2kldT8kElYkVdBKL1lHxt8faYpz4=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Date: Tue, 14 Mar 2023 05:26:55 +0300
Message-Id: <20230314022659.1816246-7-dmitry.osipenko@collabora.com>
...
Subject: [Intel-gfx] [PATCH v13 06/10] drm/shmem-helper: Add memory shrinker
...
@@ -475,13 +543,15 @@ drm_gem_shmem_create_with_handle(struct drm_file *file_priv,
  */
...
@@ -493,6 +563,9 @@ static void drm_gem_shmem_unpin_pages(struct drm_gem_shmem_object *shmem)
...
@@ -521,9 +594,60 @@ void drm_gem_shmem_purge(struct drm_gem_shmem_object *shmem)
...
@@ -570,22 +694,33 @@ static vm_fault_t drm_gem_shmem_fault(struct vm_fault *vmf)
 	vm_fault_t ret;
 	struct page *page;
 	pgoff_t page_offset;
+	bool pages_unpinned;
...
+unlock:
 	...
 	return ret;
@@ -608,6 +743,7 @@ static void drm_gem_shmem_vm_open(struct vm_area_struct *vma)
 	if (!drm_WARN_ON_ONCE(obj->dev, !shmem->pages_use_count))
...
+	drm_gem_shmem_update_pages_state(shmem);
 	...
 	drm_gem_vm_open(vma);
@@ -689,7 +825,9 @@ void drm_gem_shmem_print_info(const struct drm_gem_shmem_object *shmem,
...
@@ -744,6 +882,8 @@ static struct sg_table *drm_gem_shmem_get_pages_sgt_locked(struct drm_gem_shmem_
...
+
 ...
 err_free_sgt:
@@ -820,6 +960,191 @@ drm_gem_shmem_prime_import_sg_table(struct drm_device *dev,
 }
...
index 7d823c9fc480..e99f1715514b 100644
...
@@ -269,6 +283,36 @@ static inline int drm_gem_shmem_object_mmap(struct drm_gem_object *obj, struct v

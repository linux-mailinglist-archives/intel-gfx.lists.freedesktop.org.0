...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 729256EE90B
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 22:29:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF93010E7FF;
	Tue, 25 Apr 2023 20:29:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6D4A210E7E9
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Apr 2023 20:29:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682454546; x=1713990546;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=b4KyGg/dKRV2jHZ7P5g0uftXr7Bl3EqtwJCCpZMfg+Q=;
 b=CWGdZm4fPLZYQwl4WX6kSxk+9XqscQ6fCaz16aTqb3jdXWTHx88KbSOe
 f/j1uAdq8SzTkSzNNVYz0xiW+WMyrOF08+MRRSlkGADEpjxdue0CvcSUw
 fUW9yS+z9bbyFlVxEJskSCTSdwY4rPOB2R3+wSudlTCLANEGmNtXNNshV
 kd+CwXoJ3blT6c6egbLXBMTpCxFz0/Kx2SR+xiI79S7jpGLSiKRAloyYT
 DhzZpKkWI2U+hxpfcNwL1xXOCr/KfJmbOe168njqxeoPhDqT+C/GZwmWP
 lr/q2mx8HonEBseTfxmlET7bdk9nKdfOJKSxSCVVABY9JeH8Kh9bMkeRj Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="345651722"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="345651722"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:29:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="724141281"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="724141281"
Received: from aazuev-mobl.ccr.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.252.59.124])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:29:03 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:28:26 +0300
Message-Id: <20230425202826.1144429-9-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 8/8] drm/i915/display: provision to suppress
...
index f98e235fadc6..9ae2cbf12c04 100644
...
index 60f8b42c18c9..8ecec48ba028 100644

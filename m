...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3225A4A9D0A
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Feb 2022 17:37:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D78B210EDE9;
...
Subject: [Intel-gfx] [PATCH v5 5/5] drm/i915/gt: replace cache_clflush_range

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BD6357F405
	for <lists+intel-gfx@lfdr.de>; Sun, 24 Jul 2022 10:25:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B48BBFBF7;
	Sun, 24 Jul 2022 08:25:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 712F5BFBFA
 for <intel-gfx@lists.freedesktop.org>; Sun, 24 Jul 2022 08:25:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1658651116; x=1690187116;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=IldIp8iq+2dGBV3W9gUXTC8mwV+k/ml0RYwUDBVJoZw=;
 b=cetJBMFvooRAVAMEwWktBQ3JPfKfxTSTbMwJpSVI3hojsaSU5vccj1Pn
 XEqxuJ8l6wx0zUcHqoKwBWq+S3m18GgqeistPB0OWRSlIbEIY9I6R0njw
 jGFwnv6nVqrsRzRffk8iBxjjvBgDsG+fGSsMepMB28tePwmwSsrawTQUp
 FZvsbwy7MSalc3CiRZbze6sOr1IygY09/bQdCV1/mXJJuR4XCoxO+rkcd
 waicKSWcPIKnDr6VbSpBAheDT21caIEBecM2Lu9SoDTwk3J/5oxMaFgLT
 /CMCd3eDJl07Utgwg84PWqP4E8Uie3xshFnGncmJPUXiiqq7ODLxuVD02 A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10417"; a="285074729"
X-IronPort-AV: E=Sophos;i="5.93,190,1654585200"; d="scan'208";a="285074729"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2022 01:25:13 -0700
X-IronPort-AV: E=Sophos;i="5.93,190,1654585200"; d="scan'208";a="657756317"
Received: from twinkler-lnx.jer.intel.com ([10.12.87.143])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2022 01:25:10 -0700
From: Tomas Winkler <tomas.winkler@intel.com>
To: Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
 David Airlie <airlied@linux.ie>, Daniel Vetter <daniel@ffwll.ch>
Date: Sun, 24 Jul 2022 11:24:21 +0300
Message-Id: <20220724082428.218628-8-tomas.winkler@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 07/14] mei: extend timeouts on slow devices.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 01C007AE70F
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Sep 2023 09:44:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8635C10E35D;
	Tue, 26 Sep 2023 07:44:29 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 4/6] drm/edid: use a temp variable for sads
 to drop one level of dereferences

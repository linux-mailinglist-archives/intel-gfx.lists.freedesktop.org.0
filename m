...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7F2911ED73
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2019 23:07:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D816F6EDEF;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC v2 06/12] drm/i915/svm: Device memory support

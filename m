...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1CD6DB81E5B
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Sep 2025 23:12:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F5A510E599;
	Wed, 17 Sep 2025 21:12:25 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VzxrPPd2";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2355010E598;
 Wed, 17 Sep 2025 21:12:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1758143544; x=1789679544;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=EXtFRn3dH4AwS0e5fdjXHQ/Z78GmYwyOC81Z2cMN0sk=;
 b=VzxrPPd2rytI/FEU+CcffZDJswoNX51ONs9THfqefYEkqwIvUwgqc+jh
 PpW3wrwdBMwwaYwaEUZwZqvJlsJETpsjcj2Z1JhnU5QtiN8tZq5xRZkqb
 xjUI8gScVl71steJbO5wrKWFwnUDVvyv5BfLZLbG+xpOU6+NMrjgpqGn+
 pXHK0qPOiiPglmcVvOO+YCgPvr/dRrpTTPIDcJq3+loI0PUCigIoUySYj
 RVpgZuFkCu1zeo1cf76ScVGJ2W6Wh0L9oSXzitDr/YIBtMgLszsG4CcSv
 V7Yj1AJ6SkIf3w6Pw+EtUTWn/dWi3bw9B6SmP6OfoGRDLY3GfpH3PSI5z w==;
X-CSE-ConnectionGUID: I/ezhm8SRmeyhQRWPFrzwQ==
X-CSE-MsgGUID: jfBCIf2HQqqg0brh2TCCzQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11556"; a="70715553"
X-IronPort-AV: E=Sophos;i="6.18,273,1751266800"; d="scan'208";a="70715553"
Received: from orviesa007.jf.intel.com ([10.64.159.147])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Sep 2025 14:12:24 -0700
X-CSE-ConnectionGUID: d3Lnx6iKQnGN9O4gvUfNdA==
X-CSE-MsgGUID: jHmmUrJPR1+DlMTUVPysvw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,273,1751266800"; d="scan'208";a="175150232"
Received: from cpetruta-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.244.83])
 by orviesa007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Sep 2025 14:12:22 -0700
Date: Thu, 18 Sep 2025 00:12:19 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Nautiyal, Ankit K" <ankit.k.nautiyal@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org
Subject: Re: [PATCH 11/15] drm/i915/display: Use vrr.guardband to derive
 vblank_start
Message-ID: <aMskM8atK_wK_GhS@intel.com>
References: <20250911024554.692469-1-ankit.k.nautiyal@intel.com>
 ...
 <aMmy79ka0CgBrLmf@intel.com> <aMqSoyUVa82xsYew@intel.com>
 <aMsfV3Pt-QFVZTGJ@intel.com>
MIME-Version: 1.0

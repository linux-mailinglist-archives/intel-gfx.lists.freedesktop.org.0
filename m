...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E20FBC874
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2019 15:00:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DAA936EA2A;
	Tue, 24 Sep 2019 13:00:28 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 9/9] drm/print: rename drm_debug to
 __drm_debug to discourage use

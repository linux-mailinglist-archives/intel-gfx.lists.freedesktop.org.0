...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D11164BACCA
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 23:40:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0505710E8C0;
	Thu, 17 Feb 2022 22:40:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ABAD310E8CD
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Feb 2022 22:40:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645137644; x=1676673644;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6FTBLOblrXcx7P/OsUa1Yjqr6u5UDLQVoMPgcbNW2Uc=;
 b=OWk8RCrBP5VkNfvaZmWd/IhwoGdill/br1ee5Mn10rSIh3NLFL1Goink
 N4oniz3Z132SbzVHYj7WRchbZGOwZjVqIthi2TMnWb8/o5vm3yhoGXUe9
 Hp6CF8vDOplTezJhgcqpntRLO5J37FsQykGkA2kKvM7C4sBs962iYKPN0
 BYtOEFViwC6qHy7A9hU360DAWHm7gR22Drk4JM95LFvdM8SnTnLas/caG
 uvjXxh5YttRb2r5roQhZ8BDD2E6/HLfiqs/JC/ryQbzc6CnEQZW1Fxcx8
 A87LRNneNrRrzYCKbM8yIgdn9wbm5+qCgU/RTGw7rKUiWxEVPZRleGn// A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10261"; a="250744398"
X-IronPort-AV: E=Sophos;i="5.88,377,1635231600"; d="scan'208";a="250744398"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 14:40:44 -0800
X-IronPort-AV: E=Sophos;i="5.88,377,1635231600"; d="scan'208";a="705062074"
Received: from acushion-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.21.45])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 14:40:42 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 18 Feb 2022 00:40:23 +0200
Message-Id: <20220217224023.3994777-4-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [CI 4/4] drm/i915/reg: split out icl_dsi_regs.h
...
index 0ef1d520987e..02e74200ab45 100644
--- a/drivers/gpu/drm/i915/i915_reg.h
+++ b/drivers/gpu/drm/i915/i915_reg.h
@@ -8386,82 +8386,6 @@ enum skl_power_gate {
...
@@ -8477,24 +8401,6 @@ enum skl_power_gate {
...
@@ -8533,245 +8439,6 @@ enum skl_power_gate {

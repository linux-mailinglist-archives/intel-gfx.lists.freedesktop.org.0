...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B8EB7054AB
	for <lists+intel-gfx@lfdr.de>; Tue, 16 May 2023 19:05:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D1DEE10E282;
	Tue, 16 May 2023 17:05:20 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 6/8] drm/display/dsc: split DSC 1.2 and

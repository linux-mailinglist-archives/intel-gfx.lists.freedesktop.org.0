...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BEC475B42FD
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Sep 2022 01:19:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 48E5510E137;
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915/gt: Use MEDIA_VER() when

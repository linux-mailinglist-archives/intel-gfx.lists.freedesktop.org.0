...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5274F7600ED
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jul 2023 23:15:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B6CE10E356;
...
Subject: [Intel-gfx] [PATCH v6 0/4] drm: Use full allocated minor range for
 DRM

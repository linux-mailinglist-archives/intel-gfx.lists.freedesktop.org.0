...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2094D61CBC
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 12:09:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D6E489970;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 5HBA==
Subject: Re: [Intel-gfx] [PATCH v8 4/6] drm/hdcp: update content protection
...
Content-Type: multipart/mixed; boundary="===============1332048351=="

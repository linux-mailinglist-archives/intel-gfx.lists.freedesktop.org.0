...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C6D42D7717
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Dec 2020 14:57:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90C446EE0A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 10/19] drm/i915/hdcp: Pass dig_port to
 intel_hdcp_init

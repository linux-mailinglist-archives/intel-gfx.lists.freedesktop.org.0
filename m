...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB3F05AF88E
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 01:50:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B39B510E0B4;
...
Subject: [Intel-gfx] [PATCH v3 11/14] drm/i915/mtl: Add gsi_offset when

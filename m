...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BCDE6ED77A
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 00:06:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7FFAB10E62F;
	Mon, 24 Apr 2023 22:06:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9411810E62F;
 Mon, 24 Apr 2023 22:06:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682373977; x=1713909977;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=AQg7KZc9r4pt/1GKFRFO1byGhvFwUpRPfpH4lqM6wX0=;
 b=COBSy8J49gsQArvazTOwuyG//f6FYu+i/vnynsMpRY80bHNz3wWGoAPZ
 y4UYqEld2AQNff8y/ZMpk7RuRoufLYBsHXxedjvnkWFWKwVrO0p6ErFmX
 2WqPCNFdPZm4CtpWxc5nPlNb6rtigWfiutam5ztka+Tn6ZV+zeNLc4f00
 OxpoF6igkpr08NjsMYQRMsYkUd3dMt5gtu2PXiuhjdMIiB99tdPEhcb0Y
 ErgnitPjCErUWN2OsjErtNYuQlWP7lDQppfnwB7NqgVbHfju4/UhGpA6r
 X6Zzh79EMSI+V+ImfKAcRw37e+ekM7AkWlGf/49h237wtIg7eacDS54jy A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10690"; a="335473772"
X-IronPort-AV: E=Sophos;i="5.99,223,1677571200"; d="scan'208";a="335473772"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2023 15:06:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10690"; a="939500416"
X-IronPort-AV: E=Sophos;i="5.99,223,1677571200"; d="scan'208";a="939500416"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2023 15:06:13 -0700
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v8 7/7] drm/i915: Track gt pm wakerefs

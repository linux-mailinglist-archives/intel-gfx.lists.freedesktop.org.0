...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6629781816D
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Dec 2023 07:19:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0983D10E3FB;
	Tue, 19 Dec 2023 06:19:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1AE3C10E3FB
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 Dec 2023 06:19:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702966752; x=1734502752;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=SVZaSXt0Qjr9/b4LK3h2wTHt5Dxs8y9iiBwawp0EP6o=;
 b=aiDV2Z8N8JWslhL/CtfFGvZtI9B6Lt0jvWiQpdpytISt9NIzZRUeCZSM
 y6hQCMRcjpeK8rDYqroxT9iavntsTNoko5//fZOdXZJyOzSlpoipbbbce
 d8rW0BAT7f80toT3P9/N2Jg1KP7oIRWKayUcgXZJ+NSTCZSFXEzIegoCK
 r1nNfvSTEakapmRFPSt/0Onk1wslXa8DCyYiJIFhsDFjf1E1LC7gUosK1
 S7+/VBvUulTI7AyAghI0ha30bTcAVYyNvlGX4h/3q/xgk44qeQ99QHsB5
 lmy8wE0ZG+QEKuV46+YY9tfVPaunY8ZKZ22cTuG+VwV5qMBCz+ogoWOc1 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="14301616"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="14301616"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Dec 2023 22:19:12 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="775852262"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="775852262"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orsmga002.jf.intel.com with ESMTP; 18 Dec 2023 22:19:08 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH 2/3] drm/i915/dp: Add Read/Write support for Adaptive Sync SDP
Date: Tue, 19 Dec 2023 11:44:25 +0530
Message-Id: <20231219061426.1205337-3-mitulkumar.ajitkumar.golani@intel.com>
...
--v3:
- Move defines and comment from patch 3 to patch 2 as it was used
originally to this patch itself.

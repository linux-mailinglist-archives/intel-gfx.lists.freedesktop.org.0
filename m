...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C3842305A1
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Jul 2020 10:40:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D56A89E06;
	Tue, 28 Jul 2020 08:40:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D8AD489E06
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Jul 2020 08:40:53 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 21954418-1500050 for multiple; Tue, 28 Jul 2020 09:40:48 +0100
MIME-Version: 1.0
...
References: <20200724115352.19892-1-chris@chris-wilson.co.uk>
 ...
 <87o8o515vb.fsf@gaia.fi.intel.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
To: Mika Kuoppala <mika.kuoppala@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
Date: Tue, 28 Jul 2020 09:40:49 +0100
Message-ID: <159592564927.17058.3977003042327922914@build.alporthouse.com>
User-Agent: alot/0.9

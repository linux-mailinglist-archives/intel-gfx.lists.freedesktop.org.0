...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 97C281A72CD
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Apr 2020 07:07:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B198589F8E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 3/3] drm/i915/dp: Expose connector VRR info
 via debugfs

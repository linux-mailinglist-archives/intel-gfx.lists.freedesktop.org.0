...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7375C371F83
	for <lists+intel-gfx@lfdr.de>; Mon,  3 May 2021 20:22:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 199206E9F9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/4] New function to avoid duplicate code in
 upcomming commits

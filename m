...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 654EEB3BA31
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Aug 2025 13:48:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA33C10EB8F;
	Fri, 29 Aug 2025 11:48:29 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="HlTIbhtk";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9B47910EB8F;
 Fri, 29 Aug 2025 11:48:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1756468108; x=1788004108;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=OR9EgNKhP8sKC/gBwydNR680+dklCAxg+EGNsCSykUY=;
 b=HlTIbhtkN2+1G5BhsmqXVp54NrEQgKvWQGXcpmjnt9bS1hlP9Qz7DXyc
 5LIaKpSQXFBhXGz75lw90zNDhy1K0puh/KbpkZTFb6U+L/pr/z2dvT69X
 aljss1Q8zQnZAfHC+JosUsX0MDt6DGOTdHgOH/CDp2SKpdY6ePKUeyqH4
 7xqbcBlZQbnTeKeOeVE5ygrq5rdVk0RvmS7/OC94Cmm89BhtuX/jFdjpH
 yBzTYsu3xXT2BZgmVbsLwWnQFn/8ooQ30UuZpE6CuL9kKxtZ43Y9cPh5K
 aEfimO2exFrdLjuC4Yglm0pJj2hH+sz76cco4UxYMnrxPcl5cPmlxeK9e A==;
X-CSE-ConnectionGUID: 0AJZ9gMuSbmzaXdgm8W/xg==
X-CSE-MsgGUID: k7+VwrvBS7WdjZut8gcUKg==
X-IronPort-AV: E=McAfee;i="6800,10657,11536"; a="58818070"
X-IronPort-AV: E=Sophos;i="6.18,221,1751266800"; d="scan'208";a="58818070"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2025 04:48:28 -0700
X-CSE-ConnectionGUID: 6S63SxXXToG+XS+BHcxIpg==
X-CSE-MsgGUID: ad3jSbutTbmTqMw7PdHr6g==
X-ExtLoop1: 1
Received: from kamilkon-desk.igk.intel.com (HELO localhost) ([10.211.136.201])
 by fmviesa003-auth.fm.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Aug 2025 04:48:25 -0700
Date: Fri, 29 Aug 2025 13:48:23 +0200
...
Message-ID: <20250829114823.kxqjjrqdanbywsb6@kamilkon-DESK.igk.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D8748714856
	for <lists+intel-gfx@lfdr.de>; Mon, 29 May 2023 13:09:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC10A10E277;
	Mon, 29 May 2023 11:09:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B5C8310E277
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 May 2023 11:09:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685358554; x=1716894554;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=iri/oRna8EEqvsv29P8dIZHb6jRcIJVbXtX9sYSdnmk=;
 b=Mb1pMc1ExNWA7Tq3FjhTQZkapzbHdYBgayQRSdQkAt8F6nWrRqJqzJjF
 GjSepy3+oHZ49b9wtRZGV9l+KdKS/Zcw4li9QMrnEyGcbFE34XyRd0oqK
 D8aqMQBT5aAHnPpXl52SgmXKYsOcSO4yiFejlD17zxc/uIyFHiu/cZNn/
 goRHeQSG8gbtbq4h7KQG1qBR3QtWWe/T6yrG7LYQ2fsk/ilMcpidWWJFs
 9gwc8maA1K5iWYAzFywSfpAc4sAgXUhVHp3Vtnb+tM0I6854I3F7onrgB
 G6e0PapiRL1NmD/Imwff6uEsogiKt+VFXJZHaMPoRFm+MKEFG/Mk8+tJ/ A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10724"; a="382936204"
X-IronPort-AV: E=Sophos;i="6.00,201,1681196400"; d="scan'208";a="382936204"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 May 2023 04:09:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10724"; a="709233391"
X-IronPort-AV: E=Sophos;i="6.00,201,1681196400"; d="scan'208";a="709233391"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga007.fm.intel.com with ESMTP; 29 May 2023 04:09:11 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 29 May 2023 16:37:38 +0530
Message-Id: <20230529110740.1522985-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/3] drm/i915/hdcp: Rename dev_priv to i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6264A7C4CAA
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Oct 2023 10:11:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C37B110E30C;
	Wed, 11 Oct 2023 08:11:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C031C10E30C
 for <intel-gfx@lists.freedesktop.org>; Wed, 11 Oct 2023 08:11:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1697011895; x=1728547895;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=RLs8JGiHdPsYwk1ivdufPz009VL+3/QbEtoXwsYWMvE=;
 b=X4+ObN/vcIhqGVT2qxID543X6NG5IcihK7qBXeOutlYmg4TXiMVirXrE
 GwZt+wtXFJfnan5bvCkzrYUXfcdn2gfL+Lm/abXvxdfi6BDVfduNPExf7
 QADzACR7py8PFwEUkRMkicjXCr56Mkb4DTTRO8Gwtc96RLtl/QQd4psse
 FbIrItwBVzzaS/9KurhObXxSd7ueJjZcAm2TgzlstqgkW4aYalBhlmeme
 jiUIEdIEtj1yHSAJhxg9ZJPj/Bq1xDxEc/c0XzttF3YvUOGFHvNWu6Llu
 8pmv7bVO+Hikj1ghLIBwftwDjaWAvSi633CpNCLCWQ3zHoQclzM3yHuoK Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="384459591"
X-IronPort-AV: E=Sophos;i="6.03,214,1694761200"; d="scan'208";a="384459591"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2023 01:11:23 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="844465010"
X-IronPort-AV: E=Sophos;i="6.03,214,1694761200"; d="scan'208";a="844465010"
Received: from lkp-server02.sh.intel.com (HELO f64821696465) ([10.239.97.151])
 by FMSMGA003.fm.intel.com with ESMTP; 11 Oct 2023 01:11:21 -0700
Received: from kbuild by f64821696465 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1qqUJL-0001yv-1d;
 Wed, 11 Oct 2023 08:11:19 +0000
Date: Wed, 11 Oct 2023 16:10:28 +0800
From: kernel test robot <lkp@intel.com>
To: Shekhar Chauhan <shekhar.chauhan@intel.com>,
 intel-gfx@lists.freedesktop.org
Message-ID: <202310111551.luEGQMMh-lkp@intel.com>
...
config: i386-buildonly-randconfig-002-20231011 (https://download.01.org/0day-ci/archive/20231011/202310111551.luEGQMMh-lkp@intel.com/config)
compiler: gcc-12 (Debian 12.2.0-14) 12.2.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231011/202310111551.luEGQMMh-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202310111551.luEGQMMh-lkp@intel.com/

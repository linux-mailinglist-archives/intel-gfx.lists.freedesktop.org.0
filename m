...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5195D5FDDB1
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Oct 2022 17:56:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E33210E8FB;
	Thu, 13 Oct 2022 15:56:10 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/slpc: Use platform limits for
 min/max frequency

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47878D12F6
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Oct 2019 17:38:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF3F56E9E1;
...
Subject: [Intel-gfx] [PATCH 2/8] drm/nouveau: use drm_debug_enabled() to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C36AEA3E0A8
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Feb 2025 17:28:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BBA010E9AE;
	Thu, 20 Feb 2025 16:28:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="V39zgquT";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7412810E9AD;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 4KdFWwI2U6MQp+GgdGKbuRSEUeA5FU4aghSaiTb8v9BxSArbydQVkK2wL A==;
X-CSE-ConnectionGUID: AMw5sn69RjCHwec9BNAV+g==
X-CSE-MsgGUID: Zz7ZhXD3Tue1t1k46HYXtw==
X-IronPort-AV: E=McAfee;i="6700,10204,11351"; a="40724586"
X-IronPort-AV: E=Sophos;i="6.13,302,1732608000"; d="scan'208";a="40724586"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Feb 2025 08:28:01 -0800
X-CSE-ConnectionGUID: QPQ3ayuXRsWwW4MyBur1ag==
X-CSE-MsgGUID: YdwgBcqmTUWIjGDGp1zMMg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,302,1732608000"; d="scan'208";a="120070989"
Received: from puneetse-mobl.amr.corp.intel.com (HELO [10.125.110.82])
 ([10.125.110.82])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Feb 2025 08:28:00 -0800

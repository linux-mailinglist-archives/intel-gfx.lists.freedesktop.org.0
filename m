...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 48B4C3C9507
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jul 2021 02:21:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18A466E51A;
...
Subject: [Intel-gfx] [PATCH 00/13] Provide core infrastructure for managing
 open/release

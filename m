...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE5506721B7
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 16:45:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED51E10E783;
	Wed, 18 Jan 2023 15:45:37 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 5/7] io_uring: use __xchg if possible

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E0501A6A19
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Apr 2020 18:43:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 893F689F5F;
	Mon, 13 Apr 2020 16:43:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CF7EC89EAE
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Apr 2020 16:43:42 +0000 (UTC)
IronPort-SDR: h8ZQw8kEUNdKRnEqSIVG0cVkIR5gp9HEwAF+rzOlzOTo7LfP0maIgCwOooJAW8VU0GGuq6c3Rl
 iEvg8uI95BlQ==
...
IronPort-SDR: xoCSuo50SO+vJOyNHmMltwIBo+quJmIBahMSm5NmHXMqtTQF5rlymzsMTPbWA2POtX19DnfAF8
 U33PWNWuyASQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,378,1580803200"; d="scan'208";a="267485707"
...
Date: Mon, 13 Apr 2020 09:45:13 -0700
Message-Id: <20200413164515.13355-7-jose.souza@intel.com>
X-Mailer: git-send-email 2.26.0
In-Reply-To: <20200413164515.13355-1-jose.souza@intel.com>
References: <20200413164515.13355-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 7/9] drm/i915/tc: Catch TC users accessing
...
eS9pbnRlbF90Yy5jCmluZGV4IDUyMWE5NGM2MzY0MC4uZDNiZDVlNzk4ZmJjIDEwMDY0NAotLS0g

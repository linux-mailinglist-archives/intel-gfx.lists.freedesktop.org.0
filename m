...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DC75C05EAE
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Oct 2025 13:26:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79C6310EA66;
	Fri, 24 Oct 2025 11:26:29 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; secure) header.d=ffwll.ch header.i=@ffwll.ch header.b="cM7vtpiX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-f53.google.com (mail-wm1-f53.google.com
 [209.85.128.53])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E2C8910EA63
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Oct 2025 11:26:27 +0000 (UTC)
Received: by mail-wm1-f53.google.com with SMTP id
 5b1f17b1804b1-471131d6121so15251665e9.1
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Oct 2025 04:26:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=ffwll.ch; s=google; t=1761305186; x=1761909986; darn=lists.freedesktop.org; 
 h=in-reply-to:content-transfer-encoding:content-disposition
 :mime-version:references:message-id:subject:cc:to:from:date:from:to
 :cc:subject:date:message-id:reply-to;
 bh=fJNRsWOgouCDgjrGspPDoVt4gWAhiRaXsHw68nGGXpc=;
 b=cM7vtpiXCKjftUKPyUzDEnHAEv289F+PCEp9f4LblC+zUk1zYcrK7Nr1RMcOdWIUcK
 KevqPfp6LGI9bEFlusc51Twy5VHTX27V0nVTth1II9woB7bpHD7P2wqMtoo9wH7++yiZ
 8bQpIELsVxzS72qGYmSYxGjbpBNVnebHu6kYo=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1761305186; x=1761909986;
 h=in-reply-to:content-transfer-encoding:content-disposition
 :mime-version:references:message-id:subject:cc:to:from:date
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=fJNRsWOgouCDgjrGspPDoVt4gWAhiRaXsHw68nGGXpc=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCWJiIi/mstw8dZwq6KCC3cpjgTxQkKf0CtiK0hiZUsygmYYSU549ZrqhyUmf8GH0lZdSYziNx8wE2o=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YxqHfC6OeI3qdOcHBIlz0fS2DoEMcyc5TKaIauNqaKRRenP/2nc
 yClS31PREODUf/kBiPtaRd0ZxUEBz7TnleWSHQUaE7YE+Ys6nEj9VA1hxCVSoeli3lE=
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IFRzAW4MZbqmOH4lfCD7RO6s/zQZUkz3aIz9tQqLmfWEkzxgeTOM90hLymDO70WcRFdIgeLyw==
X-Received: by 2002:a05:600c:34d0:b0:45f:2922:2aef with SMTP id
 5b1f17b1804b1-47117911751mr224318345e9.28.1761305186242; 
 Fri, 24 Oct 2025 04:26:26 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:5485:d4b2:c087:b497])
 by smtp.gmail.com with ESMTPSA id
 5b1f17b1804b1-47496afd459sm86439065e9.1.2025.10.24.04.26.24
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 24 Oct 2025 04:26:25 -0700 (PDT)
Date: Fri, 24 Oct 2025 13:26:23 +0200
...
Message-ID: <aPtiX5aeq0N_pE5P@phenom.ffwll.local>
References: <aPXzbOb7eGbkgMrr@fedora>
MIME-Version: 1.0

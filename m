...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id ENpWBTUHsGlregIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Mar 2026 12:57:41 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E86624BD82
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Mar 2026 12:57:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1485910E6B0;
	Tue, 10 Mar 2026 11:57:30 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=lankhorst.se header.i=@lankhorst.se header.b="OUHFlH+e";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (unknown [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D004110E6AB;
 Tue, 10 Mar 2026 11:57:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1773143847;
 bh=42xBVBf7/zSvWegansEjJVb5Z73iPoTA1jQMjnntQyE=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH v7 08/26] drm/i915: Use preempt_disable/enable_rt() where
 recommended
Date: Tue, 10 Mar 2026 12:56:50 +0100
Message-ID: <20260310115709.2276203-9-dev@lankhorst.se>
...
X-Spamd-Result: default: False [1.69 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,intel.com:email,linutronix.de:email]

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 542D46CD307
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 09:25:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 93DAC10E4FE;
...
Subject: [Intel-gfx] [PATCH v2 7/9] drm/i915: Use memcpy_from_page() in
 gt/uc/intel_uc_fw.c

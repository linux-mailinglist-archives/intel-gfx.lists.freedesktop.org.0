...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F9D74BEDDD
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:26:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB2DE10E562;
	Mon, 21 Feb 2022 23:26:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C71D410E562;
 Mon, 21 Feb 2022 23:26:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485981; x=1677021981;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=mmpDbho6EFBReIp+UJ+Rf409yBMByOTa3FwPx9dN22o=;
 b=cn1Lk3NSWqjrrftB//9FNTxFKjHaAChUP2SyJCJcO+kx+EYDByiELg2o
 NClaVnJKbZpIgMpCjUhj9wL3bcMV4pi1iDcO7M5HVVhHhyNdWBeaNfGqQ
 v9ldG1C9v2PQQx5qFidmo2ZbbWaJQlfsJlde9dM4IahyHUrC3tJ5xMEva
 DJ+KiR8JOEFmjGd/q12Hbmq7GFf/rsdEiWEyhLB3f2Gss2QAJuxy+VXz4
 X9b1EQKd45MBVrk29AA/G//Sfj6fh8dpdf/h9u9ZnsBi16mCFBo6Wwkd+
 FJ+NzsnKyEYXm9ldwQnBP/MmD58VniyV58cUNND8Xx+HthwdFKSngcUFw A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="235119448"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="235119448"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:26:20 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="706397054"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:26:17 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: linux-kernel@vger.kernel.org, intel-gfx@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org, netdev <netdev@vger.kernel.org>
Date: Tue, 22 Feb 2022 00:25:39 +0100
Message-Id: <20220221232542.1481315-9-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 08/11] drm/i915: Separate wakeref tracking

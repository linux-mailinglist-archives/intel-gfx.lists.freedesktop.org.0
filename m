...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5033C184C47
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Mar 2020 17:21:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD2826EC09;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/9] drm: Constify topology id

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B1CDA9597AC
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Aug 2024 12:33:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57D7910E8CA;
	Wed, 21 Aug 2024 10:33:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VrTVbE0a";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B2BF410E8CA
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Aug 2024 10:33:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1724236420; x=1755772420;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=0vO45Ff2AsAxjbeVR5/Un2l7Ax/BJi+2LbEGbOxXpz0=;
 b=VrTVbE0a93XVQ6SWc381pfL8KcIwbP1LTiYIVWK45V7joi29ueYMavom
 YAf7J07ifv7nQtcGLbD2f/srDo2ykzEwn/rkXTsNCUguj9SyxCNpi9EV1
 Gx3e0rl5lCVpvDLP7/2RWKpnWCEgalqlVChrZXXLbD0d/TlsK99pduXQH
 nBwSeAx9GGxs49O/wmyZTOYMhqsEBp4LQlogtpPY2rPrfpbS33ntOYxtL
 Pd86SbIz/V1Brw8gDdy2I4FSxIWsgphdBDTzkZENO3O4ewIzxsoApae07
 yNBIqk9QGv9VDJDKgQLBh+L14aE/mUj3ZhKHa+ppKqaDouZjuIMpfSj7x A==;
X-CSE-ConnectionGUID: t4TOINVvTI2O9J3Aj+4ZCg==
X-CSE-MsgGUID: JI1Fr8x4STO/QDSISDETFQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11170"; a="33155453"
X-IronPort-AV: E=Sophos;i="6.10,164,1719903600"; d="scan'208";a="33155453"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Aug 2024 03:33:40 -0700
X-CSE-ConnectionGUID: R3mxRRacQMyOHKclE227Jg==
X-CSE-MsgGUID: rs1jAMXXT2WXeDCgqb8oLw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,164,1719903600"; d="scan'208";a="65740609"
Received: from srr4-3-linux-106-armuthy.iind.intel.com ([10.190.238.56])
 by fmviesa004.fm.intel.com with ESMTP; 21 Aug 2024 03:33:38 -0700
From: Arun R Murthy <arun.r.murthy@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Arun R Murthy <arun.r.murthy@intel.com>
Subject: [PATCHv2 3/5] Add crtc properties for global histogram
Date: Wed, 21 Aug 2024 15:53:47 +0530
Message-Id: <20240821102349.3961986-4-arun.r.murthy@intel.com>

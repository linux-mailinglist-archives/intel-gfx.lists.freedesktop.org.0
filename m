...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF26F675E1A
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Jan 2023 20:35:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D84710E39E;
...
Subject: [Intel-gfx] [PATCH v2 0/8] Add _PICK_EVEN_2RANGES

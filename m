...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D724128C02F
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Oct 2020 21:00:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1AC176E570;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 3/5] drm/i915: Introduce scaling filter

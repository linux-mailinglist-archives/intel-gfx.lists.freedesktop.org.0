...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A7143D9A54
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 02:49:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 182766E92F;
...
Subject: [Intel-gfx] [PATCH v3 08/14] vfio/pci: Move to the device set
 infrastructure

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4B081390AB
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jan 2020 13:04:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59F3C6E077;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 6/6] drm/i915: Make WARN* drm specific for
 various cases.

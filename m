...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84F0F5B0F83
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 23:52:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B028910E8DC;
	Wed,  7 Sep 2022 21:52:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 90D8010E8D8
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Sep 2022 21:51:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1662587514; x=1694123514;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=E4BDJWRngPMS6N93vl9Ek5HBey+FwHqzMSQ0kh5WK+c=;
 b=A4MNm6vqlT/QfuqcZdWmvGlopCw9g1HtjuVt6ywoFKaq+5JCQCC3o5R8
 6q7tLf7XPCNMRzC7k5XISdkedg7MiasuSD4dEowMfaEQG/u76lmOuGwS/
 314fIS7k6owruJ3TXOjXsZRcQwtO6pPna2ngGyk1mOLd+IMytX/U9KgbD
 s9DHTDvxdEWjHa/HJ5m6+SmkfTRCgRP/c08DuYvp99wF9peiyULjh+bdd
 b9pmJCk/4ZRuWEuFZUqWsABb3UilOsGPQdTJ6os/hzIEkhBvsU06aWVPL
 zj+QEuTYqpgXsnJQl7tVwLyxe461iAnjxGITbdoN/a++WStoVK5FZSysH A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10463"; a="323193648"
X-IronPort-AV: E=Sophos;i="5.93,298,1654585200"; d="scan'208";a="323193648"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2022 14:51:54 -0700
X-IronPort-AV: E=Sophos;i="5.93,298,1654585200"; d="scan'208";a="790207898"
...
Date: Thu,  8 Sep 2022 00:51:03 +0300
Message-Id: <20220907215113.1596567-7-tomas.winkler@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 06/16] mei: gsc: use polling instead of
 interrupts

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74A3715ADBB
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Feb 2020 17:54:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF27B6EAF6;
...
Subject: [Intel-gfx] [PATCH V7] drm: Add support for DP 1.4 Compliance edid
 corruption test

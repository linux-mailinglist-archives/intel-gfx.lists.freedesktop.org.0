...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DAE3B40012C
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Sep 2021 16:23:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B4A76E8A0;
	Fri,  3 Sep 2021 14:23:45 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH RESEND] drm/i915: Flush buffer pools on driver
 remove

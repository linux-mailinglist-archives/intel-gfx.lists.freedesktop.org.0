...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFE792F0E1D
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jan 2021 09:27:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E78406E067;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 17/19] drm/i915/hdcp: Support for HDCP 2.2
 MST shim callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DEAF49E0A3
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jan 2022 12:21:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C85410EF67;
	Thu, 27 Jan 2022 11:21:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A551510EF66
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Jan 2022 11:21:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643282501; x=1674818501;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=hQzV42cgTJ1Moxa9K1zAgU7wI5TafbRHWvgA6b20aw8=;
 b=GtPEmwG+/LQrkxGnBFRIvLjXQPWztlj65KtitAhM1l/Omq7mKywxZ/OF
 L4yzV2FASqRwnNCsWnSo1Rnky4nuzpusihlafOWjoP82vyunnx7X1rsKA
 J5jjsWYgWyLSxnx/YlGnsx7ZtRjUyfpqjH51yjCJsTckGQ3KPH/p4eONQ
 wqSYHqJ7GthDBFkrE6rZIaCQhwozgoPxOF4vtxxG6JFgq7u+QbdzQ/Jwd
 rDL0HUa7memT1y38hWlH019uieiPf7YOLXYDxZY5umbSF0d7AU0D9MvOs
 7yZ/Fyk4Z+c9wKCLPfBo8tvnyDMgrRWQAgi5fmcragVhcDs7xCd4ufeiz g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10239"; a="271277556"
X-IronPort-AV: E=Sophos;i="5.88,320,1635231600"; d="scan'208";a="271277556"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jan 2022 03:21:41 -0800
X-IronPort-AV: E=Sophos;i="5.88,320,1635231600"; d="scan'208";a="480253238"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jan 2022 03:21:38 -0800
...
Date: Thu, 27 Jan 2022 13:21:00 +0200
Message-Id: <20220127112103.2336871-3-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 2/5] mei: add support for graphics system

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 14FC57AF262
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Sep 2023 20:04:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12AB710E415;
...
Subject: Re: [Intel-gfx] [PATCH 6/6] drm/eld: add helpers to modify the SADs
 of an ELD

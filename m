...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D2CC26A7E8
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 17:00:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B34E6E88A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 07/21] drm/mediatek: Introduce GEM object
 functions

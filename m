...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6619C4A6D2C
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Feb 2022 09:46:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7ACD10FAC7;
	Wed,  2 Feb 2022 08:46:24 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 3/6] drm/vkms: change vkms driver to use

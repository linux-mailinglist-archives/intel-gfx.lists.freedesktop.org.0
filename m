...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 630071090FC
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Nov 2019 16:28:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9363689A59;
	Mon, 25 Nov 2019 15:28:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B72CB89A59
 for <intel-gfx@lists.freedesktop.org>; Mon, 25 Nov 2019 15:28:16 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19331998-1500050 
 for multiple; Mon, 25 Nov 2019 15:27:15 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 25 Nov 2019 15:27:09 +0000
Message-Id: <20191125152710.2125824-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.24.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/2] drm/i915/gem: Excise the per-batch
...

...
aW1lbGluZSkKIAkJaW50ZWxfdGltZWxpbmVfcHV0KGN0eC0+dGltZWxpbmUpOwogCkBAIC01ODQs
OSArNTgyLDYgQEAgX19jcmVhdGVfY29udGV4dChzdHJ1Y3QgZHJtX2k5MTVfcHJpdmF0ZSAqaTkx
...
cy9ncHUvZHJtL2k5MTUvaTkxNV9jbWRfcGFyc2VyLmMKaW5kZXggZjI0MDk2ZTI3YmVmLi5kZWQy
YzFlZDBmN2UgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfY21kX3BhcnNl
...
c2UgdGhlIHNoYWRvdyBvYmplY3QgaXMgYXMKQEAgLTE0ODcsMTUgKzE0NjcsMTYgQEAgaW50IGlu
...


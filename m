...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D21849770A
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jan 2022 02:54:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0F69910E43C;
	Mon, 24 Jan 2022 01:54:17 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH V2 5/7] drm/msm: Alter comment to use
 kmap_local_page()

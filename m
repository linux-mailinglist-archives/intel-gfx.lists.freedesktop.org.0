...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BC5917D097
	for <lists+intel-gfx@lfdr.de>; Sun,  8 Mar 2020 00:20:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 676366E26F;
...
Subject: Re: [Intel-gfx] [PATCH v5 02/16] drm/i915: Clear the repeater bit
 on HDCP disable
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="===============0141411683=="

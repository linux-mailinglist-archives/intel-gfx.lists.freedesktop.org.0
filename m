...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF9716EA0EB
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 03:15:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC35210ED7C;
...
Subject: [Intel-gfx] [PATCH 5/6] drm/i915/uc: Reject duplicate entries in
 firmware table

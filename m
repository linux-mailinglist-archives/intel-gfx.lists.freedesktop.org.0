...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA9665EA0AF
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Sep 2022 12:40:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17D5810E67E;
...
Subject: Re: [Intel-gfx] [PATCH v2 31/33] drm/vc4: vec: Convert to the new
 TV mode property

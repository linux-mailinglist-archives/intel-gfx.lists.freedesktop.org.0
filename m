...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GPv1Gedt6mnrzAIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Apr 2026 21:07:19 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1450D4566D1
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Apr 2026 21:07:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8333010F33B;
	Thu, 23 Apr 2026 19:07:17 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=nicolas.frattaroli@collabora.com header.b="bPIgYGIX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com
 [136.143.188.112])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4505810F372;
 Thu, 23 Apr 2026 19:07:15 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1776971224; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=LgptSmn7wY3huMQndBnDJm7fDiIG+TctMZbkdcTwktQg4yWGWvb9HG96wrBH4e6suoBGJf1FU3X/tNfW8ThmKudgfhXnqT28BbrIs72CKH8jz+E5FxdwIRSrmwiYNovJLDLSKS8OUCsgJHk2lP2wTohymgx7o9vvYhxnJDiTA0Q=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1776971224;
 h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To;
 bh=Q6LewHLgG66mB+cKlrE6Jmde9yR3/vCwSuAKYYuzjYw=; 
 b=FuE0Pi+AGsB3VtY5qJ2FIZ/gr9n5KoWibek9PGqgGTLt+vluDZXQulr+q7YY09IXrjrbDIRAI2BcuzcbXvzn6R/tRVbG/VwAPfIJKza0dkBcjfmKe+Bz7RZNkX27qNGSCBa1SvtEcsib9zJgBRElTXzZtI+CiQsGcNXJnM8T6Zc=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=nicolas.frattaroli@collabora.com;
 dmarc=pass header.from=<nicolas.frattaroli@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1776971224; 
 s=zohomail; d=collabora.com; i=nicolas.frattaroli@collabora.com;
 h=From:From:Date:Date:Subject:Subject:MIME-Version:Content-Type:Content-Transfer-Encoding:Message-Id:Message-Id:References:In-Reply-To:To:To:Cc:Cc:Reply-To;
 bh=Q6LewHLgG66mB+cKlrE6Jmde9yR3/vCwSuAKYYuzjYw=;
 b=bPIgYGIXgg6kRR5osj6P4/DiKmS0vTZokUx2qlU1ATLAr6Z0fisBP7Wx8iJT3k0x
 juCnsrcODXzCQDiqYZXYok+mxt3HSUPQVZpN/IwE9BuFRhqX+sPxmEtrFf9kGuloOur
 lL/mEqUSt9k+VFCXyZ32TlsepOabertgfhQ7QvIQ=
Received: by mx.zohomail.com with SMTPS id 1776971222059480.57614220251116;
 Thu, 23 Apr 2026 12:07:02 -0700 (PDT)
From: Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
Date: Thu, 23 Apr 2026 21:03:48 +0200
Subject: [PATCH v14 25/28] drm/tests: bridge: Add KUnit tests for bridge
 chain format selection
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260423-color-format-v14-25-449a419ccbd4@collabora.com>
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[collabora.com:email,collabora.com:dkim,collabora.com:mid,bootlin.com:email,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns]
X-Rspamd-Queue-Id: 1450D4566D1

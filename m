...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3ABB324155B
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Aug 2020 05:36:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADDF18989A;
...
Subject: [Intel-gfx] [PATCH] drm/i915/gt:fix raw-wakeref not held calltrace
 in vGPU

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BA93B5B3042
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:38:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90FE310EC3F;
...
Subject: [Intel-gfx] [PATCH v3 31/37] docs: gpu: i915.rst: GEM/TTM: add more
 kernel-doc markups

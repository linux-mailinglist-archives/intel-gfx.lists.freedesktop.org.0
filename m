...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66A8BC9A41B
	for <lists+intel-gfx@lfdr.de>; Tue, 02 Dec 2025 07:26:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CAC0A10E532;
	Tue,  2 Dec 2025 06:26:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="FTz1Osoz";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7251410E530;
 Tue,  2 Dec 2025 06:26:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764656805; x=1796192805;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=OnoQw+WGMOSua69IZF429WXsBNR+plizO3e0OgMJIsU=;
 b=FTz1OsozHexUlTt3JJWFI4kREJwUuhfxofm00lz7mEUNf6iFa0lf3z0E
 tDVTScyzddFkLww2/uU7UMkMUsnK1HLAnLFbfuhkXFh8ifsQ3Ieis7X2p
 F3F0uLLJGor0iERzVIygibe8+jPyZtNTGW5Zelh4nRwRCD4YAoyZRvLZX
 F+2H1GNbORhhAhqZBupq5ASZ5/ryewSfkm3vwxGZ9I4ebJw2LXxPjgOlG
 A0b9wklfBAAhyXvSRGnoOauG+cdJ3rL1Qb2e7THYXEQr9ErI/alqOnqSB
 4uUkxbQjFHRTu+gb9GZAqva/uyb1eQcMeiOgFKA2gHWuZA9Ky7y5kWPPw g==;
X-CSE-ConnectionGUID: gt3T9XvcRB+GIqeH/HvSNQ==
X-CSE-MsgGUID: RZnFpiWGQlqngS2Fb2QZSQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11630"; a="66499790"
X-IronPort-AV: E=Sophos;i="6.20,242,1758610800"; d="scan'208";a="66499790"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Dec 2025 22:26:44 -0800
X-CSE-ConnectionGUID: hwGmxIuASxGyqiYU4AhVNQ==
X-CSE-MsgGUID: ytDa5iBDR9W8WvbY8jXXOQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,242,1758610800"; d="scan'208";a="193961029"
Received: from srr4-3-linux-106-armuthy.iind.intel.com ([10.190.238.56])
 by fmviesa007.fm.intel.com with ESMTP; 01 Dec 2025 22:26:37 -0800
From: Arun R Murthy <arun.r.murthy@intel.com>
Date: Tue, 02 Dec 2025 11:56:55 +0530
Subject: [PATCH [RESEND] v9 01/20] DO_NOT_REVIEW: plane/crtc color pipeline
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20251202-dpst-v9-1-f2abb2ca2465@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1584ECB8D78
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Dec 2025 14:02:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 966C110E357;
	Fri, 12 Dec 2025 13:02:21 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=lankhorst.se header.i=@lankhorst.se header.b="BkoOYMj/";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (lankhorst.se [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3D47F10E356;
 Fri, 12 Dec 2025 13:02:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1765544539;
 bh=9gCKnMzauq1EgDlxj5/d0ncxaLvtKEm7MmnJ4+bl8G8=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH 03/11] drm/i915/display: Use intel_de_write_fw in
 intel_pipe_fastset
Date: Fri, 12 Dec 2025 14:02:09 +0100
Message-ID: <20251212130205.963029-16-dev@lankhorst.se>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC97C68C3E9
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Feb 2023 17:54:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4D0610E9C4;
...
Subject: [Intel-gfx] [PATCH v2 2/2] drm/i915: Remove unused/wrong

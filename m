...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C6CF6082C2
	for <lists+intel-gfx@lfdr.de>; Sat, 22 Oct 2022 02:09:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D545310E685;
	Sat, 22 Oct 2022 00:08:15 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 4/7] drm/i915/guc: Add GuC deprivilege
 feature to MTL

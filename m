...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F63F3D00A5
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 19:43:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDE306E506;
...
Subject: [Intel-gfx] [PATCH v2 10/14] vfio/pci: Reorganize

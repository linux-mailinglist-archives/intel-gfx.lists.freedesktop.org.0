...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F16C7790D84
	for <lists+intel-gfx@lfdr.de>; Sun,  3 Sep 2023 20:46:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01ECC10E1D4;
	Sun,  3 Sep 2023 18:46:32 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 3/6] drm_dbg: add trailing newlines to msgs
...
Cc: "Jason A. Donenfeld" <Jason@zx2c4.com>, daniel.vetter@ffwll.ch,
 ...
 Rob Clark <robdclark@chromium.org>, Matthew Auld <matthew.auld@intel.com>,
 jani.nikula@intel.com, seanpaul@chromium.org,
 Rodrigo Vivi <rodrigo.vivi@intel.com>, Jim Cromie <jim.cromie@gmail.com>,
 daniel@ffwll.ch

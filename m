...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC1D27424A8
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jun 2023 13:06:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E783D10E13A;
	Thu, 29 Jun 2023 11:06:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 714EB10E13A
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Jun 2023 11:06:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1688036782; x=1719572782;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=cEEkD+tSLOaSvqyv0Ajc+3fVPsdZjXigfNf097PQIUA=;
 b=W/Fe+/FZZs5LVnDhKHYXWvAWXleuILq75srOHvu80uPVT0LDNF6rKzxf
 Rze3pgnmcDphgFbOt/RVqk3LRJnsLKJUgHl2FUjk389A+E9n1e7MM8lA9
 djoHH/ZjFugptvvMM6p4wOSlON0UYg90iGYnKrXdRnI47EdTV8UUe2kJz
 ZryDkxzPxof+QKgn4Udvd8GbIvUhhkVcHVLFR76Wfv/XOST6HZpXA8eyo
 HFIEhiIEH5A0Qant2+HIqtJ/ny2qtnYpkdbYANfMLLCQkyXJuNrUXZY4j
 mZq2QJEZL/T80BCXPah+cdsDZTEglGaL+u8FzFVVpTofz45Lnp/fW0o1M Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10755"; a="359566377"
X-IronPort-AV: E=Sophos;i="6.01,168,1684825200"; d="scan'208";a="359566377"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jun 2023 04:06:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10755"; a="717323105"
X-IronPort-AV: E=Sophos;i="6.01,168,1684825200"; d="scan'208";a="717323105"
Received: from coflynn-mobl.ger.corp.intel.com (HELO [10.213.199.178])
 ([10.213.199.178])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jun 2023 04:06:07 -0700
Message-ID: <c8d141c5-6333-3b57-6248-c0313fba1ca4@linux.intel.com>
Date: Thu, 29 Jun 2023 12:06:04 +0100
MIME-Version: 1.0
...
References: <cover.1687878757.git.jani.nikula@intel.com>
 <2083fb26468eef13defb9b70523f7f707fc93bad.1687878757.git.jani.nikula@intel.com>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
In-Reply-To: <2083fb26468eef13defb9b70523f7f707fc93bad.1687878757.git.jani.nikula@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
Subject: Re: [Intel-gfx] [PATCH v2 2/6] drm/i915: move platform_engine_mask
 and memory_regions to device info

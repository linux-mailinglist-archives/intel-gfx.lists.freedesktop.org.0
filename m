...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4AE1A3DA068
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 11:39:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B09D76ED0B;
	Thu, 29 Jul 2021 09:39:31 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH rdma-next v3 3/3] RDMA: Use the sg_table

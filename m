...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 581ED563CE5
	for <lists+intel-gfx@lfdr.de>; Sat,  2 Jul 2022 01:52:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7F47D113DD1;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/display: clean up comments

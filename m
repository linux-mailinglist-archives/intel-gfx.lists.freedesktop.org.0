...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C67E457309C
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 10:14:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E6D1961DD;
...
Subject: [Intel-gfx] [PATCH v2 26/39] drm/i915: i915_gem.c fix a kernel-doc
 issue

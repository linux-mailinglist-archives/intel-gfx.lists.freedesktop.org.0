...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC1A04C3C5A
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 04:24:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BAEE710E749;
...
Subject: [Intel-gfx] [PATCH v12 2/6] drm/i915/gt: Re-work

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id MGP2FjTYeWlI0AEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Jan 2026 10:34:44 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A84159EDB5
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Jan 2026 10:34:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 923A510E630;
	Wed, 28 Jan 2026 09:34:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=oracle.com header.i=@oracle.com header.b="FtKnUzRh";
	dkim=pass (1024-bit key; unprotected) header.d=oracle.onmicrosoft.com header.i=@oracle.onmicrosoft.com header.b="WC9CzKkh";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx0b-00069f02.pphosted.com (mx0b-00069f02.pphosted.com
 [205.220.177.32])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5E1EE10E0FA;
 Wed, 28 Jan 2026 09:34:39 +0000 (UTC)
Received: from pps.filterd (m0246631.ppops.net [127.0.0.1])
 by mx0b-00069f02.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id
 60S4BtD51337279; Wed, 28 Jan 2026 09:34:00 GMT
...
Received: from pps.filterd
 ...
 with ESMTP id 60S8Abxt019753; Wed, 28 Jan 2026 09:33:59 GMT
...
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?L25IBWIsZSWv+3ZnqvAd9ay15cawbeqOk/s3kCFaXgD/qra1ruIQ0PeV3fAj?=
...
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?00y1c5fjRL0s7pYvk8P8bsIOeVEql0Z5KJgWRdDAUS9SslXkc46uxfNUCGqY?=
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,oracle.com:dkim,oracle.onmicrosoft.com:dkim];
	MISSING_XM_UA(0.00)[];

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9643C6AB2DD
	for <lists+intel-gfx@lfdr.de>; Sun,  5 Mar 2023 23:12:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D261310E0AA;
	Sun,  5 Mar 2023 22:11:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from madras.collabora.co.uk (madras.collabora.co.uk
 [IPv6:2a00:1098:0:82:1000:25:2eeb:e5ab])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E928210E0D0;
 Sun,  5 Mar 2023 22:11:45 +0000 (UTC)
Received: from workpc.. (unknown [109.252.117.89])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 (Authenticated sender: dmitry.osipenko)
 by madras.collabora.co.uk (Postfix) with ESMTPSA id 4B699660230B;
 Sun,  5 Mar 2023 22:11:43 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
 s=mail; t=1678054304;
 bh=WRl8VpDVwi1bS0uzF7+wkytil0cA8n7oxwrZSSeEdoY=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Date: Mon,  6 Mar 2023 01:10:10 +0300
Message-Id: <20230305221011.1404672-11-dmitry.osipenko@collabora.com>
...
Subject: [Intel-gfx] [PATCH v12 10/11] drm/virtio: Support memory shrinking
...
index 02e5c18c2c75..874ad6c2621a 100644
--- a/drivers/gpu/drm/virtio/virtgpu_kms.c
+++ b/drivers/gpu/drm/virtio/virtgpu_kms.c
@@ -243,6 +243,12 @@ int virtio_gpu_init(struct virtio_device *vdev, struct drm_device *dev)
 		goto err_scanouts;
 	}
...
+
 	...
 	if (num_capsets)
@@ -257,6 +263,8 @@ int virtio_gpu_init(struct virtio_device *vdev, struct drm_device *dev)
 	}
 	return 0;

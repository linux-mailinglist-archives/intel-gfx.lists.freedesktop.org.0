...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D0EB64B3248
	for <lists+intel-gfx@lfdr.de>; Sat, 12 Feb 2022 02:04:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49C1D10EB7B;
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/guc: Do not complain about stale
 reset notifications

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EADA3DF753
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Aug 2021 00:12:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33F5189E06;
...
Subject: [Intel-gfx] [PATCH 02/46] drm/i915/guc: Connect the number of
 guc_ids to debugfs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DDEE650123C
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Apr 2022 17:07:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E737110FF26;
...
Subject: [Intel-gfx] [PATCH 03/19] drm/edid: clean up CTA data block tag
 definitions

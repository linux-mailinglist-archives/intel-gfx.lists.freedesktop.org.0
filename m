...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A6F7526FFC7
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Sep 2020 16:26:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A83256ECE4;
...
Subject: Re: [Intel-gfx] [PATCH 4/4] drm/dev: Remove drm_dev_init
...
Content-Type: multipart/mixed; boundary="===============0746139105=="

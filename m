...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8230F635797
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Nov 2022 10:46:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 975B510E1FF;
	Wed, 23 Nov 2022 09:46:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A6B8110E1FF;
 Wed, 23 Nov 2022 09:46:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669196784; x=1700732784;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=JN31VfzGAHmyFw/1H3JxWq1GTgkSKyBx4fCXZiWaBdU=;
 b=B9Yyk4/q2bu8RToSoJAHsMbY5wTldf/BxImqDv37LRnPuS7qgkzF5uoa
 IGXl5J2xLZ/UlTVEkoLqhWMUK/vWFI28uAqeKiGwQLeC8X7i3uXJ5rqd7
 RAz+ijo7iuFMKg772L+BqptcZtb0TZAYw6ow7uUR8qO+9lhAYPiPY/9+w
 YhcMAxhVXRCItRGi0i9maI30VapznsOokHjnfpSktRi/MoE/5GPsQBEYa
 mkq2i2clWKTbV1HezZR0zYVt3DX1//NIHpYAsACuUeP46oAGeRufByPBB
 DmzcCL7xPFH+bRfbKI/tVDa4pbM38sAmuqUakoXKMoKmzHUNO/ch4BZ+h Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10539"; a="400318982"
X-IronPort-AV: E=Sophos;i="5.96,187,1665471600"; d="scan'208";a="400318982"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Nov 2022 01:46:24 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10539"; a="672815007"
X-IronPort-AV: E=Sophos;i="5.96,187,1665471600"; d="scan'208";a="672815007"
Received: from tpowell-mobl.ger.corp.intel.com (HELO [10.213.224.65])
 ([10.213.224.65])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Nov 2022 01:46:22 -0800
Message-ID: <5a3ef9fa-113f-9d81-a3a5-ea6d72a9852c@linux.intel.com>
Date: Wed, 23 Nov 2022 09:46:20 +0000
MIME-Version: 1.0
...
References: <20221122185737.96459-1-andi.shyti@linux.intel.com>
 <20221122185737.96459-2-andi.shyti@linux.intel.com>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
In-Reply-To: <20221122185737.96459-2-andi.shyti@linux.intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
Subject: Re: [Intel-gfx] [PATCH v2 1/4] drm/i915: Wrap all access to

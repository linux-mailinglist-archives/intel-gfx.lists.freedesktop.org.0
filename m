...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 846C02C655F
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:13:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDC266ECA6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 133/162] drm/i915/dg1: Track swap in/out
 stats via debugfs

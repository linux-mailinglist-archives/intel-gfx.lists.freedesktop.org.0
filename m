...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B70A2EF792
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Jan 2021 19:41:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 801726E892;
	Fri,  8 Jan 2021 18:41:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 89D926E892
 for <intel-gfx@lists.freedesktop.org>; Fri,  8 Jan 2021 18:41:35 +0000 (UTC)
IronPort-SDR: fZXaDsO3GoqfxtK4qJhPUSvsf2OQC0VBPYUWdP3jykAfmgdr6cNtZcaLVAJAknPb5+csHgtAXw
 8LPLT9ItPwfA==
X-IronPort-AV: E=McAfee;i="6000,8403,9858"; a="177787506"
X-IronPort-AV: E=Sophos;i="5.79,332,1602572400"; d="scan'208";a="177787506"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jan 2021 10:41:35 -0800
IronPort-SDR: CMrAoir1SVhwc5uFFVZVRlctX4NINZJWabw6xlVoBfgN5g4HyZhMU1SwLsle8uHIYnQfRtyPLe
 2sd7ZZgd50Iw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.79,332,1602572400"; d="scan'208";a="350956518"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 08 Jan 2021 10:41:32 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 08 Jan 2021 20:41:32 +0200
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  8 Jan 2021 20:41:01 +0200
Message-Id: <20210108184101.30972-10-ville.syrjala@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 9/9] drm/i915: Implement async flips for vlv/chv
...

...
CiB7CkBAIC01NzIsNiArNTg5LDI4IEBAIGlsa19wcmltYXJ5X2Rpc2FibGVfZmxpcF9kb25lKHN0
...
bmUgKnBsYW5lLAogCQkJCSAgICBlbnVtIHBpcGUgKnBpcGUpCiB7CkBAIC03MzksMTYgKzc3OCwy
...
LmMKaW5kZXggYzlhZDRlOTM1YjZiLi40NTk3MTAwYzAxODYgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMv
...

...
RElTQUJMRQkJCTAKQEAgLTY2MjcsNiArNjYyOCw3IEBAIGVudW0gewogI2RlZmluZSBfRFNQQVNV

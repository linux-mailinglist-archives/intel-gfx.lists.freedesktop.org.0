...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 87690F3288
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2019 16:13:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEA406F6D1;
	Thu,  7 Nov 2019 15:13:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-1.mimecast.com
 [207.211.31.81])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 08A566F6D2
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 Nov 2019 15:13:46 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-413-84hqFE-DNBaaOW_QJS04KA-1; Thu, 07 Nov 2019 10:13:41 -0500
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
 [10.5.11.11])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 1EEF5477;
 Thu,  7 Nov 2019 15:13:38 +0000 (UTC)
Received: from jason-ThinkPad-X1-Carbon-6th.redhat.com
 (ovpn-12-21.pek2.redhat.com [10.72.12.21])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 50E3A600D1;
 Thu,  7 Nov 2019 15:13:12 +0000 (UTC)
...
To: kvm@vger.kernel.org, linux-s390@vger.kernel.org,
 ...
 tiwei.bie@intel.com
Date: Thu,  7 Nov 2019 23:11:07 +0800
Message-Id: <20191107151109.23261-5-jasowang@redhat.com>
In-Reply-To: <20191107151109.23261-1-jasowang@redhat.com>
References: <20191107151109.23261-1-jasowang@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.11
X-MC-Unique: 84hqFE-DNBaaOW_QJS04KA-1
X-Mimecast-Spam-Score: 0
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=redhat.com; 
 s=mimecast20190719; t=1573139625;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=wtvIi2yIPGS5MLETRkpjvruFht3By2opLcoYExxwXWY=;
 b=Dg0ParWrqJ1tEbM3OzrOUmnrweBlUEbinMgNMxJsgfQHs3TgmTU/D5X0Ji3/CtqrHGlqgt
 R4ovoprrUEZoAzOqrodcq9T4+Blph8SbWax2ePeWxDBjfy0hFSR7PxYu4t2LAynCQVEtyJ
 wAsOMOcgxz2NJm7Kh1D5tCVOwD3roD8=
Subject: [Intel-gfx] [PATCH V11 4/6] mdev: introduce virtio device and its
 device ops

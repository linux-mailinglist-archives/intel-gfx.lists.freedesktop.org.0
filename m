...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C2A8B59FC87
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Aug 2022 16:01:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3448310E2AE;
	Wed, 24 Aug 2022 14:01:30 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 5/9] dma-buf: Move
 dma_buf_mmap_unlocked() to dynamic locking specification

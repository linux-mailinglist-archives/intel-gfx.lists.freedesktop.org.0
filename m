...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 81B5D21FF25
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 24D856E9C2;
...
Subject: [Intel-gfx] [PATCH v2 11/59] drm/kmb: Use correct mmio offset from
 data book

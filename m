...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F36A2C4FCB
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Nov 2020 08:51:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9DB706E859;
	Thu, 26 Nov 2020 07:51:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 91BBD6E84F;
 Thu, 26 Nov 2020 07:51:52 +0000 (UTC)
IronPort-SDR: pPCpaJmRNZY/7TC7YnR/nxonTcsA2DX45BEZQG6EwwHjtIjN7Uxfou+QeJKAyZq8RU2r3bXGM1
 330238tg9SbA==
X-IronPort-AV: E=McAfee;i="6000,8403,9816"; a="152084954"
X-IronPort-AV: E=Sophos;i="5.78,371,1599548400"; d="scan'208";a="152084954"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2020 23:51:52 -0800
IronPort-SDR: sYSiDpXYq4oIlLIlYUcDmT1z+lZcB43ZmhH7g32eKkuGqlqzl8CctOhgeQMlowR9pxCMirSmdS
 1kpmqFXeUJbQ==
X-IronPort-AV: E=Sophos;i="5.78,371,1599548400"; d="scan'208";a="535652550"
Received: from genxfsim-desktop.iind.intel.com ([10.223.74.178])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2020 23:51:49 -0800
From: Anshuman Gupta <anshuman.gupta@intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Thu, 26 Nov 2020 13:07:15 +0530
Message-Id: <20201126073722.19107-12-anshuman.gupta@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 11/18] drm/i915/hdcp: Encapsulate
...
index 8a62fdaea588..27ea99c942d7 100644
--- a/drivers/gpu/drm/i915/display/intel_ddi.c
+++ b/drivers/gpu/drm/i915/display/intel_ddi.c
@@ -4946,6 +4946,8 @@ static void intel_ddi_encoder_destroy(struct drm_encoder *encoder)
...
index ca8258483d5e..00147f4606bf 100644
...
-	struct hdcp_port_data port_data;
 	...
 	bool is_paired;
 	bool is_repeater;
@@ -1481,10 +1480,12 @@ struct intel_digital_port {

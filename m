...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62218730E7B
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jun 2023 07:00:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0ED210E483;
	Thu, 15 Jun 2023 05:00:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 269E610E483
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Jun 2023 05:00:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686805229; x=1718341229;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=JgocDkmn9jWeYuRP8wjfGOsRRiekm5KEES7saL1rSzQ=;
 b=VcQ7YghbXxwO2prdN3mFujJZWY6sWn4ewWxmYoRC8jBmMAj/LjG4RTnb
 VNqlKxWxBdnZFoDtxLBLkrKBgJF/U4eh90y/hjoILUY4MIbfZoFCQv75P
 dEBQ/0n9TS0fAd4tsxY6d4Pf8Eci4bJzMp3AmUn95eIxBcg2pjXMbgGng
 qjrrxpGNgwPzumhUxf6oz/q0YVL4kIvQVJ0EjBF/wMrFXCtfHu3zGp8dL
 AqYTw8ffQHLpVeqH5u43OogTNe9waD3LlNURWafLD6N8phOLcJD0Lqtxu
 jj9pXiB+gf3aORc/f/wQ6FUqymvARQfy838dUnMoHjjGpIiSt32DreCeC w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10741"; a="361291098"
X-IronPort-AV: E=Sophos;i="6.00,243,1681196400"; d="scan'208";a="361291098"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2023 22:00:29 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10741"; a="689649408"
X-IronPort-AV: E=Sophos;i="6.00,243,1681196400"; d="scan'208";a="689649408"
Received: from pltuser2-ms-7d25.iind.intel.com ([10.190.239.58])
 by orsmga006.jf.intel.com with ESMTP; 14 Jun 2023 22:00:26 -0700
From: Dnyaneshwar Bhadane <dnyaneshwar.bhadane@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 15 Jun 2023 10:30:08 +0530
Message-Id: <20230615050015.3105902-5-dnyaneshwar.bhadane@intel.com>

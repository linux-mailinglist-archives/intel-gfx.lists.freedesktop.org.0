...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9256D1FEF37
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jun 2020 12:04:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB8D96EB37;
	Thu, 18 Jun 2020 10:04:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E33866EB37
 for <intel-gfx@lists.freedesktop.org>; Thu, 18 Jun 2020 10:04:09 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21535912-1500050 
 for multiple; Thu, 18 Jun 2020 11:04:00 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 18 Jun 2020 11:03:52 +0100
Message-Id: <20200618100356.15744-7-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/11] drm/i915/gt: Extract busy-stats for
 ring-scheduler
...
Yy5jCmluZGV4IDcyMzU1NTc4Mzc3Yi4uNjhiOGU2ODdmMzU0IDEwMDY0NAotLS0gYS9kcml2ZXJz

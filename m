...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 83BF36CD315
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 09:25:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC97110EA44;
	Wed, 29 Mar 2023 07:25:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 04DEA10E4FE;
 Wed, 29 Mar 2023 07:25:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680074723; x=1711610723;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=0gwuCrSS+PYNYH178QUZmFv17Te3/Z0/cN6X97q7hS4=;
 b=LEYTzgaSBRTOyDGeYxvGrUQECacujZVKFfKt65caH2gUmReTek3PBIQs
 8pz4Pgy18JHKDocgNBU03hAO4A3LSzYrrBgaNJxUTgoIiBV5a7Ahd2fnB
 YIYY9J+aW0eh/nYG0v4CqueOEMl0aPx/WNX8yg7qzBhlE813mrPISuYqJ
 LP0sLGkTCQuvpvYVAFy+n0YMItM7fBHd9HQcJdSnRBQbvU8iiUk/g3ezq
 b8Qy2NmL/HYG5z6n9jQd4R/8PpTZJiTLufO4LJ68fXc5CDQmPaWZK7CBW
 u2ywSn9qLH+lG485ciOzzbS8AA1bNrRKce21ejJfCHJXz53kzyweOY0tj Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="368569822"
X-IronPort-AV: E=Sophos;i="5.98,300,1673942400"; d="scan'208";a="368569822"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Mar 2023 00:24:59 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="827773094"
X-IronPort-AV: E=Sophos;i="5.98,300,1673942400"; d="scan'208";a="827773094"
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v6 7/8] drm/i915: track gt pm wakerefs

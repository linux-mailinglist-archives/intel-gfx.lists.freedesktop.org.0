...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4233A19BE76
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Apr 2020 11:16:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBFCB6EA20;
	Thu,  2 Apr 2020 09:16:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7B3966EA20
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Apr 2020 09:16:36 +0000 (UTC)
IronPort-SDR: 38Tjxcbvuk8Mrh7zishkACfRcePoVf8NeAvKX+KATGL/l92tft3leY9Zto1EKyb5zNGE8GZcnj
 Ob471uaRkN/A==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2020 02:16:36 -0700
IronPort-SDR: RjaX8uHvbG4Xn9UaNXtsauhsQvmBH0SfJoXftYuJt0zm605p+wkraOt82ery9eU1NOOJD3sgaa
 YkFc5Fi56isw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,335,1580803200"; d="scan'208";a="360139319"
Received: from unknown (HELO intel.com) ([10.223.74.178])
 by fmsmga001.fm.intel.com with ESMTP; 02 Apr 2020 02:16:33 -0700
Date: Thu, 2 Apr 2020 14:36:31 +0530
From: Anshuman Gupta <anshuman.gupta@intel.com>
To: lakshminarayana.vudum@intel.com
Message-ID: <20200402090631.GH11633@intel.com>
...
In-Reply-To: <158575065333.25625.14709776325783740131@emeril.freedesktop.org>
...
On 2020-04-01 at 14:17:33 +0000, Patchwork wrote:
> == Series Details ==
> 
...
Above are new test and valid skip since there is no non-edp panel, could we filter these as valid skip.
...
"(i915_pm_rpm:2380) igt_pm-WARNING: timeout: pm_status expected:suspended, got:active"
Could u please check if there is any known issue, if it is not known issue probably we need to file bug for these.
> 
>   * igt@runner@aborted:
>     - shard-tglb:         NOTRUN -> [FAIL][7]
>    [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_17155/shard-tglb1/igt@runner@aborted.html
Above failure is due to below WARN_ON in kms_vblank@pipe-D-ts-continuation-suspend
<7>[  500.119918] [IGT] kms_vblank: starting subtest pipe-D-ts-continuation-suspend
-------------------------------------------------------------------------------------
<4>[  501.899229] ------------[ cut here ]------------
<4>[  501.899232] i915 raw-wakerefs=1 wakelocks=1 on cleanup
<4>[  501.899280] WARNING: CPU: 7 PID: 2600 at drivers/gpu/drm/i915/intel_runtime_pm.c:602 intel_runtime_pm_driver_release+0x27/0x40 [i915]
Is above WARN_ON a known issue.
Thanks ,
Anshuman Gupta
> 
>   

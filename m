...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C8C24FBE17
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:01:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3502B10F2D2;
	Mon, 11 Apr 2022 14:01:19 +0000 (UTC)
...
Subject: [Intel-gfx] [CI v3 07/12] drm/edid: abstract an EDID block read
 helper

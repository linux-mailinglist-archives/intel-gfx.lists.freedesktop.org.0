...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C0AC3AC6D6
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Jun 2021 11:11:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6F6C6E9A9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 01/17] drm/amd/display: Remove unnecessary

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B3BE14FDFA
	for <lists+intel-gfx@lfdr.de>; Sun,  2 Feb 2020 16:49:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E49C6EADA;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 02/18] drm/i915: Add DP VSC SDP payload data

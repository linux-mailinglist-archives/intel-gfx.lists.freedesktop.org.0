...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[puranjay@kernel.org,intel-gfx-bounces@lists.freedesktop.org];
	FROM_HAS_DN(0.00)[];

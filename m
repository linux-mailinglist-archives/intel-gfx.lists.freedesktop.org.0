...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7948E9C073D
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2024 14:26:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F55710E83F;
	Thu,  7 Nov 2024 13:26:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Y1DoU2YS";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 30A8610E83B;
 Thu,  7 Nov 2024 13:26:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1730985970; x=1762521970;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/oGYqTRoYrw0kJoOL+qCTK39HQpO/vcPi+VprpOcqgs=;
 b=Y1DoU2YSB5A9mTxII+aC4WEqRG8ZFllTt8i2ZQ/yDAvZ6x5GeL64Usqx
 vLfnaIR3S6MHRf65zDLrGVg43HMzxnVZv7GekDp1H8+KYBrbP6C5I8meC
 Jw/TPg28QutspK30+0yLxxDvpeGBsFqj17/XNWlT2k58/qW91+s6V6+Ef
 r4cnE+1Z3OBhcwPE08HBZ88LpiRDl0Sn3wepZbVoAeDKKb9WsED4up2Ic
 7VQmE1lrJyLIyWirrQmyo0pgsqSLgxyue3tnkRbEtAcG8ZDMNZdoyuhtG
 5dJ0xTzkyj+d2vUYh0E757RP4o657lH1+P9BdX7l+UvV5UBgbLf7W3eGD g==;
X-CSE-ConnectionGUID: nnSbcD0oTHmZ4kPxGIGM7A==
X-CSE-MsgGUID: hy/na4vtSdCxA42W7MOpYA==
X-IronPort-AV: E=McAfee;i="6700,10204,11249"; a="34750734"
X-IronPort-AV: E=Sophos;i="6.12,266,1728975600"; d="scan'208";a="34750734"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 05:26:09 -0800
X-CSE-ConnectionGUID: fdS8mftbTPaNiGjJFBjJNg==
X-CSE-MsgGUID: DGMGRFdTQk6YQxPU2W9TUQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,266,1728975600"; d="scan'208";a="89921688"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by orviesa005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 05:26:05 -0800
...
Subject: [PATCH v2 03/10] mtd: intel-dg: implement access functions
Date: Thu,  7 Nov 2024 15:13:49 +0200
Message-ID: <20241107131356.2796969-4-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 955C64A8539
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Feb 2022 14:33:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD50510F7D2;
...
Subject: [Intel-gfx] [PATCH 4/7] drm/selftests: add drm buddy optimistic
 testcase

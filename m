...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E0A5D44266C
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 05:35:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9DD6F6F9EF;
	Tue,  2 Nov 2021 04:35:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C9E206F9EF
 for <intel-gfx@lists.freedesktop.org>; Tue,  2 Nov 2021 04:35:37 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10155"; a="229903171"
X-IronPort-AV: E=Sophos;i="5.87,201,1631602800"; d="scan'208";a="229903171"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Nov 2021 21:35:37 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.87,201,1631602800"; d="scan'208";a="540718809"
Received: from orsmsx601.amr.corp.intel.com ([10.22.229.14])
 by fmsmga008.fm.intel.com with ESMTP; 01 Nov 2021 21:35:37 -0700
Received: from orsmsx611.amr.corp.intel.com (10.22.229.24) by
 ORSMSX601.amr.corp.intel.com (10.22.229.14) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2242.12; Mon, 1 Nov 2021 21:35:36 -0700
Received: from bgsmsx602.gar.corp.intel.com (10.109.78.81) by
 ORSMSX611.amr.corp.intel.com (10.22.229.24) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2242.12; Mon, 1 Nov 2021 21:35:35 -0700
Received: from bgsmsx602.gar.corp.intel.com ([10.109.78.81]) by
 BGSMSX602.gar.corp.intel.com ([10.109.78.81]) with mapi id 15.01.2242.012;
 Tue, 2 Nov 2021 10:05:33 +0530
From: "Kulkarni, Vandita" <vandita.kulkarni@intel.com>
To: "Navare, Manasi D" <manasi.d.navare@intel.com>
Thread-Topic: [PATCH] drm/i915/dsc: Fix the usage of uncompressed bpp
Thread-Index: AQHXyxhl7vfS49AtK0y7RnckKW8NFqvm3saAgADkerCAAn9aAIAEovmggABvowCAAFnDcA==
Date: Tue, 2 Nov 2021 04:35:32 +0000
Message-ID: <e7c3f25dc1374a7383bf554ee7a31cac@intel.com>
...
In-Reply-To: <20211102044041.GA15244@labuser-Z97X-UD5H>
...
> > > panel has a limitation or issues with higher bpcs or a display requir=
ement
...
> >
> > We are having these test cases as part of CI. We hit FIFO underrun in s=
uch
...
.
> > >
> > > So the Bspec says that if the input BPP is (8 * 3) =3D 24, then based
...
> > > the max link rate, lane count can handle, max bits per pixel by small=
 joiner
> RAM calc).
> >
...
> >
>=20
> From IGT we are forcing DSC for all supported input BPCs right, so for bp=
c =3D
> 8, so input bpp =3D 24. So IMO in the kernel code, when we calculate pipe=
_bpp
> when force_dsc is set in that case we should use the bpc requested from I=
GT
> as inpput bpc and not care for max_connector_bpc So then input bpp =3D 24
> and the limits of compressed bpp would be 8 - 23
Right, had thought of this=20
Adding a check on force_dsc_en before doing this
pipe_config->pipe_bpp =3D max_dsc_pipe_bpp;

but since you said that the design was to respect the max_requested_bpc fro=
m the user
should we use max_requested_bpc property in the igt  to say that set the ma=
x to 8bpc
...
>=20
> Ideally now the link rate and lane count should be lowered to use the lea=
st
...
> >
> > This patch is tested and resolves the FIFO underruns, in force dsc case=
s.
> > The problem is only when we are forcing DSC and the link rate can actua=
lly
> support higher bpp.
...
> > > However what you should once double check is for XeLPD (>=3D13)
...
> > > > > > intel_dp_dsc_compute_config(struct
> > > > > intel_dp *intel_dp,
> > > > > >  	 * Optimize this later for the minimum possible link rate/lan=
e
> count

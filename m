...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B938E3A8235
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Jun 2021 16:14:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56D4A6E3C4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 04/14] drm/amd/display: Add handling for new
 "active bpc" property

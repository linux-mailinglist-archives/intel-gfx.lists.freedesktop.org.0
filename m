...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B78521FF0A
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:58:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78EBB6E98A;
	Tue, 14 Jul 2020 20:58:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4F0316E97B;
 Tue, 14 Jul 2020 20:58:23 +0000 (UTC)
IronPort-SDR: BkjwF4IBjyKy6zJR6xhCVBRvhz7CJLbjPFK4z7XEQxNy8+LsGvM+aj/sWTvw7LLcqhraJ2dPmm
 eh/aKWHgas0A==
X-IronPort-AV: E=McAfee;i="6000,8403,9682"; a="233883728"
X-IronPort-AV: E=Sophos;i="5.75,352,1589266800"; d="scan'208";a="233883728"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jul 2020 13:58:23 -0700
IronPort-SDR: 74jiZwx19ubNmj312P6UUPrfTUD98urhqG3pSkEUKxS7QpI8iAWfsxk2aCNfvPF6f0aZIC9YsS
 kuAcJkHaWrCQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,352,1589266800"; d="scan'208";a="316504089"
...
Date: Tue, 14 Jul 2020 13:56:55 -0700
Message-Id: <1594760265-11618-10-git-send-email-anitha.chrisanthus@intel.com>
X-Mailer: git-send-email 2.7.4
In-Reply-To: <1594760265-11618-1-git-send-email-anitha.chrisanthus@intel.com>
References: <1594760265-11618-1-git-send-email-anitha.chrisanthus@intel.com>
Subject: [Intel-gfx] [PATCH v2 09/59] drm/kmb: Part 1 of Mipi Tx
 Initialization
...
@@ -42,6 +42,20 @@ static inline u32 kmb_read(struct kmb_drm_private *lcd, unsigned int reg)
...
@@ -111,6 +183,261 @@ static struct kmb_dsi_host *kmb_dsi_host_init(struct kmb_dsi *kmb_dsi)
 	return host;
 }
...
@@ -118,6 +445,7 @@ void kmb_dsi_init(struct drm_device *dev)
...
+	struct kmb_drm_private *dev_priv = dev->dev_private;
 	...
 	if (!kmb_dsi)
@@ -150,4 +478,6 @@ void kmb_dsi_init(struct drm_device *dev)
...
index 0f5da87..e50cd88 100644
--- a/drivers/gpu/drm/kmb/kmb_dsi.h
+++ b/drivers/gpu/drm/kmb/kmb_dsi.h
@@ -32,6 +32,238 @@ struct kmb_connector {

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 105DA4AE4EA
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 23:50:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CBB0B10E54B;
...
Subject: Re: [Intel-gfx] [PATCH v3 4/4] drm/i915/guc: Verify hwconfig blob

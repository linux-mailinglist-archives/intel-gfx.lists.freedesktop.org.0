...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EA449702920
	for <lists+intel-gfx@lfdr.de>; Mon, 15 May 2023 11:41:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0FCE10E1CA;
...
Subject: [Intel-gfx] [PATCH v2 04/12] drm/gma500: Use regular fbdev I/O
 helpers

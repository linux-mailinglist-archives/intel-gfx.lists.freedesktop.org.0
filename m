...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3ED5B6B04F5
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 11:50:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C3FF10E0D8;
...
Subject: Re: [Intel-gfx] [PATCH 1/7] drm/dp_helper: Add helper to check DSC
 support with given o/p format

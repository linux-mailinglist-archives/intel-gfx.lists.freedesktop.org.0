...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 039F1480C9
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jun 2019 13:34:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9654891C1;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 ftjg==
Subject: [Intel-gfx] [PATCH 4/6] drm/amdgpu: use allowed_domains for
 exported DMA-bufs

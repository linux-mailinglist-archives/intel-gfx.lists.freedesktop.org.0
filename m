...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB49E560B0D
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jun 2022 22:31:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BCEF10E73E;
...
Subject: Re: [Intel-gfx] [PATCH v2 26/27] dyndbg: 4 new trace-events:
 pr_debug, dev_dbg, drm_{, dev}debug

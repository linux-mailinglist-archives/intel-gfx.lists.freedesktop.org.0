...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C5D17BD778
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Oct 2023 11:45:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7155610E259;
	Mon,  9 Oct 2023 09:45:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1ABCF10E259
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Oct 2023 09:45:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1696844727; x=1728380727;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=1/hfVFm/ugHN4AlhbOxgAsaACMmEGvtJdCNhYePs7YE=;
 b=GJRkEsGBGOoNYPhPlaRy/aIEXiEB0td+eJCU+W2oE9rvHxBIXYbwIxZm
 KHqsBkLkGDxhG7MLJX105F/rwXJBSyA9+oy2P5WfiK1HdeLS9WKDCGGg4
 xHd0KwigAufDULb+jaZzHeN0mw6iz2WQX3BETEoJfOatxvKaODBKVojku
 wu6h99oCqtULFO3ZFIoFqu0peRPF+YLF70WuZ+kbQewJOddndTL/Qfv6O
 3IwuGU9lIeeJoqLT/WbvxRoWLmxaifclraRo0PhXiYj11zG+gXmRZkTM7
 JWV5uCSqr/3++9gAuMe7Nqdl0fWTeWAh0SIOie3B9zMkYsvqetJXymAzR g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10857"; a="369170496"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="369170496"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2023 02:45:26 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10857"; a="788102850"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="788102850"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga001.jf.intel.com with ESMTP; 09 Oct 2023 02:45:24 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  9 Oct 2023 15:12:57 +0530
Message-Id: <20231009094254.653551-3-suraj.kandpal@intel.com>
...
MIME-Version: 1.0
Content-Type: text/plain; charset=eUTF-8
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v5 2/2] drm/i915/hdcp: Move common message

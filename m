...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 378933B3EFE
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Jun 2021 10:23:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3AA976ED0E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 20/27] drm/sun4i: Don't set struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9846F4AEA54
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Feb 2022 07:30:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C2CD10E3FE;
...
Subject: [Intel-gfx] [PATCH v7 0/6] Use drm_clflush* instead of clflush

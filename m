...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 533AF5A9747
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 14:48:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7009C10E707;
	Thu,  1 Sep 2022 12:48:32 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 9/9] drm/rockchip: convert to using has_audio
 from display_info

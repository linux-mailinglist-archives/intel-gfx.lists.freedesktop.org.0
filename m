...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB79C434BB4
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Oct 2021 14:59:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B7BE6E9B7;
	Wed, 20 Oct 2021 12:59:19 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 09/13] drm: remove i915 selftest config check

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5AE676C9FBC
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Mar 2023 11:35:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1B6010E36E;
...
Subject: [Intel-gfx] [PATCH v2 00/10] Introduce new methods for verifying

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2507351524F
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Apr 2022 19:32:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DD3110EEBB;
...
Subject: [Intel-gfx] [PATCH v3 1/4] drm/i915/gt: Explicitly clear BB_OFFSET
 for new contexts

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C07603B95BA
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 19:56:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8E1336E0D9;
...
Subject: [Intel-gfx] [PATCH v7 5/5] drm: protect drm_master pointers in
 drm_lease.c

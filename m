...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 135542C526C
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Nov 2020 11:54:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C6EE6E891;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [RFC v2 2/8] drm/i915: Rename pwm_* backlight

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AD4C757EA0
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 15:56:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C37010E36F;
...
Subject: [Intel-gfx] [PATCH v15 26/26] docs: vfio: Add vfio device cdev
 description

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B538E3702EB
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Apr 2021 23:22:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 050736F5E2;
	Fri, 30 Apr 2021 21:22:45 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v1 1/1] drm/dp_mst: Use the correct max source
 link rate for i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 60EA32D7824
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Dec 2020 15:46:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4BB56E0AF;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [RFC 3/5] drm/i915/dp: Remove redundant AUX

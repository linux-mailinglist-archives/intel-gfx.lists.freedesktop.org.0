...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DBE8C5FD539
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Oct 2022 08:50:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 92C8010E1C5;
	Thu, 13 Oct 2022 06:50:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1CE9510E1C5;
 Thu, 13 Oct 2022 06:50:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665643836; x=1697179836;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=2jjLGw05dIVAC2cqGfrFoV+DeaP/BZY+5dyY7RvJm64=;
 b=as4ZDBFVLyx8GIEXhnFFBOuxU0K3sPLLx5XAqzYZhekoeCDw0skZJBTA
 nUeEzNz52GqbhCA6pDn2eIzzPxX/flLi50kvjSu6FwxCssXnQgEXTv4kf
 OITOB2Gsz+yeS/gwXLFrF4cUe0YqfvaKUaOysfTWWI7kJ2gUhh5ajuK9L
 4T9fsuAgWKHvbnZ1xOkp3AlJ2BkmmsIbnwAKpUJzTpSYXsQFuf06ESmwX
 U1uIFiY0xDfjIWohTlKC+UOrQUTbgVQMIbDrep+RbU/DuMUYuarPdc4zT
 BHkrR4Nr0OI8DB0ktVdN0u1n1041eBwhKbuOXV5V/guMkDQdOJhmspP+j g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10498"; a="366995380"
X-IronPort-AV: E=Sophos;i="5.95,180,1661842800"; d="scan'208";a="366995380"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Oct 2022 23:50:35 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10498"; a="769496954"
X-IronPort-AV: E=Sophos;i="5.95,180,1661842800"; d="scan'208";a="769496954"
Received: from mkroczek-mobl1.ger.corp.intel.com (HELO
 paris.ger.corp.intel.com) ([10.249.152.137])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Oct 2022 23:50:27 -0700
From: Gwan-gyeong Mun <gwan-gyeong.mun@intel.com>
To: keescook@chromium.org
Date: Thu, 13 Oct 2022 09:49:56 +0300
Message-Id: <20221013064956.1548741-1-gwan-gyeong.mun@intel.com>
...
Subject: [Intel-gfx] [PATCH v3] overflow: Introduce overflows_type() and
 castable_to_type()
...
Cc: dri-devel@lists.freedesktop.org, arnd@kernel.org, airlied@linux.ie,
 trix@redhat.com, dlatypov@google.com, llvm@lists.linux.dev,
 ndesaulniers@google.com, gustavoars@kernel.org, linux-kernel@vger.kernel.org,

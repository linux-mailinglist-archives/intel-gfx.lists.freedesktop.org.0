...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A37EA14F1AD
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jan 2020 18:53:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A280C6FBC9;
	Fri, 31 Jan 2020 17:53:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BBB156FBC9
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Jan 2020 17:53:26 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga104.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 31 Jan 2020 09:53:26 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,386,1574150400"; d="scan'208";a="233508085"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 31 Jan 2020 09:53:23 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 31 Jan 2020 19:53:23 +0200
Date: Fri, 31 Jan 2020 19:53:23 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Manasi Navare <manasi.d.navare@intel.com>
Message-ID: <20200131175323.GV13686@intel.com>
References: <20200131171547.25938-1-manasi.d.navare@intel.com>
 <20200131171547.25938-3-manasi.d.navare@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20200131171547.25938-3-manasi.d.navare@intel.com>
...
> @@ -13123,8 +13123,7 @@ intel_modeset_pipe_config(struct intel_crtc_state=
 *pipe_config)
...
> @@ -14559,76 +14558,6 @@ static bool intel_cpu_transcoders_need_modeset(s=
...
>   * @dev: drm device
> @@ -14656,21 +14585,6 @@ static int intel_atomic_check(struct drm_device =
*dev,
>  	if (ret)
>  		goto fail;
>  =
...
> @@ -6582,6 +6582,135 @@ void intel_dp_encoder_reset(struct drm_encoder *e=
ncoder)
>  	}
>  }
>  =
...
> @@ -6598,7 +6727,7 @@ static const struct drm_connector_helper_funcs inte=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A109541F4A
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 01:02:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE7DB11204B;
...
Subject: [Intel-gfx] [PATCH v2 0/2] Remove the VFIO_IOMMU_NOTIFY_DMA_UNMAP
 notifier

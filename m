...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 550882FDEBC
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Jan 2021 02:24:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 772C96E4BB;
...
Content-Type: multipart/mixed; boundary="===============1643126857=="

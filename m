...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E218D1E2225
	for <lists+intel-gfx@lfdr.de>; Tue, 26 May 2020 14:42:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C6476E186;
	Tue, 26 May 2020 12:42:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D3E36E186
 for <intel-gfx@lists.freedesktop.org>; Tue, 26 May 2020 12:42:23 +0000 (UTC)
IronPort-SDR: I2xO5zlqww95/QWme1MsBKOaHLPwoL1Lub7yv8skoJNJPq3nOIgjldg0Aw3lrLOz8gSp8yyizY
 8fBzwIFdKqng==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2020 05:42:22 -0700
IronPort-SDR: a2T4Hj9MEKBRXeNV9G/6JqzY10u33kvRaEsU6duhFkjlz2vahAaMUfA+SgtLSa+7eJsGvJheiE
 1nVQYuafQVpg==
X-IronPort-AV: E=Sophos;i="5.73,437,1583222400"; d="scan'208";a="413805418"
Received: from ygershon-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.252.42.149])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2020 05:42:19 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 26 May 2020 15:41:56 +0300
Message-Id: <20200526124156.29319-4-jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20200526124156.29319-1-jani.nikula@intel.com>
References: <20200526124156.29319-1-jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 4/4] drm/i915/params: switch to device specific
 parameters
...

...
c3BsYXkvaW50ZWxfZGlzcGxheS5jCmluZGV4IGY0MGI5MDk5NTJjYy4uNDNiYmU3YzZiNzhjIDEw
...
OSw3ICs0ODc5LDcgQEAgdm9pZCBpbnRlbF9wcmVwYXJlX3Jlc2V0KHN0cnVjdCBkcm1faTkxNV9w
...
CiAKQEAgLTc4NzMsNyArNzg3Myw3IEBAIGJvb2wgaHN3X2NydGNfc3RhdGVfaXBzX2NhcGFibGUo
...
cmV0dXJuIGZhbHNlOwogCiAJaWYgKGNydGNfc3RhdGUtPnBpcGVfYnBwID4gMjQpCkBAIC04MTQ0
LDggKzgxNDQsOCBAQCBzdGF0aWMgdm9pZCBpbnRlbF9wYW5lbF9zYW5pdGl6ZV9zc2Moc3RydWN0
...
VUlSS19MVkRTX1NTQ19ESVNBQkxFKTsKIH0KQEAgLTEzNTc5LDggKzEzNTc5LDggQEAgcGlwZV9j
...
L2Rpc3BsYXkvaW50ZWxfZGlzcGxheV9kZWJ1Z2ZzLmMKaW5kZXggNzA1MjU2MjNiY2RmLi44N2Ri
N2U5MDY2MjEgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxf
...
LmMKaW5kZXggMTc2ODczMTY3OGExLi5mMTAzYzUxYzAxM2YgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMv
Z3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZHAuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkx
NS9kaXNwbGF5L2ludGVsX2RwLmMKQEAgLTQ3NTIsNyArNDc1Miw5IEBAIGludGVsX2RwX3Npbmtf
...
dGVsX2RwKTsKIH0KQEAgLTQ3NjksMTMgKzQ3NzEsMTMgQEAgaW50ZWxfZHBfY29uZmlndXJlX21z
...
YXJ0YmVhdC5jCmluZGV4IDUxMzZjOGJmMTEyZC4uMWVkNGM5NWIyZWE2IDEwMDY0NAotLS0gYS9k
...
ImludGVsX2NvbnRleHQuaCIKQEAgLTExNyw3ICsxMTgsNyBAQCBzdGF0aWMgdm9pZCBoZWFydGJl
...
Y19mdy5jIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvdWMvaW50ZWxfdWNfZncuYwppbmRleCA5
YjYyMTgxMjhkMDkuLjQ3ZTRiNGM4MzdkMyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5
...
eCA5OGYyYzQ0OGNkOTIuLjEyODAyYWU5ZGE2NyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJt
...
LwogCXN0cnVjdCBpbnRlbF9kcml2ZXJfY2FwcyBjYXBzOwpAQCAtMTY3NSw3ICsxNjc4LDcgQEAg
...

...
dXJuOwogCiAJaWYgKGludGVsX3ZncHVfYWN0aXZlKGRldl9wcml2KSkgewpAQCAtODAsNyArODAs
...
IC0xMDAsNyArMTAwLDcgQEAgaW50IGludGVsX2d2dF9pbml0KHN0cnVjdCBkcm1faTkxNV9wcml2
...
cmV0dXJuIDA7CkBAIC0xMjEsNyArMTIxLDcgQEAgaW50IGludGVsX2d2dF9pbml0KHN0cnVjdCBk
...
CmluZGV4IGE2MWNiOGNhNGQ1MC4uZmIwOGIyNGU5MmM4IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dw

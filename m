...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A9152E9F14
	for <lists+intel-gfx@lfdr.de>; Mon,  4 Jan 2021 21:56:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9B8C6E04B;
	Mon,  4 Jan 2021 20:56:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F1CC46E04B
 for <intel-gfx@lists.freedesktop.org>; Mon,  4 Jan 2021 20:56:12 +0000 (UTC)
IronPort-SDR: gj9gpYe/5EhhCQfxZ3slMH+Y6oT/xY5cmG1hFt3JOydpeLhdT4tEYigFkK8lRRynFLx000pJg/
 Hsl2o5ax2dMw==
X-IronPort-AV: E=McAfee;i="6000,8403,9854"; a="177161469"
X-IronPort-AV: E=Sophos;i="5.78,474,1599548400"; d="scan'208";a="177161469"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jan 2021 12:56:12 -0800
IronPort-SDR: YKLmOowWuQx8h2Vs4GxUfA++oJ5pOuDlTA7rYGukKuxGlNo/2YXwTnVHEGyJg7e31DKd+0tFzl
 zqPvAkSa0krg==
X-IronPort-AV: E=Sophos;i="5.78,474,1599548400"; d="scan'208";a="421501158"
...
Message-Id: <20210104205654.238928-2-jose.souza@intel.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <20210104205654.238928-1-jose.souza@intel.com>
References: <20210104205654.238928-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH CI 2/4] drm/i915/display/psr: Use plane damage
...
IDxnd2FuLWd5ZW9uZy5tdW5AaW50ZWwuY29tPgpSZXZpZXdlZC1ieTogR3dhbi1neWVvbmcgTXVu
...
dGF0ZSwgJnBpcGVfY2xpcCwgZnVsbF91cGRhdGUpOwogCXJldHVybiAwOwogfQotLSAKMi4zMC4w

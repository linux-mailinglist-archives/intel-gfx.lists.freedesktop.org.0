...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 514F0614C38
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Nov 2022 15:06:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD59710E3D4;
	Tue,  1 Nov 2022 14:06:31 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v1 4/7] vfio/ccw: move private to mdev
 lifecycle

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C52E35ED859
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Sep 2022 10:59:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D181C10E37F;
	Wed, 28 Sep 2022 08:59:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F30E610E360
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 Sep 2022 08:59:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664355547; x=1695891547;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Ynn5TAJpEL245cJocyfiXJWJE7ojU1moeAVWvhHCItE=;
 b=ivaU2PWUb8IYp/SXvaafgDmXx0VnIIMZ5dRjaza0TI8ObVwR8f3z8T7T
 plsCEoacTOVtd0ypSgWT2iMprEZ3ieUVQ1xvtyojlRJuSaX1D1TiP1cOV
 CdGnyIWDbQgCfz9sOFUEteEAuD/+Y7NoUKMgUA8U9xvlsRDOjmhoFq7w6
 geJQnBP/rKHW36A7YsW+IhOAVtZlRuCjc+xFjYQ31Cud62PrCRJqbo1uG
 o41uoxBXMZfb9C9KMgDBifPK80v9Hla1yYfwk1FuMk/mf0z5SvvVIJg5M
 x23NHmDH0NgoTDY2cYEnGf5LQSWWGbiSKUg4dFZpWZzdKfuLpVJO7VDEj Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10483"; a="303030952"
X-IronPort-AV: E=Sophos;i="5.93,351,1654585200"; d="scan'208";a="303030952"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Sep 2022 01:58:58 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10483"; a="690319969"
X-IronPort-AV: E=Sophos;i="5.93,351,1654585200"; d="scan'208";a="690319969"
...
Message-Id: <20220928085826.243721-2-janusz.krzysztofik@linux.intel.com>
...
Subject: [Intel-gfx] [core-for-CI][PATCH v2 1/2] iommu: Remove iova cpu

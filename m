...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80DFF3CF12A
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 03:13:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1BA726E21D;
...
Subject: Re: [Intel-gfx] [PATCH 16/51] drm/i915/guc: Update GuC debugfs to
 support new GuC

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C10C34D162
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Mar 2021 15:37:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 91B216E417;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 3/8] drm/displayid: add new displayid

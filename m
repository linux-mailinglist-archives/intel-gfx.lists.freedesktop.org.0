...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACA8A86E423
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Mar 2024 16:17:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3547510EE32;
	Fri,  1 Mar 2024 15:17:56 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UcKn7PRm";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2E3CF10EE32
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 Mar 2024 15:17:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709306274; x=1740842274;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=9j5gRP2A0gsVs6cJT0akBvc/K+NuJYyvk9hZBC6Fbqc=;
 b=UcKn7PRmOPjbeFZFOHk/6en2KAtTe86cRJJaR8HbhOzIp7FmyBvo8Ced
 kUAFsILOu1GV8vI/AZXUI2RPTsdCrUUlKwsA4QuikGRxMLR2JkWFvT+Nq
 MKoEGJeNEZY7krKgr7aItSzIC0qm2h4ki/a+9QCRPgtvWMALfBp7VelRZ
 KvkqiWDKlCNo4fj8Fgn4iCoFH2lSQqJEvxpa1vzm+VldleiHbheIeBprU
 2OBtaw+66F8Ja9Tci7wt2LQ8aN2e7kExrBGm14Y+VoftTtmjuSYQ+r6I5
 TwrCG1YJdYwuJKb6gt25wEHU4TO6IL05WYHvLXzVd18j4MxzPJqXTYzND Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11000"; a="14550269"
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="14550269"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 07:17:52 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="39077882"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by orviesa002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 07:17:49 -0800
Date: Fri, 1 Mar 2024 17:17:41 +0200
...
Message-ID: <ZeHxlcUi+oYpvc/b@intel.com>
References: <20240221192010.25413-1-stanislav.lisovskiy@intel.com>
 ...
 <ZeHo3M5WZM3klgwe@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <ZeHo3M5WZM3klgwe@intel.com>

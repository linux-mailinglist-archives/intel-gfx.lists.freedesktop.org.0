...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B5D53C8A2F
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Jul 2021 19:52:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCF3B6E48B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 4/5] drm/print: move conditional deref into
 macro defn

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C484939EE39
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Jun 2021 07:37:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 747F56EAA7;
	Tue,  8 Jun 2021 05:37:53 +0000 (UTC)
...
>
> drivers/gpu/drm/amd/amdgpu/amdgpu_preempt_mgr.c: In function 'amdgpu_pree=
mpt_mgr_new':
> drivers/gpu/drm/amd/amdgpu/amdgpu_preempt_mgr.c:75:5: error: 'struct ttm_=
resource' has no member named 'mm_node'
>    75 |  mem->mm_node =3D NULL;
>       |     ^~
> drivers/gpu/drm/amd/amdgpu/amdgpu_preempt_mgr.c: At top level:
> drivers/gpu/drm/amd/amdgpu/amdgpu_preempt_mgr.c:129:11: error: initializa=
tion of 'int (*)(struct ttm_resource_manager *, struct ttm_buffer_object *,=
 const struct ttm_place *, struct ttm_resource **)' from incompatible point=
er type 'int (*)(struct ttm_resource_manager *, struct ttm_buffer_object *,=
 const struct ttm_place *, struct ttm_resource *)' [-Werror=3Dincompatible-=
pointer-types]
>   129 |  .alloc =3D amdgpu_preempt_mgr_new,
>       |           ^~~~~~~~~~~~~~~~~~~~~~
> drivers/gpu/drm/amd/amdgpu/amdgpu_preempt_mgr.c:129:11: note: (near initi=
alization for 'amdgpu_preempt_mgr_func.alloc')
>
> Caused by commit
>
>   cb1c81467af3 ("drm/ttm: flip the switch for driver allocated resources =
v2")
>
...
u/drm/amd/amdgpu/amdgpu_preempt_mgr.c

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F039C885F0
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 00:27:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A0D296EF17;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 22/37] drm/i915: define HAS_MAPPABLE_APERTURE

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC3D33FD137
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Sep 2021 04:21:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E96DF6E115;
...
Subject: [Intel-gfx] [PATCH 5/7] Me: Allow relocs on DG1 for CI

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D44E060183E
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Oct 2022 21:57:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F268F10EE18;
...
Subject: Re: [Intel-gfx] [PATCH v5 21/22] drm/vc4: vec: Add support for more
 analog TV standards

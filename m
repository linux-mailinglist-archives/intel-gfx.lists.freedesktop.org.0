...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 64A0DBC7E1E
	for <lists+intel-gfx@lfdr.de>; Thu, 09 Oct 2025 10:03:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E653B10E96D;
	Thu,  9 Oct 2025 08:02:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 6aec98b87f92 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD7AE10E96D;
 Thu,  9 Oct 2025 08:02:58 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============0668426631174032275=="
MIME-Version: 1.0
...
Date: Thu, 09 Oct 2025 08:02:58 -0000
Message-ID: <175999697874.21440.3520313004963716096@6aec98b87f92>
...
#### Suppressed ####
  ...
  * {igt@kms_frontbuffer_tracking@fbc-1p-offscreen-pri-indfb-draw-mmap-wc}:
   ...
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_frontbuffer_tracking@fbc-1p-offscreen-pri-indfb-draw-mmap-wc.html

  * {igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-shrfb-draw-mmap-wc}:
    - shard-dg2:          NOTRUN -> [SKIP][6]
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-shrfb-draw-mmap-wc.html
...
#### Issues hit ####
  ...
  * igt@device_reset@unbind-cold-reset-rebind:
   ...
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@device_reset@unbind-cold-reset-rebind.html

  * igt@fbdev@info:
    - shard-rkl:          NOTRUN -> [SKIP][8] ([i915#14544] / [i915#1849] / [i915#2582])
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@fbdev@info.html

  * igt@fbdev@nullptr:
    - shard-rkl:          [PASS][9] -> [SKIP][10] ([i915#14544] / [i915#2582])
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@fbdev@nullptr.html
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@fbdev@nullptr.html

  * igt@gem_ccs@block-multicopy-compressed:
    - shard-tglu-1:       NOTRUN -> [SKIP][11] ([i915#9323])
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@gem_ccs@block-multicopy-compressed.html

  * igt@gem_ccs@large-ctrl-surf-copy:
    - shard-rkl:          NOTRUN -> [SKIP][12] ([i915#13008] / [i915#14544])
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_ccs@large-ctrl-surf-copy.html

  * igt@gem_create@create-ext-cpu-access-big:
    - shard-tglu:         NOTRUN -> [SKIP][13] ([i915#6335])
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@gem_create@create-ext-cpu-access-big.html

  * igt@gem_ctx_persistence@heartbeat-hang:
    - shard-dg2:          NOTRUN -> [SKIP][14] ([i915#8555])
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@gem_ctx_persistence@heartbeat-hang.html

  * igt@gem_ctx_sseu@invalid-args:
    - shard-tglu-1:       NOTRUN -> [SKIP][15] ([i915#280])
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@gem_ctx_sseu@invalid-args.html

  * igt@gem_ctx_sseu@invalid-sseu:
    - shard-dg2:          NOTRUN -> [SKIP][16] ([i915#280])
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@gem_ctx_sseu@invalid-sseu.html

  * igt@gem_eio@reset-stress:
    - shard-dg1:          [PASS][17] -> [FAIL][18] ([i915#5784])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-13/igt@gem_eio@reset-stress.html
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-16/igt@gem_eio@reset-stress.html

  * igt@gem_exec_balancer@parallel-keep-submit-fence:
    - shard-tglu-1:       NOTRUN -> [SKIP][19] ([i915#4525]) +1 other test skip
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@gem_exec_balancer@parallel-keep-submit-fence.html

  * igt@gem_exec_big@single:
    - shard-tglu:         NOTRUN -> [ABORT][20] ([i915#11713] / [i915#14756])
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@gem_exec_big@single.html

  * igt@gem_exec_capture@capture-invisible:
    - shard-glk10:        NOTRUN -> [SKIP][21] ([i915#6334]) +1 other test skip
   [21]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk10/igt@gem_exec_capture@capture-invisible.html

  * igt@gem_exec_flush@basic-wb-ro-default:
    - shard-dg2-9:        NOTRUN -> [SKIP][22] ([i915#3539] / [i915#4852])
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_exec_flush@basic-wb-ro-default.html

  * igt@gem_exec_reloc@basic-wc:
    - shard-dg2:          NOTRUN -> [SKIP][23] ([i915#3281]) +9 other tests skip
   [23]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@gem_exec_reloc@basic-wc.html

  * igt@gem_exec_reloc@basic-wc-gtt-noreloc:
    - shard-dg2-9:        NOTRUN -> [SKIP][24] ([i915#3281]) +1 other test skip
   [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_exec_reloc@basic-wc-gtt-noreloc.html

  * igt@gem_exec_suspend@basic-s0@smem:
    - shard-dg2-9:        NOTRUN -> [INCOMPLETE][25] ([i915#13356]) +1 other test incomplete
   [25]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_exec_suspend@basic-s0@smem.html

  * igt@gem_fenced_exec_thrash@2-spare-fences:
    - shard-dg2:          NOTRUN -> [SKIP][26] ([i915#4860]) +1 other test skip
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@gem_fenced_exec_thrash@2-spare-fences.html

  * igt@gem_lmem_swapping@smem-oom:
    - shard-tglu:         NOTRUN -> [SKIP][27] ([i915#4613]) +1 other test skip
   [27]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@gem_lmem_swapping@smem-oom.html

  * igt@gem_lmem_swapping@verify:
    - shard-glk:          NOTRUN -> [SKIP][28] ([i915#4613]) +2 other tests skip
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk6/igt@gem_lmem_swapping@verify.html

  * igt@gem_lmem_swapping@verify-ccs:
    - shard-tglu-1:       NOTRUN -> [SKIP][29] ([i915#4613]) +2 other tests skip
   [29]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@gem_lmem_swapping@verify-ccs.html

  * igt@gem_media_fill@media-fill:
    - shard-dg2-9:        NOTRUN -> [SKIP][30] ([i915#8289])
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_media_fill@media-fill.html

  * igt@gem_mmap_gtt@pf-nonblock:
    - shard-dg2-9:        NOTRUN -> [SKIP][31] ([i915#4077]) +2 other tests skip
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_mmap_gtt@pf-nonblock.html

  * igt@gem_mmap_wc@set-cache-level:
    - shard-rkl:          NOTRUN -> [SKIP][32] ([i915#14544] / [i915#1850])
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_mmap_wc@set-cache-level.html

  * igt@gem_mmap_wc@write-read-distinct:
    - shard-dg2:          NOTRUN -> [SKIP][33] ([i915#4083]) +1 other test skip
   [33]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@gem_mmap_wc@write-read-distinct.html

  * igt@gem_pread@bench:
    - shard-dg2:          NOTRUN -> [SKIP][34] ([i915#3282]) +2 other tests skip
   [34]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@gem_pread@bench.html

  * igt@gem_pread@self:
    - shard-dg2-9:        NOTRUN -> [SKIP][35] ([i915#3282]) +1 other test skip
   [35]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_pread@self.html

  * igt@gem_pwrite@basic-exhaustion:
    - shard-glk10:        NOTRUN -> [WARN][36] ([i915#14702] / [i915#2658])
   [36]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk10/igt@gem_pwrite@basic-exhaustion.html

  * igt@gem_pxp@create-regular-buffer:
    - shard-rkl:          NOTRUN -> [TIMEOUT][37] ([i915#12917] / [i915#12964])
   [37]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_pxp@create-regular-buffer.html

  * igt@gem_pxp@display-protected-crc:
    - shard-rkl:          [PASS][38] -> [TIMEOUT][39] ([i915#12917] / [i915#12964]) +3 other tests timeout
   [38]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@gem_pxp@display-protected-crc.html
   [39]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-5/igt@gem_pxp@display-protected-crc.html

  * igt@gem_pxp@hw-rejects-pxp-buffer:
    - shard-tglu-1:       NOTRUN -> [SKIP][40] ([i915#13398])
   [40]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@gem_pxp@hw-rejects-pxp-buffer.html

  * igt@gem_pxp@verify-pxp-stale-buf-execution:
    - shard-dg2:          NOTRUN -> [SKIP][41] ([i915#4270])
   [41]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@gem_pxp@verify-pxp-stale-buf-execution.html

  * igt@gem_render_copy@yf-tiled-ccs-to-y-tiled:
    - shard-dg2:          NOTRUN -> [SKIP][42] ([i915#5190] / [i915#8428]) +3 other tests skip
   [42]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@gem_render_copy@yf-tiled-ccs-to-y-tiled.html

  * igt@gem_render_copy@yf-tiled-ccs-to-yf-tiled:
    - shard-dg2-9:        NOTRUN -> [SKIP][43] ([i915#5190] / [i915#8428]) +1 other test skip
   [43]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_render_copy@yf-tiled-ccs-to-yf-tiled.html

  * igt@gem_set_tiling_vs_blt@tiled-to-untiled:
    - shard-dg2-9:        NOTRUN -> [SKIP][44] ([i915#4079])
   [44]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_set_tiling_vs_blt@tiled-to-untiled.html

  * igt@gem_tiled_blits@basic:
    - shard-dg2:          NOTRUN -> [SKIP][45] ([i915#4077]) +2 other tests skip
   [45]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@gem_tiled_blits@basic.html

  * igt@gem_userptr_blits@invalid-mmap-offset-unsync:
    - shard-rkl:          NOTRUN -> [SKIP][46] ([i915#14544] / [i915#3297])
   [46]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_userptr_blits@invalid-mmap-offset-unsync.html

  * igt@gem_userptr_blits@unsync-overlap:
    - shard-dg2-9:        NOTRUN -> [SKIP][47] ([i915#3297])
   [47]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gem_userptr_blits@unsync-overlap.html

  * igt@gem_userptr_blits@unsync-unmap-cycles:
    - shard-tglu-1:       NOTRUN -> [SKIP][48] ([i915#3297]) +1 other test skip
   [48]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@gem_userptr_blits@unsync-unmap-cycles.html

  * igt@gen9_exec_parse@allowed-all:
    - shard-dg2-9:        NOTRUN -> [SKIP][49] ([i915#2856])
   [49]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@gen9_exec_parse@allowed-all.html

  * igt@gen9_exec_parse@batch-without-end:
    - shard-dg2:          NOTRUN -> [SKIP][50] ([i915#2856]) +2 other tests skip
   [50]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@gen9_exec_parse@batch-without-end.html

  * igt@gen9_exec_parse@bb-chained:
    - shard-tglu-1:       NOTRUN -> [SKIP][51] ([i915#2527] / [i915#2856]) +1 other test skip
   [51]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@gen9_exec_parse@bb-chained.html

  * igt@gen9_exec_parse@bb-start-param:
    - shard-tglu:         NOTRUN -> [SKIP][52] ([i915#2527] / [i915#2856])
   [52]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@gen9_exec_parse@bb-start-param.html

  * igt@i915_drm_fdinfo@virtual-busy-idle-all:
    - shard-dg2:          NOTRUN -> [SKIP][53] ([i915#14118])
   [53]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@i915_drm_fdinfo@virtual-busy-idle-all.html

  * igt@i915_module_load@reload-no-display:
    - shard-dg1:          [PASS][54] -> [DMESG-WARN][55] ([i915#13029] / [i915#14545])
   [54]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-18/igt@i915_module_load@reload-no-display.html
   [55]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-18/igt@i915_module_load@reload-no-display.html

  * igt@i915_pm_freq_api@freq-reset:
    - shard-tglu-1:       NOTRUN -> [SKIP][56] ([i915#8399])
   [56]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@i915_pm_freq_api@freq-reset.html

  * igt@i915_pm_rc6_residency@rc6-idle:
    - shard-tglu-1:       NOTRUN -> [SKIP][57] ([i915#14498])
   [57]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@i915_pm_rc6_residency@rc6-idle.html

  * igt@i915_pm_rpm@system-suspend-devices:
    - shard-dg2:          [PASS][58] -> [ABORT][59] ([i915#15060])
   [58]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-4/igt@i915_pm_rpm@system-suspend-devices.html
   [59]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-10/igt@i915_pm_rpm@system-suspend-devices.html

  * igt@i915_pm_rps@min-max-config-loaded:
    - shard-dg2:          NOTRUN -> [SKIP][60] ([i915#11681] / [i915#6621])
   [60]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@i915_pm_rps@min-max-config-loaded.html

  * igt@i915_pm_sseu@full-enable:
    - shard-dg2:          NOTRUN -> [SKIP][61] ([i915#4387])
   [61]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@i915_pm_sseu@full-enable.html

  * igt@i915_power@sanity:
    - shard-mtlp:         [PASS][62] -> [SKIP][63] ([i915#7984])
   [62]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-mtlp-2/igt@i915_power@sanity.html
   [63]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-mtlp-7/igt@i915_power@sanity.html

  * igt@i915_query@test-query-geometry-subslices:
    - shard-tglu-1:       NOTRUN -> [SKIP][64] ([i915#5723])
   [64]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@i915_query@test-query-geometry-subslices.html

  * igt@i915_suspend@basic-s2idle-without-i915:
    - shard-rkl:          [PASS][65] -> [INCOMPLETE][66] ([i915#4817])
   [65]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@i915_suspend@basic-s2idle-without-i915.html
   [66]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-3/igt@i915_suspend@basic-s2idle-without-i915.html

  * igt@i915_suspend@forcewake:
    - shard-glk:          NOTRUN -> [INCOMPLETE][67] ([i915#4817]) +1 other test incomplete
   [67]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk9/igt@i915_suspend@forcewake.html

  * igt@kms_addfb_basic@addfb25-framebuffer-vs-set-tiling:
    - shard-dg2-9:        NOTRUN -> [SKIP][68] ([i915#4212]) +1 other test skip
   [68]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_addfb_basic@addfb25-framebuffer-vs-set-tiling.html

  * igt@kms_atomic@plane-primary-overlay-mutable-zpos:
    - shard-dg2:          NOTRUN -> [SKIP][69] ([i915#9531])
   [69]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_atomic@plane-primary-overlay-mutable-zpos.html
    - shard-tglu:         NOTRUN -> [SKIP][70] ([i915#9531])
   [70]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_atomic@plane-primary-overlay-mutable-zpos.html

  * igt@kms_atomic_transition@plane-use-after-nonblocking-unbind:
    - shard-rkl:          NOTRUN -> [SKIP][71] ([i915#14544]) +11 other tests skip
   [71]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_atomic_transition@plane-use-after-nonblocking-unbind.html

  * igt@kms_big_fb@4-tiled-32bpp-rotate-180:
    - shard-tglu:         NOTRUN -> [SKIP][72] ([i915#5286]) +1 other test skip
   [72]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_big_fb@4-tiled-32bpp-rotate-180.html

  * igt@kms_big_fb@4-tiled-max-hw-stride-32bpp-rotate-0-hflip:
    - shard-tglu-1:       NOTRUN -> [SKIP][73] ([i915#5286]) +3 other tests skip
   [73]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_big_fb@4-tiled-max-hw-stride-32bpp-rotate-0-hflip.html

  * igt@kms_big_fb@x-tiled-8bpp-rotate-0:
    - shard-dg1:          [PASS][74] -> [DMESG-WARN][75] ([i915#4423]) +4 other tests dmesg-warn
   [74]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-12/igt@kms_big_fb@x-tiled-8bpp-rotate-0.html
   [75]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-17/igt@kms_big_fb@x-tiled-8bpp-rotate-0.html

  * igt@kms_big_fb@y-tiled-64bpp-rotate-0:
    - shard-dg2:          NOTRUN -> [SKIP][76] ([i915#4538] / [i915#5190]) +6 other tests skip
   [76]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_big_fb@y-tiled-64bpp-rotate-0.html

  * igt@kms_big_fb@yf-tiled-addfb-size-overflow:
    - shard-dg2:          NOTRUN -> [SKIP][77] ([i915#5190]) +1 other test skip
   [77]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_big_fb@yf-tiled-addfb-size-overflow.html

  * igt@kms_big_fb@yf-tiled-max-hw-stride-64bpp-rotate-180-hflip-async-flip:
    - shard-dg2-9:        NOTRUN -> [SKIP][78] ([i915#4538] / [i915#5190]) +2 other tests skip
   [78]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_big_fb@yf-tiled-max-hw-stride-64bpp-rotate-180-hflip-async-flip.html

  * igt@kms_ccs@bad-aux-stride-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][79] ([i915#10307] / [i915#6095]) +131 other tests skip
   [79]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-6/igt@kms_ccs@bad-aux-stride-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-3.html
  ...
  * igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-d-hdmi-a-2:
   ...
   [80]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-d-hdmi-a-2.html
  ...
  * igt@kms_ccs@crc-primary-basic-y-tiled-gen12-rc-ccs@pipe-d-hdmi-a-1:
   ...
   [81]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-4/igt@kms_ccs@crc-primary-basic-y-tiled-gen12-rc-ccs@pipe-d-hdmi-a-1.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][82] ([i915#14098] / [i915#6095]) +40 other tests skip
   [82]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-5/igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@crc-primary-rotation-180-y-tiled-gen12-rc-ccs:
    - shard-rkl:          [PASS][83] -> [SKIP][84] ([i915#14544]) +42 other tests skip
   [83]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_ccs@crc-primary-rotation-180-y-tiled-gen12-rc-ccs.html
   [84]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_ccs@crc-primary-rotation-180-y-tiled-gen12-rc-ccs.html

  * igt@kms_ccs@crc-primary-suspend-4-tiled-bmg-ccs:
    - shard-tglu-1:       NOTRUN -> [SKIP][85] ([i915#12805])
   [85]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_ccs@crc-primary-suspend-4-tiled-bmg-ccs.html

  * igt@kms_ccs@crc-primary-suspend-y-tiled-gen12-mc-ccs:
    - shard-dg2:          NOTRUN -> [SKIP][86] ([i915#6095]) +12 other tests skip
   [86]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_ccs@crc-primary-suspend-y-tiled-gen12-mc-ccs.html

  * igt@kms_ccs@crc-primary-suspend-y-tiled-gen12-mc-ccs@pipe-d-hdmi-a-1:
    - shard-tglu:         NOTRUN -> [SKIP][87] ([i915#6095]) +34 other tests skip
   [87]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_ccs@crc-primary-suspend-y-tiled-gen12-mc-ccs@pipe-d-hdmi-a-1.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs:
    - shard-tglu:         NOTRUN -> [SKIP][88] ([i915#12313])
   [88]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html
    - shard-dg2:          NOTRUN -> [SKIP][89] ([i915#12313])
   [89]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-4:
    - shard-dg1:          NOTRUN -> [SKIP][90] ([i915#6095]) +139 other tests skip
   [90]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-17/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-4.html

  * igt@kms_ccs@random-ccs-data-4-tiled-dg2-rc-ccs-cc:
    - shard-tglu-1:       NOTRUN -> [SKIP][91] ([i915#6095]) +24 other tests skip
   [91]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_ccs@random-ccs-data-4-tiled-dg2-rc-ccs-cc.html

  * igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][92] ([i915#6095]) +47 other tests skip
   [92]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-1:
    - shard-dg2:          NOTRUN -> [SKIP][93] ([i915#13781]) +3 other tests skip
   [93]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-4/igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-1.html

  * igt@kms_chamelium_color@ctm-max:
    - shard-dg2:          NOTRUN -> [SKIP][94] +10 other tests skip
   [94]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_chamelium_color@ctm-max.html

  * igt@kms_chamelium_frames@dp-frame-dump:
    - shard-dg2:          NOTRUN -> [SKIP][95] ([i915#11151] / [i915#7828]) +6 other tests skip
   [95]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_chamelium_frames@dp-frame-dump.html

  * igt@kms_chamelium_frames@hdmi-cmp-planar-formats:
    - shard-tglu:         NOTRUN -> [SKIP][96] ([i915#11151] / [i915#7828]) +4 other tests skip
   [96]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_chamelium_frames@hdmi-cmp-planar-formats.html

  * igt@kms_chamelium_frames@hdmi-crc-multiple:
    - shard-rkl:          NOTRUN -> [SKIP][97] ([i915#11151] / [i915#14544] / [i915#7828])
   [97]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_chamelium_frames@hdmi-crc-multiple.html

  * igt@kms_chamelium_hpd@hdmi-hpd-with-enabled-mode:
    - shard-tglu-1:       NOTRUN -> [SKIP][98] ([i915#11151] / [i915#7828]) +3 other tests skip
   [98]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_chamelium_hpd@hdmi-hpd-with-enabled-mode.html

  * igt@kms_chamelium_hpd@vga-hpd-fast:
    - shard-dg2-9:        NOTRUN -> [SKIP][99] ([i915#11151] / [i915#7828])
   [99]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_chamelium_hpd@vga-hpd-fast.html

  * igt@kms_color@degamma:
    - shard-rkl:          [PASS][100] -> [SKIP][101] ([i915#12655] / [i915#14544])
   [100]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_color@degamma.html
   [101]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_color@degamma.html

  * igt@kms_color@legacy-gamma:
    - shard-rkl:          NOTRUN -> [SKIP][102] ([i915#12655] / [i915#14544])
   [102]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_color@legacy-gamma.html

  * igt@kms_content_protection@content-type-change:
    - shard-dg2:          NOTRUN -> [SKIP][103] ([i915#9424])
   [103]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_content_protection@content-type-change.html

  * igt@kms_content_protection@dp-mst-lic-type-0:
    - shard-dg2:          NOTRUN -> [SKIP][104] ([i915#3299])
   [104]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_content_protection@dp-mst-lic-type-0.html

  * igt@kms_content_protection@srm@pipe-a-dp-3:
    - shard-dg2:          NOTRUN -> [FAIL][105] ([i915#7173])
   [105]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-10/igt@kms_content_protection@srm@pipe-a-dp-3.html

  * igt@kms_content_protection@uevent:
    - shard-dg2:          NOTRUN -> [SKIP][106] ([i915#7118] / [i915#9424])
   [106]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_content_protection@uevent.html
    - shard-tglu:         NOTRUN -> [SKIP][107] ([i915#6944] / [i915#7116] / [i915#7118] / [i915#9424])
   [107]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_content_protection@uevent.html

  * igt@kms_cursor_crc@cursor-onscreen-256x85:
    - shard-tglu:         [PASS][108] -> [FAIL][109] ([i915#13566]) +3 other tests fail
   [108]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-tglu-5/igt@kms_cursor_crc@cursor-onscreen-256x85.html
   [109]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-10/igt@kms_cursor_crc@cursor-onscreen-256x85.html

  * igt@kms_cursor_crc@cursor-onscreen-32x32:
    - shard-tglu-1:       NOTRUN -> [SKIP][110] ([i915#3555]) +1 other test skip
   [110]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_cursor_crc@cursor-onscreen-32x32.html

  * igt@kms_cursor_crc@cursor-sliding-128x42@pipe-a-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [FAIL][111] ([i915#13566]) +1 other test fail
   [111]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-7/igt@kms_cursor_crc@cursor-sliding-128x42@pipe-a-hdmi-a-1.html

  * igt@kms_cursor_crc@cursor-sliding-32x10:
    - shard-tglu:         NOTRUN -> [SKIP][112] ([i915#3555]) +1 other test skip
   [112]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_cursor_crc@cursor-sliding-32x10.html

  * igt@kms_cursor_crc@cursor-sliding-max-size:
    - shard-dg2:          NOTRUN -> [SKIP][113] ([i915#3555]) +3 other tests skip
   [113]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_cursor_crc@cursor-sliding-max-size.html

  * igt@kms_cursor_edge_walk@64x64-top-bottom@pipe-b-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [DMESG-WARN][114] ([i915#12964])
   [114]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-4/igt@kms_cursor_edge_walk@64x64-top-bottom@pipe-b-hdmi-a-1.html

  * igt@kms_cursor_legacy@basic-flip-after-cursor-atomic:
    - shard-rkl:          [PASS][115] -> [SKIP][116] ([i915#11190] / [i915#14544])
   [115]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_cursor_legacy@basic-flip-after-cursor-atomic.html
   [116]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_cursor_legacy@basic-flip-after-cursor-atomic.html

  * igt@kms_cursor_legacy@cursorb-vs-flipb-atomic:
    - shard-dg2:          NOTRUN -> [SKIP][117] ([i915#13046] / [i915#5354]) +1 other test skip
   [117]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_cursor_legacy@cursorb-vs-flipb-atomic.html

  * igt@kms_cursor_legacy@cursorb-vs-flipb-atomic-transitions-varying-size:
    - shard-dg2-9:        NOTRUN -> [SKIP][118] ([i915#13046] / [i915#5354])
   [118]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_cursor_legacy@cursorb-vs-flipb-atomic-transitions-varying-size.html

  * igt@kms_cursor_legacy@modeset-atomic-cursor-hotspot:
    - shard-tglu-1:       NOTRUN -> [SKIP][119] ([i915#9067])
   [119]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_cursor_legacy@modeset-atomic-cursor-hotspot.html

  * igt@kms_cursor_legacy@short-busy-flip-before-cursor-atomic-transitions:
    - shard-dg2:          NOTRUN -> [SKIP][120] ([i915#4103] / [i915#4213])
   [120]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_cursor_legacy@short-busy-flip-before-cursor-atomic-transitions.html

  * igt@kms_dp_link_training@uhbr-sst:
    - shard-tglu-1:       NOTRUN -> [SKIP][121] ([i915#13748])
   [121]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_dp_link_training@uhbr-sst.html

  * igt@kms_dp_linktrain_fallback@dp-fallback:
    - shard-tglu-1:       NOTRUN -> [SKIP][122] ([i915#13707])
   [122]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_dp_linktrain_fallback@dp-fallback.html

  * igt@kms_draw_crc@draw-method-mmap-wc:
    - shard-dg2:          NOTRUN -> [SKIP][123] ([i915#8812])
   [123]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_draw_crc@draw-method-mmap-wc.html

  * igt@kms_dsc@dsc-basic:
    - shard-dg2:          NOTRUN -> [SKIP][124] ([i915#3555] / [i915#3840]) +1 other test skip
   [124]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_dsc@dsc-basic.html

  * igt@kms_dsc@dsc-with-bpc-formats:
    - shard-tglu:         NOTRUN -> [SKIP][125] ([i915#3555] / [i915#3840]) +1 other test skip
   [125]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_dsc@dsc-with-bpc-formats.html

  * igt@kms_fbcon_fbt@fbc:
    - shard-rkl:          [PASS][126] -> [SKIP][127] ([i915#14544] / [i915#14561])
   [126]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_fbcon_fbt@fbc.html
   [127]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_fbcon_fbt@fbc.html

  * igt@kms_feature_discovery@display-4x:
    - shard-dg2-9:        NOTRUN -> [SKIP][128] ([i915#1839])
   [128]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_feature_discovery@display-4x.html

  * igt@kms_feature_discovery@psr1:
    - shard-tglu:         NOTRUN -> [SKIP][129] ([i915#658])
   [129]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_feature_discovery@psr1.html

  * igt@kms_flip@2x-flip-vs-fences:
    - shard-dg2:          NOTRUN -> [SKIP][130] ([i915#8381])
   [130]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_flip@2x-flip-vs-fences.html

  * igt@kms_flip@2x-flip-vs-modeset:
    - shard-dg2:          NOTRUN -> [SKIP][131] ([i915#9934]) +4 other tests skip
   [131]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_flip@2x-flip-vs-modeset.html

  * igt@kms_flip@2x-flip-vs-panning-vs-hang:
    - shard-tglu:         NOTRUN -> [SKIP][132] ([i915#3637] / [i915#9934]) +3 other tests skip
   [132]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_flip@2x-flip-vs-panning-vs-hang.html

  * igt@kms_flip@2x-flip-vs-suspend-interruptible:
    - shard-snb:          [PASS][133] -> [TIMEOUT][134] ([i915#14033] / [i915#14350])
   [133]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-snb1/igt@kms_flip@2x-flip-vs-suspend-interruptible.html
   [134]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-snb5/igt@kms_flip@2x-flip-vs-suspend-interruptible.html

  * igt@kms_flip@2x-flip-vs-suspend-interruptible@ab-vga1-hdmi-a1:
    - shard-snb:          [PASS][135] -> [TIMEOUT][136] ([i915#14033])
   [135]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-snb1/igt@kms_flip@2x-flip-vs-suspend-interruptible@ab-vga1-hdmi-a1.html
   [136]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-snb5/igt@kms_flip@2x-flip-vs-suspend-interruptible@ab-vga1-hdmi-a1.html

  * igt@kms_flip@2x-modeset-vs-vblank-race:
    - shard-rkl:          NOTRUN -> [SKIP][137] ([i915#14544] / [i915#9934]) +3 other tests skip
   [137]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_flip@2x-modeset-vs-vblank-race.html

  * igt@kms_flip@2x-plain-flip-fb-recreate:
    - shard-glk:          [PASS][138] -> [SKIP][139] +1 other test skip
   [138]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-glk6/igt@kms_flip@2x-plain-flip-fb-recreate.html
   [139]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk8/igt@kms_flip@2x-plain-flip-fb-recreate.html

  * igt@kms_flip@2x-single-buffer-flip-vs-dpms-off-vs-modeset-interruptible:
    - shard-tglu-1:       NOTRUN -> [SKIP][140] ([i915#3637] / [i915#9934]) +2 other tests skip
   [140]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_flip@2x-single-buffer-flip-vs-dpms-off-vs-modeset-interruptible.html

  * igt@kms_flip@bo-too-big-interruptible:
    - shard-rkl:          [PASS][141] -> [SKIP][142] ([i915#14544] / [i915#3637]) +6 other tests skip
   [141]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_flip@bo-too-big-interruptible.html
   [142]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_flip@bo-too-big-interruptible.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling:
    - shard-dg2-9:        NOTRUN -> [SKIP][143] ([i915#2672] / [i915#3555])
   [143]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling@pipe-a-valid-mode:
    - shard-dg2-9:        NOTRUN -> [SKIP][144] ([i915#2672])
   [144]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-upscaling@pipe-a-valid-mode:
    - shard-rkl:          NOTRUN -> [SKIP][145] ([i915#2672]) +1 other test skip
   [145]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-upscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftileccs-to-64bpp-yftile-downscaling:
    - shard-dg2:          NOTRUN -> [SKIP][146] ([i915#2672] / [i915#3555]) +2 other tests skip
   [146]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_flip_scaled_crc@flip-32bpp-yftileccs-to-64bpp-yftile-downscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftileccs-to-64bpp-yftile-downscaling@pipe-a-valid-mode:
    - shard-dg2:          NOTRUN -> [SKIP][147] ([i915#2672]) +2 other tests skip
   [147]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_flip_scaled_crc@flip-32bpp-yftileccs-to-64bpp-yftile-downscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-32bpp-ytileccs-to-64bpp-ytile-downscaling:
    - shard-dg2:          NOTRUN -> [SKIP][148] ([i915#2672] / [i915#3555] / [i915#5190]) +1 other test skip
   [148]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_flip_scaled_crc@flip-32bpp-ytileccs-to-64bpp-ytile-downscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-downscaling:
    - shard-tglu-1:       NOTRUN -> [SKIP][149] ([i915#2672] / [i915#3555])
   [149]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-downscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-downscaling@pipe-a-valid-mode:
    - shard-tglu-1:       NOTRUN -> [SKIP][150] ([i915#2587] / [i915#2672])
   [150]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-downscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling:
    - shard-tglu:         NOTRUN -> [SKIP][151] ([i915#2672] / [i915#3555]) +1 other test skip
   [151]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling@pipe-a-valid-mode:
    - shard-tglu:         NOTRUN -> [SKIP][152] ([i915#2587] / [i915#2672]) +1 other test skip
   [152]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling@pipe-a-valid-mode.html

  * igt@kms_flip_scaled_crc@flip-64bpp-linear-to-16bpp-linear-upscaling:
    - shard-rkl:          [PASS][153] -> [SKIP][154] ([i915#14544] / [i915#3555]) +1 other test skip
   [153]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@kms_flip_scaled_crc@flip-64bpp-linear-to-16bpp-linear-upscaling.html
   [154]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_flip_scaled_crc@flip-64bpp-linear-to-16bpp-linear-upscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-ytile-to-16bpp-ytile-upscaling:
    - shard-rkl:          NOTRUN -> [SKIP][155] ([i915#14544] / [i915#3555])
   [155]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_flip_scaled_crc@flip-64bpp-ytile-to-16bpp-ytile-upscaling.html

  * igt@kms_frontbuffer_tracking@fbc-1p-primscrn-pri-shrfb-draw-mmap-wc:
    - shard-rkl:          [PASS][156] -> [SKIP][157] ([i915#14544] / [i915#1849] / [i915#5354]) +6 other tests skip
   [156]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_frontbuffer_tracking@fbc-1p-primscrn-pri-shrfb-draw-mmap-wc.html
   [157]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-1p-primscrn-pri-shrfb-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbc-1p-primscrn-spr-indfb-draw-mmap-gtt:
    - shard-rkl:          NOTRUN -> [SKIP][158] ([i915#14544] / [i915#1849] / [i915#5354]) +11 other tests skip
   [158]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-1p-primscrn-spr-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-2p-pri-indfb-multidraw:
    - shard-dg2:          NOTRUN -> [SKIP][159] ([i915#5354]) +22 other tests skip
   [159]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_frontbuffer_tracking@fbc-2p-pri-indfb-multidraw.html

  * igt@kms_frontbuffer_tracking@fbc-2p-primscrn-cur-indfb-draw-mmap-wc:
    - shard-dg2:          NOTRUN -> [SKIP][160] ([i915#8708]) +12 other tests skip
   [160]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_frontbuffer_tracking@fbc-2p-primscrn-cur-indfb-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-blt:
    - shard-glk:          NOTRUN -> [SKIP][161] +179 other tests skip
   [161]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk8/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-indfb-pgflip-blt:
    - shard-tglu:         NOTRUN -> [SKIP][162] +37 other tests skip
   [162]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-indfb-pgflip-blt.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-draw-mmap-gtt:
    - shard-dg2-9:        NOTRUN -> [SKIP][163] ([i915#8708]) +4 other tests skip
   [163]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-move:
    - shard-dg2:          NOTRUN -> [SKIP][164] ([i915#3458]) +8 other tests skip
   [164]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-move.html

  * igt@kms_frontbuffer_tracking@psr-rgb565-draw-mmap-wc:
    - shard-tglu-1:       NOTRUN -> [SKIP][165] +42 other tests skip
   [165]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_frontbuffer_tracking@psr-rgb565-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@psr-shrfb-scaledprimary:
    - shard-dg2-9:        NOTRUN -> [SKIP][166] ([i915#3458]) +2 other tests skip
   [166]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_frontbuffer_tracking@psr-shrfb-scaledprimary.html

  * igt@kms_hdr@bpc-switch:
    - shard-dg2:          [PASS][167] -> [SKIP][168] ([i915#3555] / [i915#8228])
   [167]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-10/igt@kms_hdr@bpc-switch.html
   [168]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_hdr@bpc-switch.html
    - shard-tglu:         NOTRUN -> [SKIP][169] ([i915#3555] / [i915#8228])
   [169]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_hdr@bpc-switch.html

  * igt@kms_hdr@invalid-hdr:
    - shard-dg2:          NOTRUN -> [SKIP][170] ([i915#3555] / [i915#8228])
   [170]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_hdr@invalid-hdr.html

  * igt@kms_invalid_mode@bad-vsync-end:
    - shard-rkl:          [PASS][171] -> [SKIP][172] ([i915#14544] / [i915#3555] / [i915#8826])
   [171]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_invalid_mode@bad-vsync-end.html
   [172]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_invalid_mode@bad-vsync-end.html

  * igt@kms_joiner@basic-big-joiner:
    - shard-tglu-1:       NOTRUN -> [SKIP][173] ([i915#10656])
   [173]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_joiner@basic-big-joiner.html

  * igt@kms_joiner@basic-force-big-joiner:
    - shard-rkl:          NOTRUN -> [SKIP][174] ([i915#12388] / [i915#14544])
   [174]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_joiner@basic-force-big-joiner.html

  * igt@kms_joiner@basic-force-ultra-joiner:
    - shard-dg2:          NOTRUN -> [SKIP][175] ([i915#10656])
   [175]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_joiner@basic-force-ultra-joiner.html

  * igt@kms_joiner@invalid-modeset-force-ultra-joiner:
    - shard-tglu-1:       NOTRUN -> [SKIP][176] ([i915#12394])
   [176]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_joiner@invalid-modeset-force-ultra-joiner.html

  * igt@kms_pipe_crc_basic@compare-crc-sanitycheck-xr24:
    - shard-rkl:          NOTRUN -> [SKIP][177] ([i915#11190] / [i915#14544])
   [177]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_pipe_crc_basic@compare-crc-sanitycheck-xr24.html

  * igt@kms_pipe_crc_basic@read-crc-frame-sequence:
    - shard-glk10:        NOTRUN -> [SKIP][178] ([i915#11190]) +1 other test skip
   [178]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk10/igt@kms_pipe_crc_basic@read-crc-frame-sequence.html

  * igt@kms_pipe_crc_basic@suspend-read-crc@pipe-a-hdmi-a-1:
    - shard-glk:          NOTRUN -> [INCOMPLETE][179] ([i915#12756] / [i915#13409] / [i915#13476]) +1 other test incomplete
   [179]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk3/igt@kms_pipe_crc_basic@suspend-read-crc@pipe-a-hdmi-a-1.html

  * igt@kms_plane_alpha_blend@coverage-7efc:
    - shard-rkl:          [PASS][180] -> [SKIP][181] ([i915#14544] / [i915#7294])
   [180]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@kms_plane_alpha_blend@coverage-7efc.html
   [181]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_alpha_blend@coverage-7efc.html

  * igt@kms_plane_multiple@2x-tiling-4:
    - shard-dg2-9:        NOTRUN -> [SKIP][182] ([i915#13958])
   [182]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_plane_multiple@2x-tiling-4.html

  * igt@kms_plane_multiple@tiling-y:
    - shard-dg2:          NOTRUN -> [SKIP][183] ([i915#14259])
   [183]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_plane_multiple@tiling-y.html

  * igt@kms_plane_scaling@plane-downscale-factor-0-5-with-modifiers@pipe-c:
    - shard-glk10:        NOTRUN -> [SKIP][184] +222 other tests skip
   [184]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk10/igt@kms_plane_scaling@plane-downscale-factor-0-5-with-modifiers@pipe-c.html

  * igt@kms_plane_scaling@plane-downscale-factor-0-75-with-modifiers:
    - shard-rkl:          [PASS][185] -> [SKIP][186] ([i915#14544] / [i915#8152]) +1 other test skip
   [185]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_plane_scaling@plane-downscale-factor-0-75-with-modifiers.html
   [186]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-downscale-factor-0-75-with-modifiers.html

  * igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-pixel-formats:
    - shard-rkl:          [PASS][187] -> [SKIP][188] ([i915#14544] / [i915#3555] / [i915#8152])
   [187]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-pixel-formats.html
   [188]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-pixel-formats.html

  * igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-pixel-formats@pipe-b:
    - shard-rkl:          [PASS][189] -> [SKIP][190] ([i915#12247] / [i915#14544] / [i915#8152]) +3 other tests skip
   [189]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-pixel-formats@pipe-b.html
   [190]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-pixel-formats@pipe-b.html

  * igt@kms_plane_scaling@plane-upscale-20x20-with-modifiers:
    - shard-rkl:          NOTRUN -> [SKIP][191] ([i915#14544] / [i915#8152])
   [191]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-upscale-20x20-with-modifiers.html

  * igt@kms_plane_scaling@plane-upscale-20x20-with-modifiers@pipe-a:
    - shard-rkl:          NOTRUN -> [SKIP][192] ([i915#12247] / [i915#14544]) +1 other test skip
   [192]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-upscale-20x20-with-modifiers@pipe-a.html

  * igt@kms_plane_scaling@plane-upscale-20x20-with-rotation@pipe-c:
    - shard-tglu:         NOTRUN -> [SKIP][193] ([i915#12247]) +4 other tests skip
   [193]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_plane_scaling@plane-upscale-20x20-with-rotation@pipe-c.html

  * igt@kms_plane_scaling@planes-downscale-factor-0-5-upscale-20x20:
    - shard-rkl:          NOTRUN -> [SKIP][194] ([i915#12247] / [i915#14544] / [i915#8152]) +2 other tests skip
   [194]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@planes-downscale-factor-0-5-upscale-20x20.html

  * igt@kms_plane_scaling@planes-upscale-factor-0-25-downscale-factor-0-5:
    - shard-rkl:          [PASS][195] -> [SKIP][196] ([i915#12247] / [i915#14544] / [i915#6953] / [i915#8152])
   [195]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_plane_scaling@planes-upscale-factor-0-25-downscale-factor-0-5.html
   [196]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@planes-upscale-factor-0-25-downscale-factor-0-5.html

  * igt@kms_plane_scaling@planes-upscale-factor-0-25-downscale-factor-0-5@pipe-a:
    - shard-rkl:          [PASS][197] -> [SKIP][198] ([i915#12247] / [i915#14544]) +3 other tests skip
   [197]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_plane_scaling@planes-upscale-factor-0-25-downscale-factor-0-5@pipe-a.html
   [198]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@planes-upscale-factor-0-25-downscale-factor-0-5@pipe-a.html

  * igt@kms_pm_backlight@bad-brightness:
    - shard-dg2-9:        NOTRUN -> [SKIP][199] ([i915#5354]) +5 other tests skip
   [199]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_pm_backlight@bad-brightness.html

  * igt@kms_pm_backlight@fade-with-dpms:
    - shard-tglu-1:       NOTRUN -> [SKIP][200] ([i915#9812])
   [200]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_pm_backlight@fade-with-dpms.html

  * igt@kms_pm_dc@dc5-psr:
    - shard-rkl:          NOTRUN -> [SKIP][201] ([i915#14544] / [i915#9685])
   [201]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_pm_dc@dc5-psr.html

  * igt@kms_pm_lpsp@kms-lpsp:
    - shard-dg2:          NOTRUN -> [SKIP][202] ([i915#9340])
   [202]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_pm_lpsp@kms-lpsp.html

  * igt@kms_pm_rpm@modeset-lpsp:
    - shard-dg2:          NOTRUN -> [SKIP][203] ([i915#15073])
   [203]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_pm_rpm@modeset-lpsp.html
    - shard-rkl:          [PASS][204] -> [SKIP][205] ([i915#14544] / [i915#15073])
   [204]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_pm_rpm@modeset-lpsp.html
   [205]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_pm_rpm@modeset-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp:
    - shard-rkl:          [PASS][206] -> [SKIP][207] ([i915#15073]) +1 other test skip
   [206]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_pm_rpm@modeset-non-lpsp.html
   [207]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-7/igt@kms_pm_rpm@modeset-non-lpsp.html

  * igt@kms_psr2_sf@fbc-pr-cursor-plane-move-continuous-exceed-fully-sf:
    - shard-dg2:          NOTRUN -> [SKIP][208] ([i915#11520]) +5 other tests skip
   [208]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@kms_psr2_sf@fbc-pr-cursor-plane-move-continuous-exceed-fully-sf.html

  * igt@kms_psr2_sf@fbc-pr-overlay-plane-move-continuous-exceed-sf:
    - shard-glk:          NOTRUN -> [SKIP][209] ([i915#11520]) +5 other tests skip
   [209]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk6/igt@kms_psr2_sf@fbc-pr-overlay-plane-move-continuous-exceed-sf.html

  * igt@kms_psr2_sf@fbc-psr2-cursor-plane-update-sf:
    - shard-glk10:        NOTRUN -> [SKIP][210] ([i915#11520]) +5 other tests skip
   [210]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk10/igt@kms_psr2_sf@fbc-psr2-cursor-plane-update-sf.html

  * igt@kms_psr2_sf@pr-cursor-plane-move-continuous-exceed-sf:
    - shard-rkl:          NOTRUN -> [SKIP][211] ([i915#11520] / [i915#14544])
   [211]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_psr2_sf@pr-cursor-plane-move-continuous-exceed-sf.html

  * igt@kms_psr2_sf@psr2-cursor-plane-move-continuous-exceed-sf:
    - shard-tglu-1:       NOTRUN -> [SKIP][212] ([i915#11520]) +3 other tests skip
   [212]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_psr2_sf@psr2-cursor-plane-move-continuous-exceed-sf.html

  * igt@kms_psr2_sf@psr2-overlay-plane-move-continuous-sf:
    - shard-dg2-9:        NOTRUN -> [SKIP][213] ([i915#11520]) +1 other test skip
   [213]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_psr2_sf@psr2-overlay-plane-move-continuous-sf.html

  * igt@kms_psr2_sf@psr2-overlay-plane-update-sf-dmg-area:
    - shard-tglu:         NOTRUN -> [SKIP][214] ([i915#11520]) +3 other tests skip
   [214]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_psr2_sf@psr2-overlay-plane-update-sf-dmg-area.html

  * igt@kms_psr@fbc-pr-primary-mmap-gtt:
    - shard-dg2-9:        NOTRUN -> [SKIP][215] ([i915#1072] / [i915#9732]) +3 other tests skip
   [215]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_psr@fbc-pr-primary-mmap-gtt.html

  * igt@kms_psr@fbc-pr-suspend:
    - shard-rkl:          NOTRUN -> [SKIP][216] ([i915#1072] / [i915#14544] / [i915#9732]) +1 other test skip
   [216]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_psr@fbc-pr-suspend.html

  * igt@kms_psr@fbc-psr-cursor-plane-onoff:
    - shard-tglu:         NOTRUN -> [SKIP][217] ([i915#9732]) +8 other tests skip
   [217]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_psr@fbc-psr-cursor-plane-onoff.html

  * igt@kms_psr@psr-sprite-mmap-cpu:
    - shard-tglu-1:       NOTRUN -> [SKIP][218] ([i915#9732]) +9 other tests skip
   [218]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_psr@psr-sprite-mmap-cpu.html

  * igt@kms_psr@psr-suspend:
    - shard-dg2:          NOTRUN -> [SKIP][219] ([i915#1072] / [i915#9732]) +16 other tests skip
   [219]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_psr@psr-suspend.html

  * igt@kms_psr_stress_test@flip-primary-invalidate-overlay:
    - shard-dg2:          NOTRUN -> [SKIP][220] ([i915#9685])
   [220]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@kms_psr_stress_test@flip-primary-invalidate-overlay.html

  * igt@kms_rotation_crc@primary-4-tiled-reflect-x-0:
    - shard-tglu:         NOTRUN -> [SKIP][221] ([i915#5289])
   [221]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-7/igt@kms_rotation_crc@primary-4-tiled-reflect-x-0.html

  * igt@kms_rotation_crc@primary-rotation-90:
    - shard-rkl:          [PASS][222] -> [DMESG-WARN][223] ([i915#12964]) +20 other tests dmesg-warn
   [222]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_rotation_crc@primary-rotation-90.html
   [223]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-7/igt@kms_rotation_crc@primary-rotation-90.html
    - shard-dg2:          NOTRUN -> [SKIP][224] ([i915#12755])
   [224]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_rotation_crc@primary-rotation-90.html

  * igt@kms_setmode@invalid-clone-single-crtc-stealing:
    - shard-dg2-9:        NOTRUN -> [SKIP][225] ([i915#3555]) +2 other tests skip
   [225]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_setmode@invalid-clone-single-crtc-stealing.html

  * igt@kms_tiled_display@basic-test-pattern-with-chamelium:
    - shard-tglu-1:       NOTRUN -> [SKIP][226] ([i915#8623])
   [226]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_tiled_display@basic-test-pattern-with-chamelium.html

  * igt@kms_universal_plane@cursor-fb-leak@pipe-d-edp-1:
    - shard-mtlp:         [PASS][227] -> [FAIL][228] ([i915#9196]) +1 other test fail
   [227]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-mtlp-8/igt@kms_universal_plane@cursor-fb-leak@pipe-d-edp-1.html
   [228]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-mtlp-3/igt@kms_universal_plane@cursor-fb-leak@pipe-d-edp-1.html

  * igt@kms_vblank@ts-continuation-dpms-suspend@pipe-a-hdmi-a-2:
    - shard-glk:          NOTRUN -> [INCOMPLETE][229] ([i915#12276]) +1 other test incomplete
   [229]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk1/igt@kms_vblank@ts-continuation-dpms-suspend@pipe-a-hdmi-a-2.html

  * igt@kms_vrr@lobf:
    - shard-tglu-1:       NOTRUN -> [SKIP][230] ([i915#11920])
   [230]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_vrr@lobf.html

  * igt@kms_vrr@max-min:
    - shard-dg2-9:        NOTRUN -> [SKIP][231] ([i915#9906])
   [231]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_vrr@max-min.html

  * igt@kms_writeback@writeback-check-output:
    - shard-glk:          NOTRUN -> [SKIP][232] ([i915#2437])
   [232]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk1/igt@kms_writeback@writeback-check-output.html

  * igt@kms_writeback@writeback-check-output-xrgb2101010:
    - shard-dg2:          NOTRUN -> [SKIP][233] ([i915#2437] / [i915#9412])
   [233]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_writeback@writeback-check-output-xrgb2101010.html

  * igt@kms_writeback@writeback-fb-id:
    - shard-dg2:          NOTRUN -> [SKIP][234] ([i915#2437])
   [234]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_writeback@writeback-fb-id.html

  * igt@kms_writeback@writeback-pixel-formats:
    - shard-tglu-1:       NOTRUN -> [SKIP][235] ([i915#2437] / [i915#9412])
   [235]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-1/igt@kms_writeback@writeback-pixel-formats.html

  * igt@perf_pmu@busy-double-start@vecs1:
    - shard-dg2:          NOTRUN -> [FAIL][236] ([i915#4349]) +4 other tests fail
   [236]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-3/igt@perf_pmu@busy-double-start@vecs1.html

  * igt@perf_pmu@event-wait@rcs0:
    - shard-dg2-9:        NOTRUN -> [SKIP][237] +2 other tests skip
   [237]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@perf_pmu@event-wait@rcs0.html

  * igt@perf_pmu@rc6-suspend:
    - shard-glk:          [PASS][238] -> [INCOMPLETE][239] ([i915#13356])
   [238]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-glk6/igt@perf_pmu@rc6-suspend.html
   [239]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk8/igt@perf_pmu@rc6-suspend.html

  * igt@prime_vgem@basic-fence-flip:
    - shard-dg2:          NOTRUN -> [SKIP][240] ([i915#3708])
   [240]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-1/igt@prime_vgem@basic-fence-flip.html
    - shard-rkl:          [PASS][241] -> [SKIP][242] ([i915#14544] / [i915#3708])
   [241]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@prime_vgem@basic-fence-flip.html
   [242]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@prime_vgem@basic-fence-flip.html

  * igt@prime_vgem@fence-write-hang:
    - shard-rkl:          NOTRUN -> [SKIP][243] ([i915#14544] / [i915#3708])
   [243]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@prime_vgem@fence-write-hang.html

  
#### Possible fixes ####

  * igt@gem_ccs@suspend-resume:
    - shard-dg2:          [INCOMPLETE][244] ([i915#13356]) -> [PASS][245]
   [244]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-5/igt@gem_ccs@suspend-resume.html
   [245]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@gem_ccs@suspend-resume.html

  * igt@gem_ccs@suspend-resume@xmajor-compressed-compfmt0-lmem0-lmem0:
    - shard-dg2:          [INCOMPLETE][246] ([i915#12392] / [i915#13356]) -> [PASS][247]
   [246]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-5/igt@gem_ccs@suspend-resume@xmajor-compressed-compfmt0-lmem0-lmem0.html
   [247]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@gem_ccs@suspend-resume@xmajor-compressed-compfmt0-lmem0-lmem0.html

  * igt@gem_ctx_isolation@preservation-s3:
    - shard-dg1:          [DMESG-WARN][248] ([i915#4423]) -> [PASS][249] +4 other tests pass
   [248]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-14/igt@gem_ctx_isolation@preservation-s3.html
   [249]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-19/igt@gem_ctx_isolation@preservation-s3.html

  * igt@gem_eio@kms:
    - shard-dg1:          [FAIL][250] ([i915#5784]) -> [PASS][251]
   [250]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-14/igt@gem_eio@kms.html
   [251]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-19/igt@gem_eio@kms.html

  * igt@gem_exec_suspend@basic-s3:
    - shard-glk:          [INCOMPLETE][252] ([i915#13196] / [i915#13356]) -> [PASS][253] +1 other test pass
   [252]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-glk8/igt@gem_exec_suspend@basic-s3.html
   [253]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk1/igt@gem_exec_suspend@basic-s3.html

  * igt@gem_exec_whisper@basic-contexts:
    - shard-rkl:          [DMESG-WARN][254] ([i915#12964]) -> [PASS][255] +17 other tests pass
   [254]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_exec_whisper@basic-contexts.html
   [255]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_exec_whisper@basic-contexts.html

  * igt@gem_pxp@create-protected-buffer:
    - shard-rkl:          [TIMEOUT][256] ([i915#12964]) -> [PASS][257] +1 other test pass
   [256]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_pxp@create-protected-buffer.html
   [257]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_pxp@create-protected-buffer.html

  * igt@gem_pxp@verify-pxp-key-change-after-suspend-resume:
    - shard-rkl:          [TIMEOUT][258] ([i915#12917] / [i915#12964]) -> [PASS][259] +2 other tests pass
   [258]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_pxp@verify-pxp-key-change-after-suspend-resume.html
   [259]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_pxp@verify-pxp-key-change-after-suspend-resume.html

  * igt@kms_addfb_basic@bo-too-small:
    - shard-dg1:          [DMESG-WARN][260] ([i915#4391] / [i915#4423]) -> [PASS][261]
   [260]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-18/igt@kms_addfb_basic@bo-too-small.html
   [261]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-14/igt@kms_addfb_basic@bo-too-small.html

  * igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-0-hflip:
    - shard-mtlp:         [FAIL][262] ([i915#5138]) -> [PASS][263] +1 other test pass
   [262]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-mtlp-8/igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-0-hflip.html
   [263]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-mtlp-7/igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-0-hflip.html

  * igt@kms_color@gamma:
    - shard-rkl:          [SKIP][264] ([i915#12655] / [i915#14544]) -> [PASS][265]
   [264]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_color@gamma.html
   [265]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_color@gamma.html

  * igt@kms_cursor_crc@cursor-random-64x21:
    - shard-rkl:          [FAIL][266] ([i915#13566]) -> [PASS][267] +1 other test pass
   [266]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-5/igt@kms_cursor_crc@cursor-random-64x21.html
   [267]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_cursor_crc@cursor-random-64x21.html

  * igt@kms_cursor_legacy@flip-vs-cursor-atomic:
    - shard-rkl:          [FAIL][268] ([i915#2346]) -> [PASS][269]
   [268]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-5/igt@kms_cursor_legacy@flip-vs-cursor-atomic.html
   [269]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_cursor_legacy@flip-vs-cursor-atomic.html

  * igt@kms_feature_discovery@display-1x:
    - shard-rkl:          [SKIP][270] ([i915#14544] / [i915#9738]) -> [PASS][271]
   [270]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_feature_discovery@display-1x.html
   [271]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-4/igt@kms_feature_discovery@display-1x.html

  * igt@kms_flip@2x-flip-vs-expired-vblank-interruptible@ab-hdmi-a1-hdmi-a2:
    - shard-glk:          [FAIL][272] ([i915#13027]) -> [PASS][273] +1 other test pass
   [272]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-glk3/igt@kms_flip@2x-flip-vs-expired-vblank-interruptible@ab-hdmi-a1-hdmi-a2.html
   [273]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk5/igt@kms_flip@2x-flip-vs-expired-vblank-interruptible@ab-hdmi-a1-hdmi-a2.html

  * igt@kms_flip@flip-vs-absolute-wf_vblank:
    - shard-rkl:          [SKIP][274] ([i915#14544] / [i915#3637]) -> [PASS][275] +5 other tests pass
   [274]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_flip@flip-vs-absolute-wf_vblank.html
   [275]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_flip@flip-vs-absolute-wf_vblank.html

  * igt@kms_flip_scaled_crc@flip-32bpp-ytile-to-64bpp-ytile-upscaling:
    - shard-rkl:          [SKIP][276] ([i915#14544] / [i915#3555]) -> [PASS][277] +6 other tests pass
   [276]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-ytile-to-64bpp-ytile-upscaling.html
   [277]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_flip_scaled_crc@flip-32bpp-ytile-to-64bpp-ytile-upscaling.html

  * igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-indfb-pgflip-blt:
    - shard-glk:          [SKIP][278] -> [PASS][279]
   [278]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-glk8/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-indfb-pgflip-blt.html
   [279]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk1/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-indfb-pgflip-blt.html

  * igt@kms_frontbuffer_tracking@fbc-rgb565-draw-render:
    - shard-rkl:          [SKIP][280] ([i915#14544] / [i915#1849] / [i915#5354]) -> [PASS][281] +4 other tests pass
   [280]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-rgb565-draw-render.html
   [281]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_frontbuffer_tracking@fbc-rgb565-draw-render.html

  * igt@kms_hdr@static-swap:
    - shard-dg2:          [SKIP][282] ([i915#3555] / [i915#8228]) -> [PASS][283] +1 other test pass
   [282]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-4/igt@kms_hdr@static-swap.html
   [283]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-10/igt@kms_hdr@static-swap.html

  * igt@kms_invalid_mode@bad-hsync-end:
    - shard-rkl:          [SKIP][284] ([i915#14544] / [i915#3555] / [i915#8826]) -> [PASS][285]
   [284]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_invalid_mode@bad-hsync-end.html
   [285]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_invalid_mode@bad-hsync-end.html

  * igt@kms_pipe_crc_basic@nonblocking-crc-frame-sequence:
    - shard-rkl:          [SKIP][286] ([i915#11190] / [i915#14544]) -> [PASS][287]
   [286]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_pipe_crc_basic@nonblocking-crc-frame-sequence.html
   [287]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_pipe_crc_basic@nonblocking-crc-frame-sequence.html

  * {igt@kms_pipe_stress@stress-xrgb8888-xtiled}:
    - shard-rkl:          [SKIP][288] ([i915#14544]) -> [PASS][289] +48 other tests pass
   [288]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_pipe_stress@stress-xrgb8888-xtiled.html
   [289]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_pipe_stress@stress-xrgb8888-xtiled.html

  * igt@kms_plane@plane-panning-bottom-right-suspend:
    - shard-rkl:          [SKIP][290] ([i915#14544] / [i915#8825]) -> [PASS][291]
   [290]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_plane@plane-panning-bottom-right-suspend.html
   [291]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_plane@plane-panning-bottom-right-suspend.html

  * igt@kms_plane_alpha_blend@constant-alpha-min:
    - shard-rkl:          [SKIP][292] ([i915#14544] / [i915#7294]) -> [PASS][293]
   [292]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_plane_alpha_blend@constant-alpha-min.html
   [293]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_plane_alpha_blend@constant-alpha-min.html

  * igt@kms_plane_scaling@invalid-parameters:
    - shard-rkl:          [SKIP][294] ([i915#14544] / [i915#8152]) -> [PASS][295] +1 other test pass
   [294]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_plane_scaling@invalid-parameters.html
   [295]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-4/igt@kms_plane_scaling@invalid-parameters.html

  * igt@kms_plane_scaling@planes-scaler-unity-scaling:
    - shard-rkl:          [SKIP][296] ([i915#14544] / [i915#3555] / [i915#8152]) -> [PASS][297]
   [296]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_plane_scaling@planes-scaler-unity-scaling.html
   [297]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_plane_scaling@planes-scaler-unity-scaling.html

  * igt@kms_plane_scaling@planes-scaler-unity-scaling@pipe-a:
    - shard-rkl:          [SKIP][298] ([i915#12247] / [i915#14544]) -> [PASS][299] +4 other tests pass
   [298]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_plane_scaling@planes-scaler-unity-scaling@pipe-a.html
   [299]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_plane_scaling@planes-scaler-unity-scaling@pipe-a.html

  * igt@kms_plane_scaling@planes-unity-scaling-downscale-factor-0-75@pipe-b:
    - shard-rkl:          [SKIP][300] ([i915#12247] / [i915#14544] / [i915#8152]) -> [PASS][301] +5 other tests pass
   [300]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_plane_scaling@planes-unity-scaling-downscale-factor-0-75@pipe-b.html
   [301]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_plane_scaling@planes-unity-scaling-downscale-factor-0-75@pipe-b.html

  * igt@kms_plane_scaling@planes-upscale-factor-0-25:
    - shard-rkl:          [SKIP][302] ([i915#14544] / [i915#3555] / [i915#6953] / [i915#8152]) -> [PASS][303] +2 other tests pass
   [302]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_plane_scaling@planes-upscale-factor-0-25.html
   [303]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_plane_scaling@planes-upscale-factor-0-25.html

  * igt@kms_pm_rpm@dpms-lpsp:
    - shard-rkl:          [SKIP][304] ([i915#15073]) -> [PASS][305]
   [304]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_pm_rpm@dpms-lpsp.html
   [305]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-7/igt@kms_pm_rpm@dpms-lpsp.html

  * igt@kms_pm_rpm@dpms-mode-unset-lpsp:
    - shard-dg2:          [SKIP][306] ([i915#15073]) -> [PASS][307]
   [306]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-1/igt@kms_pm_rpm@dpms-mode-unset-lpsp.html
   [307]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-4/igt@kms_pm_rpm@dpms-mode-unset-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait:
    - shard-rkl:          [SKIP][308] ([i915#14544] / [i915#15073]) -> [PASS][309]
   [308]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html
   [309]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html

  * igt@kms_properties@crtc-properties-legacy:
    - shard-rkl:          [SKIP][310] ([i915#11521] / [i915#14544]) -> [PASS][311] +1 other test pass
   [310]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_properties@crtc-properties-legacy.html
   [311]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_properties@crtc-properties-legacy.html

  
#### Warnings ####

  * igt@api_intel_bb@blit-reloc-purge-cache:
    - shard-rkl:          [SKIP][312] ([i915#14544] / [i915#8411]) -> [SKIP][313] ([i915#8411]) +2 other tests skip
   [312]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@api_intel_bb@blit-reloc-purge-cache.html
   [313]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@api_intel_bb@blit-reloc-purge-cache.html

  * igt@gem_ccs@block-multicopy-inplace:
    - shard-rkl:          [SKIP][314] ([i915#3555] / [i915#9323]) -> [SKIP][315] ([i915#14544] / [i915#3555] / [i915#9323])
   [314]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@gem_ccs@block-multicopy-inplace.html
   [315]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_ccs@block-multicopy-inplace.html

  * igt@gem_close_race@multigpu-basic-process:
    - shard-rkl:          [SKIP][316] ([i915#7697]) -> [SKIP][317] ([i915#14544] / [i915#7697])
   [316]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@gem_close_race@multigpu-basic-process.html
   [317]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_close_race@multigpu-basic-process.html

  * igt@gem_create@create-ext-cpu-access-big:
    - shard-rkl:          [SKIP][318] ([i915#6335]) -> [SKIP][319] ([i915#14544] / [i915#6335])
   [318]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@gem_create@create-ext-cpu-access-big.html
   [319]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_create@create-ext-cpu-access-big.html

  * igt@gem_ctx_sseu@invalid-sseu:
    - shard-rkl:          [SKIP][320] ([i915#280]) -> [SKIP][321] ([i915#14544] / [i915#280])
   [320]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@gem_ctx_sseu@invalid-sseu.html
   [321]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_ctx_sseu@invalid-sseu.html

  * igt@gem_ctx_sseu@mmap-args:
    - shard-rkl:          [SKIP][322] ([i915#14544] / [i915#280]) -> [SKIP][323] ([i915#280])
   [322]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_ctx_sseu@mmap-args.html
   [323]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@gem_ctx_sseu@mmap-args.html

  * igt@gem_exec_balancer@parallel-bb-first:
    - shard-rkl:          [SKIP][324] ([i915#14544] / [i915#4525]) -> [SKIP][325] ([i915#4525]) +1 other test skip
   [324]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_exec_balancer@parallel-bb-first.html
   [325]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_exec_balancer@parallel-bb-first.html

  * igt@gem_exec_capture@capture-recoverable:
    - shard-rkl:          [SKIP][326] ([i915#14544] / [i915#6344]) -> [SKIP][327] ([i915#6344])
   [326]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_exec_capture@capture-recoverable.html
   [327]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-4/igt@gem_exec_capture@capture-recoverable.html

  * igt@gem_exec_reloc@basic-cpu-gtt:
    - shard-rkl:          [SKIP][328] ([i915#14544] / [i915#3281]) -> [SKIP][329] ([i915#3281]) +5 other tests skip
   [328]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_exec_reloc@basic-cpu-gtt.html
   [329]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_exec_reloc@basic-cpu-gtt.html

  * igt@gem_exec_reloc@basic-write-read-noreloc:
    - shard-rkl:          [SKIP][330] ([i915#3281]) -> [SKIP][331] ([i915#14544] / [i915#3281]) +14 other tests skip
   [330]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@gem_exec_reloc@basic-write-read-noreloc.html
   [331]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_exec_reloc@basic-write-read-noreloc.html

  * igt@gem_lmem_evict@dontneed-evict-race:
    - shard-rkl:          [SKIP][332] ([i915#14544] / [i915#4613] / [i915#7582]) -> [SKIP][333] ([i915#4613] / [i915#7582])
   [332]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_lmem_evict@dontneed-evict-race.html
   [333]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_lmem_evict@dontneed-evict-race.html

  * igt@gem_lmem_swapping@heavy-verify-multi:
    - shard-rkl:          [SKIP][334] ([i915#14544] / [i915#4613]) -> [SKIP][335] ([i915#4613])
   [334]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_lmem_swapping@heavy-verify-multi.html
   [335]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_lmem_swapping@heavy-verify-multi.html

  * igt@gem_lmem_swapping@verify:
    - shard-rkl:          [SKIP][336] ([i915#4613]) -> [SKIP][337] ([i915#14544] / [i915#4613]) +3 other tests skip
   [336]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@gem_lmem_swapping@verify.html
   [337]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_lmem_swapping@verify.html

  * igt@gem_partial_pwrite_pread@reads:
    - shard-rkl:          [SKIP][338] ([i915#3282]) -> [SKIP][339] ([i915#14544] / [i915#3282]) +4 other tests skip
   [338]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@gem_partial_pwrite_pread@reads.html
   [339]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_partial_pwrite_pread@reads.html

  * igt@gem_partial_pwrite_pread@writes-after-reads:
    - shard-rkl:          [SKIP][340] ([i915#14544] / [i915#3282]) -> [SKIP][341] ([i915#3282]) +7 other tests skip
   [340]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_partial_pwrite_pread@writes-after-reads.html
   [341]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_partial_pwrite_pread@writes-after-reads.html

  * igt@gem_pxp@hw-rejects-pxp-buffer:
    - shard-rkl:          [TIMEOUT][342] ([i915#12917] / [i915#12964]) -> [SKIP][343] ([i915#13717])
   [342]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_pxp@hw-rejects-pxp-buffer.html
   [343]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_pxp@hw-rejects-pxp-buffer.html

  * igt@gem_pxp@hw-rejects-pxp-context:
    - shard-rkl:          [SKIP][344] ([i915#13717]) -> [TIMEOUT][345] ([i915#12917] / [i915#12964])
   [344]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@gem_pxp@hw-rejects-pxp-context.html
   [345]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-7/igt@gem_pxp@hw-rejects-pxp-context.html

  * igt@gem_userptr_blits@coherency-unsync:
    - shard-rkl:          [SKIP][346] ([i915#14544] / [i915#3297]) -> [SKIP][347] ([i915#3297]) +2 other tests skip
   [346]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gem_userptr_blits@coherency-unsync.html
   [347]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gem_userptr_blits@coherency-unsync.html

  * igt@gem_userptr_blits@relocations:
    - shard-rkl:          [SKIP][348] ([i915#3281] / [i915#3297]) -> [SKIP][349] ([i915#14544] / [i915#3281] / [i915#3297])
   [348]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@gem_userptr_blits@relocations.html
   [349]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_userptr_blits@relocations.html

  * igt@gem_userptr_blits@unsync-unmap-after-close:
    - shard-rkl:          [SKIP][350] ([i915#3297]) -> [SKIP][351] ([i915#14544] / [i915#3297])
   [350]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@gem_userptr_blits@unsync-unmap-after-close.html
   [351]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gem_userptr_blits@unsync-unmap-after-close.html

  * igt@gen9_exec_parse@bb-oversize:
    - shard-rkl:          [SKIP][352] ([i915#2527]) -> [SKIP][353] ([i915#14544] / [i915#2527]) +2 other tests skip
   [352]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@gen9_exec_parse@bb-oversize.html
   [353]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@gen9_exec_parse@bb-oversize.html

  * igt@gen9_exec_parse@shadow-peek:
    - shard-rkl:          [SKIP][354] ([i915#14544] / [i915#2527]) -> [SKIP][355] ([i915#2527]) +3 other tests skip
   [354]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@gen9_exec_parse@shadow-peek.html
   [355]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@gen9_exec_parse@shadow-peek.html

  * igt@i915_module_load@resize-bar:
    - shard-rkl:          [SKIP][356] ([i915#6412]) -> [SKIP][357] ([i915#14544] / [i915#6412])
   [356]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@i915_module_load@resize-bar.html
   [357]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@i915_module_load@resize-bar.html

  * igt@i915_pm_rc6_residency@rc6-idle:
    - shard-rkl:          [SKIP][358] ([i915#14498] / [i915#14544]) -> [SKIP][359] ([i915#14498])
   [358]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@i915_pm_rc6_residency@rc6-idle.html
   [359]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@i915_pm_rc6_residency@rc6-idle.html

  * igt@i915_pm_rpm@system-suspend-execbuf:
    - shard-dg1:          [SKIP][360] ([i915#4423]) -> [ABORT][361] ([i915#13562])
   [360]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-15/igt@i915_pm_rpm@system-suspend-execbuf.html
   [361]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-12/igt@i915_pm_rpm@system-suspend-execbuf.html

  * igt@i915_pm_sseu@full-enable:
    - shard-rkl:          [SKIP][362] ([i915#4387]) -> [SKIP][363] ([i915#14544] / [i915#4387])
   [362]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@i915_pm_sseu@full-enable.html
   [363]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@i915_pm_sseu@full-enable.html

  * igt@i915_query@hwconfig_table:
    - shard-rkl:          [SKIP][364] ([i915#14544] / [i915#6245]) -> [SKIP][365] ([i915#6245])
   [364]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@i915_query@hwconfig_table.html
   [365]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-4/igt@i915_query@hwconfig_table.html

  * igt@i915_query@test-query-geometry-subslices:
    - shard-rkl:          [SKIP][366] ([i915#14544] / [i915#5723]) -> [SKIP][367] ([i915#5723])
   [366]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@i915_query@test-query-geometry-subslices.html
   [367]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@i915_query@test-query-geometry-subslices.html

  * igt@intel_hwmon@hwmon-read:
    - shard-rkl:          [SKIP][368] ([i915#14544] / [i915#7707]) -> [SKIP][369] ([i915#7707])
   [368]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@intel_hwmon@hwmon-read.html
   [369]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@intel_hwmon@hwmon-read.html

  * igt@kms_async_flips@async-flip-suspend-resume:
    - shard-rkl:          [INCOMPLETE][370] ([i915#12761]) -> [SKIP][371] ([i915#14544])
   [370]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@kms_async_flips@async-flip-suspend-resume.html
   [371]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_async_flips@async-flip-suspend-resume.html

  * igt@kms_atomic@plane-primary-overlay-mutable-zpos:
    - shard-rkl:          [SKIP][372] ([i915#9531]) -> [SKIP][373] ([i915#14544])
   [372]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_atomic@plane-primary-overlay-mutable-zpos.html
   [373]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_atomic@plane-primary-overlay-mutable-zpos.html

  * igt@kms_big_fb@4-tiled-64bpp-rotate-0:
    - shard-rkl:          [SKIP][374] ([i915#14544]) -> [SKIP][375] ([i915#5286]) +4 other tests skip
   [374]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_big_fb@4-tiled-64bpp-rotate-0.html
   [375]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_big_fb@4-tiled-64bpp-rotate-0.html

  * igt@kms_big_fb@4-tiled-addfb-size-overflow:
    - shard-rkl:          [SKIP][376] ([i915#5286]) -> [SKIP][377] ([i915#14544]) +4 other tests skip
   [376]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_big_fb@4-tiled-addfb-size-overflow.html
   [377]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_big_fb@4-tiled-addfb-size-overflow.html

  * igt@kms_big_fb@linear-32bpp-rotate-180:
    - shard-rkl:          [SKIP][378] ([i915#14544]) -> [DMESG-WARN][379] ([i915#12964])
   [378]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_big_fb@linear-32bpp-rotate-180.html
   [379]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_big_fb@linear-32bpp-rotate-180.html

  * igt@kms_big_fb@linear-32bpp-rotate-90:
    - shard-dg1:          [SKIP][380] ([i915#3638] / [i915#4423]) -> [SKIP][381] ([i915#3638])
   [380]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-15/igt@kms_big_fb@linear-32bpp-rotate-90.html
   [381]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-12/igt@kms_big_fb@linear-32bpp-rotate-90.html

  * igt@kms_big_fb@linear-64bpp-rotate-90:
    - shard-rkl:          [SKIP][382] ([i915#3638]) -> [SKIP][383] ([i915#14544]) +4 other tests skip
   [382]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_big_fb@linear-64bpp-rotate-90.html
   [383]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_big_fb@linear-64bpp-rotate-90.html

  * igt@kms_big_fb@x-tiled-32bpp-rotate-270:
    - shard-rkl:          [SKIP][384] ([i915#14544]) -> [SKIP][385] ([i915#3638]) +2 other tests skip
   [384]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_big_fb@x-tiled-32bpp-rotate-270.html
   [385]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_big_fb@x-tiled-32bpp-rotate-270.html

  * igt@kms_big_fb@yf-tiled-max-hw-stride-32bpp-rotate-0-hflip:
    - shard-rkl:          [SKIP][386] -> [SKIP][387] ([i915#14544]) +10 other tests skip
   [386]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_big_fb@yf-tiled-max-hw-stride-32bpp-rotate-0-hflip.html
   [387]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_big_fb@yf-tiled-max-hw-stride-32bpp-rotate-0-hflip.html

  * igt@kms_ccs@bad-rotation-90-4-tiled-lnl-ccs:
    - shard-rkl:          [SKIP][388] ([i915#14544]) -> [SKIP][389] ([i915#12313])
   [388]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_ccs@bad-rotation-90-4-tiled-lnl-ccs.html
   [389]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_ccs@bad-rotation-90-4-tiled-lnl-ccs.html

  * igt@kms_ccs@crc-primary-basic-4-tiled-dg2-mc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          [SKIP][390] ([i915#6095]) -> [SKIP][391] ([i915#14098] / [i915#6095]) +6 other tests skip
   [390]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_ccs@crc-primary-basic-4-tiled-dg2-mc-ccs@pipe-b-hdmi-a-2.html
   [391]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-3/igt@kms_ccs@crc-primary-basic-4-tiled-dg2-mc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-bmg-ccs:
    - shard-dg1:          [SKIP][392] ([i915#12313]) -> [SKIP][393] ([i915#12313] / [i915#4423])
   [392]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-16/igt@kms_ccs@crc-primary-rotation-180-4-tiled-bmg-ccs.html
   [393]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-14/igt@kms_ccs@crc-primary-rotation-180-4-tiled-bmg-ccs.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          [SKIP][394] ([i915#14098] / [i915#6095]) -> [SKIP][395] ([i915#6095]) +1 other test skip
   [394]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-5/igt@kms_ccs@crc-primary-rotation-180-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2.html
   [395]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_ccs@crc-primary-rotation-180-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@crc-primary-suspend-4-tiled-dg2-rc-ccs:
    - shard-rkl:          [SKIP][396] ([i915#14544]) -> [SKIP][397] ([i915#14098] / [i915#6095]) +7 other tests skip
   [396]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_ccs@crc-primary-suspend-4-tiled-dg2-rc-ccs.html
   [397]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_ccs@crc-primary-suspend-4-tiled-dg2-rc-ccs.html

  * igt@kms_ccs@crc-primary-suspend-y-tiled-ccs:
    - shard-glk:          [INCOMPLETE][398] ([i915#12796]) -> [INCOMPLETE][399] ([i915#12796] / [i915#14694]) +1 other test incomplete
   [398]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-glk5/igt@kms_ccs@crc-primary-suspend-y-tiled-ccs.html
   [399]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-glk1/igt@kms_ccs@crc-primary-suspend-y-tiled-ccs.html

  * igt@kms_ccs@crc-primary-suspend-y-tiled-gen12-mc-ccs:
    - shard-rkl:          [SKIP][400] ([i915#14098] / [i915#6095]) -> [SKIP][401] ([i915#14544]) +10 other tests skip
   [400]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_ccs@crc-primary-suspend-y-tiled-gen12-mc-ccs.html
   [401]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_ccs@crc-primary-suspend-y-tiled-gen12-mc-ccs.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs:
    - shard-rkl:          [SKIP][402] ([i915#12313]) -> [SKIP][403] ([i915#14544]) +1 other test skip
   [402]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html
   [403]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html

  * igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs:
    - shard-dg1:          [SKIP][404] ([i915#4423] / [i915#6095]) -> [SKIP][405] ([i915#6095]) +2 other tests skip
   [404]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-15/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs.html
   [405]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-12/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs.html

  * igt@kms_chamelium_frames@dp-crc-fast:
    - shard-rkl:          [SKIP][406] ([i915#11151] / [i915#14544] / [i915#7828]) -> [SKIP][407] ([i915#11151] / [i915#7828]) +5 other tests skip
   [406]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_chamelium_frames@dp-crc-fast.html
   [407]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_chamelium_frames@dp-crc-fast.html

  * igt@kms_chamelium_frames@hdmi-crc-fast:
    - shard-dg1:          [SKIP][408] ([i915#11151] / [i915#4423] / [i915#7828]) -> [SKIP][409] ([i915#11151] / [i915#7828])
   [408]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-15/igt@kms_chamelium_frames@hdmi-crc-fast.html
   [409]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-12/igt@kms_chamelium_frames@hdmi-crc-fast.html

  * igt@kms_chamelium_frames@hdmi-frame-dump:
    - shard-rkl:          [SKIP][410] ([i915#11151] / [i915#7828]) -> [SKIP][411] ([i915#11151] / [i915#14544] / [i915#7828]) +7 other tests skip
   [410]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_chamelium_frames@hdmi-frame-dump.html
   [411]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_chamelium_frames@hdmi-frame-dump.html

  * igt@kms_content_protection@dp-mst-lic-type-0:
    - shard-rkl:          [SKIP][412] ([i915#3116]) -> [SKIP][413] ([i915#14544])
   [412]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_content_protection@dp-mst-lic-type-0.html
   [413]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_content_protection@dp-mst-lic-type-0.html

  * igt@kms_content_protection@dp-mst-type-0:
    - shard-rkl:          [SKIP][414] ([i915#14544]) -> [SKIP][415] ([i915#3116])
   [414]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_content_protection@dp-mst-type-0.html
   [415]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_content_protection@dp-mst-type-0.html

  * igt@kms_content_protection@legacy:
    - shard-rkl:          [SKIP][416] ([i915#14544]) -> [SKIP][417] ([i915#7118] / [i915#9424])
   [416]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_content_protection@legacy.html
   [417]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_content_protection@legacy.html

  * igt@kms_content_protection@mei-interface:
    - shard-rkl:          [SKIP][418] ([i915#9424]) -> [SKIP][419] ([i915#14544])
   [418]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_content_protection@mei-interface.html
   [419]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_content_protection@mei-interface.html
    - shard-dg1:          [SKIP][420] ([i915#9424]) -> [SKIP][421] ([i915#9433])
   [420]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-17/igt@kms_content_protection@mei-interface.html
   [421]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-13/igt@kms_content_protection@mei-interface.html

  * igt@kms_content_protection@srm:
    - shard-dg2:          [SKIP][422] ([i915#7118]) -> [FAIL][423] ([i915#7173])
   [422]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-3/igt@kms_content_protection@srm.html
   [423]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-10/igt@kms_content_protection@srm.html

  * igt@kms_content_protection@uevent:
    - shard-rkl:          [SKIP][424] ([i915#7118] / [i915#9424]) -> [SKIP][425] ([i915#14544])
   [424]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_content_protection@uevent.html
   [425]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_content_protection@uevent.html

  * igt@kms_cursor_crc@cursor-onscreen-32x32:
    - shard-rkl:          [SKIP][426] ([i915#14544]) -> [SKIP][427] ([i915#3555]) +2 other tests skip
   [426]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_cursor_crc@cursor-onscreen-32x32.html
   [427]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_cursor_crc@cursor-onscreen-32x32.html

  * igt@kms_cursor_crc@cursor-onscreen-512x512:
    - shard-rkl:          [SKIP][428] ([i915#13049]) -> [SKIP][429] ([i915#14544])
   [428]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_cursor_crc@cursor-onscreen-512x512.html
   [429]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_cursor_crc@cursor-onscreen-512x512.html

  * igt@kms_cursor_crc@cursor-random-32x10:
    - shard-dg1:          [SKIP][430] ([i915#3555] / [i915#4423]) -> [SKIP][431] ([i915#3555])
   [430]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-18/igt@kms_cursor_crc@cursor-random-32x10.html
   [431]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-14/igt@kms_cursor_crc@cursor-random-32x10.html

  * igt@kms_cursor_crc@cursor-rapid-movement-32x10:
    - shard-rkl:          [SKIP][432] ([i915#3555]) -> [SKIP][433] ([i915#14544]) +5 other tests skip
   [432]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_cursor_crc@cursor-rapid-movement-32x10.html
   [433]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_cursor_crc@cursor-rapid-movement-32x10.html

  * igt@kms_cursor_crc@cursor-rapid-movement-512x512:
    - shard-rkl:          [SKIP][434] ([i915#14544]) -> [SKIP][435] ([i915#13049])
   [434]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_cursor_crc@cursor-rapid-movement-512x512.html
   [435]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-4/igt@kms_cursor_crc@cursor-rapid-movement-512x512.html

  * igt@kms_cursor_crc@cursor-sliding-64x21:
    - shard-rkl:          [FAIL][436] ([i915#13566]) -> [SKIP][437] ([i915#14544])
   [436]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@kms_cursor_crc@cursor-sliding-64x21.html
   [437]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_cursor_crc@cursor-sliding-64x21.html

  * igt@kms_cursor_legacy@2x-flip-vs-cursor-legacy:
    - shard-rkl:          [SKIP][438] ([i915#14544]) -> [SKIP][439] +16 other tests skip
   [438]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_cursor_legacy@2x-flip-vs-cursor-legacy.html
   [439]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_cursor_legacy@2x-flip-vs-cursor-legacy.html

  * igt@kms_cursor_legacy@short-busy-flip-before-cursor-atomic-transitions:
    - shard-rkl:          [SKIP][440] ([i915#4103]) -> [SKIP][441] ([i915#14544])
   [440]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_cursor_legacy@short-busy-flip-before-cursor-atomic-transitions.html
   [441]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_cursor_legacy@short-busy-flip-before-cursor-atomic-transitions.html

  * igt@kms_dirtyfb@psr-dirtyfb-ioctl:
    - shard-rkl:          [SKIP][442] ([i915#9723]) -> [SKIP][443] ([i915#14544]) +1 other test skip
   [442]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@kms_dirtyfb@psr-dirtyfb-ioctl.html
   [443]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_dirtyfb@psr-dirtyfb-ioctl.html

  * igt@kms_dp_link_training@non-uhbr-mst:
    - shard-rkl:          [SKIP][444] ([i915#14544]) -> [SKIP][445] ([i915#13749])
   [444]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_dp_link_training@non-uhbr-mst.html
   [445]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_dp_link_training@non-uhbr-mst.html

  * igt@kms_dp_linktrain_fallback@dsc-fallback:
    - shard-rkl:          [SKIP][446] ([i915#14544]) -> [SKIP][447] ([i915#13707]) +1 other test skip
   [446]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_dp_linktrain_fallback@dsc-fallback.html
   [447]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_dp_linktrain_fallback@dsc-fallback.html

  * igt@kms_dsc@dsc-fractional-bpp-with-bpc:
    - shard-rkl:          [SKIP][448] ([i915#14544]) -> [SKIP][449] ([i915#3840])
   [448]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_dsc@dsc-fractional-bpp-with-bpc.html
   [449]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_dsc@dsc-fractional-bpp-with-bpc.html

  * igt@kms_dsc@dsc-with-bpc-formats:
    - shard-rkl:          [SKIP][450] ([i915#3555] / [i915#3840]) -> [SKIP][451] ([i915#14544])
   [450]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-4/igt@kms_dsc@dsc-with-bpc-formats.html
   [451]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_dsc@dsc-with-bpc-formats.html

  * igt@kms_fbcon_fbt@psr-suspend:
    - shard-rkl:          [SKIP][452] ([i915#3955]) -> [SKIP][453] ([i915#14544] / [i915#3955])
   [452]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_fbcon_fbt@psr-suspend.html
   [453]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_fbcon_fbt@psr-suspend.html

  * igt@kms_flip@2x-flip-vs-dpms-on-nop-interruptible:
    - shard-rkl:          [SKIP][454] ([i915#9934]) -> [SKIP][455] ([i915#14544] / [i915#9934]) +6 other tests skip
   [454]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@kms_flip@2x-flip-vs-dpms-on-nop-interruptible.html
   [455]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_flip@2x-flip-vs-dpms-on-nop-interruptible.html

  * igt@kms_flip@2x-single-buffer-flip-vs-dpms-off-vs-modeset-interruptible:
    - shard-rkl:          [SKIP][456] ([i915#14544] / [i915#9934]) -> [SKIP][457] ([i915#9934]) +4 other tests skip
   [456]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_flip@2x-single-buffer-flip-vs-dpms-off-vs-modeset-interruptible.html
   [457]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_flip@2x-single-buffer-flip-vs-dpms-off-vs-modeset-interruptible.html

  * igt@kms_flip_scaled_crc@flip-32bpp-ytile-to-32bpp-ytileccs-downscaling:
    - shard-rkl:          [SKIP][458] ([i915#14544] / [i915#3555]) -> [SKIP][459] ([i915#2672] / [i915#3555]) +1 other test skip
   [458]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-ytile-to-32bpp-ytileccs-downscaling.html
   [459]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_flip_scaled_crc@flip-32bpp-ytile-to-32bpp-ytileccs-downscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-32bpp-4tile-upscaling:
    - shard-rkl:          [SKIP][460] ([i915#2672] / [i915#3555]) -> [SKIP][461] ([i915#14544] / [i915#3555]) +4 other tests skip
   [460]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-32bpp-4tile-upscaling.html
   [461]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-32bpp-4tile-upscaling.html

  * igt@kms_force_connector_basic@force-load-detect:
    - shard-dg1:          [SKIP][462] -> [ABORT][463] ([i915#4423])
   [462]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-16/igt@kms_force_connector_basic@force-load-detect.html
   [463]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-15/igt@kms_force_connector_basic@force-load-detect.html

  * igt@kms_frontbuffer_tracking@fbc-2p-indfb-fliptrack-mmap-gtt:
    - shard-rkl:          [SKIP][464] -> [SKIP][465] ([i915#14544] / [i915#1849] / [i915#5354])
   [464]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_frontbuffer_tracking@fbc-2p-indfb-fliptrack-mmap-gtt.html
   [465]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-2p-indfb-fliptrack-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-2p-primscrn-cur-indfb-draw-mmap-cpu:
    - shard-dg1:          [SKIP][466] ([i915#4423]) -> [SKIP][467] +1 other test skip
   [466]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-15/igt@kms_frontbuffer_tracking@fbc-2p-primscrn-cur-indfb-draw-mmap-cpu.html
   [467]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-12/igt@kms_frontbuffer_tracking@fbc-2p-primscrn-cur-indfb-draw-mmap-cpu.html

  * igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-shrfb-draw-mmap-gtt:
    - shard-rkl:          [SKIP][468] ([i915#14544] / [i915#1849] / [i915#5354]) -> [SKIP][469] ([i915#1825]) +30 other tests skip
   [468]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-shrfb-draw-mmap-gtt.html
   [469]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-shrfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-pri-indfb-multidraw:
    - shard-rkl:          [SKIP][470] ([i915#14544] / [i915#1849] / [i915#5354]) -> [SKIP][471] ([i915#3023]) +15 other tests skip
   [470]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-1p-pri-indfb-multidraw.html
   [471]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-1p-pri-indfb-multidraw.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-cur-indfb-draw-mmap-gtt:
    - shard-rkl:          [SKIP][472] ([i915#1825]) -> [SKIP][473] ([i915#14544] / [i915#1849] / [i915#5354]) +34 other tests skip
   [472]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-cur-indfb-draw-mmap-gtt.html
   [473]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-cur-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-shrfb-fliptrack-mmap-gtt:
    - shard-rkl:          [SKIP][474] ([i915#14544] / [i915#1849] / [i915#5354]) -> [SKIP][475]
   [474]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-2p-shrfb-fliptrack-mmap-gtt.html
   [475]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-2p-shrfb-fliptrack-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-farfromfence-mmap-gtt:
    - shard-dg1:          [SKIP][476] ([i915#8708]) -> [SKIP][477] ([i915#4423] / [i915#8708])
   [476]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-12/igt@kms_frontbuffer_tracking@fbcpsr-farfromfence-mmap-gtt.html
   [477]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-17/igt@kms_frontbuffer_tracking@fbcpsr-farfromfence-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-mmap-wc:
    - shard-rkl:          [SKIP][478] ([i915#3023]) -> [SKIP][479] ([i915#14544] / [i915#1849] / [i915#5354]) +11 other tests skip
   [478]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-mmap-wc.html
   [479]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-render:
    - shard-dg2:          [SKIP][480] ([i915#3458]) -> [SKIP][481] ([i915#10433] / [i915#3458]) +1 other test skip
   [480]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg2-3/igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-render.html
   [481]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-4/igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-render.html

  * igt@kms_hdr@brightness-with-hdr:
    - shard-dg1:          [SKIP][482] ([i915#1187] / [i915#12713]) -> [SKIP][483] ([i915#12713])
   [482]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-13/igt@kms_hdr@brightness-with-hdr.html
   [483]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-17/igt@kms_hdr@brightness-with-hdr.html
    - shard-tglu:         [SKIP][484] ([i915#1187] / [i915#12713]) -> [SKIP][485] ([i915#12713])
   [484]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-tglu-2/igt@kms_hdr@brightness-with-hdr.html
   [485]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-6/igt@kms_hdr@brightness-with-hdr.html

  * igt@kms_hdr@static-swap:
    - shard-rkl:          [SKIP][486] ([i915#14544]) -> [SKIP][487] ([i915#3555] / [i915#8228]) +1 other test skip
   [486]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_hdr@static-swap.html
   [487]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_hdr@static-swap.html

  * igt@kms_hdr@static-toggle-suspend:
    - shard-rkl:          [SKIP][488] ([i915#3555] / [i915#8228]) -> [SKIP][489] ([i915#14544]) +1 other test skip
   [488]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_hdr@static-toggle-suspend.html
   [489]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_hdr@static-toggle-suspend.html

  * igt@kms_joiner@basic-big-joiner:
    - shard-rkl:          [SKIP][490] ([i915#10656] / [i915#14544]) -> [SKIP][491] ([i915#10656])
   [490]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_joiner@basic-big-joiner.html
   [491]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_joiner@basic-big-joiner.html

  * igt@kms_joiner@basic-force-ultra-joiner:
    - shard-rkl:          [SKIP][492] ([i915#12394]) -> [SKIP][493] ([i915#12394] / [i915#14544])
   [492]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_joiner@basic-force-ultra-joiner.html
   [493]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_joiner@basic-force-ultra-joiner.html

  * igt@kms_joiner@invalid-modeset-force-ultra-joiner:
    - shard-rkl:          [SKIP][494] ([i915#12394] / [i915#14544]) -> [SKIP][495] ([i915#12394])
   [494]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_joiner@invalid-modeset-force-ultra-joiner.html
   [495]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_joiner@invalid-modeset-force-ultra-joiner.html

  * igt@kms_joiner@invalid-modeset-ultra-joiner:
    - shard-rkl:          [SKIP][496] ([i915#12339] / [i915#14544]) -> [SKIP][497] ([i915#12339])
   [496]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_joiner@invalid-modeset-ultra-joiner.html
   [497]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_joiner@invalid-modeset-ultra-joiner.html

  * igt@kms_multipipe_modeset@basic-max-pipe-crc-check:
    - shard-rkl:          [SKIP][498] ([i915#1839] / [i915#4816]) -> [SKIP][499] ([i915#4070] / [i915#4816])
   [498]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_multipipe_modeset@basic-max-pipe-crc-check.html
   [499]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-5/igt@kms_multipipe_modeset@basic-max-pipe-crc-check.html

  * igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation:
    - shard-rkl:          [SKIP][500] ([i915#3555]) -> [SKIP][501] ([i915#14544] / [i915#3555] / [i915#8152])
   [500]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation.html
   [501]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation.html

  * igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-a:
    - shard-rkl:          [SKIP][502] ([i915#12247]) -> [SKIP][503] ([i915#12247] / [i915#14544])
   [502]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-a.html
   [503]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-a.html

  * igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-b:
    - shard-rkl:          [SKIP][504] ([i915#12247]) -> [SKIP][505] ([i915#12247] / [i915#14544] / [i915#8152])
   [504]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-b.html
   [505]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_plane_scaling@plane-scaler-with-clipping-clamping-rotation@pipe-b.html

  * igt@kms_pm_backlight@fade:
    - shard-rkl:          [SKIP][506] ([i915#5354]) -> [SKIP][507] ([i915#14544] / [i915#5354])
   [506]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_pm_backlight@fade.html
   [507]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_pm_backlight@fade.html

  * igt@kms_pm_dc@dc6-dpms:
    - shard-rkl:          [SKIP][508] ([i915#3361]) -> [FAIL][509] ([i915#9295])
   [508]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_pm_dc@dc6-dpms.html
   [509]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-7/igt@kms_pm_dc@dc6-dpms.html

  * igt@kms_pm_dc@dc9-dpms:
    - shard-tglu:         [SKIP][510] -> [SKIP][511] ([i915#4281])
   [510]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-tglu-6/igt@kms_pm_dc@dc9-dpms.html
   [511]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-tglu-8/igt@kms_pm_dc@dc9-dpms.html

  * igt@kms_pm_lpsp@kms-lpsp:
    - shard-rkl:          [SKIP][512] ([i915#9340]) -> [SKIP][513] ([i915#14544] / [i915#9340])
   [512]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_pm_lpsp@kms-lpsp.html
   [513]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_pm_lpsp@kms-lpsp.html

  * igt@kms_pm_lpsp@screens-disabled:
    - shard-rkl:          [SKIP][514] ([i915#14544] / [i915#8430]) -> [SKIP][515] ([i915#8430])
   [514]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_pm_lpsp@screens-disabled.html
   [515]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_pm_lpsp@screens-disabled.html

  * igt@kms_pm_rpm@dpms-non-lpsp:
    - shard-rkl:          [SKIP][516] ([i915#15073]) -> [SKIP][517] ([i915#14544] / [i915#15073])
   [516]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_pm_rpm@dpms-non-lpsp.html
   [517]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_pm_rpm@dpms-non-lpsp.html

  * igt@kms_pm_rpm@modeset-lpsp-stress-no-wait:
    - shard-rkl:          [SKIP][518] ([i915#12916] / [i915#14544]) -> [SKIP][519] ([i915#15073])
   [518]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_pm_rpm@modeset-lpsp-stress-no-wait.html
   [519]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_pm_rpm@modeset-lpsp-stress-no-wait.html

  * igt@kms_prime@basic-crc-hybrid:
    - shard-rkl:          [SKIP][520] ([i915#6524]) -> [SKIP][521] ([i915#14544] / [i915#6524])
   [520]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_prime@basic-crc-hybrid.html
   [521]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_prime@basic-crc-hybrid.html

  * igt@kms_psr2_sf@fbc-pr-primary-plane-update-sf-dmg-area:
    - shard-rkl:          [SKIP][522] ([i915#11520] / [i915#14544]) -> [SKIP][523] ([i915#11520]) +6 other tests skip
   [522]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_psr2_sf@fbc-pr-primary-plane-update-sf-dmg-area.html
   [523]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_psr2_sf@fbc-pr-primary-plane-update-sf-dmg-area.html

  * igt@kms_psr2_sf@fbc-psr2-overlay-plane-move-continuous-exceed-sf:
    - shard-rkl:          [SKIP][524] ([i915#11520]) -> [SKIP][525] ([i915#11520] / [i915#14544]) +6 other tests skip
   [524]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@kms_psr2_sf@fbc-psr2-overlay-plane-move-continuous-exceed-sf.html
   [525]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_psr2_sf@fbc-psr2-overlay-plane-move-continuous-exceed-sf.html

  * igt@kms_psr2_su@page_flip-nv12:
    - shard-rkl:          [SKIP][526] ([i915#14544] / [i915#9683]) -> [SKIP][527] ([i915#9683])
   [526]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_psr2_su@page_flip-nv12.html
   [527]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_psr2_su@page_flip-nv12.html

  * igt@kms_psr@fbc-psr2-sprite-render:
    - shard-rkl:          [SKIP][528] ([i915#1072] / [i915#9732]) -> [SKIP][529] ([i915#1072] / [i915#14544] / [i915#9732]) +18 other tests skip
   [528]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_psr@fbc-psr2-sprite-render.html
   [529]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_psr@fbc-psr2-sprite-render.html

  * igt@kms_psr@pr-cursor-plane-onoff:
    - shard-rkl:          [SKIP][530] ([i915#1072] / [i915#14544] / [i915#9732]) -> [SKIP][531] ([i915#1072] / [i915#9732]) +13 other tests skip
   [530]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_psr@pr-cursor-plane-onoff.html
   [531]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_psr@pr-cursor-plane-onoff.html

  * igt@kms_psr@psr-cursor-render:
    - shard-dg1:          [SKIP][532] ([i915#1072] / [i915#4423] / [i915#9732]) -> [SKIP][533] ([i915#1072] / [i915#9732]) +2 other tests skip
   [532]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-19/igt@kms_psr@psr-cursor-render.html
   [533]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-15/igt@kms_psr@psr-cursor-render.html

  * igt@kms_psr_stress_test@flip-primary-invalidate-overlay:
    - shard-rkl:          [SKIP][534] ([i915#9685]) -> [SKIP][535] ([i915#14544] / [i915#9685])
   [534]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_psr_stress_test@flip-primary-invalidate-overlay.html
   [535]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_psr_stress_test@flip-primary-invalidate-overlay.html

  * igt@kms_rotation_crc@primary-yf-tiled-reflect-x-0:
    - shard-rkl:          [SKIP][536] ([i915#14544]) -> [SKIP][537] ([i915#5289])
   [536]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-0.html
   [537]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-0.html

  * igt@kms_setmode@clone-exclusive-crtc:
    - shard-rkl:          [SKIP][538] ([i915#3555]) -> [SKIP][539] ([i915#14544] / [i915#3555]) +1 other test skip
   [538]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-8/igt@kms_setmode@clone-exclusive-crtc.html
   [539]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_setmode@clone-exclusive-crtc.html

  * igt@kms_setmode@invalid-clone-single-crtc:
    - shard-rkl:          [SKIP][540] ([i915#14544] / [i915#3555]) -> [SKIP][541] ([i915#3555])
   [540]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_setmode@invalid-clone-single-crtc.html
   [541]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_setmode@invalid-clone-single-crtc.html

  * igt@kms_vrr@lobf:
    - shard-rkl:          [SKIP][542] ([i915#14544]) -> [SKIP][543] ([i915#11920])
   [542]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_vrr@lobf.html
   [543]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_vrr@lobf.html

  * igt@kms_vrr@seamless-rr-switch-drrs:
    - shard-rkl:          [SKIP][544] ([i915#14544]) -> [SKIP][545] ([i915#9906])
   [544]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_vrr@seamless-rr-switch-drrs.html
   [545]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-2/igt@kms_vrr@seamless-rr-switch-drrs.html

  * igt@kms_vrr@seamless-rr-switch-virtual:
    - shard-rkl:          [SKIP][546] ([i915#9906]) -> [SKIP][547] ([i915#14544])
   [546]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@kms_vrr@seamless-rr-switch-virtual.html
   [547]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@kms_vrr@seamless-rr-switch-virtual.html

  * igt@kms_writeback@writeback-invalid-parameters:
    - shard-rkl:          [SKIP][548] ([i915#14544] / [i915#2437]) -> [SKIP][549] ([i915#2437])
   [548]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@kms_writeback@writeback-invalid-parameters.html
   [549]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-8/igt@kms_writeback@writeback-invalid-parameters.html

  * igt@perf@unprivileged-single-ctx-counters:
    - shard-rkl:          [SKIP][550] ([i915#14544] / [i915#2433]) -> [SKIP][551] ([i915#2433])
   [550]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-6/igt@perf@unprivileged-single-ctx-counters.html
   [551]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-4/igt@perf@unprivileged-single-ctx-counters.html

  * igt@prime_vgem@fence-flip-hang:
    - shard-rkl:          [SKIP][552] ([i915#3708]) -> [SKIP][553] ([i915#14544] / [i915#3708])
   [552]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-2/igt@prime_vgem@fence-flip-hang.html
   [553]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@prime_vgem@fence-flip-hang.html

  * igt@sriov_basic@enable-vfs-bind-unbind-each:
    - shard-rkl:          [SKIP][554] ([i915#9917]) -> [SKIP][555] ([i915#14544] / [i915#9917])
   [554]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-rkl-3/igt@sriov_basic@enable-vfs-bind-unbind-each.html
   [555]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-rkl-6/igt@sriov_basic@enable-vfs-bind-unbind-each.html
...
<p>Serious unknown changes coming with Patchwork_155622v1_full absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_155622v1_full, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them<br />
  to document this new failure mode, which will reduce false positives in CI.</p>
<h2>Participating hosts (11 -&gt; 11)</h2>
<p>No changes in participating hosts</p>
<h2>Possible new issues</h2>
<p>Here are the unknown changes that may have been introduced in Patchwork_155622v1_full:</p>
<h3>IGT changes</h3>
...
<ul>
<li>shard-dg1:          <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-dg1-18/igt@gem_ctx_isolation@preservation-reset.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg1-14/igt@gem_ctx_isolation@preservation-reset.html">FAIL</a> +1 other test fail</li>
</ul>
</li>
<li>
<p>igt@i915_pm_rpm@system-suspend-execbuf:</p>
<ul>
<li>shard-mtlp:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17327/shard-mtlp-3/igt@i915_pm_rpm@system-suspend-execbuf.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-mtlp-2/igt@i915_pm_rpm@system-suspend-execbuf.html">FAIL</a></li>
</ul>
</li>
</ul>
<h4>Suppressed</h4>
...
<ul>
<li>shard-dg2-9:        NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-9/igt@kms_frontbuffer_tracking@fbc-1p-offscreen-pri-indfb-draw-mmap-wc.html">SKIP</a></li>
</ul>
</li>
<li>
<p>{igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-shrfb-draw-mmap-wc}:</p>
<ul>
<li>shard-dg2:          NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_155622v1/shard-dg2-8/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-shrfb-draw-mmap-wc.html">SKIP</a></li>
</ul>
</li>
</ul>
<h2>New tests</h2>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C82464756B6
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Dec 2021 11:43:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCE1C10E485;
	Wed, 15 Dec 2021 10:43:26 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 0/5] drm/dp: Move DisplayPort helpers into
 own module

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC2B3EF87E
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Nov 2019 10:21:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F8C989A32;
	Tue,  5 Nov 2019 09:21:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 756046E948
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 Nov 2019 09:21:29 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19084820-1500050 
 for multiple; Tue, 05 Nov 2019 09:21:16 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  5 Nov 2019 09:21:09 +0000
Message-Id: <20191105092115.11451-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 04/10] drm/i915: Drop GEM context as a direct
...
bS9pOTE1X2dlbV9jb250ZXh0LmMKaW5kZXggZGU2ZTU1YWY4MmNmLi41M2ZhMzI5NzQ3NjcgMTAw
...
IEdQVSB3ZSBuZWVkIHRvIGV2aWN0CkBAIC0xMDQzLDcgKzEwMzgsNyBAQCBzdGF0aWMgdm9pZCBz
...
L2RybS9pOTE1L2k5MTVfZ3B1X2Vycm9yLmMKaW5kZXggZThiNjdmNWU1MjFkLi5iNDAxNTdjZmFl
MTQgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZ3B1X2Vycm9yLmMKKysr
...

...


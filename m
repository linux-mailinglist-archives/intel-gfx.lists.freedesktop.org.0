...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0886B14F426
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jan 2020 22:47:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 045766FC22;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/18] drm/i915/dp: Add compute routine for DP
 PSR VSC SDP

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EF2ECA58E9
	for <lists+intel-gfx@lfdr.de>; Thu, 04 Dec 2025 22:53:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CCB2C10E9D4;
	Thu,  4 Dec 2025 21:53:43 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=Nvidia.com header.i=@Nvidia.com header.b="ee4sfrOq";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from PH0PR06CU001.outbound.protection.outlook.com
 (mail-westus3azon11011009.outbound.protection.outlook.com [40.107.208.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A3AD410E9C9;
 Thu,  4 Dec 2025 21:53:42 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=rI8HWfI+mcJpgmvRd4Aoviw43yTLWDzqjKQc0f7Lqvc=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=rI8HWfI+mcJpgmvRd4Aoviw43yTLWDzqjKQc0f7Lqvc=;
 b=
...
Subject: [PATCH v4 2/3] gpu: Move DRM buddy allocator one level up
Date: Thu,  4 Dec 2025 16:51:28 -0500
Message-Id: <20251204215129.2357292-3-joelagnelf@nvidia.com>
...
X-ClientProxiedBy: MN2PR10CA0011.namprd10.prod.outlook.com
 (2603:10b6:208:120::24) To SN7PR12MB8059.namprd12.prod.outlook.com
 (2603:10b6:806:32b::7)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: SN7PR12MB8059:EE_|BN3PR12MB9596:EE_
X-MS-Office365-Filtering-Correlation-Id: 1ee8a994-e54d-4935-830d-08de337f8661
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230040|366016|1800799024|376014|7416014;
X-Microsoft-Antispam-Message-Info: =?utf-8?B?TnR2Q0FDekd3d3NIQXhJZW5CNVV4T2NBTXo4NUdDQXdZdG5OUlc1VnNkZ0Vq?=
 =?utf-8?B?VUJSN2NUOUF1T1lpcUZyNGY2TFkwUWo4UHdVdDVtVnowNUt2VFFDc2Y0SnVj?=
 =?utf-8?B?L2pKNHkrSWRtUUl1SEppRXRZWS92UUZPZmhOQ2QyVkpYUUIxN0d3RzB2eHpL?=
 =?utf-8?B?SE5BOG1XTG83dW8wN0dBRkVBQnYxd0tYY3I1ZHEzT1RZbVhtYk5ma3FrRnRI?=
 =?utf-8?B?Vzh5SGJJU0xHTHVQb1J0R0lwS0tNdFkxT2R1Y29yK2xDN2tqZXd6ZWxuUDNM?=
 =?utf-8?B?cHJaTlBZRGRaMVhKY0pzNzd4S2lZbjFyU2FoMEF2SlhxUTdyRTNhbVI1Mm04?=
 =?utf-8?B?OG1leHhHUXBwbzlqNWRTbmpTSnVJNmVtcmlTWWZiYVVaQkZjUzlaOWwwakJ5?=
 =?utf-8?B?VnV3VkJZM0xWNjF1NjBqL0tzUWRyK2pRNUFqK21hbzErRjFES090NG81eDJN?=
 =?utf-8?B?V011dm1nZmxLeEY5S2x3aWJRZWZBYkF0NmFSSThLdERBdDNVTkdNaTJnZ1Jm?=
 =?utf-8?B?MlRlNVNERTZ5OWtnTTNkT0kyZzhBQW1qZkNNM3lSbVhZd1BSc2RBSGJ4TjRs?=
 =?utf-8?B?cUduVDM4dlJlZkFXNHdSSTlhTVBwVmhxTHFkQUtWNzRzNzVCakxLQ2V4YU1w?=
 =?utf-8?B?WS9CN1daL1YrVmJkYnVHN2p1dlJ2UGhZN3dWYVhTUStKeTBjTW9aWnpYeDJo?=
 =?utf-8?B?bDRGOHJwWlRwRlpZMnpNcjRrY0p6dUdWMUhHdDROaFdYbUpINEZENTR3cXJ2?=
 =?utf-8?B?Vmo0Q1VqSmV4VDFIWFZFYUJueVdUSGxXMjdxbUZDdHlHVng5WnRObmpXSzFM?=
 =?utf-8?B?ejQveVVXTDc2Vldic3dOUTkvL1lXcUV6dDFoeWpMeFpyUnA2T2gyQW5MSENy?=
 =?utf-8?B?MGMvd1BxTHNOS1Axb3h0WDVZQ2QraXdwdnZBZWtValNtQUlXbitELzZWNkFH?=
 =?utf-8?B?QjFta3FDc2QzblVLRjhxa2pZSGR4Z092K1VNSnRNVi9DcnRpNGQybEN2Vy9V?=
 =?utf-8?B?Mjhua1BkS1NYaFozV1FyMFV2YklmK3JzTmh6eDQ0Q3NYajdRa2NYalBuWkRv?=
 =?utf-8?B?c3dmUUgrNDZaSk4zL05LMjRQUm9SRDhHZHk1dm5jT1lkVXFnOVJRb2NHUXZl?=
 =?utf-8?B?a2pMSHpBalNzVmNMdEhMeGJJbkZUN090Ujl0MXhTUjRtbmJiR0lQTFFiUWlu?=
 =?utf-8?B?Q2xteC9SSExiem5Wek5XY1JvSkN5TmVSallFdkpOVFIxNmxoTEZOYXJuR3Qv?=
 =?utf-8?B?SGNBQjRGbGw5RWpTSDJCd1dVMXplRStmNFRkNDdCUEVnbTJWRTRCNHVTUjE4?=
 =?utf-8?B?Zzg1ZlVnODc5QVlsa2xUU2d0b3EvRUVGR0NDSlpXTFFXcEV3UjNCMEwxMGVw?=
 =?utf-8?B?V3R1Q2NWMW1yS3AvWFBPRk04SFFQOTN6TEtaMVNsbmR4MkxGS2wrZUtPdGFM?=
 =?utf-8?B?WnQ1WVR6OEZ0QW12SjV6N0dWaUthVFdVVTdrbnM3WXRGZlplQk9saVFwNVoy?=
 =?utf-8?B?MWVFaVI0QjVLYStucndBbTRTYVl4cjFEeDhxL1FVVEZYZldSQjh3UE1FQ09G?=
 =?utf-8?B?OVVvQ1JxQ0VQTk9kWDRHbnFYdHU1YWsxeFRoS25VbGhURFN1clZHUzlneWpl?=
 =?utf-8?B?ZEFEMzFkS0FCRElxQ0NPY2Q2MHN1VVo2Sm9zakhCN3hxTStsUDdGZkN6ZGxT?=
 =?utf-8?B?c3M0N3RTQjk2SStkVjhRSlZERXN0dlVKM00weGp5RHc1N01qMTFmKysvdjlt?=
 =?utf-8?B?MEJaWlJ4anBMNXZHb3Jib2lucU5rZitCRW1haC9rbkVxNXdiNHBGOFJ3WXAx?=
 =?utf-8?B?K0dSbXRvQkg2S1JBRXlvQjl6TDFRRlVaaFNlVTROZGRGWldSSk9ES0F0ZXZh?=
 =?utf-8?B?YVIvWjk4V3dqd1dxL3JkZWJoWjZvcjR0czd5aExNY2t4WFA4M2NWK2lGNFA1?=
 =?utf-8?Q?aS1CmpKPuO+zfZ1icsUX+Dvljbhq/uX/?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:SN7PR12MB8059.namprd12.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(366016)(1800799024)(376014)(7416014); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?NlZ5K08vVXZiZHlPcWlLWUpRR29mL1pibVZYM1NaaDYycFpyTmFKbU94Qlpk?=
 =?utf-8?B?Y0JHOTd3aUVibTFNeml2YTZ2WS9IMnN0MVBEMU1HUzZTdXNqd2F3SGF5djA2?=
 =?utf-8?B?TVphUVQxUTVEYnFpUSs1b0YreGUyN3JsQkRMamloQzArcEZXQ21UQnZNQzEy?=
 =?utf-8?B?ZUJvTWYzSkpvZTI2c3N0S2Rtekg3bTUxcFJob3Y0QmJ5RlViWDV0N3RCNkFO?=
 =?utf-8?B?ZkRFcWs3UDZFME5EK29oYVN0TEdHdHhldmxEMSttRzdVeCtxWjg5c1ZMT3Q5?=
 =?utf-8?B?WGhmNHMyVlI5NnFlQkxFbWN1OHBrVm91YkNuSjlZWUU3bTB5eW9acFZtOGZu?=
 =?utf-8?B?WGFVR2xUZHVPL1Zsd3ZaMTRJcHE4NjdnMEpyZFViZTdwWFJiUkJJVzlwcmVn?=
 =?utf-8?B?dEc4S2VGQUxReWNLWVoyZkFHaTNNK3FqZzA5bWlIUlpsRVNqbk5DNFdhM0pH?=
 =?utf-8?B?M1lONlBLeHkrbXRFc2FaZkRvTi9BK0k1YmxwaFEyVTlNSkdFKzNzeDliYVZX?=
 =?utf-8?B?bm96dm9rQlFDWHQ2Nk9BZDZSZTY3ZDF5UTZUMTYxRncxYS80S0F6UmRmY0kz?=
 =?utf-8?B?dUpobW95SS9MTFdON1k2a1ErUHRLaGJVbEMxWHV6NVRBOEtrbndneXBueVUx?=
 =?utf-8?B?VW9LYTF5TVF6WnUxUW5rMEJ5eUsyMk1HeHNqWHNCbE5UTVN5ZWJwR3VWeUN5?=
 =?utf-8?B?ZXRtWC8rbE9NYTVoaitWYUVyRS9sd09wU21aL3pySU5XWEJoaXN0eGdHMFVK?=
 =?utf-8?B?OVNxaVQ5RlZ6cWY0Vkdvc1l2RW5DV2lFcS91dFlEaXhyY0hZU2h6RjlxdGxo?=
 =?utf-8?B?MHhKYnNiN0poS1BndGRQWWt1b2dnVlR5S25XNklDZHhhcXNualFmcmRKRW1O?=
 =?utf-8?B?TE9laFJ4NktzNDY0TFJPaG13SlpBM2p2Qmx3S2tURjhtckV5RjhSQXNDRk1m?=
 =?utf-8?B?Y2t3Mm1xRS9nR1NZaTNhZk5KYnBjYzc5RnUvWGNnVVplTGFIakpQQ1N5MmlX?=
 =?utf-8?B?dVdqamVscy8rOTh6ZzQvNzhHUTlGQmNLdit4RVhXeldIaEE1UnQ1c2ExbHFW?=
 =?utf-8?B?bTY5ajZhOEh2TjRQSFJpRmNKNVlCNitMYi9KMmhTY2hJWmtIL1hXaWhPZnNW?=
 =?utf-8?B?V0VRL2pFQy9WN1h6b3dFdXIvbHIvSzdUd2hNdDBaSktBMnlFaDBMckl4Rm9K?=
 =?utf-8?B?UDg2dHM5MTR5RitscEZZU0ZUTG9qaFlDSVFwakhSb3hLV2lEOWVmS2hSNWJw?=
 =?utf-8?B?WVUxQUFXUkxWSmY1M0RDN001U1lEdk5Pakw5YkFYQ2t3S2tTaWxoSHk4Yklm?=
 =?utf-8?B?RzU2ZG84bzRZdTJjM1RLNTJ3dENLY3JtV2lGOUVIcnhaRWVtWStObmovTnJO?=
 =?utf-8?B?RU9zb01leWxpN3ZMR09YSnJ3WWJ5bWZvYVhrd3BHSmpxSXRkMWlKUGFUaVdh?=
 =?utf-8?B?VGc2ZVZDOHNIV0dFWnVmZlFLSXVPdGpxLzJKdlJsSGdaSVUzMW92NmljS1FD?=
 =?utf-8?B?K1g3T0RFejBsbmwzZEZBQUNJbGZHeklrSFNyWTZleng1REk2OEdxZVVvUlNj?=
 =?utf-8?B?bWZjSWQwU0JZdkZ1UnVtb0dTZ3JkOEZIbUhXaHNTWXhTVTNpZ1l6UFh2OGtp?=
 =?utf-8?B?TXBlOTIyS3VOWmRPeEtsdktjcmUrU29tTnFCS2RSeTU0ekhaam1wOGtUUmhm?=
 =?utf-8?B?Q1J2L1hIYXBjQUNwY0lobmVWejdya0NhTDRvZUh4clB0cmlNWFgyNlpHMWZt?=
 =?utf-8?B?SkJwT3Z3S2tLTGpNMWNOTUphYU0zZjV4TlovWWNCK1Bhc3NNY252QjBqeEVF?=
 =?utf-8?B?RUpiVGdCdVd6aDNKakg1Um1kdXZSTEZNa2Jlc3NBSjNzdWVwY1VZWFF4RG5y?=
 =?utf-8?B?bUM0NTFvWmpQank2Y2xYQTFwRlkva1dTeW9UZ2JkTkxndDRHdWw3czUzYmJa?=
 =?utf-8?B?RUZnNVptSWMvVXJJbXlHMUJ3MXNrdy8wRlBCeklwZUptRnFnZUJqdUVTa1pW?=
 =?utf-8?B?R2FCeSt4YXpVbStzM0w4cWRObHZSSE5GSEdiaWdMVHh5M0owNDFnVWFxcXBq?=
 =?utf-8?B?Nm1xdjllZU9DMjBYNTNoaHl3MFRVOUhpb3RwTzYrcDBEeC9jeFQwWnNlYmd2?=
 =?utf-8?Q?1Krrh5yST1ViNaOKdf0OSrknL?=
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 1ee8a994-e54d-4935-830d-08de337f8661
X-MS-Exchange-CrossTenant-AuthSource: SN7PR12MB8059.namprd12.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 04 Dec 2025 21:53:14.4724 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 43083d15-7273-40c1-b7db-39efd9ccc17a
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: zFh5PFVPssoS3QzSRrREt/+00xGkKOZjQXaDNYUzHhrUG8cripyKs+ossTIXHk1RnhgCxJWmFjXDBDuHAWvK/g==
...
---
 ...
 33 files changed, 1997 insertions(+), 1800 deletions(-)
...
index 1acfed2f92ef..e2b5a431a3b3 100644
...
index c8b4dd3ea5c3..7b0c19695c8b 100644
--- a/drivers/gpu/drm/amd/amdgpu/amdgpu_ras.c
+++ b/drivers/gpu/drm/amd/amdgpu/amdgpu_ras.c
@@ -5601,7 +5601,7 @@ int amdgpu_ras_add_critical_region(struct amdgpu_device *adev,
...
index f2c92902e4a3..d8445adb507a 100644
...
@@ -1266,27 +29,32 @@ EXPORT_SYMBOL(drm_buddy_block_print);
 /**
...
@@ -1304,22 +72,5 @@ void drm_buddy_print(struct drm_buddy *mm, struct drm_printer *p)
 }
...
index 942345548bc3..2b4987a3ca0f 100644
...
index 3a1eef83190c..87de969a04b2 100644
...
index d7eb6471f2ed..a9c233f982f6 100644
--- a/drivers/gpu/drm/ttm/tests/ttm_mock_manager.c
+++ b/drivers/gpu/drm/ttm/tests/ttm_mock_manager.c
@@ -30,7 +30,7 @@ static int ttm_mock_manager_alloc(struct ttm_resource_manager *man,
 {
...
@@ -46,14 +46,14 @@ static int ttm_mock_manager_alloc(struct ttm_resource_manager *man,
...
+	err = gpu_buddy_alloc_blocks(mm, fpfn, lpfn, alloc_size,
 				     ...
 				     &mock_res->blocks,
 				     mock_res->flags);
@@ -66,7 +66,7 @@ static int ttm_mock_manager_alloc(struct ttm_resource_manager *man,
 	return 0;
...
@@ -78,10 +78,10 @@ static void ttm_mock_manager_free(struct ttm_resource_manager *man,
 {
 	struct ttm_mock_manager *manager = to_mock_mgr(man);
...
@@ -105,7 +105,7 @@ int ttm_mock_manager_init(struct ttm_device *bdev, u32 mem_type, u32 size)
...
+	err = gpu_buddy_init(&manager->mm, size, PAGE_SIZE);
 	...
 	if (err) {
 		kfree(manager);
@@ -141,7 +141,7 @@ void ttm_mock_manager_fini(struct ttm_device *bdev, u32 mem_type)
 	ttm_resource_manager_set_used(man, false);
...
index 7219f6b884b6..0f2a480fda33 100644
...
index 13af589715a7..5b2cec42147a 100644
--- a/drivers/gpu/drm/xe/xe_svm.c
+++ b/drivers/gpu/drm/xe/xe_svm.c
@@ -677,7 +677,7 @@ static u64 block_offset_to_pfn(struct xe_vram_region *vr, u64 offset)
...
@@ -688,16 +688,16 @@ static int xe_svm_populate_devmem_pfn(struct drm_pagemap_devmem *devmem_allocati
...
@@ -864,7 +864,7 @@ static int xe_drm_pagemap_populate_mm(struct drm_pagemap *dpagemap,
...
index c2e05a281252..dbbffad9c402 100644

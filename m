...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C48D3E1E04
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Aug 2021 23:29:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D32BF6EB5E;
...
Subject: Re: [Intel-gfx] [PATCH v5 07/20] drm/panfrost: use scheduler
 dependency tracking

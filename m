...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90D3A13426C
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jan 2020 13:56:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 69D1D6E2CD;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] Fwd: [PATCH] drm/i915: Fix enable OA report logic

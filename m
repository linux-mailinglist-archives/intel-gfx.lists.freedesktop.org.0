...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C8256D919
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Jul 2019 04:35:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A71F6E484;
	Fri, 19 Jul 2019 02:35:32 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH -next] drm/i915/icl: Remove set but not used
 variable 'src_y'

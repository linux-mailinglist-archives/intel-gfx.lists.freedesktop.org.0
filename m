...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 057F320FF26
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:31:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B53A86E49C;
...
Subject: [Intel-gfx] [PATCH 34/59] drm/kmb: Enable MSS_CAM_CLK_CTRL for LCD
 and MIPI

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96A472A422A
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Nov 2020 11:34:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0205F6EC59;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch V3 23/37] sched: Make migrate_disable/enable()
 independent of RT

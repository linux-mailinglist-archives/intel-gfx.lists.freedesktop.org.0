...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id ALTzEckVk2nD1QEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Feb 2026 14:04:09 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD13C1439C8
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Feb 2026 14:04:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DA1310E39F;
	Mon, 16 Feb 2026 13:04:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=nicolas.frattaroli@collabora.com header.b="UMhH9LNh";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com
 [136.143.188.112])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C7E6010E39E;
 Mon, 16 Feb 2026 13:04:05 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1771247035; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=gAYg4ZUYr7k3Jbiy9pkkSq2oWxW3Z5oEnO0pxRx1ypu8NChZAfjUoaRYb4omqF29fTVDv15y+p0m5sfvkbC9Ct0d3TH3gj+3WISKlIP/pP3+LWdTxngX03mIPZZF1SZy6zEjdmRQ4ZWqTqhWS9XKyTsMOialXQjdR8BDufB/kIc=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1771247035;
 h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To;
 bh=Ia0vtBf7Hnezwy6KHM8b1coA0aO+S0F1jHSbeeABSIQ=; 
 b=AR2iARd8GGDFvikcu/jfk2ZMuB2QFurx6mQGmWFQw9X9AGN6lTeSZ0cA4XvLbKo3zBW/Lc3h7xX4H/Wh/z88ehNxvMIKk4am8esfV8/pIN7hhULb9Wjvmq/tSqCwpwup8b0tm+UOQpry4r8tOJTqDri+U7ENQcGEXPaU3YDbbEE=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=nicolas.frattaroli@collabora.com;
 dmarc=pass header.from=<nicolas.frattaroli@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1771247035; 
 s=zohomail; d=collabora.com; i=nicolas.frattaroli@collabora.com;
 h=From:From:Date:Date:Subject:Subject:MIME-Version:Content-Type:Content-Transfer-Encoding:Message-Id:Message-Id:References:In-Reply-To:To:To:Cc:Cc:Reply-To;
 bh=Ia0vtBf7Hnezwy6KHM8b1coA0aO+S0F1jHSbeeABSIQ=;
 b=UMhH9LNhb/aFLJExKEBmp1gOkydYlaEPkf7sI4PbNSiLZrzr1DQUOvMnq0EiltyU
 wvRz7AP9TkTjXTYDQ8v2OlgEk7M/tveblBlQNDq9eKYH6RaYwZHEviEjOFB68iiUH7b
 BN9V7JN5eaa+/f+Aiu6ld4ERhdIbxVudD7ZRgL8k=
Received: by mx.zohomail.com with SMTPS id 1771247033822778.2328575803281;
 Mon, 16 Feb 2026 05:03:53 -0800 (PST)
From: Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
Date: Mon, 16 Feb 2026 14:01:33 +0100
Subject: [PATCH v8 19/20] drm/tests: bridge: Add KUnit tests for bridge
 chain format selection
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260216-color-format-v8-19-5722ce175dd5@collabora.com>
...
DRM_COLOR_FORMAT_ENUM_AUTO, as is the behaviour in the HDMI state
helpers.
...
index 887020141c7f..4e6eade03cd5 100644
...
@@ -508,14 +867,441 @@ static struct kunit_suite drm_bridge_alloc_test_suite = {
...
+
+	conn_state->color_format = DRM_COLOR_FORMAT_ENUM_RGB444;
+
...
+	KUNIT_ASSERT_NOT_ERR_OR_NULL(test, mode);
+
+	conn_state->color_format = DRM_COLOR_FORMAT_ENUM_YCBCR444;
+
+	ret = drm_atomic_set_crtc_for_connector(conn_state, priv->crtc);
+	if (ret == -EDEADLK) {
+		drm_modeset_backoff(&ctx);

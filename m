...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFEA528861E
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Oct 2020 11:42:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 183396EC92;
...
Subject: [Intel-gfx] [PATCH v2 02/12] drm/i915: vgpu shared memory setup for
 pv support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E42E41F3E0
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Oct 2021 19:53:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9E736EEA8;
...
Subject: [Intel-gfx] [PATCH v3 00/10] Move vfio_ccw to the new mdev API

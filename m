...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EBAA9DBAAE
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Nov 2024 16:39:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E561F10ECED;
	Thu, 28 Nov 2024 15:39:42 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ZjRVlT9K";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 53CB210ECF1;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=VdLhB14rDNvbiGvmvyKi6gn9ge/LRE2gzX+cSFbG59E=;
 b=ZjRVlT9KAdM5F8qcNZSHNUZY/hGo4nVHQuwjO0gGoKXVMmT11+5UlClB
 FoUFe+4uGYgSMjZbFBhG2P6Zt2xmbSRtWdLQPLKKdymRzPYjbWHGLc1K/
 OX5hGu3GlzGjtsc7LGGlf1I1Sc2tF7CzbW8LX3nYCCmx0SNu4saZ8jq/H
 1tH0G3n+UMwmr5kXIdBKFULfzdZwHYSWfjbT1XGUJW76BctQPxY1DGEH5
 V7BMIfNzgHtmmuNA9h1O2kAkEdCfybM3M3lsFzHzUv5/oO9BMSQI2Qtlz
 2vdHQC2ab7NEcS6Fz83efQN2cxhsfFTWywJdY3fW0Om25+6+e6cq1iW+B Q==;
X-CSE-ConnectionGUID: LzIiQemqRqiHbKvXfyBFkA==
X-CSE-MsgGUID: EOn4QDuWQ6+KMIOO/5H7kw==
X-IronPort-AV: E=McAfee;i="6700,10204,11270"; a="55538964"
X-IronPort-AV: E=Sophos;i="6.12,192,1728975600"; d="scan'208";a="55538964"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2024 07:38:51 -0800
X-CSE-ConnectionGUID: +Onbqz0SRySXGMD03fxoCQ==
X-CSE-MsgGUID: yfBCk3l/R2+NBi0hRi0qYw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,192,1728975600"; d="scan'208";a="123224867"
...
Subject: [PATCH v2 5/6] drm/i915/display: convert high level power interfaces
 to struct intel_display
Date: Thu, 28 Nov 2024 17:38:23 +0200
Message-Id: <e1761b0fe5081bf6ca21cca3430befe254f61b32.1732808222.git.jani.nikula@intel.com>

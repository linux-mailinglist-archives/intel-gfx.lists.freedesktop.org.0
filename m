...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB51376B371
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 13:39:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BC0910E3F3;
...
Subject: Re: [Intel-gfx] [PATCH v4 19/29] drm/i915/gvt: switch from

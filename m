...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A33E943F567
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Oct 2021 05:28:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A42B6E9BD;
...
Subject: [Intel-gfx] [PATCH v3 05/10] drm/i915: Prepare for multiple gts

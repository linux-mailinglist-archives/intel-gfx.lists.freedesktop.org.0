...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C28192056B4
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Jun 2020 18:02:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE5596E9F6;
...
Subject: Re: [Intel-gfx] [PATCH 4/8] drm/mtk: Use

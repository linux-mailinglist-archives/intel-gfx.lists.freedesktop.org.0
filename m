...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E2D55EFB0D
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 18:39:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6B4310EACC;
	Thu, 29 Sep 2022 16:39:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EC2BF10E625;
 Thu, 29 Sep 2022 16:38:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664469535; x=1696005535;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=YN80Iq4uUXO6xsx3wJZt+fJMHSILL3ZMVfuefGPAa+g=;
 b=NxNzJKBFekUL6pLJ6m3pvtYSDwl9dLFAHNxrpvtIABBrUPV3vpCvdQ7D
 /HtvZ2KgEbKPfH6DIXE18hyvtR/JfQCTdhAE7C6xsj+/QIAnF9GLkbYbz
 Pw69kwzf/jonPKs6Vq+WGX+j4DA6AE3265QHYcLJUbyiESHHSeCFLV657
 PJ5P6o4+uGJiemcsOonJnskQFi206fRuWy33/jm2nYHxd15FM7uhV9vgM
 R2/fFMF7EyP7xwdezM/KAJz7iFwmdgm4RQHpMMm9s6hmbGNKJ3cZH9u7H
 bOxkTs0s+yhNNqIwZUNsfRwXjsznOwqri3FSBAncGcqX5gAFduKK0+1Ca A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="366000039"
X-IronPort-AV: E=Sophos;i="5.93,355,1654585200"; d="scan'208";a="366000039"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2022 09:38:45 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="624635857"
X-IronPort-AV: E=Sophos;i="5.93,355,1654585200"; d="scan'208";a="624635857"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2022 09:38:44 -0700
Date: Thu, 29 Sep 2022 09:38:22 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Matthew Auld <matthew.auld@intel.com>
Message-ID: <20220929163821.GD22224@nvishwa1-DESK>
...
In-Reply-To: <c76337af-73b2-4aef-278e-fa5f665daa97@intel.com>

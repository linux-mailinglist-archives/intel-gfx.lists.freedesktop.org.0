...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B56A3D71A5
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jul 2021 10:56:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 937B06EB27;
	Tue, 27 Jul 2021 08:56:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 608F06E828;
 Tue, 27 Jul 2021 08:56:13 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10057"; a="199627175"
X-IronPort-AV: E=Sophos;i="5.84,272,1620716400"; d="scan'208";a="199627175"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jul 2021 01:56:11 -0700
X-IronPort-AV: E=Sophos;i="5.84,272,1620716400"; d="scan'208";a="437225672"
Received: from jrgrant-mobl.ger.corp.intel.com (HELO [10.213.245.158])
 ([10.213.245.158])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jul 2021 01:56:08 -0700
To: Matthew Brost <matthew.brost@intel.com>
References: <20210624070516.21893-1-matthew.brost@intel.com>
 <20210624070516.21893-32-matthew.brost@intel.com>
 <ae1a6469-e8de-0745-1bb9-2054dd43dc74@linux.intel.com>
 <20210726224815.GA45504@DUT151-ICLU.fm.intel.com>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
Message-ID: <8eed5e3f-6cf2-e4d7-dabb-d31f0ec3f640@linux.intel.com>
Date: Tue, 27 Jul 2021 09:56:06 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.11.0
MIME-Version: 1.0
In-Reply-To: <20210726224815.GA45504@DUT151-ICLU.fm.intel.com>
Content-Language: en-US
Subject: Re: [Intel-gfx] [PATCH 31/47] drm/i915/guc: Reset implementation
...
Don't know, did not do an exhaustive search. I can understand it being 
used to make sure any lock taking sections would exit, if they happened 
to be running simultaneously to the lock cycling code, but you seem to 
be describing it being used as a memory barrier.

So either a code comment or just use a memory barrier is my ask. There 
is a requirement to comment memory barriers anyway so if this is 
effectively one of them it's pretty clear cut.
...
> https://patchwork.freedesktop.org/patch/432408/?series=89844&rev=1
> 
...
Well new bugs are found even after statements of things being well 
tested so I'd err on the side of caution. And I don't mean your code 
here but as a general principle.
...
Yeah, but if that cannot be guaranteed to happen in the same kernel 
release then lets not put dodgy code in.
...
It all boils down to whether something can modify the list in parallel 
in your case. If it can't, just don't take the lock but instead put a 
comment saying why the lock does not need to be taken would be my 
suggestion. That way you avoid having to explain why the iteration is 
not broken.

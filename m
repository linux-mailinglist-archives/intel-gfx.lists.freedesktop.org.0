...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EAF0266E857
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Jan 2023 22:23:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5964110E358;
	Tue, 17 Jan 2023 21:23:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 809F210E358
 for <intel-gfx@lists.freedesktop.org>; Tue, 17 Jan 2023 21:23:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1673990579;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=QeSklMeMSoVeudTQC5ciHBckx9nBB5Aw6Kjov/8/jjI=;
 b=AsI+KyioS9OA3GH9vENmipBW0ATJ+4gZLm9hSwE/48lcHM45heF3E3BKHcIoV3oWnGJElD
 YE1ryvPXz+6JagDjzrspMKQSOCJUTSZjw0sDThP0q8HX1RXXw+gznbw7mwYxdVF6lmjVc1
 PkdBQLpnDIn24a+ogAxWZhhBRiB21yo=
Received: from mail-io1-f71.google.com (mail-io1-f71.google.com
 [209.85.166.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_128_GCM_SHA256) id
 us-mta-520-_6juwVwnP5uLpJz6mT_cUA-1; Tue, 17 Jan 2023 16:22:58 -0500
X-MC-Unique: _6juwVwnP5uLpJz6mT_cUA-1
Received: by mail-io1-f71.google.com with SMTP id
 y24-20020a5ec818000000b006e2c0847835so19994255iol.12
 for <intel-gfx@lists.freedesktop.org>; Tue, 17 Jan 2023 13:22:58 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=QeSklMeMSoVeudTQC5ciHBckx9nBB5Aw6Kjov/8/jjI=;
 b=
X-Gm-Message-State: AFqh2krlGO20CgxM8792vMLsfV3I45ldMFRyOyQqeMaKnsLuZ28raScI
 /TfnRosGMm8e6YVEEbk4EY5z4ndXlUmVUTpjoReJVbOu7kgRmKt/yRTC9q1bF5SUMcAMX+OAFKv
 8thVxe1GpEJ/aTdNXg5qHRIjDUBFp
X-Received: by 2002:a05:6e02:50e:b0:30e:dcfb:6b9d with SMTP id
 d14-20020a056e02050e00b0030edcfb6b9dmr3964153ils.3.1673990576371; 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E809F13C01A
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 13:17:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF2526E957;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 06/21] drm/gma500: Convert to CRTC VBLANK
 callbacks

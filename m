...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F3F35B64CA
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Sep 2022 02:59:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8043310E4EF;
...
Subject: [Intel-gfx] [PATCH v5 14/15] drm/i915/huc: define gsc-compatible
 HuC fw for DG2

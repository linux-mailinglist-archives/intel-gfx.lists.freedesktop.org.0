...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 497107B4679
	for <lists+intel-gfx@lfdr.de>; Sun,  1 Oct 2023 11:11:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 941B010E179;
...
Subject: Re: [Intel-gfx] [PATCH v2 2/2] drm: Replace drm_framebuffer plane
 size functions with its equivalents

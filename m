...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E96646F7D6
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 01:03:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0272F10E156;
	Fri, 10 Dec 2021 00:03:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BF33910E155;
 Fri, 10 Dec 2021 00:03:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1639094591; x=1670630591;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=fISOTeAyjJP76tqV/B0zYM+uMStXo3oznsSyZ5pBkgU=;
 b=EVH3VWbnyTFmPzQGHg9tBNFlKaeTh5NlVBbSAvbrkJmnG4FyJJHNsI9w
 dFtQaR+hpm0DtPgys3Zi3FI4jxf0YmjZL4FRHI38O/dWgZDgxh/TJ4VC5
 3UbEG2nWeAl1wmxw8LkaEHk6RVPoaKNQMKlMNi33VRm6zTRfrcDbVnERy
 nLkimIcjIZp8yhKBGG3nrzC5okuWdR7ahQT4FQnUB4+4b/CcwFN+7Fhaa
 gsWUMRF8gfN2qfjsjYXbut1WAj5f9xrRmcif60lrj3KJA/LLGjefSEiod
 nmo5LRifYlI8voj00oKbXH0Cplt452fBqMEjkjSIsyQvIYzQLkwv2iCTm w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10193"; a="324494586"
X-IronPort-AV: E=Sophos;i="5.88,194,1635231600"; d="scan'208";a="324494586"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Dec 2021 16:02:19 -0800
X-IronPort-AV: E=Sophos;i="5.88,194,1635231600"; d="scan'208";a="516535236"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Dec 2021 16:02:18 -0800
Date: Thu, 9 Dec 2021 16:02:16 -0800
From: Matt Roper <matthew.d.roper@intel.com>
To: Andi Shyti <andi.shyti@linux.intel.com>
Message-ID: <20211210000216.GW2219399@mdroper-desk1.amr.corp.intel.com>
References: <20211209132512.47241-1-andi.shyti@linux.intel.com>
 <20211209132512.47241-10-andi.shyti@linux.intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20211209132512.47241-10-andi.shyti@linux.intel.com>
Subject: Re: [Intel-gfx] [PATCH v6 09/11] drm/i915: Use to_gt() helper

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB9A860A153
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Oct 2022 13:22:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CF6010E4C7;
...
Subject: [Intel-gfx] [PATCH v2 13/21] drm/fb-helper: Rename

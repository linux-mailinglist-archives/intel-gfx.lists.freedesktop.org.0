...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 91444554EEA
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 17:17:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5CE8C1134CB;
	Wed, 22 Jun 2022 15:17:43 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 05/13] drm/edid: add

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B476551D559
	for <lists+intel-gfx@lfdr.de>; Fri,  6 May 2022 12:12:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D71D10FB73;
...
Subject: [Intel-gfx] [PATCH 16/25] drm/edid: convert

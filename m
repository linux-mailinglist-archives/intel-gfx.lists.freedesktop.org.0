...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0E03278CE7
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Sep 2020 17:37:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C7E2E6ED22;
...
Subject: Re: [Intel-gfx] [PATCH 10/11] x86/xen: open code alloc_vm_area in
 arch_gnttab_valloc

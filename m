...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7618F1B8254
	for <lists+intel-gfx@lfdr.de>; Sat, 25 Apr 2020 01:06:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFD916EB6D;
	Fri, 24 Apr 2020 23:06:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 754776EB6D
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Apr 2020 23:06:19 +0000 (UTC)
IronPort-SDR: 9HRX6GWZbhx+Oz3fxv2jOdXhjpKhJD5xzmki1X8+npTr2f8MEpXY4FprVaSNR0dJ9trNIo8K+w
 VqVudPv3FmhA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2020 16:06:19 -0700
IronPort-SDR: N9iecH+BHmnUOmWJyHtjbzHBYaMhYNXUALS35rERO3hZiPa8/mOx4LvvtCJcA+lzdv0KuUadya
 CBo5ojNPIqaA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,313,1583222400"; d="scan'208";a="292807479"
Received: from rosetta.fi.intel.com ([10.237.72.194])
 by orsmga008.jf.intel.com with ESMTP; 24 Apr 2020 16:06:17 -0700
Received: by rosetta.fi.intel.com (Postfix, from userid 1000)
 id F3ED5843AD2; Sat, 25 Apr 2020 02:05:47 +0300 (EEST)
From: Mika Kuoppala <mika.kuoppala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sat, 25 Apr 2020 02:05:46 +0300
Message-Id: <20200424230546.30271-1-mika.kuoppala@linux.intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20200424214841.28076-2-mika.kuoppala@linux.intel.com>
References: <20200424214841.28076-2-mika.kuoppala@linux.intel.com>
...
index c1f30fe12d5d..9056ef35293c 100644

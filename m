...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E1CC81A176F
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Apr 2020 23:38:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 036AD6E902;
	Tue,  7 Apr 2020 21:38:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C29586E902
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Apr 2020 21:38:27 +0000 (UTC)
IronPort-SDR: CRgabIEdcYTq5bYLY9VlqkVrm6y7SS8GZbo2Nyhf4V6JEWSFSPOp8PfnmTT0GnKxa5NwqJi6YT
 FeWVT57W35TQ==
...
IronPort-SDR: bwM6hu8tVq14Y4PfGBUhd4yiv4SosMwuO9kfqZttOKfyEMmqbTb++rJvfL6lpQVi6VdGxmIJuD
 Owg+XNf8dxbw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,356,1580803200"; d="scan'208";a="240081645"
...
Date: Tue,  7 Apr 2020 14:39:55 -0700
Message-Id: <20200407214000.342933-3-jose.souza@intel.com>
X-Mailer: git-send-email 2.26.0
In-Reply-To: <20200407214000.342933-1-jose.souza@intel.com>
References: <20200407214000.342933-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 3/8] drm/i915/display: Split
...
bnRlbF9kaXNwbGF5X3Bvd2VyLmMKaW5kZXggNWE4Yjk0ZDlhMTBmLi4xY2QyNzFkMGYxMTQgMTAw

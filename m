...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 666A54D4984
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Mar 2022 15:41:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6924010E59C;
...
Subject: [Intel-gfx] [v5 4/5] drm/edid: parse HF-EEODB CEA extension block

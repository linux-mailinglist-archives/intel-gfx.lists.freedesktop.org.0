...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE9B752CEC6
	for <lists+intel-gfx@lfdr.de>; Thu, 19 May 2022 10:57:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 833EC11B089;
	Thu, 19 May 2022 08:57:44 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D1A1C11B086;
 Thu, 19 May 2022 08:57:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1652950662; x=1684486662;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=dp+IstLv4PcDn+6BzcYGYwE/2l45TWB6di0X4uWFWi4=;
 b=YilnbrvGpR30SLZH/KzpAJN7lJ+XuD/5lkXnAIIQsPlr4zgp+LI+b+88
 zSVxMcq+8NE5sMFyZh0cAnfrhQo6BcEVCs7NZdsx4GIkL9T560gjYo95Y
 A7dR9vVzp2WA3gNkYxlhwzvSIIj/32evkuD11YfnnqbNEprH7w7aav01k
 g9UZmWDwkoJ+JIjc6oke17iZzpei+RIafVu2Vvfu70ysLMOzl/cRvE1S7
 MQWnEfFYe866Ntms2CsPfVwBh5BsVMG9akIQVbYrA3ah7zy7C+U0oA2Az
 FZZCYrjiR1EYXd08lib+zTzpLhd+AeWjgMpjUvGtCE2FfSN8GCSbR2PZP Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10351"; a="269689982"
X-IronPort-AV: E=Sophos;i="5.91,237,1647327600"; d="scan'208";a="269689982"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 May 2022 01:57:42 -0700
X-IronPort-AV: E=Sophos;i="5.91,237,1647327600"; d="scan'208";a="673903930"
...
Message-Id: <20220519085732.1276255-2-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [CI 2/3] drm/i915/pcode: Extend pcode functions for
 multiple gt's
...
index ed6028fd442d..b47746152d97 100644

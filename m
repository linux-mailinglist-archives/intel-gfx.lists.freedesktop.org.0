...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 632BE7CE0FE
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 17:19:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 65B3510E0BF;
	Wed, 18 Oct 2023 15:19:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EE30B10E3FF
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Oct 2023 15:19:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1697642383; x=1729178383;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=vHKdC1zVtQNiXdW0GRZbI7QgYtXg0I5QFIVGG5gzLDk=;
 b=Hr5BJA3R/CsC3OVZsYuHH4y24qJDOSSBxqCMPj7vIAokLJ9hzkI62dm+
 EgikzkMkc2QUuA+eQiLxD+8WWpyA9N+plMSGz+T/O/8v38aB1ZhK0WB0R
 r+jRM8vkfg7EJk60/yFFEsTNhA/FmogA9dENlgI2jGLrMgJpLxnGAvRgF
 Pv1q8a7jVIJXYnBPSbZ9VdK71L0HbwHkzgp5B+oUzK9dUvE1VzHDRoXKC
 4vrLYghlYq0HPxUAnHciupZjHNeLUIMtMv6GVIKTXLKWQ6iZKd7RZdIOH
 ZgePaaiJqig2x+EUvqnpkpjSAzeSPNIQ4Zmjr1eeNhxJvrPNbTRu5esoO w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10867"; a="376407348"
X-IronPort-AV: E=Sophos;i="6.03,235,1694761200"; d="scan'208";a="376407348"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Oct 2023 08:19:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10867"; a="733210166"
X-IronPort-AV: E=Sophos;i="6.03,235,1694761200"; d="scan'208";a="733210166"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga006.jf.intel.com with SMTP; 18 Oct 2023 08:19:39 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 18 Oct 2023 18:19:38 +0300
Date: Wed, 18 Oct 2023 18:19:38 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jouni =?iso-8859-1?Q?H=F6gander?= <jouni.hogander@intel.com>
Message-ID: <ZS_3itLzYATBtJJp@intel.com>

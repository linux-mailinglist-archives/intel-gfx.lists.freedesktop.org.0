...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A794860A66B
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Oct 2022 14:35:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3644710E4A9;
...
Subject: [Intel-gfx] [PATCH v2 11/16] drm/edid/firmware: rename

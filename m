...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE4578C0806
	for <lists+intel-gfx@lfdr.de>; Thu,  9 May 2024 01:45:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D93A210F015;
	Wed,  8 May 2024 23:45:47 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=linux.microsoft.com header.i=@linux.microsoft.com header.b="e7K/Uh2M";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
 by gabe.freedesktop.org (Postfix) with ESMTP id 98C6F10EFA9;
 Wed,  8 May 2024 23:45:46 +0000 (UTC)
Received: from rrs24-12-35.corp.microsoft.com (unknown [131.107.1.144])
 by linux.microsoft.com (Postfix) with ESMTPSA id 279A12083CB5;
 Wed,  8 May 2024 16:45:46 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 279A12083CB5
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
 s=default; t=1715211946;
 bh=KFrpLKmpuYvbDFVNLMMHQyJZkYBLBp+pvtD5A51cO84=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=e7K/Uh2MHpysp2jVoopYxoU2QV+sWsTVfqbR15Lyn3pxMQTetemV/ytXJcPtdlG1X
 ehoZXzUl0/gdFA4D4X6tLoVcw3B35+xnWG24MG6+9wsrbPhwAJAm8EgJMPIXoGAPOn
 Tdb6GaqiKl+F2EGtpEBnVlFwIMP+PaCQRAdPDxIU=
...
Subject: [PATCH v3 3/6] drm/i915: Make I2C terminology more inclusive
Date: Wed,  8 May 2024 23:43:39 +0000
Message-Id: <20240508234342.2927398-4-eahariha@linux.microsoft.com>
...
index 52bd3576835b6..3d4ecfc9462a9 100644
...
index 2167dbee5eea7..5bfc91f0b563b 100644
...
index c076da75b066e..8d4c8f33f7763 100644
...
index d3e03ed5b79c5..fe9a3c1f00725 100644
...
index 0cd9c183f6212..cb50bf9c211d0 100644
...
index a9f44abfc9fc2..c0d5aae980a88 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D55FA6D3D87
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Apr 2023 08:45:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60D1610E152;
	Mon,  3 Apr 2023 06:45:14 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v8 06/10] drm/i915/hdcp: Retain hdcp_capable
 return codes

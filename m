...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E44E5B928B
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Sep 2022 04:10:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9259610E233;
	Thu, 15 Sep 2022 02:10:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4346C10E233
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=1GG6izM1J0nw7wQd+a36/7tsURAZP9lTHKGCgaE17rI=;
 b=RqceJb1Di0gYB6ByiFELQXA+Lv/YF78Cz/F0oS987z0kOgXX84SNSypl
 /25eAhAad8yVQUMAiDNkEDBDOYI0WpbvRLmdsn9EyUMvcExIknONMg2iU
 5Hkffwzd0+UUsMDJ3IoaqM28JgTTPfyDpcSHkjzkEC4MN0AdEn4zgWU91
 aa3DYIlBUU6EiTiucOQWPQupwyNCzRYhGhzzuuHgnwaG0c/CE2qFzFFkv
 e/6jZhQKf95wCpkXuUTdBevSZj7PXQmL18oZX69Ad73wr4KJJ0Olsu6SL
 XSbuI7/rmko1+p0jmwU+NsF4FJLR5zOLzUQ/CkKwav/S1EX47ms+PU0Yp g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10470"; a="324849103"
X-IronPort-AV: E=Sophos;i="5.93,316,1654585200"; d="scan'208";a="324849103"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2022 19:10:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,316,1654585200"; d="scan'208";a="619518014"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga007.fm.intel.com with ESMTP; 14 Sep 2022 19:10:35 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 14 Sep 2022 19:12:18 -0700
Message-Id: <20220915021218.1412111-2-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH 1/1] drm/i915/guc: Delay disabling guc_id

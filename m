...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 652271D273A
	for <lists+intel-gfx@lfdr.de>; Thu, 14 May 2020 08:08:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DBEDF6EAB0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 14/14] drm/i915/psr: Use new DP VSC SDP

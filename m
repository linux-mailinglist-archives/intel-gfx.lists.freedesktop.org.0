...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED0DC4939A9
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jan 2022 12:38:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 50EEF10EACC;
...
Subject: [Intel-gfx] [PATCH v9 4/6] drm: implement a method to free unused
 pages

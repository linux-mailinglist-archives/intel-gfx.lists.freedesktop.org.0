...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id IIpZLmonlmnxbQIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Feb 2026 21:56:10 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C7120159A4E
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Feb 2026 21:56:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2ADE810E62A;
	Wed, 18 Feb 2026 20:56:08 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=Nvidia.com header.i=@Nvidia.com header.b="Ly+Tuy4v";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from BN1PR04CU002.outbound.protection.outlook.com
 (mail-eastus2azon11010006.outbound.protection.outlook.com [52.101.56.6])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A9BD710E638;
 Wed, 18 Feb 2026 20:56:06 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=6ZMSmN832vbfqnmVPpR66Bay8F6Ujv5C4tQG1twV6eo=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=6ZMSmN832vbfqnmVPpR66Bay8F6Ujv5C4tQG1twV6eo=;
 b=
...
Received: from DS0PR12MB6486.namprd12.prod.outlook.com (2603:10b6:8:c5::21) by
 ...
 15.20.9632.14; Wed, 18 Feb 2026 20:55:43 +0000
...
Subject: [PATCH v10 2/8] gpu: Move DRM buddy allocator one level up (part two)
Date: Wed, 18 Feb 2026 15:55:00 -0500
Message-Id: <20260218205507.689429-3-joelagnelf@nvidia.com>
...
X-ClientProxiedBy: MN0P223CA0008.NAMP223.PROD.OUTLOOK.COM
 (2603:10b6:208:52b::21) To DS0PR12MB6486.namprd12.prod.outlook.com
 (2603:10b6:8:c5::21)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: DS0PR12MB6486:EE_|PH0PR12MB8031:EE_
X-MS-Office365-Filtering-Correlation-Id: 96e55c3d-2dac-41e2-1dd3-08de6f301487
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
 ARA:13230040|366016|7416014|376014|1800799024|921020|13003099007; 
X-Microsoft-Antispam-Message-Info: =?utf-8?B?dzAzYzhCYlZCTDRoRUZVVWhkcStXd3Azd2pLUm1iNkZBd2swUHVabVRSUEhS?=
 =?utf-8?B?a2ROMGZadnhjK3B6Y3c2dW5Tb3pNMVkyWnptbCtpY3dJY0ttUVY2d0czN3c3?=
 =?utf-8?B?S253K3hDQm9zaytJUWJJMncxSFU0MnlKeDlWUHQrTmNWNlRvVGF4L2ZuVGZn?=
 =?utf-8?B?ZGc2dE9LQ3EzazFoNmRpamJOWjZwa2VjcWhGelBHYzRTNDZieE5rUE90OStR?=
 =?utf-8?B?YXNMc0RlY0E1T0xjVndvQndzenV3bjYzWkxTMDA5U2R3aFRhMWZQcTlvSHU4?=
 =?utf-8?B?dVJicTdHa281K3VRT1R3TlVIN2xRTnBaK3NhaWo2dkVBZ28wMm5oaWZNQWVx?=
 =?utf-8?B?ZE9XOE10OUUxYWM0TVZpb0lscDNQditHemtlVk9RZzl4bUFKNTJMZmg3UUEz?=
 =?utf-8?B?Q2hBaFhzbkl2Y2drWExtRFhOakl4SXNrQXJlTnNXTXlNbXFoNmd6NTk3U2tM?=
 =?utf-8?B?SzRBZTdPakFoa3FlYy91dU9CME1nelQvU3QrRjFGVWMrVmJiQTRyQ0d0MWZ5?=
 =?utf-8?B?UjF3dkIwQUN1LzVxekIvOVkzZjJmeEhYMzJva21aWlRjK29kUGZNcGRkL3V6?=
 =?utf-8?B?b2JLS1pCSjUzbGJnekZhMGhtZE5CcTRNWWdMNFlvMFI3TmNTeG1xQkUwejZx?=
 =?utf-8?B?cGdqYzRGOVJDbVBqZGd0Mkx6aHIvRWVVQTFCdW85UTBRR2p2amV4dEJWOC9u?=
 =?utf-8?B?RTBoMm45Y3ZoWUFZMHdWOWVUTnh4QjhPUFFGczltOXdMRXl5Z3BLRS9pWkpp?=
 =?utf-8?B?bGRwU0oycEx6Z2dQN2Z2NDVlck8ybm1KakhLeDlzRlZxNmFhQmVwZHV2Ymx5?=
 =?utf-8?B?UWVCYmJDbm9HWU9JakdJZ2dPakRmWFc4aW9CZTJZODU2VUNHL0JnUlRzQzM5?=
 =?utf-8?B?ZHNqK0lzOVdGU01OTEk0Zk5PUnFaYXFrR29LL0t0UzV5Z3pSY09lbmNmU3Zn?=
 =?utf-8?B?OU9kc1pGbmtLNVpwZU90dm5ibXJrVnl3ZG5YS3MyZHYxYzNSbGR4dkp4bVpP?=
 =?utf-8?B?UEd2enZBa0RnQ1VIeER5dmZtNFBiWnpMaGtBZFRCTXUzdm5XQnVEMnZZaEVJ?=
 =?utf-8?B?L1JWd2hJdGJTb01BZzUwbUtmd2lkcU1BUUptNGF4MWlaSWs1ZXBxNFRHTVE1?=
 ...
 =?utf-8?B?U3RBajJOTXI4S2ZTTlQ0bXpTYWpnZzhwWnZFTGsyK0x5L3BzVWlMT2cwY1p1?=
 =?utf-8?B?STA0ZUFXc2hPUVM4cmhBdXNiRG9wakxrejc4SllHZ3NVOTBJQU5tcDFHSWJC?=
 =?utf-8?B?amp5elFGTlJDQ1c0NnY3VTBnNXdlVy9MaVQvRWJJVVNIaHVxWjRCWVpobGNF?=
 =?utf-8?B?ZE96ZTFwQXRYcUd2dERPOWk5UnJTMmVPWm9TN2xlZzJZaWNuR24vbmhXdTBD?=
 ...
 =?utf-8?B?aTVRV2YyaUphMlpYNytCUkJEVTZWRG03bVEyTWZhSXVYQkd3bnhpUk9GMm04?=
 =?utf-8?B?MVl1UzdxVUk0RERKRkVpRVp3cktIU0hmK21wUlBPeWJjN3VBVkY3bE51L3or?=
 =?utf-8?B?NFRvSWh5ZmhEQ3U5cHJkaU9VSWNGZkNGR3dGUmVhMTRLUnhvTEdIWmRiNUNC?=
 =?utf-8?B?VkYyMFp2enN2cDJxR1hCUjd1dDg1Z28rZHJyNGk0VThRU2lUcFRNbGQvdjFB?=
 =?utf-8?B?QzJQcFBYTkFSK0Q3U0tPVFROMHRkL3RwNnFvV01uNUU1dk41Qm50NGgyK2pY?=
 =?utf-8?B?UWZNNDFuMjRQWGptM2xyOE93VTNjb1VmbEVPNVF6NFVScm4vVzdicEZzdWk4?=
 =?utf-8?B?cCsxNXY2VXMwVGl0R0lteTdLdkgzUlhPVU8xcEpHdWw5aWJkWTlvSGdPeDlI?=
 =?utf-8?B?c3c9PQ==?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DS0PR12MB6486.namprd12.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(366016)(7416014)(376014)(1800799024)(921020)(13003099007);
 DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?elE3c2o2ZlNQZUduSnV6WnJtT0pnRUV0L09wYjU0RHl4YjB0cm0wUEIwbFVM?=
 =?utf-8?B?SjRzc3daUWdESUgyTXdtV2ZtKzV3a3JraEUzT3hrOUdtbHdSNS9aWW9kVkRW?=
 =?utf-8?B?dkRRWkM3RmZJam9lVStLUVgzVy9TU3luVUVDb1lwU1NtWXhXS1VnUTIyeHhw?=
 =?utf-8?B?ZVJMV1ZUZDhyVk4zVW9LcndoRnl6amhtcDdPUVNFcjMxcWlhclZ1em56R3dS?=
 =?utf-8?B?eHR3UzFybmNWOS9Ta2pSQVc2dHlnaldYUFZnY21ZUmpiZ2tFRGNDN0puTVJ2?=
 =?utf-8?B?a1BoWEFjMnBVeXdaYWFWYWcxZGM0SGZYdjAwYVpJRUd5ckdXR3NRYVlkMncx?=
 =?utf-8?B?bUVGRU1vdEQyYWJBSnVQaGNlSTlYNGtNUk81M0NHdHdPRzIvYVdUd3lFRjQ0?=
 =?utf-8?B?VlRmLzhnZHF5OGhXOWZtcFFVaU8rVEtBQ0dQYVNtcjdhMkZnbm5NYnZWdXIr?=
 =?utf-8?B?cC9nd0ZSSXNRSDdZbXRhQ0FBU1VSL1hra3cvV0lpcUN5dnZ3V0RLcEMyUFFv?=
 =?utf-8?B?bWxUZmpEV01xNlpldGJLVUdPZll0RnMzQmU2cWRPenBrSVBPNGRqUEh3dzdm?=
 =?utf-8?B?Ny9pSTNvSnVnNnIzTEdCNzkvNmdUdGowc0gzN3pTRlkyb0FlMkFRN09URHA5?=
 =?utf-8?B?WmEvWkFtWENBVmhWS1R6Y0NFRXNzUGZ2YVJRdEpMek9Tdm5STlY2ZkFnQWhx?=
 =?utf-8?B?TzBPSUovamZINEI1QTdlL0FUK0xqbWtQZS9rRmlUZVpMVm43SHJXeDRCaU1P?=
 ...
 =?utf-8?B?bDdHTkZWZ29YSGh0SFNUNitQVzdscWxwUG1BTVJJd1VMNFVxMTV4dWwzM08x?=
 =?utf-8?B?cXJuSG92dW5SU2dxaTRGOVBSQUhmWGh5M2VQZCs4U1dSeXQ5NmhsandTZFIx?=
 =?utf-8?B?VHFyM2JLcUoxNEc1TW1rcmlQYUh1WWdaVVJJS1J5N3o0MVN1MTZxKzNuRWlL?=
 =?utf-8?B?VEk0NzJvUWlzMlM5KzJxR0J3ZHhmNUgxZmVsV0tjRmViQkVsV0dvS3NRNk5t?=
 =?utf-8?B?c3RMYmkraFU0WGpYZ0NManhyRjRubWhTYW15VFRwZUZ1cG0rV1grQTV5cDZl?=
 ...
 =?utf-8?B?U0NZV0FJZGt2V3BqZm9YRUd6WVhNd3ppS3Ava3VhUWNDRis0UTFDSmpzMlR3?=
 =?utf-8?B?V2RQTkxFdTcrYVFBcFY2VENJK0t3MjRnOGNVdHFHK2RiaFdCZW5OMDBUanUr?=
 =?utf-8?B?N1JZRE1uZ2pBSnA0NXMvL0haSmhNOVk0cVRlbGRublBJVEZJQ2FrWlZFYlZv?=
 =?utf-8?B?NHBsMnY4L05aUDNGSVlhYXBMQkpNNEd2b210Q1NWSitsZ04rZGl2TXVHQlcz?=
 =?utf-8?B?SEVBcExxZC9RREdCQjk2c0srdDhjV0RvMW9GWXpSanM0TkVWdCt0VW9JY1FC?=
 =?utf-8?B?T2U4YllKRUNJU1lNUE5DS0tTNFdwNFpHOHJ2Y3kyaExyc3FDc01YVEc1MHlS?=
 =?utf-8?B?dzVaOVUzMjE5c0ROamYxc2ZraEVaWStIcmg4RkhLNnlnZ05LenpYc3AzVEFG?=
 =?utf-8?B?VHUvS0gzc1o5VE9URXI3RytzOUtaSnU3Vkt5RTdHMm9BMExuREwrclJQNkJn?=
 =?utf-8?B?V3FmVGdYQWlQcmU1YVJoWlcxQmpNOU1QcytnK0hERFZ4U1RlNjFURERYN3hU?=
 =?utf-8?B?QmJHdi8wR1FnRnhDeDdqdzFkUng2OFFmMjZxbFpnUFZuWVRRWkhjUFdNT0sv?=
 =?utf-8?B?NVBJNDJ6T0ZXYTNnNnQzUFBmYURVNWRkQWEvdk1nN0RpcGI1akFueklYZUlN?=
 =?utf-8?B?NmpRb2grVSs4cThwRSsrRHhNYkJDSlBTU2cxQkZIbllsZWJNTmRmSVRSRFJW?=
 =?utf-8?B?ZWVRVndIdlFOOVJuclNEaGtndU91UVVpQWJIdDdHTFo0QTJDTXV1ZkNuK2xS?=
 =?utf-8?B?MmF0ZkVsTHhIa3VjNW5PdEt5cTJIVFhIRWpRM3hBSlpNQTFYQTVOQk96VnNI?=
 =?utf-8?B?Sm53c09NT1hJZHZOUEpNUWdIdUZLUjFSNEpveng1dVFUUFh0V3REZz09?=
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 96e55c3d-2dac-41e2-1dd3-08de6f301487
X-MS-Exchange-CrossTenant-AuthSource: DS0PR12MB6486.namprd12.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Feb 2026 20:55:42.9667 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 43083d15-7273-40c1-b7db-39efd9ccc17a
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: LwJwhj+P4SrbgavrG6PZ4ZA1lpcgoLOOO/TBZPP5YR2P5RjQ9/1na6jhjV9KTIdUh82wSucr2EVhUZsp6Xynow==
...
X-Spamd-Result: default: False [-1.31 / 15.00];
	...
	FREEMAIL_TO(0.00)[vger.kernel.org,gmail.com,ffwll.ch,linux.intel.com,kernel.org,suse.de,lwn.net,linuxfoundation.org,intel.com,amd.com,ursulin.net,gmx.de];
	MIME_TRACE(0.00)[0:+];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[amd.com:email,lists.freedesktop.org:email,nvidia.com:mid,nvidia.com:email,intel.com:email,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,Nvidia.com:dkim,gitlab.freedesktop.org:url]
X-Rspamd-Queue-Id: C7120159A4E

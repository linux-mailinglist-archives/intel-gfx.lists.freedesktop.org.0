...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F9A6E8563
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Oct 2019 11:20:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 93AD76EB2F;
	Tue, 29 Oct 2019 10:20:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3653D6EB2F;
 Tue, 29 Oct 2019 10:20:52 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga101.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 29 Oct 2019 03:20:52 -0700
X-IronPort-AV: E=Sophos;i="5.68,243,1569308400"; d="scan'208";a="202798052"
...
Message-Id: <20191029102036.6326-2-janusz.krzysztofik@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RESUBMIT PATCH v2 1/2] drm/i915: Fix
 i915_inject_load_error() name to read *_probe_*
...

...
X2h1Yy5jCmluZGV4IDhiZTUxNWM4ZDBmMC4uMzJhMDY5ODQxYzE0IDEwMDY0NAotLS0gYS9kcml2
ZXJzL2dwdS9kcm0vaTkxNS9ndC91Yy9pbnRlbF9odWMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC91Yy9pbnRlbF9odWMuYwpAQCAtNjMsNyArNjMsNyBAQCBzdGF0aWMgaW50IGludGVs
...
OwogCWlmIChlcnIpCiAJCXJldHVybiBlcnI7CiAKQEAgLTE2MSw3ICsxNjEsNyBAQCBpbnQgaW50
...
L2dwdS9kcm0vaTkxNS9ndC91Yy9pbnRlbF91Yy5jCmluZGV4IDNmZGJjOTM1ZDE1NS4uNjI5YjE5
Mzc3YTI5IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC91Yy9pbnRlbF91Yy5j
...
dHVybiByZXQ7CiAKQEAgLTM3Miw3ICszNzIsNyBAQCBzdGF0aWMgaW50IHVjX2luaXRfd29wY20o
...
IGJiNDg4OWQyMzQ2ZC4uMjZiZWNjZmYwOTA4IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC91Yy9pbnRlbF91Y19mdy5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L3Vj
L2ludGVsX3VjX2Z3LmMKQEAgLTIyMCwyOSArMjIwLDMxIEBAIHN0YXRpYyB2b2lkIF9fZm9yY2Vf
...
LTI3MSw3ICsyNzMsNyBAQCBpbnQgaW50ZWxfdWNfZndfZmV0Y2goc3RydWN0IGludGVsX3VjX2Z3
...
cmV0dXJuIGVycjsKIApAQCAtNDMyLDcgKzQzNCw3IEBAIHN0YXRpYyBpbnQgdWNfZndfeGZlcihz
...
RVRJTUVET1VUKTsKIAlpZiAocmV0KQogCQlyZXR1cm4gcmV0OwogCkBAIC00OTMsNyArNDk1LDcg
...
bS5jCmluZGV4IDMxOWU5NmQ4MzNmYS4uYzljMjEzNWU4ZjhjIDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVf
Z2VtLmMKQEAgLTEzMDEsMTEgKzEzMDEsMTEgQEAgaW50IGk5MTVfZ2VtX2luaXQoc3RydWN0IGRy
...
ZXggMDJlOTY5YjY0NTA1Li5hYmU4MWRkZGUyMGUgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
...


...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B324A9979B
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Apr 2025 20:16:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D85C10E714;
	Wed, 23 Apr 2025 18:16:01 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=mark.filion@collabora.com header.b="I7ddbSQk";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-op-o16.zoho.com (sender4-op-o16.zoho.com
 [136.143.188.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F082B10E23A
 for <intel-gfx@lists.freedesktop.org>; Wed, 23 Apr 2025 18:15:59 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1745432158; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=FK/ents2ZQzfANPrUnTTBef4JyFmIxz/r60MkcQeFgaXnNl0tnHoVrqkdh9ltzokE95tPPYhANG6sUTbRYt2kHm9N5TM8kP6B0991N3gQfVDWZ7Md070SceusGzexf+DPrPA7eYu1lsg4OLxwJC8kHCyo825vP6atFGVJHE3eps=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1745432158;
 h=Content-Type:Date:Date:From:From:MIME-Version:Message-ID:Subject:Subject:To:To:Message-Id:Reply-To:Cc;
 bh=X4SkupaIw4uJhEzzBYffcsmXCIWgDuoYcbtQ3zCY7Oo=; 
 b=LtdIsiHNlRGQyO4MEGmn27useQy/ZfHiTrBNeAgAA/kqDwvE1GkBXvbB+H13rebN8pFSlEoiSiVZ9zT6eGXtHdOMYVvxO1EppF5DQCvpcx7TVzkwX1iF/nE2QEWMf3yj0vZsjZUWuk9YNxC7WPijcegifKFv3gQbb9e643tQiTA=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=mark.filion@collabora.com;
 dmarc=pass header.from=<mark.filion@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1745432158; 
 s=zohomail; d=collabora.com; i=mark.filion@collabora.com;
 h=Message-ID:Subject:Subject:From:From:To:To:Date:Date:Content-Type:MIME-Version:Message-Id:Reply-To:Cc;
 bh=X4SkupaIw4uJhEzzBYffcsmXCIWgDuoYcbtQ3zCY7Oo=;
 b=I7ddbSQkeS9thSCq+llWpe9Si8/w+W826YnDlRNCfzLWoGJvWDoUAkNCByssNRUw
 gRcqPDVYudR7TbG4qOJuqhSDmnJh2bdfsj0GriMw7jEdh+xHVjOdOlhgXALq0mrISJB
 ejhWzm/nVsKx3CJ7c6Zl97IL9QIigN9/gwSMelj0=
Received: by mx.zohomail.com with SMTPS id 1745432157360357.27398977801204;
 Wed, 23 Apr 2025 11:15:57 -0700 (PDT)
Message-ID: <ecd95eac5124e3d9a5969dcdb20ad4580d09c2fe.camel@collabora.com>
Subject: Announcement: 2025 X.Org Foundation Election Candidates
From: Mark Filion <mark.filion@collabora.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 23 Apr 2025 14:15:56 -0400
Content-Type: multipart/alternative; boundary="=-LSMi6F+wGJImLKDowIDk"

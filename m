...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 39C8D24368C
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Aug 2020 10:37:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49B796E994;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/20] drm/nouveau: Introduce GEM object
 functions

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C07253970DF
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Jun 2021 12:06:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 799946E9C5;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/9] drm/i915/xelpd: Define color lut range
 structure

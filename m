...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41D0869E495
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Feb 2023 17:27:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCFE510E87C;
...
Subject: Re: [Intel-gfx] [PATCH 1/4] drm/displayid: add
 displayid_get_header() and check bounds better

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28EB451D537
	for <lists+intel-gfx@lfdr.de>; Fri,  6 May 2022 12:10:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6754610F8F6;
...
Subject: [Intel-gfx] [PATCH 00/25] drm/edid: introduce struct drm_edid

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 644E52D3BE3
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Dec 2020 08:03:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 026DD6E116;
	Wed,  9 Dec 2020 07:03:49 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 58B2E6E10C
 for <Intel-gfx@lists.freedesktop.org>; Wed,  9 Dec 2020 07:03:42 +0000 (UTC)
IronPort-SDR: FdJA1Cnuz8VzU6lsoX7EoiNKF9mGbhkUpZdpcoi/Q5Uor+iW010oLFQ37zYLNYXccJEO9vMoeQ
 EJcasXEcpKWQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9829"; a="238134530"
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="238134530"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2020 23:03:40 -0800
IronPort-SDR: rFSzZXQNAeb9ndY42qfySzSZDzS7KH7uDRiBSBIjSS3ptl+DOH2nAqhb9S+JO8cz6NBoPp9u6z
 YeUXiHuXUWfw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="368074100"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga004.fm.intel.com with ESMTP; 08 Dec 2020 23:03:40 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Tue,  8 Dec 2020 23:02:57 -0800
Message-Id: <20201209070307.2304-4-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201209070307.2304-1-sean.z.huang@intel.com>
References: <20201209070307.2304-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v3 03/13] drm/i915/pxp: Implement funcs to create
 the TEE channel

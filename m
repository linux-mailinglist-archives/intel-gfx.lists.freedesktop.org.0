...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20A4164B021
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Dec 2022 08:03:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD3D410E2C8;
	Tue, 13 Dec 2022 07:03:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C7B2210E2C8
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 Dec 2022 07:03:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670914986; x=1702450986;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Rxy3l081PMlXOc5zlcfbgfm4hPojxBm6Ur9Ayljtm/0=;
 b=KcfeF/cg8/dvqD70g1mzPWGlLId03LAVQ1FpGK1QQhwxUIFCs/Frg+wK
 qKMCMNbdPI/fmqrq45SiFOn9G1ULOfCndm2t9C4sl6BxtObZQPjYAM6FV
 n2d2dlfB9qUNOcyk24zI+MDrOvNMblvNOiJBykPhBaBtNBqEgPJ0/aUlW
 6fsW/EB8+uavQHwq3Kvb8VPjTnXGrEgweVZxapJB9lt2+dq8iFPxfoXAd
 8z/6bFXzjvB/ES58/oVjuaLKB1XJbBJnmhlOUNkOcrAQt9T2qKJ/EcYkC
 uHkccjPpwK46s1lyfLTM7y01qO0mzv6NzDJutoX1sk3cxAMssgwcYg0hb A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10559"; a="404319164"
X-IronPort-AV: E=Sophos;i="5.96,240,1665471600"; d="scan'208";a="404319164"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Dec 2022 23:03:06 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10559"; a="977347023"
X-IronPort-AV: E=Sophos;i="5.96,240,1665471600"; d="scan'208";a="977347023"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga005.fm.intel.com with ESMTP; 12 Dec 2022 23:03:04 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 13 Dec 2022 12:31:54 +0530
Message-Id: <20221213070158.2621403-4-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 3/7] drm/i915/hdcp: HDCP2.x Refactoring to
 agnotic cp f/w

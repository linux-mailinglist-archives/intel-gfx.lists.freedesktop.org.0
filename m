...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F2F116F14D3
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 11:59:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76FEE10E3B6;
	Fri, 28 Apr 2023 09:59:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0906610E3B6
 for <intel-gfx@lists.freedesktop.org>; Fri, 28 Apr 2023 09:59:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682675991; x=1714211991;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=A3Rq/944kpIrRMlu+XiiKP8Rgi5SxcOzPNiwfEViCnM=;
 b=ZD4zAScgfVM8OYMyoiwptykiV/kXRkETJAJEJj9pjvw9iYXhLwB/Ef2P
 wySQpueC3cJAkGj2X4AP+7IsFhmrh2/1Nb5hQBl/fJskaY+RJ+OI1y015
 4f1Zm2iO4QEmJwekz9ERvacqxW2QDmnf/UioDvcO8Bqrt9MhKerNa6GA9
 Wqttd8QJSEzw7G/JTHKo1lBj1Qn8phVfS1t/GgqDXXyPMwjwVuU/jncop
 2NB68sI9X8p6/7qLtWHuacziRw4neEs+aqMdhz4+uez6m7TM3lE9FfFBy
 MgZglnGePNzAN5N5EZfSw8oA5AO34yAcdC4Il0Ft3l6zFN6IEo25pMAVd A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="375698218"
X-IronPort-AV: E=Sophos;i="5.99,234,1677571200"; d="scan'208";a="375698218"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Apr 2023 02:59:51 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="725295766"
X-IronPort-AV: E=Sophos;i="5.99,234,1677571200"; d="scan'208";a="725295766"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by orsmga008.jf.intel.com with ESMTP; 28 Apr 2023 02:59:50 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 28 Apr 2023 12:54:30 +0300
Message-Id: <20230428095433.4109054-11-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 10/13] drm/i915/mtl: Power up TCSS

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E0EA296B09
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Oct 2020 10:17:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D96B6E4D4;
	Fri, 23 Oct 2020 08:17:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 784DE6E4D4;
 Fri, 23 Oct 2020 08:17:29 +0000 (UTC)
IronPort-SDR: BTBV38jEvPOyxAGZMqFKfbP+XoABKxdRGvceUpgz9yNoW6R7WcqnwcjhVeXv70cDilrUYU3caa
 aT6JanNafTPQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9782"; a="185341216"
X-IronPort-AV: E=Sophos;i="5.77,407,1596524400"; d="scan'208";a="185341216"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Oct 2020 01:17:23 -0700
IronPort-SDR: UpDtxQ00iYLZC1TlWKQ7fILAp3U1ScjMy1jaj5eSkusVBw1qwfxsLFsr8ORpRZnfCTZnViLPrz
 p34UuniYDSNQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,407,1596524400"; d="scan'208";a="317015978"
Received: from unknown (HELO coxu-arch-shz.sh.intel.com) ([10.239.160.21])
 by orsmga003.jf.intel.com with ESMTP; 23 Oct 2020 01:17:21 -0700
From: Colin Xu <colin.xu@intel.com>
To: zhenyuw@linux.intel.com
Date: Fri, 23 Oct 2020 16:17:19 +0800
Message-Id: <20201023081719.772816-1-colin.xu@intel.com>
X-Mailer: git-send-email 2.29.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 1/2] drm/i915/gvt: Save/restore HW status to

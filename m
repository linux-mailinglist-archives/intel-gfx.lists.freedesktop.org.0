...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B78DF4E73ED
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Mar 2022 14:06:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C94C110E754;
...
Subject: Re: [Intel-gfx] [PATCH 3/9] drm/edid: use struct detailed_timing

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 172BF4A3FF9
	for <lists+intel-gfx@lfdr.de>; Mon, 31 Jan 2022 11:19:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 442A110E3BF;
...
Subject: Re: [Intel-gfx] [PATCH 3/5] drm/i915: More gt idling time with guc
 submission

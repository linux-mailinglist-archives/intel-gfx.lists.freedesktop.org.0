...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A1C4163F4A1
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Dec 2022 16:58:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5958310E635;
	Thu,  1 Dec 2022 15:58:45 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5] drm: Optimise for continuous memory
 allocation

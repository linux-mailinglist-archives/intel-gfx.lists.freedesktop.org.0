...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDFF7624112
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Nov 2022 12:10:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D73C10E73D;
...
Subject: [Intel-gfx] [PATCH v8 23/24] drm/vc4: vec: Add support for more
 analog TV standards

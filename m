...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3465D21FF67
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FAB36EA17;
...
Subject: [Intel-gfx] [PATCH v2 48/59] drm/kmb: SWAP R and B LCD Layer order

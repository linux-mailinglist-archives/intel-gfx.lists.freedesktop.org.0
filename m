...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9657C5F57EC
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Oct 2022 18:00:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EED2610E6C7;
	Wed,  5 Oct 2022 16:00:16 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 2/2] drm/i915/slpc: Update the frequency
 debugfs

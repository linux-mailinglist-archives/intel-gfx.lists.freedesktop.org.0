...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C29775B8C06
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Sep 2022 17:37:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2667710E042;
	Wed, 14 Sep 2022 15:37:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2DE3110E042
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Sep 2022 15:37:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663169844; x=1694705844;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=+3YEZ1CJsxPDkUQxxuUjgbTKs7QhGDJVqWthy374EH4=;
 b=OFda+9Uu7xDQzR3g8uXL84XmkF/6JSV6oo44YhTDw8pUMg1FQ/3Cghnj
 lQUki5SZVm4KfEPWN83mtf3l7VG0teyPXIvCASkZSPohRPwbzaspxj6Zi
 AcqpidH51qOhwzrZw0/I4macQYs0WNP16IBjEVa731aMFXuAepEFyvts4
 K2ap3SvQsGvTZF6Wd9RChEaa9uRiSY/26GB+HLxOZrtVLHLoseCLzOe4G
 /am0xv1xpSQXrZ2xaeXAJBgtKLlrIfC9VmxPbMpuMa+Ji8N9GsuWTcChS
 2L53PiiXZJrU4NkEUG/cIqtW1KKgucHpiBaRrLrXJirm9cWeKTDPpI6H4 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10470"; a="278188645"
X-IronPort-AV: E=Sophos;i="5.93,315,1654585200"; d="scan'208";a="278188645"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2022 08:37:23 -0700
X-IronPort-AV: E=Sophos;i="5.93,315,1654585200"; d="scan'208";a="568053907"
Received: from boreilly-mobl.ger.corp.intel.com (HELO [10.213.218.89])
 ([10.213.218.89])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2022 08:37:21 -0700
Message-ID: <d338517e-853e-98a5-1e24-59f43f2ac212@linux.intel.com>
Date: Wed, 14 Sep 2022 16:37:19 +0100
MIME-Version: 1.0

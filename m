...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C94FD53C00A
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Jun 2022 22:48:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C42041136F5;
	Thu,  2 Jun 2022 20:48:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 783D71136F5;
 Thu,  2 Jun 2022 20:48:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654202936; x=1685738936;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=q+a3jmMqmEBjjQY87Jea5Ey1oEgb8Sa/AGpnsu6MxBE=;
 b=F1FNf0TDDnxLsePxfyW27gq+PK3vMS/qpIopVHPEse2B0vFOT/IbS6eg
 ZHWKQQrd+gd9XqRZRd/urfLdPgQ9Z9pPmO4SGtS+oqHKBsaNpGQ+O4g+2
 hajj++l0nSN5ooXl+XYsUGaGed6QqA9hn3Gqvx0FL1pf7EU1KyjZDk9Eh
 ob1RbBjX8I50I2HMGvPOCtr7NFisJDbxZwIUqzZZwlCGyLOIPbhYfStKP
 /yY66OWs6ff/WSd9Sma9a6R5sbRO3myIDY6whvJxIbBEUvMUsmNuYDFJJ
 UrO6CrGwGE76veKpDp/fhpD0DnMlDLBRnjIyuXX8WKiDIObZ9BWPYCNUE w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10366"; a="336734009"
X-IronPort-AV: E=Sophos;i="5.91,272,1647327600"; d="scan'208";a="336734009"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jun 2022 13:48:55 -0700
X-IronPort-AV: E=Sophos;i="5.91,272,1647327600"; d="scan'208";a="680837125"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jun 2022 13:48:55 -0700
Date: Thu, 2 Jun 2022 13:48:37 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: "Zeng, Oak" <oak.zeng@intel.com>
Message-ID: <20220602204836.GS4461@nvishwa1-DESK>
...
In-Reply-To: <BN6PR11MB1633EE43D5B3711AC766974192DE9@BN6PR11MB1633.namprd11.prod.outlook.com>

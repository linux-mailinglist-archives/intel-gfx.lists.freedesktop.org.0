...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 274EB39A65B
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jun 2021 18:55:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67CBB6F4D9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 3/7] drm/i915/gem: replace IS_GEN and friends
 with GRAPHICS_VER

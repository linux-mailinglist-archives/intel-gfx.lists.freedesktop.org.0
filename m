...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BD96770D604
	for <lists+intel-gfx@lfdr.de>; Tue, 23 May 2023 09:51:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A2D710E3E4;
	Tue, 23 May 2023 07:51:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5331210E3DA;
 Tue, 23 May 2023 07:51:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684828274; x=1716364274;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=h5oe/SVCsipDdmRFHJD9smaFGrT78WS4yhwWEkIVOFU=;
 b=YjQK1L9orGrDhKsiX28kBISMGt7zbTvTQWSOew3IsBh7OsmWWioQdVkm
 7akjILFifSXcIrM5RWaeh5Cw/ktSHm72PXqSTVf/ilUNuDsbcZLdWCSKy
 eoFGkBiu8fyhITDbt2g2+0iL9k+DRyspae/u0a/EeXvZFYmobLAuNrx6+
 FkYzPD3/7mKd+1zi+q/k5B13nBsNr6zv6rk54o8qkvcSfJkhI3zGMItwR
 9QeUKUSiZ+oGg0TFCUv+aG4xNYUhsNZKY/gq8eUGDJBubXMJho0A2GnGM
 kaL0UJhw9ELz0B5DcUE9kWYyTp1MR55HwW1Hl2k4fGWkwjUmfm8n595ti A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="416628719"
X-IronPort-AV: E=Sophos;i="6.00,185,1681196400"; d="scan'208";a="416628719"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2023 00:51:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="681296173"
X-IronPort-AV: E=Sophos;i="6.00,185,1681196400"; d="scan'208";a="681296173"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.31.10])
 ([10.213.31.10])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2023 00:51:12 -0700
Message-ID: <c3501964-b8ac-5b88-0fd4-7f48d5fde4ed@intel.com>
Date: Tue, 23 May 2023 09:51:10 +0200
MIME-Version: 1.0
...
Subject: Re: [Intel-gfx] [PATCH v2 4/6] drm/i915/display: Make display

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 03C1E67C117
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Jan 2023 00:43:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A0B1610E3AC;
...
Subject: Re: [Intel-gfx] [PATCH v2 2/3] drm/i915/mtl: Correct implementation
 of Wa_18018781329

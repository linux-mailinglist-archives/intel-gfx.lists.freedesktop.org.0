...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 410644FC438
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 20:38:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F3AD10E1FD;
...
Subject: Re: [Intel-gfx] [PATCH 26/34] drm/i915/gvt: pass a struct
 intel_vgpu to the vfio read/write helpers

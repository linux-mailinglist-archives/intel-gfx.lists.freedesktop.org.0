...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EECC5A4DE4
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:25:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29A8110F2CA;
...
Subject: [Intel-gfx] [PATCH v2 17/41] drm/connector: Add pixel clock to
 cmdline mode

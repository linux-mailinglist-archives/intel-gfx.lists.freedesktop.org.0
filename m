...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 856E265EB7B
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Jan 2023 14:00:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 13CB410E726;
	Thu,  5 Jan 2023 13:00:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1267010E726
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Jan 2023 13:00:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672923614; x=1704459614;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=VbgMHUTUG5KFUD59ODOaodcjJt5tLl1G7p9q45lGgls=;
 b=g5pFVldHxCXBfZ5z8LVBgfe/TQfZxAmVfJXSD1MQ7qMgC95amQwPdfaz
 z6YnSGTkc6KnaPiu2VZXHdPT3pvJ2eAp6vGdvbse767ZLoghhhrtQdSAf
 svDoKq6979GZibyIar5fTn+AZ0R3SBEdc0S4TW4gw9nxRi1tWDEMweR/+
 x4pZsIHuoiaLpyDIU2VvnjuACdlxgc1n0RoN5JPu9mcbNzsxX38aKuVEL
 g3lmmWW2FYuGhsVvx1l+uylG3fbruLp8mzB7wDeZWrZXTZX8TPXzPk8Ky
 8VHsyzGYlyNKcRS8itsvjiIgw/6O36AaAZWPJxYfbtIkN7oLSFDXIYZFL g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="305697919"
X-IronPort-AV: E=Sophos;i="5.96,303,1665471600"; d="scan'208";a="305697919"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jan 2023 05:00:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="829541319"
X-IronPort-AV: E=Sophos;i="5.96,303,1665471600"; d="scan'208";a="829541319"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by orsmga005.jf.intel.com with ESMTP; 05 Jan 2023 05:00:11 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Jan 2023 14:54:42 +0200
Message-Id: <20230105125446.960504-18-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 17/21] drm/i915/mtl: MTL PICA hotplug
 detection

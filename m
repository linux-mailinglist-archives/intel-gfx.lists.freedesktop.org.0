...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DCF7642A1F
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Dec 2022 15:11:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5370710E23C;
	Mon,  5 Dec 2022 14:11:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 276C610E210
 for <intel-gfx@lists.freedesktop.org>; Mon,  5 Dec 2022 14:11:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670249498; x=1701785498;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=POOZB7GyR1WNIg7yrjzWaaRw67i7ZTGqXpdCyqKAl1k=;
 b=nM6VL2Kgf1f9eAccP7RKk2ldVsuXZzzVS/7UFApRlBvTClrzc31e0F7i
 tMlJCR3Vk5yBILk1mui/rJFHne34nh+vYy3hMh4Sdu9CIfX9cE7W1fkAR
 qhem9HryLyl5l+m9SYd6RschIC8H18GdUseST+6xa7y1OL84EMV/O87RM
 /kwdROH5Xaq6iBmvVSh/pDuw8XPUweGJuE4lGpOq8HDbGR+X2VUL1wMbR
 w14FQ8ZXsFqe1R4ExmWCOGd+P5mUt0ZgDS1vszr9/yYuvGwKbHUkFG+AZ
 b7bSCJ9lqtA4BPd/k4lj3ce8mFNIzgkoXACh7GyxAFXROlBB2WJu43fER w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10551"; a="296051731"
X-IronPort-AV: E=Sophos;i="5.96,219,1665471600"; d="scan'208";a="296051731"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Dec 2022 06:11:37 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10552"; a="752202338"
X-IronPort-AV: E=Sophos;i="5.96,219,1665471600"; d="scan'208";a="752202338"
Received: from akramiss-mobl1.amr.corp.intel.com (HELO localhost)
 ([10.252.54.203])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Dec 2022 06:11:35 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  5 Dec 2022 16:11:16 +0200
Message-Id: <eff76c08acb7794d3ef34b64116141b665bbb9e8.1670249413.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 3/5] drm/i915/backlight: mass rename dev_priv to
 i915
...
+	val = intel_de_read(i915, BLC_PWM_CTL(i915)) & BACKLIGHT_DUTY_CYCLE_MASK;
...
+	tmp = intel_de_read(i915, BLC_PWM_CTL(i915)) & ~mask;
+	intel_de_write(i915, BLC_PWM_CTL(i915), tmp | level);
 }
...
+	tmp = intel_de_read(i915, BLC_PWM_CTL2(i915));
+	intel_de_write(i915, BLC_PWM_CTL2(i915), tmp & ~BLM_PWM_ENABLE);
 }
...
+	intel_de_write(i915, BLC_PWM_CTL(i915), ctl);
+	intel_de_posting_read(i915, BLC_PWM_CTL(i915));
...
+		intel_de_write(i915, BLC_HIST_CTL(i915), BLM_HISTOGRAM_ENABLE);
 }
...
+	ctl2 = intel_de_read(i915, BLC_PWM_CTL2(i915));
 	if (ctl2 & BLM_PWM_ENABLE) {
-		drm_dbg_kms(&dev_priv->drm, "backlight already enabled\n");
+		drm_dbg_kms(&i915->drm, "backlight already enabled\n");
 		ctl2 &= ~BLM_PWM_ENABLE;
-		intel_de_write(dev_priv, BLC_PWM_CTL2(dev_priv), ctl2);
+		intel_de_write(i915, BLC_PWM_CTL2(i915), ctl2);
 	}
...
+	intel_de_write(i915, BLC_PWM_CTL2(i915), ctl2);
+	intel_de_posting_read(i915, BLC_PWM_CTL2(i915));
+	intel_de_write(i915, BLC_PWM_CTL2(i915), ctl2 | BLM_PWM_ENABLE);

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FA1D68C5D7
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Feb 2023 19:33:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2672110EA10;
	Mon,  6 Feb 2023 18:33:22 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/pcode: Give the punit time to

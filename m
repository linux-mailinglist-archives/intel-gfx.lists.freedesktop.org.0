...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76530395A63
	for <lists+intel-gfx@lfdr.de>; Mon, 31 May 2021 14:20:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 627DC6E911;
	Mon, 31 May 2021 12:20:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3B6D56E905;
 Mon, 31 May 2021 12:20:20 +0000 (UTC)
IronPort-SDR: FLGfuaDJ6BZsKYHgtIjWquve05e04cJYky4GmbeJOt73VowIoTso+IERnXItA2LjrC5wht+v3v
 ERbBayqvKtuA==
X-IronPort-AV: E=McAfee;i="6200,9189,10000"; a="183027520"
X-IronPort-AV: E=Sophos;i="5.83,237,1616482800"; d="scan'208";a="183027520"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2021 05:20:20 -0700
IronPort-SDR: hMmQYD1OTyJSiB1qre5RfRGNnbb07y49DvR/nw+3Ga/qKGP0GseGyvefg3CLgrPRvfdk/bgc9Y
 6krieh0WC83Q==
X-IronPort-AV: E=Sophos;i="5.83,237,1616482800"; d="scan'208";a="473904015"
...
Date: Mon, 31 May 2021 14:19:37 +0200
Message-Id: <20210531121940.267032-13-thomas.hellstrom@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 12/15] drm/i915/lmem: Verify checks for lmem
 residency
...


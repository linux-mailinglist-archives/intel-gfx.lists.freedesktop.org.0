...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B985ED5763
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Oct 2019 20:39:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 779EE6E154;
	Sun, 13 Oct 2019 18:39:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 64CE96E154
 for <intel-gfx@lists.freedesktop.org>; Sun, 13 Oct 2019 18:39:06 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18824049-1500050 
 for multiple; Sun, 13 Oct 2019 19:39:00 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 13 Oct 2019 19:38:58 +0100
Message-Id: <20191013183858.23727-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.23.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/execlists: Clear semaphore immediately
 upon ELSP promotion
...
Z3B1L2RybS9pOTE1L2d0L2ludGVsX2xyYy5jCmluZGV4IDE2Yjg3OGQzNTgxNC4uMzJhMzBkMzZl
YjdiIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYworKysg
Yi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYwpAQCAtMTkwMyw2ICsxOTAzLDkg
...
ZWNsaXN0cy0+YWN0aXZlKQpAQCAtMTkxOSw5ICsxOTIyLDYgQEAgc3RhdGljIHZvaWQgcHJvY2Vz

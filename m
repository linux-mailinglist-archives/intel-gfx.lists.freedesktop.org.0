...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D27817B210F
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Sep 2023 17:22:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2701E10E67E;
...
Subject: [Intel-gfx] [PATCH 08/15] infiniband: Remove the now superfluous

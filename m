...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C280C42ECEE
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Oct 2021 10:57:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 859668903B;
...
Subject: Re: [Intel-gfx] [PATCH v3] lib/stackdepot: allow optional init and

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 80D45546D3F
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 21:29:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2C4210E151;
...
Subject: Re: [Intel-gfx] [PATCH v2 09/15] drm/edid: add drm_edid_raw() to

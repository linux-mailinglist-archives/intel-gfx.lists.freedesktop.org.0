...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC2C71CF5F6
	for <lists+intel-gfx@lfdr.de>; Tue, 12 May 2020 15:38:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C6A96E0F9;
	Tue, 12 May 2020 13:38:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 305946E0F9
 for <intel-gfx@lists.freedesktop.org>; Tue, 12 May 2020 13:38:25 +0000 (UTC)
IronPort-SDR: 13jxAuM5Dj9jGqeNn9lC8dXwCOdNIM76UgMIxqJGTD+7Er1LoNlFZNoIZdUksHbGPIK6RcTt8R
 S9FDXbw0qRtA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2020 06:38:24 -0700
IronPort-SDR: Po6I4wFxyxNjw5yDreYa27E1fOmNekQ6qj9RZuhZIv9cOhOrQMuvlX0Q0F/bHyh/xD9sibiS7o
 4m+027rOslXg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,383,1583222400"; d="scan'208";a="265507185"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 12 May 2020 06:38:22 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 12 May 2020 16:38:21 +0300
Date: Tue, 12 May 2020 16:38:21 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
Message-ID: <20200512133821.GS6112@intel.com>
...
In-Reply-To: <20200512131734.GA19728@intel.com>
...
> > > > > v7: - Removed skl_plane_wm_level accessor from skl_allocate_pipe_=
ddb(Ville)
...
> > > > > @@ -3863,25 +3863,35 @@ bool intel_can_enable_sagv(struct drm_i91=
5_private *dev_priv,
...
> just get atomic state from crtc_state when we write wm in skl_write_plane=
_wm.
...
> However probably OOP principles like parent-child hieararchy is not a thi=
ng

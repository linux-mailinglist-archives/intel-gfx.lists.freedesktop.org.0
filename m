...
Received: from mail.lfdr.de
	...
	id OE7ZLXYLKGqx8wIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 09 Jun 2026 14:47:50 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F78A660318
	for <lists+intel-gfx@lfdr.de>; Tue, 09 Jun 2026 14:47:50 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=collabora.com header.s=zohomail header.b=RgYNcc4E;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org;
	dmarc=pass (policy=none) header.from=collabora.com;
	arc=pass ("zohomail.com:s=zohoarc:i=1")
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE9FC10E52B;
	Tue,  9 Jun 2026 12:47:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com
 [136.143.188.112])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3649B10E52B;
 Tue,  9 Jun 2026 12:47:48 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1781009256; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=ebG7+LPpT8nQSaMpw9F/dmri7VWQJsEVmG3b8kMfce/JQ+Q9c9nIqKcno/TxQ+bTsptAhNQOs2mgJaOwGYfy3P1Nm7ZC5yXTEL+Er1xZFeGKS+oT8GLCDBd4do84ZsSDulab22uqs41fwm5PnQ8FWtBdfxCsRcO8sl2N0OU5hfM=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1781009256;
 h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To;
 bh=agFvbtAhlJW1WPXelNZze1dnI9PB8xe3gaRUbAnwuyY=; 
 b=gyTrzWoVgoScYJTVqn3+yBWp0OYV8CWj/jVQa6JT6IYeoqT4pF7BmK90WkZ/J4BuGiWyI2il1jMO4vSZ6RzlDNO0V2wcLcwzmP81k3nUKb4PpZevg7qR9zIcDCEVkyfP2qprzPmULWVXxHnicp9Cqn7g1VkqRLyElHYMB4TNglE=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=nicolas.frattaroli@collabora.com;
 dmarc=pass header.from=<nicolas.frattaroli@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1781009256; 
 s=zohomail; d=collabora.com; i=nicolas.frattaroli@collabora.com;
 h=From:From:Date:Date:Subject:Subject:MIME-Version:Content-Type:Content-Transfer-Encoding:Message-Id:Message-Id:References:In-Reply-To:To:To:Cc:Cc:Reply-To;
 bh=agFvbtAhlJW1WPXelNZze1dnI9PB8xe3gaRUbAnwuyY=;
 b=RgYNcc4EhzviOyD/p6rSNMYB21ENG8bVqI057cp3g5LlFZ5lfHnSIWe1E8chCvJX
 uj+do8+wtys4QNmYU9X3Ee1NTGgnOHCEZwjp+2Irdeq+528hds7iCQWWdNA/y4J1SxL
 mbjOV60KWysFe3uMhLzCxSG5S87t2uvqwwrHRcpw=
Received: by mx.zohomail.com with SMTPS id 1781009254985917.4971360681741;
 Tue, 9 Jun 2026 05:47:34 -0700 (PDT)
From: Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
Date: Tue, 09 Jun 2026 14:44:08 +0200
Subject: [PATCH v17 21/28] drm/tests: bridge: Add KUnit tests for bridge
 chain format selection
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260609-color-format-v17-21-35739b5782cc@collabora.com>
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,fooishbar.org:email,lists.freedesktop.org:from_smtp,collabora.com:dkim,collabora.com:email,collabora.com:mid,collabora.com:from_mime,bootlin.com:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 3F78A660318

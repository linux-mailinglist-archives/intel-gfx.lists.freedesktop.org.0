...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DBB7E5A32CD
	for <lists+intel-gfx@lfdr.de>; Sat, 27 Aug 2022 01:54:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EC1610EA98;
	Fri, 26 Aug 2022 23:54:43 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 2/3] drm/i915/uc: Add patch level version
 number support

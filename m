...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A6241BBA68
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Apr 2020 11:56:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 166E96E16D;
	Tue, 28 Apr 2020 09:56:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C507D6E16D
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Apr 2020 09:56:03 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 21043882-1500050 for multiple; Tue, 28 Apr 2020 10:56:00 +0100
MIME-Version: 1.0
In-Reply-To: <2ea55bb059f3a6d22dac6531843bed183f1e5bea.camel@linux.intel.com>
References: <20200424152412.5928-1-chris@chris-wilson.co.uk>
 <2ea55bb059f3a6d22dac6531843bed183f1e5bea.camel@linux.intel.com>
To: Janusz Krzysztofik <janusz.krzysztofik@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
From: Chris Wilson <chris@chris-wilson.co.uk>
Message-ID: <158806775875.24122.10714011601438386144@build.alporthouse.com>
User-Agent: alot/0.8.1
Date: Tue, 28 Apr 2020 10:55:58 +0100

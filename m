...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DE577D63F5
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Oct 2023 09:49:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9237810E577;
...
Subject: Re: [Intel-gfx] [PATCH v5 4/7] drm/i915: Move fbdev functions

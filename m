...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aH9MA9+zxWnEAwUAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Mar 2026 23:31:59 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A16433C751
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Mar 2026 23:31:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D82610EAB9;
	Thu, 26 Mar 2026 22:31:57 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="noTrT3gW";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E1FF110EAAF;
 Thu, 26 Mar 2026 22:31:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1774564316; x=1806100316;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Y327fH/gVN6WLDDn2U+z+Cw/bShsmjAO2gMQcv2alcw=;
 b=noTrT3gWpvkWWGT9lnL/f64W1StwYeLCsNzYqIknfXmjKQxjNNryygKD
 n79TBRi9hSwdgAKW/5bud2cEy+OdUwEbvERXSa2mWy5MFtnrTD00bgtzk
 dGIl3S7Wc7DnEAtbCZ8+f2gCi11rHdqq5oWjE2FBWzpEGt5bPxuyFMigY
 hc30tn1Ixrkp8aMWSHVrCvEd+bGg81tQuaXPt9hD+tuVQalmUpQO2zhFv
 piCqz4+sYfThVLkV3aw2VyzJTd7l+ptbdFUY9cHmPlI9Xym8bYLcx4a/I
 NWb4hUPjSnyh3I6ugcqft49OSVhauTe9q8ReCy4MlqKwQrbwZ/9CQIw7t g==;
X-CSE-ConnectionGUID: 8VIUkWnnQkSkJNDg+8+sGA==
X-CSE-MsgGUID: oaS41ospSqiZWpQ2xNwtXg==
X-IronPort-AV: E=McAfee;i="6800,10657,11741"; a="78233047"
X-IronPort-AV: E=Sophos;i="6.23,142,1770624000"; d="scan'208";a="78233047"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Mar 2026 15:31:56 -0700
X-CSE-ConnectionGUID: E/dOG/o1RJiQfiLrDDGaFg==
X-CSE-MsgGUID: L9Cbk+OYSmu72Pdbncsg+w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,142,1770624000"; d="scan'208";a="226769474"
Received: from pgcooper-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.244.14])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Mar 2026 15:31:54 -0700
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: intel-xe@lists.freedesktop.org,
	Nemesa Garg <nemesa.garg@intel.com>
Subject: [PATCH 3/9] drm/i915/casf: Move the casf state to better place
Date: Fri, 27 Mar 2026 00:31:33 +0200
Message-ID: <20260326223139.19116-4-ville.syrjala@linux.intel.com>

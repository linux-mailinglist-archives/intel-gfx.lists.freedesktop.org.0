...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E294882FA9
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2019 12:25:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 515556E357;
	Tue,  6 Aug 2019 10:25:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E88826E357
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Aug 2019 10:25:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17901480-1500050 
 for multiple; Tue, 06 Aug 2019 10:05:40 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Aug 2019 10:05:35 +0100
Message-Id: <20190806090535.14807-22-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 22/22] drm/i915: Markup expected timeline locks
 for i915_active
...
b3ZlcmxheS5jCmluZGV4IDFhMTVmYTM0MjA1Yy4uZDVlMDZiNDYzNTY3IDEwMDY0NAotLS0gYS9k
...
OTE1X2dlbV9jbGllbnRfYmx0LmMKaW5kZXggOTk3ZTEyMjU0NWJjLi42YjE1NjUyMDU0MDMgMTAw
...
ZGV4IGYyNmMyMWU3NGVkYS4uYTllMWNlY2Y1NmVkIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9k
cm0vaTkxNS9nZW0vaTkxNV9nZW1fY29udGV4dC5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1
L2dlbS9pOTE1X2dlbV9jb250ZXh0LmMKQEAgLTk2Niw3ICs5NjYsNyBAQCBzdGF0aWMgaW50IGNv
...
cm0vaTkxNS9pOTE1X3ZtYS5jCmluZGV4IDUwMzE0ZWM3Y2EzNi4uNjQxZWM2OWM4MDE2IDEwMDY0
NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3ZtYS5jCisrKyBiL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2k5MTVfdm1hLmMKQEAgLTkwMiwxNCArOTAyLDE0IEBAIGludCBpOTE1X3ZtYV9t

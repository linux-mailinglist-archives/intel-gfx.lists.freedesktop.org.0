...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D7281FAB7C
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Jun 2020 10:42:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCEBE6E85E;
	Tue, 16 Jun 2020 08:41:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D68876E85E
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Jun 2020 08:41:55 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21509974-1500050 
 for multiple; Tue, 16 Jun 2020 09:41:45 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 16 Jun 2020 09:41:40 +0100
Message-Id: <20200616084141.3722-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 8/9] drm/i915/gt: Extract busy-stats for
 ring-scheduler
...
Yy5jCmluZGV4IDA5ZWM3MjQyZmJjYi4uYmQ4MmFiZmRjNDlkIDEwMDY0NAotLS0gYS9kcml2ZXJz
...
IgpAQCAtMTE5NCwzOSArMTE5NSw2IEBAIGV4ZWNsaXN0c19jb250ZXh0X3N0YXR1c19jaGFuZ2Uo

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEA8C5FF83C
	for <lists+intel-gfx@lfdr.de>; Sat, 15 Oct 2022 05:27:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 095BE10E33D;
	Sat, 15 Oct 2022 03:26:34 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 3/3] drm/i915/mtl: C6 residency and C state type
 for MTL SAMedia

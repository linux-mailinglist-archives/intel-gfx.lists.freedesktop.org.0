...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 798476D1036
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Mar 2023 22:43:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B577410E2D9;
	Thu, 30 Mar 2023 20:43:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8521710E2D9
 for <intel-gfx@lists.freedesktop.org>; Thu, 30 Mar 2023 20:43:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680208989; x=1711744989;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=E0eImVKhEqjJKWIKnHh3yrPK1SfiMYmPKo/+HAv37TU=;
 b=AWMxKheUpWrMBA4pJ1HMe94LxfE6UVtG0X1iwFsdbvNqQe/5K6htU5VA
 c6GhOBJvJaIYSxlFb15xtgq67ZzHTdBd3mhCb4o876G1ayGnE2HvxS7aB
 t+juHrtoCXj5rlC4G04aw6bicGwg9DT27EFMPPoxqPzfgSkgWyFnRE6rh
 hR5ukRdPLePe6tecSyeccS/2ln3PgsAF8IpUQXHvUXH7oA375mXMAK88P
 lJw9coE4fEDhzwn7iW1UiF6eaFa0iBXJYRtGxXN/U3RGv8E2cZsPFGLvy
 WD4K76aO5wkIskJLbjRmTJwz4xoJV+gYsVxIqgiR94X/fsQ9+d4eAe1nT w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10665"; a="321668291"
X-IronPort-AV: E=Sophos;i="5.98,305,1673942400"; d="scan'208";a="321668291"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Mar 2023 13:43:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10665"; a="635057426"
X-IronPort-AV: E=Sophos;i="5.98,305,1673942400"; d="scan'208";a="635057426"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230028)(136003)(366004)(39860400002)(376002)(346002)(396003)(451199021)(26005)(31686004)(316002)(6486002)(2616005)(478600001)(6506007)(6512007)(31696002)(186003)(83380400001)(66476007)(8676002)(4326008)(66946007)(66556008)(53546011)(38100700002)(8936002)(41300700001)(2906002)(82960400001)(5660300002)(86362001)(36756003)(43740500002)(45980500001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 30 Mar 2023 20:43:05.7574 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1885D94344F
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Jul 2024 18:45:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0A4F10E696;
	Wed, 31 Jul 2024 16:44:58 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="QR5Ugtrj";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0CA4210E696;
 Wed, 31 Jul 2024 16:44:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1722444297; x=1753980297;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=XtVNg8/titjasKTaE1o1JXi8ehG8P7uSqyCRa5B1oBU=;
 b=QR5Ugtrj/o/SKC2MsuX+6uinVjGoOHYR+hugHyJdwjZdfy9KFIWzdqh8
 /0dFnFrSUVt6JnDm/hVGg3rYouLPYHzTJPAKZPVemWpozyCCk5//LRh7Y
 zGVsjixEB8AVomtSkJ4z+Mj77gOoQIscF9JE7Qc4JHRLACbgZ9e5aHvhN
 6asTsB3ZANe2BqSdbdOcA85KFurL5hR0APG11s77XJJe7j3i0vci6OKSj
 m2cYxAqgM4x8e4HkBDwek6J+4MXDE4P9L/5ksp1nzEcjKreYJgX97doIk
 lkFxUK7+/v4VNiPGGrnAjxvNMgGlpggSdl3wiefNQq9Of1ZpS7Z9wyWQc A==;
X-CSE-ConnectionGUID: YG5lKo43St64Ds2hHuuzpw==
X-CSE-MsgGUID: XQDHBYsrSCi0AqGI+YGfjQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11150"; a="45754429"
X-IronPort-AV: E=Sophos;i="6.09,251,1716274800"; d="scan'208";a="45754429"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jul 2024 09:44:57 -0700
X-CSE-ConnectionGUID: xcZfi7OZTv6ZhxzZN5oSEA==
X-CSE-MsgGUID: 5ed4H+DQQM22V4SihZEr5w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,251,1716274800"; d="scan'208";a="54405310"
Received: from bergbenj-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.183])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jul 2024 09:44:54 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 3/4] drm/i915/opregion: convert to struct intel_display
Date: Wed, 31 Jul 2024 19:44:35 +0300
Message-Id: <8a71cea4f260a992200c76480c5358b72a7f9187.1722444150.git.jani.nikula@intel.com>

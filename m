...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F9DA45AD57
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Nov 2021 21:25:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 311076E452;
...
Subject: [Intel-gfx] [PATCH v2 6/8] inotify: simplify subdirectory

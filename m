...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 143FD76BA91
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 19:04:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17A2C10E452;
...
Subject: [Intel-gfx] [PATCH v5 15/22] dyndbg: add for_each_boxed_vector

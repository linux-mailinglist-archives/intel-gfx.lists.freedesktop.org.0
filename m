...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D1E32D3BE1
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Dec 2020 08:03:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 50AC86E112;
	Wed,  9 Dec 2020 07:03:48 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 272356E10C
 for <Intel-gfx@lists.freedesktop.org>; Wed,  9 Dec 2020 07:03:42 +0000 (UTC)
IronPort-SDR: N8KoBmPbl0Z+4WHLWHa3HmjqN5PSUABX7jqAbDd/7iyZlricsT7YQ0WKL86+cbSbZL7ZR2VCD8
 emgo4WLpzScQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9829"; a="173270809"
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="173270809"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2020 23:03:41 -0800
IronPort-SDR: Z9e4ETVYIok/rfWa27Qa/xncW6NS16+q8MX97AncPVGUdohSvgCebQr5iRo18fwwHs/AYD99ea
 HdqL7aSk7Yag==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="368074116"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga004.fm.intel.com with ESMTP; 08 Dec 2020 23:03:40 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Tue,  8 Dec 2020 23:03:06 -0800
Message-Id: <20201209070307.2304-13-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201209070307.2304-1-sean.z.huang@intel.com>
References: <20201209070307.2304-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v3 12/13] drm/i915/pxp: User interface for
 Protected buffer

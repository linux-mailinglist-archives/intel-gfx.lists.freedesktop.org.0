...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0F293B3E91
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Jun 2021 10:22:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3B796ECEC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 01/27] drm/amdgpu: Track IRQ state in local
 device state

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 12753702B11
	for <lists+intel-gfx@lfdr.de>; Mon, 15 May 2023 13:07:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFEC610E1A5;
	Mon, 15 May 2023 11:07:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 01FEA10E1A5;
 Mon, 15 May 2023 11:07:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684148846; x=1715684846;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-id:content-transfer-encoding: mime-version;
 bh=iyrDT1zIzoxmuoJV4p7A444/YdJymYaIccieS7MNVY4=;
 b=Vh0SKF868n4iYn96cuOoMyzVi09i32i5FkJQ4FcVRGsawAi2snxB98ih
 oSOK5sfLe0GK6f7MQw5rv/jFXEjYiaDBJ+zwsP006+PxeS7+VQ+wjASlk
 WKSGme83QKF5Lbstw7bngLA+xWGnTlUI8InvTswMt8lqMG2GRRGWD/6x1
 VTXNL+19RTM0zXtdIZ/lkjaKXCALucXpczFRN11mQoRtCcf+JKQtg7Cei
 B3Kc+yX6VArCgwuGQG2x5b2pJbeHBIHPhfpbU04fKv9dW+wcOsg47F9fA
 02x38tiTVsL/UHuEVZweQwGVE7BpM4PxNRbaYy8ZNEF6LEOAq8Hwxr989 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="335713537"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="335713537"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2023 04:07:24 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="1030871831"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="1030871831"
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230028)(396003)(366004)(376002)(136003)(346002)(39860400002)(451199021)(71200400001)(82960400001)(122000001)(38100700002)(2616005)(186003)(26005)(53546011)(83380400001)(6506007)(6512007)(2906002)(41300700001)(5660300002)(8936002)(8676002)(6486002)(36756003)(478600001)(31696002)(110136005)(38070700005)(66446008)(66476007)(66556008)(66946007)(76116006)(64756008)(316002)(4326008)(86362001)(91956017)(54906003)(31686004)(43740500002)(45980500001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 15 May 2023 11:07:20.6799 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 02/28] drm/i915/gvt: remove interface
 intel_gvt_is_valid_gfn

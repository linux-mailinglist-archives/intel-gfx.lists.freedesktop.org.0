...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A5CD1580A5
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Feb 2020 18:10:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3C7A6ECD6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 00/18] In order to readout DP SDPs,

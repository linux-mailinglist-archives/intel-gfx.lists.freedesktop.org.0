...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA39743C19C
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Oct 2021 06:37:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B45D8918A;
...
Subject: [Intel-gfx] [PATCH v9 05/10] i915/gvt: use dyndbg.CATEGORIES for
 existing pr_debugs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 29D0D26A7C3
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 17:00:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6C916E86E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 00/21] Convert all remaining drivers to GEM
 object functions

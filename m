...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 76B1478C926
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Aug 2023 18:00:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4709C10E417;
...
Subject: [Intel-gfx] [RFC 24/33] drm/i915/xelpd: Add plane color check to
 glk_plane_color_ctl

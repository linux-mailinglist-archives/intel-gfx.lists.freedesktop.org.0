...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EDD8375A89
	for <lists+intel-gfx@lfdr.de>; Thu,  6 May 2021 20:57:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E8DAD6ECE3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 00/97] Basic GuC submission support in the
 i915

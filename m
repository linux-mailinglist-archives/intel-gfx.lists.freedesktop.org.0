...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 038AF7DD9E4
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Nov 2023 01:27:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A059010E5F5;
...
Subject: [Intel-gfx] [PATCH v7d 09/23] dyndbg: silence debugs with no-change
 updates

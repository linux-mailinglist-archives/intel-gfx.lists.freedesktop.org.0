...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 699512E647E
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Dec 2020 16:53:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC6BD89A57;
	Mon, 28 Dec 2020 15:52:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2ED8B89A1F
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Dec 2020 15:52:52 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23448216-1500050 
 for multiple; Mon, 28 Dec 2020 15:52:39 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Dec 2020 15:52:12 +0000
Message-Id: <20201228155229.9516-37-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 37/54] drm/i915/gt: Support virtual engine queues
...
index cae29268ccea..7d6a39cf4a99 100644
...
@@ -526,12 +535,42 @@ resubmit_virtual_request(struct i915_request *rq, struct virtual_engine *ve)
 			cpu_relax();
 	}
...
@@ -550,7 +589,7 @@ static void kick_siblings(struct i915_request *rq, struct intel_context *ce)
...
@@ -897,10 +936,16 @@ static bool ctx_single_port_submission(const struct intel_context *ce)
...
@@ -949,6 +994,9 @@ static bool virtual_matches(const struct virtual_engine *ve,
 {
...
@@ -968,31 +1016,6 @@ static bool virtual_matches(const struct virtual_engine *ve,
 	return true;
 }
...
-
 static void virtual_xfer_context(struct virtual_engine *ve,
 				 struct intel_engine_cs *engine)
 {
@@ -1156,15 +1179,124 @@ static bool completed(const struct i915_request *rq)
...
-	struct rb_node *rb;
 	...
 	/*
@@ -1282,85 +1414,8 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 		}
 	}
...
@@ -1368,6 +1423,8 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -2700,13 +2757,11 @@ static void execlists_reset_cancel(struct intel_engine_cs *engine)
 		RB_CLEAR_NODE(rb);
...
@@ -2940,11 +2995,6 @@ int intel_execlists_submission_setup(struct intel_engine_cs *engine)
 	return 0;
 }
...
-
 ...
 {
 	struct virtual_engine *ve =
@@ -2954,17 +3004,13 @@ static void rcu_virtual_context_destroy(struct work_struct *wrk)
...
@@ -2995,7 +3041,6 @@ static void rcu_virtual_context_destroy(struct work_struct *wrk)
...
@@ -3118,7 +3163,9 @@ virtual_submission_mask(struct virtual_engine *ve, u64 *deadline)
 	struct i915_request *rq;
...
@@ -3158,9 +3205,6 @@ static void virtual_submission_tasklet(unsigned long data)
 		struct rb_node **parent, *rb;
 		bool first;
...
@@ -3222,45 +3266,6 @@ static void virtual_submission_tasklet(unsigned long data)
 	}
 }
...
@@ -3348,10 +3353,9 @@ intel_execlists_create_virtual(struct intel_engine_cs **siblings,
...
-	INIT_LIST_HEAD(virtual_queue(ve));
 	tasklet_init(&ve->base.active.tasklet,
 		     ...
 		     (unsigned long)ve);
@@ -3559,14 +3563,17 @@ void intel_execlists_show_requests(struct intel_engine_cs *engine,
...
index 92c7cbf98302..b8891b45d9b5 100644

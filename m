...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C700E303F1F
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Jan 2021 14:45:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B3AA6E459;
	Tue, 26 Jan 2021 13:45:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AA8486E452
 for <intel-gfx@lists.freedesktop.org>; Tue, 26 Jan 2021 13:45:23 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 23703907-1500050 for multiple; Tue, 26 Jan 2021 13:45:17 +0000
MIME-Version: 1.0
In-Reply-To: <161166744720.2943.1804423973098975957@build.alporthouse.com>
References: <20210125140136.10494-1-chris@chris-wilson.co.uk>
 ...
 <161166744720.2943.1804423973098975957@build.alporthouse.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
Date: Tue, 26 Jan 2021 13:45:19 +0000
Message-ID: <161166871901.2943.341555467281003301@build.alporthouse.com>
User-Agent: alot/0.9

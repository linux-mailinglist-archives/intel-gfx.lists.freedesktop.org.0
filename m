...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C6D3596C8B
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Aug 2022 12:07:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09E1D18B1D0;
	Wed, 17 Aug 2022 10:07:26 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: Fix all occurences of the "the
 the" typo

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 06B7D54E9BD
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Jun 2022 21:02:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1661511A4F0;
	Thu, 16 Jun 2022 19:02:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C31C111A4ED;
 Thu, 16 Jun 2022 19:02:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655406127; x=1686942127;
 h=date:from:to:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=nhRvQ9enbTEUmBa6ncnO8i5Yq+VM/dpnNOHB9eE0XW8=;
 b=jxtx8ix4zMS3qCKMwzca5tz8vEAjj0NSpyHWMnfhP2B4oH/BfGTuQvwT
 LfJ3ZRmmnGyP8x5zJpMfwjc7iVy6BbJOkwflQQk4E79FjFwmRRNFw/iDg
 KNyfV/YUGP6pUB/vdXIIqop0mer1sdb2tb5BTbu0v92/HnArVBf1i3jsV
 vvndLlxVUqDUWkm5Q04H9H2ah65PZgiInDwENTXtUMOvtLIm5D1/rYG2W
 HoMATDzcNNOaITMkwIRij9lwshIqn3cm1Qk2vOFzUmiKuXQbX731JZqYj
 mHe/MKTEffeU0ijtH9SYiBHU9/Ud13b5NT6Ke1lf3ijRSrmCxNrq7y0Cm w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10380"; a="259789343"
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="259789343"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2022 12:01:46 -0700
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="613269938"
Received: from ideak-desk.fi.intel.com ([10.237.72.175])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2022 12:01:44 -0700
Date: Thu, 16 Jun 2022 22:01:40 +0300
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org, Jani Nikula <jani.nikula@intel.com>,
 Lyude Paul <lyude@redhat.com>,
 Lakshminarayana Vudum <lakshminarayana.vudum@intel.com>,
 dri-devel@lists.freedesktop.org
Message-ID: <Yqt+FI4bAV8ahg9c@ideak-desk.fi.intel.com>
...
<5> [121.901521] i915 0000:00:02.0: [drm] Resetting chip for Manually reset engine mask to ffffffffffffffff
<4> [219.007508] [IGT] Per-test timeout exceeded. Killing the current test with SIGQUIT.

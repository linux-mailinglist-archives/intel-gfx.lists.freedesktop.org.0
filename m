...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 546562ACF7A
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Nov 2020 07:13:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 336F38982D;
...
Subject: Re: [Intel-gfx] [PATCH v7 1/2] drm/i915/gvt: Save/restore HW status
...
Content-Type: multipart/mixed; boundary="===============0355720420=="

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F1D28A557B
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Apr 2024 16:46:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E17CC112635;
	Mon, 15 Apr 2024 14:46:16 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="fIt1xK8l";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A559B112631
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Apr 2024 14:46:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1713192374; x=1744728374;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=yE1F4RlWG4fCFi2bXfLYcetLUdjLKCrfww2GqO6/mLE=;
 b=fIt1xK8lW8xj9Fkoi+TcuE7mc7DEIQ7z3Csd0f6hGA8wOaTscVygwQ8G
 oTIREp8i4NAgyrpBa0XBJzAioRARH6Wr1tydBViKbn7mF05NtobiCsJuh
 Kr63BptG0Bbn/XtKgE2FqiTxg4/RlnGR2URMdm//C638J2QO17O457MYo
 gyXiypwymc20llgh9wVefGkxQNnicBJt+ihKai/Qd2tQ9LogmS/8VTXkJ
 tjMXhaSfs27b4Ug90obntRCwHhWpni+yJNXexuabyh5BGYRZVrgVn6Rmz
 pwbA0H3pTCCgon0fLUaEHy/bWknmaYu+DoqelPwb+sQSkDgV3ZszNNIIL w==;
X-CSE-ConnectionGUID: TAOoVzuVTJaR3g2bM64vfg==
X-CSE-MsgGUID: hnL5x0/WQgqJfvIqeCIxZQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11045"; a="19147611"
X-IronPort-AV: E=Sophos;i="6.07,203,1708416000"; d="scan'208";a="19147611"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2024 07:46:14 -0700
X-CSE-ConnectionGUID: ULNPBP5qSQe4bGlUJk+aNw==
X-CSE-MsgGUID: bdR1n4CLTfaS1dJ7c7AYfw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,203,1708416000"; d="scan'208";a="22363831"
Received: from lcariou-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.61.121])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2024 07:46:13 -0700
...
References: <20240412173153.722804-1-mitulkumar.ajitkumar.golani@intel.com>
 <20240412173153.722804-2-mitulkumar.ajitkumar.golani@intel.com>
Date: Mon, 15 Apr 2024 17:46:02 +0300
Message-ID: <87mspu1y6t.fsf@intel.com>
MIME-Version: 1.0

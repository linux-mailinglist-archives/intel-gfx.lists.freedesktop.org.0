...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B32CB78C93B
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Aug 2023 18:01:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7394910E430;
...
Subject: [Intel-gfx] [RFC 30/33] drm/i915/color: Enable Plane CSC

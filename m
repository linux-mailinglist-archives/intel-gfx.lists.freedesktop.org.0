...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2635867BBEB
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:04:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20B7A10E884;
...
Subject: [Intel-gfx] [PATCH v3 07/10] drm/fbdev-generic: Minimize hotplug
 error handling

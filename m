...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 40DED45AD4C
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Nov 2021 21:24:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 324E56E15A;
...
Subject: [Intel-gfx] [PATCH v2 0/8] sysctl: second set of kernel/sysctl
 cleanups

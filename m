...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A4AC2AB6E
	for <lists+intel-gfx@lfdr.de>; Sun, 26 May 2019 19:36:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F40A89815;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 zIiA==
Subject: [Intel-gfx] [PATCH v2 4/7] drm: make drm_internal.h self-contained

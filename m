...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C65344B9468
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 00:18:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AC7010E628;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Kill the fake lmem support

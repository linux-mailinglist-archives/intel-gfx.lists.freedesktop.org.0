...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EDE7542CBD5
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 22:50:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E5706EB38;
...
Subject: [Intel-gfx] [PATCH v4 14/20] drm/i915: cleanup:

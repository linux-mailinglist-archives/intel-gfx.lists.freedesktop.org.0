...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3774885E7
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 00:27:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 662176EF05;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 11/37] drm/i915/blt: bump size restriction

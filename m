...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 98ED37B666A
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Oct 2023 12:30:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9805510E09F;
	Tue,  3 Oct 2023 10:30:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1037D10E09F
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Oct 2023 10:30:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1696329046; x=1727865046;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=C43+IC1OjruGp0x7NPuqnCGIec/+WaPF0BIS0Z0+bjw=;
 b=CLvS3eyihZlwLbZM+qYLkH1RMLor7Q6O4v8N6/5wqimRRERPFQ9XryE9
 enND3HrhFzT022Oz/Sdab1h01iBOTswY2pA8KYk31YNGf6QLytwPCF9fh
 JbEXlO6YeP9Lb8KQHib4zyvCyUcN7fwPjzqoXJsMb/PjtmmQ3iLfo5tqR
 ZTdgbg/x9muyNVjUSM+QjMF5IYc2v4UG+SDq9QA/qzFNn76yNZr0fvb8I
 cb7GkN44wZzVdaN6hqLMuFMNlrg9D8/M6w5UsiBjFJHDGcXpQtAFqoJJC
 CIZ+oQxRkFs+gfiKpOcBm87FTs29mq7RP5YbGHedMfkt88TTvQ6Cn+L/f g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10851"; a="446999632"
X-IronPort-AV: E=Sophos;i="6.03,196,1694761200"; d="scan'208";a="446999632"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Oct 2023 03:29:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10851"; a="744448397"
X-IronPort-AV: E=Sophos;i="6.03,196,1694761200"; d="scan'208";a="744448397"
Received: from fredden-mobl1.ger.corp.intel.com (HELO [10.213.208.132])
 ([10.213.208.132])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Oct 2023 03:28:58 -0700
Message-ID: <813ae801-b774-7d7a-df8a-00b5b0e36695@linux.intel.com>
Date: Tue, 3 Oct 2023 11:28:56 +0100
MIME-Version: 1.0

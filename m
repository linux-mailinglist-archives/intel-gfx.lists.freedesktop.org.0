...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3914B69B683
	for <lists+intel-gfx@lfdr.de>; Sat, 18 Feb 2023 00:48:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7083610E473;
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/guc: Allow for very slow GuC
 loading

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 119A84427AB
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 08:07:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25FD86FAAB;
...
Subject: [Intel-gfx] [PATCH 17/29] drm/i915/gvt: devirtualize ->inject_msi

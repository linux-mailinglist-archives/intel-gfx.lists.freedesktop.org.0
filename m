...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3074A25AAFC
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Sep 2020 14:17:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83E496E49C;
	Wed,  2 Sep 2020 12:17:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E61856E49C
 for <intel-gfx@lists.freedesktop.org>; Wed,  2 Sep 2020 12:17:11 +0000 (UTC)
IronPort-SDR: KbsHwb09i+BnKbcquT/gvPZel18BKzBF/XSjZ4EHQQrtqF1yyJrXj3eaa9DbBCu3Wt/wsHvues
 M4pn1jY7Z3ug==
X-IronPort-AV: E=McAfee;i="6000,8403,9731"; a="218923442"
X-IronPort-AV: E=Sophos;i="5.76,383,1592895600"; d="scan'208";a="218923442"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Sep 2020 05:17:11 -0700
IronPort-SDR: 2tLkQpfs7HOlLZxuZawxCth3lxPuXDvNVQbJBp0mNEs8TRrNw8UyEInhrYqqb9Xoq46WGO4J5X
 qwj9OUNAudcQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.76,383,1592895600"; d="scan'208";a="301817270"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 02 Sep 2020 05:17:09 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 02 Sep 2020 15:17:08 +0300
Date: Wed, 2 Sep 2020 15:17:08 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
Message-ID: <20200902121708.GQ6112@intel.com>
...
> > > Fixes: 4f0b4352bd26 ("drm/i915: Extract cdclk requirements checking t=
o separate function)"
...
> > > @@ -15009,12 +15009,6 @@ static int intel_atomic_check(struct drm_dev=
ice *dev,
...
> > >  	if (ret)
> > > @@ -15029,6 +15023,10 @@ static int intel_atomic_check(struct drm_dev=
ice *dev,
> > >  		goto fail;
> > >  =

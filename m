...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CpqkFs/jD2oHRQYAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 07:04:15 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0623D5AEEDA
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 07:04:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA77E10F4B8;
	Fri, 22 May 2026 05:04:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="NnJYRX4h";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B955E10F4B6;
 Fri, 22 May 2026 05:04:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1779426252; x=1810962252;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=OTIUYCyhHn6ZBsyqyCZH4HOBYLQ0ItQsBW7bYEEAwaU=;
 b=NnJYRX4hjKcCO65Xk6b7vIo9rQ+izwdZgKxzrF5A2X+EWNZplr6bJNBm
 cEMZIOXfsZys1l7SLWI4ccSZVGmaWHIiPJfTvNC2+z3gTJSzraTkC46g7
 S8pJzH3j2MsSjxnoxTyH4z6OcoYZAANhTfNLnu6PIxEil9/yq4jY/I7Q8
 C8oqI6UN2O0NHBJZpL5Q6fDuePHMuyNWPmcOqicpdaL1WfUHY2C79jZMQ
 rAyK4rprKTM2QUYnp6GM0+RCv9pYXwxZ4nMXjCK0oHSHqNH36WL4EKVc5
 UO3hh1hUNrdUEkLVP7fmgjilHR1L1uIABH0iUr+i2AMOrAgEXUP72Q+kW g==;
X-CSE-ConnectionGUID: q5hfJjqZRj+cSelf0QzkUw==
X-CSE-MsgGUID: Fw8B7wnIQ+OLuR2X1a3FDQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11793"; a="90651772"
X-IronPort-AV: E=Sophos;i="6.24,161,1774335600"; d="scan'208";a="90651772"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 May 2026 22:04:12 -0700
X-CSE-ConnectionGUID: QcGzgLDeQ4OpD/CYJXJCsg==
X-CSE-MsgGUID: rkYlc4KVQPqCP+OFaSSdpQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.24,161,1774335600"; d="scan'208";a="239946388"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa010.jf.intel.com with ESMTP; 21 May 2026 22:04:06 -0700
...
Subject: [PATCH v5 6/7] drm: writeback: Modify prepare_writeback_job helper
Date: Fri, 22 May 2026 10:33:12 +0530
Message-Id: <20260522050313.1800378-7-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CAB3E71669B
	for <lists+intel-gfx@lfdr.de>; Tue, 30 May 2023 17:13:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 15B3E10E3E5;
...
Subject: [Intel-gfx] [PATCH v5 02/13] fbdev: Add initializer macros for
 struct fb_ops

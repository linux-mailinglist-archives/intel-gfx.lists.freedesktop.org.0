...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05D21636A20
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Nov 2022 20:51:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 530FF10E615;
...
Subject: [Intel-gfx] [PATCH v3 4/5] drm/i915/guc: Add GuC CT specific debug
 print wrappers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9452F589A39
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Aug 2022 11:59:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 983488E83F;
	Thu,  4 Aug 2022 09:59:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DAF5811BCDA
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Aug 2022 09:58:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1659607123; x=1691143123;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=H73OiaTA0JhimvMvohUn4i/p0zm1TBmu7aCRXuHnEAk=;
 b=Wze9UJgjOhK/rv6syvBg4Z6Dj9DQ8TNxPoNRC31fvQ5q0J9BdfYDlmAV
 DeAP72fVbAZ1uIVQpwojayjTzX08x9y06bbwApyskdwPkuP8lZ9VMrMX8
 JEms7phe0cJp+IOZJyrzIHZMTO7bW5UQIULz11+N5XWoyXT6+maPs/5Zt
 vVxa4cYVj5fN81YAGYzdWt4OHYtigwHr4Qt3OadrjRQL0YX26oEU+2tXr
 DrHwViV8HDybJo8Hix/ebzaOOYEzZ5uKBmHV90EThX0+zv57bLiw60foE
 azqHAvK/VNoEjUXWfmVZX+pcO9Eoen1Gx34wrEeiC8YSqThWf+c6kwCWw A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10428"; a="287457439"
X-IronPort-AV: E=Sophos;i="5.93,215,1654585200"; d="scan'208";a="287457439"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Aug 2022 02:58:43 -0700
X-IronPort-AV: E=Sophos;i="5.93,215,1654585200"; d="scan'208";a="662471799"
Received: from wujunyox-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.59.120])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Aug 2022 02:58:42 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  4 Aug 2022 12:58:34 +0300
Message-Id: <ce8334342e8bdf92c17c714aa13574e66cad93bb.1659607033.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915/hdcp: split out hdcp registers to
 a separate file
...
index bf5c39d9f953..ad2c441aceca 100644

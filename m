...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D8603337AC7
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Mar 2021 18:26:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4595D6EAAD;
	Thu, 11 Mar 2021 17:26:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 19BE16EAB4
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Mar 2021 17:26:48 +0000 (UTC)
IronPort-SDR: C/jhwugoT/2nEP7sVlKMEx+67FfhsqLHd7Xbq27t6sJoVAFTO44npdOjxtaAHiQSBI5Kw4tk56
 FCXnqigX/9sQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9920"; a="168622319"
X-IronPort-AV: E=Sophos;i="5.81,241,1610438400"; d="scan'208";a="168622319"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2021 09:26:47 -0800
IronPort-SDR: 4eX5BGNB98BCgax8Q7RzPnamBTx5q04N4MJV0AiXtfS426sf75AZ80mAQHiTKvVSj8CSxkCuLy
 kDecsssZmcnQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,241,1610438400"; d="scan'208";a="448349167"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.171])
 by orsmga001.jf.intel.com with SMTP; 11 Mar 2021 09:26:42 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 11 Mar 2021 19:26:42 +0200
Date: Thu, 11 Mar 2021 19:26:42 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <YEpS0lKUt6ynqcy4@intel.com>
...
> > > remapping, add a helper to get the tile pitch and rows for an FB plan=
e,
> > > so these helpers can be used both by the normal size calculation and =
the
> > > remapping code.
> > > =

> > > Also add a new fb_plane_view_dims struct in which we can pass around =
the
> > > view (either FB plane or plane source) and tile dimensions convenient=
ly
...
> > > @@ -634,6 +634,59 @@ static u32 setup_fb_rotation(int plane, const st=
ruct intel_remapped_plane_info *
...
> > > +};
> > > +
> > > +static void init_plane_view_dims(const struct intel_framebuffer *fb,=
 int color_plane,
...
> > > +
> > > +	intel_tile_dims(&fb->base, color_plane, &dims->tile_width, &dims->t=
ile_height);
> > > +}
> > > +
> > > +static unsigned int plane_view_stride_tiles(const struct intel_frame=
...
> > > +}
> > > +
> > > +static unsigned int plane_view_tile_rows(const struct intel_framebuf=
...
> > > +}
> > > +
> > >  int intel_fill_fb_info(struct drm_i915_private *i915, struct drm_fra=
mebuffer *fb)
> > >  {
> > >  	struct intel_framebuffer *intel_fb =3D to_intel_framebuffer(fb);
> > > @@ -644,6 +697,7 @@ int intel_fill_fb_info(struct drm_i915_private *i=
...
> > >  		u32 offset;
> > > @@ -669,6 +723,8 @@ int intel_fill_fb_info(struct drm_i915_private *i=
915, struct drm_framebuffer *fb
> > >  		if (ret)
> > >  			return ret;
> > >  =
...
> > > @@ -680,38 +736,22 @@ int intel_fill_fb_info(struct drm_i915_private =

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F198C7506AC
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Jul 2023 13:48:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 713BA10E4FA;
...
Subject: [Intel-gfx] [PATCH 08/17] drm/cgroup: Track DRM clients per cgroup

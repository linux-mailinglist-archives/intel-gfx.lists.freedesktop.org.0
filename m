...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6A4E51C9A4
	for <lists+intel-gfx@lfdr.de>; Thu,  5 May 2022 21:50:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E89E10F262;
...
Subject: Re: [Intel-gfx] [v2,
 1/4] drm/i915/huc: drop intel_huc_is_authenticated

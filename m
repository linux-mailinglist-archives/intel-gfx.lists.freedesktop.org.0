...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 455872786FD
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Sep 2020 14:21:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1FEC6ECBA;
...
Subject: [Intel-gfx] [RFC 2/7] drm/edid: Parse MAX_FRL field from HFVSDB
 block

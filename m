...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 90DA41C82E3
	for <lists+intel-gfx@lfdr.de>; Thu,  7 May 2020 08:57:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 019E76E91E;
	Thu,  7 May 2020 06:57:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E11866E91E
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 May 2020 06:56:59 +0000 (UTC)
IronPort-SDR: WNjarleibl1MQEbDqhjTkTJFb1Zsc97+XReyLVbnJfmoHwpG0vWtzN7HJAwMTeyHX2B+EnMcYh
 g4OHZgNQEn8w==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 May 2020 23:56:52 -0700
IronPort-SDR: uTfk2qugsefdKDmdVpKtoqd9SghSvZmBg4fhdwdQwTRdV9VurYsn3lu4GQSBTJ0NmPc2qSaRiv
 fMEiZ9EuW3Uw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,362,1583222400"; d="scan'208";a="370025614"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by fmsmga001.fm.intel.com with SMTP; 06 May 2020 23:56:50 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 07 May 2020 09:56:49 +0300
Date: Thu, 7 May 2020 09:56:49 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <20200507065649.GY6112@intel.com>
...
In-Reply-To: <20200506151528.GA8813@ideak-desk.fi.intel.com>
...
> > +	struct drm_i915_private *dev_priv =3D to_i915(encoder->base.dev);
> > +
> > +	return intel_de_read(dev_priv, GEN8_DE_PORT_ISR) & GEN8_PORT_DP_A_HOT=
PLUG;
> > +}
> > +
...
> >  intel_ddi_init_hdmi_connector(struct intel_digital_port *intel_dig_por=
t)
> >  {
> > @@ -4534,6 +4624,25 @@ void intel_ddi_init(struct drm_i915_private *dev=
...
> > @@ -5447,25 +5447,6 @@ static bool cpt_digital_port_connected(struct in=
tel_encoder *encoder)
> >  	return intel_de_read(dev_priv, SDEISR) & bit;
> >  }
> >  =
...
> >  {
> >  	struct drm_i915_private *dev_priv =3D to_i915(encoder->base.dev);
> > @@ -5516,88 +5497,14 @@ static bool ilk_digital_port_connected(struct i=
...
> > -
> > -	if (encoder->hpd_pin =3D=3D HPD_PORT_A)
> > -		return intel_de_read(dev_priv, GEN8_DE_PORT_ISR) & GEN8_PORT_DP_A_HO=
TPLUG;
> > -	else
> > -		return cpt_digital_port_connected(encoder);
> > -}
...
> > -}
> > -
> > -static bool intel_combo_phy_connected(struct drm_i915_private *dev_pri=
v,
> > -				      enum phy phy)
> > -{
> > -	if (HAS_PCH_MCC(dev_priv) && phy =3D=3D PHY_C)
...
> >  /*
> > @@ -5611,44 +5518,15 @@ static bool icp_digital_port_connected(struct i=
ntel_encoder *encoder)
> >   *
> >   * Return %true if port is connected, %false otherwise.
> >   */
> > -static bool __intel_digital_port_connected(struct intel_encoder *encod=
er)
> > -{
> > -	struct drm_i915_private *dev_priv =3D to_i915(encoder->base.dev);
> > -
...
> >  	return is_connected;
> >  }
> > @@ -7852,6 +7730,23 @@ bool intel_dp_init(struct drm_i915_private *dev_=
priv,
> >  =
...
> > @@ -484,8 +484,9 @@ static bool intel_tc_port_needs_reset(struct intel_=
digital_port *dig_port)
> >   * connected ports are usable, and avoids exposing to the users object=
s they
> >   * can't really use.
> >   */
...
> >  u32 intel_tc_port_get_pin_assignment_mask(struct intel_digital_port *d=
ig_port);
> >  int intel_tc_port_fia_max_lane_count(struct intel_digital_port *dig_po=
rt);
> > -- =

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A9CD4AD888
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 14:12:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0AA810E32E;
	Tue,  8 Feb 2022 13:12:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x633.google.com (mail-ej1-x633.google.com
 [IPv6:2a00:1450:4864:20::633])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 51ED210E3B2
 for <intel-gfx@lists.freedesktop.org>; Tue,  8 Feb 2022 13:12:03 +0000 (UTC)
Received: by mail-ej1-x633.google.com with SMTP id d10so52233401eje.10
 for <intel-gfx@lists.freedesktop.org>; Tue, 08 Feb 2022 05:12:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:mail-followup-to:references
 :mime-version:content-disposition:content-transfer-encoding
 :in-reply-to; bh=W0nOw/oIhCLTIBhVCN40imRA/3NBwGLs8oJWztrRgYc=;
 b=LUY6fumq7mUu2SZN99vw4Ox9tjuuzSxkMbO/7gDUm8sSlK2wre64bycLinZl9+zrUn
 RcofK9MO4HJX58RFCzWg9MAjOUX8mydMjLvmcWCJVU2deu0h8Bm2y2UOnkhB5BRG0kMb
 53uuXXac2RlLDGqgQeb9eto7+XhrRPjEtZgzc=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112;
 h=x-gm-message-state:date:from:to:cc:subject:message-id
 :mail-followup-to:references:mime-version:content-disposition
 :content-transfer-encoding:in-reply-to;
 bh=W0nOw/oIhCLTIBhVCN40imRA/3NBwGLs8oJWztrRgYc=;
 b=
X-Gm-Message-State: AOAM531cENu5jt6Vd67bXIsjHRY/4jsWAV696bus+YM1DepkeYUKEKoM
 feqZveyTfpOdi8jR8intB7hrBg==
X-Google-Smtp-Source: ABdhPJzpCFIr3opUK0nBxpOLtF92PRF8lWXRBaUQdppijWELPAbFxWWwFsSTsHWRT0ob8hTMT4tiIQ==
X-Received: by 2002:a17:906:c105:: with SMTP id
 do5mr3587015ejc.165.1644325919754; 
 Tue, 08 Feb 2022 05:11:59 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id lh14sm3484532ejb.207.2022.02.08.05.11.58
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 08 Feb 2022 05:11:59 -0800 (PST)
Date: Tue, 8 Feb 2022 14:11:56 +0100
From: Daniel Vetter <daniel@ffwll.ch>
To: Lucas De Marchi <lucas.demarchi@intel.com>
Message-ID: <YgJsHIBUNpEXdNmV@phenom.ffwll.local>
Mail-Followup-To: Lucas De Marchi <lucas.demarchi@intel.com>,
 ...
 christian.koenig@amd.com, airlied@linux.ie, lyude@redhat.com,
...
Subject: Re: [Intel-gfx] [PATCH v3] dma-buf-map: Rename to iosys-map
...
> --- a/MAINTAINERS
> +++ b/MAINTAINERS
> @@ -5675,7 +5675,7 @@ T:	git git://anongit.freedesktop.org/drm/drm-misc
...
> @@ -200,7 +200,7 @@ static void *cma_heap_do_vmap(struct cma_heap_buffer *buffer)
>  	return vaddr;
>  }
>  
...
>  	void *vaddr;
> @@ -209,7 +209,7 @@ static int cma_heap_vmap(struct dma_buf *dmabuf, struct dma_buf_map *map)
...
>  	}
>  
> @@ -220,14 +220,14 @@ static int cma_heap_vmap(struct dma_buf *dmabuf, struct dma_buf_map *map)
>  	}
>  	buffer->vaddr = vaddr;
>  	buffer->vmap_cnt++;
> -	dma_buf_map_set_vaddr(map, buffer->vaddr);
...
>  	struct cma_heap_buffer *buffer = dmabuf->priv;
>  
> @@ -237,7 +237,7 @@ static void cma_heap_vunmap(struct dma_buf *dmabuf, struct dma_buf_map *map)
>  		buffer->vaddr = NULL;
>  	}
>  	mutex_unlock(&buffer->lock);
> -	dma_buf_map_clear(map);
...
>  
>  	/*
> @@ -2316,7 +2316,7 @@ static int drm_fb_helper_generic_probe(struct drm_fb_helper *fb_helper,
...
> @@ -135,7 +135,7 @@ static void tegra_bo_unpin(struct device *dev, struct sg_table *sgt)
...
>  	if (obj->vaddr)
>  		return;
> @@ -650,17 +650,17 @@ static int tegra_gem_prime_mmap(struct dma_buf *buf, struct vm_area_struct *vma)

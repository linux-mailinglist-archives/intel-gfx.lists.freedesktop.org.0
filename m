...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9996228C02C
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Oct 2020 21:00:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 63DDC6E55E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 0/5] Introduce drm scaling filter property

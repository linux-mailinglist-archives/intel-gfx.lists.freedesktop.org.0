...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 505555888F9
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Aug 2022 11:00:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8587910EE93;
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915: Use of BARs names instead of
 numbers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 43E9C6EE8F3
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 22:21:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64E5010E7EB;
	Tue, 25 Apr 2023 20:21:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3459D10E7E9
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Apr 2023 20:21:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682454102; x=1713990102;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=b4KyGg/dKRV2jHZ7P5g0uftXr7Bl3EqtwJCCpZMfg+Q=;
 b=nmh0RapDJH7ng1f/n7lRGSqvm4wYv8fjslbCHcX5e6t32IFNtBAQ3rXy
 TUZgBCUgpldwkytVPxqbvOn+KTqtI9QMOEaR52lvs8siHeUIRMavmVeT2
 N8V6PXjpldvR6t80zi9nvyjhQtMGIc5g/CtDGsmyLirG+Zj9P33yOoGDe
 MdjQJnW3Ne+UDM4sXWhUdsh7YPjb6gq7ZC01iJiiWQ/lkXfHYdspDXXzX
 FS5Cv8Qif42PMsM05Xvf8gDODsRO/BxqYZvprxSlVxD9UpvbG5jGufn1/
 ExOFBpVw8DJaMdPomwfvOdLVU0BFL+EPQHCIMJErYi+YfqHl+YHWeSghx w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="409854261"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="409854261"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:21:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="693663107"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="693663107"
Received: from aazuev-mobl.ccr.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.252.59.124])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:21:26 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:20:56 +0300
Message-Id: <20230425202056.1143994-8-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 7/7] drm/i915/display: provision to suppress

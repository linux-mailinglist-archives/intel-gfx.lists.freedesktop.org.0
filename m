...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E46F49C679
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jan 2022 10:40:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEF3010E7E5;
...
Subject: [Intel-gfx] [PATCH v2 01/11] lib/string_helpers: Consolidate string

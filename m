...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E6A4288621
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Oct 2020 11:42:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 691C86EC96;
...
Subject: [Intel-gfx] [PATCH v2 03/12] drm/i915: vgpu pv command buffer
 transport protocol

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB91E5293FD
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:57:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 456E310E8CE;
...
Subject: [Intel-gfx] [PATCH v2 04/27] dyndbg: drop EXPORTed

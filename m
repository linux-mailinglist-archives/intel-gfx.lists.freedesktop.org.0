...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0728B3B27C1
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 325B76EA40;
	Thu, 24 Jun 2021 06:47:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D18B6EA06;
 Thu, 24 Jun 2021 06:47:31 +0000 (UTC)
IronPort-SDR: ofIM56U8htHPuAflDkGnstNczOA1HkvZ6+T7gsoUDotkWBNx3cqZoN/D3svKw2Rtr+kXfno4q4
 SnNZWlZOTWxg==
X-IronPort-AV: E=McAfee;i="6200,9189,10024"; a="207346769"
X-IronPort-AV: E=Sophos;i="5.83,295,1616482800"; d="scan'208";a="207346769"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jun 2021 23:47:26 -0700
IronPort-SDR: /n+ZQEO1Fb9Zd0SjcORlJWZH8nvLN9dpIKad0eGRSTGlRyobKjzNzJ0y01v+zXsWsZY5ETFbGY
 gOeJziPykRjw==
X-IronPort-AV: E=Sophos;i="5.83,295,1616482800"; d="scan'208";a="556390956"
...
Date: Thu, 24 Jun 2021 00:05:00 -0700
Message-Id: <20210624070516.21893-32-matthew.brost@intel.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <20210624070516.21893-1-matthew.brost@intel.com>
References: <20210624070516.21893-1-matthew.brost@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 31/47] drm/i915/guc: Reset implementation for
 new GuC interface

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 873D13C7CB7
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Jul 2021 05:16:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E5236E1A2;
	Wed, 14 Jul 2021 03:16:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C5BF56E15C
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Jul 2021 03:15:59 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10044"; a="232085878"
X-IronPort-AV: E=Sophos;i="5.84,238,1620716400"; d="scan'208";a="232085878"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jul 2021 20:15:59 -0700
X-IronPort-AV: E=Sophos;i="5.84,238,1620716400"; d="scan'208";a="494031587"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jul 2021 20:15:59 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 13 Jul 2021 20:15:31 -0700
Message-Id: <20210714031540.3539704-42-matthew.d.roper@intel.com>
X-Mailer: git-send-email 2.25.4
In-Reply-To: <20210714031540.3539704-1-matthew.d.roper@intel.com>
References: <20210714031540.3539704-1-matthew.d.roper@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 41/50] drm/i915/dg2: Add MPLLB programming
 for SNPS PHY
...
cHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKaW5kZXggMjg3MmI5Yjc3ZDE1Li4y
MzU3Yjc5ZDY1NzcgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50
...
bmRleCAwZGM3OThiYzFmMTkuLjE0MjJmYmNlMzZjYiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv

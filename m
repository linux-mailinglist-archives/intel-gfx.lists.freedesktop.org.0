...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C43DAACC5D4
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Jun 2025 13:53:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B59010E6D7;
	Tue,  3 Jun 2025 11:53:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Kck2CUmh";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0524C10E660;
 Tue,  3 Jun 2025 11:53:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1748951619; x=1780487619;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GFube+gC6502VTBuZaY4++giPU/6FLO2ZUzV5+IsC6Q=;
 b=Kck2CUmhjrgqEXScbCPcJ1zgARVDmlIDgekCSiPtmSwtGU+O3FrY4e1+
 V7ntXCkRgkb08M4OIHeCD2FxCZUaad0dAkDj3qc8W4peINf5j8Se+BU9L
 qaKn25WGyeB5db6hNzcAzxnbxNlQQZyKoOUNJ8dxIFBld90vr2oOo8u6f
 N1E04iY1xG8llwPBDMNLDPDBDTGiH4R6kwtDmDWDV7Xbuq9CNF4MEmd24
 KNC82DIqtT1orVJUkPvTn7/81mamWaYyhSgDuzINjqFoVsfkmf/UriWBk
 iS8dHJWYgBuo8ZosKOHdsMXMV3+VuuF/IxJioV4CpN7Jo3bHofMed4dID A==;
X-CSE-ConnectionGUID: EEp2JXNYRSOh9Ov8FeQmMw==
X-CSE-MsgGUID: itafyGjhS3eWUtqm3XlfiA==
X-IronPort-AV: E=McAfee;i="6700,10204,11451"; a="53616436"
X-IronPort-AV: E=Sophos;i="6.16,206,1744095600"; d="scan'208";a="53616436"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2025 04:53:38 -0700
X-CSE-ConnectionGUID: ZRHBYvqUTdqXQmWc/47hlg==
X-CSE-MsgGUID: 8hcx0x7PRR+IuQ+8qpjsWg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,206,1744095600"; d="scan'208";a="149993325"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2025 04:53:33 -0700
...
Subject: [PATCH v12 02/10] mtd: intel-dg: implement region enumeration
Date: Tue,  3 Jun 2025 14:39:45 +0300
Message-ID: <20250603113953.3599816-3-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DBF2A7B01D4
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Sep 2023 12:28:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BDB8C10E4D0;
...
Subject: [Intel-gfx] [PATCH v5 1/7] drm/i915: Unregister in-kernel clients

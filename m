...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 30A3230FADD
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Feb 2021 19:11:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8437B6EE20;
	Thu,  4 Feb 2021 18:11:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F0DE56EE20
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Feb 2021 18:11:35 +0000 (UTC)
IronPort-SDR: 7/EJc8qUa2v5LC5Rjes0DCPw4B/13dLWStQq/b5ts+fesXOMH4Sayscd1Ys17SNp5Z6hM96i/T
 o1mFCe5c85cw==
X-IronPort-AV: E=McAfee;i="6000,8403,9885"; a="245370440"
X-IronPort-AV: E=Sophos;i="5.81,153,1610438400"; d="scan'208";a="245370440"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2021 10:11:33 -0800
IronPort-SDR: 4l8yU/Nl5Gekd5J09cWMuybc+gaGhjDDvhm720GLHDis7vLBO9yAbJb+gqb8L5A/eXcuJ7ZeQY
 i+Hc4tKtGJ6w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,153,1610438400"; d="scan'208";a="356814378"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.171])
 by fmsmga007.fm.intel.com with SMTP; 04 Feb 2021 10:11:30 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 04 Feb 2021 20:11:30 +0200
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  4 Feb 2021 20:10:47 +0200
Message-Id: <20210204181048.24202-14-ville.syrjala@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 13/14] drm/i915: Relocate
...

...
cnVjdCBpbnRlbF9jcnRjX3N0YXRlICpjcnRjX3N0YXRlKQogewpAQCAtMzQ2MSw2ICszNDA1LDYy

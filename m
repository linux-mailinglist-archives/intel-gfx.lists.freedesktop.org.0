...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CCD9B2C6C3D
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 20:58:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C009C6F3C6;
	Fri, 27 Nov 2020 19:58:51 +0000 (UTC)
...
User-Agent: alot/0.9
Subject: Re: [Intel-gfx] [RFC PATCH 006/162] drm/i915: split gen8+ flush and
 bb_start emission functions to their own file

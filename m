...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9163C3EB7A8
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Aug 2021 17:20:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 812166E86A;
...
Subject: [Intel-gfx] [PATCH v5 8/9] amdgpu_ucode: reduce number of pr_debug
 calls

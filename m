...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0769911E207
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2019 11:34:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 58B526E405;
	Fri, 13 Dec 2019 10:34:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 301A06E405
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Dec 2019 10:34:52 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 13 Dec 2019 02:34:51 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,309,1571727600"; d="scan'208";a="220896299"
Received: from slisovsk-lenovo-ideapad-720s-13ikb.fi.intel.com ([10.237.72.89])
 by fmsmga001.fm.intel.com with ESMTP; 13 Dec 2019 02:34:49 -0800
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 13 Dec 2019 12:31:55 +0200
Message-Id: <20191213103158.29520-2-stanislav.lisovskiy@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 1/4] drm/i915: Remove skl_ddl_allocation
 struct
...
index 53dc310a5f6d..792bdb65ee14 100644
...
index ce1b64f4dd44..01922492be3c 100644
...
index fdae5a919bc8..42a7f9785e47 100644
...
index 5aad9d49a528..ad4404411fb3 100644
--- a/drivers/gpu/drm/i915/intel_pm.c
+++ b/drivers/gpu/drm/i915/intel_pm.c
@@ -3599,16 +3599,16 @@ bool ilk_disable_lp_wm(struct drm_device *dev)
...
@@ -3616,9 +3616,9 @@ static u8 intel_enabled_dbuf_slices_num(struct drm_i915_private *dev_priv)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9831121FF2C
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C26FB6E9C1;
...
Subject: [Intel-gfx] [PATCH v2 19/59] drm/kmb: Added ioremap/iounmap for
 register access

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C989114685E
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 13:48:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7B5A6FC74;
...
Subject: [Intel-gfx] [PATCH v4 2/2] drm/debugfs: also take per device driver

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C5134C99ED
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Mar 2022 01:34:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EEC3910E920;
...
Subject: [Intel-gfx] [PATCH v3 5/8] drm/i915/guc: Move lrc desc setup to
 where it is needed

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B5D655BB3A9
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Sep 2022 22:48:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A0CB110E524;
	Fri, 16 Sep 2022 20:48:32 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915/gt: Bump the reset-failure timeout to
 60s

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D468393ACB
	for <lists+intel-gfx@lfdr.de>; Fri, 28 May 2021 02:58:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0A406F537;
	Fri, 28 May 2021 00:58:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 633EC6F537
 for <intel-gfx@lists.freedesktop.org>; Fri, 28 May 2021 00:58:53 +0000 (UTC)
IronPort-SDR: QWK9sl8mJzM87YxUMh00UnKsqCaE4VYxzaHyk+vqeU76GgkIHZkiGxol6NuKJc0Can8Jnc902k
 uFbQD/CkATiA==
X-IronPort-AV: E=McAfee;i="6200,9189,9997"; a="288460436"
X-IronPort-AV: E=Sophos;i="5.83,228,1616482800"; d="scan'208";a="288460436"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 May 2021 17:58:52 -0700
IronPort-SDR: aK074of3ANhjMXi+lPaJb4JBsrBRKaNd/o+5pTZTZAX7xyezgxdBYHwu20OE8L74kC5jlwbMn5
 R7byq6czAvTw==
X-IronPort-AV: E=Sophos;i="5.83,228,1616482800"; d="scan'208";a="445264049"
Received: from dbstims-dev.fm.intel.com ([10.1.27.177])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 May 2021 17:58:52 -0700
From: Dale B Stimson <dale.b.stimson@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 May 2021 17:58:46 -0700
Message-Id: <20210528005847.35405-1-dale.b.stimson@intel.com>
X-Mailer: git-send-email 2.31.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 0/1] drm/i915/dg1: Add HWMON power sensor
 support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B8696BDEF5
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 03:40:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 811EA10E0A2;
...
Subject: Re: [Intel-gfx] [PATCH v7 22/22] docs: vfio: Add vfio device cdev
 description

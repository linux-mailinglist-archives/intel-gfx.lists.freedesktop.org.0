...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF98B3F4F29
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Aug 2021 19:15:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6473389C49;
	Mon, 23 Aug 2021 17:15:07 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 0/6] drm: update locking for modesetting

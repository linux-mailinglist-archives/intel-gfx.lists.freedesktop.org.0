...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 73E57D69C7
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Oct 2019 20:55:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A765D892C1;
	Mon, 14 Oct 2019 18:55:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B815E892C1
 for <intel-gfx@lists.freedesktop.org>; Mon, 14 Oct 2019 18:55:32 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga101.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 14 Oct 2019 11:55:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.67,296,1566889200"; d="scan'208";a="370213904"
...
Message-Id: <20191014185531.62855-1-umesh.nerlige.ramappa@intel.com>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/3] drm/i915/perf: Add helper macros for
...
ZXJmLmMKaW5kZXggMzY2NTgwNzAxYmEyLi5kNTRkM2E0MWNlY2EgMTAwNjQ0Ci0tLSBhL2RyaXZl
cnMvZ3B1L2RybS9pOTE1L2k5MTVfcGVyZi5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5
MTVfcGVyZi5jCkBAIC0zNDU1LDU2ICszNDU1LDU4IEBAIHN0YXRpYyBib29sIGdlbjhfaXNfdmFs
...
CiBzdGF0aWMgdTMyIG1hc2tfcmVnX3ZhbHVlKHUzMiByZWcsIHUzMiB2YWwpCkBAIC0zNTEzLDE0
ICszNTE1LDE0IEBAIHN0YXRpYyB1MzIgbWFza19yZWdfdmFsdWUodTMyIHJlZywgdTMyIHZhbCkK

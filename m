...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 61516436AA
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jun 2019 15:34:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4203289A59;
...
Subject: [Intel-gfx] [PATCH] i915: gvt: no need to check return value of

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D2616D2B0E
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 00:12:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75A9910F325;
	Fri, 31 Mar 2023 22:12:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yw1-x1135.google.com (mail-yw1-x1135.google.com
 [IPv6:2607:f8b0:4864:20::1135])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 18CEB10F30F
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Mar 2023 22:12:26 +0000 (UTC)
Received: by mail-yw1-x1135.google.com with SMTP id
 00721157ae682-545e907790fso325069487b3.3
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Mar 2023 15:12:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1680300745;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=Uv8FxK/sJfiOPTi/SGRc9DA0a0QyEJoBlhkVuBwZq4Y=;
 b=btdkpg5Q7QDHfrbkTCD53PxvswXRUkZXejQ3/U3mfTeE+4UqYbJZFOjKK59H8uZqso
 zR6sz7WB2Nk1o4goCr2HrqmJNe4qtlrSeJg6yV7tXDwYKPNNwIYCEcA2yxeFbYWXH5pR
 yUzRQbGu2S6Dq0Ee6BKiCFAvDAEiqMD24HFGY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1680300745;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=Uv8FxK/sJfiOPTi/SGRc9DA0a0QyEJoBlhkVuBwZq4Y=;
 b=
X-Gm-Message-State: AAQBX9erasdDwTKYygYa82xf4+gyp1WhfOrFYrVW1r3+qZdCFJMRnn2p
 ZalFgtBCvY7bfI9PlH479UQvGQ==
X-Google-Smtp-Source: AKy350b1UJYTgnBmYXQt424dkxsST/rXy0d8BslKxetf/KBoBP+ZFFVh2yyu3tgNrVhVkdBeJ/qTBg==
X-Received: by 2002:a0d:ca16:0:b0:545:610c:ca92 with SMTP id
 m22-20020a0dca16000000b00545610cca92mr24737994ywd.50.1680300744812; 
 Fri, 31 Mar 2023 15:12:24 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:a8f6:869a:3ef5:e1d])
 by smtp.gmail.com with UTF8SMTPSA id
 l197-20020a8170ce000000b00545b02d4af5sm794641ywc.48.2023.03.31.15.12.23
...
Date: Fri, 31 Mar 2023 18:12:06 -0400
Message-Id: <20230331221213.1691997-5-markyacoub@google.com>
...
Subject: [Intel-gfx] [PATCH v8 04/10] drm/hdcp: Expand HDCP helper library

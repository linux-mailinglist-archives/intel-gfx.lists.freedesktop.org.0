...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ACFA17EAC5D
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Nov 2023 10:02:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09EC010E1E3;
	Tue, 14 Nov 2023 09:02:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D503C10E1E3
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Nov 2023 09:02:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699952525; x=1731488525;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=VfTqWTtuoIWNt9CAkogBVN+WZyxHUNJ5CnKgpE/NFDE=;
 b=XxMBBWk4dbdoAnGfMa67KEB84TB+oEoJp/wlszI2hTtq33l1q4Gal41g
 bwfweYokH+DZj13qNFL9/EBavOA1JN+NXVYCx3TxWFkdb7z+unanSN2SH
 GiyOmcn6IcDwShFsPJwP5NdW5ynl7eRcEiTuNAf6CFUyCLpF13vtCwrEt
 511flLCJF0NUylbHaFHeCxkIfcbTellZf4mBgxJMn3rByRgassXPA8QBK
 +5yRFpiNtix20yRAItv8L4LvD4Xfov/XOgW5dzAN0Rqfh6JTRd44xmHAy
 YX9bGGHLsmbyHfWH6OkRrSTLA3cJFCMx06tnKlEV1nlVVZad71tRHGWiz A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10893"; a="393472509"
X-IronPort-AV: E=Sophos;i="6.03,301,1694761200"; d="scan'208";a="393472509"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2023 01:02:05 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10893"; a="758108721"
X-IronPort-AV: E=Sophos;i="6.03,301,1694761200"; d="scan'208";a="758108721"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga007.jf.intel.com with SMTP; 14 Nov 2023 01:02:03 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 14 Nov 2023 11:02:01 +0200
Date: Tue, 14 Nov 2023 11:02:01 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Message-ID: <ZVM3iWjXyx6AnxfP@intel.com>
...
Subject: Re: [Intel-gfx] [PATCH 1/4] drm/i915: move *_crtc_clock_get() to
 intel_dpll.c

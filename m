...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A3B9AB5AED
	for <lists+intel-gfx@lfdr.de>; Tue, 13 May 2025 19:17:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6059510E230;
	Tue, 13 May 2025 17:17:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="ZdlOwEgt";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6A6A410E230
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 May 2025 17:17:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1747156637;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=WXi47cxjBm3jaOjYLGIffilivDQE+iYxrxe28Eqtjt0=;
 b=ZdlOwEgtQh+kGDvS9Mpd1twiykDlLXAxOtch0nI7vwhFVVBEzzy/SMJ6vkdB1oVbCyw5xw
 KiUXEy/WvGN5dwVxqyNbcocPaJQGgQzA00nA9rcXtosjqLiec201pEjUFy4t85N62ww+By
 kdjCXs3OBIr9TpdmkH4a3G1EoIHvhjA=
Received: from mail-wr1-f70.google.com (mail-wr1-f70.google.com
 [209.85.221.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-295-7EXd-kYIO_ijvp19piEcdA-1; Tue, 13 May 2025 13:17:14 -0400
X-MC-Unique: 7EXd-kYIO_ijvp19piEcdA-1
X-Mimecast-MFC-AGG-ID: 7EXd-kYIO_ijvp19piEcdA_1747156633
Received: by mail-wr1-f70.google.com with SMTP id
 ffacd0b85a97d-3a1c86b62e8so2141408f8f.1
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 May 2025 10:17:14 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :message-id:reply-to;
 bh=WXi47cxjBm3jaOjYLGIffilivDQE+iYxrxe28Eqtjt0=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCUPbOdXQBEntG6yo+erEKrFLTPDVIw3oQZ0dj5/4j/MZBt+GzyUT5XU0LB4kYGExYYGxyVGvVRx5yo=@lists.freedesktop.org
X-Gm-Message-State: AOJu0Yzg5QQyRZGP9S29s2DBxyfPXHBon9PLdTmUM/hQ6yISnQdUluWW
 HN/GnapOik/L5PXxFwQl+60v1L1FweeqeK6+zfkyAG97eQtsYyClyWFAi0pX2VxJTNLy3LVEaZh
 98agJ1LzO/J9mfudMYY32iAjbPZlpkdlnWSW40FVcwmqdoK6BsFPB2kfKBoTcmFCBAA==
X-Gm-Gg: 
X-Received: by 2002:a05:6000:144a:b0:39e:dce8:1c07 with SMTP id
 ffacd0b85a97d-3a34991ec80mr97253f8f.46.1747156633339; 
...
X-Mimecast-MFC-PROC-ID: 9kND4veeg1SYdQA6Z45hOK0GrrzCxPNPE9lZMZ8fetc_1747156633

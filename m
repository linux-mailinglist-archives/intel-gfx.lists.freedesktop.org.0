...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B08579AC59
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Sep 2023 01:09:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 701B110E356;
...
Subject: [Intel-gfx] [PATCH v6 10/22] dyndbg: tighten fn-sig of

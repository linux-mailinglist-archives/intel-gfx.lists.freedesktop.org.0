...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73FA47C6775
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Oct 2023 10:16:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 373A810E45A;
	Thu, 12 Oct 2023 08:16:02 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C974110E46F;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=PRebmyDH50utciPFwqa7O3shuhf57IGoHhVfz8Wwcuw=;
 b=fY9WIdKJ17lEGjC2iXmtikoJUHKx33HttWZMvonWJ8uVz64RivKBkt8Q
 Gc2JzDOy4wOLkTL9/2ec/8eOlTeVCSJkktCc8o5f4JTHuL9tGy3mfEZ7z
 z4+D3AYiAF+LsS2zM2wslGZaCFsH8OBw0ITod140dGX9r8dtP0MhiRHXW
 9JmHMDleyofudF/UrVkAWnqLnHN91u0VrFhoKsKauxoRud3PvsX0VbJcv
 qE0OZeOkSqz9VrX6wf3tX2eee8Wrj27qTWzq/h84LXS0tNlbejf/WC74v
 oKmEZzMBy3CK5SD8egH8VGbbx5axOF2a7wrKUmEBtCEybrOkIpT7UTUK4 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10860"; a="3454678"
X-IronPort-AV: E=Sophos;i="6.03,218,1694761200"; 
   d="scan'208";a="3454678"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Oct 2023 01:16:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10860"; a="783599309"
X-IronPort-AV: E=Sophos;i="6.03,218,1694761200"; d="scan'208";a="783599309"
Received: from maloneyj-mobl.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.213.239.225])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Oct 2023 01:15:58 -0700
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: igt-dev@lists.freedesktop.org,
	Intel-gfx@lists.freedesktop.org
Date: Thu, 12 Oct 2023 09:15:41 +0100
Message-Id: <20231012081547.852052-4-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH i-g-t 3/9] tests/i915/drm_fdinfo: Add some
 memory info tests

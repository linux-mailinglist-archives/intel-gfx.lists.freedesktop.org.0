...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CEA7A716C4B
	for <lists+intel-gfx@lfdr.de>; Tue, 30 May 2023 20:25:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0219F10E402;
...
Subject: [Intel-gfx] [PATCH 0/2] drm/i915/gt: Fix recent kCFI violations

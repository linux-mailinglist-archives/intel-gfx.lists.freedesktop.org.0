...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 231B35F286C
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Oct 2022 08:14:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01ECB10E21C;
...
Subject: [Intel-gfx] [PATCH v2 07/17] drm/i915/vm_bind: Add support to

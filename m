...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44CC6529452
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:58:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E87DA10F5E0;
...
Subject: [Intel-gfx] [PATCH v2 20/27] drm_print: refine drm_debug_enabled
 for jump-label

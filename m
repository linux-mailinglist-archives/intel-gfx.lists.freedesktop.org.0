...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DCE521B0DD9
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Apr 2020 16:04:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DC416E593;
	Mon, 20 Apr 2020 14:04:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98A7D6E593
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2020 14:04:49 +0000 (UTC)
IronPort-SDR: VspVAeTBRwcAddzH3SmzfE4HHan582r/DPlLauh+v7vbdZRKNnHqSm/2m1GKyN7ibFysND5+6J
 3lCMAtVwyRog==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Apr 2020 07:04:48 -0700
IronPort-SDR: eUB+6aCHPphXhPj9iAzwLtn2PBV2U70AS/lhpDFMZNXpQO/lN+lEqpgZZx9TEhfWFmiuIv9u+W
 tAQJHJ/ihCsw==
X-IronPort-AV: E=Sophos;i="5.72,406,1580803200"; d="scan'208";a="455707132"
Received: from iastakh-mobl.ccr.corp.intel.com (HELO localhost)
 ([10.252.63.229])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Apr 2020 07:04:46 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 20 Apr 2020 17:04:38 +0300
Message-Id: <20200420140438.14672-2-jani.nikula@intel.com>
...
index 1aab93a94f40..780bffb24131 100644
...
index bae1d89875d6..5abe7f2087d6 100644
...
@@ -8137,7 +8137,7 @@ static void intel_panel_sanitize_ssc(struct drm_i915_private *dev_priv)
 	}
 }
...
@@ -12830,7 +12830,7 @@ static void intel_dump_crtc_timings(struct drm_i915_private *i915,
...
index fa46ea6c6e01..abac186690a0 100644
--- a/drivers/gpu/drm/i915/display/intel_display_power.c
+++ b/drivers/gpu/drm/i915/display/intel_display_power.c
@@ -4635,9 +4635,8 @@ static void intel_power_domains_sync_hw(struct drm_i915_private *dev_priv)
...
index a71d29136595..201c4217950b 100644
--- a/drivers/gpu/drm/i915/display/intel_dp.c
+++ b/drivers/gpu/drm/i915/display/intel_dp.c
@@ -6827,9 +6827,9 @@ static const struct hdcp2_dp_msg_data hdcp2_dp_msg_data[] = {
 	  0, 0 },
 };
...
index d54833a1578f..6f40bfee7304 100644

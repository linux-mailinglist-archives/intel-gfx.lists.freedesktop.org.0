...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB7A2453B09
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Nov 2021 21:37:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B0166E1A7;
...
Subject: [Intel-gfx] [PATCH v3 2/6] drm: improve drm_buddy_alloc function

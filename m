...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F19C368F42C
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Feb 2023 18:17:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6EEFF10E7CD;
	Wed,  8 Feb 2023 17:17:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1429810E7CD
 for <intel-gfx@lists.freedesktop.org>; Wed,  8 Feb 2023 17:17:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675876671; x=1707412671;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=kLlkf3n94GohKwO4iNNXQQ/A7d9k60318LAJh/tpNyE=;
 b=XDVpieJYRM4YTwGvoYHX7DNB1wSwchNOA29gL8NXWF9161jYBTH50jzD
 RUNC842M9dmrxoxkiBkw0MtcrnOkCB3PIwZtrowYyVFyAUmMVmcgBoLvb
 nBITdcb288rHaxHz17qzpMu8m+y9k8AYEoc/Mol/O1SC8lbvJxXSEd+E4
 eA6b8YYaV3whFbv1bhJ6S+/3mNTXp0M4FnBHm64pNE+iHK0zL8+GEWnhn
 edpz7HwAJ9QA4uj07eg4PFU69ddIA5nwpoVBflMuEmLCUOLHZUQg71KUM
 OTmz9rk2ePJsGyxmK7mkmb8Dp21gweMCjXANt3gCoYhcDpHO7rimD+K/t w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10615"; a="313499438"
X-IronPort-AV: E=Sophos;i="5.97,281,1669104000"; d="scan'208";a="313499438"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2023 09:17:33 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10615"; a="669262075"
X-IronPort-AV: E=Sophos;i="5.97,281,1669104000"; d="scan'208";a="669262075"
...
To: Tomas Winkler <tomas.winkler@intel.com>, Daniele Ceraolo Spurio
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230025)(136003)(376002)(39860400002)(396003)(366004)(346002)(451199018)(66556008)(66946007)(8676002)(66476007)(41300700001)(2906002)(4326008)(8936002)(316002)(36756003)(83380400001)(110136005)(6486002)(5660300002)(6636002)(54906003)(44832011)(6512007)(186003)(26005)(478600001)(6506007)(86362001)(2616005)(107886003)(6666004)(38100700002)(82960400001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Feb 2023 17:17:29.2130 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 94E547A25C1
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Sep 2023 20:31:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33A9C10E66F;
...
Subject: [Intel-gfx] [PATCH v6 3/3] drm/i915/lrc: User PXP contexts requires
 runalone bit in lrc

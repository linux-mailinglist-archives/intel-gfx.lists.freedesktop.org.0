...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7BA705060A0
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Apr 2022 02:07:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDB6910E191;
	Tue, 19 Apr 2022 00:07:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7509F10E128
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 Apr 2022 00:07:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1650326873; x=1681862873;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WabxQjEmFXG+BT9kfyHDV+eTQ4xocJwVWxcxNYvZU0U=;
 b=P4MpVjpNiA21gj93ld3vBRI0q3T3MnqIfR5yK7lv0kEi5Nlni6wUZyOB
 zIeL6d5ut3+OkAqAp6kBcsR1/Q14jDXyUv51TqF6DFExrjRIEkDNVGJ3n
 qLY3dG52tzSoQ+bP8G4H6Wp8WQg1/ZLityF7TW3A0yBHqOQOsJLK2mGHA
 Hg1S+L7j+u9cTA4VndqUoPTZP/S6bLc4mAi75PrV3sSdssjmsaaHzg4LP
 V1KIwaHmzQLQuniuUTolIoy2ScxyCaL7aZYFhCKYTN+oQ4Zp3bF1+JzIE
 jGYNejiqVepdtJypyvc5+75jr5/0yDUMLE4GWnTezbfr0DvAtuwrTt8Dv Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10321"; a="326537808"
X-IronPort-AV: E=Sophos;i="5.90,271,1643702400"; d="scan'208";a="326537808"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Apr 2022 17:07:53 -0700
X-IronPort-AV: E=Sophos;i="5.90,271,1643702400"; d="scan'208";a="665586356"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Apr 2022 17:07:52 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 18 Apr 2022 17:07:31 -0700
Message-Id: <20220419000737.420867-2-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/7] drm/i915/gsc: add gsc as a mei auxiliary
 device
...
index 9b2b0dc44506c..2cc358f4564e0 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index b8d45d2593379..aa1e7f0b1fe4d 100644
...
index 7e37455ba88d0..cd0bf68062282 100644
...
index f0014c5072c9b..92394f13b42f3 100644
...
index 0163bba0959ec..44c6cb63ccbc8 100644
...
index 0a5c2648aaf07..5d8c8b4e2f7be 100644
...
index 9274417cd87af..a6cf9716d6aa9 100644
...
index fef71b242706a..1dd7b7de60029 100644

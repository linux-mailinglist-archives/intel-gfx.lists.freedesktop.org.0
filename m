...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 15B3940EC8E
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Sep 2021 23:26:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 806CB6E9D2;
...
Subject: [Intel-gfx] [PATCH 03/15] dmr/msm: cleanup:

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BBFEFAF6C8F
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jul 2025 10:13:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6774E10E7EA;
	Thu,  3 Jul 2025 08:13:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="QA4LT2GZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D1D1910E7E6
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Jul 2025 08:12:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1751530377;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type;
 bh=mzAmqCrGzYULhQVmt+vI7C3IoCgpWDVmftXFyp55eVc=;
 b=QA4LT2GZq7T62GV1awIphptKO/7IOs/qprNBHZ3rTriWj6MB6EoNhfRqfj/HpAyFgwX2hu
 WhVH9jypWF7x7u+9Sh/TrGGCiMBVct9CXoKMU4h4/2DFZr1rub68hyG3J4lvhumVltdrwI
 pjmTkqy7NkAiPcawvYHzipuefJueF4w=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-613-gVvDNgNZMESpkKSjfOU_MA-1; Thu, 03 Jul 2025 04:12:56 -0400
X-MC-Unique: gVvDNgNZMESpkKSjfOU_MA-1
X-Mimecast-MFC-AGG-ID: gVvDNgNZMESpkKSjfOU_MA_1751530375
Received: by mail-wr1-f71.google.com with SMTP id
 ffacd0b85a97d-3a523ce0bb2so2796789f8f.0
 for <intel-gfx@lists.freedesktop.org>; Thu, 03 Jul 2025 01:12:56 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1751530375; x=1752135175;
 h=content-disposition:mime-version:message-id:subject:cc:to:from:date
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=mzAmqCrGzYULhQVmt+vI7C3IoCgpWDVmftXFyp55eVc=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCUHoZ/FT2rBSEjCGauqoKuPh1QAtAH+XAl5FXhHYrYg8PkMrEW35Hvj31Rs5VHAJE7R9nEA87hx6ks=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YzKjIrDcKwc9+loeqU4K4jokdiSZpA3hp5kKkqGOucV+jF7ar4e
 fhsHP+ZvU+wch+qsKnndnzXYCM6XQXmONwmEOr/hUKaHUiaDKUzSivVu2QwjmfLc4T5T8SEZ9wr
 no5RjIffaH9vjtZ1V9zyvuKkHIbu/+45pz3+W266UDQVEvUu69D8lQCs3D7mE3IN5dvvbiA==
X-Gm-Gg: 
X-Received: by 2002:a5d:5e8b:0:b0:3a5:21c8:af31 with SMTP id
 ffacd0b85a97d-3b1fe5c067dmr4442979f8f.16.1751530374839; 

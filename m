...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 71E011ADE82
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 15:40:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70B536EBF6;
	Fri, 17 Apr 2020 13:40:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7A6B36EBF2
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Apr 2020 13:39:44 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 17 Apr 2020 15:39:27 +0200
Message-Id: <20200417133937.1980239-14-maarten.lankhorst@linux.intel.com>
...
index 833864dbeae7..ba69cd42354c 100644
...
index 4dd08c607f2c..f1b253c914c9 100644
--- a/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
+++ b/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
@@ -420,16 +420,17 @@ eb_pin_vma(struct i915_execbuffer *eb,
...
@@ -571,7 +572,7 @@ static inline int use_cpu_reloc(const struct reloc_cache *cache,
...
+static int eb_reserve_vma(struct i915_execbuffer *eb,
 			  ...
 			  u64 pin_flags)
 {
@@ -586,7 +587,7 @@ static int eb_reserve_vma(const struct i915_execbuffer *eb,
 			return err;
 	}
...
@@ -1398,7 +1404,7 @@ relocate_entry(struct i915_vma *vma,
 	}
...
@@ -1813,6 +1819,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2082,7 +2089,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2093,7 +2101,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2205,16 +2213,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2239,7 +2264,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2250,7 +2275,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2262,20 +2287,36 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2431,7 +2472,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -2886,33 +2927,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2985,9 +3000,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
-err_parse:
 ...
 err_vma:
@@ -3070,7 +3082,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3148,8 +3162,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index 9e0c7fcb756e..ee8c7926d0e3 100644

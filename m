...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED3C4589CEB
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Aug 2022 15:40:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 331A99451A;
...
Subject: [Intel-gfx] [PATCH v2 2/5] drm/gem: Take reservation lock for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C9536D1AD
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jul 2019 18:15:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7162F6E442;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 0sJQ==
Subject: [Intel-gfx] [PATCH v1 04/11] drm/ati_pcigart: drop dependency on
 drm_os_linux.h

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FA7B2B1BD5
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Nov 2020 14:25:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA8606E4CF;
	Fri, 13 Nov 2020 13:25:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CACE76E4D4
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Nov 2020 13:25:22 +0000 (UTC)
IronPort-SDR: 5PZNgaKGrGod3IPAzqlDu+h3ggT3H2XoEwIqWNrxa/mvB/lvq0JGzrZcXcaLXsLax/PW5vLeug
 z+lnhtylaTAQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9803"; a="170575463"
X-IronPort-AV: E=Sophos;i="5.77,475,1596524400"; d="scan'208";a="170575463"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Nov 2020 05:25:22 -0800
IronPort-SDR: vhkQsdsEuWCgel5titHwBXmzRMP2onn5ON7VgnkuzhJ9C2z0YC5k8p57SZKnylfeeaS+m2Ci1q
 o5YUk/0hQxJA==
X-IronPort-AV: E=Sophos;i="5.77,475,1596524400"; d="scan'208";a="357503693"
...
Date: Fri, 13 Nov 2020 15:24:37 +0200
Message-Id: <8a14a9224f1ea7df1f3bdf34f793772bcc6b7980.1605273766.git.jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <cover.1605273766.git.jani.nikula@intel.com>
References: <cover.1605273766.git.jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 7/9] drm/i915/pm: replace I915_READ()/WRITE()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D20557BA63
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 17:35:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BDF058F47E;
...
Subject: [Intel-gfx] [PATCH v4 21/41] drm: POC drm on dyndbg - use in core,
 2 helpers, 3 drivers.

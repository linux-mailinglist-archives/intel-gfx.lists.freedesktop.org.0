...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C903E58FEF7
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Aug 2022 17:14:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D166B3DC6;
	Thu, 11 Aug 2022 15:14:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 539ADB3D95
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Aug 2022 15:13:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1660230838; x=1691766838;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=L18PgJ9NN8GGQ++z6R1bmPVW8T8+oZF5488o2u9x4no=;
 b=CpsufVQqhT3VNX+ubOy+0z4+tZ9fTcxPgtFT3+2vAC06zLXqOUcO8iHh
 kg165vZfFOxPLtGmWZQRwHM+XyeCWyw/BkBpJe21l4DaC4TT5TAjL1zjX
 6OYRzsrq7/nTN2s0yDzN/F48scccp1QR68nboJk9eGWEoMEebcqoxkngc
 57Wsl85qI5/wMZETj4LILyjagxxUzeT446IdZZWhPzGeq9kbnWtzjbRon
 Lh9Nbuy9nM3vs60JpqHVHc6v8uFwe8faFRu2iSU44VTENpxbkGPW6VwW1
 +Vqbg8DuNkwi/j3wHgqPql91SH87xGoSuaQssc1rI08yzi0lxC2XydTit g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10436"; a="355376562"
X-IronPort-AV: E=Sophos;i="5.93,230,1654585200"; d="scan'208";a="355376562"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2022 08:09:41 -0700
X-IronPort-AV: E=Sophos;i="5.93,230,1654585200"; d="scan'208";a="781631780"
Received: from gdogaru-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.48.102])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Aug 2022 08:09:39 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 11 Aug 2022 18:07:33 +0300
Message-Id: <025e21466ace0f2e797d415f5a4792f509bb689c.1660230121.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 22/39] drm/i915: move and group cdclk under
 display.cdclk

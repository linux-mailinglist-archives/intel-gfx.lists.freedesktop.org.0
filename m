...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 447B5B1A390
	for <lists+intel-gfx@lfdr.de>; Mon,  4 Aug 2025 15:39:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D33C510E533;
	Mon,  4 Aug 2025 13:39:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="O7clTIDe";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D01510E52F;
 Mon,  4 Aug 2025 13:39:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1754314743; x=1785850743;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=oXoMszbCBEVwzfp+lQVuVAl2YTlv9EdJ8kCcxWlgtGw=;
 b=O7clTIDeQXviZksBVdpA5a26/znHITBfmuHrlTM0WSA78Tqf+zgRxx9O
 beX6bNqMF1ZzW1R8+tPTi+m6f8vmR12244ZV4sGGgc4eBkuCqr713/o7l
 V5rLZ10Eekv2XciH48j3rZUgviCzgtIMScZZ3+rvpeUtlDaoTZCNpHnC9
 baMPcphVKK6wZqRIIEgMlyvh6WTEM6cv42/3/uLWJV+bkBmI2JktUVBPQ
 ncBs18al4eTwxa1grQU7+wCiNstc6ex4C3GBjUqMoHgjuEn6bUaCsmTR8
 mBFFBZ2/UddDaYGZ0OlsPrkGbF6PnCHhc27AS3IlExDounczpgH9GKp04 w==;
X-CSE-ConnectionGUID: xWHE8UtyTFOp2zvc8q617g==
X-CSE-MsgGUID: XpwYuJKeR2yklc/5x/VTLg==
X-IronPort-AV: E=McAfee;i="6800,10657,11512"; a="56447395"
X-IronPort-AV: E=Sophos;i="6.17,258,1747724400"; d="scan'208";a="56447395"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Aug 2025 06:39:02 -0700
X-CSE-ConnectionGUID: qP9bEGTqR0yHQme0tCAEQg==
X-CSE-MsgGUID: kyoCjDDGQNCGjf33x5CmoA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.17,258,1747724400"; d="scan'208";a="163430685"
Received: from srr4-3-linux-103-aknautiy.iind.intel.com ([10.223.34.160])
 by orviesa010-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Aug 2025 06:39:00 -0700
From: Ankit Nautiyal <ankit.k.nautiyal@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: ville.syrjala@linux.intel.com, Ankit Nautiyal <ankit.k.nautiyal@intel.com>
Subject: [PATCH 12/15] drm/i915/vrr: Use static guardband to support seamless
 LRR switching
Date: Mon,  4 Aug 2025 18:54:37 +0530
Message-ID: <20250804132441.990441-13-ankit.k.nautiyal@intel.com>

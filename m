...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DDD7679999
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 14:40:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED90010E6AE;
...
Subject: [Intel-gfx] [PATCH v2 08/10] drm/fbdev-generic: Minimize client
 unregistering

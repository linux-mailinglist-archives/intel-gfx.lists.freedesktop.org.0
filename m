...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63CD4C7464F
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Nov 2025 14:59:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 779B810E74B;
	Thu, 20 Nov 2025 13:59:52 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Z14ln4Yc";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CA5C810E29E;
 Thu, 20 Nov 2025 13:59:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1763647191; x=1795183191;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=I/vJ2Mc0UUuLyo4oLRa8uaeI8tN/xo54DleQP+7c59M=;
 b=Z14ln4YcyMk1IDHJlnaCRyklb1FZEMeejM2NWhwQsYiqy6KQt1Psp118
 moGFZ9SWoUcemj5VFYcbPwyd4+Yo4wVcWYvTckBdKjfLsv5nxrYMx7mO8
 I/N1kGy5RiICuNwUeOH6aCtCjMaZkVT76E9qhBw61FgW1ZVTcwUb/q3bw
 6Qw5q0C/rN9urRfcDb8hbqohrFJuhQkqhLS3nJ4ZkcHovntXcS4ZBS16O
 OoaJ9J5BlxXRtUdIiYH49lLnuRQjgenvMBIVNre9HfXJRPEWX/4YE1Afe
 /ynD6UX4EgtRZntTm6ALGZI/oB5qbd5nmWZ7Ly2u1D0LwjhKJ5kQbtjIe g==;
X-CSE-ConnectionGUID: 9jH9nXkPRmyXxtCmuiVgyg==
X-CSE-MsgGUID: RsZTBtW4TeWSbEtueh/+ZQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11619"; a="65802246"
X-IronPort-AV: E=Sophos;i="6.20,213,1758610800"; d="scan'208";a="65802246"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Nov 2025 05:59:50 -0800
X-CSE-ConnectionGUID: lj39Boq9Se6ceAa1o+PseA==
X-CSE-MsgGUID: ZCL/NZXXRaWgnw5KYrz/yw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,213,1758610800"; d="scan'208";a="191165145"
Received: from inaky-mobl1.amr.corp.intel.com (HELO localhost)
 ([10.245.244.92])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Nov 2025 05:59:49 -0800
Date: Thu, 20 Nov 2025 15:59:44 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org
Subject: Re: [PATCH v2 05/13] drm/i915/dram: convert to struct intel_display
Message-ID: <aR8e0KuQ1PJ9cn9p@intel.com>
References: <cover.1763578288.git.jani.nikula@intel.com>
 ...
 <096de67d74882f91f10af67f6d740e3c6b4dee0c@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <096de67d74882f91f10af67f6d740e3c6b4dee0c@intel.com>

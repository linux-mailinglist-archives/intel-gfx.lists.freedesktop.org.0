...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 957962778B0
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Sep 2020 20:48:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 444CC6E8D2;
	Thu, 24 Sep 2020 18:48:17 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 0/6] drm/i915: Add support for LTTPR

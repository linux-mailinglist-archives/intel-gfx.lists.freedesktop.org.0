...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 137EB620CA5
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Nov 2022 10:48:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 27B4C10E0E8;
	Tue,  8 Nov 2022 09:48:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C8DBF10E0E8
 for <intel-gfx@lists.freedesktop.org>; Tue,  8 Nov 2022 09:48:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667900924; x=1699436924;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=6itfsQ/I/LMqAn8yKkNcfEKrXRtHcm/Cw3+m0IqlURU=;
 b=TsXf19rGy7cWXGNUVgNKVASwFECloEhcYAgMHpZ3bnPApPYfMXIzyIDu
 pKOSaQupYOHRcSdKLIn9fY4QsH+3eq72GSsqeCdZhpfRzFfMyMNBTHTDY
 8++hNr5bky5LbLBomJLHkZDRiCARYYMvv+soTzRfw7/9p7lClTp/cAc+u
 M+69lTtX7aeIogAOTurvxYL6xjwJB+GT6igiOJTmQB6ZsBZTxZiot/He0
 ywCxeVdJbeEgkmu1/Nj8DrE8QDBpzGovi++kCQCq5kVEreLcxc7s/oMEs
 PuXhsiafv5jj84OjRsoa37QnL5nrracjtuXR7TlpFEeoscyG8dgNw9bUD g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="311810197"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="311810197"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Nov 2022 01:48:44 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="811182153"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="811182153"
Received: from shylandx-mobl2.ger.corp.intel.com (HELO [10.213.210.50])
 ([10.213.210.50])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Nov 2022 01:48:42 -0800
Message-ID: <fb898538-2e97-5d33-0ad3-9bc100a2b431@linux.intel.com>
Date: Tue, 8 Nov 2022 09:48:39 +0000
MIME-Version: 1.0
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: use i915_sg_dma_sizes() for all
 backends

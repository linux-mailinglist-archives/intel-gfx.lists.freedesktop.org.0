...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F2A55AA3D1
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Sep 2022 01:39:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE7B710E39C;
	Thu,  1 Sep 2022 23:39:24 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 7/8] drm/i915/mtl: Use primary GT's irq lock
 for media GT

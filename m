...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6560D7DF605
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Nov 2023 16:13:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5035910E92C;
...
Subject: [Intel-gfx] [PATCH v3 12/15] drm/i915/dsi: Replace poking of VLV

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6CFF02E23EA
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Dec 2020 04:10:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 486B389FE3;
	Thu, 24 Dec 2020 03:10:30 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3974489DCF
 for <Intel-gfx@lists.freedesktop.org>; Thu, 24 Dec 2020 03:10:28 +0000 (UTC)
IronPort-SDR: eRuz+DWghGdRj1e0eDZOCWQ7cbBSoZnOZKhM+uJVoNBUevFHD3OnVsQ9qEguf9JTjsB6YHzOuL
 Ie9Fe9ruCEzA==
X-IronPort-AV: E=McAfee;i="6000,8403,9844"; a="155893681"
X-IronPort-AV: E=Sophos;i="5.78,444,1599548400"; d="scan'208";a="155893681"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Dec 2020 19:10:27 -0800
IronPort-SDR: dIqmNsvju+BajPmOEeMuyyRWW2f9SXYlYznIyP3Gfx4R+U2FZy8Ty+SsNHk2AbChl05TjPMNdG
 dSyYfFR+3JKA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,444,1599548400"; d="scan'208";a="342496788"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga003.jf.intel.com with ESMTP; 23 Dec 2020 19:10:27 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed, 23 Dec 2020 19:10:17 -0800
Message-Id: <20201224031026.7360-5-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201224031026.7360-1-sean.z.huang@intel.com>
References: <20201224031026.7360-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v15 04/13] drm/i915/pxp: Create the arbitrary
 session after boot
...
index 000000000000..c57b09ed56b4
--- /dev/null
...
index 4b5e3edb1d9b..27bf18f22848 100644

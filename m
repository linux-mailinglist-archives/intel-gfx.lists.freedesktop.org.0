...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BB4A2DBF67
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Dec 2020 12:30:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D1CC58945A;
	Wed, 16 Dec 2020 11:30:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AC1578945A
 for <intel-gfx@lists.freedesktop.org>; Wed, 16 Dec 2020 11:30:00 +0000 (UTC)
IronPort-SDR: haqcMSVIv0buOt0mp6rgBgW9W4/6B+ULh4SjFBzX1i/XcCnd6vD1E3KcAqcMbAb24gufGfXq/r
 8CU26tBZl8eQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9836"; a="162099219"
X-IronPort-AV: E=Sophos;i="5.78,424,1599548400"; d="scan'208";a="162099219"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Dec 2020 03:30:00 -0800
IronPort-SDR: OupUmm6eAS1yemGrn/RvlOCGisBfLcg75/EDKBY1fXX/YkiOgZeMBho906pifxU9JcI8nwkOrg
 CNdIvNmukSSA==
X-IronPort-AV: E=Sophos;i="5.78,424,1599548400"; d="scan'208";a="338372675"
Received: from slevy-mobl.ger.corp.intel.com (HELO localhost)
 ([10.214.192.176])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Dec 2020 03:29:55 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 16 Dec 2020 13:29:11 +0200
Message-Id: <468532adf2647507beff984bee8914f42a2d7256.1608117676.git.jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <cover.1608117676.git.jani.nikula@intel.com>
References: <cover.1608117676.git.jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 04/11] drm/i915: refactor cursor code out of
 i915_display.c
...
ZHJtL2k5MTUvTWFrZWZpbGUKaW5kZXggZjllZjUxOTliMTI0Li5iNjU1ODQwMTY5MWUgMTAwNjQ0
Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L01ha2VmaWxlCisrKyBiL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L01ha2VmaWxlCkBAIC0xOTgsNiArMTk4LDcgQEAgaTkxNS15ICs9IFwKIAlkaXNwbGF5
...
YXkvaW50ZWxfZGlzcGxheS5jCmluZGV4IGVmNzE5YTQ0ZDRmMS4uMmE1OTczZWI2YmY3IDEwMDY0
...
ZSAqaTkxNSk7Ci0tIAoyLjIwLjEKCl9fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19f

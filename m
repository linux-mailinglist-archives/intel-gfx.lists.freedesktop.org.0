...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 076CD97F102
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Sep 2024 21:03:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A16410E471;
	Mon, 23 Sep 2024 19:03:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="E9NSkJWc";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A6F3C10E486
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=q4VzZdIiRk28/Gsa/jvf27JVkDVw+HNMSsglSUMxKxs=;
 b=E9NSkJWcqQQpSqGxnQpwQoNn/smvhi2uwsmqoqYKPBvEMLFXOqy4TJvw
 sn4iESFTlLBKfKDB/jbbIoEWAcx5KDT6cQPPf6CGK/WmdS7DQ3puebQXN
 3I9ak2LBRXaazjSNwK/NBjByB6TRgAmQr3c0eAcDbvjhKF6r6PS9+rKcW
 YoxZAGWQNiE0gNGQBTbsQqiQXcd5Mawrw7bZ8rPp1xBvI2AApe5hvtGvB
 jT7VOB7zidXNAKqfSeCk7vClW6SClyl/h8ZUnV6VWnlvpMvMDq7BIaalX
 We0gnloSUabeedpVgzvkiRfw3PFhfiepzzlh9P7DwRadLovv0iyKAb1fs A==;
X-CSE-ConnectionGUID: GNDyK0kjTZiEOGUzG3Jy1w==
X-CSE-MsgGUID: tw8uC54HTi26y9GWxqOdcw==
X-IronPort-AV: E=McAfee;i="6700,10204,11204"; a="43601321"
X-IronPort-AV: E=Sophos;i="6.10,252,1719903600"; d="scan'208";a="43601321"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2024 12:03:39 -0700
X-CSE-ConnectionGUID: 7lI2bLBVQQ+WVGiyPx3NuA==
X-CSE-MsgGUID: lEd3rjnPTTCrQIzrRF/WWg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,252,1719903600"; d="scan'208";a="71997388"
...
Subject: [PATCH v2 3/5] drm/i915/display: Store pipe name in trace events
Date: Mon, 23 Sep 2024 16:02:52 -0300
Message-ID: <20240923190324.83013-4-gustavo.sousa@intel.com>

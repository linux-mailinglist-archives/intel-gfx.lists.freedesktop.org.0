...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FE2223291E
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Jul 2020 02:48:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B4546E822;
	Thu, 30 Jul 2020 00:48:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E21CB6E821
 for <intel-gfx@lists.freedesktop.org>; Thu, 30 Jul 2020 00:48:28 +0000 (UTC)
IronPort-SDR: hbzZSTbjV5Je7OT31FUxxjhwq2vVYUNuOQSACdUxL3B1igZqHTx/5UhQ++tSx1/tUXu4w52dC/
 8PA6qSNKd8bA==
X-IronPort-AV: E=McAfee;i="6000,8403,9697"; a="148983719"
X-IronPort-AV: E=Sophos;i="5.75,412,1589266800"; d="scan'208";a="148983719"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jul 2020 17:48:27 -0700
IronPort-SDR: LDCY2FuxpeW0d8fR5mhTicS9T6s+ESmPDunWrmwTrj+7M8CO7KO1ytrAp2k0rMNizKyVdnq2vs
 TmSpV8N29Ksw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,412,1589266800"; d="scan'208";a="274032935"
Received: from orsosgc001.ra.intel.com ([10.23.184.150])
 by fmsmga008.fm.intel.com with ESMTP; 29 Jul 2020 17:48:28 -0700
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Jul 2020 17:48:26 -0700
Message-Id: <20200730004826.8415-7-umesh.nerlige.ramappa@intel.com>
...
---
 ...
 drivers/gpu/drm/i915/i915_perf.c         | 117 ++++++++++++++++++++++-
...
index 9b55521cb09b..a995ebad0b17 100644
...
@@ -3218,6 +3220,38 @@ static long i915_perf_config_locked(struct i915_perf_stream *stream,
 	return ret;
 }
...
@@ -3243,6 +3277,8 @@ static long i915_perf_ioctl_locked(struct i915_perf_stream *stream,
 		return 0;
...
+}
 ...
 static const struct file_operations fops = {
 	.owner		= THIS_MODULE,
@@ -3336,6 +3447,7 @@ static const struct file_operations fops = {
...
@@ -4480,8 +4592,11 @@ int i915_perf_ioctl_version(void)
 	 *

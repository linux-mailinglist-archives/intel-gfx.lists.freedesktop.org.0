...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC86F52944A
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:58:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A66ED10F4DA;
...
Subject: [Intel-gfx] [PATCH v2 18/27] drm_print: interpose drm_*dbg with
 forwarding macros

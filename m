...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 62C786EB0AD
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 19:37:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C571810EEAA;
	Fri, 21 Apr 2023 17:37:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 05C7E10EE73;
 Fri, 21 Apr 2023 17:36:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682098612; x=1713634612;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=n35I7OAwob6F5Iwf1mv6YpMkaIooAEse3k7ZC26ia50=;
 b=IF/8P3QhiPmAtpHkl5x1uD1k9y31ONotcQI4K71AMIR0P1V3yq10zzdD
 7UnqSM3JRT9AeAnRdH6FT51QQMRmYcDSv8DclJkc/7TlSEVY2tNXmtXNR
 jniVQTOWa76Yj/r8bxmQDtSTQQPzsbxd8RuB57Fjid9FvHonXM6hZm+2a
 Zt8cVQkLphKj5dspauOhMmMr6MekTsBcPdWhnBcyKCIrPJKEQjRpDygXr
 qG6M76aVbKpchA4PZZic88ssPz/Nq3roJjSUkWX5Mjs0BETQ8rjRXkeU9
 SMVY/XvP0H1R6+YvDBziMsr07t9E23cTyQ7M7zem5is+rJH4tWFbAYdX6 g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10687"; a="347949462"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="347949462"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 10:36:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10687"; a="669794803"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="669794803"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 10:36:49 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Fri, 21 Apr 2023 10:37:58 -0700
Message-Id: <20230421173801.3369303-6-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 5/8] drm/i915: use pat_index instead of
 cache_level
...
index d2d5a24301b2..89938084af97 100644
...
index 009968808730..d148b1f12419 100644
--- a/drivers/gpu/drm/i915/gt/intel_gtt.h
+++ b/drivers/gpu/drm/i915/gt/intel_gtt.h
@@ -164,8 +164,6 @@ typedef u64 gen8_pte_t;
...
-
 ...
 struct i915_vma;
@@ -233,7 +231,7 @@ struct i915_vma_ops {
...
@@ -305,7 +303,7 @@ struct i915_address_space {
...
+			  unsigned int pat_index,
 ...
 #define PTE_LM		BIT(1)
@@ -320,20 +318,20 @@ struct i915_address_space {
...
@@ -580,7 +578,7 @@ void ppgtt_init(struct i915_ppgtt *ppgtt, struct intel_gt *gt,
 void intel_ggtt_bind_vma(struct i915_address_space *vm,
 			 struct i915_vm_pt_stash *stash,
 			 struct i915_vma_resource *vma_res,
-			 enum i915_cache_level cache_level,
...
@@ -658,7 +656,7 @@ void gen6_ggtt_invalidate(struct i915_ggtt *ggtt);

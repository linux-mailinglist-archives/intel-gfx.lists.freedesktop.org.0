...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FEA293F87F
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Jul 2024 16:44:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 22F0C10E402;
	Mon, 29 Jul 2024 14:44:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AvUL6TSk";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 80D2510E402
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Jul 2024 14:44:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1722264287; x=1753800287;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=213ykujctHzuccCJe4SB5sBfYrqOR8n47Cug6zKobOU=;
 b=AvUL6TSkygxEMtSy5O7JRQLz4Pdob43Og3yg24/xJ075cG8LNM7IRs2c
 bj5eDjQZohFOFJuX4g4v2Z69UpZjHv14aHc9ricoQBP72u2NvMu8Daz5t
 j2iOcznVO6wPUCGa01S54JSnoBoVPr1rTFMNn3UdAUCUQweJDpNFCUYVJ
 u1FG3zLzPIKj8GiqxI2dQOmuwHBHyVcglvqv7ccXai16ZZ9DNtCkzLcbn
 xVL0T2LGkBJ4BjUclcNK4A8THWNLwU8AIFUKDULoCDM2gtPLnKtlHP/fv
 iuvkImiFwhFJYRNdsS9WGg4KoqpmUe4ECFj/WcmOlTJdCHDa6UgWlasaO Q==;
X-CSE-ConnectionGUID: kIpy61toQ5+vovEq9XqnFA==
X-CSE-MsgGUID: ML6FcYyKRJmRB09IVqynuw==
X-IronPort-AV: E=McAfee;i="6700,10204,11148"; a="20154588"
X-IronPort-AV: E=Sophos;i="6.09,246,1716274800"; d="scan'208";a="20154588"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jul 2024 07:44:43 -0700
X-CSE-ConnectionGUID: mmhE7XW5Qn2Z7/x5In6Wbg==
X-CSE-MsgGUID: 6EYMHJ4QT4q0ETFkCyvOTA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,246,1716274800"; d="scan'208";a="58125453"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by fmviesa003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jul 2024 07:44:41 -0700
...
Message-ID: <20240729144458.2763667-1-imre.deak@intel.com>

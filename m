...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EE3E51FBFF
	for <lists+intel-gfx@lfdr.de>; Mon,  9 May 2022 14:03:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDC0A10EE6E;
	Mon,  9 May 2022 12:03:56 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 05/25] drm/edid: keep propagating drm_edid to
 display info

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DFEE1465A6
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 11:23:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB0316FBC2;
	Thu, 23 Jan 2020 10:23:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x341.google.com (mail-wm1-x341.google.com
 [IPv6:2a00:1450:4864:20::341])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DD3EF6E29D;
 Tue, 21 Jan 2020 21:46:51 +0000 (UTC)
Received: by mail-wm1-x341.google.com with SMTP id p17so4936249wma.1;
 Tue, 21 Jan 2020 13:46:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:subject:date:message-id;
 bh=KCabEl/ulRNOtqBDS8hJeZVIAXZJGaMcK/lYIVtShoE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:subject:date:message-id;
 bh=KCabEl/ulRNOtqBDS8hJeZVIAXZJGaMcK/lYIVtShoE=;
 b=
X-Gm-Message-State: APjAAAUofRUYp6U8PESwv2932Sm46AceczFSqdNzOILroAMDfpc/GmXj
 LsaGtBV04bmXt2YpJNWb4iw=
X-Google-Smtp-Source: APXvYqxm3Md8rbM3ztggNNQlmFggRlFjGkNJMveZ26qPtdawHvKPdoKRXAKB040JFMt3IYS4XjdgwQ==
X-Received: by 2002:a1c:7e0b:: with SMTP id z11mr399301wmc.88.1579643208993;
 Tue, 21 Jan 2020 13:46:48 -0800 (PST)
Received: from localhost.localdomain ([197.254.95.38])
 by smtp.googlemail.com with ESMTPSA id w20sm855370wmk.34.2020.01.21.13.46.45
...
Message-Id: <20200121214641.7262-1-wambui.karugax@gmail.com>
X-Mailer: git-send-email 2.17.1
X-Mailman-Approved-At: Thu, 23 Jan 2020 10:23:15 +0000
Subject: [Intel-gfx] [PATCH v2] drm/i915/display: conversion to new struct

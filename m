...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 33A9A2D66FA
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 20:42:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46DAC6EB46;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch 18/30] PCI: xilinx-nwl: Use

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 00EF77244DC
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Jun 2023 15:50:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1026210E237;
	Tue,  6 Jun 2023 13:50:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AF01210E237
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Jun 2023 13:50:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686059418; x=1717595418;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=7Ql2zrxVLcilU0k/Jqh76Y+TqKpfUF1nERerz9aPiCQ=;
 b=IOpruxm2m6XCyeUT6/jJKmv8cgMR9f75+hFUGpEAfTrdIvcIEGQCyvO6
 tOKgJJujTilwnEoAwXPXM/RdDFC5WYo4xqQKZi8O2/rZANAxXHzCOev1g
 IgSDIQ5d+vEkXONTGzPKybs075dpIIWsWbszsrJfzsP1cpeu+tF+PbDSu
 sw7+9X/e0dJyRi1FP1pnkb/0+HxWxVcBEIeZo/Kb7wZs84SmpTspaljRk
 icLQh8X2Q8Y0b7oBSXkXYe4bktiZ/2HDOQOdu6+wUzIjbiUFukVqNRLhY
 WVS7FyP+4jY6oZRPIKiSf15rZSP+k3VsGKornacml52Wj7+ff6m5h9o9Y A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="359133272"
X-IronPort-AV: E=Sophos;i="6.00,221,1681196400"; d="scan'208";a="359133272"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2023 06:50:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="821650933"
X-IronPort-AV: E=Sophos;i="6.00,221,1681196400"; d="scan'208";a="821650933"
Received: from unknown (HELO ideak-desk) ([10.237.72.78])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2023 06:50:15 -0700
Date: Tue, 6 Jun 2023 16:50:15 +0300
From: Imre Deak <imre.deak@intel.com>
To: Vinod Govindapillai <vinod.govindapillai@intel.com>
Message-ID: <ZH85l2K9pnHlvE/k@ideak-desk>
References: <20230606093509.221709-1-vinod.govindapillai@intel.com>
 <20230606093509.221709-8-vinod.govindapillai@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20230606093509.221709-8-vinod.govindapillai@intel.com>
Subject: Re: [Intel-gfx] [PATCH v14 7/7] drm/i915/mtl: Add support for PM
 DEMAND

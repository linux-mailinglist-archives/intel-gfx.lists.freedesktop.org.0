...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6013A4FBE2A
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:02:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A492610F744;
	Mon, 11 Apr 2022 14:02:00 +0000 (UTC)
...
Subject: [Intel-gfx] [CI v3 11/12] drm/edid: add single point of return to
 drm_do_get_edid()

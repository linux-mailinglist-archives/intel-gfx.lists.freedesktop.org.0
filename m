...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C1691726D3
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Feb 2020 19:17:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 967076ED18;
	Thu, 27 Feb 2020 18:16:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x442.google.com (mail-wr1-x442.google.com
 [IPv6:2a00:1450:4864:20::442])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 178E86ED16
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Feb 2020 18:16:32 +0000 (UTC)
Received: by mail-wr1-x442.google.com with SMTP id p18so4608435wre.9
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Feb 2020 10:16:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=Q5R9BISRhwbobALJQRmJk6fDqDSskkRT9sp55A6Z0oo=;
 b=BQt9OxySIICUbLHkj8cVmuGoEp0M+Y5TXKMDTHVUjzMAjQNpvBBSkmgWwp9GAiq5Zn
 ZAlBlPtepJTfAxyfBi0wnD8Lmfy+0BBZTk2zyDnWrpqGudFYNY72cxdppDbQxx4FG+2p
 GIlObjZ21/6r1I3/qKs9dJBR3P+15FjcbHNXM=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=Q5R9BISRhwbobALJQRmJk6fDqDSskkRT9sp55A6Z0oo=;
 b=
X-Gm-Message-State: APjAAAXmENAB7zxj1KK43g60Om07/Sw94ix+Z4XdDaXbC0qExias3vLQ
 w9PJerWni874kNCtS4HHBjfbtQ==
X-Google-Smtp-Source: APXvYqxo8sS42GR5BBfWZS8OyBhKLWzDun+lBt+TkGKHoPKf4h/OtwKs2FQK89ErCgcDc9CW5B04ag==
X-Received: by 2002:adf:bc87:: with SMTP id g7mr117462wrh.121.1582827390736;
 Thu, 27 Feb 2020 10:16:30 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id q1sm8551152wrw.5.2020.02.27.10.16.29
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 27 Feb 2020 10:16:30 -0800 (PST)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Thu, 27 Feb 2020 19:15:19 +0100
Message-Id: <20200227181522.2711142-49-daniel.vetter@ffwll.ch>
...
Cc: David Airlie <airlied@linux.ie>, Daniel Vetter <daniel.vetter@ffwll.ch>,
 ...
 Sam Ravnborg <sam@ravnborg.org>, l.stach@pengutronix.de

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 95131766665
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jul 2023 10:07:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 15C0A10E683;
	Fri, 28 Jul 2023 08:07:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E597F10E680
 for <intel-gfx@lists.freedesktop.org>; Fri, 28 Jul 2023 08:07:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690531663; x=1722067663;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=tkHeWOfJLTmdxUrpHomuQ6ctBxHx8yz99cG1EcmjsVk=;
 b=HXnyfgrnwh8mC/lGpguuW6f3zr1KVtIRZSNcbO2hwhLt4kCiqKUn5Rqc
 AZf2ST598drKrmLabT+HXdkDriM5bNSBAOIhyNSWiK71xMFu7qWUtt6xr
 6a14x3z9qplkjDaxpkZMPM0DfCh5ngK6dV9pCXDI+FDMMu5PzE6tnVo3J
 n367+Uhsa07bjG6libiYskF1jD1lTuoN1B2qf2adgegjTdRFJxgMNuvPH
 XK7N5VqwauZ9PeyYfBqZoSJqT5u1FhBy/wbi8yYAhCBpSBxADvsGkHwv6
 KiOiHEjiMH1L+GbNN86lDe7tcF4rzxQUz5U49/6JuiS0+mYO48b6hNXB7 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="348138603"
X-IronPort-AV: E=Sophos;i="6.01,236,1684825200"; d="scan'208";a="348138603"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 01:07:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="727384403"
X-IronPort-AV: E=Sophos;i="6.01,236,1684825200"; d="scan'208";a="727384403"
Received: from atoomey-mobl.amr.corp.intel.com (HELO [10.213.197.30])
 ([10.213.197.30])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 01:07:15 -0700
Message-ID: <ebba4b70-eeee-9f78-9d01-519e5e72d633@linux.intel.com>
Date: Fri, 28 Jul 2023 09:07:14 +0100
MIME-Version: 1.0
...
In-Reply-To: <ZMMbDP8ApqVREQZ3@ashyti-mobl2.lan>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E07AF4FC436
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 20:38:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C101B10EBC0;
...
Subject: Re: [Intel-gfx] [PATCH 25/34] drm/i915/gvt: streamline
 intel_vgpu_create

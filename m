...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D79FA23CA95
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Aug 2020 14:23:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A689C6E5C1;
	Wed,  5 Aug 2020 12:23:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 01B5C6E57E
 for <intel-gfx@lists.freedesktop.org>; Wed,  5 Aug 2020 12:22:52 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 22039467-1500050 
 for multiple; Wed, 05 Aug 2020 13:22:32 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  5 Aug 2020 13:22:02 +0100
Message-Id: <20200805122231.23313-9-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/37] drm/i915/gem: Don't drop the timeline
 lock during execbuf
...
dS9kcm0vaTkxNS9nZW0vaTkxNV9nZW1fZXhlY2J1ZmZlci5jICAgIHwgNDYyICsrKysrKysrKysr
LS0tLS0tLQogLi4uL2k5MTUvZ2VtL3NlbGZ0ZXN0cy9pOTE1X2dlbV9leGVjYnVmZmVyLmMgIHwg
IDI5ICstCiAyIGZpbGVzIGNoYW5nZWQsIDMxMiBpbnNlcnRpb25zKCspLCAxNzkgZGVsZXRpb25z
...
aW5kZXggOWNlMTE0ZDY3Mjg4Li4yZGMzMGRiYmRiZjMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2dlbS9pOTE1X2dlbV9leGVjYnVmZmVyLmMKKysrIGIvZHJpdmVycy9ncHUvZHJt
L2k5MTUvZ2VtL2k5MTVfZ2VtX2V4ZWNidWZmZXIuYwpAQCAtMjY3LDYgKzI2Nyw4IEBAIHN0cnVj
...
OTE1X3ZtYSAqcnFfdm1hOwpAQCAtNjUwLDYgKzY1MiwzNSBAQCBzdGF0aWMgaW50IGViX3Jlc2Vy
...
ZmVyX2NvdW50OwpAQCAtNjU3LDcgKzY4OCw2IEBAIHN0YXRpYyBpbnQgZWJfcmVzZXJ2ZShzdHJ1
...
IC02NzMsMTggKzcwMywzNyBAQCBzdGF0aWMgaW50IGViX3Jlc2VydmUoc3RydWN0IGk5MTVfZXhl
...
cmRlciAqLwogCQlJTklUX0xJU1RfSEVBRCgmZWItPnVuYm91bmQpOwpAQCAtNzEzLDM4ICs3NjIs
...
YmF0Y2hfaW5kZXgoY29uc3Qgc3RydWN0IGk5MTVfZXhlY2J1ZmZlciAqZWIpCkBAIC0xMDE4LDEz
ICsxMDc5LDQ1IEBAIHN0YXRpYyBpbnQgcmVsb2NfZ3B1X2NoYWluKHN0cnVjdCByZWxvY19jYWNo
...
OwogCWludCBlcnI7CiAKQEAgLTEwNTUsNyArMTE0OCw5IEBAIHN0YXRpYyBpbnQgcmVsb2NfZ3B1
...
ZWxpbmUocnEpLT5tdXRleCk7CiAKIAlyZXR1cm4gZXJyOwogfQpAQCAtMTExNCwyNyArMTIwOSwx
...
ZXJyKQpAQCAtMTE2Miw3ICsxMjQ1LDkgQEAgc3RhdGljIGludCBfX3JlbG9jX2dwdV9hbGxvYyhz
...
X3VucGluOgogCWk5MTVfdm1hX3VucGluKGJhdGNoKTsKIGVycl91bm1hcDoKQEAgLTExNzIsMTEg
KzEyNTcsNiBAQCBzdGF0aWMgaW50IF9fcmVsb2NfZ3B1X2FsbG9jKHN0cnVjdCBpOTE1X2V4ZWNi
...
bnQgbGVuKQpAQCAtMTE4OCwxMiArMTI2OCw2IEBAIHN0YXRpYyB1MzIgKnJlbG9jX2dwdShzdHJ1
...
VFIoZXJyKTsKQEAgLTE1MjQsNyArMTU5OCw3IEBAIHN0YXRpYyBpbnQgZWJfcmVsb2NhdGUoc3Ry
...
c2goZWIpOwogCQlpZiAoIWVycikKIAkJCWVyciA9IGZsdXNoOwogCX0KQEAgLTE3MTgsMjAgKzE3
OTIsOSBAQCBzdGF0aWMgaW50IF9fZWJfcGFyc2Uoc3RydWN0IGRtYV9mZW5jZV93b3JrICp3b3Jr
...
ZV9yZWxlYXNlLAogfTsKIAogc3RhdGljIGlubGluZSBpbnQKQEAgLTE3NDksMjEgKzE4MTIsMjMg
...
ZWJfcGFyc2VfcGlwZWxpbmUoc3RydWN0IGk5MTVfZXhlY2J1ZmZlciAqZWIsCkBAIC0xNzc3LDIw
ICsxODQyLDYgQEAgc3RhdGljIGludCBlYl9wYXJzZV9waXBlbGluZShzdHJ1Y3QgaTkxNV9leGVj
...
MTgzOSwxNCArMTg5MCw2IEBAIHN0YXRpYyBpbnQgZWJfcGFyc2VfcGlwZWxpbmUoc3RydWN0IGk5
...
IHN0YXRpYyBpbnQgZWJfcGFyc2Uoc3RydWN0IGk5MTVfZXhlY2J1ZmZlciAqZWIpCkBAIC0yMDQz
LDMyICsyMDg2LDYzIEBAIHN0YXRpYyBzdHJ1Y3QgaTkxNV9yZXF1ZXN0ICplYl90aHJvdHRsZShz
...
YWlybHkgZnJlcXVlbnRseSBpbiB0aGUKQEAgLTIwNzgsMTcgKzIxNTIsMTcgQEAgc3RhdGljIGlu
...
MjA5Niw0MCArMjE3MCw1MSBAQCBzdGF0aWMgaW50IF9fZWJfcGluX2VuZ2luZShzdHJ1Y3QgaTkx
...
KGViLT5jb250ZXh0KTsKIH0KIAogc3RhdGljIHVuc2lnbmVkIGludApAQCAtMjE3Niw2ICsyMjYx
...

...
eCk7CisKIAllcnIgPSBlYl9yZWxvY2F0ZSgmZWIpOwogCWlmIChlcnIpIHsKIAkJLyoKQEAgLTI3
MTQsMTEgKzI4MTgsMTIgQEAgaTkxNV9nZW1fZG9fZXhlY2J1ZmZlcihzdHJ1Y3QgZHJtX2Rldmlj
...


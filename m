...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8985675F1A
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Jan 2023 21:49:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2479510E1B6;
	Fri, 20 Jan 2023 20:49:21 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 3/9] drm/i915/pxp: Add MTL hw-plumbing

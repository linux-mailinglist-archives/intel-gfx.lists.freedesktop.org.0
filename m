...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D91DEF9C9
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Nov 2019 10:42:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78EDE6E976;
	Tue,  5 Nov 2019 09:42:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-2.mimecast.com
 [207.211.31.81])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B753C6E975
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 Nov 2019 09:42:36 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-367-QKyKdWrBOfGSQkBZ_IXJ0A-1; Tue, 05 Nov 2019 04:42:32 -0500
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com
 [10.5.11.16])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CD414477;
 Tue,  5 Nov 2019 09:42:26 +0000 (UTC)
Received: from jason-ThinkPad-X1-Carbon-6th.redhat.com
 (ovpn-12-252.pek2.redhat.com [10.72.12.252])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 426A25C28D;
 Tue,  5 Nov 2019 09:39:35 +0000 (UTC)
...
To: kvm@vger.kernel.org, linux-s390@vger.kernel.org,
 ...
 tiwei.bie@intel.com
Date: Tue,  5 Nov 2019 17:32:40 +0800
Message-Id: <20191105093240.5135-7-jasowang@redhat.com>
In-Reply-To: <20191105093240.5135-1-jasowang@redhat.com>
References: <20191105093240.5135-1-jasowang@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.16
X-MC-Unique: QKyKdWrBOfGSQkBZ_IXJ0A-1
X-Mimecast-Spam-Score: 0
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=redhat.com; 
 s=mimecast20190719; t=1572946955;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=syXqnRjGmjED8oe1bGzFfKezKmp2rR8du99TBlzamLo=;
 b=CNMgl8xu/5pD71WLCbBNd9U79ZU57t3pNhS11be9ACo4Z1keRjUwURbiRQRcuQiqaASfKl
 3DHvurRrN5rkyxNV1S7U3pJGcAYoQDTLD0qccM4z3SXU+D0I5Fz7CSJjfu0prgdmdxfGlK
 PO0Bcx0mc0461sQIiihIPBAGWLfEbZk=
Subject: [Intel-gfx] [PATCH V8 6/6] docs: sample driver to demonstrate how
...
fCA2ODUgKysrKysrKysrKysrKysrKysrKysrKysrKysrKysrKysrKysrKwogNCBmaWxlcyBjaGFu
Z2VkLCA2OTQgaW5zZXJ0aW9ucygrKQogY3JlYXRlIG1vZGUgMTAwNjQ0IHNhbXBsZXMvdmZpby1t
...
aWxlIG1vZGUgMTAwNjQ0CmluZGV4IDAwMDAwMDAwMDAwMC4uOGI0M2ZjYzc4YTY4Ci0tLSAvZGV2
L251bGwKKysrIGIvc2FtcGxlcy92ZmlvLW1kZXYvbXZuZXQuYwpAQCAtMCwwICsxLDY4NSBAQAor
...
IG1kZXZfZGV2aWNlICptZGV2KQoreworCXN0cnVjdCBtdm5ldF9zdGF0ZSAqbXZuZXQgPSBtZGV2
X2dldF9kcnZkYXRhKG1kZXYpOworCisJcmV0dXJuIG12bmV0LT5nZW5lcmF0aW9uOworfQorCitz
dGF0aWMgY29uc3Qgc3RydWN0IG1kZXZfdmlydGlvX2RldmljZV9vcHMgbWRldl92aXJ0aW9fb3Bz
...
ICAgICAgICAgICAgID0gbXZuZXRfa2lja192cSwKKwkuc2V0X3ZxX2NiICAgICAgICAgICAgICA9
IG12bmV0X3NldF92cV9jYiwKKwkuc2V0X3ZxX3JlYWR5ICAgICAgICAgICA9IG12bmV0X3NldF92
...

...
YXRlICAgICAgICAgICAgICAgICA9IG12bmV0X2NyZWF0ZSwKKwkucmVtb3ZlCQkJPSBtdm5ldF9y
ZW1vdmUsCit9OworCitzdGF0aWMgdm9pZCBtdm5ldF9kZXZpY2VfcmVsZWFzZShzdHJ1Y3QgZGV2
...
KwkJcHJfZXJyKCJFcnJvcjogZmFpbGVkIHRvIHJlZ2lzdGVyIG12bmV0X2RldiBjbGFzc1xuIik7
CisJCXJldCA9IFBUUl9FUlIobXZuZXRfZGV2LnZkX2NsYXNzKTsKKwkJZ290byBmYWlsZWQxOwor
...
cigmbXZuZXRfZGV2LmRldik7CisJaWYgKHJldCkKKwkJZ290byBmYWlsZWQyOworCisJcmV0ID0g
bWRldl9yZWdpc3Rlcl9kZXZpY2UoJm12bmV0X2Rldi5kZXYsICZtZGV2X2ZvcHMpOworCWlmIChy
ZXQpCisJCWdvdG8gZmFpbGVkMzsKKworCW11dGV4X2luaXQoJm1kZXZfbGlzdF9sb2NrKTsKKwlJ
...


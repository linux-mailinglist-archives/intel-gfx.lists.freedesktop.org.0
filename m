...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8D183B27CA
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 435886EA42;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 15/47] drm/i915/guc: Defer context unpin until

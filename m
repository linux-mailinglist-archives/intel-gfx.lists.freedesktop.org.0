...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8A7054ED99
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jun 2022 00:49:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E5C2410EDC2;
...
Subject: [Intel-gfx] [PATCH 1/2] agp/intel: Rename intel-gtt symbols

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A7564AC55F
	for <lists+intel-gfx@lfdr.de>; Sat,  7 Sep 2019 10:44:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DB36891A3;
	Sat,  7 Sep 2019 08:44:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7B052891A3
 for <intel-gfx@lists.freedesktop.org>; Sat,  7 Sep 2019 08:44:08 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18406719-1500050 
 for multiple; Sat, 07 Sep 2019 09:43:37 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sat,  7 Sep 2019 09:43:34 +0100
Message-Id: <20190907084334.28952-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.23.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/execlists: Ignore lost completion
 events
...
aTkxNS9ndC9pbnRlbF9scmMuYwppbmRleCAwZGRmYmViYmNiYmMuLjNhYWQzNWI1NzBkNCAxMDA2
...
LApAQCAtMTM4MSwxMyArMTM4NCw2IEBAIHJlc2V0X2luX3Byb2dyZXNzKGNvbnN0IHN0cnVjdCBp
...
bmV3IGZvcm1hdDoKICAqCkBAIC0xNDE0LDcgKzE0MTAsNyBAQCBlbnVtIGNzYl9zdGVwIHsKICAq
...
X2R3ID0gY3NiWzBdOwpAQCAtMTQyNCw3ICsxNDIwLDcgQEAgZ2VuMTJfY3NiX3BhcnNlKGNvbnN0
...
cHRpb24KQEAgLTE0MzQsNyArMTQzMCw3IEBAIGdlbjEyX2NzYl9wYXJzZShjb25zdCBzdHJ1Y3Qg
...
NDQzLDI5ICsxNDM5LDEzIEBAIGdlbjEyX2NzYl9wYXJzZShjb25zdCBzdHJ1Y3QgaW50ZWxfZW5n
...
YyB2b2lkIHByb2Nlc3NfY3NiKHN0cnVjdCBpbnRlbF9lbmdpbmVfY3MgKmVuZ2luZSkKQEAgLTE1
MDQsNyArMTQ4NCw3IEBAIHN0YXRpYyB2b2lkIHByb2Nlc3NfY3NiKHN0cnVjdCBpbnRlbF9lbmdp
...
ZWFkID0gMDsKQEAgLTE1MzIsMjAgKzE1MTIsMTYgQEAgc3RhdGljIHZvaWQgcHJvY2Vzc19jc2Io
...
Y2xpc3RzLT5pbmZsaWdodCwKQEAgLTE1NjAsOSArMTUzNiwxMCBAQCBzdGF0aWMgdm9pZCBwcm9j
...
Y3RpdmUpOwogCiAJCQkvKgpAQCAtMTU3NywxMCArMTU1NCw2IEBAIHN0YXRpYyB2b2lkIHByb2Nl

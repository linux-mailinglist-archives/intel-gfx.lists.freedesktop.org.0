...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 54354375AA1
	for <lists+intel-gfx@lfdr.de>; Thu,  6 May 2021 20:58:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A6626EDB3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 12/97] drm/i915/guc: Don't repeat CTB layout
 calculations

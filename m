...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E68D80241F
	for <lists+intel-gfx@lfdr.de>; Sun,  3 Dec 2023 14:18:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1BED10E2DB;
...
Subject: [Intel-gfx] [PATCH v3 7/9] drm/i915: Use memcpy_from_page() in
 gt/uc/intel_uc_fw.c

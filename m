...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA3EC5FF68C
	for <lists+intel-gfx@lfdr.de>; Sat, 15 Oct 2022 01:04:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E51010E17E;
	Fri, 14 Oct 2022 23:03:30 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 08/14] drm/i915: Define MCR registers
 explicitly

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F1162529439
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:58:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26C2010EDA4;
...
Subject: [Intel-gfx] [PATCH v2 13/27] dyndbg: add __pr_debug_cls(class, fmt,
 ...)

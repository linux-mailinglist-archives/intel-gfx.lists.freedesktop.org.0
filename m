...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 01CD3679470
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 10:43:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75E6F10E63E;
	Tue, 24 Jan 2023 09:43:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 25F1010E63E
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Jan 2023 09:43:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1674553428; x=1706089428;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=G31hQ2nFzNwYp6smpqLKDViSiI5w1ex36495uWHfpDE=;
 b=UBftyF0S2+q1BhTAjbSlwYXEnX2Lhg9Srsnw4domWKpMjQOVseJuVT2a
 9RR9TThNrk13zy8q6z/dhvvl+ugf/jCYkbh/DVHMg5FRIOS8kHJiuQrRc
 Y2XqJ6CdDrvC5IdXvo8ohH5Dg1OUiqJZI6WG2C/0FmPcaCGa8wtK34Sd+
 5gEsFnTL7jebnBzn9txccm5Kl1Tmh5lTxpAh9e7BV225XsgdprCL1GCXy
 ebhxoOy2htv7ZcjX1nq3/mx9ii8SNUqsdE7nie9XOSixjHV5kcSz+6Znx
 6fEzibCLGV4XF202MfHvihWXuwrmpk4uteQNebYIW6nlTskYFQDLxOn36 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10599"; a="309835467"
X-IronPort-AV: E=Sophos;i="5.97,242,1669104000"; d="scan'208";a="309835467"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jan 2023 01:43:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10599"; a="730618310"
X-IronPort-AV: E=Sophos;i="5.97,242,1669104000"; d="scan'208";a="730618310"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga004.fm.intel.com with ESMTP; 24 Jan 2023 01:43:44 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 24 Jan 2023 15:12:22 +0530
Message-Id: <20230124094224.2714023-5-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 4/6] drm/i915/hdcp: Refactor HDCP API
 structures

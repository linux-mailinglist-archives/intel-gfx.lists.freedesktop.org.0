...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0588F198AC9
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2020 06:03:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 638BC6E52F;
	Tue, 31 Mar 2020 04:03:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id 4B0C06E22B;
 Tue, 31 Mar 2020 04:03:11 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 48EC1A00E6;
 Tue, 31 Mar 2020 04:03:11 +0000 (UTC)
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Chris Wilson" <chris@chris-wilson.co.uk>
Date: Tue, 31 Mar 2020 04:03:11 -0000
Message-ID: <158562739129.5566.3848522649577345303@emeril.freedesktop.org>
...
-------
  ...
  **SUCCESS**
  ...
  External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_17147/index.html

Known issues
------------

  Here are the changes found in Patchwork_17147 that come from known issues:
...
#### Issues hit ####
  ...
  * igt@i915_pm_rpm@module-reload:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_17147/fi-icl-dsi/igt@i915_pm_rpm@module-reload.html
...
#### Possible fixes ####
  ...
  * igt@gem_exec_suspend@basic-s4-devices:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_17147/fi-tgl-y/igt@gem_exec_suspend@basic-s4-devices.html
  ...
  * igt@i915_selftest@live@execlists:
   ...
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_17147/fi-tgl-u/igt@i915_selftest@live@execlists.html
  ...
  * igt@i915_selftest@live@requests:
   ...
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_17147/fi-icl-guc/igt@i915_selftest@live@requests.html
...
e21edf1eeb26 drm/i915/execlists: Peek at the next submission for error interrupts

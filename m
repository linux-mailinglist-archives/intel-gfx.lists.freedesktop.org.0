...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDC9179AC54
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Sep 2023 01:09:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8E74210E36F;
...
Subject: [Intel-gfx] [PATCH v6 09/22] dyndbg: tighten ddebug_class_name()
 1st arg type

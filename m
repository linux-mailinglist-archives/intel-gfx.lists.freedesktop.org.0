...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1089B5728F3
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 00:05:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8A5E96FB5;
	Tue, 12 Jul 2022 22:05:19 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915: Correct ss -> steering calculation
 for pre-Xe_HP platforms

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CDD13C8A21
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Jul 2021 19:51:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 231476E45E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 1/5] drm/print: fixup spelling in a comment

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 85F3746172B
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Nov 2021 14:57:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 80E286EB8A;
...
Subject: [Intel-gfx] [PATCH v2 00/16] drm/i915: Remove short term pins from
 execbuf.

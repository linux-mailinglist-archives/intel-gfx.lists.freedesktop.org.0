...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE0EA6BB30
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jul 2019 13:13:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F2C16E110;
	Wed, 17 Jul 2019 11:13:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 294366E110
 for <intel-gfx@lists.freedesktop.org>; Wed, 17 Jul 2019 11:13:11 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17368380-1500050 
 for multiple; Wed, 17 Jul 2019 12:13:04 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 17 Jul 2019 12:13:03 +0100
Message-Id: <20190717111303.29051-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.22.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915: Move aliasing_ppgtt underneath its
 i915_ggtt
...

...
KTsKIH0KIAogc3RhdGljIHN0cnVjdCBpOTE1X3ZtYSAqCkBAIC0xNDcwLDcgKzE0ODEsNyBAQCBz
...
IAkJZ290byBlcnJfYWN0aXZlOwogCkBAIC0xNjYyLDcgKzE2NzMsNyBAQCBzdGF0aWMgaW5saW5l
...
NS0+bDNfcGFyaXR5LnJlbWFwX2luZm9bc2xpY2VdOwogCWludCBpOwpAQCAtMTY5MCwxNSArMTcw
MSwzNCBAQCBzdGF0aWMgaW50IHJlbWFwX2wzKHN0cnVjdCBpOTE1X3JlcXVlc3QgKnJxLCBpbnQg
...
dCByZXQ7CiAKIAlHRU1fQlVHX09OKEhBU19FWEVDTElTVFMocnEtPmk5MTUpKTsKIApAQCAtMTc0
Miw3ICsxNzcyLDcgQEAgc3RhdGljIGludCBzd2l0Y2hfY29udGV4dChzdHJ1Y3QgaTkxNV9yZXF1
...
IGh3X2ZsYWdzKTsKQEAgLTE3NzYsMTggKzE4MDYsOSBAQCBzdGF0aWMgaW50IHN3aXRjaF9jb250
...
NS9pOTE1X2Rydi5oCmluZGV4IDc4YzFlZDZlMTdiMi4uNTQ5OWZjNTMwNWYxIDEwMDY0NAotLS0g
...

...
IHsKQEAgLTI0ODEsNyArMjQ4MSw4IEBAIHN0YXRpYyB2b2lkIGFsaWFzaW5nX2d0dF91bmJpbmRf
...
YXJfcmFuZ2Uodm0sIHZtYS0+bm9kZS5zdGFydCwgdm1hLT5zaXplKTsKIAl9CkBAIC0yNTM4LDEz
ICsyNTM5LDEyIEBAIHN0YXRpYyB2b2lkIGk5MTVfZ3R0X2NvbG9yX2FkanVzdChjb25zdCBzdHJ1
...
aWYgKElTX0VSUihwcGd0dCkpCiAJCXJldHVybiBQVFJfRVJSKHBwZ3R0KTsKIApAQCAtMjU2Myw3
ICsyNTYzLDcgQEAgc3RhdGljIGludCBpbml0X2FsaWFzaW5nX3BwZ3R0KHN0cnVjdCBkcm1faTkx
...
dHQtPnZtLnZtYV9vcHMuYmluZF92bWEgPSBhbGlhc2luZ19ndHRfYmluZF92bWE7CkBAIC0yNTc4
LDE0ICsyNTc4LDE0IEBAIHN0YXRpYyBpbnQgaW5pdF9hbGlhc2luZ19wcGd0dChzdHJ1Y3QgZHJt
...
bygmZ2d0dC0+YWxpYXMpOwogCWlmICghcHBndHQpCiAJCWdvdG8gb3V0OwogCkBAIC0yNzAyLDcg
KzI3MDIsNyBAQCBpbnQgaTkxNV9pbml0X2dndHQoc3RydWN0IGRybV9pOTE1X3ByaXZhdGUgKmk5
...
bnVwX2luaXRfZ2d0dCgmaTkxNS0+Z2d0dCk7CiAJfQpAQCAtMjc0OCw3ICsyNzQ4LDcgQEAgdm9p
...
KCZpOTE1LT5nZ3R0KTsKIApAQCAtMzU4Niw3ICszNTg2LDcgQEAgaW50IGk5MTVfZ2VtX2d0dF9y
...
bm9kZSkpOwogCiAJbm9kZS0+c2l6ZSA9IHNpemU7CkBAIC0zNjgzLDcgKzM2ODMsNyBAQCBpbnQg

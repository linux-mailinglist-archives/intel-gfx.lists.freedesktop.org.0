...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B5BEDA0BFB3
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jan 2025 19:22:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5630610E79A;
	Mon, 13 Jan 2025 18:22:01 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="HrdPC45e";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1131210E795
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Jan 2025 18:22:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1736792520; x=1768328520;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=LxkbulglXav98UP0lqRTfnT0ClzBpSf0wpxPsx+gO2U=;
 b=HrdPC45emtTAqNiy/q0/6qujo4ZzBSr/T4f0aqghKy8lYatj97xOQf6k
 4Y5Yj9TAYWlc0TS9+/aBd9xMMCC0P9GBU3KXZJn+svZwhEtmJS0PwyMP9
 W5Y8c3tQbO3M5xcOJ//9zb1l+Os1ZRXjfXb++rhpAsEZnRYbVD1kbOEuZ
 qDIxfwmgF2B1Pk0S76KQPFf+8PiBK57kx4nDYC6KGDdSZ6mNmr2DOY0pM
 AdNp5lEEE3d4q/hG3WV+R68Voa81jigZppMDvTy4W9yp8F5ja+75IYdsF
 Rcj+QTHk7C6zbSULaL6w+fT3T/Ka2FaykeGvguBkV2Nf4IsRbYhVsXTF0 Q==;
X-CSE-ConnectionGUID: O9qLsyy3TZKyBd9GDtdKsw==
X-CSE-MsgGUID: 8VNHeI02RA66nTfhwrw4+g==
X-IronPort-AV: E=McAfee;i="6700,10204,11314"; a="37299055"
X-IronPort-AV: E=Sophos;i="6.12,310,1728975600"; d="scan'208";a="37299055"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jan 2025 10:21:59 -0800
X-CSE-ConnectionGUID: ddH9HjWFSBSFz0CCJ1F+TA==
X-CSE-MsgGUID: PRJDr4fQQN+pBDZtXJh44Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,310,1728975600"; d="scan'208";a="105078576"
Received: from nitin-super-server.iind.intel.com ([10.145.169.70])
 by fmviesa010.fm.intel.com with ESMTP; 13 Jan 2025 10:21:57 -0800
From: Nitin Gote <nitin.r.gote@intel.com>
To: andi.shyti@intel.com, jani.nikula@linux.intel.com,
 intel-gfx@lists.freedesktop.org
Cc: nitin.r.gote@intel.com
Subject: [PATCH v3 7/8] drm/i915/display: fix typos in i915/display files
Date: Tue, 14 Jan 2025 00:13:17 +0530
Message-Id: <20250113184318.2549653-8-nitin.r.gote@intel.com>
...
---
 ...
 47 files changed, 107 insertions(+), 101 deletions(-)
...
index 09034ef651f0..84a433acfd86 100644
...
index c7a603589412..e8e3f5c1d153 100644
...
index 968ac705c3c6..ffdac652f791 100644
...
index acb986bc1f33..2239fac626d8 100644
...
index 7464b44c8bb3..9077b876ee57 100644
...
@@ -2560,7 +2560,7 @@ void intel_hdcp_update_pipe(struct intel_atomic_state *state,

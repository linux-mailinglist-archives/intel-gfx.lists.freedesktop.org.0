...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 91F345BA686
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Sep 2022 07:50:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1206E10E3BA;
	Fri, 16 Sep 2022 05:50:13 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/display: Don't rewrite link config when

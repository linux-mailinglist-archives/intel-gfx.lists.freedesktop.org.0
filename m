...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FB69C9A43B
	for <lists+intel-gfx@lfdr.de>; Tue, 02 Dec 2025 07:27:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97F1010E53D;
	Tue,  2 Dec 2025 06:27:04 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="bBfx832V";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1061A10E53C;
 Tue,  2 Dec 2025 06:27:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764656823; x=1796192823;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=p2Sbk2HbFLhFIwul3DsS5FO3OjVhsEq5FVlOQD1Tneo=;
 b=bBfx832Vuag0/AyyQ6EXX0z+amicarZjt/bWmopZBPZ7R9GL+vGogue8
 JeAVQH97E8x9cYhtHFUpv7VBUh1CWAhFKt2OlppLR4qDEreEYiOD/9Ewn
 95P1mnweJIoHlWiVBSGzzJMvpvnfux34KZ1JAdCL8ZlEizDwaEqboinTj
 ua4dGqCcEqt46DwbEp1GQ9eUbekuFB59L9PCpbgyggFPNu+LuUMsP4wCO
 Wh052UDC88+XoOisroZ23zk7xuI0etlB6uicKzg4TqheMMwMoYovei0xy
 RZ0wW7BRgfXFDTezyMHtFkJ0CdkG34t1eymQSpwTmIZbraiQ8KbqyvEaS g==;
X-CSE-ConnectionGUID: yX7mg62CTFaF23Ybp0Nz7w==
X-CSE-MsgGUID: YNqUMAHuTjKAm+oKnwr+uw==
X-IronPort-AV: E=McAfee;i="6800,10657,11630"; a="66499839"
X-IronPort-AV: E=Sophos;i="6.20,242,1758610800"; d="scan'208";a="66499839"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Dec 2025 22:27:03 -0800
X-CSE-ConnectionGUID: VJzAIeYnSDKmsTxq8uxhjg==
X-CSE-MsgGUID: r/NNIpDHSjyQMugB6UXiBQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,242,1758610800"; d="scan'208";a="193961143"
Received: from srr4-3-linux-106-armuthy.iind.intel.com ([10.190.238.56])
 by fmviesa007.fm.intel.com with ESMTP; 01 Dec 2025 22:26:56 -0800
From: Arun R Murthy <arun.r.murthy@intel.com>
Date: Tue, 02 Dec 2025 11:56:58 +0530
Subject: [PATCH [RESEND] v9 04/20] drm/colorop: Export function to create
 pipeline element histogram
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20251202-dpst-v9-4-f2abb2ca2465@intel.com>

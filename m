...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05F231C94B1
	for <lists+intel-gfx@lfdr.de>; Thu,  7 May 2020 17:17:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6652F6EA02;
	Thu,  7 May 2020 15:17:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 269316EA02
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 May 2020 15:17:25 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 21140233-1500050 for multiple; Thu, 07 May 2020 16:17:24 +0100
MIME-Version: 1.0
In-Reply-To: <2340d9e2-31b8-3989-ebaf-8e2fd7bf32b0@linux.intel.com>
References: <20200507082124.1673-1-chris@chris-wilson.co.uk>
 ...
 <2340d9e2-31b8-3989-ebaf-8e2fd7bf32b0@linux.intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
From: Chris Wilson <chris@chris-wilson.co.uk>
Message-ID: <158886464197.20858.7098129994342199383@build.alporthouse.com>
User-Agent: alot/0.8.1
Date: Thu, 07 May 2020 16:17:21 +0100

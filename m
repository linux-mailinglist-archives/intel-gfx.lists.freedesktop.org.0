...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32F7D44DDA2
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Nov 2021 23:03:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 619DD6E982;
	Thu, 11 Nov 2021 22:02:43 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v10 06/10] drm_print: add choice to use dynamic
 debug in drm-debug

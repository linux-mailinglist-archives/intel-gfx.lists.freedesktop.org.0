...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A60EB3672B3
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Apr 2021 20:39:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D08566E9B1;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/dp: Use slow and wide link

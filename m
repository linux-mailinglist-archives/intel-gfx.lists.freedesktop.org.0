...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DD18B517174
	for <lists+intel-gfx@lfdr.de>; Mon,  2 May 2022 16:25:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 875E310EAE2;
...
Subject: [Intel-gfx] [PATCH v3 0/3] Flat-CCS eviction enhancements

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD16043D646
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Oct 2021 00:08:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADDBA6E111;
	Wed, 27 Oct 2021 22:08:07 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 3/3] drm/i915: Initial introduction of
 vma resources

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E96F16D2EA8
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 08:37:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C55C10F3B4;
	Sat,  1 Apr 2023 06:37:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 994C410F395;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=1B9bTB56QVRn5u+NCo3bZutbJpNhQ67YNci8SoxOV6k=;
 b=LMf7h6e4btWCJYVE4XfO4AgGG97N3l5rEdWkB0r36f9bJN2VwP2HpoBT
 7fuit39VznIoOjpdBOEmWB9kDoa0JPHekGdrXjwvYNPoQQngcSxl0AOJI
 SoK2T1vriAKgym/9N4AKAB4f/PJhrMtdA6hJ/e1bjMlHHgjA5V2L0orTu
 t4LSedCw6UejfTJiPEFAJlNiA+GQrt3xCbwGYWarBoh3taKJWvm0Fkzsz
 ON/3YtP6gZ+rixp/OftHN40iUBuz6IUjHYWyHcj9Wn2jQYFHHAYeEfHja
 zQMA6cAk/oiM0P0sfg5JGKXrl6y+pLm+qVg6wGqdf+our+B79ZnYVnVPA w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10666"; a="340349510"
X-IronPort-AV: E=Sophos;i="5.98,308,1673942400"; d="scan'208";a="340349510"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2023 23:37:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10666"; a="635539634"
X-IronPort-AV: E=Sophos;i="5.98,308,1673942400"; d="scan'208";a="635539634"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2023 23:37:00 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Fri, 31 Mar 2023 23:38:28 -0700
Message-Id: <20230401063830.438127-6-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230401063830.438127-1-fei.yang@intel.com>
References: <20230401063830.438127-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 5/7] drm/i915: use pat_index instead of
 cache_level

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DFAB4DAAC2
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Mar 2022 07:34:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E397510E6C7;
	Wed, 16 Mar 2022 06:34:43 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm: Fix a infinite loop condition when
 order becomes 0

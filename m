...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74D8C4B2143
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Feb 2022 10:16:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 32CC510EA32;
	Fri, 11 Feb 2022 09:16:05 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v11 1/5] drm: improve drm_buddy_alloc
 function

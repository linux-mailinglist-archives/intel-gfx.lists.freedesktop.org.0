...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BCE17A3986
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Aug 2019 16:47:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C34506E359;
	Fri, 30 Aug 2019 14:47:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 741F86E353
 for <intel-gfx@lists.freedesktop.org>; Fri, 30 Aug 2019 14:47:42 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga105.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 30 Aug 2019 07:47:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,447,1559545200"; d="scan'208";a="188894223"
Received: from unknown (HELO delly.ger.corp.intel.com) ([10.252.38.85])
 by FMSMGA003.fm.intel.com with ESMTP; 30 Aug 2019 07:47:40 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 30 Aug 2019 17:47:22 +0300
Message-Id: <20190830144726.18291-8-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 07/11] drm/i915/perf: implement active wait
...

...

...

...
aTkxNV9wZXJmLmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3BlcmYuYwppbmRleCAwODg2
OTY2MGYxZjIuLmQwNzY0ODUyYjM0NyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUv
...
ICAmc3RyZWFtLT5vYV9jb25maWcpOwogCWlmIChyZXQpIHsKQEAgLTI0NzEsNiArMjY5Myw5IEBA
...
eCkKIAkJb2FfcHV0X3JlbmRlcl9jdHhfaWQoc3RyZWFtKTsKIApAQCAtMzg1NSw2ICs0MDgwLDkg
...


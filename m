...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id QIJXDoUlsWnJrQIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Mar 2026 09:19:17 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B959D25EEDF
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Mar 2026 09:19:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4646F10E886;
	Wed, 11 Mar 2026 08:19:15 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Kj1Jt1sO";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D7E7810E874;
 Wed, 11 Mar 2026 08:19:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1773217154; x=1804753154;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=Vb8k9EUnk5kJj2LtvvAOaCQRgisPN85MlLKf/pO85gI=;
 b=Kj1Jt1sOYQ1p+NuTskmEgu4uwfPCg+utPRq5TtZ/Ry2dJvP37cqjKl0c
 81dOci5M8MiJEE1RCetC2fbsBs7vhNG/38VrsAx8W6L+wBO3HkJecWkvt
 ob3v9gq3YUgefC3DWgIRSYaDVGoZ3PSQRrwj6X4Ey5hewbULurBhjtcZR
 qAkGb1ZLY/hSmCtzzA8zpyurkhibAFjNKCC8Yxb9ts2bO50/7enRawq4y
 d8DYXzwTfadml+9DYlHBt052hard6G2ECRYZVI974JuBBQxD8BbPYlzI3
 cXSfpGSkC7p11/GsYz2GRdtLsIZmUqcKEWPUJU2uaBo+5DuUnomBc/mAN A==;
X-CSE-ConnectionGUID: EN3QaycHRs+3C4zlLcGUqw==
X-CSE-MsgGUID: kHm4qmm1TlWaAP8TepbV6g==
X-IronPort-AV: E=McAfee;i="6800,10657,11725"; a="78164851"
X-IronPort-AV: E=Sophos;i="6.23,113,1770624000"; d="scan'208";a="78164851"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2026 01:19:13 -0700
X-CSE-ConnectionGUID: 0G/JU1hJQDO4CX97TaJrVA==
X-CSE-MsgGUID: 7FfCmmmvT/izw51Ty9X2lA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,113,1770624000"; d="scan'208";a="225346316"
Received: from orsmsx901.amr.corp.intel.com ([10.22.229.23])
 by orviesa005.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2026 01:19:12 -0700
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 11 Mar 2026 08:19:03.7196 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5056F416C3E
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 08:52:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7CE566EE1A;
...
Subject: [Intel-gfx] [PATCH v2 09/17] drm/omapdrm: cleanup:

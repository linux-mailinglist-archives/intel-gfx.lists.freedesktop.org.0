...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B0E61CDD3F
	for <lists+intel-gfx@lfdr.de>; Mon, 11 May 2020 16:30:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E8916E49F;
	Mon, 11 May 2020 14:30:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 72ADB6E48C
 for <intel-gfx@lists.freedesktop.org>; Mon, 11 May 2020 14:29:48 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 11 May 2020 16:29:27 +0200
Message-Id: <20200511142938.1041006-12-maarten.lankhorst@linux.intel.com>
...
index ed45fc40f884..e67ad92530d6 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3268,7 +3268,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3430,20 +3433,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3451,9 +3457,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3479,8 +3485,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -5333,13 +5341,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -5372,8 +5380,10 @@ static void virtual_context_exit(struct intel_context *ce)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 732B9C2764D
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:05:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F098B10EC24;
	Sat,  1 Nov 2025 03:05:36 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PyhVZ32M";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1398110EC24;
 Sat,  1 Nov 2025 03:05:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761966336; x=1793502336;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6SU1XWvcZFVhSB3OGDE7j7/vT3YE8RULtQfiA2mKNCc=;
 b=PyhVZ32MG7ROiHSN4fxl4GmWLdXRifI8j8lnjKGnnnnxNjGazVzqPD1s
 eL12Bgi/K4+71qpQ4u1wZjD1/ruY5QFUbvKZ2BsP2LQiv9HYws/hoMVSB
 84ad0wMz34ZnvbbXqz+/JHflUmns6iL0AFHxlIiVrtuRcF2ueR3dHqCXp
 vCKx8hSjh+94OjtWZAAOE3edQqvlprEwy2StoJa4qowTuLkQtcxFz03iP
 EzAryXM0g+yU/TQ7hMacIEcKMxBG+PXnfzXY4Gt9yrGjctCXGYyCFmy9V
 Iiv16QKnPHaZHzXtj+z5T16CKRRC3ofGC4Siom4vMKn3hhotRmHtgBAuQ w==;
X-CSE-ConnectionGUID: FYDTHxIgT0GzYaljD+xAew==
X-CSE-MsgGUID: U4jlS7dRRCeQjQR3Q1bBIA==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="81759542"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="81759542"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:05:36 -0700
X-CSE-ConnectionGUID: JTnKSrwIRmG25b+JspWY4A==
X-CSE-MsgGUID: p4miBL6OQxiHadictksOyA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217222786"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa001.fm.intel.com with ESMTP; 31 Oct 2025 20:05:31 -0700
...
Subject: [PATCH v4 20/25] drm/i915/ltphy: Enable/Disable Tx after Non TBT
 Enable sequence
Date: Sat,  1 Nov 2025 08:34:29 +0530
Message-Id: <20251101030434.4159839-21-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A161D6CBD34
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Mar 2023 13:14:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F99710E86F;
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915: Initialize fbdev DRM client with
 callback functions

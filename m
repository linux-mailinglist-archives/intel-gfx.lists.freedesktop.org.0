...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E781B38C35
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Aug 2025 00:04:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A635510E8D6;
	Wed, 27 Aug 2025 22:04:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="h26qiZUC";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A0A2F10E8D4
 for <intel-gfx@lists.freedesktop.org>; Wed, 27 Aug 2025 22:04:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1756332269;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=L6FCsZfzSN7fAFSGFsxI24ix2lgnSyrxfbvzUHWhoBg=;
 b=h26qiZUCUClmYvNMqjprF4YzX2ncGk9/QXgPUQH1HmK5U+e8129eUVzHib/D+CG18N2zUe
 B4VDMwhuOMGVZaCu2sXgwmHrgN90fnfXY0PtyBtAe34SEvUKmwyW4cR8uTgeAuXIZX6qiw
 WGyuzTNg6RKj1iAOjzFH0RcodLQlpj4=
...
Received: from mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 15140195609F; Wed, 27 Aug 2025 22:04:20 +0000 (UTC)
Received: from t14s.redhat.com (unknown [10.22.80.195])
 by mx-prod-int-01.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id A03B330001A1; Wed, 27 Aug 2025 22:04:03 +0000 (UTC)
...
Subject: [PATCH v1 07/36] mm/memremap: reject unreasonable folio/compound page

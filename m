...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 12B656EB0A1
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 19:36:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6FBD10EE83;
...
Subject: [Intel-gfx] [PATCH v4 1/8] drm/i915/mtl: Define MOCS and PAT tables
 for MTL

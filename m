...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8718527E81
	for <lists+intel-gfx@lfdr.de>; Thu, 23 May 2019 15:44:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBC9A89E7C;
	Thu, 23 May 2019 13:44:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp.domeneshop.no (smtp.domeneshop.no
 [IPv6:2a01:5b40:0:3005::1])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD23189DF9;
...
Received: from 211.81-166-168.customer.lyse.net ([81.166.168.211]:53376
 ...
 id 1hTo1N-0002si-KO; Thu, 23 May 2019 15:44:37 +0200
From: =?UTF-8?q?Noralf=20Tr=C3=B8nnes?= <noralf@tronnes.org>
To: dri-devel@lists.freedesktop.org
Date: Thu, 23 May 2019 15:44:13 +0200
Message-Id: <20190523134413.4210-9-noralf@tronnes.org>
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt;
 ...
 bh=RZe2SkCjCtWuyzSpgbGBZbxH1jKq2qle0+tFgIdg8Ho=; 
 b=;
Subject: [Intel-gfx] [PATCH v6 8/8] drm/client: Hack: Add bootsplash example
...
Z3B1L2RybS9LY29uZmlnCmluZGV4IGE0NjFmMDc4YTBkZC4uYWVkZTBkZTBjOWQ5IDEwMDY0NAot
LS0gYS9kcml2ZXJzL2dwdS9kcm0vS2NvbmZpZworKysgYi9kcml2ZXJzL2dwdS9kcm0vS2NvbmZp
ZwpAQCAtNjUsNiArNjUsMTEgQEAgY29uZmlnIERSTV9ERUJVR19TRUxGVEVTVAogCiAJICBJZiBp
...
cnMvZ3B1L2RybS9NYWtlZmlsZSBiL2RyaXZlcnMvZ3B1L2RybS9NYWtlZmlsZQppbmRleCA5ZWFk
NjQzNmZiODcuLjc4NTczZWQwMmE0ZSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL01ha2Vm
...
ZHJpdmVycy9ncHUvZHJtL2RybV9jbGllbnQuYwppbmRleCA3N2FhMWNmMDljYWEuLmJmN2JhZGNk
ZTJmMCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2RybV9jbGllbnQuYworKysgYi9kcml2
...
ODYyNjIxNDk0YTkzLi4zMTdiOGNmNjc5ODAgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9k
cm1fZHJ2LmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2RybV9kcnYuYwpAQCAtMTAxNCw2ICsxMDE0

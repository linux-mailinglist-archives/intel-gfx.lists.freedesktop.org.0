...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 805AA6F4874
	for <lists+intel-gfx@lfdr.de>; Tue,  2 May 2023 18:39:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E9B2710E22A;
...
Subject: [Intel-gfx] [PATCH v3 1/4] drm/i915/mtl: Define GSC Proxy component
 interface

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E78E627FC5
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 14:01:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D88C710E2A9;
...
Subject: [Intel-gfx] [PATCH v9 10/25] drm/modes: Switch to named mode
 descriptors

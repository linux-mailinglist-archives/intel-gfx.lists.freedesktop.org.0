...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 454DD20FEFD
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:30:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9050A6E43C;
...
Subject: [Intel-gfx] [PATCH 39/59] drm/kmb: Fixed driver unload

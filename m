...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 342D2BC86F
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2019 15:00:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA2996EA2C;
	Tue, 24 Sep 2019 13:00:24 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 8/9] drm/amdgpu: use drm_debug_enabled() to

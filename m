...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F82C52F5F2
	for <lists+intel-gfx@lfdr.de>; Sat, 21 May 2022 01:04:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 392E510E62E;
...
Subject: [Intel-gfx] [PATCH v4 6/6] drm/i915/pvc: Add SSEU changes

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C7797C9722
	for <lists+intel-gfx@lfdr.de>; Sun, 15 Oct 2023 00:54:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A5BBA10E082;
...
Subject: Re: [Intel-gfx] [PATCH v7b 00/25] fix DRM_USE_DYNAMIC_DEBUG=y
 regression

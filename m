...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F69B21EFAE
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 13:45:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AEB46E953;
	Tue, 14 Jul 2020 11:45:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 778756E8B6
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Jul 2020 11:45:21 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Jul 2020 13:44:59 +0200
Message-Id: <20200714114516.3073222-6-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/23] drm/i915: Parse command buffer earlier in
 eb_relocate(slow)
...
@@ -1814,7 +1836,7 @@ static int eb_prefault_relocations(const struct i915_execbuffer *eb)
 	return 0;
 }
...
+static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
 {
 	...
 	struct eb_vma *ev;
@@ -1880,6 +1902,11 @@ static noinline int eb_relocate_slow(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
@@ -1912,7 +1939,7 @@ static noinline int eb_relocate_slow(struct i915_execbuffer *eb)
 	return err;
 }
...
@@ -2930,13 +2934,15 @@ i915_gem_do_execbuffer(struct drm_device *dev,

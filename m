...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 586A026A808
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 17:01:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EF5F6E8E2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 16/21] drm/vgem: Introduce GEM object
 functions

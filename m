...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CEBCB434BB2
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Oct 2021 14:59:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8127A6E9A9;
...
Subject: [Intel-gfx] [PATCH 08/13] drm: export functions and write
 description

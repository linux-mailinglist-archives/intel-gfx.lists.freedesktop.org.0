...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BA6C821FF22
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47FF96E9BC;
...
Subject: [Intel-gfx] [PATCH v2 18/59] drm/kmb: Part8 of Mipi Tx
 Initialization

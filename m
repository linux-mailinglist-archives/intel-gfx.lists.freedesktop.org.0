...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 91D7B7B8B23
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Oct 2023 20:47:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 98AE810E3B6;
	Wed,  4 Oct 2023 18:47:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3CE4F10E3B6
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=YwFHlmJalDbRSNXCCOTYMBE69D/k75EhyBeAeFXmSCY=;
 b=Yz2gSoWCMwzf2nFcEJLSi9RZIXZ4CSIK5xdJ/KaCQHILNrDW0sA5Yw7Q
 jTiikDkHXbyPmARz9tFeh4v9bG6XtwStHg7/5F5C2HOdlGbZTtskNCcnr
 YwBE6AZnk3jPxtctS5SlqAYqlvPRMEiv3Ss5vjsYFVFyeHmmQHVbI57R3
 XSfvoIJKPa/MBag+lecAlgCF8Zf/PrwvfxU/AUJMgpkMOuVfNMENf4LPy
 9MEulllwaI8tID0IDpxDqXXSMIxENRd37vFReFveZkkoWhMbtK6TmY+5N
 /oFHqDqzMIc5Jb71GMBKu8U89q5XxafJaIuLR/zse6et8pQyi01kOJkWL w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10853"; a="1864915"
X-IronPort-AV: E=Sophos;i="6.03,201,1694761200"; 
   d="scan'208";a="1864915"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Oct 2023 11:47:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10853"; a="925274558"
X-IronPort-AV: E=Sophos;i="6.03,201,1694761200"; d="scan'208";a="925274558"
...
Message-Id: <20231004183625.1307100-2-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 2/4] drm/i915: Define and use GuC and CTB TLB

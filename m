...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36EF58296FD
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Jan 2024 11:11:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 321EA10E58F;
	Wed, 10 Jan 2024 10:11:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B2E0A10E58F
 for <intel-gfx@lists.freedesktop.org>; Wed, 10 Jan 2024 10:11:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1704881476; x=1736417476;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=mLyZX2FVpXSj8xy8xsk3gOPSwNZ8FXS1M8XWYMOiHOY=;
 b=lPYAb99+XuGPfqXSF43UnA18bFHEhHxd3m18VODRJaUg1lQx6/S251su
 7CoFo69xvtk/P+YexDyOalmAzVXbBruzTgmjcGyqtsES+zfzvqeHuPmO+
 lZpBF9ywaAQom7KzV2al9UZZFvZhmlAgQKiMNc1z7TKM2kfHaTvDt+fMG
 Ha4chhw9WBsqtAP1kRpFqBxnEXBjvoHAy301LtJx2N797mDct9fRKACoC
 QC0dOhERv++k3nUJoIodwamZovc5o+9iB1dBPOtuNP3QGywiPGBt7C41X
 FMGubiw4F3gzt6Zpaxg/HsAykoCyP49b//yxUtp/6ld5KE6vPueKGoRsh Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10947"; a="5217426"
X-IronPort-AV: E=Sophos;i="6.04,184,1695711600"; 
   d="scan'208";a="5217426"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2024 02:11:14 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10947"; a="1113400498"
X-IronPort-AV: E=Sophos;i="6.04,184,1695711600"; d="scan'208";a="1113400498"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.246.0.51])
 ([10.246.0.51])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2024 02:11:13 -0800
Message-ID: <287a84e9-29c1-40a5-ad8c-f29bc9a0aab2@intel.com>
Date: Wed, 10 Jan 2024 11:11:10 +0100
MIME-Version: 1.0

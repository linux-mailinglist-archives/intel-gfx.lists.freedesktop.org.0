...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 540D97F5F9B
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Nov 2023 13:59:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 22FF410E73A;
	Thu, 23 Nov 2023 12:59:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 35B1B10E739
 for <intel-gfx@lists.freedesktop.org>; Thu, 23 Nov 2023 12:58:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1700744337;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type;
 bh=/7ObfiPqZ+LlSreBiTL2Aa55YSP6Ys8mNnpf4ICQ3I0=;
 b=GPBBuW6vltdvFRpph98Znypb00h3PM3tSEht1hN57lgzpxisaGYfjPGFsXRj7K/AdEX7y3
 Zcck+ySgrkQdbRGojV6ivgg1DIFe2HuJ1b3K8sI2PkXNWxKIogG1IAv9e7LatvaBHwcPzo
 dJ75JilpLv2cbY/zgVtme9pi9Y4+5lA=
Received: from mail-wr1-f72.google.com (mail-wr1-f72.google.com
 [209.85.221.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-253-MjdusjwlOGq2GvDvHxlCyg-1; Thu, 23 Nov 2023 07:58:53 -0500
X-MC-Unique: MjdusjwlOGq2GvDvHxlCyg-1
Received: by mail-wr1-f72.google.com with SMTP id
 ffacd0b85a97d-332e61e2480so101824f8f.0
 for <intel-gfx@lists.freedesktop.org>; Thu, 23 Nov 2023 04:58:53 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1700744332; x=1701349132;
 h=content-disposition:mime-version:message-id:subject:cc:to:from:date
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=/7ObfiPqZ+LlSreBiTL2Aa55YSP6Ys8mNnpf4ICQ3I0=;
 b=
X-Gm-Message-State: AOJu0Yz/V908lcrFIiatNst0WJA5RFz1FeN3Zjck3HypW86el3UYeZZ3
 aTDmgIgJ4eHWp8OoBMBYpKrTZRyYFfOuMwXntMhXU+q7+mMofZEg2hX8u8vB1H+35WYfAj9pSYc
 /olRPxSAyAJK8aM1jLhcYmhx4w3vP
X-Received: by 2002:adf:f78f:0:b0:32d:9d80:4039 with SMTP id
 q15-20020adff78f000000b0032d9d804039mr3633198wrp.34.1700744332280; 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A68DF2A8DF8
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Nov 2020 05:02:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4517C6EA32;
	Fri,  6 Nov 2020 04:01:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D831C6EA2B
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Nov 2020 04:01:53 +0000 (UTC)
IronPort-SDR: JCj0659/laSp/RTI6FiroLPWGpqQnZQ0hRIUmKKCrg2x/KbO7LpMkwc1MF+HigNJaotiBXl33y
 LGiz8Wit6DSg==
X-IronPort-AV: E=McAfee;i="6000,8403,9796"; a="157278286"
X-IronPort-AV: E=Sophos;i="5.77,455,1596524400"; d="scan'208";a="157278286"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Nov 2020 20:01:52 -0800
IronPort-SDR: Mo1B5l+qtVe8iNuDieMQsCDukgch4aWInjWpsnVm97OIquHdVQcRviBeyyUc3bY4tw/aqmRFTx
 MhGUyCiQztYQ==
X-IronPort-AV: E=Sophos;i="5.77,455,1596524400"; d="scan'208";a="471918722"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 05 Nov 2020 20:01:52 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Nov 2020 20:03:53 -0800
Message-Id: <20201106040355.12809-13-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v15 12/14] drm/i915: Link planes in a bigjoiner
 configuration, v3.
...
index 5ca83eaf373a..6ccebca1f56b 100644
...
@@ -12813,26 +12813,180 @@ static bool check_single_encoder_cloning(struct intel_atomic_state *state,
 	return true;
 }
...
+		}
 	...
 	return 0;
@@ -12872,6 +13026,7 @@ static int icl_check_nv12_planes(struct intel_crtc_state *crtc_state)
...
@@ -12915,7 +13070,14 @@ static int icl_check_nv12_planes(struct intel_crtc_state *crtc_state)
...
@@ -15268,6 +15430,7 @@ static int intel_atomic_check_bigjoiner(struct intel_atomic_state *state,
 	struct drm_i915_private *dev_priv = to_i915(state->base.dev);
...
@@ -15302,7 +15471,11 @@ static int intel_atomic_check_bigjoiner(struct intel_atomic_state *state,
...
@@ -16915,7 +17088,7 @@ intel_legacy_cursor_update(struct drm_plane *_plane,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 64AE3416C35
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 08:51:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DAF936EE0F;
...
Subject: [Intel-gfx] [PATCH v2 14/17] drm/gma500: cleanup:

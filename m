...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2182707D7A
	for <lists+intel-gfx@lfdr.de>; Thu, 18 May 2023 12:01:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C760D10E4ED;
	Thu, 18 May 2023 10:01:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B9F7A10E057;
 Thu, 18 May 2023 10:01:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684404067; x=1715940067;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=qIlABVHpA4mUgb53G9W3qOFM54dPkHkPUbuqYslwUhk=;
 b=j6m4YWuYbGr0anVD5V7Xl/D8RN6078p7OBiM88AEEdIqTOjzatoZLTlH
 p+E5h0726n/N+WaxVp5xw2PAY52/m4kmOlU5xUUkrnU+p0ffTsRjw6yGd
 NUJAXMtSQ6Kv0dn0HNL6opJwS4REeZvFc4UFTsy0gaK/eslBzEJkmcgip
 mGTsFGGXJxFD4uWPd0rmFEkGqV3b2bYtu+D/lvrLcqH7X4qhdTJ+F9UwI
 sChhXDAOf9Xa8m+GFJBu2Z0oNqR+BOhxmUPa8FSlrrQLkDdFwIFLrN0Rd
 aAqo3ye71SVAG1ATyDEfBOtFmP3A90vPh6PwxM6Qil7NMs6sLCrxk8yif w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10713"; a="438367397"
X-IronPort-AV: E=Sophos;i="5.99,285,1677571200"; d="scan'208";a="438367397"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 May 2023 03:01:07 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10713"; a="791897981"
X-IronPort-AV: E=Sophos;i="5.99,285,1677571200"; d="scan'208";a="791897981"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.28.37])
 ([10.213.28.37])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 May 2023 03:01:05 -0700
Message-ID: <ab7e357f-141a-086a-f701-50ae273ca8bb@intel.com>
Date: Thu, 18 May 2023 12:01:04 +0200
MIME-Version: 1.0
...
References: <20230518031804.3133486-1-matthew.d.roper@intel.com>
 <20230518031804.3133486-5-matthew.d.roper@intel.com>
From: Andrzej Hajda <andrzej.hajda@intel.com>
Organization: Intel Technology Poland sp. z o.o. - ul. Slowackiego 173, 80-298
 Gdansk - KRS 101882 - NIP 957-07-52-316
In-Reply-To: <20230518031804.3133486-5-matthew.d.roper@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
Subject: Re: [Intel-gfx] [PATCH 4/5] drm/i915/display: Make display
 responsible for probing its own IP

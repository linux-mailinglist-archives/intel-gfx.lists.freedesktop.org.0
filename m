...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 057FE5EEC69
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 05:25:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56F1610EA2C;
	Thu, 29 Sep 2022 03:25:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 70C1710EA2C;
 Thu, 29 Sep 2022 03:25:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664421904; x=1695957904;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=TAHD2egD8qVx5yY24vvJEoNL8xiiWXpzU5Ix6/rBwFk=;
 b=KscJXrryKqsuUhK/mGURThHJ5RWzVbdd+DmbNhtuLCqFaIuWqxOmsFLL
 9T3nw1sCrNEWQXB+dDkubTRqPVTKbsUZwb+peAaMObAOFn0qli2isuyst
 +GKRsejX2JWGOn1AD1zemWqyycEnqkrqCkM6aSZRnJ/HVfP0AqmIR+qpj
 LIAMGkI+cddpH87s09Lpjh7/3qd+0kHwWC0k+eub1jdI/jsZrVe5DZvi6
 IqTpwSYyzd4cIflKK9ObnoY5t89zGLvTzVTtEnzK0dM0MvVW0w5frODn1
 sBBvHi0jOf7+fWawqzuw5OFCWnqRfwqZ1bN0daw0SIWipf2C4b0ipLLjN Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="300499463"
X-IronPort-AV: E=Sophos;i="5.93,353,1654585200"; d="scan'208";a="300499463"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Sep 2022 20:25:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="617445794"
X-IronPort-AV: E=Sophos;i="5.93,353,1654585200"; d="scan'208";a="617445794"
Received: from lkp-server01.sh.intel.com (HELO 6126f2790925) ([10.239.97.150])
 by orsmga007.jf.intel.com with ESMTP; 28 Sep 2022 20:24:57 -0700
Received: from kbuild by 6126f2790925 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1odkAT-0000Wg-0N;
 Thu, 29 Sep 2022 03:24:57 +0000
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="4qhG4o4r07Nal/fq"

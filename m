...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32B324E32C5
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Mar 2022 23:44:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 81AD710E49E;
...
Subject: [Intel-gfx] [PATCH v5 2/9] drm/i915/gt: Optimize the migration and
 clear loop

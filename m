...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2908C46F9EE
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 05:40:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 482F610E212;
...
Subject: [Intel-gfx] [PATCH 3/4] drm/i915/guc: Increase GuC log size for
 CONFIG_DEBUG_GEM

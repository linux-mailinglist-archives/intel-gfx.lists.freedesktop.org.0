...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 678842C64AF
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:10:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76CF56EC32;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 058/162] drm/i915/selftests: Prepare object

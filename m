...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 035388B7ED1
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Apr 2024 19:39:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 548E3112DAE;
	Tue, 30 Apr 2024 17:39:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=linux.microsoft.com header.i=@linux.microsoft.com header.b="Ay8PWYZA";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
 by gabe.freedesktop.org (Postfix) with ESMTP id 1FA03112DA2;
 Tue, 30 Apr 2024 17:39:37 +0000 (UTC)
Received: from rrs24-12-35.corp.microsoft.com (unknown [131.107.174.176])
 by linux.microsoft.com (Postfix) with ESMTPSA id 977D0210FBDE;
 Tue, 30 Apr 2024 10:39:36 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 977D0210FBDE
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
 s=default; t=1714498776;
 bh=I3/QrK2Qvyu73V/1WXif1zaeCNbhEpu36Uf57eU90oc=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=Ay8PWYZAN8qYQjs3Dy9YZuNrcODHde9rfF1C7YFE8yniulETJe+dp5Ev8KStli7/I
 m7nHzWDwcyiawQvg3rSQ4KFYgpC7jTwwaYsulCm8tRdc/dXkB6wNndEyYqz+mqLvCZ
 X0tDGySUbm/jM2lZH8/joSG38s7VJd5KKt8ZOku8=
...
Subject: [PATCH v1 03/12] drm/i915: Make I2C terminology more inclusive
Date: Tue, 30 Apr 2024 17:38:02 +0000
Message-Id: <20240430173812.1423757-4-eahariha@linux.microsoft.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 451F8495EEA
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jan 2022 13:20:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B93910E6F5;
...
Subject: Re: [Intel-gfx] [PATCH v9 3/6] drm: implement top-down allocation
 method

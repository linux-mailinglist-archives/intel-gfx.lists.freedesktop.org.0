...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A82884AAF5E
	for <lists+intel-gfx@lfdr.de>; Sun,  6 Feb 2022 14:13:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D12510E622;
	Sun,  6 Feb 2022 13:13:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 19FE110E68D
 for <intel-gfx@lists.freedesktop.org>; Sun,  6 Feb 2022 13:13:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644153229; x=1675689229;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=sqjcRFDa+jjbKDmNtY/gPD9tgL+Ze+e21tnHLPdh1DQ=;
 b=OK/7/BrcJQhLvQJHJqzcB+hFqwirjbPyTRTkYlY0OCOUvMFrZS1nUxKh
 sFQeFvUY7VglaWiNq86pWtCGCj8S45BIJLncsk1QG7MNDRbiZdlEsg6m4
 8pGzvDYzafEw3vt0844BRjqG/RQj0CuL962Mdks/AKCrhtapW0QQaw4vp
 aMcrrl7zCXDS9Nki7IGl1R0yf3+ip+dmWv4hs9ZL6Dypw8xCVvaptGsET
 DUkBY24XjCey9Frawawvgv7/so+gNAR/91MN0YipDjjPrjhiEgSrL5G4H
 Bbo4SOnCyv7TMxM0Ynr2Bh3XKXbZ1SbFW1HC/b7jwFkDoz0QgZErqUTaj A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10249"; a="232145923"
X-IronPort-AV: E=Sophos;i="5.88,347,1635231600"; d="scan'208";a="232145923"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2022 05:13:48 -0800
X-IronPort-AV: E=Sophos;i="5.88,347,1635231600"; d="scan'208";a="539750865"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2022 05:13:45 -0800
...
Date: Sun,  6 Feb 2022 15:13:19 +0200
Message-Id: <20220206131322.3246403-3-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 2/5] mei: add support for graphics system

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C3EA70CACF
	for <lists+intel-gfx@lfdr.de>; Mon, 22 May 2023 22:23:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1645010E380;
	Mon, 22 May 2023 20:23:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8719810E37D;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=HZFwb24WcoqfrNFO4LrQ4hR3W85HfeKi+2c26m3ejG0=;
 b=YvLWsPbPTL+tvKDgBOUfermxw5AJ+AP6q76ZFcdCK36kXgtrUW9l5ebM
 pfAiTkQrPVm30WNERgb8jWiMAYRP7x05y2HEY64j09PbAkW2F7FFQCqRo
 aNlSg4orWZ+wkv5HK419rjBGBNQzlvW6ovm1MtSg/yH2XgzdRHZXPAo5c
 gTW89WmkVywytf7QzD+itJFx0koUtJH1T/s2px0l7lefs0wbd7R6iAIoQ
 plso8xxfI7GaMktIwlnULm3eJj6QupviLaTcRaPmpOgmUVKnXx84LW67+
 zb2plB8AWaxVN9nPeA9X5gzW2SO1cty44r0Fn01feQYC9+znh6iPKwP/8 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="337620402"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="337620402"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 13:23:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="681087972"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="681087972"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 13:23:30 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 22 May 2023 13:23:11 -0700
Message-Id: <20230522202314.3939499-4-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 3/6] drm/i915/display: Move display runtime

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A41F2A89B10
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Apr 2025 12:51:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B24710E72A;
	Tue, 15 Apr 2025 10:51:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="HWFmdr7I";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ACFD010E70A;
 Tue, 15 Apr 2025 10:51:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1744714306; x=1776250306;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=j85UQ22tOz+IRrT9bf/kNLcsKuwKaPe2ydo/ZeBrnZI=;
 b=HWFmdr7ItV163fTq8XotkI2/eQb0CDg11IgcFIzc5uv+2z0Mw2TsGsTL
 HmvQQMn7WoT6d11bQnCAro87PeSblcUs+KRMrkDISGaFUSY/JR8ZpZXeG
 n0PTfYWPp2VX5NSzXC2Vg372IeX3AQrRdlzIOkQIWHQ/iX4ZPP8JvTmVj
 e91ovpc+Ny9MH1F3JcHU7BJYwk5bzpXwETpRTjjx9cOQHCJacK80/9oBx
 sWJ6zddw4spJgp+7Lmc6AeLUQkz/bk9x14m/qOZyJ02CmB8JvRT/+y3vU
 PG59D/DLwXTqmA/o2b38H/5EnhmuFqn+DmJfyN5MWjFUMsar3ZKa/dnl1 g==;
X-CSE-ConnectionGUID: DQwfxSIARPW3MeRkfFjyzg==
X-CSE-MsgGUID: cns3zM4XS5SmcfMKygIWSg==
X-IronPort-AV: E=McAfee;i="6700,10204,11403"; a="56854383"
X-IronPort-AV: E=Sophos;i="6.15,213,1739865600"; d="scan'208";a="56854383"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2025 03:51:45 -0700
X-CSE-ConnectionGUID: W5eY65cdSxumZnXK7dMVrw==
X-CSE-MsgGUID: tlsaHnzjRX2PA+Adxp3Q3g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,213,1739865600"; d="scan'208";a="153283629"
Received: from dprybysh-mobl.ger.corp.intel.com (HELO localhost)
 ([10.245.246.35])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2025 03:51:42 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, ville.syrjala@linux.intel.com,
 Suraj Kandpal <suraj.kandpal@intel.com>
Subject: [PATCH v2 3/3] drm/i915: split out display register macros to a
 separate file
Date: Tue, 15 Apr 2025 13:51:22 +0300
Message-Id: <d66e0e382461a77661d99f7edd02570b55a2cf3c.1744714233.git.jani.nikula@intel.com>
...
All moved lines are moved verbatim, with no additional changes, so 'git
show --color-moved' will be helpful for review.

I've added a way to manually indicate register macro groups that should
be moved or kept. I've added some to the list. I hope the end result is
better than last time. It's trivial to amend those move/keep lists and
re-run this if you spot something that's not right.
---
...
index 21b5db2fa203..863fea23dd08 100644
...
index 32abe9743014..357212f09a0f 100644
...
index 5e8344fdfc28..b7248ae98ad1 100644
...
index 40751f1547b7..9f0509a5d2c1 100644
...
index ca7033251e91..c62e97e494c2 100644
...
index 4f3fa966c537..3e9e0b2b4a53 100644
...
index a5dd2932b852..23712f38d368 100644
...
index 6830950aae3f..e9f315f6a5a1 100644
...
index 07d7f4e8f60f..e9d03daec80d 100644
...
index f5cc38dbe559..b1bff2f0b020 100644
...
index cca22d2402e8..20eafd2a48fd 100644
...
index b48ed5df7a96..def7ce928782 100644
...
index db524d01e574..dfe9972f602e 100644
...
index 3f7c605d47d3..7d70918903e3 100644
...
index 738ae522c8f4..cf4ab425984b 100644
...
index 5d07b6a9e59e..30bf80bb576b 100644
...
index c78315eb44fa..592f6d0cce97 100644
...
index ab1163744bc5..adbe321cb70b 100644
...
index b9b4359751cc..c360d8365c84 100644
...
index 000000000000..19c02a2e3198
--- /dev/null
...
index 98f80a6c63e8..e516104ee069 100644
...
index 7e2ce0c2f6c3..082cb5597c1a 100644
...
index d7a30d0992b7..56224d9ffdc0 100644
...
index cc312596fb77..23ea94ba4c6c 100644
...
index 4c15dcb103aa..94064cb7be28 100644
...
index bd61f3c3ec91..82b74f109315 100644
...
index 1e1af7150723..ce6ccc14d093 100644
...
index 0481b1365b85..c694be9521ae 100644
...
index 84df41086a89..18b79485b9dd 100644
...
index d2dede0a5229..4e05558d6b64 100644
...
index 05cd0f6e6d71..09ee2b157e2f 100644
...
index 72fe390c5af2..f6123081b6bd 100644
...
index 4e92504f5c14..ecebc3946cbb 100644
...
index b61520353c92..7cf3fb9163f4 100644
...
index ce5b1e3f1c20..4665bce3487a 100644
...
index 40deee0769ae..7fdd2254eba6 100644
...
index 451cd26024f7..7356b1d48a4b 100644
...
index abf457e68ee9..c06eec0c654f 100644
...
index 411f17655f89..e344fd1a4717 100644
...
index f9fa17e1f584..fb8ead20e180 100644
...
index 2463e61e7802..8486a378a0e6 100644
...
index f94b7eeae20f..a874a28e4cf9 100644
...
index 9e963bce340f..85b53a08daf8 100644
...
index aff9a3455c1b..ff5dc2515f55 100644
...
index b909ed18a5b2..567887a0cccf 100644
...
index 1307a478861a..221bf8d49afb 100644
...
index 3c3ecf288570..b615be868fd9 100644
...
index 6182f484b5bd..6e4c65a08949 100644
...
index d22b5469672d..86f924c2fe70 100644
...
index 4d4e2b9f5f2d..f2c87deca30e 100644
...
index eef48c014112..aa1915a30bea 100644
...
index 757b9ce7e3b1..89b66473fd17 100644
...
index 2b53ac9f4935..8edc9252276b 100644
...
index 139fa5deba80..c1c6ce390bbc 100644
...
index 684b5d1bc87c..85ec1969d4dd 100644
...
index c6565baf815a..619a6b78a991 100644
...
index ee81220a7c88..b3e41b342127 100644
...
index 8739195aba69..881a690c36e8 100644
...
index 8080f777910a..689595693781 100644
...
index 346737f15fa9..cc16957da106 100644
...
index f25ee2953baf..fa6625fdf4cb 100644
...
index 1e1af5e545a4..35e8103953a0 100644
...
index f9f7ef131371..1b009543d9a2 100644
...
index e6e9010462e3..6ef1100b5917 100644
...
index 88c46a7c948f..7ae9dc2970cd 100644
...
-
 ...
 enum skl_power_gate {
 	SKL_PG0,
@@ -3413,193 +1305,6 @@ enum skl_power_gate {
 	ICL_PG4,
 };
...
@@ -3617,489 +1322,6 @@ enum skl_power_gate {
...
@@ -4107,30 +1329,6 @@ enum skl_power_gate {
...
@@ -4145,45 +1343,6 @@ enum skl_power_gate {
...
@@ -4192,37 +1351,11 @@ enum skl_power_gate {
...
index 76d84cbb8361..de48dbc11740 100644
...
index 6502b8274173..d7a7ccab9e2e 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CE7BB1727B5
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Feb 2020 19:35:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E34F6E0C8;
	Thu, 27 Feb 2020 18:35:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D9B1A6E0C8
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Feb 2020 18:35:35 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga102.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 27 Feb 2020 10:35:35 -0800
X-IronPort-AV: E=Sophos;i="5.70,493,1574150400"; d="scan'208";a="231957584"
Received: from ideak-desk.fi.intel.com ([10.237.72.183])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 27 Feb 2020 10:35:29 -0800
Date: Thu, 27 Feb 2020 20:34:53 +0200
From: Imre Deak <imre.deak@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20200227183453.GA24796@ideak-desk.fi.intel.com>
...
In-Reply-To: <20200227175741.GW13686@intel.com>
...
> > @@ -1350,13 +1350,15 @@ static void gen11_dsi_get_timings(struct intel_=
encoder *encoder,
...
> > @@ -1383,8 +1383,8 @@ static void intel_ddi_clock_get(struct intel_enco=
der *encoder,
...
> > @@ -1052,23 +1052,6 @@ static bool hsw_get_dpll(struct intel_atomic_sta=
te *state,
> >  	return true;
> >  }
> >  =
...
> >  			      const struct intel_dpll_hw_state *hw_state)
> >  {
> > @@ -1080,12 +1063,14 @@ static const struct intel_shared_dpll_funcs hsw=
_ddi_wrpll_funcs =3D {
...
> > @@ -1109,6 +1094,7 @@ static const struct intel_shared_dpll_funcs hsw_d=
di_lcpll_funcs =3D {
...
> > @@ -1574,8 +1560,10 @@ static bool skl_ddi_hdmi_pll_dividers(struct int=
el_crtc_state *crtc_state)
> >  	return true;
> >  }
> >  =

> > -static int skl_calc_wrpll_link(const struct intel_dpll_hw_state *pll_s=
tate)
...
> > @@ -1670,6 +1658,40 @@ skl_ddi_dp_set_dpll_hw_state(struct intel_crtc_s=
tate *crtc_state)
> >  	return true;
> >  }
> >  =
...
> > @@ -1719,50 +1741,17 @@ static bool skl_get_dpll(struct intel_atomic_st=
ate *state,
> >  	return true;
> >  }
> >  =
...
> > @@ -1779,12 +1768,14 @@ static const struct intel_shared_dpll_funcs skl=
_ddi_pll_funcs =3D {
...
> > @@ -2190,11 +2181,10 @@ bxt_ddi_hdmi_set_dpll_hw_state(struct intel_crt=
c_state *crtc_state)
...
> >  	clock.m1 =3D 2;
> > @@ -2264,6 +2254,7 @@ static const struct intel_shared_dpll_funcs bxt_d=
di_pll_funcs =3D {
...
> > @@ -2608,9 +2599,10 @@ static bool cnl_ddi_hdmi_pll_dividers(struct int=
el_crtc_state *crtc_state)
> >  	return true;
> >  }
> >  =
...
> > @@ -2709,6 +2701,44 @@ cnl_ddi_dp_set_dpll_hw_state(struct intel_crtc_s=
tate *crtc_state)
> >  	return true;
> >  }
> >  =
...
> >  			 struct intel_crtc *crtc,
> >  			 struct intel_encoder *encoder)
> > @@ -2758,51 +2788,13 @@ static bool cnl_get_dpll(struct intel_atomic_st=
ate *state,
> >  	return true;
> >  }
> >  =
...
> > @@ -2818,6 +2810,7 @@ static const struct intel_shared_dpll_funcs cnl_d=
di_pll_funcs =3D {
...
> > @@ -2979,6 +2972,18 @@ static bool icl_calc_tbt_pll(struct intel_crtc_s=
tate *crtc_state,
> >  	return true;
> >  }
> >  =
...
> >  				struct intel_encoder *encoder,
> >  				struct intel_dpll_hw_state *pll_state)
> > @@ -3317,9 +3322,10 @@ static bool icl_calc_mg_pll_state(struct intel_c=
...
> > @@ -3388,19 +3394,6 @@ static int icl_calc_mg_pll_link(struct drm_i915_=
private *dev_priv,
> >  	return tmp;
> >  }
> >  =
...
> > -
> >  /**
> >   * icl_set_active_port_dpll - select the active port DPLL for a given =
CRTC
> >   * @crtc_state: state for the CRTC to select the DPLL for
> > @@ -3485,6 +3478,12 @@ static bool icl_get_combo_phy_dpll(struct intel_=
atomic_state *state,
> >  	return true;
> >  }
> >  =
...
> >  				 struct intel_crtc *crtc,
> >  				 struct intel_encoder *encoder)
> > @@ -4141,18 +4140,21 @@ static const struct intel_shared_dpll_funcs com=
bo_pll_funcs =3D {
...
> > @@ -4192,6 +4194,7 @@ static const struct intel_shared_dpll_funcs dkl_p=
ll_funcs =3D {
> >  	.enable =3D mg_pll_enable,
> >  	.disable =3D mg_pll_disable,
...
> > @@ -4348,27 +4351,15 @@ void intel_update_active_dpll(struct intel_atom=
ic_state *state,
...
> >  /**
> > @@ -372,8 +375,8 @@ void icl_set_active_port_dpll(struct intel_crtc_sta=
te *crtc_state,
...
te);
> > @@ -384,7 +387,6 @@ void intel_dpll_sanitize_state(struct drm_i915_priv=
ate *dev_priv);
> >  =

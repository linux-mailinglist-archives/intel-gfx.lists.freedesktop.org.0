...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B903552B5A5
	for <lists+intel-gfx@lfdr.de>; Wed, 18 May 2022 11:18:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8596410EDF5;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: check fence to avoid null pointer
 dereference

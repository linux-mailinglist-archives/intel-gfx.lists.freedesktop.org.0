...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B91AA1B8AB
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Jan 2025 16:16:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6E7F10E99E;
	Fri, 24 Jan 2025 15:16:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="CzViRXIH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AE71910E997;
 Fri, 24 Jan 2025 15:16:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1737731783; x=1769267783;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=wVON4vpQz/buogCA93VkTsM+eIZ/2GlrvJwZKAQ1L+c=;
 b=CzViRXIHEhKuCxr9OOP7YMiKOueZnH9daJvkW3d5LHoDbkCaE4CGNF6O
 EK81bc21inTSUnLwpD7i90mHwwBNnQwcdcSRIoxLNKb9A9AUzmDW++G3o
 gbLOrpRK69fy0LSLDVSXI0B96WdWK38jqy6mvZiV5mAX478GmYVkBKvSn
 q/hPTuDK97TOO/r5XQOvKg0ULVxOvBrFJoj0NBdbUOIddGhE4fOBGA7LJ
 jqfG9xSegzu12QuytPWeJ89x8BI33cRVsds4RvXUMJNorrTipmXGPtEqp
 gaUs8rgYzwJmPZiqPxqo+fGroFBMU3TivFs9Wuuj6ld3OFb3wQi524yPz A==;
X-CSE-ConnectionGUID: rXCJfBsjQy2e+adAF6TJ4g==
X-CSE-MsgGUID: P0RSZdyMT+Wq/1tPJCS4fw==
X-IronPort-AV: E=McAfee;i="6700,10204,11325"; a="38298404"
X-IronPort-AV: E=Sophos;i="6.13,231,1732608000"; d="scan'208";a="38298404"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jan 2025 07:16:23 -0800
X-CSE-ConnectionGUID: cTu/Co6gTe2kCIX7ySaPiA==
X-CSE-MsgGUID: bJXEJIBbQNCFdRJ0Z8K4xw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,231,1732608000"; d="scan'208";a="107912154"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by fmviesa008.fm.intel.com with SMTP; 24 Jan 2025 07:16:20 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 24 Jan 2025 17:16:20 +0200
Date: Fri, 24 Jan 2025 17:16:20 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Gustavo Sousa <gustavo.sousa@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org,
 Jani Nikula <jani.nikula@intel.com>
Subject: Re: [PATCH v7] drm/i915/cmtg: Disable the CMTG
Message-ID: <Z5OuxLDHHvEnfcaJ@intel.com>
...
In-Reply-To: <173772913356.3215.15837611112615353054@intel.com>

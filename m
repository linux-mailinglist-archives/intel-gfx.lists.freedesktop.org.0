...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7E722B29F4
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Nov 2020 01:37:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84E9E6E8AB;
	Sat, 14 Nov 2020 00:37:35 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 53BF06E8AC
 for <Intel-gfx@lists.freedesktop.org>; Sat, 14 Nov 2020 00:37:28 +0000 (UTC)
IronPort-SDR: 0USNUzTiQ6eIbGxxKBEiH2aZ6T1/lkr0RNWB7zkJCf6wLBEGZJzfM1oyh3Zq3kJqhKl2ek6nEu
 zdTGkgkcCzsA==
X-IronPort-AV: E=McAfee;i="6000,8403,9804"; a="169768619"
X-IronPort-AV: E=Sophos;i="5.77,477,1596524400"; d="scan'208";a="169768619"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Nov 2020 16:37:18 -0800
IronPort-SDR: 56FDZNooTLRrPQdN7Aqsc18n3REe/YyRQXtaT2ebvPt4sg3ennX5awnx+TLEEN6qt6LbHrf9wR
 UYKy9JMoYaFw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,477,1596524400"; d="scan'208";a="474848534"
...
Date: Fri, 13 Nov 2020 16:37:00 -0800
Message-Id: <20201114003716.4875-11-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201114003716.4875-1-sean.z.huang@intel.com>
References: <20201114003716.4875-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [PXP CLEAN PATCH v06 11/27] drm/i915/pxp: Enable ioctl
 action to set session in play

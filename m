...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7135132A182
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Mar 2021 14:51:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83E9F6E0D8;
	Tue,  2 Mar 2021 13:51:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 962386E0D8
 for <intel-gfx@lists.freedesktop.org>; Tue,  2 Mar 2021 13:51:01 +0000 (UTC)
IronPort-SDR: WAx56zKrfr+HPkzF+gjPscnTNIjv4TQPHZBHJ5IFbLZIWi2AaMpyEcH79weQC7ETzQQ/aQoyqz
 u7a4L0Ad8OXg==
X-IronPort-AV: E=McAfee;i="6000,8403,9910"; a="186874268"
X-IronPort-AV: E=Sophos;i="5.81,216,1610438400"; 
 d="scan'208,217";a="186874268"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Mar 2021 05:51:00 -0800
IronPort-SDR: 09Xo6c/fh1s+GVGBeRfze/H9iZxR/g1WknDFwFXlTtX/5bOTcCLCS1BlRUZ6vQqd+1WhyyGfg3
 vapqMSqVPEjw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,216,1610438400"; 
 d="scan'208,217";a="399028856"
Received: from irsmsx604.ger.corp.intel.com ([163.33.146.137])
 by fmsmga008.fm.intel.com with ESMTP; 02 Mar 2021 05:50:59 -0800
Received: from irsmsx601.ger.corp.intel.com (163.33.146.7) by
 IRSMSX604.ger.corp.intel.com (163.33.146.137) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2106.2; Tue, 2 Mar 2021 13:50:58 +0000
Received: from irsmsx601.ger.corp.intel.com ([163.33.146.7]) by
 irsmsx601.ger.corp.intel.com ([163.33.146.7]) with mapi id 15.01.2106.002;
 Tue, 2 Mar 2021 13:50:58 +0000
From: "Sarvela, Tomi P" <tomi.p.sarvela@intel.com>
To: "intel-gfx@lists.freedesktop.org" <intel-gfx@lists.freedesktop.org>
Thread-Topic: Public i915 CI shardruns are disabled
Thread-Index: AdcPWHkSgYTOIBqtStq84U3dnNSQvwAC8QNQ
Date: Tue, 2 Mar 2021 13:50:58 +0000
Message-ID: <51946a94b1154605bd7dda2c77ab12fc@intel.com>
...
Content-Type: multipart/mixed; boundary="===============1459941277=="
...
Content-Type: multipart/alternative;
	boundary="_000_51946a94b1154605bd7dda2c77ab12fcintelcom_"
...
/* List Definitions */
@list l0
	{mso-list-id:32964825;
	mso-list-type:hybrid;
	mso-list-template-ids:-1070957436 -366593260 67829763 67829765 67829761 67=
829763 67829765 67829761 67829763 67829765;}
@list l0:level1
...
@list l0:level9
	...
	font-family:Wingdings;}
@list l1
	{mso-list-id:768233606;
	mso-list-type:hybrid;
	mso-list-template-ids:580949550 1149940604 67829763 67829765 67829761 6782=
9763 67829765 67829761 67829763 67829765;}
@list l1:level1
	{mso-level-start-at:0;
	mso-level-number-format:bullet;
	mso-level-text:-;
...
@list l1:level9
	...
	font-family:Wingdings;}
@list l2
	{mso-list-id:1665160783;
	mso-list-type:hybrid;
	mso-list-template-ids:663756974 -1589839208 67829763 67829765 67829761 678=
...
@list l2:level9
	...
	font-family:Wingdings;}
@list l3
	{mso-list-id:1974826458;
	mso-list-type:hybrid;
	mso-list-template-ids:1879981442 -697285356 67829763 67829765 67829761 678=
29763 67829765 67829761 67829763 67829765;}
@list l3:level1
	{mso-level-start-at:0;
	mso-level-number-format:bullet;
...
<p class=3D"MsoNormal"><span lang=3D"EN-US">- Issue happens in </span><span=
 lang=3D"EN-US">igt@gem_tiled_swapping@non-threaded Mlocking<o:p></o:p></sp=
an></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US">phase, before &#8220;starting s=
ubtest&#8221; appears.<o:p></o:p></span></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US"><o:p>&nbsp;</o:p></span></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US">- </span><span lang=3D"EN-US">F=
ilesystem trashed is the one containing swapfile<o:p></o:p></span></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US"><o:p>&nbsp;</o:p></span></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US">- </span><span lang=3D"EN-US">I=
f swap is partition, it seems that the swap signature is correct even<o:p><=
/o:p></span></p>
...
<p class=3D"MsoNormal"><span lang=3D"EN-US">CI_DRM_9817 and 9818 might work=
 better</span><span lang=3D"EN-US"><o:p></o:p></span></p>
<p class=3D"MsoNormal"><span lang=3D"EN-US"><o:p>&nbsp;</o:p></span></p>
...
"> Sarvela, Tomi P
<br>
<b>Sent:</b> Tuesday, March 2, 2021 1:38 PM<br>
<b>To:</b> intel-gfx@lists.freedesktop.org<br>
<b>Cc:</b> Szwichtenberg, Radoslaw &lt;radoslaw.szwichtenberg@intel.com&gt;=
<br>
<b>Subject:</b> Public i915 CI shardruns are disabled<o:p></o:p></span></p>
</div>
</div>

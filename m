...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CC60DAC9EB
	for <lists+intel-gfx@lfdr.de>; Sun,  8 Sep 2019 01:22:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6E1989DA7;
	Sat,  7 Sep 2019 23:22:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7CD7289DBA;
 Sat,  7 Sep 2019 23:22:47 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 07 Sep 2019 16:22:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,478,1559545200"; d="scan'208";a="177981245"
Received: from helsinki.fi.intel.com ([10.237.66.149])
 by orsmga008.jf.intel.com with ESMTP; 07 Sep 2019 16:22:45 -0700
From: Gwan-gyeong Mun <gwan-gyeong.mun@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sun,  8 Sep 2019 02:22:25 +0300
Message-Id: <20190907232226.9064-7-gwan-gyeong.mun@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 6/7] drm/i915/dp: Program an Infoframe SDP
...
X2RkaS5jCmluZGV4IDg3ZGM1YTE5Y2I3Yi4uMTExYTVjOTViZTg1IDEwMDY0NAotLS0gYS9kcml2
ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2RkaS5jCisrKyBiL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGRpLmMKQEAgLTM2MTIsNiArMzYxMiw3IEBAIHN0YXRpYyB2
...

...
CQkgY29uc3Qgc3RydWN0IGRybV9jb25uZWN0b3Jfc3RhdGUgKmNvbm5fc3RhdGUpCkBAIC00NjA2
LDYgKzQ2ODMsMTggQEAgdm9pZCBpbnRlbF9kcF92c2NfZW5hYmxlKHN0cnVjdCBpbnRlbF9kcCAq

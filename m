...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 744C94E7A1F
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Mar 2022 18:53:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7106610E988;
	Fri, 25 Mar 2022 17:53:17 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v7 3/3] i915/gvt: Use the initial HW state

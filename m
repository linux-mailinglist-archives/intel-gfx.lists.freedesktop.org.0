...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1773216C42C
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Feb 2020 15:38:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74CCB6EB14;
	Tue, 25 Feb 2020 14:38:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C4F1C6EAF7
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Feb 2020 14:38:32 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Feb 2020 15:38:20 +0100
Message-Id: <20200225143824.1858038-16-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 16/20] drm/i915: Convert i915_perf to ww locking
 as well
...
@@ -1242,24 +1242,39 @@ static struct intel_context *oa_pin_context(struct i915_perf_stream *stream)
...
@@ -1976,15 +1991,22 @@ static int emit_oa_config(struct i915_perf_stream *stream,
 {
...
@@ -1994,11 +2016,9 @@ static int emit_oa_config(struct i915_perf_stream *stream,
 		goto err_vma_unpin;
 	}
...
@@ -2009,7 +2029,14 @@ static int emit_oa_config(struct i915_perf_stream *stream,
 	i915_request_add(rq);
 err_vma_unpin:
 	i915_vma_unpin(vma);
-err_vma_put:

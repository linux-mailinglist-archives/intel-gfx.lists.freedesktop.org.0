...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7ED644BAAED
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 21:27:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8CDE610E7B8;
...
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915/gem: Remove logic for
 wbinvd_on_all_cpus

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D4CE5AC720
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:45:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67C6D10E298;
...
Subject: [Intel-gfx] [PATCH v6 23/57] drm: POC drm on dyndbg - use in core,
 2 helpers, 3 drivers.

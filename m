...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E08E144308
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Jan 2020 18:20:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C90026EDF2;
...
Subject: [Intel-gfx] [PATCH 2/6] drm/i915/ddi: convert to struct drm_device
 log macros.

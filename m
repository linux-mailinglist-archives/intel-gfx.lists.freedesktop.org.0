...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 00CCA757DDB
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 15:39:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB19210E353;
...
Subject: [Intel-gfx] [PATCH v5 3/9] drm/i915: Add the has_aux_ccs device
 property

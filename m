...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AEF4DAD1C38
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Jun 2025 13:06:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC83410E109;
	Mon,  9 Jun 2025 11:06:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SfHZ0HY8";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 39C6910E09B;
 Mon,  9 Jun 2025 11:06:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1749467204; x=1781003204;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=JUYTMS3ASyweI8DJebmZSyJBDI/VBhfDmAIHIsNk0Mg=;
 b=SfHZ0HY8AN58J2srzTJA0RJYCm/1Wq5JxuoAadqAINQ/gZ41s5nM7QoU
 h0qii3/ffJTf0Ar203m8D+WXi5u3wg/Y/qmnxTkTzBgeyZm6d/FeCTAts
 1WgBXeTisMmEHUt50ghMnPMPzhRuqgoYIhfmOJnql6lb4ty6aIhGsFXyz
 /j+qWu6DVjWRZ9c1EY0lABOELCvH9e/+eWf/o/qfqG1yTq3wzLfHQNIvg
 G0nCEQrQ7ePvQLtBkg6ckb/Xoot3hdHKG4ItlIgZstqoA3NwzBaJGg+vx
 BnYIAk4ULXkfxHJSrKoFOYFBT6qfJ9zdfORcWo/JnP/0/snWTE1P09WV6 A==;
X-CSE-ConnectionGUID: T/qFDoOyR+iTnlY6CsJ3Ig==
X-CSE-MsgGUID: JuTUHc/4Rn+q+jgBzKIDRA==
X-IronPort-AV: E=McAfee;i="6800,10657,11458"; a="62193077"
X-IronPort-AV: E=Sophos;i="6.16,222,1744095600"; d="scan'208";a="62193077"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2025 04:06:44 -0700
X-CSE-ConnectionGUID: B2AVCwb6Soe/b0AN3s30rQ==
X-CSE-MsgGUID: qz+SStE6Q5OMvItYJYVCFQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,222,1744095600"; d="scan'208";a="146417142"
Received: from orsmsx902.amr.corp.intel.com ([10.22.229.24])
 by orviesa010.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2025 04:06:43 -0700
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 09 Jun 2025 11:06:39.9553 (UTC)

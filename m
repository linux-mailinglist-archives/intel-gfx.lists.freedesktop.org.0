...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 289DA3F6D31
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Aug 2021 03:44:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 976BF6E0F8;
...
Subject: Re: [Intel-gfx] [PATCH 18/27] drm/i915/guc: Release submit fence
 from an irq_work

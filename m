...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F10246569
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jun 2019 19:10:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B8EE489A8B;
	Fri, 14 Jun 2019 17:10:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8563789A8B
 for <intel-gfx@lists.freedesktop.org>; Fri, 14 Jun 2019 17:10:22 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 16905690-1500050 for multiple; Fri, 14 Jun 2019 18:10:19 +0100
MIME-Version: 1.0
...
References: <20190614164350.30415-1-mika.kuoppala@linux.intel.com>
 <20190614164350.30415-3-mika.kuoppala@linux.intel.com>
In-Reply-To: <20190614164350.30415-3-mika.kuoppala@linux.intel.com>
Message-ID: <156053221699.7796.17150102570716694891@skylake-alporthouse-com>
Date: Fri, 14 Jun 2019 18:10:17 +0100
Subject: Re: [Intel-gfx] [PATCH 03/10] drm/i915/gtt: Introduce
 init_pd_with_page
...
UXVvdGluZyBNaWthIEt1b3BwYWxhICgyMDE5LTA2LTE0IDE3OjQzOjQzKQo+IFdlIHNldCB0aGUg
...
bmRleCBlZjNmYTZiNWVmMTAuLmEyYWIwYjdiYjIzNCAxMDA2NDQKPiAtLS0gYS9kcml2ZXJzL2dw
dS9kcm0vaTkxNS9pOTE1X2dlbV9ndHQuYwo+ICsrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5
MTVfZ2VtX2d0dC5jCj4gQEAgLTcyNiwxMiArNzI2LDEyIEBAIHN0YXRpYyB2b2lkIGZyZWVfcGQo
...
bSwgcGQsIGdlbjhfcGRlX2VuY29kZShweF9kbWEocHQpLCBJOTE1X0NBQ0hFX0xMQykpOwo+ICsg
ICAgICAgbWVtc2V0X3AocGQtPmVudHJ5LCBwdCwgNTEyKTsKCkxvb2tzIGdvb2QsClJldmlld2Vk

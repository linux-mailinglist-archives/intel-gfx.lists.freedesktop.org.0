...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7678C4FE9AB
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 22:52:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 32B9210E765;
...
Subject: Re: [Intel-gfx] [PATCH 33/34] vfio/mdev: Use the driver core to

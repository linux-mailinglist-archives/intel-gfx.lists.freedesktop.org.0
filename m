...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F141088601
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 00:28:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4642E6EF23;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 24/37] drm/i915: set num_fence_regs to 0 if

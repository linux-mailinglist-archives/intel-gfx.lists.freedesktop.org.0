...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C3AF95B81E5
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Sep 2022 09:13:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7870210E5C7;
	Wed, 14 Sep 2022 07:13:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 031BF10E422
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Sep 2022 07:13:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663139618; x=1694675618;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=pzMsTTdSjEQAc4BOInAY6G6HHagko7a6+hhmj5hijDQ=;
 b=V5Efnd2cDs929OuGwBUw+0eVR9VUGa3et89uK0WT/mOfrywO6siZ8RRf
 nEqgpHjOgu09XPVeG0Bf7DkhdwuWN34ujx9glXGFHMxg57ekzq0A69Hhj
 acphBIa7aaBxiOCRrQAZxfk0Fm2a2ctdl7Fz4ofbQmeHgELc0YRGjONKW
 w+U5mgTCe+q79AUbnCJhvlzb406YsBQ+W/ehgpEXq5jqRxOI+PEbrnXBx
 1ZY+PGcHuxknEbU8zhx0Ys+1XTwNpF2HKQgAS9X67CH5nHaADIEmDQHHa
 B544grCqkPhdk1LEWrdmLkK47VeVdYG3wJ5kGwi/RwKkSzcbRH4X9DbhB g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10469"; a="324606897"
X-IronPort-AV: E=Sophos;i="5.93,313,1654585200"; d="scan'208";a="324606897"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2022 00:13:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,313,1654585200"; d="scan'208";a="567904174"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga003.jf.intel.com with ESMTP; 14 Sep 2022 00:13:34 -0700
From: "Kandpal, Suraj" <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 14 Sep 2022 12:42:26 +0530
Message-Id: <20220914071228.1595878-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/3] drm/i915: Define WD trancoder for i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2581970F6B4
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 14:42:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 890D510E677;
	Wed, 24 May 2023 12:42:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 75D3D10E677
 for <intel-gfx@lists.freedesktop.org>; Wed, 24 May 2023 12:42:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684932126; x=1716468126;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=XPDwWIaXS7gitexGHnVtMNj92widGCCHY6N2HeSBtrA=;
 b=h0iMj79WNz+rgLL9LNybsja09zNu8xBJMWtyScAyXsp7mwzwD3INVXpI
 LRVE19EtjwhChEdVbXClxhzbP6RBqZYiZJuhQPVV2UpAsJ0EPaDpH9BsV
 6EuvhcI5PWj4gLraXga8D6wg2JteY74cz7FGD/TcKvE2YkelVdbd/op+L
 087XXMBxAGBcNA+OTtceOrOePvJRH7ksqBPQVBfA7iIVN+zTKtnUMe3QO
 +IWLZSe68TAjaPdv0na+QRjj8W0JRub/063Zv8REpyjZ7iRkUwh8rSOvJ
 J8wmRelyxdPa9+PASiCSJhEIDF0NyVpnIgh4J4l4ELEpz0niN11VuGPEr A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="353575703"
X-IronPort-AV: E=Sophos;i="6.00,189,1681196400"; d="scan'208";a="353575703"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 05:42:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="828561924"
X-IronPort-AV: E=Sophos;i="6.00,189,1681196400"; d="scan'208";a="828561924"
Received: from kathrine-mobl2.ger.corp.intel.com (HELO
 vgovind2-mobl3.intel.com) ([10.251.223.215])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 05:42:03 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 24 May 2023 15:41:21 +0300
Message-Id: <20230524124124.378194-5-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 4/7] drm/i915: extract

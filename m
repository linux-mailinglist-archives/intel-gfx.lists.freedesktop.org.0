...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C8F12D4786
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Dec 2020 18:11:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D05C36EB07;
...
Subject: Re: [Intel-gfx] (subset) [PATCH 000/141] Fix fall-through warnings
 for Clang

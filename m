...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FB88572A79
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 02:54:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A048097EEA;
...
Subject: Re: [Intel-gfx] [PATCH 09/12] drm/i915/selftest: Cope with not
 having an RCS engine

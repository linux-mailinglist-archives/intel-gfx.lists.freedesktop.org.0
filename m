...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6828B2AB85
	for <lists+intel-gfx@lfdr.de>; Sun, 26 May 2019 20:05:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E43E897C3;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 ItHA==
Subject: [Intel-gfx] [PATCH v2 0/2] drm/panel: drmP.h removal + small fix
...
Cc: David Airlie <airlied@linux.ie>, Linus Walleij <linus.walleij@linaro.org>,
 intel-gfx@lists.freedesktop.org, Stefan Mavrodiev <stefan@olimex.com>

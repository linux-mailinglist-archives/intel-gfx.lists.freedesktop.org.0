...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B045A3A1C32
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Jun 2021 19:45:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0317D6EAD8;
	Wed,  9 Jun 2021 17:45:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pf1-x435.google.com (mail-pf1-x435.google.com
 [IPv6:2607:f8b0:4864:20::435])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CDFEF6EAD6
 for <intel-gfx@lists.freedesktop.org>; Wed,  9 Jun 2021 17:44:59 +0000 (UTC)
Received: by mail-pf1-x435.google.com with SMTP id u126so15001280pfu.13
 for <intel-gfx@lists.freedesktop.org>; Wed, 09 Jun 2021 10:44:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=jlekstrand-net.20150623.gappssmtp.com; s=20150623;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=5uLxWPZXO1QCNOTv9xIw9fJ/DqpXPbn/95/yabRND0M=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=5uLxWPZXO1QCNOTv9xIw9fJ/DqpXPbn/95/yabRND0M=;
 b=
X-Gm-Message-State: AOAM530zF2g6PfHHe1w9ZCGMqHvCjGB9rNsA0gpR/KDY+ixGfchYggbE
 aG47R16WhiA77Ll4qmMJ3lpbRg==
X-Google-Smtp-Source: ABdhPJypbxYCbJpOdtdDe803m1nugUGC0qRXQ2QkT7B0HMXlhp5rYXgZlDl0XgEjhYc8ptAiDbx3lg==
X-Received: by 2002:aa7:962f:0:b029:2ed:cf:1f90 with SMTP id
 r15-20020aa7962f0000b02902ed00cf1f90mr825955pfg.76.1623260699183; 
 Wed, 09 Jun 2021 10:44:59 -0700 (PDT)
Received: from omlet.lan (jfdmzpr04-ext.jf.intel.com. [134.134.137.73])
 by smtp.gmail.com with ESMTPSA id b10sm208619pfi.122.2021.06.09.10.44.57
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 09 Jun 2021 10:44:58 -0700 (PDT)
From: Jason Ekstrand <jason@jlekstrand.net>
To: dri-devel@lists.freedesktop.org,
	intel-gfx@lists.freedesktop.org
Date: Wed,  9 Jun 2021 12:44:08 -0500
Message-Id: <20210609174418.249585-22-jason@jlekstrand.net>
...
@@ -248,6 +255,8 @@ proto_context_create(struct drm_i915_private *i915, unsigned int flags)
 	if (!pc)
...
@@ -269,6 +278,430 @@ proto_context_create(struct drm_i915_private *i915, unsigned int flags)
 	return err;
 }
...
+
 ...
 {
@@ -462,6 +895,56 @@ static struct i915_gem_engines *default_engines(struct i915_gem_context *ctx,
 	return err;
 }
...
@@ -766,7 +1249,6 @@ __create_context(struct drm_i915_private *i915,
 {
...
@@ -784,7 +1266,7 @@ __create_context(struct drm_i915_private *i915,
...
+	e = default_engines(ctx, pc->legacy_rcs_sseu);
 	if (IS_ERR(e)) {
 		err = PTR_ERR(e);
 		goto err_free;
@@ -922,6 +1404,24 @@ i915_gem_create_context(struct drm_i915_private *i915,
...
@@ -1956,7 +2456,7 @@ static int ctx_setparam(struct drm_i915_file_private *fpriv,
 }
...
@@ -1971,7 +2471,7 @@ static int create_setparam(struct i915_user_extension __user *ext, void *data)
...
@@ -1994,7 +2494,7 @@ int i915_gem_context_create_ioctl(struct drm_device *dev, void *data,
 {
...
+	struct i915_gem_context *ctx;
 	...
 	int ret;
 	u32 id;
@@ -2017,25 +2517,27 @@ int i915_gem_context_create_ioctl(struct drm_device *dev, void *data,
 		return -EIO;
 	}
...
@@ -2045,7 +2547,7 @@ int i915_gem_context_create_ioctl(struct drm_device *dev, void *data,
 	return 0;

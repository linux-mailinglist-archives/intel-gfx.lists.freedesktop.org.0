...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 33DA36013EE
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Oct 2022 18:52:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D28F10EDA4;
	Mon, 17 Oct 2022 16:52:05 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 05/14] drm/i915/gt: Add
 intel_gt_mcr_multicast_rmw() operation

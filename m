...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 145CE616195
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Nov 2022 12:18:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFFB410E47C;
	Wed,  2 Nov 2022 11:17:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1C06510E477
 for <intel-gfx@lists.freedesktop.org>; Wed,  2 Nov 2022 11:17:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667387868; x=1698923868;
 h=message-id:date:mime-version:cc:subject:to:references:
 from:in-reply-to:content-transfer-encoding;
 bh=7L5jtXqroh+dSe/5mpLCVCJI2n630bi0o3depG/Lmp4=;
 b=MkvN0FXLZdr0tKIS6ll0Xiq+2UiBRy6LrAjjUzQvp0wVxYk2ZcBfga9n
 ZrWjr513nxGUXfkCenGxn4OK5mE7LLpEl/YteD/lm0BtbkDqxcKawAWYy
 62CSGVnnXLFlat5JxXVC55blmla0oFVTUihuS89eIJY67ZZm7KeaxRX4A
 ImcCLZJMJst0PgvJfvOp6tC2yLt13Ia7tI2vtC5BzjvQsmykC18JDM978
 j4gRWboRiO4ArVx+liA67/ZKHXOKQ7JAUkmMIuJIrC7jRGQOSsjithXkR
 /v6HsjRQpxqQfzM5zKcI37Zk4lHru1Sd4ANmNn6W4gGZNeu4Cw30LrrEu A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10518"; a="308101190"
X-IronPort-AV: E=Sophos;i="5.95,232,1661842800"; d="scan'208";a="308101190"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Nov 2022 04:17:47 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10518"; a="612206821"
X-IronPort-AV: E=Sophos;i="5.95,232,1661842800"; d="scan'208";a="612206821"
Received: from blu2-mobl3.ccr.corp.intel.com (HELO [10.254.215.165])
 ([10.254.215.165])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Nov 2022 04:17:44 -0700

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 58C9F51BC9E
	for <lists+intel-gfx@lfdr.de>; Thu,  5 May 2022 11:59:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A012C10F4AD;
	Thu,  5 May 2022 09:59:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id 8028F10F4EC;
 Thu,  5 May 2022 09:59:43 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 7E5FFAA0EB;
 Thu,  5 May 2022 09:59:43 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============1402590130343295811=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Anusha Srivatsa" <anusha.srivatsa@intel.com>
Date: Thu, 05 May 2022 09:59:43 -0000
Message-ID: <165174478348.7658.547895679354063591@emeril.freedesktop.org>
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_102630v5:
...
#### Suppressed ####
  ...
  * igt@i915_pm_rpm@basic-pci-d3-state:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11607/bat-dg2-8/igt@i915_pm_rpm@basic-pci-d3-state.html
   [2]: None
...
#### Issues hit ####
  ...
  * igt@gem_huc_copy@huc-copy:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-hsw-4770/igt@gem_huc_copy@huc-copy.html

  * igt@i915_pm_backlight@basic-brightness:
    - fi-hsw-4770:        NOTRUN -> [SKIP][4] ([fdo#109271] / [i915#3012])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-hsw-4770/igt@i915_pm_backlight@basic-brightness.html

  * igt@kms_chamelium@common-hpd-after-suspend:
    - fi-hsw-4770:        NOTRUN -> [SKIP][5] ([fdo#109271] / [fdo#111827]) +8 similar issues
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-hsw-4770/igt@kms_chamelium@common-hpd-after-suspend.html
    - fi-hsw-g3258:       NOTRUN -> [SKIP][6] ([fdo#109271] / [fdo#111827])
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-hsw-g3258/igt@kms_chamelium@common-hpd-after-suspend.html

  * igt@kms_pipe_crc_basic@compare-crc-sanitycheck-pipe-d:
    - fi-hsw-4770:        NOTRUN -> [SKIP][7] ([fdo#109271] / [i915#533])
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-hsw-4770/igt@kms_pipe_crc_basic@compare-crc-sanitycheck-pipe-d.html

  * igt@kms_psr@primary_mmap_gtt:
    - fi-hsw-4770:        NOTRUN -> [SKIP][8] ([fdo#109271] / [i915#1072]) +3 similar issues
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-hsw-4770/igt@kms_psr@primary_mmap_gtt.html
...
#### Possible fixes ####
  ...
  * igt@i915_selftest@live@hangcheck:
   ...
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-hsw-g3258/igt@i915_selftest@live@hangcheck.html
   ...
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/fi-ehl-2/igt@i915_selftest@live@hangcheck.html

  * igt@i915_selftest@live@requests:
    - {bat-rpls-1}:       [INCOMPLETE][13] ([i915#4983] / [i915#5338]) -> [PASS][14]
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11607/bat-rpls-1/igt@i915_selftest@live@requests.html
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_102630v5/bat-rpls-1/igt@i915_selftest@live@requests.html
...
<p>Here are the unknown changes that may have been introduced in Patchwork_102630v5:</p>
<h3>IGT changes</h3>
<h4>Suppressed</h4>
...
<li>{bat-dg2-8}:        <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11607/bat-dg2-8/igt@i915_pm_rpm@basic-pci-d3-state.html">SKIP</a> (<a href="https://gitlab.freedesktop.org/drm/intel/issues/5275">i915#5275</a>) -&gt; <a href="None">SKIP</a> +1 similar issue</li>
</ul>
</li>
</ul>
<h2>Known issues</h2>

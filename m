...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AEDE15E8857
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Sep 2022 06:30:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7FE710EBBA;
	Sat, 24 Sep 2022 04:30:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2A96710EBAD;
 Sat, 24 Sep 2022 04:30:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663993834; x=1695529834;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=r5JchWdxL0sPaQ470AXhPMvMQo0z03ynUU/ygBmM2/M=;
 b=WRVd11oMVNAY2++P5gjd1iSV4IsPzM7xcFyWbZBDwjgp30LJwuscCcPr
 tTiPdLZbMGdc/T2HfCqJ2x7lqz/1TuP+BfNaqi3tI1BWljDsuI/o7W6pM
 XJi/xooklSbLwiipxkP5pf1U7PLIs1VSTp/X7+05A1Y+1i94bpUEsDFPe
 ewb1uZSHsc4hyBuXsFiCnscJz+xHdGkhvY0aX0Fc+8NXcHHA3X9DJfxMx
 cqojcu1VHwxpcr00RAmY0FYN6kCgsT4sy6v9/49zc6c8PR1LOwYMmJz+B
 DHfUnF6y3ueunfHJCMESb/FaAh5Q3XxcLfIguMrvtEp06Yihul89ETF00 Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10479"; a="387033495"
X-IronPort-AV: E=Sophos;i="5.93,341,1654585200"; d="scan'208";a="387033495"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2022 21:30:33 -0700
X-IronPort-AV: E=Sophos;i="5.93,341,1654585200"; d="scan'208";a="615846027"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2022 21:30:33 -0700
Date: Fri, 23 Sep 2022 21:30:11 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Message-ID: <20220924043010.GJ28263@nvishwa1-DESK>
...
In-Reply-To: <99bbab8d-42e7-2aed-d64a-5bd61dfc9fd6@linux.intel.com>

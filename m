...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 719C86C9FD2
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Mar 2023 11:35:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B951110E557;
	Mon, 27 Mar 2023 09:35:18 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 05/10] vfio/pci: Allow passing zero-length fd

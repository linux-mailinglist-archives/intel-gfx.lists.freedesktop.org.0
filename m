...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D261248E0D3
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jan 2022 00:24:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E12ED10E7AE;
	Thu, 13 Jan 2022 23:24:06 +0000 (UTC)
X-Original-To: Intel-GFX@lists.freedesktop.org
Delivered-To: Intel-GFX@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B95A110E656;
 Thu, 13 Jan 2022 23:24:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642116245; x=1673652245;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=EnyT+dq+GuzzwfvvcH4v+mjZUdOE5Al4DQ+ee95tbRA=;
 b=jZK9fjRxf9sxX/Xw3HKK3MBfive3bNRNI26chkB6K9+mKNkHhET07VdE
 ZRVL8gDAdy5xecmQLddrhEuMPAZ4yF8iXXPbqUd/ESUcbb3K2mLN4NDtS
 VaM/Q3kt9V7fJCbsq5Us7O798Sd4Jx7HxqioyLIzqilX0JxOnfnbcVGbk
 tqtSszxinKKxrD/mnqaFHYb5GX6Z37+TDVxu8bNRVxTdm+gC5JNhtkO8w
 ZiYPO6RmwamxObN2qK+Ek+BLyczIub/KwjitRGqv/VNfIFXs90H5k5B4U
 +nG8oE4YonFt17kZcW8wz2guhhmyKFN/PO0htCiaMvIFlA5wfNPwMo60y g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10226"; a="243932079"
X-IronPort-AV: E=Sophos;i="5.88,286,1635231600"; d="scan'208";a="243932079"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jan 2022 15:24:05 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,286,1635231600"; d="scan'208";a="516131659"
Received: from relo-linux-5.jf.intel.com ([10.165.21.134])
 by orsmga007.jf.intel.com with ESMTP; 13 Jan 2022 15:24:05 -0800
From: John.C.Harrison@Intel.com
To: IGT-Dev@Lists.FreeDesktop.Org
Date: Thu, 13 Jan 2022 15:24:05 -0800
Message-Id: <20220113232405.1572765-1-John.C.Harrison@Intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20220113195947.1536897-9-John.C.Harrison@Intel.com>
References: <20220113195947.1536897-9-John.C.Harrison@Intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH i-g-t] tests/i915/i915_hangman: Add alive-ness
 test after error capture

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A52D1E7729
	for <lists+intel-gfx@lfdr.de>; Fri, 29 May 2020 09:41:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D8876E88D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/13] eventpoll: simplify sysctl declaration

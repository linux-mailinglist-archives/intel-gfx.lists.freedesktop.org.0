...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7358C42CB63
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 22:49:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E69B46EB0C;
...
Subject: [Intel-gfx] [PATCH v4 00/20] drm: cleanup: Use

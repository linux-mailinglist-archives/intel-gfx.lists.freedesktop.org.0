...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B50B5B300C
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:36:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 707C510EBFF;
...
Subject: [Intel-gfx] [PATCH v3 24/37] drm/i915: i915_scatterlist.h: fix some
 kernel-doc markups

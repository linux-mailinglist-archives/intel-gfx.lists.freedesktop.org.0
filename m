...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ADE9F509EB6
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 13:37:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FE1710E8CB;
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915/gt: optimize the ccs_sz

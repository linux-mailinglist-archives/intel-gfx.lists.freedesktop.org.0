...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0644586CF3D
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Feb 2024 17:32:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1DE9510E534;
	Thu, 29 Feb 2024 16:32:15 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="nb/e4RIK";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EA74110E4FD;
 Thu, 29 Feb 2024 16:32:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709224334; x=1740760334;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ufhMOxGmyarMUMBEKJ8xD7YVtF/Fxnv3euJ5BxOmwJM=;
 b=nb/e4RIKQXSCsKZ3PoUIIOunZJjLKazRY/SaFlc1N51bp1k3binrQMcc
 3p6RzZ4iNeM5sCVgWlfRkJWRO1sPvR/Xj5Ot6m6ZYThBPMUrIvePM7Tuk
 2bqebYDpaeKB+7R4mQw1nS3KU8UMrSX7zL9PPp+wpECKrxMzZxTCleZPM
 tA/4TDpjPCWAS9AhGxyuqi1XNJIwQajzMzo7F15rrli1gYzLsaQ+SpRjk
 Wxl/TFvHzqBiIi61FLnPEDq44LpX+hJOb7MD1u7v81da0IclgkoTClWA1
 I8qIhO18ue0AJMRxxk4xaGdoS87AC4mbcO/pgLhWPUJOKGX1n1xCrjcWE Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10999"; a="29137203"
X-IronPort-AV: E=Sophos;i="6.06,194,1705392000"; d="scan'208";a="29137203"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Feb 2024 08:32:10 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,194,1705392000"; 
   d="scan'208";a="7754326"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmviesa007.fm.intel.com with ESMTP; 29 Feb 2024 08:32:08 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: dri-devel@lists.freedesktop.org, jani.nikula@intel.com,
 ankit.k.nautiyal@intel.com,
 Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
Subject: [PATCH v13 1/8] drm: Add Adaptive Sync SDP logging
Date: Thu, 29 Feb 2024 21:55:14 +0530
Message-Id: <20240229162521.2943630-2-mitulkumar.ajitkumar.golani@intel.com>

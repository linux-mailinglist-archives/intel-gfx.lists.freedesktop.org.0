...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1191624365A
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Aug 2020 10:37:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B24826E5B9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/20] drm/armada: Introduce GEM object functions

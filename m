...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A1BF75BAFD
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jul 2023 01:05:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3241E10E1C4;
...
Subject: [Intel-gfx] [PATCH] drm/i915/huc: silence injected failure in the
 load via GSC path

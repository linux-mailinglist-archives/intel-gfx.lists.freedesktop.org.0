...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 762B562842
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 20:20:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C1B66E03A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 2/6] drm/i915: Attach content type property

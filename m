...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D6A864AD5C4
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 11:49:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DE02810E5F4;
...
Subject: [Intel-gfx] [PATCH v2 0/4] GuC HWCONFIG with documentation

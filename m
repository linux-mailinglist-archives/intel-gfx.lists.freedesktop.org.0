...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8EAB26B0D93
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 16:54:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 258CF10E63F;
...
Subject: [Intel-gfx] [PATCH v10 06/15] dma-buf/sync_file: Add SET_DEADLINE
 ioctl

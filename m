...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFE69BE8849
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Oct 2025 14:06:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AAA0B10EBCC;
	Fri, 17 Oct 2025 12:06:08 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="h9SsEDiY";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D0CB310EBCB;
 Fri, 17 Oct 2025 12:06:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1760702767; x=1792238767;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=t+Wz/W0pBcnwcWGdflsV4Dj1d1fbLd0AChS07XAvIXc=;
 b=h9SsEDiYUXSyJvuXJCZud++fv2S+Fe3LnMoztRIRBo3XV1CfdFCtAlgG
 ZbNvxpE1a6sFIxauZIHW3s0R1ap7SlCxfmi6JHzKiomh3to4L55d4ge3q
 HirzQNRs8Q4Y+5K+UkgTAM8oHQk6HA5ePH5r+bhnwFDJWzvZPrq1DMWqO
 fPeGspB7JK2O/SeJiecLyt+L1iyMl96FPAUSCC1WBEf4SJV+EOs+Ut13i
 0CEtAvDSZ1naszpw4ITWkxpV6EV3gIYl+lRynVyf8YrGOB+edtT3RAOSt
 fLzRpDJKpvVDcnCM/kuHgCWlm8pfhbzRvi/0JoDkZmKBRS0QDG15t0gfn Q==;
X-CSE-ConnectionGUID: Rd7zUIMLSaqEOFtRmC6NcQ==
X-CSE-MsgGUID: jVJCqUXoTji9wrFxeArDfg==
X-IronPort-AV: E=McAfee;i="6800,10657,11584"; a="62815160"
X-IronPort-AV: E=Sophos;i="6.19,236,1754982000"; d="scan'208";a="62815160"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Oct 2025 05:06:06 -0700
X-CSE-ConnectionGUID: e77Nft2nSCid/9eJsIQdVA==
X-CSE-MsgGUID: P+7/qxuASq2K/QUkbsWV8g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,236,1754982000"; d="scan'208";a="219878369"
Received: from klitkey1-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.244.129])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Oct 2025 05:06:05 -0700
Date: Fri, 17 Oct 2025 15:06:02 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Ankit Nautiyal <ankit.k.nautiyal@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org
Subject: Re: [PATCH 4/5] drm/i915/vrr: Use the min static optimized guardband
Message-ID: <aPIxKia4fCYxOHwN@intel.com>
References: <20251017050202.2211985-1-ankit.k.nautiyal@intel.com>
 <20251017050202.2211985-5-ankit.k.nautiyal@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20251017050202.2211985-5-ankit.k.nautiyal@intel.com>

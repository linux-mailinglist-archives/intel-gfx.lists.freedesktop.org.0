...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 327FE20FEDF
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:29:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A48056E34D;
...
Subject: [Intel-gfx] [PATCH 32/59] drm/kmb: Revert dsi_host back to a static
 variable

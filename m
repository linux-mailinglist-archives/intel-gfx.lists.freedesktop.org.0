...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 24C3A258962
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Sep 2020 09:39:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70BC66E7DD;
...
Subject: Re: [Intel-gfx] [PATCH v8 00/17] drm/i915: Add support for HDCP 1.4
 over MST

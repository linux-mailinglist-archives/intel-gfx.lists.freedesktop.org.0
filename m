...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4457181BFF
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Mar 2020 16:04:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E333F6E9A5;
...
Subject: [Intel-gfx] [PATCH 3/6] drm/amdgpu: note that we can handle
 peer2peer DMA-buf

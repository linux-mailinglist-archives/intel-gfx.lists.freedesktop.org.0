...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 468166CA442
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Mar 2023 14:40:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9274010E5B1;
	Mon, 27 Mar 2023 12:40:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0DDBB10E5A8
 for <intel-gfx@lists.freedesktop.org>; Mon, 27 Mar 2023 12:39:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1679920797; x=1711456797;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PWG2j/XLcfcz24WYBj9r4M2cDbbhPVmIJGCLwOSZZmk=;
 b=KEW3OR2aLdgyVI7VV7IorN8JLLFMILqrLG41ftOd+bBysC4TaUUb2AcQ
 jGJMxvDQcRT4BpNgQz2MXxjSgRiqALZDMzliAxHeHQE+jVvY3E6FX6IHx
 jqXHE5MZfeIG6ZgTEKe7lpi8BipwCHl0g8yY8g2Ouoh2/M7vyylvE/eh8
 JUj8NKIrlsB24qiVKDufLplKSMDHI2Q3IOIIUEkye+TmvspGIoekZdHaS
 d6N7G33638VvHiM5Lu4HhKQXz7C/Ist3i512fy9wE2jJSN5RbySGck73h
 kWDr2jdQ7N8b8NegqRF8FX7EbluqCpwv1H/1x/72C1Jc2QpUoP3axIAUu A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="402847814"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="402847814"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Mar 2023 05:39:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="747984759"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="747984759"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by fmsmga008.fm.intel.com with ESMTP; 27 Mar 2023 05:39:54 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 27 Mar 2023 15:34:32 +0300
Message-Id: <20230327123433.896216-7-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH 6/7] drm/i915/mtl: Add vswing programming for
 C10 phys

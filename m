...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E35F8F3285
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2019 16:13:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E06696F6CE;
	Thu,  7 Nov 2019 15:13:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
 [207.211.31.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C40906F6CC
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 Nov 2019 15:13:21 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-37-449BzMvmN6Sn8PaFxD90qg-1; Thu, 07 Nov 2019 10:13:15 -0500
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
 [10.5.11.11])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CDA2C107ACC3;
 Thu,  7 Nov 2019 15:13:11 +0000 (UTC)
Received: from jason-ThinkPad-X1-Carbon-6th.redhat.com
 (ovpn-12-21.pek2.redhat.com [10.72.12.21])
 by smtp.corp.redhat.com (Postfix) with ESMTP id D0DF1600D1;
...
To: kvm@vger.kernel.org, linux-s390@vger.kernel.org,
 ...
 tiwei.bie@intel.com
Date: Thu,  7 Nov 2019 23:11:06 +0800
Message-Id: <20191107151109.23261-4-jasowang@redhat.com>
In-Reply-To: <20191107151109.23261-1-jasowang@redhat.com>
References: <20191107151109.23261-1-jasowang@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.11
X-MC-Unique: 449BzMvmN6Sn8PaFxD90qg-1
X-Mimecast-Spam-Score: 0
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=redhat.com; 
 s=mimecast20190719; t=1573139600;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=SsFfHA12rLKQuNw+Ju5OJCJI1NTIItUqVY4qTacphZY=;
 b=UFE+ZJ68w0zt95WK+sNsztuIgs0p/OzgVcbhyW369ueX9sHz5fsfENKAZGZJa53VFxeNJv
 bpk6Qp9D0PnNf9D5VMlIs87fkt2soJSgkOh8VSdbsu38oET2cKqR1JeEneJuaInE5D+bab
 GP8xnVBQrp8v3bVC1XWakIQZcULnp/Y=
Subject: [Intel-gfx] [PATCH V11 3/6] mdev: introduce device specific ops

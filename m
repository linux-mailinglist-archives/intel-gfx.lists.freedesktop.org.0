...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3149FC9F6CB
	for <lists+intel-gfx@lfdr.de>; Wed, 03 Dec 2025 16:24:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0934610E896;
	Wed,  3 Dec 2025 15:24:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="fa4aOpdg";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3A38410E87F;
 Wed,  3 Dec 2025 15:24:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764775468; x=1796311468;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Qty9f/J0oJTU6h3ov5Ej3qlaBzohrFwSm7p2MNbiy5M=;
 b=fa4aOpdgM3xpvJ16Q17DpZeuXzP/4N3rj4tMo7fScKUtO21/2xPvgzpA
 5jce61qaZ6DxkRKBLVDeQiL7/gG9OLSvA4SWuaiGhBUwWBCFtsCPs8H7U
 aBqZu3Mpv0v9Ytsig7TgV68+a8ZkAU70JgtrWLVXIH3ViWZ856mBzO1CX
 4RhNhXqSM42CJC1dvRhMvly4ADbjxE5OD/Zs794dmaf353voKibQ8T8gk
 Kl/TEBtbXkmH9F7Mgk7J3gKU11Th7vxJBJ2MlqxfI0neVwWp8rG0P22hV
 QapKSeBX86JIebcM0Kgm1IutAaZajj+sJq+BK0uHIknjP5x6AEBqFegG8 A==;
X-CSE-ConnectionGUID: VT4rGTqkQqWeqAFrh9/wyQ==
X-CSE-MsgGUID: VEl6kOSYRSCsAtsYKFxBPA==
X-IronPort-AV: E=McAfee;i="6800,10657,11631"; a="70387901"
X-IronPort-AV: E=Sophos;i="6.20,246,1758610800"; d="scan'208";a="70387901"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Dec 2025 07:24:28 -0800
X-CSE-ConnectionGUID: ewWZP4a7SeeWPOAU4RS5cg==
X-CSE-MsgGUID: LTgfYIp6T0KafVog9ixWiQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,246,1758610800"; d="scan'208";a="218045834"
Received: from lfiedoro-mobl.ger.corp.intel.com (HELO
 jhogande-mobl3.intel.com) ([10.245.246.208])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Dec 2025 07:24:25 -0800
From: =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>,
 Imre Deak <imre.deak@intel.com>
Subject: [PATCH v3] drm/i915/psr: Use SU granularity information available in
 intel_connector
Date: Wed,  3 Dec 2025 17:23:59 +0200
Message-ID: <20251203152359.1067495-1-jouni.hogander@intel.com>
X-Mailer: git-send-email 2.43.0
In-Reply-To: <20251203103134.1054430-3-jouni.hogander@intel.com>
References: <20251203103134.1054430-3-jouni.hogander@intel.com>
MIME-Version: 1.0

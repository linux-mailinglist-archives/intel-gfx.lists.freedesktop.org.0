...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 66K3IfyRx2mSZQUAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Sat, 28 Mar 2026 09:31:56 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BBE2734DD73
	for <lists+intel-gfx@lfdr.de>; Sat, 28 Mar 2026 09:31:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B84210E2D9;
	Sat, 28 Mar 2026 08:31:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from a3b018990fe9 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5EFC910E26C;
 Sat, 28 Mar 2026 08:31:51 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============6183345095536208032=="
MIME-Version: 1.0
...
Date: Sat, 28 Mar 2026 08:31:51 -0000
Message-ID: <177468671135.409333.3626188181095653878@a3b018990fe9>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_162934v5_full absolutely need to be
  verified manually.
  
  If you think the reported changes have nothing to do with the changes
  introduced in Patchwork_162934v5_full, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_162934v5_full:
...
#### Possible regressions ####
  ...
  * igt@i915_module_load@fault-injection@uc_fw_rsa_data_create:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18232/shard-mtlp-5/igt@i915_module_load@fault-injection@uc_fw_rsa_data_create.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-mtlp-2/igt@i915_module_load@fault-injection@uc_fw_rsa_data_create.html
...
### New IGT tests (11) ###
  ...
  * igt@i915_module_load@bo-too-small:
    - Statuses :
    - Exec time: [None] s

  * igt@i915_module_load@cursor-onscreen-32x10:
    - Statuses :
    - Exec time: [None] s

  * igt@i915_module_load@fbc-1p-primscrn-pri-shrfb-draw-pwrite:
    - Statuses :
    - Exec time: [None] s

  * igt@i915_module_load@fbc-1p-primscrn-spr-indfb-draw-mmap-cpu:
    - Statuses :
    - Exec time: [None] s

  * igt@i915_module_load@multi-wait-available-submitted:
    - Statuses :
    - Exec time: [None] s
  ...
  * igt@i915_module_load@psr-1p-offscreen-pri-shrfb-draw-blt:
    - Statuses :
    - Exec time: [None] s

  * igt@i915_module_load@reset-multiple-signaled:
    - Statuses :
    - Exec time: [None] s
  ...
  * igt@i915_module_load@test-only:
    - Statuses :
    - Exec time: [None] s

  * igt@i915_module_load@verify-pxp-execution-after-suspend-resume:
    - Statuses :
    - Exec time: [None] s
...
#### Issues hit ####
  ...
  * igt@gem_ccs@ctrl-surf-copy-new-ctx:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-tglu-6/igt@gem_ccs@ctrl-surf-copy-new-ctx.html

  * igt@gem_create@create-ext-cpu-access-sanity-check:
    - shard-rkl:          NOTRUN -> [SKIP][4] ([i915#6335])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-2/igt@gem_create@create-ext-cpu-access-sanity-check.html

  * igt@gem_ctx_sseu@mmap-args:
    - shard-dg2:          NOTRUN -> [SKIP][5] ([i915#280])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-dg2-3/igt@gem_ctx_sseu@mmap-args.html
    - shard-tglu-1:       NOTRUN -> [SKIP][6] ([i915#280])
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-tglu-1/igt@gem_ctx_sseu@mmap-args.html

  * igt@gem_exec_balancer@parallel-balancer:
    - shard-rkl:          NOTRUN -> [SKIP][7] ([i915#4525])
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-2/igt@gem_exec_balancer@parallel-balancer.html

  * igt@gem_exec_capture@capture-recoverable:
    - shard-rkl:          NOTRUN -> [SKIP][8] ([i915#6344])
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-2/igt@gem_exec_capture@capture-recoverable.html

  * igt@gem_exec_flush@basic-batch-kernel-default-cmd:
    - shard-rkl:          NOTRUN -> [SKIP][9] +9 other tests skip
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-2/igt@gem_exec_flush@basic-batch-kernel-default-cmd.html

  * igt@gem_exec_reloc@basic-gtt-wc:
    - shard-dg2:          NOTRUN -> [SKIP][10] ([i915#3281]) +2 other tests skip
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-dg2-3/igt@gem_exec_reloc@basic-gtt-wc.html

  * igt@gem_exec_reloc@basic-softpin:
    - shard-rkl:          NOTRUN -> [SKIP][11] ([i915#3281])
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-7/igt@gem_exec_reloc@basic-softpin.html

  * igt@gem_lmem_swapping@heavy-multi:
    - shard-rkl:          NOTRUN -> [SKIP][12] ([i915#4613]) +1 other test skip
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-7/igt@gem_lmem_swapping@heavy-multi.html

  * igt@gem_lmem_swapping@heavy-verify-multi:
    - shard-glk:          NOTRUN -> [SKIP][13] ([i915#4613])
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-glk9/igt@gem_lmem_swapping@heavy-verify-multi.html

  * igt@gem_lmem_swapping@parallel-multi:
    - shard-tglu-1:       NOTRUN -> [SKIP][14] ([i915#4613]) +1 other test skip
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-tglu-1/igt@gem_lmem_swapping@parallel-multi.html

  * igt@gem_lmem_swapping@verify:
    - shard-tglu:         NOTRUN -> [SKIP][15] ([i915#4613]) +1 other test skip
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-tglu-9/igt@gem_lmem_swapping@verify.html

  * igt@gem_mmap_gtt@basic-small-bo-tiledy:
    - shard-dg2:          NOTRUN -> [SKIP][16] ([i915#4077]) +3 other tests skip
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-dg2-3/igt@gem_mmap_gtt@basic-small-bo-tiledy.html

  * igt@gem_pread@exhaustion:
    - shard-glk10:        NOTRUN -> [WARN][17] ([i915#2658])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-glk10/igt@gem_pread@exhaustion.html

  * igt@gem_pxp@create-valid-protected-context:
    - shard-dg2:          NOTRUN -> [SKIP][18] ([i915#4270])
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-dg2-3/igt@gem_pxp@create-valid-protected-context.html

  * igt@gem_readwrite@beyond-eob:
    - shard-rkl:          NOTRUN -> [SKIP][19] ([i915#3282]) +3 other tests skip
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-7/igt@gem_readwrite@beyond-eob.html

  * igt@gem_render_copy@y-tiled-ccs-to-y-tiled-mc-ccs:
    - shard-glk:          NOTRUN -> [SKIP][20] +107 other tests skip
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-glk9/igt@gem_render_copy@y-tiled-ccs-to-y-tiled-mc-ccs.html

  * igt@gem_render_copy@y-tiled-ccs-to-yf-tiled-ccs:
    - shard-snb:          NOTRUN -> [SKIP][21] +15 other tests skip
   [21]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-snb4/igt@gem_render_copy@y-tiled-ccs-to-yf-tiled-ccs.html

  * igt@gem_render_copy@yf-tiled:
    - shard-dg2:          NOTRUN -> [SKIP][22] ([i915#5190] / [i915#8428]) +1 other test skip
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-dg2-3/igt@gem_render_copy@yf-tiled.html

  * igt@gem_userptr_blits@unsync-unmap:
    - shard-rkl:          NOTRUN -> [SKIP][23] ([i915#3297])
   [23]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-2/igt@gem_userptr_blits@unsync-unmap.html

  * igt@gem_userptr_blits@unsync-unmap-cycles:
    - shard-tglu-1:       NOTRUN -> [SKIP][24] ([i915#3297])
   [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-tglu-1/igt@gem_userptr_blits@unsync-unmap-cycles.html

  * igt@gem_workarounds@suspend-resume:
    - shard-rkl:          [PASS][25] -> [ABORT][26] ([i915#15152])
   [25]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18232/shard-rkl-7/igt@gem_workarounds@suspend-resume.html
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-1/igt@gem_workarounds@suspend-resume.html

  * igt@gen9_exec_parse@allowed-all:
    - shard-tglu-1:       NOTRUN -> [SKIP][27] ([i915#2527] / [i915#2856]) +1 other test skip
   [27]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-tglu-1/igt@gen9_exec_parse@allowed-all.html
    - shard-glk:          [PASS][28] -> [ABORT][29] ([i915#5566])
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18232/shard-glk3/igt@gen9_exec_parse@allowed-all.html
   [29]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-glk5/igt@gen9_exec_parse@allowed-all.html

  * igt@gen9_exec_parse@batch-invalid-length:
    - shard-dg2:          NOTRUN -> [SKIP][30] ([i915#2856])
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-dg2-3/igt@gen9_exec_parse@batch-invalid-length.html

  * igt@gen9_exec_parse@batch-without-end:
    - shard-rkl:          NOTRUN -> [SKIP][31] ([i915#2527]) +1 other test skip
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-rkl-7/igt@gen9_exec_parse@batch-without-end.html

  * igt@gen9_exec_parse@bb-secure:
    - shard-tglu:         NOTRUN -> [SKIP][32] ([i915#2527] / [i915#2856])
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_162934v5/shard-tglu-6/igt@gen9_exec_parse@bb-secure.html
...
<p>Serious unknown changes coming with Patchwork_162934v5_full absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_162934v5_full, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them<br />
  to document this new failure mode, which will reduce false positives in CI.</p>
<h2>Participating hosts (10 -&gt; 10)</h2>
<p>No changes in participating hosts</p>
<h2>Possible new issues</h2>
<p>Here are the unknown changes that may have been introduced in Patchwork_162934v5_full:</p>
<h3>IGT changes</h3>
...
<ul>
<li>
<p>igt@i915_module_load@bo-too-small:</p>
<ul>
<li>Statuses :</li>
...
<li>
<p>igt@i915_module_load@cursor-onscreen-32x10:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>
...
<li>
<p>igt@i915_module_load@fbc-1p-primscrn-pri-shrfb-draw-pwrite:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>
...
<li>
<p>igt@i915_module_load@fbc-1p-primscrn-spr-indfb-draw-mmap-cpu:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>
...
<li>
<p>igt@i915_module_load@multi-wait-available-submitted:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>
...
<li>
<p>igt@i915_module_load@psr-1p-offscreen-pri-shrfb-draw-blt:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>
...
<li>
<p>igt@i915_module_load@reset-multiple-signaled:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>
...
<li>
<p>igt@i915_module_load@test-only:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>
...
<li>
<p>igt@i915_module_load@verify-pxp-execution-after-suspend-resume:</p>
<ul>
<li>Statuses :</li>
<li>Exec time: [None] s</li>
</ul>

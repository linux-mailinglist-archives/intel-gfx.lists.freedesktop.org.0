...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 340BF75B2A
	for <lists+intel-gfx@lfdr.de>; Fri, 26 Jul 2019 01:17:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B902E6E839;
	Thu, 25 Jul 2019 23:17:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AE19C6E839
 for <intel-gfx@lists.freedesktop.org>; Thu, 25 Jul 2019 23:17:12 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17611364-1500050 
 for multiple; Fri, 26 Jul 2019 00:16:52 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 26 Jul 2019 00:16:51 +0100
Message-Id: <20190725231651.17660-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.22.0
In-Reply-To: <57b95613f6cf4a0806baeb3d99790bd90b7615e4>
References: <57b95613f6cf4a0806baeb3d99790bd90b7615e4>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915: Replace hangcheck by heartbeats

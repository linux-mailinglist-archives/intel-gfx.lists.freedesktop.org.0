...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC2B1A00A0B
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jan 2025 14:52:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EE7710E8BD;
	Fri,  3 Jan 2025 13:52:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="WaEMrLmq";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B8AC710E8BD;
 Fri,  3 Jan 2025 13:52:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1735912370; x=1767448370;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=DIOm+M98BNAigtUjAWLLgrfejo0F4twAmCPlP9Tkrvc=;
 b=WaEMrLmqmvx826Vhdc1eXCsDIVHh8ehJqwI9a3nt7MTTvggO00MPVvDV
 vpV02O+AG0CnHzVSTV1VKkY2kMl8LS23fUUFL6Ekb8p926b9iKaoVQPee
 5WU7pajhOBgNlt8IIMxw6sUVsUWQmfe9Ixtn37fOtCuesjrjje4/1EqtF
 5PGfFOhhJXSMvT58eXBX4ecwO3u9SuRNROGdjS4H9R4yf6iGgHjk7YuYl
 g32bsjw17RmCPSVMDm/Q2KV1ntHEa3vX6767I0yhBR9rp20WlBvcOwycC
 LuN+n1C1Z/Mg0N5M3oP9E3cVR/XSSS4U0UUiICQ3akeJ+HVBMD7sZuqKW g==;
X-CSE-ConnectionGUID: wzOmZ4XXS4+gH/g+GHBd4w==
X-CSE-MsgGUID: f/Nl4WdoRgiltnXWrcGvSw==
X-IronPort-AV: E=McAfee;i="6700,10204,11304"; a="47573800"
X-IronPort-AV: E=Sophos;i="6.12,286,1728975600"; d="scan'208";a="47573800"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jan 2025 05:52:50 -0800
X-CSE-ConnectionGUID: SEkEpoxoQsyM4CesuoGCyg==
X-CSE-MsgGUID: KOQy6rkASYa6AKIgqTKF9w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="132716691"
Received: from dprybysh-mobl.ger.corp.intel.com (HELO localhost)
 ([10.245.246.242])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jan 2025 05:52:47 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: imre.deak@intel.com, jani.nikula@intel.com, Lyude Paul <lyude@redhat.com>
Subject: [PATCH v3 01/16] drm/mst: remove mgr parameter and debug logging from
 drm_dp_get_vc_payload_bw()
Date: Fri,  3 Jan 2025 15:52:24 +0200
Message-Id: <72d77e7a7fe69c784e9df048b7e6f250fd7599e4.1735912293.git.jani.nikula@intel.com>

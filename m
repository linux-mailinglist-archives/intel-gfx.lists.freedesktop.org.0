...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 281B067DAA3
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Jan 2023 01:20:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F1E8910E07E;
	Fri, 27 Jan 2023 00:20:27 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 2/8] drm/i915/pxp: Add MTL hw-plumbing

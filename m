...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 185C22132E9
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jul 2020 06:36:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B2B0B6E8BD;
	Fri,  3 Jul 2020 04:35:58 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] linux-next: manual merge of the kspp tree with the
 drm-misc tree
...
Content-Type: multipart/mixed; boundary="===============1427595820=="

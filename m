...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 33A6840CE2E
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 22:39:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B57D26EA3B;
	Wed, 15 Sep 2021 20:39:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x834.google.com (mail-qt1-x834.google.com
 [IPv6:2607:f8b0:4864:20::834])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 15E8C6EA3B
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Sep 2021 20:39:02 +0000 (UTC)
Received: by mail-qt1-x834.google.com with SMTP id u21so3602797qtw.8
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Sep 2021 13:39:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=j9U/+9UZ2X63Fxwr00yPlDrYqpyCxMV3V2Jh2AuTAXE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=j9U/+9UZ2X63Fxwr00yPlDrYqpyCxMV3V2Jh2AuTAXE=;
 b=
X-Gm-Message-State: AOAM533ybu1dV/pmGCMwAcJoCqQD9X61PdYxiexXfJDm3H6w+BpslHmz
 o0HesqME5Kjm9uVrYMKp6X3+iQ==
X-Google-Smtp-Source: ABdhPJxLvRjlG6ZUklkrZEeUkdZDVQ9UimsDI4kLtDWsx/RMejaQ6upF5/q9nge1HWXv2fGln8v6Ew==
X-Received: by 2002:a05:622a:1aaa:: with SMTP id
 s42mr1867740qtc.122.1631738340544; 
 Wed, 15 Sep 2021 13:39:00 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id j3sm823020qki.104.2021.09.15.13.38.59
...
Date: Wed, 15 Sep 2021 16:38:23 -0400
Message-Id: <20210915203834.1439-5-sean@poorly.run>
X-Mailer: git-send-email 2.31.0
In-Reply-To: <20210915203834.1439-1-sean@poorly.run>
References: <20210915203834.1439-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 04/13] drm/hdcp: Expand HDCP helper library

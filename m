...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FABA6BDE1D
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 02:19:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DA9E10E4E2;
	Fri, 17 Mar 2023 01:19:38 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 7/7] vfio/pci: Accept device fd in
 VFIO_DEVICE_PCI_HOT_RESET ioctl

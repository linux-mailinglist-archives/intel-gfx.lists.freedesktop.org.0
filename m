...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05F53529465
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 00:58:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C0FC10F643;
...
Subject: [Intel-gfx] [PATCH v2 27/27] dyndbg/drm: POC add tracebits
 sysfs-knob

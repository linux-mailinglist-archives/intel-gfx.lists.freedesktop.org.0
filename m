...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EC1283ED82C
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Aug 2021 15:58:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BC7A89FE3;
...
Subject: [Intel-gfx] [PATCH 18/22] drm/i915/guc: Rework and simplify locking

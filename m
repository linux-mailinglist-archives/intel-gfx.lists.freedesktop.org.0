...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 49D1F436420
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Oct 2021 16:24:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6ACC16EC9A;
...
Subject: [Intel-gfx] [PATCH v2 08/17] drm/i915/selftests: account for

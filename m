...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D9A560D373
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Oct 2022 20:18:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FF6A10E425;
	Tue, 25 Oct 2022 18:17:40 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 01/10] vfio: Move vfio_device driver open/close
 code to a function

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 99E93142504
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2020 09:23:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EC036E5CE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 02/22] drm: Add get_scanout_position() to

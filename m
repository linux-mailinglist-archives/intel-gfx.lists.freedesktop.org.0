...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F05451C45C1
	for <lists+intel-gfx@lfdr.de>; Mon,  4 May 2020 20:24:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BAD46E457;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 4/9] drm/i915/display/tc: Prefer drm_WARN_ON
 over WARN_ON

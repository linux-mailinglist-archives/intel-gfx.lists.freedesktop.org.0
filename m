...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D210554DA3
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 16:41:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F8CA10E942;
...
Subject: Re: [Intel-gfx] [PATCH v3 03/13] drm/edid: clean up connector

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E9981329D2
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Jan 2020 16:18:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 71C6D6E0D2;
...
Subject: [Intel-gfx] [PATCH 1/5] drm/i915: convert to using the
 drm_dbg_kms() macro.

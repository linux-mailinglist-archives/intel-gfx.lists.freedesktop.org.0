...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DC8E47F8E1
	for <lists+intel-gfx@lfdr.de>; Sun, 26 Dec 2021 21:53:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F041B10F22D;
...
Subject: [Intel-gfx] [PATCH v5 4/6] drm: implement a method to free unused
 pages

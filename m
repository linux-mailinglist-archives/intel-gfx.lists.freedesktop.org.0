...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C2C25A39D1
	for <lists+intel-gfx@lfdr.de>; Sat, 27 Aug 2022 21:46:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2682610ED1F;
	Sat, 27 Aug 2022 19:46:06 +0000 (UTC)
...
Subject: [Intel-gfx] [RFC PATCH v3 06/17] drm/i915/dmabuf: Deny the dmabuf
 export for VM private BOs

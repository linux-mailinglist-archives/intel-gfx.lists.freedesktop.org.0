...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2C423D0092
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 19:43:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 691656E4EC;
...
Subject: [Intel-gfx] [PATCH v2 07/14] vfio/platform: Use open_device()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 142B8AB3B71
	for <lists+intel-gfx@lfdr.de>; Mon, 12 May 2025 16:57:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A794C10E422;
	Mon, 12 May 2025 14:57:10 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aVt3kl63";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A6ACF10E422;
 Mon, 12 May 2025 14:57:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1747061830; x=1778597830;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=1dSBjQvetb9hqk2xzKXMKH9i4BS23VHMUoQ7x5qB3eQ=;
 b=aVt3kl630Nqdw3N5CdNI5+vIPx1N+E7/lmX7oD5Lwf1cTsAHR7zm8ZC1
 F+r1bCaWPa3JLQVB7jHzS3V+6BJd+UfSVvMKmTZ/cXwpcHT4c3nXDrQzJ
 DYj6Y5csyEVbhv9puHDfFmeVQEVxJyHNcmEQZqC0IL27lSxeFQY5T2KYv
 EfntA8A65ivk7uaIz9U/WehwAkSimc4CwO4ReEWmKXgQ5zA2dMbZvViNA
 fU338Ctkfr5i0lpZFWGUeo/3RUFgJ31KrxNBnKzkcFTcGtMH9D/xd31+M
 +nGqtv+EYOTZPsWstCIVIors9CsxAaYwZnJM4S3h3C9tiJB1TnyHYy4KF Q==;
X-CSE-ConnectionGUID: aER/IHQqS/KFodfI2D8yFw==
X-CSE-MsgGUID: 5OsaieBOTzyiLEX6svwJjg==
X-IronPort-AV: E=McAfee;i="6700,10204,11431"; a="59865107"
X-IronPort-AV: E=Sophos;i="6.15,282,1739865600"; d="scan'208";a="59865107"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2025 07:57:10 -0700
X-CSE-ConnectionGUID: y6fPHy8yRWyZs3vVCUSGzQ==
X-CSE-MsgGUID: jMX0uhK8SVm4tCYddIcL8Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,282,1739865600"; d="scan'208";a="142502028"
Received: from smoticic-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.245.186])
 by orviesa005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2025 07:57:07 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: ville.syrjala@linux.intel.com,
	jani.nikula@intel.com
Subject: [PATCH v3 1/8] drm/i915: rename vlv_sideband*.[ch] to
 vlv_iosf_sb*.[ch]
Date: Mon, 12 May 2025 17:56:52 +0300
Message-Id: <d3d97d34a197ba801c558c3fd72b29f9e5c783af.1747061743.git.jani.nikula@intel.com>
...
index abf1db22fafe..6f364db27e21 100644

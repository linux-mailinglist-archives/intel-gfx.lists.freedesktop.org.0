...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B07424910AE
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jan 2022 20:33:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9ED8E10FABA;
	Mon, 17 Jan 2022 19:33:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 09DE510FAB8;
 Mon, 17 Jan 2022 19:33:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642447992; x=1673983992;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/AD2x6GTAtJN06ja5FD2YHx8o0k4S41S+oMyUqgOPNc=;
 b=UdGUX5YnEw6ZFt0z4lYBQqWWlfqU547NbBndynjU5TzC4Hjvj/x1BkPW
 BjS9tf+KQ2uhCeyd3QLVQwaPhpLPdi/m5f9OtKbP3MDjtoJGkgXSI0OTt
 J0mFPgKNtF8jXvxm/Ns3r74rInUWFHtw2DRDehZdUpwvdheUxGXWYlXGe
 JDAdmganJRTEWxUnRJ1WCdcYDFT7HLlgeP1UQNwg5VyePzTzW/CJOTTxm
 dMBnx0oL8mFAYwliEroBK6VnrWGENhC2cysWHbDSQfcrKO+ntcK8LeSae
 ET7dM8b1teTkzb1BB4d03wu6K34gTTsdv42sPZ/CYXs7rnZLpP+1hoAIp Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10230"; a="269061181"
X-IronPort-AV: E=Sophos;i="5.88,296,1635231600"; d="scan'208";a="269061181"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2022 11:33:11 -0800
X-IronPort-AV: E=Sophos;i="5.88,296,1635231600"; d="scan'208";a="517509494"
Received: from nkohl-mobl.ger.corp.intel.com (HELO intel.com) ([10.249.41.90])
 by orsmga007-auth.jf.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Jan 2022 11:33:06 -0800
From: Andi Shyti <andi.shyti@linux.intel.com>
To: Intel GFX <intel-gfx@lists.freedesktop.org>,
 DRI Devel <dri-devel@lists.freedesktop.org>
Date: Mon, 17 Jan 2022 21:32:54 +0200
Message-Id: <20220117193255.236599-2-andi.shyti@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/2] drm/i915: Prepare for multiple GTs

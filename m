...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 01213501281
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Apr 2022 17:08:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A99C10FD1B;
	Thu, 14 Apr 2022 15:08:46 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 17/19] drm/edid: detect color formats and CTA

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BE8C3DD6C1
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Aug 2021 15:17:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 936AF6E07F;
...
Subject: [Intel-gfx] [RESEND PATCH v2 1/2] locking/lockdep: Provide
 lockdep_assert{, _once}() helpers

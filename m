...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E9B3F3451B7
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Mar 2021 22:25:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 08A966E5B0;
	Mon, 22 Mar 2021 21:25:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 386126E079
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Mar 2021 21:25:15 +0000 (UTC)
IronPort-SDR: i6KXm7xHX7OWNG8OHdGWiuZ0xCk2xkmu8rGXl8HBjvG5RM2yeB7IPVc5h7/Y54WY58sTBgtWVZ
 aZnv8TCHih0g==
X-IronPort-AV: E=McAfee;i="6000,8403,9931"; a="170314357"
X-IronPort-AV: E=Sophos;i="5.81,269,1610438400"; d="scan'208";a="170314357"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Mar 2021 14:25:14 -0700
IronPort-SDR: TQrYgqN2U5wPZ+LGXtafwVx7BPsa0juCvVqMvd8jUtEVzD1CB0XSdisGCcL5UTz0Y91FNEuXWm
 wnt0g8bkpqfg==
X-IronPort-AV: E=Sophos;i="5.81,269,1610438400"; d="scan'208";a="524587484"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.168])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Mar 2021 14:25:14 -0700
Date: Mon, 22 Mar 2021 14:25:12 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20210322212512.GR3422723@mdroper-desk1.amr.corp.intel.com>
...
like:
        ...
        binary operator OP;
        @@
        DISPLAY_VER(dev_priv) OP i || E <=3D> E || DISPLAY_VER(dev_priv) OP=
 i

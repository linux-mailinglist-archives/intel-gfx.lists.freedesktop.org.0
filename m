...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 35C6F577B67
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:39:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D45FA9D2E;
...
Subject: [Intel-gfx] [PATCH v3 16/41] dyndbg: add drm.debug style bitmap
 support

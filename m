...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 13CF8710093
	for <lists+intel-gfx@lfdr.de>; Thu, 25 May 2023 00:01:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD27310E69A;
	Wed, 24 May 2023 22:01:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 72B8310E63A;
 Wed, 24 May 2023 22:01:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684965666; x=1716501666;
 h=date:message-id:from:to:cc:subject:in-reply-to:
 references:mime-version;
 bh=hulZ/jmHq6s8sxgcbRLDgrYP0tDKivnidOZZIJUtOo4=;
 b=nSFCv6h0hk0ZsHAu+cExbLLy92C5RAajUBzmZ/ePqC3hGfLD+iSVO8rh
 g4H+N8JRKTexH8CA5YIZiegw0Wc1SPuPY1bl6q0YfijX3oo0HUh89AlTU
 GO61INNYDqSbiodMNEhAUOvw/EzyrgFFAty0y4sTQTGhA8DaOLpXV75MH
 bYJpYpK9y7HVKvmw8sWpMSY0T8I9CKdZV4Oexalv74uotBWrfG6qhPdmO
 A+xzaYIFaQfDXsWIqF8o9KDlTFmLQ2FYjzqduTCoGZEjvghU+pI9Ba36X
 w6nFtnKmzfGK/8qJGEZwW1HQyE+lM0UGvaQ2qrXqO2UT3hwsZbmmBJDbg Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="381949667"
X-IronPort-AV: E=Sophos;i="6.00,190,1681196400"; d="scan'208";a="381949667"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 15:01:05 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10720"; a="704536423"
X-IronPort-AV: E=Sophos;i="6.00,190,1681196400"; d="scan'208";a="704536423"
Received: from adixit-mobl.amr.corp.intel.com (HELO adixit-arch.intel.com)
 ([10.209.17.238])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2023 15:01:05 -0700
Date: Wed, 24 May 2023 14:46:22 -0700
Message-ID: <87y1ldmmhd.wl-ashutosh.dixit@intel.com>
From: "Dixit, Ashutosh" <ashutosh.dixit@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
In-Reply-To: <458a92eb-5b95-4cea-ab3d-ea889b20d626@linux.intel.com>
References: <20230523151918.4170499-1-ashutosh.dixit@intel.com>	<20230523151918.4170499-3-ashutosh.dixit@intel.com>	<beaf5d7d-a611-6c87-efa7-5b4c87e5ac7d@linux.intel.com>	<87fs7lr5oj.wl-ashutosh.dixit@intel.com>	<458a92eb-5b95-4cea-ab3d-ea889b20d626@linux.intel.com>

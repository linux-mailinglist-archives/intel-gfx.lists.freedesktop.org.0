...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D654797FCF
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Sep 2023 02:40:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 27C9310E84C;
	Fri,  8 Sep 2023 00:40:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 324B610E84B
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=F4/7nS493lpYk6k/M/emQbHI3dQVb9ACm/MN+c8aDNGAG6tiXW2/JMl0
 Rg81fUYdeerA2n5oKVhib4GyNKtD6lIoh26KIBEzRNIQ8W0Cb6qbZlU3t
 I4xoi6kHcEvT1KLd0DqzoL9uSQWjje2CYo17if8OfHtk72Ct0NsHN+IQW
 pEZ0Sc4jk5xlDsH8gANaRrIkJsDAOFF4fmDGES1Qlb/h/LwxbxX939GW4
 YG+leEsQgeDYTpROLTcbxuGZ4R1+AUc2bn/EzQXsgB9rvryp9LQsDx1dQ
 AAd0DjHGJMOETkjwKECP3kqJ45MwWmSGeE1H7kAPwClPGLe0ynEHp9b6i w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10826"; a="443945605"
X-IronPort-AV: E=Sophos;i="6.02,236,1688454000"; d="scan'208";a="443945605"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2023 17:40:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10826"; a="777310553"
X-IronPort-AV: E=Sophos;i="6.02,236,1688454000"; d="scan'208";a="777310553"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2023 17:40:17 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  7 Sep 2023 17:29:36 -0700
Message-Id: <20230908002937.1660911-3-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 2/3] drm/i915: Add WABB blit for

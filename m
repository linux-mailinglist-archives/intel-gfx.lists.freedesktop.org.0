...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DEBB402436
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Sep 2021 09:26:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34F7F89D6C;
	Tue,  7 Sep 2021 07:26:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 11E9B89D4F
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Sep 2021 07:26:18 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-39-vYYwCDcLMEGW6k4m_hUeUw-1; Tue, 07 Sep 2021 03:25:59 -0400
X-MC-Unique: vYYwCDcLMEGW6k4m_hUeUw-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com
 [10.5.11.13])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 1F5B46C500;
 Tue,  7 Sep 2021 07:25:58 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 913CA60936;
 Tue,  7 Sep 2021 07:25:56 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Tue,  7 Sep 2021 17:25:26 +1000
Message-Id: <20210907072549.2962226-3-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 02/25] drm/i915/display: move cdclk info into
 display
...
+=09    dev_priv->display->cdclk.hw.cdclk =3D=3D dev_priv->display->cdclk.h=
w.bypass)
 =09=09goto sanitize;
=20
...
+=09=09dev_priv->display->cdclk.hw.voltage_level =3D cdclk_config->voltage_=
level;
 }
=20
...
+=09=09dev_priv->display->max_cdclk_freq =3D dev_priv->display->cdclk.hw.cd=
clk;
 =09}
=20
...
+=09dev_priv->display->funcs.get_cdclk(dev_priv, &dev_priv->display->cdclk.=
hw);
=20
 =09/*
...
+=09    crtc_state->pixel_rate > dev_priv->display->max_cdclk_freq * 95 / 1=
00)
 =09=09return false;
=20
 =09return true;
...
+=09cdclk_state->logical =3D cdclk_state->actual =3D i915->display->cdclk.h=
w;
 }
=20
...
-=09    cache->crtc.hsw_bdw_pixel_rate >=3D dev_priv->cdclk.hw.cdclk * 95 /=
 100) {
+=09    cache->crtc.hsw_bdw_pixel_rate >=3D dev_priv->display->cdclk.hw.cdc=
lk * 95 / 100) {

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 00E2B652798
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Dec 2022 21:12:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E9EA710E3D3;
	Tue, 20 Dec 2022 20:11:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5022B10E3D3
 for <intel-gfx@lists.freedesktop.org>; Tue, 20 Dec 2022 20:11:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671567107; x=1703103107;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=AscmtvaypLYDvDSpKNSZHb13JjkYmj59JR9IgzrpA8U=;
 b=gw64AqQvAsPiDx+3EZAJvyk39TIvfzQyLfthrS/joj5It9I7q9GaTwdL
 REj4XtgDnkmO6g5vAYEyxXTC0bgUDKh2nWz0gYS6tpkx7dOyExp3mbOi7
 XTQ31Xa59ErEPgceaYF8WKL5kcLbfV9/luaMCGS28Hfx5cdT1htNuyBDu
 uFExOPXJ3Ja3mUS4AyHwn+6OQPjZFE/7EGRiYiHNeCsGGrC2cDBlHl3Jy
 uFtzfUiBpNC2qU0FSvcMDLF4gNNoO6j+z2P39AvsTE/lBo6OgEzDuM8IV
 Wt6NeuwqrO+1MnmJhuNPABLayeJiRed1yyB5u3XXJ+7ayQbzjT307hB71 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10567"; a="405950666"
X-IronPort-AV: E=Sophos;i="5.96,259,1665471600"; d="scan'208";a="405950666"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Dec 2022 12:11:46 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10567"; a="681785481"
X-IronPort-AV: E=Sophos;i="5.96,259,1665471600"; d="scan'208";a="681785481"
Received: from dtpaulso-mobl.amr.corp.intel.com (HELO gjsousa-mobl2.intel.com)
 ([10.209.148.251])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Dec 2022 12:11:44 -0800
From: Gustavo Sousa <gustavo.sousa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 20 Dec 2022 17:11:03 -0300
Message-Id: <20221220201104.339399-2-gustavo.sousa@intel.com>
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915/dmc: Do not require specific
 versions

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4002E8798FD
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Mar 2024 17:30:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5EB5E10F62D;
	Tue, 12 Mar 2024 16:30:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="V6C2FKF5";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0F5A210F4C4;
 Tue, 12 Mar 2024 16:30:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710261017; x=1741797017;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=Ri0kzoOYZG5YMsQKqFTcZnAsSaAT+baSDAo7q+M/jJ0=;
 b=V6C2FKF5WLMx/AJkp2J7othyjUm/pV6RqEvkXgUFurkBDpINrQwOYnQk
 lATLd10+dqjlFuzRzdrPnpWLXTRJXEOKJD/tEV3Clw8eLVOnb6Pbt04vK
 zZwwm7NRsUhvSEHbFsCgyW0xVD9GB73xHW6PcFiyT5LCJwaLDaaqwW+kC
 wo9eKp9zvuKQYPg1dY87t++zFUo/ninrd4kE4lBHTIlaO4xgfYIiWXfEJ
 fs5culEqdWOWWqSKHqafL1vQejWhpE5UpfJDXji/kE5ztMjLK9jMFLRid
 3MEHiQDTC3pT/JWyyS95e9k2c+Lekmehpmt67h0OeazS5vghAjk41+0Ew Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="15620678"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="15620678"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by fmvoesa105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 09:29:45 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="16078612"
...
Received: from orsmsx611.amr.corp.intel.com (10.22.229.24) by
 ...
 15.1.2507.35; Tue, 12 Mar 2024 09:29:44 -0700
...
Received: from orsedg603.ED.cps.intel.com (10.7.248.4) by
 ...
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.35 via Frontend Transport; Tue, 12 Mar 2024 09:29:44 -0700
Received: from NAM04-MW2-obe.outbound.protection.outlook.com (104.47.73.169)
 by edgegateway.intel.com (134.134.137.100) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.35; Tue, 12 Mar 2024 09:29:44 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=Il01tmyHwmDZE7NcwmZv5pBke1kBmxAm8YC5LXuSthA=;
 b=
...
Received: from CY5PR11MB6139.namprd11.prod.outlook.com
 ...
 16:29:39 +0000
Date: Tue, 12 Mar 2024 11:29:37 -0500
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: Rodrigo Vivi <rodrigo.vivi@intel.com>
CC: <intel-gfx@lists.freedesktop.org>, <dri-devel@lists.freedesktop.org>
Subject: Re: [PATCH 2/5] drm/i915: Drop dead code for xehpsdv
Message-ID: <23n224gu57lfd4wbroqflav4pih6usrkf53q2ve4ntekhueylb@eqigxyktri6b>
References: <20240306193643.1897026-1-lucas.demarchi@intel.com>
 <20240306193643.1897026-3-lucas.demarchi@intel.com>
 <Ze8gNo_qTABGfG8j@intel.com>
Content-Type: text/plain; charset="us-ascii"; format=flowed
Content-Disposition: inline
In-Reply-To: <Ze8gNo_qTABGfG8j@intel.com>
X-ClientProxiedBy: SJ0PR03CA0297.namprd03.prod.outlook.com
 (2603:10b6:a03:39e::32) To CY5PR11MB6139.namprd11.prod.outlook.com
 (2603:10b6:930:29::17)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: CY5PR11MB6139:EE_|IA1PR11MB7385:EE_
X-MS-Office365-Filtering-Correlation-Id: 9e3f0154-6897-47d2-c5b9-08dc42b19d46
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:CY5PR11MB6139.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230031)(376005)(1800799015); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?x2yfnQ+19MmsGn6CrmgmkHzz6UAdzL+C8K/knKeK1Z7QB3WQRW1AdNymUswV?=
 =?us-ascii?Q?+18TJVOOiiC8pCI4rsYfCWojRHWjU0mXZ6JHizfyESdI4xmcl24e6QgzeMfe?=
 =?us-ascii?Q?rUxh4OgvPUrdNuDLBsI2DhbymrVuiBEn+jcLtkcYHolaXZt7rqVOW5JyhlZK?=
 =?us-ascii?Q?mLH1IVCtpzXgWHK48P8glgF66U4w9POAta8iMvr7POVklkKtM9mTqPBytKke?=
 =?us-ascii?Q?b5dYnF5cETdUUFua2rZSgkNFy+MmkICns3MXIvvKQYx3F6FspkgZpXn0hw3L?=
 =?us-ascii?Q?J+4c6+15ChfXg/6NqeMSbzfDNDl2OtWyIqamntESK+d5G7l4rUgi8fytyijb?=
 =?us-ascii?Q?oCYeAS4CxoXJ5AYhMTHrmKRiUXOaxaSkL2e2/DJD7iT2aTFSmABpHwrf97v2?=
 =?us-ascii?Q?oBQgnIxXbYTLeVGa0O8Y+vmjG3LqpUH3cya36fElP70it6KUv/crPIyOXXXZ?=
 =?us-ascii?Q?XSRKWOHr/GWa/8ZxxVjE+y2cz0U7R61+5bJAN4YXDBURQDaOpPysU6aUvNRT?=
 =?us-ascii?Q?uzcVyALpwVk4AsxLsLg7H+L8iXN5Jl0rvTzUM3/gV2ezT7WjqwSfYctzqsTi?=
 =?us-ascii?Q?Iyv7zgDnltcWNrj5B4G6ZWvD6i37D9zbZcs3pM5KltpAE2vtVlPe6dhLPAe3?=
 =?us-ascii?Q?zrMo2BfejNDjtTXcSMcFGYLt2OgF2bC80k8ZJ+nCvtQ7OToMW6mQzXbjLavz?=
 =?us-ascii?Q?eLldELXs0PPW97tu6+l5rcjpbZiWpEbsy/kvZbMnKSCiVKaAjCb7AWQ7Knob?=
 =?us-ascii?Q?modXlU5CjEuR/RIuExFA5o2KNeVEOdrYxc+HjG+mKCW80Esh+cDxlZ8Nk3kF?=
 =?us-ascii?Q?fBzNTwd4LxXd2oRTbT7dF+erfxnrc7fQUnyVrMJmhGaeO35YgupDSMRiaxaV?=
 =?us-ascii?Q?/nCOs92FXf+mIaGBqAS0qdp32eY2L6kKM5OBJKywmBVIOEtM4TuGk76gCcMa?=
 =?us-ascii?Q?JbCmkEaqnD1KIfv3ty+AXSrRGNjgieg1lCiwqx+K3XdrDOqzbn2wnKpi32tT?=
 =?us-ascii?Q?R8N43VKK4/p9y8MRnenBMJB3vtA/CTTBGAj9ersL319c4VaEr7IKBi1zxVQB?=
 =?us-ascii?Q?g6o2SFKhl5jxKHeF61SwJpvt9piiRFOkpoRnDxVLaJtkJ1fEbI0HWXzYjG7X?=
 =?us-ascii?Q?hMUiyMjziDpHGjeRtMVYvhsaoZhaHu0FqoahdxeuVNV0s3hVFAU3UeEu3Os4?=
 =?us-ascii?Q?nZQ7i5wKA/izXENpE8Ike/V2/L7cD9L485/LD2U/uqULEb+TOf1A6Shz3/HH?=
 =?us-ascii?Q?5dgA0MMQ4IdxmuV8IbPbwmWNw/uGQu7C77wOhQ4z1aLodYdxhkjN9t5WizGG?=
 =?us-ascii?Q?4CJkBUh3kt3puvn2hcmg8AvbIGxkCCysI3eJaaaW2hEhnWuphJ1xjmNj7n8M?=
 =?us-ascii?Q?cU+DT0nQdzTS/9H+QVJsaHRxoc0o0/jvr8zQVKO/yV6OS95elmDIw6PWCR17?=
 =?us-ascii?Q?zN2qcXiH+NuG8HOVgTey2lOS9LgVXm9mPcXa+jlzlC4NwIXz/2yl5tOpkxI0?=
 =?us-ascii?Q?6IS3RTJEG8xGdWHnHw6kZqCm//57nph+V+6fVblatGnh/pTRJiSl7YIonIkA?=
 =?us-ascii?Q?iS+3ik2PVNXhjp3iUcnfsYIF6bG9KQiVbyiaVgzNFPcr2q0/RSgmdtACXRmn?=
 =?us-ascii?Q?Ww=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 9e3f0154-6897-47d2-c5b9-08dc42b19d46
X-MS-Exchange-CrossTenant-AuthSource: CY5PR11MB6139.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 12 Mar 2024 16:29:39.7428 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: PVsiy5fbjuWhGCj6B3yZnIiLqD/BxUPhGHNNjyVMYz+1R50wnpuhpb0Hi5DPCpDVWBajS4LfAjB2cFkqZmtbWlnoh6CZZKracyi8IE4GXSo=

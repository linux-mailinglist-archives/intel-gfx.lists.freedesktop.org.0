...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22DF94FBE7D
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:14:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 433FC10E2DC;
...
Subject: [Intel-gfx] [PATCH 03/34] drm/i915/gvt: rename intel_vgpu_ops to
 intel_vgpu_mdev_ops

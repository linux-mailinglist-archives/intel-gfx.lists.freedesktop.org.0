...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E73271079C6
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Nov 2019 22:09:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F0036F582;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC 04/13] drm/i915/svm: Implicitly migrate BOs upon
 CPU access

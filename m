...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C98AF3B279B
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:47:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 331BB6EA16;
	Thu, 24 Jun 2021 06:47:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0A8BE6E9F4;
 Thu, 24 Jun 2021 06:47:29 +0000 (UTC)
IronPort-SDR: VBybrvd0Un7q5znaZrFWR+8y6BtIbRA1+xHICYtZ0v9QgN+liPo1ph7RBUucjsxCtgyvq6WoFg
 pZ35QOjclWpQ==
X-IronPort-AV: E=McAfee;i="6200,9189,10024"; a="207346750"
X-IronPort-AV: E=Sophos;i="5.83,295,1616482800"; d="scan'208";a="207346750"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jun 2021 23:47:25 -0700
IronPort-SDR: 7eClgJWCFFZEGjATW3TlloytgVESoKoe99fQv9d4J/h3gImhcu+lNx5L38Ed6p+VmW+U//B8Yg
 Z/O1A3Gz29fA==
X-IronPort-AV: E=Sophos;i="5.83,295,1616482800"; d="scan'208";a="556390896"
...
Date: Thu, 24 Jun 2021 00:04:40 -0700
Message-Id: <20210624070516.21893-12-matthew.brost@intel.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <20210624070516.21893-1-matthew.brost@intel.com>
References: <20210624070516.21893-1-matthew.brost@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/47] drm/i915/guc: Implement GuC submission
 tasklet

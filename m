...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A18E75B94E
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jul 2023 23:08:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9704B10E607;
	Thu, 20 Jul 2023 21:08:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7133110E620;
 Thu, 20 Jul 2023 21:08:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689887319; x=1721423319;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=8PftsjpnhIbJM7cH1XP+PS2IDm3ZahoW3XZfOjq+elE=;
 b=hZYtP4IDU0QJ649WgpREfvTPUrX3qBxNx9jucf/FSdqle9Z0rBRZ82tG
 LSy9KBPGmvZ8rRm4jS+7I7g3UCEsSuk8VLDXBLxL/5ZKN5d2CxULb1Jq/
 887vIne8wrl2eYfLo0GKqfz4YMSrGw/jQu4UNtB8rvjfCzUd6q+gilDyK
 hpy46LeNgrAIJ5oRVhMN9fykBz/bDdLcXka2BbjwvCggz5YPJ50k6rdJ+
 0r226y00XL+qadAMEAYekNR/yGY6epryo6u13mv7GFALIfOHEyxOOsfAX
 pa80K7V6zGGXn13Qeoq57YrmEzmP42RZzJ+0PcEVt3COAKJN1kVxIqk/+ g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10777"; a="370462387"
X-IronPort-AV: E=Sophos;i="6.01,219,1684825200"; d="scan'208";a="370462387"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 14:08:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10777"; a="759704744"
X-IronPort-AV: E=Sophos;i="6.01,219,1684825200"; d="scan'208";a="759704744"
Received: from sdene1-mobl1.ger.corp.intel.com (HELO intel.com)
 ([10.252.32.238])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 14:08:11 -0700
...
Subject: [Intel-gfx] [PATCH v7 4/9] drm/i915/gt: Rename flags with

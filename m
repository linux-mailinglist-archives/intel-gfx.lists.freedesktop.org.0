...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D07435BAD43
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Sep 2022 14:20:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D51810E41E;
	Fri, 16 Sep 2022 12:20:51 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v1 3/4] drm/i915: Split

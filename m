...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C601266A344
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 20:31:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 491F410EB01;
...
Subject: [Intel-gfx] [PATCH v2 08/20] dyndbg: tighten ddebug_class_name()
 1st arg

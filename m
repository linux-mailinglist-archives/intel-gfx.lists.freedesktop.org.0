...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 61E84732BFB
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 11:39:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D3FC10E5A0;
	Fri, 16 Jun 2023 09:39:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 26B1910E58E;
 Fri, 16 Jun 2023 09:39:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686908393; x=1718444393;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=75yOAnfFQYXol7+/zRc9bLgt67cNmgu3dtj/juK5NKk=;
 b=DI85DYOlUoDkGZU2Gmqb+xjAjD4jwY/7OBBECZrDs9r1nB3JzXqIU360
 JFXATfgdC9TH7iAkzvVK5jscZGCDi10r8viBvj1vxs4JAodLYAWxtGtyT
 foJsG2IyhrzTHE+38OVhQzguZxlwKeQ/ddGkah5mh72RQyoikhug8rzb8
 ue+0WHUQn4LdDgcI2wRZP8gK3QmT5Kg5VbwJ9PzvPgJAr25P0G8UTVvll
 Naaa3l1mqFVUT/rna+97bbMZPgO510EwWcVQK5KWUTB+deDqPsuRmJeWQ
 TRo+Duf9y5HwY/zz8ZtyAThD6IuFyh5W5D9C1RanZcFuHNwqjsh73yhBh A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="361700136"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="361700136"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2023 02:39:52 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="715951002"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="715951002"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga007.fm.intel.com with ESMTP; 16 Jun 2023 02:39:51 -0700
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Fri, 16 Jun 2023 02:39:26 -0700
Message-Id: <20230616093946.68711-3-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230616093946.68711-1-yi.l.liu@intel.com>
References: <20230616093946.68711-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v13 02/22] vfio: Refine vfio file kAPIs for KVM

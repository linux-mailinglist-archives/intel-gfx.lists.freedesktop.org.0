...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B45E85D7D1
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Feb 2024 13:20:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6F8510E717;
	Wed, 21 Feb 2024 12:20:23 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="QNPBUkr/";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 79D2310E726
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Feb 2024 12:20:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1708518020; x=1740054020;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Nqm0lKRiSYxunkIOpqm5sfMxEbd9dME+8apOOz8SDPw=;
 b=QNPBUkr/MMNb/yI33zOgMf5N41k+Y4ozg5gE6fJpIJLirpJrgmSGo4SN
 l62WhAG/rZRqhEtjTpTIU8O/TQCBhKUb5P5uLf7EL5QQugofKN/WASq88
 v0cBNmLo8zqm6oiKvTmQq8s7xBWhDpcC1Nb+gnE81Db1mFp/sFriSQWNA
 Jez+BlPRYJWoleEZkgeODo9mOUL5E8nuOP+uINR4ZhEM96+1T4vKAI1hu
 k5o/AWGq732HUrqlZEngymuiZ6zGWo9dUi8D30H1fO9JEoAE1sEEIHfI7
 xiI2mxDdlzObN428+p6yX2mBW1ieh9TDOiff4RmskOf0pLbZoJjVieeHy g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10990"; a="6488801"
X-IronPort-AV: E=Sophos;i="6.06,175,1705392000"; 
   d="scan'208";a="6488801"
Received: from orviesa007.jf.intel.com ([10.64.159.147])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2024 04:20:19 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,175,1705392000"; 
   d="scan'208";a="5426095"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orviesa007.jf.intel.com with ESMTP; 21 Feb 2024 04:20:17 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: ankit.k.nautiyal@intel.com,
 Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
Subject: [PATCH 3/6] drm/i915/dp: Add Read/Write support for Adaptive Sync SDP
Date: Wed, 21 Feb 2024 17:43:18 +0530
Message-Id: <20240221121321.2213128-4-mitulkumar.ajitkumar.golani@intel.com>

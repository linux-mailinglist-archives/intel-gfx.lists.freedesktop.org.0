...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EAAF3B28ED
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:29:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B99D6EA48;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 04/27] drm: Don't test for IRQ support in
 VBLANK ioctls

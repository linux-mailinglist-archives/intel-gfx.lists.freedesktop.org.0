...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A5D1175B36
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Mar 2020 14:08:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA03F6E27A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/9] drm/radeon: remove radeon_fb_{add,

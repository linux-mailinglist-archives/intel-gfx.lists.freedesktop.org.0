...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id EN9FIMVrw2kqqwQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 05:59:49 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BED6631FC24
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 05:59:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4A5A610E75A;
	Wed, 25 Mar 2026 04:59:47 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Swx0u/fY";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BCD9110E1DC;
 Wed, 25 Mar 2026 04:59:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1774414787; x=1805950787;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/UR4WjsWIOaR8NCJFSHnJFlO1BynMpdq8U3Y6Agi2wU=;
 b=Swx0u/fY6t9paF9HgbzH9c755VJbtald2Rk8DmxNwPVaNGtVyDQj/k7S
 EXGW8f+LIddRIFYrrMDZOHSaSIaGHfThD1VHzKWd6KIkEJPRbELUnVGLK
 WYGJvnqzPURIjFAdilwszcMUg5ybagoImGx1Sngo70Se3CbvIS+kWsgrF
 8O6yAEKBM2KLO3F4bqlhoPFsxJD/bz4iR1UhYvE9hoPXPvT6idefgiUvL
 VYva5cib9aDTZqNlmFOizxk833bSvfKitc4r/nprpgbGlpfoGIyn1Vogf
 nckyx5xvhqPAp/VP9BRyLC1SJCimaLTU7Ww+tWk4pAMAG3gEtYPqIo6Qd w==;
X-CSE-ConnectionGUID: +F1GnwkCTealqCI8aS9sdQ==
X-CSE-MsgGUID: wdweEcmPScOUulnRHi5x4g==
X-IronPort-AV: E=McAfee;i="6800,10657,11739"; a="86922231"
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; d="scan'208";a="86922231"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2026 21:59:30 -0700
X-CSE-ConnectionGUID: p4O7bR5CR+6FmuTXL9SLKQ==
X-CSE-MsgGUID: 02DTSnwmQY2HCx0KYsB/kA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; d="scan'208";a="224580483"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa008.jf.intel.com with ESMTP; 24 Mar 2026 21:59:27 -0700
...
Subject: [PATCH v2 DO NOT REVIEW 02/26] drm: writeback: Refactor
 drm_writeback_connector structure
Date: Wed, 25 Mar 2026 10:28:52 +0530
Message-Id: <20260325045916.984243-3-suraj.kandpal@intel.com>
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[bootlin.com:email,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,intel.com:dkim,intel.com:email,intel.com:mid,connector.base:url]
X-Rspamd-Queue-Id: BED6631FC24
...
index 2f2b1b115bf2..308809128ac1 100644
...
@@ -10647,7 +10645,7 @@ static void dm_set_writeback(struct amdgpu_display_manager *dm,
...
index 9c8b8da531a7..eed6ac53cc35 100644
...
index 87de41fb4459..5e61565c939b 100644

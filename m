...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 209116F10B1
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 05:11:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BEAB10E00B;
	Fri, 28 Apr 2023 03:11:49 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 0/8] drm/i915: HuC loading and
 authentication for MTL

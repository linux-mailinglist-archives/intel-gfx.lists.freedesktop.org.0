...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A5B3B40242F
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Sep 2021 09:26:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCD4889D5B;
	Tue,  7 Sep 2021 07:26:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EC21189D5B
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Sep 2021 07:26:06 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-479-e1crlgROMGa9DTm58NmaWQ-1; Tue, 07 Sep 2021 03:26:02 -0400
X-MC-Unique: e1crlgROMGa9DTm58NmaWQ-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com
 [10.5.11.13])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id A87A7107ACCA;
 Tue,  7 Sep 2021 07:26:01 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 63A1060936;
 Tue,  7 Sep 2021 07:26:00 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Tue,  7 Sep 2021 17:25:28 +1000
Message-Id: <20210907072549.2962226-5-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 04/25] drm/i915/display: move gmbus into display
 struct
...
index 89df878a7953..cd6fcfb660c6 100644
...
index 60a94bab922a..0fc1ad7c4506 100644
...
index ceb1bf8a8c3c..5cc1a66b9708 100644
...
v.h
index 343cc351d57f..5ca320d1d718 100644
...
@@ -900,25 +913,11 @@ struct drm_i915_private {
=20
...
q.c
index 0b35ab7b421d..dcc404ca919f 100644
...
g.h
index bd63760207b0..a080fe654f8c 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6302586DF32
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Mar 2024 11:27:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2AEB10EC70;
	Fri,  1 Mar 2024 10:27:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="eWYQYp3u";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2291510EC70
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 Mar 2024 10:27:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709288845; x=1740824845;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=gKrWgv6u8Z7reu3jxnevTBnmGS2HbkTA/VxlmPgbs4w=;
 b=eWYQYp3umC/RikB59go8k9GuMBy43UtvE0ZLTkzoEw6lsS5bOWrRMUqy
 1sFowIFfywYtXvRh6EV8XIcJV/BicVVRUxO7mSWjMOBCDGVCQ7wrq5BUt
 kqAMUVWT0s7PHVSkvZIVasNLlSFInPYRKvXYqUh7sQybvc3peIqgd41qi
 wptkR9NFmXRUtZbk+OG4yvfmajBS7L0LbB0AygZ3UkSyT7UbDwljBwE3U
 AYZ8ISiZcgwstXpeSt+jEc/iuR9whtecrwE94TqDUFwP9A98JhbSxUPOL
 yqwoberZz5YxD/HO5bOopqW2/oPOtGYFPxXvmhAzccfhl2BAWJYtwP5yl Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10999"; a="15252916"
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="15252916"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 02:27:24 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,195,1705392000"; 
   d="scan'208";a="8294464"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by fmviesa008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 02:27:22 -0800
Date: Fri, 1 Mar 2024 12:27:18 +0200

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5979136B184
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Apr 2021 12:20:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C90D06E7D2;
	Mon, 26 Apr 2021 10:20:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C181D6E56A;
 Mon, 26 Apr 2021 10:20:28 +0000 (UTC)
IronPort-SDR: 2MAZxBDbWS3D2Q/ugGv6xuL8tcr50frEmxtjIDXIA6O1pWWuRtb4yfoqYv112N52RZ4eg41VJF
 e2h3HD5rCumA==
X-IronPort-AV: E=McAfee;i="6200,9189,9965"; a="196370955"
X-IronPort-AV: E=Sophos;i="5.82,252,1613462400"; d="scan'208";a="196370955"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Apr 2021 03:20:28 -0700
IronPort-SDR: OY8tWpeu3ju9xE5Tqm3vmNQWtH9fgELFoUGPK98wBv4RnKl5dzitWygiXdOKTJAqvpnlki5FAZ
 jJWbMwRUT5rw==
X-IronPort-AV: E=Sophos;i="5.82,252,1613462400"; d="scan'208";a="422613706"
Received: from rgunnin1-mobl.ger.corp.intel.com (HELO
 mwauld-desk1.ger.corp.intel.com) ([10.252.12.201])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Apr 2021 03:20:27 -0700
From: Matthew Auld <matthew.auld@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 26 Apr 2021 11:18:17 +0100
Message-Id: <20210426101821.42147-3-matthew.auld@intel.com>
X-Mailer: git-send-email 2.26.3
In-Reply-To: <20210426101821.42147-1-matthew.auld@intel.com>
References: <20210426101821.42147-1-matthew.auld@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/7] drm/i915/gtt: map the PD up front

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 82A103F4226
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Aug 2021 00:22:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD5D489F8E;
...
Subject: [Intel-gfx] [PATCH v6 06/11] drm_print: add choice to use dynamic
 debug in drm-debug

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DB97416C1D
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 08:51:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C01C96EDF9;
...
Subject: [Intel-gfx] [PATCH v2 10/17] drm/nouveau: cleanup:

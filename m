...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CCA636BC30D
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 02:01:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEEB710EA54;
	Thu, 16 Mar 2023 01:01:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5690810E58E
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=RSgpXJzZiC5gEnx/dX8GvfjEmFeo3dVXoCB+PgrLVYA=;
 b=gF0WtisLyuunWtCUOTJBnapqG1dceIMtxLICoY7KQjV1bn4Sk+LIlIEy
 Q65RF3du7isj/5LE4bPVfDfMrqBc6woqDWgjoiyWxczmBVYl39Eovdizy
 XjxpZpLbsmaFEiua0PVvCF1GwDdupj59T57UKJsAFWcLItifvIrRpzoRz
 1SWfzO2ZPNB++MeOllET2zoO6dDAAUcT8JasMaN0M7A5xbQe8ZExsX9Kh
 nMNe6M9kVVodNNt1WiR8vei8asqw6E54QZwDKq1Ws2K2PwXQ377DGcOgP
 eLM/30oPIpfjwpspVcpa7nw9xf9DcRXkPOwwgO4laUsE145pMuHu5nX9C A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="400434073"
X-IronPort-AV: E=Sophos;i="5.98,262,1673942400"; d="scan'208";a="400434073"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2023 18:01:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="743916702"
X-IronPort-AV: E=Sophos;i="5.98,262,1673942400"; d="scan'208";a="743916702"
Received: from orsosgc001.jf.intel.com ([10.165.21.138])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2023 18:01:06 -0700
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 15 Mar 2023 18:00:59 -0700
Message-Id: <20230316010101.2590309-11-umesh.nerlige.ramappa@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 10/12] drm/i915/perf: Add support for OA
 media units
...
index 0c52ffa6d470..f68a66cc387b 100644
...
@@ -4196,6 +4225,14 @@ static int read_properties_unlocked(struct i915_perf *perf,
 		return -EINVAL;
 	}
...
+
 	if (config_sseu) {
 		...
 		if (ret) {
@@ -4376,6 +4413,14 @@ static const struct i915_range gen12_oa_b_counters[] = {
 	{}
 };
...
@@ -4429,6 +4474,8 @@ static const struct i915_range mtl_oa_mux_regs[] = {
...
@@ -4466,10 +4513,20 @@ static bool gen12_is_valid_b_counter_addr(struct i915_perf *perf, u32 addr)
...
@@ -4839,12 +4896,86 @@ static u32 num_perf_groups_per_gt(struct intel_gt *gt)
 	return 1;
 }
...
@@ -4871,6 +5002,8 @@ static int oa_init_gt(struct intel_gt *gt)
...
@@ -4928,9 +5061,15 @@ static void oa_init_supported_formats(struct i915_perf *perf)
 		break;
...
+		oa_format_add(perf, I915_OAM_FORMAT_MPEC8u32_B8_C8);
 	...
 	default:
@@ -5175,8 +5314,10 @@ int i915_perf_ioctl_version(void)
 	 *
...
index e8c258bfd4c9..6687b90c6886 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE5727B20DC
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Sep 2023 17:17:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9410110E679;
...
Subject: Re: [Intel-gfx] [PATCH 9/9] drm/v3d: Annotate struct v3d_perfmon
 with __counted_by

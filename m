...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D435563C86
	for <lists+intel-gfx@lfdr.de>; Sat,  2 Jul 2022 00:51:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 346A011259B;
...
Subject: [Intel-gfx] [RFC 09/10] drm/i915/vm_bind: Skip vma_lookup for
 persistent vmas

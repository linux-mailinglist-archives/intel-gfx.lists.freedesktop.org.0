...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B9686E58A4
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Apr 2023 07:37:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6787410E68B;
	Tue, 18 Apr 2023 05:37:46 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v9 02/10] drm/hdcp: Avoid changing crtc

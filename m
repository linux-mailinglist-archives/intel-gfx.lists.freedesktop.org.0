...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FA9D392288
	for <lists+intel-gfx@lfdr.de>; Thu, 27 May 2021 00:09:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E6186EC62;
	Wed, 26 May 2021 22:09:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A91336EDDF
 for <intel-gfx@lists.freedesktop.org>; Wed, 26 May 2021 22:09:16 +0000 (UTC)
IronPort-SDR: Umubb6bkguwS3oZaLSw3DoNjM/CwHQ3PlcuMIfaHO15rQ4mbmi7tQULJM4LCPuuhOEbRpT5k2Y
 k7vwL9ALePzg==
X-IronPort-AV: E=McAfee;i="6200,9189,9996"; a="202600441"
X-IronPort-AV: E=Sophos;i="5.82,331,1613462400"; d="scan'208";a="202600441"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2021 15:08:58 -0700
IronPort-SDR: rEPtBAitriaF6FIIFjmhkit2L40Y/KwX9hoDeBovKqVT6Z5PKFUM6e5keeSBbPm5IuwBt0p/mi
 LFtCk64L3NEg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.82,331,1613462400"; d="scan'208";a="633689144"
Received: from anushasr-mobl6.jf.intel.com ([10.165.21.155])
 by fmsmga005.fm.intel.com with ESMTP; 26 May 2021 15:08:57 -0700
From: Anusha Srivatsa <anusha.srivatsa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 26 May 2021 15:08:51 -0700
Message-Id: <20210526220853.4550-6-anusha.srivatsa@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/7] xdrm/i915/xelpd: Pipe A DMC plugging
...
---
 ...
 drivers/gpu/drm/i915/display/intel_dmc.c      | 123 ++++++++++--------
...
index 3ca8112eead5..4d62e8476a6c 100644
--- a/drivers/gpu/drm/i915/display/intel_display_power.c
+++ b/drivers/gpu/drm/i915/display/intel_display_power.c
@@ -959,8 +959,9 @@ static void bxt_disable_dc9(struct drm_i915_private *dev_priv)
...
index b78cb44731fe..a111537f2ba8 100644
...
@@ -505,7 +518,7 @@ parse_dmc_fw_package(struct intel_dmc *dmc,
 {
 	struct drm_i915_private *i915 = container_of(dmc, typeof(*i915), dmc);
...
@@ -541,16 +554,11 @@ parse_dmc_fw_package(struct intel_dmc *dmc,
...
@@ -602,7 +610,8 @@ static void parse_dmc_fw(struct drm_i915_private *dev_priv,
 	struct intel_dmc *dmc = &dev_priv->dmc;
...
+	int id;
 	...
 	if (!fw)
 		return;
@@ -623,9 +632,19 @@ static void parse_dmc_fw(struct drm_i915_private *dev_priv,
...
index 4979b4965a82..5dfff087d04b 100644

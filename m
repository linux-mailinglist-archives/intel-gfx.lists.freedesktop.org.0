...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D67F9146A35
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 15:00:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 864286FCE3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 02/22] drm: Add get_scanout_position() to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D50C944278A
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 08:06:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C08E06FAB8;
...
Subject: [Intel-gfx] [PATCH 06/29] drm/i915/gvt: move the gvt code into
 kvmgt.ko

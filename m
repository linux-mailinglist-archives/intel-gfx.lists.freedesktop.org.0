...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 06A9C5FDA9E
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Oct 2022 15:21:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2B3510E8F9;
	Thu, 13 Oct 2022 13:19:52 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 16/22] drm/atomic-helper: Add a TV properties
 reset helper

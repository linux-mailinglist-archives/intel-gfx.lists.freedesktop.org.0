...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CB08B686EBE
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Feb 2023 20:16:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02FB810E18F;
	Wed,  1 Feb 2023 19:16:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0825110E19D;
 Wed,  1 Feb 2023 19:16:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675278995; x=1706814995;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=zVAkci99U15ECAzUav4vWIpDTQXKnYj9XcQ4fwTbyL4=;
 b=X0oo91WuiBJ1l2TxdYIZWDYyh8xADQKtQSvNmglKJufTXj+JO5X4q+Qz
 uS2tl1/CsPumG0f5xz8DchHhRhy6X/RF+Uq5nZptw0arLDJuH4A/5kqZQ
 0OeZbOwnBOGZbZkMgL1i8I4JZmzSSEHY15d2PAoVkYWf9TEn/Fnsg2zwG
 +GIPJrElBT+ZiBDFVQ2w4tBnI/LKDWK/mY9PqKofYb0QCD1BIn87BGBEa
 Qj5LPAnZEVL7TCrQfuxrIuLW1ZE6NSUtDO+ArmCXLVFiy4gF0a87x81Ag
 SHKwwLUTEYoZP7bAcZwNaxNUF8DZxjfrBSV9WJQEZKO24p2plG3thShML Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="414453304"
X-IronPort-AV: E=Sophos;i="5.97,265,1669104000"; d="scan'208";a="414453304"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 11:16:18 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="773554969"
X-IronPort-AV: E=Sophos;i="5.97,265,1669104000"; d="scan'208";a="773554969"
Received: from jkrzyszt-mobl1.ger.corp.intel.com ([10.213.17.84])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 11:16:14 -0800
From: Janusz Krzysztofik <janusz.krzysztofik@linux.intel.com>
To: Kamil Konieczny <kamil.konieczny@linux.intel.com>
Date: Wed, 01 Feb 2023 20:16:11 +0100
Message-ID: <1887805.taCxCBeP46@jkrzyszt-mobl1.ger.corp.intel.com>
Organization: Intel Technology Poland sp. z o.o. - ul. Slowackiego 173,
 80-298 Gdansk - KRS 101882 - NIP 957-07-52-316
In-Reply-To: <20230201182157.qpu6fyobvwwxdwwt@kamilkon-desk1>

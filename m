...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A9C6C2C653D
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:13:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D56DE6ECF6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 116/162] drm/i915/dsb: Enable lmem for dsb

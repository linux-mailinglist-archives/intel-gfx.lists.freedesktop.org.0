...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 39308785745
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Aug 2023 13:57:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE05F10E412;
...
Subject: [Intel-gfx] [PATCH 0/2] eDP DSC fixes

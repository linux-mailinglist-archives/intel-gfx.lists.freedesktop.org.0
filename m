...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B49620423C
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Jun 2020 22:54:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 811AB6E0A1;
	Mon, 22 Jun 2020 20:54:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 945CF6E0A1
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Jun 2020 20:54:23 +0000 (UTC)
IronPort-SDR: +VV2kaW7UvlaSFlmkOJ2IYZ3Pzm2mNTQSL9CJPkMJphjYiRkxeHa00H8TBchVYOjLtZBxcUTli
 Mx4MCUr5N1KA==
X-IronPort-AV: E=McAfee;i="6000,8403,9660"; a="209065866"
X-IronPort-AV: E=Sophos;i="5.75,268,1589266800"; d="scan'208";a="209065866"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Jun 2020 13:54:22 -0700
IronPort-SDR: zyMTTEKz/HiJb7ME11ymJ2hgPJ3PfvbKpC7i0PkW7ejbdNwzHrsc58n9hkf8ztmXNh02CHBl6g
 /ibjZBYLSk2w==
X-IronPort-AV: E=Sophos;i="5.75,268,1589266800"; d="scan'208";a="422759411"
Received: from ideak-desk.fi.intel.com ([10.237.72.183])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Jun 2020 13:54:21 -0700
Date: Mon, 22 Jun 2020 23:54:11 +0300
From: Imre Deak <imre.deak@intel.com>
To: Lucas De Marchi <lucas.demarchi@intel.com>
Message-ID: <20200622205411.GA12843@ideak-desk.fi.intel.com>
...
In-Reply-To: <20200622204345.l3hbdamz4zgymbuc@ldmartin-desk1>
...
> > > DG1 has one more combo phy port, no TC and all irq handling goes thro=
ugh
> > > SDE, like for MCC.
> > > =
...
> 270810a73210 ("drm/i915/hotplug: Use phy to get the hpd_pin instead of th=
e port (v5)")
> =
...
> > > @@ -193,10 +200,13 @@ static void intel_hpd_init_pins(struct drm_i915=
_private *dev_priv)
> > >  	else
> > >  		hpd->hpd =3D hpd_ilk;
> > > =
...
> > > @@ -1145,6 +1155,22 @@ static bool tgp_tc_port_hotplug_long_detect(en=
um hpd_pin pin, u32 val)
> > >  	}
> > >  }
> > > =

> > > +static bool dg1_ddi_port_hotplug_long_detect(enum hpd_pin pin, u32 v=
al)
> > > +{
> > > +	switch (pin) {
> > > +	case HPD_PORT_A:
...
> > >  {
> > >  	switch (pin) {
> > > @@ -1893,13 +1919,20 @@ static void icp_irq_handler(struct drm_i915_p=
rivate *dev_priv, u32 pch_iir)
...
> > > @@ -1911,6 +1944,7 @@ static void icp_irq_handler(struct drm_i915_pri=
...
> > >  	}
> > > @@ -1924,7 +1958,7 @@ static void icp_irq_handler(struct drm_i915_pri=
vate *dev_priv, u32 pch_iir)
...
> > > @@ -3147,6 +3181,13 @@ static void jsp_hpd_irq_setup(struct drm_i915_=
private *dev_priv)
...
> > > +}
> > > +
> > >  static void gen11_hpd_detection_setup(struct drm_i915_private *dev_p=
riv)
> > >  {
> > >  	u32 hotplug;
> > > @@ -3535,7 +3576,9 @@ static void icp_irq_postinstall(struct drm_i915=
_private *dev_priv)
...
> > >  	else if (HAS_PCH_JSP(dev_priv))
> > > @@ -4051,7 +4094,9 @@ void intel_irq_init(struct drm_i915_private *de=
v_priv)

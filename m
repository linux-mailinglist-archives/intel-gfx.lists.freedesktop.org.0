...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB195139093
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jan 2020 13:01:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF92689322;
	Mon, 13 Jan 2020 12:01:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 79D3389322;
 Mon, 13 Jan 2020 12:01:15 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 13 Jan 2020 04:01:14 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,428,1571727600"; 
 d="scan'208,217";a="243978646"
Received: from plaxmina-desktop.iind.intel.com ([10.106.124.119])
 by fmsmga001.fm.intel.com with ESMTP; 13 Jan 2020 04:01:07 -0800
...
Date: Mon, 13 Jan 2020 17:25:54 +0530
Message-Id: <20200113115557.32713-4-pankaj.laxminarayan.bharadiya@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/6] drm/i915: Make WARN* drm specific where
...
index fbc13f36f76f..4b384d974922 100644
...
index 59c375879186..1dca6c730025 100644
...
@@ -10513,8 +10517,8 @@ static bool ilk_get_pipe_config(struct intel_crtc *crtc,
...
@@ -10738,8 +10742,9 @@ static bool hsw_get_transcoder_state(struct intel_crtc *crtc,
...
+				 transcoder_name(panel_transcoder));
 		...
 		case TRANS_DDI_EDP_INPUT_A_ONOFF:
 			force_thru = true;
@@ -10767,11 +10772,11 @@ static bool hsw_get_transcoder_state(struct intel_crtc *crtc,
 	/*
...
+	drm_WARN_ON(dev, *power_domain_mask & BIT_ULL(power_domain));
 	...
 	if (!wf)
@@ -10805,7 +10810,7 @@ static bool bxt_get_dsi_transcoder_state(struct intel_crtc *crtc,
...
+		drm_WARN_ON(dev, *power_domain_mask & BIT_ULL(power_domain));
 		...
 		wf = intel_display_power_get_if_enabled(dev_priv, power_domain);
 		if (!wf)
@@ -11706,7 +11711,7 @@ int intel_get_load_detect_pipe(struct drm_connector *connector,
...
@@ -12956,12 +12961,12 @@ static bool check_digital_port_conflicts(struct intel_atomic_state *state)
...
@@ -17338,12 +17343,12 @@ static void sanitize_watermarks(struct drm_device *dev)
 	if (ret == -EDEADLK) {
...
@@ -17369,7 +17374,8 @@ static void sanitize_watermarks(struct drm_device *dev)
...
@@ -18187,7 +18193,7 @@ static void intel_modeset_readout_hw_state(struct drm_device *dev)
...
@@ -18398,7 +18404,7 @@ intel_modeset_setup_hw_state(struct drm_device *dev,
 		u64 put_domains;
...
index 93b20c4060c8..f6776899f24c 100644
...
index 728a4b045de7..f1e5bf498227 100644
...
index bb3fd8b786a2..6012f59e14d5 100644
...
index 685589064d10..36738bb893f5 100644
...
index fc29046d48ea..a0ae7cb843d4 100644
...
index 2746512f4466..b4efee22fa63 100644
...
index 8758ee2a4442..ee54aa9fc8b5 100644
...
index afc6aad9bf8c..08c498ea4d0a 100644
...
+	if (drm_WARN_ON(dev, !mode->crtc_clock)) {

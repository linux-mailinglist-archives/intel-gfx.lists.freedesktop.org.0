...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 0NrAKiIqimm6HwAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Feb 2026 19:40:34 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7E48113A90
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Feb 2026 19:40:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C632410E06B;
	Mon,  9 Feb 2026 18:40:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=oracle.com header.i=@oracle.com header.b="O1xNgLW7";
	dkim=pass (1024-bit key; unprotected) header.d=oracle.onmicrosoft.com header.i=@oracle.onmicrosoft.com header.b="B9zwpgfx";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx0a-00069f02.pphosted.com (mx0a-00069f02.pphosted.com
 [205.220.165.32])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9089410E06B;
 Mon,  9 Feb 2026 18:40:30 +0000 (UTC)
Received: from pps.filterd (m0246627.ppops.net [127.0.0.1])
 by mx0b-00069f02.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id
 619ECXXA1228995; Mon, 9 Feb 2026 18:38:42 GMT
...
Received: from pps.filterd
 ...
 with ESMTP id 619H0cl0040498; Mon, 9 Feb 2026 18:38:40 GMT
...
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?ME9BxVEbQRWtiVZlA+9gngr+cXmzCXOAfTyZDN76q83JvICxDiR6aupWRDmH?=
...
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?peCZI8IHNhCsJWxpHxCZmC8LHzZbo//aY7RFGJE8GaGE9r6QBpmxkoZTTVnz?=
...
X-Spamd-Result: default: False [-0.31 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,oracle.onmicrosoft.com:dkim];
	MIME_TRACE(0.00)[0:+];

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 654124F8A68
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Apr 2022 00:59:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FA1710E4CD;
	Thu,  7 Apr 2022 22:59:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from alexa-out-sd-02.qualcomm.com (alexa-out-sd-02.qualcomm.com
 [199.106.114.39])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9429010E4CD;
 Thu,  7 Apr 2022 22:59:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=quicinc.com; i=@quicinc.com; q=dns/txt; s=qcdkim;
 t=1649372365; x=1680908365;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=fJeuFnrzGXBgW0z4FhiP7Xbnm8AQhqQfBRtamJgM6Uk=;
 b=L9RxqiePXifOHuUqxWXq6EjV4V6SGZxQkz5RzDnZ2feXN7rfxApVgf5S
 RkL2Q0/Zs1K2BOeLwIRuVBA3uwaouei0dy4MFztprBKrMX0NDrS44z2UH
 wWrCQyNJgLXcHr/9E1aX0GbzSqSPRpv353Ofb+56Fv1Qf2LVNCz8V/fa2 M=;
Received: from unknown (HELO ironmsg02-sd.qualcomm.com) ([10.53.140.142])
 by alexa-out-sd-02.qualcomm.com with ESMTP; 07 Apr 2022 15:59:25 -0700
X-QCInternal: smtphost
Received: from nasanex01c.na.qualcomm.com ([10.47.97.222])
 by ironmsg02-sd.qualcomm.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2022 15:59:24 -0700
Received: from nalasex01a.na.qualcomm.com (10.47.209.196) by
 nasanex01c.na.qualcomm.com (10.47.97.222) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.22; Thu, 7 Apr 2022 15:59:24 -0700
Received: from [10.111.161.146] (10.80.80.8) by nalasex01a.na.qualcomm.com
 ...
 15:59:21 -0700
Message-ID: <ec74f2f6-488f-bc34-3d9a-3e1cec68aedc@quicinc.com>
Date: Thu, 7 Apr 2022 15:59:19 -0700
MIME-Version: 1.0
...
In-Reply-To: <CAF6AEGvLY-+v0ZCvtoZDsW-0z5a8UH8suN9cp22m_ec=Ggb9Mw@mail.gmail.com>

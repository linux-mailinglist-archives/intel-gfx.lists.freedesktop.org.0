...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A9192D70E0
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Dec 2020 08:29:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 300336EC7D;
	Fri, 11 Dec 2020 07:29:51 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3D9076EC82
 for <Intel-gfx@lists.freedesktop.org>; Fri, 11 Dec 2020 07:29:47 +0000 (UTC)
IronPort-SDR: f4LHxJdnNSqX5wTIW4a/xZTS3vBHS6O9K2Wax8BRkPdpojs8fmFzOs8XHK916SgQeTGN2FdLQR
 1HTyuPPZGtvg==
X-IronPort-AV: E=McAfee;i="6000,8403,9831"; a="174506408"
X-IronPort-AV: E=Sophos;i="5.78,410,1599548400"; d="scan'208";a="174506408"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2020 23:29:45 -0800
IronPort-SDR: Jz/bfc2/grpdwMvswrMVhMQqTG2r5Q3ukrHEZr4Mm73FoEpVi5Wh++8OI7ia6dG1smFbVq+3wc
 t7lY79p32cDQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,410,1599548400"; d="scan'208";a="409063301"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga001.jf.intel.com with ESMTP; 10 Dec 2020 23:29:45 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 10 Dec 2020 23:29:02 -0800
Message-Id: <20201211072911.27403-13-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201211072911.27403-1-sean.z.huang@intel.com>
References: <20201211072911.27403-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v7 12/21] drm/i915/pxp: User interface for
 Protected buffer

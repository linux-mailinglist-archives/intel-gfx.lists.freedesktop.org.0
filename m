...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 38CA32C6478
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:09:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B71046EC3A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 029/162] drm/i915: Handle ww locking in
 init_status_page

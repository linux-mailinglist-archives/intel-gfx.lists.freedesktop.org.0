...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E488C3B27D5
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE25B6EA2D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 16/47] drm/i915/guc: Disable engine barriers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AEEE65AC792
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:48:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFEF510E1EB;
...
Subject: [Intel-gfx] [PATCH v6 51/57] dyndbg: prevent build bugs via

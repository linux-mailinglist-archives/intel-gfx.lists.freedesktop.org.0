...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CB492B1895
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Nov 2020 10:42:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F36F86E4B6;
	Fri, 13 Nov 2020 09:42:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 236416E4A1
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Nov 2020 09:41:44 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 22980371-1500050 
 for multiple; Fri, 13 Nov 2020 09:41:35 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 13 Nov 2020 09:41:25 +0000
Message-Id: <20201113094128.8740-30-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 30/33] drm/i915/gt: Add timeline "mode"
...
index eb34a39fee5f..791662708d05 100644
...
index 9b7f30c147c5..064255210209 100644
--- a/drivers/gpu/drm/i915/gt/intel_timeline.h
+++ b/drivers/gpu/drm/i915/gt/intel_timeline.h
@@ -69,7 +69,7 @@ static inline void intel_timeline_put(struct intel_timeline *timeline)
 static inline bool

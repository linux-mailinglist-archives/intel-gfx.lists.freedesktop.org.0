...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3986EBDC517
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Oct 2025 05:18:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 95BF710E720;
	Wed, 15 Oct 2025 03:18:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="cebB+kGq";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9252010E720;
 Wed, 15 Oct 2025 03:18:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1760498325; x=1792034325;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=0su3RDheU912mZ81gl9GgxSwG/781wFtGOccH+Bkza0=;
 b=cebB+kGq+0m0rdNmYcInKQ2KXzo4ltBFB+uTJaLcLQM/HMKkwMIS1747
 Vzy068TSNB8FdpHCq8OLOo40h/04CSWLUXYM66KEfRxwx9++IOSvXivDt
 /Gm2aHRSdu1CQgkhXDlVpx7XYgv8N7TpRS5A4XPUNzJoPBMaBkDDKToo1
 UC9xFrv4YsSB3xliqldyF48BfC9KCeD2d4xByrV6jcao1dtTnZFk8L6D8
 ulxYeiLpAfCDk6Y7SXmDxMEZmHRtI9F2q1RFhNtfG4+pkE4MEKgdvUpvD
 uA6pJN+3sHAa8GTpOGOp3+ZYtZbH9Rzd9tafoWZSFD3vJkGPmBag7ms9L Q==;
X-CSE-ConnectionGUID: Mldz4fgrRqyV13o+6ZAadw==
X-CSE-MsgGUID: G+8yfguWRVO4wdlIkCVcYA==
X-IronPort-AV: E=McAfee;i="6800,10657,11582"; a="62702617"
X-IronPort-AV: E=Sophos;i="6.19,230,1754982000"; d="scan'208";a="62702617"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2025 20:18:45 -0700
X-CSE-ConnectionGUID: GUpunauCRXmKlAERIgtd2w==
X-CSE-MsgGUID: Drtv1okXSRac5fpbxzxQPg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,230,1754982000"; d="scan'208";a="186303253"
Received: from smoehrl-linux.amr.corp.intel.com (HELO [192.168.1.16])
 ([10.124.222.185])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2025 20:18:42 -0700
From: Gustavo Sousa <gustavo.sousa@intel.com>
Date: Wed, 15 Oct 2025 00:15:31 -0300
Subject: [PATCH 31/32] drm/i915/xe3p_lpd: Extend Type-C flow for static DDI
 allocation
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20251015-xe3p_lpd-basic-enabling-v1-31-d2d1e26520aa@intel.com>

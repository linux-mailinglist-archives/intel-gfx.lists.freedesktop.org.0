...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 256941369D3
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B3DD6E9CF;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 13/23] drm/gma500: Convert to CRTC VBLANK
 callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7BC566A347
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 20:31:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4CF8110EB03;
...
Subject: [Intel-gfx] [PATCH v2 09/20] dyndbg: constify

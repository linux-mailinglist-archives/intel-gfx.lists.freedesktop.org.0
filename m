...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 93E7E3EB78F
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Aug 2021 17:18:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7768E6E85D;
	Fri, 13 Aug 2021 15:18:45 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 2/9] moduleparam: add data member to struct
 kernel_param

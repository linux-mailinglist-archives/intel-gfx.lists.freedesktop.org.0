...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B809B665FB4
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Jan 2023 16:51:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 24A8C10E773;
...
Subject: [Intel-gfx] [PATCH v3 1/2] drm/i915/display: Avoid full proxy f_ops
 for DRRS debug attributes

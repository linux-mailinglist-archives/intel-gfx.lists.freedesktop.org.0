...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 342B8C9AE4
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Oct 2019 11:37:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E4C26E986;
	Thu,  3 Oct 2019 09:37:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D4D696E99A
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Oct 2019 09:37:02 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18704176-1500050 
 for multiple; Thu, 03 Oct 2019 10:36:42 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  3 Oct 2019 10:36:20 +0100
Message-Id: <20191003093639.10186-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/22] drm/i915: Only track bound elements of
 the GTT
...
ZGV4IGJmYmMzZTNkYWY5Mi4uZTQ1ZWI4NzIxODUwIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9k
cm0vaTkxNS9nZW0vaTkxNV9nZW1fc3RvbGVuLmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUv
Z2VtL2k5MTVfZ2VtX3N0b2xlbi5jCkBAIC02OTIsNyArNjkyLDcgQEAgaTkxNV9nZW1fb2JqZWN0
...
bS9pOTE1L2k5MTVfZ2VtX2d0dC5jCmluZGV4IGU2MmU5ZDFhMTMwNy4uYWQ5ZWIyZDY4ZjNmIDEw
...
JnZtLT5ib3VuZF9saXN0KTsKIH0KIApAQCAtMTg4NywxMCArMTg3Niw2IEBAIHN0YXRpYyBzdHJ1
...
NS9pOTE1X2dlbV9ndHQuaAppbmRleCA4ZmQyMjM0YmEwYmYuLmJiZGM3MzU0NjZjMSAxMDA2NDQK
...
NS9pOTE1X3ZtYS5jIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV92bWEuYwppbmRleCA2OGMz
NGIxYTIwZTQuLmQwOTdmNzc4OTBiYSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUv
...


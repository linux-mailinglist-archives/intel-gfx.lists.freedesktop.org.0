...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B93CBD0DF
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2019 19:46:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 044AA6EAD4;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 j0Ag==
Subject: Re: [Intel-gfx] [PATCH v2 9/9] drm/print: rename drm_debug to

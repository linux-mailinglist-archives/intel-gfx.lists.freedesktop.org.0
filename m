...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 007829B4DF1
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Oct 2024 16:29:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CB8110E29E;
	Tue, 29 Oct 2024 15:29:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 2413ebb6fbb6 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6142710E29E;
 Tue, 29 Oct 2024 15:29:14 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============3420721217705860454=="
MIME-Version: 1.0
...
Date: Tue, 29 Oct 2024 15:29:14 -0000
Message-ID: <173021575439.1359138.3100012827256478740@2413ebb6fbb6>
...
CI Bug Log - changes from CI_DRM_15604 -> Patchwork_140444v3
====================================================
...
-------
  ...
  **SUCCESS**
  ...
  External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_140444v3/index.html
...
------------
  ...
  Here are the changes found in Patchwork_140444v3 that come from known issues:
...
#### Issues hit ####
  ...
  * igt@i915_selftest@live:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_140444v3/bat-arlh-3/igt@i915_selftest@live.html
  ...
  * igt@i915_selftest@live@workarounds:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_140444v3/bat-arlh-3/igt@i915_selftest@live@workarounds.html
...
-------------
  ...
  * Linux: CI_DRM_15604 -> Patchwork_140444v3
  ...
  Patchwork_140444v3: 738c18d8599dce736da8b6958f96d2eac08a36ab @ git://anongit.freedesktop.org/gfx-ci/linux
...
<tr><td><b>State:</b></td><td>success</td></tr>
    ...
    <h1>CI Bug Log - changes from CI_DRM_15604 -&gt; Patchwork_140444v3</h1>
<h2>Summary</h2>
<p><strong>SUCCESS</strong></p>
<p>No regressions found.</p>
<p>External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_140444v3/index.html</p>
<h2>Participating hosts (47 -&gt; 46)</h2>
<p>Missing    (1): fi-snb-2520m </p>
<h2>Known issues</h2>
<p>Here are the changes found in Patchwork_140444v3 that come from known issues:</p>
<h3>IGT changes</h3>
<h4>Issues hit</h4>
<ul>
<li>
...
<ul>
<li>bat-arlh-3:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_15604/bat-arlh-3/igt@i915_selftest@live.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_140444v3/bat-arlh-3/igt@i915_selftest@live.html">ABORT</a> (<a href="https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/12133">i915#12133</a>)</li>
</ul>
</li>
<li>
<p>igt@i915_selftest@live@workarounds:</p>
<ul>
<li>bat-arlh-3:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_15604/bat-arlh-3/igt@i915_selftest@live@workarounds.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_140444v3/bat-arlh-3/igt@i915_selftest@live@workarounds.html">ABORT</a> (<a href="https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/12061">i915#12061</a>)</li>
</ul>
</li>
</ul>
<h2>Build changes</h2>
<ul>
<li>Linux: CI_DRM_15604 -&gt; Patchwork_140444v3</li>
</ul>
<p>CI-20190529: 20190529<br />
  ...
  Patchwork_140444v3: 738c18d8599dce736da8b6958f96d2eac08a36ab @ git://anongit.freedesktop.org/gfx-ci/linux</p>

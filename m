...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 423BE6CD30C
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 09:25:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C7BDA10EA47;
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v6 5/8] drm/i915: Correct type of wakeref
 variable

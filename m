...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E33B56B0200
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 09:50:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26D1010E5B7;
...
Subject: Re: [Intel-gfx] [PATCH v2 4/7] drm/ttm: Unexport
 ttm_global_swapout()

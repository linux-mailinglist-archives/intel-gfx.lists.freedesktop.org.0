...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7799471FB8
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Jul 2019 20:56:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C185D6E39E;
	Tue, 23 Jul 2019 18:56:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 12C856E39E
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Jul 2019 18:56:38 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17542627-1500050 
 for multiple; Tue, 23 Jul 2019 19:38:47 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 Jul 2019 19:38:42 +0100
Message-Id: <20190723183842.20372-23-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 23/23] drm/i915: Markup expected timeline locks
 for i915_active
...
aWVudF9ibHQuYwppbmRleCAyMzEyYTBjNmFmODkuLmYxNWIwYjgyZTU2MiAxMDA2NDQKLS0tIGEv
...

...
dC5jCmluZGV4IGJjZDY5YzE4NzMxMy4uYjVhMTJiNzk2YTQ5IDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9jb250ZXh0LmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvZ3QvaW50ZWxfY29udGV4dC5jCkBAIC0yODIsNyArMjgyLDcgQEAgaW50IGludGVsX2NvbnRl
...
X3ZtYS5jCmluZGV4IGMzODc3NzBjMzc2NC4uZjdmNTE2YTc1YzY2IDEwMDY0NAotLS0gYS9kcml2

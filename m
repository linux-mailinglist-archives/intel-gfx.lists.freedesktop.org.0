...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27F08684FA
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Jul 2019 10:12:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7029F898A7;
	Mon, 15 Jul 2019 08:12:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A647B89826
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Jul 2019 08:11:45 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17303251-1500050 
 for multiple; Mon, 15 Jul 2019 09:09:53 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 15 Jul 2019 09:09:36 +0100
Message-Id: <20190715080946.15593-14-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/24] drm/i915: Protect request retirement with
 timeline->mutex
...
bS9pOTE1X2dlbV9leGVjYnVmZmVyLmMKaW5kZXggNjE5ZjY4M2Q0ZWU5Li5kZDVkZjE4MDEwOWIg
...
cy5jIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZW5naW5lX2NzLmMKaW5kZXggNWY4
OTA5NTQ2ZDM2Li4xZjVhYzA0NWE4ZDggMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1
...
bF9lbmdpbmVfdHlwZXMuaAppbmRleCA2ODIyZmJiNDRkMmQuLjg3ZWFiN2QxM2M4YyAxMDA2NDQK
...
bF9scmMuYyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2xyYy5jCmluZGV4IGI1YjJi
OTM5ZDVkMi4uMThkOWRkYzVjZDU4IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9n
...
LmMKaW5kZXggZjM5Yzc0NzQwZDhkLi5hMDkyNGYyMDdkMmMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMv
Z3B1L2RybS9pOTE1L2d0L2ludGVsX3JpbmdidWZmZXIuYworKysgYi9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF9yaW5nYnVmZmVyLmMKQEAgLTEyMzcsNyArMTIzNyw3IEBAIHZvaWQgaW50
...
KGk5MTVfdm1hX2lzX21hcF9hbmRfZmVuY2VhYmxlKHZtYSkpCkBAIC0xMzAyLDcgKzEzMDIsNiBA
...
LTE4MjgsMjEgKzE4MjcsMjUgQEAgc3RhdGljIGludCByaW5nX3JlcXVlc3RfYWxsb2Moc3RydWN0

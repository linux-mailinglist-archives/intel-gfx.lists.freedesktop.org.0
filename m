...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4125D11BC1A
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Dec 2019 19:45:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 054AC6EBB9;
	Wed, 11 Dec 2019 18:45:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CEB896EBB3
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,302,1571727600"; d="scan'208";a="216016732"
Received: from josouza-mobl.jf.intel.com (HELO josouza-MOBL.intel.com)
 ([10.24.8.163])
 by orsmga003.jf.intel.com with ESMTP; 11 Dec 2019 10:45:28 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 11 Dec 2019 10:45:19 -0800
Message-Id: <20191211184526.142413-4-jose.souza@intel.com>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20191211184526.142413-1-jose.souza@intel.com>
References: <20191211184526.142413-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 rebased 04/11] drm/i915: Introduce
...
IGI2ZDM2NGRkM2U0Yy4uYjRlNDRkM2NkMjc1IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
...
QCAtMTA2MjYsOCArMTA2MjUsNiBAQCBzdGF0aWMgYm9vbCBoYXN3ZWxsX2dldF9waXBlX2NvbmZp
...
b3dlcl9kb21haW4gPSBQT1dFUl9ET01BSU5fUElQRShjcnRjLT5waXBlKTsKQEAgLTExNjc1LDYg
KzExNjcyLDIwIEBAIHN0YXRpYyB2b2lkIGlyb25sYWtlX3BjaF9jbG9ja19nZXQoc3RydWN0IGlu
...
ZGVyICplbmNvZGVyKQpAQCAtMTE3MDAsNyArMTE3MTEsNyBAQCBpbnRlbF9lbmNvZGVyX2N1cnJl

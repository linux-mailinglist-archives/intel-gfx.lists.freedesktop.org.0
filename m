...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F8716F8406
	for <lists+intel-gfx@lfdr.de>; Fri,  5 May 2023 15:28:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5791510E076;
	Fri,  5 May 2023 13:28:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6897010E603
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 May 2023 13:28:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683293334; x=1714829334;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=bM6nPu50eHWvEWH5KY54B//qZKBotY7Di7za/umlGhE=;
 b=dU2YLQGWF5gyuaejb/WiZ7ldXPdz36Tkid3B4B7hljiivTkfJBYsSpEe
 P6lVlesfOND0mPeHwmbFryVrcfq989khxyqfHJlQ3PDgUusy4YZeT/e96
 aamnemOGbTeydrzcX9JUK6p45TwbiPv7DV9VA08b3fLnoq9yUTXcWR+M5
 NDbYyTWVB3gFi/AwLf/Fq2lJ0dVU0Uq+F5+eA1FCqWvjPPrdNAOQvAuZt
 AIgeZU4IoU56+EZtOsXPtjFAwYEVShTSs7avhJP5EVhPhUPsvWcC76m+1
 la1Up+8dejnbWyE5IcAPLcr94jHJhXfYk/PXx8AKUvLXsAaLY+0jb1Ssl w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10701"; a="377283922"
X-IronPort-AV: E=Sophos;i="5.99,252,1677571200"; d="scan'208";a="377283922"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2023 06:28:53 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10701"; a="700433287"
X-IronPort-AV: E=Sophos;i="5.99,252,1677571200"; d="scan'208";a="700433287"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.70])
 by fmsmga007.fm.intel.com with SMTP; 05 May 2023 06:28:51 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 05 May 2023 16:28:50 +0300
Date: Fri, 5 May 2023 16:28:50 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
Message-ID: <ZFUEkh-42PjplGtN@intel.com>
References: <ZFTjOncKZ1ZksCSH@intel.com> <ZFTmcR48e6eXPIg6@intel.com>
...
In-Reply-To: <ZFUCzMeHI5UFqfL7@intel.com>

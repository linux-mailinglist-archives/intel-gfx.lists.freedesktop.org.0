...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A19C2804B49
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Dec 2023 08:42:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 907D410E46C;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/display: Check GGTT to determine
 phys_base

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E03F402435
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Sep 2021 09:26:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BB5889D5F;
	Tue,  7 Sep 2021 07:26:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ADC0D89D66
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Sep 2021 07:26:17 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-405-_f40iwlPNAabFOddi_xUGg-1; Tue, 07 Sep 2021 03:26:13 -0400
X-MC-Unique: _f40iwlPNAabFOddi_xUGg-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com
 [10.5.11.13])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 57E97800FF4;
 Tue,  7 Sep 2021 07:26:12 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 123ED6608B;
 Tue,  7 Sep 2021 07:26:10 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Tue,  7 Sep 2021 17:25:34 +1000
Message-Id: <20210907072549.2962226-11-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 10/25] drm/i915/display: move fbc into display
 struct
...
index b1439ba78f67..7dd9aa592a45 100644
...
index 472cd21fc788..5cd93ca2aaa1 100644
...
index b3f47a6308f6..ed559c0fdcc5 100644
...
+=09const struct intel_fbc_reg_params *params =3D &i915->display->fbc.param=
s;
...
-=09struct intel_fbc *fbc =3D &dev_priv->fbc;
+=09=09container_of(work, struct drm_i915_private, _display.fbc.underrun_wo=
rk);
+=09struct intel_fbc *fbc =3D &dev_priv->display->fbc;
=20
...
index 724e7b04f3b6..510eaa7f68c8 100644
...
v.h
index 8daa5a24782f..b94f25eb6ce5 100644

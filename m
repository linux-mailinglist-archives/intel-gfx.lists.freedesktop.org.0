...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FB9917662E
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Mar 2020 22:41:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D9B989CA2;
	Mon,  2 Mar 2020 21:41:57 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 3/9] drm/amdgpu: Remove drm_fb_helper_{add,

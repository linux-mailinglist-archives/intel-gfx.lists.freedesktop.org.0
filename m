...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B24D6E0E0C
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Apr 2023 15:07:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F5B510EAE8;
	Thu, 13 Apr 2023 13:07:45 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 4/6] drm/i915: Switch to fdinfo helper

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34C226D8EEB
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Apr 2023 07:45:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 035C410EADA;
	Thu,  6 Apr 2023 05:44:58 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v6 7/8] drm/i915/pxp: On MTL,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D1A7EBD52E
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Sep 2019 01:00:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9D4A6EB04;
	Tue, 24 Sep 2019 23:00:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CDFF86EB04
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Sep 2019 23:00:49 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga104.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 24 Sep 2019 16:00:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,545,1559545200"; 
 d="gz'50?scan'50,208,50";a="389029450"
Received: from lkp-server01.sh.intel.com (HELO lkp-server01) ([10.239.97.150])
 by fmsmga005.fm.intel.com with ESMTP; 24 Sep 2019 16:00:47 -0700
Received: from kbuild by lkp-server01 with local (Exim 4.89)
 (envelope-from <lkp@intel.com>)
 id 1iCtna-000C9f-Vl; Wed, 25 Sep 2019 07:00:46 +0800
Date: Wed, 25 Sep 2019 06:59:59 +0800
From: kbuild test robot <lkp@intel.com>
To: Manasi Navare <manasi.d.navare@intel.com>
Message-ID: <201909250616.canupTFE%lkp@intel.com>
References: <20190924195007.15870-1-manasi.d.navare@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="7zds7qmcxhsjmj65"
...
H4sICNmWil0AAy5jb25maWcAlDzbctw2su/5iinnJamtJJIlKz67pQcQBDnIEAQNgHPRC0uR
...


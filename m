...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7F4B625B80
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Nov 2022 14:52:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4B9710E170;
	Fri, 11 Nov 2022 13:52:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C370C10E170
 for <intel-gfx@lists.freedesktop.org>; Fri, 11 Nov 2022 13:52:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1668174731; x=1699710731;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=WC8brab0ve63XQW7Jsz9aAruAfSCiFJvtKMpp6BY5UI=;
 b=HYnVIgE/atrES4X4ycritiwcV6KkVkinSQjKItFO9lGPDaiXr+OvblkE
 88az5DQv8UaJSaLydifYj600f2Yx69hBKS/c74892Sk82FQssTCZ9+ieS
 6uG1I10SMbtXN7wvXFqFbNvimz0ukMbcrdRrXvbuYE9S9+rz5IB2x89o0
 ZGgDTISKlBMZHr5tP49oM7D+AGKX1fzZAPBmtFsOJ7ic49JP3Z8+aYgWO
 LWIeE1W4D/7uiAEX6cYo3+DTc+5eV9dUEkYUCkkv0uH4LhIq8IDoDIj++
 c5Wbc7WmpxRQblqE9fdRb9N/wgqmKmd3Y7ro7MjKan2Pam86kJQse1ied A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="338368410"
X-IronPort-AV: E=Sophos;i="5.96,156,1665471600"; d="scan'208";a="338368410"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2022 05:52:11 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="780185554"
X-IronPort-AV: E=Sophos;i="5.96,156,1665471600"; d="scan'208";a="780185554"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.191])
 by fmsmga001.fm.intel.com with SMTP; 11 Nov 2022 05:52:09 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 11 Nov 2022 15:52:08 +0200
Date: Fri, 11 Nov 2022 15:52:08 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <Y25TiP/Lr3xjb5bk@intel.com>
References: <20221107170917.3566758-2-imre.deak@intel.com>
 ...
 <Y25Rmlqq6k2plwsP@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <Y25Rmlqq6k2plwsP@intel.com>

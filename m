...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5E4970E618
	for <lists+intel-gfx@lfdr.de>; Tue, 23 May 2023 21:56:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 708DC10E4C5;
	Tue, 23 May 2023 19:56:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9830110E4C6
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=JQt//fk6yPRCD/CFFtGduPGeh5wNRRzsje60Sov1Srs=;
 b=EjJl/MKogayXh3r+6Zi9wwviHkn+cioGll2SdNNGNo1AnyKnma/nnFds
 WsyLP/ut3V0YTH9Akx6vzoUhQr9i9xc3q0UL/102X6rfyYRLbDjMRoawg
 P2mNHrdtZjBIMz8SHg6bqfOSSSwbbCR8Fy/JRZxOX8SZTLVbE+jfaIuPH
 qjWRyD5m1qAgIB0Fn+HsZwZf4ZKZXhOZKBIeV/1h2jOP9HWQZ765aN0Ox
 G+1LGcMaCaEAJr9x2NDbyxCtCmlUYxxuDDSauMNc8xOHsFz1fKcs61ObK
 R87rnIRzR7XYAS1vSK0F/AzbG5YzyRVdXjht+fmVI8rN9dEcbyb/lOZfi Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10719"; a="353372867"
X-IronPort-AV: E=Sophos;i="6.00,187,1681196400"; d="scan'208";a="353372867"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 May 2023 12:56:23 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10719"; a="681557153"
X-IronPort-AV: E=Sophos;i="6.00,187,1681196400"; d="scan'208";a="681557153"
...
Message-Id: <20230523195609.73627-3-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [CI v3 2/6] drm/i915: Convert INTEL_INFO()->display to
 a pointer
...
index e4a19161afce..bbb675dbc998 100644

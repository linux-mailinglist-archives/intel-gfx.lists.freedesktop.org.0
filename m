...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 638B8153584
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2020 17:46:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 964136F8AB;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v3 10/17] drm/i915: Include DP VSC SDP in
 the crtc state dump

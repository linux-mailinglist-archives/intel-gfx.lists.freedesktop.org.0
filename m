...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F6FA51119B
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Apr 2022 08:48:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 54D4010E502;
	Wed, 27 Apr 2022 06:48:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E203E10E2E7;
 Wed, 27 Apr 2022 06:48:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1651042132; x=1682578132;
 h=message-id:date:mime-version:subject:from:to:cc:
 references:in-reply-to:content-transfer-encoding;
 bh=Wa7ZrIaXVDD+rw39Zeu2BfxDCE6uYq+Y+zwsHMzxhu4=;
 b=WaQrMGtrWUAf4GLYk3wa2iDwn2jwzbm81gtuW+ZA6ZKJxIwdXk2Woa9M
 c/5K/PTmytkm4ABh2jopCkkC71fthTTkTDDuFFP8LkSlITOYLFuiRBqDJ
 4bI02y8WmXCi54r9u83qJrPt5OHo4oJEJrvksyCqYUDXQmZgfn4xfW44K
 o3oOQkW6Yk1tryW1T30eShIJFRtp43VzYMoqIcDowBmUc2+DQDlmqTfhF
 kW8SMw/tylbfsAZNCPfS9Q+rdfSttsX8/HbX9WlABC5Y+6rgm0wENPSV0
 +O16jxw4ITbAcgvKNtDDxIwANY8pIE/OmC+M6V9+XCqp8jFZOMe4h8Bvb A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10329"; a="326325990"
X-IronPort-AV: E=Sophos;i="5.90,292,1643702400"; d="scan'208";a="326325990"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Apr 2022 23:48:51 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,292,1643702400"; d="scan'208";a="875858755"
Received: from linux.intel.com ([10.54.29.200])
 by fmsmga005.fm.intel.com with ESMTP; 26 Apr 2022 23:48:50 -0700
Received: from [10.249.132.123] (bpingot-mobl1.ger.corp.intel.com
 [10.249.132.123])
 by linux.intel.com (Postfix) with ESMTP id 30973580689;
 Tue, 26 Apr 2022 23:48:46 -0700 (PDT)
Message-ID: <a667ccc4-fd5e-7e15-cffc-d5a65a834825@intel.com>
Date: Wed, 27 Apr 2022 09:48:45 +0300
MIME-Version: 1.0
...
In-Reply-To: <5553382d-2674-76f0-ab6e-408b99111a62@intel.com>

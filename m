...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF43A57E386
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Jul 2022 17:12:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 205BD18B6DC;
	Fri, 22 Jul 2022 15:12:40 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3] drm/i915: stop using swiotlb

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0574A67BCEB
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:38:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 24E7710E88E;
...
Subject: [Intel-gfx] [PATCH v3 10/19] dyndbg-API: split
 DECLARE_(DYNDBG_CLASSMAP) to $1(_DEFINE|_USE)

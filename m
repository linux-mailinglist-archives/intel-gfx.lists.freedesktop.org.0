...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC27A5A8FB9
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 09:18:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B323910E61F;
...
Subject: [Intel-gfx] [PATCH v2 05/15] vfio/mdpy: Use the new device life
 cycle helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6D8F2A700
	for <lists+intel-gfx@lfdr.de>; Sat, 25 May 2019 22:43:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4CB906E17E;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 FOFw==
Subject: [Intel-gfx] [PATCH v3 4/5] drm/gma500: drop use of DRM_UDELAY
 wrapper

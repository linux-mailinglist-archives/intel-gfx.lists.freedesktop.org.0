...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 24188CCEBEF
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Dec 2025 08:13:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4F4410EE90;
	Fri, 19 Dec 2025 07:13:22 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="DnODTXWz";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D40E610EE90;
 Fri, 19 Dec 2025 07:13:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1766128400; x=1797664400;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=iaL0y9wji1adzLZb8Ac3dGSEmGlGazY1SZxPua2vaks=;
 b=DnODTXWzf9voRMaCcoeIHL4ypeEhU3GOnKjwWa/3P3R7Lv7ROABA4A8N
 f8TTdAk2OEUi2GlQwCovxaW3VBX/4moQCue3NaYBZ7cV+Pr7Ok0QNhrVm
 9yiN0M3/kQ51PX5GKjUSyJk2UsVIy7CFiKMY2zj2MPtix5uaanXI7iG4G
 h4Z7Izsuckt4y6Zc1JVziOyN7OP79DAeQTahy6HwILN1kN/Cy6Qv9OakU
 riRan4BhS9utK2T1EgDPo4wDU7PGH5uHkqNPHaYoMwYhu0ArIRT5xa6sP
 X90r9dCBGRI5XEMlIwNI+Lh9q0jYvxcz/j9ngpd7eBpE3lVX6GhaS6WqF w==;
X-CSE-ConnectionGUID: vSr1eeMvSdaGw5Nb29c6wA==
X-CSE-MsgGUID: HH9CEX+lQjmQqUSI6/N8Xg==
X-IronPort-AV: E=McAfee;i="6800,10657,11646"; a="93562317"
X-IronPort-AV: E=Sophos;i="6.21,159,1763452800"; d="scan'208";a="93562317"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Dec 2025 23:13:20 -0800
X-CSE-ConnectionGUID: jDHHMH/vSguHwCnw2mInBw==
X-CSE-MsgGUID: KH38aX8jS2aNBL15/4t1sg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,159,1763452800"; d="scan'208";a="222209465"
Received: from dut-2a59.iind.intel.com ([10.190.239.113])
 by fmviesa002.fm.intel.com with ESMTP; 18 Dec 2025 23:13:16 -0800
...
Date: Fri, 19 Dec 2025 12:26:06 +0530
Message-Id: <20251219065614.190834-6-chaitanya.kumar.borah@intel.com>

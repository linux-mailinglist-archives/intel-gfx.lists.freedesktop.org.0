...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3907E195201
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2020 08:29:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C50336E9A8;
	Fri, 27 Mar 2020 07:29:04 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 09/14] drm/i915: Add state readout for DP VSC
 SDP

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B99846A0AFD
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Feb 2023 14:46:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1526C10E4F2;
	Thu, 23 Feb 2023 13:45:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ABEF310EB8F
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=3TwCFy7Bzq38GyUS4zVN0ISbCWvARqYQqR+iFLTKaZs=;
 b=GWUtOTqulZgF6RaGI39I09uLHimg8TJ3gO2kPPwGL0KYeiCmybiOTpU8
 1q9bSOAs+tq5npE81ND6qys/TNcidB7Rfq0Nu0rQ5IX14g5k54WfVPW17
 T5wpclI0pUm8uhoiOeWbdIVAwdHFuB71MIxVlHpXP3yHkKyOp6PLEhUcj
 J9hYrGYcYdGUH7V/7ccQk7C2NSPPQjlMEfGKTDX813HwDNJLxWFMwqcQt
 BfgIgrlN99iQnZgkyY4y+ppJsg4v1/fryOd+EOPYQbs4QxoBx5F7kv1z1
 xTgAnEpWHOSm7jXCrJxz+72pZygAjrGKy1aZHuRIVO+wEGuvpogVI/Dfh A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10630"; a="334581656"
X-IronPort-AV: E=Sophos;i="5.97,320,1669104000"; d="scan'208";a="334581656"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Feb 2023 05:45:51 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10630"; a="846562489"
X-IronPort-AV: E=Sophos;i="5.97,320,1669104000"; d="scan'208";a="846562489"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by orsmga005.jf.intel.com with ESMTP; 23 Feb 2023 05:45:50 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 23 Feb 2023 15:40:10 +0200
Message-Id: <20230223134021.2236889-12-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 11/22] drm/i915/mtl: C20 port clock
 calculation

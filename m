...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 99D7E76DBA5
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Aug 2023 01:35:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9392710E58B;
...
Subject: [Intel-gfx] [PATCH v1 2/3] drm/i915/guc: Close deregister-context

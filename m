...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F15411C120D
	for <lists+intel-gfx@lfdr.de>; Fri,  1 May 2020 14:21:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 376916EC81;
	Fri,  1 May 2020 12:20:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4857F6EC68
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 May 2020 12:20:52 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  1 May 2020 14:20:32 +0200
Message-Id: <20200501122043.2504429-13-maarten.lankhorst@linux.intel.com>
...
index 4311b12542fb..43141d061d97 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3269,7 +3269,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3431,20 +3434,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3452,9 +3458,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3480,8 +3486,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -5246,13 +5254,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -5285,8 +5293,10 @@ static void virtual_context_exit(struct intel_context *ce)
...
index ca7286e58409..a3e9487a50f0 100644
--- a/drivers/gpu/drm/i915/gt/intel_ring_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_ring_submission.c
@@ -1207,6 +1207,10 @@ static void __context_unpin_ppgtt(struct intel_context *ce)
 }
...
@@ -1295,11 +1299,16 @@ static int ring_context_alloc(struct intel_context *ce)
 	return 0;
 }
...
@@ -1308,8 +1317,10 @@ static void ring_context_reset(struct intel_context *ce)

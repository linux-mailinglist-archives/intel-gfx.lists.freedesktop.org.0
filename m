...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FC028303E2
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jan 2024 11:47:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA3F910E674;
	Wed, 17 Jan 2024 10:47:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BAE2210E661;
 Wed, 17 Jan 2024 10:47:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1705488468; x=1737024468;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=tabymZXyTQqeHtfdJ117yFSTD5drmUbuTGg41fo+zmE=;
 b=a3zfc9mnIKZBo99fX9gsouKfKP1pLU+bYD9IeRVCa9/uTrmkOqjxJ/B0
 te6olMEma3h7SBH7cXCw2bG/SoD2uvI6SiTMM8oUcaW1PDFMukSzUW8XI
 wS4FmX7zjp78w2Iy0DF7Lscqw4j8o9sAgWzscnblM6yCdtx2mdZtx6x2s
 nXt8UcysmOL/MBZWQ9YHay7QPkdu9778bqMqVndEvV9x8jBlaLIxkJd7w
 mpsicJnCF9+gaPlDVOu73/HMyShByA0jYeCmqTJYpYrxE1HlxUjCm5jBM
 P2Yas5EKYpNiyJ/2V2naYIhc/y3XfWdCbYdaOpfFQDBj8HLyL6WAUQGfK w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10955"; a="431295092"
X-IronPort-AV: E=Sophos;i="6.05,200,1701158400"; d="scan'208";a="431295092"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2024 02:47:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,200,1701158400"; d="scan'208";a="26447576"
Received: from clanggaa-mobl.ger.corp.intel.com (HELO [10.249.254.57])
 ([10.249.254.57])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2024 02:47:45 -0800
Message-ID: <0049f12e-ce96-4320-8158-c5a23164261f@linux.intel.com>
Date: Wed, 17 Jan 2024 11:47:42 +0100
MIME-Version: 1.0

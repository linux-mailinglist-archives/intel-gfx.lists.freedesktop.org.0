...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA15136DE98
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Apr 2021 19:46:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 985CA6EC06;
	Wed, 28 Apr 2021 17:46:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x62e.google.com (mail-ej1-x62e.google.com
 [IPv6:2a00:1450:4864:20::62e])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 427E26EC06
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 Apr 2021 17:46:20 +0000 (UTC)
Received: by mail-ej1-x62e.google.com with SMTP id u21so95917255ejo.13
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 Apr 2021 10:46:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=jlekstrand-net.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=rwJFD+4AXPBEFuFEtBXlh+ejZVBcRjBhfK1dpTk4tc4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=rwJFD+4AXPBEFuFEtBXlh+ejZVBcRjBhfK1dpTk4tc4=;
 b=
X-Gm-Message-State: AOAM530WVVrrjLuGQCapuzPpo1yCYgjiSX6eZ90fsjFpX5PiCr0PxeED
 wC79MnucTHj5Bj/yb/T2EQ7cYVR9J/N3zv/JyrWUJw==
X-Google-Smtp-Source: ABdhPJy+ml+HyIOQpAxqkoq3w7c+J6I6R4C7o7QcAXZ+ybjsquzyhyjmP0N/n77s769ETkEUWGJVaufy05ccVoZCj/M=
X-Received: by 2002:a17:906:2596:: with SMTP id
 m22mr31005948ejb.175.1619631978644; 
 Wed, 28 Apr 2021 10:46:18 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <20210428171853.GA3260@sdutt-i7>
From: Jason Ekstrand <jason@jlekstrand.net>
Date: Wed, 28 Apr 2021 12:46:07 -0500
Message-ID: <CAOFGe96Qy8hXsJCemgDJtZYCbwqxvUS4j-SEKKnLQjE6dmRP2w@mail.gmail.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 954A57002E3
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 10:42:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2C6F10E65D;
...
Subject: [Intel-gfx] [PATCH 06/11] drm/msm: Use regular fbdev I/O helpers

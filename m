...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36C80C84783
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Nov 2025 11:26:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF78610E3A9;
	Tue, 25 Nov 2025 10:26:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="MfNzVu19";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E180910E3A9
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Nov 2025 10:26:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764066412; x=1795602412;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=M4ryqwRLQtgqqHT7/6qoXeIvgW9pJC0R1Y1Al3BtVdI=;
 b=MfNzVu19qKDHTLy9vLa53mI22Hf3ZMIxGzrHKbPZ7vWChCOqimJgVCT5
 ds93eWiNj+Zy2DXrjwgX3D57GrCdYrAXeQgt8QSjPeRACllS1zwxCECQb
 lVYUt86rVFTRZ4wC4Q+Ygu8Vw3GfZI8vnGO/BM0XswwiGA4VJQytqiWuz
 oayPAtVSwU/PPnZygSJBWc9mHRXA6Zb4+5clvD7sORLZPMhZsgvGB1Uhk
 jqo9ZCefLfIud8QMaYrQ7iy6S0yP3+ufVL+T32YGKD4i8uPOp354cKXFF
 Q1F9BUREOBp0t4OptWjqAltV2RHxFMel5LPYHBlbSLvwLXvIEYLHut43V A==;
X-CSE-ConnectionGUID: lYMu+pfHRR238YS7T6NnfA==
X-CSE-MsgGUID: mQK5BjPBTNa3mLJYZYpVaQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11623"; a="65265097"
X-IronPort-AV: E=Sophos;i="6.20,225,1758610800"; d="scan'208";a="65265097"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2025 02:26:51 -0800
X-CSE-ConnectionGUID: Yt0BW1WrTdCujYgcmsodmg==
X-CSE-MsgGUID: 8GEg0aqASNedzGfcTx+yZw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,225,1758610800"; d="scan'208";a="196766232"
Received: from ettammin-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.213])
 by ORVIESA003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2025 02:26:49 -0800
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>,
 intel-gfx@lists.freedesktop.org
Cc: gregkh@linuxfoundation.org, Daniele Ceraolo Spurio
 <daniele.ceraolospurio@intel.com>, Alexander Usyskin
 <alexander.usyskin@intel.com>
Subject: Re: [PATCH v3 1/2] mei: me: Export the PCI ID list
In-Reply-To: <20251114201431.1135031-5-daniele.ceraolospurio@intel.com>
...
Date: Tue, 25 Nov 2025 12:26:46 +0200
Message-ID: <632d00475a9dc4e878d7145834a70028ab298f95@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 993E13499DF
	for <lists+intel-gfx@lfdr.de>; Thu, 25 Mar 2021 19:59:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B08E6EE1A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH i-g-t 3/5] tests: Remove ddx_intel_after_fbdev

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 95CE73D247D
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Jul 2021 15:21:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B5C06E9FF;
...
Subject: [Intel-gfx] [PATCH 3/3] drm/vmwgfx: fix potential UAF in
 vmwgfx_surface.c

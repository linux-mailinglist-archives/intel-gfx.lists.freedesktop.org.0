...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 12B071532CA
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2020 15:25:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 69C756E9AA;
	Wed,  5 Feb 2020 14:25:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D5846E9B0
 for <intel-gfx@lists.freedesktop.org>; Wed,  5 Feb 2020 14:25:48 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 05 Feb 2020 06:25:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,405,1574150400"; d="scan'208";a="235599379"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 05 Feb 2020 06:25:44 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 05 Feb 2020 16:25:44 +0200
Date: Wed, 5 Feb 2020 16:25:44 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Manasi Navare <manasi.d.navare@intel.com>
Message-ID: <20200205142543.GH13686@intel.com>
References: <20200203074756.10549-1-manasi.d.navare@intel.com>
 <20200203074756.10549-2-manasi.d.navare@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20200203074756.10549-2-manasi.d.navare@intel.com>
...
> @@ -4448,6 +4448,114 @@ static int intel_ddi_compute_config(struct intel_=
encoder *encoder,
>  	return 0;
>  }
>  =
...
> +}
> +
> +static bool crtcs_port_sync_compatible(const struct intel_crtc_state *cr=
tc_state1,
...
r(encoder));
> @@ -4757,6 +4865,7 @@ void intel_ddi_init(struct drm_i915_private *dev_pr=
iv, enum port port)
...
> @@ -12564,126 +12564,6 @@ static bool c8_planes_changed(const struct inte=
...
> @@ -13332,15 +13212,6 @@ intel_crtc_prepare_cleared_state(struct intel_cr=
tc_state *crtc_state)
>  	if (IS_G4X(dev_priv) ||
...
>  	kfree(saved_state);
> @@ -13358,8 +13229,7 @@ intel_modeset_pipe_config(struct intel_crtc_state=
 *pipe_config)
...
> @@ -13431,24 +13301,6 @@ intel_modeset_pipe_config(struct intel_crtc_stat=
e *pipe_config)
...
> @@ -13460,15 +13312,6 @@ intel_modeset_pipe_config(struct intel_crtc_stat=
e *pipe_config)
>  		if (connector_state->crtc !=3D crtc)
>  			continue;
>  =

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E08872045
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Jul 2019 21:58:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7FD2C6E3AC;
	Tue, 23 Jul 2019 19:58:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D6D0B6E31E
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Jul 2019 19:58:24 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17542626-1500050 
 for multiple; Tue, 23 Jul 2019 19:38:46 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 Jul 2019 19:38:41 +0100
Message-Id: <20190723183842.20372-22-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 22/23] drm/i915: Extract intel_frontbuffer
 active tracking
...
L2k5MTUvaTkxNV9kZWJ1Z2ZzLmMKaW5kZXggY2FlZGQ4NjU2MzFkLi44NjI2OWRlNTU1MGEgMTAw
...
ZXggYzg1ZTBkNWFkYWI4Li4wNzUwYzkzMDMwNjEgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
...
L2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCmluZGV4IDg4MGI5YWY1ZjMzNC4uYjlmNjEyODZmNDUy
...
Y3RfdW5sb2NrX2ZlbmNlKG9iaiwgZmVuY2UpOwogCiAJcmV0dXJuIHJldDsKQEAgLTE3NzQsMzkg
KzE3NzYsNiBAQCBpbnQgaTkxNV9nZW1fb3BlbihzdHJ1Y3QgZHJtX2k5MTVfcHJpdmF0ZSAqaTkx

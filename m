...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0EFD5B64C0
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Sep 2022 02:59:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDE5810E4BF;
	Tue, 13 Sep 2022 00:58:19 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 02/15] mei: bus: enable sending gsc commands

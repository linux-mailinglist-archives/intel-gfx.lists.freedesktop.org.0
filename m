...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A309C1BD9CD
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 12:39:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA6F76EE7C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 12/16] drm/i915: Stop using
 mode->private_flags

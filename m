...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C9A31FCF52
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jun 2020 16:17:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 259C26E311;
	Wed, 17 Jun 2020 14:17:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E93B66E126
 for <intel-gfx@lists.freedesktop.org>; Wed, 17 Jun 2020 14:17:07 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21525939-1500050 
 for multiple; Wed, 17 Jun 2020 15:16:59 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 17 Jun 2020 15:16:56 +0100
Message-Id: <20200617141656.24384-12-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/12] drm/i915/gt: Resubmit the virtual engine
 on schedule-out
...
index 6a36939abfab..07a69765b73c 100644
...
+
 		...
 		if (!spin_trylock_irqsave(&rq->lock, flags))
 			continue;
@@ -2317,6 +2338,15 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
index 7f27088ded55..241e65e77889 100644

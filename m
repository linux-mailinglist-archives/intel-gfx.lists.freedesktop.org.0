...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9ECEB6CC5B0
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Mar 2023 17:16:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF4BF10E93A;
	Tue, 28 Mar 2023 15:16:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2586C10E940;
 Tue, 28 Mar 2023 15:16:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680016571; x=1711552571;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=B8YnyvEqmHM+zRWtrOkf33pW+HfMtg0e9gggedrHS/w=;
 b=k1h37HxqwxxCsIBrUuCB60dgb4iLz2J+RQ4XS8ulaNzDO+lb7aJnXW2E
 ORf/vkzGGP8LmYdImlyKr3JDIHKBwUMQrl1CYQwVoV2igASOf7Pav23Xb
 gYUekR3fNdcqBGMfVcjiV3hBQ4/hWxpSBd05WK8ABfjknKozE67lCqb3h
 OiHFz1t55U8+GbaDZMzgKKTA+DWZjEf0+QwMs37Lj93QVmVL9VFk2xZva
 LGeD42bXkfDYF42X/1kwn8XaqyzrCRnws2+ory7sLsJ61eKpN9uPfpqfM
 x2EaGcBdLnBiCcNoI9EtATsuzhPtTnLjQrKD+espjSo+OUgYO14wad79R Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="403208758"
X-IronPort-AV: E=Sophos;i="5.98,297,1673942400"; d="scan'208";a="403208758"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Mar 2023 08:16:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="773181777"
X-IronPort-AV: E=Sophos;i="5.98,297,1673942400"; d="scan'208";a="773181777"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Mar 2023 08:16:06 -0700
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v5 7/8] drm/i915: track gt pm wakerefs

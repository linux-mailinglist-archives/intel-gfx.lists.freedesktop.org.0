...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56CAE28135A
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Oct 2020 15:00:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DEDC66E966;
	Fri,  2 Oct 2020 12:59:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AB2016E95A
 for <intel-gfx@lists.freedesktop.org>; Fri,  2 Oct 2020 12:59:46 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  2 Oct 2020 14:58:50 +0200
Message-Id: <20201002125939.50817-13-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/61] drm/i915: Reject more ioctls for userptr
...
@@ -17354,7 +17354,7 @@ static int intel_user_framebuffer_create_handle(struct drm_framebuffer *fb,
...
@@ -511,6 +511,12 @@ void __i915_gem_object_flush_frontbuffer(struct drm_i915_gem_object *obj,

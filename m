...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DB334766D5D
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jul 2023 14:39:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A200C10E208;
	Fri, 28 Jul 2023 12:39:12 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1A3A610E208;
 Fri, 28 Jul 2023 12:39:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690547951; x=1722083951;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=AP0lfn+zRG8Knby16LQuqwMmdI8oR7V9ksOFjgCUuaM=;
 b=P9u+El43sIaNzUlbRoVTkovbQ4YY9ABHS6K8C6767O6LJBqa0LYSay10
 Mr1qY80cXCCdRfGwBfwFcnSu7/pLupn0tZJOfvf9vCGGRVd8JBos+o9Gn
 uK7WnsnpbPHXLRLLfclK4LeBZ2T8RHBMRwI32AgSKFdBINRU12V0x284N
 x8/jNzPqL92JAqA1H8IjOyzVcJtCSIjGJPbzPlNw20PUd86FOPS6Ajt68
 qUB6ccofV9mNZ+kNLiv5/f2FejosQOoXL7MfPoEflGXefNJ4WnoCJLIs2
 FCXA/WyPicrFjVf1Hwq7QSVNMzIUO7RqeaavnQI3MpMSOOQOhbwzWlfnK g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="366042304"
X-IronPort-AV: E=Sophos;i="6.01,237,1684825200"; d="scan'208";a="366042304"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 05:39:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="797427266"
X-IronPort-AV: E=Sophos;i="6.01,237,1684825200"; d="scan'208";a="797427266"
Received: from atoomey-mobl.amr.corp.intel.com (HELO [10.213.197.30])
 ([10.213.197.30])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2023 05:39:08 -0700
Message-ID: <e8c5a788-72ff-7b63-93af-25a9549ebf91@linux.intel.com>
Date: Fri, 28 Jul 2023 13:39:06 +0100
MIME-Version: 1.0

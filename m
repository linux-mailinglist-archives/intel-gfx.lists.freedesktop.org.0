...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04A2170BDA3
	for <lists+intel-gfx@lfdr.de>; Mon, 22 May 2023 14:22:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86B6110E327;
...
Subject: [Intel-gfx] [PATCH v3 04/12] drm/gma500: Use regular fbdev I/O
 helpers

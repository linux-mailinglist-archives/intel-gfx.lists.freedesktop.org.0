...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D853FA21D91
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jan 2025 14:11:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 628D310E7F8;
	Wed, 29 Jan 2025 13:11:21 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="GYx+Zz+J";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9E7DE10E7F5;
 Wed, 29 Jan 2025 13:11:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1738156279; x=1769692279;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=0eqoW0XNXLDQoN1wgGICS1K3wg5TFZEOaRZETfhtYFs=;
 b=GYx+Zz+J7O+Od/iwX4f92lPYKtGbjOIAsbYuEVjGCX8JXeJPPoXcZw2Z
 B+zL6yJN4O27rl+hJk4Sjmv6kmM5+m6+tkA7dGloOru6Et/Me2k/Bk1p3
 vTFru3rlJclVDenfgjv6emhC+jqgVxDiNvowsALufyaifcQHDfvWkX+ZI
 nIOk7HSrKRQEIpdGGpn5CpEP7jghsjqwgZMbBNfDe3o8STVDd8dkwysVf
 4YJ7AlJqrtuHTV1q8IlacvHzi0oXB3dLBjI+hK+ETU+B3YIz0UrHrzLrZ
 tVqB3DogLVdIefFmR52J98iF4NYC+zVTiKVr2BBPQMbXkcWk6JhoRB8wN g==;
X-CSE-ConnectionGUID: wt+Jub+UTh+tHFSRZdmLzA==
X-CSE-MsgGUID: yLluh1JvS5StIgJ+m29tdg==
X-IronPort-AV: E=McAfee;i="6700,10204,11329"; a="37911559"
X-IronPort-AV: E=Sophos;i="6.13,243,1732608000"; d="scan'208";a="37911559"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jan 2025 05:11:18 -0800
X-CSE-ConnectionGUID: rBNm2f96TkqKGRT9kr16uA==
X-CSE-MsgGUID: 9xXdClLeSsSvZw9XcJtf8A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="114010027"
Received: from unknown (HELO sorvi2.fi.intel.com) ([10.237.72.194])
 by orviesa003.jf.intel.com with ESMTP; 29 Jan 2025 05:11:17 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: imre.deak@intel.com,
	Mika Kahola <mika.kahola@intel.com>
Subject: [PATCH 1/2] drm/i915/display: Drop crtc_state from C10/C20 pll
 programming
Date: Wed, 29 Jan 2025 15:01:04 +0200
Message-ID: <20250129130105.198817-2-mika.kahola@intel.com>

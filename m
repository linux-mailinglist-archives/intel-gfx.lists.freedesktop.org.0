...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 581A7437210
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Oct 2021 08:47:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94C576E4AB;
...
Subject: Re: [Intel-gfx] [PATCH v2 02/17] drm/i915/xehpsdv: set min
 page-size to 64K

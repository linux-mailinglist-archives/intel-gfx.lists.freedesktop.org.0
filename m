...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A411153F9A
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Feb 2020 09:00:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B339C6F9DE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 05/12] drm/i915/crt: automatic conversion to

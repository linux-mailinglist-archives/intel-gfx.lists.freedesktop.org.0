...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2383935DE4E
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Apr 2021 14:11:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DA2589CF8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 2/5] drm/connector: Add helper to compare HDR
 metadata

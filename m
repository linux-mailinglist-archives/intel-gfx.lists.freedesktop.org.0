...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACCAB52CEFB
	for <lists+intel-gfx@lfdr.de>; Thu, 19 May 2022 11:08:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3ED0E11B11B;
...
Subject: [Intel-gfx] [PATCH 5/7] Revert "drm/i915: Drop has_reset_engine
 from device info"

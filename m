...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D89242037AD
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Jun 2020 15:16:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDE476E544;
	Mon, 22 Jun 2020 13:16:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x842.google.com (mail-qt1-x842.google.com
 [IPv6:2607:f8b0:4864:20::842])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DC1736E483
 for <intel-gfx@lists.freedesktop.org>; Sun, 21 Jun 2020 17:46:50 +0000 (UTC)
Received: by mail-qt1-x842.google.com with SMTP id x62so7685050qtd.3
 for <intel-gfx@lists.freedesktop.org>; Sun, 21 Jun 2020 10:46:50 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=lca.pw; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:content-transfer-encoding:in-reply-to;
 bh=Xh5z1nlb8fAayW90tIcDfCk282hhuyOiml8yhfGFpUY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :in-reply-to;
 bh=Xh5z1nlb8fAayW90tIcDfCk282hhuyOiml8yhfGFpUY=;
 b=
X-Gm-Message-State: AOAM532LdVn+C68y41TiNGIil4kZqQJTPxHdT0V89EGZ62Xixi+Sy0Ks
 XqjH62eNM4T6j5PPGYWmi52DEQ==
X-Google-Smtp-Source: ABdhPJyQU0N5biopapodNoAWbAXXkos89kzE/YUHWe9cozegm0Ryr45CTc371q5ZxEwqvOju/Msb7g==
X-Received: by 2002:ac8:748:: with SMTP id k8mr13291993qth.122.1592761609799; 
 Sun, 21 Jun 2020 10:46:49 -0700 (PDT)
Received: from lca.pw (pool-71-184-117-43.bstnma.fios.verizon.net.
 [71.184.117.43])
 by smtp.gmail.com with ESMTPSA id u16sm12079728qkm.107.2020.06.21.10.46.48
...
References: <20200604081224.863494-1-daniel.vetter@ffwll.ch>
 ...
 <CAKMK7uGbf=OAWWtZMwoaioDKHA_DUyVNiJU4ORbijzUcn+u+Mw@mail.gmail.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <CAKMK7uGbf=OAWWtZMwoaioDKHA_DUyVNiJU4ORbijzUcn+u+Mw@mail.gmail.com>
...
> > [  191.667607][  T369]                                lock(&xfs_nondir_=
ilock_class);
...
> > [  191.812198][  T369]  #0: ffffffffb50ced00 (fs_reclaim){+.+.}-{0:0}, =
at: __fs_reclaim_acquire+0x0/0x30
> > [  191.854319][  T369]  #1: ffffffffb5074c50 (shrinker_rwsem){++++}-{3:=
3}, at: shrink_slab+0x219/0x4b0
> > [  191.896043][  T369]  #2: ffff8890279b40e0 (&type->s_umount_key#27){+=
+++}-{3:3}, at: trylock_super+0x11/0xb0
> > [  191.940538][  T369]  #3: ffff889027a73a28 (&pag->pag_ici_reclaim_loc=
k){+.+.}-{3:3}, at: xfs_reclaim_inodes_ag+0x135/0xb00
> > [  191.995314][  T369]
> > [  191.995314][  T369] stack backtrace:
> > [  192.022934][  T369] CPU: 42 PID: 369 Comm: kswapd3 Not tainted 5.8.0=
-rc1-next-20200621 #1
> > [  192.060546][  T369] Hardware name: HP ProLiant BL660c Gen9, BIOS I38=
 10/17/2018
...
> > > -             lock_map_acquire(&__mmu_notifier_invalidate_range_start=
_map);
> > > -             lock_map_release(&__mmu_notifier_invalidate_range_start=
_map);
...
> > >               /*
> > >                * kmalloc cannot be called under mm_take_all_locks(), =
but we

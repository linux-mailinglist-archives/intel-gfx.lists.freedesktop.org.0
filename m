...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 193702577DC
	for <lists+intel-gfx@lfdr.de>; Mon, 31 Aug 2020 13:02:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BEEA89FF6;
...
Subject: Re: [Intel-gfx] [PATCH v8 04/17] pwm: lpss: Add range limit check
...
Content-Type: multipart/mixed; boundary="===============0481786612=="

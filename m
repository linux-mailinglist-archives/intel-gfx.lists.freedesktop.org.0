...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 442056867EB
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Feb 2023 15:03:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 781E310E149;
	Wed,  1 Feb 2023 14:03:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0CC0910E149
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 Feb 2023 14:03:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675260230; x=1706796230;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=qVz8E/7nn0d5ALfMbZMLU3nx8zTzomcba6R6UJT0iU0=;
 b=XVdlRRD+x0kp2d9doXY9XQu2fqJncs5osLl9eXYT7IP4le3eyPEGkBuf
 zstaxg1656tg5BY4aLWWTQKAitiguQqHTIQezxAWiS/026FPFRkhjIRBG
 95M2a6wP6Jm9QSSJX1fooAoieou48EQsW5Yq3cbM081SBLkP25264Pc8n
 OObFegjOzQrg3ZPcAsf6upZXAgOdNv61qIRqpx0zmzwIimJ9qlcp9H0O/
 NHum+24H3GWdP+9Clqb0UF5qtHZQuWyErMxLfxbvb+tUXicWsskaGvBoW
 yxtt+bJg095fn/MW8skR8VOwM+vdWamDjOtD0FcjHtPI3LW4aOoE+AIax g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="308488888"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="308488888"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 06:03:49 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="788897406"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="788897406"
Received: from ideak-desk.fi.intel.com ([10.237.72.58])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 06:03:47 -0800
Date: Wed, 1 Feb 2023 16:03:44 +0200
From: Imre Deak <imre.deak@intel.com>
To: Jani Nikula <jani.nikula@linux.intel.com>
Message-ID: <Y9pxQIFYu+vmufVI@ideak-desk.fi.intel.com>
References: <20230131150548.1614458-1-imre.deak@intel.com>
 <20230131150548.1614458-18-imre.deak@intel.com>
 <87cz6t3ep0.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <87cz6t3ep0.fsf@intel.com>

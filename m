...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 142C94D59CE
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Mar 2022 05:48:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B2CB10E29C;
...
Subject: [Intel-gfx] [PATCH 1/5] dyndbg: fix static_branch manipulation

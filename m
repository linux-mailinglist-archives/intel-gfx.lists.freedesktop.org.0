...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E6DB31091E8
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Nov 2019 17:35:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36AB86E150;
	Mon, 25 Nov 2019 16:35:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
 [205.139.110.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9D4626E150
 for <intel-gfx@lists.freedesktop.org>; Mon, 25 Nov 2019 16:35:04 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=redhat.com; 
 s=mimecast20190719; t=1574699703;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=UEl7guTW8sLWw4hnEJMV973DykWnJO6h4KmcaCM/N+o=;
 b=F1ueHIsWgEYoJwA6UOPRiNX2/CQ5p2qnFLGCRl3Xdxxav1P4ZyZkQ1+/KYiSvyLzM6DJAc
 NOAZO6kccOeju1WYlK/YF3vVwBylNIgAVAZ4WaoNop0xIRDm9ewN26Rzn/UVI0JPYcoo12
 P+pZWWMXWwQ5MTyF8vqP1Hxc6R/NlEw=
Subject: Re: [Intel-gfx] [RFC 06/13] drm/i915/svm: Page table mirroring
 support

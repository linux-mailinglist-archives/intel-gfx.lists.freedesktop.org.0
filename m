...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36AC8665703
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Jan 2023 10:11:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B46B10E2B1;
...
Subject: Re: [Intel-gfx] [PATCH v3 3/4] drm/amdgpu: Clean up page shift

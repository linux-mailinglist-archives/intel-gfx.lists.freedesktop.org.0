...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A12CB36733C
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Apr 2021 21:13:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 404136E9B1;
	Wed, 21 Apr 2021 19:13:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qk1-x731.google.com (mail-qk1-x731.google.com
 [IPv6:2607:f8b0:4864:20::731])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 488D36E9B1;
 Wed, 21 Apr 2021 19:13:35 +0000 (UTC)
Received: by mail-qk1-x731.google.com with SMTP id z2so6943509qkb.9;
 Wed, 21 Apr 2021 12:13:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=t2RYCxS5MrnHWyUf5/+n6R469QKcG0iz1X5+Z3qb0Ts=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=t2RYCxS5MrnHWyUf5/+n6R469QKcG0iz1X5+Z3qb0Ts=;
 b=
X-Gm-Message-State: AOAM5316A6rLw5gCT+4t5enp+8mr0CoaJyCAa4UiCw7Si3nLGQbZaC7u
 3e1YKxNq/QtvQ+/xKExzIpDTaQqTf52LZ2fYyZJlSap7dLA=
X-Google-Smtp-Source: ABdhPJzhRYjrJw1ZZ1gw5ji+vvSEVxOvp9rUmMR+hsSrOkHV419LbjXDM5VD0S5HcUidEgYRbycWTIAxfH7jlu+aaS8=
X-Received: by 2002:a37:58c5:: with SMTP id
 m188mr24090442qkb.327.1619032414259; 
 Wed, 21 Apr 2021 12:13:34 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <0be7012c-c889-c5c5-6624-2f63b9daf46b@linux.intel.com>
From: Matthew Auld <matthew.william.auld@gmail.com>
Date: Wed, 21 Apr 2021 20:13:07 +0100
Message-ID: <CAM0jSHMBTFuO8Th6NDQpGhzr9XtP_zczKSjDiD3Q5onV5MLdYA@mail.gmail.com>

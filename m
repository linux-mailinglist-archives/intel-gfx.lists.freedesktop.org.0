...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0AB382EC697
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Jan 2021 00:12:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 04F436E329;
	Wed,  6 Jan 2021 23:12:26 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 30CD96E314
 for <Intel-gfx@lists.freedesktop.org>; Wed,  6 Jan 2021 23:12:24 +0000 (UTC)
IronPort-SDR: jGnNn5G9MPTKUBq1v+ZEvTfai9ALlvFBQ5s5yosOgUz+zsp6TS2vQQJXnC92wUa1qrY5lUl3q+
 KReLM4tvva9A==
X-IronPort-AV: E=McAfee;i="6000,8403,9856"; a="195900069"
X-IronPort-AV: E=Sophos;i="5.79,328,1602572400"; d="scan'208";a="195900069"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jan 2021 15:12:23 -0800
IronPort-SDR: YcUlAl4r2OpCQSbxFzYxB7ZXHq/8AA/yrIDDl90HFGATPaOz2wEsjFPgVG+uevH5yMkVYlB4Gp
 GyvyUlFFNI0Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.79,328,1602572400"; d="scan'208";a="567566122"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga006.fm.intel.com with ESMTP; 06 Jan 2021 15:12:23 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed,  6 Jan 2021 15:12:14 -0800
Message-Id: <20210106231223.8323-5-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210106231223.8323-1-sean.z.huang@intel.com>
References: <20210106231223.8323-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v19 04/13] drm/i915/pxp: Create the arbitrary
 session after boot
...
+	struct intel_pxp *pxp = &i915->gt.pxp;
 	...
 	if (!i915 || !tee_kdev || !data)
 		return -EPERM;
@@ -80,6 +108,19 @@ static int i915_pxp_tee_component_bind(struct device *i915_kdev,
...
@@ -135,3 +176,35 @@ void intel_pxp_tee_component_fini(struct intel_pxp *pxp)

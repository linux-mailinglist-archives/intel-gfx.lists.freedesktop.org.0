...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 071CF40C670
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 15:30:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A4056E934;
...
Subject: Re: [Intel-gfx] [PATCH v9 03/17] drm/i915/pxp: define PXP device
 flag and kconfig

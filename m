...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 30BD823AE81
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Aug 2020 22:56:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E8CF6E2D8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5] drm/kmb: Add support for KeemBay Display

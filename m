...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75DAF768898
	for <lists+intel-gfx@lfdr.de>; Sun, 30 Jul 2023 23:58:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5244410E13F;
...
Subject: [Intel-gfx] [PATCH 0/5] drm_dbg: add trailing newlines where missing

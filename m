...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 304F9599165
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Aug 2022 01:44:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2DCF10E595;
...
Subject: [Intel-gfx] [PATCH v2 18/21] drm/i915/mtl: Reuse adl-p DBUF
 calculations

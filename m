...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF1A416C41E
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Feb 2020 15:38:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E959F6EAFE;
	Tue, 25 Feb 2020 14:38:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 137416EAF7
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Feb 2020 14:38:30 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Feb 2020 15:38:07 +0100
Message-Id: <20200225143824.1858038-3-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/20] drm/i915: Separate lookup and pinning in
 execbuf.
...
index 88e4fb8ac739..567dc7106286 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1824,12 +1824,6 @@ int i915_gem_object_unbind(struct drm_i915_gem_object *obj,

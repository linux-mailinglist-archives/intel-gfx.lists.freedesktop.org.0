...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3637861056F
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Oct 2022 00:13:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 498CB10E055;
...
Subject: [Intel-gfx] [PATCH 1/5] drm/i915/mtl: add initial definitions for
 GSC CS

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B887B6E3CAF
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Apr 2023 00:47:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E761710E03C;
	Sun, 16 Apr 2023 22:47:32 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3] drm/i915: Make IRQ reset and postinstall
 multi-gt aware

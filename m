...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 03654566938
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Jul 2022 13:31:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7DD8110EF13;
...
Subject: [Intel-gfx] [PATCH v3 2/2] vfio: Replace the iommu notifier with a
 device list

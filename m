...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80786ADFDB1
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Jun 2025 08:39:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 08DDF10E9A7;
	Thu, 19 Jun 2025 06:39:23 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="HppjF6WZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C865510E12B
 for <intel-gfx@lists.freedesktop.org>; Thu, 19 Jun 2025 06:39:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1750315161;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type;
 bh=p5enKuiqyRGMmsEPAdTXolzNCfuZy/BY1RSK8455g0s=;
 b=HppjF6WZRuKCsonUilYmGvKpZLPl5X8vwJXa1jVtZ3Q17YV/jdlrUr99gdUuY6QoZhA99P
 FgcuIu6kxiQeIUQZvJkFuyHMSxGBz9UswOrKQRByYl1Q3sNJSSdI4UjGfturGZ4Uddc8g9
 /e1ve5Y/LjtNQJvQc26vkeYQ+ymjCLM=
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 [209.85.128.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-122-AkfsQN7GOUmr0WvxWx-vCw-1; Thu, 19 Jun 2025 02:39:18 -0400
X-MC-Unique: AkfsQN7GOUmr0WvxWx-vCw-1
X-Mimecast-MFC-AGG-ID: AkfsQN7GOUmr0WvxWx-vCw_1750315157
Received: by mail-wm1-f72.google.com with SMTP id
 5b1f17b1804b1-45311704d22so2395725e9.2
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Jun 2025 23:39:18 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1750315157; x=1750919957;
 h=content-disposition:mime-version:message-id:subject:cc:to:from:date
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=p5enKuiqyRGMmsEPAdTXolzNCfuZy/BY1RSK8455g0s=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXC4oM/bInvX7zYFcbJ2svMVBLV6S3nq85zrLYwbUJ8spcj8gJCnCrBa7sFPaNlPBShRES53ntSiBs=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YyAZESjH92rHB67okui4Su7r/CudcDhi4BxSSPQCBNph5i9rOpF
 G32RxX4R12ikDNQU4NbvflR9vjyoNMjh5S75orVZPaZtUMiNu4PCU66hDv/UfsPQIez+tKkOiQC
 Vawd2nMFgJN97i7D+2MSUA28hzYsQnFnKGTfpnWAw+ipHkPJ7o+cxMdqJCMVg3KiW2lv86A==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:529b:b0:43d:97ea:2f4 with SMTP id
 5b1f17b1804b1-4533caf5b1amr190948715e9.12.1750315157194; 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 598C67EB430
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Nov 2023 16:52:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74E2910E454;
...
Subject: [Intel-gfx] [PATCH v6 0/2] Resolve suspend-resume racing with GuC

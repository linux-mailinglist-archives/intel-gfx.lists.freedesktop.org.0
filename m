...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 144ED4FBEAB
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:15:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7683C10EDCA;
...
Subject: [Intel-gfx] [PATCH 25/34] drm/i915/gvt: streamline intel_vgpu_create

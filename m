...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E29E648DE0B
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jan 2022 20:14:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2A6C10E288;
	Thu, 13 Jan 2022 19:14:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5327410E23E
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Jan 2022 19:14:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 +w+5Z81ks8rv4U9XL6H+VNOIxiGZ/gFaKM7GZ26kbPdRtf7qLNIbX17T7 w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10226"; a="242909928"
X-IronPort-AV: E=Sophos;i="5.88,286,1635231600"; d="scan'208";a="242909928"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jan 2022 11:14:16 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,286,1635231600"; d="scan'208";a="529794538"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(366004)(53546011)(186003)(82960400001)(6506007)(26005)(66946007)(6486002)(8676002)(66476007)(83380400001)(66556008)(5660300002)(36756003)(2906002)(6512007)(54906003)(316002)(4326008)(31686004)(86362001)(2616005)(38100700002)(31696002)(6666004)(508600001)(8936002)(45980500001)(43740500002);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 13 Jan 2022 19:14:14.3335 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/display/adlp: Implement new step
 in the TC voltage swing prog sequence

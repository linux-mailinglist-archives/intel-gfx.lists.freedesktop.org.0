...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A31AD50DF8A
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Apr 2022 13:57:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 793D110E59C;
	Mon, 25 Apr 2022 11:57:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 4/4] drm/i915/selftest: Clear the output

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D5341BD7D3
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 11:02:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 688966ECE6;
	Wed, 29 Apr 2020 09:02:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7A2C96EC4D
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 09:02:49 +0000 (UTC)
IronPort-SDR: R4bX142/k1RfJXDPcuVF7IsHP2qppF5zFpLMKDTsjtZC35VqeHeQVfTObY2jrU5zSNPUN3sKF/
 cfys5z+LfIQg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Apr 2020 02:02:49 -0700
IronPort-SDR: f6797HHtUd2aX3GtdDINYd5iNzz3MYh6OLq48n7FXvcHxW/LFFC4LBDM9+pIiYTxATD6M9Igvh
 jZHlj9WqEAvw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,331,1583222400"; d="scan'208";a="246784837"
Received: from unknown (HELO delly.ger.corp.intel.com) ([10.252.38.205])
 by orsmga007.jf.intel.com with ESMTP; 29 Apr 2020 02:02:47 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 12:02:40 +0300
Message-Id: <20200429090242.978170-3-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 2/4] drm/i915/perf: stop using the kernel
 context

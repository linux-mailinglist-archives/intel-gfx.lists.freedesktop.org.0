...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A0175B6468
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Sep 2022 01:55:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C74310E44D;
...
Subject: [Intel-gfx] [PATCH 1/1] drm/i915/uc: Fix issues with overriding
 firmware files

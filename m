...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3AED6FBB92
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 01:52:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8DEBC10E160;
	Mon,  8 May 2023 23:51:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7A80D10E160;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=GUPMFc8rD2tF1qWUBCbeqs3xnS8XjP/Md9pdAh/dyCMO97E6Xgi+mKgu
 cokFOF+ZigqtvCbbGdnIjxMmEO4n0x7lEh3/ce9jd8TGIqo9noIMNi9hl
 UMQHHOqb+CcOCZZT7cVmQW2pkjhcD0x8lBsw+rg7hZ/AJPajbnhjXrgj4
 D3mS7Nc/BSwwFcQqtBcYuzNdgjVWupI2SXFeE3MpdeebPX7FGVjpwhqF2
 C7O3IkLE9zQRFiHElh4tKDVElC78c02bFg0crDB1ZSCfwUpkjtt7kDoQ7
 qP0TBTT4mIqROIaZIRTYbgsrDUnewO/QatZl4oaUtxmilBag18EPdwE68 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="348605478"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="348605478"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:51:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="701613517"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="701613517"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:51:54 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  8 May 2023 16:52:47 -0700
Message-Id: <20230508235250.4028749-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 1/4] drm/i915: preparation for using PAT index

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E83FD337E41
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Mar 2021 20:36:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 084BB6EBFB;
	Thu, 11 Mar 2021 19:35:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AD3676EBFB
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 Mar 2021 19:35:56 +0000 (UTC)
IronPort-SDR: BS1K7eQJwdE2DRjkHSuiNY7A80WFJmZYnI1mXRKbOfxnokhSiPJTHepEXHvu/3Njp9qFRBKeCG
 xUWfaQxzG+bQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9920"; a="188766986"
X-IronPort-AV: E=Sophos;i="5.81,241,1610438400"; d="scan'208";a="188766986"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2021 11:35:41 -0800
IronPort-SDR: 3tZ5N97dyL9icDMeu7NJfly+EkU1CICnBJMv8tivCpXW1BQStYYL6OHkUXQUjyWQO6xwX7fjBH
 zq9Bt0/Oqq+A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,241,1610438400"; d="scan'208";a="409598106"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.171])
 by orsmga007.jf.intel.com with SMTP; 11 Mar 2021 11:35:38 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 11 Mar 2021 21:35:38 +0200
Date: Thu, 11 Mar 2021 21:35:38 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <YEpxCuCsH0JGZ82q@intel.com>
References: <20210310221736.2963264-1-imre.deak@intel.com>
 <20210310221736.2963264-18-imre.deak@intel.com>
 <YEpRmUdd5NNdxxrL@intel.com>
 <20210311190413.GH2970909@ideak-desk.fi.intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20210311190413.GH2970909@ideak-desk.fi.intel.com>
...
> > > Add a new intel_fb_plane_remap_info() that can be used by a new remap=
ped
...
> > > @@ -574,66 +576,6 @@ static u32 calc_plane_aligned_offset(const struc=
t intel_framebuffer *fb, int col
> > >  	return offset / tile_size;
> > >  }
> > >  =

> > > -/*
> > > - * Setup the rotated view for an FB plane and return the size the GT=
T mapping
> > > - * requires for this view.
> > > - */
> > > -static u32 setup_fb_rotation(int plane, const struct intel_remapped_=
...
> > > @@ -665,6 +607,66 @@ static unsigned int plane_view_tile_rows(const s=
truct intel_framebuffer *fb, int
> > >  	return DIV_ROUND_UP(y + dims->height, dims->tile_height);
> > >  }
> > >  =

> > > +static u32 calc_plane_remap_info(const struct intel_framebuffer *fb,=
 int color_plane,
...
> > > +	gtt_remap_info->width =3D DIV_ROUND_UP(x + dims->width, dims->tile_=
width);
> > > +	gtt_remap_info->height =3D plane_view_tile_rows(fb, color_plane, di=
ms, y);
> > > +	gtt_remap_info->stride =3D plane_view_stride_tiles(fb, color_plane,=
 dims);
> > =

> > I would keep offset and stride next to each other like in the other pla=
ce
...
> > > +		plane_remap_info->pitch =3D pitch_tiles * tile_width * drm_fb->for=
mat->cpp[color_plane];
> > > +	}
> > > +
> > > +	/*
...
> > >  				  const struct fb_plane_view_dims *dims,
> > >  				  int x, int y)
> > > @@ -734,21 +736,17 @@ int intel_fill_fb_info(struct drm_i915_private =
*i915, struct drm_framebuffer *fb
> > >  =
...
> > > -			plane_info.stride =3D plane_view_stride_tiles(intel_fb, i, &view_=
dims);
> > > -			plane_info.width =3D DIV_ROUND_UP(x + width, view_dims.tile_width=
);
> > > -			plane_info.height =3D plane_view_tile_rows(intel_fb, i, &view_dim=
s, y);
> > > -
...
> > > -						  fb);
> > > +			gtt_offset_rotated +=3D calc_plane_remap_info(intel_fb, i, &view_=
dims,
...
> > > @@ -772,10 +770,8 @@ static void intel_plane_remap_gtt(struct intel_p=
...
> > >  	u32 gtt_offset =3D 0;
> > > @@ -804,20 +800,19 @@ static void intel_plane_remap_gtt(struct intel_=
...
> > > @@ -827,49 +822,18 @@ static void intel_plane_remap_gtt(struct intel_=
plane_state *plane_state)
> > >  =
...
> > > -			plane_state->color_plane[i].stride =3D pitch_tiles * tile_width *=
 cpp;
> > > -		}
> > > -
> > > -		/*

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3BC46A4A2E
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Feb 2023 19:46:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1120D10E4A6;
	Mon, 27 Feb 2023 18:46:53 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 02/19] vfio: Refine vfio file kAPIs for
 KVM

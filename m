...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 60DD0502C4B
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Apr 2022 17:04:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 841E010E1AA;
	Fri, 15 Apr 2022 15:04:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E438810E08B
 for <intel-gfx@lists.freedesktop.org>; Fri, 15 Apr 2022 15:04:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1650035040; x=1681571040;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=QRHh1ImysLFLqJ5IOc/1k+cp4h0oQ1R1BlTSUopViB0=;
 b=gHLDRpqDnA0rVZAZTGiO2a69Riqo46uCTY9xvzsDoxoTq6DrUAOgXHEN
 VtsJhkkZPv6XCvJ6E7vh8zOEwPxdiTQV9BSC/uOT4WnvurtiOpqWvVGSQ
 KvAa7tetoJKFNsuVvzmlIEif218/gZSpA3AWG6y+tyzFzENl3l+Yucnkc
 k7xOUTYvLA6uDCB1hilD/DP0tbrF7PYhlB74VMhNCm5GpDqMsw2zG3A2A
 QssvVJsUXIQhHyFkl9jOHGtbr0vZWL36AwTm2p4z2bqVpuWuADhXiOA7G
 ygpHmJSvIAj4S2x9JZPeRJYjWkaXBdHHvGDeEG0oJ2BGN4H2uuk4ZI10O Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10317"; a="260761193"
X-IronPort-AV: E=Sophos;i="5.90,262,1643702400"; d="scan'208";a="260761193"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2022 08:04:00 -0700
X-IronPort-AV: E=Sophos;i="5.90,262,1643702400"; d="scan'208";a="646081179"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2022 08:04:00 -0700
Date: Fri, 15 Apr 2022 08:03:58 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Message-ID: <YlmJXtDYbl+vMhi9@mdroper-desk1.amr.corp.intel.com>
References: <20220414192230.749771-1-matthew.d.roper@intel.com>
 ...
 <YlmG6v0XrbrxdDno@mdroper-desk1.amr.corp.intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <YlmG6v0XrbrxdDno@mdroper-desk1.amr.corp.intel.com>
...
On Fri, Apr 15, 2022 at 07:53:31AM -0700, Matt Roper wrote:
...
Series applied to drm-intel-gt-next.  Thanks Francisco for the review.

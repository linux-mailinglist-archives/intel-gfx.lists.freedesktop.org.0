...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ADA71191E8A
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2020 02:20:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5C666E584;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 1/2] drm/dp: DRM DP helper for reading Ignore
 MSA from DPCD

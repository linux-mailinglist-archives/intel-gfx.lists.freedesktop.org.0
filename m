...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A9F3A6BD020
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 13:56:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D53D10ECCC;
...
Subject: [Intel-gfx] [PATCH v7 11/22] vfio: Make vfio_device_first_open() to

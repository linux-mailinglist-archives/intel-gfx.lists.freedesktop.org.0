...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10C2CBDD1F0
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Oct 2025 09:35:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74A5D10E72F;
	Wed, 15 Oct 2025 07:35:42 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VzgVoHBM";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9803910E72A;
 Wed, 15 Oct 2025 07:35:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1760513740; x=1792049740;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=SuaNtrCwDY46BRKQvoLxUC5c8VLhvyF1UEyOt49kRt4=;
 b=VzgVoHBM9O61kX8HSZ0ogz56fCrnt9FivgHHa2pGO6xYAnYPdYL6yZl+
 16fzfXWI2dfc4l9Nnl2jpljBKNyUsuMQOv5hxPqiue2P59BV0nfjGuJhc
 O7dvpAglWzaBKHwpWQi4a224GY/rVts6KqdPsh1LJbVIuUJbHN7Z8aW2A
 INsg6NV3XKbBUQcHEZiqOv5Kufoa3n2T4ybBe2z5sQKfwOBy4wBrMK6mD
 h3GNb/RHRTeW9smCPv9l57tAk14mF1r0g2BWOKXRARlbUvvbSOgxdj0Oq
 PNCJk74cZ8/2kvMedBvpd7GRe3mWc9L3w40WkqQrovhotdvchRdrWmDDr A==;
X-CSE-ConnectionGUID: GVrQiJFeQQSBZhkdoglJjg==
X-CSE-MsgGUID: 7b6nHuyDQ2mZbyTxBmD+SA==
X-IronPort-AV: E=McAfee;i="6800,10657,11582"; a="62573629"
X-IronPort-AV: E=Sophos;i="6.19,230,1754982000"; d="scan'208";a="62573629"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Oct 2025 00:35:40 -0700
X-CSE-ConnectionGUID: iJSycXRfT1eqXUpgwESKrw==
X-CSE-MsgGUID: NxnH0+MISzyGUheKAP5Ujw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,230,1754982000"; d="scan'208";a="182882329"
...
Date: Wed, 15 Oct 2025 12:52:14 +0530
Message-ID: <20251015072217.1710717-8-ankit.k.nautiyal@intel.com>

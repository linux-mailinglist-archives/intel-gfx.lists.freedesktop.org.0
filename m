...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 66C8E5EE387
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Sep 2022 19:52:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBC0710E52D;
	Wed, 28 Sep 2022 17:52:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A440710E517;
 Wed, 28 Sep 2022 17:52:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664387556; x=1695923556;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=X6f3iXBgD9yEONX+d7t5ZDaLccatG443cJ/hnFshW9I=;
 b=iUy5Szu/6BKU66D4GO+DrwXqTKqWvvFT4M9H3fzZwzTz4+HHkunEFT17
 2pu4KKEJnhg6oe9S3E7aCE6EuazAGLwTeFRqiBw16nH0abDaNHyz2jmfx
 LcgYRPLj5dVAS7VkM8qZLffnH6jWlmbNLxx26BgGUS90vzKM+RSAEqDE9
 E27oOSfF+bQQ6FxvzVUMiPODZHkQUXH8f+EMSz4MLIniHa54axFwWT9HO
 D4QrYa+Qyjpr7iWB0qYFLidvpvHNm6tjnR3C1nTaGyrqVQtpKdnVlb8uE
 ovla3vUVgRop41AkN/+xVR0i8Sv2wZ8VNOKGXTnfk9D2D69Xt7/V9m6Yo w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="302585117"
X-IronPort-AV: E=Sophos;i="5.93,352,1654585200"; d="scan'208";a="302585117"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Sep 2022 10:52:28 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="599671420"
X-IronPort-AV: E=Sophos;i="5.93,352,1654585200"; d="scan'208";a="599671420"
Received: from ekarpovi-mobl1.ger.corp.intel.com (HELO [10.252.6.131])
 ([10.252.6.131])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Sep 2022 10:52:24 -0700
Message-ID: <da26c1a5-efd4-25ff-c2b4-5d4e454772a6@intel.com>
Date: Wed, 28 Sep 2022 18:52:21 +0100
MIME-Version: 1.0
...
There is lots of rsvd stuff here and below, but I don't see where we are 
verifying if it is actually MBZ?

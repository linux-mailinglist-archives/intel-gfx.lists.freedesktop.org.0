...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D4F53ED9DA
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Aug 2021 17:29:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D47A989FD4;
	Mon, 16 Aug 2021 15:29:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x62d.google.com (mail-ej1-x62d.google.com
 [IPv6:2a00:1450:4864:20::62d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 495EC89FD1
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Aug 2021 15:29:08 +0000 (UTC)
Received: by mail-ej1-x62d.google.com with SMTP id w5so32498481ejq.2
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Aug 2021 08:29:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=gCpIMqFkASsQIi2bwQszUBK9E3isNBXs2sNuQ+Dy07w=;
 b=e+3C0m5Fqh6ltzvi3OfHvMYwrDbmBE8JWgiqbXvKRD+sVT0RTYhT0TZnlqM7/gnc1O
 IyUApsEdQxsmxiNaj9wG5OBBjtOahIlNpI7QApXC+je9kEnpdU8dwmDtTV4UW6gXWWvV
 SHxBaukkoTzmn+t2/sTpb50qLXaDpHRQ12xuQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=gCpIMqFkASsQIi2bwQszUBK9E3isNBXs2sNuQ+Dy07w=;
 b=
X-Gm-Message-State: AOAM532k5F1IrzMfp86nIkEiXHTHI62JuJ3tX8nDnhEbFjF4jaeNw+i5
 pgA3TWrH+sUKbXKooSt0G9LhKg==
X-Google-Smtp-Source: ABdhPJzE6NkFO41Sv6XKOlei0Vc7REwoiPxWcoLSXrbqQTsYJpKwksAUi/ir3RMcABqThI4GWiNQ1A==
X-Received: by 2002:a17:906:704e:: with SMTP id
 r14mr16625041ejj.293.1629127746648; 
 Mon, 16 Aug 2021 08:29:06 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id q21sm3835517ejs.43.2021.08.16.08.29.05
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 16 Aug 2021 08:29:05 -0700 (PDT)
...
Message-ID: <YRqEQAJ8eVKcJir2@phenom.ffwll.local>
References: <20210729020106.18346-1-daniele.ceraolospurio@intel.com>
 ...
 <YRaEwdeP4U2W+q5i@phenom.ffwll.local>
 <3abe466f-3c7f-da5b-9ea0-de686bddf749@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4FD6894F14
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Apr 2024 11:50:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 452B810FBDB;
	Tue,  2 Apr 2024 09:50:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="axeYCsmb";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 52B4F10FBDB
 for <intel-gfx@lists.freedesktop.org>; Tue,  2 Apr 2024 09:50:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1712051444; x=1743587444;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Wyfc3s0k6vfL5iP0yCS2LVBhJf6N8j5/FVoBCCJcLIg=;
 b=axeYCsmbaBfMleb0WXZ6mh3M1tBfUIJOMNAPMJh/xT7+CynLMo6HjIeo
 64R/kACP35hQpVdWqYEVwSTY348Ry50CfEGt9IU+cZ0WgY3h6uZm0X+LM
 Nrvax33Xwod8htRBsyW1epLcFq7sXb5DbPztkeQbc1izPWyAlBcOf+YRv
 VquxAykrdNqtSdaOvHen5JwbVDZ6/2i+Kp7dA3L6P8BOboRhR/0ei3s+b
 Xe0SphnN7ktwgKzu4TsQJysKYaztpomuEY4DeCMaT7gtfaHyisdSfjlKd
 kfJQONxw+Yjj4MPWsROBs+M5iDp8JIkUbaboFvJmI1b1Vw2Di/mq3Lvfb g==;
X-CSE-ConnectionGUID: ZiPcimVbQ5qqvo7vGH0+3g==
X-CSE-MsgGUID: lFeuSMBDTR+K36v6J5rhbw==
X-IronPort-AV: E=McAfee;i="6600,9927,11031"; a="7422659"
X-IronPort-AV: E=Sophos;i="6.07,174,1708416000"; 
   d="scan'208";a="7422659"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2024 02:50:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,174,1708416000"; d="scan'208";a="22693356"
Received: from sudhirj1-mobl.ger.corp.intel.com (HELO
 jhogande-mobl1.intel.com) ([10.249.34.252])
 by ORVIESA003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2024 02:50:42 -0700
From: =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Animesh Manna <animesh.manna@intel.com>,
 =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>
Subject: [PATCH v4 11/19] drm/i915/psr: Rename psr2_enabled as
 sel_update_enabled
Date: Tue,  2 Apr 2024 12:50:03 +0300
Message-Id: <20240402095011.200558-12-jouni.hogander@intel.com>

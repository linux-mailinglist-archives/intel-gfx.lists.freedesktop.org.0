...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44E17B2C936
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Aug 2025 18:12:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B93010E635;
	Tue, 19 Aug 2025 16:12:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 1538d3639d33 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 985A610E635;
 Tue, 19 Aug 2025 16:12:53 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============7025112206043448581=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=97_i915=2ECI=2EBAT=3A_failure_for_drm/i915/hdcp=3A_Remove_t?=
 =?utf-8?q?he_encoder_check_in_hdcp_enable?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Suraj Kandpal" <suraj.kandpal@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Tue, 19 Aug 2025 16:12:53 -0000
Message-ID: <175561997361.248501.13745219971310702413@1538d3639d33>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_153149v1 absolutely need to be
  verified manually.
  
  If you think the reported changes have nothing to do with the changes
  introduced in Patchwork_153149v1, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_153149v1:
...
#### Possible regressions ####
  ...
  * igt@gem_softpin@safe-alignment:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17030/fi-hsw-4770/igt@gem_softpin@safe-alignment.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153149v1/fi-hsw-4770/igt@gem_softpin@safe-alignment.html
...
#### Issues hit ####
  ...
  * igt@fbdev@info:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17030/fi-hsw-4770/igt@fbdev@info.html
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153149v1/fi-hsw-4770/igt@fbdev@info.html

  * igt@fbdev@nullptr:
    - fi-hsw-4770:        [PASS][5] -> [SKIP][6] ([i915#2582]) +3 other tests skip
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17030/fi-hsw-4770/igt@fbdev@nullptr.html
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153149v1/fi-hsw-4770/igt@fbdev@nullptr.html
...
<p>Serious unknown changes coming with Patchwork_153149v1 absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_153149v1, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them<br />
  to document this new failure mode, which will reduce false positives in CI.</p>
<p>External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153149v1/index.html</p>
<h2>Participating hosts (43 -&gt; 42)</h2>
<p>Missing    (1): fi-snb-2520m </p>
<h2>Possible new issues</h2>
<p>Here are the unknown changes that may have been introduced in Patchwork_153149v1:</p>
<h3>IGT changes</h3>
<h4>Possible regressions</h4>
<ul>
<li>igt@gem_softpin@safe-alignment:<ul>
<li>fi-hsw-4770:        <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17030/fi-hsw-4770/igt@gem_softpin@safe-alignment.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_153149v1/fi-hsw-4770/igt@gem_softpin@safe-alignment.html">FAIL</a></li>
</ul>
</li>
</ul>
<h2>Known issues</h2>

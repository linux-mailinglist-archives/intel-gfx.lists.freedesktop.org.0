...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B3CD75C812
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jul 2023 15:43:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E67A10E68B;
	Fri, 21 Jul 2023 13:43:20 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v1 1/1] drm/i915: Move abs_diff() to math.h

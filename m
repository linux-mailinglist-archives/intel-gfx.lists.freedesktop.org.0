...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FEB18183F5
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Dec 2023 09:58:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AD3C10E428;
	Tue, 19 Dec 2023 08:58:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EB96F10E428
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 Dec 2023 08:58:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702976305; x=1734512305;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=2q0SY4O4+O9/3L/4WfIT/nZ6+7lnC7lKfUtPIp+s1mU=;
 b=cAtmocG0368yBaRMoCOe7V+TPlxSs952NGsd9M8ukLqEG2qyWXwi8uFt
 KMMUUAXAeWAbKVfHttzKaasvPBi2zPGr043Q+QHBNBVy0TFzxc525cEJC
 ZshAFpa4LKh+9WitBs2i/JaymZEA4gQRhO93pE7/GEwqE5XEKEtTBbFMJ
 FgCWcPYdAazU5864idgz+0MrTgPg/m7DFPQ+UWGUK0Q5mTyaFLOV7lRxi
 qNkF4C6prXTKrP/T8Y7qn7+tMhKqN1EwKlgUAylun7aFAMgp3OXdTdgeJ
 INyp2ECLAWrNv6nJsDfZ/e6rH1uW6TtQQrI2a91OFNloBjQdm5lZumfdU w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="2857450"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; 
   d="scan'208";a="2857450"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Dec 2023 00:58:24 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="24118513"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orviesa001.jf.intel.com with ESMTP; 19 Dec 2023 00:58:23 -0800

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C93A37DF358
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Nov 2023 14:11:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4C1D10E895;
...
Subject: [Intel-gfx] [PATCH v6 6/7] drm/i915: Implement fbdev client
 callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 298FC68247A
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Jan 2023 07:36:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A7D9810E325;
	Tue, 31 Jan 2023 06:36:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9D72F10E325
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Jan 2023 06:36:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675146967; x=1706682967;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Ha+N4+GgCZ20D9urHGiU9EQIFtIpINbliFs6bQ3zgfg=;
 b=UgybwDuBXi5rlO8iwxB0EjZO2DreKGkv9WsHQgT9g61wuPfyz5nJe6Vj
 bTho8nWX9aeXSbgntejsd6PS15FcxTpJmLqNmMabC2iLCKcEVbopaui8A
 8VfNbJBcX360SI0FjwFrBr6VhmwCYyQMl82yoPgHQ7niMecnkHAbE4idR
 MaBxVGr5Rkbx4BwVAFxDNEwRKZR4g6mq6VbLpxvKgt4HTwYCiuWX6x8Y4
 se+2Ms9l0oxmYjbIYlAR8ZcXDfrLnyazmqOf+WN1iuYv2/kdmNgXxOE/g
 Yc9xlSndXZsqZV2j/TNuFgpdJKwGGkfLfJzzG+DZPmunKfrcX/rRCRnPz Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10606"; a="390126807"
X-IronPort-AV: E=Sophos;i="5.97,259,1669104000"; d="scan'208";a="390126807"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jan 2023 22:36:07 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10606"; a="838248463"
X-IronPort-AV: E=Sophos;i="5.97,259,1669104000"; d="scan'208";a="838248463"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga005.jf.intel.com with ESMTP; 30 Jan 2023 22:36:04 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 31 Jan 2023 12:03:38 +0530
Message-Id: <20230131063342.2811275-3-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 2/6] drm/i915/hdcp: Keep hdcp agonstic naming
 convention

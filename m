...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EBB3043C1B6
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Oct 2021 06:38:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4A18D89083;
...
Subject: [Intel-gfx] [PATCH v9 10/10] drm: use

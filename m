...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CFD1B4C4FD1
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 21:42:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C671610E93D;
...
Subject: [Intel-gfx] [PATCH v2 3/3] drm/i915: Improve long running OCL w/a
 for GuC submission

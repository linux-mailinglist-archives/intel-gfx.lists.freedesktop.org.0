...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66FB0407246
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 22:10:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BE9D6EAA5;
...
Subject: [Intel-gfx] [PATCH v2 0/6] i915: Simplify mmio handling & add new
 DG2 shadow table

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A21E64EB37F
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Mar 2022 20:42:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C737010E555;
...
Subject: [Intel-gfx] [PATCH 01/12] drm/edid: use struct edid * in
 drm_do_get_edid()

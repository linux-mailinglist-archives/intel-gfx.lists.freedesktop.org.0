...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C5D251568C9
	for <lists+intel-gfx@lfdr.de>; Sun,  9 Feb 2020 04:54:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2340A6EB4E;
	Sun,  9 Feb 2020 03:54:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C86756EB48;
 Sun,  9 Feb 2020 03:54:14 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga106.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 08 Feb 2020 19:54:14 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,419,1574150400"; d="scan'208";a="221210586"
Received: from rrcarnag-mobl.amr.corp.intel.com (HELO
 helsinki.ger.corp.intel.com) ([10.252.14.133])
 by orsmga007.jf.intel.com with ESMTP; 08 Feb 2020 19:54:13 -0800
From: Gwan-gyeong Mun <gwan-gyeong.mun@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sun,  9 Feb 2020 05:53:45 +0200
Message-Id: <20200209035345.357436-19-gwan-gyeong.mun@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 18/18] drm/i915/psr: Use new DP VSC SDP
...
index a00433d9cdd1..d45122a5e8b5 100644
--- a/drivers/gpu/drm/i915/display/intel_ddi.c
+++ b/drivers/gpu/drm/i915/display/intel_ddi.c
@@ -3926,7 +3926,7 @@ static void intel_enable_ddi_dp(struct intel_encoder *encoder,
...
@@ -4094,7 +4094,7 @@ static void intel_ddi_update_pipe_dp(struct intel_encoder *encoder,

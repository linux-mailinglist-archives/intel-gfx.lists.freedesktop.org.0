...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C33D9D27C5
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Nov 2024 15:13:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 039FC10E65D;
	Tue, 19 Nov 2024 14:13:19 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="bYlwRzK/";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C0E6E10E65D;
 Tue, 19 Nov 2024 14:13:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1732025598; x=1763561598;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=iG0PJQWxfDqox5VAgtkaHavDgcXiQNEj2qOn9DNvhPQ=;
 b=bYlwRzK/xgLOwlTTef1MiAa/qkycCNJHwmpUmEU0RicC29VbNen0hqML
 Ucl9LB1HhsiehzplC7XdzH9HHXFOxoEsErbyeYGcO7tB6jpDuhEk4+NQO
 n2UPw2HR+nsy+imv5DaFQr+19JOTxxJDqyVvF3d+4sc3z0H0yWzXPB0Ln
 IJglJXtjn/XSOXXx+Yx/xNNH08kZOZHco/A0dYBotig0gvcaNEnfWyX21
 4Cs6oqbBz7QRE7IXfvfpLEMdJdOYyB9Us70EVht2/yZZj6k0ScDbiuV2c
 4FCBOvfgdt80t+g7q60NUjnp6BXYKKudynFFuR7sWkbrHcLtvJMV2wfFn A==;
X-CSE-ConnectionGUID: +G78V0ykSLKhvTwrsOAcYQ==
X-CSE-MsgGUID: E7fy9yA+Q+m3rZPa9CO4zg==
X-IronPort-AV: E=McAfee;i="6700,10204,11261"; a="54526802"
X-IronPort-AV: E=Sophos;i="6.12,166,1728975600"; d="scan'208";a="54526802"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Nov 2024 06:13:18 -0800
X-CSE-ConnectionGUID: zKlfGSkeTPiAixTd+x69wA==
X-CSE-MsgGUID: /N3wYToLR3ikhI6yIBFZSA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,166,1728975600"; d="scan'208";a="94398675"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Nov 2024 06:13:12 -0800
...
Subject: [PATCH v3 07/10] drm/i915/nvm: add nvm device for discrete graphics
Date: Tue, 19 Nov 2024 16:01:09 +0200
Message-ID: <20241119140112.790720-8-alexander.usyskin@intel.com>

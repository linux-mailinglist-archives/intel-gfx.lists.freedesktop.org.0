...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F1A63B860F
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 17:11:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C68706EA2D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 13/17] drm/amd/display: Add handling for new

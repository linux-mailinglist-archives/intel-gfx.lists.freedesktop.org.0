...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ED22B4A70B
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jun 2019 18:35:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 818096E1E8;
	Tue, 18 Jun 2019 16:35:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pf1-x449.google.com (mail-pf1-x449.google.com
 [IPv6:2607:f8b0:4864:20::449])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 37A026E0DA
 for <intel-gfx@lists.freedesktop.org>; Tue, 18 Jun 2019 06:26:33 +0000 (UTC)
Received: by mail-pf1-x449.google.com with SMTP id y5so8606003pfb.20
 for <intel-gfx@lists.freedesktop.org>; Mon, 17 Jun 2019 23:26:33 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:message-id:mime-version:subject:from:to:cc
 :content-transfer-encoding;
 bh=vA+kgCBJcMIEMYkHeCd3wqGKPPi8vvElInzRHbJTvB8=;
 b=
X-Gm-Message-State: APjAAAUzgveiV4bHG/ZpA/anTiU53knsd8nnAjQVyOI6cfTuR1AumArD
 61C3uIIcpTV4T/ItaTPmxsiO56/m1MpS
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 mVrA==
Subject: [Intel-gfx] [PATCH] i915: intel_dp_aux_backlight: Fix max backlight
 calculations

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EBA43B27B7
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB5846EA39;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 36/47] drm/i915/guc: Handle engine reset failure
 notification

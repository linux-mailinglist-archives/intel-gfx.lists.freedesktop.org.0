...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7FCA6F1E57
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 20:56:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1ECDA10EDAC;
...
Subject: [Intel-gfx] [PATCH v2 3/4] drm/i915/guc: Capture list naming clean
 up

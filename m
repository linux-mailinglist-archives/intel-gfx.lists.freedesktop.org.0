...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AACE07CE3CA
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:07:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E6C2710E443;
...
Subject: [Intel-gfx] [PATCH v7c 15/24] dyndbg: refactor

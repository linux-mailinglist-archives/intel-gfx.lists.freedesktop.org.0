...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9656640FE60
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Sep 2021 19:08:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A36A6E02E;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Make wa list per-gt

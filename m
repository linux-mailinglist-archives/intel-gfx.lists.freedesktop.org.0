...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EACA97C0019
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Oct 2023 17:13:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3FC3D10E39B;
	Tue, 10 Oct 2023 15:13:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3DC8710E397
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=QXia8pyGc29oJo5y7QovwRi65ya0RlNE4HWl5PmWO60=;
 b=E2gW6IZYdHLKNxgzgRVKAlNmZK6Ha/T/PHK92zw4KMWTPJnV77nU58k8
 ObIxKOPwaPIYhAadfGbsAVVtOdVgCzj+uLhYcsrC2XjFBc0nIhssXxEQM
 eZNxUs31ZuCxWFXSVR8O8xdLs/T4zVkbeuSwhNKuRetoVKjRHh8HEBoR+
 qz2UoOoOqCg+mue1lkRZQ8Dp1QuBPp9X5qnHPhfYKhvzXKYWNvvKOX0wu
 LtCEim8uQh51r4jOHqhb+csptv1TUimL8tkRVyCgQb4YRK2DmcJZ1G59y
 gOtliYRkj8TaNyx7JOWbAqJibOuck9ks2ak13MnPcv82MqUsjXc08PHtV Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="415435745"
X-IronPort-AV: E=Sophos;i="6.03,213,1694761200"; d="scan'208";a="415435745"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 08:13:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="757155003"
X-IronPort-AV: E=Sophos;i="6.03,213,1694761200"; d="scan'208";a="757155003"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 08:13:28 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Oct 2023 08:02:40 -0700
Message-Id: <20231010150244.2021420-4-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 3/7] drm/i915: Define and use GuC and CTB

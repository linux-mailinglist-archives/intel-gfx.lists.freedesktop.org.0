...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0389D6E0A83
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Apr 2023 11:48:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60BB410EA9C;
	Thu, 13 Apr 2023 09:48:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AAAD510EAAA
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Apr 2023 09:48:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1681379281; x=1712915281;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lGDLjf2MiOXikPvyQDVKLusQ1LMAuSFVHautysfe/Ao=;
 b=Di6sbTtkz0Nlx3pW9BMZCm5EyQ+UHB2Iv5xj1TYsNszOjMxU3yLwPP75
 V2y7VeeJ8OKXZocab7vUecmlV/qsN+GH3DEQlBSGN4ry4o2IBKUlqli72
 63yoic5LGCT+QEZmlCsvnny9pNsjnLnFQNGHDwdcWqrfpbQE11bT4iUYE
 XlbCqYVDzk5vTZQK6KYQO8F+8wZwhjlQBNVPa/oWE/yahqtmn2L7S7Djt
 9FkTwJ+g6hI0S9oXlpc9ZzNZhd5cV828MnH+1aqctrCFtd9fgobGy1MJe
 v1QjwDec332CwVjTAcxbHN63t/NHgdOoEIfRR+pF8R87pC0Q/HDHmOVYP w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10678"; a="328254748"
X-IronPort-AV: E=Sophos;i="5.98,341,1673942400"; d="scan'208";a="328254748"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Apr 2023 02:48:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10678"; a="719778905"
X-IronPort-AV: E=Sophos;i="5.98,341,1673942400"; d="scan'208";a="719778905"
Received: from merkanx-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.55.88])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Apr 2023 02:47:59 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 13 Apr 2023 12:47:31 +0300
Message-Id: <79b7928790ba7e006bd0673da84ce5cc6e5db478.1681379167.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 05/10] drm/i915/display: move modeset

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ECEE02B6843
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Nov 2020 16:09:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 32F2A6E0F5;
	Tue, 17 Nov 2020 15:09:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8604D6E0F5
 for <intel-gfx@lists.freedesktop.org>; Tue, 17 Nov 2020 15:09:09 +0000 (UTC)
IronPort-SDR: VVpEzM1/85+sa+jca2PdeWOxIKIzlP1kbBHBqB7lHgBtimgD3jvX5DBcw97L57UlSjqh8oweaI
 nqEvdIYYuqYg==
X-IronPort-AV: E=McAfee;i="6000,8403,9808"; a="170156127"
X-IronPort-AV: E=Sophos;i="5.77,485,1596524400"; d="scan'208";a="170156127"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Nov 2020 07:09:09 -0800
IronPort-SDR: iUXPQt83ZgHbFIeGNKvPFG7RNkov5EC0OItooZ1tf0U4UkwIg4ny5AfAaQDb07c0347DTHisD4
 WajWuSbpABGA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,485,1596524400"; d="scan'208";a="310239784"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by fmsmga008.fm.intel.com with SMTP; 17 Nov 2020 07:09:07 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 17 Nov 2020 17:09:06 +0200
Date: Tue, 17 Nov 2020 17:09:06 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Navare, Manasi" <manasi.d.navare@intel.com>
Message-ID: <20201117150906.GB6112@intel.com>
...
In-Reply-To: <20201117003343.GB29332@labuser-Z97X-UD5H>
...
> > @@ -11651,6 +11651,8 @@ static int intel_check_cursor(struct intel_crtc=
_state *crtc_state,
> >  {
> >  	const struct drm_framebuffer *fb =3D plane_state->hw.fb;
> >  	struct drm_i915_private *i915 =3D to_i915(plane_state->uapi.plane->de=
v);
...
> > @@ -11666,8 +11668,8 @@ static int intel_check_cursor(struct intel_crtc=
_state *crtc_state,
> >  		return ret;
> >  =

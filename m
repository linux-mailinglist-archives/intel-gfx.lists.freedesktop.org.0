...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7513E6A5122
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Feb 2023 03:23:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 58BCE10E5C3;
	Tue, 28 Feb 2023 02:23:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E28CB10E4A1
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=lKEKjdZgd8blXMIjzBEn3TqBrbtHOvaFqxGFP/KRldM=;
 b=LaDykzE4zYwZ5rpc0j1hDqM814pQuIoXYZTbKOGO0uVGw5WtNVq/EOwC
 /oadjMBDmbweKPqIOOLdrj+Lc7STpVZmxroNtWAG3ErbTdF4iVOBjzN3/
 kro22VHh7cn312Rjln7epLEdtleRSAbgblcmOi0uBHjN8qRLnkW0LTBq6
 7RUdSST9ojFVGO4trnHjhLUbcbt+0t9Ud9VSPeGnCKOJdbrGQlVzChpsN
 6FhgD/gU/2l0i3Y4OcSKq7Jt1kpfZy/Ovu75xugsr802EPJRIyaQetfPM
 gi6SgMRnwCbKZBVPyotBJc9aMO3YGllQ58Nc/+vCdc3IF0pQAtl3Mn3Bs A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10634"; a="331504080"
X-IronPort-AV: E=Sophos;i="5.98,220,1673942400"; d="scan'208";a="331504080"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Feb 2023 18:23:36 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10634"; a="676129243"
X-IronPort-AV: E=Sophos;i="5.98,220,1673942400"; d="scan'208";a="676129243"
Received: from orsosgc001.jf.intel.com ([10.165.21.138])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Feb 2023 18:23:36 -0800
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 27 Feb 2023 18:23:29 -0800
Message-Id: <20230228022329.3615793-10-umesh.nerlige.ramappa@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 9/9] drm/i915/perf: Add support for OA media
 units
...
@@ -1788,8 +1820,8 @@ static void gen12_init_oa_buffer(struct i915_perf_stream *stream)
...
@@ -1801,9 +1833,9 @@ static void gen12_init_oa_buffer(struct i915_perf_stream *stream)
...
@@ -2563,7 +2595,8 @@ gen8_modify_self(struct intel_context *ce,
 	return err;
 }
...
@@ -2573,7 +2606,8 @@ static int gen8_configure_context(struct i915_gem_context *ctx,
...
@@ -2704,7 +2738,7 @@ oa_configure_all_contexts(struct i915_perf_stream *stream,
...
+		err = gen8_configure_context(stream, ctx, regs, num_regs);
 		if (err) {
 			...
 			return err;
@@ -2724,7 +2758,8 @@ oa_configure_all_contexts(struct i915_perf_stream *stream,
...
@@ -2749,6 +2784,9 @@ gen12_configure_all_contexts(struct i915_perf_stream *stream,
 		},
 	};
...
+
 	return oa_configure_all_contexts(stream,
 					 ...
 					 active);
@@ -2878,7 +2916,7 @@ gen12_enable_metric_set(struct i915_perf_stream *stream,
...
@@ -2888,7 +2926,7 @@ gen12_enable_metric_set(struct i915_perf_stream *stream,
 			    */
...
@@ -3042,8 +3080,8 @@ static void gen8_oa_enable(struct i915_perf_stream *stream)
...
@@ -3054,9 +3092,11 @@ static void gen12_oa_enable(struct i915_perf_stream *stream)
...
+	intel_uncore_write(stream->uncore, regs->oa_ctrl, val);
 ...
 /**
@@ -3108,9 +3148,9 @@ static void gen12_oa_disable(struct i915_perf_stream *stream)
 {
 	struct intel_uncore *uncore = stream->uncore;
...
@@ -4012,6 +4052,7 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+
 	if (config_sseu) {
 		...
 		if (ret) {
@@ -4366,6 +4418,14 @@ static const struct i915_range gen12_oa_b_counters[] = {
 	{}
 };
...
@@ -4419,6 +4479,8 @@ static const struct i915_range mtl_oa_mux_regs[] = {
...
@@ -4456,10 +4518,20 @@ static bool gen12_is_valid_b_counter_addr(struct i915_perf *perf, u32 addr)
...
@@ -4829,12 +4901,86 @@ static u32 num_perf_groups_per_gt(struct intel_gt *gt)
 	return 1;
 }
...
@@ -4861,6 +5007,8 @@ static int oa_init_gt(struct intel_gt *gt)
...
@@ -4918,9 +5066,15 @@ static void oa_init_supported_formats(struct i915_perf *perf)
 		break;
...
+		oa_format_add(perf, I915_OAM_FORMAT_MPEC8u32_B8_C8);
 	...
 	default:
@@ -5165,8 +5319,10 @@ int i915_perf_ioctl_version(void)
 	 *
...
index 8ce20004a9dd..ceffe9a38a68 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 08E8E8B7EC3
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Apr 2024 19:39:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D28B112D8D;
	Tue, 30 Apr 2024 17:39:08 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=linux.microsoft.com header.i=@linux.microsoft.com header.b="WTaztFSZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
 by gabe.freedesktop.org (Postfix) with ESMTP id 5C5B4112D2C;
 Tue, 30 Apr 2024 17:39:06 +0000 (UTC)
Received: from rrs24-12-35.corp.microsoft.com (unknown [131.107.174.176])
 by linux.microsoft.com (Postfix) with ESMTPSA id 61254210FBDE;
 Tue, 30 Apr 2024 10:39:05 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 61254210FBDE
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
 s=default; t=1714498745;
 bh=kSpDVAvN8PT1T8YPqp2DTm4soGBxuGXjM1zo4YedgKU=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=WTaztFSZfOafjwGjgDuU1+Y7Wu4IaHiuSy23wN7PuzO/cL9/jYi6l+j/89JVJNv9r
 jWxX4gPdjIPOrpKrUnSzOTS+p6cygbtwrrEoPkMSWlFCe+ydSoxu7ImUzz6bCju6KS
 W0zWu94FKJAUcLD7E915Im9Gi35tlgoKiHuB/IIA=
...
To: Alex Deucher <alexander.deucher@amd.com>,
 ...
 Alexander Richards <electrodeyt@gmail.com>, Ran Sun <sunran001@208suo.com>,
 ...
 Hamza Mahfooz <hamza.mahfooz@amd.com>, Alan Liu <haoping.liu@amd.com>,
 ...
 Asad kamal <asad.kamal@amd.com>, Ma Jun <Jun.Ma2@amd.com>,
...
Subject: [PATCH v1 01/12] drm/amdgpu,
 drm/radeon: Make I2C terminology more inclusive
Date: Tue, 30 Apr 2024 17:38:00 +0000
Message-Id: <20240430173812.1423757-2-eahariha@linux.microsoft.com>

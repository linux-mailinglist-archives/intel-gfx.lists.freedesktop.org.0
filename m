...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 001E77A69A0
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Sep 2023 19:27:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 611EE10E24F;
	Tue, 19 Sep 2023 17:27:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 35A7C10E13D
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=cbt8PLEsSbheHJY2hKegztduksMhLyJh1XFxeJo6qRbSuFdzuVq5cqd+
 WXNaf8CW5qf5RCDdNtZCCb5UMLMp8lNPUW0gpKeu2JIFFZ3jzV7d0BOTw
 BFDFMIt1Ddj3v8FEqo0fN27d3OzltipRBF97v8EOQmOMA+Nlx4TMUs1Kq
 BJfF+aDlt+8sa0i1c+tiR8ntgfn3n4kldlpATCTKAzRNfGw7ZlOeuWSk0
 4ZXMvE5PFBzg+4L3bLceSzqWw6xHjvny8ewY0fU9gKnphjALqo9elgHrl
 NhO2IvJZSN8sZOeBnlQ+kpd2nom6gjul1gMT4iYYQsEXcIBGVwo4J/ii0 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="360266458"
X-IronPort-AV: E=Sophos;i="6.02,160,1688454000"; d="scan'208";a="360266458"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2023 10:27:41 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="993247472"
X-IronPort-AV: E=Sophos;i="6.02,160,1688454000"; d="scan'208";a="993247472"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2023 10:27:41 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 19 Sep 2023 10:16:53 -0700
Message-Id: <20230919171655.3308090-2-jonathan.cavitt@intel.com>

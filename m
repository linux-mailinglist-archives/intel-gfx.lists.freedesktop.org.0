...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B81C6D7EEE
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Apr 2023 16:14:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1000A10E990;
	Wed,  5 Apr 2023 14:14:48 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 4/5] drm/i915/display: Add helper func to

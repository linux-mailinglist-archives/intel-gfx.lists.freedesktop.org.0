...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AD7B30CE8C
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Feb 2021 23:12:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12C2D6E9A8;
	Tue,  2 Feb 2021 22:12:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 26E876E81E
 for <intel-gfx@lists.freedesktop.org>; Tue,  2 Feb 2021 22:12:41 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23777552-1500050 
 for <intel-gfx@lists.freedesktop.org>; Tue, 02 Feb 2021 22:12:32 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  2 Feb 2021 22:12:24 +0000
Message-Id: <20210202221233.28223-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 04/13] drm/i915/gt: Move CS interrupt handler to
 the backend
...
index 8dc52cc43f27..d69108b45377 100644
...
index f667e976fb2b..e13a107b4a1c 100644
...
index 3cb2ce503544..88da579f9d75 100644
...
index 17b551a0c89f..c522506af1af 100644

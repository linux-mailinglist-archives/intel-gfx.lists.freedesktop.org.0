...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FC5BB2D5F4
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Aug 2025 10:18:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4987F10E35C;
	Wed, 20 Aug 2025 08:18:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AtPZbYfS";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 09A7710E24D;
 Wed, 20 Aug 2025 08:18:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1755677920; x=1787213920;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=xQlbQWDPVF0lgkvI19q9dm8t4S2wUKyMxEvZT8e+EFg=;
 b=AtPZbYfSZ7XVUx+xp3xyVOOw6OJau5o7ORmFjljtCiQew2/eLb/0G79S
 lWNh5fc+zMo4foy1QGrPwWr4OSgaONKcbyuQWQK5ohYTO5y3zdh0uOTUV
 h50ZdaT41Jg8iCVDsiNrMwXv1SsxpHJ0zjbVzyAN5t4gDXSPaiQNt5eI2
 NJNPaA0/Y3Ki1us2GlA4r5uY7wK5B8AIEkLHPU40ZES3Ez2Rkfm3pL9di
 RaL6bbPPP+fCO5rTYLsJcf1en4oR0hN36N/KhRpo0pWtnvYRQiSyu963V
 vVIt4QjN1LIfDbzkkSgKilCsFDe/u3nG25s5ofXcf4cj+kYiLvelADStS g==;
X-CSE-ConnectionGUID: jgYKPuL5RSuTmg/h3RXaDg==
X-CSE-MsgGUID: C7nmvvO2QMumQ383xNZClQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11527"; a="69316767"
X-IronPort-AV: E=Sophos;i="6.17,302,1747724400"; d="scan'208";a="69316767"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Aug 2025 01:18:39 -0700
X-CSE-ConnectionGUID: Y9EWCm7bRSmGFnYqqHgHoQ==
X-CSE-MsgGUID: dZJjbu71QGmyNROv+iJ4CA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.17,302,1747724400"; d="scan'208";a="172292761"
Received: from srr4-3-linux-103-aknautiy.iind.intel.com ([10.223.34.160])
 by ORVIESA003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Aug 2025 01:18:38 -0700
From: Ankit Nautiyal <ankit.k.nautiyal@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: ville.syrjala@linux.intel.com, Ankit Nautiyal <ankit.k.nautiyal@intel.com>
Subject: [PATCH 00/12] Optimize vrr.guardband and fix LRR
Date: Wed, 20 Aug 2025 13:34:38 +0530
Message-ID: <20250820080451.2634888-1-ankit.k.nautiyal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 57FA64FB820
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 11:48:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9826810F8A6;
...
Subject: [Intel-gfx] [CI v2 12/12] drm/edid: add EDID block count and size
 helpers

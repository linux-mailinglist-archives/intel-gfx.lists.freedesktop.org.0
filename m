...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 519B46EEE21
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Apr 2023 08:14:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4587B10E8BA;
	Wed, 26 Apr 2023 06:13:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 728D910E8AC;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=8uCvN1+xBgISgTi+mWWfQ0jgczeGA8YRxAZ6iW9OudE=;
 b=EL17j2aIDoYeMw53qixtzDBlcvnejA1Z23FvgRn8YUpB7pMge3dyCZcB
 U8eik7uS9YSDLH9v3Vr1YvYYJxqwCgI6TE3sIjxX2x0ZdHVlPh3+9mktP
 MUSK60MbnNJ8jIR79KlQqe0Rzj7GTGjmNIm9Nh7IseV4HKrJySQ0KsLS9
 9pL8j/t88v8gz7SrvMKSw/MSF4fqSG4uf5wog2L6e/r+OOKwDewdKAYHS
 vw+y7DKk5JXdaG5IiwyRtTG8EMEswZVImuoT2/I0D94wgulumMyn76f+X
 oad35p2qVa7OXP+GwWFWmOUq1NGaPv1QZmBcTlX0DW9NedA9Zaz9XzYC8 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="331234662"
X-IronPort-AV: E=Sophos;i="5.99,227,1677571200"; d="scan'208";a="331234662"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 23:13:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="837767310"
X-IronPort-AV: E=Sophos;i="5.99,227,1677571200"; d="scan'208";a="837767310"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 23:13:47 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:14:51 -0700
Message-Id: <20230426061452.320390-3-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230426061452.320390-1-fei.yang@intel.com>
References: <20230426061452.320390-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915: use pat_index instead of
 cache_level

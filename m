...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BA88A402276
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Sep 2021 05:24:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0641389BB0;
	Tue,  7 Sep 2021 03:24:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9096A89BB3
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Sep 2021 03:24:21 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10099"; a="281099397"
X-IronPort-AV: E=Sophos;i="5.85,273,1624345200"; d="scan'208";a="281099397"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Sep 2021 20:24:21 -0700
X-IronPort-AV: E=Sophos;i="5.85,273,1624345200"; d="scan'208";a="537665629"
...
Date: Tue,  7 Sep 2021 06:24:16 +0300
Message-Id: <20210907032416.3934415-2-imre.deak@intel.com>
X-Mailer: git-send-email 2.27.0
In-Reply-To: <20210906182715.3915100-2-imre.deak@intel.com>
References: <20210906182715.3915100-2-imre.deak@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [CI 1/6] drm/i915: Use tile block based dimensions for
 CCS origin x, y check

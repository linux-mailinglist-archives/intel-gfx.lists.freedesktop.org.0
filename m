...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEA0C51764A
	for <lists+intel-gfx@lfdr.de>; Mon,  2 May 2022 20:03:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A96EF10E070;
	Mon,  2 May 2022 18:03:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C879410E00A;
 Mon,  2 May 2022 18:03:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1651514602; x=1683050602;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=ovO9oKS9gIpozfUU4QwboaAKpOOFHKQUqTjmldAaq7Y=;
 b=MscI0YIgemHt1VmKGorMfNYvrd9Sb7staguRB58NmPeqynWimXvXKF0I
 iDJUCIlxexh+hBGQdUBtvMq4xDVpGPvc97kPiP8z8fgCfXcT6iYnU/Mg5
 w6FPZ3YB12wptPZ4K3OvXcVyP/ieGt3QlogP2R7xMxM8JXjCZEsEBJjFK
 KxUZL1JkEarZRnfqcwujF1Ip/zWkN3VD17BwZATDPHoiSh82j2vq9Urzi
 wBp5WvjEc7YI+ft2J7U7AvFOARuSsIuU1fjdlqpEKUH9N1HnxK+Guke2I
 SRxZ9LNI4oa9xPY3A4iIHKbK+sT8E+5pwywLatwwheMrCzDrYvnyGWKsP A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10335"; a="254744652"
X-IronPort-AV: E=Sophos;i="5.91,192,1647327600"; d="scan'208";a="254744652"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 May 2022 11:03:22 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.91,192,1647327600"; d="scan'208";a="567304887"
Received: from linux.intel.com ([10.54.29.200])
 by fmsmga007.fm.intel.com with ESMTP; 02 May 2022 11:03:21 -0700
Received: from [10.249.133.140] (rjankows-MOBL1.ger.corp.intel.com
 [10.249.133.140])
 by linux.intel.com (Postfix) with ESMTP id 879E1580966;
 Mon,  2 May 2022 11:03:18 -0700 (PDT)
Message-ID: <08238499-2818-1fac-acf8-736a835b01d2@intel.com>
Date: Mon, 2 May 2022 21:03:17 +0300
MIME-Version: 1.0
...
In-Reply-To: <MWHPR11MB17438452CE887B7E85FB912AA9C19@MWHPR11MB1743.namprd11.prod.outlook.com>

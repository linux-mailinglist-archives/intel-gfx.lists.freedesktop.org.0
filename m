...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BCD5B1CA2
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Sep 2019 13:52:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDC996EF3A;
...
Subject: [Intel-gfx] [PATCH 8/9] drm/amdgpu: use drm_debug_enabled() to

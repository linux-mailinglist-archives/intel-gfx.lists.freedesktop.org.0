...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C9B0C4DD4BA
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Mar 2022 07:40:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DCBD10E0A3;
	Fri, 18 Mar 2022 06:40:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6835410E062;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=G7081XUsRkJyMXgeGN9pSwytvkiLLjPh12Emjeci9gaDtqL6DN8QMsn/
 Ja2Eq16m8NxWi9DTB+0QAKTDoh7vfPJPC5yuHm45O3qaUFGfjLdV4l3dy
 lhoCII1i2U69ZvUrJl60MfauEXGfyjfnyiPgN0KP2H9K1TOuALDIXTq/1
 E0Wf4Sj94vFxo1AWg57fkV8CBL5ibCHySdhc69PW9BZ9fIrsoVNLrEYr+
 56IZQhHllyaybClk+2LBucZhwmSVL7p8sIq54uB07u6nJw90KDRWkyis4
 TGs+84H9qTS1SmWSQqow9Z/wwrUkFku3xZXkFBVfVlKTbtEmL/lPOCcmt g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10289"; a="256796643"
X-IronPort-AV: E=Sophos;i="5.90,191,1643702400"; d="scan'208";a="256796643"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Mar 2022 23:40:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,191,1643702400"; d="scan'208";a="691205041"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga001.fm.intel.com with ESMTP; 17 Mar 2022 23:40:30 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 17 Mar 2022 23:42:59 -0700
Message-Id: <20220318064300.1831909-13-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 12/13] drm/i915/guc: Plumb GuC-capture into
 gpu_coredump

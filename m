...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F887375AA7
	for <lists+intel-gfx@lfdr.de>; Thu,  6 May 2021 20:58:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4C616ED94;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 13/97] drm/i915/guc: Replace CTB array with
 explicit members

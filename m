...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 33F3A73FE99
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jun 2023 16:44:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02A4410E305;
	Tue, 27 Jun 2023 14:43:58 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 00/24] use vmalloc_array and vcalloc

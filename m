...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E8E1C570B9A
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:27:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C48290FD2;
...
Subject: [Intel-gfx] [PATCH 17/32] drm/i915: i915_gem_wait.c: fix a
 kernel-doc markup

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6428111ED6D
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2019 23:07:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9D946EDE4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC v2 01/12] drm/i915/svm: Add SVM documentation

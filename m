...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ABDBB546F2B
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 23:19:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0536113E45;
	Fri, 10 Jun 2022 21:19:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 620A4113E3B;
 Fri, 10 Jun 2022 21:19:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654895962; x=1686431962;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=1tS2F+pFeHW9LDJ3DFfUYMG8ZzTX56kjOlXZZxus6J0=;
 b=Rr7fmdiB6Pxma/bLFs2bvIniP69NONYNazM8SxC1ttzhAfBG7sLGG+Yj
 vRDUIS3nYaLJryYZYH14tPsW2kPWPLxc9G0MkzAqq/t8WCHHDGb5v3WSH
 FOYHGm/rSrKD8Iv10K3BlAu2NQa4NUSKHEFAKDGUggDQXVOio5vst7TD/
 9vERVUc36Pa7XJsagYKHqEwbzThuF5dRJoILMJhR9EC7o1kafZfNhNdJC
 XnYF6eY0N5Q9NtNX+xoFsPipBdrIwxgYRuXSNHW2DEnXG/xEeSiAT1HCp
 hFbGQCqWiSDvO4/kJUhA/oWTlY2D6j6+qtV4XTPMwuuAEsthazNe/1y0Y Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10374"; a="303131233"
X-IronPort-AV: E=Sophos;i="5.91,291,1647327600"; d="scan'208";a="303131233"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 14:19:20 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.91,291,1647327600"; d="scan'208";a="567006552"
Received: from vbelgaum-ubuntu.fm.intel.com ([10.1.27.27])
 by orsmga002.jf.intel.com with ESMTP; 10 Jun 2022 14:19:14 -0700
From: Vinay Belgaumkar <vinay.belgaumkar@intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Fri, 10 Jun 2022 14:18:17 -0700
Message-Id: <20220610211817.2909-1-vinay.belgaumkar@intel.com>

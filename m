...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 438B357BA0E
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 17:34:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9E7B38F4B2;
...
Subject: [Intel-gfx] [PATCH v4 25/41] drm-print: include dyndbg header
 indirectly

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id eGdHENrPimk/OAAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Feb 2026 07:27:38 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1C801175D4
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Feb 2026 07:27:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CACD710E1ED;
	Tue, 10 Feb 2026 06:27:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from a3b018990fe9 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E37B210E1C5;
 Tue, 10 Feb 2026 06:27:32 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============6068989580650572552=="
MIME-Version: 1.0
...
Date: Tue, 10 Feb 2026 06:27:32 -0000
Message-ID: <177070485289.240455.3648030588871672672@a3b018990fe9>
...
---------
  ...
  New tests have been introduced between CI_DRM_17919_full and Patchwork_159261v4_full:
...
#### Issues hit ####
  ...
  * igt@drm_buddy@drm_buddy:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk1/igt@drm_buddy@drm_buddy.html

  * igt@drm_buddy@drm_buddy@drm_test_buddy_fragmentation_performance:
    - shard-tglu:         NOTRUN -> [DMESG-WARN][2] ([i915#15095]) +1 other test dmesg-warn
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@drm_buddy@drm_buddy@drm_test_buddy_fragmentation_performance.html

  * igt@gem_bad_reloc@negative-reloc:
    - shard-rkl:          NOTRUN -> [SKIP][3] ([i915#3281]) +1 other test skip
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@gem_bad_reloc@negative-reloc.html

  * igt@gem_basic@multigpu-create-close:
    - shard-dg2:          NOTRUN -> [SKIP][4] ([i915#7697])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_basic@multigpu-create-close.html

  * igt@gem_ccs@block-multicopy-compressed:
    - shard-rkl:          NOTRUN -> [SKIP][5] ([i915#9323])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@gem_ccs@block-multicopy-compressed.html

  * igt@gem_ccs@large-ctrl-surf-copy:
    - shard-tglu:         NOTRUN -> [SKIP][6] ([i915#13008])
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@gem_ccs@large-ctrl-surf-copy.html

  * igt@gem_eio@throttle:
    - shard-dg1:          [PASS][7] -> [DMESG-WARN][8] ([i915#4423]) +1 other test dmesg-warn
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@gem_eio@throttle.html
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@gem_eio@throttle.html

  * igt@gem_exec_balancer@parallel:
    - shard-tglu:         NOTRUN -> [SKIP][9] ([i915#4525])
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@gem_exec_balancer@parallel.html

  * igt@gem_exec_capture@capture@vecs0-lmem0:
    - shard-dg2:          NOTRUN -> [FAIL][10] ([i915#11965]) +4 other tests fail
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_exec_capture@capture@vecs0-lmem0.html

  * igt@gem_exec_flush@basic-wb-rw-default:
    - shard-dg1:          NOTRUN -> [SKIP][11] ([i915#3539] / [i915#4852])
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@gem_exec_flush@basic-wb-rw-default.html

  * igt@gem_exec_reloc@basic-wc-cpu:
    - shard-dg2:          NOTRUN -> [SKIP][12] ([i915#3281]) +1 other test skip
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_exec_reloc@basic-wc-cpu.html

  * igt@gem_exec_reloc@basic-wc-cpu-noreloc:
    - shard-dg1:          NOTRUN -> [SKIP][13] ([i915#3281])
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@gem_exec_reloc@basic-wc-cpu-noreloc.html

  * igt@gem_lmem_swapping@heavy-verify-random:
    - shard-tglu:         NOTRUN -> [SKIP][14] ([i915#4613]) +2 other tests skip
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@gem_lmem_swapping@heavy-verify-random.html

  * igt@gem_lmem_swapping@random-engines:
    - shard-glk:          NOTRUN -> [SKIP][15] ([i915#4613]) +2 other tests skip
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk3/igt@gem_lmem_swapping@random-engines.html

  * igt@gem_mmap@pf-nonblock:
    - shard-mtlp:         NOTRUN -> [SKIP][16] ([i915#4083])
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@gem_mmap@pf-nonblock.html

  * igt@gem_mmap_gtt@big-copy-odd:
    - shard-dg1:          NOTRUN -> [SKIP][17] ([i915#4077])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@gem_mmap_gtt@big-copy-odd.html

  * igt@gem_mmap_offset@clear-via-pagefault:
    - shard-mtlp:         [PASS][18] -> [ABORT][19] ([i915#14809]) +1 other test abort
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-7/igt@gem_mmap_offset@clear-via-pagefault.html
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-6/igt@gem_mmap_offset@clear-via-pagefault.html

  * igt@gem_mmap_wc@write:
    - shard-dg2:          NOTRUN -> [SKIP][20] ([i915#4083])
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_mmap_wc@write.html

  * igt@gem_mmap_wc@write-prefaulted:
    - shard-dg1:          NOTRUN -> [SKIP][21] ([i915#4083])
   [21]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@gem_mmap_wc@write-prefaulted.html

  * igt@gem_pread@exhaustion:
    - shard-dg2:          NOTRUN -> [SKIP][22] ([i915#3282])
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_pread@exhaustion.html

  * igt@gem_pxp@hw-rejects-pxp-context:
    - shard-tglu-1:       NOTRUN -> [SKIP][23] ([i915#13398])
   [23]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@gem_pxp@hw-rejects-pxp-context.html

  * igt@gem_pxp@protected-encrypted-src-copy-not-readible:
    - shard-dg2:          NOTRUN -> [SKIP][24] ([i915#4270])
   [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_pxp@protected-encrypted-src-copy-not-readible.html

  * igt@gem_render_copy@yf-tiled-to-vebox-linear:
    - shard-dg2:          NOTRUN -> [SKIP][25] ([i915#5190] / [i915#8428]) +1 other test skip
   [25]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_render_copy@yf-tiled-to-vebox-linear.html

  * igt@gem_set_tiling_vs_gtt:
    - shard-dg2:          NOTRUN -> [SKIP][26] ([i915#4079])
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_set_tiling_vs_gtt.html

  * igt@gem_userptr_blits@coherency-sync:
    - shard-tglu:         NOTRUN -> [SKIP][27] ([i915#3297]) +2 other tests skip
   [27]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@gem_userptr_blits@coherency-sync.html

  * igt@gem_userptr_blits@dmabuf-sync:
    - shard-rkl:          NOTRUN -> [SKIP][28] ([i915#3297] / [i915#3323])
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@gem_userptr_blits@dmabuf-sync.html

  * igt@gem_userptr_blits@dmabuf-unsync:
    - shard-tglu-1:       NOTRUN -> [SKIP][29] ([i915#3297])
   [29]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@gem_userptr_blits@dmabuf-unsync.html

  * igt@gem_userptr_blits@unsync-unmap:
    - shard-rkl:          NOTRUN -> [SKIP][30] ([i915#3297])
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@gem_userptr_blits@unsync-unmap.html

  * igt@gen9_exec_parse@basic-rejected-ctx-param:
    - shard-rkl:          NOTRUN -> [SKIP][31] ([i915#2527])
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@gen9_exec_parse@basic-rejected-ctx-param.html

  * igt@gen9_exec_parse@bb-oversize:
    - shard-tglu-1:       NOTRUN -> [SKIP][32] ([i915#2527] / [i915#2856]) +2 other tests skip
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@gen9_exec_parse@bb-oversize.html

  * igt@gen9_exec_parse@secure-batches:
    - shard-tglu:         NOTRUN -> [SKIP][33] ([i915#2527] / [i915#2856]) +1 other test skip
   [33]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@gen9_exec_parse@secure-batches.html

  * igt@i915_module_load@fault-injection:
    - shard-dg1:          NOTRUN -> [ABORT][34] ([i915#11815] / [i915#15481]) +1 other test abort
   [34]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@i915_module_load@fault-injection.html

  * igt@i915_module_load@fault-injection@i915_driver_mmio_probe:
    - shard-dg1:          NOTRUN -> [INCOMPLETE][35] ([i915#15481])
   [35]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@i915_module_load@fault-injection@i915_driver_mmio_probe.html

  * igt@i915_module_load@fault-injection@intel_connector_register:
    - shard-tglu:         NOTRUN -> [ABORT][36] ([i915#15342]) +1 other test abort
   [36]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@i915_module_load@fault-injection@intel_connector_register.html

  * igt@i915_module_load@fault-injection@uc_fw_rsa_data_create:
    - shard-tglu:         NOTRUN -> [SKIP][37] ([i915#15479]) +4 other tests skip
   [37]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@i915_module_load@fault-injection@uc_fw_rsa_data_create.html

  * igt@i915_module_load@resize-bar:
    - shard-tglu-1:       NOTRUN -> [SKIP][38] ([i915#6412])
   [38]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@i915_module_load@resize-bar.html

  * igt@i915_pm_freq_api@freq-basic-api:
    - shard-rkl:          NOTRUN -> [SKIP][39] ([i915#8399])
   [39]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@i915_pm_freq_api@freq-basic-api.html

  * igt@i915_pm_rc6_residency@rc6-idle:
    - shard-tglu:         NOTRUN -> [SKIP][40] ([i915#14498])
   [40]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@i915_pm_rc6_residency@rc6-idle.html

  * igt@i915_pm_rpm@gem-evict-pwrite:
    - shard-dg2:          NOTRUN -> [SKIP][41] ([i915#4077])
   [41]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@i915_pm_rpm@gem-evict-pwrite.html

  * igt@i915_selftest@live@late_gt_pm:
    - shard-mtlp:         [PASS][42] -> [INCOMPLETE][43] ([i915#15680])
   [42]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-3/igt@i915_selftest@live@late_gt_pm.html
   [43]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-7/igt@i915_selftest@live@late_gt_pm.html

  * igt@i915_suspend@basic-s2idle-without-i915:
    - shard-dg1:          [PASS][44] -> [DMESG-WARN][45] ([i915#4391] / [i915#4423])
   [44]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-17/igt@i915_suspend@basic-s2idle-without-i915.html
   [45]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-13/igt@i915_suspend@basic-s2idle-without-i915.html

  * igt@i915_suspend@fence-restore-tiled2untiled:
    - shard-glk:          NOTRUN -> [INCOMPLETE][46] ([i915#4817])
   [46]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk1/igt@i915_suspend@fence-restore-tiled2untiled.html

  * igt@i915_suspend@forcewake:
    - shard-rkl:          [PASS][47] -> [INCOMPLETE][48] ([i915#4817])
   [47]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@i915_suspend@forcewake.html
   [48]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@i915_suspend@forcewake.html

  * igt@intel_hwmon@hwmon-write:
    - shard-tglu-1:       NOTRUN -> [SKIP][49] ([i915#7707])
   [49]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@intel_hwmon@hwmon-write.html

  * igt@kms_async_flips@test-cursor:
    - shard-mtlp:         NOTRUN -> [SKIP][50] ([i915#10333])
   [50]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@kms_async_flips@test-cursor.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-fencing:
    - shard-tglu:         [PASS][51] -> [FAIL][52] ([i915#15662]) +1 other test fail
   [51]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-10/igt@kms_atomic_transition@plane-all-modeset-transition-fencing.html
   [52]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-5/igt@kms_atomic_transition@plane-all-modeset-transition-fencing.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels:
    - shard-glk:          NOTRUN -> [SKIP][53] ([i915#1769])
   [53]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk3/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html

  * igt@kms_big_fb@4-tiled-32bpp-rotate-180:
    - shard-dg1:          NOTRUN -> [SKIP][54] ([i915#4538] / [i915#5286])
   [54]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_big_fb@4-tiled-32bpp-rotate-180.html

  * igt@kms_big_fb@4-tiled-64bpp-rotate-0:
    - shard-rkl:          NOTRUN -> [SKIP][55] ([i915#5286]) +1 other test skip
   [55]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_big_fb@4-tiled-64bpp-rotate-0.html

  * igt@kms_big_fb@4-tiled-max-hw-stride-32bpp-rotate-0-hflip:
    - shard-tglu:         NOTRUN -> [SKIP][56] ([i915#5286]) +2 other tests skip
   [56]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_big_fb@4-tiled-max-hw-stride-32bpp-rotate-0-hflip.html

  * igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-180-async-flip:
    - shard-tglu-1:       NOTRUN -> [SKIP][57] ([i915#5286]) +3 other tests skip
   [57]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_big_fb@4-tiled-max-hw-stride-64bpp-rotate-180-async-flip.html

  * igt@kms_big_fb@linear-64bpp-rotate-270:
    - shard-rkl:          NOTRUN -> [SKIP][58] ([i915#3638])
   [58]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_big_fb@linear-64bpp-rotate-270.html

  * igt@kms_big_fb@linear-max-hw-stride-32bpp-rotate-0-hflip:
    - shard-tglu:         NOTRUN -> [SKIP][59] ([i915#3828])
   [59]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_big_fb@linear-max-hw-stride-32bpp-rotate-0-hflip.html

  * igt@kms_big_fb@linear-max-hw-stride-32bpp-rotate-180-hflip:
    - shard-tglu-1:       NOTRUN -> [SKIP][60] ([i915#3828])
   [60]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_big_fb@linear-max-hw-stride-32bpp-rotate-180-hflip.html

  * igt@kms_big_fb@x-tiled-64bpp-rotate-270:
    - shard-dg1:          NOTRUN -> [SKIP][61] ([i915#3638])
   [61]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_big_fb@x-tiled-64bpp-rotate-270.html

  * igt@kms_big_fb@yf-tiled-16bpp-rotate-0:
    - shard-dg2:          NOTRUN -> [SKIP][62] ([i915#4538] / [i915#5190]) +2 other tests skip
   [62]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_big_fb@yf-tiled-16bpp-rotate-0.html

  * igt@kms_big_fb@yf-tiled-64bpp-rotate-180:
    - shard-glk:          NOTRUN -> [SKIP][63] +228 other tests skip
   [63]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk1/igt@kms_big_fb@yf-tiled-64bpp-rotate-180.html

  * igt@kms_big_fb@yf-tiled-addfb-size-offset-overflow:
    - shard-tglu-1:       NOTRUN -> [SKIP][64] +28 other tests skip
   [64]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_big_fb@yf-tiled-addfb-size-offset-overflow.html

  * igt@kms_ccs@ccs-on-another-bo-y-tiled-ccs@pipe-b-edp-1:
    - shard-mtlp:         NOTRUN -> [SKIP][65] ([i915#6095]) +9 other tests skip
   [65]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@kms_ccs@ccs-on-another-bo-y-tiled-ccs@pipe-b-edp-1.html

  * igt@kms_ccs@crc-primary-basic-4-tiled-dg2-rc-ccs-cc@pipe-c-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][66] ([i915#6095]) +67 other tests skip
   [66]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-5/igt@kms_ccs@crc-primary-basic-4-tiled-dg2-rc-ccs-cc@pipe-c-hdmi-a-3.html
  ...
  * igt@kms_ccs@crc-primary-basic-4-tiled-mtl-rc-ccs-cc@pipe-b-hdmi-a-1:
   ...
   [67]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_ccs@crc-primary-basic-4-tiled-mtl-rc-ccs-cc@pipe-b-hdmi-a-1.html

  * igt@kms_ccs@crc-primary-basic-y-tiled-gen12-rc-ccs@pipe-d-hdmi-a-1:
    - shard-dg2:          NOTRUN -> [SKIP][68] ([i915#10307] / [i915#10434] / [i915#6095]) +2 other tests skip
   [68]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-4/igt@kms_ccs@crc-primary-basic-y-tiled-gen12-rc-ccs@pipe-d-hdmi-a-1.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][69] ([i915#6095]) +77 other tests skip
   [69]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-4/igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@crc-primary-suspend-4-tiled-mtl-rc-ccs-cc@pipe-c-hdmi-a-1:
    - shard-tglu-1:       NOTRUN -> [SKIP][70] ([i915#6095]) +29 other tests skip
   [70]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_ccs@crc-primary-suspend-4-tiled-mtl-rc-ccs-cc@pipe-c-hdmi-a-1.html

  * igt@kms_ccs@crc-primary-suspend-yf-tiled-ccs:
    - shard-glk:          NOTRUN -> [INCOMPLETE][71] ([i915#14694] / [i915#15582]) +1 other test incomplete
   [71]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk3/igt@kms_ccs@crc-primary-suspend-yf-tiled-ccs.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][72] ([i915#10307] / [i915#6095]) +180 other tests skip
   [72]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-3.html

  * igt@kms_ccs@crc-sprite-planes-basic-y-tiled-ccs@pipe-c-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [SKIP][73] ([i915#14098] / [i915#6095]) +44 other tests skip
   [73]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@kms_ccs@crc-sprite-planes-basic-y-tiled-ccs@pipe-c-hdmi-a-1.html

  * igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs:
    - shard-tglu-1:       NOTRUN -> [SKIP][74] ([i915#12313])
   [74]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs.html

  * igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][75] ([i915#14544] / [i915#6095]) +1 other test skip
   [75]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-c-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][76] ([i915#14098] / [i915#14544] / [i915#6095])
   [76]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-c-hdmi-a-2.html

  * igt@kms_ccs@random-ccs-data-yf-tiled-ccs@pipe-a-hdmi-a-3:
    - shard-dg1:          NOTRUN -> [SKIP][77] ([i915#6095]) +163 other tests skip
   [77]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-13/igt@kms_ccs@random-ccs-data-yf-tiled-ccs@pipe-a-hdmi-a-3.html

  * igt@kms_cdclk@mode-transition-all-outputs:
    - shard-tglu-1:       NOTRUN -> [SKIP][78] ([i915#3742])
   [78]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_cdclk@mode-transition-all-outputs.html

  * igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][79] ([i915#13781]) +4 other tests skip
   [79]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-3.html

  * igt@kms_cdclk@plane-scaling@pipe-c-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][80] ([i915#13783]) +3 other tests skip
   [80]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-8/igt@kms_cdclk@plane-scaling@pipe-c-hdmi-a-3.html

  * igt@kms_chamelium_audio@hdmi-audio-edid:
    - shard-tglu-1:       NOTRUN -> [SKIP][81] ([i915#11151] / [i915#7828]) +4 other tests skip
   [81]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_chamelium_audio@hdmi-audio-edid.html

  * igt@kms_chamelium_color@ctm-negative:
    - shard-rkl:          NOTRUN -> [SKIP][82] +7 other tests skip
   [82]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_chamelium_color@ctm-negative.html

  * igt@kms_chamelium_hpd@dp-hpd-for-each-pipe:
    - shard-dg2:          NOTRUN -> [SKIP][83] ([i915#11151] / [i915#7828]) +1 other test skip
   [83]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_chamelium_hpd@dp-hpd-for-each-pipe.html

  * igt@kms_chamelium_hpd@hdmi-hpd-with-enabled-mode:
    - shard-rkl:          NOTRUN -> [SKIP][84] ([i915#11151] / [i915#7828]) +1 other test skip
   [84]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_chamelium_hpd@hdmi-hpd-with-enabled-mode.html

  * igt@kms_chamelium_hpd@vga-hpd-without-ddc:
    - shard-tglu:         NOTRUN -> [SKIP][85] ([i915#11151] / [i915#7828]) +4 other tests skip
   [85]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_chamelium_hpd@vga-hpd-without-ddc.html

  * igt@kms_color@deep-color:
    - shard-tglu-1:       NOTRUN -> [SKIP][86] ([i915#3555] / [i915#9979])
   [86]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_color@deep-color.html

  * igt@kms_content_protection@dp-mst-lic-type-0:
    - shard-rkl:          NOTRUN -> [SKIP][87] ([i915#15330] / [i915#3116])
   [87]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_content_protection@dp-mst-lic-type-0.html

  * igt@kms_content_protection@dp-mst-lic-type-0-hdcp14:
    - shard-tglu-1:       NOTRUN -> [SKIP][88] ([i915#15330])
   [88]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_content_protection@dp-mst-lic-type-0-hdcp14.html

  * igt@kms_content_protection@dp-mst-lic-type-1:
    - shard-tglu-1:       NOTRUN -> [SKIP][89] ([i915#15330] / [i915#3116] / [i915#3299])
   [89]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_content_protection@dp-mst-lic-type-1.html

  * igt@kms_content_protection@legacy-hdcp14:
    - shard-tglu:         NOTRUN -> [SKIP][90] ([i915#6944])
   [90]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_content_protection@legacy-hdcp14.html

  * igt@kms_content_protection@legacy@pipe-a-dp-3:
    - shard-dg2:          NOTRUN -> [FAIL][91] ([i915#7173])
   [91]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-11/igt@kms_content_protection@legacy@pipe-a-dp-3.html

  * igt@kms_content_protection@lic-type-0:
    - shard-tglu:         NOTRUN -> [SKIP][92] ([i915#6944] / [i915#9424])
   [92]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_content_protection@lic-type-0.html

  * igt@kms_content_protection@uevent:
    - shard-dg2:          NOTRUN -> [SKIP][93] ([i915#6944] / [i915#7118] / [i915#9424])
   [93]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_content_protection@uevent.html

  * igt@kms_cursor_crc@cursor-offscreen-512x170:
    - shard-tglu:         NOTRUN -> [SKIP][94] ([i915#13049])
   [94]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_cursor_crc@cursor-offscreen-512x170.html

  * igt@kms_cursor_crc@cursor-random-512x170:
    - shard-tglu-1:       NOTRUN -> [SKIP][95] ([i915#13049]) +1 other test skip
   [95]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_cursor_crc@cursor-random-512x170.html

  * igt@kms_cursor_crc@cursor-rapid-movement-32x32:
    - shard-tglu:         NOTRUN -> [SKIP][96] ([i915#3555]) +1 other test skip
   [96]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_cursor_crc@cursor-rapid-movement-32x32.html

  * igt@kms_cursor_crc@cursor-rapid-movement-512x512:
    - shard-dg2:          NOTRUN -> [SKIP][97] ([i915#13049])
   [97]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_cursor_crc@cursor-rapid-movement-512x512.html

  * igt@kms_cursor_crc@cursor-rapid-movement-max-size:
    - shard-dg1:          NOTRUN -> [SKIP][98] ([i915#3555])
   [98]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_cursor_crc@cursor-rapid-movement-max-size.html

  * igt@kms_cursor_crc@cursor-sliding-128x42@pipe-a-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [FAIL][99] ([i915#13566]) +2 other tests fail
   [99]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_cursor_crc@cursor-sliding-128x42@pipe-a-hdmi-a-1.html

  * igt@kms_cursor_legacy@basic-busy-flip-before-cursor-legacy:
    - shard-tglu:         NOTRUN -> [SKIP][100] ([i915#4103])
   [100]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_cursor_legacy@basic-busy-flip-before-cursor-legacy.html

  * igt@kms_cursor_legacy@cursora-vs-flipb-atomic-transitions:
    - shard-dg2:          NOTRUN -> [SKIP][101] ([i915#13046] / [i915#5354]) +1 other test skip
   [101]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_cursor_legacy@cursora-vs-flipb-atomic-transitions.html

  * igt@kms_cursor_legacy@cursorb-vs-flipb-atomic-transitions-varying-size:
    - shard-dg1:          NOTRUN -> [SKIP][102] +2 other tests skip
   [102]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_cursor_legacy@cursorb-vs-flipb-atomic-transitions-varying-size.html

  * igt@kms_dirtyfb@drrs-dirtyfb-ioctl:
    - shard-rkl:          NOTRUN -> [SKIP][103] ([i915#9723])
   [103]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@kms_dirtyfb@drrs-dirtyfb-ioctl.html

  * igt@kms_dither@fb-8bpc-vs-panel-8bpc:
    - shard-dg2:          [PASS][104] -> [SKIP][105] ([i915#3555])
   [104]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-11/igt@kms_dither@fb-8bpc-vs-panel-8bpc.html
   [105]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-5/igt@kms_dither@fb-8bpc-vs-panel-8bpc.html

  * igt@kms_dp_link_training@uhbr-mst:
    - shard-rkl:          NOTRUN -> [SKIP][106] ([i915#13748])
   [106]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_dp_link_training@uhbr-mst.html

  * igt@kms_dp_link_training@uhbr-sst:
    - shard-tglu-1:       NOTRUN -> [SKIP][107] ([i915#13748])
   [107]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_dp_link_training@uhbr-sst.html

  * igt@kms_dp_linktrain_fallback@dp-fallback:
    - shard-dg2:          [PASS][108] -> [SKIP][109] ([i915#13707])
   [108]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-10/igt@kms_dp_linktrain_fallback@dp-fallback.html
   [109]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_dp_linktrain_fallback@dp-fallback.html
    - shard-tglu-1:       NOTRUN -> [SKIP][110] ([i915#13707])
   [110]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_dp_linktrain_fallback@dp-fallback.html

  * igt@kms_dsc@dsc-with-bpc-formats:
    - shard-dg2:          NOTRUN -> [SKIP][111] ([i915#3555] / [i915#3840])
   [111]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_dsc@dsc-with-bpc-formats.html

  * igt@kms_fbcon_fbt@psr-suspend:
    - shard-tglu:         NOTRUN -> [SKIP][112] ([i915#3469])
   [112]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_fbcon_fbt@psr-suspend.html

  * igt@kms_feature_discovery@chamelium:
    - shard-tglu-1:       NOTRUN -> [SKIP][113] ([i915#2065] / [i915#4854])
   [113]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_feature_discovery@chamelium.html

  * igt@kms_flip@2x-absolute-wf_vblank-interruptible:
    - shard-rkl:          NOTRUN -> [SKIP][114] ([i915#9934])
   [114]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_flip@2x-absolute-wf_vblank-interruptible.html

  * igt@kms_flip@2x-flip-vs-fences-interruptible:
    - shard-mtlp:         NOTRUN -> [SKIP][115] ([i915#8381])
   [115]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@kms_flip@2x-flip-vs-fences-interruptible.html

  * igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1:
    - shard-snb:          [PASS][116] -> [TIMEOUT][117] ([i915#14033]) +1 other test timeout
   [116]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-snb7/igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1.html
   [117]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-snb6/igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1.html

  * igt@kms_flip@2x-flip-vs-wf_vblank:
    - shard-dg2:          NOTRUN -> [SKIP][118] ([i915#9934])
   [118]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_flip@2x-flip-vs-wf_vblank.html

  * igt@kms_flip@2x-plain-flip:
    - shard-tglu:         NOTRUN -> [SKIP][119] ([i915#3637] / [i915#9934]) +1 other test skip
   [119]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_flip@2x-plain-flip.html
    - shard-mtlp:         NOTRUN -> [SKIP][120] ([i915#3637] / [i915#9934])
   [120]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@kms_flip@2x-plain-flip.html

  * igt@kms_flip@2x-single-buffer-flip-vs-dpms-off-vs-modeset-interruptible:
    - shard-tglu-1:       NOTRUN -> [SKIP][121] ([i915#3637] / [i915#9934]) +3 other tests skip
   [121]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_flip@2x-single-buffer-flip-vs-dpms-off-vs-modeset-interruptible.html

  * igt@kms_flip@flip-vs-suspend:
    - shard-rkl:          [PASS][122] -> [INCOMPLETE][123] ([i915#6113]) +1 other test incomplete
   [122]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_flip@flip-vs-suspend.html
   [123]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_flip@flip-vs-suspend.html

  * igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-downscaling:
    - shard-tglu-1:       NOTRUN -> [SKIP][124] ([i915#15643])
   [124]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-32bpp-4tiledg2rcccs-downscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling:
    - shard-tglu:         NOTRUN -> [SKIP][125] ([i915#15643]) +2 other tests skip
   [125]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-4/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling:
    - shard-rkl:          NOTRUN -> [SKIP][126] ([i915#15643]) +2 other tests skip
   [126]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling.html

  * igt@kms_frontbuffer_tracking@fbc-1p-offscreen-pri-shrfb-draw-mmap-gtt:
    - shard-dg2:          NOTRUN -> [SKIP][127] ([i915#15104])
   [127]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_frontbuffer_tracking@fbc-1p-offscreen-pri-shrfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-1p-primscrn-cur-indfb-draw-mmap-gtt:
    - shard-dg2:          NOTRUN -> [SKIP][128] ([i915#8708]) +3 other tests skip
   [128]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_frontbuffer_tracking@fbc-1p-primscrn-cur-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-2p-primscrn-pri-indfb-draw-mmap-wc:
    - shard-mtlp:         NOTRUN -> [SKIP][129] ([i915#1825])
   [129]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@kms_frontbuffer_tracking@fbc-2p-primscrn-pri-indfb-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt:
    - shard-tglu:         NOTRUN -> [SKIP][130] ([i915#15574]) +2 other tests skip
   [130]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html
    - shard-dg1:          NOTRUN -> [SKIP][131] ([i915#15574])
   [131]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-wc:
    - shard-rkl:          NOTRUN -> [SKIP][132] ([i915#15574])
   [132]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-render:
    - shard-tglu-1:       NOTRUN -> [SKIP][133] ([i915#15574])
   [133]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-render.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-shrfb-draw-pwrite:
    - shard-rkl:          NOTRUN -> [SKIP][134] ([i915#15102])
   [134]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-shrfb-draw-pwrite.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-cur-indfb-draw-blt:
    - shard-tglu:         NOTRUN -> [SKIP][135] ([i915#15102]) +8 other tests skip
   [135]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-cur-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-fullscreen:
    - shard-tglu:         NOTRUN -> [SKIP][136] +38 other tests skip
   [136]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-fullscreen.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-onoff:
    - shard-rkl:          NOTRUN -> [SKIP][137] ([i915#1825]) +8 other tests skip
   [137]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-onoff.html

  * igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-blt:
    - shard-dg2:          NOTRUN -> [SKIP][138] ([i915#15102]) +1 other test skip
   [138]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@psr-1p-pri-indfb-multidraw:
    - shard-dg2:          NOTRUN -> [SKIP][139] ([i915#15102] / [i915#3458]) +3 other tests skip
   [139]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_frontbuffer_tracking@psr-1p-pri-indfb-multidraw.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-draw-mmap-wc:
    - shard-tglu-1:       NOTRUN -> [SKIP][140] ([i915#15102]) +7 other tests skip
   [140]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-indfb-draw-blt:
    - shard-dg1:          NOTRUN -> [SKIP][141] ([i915#15102] / [i915#3458])
   [141]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@psr-2p-primscrn-spr-indfb-draw-pwrite:
    - shard-dg2:          NOTRUN -> [SKIP][142] ([i915#5354]) +7 other tests skip
   [142]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_frontbuffer_tracking@psr-2p-primscrn-spr-indfb-draw-pwrite.html

  * igt@kms_frontbuffer_tracking@psr-rgb565-draw-render:
    - shard-rkl:          NOTRUN -> [SKIP][143] ([i915#15102] / [i915#3023]) +5 other tests skip
   [143]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@kms_frontbuffer_tracking@psr-rgb565-draw-render.html

  * igt@kms_hdr@bpc-switch:
    - shard-dg2:          [PASS][144] -> [SKIP][145] ([i915#3555] / [i915#8228])
   [144]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-10/igt@kms_hdr@bpc-switch.html
   [145]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-4/igt@kms_hdr@bpc-switch.html

  * igt@kms_hdr@bpc-switch-suspend:
    - shard-tglu:         NOTRUN -> [SKIP][146] ([i915#3555] / [i915#8228])
   [146]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_hdr@bpc-switch-suspend.html

  * igt@kms_hdr@invalid-hdr:
    - shard-rkl:          NOTRUN -> [SKIP][147] ([i915#3555] / [i915#8228])
   [147]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_hdr@invalid-hdr.html

  * igt@kms_hdr@invalid-metadata-sizes:
    - shard-rkl:          [PASS][148] -> [SKIP][149] ([i915#3555] / [i915#8228])
   [148]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_hdr@invalid-metadata-sizes.html
   [149]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_hdr@invalid-metadata-sizes.html

  * igt@kms_hdr@static-toggle-suspend:
    - shard-tglu-1:       NOTRUN -> [SKIP][150] ([i915#3555] / [i915#8228])
   [150]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_hdr@static-toggle-suspend.html

  * igt@kms_joiner@basic-force-ultra-joiner:
    - shard-dg1:          NOTRUN -> [SKIP][151] ([i915#15458])
   [151]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_joiner@basic-force-ultra-joiner.html
    - shard-tglu:         NOTRUN -> [SKIP][152] ([i915#15458])
   [152]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_joiner@basic-force-ultra-joiner.html

  * igt@kms_joiner@invalid-modeset-big-joiner:
    - shard-tglu-1:       NOTRUN -> [SKIP][153] ([i915#15460])
   [153]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_joiner@invalid-modeset-big-joiner.html

  * igt@kms_joiner@invalid-modeset-force-big-joiner:
    - shard-tglu:         NOTRUN -> [SKIP][154] ([i915#15459])
   [154]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_joiner@invalid-modeset-force-big-joiner.html

  * igt@kms_joiner@invalid-modeset-ultra-joiner:
    - shard-dg2:          NOTRUN -> [SKIP][155] ([i915#15458])
   [155]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_joiner@invalid-modeset-ultra-joiner.html

  * igt@kms_joiner@switch-modeset-ultra-joiner-big-joiner:
    - shard-rkl:          NOTRUN -> [SKIP][156] ([i915#15638])
   [156]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_joiner@switch-modeset-ultra-joiner-big-joiner.html

  * igt@kms_panel_fitting@atomic-fastset:
    - shard-tglu-1:       NOTRUN -> [SKIP][157] ([i915#6301]) +1 other test skip
   [157]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_panel_fitting@atomic-fastset.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping:
    - shard-dg2:          NOTRUN -> [SKIP][158] ([i915#15608] / [i915#15609] / [i915#8825])
   [158]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping.html
  ...
  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-a-plane-5:
   ...
   [159]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-a-plane-5.html
  ...
  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-0:
   ...
   [160]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-0.html
  ...
  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-5:
   ...
   [161]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-modifier@pipe-b-plane-5:
    - shard-rkl:          NOTRUN -> [SKIP][162] ([i915#15608] / [i915#8825]) +1 other test skip
   [162]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-modifier@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-mtl-rc-ccs-modifier-source-clamping:
    - shard-tglu-1:       NOTRUN -> [SKIP][163] ([i915#15608] / [i915#15609] / [i915#8825])
   [163]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_plane@pixel-format-4-tiled-mtl-rc-ccs-modifier-source-clamping.html

  * igt@kms_plane@pixel-format-4-tiled-mtl-rc-ccs-modifier-source-clamping@pipe-b-plane-3:
    - shard-tglu-1:       NOTRUN -> [SKIP][164] ([i915#15608]) +5 other tests skip
   [164]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_plane@pixel-format-4-tiled-mtl-rc-ccs-modifier-source-clamping@pipe-b-plane-3.html

  * igt@kms_plane@pixel-format-4-tiled-mtl-rc-ccs-modifier-source-clamping@pipe-b-plane-7:
    - shard-tglu-1:       NOTRUN -> [SKIP][165] ([i915#15609] / [i915#8825])
   [165]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_plane@pixel-format-4-tiled-mtl-rc-ccs-modifier-source-clamping@pipe-b-plane-7.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier:
    - shard-dg1:          NOTRUN -> [SKIP][166] ([i915#15608] / [i915#8825]) +1 other test skip
   [166]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html
    - shard-tglu:         NOTRUN -> [SKIP][167] ([i915#15608] / [i915#8825]) +5 other tests skip
   [167]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping:
    - shard-tglu:         NOTRUN -> [SKIP][168] ([i915#15608] / [i915#15609] / [i915#8825])
   [168]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping@pipe-a-plane-3:
    - shard-tglu:         NOTRUN -> [SKIP][169] ([i915#15608]) +28 other tests skip
   [169]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping@pipe-a-plane-3.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping@pipe-a-plane-7:
    - shard-tglu:         NOTRUN -> [SKIP][170] ([i915#15609])
   [170]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping@pipe-a-plane-7.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping@pipe-b-plane-7:
    - shard-tglu:         NOTRUN -> [SKIP][171] ([i915#15609] / [i915#8825])
   [171]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_plane@pixel-format-y-tiled-ccs-modifier-source-clamping@pipe-b-plane-7.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier@pipe-b-plane-5:
    - shard-dg1:          NOTRUN -> [SKIP][172] ([i915#15608]) +6 other tests skip
   [172]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_plane@pixel-format-y-tiled-ccs-modifier@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-modifier-source-clamping@pipe-b-plane-7:
    - shard-tglu-1:       NOTRUN -> [SKIP][173] ([i915#15609]) +2 other tests skip
   [173]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-modifier-source-clamping@pipe-b-plane-7.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-modifier@pipe-b-plane-5:
    - shard-rkl:          NOTRUN -> [SKIP][174] ([i915#15608]) +6 other tests skip
   [174]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-modifier@pipe-b-plane-5.html

  * igt@kms_plane_alpha_blend@constant-alpha-max:
    - shard-glk:          NOTRUN -> [FAIL][175] ([i915#10647] / [i915#12169])
   [175]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk3/igt@kms_plane_alpha_blend@constant-alpha-max.html

  * igt@kms_plane_alpha_blend@constant-alpha-max@pipe-c-hdmi-a-1:
    - shard-glk:          NOTRUN -> [FAIL][176] ([i915#10647]) +1 other test fail
   [176]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk3/igt@kms_plane_alpha_blend@constant-alpha-max@pipe-c-hdmi-a-1.html

  * igt@kms_plane_multiple@2x-tiling-y:
    - shard-tglu-1:       NOTRUN -> [SKIP][177] ([i915#13958])
   [177]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_plane_multiple@2x-tiling-y.html

  * igt@kms_plane_scaling@intel-max-src-size:
    - shard-rkl:          [PASS][178] -> [SKIP][179] ([i915#6953])
   [178]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane_scaling@intel-max-src-size.html
   [179]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_plane_scaling@intel-max-src-size.html

  * igt@kms_plane_scaling@plane-scaler-unity-scaling-with-rotation@pipe-b:
    - shard-tglu-1:       NOTRUN -> [SKIP][180] ([i915#15329]) +4 other tests skip
   [180]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_plane_scaling@plane-scaler-unity-scaling-with-rotation@pipe-b.html

  * igt@kms_plane_scaling@plane-upscale-factor-0-25-with-rotation@pipe-c:
    - shard-rkl:          NOTRUN -> [SKIP][181] ([i915#15329]) +3 other tests skip
   [181]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_plane_scaling@plane-upscale-factor-0-25-with-rotation@pipe-c.html

  * igt@kms_pm_backlight@basic-brightness:
    - shard-tglu-1:       NOTRUN -> [SKIP][182] ([i915#9812])
   [182]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_pm_backlight@basic-brightness.html

  * igt@kms_pm_dc@dc6-dpms:
    - shard-tglu:         NOTRUN -> [FAIL][183] ([i915#9295])
   [183]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-3/igt@kms_pm_dc@dc6-dpms.html

  * igt@kms_pm_dc@dc9-dpms:
    - shard-tglu-1:       NOTRUN -> [SKIP][184] ([i915#4281])
   [184]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_pm_dc@dc9-dpms.html

  * igt@kms_pm_rpm@dpms-non-lpsp:
    - shard-dg2:          [PASS][185] -> [SKIP][186] ([i915#15073])
   [185]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-6/igt@kms_pm_rpm@dpms-non-lpsp.html
   [186]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-4/igt@kms_pm_rpm@dpms-non-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress:
    - shard-dg1:          [PASS][187] -> [SKIP][188] ([i915#15073])
   [187]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-13/igt@kms_pm_rpm@modeset-non-lpsp-stress.html
   [188]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-14/igt@kms_pm_rpm@modeset-non-lpsp-stress.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait:
    - shard-tglu:         NOTRUN -> [SKIP][189] ([i915#15073]) +1 other test skip
   [189]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html

  * igt@kms_pm_rpm@pc8-residency:
    - shard-dg2:          NOTRUN -> [SKIP][190] +3 other tests skip
   [190]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_pm_rpm@pc8-residency.html

  * igt@kms_prime@basic-crc-hybrid:
    - shard-rkl:          NOTRUN -> [SKIP][191] ([i915#6524])
   [191]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@kms_prime@basic-crc-hybrid.html

  * igt@kms_psr2_sf@fbc-psr2-cursor-plane-move-continuous-exceed-sf:
    - shard-tglu-1:       NOTRUN -> [SKIP][192] ([i915#11520]) +3 other tests skip
   [192]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_psr2_sf@fbc-psr2-cursor-plane-move-continuous-exceed-sf.html

  * igt@kms_psr2_sf@fbc-psr2-overlay-plane-move-continuous-sf:
    - shard-glk:          NOTRUN -> [SKIP][193] ([i915#11520]) +4 other tests skip
   [193]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk3/igt@kms_psr2_sf@fbc-psr2-overlay-plane-move-continuous-sf.html

  * igt@kms_psr2_sf@fbc-psr2-overlay-primary-update-sf-dmg-area:
    - shard-rkl:          NOTRUN -> [SKIP][194] ([i915#11520]) +1 other test skip
   [194]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@kms_psr2_sf@fbc-psr2-overlay-primary-update-sf-dmg-area.html

  * igt@kms_psr2_sf@pr-cursor-plane-update-sf:
    - shard-tglu:         NOTRUN -> [SKIP][195] ([i915#11520]) +5 other tests skip
   [195]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_psr2_sf@pr-cursor-plane-update-sf.html

  * igt@kms_psr2_sf@psr2-overlay-primary-update-sf-dmg-area:
    - shard-dg2:          NOTRUN -> [SKIP][196] ([i915#11520]) +2 other tests skip
   [196]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_psr2_sf@psr2-overlay-primary-update-sf-dmg-area.html

  * igt@kms_psr@fbc-psr-basic:
    - shard-dg2:          NOTRUN -> [SKIP][197] ([i915#1072] / [i915#9732]) +3 other tests skip
   [197]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_psr@fbc-psr-basic.html

  * igt@kms_psr@fbc-psr2-dpms:
    - shard-mtlp:         NOTRUN -> [SKIP][198] ([i915#9688]) +1 other test skip
   [198]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@kms_psr@fbc-psr2-dpms.html

  * igt@kms_psr@pr-primary-page-flip:
    - shard-tglu:         NOTRUN -> [SKIP][199] ([i915#9732]) +12 other tests skip
   [199]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_psr@pr-primary-page-flip.html

  * igt@kms_psr@pr-sprite-plane-onoff:
    - shard-tglu-1:       NOTRUN -> [SKIP][200] ([i915#9732]) +9 other tests skip
   [200]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_psr@pr-sprite-plane-onoff.html

  * igt@kms_psr@psr-cursor-render:
    - shard-rkl:          NOTRUN -> [SKIP][201] ([i915#1072] / [i915#9732]) +8 other tests skip
   [201]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_psr@psr-cursor-render.html

  * igt@kms_psr@psr-sprite-render:
    - shard-dg1:          NOTRUN -> [SKIP][202] ([i915#1072] / [i915#9732]) +2 other tests skip
   [202]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-17/igt@kms_psr@psr-sprite-render.html

  * igt@kms_rotation_crc@multiplane-rotation-cropping-top:
    - shard-glk:          NOTRUN -> [INCOMPLETE][203] ([i915#15492])
   [203]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk3/igt@kms_rotation_crc@multiplane-rotation-cropping-top.html

  * igt@kms_rotation_crc@primary-4-tiled-reflect-x-0:
    - shard-rkl:          NOTRUN -> [SKIP][204] ([i915#5289])
   [204]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@kms_rotation_crc@primary-4-tiled-reflect-x-0.html

  * igt@kms_scaling_modes@scaling-mode-none:
    - shard-tglu-1:       NOTRUN -> [SKIP][205] ([i915#3555]) +3 other tests skip
   [205]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_scaling_modes@scaling-mode-none.html

  * igt@kms_setmode@basic-clone-single-crtc:
    - shard-dg2:          NOTRUN -> [SKIP][206] ([i915#3555]) +1 other test skip
   [206]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@kms_setmode@basic-clone-single-crtc.html

  * igt@kms_tiled_display@basic-test-pattern:
    - shard-tglu-1:       NOTRUN -> [SKIP][207] ([i915#8623])
   [207]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_tiled_display@basic-test-pattern.html

  * igt@kms_tiled_display@basic-test-pattern-with-chamelium:
    - shard-rkl:          NOTRUN -> [SKIP][208] ([i915#8623])
   [208]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_tiled_display@basic-test-pattern-with-chamelium.html
    - shard-tglu:         NOTRUN -> [SKIP][209] ([i915#8623])
   [209]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-4/igt@kms_tiled_display@basic-test-pattern-with-chamelium.html

  * igt@kms_vrr@max-min:
    - shard-tglu:         NOTRUN -> [SKIP][210] ([i915#9906])
   [210]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@kms_vrr@max-min.html

  * igt@kms_vrr@seamless-rr-switch-virtual:
    - shard-tglu-1:       NOTRUN -> [SKIP][211] ([i915#9906])
   [211]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-1/igt@kms_vrr@seamless-rr-switch-virtual.html

  * igt@perf_pmu@module-unload:
    - shard-glk:          NOTRUN -> [FAIL][212] ([i915#14433])
   [212]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-glk1/igt@perf_pmu@module-unload.html
    - shard-tglu:         NOTRUN -> [FAIL][213] ([i915#14433])
   [213]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@perf_pmu@module-unload.html

  * igt@perf_pmu@rc6@other-idle-gt0:
    - shard-tglu:         NOTRUN -> [SKIP][214] ([i915#8516])
   [214]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-10/igt@perf_pmu@rc6@other-idle-gt0.html

  * igt@prime_vgem@basic-read:
    - shard-mtlp:         NOTRUN -> [SKIP][215] ([i915#3708])
   [215]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@prime_vgem@basic-read.html

  * igt@prime_vgem@coherency-gtt:
    - shard-mtlp:         NOTRUN -> [SKIP][216] ([i915#3708] / [i915#4077])
   [216]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@prime_vgem@coherency-gtt.html
...
#### Possible fixes ####
  ...
  * igt@gem_exec_suspend@basic-s0:
   ...
   [217]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-7/igt@gem_exec_suspend@basic-s0.html
   [218]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-1/igt@gem_exec_suspend@basic-s0.html

  * igt@gem_workarounds@suspend-resume-fd:
    - shard-rkl:          [INCOMPLETE][219] ([i915#13356]) -> [PASS][220]
   [219]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_workarounds@suspend-resume-fd.html
   [220]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@gem_workarounds@suspend-resume-fd.html

  * igt@i915_power@sanity:
    - shard-mtlp:         [SKIP][221] ([i915#7984]) -> [PASS][222]
   [221]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-5/igt@i915_power@sanity.html
   [222]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-3/igt@i915_power@sanity.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels:
    - shard-mtlp:         [FAIL][223] ([i915#5956]) -> [PASS][224] +1 other test pass
   [223]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-7/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html
   [224]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-6/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html

  * igt@kms_cursor_legacy@cursor-vs-flip-atomic:
    - shard-dg1:          [DMESG-WARN][225] ([i915#4423]) -> [PASS][226] +3 other tests pass
   [225]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-15/igt@kms_cursor_legacy@cursor-vs-flip-atomic.html
   [226]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-14/igt@kms_cursor_legacy@cursor-vs-flip-atomic.html

  * igt@kms_flip@plain-flip-interruptible:
    - shard-tglu:         [ABORT][227] ([i915#15470]) -> [PASS][228]
   [227]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible.html
   [228]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-4/igt@kms_flip@plain-flip-interruptible.html

  * igt@kms_flip@plain-flip-interruptible@a-hdmi-a1:
    - shard-tglu:         [DMESG-WARN][229] ([i915#15470]) -> [PASS][230]
   [229]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible@a-hdmi-a1.html
   [230]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-4/igt@kms_flip@plain-flip-interruptible@a-hdmi-a1.html

  * igt@kms_flip@plain-flip-interruptible@c-hdmi-a1:
    - shard-tglu:         [DMESG-WARN][231] -> [PASS][232] +1 other test pass
   [231]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible@c-hdmi-a1.html
   [232]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-4/igt@kms_flip@plain-flip-interruptible@c-hdmi-a1.html

  * igt@kms_flip@plain-flip-interruptible@d-hdmi-a1:
    - shard-tglu:         [ABORT][233] -> [PASS][234]
   [233]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible@d-hdmi-a1.html
   [234]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-tglu-4/igt@kms_flip@plain-flip-interruptible@d-hdmi-a1.html

  * igt@kms_hdr@bpc-switch-dpms:
    - shard-dg2:          [SKIP][235] ([i915#3555] / [i915#8228]) -> [PASS][236] +1 other test pass
   [235]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-5/igt@kms_hdr@bpc-switch-dpms.html
   [236]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-11/igt@kms_hdr@bpc-switch-dpms.html

  * igt@kms_hdr@static-toggle:
    - shard-rkl:          [SKIP][237] ([i915#3555] / [i915#8228]) -> [PASS][238] +1 other test pass
   [237]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-8/igt@kms_hdr@static-toggle.html
   [238]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-1/igt@kms_hdr@static-toggle.html

  * igt@kms_pm_dc@dc9-dpms:
    - shard-dg1:          [DMESG-FAIL][239] ([i915#4423]) -> [PASS][240]
   [239]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_pm_dc@dc9-dpms.html
   [240]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-16/igt@kms_pm_dc@dc9-dpms.html

  * igt@kms_pm_rpm@dpms-lpsp:
    - shard-rkl:          [SKIP][241] ([i915#15073]) -> [PASS][242] +4 other tests pass
   [241]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-4/igt@kms_pm_rpm@dpms-lpsp.html
   [242]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_pm_rpm@dpms-lpsp.html

  * igt@kms_pm_rpm@dpms-mode-unset-lpsp:
    - shard-dg1:          [SKIP][243] ([i915#15073]) -> [PASS][244]
   [243]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-18/igt@kms_pm_rpm@dpms-mode-unset-lpsp.html
   [244]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-14/igt@kms_pm_rpm@dpms-mode-unset-lpsp.html

  * igt@kms_pm_rpm@modeset-lpsp-stress:
    - shard-dg2:          [SKIP][245] ([i915#15073]) -> [PASS][246] +3 other tests pass
   [245]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-10/igt@kms_pm_rpm@modeset-lpsp-stress.html
   [246]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-4/igt@kms_pm_rpm@modeset-lpsp-stress.html

  * igt@kms_setmode@basic:
    - shard-snb:          [FAIL][247] ([i915#15106]) -> [PASS][248] +1 other test pass
   [247]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-snb5/igt@kms_setmode@basic.html
   [248]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-snb5/igt@kms_setmode@basic.html

  * igt@perf_pmu@rc6-suspend:
    - shard-rkl:          [ABORT][249] ([i915#15131]) -> [PASS][250]
   [249]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-1/igt@perf_pmu@rc6-suspend.html
   [250]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-2/igt@perf_pmu@rc6-suspend.html
...
#### Warnings ####
  ...
  * igt@api_intel_bb@blit-reloc-purge-cache:
   ...
   [251]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@api_intel_bb@blit-reloc-purge-cache.html
   [252]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@api_intel_bb@blit-reloc-purge-cache.html

  * igt@api_intel_bb@object-reloc-purge-cache:
    - shard-rkl:          [SKIP][253] ([i915#8411]) -> [SKIP][254] ([i915#14544] / [i915#8411])
   [253]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@api_intel_bb@object-reloc-purge-cache.html
   [254]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@api_intel_bb@object-reloc-purge-cache.html

  * igt@device_reset@unbind-cold-reset-rebind:
    - shard-rkl:          [SKIP][255] ([i915#11078] / [i915#14544]) -> [SKIP][256] ([i915#11078])
   [255]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@device_reset@unbind-cold-reset-rebind.html
   [256]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@device_reset@unbind-cold-reset-rebind.html

  * igt@gem_ccs@ctrl-surf-copy:
    - shard-rkl:          [SKIP][257] ([i915#14544] / [i915#3555] / [i915#9323]) -> [SKIP][258] ([i915#3555] / [i915#9323]) +1 other test skip
   [257]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_ccs@ctrl-surf-copy.html
   [258]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@gem_ccs@ctrl-surf-copy.html

  * igt@gem_create@create-ext-cpu-access-big:
    - shard-rkl:          [SKIP][259] ([i915#14544] / [i915#6335]) -> [SKIP][260] ([i915#6335])
   [259]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_create@create-ext-cpu-access-big.html
   [260]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@gem_create@create-ext-cpu-access-big.html

  * igt@gem_ctx_sseu@engines:
    - shard-rkl:          [SKIP][261] ([i915#280]) -> [SKIP][262] ([i915#14544] / [i915#280])
   [261]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@gem_ctx_sseu@engines.html
   [262]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@gem_ctx_sseu@engines.html

  * igt@gem_ctx_sseu@invalid-sseu:
    - shard-rkl:          [SKIP][263] ([i915#14544] / [i915#280]) -> [SKIP][264] ([i915#280])
   [263]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_ctx_sseu@invalid-sseu.html
   [264]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@gem_ctx_sseu@invalid-sseu.html

  * igt@gem_exec_balancer@parallel-out-fence:
    - shard-rkl:          [SKIP][265] ([i915#4525]) -> [SKIP][266] ([i915#14544] / [i915#4525]) +1 other test skip
   [265]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_exec_balancer@parallel-out-fence.html
   [266]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@gem_exec_balancer@parallel-out-fence.html

  * igt@gem_exec_capture@capture-recoverable:
    - shard-rkl:          [SKIP][267] ([i915#14544] / [i915#6344]) -> [SKIP][268] ([i915#6344])
   [267]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_exec_capture@capture-recoverable.html
   [268]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@gem_exec_capture@capture-recoverable.html

  * igt@gem_exec_reloc@basic-gtt-cpu-active:
    - shard-rkl:          [SKIP][269] ([i915#14544] / [i915#3281]) -> [SKIP][270] ([i915#3281]) +8 other tests skip
   [269]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_exec_reloc@basic-gtt-cpu-active.html
   [270]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@gem_exec_reloc@basic-gtt-cpu-active.html

  * igt@gem_exec_reloc@basic-gtt-wc-noreloc:
    - shard-rkl:          [SKIP][271] ([i915#3281]) -> [SKIP][272] ([i915#14544] / [i915#3281]) +8 other tests skip
   [271]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_exec_reloc@basic-gtt-wc-noreloc.html
   [272]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@gem_exec_reloc@basic-gtt-wc-noreloc.html

  * igt@gem_exec_schedule@semaphore-power:
    - shard-rkl:          [SKIP][273] ([i915#7276]) -> [SKIP][274] ([i915#14544] / [i915#7276])
   [273]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_exec_schedule@semaphore-power.html
   [274]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@gem_exec_schedule@semaphore-power.html

  * igt@gem_lmem_swapping@heavy-random:
    - shard-rkl:          [SKIP][275] ([i915#4613]) -> [SKIP][276] ([i915#14544] / [i915#4613])
   [275]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@gem_lmem_swapping@heavy-random.html
   [276]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@gem_lmem_swapping@heavy-random.html

  * igt@gem_lmem_swapping@random-engines:
    - shard-rkl:          [SKIP][277] ([i915#14544] / [i915#4613]) -> [SKIP][278] ([i915#4613]) +1 other test skip
   [277]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_lmem_swapping@random-engines.html
   [278]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@gem_lmem_swapping@random-engines.html

  * igt@gem_partial_pwrite_pread@write-display:
    - shard-rkl:          [SKIP][279] ([i915#3282]) -> [SKIP][280] ([i915#14544] / [i915#3282]) +2 other tests skip
   [279]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_partial_pwrite_pread@write-display.html
   [280]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@gem_partial_pwrite_pread@write-display.html

  * igt@gem_pread@snoop:
    - shard-rkl:          [SKIP][281] ([i915#14544] / [i915#3282]) -> [SKIP][282] ([i915#3282]) +4 other tests skip
   [281]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_pread@snoop.html
   [282]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@gem_pread@snoop.html

  * igt@gem_userptr_blits@create-destroy-unsync:
    - shard-rkl:          [SKIP][283] ([i915#14544] / [i915#3297]) -> [SKIP][284] ([i915#3297])
   [283]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_userptr_blits@create-destroy-unsync.html
   [284]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@gem_userptr_blits@create-destroy-unsync.html

  * igt@gem_userptr_blits@forbidden-operations:
    - shard-rkl:          [SKIP][285] ([i915#14544] / [i915#3282] / [i915#3297]) -> [SKIP][286] ([i915#3282] / [i915#3297])
   [285]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_userptr_blits@forbidden-operations.html
   [286]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@gem_userptr_blits@forbidden-operations.html

  * igt@gen9_exec_parse@allowed-all:
    - shard-rkl:          [SKIP][287] ([i915#2527]) -> [SKIP][288] ([i915#14544] / [i915#2527])
   [287]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@gen9_exec_parse@allowed-all.html
   [288]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@gen9_exec_parse@allowed-all.html

  * igt@gen9_exec_parse@valid-registers:
    - shard-rkl:          [SKIP][289] ([i915#14544] / [i915#2527]) -> [SKIP][290] ([i915#2527]) +4 other tests skip
   [289]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gen9_exec_parse@valid-registers.html
   [290]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@gen9_exec_parse@valid-registers.html

  * igt@i915_module_load@fault-injection@__uc_init:
    - shard-rkl:          [SKIP][291] ([i915#15479]) -> [SKIP][292] ([i915#14544] / [i915#15479]) +4 other tests skip
   [291]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@i915_module_load@fault-injection@__uc_init.html
   [292]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@i915_module_load@fault-injection@__uc_init.html

  * igt@i915_pm_rc6_residency@media-rc6-accuracy:
    - shard-rkl:          [SKIP][293] ([i915#14544]) -> [SKIP][294] +11 other tests skip
   [293]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@i915_pm_rc6_residency@media-rc6-accuracy.html
   [294]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@i915_pm_rc6_residency@media-rc6-accuracy.html

  * igt@i915_pm_sseu@full-enable:
    - shard-rkl:          [SKIP][295] ([i915#14544] / [i915#4387]) -> [SKIP][296] ([i915#4387])
   [295]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@i915_pm_sseu@full-enable.html
   [296]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@i915_pm_sseu@full-enable.html

  * igt@i915_selftest@live:
    - shard-mtlp:         [DMESG-FAIL][297] ([i915#12061] / [i915#15560]) -> [INCOMPLETE][298] ([i915#15176])
   [297]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-3/igt@i915_selftest@live.html
   [298]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-mtlp-7/igt@i915_selftest@live.html

  * igt@kms_atomic@plane-primary-overlay-mutable-zpos:
    - shard-rkl:          [SKIP][299] ([i915#14544] / [i915#9531]) -> [SKIP][300] ([i915#9531])
   [299]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_atomic@plane-primary-overlay-mutable-zpos.html
   [300]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_atomic@plane-primary-overlay-mutable-zpos.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels:
    - shard-rkl:          [SKIP][301] ([i915#14544] / [i915#1769] / [i915#3555]) -> [SKIP][302] ([i915#1769] / [i915#3555])
   [301]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html
   [302]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html

  * igt@kms_big_fb@4-tiled-16bpp-rotate-0:
    - shard-rkl:          [SKIP][303] ([i915#14544] / [i915#5286]) -> [SKIP][304] ([i915#5286]) +4 other tests skip
   [303]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_big_fb@4-tiled-16bpp-rotate-0.html
   [304]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_big_fb@4-tiled-16bpp-rotate-0.html

  * igt@kms_big_fb@4-tiled-32bpp-rotate-180:
    - shard-rkl:          [SKIP][305] ([i915#5286]) -> [SKIP][306] ([i915#14544] / [i915#5286]) +2 other tests skip
   [305]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_big_fb@4-tiled-32bpp-rotate-180.html
   [306]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_big_fb@4-tiled-32bpp-rotate-180.html

  * igt@kms_big_fb@linear-64bpp-rotate-90:
    - shard-rkl:          [SKIP][307] ([i915#14544] / [i915#3638]) -> [SKIP][308] ([i915#3638]) +1 other test skip
   [307]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_big_fb@linear-64bpp-rotate-90.html
   [308]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_big_fb@linear-64bpp-rotate-90.html

  * igt@kms_big_fb@x-tiled-32bpp-rotate-270:
    - shard-rkl:          [SKIP][309] ([i915#3638]) -> [SKIP][310] ([i915#14544] / [i915#3638]) +3 other tests skip
   [309]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_big_fb@x-tiled-32bpp-rotate-270.html
   [310]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_big_fb@x-tiled-32bpp-rotate-270.html

  * igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2:
    - shard-rkl:          [SKIP][311] ([i915#14544] / [i915#6095]) -> [SKIP][312] ([i915#6095]) +8 other tests skip
   [311]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2.html
   [312]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2.html

  * igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2:
    - shard-rkl:          [SKIP][313] ([i915#14098] / [i915#14544] / [i915#6095]) -> [SKIP][314] ([i915#14098] / [i915#6095]) +16 other tests skip
   [313]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html
   [314]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html
  ...
  * igt@kms_ccs@crc-primary-basic-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2:
   ...
   [315]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_ccs@crc-primary-basic-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html
   [316]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_ccs@crc-primary-basic-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html

  * igt@kms_ccs@crc-primary-suspend-4-tiled-bmg-ccs:
    - shard-rkl:          [SKIP][317] ([i915#12805] / [i915#14544]) -> [SKIP][318] ([i915#12805])
   [317]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_ccs@crc-primary-suspend-4-tiled-bmg-ccs.html
   [318]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_ccs@crc-primary-suspend-4-tiled-bmg-ccs.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          [SKIP][319] ([i915#6095]) -> [SKIP][320] ([i915#14544] / [i915#6095]) +5 other tests skip
   [319]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2.html
   [320]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs:
    - shard-rkl:          [SKIP][321] ([i915#12313]) -> [SKIP][322] ([i915#12313] / [i915#14544]) +2 other tests skip
   [321]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html
   [322]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html

  * igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs:
    - shard-dg1:          [SKIP][323] ([i915#12313] / [i915#4423]) -> [SKIP][324] ([i915#12313])
   [323]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs.html
   [324]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-16/igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs.html

  * igt@kms_chamelium_edid@hdmi-edid-read:
    - shard-rkl:          [SKIP][325] ([i915#11151] / [i915#14544] / [i915#7828]) -> [SKIP][326] ([i915#11151] / [i915#7828]) +5 other tests skip
   [325]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_chamelium_edid@hdmi-edid-read.html
   [326]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_chamelium_edid@hdmi-edid-read.html

  * igt@kms_chamelium_frames@hdmi-crc-nonplanar-formats:
    - shard-rkl:          [SKIP][327] ([i915#11151] / [i915#7828]) -> [SKIP][328] ([i915#11151] / [i915#14544] / [i915#7828]) +3 other tests skip
   [327]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_chamelium_frames@hdmi-crc-nonplanar-formats.html
   [328]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_chamelium_frames@hdmi-crc-nonplanar-formats.html

  * igt@kms_content_protection@atomic-dpms:
    - shard-dg2:          [FAIL][329] ([i915#7173]) -> [SKIP][330] ([i915#6944] / [i915#7118] / [i915#9424])
   [329]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-11/igt@kms_content_protection@atomic-dpms.html
   [330]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-8/igt@kms_content_protection@atomic-dpms.html

  * igt@kms_content_protection@content-type-change:
    - shard-rkl:          [SKIP][331] ([i915#6944] / [i915#9424]) -> [SKIP][332] ([i915#14544] / [i915#6944] / [i915#9424])
   [331]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_content_protection@content-type-change.html
   [332]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_content_protection@content-type-change.html

  * igt@kms_content_protection@dp-mst-type-0-suspend-resume:
    - shard-rkl:          [SKIP][333] ([i915#14544] / [i915#15330]) -> [SKIP][334] ([i915#15330])
   [333]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_content_protection@dp-mst-type-0-suspend-resume.html
   [334]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_content_protection@dp-mst-type-0-suspend-resume.html

  * igt@kms_content_protection@legacy:
    - shard-dg2:          [SKIP][335] ([i915#6944] / [i915#7118] / [i915#9424]) -> [FAIL][336] ([i915#7173])
   [335]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-5/igt@kms_content_protection@legacy.html
   [336]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-11/igt@kms_content_protection@legacy.html

  * igt@kms_content_protection@lic-type-0-hdcp14:
    - shard-dg2:          [FAIL][337] ([i915#7173]) -> [SKIP][338] ([i915#6944]) +1 other test skip
   [337]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-11/igt@kms_content_protection@lic-type-0-hdcp14.html
   [338]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-5/igt@kms_content_protection@lic-type-0-hdcp14.html
    - shard-rkl:          [SKIP][339] ([i915#14544] / [i915#6944]) -> [SKIP][340] ([i915#6944]) +1 other test skip
   [339]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_content_protection@lic-type-0-hdcp14.html
   [340]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_content_protection@lic-type-0-hdcp14.html

  * igt@kms_content_protection@type1:
    - shard-dg2:          [SKIP][341] ([i915#6944] / [i915#7118] / [i915#9424]) -> [SKIP][342] ([i915#6944] / [i915#7118] / [i915#7162] / [i915#9424])
   [341]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-8/igt@kms_content_protection@type1.html
   [342]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-11/igt@kms_content_protection@type1.html

  * igt@kms_cursor_crc@cursor-offscreen-512x512:
    - shard-rkl:          [SKIP][343] ([i915#13049]) -> [SKIP][344] ([i915#13049] / [i915#14544])
   [343]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_cursor_crc@cursor-offscreen-512x512.html
   [344]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_cursor_crc@cursor-offscreen-512x512.html

  * igt@kms_cursor_crc@cursor-random-max-size:
    - shard-rkl:          [SKIP][345] ([i915#14544] / [i915#3555]) -> [SKIP][346] ([i915#3555]) +2 other tests skip
   [345]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_cursor_crc@cursor-random-max-size.html
   [346]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_cursor_crc@cursor-random-max-size.html

  * igt@kms_cursor_crc@cursor-sliding-32x10:
    - shard-rkl:          [SKIP][347] ([i915#3555]) -> [SKIP][348] ([i915#14544] / [i915#3555]) +1 other test skip
   [347]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@kms_cursor_crc@cursor-sliding-32x10.html
   [348]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_cursor_crc@cursor-sliding-32x10.html

  * igt@kms_cursor_crc@cursor-sliding-512x512:
    - shard-rkl:          [SKIP][349] ([i915#13049] / [i915#14544]) -> [SKIP][350] ([i915#13049]) +1 other test skip
   [349]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_cursor_crc@cursor-sliding-512x512.html
   [350]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_cursor_crc@cursor-sliding-512x512.html

  * igt@kms_cursor_legacy@basic-busy-flip-before-cursor-atomic:
    - shard-rkl:          [SKIP][351] ([i915#14544] / [i915#4103]) -> [SKIP][352] ([i915#4103]) +1 other test skip
   [351]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_cursor_legacy@basic-busy-flip-before-cursor-atomic.html
   [352]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_cursor_legacy@basic-busy-flip-before-cursor-atomic.html

  * igt@kms_cursor_legacy@cursorb-vs-flipa-legacy:
    - shard-rkl:          [SKIP][353] -> [SKIP][354] ([i915#14544]) +15 other tests skip
   [353]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@kms_cursor_legacy@cursorb-vs-flipa-legacy.html
   [354]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_cursor_legacy@cursorb-vs-flipa-legacy.html

  * igt@kms_dp_aux_dev:
    - shard-rkl:          [SKIP][355] ([i915#1257]) -> [SKIP][356] ([i915#1257] / [i915#14544])
   [355]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@kms_dp_aux_dev.html
   [356]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_dp_aux_dev.html

  * igt@kms_dp_link_training@non-uhbr-sst:
    - shard-rkl:          [SKIP][357] ([i915#13749] / [i915#14544]) -> [SKIP][358] ([i915#13749])
   [357]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_dp_link_training@non-uhbr-sst.html
   [358]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_dp_link_training@non-uhbr-sst.html

  * igt@kms_fbcon_fbt@psr:
    - shard-rkl:          [SKIP][359] ([i915#14544] / [i915#3955]) -> [SKIP][360] ([i915#3955])
   [359]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_fbcon_fbt@psr.html
   [360]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_fbcon_fbt@psr.html

  * igt@kms_feature_discovery@psr1:
    - shard-rkl:          [SKIP][361] ([i915#14544] / [i915#658]) -> [SKIP][362] ([i915#658])
   [361]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_feature_discovery@psr1.html
   [362]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_feature_discovery@psr1.html

  * igt@kms_flip@2x-flip-vs-panning-vs-hang:
    - shard-rkl:          [SKIP][363] ([i915#14544] / [i915#9934]) -> [SKIP][364] ([i915#9934]) +6 other tests skip
   [363]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_flip@2x-flip-vs-panning-vs-hang.html
   [364]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_flip@2x-flip-vs-panning-vs-hang.html

  * igt@kms_flip@2x-wf_vblank-ts-check:
    - shard-rkl:          [SKIP][365] ([i915#9934]) -> [SKIP][366] ([i915#14544] / [i915#9934]) +4 other tests skip
   [365]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_flip@2x-wf_vblank-ts-check.html
   [366]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_flip@2x-wf_vblank-ts-check.html

  * igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling:
    - shard-rkl:          [SKIP][367] ([i915#14544]) -> [SKIP][368] ([i915#15643]) +1 other test skip
   [367]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling.html
   [368]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yuv-linear-to-32bpp-yuv-linear-reflect-x:
    - shard-rkl:          [SKIP][369] ([i915#14544]) -> [SKIP][370] ([i915#15645]) +1 other test skip
   [369]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-yuv-linear-to-32bpp-yuv-linear-reflect-x.html
   [370]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_flip_scaled_crc@flip-32bpp-yuv-linear-to-32bpp-yuv-linear-reflect-x.html

  * igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling:
    - shard-rkl:          [SKIP][371] ([i915#15643]) -> [SKIP][372] ([i915#14544]) +1 other test skip
   [371]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling.html
   [372]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling.html

  * igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-mmap-cpu:
    - shard-dg1:          [SKIP][373] ([i915#4423]) -> [SKIP][374]
   [373]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-mmap-cpu.html
   [374]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-16/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-mmap-cpu.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt:
    - shard-rkl:          [SKIP][375] ([i915#15574]) -> [SKIP][376] ([i915#14544] / [i915#15574])
   [375]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html
   [376]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-pri-shrfb-draw-render:
    - shard-rkl:          [SKIP][377] ([i915#14544] / [i915#1825]) -> [SKIP][378] ([i915#1825]) +23 other tests skip
   [377]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-pri-shrfb-draw-render.html
   [378]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-pri-shrfb-draw-render.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-shrfb-pgflip-blt:
    - shard-rkl:          [SKIP][379] ([i915#1825]) -> [SKIP][380] ([i915#14544] / [i915#1825]) +16 other tests skip
   [379]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-shrfb-pgflip-blt.html
   [380]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-shrfb-pgflip-blt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-indfb-scaledprimary:
    - shard-dg2:          [SKIP][381] ([i915#15102] / [i915#3458]) -> [SKIP][382] ([i915#10433] / [i915#15102] / [i915#3458]) +5 other tests skip
   [381]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-6/igt@kms_frontbuffer_tracking@fbcpsr-indfb-scaledprimary.html
   [382]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-4/igt@kms_frontbuffer_tracking@fbcpsr-indfb-scaledprimary.html

  * igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-mmap-wc:
    - shard-rkl:          [SKIP][383] ([i915#14544] / [i915#15102] / [i915#3023]) -> [SKIP][384] ([i915#15102] / [i915#3023]) +15 other tests skip
   [383]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-mmap-wc.html
   [384]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_frontbuffer_tracking@fbcpsr-rgb101010-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-gtt:
    - shard-rkl:          [SKIP][385] ([i915#15102] / [i915#3023]) -> [SKIP][386] ([i915#14544] / [i915#15102] / [i915#3023]) +11 other tests skip
   [385]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-gtt.html
   [386]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-tiling-4:
    - shard-rkl:          [SKIP][387] ([i915#5439]) -> [SKIP][388] ([i915#14544] / [i915#5439])
   [387]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@kms_frontbuffer_tracking@fbcpsr-tiling-4.html
   [388]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-tiling-4.html

  * igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt:
    - shard-rkl:          [SKIP][389] ([i915#14544] / [i915#15102]) -> [SKIP][390] ([i915#15102]) +3 other tests skip
   [389]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt.html
   [390]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-draw-mmap-cpu:
    - shard-dg2:          [SKIP][391] ([i915#10433] / [i915#15102] / [i915#3458]) -> [SKIP][392] ([i915#15102] / [i915#3458]) +1 other test skip
   [391]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-4/igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-draw-mmap-cpu.html
   [392]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg2-5/igt@kms_frontbuffer_tracking@psr-1p-primscrn-cur-indfb-draw-mmap-cpu.html

  * igt@kms_frontbuffer_tracking@psr-abgr161616f-draw-blt:
    - shard-rkl:          [SKIP][393] ([i915#14544] / [i915#15574]) -> [SKIP][394] ([i915#15574]) +2 other tests skip
   [393]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-abgr161616f-draw-blt.html
   [394]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_frontbuffer_tracking@psr-abgr161616f-draw-blt.html

  * igt@kms_joiner@basic-force-ultra-joiner:
    - shard-rkl:          [SKIP][395] ([i915#15458]) -> [SKIP][396] ([i915#14544] / [i915#15458]) +1 other test skip
   [395]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_joiner@basic-force-ultra-joiner.html
   [396]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_joiner@basic-force-ultra-joiner.html

  * igt@kms_panel_fitting@legacy:
    - shard-dg1:          [SKIP][397] ([i915#4423] / [i915#6301]) -> [SKIP][398] ([i915#6301])
   [397]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_panel_fitting@legacy.html
   [398]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-16/igt@kms_panel_fitting@legacy.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping:
    - shard-rkl:          [SKIP][399] ([i915#15608] / [i915#15609] / [i915#8825]) -> [SKIP][400] ([i915#14544] / [i915#15608] / [i915#15609] / [i915#8825]) +1 other test skip
   [399]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping.html
   [400]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping@pipe-b-plane-5:
    - shard-rkl:          [SKIP][401] ([i915#15609] / [i915#8825]) -> [SKIP][402] ([i915#14544] / [i915#15609] / [i915#8825]) +1 other test skip
   [401]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html
   [402]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier-source-clamping:
    - shard-rkl:          [SKIP][403] ([i915#14544] / [i915#15608] / [i915#15609] / [i915#8825]) -> [SKIP][404] ([i915#15608] / [i915#15609] / [i915#8825]) +1 other test skip
   [403]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier-source-clamping.html
   [404]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier-source-clamping.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier:
    - shard-rkl:          [SKIP][405] ([i915#15608] / [i915#8825]) -> [SKIP][406] ([i915#14544] / [i915#15608] / [i915#8825]) +1 other test skip
   [405]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html
   [406]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-5:
    - shard-rkl:          [SKIP][407] ([i915#14544] / [i915#15609] / [i915#8825]) -> [SKIP][408] ([i915#15609] / [i915#8825]) +1 other test skip
   [407]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html
   [408]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-yf-tiled-ccs-modifier-source-clamping@pipe-a-plane-0:
    - shard-rkl:          [SKIP][409] ([i915#15608]) -> [SKIP][410] ([i915#14544] / [i915#15608]) +2 other tests skip
   [409]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_plane@pixel-format-yf-tiled-ccs-modifier-source-clamping@pipe-a-plane-0.html
   [410]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_plane@pixel-format-yf-tiled-ccs-modifier-source-clamping@pipe-a-plane-0.html

  * igt@kms_plane@pixel-format-yf-tiled-modifier:
    - shard-rkl:          [SKIP][411] ([i915#14544] / [i915#15608] / [i915#8825]) -> [SKIP][412] ([i915#15608] / [i915#8825]) +5 other tests skip
   [411]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-yf-tiled-modifier.html
   [412]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_plane@pixel-format-yf-tiled-modifier.html

  * igt@kms_plane@pixel-format-yf-tiled-modifier@pipe-a-plane-0:
    - shard-rkl:          [SKIP][413] ([i915#14544] / [i915#15608]) -> [SKIP][414] ([i915#15608]) +4 other tests skip
   [413]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-yf-tiled-modifier@pipe-a-plane-0.html
   [414]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_plane@pixel-format-yf-tiled-modifier@pipe-a-plane-0.html

  * igt@kms_pm_backlight@brightness-with-dpms:
    - shard-rkl:          [SKIP][415] ([i915#12343] / [i915#14544]) -> [SKIP][416] ([i915#12343])
   [415]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_pm_backlight@brightness-with-dpms.html
   [416]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_pm_backlight@brightness-with-dpms.html

  * igt@kms_pm_lpsp@kms-lpsp:
    - shard-rkl:          [SKIP][417] ([i915#9340]) -> [SKIP][418] ([i915#3828])
   [417]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_pm_lpsp@kms-lpsp.html
   [418]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-8/igt@kms_pm_lpsp@kms-lpsp.html

  * igt@kms_pm_lpsp@screens-disabled:
    - shard-rkl:          [SKIP][419] ([i915#8430]) -> [SKIP][420] ([i915#14544] / [i915#8430])
   [419]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_pm_lpsp@screens-disabled.html
   [420]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_pm_lpsp@screens-disabled.html

  * igt@kms_pm_rpm@modeset-lpsp-stress:
    - shard-rkl:          [SKIP][421] ([i915#15073]) -> [SKIP][422] ([i915#14544] / [i915#15073])
   [421]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_pm_rpm@modeset-lpsp-stress.html
   [422]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_pm_rpm@modeset-lpsp-stress.html

  * igt@kms_pm_rpm@modeset-lpsp-stress-no-wait:
    - shard-rkl:          [SKIP][423] ([i915#14544] / [i915#15073]) -> [SKIP][424] ([i915#15073])
   [423]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_pm_rpm@modeset-lpsp-stress-no-wait.html
   [424]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_pm_rpm@modeset-lpsp-stress-no-wait.html
  ...
  * igt@kms_prime@d3hot:
   ...
   [426]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_prime@d3hot.html
  ...
  * igt@kms_psr2_sf@fbc-pr-overlay-plane-update-continuous-sf:
   ...
   [428]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_psr2_sf@fbc-pr-overlay-plane-update-continuous-sf.html

  * igt@kms_psr2_sf@pr-cursor-plane-move-continuous-sf:
    - shard-rkl:          [SKIP][429] ([i915#11520]) -> [SKIP][430] ([i915#11520] / [i915#14544]) +2 other tests skip
   [429]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_psr2_sf@pr-cursor-plane-move-continuous-sf.html
   [430]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_psr2_sf@pr-cursor-plane-move-continuous-sf.html

  * igt@kms_psr2_su@page_flip-p010:
    - shard-rkl:          [SKIP][431] ([i915#9683]) -> [SKIP][432] ([i915#14544] / [i915#9683])
   [431]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_psr2_su@page_flip-p010.html
   [432]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_psr2_su@page_flip-p010.html

  * igt@kms_psr2_su@page_flip-xrgb8888:
    - shard-rkl:          [SKIP][433] ([i915#14544] / [i915#9683]) -> [SKIP][434] ([i915#9683]) +1 other test skip
   [433]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_psr2_su@page_flip-xrgb8888.html
   [434]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_psr2_su@page_flip-xrgb8888.html

  * igt@kms_psr@pr-primary-render:
    - shard-rkl:          [SKIP][435] ([i915#1072] / [i915#14544] / [i915#9732]) -> [SKIP][436] ([i915#1072] / [i915#9732]) +13 other tests skip
   [435]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_psr@pr-primary-render.html
   [436]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_psr@pr-primary-render.html

  * igt@kms_psr@psr2-primary-mmap-gtt:
    - shard-rkl:          [SKIP][437] ([i915#1072] / [i915#9732]) -> [SKIP][438] ([i915#1072] / [i915#14544] / [i915#9732]) +12 other tests skip
   [437]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_psr@psr2-primary-mmap-gtt.html
   [438]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_psr@psr2-primary-mmap-gtt.html

  * igt@kms_rotation_crc@primary-yf-tiled-reflect-x-90:
    - shard-rkl:          [SKIP][439] ([i915#14544] / [i915#5289]) -> [SKIP][440] ([i915#5289])
   [439]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-90.html
   [440]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_rotation_crc@primary-yf-tiled-reflect-x-90.html

  * igt@kms_scaling_modes@scaling-mode-none:
    - shard-dg1:          [SKIP][441] ([i915#3555] / [i915#4423]) -> [SKIP][442] ([i915#3555])
   [441]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_scaling_modes@scaling-mode-none.html
   [442]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-dg1-16/igt@kms_scaling_modes@scaling-mode-none.html

  * igt@kms_vrr@seamless-rr-switch-drrs:
    - shard-rkl:          [SKIP][443] ([i915#14544] / [i915#9906]) -> [SKIP][444] ([i915#9906])
   [443]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_vrr@seamless-rr-switch-drrs.html
   [444]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@kms_vrr@seamless-rr-switch-drrs.html

  * igt@perf_pmu@rc6-all-gts:
    - shard-rkl:          [SKIP][445] ([i915#14544] / [i915#8516]) -> [SKIP][446] ([i915#8516])
   [445]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@perf_pmu@rc6-all-gts.html
   [446]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@perf_pmu@rc6-all-gts.html

  * igt@prime_vgem@basic-fence-read:
    - shard-rkl:          [SKIP][447] ([i915#3291] / [i915#3708]) -> [SKIP][448] ([i915#14544] / [i915#3291] / [i915#3708])
   [447]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@prime_vgem@basic-fence-read.html
   [448]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@prime_vgem@basic-fence-read.html

  * igt@sriov_basic@bind-unbind-vf:
    - shard-rkl:          [SKIP][449] ([i915#14544] / [i915#9917]) -> [SKIP][450] ([i915#9917])
   [449]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@sriov_basic@bind-unbind-vf.html
   [450]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-5/igt@sriov_basic@bind-unbind-vf.html

  * igt@sriov_basic@enable-vfs-bind-unbind-each:
    - shard-rkl:          [SKIP][451] ([i915#9917]) -> [SKIP][452] ([i915#14544] / [i915#9917])
   [451]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@sriov_basic@enable-vfs-bind-unbind-each.html
   [452]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@sriov_basic@enable-vfs-bind-unbind-each.html
  ...
  [i915#15680]: https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/15680
...
<h2>New tests</h2>
<p>New tests have been introduced between CI_DRM_17919_full and Patchwork_1=
59261v4_full:</p>
<h3>New IGT tests (12)</h3>
<ul>
<li>
<p>igt@gem_ctx_isolation@preservation@vecs1:</p>
<ul>
...
<li>
<p>igt@gem_ctx_shared@q-in-order@vecs1:</p>
<ul>
<li>Statuses : 1 pass(s)</li>
...
<li>
<p>igt@gem_exec_schedule@lateslice@vecs1:</p>
<ul>
<li>Statuses : 1 pass(s)</li>
...
<li>
<p>igt@gem_spin_batch@engines@vecs1:</p>
<ul>
<li>Statuses : 1 pass(s)</li>
...
<li>
<p>igt@gem_wait@write-wait@vecs1:</p>
<ul>
<li>Statuses : 1 pass(s)</li>
...
<li>
<p>igt@kms_flip@dpms-off-confusion-interruptible@d-hdmi-a3:</p>
<ul>
<li>Statuses : 1 pass(s)</li>
...
<li>
<p>igt@kms_plane_alpha_blend@alpha-transparent-fb@pipe-a-dp-3:</p>
<ul>
<li>Statuses : 1 pass(s)</li>
...
<li>
<p>igt@perf_pmu@busy-start@vecs1:</p>
<ul>
<li>Statuses : 1 pass(s)</li>
...
v4/shard-mtlp-7/igt@i915_selftest@live@late_gt_pm.html">INCOMPLETE</a> (<a =
href=3D"https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/15680">i915=
#15680</a>)</li>
</ul>
</li>
<li>
...
.freedesktop.org/drm/i915/kernel/-/issues/15662">i915#15662</a>) +1 other t=
est fail</li>
</ul>
</li>
<li>
...
<ul>
<li>shard-rkl:          <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip=
/CI_DRM_17919/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp=
...
tel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-3/igt@kms_flip_=
scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling.html">SKIP</a> (<a hre=
f=3D"https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/15643">i915#15=
643</a>) +1 other test skip</li>
</ul>
</li>
<li>
...
ml">SKIP</a> (<a href=3D"https://gitlab.freedesktop.org/drm/i915/kernel/-/i=
ssues/15645">i915#15645</a>) +1 other test skip</li>
</ul>
</li>
<li>
...
intel-gfx-ci.01.org/tree/drm-tip/Patchwork_159261v4/shard-rkl-6/igt@kms_fli=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D5BE184C48
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Mar 2020 17:21:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 587926EC0C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/9] drm/edid: Swap some operands in

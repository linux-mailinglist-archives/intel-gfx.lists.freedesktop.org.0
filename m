...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 51DED35DE4F
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Apr 2021 14:11:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E48489DEA;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 4/5] drm/connector: Add a helper to attach

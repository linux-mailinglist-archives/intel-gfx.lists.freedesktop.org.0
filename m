...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB70188BE9
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 17:36:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 210CB6E431;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/4] dma-fence: Refactor signaling for manual
 invocation

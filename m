...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0453C650FE3
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:08:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AAA7010E2D9;
...
Subject: [Intel-gfx] [PATCH 15/18] fbdev/vesafb: Remove trailing whitespaces

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B1568B3609
	for <lists+intel-gfx@lfdr.de>; Fri, 26 Apr 2024 12:52:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D813E10F69B;
	Fri, 26 Apr 2024 10:52:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="f9DZEFEr";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F130E11215F
 for <intel-gfx@lists.freedesktop.org>; Fri, 26 Apr 2024 10:52:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1714128722; x=1745664722;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=1u1QSwo8p8MF6O/C0M2coZGJI9x18+asMXc++9mr8uk=;
 b=f9DZEFErkwLPedSuBlmt5QzfDZP3zfubyDLAzuCl9j98XB5KUYzuST1j
 dmyCZP6f+lzXk/Cz+2/nxRvgSdQb73zTiOrmI0iXkGlx4Uk1KwO/D/TA/
 8pPSjVYEzP6Z8nMmMS+nJ5EP33W5o3r7etIPpECT2ZKZRPDsddgg2Rno/
 RrbSd3pjLkzfMbBESwR3C+qpegWFI4Y7X2VnwJiwoGYg4QR++FtnyvFi7
 bup3NfVV7VA6/N8T4W3hdRIo9RK5Gbssm8PO3iT8VkENWqWsxpyKsTDFv
 03Z+PomRQa4JQAvZ2dMBnOVO1wHU0/e/kt+AW6hYBQVN7azKC8rqXnHVA A==;
X-CSE-ConnectionGUID: epyNHAk3R6eqkQ8BZvUjFA==
X-CSE-MsgGUID: YBKDFEYSQ5akqYnOBFgs3Q==
X-IronPort-AV: E=McAfee;i="6600,9927,11055"; a="20546329"
X-IronPort-AV: E=Sophos;i="6.07,232,1708416000"; d="scan'208";a="20546329"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Apr 2024 03:52:01 -0700
X-CSE-ConnectionGUID: VYP/qmbVT4ywznrovn4WyA==
X-CSE-MsgGUID: RGPzRSGqRoWaHHOHTzV5ew==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,232,1708416000"; d="scan'208";a="30200888"
Received: from dgarbuz-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.48.145])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Apr 2024 03:51:59 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	ville.syrjala@linux.intel.com
Subject: [PATCH v2 4/4] drm/i915/display: split out intel_sprite_regs.h from
 i915_reg.h
Date: Fri, 26 Apr 2024 13:51:37 +0300
Message-Id: <679b7395a78c53006ac07448706f1809b74810de.1714128645.git.jani.nikula@intel.com>

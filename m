...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9637359A8DE
	for <lists+intel-gfx@lfdr.de>; Sat, 20 Aug 2022 00:54:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A88D10E7B8;
...
Subject: [Intel-gfx] [PATCH v3 09/15] drm/i915/pxp: add huc authentication
 and loading command

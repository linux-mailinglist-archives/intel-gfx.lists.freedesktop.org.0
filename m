...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B2B9796DDA
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Sep 2023 02:12:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70A2610E20C;
...
Subject: Re: [Intel-gfx] [PATCH v3 2/5] drm/kmb: add trailing newlines to
 drm_dbg msgs
...
Cc: "Nikula, Jani" <jani.nikula@intel.com>,
 ...
 "daniel@ffwll.ch" <daniel@ffwll.ch>, David Airlie <airlied@gmail.com>

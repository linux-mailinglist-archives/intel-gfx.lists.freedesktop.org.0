...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7947A62D6FB
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Nov 2022 10:30:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C29210E5BC;
...
Subject: [Intel-gfx] [PATCH v10 16/19] drm/vc4: vec: Check for VEC output
 constraints

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DEEC2A7B5D
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Nov 2020 11:11:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C098F6EA08;
	Thu,  5 Nov 2020 10:11:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E16446E1A3
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Nov 2020 10:11:45 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 22900154-1500050 
 for multiple; Thu, 05 Nov 2020 10:11:41 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Nov 2020 10:11:33 +0000
Message-Id: <20201105101134.19716-21-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 21/22] drm/i915/gt: Resubmit the virtual engine
 on schedule-out
...
index 1c95ac01d9af..75289211d2c6 100644
...
+
 		...
 		if (!spin_trylock_irqsave(&rq->lock, flags))
 			continue;
@@ -2324,6 +2347,15 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -5719,7 +5751,6 @@ static void virtual_submission_tasklet(unsigned long data)
...
@@ -5730,28 +5761,27 @@ static void virtual_submit_request(struct i915_request *rq)

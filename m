...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E59C6650BE
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Jan 2023 01:57:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD8F910E6BA;
...
Subject: [Intel-gfx] [PATCH 6/9] drm/i915/pxp: Add ARB session creation with
 new PXP API Ver4.3

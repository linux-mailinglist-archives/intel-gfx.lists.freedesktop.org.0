...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F817C70B58
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Nov 2025 19:53:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E0C5510E682;
	Wed, 19 Nov 2025 18:53:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PE5OiKJN";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD54510E67E;
 Wed, 19 Nov 2025 18:53:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1763578402; x=1795114402;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=cSeRt1161oEF3TBpgMHiReLkRRlDUFqIxnfWK8yh6bY=;
 b=PE5OiKJNqlJGFw+TxSNtkkulMb6HFKsclgmO6rh4yCHbhdJD/+gagQ3q
 XO0qLbhTXCHNbvOXJrIHIacdSrjDXbC6FWe4D53DdgRtH7cO61RDwltHx
 vQ5qIIf2ve0G0qZ3AmHPABd54IaWpSeB9I47ybxQckK+FGOiUUWp2pNkW
 Xj9SP6zRPB3IT9xV6DnHUuXz/XVwY28riX0LohJ5vzu6eOzCryI40f1C+
 x3SNYuoOr1oKvVZKyatBzqzDUeOxS3ftdBQxZiR6MPjx3pKVM049lS9Ws
 iOiorojgkz3meCdi6rfHvU23o77yEexNrs9U6X3cB+Q6LtrxrNE4Qx+Fb g==;
X-CSE-ConnectionGUID: lKq7OehBSkaJPV1DY4kP0A==
X-CSE-MsgGUID: 3Iip1O9cSxmP1k5LkUxcbQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11618"; a="65672340"
X-IronPort-AV: E=Sophos;i="6.19,316,1754982000"; d="scan'208";a="65672340"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Nov 2025 10:53:21 -0800
X-CSE-ConnectionGUID: nh6mF5B/QeGk8LrowsD02Q==
X-CSE-MsgGUID: /Ifeq2rWQ/G7VsbZQdhzvg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,316,1754982000"; d="scan'208";a="196279675"
...
Subject: [PATCH v2 05/13] drm/i915/dram: convert to struct intel_display
Date: Wed, 19 Nov 2025 20:52:44 +0200
Message-ID: <b77d1fe4d12fd47ae0edee7ad8c0e9f44ca9246d.1763578288.git.jani.nikula@intel.com>

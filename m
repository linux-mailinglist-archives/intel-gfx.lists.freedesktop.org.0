...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A599616DB3
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Nov 2022 20:19:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F314C10E598;
...
Subject: [Intel-gfx] [PATCH v2 2/2] drm/i915/guc: Don't deadlock busyness
 stats vs reset

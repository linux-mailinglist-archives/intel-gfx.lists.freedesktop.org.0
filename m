...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 97FA750FBFE
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Apr 2022 13:31:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D4FC10E818;
	Tue, 26 Apr 2022 11:31:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7A64210E818
 for <intel-gfx@lists.freedesktop.org>; Tue, 26 Apr 2022 11:31:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1650972673; x=1682508673;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=gU9sVGIShrai8XxvS1+dpCWrLIgo7SdLtQtYTQcAp+Y=;
 b=CacjZmN51+13ZQlZE0k+1clWR8CMy8nT75vE91Yqdn0I/rDYVREBfImL
 kZ+DgkHR5p1XoYVN3Tddv+NYz6FW4a/dMV+5DR0iPoEPVBHP0hpsvivAe
 /gqZkeCEv4RZwIbkr2RM0ydg1xmt0LDVOthtEdYh8hUQ1Dk530Bomo/Km
 Mr6lkj9nPyrCOM80VpWevZeHL547XWDwPQm5GQCwBLP89dhlZ620whtzb
 ApcjZwSjC+7wH9tGNmsMKDoxdMGjA6A1TPxSlZpLXY/Qts+AsiGElMRcc
 ovE5uwTHbgveQCE/jRnq+5f9lrGFGroced0u/ephHr6A8y4kL8bEIPmDo g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10328"; a="265713128"
X-IronPort-AV: E=Sophos;i="5.90,290,1643702400"; d="scan'208";a="265713128"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Apr 2022 04:31:11 -0700
X-IronPort-AV: E=Sophos;i="5.90,290,1643702400"; d="scan'208";a="558264977"
Received: from vhlushch-mobl.ger.corp.intel.com (HELO localhost)
 ([10.249.132.136])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Apr 2022 04:31:09 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: imre.deak@intel.com
In-Reply-To: <YmfAJgD/ns6l7eyd@ideak-desk.fi.intel.com>
...
Date: Tue, 26 Apr 2022 14:31:07 +0300
Message-ID: <87o80ot72c.fsf@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D836D6C85D1
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Mar 2023 20:21:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 08FE110EC61;
	Fri, 24 Mar 2023 19:21:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yw1-x112a.google.com (mail-yw1-x112a.google.com
 [IPv6:2607:f8b0:4864:20::112a])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E14F310EC63
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 19:21:20 +0000 (UTC)
Received: by mail-yw1-x112a.google.com with SMTP id
 00721157ae682-5447d217bc6so50799217b3.7
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 12:21:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1679685680;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=RQgvC0Q+CIVmgyjgzJ3RO6pVvgPsqkRgZbyp5TJJC/E=;
 b=SFFUhykJbPfV1HwPgk9wQCThUKHmxBv1f8GFwwbC2H/6id5mulVQjaaqfHQwSQ/HtT
 zM95OWLUfSElMCEDPmMRzVdnVB6Pt7oNJ+x/glFZHRwhs2yTKrnduGqJ7XpD9PPRRKKd
 FLhuX6QTASk3sjOu8qHyjVpzl2WLviQa13pGU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1679685680;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=RQgvC0Q+CIVmgyjgzJ3RO6pVvgPsqkRgZbyp5TJJC/E=;
 b=
X-Gm-Message-State: AAQBX9dU/t4j2iPV3qh5oXt3Rt0aJcKyzTtb1smrTXNUuuDvMsVzaKIV
 YGGov8xqPiY25tOw6L6GH1+csQ==
X-Google-Smtp-Source: AKy350ZcYHvGTLTPn+NZB5ltYZ0hyNUX8Dfby4qCMV9IfFGGpkADyk40pB1IW1g97qqmlsjaAq6STw==
X-Received: by 2002:a81:6dc6:0:b0:545:a7d7:d81b with SMTP id
 i189-20020a816dc6000000b00545a7d7d81bmr2834795ywc.11.1679685679225; 
 Fri, 24 Mar 2023 12:21:19 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:5509:ec45:2b32:b39f])
 by smtp.gmail.com with UTF8SMTPSA id
 v22-20020a814816000000b00545a08184e6sm575897ywa.118.2023.03.24.12.21.18
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Fri, 24 Mar 2023 12:21:18 -0700 (PDT)
...
Date: Fri, 24 Mar 2023 15:20:54 -0400
Message-Id: <20230324192058.3916571-8-markyacoub@google.com>
...
Subject: [Intel-gfx] [PATCH v7 07/10] drm/i915/hdcp: Use HDCP helpers for
 i915

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sDF/JgFtBGprIQIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2026 14:22:25 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC818532FAC
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2026 14:22:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA4B010EE10;
	Wed, 13 May 2026 12:22:22 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="g+X+5cFn";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 57D1210EE0D;
 Wed, 13 May 2026 12:22:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1778674941; x=1810210941;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=rhpeUq+6AzAZ/BzfBN3298Zf5YgAgG2maAUlZEbbf30=;
 b=g+X+5cFn1WtC9jQHACyzsVv5UcHEN9u6sZfunv5JkeU9ePRE6anyjHvX
 mndvAz0nn+427xe8Un0z8sBvG7eNkCrAA80xlSws+txVELl4a2DTNcQD4
 JLIDCPQEpUCvuhpcyKmnwnYYLIplvO/TLgH4GLWAyro8PpMq/IaBvXqfJ
 MRxUNFW7hwYCzB602khuTCIDgyo8lbGWy1zDexkGwJxQeWZxbVAopUhJv
 F8SkbVdgWCW9XC/sUuYa/E/qWf0qZDRI6sAokIgUnAuPENyf0OOlK/D3C
 kxgek+la2PHj+lXkZoC+626ZargeU2ShcmujC0NWECZaVe/X95XH6OPOh w==;
X-CSE-ConnectionGUID: fozR9/gVTZOpeE88jh92FQ==
X-CSE-MsgGUID: YuNDebQKS9Cs0IUhoSeZYw==
X-IronPort-AV: E=McAfee;i="6800,10657,11784"; a="83472833"
X-IronPort-AV: E=Sophos;i="6.23,232,1770624000"; d="scan'208";a="83472833"
Received: from orviesa007.jf.intel.com ([10.64.159.147])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2026 05:22:21 -0700
X-CSE-ConnectionGUID: kmYb8tgjT0KbXfmYZd0Qqg==
X-CSE-MsgGUID: 27iEsAcYQ96sg0y8CafmKA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,232,1770624000"; d="scan'208";a="238318801"
Received: from amilburn-desk.amilburn-desk (HELO localhost) ([10.245.244.10])
 by orviesa007-auth.jf.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 May 2026 05:22:19 -0700
Date: Wed, 13 May 2026 15:22:16 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org
Subject: Re: [RESEND 4/6] drm/i915/display: pass struct intel_display to all
 for_each_intel_crtc*() macros
Message-ID: <agRs-Jk-Vrt5BVif@intel.com>
References: <cover.1778659089.git.jani.nikula@intel.com>
 <90ec6b84d772a4842d4816efc10042ec4403e996.1778659089.git.jani.nikula@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <90ec6b84d772a4842d4816efc10042ec4403e996.1778659089.git.jani.nikula@intel.com>

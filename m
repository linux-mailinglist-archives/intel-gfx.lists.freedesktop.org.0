...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 109D92B35C3
	for <lists+intel-gfx@lfdr.de>; Sun, 15 Nov 2020 16:32:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 932426E98A;
	Sun, 15 Nov 2020 15:32:05 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] Revert "drm: convert drm_atomic_uapi.c to new
 debug helpers"
...
Cc: Daniel Vetter <daniel.vetter@ffwll.ch>, Simon Ser <contact@emersion.fr>,

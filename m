...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75F107FE028
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Nov 2023 20:13:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B0B610E206;
...
Subject: [Intel-gfx] [PATCH v4 1/1] drm/i915/pxp: Add missing tag for
 Wa_14019159160

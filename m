...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 91B941B7BE6
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Apr 2020 18:43:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 777AD6EAD2;
	Fri, 24 Apr 2020 16:43:15 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 39/59] drm/arcpgu: Switch to
 devm_drm_dev_alloc

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A14F4B9701
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 04:49:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 48FC110E792;
...
Subject: [Intel-gfx] [PATCH 04/13] dyndbg: drop EXPORTed

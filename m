...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A51A15FBFF8
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Oct 2022 06:51:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4203610E321;
...
Subject: [Intel-gfx] [PATCH 3/3] drm/i915: Convert pll macros to
 _PICK_EVEN_RANGES

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BBA925327FB
	for <lists+intel-gfx@lfdr.de>; Tue, 24 May 2022 12:40:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5E7310F51A;
	Tue, 24 May 2022 10:40:44 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v1 08/13] drm/edid: add drm_edid_raw() to access
 the raw EDID data

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E4B9627FC4
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 14:01:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1563510E2AE;
	Mon, 14 Nov 2022 13:01:03 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v9 09/25] drm/modes: Move named modes parsing to
 a separate function

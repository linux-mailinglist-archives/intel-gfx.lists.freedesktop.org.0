...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 296794C3B3A
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 02:52:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 202B910E54E;
...
Subject: [Intel-gfx] [PATCH v3] drm/i915/guc: Do not complain about stale
 reset notifications

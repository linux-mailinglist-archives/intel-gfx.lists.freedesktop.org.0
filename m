...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D6A45B3D0C
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 18:33:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E32CC10EC92;
	Fri,  9 Sep 2022 16:33:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E32FA10EC92
 for <intel-gfx@lists.freedesktop.org>; Fri,  9 Sep 2022 16:33:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 44oXTOkBdTLsF3qyikYMS507mMcsyPPiHdionPB06Sq7C8LIG7AtQ+RvU g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10465"; a="296252735"
X-IronPort-AV: E=Sophos;i="5.93,303,1654585200"; d="scan'208";a="296252735"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Sep 2022 09:33:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,303,1654585200"; d="scan'208";a="683697151"
...
To: "joonas.lahtinen@linux.intel.com" <joonas.lahtinen@linux.intel.com>,
 "gregkh@linuxfoundation.org" <gregkh@linuxfoundation.org>, "Winkler, Tomas"
 <tomas.winkler@intel.com>, "Ceraolo Spurio, Daniele"
 <daniele.ceraolospurio@intel.com>, "airlied@linux.ie" <airlied@linux.ie>
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230016)(346002)(366004)(39860400002)(396003)(376002)(136003)(38070700005)(122000001)(38100700002)(82960400001)(8676002)(76116006)(66946007)(66556008)(64756008)(4326008)(66446008)(91956017)(54906003)(66476007)(316002)(110136005)(2906002)(5660300002)(8936002)(2616005)(186003)(83380400001)(966005)(71200400001)(6486002)(478600001)(53546011)(6506007)(6512007)(26005)(41300700001)(86362001)(36756003);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 09 Sep 2022 16:33:45.5033 (UTC)

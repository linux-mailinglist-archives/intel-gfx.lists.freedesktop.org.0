...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F7294EDBC8
	for <lists+intel-gfx@lfdr.de>; Thu, 31 Mar 2022 16:37:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8350C10EAA9;
	Thu, 31 Mar 2022 14:37:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 91D1810EAA9
 for <intel-gfx@lists.freedesktop.org>; Thu, 31 Mar 2022 14:37:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1648737424; x=1680273424;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=bmO3PlYG2ncGldbfcRZFgpLISGBBpiHNxFXfhB6ZHvw=;
 b=Q8jkWsdOCB52uE5fqY70xugjbYv4Vu9jdkmnmdQTG3KX1FhFaBJj1dzZ
 XlEostbwNNoRfSpVj2/+wHjSq5JPa/ce/IXUjOTBQYeU83k1U6+OK6UWR
 XfXR+oYTi1XQE7zbGMk4CKqg9XQQ9Qc4RZWtytwUGYQR8i4EuoYGG5XhD
 3ekuDwupSSz4a4iw07Sfwihcz4ZSy0l62YvxWFKU1B8NaCg7KrahUnr7V
 VNznatsxwurDB2amZtUHSzSGNlUSdH5FvwFPo1K/sZzEhF1RASHsfrskD
 11fmzqP23q17Dw+WWqdwEFUDLKm+IaYzYEbmWbcUkmJ0RWlcwU5AA6m+a w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10302"; a="320545606"
X-IronPort-AV: E=Sophos;i="5.90,225,1643702400"; d="scan'208";a="320545606"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2022 07:37:03 -0700
X-IronPort-AV: E=Sophos;i="5.90,225,1643702400"; d="scan'208";a="654792883"
Received: from juanniex-mobl.ger.corp.intel.com (HELO [10.213.215.247])
 ([10.213.215.247])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2022 07:37:01 -0700
Message-ID: <56ead1fb-bd26-2e92-7fe5-4ef441434be1@linux.intel.com>
Date: Thu, 31 Mar 2022 15:36:57 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220330234809.1218210-2-casey.g.bowman@intel.com>
...
>   
> @@ -230,11 +205,6 @@ static void guc_ggtt_invalidate(struct i915_ggtt *ggtt)
...
>   			  struct i915_vma_resource *vma_res,
>   			  enum i915_cache_level cache_level,
> @@ -522,7 +241,7 @@ static void ggtt_bind_vma(struct i915_address_space *vm,
...
> @@ -725,10 +444,10 @@ static int init_aliasing_ppgtt(struct i915_ggtt *ggtt)
>   	ggtt->alias = ppgtt;
...
> @@ -751,8 +470,8 @@ static void fini_aliasing_ppgtt(struct i915_ggtt *ggtt)
>   
...
> @@ -840,364 +559,12 @@ void i915_ggtt_driver_late_release(struct drm_i915_private *i915)
...
> @@ -1209,11 +576,11 @@ static int ggtt_probe_hw(struct i915_ggtt *ggtt, struct intel_gt *gt)
...
>   		dma_resv_fini(&ggtt->vm._resv);
>   		return ret;
> @@ -1267,10 +634,7 @@ int i915_ggtt_probe_hw(struct drm_i915_private *i915)
>   
...
> @@ -549,6 +549,14 @@ i915_page_dir_dma_addr(const struct i915_ppgtt *ppgtt, const unsigned int n)
...
>   int i915_ggtt_enable_hw(struct drm_i915_private *i915);
> @@ -619,6 +627,7 @@ release_pd_entry(struct i915_page_directory * const pd,

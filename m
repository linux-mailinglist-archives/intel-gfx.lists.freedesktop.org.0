...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8212544EE39
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Nov 2021 21:57:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C7AC86E0AD;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/pmu: Increase the

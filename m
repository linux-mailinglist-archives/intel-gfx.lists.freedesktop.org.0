...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 006A14D004A
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Mar 2022 14:40:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CB0910F0CA;
...
Subject: [Intel-gfx] [PATCH v3 5/6] drm/i915/gt: Optimize the migration loop

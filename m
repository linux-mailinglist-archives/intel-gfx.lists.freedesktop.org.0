...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ABBB83DADE2
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 22:45:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77D976E16D;
...
Subject: Re: [Intel-gfx] [PATCH v6 02/15] mei: pxp: export pavp client to me
 client bus

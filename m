...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 419C228F08D
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Oct 2020 13:00:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2CE06EC60;
...
Subject: [Intel-gfx] [RFC 11/13] drm/i915: Read DSC capabilities of the

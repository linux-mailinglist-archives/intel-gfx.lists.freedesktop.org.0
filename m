...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CACE40D777
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Sep 2021 12:32:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D061E6EB49;
	Thu, 16 Sep 2021 10:32:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1C2876EB49
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Sep 2021 10:32:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1631788360;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=gbtQYbmXTfGjFc0xtrXYRpBgRpF9MVZuvT9anQld5O8=;
 b=ZaEDD4Txq1yq2LxOSZK2AmL48I8XhxDxpn7gedomjAzXl9nKk/C3o0s7L1ZexRb8qVBBa+
 hnFMQI5u9KXWXu8hdMxwHR2Onp8SSb2uix8efUR53J7mWDI2C7mevF/sH53fZsWJidadNq
 WqZDOcUvb4F096yIIC+xZE7O8l6K7Ik=
Received: from mail-ed1-f72.google.com (mail-ed1-f72.google.com
 [209.85.208.72]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-243-l8LJO7EkO82GwBu6_gUy0Q-1; Thu, 16 Sep 2021 06:32:39 -0400
X-MC-Unique: l8LJO7EkO82GwBu6_gUy0Q-1
Received: by mail-ed1-f72.google.com with SMTP id
 r7-20020aa7c147000000b003d1f18329dcso4941576edp.13
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Sep 2021 03:32:39 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=gbtQYbmXTfGjFc0xtrXYRpBgRpF9MVZuvT9anQld5O8=;
 b=
X-Gm-Message-State: AOAM530+c4MaqDoBC1H4NaK/LIxYmLqbka7KUJ3w/gipZkfH+baOmu61
 5q+aWhUw6AuDedD16K6mHkQr3x3mB3UNYSiNahRKK7WbxueSvp/7ToRlS8AS41cI/odBKoVMZoJ
 ADUSqCDXvQrkvkX1rT7pXWxZNGDNu
X-Received: by 2002:a17:907:9854:: with SMTP id
 jj20mr5775207ejc.133.1631788356417; 

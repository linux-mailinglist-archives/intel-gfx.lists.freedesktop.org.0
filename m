...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 4FkBEfKfb2ktKAAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jan 2026 16:32:02 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DCE34618C
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jan 2026 16:32:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6660210E61C;
	Tue, 20 Jan 2026 15:22:55 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=Nvidia.com header.i=@Nvidia.com header.b="BatpiT5w";
	dkim-atps=neutral
...
Received: from CY3PR05CU001.outbound.protection.outlook.com
 ...
 [40.93.201.32])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D4E9E10E61C;
...
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?r7/Chpr1IksxhPJwyfuAbHS5ygCLDBPt3GBXthlBe6RpZEgxhZDvK/EeXGxY?=
...
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?/kJlt45gk9FgL+tTa7H+v4SFi+ZNQ9RsaoVOCXb/xzD3J64tWrLguNA96P6G?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 20 Jan 2026 15:22:46.6186 (UTC)
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	MISSING_XM_UA(0.00)[];
	DNSWL_BLOCKED(0.00)[131.252.210.177:from,2603:10b6:408:2a1::19:received,40.93.201.32:received];
	RCPT_COUNT_GT_50(0.00)[93];
	FROM_NEQ_ENVFROM(0.00)[jgg@nvidia.com,intel-gfx-bounces@lists.freedesktop.org];
	FROM_HAS_DN(0.00)[];
	FORGED_RECIPIENTS_MAILLIST(0.00)[];
	MID_RHS_MATCH_FROM(0.00)[];
	RECEIVED_SPAMHAUS_BLOCKED_OPENRESOLVER(0.00)[2603:10b6:408:2a1::19:received,40.93.201.32:received];

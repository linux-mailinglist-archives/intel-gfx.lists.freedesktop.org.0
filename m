...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4007F6E4DCB
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Apr 2023 17:56:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDEFA10E428;
...
Subject: [Intel-gfx] [RFC 4/6] drm: Add simple fdinfo memory helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 965114B3AD0
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Feb 2022 11:32:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B5CAB10F199;
	Sun, 13 Feb 2022 10:32:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BED2410F199
 for <intel-gfx@lists.freedesktop.org>; Sun, 13 Feb 2022 10:32:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644748357; x=1676284357;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=bLRDruTHWVKvpqzWiA3/uEB8qshUYDwQ0cOtU3KkeRg=;
 b=dXVloROo0C28+3cD6+TqbrjuG9U1dTdaChoU/3zR2wev/5ZBGNaf0Vax
 RJI2X2hHfbhcHU3AilAv5BzOhViIb9vuVPHVCXMgp61HmjVLTlp1x+4Mw
 PLiI9QcdKbbsL+du5WPDnpxvrWsHhDUSgODPpVQlVN0sBuivvJVcVUtLh
 +W5hiHCMXI8WjeCVvreyz+plJ4Q0IHHiD+QZ2LA/CO/u2NC5ipr9zf1VI
 cWKBqsx7uFJ+B+psgXvOTvuGwqcnypCa2kGqX6fb1mE77qUDei3coXjeO
 abi/BD8LR/tIGTJURDoQ7YMCzrQwojQwGKGDRK1+3SYxj+QlJ442jcCdd Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10256"; a="336363634"
X-IronPort-AV: E=Sophos;i="5.88,365,1635231600"; d="scan'208";a="336363634"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2022 02:32:37 -0800
X-IronPort-AV: E=Sophos;i="5.88,365,1635231600"; d="scan'208";a="527474276"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2022 02:32:34 -0800
...
Date: Sun, 13 Feb 2022 12:32:11 +0200
Message-Id: <20220213103215.2440248-2-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 1/5] drm/i915/gsc: add gsc as a mei auxiliary
 device

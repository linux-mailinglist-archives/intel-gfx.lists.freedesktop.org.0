...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76DFB20FED9
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:29:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A862C6E378;
	Tue, 30 Jun 2020 21:28:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C3E806E2F8;
 Tue, 30 Jun 2020 21:28:39 +0000 (UTC)
IronPort-SDR: 6BzaD4CxmOZTVdRvs0QqUEfNCWHr0LMy+dKtio4u8aoe+VJE5701yJwyhjYd9kqd6cKXii950+
 cXayGbCiCkkg==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="146386953"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="146386953"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2020 14:28:39 -0700
IronPort-SDR: yBfRSCEs9EBOGHi2hCJEeurw5E2JUzjMD4k8E1ZhvrJ8lJ+jXosbxUzl6XoB51FXQJqyfTQHCS
 F9gSNHbywuCw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="481066648"
...
Date: Tue, 30 Jun 2020 14:27:24 -0700
Message-Id: <1593552491-23698-13-git-send-email-anitha.chrisanthus@intel.com>
X-Mailer: git-send-email 2.7.4
In-Reply-To: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
References: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
Subject: [Intel-gfx] [PATCH 12/59] drm/kmb: Part3 of Mipi Tx initialization

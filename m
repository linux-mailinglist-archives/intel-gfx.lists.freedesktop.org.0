...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C3984F7FBD
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Apr 2022 15:00:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60AF210EB2D;
	Thu,  7 Apr 2022 13:00:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B464210EB42
 for <intel-gfx@lists.freedesktop.org>; Thu,  7 Apr 2022 13:00:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1649336417; x=1680872417;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=2HzDU9iJlkMViSTHOB1v0XvsV1lU5Pq9laruzE8ErdM=;
 b=MtU0+r4ELnTt4Op9mQcQ8t29q9ZtQ1vmZG6rRwkYf8u86PLS/RGNx9YY
 gNz4J8GbjDdqimxtb0qOtyS378vFUW2hi1htvNobIjvwjzJ29V2vMDl+z
 qQ4DDYD1gHl50e2gs15m5E1+v6TKrwLqSQHr6Yh2BWwCNXfCjxpSfJuJ6
 OIRWOuIdbt+DPMOxQQjITZU1Pbqty1rIO3ItX5+UK6al9/sqHGSuoyxKt
 ISsuhWc6bIvi8wcBPsBBq7gJrY+cK98o/Zgw/HpMJf729ybGIZMIm3fBK
 ASJgYMFI/Ic5EU/7Yn81PiWHPKKL7XCpI/jJGVB4gmVFpY2gxulPHUl3n g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10309"; a="324475945"
X-IronPort-AV: E=Sophos;i="5.90,242,1643702400"; d="scan'208";a="324475945"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2022 06:00:17 -0700
X-IronPort-AV: E=Sophos;i="5.90,242,1643702400"; d="scan'208";a="571041147"
Received: from sannilnx.jer.intel.com ([10.12.231.73])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Apr 2022 06:00:12 -0700
...
Date: Thu,  7 Apr 2022 15:58:32 +0300
Message-Id: <20220407125839.1479249-14-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH 13/20] mei: extend timeouts on slow devices.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D46759A8E3
	for <lists+intel-gfx@lfdr.de>; Sat, 20 Aug 2022 00:55:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1D8F10EBEF;
...
Subject: [Intel-gfx] [PATCH v3 01/15] HAX: mei: GSC support for XeHP SDV and
 DG2 platform

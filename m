...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E24BA416C4B
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 08:52:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 351476EE17;
...
Subject: [Intel-gfx] [PATCH v2 15/17] drm/amd: cleanup:

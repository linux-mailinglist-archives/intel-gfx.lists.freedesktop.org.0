...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A1FD81103B0
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 18:37:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D0556EA49;
	Tue,  3 Dec 2019 17:37:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yb1-xb42.google.com (mail-yb1-xb42.google.com
 [IPv6:2607:f8b0:4864:20::b42])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 686A16EA49
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Dec 2019 17:37:41 +0000 (UTC)
Received: by mail-yb1-xb42.google.com with SMTP id i3so1837426ybe.12
 for <intel-gfx@lists.freedesktop.org>; Tue, 03 Dec 2019 09:37:41 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=DQr43OWwM0zkaVjx1CwvWsP5lq5M+BXcr+mK36r5o+8=;
 b=
X-Gm-Message-State: APjAAAXWR4oL2t26/hqjkutTfuwEIJ2aX1e6P/2UWzB42VaAGsmvAZXX
 wPOLBZ4I3ZIzrV96C90mpurAJA==
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 aFmg==
Subject: [Intel-gfx] [PATCH 10/11] drm/i915: Expose HDCP shim functions from

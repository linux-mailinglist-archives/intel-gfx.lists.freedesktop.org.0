...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FDE569EE55
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Feb 2023 06:33:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 40C8D10E3CD;
...
Subject: [Intel-gfx] [PATCH 2/7] drm/i915/dp: Check if DSC supports the
 given output_format

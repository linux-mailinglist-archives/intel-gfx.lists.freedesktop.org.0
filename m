...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6231C1A6A16
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Apr 2020 18:43:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B06889F2D;
	Mon, 13 Apr 2020 16:43:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A896689EFF
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Apr 2020 16:43:41 +0000 (UTC)
IronPort-SDR: ev0TtZ8tbi5yOEvdplnoVyo37lHuSlgntgW/pqEmZareMsnH7nF179ZXB/56YqcBqU8Bku5j2b
 IaXfAO0S/UWA==
...
IronPort-SDR: lxjpwUOPUSS+LMzTrmDh+FMVn05PoqGoKw7r3MpVW5doCxWSF6zqwkpDHfRPadhhlsqSJdfnOW
 JF9ZInBGTgGQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,378,1580803200"; d="scan'208";a="267485682"
Received: from shandley-mobl.amr.corp.intel.com (HELO
 josouza-MOBL2.amr.corp.intel.com) ([10.135.3.40])
 by orsmga008.jf.intel.com with ESMTP; 13 Apr 2020 09:43:39 -0700
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 13 Apr 2020 09:45:07 -0700
Message-Id: <20200413164515.13355-1-jose.souza@intel.com>
X-Mailer: git-send-email 2.26.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 1/9] drm/i915/display: Move out code to

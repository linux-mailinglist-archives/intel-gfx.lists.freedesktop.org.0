...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A4EC550A569
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 18:28:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC46E10E2F4;
...
Subject: [Intel-gfx] [PATCH v2 6/7] vfio: Remove dead code

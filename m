...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACAABAD01B6
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Jun 2025 14:06:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 427D610EA83;
	Fri,  6 Jun 2025 12:06:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="E1cyHeIX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 45C2210EA7F
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Jun 2025 12:06:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1749211603;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=04LRSvqeoLp7K6hiMt+5nhRqp6hRGXKPyGrTB58OXbY=;
 b=E1cyHeIX+/jrXdhy7yWBdqjqIsPeJsJ22KxNPnJtwfcbvhgZ9WeYBo3g2DRdqzwYU+PnYv
 0Ljp3jxboY2YrMY+oJOjMsjV9j72B+aF9V3IPTCfaACLK+olvaK0DWC4vgOtpJgvrXjyZh
 Qn6mBUF+QzZSJ3JyUs7VNIYUtzogZkk=
...
Received: from mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id CF518180036E; Fri,  6 Jun 2025 12:06:37 +0000 (UTC)
Received: from hydra.redhat.com (unknown [10.44.33.65])
 by mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id 5F49D18002A5; Fri,  6 Jun 2025 12:06:32 +0000 (UTC)
...
Subject: [PATCH v8 7/9] drm/i915/display: Add drm_panic support for Y-tiling
 with DPT

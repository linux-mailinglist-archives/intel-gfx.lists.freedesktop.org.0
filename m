...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE7BA577BA4
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:41:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E099A9DB8;
...
Subject: [Intel-gfx] [PATCH v3 28/39] nouveau: change nvkm_debug/trace to
 use dev_dbg POC

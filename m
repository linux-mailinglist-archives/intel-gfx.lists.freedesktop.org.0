...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4D394FE55E
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 17:54:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F1AE810E735;
...
Subject: [Intel-gfx] [PATCH 6/9] drm/i915/gvt: Add missing module_put() in
 error unwind

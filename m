...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C8806EA941
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 13:35:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B59DB10EE0D;
	Fri, 21 Apr 2023 11:35:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DC90010EE00;
 Fri, 21 Apr 2023 11:35:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682076944; x=1713612944;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=9jtER+oiXneUK4FyQN6gdaofhY2rw/kpz3wAaQGzApQ=;
 b=UMmTJhyYLLHAVFzPPjqehWsBcEqf4ZQvGOOnRKTc4KNkYLm4+vY3dAM5
 sLYtAbPGkEN3+K8bEMouKqj8rE1R70t9j3kKsWgGgFRUiMTzyhWU67kdf
 hyjdrpZ6JNbOOpAtMwnZmkCp95rRf98lkdxSbt6cfut0VFsXovKsgUx79
 vfNJUKYVqKn9HFQqBYVTo19Mf9DU8nzv+NeIpCVrehOthOzcZR5RZuZV1
 hENmFs9IOcqE08w8yY6UR31OqO9oFWps6TVg+JAzaKqtbw/auHwvUfrUH
 Q6KOiZHx5tcNt5KSZGD7os99lF+AYHJ4yEpnLiM23RjlCkwaDcUYPk79r A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="432249986"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="432249986"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 04:35:44 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="642489695"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="642489695"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 04:35:40 -0700
From: Andrzej Hajda <andrzej.hajda@intel.com>
Date: Fri, 21 Apr 2023 13:35:10 +0200
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230224-track_gt-v7-7-11f08358c1ec@intel.com>
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v7 7/7] drm/i915: track gt pm wakerefs

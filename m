...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 455467F506F
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Nov 2023 20:15:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C995B10E148;
...
Subject: [Intel-gfx] [PATCH v5] drm/i915/pxp: Add drm_dbgs for critical PXP
 events.

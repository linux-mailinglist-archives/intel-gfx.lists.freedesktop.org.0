...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6019B70CAD0
	for <lists+intel-gfx@lfdr.de>; Mon, 22 May 2023 22:23:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B27E10E294;
	Mon, 22 May 2023 20:23:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4567110E294;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=i8zJuaBVXfFWk56oVsC9WQSHhATrMAqFMOoSLrv5p4c=;
 b=MGlO0mEVhEgvguhmkFV8CytWPI/aMInoNyBlRC5187p8fP0v7zrikARZ
 rOEtWCxGmNUW++vHGN9xCkZ2TpV4MYFo4o/H3INHXl38nyEDxdnAJNYOL
 X2HgHunhRBOoTwjoPASmPmybGgCXqcbYdRD2tJnTVnWmwhGCicNCscjKs
 qTs8qVL8c61kCl6QyAjNc3bzmM4vbQifgApUd21EF9RZUyx2itfnEGBBC
 wSRs3Qp5XG/URiVag8Ci736reua32L7c3p9QLrKBVRuasJ03ufZ72cXXQ
 MvivOFXDtHr8ZC2hxvGL9O3hP3fF94F/OOMvDjQNvJLEgxBLB9efN9UJY Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="337620401"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="337620401"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 13:23:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="681087969"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="681087969"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 13:23:29 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 22 May 2023 13:23:10 -0700
Message-Id: <20230522202314.3939499-3-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 2/6] drm/i915: Convert INTEL_INFO()->display
 to a pointer

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 16DA339A50A
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jun 2021 17:54:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06F6F6F4C3;
...
Subject: Re: [Intel-gfx] [PATCH v2 1/4] drm/gem-shmem-helper: Export
 drm_gem_shmem_funcs
...
Content-Type: multipart/mixed; boundary="===============0465941273=="

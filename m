...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF65F21EC0A
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 11:02:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 274EE6E89A;
	Tue, 14 Jul 2020 09:02:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8ED966E891
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Jul 2020 09:02:42 +0000 (UTC)
IronPort-SDR: UvcIqwp0n+oPjoba7V6PxXoFVHy4PI0PMMwrOt+zr8dDH3ZdihL8PVDwbokgkwgrEwhnXs3szi
 jdmzURiaHl6A==
X-IronPort-AV: E=McAfee;i="6000,8403,9681"; a="146326130"
X-IronPort-AV: E=Sophos;i="5.75,350,1589266800"; d="scan'208";a="146326130"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jul 2020 02:02:41 -0700
IronPort-SDR: 3UwA6MNfYSqfl2j9U4zjnfJNIsjAx2hKVQTa55SMLE9px7VX2u/5+uSAYp7mUqvJS6efS4W3ff
 atNdbxCpJWjA==
X-IronPort-AV: E=Sophos;i="5.75,350,1589266800"; d="scan'208";a="429697180"
Received: from alaskov-mobl.ger.corp.intel.com (HELO [10.214.244.103])
 ([10.214.244.103])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jul 2020 02:02:38 -0700
To: Chris Wilson <chris@chris-wilson.co.uk>, intel-gfx@lists.freedesktop.org
References: <20200706061926.6687-1-chris@chris-wilson.co.uk>
 <20200706061926.6687-13-chris@chris-wilson.co.uk>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
Message-ID: <e93eba0c-59ad-5071-9fcd-e5f482cdf752@linux.intel.com>
Date: Tue, 14 Jul 2020 10:02:35 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.10.0
MIME-Version: 1.0
In-Reply-To: <20200706061926.6687-13-chris@chris-wilson.co.uk>

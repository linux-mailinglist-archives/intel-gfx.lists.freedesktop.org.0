...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84410A36127
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Feb 2025 16:13:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1FB2210ECCC;
	Fri, 14 Feb 2025 15:13:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Jj4wGTf4";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9EC8C10ECD6
 for <intel-gfx@lists.freedesktop.org>; Fri, 14 Feb 2025 15:13:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739546024; x=1771082024;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WpVZpCg/0XLtfScWnpsgUb6CV2Fce8c9T2D7+v27SX8=;
 b=Jj4wGTf4sZViGw1H5ODOji0TgEY+PwxXnYafL2UmJpdR3J69ynlI/Qtq
 RwyDWZj+Wkfr6D2q/DM1mquhTiVEGgqpf/2pygHkbYxOxXMEtA6WlJC2H
 aRIA8/5pqJxfMgt1AUOwKIQmgwrOoSXANjhRYHGIoh+D8IkJCniy7S1Iw
 RpyR1cyk0e0F3ipB4H3cqXiF2vqukl5GFIX8qXeRzueuUBpeI/P3A4Rw5
 a1bgrfXUFK3JPijKGaaXtdF5EYn5DxBIoWaOIASwolAKlxy20jcPw88xH
 X4uDd3liHIqKRvdqUaF1ktYR0OgbI6DK2cDkqQW2ZBqwnOQ9zXoSb6u+W Q==;
X-CSE-ConnectionGUID: lkABWbsfRhWiFLnpS0k4CA==
X-CSE-MsgGUID: OjMQJcEYSz+mpvt2eUuMbQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11345"; a="39482266"
X-IronPort-AV: E=Sophos;i="6.13,286,1732608000"; d="scan'208";a="39482266"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Feb 2025 07:13:43 -0800
X-CSE-ConnectionGUID: agPmgUFQQFuf8MYlNioXwQ==
X-CSE-MsgGUID: BK6eigL6QBOdOpKI7xIUzA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,286,1732608000"; d="scan'208";a="113675803"
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by fmviesa008.fm.intel.com with ESMTP; 14 Feb 2025 07:13:42 -0800
From: Nemesa Garg <nemesa.garg@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Nemesa Garg <nemesa.garg@intel.com>
Subject: [PATCH v8 5/6] drm/i915/display: Add registers and compute the
 strength
Date: Fri, 14 Feb 2025 20:39:23 +0530
Message-Id: <20250214150924.1811372-6-nemesa.garg@intel.com>

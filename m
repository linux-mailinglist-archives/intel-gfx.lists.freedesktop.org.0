...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 23BF33FF41F
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Sep 2021 21:25:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B40A6E7F1;
...
Subject: Re: [Intel-gfx] [PATCH v5 10/25] drm/i915/guc: Copy whole golden

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF82E29CA99
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Oct 2020 21:50:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 40E726EC4F;
	Tue, 27 Oct 2020 20:50:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 726A76EC4E
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Oct 2020 20:50:16 +0000 (UTC)
IronPort-SDR: 1JeHMsW69SH3fCS/yx3LttIcbOl1N2uV+bpb1xlhBKfhtgmcvnRsfQVyKgWki8fwtTTuE5PzWl
 I8aT2UM0hwiw==
X-IronPort-AV: E=McAfee;i="6000,8403,9787"; a="147446067"
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="147446067"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2020 13:50:15 -0700
IronPort-SDR: FitVarcutaLxmv53nTqA/km63RwJj+3wZwGUb9qXkqXL/9LBizYBw7OJ52nY8chWCZ0TsSMpE6
 14dQLjGSGE/g==
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="535951403"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO labuser-Z97X-UD5H)
 ([10.165.21.211])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2020 13:50:14 -0700
Date: Tue, 27 Oct 2020 13:52:07 -0700
From: "Navare, Manasi" <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20201027205207.GB29088@labuser-Z97X-UD5H>
References: <20201027193034.28721-1-manasi.d.navare@intel.com>
 <20201027193034.28721-6-manasi.d.navare@intel.com>
 <20201027201735.GT6112@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20201027201735.GT6112@intel.com>
...
On Tue, Oct 27, 2020 at 10:17:35PM +0200, Ville Syrj=E4l=E4 wrote:
...
> > @@ -17779,7 +17780,7 @@ intel_mode_valid_max_plane_size(struct drm_i915=
_private *dev_priv,
> >  	 * too big for that.
> >  	 */
...
> > @@ -254,6 +254,17 @@ intel_dp_max_data_rate(int max_link_clock, int max=
_lanes)
...
> > @@ -519,7 +530,8 @@ small_joiner_ram_size_bits(struct drm_i915_private =
*i915)
> >  =
...
> >  	int i;
> > @@ -537,6 +549,10 @@ static u16 intel_dp_dsc_get_output_bpp(struct drm_=
i915_private *i915,
...
> > @@ -546,6 +562,15 @@ static u16 intel_dp_dsc_get_output_bpp(struct drm_=
i915_private *i915,
> >  	 */
...
> > @@ -568,7 +593,8 @@ static u16 intel_dp_dsc_get_output_bpp(struct drm_i=
915_private *i915,
> >  }
> >  =
...
> > @@ -595,12 +621,20 @@ static u8 intel_dp_dsc_get_slice_count(struct int=
el_dp *intel_dp,
> >  =
...
Yes so here we use 2 dsc engines so slice count * 2
But will just do slice_count =3D valid_dsc_slicecount[i] << bigjoiner;
...
> > @@ -684,10 +718,6 @@ intel_dp_mode_valid_downstream(struct intel_connec=
tor *connector,
...
Hmm yea thats removed by mistake, will fix this.
...
> > @@ -737,6 +768,13 @@ intel_dp_mode_valid(struct drm_connector *connecto=
r,
> >  	if (mode->clock < 10000)
...
> > @@ -765,16 +803,23 @@ intel_dp_mode_valid(struct drm_connector *connect=
or,
> >  							    max_link_clock,
> >  							    max_lanes,
> >  							    target_clock,
...
> > @@ -2297,11 +2342,13 @@ static int intel_dp_dsc_compute_config(struct i=
ntel_dp *intel_dp,

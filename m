...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB23A1B12F6
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Apr 2020 19:27:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03EB26E7FE;
	Mon, 20 Apr 2020 17:27:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3AADE6E832
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2020 17:27:46 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20963020-1500050 
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2020 18:27:41 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 20 Apr 2020 18:27:36 +0100
Message-Id: <20200420172739.11620-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 3/6] drm/i915/selftests: Check RPS controls
...
index 149a3de86cb9..4f6c9a5b2b7a 100644
--- a/drivers/gpu/drm/i915/gt/selftest_rps.c
+++ b/drivers/gpu/drm/i915/gt/selftest_rps.c
@@ -107,6 +107,190 @@ create_spin_counter(struct intel_engine_cs *engine,
 	return vma;
 }
...
+
 ...
 {
 	u64 dc, dt;
@@ -125,16 +309,10 @@ static u64 measure_frequency_at(struct intel_rps *rps, u32 *cntr, int *freq)
 	u64 x[5];
 	int i;
...
@@ -279,10 +457,7 @@ static int __rps_up_interrupt(struct intel_rps *rps,
 	if (!intel_engine_can_store_dword(engine))
 		return 0;
...
+	rps_set_check(rps, rps->min_freq);
 	...
 	if (IS_ERR(rq))
@@ -354,10 +529,7 @@ static int __rps_down_interrupt(struct intel_rps *rps,
...
@@ -490,16 +662,10 @@ static u64 measure_power_at(struct intel_rps *rps, int *freq)
 	u64 x[5];
 	int i;

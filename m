...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 46C304FE2C9
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 15:37:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A57F10E9E3;
...
Subject: Re: [Intel-gfx] [PATCH v5 05/10] drm/i915/hdcp: Consolidate HDCP
 setup/state cache

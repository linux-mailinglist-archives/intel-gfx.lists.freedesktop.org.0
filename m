...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D9C3494B52
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jan 2022 11:05:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 742AA10E308;
	Thu, 20 Jan 2022 10:05:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E9EBA10E32F
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jan 2022 10:05:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642673127; x=1674209127;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=gziqpiTHzessAGdl4RZE9BDX2LxywD77LjAmrrCgN3g=;
 b=LnS1wmJHFieEEzIwUR/b9e9elevFOaaDwHAxSr4fjBkxWCE7jdePdq5E
 eV1AdMpRriEb2g2fn152sLH4w5c17jNuiI250A9YvfMSZT1MyaBe1AaWd
 z6YQsXoE9gml/pK+a9lFrMH37UX8JM1FH3qSbLTE8xVRwqEUN2FKr0PKL
 Qk0nGEe3jADjdG81j7wzmvfpr7woxOEQ0b0w2TygXT8t1WybnBC9GZ8UB
 kaS3RkFF5nei79vcokaymF3Az7iJN3IAKw56c44TblRgjCppBBUrSi3s1
 Gb4Gcf0PjzosKtB93apOzdJ+hcnL77TckTZxxh3/SB4LndN+c2Q2q/HcI Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10232"; a="232679990"
X-IronPort-AV: E=Sophos;i="5.88,302,1635231600"; d="scan'208";a="232679990"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2022 02:05:26 -0800
X-IronPort-AV: E=Sophos;i="5.88,302,1635231600"; d="scan'208";a="532706859"
Received: from davidfsc-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.252.52.140])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2022 02:05:23 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: Matt Roper <matthew.d.roper@intel.com>, intel-gfx@lists.freedesktop.org
In-Reply-To: <20220120063809.1020633-3-matthew.d.roper@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20220120063809.1020633-1-matthew.d.roper@intel.com>
 <20220120063809.1020633-3-matthew.d.roper@intel.com>
Date: Thu, 20 Jan 2022 12:05:19 +0200
Message-ID: <87sftiafj4.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain
Subject: Re: [Intel-gfx] [PATCH 2/6] drm/i915/perf: Express OA register

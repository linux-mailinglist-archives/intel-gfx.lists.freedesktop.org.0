...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CF6C48729B
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jan 2022 06:31:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B496113265;
...
Subject: [Intel-gfx] [PATCH v11 19/19] drm_print: use

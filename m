...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2CC58C9964
	for <lists+intel-gfx@lfdr.de>; Mon, 20 May 2024 09:38:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00D4810E02E;
	Mon, 20 May 2024 07:38:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="a1FjbsV0";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C08DB10E027
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 May 2024 07:38:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1716190724; x=1747726724;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=8xXefKf8WB30DcVAlHPWRS+qBQ2K2n4+uKiZ1Q70mjM=;
 b=a1FjbsV0dPMUKyrNvlQU7KkQ4nvMNHbG0rj0i1I1MEDDCRaehqXKgFmS
 xId+3jO3nNpSG2zcS//7DnfHl995bxBhIDea2t5ZjhK4EZwLtt8qPLMis
 rb5ciIkftcSWzG5C+a+r3C3EtE1WPUvxE75iY9Wq6KwKI1o6pZg2TZW9t
 3o74iuwDV3QYw+Fco4VqUYyNhIAt+6DJDFQswXHB5Vcz/F0yzkw3N+fvQ
 KzDZaBoY29DqFzT8QlyHnr2KHJ6B9297RtPFuXtmXjSZB2FjY5mwnsPA3
 OG/kEN7NfQENmXRt8aUk3EgqLQY96E4xUv07jEfAXvNcZUD+zOlMO3ReG w==;
X-CSE-ConnectionGUID: 26IBX9gYT5CgBUcjJuJnZQ==
X-CSE-MsgGUID: mf2ZlNNPSvGlLWfFO/rycw==
X-IronPort-AV: E=McAfee;i="6600,9927,11077"; a="23444998"
X-IronPort-AV: E=Sophos;i="6.08,174,1712646000"; d="scan'208";a="23444998"
Received: from orviesa007.jf.intel.com ([10.64.159.147])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 May 2024 00:38:44 -0700
X-CSE-ConnectionGUID: hrFofgFlSoKFMONfqSDmFg==
X-CSE-MsgGUID: pj7tvDNHSiuZ9jaWrMoc0Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,174,1712646000"; d="scan'208";a="33053210"
Received: from unknown (HELO slisovsk-Lenovo-ideapad-720S-13IKB.fi.intel.com)
 ([10.237.72.65])
 by orviesa007.jf.intel.com with ESMTP; 20 May 2024 00:38:42 -0700
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.saarinen@intel.com,
	ville.syrjala@linux.intel.com
Subject: [PATCH 1/5] drm/i915: Rename all bigjoiner to joiner
Date: Mon, 20 May 2024 10:38:35 +0300
Message-Id: <20240520073839.23881-2-stanislav.lisovskiy@intel.com>

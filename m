...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0425542088
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 02:51:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0DFC10E62A;
...
Subject: [Intel-gfx] [PATCH] drm/i915: More PVC+DG2 workarounds

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wAkOAI1JxmmgIAUAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2026 10:10:37 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 828DC341841
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2026 10:10:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B17E010E323;
	Fri, 27 Mar 2026 09:10:30 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aafARmkE";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9124910E28D;
 Fri, 27 Mar 2026 09:10:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1774602630; x=1806138630;
 h=date:from:to:cc:subject:in-reply-to:message-id:
 references:mime-version;
 bh=RJmxSgiQs0p+uJA4H8xQXMZTKCZbNooaAmBKXEODK5I=;
 b=aafARmkEtxH8XbituKuRnUROtS8s2vpOYK8/DgWvmi3b/f5266qqaKlt
 Te25DqWVATF9Kk8hQLL4+7LIEUDYqT6RmMuIeY4HUOPWBvmq61DUQ5PUV
 fsCDmy6CfDMitUcy6zkEqn9c+JiH7RJzo9R7r32Abuf68/sNm30joeHUA
 HOyGjiacfkMxiXE0hbCFyZ3xWe/k4LzHpOhJq14AFo+KNAhoMEUDRyb/J
 HphW2wxjWpZwHD23l64NNx2R3UmVB62brp4k+wddtr3fvlpzMeMGg0An9
 kq1MXsObHZBteKzXo2L/mXoYkij0hO46VCE1pu8y+QVYGhuWvfs8pHzfk A==;
X-CSE-ConnectionGUID: LtBC4RmNSX+65uSttRafhQ==
X-CSE-MsgGUID: ms8akgqfQaWF70ONKYPGYg==
X-IronPort-AV: E=McAfee;i="6800,10657,11741"; a="101132989"
X-IronPort-AV: E=Sophos;i="6.23,143,1770624000"; d="scan'208";a="101132989"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Mar 2026 02:10:29 -0700
X-CSE-ConnectionGUID: E8MUt1ShTruB0OYIT2wvHw==
X-CSE-MsgGUID: AF+mCzC1SSK0wfzCqnN++w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,143,1770624000"; d="scan'208";a="220412441"
Received: from administrator-system-product-name.igk.intel.com
 ([10.91.214.181])
 by fmviesa006.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Mar 2026 02:10:28 -0700
Date: Fri, 27 Mar 2026 10:10:26 +0100 (CET)
From: =?ISO-8859-2?Q?Micha=B3_Grzelak?= <michal.grzelak@intel.com>
To: Ville Syrjala <ville.syrjala@linux.intel.com>
cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org, 
 Nemesa Garg <nemesa.garg@intel.com>
Subject: Re: [PATCH 3/9] drm/i915/casf: Move the casf state to better place
In-Reply-To: <20260326223139.19116-4-ville.syrjala@linux.intel.com>
Message-ID: <e45e984b-2087-2683-0cfb-33569562f1f1@intel.com>
References: <20260326223139.19116-1-ville.syrjala@linux.intel.com>
 <20260326223139.19116-4-ville.syrjala@linux.intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="8323329-753816395-1774602629=:330621"
...
--8323329-753816395-1774602629=:330621

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D60177C5EE0
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Oct 2023 23:04:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09AD410E1FD;
	Wed, 11 Oct 2023 21:04:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6A01D10E1F3
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=NZoV6n5G+p5YAIce/s7vIId0Ey+msFyqwUUmMlqy0D4=;
 b=FMtl1NbqI6IN7yBa1KkcFikYAfCy1Cn5inYiXQZSRt460VBf6ixhRncx
 4jy/QGFAxqgWetoQRQD5kh4tnZsbGRnJ6cfllt+PsVwWO5AY/As1kFpuN
 8q4z1qGIWCVtBQd8Q+TfmmF0ciKEg1sQ0I4EVzG5fFdI9nR7IBJ7ynfYI
 fHObeNfF85iHWNemA4sTU8rKGXi9wZOp0ocebOyubGWSQjdhIEkXW0jWM
 2QdLaIOeC49oDEA3O3ju8jsoBFCoiddWHeJJWI51Fcmnwe3rhReGkulYc
 BBOOiiCEx+Xlurz3UQXMLOfNzOtLhABDU7PwJ2QoVpCDsw5bV77JU4FeK A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10860"; a="375118428"
X-IronPort-AV: E=Sophos;i="6.03,217,1694761200"; d="scan'208";a="375118428"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2023 14:04:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10860"; a="757717905"
X-IronPort-AV: E=Sophos;i="6.03,217,1694761200"; d="scan'208";a="757717905"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2023 14:03:43 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 11 Oct 2023 13:52:55 -0700
Message-Id: <20231011205259.2295032-4-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 3/7] drm/i915: Define and use GuC and CTB

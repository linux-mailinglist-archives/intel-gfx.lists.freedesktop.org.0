...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A1D51EE906
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Jun 2020 19:00:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B448E6E519;
	Thu,  4 Jun 2020 17:00:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 95AB86E519
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Jun 2020 16:59:59 +0000 (UTC)
IronPort-SDR: BSuWHJuCLMksErlaPz55A1OOtoWcr1GPU9FHKtzDtZkjFT075Dnn+NTLSjyRfLxokH728p6091
 Hqp9MP3/UvFw==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jun 2020 09:59:58 -0700
IronPort-SDR: KNvjFMlbZvM3mfICl/meJvTQiPtBVuRJK0omDjvxQ5zdK64iIQp19hsIg3GUECnmW1g3OYzsUA
 JGqKEJ/9aBhQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,472,1583222400"; d="scan'208";a="312950022"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by FMSMGA003.fm.intel.com with SMTP; 04 Jun 2020 09:59:56 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 04 Jun 2020 19:59:55 +0300
Date: Thu, 4 Jun 2020 19:59:55 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Matt Roper <matthew.d.roper@intel.com>
Message-ID: <20200604165955.GY6112@intel.com>
References: <20200603211529.3005059-1-matthew.d.roper@intel.com>
 <20200603211529.3005059-14-matthew.d.roper@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20200603211529.3005059-14-matthew.d.roper@intel.com>
...
> @@ -16817,6 +16818,13 @@ static void intel_pps_init(struct drm_i915_priva=
te *dev_priv)
...
> @@ -16828,10 +16836,22 @@ static void intel_setup_outputs(struct drm_i915=
_private *dev_priv)
>  		return;
>  =
...
> @@ -265,6 +265,24 @@ void intel_disable_shared_dpll(const struct intel_cr=
tc_state *crtc_state)
...
> +/*
> + * HTI (aka HDPORT) may be using some of the platform's PLL's, making th=
em
> + * unavailable for use.
> + */
...
> @@ -280,6 +298,9 @@ intel_find_shared_dpll(struct intel_atomic_state *sta=
te,
>  =
...
> @@ -390,6 +390,7 @@ void intel_shared_dpll_swap_state(struct intel_atomic=
_state *state);
...
> @@ -2906,6 +2906,12 @@ static inline bool i915_mmio_reg_valid(i915_reg_t =
reg)

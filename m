...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EEAE2C64D1
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:11:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D8D36EC92;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 077/162] drm/i915/fbdev: Use lmem physical

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 03E114892FA
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Jan 2022 09:04:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1B8611BEBD;
...
Subject: Re: [Intel-gfx] [PATCH v7 1/6] drm: move the buddy allocator from

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EC52577BC5
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:41:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BB86A67D6;
	Mon, 18 Jul 2022 06:40:02 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 32/41] dyndbg: add _DPRINTK_FLAGS_TRACE

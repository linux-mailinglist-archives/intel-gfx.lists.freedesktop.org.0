...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1039B2D0890
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Dec 2020 01:22:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F1766E56A;
	Mon,  7 Dec 2020 00:22:13 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 90EBB6E544
 for <Intel-gfx@lists.freedesktop.org>; Mon,  7 Dec 2020 00:22:09 +0000 (UTC)
IronPort-SDR: wU+wYwSUsQiVCddLgQu79U8Na7zrYUhzN2B8eH4k2/GvR91JCtn3KHbpFQglUXtvhzBNZnJzxy
 pB4H7fmtZV6g==
X-IronPort-AV: E=McAfee;i="6000,8403,9827"; a="191889202"
X-IronPort-AV: E=Sophos;i="5.78,398,1599548400"; d="scan'208";a="191889202"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Dec 2020 16:22:08 -0800
IronPort-SDR: on2pS6ZcpjyMkUIoJ7OrXZkqqOont+ISBABQFUNQg4G8Lly3Atv9YdV9aRUZp+bElbgs50aqi2
 snMOvBwkTr/w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,398,1599548400"; d="scan'208";a="369586449"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga002.fm.intel.com with ESMTP; 06 Dec 2020 16:22:08 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Sun,  6 Dec 2020 16:21:31 -0800
Message-Id: <20201207002134.13731-14-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201207002134.13731-1-sean.z.huang@intel.com>
References: <20201207002134.13731-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v1 13/16] mei: pxp: export pavp client to me
 client bus

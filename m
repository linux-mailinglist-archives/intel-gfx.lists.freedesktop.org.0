...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0465D78C901
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Aug 2023 17:59:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85E7810E3E0;
...
Subject: [Intel-gfx] [RFC 06/33] drm: Add set colorpipeline property

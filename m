...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 53C47445362
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Nov 2021 13:54:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB7696F467;
...
Subject: Re: [Intel-gfx] [PATCH 06/29] drm/i915/gvt: move the gvt code into
 kvmgt.ko

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 73CE97D5BF9
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Oct 2023 21:58:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 911C310E4B3;
	Tue, 24 Oct 2023 19:58:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 688D610E4A1
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Oct 2023 19:58:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1698177510; x=1729713510;
 h=date:from:to:subject:message-id:references:in-reply-to:
 mime-version; bh=cGfFajyBsyFXgrZ3cWCJrbEdP7GZ0KHySorBTVoRoyc=;
 b=N5/18pIn1VhI1KO/6mSRv3lzH8ZWDeSQ9djeUb+K75AjDyENL4ylSy2e
 GLlAf9/Dw/CWyQZGjWeQN0bDexlgleVH2TlpS5REmQ/I5t7y1Z53ypF1n
 GJo7r2h2zDPj/cgrwUNBTseEI65jL4uLEtZxSsyG36RUOVq1HzFUJ2qg3
 za7Xqx5wrBrU9fTpV82wgsFipJYuYuUr0SS6852HELhN7vfcVSQdvDdp1
 R57JbTj0lJohF+/biXuqVxTwb5b5zZLI0wVK0wNQaMaSK0TlBGSNy65TH
 gCxHwLddgJM1eKvjQ+5fx6bk8qqexIgWt56ytfbCPWaEGqgnJ/hE/zlTZ g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10873"; a="386040968"
X-IronPort-AV: E=Sophos;i="6.03,248,1694761200"; d="scan'208";a="386040968"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2023 12:58:29 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10873"; a="758604089"
X-IronPort-AV: E=Sophos;i="6.03,248,1694761200"; d="scan'208";a="758604089"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
 by orsmga002.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384;
 24 Oct 2023 12:58:28 -0700
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 fmsmsx603.amr.corp.intel.com (10.18.126.83) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.32; Tue, 24 Oct 2023 12:58:27 -0700
Received: from fmsedg602.ED.cps.intel.com (10.1.192.136) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.32 via Frontend Transport; Tue, 24 Oct 2023 12:58:27 -0700
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (104.47.58.168)
 by edgegateway.intel.com (192.55.55.71) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.32; Tue, 24 Oct 2023 12:58:27 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=wP/cISOJ5EbyQF2TuDOZScZLVaSwCwOCNLYde4ukueY=;
 b=
...
Received: from DS7PR11MB7859.namprd11.prod.outlook.com (2603:10b6:8:da::22) by
 ...
 15.20.6907.26; Tue, 24 Oct 2023 19:57:59 +0000
Received: from DS7PR11MB7859.namprd11.prod.outlook.com
 ...
 19:57:59 +0000
Date: Tue, 24 Oct 2023 12:57:56 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: <intel-gfx@lists.freedesktop.org>
Message-ID: <20231024195756.GI1327160@mdroper-desk1.amr.corp.intel.com>
References: <20231019163913.2097183-2-matthew.d.roper@intel.com>
 <169817490769.18361.1190464146157231457@emeril.freedesktop.org>
Content-Type: text/plain; charset="us-ascii"
Content-Disposition: inline
In-Reply-To: <169817490769.18361.1190464146157231457@emeril.freedesktop.org>
...
X-MS-TrafficTypeDiagnostic: DS7PR11MB7859:EE_|CY8PR11MB7010:EE_
X-MS-Office365-Filtering-Correlation-Id: 0e300b2b-9882-4eba-deeb-08dbd4cb8607
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DS7PR11MB7859.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230031)(136003)(366004)(396003)(39860400002)(346002)(376002)(230922051799003)(186009)(451199024)(1800799009)(64100799003)(38100700002)(6512007)(86362001)(66476007)(33656002)(478600001)(66556008)(316002)(66946007)(6666004)(966005)(6916009)(6486002)(30864003)(82960400001)(6506007)(83380400001)(26005)(1076003)(8936002)(41300700001)(5660300002)(2906002)(559001)(579004);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?75p5P3aUjdsK5q6Ahx5VkMD/hGR+P61HG2Mj8eAKLh7zsZuaZEKa75utyMfA?=
 =?us-ascii?Q?rIyvW9RIXVXNgsxsQ2Vw6XK9RHRAkdQQicFh3a9cjXzvqxOrCWv/81k0KGBj?=
 =?us-ascii?Q?7Fp4xSS4M9wrdKvU0AIFW2J5cssZf2vTpRk1Lo4SWD+I/Rf+OyXA+4CWqHrO?=
 =?us-ascii?Q?TkA15/0oUSGCjVu3ExWfky0yJhgbZMGoqEXzx9vE3Auffc/ZwNFLnAEAqYuZ?=
 =?us-ascii?Q?yvMYw6etE0FD8fJyu1hdtJLwThDAFdnjgxBpLTskokxoLcEZb9f5OsrjQ9uw?=
 =?us-ascii?Q?rEkzltQKzLsw81W/1QfR9u9y5m+KsdsAm7dKXQoXPJxIUd+D5Ixt97WHWFcB?=
 =?us-ascii?Q?vZ7aSPh9GfXAa9dFPoiHbfFdlSjfz4RBfJ8C7s+3Y+a3OZF858dSHsZD3eE4?=
 =?us-ascii?Q?AbhI7CiaYp1ht+rkkosIKxym8cqvKI48AaK5MOnJE7LWxIKpSPfXZmOgZsZS?=
 =?us-ascii?Q?PMzRkbEj87ee2YjrpAJQZDL5BdZB+eDYBx7q+/Zb4vayB3d28n02vNXlgomM?=
 =?us-ascii?Q?Ku44X8lMGtewrx4oOAnn+j7suBvoc6HZbOaLCrI8QZWFELYWkBGM9Cl+0vOW?=
 =?us-ascii?Q?k7SxLWn7UKDZsU/KBqKFwdcmqE3der9uhWc6KoezVNU1UHRFlt5PwGNX/dSX?=
 =?us-ascii?Q?uVikC4SzNPoxJN4I54JX4LsimpwikF/nyEQ/9X/mo/ViEQDAP5WgdJNvj6O6?=
 =?us-ascii?Q?9fsNxPMeyXSMR1RvZ8fsYjsezifQT4f7R6KofB63jRewi1MOYO9XCL7XdaD/?=
 =?us-ascii?Q?wANnHQj1y5bZVXBwvCsP9vhUsiPonRr08v0nxnbdV3qC4mjc8QdQGf6RRlDz?=
 =?us-ascii?Q?+mrtQKqTMbtuP2+KLJLcG7B5lpA508QH3uB29X9QOY/Iuv8Okkhv2qiosG5W?=
 =?us-ascii?Q?VvVtz/nF8+bIsJpa+PKD57AE6bocoeKkhDQxUc+szGSJ6N2ohaFVoY7/jes/?=
 =?us-ascii?Q?i40VxONiqWx7v8AhN7slp6uCyk3LQwi71WM6Pj7RDLmRQDYM5TvH4lZfH68b?=
 =?us-ascii?Q?rZ+/oj8VXwkNbqr6G2P5HzqbpOvteYnOmGyGuo1xnfOxGiBMNAdViOSGus3M?=
 =?us-ascii?Q?Ek0rt9S3PHs8uy8dSGnYoDwxt+wpT6BpR/NbJueAj+zTEk8ObFt4REzAcfo6?=
 =?us-ascii?Q?aPrLBygmKbxOXJXAYR+YwIGXCGXnR1Y/3je4EUxfBabrAHdUhmM0dD5WtMQf?=
 =?us-ascii?Q?OBP+4CIo46p44uzM3gqV1MApCC5bYFtO3bFb2A71s+vmx0qIzc81KjKbqRif?=
 =?us-ascii?Q?RoBsljoIEg7cJVpIljzNAF8OmWl5w3DeOBdXY6VsR68M2Ns4u4gfa67xOlSM?=
 =?us-ascii?Q?Ma4A1ag871SrWC2XbE8EyLFTfyb2xQ96BuKnMYDp/QOjPA2IRUtJ/m4ojRTN?=
 =?us-ascii?Q?86FoVpNdtHaJgrv/sxYtTHt7iXd/FRkJCEbPfWq4jUT1htts8kTSHdmvgb6E?=
 =?us-ascii?Q?CAs3bvaRiUrBacgD1QlA34ANusXMQ6sw9RKIeBn3HhGlS8o+bpNkVZ1G/0L8?=
 =?us-ascii?Q?xyXEezWs+DknbvFhFJrrvZ1MLiUusw7p/D6akNIhjH/U33gInsVoK330zP+x?=
 =?us-ascii?Q?qrZgheYIUDBKw/SLf2RuWeo4t/b5G8CQXBLq+AeFpMrrwNF9AJPmDxgFFwhw?=
 =?us-ascii?Q?Gg=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 0e300b2b-9882-4eba-deeb-08dbd4cb8607
X-MS-Exchange-CrossTenant-AuthSource: DS7PR11MB7859.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 Oct 2023 19:57:59.7212 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: lHyEDcwTITZ20w4fZLZSr66i5SJVCUD2F6zMXKolo90drcos3wmOTsdohBMiw/C461mYeQK/7cdrZU6tj/zPIAVuN0PGxx3i9bFHMTTNGb0=
...
On Tue, Oct 24, 2023 at 07:15:07PM +0000, Patchwork wrote:
> == Series Details ==
> 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C9158435F1E
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Oct 2021 12:36:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A09428933E;
...
Subject: [Intel-gfx] [PATCH 04/28] drm/i915: Remove unused bits of
 i915_vma/active api

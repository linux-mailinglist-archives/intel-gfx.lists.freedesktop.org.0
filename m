...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CCCA1AB74F
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Apr 2020 07:32:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 882EB6E22D;
...
Subject: [Intel-gfx] improve use_mm / unuse_mm v2

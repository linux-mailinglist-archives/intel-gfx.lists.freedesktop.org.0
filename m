...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DD2B798A13A
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Sep 2024 13:55:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE03F10E3FE;
	Mon, 30 Sep 2024 11:55:22 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="UtdrEsYG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9AFEF10E008
 for <intel-gfx@lists.freedesktop.org>; Mon, 30 Sep 2024 11:55:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1727697320;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=0v6DObG63EY4YajT8ZNotVrkyIa+4XBbZiluXGochPk=;
 b=UtdrEsYGUU4MYQ2EK40cFi8FLie29M8iZ+qsdFUAX7ITOSmJaj15OP88KDXQLjs3YlqOYQ
 hlUj/+uFUFfM0qAz7ussr0aM7cpX8wjBQmYC4GRCaiUscFVPjbCdTtcq+icta/FNmj0j5P
 GuGZYd9kTHsD6R5dNeP08Jrw3ixPQJw=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-645-hX8IoWNNPTSAr5oIeh66jA-1; Mon, 30 Sep 2024 07:55:19 -0400
X-MC-Unique: hX8IoWNNPTSAr5oIeh66jA-1
Received: by mail-wr1-f71.google.com with SMTP id
 ffacd0b85a97d-37cd282fb39so1925248f8f.2
 for <intel-gfx@lists.freedesktop.org>; Mon, 30 Sep 2024 04:55:19 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=0v6DObG63EY4YajT8ZNotVrkyIa+4XBbZiluXGochPk=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCVHgrTL0eDghWX4Zc56N7X8CljJo1+BNlYInOg/BqR1j4U/RkX/65Tppm2FSrCy5sRbduRLFazAepY=@lists.freedesktop.org
X-Gm-Message-State: AOJu0Yx1Mr1XoBriaaEeicbobV8vccfyM8GeUxvSyljfPX3otUVUqdvN
 OK9B/k/EhMjRucefPGWj/L+jRcCtzhKmCbY2g6Cq6EmP7i/CXV2LLe2l5Op31kWN4YzHCPWlQ5h
 JixTRKZoR3S6rArXQ5I7zuS1d0294U6lYzjrDdtbcymkoDPxJ7PGchEJbtWYoZHJE7Q==
X-Received: by 2002:a05:6000:1105:b0:37c:d1e3:198b with SMTP id
 ffacd0b85a97d-37cd5b1e3famr5432687f8f.58.1727697318348; 

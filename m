...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C7AFD4D0854
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Mar 2022 21:30:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 360A810E181;
...
Subject: [Intel-gfx] [RFC v2 1/2] drm/doc/rfc: VM_BIND feature design
 document

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A5F80181D31
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Mar 2020 17:07:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 060B66E9AE;
	Wed, 11 Mar 2020 16:07:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4D57B6E9AE
 for <intel-gfx@lists.freedesktop.org>; Wed, 11 Mar 2020 16:07:47 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20523875-1500050 
 for multiple; Wed, 11 Mar 2020 16:07:40 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 11 Mar 2020 16:07:39 +0000
Message-Id: <20200311160739.21475-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/gem: Drop cached obj->bind_count
...
index 19195bde4921..8030307fe6d6 100644
...
index ca5420012a22..c67042ec44bb 100644
...
index 5b3efb43a8ef..ed65d92a7609 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04A0E60DD16
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Oct 2022 10:33:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6152310E2D6;
...
Subject: Re: [Intel-gfx] [PATCH v2 00/16] drm/edid: EDID override

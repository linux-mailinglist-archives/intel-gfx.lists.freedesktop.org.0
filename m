...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E2C0B1C1213
	for <lists+intel-gfx@lfdr.de>; Fri,  1 May 2020 14:21:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F00056EC73;
	Fri,  1 May 2020 12:20:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CF8456EC73
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 May 2020 12:20:53 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  1 May 2020 14:20:38 +0200
Message-Id: <20200501122043.2504429-19-maarten.lankhorst@linux.intel.com>
...
@@ -4661,6 +4661,7 @@ static int __live_lrc_state(struct intel_engine_cs *engine,
 {
...
+	struct i915_gem_ww_ctx ww;
 	enum {
 		RING_START_IDX = 0,
 		RING_TAIL_IDX,
@@ -4675,7 +4676,11 @@ static int __live_lrc_state(struct intel_engine_cs *engine,
 	if (IS_ERR(ce))
 		return PTR_ERR(ce);
...
@@ -4704,11 +4709,9 @@ static int __live_lrc_state(struct intel_engine_cs *engine,
...
-	i915_vma_unlock(scratch);
 	...
 	i915_request_get(rq);
 	i915_request_add(rq);
@@ -4745,6 +4748,12 @@ static int __live_lrc_state(struct intel_engine_cs *engine,
 err_unpin:

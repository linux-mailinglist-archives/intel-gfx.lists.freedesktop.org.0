...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DE25A758146
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 17:48:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3FD8210E375;
	Tue, 18 Jul 2023 15:48:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 52F4110E373
 for <intel-gfx@lists.freedesktop.org>; Tue, 18 Jul 2023 15:48:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689695331; x=1721231331;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=6W7EWQnvBSTKoSeQwNRKtIRmGgMOA94fxbwWSAbgAys=;
 b=TPmRIWYWqQanE2IXQtrgM/PVB8Yr3ZU+BRvw8TetLvYxjOcZ0AyD/Ap9
 00Mk5pRQfGFdto4S9PTSMDcGl02+F7bChS9Dux07yqLgQf1BzbJ2dhqrX
 ekBEymS8Cg/SFBMzBN1SS3trAZOdPx3sS0EFxi1jFbSCq2XBtqqvUawdc
 uGXMr4P/tge1ce4QQNIUBBM04fVqeQBRyC6uUvQIeoFe4lW85UElQf6Aa
 YLrz76ARRGL0I4aoOe6aQW2end8i8yfgN/7/6aRfg9g78A8C2to2vpJ2Y
 j6JuBEgsqXCY9Y99AUfTtuJB6Niev0GcLYdVDAPV4daO91R8CH9aigcTU Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="356185600"
X-IronPort-AV: E=Sophos;i="6.01,214,1684825200"; d="scan'208";a="356185600"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Jul 2023 08:48:50 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="700961994"
X-IronPort-AV: E=Sophos;i="6.01,214,1684825200"; d="scan'208";a="700961994"
Received: from maloneyj-mobl.ger.corp.intel.com (HELO [10.213.207.99])
 ([10.213.207.99])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Jul 2023 08:48:48 -0700
Message-ID: <2d76238d-1cd5-09fe-3a7a-53c088560bde@linux.intel.com>
Date: Tue, 18 Jul 2023 16:48:46 +0100
MIME-Version: 1.0
...
In-Reply-To: <5beeb696-d720-4d08-9644-a98402d34194@intel.com>

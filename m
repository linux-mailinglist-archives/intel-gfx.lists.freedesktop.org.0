...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C0E865486E
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Dec 2022 23:29:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CBCB310E5A0;
...
Subject: [Intel-gfx] [RFC PATCH 08/20] drm/sched: Add helper to set TDR
 timeout

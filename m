...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C7A22E9454
	for <lists+intel-gfx@lfdr.de>; Mon,  4 Jan 2021 12:52:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E060A89DA9;
	Mon,  4 Jan 2021 11:52:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 772AA89B4D
 for <intel-gfx@lists.freedesktop.org>; Mon,  4 Jan 2021 11:52:07 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23495870-1500050 
 for multiple; Mon, 04 Jan 2021 11:51:53 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  4 Jan 2021 11:51:45 +0000
Message-Id: <20210104115145.24460-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 6/6] drm/i915/gt: Remove timeslice suppression
...
@@ -1371,16 +1344,16 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -1416,7 +1389,6 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -1443,7 +1415,6 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -1607,29 +1578,23 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -1987,8 +1952,6 @@ process_csb(struct intel_engine_cs *engine, struct i915_request **inactive)
 		}
 	} while (head != tail);
...
@@ -2001,6 +1964,7 @@ process_csb(struct intel_engine_cs *engine, struct i915_request **inactive)
 	 * invalidation before.
 	 */
...
@@ -2413,8 +2377,10 @@ static void execlists_submission_tasklet(unsigned long data)
...
+	}
 	...
 	rcu_read_unlock();
@@ -3859,9 +3825,6 @@ void intel_execlists_show_requests(struct intel_engine_cs *engine,

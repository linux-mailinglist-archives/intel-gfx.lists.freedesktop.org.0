...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B20045A4DAC
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:19:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC50610F270;
	Mon, 29 Aug 2022 13:19:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B190510F278
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Aug 2022 13:19:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661779153; x=1693315153;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=4fzF29MUAki61A6xE3xP/1FQaX03ew6EeNaKrKknoK8=;
 b=IxS4KPJSV+Wvop1lgRYQbj4Ht1rW36VrZx3d7jKarrURzELsUs/gUaF4
 2WatLD+SMGZtR8VdNDyfJzHImPiPH3oHu2TUsi9bx2tdJ63y2Gw5uDH37
 rRt+f+LQMWMLX/+ETrcoTdxsUcoU4N3ws3SC5HLltytRYmU9e4ylkhdxO
 mBXOw1NUjhCCc/Wgwct5MRTtDBW7jIN3BPoFJYGd9abu8V4jiUfFhRdp5
 L9qKvGx4l2FHAk7rJ7GbyO+Dd6iwu30BoMqAmgN4BnjYoCNVzGysivfLI
 mY4j2CBPrmv9S3sCO1ZCTm5IZY9l9EvCo2n34a3SFQ3JezoW+2ka/OTPA Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10454"; a="356605657"
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="356605657"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:19:12 -0700
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="679621259"
Received: from idecesar-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.53.198])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:19:11 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 29 Aug 2022 16:18:16 +0300
Message-Id: <57bfa82f6fe85a775f80c398b2a7dff77b9452b0.1661779055.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 09/18] drm/i915: move and group power related
...
index 438a368ba358..b64aec60c36c 100644
...
index 63fd18732db3..3e99a6a88c3a 100644
...
index 43e73f6d7ef3..074679320056 100644
...
@@ -360,8 +359,6 @@ struct drm_i915_private {
 	 */
 	u32 edram_size_mb;
...
@@ -369,8 +366,6 @@ struct drm_i915_private {
...
@@ -439,16 +434,11 @@ struct drm_i915_private {

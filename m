...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D76EE4FF6B7
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Apr 2022 14:25:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C7F6510E775;
...
Subject: [Intel-gfx] [PATCH 0/2] drm/i915/gvt: clean up makefile

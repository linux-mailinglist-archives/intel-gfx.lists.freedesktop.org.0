...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A936730F3BF
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Feb 2021 14:18:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8098A6ECB5;
...
Subject: [Intel-gfx] [PATCH RFC v1 5/6] xen-swiotlb: convert variables to
 arrays

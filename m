...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BCF614066D2
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 07:33:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25EB56E970;
...
Subject: [Intel-gfx] [PATCH 2/6] drm/i915/uncore: Associate shadow table
 with uncore

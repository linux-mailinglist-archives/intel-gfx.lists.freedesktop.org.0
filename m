...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9647E5B64C1
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Sep 2022 02:59:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AECAB10E4BE;
...
Subject: [Intel-gfx] [PATCH v5 05/15] mei: pxp: add command streamer API to
 the PXP driver

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DD786F1064
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 04:34:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C030E10EC2D;
	Fri, 28 Apr 2023 02:34:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 162AA10EC29;
 Fri, 28 Apr 2023 02:34:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682649275; x=1714185275;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=YtJD7ZfMWiIn0x/vN3tifyOnTldu9hXsM1lCyNsmu2c=;
 b=VOhz5TPEZB1tIcsUzalbHlndPwcZiBPNFLiKatFguBB+8DfnqCz6lQiS
 9LgM15+WYepBkjkemd+iCfrCdP+KxwUcMzYkgwTwgBsCsO2QYlUj4PuCp
 i54GjqxlDq16DHl6Icqb6vBzrhWdYgmnzPeh9tIkO2HB32xT6Xf5zYkTa
 Q+twLR6QEqE5VsigKE7H+UTrvNSVUo45fdjIHbCMugFCCmXGjKD01PaMA
 BUsdo9Seotiw0PynMclrYU25btwN9wnVygKxr7gjDzR5w1dwEPatpAowc
 rzjsaJkLyOxUNz3HjnUJQULaLqQG8VXytNx0gIdoYlyslp3FgyMxGx4ZF w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="346386503"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="346386503"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 19:34:34 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="644937221"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="644937221"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 19:34:34 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Apr 2023 19:34:12 -0700
Message-Id: <20230428023416.4051910-5-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH 4/8] drm/i915/huc: Load GSC-enabled HuC via DMA

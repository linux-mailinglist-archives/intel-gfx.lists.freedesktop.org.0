...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2F714BDAF4
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Feb 2022 17:46:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6C1110E4DB;
...
Subject: [Intel-gfx] [PATCH v13 2/5] drm: implement top-down allocation
 method

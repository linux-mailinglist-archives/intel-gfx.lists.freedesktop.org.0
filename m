...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 680B163ACB2
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Nov 2022 16:35:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D7C789654;
	Mon, 28 Nov 2022 15:35:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0F61610E2E2
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Nov 2022 15:35:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669649736; x=1701185736;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=Fioqo7129KUd5huD8pVg3Kp0PhbnAGyiZikcrbHRMoI=;
 b=PYCoxf2YGfTorJfUQHXceNngYUmHqDjBZ2UuxNGP0MgyMXy60Rm8F7JQ
 wMco+eGQcz+MKEgXEiPXjqoPQWxdpwlGt5oDud4g/AG63hD+gqprY8RyM
 nfhS1SMRaJNH05CqGcUf/fJe3Djv3yjn2gtbtpOXA03OkOVsE7C2yslqc
 QX78J93LilXFl/ORFNXolZutJmM8Q16t1ryZpB6701IPAgWL2Cd77yT1I
 g1N/HfyS7ok/qV3Bw9tpysiO4GRYXKEhKQ0Oc/bDiMgVYC+0ACKtuxIe6
 HrbUt7eB40cUzNXuYvXkT4cIMHkeXCL28SotN0GrYNSFlBbPd6MlBL3++ g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10545"; a="294563237"
X-IronPort-AV: E=Sophos;i="5.96,200,1665471600"; d="scan'208";a="294563237"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2022 07:27:53 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10545"; a="732178383"
X-IronPort-AV: E=Sophos;i="5.96,200,1665471600"; d="scan'208";a="732178383"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
 by FMSMGA003.fm.intel.com with ESMTP; 28 Nov 2022 07:27:46 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1ozg2s-00086p-0n;
 Mon, 28 Nov 2022 15:27:46 +0000
Date: Mon, 28 Nov 2022 23:27:31 +0800
From: kernel test robot <lkp@intel.com>
To: Ankit Nautiyal <ankit.k.nautiyal@intel.com>,
 intel-gfx@lists.freedesktop.org
Message-ID: <202211282330.aRvIjg66-lkp@intel.com>
References: <20221128101922.217217-3-ankit.k.nautiyal@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="pS8naTXPpY48hs0L"
Content-Disposition: inline
In-Reply-To: <20221128101922.217217-3-ankit.k.nautiyal@intel.com>
Subject: Re: [Intel-gfx] [PATCH 02/11] drm/display/dp: Add helper function
 to get DSC bpp prescision
...
url:    https://github.com/intel-lab-lkp/linux/commits/Ankit-Nautiyal/Add-DSC-fractional-bpp-support/20221128-182139
base:   git://anongit.freedesktop.org/drm/drm-tip drm-tip
patch link:    https://lore.kernel.org/r/20221128101922.217217-3-ankit.k.nautiyal%40intel.com
patch subject: [Intel-gfx] [PATCH 02/11] drm/display/dp: Add helper function to get DSC bpp prescision
config: x86_64-allmodconfig
compiler: gcc-11 (Debian 11.3.0-8) 11.3.0
reproduce (this is a W=1 build):
        # https://github.com/intel-lab-lkp/linux/commit/f2284323c8d5ced115fe358e76bb7955dfaea22c
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Ankit-Nautiyal/Add-DSC-fractional-bpp-support/20221128-182139
        git checkout f2284323c8d5ced115fe358e76bb7955dfaea22c
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        make W=1 O=build_dir ARCH=x86_64 SHELL=/bin/bash drivers/gpu/drm/display/
...
All warnings (new ones prefixed by >>):
   ...
   drivers/gpu/drm/display/drm_dp_helper.c: In function 'drm_dp_dsc_sink_bpp_incr':
>> drivers/gpu/drm/display/drm_dp_helper.c:2334:41: warning: array subscript 15 is outside array bounds of 'const u8[15]' {aka 'const unsigned char[15]'} [-Warray-bounds]
    2334 |         u8 bpp_increment_dpcd = dsc_dpcd[DP_DSC_BITS_PER_PIXEL_INC - DP_DSC_SUPPORT];
         |                                 ~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   drivers/gpu/drm/display/drm_dp_helper.c:2332:38: note: while referencing 'dsc_dpcd'
    2332 | u8 drm_dp_dsc_sink_bpp_incr(const u8 dsc_dpcd[DP_DSC_RECEIVER_CAP_SIZE])
         |                             ~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


vim +2334 drivers/gpu/drm/display/drm_dp_helper.c

  2325	
  2326	/**
  2327	 * drm_dp_dsc_sink_bpp_incr() - Get bits per pixel increment
  2328	 * @dsc_dpcd: DSC capabilities from DPCD
  2329	 *
  2330	 * Returns the bpp precision supported by the DP sink.
  2331	 */
  2332	u8 drm_dp_dsc_sink_bpp_incr(const u8 dsc_dpcd[DP_DSC_RECEIVER_CAP_SIZE])
  2333	{
> 2334		u8 bpp_increment_dpcd = dsc_dpcd[DP_DSC_BITS_PER_PIXEL_INC - DP_DSC_SUPPORT];
  2335	
  2336		switch (bpp_increment_dpcd) {
  2337		case DP_DSC_BITS_PER_PIXEL_1_16:
  2338			return 16;
  2339		case DP_DSC_BITS_PER_PIXEL_1_8:
  2340			return 8;
  2341		case DP_DSC_BITS_PER_PIXEL_1_4:
  2342			return 4;
  2343		case DP_DSC_BITS_PER_PIXEL_1_2:
  2344			return 2;
  2345		case DP_DSC_BITS_PER_PIXEL_1:
  2346			return 1;
  2347		}
  2348	
  2349		return 0;
  2350	}
  2351	EXPORT_SYMBOL(drm_dp_dsc_sink_bpp_incr);
  2352	

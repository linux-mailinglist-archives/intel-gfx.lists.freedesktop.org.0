...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9741F786DB
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Jul 2019 09:59:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02F3489D46;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 5/9] drm/i915: vgpu context submission pv
 optimization

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DDF0324C4FC
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Aug 2020 20:02:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3966C6E9AF;
	Thu, 20 Aug 2020 18:02:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 599D06E9A7
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Aug 2020 18:02:07 +0000 (UTC)
IronPort-SDR: ec+wIInrdyq0vpZMdNVmXby17pGJ+zNIymH/0mNJSFmlOZL49htsgb4Xc1EGbnC7XbcDIw9NCe
 tthE1G0S3s1g==
X-IronPort-AV: E=McAfee;i="6000,8403,9718"; a="154638698"
X-IronPort-AV: E=Sophos;i="5.76,334,1592895600"; d="scan'208";a="154638698"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Aug 2020 11:02:06 -0700
IronPort-SDR: idOWpjUg9KGioSQ5a8iHefpnfa2ZrkRSIL5SvSjFEWDkuyCP/nLsGmm/6DeeRr34E8V+sYyKi8
 nFVmN1fFJIyA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.76,334,1592895600"; d="scan'208";a="442071393"
Received: from orsosgc001.ra.intel.com ([10.23.184.150])
 by orsmga004.jf.intel.com with ESMTP; 20 Aug 2020 11:02:00 -0700
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 20 Aug 2020 11:02:00 -0700
Message-Id: <20200820180200.68355-5-umesh.nerlige.ramappa@intel.com>
...
@@ -3265,6 +3267,44 @@ static long i915_perf_config_locked(struct i915_perf_stream *stream,
 	return ret;
 }
...
@@ -3290,6 +3330,8 @@ static long i915_perf_ioctl_locked(struct i915_perf_stream *stream,
 		return 0;
...
+		return i915_perf_oa_buffer_info_locked(stream, cmd, arg);
 	...
 	return -EINVAL;
@@ -3361,6 +3403,14 @@ static int i915_perf_release(struct inode *inode, struct file *file)
...
@@ -3371,6 +3421,75 @@ static int i915_perf_release(struct inode *inode, struct file *file)
 	return 0;
 }
...
+}
 ...
 static const struct file_operations fops = {
 	.owner		= THIS_MODULE,
@@ -3383,6 +3502,7 @@ static const struct file_operations fops = {
...
@@ -4527,8 +4647,12 @@ int i915_perf_ioctl_version(void)
 	 *

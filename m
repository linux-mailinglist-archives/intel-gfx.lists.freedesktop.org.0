...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21697759347
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jul 2023 12:41:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77AC710E463;
	Wed, 19 Jul 2023 10:41:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EED8310E463
 for <intel-gfx@lists.freedesktop.org>; Wed, 19 Jul 2023 10:41:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689763280; x=1721299280;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=rZ8/t8r6t/ihbwpHfbeOVJYARiic1ByocxdM/OiMCwY=;
 b=FcZO3R9A3e0ZDwc3x8GcWNVYgaU4f68PyJtrlg5NCPtTUK86gBEnTfSd
 Avilpz9MS74rvJctsP3j1Kbe35bBhGLgeqGxfIBfP50DwJiQbo9Jdbesx
 toKsfukx+EDBjSaCNYwRdcl8kGkSINtkdfHuwWbVf35sq9ZZgD/m5ck5U
 DWkBygu4YqEuLaRI94WVWa1Pz0dijAua2UGYTTX0dCqfp6DiYtJwBUQR1
 4uioI/UGKcXaLgre3EUpdEBfPBEyEIIqZjsr+MfyGIicb9q9rMoPEHrH+
 +g6nWLNbkcaZFUttY+fRjQ7TB0PCArhWnohp4elNwglBDpSXm8AUhvOBE g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="365308509"
X-IronPort-AV: E=Sophos;i="6.01,216,1684825200"; d="scan'208";a="365308509"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jul 2023 03:41:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="970569518"
X-IronPort-AV: E=Sophos;i="6.01,216,1684825200"; d="scan'208";a="970569518"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.19.239])
 ([10.213.19.239])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jul 2023 03:41:17 -0700
Message-ID: <4059a0cd-cc3f-46a7-a1bf-bcbe74ac3d9f@intel.com>
Date: Wed, 19 Jul 2023 12:41:10 +0200
MIME-Version: 1.0
...
In-Reply-To: <2d76238d-1cd5-09fe-3a7a-53c088560bde@linux.intel.com>

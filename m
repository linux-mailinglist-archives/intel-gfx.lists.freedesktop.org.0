...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E3738C9D2F
	for <lists+intel-gfx@lfdr.de>; Mon, 20 May 2024 14:27:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9891110E6B8;
	Mon, 20 May 2024 12:27:23 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="dq3+PP/Y";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5A8C410E697
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 May 2024 12:27:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1716208040; x=1747744040;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=kI+oFa0OIqzV/mhgXfE3tKcJG31Gw5HZVcejCjJMRbg=;
 b=dq3+PP/Y28TzXCk5dZb1PiwlOdnzVoWtWf23LlxgjuqLwlSX+N7U7V/i
 iDggKbXjQdZJpBYO7mWl2EqC77iSkywGIIeFP/Au6r8n7KZleOiahLVoZ
 6oO6Z4xYNuYtIGEOiLK5xIZH8TjlOmdGWp9+vaU3aJuOz39bAEFH3w8Gx
 eUM5wpbjp+Ne/vj8YD7henFFJdIaU7xMGVK9Ey6xxK3pz7msYFH2BJghK
 xVSMF39O6Jui2SXoDQHIxDPenRPe2mGfD85i5eMnb3x73haJakqEd8J99
 hF57irL6GvAKD5uWiopqnVNm52HgrwNJJsgnKuXSWpeznoPku9aKGuxwN A==;
X-CSE-ConnectionGUID: cv3zuRnoSQ2D14OqoRJ2Fg==
X-CSE-MsgGUID: Mpy0mrX6TWGBIT0ljyiToA==
X-IronPort-AV: E=McAfee;i="6600,9927,11078"; a="16158746"
X-IronPort-AV: E=Sophos;i="6.08,175,1712646000"; d="scan'208";a="16158746"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 May 2024 05:27:20 -0700
X-CSE-ConnectionGUID: DMkbe+w0Q3eH83+qsPKCpw==
X-CSE-MsgGUID: lB9eBQ0aSEGnGbiOCzM72w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,175,1712646000"; d="scan'208";a="32418628"
Received: from unknown (HELO localhost) ([10.245.246.99])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 May 2024 05:27:16 -0700

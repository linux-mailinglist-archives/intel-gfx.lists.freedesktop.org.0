...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 980045A7227
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Aug 2022 02:01:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A12510E3AB;
...
Subject: Re: [Intel-gfx] [PATCH 2/8] drm/i915: Only hook up uncore->debug
 for primary uncore

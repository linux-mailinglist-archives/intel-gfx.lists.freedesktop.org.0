...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A9B8C43D4A8
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Oct 2021 23:21:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0BA96E91F;
...
Subject: [Intel-gfx] [PATCH v3 07/17] drm/i915/xehpsdv: implement memory
 coloring

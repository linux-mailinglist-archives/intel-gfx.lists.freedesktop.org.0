...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AAFA0304BAA
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Jan 2021 22:45:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BC216E4A1;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 5/9] drmcg: Add support for device memory
 accounting via page counter

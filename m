...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22BE12C6557
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:13:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7ADB46ED10;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 129/162] drm/i915/dg1:
 i915_gem_object_memcpy(..) infrastructure

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02B1E75CCAC
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jul 2023 17:53:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9FA2D10E6B4;
	Fri, 21 Jul 2023 15:53:35 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: Use the i915_vma_flush_writes
 helper

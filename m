...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 14A5E31204D
	for <lists+intel-gfx@lfdr.de>; Sat,  6 Feb 2021 23:32:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 517C36E49C;
	Sat,  6 Feb 2021 22:31:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5E10389DB5
 for <intel-gfx@lists.freedesktop.org>; Sat,  6 Feb 2021 22:31:53 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.69.177; 
Received: from build.alporthouse.com (unverified [78.156.69.177]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23807901-1500050 
 for <intel-gfx@lists.freedesktop.org>; Sat, 06 Feb 2021 22:31:49 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sat,  6 Feb 2021 22:31:47 +0000
Message-Id: <20210206223148.16762-3-chris@chris-wilson.co.uk>
...
index 636a2190e535..28d2a121f2c0 100644
...
@@ -1356,205 +1313,69 @@ static void hexdump(struct drm_printer *m, const void *buf, size_t len)
 	}
 }
...
@@ -1584,9 +1405,9 @@ static void print_properties(struct intel_engine_cs *engine,
 	};
 	const struct pmap *p;
...
-	unsigned long flags;
 	...
 	if (header) {
@@ -1614,78 +1433,41 @@ void intel_engine_dump(struct intel_engine_cs *engine,

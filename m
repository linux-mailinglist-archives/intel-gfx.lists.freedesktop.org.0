...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ABA074F387E
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 16:34:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B33910E732;
	Tue,  5 Apr 2022 14:34:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D593310E732;
 Tue,  5 Apr 2022 14:34:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1649169257; x=1680705257;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=7QWOcN5xHytWixrkVZERQ4mhV5yhqGT82aDJJnK893E=;
 b=JU4UDuEczPcg7IKayHLYMO7rbIgnXqtEaIuWQHmQs5RZucQszGCXPs0j
 VcLtKxSfQesHP3frtN8hGrpzdRsT0i+8k0ZjaxW39MZPCXtXCVDyEAD/0
 5R61l/gItZr4J2pSRE+S6GniOJtFU1acWRoBcueLE2LKPVf6iopt7weI5
 XQSSaeBvnX+EopJfuu/5ivnetm3giMb3tYRgBbZP+OwVbUTeK7nYrZxrK
 YElOOuqdj+NvtP93H8ssCQyTHT9vozucga69yojFAYNhc/Z+5zzdeZO70
 TfHK+oZA5WDj7xQcIlE6C6kwRLGL7BoxAUnXmMCAQOmwgNPuALW47oxqR g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10307"; a="285722202"
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="285722202"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Apr 2022 07:34:17 -0700
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="657958993"
...
Date: Tue,  5 Apr 2022 20:04:50 +0530
Message-Id: <20220405143454.16358-6-ramalingam.c@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 5/9] drm/i915/gt: Clear compress metadata for
 Flat-ccs objects
...
+
 ...
 {
@@ -690,6 +809,7 @@ intel_context_migrate_clear(struct intel_context *ce,
 			    u32 value,
...
+	struct drm_i915_private *i915 = ce->engine->i915;
 	...
 	u32 offset;
@@ -701,7 +821,7 @@ intel_context_migrate_clear(struct intel_context *ce,
...
+	if (HAS_64K_PAGES(i915) && is_lmem)
 	...
 	do {
@@ -743,6 +863,21 @@ intel_context_migrate_clear(struct intel_context *ce,
 			goto out_rq;

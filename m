...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F66976A6CE
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 04:12:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CCE9E10E2FA;
...
Subject: Re: [Intel-gfx] [PATCH v4 07/29] drm/i915/gvt: Error out on an

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F15994375C
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jun 2019 16:50:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1FA808999E;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH] i915: no need to check return value of

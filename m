...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D8ECF73C2A9
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Jun 2023 23:22:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 099E010E6BA;
...
Subject: [Intel-gfx] [PATCH 00/26] use array_size

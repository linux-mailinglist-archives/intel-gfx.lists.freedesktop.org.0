...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17A774428CB
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 08:47:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A41086FC18;
	Tue,  2 Nov 2021 07:47:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [IPv6:2610:10:20:722:a800:ff:feee:56cf])
 by gabe.freedesktop.org (Postfix) with ESMTP id 13E636FC18;
 Tue,  2 Nov 2021 07:47:03 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 0C022AA01E;
 Tue,  2 Nov 2021 07:47:03 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============8261788157365982892=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: =?utf-8?q?Thomas_Hellstr=C3=B6m?= <thomas.hellstrom@linux.intel.com>
Date: Tue, 02 Nov 2021 07:47:03 -0000
Message-ID: <163583922302.15502.9469805777484793712@emeril.freedesktop.org>
...
#### Possible regressions ####
  ...
  * igt@gem_workarounds@suspend-resume-fd:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_10826/shard-snb2/igt@gem_workarounds@suspend-resume-fd.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/shard-snb2/igt@gem_workarounds@suspend-resume-fd.html
...
#### Issues hit ####
  ...
  * igt@gem_create@create-massive:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/shard-skl4/igt@gem_create@create-massive.html

  * igt@gem_eio@in-flight-10ms:
    - shard-skl:          NOTRUN -> [TIMEOUT][4] ([i915#3063])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/shard-skl7/igt@gem_eio@in-flight-10ms.html

  * igt@gem_eio@unwedge-stress:
    - shard-tglb:         [PASS][5] -> [TIMEOUT][6] ([i915#2369] / [i915#3063] / [i915#3648])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_10826/shard-tglb2/igt@gem_eio@unwedge-stress.html
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/shard-tglb5/igt@gem_eio@unwedge-stress.html

  * igt@gem_exec_fair@basic-pace@vcs1:
    - shard-kbl:          [PASS][7] -> [SKIP][8] ([fdo#109271])
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_10826/shard-kbl7/igt@gem_exec_fair@basic-pace@vcs1.html
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/shard-kbl3/igt@gem_exec_fair@basic-pace@vcs1.html

  * igt@gem_pxp@verify-pxp-stale-ctx-execution:
    - shard-tglb:         NOTRUN -> [SKIP][9] ([i915#4270])
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/shard-tglb6/igt@gem_pxp@verify-pxp-stale-ctx-execution.html

  * igt@gem_userptr_blits@vma-merge:
    - shard-skl:          NOTRUN -> [FAIL][10] ([i915#3318])
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/shard-skl6/igt@gem_userptr_blits@vma-merge.html
...
#### Warnings ####
  ...
  * igt@runner@aborted:
   ...
   [152]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501
...
<p>Serious unknown changes coming with Patchwork_21501_full absolutely need=
 to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br=
 />
  introduced in Patchwork_21501_full, please notify your bug team to allow =
them<br />
...
1/shard-snb2/igt@gem_workarounds@suspend-resume-fd.html">TIMEOUT</a></li>
</ul>
</li>
</ul>
<h2>Known issues</h2>
...
p-scndscrn-pri-indfb-draw-blt.html">SKIP</a> ([fdo#109271]) +283 similar is=
sues</li>
</ul>
</li>
<li>
...
r-1p-primscrn-spr-indfb-draw-blt.html">SKIP</a> ([fdo#109271]) +98 similar =
issues</li>
</ul>
</li>
<li>
...
gb101010-draw-mmap-wc.html">SKIP</a> ([fdo#109271]) +79 similar issues</li>
</ul>
</li>
<li>
...
lpha-7efc.html">FAIL</a> ([fdo#108145] / [i915#265]) +5 similar issues</li>
</ul>
</li>
<li>
...
&gt; <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_21501/sh=
ard-iclb1/igt@kms_psr@psr2_cursor_mmap_cpu.html">SKIP</a> ([fdo#109441])</l=
i>
</ul>
</li>
<li>
...
port.html">SKIP</a> ([fdo#109271]) +1 similar issue</li>
</ul>
</li>
<li>
...
<ul>
<li>shard-iclb:         <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip=
/CI_DRM_10826/shard-iclb4/igt@kms_psr@psr2_no_drrs.html">SKIP</a> ([fdo#109=
441]) -&gt; <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_2=
1501/shard-iclb2/igt@kms_psr@psr2_no_drrs.html">PASS</a> +2 similar issues<=
/li>
</ul>
</li>
<li>
...
/Patchwork_21501">FAIL</a>) ([i915#1436] / [i915#3002] / [i915#3363] / [i91=
5#4312])</p>
</li>
</ul>
</li>

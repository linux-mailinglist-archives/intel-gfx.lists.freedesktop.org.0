...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D1104F9846
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Apr 2022 16:38:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C7A710E53A;
...
Subject: Re: [Intel-gfx] [PATCH 2/4] drm/i915/selftests: Check for
 incomplete LRI from the context image

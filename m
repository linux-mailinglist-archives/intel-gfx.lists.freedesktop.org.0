...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB3DA19574F
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2020 13:42:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBC056EA11;
...
Subject: [Intel-gfx] [PATCH RESEND 2/7] drm/dsc: add helper for calculating
 rc buffer size from DPCD

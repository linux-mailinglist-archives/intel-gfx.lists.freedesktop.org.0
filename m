...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7FBA677861
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Jan 2023 11:06:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9DD0210E33A;
...
Subject: [Intel-gfx] [PATCH 03/10] drm/fb-helper: Introduce

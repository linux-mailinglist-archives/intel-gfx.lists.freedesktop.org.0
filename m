...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1843E55457D
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 12:59:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F40ED10E6EE;
...
Subject: [Intel-gfx] [PATCH v3 02/13] drm/edid: convert

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC2A74AD5F1
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 12:12:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B23310E484;
...
Subject: [Intel-gfx] [PATCH v6 2/3] i915/gvt: Save the initial HW state
 snapshot in i915

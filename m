...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D75FB19DFB2
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Apr 2020 22:41:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A76276ECA0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 16/17] drm: Nuke mode->private_flags

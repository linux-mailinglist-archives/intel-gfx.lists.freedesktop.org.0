...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E5142B31DC
	for <lists+intel-gfx@lfdr.de>; Sun, 15 Nov 2020 03:02:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 93D116E96B;
	Sun, 15 Nov 2020 02:02:20 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5A7B36E972
 for <Intel-gfx@lists.freedesktop.org>; Sun, 15 Nov 2020 02:02:18 +0000 (UTC)
IronPort-SDR: lpUUVFYUb/2a5X7gdu0KCxDX11yVujgrjAV9yKWSCQU5lPqPLtiiZ9oSQrITrBxdYKJ3/2vn79
 tHJpyjf/p/Uw==
X-IronPort-AV: E=McAfee;i="6000,8403,9805"; a="255321267"
X-IronPort-AV: E=Sophos;i="5.77,479,1596524400"; d="scan'208";a="255321267"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2020 18:02:16 -0800
IronPort-SDR: 5gsVO7PZ1LR+nElZqmMq4LPVKdX/Zm9rVnKEoLgzVlcpFv9rBe45nvYjU45F1fx9xqKrXUvB/I
 BX39THUlEH0A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,479,1596524400"; d="scan'208";a="367120676"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by FMSMGA003.fm.intel.com with ESMTP; 14 Nov 2020 18:02:16 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Sat, 14 Nov 2020 18:02:13 -0800
Message-Id: <20201115020216.17242-24-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201115020216.17242-1-sean.z.huang@intel.com>
References: <20201115020216.17242-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 24/27] mei: pxp: export pavp client to me
 client bus

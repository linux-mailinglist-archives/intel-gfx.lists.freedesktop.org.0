...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E21DC2C67F9
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 15:33:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 329856EDF7;
	Fri, 27 Nov 2020 14:33:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 814966EDF7
 for <intel-gfx@lists.freedesktop.org>; Fri, 27 Nov 2020 14:33:05 +0000 (UTC)
IronPort-SDR: pLCiiqE+9EBxQ7wm2NwbsELVALdjBl+k73EwkmKyuGKjiny2oWUP/XZh7xGNTfO2MiOuqN3xI9
 1PV8klpSH8/g==
X-IronPort-AV: E=McAfee;i="6000,8403,9817"; a="190561241"
X-IronPort-AV: E=Sophos;i="5.78,374,1599548400"; d="scan'208";a="190561241"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Nov 2020 06:33:05 -0800
IronPort-SDR: gMZM7m9y/DXPcGzjT97oOIIWDfPQ+/D0gunt3FilZSG9C/7Fr1Mu1cYbILWStL/T7cMCWbuCKl
 6L6x82L+23qg==
X-IronPort-AV: E=Sophos;i="5.78,374,1599548400"; d="scan'208";a="328669968"
...
Date: Fri, 27 Nov 2020 06:33:04 -0800
Message-Id: <20201127143306.140047-2-jose.souza@intel.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <20201127143306.140047-1-jose.souza@intel.com>
References: <20201127143306.140047-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 2/4] drm/i915/display: Split and export main
...
bmRleCBiYTI2NTQ1MzkyYmMuLjE4NDRkZDAyOGRiMiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKQEAgLTM4MTcsMzMgKzM4MTcsMTkgQEAgc3RhdGlj
...
bWVudCkpKQogCQlyZXR1cm4gLUVJTlZBTDsKIApAQCAtMzg1Miw5ICszODM4LDEwIEBAIHN0YXRp
...
IC0zODY1LDE4ICszODUyLDUxIEBAIHN0YXRpYyBpbnQgc2tsX2NoZWNrX21haW5fc3VyZmFjZShz
...
YXkuaAppbmRleCA1ZTBkNDJkODJjMTEuLmI0ODM4MzVlOGYzZSAxMDA2NDQKLS0tIGEvZHJpdmVy
cy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmgKKysrIGIvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmgKQEAgLTYyOCw2ICs2MjgsOCBAQCB1MzIg

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B51ED36E12D
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Apr 2021 23:53:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 040A56EC50;
	Wed, 28 Apr 2021 21:53:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A6ED16EC50
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 Apr 2021 21:53:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1619646791;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=CHPFfFBaEv5BhiohhcETCsT/UQLEXf89TQ8+clFnID0=;
 b=L2NGrGfN6809+EZfYBB1RSY2GUyKbiQ6wwDdB0lc3RCr30c0NMN/TM9Z9Bxg3gtuZ/VySN
 d94b/v4pgCMBVwayQyUSQPSopPvF29rMMcaz++TFlHqUkH5zot6fq1n0laVPqTcy9WOBbV
 8WwNUz+ymS44VUIsYqhvsqR0pQ/tzYc=
...
Subject: [Intel-gfx] [PATCH 1/9] drm/connector: Make the drm_sysfs

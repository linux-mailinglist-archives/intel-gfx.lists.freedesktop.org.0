...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B7C7390AE7
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 22:58:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BDD26EAD7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/17] drm/i915/guc: Update sizes of CTB buffers

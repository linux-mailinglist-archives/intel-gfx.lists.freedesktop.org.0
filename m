...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE70021FF55
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 164F46E9FE;
...
Subject: [Intel-gfx] [PATCH v2 36/59] drm/kmb: Enable MIPI TX HS Test
 Pattern Generation

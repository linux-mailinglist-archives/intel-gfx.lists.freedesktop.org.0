...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6787E6799A4
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 14:40:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 930C410E6B6;
...
Subject: [Intel-gfx] [PATCH v2 10/10] drm/fbdev-generic: Rename struct
 fb_info 'fbi' to 'info'

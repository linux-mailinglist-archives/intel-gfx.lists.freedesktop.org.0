...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C5B9546D55
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 21:36:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F229113A07;
	Fri, 10 Jun 2022 19:36:48 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 07/15] drm/probe-helper: abstract
 .get_modes() connector helper call

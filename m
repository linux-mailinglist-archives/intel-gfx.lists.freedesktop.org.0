...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACEEC8443BA
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Jan 2024 17:09:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97CD810FB1F;
	Wed, 31 Jan 2024 16:09:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A0A6410FB35;
 Wed, 31 Jan 2024 16:09:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1706717351; x=1738253351;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=LBSSK9SRSMOm1BbIIM7p4oJ8jl0GxhFgNQlCSivF+cU=;
 b=MXhV2V0v4YCxRzugwH6gTNKupfcsdCgeWKHE/2nVrgvpeTaqfaLP5C5f
 ldwsZ4mNa00Mz+tQXUXgWqTxFVvTRNsdiyogkW1s4e7fkUq/IQZy7WueO
 qoNLlZSWtk2w60oCGLV/9MXJGtEK5w/d7BVu5jMr/61AOEE7O5OH1BAMn
 r9ZYCnXH0FuzvZeMTwyYbnIh2s8fpxv2eykfLXAC6SUenG1TRgKGylGl1
 LEhPDf+gtdTNHeWZSIibYS66X0G6j9/bw5ETUwQ7w3Amp3FDfeCK4YloG
 eDpylv8BQIa1EYQcO709n4YLM41ZTVnxKxTUEwbuFDmDgkkTVyYDJZKOW g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10969"; a="2581194"
X-IronPort-AV: E=Sophos;i="6.05,231,1701158400"; 
   d="scan'208";a="2581194"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jan 2024 08:09:09 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10969"; a="822612834"
X-IronPort-AV: E=Sophos;i="6.05,231,1701158400"; d="scan'208";a="822612834"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga001.jf.intel.com with SMTP; 31 Jan 2024 08:09:05 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 31 Jan 2024 18:09:04 +0200
Date: Wed, 31 Jan 2024 18:09:04 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Subject: Re: [PATCH 02/19] drm/dp: Add support for DP tunneling
Message-ID: <ZbpwoA1gXI_dnZAr@intel.com>

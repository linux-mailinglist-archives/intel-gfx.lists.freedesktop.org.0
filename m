...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B85DA366BC
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Feb 2025 21:14:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D9D610E038;
	Fri, 14 Feb 2025 20:14:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="IWz0ixA8";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 900EC10E038;
 Fri, 14 Feb 2025 20:14:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739564070; x=1771100070;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=l29vs7SywmChskIn5N0CodNBohA/cvcjljIphBAuUyA=;
 b=IWz0ixA8WT1g0/TDnZd7tNvTr5xc+k+rHKF2+tjJ1EJy0Gosi2ka66yh
 69Wvb4/QeNixvrvmrt0noKDr8UufuXP2e3Dfi+1M/EieN34SIj4BGywSv
 uxJYsKQQVD0ikCwRSwUu57n81sljE+72rngzbZVsRVmJna7+l9FlqPPR5
 VVfSgaObw8jxK3Dr9aUHwda24U4jzRuoxcnts36twMw8MJP+Mm0kyJdN8
 2PZB8QgTseG6cTlp3yMXpRB1kxphgvkeUrjE9HOcZ0mnREHQdpVHCDygJ
 4/LnX7n0+wl4vrLDVJEIRhwntoLt54bWINqR8XEnw+Y7MZgGGntIzrDKA Q==;
X-CSE-ConnectionGUID: w1K8sTOaSousKMxY/gDPRA==
X-CSE-MsgGUID: zKEz7at+Ry2FGhysv6dTpw==
X-IronPort-AV: E=McAfee;i="6700,10204,11314"; a="51755272"
X-IronPort-AV: E=Sophos;i="6.12,310,1728975600"; d="scan'208";a="51755272"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Feb 2025 12:14:30 -0800
X-CSE-ConnectionGUID: yl+pf1eWT0m1HSioAPNrXw==
X-CSE-MsgGUID: ZECLJ3KuRVW4Z5jbOMcH1A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,286,1732608000"; d="scan'208";a="113524375"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Feb 2025 12:14:28 -0800
Date: Fri, 14 Feb 2025 22:15:25 +0200

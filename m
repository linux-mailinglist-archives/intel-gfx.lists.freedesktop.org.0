...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4D057F741D
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Nov 2023 13:44:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D48C10E7CE;
...
Subject: [Intel-gfx] [PATCH 6/8] drm/dp: switch drm_dp_vsc_sdp_log() to
 struct drm_printer

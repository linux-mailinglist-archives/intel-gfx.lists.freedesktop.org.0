...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C104659A8CE
	for <lists+intel-gfx@lfdr.de>; Sat, 20 Aug 2022 00:54:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7629310E5C6;
...
Subject: [Intel-gfx] [PATCH v3 03/15] mei: bus: enable sending gsc commands

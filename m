...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D266EA400
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Oct 2019 20:22:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADBEF6ED09;
	Wed, 30 Oct 2019 19:22:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EC9496ED06
 for <intel-gfx@lists.freedesktop.org>; Wed, 30 Oct 2019 19:22:14 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19024462-1500050 
 for multiple; Wed, 30 Oct 2019 19:22:02 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 30 Oct 2019 19:21:56 +0000
Message-Id: <20191030192159.18404-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/11] drm/i915: Remove i915->kernel_context
...
OTE1L2dlbS9pOTE1X2dlbV9jb250ZXh0LmMKaW5kZXggNDU1NjkwYzgwZDQyLi5mZjllNjRjNTEz
ZTcgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2dlbS9pOTE1X2dlbV9jb250ZXh0
...
ZW5naW5lcywgZW5naW5lLT5sZWdhY3lfaWR4KTsKIAl9CkBAIC02MzQsMzcgKzY1Niw2IEBAIGk5
...
aW5fbG9ja19pbml0KCZnYy0+bG9jayk7CkBAIC02NzQsMzIgKzY2NSwxMiBAQCBzdGF0aWMgdm9p
...
bnVwKGludCBpZCwgdm9pZCAqcCwgdm9pZCAqZGF0YSkKQEAgLTE0NTcsMTIgKzE0MjgsMTQgQEAg
...
CWVyciA9IC1FRVhJU1Q7CkBAIC0xNjMyLDEyICsxNjA1LDE0IEBAIHNldF9lbmdpbmVzKHN0cnVj
...
OTM4LDEzICsxOTEzLDE1IEBAIHN0YXRpYyBpbnQgY2xvbmVfZW5naW5lcyhzdHJ1Y3QgaTkxNV9n
...
X2dlbV9jb250ZXh0LmMKaW5kZXggYzZlNjE1NjRiYjVlLi42ZDE3NGNhYThmOGIgMTAwNjQ0Ci0t
...
KElTX0VSUihjZSkpCiAJCQkJZ290byBvdXQ7CiAKQEAgLTEyMzAsOCArMTIzMCw3IEBAIF9faWd0
...

...
YWxseV93ZWRnZWQoZ3QpOwogCWlmIChyZXQpCiAJCXJldHVybiByZXQ7CkBAIC0zNjQsNiArMzYz
...
X2luaXQoc3RydWN0IGludGVsX2d0ICpndCkKIHsKIAlpbnQgZXJyOwpAQCAtMzc0LDcgKzM4MSwx
...
CkBAIC0zODksNiArNDA2LDEzIEBAIHZvaWQgaW50ZWxfZ3RfZHJpdmVyX3VucmVnaXN0ZXIoc3Ry
...
L2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYwppbmRleCA1YjIzYWViNTAzODUuLjI0MmU2OTI3
Njc1YyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMKKysr
...
NDM5Myw4ICs0MzkyLDcgQEAgdmlydHVhbF9ib25kX2V4ZWN1dGUoc3RydWN0IGk5MTVfcmVxdWVz
...
YWxfZW5naW5lICp2ZTsKQEAgLTQ0MDUsMTMgKzQ0MDMsMTMgQEAgaW50ZWxfZXhlY2xpc3RzX2Ny
...
NDU0LDcgKzQ0NTIsNyBAQCBpbnRlbF9leGVjbGlzdHNfY3JlYXRlX3ZpcnR1YWwoc3RydWN0IGk5
...
dCBpbnRlbF9lbmdpbmVfY3MgKnNpYmxpbmcgPSBzaWJsaW5nc1tuXTsKQEAgLTQ1MzUsMTQgKzQ1
MzMsMTIgQEAgaW50ZWxfZXhlY2xpc3RzX2NyZWF0ZV92aXJ0dWFsKHN0cnVjdCBpOTE1X2dlbV9j
...

...
LmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9zZWxmdGVzdF9jb250ZXh0LmMKaW5kZXggZjYz
YTI2YTNlNjIwLi42YjcwNDg2MzZjNDMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1
...
ZSkpCiAJCXJldHVybiBQVFJfRVJSKGNlKTsKIApAQCAtMTQ2LDcgKzE0NSw2IEBAIHN0YXRpYyBp
...
MDsKIApAQCAtMTU1LDEwICsxNTMsNiBAQCBzdGF0aWMgaW50IGxpdmVfY29udGV4dF9zaXplKHZv
...
YXRlOwpAQCAtMTgzLDcgKzE3Nyw3IEBAIHN0YXRpYyBpbnQgbGl2ZV9jb250ZXh0X3NpemUodm9p
...
U0laRTsKIApAQCAtMTk2LDEyICsxOTAsMTAgQEAgc3RhdGljIGludCBsaXZlX2NvbnRleHRfc2l6
...
dCBwYXNzOwpAQCAtMjI2LDEwICsyMTgsMTUgQEAgc3RhdGljIGludCBfX2xpdmVfYWN0aXZlX2Nv
...
aTkxNV9yZXF1ZXN0ICpycTsKIApAQCAtMjgyLDYgKzI3OSw4IEBAIHN0YXRpYyBpbnQgX19saXZl
...
dGVsX2NvbnRleHRfcHV0KGNlKTsKIAlyZXR1cm4gZXJyOwogfQpAQCAtMjkwLDcgKzI4OSw2IEBA
...
CXN0cnVjdCBkcm1fZmlsZSAqZmlsZTsKIAlpbnQgZXJyID0gMDsKQEAgLTI5OSwxNCArMjk3LDgg
...
CWJyZWFrOwogCkBAIC0zMTUsNyArMzA3LDYgQEAgc3RhdGljIGludCBsaXZlX2FjdGl2ZV9jb250
ZXh0KHZvaWQgKmFyZykKIAkJCWJyZWFrOwogCX0KIAotb3V0X2ZpbGU6CiAJbW9ja19maWxlX2Zy
ZWUoZ3QtPmk5MTUsIGZpbGUpOwogCXJldHVybiBlcnI7CiB9CkBAIC0zNDgsOCArMzM5LDcgQEAg
...
ZWxfY29udGV4dCAqbG9jYWwsICpyZW1vdGU7CiAJaW50IHBhc3M7CkBAIC0zNjMsMTEgKzM1Mywx
...
IGVycl9yZW1vdGU7CkBAIC0zOTIsNiArMzg3LDggQEAgc3RhdGljIGludCBfX2xpdmVfcmVtb3Rl
...
KTsKIAlyZXR1cm4gZXJyOwogfQpAQCAtNDAwLDcgKzM5Nyw2IEBAIHN0YXRpYyBpbnQgbGl2ZV9y
...
ZmlsZTsKIAlpbnQgZXJyID0gMDsKQEAgLTQwOSwxNCArNDA1LDggQEAgc3RhdGljIGludCBsaXZl
...
cmVtb3RlX2NvbnRleHQoZW5naW5lKTsKIAkJaWYgKGVycikKIAkJCWJyZWFrOwogCkBAIC00MjUs
NyArNDE1LDYgQEAgc3RhdGljIGludCBsaXZlX3JlbW90ZV9jb250ZXh0KHZvaWQgKmFyZykKIAkJ
...
dGVzdF9lbmdpbmVfaGVhcnRiZWF0LmMKaW5kZXggMTU1YzUwODAyNGRmLi45ZTczNzZiNTkyZTUg
...
cnRiZWF0LmMKQEAgLTE2OSw4ICsxNjksNyBAQCBzdGF0aWMgaW50IF9fbGl2ZV9oZWFydGJlYXRf
...
cnMvZ3B1L2RybS9pOTE1L2d0L3NlbGZ0ZXN0X2hhbmdjaGVjay5jCmluZGV4IDhhYmMwYTFkNjky
Yi4uNGY4Y2QzY2JiOGJkIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9zZWxm
...
ZXN0X2xyYy5jCmluZGV4IDk1NTA0YzQ4Y2Q5OS4uMDRkMGRkNmE5MzhhIDEwMDY0NAotLS0gYS9k
...
OwogCXJldHVybiBycTsKIH0KIApAQCAtMjM5MCwyNyArMjM5MiwxNyBAQCBzdGF0aWMgaW50IG5v
...
PSBuOwogCQkJZ290byBvdXQ7CkBAIC0yNDE5LDcgKzI0MTEsNiBAQCBzdGF0aWMgaW50IG5vcF92
...
b3V0OwogCQl9CkBAIC0yNTAwLDcgKzI0OTEsNiBAQCBzdGF0aWMgaW50IG5vcF92aXJ0dWFsX2Vu
...
cjsKIH0KQEAgLTI1NTksNyArMjU0OSw2IEBAIHN0YXRpYyBpbnQgbWFza192aXJ0dWFsX2VuZ2lu
...
MCwxMSArMjU1OSw3IEBAIHN0YXRpYyBpbnQgbWFza192aXJ0dWFsX2VuZ2luZShzdHJ1Y3QgaW50
...

...
OwogCXN0cnVjdCBpZ3RfbGl2ZV90ZXN0IHQ7CkBAIC0yNjkwLDE3ICsyNjczLDExIEBAIHN0YXRp
...
Myw4ICsyNzYwLDYgQEAgc3RhdGljIGludCBwcmVzZXJ2ZWRfdmlydHVhbF9lbmdpbmUoc3RydWN0
...
bmVsX2NvbnRleHRfY2xvc2UoY3R4KTsKIAlyZXR1cm4gZXJyOwogfQogCkBAIC0yODc4LDkgKzI4
NTMsNyBAQCBzdGF0aWMgaW50IGJvbmRfdmlydHVhbF9lbmdpbmUoc3RydWN0IGludGVsX2d0ICpn
...
ZV9maW5pKCZmZW5jZSk7CkBAIC0zMjY4LDggKzMyNDEsNyBAQCBzdGF0aWMgaW50IGxpdmVfbHJj
...
dGNoKQogewogCXN0cnVjdCBpbnRlbF9jb250ZXh0ICpjZTsKQEAgLTMyODQsNyArMzI1Niw3IEBA
...
U19FUlIoY2UpKQogCQlyZXR1cm4gUFRSX0VSUihjZSk7CiAKQEAgLTMzNTgsNyArMzMzMCw2IEBA
...
bSBpbnRlbF9lbmdpbmVfaWQgaWQ7CiAJaW50IGVyciA9IDA7CkBAIC0zMzY4LDE4ICszMzM5LDEy
...
fQpAQCAtMzM4OCw4ICszMzUzLDYgQEAgc3RhdGljIGludCBsaXZlX2xyY19zdGF0ZSh2b2lkICph
...
biBlcnI7CiB9CiAKQEAgLTM0MjIsOCArMzM4NSw3IEBAIHN0YXRpYyBpbnQgZ3ByX21ha2VfZGly
...
MzksNyArMzQwMSw3IEBAIHN0YXRpYyBpbnQgX19saXZlX2dwcl9jbGVhcihzdHJ1Y3QgaTkxNV9n
...
QEAgLTM1MDEsNyArMzQ2Myw2IEBAIHN0YXRpYyBpbnQgbGl2ZV9ncHJfY2xlYXIodm9pZCAqYXJn
...
CkBAIC0zNTExLDE4ICszNDcyLDEyIEBAIHN0YXRpYyBpbnQgbGl2ZV9ncHJfY2xlYXIodm9pZCAq
...
YWs7CiAJfQpAQCAtMzUzMSw4ICszNDg2LDYgQEAgc3RhdGljIGludCBsaXZlX2dwcl9jbGVhcih2
...
Y2hlZHVsZXIuYyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d2dC9zY2hlZHVsZXIuYwppbmRleCA5
NzZkNjk1MDIxOGUuLmYwNzg1YjlmZTAyYyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5
...

...
MTVfZ2VtLmMKaW5kZXggZmUzNDhmZjdkYjRmLi4xMDYzZDRjNzRhN2YgMTAwNjQ0Ci0tLSBhL2Ry
...
CQllcnIgPSBQVFJfRVJSKGNlKTsKIAkJCWdvdG8gb3V0OwpAQCAtMTIxOSw2ICsxMjE4LDcgQEAg
...
OwogCWlmIChyZXQpIHsKQEAgLTEyMjYsMTYgKzEyMjYsMTAgQEAgaW50IGk5MTVfZ2VtX2luaXQo
...
MTI5OSw5ICsxMjkzLDYgQEAgaW50IGk5MTVfZ2VtX2luaXQoc3RydWN0IGRybV9pOTE1X3ByaXZh
...
dCk7CiBlcnJfdW5sb2NrOgpAQCAtMTM2Nyw3ICsxMzU4LDYgQEAgdm9pZCBpOTE1X2dlbV9kcml2
...
OTE1L2k5MTVfcGVyZi5jCmluZGV4IDZlMzViOTI1NTg4Mi4uZjExNDdmYmIxZGMwIDEwMDY0NAot
...
L2RybS9pOTE1L2k5MTVfcmVxdWVzdC5jCmluZGV4IGI5YmNjZGI5ZWU2Yy4uM2I5Yzc2ZGQwOGYw
IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlcXVlc3QuYworKysgYi9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlcXVlc3QuYwpAQCAtMTIyNyw4ICsxMjI3LDggQEAg
...
cXVlc3QgKnByZXY7CiAKIAlsb2NrZGVwX2Fzc2VydF9oZWxkKCZ0bC0+bXV0ZXgpOwpAQCAtMTIz
OCw2ICsxMjM4LDkgQEAgdm9pZCBpOTE1X3JlcXVlc3RfYWRkKHN0cnVjdCBpOTE1X3JlcXVlc3Qg
...
bS9pOTE1L3NlbGZ0ZXN0cy9tb2NrX2dlbV9kZXZpY2UuYwppbmRleCAyN2VkM2NlZTZhOWIuLjk4
YTc1NGZhZjIyMiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvc2VsZnRlc3RzL21v
...


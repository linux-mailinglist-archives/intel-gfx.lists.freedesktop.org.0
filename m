...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B771A60EFB6
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Oct 2022 07:58:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E60F910E478;
	Thu, 27 Oct 2022 05:58:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A833810E478
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Oct 2022 05:58:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666850313; x=1698386313;
 h=date:from:to:cc:subject:message-id:references:
 content-transfer-encoding:in-reply-to:mime-version;
 bh=dqdszg/SUgKqbArfU0ZjFxrR1VHoAnYIZxAViXCU0DA=;
 b=jufsmsIsSGuX7HNllL3S5OKCAp5JLQppi1qBqvZwieDLBWJhlIkXGwrZ
 I1bLuKjxvUsjgYLRTOBtwkDOiTwLQMz2AqE8xb80ivl2fZy4tDQuSzRzh
 bA4h8r/XfmPvTlk01tVoDNJBmHCxWcoAsqGXw2RAxxXAiBp6jM17abzGg
 29nA3fRcrj0A2hQ2ezBk1av5QCxO8ha9nLKC64uUbhK9zoxYzgakjJFaH
 E4pTYWJ4f74+0WlA8Gsn+0I8Rkv/HnAjKcLD5BFIjmxIrx5FKr783e2EZ
 VtxJh+2sfElvhevz4tN7LVhk1jZ4BMdI/tyHBoS9S/HnXt7XhyIvZFI5T g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="334765090"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; d="scan'208";a="334765090"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Oct 2022 22:58:33 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10512"; a="774868928"
X-IronPort-AV: E=Sophos;i="5.95,215,1661842800"; d="scan'208";a="774868928"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:MN0PR11MB6206.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230022)(7916004)(346002)(396003)(366004)(39860400002)(376002)(136003)(451199015)(7416002)(45080400002)(6506007)(66476007)(66556008)(66946007)(186003)(5660300002)(53546011)(83380400001)(6486002)(33716001)(478600001)(4326008)(6666004)(8676002)(4001150100001)(82960400001)(66574015)(86362001)(38100700002)(8936002)(6916009)(2906002)(54906003)(6512007)(316002)(41300700001)(26005)(9686003);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Oct 2022 05:58:28.5534 (UTC)

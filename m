...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F5D46F592F
	for <lists+intel-gfx@lfdr.de>; Wed,  3 May 2023 15:40:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46C5710E29A;
	Wed,  3 May 2023 13:40:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AFF6410E0CB;
 Wed,  3 May 2023 13:40:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683121230; x=1714657230;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=Eh2E4XPlSmyRUy1HP+QVvnddSqOU9wPxlr6ML3UIP2g=;
 b=XPObklkvMAp/qvc7VEV8Regy3t+Muu0LQE5L+cB8Hgill/C+hE0MJaZ3
 c+WTKHj5B/xp4/UvopcdYp+NHamd4vstNuwlWMvUonouQB5AWqq0cR+UH
 VDla8BWow/hhQrvVKvR49WQUvjQBxT0GqfFNbb3FhXD+gjgSTpgDwMpeR
 7pC37MCzX3Y4FuUyNKujZui/DUMI1yWz3t8EPaaBSjuTmGdiUQUOFW16b
 gDUJkZOP4hZnEiYJqgxuOyV2MHIBZshyXojNADNiTCT5jwboG+ixYelDW
 Z/ofu89yUIMO67jS9FF/8Mh8QpH22zUXqVT0PVCRRAzUZSfb3ZmZUjrkX A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="351632711"
X-IronPort-AV: E=Sophos;i="5.99,247,1677571200"; d="scan'208";a="351632711"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 06:40:29 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="674092863"
X-IronPort-AV: E=Sophos;i="5.99,247,1677571200"; d="scan'208";a="674092863"
Received: from slinsell-mobl.ger.corp.intel.com (HELO [10.213.195.109])
 ([10.213.195.109])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 06:40:27 -0700
Message-ID: <f0e0df9a-2913-dfc3-042a-867e536c3ceb@linux.intel.com>
Date: Wed, 3 May 2023 14:40:25 +0100
MIME-Version: 1.0
...
In-Reply-To: <20230502041200.2170424-3-fei.yang@intel.com>
...
On 02/05/2023 05:11, fei.yang@intel.com wrote:
...
> index d2d5a24301b2..95a0d845d949 100644
...
> @@ -306,20 +304,23 @@ int i915_gem_get_caching_ioctl(struct drm_device *dev, void *data,
>   		goto out;
>   	}
>   
...
> +	 * caching policy through pat_index, in which case this ioctl should
> +	 * be disabled.
> +	 */
...
>   	rcu_read_unlock();
>   	return err;
> @@ -364,6 +365,16 @@ int i915_gem_set_caching_ioctl(struct drm_device *dev, void *data,
>   	if (!obj)
>   		return -ENOENT;
>   
> +	/*

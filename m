...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A60193FFF49
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Sep 2021 13:38:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3047D6E872;
	Fri,  3 Sep 2021 11:38:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [IPv6:2610:10:20:722:a800:ff:feee:56cf])
 by gabe.freedesktop.org (Postfix) with ESMTP id 016896E876;
 Fri,  3 Sep 2021 11:37:59 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id ECB96A7DFC;
 Fri,  3 Sep 2021 11:37:58 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============2757862091963660563=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Ayaz A Siddiqui" <ayaz.siddiqui@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Fri, 03 Sep 2021 11:37:58 -0000
Message-ID: <163066907893.21416.4157743352535154096@emeril.freedesktop.org>
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_20950_full:
...
#### Possible regressions ####
  ...
  * igt@gem_ctx_isolation@preservation-s3@rcs0:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_10549/shard-skl2/igt@gem_ctx_isolation@preservation-s3@rcs0.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-skl5/igt@gem_ctx_isolation@preservation-s3@rcs0.html
...
#### Issues hit ####
  ...
  * igt@feature_discovery@display-2x:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-iclb7/igt@feature_discovery@display-2x.html

  * igt@feature_discovery@display-3x:
    - shard-tglb:         NOTRUN -> [SKIP][4] ([i915#1839])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-tglb5/igt@feature_discovery@display-3x.html

  * igt@gem_create@create-massive:
    - shard-snb:          NOTRUN -> [DMESG-WARN][5] ([i915#3002])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-snb5/igt@gem_create@create-massive.html

  * igt@gem_ctx_isolation@preservation-s3@rcs0:
    - shard-apl:          NOTRUN -> [DMESG-WARN][6] ([i915#180]) +1 similar issue
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-apl8/igt@gem_ctx_isolation@preservation-s3@rcs0.html
...
#### Possible fixes ####
  ...
  * igt@kms_cursor_crc@pipe-b-cursor-256x85-random:
   ...
   [137]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-rkl
...
<p>Serious unknown changes coming with Patchwork_20950_full absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_20950_full, please notify your bug team to allow them<br />
  to document this new failure mode, which will reduce false positives in CI.</p>
<h2>Possible new issues</h2>
<p>Here are the unknown changes that may have been introduced in Patchwork_20950_full:</p>
<h3>IGT changes</h3>
<h4>Possible regressions</h4>
<ul>
<li>igt@gem_ctx_isolation@preservation-s3@rcs0:<ul>
<li>shard-skl:          <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_10549/shard-skl2/igt@gem_ctx_isolation@preservation-s3@rcs0.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-skl5/igt@gem_ctx_isolation@preservation-s3@rcs0.html">DMESG-WARN</a></li>
</ul>
</li>
</ul>
<h2>Known issues</h2>
...
<ul>
<li>shard-apl:          NOTRUN -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-apl8/igt@gem_ctx_isolation@preservation-s3@rcs0.html">DMESG-WARN</a> ([i915#180]) +1 similar issue</li>
</ul>
</li>
<li>
...
<ul>
<li>{shard-rkl}:        <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_10549/shard-rkl-5/igt@kms_cursor_crc@pipe-b-cursor-256x85-random.html">SKIP</a> ([fdo#112022] / [i915#4070]) -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_20950/shard-rkl">PASS</a> +5 similar issues</li>
</ul>
</li>
</ul>

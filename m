...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 07F2F54286F
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 09:51:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AE1110EEC7;
...
Subject: [Intel-gfx] [PATCH v2 08/15] drm/probe-helper: add

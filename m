...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF0642D7727
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Dec 2020 14:57:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B155C6EE19;
	Fri, 11 Dec 2020 13:57:20 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 16/19] drm/i915/hdcp: Add HDCP 2.2 stream
 register

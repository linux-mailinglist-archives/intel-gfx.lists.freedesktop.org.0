...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 806C9186C49
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Mar 2020 14:39:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D755089FE6;
	Mon, 16 Mar 2020 13:39:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F2C376E0F4
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Mar 2020 13:39:04 +0000 (UTC)
IronPort-SDR: m8+ssMBhbv9e7aWsBwa6avhKzfQm2UfWi6DCqsKx0G7OdQSdtj/6JbihfzVTMYrMvcp0/KY5lt
 4R2shnM/5r5w==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2020 06:39:04 -0700
IronPort-SDR: IegoY0/TD7NxNc0Y3nz3m7sZYlZHBohWX9PIQZbxgCa2AKfsihb9y6TxscApqketbtiVuEA8Uw
 Prug/NhxI9ag==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,560,1574150400"; d="scan'208";a="290702910"
Received: from unknown (HELO localhost.localdomain) ([10.223.165.29])
 by FMSMGA003.fm.intel.com with ESMTP; 16 Mar 2020 06:39:03 -0700
From: Ankit Navik <ankit.p.navik@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 16 Mar 2020 19:07:00 +0530
Message-Id: <1584365821-30240-3-git-send-email-ankit.p.navik@intel.com>
X-Mailer: git-send-email 2.7.4
In-Reply-To: <1584365821-30240-1-git-send-email-ankit.p.navik@intel.com>
References: <1584365821-30240-1-git-send-email-ankit.p.navik@intel.com>

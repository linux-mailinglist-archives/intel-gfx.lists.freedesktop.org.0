...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F6856ED454
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 20:28:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3A6610E5BE;
	Mon, 24 Apr 2023 18:27:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3830310E1C6;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=iwC96/grpHbaoPYjKXIPv1w6PFpaTXyNWp+fjyuJC94=;
 b=DTVKNlLaUV4HpucboDUesCmvgQoa8f6MPSm30oPSV5TKo0J8Lzy7omAT
 JhTImg3qo/aq9OXvzGnedQc5b4x9AStEiyGgm9QcUTv+ArsLnoouCdH5p
 e7hVxT/WLUZ7v21ocBtxpevb0b6pJ7CMKv7TafbbRw1B8ltWZXTce/zYl
 KrzwiPu9fMHYor+wg+DkBjrDDomsC62BS+z3Dsk2lPRqJ+Zzo1niIBsgp
 6I7ZjTjXPTX1u5HjJzK4c+8dJyTMwEpum/p+/vFSHFu6LNp6rFA1cMiUz
 lAzIqvYW3X2gwlBU92X8ELn7aEjtBKnsHd0Og517tFpgddXFVG26pNXVO A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10690"; a="411802209"
X-IronPort-AV: E=Sophos;i="5.99,223,1677571200"; d="scan'208";a="411802209"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2023 11:27:54 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10690"; a="762539847"
X-IronPort-AV: E=Sophos;i="5.99,223,1677571200"; d="scan'208";a="762539847"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2023 11:27:54 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon, 24 Apr 2023 11:29:01 -0700
Message-Id: <20230424182902.3663500-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915/mtl: Add PTE encode function

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A76355B2450
	for <lists+intel-gfx@lfdr.de>; Thu,  8 Sep 2022 19:21:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 32C2510EB79;
	Thu,  8 Sep 2022 17:21:36 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4.1] drm/i915: Move display and media IP

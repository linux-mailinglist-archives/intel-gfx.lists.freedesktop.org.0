...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE0175F7113
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Oct 2022 00:21:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6EB1810E0DE;
	Thu,  6 Oct 2022 22:21:54 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/edid/firmware: stop using throwaway
 platform device

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7496F7C9086
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 00:48:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3CBC010E645;
...
Subject: [Intel-gfx] [PATCH v7b 01/25] test-dyndbg: fixup CLASSMAP usage
 error

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C208BCF53F2
	for <lists+intel-gfx@lfdr.de>; Mon, 05 Jan 2026 19:31:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6756010E29B;
	Mon,  5 Jan 2026 18:31:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="axwZHyau";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 579A810E29B;
 Mon,  5 Jan 2026 18:31:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1767637866; x=1799173866;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=ktHXCzPHJgY7XQIgZS1cpiTgqKNmo93Rr7YlINKPrMk=;
 b=axwZHyauSDGUruHPh7N6vLEr6sGZnb0pbGcVRBuVE6X3ACcocIbnvQA8
 ycX+Fge5vroS0SSePKvR1Ykht+Q9acqKkblfrrC1WrUAcMujMdzYhXI8Q
 3kgST4F/hECgtSdcxYXQlOKZ1rN3bV3wPeRm6JaUia3hSbjCG93E2+DEx
 YvJX+N3eGBKL6oYm91zdzm1OzAjgsHY3ZMM8cPvGrt1vB4ZD9g4RBYFh1
 6nXv3XXQOmtVU7avUtUmcUsP/vRbypWt8+eKnbDi0sA/XceyO+EWLtiRI
 hZ9zSyrj0b61R9SXcWIbpGUqXv7eE8ozsM3Tk97me+Sf00dfsNhYz3O89 Q==;
X-CSE-ConnectionGUID: WBLY6+grR1+xmcZ0lO66Ig==
X-CSE-MsgGUID: i2dd+yqdRsiCOnS7CVGsJQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11662"; a="69165765"
X-IronPort-AV: E=Sophos;i="6.21,204,1763452800"; d="scan'208";a="69165765"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jan 2026 10:31:05 -0800
X-CSE-ConnectionGUID: xQbfnGbcRSiQ1JYrgkaMhw==
X-CSE-MsgGUID: vHKsorAGSpqZSH/ARbKQWQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,204,1763452800"; d="scan'208";a="207347253"
Received: from ettammin-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.245.246.3])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jan 2026 10:30:57 -0800

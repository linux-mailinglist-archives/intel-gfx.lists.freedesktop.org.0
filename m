...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BEA371D2711
	for <lists+intel-gfx@lfdr.de>; Thu, 14 May 2020 08:07:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E0DC6EAA0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 00/14] In order to readout DP SDPs,

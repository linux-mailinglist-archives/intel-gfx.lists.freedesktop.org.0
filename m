...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80B4847F8DC
	for <lists+intel-gfx@lfdr.de>; Sun, 26 Dec 2021 21:53:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB6D710F21E;
...
Subject: [Intel-gfx] [PATCH v5 3/6] drm: implement top-down allocation method

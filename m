...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B487A381A5
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Feb 2025 12:27:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 119FD10E416;
	Mon, 17 Feb 2025 11:27:32 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Z1oFwNZa";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1915E10E416;
 Mon, 17 Feb 2025 11:27:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739791651; x=1771327651;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=AH8Qg+64UDjmyc+5Y3y8Yy7cmXSr8nddJAUJfzLyxxw=;
 b=Z1oFwNZauCBFuMW8BHHerMI8aRE0u9+fsyoMk4Uz5vqMMsVgR/ieS/KM
 deQVgm6C4GcY9YKJ2UViYpg8KZghEaM82d0n6URmh8Jl7lmvAhiSXi70J
 FZxUPq4Li8XdaFpQ4cj0hPr7rm0a2XKccZfNX2hwViFNhi9NWMHL1C8eP
 zkwfyOb3yONETL++7qNrvhV/9gVLJaLLkdaPqaG8uKcskv/2CTVnR1nJv
 /04r/pbFV560/pKwFjFao99FyW/kh7IOXJ6lfSCAYM2o9/w5sDnI34xLw
 Lun6jdVZkg+5RTjbUmlj7CDO64w7/sdl/mDRoNtJWuN8DfXhpnE8nvnVJ A==;
X-CSE-ConnectionGUID: H+VpG36WRb6aSmaT6+BgVQ==
X-CSE-MsgGUID: Tn6LMHZYSKCKmYNYkv4F6w==
X-IronPort-AV: E=McAfee;i="6700,10204,11347"; a="40392603"
X-IronPort-AV: E=Sophos;i="6.13,292,1732608000"; d="scan'208";a="40392603"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa113.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2025 03:27:31 -0800
X-CSE-ConnectionGUID: HQ4IbW/JQHqnNWb509w/BQ==
X-CSE-MsgGUID: 6L/bFpHuR22O59XrL/KfwQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,292,1732608000"; d="scan'208";a="119101912"
Received: from unknown (HELO sorvi2.fi.intel.com) ([10.237.72.194])
 by orviesa004.jf.intel.com with ESMTP; 17 Feb 2025 03:27:30 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: imre.deak@intel.com, jani.nikula@linux.intel.com,
 Mika Kahola <mika.kahola@intel.com>
Subject: [PATCH v4 1/2] drm/i915/display: Drop crtc_state from C10/C20 pll
 programming
Date: Mon, 17 Feb 2025 13:17:10 +0200
Message-ID: <20250217111711.639619-2-mika.kahola@intel.com>
...
index 4121d0d759bf..9d46acbf26f4 100644
...
@@ -2050,32 +2048,52 @@ static void intel_c10pll_update_pll(struct intel_crtc_state *crtc_state,
...
+					intel_crtc_has_dp_encoder(crtc_state));
 		...
 		return 0;
@@ -2111,10 +2129,9 @@ static void intel_c10pll_readout_hw_state(struct intel_encoder *encoder,
 }
...
@@ -2333,7 +2350,9 @@ static int intel_c20pll_calc_state(struct intel_crtc_state *crtc_state,
 	for (i = 0; tables[i]; i++) {
 		if (crtc_state->port_clock == tables[i]->clock) {
...
@@ -2599,19 +2618,14 @@ static int intel_get_c20_custom_width(u32 clock, bool dp)
 }
...
@@ -2679,23 +2693,23 @@ static void intel_c20_pll_program(struct intel_display *display,
...
@@ -2735,7 +2749,8 @@ static int intel_c10pll_calc_port_clock(struct intel_encoder *encoder,
 }
...
+					 bool is_dp, int port_clock,
 ...
 {
 	struct intel_display *display = to_intel_display(encoder);
@@ -2750,18 +2765,17 @@ static void intel_program_port_clock_ctl(struct intel_encoder *encoder,
...
@@ -2991,8 +3005,9 @@ static u32 intel_cx0_get_pclk_pll_ack(u8 lane_mask)
 	return val;
 }
...
@@ -3006,7 +3021,7 @@ static void intel_cx0pll_enable(struct intel_encoder *encoder,
...
@@ -3026,15 +3041,15 @@ static void intel_cx0pll_enable(struct intel_encoder *encoder,
...
@@ -3045,8 +3060,7 @@ static void intel_cx0pll_enable(struct intel_encoder *encoder,
...
@@ -3073,6 +3087,15 @@ static void intel_cx0pll_enable(struct intel_encoder *encoder,

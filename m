...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5BF7D62F9BD
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Nov 2022 16:54:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E74888F78;
	Fri, 18 Nov 2022 15:53:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 334D588F78;
 Fri, 18 Nov 2022 15:53:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1668786834; x=1700322834;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=IgwbfkOzAdjg9aNcU8aS7ayZEFzAAc21vo4gWvNc0RE=;
 b=EgFInCEuERiuWYtuXiYQnYT7KMrQjOBigGePEXA3jbpLy7YI39qJd4j+
 cKt9MX1DsEiuMrhGEGJsiDPMl9UXqzDxFa2DMCJxX73XL1v7sYmjo/j2O
 NhptQ5VwvIg9lfxmx3hrGax7h66J8Yx2RtOG1mZBu57cKgWwSCksgzSHT
 cXVXJlMTyOgU9Gx3U/+Bw2FXl2NzRwbwibPDsZVIDkSfuKG8cuTnKHcF9
 Rx8voesDRdmoCNAwvgIRpyGYbNxIcQd094L6/LCzmmcoNcR7khRV1avjq
 U27mbS6TloeDiFJLT3R9TOa0EKGn3OY+YKTNXnlbOdIYczxobwmuLa/Ro Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10535"; a="296525536"
X-IronPort-AV: E=Sophos;i="5.96,174,1665471600"; d="scan'208";a="296525536"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Nov 2022 07:53:44 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10535"; a="969315379"
X-IronPort-AV: E=Sophos;i="5.96,174,1665471600"; d="scan'208";a="969315379"
Received: from bbaker-mobl.ger.corp.intel.com (HELO mwauld-desk1.intel.com)
 ([10.252.1.50])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Nov 2022 07:53:42 -0800
From: Matthew Auld <matthew.auld@intel.com>
To: igt-dev@lists.freedesktop.org
Date: Fri, 18 Nov 2022 15:53:35 +0000
Message-Id: <20221118155335.635430-1-matthew.auld@intel.com>
X-Mailer: git-send-email 2.38.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH i-g-t] tests/i915/gem_exec_balancer: exercise
 dmabuf import

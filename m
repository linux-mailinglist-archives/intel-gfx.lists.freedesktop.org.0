...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KV9TMIchw2lpogQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 00:43:03 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18E2E31DC7E
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 00:43:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD76110E622;
	Tue, 24 Mar 2026 23:43:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Y2ipEvf5";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D5C710E19A;
 Tue, 24 Mar 2026 23:42:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1774395779; x=1805931779;
 h=date:from:to:cc:subject:in-reply-to:message-id:
 references:mime-version:content-id;
 bh=jgosETqmM78jjEDDBWwT2iTFcMQRZBFx4pod6PFuIHI=;
 b=Y2ipEvf5toX+zD3gOdqeSVspPj96O7ji5+c0DOnqRplFhlnQHL4plrDs
 q7PT6ZivKd/9kIvTD5/eCd0WSn7xzUAhzrqINMz8cjTJZ+BWy91lwMQ2v
 Mo29Vh6VPP/dcQJ9Mld2z7EHIcOVsAYc9B5XvXMAohKdCl3iH+gQdKpAm
 vgYFyfR3pPFc0StpSZzSYnphVm3SD6fM0v6kXWgpRnnnKtKH37cTTnDBZ
 W4EgwIhPhwT8gkyqwTG/rZGQUrcxxGPHZvJtYU38mxyptQuaUdDh2MWIR
 Qcmnsqk7j29mslohTD27G8Ef2gqyoHWym6yZod8bXHVzBovFA/GW0uSh4 Q==;
X-CSE-ConnectionGUID: 2YXQHzHqR6y5UP29z6Hv3g==
X-CSE-MsgGUID: xWwK8rrRTpuLCiv4cxKLyA==
X-IronPort-AV: E=McAfee;i="6800,10657,11739"; a="93001802"
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; d="scan'208";a="93001802"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2026 16:42:58 -0700
X-CSE-ConnectionGUID: pPszLHoRQrmzAvuRfKPfcg==
X-CSE-MsgGUID: vIQywnQLTqirnlMIZ9RNTg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; d="scan'208";a="255006990"
Received: from administrator-system-product-name.igk.intel.com
 ([10.91.214.181])
 by orviesa002.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2026 16:42:57 -0700
Date: Wed, 25 Mar 2026 00:42:55 +0100 (CET)
From: =?ISO-8859-2?Q?Micha=B3_Grzelak?= <michal.grzelak@intel.com>
To: Jani Nikula <jani.nikula@intel.com>
cc: "intel-gfx@lists.freedesktop.org" <intel-gfx@lists.freedesktop.org>, 
 "intel-xe@lists.freedesktop.org" <intel-xe@lists.freedesktop.org>
Subject: Re: [PATCH 3/5] drm/{i915,xe}: move fbdev fb calls to parent interface
In-Reply-To: <37ec4a959c375a9099b42d11aa9454c51a96aec2.1773840563.git.jani.nikula@intel.com>
Message-ID: <fa1f7a18-f96e-c347-ac1c-b903c7122e89@intel.com>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; BOUNDARY="8323329-521014362-1774394929=:294587"
Content-ID: <8ad498a7-c172-eafa-0ec5-8ffea6480642@intel.com>
...
--8323329-521014362-1774394929=:294587
Content-Type: text/plain; CHARSET=UTF-8; format=flowed
Content-Transfer-Encoding: 8BIT
Content-ID: <2557bd98-c130-41ab-3ec9-50a602a69b8c@intel.com>

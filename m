...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 980EF4C9141
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Mar 2022 18:14:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFA9810E6EA;
...
Subject: Re: [Intel-gfx] [PATCH][V2] drm/i915: make a handful of read-only
 arrays static const

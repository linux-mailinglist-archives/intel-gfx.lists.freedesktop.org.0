...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BDE4B7FBBEF
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Nov 2023 14:53:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2521610E540;
	Tue, 28 Nov 2023 13:53:55 +0000 (UTC)
...
Subject: [Intel-gfx] [RFC PATCH 0/6] Supporting GMEM (generalized memory

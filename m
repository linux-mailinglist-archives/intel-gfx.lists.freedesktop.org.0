...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B778C49BB5F
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jan 2022 19:37:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5A0010E41A;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/guc: Update guc shim control

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 6K7IDvWLEGrEZQYAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 19:01:41 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D8E15B7D70
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 19:01:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 495B810E297;
	Fri, 22 May 2026 17:01:38 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=kernel.org header.i=@kernel.org header.b="ao/i8rtQ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sea.source.kernel.org (sea.source.kernel.org [172.234.252.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9C93E10E297
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 May 2026 17:01:36 +0000 (UTC)
Received: from smtp.kernel.org (quasi.space.kernel.org [100.103.45.18])
 by sea.source.kernel.org (Postfix) with ESMTP id 4F4B944608
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 May 2026 17:01:36 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id AD7C91F0180C
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 May 2026 17:01:35 +0000 (UTC)
...
Received: by mail-lf1-f42.google.com with SMTP id
 2adb3069b0e04-5aa21fa024cso5217699e87.2
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 May 2026 10:01:35 -0700 (PDT)
X-Forwarded-Encrypted: i=1;
 AFNElJ8aQUtEieEoz5HsFXtifkRNOGCOAzKzbS5e1KEPxmmbyqrzmz3b6M7hirdZTFGGmMRTXoE34oO48RA=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YyTt5qurinUM8Qtq+XRcaVZ+dbDmnalaUCykMpvxdWQzaCgD99Y
 47zHQHx3ApblZRWs8038jKrDRqYb0LwJ2eyANLpcdRD9+NHLQwhWyW5lFdwLYdQwgXXLUKnZ2CK
 Jcdy5DgI/2GodNMcHwjt6yDLh2pOAwt4=
...
X-Spamd-Result: default: False [0.19 / 15.00];
 ...
 @linux.intel.com,m:david.e.box@linux.intel.com,m:macro@orcam.me.uk,m:srinivas.pandruvada@linux.intel.com,m:peterz@infradead.org,m:hca@linux.ibm.com,m:gor@linux.ibm.com,m:seanjc@google.com,m:pbonzini@redhat.com,m:tglx@kernel.org,m:mingo@redhat.com,m:bp@alien8.de,m:dave.hansen@linux.intel.com,m:x86@kernel.org,m:hpa@zytor.com,m:vkoul@kernel.org,m:Frank.Li@kernel.org,m:da.gomez@kernel.org,m:samitolvanen@google.com,m:atomlin@atomlin.com,m:glider@google.com,m:elver@google.com,m:dvyukov@google.com,m:akpm@linux-foundation.org,m:john.johansen@canonical.com,m:paul@paul-moore.com,m:jmorris@namei.org,m:serge@hallyn.com,m:andriy.shevchenko@linux.intel.com,m:georgia.garcia@canonical.com,m:kvm@vger.kernel.org,m:dmaengine@vger.kernel.org,m:linux-modules@vger.kernel.org,m:kasan-dev@googlegroups.com,m:linux-mm@kvack.org,m:apparmor@lists.ubuntu.com,m:linux-security-module@vger.kernel.org,m:linux-um@lists.infradead.org,m:linux-acpi@vger.kernel.org,m:openipmi-developer@lists.sourceforge.net,m:qemu-devel
 @nongnu.org,m:dri-devel@lists.freedesktop.org,m:linux-rdma@vger.kernel.org,m:linux-media@vger.kernel.org,m:linux-pci@vger.kernel.org,m:linux-scsi@vger.kernel.org,m:linux-pm@vger.kernel.org,m:linuxppc-dev@lists.ozlabs.org,m:linux-serial@vger.kernel.org,m:linux-usb@vger.kernel.org,m:usb-storage@lists.one-eyed-alien.net,m:virtualization@lists.linux.dev,m:linux-kernel@vger.kernel.org,m:linux-arch@vger.kernel.org,m:netdev@vger.kernel.org,m:linux-fsdevel@vger.kernel.org,m:linux-hardening@vger.kernel.org,s:lists@lfdr.de];
	FORWARDED(0.00)[intel-gfx@lists.freedesktop.org];
	FORGED_SENDER(0.00)[rafael@kernel.org,intel-gfx-bounces@lists.freedesktop.org];
	...
	FROM_NEQ_ENVFROM(0.00)[rafael@kernel.org,intel-gfx-bounces@lists.freedesktop.org];

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A1B6A36F81A
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Apr 2021 11:45:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0902F6F523;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 4/5] drm/connector: Add a helper to attach

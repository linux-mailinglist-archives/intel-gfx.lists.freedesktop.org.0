...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E36F153603
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2020 18:12:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60BFC6E9D4;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v3 16/17] drm/i915/dp: Add compute routine
 for DP PSR VSC SDP

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9488B6BD6B8
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 18:06:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1676010E215;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/huc: Cancel HuC delayed load timer
 on reset.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C94C3B27D8
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:49:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75E6E6EA17;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 46/47] drm/i915/guc: Add golden context to GuC
 ADS

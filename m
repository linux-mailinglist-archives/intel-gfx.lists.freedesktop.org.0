...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 112B36FBB7F
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 01:48:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4688C10E027;
...
Subject: [Intel-gfx] [PATCH v7 0/2] drm/i915: use pat_index instead of
 cache_level

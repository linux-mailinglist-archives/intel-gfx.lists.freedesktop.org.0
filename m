...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5231440716B
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 20:45:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36B546EA82;
	Fri, 10 Sep 2021 18:45:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D4C2D6EA82;
 Fri, 10 Sep 2021 18:45:28 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10103"; a="201337683"
X-IronPort-AV: E=Sophos;i="5.85,283,1624345200"; d="scan'208";a="201337683"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2021 11:45:23 -0700
X-IronPort-AV: E=Sophos;i="5.85,283,1624345200"; d="scan'208";a="540763315"
Received: from bwparris-mobl.amr.corp.intel.com (HELO intel.com)
 ([10.255.36.148])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2021 11:45:22 -0700
Date: Fri, 10 Sep 2021 14:45:21 -0400
...
Message-ID: <YTunwfMgUGVdQ+cl@intel.com>
References: <20210910153627.1060858-1-daniele.ceraolospurio@intel.com>
 <20210910153627.1060858-11-daniele.ceraolospurio@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20210910153627.1060858-11-daniele.ceraolospurio@intel.com>
Subject: Re: [Intel-gfx] [PATCH v9 10/17] drm/i915/pxp: interfaces for using
 protected objects
...
> index b0c7edc10cc3..e49e60567a56 100644
...
>  #include "i915_drv.h"
>  
> @@ -166,3 +167,80 @@ void intel_pxp_fini_hw(struct intel_pxp *pxp)
>  

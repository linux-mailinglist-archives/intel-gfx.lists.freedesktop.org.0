...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 74CD9512755
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Apr 2022 01:07:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D56C10EDBA;
...
Subject: [Intel-gfx] [PATCH 3/5] drm/i915/xehp: Use separate sseu init
 function

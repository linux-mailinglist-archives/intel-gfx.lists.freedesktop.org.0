...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 65163573798
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 15:39:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 455F810E418;
...
Subject: [Intel-gfx] [PATCH v4 4/8] drm/i915: add gen6 ppgtt dummy creation
 function

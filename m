...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 395C395BD33
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Aug 2024 19:29:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF91210EB8F;
	Thu, 22 Aug 2024 17:29:20 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="E4S2i3Qq";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BFE3110EB8F;
 Thu, 22 Aug 2024 17:29:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1724347759; x=1755883759;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=cArMvq2xkqJhtt4K5fJEZb78vaknq3kelM1vlq6V4iU=;
 b=E4S2i3Qqt4RyeoqBkA8VvIXiSp8r0joxNpn2FpbGxawqJXMjinqVFmQc
 6lgv+9P9VL27hg1o0UfQKdw2ZQb//BdJK+2UbPamVq+JXxq4D1Ho4ZdJR
 jXFC7ai2S5x6aeVL76oiNSupr5I59BCHbQLD9hvos6zht2pfnlQUsiniE
 QdTppf1xj6rDi6lkIXq/PCx/bPjyBIeJxLBlr98guKKCu04Zuc3GNv7wI
 gqT2YVig18NB18KSHVhbLWBzQq3od1YzT2UlxyCKqEwURfjrEzBb5WGeF
 /tbK1Lboo3sESy4qvmHMfG2hmFhEkotdRUQyX2+Nh4LQpdiKA8zI26IGt Q==;
X-CSE-ConnectionGUID: kHiayj/zT4SO7ZRjtoXGpw==
X-CSE-MsgGUID: 176vznWHQjq8cF3uPTSGtQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11172"; a="22935354"
X-IronPort-AV: E=Sophos;i="6.10,167,1719903600"; d="scan'208";a="22935354"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Aug 2024 10:29:19 -0700
X-CSE-ConnectionGUID: NE/4J3CmQbi3u3CB0vfPUg==
X-CSE-MsgGUID: lREevMtqQlirWeLo5xzedg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,167,1719903600"; d="scan'208";a="84706361"
Received: from fdefranc-mobl3.ger.corp.intel.com (HELO intel.com)
 ([10.245.246.104])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Aug 2024 10:29:17 -0700
...
Subject: [PATCH v2 06/15] drm/i915/gt: Introduce for_each_enabled_engine() and
 apply it in selftests
Date: Thu, 22 Aug 2024 19:28:23 +0200
Message-ID: <20240822172832.494994-7-andi.shyti@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5300FC8718
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Oct 2019 13:20:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F8346E93E;
	Wed,  2 Oct 2019 11:20:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0C1B86E933
 for <intel-gfx@lists.freedesktop.org>; Wed,  2 Oct 2019 11:20:29 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18692021-1500050 
 for multiple; Wed, 02 Oct 2019 12:20:06 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  2 Oct 2019 12:19:36 +0100
Message-Id: <20191002112000.12280-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/30] drm/i915: Pull i915_vma_pin under the
 vm->mutex
...
ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYwppbmRleCBkOTljNTllOTc1
NjguLmM2NGM3MDQ1ZGUyOCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxh
...
L2dlbS9pOTE1X2dlbV9vYmplY3QuaAppbmRleCBhZWMwNWY5NjdkOWQuLmE3MGZiYmQ4Yzk4ZCAx
...
dGVzdHMvaTkxNV9nZW1fZ3R0LmMKaW5kZXggODRkOTRlYWJjN2RkLi4zNzNmYmQ1OGExN2EgMTAw
...
CiAJbXV0ZXhfbG9jaygmdm1hLT52bS0+bXV0ZXgpOwpAQCAtMTMzNSwxMSArMTMyOCwxMyBAQCBz
...
PSVkXG4iLAogCQkJICAgICAgIHRvdGFsLCBnZ3R0LT52bS50b3RhbCwgZXJyKTsKQEAgLTEzODUs
MTEgKzEzODAsMTMgQEAgc3RhdGljIGludCBpZ3RfZ3R0X3Jlc2VydmUodm9pZCAqYXJnKQogCQkJ
...

...
bmxvY2soJmdndHQtPnZtLm11dGV4KTsKIAkJaWYgKGVyciA9PSAtRU5PU1BDKSB7CiAJCQkvKiBt
YXhlZCBvdXQgdGhlIEdHVFQgc3BhY2UgKi8KIAkJCWk5MTVfZ2VtX29iamVjdF9wdXQob2JqKTsK
QEAgLTE2MDAsMTAgKzE2MDMsMTIgQEAgc3RhdGljIGludCBpZ3RfZ3R0X2luc2VydCh2b2lkICph
...


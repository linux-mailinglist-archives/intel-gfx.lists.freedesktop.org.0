...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 604628789C6
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Mar 2024 22:01:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 372A0112C7E;
	Mon, 11 Mar 2024 21:01:15 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RXbohA1U";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7AA4C112C7D;
 Mon, 11 Mar 2024 21:01:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710190875; x=1741726875;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=AFOd/W1vbEA9r4Qz8AaOnoTggdP+88mKas2wJU5iwSI=;
 b=RXbohA1UcAs/VkFoCtDM33E1qEJbJWChR69JgMx6c3dCwNtiR1zbb7P8
 EgolbrAryANI994tTEA1MhK6JTmZommTaGJMQqqHJZyrlqHCda2w02/hx
 kSZPVuybTAaO3yLNWFAtlYATCBqiQpJOTZsb9Oohih+AKRNS+KJtVuEsd
 SpgOCXdza0Pvh6L9Uedl6gxcAA+G6k5ZQxyWMMZyPN52KxUJfD8TWDxCP
 HnYuvDyU4CluTW4LA2RTHdsaWDl/A4zIwPTlDZYj9kR0GLZ/2UVSuQGWR
 uq8sUBSMacBgTayUrB8QIZ03g6ZOON/pVftRQqf7UaMI6p/mAuO2A51oY Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11010"; a="16020215"
X-IronPort-AV: E=Sophos;i="6.07,117,1708416000"; d="scan'208";a="16020215"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2024 14:01:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,117,1708416000"; d="scan'208";a="11719942"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2024 14:01:12 -0700
Date: Mon, 11 Mar 2024 23:01:04 +0200

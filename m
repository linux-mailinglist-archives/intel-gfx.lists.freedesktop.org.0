...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46288545CCD
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 09:07:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 357DB11BEDA;
...
Subject: [Intel-gfx] [PATCH 1/3] drm/doc/rfc: VM_BIND feature design document

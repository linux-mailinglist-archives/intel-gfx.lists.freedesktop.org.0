...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC8DB6B08D3
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8260410E615;
...
Subject: [Intel-gfx] [PATCH v6 12/24] vfio/pci: Allow passing zero-length fd

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC3C45AC7D6
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:50:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D0BA10EA49;
	Sun,  4 Sep 2022 21:44:27 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 53/57] dyndbg: add/use is_dyndbg_header then
 set _uplink

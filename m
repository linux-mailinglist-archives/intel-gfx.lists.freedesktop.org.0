...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 14523B07CE
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Sep 2019 06:15:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 858A96EB9E;
	Thu, 12 Sep 2019 04:13:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 635946E02C
 for <intel-gfx@lists.freedesktop.org>; Wed, 11 Sep 2019 20:28:03 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 11 Sep 2019 13:28:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,494,1559545200"; d="scan'208";a="200587704"
Received: from jmukumbi-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.54.83])
 by fmsmga001.fm.intel.com with ESMTP; 11 Sep 2019 13:28:00 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 11 Sep 2019 23:29:08 +0300
Message-Id: <20190911202908.19631-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
Subject: [Intel-gfx] [CI RESEND] drm/i915: convert device info num_pipes to
 pipe_mask
...
OTE1L2k5MTVfZHJ2LmgKaW5kZXggODRmYjAyNDVjZjYyLi5iZjYwMDg4OGIzZjEgMTAwNjQ0Ci0t
LSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZHJ2LmgKKysrIGIvZHJpdmVycy9ncHUvZHJt
L2k5MTUvaTkxNV9kcnYuaApAQCAtMjE4OCw5ICsyMTg4LDkgQEAgSVNfU1VCUExBVEZPUk0oY29u
...
ZXggYjNjYzg1NjA2OTZiLi42OTgxMTYyNzY0NDEgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry

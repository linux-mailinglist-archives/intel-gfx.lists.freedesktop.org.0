...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E4014C06CE
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Feb 2022 02:19:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A6A010E1A3;
...
Subject: Re: [Intel-gfx] [PATCH 7/8] drm/i915/guc: Drop obsolete H2G
 definitions

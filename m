...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66EBD5ED4AB
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Sep 2022 08:21:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A98710E282;
...
Subject: [Intel-gfx] [PATCH 16/16] drm/i915/vm_bind: Add uapi for user to
 enable vm_bind_mode

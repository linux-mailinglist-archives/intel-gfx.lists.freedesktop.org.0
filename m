...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 359716B051C
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 11:55:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CEFC210E5F7;
...
Subject: Re: [Intel-gfx] [PATCH 2/7] drm/i915/dp: Check if DSC supports the
 given output_format

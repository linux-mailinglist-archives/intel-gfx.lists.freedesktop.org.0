...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41DD63C5DBB
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Jul 2021 15:50:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8771489BF6;
...
Subject: [Intel-gfx] [RFC PATCH v2 3/4] drm: RFC add choice to use dynamic
 debug in drm-debug

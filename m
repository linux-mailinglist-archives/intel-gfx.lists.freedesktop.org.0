...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FB3F78C8FB
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Aug 2023 17:59:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46A0110E3C9;
	Tue, 29 Aug 2023 15:58:55 +0000 (UTC)
...
Subject: [Intel-gfx] [RFC 04/33] drm: Add helper to add color pipeline

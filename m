...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5189E3F771A
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Aug 2021 16:23:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6714A6E250;
...
Subject: [Intel-gfx] [PATCH v7 6/7] drm: avoid circular locks with

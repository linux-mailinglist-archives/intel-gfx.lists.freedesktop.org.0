...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B77635FB03B
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Oct 2022 12:13:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE74310E7E4;
	Tue, 11 Oct 2022 10:13:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 675F510E7E4
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Oct 2022 10:13:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665483214; x=1697019214;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=jEzWHLM2QAn7e/aHRN9LkCKkCAAbW62aU+WsrYx+O/U=;
 b=RnaWAOG+8Rh3hnG8kX144PSGHstDTfqQByOk4ce07Wxt7Xy60c3fOvLx
 gMbCHKNX7YmvJI4o1giiuUP2Jb7A/E9niLcrFYN1jqMW1oOlnpn3VddA9
 V5RmdanPnofRcoHw8icwVr3AU7fRRPwYg8YJT7kUUyz3E7Q3VU1AQ6aYo
 0Ni/vJwB7UcMrdD3FC9Mevg312SPvDvla5QhnQwRbip5cz794mGaW3est
 zoMM0/hyqyWcxarxK2wyA91QRl269D6/klv55cQzeIqbhkp45rPov8LF2
 NzjkL44LWfGzfanFb63tB44Zl4iphDzQgwTckcgqtF1bOhcUvF4tXdG29 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="390772414"
X-IronPort-AV: E=Sophos;i="5.95,176,1661842800"; d="scan'208";a="390772414"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2022 03:13:34 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="871455975"
X-IronPort-AV: E=Sophos;i="5.95,176,1661842800"; d="scan'208";a="871455975"
Received: from milawils-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.40.183])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2022 03:13:31 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: Andi Shyti <andi.shyti@linux.intel.com>, Andi Shyti
 <andi.shyti@linux.intel.com>
In-Reply-To: <Y0VAyikdFVTl0YhX@ashyti-mobl2.lan>
...
Date: Tue, 11 Oct 2022 13:13:28 +0300
Message-ID: <87h70ay8fr.fsf@intel.com>
MIME-Version: 1.0

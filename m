...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0946A5B2C85
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 05:06:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87A5510EBC9;
...
Subject: [Intel-gfx] [PATCH v3 13/15] vfio/ccw: Use the new device life
 cycle helpers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 989174C01A4
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 19:52:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA6F110EAD4;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: make a handful of read-only
 arrays static const

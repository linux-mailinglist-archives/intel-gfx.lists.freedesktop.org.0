...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BD68617BCC0
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 13:31:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DE486ECF7;
	Fri,  6 Mar 2020 12:31:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B5D7589B4D
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Mar 2020 12:30:59 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  6 Mar 2020 13:30:35 +0100
Message-Id: <20200306123046.2797797-6-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/17] drm/i915: Add ww context handling to
...
@@ -1061,12 +1061,14 @@ I915_SELFTEST_DECLARE(static intel_engine_mask_t context_barrier_inject_fault);
...
@@ -1098,10 +1100,21 @@ static int context_barrier_task(struct i915_gem_context *ctx,
...
+			goto err_unpin;
 		...
 		err = 0;
@@ -1111,6 +1124,16 @@ static int context_barrier_task(struct i915_gem_context *ctx,
...
@@ -1222,20 +1256,10 @@ static int emit_ppgtt_update(struct i915_request *rq, void *data)
...
@@ -1286,6 +1310,7 @@ static int set_ppgtt(struct drm_i915_file_private *file_priv,
 	 */

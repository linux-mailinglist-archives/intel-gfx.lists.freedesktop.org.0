...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4940137AA7B
	for <lists+intel-gfx@lfdr.de>; Tue, 11 May 2021 17:18:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 197636EA61;
	Tue, 11 May 2021 15:18:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x62b.google.com (mail-ej1-x62b.google.com
 [IPv6:2a00:1450:4864:20::62b])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6A91C6EA61
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 May 2021 15:18:28 +0000 (UTC)
Received: by mail-ej1-x62b.google.com with SMTP id a4so30370019ejk.1
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 May 2021 08:18:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=P/1dSG05hwXZpqAzeIo4OGRHF3Fh20jbabeasi8yJxc=;
 b=fop7sPsN2KBWNjn/8XOjN7eDsKXVIBTYMzKFJyvA2Gvo4fMNKFQ3f792/YMKOfJuHX
 OoaMD2tr8rIqoToE1wpAFNQx+nKpF3amLWLAus4QhztS+ucHOLuMC50eiJaJ0HHygids
 y2RxRp+VwyGBpqQYcfdjLLDRFqyiXxrL3aiJo=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=P/1dSG05hwXZpqAzeIo4OGRHF3Fh20jbabeasi8yJxc=;
 b=
X-Gm-Message-State: AOAM5300DF+HocglJZjDWMi9iqo7fsA/noS6yNvIE5Ixge4ny0KJVNZO
 W/7xSc+v9Y0E3JoE3n+dvH6UFEv9Xuv4pw==
X-Google-Smtp-Source: ABdhPJxYH3CsfvvYduBNKGyEjJ9J/NaQpy9EXlxxpacoNOuvfJPtkFVzg13FMIY6DfY5PKUh9uqySA==
X-Received: by 2002:a17:906:53d1:: with SMTP id
 p17mr31863775ejo.470.1620746305550; 
 Tue, 11 May 2021 08:18:25 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id gb26sm2353306ejc.25.2021.05.11.08.18.24
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 11 May 2021 08:18:24 -0700 (PDT)
Date: Tue, 11 May 2021 17:18:22 +0200
From: Daniel Vetter <daniel@ffwll.ch>
To: Matthew Brost <matthew.brost@intel.com>
Message-ID: <YJqgPtRSISxZzHlw@phenom.ffwll.local>
References: <20210506191451.77768-1-matthew.brost@intel.com>
 <20210506191451.77768-33-matthew.brost@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20210506191451.77768-33-matthew.brost@intel.com>
X-Operating-System: Linux phenom 5.10.32scarlett+ 
Subject: Re: [Intel-gfx] [RFC PATCH 32/97] drm/i915: Introduce

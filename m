...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 230D06C9A1
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jul 2019 09:01:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 23A936E330;
	Thu, 18 Jul 2019 07:01:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C6EF56E31A
 for <intel-gfx@lists.freedesktop.org>; Thu, 18 Jul 2019 07:00:40 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17390398-1500050 
 for multiple; Thu, 18 Jul 2019 08:00:39 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 18 Jul 2019 08:00:22 +0100
Message-Id: <20190718070024.21781-18-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 18/20] drm/i915: Protect request retirement with
 timeline->mutex
...
bS9pOTE1X2dlbV9leGVjYnVmZmVyLmMKaW5kZXggODc2OGQ0MzZlNTRiLi4yMjE5MTg0YTk2ZGMg
...
c192bWE7CkBAIC0yMTE3LDEwICsyMDYwLDc1IEBAIHN0YXRpYyBjb25zdCBlbnVtIGludGVsX2Vu
...
YWxyZWFkeSB3ZWRnZWQuCkBAIC0yMTM0LDcgKzIxNDIsNyBAQCBzdGF0aWMgaW50IGViX3Bpbl9j
...
dHVybiBlcnI7CiAKQEAgLTIxNDUsMjkgKzIxNTMsNTIgQEAgc3RhdGljIGludCBlYl9waW5fY29u
...
MjIxMiw5ICsyMjQzLDkgQEAgZWJfc2VsZWN0X2xlZ2FjeV9yaW5nKHN0cnVjdCBpOTE1X2V4ZWNi
...
bnRleHQgKmNlOwogCXVuc2lnbmVkIGludCBpZHg7CkBAIC0yMjI5LDcgKzIyNjAsNyBAQCBlYl9z
...
KTsKIAogCXJldHVybiBlcnI7CkBAIC0yNDQ3LDE2ICsyNDc4LDEyIEBAIGk5MTVfZ2VtX2RvX2V4
...
IGVycl9lbmdpbmU7CiAKIAllcnIgPSBlYl9yZWxvY2F0ZSgmZWIpOwpAQCAtMjYxMCwxMCArMjYz
Nyw5IEBAIGk5MTVfZ2VtX2RvX2V4ZWNidWZmZXIoc3RydWN0IGRybV9kZXZpY2UgKmRldiwKIGVy
...
dGV4dC5oIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfY29udGV4dC5oCmluZGV4IDQ4
NTg4NmQ4NGE1Ni4uZmM3ODU5ZjUwNmMyIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkx
...
X2NvbnRleHQgKmN0eCwKQEAgLTEyNywyNCArMTI4LDI0IEBAIHN0YXRpYyBpbmxpbmUgdm9pZCBp
...

...
bF9lbmdpbmVfdHlwZXMuaAppbmRleCA5YzkyN2ZhNDA4YWEuLjNjODQ5NzMyNzVhZSAxMDA2NDQK
LS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZW5naW5lX3R5cGVzLmgKKysrIGIv
ZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZW5naW5lX3R5cGVzLmgKQEAgLTcwLDggKzcw
...
NS9ndC9pbnRlbF9ndC5jCmluZGV4IGY3ZTY5ZGI0MDE5ZC4uOTBlZDc5Mjg1ZmY4IDEwMDY0NAot
...
cy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZ3RfdHlwZXMuaAppbmRleCBiMTNmNjNlNTIyMDMuLmJm
ZGFiZjQ5YjFlNyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZ3Rf
...

...
LmMKaW5kZXggZDhlZmI4OGYzM2YzLi45ZDliZTVmZWQ5ZmMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMv
Z3B1L2RybS9pOTE1L2d0L2ludGVsX3JpbmdidWZmZXIuYworKysgYi9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF9yaW5nYnVmZmVyLmMKQEAgLTEyNzUsNyArMTI3NSw3IEBAIHZvaWQgaW50
...
ZywgcmluZy0+ZW1pdCk7CiAKIAlpOTE1X3ZtYV91bnNldF9nZ3R0X3dyaXRlKHZtYSk7CiAJaWYg
KGk5MTVfdm1hX2lzX21hcF9hbmRfZmVuY2VhYmxlKHZtYSkpCkBAIC0xMzQwLDcgKzEzNDAsNiBA
...
LTE4ODgsMjEgKzE4ODcsMjUgQEAgc3RhdGljIGludCByaW5nX3JlcXVlc3RfYWxsb2Moc3RydWN0
...
cm0vaTkxNS9ndC9tb2NrX2VuZ2luZS5jCmluZGV4IDA0MmI0NTZjZGU0OS4uNDI3NzY2NzJjNTli
...
dC5jCmluZGV4IDhhYzdkMTRlYzhjOS4uOTIzMTNhNTk1NjNjIDEwMDY0NAotLS0gYS9kcml2ZXJz
...
bG9jYWxfY2xvY2tfdXModW5zaWduZWQgaW50ICpjcHUpCkBAIC0xNDg2LDE4ICsxNDU0LDQzIEBA
...
dS9kcm0vaTkxNS9pOTE1X3JlcXVlc3QuaAppbmRleCAzMTNkZjNjMzcxNTguLjIyZTUwNmU5NjBl
MCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9yZXF1ZXN0LmgKKysrIGIv
ZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9yZXF1ZXN0LmgKQEAgLTIyMyw5ICsyMjMsNiBAQCBz
...
aGVhZCBjbGllbnRfbGluazsKLS0gCjIuMjIuMAoKX19fX19fX19fX19fX19fX19fX19fX19fX19f

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7714225DE4
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jul 2020 13:54:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BBC06E39C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 1/5] drm/i915: Add enable/disable flip done

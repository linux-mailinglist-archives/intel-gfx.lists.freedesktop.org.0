...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8107E6650A9
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Jan 2023 01:57:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0F2510E1B4;
...
Subject: [Intel-gfx] [PATCH 0/9] drm/i915/pxp: Add MTL PXP Support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3046D3D0607
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Jul 2021 02:12:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C60B76E4A5;
...
Subject: Re: [Intel-gfx] [PATCH 04/18] drm/i915/guc: Implement GuC
 submission tasklet

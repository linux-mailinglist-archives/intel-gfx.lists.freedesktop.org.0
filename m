...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF04D86A0DF
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Feb 2024 21:32:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82ADE10E998;
	Tue, 27 Feb 2024 20:32:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="WTxtBb5T";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E50F110E997
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Feb 2024 20:32:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1709065958;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=RDeKszvlmwbpY5egO9Ok+fiwmYst3E3Ei5OEyxOFq1U=;
 b=WTxtBb5TR0lPzBltfTM1E5ZMc1EH1wUXLBVHw1/zQ63hE2kxmpJWjAA+tQgfRCbzhg3ZMp
 m6FTWaORoOxP/MqeFMRnSe2Um/JFCqqp0Phy2OW9tMz3uIMdR4f4C/86qWT/faBEqLTTUp
 dnQLIys76rM3N+tjZhQ7cVeVVZ+FlMk=
Received: from mail-wr1-f69.google.com (mail-wr1-f69.google.com
 [209.85.221.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-302-dn9o4K-aPh-z3BkOaXRZWg-1; Tue, 27 Feb 2024 15:32:34 -0500
X-MC-Unique: dn9o4K-aPh-z3BkOaXRZWg-1
Received: by mail-wr1-f69.google.com with SMTP id
 ffacd0b85a97d-33dc175ff8fso2192314f8f.0
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Feb 2024 12:32:34 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=RDeKszvlmwbpY5egO9Ok+fiwmYst3E3Ei5OEyxOFq1U=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCVetEHVhVgfObeevkxbyAydBx6qPbcPwBl5F49NjrfseNWZEyN2UiuZSgaGXYg5QyP53BQYkmQZiB5y+SVX97m93gxKU3lXJMbVtTOZ6MWj
X-Gm-Message-State: AOJu0Yyr5QXehTHeUhuTh3NF8UAV3qOpEyUmLwhkipBNXsvnM0wR6u0r
 cKIJuhCYffS7kt7U3i8ZHm6+1RCA4w4g74O6JRhxTUP1nbT2fRnRctt+Gn5P9+8W9oFb7A4Yvdv
 RvsQ+uUBxdhuyQuMnixqHXNrnwLutAtNyduqoHIcNsBhIvmFUxWtMzrylY8+K4YDovg==
X-Received: by 2002:adf:e0cf:0:b0:33d:161d:5e66 with SMTP id
 m15-20020adfe0cf000000b0033d161d5e66mr7388179wri.21.1709065953537; 

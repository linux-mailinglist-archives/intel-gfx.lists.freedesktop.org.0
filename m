...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6D7C1ADCA7
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 13:58:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A47C46EBB4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v10 07/14] drm/i915: Program DP SDPs with
 computed configs

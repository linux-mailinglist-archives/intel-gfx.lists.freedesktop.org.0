...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32D9D41D11B
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Sep 2021 03:45:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2AEA6EB23;
...
Subject: [Intel-gfx] [PATCH 2/4] amdgpu_ucode: reduce number of pr_debug
 calls

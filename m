...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7216254AD88
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jun 2022 11:45:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D2E4D10F847;
...
Subject: [Intel-gfx] [PATCH] drm/dp/mst: Read the extended DPCD capabilities

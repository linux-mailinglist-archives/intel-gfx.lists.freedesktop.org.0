...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21C2F60A147
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Oct 2022 13:22:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83C8610E482;
...
Subject: [Intel-gfx] [PATCH v2 17/21] drm/fb-helper: Perform all fbdev I/O

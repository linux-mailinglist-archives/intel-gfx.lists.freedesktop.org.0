...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F36A87C746D
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Oct 2023 19:22:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9E34410E54E;
...
Subject: [Intel-gfx] [PATCH v7 12/25] dyndbg: reduce verbose=3 messages in
 ddebug_add_module

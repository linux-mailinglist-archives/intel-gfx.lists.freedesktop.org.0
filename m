...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EBF57D9374
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Oct 2023 11:21:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 52A4410E95A;
...
Subject: [Intel-gfx] [PATCH v4 1/4] pwm: rename pwm_apply_state() to
 pwm_apply_cansleep()

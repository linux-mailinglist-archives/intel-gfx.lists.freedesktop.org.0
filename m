...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ED4666D9884
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Apr 2023 15:47:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BEF310EBC9;
	Thu,  6 Apr 2023 13:47:24 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 2/2] drm/dsc: fix DP_DSC_MAX_BPP_DELTA_* macro
 values

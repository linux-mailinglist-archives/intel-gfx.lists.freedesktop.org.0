...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC10514F41A
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jan 2020 22:47:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1D216FC14;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/18] drm/i915: Include DP HDR Metadata

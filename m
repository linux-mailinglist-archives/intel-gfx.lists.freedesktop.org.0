...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 78E4C509A80
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 10:18:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82CFF10F62D;
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/i915/selftests: tweak the
 misaligned_case

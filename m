...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62AEA4BF62A
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 11:37:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B08C10E6C5;
	Tue, 22 Feb 2022 10:36:58 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 4/4] drm/i915/guc: Verify hwconfig blob

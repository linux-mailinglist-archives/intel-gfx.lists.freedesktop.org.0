...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AC341E5915
	for <lists+intel-gfx@lfdr.de>; Thu, 28 May 2020 09:41:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E8326E3EB;
	Thu, 28 May 2020 07:41:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DCF0C6E3DF
 for <intel-gfx@lists.freedesktop.org>; Thu, 28 May 2020 07:41:41 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21318026-1500050 
 for multiple; Thu, 28 May 2020 08:41:11 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 28 May 2020 08:41:04 +0100
Message-Id: <20200528074109.28235-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/11] drm/i915/gem: Lift GPU relocation
 allocation
...
index f50378699a19..d48f42567f75 100644
...
@@ -1605,18 +1618,14 @@ static int eb_relocate(struct i915_execbuffer *eb)
...
@@ -2576,9 +2585,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 		batch = vma;
 	}

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B40C15095E
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Feb 2020 16:14:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 362746EC30;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/26] drm/dp: Define more downstream facing
 port caps

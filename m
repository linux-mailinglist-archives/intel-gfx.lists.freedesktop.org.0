...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C40C3DF78F
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Aug 2021 00:13:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CFFB6E252;
...
Subject: [Intel-gfx] [PATCH 14/46] drm/i915: Expose logical engine instance
 to user

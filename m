...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 79028457186
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Nov 2021 16:17:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 13D8E6EC04;
...
Subject: [Intel-gfx] [PATCH 2/2] i915/gvt: save the MMIO snapshot in the
 early init of GVT-g

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7671E19DF9A
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Apr 2020 22:40:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 551806EC92;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 08/17] drm: Shrink drm_display_mode timings

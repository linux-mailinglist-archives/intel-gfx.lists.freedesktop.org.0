...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0508A6013E4
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Oct 2022 18:50:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 380B310E69F;
...
Subject: Re: [Intel-gfx] [PATCH v3 03/14] drm/i915/gt: Drop a few unused

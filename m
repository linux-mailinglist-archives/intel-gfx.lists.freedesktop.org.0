...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 98F8E14F41C
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jan 2020 22:47:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C4016FC0A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/18] drm/i915: Program DP SDPs with computed
 configs

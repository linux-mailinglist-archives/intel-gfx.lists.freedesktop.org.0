...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C2FA46CA440
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Mar 2023 14:40:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9511D10E5AF;
	Mon, 27 Mar 2023 12:40:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 178B210E5A8
 for <intel-gfx@lists.freedesktop.org>; Mon, 27 Mar 2023 12:39:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1679920796; x=1711456796;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=emX7C2YNuNwFZ9fP56i5tec5gOq06maKnq4k/uzZS3I=;
 b=iibMWf2uvtB7lsQJc6Iv3GxkQ/2dYzQ1DEMMaCaJ45EaEnxTQGkcGJwa
 WTnPVuV3TZrGRPtQeIHjTV/+xBmCitCFTM0T5wLSerywBaqguYfF+mGi+
 CScCHbBSG2nDQvPascV1TrQP743oMWFtoK52mJvZEjl/W4eOdaEQRWuZ9
 5s/vqNtJ6K64zmebQaVc4C7XKWeGwqZi1RbYt4gP8fMiYIAHwBUiBQhIG
 rMkNi/T7kbbEOs2BX1Z+ytx9K72zwKUKdogydtOGZilfYRZhFbYfhYPD1
 0iC2HX8OUw7mJJyfFTp4s+it/69SY87MTZystDXpPaCR3syC7cDdWhTAA A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="402847812"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="402847812"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Mar 2023 05:39:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="747984754"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="747984754"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by fmsmga008.fm.intel.com with ESMTP; 27 Mar 2023 05:39:52 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 27 Mar 2023 15:34:31 +0300
Message-Id: <20230327123433.896216-6-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH 5/7] drm/i915/mtl: Add C10 phy programming for
 HDMI

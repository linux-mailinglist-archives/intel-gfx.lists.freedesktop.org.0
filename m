...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA1E142C8D1
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 20:36:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33C9B6E106;
	Wed, 13 Oct 2021 18:36:29 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 4/4] vgaswitcheroo: do not check for NULL
 debugfs dentry

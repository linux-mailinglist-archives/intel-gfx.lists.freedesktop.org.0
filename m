...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEEA02D55BC
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 09:53:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C876E6E43A;
	Thu, 10 Dec 2020 08:52:57 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 66F796E3F0
 for <Intel-gfx@lists.freedesktop.org>; Thu, 10 Dec 2020 08:52:39 +0000 (UTC)
IronPort-SDR: 4THGvikrTR4hsdJkKR8/Jd6r1Z7M9XF8gpUhdylM9J/48HE9NG+SZXis/AJ9cvuDLDSVcMTyE8
 HlkXYOr6ToRQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9830"; a="171653241"
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; d="scan'208";a="171653241"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2020 00:52:38 -0800
IronPort-SDR: VnXHPkPtE5LZARDFvvs49ID1JGTLATpmsqFBS2/ROTkqENqYm7RaaDlFmVExARHhX7fQTURtyX
 KHkDsgHAM8eg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; d="scan'208";a="318931573"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga008.fm.intel.com with ESMTP; 10 Dec 2020 00:52:36 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 10 Dec 2020 00:51:56 -0800
Message-Id: <20201210085203.14422-15-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201210085203.14422-1-sean.z.huang@intel.com>
References: <20201210085203.14422-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v5 14/21] drm/i915/pxp: Implement ioctl action to

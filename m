...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 60F3C67A821
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 02:02:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A324010E0C1;
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/i915/guc: Fix missing return code

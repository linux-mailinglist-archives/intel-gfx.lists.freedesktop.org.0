...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 49DB2390AD1
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 22:58:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3FE5B6EAE3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 01/17] drm/i915/guc: skip disabling CTBs before
 sanitizing the GuC

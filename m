...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44C6958B18D
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Aug 2022 23:55:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F41D412AC4F;
...
Subject: [Intel-gfx] [PATCH v5 03/33] dyndbg: show both old and new in
 change-info

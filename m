...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AAB3442793
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 08:07:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C7506FAAB;
...
Subject: [Intel-gfx] [PATCH 09/29] drm/i915/gvt: remove the unused
 from_virt_to_mfn op

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B11E885D2
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 00:27:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 273B36EEE7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 05/37] drm/i915/region: support volatile
 objects

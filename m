...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9643346FD2C
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 09:59:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A10010E3D3;
	Fri, 10 Dec 2021 08:59:38 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 1/9] drm/i915/gvt: Constify

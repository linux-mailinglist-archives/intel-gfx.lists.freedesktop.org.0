...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46843CD6494
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Dec 2025 15:00:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F2BC810E675;
	Mon, 22 Dec 2025 14:00:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="RNRKDkr2";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pf1-f196.google.com (mail-pf1-f196.google.com
 [209.85.210.196])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4753010E5CB
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Dec 2025 08:25:08 +0000 (UTC)
Received: by mail-pf1-f196.google.com with SMTP id
 d2e1a72fcca58-7fc0c1d45a4so3371492b3a.0
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Dec 2025 00:25:08 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1766391908; x=1766996708; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=8Szrm2xyRg1lmaQf8zywAaKn+Ehry2sa3RT5H465S+Q=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1766391908; x=1766996708;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=8Szrm2xyRg1lmaQf8zywAaKn+Ehry2sa3RT5H465S+Q=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCWyhggtte6LE68Bt7qjLCEnlgg19rsBkSo1Oniv5Zud9mNn6Tz+Bfb/qP1ok+N2w4vLKTj237mAywk=@lists.freedesktop.org
X-Gm-Message-State: AOJu0Yw3+paOoLKs3gkel5tiPnTqw5WfmBcDzADoruJDFzhaGIfcinj7
 ncNYFvAWQ6UNhBh1K2hvR9gZYnEL2n86o3FqfJ5gqrNMMNqlo2H5DhSf
X-Gm-Gg: 
 wovbFutyEJ
X-Google-Smtp-Source: AGHT+IG+n7LX5UcpJ3Aoj5or+4oM3rMJS7vM61ev9Q8cFbiDoDQdRco6FYLlqYmBvV/HW8u2G5hLbA==
X-Received: by 2002:a05:6a00:4c0e:b0:7e8:450c:61bb with SMTP id
 d2e1a72fcca58-7ff6607e24amr8806423b3a.43.1766391907426; 
 Mon, 22 Dec 2025 00:25:07 -0800 (PST)
Received: from frodo ([2404:4400:417e:3d00:8b90:7f55:1261:772f])
 by smtp.googlemail.com with ESMTPSA id
 d2e1a72fcca58-7ff7e493123sm9540699b3a.50.2025.12.22.00.24.56
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 22 Dec 2025 00:25:06 -0800 (PST)
...
Subject: [PATCH v7 21/31] dyndbg-API: replace DECLARE_DYNDBG_CLASSMAP
Date: Mon, 22 Dec 2025 21:20:38 +1300
Message-ID: <20251222082049.1782440-22-jim.cromie@gmail.com>
...
---
replace di with &dt->info, since its stale
...
---
 ...
 9 files changed, 413 insertions(+), 79 deletions(-)
 create mode 100644 lib/test_dynamic_debug_submod.c

diff --git a/MAINTAINERS b/MAINTAINERS
index b9d38a5b4f12..b6c549cc27e6 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -8771,7 +8771,7 @@ M:	Jim Cromie <jim.cromie@gmail.com>
 S:	Maintained
...
index da15cf0c16d0..c7d85b857997 100644
...
index 713cc94caa02..9bc6f76830a6 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
@@ -2979,12 +2979,26 @@ config TEST_STATIC_KEYS
 	  If unsure, say N.
...
index 1ab2c4be3b66..63ed5fabada2 100644
--- a/lib/Makefile
+++ b/lib/Makefile
@@ -82,6 +82,9 @@ obj-$(CONFIG_TEST_RHASHTABLE) += test_rhashtable.o
...
@@ -204,6 +207,8 @@ obj-$(CONFIG_ARCH_NEED_CMPXCHG_1_EMU) += cmpxchg-emu.o
...
index 63bfe1891a9e..c60c2142f8ac 100644

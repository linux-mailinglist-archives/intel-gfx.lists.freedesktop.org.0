...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D74BD4BEDE2
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:26:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5358A10E572;
	Mon, 21 Feb 2022 23:26:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F053110E56D;
 Mon, 21 Feb 2022 23:26:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485992; x=1677021992;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+cYQCtajtLHF13wD1Ab8Zm6c/BiUXjG1ZHacvq+QS4Q=;
 b=YqNN6jY/VVreuZzx6UJEp5TyEDXQ05tegOquQ0UI0Q2RzPPsgtv5pFfc
 xNsdLXlrsRwEK1jB3GTZl7oNtVrOOFRy/KmAFipxfMFDtYwYuRyjNBYbr
 9w2GUjPZoOos4443uqCOxkRH07/VvKFNkfbuIOUI4gbKBKPxibTLGY6ic
 yygtSY7SjFNvHqWA/GecgqYEGu09ssJF/K0qn3hyiA4Mxf7xxascsBX2Y
 RRjY6LiCv99aJL0OMmh6LYz3+mNulDgB7zxjTAn9Y4VFCKEdKybAnThhK
 Ca3pdCGCc1Iaub7LxBfM7JiuEKd58BZCCa639ahH1AQTOg9LD/AelPyFc g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="235119470"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="235119470"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:26:31 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="706397094"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:26:28 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: linux-kernel@vger.kernel.org, intel-gfx@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org, netdev <netdev@vger.kernel.org>
Date: Tue, 22 Feb 2022 00:25:42 +0100
Message-Id: <20220221232542.1481315-12-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 11/11] drm/i915: replace Intel internal

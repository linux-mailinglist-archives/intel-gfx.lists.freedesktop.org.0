...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E920F5AACF2
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Sep 2022 12:59:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D87810E7F5;
...
Subject: Re: [Intel-gfx] [PATCH v2 1/4] drm: Use original src rect while

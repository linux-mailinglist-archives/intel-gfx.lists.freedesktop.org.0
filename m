...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B436B2FCFD2
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jan 2021 13:14:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 788A96E1ED;
	Wed, 20 Jan 2021 12:14:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 757F56E19A
 for <intel-gfx@lists.freedesktop.org>; Wed, 20 Jan 2021 12:14:47 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23649060-1500050 
 for multiple; Wed, 20 Jan 2021 12:14:40 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 20 Jan 2021 12:14:39 +0000
Message-Id: <20210120121439.17600-2-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20210120121439.17600-1-chris@chris-wilson.co.uk>
References: <20210120121439.17600-1-chris@chris-wilson.co.uk>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0998B79AC57
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Sep 2023 01:09:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F252410E379;
...
Subject: [Intel-gfx] [PATCH v6 13/22] dyndbg: add for_each_boxed_vector

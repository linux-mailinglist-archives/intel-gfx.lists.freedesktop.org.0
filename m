...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D40B95470B8
	for <lists+intel-gfx@lfdr.de>; Sat, 11 Jun 2022 02:57:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C560610F2BC;
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/gt: Cleanup interface for MCR
 operations

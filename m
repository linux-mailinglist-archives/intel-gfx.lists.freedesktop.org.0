...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC2AE5A2101
	for <lists+intel-gfx@lfdr.de>; Fri, 26 Aug 2022 08:42:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9800D10E616;
	Fri, 26 Aug 2022 06:42:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C2DB510E616;
 Fri, 26 Aug 2022 06:42:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661496159; x=1693032159;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=SqNqCOxk9TSNEIgGDrqpMrqcqUbVKX6GZwA09lWrGow=;
 b=Cl7xBSm3VlPhE5u97XwPF5hChWRYQI66hi32g3FM3Rtz5hvAEIPs0NYc
 K8F9yCQBGNQa/EMaRL326VNX1mSLt2LgmlpijVyrVHnKJTOQDjv/fnlmz
 svDuQLTl4ftUfAU4iK6W6or94m/2y/t6yJwF2MIlPkTRbmkPP75bixsDZ
 POwpXUzM+q0yan2Ry/FviSdVU152Nc5DxewZ6irzJffybiagezIqdXIXk
 ZXCYaWbQjfVzs8PSVr/uVTGTAq+ONmR4o6aDqEyqcO5qzJFPFeqNCUTjO
 TpmnLxeBKoj77Qv4NrXt4LRE3CJBb1I3Biq12hzmKMRYWYmYJitxvyLC9 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10450"; a="320531465"
X-IronPort-AV: E=Sophos;i="5.93,264,1654585200"; d="scan'208";a="320531465"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Aug 2022 23:42:38 -0700
X-IronPort-AV: E=Sophos;i="5.93,264,1654585200"; d="scan'208";a="587194238"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Aug 2022 23:42:35 -0700
Date: Fri, 26 Aug 2022 09:41:31 +0300
From: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
To: "Govindapillai, Vinod" <vinod.govindapillai@intel.com>
Message-ID: <YwhrG3MfN0oZdEVz@intel.com>
References: <20220822094037.15483-1-stanislav.lisovskiy@intel.com>
 ...
 <9dd212425dacb50212d7d6d6c2631d392eee20e9.camel@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <9dd212425dacb50212d7d6d6c2631d392eee20e9.camel@intel.com>
...
> > > > +               if (slots >= 0)
> > > > +                       break;
> > > Based on our understanding that drm_dp_atomic_find_vcpi_slots" doesn't check any limits, we
> > > cannot
...
> > Stan
> 
> Okay. I got that part. if you are keeping the logic like that, then there is no need to do loop over
> max_bpp to min_bpp here. Because bpp = max_bpp will never fail, the DSC will be always attempted
> with the max_bpp. And as you mentioned eventually intel_atomic_check() will catch if it is too big.
> 
> But if the intention is to find the right "bpp" which might still fit to the link, we should iterate
> over the bpp-s like you have here. But in that case the decision has to be based on one more
> "drm_dp_mst_atomic_check()"

Oh, you are right - that new finding means not only that, but also that intel_dp_mst_compute_link_config,
which I took as a template doesn't work either - because of same reason drm_dp_atomic_find_vcpi_slots 
just doesn't care if we don't have enough slots.. :(

We are also loosing opportunity to use smaller bpps here, which could allows us to fit actually, even without
DSC.. That needs to be fixed. Probably will add one patch which fixes intel_dp_mst_compute_link_config first,
then we add intel_dp_dsc_mst_compute_link_config, which works same way but with DSC. 
May be I could also extract this loop to avoid code duplication.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D97268211A
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Aug 2019 18:03:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1AB7F6E4D4;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 KUdg==
Subject: [Intel-gfx] [PATCHv2 2/3] i915: convert to new mount API

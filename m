...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DF0346FEED
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 11:47:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8828710E47E;
	Fri, 10 Dec 2021 10:46:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C8B4B10E38F
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Dec 2021 10:46:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1639133216;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=3pZ4ChwNXB58l3uu5uA6Fbc5nYRsjeY8eImd9T6ngNQ=;
 b=Aa6M/eVI6HtLUUCMeo4S+K3Q5/LS2z4yQHRKJIcNxvlZv6UeOGPRAkeG/jfEua7YK1Zi+b
 h8LElLENdApVd1Zg17SojUuO3zU3jjuVEu4DfOPHZ0XjdTGPqhg5cHzIC+Tfo3/rldEhPi
 QqteOmKJHAJfr0P0VMr9RSGSieT6rJ0=
Received: from mail-ed1-f69.google.com (mail-ed1-f69.google.com
 [209.85.208.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-525-_pGS3Qx-N5eNUewsR4mU9Q-1; Fri, 10 Dec 2021 05:46:50 -0500
X-MC-Unique: _pGS3Qx-N5eNUewsR4mU9Q-1
Received: by mail-ed1-f69.google.com with SMTP id
 k7-20020aa7c387000000b003e7ed87fb31so7926768edq.3
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Dec 2021 02:46:49 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=3pZ4ChwNXB58l3uu5uA6Fbc5nYRsjeY8eImd9T6ngNQ=;
 b=
X-Gm-Message-State: AOAM531eSa+nBdlYpNiwcitsvJ6IHL5si4wTwfgPMbxeknLb8zcG4pJz
 lN5zZ0ulPkbnqcMBqcepUWk+6vCB+0dOXxUIdXybdcu7atwnqVBvFbdVvTLgq4ELNOpffoW6iRA
 YfbovNhDR9JV/c+3uv9ofPogXTGiy
X-Received: by 2002:a05:6402:4389:: with SMTP id
 o9mr37724365edc.138.1639133208433; 
 Fri, 10 Dec 2021 02:46:48 -0800 (PST)
X-Google-Smtp-Source: ABdhPJxg+yRY2omK93or7Lmk75dg+FPQ2fOrk9qY5bUJgH1yEdALs20s3y//N2MO/LMMMmdnRztXAA==
X-Received: by 2002:a05:6402:4389:: with SMTP id
 o9mr37724275edc.138.1639133207806; 
 Fri, 10 Dec 2021 02:46:47 -0800 (PST)
Received: from ?IPV6:2001:1c00:c1e:bf00:1054:9d19:e0f0:8214?
 (2001-1c00-0c1e-bf00-1054-9d19-e0f0-8214.cable.dynamic.v6.ziggo.nl.
 [2001:1c00:c1e:bf00:1054:9d19:e0f0:8214])
 by smtp.gmail.com with ESMTPSA id gn26sm1280412ejc.14.2021.12.10.02.46.46
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Fri, 10 Dec 2021 02:46:47 -0800 (PST)
Message-ID: <0d66aa18-4ad8-a117-8ec2-bc3aa676a14e@redhat.com>
Date: Fri, 10 Dec 2021 11:46:46 +0100
MIME-Version: 1.0
...
In-Reply-To: <460220bf-a34d-ba23-4624-e296e9ada6bb@leemhuis.info>

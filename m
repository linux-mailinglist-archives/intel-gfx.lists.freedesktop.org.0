...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1084A3F4E30
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Aug 2021 18:18:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 193B489D60;
...
Subject: [Intel-gfx] [PATCH v2 03/19] drm/dp: add LTTPR DP 2.0 DPCD addresses

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A53B2D7709
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Dec 2020 14:56:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C47EF6EDF7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 03/19] drm/i915/hotplug: Handle CP_IRQ for
 DP-MST

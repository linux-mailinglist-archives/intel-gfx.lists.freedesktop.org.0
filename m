...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7C41786038
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Aug 2023 20:56:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BA8810E0D4;
	Wed, 23 Aug 2023 18:56:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3A2FF10E0CF
 for <intel-gfx@lists.freedesktop.org>; Wed, 23 Aug 2023 18:56:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692816963; x=1724352963;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=T11dV/7PB8tcxBhoFTehdKD6oILIgwgtOZ/lRDm0ZbQ=;
 b=Xtw+xVoV46kI5P8aYceAgWisZkzOSCZyMtMVKSnqQmW8+0/dQUzAJdG5
 0pPk+4c9aIE1ZVx9s/QmVGPwx65xsS6eOOSOhWRj4gqMyP2ss2MZpehRG
 58gKURPmdcHMWzUBN60iXntbM49Lgt1uSJQ07fdC+dzonCDpnko61oBDS
 j8LfLuiXr10yiQg4KRJQMPAloiZaSSH/u1mHO2O3MRkbC1ngROrx1fmyi
 fMPNONJuSPWSChYpQ4RLhFdP3sPvm3RZhJcv2KC06uojUq7XgIvttoCOo
 7upxO55vAFFDyd6n5x1owAMJtVmln3JmJrvJLeKPrXc6cORS5D0zzokAp Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10811"; a="438172321"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="438172321"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Aug 2023 11:56:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10811"; a="686569653"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="686569653"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Aug 2023 11:55:59 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 23 Aug 2023 11:45:19 -0700
Message-Id: <20230823184520.1993320-2-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: Add WABB blit for Wa_16018031267
 / Wa_16018063123

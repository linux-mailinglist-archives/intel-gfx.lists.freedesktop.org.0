...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EA0A7A5C75
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Sep 2023 10:27:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 620AE10E38E;
	Tue, 19 Sep 2023 08:27:06 +0000 (UTC)
...
Subject: [Intel-gfx] [REGRESSION] [BISECTED] Panic in

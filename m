...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7F751DB7AC
	for <lists+intel-gfx@lfdr.de>; Wed, 20 May 2020 17:04:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3AAB89B51;
	Wed, 20 May 2020 15:04:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 55C6E89B51
 for <intel-gfx@lists.freedesktop.org>; Wed, 20 May 2020 15:04:56 +0000 (UTC)
IronPort-SDR: HKb6lzEQ1DHDmaFk/ssWYRoL+b48PGezzMOoSfMPTq+Ls+ldIa/ZOeuHjNf6b3Pjeodhe+sUdX
 dWy9CHch7NJg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 May 2020 08:04:55 -0700
IronPort-SDR: ORe9HIlrDJOgTKW5inPsdKhCM6ZFATHoC0O5qXfHhX12KDcTLPvs3OigrGNVv9+BbE5N0TmFZD
 jkSmNJeVE0QA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,414,1583222400"; d="scan'208";a="466418281"
Received: from unknown (HELO slisovsk-Lenovo-ideapad-720S-13IKB.fi.intel.com)
 ([10.237.72.89])
 by fmsmga005.fm.intel.com with ESMTP; 20 May 2020 08:04:54 -0700
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 20 May 2020 18:00:58 +0300
Message-Id: <20200520150058.16123-1-stanislav.lisovskiy@intel.com>
X-Mailer: git-send-email 2.24.1.485.gad05a3d8e5
In-Reply-To: <20200519212525.20492-1-stanislav.lisovskiy@intel.com>
References: <20200519212525.20492-1-stanislav.lisovskiy@intel.com>
MIME-Version: 1.0
...
-
 ...
 {
@@ -420,6 +420,123 @@ intel_atomic_get_bw_state(struct intel_atomic_state *state)

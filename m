...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B53E546A82
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 18:35:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DA1B10EA69;
	Fri, 10 Jun 2022 16:35:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 910D010E927;
 Fri, 10 Jun 2022 16:35:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654878935; x=1686414935;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=g49tN9W0JjhJKCMgrmKQLlIJGiMb6X+9yZMFr3suhSQ=;
 b=ReFyZYxt/Q57EbGsO2LE0MybiXRI8jWKK0p8BPSxuYZ+FJoP5uz0D5Ct
 4ugSpL+jLffXHOjQwoaflMSpGGfk5npzXWfITHFoWPwz2QNVtuxS4u6WI
 JlVwh3g9LH2wV+uax98yVSf1nbvAdl36mgZH3r6+6mDJyGbd35xmDxNWl
 MQEB3WF7oyiH4NCKuK1E4UmRz8punUxHovLUDvX1xvH7K87Dm+xnfVlP/
 bYgQKHKtw8Ugi5/IDWdBr5PctwMlVmtXj2N09U90flM1I4QMFv2nxCPUR
 aShIcLqCa1Z5DOlObSPdjItErptFnjmxBprnld4OyWHKaKDw/tUULAId/ g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10374"; a="278476777"
X-IronPort-AV: E=Sophos;i="5.91,290,1647327600"; d="scan'208";a="278476777"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 09:35:33 -0700
X-IronPort-AV: E=Sophos;i="5.91,290,1647327600"; d="scan'208";a="760583067"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jun 2022 09:35:32 -0700
Date: Fri, 10 Jun 2022 09:35:14 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Matthew Brost <matthew.brost@intel.com>
Message-ID: <20220610163512.GC376@nvishwa1-DESK>
...
In-Reply-To: <20220610085658.GB20978@jons-linux-dev-box>

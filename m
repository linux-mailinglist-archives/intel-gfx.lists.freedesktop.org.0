...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4055561463
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Jun 2022 10:12:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A8C5113131;
	Thu, 30 Jun 2022 08:12:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5420C113130;
 Thu, 30 Jun 2022 08:12:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656576769; x=1688112769;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to;
 bh=wxEA/uVAqJQvtCxzPctMKgmGZGDpbP+frW55pMt+y00=;
 b=SM0ed50smIMI+VfaaUINh4IDrfC49OKh4R/ESETn1vgHtZcKqACNvyXc
 5FGJIItQTMWBO8OAGvH3T3LxyI3S+375dMgxkBXH44Wrzv5sSb/eI4lX6
 WbvEkGCN97hiNWxvmTkj+ALMFzWArUECoObFZcNdDrVGejUkWsGZ8tojt
 yiYrT7V+83cppARjrsnFaGFFD7zwUdPUMEDQDBfscgIdnBgfrK4UdccrK
 rOXZtPprh8ravvuWB3MF2mx8ziBhPGgWIZGqCXFfn6j9vTIMi7K20tNOd
 9AyLD304N95FOhUeJ6ObdpPzblSNgWU2ZYlvqx84H+RE3wftgK/aeZ2m6 A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10393"; a="282315133"
X-IronPort-AV: E=Sophos;i="5.92,233,1650956400"; 
 d="gz'50?scan'50,208,49,50,223";a="282315133"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2022 01:12:47 -0700
X-IronPort-AV: E=Sophos;i="5.92,233,1650956400"; 
 d="gz'50?scan'50,208,49,50,223";a="837507771"
Received: from hanj1-mobl1.ccr.corp.intel.com (HELO [10.213.202.230])
 ([10.213.202.230])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2022 01:12:43 -0700

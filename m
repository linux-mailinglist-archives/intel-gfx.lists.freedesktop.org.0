...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1016D4D2828
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Mar 2022 06:17:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 51DF010E93B;
...
Subject: [Intel-gfx] [PATCH 4/8] drm/i915/gt: Explicitly clear BB_OFFSET for
 new contexts

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC0AE3D6751
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Jul 2021 21:08:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1BEF172BB8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/15] drm/i915/guc/slpc: Gate Host RPS when
 SLPC is enabled

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFA1614EB31
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jan 2020 11:46:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A48036FAE2;
	Fri, 31 Jan 2020 10:46:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 26FBC6E960
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Jan 2020 10:46:05 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20070416-1500050 
 for multiple; Fri, 31 Jan 2020 10:45:50 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 31 Jan 2020 10:45:40 +0000
Message-Id: <20200131104548.2451485-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 04/12] drm/i915/gt: Yield the timeslice if
...
index 86af5edd6933..a14b2f9e0155 100644
--- a/drivers/gpu/drm/i915/gt/intel_engine_cs.c
+++ b/drivers/gpu/drm/i915/gt/intel_engine_cs.c
@@ -1283,6 +1283,12 @@ static void intel_engine_print_registers(struct intel_engine_cs *engine,
...
index 5906fc7df2a4..e1ea369bc62d 100644
...
@@ -4345,6 +4372,7 @@ logical_ring_default_irqs(struct intel_engine_cs *engine)
...
index 639c3a10cfa3..1bacdbbb7516 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4951B60BC6E
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Oct 2022 23:46:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B0A610E05C;
	Mon, 24 Oct 2022 21:46:16 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 5/7] drm/i915/mtl: Handle wopcm per-GT

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DBDFF2466D4
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Aug 2020 15:02:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C6376E2B0;
...
Subject: [Intel-gfx] [PATCH] drm: i915: convert tasklets to use new
 tasklet_setup() API

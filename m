...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D8B8403250
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Sep 2021 03:43:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 15BE16E0F5;
...
Subject: [Intel-gfx] [PATCH 2/8] drm/i915/guc: put all guc objects in lmem
 when available

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E33743B15F
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Oct 2021 13:41:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7AE466E41B;
...
Subject: [Intel-gfx] [PATCH 2/9] drm/i915/gt: Queue and wait for the
 irq_work item.

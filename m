...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6222BBEA07
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Sep 2019 03:23:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CFE8D6EC4E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 1/2] drm/i915: Introduce async plane update
 to i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 345697B0DDD
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Sep 2023 23:11:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5775A10E0EA;
...
Subject: [Intel-gfx] [PATCH v6 2/4] drm/i915: Introduce the

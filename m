...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B4A661F43FD
	for <lists+intel-gfx@lfdr.de>; Tue,  9 Jun 2020 19:59:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CA046E313;
	Tue,  9 Jun 2020 17:59:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 46BA96E313
 for <intel-gfx@lists.freedesktop.org>; Tue,  9 Jun 2020 17:59:27 +0000 (UTC)
IronPort-SDR: AeX8NJWmAQzQF1NcCq46YzyVnEiShRo/0I72ugMWA2siKrol0R4ihalCbqZbwLlvDlpEspP1qA
 wUtp2bsXyPAg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2020 10:59:26 -0700
IronPort-SDR: FOams4jqVfrawTxazQRjyMyowimCI54os95cu4/QNqP8y3Ko8ggAtx9bVmkAQXkKfJ+2hOvPoR
 H0yBtgo/7fpA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,492,1583222400"; d="scan'208";a="274684993"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 09 Jun 2020 10:59:24 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 09 Jun 2020 20:59:23 +0300
Date: Tue, 9 Jun 2020 20:59:23 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <20200609175923.GU6112@intel.com>
...
In-Reply-To: <20200609174035.GG22647@ideak-desk.fi.intel.com>
...
> > > @@ -2094,6 +2094,8 @@ static int i915_dsc_fec_support_show(struct seq=
_file *m, void *data)
...
> > >  				       &ctx);
> > > @@ -2120,8 +2122,17 @@ static int i915_dsc_fec_support_show(struct se=
q_file *m, void *data)
> > >  		} else if (ret) {
> > >  			break;
> > >  		}
...
> > > @@ -2147,9 +2158,8 @@ static ssize_t i915_dsc_fec_support_write(struc=
t file *file,
> > >  	int ret;
> > >  	struct drm_connector *connector =3D
> > >  		((struct seq_file *)file->private_data)->private;
> > > -	struct intel_encoder *encoder =3D intel_attached_encoder(to_intel_c=
onnector(connector));
...
> > >  	if (len =3D=3D 0)
> > >  		return 0;
> > > @@ -2163,10 +2173,22 @@ static ssize_t i915_dsc_fec_support_write(str=
uct file *file,
> > >  =

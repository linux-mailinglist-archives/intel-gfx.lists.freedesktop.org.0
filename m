...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D29723D9A70
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 02:50:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 855C46EB98;
...
Subject: [Intel-gfx] [PATCH v3 05/14] vfio/samples: Delete useless open/close

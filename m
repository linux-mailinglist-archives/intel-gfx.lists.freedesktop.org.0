...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E061840154E
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Sep 2021 05:50:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4F18899E6;
	Mon,  6 Sep 2021 03:50:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
X-Greylist: delayed 375 seconds by postgrey-1.36 at gabe;
 Mon, 06 Sep 2021 03:50:20 UTC
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 80746899C4
 for <intel-gfx@lists.freedesktop.org>; Mon,  6 Sep 2021 03:50:20 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-3-K_YSW_AjOcWWchGr8RH5bA-1; Sun, 05 Sep 2021 23:44:08 -0400
X-MC-Unique: K_YSW_AjOcWWchGr8RH5bA-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com
 [10.5.11.14])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 5857918BA280;
 Mon,  6 Sep 2021 03:44:07 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 4C9AE5D9DE;
 Mon,  6 Sep 2021 03:44:04 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Mon,  6 Sep 2021 13:43:47 +1000
Message-Id: <20210906034356.2946530-2-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 01/10] drm/i915: move display funcs into a
 display struct.
...
+=09=09dev_priv->display.funcs.audio_codec_enable =3D g4x_audio_codec_enabl=
e;
+=09=09dev_priv->display.funcs.audio_codec_disable =3D g4x_audio_codec_disa=
ble;
...
+=09=09dev_priv->display.funcs.audio_codec_enable =3D ilk_audio_codec_enabl=
e;
+=09=09dev_priv->display.funcs.audio_codec_disable =3D ilk_audio_codec_disa=
ble;
...
+=09=09dev_priv->display.funcs.audio_codec_enable =3D hsw_audio_codec_enabl=
e;
+=09=09dev_priv->display.funcs.audio_codec_disable =3D hsw_audio_codec_disa=
ble;
...
+=09=09dev_priv->display.funcs.modeset_calc_cdclk =3D skl_modeset_calc_cdcl=
k;
...
+=09=09dev_priv->display.funcs.bw_calc_min_cdclk =3D intel_bw_calc_min_cdcl=
k;
+=09=09dev_priv->display.funcs.set_cdclk =3D bdw_set_cdclk;
+=09=09dev_priv->display.funcs.modeset_calc_cdclk =3D bdw_modeset_calc_cdcl=
k;
...
+=09=09dev_priv->display.funcs.modeset_calc_cdclk =3D vlv_modeset_calc_cdcl=
k;
...
+=09=09dev_priv->display.funcs.bw_calc_min_cdclk =3D intel_bw_calc_min_cdcl=
k;
+=09=09dev_priv->display.funcs.modeset_calc_cdclk =3D fixed_modeset_calc_cd=
clk;
 =09}
=20
...
+=09dev_priv->display.funcs.crtc_disable(to_intel_atomic_state(state), crtc=
);
=20
...
_config;
+=09=09dev_priv->display.funcs.commit_modeset_enables =3D skl_commit_modese=
t_enables;
+=09=09dev_priv->display.funcs.get_initial_plane_config =3D skl_get_initial=
_plane_config;
 =09} else {
...
e_config;
+=09=09dev_priv->display.funcs.commit_modeset_enables =3D intel_commit_mode=
set_enables;
+=09=09dev_priv->display.funcs.get_initial_plane_config =3D i9xx_get_initia=
l_plane_config;
 =09}
=20
 }
...
+=09=09dev_priv->display.funcs.fdi_link_train =3D ivb_manual_fdi_link_train=
;
 =09}
 }
...
+=09=09=09=09       dev_priv->display.funcs.get_fifo_size(dev_priv, PLANE_A=
),
...
+=09=09dev_priv->display.funcs.init_clock_gating =3D adlp_init_clock_gating=
;
...
+=09=09dev_priv->display.funcs.init_clock_gating =3D gen12lp_init_clock_gat=
ing;
...
+=09=09dev_priv->display.funcs.init_clock_gating =3D gen6_init_clock_gating=
;
...
+=09=09dev_priv->display.funcs.compute_global_watermarks =3D skl_compute_wm=
;
 =09} else if (HAS_PCH_SPLIT(dev_priv)) {
...
+=09=09dev_priv->display.funcs.compute_intermediate_wm =3D vlv_compute_inte=
rmediate_wm;
+=09=09dev_priv->display.funcs.initial_watermarks =3D vlv_initial_watermark=
s;
+=09=09dev_priv->display.funcs.optimize_watermarks =3D vlv_optimize_waterma=
rks;
+=09=09dev_priv->display.funcs.atomic_update_watermarks =3D vlv_atomic_upda=
te_fifo;
...
+=09=09dev_priv->display.funcs.compute_intermediate_wm =3D g4x_compute_inte=
rmediate_wm;
+=09=09dev_priv->display.funcs.initial_watermarks =3D g4x_initial_watermark=
s;
+=09=09dev_priv->display.funcs.optimize_watermarks =3D g4x_optimize_waterma=
rks;

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id IDbSMQe2wmlolAQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Mar 2026 17:04:23 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59B66318A5B
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Mar 2026 17:04:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2C2810E491;
	Tue, 24 Mar 2026 16:04:21 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=nicolas.frattaroli@collabora.com header.b="eUmvtF0K";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com
 [136.143.188.112])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BDDDA10E751;
 Tue, 24 Mar 2026 16:04:19 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1774368248; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=mwevGsJxZ1jPmXgevtCUoTNnz3hpF2krz00d7qvp7fprfDnKioShwZqxgWOntdo6nz9mKnoqWoMFS+KW94nMtcrJHV3mrzsElffFMs3xusUOibmRbuPoo3vAfJKGL979oJyC91goxEmhDaX2/2ego9nGkeuByYvq4/dbv+6aoMw=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1774368248;
 h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To;
 bh=Q6LewHLgG66mB+cKlrE6Jmde9yR3/vCwSuAKYYuzjYw=; 
 b=EEVSAGaUWe74MUHX5pUN0DJ1i9gSPpdkGK8VBcAxW3fFTlQHHGUus/UlxaCpEyE6ts+6oITD8gaewRTssh2FYyG1WUhBhnbyC9K/Opb7ouLDRsbs9+E8z3TeOUYcHNHn4xCyxeEMBX134tCkxp0n7FPraL6xS3Wo+FkdfhqZnUo=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=nicolas.frattaroli@collabora.com;
 dmarc=pass header.from=<nicolas.frattaroli@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1774368248; 
 s=zohomail; d=collabora.com; i=nicolas.frattaroli@collabora.com;
 h=From:From:Date:Date:Subject:Subject:MIME-Version:Content-Type:Content-Transfer-Encoding:Message-Id:Message-Id:References:In-Reply-To:To:To:Cc:Cc:Reply-To;
 bh=Q6LewHLgG66mB+cKlrE6Jmde9yR3/vCwSuAKYYuzjYw=;
 b=eUmvtF0K4yaStJexpLsNc3sCqWKR4k6Z0a+EB9tWF/b9oyHlQ31b2EBZezQ1XJjm
 ETokSXV7pyNNzUNJzrLa1N+JsQ+JUUo/ArdWfSYDzjYdQ26F7tM5p5MSqJThhYHL5+j
 aSt+wnRYClWyQ6NKe0bphzOzZ/cR4RfTV31Gn5zA=
Received: by mx.zohomail.com with SMTPS id 1774368247242778.9337032422497;
 Tue, 24 Mar 2026 09:04:07 -0700 (PDT)
From: Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
Date: Tue, 24 Mar 2026 17:01:24 +0100
Subject: [PATCH v11 20/22] drm/tests: bridge: Add KUnit tests for bridge
 chain format selection
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260324-color-format-v11-20-605559af4fb4@collabora.com>
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[collabora.com:dkim,collabora.com:email,collabora.com:mid,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,bootlin.com:email]
X-Rspamd-Queue-Id: 59B66318A5B

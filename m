...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 792371D9DC9
	for <lists+intel-gfx@lfdr.de>; Tue, 19 May 2020 19:21:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDE5C6E34E;
	Tue, 19 May 2020 17:21:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6CD286E34E
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 May 2020 17:21:30 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 21231675-1500050 for multiple; Tue, 19 May 2020 18:21:24 +0100
MIME-Version: 1.0
...
References: <20200519145131.2893-1-chris@chris-wilson.co.uk>
 <158990760488.8153.1957849509074612932@build.alporthouse.com>
To: intel-gfx@lists.freedesktop.org
From: Chris Wilson <chris@chris-wilson.co.uk>
Message-ID: <158990888263.8153.644863607940436351@build.alporthouse.com>
User-Agent: alot/0.8.1
Date: Tue, 19 May 2020 18:21:22 +0100

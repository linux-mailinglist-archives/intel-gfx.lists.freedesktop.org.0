...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AA3161076D0
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Nov 2019 18:56:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 008B86E46D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 2/4] drm/rect: Keep the scaled clip bounded

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 92B3D9AE648
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Oct 2024 15:28:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3022210E93D;
	Thu, 24 Oct 2024 13:28:23 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="iUVoFWN4";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 17FBE10E93D;
 Thu, 24 Oct 2024 13:28:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729776502; x=1761312502;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Q8feO2Kapm92BYRr9DQAieKp3g8fPQWhFTMwKsRmESg=;
 b=iUVoFWN4m3dL9aZ19Ro7Bb1dt1rxaxSFtu/HuKFc4k761vb5pMLwoS8y
 6Md8xzc+QBBGoPEGEuplmyzphRH7P5VbYfFzTfreHF3d67XkTzgqg3M/6
 T3XHclgPBUc+jYam8216EwGYkK0TjdLI7AadQVN0EA6too9EVvAN6xm6o
 n5VROH5gOwlnKEycTM8Mj+SQVAiy+QDxv3xLoDA+CDtnBZt0RWdIlRJ5N
 vnbrO96OKLsLE4DmdXZs7ytX+CJVjUeT5u9nHnqeotad3Q14n1FypVDai
 5cOnzSBRfCQ83GsqAp52A1tzILwpMwYHeUNyKzRM4WlCPV5Fiq94qrbIf Q==;
X-CSE-ConnectionGUID: wkBTlUY1QGm4xlC7ML6Z+w==
X-CSE-MsgGUID: 6I3ugprdT0uSAYW5qkAXPA==
X-IronPort-AV: E=McAfee;i="6700,10204,11235"; a="28841271"
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="28841271"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 06:28:21 -0700
X-CSE-ConnectionGUID: v5GiQbE4SrGFm7TvOa3MKw==
X-CSE-MsgGUID: t0veSwMcRG6dAJVU9iNNOg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="118052963"
Received: from unknown (HELO localhost) ([10.237.66.160])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 06:28:19 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: rodrigo.vivi@intel.com,
	jani.nikula@intel.com
Subject: [PATCH v2 07/12] drm/i915/crt: convert to struct intel_display
Date: Thu, 24 Oct 2024 16:27:37 +0300
Message-Id: <afcb03882082644a7c56ef71a5d41967135abecf.1729776384.git.jani.nikula@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 69ED7A98A8F
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Apr 2025 15:11:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B66E310E68E;
	Wed, 23 Apr 2025 13:10:38 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="c/QMJ1tn";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2065610E687;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=FOEX86G++6X2+UGcWbzOD71v8vYgzOLw71VEF4hNaSs=;
 b=c/QMJ1tniyEOAB75jNtepb4qTSBeF1r+aTVwyEDvQyVQhjRABKkKUzUk
 WL8w9PKKRIl0egI//3XiV9+q4WxaBtg5htg33NPEhJ4nsgRTY2/JhCWg6
 +LK0tP6YDY7EXXF+hVtAJdaMZRM6yj6FalLymMdHWD72GzKgC9Bx3NZGo
 wtpy41/HYu9dD+R54yNLcn8Dwnd05/el06bCvVMKWm+ruPhEgKYvWlyhz
 tOTVOFsj5C+u2i+0x7rZeYxH7G2enN8JN+6fy3GLLkyaguJbD0P2reb/0
 MZA/FxeAn/d5C260+77XM+DnFvj2fVplA5lJRRWea8rtsZy9rnKbAcD8P A==;
X-CSE-ConnectionGUID: L1fUOaG2S9Kr7soPsuqsXw==
X-CSE-MsgGUID: Jb6zYq4KTBmO/eEDyt1EvA==
X-IronPort-AV: E=McAfee;i="6700,10204,11412"; a="47185228"
X-IronPort-AV: E=Sophos;i="6.15,233,1739865600"; d="scan'208";a="47185228"
Received: from fmviesa009.fm.intel.com ([10.60.135.149])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2025 06:08:22 -0700
X-CSE-ConnectionGUID: lK7vMa/zQdmDT6EeoWYYaA==
X-CSE-MsgGUID: aG2ajtQ+THyrTXO0xjn0dQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,233,1739865600"; d="scan'208";a="133196422"
Received: from srr4-3-linux-106-armuthy.iind.intel.com ([10.190.238.56])
 by fmviesa009.fm.intel.com with ESMTP; 23 Apr 2025 06:08:04 -0700
From: Arun R Murthy <arun.r.murthy@intel.com>
Date: Wed, 23 Apr 2025 18:23:34 +0530
Subject: [PATCH v5 2/2] drm/i915/display: move min_hblank from dp_mst.c to dp.c
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20250423-hblank-v5-2-6bee618bc979@intel.com>

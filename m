...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 251B717A502
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Mar 2020 13:15:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6673B6E2E2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RESEND PATCH v2 0/7] drm: drm_fb_helper cleanup.

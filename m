...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A6EC31A952A
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Apr 2020 09:53:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9B6136E8F5;
...
Subject: Re: [Intel-gfx] [PATCH 58/59] drm/ast: Drop explicit connector
 register/unregister
...
Content-Type: multipart/mixed; boundary="===============0723521189=="

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5957B5B2AF3
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 02:16:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE57B10E877;
...
Subject: [Intel-gfx] [PATCH v4 03/15] mei: adjust extended header kdocs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E55A7662FB
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jul 2023 06:16:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFDF410E659;
	Fri, 28 Jul 2023 04:16:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8F92710E651;
 Fri, 28 Jul 2023 04:16:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690517760; x=1722053760;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=gpCnjmNhqFltnLFJpnNwlbopLz1FNw26R9CJGBs2V94=;
 b=UXQl9lgk9ngZhjZ5BYF6xFXdHIaKqcmDUmqtTvDJnlsN5w62vct8hxtN
 3G8j8Ch49unSYsz7ECk6fZvLyBHQrsN25w1RZodMgUtPD6J3nVyjc3Wag
 NJ/9h3Pz9uXHL5CZUFxkKRf7t7xsbx7GCA0Y2Fd3H/kLkG3fnvpzTWNEC
 W52BmV064PNJPTP5EWjgnw99WJtTt1nOiIdC5gezCC1lqjMs0B2a1IKPm
 HIgy2g0UVeBWTXikmnHzJgrsIRQr/7ZK6hBKn+aEUwmVG7KgjN6kSpgxy
 woZMtGf1dYVZfUEKPtd85VZyng3W4TFTRxJBc1lmF5GvA6/XR9CRPEN/y Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="348104209"
X-IronPort-AV: E=Sophos;i="6.01,236,1684825200"; d="scan'208";a="348104209"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jul 2023 21:16:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10784"; a="797276476"
X-IronPort-AV: E=Sophos;i="6.01,236,1684825200"; d="scan'208";a="797276476"
...
Date: Fri, 28 Jul 2023 09:41:47 +0530
Message-Id: <20230728041150.2524032-18-ankit.k.nautiyal@intel.com>
...
Subject: [Intel-gfx] [PATCH 17/20] drm/i915/dp: Get optimal link config to
...
+
 ...
 {
@@ -1747,52 +1972,55 @@ static int intel_dp_dsc_compute_pipe_bpp(struct intel_dp *intel_dp,
 					 struct link_config_limits *limits,
 					 int timeslots)
 {
-	const struct drm_display_mode *adjusted_mode = &pipe_config->hw.adjusted_mode;

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6AB6672A9A3
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Jun 2023 09:01:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3249110E17C;
	Sat, 10 Jun 2023 07:01:37 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5] drm/i915: avoid flush_scheduled_work()
 usage

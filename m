...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D8632C656B
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7957E6ED6B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 138/162] drm/i915/dg1: Eliminate eviction
 mutex

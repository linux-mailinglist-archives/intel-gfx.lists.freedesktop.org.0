...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D94AE6D1A6
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jul 2019 18:15:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 761EA6E432;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 FRLA==
Subject: [Intel-gfx] [PATCH v1 01/11] drm/panel: make drm_panel.h
 self-contained

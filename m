...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8186B3A5EE9
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Jun 2021 11:10:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94E9A89826;
	Mon, 14 Jun 2021 09:10:12 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2] drm/i915: Document the Virtual Engine uAPI

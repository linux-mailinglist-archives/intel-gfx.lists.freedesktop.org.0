...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A60D57826DE
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Aug 2023 12:15:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5740110E232;
	Mon, 21 Aug 2023 10:15:23 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 3/3] drm/i915: Remove the contiguous computation
 and trim

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25AC42D5EFD
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 16:06:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06B4C6E536;
	Thu, 10 Dec 2020 15:06:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4F4B06E536
 for <intel-gfx@lists.freedesktop.org>; Thu, 10 Dec 2020 15:06:56 +0000 (UTC)
IronPort-SDR: ndm4dLSCxjbJ3tGEusVACZL+kEap3YzZGAftWwQdCUAwfBUBlAUuoYGSngaWKShR0KSdryZEB3
 CskTU1Jhvd6g==
X-IronPort-AV: E=McAfee;i="6000,8403,9830"; a="170759685"
X-IronPort-AV: E=Sophos;i="5.78,408,1599548400"; d="scan'208";a="170759685"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2020 07:06:54 -0800
IronPort-SDR: QhZhnZ/HxAZCM3ItH+zNjLUFiTCRQPkA2BLZZGmHJfWQPjVn/yRKTKKXBJsG1Z5rBtYUPDFYIW
 2FpajEIgoeRA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,408,1599548400"; d="scan'208";a="375947550"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga007.jf.intel.com with SMTP; 10 Dec 2020 07:06:52 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 10 Dec 2020 17:06:51 +0200
Date: Thu, 10 Dec 2020 17:06:51 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Dave Airlie <airlied@gmail.com>
Message-ID: <X9I5i9wY/NkhkBD6@intel.com>
References: <20201210041755.29088-1-airlied@gmail.com>
 <20201210041755.29088-5-airlied@gmail.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20201210041755.29088-5-airlied@gmail.com>
...
> @@ -137,16 +137,6 @@ static const u64 i9xx_format_modifiers[] =3D {
>  	DRM_FORMAT_MOD_INVALID
>  };
>  =
...
> @@ -2528,9 +2518,9 @@ static u32 intel_compute_aligned_offset(struct drm_=
...
> @@ -3267,7 +3257,7 @@ intel_plane_remap_gtt(struct intel_plane_state *pla=
ne_state)
>  	}
>  }
>  =
...
> @@ -11536,569 +11526,6 @@ static bool intel_crtc_get_pipe_config(struct i=
...
> @@ -16609,7 +16036,7 @@ static void add_rps_boost_after_vblank(struct drm=
_crtc *crtc,
...
>  	struct intel_plane *plane =3D to_intel_plane(plane_state->uapi.plane);
>  	struct drm_i915_private *dev_priv =3D to_i915(plane->base.dev);
> @@ -16639,7 +16066,7 @@ static int intel_plane_pin_fb(struct intel_plane_=
state *plane_state)
>  	return 0;
>  }
>  =
...
> @@ -16875,13 +16302,6 @@ static bool i965_plane_format_mod_supported(stru=
ct drm_plane *_plane,
>  	}
>  }
>  =
...
>  	.disable_plane =3D drm_atomic_helper_disable_plane,
> @@ -16900,142 +16320,6 @@ static const struct drm_plane_funcs i8xx_plane_=
funcs =3D {
...
>  {
> @@ -17187,74 +16471,6 @@ intel_primary_plane_create(struct drm_i915_priva=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB4C649C684
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jan 2022 10:40:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C080E10E842;
...
Subject: [Intel-gfx] [PATCH v2 08/11] drm/gem: Sort includes alphabetically

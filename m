...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A6DF4708F33
	for <lists+intel-gfx@lfdr.de>; Fri, 19 May 2023 07:10:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0893B10E5C3;
...
Subject: [Intel-gfx] [PATCH v10 1/2] drm/i915/mtl: end support for set
 caching ioctl

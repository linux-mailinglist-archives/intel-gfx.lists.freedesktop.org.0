...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 076C33002E3
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Jan 2021 13:29:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1FC5A6E9E4;
	Fri, 22 Jan 2021 12:29:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0D4626E9E3
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 Jan 2021 12:29:08 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23670788-1500050 
 for <intel-gfx@lists.freedesktop.org>; Fri, 22 Jan 2021 12:29:04 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 22 Jan 2021 12:29:02 +0000
Message-Id: <20210122122903.23893-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 8/9] drm/i915: Track context current active time
...
index f5bf3a164563..8d1cdf987074 100644
...
index 3e680bfa9d13..ae8159ffd665 100644
--- a/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
@@ -600,9 +600,8 @@ static void __execlists_schedule_out(struct i915_request * const rq,
...
@@ -1741,6 +1740,9 @@ static void new_timeslice(struct intel_engine_execlists *el)
 {
...
index 45fcc4ef27e7..5c5ba90e2f8e 100644
...
index 9b72a431b351..0f49fb5499d6 100644
--- a/drivers/gpu/drm/i915/i915_gpu_error.c
+++ b/drivers/gpu/drm/i915/i915_gpu_error.c
@@ -1288,8 +1288,8 @@ static bool record_context(struct i915_gem_context_coredump *e,

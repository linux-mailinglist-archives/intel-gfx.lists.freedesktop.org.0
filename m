...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E42BF77D419
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Aug 2023 22:29:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5C5710E297;
	Tue, 15 Aug 2023 20:29:24 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915/pxp/mtl: Update pxp-firmware
 packet size

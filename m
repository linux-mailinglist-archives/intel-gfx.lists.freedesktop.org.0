...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F1012E904F
	for <lists+intel-gfx@lfdr.de>; Mon,  4 Jan 2021 07:01:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B89D48969E;
	Mon,  4 Jan 2021 06:01:39 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DE7D489561
 for <Intel-gfx@lists.freedesktop.org>; Mon,  4 Jan 2021 06:01:36 +0000 (UTC)
IronPort-SDR: EIfkzsgTGcUa0ZbyWSeh8z1cp/NhmgUhk0hDTKRnUlEO8NrDhxjGHUdj+rFev/linJzfxZnc8S
 R6/H2gB9ocWA==
X-IronPort-AV: E=McAfee;i="6000,8403,9853"; a="176135362"
X-IronPort-AV: E=Sophos;i="5.78,473,1599548400"; d="scan'208";a="176135362"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jan 2021 22:01:36 -0800
IronPort-SDR: hCearDfrQdAOchysTevZiAbOLDAbshzaARIFSAfkEtQ4SDayfqyzOT2bOw4EZIN1KiwpUApon1
 UlyofC0LUT+A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,473,1599548400"; d="scan'208";a="461826923"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga001.fm.intel.com with ESMTP; 03 Jan 2021 22:01:35 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Sun,  3 Jan 2021 22:01:29 -0800
Message-Id: <20210104060135.3076-8-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210104060135.3076-1-sean.z.huang@intel.com>
References: <20210104060135.3076-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v18 07/13] drm/i915/pxp: Destroy arb session upon
 teardown

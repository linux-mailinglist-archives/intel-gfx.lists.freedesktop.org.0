...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 400983E1601
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Aug 2021 15:49:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0B0A6EA6F;
...
Subject: Re: [Intel-gfx] [PATCH v5 05/20] drm/sched: drop entity parameter
 from drm_sched_push_job

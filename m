...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9A742E8ACA
	for <lists+intel-gfx@lfdr.de>; Sun,  3 Jan 2021 06:41:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B842789AE6;
	Sun,  3 Jan 2021 05:41:40 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DE9B089A74
 for <Intel-gfx@lists.freedesktop.org>; Sun,  3 Jan 2021 05:41:36 +0000 (UTC)
IronPort-SDR: sewAOINhG7n2sAgm7+/ooX+VeojkYhq/TI5XTuotFYMuUuV672bK11FCZr2Uf+BTsqDb+OMpe9
 iBPzUWFMmYOQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9852"; a="163916491"
X-IronPort-AV: E=Sophos;i="5.78,471,1599548400"; d="scan'208";a="163916491"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jan 2021 21:41:34 -0800
IronPort-SDR: KE4MU1yAfeLBtiPePx+xaGy6NYrPtXO/xIB0IoDrHaZAC09H5P/Ggs+S2UWYSU13M59o5zOzBm
 i306TjMOcfuw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,471,1599548400"; d="scan'208";a="461562834"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga001.fm.intel.com with ESMTP; 02 Jan 2021 21:41:34 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Sat,  2 Jan 2021 21:41:27 -0800
Message-Id: <20210103054134.10148-7-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210103054134.10148-1-sean.z.huang@intel.com>
References: <20210103054134.10148-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v17 06/13] drm/i915/pxp: Enable PXP irq worker and
 callback stub

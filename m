...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 588B0695CE1
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Feb 2023 09:26:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F25F310E809;
...
Subject: Re: [Intel-gfx] [PATCH v3 12/15] vfio: Make vfio_device_open()

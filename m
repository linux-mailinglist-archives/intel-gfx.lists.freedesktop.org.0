...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A87BB8183EB
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Dec 2023 09:55:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E09510E448;
	Tue, 19 Dec 2023 08:55:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8C5B610E435
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 Dec 2023 08:55:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702976144; x=1734512144;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=2q0SY4O4+O9/3L/4WfIT/nZ6+7lnC7lKfUtPIp+s1mU=;
 b=i/lNAKvrNO0LR/8u3UUfyjnX4Yhe8pgwegWJyKERxtnn0Zg/ZdldNTB1
 nr2yXybx7gq7wIg7PeqpDOzlobAjOCSwqTqmRrBN94axmi67ab8THsoU2
 AYSCtCGtdGECXSfljIe15LGupKcra+aP6Ydrd33fD9ACV865+eb0w1Grj
 WinCW8k47LfSFX3/IYLzefxDfFgFxP8uVJ+fO7v9iQmtwz7OfTZpsvA8L
 ZxEjv70+mRTLnUQalZwNuAYFNaBHAkWMx2sbXC139iOwTFMyPDGSU/sW4
 dVgRh+flouUFhSYxAeU4F9UOcAt6XiVZtvkO6Dxmd7tgE9Q6T1ZGwgrHJ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="399462043"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="399462043"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Dec 2023 00:55:44 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="846272357"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="846272357"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmsmga004.fm.intel.com with ESMTP; 19 Dec 2023 00:55:42 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH 2/3] drm/i915/dp: Add Read/Write support for Adaptive Sync SDP
Date: Tue, 19 Dec 2023 14:21:03 +0530
Message-Id: <20231219085104.1211388-3-mitulkumar.ajitkumar.golani@intel.com>

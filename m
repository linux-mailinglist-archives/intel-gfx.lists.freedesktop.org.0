...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id QDeOO/oXr2nHNgIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Mar 2026 19:56:58 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EA8B23EF27
	for <lists+intel-gfx@lfdr.de>; Mon, 09 Mar 2026 19:56:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1959E10E593;
...
Received: from mail-ot1-f53.google.com (mail-ot1-f53.google.com
 [209.85.210.53])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 746D810E2E6
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Mar 2026 01:51:04 +0000 (UTC)
Received: by mail-ot1-f53.google.com with SMTP id
 46e09a7af769-7d4ba9abbecso10273088a34.1
 for <intel-gfx@lists.freedesktop.org>; Thu, 05 Mar 2026 17:51:04 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=F0rsOoswj5eD7nQPQpmkp6jfLbhrwTpwHV3qnnV31B8=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCV7PJHo1Omfl2JCTrjpsL/ad1q1BUbsvuBTFZX/hb7aCzIsOCkTvQ7txWoQBAvDg7VzwB7amcIHbLA=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YycvzWqlbz6a1b2PLZF5zz+pr2gnsHBbfaUxxCxJt4R2o0EUl87
 qvfDhIjNPvdZ5sY7MP6jUUlj4n+0DiltkNDD0HSvEZSg3Sn6V+UgIQsu
X-Gm-Gg: 
...
X-Spamd-Result: default: False [1.69 / 15.00];
	...
	FORGED_RECIPIENTS(0.00)[m:linux-kernel@vger.kernel.org,m:dri-devel@lists.freedesktop.org,m:amd-gfx@lists.freedesktop.org,m:intel-gvt-dev@lists.freedesktop.org,m:jim.cromie@gmail.com,m:mst@redhat.com,m:jasowang@redhat.com,m:xuanzhuo@linux.alibaba.com,m:eperezma@redhat.com,m:sumit.semwal@linaro.org,m:christian.koenig@amd.com,m:virtualization@lists.linux.dev,m:linux-media@vger.kernel.org,m:linaro-mm-sig@lists.linaro.org,m:jimcromie@gmail.com,s:lists@lfdr.de];
	MIME_TRACE(0.00)[0:+];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,drm-misc-fixes-2026-02-26-80-g9a2f253ad689:email]

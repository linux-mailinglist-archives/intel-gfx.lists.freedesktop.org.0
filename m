...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DC63E568A7
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jun 2019 14:23:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C5416E3C6;
	Wed, 26 Jun 2019 12:23:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x443.google.com (mail-wr1-x443.google.com
 [IPv6:2a00:1450:4864:20::443])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 47F406E3C6;
 Wed, 26 Jun 2019 12:23:17 +0000 (UTC)
Received: by mail-wr1-x443.google.com with SMTP id v14so2508809wrr.4;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 b=
X-Gm-Message-State: APjAAAWvSAe6Bfm2kMobTkmMbh3J4lI19Peu++YF6LT8eREa86J9BzQF
 FaF0DY608MR5YT6O7EDuYXMGdz19
X-Google-Smtp-Source: APXvYqz8+ZObApzQQg9mOLTq1VTZRQH50YSclCsmpVqdcIzkkyvDsVgZfKJh7Xn96ExRkLxPN40b7g==
X-Received: by 2002:adf:fc85:: with SMTP id g5mr3461150wrr.324.1561551795492; 
 Wed, 26 Jun 2019 05:23:15 -0700 (PDT)
Received: from abel.fritz.box ([2a02:908:1252:fb60:902c:2dc9:c30e:db03])
 by smtp.gmail.com with ESMTPSA id k125sm2262018wmf.41.2019.06.26.05.23.14
...
Date: Wed, 26 Jun 2019 14:23:09 +0200
Message-Id: <20190626122310.1498-5-christian.koenig@amd.com>
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=c2Uc2vlzqpmxAEq67xv8n5bep8psXbI3CgHMnA1wD20=;
 b=

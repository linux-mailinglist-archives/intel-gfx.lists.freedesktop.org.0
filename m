...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 29A5067B1F8
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 12:49:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6BE910E7B4;
	Wed, 25 Jan 2023 11:49:29 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 8/9] drm/display/dp_mst: Add a helper to verify
 the MST payload state

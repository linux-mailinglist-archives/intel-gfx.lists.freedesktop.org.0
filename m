...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 62BE44B6EAD
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Feb 2022 15:17:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8517910E61E;
...
Subject: [Intel-gfx] [PATCH V3 12/13] media: wl128x: use

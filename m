...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CC122139FE
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jul 2020 14:22:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AC476EB76;
	Fri,  3 Jul 2020 12:22:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8B9886EB55
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 Jul 2020 12:22:27 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 Jul 2020 14:22:12 +0200
Message-Id: <20200703122221.591656-15-maarten.lankhorst@linux.intel.com>
...
---
 ...
 26 files changed, 216 insertions(+), 136 deletions(-)

diff --git a/drivers/gpu/drm/i915/display/intel_display.c b/drivers/gpu/drm/i915/display/intel_display.c
index 3c8053480dfe..a317318174ca 100644
...
index c01fc27c34c0..855452a413e5 100644
--- a/drivers/gpu/drm/i915/gem/i915_gem_context.c
+++ b/drivers/gpu/drm/i915/gem/i915_gem_context.c
@@ -1140,7 +1140,7 @@ static int context_barrier_task(struct i915_gem_context *ctx,
...
@@ -1233,7 +1233,7 @@ static int pin_ppgtt_update(struct intel_context *ce, struct i915_gem_ww_ctx *ww
...
index 5764e72a9d26..6296c60b4242 100644
...
+	err = i915_vma_pin_ww(vma, &eb->ww,
 	...
 	if (err)
@@ -1108,9 +1109,10 @@ static void *reloc_kmap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	void *vaddr;
@@ -1132,10 +1134,13 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 		if (err)
 			return ERR_PTR(err);
...
@@ -1171,9 +1176,10 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	if (cache->page == page) {
@@ -1181,7 +1187,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 	} else {
 		vaddr = NULL;
...
@@ -1268,7 +1274,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 		goto err_unmap;
 	}
...
@@ -1505,8 +1511,7 @@ relocate_entry(struct i915_vma *vma,
 		void *vaddr;
...
@@ -1922,6 +1927,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2204,7 +2210,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2215,7 +2222,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2365,16 +2372,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2402,7 +2426,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2414,7 +2438,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2427,19 +2451,34 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2594,7 +2633,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -3017,33 +3056,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -3052,7 +3065,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
+		goto err_vma;
 	...
 	if (in_fence) {
@@ -3114,9 +3127,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	}
...
-		i915_vma_unpin(batch);
 err_vma:
 	...
 	if (eb.trampoline)
@@ -3200,7 +3210,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3278,8 +3290,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index bc08c02b5767..1df5bf73a4cb 100644
...
@@ -138,7 +138,7 @@ static int igt_gpu_reloc(void *arg)
...
index 2c2e88d49f3e..cb2ae5542174 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1778,11 +1778,18 @@ static inline void i915_gem_drain_workqueue(struct drm_i915_private *i915)
 }
...
index f4e22e256ac6..3497a4f1c98a 100644

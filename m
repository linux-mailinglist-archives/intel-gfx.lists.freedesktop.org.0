...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C94E1732C
	for <lists+intel-gfx@lfdr.de>; Wed,  8 May 2019 10:08:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A17A5893AB;
	Wed,  8 May 2019 08:07:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 76FC0893C9
 for <intel-gfx@lists.freedesktop.org>; Wed,  8 May 2019 08:07:47 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16485916-1500050 
 for multiple; Wed, 08 May 2019 09:07:09 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  8 May 2019 09:06:40 +0100
Message-Id: <20190508080704.24223-16-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 16/40] drm/i915: Extend execution fence to
 support a callback
...
OTE1L2k5MTVfcmVxdWVzdC5jCmluZGV4IDNiZWNlZDdkYWExNS4uMTE4OGE0NTA4MDRmIDEwMDY0
...
CiAJfSBlbHNlIHsKQEAgLTg0NSw3ICs4NzMsNyBAQCBlbWl0X3NlbWFwaG9yZV93YWl0KHN0cnVj
...
cmV0dXJuIGVycjsKIApAQCAtOTcxLDYgKzk5OSw1MiBAQCBpOTE1X3JlcXVlc3RfYXdhaXRfZG1h

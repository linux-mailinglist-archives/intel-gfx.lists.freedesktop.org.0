...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D929BC5515
	for <lists+intel-gfx@lfdr.de>; Wed, 08 Oct 2025 15:53:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C568610E063;
	Wed,  8 Oct 2025 13:53:51 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="F9eIGADc";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 133A610E063;
 Wed,  8 Oct 2025 13:53:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1759931631; x=1791467631;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=ux3nwNDCEDiORfaH1+6v54YgfxvXqyFZcj5xqr0c7so=;
 b=F9eIGADcnmIj/aqW5/XSIGQPJ//763kW2HKI09d7cvPi+S+s61Wq4S7+
 9QZyKpEuNMUoI5nUY9AfDIRl2sj8jHYAGJEn5SMtrfBtUw+oxoJChO3eu
 +6tznP37CThawOyJ0ILsQgDWWHG6ORbSQWZ52+4qDEJU8uZ0eIZithYtz
 NbgkyeqZIsNEFcL/MvQ+hkdYk03DRghNPAnAhUVg4qT0baIT8zdHzGdgU
 LtzjSMINTdx2sxQbz1HHsABpS+dRTTKd8UOErgwLmdI2WzeLE2WzeiaSo
 gfWiDcPBhwJYOXJ4C75wWzilOs4ZPF0sDabD1GjnsF+LwhfETH/DmsAhK A==;
X-CSE-ConnectionGUID: CpD0RND7ScetTwd46zZbyA==
X-CSE-MsgGUID: wd7IWOAtTw2RHyiITVVl4w==
X-IronPort-AV: E=McAfee;i="6800,10657,11576"; a="62287730"
X-IronPort-AV: E=Sophos;i="6.19,213,1754982000"; d="scan'208";a="62287730"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Oct 2025 06:53:50 -0700
X-CSE-ConnectionGUID: 954YM5ckTlqInSlzzORw9A==
X-CSE-MsgGUID: Glni/AThQK2K5icjKlaewg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,213,1754982000"; d="scan'208";a="180110422"
Received: from hrotuna-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.245.246.39])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Oct 2025 06:53:48 -0700
...
Subject: [PATCH] drm/{i915, xe}/display: pass parent interface to display probe
Date: Wed,  8 Oct 2025 16:53:44 +0300
Message-ID: <20251008135344.773326-1-jani.nikula@intel.com>

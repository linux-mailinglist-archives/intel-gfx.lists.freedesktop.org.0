...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E0D3407253
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 22:11:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 69A796EABC;
	Fri, 10 Sep 2021 20:10:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 5/6] drm/i915/uncore: Drop gen11 mmio read
 handlers

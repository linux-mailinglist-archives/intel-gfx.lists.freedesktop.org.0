...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A3E4A20FEDB
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:29:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BE3C6E32A;
	Tue, 30 Jun 2020 21:28:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6201A6E317;
 Tue, 30 Jun 2020 21:28:42 +0000 (UTC)
IronPort-SDR: yfyK5uOfHKIf7XE1/eyjfazIT2aK8eof+QOMwFztrsnhXKIq1okS3q2Vh7A47Gcovc0g6jl55J
 Fc0NHgiOxB6A==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="144554731"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="144554731"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2020 14:28:42 -0700
IronPort-SDR: Rp9zbeP2w+ta18Ws+K0O5V8zDCNUEES+YEkivh7WxxTnQW5hNj3ziF+Gz50PBb5tlvW0yiYehN
 tKelhHFFMjwQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="481066686"
...
Date: Tue, 30 Jun 2020 14:27:31 -0700
Message-Id: <1593552491-23698-20-git-send-email-anitha.chrisanthus@intel.com>
X-Mailer: git-send-email 2.7.4
In-Reply-To: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
References: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
Subject: [Intel-gfx] [PATCH 19/59] drm/kmb: Added ioremap/iounmap for
 register access

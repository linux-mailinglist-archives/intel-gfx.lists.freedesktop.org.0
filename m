...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 87F40C32E82
	for <lists+intel-gfx@lfdr.de>; Tue, 04 Nov 2025 21:29:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F418B10E670;
	Tue,  4 Nov 2025 20:29:30 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=daniel.almeida@collabora.com header.b="Dd8zVtfX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com
 [136.143.188.112])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E6B1510E326;
 Tue,  4 Nov 2025 20:29:28 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1762288166; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=cbq2mtTap3C16PZKzL82PSJh3VCI6FSVCDE6SwgLP/ISPuGr/+feyYQDf7cxjLXoR5ThDXbsubGOw1zPE7e4FT7yMwKwROEuLediUV4fiktWcDrM93i9D4aFVamhQkUscSKIdRdHsHOA1OTNDkTMrmlxEykNtPJKo5m7Rat9bBE=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1762288166;
 h=Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To;
 bh=loFCezPOQiLauiVe9nlAXAEX/t4O3DqZ56PAX5dn0Oo=; 
 b=haDUUjXhoCmoWTC6eVzTW0qR7Z9wO6iH1TOEG5mdVCZ7p1IPumxJC9Qjrodljp99a736U/OrwX+nWJMtCYZX5yvJV56TGVMZEq0Hgp/pKaZiRObcr6aDygxm4sZO/ty2CXKdvKs4DRkULNWQPJuL3o18SkspNaNY+kSI2PbDCBE=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=daniel.almeida@collabora.com;
 dmarc=pass header.from=<daniel.almeida@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1762288166; 
 s=zohomail; d=collabora.com; i=daniel.almeida@collabora.com;
 h=From:From:To:To:Cc:Cc:Subject:Subject:Date:Date:Message-ID:In-Reply-To:References:MIME-Version:Content-Transfer-Encoding:Message-Id:Reply-To;
 bh=loFCezPOQiLauiVe9nlAXAEX/t4O3DqZ56PAX5dn0Oo=;
 b=Dd8zVtfXJP+UPmrxPhj+yI+ojuVL7sAxJHTL7jdmsBsBMWZeioThvAvk1r27Q96P
 ZAsxWn6TjN/AT9jd2G9erxqaaKtSSAKzO1WuQBMLFS7e+Z2dx4IIuZSgW9Qr97HRYhS
 SVtSofwRWbDmoXW15lWesxzGXIeGtDJmcLJWQ9K0=
Received: by mx.zohomail.com with SMTPS id 1762288165447140.40674932227023;
 Tue, 4 Nov 2025 12:29:25 -0800 (PST)
...
Subject: [PATCH i-g-t v3 3/3] tests/panthor: add panthor tests
Date: Tue,  4 Nov 2025 17:28:43 -0300
Message-ID: <20251104202845.2879460-4-daniel.almeida@collabora.com>

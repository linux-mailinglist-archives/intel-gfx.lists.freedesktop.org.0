...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 569412EB6E4
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Jan 2021 01:29:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9F3689C63;
	Wed,  6 Jan 2021 00:29:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 364F889C63
 for <intel-gfx@lists.freedesktop.org>; Wed,  6 Jan 2021 00:29:40 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23512886-1500050 
 for multiple; Wed, 06 Jan 2021 00:29:31 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  6 Jan 2021 00:29:29 +0000
Message-Id: <20210106002929.5555-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20210104115145.24460-6-chris@chris-wilson.co.uk>
References: <20210104115145.24460-6-chris@chris-wilson.co.uk>
MIME-Version: 1.0

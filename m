...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04D39C97951
	for <lists+intel-gfx@lfdr.de>; Mon, 01 Dec 2025 14:25:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 81DD810E3DA;
	Mon,  1 Dec 2025 13:25:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="OWZ9dPbB";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1B90A10E3DA;
 Mon,  1 Dec 2025 13:25:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764595512; x=1796131512;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=uZezOW5GxDQPwSZmx/3LP4Rq71iBuWG1pQaHZGgZRBQ=;
 b=OWZ9dPbBn/1cbqRKWgJWVFixYF7FDdKcJLSq+FUr+s3CO3TxRIQXVPQ7
 Vejm1zsBCwWHKU16UzeTYL9zIHKSLyU9j3XKgUTJPoYoK11YBGcV9tlJY
 6PgGu9dD3xJXq9H9dn6rnrpauoO3gPXHeAaf4sq2Iv1+l1E0EqGuHXRK6
 RAyJyD/ktbEJcfbkA+J53mPDWSxTRbYOqaJSAgabvmTH3qjXNacgli0EH
 4WqzL/7fGZ2PmuGGXFVo1NXeqVIP5fpmbY5vzZ4Xyrx1gpQH5hat7K3Wd
 PPJQFMUI/cMp2xaqE6Lynbz6zepCt2mHdaCdrfDW1ktjwhsRG9Not2vDU g==;
X-CSE-ConnectionGUID: GY/C5cB4SQamimbInmDNPw==
X-CSE-MsgGUID: l4jGvmULTG2rYDBIIleiBA==
X-IronPort-AV: E=McAfee;i="6800,10657,11629"; a="70394311"
X-IronPort-AV: E=Sophos;i="6.20,240,1758610800"; d="scan'208";a="70394311"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Dec 2025 05:25:12 -0800
X-CSE-ConnectionGUID: OxFTt9ntTJaRyX7OuS6xZA==
X-CSE-MsgGUID: 9Ddk2bJ9Svy8Yk/F0VIQIQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,240,1758610800"; d="scan'208";a="225055511"
...
Subject: [PATCH v3 2/3] drm/i915/psr: Perform full frame update on async flip
Date: Mon,  1 Dec 2025 15:24:56 +0200
Message-ID: <20251201132457.624358-3-jouni.hogander@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB6F2399979
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jun 2021 06:58:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D41CB6F3AD;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 01/20] drm/i915/guc: skip disabling CTBs before
 sanitizing the GuC

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A28E46F1160
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 07:38:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB41710EC4C;
	Fri, 28 Apr 2023 05:38:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C846C10EC3C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=hZEgkGMTGu5ya0wt2bmAVtHrz82+APdTDs4gKd/eR256dY0tDjKjDmjy
 DwLqGgDdOCT53HnSWjYitjnONmll3ky6edEcgGULM1GxQnWNhIZYezZyc
 9JebPPZtqI/WQI0ZmsaJdcJ0Ni16lRr3Rgfz1OPgKWXxo6DasIEJM1esX
 sWBQSuESnN7gQogHJu7zlzf+JqtQWaoSaYbWX58r62yo4x/QpXoH4G8A1
 dsEYFs+UjjyZ8/eJcZEUUuslOMh/bQJTp91v8Qi/mYkrQ1/Fs1LQjeGx0
 0S+YpBm9tpBq8Mc+MV8UZDCPGnSJGKp9Jra9qTEUIBxnGYTQ0qQHlhhcZ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="345109199"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="345109199"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:38:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="838731998"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="838731998"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:38:13 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Apr 2023 22:39:16 -0700
Message-Id: <20230428053917.1765521-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915: use pat_index instead of
 cache_level

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 38D9029C8DE
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Oct 2020 20:28:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB07B6EC22;
	Tue, 27 Oct 2020 19:28:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD1986EC24
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Oct 2020 19:28:47 +0000 (UTC)
IronPort-SDR: MRqBN0uavVAtsuAsmTf00I4ghtZfyOYBsAWp1LcHkMDKSbMTgE0LCjdnqvxou0GyFiauWTcGdK
 DQi2Dw23Zvtg==
X-IronPort-AV: E=McAfee;i="6000,8403,9787"; a="147433130"
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="147433130"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2020 12:28:47 -0700
IronPort-SDR: Bwjj6rYq4kx1L1Fs7QUL6+Z3VuO1d/yaIiRS+JdsNmRkMc+EnoAAZXBAp6cYEN3LpHHGzl570x
 jvTCpNwEUGgw==
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="318338892"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 27 Oct 2020 12:28:46 -0700
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 27 Oct 2020 12:30:34 -0700
Message-Id: <20201027193034.28721-6-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/5] drm/i915/dp: Allow big joiner modes in
...
@@ -17779,7 +17780,7 @@ intel_mode_valid_max_plane_size(struct drm_i915_private *dev_priv,
 	 * too big for that.
 	 */

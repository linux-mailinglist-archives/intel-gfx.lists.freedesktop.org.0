...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FBA643048E
	for <lists+intel-gfx@lfdr.de>; Sat, 16 Oct 2021 21:18:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 58C0A6E4D2;
...
Subject: [Intel-gfx] [PATCH v2 07/13] drm/msm: replace

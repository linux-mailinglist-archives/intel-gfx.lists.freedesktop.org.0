...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0064065358D
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Dec 2022 18:46:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5158010E12E;
	Wed, 21 Dec 2022 17:46:15 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 1/1] drm/i915/pxp: Use drm_dbg if arb session

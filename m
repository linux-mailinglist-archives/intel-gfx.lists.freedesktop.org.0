...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17CBE7E0A23
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Nov 2023 21:19:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A4C110EAA9;
...
Subject: [Intel-gfx] [PATCH v4 11/16] drm/i915/dsi: Extract common

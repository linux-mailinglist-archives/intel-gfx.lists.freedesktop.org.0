...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OK4vJt3alWn3VQIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Feb 2026 16:29:33 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A3E61576C0
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Feb 2026 16:29:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D7D4010E5F9;
	Wed, 18 Feb 2026 15:29:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="JOn/iuub";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C2DCF10E5FA;
 Wed, 18 Feb 2026 15:29:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1771428571; x=1802964571;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=yOabKG/OufkZ0XrRYrwVF5KhSIVejFwDkGxjZBc4S0c=;
 b=JOn/iuubfhkNZaEBV0cemzAyRNZ2VlQatH/zL5Kow0ITa6TGTW1J0q1D
 jk9ZO9HA3J9G5pvsOHof9JR0lW4jtyF0jhTTen70LITz/CvZ+6JTI1BoG
 NW6G61663ZoeZIy9rbj0XN8eBYrdsq06/qgs0HXYjWhaN3xO1gf+q+ww4
 pHSwfgN+Gu/A6pnIdM5O/laalYntiuDZrvofrAeFx90sBMBhuzcXRrrQK
 pevcxI72O0f9Zg74t2LnkVtZhWTg+OUXuqyNK+K5XfzYzVD7aM1Io8ha/
 rR6h2I7oaPXO3QB81zek+jxBqnvEa7+ZsyDc/78piBVXPopbcS3gaDHMj Q==;
X-CSE-ConnectionGUID: QZt0B67qSRqnZE1Icw+Z5Q==
X-CSE-MsgGUID: cPc6t1bNR8G3hkEr/qaIRw==
X-IronPort-AV: E=McAfee;i="6800,10657,11705"; a="72495501"
X-IronPort-AV: E=Sophos;i="6.21,298,1763452800"; d="scan'208";a="72495501"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Feb 2026 07:29:31 -0800
X-CSE-ConnectionGUID: 7vfWCQQvQ/u/PPB0omQmjg==
X-CSE-MsgGUID: eNCC+IX1TfKQmJ4KaBaVUA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,298,1763452800"; d="scan'208";a="213303006"
Received: from vpanait-mobl.ger.corp.intel.com (HELO localhost)
 ([10.245.244.66])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Feb 2026 07:29:28 -0800
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: intel-xe@lists.freedesktop.org
Subject: [PATCH 18/19] drm/i915/overlay: Move i915 specific code into
 i915_overlay.c
Date: Wed, 18 Feb 2026 17:28:05 +0200
Message-ID: <20260218152806.18885-19-ville.syrjala@linux.intel.com>

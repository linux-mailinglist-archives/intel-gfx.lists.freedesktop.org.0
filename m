...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E19636EE8EF
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 22:21:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 73F6210E7C7;
	Tue, 25 Apr 2023 20:21:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4F2CB10E7C7
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Apr 2023 20:21:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1682454076; x=1713990076;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WKTQ733lo6Gm7I5SxpgB96pTDE819d0Ua7DqckL+OZE=;
 b=fDHtqp8gQAojuGLTu8l3MhQlUmGufkJhq8Sf7C/3VVur2X0WdBcgt360
 WAtUwITMcGk1cUR6pIfhvJ7b48w3ARyTZUID8F5YbcKCj/scp9DwDxZn0
 sgldfd3Sr6GMSIIp7d5g3PBb/xX2q5tCtoa6AMUSGt+6S9CynGR/Sc9yI
 nE6fWG1y9aK3kGUb9DSHZGxFCkZ47/ZVQV10S/tMQzOW2KSXZCUh6/c9a
 vV6wrGAOarfdp5XWuHQIMWsASeU2Sr4ohY591zsta4EpdkmQkFDpuRQyt
 CvHSpXTO7JbkOitdJbteaA8wfflay+AZcdpa37I4XIkRufFOAFT6QYtp3 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="409854220"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="409854220"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:21:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="693663058"
X-IronPort-AV: E=Sophos;i="5.99,226,1677571200"; d="scan'208";a="693663058"
Received: from aazuev-mobl.ccr.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.252.59.124])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 13:21:13 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:20:52 +0300
Message-Id: <20230425202056.1143994-4-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 3/7] drm/i915: extract

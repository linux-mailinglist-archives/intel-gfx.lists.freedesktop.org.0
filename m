...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BA5075FAC7
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jul 2023 17:29:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 95CCC10E330;
	Mon, 24 Jul 2023 15:29:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 97D3810E330
 for <intel-gfx@lists.freedesktop.org>; Mon, 24 Jul 2023 15:29:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690212557; x=1721748557;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=ntzH9iYl7S61KQwYxVKikD1p090fEC8wXq6gEAwW+yM=;
 b=HE4NHswCJf7JgzdMZlum0kllpxHNl/iglH4q0JHzzZT+fvf2nzotvOG+
 0SiiJVebVfMFLVrRHzY8m7ZGoDV0azTTPoX3x6yRnaeif8WGLC8LFWpoP
 JemW0aACLqk6bbHWdFQclO5UUaAIqnLemHBDuoOX8mz7sBs1c7oK30Ssr
 Wg7Rr1P0AIYBnC67/v2RjS/1JbeNa9/nd4tLWf4LoYsMVw0HlsdVtMv/i
 FcWP2gXZxq0j1kcmHNyUrYkbbXSPmtCXh4Qz2bVDMFwYXiQDvZBNfoRNq
 QVWFgMGCiWg1clY8aJDP1fwxc4FHeecEWT4tnk+shs/uw0SsAuB7DAarC A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="347746375"
X-IronPort-AV: E=Sophos;i="6.01,228,1684825200"; d="scan'208";a="347746375"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2023 08:29:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="849670952"
X-IronPort-AV: E=Sophos;i="6.01,228,1684825200"; d="scan'208";a="849670952"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.14.115])
 ([10.213.14.115])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2023 08:29:14 -0700
Message-ID: <c7221921-3038-db54-bc9e-e22b97dd4d5b@intel.com>
Date: Mon, 24 Jul 2023 17:29:11 +0200
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:102.0) Gecko/20100101
 Firefox/102.0 Thunderbird/102.13.0
Content-Language: en-US
To: intel-gfx@lists.freedesktop.org
References: <5d394917-a4fc-cb57-ea79-25e2bd9e007f@linux.intel.com>
 <20230720113002.1541572-1-andrzej.hajda@intel.com>
From: Andrzej Hajda <andrzej.hajda@intel.com>
Organization: Intel Technology Poland sp. z o.o. - ul. Slowackiego 173, 80-298
 Gdansk - KRS 101882 - NIP 957-07-52-316
In-Reply-To: <20230720113002.1541572-1-andrzej.hajda@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
Subject: Re: [Intel-gfx] [PATCH v2] drm/i915: use direct alias for i915 in
 requests

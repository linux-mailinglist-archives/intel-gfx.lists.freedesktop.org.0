...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3294D21FF54
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 81EDB6E9F9;
...
Subject: [Intel-gfx] [PATCH v2 49/59] drm/kmb: Disable ping pong mode

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 45398210326
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Jul 2020 06:53:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0F2FB6E5C5;
	Wed,  1 Jul 2020 04:53:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 091DF6E5C5
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 Jul 2020 04:53:25 +0000 (UTC)
IronPort-SDR: gXCNubiJ0/kIMnZpBVkIJffr/7Hi81CxoGahZGVk9E7Qk2i1qRrYcuW+oYbJ2ysB+1Qyjn3QMH
 QClpRLZDiEQQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="126562535"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="126562535"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2020 21:53:25 -0700
IronPort-SDR: ZLncAuWHH5QOssziYHqYxWEhs89sNq0GXkc/3wrcp+WdpPXHOJ5SxQ/NoVVR3bjagafniJaH7z
 IuQYD0tlCvkg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="303694680"
Received: from ldmartin1-desk.jf.intel.com ([10.165.21.151])
 by fmsmga004.fm.intel.com with ESMTP; 30 Jun 2020 21:53:24 -0700
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 30 Jun 2020 21:50:54 -0700
Message-Id: <20200701045054.23357-1-lucas.demarchi@intel.com>
X-Mailer: git-send-email 2.26.2
MIME-Version: 1.0
Subject: [Intel-gfx] [CI] drm/i915/display: prefer dig_port to reference
 intel_digital_port
...
---
 ...
 18 files changed, 533 insertions(+), 536 deletions(-)
...
index 84e2a17b5ecb..98a59e014b75 100644
...
index 864a1642e81c..973450a393d2 100644
...
@@ -2722,12 +2722,12 @@ static void intel_hdmi_pre_enable(struct intel_atomic_state *state,
...
@@ -2737,7 +2737,7 @@ static void vlv_hdmi_pre_enable(struct intel_atomic_state *state,
 				const struct intel_crtc_state *pipe_config,
 				const struct drm_connector_state *conn_state)
 {
-	struct intel_digital_port *dport = enc_to_dig_port(encoder);
...
@@ -2746,13 +2746,13 @@ static void vlv_hdmi_pre_enable(struct intel_atomic_state *state,
...
@@ -2813,7 +2813,7 @@ static void chv_hdmi_pre_enable(struct intel_atomic_state *state,
 				const struct intel_crtc_state *pipe_config,
 				const struct drm_connector_state *conn_state)
 {
-	struct intel_digital_port *dport = enc_to_dig_port(encoder);
...
@@ -2823,13 +2823,13 @@ static void chv_hdmi_pre_enable(struct intel_atomic_state *state,
 	/* Use 800mV-0dB */
...
@@ -2935,7 +2935,7 @@ intel_hdmi_add_properties(struct intel_hdmi *intel_hdmi, struct drm_connector *c
...
@@ -3172,52 +3172,52 @@ static u8 intel_hdmi_ddc_pin(struct intel_encoder *encoder)
 	return ddc_pin;
 }
...
@@ -3231,9 +3231,9 @@ void intel_hdmi_init_connector(struct intel_digital_port *intel_dig_port,
...
@@ -3322,21 +3322,21 @@ intel_hdmi_hotplug(struct intel_encoder *encoder,
...
@@ -3393,12 +3393,12 @@ void intel_hdmi_init(struct drm_i915_private *dev_priv,
 	if (IS_G4X(dev_priv))

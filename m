...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A22422C6568
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C09B6ED34;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 137/162] drm/i915: blt copy between objs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 139936650AD
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Jan 2023 01:57:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4453010E6AB;
...
Subject: [Intel-gfx] [PATCH 2/9] drm/i915/pxp: Add GSC-CS back-end resource
 init and cleanup

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD20F397110
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Jun 2021 12:16:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 325646E9DF;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 01/21] drm: Add Enhanced Gamma and color lut
 range attributes

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CA2914251C
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2020 09:24:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFCBC6E7E2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 03/22] drm: Add get_vblank_timestamp() to

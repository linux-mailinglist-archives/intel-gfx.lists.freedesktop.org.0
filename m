...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BAE97727F21
	for <lists+intel-gfx@lfdr.de>; Thu,  8 Jun 2023 13:43:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C355510E239;
...
Subject: [Intel-gfx] [PATCH v3 1/4] PCI/VGA: tidy up the code and comment
 format

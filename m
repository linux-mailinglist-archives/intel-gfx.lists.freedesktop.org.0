...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2452B9C110F
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2024 22:37:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC7DC10E8FD;
	Thu,  7 Nov 2024 21:37:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="C3LnoxDW";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 627BB10E8F8;
 Thu,  7 Nov 2024 21:37:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1731015463; x=1762551463;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=sKNV3AOo0WgFFrjW2b7/e+nBXTgl+/lsDTGWiIkhKIQ=;
 b=C3LnoxDWIblM50iU6J5rVVPly3+mXHPpj/xzHha4NXjMwK/g/bQ1qVlQ
 Z+A9bhLYzARKdYRJ8YKHGEUzWXrApzCUC2ACVm5qPcfV6ywfjwoXh4Ir0
 e7jSr9mSXowUkaibgzW31uV0tr3NwWXRmKTGpLEY5D472eOdjtK9OZ0vj
 gQRGWc1nUIQxZBLcmDbSfL6fxUP4DD3Ots9j+cMXpnxio3DtOa5YZKsuM
 Rh9oSeegfKS1Wiyj7kYBLeTwQEW5ZeVEjHyLBPyCFGKaIQd4eNlMk+tWf
 /tAuCCdsn2n6EUd/x4gg7A2wihi136vzb3/BTuB0ZGOcEUdnWdG35Onk+ w==;
X-CSE-ConnectionGUID: 8s1CZ8Z6ShygXiERr1gNqQ==
X-CSE-MsgGUID: PMgNG4DHSoG7ZtENhs41ww==
X-IronPort-AV: E=McAfee;i="6700,10204,11249"; a="56282998"
X-IronPort-AV: E=Sophos;i="6.12,136,1728975600"; d="scan'208";a="56282998"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 13:37:43 -0800
X-CSE-ConnectionGUID: Y0rbaiSHR6KnFVeLosjaQA==
X-CSE-MsgGUID: SASEkcwNR0i60D41JjgSzQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,136,1728975600"; d="scan'208";a="85574875"
Received: from klitkey1-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.233])
 by fmviesa010-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 13:37:41 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, Vinod Govindapillai <vinod.govindapillai@intel.com>,
 Rodrigo Vivi <rodrigo.vivi@intel.com>
Subject: [CI v2 v2 09/15] drm/i915/display: convert HAS_SAGV() to struct
 intel_display
Date: Thu,  7 Nov 2024 23:36:43 +0200
Message-Id: <b780558753f1096eaa8b416f2f0145729b8a1a5f.1731015334.git.jani.nikula@intel.com>
...
index a9a8995af855..44142adde9cc 100644
--- a/drivers/gpu/drm/i915/display/intel_display_device.h
+++ b/drivers/gpu/drm/i915/display/intel_display_device.h
@@ -174,7 +174,8 @@ struct intel_display_platforms {

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A43CA4267C5
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Oct 2021 12:29:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F9D16F41C;
	Fri,  8 Oct 2021 10:29:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6DE2B6F41C
 for <intel-gfx@lists.freedesktop.org>; Fri,  8 Oct 2021 10:29:14 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10130"; a="312677278"
X-IronPort-AV: E=Sophos;i="5.85,357,1624345200"; d="scan'208";a="312677278"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Oct 2021 03:29:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.85,357,1624345200"; d="scan'208";a="561277734"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.171])
 by FMSMGA003.fm.intel.com with SMTP; 08 Oct 2021 03:29:11 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 08 Oct 2021 13:29:11 +0300
Date: Fri, 8 Oct 2021 13:29:11 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@linux.intel.com>
Cc: intel-gfx@lists.freedesktop.org
Message-ID: <YWAdd3dqlFoIWDjs@intel.com>
References: <20211006204937.30774-1-ville.syrjala@linux.intel.com>
 <20211006204937.30774-5-ville.syrjala@linux.intel.com>
 <87y273x1e1.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <87y273x1e1.fsf@intel.com>

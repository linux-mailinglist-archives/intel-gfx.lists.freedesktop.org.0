...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D649B3B3EEB
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Jun 2021 10:23:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 045146ED65;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 16/27] drm/rcar-du: Don't set struct

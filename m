...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E6CE4B6EA2
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Feb 2022 15:17:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BBEC10E603;
...
Subject: [Intel-gfx] [PATCH V3 11/13] media: tda8083: use

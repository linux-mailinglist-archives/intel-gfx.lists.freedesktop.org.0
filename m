...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C6CC70291F
	for <lists+intel-gfx@lfdr.de>; Mon, 15 May 2023 11:41:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D815110E1CC;
...
Subject: [Intel-gfx] [PATCH v2 07/12] drm/msm: Use regular fbdev I/O helpers

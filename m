...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 537A61CA5DB
	for <lists+intel-gfx@lfdr.de>; Fri,  8 May 2020 10:17:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BB476EA9B;
	Fri,  8 May 2020 08:17:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C68836E148
 for <intel-gfx@lists.freedesktop.org>; Fri,  8 May 2020 08:17:04 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21147519-1500050 
 for multiple; Fri, 08 May 2020 09:16:36 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  8 May 2020 09:16:30 +0100
Message-Id: <20200508081630.13882-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/11] drm/i915: Move saturated workload
...
index c113b7805e65..2b1232a233bc 100644
...
index fd0cb419fc11..e9336547212b 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -5582,21 +5582,6 @@ intel_execlists_create_virtual(struct intel_engine_cs **siblings,
...
index 87ae67fc5022..2b1a96cbf9fb 100644
--- a/drivers/gpu/drm/i915/i915_request.c
+++ b/drivers/gpu/drm/i915/i915_request.c
@@ -468,7 +468,7 @@ bool __i915_request_submit(struct i915_request *request)
 	 */
...
@@ -920,7 +920,7 @@ already_busywaiting(struct i915_request *rq)
 	 *

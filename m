...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FBF878695A
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Aug 2023 10:05:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5010E10E4D2;
	Thu, 24 Aug 2023 08:05:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F2F6B10E4BC
 for <intel-gfx@lists.freedesktop.org>; Thu, 24 Aug 2023 08:05:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692864311; x=1724400311;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=pSavctLchAUmBDRHHQITbLATs8rDjFIBN71Fm3dmPd8=;
 b=Y2LbFUCnomykT8j7fYqvt1qsr4zP3bKkF5sF3kRrpaZMJYaK7OliZio1
 W6TR//6HSsRZ9n1ySHymSdw6WVgcU78zvr9BzgA1UzYOkQMH1bHQitYnX
 p1lMv636oRu1dQywHPvmpNEIPMQPmyQAh8T4FMh6Tu4/cLlemNRSZT0Ie
 mDige4en8zEQiawMhV0kSfPvYcv3qsuiz+0MV1IvcqZL0bct6nZ5EQzik
 /hFGAZhUZXX8ydHYeY93+7Vd0VMr9yipWokWZy4cIzTfDwmaw01iRobrd
 eShJiWo4v5uAn3SRVdbM9CNDLqT1Tsq2QTphuMkj7Km/zWQgDbioGi75u Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10811"; a="374345860"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="374345860"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2023 01:05:11 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; d="scan'208";a="880710301"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2023 01:05:15 -0700
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 24 Aug 2023 11:05:03 +0300
Message-Id: <20230824080517.693621-9-imre.deak@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 08/22] drm/i915/fdi: Improve FDI BW sharing

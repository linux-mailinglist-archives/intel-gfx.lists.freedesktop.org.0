...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B133A45B744
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Nov 2021 10:19:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 431FC6E9DD;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/dmabuf: remove duplicate include
 in i915_gem_dmabuf.c

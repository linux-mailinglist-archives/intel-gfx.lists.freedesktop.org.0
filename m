...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 862FAF0471
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Nov 2019 18:53:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E56CF6EB36;
	Tue,  5 Nov 2019 17:53:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pl1-x649.google.com (mail-pl1-x649.google.com
 [IPv6:2607:f8b0:4864:20::649])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4B430896AF
 for <intel-gfx@lists.freedesktop.org>; Mon,  4 Nov 2019 19:41:53 +0000 (UTC)
Received: by mail-pl1-x649.google.com with SMTP id v2so11212670plp.14
 for <intel-gfx@lists.freedesktop.org>; Mon, 04 Nov 2019 11:41:53 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:in-reply-to:message-id:mime-version
 :references:subject:from:to:cc;
 bh=3VArYdzuhYZ5F7lzuhgwCdAuyaphVwUyvDoIU6FlqsQ=;
 b=
X-Gm-Message-State: APjAAAVCy/xx6zcUSjJImvecve2vzHe+Mmt+vpJsp1Zuq6T6WdpbjvHf
 Ry7Gka+kK2kA9WB+Hj4kTjmCBW0EclLK
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 rzmg==
Subject: [Intel-gfx] [PATCH v2 1/3] drm/i915: Move the code to populate ACPI
...
ZC1nb29nCgpfX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fXwpJ

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE7C417C5BA
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 19:57:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A14606ED46;
	Fri,  6 Mar 2020 18:57:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 024776ED46
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,523,1574150400"; d="scan'208";a="244690529"
Received: from josouza-mobl2.jf.intel.com (HELO josouza-MOBL2.intel.com)
 ([10.24.14.241])
 by orsmga006.jf.intel.com with ESMTP; 06 Mar 2020 10:57:34 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  6 Mar 2020 10:58:32 -0800
Message-Id: <20200306185833.53984-1-jose.souza@intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915/display: Deactive FBC in
...
bF9zdGF0ZS5pc3JhLjE1MCBbaTkxNV1dIERQTEwgMAoKdjI6CnVzaW5nIGludGVsX2ZiY19jYW5f
ZW5hYmxlKCkgaW5zdGVhZCBvZiBjcnRjX3N0YXRlLT5lbmFibGVfZmJjIChWaWxsZSkKCkNjOiBW
...
LQogZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9mYmMuYyB8IDQ3ICsrKysrKysr
KysrKystLS0tLS0tLS0tLQogMSBmaWxlIGNoYW5nZWQsIDI1IGluc2VydGlvbnMoKyksIDIyIGRl
...


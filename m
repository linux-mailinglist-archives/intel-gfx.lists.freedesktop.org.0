...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EE731B2437
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Apr 2020 12:46:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A4FD6E908;
	Tue, 21 Apr 2020 10:46:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2A4586E86B
 for <intel-gfx@lists.freedesktop.org>; Tue, 21 Apr 2020 10:46:31 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 21 Apr 2020 12:46:16 +0200
Message-Id: <20200421104626.1480208-14-maarten.lankhorst@linux.intel.com>
...
---
 ...
 24 files changed, 213 insertions(+), 132 deletions(-)

diff --git a/drivers/gpu/drm/i915/display/intel_display.c b/drivers/gpu/drm/i915/display/intel_display.c
index 1064e34e42cd..0c3ca46c6cc7 100644
...
index 9fe387ac9850..6a0180ac8101 100644
--- a/drivers/gpu/drm/i915/gem/i915_gem_context.c
+++ b/drivers/gpu/drm/i915/gem/i915_gem_context.c
@@ -1144,7 +1144,7 @@ static int context_barrier_task(struct i915_gem_context *ctx,
...
@@ -1237,7 +1237,7 @@ static int pin_ppgtt_update(struct intel_context *ce, struct i915_gem_ww_ctx *ww
...
index 6abe37b7933d..28cf45e9d9c6 100644
...
+	err = i915_vma_pin_ww(vma, &eb->ww,
 	...
 	if (err)
@@ -1093,9 +1094,10 @@ static void *reloc_kmap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	void *vaddr;
@@ -1117,10 +1119,13 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 		if (err)
 			return ERR_PTR(err);
...
@@ -1156,9 +1161,10 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	if (cache->page == page) {
@@ -1166,7 +1172,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 	} else {
 		vaddr = NULL;
...
@@ -1252,7 +1258,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 		goto err_unmap;
 	}
...
@@ -1417,7 +1423,7 @@ relocate_entry(struct i915_vma *vma,
 	}
...
@@ -1832,6 +1838,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2101,7 +2108,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2112,7 +2120,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2224,16 +2232,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2261,7 +2286,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2272,7 +2297,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2284,19 +2309,34 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2451,7 +2491,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -2907,33 +2947,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2942,7 +2956,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
+		goto err_vma;
 	...
 	if (in_fence) {
@@ -3005,9 +3019,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	}
...
-		i915_vma_unpin(batch);
 err_vma:
 	...
 	if (eb.trampoline)
@@ -3093,7 +3104,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3171,8 +3184,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index 4141dacf6ad9..059095a3692d 100644
...
index b5f216bb266d..60e2aa8db0b3 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt.c
@@ -346,7 +346,7 @@ static int intel_gt_init_scratch(struct intel_gt *gt, unsigned int size)
 		goto err_unref;
 	}
...
index 932049c14ba2..861dcc74ee3f 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3171,7 +3171,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3533,7 +3534,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index f0383a68c981..98476f09f3f0 100644

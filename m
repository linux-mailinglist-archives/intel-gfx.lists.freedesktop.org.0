...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C553790D89
	for <lists+intel-gfx@lfdr.de>; Sun,  3 Sep 2023 20:46:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DA1910E1D9;
...
Subject: [Intel-gfx] [PATCH v2 2/6] drm_dbg: add trailing newlines to msgs

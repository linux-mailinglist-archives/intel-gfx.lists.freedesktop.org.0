...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 81A111C31E8
	for <lists+intel-gfx@lfdr.de>; Mon,  4 May 2020 06:49:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCA246E2DF;
	Mon,  4 May 2020 04:49:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9989A6E161
 for <intel-gfx@lists.freedesktop.org>; Mon,  4 May 2020 04:49:36 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21102376-1500050 
 for multiple; Mon, 04 May 2020 05:49:11 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  4 May 2020 05:49:01 +0100
Message-Id: <20200504044903.7626-20-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 20/22] drm/i915/gem: Asynchronous GTT unbinding
...
---
 .../gpu/drm/i915/gem/i915_gem_execbuffer.c    | 798 ++++++++++++++++--
 ...
 10 files changed, 836 insertions(+), 122 deletions(-)

diff --git a/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c b/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
index 0d773767c2ac..924d1ed50732 100644
...
@@ -632,85 +654,700 @@ static inline int use_cpu_reloc(const struct reloc_cache *cache,
...
+retry:
 		...
 		INIT_LIST_HEAD(&last);
@@ -739,37 +1376,52 @@ static int eb_reserve(struct i915_execbuffer *eb)
 		}
...
@@ -1235,6 +1887,8 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 {
 	void *vaddr;
...
@@ -1244,6 +1898,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 		if (!vaddr)
...
@@ -1596,6 +2251,8 @@ eb_relocate_entry(struct i915_execbuffer *eb,
 	if (unlikely(!target))
 		return -ENOENT;
...
@@ -1872,7 +2529,6 @@ static int eb_move_to_gpu(struct i915_execbuffer *eb)
...
@@ -2783,7 +3439,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2803,6 +3459,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 			goto err_parse;
 		}
...
@@ -2882,6 +3539,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 err_parse:
 	if (batch->private)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C4C23C5DBC
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Jul 2021 15:50:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A052889C05;
...
Subject: [Intel-gfx] [PATCH v8 4/5] drm: serialize drm_file.master with a
 new spinlock

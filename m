...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A8287330B8
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 14:05:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D31E410E605;
	Fri, 16 Jun 2023 12:05:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5303C10E605
 for <intel-gfx@lists.freedesktop.org>; Fri, 16 Jun 2023 12:05:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686917113; x=1718453113;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=AzdQXGQQWP7uGfBDxFphVz9V10sVJbDjvEIKKpyw+ro=;
 b=eolh4oY1u0XLq/qMZ0EzfMI19vQdfDtYVSnzIsKM13V8n17Zqk6ZHuNg
 9p2Y8f7J7wzsCjiayKvCyGumJsjsWGCzu6RLI80V/HJ1bhcL+A59iYO6n
 rbFQ9ayfv8DagMIuXId8PfINBFQzMevFu7wzv0tc23qZtiWYi/1HbS3az
 +LRVLZ+tYEZmZJwia6DJKFRui32goOa1kKdKxt42gZPP5PRXCuIfKK1Mz
 Ofk/0l/m5+3xd52qaO7psl74p1lchOA/fvsqshHaThGKMiFQFOm1JLN20
 /Nan4P2JvPRlk+MTMfW512eTIbR/FkJoFPFHc5ePl4L4BQGQp/bFVMJjq g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="338818650"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="338818650"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2023 05:05:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="712843188"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="712843188"
Received: from sdonohue-mobl.ger.corp.intel.com (HELO [10.213.214.201])
 ([10.213.214.201])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2023 05:05:10 -0700
Message-ID: <a2a59852-d13a-50e8-7491-fd2f95709419@linux.intel.com>
Date: Fri, 16 Jun 2023 13:05:08 +0100
MIME-Version: 1.0

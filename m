...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A412A66A2FD
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 20:30:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2A0110EABE;
...
Subject: [Intel-gfx] [PATCH v2 01/20] test-dyndbg: fixup CLASSMAP usage error

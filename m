...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2CEA54F264
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jun 2022 10:00:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF13A10F6D5;
	Fri, 17 Jun 2022 08:00:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B389910F6D5
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Jun 2022 08:00:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655452809; x=1686988809;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=EEPxEBY+pYT5HxxDiVlv0eg8/w9rFytuTXXcH0c0IRM=;
 b=ausG1va7dOBVYPZ8M9JFoFhpcMDEpzlgDjG2mht0mkDt7/vvd0ydN+WN
 9YiDA62rv6YbZRU0dCz5C/ZebQm0bBbsX816YSkLJ7t0btSY3GScGnI9D
 4bxRRMWgJ2g/Nm2YJxXv+//mB6h8/b58dXYnt9088saLgC2vOP5od/mkb
 gD4R4hzvtU8OGjrKSebsRyPDGlsTtU9PsPsBMJFJaC1mLdkZAmzNf9zdf
 yVcmSa9OwVFunzYO5esdCzhj1IjfHgzHoJY7ReDwLjqMuhPn28w1q/g5r
 1YRqzOkILhsjmr804xdAI0dR4N/nnPGwgm7JChXWIypKmevhC5tBhAMof Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10380"; a="259299931"
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="259299931"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2022 01:00:09 -0700
X-IronPort-AV: E=Sophos;i="5.92,306,1650956400"; d="scan'208";a="831940590"
Received: from makierna-mobl1.ger.corp.intel.com (HELO [10.213.236.232])
 ([10.213.236.232])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2022 01:00:08 -0700
Message-ID: <a0c37ef9-9cde-883e-306d-11f520e273ef@linux.intel.com>
Date: Fri, 17 Jun 2022 09:00:06 +0100
MIME-Version: 1.0

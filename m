...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BA0227016DE
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 15:21:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D2B610E0B6;
...
Subject: [Intel-gfx] [PATCH v5 00/10] Enhance vfio PCI hot reset for vfio
 cdev device

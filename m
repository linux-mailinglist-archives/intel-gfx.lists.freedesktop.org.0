...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 026B16915BF
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Feb 2023 01:42:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A9C810EC24;
...
Subject: [Intel-gfx] [PATCH v4 2/8] drm/i915/pxp: Add MTL hw-plumbing

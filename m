...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 003AF7CDD21
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 15:24:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 276DA10E3F3;
	Wed, 18 Oct 2023 13:24:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C6ED010E0A3
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Oct 2023 13:24:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1697635484; x=1729171484;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=n2nHVafw3GyOXFKiUfKBkFJodxCmmz7RWh0GRCy4v4I=;
 b=jufSiKu7umeVL0MVHGROF1fuNgFFd57jvac4R72q76PhXetrPzIxN5fY
 DZhnBVf/C6OESqrsJyZGNg7p0Kkbv91O4Wf617+WpTUqBrJLB3mZWgZVA
 fnquLcT8GQ+HPJNKrgFvX7jeMfSlrTQKOxKKlOfXMHiSx0W+pgp8Tk1SN
 0cg1+vY8Ui/DbzeDavMVsO2lvtI08jri0ZA1l9+Mw+TNd9Uv9U7EJwr+k
 t+ipGJrMjU/HgJTfhEh4KV2oBDF5HtDfM/+fX+vBLgMa9O2380jJaUfvw
 P270J0hCknH6MdzQG3zt4yFdy1uzmyMVTXz6T+abw01aVkBGbFH0yZS2J A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10867"; a="450234943"
X-IronPort-AV: E=Sophos;i="6.03,235,1694761200"; d="scan'208";a="450234943"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Oct 2023 06:24:44 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10867"; a="930196383"
X-IronPort-AV: E=Sophos;i="6.03,235,1694761200"; d="scan'208";a="930196383"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.19.191])
 ([10.213.19.191])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Oct 2023 06:24:41 -0700
Message-ID: <46999778-3c13-4e70-96a3-ea97e4177b85@intel.com>
Date: Wed, 18 Oct 2023 15:24:39 +0200
MIME-Version: 1.0
...
In-Reply-To: <20230920210704.3624771-4-jonathan.cavitt@intel.com>

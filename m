...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D6D93BC98F
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2019 15:57:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EEFF96EA3F;
...
Subject: [Intel-gfx] [PATCH V2 8/8] docs: sample driver to demonstrate how

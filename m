...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 95184397132
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Jun 2021 12:16:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E1536EA07;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/21] drm: Add Plane Gamma Lut property

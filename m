...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF75825D7E9
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Sep 2020 13:54:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A277F6EB46;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 00/18] drm/i915: Pimp DP DFP handling

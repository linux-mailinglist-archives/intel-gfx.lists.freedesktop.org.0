...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 055F4A0074E
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jan 2025 10:55:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7FB9910E040;
	Fri,  3 Jan 2025 09:55:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from b555e5b46a47 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DE1CB10E040;
 Fri,  3 Jan 2025 09:55:15 +0000 (UTC)
...
Date: Fri, 03 Jan 2025 09:55:15 -0000
Message-ID: <173589811590.2524096.14995506864806544265@b555e5b46a47>
...
#### Suppressed ####
  ...
  * igt@i915_module_load@load:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_139267v6/bat-mtlp-9/igt@i915_module_load@load.html
...
#### Issues hit ####
  ...
  * igt@i915_pm_rpm@module-reload:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_139267v6/bat-dg1-7/igt@i915_pm_rpm@module-reload.html
  ...
  * igt@i915_selftest@live:
   ...
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_139267v6/bat-arlh-3/igt@i915_selftest@live.html
  ...
  * igt@i915_selftest@live@workarounds:
   ...
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_139267v6/bat-arlh-3/igt@i915_selftest@live@workarounds.html

  * igt@kms_flip@basic-flip-vs-dpms@a-dp1:
    - fi-cfl-8109u:       [PASS][9] -> [DMESG-WARN][10] ([i915#13445]) +1 other test dmesg-warn
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_15896/fi-cfl-8109u/igt@kms_flip@basic-flip-vs-dpms@a-dp1.html
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_139267v6/fi-cfl-8109u/igt@kms_flip@basic-flip-vs-dpms@a-dp1.html

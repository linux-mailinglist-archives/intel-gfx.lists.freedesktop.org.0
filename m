...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2831B3B27A8
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D9576EA1C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 22/47] drm/i915/guc: Update

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A2E74623ED
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Nov 2021 23:03:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9331A6E332;
...
Subject: Re: [Intel-gfx] [PATCH v4.5 12/14] dt-bindings: msm/dp: Add

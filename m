...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BD91F39B4B4
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Jun 2021 10:16:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4EF496F5CD;
	Fri,  4 Jun 2021 08:16:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ot1-x329.google.com (mail-ot1-x329.google.com
 [IPv6:2607:f8b0:4864:20::329])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8B2C66F5CD
 for <intel-gfx@lists.freedesktop.org>; Fri,  4 Jun 2021 08:16:26 +0000 (UTC)
Received: by mail-ot1-x329.google.com with SMTP id
 w23-20020a9d5a970000b02903d0ef989477so3929451oth.9
 for <intel-gfx@lists.freedesktop.org>; Fri, 04 Jun 2021 01:16:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=E8O9J7+tUswil4rCJQSS2FeCagE+S3wD8Fshvp+o8mM=;
 b=MPv/md67nySOkQDRPbODdm+JOhjaHOYhRKVisZC+lvwHVIaJdJZFIhWJzmcw0K1Ky+
 WHa5KyM5PI/o//0lrlz6WQSd9xXLvRGdpxTPE1CUSqiPiHg9DpEG40KM5h6vCosh47nr
 UmEh922MsjJfOxBtrwveN0lqFfKDOOtRb4gRw=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=E8O9J7+tUswil4rCJQSS2FeCagE+S3wD8Fshvp+o8mM=;
 b=
X-Gm-Message-State: AOAM5310+GwqjTRsMqGC+rmxuG3BK+0aqNNM3d3JQ6fx9Wrf7LW5XNlL
 EYbi4RMND7HSr6OOgB60M8bWi4L0Du4f0ADnxQTCiw==
X-Google-Smtp-Source: ABdhPJwP2dPVvWx8FkoRAkgLm+37uTm5I84H5z+fAmUsB+g1A2/+qj9p9pn8XYI3DkbMadgBRn95E06TA0Rt8gyN1bg=
X-Received: by 2002:a05:6830:1155:: with SMTP id
 x21mr2735406otq.303.1622794585251; 
 Fri, 04 Jun 2021 01:16:25 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <20210604031759.GA11820@sdutt-i7>
From: Daniel Vetter <daniel@ffwll.ch>
Date: Fri, 4 Jun 2021 10:16:14 +0200
Message-ID: <CAKMK7uH8_ZNtN5pBeVojbbTWzWg3=6JZQRsKvO_4C-3KW9Ht_Q@mail.gmail.com>
To: Matthew Brost <matthew.brost@intel.com>
Subject: Re: [Intel-gfx] [RFC PATCH 64/97] drm/i915/guc: Reset

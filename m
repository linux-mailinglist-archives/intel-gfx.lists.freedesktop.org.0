...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D70527D5001
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Oct 2023 14:42:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02E8B10E377;
	Tue, 24 Oct 2023 12:42:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E42C610E378
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Oct 2023 12:41:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1698151318; x=1729687318;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6lWg3/UwCvisXTVFryNaz6Vbo0jyn5QxZQEPRbdRnQY=;
 b=anG+TTLeE5vxG9+iK4AHFBN6QOr9qSp6F0E5G+1qYvWc+fEbytBTmjqg
 kuaixB1zj5QYMk21l7FxDpZVs4/RkNplQN0OpjWv+tQsr7sqV2Aui68zj
 KAYAW12waVbTjBrVZoAETXn49P3eK1KXs9dszELnO3FtslvbCcURTyhrd
 F4sx6Q/ZE61Vk+Z61fBxBP3P8ztDpa2/MmoP7X7c/2QghTeopXXmT74Y0
 l0OAM3QUnZzkNDtq91uJV9BTgapTDt2CR/HSvTuCFQ+ZjoX5hVnsD2Pjt
 QytcUhUCahxcBXJGcQMhKC1qpzI/kelH9HgVSXVNYkVrFObeeAci5ZqxV Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10873"; a="386856627"
X-IronPort-AV: E=Sophos;i="6.03,247,1694761200"; d="scan'208";a="386856627"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2023 05:41:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10873"; a="758464431"
X-IronPort-AV: E=Sophos;i="6.03,247,1694761200"; d="scan'208";a="758464431"
...
Message-Id: <20231024124109.384973-12-jouni.hogander@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 11/23] drm/i915/display: Move enable_sagv

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 565006B1D11
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Mar 2023 08:55:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BDBDE10E7B0;
	Thu,  9 Mar 2023 07:55:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E1F8A10E7B0
 for <intel-gfx@lists.freedesktop.org>; Thu,  9 Mar 2023 07:55:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678348531; x=1709884531;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=j/C//rZ4OA3CNi69xWU6rH9z8Ppp6kgCuYMXXT46uv0=;
 b=DaxKxrzaZhyxW1+xvWsQ0ZPx8/lE3bYgBlbGUwBqY5jBaV36/hYZXpQ7
 vKqQ69aUFvJcjIfunWaIwOZVmbMRFgl66K2u6InPr4jQAwq1WMImUxfJD
 Lkrc+viUBO7bCM2N3LWuJ2XQQrAOIyLeWPVuo9GeQRWT3D8C3XwJ/g//w
 1jgqDDsMsNJDd7uR5rJ4+LJoFofDWjfqdKgvgAjKOLzLNwAdsTyoacp+H
 Yf1uVDUuZnTAF8jzCe4y/ZKAulfaqpTGokQN0vlMgn7JkKMqkl4lUgezk
 4oMbc+q+j4rsTeNqEB5vBdmo4iP6T1cH4fCwTouYTdwXnofEVilghxLJw Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10643"; a="398960466"
X-IronPort-AV: E=Sophos;i="5.98,245,1673942400"; d="scan'208";a="398960466"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Mar 2023 23:55:31 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10643"; a="707510447"
X-IronPort-AV: E=Sophos;i="5.98,245,1673942400"; d="scan'208";a="707510447"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga008.jf.intel.com with ESMTP; 08 Mar 2023 23:55:28 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  9 Mar 2023 13:24:21 +0530
Message-Id: <20230309075423.409402-5-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 4/6] drm/i915/hdcp: Refactor HDCP API
 structures

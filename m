...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47DC77A2D70
	for <lists+intel-gfx@lfdr.de>; Sat, 16 Sep 2023 04:26:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A393410E0B5;
	Sat, 16 Sep 2023 02:26:04 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v6 1/3] drm/i915/pxp/mtl: Update

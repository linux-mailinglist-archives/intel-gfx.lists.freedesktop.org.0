...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F0775E6F6A
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Sep 2022 00:10:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 822C410E491;
	Thu, 22 Sep 2022 22:10:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2498F10E481;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=KUc0z1/7XJ9EDa7Hqkj3/wUdHhfMjsUaDdvhkoyZhNg=;
 b=nIdYzBD20WloEcutqb3Dcat91rcWDUZ7SD8S+eXrHjEEekmfL0Tlco99
 pdlF6nZ0OFSEFAKaYt+5fTqVg/0BOsBWnRgG4ZSZ49k0nJqM/iZ9kn7aN
 cctcj/w7/5Fgl7+UFHrvavhxvrm2CyvdUUTKKW4xID87dPEDVxxsEWvSh
 cCm8A7tIr/o2rRn2luN9c1Gs46FREqESjMmEOTlTAjNDCAuKqQGgFd9gP
 m6HPrC45Jfd5bIahRyZa69rpdbQm7RFdNFzzU9d9z/JJRVWm5xIZCJi1d
 uKdGzX3yUueBofT+1UqkwcYo0yLvlcqMrwqA2+yDuWz/Bi7DnBql2OvD9 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10478"; a="280815512"
X-IronPort-AV: E=Sophos;i="5.93,337,1654585200"; d="scan'208";a="280815512"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Sep 2022 15:10:30 -0700
X-IronPort-AV: E=Sophos;i="5.93,337,1654585200"; d="scan'208";a="682416253"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Sep 2022 15:10:30 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 22 Sep 2022 15:11:15 -0700
Message-Id: <20220922221117.458087-6-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH 5/7] drm/i915/mtl: Handle wopcm per-GT and limit
 calculations.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BCBC86ED773
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Apr 2023 00:06:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5122B10E62A;
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v8 3/7] lib/ref_tracker: add printing to memory
 buffer

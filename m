...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E3BB03722AA
	for <lists+intel-gfx@lfdr.de>; Mon,  3 May 2021 23:50:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D51026E182;
	Mon,  3 May 2021 21:50:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C101E6E182
 for <intel-gfx@lists.freedesktop.org>; Mon,  3 May 2021 21:50:09 +0000 (UTC)
IronPort-SDR: 9d6q+86ej0rI4b1N+jFGD9JtQar57H2/QibsUs6WDKRHbqf856KN7E0PQ7egtsoq3L2Lo5tnQk
 yfmbsJ7jHUNw==
X-IronPort-AV: E=McAfee;i="6200,9189,9973"; a="177377600"
X-IronPort-AV: E=Sophos;i="5.82,271,1613462400"; d="scan'208";a="177377600"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2021 14:50:09 -0700
IronPort-SDR: MQfnzBR0AsxC8aGqAtKBjubiFS9/eJ+Ky7sXmYXX+KsY0jsCBhUeLe4ClkPi2yjFTWVjhQoE5n
 TZewvuI6qRrw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.82,271,1613462400"; d="scan'208";a="450623714"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
 by fmsmga004.fm.intel.com with ESMTP; 03 May 2021 14:50:09 -0700
Received: from fmsmsx612.amr.corp.intel.com (10.18.126.92) by
 fmsmsx603.amr.corp.intel.com (10.18.126.83) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2106.2; Mon, 3 May 2021 14:50:08 -0700
...
Received: from fmsmsx611.amr.corp.intel.com ([10.18.126.91]) by
 ...
 Mon, 3 May 2021 14:50:08 -0700
From: "Srivatsa, Anusha" <anusha.srivatsa@intel.com>
To: Jani Nikula <jani.nikula@linux.intel.com>,
 "intel-gfx@lists.freedesktop.org" <intel-gfx@lists.freedesktop.org>
Thread-Topic: [Intel-gfx] [PATCH 2/3] drm/i915/csr: Add
 intel_csr_has_dmc_payload() helper
Thread-Index: AQHXPHNG4E66SJSg0UG6R5HJLuTrrKrSiruA///HyyA=
Date: Mon, 3 May 2021 21:50:08 +0000
Message-ID: <3c2ad3356ff94012ae3fddec3780f17a@intel.com>
References: <20210428211249.11037-1-anusha.srivatsa@intel.com>
 <20210428211249.11037-3-anusha.srivatsa@intel.com> <87k0ofzo6m.fsf@intel.com>
In-Reply-To: <87k0ofzo6m.fsf@intel.com>

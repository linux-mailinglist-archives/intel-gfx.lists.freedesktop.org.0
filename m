...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5182967EF2B
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Jan 2023 21:05:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26D8310E1A6;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Fix potential bit_17 double-free

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A56F35B2FFF
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:36:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 041EF10EC09;
...
Subject: [Intel-gfx] [PATCH v3 04/37] drm/i915: gvt: fix kernel-doc trivial
 warnings

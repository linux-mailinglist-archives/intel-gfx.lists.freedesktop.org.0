...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D92113D9A4A
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 02:49:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59B296E961;
...
Subject: [Intel-gfx] [PATCH v3 00/14] Provide core infrastructure for

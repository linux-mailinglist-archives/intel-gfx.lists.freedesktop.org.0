...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9185E4BEDBB
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:18:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1526310E521;
	Mon, 21 Feb 2022 23:18:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7FF2310E521;
 Mon, 21 Feb 2022 23:18:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485489; x=1677021489;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qlFqLRfrfrx4mNRF6vVIBqvEiaofH2gyPUSV1nRx1WA=;
 b=YoBpEHZ3ryqadGDlR5NPfuSioiQVjVZKPkASohIpV3BvtqVNNrQ0dCyJ
 qy6EHg1hQKeM82os3e31cCOlxWQzMAIYstuErzFCQj4i4wL91hPHAc8ig
 O7o3SANKLqss2NBPRqxnvPeqYyxwyzsnel0+9t8LneJ1idHkH+F+SP+jL
 Xsm7fPKgu6AVM+21idTbstO8bFD+V0ChNE4yUAlq/kmamZF8vnWPOARDL
 t9R3MkoMsVbksKszuweCPLiUqsyODHQG9pW17fpgi/rddMollUDURcgYv
 zlsAoyoeM10vdL/wYZynxSTguWiq28ExVcrO7Px6CJvMy3W+EFbLO+NgP g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="238996032"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="238996032"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:18:09 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="638694559"
...
Date: Tue, 22 Feb 2022 00:16:58 +0100
Message-Id: <20220221231705.1481059-17-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 7/9] drm/i915: Track leaked gt->wakerefs

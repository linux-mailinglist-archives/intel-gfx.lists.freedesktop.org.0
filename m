...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7353F307AD6
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Jan 2021 17:27:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E0ED6E9A8;
	Thu, 28 Jan 2021 16:27:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 256306E993
 for <intel-gfx@lists.freedesktop.org>; Thu, 28 Jan 2021 16:26:24 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 28 Jan 2021 17:25:31 +0100
Message-Id: <20210128162612.927917-23-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 22/63] drm/i915: Pass ww ctx to
...
aXNwbGF5L2ludGVsX2Rpc3BsYXkuYwppbmRleCAzZTI0ZGI4YjlhZDYuLjhhMGFmMjZiY2NlMiAx
...
NjgsNiArMTM2OCw3IEBAIHN0YXRpYyBib29sIGludGVsX3BsYW5lX3VzZXNfZmVuY2UoY29uc3Qg
...
Km91dF9mbGFncykKQEAgLTEzNzYsMTQgKzEzNzcsMTkgQEAgaW50ZWxfcGluX2FuZF9mZW5jZV9m
...
ZXJfb2ZfMihhbGlnbm1lbnQpKSkKIAkJcmV0dXJuIEVSUl9QVFIoLUVJTlZBTCk7CiAKQEAgLTE0
MTgsMTQgKzE0MjQsMjYgQEAgaW50ZWxfcGluX2FuZF9mZW5jZV9mYl9vYmooc3RydWN0IGRybV9m
...
c2luZwpAQCAtMTQ0NiwxNiArMTQ2NCwyOCBAQCBpbnRlbF9waW5fYW5kX2ZlbmNlX2ZiX29iaihz
...
dGltZV9wbSwgd2FrZXJlZik7CiAJcmV0dXJuIHZtYTsKQEAgLTEzNjA4LDE5ICsxMzYzOCwxMSBA
...
ZS0+ZmxhZ3MpOwpAQCAtMTM3MTAsMTMgKzEzNzMyLDggQEAgaW50ZWxfcHJlcGFyZV9wbGFuZV9m
...
ZXggNjRmZmEzNDU0NGE3Li5mMjg5NTFmNTU4NmUgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGlzcGxheS5oCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1
L2Rpc3BsYXkvaW50ZWxfZGlzcGxheS5oCkBAIC01NzAsNyArNTcwLDcgQEAgdm9pZCBpbnRlbF9y
...
ZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9mYmRldi5jCmluZGV4IDg0Zjg1M2Yx
MTNiOS4uZGRlOTZkMTg4YmFiIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNw
...

...
NywxMiArODAzLDEwIEBAIHN0YXRpYyBpbnQgaW50ZWxfb3ZlcmxheV9kb19wdXRfaW1hZ2Uoc3Ry
...

...
Mzc4LDExICszNzgsNiBAQCBpOTE1X2dlbV9vYmplY3RfcGluX3RvX2Rpc3BsYXlfcGxhbmUoc3Ry
...
ZyB0aGF0IGlzIGFib3V0IHRvIG9jY3VyIGlzCkBAIC0zOTcsNyArMzkyLDcgQEAgaTkxNV9nZW1f
...
ZSBwaW5uZWQgaW4gdGhlIGRpc3BsYXkgcGxhbmUKQEAgLTQxMCwzMyArNDA1LDIwIEBAIGk5MTVf
...
aTkxNV9nZW1fb2JqZWN0LmgKaW5kZXggNDI1YmM2OGMxYzJkLi5iMjJkYzNkMmYzYjcgMTAwNjQ0
...


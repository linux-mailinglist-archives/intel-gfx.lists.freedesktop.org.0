...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A2B9699E21
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Feb 2023 21:45:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1ED1210EEC3;
...
Subject: [Intel-gfx] [PATCH 3/4] drm/displayid: provide access to DisplayID
 version and primary use case

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7109145A70D
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Nov 2021 16:59:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E49DE6E10B;
	Tue, 23 Nov 2021 15:59:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D748F6E10B
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Nov 2021 15:59:23 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10176"; a="215755110"
X-IronPort-AV: E=Sophos;i="5.87,258,1631602800"; d="scan'208";a="215755110"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Nov 2021 07:59:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.87,258,1631602800"; d="scan'208";a="457092168"
Received: from irsmsx605.ger.corp.intel.com ([163.33.146.138])
 by orsmga006.jf.intel.com with ESMTP; 23 Nov 2021 07:59:22 -0800
Received: from fmsmsx611.amr.corp.intel.com (10.18.126.91) by
 IRSMSX605.ger.corp.intel.com (163.33.146.138) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2242.12; Tue, 23 Nov 2021 15:59:20 +0000
Received: from fmsmsx611.amr.corp.intel.com ([10.18.126.91]) by
 fmsmsx611.amr.corp.intel.com ([10.18.126.91]) with mapi id 15.01.2242.012;
 Tue, 23 Nov 2021 07:59:19 -0800
...
Thread-Index: AQHX3+2SwoFlDoYHdUybS+QOIjdGjawRSmIA///DGvCAAJcVgP//j+mQgACNxYD//3sA4A==
Date: Tue, 23 Nov 2021 15:59:19 +0000
Message-ID: <b1dcee8c618f4e6b92e7f28696742425@intel.com>
References: <20211122211420.31584-1-stanislav.lisovskiy@intel.com>
 ...
 <7f08db92de8746bda63bd4f6c7957e60@intel.com>
 <20211123152259.GA31144@intel.com>
In-Reply-To: <20211123152259.GA31144@intel.com>
...
Yeah, I don't think much of the process has been documented. Might be good =
for us
to discuss and/or put something together. The ack was something we did in t=
he last
cycle and it seemed like something we were going to do for this one as well=
.

> How do we proceed then? Should I revert and push the fixed version or do =
we
...
Reverting and waiting for IGT tests to at least be on the list seems like a=
 reasonable
plan to me. I also think it's a good idea to continue waiting on an ack fro=
m mesa as
well. I'll be OOO this week for holidays, but I'm happy to discuss the latt=
er bit when
I get back.
...
> > > > > > > Signed-off-by: Juha-Pekka Heikkil=E4
...
> > > > > >
> > > > > > > +       }, {
> > > > > > >                 .modifier =3D I915_FORMAT_MOD_Y_TILED_GEN12_M=
C_CCS,
...
> > > > > > > +       case I915_FORMAT_MOD_4_TILED:
> > > > > > > +               /*
> > > > > > > +                * Each 4K tile consists of 64B(8*8) subtiles=
, with
...
> > > > > *crtc,
> > > > > > >                 else
> > > > > > >                         fb->modifier =3D I915_FORMAT_MOD_Y_TI=
LED;
> > > > > > >                 break;
...
> > > > > > > +                       fb->modifier =3D I915_FORMAT_MOD_4_TI=
LED;
> > > > > > > +               } else {
> > > > > > > +                       if (val &
> PLANE_CTL_RENDER_DECOMPRESSION_ENABLE)
...
> > > =3D=3D 7)
> > > > > > >
> > > > > > >  #define HAS_LLC(dev_priv)      (INTEL_INFO(dev_priv)->has_ll=
c)
> > > > > > > +#define HAS_4TILE(dev_priv)    (INTEL_INFO(dev_priv)->has_4t=
ile)
> > > > > > >  #define HAS_SNOOP(dev_priv)    (INTEL_INFO(dev_priv)->has_sn=
oop)
...
> > > > > > >         }
> > > > > > >
> > > > > > >         wp->y_tiled =3D modifier =3D=3D I915_FORMAT_MOD_Y_TIL=
ED ||
> > > > > > > +                     modifier =3D=3D I915_FORMAT_MOD_4_TILED=
 ||
> > > > > > >                       modifier =3D=3D I915_FORMAT_MOD_Yf_TILE=
D ||
> > > > > > >                       modifier =3D=3D I915_FORMAT_MOD_Y_TILED=
_CCS ||
> > > > > > >                       modifier =3D=3D
...
> > > > > >
> > > > > > > + * This is a tiled layout using 4Kb tiles in row-major layou=
t.
...
> > > > > > Could we update it?
> > > > > > Here's a draft I came up with when wondering how I might do thi=
s
> myself:
> > > > > >

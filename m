...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 880781C45BA
	for <lists+intel-gfx@lfdr.de>; Mon,  4 May 2020 20:24:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9C08899A3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 0/9] Prefer drm_WARN* over WARN*

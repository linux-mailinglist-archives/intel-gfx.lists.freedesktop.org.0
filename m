...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 468E621FF27
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EE026E9B9;
...
Subject: [Intel-gfx] [PATCH v2 22/59] drm/kmb: Set hardcoded values to
 LCD_VSYNC_START

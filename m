...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DDD7B494B6B
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jan 2022 11:10:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 34EBA10E392;
	Thu, 20 Jan 2022 10:10:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A845210E392
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jan 2022 10:10:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642673443; x=1674209443;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=DkZIwlfwnQYr5mHrENDwI1EKgu44/4lwlScJr7QbDyc=;
 b=DjIV0XRvkXcFcMhRAQDwAsD+ziwIlXoUFD9IWL2RBHsrhl+4ROaI3j+H
 yqZg/5Up1y9ruzn0Y4x4tzWzDKa19f9OR3n6Z/NwWKiTXQkOMCBBnqENb
 VhPvu2DGr5hh2VeYGqPkOCKScJ6Ekjl4I8Ch9ti80wrFZ0IGQKv7zeAEB
 /VIa384LpPjPrZpVLe1ttqyskxvNN+7oaFP76gFrkyqjArYLXHpNGHKGl
 6WnEEjSKlWHFCNk7pjmoo0aP45du+VAqhXN8IP8tqAblI0Va0iSsBL+If
 Yw+KOzlg2GQxe6Ywow0/GKEwEbMTe4quCfjF9hMiIW+ZWp/wOOdCWL4Qo A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10232"; a="331670115"
X-IronPort-AV: E=Sophos;i="5.88,302,1635231600"; d="scan'208";a="331670115"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2022 02:10:42 -0800
X-IronPort-AV: E=Sophos;i="5.88,302,1635231600"; d="scan'208";a="532708504"
Received: from davidfsc-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.252.52.140])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2022 02:10:40 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: Matt Roper <matthew.d.roper@intel.com>, intel-gfx@lists.freedesktop.org
In-Reply-To: <20220120063809.1020633-7-matthew.d.roper@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20220120063809.1020633-1-matthew.d.roper@intel.com>
 <20220120063809.1020633-7-matthew.d.roper@intel.com>
Date: Thu, 20 Jan 2022 12:10:36 +0200
Message-ID: <87pmomafab.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain
Subject: Re: [Intel-gfx] [PATCH 6/6] drm/i915: Only include i915_reg.h from
 .c files
...
On Wed, 19 Jan 2022, Matt Roper <matthew.d.roper@intel.com> wrote:
...
> index 7d04572dd18b..a0b818b127df 100644
...
> index 2bf440eb400a..ab3ae245eb66 100644
...
> index 8ce5d2b2e330..54bfb0f928cd 100644
...
> index 40ace46bad46..c81f232d05a8 100644
...
> index 890f1f6fbc49..e969a5ca5038 100644
...
> index 5e283bdb3ab7..f51751f9c8d8 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E1E07129BC9
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Dec 2019 00:23:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B55689ABA;
	Mon, 23 Dec 2019 23:23:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D01C489ABA
 for <intel-gfx@lists.freedesktop.org>; Mon, 23 Dec 2019 23:23:01 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga102.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 23 Dec 2019 15:23:01 -0800
X-IronPort-AV: E=Sophos;i="5.69,349,1571727600"; d="scan'208";a="367180876"
Received: from ldmartin-desk1.jf.intel.com (HELO ldmartin-desk1)
 ([10.24.14.204])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 23 Dec 2019 15:23:00 -0800
Date: Mon, 23 Dec 2019 15:22:55 -0800
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: Matt Roper <matthew.d.roper@intel.com>
Message-ID: <20191223232255.j63s2xllbu5yh5so@ldmartin-desk1>
...
In-Reply-To: <20191223231330.GP2877816@mdroper-desk1.amr.corp.intel.com>
...
>> @@ -247,7 +247,7 @@ static void hsw_post_disable_crt(struct intel_encode=
r *encoder,
>>
...
>> @@ -427,7 +427,7 @@ static int hsw_crt_compute_config(struct intel_encod=
er *encoder,
>>  	return 0;
>>  }
>>
...
>> @@ -535,7 +535,7 @@ static bool intel_crt_detect_hotplug(struct drm_conn=
ector *connector)
>>  	int i, tries =3D 0;
>>
...
>> @@ -3898,7 +3898,7 @@ static void intel_ddi_post_disable(struct intel_en=
coder *encoder,
...
>>  static struct intel_crtc_state *intel_crtc_state_alloc(struct intel_crt=
c *crtc);
...
>> @@ -415,7 +415,7 @@ static const struct intel_limit intel_limits_ironlak=
e_dac =3D {
...
>> @@ -428,7 +428,7 @@ static const struct intel_limit intel_limits_ironlak=
e_single_lvds =3D {
...
>>  	.vco =3D { .min =3D 1760000, .max =3D 3510000 },
>>  	.n =3D { .min =3D 1, .max =3D 3 },
>> @@ -442,7 +442,7 @@ static const struct intel_limit intel_limits_ironlak=
e_dual_lvds =3D {
>>  };
>>
...
>> @@ -455,7 +455,7 @@ static const struct intel_limit intel_limits_ironlak=
e_single_lvds_100m =3D {
>>  		.p2_slow =3D 14, .p2_fast =3D 14 },
>>  };
>>
...
>>  	.vco =3D { .min =3D 1760000, .max =3D 3510000 },
>>  	.n =3D { .min =3D 1, .max =3D 3 },
>> @@ -1637,7 +1637,7 @@ void vlv_wait_port_ready(struct drm_i915_private *=
dev_priv,
>>  		     I915_READ(dpll_reg) & port_mask, expected_mask);
>>  }
>>
>> -static void ironlake_enable_pch_transcoder(const struct intel_crtc_stat=
e *crtc_state)
>> +static void ilk_enable_pch_transcoder(const struct intel_crtc_state *cr=
tc_state)
>>  {
>>  	struct intel_crtc *crtc =3D to_intel_crtc(crtc_state->uapi.crtc);
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>> @@ -1735,8 +1735,8 @@ static void lpt_enable_pch_transcoder(struct drm_i=
915_private *dev_priv,
>>  		DRM_ERROR("Failed to enable PCH transcoder\n");
>>  }
>>
>> -static void ironlake_disable_pch_transcoder(struct drm_i915_private *de=
v_priv,
>> -					    enum pipe pipe)
>> +static void ilk_disable_pch_transcoder(struct drm_i915_private *dev_pri=
v,
>> +				       enum pipe pipe)
>>  {
>>  	i915_reg_t reg;
>>  	u32 val;
>> @@ -4869,8 +4869,8 @@ static void intel_fdi_normal_train(struct intel_cr=
tc *crtc)
>>  }
>>
...
>> @@ -5222,7 +5222,7 @@ static void ivb_manual_fdi_link_train(struct intel=
_crtc *crtc,
>>  	DRM_DEBUG_KMS("FDI train done.\n");
>>  }
>>
>> -static void ironlake_fdi_pll_enable(const struct intel_crtc_state *crtc=
_state)
>> +static void ilk_fdi_pll_enable(const struct intel_crtc_state *crtc_stat=
e)
>>  {
...
>> @@ -5259,7 +5259,7 @@ static void ironlake_fdi_pll_enable(const struct i=
...
>>  	struct drm_i915_private *dev_priv =3D to_i915(dev);
>> @@ -5289,7 +5289,7 @@ static void ironlake_fdi_pll_disable(struct intel_=
crtc *intel_crtc)
>>  	udelay(100);
>>  }
>>
...
>> @@ -5496,8 +5496,8 @@ int lpt_get_iclkip(struct drm_i915_private *dev_pr=
iv)
>>  				 desired_divisor << auxdiv);
>>  }
>>
>> -static void ironlake_pch_transcoder_set_timings(const struct intel_crtc=
_state *crtc_state,
>> -						enum pipe pch_transcoder)
>> +static void ilk_pch_transcoder_set_timings(const struct intel_crtc_stat=
e *crtc_state,
>> +					   enum pipe pch_transcoder)
>>  {
>>  	struct intel_crtc *crtc =3D to_intel_crtc(crtc_state->uapi.crtc);
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>> @@ -5601,8 +5601,8 @@ intel_get_crtc_new_encoder(const struct intel_atom=
ic_state *state,
>>   *   - DP transcoding bits
>>   *   - transcoder
>>   */
...
>>  	struct intel_crtc *crtc =3D to_intel_crtc(crtc_state->uapi.crtc);
>>  	struct drm_device *dev =3D crtc->base.dev;
>> @@ -5650,7 +5650,7 @@ static void ironlake_pch_enable(const struct intel=
_atomic_state *state,
>>
...
>>
>> @@ -5682,7 +5682,7 @@ static void ironlake_pch_enable(const struct intel=
_atomic_state *state,
>>  		I915_WRITE(reg, temp);
>>  	}
>>
...
>> @@ -5697,7 +5697,7 @@ static void lpt_pch_enable(const struct intel_atom=
ic_state *state,
...
>>  }
>> @@ -6047,7 +6047,7 @@ static void skl_pfit_enable(const struct intel_crt=
c_state *crtc_state)
>>  	}
>>  }
>>
...
>>  	struct intel_crtc *crtc =3D to_intel_crtc(crtc_state->uapi.crtc);
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>> @@ -6643,8 +6643,8 @@ static void intel_disable_primary_plane(const stru=
ct intel_crtc_state *crtc_stat
...
>> @@ -6680,7 +6680,7 @@ static void ironlake_crtc_enable(struct intel_atom=
ic_state *state,
...
>>  	crtc->active =3D true;
>>
>> @@ -6690,13 +6690,13 @@ static void ironlake_crtc_enable(struct intel_at=
omic_state *state,
...
>> @@ -6712,7 +6712,7 @@ static void ironlake_crtc_enable(struct intel_atom=
ic_state *state,
...
>>
>> @@ -6846,7 +6846,7 @@ static void hsw_crtc_enable(struct intel_atomic_st=
ate *state,
>>  	if (INTEL_GEN(dev_priv) >=3D 9)
...
>>  	/*
>>  	 * On ILK+ LUT must be loaded before the pipe is running but with
>> @@ -6895,7 +6895,7 @@ static void hsw_crtc_enable(struct intel_atomic_st=
ate *state,
>>  	}
>>  }
>>
>> -void ironlake_pfit_disable(const struct intel_crtc_state *old_crtc_stat=
e)
>> +void ilk_pfit_disable(const struct intel_crtc_state *old_crtc_state)
>>  {
>>  	struct intel_crtc *crtc =3D to_intel_crtc(old_crtc_state->uapi.crtc);
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>> @@ -6910,8 +6910,8 @@ void ironlake_pfit_disable(const struct intel_crtc=
...
>> @@ -6932,15 +6932,15 @@ static void ironlake_crtc_disable(struct intel_a=
tomic_state *state,
>>
...
>>  			i915_reg_t reg;
>> @@ -6960,7 +6960,7 @@ static void ironlake_crtc_disable(struct intel_ato=
mic_state *state,
...
>> @@ -7505,8 +7505,8 @@ static int pipe_required_fdi_lanes(struct intel_cr=
tc_state *crtc_state)
>>  	return 0;
>>  }
>>
>> -static int ironlake_check_fdi_lanes(struct drm_device *dev, enum pipe p=
ipe,
>> -				     struct intel_crtc_state *pipe_config)
...
>> @@ -7578,8 +7578,8 @@ static int ironlake_check_fdi_lanes(struct drm_dev=
ice *dev, enum pipe pipe,
>>  }
>>
>>  #define RETRY 1
...
>>  {
>>  	struct drm_device *dev =3D intel_crtc->base.dev;
>>  	const struct drm_display_mode *adjusted_mode =3D &pipe_config->hw.adju=
sted_mode;
>> @@ -7598,15 +7598,15 @@ static int ironlake_fdi_compute_config(struct in=
tel_crtc *intel_crtc,
>>
...
>>  		return ret;
>>
>> @@ -7812,7 +7812,7 @@ static int intel_crtc_compute_config(struct intel_=
crtc *crtc,
...
>>  	int i;
>> @@ -9722,12 +9722,12 @@ static void lpt_init_pch_refclk(struct drm_i915_=
private *dev_priv)
...
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>>  	u32 dpll, fp, fp2;
>> @@ -9909,7 +9909,7 @@ static void ironlake_compute_dpll(struct intel_crt=
c *crtc,
>>
...
>>
>>  	if (reduced_clock) {
>> @@ -9989,8 +9989,8 @@ static void ironlake_compute_dpll(struct intel_crt=
c *crtc,
...
>> @@ -10014,17 +10014,17 @@ static int ironlake_crtc_compute_clock(struct =
intel_crtc *crtc,
>>
...
>> @@ -10034,7 +10034,7 @@ static int ironlake_crtc_compute_clock(struct in=
tel_crtc *crtc,
>>  		return -EINVAL;
>>  	}
>>
...
>> @@ -10276,8 +10276,8 @@ skl_get_initial_plane_config(struct intel_crtc *=
crtc,
>>  	kfree(intel_fb);
>>  }
>>
...
>>  	struct drm_device *dev =3D crtc->base.dev;
>>  	struct drm_i915_private *dev_priv =3D to_i915(dev);
>> @@ -10300,8 +10300,8 @@ static void ironlake_get_pfit_config(struct inte=
l_crtc *crtc,
>>  	}
>>  }
>>
...
>>  	struct drm_device *dev =3D crtc->base.dev;
>>  	struct drm_i915_private *dev_priv =3D to_i915(dev);
>> @@ -10372,7 +10372,7 @@ static bool ironlake_get_pipe_config(struct inte=
l_crtc *crtc,
...
>>  			/*
>> @@ -10400,7 +10400,7 @@ static bool ironlake_get_pipe_config(struct inte=
l_crtc *crtc,
...
>>  	}
>> @@ -10408,7 +10408,7 @@ static bool ironlake_get_pipe_config(struct inte=
l_crtc *crtc,
...
>>  	ret =3D true;
>>
>> @@ -10769,7 +10769,7 @@ static void hsw_get_ddi_port_state(struct intel_=
crtc *crtc,
>>  		pipe_config->fdi_lanes =3D ((FDI_DP_PORT_WIDTH_MASK & tmp) >>
>>  					  FDI_DP_PORT_WIDTH_SHIFT) + 1;
>>
...
>>  }
>>
>> @@ -10921,7 +10921,7 @@ static bool hsw_get_pipe_config(struct intel_crt=
c *crtc,
>>  		if (INTEL_GEN(dev_priv) >=3D 9)
...
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>>
>> @@ -14472,9 +14472,9 @@ static void intel_pipe_fastset(const struct inte=
l_crtc_state *old_crtc_state,
>>  			skl_pfit_enable(new_crtc_state);
...
>> @@ -16826,13 +16826,13 @@ void intel_init_display_hooks(struct drm_i915_=
private *dev_priv)
...
>>  		dev_priv->display.get_initial_plane_config =3D
>> @@ -16878,7 +16878,7 @@ void intel_init_display_hooks(struct drm_i915_pr=
ivate *dev_priv)
>>  	}
>>
...
>> @@ -521,7 +521,7 @@ int intel_get_pipe_from_crtc_id_ioctl(struct drm_dev=
ice *dev, void *data,
...
>>  	u32 control;
>> @@ -2703,7 +2703,7 @@ static bool edp_panel_vdd_on(struct intel_dp *inte=
l_dp)
...
>> @@ -2919,7 +2919,7 @@ static void edp_panel_off(struct intel_dp *intel_d=
p)
>>  	WARN(!intel_dp->want_panel_vdd, "Need [ENCODER:%d:%s] VDD to turn off =
panel\n",
>>  	     dig_port->base.base.base.id, dig_port->base.base.name);
>>
>> -	pp =3D ironlake_get_pp_control(intel_dp);
>> +	pp =3D ilk_get_pp_control(intel_dp);
>>  	/* We need to switch off panel power _and_ force vdd, for otherwise so=
me
>>  	 * panels get very unhappy and cease to work. */
>>  	pp &=3D ~(PANEL_POWER_ON | PANEL_POWER_RESET | EDP_FORCE_VDD |
>> @@ -2968,7 +2968,7 @@ static void _intel_edp_backlight_on(struct intel_d=
p *intel_dp)
...
>> @@ -3004,7 +3004,7 @@ static void _intel_edp_backlight_off(struct intel_=
dp *intel_dp)
>>  		i915_reg_t pp_ctrl_reg =3D _pp_ctrl_reg(intel_dp);
>>  		u32 pp;
>>
...
>>
>>  		I915_WRITE(pp_ctrl_reg, pp);
>> @@ -3042,7 +3042,7 @@ static void intel_edp_backlight_power(struct intel=
...
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>> @@ -3119,8 +3119,8 @@ static void ironlake_edp_pll_on(struct intel_dp *i=
ntel_dp,
>>  	udelay(200);
>>  }
>>
...
>>  	struct intel_crtc *crtc =3D to_intel_crtc(old_crtc_state->uapi.crtc);
>>  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
>> @@ -3410,7 +3410,7 @@ static void g4x_post_disable_dp(struct intel_encod=
er *encoder,
>>
>>  	/* Only ilk+ has port A */
...
>> @@ -6693,7 +6693,7 @@ intel_pps_readout_hw_state(struct intel_dp *intel_=
dp, struct edp_power_seq *seq)
>>
...
>>  	if (!HAS_DDI(dev_priv))
>> @@ -6863,7 +6863,7 @@ intel_dp_init_panel_power_sequencer_registers(stru=
...
>> @@ -250,7 +250,7 @@ static void intel_mst_post_disable_dp(struct intel_e=
ncoder *encoder,
>>  	if (INTEL_GEN(dev_priv) >=3D 9)
>>  		skl_scaler_disable(old_crtc_state);
>>  	else
...
>> @@ -126,8 +126,8 @@ static void i9xx_set_fifo_underrun_reporting(struct =
drm_device *dev,
>>  	}
>>  }
>>
...
>> @@ -264,7 +264,7 @@ static bool __intel_set_cpu_fifo_underrun_reporting(=
...
>> -			     unsigned int retry)
>> +static int ilk_do_reset(struct intel_gt *gt, intel_engine_mask_t engine=
_mask,
>> +			unsigned int retry)
>>  {
>>  	struct intel_uncore *uncore =3D gt->uncore;
>>  	int ret;
>> @@ -597,7 +596,7 @@ static reset_func intel_get_gpu_reset(const struct i=
ntel_gt *gt)
...
>> @@ -2031,7 +2031,7 @@ static void ivb_display_irq_handler(struct drm_i91=
5_private *dev_priv,
...
>> @@ -2742,7 +2742,7 @@ static void vlv_display_irq_postinstall(struct drm=
...
>>
>> @@ -3225,7 +3225,7 @@ static void ibx_irq_postinstall(struct drm_i915_pr=
ivate *dev_priv)
...
>> @@ -3980,7 +3980,7 @@ static irq_handler_t intel_irq_handler(struct drm_=
...
>>  }
>>
>> @@ -4003,7 +4003,7 @@ static void intel_irq_reset(struct drm_i915_privat=
e *dev_priv)
>>  		else if (INTEL_GEN(dev_priv) >=3D 8)
...
>>  }
>>
>> @@ -4026,7 +4026,7 @@ static void intel_irq_postinstall(struct drm_i915_=
private *dev_priv)
>>  		else if (INTEL_GEN(dev_priv) >=3D 8)
...
>>  }
>>
>> -static void i915_ironlake_get_mem_freq(struct drm_i915_private *dev_pri=
v)
>> +static void ilk_get_mem_freq(struct drm_i915_private *dev_priv)
>>  {
>>  	u16 ddrpll, csipll;
>>
>> @@ -7182,7 +7182,7 @@ void intel_init_pm(struct drm_i915_private *dev_pr=
iv)

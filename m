...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8962546591
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jun 2019 19:20:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C53D989B70;
...
Subject: Re: [Intel-gfx] Drop use of DRM_WAIT_ON() [Was: drm/drm_vblank:
 Change EINVAL by the correct errno]

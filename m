...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C704E434E12
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Oct 2021 16:39:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5BAFF6E323;
...
Subject: Re: [Intel-gfx] [PATCH 3/9] drm/i915: extract bypass-llc check into
 helper

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C49E58B228
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Aug 2022 23:59:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF326A9AEC;
...
Subject: [Intel-gfx] [PATCH v5 23/33] drm: POC drm on dyndbg - use in core,
 2 helpers, 3 drivers.

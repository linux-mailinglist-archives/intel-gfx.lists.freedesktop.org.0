...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AD4AC6EB0A2
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 19:37:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE3BA10EE8B;
...
Subject: [Intel-gfx] [PATCH v4 0/8] drm/i915/mtl: Define MOCS and PAT tables
 for MTL

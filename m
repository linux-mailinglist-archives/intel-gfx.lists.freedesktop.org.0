...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D6BCAC276A2
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:25:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A73810EC50;
	Sat,  1 Nov 2025 03:25:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SMcbexTc";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DFBC210EC50;
 Sat,  1 Nov 2025 03:25:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761967543; x=1793503543;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Cv2wmAv+u49JYkIe5LDyPflUkE6uKWeRjs1Jjc6s6kI=;
 b=SMcbexTcAqFwxh0gFzujf5qO387lLLm8vf7A2Q//eL4MNG36ozC52mCR
 O02ImVydnZFi3tHWWWNIM19TTO0M50lBv0miSp+BvsoR/uB8tfFM3KHps
 F679zzFqiZI6QRb1p0zk6ZaCAYwHS4k8kGtC+tesmt6OMOdQuoGrjr/um
 AJoJA+7OeMnOFYtBFSfd/h/rUXRFhgH0jcWvUwj5gRgsJePe52AD9NlE8
 dYDJBu1FLlB6jchnjhgsNoDzb1/N5Hvx8ca6/YaoqObysRcl8Le6tBfy9
 ADnfsG1yiohkTGnH219qJLaj+dYmKPldQVslQlpFvjN/8lLVPI+wdr1p7 Q==;
X-CSE-ConnectionGUID: Q2Qvo4L9Rdm4ld2BuF0Q0w==
X-CSE-MsgGUID: VdgHYG2pSHClzNbq4dx3qg==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="64019865"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="64019865"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:25:42 -0700
X-CSE-ConnectionGUID: UagpovbyQfi02iB4+p6qzA==
X-CSE-MsgGUID: Na10S5Q2RhKyE18cTE8f9g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217038001"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa002.jf.intel.com with ESMTP; 31 Oct 2025 20:25:41 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-xe@lists.freedesktop.org,
	intel-gfx@lists.freedesktop.org
Cc: Suraj Kandpal <suraj.kandpal@intel.com>,
 Arun R Murthy <arun.r.murthy@intel.com>
Subject: [PATCH v5 13/25] drm/i915/ltphy: Program the P2P Transaction flow for
 LT Phy
Date: Sat,  1 Nov 2025 08:55:01 +0530
Message-Id: <20251101032513.4171255-14-suraj.kandpal@intel.com>
...
index 7d57f0d8d4d7..f7b4a5746c86 100644

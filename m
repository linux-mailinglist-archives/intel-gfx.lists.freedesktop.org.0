...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F6F1A5CCFE
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Mar 2025 19:01:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8AC6A10E663;
	Tue, 11 Mar 2025 18:01:04 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UkIQJKZB";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 724AE10E650;
 Tue, 11 Mar 2025 18:01:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1741716063; x=1773252063;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Ib0ON780FYT1QcU8NKhjtx1LL5kLfPNv5oUxM5xTXdE=;
 b=UkIQJKZB77ny5CpR4ii84lDzOmjcSM55V9PVmURAqwdqRIJEaHrLIpyU
 0OHTZeRGkeRxIZp3EV185aUvKnp9TWd3jtDJKd4pLbmhtdg2tZdzQLt0f
 Zd2LQOQnGJ3wXfY61UwQVfHeNkU4BRJvPOyrorr5fix/ZbUyhwFnEgGXJ
 x+4f8mD0cMpTi6Er6U4FHryds9Ry28TR9N50boc9PsVU+uGUqvLWtXdjD
 zg6Kgte44bvwImNKj7lxlj7B8EoQM5ve9xwI/ZgYf5C8TYqR7+ugd5Jr5
 7/90w6vXbv+LVjCnu0Wx2U79OA+nUDQzI1ZlC/W7EuxlJFTaYP1N4DJSX A==;
X-CSE-ConnectionGUID: 3e7bJ2YkRj+lp3Y2CIdHSw==
X-CSE-MsgGUID: mtOsc+DZR/mmHQM4bxJJZg==
X-IronPort-AV: E=McAfee;i="6700,10204,11370"; a="42805789"
X-IronPort-AV: E=Sophos;i="6.14,239,1736841600"; d="scan'208";a="42805789"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2025 11:01:03 -0700
X-CSE-ConnectionGUID: 20VS617QRByxb3+aoLXoGg==
X-CSE-MsgGUID: XeVLzeUlS8SvehNoOQt7pw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,239,1736841600"; d="scan'208";a="125457144"
Received: from carterle-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.184])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2025 11:01:01 -0700
...
Subject: [PATCH 3/9] drm/i915/hotplug: convert intel_hotplug.[ch] to struct
 intel_display
Date: Tue, 11 Mar 2025 20:00:37 +0200
Message-Id: <36abad1ae08a76978ac5a2011d89a1dacbf0ac2a.1741715981.git.jani.nikula@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63CD64FBE83
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:14:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AB2F10EB36;
...
Subject: [Intel-gfx] [PATCH 06/34] drm/i915/gvt: move the gvt code into
 kvmgt.ko

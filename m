...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D1B292DF86
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Jul 2024 07:29:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B196A10E77A;
	Thu, 11 Jul 2024 05:29:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=linux.microsoft.com header.i=@linux.microsoft.com header.b="LAjbe8Nz";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
 by gabe.freedesktop.org (Postfix) with ESMTP id 8EC8D10E331;
 Thu, 11 Jul 2024 05:29:04 +0000 (UTC)
Received: from rrs24-12-35.corp.microsoft.com (unknown [131.107.159.213])
 by linux.microsoft.com (Postfix) with ESMTPSA id 43B1020B7165;
 Wed, 10 Jul 2024 22:29:04 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 43B1020B7165
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
 s=default; t=1720675744;
 bh=DXk//xpE1Oq9XGH/dGYEVxpmNgPIksdaBPVlpvJ7rzM=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=LAjbe8Nzh2m5PPwDcctRzn9J9+c3KZwkmJr3c2EzgBc3Cj99uBWdVgzP60S/rVYMr
 lyduaKcuIfOA6OjrN1LvR4UAwIr5Zb4DXyLNwMtUcPap31BP3hNPnxQ31JMDqxrk60
 bReDrRYdmmj+bqFtGzhSM12dMWvJX5RH6TXzqgxM=
...
Subject: [PATCH v4 3/6] drm/i915: Make I2C terminology more inclusive
Date: Thu, 11 Jul 2024 05:27:31 +0000
Message-Id: <20240711052734.1273652-4-eahariha@linux.microsoft.com>

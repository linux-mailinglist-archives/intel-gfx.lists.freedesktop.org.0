...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8764132AB9B
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Mar 2021 21:36:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD4B26E0EE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/atomic: Add the crtc to affected crtc only
 if uapi.enable = true

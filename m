...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66DF9BFFEEB
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Oct 2025 10:30:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C022110E8DB;
	Thu, 23 Oct 2025 08:30:19 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="BaWmAdrC";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 408F310E8DD;
 Thu, 23 Oct 2025 08:30:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761208218; x=1792744218;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=CfZ+UB2pFhjxdsBdIWj5lGHVkb1YIYK5lim8hTLx5G8=;
 b=BaWmAdrC+JDO9plfNQ/TulTPxSTBTk0kLW50V/R6MkrDCQcpFsoKO2fU
 NAEtArlDC+NpEjjkRIsKVQUPfQdRyJuiDxVOMNmuzsXxzr2XsPSaZk9mc
 eCwoVIXx5ozFMiSdoGBCC4uzNBiFPwG4Zy7fZBh1SZojC5BXFnedo5cgk
 GfqHGS/MBfRXRsQWd6w+vYzypzwPAbs1DKvG3l6fB7FhCUXJEY3QAk1qO
 Bq+GF9W3+jXxGSsVuJaAxhul8CjNTiz23L4w8XVeIArm72KrB3mEboiW9
 kA/ngWqQFeQWHqaWkRHMRj7tPVnvlqiTw+iVIAeVV2HYdJ4Rx5qHg4y0K g==;
X-CSE-ConnectionGUID: bRt9nGU8QsugKDYCig9Shw==
X-CSE-MsgGUID: xBotemH3TLqydK5zOBhvPg==
X-IronPort-AV: E=McAfee;i="6800,10657,11586"; a="63264858"
X-IronPort-AV: E=Sophos;i="6.19,249,1754982000"; d="scan'208";a="63264858"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Oct 2025 01:30:18 -0700
X-CSE-ConnectionGUID: x/IY6nQUS6++z68yI8JszA==
X-CSE-MsgGUID: g6hj4M2tSjmT/hIy/1yNAA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,249,1754982000"; d="scan'208";a="183319568"
...
Subject: [PATCH v3 1/3] drm/i915: Avoid lock inversion when pinning to GGTT on
 CHV/BXT+VTD
Date: Thu, 23 Oct 2025 10:25:19 +0200
Message-ID: <20251023082925.351307-6-janusz.krzysztofik@linux.intel.com>

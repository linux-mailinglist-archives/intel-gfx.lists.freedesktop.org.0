...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6838828FE33
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Oct 2020 08:20:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4AAA06E9B1;
	Fri, 16 Oct 2020 06:20:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 05B9F6E9B1;
 Fri, 16 Oct 2020 06:20:32 +0000 (UTC)
IronPort-SDR: P8stUfp+aJdcfYxJmtJJwQ/e6for6ojvv7ECyOdrksfUXM/qIJeLLFD+0+oYkgeYPDfISHOxj/
 wVO1a4diIq+g==
X-IronPort-AV: E=McAfee;i="6000,8403,9775"; a="163919601"
X-IronPort-AV: E=Sophos;i="5.77,381,1596524400"; d="scan'208";a="163919601"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Oct 2020 23:20:32 -0700
IronPort-SDR: bK+ea9Kgv1kB0m0i+PoRrMvIwp+m58jsoefVwqLA8fxr6AUjJNa4Yl4hge5L8aEINSA9OfyVAO
 crbyvW5woAmw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,381,1596524400"; d="scan'208";a="531594012"
Received: from unknown (HELO [10.239.160.24]) ([10.239.160.24])
 by orsmga005.jf.intel.com with ESMTP; 15 Oct 2020 23:20:30 -0700
To: Zhenyu Wang <zhenyuw@linux.intel.com>, "Yuan, Hang" <hang.yuan@intel.com>
References: <20201016055959.295529-1-colin.xu@intel.com>
 <20201016055426.GH27141@zhen-hp.sh.intel.com>
From: Colin Xu <Colin.Xu@intel.com>
Message-ID: <442b4abf-1f26-0804-6881-2bc9bef79c1c@intel.com>
Date: Fri, 16 Oct 2020 14:20:29 +0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.12.0
MIME-Version: 1.0
In-Reply-To: <20201016055426.GH27141@zhen-hp.sh.intel.com>
Content-Language: en-US
Subject: Re: [Intel-gfx] [PATCH v4 1/2] drm/i915/gvt: Save/restore HW status
...
>> @@ -2533,6 +2533,11 @@ static void intel_vgpu_destroy_ggtt_mm(struct int=
el_vgpu *vgpu)
>>   	}
...
>> +	}
>> +}
>> diff --git a/drivers/gpu/drm/i915/gvt/gtt.h b/drivers/gpu/drm/i915/gvt/g=
tt.h
>> index 52d0d88abd86..141e0a41cd50 100644
>> --- a/drivers/gpu/drm/i915/gvt/gtt.h
>> +++ b/drivers/gpu/drm/i915/gvt/gtt.h
>> @@ -280,5 +280,7 @@ int intel_vgpu_emulate_ggtt_mmio_write(struct intel_=
vgpu *vgpu,
...
>>   #endif /* _GVT_GTT_H_ */
>> diff --git a/drivers/gpu/drm/i915/gvt/gvt.c b/drivers/gpu/drm/i915/gvt/g=
vt.c
...
>> @@ -3092,9 +3092,10 @@ static int init_skl_mmio_info(struct intel_gvt *g=
vt)
...
>> @@ -3631,3 +3632,35 @@ int intel_vgpu_mmio_reg_rw(struct intel_vgpu *vgp=
...
>> +	}
>> +}
>> diff --git a/drivers/gpu/drm/i915/gvt/mmio.h b/drivers/gpu/drm/i915/gvt/=
mmio.h
...
>>   int intel_vgpu_mask_mmio_write(struct intel_vgpu *vgpu, unsigned int o=
ffset,
...
>> @@ -396,6 +396,7 @@ static struct intel_vgpu *__intel_gvt_create_vgpu(st=
ruct intel_gvt *gvt,
...
>>   	if (ret)
>> diff --git a/drivers/gpu/drm/i915/intel_gvt.c b/drivers/gpu/drm/i915/int=
el_gvt.c
...
>> @@ -147,3 +148,31 @@ void intel_gvt_driver_remove(struct drm_i915_privat=
e *dev_priv)
>>   =
...
>> + *
>> + * This function is called at the i915 driver suspend stage to save nec=
essary
...
>> + * @dev_priv: drm i915 private *
>> + *
>> + * This function is called at the i915 driver resume stage to restore r=
equired
...
>> +}
>> diff --git a/drivers/gpu/drm/i915/intel_gvt.h b/drivers/gpu/drm/i915/int=
el_gvt.h
>> index 502fad8a8652..5732c7b10ab2 100644
>> --- a/drivers/gpu/drm/i915/intel_gvt.h
>> +++ b/drivers/gpu/drm/i915/intel_gvt.h
>> @@ -33,6 +33,8 @@ int intel_gvt_init_device(struct drm_i915_private *dev=
_priv);
...
>>   {
>> @@ -46,6 +48,14 @@ static inline void intel_gvt_driver_remove(struct drm=

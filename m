...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7DB7410D412
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Nov 2019 11:30:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0C366E8BC;
...
Subject: [Intel-gfx] [PATCH v2 07/14] video: omapfb: use const pointer for
 fb_ops

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 16AB963A58B
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Nov 2022 10:59:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86DC410E205;
	Mon, 28 Nov 2022 09:59:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7137810E1F1
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=0s5cnjius6eVvJUg3vLIF7QmZ2JJjN1TxteYnRvJ9qA=;
 b=S9L3BZNHVxFgWqYu6HR+59q2wEBDrl4GFgmretlNKHANV1E4fIUTzZew
 /4NiJ9qDas/o+1eqMe6PcxOV3NuvwiQgoC+R5NyaYKRxvrlpwiS9GSU6p
 zjuNsISFDfJxCgWBm+Fx50m2JhAPBvcsQboWMg9jFQnPrUMk5BH6ruyOu
 nVE36o+cjYWB2HbuqE3unHwkiJjPsxZgOk/vHs6hVlc60QoxjKwrheeCH
 EmLIk/PH7zo873HqqQiNozYOtSN2LtpfHhOuuGnrxYeLMW4MLZEoGgCTo
 bXE0FUe8jB0uU6YonB+4qEyiuDQnjjsSs0YRCNEZa6RM19BNG2RRhDCUK w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10544"; a="315950440"
X-IronPort-AV: E=Sophos;i="5.96,200,1665471600"; d="scan'208";a="315950440"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2022 01:59:13 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10544"; a="674169436"
X-IronPort-AV: E=Sophos;i="5.96,200,1665471600"; d="scan'208";a="674169436"
Received: from aravind-dev.iind.intel.com ([10.145.162.80])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2022 01:59:11 -0800
From: Aravind Iddamsetty <aravind.iddamsetty@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Nov 2022 15:43:50 +0530
Message-Id: <3a47d428e1929942374b9eaead5372bfaaefdeed.1669629369.git.aravind.iddamsetty@intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 1/3] drm/i915/mtl: Define MOCS and PAT tables
 for MTL

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6611A894CD6
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Apr 2024 09:49:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CBEAF10FAFA;
	Tue,  2 Apr 2024 07:49:06 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Qah5btwD";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AFCC510F3D8;
 Tue,  2 Apr 2024 07:49:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1712044145; x=1743580145;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=9OJYyvY8/hBGzW3Rf8/J+ZMGx8aGP9mf0g9/VP6OVyU=;
 b=Qah5btwDXehp8brXpgrgzTdqGwjQyRM5B2So8YqIhkm4GdnJ9LA3w6QM
 N/VxnRaHRnPAYQDWRZqPhqhD4yvahhqEGeEFXH+6Z5vttxTJThgay7eM4
 xpv0UlSe2HZxLVDTz7cC1iaLQHfa4e0wt6xHnBpm0unp41ZAbTQzDY/3b
 DN4mQKhixGW9Xu/Z9qxtLqiJs/I2bMA38XUxx++kAOXtk15wYESIrc29b
 6ST9Bnsu9m5F2wZ7zWFpF0xTvrLEzMRHCvEMIPXwlEJj2qeswwy+lfTBh
 AulgjZV5zNd8cfx6zkDYUtAR0qzk8sFzv3mS5q79cngSLfd3cBCDx0+9L w==;
X-CSE-ConnectionGUID: cBJgin2ASbWOVblb3Ci1Lg==
X-CSE-MsgGUID: rIlyqix3TRunyr9XvmJjyw==
X-IronPort-AV: E=McAfee;i="6600,9927,11031"; a="17768387"
X-IronPort-AV: E=Sophos;i="6.07,174,1708416000"; d="scan'208";a="17768387"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2024 00:49:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,174,1708416000"; d="scan'208";a="41143402"
Received: from zkatz1-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.41.111])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2024 00:48:56 -0700

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D014D15340
	for <lists+intel-gfx@lfdr.de>; Mon,  6 May 2019 20:02:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4019289B78;
...
Subject: [Intel-gfx] [PATCH v5 00/11] drm/fb-helper: Move modesetting code
 to drm_client

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A772557D97
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jun 2022 16:13:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 801F910E25D;
	Thu, 23 Jun 2022 14:13:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8AF3210E1E1;
 Thu, 23 Jun 2022 14:13:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655993597; x=1687529597;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=OckPq3TCQ3S8Z2wVF7nl89nMA5jcXBxp1cP3DJ+etJU=;
 b=bbSS9DSpkd7YHJ1FT5vMzeM/PtQHAH3YfkpTucfXXScuyEBEb6wHk4RP
 WaCmkMPznaNBDfNS33WTpXmdzp/lzLM2vDyrV+fr9P6PoV/9Cz4NKg8Si
 jbjT1MC4RlpF2c6xZHo7DCclNhTlv6HHYNST8B4KEusG0FbrYzKxGebzB
 IOaj+vC7VzxwBsCHYEbVdOUKqLKcmKifRFtY6tLifWhhTtv+SBr65eyWB
 VORFdY0s4G8bsdSxyu8WEk/dk+GrNSU8Gp8vjhix9CpuXGZHUtWp4Hzpa
 b22kcdnbe6yjAhgV4vf8mhic6/553HEKXX37jq6z/QjA/O4/CXERU5z8r w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10386"; a="281807661"
X-IronPort-AV: E=Sophos;i="5.92,216,1650956400"; d="scan'208";a="281807661"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jun 2022 07:13:16 -0700
X-IronPort-AV: E=Sophos;i="5.92,216,1650956400"; d="scan'208";a="563465893"
Received: from mlloyd-mobl1.amr.corp.intel.com (HELO [10.213.238.120])
 ([10.213.238.120])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jun 2022 07:13:13 -0700
Message-ID: <27334c5e-6ee0-361a-cc93-9785f6c7136f@intel.com>
Date: Thu, 23 Jun 2022 15:13:11 +0100
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:91.0) Gecko/20100101
 Firefox/91.0 Thunderbird/91.10.0
Content-Language: en-GB
To: =?UTF-8?Q?Thomas_Hellstr=c3=b6m?= <thomas.hellstrom@linux.intel.com>,
 intel-gfx@lists.freedesktop.org, =?UTF-8?Q?christian_K=c3=b6nig?=
...
In-Reply-To: <142c82a44dc1ea6ec1d501d783679c3a513282b5.camel@linux.intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
Subject: Re: [Intel-gfx] [PATCH v2 10/12] drm/i915/ttm: handle blitter
 failure on DG2

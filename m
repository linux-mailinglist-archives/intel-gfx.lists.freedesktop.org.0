...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1104482E9F
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2019 11:23:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 174956E345;
	Tue,  6 Aug 2019 09:23:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 97A4C6E343
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Aug 2019 09:23:40 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17901475-1500050 
 for multiple; Tue, 06 Aug 2019 10:05:39 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Aug 2019 10:05:30 +0100
Message-Id: <20190806090535.14807-17-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/22] drm/i915: Protect request retirement with
 timeline->mutex
...
L2k5MTVfZ2VtX2V4ZWNidWZmZXIuYwppbmRleCBjZWUzNzMyMmI5NTMuLmRiOTk3ODIyN2VmMiAx
...
X2VuZ2luZV9jcy5jCmluZGV4IDBmODQxZTFlNTBjYS4uNDdmNTU1ZGZhMjg4IDEwMDY0NAotLS0g
YS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9lbmdpbmVfY3MuYworKysgYi9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9lbmdpbmVfY3MuYwpAQCAtNjk5LDcgKzY5OSw2IEBAIHN0
...
cy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZ3RfdHlwZXMuaAppbmRleCBlYzdiYWFlZDM5MWQuLjdl
Y2U2MmM0NjY2YyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZ3Rf
...

...
OTE1L2d0L21vY2tfZW5naW5lLmMKaW5kZXggNDQwODFlY2ZiYjliLi5lNjVhZjlmMzA1MjMgMTAw
...
cml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9zZWxmdGVzdF9jb250ZXh0LmMKaW5kZXggOWQzY2RjYzY3
YjRkLi5kYWIwYzAzMGU5ZTQgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L3Nl
...
ZHJtL2k5MTUvaTkxNV9yZXF1ZXN0LmMKaW5kZXggMzBhZTJkNjMwMDIyLi43ZTJkMmQyMjc4NGUg
MTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfcmVxdWVzdC5jCisrKyBiL2Ry
aXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfcmVxdWVzdC5jCkBAIC0xODAsNDAgKzE4MCw2IEBAIGk5
...
cHR1cmU7CkBAIC0yMzEsNyArMTk3LDcgQEAgc3RhdGljIGJvb2wgaTkxNV9yZXF1ZXN0X3JldGly
...
QEAgLTI0Myw3ICsyMDksMTcgQEAgc3RhdGljIGJvb2wgaTkxNV9yZXF1ZXN0X3JldGlyZShzdHJ1
...
ZyByZXRpcmUgb24gZWFjaC4gVGhpcyBhbGxvd3MKQEAgLTMyMCw3ICsyOTYsNyBAQCBzdGF0aWMg
...
IAogCUdFTV9UUkFDRSgiJXMgZmVuY2UgJWxseDolbGxkLCBjdXJyZW50ICVkXG4iLApAQCAtMzI4
LDE1ICszMDQsMTEgQEAgdm9pZCBpOTE1X3JlcXVlc3RfcmV0aXJlX3VwdG8oc3RydWN0IGk5MTVf
...
IHJxKTsKIH0KIApAQCAtNTYzLDI5ICs1MzUsMjggQEAgc2VtYXBob3JlX25vdGlmeShzdHJ1Y3Qg
...
bGFiX3JlcXVlc3RzLApAQCAtNTk0LDExICs1NjUsMTEgQEAgcmVxdWVzdF9hbGxvY19zbG93KHN0
...
ZnApOwpAQCAtNjQ5LDcgKzYyMCw3IEBAIF9faTkxNV9yZXF1ZXN0X2NyZWF0ZShzdHJ1Y3QgaW50
...
NDEsMTUgKzcxMiwxNSBAQCBzdHJ1Y3QgaTkxNV9yZXF1ZXN0ICoKIGk5MTVfcmVxdWVzdF9jcmVh
...
QEAgLTc1OSwyMiArNzMwLDIyIEBAIGk5MTVfcmVxdWVzdF9jcmVhdGUoc3RydWN0IGludGVsX2Nv
...
dG8gYSBoaWdoIHByaW9yaXR5CkBAIC0xMjM1LDEwICsxMjAyLDExIEBAIHN0cnVjdCBpOTE1X3Jl
...
cSk7CiAKQEAgLTEyNjEsMTAgKzEyMjksMTAgQEAgdm9pZCBpOTE1X3JlcXVlc3RfYWRkKHN0cnVj
...
ZWQgbG9uZyBsb2NhbF9jbG9ja191cyh1bnNpZ25lZCBpbnQgKmNwdSkKQEAgLTE0ODQsMTggKzE0
NTIsNDMgQEAgbG9uZyBpOTE1X3JlcXVlc3Rfd2FpdChzdHJ1Y3QgaTkxNV9yZXF1ZXN0ICpycSwK

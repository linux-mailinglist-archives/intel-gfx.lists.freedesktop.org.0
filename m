...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A4A654798A2
	for <lists+intel-gfx@lfdr.de>; Sat, 18 Dec 2021 05:44:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D4A8F10EB6E;
...
Subject: Re: [Intel-gfx] [PATCH v8 11/16] drm/i915/gem: Use to_gt() helper
 for GGTT accesses

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4ED06616A0C
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Nov 2022 18:08:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D458E10E51D;
...
Subject: [Intel-gfx] [PATCH v2 1/5] drm/i915/mtl: add initial definitions
 for GSC CS

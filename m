...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A372D307723
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Jan 2021 14:31:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 242346E954;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 3/5] drm/i915/gvt: Remove references to

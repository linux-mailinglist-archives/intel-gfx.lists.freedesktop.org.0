...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7DF617627F0
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jul 2023 03:02:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2DE110E406;
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/guc/slpc: Restore efficient freq
 earlier

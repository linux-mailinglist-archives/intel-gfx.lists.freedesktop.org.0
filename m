...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 81B75C1EC60
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Oct 2025 08:34:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D21F210E8B7;
	Thu, 30 Oct 2025 07:34:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ek2fMH3O";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2912C10E8B6;
 Thu, 30 Oct 2025 07:34:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761809688; x=1793345688;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=zDeU1zZF9ie+XgXSMLKXia3fY+UcJUXRUFsFid9Xjfg=;
 b=ek2fMH3O7/45hslWbR5UzxbtN5falmSdk6+V5aAhy4uKKZyKFeHunCCc
 +iwUY6RZ6pFQA/XeFL3TNtag/IU7CiIfmtTSGp0Bk3tlzfIzqq9b18L5/
 NF1GyWm+V5zOSGqKvmDd4W/dcOcq4XkUW9NUR3usDJmfSuT3HP0/kG/s1
 OLzvEYn8H5jCdIbCEj66VZetWz49YRoJGWBBqE4LlxiccyVX3ToAInUST
 vPt2UaWvV7iSBdOfNAFLewUh0NZ0pjPXMqLHRFfoodoGx7GCUaiqWZ7Sk
 c95ryrajRCmDqKifGySFw2E65uP/51kKFfBn/i1ifcNvSgEjcdA6r50ej g==;
X-CSE-ConnectionGUID: lpo0n/5TSeaiG+7dgyYWCg==
X-CSE-MsgGUID: 88YVDpI0S4KCUyjKQWj9Hg==
X-IronPort-AV: E=McAfee;i="6800,10657,11597"; a="75063367"
X-IronPort-AV: E=Sophos;i="6.19,266,1754982000"; d="scan'208";a="75063367"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Oct 2025 00:34:48 -0700
X-CSE-ConnectionGUID: dbnYT5++SP2wmWwLx1mN5A==
X-CSE-MsgGUID: vjyJoxpUTg+FoNYJExboOQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,266,1754982000"; d="scan'208";a="185075315"
Received: from display-adls.igk.intel.com ([10.211.131.198])
 by orviesa006.jf.intel.com with ESMTP; 30 Oct 2025 00:34:46 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Imre Deak <imre.deak@intel.com>,
	Mika Kahola <mika.kahola@intel.com>
Subject: [PATCH 06/32] drm/i915/display: Move definition of Cx0 PHY functions
 earlier
Date: Thu, 30 Oct 2025 09:22:23 +0200
Message-Id: <20251030072249.155095-7-mika.kahola@intel.com>

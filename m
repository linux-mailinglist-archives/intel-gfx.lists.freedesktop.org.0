...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4ECD3433BEA
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Oct 2021 18:18:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C8A36E17B;
	Tue, 19 Oct 2021 16:18:34 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 1/2] drm/dp: add drm_dp_phy_name() for getting
 DP PHY name

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EFC24BA54E
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 17:00:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49B9110ED33;
	Thu, 17 Feb 2022 16:00:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6652210ED10
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Feb 2022 16:00:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645113631; x=1676649631;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=sLKyR0c0d9E3NAGT+TXH9u9VBvcg77Y9zkPCg3LnEzU=;
 b=NnjsbmbwN0mZJdX1/xiMggKjz45PSoM+tDeahTB1b4u4CbT+d2isu6Fw
 Bmu/wQgLU7lpNgNOHB40kmwCuKpln6iIwfPXoTipAdeE3ID5P1i3IVOUh
 zn1I6he6HpSqu789/5oMRZTDimQqDc+JkYJdpAFzrS9HMUDCxI1afvl6q
 QEp5h0FxeD0EQo4gZIED4GVmEFfNA4BNBmfJdO3ZAJ+lvEnOws7rIbHZP
 9QI2TNjMd69qTi3XoRJVfgQ4Xa/YCzj4v0XauT8FU0FBS+UQwHg0AWE/T
 MNKllHcyrKpyRyRvGj5dwB6AydU9quVGJraMBvEA6e3RFmi3nURZ2ln9G Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10261"; a="230865756"
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="230865756"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 08:00:23 -0800
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="530317784"
Received: from markorti-mobl.ger.corp.intel.com (HELO [10.213.216.21])
 ([10.213.216.21])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 08:00:18 -0800
Message-ID: <133f292b-2ef5-af35-d264-7d9c749a4098@linux.intel.com>
Date: Thu, 17 Feb 2022 16:00:15 +0000
MIME-Version: 1.0
...
References: <20220217152248.1016134-1-alexander.usyskin@intel.com>
 <20220217152248.1016134-2-alexander.usyskin@intel.com>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
In-Reply-To: <20220217152248.1016134-2-alexander.usyskin@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
Subject: Re: [Intel-gfx] [PATCH v9 1/5] drm/i915/gsc: add gsc as a mei
 auxiliary device
...
On 17/02/2022 15:22, Alexander Usyskin wrote:
...
>      add defence aginst discepancy between has_pxp flag and actual definition structure,
>      move more error prints to drm prints

No more blockers from my side. Thanks for doing the little tweaks!
...
> index 9d588d936e3d..d86f6b5ce397 100644
...
> index bf4b942c62ee..241a01f44e66 100644
...
> index 91677a9f330c..1a3e29b683c2 100644
...
> index 2243d9d1d941..ce79efe24bfd 100644

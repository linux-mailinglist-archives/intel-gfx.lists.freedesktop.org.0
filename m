...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 56EC436C14E
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Apr 2021 10:54:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F0DA6E91C;
	Tue, 27 Apr 2021 08:54:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F0D386E91C;
 Tue, 27 Apr 2021 08:54:41 +0000 (UTC)
IronPort-SDR: bmMLFXP8Kce/zv65NRg50wFRD3/oW2H8Eg3VrI/QQoUaRhv9JcEvgYFYauYEPubuneETUg0EsE
 zE/o+GJQZHqA==
X-IronPort-AV: E=McAfee;i="6200,9189,9966"; a="260428703"
X-IronPort-AV: E=Sophos;i="5.82,254,1613462400"; d="scan'208";a="260428703"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2021 01:54:41 -0700
IronPort-SDR: wnIlLnNIS2x3PesNr98v+HC6rXk/Q5IbajN1qsWTCo7oahIZJueIJrvj6VkBhGj7Y9NNzujv/A
 p3j8A6n9RQww==
X-IronPort-AV: E=Sophos;i="5.82,254,1613462400"; d="scan'208";a="422978858"
Received: from galinart-mobl.ger.corp.intel.com (HELO
 mwauld-desk1.ger.corp.intel.com) ([10.252.12.239])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2021 01:54:38 -0700
From: Matthew Auld <matthew.auld@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 27 Apr 2021 09:54:16 +0100
Message-Id: <20210427085417.120246-6-matthew.auld@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 6/7] drm/i915/lmem: Bypass aperture when lmem
 is available

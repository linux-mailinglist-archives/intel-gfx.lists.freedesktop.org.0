...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F3963FD133
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Sep 2021 04:21:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9751D6E10E;
...
Subject: [Intel-gfx] [PATCH 7/7] Me: Dump GuC log to dmesg on SLPC load
 failure

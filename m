...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A8E141916EC
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Mar 2020 17:52:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7ED0D6E4CB;
	Tue, 24 Mar 2020 16:51:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 090A76E4C1
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Mar 2020 16:51:52 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 24 Mar 2020 17:51:35 +0100
Message-Id: <20200324165146.1032624-10-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/21] drm/i915: Rework intel_context pinning to
...
index 210f60e14ef4..310cfc2d5ed8 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -2986,7 +2986,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3016,20 +3019,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3037,9 +3043,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3065,8 +3071,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -4843,13 +4851,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -4882,8 +4890,10 @@ static void virtual_context_exit(struct intel_context *ce)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFEB22DA53C
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Dec 2020 02:08:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D92926E0AC;
	Tue, 15 Dec 2020 01:08:21 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 340F46E0C6
 for <Intel-gfx@lists.freedesktop.org>; Tue, 15 Dec 2020 01:08:03 +0000 (UTC)
IronPort-SDR: xPH2m0N07cna+mWAeB18lAwFXYk3TYA616r+MnPATUV8nXyCyfNDUU+U+x0qrpiGHsLPgD5dQA
 jZGv7FsXbjhA==
X-IronPort-AV: E=McAfee;i="6000,8403,9835"; a="171297997"
X-IronPort-AV: E=Sophos;i="5.78,420,1599548400"; d="scan'208";a="171297997"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Dec 2020 17:08:01 -0800
IronPort-SDR: adqZleXVmxR7MJuPVEMqkYcaxxGTWbeKn1snqB3vHWRycOWVlbtSK/bvpNYSwc34RJyXIPSpP/
 p2IQMfmkeu5g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,420,1599548400"; d="scan'208";a="331861142"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga007.fm.intel.com with ESMTP; 14 Dec 2020 17:08:01 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Mon, 14 Dec 2020 17:07:16 -0800
Message-Id: <20201215010726.15898-14-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201215010726.15898-1-sean.z.huang@intel.com>
References: <20201215010726.15898-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v9 13/23] drm/i915/pxp: Add plane decryption
 support

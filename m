...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F6595FB3BB
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Oct 2022 15:50:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3605710E532;
...
Subject: [Intel-gfx] [PATCH 00/15] drm/edid: EDID override refactoring and
 fixes

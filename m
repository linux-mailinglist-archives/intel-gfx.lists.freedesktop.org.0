...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E01C4673FB1
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Jan 2023 18:15:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6F3A10E97C;
	Thu, 19 Jan 2023 17:15:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 95A1710E095;
 Thu, 19 Jan 2023 17:15:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1674148544; x=1705684544;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=tYdv/0f+pjWJglD8zW3Ul8PYz64bIrSLrzlN8UanuyQ=;
 b=cv05bZQiVLm2ScVw75vWIcEtNqQsNXmWJZBTaV9r4UhfkxAbotS/XVad
 sX+KmKaBYc6jNCTCveIocqMvltBndp/Lg5jVRFkPI+/nxYCHjysjdNCsD
 L5Ib+OJX3G7gX2gfqP5V4S2FufeKJiQYdrkiy8CuqU3gAxorJfT/vDTsI
 5BJwYhmVyabvsHwUFf+KdgkKoI6fOyvYT8Fpfafv4qvokwNSXo1Ps7+7U
 ynLRptJz6qZdwv/wxqlsIBXC6FKNuEpZ3XCniebMruDnDA3svYcbmgk5W
 ZxKtKcz1Had7/KdAiB9NNx2hGC2qzXhklX71uVeLmq7ONPqsn+8cESodx g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10595"; a="305716787"
X-IronPort-AV: E=Sophos;i="5.97,229,1669104000"; d="scan'208";a="305716787"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2023 09:11:31 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10595"; a="834044330"
X-IronPort-AV: E=Sophos;i="5.97,229,1669104000"; d="scan'208";a="834044330"
Received: from btbaby-mobl.ger.corp.intel.com (HELO [10.213.230.246])
 ([10.213.230.246])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2023 09:11:29 -0800
Message-ID: <334f3574-1764-cd7d-83fe-7a32be66cc12@linux.intel.com>
Date: Thu, 19 Jan 2023 17:11:27 +0000
MIME-Version: 1.0
...
References: <20230119164051.2819437-1-lucas.demarchi@intel.com>
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Organization: Intel Corporation UK Plc
In-Reply-To: <20230119164051.2819437-1-lucas.demarchi@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
Subject: Re: [Intel-gfx] [PATCH i-g-t] Remove sysfs_clients

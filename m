...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A9C54427C7
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 08:08:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67E8D6FAC8;
...
Subject: [Intel-gfx] [PATCH 26/29] drm/i915/gvt: pass a struct intel_vgpu to

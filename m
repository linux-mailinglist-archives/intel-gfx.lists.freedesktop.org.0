...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E7E34AC982
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Feb 2022 20:29:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1890310F8F3;
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915/uapi: Add query for hwconfig blob

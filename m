...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A63AA64D4
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Sep 2019 11:13:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 81179895D7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 4/7] drm/i915/dp: Attach colorspace property

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A3D9D4FBE95
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:14:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C780A10EC4A;
	Mon, 11 Apr 2022 14:14:53 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 14/34] drm/i915/gvt: devirtualize ->{get,
 put}_vfio_device

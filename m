...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AA8EF718E7B
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 00:28:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 130A010E1F1;
	Wed, 31 May 2023 22:27:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F0D7010E0D3
 for <intel-gfx@lists.freedesktop.org>; Wed, 31 May 2023 22:27:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685572075; x=1717108075;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=i56j+AsLzARKA9u4bHAP9ta4xLf7fG6gYXB4gP9+8hs=;
 b=lhHpitfMCD90Nb4OW4xO7/nPerFno2rWwybbKPI0u14zfXFwn/Wxi+dT
 dtVQDicBSJd52ZBspqLu3sWuuMQvYN3KB5iyBprtFqie9gFT4dcfxsV/w
 dshuro3dkxgcytWNEbApA8J5MA77CVvoCBRBGr1Lx2KXhNGkAN5VSrTtX
 JEAm/dm6EXKsdper2YxUYeQd02qa3W+cEMst2ztogbB9HEDfl5NI8t/yp
 TT75UQUdHkL1MhL3URH2iKNH+r7il/c3HtSUmR8WPfhQ3E4KyrohNKefF
 jNxwtsfrcoiTOeIrG9lEbNvmNlcyCoBpEqJGzZHVF/i4gEH4Klegpezw5 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="383651666"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; 
 d="scan'208,223";a="383651666"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2023 15:27:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="1037222166"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; 
 d="scan'208,223";a="1037222166"
Received: from gliakhov-mobl.ger.corp.intel.com (HELO
 vgovind2-mobl3.intel.com) ([10.252.47.114])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2023 15:27:52 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  1 Jun 2023 01:27:13 +0300
Message-Id: <20230531222714.439313-7-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 6/7] drm/i915/mtl: find the best QGV point

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3E438C6E74
	for <lists+intel-gfx@lfdr.de>; Thu, 16 May 2024 00:13:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F319A10E142;
	Wed, 15 May 2024 22:13:15 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="h3JpUwxZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 09B9A10E142
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 May 2024 22:13:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 sSPiwOl1TnbJAfdCKfdazCL6r7Hir3234i7afpYV9PsShcpb3EFcWm3yj Q==;
X-CSE-ConnectionGUID: Nam6r2DMSJK0avi0mgQPaQ==
X-CSE-MsgGUID: 9tIJl3YnShGIrVhD1ggMDA==
X-IronPort-AV: E=McAfee;i="6600,9927,11074"; a="23292862"
X-IronPort-AV: E=Sophos;i="6.08,162,1712646000"; d="scan'208";a="23292862"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2024 15:13:13 -0700
X-CSE-ConnectionGUID: A9VWFUUsTISe7GfSg3sLfA==
X-CSE-MsgGUID: LsnWEghHSmyN+35O9fPT1Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,162,1712646000"; d="scan'208";a="31134668"
Received: from rcheerla-mobl.amr.corp.intel.com (HELO [10.212.179.162])
 ([10.212.179.162])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2024 15:13:12 -0700

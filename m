...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id kEmXNF3jFmpIvAcAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 27 May 2026 14:28:13 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4101F5E42BB
	for <lists+intel-gfx@lfdr.de>; Wed, 27 May 2026 14:28:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 91FE910E7AD;
	Wed, 27 May 2026 12:28:11 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="mkz9GDE8";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4FD3A10E7B9;
 Wed, 27 May 2026 12:28:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1779884890; x=1811420890;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=nsyu9SnBH47KHotxyJjGi+QX34bNjV12+yahHwDs6FY=;
 b=mkz9GDE8KXnK62M8m4lDpWf35CZcknV0nAGllbfzt61B7i8TVKlkVFpV
 ivIN/VVrQlVm5gpXCiDUwRp3S3CygVYmmoR6OqxLPh7qQtC07b/hboGx1
 lsvzR65PpiYJeoj6xmRnsBtxriSX1Zjv2n3Mja+1fpiWzurMmPxZuwqhs
 rN/wOozeHomdwp4A+ccC902VwFGlNt64579iaQLfUz+WOg/wXQymxfZSx
 cc4Phh2A2s1KxSwyW2C8buDxKXRZKcBsLjbno/k15VX2nLrvCU2J5Au8o
 Y+HdkjGLjZX/w7HYqATezEYX17Q91psbZhHUk6+7GlgZq6uys+CrYii9g Q==;
X-CSE-ConnectionGUID: xNrI888gQc+joazFraoXMw==
X-CSE-MsgGUID: GREoiqSXRQeGx+Tq8YPy8Q==
X-IronPort-AV: E=McAfee;i="6800,10657,11799"; a="80823498"
X-IronPort-AV: E=Sophos;i="6.24,171,1774335600"; d="scan'208";a="80823498"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 May 2026 05:28:10 -0700
X-CSE-ConnectionGUID: se45Zmo6Tzaqm2OMLiuYRQ==
X-CSE-MsgGUID: Uj4t8IqlQD2n4n7NSUnKXg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.24,171,1774335600"; d="scan'208";a="239633548"
Received: from amilburn-desk.amilburn-desk (HELO localhost) ([10.245.245.38])
 by fmviesa008-auth.fm.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 May 2026 05:28:08 -0700
...
Subject: Re: [PATCH v4 07/13] drm/i915/display: Add DC3CO eligibility
 computation
In-Reply-To: <20260526191826.3786009-8-dibin.moolakadan.subrahmanian@intel.com>
...
Date: Wed, 27 May 2026 15:28:05 +0300
Message-ID: <5f8649f78febe065bb886f5318c98cabb7e44862@intel.com>
MIME-Version: 1.0

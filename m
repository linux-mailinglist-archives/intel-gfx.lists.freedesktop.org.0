...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 86FD6AAF75C
	for <lists+intel-gfx@lfdr.de>; Thu,  8 May 2025 12:04:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B6F410E8D9;
	Thu,  8 May 2025 10:04:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="KMVNE+IP";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 765CA10E8D4;
 Thu,  8 May 2025 10:04:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1746698647; x=1778234647;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=j+TFdtvzrbu0Qd/kKNnTRoIl3mM6mIPvrQcNQ44YP4g=;
 b=KMVNE+IPU1jJbWFTUpVpSmMQTyTWRXsoXIqwTcDsN1xhEpS6TPJroxFv
 7rQI2bVaw4XERBfjpux62zUfobZTc3F4IJiODxfZ5Nys8svjsOL5b6cvn
 EOCQWjVEuJDMzo5jQgI9NdLLpJ5jKgp0xdyFDee3xa9j2YGwP0cq8iYvA
 qzgMVj6MgLF2iR0F4vmJK2uStIW8k99MKsIUh4xf/tK7f9uHlFindzoYg
 uZvf++GGjVT8h9jA/Rtdgko1az/SFY/oiCM1Gg1RffLoXlHLl8hmaX1ci
 hZISwXmwptTXKR/QsX2Y283apm8XpvKl6lOh7CyuLvzzQSagMQ6Te9Sfe w==;
X-CSE-ConnectionGUID: tDcLEtxJRp+HCiS5FbbvgA==
X-CSE-MsgGUID: AjByLY1WSDm4qL8dDPZjNA==
X-IronPort-AV: E=McAfee;i="6700,10204,11426"; a="66003216"
X-IronPort-AV: E=Sophos;i="6.15,271,1739865600"; d="scan'208";a="66003216"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2025 03:04:06 -0700
X-CSE-ConnectionGUID: 1EUBRz3BQyigPzzjCqu2tg==
X-CSE-MsgGUID: RUzXNMvVSmiLFYB+7dfXzQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,271,1739865600"; d="scan'208";a="136634280"
Received: from slindbla-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.245.176])
 by fmviesa008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2025 03:04:04 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	ville.syrjala@linux.intel.com
Subject: [PATCH v2 5/8] drm/i915: move VLV IOSF SB unit specific helpers under
 display
Date: Thu,  8 May 2025 13:03:39 +0300
Message-Id: <858e3de8b3af5d4c2581b88f6c34f4f56192de4d.1746698410.git.jani.nikula@intel.com>
...
index e902771954e7..287110e4e435 100644

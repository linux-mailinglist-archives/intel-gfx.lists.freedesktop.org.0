...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7A944008C0
	for <lists+intel-gfx@lfdr.de>; Sat,  4 Sep 2021 02:36:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D13616E8EF;
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/dg2: Define MOCS table for DG2

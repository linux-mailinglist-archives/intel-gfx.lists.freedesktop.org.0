...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 89A76636A1D
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Nov 2022 20:51:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF23C10E609;
...
Subject: [Intel-gfx] [PATCH v3 3/5] drm/i915/guc: Add GuC specific debug
 print wrappers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C8E86A6C58
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Mar 2023 13:29:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4774F10E0BB;
	Wed,  1 Mar 2023 12:29:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2751010E0BB
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 Mar 2023 12:29:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1677673790; x=1709209790;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=5beJnKN92NuYezTcOZa7R8tFl7V2XPgY9K0He1rhWF8=;
 b=KdDs8NDnQPRMQNZkWt5UzK3M6HzieRq+e4qOj15OoDROCOhLYAp6ob1U
 jQBi/hbLFJtH3qlv6elSI6rANtMoP0bQrnbDTt88mNzPH34nkaHSoCW+p
 tRP53LEW4bCgYQFzwe5K0Zknvca0dRuu/hFt67m1elKiLXNdCeAXXsd9w
 8QzLIY7pOp+Sg8HgshLl1Bdr9h24ND2iQJx+MDa+SJKqAHeKZCAflRFwH
 SDREFXrdBKSeDCcTWtyHrV1ZmG0+Oez5EGd2J05u4Dj7qxDdbN63tqMLV
 g7BlyN6Zl7t3FQLIm7UKATcGfe/4N3gLC++OrD+KM4BIFG6DX4lsmbHrG A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10635"; a="318195882"
X-IronPort-AV: E=Sophos;i="5.98,224,1673942400"; d="scan'208";a="318195882"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2023 04:29:49 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10635"; a="676739559"
X-IronPort-AV: E=Sophos;i="5.98,224,1673942400"; d="scan'208";a="676739559"
Received: from dsvarnas-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.46.249])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2023 04:29:47 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  1 Mar 2023 14:29:40 +0200
Message-Id: <20230301122944.1298929-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.39.1
MIME-Version: 1.0
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v4 1/5] drm/i915/power: move dc state members to

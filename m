...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 89E5D288630
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Oct 2020 11:42:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E52EB6ECA3;
...
Subject: [Intel-gfx] [PATCH v2 10/12] drm/i915/gvt: GVTg support ppgtt pv
 operations

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B04D4D5723
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Mar 2022 02:08:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F6D710E5C2;
	Fri, 11 Mar 2022 01:08:37 +0000 (UTC)
...
Subject: [Intel-gfx] [v6 1/5] drm/edid: seek for available CEA block from

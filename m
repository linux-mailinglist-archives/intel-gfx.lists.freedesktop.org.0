...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 216A955FE8B
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jun 2022 13:29:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D206113196;
	Wed, 29 Jun 2022 11:29:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A589E113196
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Jun 2022 11:29:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656502187; x=1688038187;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=il+o8C/Gn6Q6fQQ6Yml45IgBsFttI3+7DomOFZBlqHs=;
 b=QDRhBJ0tpd7GLaoghyWXxbMJmLQ14KD6/eG6lzof9hwisw8cYb4p/zwY
 b3V/Y9hqO2h9rZltxkMOLqFw1xQObw0K/NeCH1ctTiIkg5qaDTtpfhHI0
 Eba9gOeA7UrtHK63ojqYs7yjj3GeMRI/bgoCkW4oYyWkQ5hEjKeu69bVN
 yDxasHsaH1p+5P+u7TUUlwachFyvQlcoMGB/lhyva4uzO7dRfkH8E7G7q
 ktGPKNmmhEQcsJe62vLybDOzVfAfcDfgCmntx9G4LjBl8GlTp7SHyq9NM
 bEvS/TeNPmV5aTUaHsdaYsESx1aiBqUAogbuPD/L9GD1MzI++G/ikYSiL A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10392"; a="368319271"
X-IronPort-AV: E=Sophos;i="5.92,231,1650956400"; d="scan'208";a="368319271"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jun 2022 04:29:47 -0700
X-IronPort-AV: E=Sophos;i="5.92,231,1650956400"; d="scan'208";a="647353123"
Received: from sannilnx.jer.intel.com ([10.12.26.157])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Jun 2022 04:29:44 -0700
...
Date: Wed, 29 Jun 2022 14:29:05 +0300
Message-Id: <20220629112913.1210933-7-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 06/14] mei: gsc: use polling instead of
 interrupts

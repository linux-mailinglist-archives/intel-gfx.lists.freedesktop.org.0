...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 290C4B4B2C
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Sep 2019 11:46:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 850C96EB98;
	Tue, 17 Sep 2019 09:46:05 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v10 3/9] drm/i915: vgpu pv command buffer
 support

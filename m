...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB0D417EB50
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Mar 2020 22:38:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 45E326E59F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 1/2] drm/edid: Name the detailed monitor
 range flags

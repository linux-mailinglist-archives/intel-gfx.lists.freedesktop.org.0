...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AACB3B9747
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 22:26:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A0FDE6EC29;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 28/53] drm/i915/dg2: Add SQIDI steering

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A3B4D29BE19
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Oct 2020 17:56:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 153916EB9E;
	Tue, 27 Oct 2020 16:56:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2240E6EBA4;
 Tue, 27 Oct 2020 16:56:14 +0000 (UTC)
IronPort-SDR: AUib4Wry08ZPgcDuYs3kUHvZSwYI55G9ACfHRgIbJ6qeqIVTldXcT2Q3e3/xFXI+88t5HOzlDW
 Yx8bMkrNd+/g==
X-IronPort-AV: E=McAfee;i="6000,8403,9787"; a="147975779"
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="147975779"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2020 09:56:13 -0700
IronPort-SDR: t1R9e0xNjbflh+xYO1q8tE8V2iEJZE40A0QL8xM15wQvKnr7V7sb4LDiEGN1NPzgVAQMtENdMk
 2P6xgqQBwZuQ==
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="355613089"
...
Date: Tue, 27 Oct 2020 22:11:57 +0530
Message-Id: <20201027164208.10026-6-anshuman.gupta@intel.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20201027164208.10026-1-anshuman.gupta@intel.com>
References: <20201027164208.10026-1-anshuman.gupta@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 05/16] drm/i915/hdcp: Move HDCP enc status
 timeout to header

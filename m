...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF7C885E98E
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Feb 2024 22:08:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5076710E80D;
	Wed, 21 Feb 2024 21:08:23 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UQbxt21P";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3BEDD10E80D
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Feb 2024 21:08:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1708549702; x=1740085702;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=dPdHtnstdzLG+WK5z6OQoC5W2Vr0KqkI2bq58TZ+vOU=;
 b=UQbxt21PIecERElSYzmrcxm8IoS8o7JuiuyyiOZ5Zi6jWHd96LutUVrI
 EKV8nR3ofCY3+yPsnzjwH5W0bURkm/2POpWaODNBmvSLbTmnTo6w2jf2n
 KjFpgEghYH33qxox29vaHSoSB0Zoc6UZTqEcr31xN4WZTRZxdBk2SLKBP
 o3NzKTyEbomkxxDdDvzC5vjCnwfkccusTG2Pc1DeIhsgGug1k6WzQBQSO
 5p5SmPMAqFoOhoZYvewx6BilyaOaYHRkhVobP+s7XpdSAsGdbDaeAdyMj
 GVyKIOUWWqyBnkxZye2+YRBNAnUO8ViDvu+rQPjeXZxJgDUzYmUz61IVL A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10991"; a="2609995"
X-IronPort-AV: E=Sophos;i="6.06,176,1705392000"; 
   d="scan'208";a="2609995"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orvoesa112.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2024 13:08:22 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10991"; a="827409706"
X-IronPort-AV: E=Sophos;i="6.06,176,1705392000"; d="scan'208";a="827409706"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga001.jf.intel.com with SMTP; 21 Feb 2024 13:08:18 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 21 Feb 2024 23:08:18 +0200
Date: Wed, 21 Feb 2024 23:08:18 +0200
...
Message-ID: <ZdZmQuJkN0P0JDGp@intel.com>

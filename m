...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 747C8629C3F
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Nov 2022 15:40:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B99BA10E407;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Fix build failure with debug and

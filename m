...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 471FB688B1D
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Feb 2023 00:48:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A660C10E68F;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/huc: Add and use HuC oriented
 print macros

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D00036FBB9B
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 01:52:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D6C1410E31E;
	Mon,  8 May 2023 23:52:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A5BBF10E0F5;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=hXeF9JsjHbXPGzTgFQzpJUI8xXlZMXtqrOPAMTWRPpFKnsGgH/rW9ar9
 5GEcNiEYdw/mdo/tZ071D/xh7KKlWEhqQJbUCnNqGwpQfiPZVm16XduMA
 aGZ4kk8gt4+Y+oMUxTrouAnTUJOTMxrXxjRMpAkjkOmP/N9vsxo2z+gAq
 OqMccXfTt4okFriqZcv056zLenRuDEiRrLV6F4awKqPRLnbz7+7Ra7hEC
 5WQljc1FA6lYbY/17azolnbUxJAf4ds79QxLqHCdJsjlC3FGTE9kCRJxb
 s3URFplvxbQ1IpZglVu1UZNAquODwPHF917ol7kjei90lTrT5rUzsg57e g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="348605479"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="348605479"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:51:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="701613521"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="701613521"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 16:51:55 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  8 May 2023 16:52:48 -0700
Message-Id: <20230508235250.4028749-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 2/4] drm/i915: use pat_index instead of
 cache_level

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 236C0752884
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jul 2023 18:37:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC98D10E717;
...
Subject: [Intel-gfx] [PATCH v4 02/21] test-dyndbg: fixup CLASSMAP usage error

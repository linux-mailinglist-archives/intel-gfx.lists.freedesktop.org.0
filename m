...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C8E9959C31
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Aug 2024 14:44:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF9F010E8F5;
	Wed, 21 Aug 2024 12:44:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="cVIuiLgQ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6271010E8F0;
 Wed, 21 Aug 2024 12:44:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1724244293; x=1755780293;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=cArMvq2xkqJhtt4K5fJEZb78vaknq3kelM1vlq6V4iU=;
 b=cVIuiLgQAL5lq2wHrvcrOBT5DXx6m1s1zedJCdMl7F28MbKOK4gLCIiu
 yFEvw5jrwTUHotZUtX6lmWnIaAsn9fk6muYg8Y0OGRyC6Y5YHFhCb33u1
 Rao79FeTYw3lbZ8S/dzbxSw72ESjD0hOQhJjvVo8tKjmZ0l38axf06A+H
 SvQrV5SAtFo2owX541wxUMxArUGmyzhF/WmdK4/mWwdHrAl2jRIehunDI
 0vG73Vy3h75vltDE7oNR1x2UnmG6ubTOTyep5rQP9Ybtk1QbXtdqRwKv1
 HU9prMzCyDRDM3Zm7veY9NVo6DsBdaqCwFZ922wG+zrTDXPYb+1WvNfNX g==;
X-CSE-ConnectionGUID: Gh8sSniBRiG8k01jjzmtYw==
X-CSE-MsgGUID: 8ygUQWgVQmyDKLeukQ+KhA==
X-IronPort-AV: E=McAfee;i="6700,10204,11171"; a="26395350"
X-IronPort-AV: E=Sophos;i="6.10,164,1719903600"; d="scan'208";a="26395350"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Aug 2024 05:44:53 -0700
X-CSE-ConnectionGUID: mNk4AO97TSCmBPw8bxFFVw==
X-CSE-MsgGUID: lFL1a1Z0Q9eJPplXD6M7Zg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,164,1719903600"; d="scan'208";a="66038676"
Received: from bergbenj-mobl1.ger.corp.intel.com (HELO intel.com)
 ([10.245.246.24])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Aug 2024 05:44:49 -0700
...
Subject: [PATCH v1 06/14] drm/i915/gt: Introduce for_each_enabled_engine() and
 apply it in selftests
Date: Wed, 21 Aug 2024 14:43:41 +0200
Message-ID: <20240821124349.295259-7-andi.shyti@linux.intel.com>

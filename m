...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9601A9DBAAD
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Nov 2024 16:39:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 300E510ECF5;
	Thu, 28 Nov 2024 15:39:42 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="P6n28yxk";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1E4F010ECED;
 Thu, 28 Nov 2024 15:39:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1732808381; x=1764344381;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ymg7YpHQKw4XiJzyncWOliPjrkjhAkQFYzijANGka5E=;
 b=P6n28yxk9veNDLwzmSckrS1LSiXs3vXsbWX/DIne/63iZzLw7/EWysJD
 T11Q6Osr+yhUbHAM4Ky4kYP5rSV0M3nx8zIlLO7omCM1he8xRzfS4oO7L
 F/sCKlSiz1fPu6AhPM9Y8cYBLATURtt0aBdQjUT3msbOrTSPutKXYozg6
 66YBBDaxTQhZKqD96zaDCMWSpNpAHeKeiJXoctzrmJRzkyZYQDsFOy3a0
 3DOGsuoITinHGO46GuZPMPoROqwZygS5Et781XC35VLN+ux2COw+cMPH7
 rU1JM5qtYHMHBkS5jcTYBSD8kOnfJlMX59aKV9Azfiaxjc5YFgjxsDDSt Q==;
X-CSE-ConnectionGUID: 96inUwJ1TcusJ3C75bwmsg==
X-CSE-MsgGUID: CtXRwtbSR5K/wDx8azxsUw==
X-IronPort-AV: E=McAfee;i="6700,10204,11270"; a="55538941"
X-IronPort-AV: E=Sophos;i="6.12,192,1728975600"; d="scan'208";a="55538941"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2024 07:38:42 -0800
X-CSE-ConnectionGUID: 6VXaNPDqSCyzhT35Zsu+Uw==
X-CSE-MsgGUID: S2X19XEZTmOKQuwfXZR+cA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,192,1728975600"; d="scan'208";a="123224849"
Received: from unknown (HELO localhost) ([10.237.66.160])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2024 07:38:40 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: imre.deak@intel.com,
	jani.nikula@intel.com
Subject: [PATCH v2 3/6] drm/i915/display: convert power wells to struct
 intel_display
Date: Thu, 28 Nov 2024 17:38:21 +0200
Message-Id: <b8c0ff5502a5df55ec7a160d90257c6f2befc0b6.1732808222.git.jani.nikula@intel.com>

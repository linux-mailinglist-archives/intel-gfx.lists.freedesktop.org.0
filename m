...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9762E6C8653
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Mar 2023 20:56:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B450E10EC8D;
	Fri, 24 Mar 2023 19:56:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yw1-x1129.google.com (mail-yw1-x1129.google.com
 [IPv6:2607:f8b0:4864:20::1129])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6281410EC8D
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 19:56:18 +0000 (UTC)
Received: by mail-yw1-x1129.google.com with SMTP id
 00721157ae682-5445009c26bso52380017b3.8
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 Mar 2023 12:56:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1679687777;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=oZyOf0ua/RlTK8COzBtKQqCCttolhrV1JkTRTUPNpOA=;
 b=c/DPGmP7lx2ToOvy2iLtiogfS2cZWykeTm8s2hfLWz34FYDowzI3HkMR2e2mAXQxKy
 K92CauVqAFr8MNH0VOpOPQUWbH7Waxn8NYVfJ8nFbw7UG8QOpg6g6k7hv05dR2GyRbE7
 Br6WC28x3xmyudDuuOvPqDU1kA5SHLflWbmbM=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1679687777;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=oZyOf0ua/RlTK8COzBtKQqCCttolhrV1JkTRTUPNpOA=;
 b=
X-Gm-Message-State: AAQBX9dsOysnOwZSnAKtIH5h1Y2W74t+AIwc5/8Oz2FQoyLNxZx/IksM
 wTMuxxygScTIPxMyzdriNWZ2fQ==
X-Google-Smtp-Source: AKy350auajs/zZH4sRSHqKy5dR7S7CKmEASB0gILpH2B7MQUD/jeXCHLpGdccKtdl+aOg/zLLKyqyA==
X-Received: by 2002:a0d:fa03:0:b0:52f:169c:cca9 with SMTP id
 k3-20020a0dfa03000000b0052f169ccca9mr3376301ywf.49.1679687777159; 
 Fri, 24 Mar 2023 12:56:17 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:5509:ec45:2b32:b39f])
 by smtp.gmail.com with UTF8SMTPSA id
 dc8-20020a05690c0f0800b00545a08184besm589041ywb.78.2023.03.24.12.56.16
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Fri, 24 Mar 2023 12:56:16 -0700 (PDT)
From: Mark Yacoub <markyacoub@chromium.org>
X-Google-Original-From: Mark Yacoub <markyacoub@google.com>
To: David Airlie <airlied@gmail.com>,
	Daniel Vetter <daniel@ffwll.ch>
Date: Fri, 24 Mar 2023 15:55:48 -0400
Message-Id: <20230324195555.3921170-5-markyacoub@google.com>
...
Subject: [Intel-gfx] [PATCH v7 04/10] drm/hdcp: Expand HDCP helper library
...
@@ -507,3 +512,1209 @@ bool drm_hdcp_has_changed(struct drm_connector *connector,

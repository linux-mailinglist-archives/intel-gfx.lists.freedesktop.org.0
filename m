...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0824D570B54
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:25:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47FD614A0BF;
...
Subject: [Intel-gfx] [PATCH 15/32] drm/i915: intel_pm.c: fix some ascii

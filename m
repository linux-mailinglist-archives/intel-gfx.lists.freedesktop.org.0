...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFD23699E18
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Feb 2023 21:45:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 268CC10E377;
...
Subject: [Intel-gfx] [PATCH 0/4] drm/displayid: use primary use case to

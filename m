...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 850406B08FB
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 71FE310E68A;
...
Subject: [Intel-gfx] [PATCH v6 24/24] docs: vfio: Add vfio device cdev
 description

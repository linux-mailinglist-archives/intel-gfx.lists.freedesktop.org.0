...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CF995AC6CE
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:43:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BE1810E197;
...
Subject: [Intel-gfx] [PATCH v6 10/57] dyndbg: cleanup auto vars in
 dynamic_debug_init

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 40569153432
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2020 16:41:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D1AC6F624;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 02/17] drm/i915/dp: Add compute routine for
 DP VSC SDP

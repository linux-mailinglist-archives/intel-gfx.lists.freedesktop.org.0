...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DC1EA9C432
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Apr 2025 11:51:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FFDF10E90E;
	Fri, 25 Apr 2025 09:51:13 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="XB39H99Y";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EE63B10E911
 for <intel-gfx@lists.freedesktop.org>; Fri, 25 Apr 2025 09:51:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1745574672;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=ulLK6NlOiEAhdPVwDdczTykPb0OkKkVgfQ9oAnDdfac=;
 b=XB39H99YbKhGS/7XCNymQK6ZfGBD9P7R5JKsoJF1lh5i3OqkzcuDMVO4VeEBcFEJGZl4v1
 YIISYex5ujbvIiO+fCLoLNWvfkABxF5Hej+F6SHwqB0QNZfrypMq2XB91sz6GEQFULvOgL
 GpUIFjBNH1GojrrFwpPSy+2eow/cqEk=
...
Received: from mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id D487F19560AF; Fri, 25 Apr 2025 09:51:06 +0000 (UTC)
Received: from hydra.redhat.com (unknown [10.44.34.172])
 by mx-prod-int-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id D0666195608D; Fri, 25 Apr 2025 09:51:00 +0000 (UTC)
...
Subject: [PATCH v7 7/8] drm/i915/display: Add drm_panic support for Y-tiling
 with DPT

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C762F86E494
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Mar 2024 16:43:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8479C10E037;
	Fri,  1 Mar 2024 15:43:11 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="TUSVviun";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 953DD10E037
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 Mar 2024 15:43:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709307790; x=1740843790;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=njf6xoWg25qZH/+LolspiID4Xy3Zh6GRUSc7ilTVmts=;
 b=TUSVviuno7JuRjEmYcA9ECrrL7zUbjZC3ylujdhui2wCZVOA4gZXLgUr
 2MRHQieS0poPdjgvm22dDp7SUfwdGAzAtYC0mFmaq6OfT7ux0PM4GsigW
 8zvPj975Vl6ODTaMgBKxTtRA5KGctzyTuXqNd+S6xggQjfNlADhLnZ2xI
 cnqCBjvTDosnWdC3ELpylb1LlBrkpUmHrRDLUeEPFCMfglSUyMd6JgCQI
 cvS1KxFTcABtaH+XrJz0ZF/6nn5kMw+7mWSkteTHASMgMWXOTBb6Kzubt
 xatvnC86QT6N8nPpc8/t1lxHgVq82jkXYf8m8KuAawMmp3A80AtDEy4eG A==;
X-IronPort-AV: E=McAfee;i="6600,9927,11000"; a="26312008"
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="26312008"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 07:43:09 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="45768700"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 07:43:07 -0800
Date: Fri, 1 Mar 2024 17:42:59 +0200
...
Message-ID: <ZeH3g2spuwiGz9M8@intel.com>
References: <20240221192010.25413-1-stanislav.lisovskiy@intel.com>
 ...
 <ZeHzmx4nWMLpQhL0@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <ZeHzmx4nWMLpQhL0@intel.com>

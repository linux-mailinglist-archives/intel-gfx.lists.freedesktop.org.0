...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CB763B85F0
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 17:10:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD2C46EA26;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 10/17] drm/amd/display: Add handling for new

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E3E399B3B10
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Oct 2024 21:07:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 75BEB10E55E;
	Mon, 28 Oct 2024 20:07:43 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Pba3Byiy";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1DE4010E55E;
 Mon, 28 Oct 2024 20:07:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1730146062; x=1761682062;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=aQNxFMlxS/yfCgvbmnDAjRk95o0+k5MCiSmRDTYrUiA=;
 b=Pba3Byiyecqc6YPOh/Die4hBEFpyv5b4U9zdRbv/BxROSdK9Z9pjyuE5
 loFzLmnDkScevIsPAK81ZbUYCWvOqWWhNPS/+YlmEtTLWwBTE0hi+OIod
 Ddih3Ro9PtaGZAqD6iXOXxCujACvyQCj2WmqrE7zDx5GU7D4l3VSjB9tm
 YIXMHsvdtH8wDj9Xhq/8qb1QnKsMvMMU0QlaWj7ISCPvEq81IhlHLAksu
 xvqj+4RZN1++1F5wD6tdQnLe4GVdVq7JKekfX4lyvCM1maRppu2kFn99P
 7p6lLa6horFUpD+roLrnYp8IxdcDfkIFmwmp4+wkBidOxdRD7WPjMznLd Q==;
X-CSE-ConnectionGUID: G1DQIf2pT6CMcmFm9HpDVg==
X-CSE-MsgGUID: PgvM0bkqTPS8JFwKsvNhrw==
X-IronPort-AV: E=McAfee;i="6700,10204,11239"; a="33681143"
X-IronPort-AV: E=Sophos;i="6.11,239,1725346800"; d="scan'208";a="33681143"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2024 13:07:42 -0700
X-CSE-ConnectionGUID: t11lCuSuQa2sDkKUlhJR3A==
X-CSE-MsgGUID: ONynyV/GTKCcMQMB0zBZrg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,239,1725346800"; d="scan'208";a="82055068"
Received: from fdefranc-mobl3.ger.corp.intel.com (HELO localhost)
 ([10.245.246.21])
 by fmviesa010-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2024 13:07:39 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	Rodrigo Vivi <rodrigo.vivi@intel.com>
Subject: [CI v2 v2 01/12] drm/i915/gmbus: convert to struct intel_display
Date: Mon, 28 Oct 2024 22:07:19 +0200
Message-Id: <d784e4799ab5095baa5c8fd840920066878c6273.1730146000.git.jani.nikula@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C04E150DA77
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Apr 2022 09:49:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA90A10E34C;
	Mon, 25 Apr 2022 07:49:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 59EF610E36F
 for <intel-gfx@lists.freedesktop.org>; Mon, 25 Apr 2022 07:49:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1650872990; x=1682408990;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=SuHhKloRFvglX9zFGdP7Nu+8Y1f8MGBa3hFTJEwSwKI=;
 b=IKZoJ/CqQgrHypoz2XJroV2Pap75CFtzPzEcyyVUIvCFG9zTJr81chYT
 lCd2UoKbhhri0mEjFpem8gC2rvNxUPkkYuOqIDuZTsxLgvzifKFl9VRfb
 +awpmSJ04Td9xz109yhhDF4EppUjs5zgpLwVtVqdB1qeHOunTelmNXdFE
 EP+sXGJrxSpDRh2fOxlN7jy81fDCCmccnz1aL9OyU4XbBKugdKSP+dqYa
 d2nlz4wKHxum8afKcNympxZOUhm04B6qYrZv82liKaHKQOx+qxMIaazuT
 QEKoKA39EH1Rmv8Bi9wQdvy6fQhVq7n9yUKIbo4xVihQJQjeV1o0ZSNVt g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10327"; a="245101411"
X-IronPort-AV: E=Sophos;i="5.90,287,1643702400"; d="scan'208";a="245101411"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2022 00:49:50 -0700
X-IronPort-AV: E=Sophos;i="5.90,287,1643702400"; d="scan'208";a="557600041"
...
Date: Mon, 25 Apr 2022 10:48:58 +0300
Message-Id: <20220425074901.3991274-12-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 11/14] mei: gsc: setup gsc extended
 operational memory

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E6D7522F3D
	for <lists+intel-gfx@lfdr.de>; Wed, 11 May 2022 11:21:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1EBC10F97C;
...
Subject: [Intel-gfx] [PATCH v3] drm/edid: keep propagating drm_edid to
 display info

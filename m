...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1D0C5A886B
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Aug 2022 23:51:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C314110E4FC;
...
Subject: [Intel-gfx] [PATCH v3 05/11] drm/i915/mtl: Add gmbus and gpio
 support

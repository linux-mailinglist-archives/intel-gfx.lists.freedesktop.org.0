...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A74D3DC852
	for <lists+intel-gfx@lfdr.de>; Sat, 31 Jul 2021 23:42:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFAFC6E0D9;
	Sat, 31 Jul 2021 21:42:20 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 0/7] drm: use dyndbg in drm_print

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C071F2C6720
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 14:46:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA5D06EDCF;
...
Subject: Re: [Intel-gfx] [PATCH 07/15] drm/i915: Remove references to struct
 drm_device.pdev
...
Content-Type: multipart/mixed; boundary="===============0282103646=="

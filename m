...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4BF3265DE0
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Sep 2020 12:31:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E12AE89580;
	Fri, 11 Sep 2020 10:31:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6D74B89E03;
 Fri, 11 Sep 2020 10:31:03 +0000 (UTC)
IronPort-SDR: jhmaJs0Bp/s5f/DlPUbcpFDSW8SA2q4q/VlQgMtUBhclNuzN+bkARB6dT/hKV9Uvn/yXTrasEC
 1PuOxjdSMN9g==
X-IronPort-AV: E=McAfee;i="6000,8403,9740"; a="146463201"
X-IronPort-AV: E=Sophos;i="5.76,414,1592895600"; d="scan'208";a="146463201"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Sep 2020 03:31:03 -0700
IronPort-SDR: IEHtS1gCSpc4sAvOZYSzNuTdcIRsVVtplJMvqu2uiVmwSgA4mUS7znm9QAraw1gWcdz4Mr5z/8
 LW3YmuOpoa8A==
X-IronPort-AV: E=Sophos;i="5.76,414,1592895600"; d="scan'208";a="334474730"
Received: from jkrzyszt-desk.igk.intel.com ([172.22.244.18])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Sep 2020 03:31:01 -0700
From: Janusz Krzysztofik <janusz.krzysztofik@linux.intel.com>
To: igt-dev@lists.freedesktop.org
Date: Fri, 11 Sep 2020 12:30:21 +0200
Message-Id: <20200911103039.4574-7-janusz.krzysztofik@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH i-g-t v6 06/24] tests/core_hotunplug: Maintain a
...
aW5kZXggMmY3MDMxMDk0Li5jYjVmMTA0NzQgMTAwNjQ0Ci0tLSBhL3Rlc3RzL2NvcmVfaG90dW5w

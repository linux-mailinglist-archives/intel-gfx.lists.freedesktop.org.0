...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 537CF366E53
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Apr 2021 16:35:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D02E6E0C5;
	Wed, 21 Apr 2021 14:35:33 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 1/4] drm/i915: Create stolen memory

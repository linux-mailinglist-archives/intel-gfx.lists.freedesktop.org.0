...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A1E6705C57
	for <lists+intel-gfx@lfdr.de>; Wed, 17 May 2023 03:22:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B631610E088;
...
Subject: Re: [Intel-gfx] [PATCH v3 07/28] drm/i915/gvt: Don't rely on KVM's

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 30B1B87546
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:17:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78E9B6ED7F;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 uMYw==
Subject: [Intel-gfx] [PATCH 16/34] drivers/tee: convert put_page() to
 put_user_page*()

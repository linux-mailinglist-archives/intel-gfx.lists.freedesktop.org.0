...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KPm2NraYy2mYJQYAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2026 11:49:42 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80CDE367588
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2026 11:49:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E95E10EA0B;
	Tue, 31 Mar 2026 09:49:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PWW3hdEf";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1D56E10EA05;
 Tue, 31 Mar 2026 09:49:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1774950580; x=1806486580;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PQT4O+yZ49xxvC0jyOtKt6aqlqrGY95PYF23gLuVzUo=;
 b=PWW3hdEfwCMhKSyKsTQQTV1jXh9sUDCzPLx3lvmBiRNpvVAS+w7cxUaq
 tFGLZT7+vUmSdhxAcnJ2e1b2huT+klLXF7SMh+DmQ6WUVdjHmtiYW9FmN
 K8Rd2D9jTff7c5qzgz1mabgYCwONLQb3hy+c8LrP6hpRl4NCUhPMDJ2HL
 LNsf8xvSp184xyKWScqpUvpnHmMCAWJNl7b5q4Iur6JDjGNvlN1TYzy0r
 n4Plb/HEv8tf6Sa6pz4d1JGD3A3F6kvCGcOEXCY9ibtuhaw0v7hR+h0JG
 ltuVyu56ehJ6KKyM5MrgI4fwISmESqGSkrapLRccX+G/uYlMFYSVwYDll A==;
X-CSE-ConnectionGUID: jEB2QDVoSm6QhSJ6bj5h3Q==
X-CSE-MsgGUID: zaQ/TBMASvKX6gxj13Oh0w==
X-IronPort-AV: E=McAfee;i="6800,10657,11744"; a="101414073"
X-IronPort-AV: E=Sophos;i="6.23,151,1770624000"; d="scan'208";a="101414073"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2026 02:49:39 -0700
X-CSE-ConnectionGUID: RVFJm4YQQU2hwBhqiDMN9w==
X-CSE-MsgGUID: Fa70DGiFQ+u1/bcgW2IimQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,151,1770624000"; d="scan'208";a="231252261"
Received: from kniemiec-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.73])
 by orviesa005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2026 02:49:38 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
 =?UTF-8?q?Micha=C5=82=20Grzelak?= <michal.grzelak@intel.com>
Subject: [PATCH v2 3/5] drm/{i915, xe}: move fbdev fb calls to parent interface
Date: Tue, 31 Mar 2026 12:49:16 +0300
Message-ID: <a6bb24909a58181cfc41b91a4c6538a181d27158.1774950508.git.jani.nikula@intel.com>
...
---
 ...
 drivers/gpu/drm/xe/display/xe_display_bo.c    | 121 ++++++++++++++++++
 ...
 15 files changed, 303 insertions(+), 276 deletions(-)
...
index b677720a1c2d..f7cdeaf178a6 100644
--- a/drivers/gpu/drm/i915/Makefile
+++ b/drivers/gpu/drm/i915/Makefile
@@ -325,8 +325,7 @@ i915-$(CONFIG_ACPI) += \
...
index 9dacb0579a7d..144bfd9f80b1 100644
--- a/drivers/gpu/drm/xe/Makefile
+++ b/drivers/gpu/drm/xe/Makefile
@@ -213,7 +213,6 @@ $(obj)/i915-display/%.o: $(srctree)/drivers/gpu/drm/i915/display/%.c FORCE
...
deleted file mode 100644
index 23fa54ee781e..000000000000
...
index 1d81b9908265..6f372c73ab8e 100644
...
+#include <generated/xe_device_wa_oob.h>
 ...
 {
@@ -101,6 +107,115 @@ xe_display_bo_framebuffer_lookup(struct drm_device *drm,
 	return gem;
 }
...
@@ -109,4 +224,10 @@ const struct intel_display_bo_interface xe_display_bo_interface = {
...
index d44746f4966c..73ae502bb2a5 100644

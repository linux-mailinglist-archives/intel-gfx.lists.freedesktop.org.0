...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C11FD7B2114
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Sep 2023 17:23:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C097310E68A;
...
Subject: [Intel-gfx] [PATCH 12/15] fw loader: Remove the now superfluous

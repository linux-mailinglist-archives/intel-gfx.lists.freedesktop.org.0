...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 283724BA438
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 16:23:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5CB5E10ECED;
	Thu, 17 Feb 2022 15:23:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 680FD10ED0E
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Feb 2022 15:23:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645111414; x=1676647414;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=SHaqz+kuBPMCnRmckiVfveWyYrVDJjU4Xl2dO2GAYiM=;
 b=feSWC3xsfmBLvbEXN89HQDzvl3lSQTF/YGDiWipidzM5Oi2HLu+QfONo
 jvCLpEZ8Jqox+acwK7e8cHfAxqfAIv/6Y1KOPh394QUKZuPyX4eOksqx6
 fH5PUlBz8rBErg6CTX0kZv8FFqMw7/d1qPagj9HxK21o/jG+ubucajBoc
 wx5ALTqORgYDGapRvKykzgd/PaV9PnjilOXv1AQi2uFMuuUdhfFFF9iW0
 oHlG1eMIjd1Ho8iLVZ1kZ5+S16jpawAccrc6m1T7W8VPftOKssAxtOOOB
 lfIlM75O0NHYvRxEs905QndMUB8Hl8JWMyqQgeX2IUCU6lERu9WKG+DAB A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10260"; a="238300060"
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="238300060"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 07:23:34 -0800
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="545659025"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 07:23:30 -0800
...
Date: Thu, 17 Feb 2022 17:22:45 +0200
Message-Id: <20220217152248.1016134-3-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 2/5] mei: add support for graphics system

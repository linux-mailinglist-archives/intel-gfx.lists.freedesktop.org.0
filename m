...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 888B336EFF1
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Apr 2021 21:04:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0EF46F466;
	Thu, 29 Apr 2021 19:03:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pj1-x102c.google.com (mail-pj1-x102c.google.com
 [IPv6:2607:f8b0:4864:20::102c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 174CC6F459
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Apr 2021 19:03:58 +0000 (UTC)
Received: by mail-pj1-x102c.google.com with SMTP id
 y22-20020a17090a8b16b0290150ae1a6d2bso437825pjn.0
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Apr 2021 12:03:58 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=/suOcRFw1vdHRsSXXeAie2peFRiISvO2NIBvU7QrSRk=;
 b=
X-Gm-Message-State: AOAM533bk/NPegAFwyzo/C+SwN3fa9V6qec5FcccK9j/Ls9cj/4jOfpE
 YZxhGlRGwpMQ/AyPOAUb5A8S0UsQZl5wxw==
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/25] drm/i915: Implement SINGLE_TIMELINE with
 a syncobj (v4)

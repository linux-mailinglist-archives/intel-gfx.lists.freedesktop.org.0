...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 27B112CB3B8
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Dec 2020 05:04:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 27FD86EA0C;
	Wed,  2 Dec 2020 04:04:23 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9A5FC6E9A6
 for <Intel-gfx@lists.freedesktop.org>; Wed,  2 Dec 2020 04:04:18 +0000 (UTC)
IronPort-SDR: +5NU46a/ef2v0+00e03k4+p6eVDYA5gTZ76YBNLES8YCDgOJDsjJXOo9uxRhFJXxzfsC4RPHId
 Lt6Jj8EMtK0g==
X-IronPort-AV: E=McAfee;i="6000,8403,9822"; a="172165853"
X-IronPort-AV: E=Sophos;i="5.78,385,1599548400"; d="scan'208";a="172165853"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Dec 2020 20:04:17 -0800
IronPort-SDR: T8IQDqT3yRMAXrqSpSIPcK9Z+xovnBzaE+1LWPrNLW07kHNpGaWgevDSUTnB2pqbHN+ewE6muG
 ZQnuYoNj+YQQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,385,1599548400"; d="scan'208";a="549869256"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga005.jf.intel.com with ESMTP; 01 Dec 2020 20:04:16 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Tue,  1 Dec 2020 20:03:29 -0800
Message-Id: <20201202040341.31981-15-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201202040341.31981-1-sean.z.huang@intel.com>
References: <20201202040341.31981-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v4 14/26] drm/i915/pxp: Destroy all type0 sessions
 upon teardown

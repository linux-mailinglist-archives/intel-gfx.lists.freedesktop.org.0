...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27E8273E58F
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Jun 2023 18:45:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D6FB10E20F;
	Mon, 26 Jun 2023 16:45:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 28ED910E089
 for <intel-gfx@lists.freedesktop.org>; Mon, 26 Jun 2023 16:44:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1687797893; x=1719333893;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+5forLNrsrVf3VPfdkk6t3ZkI+0M5tlERJmwoPljNSU=;
 b=A/urzyKyx9Vei7NEHbzdpY14mI01HJM1xjdG+zu2dwNiXNQdPszFkwVN
 aIorbZHv6aggGijsLZbLJSg2Du+RLFlDOVqNVPGEXfLB66HyKggoGye6h
 t3con3EMiI5MPbjEuH0P8MfbSV8P1Vxm6Ba+jcm9EgyPWXwzmMcyKxhrY
 6d1t4VkiqAeelz6d/cG5g9dvXA/FYpo25Zp+vRBTb981kh8gSakoA16Ur
 7nGwbawM7vPrnYaxOCxbG9gxCl4hO69qQOnOVR4kQff4RXWofkoCLWBlu
 8qOj9ux67vmNAKHeS4bvFoQXMATUUjbTcQ9+7GUJvnacIikmTE9kKv6f5 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10753"; a="341658769"
X-IronPort-AV: E=Sophos;i="6.01,160,1684825200"; d="scan'208";a="341658769"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Jun 2023 09:44:52 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10753"; a="806129484"
X-IronPort-AV: E=Sophos;i="6.01,160,1684825200"; d="scan'208";a="806129484"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by FMSMGA003.fm.intel.com with ESMTP; 26 Jun 2023 09:44:51 -0700
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 26 Jun 2023 22:16:02 +0530
Message-Id: <20230626164604.2759876-2-mitulkumar.ajitkumar.golani@intel.com>

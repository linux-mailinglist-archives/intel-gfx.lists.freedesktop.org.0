...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 569DB6E8583
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Apr 2023 01:00:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 663DF10EB4B;
	Wed, 19 Apr 2023 22:59:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B347D10EB36;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=j1uyuWsTWENzB7AQ7vclglJvMcKJvsNKxtYENu/dmktmYYpyD/KFIXoQ
 pdgqXoKxHycWcdLlCUo27I1HnBCoLcrj1201IP6ics0VD2syhe8MY4tdv
 aqOzD2kPhZBCUjwtLbxwpIumZfFMwtSjz4s+QtBeLtqoS+3P6T5vlBiNj
 9/4720mDVQnssrnraoRtyzq/lwOnC6mV2XAapU9H/naX6ca0m8hNOVKS5
 vVCYaiCc/UYnb2fOE4jzPasYyrUhlifDfzQiMQEHnMISJV6mgMRrtXz4s
 b9toZiW+Nf93AqFDwf8XvviVenAo6rCD0v1bJccXI+k1b7iVR5FaY4fhl A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="431858541"
X-IronPort-AV: E=Sophos;i="5.99,210,1677571200"; d="scan'208";a="431858541"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2023 15:59:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="815787145"
X-IronPort-AV: E=Sophos;i="5.99,210,1677571200"; d="scan'208";a="815787145"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2023 15:59:47 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Wed, 19 Apr 2023 16:00:58 -0700
Message-Id: <20230419230058.2659455-9-fei.yang@intel.com>

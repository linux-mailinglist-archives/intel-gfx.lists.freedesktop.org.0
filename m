...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 043673B28AE
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:29:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8252A6E986;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 01/27] drm/amdgpu: Track IRQ state in local
 device state

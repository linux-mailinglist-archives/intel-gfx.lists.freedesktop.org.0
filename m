...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A3B6078C92F
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Aug 2023 18:01:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C40910E41A;
	Tue, 29 Aug 2023 16:00:09 +0000 (UTC)
...
Subject: [Intel-gfx] [RFC 29/33] drm/i915/xelpd: Program Plane Post CSC
 Registers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04C0D1ADC9A
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 13:58:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5C756EBA6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v10 00/14] In order to readout DP SDPs,

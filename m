...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B1D287B1498
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Sep 2023 09:18:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 479C410E067;
	Thu, 28 Sep 2023 07:18:47 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v6 1/4] drm/i915: Introduce

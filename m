...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 480293F7304
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Aug 2021 12:26:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F2EC6E1AA;
	Wed, 25 Aug 2021 10:26:22 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 2/7] drm: convert drm_device.master_mutex
 into a rwsem

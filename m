...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C3ACA38964E
	for <lists+intel-gfx@lfdr.de>; Wed, 19 May 2021 21:10:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DE9A76EE68;
...
- Add the missing MC CCS/XYUV8888 format support on display >=3D 12 (Imre).
...
are available in the Git repository at:
  ...
  git://anongit.freedesktop.org/drm/drm-intel tags/drm-intel-next-2021-05-1=
9-1
...
Imre Deak (9):
      ...
      drm/i915: Pass intel_framebuffer instad of drm_framebuffer to intel_f=
ill_fb_info()
...
le
      ...
      Revert "drm/i915/tgl/psr: Fix glitches when doing frontbuffer modific=
ations"
...
ut
      drm/i915/display: Replace intel_psr_enabled() calls by intel_crtc_sta=
te check
...
Rodrigo Vivi (3):
      Merge tag 'topic/intel-gen-to-ver-2021-04-19' of git://anongit.freede=
sktop.org/drm/drm-intel into drm-intel-next
...
Werner Sembach (3):
      drm/i915/display: New function to avoid duplicate code in upcomming c=
ommits
      drm/i915/display: Restructure output format computation for better ex=
pandability

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E6035429CC
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 10:46:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EEFB310E9E1;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/xehp: Correct steering
 initialization

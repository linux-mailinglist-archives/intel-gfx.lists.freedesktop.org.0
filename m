...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A77F517329
	for <lists+intel-gfx@lfdr.de>; Wed,  8 May 2019 10:07:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 658A4893DB;
	Wed,  8 May 2019 08:07:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 48BB0893A2
 for <intel-gfx@lists.freedesktop.org>; Wed,  8 May 2019 08:07:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16485928-1500050 
 for multiple; Wed, 08 May 2019 09:07:11 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  8 May 2019 09:06:52 +0100
Message-Id: <20190508080704.24223-28-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 28/40] drm/i915: Move GEM object domain
...
aC5jCmluZGV4IDA5M2JmZmY1NWE5Ni4uZWZhYjQ3MjUwNTg4IDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9nZW0vaTkxNV9nZW1fY2xmbHVzaC5jCisrKyBiL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2dlbS9pOTE1X2dlbV9jbGZsdXNoLmMKQEAgLTk2LDYgKzk2LDggQEAgYm9vbCBpOTE1
...
ZSBzeXN0ZW0gaXMgY2FjaGUtY29oZXJlbnQuCkBAIC0xNDUsOSArMTQ3LDcgQEAgYm9vbCBpOTE1
...

...
IApAQCAtMTYwLDEyICsxNTksMTIgQEAgc3RhdGljIGludCBpOTE1X2dlbV9iZWdpbl9jcHVfYWNj
...
X3VucGluX3BhZ2VzKG9iaik7CkBAIC0xNzUsMTkgKzE3NCwxOCBAQCBzdGF0aWMgaW50IGk5MTVf
...

...
b2JqKTsKIH0KIAogLyoqCkBAIC00OSwxMSArNDksMTAgQEAgaTkxNV9nZW1fb2JqZWN0X3NldF90
...
LAogCQkJCSAgIE1BWF9TQ0hFRFVMRV9USU1FT1VUKTsKIAlpZiAocmV0KQpAQCAtMTExLDExICsx
MTAsMTAgQEAgaTkxNV9nZW1fb2JqZWN0X3NldF90b19ndHRfZG9tYWluKHN0cnVjdCBkcm1faTkx
...
RU9VVCk7CiAJaWYgKHJldCkKQEAgLTE4MSw3ICsxNzksNyBAQCBpbnQgaTkxNV9nZW1fb2JqZWN0
...
aWYgKG9iai0+Y2FjaGVfbGV2ZWwgPT0gY2FjaGVfbGV2ZWwpCiAJCXJldHVybiAwOwpAQCAtMjMw
LDcgKzIyOCw2IEBAIGludCBpOTE1X2dlbV9vYmplY3Rfc2V0X2NhY2hlX2xldmVsKHN0cnVjdCBk
...
RFVMRV9USU1FT1VUKTsKIAkJaWYgKHJldCkKQEAgLTM3NCwxMiArMzcxLDE2IEBAIGludCBpOTE1
...
MTVfZ2VtX29iamVjdF9wdXQob2JqKTsKQEAgLTQwMSw3ICs0MDIsNyBAQCBpOTE1X2dlbV9vYmpl
...
ZG9tYWlucy4KQEAgLTQ4NiwxNiArNDg3LDE4IEBAIHN0YXRpYyB2b2lkIGk5MTVfZ2VtX29iamVj
...
Z3R0KG9iaik7CiAKIAlpOTE1X3ZtYV91bnBpbih2bWEpOwogfQpAQCAtNTEzLDExICs1MTYsMTAg
...
CiAJaWYgKHJldCkKQEAgLTYzOSw3ICs2NDEsNyBAQCBpOTE1X2dlbV9zZXRfZG9tYWluX2lvY3Rs
...
IGk5MTVfZ2VtX29iamVjdF9sb2NrX2ludGVycnVwdGlibGUob2JqKTsKIAlpZiAoZXJyKQogCQln
b3RvIG91dF91bnBpbjsKIApAQCAtNjUzLDcgKzY1NSw3IEBAIGk5MTVfZ2VtX3NldF9kb21haW5f
...
ZWxfZmJfb2JqX2ludmFsaWRhdGUob2JqLApAQCAtNjc2LDIyICs2NzgsMjMgQEAgaW50IGk5MTVf
...
Q0xGTFVTSCkpIHsKQEAgLTcxOSw2ICs3MjIsOCBAQCBpbnQgaTkxNV9nZW1fb2JqZWN0X3ByZXBh
...
X29iamVjdF91bmxvY2sob2JqKTsKIAlyZXR1cm4gcmV0OwogfQogCkBAIC03MjcsMjMgKzczMiwy
...
RUFUVVJFX0NMRkxVU0gpKSB7CkBAIC03ODAsNSArNzg2LDcgQEAgaW50IGk5MTVfZ2VtX29iamVj
...

...
dXJuIEVSUl9QVFIoZXJyKTsKIApAQCAtMTE2NSw2ICsxMTY3LDI2IEBAIHN0YXRpYyB2b2lkIGNs
...
ICAgICB1bnNpZ25lZCBpbnQgbGVuKQpAQCAtMTE3NiwxNSArMTE5OCw2IEBAIHN0YXRpYyBpbnQg
...
KQogCQlyZXR1cm4gUFRSX0VSUihvYmopOwpAQCAtMTIxMyw3ICsxMjI2LDcgQEAgc3RhdGljIGlu
...
cnIpCiAJCWdvdG8gZXJyX3JlcXVlc3Q7CiAKQEAgLTEyMjEsMTQgKzEyMzQsMTIgQEAgc3RhdGlj
...

...
MTUvZ2VtL2k5MTVfZ2VtX29iamVjdC5oCmluZGV4IDk4MDU4N2U0MjBlNi4uNTA5ZDE0NWQ4MDhh
...

...
VFJfRVJSKGJhdGNoKTsKQEAgLTk3MywxMyArOTY5LDE5IEBAIHN0YXRpYyBpbnQgZ3B1X3dyaXRl
...
Y29oZXJlbmN5LmMKaW5kZXggYjY2MTNjYWE2ZjQ1Li4yMmZlNGI2ZmQ1MDYgMTAwNjQ0Ci0tLSBh
...
OTE1L2dlbS9zZWxmdGVzdHMvaTkxNV9nZW1fcGh5cy5jCmluZGV4IGI3NmI1MDNiMzk5OS4uOGVj
ZjhkN2JkMDgzIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9nZW0vc2VsZnRlc3Rz
...
Z3Qvc2VsZnRlc3RfbHJjLmMKaW5kZXggOGU1ZGRiNDJmYTNlLi5jOTZjZDY5Zjk4MDAgMTAwNjQ0
...
aXNwbGF5LmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pbnRlbF9kaXNwbGF5LmMKaW5kZXggZTYz
ZjI5MGNjYzI2Li5lZTJmZmE1YTAzZGYgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1

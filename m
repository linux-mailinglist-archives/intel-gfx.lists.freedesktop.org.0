...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DF59E744D
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Oct 2019 16:01:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 098F06E8EB;
	Mon, 28 Oct 2019 15:01:05 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 2/5] drm/dsi: add missing DSI data types

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 42E3A702B63
	for <lists+intel-gfx@lfdr.de>; Mon, 15 May 2023 13:24:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5D5D10E056;
	Mon, 15 May 2023 11:24:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4693510E056;
 Mon, 15 May 2023 11:24:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684149896; x=1715685896;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-id:content-transfer-encoding: mime-version;
 bh=awKSqmCq/eio3xsw1c2qSv7W4u3/D2cuHmzS9LAvCSw=;
 b=IQU7eUVtHyMcaS+mzI1OlDzp6DDroyHeS+D1ymblhDIpCk++RAb3eDjC
 4pWx7y1kwOjHEmNcQEm349X8lxcfRph7fySySSFh7OMwin8cGofHIRck4
 Zb+VlktZU6iMOiypuZZ+gyokirKUdmtpgu6EW7ohfgQZ23KpfIsUB+sqJ
 DEGe+8s8TzBAH/QOfY8sl10tf+eQq8Owf78+B8GnGkG6SDy0R7fFmh/Kc
 ZdsyFXzeCBPytyblMd8ns1laLt1iq7tBOy92NwhueEz3B7aew7RdWUarI
 TXFDqWDrbNZ9/LATk5UDm+92+Hpnv3RaOopjk2y5fyjQ7/F8lEWOQPh8K Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="350014158"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="350014158"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 May 2023 04:24:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10710"; a="678413611"
X-IronPort-AV: E=Sophos;i="5.99,276,1677571200"; d="scan'208";a="678413611"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 15 May 2023 11:24:51.3956 (UTC)

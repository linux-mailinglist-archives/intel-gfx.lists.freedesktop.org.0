...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 65F191580B2
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Feb 2020 18:10:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12F746ECE7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 06/18] drm/i915/dp: Read out DP SDPs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 946B53FEBD4
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Sep 2021 12:05:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D0886E4C1;
	Thu,  2 Sep 2021 10:05:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2BC386E4C5
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Sep 2021 10:05:45 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10094"; a="198611194"
X-IronPort-AV: E=Sophos;i="5.84,372,1620716400"; d="scan'208";a="198611194"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Sep 2021 03:05:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.84,372,1620716400"; d="scan'208";a="510920606"
Received: from shawnle1-build-machine.itwn.intel.com ([10.5.253.12])
 by orsmga001.jf.intel.com with ESMTP; 02 Sep 2021 03:05:40 -0700
...
Date: Thu,  2 Sep 2021 18:08:47 +0800
Message-Id: <20210902100851.21719-2-shawn.c.lee@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210902100851.21719-1-shawn.c.lee@intel.com>
References: <20210902100851.21719-1-shawn.c.lee@intel.com>
Subject: [Intel-gfx] [v2 1/5] drm/i915/dsi: wait for header and payload
 credit available

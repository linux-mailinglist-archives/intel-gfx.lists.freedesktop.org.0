...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C9E34B970A
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 04:49:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 395EC10E7A0;
...
Subject: [Intel-gfx] [PATCH 07/13] drm_print: condense enum
 drm_debug_category

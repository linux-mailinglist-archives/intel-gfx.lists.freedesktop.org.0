...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA091688B84
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Feb 2023 01:11:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 262D210E6BA;
...
Subject: [Intel-gfx] [PATCH 4/6] drm/i915/guc: More debug print updates -
 GuC selftests

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 692844020F3
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Sep 2021 23:02:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C08D89D8A;
...
Subject: [Intel-gfx] [RFC v2 19/22] drm/i915/xelpd: Define and Initialize
 Plane Gamma Lut range

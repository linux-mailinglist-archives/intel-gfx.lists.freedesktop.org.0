...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FEF5243697
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Aug 2020 10:37:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 798086E9CB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/20] drm/radeon: Introduce GEM object functions

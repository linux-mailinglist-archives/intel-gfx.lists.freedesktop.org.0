...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF115603930
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Oct 2022 07:21:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0A5210F141;
	Wed, 19 Oct 2022 05:21:15 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 4/4] drm/i915/mtl: C6 residency and C state type
 for MTL SAMedia

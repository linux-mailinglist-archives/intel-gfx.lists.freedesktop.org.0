...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EE2C5E75F5
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Sep 2022 10:40:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EEDB210E74A;
	Fri, 23 Sep 2022 08:40:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A923310E74A;
 Fri, 23 Sep 2022 08:40:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663922425; x=1695458425;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=zHM86bZBifc4ZHL1/+9Jekj60fKJFejNUvx52iUhdQo=;
 b=e1RMaKYIukXlTbOjqKooQBAyHyEFM+eXVT6l5NC3WaO69xV0Lrw2iAo6
 HhTjkYmH550ud5qvyxHZO8YJlim1oCFw619M/ZsUDE+H+mWL0ruTGonQP
 8VtIVo/36iW0xhf6jwCFS7+84ouUuDjuryqRiyHlz4Yo98LDRyclXKzhb
 W4l2uioGKkF8iS8F2JuvXI6cDD+XEhTk7kY30JZb/EfqawJ9GvFSxD9eu
 E5i5GpGUvCInBDFr55LJ3yDrzGgFB//BOrbfLg6U+HXYsjj6VUqPQ52PW
 IXf/WSgDYmLHugMeZPJ6p35CqifleowVinIvxz3ZFlHt7t/z2pwRkiq29 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10478"; a="386835853"
X-IronPort-AV: E=Sophos;i="5.93,337,1654585200"; d="scan'208";a="386835853"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2022 01:40:24 -0700
X-IronPort-AV: E=Sophos;i="5.93,337,1654585200"; d="scan'208";a="650875401"
Received: from ccislaru-mobl.ger.corp.intel.com (HELO [10.213.225.140])
 ([10.213.225.140])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Sep 2022 01:40:22 -0700
Message-ID: <99bbab8d-42e7-2aed-d64a-5bd61dfc9fd6@linux.intel.com>
Date: Fri, 23 Sep 2022 09:40:20 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220921070945.27764-14-niranjana.vishwanathapura@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
Subject: Re: [Intel-gfx] [RFC v4 13/14] drm/i915/vm_bind: Skip vma_lookup
 for persistent vmas

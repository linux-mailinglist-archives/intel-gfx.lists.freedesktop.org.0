...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 517A57A699F
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Sep 2023 19:27:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8ED0B10E13D;
	Tue, 19 Sep 2023 17:27:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6741510E13A
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=R913Y1lqfIX9t8/KmXKPG2UaGbSIXlJnOCIDT2LkNi0rwJJC2wI1AW2X
 94XrAGmL3g9n9v/onuSZ/diFEingiBlIRsVrU6NZU3swb4Q4n/QeOYlyY
 C+akA5XVYKexlp4zDHV5evqxlDq+le05D41tq+M98RG0FylKGg3gFFDwp
 rp1KzPUJNZkNDV2nh+Cr7V/bBIpMSldyEA/BGLUmcfusIVYEjR3Wt//rv
 dd7dsMPRY1VzUwNFOz+o+XyN631DuSwsaNUp04wokBiB8R7PxvgBKVK5P
 6d5a/hZlYyhgBb/CGAovR7by9iVGvKHlHVVOAElBywURR+woDJzPGDvG9 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="360266460"
X-IronPort-AV: E=Sophos;i="6.02,160,1688454000"; d="scan'208";a="360266460"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2023 10:27:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="993247476"
X-IronPort-AV: E=Sophos;i="6.02,160,1688454000"; d="scan'208";a="993247476"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2023 10:27:41 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 19 Sep 2023 10:16:54 -0700
Message-Id: <20230919171655.3308090-3-jonathan.cavitt@intel.com>

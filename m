...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 6CDHINWrgWn0IQMAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 03 Feb 2026 09:03:33 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E64FD5F67
	for <lists+intel-gfx@lfdr.de>; Tue, 03 Feb 2026 09:03:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9482C10E58B;
	Tue,  3 Feb 2026 08:03:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from a3b018990fe9 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A0C9910E30B;
 Tue,  3 Feb 2026 08:03:28 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============5384753435990656785=="
MIME-Version: 1.0
...
Date: Tue, 03 Feb 2026 08:03:28 -0000
Message-ID: <177010580861.219446.13954718013747938473@a3b018990fe9>
...
#### Issues hit ####
  ...
  * igt@device_reset@unbind-cold-reset-rebind:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@device_reset@unbind-cold-reset-rebind.html

  * igt@gem_bad_reloc@negative-reloc:
    - shard-rkl:          NOTRUN -> [SKIP][2] ([i915#3281]) +1 other test skip
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@gem_bad_reloc@negative-reloc.html

  * igt@gem_basic@multigpu-create-close:
    - shard-dg2:          NOTRUN -> [SKIP][3] ([i915#7697])
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_basic@multigpu-create-close.html

  * igt@gem_ccs@block-multicopy-compressed:
    - shard-rkl:          NOTRUN -> [SKIP][4] ([i915#9323])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@gem_ccs@block-multicopy-compressed.html

  * igt@gem_ccs@suspend-resume:
    - shard-dg2:          [PASS][5] -> [INCOMPLETE][6] ([i915#13356])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-11/igt@gem_ccs@suspend-resume.html
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-7/igt@gem_ccs@suspend-resume.html

  * igt@gem_ccs@suspend-resume@linear-compressed-compfmt0-lmem0-lmem0:
    - shard-dg2:          [PASS][7] -> [INCOMPLETE][8] ([i915#12392] / [i915#13356])
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-11/igt@gem_ccs@suspend-resume@linear-compressed-compfmt0-lmem0-lmem0.html
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-7/igt@gem_ccs@suspend-resume@linear-compressed-compfmt0-lmem0-lmem0.html

  * igt@gem_create@create-ext-cpu-access-big:
    - shard-tglu-1:       NOTRUN -> [SKIP][9] ([i915#6335])
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@gem_create@create-ext-cpu-access-big.html

  * igt@gem_eio@throttle:
    - shard-dg1:          [PASS][10] -> [DMESG-WARN][11] ([i915#4423]) +2 other tests dmesg-warn
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@gem_eio@throttle.html
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@gem_eio@throttle.html

  * igt@gem_exec_big@single:
    - shard-mtlp:         [PASS][12] -> [DMESG-FAIL][13] ([i915#15478])
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-3/igt@gem_exec_big@single.html
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-4/igt@gem_exec_big@single.html

  * igt@gem_exec_capture@capture@vecs0-lmem0:
    - shard-dg2:          NOTRUN -> [FAIL][14] ([i915#11965]) +4 other tests fail
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_exec_capture@capture@vecs0-lmem0.html

  * igt@gem_exec_flush@basic-wb-rw-default:
    - shard-dg1:          NOTRUN -> [SKIP][15] ([i915#3539] / [i915#4852])
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@gem_exec_flush@basic-wb-rw-default.html

  * igt@gem_exec_reloc@basic-wc-cpu:
    - shard-dg2:          NOTRUN -> [SKIP][16] ([i915#3281]) +1 other test skip
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_exec_reloc@basic-wc-cpu.html

  * igt@gem_exec_reloc@basic-wc-cpu-noreloc:
    - shard-dg1:          NOTRUN -> [SKIP][17] ([i915#3281])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@gem_exec_reloc@basic-wc-cpu-noreloc.html

  * igt@gem_huc_copy@huc-copy:
    - shard-tglu-1:       NOTRUN -> [SKIP][18] ([i915#2190])
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@gem_huc_copy@huc-copy.html

  * igt@gem_lmem_swapping@heavy-multi:
    - shard-tglu-1:       NOTRUN -> [SKIP][19] ([i915#4613])
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@gem_lmem_swapping@heavy-multi.html

  * igt@gem_lmem_swapping@random:
    - shard-tglu:         NOTRUN -> [SKIP][20] ([i915#4613]) +1 other test skip
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@gem_lmem_swapping@random.html

  * igt@gem_lmem_swapping@verify-random-ccs:
    - shard-glk:          NOTRUN -> [SKIP][21] ([i915#4613])
   [21]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk3/igt@gem_lmem_swapping@verify-random-ccs.html

  * igt@gem_media_vme:
    - shard-tglu-1:       NOTRUN -> [SKIP][22] ([i915#284])
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@gem_media_vme.html

  * igt@gem_mmap@pf-nonblock:
    - shard-mtlp:         NOTRUN -> [SKIP][23] ([i915#4083])
   [23]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@gem_mmap@pf-nonblock.html

  * igt@gem_mmap_gtt@big-copy-odd:
    - shard-dg1:          NOTRUN -> [SKIP][24] ([i915#4077])
   [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@gem_mmap_gtt@big-copy-odd.html

  * igt@gem_mmap_offset@clear-via-pagefault:
    - shard-mtlp:         [PASS][25] -> [ABORT][26] ([i915#14809]) +1 other test abort
   [25]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-7/igt@gem_mmap_offset@clear-via-pagefault.html
   [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-6/igt@gem_mmap_offset@clear-via-pagefault.html

  * igt@gem_mmap_wc@write:
    - shard-dg2:          NOTRUN -> [SKIP][27] ([i915#4083])
   [27]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_mmap_wc@write.html

  * igt@gem_mmap_wc@write-prefaulted:
    - shard-dg1:          NOTRUN -> [SKIP][28] ([i915#4083])
   [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@gem_mmap_wc@write-prefaulted.html

  * igt@gem_pread@exhaustion:
    - shard-dg2:          NOTRUN -> [SKIP][29] ([i915#3282])
   [29]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_pread@exhaustion.html

  * igt@gem_pwrite@basic-exhaustion:
    - shard-tglu-1:       NOTRUN -> [WARN][30] ([i915#2658])
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@gem_pwrite@basic-exhaustion.html

  * igt@gem_pxp@protected-encrypted-src-copy-not-readible:
    - shard-dg2:          NOTRUN -> [SKIP][31] ([i915#4270])
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_pxp@protected-encrypted-src-copy-not-readible.html

  * igt@gem_render_copy@yf-tiled-to-vebox-linear:
    - shard-dg2:          NOTRUN -> [SKIP][32] ([i915#5190] / [i915#8428]) +1 other test skip
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_render_copy@yf-tiled-to-vebox-linear.html

  * igt@gem_set_tiling_vs_gtt:
    - shard-dg2:          NOTRUN -> [SKIP][33] ([i915#4079])
   [33]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_set_tiling_vs_gtt.html

  * igt@gem_userptr_blits@access-control:
    - shard-tglu-1:       NOTRUN -> [SKIP][34] ([i915#3297])
   [34]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@gem_userptr_blits@access-control.html

  * igt@gem_userptr_blits@coherency-sync:
    - shard-tglu:         NOTRUN -> [SKIP][35] ([i915#3297])
   [35]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@gem_userptr_blits@coherency-sync.html

  * igt@gem_userptr_blits@dmabuf-sync:
    - shard-rkl:          NOTRUN -> [SKIP][36] ([i915#3297] / [i915#3323])
   [36]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@gem_userptr_blits@dmabuf-sync.html

  * igt@gem_userptr_blits@unsync-unmap:
    - shard-rkl:          NOTRUN -> [SKIP][37] ([i915#3297])
   [37]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@gem_userptr_blits@unsync-unmap.html

  * igt@gen9_exec_parse@allowed-single:
    - shard-glk:          [PASS][38] -> [ABORT][39] ([i915#5566])
   [38]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-glk3/igt@gen9_exec_parse@allowed-single.html
   [39]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk9/igt@gen9_exec_parse@allowed-single.html

  * igt@gen9_exec_parse@basic-rejected-ctx-param:
    - shard-rkl:          NOTRUN -> [SKIP][40] ([i915#2527])
   [40]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@gen9_exec_parse@basic-rejected-ctx-param.html

  * igt@gen9_exec_parse@secure-batches:
    - shard-tglu:         NOTRUN -> [SKIP][41] ([i915#2527] / [i915#2856])
   [41]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@gen9_exec_parse@secure-batches.html

  * igt@gen9_exec_parse@valid-registers:
    - shard-tglu-1:       NOTRUN -> [SKIP][42] ([i915#2527] / [i915#2856]) +1 other test skip
   [42]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@gen9_exec_parse@valid-registers.html

  * igt@i915_module_load@fault-injection:
    - shard-dg1:          NOTRUN -> [ABORT][43] ([i915#11815] / [i915#15481]) +1 other test abort
   [43]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@i915_module_load@fault-injection.html

  * igt@i915_module_load@fault-injection@i915_driver_mmio_probe:
    - shard-dg1:          NOTRUN -> [INCOMPLETE][44] ([i915#15481])
   [44]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@i915_module_load@fault-injection@i915_driver_mmio_probe.html

  * igt@i915_module_load@fault-injection@intel_connector_register:
    - shard-tglu:         NOTRUN -> [ABORT][45] ([i915#15342]) +1 other test abort
   [45]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-10/igt@i915_module_load@fault-injection@intel_connector_register.html
    - shard-glk:          NOTRUN -> [ABORT][46] ([i915#15342]) +1 other test abort
   [46]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk5/igt@i915_module_load@fault-injection@intel_connector_register.html

  * igt@i915_module_load@fault-injection@uc_fw_rsa_data_create:
    - shard-tglu:         NOTRUN -> [SKIP][47] ([i915#15479]) +4 other tests skip
   [47]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-10/igt@i915_module_load@fault-injection@uc_fw_rsa_data_create.html

  * igt@i915_pm_freq_api@freq-basic-api:
    - shard-rkl:          NOTRUN -> [SKIP][48] ([i915#8399])
   [48]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@i915_pm_freq_api@freq-basic-api.html

  * igt@i915_pm_rpm@gem-evict-pwrite:
    - shard-dg2:          NOTRUN -> [SKIP][49] ([i915#4077])
   [49]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@i915_pm_rpm@gem-evict-pwrite.html

  * igt@i915_pm_sseu@full-enable:
    - shard-tglu-1:       NOTRUN -> [SKIP][50] ([i915#4387])
   [50]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@i915_pm_sseu@full-enable.html

  * igt@i915_suspend@forcewake:
    - shard-rkl:          [PASS][51] -> [ABORT][52] ([i915#15140])
   [51]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-5/igt@i915_suspend@forcewake.html
   [52]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-1/igt@i915_suspend@forcewake.html

  * igt@kms_async_flips@async-flip-suspend-resume:
    - shard-glk10:        NOTRUN -> [INCOMPLETE][53] ([i915#12761])
   [53]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk10/igt@kms_async_flips@async-flip-suspend-resume.html

  * igt@kms_async_flips@async-flip-suspend-resume@pipe-a-hdmi-a-2:
    - shard-glk10:        NOTRUN -> [INCOMPLETE][54] ([i915#12761] / [i915#14995])
   [54]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk10/igt@kms_async_flips@async-flip-suspend-resume@pipe-a-hdmi-a-2.html

  * igt@kms_async_flips@test-cursor:
    - shard-mtlp:         NOTRUN -> [SKIP][55] ([i915#10333])
   [55]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@kms_async_flips@test-cursor.html

  * igt@kms_big_fb@4-tiled-16bpp-rotate-0:
    - shard-tglu-1:       NOTRUN -> [SKIP][56] ([i915#5286]) +2 other tests skip
   [56]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_big_fb@4-tiled-16bpp-rotate-0.html

  * igt@kms_big_fb@4-tiled-32bpp-rotate-180:
    - shard-dg1:          NOTRUN -> [SKIP][57] ([i915#4538] / [i915#5286])
   [57]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_big_fb@4-tiled-32bpp-rotate-180.html

  * igt@kms_big_fb@4-tiled-64bpp-rotate-0:
    - shard-rkl:          NOTRUN -> [SKIP][58] ([i915#5286]) +1 other test skip
   [58]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_big_fb@4-tiled-64bpp-rotate-0.html

  * igt@kms_big_fb@4-tiled-64bpp-rotate-180:
    - shard-mtlp:         [PASS][59] -> [FAIL][60] ([i915#5138])
   [59]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-3/igt@kms_big_fb@4-tiled-64bpp-rotate-180.html
   [60]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-2/igt@kms_big_fb@4-tiled-64bpp-rotate-180.html

  * igt@kms_big_fb@4-tiled-max-hw-stride-32bpp-rotate-0-hflip:
    - shard-tglu:         NOTRUN -> [SKIP][61] ([i915#5286]) +1 other test skip
   [61]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_big_fb@4-tiled-max-hw-stride-32bpp-rotate-0-hflip.html

  * igt@kms_big_fb@linear-64bpp-rotate-270:
    - shard-rkl:          NOTRUN -> [SKIP][62] ([i915#3638])
   [62]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_big_fb@linear-64bpp-rotate-270.html

  * igt@kms_big_fb@x-tiled-64bpp-rotate-270:
    - shard-dg1:          NOTRUN -> [SKIP][63] ([i915#3638])
   [63]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_big_fb@x-tiled-64bpp-rotate-270.html

  * igt@kms_big_fb@yf-tiled-16bpp-rotate-0:
    - shard-dg2:          NOTRUN -> [SKIP][64] ([i915#4538] / [i915#5190]) +2 other tests skip
   [64]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_big_fb@yf-tiled-16bpp-rotate-0.html

  * igt@kms_ccs@ccs-on-another-bo-y-tiled-ccs@pipe-b-edp-1:
    - shard-mtlp:         NOTRUN -> [SKIP][65] ([i915#6095]) +9 other tests skip
   [65]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@kms_ccs@ccs-on-another-bo-y-tiled-ccs@pipe-b-edp-1.html

  * igt@kms_ccs@crc-primary-basic-4-tiled-dg2-rc-ccs-cc@pipe-c-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][66] ([i915#6095]) +51 other tests skip
   [66]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-6/igt@kms_ccs@crc-primary-basic-4-tiled-dg2-rc-ccs-cc@pipe-c-hdmi-a-3.html

  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-lnl-ccs:
    - shard-glk10:        NOTRUN -> [SKIP][67] +43 other tests skip
   [67]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk10/igt@kms_ccs@crc-primary-rotation-180-4-tiled-lnl-ccs.html
  ...
  * igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-1:
   ...
   [68]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_ccs@crc-primary-rotation-180-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-1.html

  * igt@kms_ccs@crc-primary-suspend-yf-tiled-ccs:
    - shard-glk:          NOTRUN -> [INCOMPLETE][69] ([i915#14694] / [i915#15582]) +1 other test incomplete
   [69]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk3/igt@kms_ccs@crc-primary-suspend-yf-tiled-ccs.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][70] ([i915#10307] / [i915#6095]) +146 other tests skip
   [70]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-mtl-mc-ccs@pipe-a-hdmi-a-3.html

  * igt@kms_ccs@crc-sprite-planes-basic-y-tiled-ccs@pipe-c-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [SKIP][71] ([i915#14098] / [i915#6095]) +31 other tests skip
   [71]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_ccs@crc-sprite-planes-basic-y-tiled-ccs@pipe-c-hdmi-a-1.html

  * igt@kms_ccs@crc-sprite-planes-basic-y-tiled-gen12-rc-ccs@pipe-d-hdmi-a-1:
    - shard-dg2:          NOTRUN -> [SKIP][72] ([i915#10307] / [i915#10434] / [i915#6095]) +4 other tests skip
   [72]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-4/igt@kms_ccs@crc-sprite-planes-basic-y-tiled-gen12-rc-ccs@pipe-d-hdmi-a-1.html

  * igt@kms_ccs@random-ccs-data-4-tiled-lnl-ccs:
    - shard-tglu-1:       NOTRUN -> [SKIP][73] ([i915#12313]) +1 other test skip
   [73]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_ccs@random-ccs-data-4-tiled-lnl-ccs.html

  * igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [SKIP][74] ([i915#6095]) +51 other tests skip
   [74]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-1/igt@kms_ccs@random-ccs-data-4-tiled-mtl-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@random-ccs-data-y-tiled-ccs@pipe-d-hdmi-a-1:
    - shard-tglu-1:       NOTRUN -> [SKIP][75] ([i915#6095]) +24 other tests skip
   [75]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_ccs@random-ccs-data-y-tiled-ccs@pipe-d-hdmi-a-1.html

  * igt@kms_ccs@random-ccs-data-yf-tiled-ccs@pipe-a-hdmi-a-3:
    - shard-dg1:          NOTRUN -> [SKIP][76] ([i915#6095]) +195 other tests skip
   [76]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-12/igt@kms_ccs@random-ccs-data-yf-tiled-ccs@pipe-a-hdmi-a-3.html

  * igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][77] ([i915#13781]) +4 other tests skip
   [77]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_cdclk@mode-transition@pipe-d-hdmi-a-3.html

  * igt@kms_cdclk@plane-scaling@pipe-c-hdmi-a-3:
    - shard-dg2:          NOTRUN -> [SKIP][78] ([i915#13783]) +3 other tests skip
   [78]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-7/igt@kms_cdclk@plane-scaling@pipe-c-hdmi-a-3.html

  * igt@kms_chamelium_color@ctm-negative:
    - shard-rkl:          NOTRUN -> [SKIP][79] +7 other tests skip
   [79]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_chamelium_color@ctm-negative.html

  * igt@kms_chamelium_frames@hdmi-crc-multiple:
    - shard-tglu:         NOTRUN -> [SKIP][80] ([i915#11151] / [i915#7828]) +2 other tests skip
   [80]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_chamelium_frames@hdmi-crc-multiple.html

  * igt@kms_chamelium_hpd@dp-hpd-for-each-pipe:
    - shard-dg2:          NOTRUN -> [SKIP][81] ([i915#11151] / [i915#7828]) +1 other test skip
   [81]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_chamelium_hpd@dp-hpd-for-each-pipe.html

  * igt@kms_chamelium_hpd@hdmi-hpd-storm-disable:
    - shard-tglu-1:       NOTRUN -> [SKIP][82] ([i915#11151] / [i915#7828]) +2 other tests skip
   [82]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_chamelium_hpd@hdmi-hpd-storm-disable.html

  * igt@kms_chamelium_hpd@hdmi-hpd-with-enabled-mode:
    - shard-rkl:          NOTRUN -> [SKIP][83] ([i915#11151] / [i915#7828]) +1 other test skip
   [83]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_chamelium_hpd@hdmi-hpd-with-enabled-mode.html

  * igt@kms_content_protection@dp-mst-lic-type-0:
    - shard-rkl:          NOTRUN -> [SKIP][84] ([i915#15330] / [i915#3116])
   [84]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_content_protection@dp-mst-lic-type-0.html

  * igt@kms_content_protection@dp-mst-type-0-suspend-resume:
    - shard-tglu-1:       NOTRUN -> [SKIP][85] ([i915#15330])
   [85]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_content_protection@dp-mst-type-0-suspend-resume.html

  * igt@kms_content_protection@legacy-hdcp14:
    - shard-tglu:         NOTRUN -> [SKIP][86] ([i915#6944])
   [86]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_content_protection@legacy-hdcp14.html

  * igt@kms_content_protection@uevent:
    - shard-dg2:          NOTRUN -> [SKIP][87] ([i915#6944] / [i915#7118] / [i915#9424])
   [87]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_content_protection@uevent.html

  * igt@kms_content_protection@uevent-hdcp14@pipe-a-dp-3:
    - shard-dg2:          NOTRUN -> [FAIL][88] ([i915#7173])
   [88]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-11/igt@kms_content_protection@uevent-hdcp14@pipe-a-dp-3.html

  * igt@kms_cursor_crc@cursor-random-64x21:
    - shard-rkl:          [PASS][89] -> [FAIL][90] ([i915#13566])
   [89]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-8/igt@kms_cursor_crc@cursor-random-64x21.html
   [90]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_cursor_crc@cursor-random-64x21.html

  * igt@kms_cursor_crc@cursor-random-max-size:
    - shard-tglu-1:       NOTRUN -> [SKIP][91] ([i915#3555]) +1 other test skip
   [91]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_cursor_crc@cursor-random-max-size.html

  * igt@kms_cursor_crc@cursor-rapid-movement-32x32:
    - shard-tglu:         NOTRUN -> [SKIP][92] ([i915#3555]) +1 other test skip
   [92]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_cursor_crc@cursor-rapid-movement-32x32.html

  * igt@kms_cursor_crc@cursor-rapid-movement-512x512:
    - shard-dg2:          NOTRUN -> [SKIP][93] ([i915#13049])
   [93]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_cursor_crc@cursor-rapid-movement-512x512.html

  * igt@kms_cursor_crc@cursor-rapid-movement-max-size:
    - shard-dg1:          NOTRUN -> [SKIP][94] ([i915#3555])
   [94]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_cursor_crc@cursor-rapid-movement-max-size.html

  * igt@kms_cursor_crc@cursor-sliding-512x512:
    - shard-tglu-1:       NOTRUN -> [SKIP][95] ([i915#13049])
   [95]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_cursor_crc@cursor-sliding-512x512.html

  * igt@kms_cursor_crc@cursor-sliding-64x21@pipe-a-hdmi-a-2:
    - shard-rkl:          NOTRUN -> [FAIL][96] ([i915#13566]) +1 other test fail
   [96]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_cursor_crc@cursor-sliding-64x21@pipe-a-hdmi-a-2.html

  * igt@kms_cursor_legacy@basic-flip-before-cursor-legacy:
    - shard-dg1:          [PASS][97] -> [DMESG-WARN][98] ([i915#4391] / [i915#4423])
   [97]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-17/igt@kms_cursor_legacy@basic-flip-before-cursor-legacy.html
   [98]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-14/igt@kms_cursor_legacy@basic-flip-before-cursor-legacy.html

  * igt@kms_cursor_legacy@cursora-vs-flipb-atomic-transitions:
    - shard-dg2:          NOTRUN -> [SKIP][99] ([i915#13046] / [i915#5354]) +1 other test skip
   [99]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_cursor_legacy@cursora-vs-flipb-atomic-transitions.html

  * igt@kms_cursor_legacy@cursorb-vs-flipb-atomic-transitions-varying-size:
    - shard-dg1:          NOTRUN -> [SKIP][100] +2 other tests skip
   [100]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_cursor_legacy@cursorb-vs-flipb-atomic-transitions-varying-size.html

  * igt@kms_dirtyfb@drrs-dirtyfb-ioctl:
    - shard-rkl:          NOTRUN -> [SKIP][101] ([i915#9723])
   [101]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_dirtyfb@drrs-dirtyfb-ioctl.html

  * igt@kms_display_modes@extended-mode-basic:
    - shard-tglu-1:       NOTRUN -> [SKIP][102] ([i915#13691])
   [102]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_display_modes@extended-mode-basic.html

  * igt@kms_dither@fb-8bpc-vs-panel-6bpc@pipe-a-hdmi-a-1:
    - shard-rkl:          NOTRUN -> [SKIP][103] ([i915#3804])
   [103]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_dither@fb-8bpc-vs-panel-6bpc@pipe-a-hdmi-a-1.html

  * igt@kms_dp_link_training@non-uhbr-sst:
    - shard-tglu-1:       NOTRUN -> [SKIP][104] ([i915#13749])
   [104]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_dp_link_training@non-uhbr-sst.html

  * igt@kms_dp_link_training@uhbr-mst:
    - shard-rkl:          NOTRUN -> [SKIP][105] ([i915#13748])
   [105]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_dp_link_training@uhbr-mst.html

  * igt@kms_dp_linktrain_fallback@dp-fallback:
    - shard-dg2:          [PASS][106] -> [SKIP][107] ([i915#13707])
   [106]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-10/igt@kms_dp_linktrain_fallback@dp-fallback.html
   [107]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-1/igt@kms_dp_linktrain_fallback@dp-fallback.html

  * igt@kms_dsc@dsc-with-bpc-formats:
    - shard-dg2:          NOTRUN -> [SKIP][108] ([i915#3555] / [i915#3840])
   [108]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_dsc@dsc-with-bpc-formats.html

  * igt@kms_flip@2x-absolute-wf_vblank-interruptible:
    - shard-rkl:          NOTRUN -> [SKIP][109] ([i915#9934])
   [109]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_flip@2x-absolute-wf_vblank-interruptible.html

  * igt@kms_flip@2x-flip-vs-fences-interruptible:
    - shard-mtlp:         NOTRUN -> [SKIP][110] ([i915#8381])
   [110]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@kms_flip@2x-flip-vs-fences-interruptible.html

  * igt@kms_flip@2x-flip-vs-suspend:
    - shard-glk:          NOTRUN -> [INCOMPLETE][111] ([i915#12314] / [i915#12745] / [i915#4839] / [i915#6113])
   [111]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk5/igt@kms_flip@2x-flip-vs-suspend.html

  * igt@kms_flip@2x-flip-vs-suspend@ab-hdmi-a1-hdmi-a2:
    - shard-glk:          NOTRUN -> [INCOMPLETE][112] ([i915#12314] / [i915#4839] / [i915#6113])
   [112]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk5/igt@kms_flip@2x-flip-vs-suspend@ab-hdmi-a1-hdmi-a2.html

  * igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1:
    - shard-snb:          [PASS][113] -> [TIMEOUT][114] ([i915#14033]) +1 other test timeout
   [113]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-snb7/igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1.html
   [114]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-snb1/igt@kms_flip@2x-flip-vs-suspend@ab-vga1-hdmi-a1.html

  * igt@kms_flip@2x-flip-vs-wf_vblank:
    - shard-dg2:          NOTRUN -> [SKIP][115] ([i915#9934])
   [115]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_flip@2x-flip-vs-wf_vblank.html

  * igt@kms_flip@2x-nonexisting-fb-interruptible:
    - shard-tglu-1:       NOTRUN -> [SKIP][116] ([i915#3637] / [i915#9934]) +4 other tests skip
   [116]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_flip@2x-nonexisting-fb-interruptible.html

  * igt@kms_flip@2x-plain-flip:
    - shard-tglu:         NOTRUN -> [SKIP][117] ([i915#3637] / [i915#9934]) +1 other test skip
   [117]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_flip@2x-plain-flip.html
    - shard-mtlp:         NOTRUN -> [SKIP][118] ([i915#3637] / [i915#9934])
   [118]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@kms_flip@2x-plain-flip.html

  * igt@kms_flip@flip-vs-suspend:
    - shard-rkl:          [PASS][119] -> [INCOMPLETE][120] ([i915#6113]) +1 other test incomplete
   [119]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_flip@flip-vs-suspend.html
   [120]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_flip@flip-vs-suspend.html

  * igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling:
    - shard-tglu-1:       NOTRUN -> [SKIP][121] ([i915#15643])
   [121]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling:
    - shard-tglu:         NOTRUN -> [SKIP][122] ([i915#15643]) +1 other test skip
   [122]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-4/igt@kms_flip_scaled_crc@flip-32bpp-yftile-to-32bpp-yftileccs-downscaling.html

  * igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling:
    - shard-rkl:          NOTRUN -> [SKIP][123] ([i915#15643]) +2 other tests skip
   [123]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_flip_scaled_crc@flip-64bpp-4tile-to-16bpp-4tile-upscaling.html

  * igt@kms_frontbuffer_tracking@fbc-1p-offscreen-pri-shrfb-draw-mmap-gtt:
    - shard-dg2:          NOTRUN -> [SKIP][124] ([i915#15104])
   [124]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_frontbuffer_tracking@fbc-1p-offscreen-pri-shrfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-1p-primscrn-cur-indfb-draw-mmap-gtt:
    - shard-dg2:          NOTRUN -> [SKIP][125] ([i915#8708]) +3 other tests skip
   [125]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_frontbuffer_tracking@fbc-1p-primscrn-cur-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-2p-primscrn-pri-indfb-draw-mmap-wc:
    - shard-mtlp:         NOTRUN -> [SKIP][126] ([i915#1825])
   [126]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@kms_frontbuffer_tracking@fbc-2p-primscrn-pri-indfb-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-blt:
    - shard-tglu-1:       NOTRUN -> [SKIP][127] ([i915#15574])
   [127]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-blt.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt:
    - shard-tglu:         NOTRUN -> [SKIP][128] ([i915#15574]) +1 other test skip
   [128]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-10/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html
    - shard-dg1:          NOTRUN -> [SKIP][129] ([i915#15574])
   [129]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-wc:
    - shard-rkl:          NOTRUN -> [SKIP][130] ([i915#15574])
   [130]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-wc.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-shrfb-draw-pwrite:
    - shard-rkl:          NOTRUN -> [SKIP][131] ([i915#15102])
   [131]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_frontbuffer_tracking@fbcpsr-1p-offscreen-pri-shrfb-draw-pwrite.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-cur-indfb-draw-blt:
    - shard-tglu:         NOTRUN -> [SKIP][132] ([i915#15102]) +5 other tests skip
   [132]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_frontbuffer_tracking@fbcpsr-1p-primscrn-cur-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-fullscreen:
    - shard-tglu:         NOTRUN -> [SKIP][133] +19 other tests skip
   [133]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-fullscreen.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-onoff:
    - shard-rkl:          NOTRUN -> [SKIP][134] ([i915#1825]) +8 other tests skip
   [134]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-spr-indfb-onoff.html

  * igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-blt:
    - shard-dg2:          NOTRUN -> [SKIP][135] ([i915#15102]) +1 other test skip
   [135]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt:
    - shard-tglu-1:       NOTRUN -> [SKIP][136] ([i915#15102]) +12 other tests skip
   [136]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@psr-1p-pri-indfb-multidraw:
    - shard-dg2:          NOTRUN -> [SKIP][137] ([i915#15102] / [i915#3458]) +3 other tests skip
   [137]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_frontbuffer_tracking@psr-1p-pri-indfb-multidraw.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-indfb-draw-blt:
    - shard-dg1:          NOTRUN -> [SKIP][138] ([i915#15102] / [i915#3458])
   [138]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-indfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@psr-2p-primscrn-spr-indfb-draw-pwrite:
    - shard-dg2:          NOTRUN -> [SKIP][139] ([i915#5354]) +7 other tests skip
   [139]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_frontbuffer_tracking@psr-2p-primscrn-spr-indfb-draw-pwrite.html

  * igt@kms_frontbuffer_tracking@psr-rgb565-draw-render:
    - shard-rkl:          NOTRUN -> [SKIP][140] ([i915#15102] / [i915#3023]) +5 other tests skip
   [140]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_frontbuffer_tracking@psr-rgb565-draw-render.html

  * igt@kms_hdr@bpc-switch:
    - shard-dg2:          [PASS][141] -> [SKIP][142] ([i915#3555] / [i915#8228])
   [141]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-10/igt@kms_hdr@bpc-switch.html
   [142]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-1/igt@kms_hdr@bpc-switch.html

  * igt@kms_hdr@bpc-switch-suspend:
    - shard-tglu:         NOTRUN -> [SKIP][143] ([i915#3555] / [i915#8228])
   [143]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_hdr@bpc-switch-suspend.html

  * igt@kms_hdr@invalid-hdr:
    - shard-rkl:          NOTRUN -> [SKIP][144] ([i915#3555] / [i915#8228])
   [144]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_hdr@invalid-hdr.html

  * igt@kms_hdr@invalid-metadata-sizes:
    - shard-rkl:          [PASS][145] -> [SKIP][146] ([i915#3555] / [i915#8228])
   [145]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_hdr@invalid-metadata-sizes.html
   [146]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_hdr@invalid-metadata-sizes.html
    - shard-tglu-1:       NOTRUN -> [SKIP][147] ([i915#3555] / [i915#8228])
   [147]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_hdr@invalid-metadata-sizes.html

  * igt@kms_joiner@basic-force-ultra-joiner:
    - shard-dg1:          NOTRUN -> [SKIP][148] ([i915#15458])
   [148]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_joiner@basic-force-ultra-joiner.html
    - shard-tglu:         NOTRUN -> [SKIP][149] ([i915#15458])
   [149]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-10/igt@kms_joiner@basic-force-ultra-joiner.html

  * igt@kms_joiner@invalid-modeset-force-big-joiner:
    - shard-tglu:         NOTRUN -> [SKIP][150] ([i915#15459])
   [150]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_joiner@invalid-modeset-force-big-joiner.html

  * igt@kms_joiner@invalid-modeset-ultra-joiner:
    - shard-dg2:          NOTRUN -> [SKIP][151] ([i915#15458])
   [151]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_joiner@invalid-modeset-ultra-joiner.html

  * igt@kms_joiner@switch-modeset-ultra-joiner-big-joiner:
    - shard-rkl:          NOTRUN -> [SKIP][152] ([i915#15638])
   [152]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_joiner@switch-modeset-ultra-joiner-big-joiner.html

  * igt@kms_pipe_b_c_ivb@from-pipe-c-to-b-with-3-lanes:
    - shard-tglu-1:       NOTRUN -> [SKIP][153] +17 other tests skip
   [153]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_pipe_b_c_ivb@from-pipe-c-to-b-with-3-lanes.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping:
    - shard-dg2:          NOTRUN -> [SKIP][154] ([i915#15608] / [i915#15609] / [i915#8825])
   [154]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-a-plane-5:
    - shard-dg2:          NOTRUN -> [SKIP][155] ([i915#15609]) +2 other tests skip
   [155]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-a-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-0:
    - shard-dg2:          NOTRUN -> [SKIP][156] ([i915#15608]) +3 other tests skip
   [156]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-0.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-5:
    - shard-dg2:          NOTRUN -> [SKIP][157] ([i915#15609] / [i915#8825])
   [157]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier@pipe-b-plane-5:
    - shard-tglu-1:       NOTRUN -> [SKIP][158] ([i915#15608]) +12 other tests skip
   [158]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier@pipe-b-plane-7:
    - shard-tglu-1:       NOTRUN -> [SKIP][159] ([i915#15608] / [i915#8825]) +1 other test skip
   [159]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier@pipe-b-plane-7.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-modifier@pipe-b-plane-5:
    - shard-rkl:          NOTRUN -> [SKIP][160] ([i915#15608] / [i915#8825]) +1 other test skip
   [160]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-modifier@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier@pipe-b-plane-0:
    - shard-tglu:         NOTRUN -> [SKIP][161] ([i915#15608]) +22 other tests skip
   [161]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier@pipe-b-plane-0.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier:
    - shard-dg1:          NOTRUN -> [SKIP][162] ([i915#15608] / [i915#8825]) +1 other test skip
   [162]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html
    - shard-tglu:         NOTRUN -> [SKIP][163] ([i915#15608] / [i915#8825]) +5 other tests skip
   [163]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-10/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier@pipe-b-plane-5:
    - shard-dg1:          NOTRUN -> [SKIP][164] ([i915#15608]) +6 other tests skip
   [164]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_plane@pixel-format-y-tiled-ccs-modifier@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping:
    - shard-tglu-1:       NOTRUN -> [SKIP][165] ([i915#15608] / [i915#15609] / [i915#8825])
   [165]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping.html
  ...
  * igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-7:
   ...
   [166]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-7.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-7:
    - shard-tglu-1:       NOTRUN -> [SKIP][167] ([i915#15609]) +2 other tests skip
   [167]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-cc-modifier-source-clamping@pipe-b-plane-7.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-modifier@pipe-b-plane-5:
    - shard-rkl:          NOTRUN -> [SKIP][168] ([i915#15608]) +6 other tests skip
   [168]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_plane@pixel-format-y-tiled-gen12-rc-ccs-modifier@pipe-b-plane-5.html

  * igt@kms_plane_multiple@tiling-4:
    - shard-tglu-1:       NOTRUN -> [SKIP][169] ([i915#14259])
   [169]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_plane_multiple@tiling-4.html

  * igt@kms_plane_scaling@intel-max-src-size:
    - shard-rkl:          [PASS][170] -> [SKIP][171] ([i915#6953])
   [170]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane_scaling@intel-max-src-size.html
   [171]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_plane_scaling@intel-max-src-size.html
    - shard-tglu-1:       NOTRUN -> [SKIP][172] ([i915#6953])
   [172]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_plane_scaling@intel-max-src-size.html

  * igt@kms_plane_scaling@plane-upscale-factor-0-25-with-rotation@pipe-c:
    - shard-rkl:          NOTRUN -> [SKIP][173] ([i915#15329]) +3 other tests skip
   [173]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_plane_scaling@plane-upscale-factor-0-25-with-rotation@pipe-c.html

  * igt@kms_pm_backlight@brightness-with-dpms:
    - shard-tglu-1:       NOTRUN -> [SKIP][174] ([i915#12343])
   [174]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_pm_backlight@brightness-with-dpms.html

  * igt@kms_pm_backlight@fade:
    - shard-tglu-1:       NOTRUN -> [SKIP][175] ([i915#9812])
   [175]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_pm_backlight@fade.html

  * igt@kms_pm_dc@dc6-dpms:
    - shard-tglu:         NOTRUN -> [FAIL][176] ([i915#9295])
   [176]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_pm_dc@dc6-dpms.html

  * igt@kms_pm_dc@dc6-psr:
    - shard-tglu-1:       NOTRUN -> [SKIP][177] ([i915#9685])
   [177]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_pm_dc@dc6-psr.html

  * igt@kms_pm_dc@dc9-dpms:
    - shard-dg2:          [PASS][178] -> [FAIL][179] ([i915#15644])
   [178]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-10/igt@kms_pm_dc@dc9-dpms.html
   [179]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-1/igt@kms_pm_dc@dc9-dpms.html

  * igt@kms_pm_rpm@modeset-non-lpsp:
    - shard-dg1:          [PASS][180] -> [SKIP][181] ([i915#15073]) +1 other test skip
   [180]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-18/igt@kms_pm_rpm@modeset-non-lpsp.html
   [181]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-14/igt@kms_pm_rpm@modeset-non-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait:
    - shard-rkl:          [PASS][182] -> [SKIP][183] ([i915#15073]) +1 other test skip
   [182]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html
   [183]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-5/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html

  * igt@kms_pm_rpm@pc8-residency:
    - shard-dg2:          NOTRUN -> [SKIP][184] +3 other tests skip
   [184]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_pm_rpm@pc8-residency.html

  * igt@kms_pm_rpm@system-suspend-idle:
    - shard-dg2:          [PASS][185] -> [INCOMPLETE][186] ([i915#14419])
   [185]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-4/igt@kms_pm_rpm@system-suspend-idle.html
   [186]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-6/igt@kms_pm_rpm@system-suspend-idle.html

  * igt@kms_prime@basic-crc-hybrid:
    - shard-rkl:          NOTRUN -> [SKIP][187] ([i915#6524])
   [187]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_prime@basic-crc-hybrid.html

  * igt@kms_psr2_sf@fbc-psr2-overlay-plane-update-sf-dmg-area:
    - shard-glk:          NOTRUN -> [SKIP][188] ([i915#11520]) +3 other tests skip
   [188]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk6/igt@kms_psr2_sf@fbc-psr2-overlay-plane-update-sf-dmg-area.html

  * igt@kms_psr2_sf@fbc-psr2-overlay-primary-update-sf-dmg-area:
    - shard-rkl:          NOTRUN -> [SKIP][189] ([i915#11520]) +1 other test skip
   [189]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_psr2_sf@fbc-psr2-overlay-primary-update-sf-dmg-area.html

  * igt@kms_psr2_sf@pr-overlay-plane-update-continuous-sf:
    - shard-tglu:         NOTRUN -> [SKIP][190] ([i915#11520]) +2 other tests skip
   [190]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_psr2_sf@pr-overlay-plane-update-continuous-sf.html

  * igt@kms_psr2_sf@psr2-overlay-plane-move-continuous-sf:
    - shard-tglu-1:       NOTRUN -> [SKIP][191] ([i915#11520]) +2 other tests skip
   [191]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_psr2_sf@psr2-overlay-plane-move-continuous-sf.html
    - shard-glk10:        NOTRUN -> [SKIP][192] ([i915#11520])
   [192]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk10/igt@kms_psr2_sf@psr2-overlay-plane-move-continuous-sf.html

  * igt@kms_psr2_sf@psr2-overlay-primary-update-sf-dmg-area:
    - shard-dg2:          NOTRUN -> [SKIP][193] ([i915#11520]) +2 other tests skip
   [193]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_psr2_sf@psr2-overlay-primary-update-sf-dmg-area.html

  * igt@kms_psr2_su@page_flip-xrgb8888:
    - shard-tglu-1:       NOTRUN -> [SKIP][194] ([i915#9683])
   [194]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_psr2_su@page_flip-xrgb8888.html

  * igt@kms_psr@fbc-psr-basic:
    - shard-dg2:          NOTRUN -> [SKIP][195] ([i915#1072] / [i915#9732]) +3 other tests skip
   [195]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_psr@fbc-psr-basic.html

  * igt@kms_psr@fbc-psr2-basic:
    - shard-tglu-1:       NOTRUN -> [SKIP][196] ([i915#9732]) +7 other tests skip
   [196]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_psr@fbc-psr2-basic.html

  * igt@kms_psr@fbc-psr2-dpms:
    - shard-mtlp:         NOTRUN -> [SKIP][197] ([i915#9688]) +1 other test skip
   [197]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@kms_psr@fbc-psr2-dpms.html

  * igt@kms_psr@psr-cursor-render:
    - shard-rkl:          NOTRUN -> [SKIP][198] ([i915#1072] / [i915#9732]) +8 other tests skip
   [198]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_psr@psr-cursor-render.html

  * igt@kms_psr@psr-sprite-plane-move:
    - shard-tglu:         NOTRUN -> [SKIP][199] ([i915#9732]) +8 other tests skip
   [199]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-2/igt@kms_psr@psr-sprite-plane-move.html

  * igt@kms_psr@psr-sprite-render:
    - shard-dg1:          NOTRUN -> [SKIP][200] ([i915#1072] / [i915#9732]) +2 other tests skip
   [200]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_psr@psr-sprite-render.html

  * igt@kms_rotation_crc@multiplane-rotation:
    - shard-glk:          NOTRUN -> [INCOMPLETE][201] ([i915#15492])
   [201]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk5/igt@kms_rotation_crc@multiplane-rotation.html

  * igt@kms_rotation_crc@primary-4-tiled-reflect-x-0:
    - shard-rkl:          NOTRUN -> [SKIP][202] ([i915#5289])
   [202]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@kms_rotation_crc@primary-4-tiled-reflect-x-0.html

  * igt@kms_selftest@drm_framebuffer:
    - shard-tglu-1:       NOTRUN -> [ABORT][203] ([i915#13179]) +1 other test abort
   [203]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-1/igt@kms_selftest@drm_framebuffer.html

  * igt@kms_setmode@basic-clone-single-crtc:
    - shard-dg2:          NOTRUN -> [SKIP][204] ([i915#3555]) +1 other test skip
   [204]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_setmode@basic-clone-single-crtc.html

  * igt@kms_tiled_display@basic-test-pattern-with-chamelium:
    - shard-rkl:          NOTRUN -> [SKIP][205] ([i915#8623])
   [205]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_tiled_display@basic-test-pattern-with-chamelium.html
    - shard-tglu:         NOTRUN -> [SKIP][206] ([i915#8623])
   [206]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-4/igt@kms_tiled_display@basic-test-pattern-with-chamelium.html

  * igt@kms_vblank@ts-continuation-suspend:
    - shard-snb:          [PASS][207] -> [DMESG-WARN][208] ([i915#13899]) +1 other test dmesg-warn
   [207]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-snb5/igt@kms_vblank@ts-continuation-suspend.html
   [208]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-snb5/igt@kms_vblank@ts-continuation-suspend.html

  * igt@kms_vrr@negative-basic:
    - shard-glk:          NOTRUN -> [SKIP][209] +189 other tests skip
   [209]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk3/igt@kms_vrr@negative-basic.html

  * igt@prime_vgem@basic-read:
    - shard-mtlp:         NOTRUN -> [SKIP][210] ([i915#3708])
   [210]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@prime_vgem@basic-read.html

  * igt@prime_vgem@coherency-gtt:
    - shard-mtlp:         NOTRUN -> [SKIP][211] ([i915#3708] / [i915#4077])
   [211]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@prime_vgem@coherency-gtt.html
...
#### Possible fixes ####
  ...
  * igt@gem_exec_suspend@basic-s0:
   ...
   [212]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-7/igt@gem_exec_suspend@basic-s0.html
   [213]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@gem_exec_suspend@basic-s0.html

  * igt@gem_workarounds@suspend-resume-fd:
    - shard-rkl:          [INCOMPLETE][214] ([i915#13356]) -> [PASS][215]
   [214]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_workarounds@suspend-resume-fd.html
   [215]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@gem_workarounds@suspend-resume-fd.html

  * igt@i915_power@sanity:
    - shard-mtlp:         [SKIP][216] ([i915#7984]) -> [PASS][217]
   [216]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-5/igt@i915_power@sanity.html
   [217]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-5/igt@i915_power@sanity.html

  * igt@i915_selftest@live:
    - shard-mtlp:         [DMESG-FAIL][218] ([i915#12061] / [i915#15560]) -> [PASS][219]
   [218]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-3/igt@i915_selftest@live.html
   [219]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-2/igt@i915_selftest@live.html

  * igt@i915_selftest@live@workarounds:
    - shard-mtlp:         [DMESG-FAIL][220] ([i915#12061]) -> [PASS][221]
   [220]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-3/igt@i915_selftest@live@workarounds.html
   [221]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-2/igt@i915_selftest@live@workarounds.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels:
    - shard-mtlp:         [FAIL][222] ([i915#5956]) -> [PASS][223] +1 other test pass
   [222]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-mtlp-7/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html
   [223]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-mtlp-6/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html

  * igt@kms_cursor_crc@cursor-onscreen-256x85@pipe-a-hdmi-a-2:
    - shard-rkl:          [FAIL][224] ([i915#13566]) -> [PASS][225] +1 other test pass
   [224]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-4/igt@kms_cursor_crc@cursor-onscreen-256x85@pipe-a-hdmi-a-2.html
   [225]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-7/igt@kms_cursor_crc@cursor-onscreen-256x85@pipe-a-hdmi-a-2.html

  * igt@kms_cursor_legacy@cursor-vs-flip-atomic:
    - shard-dg1:          [DMESG-WARN][226] ([i915#4423]) -> [PASS][227] +2 other tests pass
   [226]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-15/igt@kms_cursor_legacy@cursor-vs-flip-atomic.html
   [227]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-12/igt@kms_cursor_legacy@cursor-vs-flip-atomic.html

  * igt@kms_cursor_legacy@flip-vs-cursor-atomic-transitions-varying-size:
    - shard-glk:          [FAIL][228] ([i915#15588] / [i915#2346]) -> [PASS][229]
   [228]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-glk5/igt@kms_cursor_legacy@flip-vs-cursor-atomic-transitions-varying-size.html
   [229]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk9/igt@kms_cursor_legacy@flip-vs-cursor-atomic-transitions-varying-size.html

  * igt@kms_flip@plain-flip-interruptible:
    - shard-tglu:         [ABORT][230] ([i915#15470]) -> [PASS][231]
   [230]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible.html
   [231]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-4/igt@kms_flip@plain-flip-interruptible.html

  * igt@kms_flip@plain-flip-interruptible@a-hdmi-a1:
    - shard-tglu:         [DMESG-WARN][232] ([i915#15470]) -> [PASS][233]
   [232]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible@a-hdmi-a1.html
   [233]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-4/igt@kms_flip@plain-flip-interruptible@a-hdmi-a1.html

  * igt@kms_flip@plain-flip-interruptible@c-hdmi-a1:
    - shard-tglu:         [DMESG-WARN][234] -> [PASS][235] +1 other test pass
   [234]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible@c-hdmi-a1.html
   [235]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-4/igt@kms_flip@plain-flip-interruptible@c-hdmi-a1.html

  * igt@kms_flip@plain-flip-interruptible@d-hdmi-a1:
    - shard-tglu:         [ABORT][236] -> [PASS][237]
   [236]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-tglu-2/igt@kms_flip@plain-flip-interruptible@d-hdmi-a1.html
   [237]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-tglu-4/igt@kms_flip@plain-flip-interruptible@d-hdmi-a1.html

  * igt@kms_frontbuffer_tracking@fbc-2p-primscrn-spr-indfb-draw-pwrite:
    - shard-snb:          [SKIP][238] -> [PASS][239]
   [238]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-snb4/igt@kms_frontbuffer_tracking@fbc-2p-primscrn-spr-indfb-draw-pwrite.html
   [239]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-snb1/igt@kms_frontbuffer_tracking@fbc-2p-primscrn-spr-indfb-draw-pwrite.html

  * igt@kms_hdr@bpc-switch:
    - shard-rkl:          [SKIP][240] ([i915#3555] / [i915#8228]) -> [PASS][241]
   [240]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_hdr@bpc-switch.html
   [241]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_hdr@bpc-switch.html

  * igt@kms_hdr@static-toggle:
    - shard-dg2:          [SKIP][242] ([i915#3555] / [i915#8228]) -> [PASS][243]
   [242]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-3/igt@kms_hdr@static-toggle.html
   [243]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-11/igt@kms_hdr@static-toggle.html

  * igt@kms_pm_dc@dc9-dpms:
    - shard-dg1:          [DMESG-FAIL][244] ([i915#4423]) -> [PASS][245]
   [244]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_pm_dc@dc9-dpms.html
   [245]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-13/igt@kms_pm_dc@dc9-dpms.html

  * igt@kms_pm_rpm@dpms-mode-unset-lpsp:
    - shard-dg1:          [SKIP][246] ([i915#15073]) -> [PASS][247]
   [246]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-18/igt@kms_pm_rpm@dpms-mode-unset-lpsp.html
   [247]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-14/igt@kms_pm_rpm@dpms-mode-unset-lpsp.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress:
    - shard-rkl:          [SKIP][248] ([i915#15073]) -> [PASS][249] +2 other tests pass
   [248]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_pm_rpm@modeset-non-lpsp-stress.html
   [249]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_pm_rpm@modeset-non-lpsp-stress.html

  * igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait:
    - shard-dg2:          [SKIP][250] ([i915#15073]) -> [PASS][251] +2 other tests pass
   [250]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-4/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html
   [251]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-6/igt@kms_pm_rpm@modeset-non-lpsp-stress-no-wait.html

  * igt@kms_setmode@basic:
    - shard-snb:          [FAIL][252] ([i915#15106]) -> [PASS][253] +1 other test pass
   [252]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-snb5/igt@kms_setmode@basic.html
   [253]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-snb1/igt@kms_setmode@basic.html

  * igt@perf_pmu@rc6-suspend:
    - shard-rkl:          [ABORT][254] ([i915#15131]) -> [PASS][255]
   [254]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-1/igt@perf_pmu@rc6-suspend.html
   [255]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-8/igt@perf_pmu@rc6-suspend.html

  
#### Warnings ####

  * igt@api_intel_bb@blit-reloc-purge-cache:
    - shard-rkl:          [SKIP][256] ([i915#14544] / [i915#8411]) -> [SKIP][257] ([i915#8411])
   [256]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@api_intel_bb@blit-reloc-purge-cache.html
   [257]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@api_intel_bb@blit-reloc-purge-cache.html

  * igt@device_reset@unbind-cold-reset-rebind:
    - shard-rkl:          [SKIP][258] ([i915#11078] / [i915#14544]) -> [SKIP][259] ([i915#11078])
   [258]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@device_reset@unbind-cold-reset-rebind.html
   [259]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@device_reset@unbind-cold-reset-rebind.html

  * igt@gem_ccs@ctrl-surf-copy:
    - shard-rkl:          [SKIP][260] ([i915#14544] / [i915#3555] / [i915#9323]) -> [SKIP][261] ([i915#3555] / [i915#9323])
   [260]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_ccs@ctrl-surf-copy.html
   [261]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@gem_ccs@ctrl-surf-copy.html

  * igt@gem_create@create-ext-cpu-access-big:
    - shard-rkl:          [SKIP][262] ([i915#14544] / [i915#6335]) -> [SKIP][263] ([i915#6335])
   [262]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_create@create-ext-cpu-access-big.html
   [263]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@gem_create@create-ext-cpu-access-big.html

  * igt@gem_ctx_sseu@invalid-sseu:
    - shard-rkl:          [SKIP][264] ([i915#14544] / [i915#280]) -> [SKIP][265] ([i915#280])
   [264]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_ctx_sseu@invalid-sseu.html
   [265]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@gem_ctx_sseu@invalid-sseu.html

  * igt@gem_exec_balancer@parallel-out-fence:
    - shard-rkl:          [SKIP][266] ([i915#4525]) -> [SKIP][267] ([i915#14544] / [i915#4525]) +1 other test skip
   [266]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_exec_balancer@parallel-out-fence.html
   [267]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@gem_exec_balancer@parallel-out-fence.html

  * igt@gem_exec_reloc@basic-gtt-cpu-active:
    - shard-rkl:          [SKIP][268] ([i915#14544] / [i915#3281]) -> [SKIP][269] ([i915#3281]) +7 other tests skip
   [268]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_exec_reloc@basic-gtt-cpu-active.html
   [269]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@gem_exec_reloc@basic-gtt-cpu-active.html

  * igt@gem_exec_reloc@basic-gtt-wc-noreloc:
    - shard-rkl:          [SKIP][270] ([i915#3281]) -> [SKIP][271] ([i915#14544] / [i915#3281]) +6 other tests skip
   [270]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_exec_reloc@basic-gtt-wc-noreloc.html
   [271]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@gem_exec_reloc@basic-gtt-wc-noreloc.html

  * igt@gem_exec_schedule@semaphore-power:
    - shard-rkl:          [SKIP][272] ([i915#7276]) -> [SKIP][273] ([i915#14544] / [i915#7276])
   [272]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_exec_schedule@semaphore-power.html
   [273]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@gem_exec_schedule@semaphore-power.html

  * igt@gem_lmem_swapping@heavy-random:
    - shard-rkl:          [SKIP][274] ([i915#4613]) -> [SKIP][275] ([i915#14544] / [i915#4613])
   [274]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@gem_lmem_swapping@heavy-random.html
   [275]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@gem_lmem_swapping@heavy-random.html

  * igt@gem_lmem_swapping@random-engines:
    - shard-rkl:          [SKIP][276] ([i915#14544] / [i915#4613]) -> [SKIP][277] ([i915#4613]) +1 other test skip
   [276]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_lmem_swapping@random-engines.html
   [277]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@gem_lmem_swapping@random-engines.html

  * igt@gem_partial_pwrite_pread@write-display:
    - shard-rkl:          [SKIP][278] ([i915#3282]) -> [SKIP][279] ([i915#14544] / [i915#3282]) +2 other tests skip
   [278]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@gem_partial_pwrite_pread@write-display.html
   [279]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@gem_partial_pwrite_pread@write-display.html

  * igt@gem_partial_pwrite_pread@write-snoop:
    - shard-rkl:          [SKIP][280] ([i915#14544] / [i915#3282]) -> [SKIP][281] ([i915#3282]) +2 other tests skip
   [280]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_partial_pwrite_pread@write-snoop.html
   [281]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@gem_partial_pwrite_pread@write-snoop.html

  * igt@gem_userptr_blits@create-destroy-unsync:
    - shard-rkl:          [SKIP][282] ([i915#14544] / [i915#3297]) -> [SKIP][283] ([i915#3297])
   [282]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_userptr_blits@create-destroy-unsync.html
   [283]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@gem_userptr_blits@create-destroy-unsync.html

  * igt@gem_userptr_blits@forbidden-operations:
    - shard-rkl:          [SKIP][284] ([i915#14544] / [i915#3282] / [i915#3297]) -> [SKIP][285] ([i915#3282] / [i915#3297])
   [284]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gem_userptr_blits@forbidden-operations.html
   [285]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@gem_userptr_blits@forbidden-operations.html

  * igt@gen9_exec_parse@allowed-all:
    - shard-rkl:          [SKIP][286] ([i915#2527]) -> [SKIP][287] ([i915#14544] / [i915#2527])
   [286]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@gen9_exec_parse@allowed-all.html
   [287]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@gen9_exec_parse@allowed-all.html

  * igt@gen9_exec_parse@valid-registers:
    - shard-rkl:          [SKIP][288] ([i915#14544] / [i915#2527]) -> [SKIP][289] ([i915#2527]) +2 other tests skip
   [288]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@gen9_exec_parse@valid-registers.html
   [289]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@gen9_exec_parse@valid-registers.html

  * igt@i915_module_load@fault-injection@__uc_init:
    - shard-rkl:          [SKIP][290] ([i915#15479]) -> [SKIP][291] ([i915#14544] / [i915#15479]) +4 other tests skip
   [290]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@i915_module_load@fault-injection@__uc_init.html
   [291]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@i915_module_load@fault-injection@__uc_init.html

  * igt@i915_pm_rc6_residency@media-rc6-accuracy:
    - shard-rkl:          [SKIP][292] ([i915#14544]) -> [SKIP][293] +8 other tests skip
   [292]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@i915_pm_rc6_residency@media-rc6-accuracy.html
   [293]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@i915_pm_rc6_residency@media-rc6-accuracy.html

  * igt@i915_pm_sseu@full-enable:
    - shard-rkl:          [SKIP][294] ([i915#14544] / [i915#4387]) -> [SKIP][295] ([i915#4387])
   [294]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@i915_pm_sseu@full-enable.html
   [295]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@i915_pm_sseu@full-enable.html

  * igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels:
    - shard-rkl:          [SKIP][296] ([i915#14544] / [i915#1769] / [i915#3555]) -> [SKIP][297] ([i915#1769] / [i915#3555])
   [296]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html
   [297]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_atomic_transition@plane-all-modeset-transition-fencing-internal-panels.html

  * igt@kms_big_fb@4-tiled-16bpp-rotate-0:
    - shard-rkl:          [SKIP][298] ([i915#14544] / [i915#5286]) -> [SKIP][299] ([i915#5286]) +2 other tests skip
   [298]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_big_fb@4-tiled-16bpp-rotate-0.html
   [299]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_big_fb@4-tiled-16bpp-rotate-0.html

  * igt@kms_big_fb@4-tiled-32bpp-rotate-180:
    - shard-rkl:          [SKIP][300] ([i915#5286]) -> [SKIP][301] ([i915#14544] / [i915#5286]) +1 other test skip
   [300]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_big_fb@4-tiled-32bpp-rotate-180.html
   [301]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_big_fb@4-tiled-32bpp-rotate-180.html

  * igt@kms_big_fb@linear-64bpp-rotate-90:
    - shard-rkl:          [SKIP][302] ([i915#14544] / [i915#3638]) -> [SKIP][303] ([i915#3638])
   [302]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_big_fb@linear-64bpp-rotate-90.html
   [303]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_big_fb@linear-64bpp-rotate-90.html

  * igt@kms_big_fb@x-tiled-32bpp-rotate-270:
    - shard-rkl:          [SKIP][304] ([i915#3638]) -> [SKIP][305] ([i915#14544] / [i915#3638]) +3 other tests skip
   [304]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_big_fb@x-tiled-32bpp-rotate-270.html
   [305]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_big_fb@x-tiled-32bpp-rotate-270.html

  * igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2:
    - shard-rkl:          [SKIP][306] ([i915#14544] / [i915#6095]) -> [SKIP][307] ([i915#6095]) +13 other tests skip
   [306]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2.html
   [307]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_ccs@bad-rotation-90-4-tiled-mtl-rc-ccs-cc@pipe-a-hdmi-a-2.html

  * igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2:
    - shard-rkl:          [SKIP][308] ([i915#14098] / [i915#14544] / [i915#6095]) -> [SKIP][309] ([i915#14098] / [i915#6095]) +15 other tests skip
   [308]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html
   [309]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_ccs@bad-rotation-90-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html

  * igt@kms_ccs@crc-primary-basic-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2:
    - shard-rkl:          [SKIP][310] ([i915#14098] / [i915#6095]) -> [SKIP][311] ([i915#14098] / [i915#14544] / [i915#6095]) +5 other tests skip
   [310]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_ccs@crc-primary-basic-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html
   [311]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_ccs@crc-primary-basic-y-tiled-gen12-mc-ccs@pipe-c-hdmi-a-2.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2:
    - shard-rkl:          [SKIP][312] ([i915#6095]) -> [SKIP][313] ([i915#14544] / [i915#6095]) +5 other tests skip
   [312]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2.html
   [313]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-dg2-rc-ccs@pipe-b-hdmi-a-2.html

  * igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs:
    - shard-rkl:          [SKIP][314] ([i915#12313]) -> [SKIP][315] ([i915#12313] / [i915#14544]) +2 other tests skip
   [314]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html
   [315]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_ccs@crc-sprite-planes-basic-4-tiled-lnl-ccs.html

  * igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs:
    - shard-dg1:          [SKIP][316] ([i915#12313] / [i915#4423]) -> [SKIP][317] ([i915#12313])
   [316]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs.html
   [317]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-13/igt@kms_ccs@random-ccs-data-4-tiled-bmg-ccs.html

  * igt@kms_chamelium_edid@dp-edid-stress-resolution-4k:
    - shard-rkl:          [SKIP][318] ([i915#11151] / [i915#14544] / [i915#7828]) -> [SKIP][319] ([i915#11151] / [i915#7828]) +3 other tests skip
   [318]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_chamelium_edid@dp-edid-stress-resolution-4k.html
   [319]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_chamelium_edid@dp-edid-stress-resolution-4k.html

  * igt@kms_chamelium_frames@hdmi-crc-nonplanar-formats:
    - shard-rkl:          [SKIP][320] ([i915#11151] / [i915#7828]) -> [SKIP][321] ([i915#11151] / [i915#14544] / [i915#7828]) +2 other tests skip
   [320]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_chamelium_frames@hdmi-crc-nonplanar-formats.html
   [321]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_chamelium_frames@hdmi-crc-nonplanar-formats.html

  * igt@kms_content_protection@atomic-hdcp14:
    - shard-dg2:          [FAIL][322] ([i915#7173]) -> [SKIP][323] ([i915#6944])
   [322]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-11/igt@kms_content_protection@atomic-hdcp14.html
   [323]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-5/igt@kms_content_protection@atomic-hdcp14.html
    - shard-rkl:          [SKIP][324] ([i915#14544] / [i915#6944]) -> [SKIP][325] ([i915#6944])
   [324]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_content_protection@atomic-hdcp14.html
   [325]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_content_protection@atomic-hdcp14.html

  * igt@kms_content_protection@content-type-change:
    - shard-rkl:          [SKIP][326] ([i915#6944] / [i915#9424]) -> [SKIP][327] ([i915#14544] / [i915#6944] / [i915#9424])
   [326]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_content_protection@content-type-change.html
   [327]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_content_protection@content-type-change.html

  * igt@kms_content_protection@dp-mst-type-0-suspend-resume:
    - shard-rkl:          [SKIP][328] ([i915#14544] / [i915#15330]) -> [SKIP][329] ([i915#15330])
   [328]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_content_protection@dp-mst-type-0-suspend-resume.html
   [329]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_content_protection@dp-mst-type-0-suspend-resume.html

  * igt@kms_content_protection@uevent-hdcp14:
    - shard-dg2:          [SKIP][330] ([i915#6944]) -> [FAIL][331] ([i915#7173])
   [330]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-3/igt@kms_content_protection@uevent-hdcp14.html
   [331]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-11/igt@kms_content_protection@uevent-hdcp14.html

  * igt@kms_cursor_crc@cursor-offscreen-512x512:
    - shard-rkl:          [SKIP][332] ([i915#13049]) -> [SKIP][333] ([i915#13049] / [i915#14544])
   [332]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_cursor_crc@cursor-offscreen-512x512.html
   [333]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_cursor_crc@cursor-offscreen-512x512.html

  * igt@kms_cursor_crc@cursor-random-max-size:
    - shard-rkl:          [SKIP][334] ([i915#14544] / [i915#3555]) -> [SKIP][335] ([i915#3555]) +1 other test skip
   [334]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_cursor_crc@cursor-random-max-size.html
   [335]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_cursor_crc@cursor-random-max-size.html

  * igt@kms_cursor_crc@cursor-rapid-movement-32x32:
    - shard-dg1:          [SKIP][336] ([i915#3555]) -> [SKIP][337] ([i915#3555] / [i915#4423])
   [336]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_cursor_crc@cursor-rapid-movement-32x32.html
   [337]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-16/igt@kms_cursor_crc@cursor-rapid-movement-32x32.html

  * igt@kms_cursor_crc@cursor-rapid-movement-max-size:
    - shard-rkl:          [SKIP][338] ([i915#3555]) -> [SKIP][339] ([i915#14544] / [i915#3555])
   [338]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_cursor_crc@cursor-rapid-movement-max-size.html
   [339]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_cursor_crc@cursor-rapid-movement-max-size.html

  * igt@kms_cursor_crc@cursor-sliding-512x512:
    - shard-rkl:          [SKIP][340] ([i915#13049] / [i915#14544]) -> [SKIP][341] ([i915#13049])
   [340]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_cursor_crc@cursor-sliding-512x512.html
   [341]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_cursor_crc@cursor-sliding-512x512.html

  * igt@kms_cursor_legacy@cursora-vs-flipb-varying-size:
    - shard-rkl:          [SKIP][342] -> [SKIP][343] ([i915#14544]) +8 other tests skip
   [342]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_cursor_legacy@cursora-vs-flipb-varying-size.html
   [343]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_cursor_legacy@cursora-vs-flipb-varying-size.html
  ...
  * igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling:
    - shard-rkl:          [SKIP][360] ([i915#14544]) -> [SKIP][361] ([i915#15643]) +1 other test skip
   [360]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling.html
   [361]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_flip_scaled_crc@flip-32bpp-4tile-to-64bpp-4tile-upscaling.html

  * igt@kms_flip_scaled_crc@flip-32bpp-yuv-linear-to-32bpp-yuv-linear-reflect-x:
    - shard-rkl:          [SKIP][362] ([i915#14544]) -> [SKIP][363] ([i915#15645]) +1 other test skip
   [362]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_flip_scaled_crc@flip-32bpp-yuv-linear-to-32bpp-yuv-linear-reflect-x.html
   [363]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_flip_scaled_crc@flip-32bpp-yuv-linear-to-32bpp-yuv-linear-reflect-x.html

  * igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling:
    - shard-rkl:          [SKIP][364] ([i915#15643]) -> [SKIP][365] ([i915#14544]) +1 other test skip
   [364]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling.html
   [365]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_flip_scaled_crc@flip-64bpp-yftile-to-32bpp-yftile-upscaling.html

  * igt@kms_frontbuffer_tracking@fbc-2p-indfb-fliptrack-mmap-gtt:
    - shard-dg1:          [SKIP][366] ([i915#8708]) -> [SKIP][367] ([i915#4423] / [i915#8708])
   [366]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-12/igt@kms_frontbuffer_tracking@fbc-2p-indfb-fliptrack-mmap-gtt.html
   [367]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-13/igt@kms_frontbuffer_tracking@fbc-2p-indfb-fliptrack-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-mmap-cpu:
    - shard-dg1:          [SKIP][368] ([i915#4423]) -> [SKIP][369]
   [368]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-mmap-cpu.html
   [369]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-13/igt@kms_frontbuffer_tracking@fbc-2p-scndscrn-pri-indfb-draw-mmap-cpu.html

  * igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt:
    - shard-rkl:          [SKIP][370] ([i915#15574]) -> [SKIP][371] ([i915#14544] / [i915#15574])
   [370]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html
   [371]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_frontbuffer_tracking@fbc-abgr161616f-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-1p-rte:
    - shard-rkl:          [SKIP][372] ([i915#14544] / [i915#15102] / [i915#3023]) -> [SKIP][373] ([i915#15102] / [i915#3023]) +9 other tests skip
   [372]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-1p-rte.html
   [373]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_frontbuffer_tracking@fbcpsr-1p-rte.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-pri-shrfb-draw-render:
    - shard-rkl:          [SKIP][374] ([i915#14544] / [i915#1825]) -> [SKIP][375] ([i915#1825]) +14 other tests skip
   [374]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-pri-shrfb-draw-render.html
   [375]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_frontbuffer_tracking@fbcpsr-2p-primscrn-pri-shrfb-draw-render.html

  * igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-shrfb-pgflip-blt:
    - shard-rkl:          [SKIP][376] ([i915#1825]) -> [SKIP][377] ([i915#14544] / [i915#1825]) +12 other tests skip
   [376]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-shrfb-pgflip-blt.html
   [377]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-2p-scndscrn-shrfb-pgflip-blt.html

  * igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-gtt:
    - shard-rkl:          [SKIP][378] ([i915#15102] / [i915#3023]) -> [SKIP][379] ([i915#14544] / [i915#15102] / [i915#3023]) +7 other tests skip
   [378]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-gtt.html
   [379]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_frontbuffer_tracking@fbcpsr-rgb565-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt:
    - shard-rkl:          [SKIP][380] ([i915#14544] / [i915#15102]) -> [SKIP][381] ([i915#15102]) +3 other tests skip
   [380]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt.html
   [381]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_frontbuffer_tracking@psr-1p-offscreen-pri-indfb-draw-mmap-gtt.html

  * igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-shrfb-draw-blt:
    - shard-dg2:          [SKIP][382] ([i915#10433] / [i915#15102] / [i915#3458]) -> [SKIP][383] ([i915#15102] / [i915#3458])
   [382]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-4/igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-shrfb-draw-blt.html
   [383]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-6/igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-shrfb-draw-blt.html

  * igt@kms_frontbuffer_tracking@psr-abgr161616f-draw-blt:
    - shard-rkl:          [SKIP][384] ([i915#14544] / [i915#15574]) -> [SKIP][385] ([i915#15574])
   [384]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_frontbuffer_tracking@psr-abgr161616f-draw-blt.html
   [385]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_frontbuffer_tracking@psr-abgr161616f-draw-blt.html

  * igt@kms_frontbuffer_tracking@psr-indfb-scaledprimary:
    - shard-dg2:          [SKIP][386] ([i915#15102] / [i915#3458]) -> [SKIP][387] ([i915#10433] / [i915#15102] / [i915#3458]) +5 other tests skip
   [386]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg2-3/igt@kms_frontbuffer_tracking@psr-indfb-scaledprimary.html
   [387]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg2-4/igt@kms_frontbuffer_tracking@psr-indfb-scaledprimary.html

  * igt@kms_joiner@basic-force-ultra-joiner:
    - shard-rkl:          [SKIP][388] ([i915#15458]) -> [SKIP][389] ([i915#14544] / [i915#15458]) +1 other test skip
   [388]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_joiner@basic-force-ultra-joiner.html
   [389]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_joiner@basic-force-ultra-joiner.html

  * igt@kms_panel_fitting@legacy:
    - shard-dg1:          [SKIP][390] ([i915#4423] / [i915#6301]) -> [SKIP][391] ([i915#6301])
   [390]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_panel_fitting@legacy.html
   [391]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-13/igt@kms_panel_fitting@legacy.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping:
    - shard-rkl:          [SKIP][392] ([i915#15608] / [i915#15609] / [i915#8825]) -> [SKIP][393] ([i915#14544] / [i915#15608] / [i915#15609] / [i915#8825]) +1 other test skip
   [392]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping.html
   [393]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping@pipe-b-plane-5:
    - shard-rkl:          [SKIP][394] ([i915#15609] / [i915#8825]) -> [SKIP][395] ([i915#14544] / [i915#15609] / [i915#8825]) +1 other test skip
   [394]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html
   [395]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_plane@pixel-format-4-tiled-dg2-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier:
    - shard-rkl:          [SKIP][396] ([i915#14544] / [i915#15608] / [i915#8825]) -> [SKIP][397] ([i915#15608] / [i915#8825]) +1 other test skip
   [396]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier.html
   [397]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_plane@pixel-format-4-tiled-dg2-rc-ccs-cc-modifier.html

  * igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier-source-clamping:
    - shard-rkl:          [SKIP][398] ([i915#14544] / [i915#15608] / [i915#15609] / [i915#8825]) -> [SKIP][399] ([i915#15608] / [i915#15609] / [i915#8825]) +1 other test skip
   [398]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier-source-clamping.html
   [399]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@kms_plane@pixel-format-4-tiled-lnl-ccs-modifier-source-clamping.html

  * igt@kms_plane@pixel-format-y-tiled-ccs-modifier:
    - shard-rkl:          [SKIP][400] ([i915#15608] / [i915#8825]) -> [SKIP][401] ([i915#14544] / [i915#15608] / [i915#8825]) +1 other test skip
   [400]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-2/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html
   [401]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_plane@pixel-format-y-tiled-ccs-modifier.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-a-plane-0:
    - shard-rkl:          [SKIP][402] ([i915#14544] / [i915#15608]) -> [SKIP][403] ([i915#15608]) +2 other tests skip
   [402]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-a-plane-0.html
   [403]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-a-plane-0.html

  * igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-5:
    - shard-rkl:          [SKIP][404] ([i915#14544] / [i915#15609] / [i915#8825]) -> [SKIP][405] ([i915#15609] / [i915#8825]) +1 other test skip
   [404]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html
   [405]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_plane@pixel-format-y-tiled-gen12-mc-ccs-modifier-source-clamping@pipe-b-plane-5.html

  * igt@kms_plane@pixel-format-yf-tiled-ccs-modifier-source-clamping@pipe-a-plane-0:
    - shard-rkl:          [SKIP][406] ([i915#15608]) -> [SKIP][407] ([i915#14544] / [i915#15608]) +2 other tests skip
   [406]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_plane@pixel-format-yf-tiled-ccs-modifier-source-clamping@pipe-a-plane-0.html
   [407]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_plane@pixel-format-yf-tiled-ccs-modifier-source-clamping@pipe-a-plane-0.html

  * igt@kms_pm_backlight@brightness-with-dpms:
    - shard-rkl:          [SKIP][408] ([i915#12343] / [i915#14544]) -> [SKIP][409] ([i915#12343])
   [408]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_pm_backlight@brightness-with-dpms.html
   [409]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_pm_backlight@brightness-with-dpms.html

  * igt@kms_pm_lpsp@kms-lpsp:
    - shard-rkl:          [SKIP][410] ([i915#9340]) -> [SKIP][411] ([i915#3828])
   [410]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_pm_lpsp@kms-lpsp.html
   [411]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-2/igt@kms_pm_lpsp@kms-lpsp.html

  * igt@kms_pm_lpsp@screens-disabled:
    - shard-rkl:          [SKIP][412] ([i915#8430]) -> [SKIP][413] ([i915#14544] / [i915#8430])
   [412]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_pm_lpsp@screens-disabled.html
   [413]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_pm_lpsp@screens-disabled.html

  * igt@kms_pm_rpm@modeset-lpsp-stress:
    - shard-rkl:          [SKIP][414] ([i915#15073]) -> [SKIP][415] ([i915#14544] / [i915#15073])
   [414]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_pm_rpm@modeset-lpsp-stress.html
   [415]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_pm_rpm@modeset-lpsp-stress.html

  * igt@kms_pm_rpm@modeset-lpsp-stress-no-wait:
    - shard-rkl:          [SKIP][416] ([i915#14544] / [i915#15073]) -> [SKIP][417] ([i915#15073])
   [416]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_pm_rpm@modeset-lpsp-stress-no-wait.html
   [417]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_pm_rpm@modeset-lpsp-stress-no-wait.html

  * igt@kms_psr2_sf@fbc-pr-overlay-plane-update-continuous-sf:
    - shard-rkl:          [SKIP][418] ([i915#11520] / [i915#14544]) -> [SKIP][419] ([i915#11520]) +3 other tests skip
   [418]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_psr2_sf@fbc-pr-overlay-plane-update-continuous-sf.html
   [419]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_psr2_sf@fbc-pr-overlay-plane-update-continuous-sf.html

  * igt@kms_psr2_sf@pr-cursor-plane-move-continuous-sf:
    - shard-rkl:          [SKIP][420] ([i915#11520]) -> [SKIP][421] ([i915#11520] / [i915#14544]) +2 other tests skip
   [420]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_psr2_sf@pr-cursor-plane-move-continuous-sf.html
   [421]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_psr2_sf@pr-cursor-plane-move-continuous-sf.html

  * igt@kms_psr2_su@page_flip-p010:
    - shard-rkl:          [SKIP][422] ([i915#9683]) -> [SKIP][423] ([i915#14544] / [i915#9683])
   [422]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@kms_psr2_su@page_flip-p010.html
   [423]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_psr2_su@page_flip-p010.html

  * igt@kms_psr2_su@page_flip-xrgb8888:
    - shard-rkl:          [SKIP][424] ([i915#14544] / [i915#9683]) -> [SKIP][425] ([i915#9683])
   [424]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_psr2_su@page_flip-xrgb8888.html
   [425]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_psr2_su@page_flip-xrgb8888.html

  * igt@kms_psr@pr-primary-blt:
    - shard-rkl:          [SKIP][426] ([i915#1072] / [i915#14544] / [i915#9732]) -> [SKIP][427] ([i915#1072] / [i915#9732]) +9 other tests skip
   [426]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@kms_psr@pr-primary-blt.html
   [427]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_psr@pr-primary-blt.html

  * igt@kms_psr@psr2-primary-mmap-gtt:
    - shard-rkl:          [SKIP][428] ([i915#1072] / [i915#9732]) -> [SKIP][429] ([i915#1072] / [i915#14544] / [i915#9732]) +10 other tests skip
   [428]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-7/igt@kms_psr@psr2-primary-mmap-gtt.html
   [429]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_psr@psr2-primary-mmap-gtt.html

  * igt@kms_rotation_crc@multiplane-rotation-cropping-bottom:
    - shard-glk:          [INCOMPLETE][430] ([i915#15500]) -> [DMESG-FAIL][431] ([i915#118])
   [430]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-glk1/igt@kms_rotation_crc@multiplane-rotation-cropping-bottom.html
   [431]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-glk6/igt@kms_rotation_crc@multiplane-rotation-cropping-bottom.html

  * igt@kms_scaling_modes@scaling-mode-none:
    - shard-dg1:          [SKIP][432] ([i915#3555] / [i915#4423]) -> [SKIP][433] ([i915#3555])
   [432]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-dg1-16/igt@kms_scaling_modes@scaling-mode-none.html
   [433]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg1-13/igt@kms_scaling_modes@scaling-mode-none.html

  * igt@perf_pmu@rc6-all-gts:
    - shard-rkl:          [SKIP][434] ([i915#14544] / [i915#8516]) -> [SKIP][435] ([i915#8516])
   [434]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@perf_pmu@rc6-all-gts.html
   [435]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@perf_pmu@rc6-all-gts.html

  * igt@prime_vgem@basic-fence-read:
    - shard-rkl:          [SKIP][436] ([i915#3291] / [i915#3708]) -> [SKIP][437] ([i915#14544] / [i915#3291] / [i915#3708])
   [436]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@prime_vgem@basic-fence-read.html
   [437]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@prime_vgem@basic-fence-read.html

  * igt@sriov_basic@bind-unbind-vf:
    - shard-rkl:          [SKIP][438] ([i915#14544] / [i915#9917]) -> [SKIP][439] ([i915#9917])
   [438]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-6/igt@sriov_basic@bind-unbind-vf.html
   [439]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-4/igt@sriov_basic@bind-unbind-vf.html

  * igt@sriov_basic@enable-vfs-bind-unbind-each:
    - shard-rkl:          [SKIP][440] ([i915#9917]) -> [SKIP][441] ([i915#14544] / [i915#9917])
   [440]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17919/shard-rkl-3/igt@sriov_basic@enable-vfs-bind-unbind-each.html
   [441]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@sriov_basic@enable-vfs-bind-unbind-each.html
  ...
  [i915#15644]: https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/15644
...
ref=3D"https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-dg=
2-1/igt@kms_pm_dc@dc9-dpms.html">FAIL</a> (<a href=3D"https://gitlab.freede=
sktop.org/drm/i915/kernel/-/issues/15644">i915#15644</a>)</li>
</ul>
</li>
<li>
...
<ul>
<li>shard-rkl:          <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip=
/CI_DRM_17919/shard-rkl-3/igt@kms_cursor_legacy@cursora-vs-flipb-varying-si=
ze.html">SKIP</a> -&gt; <a href=3D"https://intel-gfx-ci.01.org/tree/drm-tip=
/Patchwork_152804v7/shard-rkl-6/igt@kms_cursor_legacy@cursora-vs-flipb-vary=
ing-size.html">SKIP</a> (<a href=3D"https://gitlab.freedesktop.org/drm/i915=
/kernel/-/issues/14544">i915#14544</a>) +8 other tests skip</li>
</ul>
</li>
<li>
...
tel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-3/igt@kms_flip_=
...
intel-gfx-ci.01.org/tree/drm-tip/Patchwork_152804v7/shard-rkl-6/igt@kms_fli=

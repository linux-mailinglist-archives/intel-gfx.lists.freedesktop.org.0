...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B66974083D1
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Sep 2021 07:31:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C40D589CD3;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v2 1/6] drm/displayid: re-align data block
 macros

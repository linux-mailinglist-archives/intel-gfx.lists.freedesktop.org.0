...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B4F1C8969CE
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Apr 2024 11:00:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25C571128F0;
	Wed,  3 Apr 2024 09:00:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="mspnsNFi";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 28CB91128ED
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Apr 2024 09:00:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1712134840; x=1743670840;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=cHrxO1GFaFegbeqYIUHlPrWg/1seEF9cr9e4sZRGK2c=;
 b=mspnsNFiXmzEcURoZVjpcNDZRQBC/bsBzdBHcNutffsgogYy/JYeJl7D
 LV1i+l1LcMygwgPoxZ/ATaimUMSe30TQDnzxPeMFJNx6B8amkBlHkBV2h
 KLEuBeQG9M5JdgZrdYdZ1CSHCrf0OUtWB8aVC4X28hxLDNXx7n5uEC3x9
 1QA3qP025gZJ/46j085ZPX3AuVwzLmpA2DSHxPlrw2aaJQg/b3OrB4Ufc
 k23NQa97nn9PXiK2cKn93i7KPiWaGU/kSp4MYlbEvmHpz9N/kR8khWdcu
 VhPlNu7x0dNAt/PLBMNoQwYlS97P7D5jfgS7JThAqeJ0RfIO2cwc/RIgy A==;
X-CSE-ConnectionGUID: 3jTT+cGvTYKy0cE9qz93qg==
X-CSE-MsgGUID: Ek5F2iQmSeGMGS5rmO7HpQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11032"; a="7472447"
X-IronPort-AV: E=Sophos;i="6.07,177,1708416000"; 
   d="scan'208";a="7472447"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2024 02:00:37 -0700
X-CSE-ConnectionGUID: K4iufVOmQfOlAF+WTc5lXg==
X-CSE-MsgGUID: g0bvdR7oQMG0eC80Z9sX1A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,177,1708416000"; d="scan'208";a="18453112"
Received: from esavax-mobl.ger.corp.intel.com (HELO jhogande-mobl1.intel.com)
 ([10.249.35.175])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2024 02:00:36 -0700
From: =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Animesh Manna <animesh.manna@intel.com>,
 =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>
Subject: [PATCH v5 08/19] drm/i915/psr: Unify panel replay enable/disable sink
Date: Wed,  3 Apr 2024 12:00:02 +0300
Message-Id: <20240403090013.54296-9-jouni.hogander@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5012188A501
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Mar 2024 15:45:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B71CF10E940;
	Mon, 25 Mar 2024 14:45:54 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UwHZfHiN";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DCD6810E940
 for <intel-gfx@lists.freedesktop.org>; Mon, 25 Mar 2024 14:45:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1711377954; x=1742913954;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=v807PzcljVF+OEwgWTj+x3UsMaWnVNn1P2qZfLPrCns=;
 b=UwHZfHiNCbfMaMHkdtpZYlxFz3o6Hbn0Vm2HhS56E76k3KQYaKz3zZ9j
 K6xY62Sh1/MAr20ApHULK7bcfJEOYpHkOI0+rH1uc5+5CFE7n2S087tLI
 9qol/Gny/UwcpfEgUpHMiEEdeuhg6rIhpcZAYcK5vp9/jSWoZthPfDOeS
 WkJknqpH2fT3UKzmTsGDm3mURy52bS/9TDWvZ8t2hqFqZz6emFujZNOVA
 h7q8udxuPo6JzMroiPnEZLSAnlLGVnndmilzcvIeaG9HXx07Vgwo0WZKz
 6o+iBXVCBr29CU/Qihb/SGearm5WB+K6YGP4gZ8fq/SdNzR8GmtmddUlJ g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11023"; a="17777925"
X-IronPort-AV: E=Sophos;i="6.07,153,1708416000"; d="scan'208";a="17777925"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2024 07:45:53 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,11023"; a="827784705"
X-IronPort-AV: E=Sophos;i="6.07,153,1708416000"; d="scan'208";a="827784705"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga001.jf.intel.com with SMTP; 25 Mar 2024 07:45:50 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Mon, 25 Mar 2024 16:45:49 +0200
Date: Mon, 25 Mar 2024 16:45:49 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
Cc: intel-gfx@lists.freedesktop.org, jani.saarinen@intel.com
Subject: Re: [PATCH 1/4] drm/i915: Update mbus in intel_dbuf_mbus_update and
 do it properly
Message-ID: <ZgGOHR8gOPUQNdMS@intel.com>

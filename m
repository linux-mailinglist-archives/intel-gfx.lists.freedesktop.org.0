...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62C87650FED
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:08:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C69C410E2B5;
	Mon, 19 Dec 2022 16:06:31 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 13/18] fbdev/offb: Do not use struct
 fb_info.apertures

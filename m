...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE5A944DD7D
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Nov 2021 23:02:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 65E1D6E932;
	Thu, 11 Nov 2021 22:02:21 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v10 01/10] dyndbg: add
 DEFINE_DYNAMIC_DEBUG_BITGRPS macro and callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7CA1C40D363
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Sep 2021 08:46:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 540DE6EAB0;
...
Subject: Re: [Intel-gfx] [PATCH v3 03/12] drm/ttm: remove

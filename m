...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 52A3343C1C0
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Oct 2021 06:38:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 373B36E873;
	Wed, 27 Oct 2021 04:37:39 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v9 06/10] drm_print: add choice to use dynamic
 debug in drm-debug

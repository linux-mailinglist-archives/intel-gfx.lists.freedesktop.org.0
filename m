...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC2124BA436
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 16:23:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03C6D10ED04;
	Thu, 17 Feb 2022 15:23:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2C2F910ECED
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Feb 2022 15:23:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645111410; x=1676647410;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Xv/qKxMjwKeAKY1B7wfp6re8UKuyTMN8JOBBLXGFX0Q=;
 b=huP7/ovWVIQNMSIgBZxX+gJNtGnLK/n4iqSM6dRaOtvI7VaRk/Re3KB8
 B+RLLBaHNPSqd8Kv4rvk9D2FKjphWgx5+Lw98C0Y4UtxoxJuqyBldRI5a
 F6q5FZ0tkpB+xP0kit0sfzQ/SBQKYseG8UkQFeSreeNZ0jSJXR5sfA+ZY
 OhgpuNcIJaheR1PaQ0k+MICYywl4mSNNyl1CI1hxdeTBMg+VYhM+L6A59
 j5AtFtvsABCBJc6FErcdzUJvdf+vwaafbQO/4sRkORe4tcnOy7jZdrWQM
 olCaFgbhB6lpcknxqm3Q4eM/3ENh4e4GbIp4+GvqR2LpMs5aU7QA7N0my g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10260"; a="238300045"
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="238300045"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 07:23:29 -0800
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="545658981"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 07:23:26 -0800
...
Date: Thu, 17 Feb 2022 17:22:44 +0200
Message-Id: <20220217152248.1016134-2-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 1/5] drm/i915/gsc: add gsc as a mei auxiliary
 device

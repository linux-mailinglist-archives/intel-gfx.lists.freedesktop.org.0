...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D6FAA5BF747
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Sep 2022 09:12:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDA2810E886;
	Wed, 21 Sep 2022 07:12:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B2D6610E85C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=kvxYryI0UiEan+kZ0IyDwgQE3Fk96gsYviB46imoZ0c=;
 b=QzKGe88WmVQdzeV7RVhzSpsmzeeSEqhiZXzUZ54FjNMYLKbJSC9cSg3y
 DPBh+0S4+RLUW6UtyBGh6Yjlauq6JBjT6i+dIwqNQmt9P5LwNUptmg0Ox
 eGWzsuDUrPzczxGyeN5amiYxVKqAporOpubf/8bzicXLtKWLfiy5CMKvP
 i+kDNvciDIQyF7w1sVdATiND2yLTuYxOQ87Ud8VmqeKc+OayxPId4yUZ9
 x6Tk2iPLpvOxLqNs2I3cIu4rAIb7zRMphQ6fQWDRWHgr+vt/7eq/J/W8y
 YnkuwRnyG/vc3RF03/aBmZq3EY2dvWhnWqitF0DaPHv7jzZuUZx2sNv5k g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10476"; a="386208194"
X-IronPort-AV: E=Sophos;i="5.93,332,1654585200"; d="scan'208";a="386208194"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Sep 2022 00:10:12 -0700
X-IronPort-AV: E=Sophos;i="5.93,332,1654585200"; d="scan'208";a="948022851"
...
Date: Wed, 21 Sep 2022 00:09:44 -0700
Message-Id: <20220921070945.27764-14-niranjana.vishwanathapura@intel.com>
...
Subject: [Intel-gfx] [RFC v4 13/14] drm/i915/vm_bind: Skip vma_lookup for
 persistent vmas

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F391836C142
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Apr 2021 10:54:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EC296E1D5;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 2/7] drm/i915: Update the helper to set
 correct mapping

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FCBA2FCDC7
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jan 2021 11:18:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7EE8A6E153;
	Wed, 20 Jan 2021 10:18:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6BBB66E156
 for <intel-gfx@lists.freedesktop.org>; Wed, 20 Jan 2021 10:18:51 +0000 (UTC)
IronPort-SDR: 01nkDmTeaF34UleHWraBHqvffE6uj2PMwanUExEUdF0+KU2Nh2Fq9y7Pqur7qabr1nYojmB3E1
 msZAaob4PBlw==
X-IronPort-AV: E=McAfee;i="6000,8403,9869"; a="158854944"
X-IronPort-AV: E=Sophos;i="5.79,360,1602572400"; d="scan'208";a="158854944"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2021 02:18:50 -0800
IronPort-SDR: XFaH2Vz0sMnamjMjXKqSFTOX0qz/jPC8tGVRiscUG5i4BNIfFOf7Mhvb3B5LjIrfppVzxWEoJ2
 BbHlNMYgK7iQ==
X-IronPort-AV: E=Sophos;i="5.79,360,1602572400"; d="scan'208";a="426845922"
Received: from oreunova-mobl1.ccr.corp.intel.com (HELO localhost)
 ([10.252.45.61])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jan 2021 02:18:48 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 20 Jan 2021 12:18:33 +0200
Message-Id: <20210120101834.19813-3-jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20210120101834.19813-1-jani.nikula@intel.com>
References: <20210120101834.19813-1-jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/4] drm/i915/dp: abstract struct intel_dp pps
 members to a sub-struct

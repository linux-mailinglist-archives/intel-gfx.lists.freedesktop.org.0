...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83E72644DE8
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Dec 2022 22:24:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CBEF210E155;
	Tue,  6 Dec 2022 21:24:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1366510E00F;
 Tue,  6 Dec 2022 21:24:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670361856; x=1701897856;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=6jpmLo8eItnmQ/bvMlHS+RJuORXBe8s7YaCYc0ijddo=;
 b=dX/LyKpVdmMmW6qQ8XNlen/88sVakl9119kKeuF9oBwZMEvJ1ed8J902
 jaLdKsNdbu3R0FWopqWhFA0zoDtWnxxEC31n9BS6TliM2ZC6+FCNlMIcC
 Y/wg+5v6R7EegAcpKbwmGDhkJjknjy2AAHETPUDTYdFBDwj41qRO3/WKY
 3I4BtxFn+5aJopAI009qYWHt7xbOJRA4c5YbZ3oQG80SLdIQ4HecltZsa
 D+VxMrd4sSrt6H4uKxmQL97lwRb0CqdGpERpcdMIJEEZNZvLFMRH1qKLC
 tCdaLYPX9MObA1EIWugixRHrPU+/2gAUXzu+flN+W1JRWmgLrveY9YLhG A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10553"; a="316752939"
X-IronPort-AV: E=Sophos;i="5.96,223,1665471600"; d="scan'208";a="316752939"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Dec 2022 13:24:14 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10553"; a="752803228"
X-IronPort-AV: E=Sophos;i="5.96,223,1665471600"; d="scan'208";a="752803228"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga002.fm.intel.com with ESMTP; 06 Dec 2022 13:24:14 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Dec 2022 13:27:05 -0800
Message-Id: <20221206212705.344422-1-alan.previn.teres.alexis@intel.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v9 1/1] drm/i915/pxp: Promote pxp subsystem to
 top-level of i915

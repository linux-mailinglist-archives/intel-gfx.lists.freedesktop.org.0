...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C9D867B44E
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 15:25:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 154EE10E7D7;
	Wed, 25 Jan 2023 14:25:07 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 3/4] drm/amdgpu: Movie the amdgpu_gtt_mgr

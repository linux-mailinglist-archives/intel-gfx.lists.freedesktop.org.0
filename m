...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5822E6FB5F8
	for <lists+intel-gfx@lfdr.de>; Mon,  8 May 2023 19:34:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2AD5C10E297;
	Mon,  8 May 2023 17:33:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C8AB910E012;
 Mon,  8 May 2023 17:33:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683567234; x=1715103234;
 h=date:from:to:cc:subject:message-id:references:
 content-transfer-encoding:in-reply-to:mime-version;
 bh=hmutMTSHc5dQrsbY2EueYbN2X1SBELoyKbjewNuGvm4=;
 b=IF2q0FY6wC1QZD9LTbkjRF/uiPrbNz/AluDsF6/N5sOf/T9j6JzgMXTI
 qg3yUhiZFVXJBP2p3ASvD47lGBr7nmEyv+y5DQsvB7gmnH3C/gMLt+Na/
 FMc5TUGzOFhR7SSmUEEaRoiKrEuYyNfL6qeltWyQ7F+k4sR+ksqM1QzLl
 32MTaast8v80v0xG5JiI/mpLiJTxNK/LVasCiAamCzi3kKMatIzogT1dU
 7uBl4aDMf742zg9pg/wn2vzgAp/1obr4tfUI3G+QhBeJ7+yHLcjRCzuvv
 tz1TdtL6dEvWilEyYd7XPqRG1S7Yf/l6EW3+3a1aZlx7TpqP8jvcimxJU A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="348538390"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="348538390"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 10:33:53 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="701500820"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="701500820"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
 by fmsmga007.fm.intel.com with ESMTP; 08 May 2023 10:33:53 -0700
Received: from fmsmsx602.amr.corp.intel.com (10.18.126.82) by
 fmsmsx601.amr.corp.intel.com (10.18.126.81) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.23; Mon, 8 May 2023 10:33:53 -0700
Received: from FMSEDG603.ED.cps.intel.com (10.1.192.133) by
 fmsmsx602.amr.corp.intel.com (10.18.126.82) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.23 via Frontend Transport; Mon, 8 May 2023 10:33:53 -0700
Received: from NAM10-DM6-obe.outbound.protection.outlook.com (104.47.58.106)
 by edgegateway.intel.com (192.55.55.68) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.23; Mon, 8 May 2023 10:33:52 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=oDUurTnuuuScFIW3qPj9xntFgd6btKyKCkPnHe3Nqpg=;
 b=
...
Received: from DS7PR11MB7859.namprd11.prod.outlook.com (2603:10b6:8:da::22) by
 MW3PR11MB4521.namprd11.prod.outlook.com (2603:10b6:303:55::13) with
 Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.6363.32; Mon, 8 May 2023 17:33:49 +0000
Received: from DS7PR11MB7859.namprd11.prod.outlook.com
 ([fe80::9f98:8f3c:a608:8396]) by DS7PR11MB7859.namprd11.prod.outlook.com
 ([fe80::9f98:8f3c:a608:8396%7]) with mapi id 15.20.6363.032; Mon, 8 May 2023
 17:33:49 +0000
Date: Mon, 8 May 2023 10:33:44 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: "Yang, Fei" <fei.yang@intel.com>
Message-ID: <20230508173344.GO6250@mdroper-desk1.amr.corp.intel.com>
...
In-Reply-To: <BYAPR11MB2567E1EA374BFD566B4FADB59A719@BYAPR11MB2567.namprd11.prod.outlook.com>
X-ClientProxiedBy: SJ0PR03CA0170.namprd03.prod.outlook.com
 (2603:10b6:a03:338::25) To DS7PR11MB7859.namprd11.prod.outlook.com
 (2603:10b6:8:da::22)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: DS7PR11MB7859:EE_|MW3PR11MB4521:EE_
X-MS-Office365-Filtering-Correlation-Id: 8bafd48a-272c-4cfc-bc65-08db4fea6182
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DS7PR11MB7859.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230028)(346002)(136003)(39860400002)(376002)(396003)(366004)(451199021)(33656002)(66476007)(54906003)(6636002)(4326008)(66946007)(66556008)(316002)(6486002)(86362001)(478600001)(6862004)(5660300002)(8676002)(2906002)(8936002)(30864003)(41300700001)(186003)(38100700002)(82960400001)(6512007)(26005)(6506007)(1076003)(83380400001)(6666004)(66899021)(579004)(559001);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?cFJzd0F3QjlLWTVVOTBmUDVVdThkZkdQQXFZSW91ZlRlR1JUUjRxdVFZRFpC?=
 =?utf-8?B?WlNubXQ4akZsMHlTQW1ZOWczNUtudmNxZ0lEQ0hpMWtwaEU1U3lQb0FYY0ZV?=
 =?utf-8?B?d3dFT0s0ZVFXQ3hEYnBWQThlTzJFZnFuMm8xcjBRMko3NmFJajRzRWhZcWh4?=
 =?utf-8?B?bkh5Ky8xZXZZUW5iL1BrazJJSGlBWjlEaStHQ00rOWNoaVcvUVl4YjY1YjZI?=
 =?utf-8?B?UjMydmtmcGJyS1lRMW5WYnVvK3dERS9HTllrTVl6bzBORFhmMDdiK1czRGhz?=
 =?utf-8?B?anB4Y1lxR2xsY3NYSHlua3ZqaFFOZHJSSUo1RWtWU3BZNTdlT2kzVll1RWlp?=
 =?utf-8?B?Zzk2TUVSMW9GamJ4YzVTaVNKSS93ZU81N3lSUGZaTS83QXdYMStGdkVZcnJw?=
 =?utf-8?B?Ulk1ekVyaHEzVkJGWDhnOXYrNlpIWnp1T1Nua0MwQzV6S0RidGwyaEgya2hP?=
 =?utf-8?B?L21qSkhIL1gwWGxUZDlEUGNUTUVHbW9sM2lRT1pHa0lRYnFCdlc0WldSZ2pj?=
 =?utf-8?B?WU1JelhiN2c0SlhyRlNhMzJWNEFsOE5BZzBkTllvcWJ3QlVzWW5pQ0VoMzFj?=
 =?utf-8?B?V0lTOGtlNmZKNGRVYlRvQ010S3JUM2czTzJacCtWZDROaC9ZcGwrWTFXaXpP?=
 =?utf-8?B?c0F5Z3JRaEVXcmUvU2wxWFpzWnR2Zzk3YXYwSnNsSDZ0eU9lVnRUaU5HdHdz?=
 =?utf-8?B?R0lBZU9nNGk1dWFQeTdjYVhOWHJ5Ky9MYUpDb3dNUDk0TTJsNi9OU1F1dCtC?=
 =?utf-8?B?S3owMTBaWHZubVpWNHR2MFQ5YlNaYmhBN0J2VVllWE9rVWxLZStaVGtQaFJl?=
 =?utf-8?B?WVZUdGlQRmZOWU5XbG5sQjFDT0ovc3UwTUthV0IwaDBXOHFEWXo4emI0cWlD?=
 =?utf-8?B?ZkoyV0xSQ29sSFlXMU4vM2hOQzZXdWx4cFExWXo5NHhMMjdBdHJreTkwZ1pP?=
 =?utf-8?B?aStpaXRSR0p2SlFmckJxcE9wdHdMSWJkTWRwUVorZUYxUzdpRFoyWHZXTGx2?=
 =?utf-8?B?bkJvOGdxT2lzaUJ2T045RlZOYzYyZHZxSmM3cHdDczlJMjY1djBkd29JUXZF?=
 =?utf-8?B?cmxrdzNSemtnWkRNTm9KUitSWWllSmYvdk4rQmdkRWtNckF0emdRMjRMUHNI?=
 =?utf-8?B?Z3dLdkhpZmpFY0xDY1R0eE5wd0lHb3ZqL1pZODIvMXp3WUFUeHFycy9LYmVh?=
 =?utf-8?B?YWRwN0pJcmJOMlNmUmhISUJ2TzZqbVNhZjQzL2ZoOTQwZWFLUUNXRUU0Mi9h?=
 =?utf-8?B?OWxHRXV4d054cis1OHk0dmEyM2ZGK05yZXdUeWVOejBRei9OTWVNemsvaVlq?=
 =?utf-8?B?YWw3RnVwUzNsTUNkaWU2bjBjaHg4VVlUM3NSYU1qR2NuL0NraG1vSThYNVFt?=
 =?utf-8?B?T0dvT0prSGtLYkNxN1Zvc3NRZFBpd3d1d282azQ4WVBrcTQvZW00TGRrKytT?=
 =?utf-8?B?M1VtWEF2VGVrNW9aMDlyd1BvaEFLdU1ySmRlNzJZNC9XUlpTRlVrb04rY3F3?=
 =?utf-8?B?YzkwbHVEK2Q2Zm03VXp6Qlp2RzN4TzBrQlA5M21NeTlpUjFhTjloQy9ReFpi?=
 =?utf-8?B?bVREQW5EdXpVTyt5b0Vlcm9oQXNkTm00VHhwWkxpay9QTFZIenZ6U2ZWOTAv?=
 =?utf-8?B?Wmw2SG9NTy9YcEtaK296cmFhVmFmRlVJdmpKaHlkYW53QVlQbGZsT3hyUGIv?=
 =?utf-8?B?THdjdlZrSkhRRnJWUE5SUUtIL0t4MzNMeG9JTTZ0YzgzaVpmbzkxb0NEaWFx?=
 =?utf-8?B?SlZydG85eDFoS1JxS2ZkWFdvZGpkU2hlYndaK3ZyZUpIV2RibEtHNjZWYi9C?=
 =?utf-8?B?SUlMSXJyWEl2UlBZMHM5d0kvY0ZnMkNnWjl5UWVZaTIrUENtWVJWS2lDSENr?=
 =?utf-8?B?MVZ3KzFuTHNjWlZCMy9IQldKZXgvdG1LRTgzS1FNdDU2Vnh3ZDhxbTNqZXEv?=
 =?utf-8?B?YmxXaXA5UnhwQlIrWFNWbjhkR28wQVhXOW1BdnZibFQxcWthUVR2OUJIY0kr?=
 =?utf-8?B?K1U2MEFvRGxCUU5CNTI1OUdNWTI3dnJpcmtKL1FZOHRqWG5IM0QvZ0MwMDFM?=
 =?utf-8?B?VWZZRFE3V0xzWDRjR1Z5OGxUWjVQT3E5ZDZnN2lQSUFTNWtpT2JMSUxucnpU?=
 =?utf-8?B?UVBmSk5CekxrU3Z6T0g2aEl4eTNLWEU3dEJXRXNrOVQxWmNIT0hLSG5PbHQy?=
 =?utf-8?B?b2c9PQ==?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 8bafd48a-272c-4cfc-bc65-08db4fea6182
X-MS-Exchange-CrossTenant-AuthSource: DS7PR11MB7859.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 May 2023 17:33:48.4054 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: hZ7ZovEtH9NCIOph1d3n31oVwV7R7gfu/gm7yyw7koUXuJw02ANi99bgqa+gmBZPKTAON01Pc/I9pW4bQfZU9DmLRUYMwi/ud93me6cDzzE=
X-MS-Exchange-Transport-CrossTenantHeadersStamped: MW3PR11MB4521
X-OriginatorOrg: intel.com
Subject: Re: [Intel-gfx] [PATCH v5 2/3] drm/i915: use pat_index instead of
 cache_level
...
>    > On Wed, May 03, 2023 at 03:50:59PM -0700, fei.yang@intel.com wrote:
...
>    >>  {
>    >>    u32 pte_flags;
>    >> @@ -98,7 +98,7 @@ static void dpt_bind_vma(struct i915_address_space
>    *vm,
>    >>    if (vma_res->bi.lmem)
>    >>          pte_flags |= PTE_LM;
>    >>  
...
>    >> @@ -306,20 +304,22 @@ int i915_gem_get_caching_ioctl(struct drm_device
>    *dev, void *data,
>    >>          goto out;
>    >>    }
>    >>  
...
>    >>    rcu_read_unlock();
>    >>    return err;
>    >> @@ -364,6 +364,15 @@ int i915_gem_set_caching_ioctl(struct drm_device
>    *dev, void *data,
>    >>    if (!obj)
>    >>          return -ENOENT;
>    >>  
...
>    >> +++ b/drivers/gpu/drm/i915/gem/i915_gem_mman.c
>    >> @@ -383,7 +383,8 @@ static vm_fault_t vm_fault_gtt(struct vm_fault
>    *vmf)
>    >>    }
>    >>  
...
>    >> +++ b/drivers/gpu/drm/i915/gem/i915_gem_object.c
>    >> @@ -54,6 +54,24 @@ unsigned int i915_gem_get_pat_index(struct
...
>    >> @@ -133,7 +151,7 @@ void i915_gem_object_set_cache_coherency(struct
>    drm_i915_gem_object *obj,
>    >>  {
...
>    >> @@ -148,6 +166,37 @@ void i915_gem_object_set_cache_coherency(struct
>    drm_i915_gem_object *obj,
>    >>          !IS_DGFX(i915);
>    >>  }
>    >>  
...
>    >> +++ b/drivers/gpu/drm/i915/gem/i915_gem_object.h
>    >> @@ -34,6 +34,8 @@ static inline bool i915_gem_object_size_2big(u64
>    size)
>    >>  
...
>    >> +                       unsigned int pat_index);
>    >>  bool i915_gem_object_can_bypass_llc(struct drm_i915_gem_object *obj);
>    >>  void i915_gem_object_flush_if_display(struct drm_i915_gem_object
>    *obj);
>    >>  void i915_gem_object_flush_if_display_locked(struct
>    drm_i915_gem_object *obj);
>    >> diff --git a/drivers/gpu/drm/i915/gem/i915_gem_object_types.h
>    b/drivers/gpu/drm/i915/gem/i915_gem_object_types.h
>    >> index 41b35abccf88..e19151f6e279 100644
>    >> --- a/drivers/gpu/drm/i915/gem/i915_gem_object_types.h
>    >> +++ b/drivers/gpu/drm/i915/gem/i915_gem_object_types.h
>    >> @@ -358,12 +358,29 @@ struct drm_i915_gem_object {
...
>    >> +   * pat_index is set by user space. By design, user space is capable
>    of
>    >> +   * managing caching behavior by setting pat_index, in which case
>    this
...
>    >> index cb5863f37f9d..763df437c20c 100644
...
>    >> @@ -612,10 +605,10 @@ xehpsdv_ppgtt_insert_huge(struct
>    i915_address_space *vm,
...
>    >>    u64 start = vma_res->start;
>    >>  
>    >> @@ -735,7 +728,7 @@ static void gen8_ppgtt_insert_huge(struct
>    i915_address_space *vm,
>    >>  
...
>    >> @@ -743,9 +736,9 @@ static void gen8_ppgtt_insert(struct
>    i915_address_space *vm,
>    >>  
...
>    >>  
>    >> @@ -754,7 +747,7 @@ static void gen8_ppgtt_insert(struct
>    i915_address_space *vm,
...
>    >>  
>    >>          vma_res->page_sizes_gtt = I915_GTT_PAGE_SIZE;
>    >> @@ -764,7 +757,7 @@ static void gen8_ppgtt_insert(struct
>    i915_address_space *vm,
...
>    >> @@ -778,14 +771,14 @@ static void gen8_ppgtt_insert_entry(struct
>    i915_address_space *vm,
...
>    flags);
>    >> +  vaddr[gen8_pd_index(idx, 0) / 16] = vm->pte_encode(addr, pat_index,
>    flags);
>    >>  }
>    >>  
...
>    >> @@ -856,7 +849,9 @@ static int gen8_init_scratch(struct
>    i915_address_space *vm)
>    >>  
>    >>    vm->scratch[0]->encode =
>    >>          vm->pte_encode(px_dma(vm->scratch[0]),
...
>    >>    for (i = 1; i <= vm->top; i++) {
>    >>          struct drm_i915_gem_object *obj;
>    >> @@ -874,7 +869,9 @@ static int gen8_init_scratch(struct
>    i915_address_space *vm)
>    >>          }
>    >>  
...
>    >>  
>    >>    return 0;
>    >> @@ -436,10 +424,10 @@ static int bxt_vtd_ggtt_insert_page__cb(void
>    *_arg)
...
>    >>    return 0;
>    >>  }
>    >> @@ -1022,6 +1013,11 @@ static int gen8_gmch_probe(struct i915_ggtt
>    *ggtt)
...
>    >> index 1910683f03b4..3b86f66f64d3 100644
...
>    >>  
>    >> @@ -579,7 +577,7 @@ void ppgtt_init(struct i915_ppgtt *ppgtt, struct
>    intel_gt *gt,
>    >>  void intel_ggtt_bind_vma(struct i915_address_space *vm,
>    >>                 struct i915_vm_pt_stash *stash,
>    >>                 struct i915_vma_resource *vma_res,
...
>    >>          }
>    >>  
>    >> @@ -773,7 +778,7 @@ intel_context_migrate_copy(struct intel_context
>    *ce,
...
>    >>          if (!len) {
>    >>                err = -EINVAL;
>    >> @@ -784,7 +789,7 @@ intel_context_migrate_copy(struct intel_context
>    *ce,
>    >>                goto out_rq;
>    >>          }
>    >>  
...
>    >>          if (err < 0)
>    >>                goto out_rq;
>    >> @@ -811,7 +816,7 @@ intel_context_migrate_copy(struct intel_context
>    *ce,
>    >>                      goto out_rq;
>    >>  
...
>    >>                goto out_rq;
>    >>  
>    >> -        len = emit_pte(rq, &it, cache_level, is_lmem, offset,
>    CHUNK_SZ);
...
>    >>                    size_t sz)
>    >>  {
>    >> @@ -858,7 +858,7 @@ static int __perf_clear_blt(struct intel_context
>    *ce,
>    >>  
>    >>          t0 = ktime_get();
>    >>  
...
>    >>                   size_t sz)
>    >>  {
>    >> @@ -937,9 +938,9 @@ static int __perf_copy_blt(struct intel_context
>    *ce,
>    >>          t0 = ktime_get();
>    >>  
...
>    >> index 6b71b9febd74..4888038c044f 100644
>    >> --- a/drivers/gpu/drm/i915/gt/uc/intel_uc_fw.c
>    >> +++ b/drivers/gpu/drm/i915/gt/uc/intel_uc_fw.c
>    >> @@ -894,9 +894,15 @@ static void uc_fw_bind_ggtt(struct intel_uc_fw
>    *uc_fw)
>    >>          pte_flags |= PTE_LM;
>    >>  
...
>    >> index 41389a32e998..deabd69c78cc 100644
>    >> --- a/drivers/gpu/drm/i915/i915_debugfs.c
>    >> +++ b/drivers/gpu/drm/i915/i915_debugfs.c
>    >> @@ -139,21 +139,53 @@ static const char *stringify_vma_type(const
>    struct i915_vma *vma)
>    >>    return "ppgtt";
>    >>  }
>    >>  
...
>    >> -  default: return "";
>    >> +static const char *i915_cache_level_str(struct drm_i915_gem_object
>    *obj)
>    >> +{
...
>    >>    int pin_count = 0;
>    >>  
>    >> @@ -165,7 +197,7 @@ i915_debugfs_describe_obj(struct seq_file *m,
>    struct drm_i915_gem_object *obj)
>    >>             obj->base.size / 1024,
>    >>             obj->read_domains,
>    >>             obj->write_domain,
...
>    >> +++ b/drivers/gpu/drm/i915/i915_gem.c
>    >> @@ -420,8 +420,12 @@ i915_gem_gtt_pread(struct drm_i915_gem_object
>    *obj,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5059570BDA2
	for <lists+intel-gfx@lfdr.de>; Mon, 22 May 2023 14:22:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3221110E325;
...
Subject: [Intel-gfx] [PATCH v3 01/12] fbdev: Add Kconfig options to select

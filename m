...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4F464E73BE
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Mar 2022 13:50:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D2C710E561;
...
Subject: Re: [Intel-gfx] [PATCH 2/9] drm/edid: pass a timing pointer to

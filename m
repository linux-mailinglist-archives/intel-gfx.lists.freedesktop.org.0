...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E63B582679
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Jul 2022 14:30:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDCB8C5CBC;
...
Subject: [Intel-gfx] [PATCH v3 2/6] drm/i915/gt: document

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1CBC26C44E
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Sep 2020 17:35:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0829B6EA47;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 6/8] drm/i915: WA for platforms with double
 buffered address update enable bit

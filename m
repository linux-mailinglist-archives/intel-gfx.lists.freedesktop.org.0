...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8242271507
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Jul 2019 11:26:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF97489755;
	Tue, 23 Jul 2019 09:26:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8392889733
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Jul 2019 09:26:03 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17528440-1500050 
 for multiple; Tue, 23 Jul 2019 10:25:51 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 Jul 2019 10:25:49 +0100
Message-Id: <20190723092550.2443-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/4] drm/i915: Remove lrc default desc from GEM
 context
...
L2k5MTUvZ3QvaW50ZWxfbHJjLmMKaW5kZXggNjMyMzQ0YzE2M2E4Li41ZmRhYzQwMDE1Y2YgMTAw

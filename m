...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0321887839D
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Mar 2024 16:30:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D4AF10F0B1;
	Mon, 11 Mar 2024 15:30:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="i46uR965";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D754010F0B1;
 Mon, 11 Mar 2024 15:30:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710171011; x=1741707011;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=ZtU1tE0Qax5xfk9vhty9fK6mXKanPIdsERg3NoEGG0M=;
 b=i46uR965UJzE1McbQvkYVafmALXvnerH/O3K4KWBWWiO6bst2omcToq3
 TckZXaY8A1GctyVNjLYMKxlCwpBjqI74vnUJPd7K2uB8+G0RI3ppcoTPk
 ifAqQ8QVZt4qXPp6TXYfqM7QeCc5AGajHgyiUvH+UAlEd3mqCLLadywTz
 LHZpLZyB5o9OmU1Njufp3pjRwpqbvD0d1rSSfZ3L+d7y0nvVrPuy1z4ul
 XPzq4Tm2ERdfvWKU7MP+s/Id0Ony1DZOyqAspoMaglPtGWXbzjyS1W73F
 XxHuGDrmWMvtZg/tlaeq/DQmv3YXySwBnylV366Ojt2luzry+UBkR0+3U w==;
X-IronPort-AV: E=McAfee;i="6600,9927,11010"; a="30277883"
X-IronPort-AV: E=Sophos;i="6.07,117,1708416000"; d="scan'208";a="30277883"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2024 08:29:40 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,117,1708416000"; d="scan'208";a="42182772"
...
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 ...
 15.1.2507.35; Mon, 11 Mar 2024 08:29:38 -0700
Received: from FMSEDG603.ED.cps.intel.com (10.1.192.133) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.35 via Frontend Transport; Mon, 11 Mar 2024 08:29:38 -0700
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (104.47.66.40) by
 edgegateway.intel.com (192.55.55.68) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.35; Mon, 11 Mar 2024 08:29:38 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=aE4xoNMrTA+P9MvuAaiUcnLO/HMdInZHp5n4v63++vY=;
 b=
...
In-Reply-To: <20240306193643.1897026-5-lucas.demarchi@intel.com>
X-ClientProxiedBy: BY3PR04CA0023.namprd04.prod.outlook.com
 (2603:10b6:a03:217::28) To MN0PR11MB6059.namprd11.prod.outlook.com
 (2603:10b6:208:377::9)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: MN0PR11MB6059:EE_|BL1PR11MB5254:EE_
X-MS-Office365-Filtering-Correlation-Id: 5c2627b4-79f4-498f-2ed6-08dc41e00edd
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:MN0PR11MB6059.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230031)(376005)(1800799015); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?yM1IjwuXtJB4egVcUWtYuvdj/QPA1DHChvm3U2jJ3L5LGpnQAWHWXV3Tyiz+?=
 =?us-ascii?Q?7VmPcGxGcsQobA5zrPXKRbh/KDdwrje7UqDlJ6B9fLriFDqSLA5mVkbUYlAq?=
 =?us-ascii?Q?pHVZunRUKDMhHOzZGAsMxoFSaDALXdmOVR1M/bWiS5+uAE4jZgZP6y9aAoWi?=
 =?us-ascii?Q?16WuNnGEo85DuVx7uIDhDlBb1vScp8Aq60WHIfuT1kTarsvaxNzjpkvmrxxq?=
 =?us-ascii?Q?+3aGz6gOKJiI9mnsh3YOchtpXr2SYQ/yW+Bs8yMbohfk4CXaE07w71+wts9P?=
 =?us-ascii?Q?xv+YjhDun9cTftCGrsGWGcG9aE9FU4cpJ/ci25pgI3F1eUCS6JTXCUKm+bn6?=
 =?us-ascii?Q?bLJiS9We/C0H9tBQ8LT2tU92RB0AFLDeWHfTP3xhMLZFVCMqyAut7txJbB8j?=
 =?us-ascii?Q?YEQGXIg3uU/pFR3T2sfZv7PxcRJrjgoY4lR7ncBEM680/VjT6WbQ7kkYh7tU?=
 =?us-ascii?Q?6u65LW56cz16r8pbE6l5MOwCnC/06dWRwbWVJ4B2+M6gvrIvHfP4ycLZ1/wA?=
 =?us-ascii?Q?D7GtuBooVqGvCQOVP6C6mR3syx0A+dpYghQDa9yYGi0dkY09oaQVoAtJkawO?=
 =?us-ascii?Q?9FZS2gUcZ7OkSNsqGA51ZbxCi3fVgh6yXvqcguki5oq2hRHeOprqR9GTo3x+?=
 =?us-ascii?Q?vU2kcA5BrhVffj2GGRX7PD04XtFpWYk8odDjVQpKHI9Ek2+5at2MfRQM8GJA?=
 =?us-ascii?Q?onfK2Zn5Al2LUVe4vbAQY7YPnk0py2VKkHmv1iLT1QTakUpr9+vGagM13HMk?=
 =?us-ascii?Q?kDQhu6r/rxMzg5cR8/Az0tQwMpJpULBFyqtN4cQCBBaZhOaGVb6eaBEYEsXu?=
 =?us-ascii?Q?wm7S2+xMzU6XMYsLitTpCFKrBXTRj8PnS1o6r8vC/Zb3nnWxVuShqIRZaHCM?=
 =?us-ascii?Q?z2HOEdEqMx0/U6bR2GxTghjmM7p2c4+TdmmLWp3jUepB8GvBJn4zy7IXUMv2?=
 =?us-ascii?Q?d0wGvUYReqTMKjVeaUY2wtea/r9q2kdVtpDgLBLlgkHwFy11YghmgRCxLX5M?=
 =?us-ascii?Q?N7KRe4c1QmcejLpYiiudi80Evct6K9RZ7HNrfURcVEbA2w5zc9UbrGmnyfzA?=
 =?us-ascii?Q?HFsfzyuMqlDqRtrgMEy6e/u4rdh65okfUqb6sbFs32e8+E8HBQPAG1ny23LM?=
 =?us-ascii?Q?wfNiripBP8HmSD/xJ4nvWlwop5ZlyAeHYqlRd1C+AZzIHxTxrwJ1LLbYg0rj?=
 =?us-ascii?Q?9rCeFtLJeQZTQM50KNwZMxqimmrubDKdRr3R6jaJhP47+0RyF8tnAQqGgc+9?=
 =?us-ascii?Q?nThFPIcxJP12rDsXUnKHJoXsOrG2K+Eve6CYKY43TwIcL4BnRLWYE/MECaEk?=
 =?us-ascii?Q?Q625Vy5rnv2M7RIgbyU3bKr/JNm8X+O9yYvEb933+mDjA8VMO+NibQYXumel?=
 =?us-ascii?Q?t4Yp/fWWwIo+ZYVlqOQ29SYK908BI7hf9jIHA+oLHSFQJS/T9kqpuJQOU4mo?=
 =?us-ascii?Q?MhXbT91CVgVK4f2/+vMF3otvtH4+5yo6MWi6lOBNeNr1DrdCRE5WJEn4oFbJ?=
 =?us-ascii?Q?T5Tybny/X1lTJZGBlJ3EwtUxfhnbGLhaLFCV1MG/YhKlSwXJoQd4xCyPgewX?=
 =?us-ascii?Q?WSc/sfDfsRxr/LsccUhIYeAx+olUVv6ot5pl1BG2?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 5c2627b4-79f4-498f-2ed6-08dc41e00edd
X-MS-Exchange-CrossTenant-AuthSource: MN0PR11MB6059.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Mar 2024 15:29:36.1681 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: oAE2RQyOQHTr9Yo7IkD663/aHVzY5lgbXJYj6GdYuZq2qZ3zyLuJVlG6r+HshBlHP2OC/iQiMyFiwwbmzdn1XQ==

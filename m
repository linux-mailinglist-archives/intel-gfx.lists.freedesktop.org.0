...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28736C97298
	for <lists+intel-gfx@lfdr.de>; Mon, 01 Dec 2025 13:00:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 72CA310E3B2;
	Mon,  1 Dec 2025 12:00:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="d1kiA8Vp";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pl1-f169.google.com (mail-pl1-f169.google.com
 [209.85.214.169])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 435D610E3B2
 for <intel-gfx@lists.freedesktop.org>; Mon,  1 Dec 2025 12:00:34 +0000 (UTC)
Received: by mail-pl1-f169.google.com with SMTP id
 d9443c01a7336-2984dfae0acso64802745ad.0
 for <intel-gfx@lists.freedesktop.org>; Mon, 01 Dec 2025 04:00:34 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1764590433; x=1765195233; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=kCGGS5rEiJjEW6dpZc9ZXXggtQlpbJyb0OYrg3VhTMk=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1764590433; x=1765195233;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=kCGGS5rEiJjEW6dpZc9ZXXggtQlpbJyb0OYrg3VhTMk=;
 b=
X-Gm-Message-State: AOJu0Yz0+pOADWQdB64YTFWuveGgeWfC283vPLkerLtDzvxfK/NpPJf2
 YPeGDnZHjvTICGW4wpI0HVUsFmZNL4Xhzc4ZfbTOIwgxIRE9wGDeI5TieVi4rCv5
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IEcxTCBAIOM4N5LsHZH/VCFRYxTOELnlEYOkfUQojzBZmqffq1VS4JeWNscwtCTaxweDGqSGA==
X-Received: by 2002:a17:903:acf:b0:295:7806:1d7b with SMTP id
 d9443c01a7336-29bab19c771mr294033415ad.45.1764590433041; 
 Mon, 01 Dec 2025 04:00:33 -0800 (PST)
Received: from localhost ([134.134.137.78]) by smtp.gmail.com with ESMTPSA id
 d2e1a72fcca58-7d150c5e612sm7646748b3a.6.2025.12.01.04.00.31
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 01 Dec 2025 04:00:32 -0800 (PST)
From: Juha-Pekka Heikkila <juhapekka.heikkila@gmail.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Juha-Pekka Heikkila <juhapekka.heikkila@gmail.com>
Subject: [PATCH 1/2] drm/i915: switch to use kernel standard error injection
Date: Mon,  1 Dec 2025 14:00:03 +0200
Message-ID: <20251201120004.690290-2-juhapekka.heikkila@gmail.com>

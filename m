...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E90C445313D
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Nov 2021 12:49:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 213DE6EA2F;
...
Subject: [Intel-gfx] [PATCH] drm/i915/guc: fix NULL vs IS_ERR() checking

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC966BDDE3
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Sep 2019 14:14:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D5996E82A;
	Wed, 25 Sep 2019 12:14:07 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH V2 0/8] mdev based hardware virtio
 offloading support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D137577BAA
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:41:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF31AA9DCA;
...
Subject: [Intel-gfx] [PATCH v3 37/39] nouveau-dbg: add 2 verbose-classmaps
 for CLI, SUBDEV

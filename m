...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EAD234F3B0A
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 17:08:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0068A10E937;
	Tue,  5 Apr 2022 15:08:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 82F7710E920;
 Tue,  5 Apr 2022 15:08:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1649171285; x=1680707285;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=C7KSgyXS7+TQoLV43yMZNJqRIUfI/4INR6EpCGaMKo4=;
 b=a0oihz3PV9GF7z47Yx7gXZvhSOU2+ALXcnI4FXSDQixVtk7bnTJ4RLEO
 cH2/PnTyYzuJqIAQVg3WF0RKj0R0fVxjGpwwsW2huD+LhEGvdxniiNN/r
 j8UtGT24vdRm04eyxVLBlejE9MHAql0QHlqElsz0hdPfO+FNiQVVa+Kwa
 3R8l/naWKjcUBPiS+M+poCIl8fWrRZpSCTYYqdrO6c5HHlyf1Sn+6Xngu
 1n0yIgWZYKw/QnOYcRibS5UR2hgWVJvJO8oxqA6lmO5av0Y8PzDP0VUGW
 Bjj9s1Hl7ZIG0WZiu3FH1Ul2mIpVol6MemgXoPOC25jNTPcAuhrHSKys5 Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10307"; a="240706498"
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="240706498"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Apr 2022 08:08:05 -0700
X-IronPort-AV: E=Sophos;i="5.90,236,1643702400"; d="scan'208";a="641644372"
...
Date: Tue,  5 Apr 2022 20:38:38 +0530
Message-Id: <20220405150840.29351-8-ramalingam.c@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 7/9] drm/i915/selftest_migrate: Check CCS
 meta data clear

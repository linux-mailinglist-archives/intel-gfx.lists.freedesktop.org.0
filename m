...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EDC1C4B8CFD
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Feb 2022 16:56:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDD4210EA1F;
	Wed, 16 Feb 2022 15:56:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F2F7E10EA1F
 for <intel-gfx@lists.freedesktop.org>; Wed, 16 Feb 2022 15:56:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645027001; x=1676563001;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GJR/aZaYRlqTaIE4TYXqAG0dtB82ILYTPUeyULVgCMA=;
 b=XCajBtpv9Z6rjms5+E1k391XFY+7VeBUr9gObklJgB4kxBV5LvQo+T+j
 Aqa1TWWMCxj2c/fO/7jpQAIwhS8IqJVMYNYVD3rd+JyG3PjYRsdtojrTj
 xW63y7uIXwNAetxJwhDQ0PyJve/QfEz5paERVgMNbytMOEHfH9+/nVL75
 /qjEGXbcIt3miR2yr27ebgp9OkiCB8yt2G6Z+guykwWckeHYW6NfueOaa
 3S6KQHFpEyC4AEONBwGgoYLkuQv399709DjFQ1f3LyH3QLDQiqYbEYTDW
 QKcc5yQ220Bi2KlgrvcKnSh82jWyJM2DEmYO98q5awc9G/DzK2FHejnc7 A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10260"; a="313918073"
X-IronPort-AV: E=Sophos;i="5.88,374,1635231600"; d="scan'208";a="313918073"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Feb 2022 07:47:30 -0800
X-IronPort-AV: E=Sophos;i="5.88,374,1635231600"; d="scan'208";a="571334351"
Received: from rbilei-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.13.113])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Feb 2022 07:47:27 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 16 Feb 2022 17:47:10 +0200
Message-Id: <20220216154711.3329667-3-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 3/4] drm/i915/reg: split out vlv_dsi_regs.h and
 vlv_dsi_pll_regs.h

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7875C677882
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Jan 2023 11:06:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5584910E358;
	Mon, 23 Jan 2023 10:06:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out1.suse.de (smtp-out1.suse.de [IPv6:2001:67c:2178:6::1c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2F92010E338;
 Mon, 23 Jan 2023 10:06:06 +0000 (UTC)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
 (No client certificate requested)
 by smtp-out1.suse.de (Postfix) with ESMTPS id E355234210;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 ...
 bh=O/xtJivrfLTY54rz6F/LCUIR8SHSDSSrKAoLo5uPV4g=;
 b=BebsJxR9ibAHXGgqkKr1mThg8UQRPdsZZec4uYa9P8oqFZrB6CzXXUoflLe4K0gHbG2JCt
 wj1HgKx+cFzoAUMkHiGldPFeO0CgQ079cuI74il8pjrEXburRmCfx5rhbXUXr89rwkkfrK
 5SO532eLMeDRMrc4qHEdKRCnDRgO0kM=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 ...
 in-reply-to:in-reply-to:references:references;
 bh=O/xtJivrfLTY54rz6F/LCUIR8SHSDSSrKAoLo5uPV4g=;
 b=TGz+xtAz6rmHRsa3Q2GprzZGZGFdwFXTz6oSFq0HGdOZAHoxx4pHsCfTJkwHbD72Q/A9sN
 YoJ2mZehQlQs4iBQ==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
 (No client certificate requested)
 by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id 8C355134F5;
 Mon, 23 Jan 2023 10:06:04 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
 by imap2.suse-dmz.suse.de with ESMTPSA id AGRNIQxczmO+DwAAMHmgww
 (envelope-from <tzimmermann@suse.de>); Mon, 23 Jan 2023 10:06:04 +0000
From: Thomas Zimmermann <tzimmermann@suse.de>
To: airlied@gmail.com, daniel@ffwll.ch, maarten.lankhorst@linux.intel.com,
 mripard@kernel.org, javierm@redhat.com
Date: Mon, 23 Jan 2023 11:05:55 +0100
Message-Id: <20230123100559.12351-7-tzimmermann@suse.de>
X-Mailer: git-send-email 2.39.0
In-Reply-To: <20230123100559.12351-1-tzimmermann@suse.de>
References: <20230123100559.12351-1-tzimmermann@suse.de>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 06/10] drm/fb-helper: Initialize fb-helper's
...
index 123f2ef035c5..9331c36bdab6 100644

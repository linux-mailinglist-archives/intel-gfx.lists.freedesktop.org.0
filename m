...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F2F6A1C636F
	for <lists+intel-gfx@lfdr.de>; Tue,  5 May 2020 23:52:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E9C7D6E43F;
	Tue,  5 May 2020 21:52:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2897C6E440
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 May 2020 21:52:27 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21124371-1500050 
 for multiple; Tue, 05 May 2020 22:52:20 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  5 May 2020 22:52:09 +0100
Message-Id: <20200505215214.9690-9-chris@chris-wilson.co.uk>
...
@@ -3500,6 +3500,9 @@ static int gen8_emit_init_breadcrumb(struct i915_request *rq)
 {
 	u32 *cs;
...
@@ -1101,6 +1102,137 @@ i915_request_await_external(struct i915_request *rq, struct dma_fence *fence)
 					     I915_FENCE_GFP);
 }
...
+
 ...
 {
@@ -1147,6 +1279,8 @@ i915_request_await_dma_fence(struct i915_request *rq, struct dma_fence *fence)
...
+			ret = i915_request_await_proxy(rq, fence);
 		...
 		if (ret < 0)
@@ -1472,6 +1606,7 @@ void __i915_request_queue(struct i915_request *rq,
 	 */
...
index 5f4c1e49e974..07c3353cfaf6 100644

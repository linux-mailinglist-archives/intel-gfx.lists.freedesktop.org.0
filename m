...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BFD484D5B74
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Mar 2022 07:15:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C4DB10E22D;
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915/sseu: Don't overallocate subslice
 storage

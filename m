...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 95E1175C300
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jul 2023 11:25:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECEBC10E63D;
	Fri, 21 Jul 2023 09:25:14 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [v7,
 2/9] drm/i915: Add the has_aux_ccs device property

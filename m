...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7827BC5F9A
	for <lists+intel-gfx@lfdr.de>; Wed, 08 Oct 2025 18:13:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EC5E10E856;
	Wed,  8 Oct 2025 16:13:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="N0Z0zxBV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 18BEE10E858;
 Wed,  8 Oct 2025 16:13:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1759940004; x=1791476004;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=u2iKc86otZ3+N04xatHaflOUM867c8MLPKJbsGPE9mw=;
 b=N0Z0zxBVo9eNt/ZZXRs6IA0HCzMcwboT0jrDeOpEBZY6klSttKBIZcQM
 GI852ypfKpRVC4bEORgecnbKx3F3E3/7oAZ2tCkOBvwCRcbFSvsRgZ6gO
 /kHfcgfmIu0AlUPraqViymApCqgxPGlD30uCL9pPcla1NgLyki3A4QaPZ
 SXVopXDautmYJXIiCbG+j68ltqeUTVOnwseMbEjWUtZqNPkk21p6H0rzP
 un8bzdQMxvp7dgXS74hQPFoj++XEIiUtdgP8B60kc39vv8qXFMxxaIpXZ
 o4U/Dne0oB3A43swVbnGe7an1k4CStElqQt4isVPJGIA9mXM+vU4VMvPu Q==;
X-CSE-ConnectionGUID: lU9ehFOxQgmN6ku4kSGFEQ==
X-CSE-MsgGUID: oRm7aqxQTaGYOm/KoKXdKA==
X-IronPort-AV: E=McAfee;i="6800,10657,11576"; a="79784437"
X-IronPort-AV: E=Sophos;i="6.19,213,1754982000"; d="scan'208";a="79784437"
Received: from orviesa007.jf.intel.com ([10.64.159.147])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Oct 2025 09:13:24 -0700
X-CSE-ConnectionGUID: D+dy+8kaRc2KhV64pFTrgA==
X-CSE-MsgGUID: GA+u0s5BQsaPA6YYqdO4Bg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,213,1754982000"; d="scan'208";a="180294870"
Received: from jkrzyszt-mobl2.ger.corp.intel.com (HELO
 jkrzyszt-mobl2.intranet) ([10.245.244.124])
 by orviesa007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Oct 2025 09:13:21 -0700
...
Subject: [PATCH 1/3] drm/i915: Avoid lock inversion when pinning to GGTT
Date: Wed,  8 Oct 2025 18:12:26 +0200
Message-ID: <20251008161258.3568573-6-janusz.krzysztofik@linux.intel.com>

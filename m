...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 807D564A548
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Dec 2022 17:52:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C49B10E0FE;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/hwconfig: Modify mismatched
 function name

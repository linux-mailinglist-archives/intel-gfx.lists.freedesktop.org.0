...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9975B21FF30
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9E1C6E9C8;
...
Subject: [Intel-gfx] [PATCH v2 41/59] drm/kmb: Changes for LCD to Mipi

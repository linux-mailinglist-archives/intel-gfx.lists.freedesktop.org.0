...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63B2D7C8CBB
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Oct 2023 20:03:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC3DC10E62B;
	Fri, 13 Oct 2023 18:03:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CC76B10E629
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=k/ziTSyi4fuIzab0k8bBNTAdhzHzXFSW3bdT0AXdU+s=;
 b=RE9HdJ7/t+wFV4KREB+Vhd7i4IYZ1Wpd0vU5RjnwuyWePEPT1yh3gJ36
 ZfCpqfNpDcE0se+Ei0itfFfETU1d+xE/UskKX9d2gnA9BU2BaRBMtDQYe
 NGwlwWaoWcidIqg0fhSDdYRI0yfK7V41o9imsi6x5vz9+CzK9uvPEawcT
 TyMcUYYlJhndb7t0FGo+lm9meGJmgI8kXJR6dpJuVYLyhA5NEUmMF0CED
 U1NTtqIhNrUDy+OMLDwav0uLJfUuuE8CnQqr6ltBoesIor5AvlEQr2zcS
 epCyUbVfioc473dwoM/TH4zwbZvOJCcRnf19BCjCxBX4FoqwTGm06XEp/ A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10862"; a="388083597"
X-IronPort-AV: E=Sophos;i="6.03,222,1694761200"; d="scan'208";a="388083597"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Oct 2023 11:03:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10862"; a="898649297"
X-IronPort-AV: E=Sophos;i="6.03,222,1694761200"; d="scan'208";a="898649297"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Oct 2023 11:01:19 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 13 Oct 2023 10:52:14 -0700
Message-Id: <20231013175218.2664309-4-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v14 3/7] drm/i915: Define and use GuC and CTB

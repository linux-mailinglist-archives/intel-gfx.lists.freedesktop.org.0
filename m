...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21FDFC5C900
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Nov 2025 11:27:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 959D510EA2F;
	Fri, 14 Nov 2025 10:27:10 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RzvGjmkz";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 22E0410EA28;
 Fri, 14 Nov 2025 10:27:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1763116029; x=1794652029;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WuNBiviTLjKocbR5jTrdb1JUTCNY+EGC7AybBCzUhbc=;
 b=RzvGjmkzyLjDEipN9/7DFrisgmAvUwjtFjjiT0F17MxhonHTewrMraqr
 RA+UI7kvtzzpsRkEY8f+MzGjn8crJ6lpVe7yD7fqb/evJygiMd8KTUazA
 HzsAl/hFDpLqQl9NK4f0dIx1+Z6266YYrhXSwsrvYxAExQIiBAKfS5xbS
 w8l3Qpbe2uK+AfDHkWBqtDg7VTYvIiV7vsuQDjnsV8zrxMgPvQzOWZcHR
 jcr/26X/ROqDIJz8F+d7ZKXwPfEKMlpxeae4y+Ik+B+50WNQvYH0Eg0Hj
 OV2W0t7GCDnElBwxW1Zd5hSF98OUKx5QpNeJrXMyjltqoqs40suXN74m9 A==;
X-CSE-ConnectionGUID: 24fpkwu4QJ6l09CQa/OSPw==
X-CSE-MsgGUID: 7L0O5RtpT9uaMSYUAyPTgA==
X-IronPort-AV: E=McAfee;i="6800,10657,11612"; a="87855751"
X-IronPort-AV: E=Sophos;i="6.19,304,1754982000"; d="scan'208";a="87855751"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2025 02:27:09 -0800
X-CSE-ConnectionGUID: LPoAXrlNTYKcqbwC1CO8OQ==
X-CSE-MsgGUID: K4N3IwtVQ/efEOm85rrsuQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,304,1754982000"; d="scan'208";a="189041683"
Received: from ettammin-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.245.246.202])
 by orviesa010-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Nov 2025 02:27:07 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	ville.syrjala@linux.intel.com
Subject: [PATCH 03/10] drm/{i915,
 xe}/display: move irq calls to parent interface
Date: Fri, 14 Nov 2025 12:26:42 +0200
Message-ID: <3878d539ec42835d1e61af7faaa1655cfeeaa18e.1763115899.git.jani.nikula@intel.com>

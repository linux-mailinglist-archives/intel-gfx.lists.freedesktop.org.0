...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDF093AA17C
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Jun 2021 18:37:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D5C098980C;
	Wed, 16 Jun 2021 16:37:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 01D678980C
 for <intel-gfx@lists.freedesktop.org>; Wed, 16 Jun 2021 16:37:10 +0000 (UTC)
IronPort-SDR: 1896DxwwWC/TGD/Kq/Wgh6XA+X4YXH1XoEYJYjVJJsRNTMQ2i6WRJ95YvtKdY9YTL4PhN3DNNM
 DNuBibzi88LA==
X-IronPort-AV: E=McAfee;i="6200,9189,10016"; a="206171406"
X-IronPort-AV: E=Sophos;i="5.83,278,1616482800"; d="scan'208";a="206171406"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2021 09:37:10 -0700
IronPort-SDR: lV2I/qTu8q4FCkeWEE7q2WUtxwLKaCK7oZAhMJ1xxyJvt1D7djkLqr+UOVznxM6vPjTeZJw797
 1eG+mkXpRjZw==
X-IronPort-AV: E=Sophos;i="5.83,278,1616482800"; d="scan'208";a="404353785"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2021 09:37:09 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 16 Jun 2021 09:36:49 -0700
Message-Id: <20210616163649.1727383-1-matthew.d.roper@intel.com>
X-Mailer: git-send-email 2.25.4
In-Reply-To: <20210616004213.1705079-3-matthew.d.roper@intel.com>
References: <20210616004213.1705079-3-matthew.d.roper@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915: Add GT support for multiple
...
index 2161bf01ef8b..80badc54b19d 100644

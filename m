...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D9C6D1102A9
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 17:40:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E2BFD6EA0D;
	Tue,  3 Dec 2019 16:40:17 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 12/12] auxdisplay: constify fb ops

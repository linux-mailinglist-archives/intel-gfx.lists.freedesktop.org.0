...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A91E2C6458
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:08:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B729C6EC20;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 016/162] drm/i915: Move HAS_STRUCT_PAGE to
 obj->flags

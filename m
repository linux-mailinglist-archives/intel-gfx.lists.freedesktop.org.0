...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 15AE77E21C8
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Nov 2023 13:35:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D52CC10E2F3;
	Mon,  6 Nov 2023 12:35:29 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7CB4010E06F;
 Mon,  6 Nov 2023 12:35:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699274126; x=1730810126;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=4oKF2/huwj7rparE2hVSJSQAxxhS8pAsEp+Eh1dtMxM=;
 b=AV4CyMpnYzEmempEIfYDNDtTXxQrH1/XnIoPXafDfxd984dA4wl0qM1Z
 LEn+b08k4RwQJwDNI49V+0radESYGUskD8iO+5wnQqkih1lWlwefU5aII
 8EW82RhLE1IA6UYrFRHwLZea8F2xCdZsTKiiOx25tBT70CmdYrFJ/oyKa
 FVId0qzxjW53v/6+VRjz3FDSO2+MCLz9HueLCdSYJ7zxdNMma52YLulNw
 QJY7eK9pHn4RWfopFCbdao48jl0VTtQDipnlWQ2hXkz8M/CZYEFm6PkJ4
 50t4w24H75ca31Rs62rricLI3XjNYsIphI2noXgiRh/eFgbB9CyQldzgg w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="393159544"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="393159544"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 04:35:26 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="712188459"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="712188459"
Received: from ajayshan-mobl.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.213.234.152])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 04:35:25 -0800
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: igt-dev@lists.freedesktop.org,
	Intel-gfx@lists.freedesktop.org
Date: Mon,  6 Nov 2023 12:35:11 +0000
Message-Id: <20231106123518.588528-2-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [CI 2/9] tests/i915/drm_fdinfo: Stress test context
 close versus fdinfo reads

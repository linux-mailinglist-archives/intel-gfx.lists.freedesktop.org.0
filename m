...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FD5027562E
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:23:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 264EF6E94D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 21/22] drm/xlnx: Initialize DRM driver

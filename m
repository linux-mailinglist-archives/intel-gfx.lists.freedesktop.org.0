...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCD9D42CFA1
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Oct 2021 02:48:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5EFF66EC0A;
...
Subject: Re: [Intel-gfx] [PATCH 19/25] drm/i915/guc: Implement no mid batch

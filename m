...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D83A05EEB8A
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 04:17:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 404B410E9B0;
...
Subject: [Intel-gfx] [PATCH v4 1/4] drm/i915/guc: Limit scheduling

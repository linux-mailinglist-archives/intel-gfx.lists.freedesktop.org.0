...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F4BA17383
	for <lists+intel-gfx@lfdr.de>; Wed,  8 May 2019 10:18:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9371389728;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 4/6] drm/i915/dp: Add a support of YCBCR
 4:2:0 to DP MSA

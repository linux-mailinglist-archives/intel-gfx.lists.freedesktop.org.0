...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 868179AE640
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Oct 2024 15:28:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3039910E93F;
	Thu, 24 Oct 2024 13:28:09 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="nafKAz1a";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EE7C310E93D;
 Thu, 24 Oct 2024 13:28:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729776488; x=1761312488;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=tixw/wT3vaVKA7tcJwOA/hbkoJZ6eD0MHEhqVyIbjLM=;
 b=nafKAz1aWdMuVULnKdRQPyz3zjNgkLnvr0uWGSvaOvkmw3fCl/TfSSuw
 RUewvNAYg1v84t5VMJO89f18J0vRRSrWQjPtxebiCJRK+Ku0vDM93mN44
 iaEiL/W3yGS91wBNgQhZ3D2bpxoY7ACb5akIIaH+EGSpV4si88vnJMyBH
 lQLrtO9vv04Xki/bShDb6wqcqOWel53+gvqsxpwepz7SGx7V0Jufjjg2X
 QqZQTmKDmcTb72SP86ddrz7iNMHQHCU6Pb2yOcUlpYQg1yUqht6rSQ0YT
 iDzdMPJkcJoQyBE6AnJ1so+pCOXcXEmMeva+NUkjtXz5qJ+zVoA9VQ1+5 w==;
X-CSE-ConnectionGUID: 442zzF0jT3K3zFfgX354rA==
X-CSE-MsgGUID: CaV8ZOSaTKiOxQlnhC8AMA==
X-IronPort-AV: E=McAfee;i="6700,10204,11235"; a="29305926"
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="29305926"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 06:28:07 -0700
X-CSE-ConnectionGUID: jGgQRLUzQbWtwXOX3xjd4w==
X-CSE-MsgGUID: RPvE0secRKaNEEHB1QGXmw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,229,1725346800"; d="scan'208";a="85196086"
Received: from unknown (HELO localhost) ([10.237.66.160])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Oct 2024 06:28:05 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: rodrigo.vivi@intel.com,
	jani.nikula@intel.com
Subject: [PATCH v2 04/12] drm/i915/dpio: convert to struct intel_display
Date: Thu, 24 Oct 2024 16:27:34 +0300
Message-Id: <6324b3113cf6d4dd454bb4e1b2c7fa2d422ab176.1729776384.git.jani.nikula@intel.com>

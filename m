...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A97AFBDFC4
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Sep 2019 16:14:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9E0C891F8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/3] drm/dp/mst: Handle arbitrary DP_LINK_BW
 values

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46FA57187F9
	for <lists+intel-gfx@lfdr.de>; Wed, 31 May 2023 19:03:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A44910E1D7;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/guc: Remove some obsolete
 definitions

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BF82BC6137
	for <lists+intel-gfx@lfdr.de>; Wed, 08 Oct 2025 18:51:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3B7810E888;
	Wed,  8 Oct 2025 16:51:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AjvakfBx";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 20B7010E875
 for <intel-gfx@lists.freedesktop.org>; Wed,  8 Oct 2025 16:51:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1759942299; x=1791478299;
 h=date:from:to:subject:message-id:references:in-reply-to:
 mime-version; bh=m48V9ukPl7N0+DkA/lipKhzFTfDVZeblvdvOvV3vVZE=;
 b=AjvakfBxYAgyUsH+RQZnhVnDinWkf8yY8iubMNs6YMmaoxo+/y9OY2EU
 uUwo8G+NnxGeb5mIEaLb2e2duOptJ5gLgSqVOX5bn48gf3KhbS90xDCw9
 lkONySWeu1m4DqspGRIBGSipZpzgPjwS6eZEG8zkzU/MsMk034jkXMs0m
 YCA1DKi6hV4oQps8czwLOn/xXK1Wugl+K+cZcpWV2zmIQnx9knClmFWCl
 l/4dE7akcTp2BepioOtEUF/ZZpS0fwUGQ8nkCtSz3v3kjjq8b8sAdnzoa
 vzjqgxV/k6FtT7YdTQe+CfWVnNJ7v6f5Oj5ILd4IkdP5CE4ITRBO2W0ID A==;
X-CSE-ConnectionGUID: sSjZ7XwtQ7yz0Izf2Y8Ivw==
X-CSE-MsgGUID: zCylud4NSZSIp5PSwcuA5A==
X-IronPort-AV: E=McAfee;i="6800,10657,11531"; a="62060113"
X-IronPort-AV: E=Sophos;i="6.17,312,1747724400"; d="scan'208";a="62060113"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa113.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Oct 2025 09:51:39 -0700
X-CSE-ConnectionGUID: htcT5Eh9T8eVG0xFhhusEw==
X-CSE-MsgGUID: DEJTT3ruRtCzRo68vx/dLQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,213,1754982000"; d="scan'208";a="180083233"
Received: from fmsmsx903.amr.corp.intel.com ([10.18.126.92])
 by orviesa009.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Oct 2025 09:51:38 -0700
Received: from FMSMSX901.amr.corp.intel.com (10.18.126.90) by
 fmsmsx903.amr.corp.intel.com (10.18.126.92) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.27; Wed, 8 Oct 2025 09:51:37 -0700
Received: from fmsedg901.ED.cps.intel.com (10.1.192.143) by
 FMSMSX901.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.27 via Frontend Transport; Wed, 8 Oct 2025 09:51:37 -0700
Received: from CH1PR05CU001.outbound.protection.outlook.com (52.101.193.3) by
 edgegateway.intel.com (192.55.55.81) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.27; Wed, 8 Oct 2025 09:51:37 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=OMRJVUVvrqr1ni+6ANTUytXv0jixhpXyN9V02hp+FrE=;
 b=
...
Received: from SJ5PPF89507EDE4.namprd11.prod.outlook.com
 (2603:10b6:a0f:fc02::83e) by BY1PR11MB8032.namprd11.prod.outlook.com
...
Received: from SJ5PPF89507EDE4.namprd11.prod.outlook.com
 ...
 16:51:21 +0000
Date: Wed, 8 Oct 2025 09:51:18 -0700
...
Message-ID: <aOaWhmnrdgPzJPRG@msatwood-mobl>
References: <20251007212447.941389-1-matthew.s.atwood@intel.com>
 <175992022773.17350.1347449126500328685@6aec98b87f92>
Content-Type: text/plain; charset="utf-8"
Content-Disposition: inline
In-Reply-To: <175992022773.17350.1347449126500328685@6aec98b87f92>
X-ClientProxiedBy: MW4PR03CA0320.namprd03.prod.outlook.com
 (2603:10b6:303:dd::25) To SJ5PPF89507EDE4.namprd11.prod.outlook.com
 (2603:10b6:a0f:fc02::83e)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: SJ5PPF89507EDE4:EE_|BY1PR11MB8032:EE_
X-MS-Office365-Filtering-Correlation-Id: 56616d3c-4101-4d0d-57d0-08de068ae89c
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230040|376014|366016|1800799024;
X-Microsoft-Antispam-Message-Info: =?utf-8?B?K3BxdjB2Ny9GYkdUMitDVzY4cmJCd3gveldLZkdZazRtSUJoT3lKOTdWNGpU?=
 =?utf-8?B?djFNUjFqaFpkTVpLdGR6SElmUWZudU1zMExnNFFCZGg0bEM3b3BaTlBUcmQ4?=
 =?utf-8?B?OVhYeUxReTlMSUtPMk9aUnNkN3RQOGk0NWlIQStFVnN0TFdoZ2cvV0luNUt5?=
 =?utf-8?B?eXp2TFBGZzA0MWdsaEpVY01DSUpEdmZOd0w4KzR6UDZOUTlyQXBPaTRVY1N5?=
 =?utf-8?B?anJ0VlNBVEtkM211aGMvQjJYcnNBVFpWNVhDdlowYVJPRXZPMkJBMUxpYzNP?=
 =?utf-8?B?QVQ5SkZWdTgwWGdQKy9UZ0xXSzBjTkJVczRTaGlDdFl0dS9scHhKMnRGOCtL?=
 =?utf-8?B?K3VIaWFNUTdHWjFVdjh1bURyK0tLUVl3ekZQc1o0UnZuMnBER3RDenZLTDFm?=
 =?utf-8?B?cXZwUHVENzhxS2pGKzVaTG5pV2tnaWtDaXdETEJneUNBT2NQOGR4OUVVYUR4?=
 =?utf-8?B?TWREREpxTzFHMWUrL2h5YVpCUlhjNWJGekFYSTdabFp1aUYySy9MMWpiSlhQ?=
 =?utf-8?B?ZmlWei9BWVFROEVYd1BSK0FGVmdwMGxHR3hRYjR3a3NnMG1pdjNXaE9NZDJO?=
 =?utf-8?B?c0swbld3U25XM0hORzI3MEp0aEZHVnFmUUx2UmpvdU9sRzFqNFB2UlVOdCsw?=
 =?utf-8?B?M2ptOEtrOWFNN1JCZ0JqSFdpcFc0TGh5SDZITE04VzdpRjlDMlBwa3JJRlMy?=
 =?utf-8?B?aDBFT2NTUUhKSklFWTQ5ZW5lY3B1bFMvVU83ZXJPbjI4Qk83enpJS0pLdWNs?=
 =?utf-8?B?ZE1wbUtzY2FCWWZEOXhYOWFwOExpR2JHMFZRcXpySnFHYjlYWUFIRjk4MnIr?=
 =?utf-8?B?YmVwQ1B4d29OUU5PYkFRaDI2ZHFLQ2d2dDlsY3lVM3hZVjlkdWZhRHJvajRI?=
 =?utf-8?B?L3VBVU4yM1Q4RzB4aEpaeHJHdWZ5NzhYdTNSbWRqT2ErRWx2MWlaeDNkWUY4?=
 =?utf-8?B?d3YxZ0x6aUorQXZvM2NscGpZdVZRVUlGNGZsay9VNHVORTJHM0sxWmpxMkJt?=
 =?utf-8?B?LytRK2IvZnQzeGwvQWRNTUlpa3JpNmtmcFhVVWsrQWtnZTV2R2J1NFNtSkx5?=
 =?utf-8?B?MTlrUkdyalF6NlJpNFg1OWxFVm9USDJHaVJLNnNHcUpqdXFCT0tkdVJnOTZD?=
 =?utf-8?B?dnlwbjdVY1A5eFlwT2QvQU1lRWpCbWtnQW9Ibk5SNjNsdlVyaGpXRzI1dmNa?=
 =?utf-8?B?U0dyYXZiSUVBVnFicTNjR3doVGVodkoycVRrK25QbVNkcWo4RjhyOGlYZTRZ?=
 =?utf-8?B?bDZtaXAyREY2S3R2dm9IWGkza1hRNTN4dUV5UWw0bFRzUXVlU3ZXZDJWSEs1?=
 =?utf-8?B?WmpGblRZWDVPcGlGcitwam80Z1dSanZrMmJVUmtLWE1zOWhGMHhKL3RiRUFU?=
 =?utf-8?B?RkpyYWNjWHBtVXFJaGU3akxoTXJEZXJmeG5ubFJzOHU3Y3ZxZW1CTThvN1Q0?=
 =?utf-8?B?M0t1ay9yQmhJaVRkdUFaTEtsdytYdFFNWEhqY2Z0aXBEcmNTZGhVYjJpTmQ3?=
 =?utf-8?B?aTJYL3haQ3JpcDh0MkxsNDVIdy9nQmc2VXJsRXJDZXV3SEN5S2U2MTVhVU5u?=
 =?utf-8?B?N2dmc0RuRVRMRWt2ZEY0ZmFGNE1UaFVVSEZIQWlQZmZseXM3d1Y5M3pFdEFR?=
 =?utf-8?B?SWx2azN5Yk1DR1phQ2hHbjJ3MXh3S0p4VmdPY3Y5TTZwbFJUajB6N2VtejVD?=
 =?utf-8?B?Q1dHQkFHdVRJQXpmTFU3ZDd6d1o2bnVOMDRWSHJHejFBZ2NHUUVKTEtrRTVX?=
 =?utf-8?B?MDYxbnZyYmNoaFdGMlozTUVNMU9RREFMaW9Eb3Q4RGtZSkZETTlFVUMra1dv?=
 =?utf-8?B?R0VrV01UOWE5VFhSdVZXTHpveVY4R0JGMkNNSXI1QjNVZHhKN3RKZFBhQ3pl?=
 =?utf-8?B?aG53QUlQUktudVF3T1ZoOFVEREdSbFBtUG1KODBVWU1xblE9PQ==?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:SJ5PPF89507EDE4.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(376014)(366016)(1800799024); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?Vjh2VlpQVHJxMERhVnptbHhvZ0ZCZGVRVFlRd3JTaHFoakEzd2NxbXhDTHZw?=
 =?utf-8?B?cjVMdEZaa2FnMDEydTZaeGxUMzZUZUVEY1NhVE45TkpiaHJabC90OWFaVjlE?=
 =?utf-8?B?NE9HK1F0L1pmYTRBNEpPdTFZZ3hGM09xMHdvQ3NGTEcvaWUxelNsdGFGQ0dV?=
 =?utf-8?B?Q2w1L0dtQnVQaEhpVjVEQW5lZHZjd05OQUpKS3NmUG9WRmF1OWN5MFhKNDVS?=
 =?utf-8?B?VmtXRFRBMGpxSFdOdHpDRFNlK293Skp5MkNNNXVjN0ZDQXphZnFUSERpSVhK?=
 =?utf-8?B?YjRCdXpKVXk5dTBzQWxFWTVHMWhSZGVUcHowQ2FwQjFiZjdNb0gyWXkxU3Uv?=
 =?utf-8?B?V29NbU1qUlpxUUQ4R05BaEswa3M1blZTbi85dk9zY0pXVlNKUDlRazVscGhm?=
 =?utf-8?B?RzdPQ1VnQkhETllKS294V0RzUEhsc1JMNFIvVkpKM2o1NjBoR3Erd05GeUxr?=
 =?utf-8?B?UWk4UmNVU1RiZVZIRXYzTWNNL3dDZ2pVMmJvOTJlaGZ5R0hJSGJmamFsSzdY?=
 =?utf-8?B?OW12aEl0amc2akwwc3R0dHkxYW9kNjkyN1ExZllFeW5sY3JHZVY2MDVzdTZy?=
 =?utf-8?B?NGZZWWNONjVzVGxZWEFLTnJLaWFCK1cySE5vVmV2eFN6cTNnR2VWak01WWhs?=
 =?utf-8?B?R1NnNjh0YXJkN0VRMmcwSmxVM3h2T0NqcHRra0kwU3EwSEJqSm5nc0ZBTG14?=
 =?utf-8?B?K01CMmpuRE12NWhuY2ozbnhVcTBMc21oZ0pRS2REQmw3a3VUSmYydXk1M0ZZ?=
 =?utf-8?B?OUo5K01rMlAyUGtBUkFGdE1sUlRtRnJMRU5xa1M3V0cycC8xL3J3MjJ4d1BN?=
 =?utf-8?B?MDZrTlU2eXdNRkxNTlBybXNBajhUbE1Ta1Nmc2R4VjNDUW9IdmMzNHhhUnE5?=
 =?utf-8?B?RUF6blVFam82Y3IyT3I0dEgwWC9hVDc5RjRCSTA5SGhTVzdDUHg4dldLQlF2?=
 =?utf-8?B?NnVoZGN4czUzUDhndXZPSlFyQ1ZWUUowU1paVmNERjVZNWJxaGxxS2IzN08r?=
 =?utf-8?B?aGFJMGVtY1UwR1NWRm9WSTNBRGp3UXZJa3dzSlRZWkFodVlyMzJKY080dVJi?=
 =?utf-8?B?TFZmMS9UQndvbjRHdGhmWVB6MUFaUzdTQ2krckloN3NBNUVNVkRVUXNnT2RI?=
 =?utf-8?B?TW9POG81dGprOThqMTI4TVBacTVVU0xGWlJQSmY4UWQxemw4dHBmWmpkTzFV?=
 =?utf-8?B?RHNBc2RvQXhvT0NhbWhUN0NRdmxjWnUveVQ4aHRablRNQWdIZHlCSENGNmxt?=
 =?utf-8?B?R1hod014QURNeHlZdWRHUk44N3h6cTRFaGVrdHUwMDhNNHIxZlRrYTJocVNa?=
 =?utf-8?B?VUM2bWNIY1lYdnRVMTROeHpjVDFLQUlLOWtDaFAyaGJKYmJxcjVOTkNpMmxz?=
 =?utf-8?B?ZGhEVkg3WThGK21VdC8waVVDbVdzN0h1NHRXMjNabUttTERoVllwK1ZtVWlF?=
 =?utf-8?B?L0RJdjZSYlJoWlZvbEUzcVI0MEpkNldaS09yQUc3di9HVXFFNTVEcEYwcnNK?=
 =?utf-8?B?LzJFdFN2L0JWSHdRQ0lFN29HQmdQb2JXcExWY1dBUkQ0TVpuK0k4YTZFQU8r?=
 =?utf-8?B?c050ZEg3bi9wU1IwY2xOenNkdkZBU1lhcHlSZUNLTWtHcS9BaDJPODR6STIy?=
 =?utf-8?B?c2JpZ3ZDODlFeGlXWkxVT2dEOVBRNzBPaDd4c0VhSzloZy9xMVBmd3RYbmV5?=
 =?utf-8?B?NHZDN2N6MkxCQzNtWGtUb3c0ODJjSkVWR3hNazN0UGg5bWlucEtRaUFObStQ?=
 =?utf-8?B?cDB0Z3NEMnN4RVFKV0VaOUFwVWhEVnR4bzdlNjgvSlF6QmUwS3NHL1RBeU5K?=
 =?utf-8?B?MVlVbFgxbkdxdUJRVUxKeGFyYkJnaUJNMEpiYk9mWDdBV2tMcTAvSXZGWUZY?=
 =?utf-8?B?bjRtUXJEYXJjVHp2S3RhQzFudVVJWUo4dktRRS9BdnlCS3NLWkxQR0kvbjJP?=
 =?utf-8?B?YzZHMVhZa2NBUjZNZWVnL2oxZHUyV1Q0Z3pVTFVIdlpMcWE1ZnErazdPVzFC?=
 =?utf-8?B?djU3ZEozUzVlRTl6bHNVZ2IxMUtQUXhndzN6VlhybGlBbmRma3MyN1hkNFRo?=
 =?utf-8?B?Y0NIMWpMQTdHN05CcmpzdkFvRFFudjZIaGJvUmNmRFVGRk1IK3pZWmFleFpo?=
 =?utf-8?B?Qk80aHJ2R2VXck1DWGNqdjJmc0dncjh3Zm9wOW5NYzNaanBmT2Y1Q0s4ekxh?=
 =?utf-8?B?WWc9PQ==?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 56616d3c-4101-4d0d-57d0-08de068ae89c
X-MS-Exchange-CrossTenant-AuthSource: SJ5PPF89507EDE4.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Oct 2025 16:51:21.4311 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: PN53AvbzZBIBtc2YyzqIPKtXCUuk8j1bfknBMGNF+hCGy+J90P0QKNqgbvd9VjbrOj767q1zUODNA4NGwbgmPMEsuiN7SEDArpjInG9N7vo=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A0D52C650D
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:12:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5533D6ECC0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 095/162] drm/i915/dg1: Introduce dmabuf mmap
 to LMEM

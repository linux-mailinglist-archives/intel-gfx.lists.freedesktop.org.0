...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0D08756333
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jul 2023 14:52:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1BE7710E240;
	Mon, 17 Jul 2023 12:52:24 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 3/5] drm/i915/gt: Enable the CCS_FLUSH bit in
 the pipe control

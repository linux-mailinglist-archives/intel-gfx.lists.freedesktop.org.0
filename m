...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 92F7A6F6F12
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 17:35:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F4A910E518;
	Thu,  4 May 2023 15:35:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-lf1-x134.google.com (mail-lf1-x134.google.com
 [IPv6:2a00:1450:4864:20::134])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A657310E4D7
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 May 2023 15:35:18 +0000 (UTC)
Received: by mail-lf1-x134.google.com with SMTP id
 2adb3069b0e04-4efec123b28so777607e87.1
 for <intel-gfx@lists.freedesktop.org>; Thu, 04 May 2023 08:35:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1683214516; x=1685806516;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=BmEGwl1dtwXNhBVAE3u5X5GcBU4ls7eYTmNONq4yQ1A=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1683214516; x=1685806516;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=BmEGwl1dtwXNhBVAE3u5X5GcBU4ls7eYTmNONq4yQ1A=;
 b=
X-Gm-Message-State: AC+VfDwsaRdvfw+bRDiFjyK/EbL9EGce78LLc1JkzEOay2MDgVxOkOpP
 lmOTWou0EqlhEqMNqJWnOeVNmQ==
X-Google-Smtp-Source: ACHHUZ4yiKI067FxNIrzO0edaaTd3//481JSOsDPT99sn60Az2fLPNqZCrSvkRfkvUSMQ1wq3FRFFQ==
X-Received: by 2002:a05:6512:374c:b0:4ec:7b87:931a with SMTP id
 a12-20020a056512374c00b004ec7b87931amr2435566lfs.13.1683214516251; 
 Thu, 04 May 2023 08:35:16 -0700 (PDT)
Received: from eriador.lan (dzdqv0yyyyyyyyyyybcwt-3.rev.dnainternet.fi.
 [2001:14ba:a0db:1f00::8a5]) by smtp.gmail.com with ESMTPSA id
 n15-20020a056512388f00b004e96afb1e9asm6608753lft.253.2023.05.04.08.35.15
...
Date: Thu,  4 May 2023 18:35:08 +0300
Message-Id: <20230504153511.4007320-6-dmitry.baryshkov@linaro.org>
...
Subject: [Intel-gfx] [PATCH v5 5/8] drm/display/dsc: use flat array for

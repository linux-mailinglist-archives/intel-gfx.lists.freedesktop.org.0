...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B96526729
	for <lists+intel-gfx@lfdr.de>; Wed, 22 May 2019 17:48:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D10F789BD2;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 jXdg==
Subject: [Intel-gfx] [PATCH 3/4] drm/i915: remove irrelevant DRM_UNLOCKED
 flag

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3269B421F7E
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Oct 2021 09:36:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A00D46EB18;
...
Subject: Re: [Intel-gfx] [PATCH 08/28] dma-buf: use the new iterator in
 dma_buf_debug_show

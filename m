...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 715E7C2AA8
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Oct 2019 01:13:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 870E86E504;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH i-g-t] tests/kms_crtc_background_color: overhaul
 to match upstream ABI (v5.1)

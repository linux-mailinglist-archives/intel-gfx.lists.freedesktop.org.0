...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83B2340CE36
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 22:39:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B55056EA46;
	Wed, 15 Sep 2021 20:39:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x82a.google.com (mail-qt1-x82a.google.com
 [IPv6:2607:f8b0:4864:20::82a])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 83A3A6EA46
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Sep 2021 20:39:17 +0000 (UTC)
Received: by mail-qt1-x82a.google.com with SMTP id d11so3620099qtw.3
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Sep 2021 13:39:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=guSiBNaFO+3K/SgPTI8yvfYQvo7pQTSYXnNNFS4rJ4I=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=guSiBNaFO+3K/SgPTI8yvfYQvo7pQTSYXnNNFS4rJ4I=;
 b=
X-Gm-Message-State: AOAM5304jhaLguD0npn2VIngwFKuDJhpFTLznmuZlfCyBRSUm2qSZ8QD
 C9Ms8E/nzPcpD2WItWJ8++TQ5A==
X-Google-Smtp-Source: ABdhPJxAmAmOoH4vfJis8gOJt10XSXStDwndtz0oc74I7ICrUApeDWzZEQ/k1VliMbmZy5irbTBrOA==
X-Received: by 2002:ac8:5887:: with SMTP id t7mr72763qta.0.1631738356239;
 Wed, 15 Sep 2021 13:39:16 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id m5sm865955qkn.33.2021.09.15.13.39.15
 (version=TLS1_2 cipher=ECDHE-ECDSA-CHACHA20-POLY1305 bits=256/256);
 Wed, 15 Sep 2021 13:39:15 -0700 (PDT)
...
Date: Wed, 15 Sep 2021 16:38:26 -0400
Message-Id: <20210915203834.1439-8-sean@poorly.run>
X-Mailer: git-send-email 2.31.0
In-Reply-To: <20210915203834.1439-1-sean@poorly.run>
References: <20210915203834.1439-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 07/13] drm/i915/hdcp: Use HDCP helpers for
 i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 52CE84B91DC
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Feb 2022 20:55:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B96E89204;
	Wed, 16 Feb 2022 19:55:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A14B489204
 for <intel-gfx@lists.freedesktop.org>; Wed, 16 Feb 2022 19:55:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645041331; x=1676577331;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=wx+10nvyuqDniGdZU6VDpfEF6N+4KhpXUut7ijnAFjI=;
 b=FqtnutE9xa086hxcre7s2/mZeRx+eTayqZ4W9z50mmRX5nqRh5aZyUqe
 81jNL6ZdcL2uflpNyVqpfhZdyC+lMmFbYsreVE9Jzim0/keHOxLtHob6G
 PPB4Ao0wUp4132Cu452wrA3fkBqON2xkkzlBibCBTkYElNwFyEH+ahufg
 qG47S+2xKHCLt9IuJOuIOFc2Nf1GOrg+u1SraR/9aWChnqHy1DYJE+u+I
 YTR4SKEp8NskSEvqUl2d9HDd0MPPCfC7e/NRdxuDLph8MoyXuZU30jvLD
 YNc2WdwoTv7TMHGPBQrWuk6J8SYxD0V0v8bYMV00RwlDCStlZ2Pw0IzUK g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10260"; a="249544609"
X-IronPort-AV: E=Sophos;i="5.88,374,1635231600"; d="scan'208";a="249544609"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Feb 2022 11:55:31 -0800
X-IronPort-AV: E=Sophos;i="5.88,374,1635231600"; d="scan'208";a="545140399"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Feb 2022 11:55:27 -0800
...
Date: Wed, 16 Feb 2022 21:54:56 +0200
Message-Id: <20220216195459.3918414-3-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 2/5] mei: add support for graphics system

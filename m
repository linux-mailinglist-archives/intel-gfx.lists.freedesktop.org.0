...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B2EF26DE4DC
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Apr 2023 21:22:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 706A610E631;
	Tue, 11 Apr 2023 19:22:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yb1-xb33.google.com (mail-yb1-xb33.google.com
 [IPv6:2607:f8b0:4864:20::b33])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2091410E631
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Apr 2023 19:22:19 +0000 (UTC)
Received: by mail-yb1-xb33.google.com with SMTP id e127so9364222ybf.8
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Apr 2023 12:22:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1681240939; x=1683832939;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=JFo0f1Sr1+yQ3QLGhxacntBMMbw5RN6UTvDoJXnJ62I=;
 b=RsFrEqtG4HporUh9/3w+k/W9443eV9+pJmn5QcOfBBCOs+tcaXPovsKWjoFop+CHcd
 Jq3IcOySgUotQtSSXzivOThUDArl/exLxnk9kalw/milzlwKJ9KrlxMl8v9Eg0VBbFDu
 QWzfKtn/gjz7bTp5zUoO72NuA/zNwVzzXnfuQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1681240939; x=1683832939;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=JFo0f1Sr1+yQ3QLGhxacntBMMbw5RN6UTvDoJXnJ62I=;
 b=
X-Gm-Message-State: AAQBX9dxUsGNxCWlYdqQSIa2AxXaPujCmf1ctCx2UUkVPcQETY2Hy1vw
 3Am3lkbDZoIvTppq++2gnO7cwA==
X-Google-Smtp-Source: AKy350YewVx7oxQIWCkA3iv9V+QhEdGnsSj/AULCRKYUBlUOrdw8ND56WLkjy17pgkx1IAZ/unzHrQ==
X-Received: by 2002:a25:ae08:0:b0:b73:1eab:1723 with SMTP id
 a8-20020a25ae08000000b00b731eab1723mr9519126ybj.29.1681240938528; 
 Tue, 11 Apr 2023 12:22:18 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:2991:9b76:4e62:65bf])
 by smtp.gmail.com with UTF8SMTPSA id
 130-20020a250a88000000b00b8bd10ad9b0sm3847876ybk.11.2023.04.11.12.22.17
...
Subject: [Intel-gfx] [PATCH v9 10/10] drm/msm: Implement HDCP 1.x using the

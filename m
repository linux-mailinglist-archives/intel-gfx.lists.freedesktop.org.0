...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F2C4E4E4CB5
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Mar 2022 07:26:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47AB810E5D7;
...
Subject: [Intel-gfx] [PATCH v11] drm/amdgpu: add drm buddy support to amdgpu

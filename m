...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D761134737
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Jun 2019 14:46:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E6E67897F9;
...
Subject: Re: [Intel-gfx] [PATCH] dma-buf: Discard old fence_excl on retrying
 get_fences_rcu for realloc

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 23D52669414
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 11:26:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0955C10E9E4;
	Fri, 13 Jan 2023 10:26:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x634.google.com (mail-ej1-x634.google.com
 [IPv6:2a00:1450:4864:20::634])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 149B910E9E1
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Jan 2023 10:26:04 +0000 (UTC)
Received: by mail-ej1-x634.google.com with SMTP id cf18so44881007ejb.5
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Jan 2023 02:26:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=in-reply-to:content-transfer-encoding:content-disposition
 :mime-version:references:message-id:subject:cc:to:from:date:from:to
 :cc:subject:date:message-id:reply-to;
 bh=dQkwCuEehUtLPsDqaNm/Hq/HAQcWlSm6jFbjlljlIME=;
 b=Tf3aXMQ7fXFTquJ417v9gJWhFVfSRD1/NKjf3tO/eckoaYx1B/R40/kWPupGIjmMPJ
 VW0Li8mGejkmkMQvPL3evusudJc4mLL4Sk5SptHD2UE5ci5FxAHPv66g0op9844kUz2e
 MDqpxDLavJOk3oB8x03sjpIErVDCH1BC5cX9w=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=dQkwCuEehUtLPsDqaNm/Hq/HAQcWlSm6jFbjlljlIME=;
 b=
X-Gm-Message-State: AFqh2kr5gKsgikw9ZQTEsmWSmiupxwySeG2wodGWKGBtxRXksTVDDfNB
 S9YjvXLTtt0vRU7v9aAGi8WWRQ==
X-Google-Smtp-Source: AMrXdXtwaQbBdop0kbtgiUs2lmTrhAyHGDnWazaseY3eHXoBu7gyxzgJJwkZeuffsKaJsuhA09Lagw==
X-Received: by 2002:a17:906:39cc:b0:865:db90:1fd8 with SMTP id
 i12-20020a17090639cc00b00865db901fd8mr5267012eje.61.1673605562278; 
 Fri, 13 Jan 2023 02:26:02 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id
 f4-20020a50ee84000000b00494dcc5047asm7981336edr.22.2023.01.13.02.26.00
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 13 Jan 2023 02:26:01 -0800 (PST)
Date: Fri, 13 Jan 2023 11:25:58 +0100
From: Daniel Vetter <daniel@ffwll.ch>
To: Jani Nikula <jani.nikula@linux.intel.com>
Message-ID: <Y8ExtuE8fFyNnnXh@phenom.ffwll.local>
References: <20230112085044.1706379-1-Wayne.Lin@amd.com>
 <877cxqg2na.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <877cxqg2na.fsf@intel.com>
...
Cc: intel-gfx@lists.freedesktop.org, Rodrigo Vivi <rodrigo.vivi@intel.com>,
 amd-gfx@lists.freedesktop.org, bskeggs@redhat.com,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 63BAD5B5148
	for <lists+intel-gfx@lfdr.de>; Sun, 11 Sep 2022 23:17:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE3E110E537;
...
Subject: [Intel-gfx] [PATCH v5 2/3] drm: Expand max DRM device number to
 full MINORBITS

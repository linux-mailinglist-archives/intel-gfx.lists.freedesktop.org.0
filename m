...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C96E8C0AEB7
	for <lists+intel-gfx@lfdr.de>; Sun, 26 Oct 2025 18:30:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28BBE10E2ED;
	Sun, 26 Oct 2025 17:30:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="WFVMjGwZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ACACC10E2ED;
 Sun, 26 Oct 2025 17:30:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761499840; x=1793035840;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=c+G2ZBG0X8FLXRO71gRUtnKd0nDqbMtx3UMc1sXwk40=;
 b=WFVMjGwZZ/AGmslq1PNc9SUGr/UiMzo1qo4HCIeNwaNf+xoGnPRMfnLO
 cBSKemfFDAPhJ/lbIMB/W7g3FQY4k42ybO445PliSQwUQRhL6TvrXj1bE
 xTb4/54HTn5BYcSfAJMXe5salEJPfelM/aLylXs95vCbneeLb7ukWtHPU
 NrZmOscct89EuhLSYexR6L8Ix/GL/IpXsn/eHFgepREOglqSIQCwzbS99
 bOr3n3OQRGQFRzLDiSuCRHhXQgvuwns0HXZj/7xQTwwT/eATeLluzrzit
 PfK6kZ7aMT8+n7f372/tMAXEgLuXbw764jGYeDtGoHnjVY6XU55jhE0VX w==;
X-CSE-ConnectionGUID: FzTzOR+RR3unvBcZERWUKg==
X-CSE-MsgGUID: nS6cMU0nQgCpHE3jXxK9vg==
X-IronPort-AV: E=McAfee;i="6800,10657,11586"; a="62624102"
X-IronPort-AV: E=Sophos;i="6.19,257,1754982000"; d="scan'208";a="62624102"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Oct 2025 10:30:39 -0700
X-CSE-ConnectionGUID: RuYHVhp4RTeESttlFR0PaA==
X-CSE-MsgGUID: Xz/pff+4QfWNW+Mg/+5Www==
X-ExtLoop1: 1
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by fmviesa003.fm.intel.com with ESMTP; 26 Oct 2025 10:30:38 -0700
From: Nemesa Garg <nemesa.garg@intel.com>
To: intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org,
 intel-xe@lists.freedesktop.org
Cc: Nemesa Garg <nemesa.garg@intel.com>
Subject: [PATCH 00/10]  Introduce drm sharpness property
Date: Sun, 26 Oct 2025 22:56:17 +0530
Message-Id: <20251026172628.2705365-1-nemesa.garg@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 64964A2ECB7
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Feb 2025 13:40:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 081C610E514;
	Mon, 10 Feb 2025 12:40:21 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aojFQEuB";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E8DFD10E516;
 Mon, 10 Feb 2025 12:40:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739191219; x=1770727219;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=LcLZX+MqsuiGWTPJq5PwjVg9YlIKYThjrrW12WoaaM8=;
 b=aojFQEuBQS+OUsmHnVW50zPBUuj6cHXcXhrO4Nijvn5SwXBh7ELozH/i
 lV/PGPVIJwhGqYawXakU9H6RieCNbbAKSwf3SQdp6Dq9tmXdPoXuD1UJm
 FybPwLsWkJy5leXijgfw6ow9Ca+Qg4TWhrDnr09QkK977pp0q+JgpxwCx
 /HveoeRxESFcTCO1G00E76Zl8AKuxlYc95BpuU/HT8aQBjIufIuzyuTW+
 RgBqIUvGHSanC76L3n9cmeNvUKrqcyWpebuZxmp79Vj9OYnlDcno+Tkc7
 AYFlea7bvnHhTIAK5pjCFeVBqVM4LpYYWhqcd8njEWxeBoOt4mYRRYcKN Q==;
X-CSE-ConnectionGUID: Wgj/9bEKS7CD3cmtykhEUQ==
X-CSE-MsgGUID: gNXHswUyQxCnucU2N6YXig==
X-IronPort-AV: E=McAfee;i="6700,10204,11341"; a="40038344"
X-IronPort-AV: E=Sophos;i="6.13,274,1732608000"; d="scan'208";a="40038344"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Feb 2025 04:40:18 -0800
X-CSE-ConnectionGUID: N6wJ54bmTGapnRfVuA8qbQ==
X-CSE-MsgGUID: B16Z+p8bRBS02smL5lGsDw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="113063688"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa008.jf.intel.com with ESMTP; 10 Feb 2025 04:40:17 -0800
...
Date: Mon, 10 Feb 2025 18:09:48 +0530
Message-Id: <20250210123950.3476620-8-suraj.kandpal@intel.com>
...
index c4120a834698..75b865bde1b9 100644
...
index ed530363c10d..1d69fa8b2ad0 100644
...
@@ -1247,14 +1247,14 @@ static int hsw_get_dpll(struct intel_atomic_state *state,
 	return 0;
 }
...
@@ -1986,10 +1986,10 @@ static int skl_ddi_pll_get_freq(struct intel_display *display,
...
@@ -2456,10 +2456,10 @@ static int bxt_get_dpll(struct intel_atomic_state *state,
 	return 0;
 }
...
@@ -4091,10 +4091,10 @@ static void mg_pll_disable(struct intel_display *display,
...
@@ -4546,10 +4546,10 @@ static void readout_dpll_hw_state(struct intel_display *display,

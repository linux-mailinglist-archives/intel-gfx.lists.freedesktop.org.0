...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E8D657237F5
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Jun 2023 08:44:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5133410E299;
	Tue,  6 Jun 2023 06:44:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E794610E29D
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Jun 2023 06:43:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686033837; x=1717569837;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6YL/oJGHickUiahL4FdNBLu7zUkFf867Tq4brz/OQBM=;
 b=UCaR3VkIh/m3MNbpHbS6yydC1owasMjyUCj5A7FoOo47ItrWUmQbwhp0
 rrU8XANigDG97mASykNzROOkRmU2ht1OJyMsNMvrH1+Djd2JmWwBKygYH
 wtc0M46sHe1fZzEPwkUuJQD4Cf4rvBpIBi9ur+i+mZ7yGha5E57bALEpn
 QBGzf5UP98TttFChLi9nVZIzKGoEjsRAWYrAc6hI87FgarBODgitdk59c
 wRYSj6Wy6ATl1OFEQoTWnTWjy+iv3mB+dQHraQWmGQQ0+OpqxXM4JiRBl
 VdmfDStIqcBz/0pwnE592SbHI8l76vRuzNSeGeZh1EvMcdmVauh1cloy8 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="336940610"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="336940610"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jun 2023 23:43:57 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="778865628"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="778865628"
Received: from mgmohiud-mobl2.gar.corp.intel.com (HELO
 vgovind2-mobl3.intel.com) ([10.249.42.181])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jun 2023 23:43:55 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Jun 2023 09:43:25 +0300
Message-Id: <20230606064327.188226-6-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v13 5/7] drm/i915: modify max_bw to return index
 to intel_bw_info

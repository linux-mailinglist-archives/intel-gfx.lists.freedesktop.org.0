...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FFE06AF99C
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Mar 2023 23:55:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9798010E2AA;
...
Subject: Re: [Intel-gfx] [PATCH 1/2] drm/i915/gsc: flush the GSC worker

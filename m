...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 662A057BBCA
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 18:49:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C9F79106E;
...
Subject: [Intel-gfx] [PATCH v5 0/4] drm/i915/display: stop HPD workers

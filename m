...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7642D21FE2A
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:06:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7304F6E87E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/3] dma-buf/selftests: Add locking selftests
 for sw_sync

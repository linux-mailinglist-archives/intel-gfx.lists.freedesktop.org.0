...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id GINJOdbalWn3VQIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Feb 2026 16:29:26 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A8E41576B2
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Feb 2026 16:29:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 267D410E5F7;
	Wed, 18 Feb 2026 15:29:25 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="MSR/9kba";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4E85210E5F5;
 Wed, 18 Feb 2026 15:29:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1771428564; x=1802964564;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=0/UxckNm/ol0hzDDiy/OSEdXALPhdtjMatRaP1R3Zto=;
 b=MSR/9kbaK1te2TDIfhzR+QAP5GpmDJsDOk/4OWD42J7SYzTD1hQM/kwE
 fAtyvW/n0jJQc+JJF0CjndFgZ/5r6ib5In9YkI1ZP0ksffH3SW2+OGehf
 jVC09f9BGozAsfZSHJk8tdkUqEFMZdvKP83HV3kk62LDzjU8VlWaNv7SV
 Q/c0ep/BKwvsSY03Dn3IL0q/PJ0K0i7RykxnjqSghzEd/3hiUGZmjEGHn
 /Q7mTKEo755yh4BHbYbpaQ4cEHbVGcUvRSkYxG/pHqG9Ltp58mNFTdK7m
 ZA1CElzg7lO8kxI3NRuPKLLZn/Lisy4JYFke5wtg4oFd99yZsoZxBQM2z w==;
X-CSE-ConnectionGUID: BrFGrL1dQPSKPJnnVK+9ug==
X-CSE-MsgGUID: gsw6RSpaRv2pGoSnzA5T0w==
X-IronPort-AV: E=McAfee;i="6800,10657,11705"; a="72495491"
X-IronPort-AV: E=Sophos;i="6.21,298,1763452800"; d="scan'208";a="72495491"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Feb 2026 07:29:23 -0800
X-CSE-ConnectionGUID: t0TLlSCGRJyDCN8BZXVdeQ==
X-CSE-MsgGUID: ftBGOneDTaGytMrnQopBeg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,298,1763452800"; d="scan'208";a="213302965"
Received: from vpanait-mobl.ger.corp.intel.com (HELO localhost)
 ([10.245.244.66])
 by orviesa006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Feb 2026 07:29:19 -0800
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: intel-xe@lists.freedesktop.org
Subject: [PATCH 16/19] drm/i915/overlay: Split 'struct intel_overlay'
Date: Wed, 18 Feb 2026 17:28:03 +0200
Message-ID: <20260218152806.18885-17-ville.syrjala@linux.intel.com>

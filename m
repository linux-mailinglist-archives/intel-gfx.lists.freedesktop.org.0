...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 382223DF74E
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Aug 2021 00:12:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 127EB6E13A;
...
Subject: [Intel-gfx] [PATCH 00/46] Parallel submission aka multi-bb execbuf

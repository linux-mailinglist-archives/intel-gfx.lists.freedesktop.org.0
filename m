...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D579A3C94FD
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jul 2021 02:21:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74E956E511;
...
Subject: [Intel-gfx] [PATCH 02/13] vfio: Introduce a vfio_uninit_group_dev()
 API call

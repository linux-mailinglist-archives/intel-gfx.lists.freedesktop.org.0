...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4897214FE1B
	for <lists+intel-gfx@lfdr.de>; Sun,  2 Feb 2020 16:50:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B31A46EAEB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 12/18] drm/i915: Program DP SDPs with
 computed configs

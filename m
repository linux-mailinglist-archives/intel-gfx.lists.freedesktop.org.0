...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C62858365D
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Jul 2022 03:35:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BBB610E983;
	Thu, 28 Jul 2022 01:35:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 59F1410E0B7
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=cB0WKuMTjEpmc5A5FlxH89b4q2q6i1iyR7CBb3hT/eI=;
 b=gPCcmhxLJGKXD/m/PXMq+V9MsHw1QuY9x+yF1sApvV3aT0/Z9FpOtmrx
 /YslzxSGqLQaamsLz7RG5b20AzGspYfuOM2/UOfEWKUs2bOKnfNvM+2TT
 0y+eZ3w+jZSLw5s/U8AFvrWK0WNdVXJeiXGvw9CjIZcU0ns4Atjwgbw4P
 Gj3x+WpF9Jvg96BnkxkhEMNRMGdQ4zl8FYDmTLHzRAolxPXFhQtcHXYv6
 52pv85Vf3PUEIoWLQhwSr8DtWKVTrvhsVTwRX/wuWUFY/0wHrNUbhlybp
 yO5WEt+Rzq2Xxc3Xtj27IQDN5F8G2iXkbrem+47dGXncso+TtyAGlkKlV Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10421"; a="288403225"
X-IronPort-AV: E=Sophos;i="5.93,196,1654585200"; d="scan'208";a="288403225"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jul 2022 18:34:38 -0700
X-IronPort-AV: E=Sophos;i="5.93,196,1654585200"; d="scan'208";a="659456932"
Received: from invictus.jf.intel.com ([10.165.21.205])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jul 2022 18:34:38 -0700
From: Radhakrishna Sripada <radhakrishna.sripada@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 27 Jul 2022 18:33:58 -0700
Message-Id: <20220728013420.3750388-2-radhakrishna.sripada@intel.com>
...
Subject: [Intel-gfx] [PATCH 01/23] drm/i915: Read graphics/media/display
...
@@ -855,14 +925,23 @@ int i915_driver_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
 		return PTR_ERR(i915);

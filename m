...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5907D7E2FD5
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Nov 2023 23:28:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00A4F10E452;
	Mon,  6 Nov 2023 22:28:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7FA1A10E44E;
 Mon,  6 Nov 2023 22:28:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699309709; x=1730845709;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=5/lX+i/xrutSkuFqYuLe/BLITugE5iyFRJKZgqmx6bs=;
 b=BTZpr7XKtWgRXhCGOBYEC0iXzY0CGkci1Y9Tdrv49msbfr2n6h8Pl+UT
 0zler/4darx3vnNMmrNIN4FXPBtPWiHqnkWoMqwb9Vr3sjEA4+U424cCI
 Gd/MRxj3YFGVm1XdCpfInH1uNB9nvel+9IaGASgvmXZEWvq5r7XUA6F9t
 eEvfE3e/6ZRy4xJrFdDfDKuMet9BlanO5dDGWciZMYXO8k1j4yEoEN9cv
 DNXJXHIJkJqDL8+GCitM9t0GDantsuH1e6nqga66Dp0Lq97jzFHcu1sdo
 ktPLFYn93dcEncpAt04+Qtbl5dJH+bCy8STAGmnoM5a1eVWrJm9aPqR63 g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10886"; a="8014187"
X-IronPort-AV: E=Sophos;i="6.03,282,1694761200"; 
   d="scan'208";a="8014187"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 14:28:29 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10886"; a="853148960"
X-IronPort-AV: E=Sophos;i="6.03,282,1694761200"; d="scan'208";a="853148960"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 14:28:25 -0800
Date: Tue, 7 Nov 2023 00:28:24 +0200
From: Imre Deak <imre.deak@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <ZUloiFDQkl+om9wX@ideak-desk.fi.intel.com>
...
In-Reply-To: <ZUlbR4FGcRPuXXfM@intel.com>

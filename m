...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EC34673E7D
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Jan 2023 17:19:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 37D1310E9A4;
	Thu, 19 Jan 2023 16:19:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AA6DE10E9A4;
 Thu, 19 Jan 2023 16:19:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1674145174; x=1705681174;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=c72u0LbNFOKSIut9bTyjOU0Bmjmq1MjEOcYeGjfeVNU=;
 b=QFEDON78EjeR8IOkxPAVXLlDtkayQV9pInWRHUkv5DhEm5q/m6ZACdDw
 1N0jvV30kL8WKM0NYNsMiCiBpnAAScGnt34JAM/1h95XIe1dzoAigXtCf
 /hkaI8Y3Fuo8/E7R4Q3UkNYKQKRmRINekF4R7kPbYFQUJ7uuhgkCmUG0f
 OkYltCdfz+D87npt+dL0eYr0BvyePMH1/cc+YKG4KFzVdZO3ngOGu+CXK
 KWZ8UlOQT/soJ8HGFXgTIMeF1yiMSnNdy/zwXTzjN+WiJ1ac7+GsUHof4
 s2NiHhVJo8Jdx3cjG8aRKuOwnl1Y9mehRKanbLFgfU2Zkd8nrCJBVTjVo w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10595"; a="305699280"
X-IronPort-AV: E=Sophos;i="5.97,229,1669104000"; d="scan'208";a="305699280"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2023 08:19:34 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10595"; a="637756090"
X-IronPort-AV: E=Sophos;i="5.97,229,1669104000"; d="scan'208";a="637756090"
Received: from jnikula-mobl4.fi.intel.com (HELO localhost) ([10.237.66.157])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2023 08:19:31 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Thu, 19 Jan 2023 18:18:58 +0200
Message-Id: <b58b4c5ea31943e6c816ba0f6f4efa48bd9e5ab6.1674144945.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 5/8] drm/i915/edid: convert DP,

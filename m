...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EB9A44C06DD
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Feb 2022 02:28:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EAFA10E21B;
	Wed, 23 Feb 2022 01:28:31 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 8/8] drm/i915/guc: Fix potential invalid

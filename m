...
Received: from mail.lfdr.de
	...
	id W8JDOCF1R2ocYgAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 03 Jul 2026 10:38:57 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 226077002BC
	for <lists+intel-gfx@lfdr.de>; Fri, 03 Jul 2026 10:38:57 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=none;
	dmarc=none;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1516410F5C4;
	Fri,  3 Jul 2026 08:38:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 6beec6c84f66 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BEE3C10F5C4;
 Fri,  3 Jul 2026 08:38:53 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============3748107724524329287=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=93_i915=2ECI=2EBAT=3A_success_for_drm=3A_Guard_DRM=5FCLIENT?=
 =?utf-8?q?=5FCAP=5FPLANE=5FCOLOR=5FPIPELINE_=28rev2=29?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Robert Mader" <robert.mader@collabora.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Fri, 03 Jul 2026 08:38:53 -0000
Message-ID: <178306793377.147660.10360036708332823335@6beec6c84f66>
...
<b>Patch Details</b>
<table>
<tr><td><b>Series:</b></td><td>drm: Guard DRM_CLIENT_CAP_PLANE_COLOR_PIPELINE (rev2)</td></tr>
...
<tr><td><b>State:</b></td><td>success</td></tr>
    ...
    <tr><td><b>Details:</b></td><td><a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169680v2/index.html">https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169680v2/index.html</a></td></tr>

</table>


    <h1>CI Bug Log - changes from CI_DRM_18755 -&gt; Patchwork_169680v2</h1>
<h2>Summary</h2>
<p><strong>SUCCESS</strong></p>
<p>No regressions found.</p>
<p>External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169680v2/index.html</p>
<h2>Participating hosts (42 -&gt; 39)</h2>
<p>Missing    (3): bat-dg2-13 fi-snb-2520m bat-jsl-5 </p>
<h2>Known issues</h2>
<p>Here are the changes found in Patchwork_169680v2 that come from known issues:</p>
<h3>IGT changes</h3>
<h4>Possible fixes</h4>
<ul>
<li>igt@i915_selftest@live:<ul>
<li>bat-twl-1:          <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18755/bat-twl-1/igt@i915_selftest@live.html">DMESG-FAIL</a> (<a href="https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/16528">i915#16528</a>) -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169680v2/bat-twl-1/igt@i915_selftest@live.html">PASS</a> +1 other test pass</li>
</ul>
</li>
</ul>
<h2>Build changes</h2>
<ul>
<li>Linux: CI_DRM_18755 -&gt; Patchwork_169680v2</li>
</ul>
<p>CI-20190529: 20190529<br />
  CI_DRM_18755: 2bdb7ee737dfd4d699e9994ef8aec5c92ec2d4e5 @ git://anongit.freedesktop.org/gfx-ci/linux<br />
  IGT_8990: 8990<br />
  Patchwork_169680v2: 2bdb7ee737dfd4d699e9994ef8aec5c92ec2d4e5 @ git://anongit.freedesktop.org/gfx-ci/linux</p>

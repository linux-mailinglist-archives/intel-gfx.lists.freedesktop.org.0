...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C22FE714857
	for <lists+intel-gfx@lfdr.de>; Mon, 29 May 2023 13:09:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C188A10E27B;
	Mon, 29 May 2023 11:09:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B5FFE10E277
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 May 2023 11:09:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685358556; x=1716894556;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=h5fbRKdUHjRbFWW1Va+OG42WmPCP2k6XxZUERHd6gxw=;
 b=k5EaLr8jt1xfPgRpD7TXDrTcYIJbFi9QdFW8/xoON7l3HK0SJPfYo4r/
 00Aipohg0jn1AUQGv5yf8TSsr953ygM4Y42ZbnP3IdGxKqZi8ytx5iyU0
 yrl1Y6b5P4+vdxe2AO9A8DCIW9St8x9gjlfKtH4SrSn8+XTXR9b8CeW7s
 foUFeuaQ1KLj2xOBhPnDks/j5DMQz/c4VsJLDC2WCNfJJ2EykCkQ0bVo4
 /bEntTbmlYsqYyFti4e2JNb+1tfpBZbllsqHHuZRk9qFFn9vjtpQtzhFD
 YJ5CA/1oBuVJ+0smw55+RcFHW/Xs1vApilxbCi4rnzhSBHDAcffbKQa6B w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10724"; a="382936212"
X-IronPort-AV: E=Sophos;i="6.00,201,1681196400"; d="scan'208";a="382936212"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 May 2023 04:09:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10724"; a="709233401"
X-IronPort-AV: E=Sophos;i="6.00,201,1681196400"; d="scan'208";a="709233401"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga007.fm.intel.com with ESMTP; 29 May 2023 04:09:14 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 29 May 2023 16:37:39 +0530
Message-Id: <20230529110740.1522985-3-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 2/3] drm/i915/hdcp: Move away from master
 naming to arbiter

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 347573CBD0D
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jul 2021 22:00:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02CC46E9EB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/51] drm/i915/guc: Add LRC descriptor context
 lookup array

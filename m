...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47B236F6172
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 00:50:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7165510E0F2;
	Wed,  3 May 2023 22:50:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D95E910E0F5;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=cYFKpj4L1CeqSOc/Ns4GHh+VL18+ComnXqJlcfP3xe8AeSrN3JVGf3si
 gV2uRtS65unijB2CHiMiGONoDi5OjrTUembhy75rbtl3dYUFAv4vytSHx
 wweJqhLOGBxCeEpB2ez7Nm0gh10Gp3lsGa/dE36wPxzsp85Dc3ouMq/sZ
 Y/RyqKNgri7ef7LTnfFmAXPJ3/S4VnwgIXUNf860J84RdV/9KYdAzag0O
 zaltiRE08I9Y0YFDl4TdRyA7xBuAh8ZMQMdc0BWInfT4bRKijGRlQ0+/7
 eUrIIZFPz/uCqJxOmVZX7oO/TdWEugk+r1X8nZFZOjPKDEPdhggBcpVr3 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="347604359"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="347604359"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 15:49:59 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="871121279"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="871121279"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 15:49:59 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 May 2023 15:50:58 -0700
Message-Id: <20230503225100.2834222-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 1/3] drm/i915: preparation for using PAT index

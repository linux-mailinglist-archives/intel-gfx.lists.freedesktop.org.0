...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F02D782DBD
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Aug 2023 18:04:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6B75410E285;
	Mon, 21 Aug 2023 16:04:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A9CAF10E1E0
 for <intel-gfx@lists.freedesktop.org>; Mon, 21 Aug 2023 16:04:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692633861; x=1724169861;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=0ttDn9/xhx6kEJLX5ZG9V/cmUns9UFyfrQlcTYJBREU=;
 b=Ss0WxGPP3Min+I+f8n3yRNOKrf04sJn0Pn60h9d1gQIGNgUmgWwCWfne
 IMV3YunE9dj5Z6VWlVeoi3rEYCbL19FrZTBss8VUmfvWBjwcI7c08wlas
 Y5wv4PzukBBKY0K3HZHNf+bdXjxunF6hag0BYIeWAMbS3117gPe7LlVjT
 IEDNTyhmyJx9UZEiStnOtikkoD2YAtcwKhU+nWArzvQOqSK2jLlQjERnl
 IkT4BIL9NS+rp9JRCbnL9i9c2aDhyctkvzzo3i55OKn9FdAsrLOke3BYx
 JNLbUJXmtLGBAT0CdKMQ3njtunbWhx5B08fg1yUL6pOpc1VPmYZFINx02 g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10809"; a="363799476"
X-IronPort-AV: E=Sophos;i="6.01,190,1684825200"; d="scan'208";a="363799476"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Aug 2023 09:04:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10809"; a="771012433"
X-IronPort-AV: E=Sophos;i="6.01,190,1684825200"; d="scan'208";a="771012433"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orsmga001.jf.intel.com with ESMTP; 21 Aug 2023 09:04:19 -0700
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 21 Aug 2023 21:30:02 +0530
Message-Id: <20230821160004.2821445-2-mitulkumar.ajitkumar.golani@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A8E2577B52
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:39:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C196A9CBE;
...
Subject: [Intel-gfx] [PATCH v3 09/41] dyndbg: drop EXPORTed

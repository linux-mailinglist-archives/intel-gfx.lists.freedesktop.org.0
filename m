...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B5573B9590
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 19:36:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B1E36EB75;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 1/2] drm/i915: Use the correct IRQ during
 resume

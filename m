...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3455F650FDC
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:07:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEE0410E2D5;
...
Subject: [Intel-gfx] [PATCH 09/18] vfio-mdev/mdpy-fb: Do not set struct
 fb_info.apertures

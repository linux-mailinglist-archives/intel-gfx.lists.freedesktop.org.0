...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 604B1701753
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 15:29:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 062DC10E11A;
...
Subject: [Intel-gfx] [PATCH v11 23/23] docs: vfio: Add vfio device cdev
 description

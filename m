...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4B07346377
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Mar 2021 16:52:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B8C86EAD2;
	Tue, 23 Mar 2021 15:51:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1B2D66EA2B
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 65/70] drm/i915: Fix pin_map in scheduler
 selftests

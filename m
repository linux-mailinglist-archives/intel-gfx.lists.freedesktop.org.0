...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8781B8AAC6B
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Apr 2024 12:05:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF3C910EF3B;
	Fri, 19 Apr 2024 10:05:04 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AatA0YyO";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1E73110EEA3
 for <intel-gfx@lists.freedesktop.org>; Fri, 19 Apr 2024 10:04:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1713521098; x=1745057098;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=NKvAaPbH/sas8zPDuJ6NNGEXEtRiN0C2xnRRHpOvoqA=;
 b=AatA0YyOUAqDhC8bDNN+RGaz+v5QFQ3t70PKcsp5KVk7rTaHV6C+CSJu
 NrQlzKp/69RzYcbJCyKWNKpEytwIMLNb2Qk/e4uBblnnHn0aXBKLSE7B4
 NRq9QGFyQuz9M9g6zVGyNg0H4GFy28inTc5atw98f9CHsRB59RnXp6ndv
 /uTBF4Tlvrhm0EZ2R3tDPDj8915L6veidwAhNnUih7kf0k/zGFgsaYZwX
 a9oGW5MuUEUrDaBlbGdmVvuHZR2AH+6GIOLc4dMto9zV1c39t0so/vWnk
 LnMyq2GTf2SGmpp4tylF2PZUHWNGB/Zti1Af7PJOncIAjb61FQpv7aQkV w==;
X-CSE-ConnectionGUID: 4uylwfiAS22rJgx3yF7LkQ==
X-CSE-MsgGUID: khHv02L7QUiB8I2izL+9YA==
X-IronPort-AV: E=McAfee;i="6600,9927,11047"; a="8975195"
X-IronPort-AV: E=Sophos;i="6.07,213,1708416000"; 
   d="scan'208";a="8975195"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2024 03:04:58 -0700
X-CSE-ConnectionGUID: JzFH37vWSEW7nmsgBga5CQ==
X-CSE-MsgGUID: +ZHrVyY2RGeuTNXXXsno8Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,213,1708416000"; d="scan'208";a="23361499"
Received: from agherasi-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.46.119])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2024 03:04:26 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH v2 4/4] drm/i915/dsi: pass display to register macros instead
 of implicit variable
Date: Fri, 19 Apr 2024 13:04:06 +0300
Message-Id: <6dd52f3fce3527242479aadc276d05de74ceae5d.1713520813.git.jani.nikula@intel.com>

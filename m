...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A925EA2094
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Aug 2019 18:16:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 04FE46E11F;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 Xs9A==
Subject: [Intel-gfx] [PATCH 2/4] drm/ttm: use the parent resv for ghost
 objects v2

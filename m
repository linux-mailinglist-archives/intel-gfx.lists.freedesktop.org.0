...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96B7F76C76D
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Aug 2023 09:51:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1119410E055;
	Wed,  2 Aug 2023 07:51:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C5CA610E055
 for <intel-gfx@lists.freedesktop.org>; Wed,  2 Aug 2023 07:51:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690962670; x=1722498670;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=BgTDAxpLAyu4JtGBsh80drWd1StKAzGqjY6SI/S1wgQ=;
 b=edqdiS1tpbcYlWIPlSrHqnLHLPuruQyJpnpFqFbHkFE/1or+u+ScUphY
 b+LcPbvgdLQ1K1FY51yU8Vx1IntBe654sI7o4nR3B20drPPaV/mMg3Rkv
 RpQ+SugrUpl0vt+MMyXYGr2+KT2xUhY38BLzqTEdir8WDftdw8UW4Nb8P
 a8oEPCbRfDs7eW8LQ7ZuF44ZdPzcGbcg6EhkVEf+XB8ZeYsOz4I1oMXLK
 LmRbtR7SG+Hm2v/Pt6PSCIjp/CEmCva5Mmj8bbELbrTsFPWdu1sR1QrAB
 MJ0c97fe2FBr3leFaYewyzBLPP47mzffHCqMRz4nbjv0Qd8+H0t3U9S9p A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10789"; a="400455263"
X-IronPort-AV: E=Sophos;i="6.01,248,1684825200"; d="scan'208";a="400455263"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Aug 2023 00:51:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10789"; a="852788942"
X-IronPort-AV: E=Sophos;i="6.01,248,1684825200"; d="scan'208";a="852788942"
Received: from nirmoyda-mobl.ger.corp.intel.com (HELO [10.252.37.12])
 ([10.252.37.12])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Aug 2023 00:51:09 -0700
Message-ID: <c625914a-90f9-3953-981b-1621a899f8b0@linux.intel.com>
Date: Wed, 2 Aug 2023 09:51:06 +0200
MIME-Version: 1.0

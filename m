...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A7525A7A2C
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Aug 2022 11:26:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA7C910E2A4;
	Wed, 31 Aug 2022 09:26:36 +0000 (UTC)

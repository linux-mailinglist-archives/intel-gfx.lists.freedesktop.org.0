...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F9437106F4
	for <lists+intel-gfx@lfdr.de>; Thu, 25 May 2023 10:12:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 303AB10E7ED;
...
Subject: [Intel-gfx] [PATCH 1/5] drm/i915: Move setting of rps thresholds to
 init

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C90BA4C4FCA
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 21:42:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6AB3D10E935;
...
Subject: [Intel-gfx] [PATCH v2 1/3] drm/i915/guc: Limit scheduling

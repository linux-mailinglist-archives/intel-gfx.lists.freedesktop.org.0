...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 739C436745C
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Apr 2021 22:48:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAF3C6E9F6;
	Wed, 21 Apr 2021 20:48:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 134296E9F0
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Apr 2021 20:48:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1619038117;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=9ClqrLs0VWvbmqd4Kpzdj6bq2wi6fzSArgsNAxBwVl8=;
 b=Amuhy9Own7Dd2PUrg+OWCjg9SdNYvcwsLuDy9x3/r/DJk6qBOZ/doBzprctrUBJTfcMZmB
 mc0JxeZTosnnrYFmjflz4bTaNEJr2KYoJMuZG7zR22Y6JwnFu56SaqKV0KJ5Z8k65PHiLQ
 HaiS6ECepJHA8O//DmNpkbY3xf+h17o=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-395-d9RPrxn2MsqNExTH0Ek5Dg-1; Wed, 21 Apr 2021 16:48:27 -0400
X-MC-Unique: d9RPrxn2MsqNExTH0Ek5Dg-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com
 [10.5.11.15])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 7495818397A6;
 Wed, 21 Apr 2021 20:48:24 +0000 (UTC)
Received: from x1.localdomain (ovpn-112-17.ams2.redhat.com [10.36.112.17])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 2D5805D736;
 Wed, 21 Apr 2021 20:48:21 +0000 (UTC)
...
Date: Wed, 21 Apr 2021 22:47:59 +0200
Message-Id: <20210421204804.589962-5-hdegoede@redhat.com>
In-Reply-To: <20210421204804.589962-1-hdegoede@redhat.com>
References: <20210421204804.589962-1-hdegoede@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.15
Subject: [Intel-gfx] [PATCH v2 4/9] drm/privacy-screen: Add notifier support
...
+					   struct notifier_block *nb);
 ...
 static inline struct drm_privacy_screen *drm_privacy_screen_get(struct device *dev,
 								const char *con_id)
@@ -43,6 +48,16 @@ static inline void drm_privacy_screen_get_state(struct drm_privacy_screen *priv,
 						enum drm_privacy_screen_status *hw_state_ret)
 {
 }

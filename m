...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD4D7A387B7
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Feb 2025 16:36:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 529A710E4FC;
	Mon, 17 Feb 2025 15:36:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="G/o61R2p";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6384910E4FC;
 Mon, 17 Feb 2025 15:36:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739806570; x=1771342570;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=I/E3/JxVqckmAHAEC0OJB0ci+WbyQWzY3xbjYL+PxCY=;
 b=G/o61R2pfyau0CXfhhAkR+qr5uYaqXh2QqgVMmwbRAMP+cTy2sl2zOql
 l6mbuN7CkJ1mnsl5d1yOfuV2guDl/wM8iPNgry/HlKgxXDcIfPB+c/zpT
 7vqPGzV0VF7RsqdGZVdGkDjZ1DzlNAUTBZMuSefdoTSETyipWcWvMedpS
 rmfGPX9apGV3Ibyx7LohFtm13aAEOz0psJhoNS4dwMXpmucu4sP0ONkaO
 GrRGZvCQv7N3bmFU5OnfOk1HmVmy7/4in137Ji1+vgWVW12lRVOEhz12q
 1X0TLNBTonnhQZ0ajnf4pv+dl7o3IoPR1rb2W5CfDI9To0Ov+RwjoeBma w==;
X-CSE-ConnectionGUID: PY6IZQGPSJmOkqGDcFHEqw==
X-CSE-MsgGUID: 8qYkbwR1SamusxXhB+zhTg==
X-IronPort-AV: E=McAfee;i="6700,10204,11348"; a="43321625"
X-IronPort-AV: E=Sophos;i="6.13,293,1732608000"; d="scan'208";a="43321625"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2025 07:36:10 -0800
X-CSE-ConnectionGUID: wI6nkqsIQKO9iXmsKDEnPg==
X-CSE-MsgGUID: Uv/Y6J9pSjSuffwqPNc61Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,293,1732608000"; d="scan'208";a="119258646"
...
Subject: [PATCH v2 1/3] drm/i915/display: Use display variable in intel_bw.c
Date: Mon, 17 Feb 2025 12:35:23 -0300
Message-ID: <20250217153550.43909-2-gustavo.sousa@intel.com>

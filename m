...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CA4A20FF0F
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:30:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 480586E492;
...
Subject: [Intel-gfx] [PATCH 35/59] drm/kmb: Remove declaration of
 irq_lcd/irq_mipi

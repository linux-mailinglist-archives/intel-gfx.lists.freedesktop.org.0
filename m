...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DEB1701734
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 15:28:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47C4810E0E4;
...
Subject: [Intel-gfx] [PATCH v11 09/23] vfio: Make vfio_device_open() single
 open for device cdev path

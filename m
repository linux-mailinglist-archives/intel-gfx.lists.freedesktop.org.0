...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 021ED73FE9E
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jun 2023 16:44:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0B9210E34C;
	Tue, 27 Jun 2023 14:44:02 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 16/24] drm/i915/gvt: use vmalloc_array and
 vcalloc

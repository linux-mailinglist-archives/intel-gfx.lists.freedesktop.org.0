...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 192905FA113
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Oct 2022 17:22:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20D3F10E62B;
	Mon, 10 Oct 2022 15:22:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2550610E62B
 for <intel-gfx@lists.freedesktop.org>; Mon, 10 Oct 2022 15:22:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665415363; x=1696951363;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=TxM55zVxKzJvMF8B+qXBVMfWdXQISifmxYh3XEBQIzs=;
 b=j4XswKTjuZOUtvIwi6sR9Y8Glc+MqtVAKhRfhDHrIW4+YraE1dcBRY7x
 xKcKlOxD7egmuUd7Rvd3KSKPX57jCM1fYB69+2cI93DPlWewjOrIoP5G8
 VwikUKNEY+yxdfV93gSrr1c54t16zyo19HB1ixe9vYcXplbcAqZ8krTYa
 sb71Tu7icAclXo7w0WXcPUqWvKMyO5mnYC9Tdw2sDG43VqXTh8LnS33pI
 o4R9KzzhadZL61c1ZfzXwuqdyQ0ST34NhtkGYcAHxCfRvHjbkgcXWJCee
 t8LPbx6Refge+6UZpNthb8o5OL90pPTr3YDR8c3a7qdpl99iNKxQ2qNt+ A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="304240233"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="304240233"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2022 08:22:42 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="659183235"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="659183235"
Received: from iolejnic-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.41.51])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2022 08:22:39 -0700
...
Date: Mon, 10 Oct 2022 18:22:37 +0300
Message-ID: <871qrfzosi.fsf@intel.com>
MIME-Version: 1.0

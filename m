...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 10EA34DD4BC
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Mar 2022 07:40:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 45F9C10E1D2;
	Fri, 18 Mar 2022 06:40:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0FC8310E062;
 Fri, 18 Mar 2022 06:40:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=gLRWApPgIIuX2Hu04L9jZFJ5HFuJOr0dVUculNM0dI6EOgbK3vRv5Opl
 kZBneNFBy/y9qzM76uQif7g6z6AcghGxZ7re+ghzeK3bt8+pACTv1c9I3
 IzsaidwPW3qxzNj1z28XaCAmi6SVS/8vaoAjbl0iG+5WmehIbTDJPnhY/
 8RYRapTeGQfdAYTNpUlwMMTsYooRP0jTq8a6KvOlRA8k+k/H8zVY80PTk
 x9VO810ykfFn2SDSVI95WKKXv35cBal5SmqxnHdvhsFpfJysjQSh00fyW
 y17SI8eYOZZPGHW7oySLwpTDeWC9Zdye8WCw33GhcJt+weBgdzb/LJ57P A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10289"; a="255896186"
X-IronPort-AV: E=Sophos;i="5.90,191,1643702400"; d="scan'208";a="255896186"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Mar 2022 23:40:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,191,1643702400"; d="scan'208";a="691205037"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga001.fm.intel.com with ESMTP; 17 Mar 2022 23:40:30 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 17 Mar 2022 23:42:58 -0700
Message-Id: <20220318064300.1831909-12-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 11/13] drm/i915/guc: Pre-allocate output

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA35E57C3C
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jun 2019 08:32:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E61296E5AF;
	Thu, 27 Jun 2019 06:32:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 31B2389CAF
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Jun 2019 06:32:41 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17038749-1500050 
 for multiple; Thu, 27 Jun 2019 07:30:48 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Jun 2019 07:30:43 +0100
Message-Id: <20190627063044.11858-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 6/7] drm/i915: Protect request retirement with
 timeline->mutex
...
bmRleCBmZjhlYjNmYTNmYzYuLjJmNGM5Yzc4NmQ0NCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50
ZWxfbHJjLmMKQEAgLTE1MTEsNiArMTUxMSw3IEBAIHN0YXRpYyB2b2lkIGV4ZWNsaXN0c19jb250
...
cmluZ2J1ZmZlci5jCmluZGV4IDgxZjliMDQyMmU2YS4uYjc3MTE3MGViNTZhIDEwMDY0NAotLS0g
YS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9yaW5nYnVmZmVyLmMKKysrIGIvZHJpdmVy
cy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfcmluZ2J1ZmZlci5jCkBAIC0xMjI3LDcgKzEyMjcsNyBA
...
OTE1X3ZtYV91bnNldF9nZ3R0X3dyaXRlKHJpbmctPnZtYSk7CkBAIC0xMjkzLDcgKzEyOTMsNiBA
...
LTE4MTcsMjEgKzE4MTYsMjUgQEAgc3RhdGljIGludCByaW5nX3JlcXVlc3RfYWxsb2Moc3RydWN0
...
dC5jCmluZGV4IDViMWM2MzhkMzc1NC4uM2YzM2E3MjA4NWY2IDEwMDY0NAotLS0gYS9kcml2ZXJz
...

...

...


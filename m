...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D78E2577B99
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:40:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7E16DA9D9A;
...
Subject: [Intel-gfx] [PATCH v3 31/39] dyndbg: add write-events-to-tracefs
 code

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C5741618F1
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 03:35:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 23AE6899F0;
...
Subject: [Intel-gfx] [PATCH v7 7/9] drm/i915/gvt: GVTg handle shared_page
 setup

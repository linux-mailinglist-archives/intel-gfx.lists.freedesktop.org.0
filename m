...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C3EA56D4AEE
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Apr 2023 16:51:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3CF6910E4B8;
	Mon,  3 Apr 2023 14:51:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AD43E10E4B8;
 Mon,  3 Apr 2023 14:51:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680533481; x=1712069481;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=tJmprVDokhvXqhl4XiucxJmHG/IVIuB4LegZya8ZCts=;
 b=dyiEGif5z3K1GFhivmyiFTV9fykpj/Wwy1Da+myF0qxkDpSudOj6D+I3
 99Bl/G1W98sbuUFE8uPtXnWWFe9RIRGO05/DEjzH0p1+Vve7ZaeyKIsJA
 sUCzYguqt241XPvWh5eqFHf2C2K7Eoas9nkzm8bTmDwM9k+Ivpfyocpmx
 X2Q/cLl4zQstxOzcvPy+0NfqmKz/lcqfgGcM3aJGse0YKkPOKJLHqvoE6
 dsUY/vNQjA0HOK7OY5HYdCJ7kB8u5B3TfSTpaanRryPX+WJe7ZmDfCQGe
 eFB/E7BD7aX40If5DbDYuM/1jdQK/hZhQEtCr4njs3mL+ovy63TJ4LQaW g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10669"; a="344469678"
X-IronPort-AV: E=Sophos;i="5.98,314,1673942400"; d="scan'208";a="344469678"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2023 07:50:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10669"; a="685996184"
X-IronPort-AV: E=Sophos;i="5.98,314,1673942400"; d="scan'208";a="685996184"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.70])
 by orsmga002.jf.intel.com with SMTP; 03 Apr 2023 07:50:29 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Mon, 03 Apr 2023 17:50:28 +0300
Date: Mon, 3 Apr 2023 17:50:28 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: fei.yang@intel.com
Message-ID: <ZCrntC9f1E0MZlXa@intel.com>
...
In-Reply-To: <20230401063830.438127-6-fei.yang@intel.com>

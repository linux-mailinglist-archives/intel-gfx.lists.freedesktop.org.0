...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 26BB27A6BC8
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Sep 2023 21:49:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A41710E288;
	Tue, 19 Sep 2023 19:49:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C2A3810E1D9
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=MWX/jeDwvAWGA4FaonaKdY/eXq60DZB88zHK/5zgnNY=;
 b=ZaF+SPuwgr7hdfMWfvnjGaWZ850O7TzTjV5Kv3z4q7YdLR5EM1VmSZTx
 /kr/9PKeAbTK2DqFeCW6is5opY2oNbi7Hs5O/7Jh2azpwmHVWl5xf0PCn
 vC/s9QlyRnvoDXjyX3VViARZi4wMeVFpP+PV/bdG1ZhI8MGfpjc6T6mYT
 SZh8V/WplwIud3mSfVlzT+5bv+xsBYlYNTGET9ra5s1BU6wJFEc0IXtce
 DALrRG8zQejS118KAjfAtjmTWYf17fk3QmttQufXThr1wldpUXKSitG8x
 d6eY13VghWyhqLKKWyhgKfESUPMVutlDqGlq1oMM5ZeJDJonXrtFxtq/c A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="410968570"
X-IronPort-AV: E=Sophos;i="6.02,160,1688454000"; d="scan'208";a="410968570"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2023 12:49:39 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="749616778"
X-IronPort-AV: E=Sophos;i="6.02,160,1688454000"; d="scan'208";a="749616778"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2023 12:49:39 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 19 Sep 2023 12:38:56 -0700
Message-Id: <20230919193857.3391566-3-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 2/3] drm/i915: Add WABB blit for
...
index 147b6f44ad56d..30dcfbda1d448 100644
...
@@ -1384,12 +1404,85 @@ gen12_emit_indirect_ctx_xcs(const struct intel_context *ce, u32 *cs)
...
+	u32 * const start = context_wabb(ce, false);
 	...
 	cs = emit(ce, start);
@@ -1488,6 +1581,7 @@ u32 lrc_update_regs(const struct intel_context *ce,

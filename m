...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D25B5F57E9
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Oct 2022 18:00:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A72610E6C0;
	Wed,  5 Oct 2022 16:00:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 18F4D10E6BD;
 Wed,  5 Oct 2022 16:00:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664985601; x=1696521601;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=TZTQej28oyeUDOCZ5O8e2+S8gZaRbkKy6GqudUw3beo=;
 b=R8J/pP/U7yUiFN5DXKk9Gg05LqsEYifSOvaIGlp9kn4gTjL+rqzgR7CV
 s9Tyv0Os+9kPS7KtjA67s5SzGg03Mzn/fNrkAaiiMwM88lysI8nEpU9XU
 dxW1HMgkEpBTuaCuWSbTvjXSeqKQZMpwPL67ooIR8WyHlpi/bMoUU5yjQ
 X5jSyAAMNVaJg3689Zw1gpdCK9p0XD96+TAaXXeneBK0WFxovOFbwRWNp
 2FOB5kIkWvPf1AFZW0Jtx5Kqo9HjCuMNleG6oR1pKfyIHsK6Kl+ZxK616
 hjsO8OS5hzUkf+0IpiGIYtlcK8ms7yhwbOFnayctvbWhKKkkUUj/72DgA g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10491"; a="304177348"
X-IronPort-AV: E=Sophos;i="5.95,161,1661842800"; d="scan'208";a="304177348"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2022 09:00:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10491"; a="657549963"
X-IronPort-AV: E=Sophos;i="5.95,161,1661842800"; d="scan'208";a="657549963"
Received: from vbelgaum-ubuntu.fm.intel.com ([10.1.27.27])
 by orsmga001.jf.intel.com with ESMTP; 05 Oct 2022 09:00:00 -0700
From: Vinay Belgaumkar <vinay.belgaumkar@intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Wed,  5 Oct 2022 08:59:42 -0700
Message-Id: <20221005155943.34747-2-vinay.belgaumkar@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/2] drm/i915: Add a wrapper for frequency
 debugfs

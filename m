...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A9D027562C
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:23:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BB236E92A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 17/22] drm/vgem: Introduce GEM object
 functions

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFC762C6538
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:13:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49C8C6ECF2;
	Fri, 27 Nov 2020 12:11:10 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 113/162] drm/i915: Create stolen memory

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 230708CE347
	for <lists+intel-gfx@lfdr.de>; Fri, 24 May 2024 11:23:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 68F0D10E0B6;
	Fri, 24 May 2024 09:23:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="JI9OL/nK";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F3BAF10E0B6
 for <intel-gfx@lists.freedesktop.org>; Fri, 24 May 2024 09:23:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1716542608; x=1748078608;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=oW2Kt0kXLAp90gV/Md7Qi7szNeMHmZYOJKYz2bs4J5M=;
 b=JI9OL/nKtsnHnZZNkwSZk3UXW31RwsgY8/jaLd0tXOf+WyBq99sCAX/T
 SwncNAoKsEXbS56gX1bOC3Vi918oIWpgB0XIBgjExbuu2Acdw3AVTjNIm
 cneson67fEVdyb84Mjl/C4GSj6FljLq8GO0Cz4xwh6MZlGSMDmI8ZtabX
 itaQ2y2Dn9kpfHbOMoOTtfsBUh06wZWLM2nYCWCCm+I31XHCiQPk/Qhf8
 72AmweP7qvkdgaWZghL+XKRgph+vKvznnOb46XpDFFvi3EcWIBE7vNbsW
 bqCBUdPpS9ub2lEuu2+6rWD58m3ap03m5aB8/PhFoRWsMBbah3ZMJF3kq g==;
X-CSE-ConnectionGUID: +cnRkJRQQOikJzLnCmAkEw==
X-CSE-MsgGUID: 4pZN4o6KT5WAQ9IVo9zAQg==
X-IronPort-AV: E=McAfee;i="6600,9927,11081"; a="16739923"
X-IronPort-AV: E=Sophos;i="6.08,185,1712646000"; d="scan'208";a="16739923"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2024 02:23:26 -0700
X-CSE-ConnectionGUID: w+WSLFMsQsasNa8I5dF8Mw==
X-CSE-MsgGUID: 8cmiDN3oSIm4oIHD3FRJVA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,185,1712646000"; d="scan'208";a="57204375"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2024 02:23:24 -0700
Date: Fri, 24 May 2024 12:23:14 +0300
From: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Cc: intel-gfx@lists.freedesktop.org, jani.saarinen@intel.com
Subject: Re: [PATCH 2/5] drm/i915: Implement basic functions for ultrajoiner
 support
Message-ID: <ZlBcgtUiHU2305mJ@intel.com>
References: <20240520073839.23881-1-stanislav.lisovskiy@intel.com>
 ...
 <Zk3ZyJyA5hx8L3PB@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <Zk3ZyJyA5hx8L3PB@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 709CF329D80
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Mar 2021 13:00:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 936606E930;
	Tue,  2 Mar 2021 12:00:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 30D246E92F
 for <intel-gfx@lists.freedesktop.org>; Tue,  2 Mar 2021 12:00:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1614686450;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=vMB5sZOVOXItUMnQyuAgNzh/55BK52eFL7O0INCVrf0=;
 b=VpSLo4lN18Jc/PFIcLHv2zcf4Y9ssdr6QR2MSVoxJp5WxYfu7ZlLwMmZ7rse0iRNoO1Yoh
 l4J8bSLMeRqJrit7MjIoP1zezXD0TNh8Xhc+mmsARlW32MUwcOUU0FByS3YP7SlCBL83vW
 +t8q8R5d7pT798gYh7rva3dCJygwNgA=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-569-Ht2ZKcO_PTixM_TTrkr_qg-1; Tue, 02 Mar 2021 07:00:48 -0500
X-MC-Unique: Ht2ZKcO_PTixM_TTrkr_qg-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com
 [10.5.11.15])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 14A53801982;
 Tue,  2 Mar 2021 12:00:47 +0000 (UTC)
Received: from x1.localdomain.com (ovpn-115-7.ams2.redhat.com [10.36.115.7])
 by smtp.corp.redhat.com (Postfix) with ESMTP id AABDC5D722;
...
Date: Tue,  2 Mar 2021 13:00:40 +0100
Message-Id: <20210302120040.94435-3-hdegoede@redhat.com>
...
Subject: [Intel-gfx] [PATCH resend 2/2] drm/i915/display: Make

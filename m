...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A0546C999
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jul 2019 09:00:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C8686E321;
	Thu, 18 Jul 2019 07:00:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 944116E312
 for <intel-gfx@lists.freedesktop.org>; Thu, 18 Jul 2019 07:00:41 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17390394-1500050 
 for multiple; Thu, 18 Jul 2019 08:00:38 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 18 Jul 2019 08:00:19 +0100
Message-Id: <20190718070024.21781-15-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 15/20] drm/i915/gt: Convert timeline tracking to
 spinlock
...
bmRleCA1NWUyZGRjYmQyMTUuLjdkMTk1YTVmN2RhMyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZ3QvaW50ZWxfcmVzZXQuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9p
bnRlbF9yZXNldC5jCkBAIC04MTMsNyArODEzLDcgQEAgc3RhdGljIGJvb2wgX19pbnRlbF9ndF91
...
IAkJc3RydWN0IGk5MTVfcmVxdWVzdCAqcnE7CiAKQEAgLTgyMSw2ICs4MjEsOCBAQCBzdGF0aWMg
...
IHN0dWNrIHdhaXRpbmcKQEAgLTgzMCw4ICs4MzIsMTIgQEAgc3RhdGljIGJvb2wgX19pbnRlbF9n

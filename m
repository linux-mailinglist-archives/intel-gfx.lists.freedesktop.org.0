...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 31C057074E4
	for <lists+intel-gfx@lfdr.de>; Thu, 18 May 2023 00:01:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F83810E2C9;
	Wed, 17 May 2023 22:01:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C75C410E2C1
 for <intel-gfx@lists.freedesktop.org>; Wed, 17 May 2023 22:01:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1684360898;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=HG/rceSfXoWbIlm6Cl/pPVb/WvTeG1OA3/AKdOuyr2M=;
 b=UBmuQ6hLU8hfJKKLAgklQWgxLEr9Z7XdkftlflAQ/zJAcs6RONYn1R3A0n2U0vCjAacbsX
 IHY3lfd7D7GKf1Tn37DOjsvoVK+g4hM01sDN0n5/DsIDdTWwqyiEmaQyQi9aPTPF6FAuuA
 7aRPgr0PatV5RdwKw9xTVbab1njcBig=
Received: from mail-io1-f70.google.com (mail-io1-f70.google.com
 [209.85.166.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-536-iwcLBEgMMXeNo46Zysv7YA-1; Wed, 17 May 2023 18:01:35 -0400
X-MC-Unique: iwcLBEgMMXeNo46Zysv7YA-1
Received: by mail-io1-f70.google.com with SMTP id
 ca18e2360f4ac-76ce93a10f3so91285439f.0
 for <intel-gfx@lists.freedesktop.org>; Wed, 17 May 2023 15:01:35 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=HG/rceSfXoWbIlm6Cl/pPVb/WvTeG1OA3/AKdOuyr2M=;
 b=
X-Gm-Message-State: AC+VfDy2g/fD35cxLGg4iMXBU7eEL+u6IVNp1dkEgbA4GEsnZLju6Kq5
 sfjATHCAlb8guk1LjEVjjxYFkSUuDENJ0iA4v+NfRNCjwsgjxaJkZlVR7j4UkRPzTm98u9J6ggw
 O9sHmF9ERH9WnCSn9x1/RNyM/lc2V
X-Received: by 2002:a5d:8558:0:b0:763:a8a0:c7c0 with SMTP id
 b24-20020a5d8558000000b00763a8a0c7c0mr5096039ios.10.1684360894637; 

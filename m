...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FA5E62800E
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 14:03:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A604D10E2C3;
...
Subject: [Intel-gfx] [PATCH v9 21/25] drm/vc4: vec: Use TV Reset
 implementation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E57C9482FB
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jun 2019 14:51:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FD938921E;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [RESEND FOR CI] i915: no need to check return value

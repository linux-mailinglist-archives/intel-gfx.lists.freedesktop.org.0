...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C066E5AEE84
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Sep 2022 17:21:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5DCCC10E6B3;
	Tue,  6 Sep 2022 15:21:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x634.google.com (mail-ej1-x634.google.com
 [IPv6:2a00:1450:4864:20::634])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 864C110E6C8
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Sep 2022 15:21:03 +0000 (UTC)
Received: by mail-ej1-x634.google.com with SMTP id gh9so2172227ejc.8
 for <intel-gfx@lists.freedesktop.org>; Tue, 06 Sep 2022 08:21:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=in-reply-to:content-transfer-encoding:content-disposition
 :mime-version:references:message-id:subject:cc:to:from:date:from:to
 :cc:subject:date;
 bh=BIph1DufPU5JL4YtqB3Fmqc7o4955sxod6ypEJrv5HY=;
 b=YKvKg6CMr7DF72d3J81NSUF7MDqt9NlFG8nJX1IkZYB4b4cIvh2OzCkwvR9BHo1vMj
 WLhCmb9/gBJ5NYPr8KVVYqAMFpeMtJ1+TLbsPcbYokFBabS9TJ94CycGkj6BDDmWrCbQ
 DbreSz0TUtJeodoufotY58mhRIcKXV94SSiCM=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=BIph1DufPU5JL4YtqB3Fmqc7o4955sxod6ypEJrv5HY=;
 b=
X-Gm-Message-State: ACgBeo1Ergo5Ixild4AMvWRGw8leN4KwMGyyBjjBsepSseW708zWJ2FL
 GIWAg733Xs0wBZKbtGUsH64V5A==
X-Google-Smtp-Source: AA6agR7Uf3/PE/fmLhCDx0t65DTDDUFOeTqlTMGxT2oBwGajcx745qWQsqKf02H97PJ7greKJvGJCA==
X-Received: by 2002:a17:907:8a1e:b0:731:39b9:e00c with SMTP id
 sc30-20020a1709078a1e00b0073139b9e00cmr40624761ejc.65.1662477661386; 
 Tue, 06 Sep 2022 08:21:01 -0700 (PDT)
Received: from phenom.ffwll.local (212-51-149-33.fiber7.init7.net.
 [212.51.149.33]) by smtp.gmail.com with ESMTPSA id
 10-20020a170906218a00b0073ddfe1ea69sm6816637eju.111.2022.09.06.08.21.00
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 06 Sep 2022 08:21:00 -0700 (PDT)
Date: Tue, 6 Sep 2022 17:20:58 +0200
From: Daniel Vetter <daniel@ffwll.ch>
To: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
Message-ID: <YxdlWvYLFX0hDU9E@phenom.ffwll.local>
References: <f0c71766-61e8-19b7-763a-5fbcdefc633d@linux.intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6967E25C03D
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Sep 2020 13:24:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 206766E9CD;
	Thu,  3 Sep 2020 11:24:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
 [205.139.110.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E303B6E9C8
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Sep 2020 11:24:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1599132291;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=yBZnW0uEhs9/IogdfbWxz1WbKxUqUn2zepvhTOAX9YU=;
 b=DSlh9/gECHMIm0+0YFuDsRSGIn8/VbBhaZUaRmzLOJZIJC+kzfu7buZ81+L3s3DglVmBAN
 g0uYPfczsQWHnMaxuZWQ+o8tR1GJpnFR/a2IbHwCEA/AxamTVAscoNonZGHKYQkzHtqcO+
 8W4SubG6+UNGp0axV/NLjV42yW8/vy0=
...
Subject: [Intel-gfx] [PATCH v10 16/17] drm/i915: panel: Honor the VBT PWM
 min setting for devs with an external PWM controller

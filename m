...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D61652AAED
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 20:32:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D870910F481;
...
Subject: [Intel-gfx] [RFC v3 1/3] drm/doc/rfc: VM_BIND feature design
 document

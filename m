...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD22464688C
	for <lists+intel-gfx@lfdr.de>; Thu,  8 Dec 2022 06:24:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 50FCA10E459;
	Thu,  8 Dec 2022 05:24:08 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 2/6] drm/i915/gsc: Skip the version check

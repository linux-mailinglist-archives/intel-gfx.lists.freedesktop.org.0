...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7CF229C8E2
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Oct 2020 20:28:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B4516EC2B;
	Tue, 27 Oct 2020 19:28:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 952186EC22
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Oct 2020 19:28:47 +0000 (UTC)
IronPort-SDR: 7pksFFcM9PfFQE84yGcw2MIphC/Z65AtclVW33KIXfrBoaluQXp/uIBvbCFrSE/aBNz/o+HG1U
 PY2q96Mz0I6w==
X-IronPort-AV: E=McAfee;i="6000,8403,9787"; a="147433128"
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="147433128"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2020 12:28:46 -0700
IronPort-SDR: xlP3dXscJAgkOvM3vJpbtd9oElXib7lQhxutvRnzRFCeicsFMFmDUYXRaL4lBUSM7TJ0oEssrH
 1TWEttdLx33Q==
X-IronPort-AV: E=Sophos;i="5.77,424,1596524400"; d="scan'208";a="318338887"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 27 Oct 2020 12:28:46 -0700
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 27 Oct 2020 12:30:30 -0700
Message-Id: <20201027193034.28721-2-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/5] drm/i915: Add hw.pipe_mode to allow
...
@@ -12821,15 +12819,15 @@ static bool c8_planes_changed(const struct intel_crtc_state *new_crtc_state)
...
@@ -13459,8 +13457,9 @@ intel_crtc_copy_uapi_to_hw_state(struct intel_crtc_state *crtc_state)
...
@@ -13563,7 +13562,7 @@ intel_modeset_pipe_config(struct intel_crtc_state *pipe_config)
...
@@ -13657,6 +13656,9 @@ intel_modeset_pipe_config(struct intel_crtc_state *pipe_config)
...
@@ -18914,6 +18916,9 @@ static void intel_modeset_readout_hw_state(struct drm_device *dev)
 			 */

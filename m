...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D95F3E20E3
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Aug 2021 03:21:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36CA76EB65;
...
Subject: [Intel-gfx] [PATCH v4 14/14] vfio: Remove struct vfio_device_ops
 open/release

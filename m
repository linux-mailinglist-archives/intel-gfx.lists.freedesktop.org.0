...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 742AB6F649C
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 08:01:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 946F610E215;
...
Subject: Re: [Intel-gfx] [PATCH v3 3/4] drm/i915/gsc: add initial support
 for GSC proxy

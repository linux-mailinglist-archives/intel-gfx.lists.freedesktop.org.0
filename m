...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 77CE02A426B
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Nov 2020 11:34:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF17289A8B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch V3 37/37] io-mapping: Remove

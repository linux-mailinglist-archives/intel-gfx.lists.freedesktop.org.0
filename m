...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B24D534990E
	for <lists+intel-gfx@lfdr.de>; Thu, 25 Mar 2021 19:07:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8CC166EE03;
	Thu, 25 Mar 2021 18:07:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A84366EE34
 for <intel-gfx@lists.freedesktop.org>; Thu, 25 Mar 2021 18:07:34 +0000 (UTC)
IronPort-SDR: 9ExqtYYG1jyDBehfza/2uMLGrXAogAdmB3T62pMmJ/JpmbNY9qsrnAn58+vT+Wa1VGM5aS2nE+
 oSaYbB94J3bg==
X-IronPort-AV: E=McAfee;i="6000,8403,9934"; a="178112560"
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="178112560"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:34 -0700
IronPort-SDR: RrY1PXjFJpu8/YE5/Stu2YXZzRwq8rSbSfIHutI+R4KWc0AedT0Uj4rkfUJm4PdlGuWtx2QvjG
 9mcBB5d7qP1w==
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="453176700"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.168])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:34 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 25 Mar 2021 11:07:06 -0700
Message-Id: <20210325180720.401410-37-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 36/50] drm/i915/adl_p: Add initial ADL_P
 Workarounds
...
CmluZGV4IDFhZTE1OGQxMmMwNy4uMjY4ZWNmMWMwMDBmIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dw
...
NGI2OWVkZTM0ODVkLi42ZDQ0OWY0OTRlNDMgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9p
...
QkxFOwpAQCAtNjI1LDcgKzYyNSw3IEBAIHUzMiAqZ2VuMTJfZW1pdF9maW5pX2JyZWFkY3J1bWJf
...
bnRlbF93b3JrYXJvdW5kcy5jCmluZGV4IGJiMjM1NzExOTc5Mi4uZDMxNjdmZjRjYTZiIDEwMDY0
...
L2k5MTUvaW50ZWxfcG0uYwppbmRleCA2MGQ3ZGYxYWMzNjIuLmIyMmFmNDc3NGVmMCAxMDA2NDQK
LS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaW50ZWxfcG0uYworKysgYi9kcml2ZXJzL2dwdS9k
cm0vaTkxNS9pbnRlbF9wbS5jCkBAIC03MzY4LDE1ICs3MzY4LDE3IEBAIHN0YXRpYyB2b2lkIGlj

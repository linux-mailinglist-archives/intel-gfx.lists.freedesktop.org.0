...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1898C6E5D5
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Jul 2019 14:40:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 551816E824;
	Fri, 19 Jul 2019 12:39:59 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH -next] drm/i915/icl: Remove set but not used
 variable 'src_y'

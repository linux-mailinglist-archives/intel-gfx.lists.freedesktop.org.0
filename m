...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E00DE6F8C45
	for <lists+intel-gfx@lfdr.de>; Sat,  6 May 2023 00:11:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01BBB10E0C5;
	Fri,  5 May 2023 22:11:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6680B10E0C5
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 May 2023 22:11:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683324705; x=1714860705;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=Zbrn+YxldU2klEALX5p/NOXWnfqhp89CtmxYA6hpOq8=;
 b=miwvMvc0k1sNVZvvYzajAjo7FuMFOw3RwCt1qNKN1cWCrFGfUhTbbRhM
 vmCnEfes7jjfywgqgWdiUzNeWXLvcf/1sFsogfO/O083rf7TTfA0NSUTW
 hyu8sTbHmjsAFVBLg/3afHJcCk19mr0ukIt9qpRUN69dz8ONAWh8NfSOZ
 100ToFSpY5tfZPZDV7Gns5NKzFUjfoUM8+Abuw1wLhAfJr1JRHjsX1PNd
 GpUnQl/I2IdKuZFtPtRUHRb5Vcrod+HfhRb8ufSl1p1F0si3q4nXNFTcl
 bqmxd12jDiJ+IOTHZg2zvCr+oAx11sOKeGsAr9p3NN1ppSBry01pROUhU w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10701"; a="352357647"
X-IronPort-AV: E=Sophos;i="5.99,253,1677571200"; d="scan'208";a="352357647"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2023 15:11:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10701"; a="728271534"
X-IronPort-AV: E=Sophos;i="5.99,253,1677571200"; d="scan'208";a="728271534"
Received: from unknown (HELO ideak-desk.fi.intel.com) ([10.237.72.78])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2023 15:11:42 -0700
Date: Sat, 6 May 2023 01:12:13 +0300
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Message-ID: <ZFV/Pe5zyJPA4fY9@ideak-desk.fi.intel.com>
References: <20230503231048.432368-13-imre.deak@intel.com>
 <20230505204611.682946-8-imre.deak@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20230505204611.682946-8-imre.deak@intel.com>
Subject: Re: [Intel-gfx] [PATCH v3 12/12] drm/i915/tc: Reset TypeC PHYs left

...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/7] drm/i915/gt: Expose busywait duration to
 sysfs
...
index d53af93b919b..de010d1d71ec 100644
--- a/drivers/gpu/drm/i915/i915_request.c
+++ b/drivers/gpu/drm/i915/i915_request.c
@@ -1389,7 +1389,7 @@ void i915_request_add(struct i915_request *rq)
...
@@ -1406,7 +1406,7 @@ static unsigned long local_clock_us(unsigned int *cpu)
...
+	t = local_clock();
 	...
 	return t;
@@ -1416,15 +1416,15 @@ static bool busywait_stop(unsigned long timeout, unsigned int cpu)
 {
...
+	unsigned long timeout_ns;
 	...
 	/*
@@ -1452,7 +1452,8 @@ static bool __i915_spin_request(const struct i915_request * const rq,
...
+	timeout_ns += local_clock_ns(&cpu);
 	do {
 		if (i915_request_completed(rq))
 			return true;
@@ -1460,7 +1461,7 @@ static bool __i915_spin_request(const struct i915_request * const rq,
...
+		if (busywait_stop(timeout_ns, cpu))
 		...
 		cpu_relax();
@@ -1546,8 +1547,8 @@ long i915_request_wait(struct i915_request *rq,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FA211BC05A
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Apr 2020 15:57:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F07376E3F9;
	Tue, 28 Apr 2020 13:57:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CAFE58935B
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Apr 2020 13:56:59 +0000 (UTC)
IronPort-SDR: B0LCRhT9uyTau2C7ZKVClGS7PTCEmlGMA34BlklhwJ07qZNCtvWSezfJVxM2jtBR54wt0OS+bq
 xB+cCgU7OvYA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Apr 2020 06:56:59 -0700
IronPort-SDR: sxNgv1bRT7WqOxWV4lFF+5/1qCEY7b3dk06lCsrTLIfArYONrL5MAraaIzTMN8nnkEzfDI3TMD
 8/u5sKZO9iEw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,327,1583222400"; d="scan'208";a="459240103"
Received: from pbooyens-mobl1.ger.corp.intel.com (HELO
 delly.ger.corp.intel.com) ([10.252.37.143])
 by fmsmga006.fm.intel.com with ESMTP; 28 Apr 2020 06:56:58 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 28 Apr 2020 16:56:48 +0300
Message-Id: <20200428135650.956161-3-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 2/4] drm/i915/perf: stop using the kernel
 context

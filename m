...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9F5452F5F1
	for <lists+intel-gfx@lfdr.de>; Sat, 21 May 2022 01:04:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D22BF10EB8E;
...
Subject: [Intel-gfx] [PATCH v4 2/6] drm/i915/xehp: Drop GETPARAM lookups of

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1CE65CB998B
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Dec 2025 19:45:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 943CA10E090;
	Fri, 12 Dec 2025 18:45:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="WovFfU3q";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5172C10E090;
 Fri, 12 Dec 2025 18:45:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1765565143; x=1797101143;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=UhXq1Up/zfsYcUHE1TSOJz5tAaESIqsgggpPg2jMlms=;
 b=WovFfU3qBM4lBbbKPQLYhn5uEVUDpyB/abbKmMirbroBH6sVNqdKCzx8
 YEnxUmrEYLc8E5y39TdCnniM6X8Y+vmQF1p1ndvZUgjKo4G9hwS5z512y
 gjqCpnrbtZSq+xNT9l9qQJX3l/wAuVW1JbXOW8B5fvCiU7QfB+7TVdAKS
 LcVTzalBOs3tWAZONdwq8Gll3sT6qAXpMipK5NS+s1YBnOlTBGfmS43c2
 qGedDhsRU9LSUkSfdtgz8DNOSH+29cNlV8Z26+PeMDrQ+sQdmlgishdfr
 tZ6+lQPr8c8d4Cq46VfTefLQ5gm80bbfl8kk7J3tl1oddnZ5UiA+oJjIU Q==;
X-CSE-ConnectionGUID: Gg2iyyetTXG9ImgBuKFcuA==
X-CSE-MsgGUID: J1dwF52STDCV4tmxjNbVxg==
X-IronPort-AV: E=McAfee;i="6800,10657,11640"; a="67610622"
X-IronPort-AV: E=Sophos;i="6.21,144,1763452800"; d="scan'208";a="67610622"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Dec 2025 10:45:43 -0800
X-CSE-ConnectionGUID: JJedukN3QmG0yyjz0Z4Fag==
X-CSE-MsgGUID: LDDQFR6qRyS+8+P3MdsnUw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,144,1763452800"; d="scan'208";a="201573591"
Received: from egrumbac-mobl6.ger.corp.intel.com (HELO localhost)
 ([10.245.245.152])
 by fmviesa005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Dec 2025 10:45:39 -0800
Date: Fri, 12 Dec 2025 20:45:36 +0200
...
Message-ID: <aTxi0OvIyTXjiUZ7@intel.com>
References: <20251203085211.3663374-1-uma.shankar@intel.com>
 ...
 <f24364ad-a861-4fcd-93ab-3230a6b3299b@intel.com>
MIME-Version: 1.0

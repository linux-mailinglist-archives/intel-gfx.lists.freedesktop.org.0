...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C157A6D09F5
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Mar 2023 17:40:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B8B3A10EEE7;
	Thu, 30 Mar 2023 15:40:33 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 05/12] drm/amdgpu: remove
 amdgpu_connector_edid() and stop using edid_blob_ptr

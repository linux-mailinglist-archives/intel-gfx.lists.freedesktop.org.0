...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73A584CC4C7
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Mar 2022 19:12:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8591A10EB58;
...
Subject: [Intel-gfx] [PATCH v2 7/7] drm/i915: Avoid dereferencing io mapped
 memory

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 27ABB2E9F15
	for <lists+intel-gfx@lfdr.de>; Mon,  4 Jan 2021 21:56:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 345D46E04E;
	Mon,  4 Jan 2021 20:56:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1DE216E04E
 for <intel-gfx@lists.freedesktop.org>; Mon,  4 Jan 2021 20:56:15 +0000 (UTC)
IronPort-SDR: x+35Lz14yPYSeo7rKwl71CpeFTIjowYBlQrgumIBSPLrM28VZXfv5LEjZDMF8yy4smxijI25cL
 Cp9tqFAtx4mg==
X-IronPort-AV: E=McAfee;i="6000,8403,9854"; a="177161474"
X-IronPort-AV: E=Sophos;i="5.78,474,1599548400"; d="scan'208";a="177161474"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jan 2021 12:56:14 -0800
IronPort-SDR: 12r9fGF7n8o4c8j9hwvWP9GeY7dRpE4cgkjukd9n2CloxMWoXAgxFeaehPHx+WJ05W0F67yk+B
 Cl4iL2bVsXIA==
X-IronPort-AV: E=Sophos;i="5.78,474,1599548400"; d="scan'208";a="421501162"
Received: from yche108-mobl.amr.corp.intel.com (HELO josouza-mobl2.intel.com)
 ([10.251.138.25])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jan 2021 12:56:12 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  4 Jan 2021 12:56:53 -0800
Message-Id: <20210104205654.238928-3-jose.souza@intel.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <20210104205654.238928-1-jose.souza@intel.com>
References: <20210104205654.238928-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH CI 3/4] drm/i915/display: Split and export main
...
bmRleCBmMmM0OGU1Y2RiNDMuLjAxODlkMzc5YTU1ZSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKQEAgLTM3NTIsMzMgKzM3NTIsMTkgQEAgc3RhdGlj
...
bWVudCkpKQogCQlyZXR1cm4gLUVJTlZBTDsKIApAQCAtMzc4Nyw5ICszNzczLDEwIEBAIHN0YXRp
...
IC0zODAwLDE4ICszNzg3LDUxIEBAIHN0YXRpYyBpbnQgc2tsX2NoZWNrX21haW5fc3VyZmFjZShz
...
YXkuaAppbmRleCBmN2U0OWEzOWJkOTIuLjdkZGJjMDBhMGY0MSAxMDA2NDQKLS0tIGEvZHJpdmVy
...


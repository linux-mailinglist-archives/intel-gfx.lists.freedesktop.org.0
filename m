...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 81D532E7046
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Dec 2020 13:02:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67BEF89339;
	Tue, 29 Dec 2020 12:02:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E7FF389023
 for <intel-gfx@lists.freedesktop.org>; Tue, 29 Dec 2020 12:02:01 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23455199-1500050 
 for multiple; Tue, 29 Dec 2020 12:01:53 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 29 Dec 2020 12:01:28 +0000
Message-Id: <20201229120145.26045-39-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 39/56] drm/i915/gt: Support virtual engine queues
...
---
 .../drm/i915/gt/intel_execlists_submission.c  | 397 +++++++++---------
 drivers/gpu/drm/i915/i915_request.c           |   3 +-
 drivers/gpu/drm/i915/i915_scheduler.c         |  65 ++-
 drivers/gpu/drm/i915/i915_scheduler.h         |   4 +-
 4 files changed, 261 insertions(+), 208 deletions(-)

diff --git a/drivers/gpu/drm/i915/gt/intel_execlists_submission.c b/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
index 3aac8dac5518..6d5a5e881335 100644
...
@@ -507,9 +514,11 @@ static inline void execlists_schedule_in(struct i915_request *rq, int idx)
 }
...
@@ -524,12 +533,42 @@ resubmit_virtual_request(struct i915_request *rq, struct virtual_engine *ve)
...
@@ -549,7 +588,7 @@ static void kick_siblings(struct i915_request *rq, struct intel_context *ce)
...
@@ -900,10 +939,16 @@ static bool ctx_single_port_submission(const struct intel_context *ce)
...
@@ -952,6 +997,9 @@ static bool virtual_matches(const struct virtual_engine *ve,
 {
...
@@ -971,31 +1019,6 @@ static bool virtual_matches(const struct virtual_engine *ve,
 	return true;
 }
...
-
 static void virtual_xfer_context(struct virtual_engine *ve,
 				 struct intel_engine_cs *engine)
 {
@@ -1159,15 +1182,124 @@ static bool completed(const struct i915_request *rq)
...
-	struct rb_node *rb;
 	...
 	/*
@@ -1285,85 +1417,8 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 		}
 	}
...
@@ -1371,6 +1426,8 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -2703,13 +2760,11 @@ static void execlists_reset_cancel(struct intel_engine_cs *engine)
 		RB_CLEAR_NODE(rb);
...
@@ -2943,11 +2998,6 @@ int intel_execlists_submission_setup(struct intel_engine_cs *engine)
 	return 0;
 }
...
-
 ...
 {
 	struct virtual_engine *ve =
@@ -2957,17 +3007,13 @@ static void rcu_virtual_context_destroy(struct work_struct *wrk)
...
@@ -2998,7 +3044,6 @@ static void rcu_virtual_context_destroy(struct work_struct *wrk)
...
@@ -3121,7 +3166,9 @@ virtual_submission_mask(struct virtual_engine *ve, u64 *deadline)
 	struct i915_request *rq;
...
@@ -3161,9 +3208,6 @@ static void virtual_submission_tasklet(unsigned long data)
 		struct rb_node **parent, *rb;
 		bool first;
...
@@ -3225,45 +3269,6 @@ static void virtual_submission_tasklet(unsigned long data)
 	}
 }
...
@@ -3351,10 +3356,9 @@ intel_execlists_create_virtual(struct intel_engine_cs **siblings,
...
-	INIT_LIST_HEAD(virtual_queue(ve));
 	tasklet_init(&ve->base.active.tasklet,
 		     ...
 		     (unsigned long)ve);
@@ -3562,14 +3566,17 @@ void intel_execlists_show_requests(struct intel_engine_cs *engine,
...
index 18058267040e..ecb186fba49d 100644
--- a/drivers/gpu/drm/i915/i915_scheduler.c
+++ b/drivers/gpu/drm/i915/i915_scheduler.c
@@ -580,7 +580,7 @@ static u64 virtual_deadline(u64 kt, int priority)
...
@@ -821,20 +821,17 @@ bool __intel_engine_queue_request(struct intel_engine_cs *engine,
...
@@ -902,6 +899,14 @@ void __intel_engine_defer_request(struct intel_engine_cs *engine,
 	}
 }
...
@@ -935,6 +940,46 @@ static bool ancestor_on_hold(const struct intel_engine_cs *engine,
...
+
 ...
 {
 	struct intel_engine_cs *engine = rq->engine;
@@ -985,9 +1030,9 @@ __intel_engine_rewind_requests(struct intel_engine_cs *engine)
...
index df0f1993b3b8..da17faa883a9 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CB6561F96C5
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Jun 2020 14:40:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28D866E317;
	Mon, 15 Jun 2020 12:40:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D630E6E317
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Jun 2020 12:39:58 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21501019-1500050 
 for multiple; Mon, 15 Jun 2020 13:39:22 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 15 Jun 2020 13:39:20 +0100
Message-Id: <20200615123920.17749-10-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/10] drm/i915/gt: Resubmit the virtual engine
 on schedule-out
...
+		active = rq;
 	...
 	return active;
@@ -1406,12 +1376,49 @@ execlists_schedule_in(struct i915_request *rq, int idx)

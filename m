...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 30870394179
	for <lists+intel-gfx@lfdr.de>; Fri, 28 May 2021 12:58:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C38F6F472;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 05/15] drm/i915/ttm: Embed a ttm buffer

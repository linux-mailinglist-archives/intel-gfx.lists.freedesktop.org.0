...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BEF1B5B300A
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:36:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9FF4E10EBF0;
...
Subject: [Intel-gfx] [PATCH v3 07/37] drm/i915: i915_gem_ttm: fix a
 kernel-doc markup

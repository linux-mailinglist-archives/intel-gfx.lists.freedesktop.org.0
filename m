...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A06D02C9FA8
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Dec 2020 11:36:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0FB426E856;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 10/20] drm/i915/gt: Remove references to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B1A61461730
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Nov 2021 14:57:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DA226EDD1;
...
Subject: [Intel-gfx] [PATCH v2 07/16] drm/i915: Take trylock during eviction, v2.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 54A00848E70
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Feb 2024 15:27:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFB891121DA;
	Sun,  4 Feb 2024 14:27:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="In7R1OyH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D63501121D9
 for <intel-gfx@lists.freedesktop.org>; Sun,  4 Feb 2024 14:27:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1707056843; x=1738592843;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ZsatCKRGIt9BcWWWAmrsrGGnT+Z82IRwdjTfCE+zs4E=;
 b=In7R1OyHqq+fWzrRxZKxt6SSAVyLlzYo+vmPulBf04tuZHy7VcsVq5Au
 FeVRaEdE2YDFxTsdQ9yQTrkpvjSRqatOQwEZVliGJ8emj6BI5aWj/X7wQ
 jCV15RaadcWFCl7Uc4Rnm3C0zLtN7q5W54FKa+jFC2vY5Z4sGPlqYWyS0
 /iJjS+C7evCN6CFiZ3/cTrHMKrll/k+tYndCHPLK1DGO9Bs/yvhQx5uSw
 T115GJZ7i7xbDPojmVhAsrCy3TUWsNaI/uvRnPgOJrsnstx7HWGOBXYxm
 DI/W7AHD9JVuHrtU1n0QECkrkUunOtge3yJ2QjKZ4ohuqed7VbZK3koh5 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10973"; a="17920791"
X-IronPort-AV: E=Sophos;i="6.05,242,1701158400"; d="scan'208";a="17920791"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2024 06:27:22 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,242,1701158400"; d="scan'208";a="31605291"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmviesa001.fm.intel.com with ESMTP; 04 Feb 2024 06:27:21 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: uma.shankar@intel.com, ankit.k.nautiyal@intel.com,
 Suraj Kandpal <suraj.kandpal@intel.com>
Subject: [PATCH 10/11] drm/i915/hdcp: Allocate stream id after HDCP AKE stage
Date: Sun,  4 Feb 2024 19:55:04 +0530
Message-Id: <20240204142505.1157146-11-suraj.kandpal@intel.com>

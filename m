...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D3B7E3300A
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Jun 2019 14:44:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8299589272;
...
Subject: [Intel-gfx] [v2 3/3] video/hdmi: Dropped static functions from
 kernel doc

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F652A1A7D7
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2025 17:27:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A93C110E880;
	Thu, 23 Jan 2025 16:27:37 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="H7MI0zZi";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3960B10E880
 for <intel-gfx@lists.freedesktop.org>; Thu, 23 Jan 2025 16:27:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1737649656; x=1769185656;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=6zhs8qJMRDNPwkkze/DqRB4UVWbugRujWhHTqvut4j0=;
 b=H7MI0zZip9V3BFVKOjwNHPehNYqaCzce43J1LIcsCRbmobcXL8BeXTlV
 T/BkxwOL3W2B9H46NjP2kpHhseuxClbEW9bbqTXzUZ8lc71L8/Z+SaGjU
 IXM5KhjwPyuEBoj3BCLceQ4AvLLTXAFHF+j67haHTWscP6jjfk2aswtWs
 135jlMzIZMJFzyk903cfgrhhN3WNPi4jqn32V3OoNPTwAo4yivlgickDY
 j2U892+EY8Q6Ciawy6bGNaTyT/vDhgZEbcggux+rMnxmUYgYq98D/Took
 Qc72iru8cOz7cRie53wnJPUbVqGDie2oxSHg9MoCbrqrPfbCMnBOAG7qt A==;
X-CSE-ConnectionGUID: XqDkhRi1RqabGtajMUxP+A==
X-CSE-MsgGUID: rtYsGZueTs26m6S2Wmd0dw==
X-IronPort-AV: E=McAfee;i="6700,10204,11324"; a="60628013"
X-IronPort-AV: E=Sophos;i="6.13,228,1732608000"; d="scan'208";a="60628013"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jan 2025 08:27:36 -0800
X-CSE-ConnectionGUID: hWsRsMIYSXOsR7QOfbo15w==
X-CSE-MsgGUID: wWe0vl8JRRun1ZiGLwIMdA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,228,1732608000"; d="scan'208";a="107315809"
Received: from ldmartin-desk2.corp.intel.com (HELO ldmartin-desk2)
 ([10.125.110.196])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jan 2025 08:27:36 -0800
Date: Thu, 23 Jan 2025 10:27:29 -0600
...
Message-ID: <3g4bxt5ehrhuyxz7y35h2znym55aufixjpzvytnfdehhg5edkm@bol7omhcgchg>
...
In-Reply-To: <c7e1fc84-5cbf-4196-8558-bc410ef378a8@ursulin.net>

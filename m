...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF9C53FC374
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Aug 2021 09:25:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 289B389C05;
	Tue, 31 Aug 2021 07:25:44 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v10 2/4] drm: convert drm_device.master_mutex
 into a rwsem

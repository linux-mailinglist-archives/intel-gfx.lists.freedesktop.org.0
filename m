...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFB64375AA3
	for <lists+intel-gfx@lfdr.de>; Thu,  6 May 2021 20:58:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2E7E56ED9D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 05/97] drm/i915/guc: use probe_error log for
 CT enablement failure

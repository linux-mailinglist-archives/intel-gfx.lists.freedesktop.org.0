...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 44450CBCF1
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Oct 2019 16:19:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 645FD6EBB0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/4] drm/edid: Prep for HDMI VIC aspect ratio
 (WIP)

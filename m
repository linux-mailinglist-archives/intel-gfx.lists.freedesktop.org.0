...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 103CF8A4D4
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Aug 2019 19:48:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B2146E593;
	Mon, 12 Aug 2019 17:48:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EA5BC6E58F
 for <intel-gfx@lists.freedesktop.org>; Mon, 12 Aug 2019 17:48:07 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17973031-1500050 
 for <intel-gfx@lists.freedesktop.org>; Mon, 12 Aug 2019 18:48:05 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 12 Aug 2019 18:48:03 +0100
Message-Id: <20190812174804.26180-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.23.0.rc1
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 1/2] drm/i915: Forgo last_fence active request
 tracking
...
IGI2MTZiYTBlMGRhMC4uMmM2NDA5ODdjMjRkIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
...
dmVycy9ncHUvZHJtL2k5MTUvaTkxNV9nZW1fZ3R0LmMKaW5kZXggNzJhMjI3YzQzZTM1Li5lMDdj
MWFlOTcxZDcgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZ2VtX2d0dC5j

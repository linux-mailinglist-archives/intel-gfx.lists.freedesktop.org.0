...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D83926C5CD
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Sep 2020 19:20:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 714CC6EAA8;
	Wed, 16 Sep 2020 17:20:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [63.128.21.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C1DF26EAA8
 for <intel-gfx@lists.freedesktop.org>; Wed, 16 Sep 2020 17:19:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 ...
 bh=f+XN1Us8bt7PEaLxZdBLUd45/D3Ylg9jgvhjf9lNi14=;
 b=QYBXp8VmKuT8HGB04apbvnofx5rSn2ZPS1ANjlfaGCcQRhrvNAFuUDlk045MhfUHB8uNK6
 2axla30bXwkT6AMMi2uS3NsosC9mB06YXRfd/NKIbMPidjtvB6Onh5eQ3XaAwzAuVIzauC
 2MD4lqPXV1Osgx8uvMBpb17vZ2+lFbw=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-94-V8u-cA5TMfqdvGanp5VFcA-1; Wed, 16 Sep 2020 13:19:53 -0400
X-MC-Unique: V8u-cA5TMfqdvGanp5VFcA-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com
 [10.5.11.13])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CA8B1186DD23;
 Wed, 16 Sep 2020 17:19:50 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-120-66.rdu2.redhat.com
 [10.10.120.66])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 18ED47E46E;
 Wed, 16 Sep 2020 17:19:49 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 16 Sep 2020 13:18:53 -0400
Message-Id: <20200916171855.129511-7-lyude@redhat.com>
In-Reply-To: <20200916171855.129511-1-lyude@redhat.com>
References: <20200916171855.129511-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.13
Subject: [Intel-gfx] [RFC v2 6/8] drm/i915/dp: Enable Intel's HDR backlight

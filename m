...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B06B573091
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 10:14:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8ED5396125;
...
Subject: [Intel-gfx] [PATCH v2 14/39] drm/i915: document kernel-doc trivial
 issues

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 609B57528AB
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jul 2023 18:37:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DADF410E746;
...
Subject: [Intel-gfx] [PATCH v4 10/21] dyndbg: tighten ddebug_class_name()
 1st arg type

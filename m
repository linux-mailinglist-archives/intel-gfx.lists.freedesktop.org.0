...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D36CB3E8FC
	for <lists+intel-gfx@lfdr.de>; Mon,  1 Sep 2025 17:13:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2E3610E4C8;
	Mon,  1 Sep 2025 15:13:10 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="a77UORix";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 83EBD10E4C9
 for <intel-gfx@lists.freedesktop.org>; Mon,  1 Sep 2025 15:13:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1756739588;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=K7jUgCzLPy6D8wIKPj616StOUbYwsKVjaRrDFqVFeZE=;
 b=a77UORixYa4q0xVve8PCkC3ztFnjbyVA+uUD0Tp7qnwvOOg5LVDNAeMfM444R4wmKvPje7
 XQBpoxXBVbjdoPWBQkYA60SM7FS/jA2+/h7tzrl/bQtcRfdvCJ5FOCiGn1NNAkcVr005B0
 dxu2qGwmMknGemY8sXhKIAza24Qx7/k=
...
Received: from mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 995741800359; Mon,  1 Sep 2025 15:12:59 +0000 (UTC)
Received: from t14s.fritz.box (unknown [10.22.88.45])
 by mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id 3D39D180044F; Mon,  1 Sep 2025 15:12:42 +0000 (UTC)
...
Cc: David Hildenbrand <david@redhat.com>,
 ...
 Kevin Tian <kevin.tian@intel.com>, Alexander Potapenko <glider@google.com>,

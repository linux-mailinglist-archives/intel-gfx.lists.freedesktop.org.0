...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C9EED374936
	for <lists+intel-gfx@lfdr.de>; Wed,  5 May 2021 22:18:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3E426EC46;
	Wed,  5 May 2021 20:18:17 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 2/3] Restructure output format computation

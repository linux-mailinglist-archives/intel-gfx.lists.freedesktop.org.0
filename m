...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D497B94B66
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Aug 2019 19:13:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 560FD6E23D;
...
Subject: Re: [Intel-gfx] [PATCH 1/3] dma-buf: Introduce selftesting framework

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C00D75946F4
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Aug 2022 01:24:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77676D6F88;
	Mon, 15 Aug 2022 23:24:40 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2] drm/i915/guc/slpc: Allow SLPC to use
 efficient frequency

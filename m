...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41306A00D00
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jan 2025 18:42:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 424A110E906;
	Fri,  3 Jan 2025 17:42:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="KfOn5GfU";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D3D2E10E200;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=+4N8oPmRABWexLTcX2ApqS44PT8hpnp8px62ygsvjAQ=;
 b=KfOn5GfUKgQ3GTpmTQLCg3L/hmSrtYGI/N8PYeaVfGkO8NBORdncIImm
 2vGKXYPXLciWe1LaKPMXkCNGAACAFYn1Q/lCle5I2psepUjvgNR6wK8lS
 1aDx0ppakQ+hXJbfNeum7IT68sg9rSBQ5rKJ8aQTIMqju0PISH4G6pAw2
 aB9TZ9HslwZ/BEzETRl3D35xFCd/Eo9yR98CjSaBaWTcT/c4qU7sE+eph
 G1DS1GDK/RKxrnXRfKGOHAYbolqFieHHVGvYDLt1fE2DXYsvG17hEfvBI
 0AVcl/f4HO4ktYTzDpFzX5aeLduVG+rNyAXyu9/Wrp6RC3igia2K5ecs2 g==;
X-CSE-ConnectionGUID: G0R016vCQtWgsi6WrcILSQ==
X-CSE-MsgGUID: fpmCjE/jTWCihyoUY2v22A==
X-IronPort-AV: E=McAfee;i="6700,10204,11304"; a="36326347"
X-IronPort-AV: E=Sophos;i="6.12,286,1728975600"; d="scan'208";a="36326347"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jan 2025 09:42:39 -0800
X-CSE-ConnectionGUID: AmbY93TpQQKdHjpe/50x0g==
X-CSE-MsgGUID: bBgs7ERVRfiJoRzmc0ocuw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="102709606"
...
Subject: [PATCH 1/3] drm/i915/display: Use display MMIO functions in
 intel_display_irq.c
Date: Fri,  3 Jan 2025 14:41:35 -0300
Message-ID: <20250103174223.58140-2-gustavo.sousa@intel.com>
...
Since most of the changes in this patch are somewhat mechanic, it might be
easier to review this specific patch (after turned into a commit) with the
following script:

    #!/bin/bash
    pairs=(
        intel_uncore_posting_read intel_de_posting_read
        intel_uncore_read intel_de_read
        intel_uncore_rmw intel_de_rmw
        intel_uncore_write intel_de_write
    )
    
    sed_script=$(
        for ((i = 0; i < ${#pairs[@]}; i += 2)); do
            echo "s/\\<${pairs[i]}([^,]\\+/${pairs[i+1]}(display/g"
        done
    )
    
    new_file_obj=$(
        git show HEAD~:drivers/gpu/drm/i915/display/intel_display_irq.c \
            | sed "$sed_script" \
            | git hash-object -w --stdin
    )
    
    exec git diff --word-diff \
        $new_file_obj \
        HEAD:drivers/gpu/drm/i915/display/intel_display_irq.c

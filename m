...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7CDFBB8C88
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Sep 2019 10:22:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED3036E81E;
...
Subject: [Intel-gfx] [RFC PATCH V2 0/6] mdev based hardware virtio
 offloading support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE1B598F181
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Oct 2024 16:33:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E4F410E86D;
	Thu,  3 Oct 2024 14:33:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Rf6hWAxy";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7808C10E867
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Oct 2024 14:32:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1727965979; x=1759501979;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=3QSWSF7FOFfF1XnhVgRzYaL3JLhnuVkLG0zCU295vX0=;
 b=Rf6hWAxy/Be40f381JgFtvIP7Fzo5V3PzxP3QZuD9LC+XoqCHsiGpwYP
 yDOK9QqbBhKokESTdthZO3PkCcFIrzeUeS+nBUUHcgnNZgOBgIi69LP7y
 aJQJRW2+VBmrpAaJaKjV1d04/xeJOm54IPfAOu1vJ+zpwNLO+4N4yRGPG
 /I4qLj2Zenb6bARo2veQHqA/9SRgJLm4W0NBXWs6gntY4ICNu9UmUobX+
 nphXTMrpwA1HvHkLHtCVrF4zuumooY8CAc7Uu6Alyu3wfv4aJWv2TnK22
 Ez9FxmRMQjBokUPFDku8QaxMag2qa8BBQH+Itd01rMyi8t4CLsPTNtbkY w==;
X-CSE-ConnectionGUID: vLtn0R1qTRmfbtvErPaKJw==
X-CSE-MsgGUID: 10w8oF/sTZeJZfqAoXTrPg==
X-IronPort-AV: E=McAfee;i="6700,10204,11214"; a="27337639"
X-IronPort-AV: E=Sophos;i="6.11,174,1725346800"; d="scan'208";a="27337639"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Oct 2024 07:32:59 -0700
X-CSE-ConnectionGUID: Rb+9H3SqRE61saPoyQeGaQ==
X-CSE-MsgGUID: X1PXfKoLTGem3rpd0KKFLw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,174,1725346800"; d="scan'208";a="74463556"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by fmviesa008.fm.intel.com with SMTP; 03 Oct 2024 07:32:57 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 03 Oct 2024 17:32:56 +0300
Date: Thu, 3 Oct 2024 17:32:56 +0300
...
Message-ID: <Zv6rGHmLiL5GrpKG@intel.com>
...
In-Reply-To: <20241003142237.GK5725@mdroper-desk1.amr.corp.intel.com>

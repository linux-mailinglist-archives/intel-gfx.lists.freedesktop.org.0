...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4489BA6E86
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Sep 2019 18:28:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6342389862;
...
Subject: [Intel-gfx] [PATCH AUTOSEL 4.19 088/167] drm/i915: Sanity check
 mmap length against object size

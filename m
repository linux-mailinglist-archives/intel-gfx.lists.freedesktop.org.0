...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7DA04FC249
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 18:27:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 69CB410E969;
...
Subject: Re: [Intel-gfx] [PATCH 16/34] drm/i915/gvt: devirtualize
 ->detach_vgpu

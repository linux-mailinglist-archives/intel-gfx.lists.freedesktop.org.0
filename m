...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C1AEE53A953
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Jun 2022 16:41:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ABB8810E56A;
	Wed,  1 Jun 2022 14:41:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4A37410E56A;
 Wed,  1 Jun 2022 14:41:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654094461; x=1685630461;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=5N58DkWE+rjoluui3i9mtUf8XNxa9KY/axB3G8tO4Xs=;
 b=LzfL2lRrL4S3ISXZoiZBz8I6wYdAvsqQKpfmTJYdaZVuh+B4farnDKmJ
 Qa4YKK5+AImsvblrcVhZAg1MdUq6ovqqpjScDtV3PGNJlz7mW/CNZKnJO
 gwcUC38csFzm5Dw86MS+DLQgw/ozx8DTclm5Z/f/UP1fGmovHaDTE7LKt
 g4PU6s1R0kCyey4JD27xW7WoUl6UOarE/TdJguU9DTcCmAsi05tMfljLh
 Tc5kd9pt9+QSQbGce2Oqc0ygN2zdXNOdsLavUh2cJ24ac1MPoKXb7Jjc/
 UXZQ8YRPqU+gNjtawgv68w9dk9U4nsM4pwi2e7KIVu8SEc7Bcl1c94je6 w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10365"; a="263247382"
X-IronPort-AV: E=Sophos;i="5.91,268,1647327600"; d="scan'208";a="263247382"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2022 07:41:00 -0700
X-IronPort-AV: E=Sophos;i="5.91,268,1647327600"; d="scan'208";a="904481446"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2022 07:40:59 -0700
Date: Wed, 1 Jun 2022 07:40:58 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: Balasubramani Vivekanandan <balasubramani.vivekanandan@intel.com>
Message-ID: <Ypd6eqUwRvvKAvEu@mdroper-desk1.amr.corp.intel.com>
References: <20220520230408.3787166-6-matthew.d.roper@intel.com>
 <20220523204525.4084150-1-matthew.d.roper@intel.com>
 <Ypcg8HdIvzhLxNNu@bvivekan-mobl.gar.corp.intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <Ypcg8HdIvzhLxNNu@bvivekan-mobl.gar.corp.intel.com>
Subject: Re: [Intel-gfx] [PATCH v5 5/6] drm/i915/sseu: Disassociate internal

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 216752C657B
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B36C56ED85;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 145/162] drm/i915/dg1: Add dedicated context
 for blitter eviction

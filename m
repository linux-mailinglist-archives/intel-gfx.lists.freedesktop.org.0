...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EEAF48ED40
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jan 2022 16:40:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED14610E282;
...
Subject: Re: [Intel-gfx] [PATCH][RESEND] i915: make array flex_regs static
 const

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3107376B65B
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 15:54:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A5BA110E407;
	Tue,  1 Aug 2023 13:54:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (unknown [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C2B8310E403
 for <intel-gfx@lists.freedesktop.org>; Tue,  1 Aug 2023 13:54:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1690898049; x=1722434049;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ul/Pm8LwW0A2SWTg2BOC7UXVJieSt333tNfjuW1smUU=;
 b=AuxIivJQDWdFJHU5vRcDant/W1hi9P6BkkP1709WGGRakBEdT9fGJe5s
 aVdJmlfiP5tM4iyTW7vbIZ4nBx33YSB4sn8K8dGxS7q8CqsK4/NaHD2XX
 YSENag8j6lYw798hrL1EjfjjDoefzWTwfOpWnWAJVh1MUI54bavvIo4DT
 ZuDegJSLBvuempOXJ0Hhe6WLSrgdqVwgNzyW3qhJ78gWL2o75q/kv5pAC
 fhCXyFDFGTxjKVJHDxf8Lw/MnwQN7DHqpf/SmXCMZnLGkw6Xmvf/La/D0
 MRtAVUEBiIbLtDAXXPo6elGOAy65p+H/AqeA5qRA486SVuyhWtaJcSPkD w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10789"; a="435629382"
X-IronPort-AV: E=Sophos;i="6.01,247,1684825200"; d="scan'208";a="435629382"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Aug 2023 06:54:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10789"; a="818803947"
X-IronPort-AV: E=Sophos;i="6.01,247,1684825200"; d="scan'208";a="818803947"
Received: from pltuser2-ms-7d25.iind.intel.com ([10.190.239.58])
 by FMSMGA003.fm.intel.com with ESMTP; 01 Aug 2023 06:54:07 -0700
From: Dnyaneshwar Bhadane <dnyaneshwar.bhadane@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  1 Aug 2023 19:23:38 +0530
Message-Id: <20230801135344.3797924-9-dnyaneshwar.bhadane@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BF4268627F
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Feb 2023 10:09:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 230DF10E3D7;
	Wed,  1 Feb 2023 09:09:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E5EC910E3D3
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 Feb 2023 09:09:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675242556; x=1706778556;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Ha+N4+GgCZ20D9urHGiU9EQIFtIpINbliFs6bQ3zgfg=;
 b=CN0jJGT6skHh48cBi1LzS2UtIGR473+ee3BdUV2/T1lI++9eU8gs5zrF
 P1vnBXQ7J4ISUrrca4fsG10r+kvlcaIvTEwgQU2xCB/4tb2YsYbZgOOXH
 +PeAQoTEJZDGoOOo6k1Im1XZIxJKuBoygTJDXtG2APtas3jr/YlQPSUhB
 uttddJPUwzGzppyRt+f9HZZFGkfoX955MbmTu7SvMP5XOx94EUINMbBD/
 H1ej8I7D4itkLens0ioVgoDseuTcIvCWJH+TpZipnx3Jwmzm/kSMWstt2
 3Vt2sqkfpCI29oifZsNG1iFH7sgDfBdH6VSGnFiI0WvXSMcQgL7j2tOa6 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10607"; a="328103312"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="328103312"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 01:09:16 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10607"; a="910263763"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="910263763"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga006.fm.intel.com with ESMTP; 01 Feb 2023 01:09:12 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  1 Feb 2023 14:38:02 +0530
Message-Id: <20230201090806.3008619-3-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 2/6] drm/i915/hdcp: Keep hdcp agonstic
 naming convention

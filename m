...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B1FA50BDFD
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Apr 2022 19:07:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 510EF10E572;
	Fri, 22 Apr 2022 17:07:48 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 1/7] vfio: Make
 vfio_(un)register_notifier accept a vfio_device

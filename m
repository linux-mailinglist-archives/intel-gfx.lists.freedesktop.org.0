...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BE8164E90F2
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 11:17:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F1C2B10EA4B;
	Mon, 28 Mar 2022 09:17:42 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 01/11] drm/edid: don't modify EDID while
 parsing

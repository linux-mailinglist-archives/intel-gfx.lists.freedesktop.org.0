...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3FDE9257B2
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jul 2024 12:02:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38FC710E0FA;
	Wed,  3 Jul 2024 10:02:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="BQW4fVz1";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 632FB10E0FA
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jul 2024 10:02:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1720000944; x=1751536944;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=V/u/t3K3jS7tKqR/abKQDPcKJvW7PmR1eRK7iORU//M=;
 b=BQW4fVz1HKDe3JbgTwxmzK9S9a+2fmVMBNiluKB9dvjjgaFQznkXa1YL
 9psaJcX155IJX33DT6bmx8itrG5tdkLS8M8kmdUAIU3yXm6CYP6oSRwzK
 v0QGWSdpVHHSWRXTOzxdFcdTVZRLltQ9vDZEH4ijGRPHMblhjCHcpjBku
 vtdJvaVHwOm0WuSOku8iAmYZA/axxvx8nCMbqOZNOXIeDNwlDA98yl3Px
 tcBPoJfQG4hZScYW8lEeUFwSIC2mAfCZN5TmqeJfYwo0YlhpTDNf57NHp
 GCcI3Kjjoa2IYGNLN1lq3aBjr91gYbl44PfjX5BduieuTJNoAHGS6LmVh g==;
X-CSE-ConnectionGUID: 4vJqS37mTDS7evR8a/YPFg==
X-CSE-MsgGUID: auiJ4XR/T6+Iv6l2wdVBMQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11121"; a="17355076"
X-IronPort-AV: E=Sophos;i="6.09,181,1716274800"; d="scan'208";a="17355076"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jul 2024 03:02:23 -0700
X-CSE-ConnectionGUID: bkHd7bayRjGmbPGID8xXtQ==
X-CSE-MsgGUID: fVhtItuhQaGFhMna9CpXhw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,181,1716274800"; d="scan'208";a="46953269"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jul 2024 03:02:22 -0700
Date: Wed, 3 Jul 2024 13:02:11 +0300
...
Subject: Re: [PATCH 3/4] drm/i915: Compute config and mode valid changes for
 ultrajoiner
Message-ID: <ZoUhj679uvekzl26@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 27215802DED
	for <lists+intel-gfx@lfdr.de>; Mon,  4 Dec 2023 10:11:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E93E10E30A;
	Mon,  4 Dec 2023 09:11:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [IPv6:2610:10:20:722:a800:ff:feee:56cf])
 by gabe.freedesktop.org (Postfix) with ESMTP id 8768C10E30A;
 Mon,  4 Dec 2023 09:11:04 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 54493AA917;
 Mon,  4 Dec 2023 09:11:04 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============3888866450521498716=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Almahallawy, Khaled" <khaled.almahallawy@intel.com>
Date: Mon, 04 Dec 2023 09:11:04 -0000
Message-ID: <170168106433.20595.16241682673000361089@emeril.freedesktop.org>
...
#### Issues hit ####
  ...
  * igt@gem_lmem_swapping@basic:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_123149v2/fi-apl-guc/igt@gem_lmem_swapping@basic.html

  * igt@gem_mmap@basic:
    - bat-dg2-8:          NOTRUN -> [SKIP][2] ([i915#4083])
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_123149v2/bat-dg2-8/igt@gem_mmap@basic.html

  * igt@gem_mmap_gtt@basic:
    - bat-dg2-8:          NOTRUN -> [SKIP][3] ([i915#4077]) +2 other tests skip
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_123149v2/bat-dg2-8/igt@gem_mmap_gtt@basic.html

  * igt@gem_tiled_pread_basic:
    - bat-dg2-8:          NOTRUN -> [SKIP][4] ([i915#4079]) +1 other test skip
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_123149v2/bat-dg2-8/igt@gem_tiled_pread_basic.html

  * igt@i915_pm_rps@basic-api:
    - bat-dg2-8:          NOTRUN -> [SKIP][5] ([i915#6621])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_123149v2/bat-dg2-8/igt@i915_pm_rps@basic-api.html

  * igt@i915_selftest@live@execlists:
    - bat-atsm-1:         [PASS][6] -> [INCOMPLETE][7] ([i915#9784])
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_13956/bat-atsm-1/igt@i915_selftest@live@execlists.html
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_123149v2/bat-atsm-1/igt@i915_selftest@live@execlists.html
...
#### Possible fixes ####
  ...
  * igt@gem_exec_suspend@basic-s3@smem:
  ...
  [i915#9784]: https://gitlab.freedesktop.org/drm/intel/issues/9784
...
<ul>
<li>bat-atsm-1:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_13956/bat-atsm-1/igt@i915_selftest@live@execlists.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_123149v2/bat-atsm-1/igt@i915_selftest@live@execlists.html">INCOMPLETE</a> (<a href="https://gitlab.freedesktop.org/drm/intel/issues/9784">i915#9784</a>)</li>
</ul>
</li>
<li>

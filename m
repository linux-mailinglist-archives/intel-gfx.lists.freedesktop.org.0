...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A2D06F3C91
	for <lists+intel-gfx@lfdr.de>; Tue,  2 May 2023 06:11:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEA9B10E19E;
	Tue,  2 May 2023 04:11:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98EB710E116;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=lEtsBXCggxvDx8RA06HNOcP0/5Ui8gbS7YI20bIWzQy+t6PJAgZiKN8q
 uFUdFZOiBhUFAyCl1Oi0SIEW9Y3ohbvPB3onu4ezLkvSWzWdPp1f9AEbd
 6Wu4WQrVCTAprtyOjJE3GiQ+Z3mwKjP+s1DJR4JNtNUWL6nlHJqeBdrr+
 mf0yty5zmUfGr5RIuo1ou3mhsVevSoVmpvLsP1qpxIRY4NXl3DFkkL1HI
 uiCiVJwtUXZTRSkTq+d0F9cV9s2X6p4SDxZZhTK1OpCH+nITD2GmMDWPc
 nfeKl7rlsmdZaAKK3ZZnQ5bRbebs19Ei2biwN3tzAwsooPgzy7G6iZpBj w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="351280164"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="351280164"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:11:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="785518093"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="785518093"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:11:00 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  1 May 2023 21:11:58 -0700
Message-Id: <20230502041200.2170424-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/3] drm/i915: preparation for using PAT index

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 020B96F61AF
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 01:01:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 404F810E36F;
	Wed,  3 May 2023 23:01:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 692B810E165;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=rKZ6HXx+0S348kUczbMlPRGX5U1T/MUle9gKzKVpE3w=;
 b=TZYLV/tt51vyPK5HEtidAsg/SgPoO8KsikBH/F7aegsPWwTRNY0m8cMx
 +KV1FSobgqnw9R3WyAqRumzLQFnv2txUlEn3SFZBT4D78IUcrZBhcuJEk
 4hY2lq/ppEj8659mFHleNw1He/O/OYwUW9jpKWeQw/n5tvkRQLB7eOCSb
 g+gck8GuNMnT4uZ5/j4aV+YUouTGd/UJVnkNTOLxTsjXibZCbfOVgkoYi
 ryKZS3htu/CMLyFDkjla8rFOdx2/fTmscTp65r2Qyv0WpNptlq5dUsnjd
 kYLX7+STmeB2yw9Uth0/qrh9VWP+gofzm+o8fJ/tn1+LOirDppjtLotTt A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="350868541"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="350868541"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 16:01:11 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10699"; a="943061850"
X-IronPort-AV: E=Sophos;i="5.99,248,1677571200"; d="scan'208";a="943061850"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 May 2023 16:01:11 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 May 2023 16:02:08 -0700
Message-Id: <20230503230211.2834340-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 2/5] drm/i915: use pat_index instead of
 cache_level

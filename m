...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 820AB8CF6B
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Aug 2019 11:27:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4034389AEA;
	Wed, 14 Aug 2019 09:27:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6574C89AEA
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Aug 2019 09:27:04 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18076225-1500050 
 for multiple; Wed, 14 Aug 2019 10:26:46 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 14 Aug 2019 10:26:42 +0100
Message-Id: <20190814092643.1908-7-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 7/8] drm/i915: Extract intel_frontbuffer active
 tracking
...
LmMKaW5kZXggNWI3MzNlMzhlYWUzLi5jNmEzZjU3NTM3NjkgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMv
...
KGNvbnN0IHN0cnVjdCBkcm1fZnJhbWVidWZmZXIgKmZiLApAQCAtMTQxMzIsOSArMTQxMzYsOSBA
...
cnVjdCBkcm1fZGV2aWNlICpkZXYsCkBAIC0xNDQxOCw3ICsxNDQyMiw3IEBAIGludGVsX3ByZXBh
...
cGxpY2l0IGZlbmNpbmcgKi8KIAkJc3RydWN0IGRtYV9mZW5jZSAqZmVuY2U7CkBAIC0xNDY4MSwx
MyArMTQ2ODUsMTIgQEAgaW50ZWxfbGVnYWN5X2N1cnNvcl91cGRhdGUoc3RydWN0IGRybV9wbGFu
...
IGEgbW9kZXNldCBwZW5kaW5nLApAQCAtMTQ3NTUsMTEgKzE0NzU4LDEwIEBAIGludGVsX2xlZ2Fj
...
CmluZGV4IDJkNzRjMzNhNTA0ZC4uZDU5ZWVlNWM1ZDljIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dw
...
YmRldi0+ZmItPmJhc2U7CiAKIAlpbmZvLT5mYm9wcyA9ICZpbnRlbGZiX29wczsKIApAQCAtMjYz
LDEzICsyNTQsMTQgQEAgc3RhdGljIGludCBpbnRlbGZiX2NyZWF0ZShzdHJ1Y3QgZHJtX2ZiX2hl
...
eCAxNzVkYzE0YWNmMTQuLjcyNDI0MmVjMzk3MiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJt
...
MTVfZ2VtX29iamVjdC5jCmluZGV4IDY3ZGM2MWUwMmM5Zi4uZDc4NTVkYzVhNWM1IDEwMDY0NAot
...
ZXggNzRiY2Q1ODBjY2MzLi41ZWZiOTkzNmUwNWIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
...
ZnMuYwppbmRleCBlZjRmODRlMDYwZWUuLmU3Y2U3MzlmZTU0NSAxMDA2NDQKLS0tIGEvZHJpdmVy
...
di5oIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuaAppbmRleCBjNDQwNmE2MGYzZTQu
LjA1MjdlZGU2ZTBmMiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYu
aAorKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2Rydi5oCkBAIC0yMzU1LDEwICsyMzU1
...
MTVfZ2VtLmMKaW5kZXggMDdkYTdkNWY4NTVhLi4zZjBkODhjYjQ3ZGQgMTAwNjQ0Ci0tLSBhL2Ry
...
b2JqLCBmZW5jZSk7CiAKIAlyZXR1cm4gcmV0OwpAQCAtMTc2MywzOSArMTc2NSw2IEBAIGludCBp
...
YwppbmRleCBjYzA4NDhlZjVkZjAuLmEzMjI0Mzk1MWIyOSAxMDA2NDQKLS0tIGEvZHJpdmVycy9n
...
aXRlLAorCQkJCQlycS0+ZmVuY2UuY29udGV4dCwKKwkJCQkJcnEpOwogCiAJCWRtYV9yZXN2X2Fk
ZF9leGNsX2ZlbmNlKHZtYS0+cmVzdiwgJnJxLT5mZW5jZSk7CiAJCW9iai0+d3JpdGVfZG9tYWlu
ID0gSTkxNV9HRU1fRE9NQUlOX1JFTkRFUjsKLS0gCjIuMjMuMC5yYzEKCl9fX19fX19fX19fX19f

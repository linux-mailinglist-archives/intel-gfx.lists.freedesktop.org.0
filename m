...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ACE6D74E4A1
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Jul 2023 04:59:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25A3210E2EF;
	Tue, 11 Jul 2023 02:59:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1108810E2E1;
 Tue, 11 Jul 2023 02:59:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689044372; x=1720580372;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=LocATiEkZYMYTJ6n8h1AtSCYUANokIMFPyaJ6ON+JM0=;
 b=OCEhdIfOxSoQ1V1Hng9gYO8EntAtmSDlhRuMnfuFCQOIZh+tZGKQN5ih
 dm27KD0IXJq3Ghf8cavouoDHGWCuTf9vQ+gts7ItXHyy+5CTvX/RweE+k
 5WOSiT3RycASf12DG+2SXYNvsx8RdHuOjmFL5Jt/Kzu9YBUig3l7iXhlP
 RuzgMoWx9Y0FRU5OSojTJP1F6gFTy3c13+fGDMO1kV2T4ARAfFpFRjvKZ
 2ZN1mWCTV+oRgd6ucoLGwe17dpzDlzkqxkpMPijoeTXW2HShd9ITGp6EX
 OzQEV8nEpa6qRUzP8/3PTMsINTmRHYEDRAeX1Esi8DkyNVAHgSJ3soIzz g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10767"; a="361972935"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="361972935"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jul 2023 19:59:31 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10767"; a="724250752"
X-IronPort-AV: E=Sophos;i="6.01,195,1684825200"; d="scan'208";a="724250752"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga007.fm.intel.com with ESMTP; 10 Jul 2023 19:59:30 -0700
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Mon, 10 Jul 2023 19:59:03 -0700
Message-Id: <20230711025928.6438-2-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230711025928.6438-1-yi.l.liu@intel.com>
References: <20230711025928.6438-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v14 01/26] vfio: Allocate per device file
 structure

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8FFDD3B973A
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 22:25:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A83066EC16;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/53] drm/i915/xehp: Extra media engines - Part
 3 (reset)

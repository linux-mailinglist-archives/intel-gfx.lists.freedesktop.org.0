...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DCA86EC472
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 06:42:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 748E510E2CF;
	Mon, 24 Apr 2023 04:41:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7A54510E26C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=S4cCKZIbXuD/0sN8H+jRuRtItqUwvaUPZf5FI54ICCkX1LNY6AQKaTJz
 k2rECpnG7U4sCGkJnKy8i2I0i/wXveSYXcDHWsnNO/NXMQ8CjnTb7r+Pf
 j4IYVTJJi2o9oPYT/1fxYJIkbCDCZ0pKL/9sv541U+tFi/XM6tvEDr+C1
 D7GqcvKRs75rGWbQFlTf/qwndKC8mbAZRAijtgxSuQjTV+RLT5cN9mNh3
 F9sHfdOxLiqXswksidhvSR7hBtFWo8NBtjME4SVXIdPaEh47UnE/UJMN0
 PlRKWvURVt9fL60WHkWno3IN3EqeYsO7w+SwZhlg1iu3EBm+lNSRuKkKN A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="345115346"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="345115346"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 21:41:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="643211485"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="643211485"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 21:41:42 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Sun, 23 Apr 2023 21:42:48 -0700
Message-Id: <20230424044251.3390364-4-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 3/6] drm/i915: use pat_index instead of
 cache_level

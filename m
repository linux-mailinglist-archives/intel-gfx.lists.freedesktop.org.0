...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C0D7628500
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 17:22:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AADE10E2DE;
	Mon, 14 Nov 2022 16:21:56 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 2/4] usb: gadget: hid: Convert to use
 list_count()

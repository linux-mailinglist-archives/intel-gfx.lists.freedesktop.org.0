...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3932030C4F4
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Feb 2021 17:08:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84B436E942;
	Tue,  2 Feb 2021 16:08:12 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5C8406E942
 for <intel-gfx@lists.freedesktop.org>; Tue,  2 Feb 2021 16:08:11 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 23774375-1500050 for multiple; Tue, 02 Feb 2021 16:08:06 +0000
MIME-Version: 1.0
In-Reply-To: <161228122183.1150.11345446372757847691@build.alporthouse.com>
References: <20210202151445.20002-1-chris@chris-wilson.co.uk>
 ...
 <161228122183.1150.11345446372757847691@build.alporthouse.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
Date: Tue, 02 Feb 2021 16:08:06 +0000
Message-ID: <161228208667.1150.11666315738374215255@build.alporthouse.com>
User-Agent: alot/0.9

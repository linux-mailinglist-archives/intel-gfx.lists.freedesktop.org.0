...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 771D770F22F
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 11:22:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DA4D910E5CA;
...
Subject: [Intel-gfx] [PATCH v4 02/13] fbdev: Add initializer macros for
 struct fb_ops

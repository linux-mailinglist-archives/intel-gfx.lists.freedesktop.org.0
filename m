...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D068C14961
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Oct 2025 13:20:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFE5C10E3CC;
	Tue, 28 Oct 2025 12:20:56 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PvuREWpY";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 70CC610E3D3;
 Tue, 28 Oct 2025 12:20:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761654055; x=1793190055;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=DUUU9whlpUsZ5Cr/LlOslXmOJPKKN594SOXY9jdORCU=;
 b=PvuREWpY3sfHWXjqum4Mmj7BCx06TbDiMuHcYqu27ejCTc35cu1oqL2N
 /N3XofanaGRM8Hbn4+Lv0KSNFeXd2oIZ7OQrWFqW2QwcH8z+0yJWOJeB0
 6jNzkjrH0VOZblHsdvjOFBpEWTfqSJaQqQBKeh8dWsvbpnkR/if4H7dOf
 ysErC26wunJ+Gzo77Jx7JScUxcpHF7Ac20mVCqVWbxiEjv9Ew5UIk5H2q
 npmPG2cvr7hi5MrVT5CrECxWI3K7YpQKRD4T7OEOBLGwNzmHW2X3LPYO3
 ujlaH7Y76x+siOmkEeh6IyaTx7wOGvDLKbrsFrfFPaollAxTrbfzT/CW9 A==;
X-CSE-ConnectionGUID: IOpBbYlnSxGBWHrUc0VAoQ==
X-CSE-MsgGUID: yipzeauQSqqIBEDLtN3A0Q==
X-IronPort-AV: E=McAfee;i="6800,10657,11586"; a="75198273"
X-IronPort-AV: E=Sophos;i="6.19,261,1754982000"; d="scan'208";a="75198273"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2025 05:20:55 -0700
X-CSE-ConnectionGUID: C3ZH4Jw/SemsAqxAyOvkTQ==
X-CSE-MsgGUID: i2d/1Yj8TQKByJQ2yw5koA==
X-ExtLoop1: 1
...
Date: Tue, 28 Oct 2025 17:37:41 +0530
Message-ID: <20251028120747.3027332-6-ankit.k.nautiyal@intel.com>

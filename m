...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18101991D3
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Aug 2019 13:15:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 902166E4B6;
	Thu, 22 Aug 2019 11:15:28 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 0/6] drm/i915: Enable HDCP 1.4 and 2.2 on
 Gen12+

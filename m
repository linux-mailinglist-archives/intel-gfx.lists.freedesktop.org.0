...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3399F9FF45B
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Jan 2025 16:51:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF75310E257;
	Wed,  1 Jan 2025 15:51:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="njXl8OKh";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1B0F710E215;
 Wed,  1 Jan 2025 15:51:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1735746662; x=1767282662;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=kCM9TvpuDVzgK4w/JiS5XgvUi/UOMIkCRUafIh4iGw0=;
 b=njXl8OKhCLrV8Ko3vf8rGQrbhcKPErm81Nb4c7HvZ0KP24yIAqfQWeUV
 lUfdHAT4PeVS1XV01d00VJ+A/qfF/65Repp9KILGu05zw3am0iHYURqVG
 xcV+v4d8gUO0cvWj222dU86HzXY37/ozh8YK/XVWK1t/8tyDgJFsQrP0Q
 TXhpS5yXNVWxn6CEE6irCTjLocNiPwaiRwU8QR0YVHCEYqL0AzNBiRAxM
 87/ymKJNVW4ad5Zubcwo3XxyBUgTHA6hcHU1+C2Zaz+uYTrSmrDNyfFYh
 ChNkyUfJUuHtC4aiVHz9Gu70v/aUt7e5GmI56EnrsAyAOOGjMCkv2+wyR w==;
X-CSE-ConnectionGUID: 5MEoPmG7RCug55LANhbEAw==
X-CSE-MsgGUID: Wv8NkVrXSmyCbyn6AYliOw==
X-IronPort-AV: E=McAfee;i="6700,10204,11302"; a="46485604"
X-IronPort-AV: E=Sophos;i="6.12,282,1728975600"; d="scan'208";a="46485604"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jan 2025 07:51:01 -0800
X-CSE-ConnectionGUID: N8WQfxAjSkWu4Hh8LPvi/w==
X-CSE-MsgGUID: xlUpX709S2CS3Wm/IPecOg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,282,1728975600"; d="scan'208";a="132138973"
...
Subject: [PATCH v4 05/11] mtd: intel-dg: register with mtd
Date: Wed,  1 Jan 2025 17:39:19 +0200
Message-ID: <20250101153925.865703-6-alexander.usyskin@intel.com>

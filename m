...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E14783C6466
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Jul 2021 21:58:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 329B389994;
	Mon, 12 Jul 2021 19:58:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E437A89939;
 Mon, 12 Jul 2021 19:58:50 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10043"; a="295693239"
X-IronPort-AV: E=Sophos;i="5.84,234,1620716400"; d="scan'208";a="295693239"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Jul 2021 12:58:46 -0700
X-IronPort-AV: E=Sophos;i="5.84,234,1620716400"; d="scan'208";a="412697443"
...
Message-ID: <844763b3-3abd-f7c8-5f62-8e255165a9cd@intel.com>
Date: Mon, 12 Jul 2021 12:58:45 -0700
...
> +		return;
Ew. Multi-line if without braces just looks broken even if one line is 
just a comment.
...
> +	/* GuC is blown away, drop all references to contexts */
> +	xa_destroy(&guc->context_lookup);
This function shares most of the code with 'intel_guc_submission_reset'. 
Can the xa clean be moved to a common helper?

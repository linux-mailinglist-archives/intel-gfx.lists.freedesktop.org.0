...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BEFD73A0DA
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Jun 2023 14:26:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ADF3410E559;
...
Subject: Re: [Intel-gfx] [PATCH 1/4] drm/ttm: Fix

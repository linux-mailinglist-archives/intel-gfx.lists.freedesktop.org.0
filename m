...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E092500FDA
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Apr 2022 16:09:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 379B410FDEC;
...
Subject: Re: [Intel-gfx] [CI v3 00/12] drm/edid: low level EDID block read
 refactoring etc.

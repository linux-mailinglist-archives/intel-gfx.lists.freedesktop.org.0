...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D0E7E11E3C7
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2019 13:45:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B395F6E55E;
	Fri, 13 Dec 2019 12:45:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 6.mo179.mail-out.ovh.net (6.mo179.mail-out.ovh.net
 [46.105.56.76])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D41D36E55E
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Dec 2019 12:45:41 +0000 (UTC)
Received: from player691.ha.ovh.net (unknown [10.108.42.23])
 by mo179.mail-out.ovh.net (Postfix) with ESMTP id 7F277152BBF
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Dec 2019 13:45:39 +0100 (CET)
Received: from etezian.org (net-37-116-49-191.cust.vodafonedsl.it
 [37.116.49.191]) (Authenticated sender: andi@etezian.org)
 by player691.ha.ovh.net (Postfix) with ESMTPSA id D7C3FD596C5C;
 Fri, 13 Dec 2019 12:45:35 +0000 (UTC)
From: Andi Shyti <andi@etezian.org>
To: Intel GFX <intel-gfx@lists.freedesktop.org>
Date: Fri, 13 Dec 2019 14:45:48 +0200
Message-Id: <20191213124549.28412-2-andi@etezian.org>
X-Mailer: git-send-email 2.24.0
In-Reply-To: <20191213124549.28412-1-andi@etezian.org>
References: <20191213124549.28412-1-andi@etezian.org>
MIME-Version: 1.0
X-Ovh-Tracer-Id: 9796173616012182109
X-VR-SPAMSTATE: OK
X-VR-SPAMSCORE: -100
X-VR-SPAMCAUSE: 
Subject: [Intel-gfx] [PATCH v3 1/2] drm/i915/rps: Add frequency translation
 helpers

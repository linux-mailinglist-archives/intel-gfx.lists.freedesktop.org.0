...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E3D4E5297D8
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 05:20:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8433F10EAB2;
...
Subject: [Intel-gfx] [PATCH v2 6/6] drm/i915/pvc: Add SSEU changes

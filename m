...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 28BD3F17C0
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Nov 2019 14:57:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38D8F6E21F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 2/4] drm/i915/selftests: Replace mock_file

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 615779A9EED
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Oct 2024 11:45:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9801510E30B;
	Tue, 22 Oct 2024 09:45:55 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="boP47hjp";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D92A610E30B
 for <intel-gfx@lists.freedesktop.org>; Tue, 22 Oct 2024 09:45:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729590354; x=1761126354;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=6c5Hc72KFa3wHRhKUP2iQA9nvT6ib1Cf8rq6gHPwEJk=;
 b=boP47hjpC1bLwYaPXD46gqVw4bT0wCivByTnpOqsqKIqi+lbEp+o7IJT
 Dikk7Ol7KxqWWxqHXGZnl5gKEDMYN+4myZRIWDwkVz+hamckB9EFVAGR3
 Ddg6q7zZB+xza5OP7ZrlkYnsQYsVqjQO7B/mb3u6MMLnMl6ecULxW+5tw
 AZq1zxKPR0jy8xHc30UWshpXleeGi00/ElHr1uMHLER7Rc4QXOlaQ7kRp
 qh4atsFwCJi3bdCVF4MKX8RQMD9h0PbBiI+JzauAe/0xcsmzFbM3HQaq4
 CeU6mbbrqzYoT+ulYu8ySwy9KA45/NKWpswlkSrr1A+2jtMZY4HRvc6QA Q==;
X-CSE-ConnectionGUID: Qmt5T1b/SXevnP5v1rjw9Q==
X-CSE-MsgGUID: wbI6B7cVR4ySZwnLfVFSbw==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="28893155"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="28893155"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa112.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2024 02:45:53 -0700
X-CSE-ConnectionGUID: oYzT/wxMQiCRnGr6t4jpqA==
X-CSE-MsgGUID: gk9wuHxPSbOkviuNFoXR6Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,222,1725346800"; d="scan'208";a="80621848"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2024 02:45:52 -0700
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH v4 4/8] drm/i915/dp: Track source OUI validity explicitly
Date: Tue, 22 Oct 2024 12:46:23 +0300
Message-ID: <20241022094624.2696428-1-imre.deak@intel.com>
X-Mailer: git-send-email 2.44.2
In-Reply-To: <20241016132405.2231744-5-imre.deak@intel.com>

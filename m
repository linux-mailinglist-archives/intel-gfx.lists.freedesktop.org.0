...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E572175FC7
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Mar 2020 17:33:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A5A1A6E58E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 5/7] drm: Remove drm_fb_helper add,

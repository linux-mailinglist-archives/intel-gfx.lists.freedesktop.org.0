...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C7E7E38AAA
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jun 2019 14:50:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5399389CDF;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 +aMQ==
Subject: [Intel-gfx] [PATCH 1/6] dma-buf: add dynamic DMA-buf handling v9

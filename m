...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7594F9AB2E8
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Oct 2024 17:57:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18B8A10E6AE;
	Tue, 22 Oct 2024 15:57:58 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ePChnkjX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AE35710E053;
 Tue, 22 Oct 2024 15:57:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729612677; x=1761148677;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=aqT1E3rX9zhVeg/ldRMbDh18QXMGczLvqChUyPepn1E=;
 b=ePChnkjXHrz8dbG5PryjfMHjaBumkX4OnSxIFOIBP4oUkbib2AfhlrNZ
 VOrSBYmTL0LGZkAMjaFmBa8Fua5xdW0SfULm4XSKAQMdwoBbd/XlSTdy/
 wzDejkFXbH9EgNNUt3NBGYXQh89ZfC1CtMIXVxq/n0Rb9T2dQzcBSg4yk
 XKfmmOcihvQNaKgzs50Ua90/pjqDvGbuL8iIhxYXoSyOD4NuROrGPWGJr
 ZBXU+mRITZmFASgsF3+GUUXcehqANnVXM8Aan2L3NP9Texx1SZe9usAR7
 rloLWdda62WzTdL/QB5XvcmvFsNtobCTXThAqiLgwpmm3y9iW8LIXRVWR A==;
X-CSE-ConnectionGUID: bo3aQDdvSIKRT8b1MBY4Xw==
X-CSE-MsgGUID: dP5e3eYhT+iuiCjC0gZOrQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11233"; a="29270587"
X-IronPort-AV: E=Sophos;i="6.11,223,1725346800"; d="scan'208";a="29270587"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2024 08:57:55 -0700
X-CSE-ConnectionGUID: /zppWaiGTImNkOOP1F3c0Q==
X-CSE-MsgGUID: yFRDi9MWQ0Kw7ka2Fct7tA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,223,1725346800"; d="scan'208";a="79857987"
Received: from mjarzebo-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.58])
 by orviesa010-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Oct 2024 08:57:53 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 04/11] drm/i915/hdcp: further conversion to struct
 intel_display
Date: Tue, 22 Oct 2024 18:57:21 +0300
Message-Id: <ad036d2f267ab49b7943f46dad94c0f34e9f2d84.1729612605.git.jani.nikula@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DEB55A973E
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 14:48:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D624610E708;
...
Subject: [Intel-gfx] [PATCH 5/9] drm/exynos: convert to using is_hdmi from
 display info

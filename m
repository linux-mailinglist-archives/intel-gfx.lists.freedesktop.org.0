...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7DDFCA349A
	for <lists+intel-gfx@lfdr.de>; Thu, 04 Dec 2025 11:48:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2FA5110E927;
	Thu,  4 Dec 2025 10:48:06 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="be2xD2TG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B139810E925;
 Thu,  4 Dec 2025 10:48:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1764845286; x=1796381286;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=4ARsVYCVN7Mj/XfpHJH+ZRwnBDqrvYwPzfZWk31dc3c=;
 b=be2xD2TGiUL+vBqx3jWMOo7KXE9b5AtXp0+GtSXOn/e1+MtuyjCHAg43
 Q7vF7VMcyjHK63gxVgT/wKAb0rFvguJd1a8dSmww4vDYno2VzQ73UN18X
 mBW2r2ruBCQpruzp7lRSY8W8PLmMCkj9CC2hkAXTk2SdfrFJdcgaCerbH
 uidsWopIVuFkrFaXFxdR53lYXwXLafv/Z/PpRbsTdU41YEoAf2N7cxORn
 2p2ar0hymcPNTCbsvCNQ5rEAAblyLMl6yXrLJKq36HMo+wRrlCHL7EK+8
 gvTgmRYUklXToEu+yZ2/k56YWKGdDfO3YwwJm+HE5WsKb/jhzHQsN9vwu A==;
X-CSE-ConnectionGUID: VjF829IpQDOUIwh8oBx0wg==
X-CSE-MsgGUID: pEMyHhVeRkiqi7Woo9vuog==
X-IronPort-AV: E=McAfee;i="6800,10657,11631"; a="66901803"
X-IronPort-AV: E=Sophos;i="6.20,248,1758610800"; d="scan'208";a="66901803"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Dec 2025 02:48:06 -0800
X-CSE-ConnectionGUID: UNL1Ww8zTaiSyYDH8wfrYw==
X-CSE-MsgGUID: RyV/cl+UQMq/ar1xr1KW1g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.20,248,1758610800"; d="scan'208";a="194018753"
...
Subject: [PATCH v3 4/8] drm/i915/psr: Move pr_dpcd and psr_dpcd to
 intel_connector
Date: Thu,  4 Dec 2025 12:47:29 +0200
Message-ID: <20251204104733.1106145-5-jouni.hogander@intel.com>
...
index c95d1e5724c32..89680d7cbabd0 100644

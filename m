...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 42A0A4E99B3
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 16:34:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B02B510E452;
...
Subject: [Intel-gfx] [PATCH v3 01/12] drm/edid: don't modify EDID while
 parsing

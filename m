...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sKh7EtVNEGq5VwYAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 14:36:37 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C7C425B42DC
	for <lists+intel-gfx@lfdr.de>; Fri, 22 May 2026 14:36:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F83A10F6B8;
	Fri, 22 May 2026 12:36:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=nicolas.frattaroli@collabora.com header.b="izx3pqbc";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com
 [136.143.188.112])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C722310F6B8;
 Fri, 22 May 2026 12:36:33 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1779453385; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=nrB+hC41MI6OPfN84lXwDWa48j3RKdv6pGTxVUuqyxOCCUKdLTAoEl3SRqCs4omO9cQvkvpRzT+TXZADw6SgkzlgdmjRje/fM+xghBoFpUdWFG/0y/XfyskhybBLhUvNMMlHxFhF508TVPWtVvDXXV2Lsg/rTrdk+yFlgIJe510=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1779453385;
 h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To;
 bh=agFvbtAhlJW1WPXelNZze1dnI9PB8xe3gaRUbAnwuyY=; 
 b=hYEFJFQWvVUB4QP1N2S4RcXLHvxPg9u8eseNYWpbAyZ460C1VbFM9hspgtqF1pABBZYZe+OLlkp3td8WM8HXU9DSZapA1JKLhrSC2FBB/+eNA0lU2YXVvfAGSLx7mS/fdnxOYH4WA2OwXBxRGv+Gq0r9+a2llj+06JLnH/b8vOc=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=nicolas.frattaroli@collabora.com;
 dmarc=pass header.from=<nicolas.frattaroli@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1779453385; 
 s=zohomail; d=collabora.com; i=nicolas.frattaroli@collabora.com;
 h=From:From:Date:Date:Subject:Subject:MIME-Version:Content-Type:Content-Transfer-Encoding:Message-Id:Message-Id:References:In-Reply-To:To:To:Cc:Cc:Reply-To;
 bh=agFvbtAhlJW1WPXelNZze1dnI9PB8xe3gaRUbAnwuyY=;
 b=izx3pqbcwyZp4RVA4h0JX0yzaD3mT85JesTOEDyfn/n3TOGDRzmR18ZBZ14s7249
 WqSFTWyf1V1thwkX9kBAdg+wFkNyX04mdrKmRdVhKDpRedPO8z05zKr7/6A8rliVmYn
 My/dBsEqWpHTzH6QuY2L7nfwFOSxbTLfvc4/extA=
Received: by mx.zohomail.com with SMTPS id 177945338304433.448539166139426;
 Fri, 22 May 2026 05:36:23 -0700 (PDT)
From: Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
Date: Fri, 22 May 2026 14:32:16 +0200
Subject: [PATCH v15 25/28] drm/tests: bridge: Add KUnit tests for bridge
 chain format selection
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260522-color-format-v15-25-21fb136c9df2@collabora.com>
...
X-Spamd-Result: default: False [-0.81 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,fooishbar.org:email,collabora.com:email,collabora.com:mid,collabora.com:dkim]
X-Rspamd-Queue-Id: C7C425B42DC

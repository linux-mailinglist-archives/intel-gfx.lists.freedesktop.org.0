...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B3DF4E90F5
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 11:17:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FE7A10EAD7;
	Mon, 28 Mar 2022 09:17:51 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 02/11] drm/edid: fix reduced blanking support
 check

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FE1CC98309
	for <lists+intel-gfx@lfdr.de>; Mon, 01 Dec 2025 17:10:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1F1510E428;
	Mon,  1 Dec 2025 16:10:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="K41ShZ92";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-dl1-f54.google.com (mail-dl1-f54.google.com [74.125.82.54])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E33C510E428
 for <intel-gfx@lists.freedesktop.org>; Mon,  1 Dec 2025 16:10:27 +0000 (UTC)
Received: by mail-dl1-f54.google.com with SMTP id
 a92af1059eb24-11beb0a7bd6so5650654c88.1
 for <intel-gfx@lists.freedesktop.org>; Mon, 01 Dec 2025 08:10:27 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1764605427; x=1765210227; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=ITWhguaUC98QYy5pkBWdIVw0/sOWPxITgfp9NKDf+OY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1764605427; x=1765210227;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=ITWhguaUC98QYy5pkBWdIVw0/sOWPxITgfp9NKDf+OY=;
 b=
X-Gm-Message-State: AOJu0YyF9iqrU21TkXfXzPoYDNBQFAOD9wCascJUp+2dbBgMgP1llEeK
 NSOfc5LntKrPFP3T1/x1dTyIcClMDHc+Nhg2oLRMDoAQUsDSbwpBUTXsoaaYxA5d
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IEknyLskvqBJFbd1uKtLZ9Fyl6zA36ledl2TxsYp1HwetGOwVpfS427hle6LCZvFATSmYd0DQ==
X-Received: by 2002:a05:701b:2818:b0:11b:b6f7:563b with SMTP id
 a92af1059eb24-11c94aefe78mr21592263c88.1.1764605426166; 
 Mon, 01 Dec 2025 08:10:26 -0800 (PST)
Received: from localhost ([192.55.54.43]) by smtp.gmail.com with ESMTPSA id
 a92af1059eb24-11dcb04a07bsm61216859c88.7.2025.12.01.08.10.24
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 01 Dec 2025 08:10:25 -0800 (PST)
From: Juha-Pekka Heikkila <juhapekka.heikkila@gmail.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Juha-Pekka Heikkila <juhapekka.heikkila@gmail.com>
Subject: [PATCH 1/2] drm/i915: switch to use kernel standard error injection
Date: Mon,  1 Dec 2025 18:10:12 +0200
Message-ID: <20251201161013.735943-2-juhapekka.heikkila@gmail.com>

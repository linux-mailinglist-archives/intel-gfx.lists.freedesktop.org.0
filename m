...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C726522ED7
	for <lists+intel-gfx@lfdr.de>; Wed, 11 May 2022 10:58:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D76B410E1F9;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/gt: Fix use of static in macro
 mismatch

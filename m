...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C43C03AC714
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Jun 2021 11:12:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 171676E9CB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 14/17] drm/i915/display: Add handling for new

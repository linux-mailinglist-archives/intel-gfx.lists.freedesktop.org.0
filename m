...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BC4135D350
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Apr 2021 00:43:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 950F76E09E;
	Mon, 12 Apr 2021 22:43:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 644216E092
 for <intel-gfx@lists.freedesktop.org>; Mon, 12 Apr 2021 22:43:37 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 13 Apr 2021 00:43:30 +0200
Message-Id: <20210412224330.515926-3-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/2] drm/i915: Use trylock in shrinker for ggtt
 on bsw vt-d and bxt.
...
index 941f8af016d6..9dc4d78e7ca7 100644
...
index 69e43bf91a15..3379163f4b91 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1704,9 +1704,15 @@ static inline bool intel_scanout_needs_vtd_wa(struct drm_i915_private *dev_priv)
 }
...
+	return IS_CHERRYVIEW(i915) || intel_ggtt_update_needs_vtd_wa(i915);
 ...
 /* i915_drv.c */
@@ -1786,6 +1792,7 @@ int i915_gem_object_unbind(struct drm_i915_gem_object *obj,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D8D9415689D
	for <lists+intel-gfx@lfdr.de>; Sun,  9 Feb 2020 04:54:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A06A6E48E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 01/18] drm: Add DP1.4 VSC SDP Payload related
 Data Structures

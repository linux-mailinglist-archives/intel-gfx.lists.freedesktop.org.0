...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11986532483
	for <lists+intel-gfx@lfdr.de>; Tue, 24 May 2022 09:55:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 55E8A10EC1B;
	Tue, 24 May 2022 07:55:31 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915: Complete and clarify per client usage
 stats documentation

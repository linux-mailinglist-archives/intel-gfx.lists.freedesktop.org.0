...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FB996BCFB8
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 13:42:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6263F10E156;
...
Subject: [Intel-gfx] [PATCH 0/7] Introduce new methods for verifying

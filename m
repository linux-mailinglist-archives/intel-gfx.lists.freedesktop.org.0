...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E87D16F0F45
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 01:49:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C880410E364;
	Thu, 27 Apr 2023 23:48:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1CBC210E201;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=cyLFuahclWuiDQy0air7F+6pvAqx9gEbePkawYj3DKsf0Yaw5D5gH0um
 B5GsQOsThu4leW52fTOYyDHi488as6gkFApInOdj9Eft5pbo4TzBuwhdQ
 sYmqAvE2q1Yzq7tXAKqN0t5F3nL9mrvDBm18a2DVQFYCqTvcXFRUv3/ti
 v0AS8ZiR4+d9HV0/fkkCfzNCf7otgApC8I9UTwcbliY/tCgFUyIJOYeyQ
 RtVtDBfJmujJc+QShuf9LHbKa4Lg4BiEv9rhgz0KjwkSVwAII6YhWR3sK
 91RtpFps4+mozPUwzLKACCIiTqpyfY0VgmztS9rz7T7yMeuKM5UhIjWKa Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="336634851"
X-IronPort-AV: E=Sophos;i="5.99,232,1677571200"; d="scan'208";a="336634851"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 16:48:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="764051954"
X-IronPort-AV: E=Sophos;i="5.99,232,1677571200"; d="scan'208";a="764051954"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga004.fm.intel.com with ESMTP; 27 Apr 2023 16:48:45 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Apr 2023 16:48:39 -0700
Message-Id: <20230427234843.2886921-5-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 4/8] drm/i915/pxp: Add GSC-CS backend to send
 GSC fw messages

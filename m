...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BF877DDA11
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Nov 2023 01:27:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD73D10E63F;
	Wed,  1 Nov 2023 00:26:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-il1-x12d.google.com (mail-il1-x12d.google.com
 [IPv6:2607:f8b0:4864:20::12d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 10A3810E631;
 Wed,  1 Nov 2023 00:26:49 +0000 (UTC)
Received: by mail-il1-x12d.google.com with SMTP id
 e9e14a558f8ab-35942cb9ef4so691995ab.3; 
 Tue, 31 Oct 2023 17:26:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1698798408; x=1699403208; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=BcqTwHq7sHXYNJa8WmhhNW6roNCK+d1UfmWS8347nH4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1698798408; x=1699403208;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=BcqTwHq7sHXYNJa8WmhhNW6roNCK+d1UfmWS8347nH4=;
 b=
X-Gm-Message-State: AOJu0YxH5FxxopfaZbdP+zZ0I3/ai9OOrdyA2ytSjYyK1YS43H7dhNhO
 Zp9PvlR7rghY07UZlFUIgK4=
X-Google-Smtp-Source: AGHT+IHvcqQlDIknOXSnqb2n6Um6z+Q2UEXSP+R7iLclSUbClv3jPZU21kR8KUqA4U1P6wYcmwUMqg==
X-Received: by 2002:a05:6e02:12c3:b0:34f:c7f7:18b with SMTP id
 i3-20020a056e0212c300b0034fc7f7018bmr19835858ilm.2.1698798408357; 
 Tue, 31 Oct 2023 17:26:48 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 t1-20020a92c901000000b00357cc8df1d5sm141701ilp.68.2023.10.31.17.26.47
...
Date: Tue, 31 Oct 2023 18:26:08 -0600
Message-ID: <20231101002609.3533731-23-jim.cromie@gmail.com>
...
Subject: [Intel-gfx] [PATCH v7d 22/23] drm-drivers: DRM_CLASSMAP_USE in 2nd

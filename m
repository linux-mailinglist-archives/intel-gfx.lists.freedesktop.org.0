...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F3CC7445E49
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Nov 2021 04:05:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9CD4B6E56D;
	Fri,  5 Nov 2021 03:05:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x833.google.com (mail-qt1-x833.google.com
 [IPv6:2607:f8b0:4864:20::833])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AD51B6E56D
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 Nov 2021 03:05:15 +0000 (UTC)
Received: by mail-qt1-x833.google.com with SMTP id w9so1001060qtk.13
 for <intel-gfx@lists.freedesktop.org>; Thu, 04 Nov 2021 20:05:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=poorly.run; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=w/eHmS/Y9B4JI0yybGtHe2Zw+5o/GlkhTKUlw+VrSZA=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=w/eHmS/Y9B4JI0yybGtHe2Zw+5o/GlkhTKUlw+VrSZA=;
 b=
X-Gm-Message-State: AOAM533yds8NSaxTI+WYUuVsE14Q0C90JaIzT3jIrMKsBdZC+sdiVy9P
 9VccNYrgo9C8oHovr2i3PTxgFg==
X-Google-Smtp-Source: ABdhPJz89bjQera8BJP6Cfk8MEBI1qFn1KcSahqBfAkoloMnqZWQPaRiUKsopMV1JURLrTCG/dIY/Q==
X-Received: by 2002:a05:622a:13cc:: with SMTP id
 p12mr59553821qtk.255.1636081514180; 
 Thu, 04 Nov 2021 20:05:14 -0700 (PDT)
Received: from localhost ([167.100.64.199])
 by smtp.gmail.com with ESMTPSA id o14sm5444311qtv.34.2021.11.04.20.05.13
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 04 Nov 2021 20:05:13 -0700 (PDT)
From: Sean Paul <sean@poorly.run>
To: dri-devel@lists.freedesktop.org, intel-gfx@lists.freedesktop.org,
 freedreno@lists.freedesktop.org
Date: Thu,  4 Nov 2021 23:04:24 -0400
Message-Id: <20211105030434.2828845-8-sean@poorly.run>
X-Mailer: git-send-email 2.33.1
In-Reply-To: <20211105030434.2828845-1-sean@poorly.run>
References: <20211105030434.2828845-1-sean@poorly.run>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v4 07/14] drm/i915/hdcp: Use HDCP helpers for
 i915
...
index 145d51ac43a3..bfdf586207d2 100644
...
@@ -3016,6 +3017,9 @@ static void intel_enable_ddi(struct intel_atomic_state *state,
...
@@ -3032,12 +3036,10 @@ static void intel_enable_ddi(struct intel_atomic_state *state,
 	else
...
@@ -3088,7 +3090,13 @@ static void intel_disable_ddi(struct intel_atomic_state *state,
...
@@ -3118,13 +3126,18 @@ void intel_ddi_update_pipe(struct intel_atomic_state *state,
 			   const struct intel_crtc_state *crtc_state,
 			   const struct drm_connector_state *conn_state)
 {
+	struct intel_connector *connector = to_intel_connector(conn_state->connector);
...
index ef3039fb1e0c..4391e28f04f6 100644
...
+#include <drm/drm_hdcp.h>
 ...
 #include "intel_de.h"
@@ -651,10 +652,11 @@ static void intel_hdcp_info(struct seq_file *m,
 		goto out;
 	}
...
index e4c375450138..fbce43393a97 100644
--- a/drivers/gpu/drm/i915/display/intel_display_types.h
+++ b/drivers/gpu/drm/i915/display/intel_display_types.h
@@ -355,70 +355,13 @@ enum check_link_response {
...
@@ -548,6 +491,7 @@ struct intel_connector {
...
index b8bc7d397c81..b413b97bf0df 100644
...
@@ -362,7 +361,10 @@ static void intel_mst_disable_dp(struct intel_atomic_state *state,
...
@@ -535,6 +537,8 @@ static void intel_mst_enable_dp(struct intel_atomic_state *state,
...
@@ -576,11 +580,10 @@ static void intel_mst_enable_dp(struct intel_atomic_state *state,
...
index ac05d2c6d3e7..47ecd1e28830 100644
...
index 3b5b9e7b05b7..6d03e4c6981f 100644
...
+
 ...
 {
 	struct drm_i915_private *dev_priv = to_i915(encoder->base.dev);
@@ -2872,6 +2766,38 @@ void intel_infoframe_init(struct intel_digital_port *dig_port)
 	}
 }
...
+
 void intel_hdmi_init_connector(struct intel_digital_port *dig_port,
 			       struct intel_connector *intel_connector)
 {
@@ -2925,13 +2851,7 @@ void intel_hdmi_init_connector(struct intel_digital_port *dig_port,

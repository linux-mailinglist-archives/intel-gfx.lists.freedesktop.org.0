...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6CAD5AAE47F
	for <lists+intel-gfx@lfdr.de>; Wed,  7 May 2025 17:23:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 61D1010E832;
	Wed,  7 May 2025 15:23:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="gdezFZKQ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2175C10E832;
 Wed,  7 May 2025 15:23:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1746631386; x=1778167386;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6L2wr0wlx/hKu+7/Qa+IxBX2Xh3zgRuneBQaURBaGmI=;
 b=gdezFZKQtJi8Zg8DQXePaCXWciQ2cFENKpON81rlXpfXoSSWTTBp9pli
 FdpWHV95AKmV8DRexBNacxewpHTgnyKfqqgl3llRCWz9ikL+DARCfxbcS
 kP2Q7FQPf+nojgbV7XKJdlUtsP61M3pW8MbBvi5KqWP1ZTrdeV3I4wlkH
 PRMxtqdgSeNY+xPHamkAImRS7IvzPImS4ExOV9g1eDyL4Eq0ZrF0jEgB0
 k+8wCAt/7ZsRLXkrjGQDb6bUG+P5KOKqm4ywhMyPYztlzAYrOBqts30JF
 xSkQ3zehIHiZate+XfUpgxMC9ZtVVmiJ5VsH6qNlU9KNUYYfjzUH7jmMX w==;
X-CSE-ConnectionGUID: IgCMXWxERuSHdCf5nigXhQ==
X-CSE-MsgGUID: 3A3FW4xwRRS1O7vmONhKoQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11426"; a="59028340"
X-IronPort-AV: E=Sophos;i="6.15,269,1739865600"; d="scan'208";a="59028340"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 May 2025 08:23:06 -0700
X-CSE-ConnectionGUID: v1hxOu37QRW4eMWofJLt3w==
X-CSE-MsgGUID: KVGpZQktTtCei5ZOcTmRgg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,269,1739865600"; d="scan'208";a="140839974"
Received: from ijarvine-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.244.218])
 by fmviesa005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 May 2025 08:23:04 -0700
...
Message-Id: <20250507152254.2398934-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.39.5
In-Reply-To: <d70bb3237430766071148977c128492a8711bec3.1746610602.git.jani.nikula@intel.com>
References: <d70bb3237430766071148977c128492a8711bec3.1746610602.git.jani.nikula@intel.com>
MIME-Version: 1.0
...
index a77e5b26542c..0ea12c68cedb 100644

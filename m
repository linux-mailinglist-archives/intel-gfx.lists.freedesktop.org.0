...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4AA054A006B
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Jan 2022 19:52:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E0DFC10E7F6;
	Fri, 28 Jan 2022 18:52:22 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 5/5] drm/i915/guc: Allow user to override driver
 load failure without GuC

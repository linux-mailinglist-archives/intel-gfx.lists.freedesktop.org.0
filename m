...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DAB6C86323
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Nov 2025 18:24:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 312CC10E575;
	Tue, 25 Nov 2025 17:24:46 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=Nvidia.com header.i=@Nvidia.com header.b="Xgj183bz";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from CO1PR03CU002.outbound.protection.outlook.com
 (mail-westus2azon11010052.outbound.protection.outlook.com [52.101.46.52])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5D16E10E26E;
 Mon, 24 Nov 2025 23:45:29 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=WaLJvVJ26Qx6cFtr6NsarOigUV8numQENGkqZHDYW58=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=WaLJvVJ26Qx6cFtr6NsarOigUV8numQENGkqZHDYW58=;
 b=
...
Message-Id: <20251124234432.1988476-1-joelagnelf@nvidia.com>
X-Mailer: git-send-email 2.34.1
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: 8bit
X-ClientProxiedBy: BL1PR13CA0332.namprd13.prod.outlook.com
 (2603:10b6:208:2c6::7) To SN7PR12MB8059.namprd12.prod.outlook.com
 (2603:10b6:806:32b::7)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: SN7PR12MB8059:EE_|IA1PR12MB6578:EE_
X-MS-Office365-Filtering-Correlation-Id: 5ca02b2c-5323-44b3-6754-08de2bb377df
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
 ARA:13230040|366016|7416014|376014|1800799024|921020; 
X-Microsoft-Antispam-Message-Info: =?utf-8?B?a01Hc3dvS3FGUGhjZlRBRjNaMjVObEErRzdUQ0t0LytXOWdqMFRyaFZ0a2xH?=
 =?utf-8?B?elFGdFk5VlNBZUI4ZTRQWGVRQVRvbFB2NGh2UXNGbmJXcW9EKzdXTDBreXRU?=
 =?utf-8?B?bFVEeTA5bGcxQlBmc1ZzVnBpck1IRDNadkQ2TkZFay93SnJqZ1JpeW8zU05r?=
 =?utf-8?B?Y3NmSkxBMnl4MkkzMHY1ZVpsZ054NExUM2gwaW9hWGkrUW0xOGIyTkFHVWNB?=
 =?utf-8?B?aWN5SjZvQy85NTVjNTNDRVNxbU9mM2lsclZsQTF1OEFpTml0anU3K0xmdjAw?=
 =?utf-8?B?bTJ0c2RuOW5hQmxMbzB5UmNHdlVmb1dBaFNWOFZsY1RmTmpPQ2x5Ym9lL3VR?=
 =?utf-8?B?SStHR2IxRUpmZWQwWjNXbTB4U2l1d0tDNFdlYkpvY1lFbVhmVndIbXo0RXBz?=
 =?utf-8?B?bERJbUdYTXpTeU5LdUkxUVdxdVVobEwxWmc4VDVBb0gxSWpUT1ZmNDhOdW9u?=
 =?utf-8?B?SWlDK2NudW93M3JSM2RlMHJRVWJCV3pJc2dvcHBPYzNvTFJWcUJwTEtucm40?=
 =?utf-8?B?U1daSkNFdFFoa1JVQ25COEQyZDVEOUVEWGV2WkN6anhNc0UrRmJ4ZExqREZw?=
 =?utf-8?B?ZDVHb1RyMVB3dHdZcWJKU0o5QW03L0tHS05XM2dBSlkwYjErbCtzdlVDQ3lW?=
 =?utf-8?B?NHhVZ1BkVC9KVmdGT0tUS2pmUGYzczlYRzRzZE1lbnlxR0tDcGp2QzU3UE81?=
 =?utf-8?B?M2J5V0ltWmliQmFteENWRThpUUZsb3YzNGg1UWFJS2RJdmFIdkhieVhvZnQ3?=
 =?utf-8?B?eVRqNzVHNHZiMXRVMXNFNGFoVVlXMklOb1FraC9maEY3RFpuN0lxVEswVjkz?=
 =?utf-8?B?NStlUEExbzhhQ0o5dWJBUk5Yb0FZNTBhMFJHVGpOc1JsWnNzRjR6Uk9NNUM5?=
 =?utf-8?B?T1BnWGtoV2hqMlVZRHVJM3dGR0dpUmZpTEE1NFVXc0FTQ0lBdWlGaE9xUFVP?=
 =?utf-8?B?aTMzMTlFazZXRndDQmdhQXpVYU9OMnJBZXZuWFo3YW9zWjdXWkdob2dzZ3VE?=
 =?utf-8?B?NDdKd21VYzhTR0orVjRZcEowdzA1NlkxRnNnOGtoV0IzTWRla04vNFJpODBG?=
 =?utf-8?B?RHlwbFUxYXNDdW50MnhocTlLWVUrZlp3Y2I3czlyYmVUbWFsOG01aTRkcjRs?=
 =?utf-8?B?VUE0WUdFSjM2S0xvcjkrRlpSTmRJSE5xdWxsY25DaWlXZExaZk5yMzhyUGJ3?=
 =?utf-8?B?c0hROEZsQjhtMWpBMk4xSE5mekZiOFBpSElJaUlULzZPZTN4YmF6V0FxS0RH?=
 =?utf-8?B?SEtXUURsY0ZFeTB2WXd1Y2x3WmhxZmNZeHBCbjcvT0ZDWjVNbXdueTd6Z0ha?=
 =?utf-8?B?ajR4aGF3ZDZaeExvZ2k4UXZsN2YwTUZFckNhUlUwbys2NGlFcGZ3WWNuakk3?=
 =?utf-8?B?QzhDN08wbmk1T2VNVDI1NU1ISi9FTjNiUUFYQ1Azbnh6TDdxaEJkL05mTEda?=
 =?utf-8?B?WUJqT1VkNVRpRzJxMkpLSCtTV0lhazdwSnA5REJncUNlWDFoQTRsKzZOUVZZ?=
 =?utf-8?B?RFdqUHhJQUNrVE0zWDlSZE1RU2RJeTJnbG56UHNnSGpLblZJVjd2Y016enRJ?=
 =?utf-8?B?OFdjUitnWm82dHArc1Y3RVFXTW52SlVEMWttaXMrMWhHWHc0bjdmTlBOVlpH?=
 =?utf-8?B?dXpDVjRtQ0J6MEFBbWxJRi9vTWFpSjhzUGZNQ2x0Y0dPVFN5UEpMU3hNWFhq?=
 =?utf-8?B?N2dvTENaNHZ5VlJZV081ZHRaSlhDYTN5R2E5TG5PZW50bGhZRnBWcWg4cmJp?=
 =?utf-8?B?YXQxYTkzR0tuZ29XTnJGd2Roa2NDbjFXZTMzRlFFaGZQMXk5WVNRbUlvSEEz?=
 =?utf-8?B?TmNkTkJoMVh3MHlDb2tWMWo1ak1XeTh2WlA0aHROUGExeURXQllVdm5PTWhD?=
 =?utf-8?B?VXdhWjFObjBPQU9yYlV4U2dsYW9mdGd1VjBoVW5KWWJtdmdSZEY3QVc0MVov?=
 =?utf-8?B?eTAxMEk0SUdVWksxSjlTNkJ1OWI5UXdacUduWWZoOVA1WVBkeWR5WlFhUDlG?=
 =?utf-8?Q?tESU3r+q8QC3koPUG/FrutCFLgzyfQ=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:SN7PR12MB8059.namprd12.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(366016)(7416014)(376014)(1800799024)(921020); DIR:OUT; SFP:1101;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?Q0N4M1lXK0Naa2dPMWZLODJ5V0swamQxbEx4bUpzRkZCUXpqNnY0ZDdrVm4r?=
 =?utf-8?B?U0gvT0M3cUZPMkJQeldmc1FWb3o4L1hXa1BNM3R0anI2cmhXdldCSitXc1RD?=
 =?utf-8?B?UWFnSkFnays3dkUxa1RVVFRjRlowNW9zSGNLSUFsbzNZWTdla0RFYzJjQmJp?=
 =?utf-8?B?eFJKSTRZcnE5RDdtNjRkZkdPYW9XS1A3MUlKUUNLdEw0Vm5CT2J5Rjk4STVn?=
 =?utf-8?B?YnhndE0zbHMvd1lFRjk3V3VPTTRqb011Mk1sV0d5NmlpeExEclo3enRrN3Rr?=
 =?utf-8?B?WXJxR0g4U0ZzU3B6eE4zVGpyYVpMeUNTcFpFT0ZZVFRaQUlpeER2V2F5NXRL?=
 =?utf-8?B?QVlsNmxyL20rZzBuNmZKcVpTek53MzRuNWtkVW9jNnFyQ3ZDdXYwSVZmNjBv?=
 =?utf-8?B?Skk4dDdqUlppUEYzbWJmVnlWekd2d0dPc2ZmVTQ3Q2NRUVBQQWJ5V05IRDZE?=
 =?utf-8?B?VGpZMGVlVnFIU3ZsbW1kYmUybnlSZEFoRUo2b3Z0M2lCcm9YaCt0b3YzYVF1?=
 =?utf-8?B?eFI0VDA0ZlpNbUl1R2NxSVR0S1c0UDJKQkU2SGNoWUJUOUNBZURMWG13cExt?=
 =?utf-8?B?ZkNKNzZEL2pSajFjeU1zSXJkVHBlbGp6d045VkVKU3VDYnVZRDdmcGtpemFL?=
 =?utf-8?B?VmZDVWZNM0VVYmRYTXYzL3JjYTNOQWJHUXdLRWZGSVk0eSs5S3NlWkNjQWFS?=
 =?utf-8?B?Y0tNY2Jab2ExZVZLZnp6MjJXSVdYelNUU0MveWltemRpVEY3U2ZXTXgwZXZD?=
 =?utf-8?B?YXp5Nmd2cGhXNjltY2NhSVRpdjZoeGUwOFUxK0FBTEE1eSt1bm03WUx5M3hZ?=
 =?utf-8?B?dXJnSXdMRUxEV0gzaXJsaExnUWRTR2ZBdHcvNkFjMUd3OVV5amxMWm1pNVly?=
 =?utf-8?B?NjhXZFFrRXZoc3BzNGIveWphZ2I3ckJOa1RWbC9RakQrMFhMUjJITW11a2hy?=
 =?utf-8?B?UXd5WWJFNE8yODRad0FhSFhjb0dxWW4zUTl0UkZXQk5TTTYwbDFMYVRnckZn?=
 =?utf-8?B?WkE0N052SUlXSW96VVU5QmFWYXhONlRlT2ZpRFhiNCsxTTRpelMwVVRBSy9t?=
 =?utf-8?B?Vy9jK0FkNExCT1RqdEZnOFBSRjVNbXFweWVxVUxoWlludEZ4ZFVjZ1l1R1hv?=
 =?utf-8?B?dm5WQnNKRExvY2N0L21pR09WQ0MyNXVoeWpEdmhzaDF0NVN1azRHQW85dkpC?=
 =?utf-8?B?c1NIcEJSc25qNEJZZWQwUkI3UHZHajVsWUNYVTdLU2FGYVBUSFRIUzB0RWcr?=
 =?utf-8?B?YVB0SG1NclhienVGMFNCSzdLNmNHc1hBdG1vMTgxeVpOaGd6UThoWjBINGF5?=
 =?utf-8?B?Y1doTTNyUjdNNUMwdldvT3JoYkRKWWxiZ3N2SDNmTk1ZaVRkSnRRVEs0WkNM?=
 =?utf-8?B?RGI1WUVhK3hBQ1pFVStkaWY4SUtvbGFsdVdzUlR4YWpZTHNQWDBCQkZTbWRH?=
 =?utf-8?B?aDFkNjRoS0RtUytyWjl0Yy9oTSswemgyejY4TmxzamowRnRzZnVHeGhMT3Ex?=
 =?utf-8?B?bXFwRVI5czQ4NHBYb1A0eUMxa0FpeTRaNlJFTEF4SlJ6bDJ5R1ZvQjNPM1FE?=
 =?utf-8?B?Nm80Y21sdE1UZTBYQ2t3OCtpejJHaDZRd0VIVGZlSkRFb1V0RmlJeTlCdHZW?=
 =?utf-8?B?MnRaWm9HTkM2dVNhNE9mS3ZQak5ienZxcDUyRlUyU2t2K2svOE9OQjRjK1Y4?=
 =?utf-8?B?LzBKUlFEdVRBcmR2YndURU14R0JSNGxkNG0yWi8xWSsyTWpOMkxmdFdPakt4?=
 =?utf-8?B?WFEwRDhYOU1ITU1ydnVrT1BJK3JMbS8vSVFpZ0RsVElqdDA0NTlsK3YwN01B?=
 =?utf-8?B?MFRhM3NLNThGcURSZTVqVGp2NC9TOFIyTUpPSUdEKytyQmxLeTB5VXUzUlJZ?=
 =?utf-8?B?SkxwNENPNm1oOGNpeWpaT1llS1QyMi9KdDQ2SU41VDhoYjh5dlh1VmZtSDlU?=
 =?utf-8?B?ZXJ0MzcwbWpsSVpVQ3ZHZE5tb1hTM2QrMU9Ra0I3K2RxcnZzRjhIcDVoMHpp?=
 =?utf-8?B?R05zSEk2NkpkTlhFYjk2QUcyb0lWSm1ZcWpxTnZxd0Fodm9CV3l6eUdycnpE?=
 =?utf-8?B?Q0NRTEJ1MlZCMEpubkZOWmlBbStMVytUZjIyRXp6d2ZRT3RSbXNkaG5aRTFT?=
 =?utf-8?Q?X/2S1pEX7SH3qcc7aPpaaHIBC?=
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 5ca02b2c-5323-44b3-6754-08de2bb377df
X-MS-Exchange-CrossTenant-AuthSource: SN7PR12MB8059.namprd12.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 Nov 2025 23:44:54.6263 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 43083d15-7273-40c1-b7db-39efd9ccc17a
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: vdrb8r3awVX1rWmyJwwdjjnQk27PCoPcJl2EpDA+UrSqXJ6DXpA9fDeQlQskE8eEaiHalRP2t6VXKiSHRYbUxw==

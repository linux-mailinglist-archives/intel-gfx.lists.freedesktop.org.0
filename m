...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FDAD42E072
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Oct 2021 19:49:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E67C6E89C;
...
Subject: [Intel-gfx] [PATCH 04/25] drm/i915/guc: Don't call

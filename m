...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B439349922
	for <lists+intel-gfx@lfdr.de>; Thu, 25 Mar 2021 19:08:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E34386EE2F;
	Thu, 25 Mar 2021 18:08:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EF3F66EE29
 for <intel-gfx@lists.freedesktop.org>; Thu, 25 Mar 2021 18:07:33 +0000 (UTC)
IronPort-SDR: MXdJmfVAgHEvgQymeB5XY5RqTrMwdP+shleJMjuYRL+IuKaO2eDzJEPgR4ufuAtu91sD3YpWfa
 3tRQbzePY4Nw==
X-IronPort-AV: E=McAfee;i="6000,8403,9934"; a="178112556"
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="178112556"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:33 -0700
IronPort-SDR: mrTjjfqrun5HlH9s9lGfq949CeHuWvPTq/JzQ9B8U6PGY2VNCHw9WzDOiTqYpi+B51FxLZ88ih
 VGedE9l/JGRQ==
X-IronPort-AV: E=Sophos;i="5.81,278,1610438400"; d="scan'208";a="453176683"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.168])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2021 11:07:33 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 25 Mar 2021 11:07:03 -0700
Message-Id: <20210325180720.401410-34-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 33/50] drm/i915: Move
...
eS9pbnRlbF9jZGNsay5jCmluZGV4IDg1ZGE4YzQzZDVkNi4uNGM0NDFiMzU5ZDdmIDEwMDY0NAot
...
ZWxfZGlzcGxheS5jCmluZGV4IDI2NTUxOGJjMTk3ZS4uMzNjZGM0MTljNjI3IDEwMDY0NAotLS0g
YS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYworKysgYi9kcml2
ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYwpAQCAtOTU5OCw2ICs5NTk4
...
ZGlzcGxheS9pbnRlbF9kaXNwbGF5LmgKaW5kZXggNWIxOTk1Mzg0MGFhLi4xMWViMGYwMmJlZTMg

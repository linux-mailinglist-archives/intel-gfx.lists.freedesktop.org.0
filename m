...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FA5CC19CA7
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Oct 2025 11:39:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 39E8F10E793;
	Wed, 29 Oct 2025 10:39:58 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UDa/FCQC";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C69B910E790;
 Wed, 29 Oct 2025 10:39:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761734397; x=1793270397;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=mRwyXLYVwmKexTRQCbiy7hcUs46oHUMqVP4BdBj2CtE=;
 b=UDa/FCQCVxnr+lXOYR59kSiHcYSQ0x0Wh1ws4vdh5jMTy5RjgRQ54fwG
 uyO7Oiv/un7d3/LqP52PNnKbX9eqoRmtzK5TpHMSwlnjp2bIOpzHhSQyH
 f/YW54MNZX6+KaLkyvRgydSi2R126/DhEJt+aNwbVH7qIG8IAU8hQu0tm
 f5qKGf5JVS2a6IMH8NKoMDViu5vKYW//6BP2F0EOiSS7O+q/wPOg6wbej
 nefGOM/+uBy7UzI2+0LrOHie291kqUr6cdqKBZbuzK/o9shLmvM2Slmx1
 3adiSN5vWmg7ziDszIGHgrskuDWzVLrJydGTzonJelV6fCe/Rokao7WQx Q==;
X-CSE-ConnectionGUID: NohHYDLdTS63WYlkifhiqA==
X-CSE-MsgGUID: tOtmkNs2ThurT9wv8BUQCg==
X-IronPort-AV: E=McAfee;i="6800,10657,11596"; a="66467177"
X-IronPort-AV: E=Sophos;i="6.19,263,1754982000"; d="scan'208";a="66467177"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Oct 2025 03:39:56 -0700
X-CSE-ConnectionGUID: h1CBf0kyTO27UdAtP7Nrgw==
X-CSE-MsgGUID: gUJeIumYTkq65StHzNOkpw==
X-ExtLoop1: 1
Received: from ettammin-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.160])
 by fmviesa003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Oct 2025 03:39:54 -0700
...
Subject: [PATCH v3 0/4] drm: replace drm_print.h includes from headers with a
 forward declaration
Date: Wed, 29 Oct 2025 12:39:44 +0200
Message-ID: <cover.1761734313.git.jani.nikula@intel.com>

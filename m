...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FF15819BD
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Aug 2019 14:43:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFFD26E47A;
...
Subject: [Intel-gfx] [PATCH v5 02/18] drm/vram: use embedded gem object

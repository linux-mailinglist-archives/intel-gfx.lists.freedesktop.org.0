...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BBDBDD24792
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jan 2026 13:29:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAAC310E74A;
	Thu, 15 Jan 2026 12:29:32 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="g+3y4CbB";
...
Received: from us-smtp-delivery-124.mimecast.com
 ...
 by gabe.freedesktop.org (Postfix) with ESMTPS id 90F3010E753
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Jan 2026 12:29:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1768480170;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type;
 bh=wp62IAblmjf2cdmiyyJKUfUX1geHsq0NaKyZVo0SXeY=;
 b=g+3y4CbBUT4m5wOK7DYu27yc6YtMgK41g6y8yQHoBEotY9J6gNQB0/+ZNIRbD4gFmAXKS2
 bve/rOIRK+PA3cW9Wxtrq2VsodWxPqqd7nBZk9mramLCpt3ESLhujEgvpdIw1jd0BkCQ5M
 i8C4JSos+9hcb+nXMxzCvj42R7GjjpY=
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 [209.85.128.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-392-A8qEaTGfOFO5F9fPAPNEdg-1; Thu, 15 Jan 2026 07:29:29 -0500
X-MC-Unique: A8qEaTGfOFO5F9fPAPNEdg-1
X-Mimecast-MFC-AGG-ID: A8qEaTGfOFO5F9fPAPNEdg_1768480168
Received: by mail-wm1-f72.google.com with SMTP id
 5b1f17b1804b1-4801bceb317so3906725e9.1
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Jan 2026 04:29:28 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :reply-to;
 bh=wp62IAblmjf2cdmiyyJKUfUX1geHsq0NaKyZVo0SXeY=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCWMurhyb+imGxy1IysNLOehn+9kbp6VV2eFv8vM9CMVXYWFmMKx1qgvz5GA/kZfhhIMNQmCMbrTZEM=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YzXEIUEIvDTn978NKKn1mwCPsYks6omM+fUaUSK2dIuOjW5gpRA
 IwQ33+Kt7xkm0LQJHDzaznGXBLdTwzt/sHMrWsYUbQvb9CcuJhoxCGQsW1b7bFGXd+q9ofKFO55
 Y/TK/urDh+hNRxlGxfYs69NLck7FwpsiT9PwnKXSYfVBlb7Pi3yyENuwBJ2ZqAlZ0AG6stQ==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:a406:b0:480:1d32:afc6 with SMTP id
 5b1f17b1804b1-4801d32b09fmr3466405e9.4.1768480167602; 

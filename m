...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC71388BED
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 17:36:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 697856E440;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/4] dma-fence: Propagate errors to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E86378791B
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Aug 2023 22:09:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0ECBB10E136;
	Thu, 24 Aug 2023 20:08:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 194E610E136
 for <intel-gfx@lists.freedesktop.org>; Thu, 24 Aug 2023 20:08:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692907736; x=1724443736;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=fd19+TMlATlYaKYNkfZOt5kpzvJXhPyIv9dV1DZN57Y=;
 b=IGTMpIX6OCAl5IRfWNIk+4TpiETCFU2FO04xjeSCR8vIvMRR1/A4zD0r
 Igo/vCW/0/lGNdlMb9P5a79dGx2PYd4ehkmAUV08BELEnspvI+n0xdGcj
 zj9sywdXAKAPuV8HS1KffviY4uAsq3wtb1zFBQPCrMQ0I8Sj6yH5+YGFQ
 1J47HxSNmRSsJc0Q/wP+9Mh5m1sQbVXUmxVRc2XMeuJ+Hvpk5N5/xH0YR
 8p9ZFfA2l6z5cFtdXt5W5viyCoqup3X2b1lb+w8O/k8CnhCnQeq1iGQSu
 8GjjAdMG/jcGsfZzCGlCR9509m1kUvo4FdxzzaMMkvhEFIbE5qjcL++7T g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10812"; a="364736159"
X-IronPort-AV: E=Sophos;i="6.02,195,1688454000"; d="scan'208";a="364736159"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2023 13:08:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10812"; a="687020846"
X-IronPort-AV: E=Sophos;i="6.02,195,1688454000"; d="scan'208";a="687020846"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2023 13:08:54 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 24 Aug 2023 12:58:15 -0700
Message-Id: <20230824195816.2127026-2-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/2] drm/i915: Add WABB blit for
...
index 239848bcb2a4..40cc0005dd73 100644
...
index def7dd0eb6f1..4917633f299d 100644
...
index 967fe4d77a87..975a752374e6 100644
...
index 5f826b6dcf5d..ba0d6293ddea 100644

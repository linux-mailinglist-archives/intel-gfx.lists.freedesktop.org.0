...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DA00255BC6C
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Jun 2022 01:04:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25B5910E262;
	Mon, 27 Jun 2022 23:04:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3EC2210E16F;
 Mon, 27 Jun 2022 23:04:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1656371040; x=1687907040;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=pZ4poRK6IlWYaDOXTXcoemEAPenECuKoyCcwScq4bDI=;
 b=LK0o/FmqS/E8Rnh97WucquSnHiz5ki048NXgf7HDPXhrMTm2FM00xwI0
 EOH4pF1S0L1gDJ3v4rkPSJ1w1ivKbYplX3u0P031UTvjvRojy9b8BSrUJ
 2wFtA+Dkm4N6AHlE8l/LopnhShWb8P2W9e5+rWhMovZYImQOrnIyOiD4Z
 JQQu06Dr3H8sqcoDlgSodbshcfr2jUxPNN0iNSTwpv9epBs8RG6i/7/7C
 jM8eq/KKulEG4bEYJnFekBTkXnRj5vmDtAd0YhNBl0IqSLUiI/LzC7MO+
 OwrgVEeStO34GmCinZoTYfatgTGDEw0ehdp35wKXZHcqTBfgQ6W0LINqQ w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10391"; a="307060257"
X-IronPort-AV: E=Sophos;i="5.92,227,1650956400"; d="scan'208";a="307060257"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jun 2022 16:03:59 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,227,1650956400"; d="scan'208";a="587632534"
Received: from vbelgaum-ubuntu.fm.intel.com ([10.1.27.27])
 by orsmga007.jf.intel.com with ESMTP; 27 Jun 2022 16:03:59 -0700
From: Vinay Belgaumkar <vinay.belgaumkar@intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Mon, 27 Jun 2022 16:03:46 -0700
Message-Id: <20220627230346.27720-1-vinay.belgaumkar@intel.com>

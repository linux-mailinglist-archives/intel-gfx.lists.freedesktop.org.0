...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF6C04AD5A0
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 11:45:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5179010E699;
...
Subject: [Intel-gfx] [PATCH v2 15/18] drm/i915/guc: Use a single pass to
 calculate regset

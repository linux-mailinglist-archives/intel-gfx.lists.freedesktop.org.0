...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 55C74885C6D
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Mar 2024 16:45:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26E0D10EE58;
	Thu, 21 Mar 2024 15:45:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="MgHlEeF7";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DD4F410EE35
 for <intel-gfx@lists.freedesktop.org>; Thu, 21 Mar 2024 15:45:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1711035903; x=1742571903;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=AsoG1iIOLhSQ4K/PIRDrRa0n9WwRr3wmERG7lpBf0+I=;
 b=MgHlEeF7wHe06TPH8IzVcb0QNZnE2vv2pVUYBSr/PgKQLd/62YTjlKXa
 vstTjd2cBKyqLD+W2Xc5mUD+rNxIkmMyxLTrSqBBxnN+3boF3EuTd/eGS
 od+ErDxYUXlygW+w8I8WpB8DQhQVfu5CNwsxend6kQuvd7iCbgb84Ept/
 ClsASPCJjRGc9h+iiuXcTreuJF9TD0OR7K7MqBfmwUV/1D9C0mVGoauao
 SmBnvS0YQLwOQ2ICIheid6YSQ60LGg3bzW/uCT1u6gcQbf60GPQkjZdOm
 knKb4Cvjb1Scg2DLdNbv/zqzitunR5vPhbJNkdiROHRgjDD5yNw3jleKg g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11020"; a="5867564"
X-IronPort-AV: E=Sophos;i="6.07,143,1708416000"; 
   d="scan'208";a="5867564"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Mar 2024 08:45:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,143,1708416000"; d="scan'208";a="19018758"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmviesa005.fm.intel.com with ESMTP; 21 Mar 2024 08:45:00 -0700
...
Subject: [PATCH v18 4/9] drm/i915/dp: Add Read/Write support for Adaptive Sync
 SDP
Date: Thu, 21 Mar 2024 21:08:18 +0530
Message-Id: <20240321153828.3815870-5-mitulkumar.ajitkumar.golani@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C28E50F70C
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Apr 2022 11:19:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9F04110EA88;
...
Subject: [Intel-gfx] [PATCH 2/2] drm/edid: drop kernel-doc for static
 functions

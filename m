...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ECDBD26C44D
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Sep 2020 17:35:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A87BC6EA49;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 5/8] drm/i915: Add dedicated plane hook for
 async flip case

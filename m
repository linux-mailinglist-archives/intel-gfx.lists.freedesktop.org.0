...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EFF9C69A8FE
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Feb 2023 11:21:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 709A410EF46;
	Fri, 17 Feb 2023 10:21:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 750BD10EF46
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Feb 2023 10:21:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1676629297; x=1708165297;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=qahpswAfIFXtPhSf7zY8ACklONx9kA1c+G70jl9sStw=;
 b=grvXprQmnt+XOB3B7WJfxLsj0Tu4YTsNjyg29VnZWI6Q/CTMwJACVexP
 FpI7zZ64LPVE1znKLyKAF55qZOnpTJ69vb8mgLXiJVGko8A20RLWF7V8U
 ogqeuaglpJrLq/o8LcNtTByFcRkJHutdvcTtE6RaS7LruEk1yiER1o7Qt
 FSigotzpo0kSvJEf0nVQq+mCKYPKKIbcpZxLnW4f3ZVoC0aPTjt+/Fve5
 Vn2zOkxBab7nNnzgpLWAydX7b4Asj+DCoFJDc1ptXGlU/1hv/D37zSIyY
 2feFFGHsmLlF/Qp2QwRacaLkbDyrXo9EwcA4RPuJWMNQbzrtLubVXBvj1 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10623"; a="333317011"
X-IronPort-AV: E=Sophos;i="5.97,304,1669104000"; d="scan'208";a="333317011"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2023 02:21:32 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10623"; a="670497021"
X-IronPort-AV: E=Sophos;i="5.97,304,1669104000"; d="scan'208";a="670497021"
Received: from ideak-desk.fi.intel.com ([10.237.72.58])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2023 02:21:30 -0800
Date: Fri, 17 Feb 2023 12:21:27 +0200
From: Imre Deak <imre.deak@intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Message-ID: <Y+9VJ4WjNGYsVPTL@ideak-desk.fi.intel.com>
References: <20230216161739.668294-1-jani.nikula@intel.com>
 ...
 <874jrkzjz5.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <874jrkzjz5.fsf@intel.com>

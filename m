...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BC6956B141
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Jul 2019 23:42:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 108B36E0E4;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 Yn5Q==
Subject: [Intel-gfx] [PATCH v3 2/3] drm: plumb attaching dev thru to
 prime_pin/unpin

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E5D7F4DCE20
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Mar 2022 19:54:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6DDD10E656;
	Thu, 17 Mar 2022 18:54:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5A77910E683
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=T7yz1VCHojid4N5qIHYtAL0chruiFWCALvPbSekprh7J2lgZ2CTKTt+n
 l322IrnnjmRazdJxU330+bfBjtSv6czt2jpa/A6CEQ5nq1vWuDc17xWcz
 M+X6ualzXOe28E0T+P83BGe+G4HBkySL7vBQrUEhchNQUBxgPc+S4oKWT
 4gjNOdjdUclWv8AsPe15XTLbdK3hii22X5XRc2r6s9jLyNARUdRwiulk2
 rHV3L0tLDaZgZzSIcLqh0keJrZ+UaJCWd90yyiCA9gGBJY5ABu927YVCq
 lC4zaSz2IE84fF6kFueg8ozYKtwe2L2wD0GXM8PUhnSvP1PYnW62f26Et w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10289"; a="281749734"
X-IronPort-AV: E=Sophos;i="5.90,188,1643702400"; d="scan'208";a="281749734"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Mar 2022 11:54:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,188,1643702400"; d="scan'208";a="581405081"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga001.jf.intel.com with ESMTP; 17 Mar 2022 11:54:27 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 17 Mar 2022 11:56:52 -0700
Message-Id: <20220317185655.1786958-11-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 10/13] drm/i915/guc: Extract GuC error

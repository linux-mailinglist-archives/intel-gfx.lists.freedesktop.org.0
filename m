...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6C6D42CBC9
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Oct 2021 22:49:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 045CC6EB3F;
...
Subject: [Intel-gfx] [PATCH v4 10/20] drm/nouveau: cleanup:

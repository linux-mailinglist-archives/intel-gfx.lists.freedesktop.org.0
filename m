...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9273D8BE192
	for <lists+intel-gfx@lfdr.de>; Tue,  7 May 2024 14:04:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E11B112AEF;
	Tue,  7 May 2024 12:04:32 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="g+VrA3it";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="hxdnzbLG";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="g+VrA3it";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="hxdnzbLG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A7D1410F585;
...
Received: from imap1.dmz-prg2.suse.org (imap1.dmz-prg2.suse.org
 ...
 by smtp-out2.suse.de (Postfix) with ESMTPS id F217320951;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 ...
 bh=1rlnhAb4uk7Z6RAcCrxTShiVkOdyMn01rJtEAndOtos=;
 b=g+VrA3it/+G6r8HEgrE6pVqVP4KpwrmqDqJPLQoAbkp9vJvl9CaJYNaBKqKSlJ13uZmw0D
 0FTX7f/D/l6udm19V7Flj5R1gFN7fOiiz6NrLWNnbU/NCW5Bx/yRqXb6aDHVUxYO35CZwM
 qxmk2XkCua8rI1QlxQgEGOVrYSHfGkA=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 ...
 in-reply-to:in-reply-to:references:references;
 bh=1rlnhAb4uk7Z6RAcCrxTShiVkOdyMn01rJtEAndOtos=;
 b=hxdnzbLGWJs4KsGyJ9tEe9Jy9KkxL2mbiBgACPglQURF2SOVY180jJ3ZgVgcZm/V3Upvf5
 lnaeMEQUUFDlbhBQ==
Authentication-Results: smtp-out2.suse.de;
 dkim=pass header.d=suse.de header.s=susede2_rsa header.b=g+VrA3it;
 dkim=pass header.d=suse.de header.s=susede2_ed25519 header.b=hxdnzbLG
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1715083468; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 3CFFA13A3C;
 Tue,  7 May 2024 12:04:27 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id +H2zDcsYOmZDCgAAD6G6ig
...
Subject: [PATCH 02/11] drm/fbdev-dma: Use fbdev client helpers
Date: Tue,  7 May 2024 13:58:23 +0200
Message-ID: <20240507120422.25492-3-tzimmermann@suse.de>
...
@@ -189,60 +188,9 @@ static const struct drm_fb_helper_funcs drm_fbdev_dma_helper_funcs = {

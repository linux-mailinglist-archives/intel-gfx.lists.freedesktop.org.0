...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F3B0962D6FF
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Nov 2022 10:30:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D93D310E5CC;
...
Subject: [Intel-gfx] [PATCH v10 15/19] drm/vc4: vec: Use TV Reset
 implementation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AC7422D8E
	for <lists+intel-gfx@lfdr.de>; Mon, 20 May 2019 10:02:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA78D89243;
	Mon, 20 May 2019 08:02:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 44C0E8920E
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 May 2019 08:02:04 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16610884-1500050 
 for multiple; Mon, 20 May 2019 09:01:36 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 20 May 2019 09:01:23 +0100
Message-Id: <20190520080127.18255-29-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 29/33] drm/i915: Replace engine->timeline with a
 plain list
...
bS9pOTE1L2d0L2ludGVsX2VuZ2luZS5oCmluZGV4IDFhZTI5MzRiN2VjYy4uYjhmNWM0ZTFkMzll
IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9lbmdpbmUuaAorKysg
Yi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9lbmdpbmUuaApAQCAtNTQ0LDQgKzU0NCwx
...
bmVfY3MuYwppbmRleCBhY2QzYmMzM2E5OWMuLjEyMGY3N2FmNGMzOCAxMDA2NDQKLS0tIGEvZHJp
dmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfZW5naW5lX2NzLmMKKysrIGIvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZ3QvaW50ZWxfZW5naW5lX2NzLmMKQEAgLTU3NywxNCArNTc3LDcgQEAgc3RhdGlj
...
ZSk7CkBAIC01OTcsMTAgKzU5MCw2IEBAIHN0YXRpYyBpbnQgaW50ZWxfZW5naW5lX3NldHVwX2Nv
...
ZXJyOwogfQogCiAvKioKQEAgLTc1Nyw2ICs3NDYsMjcgQEAgc3RhdGljIGludCBwaW5fY29udGV4
...
aXRpYWxpemUuCkBAIC04MjAsNiArODMwLDggQEAgaW50IGludGVsX2VuZ2luZV9pbml0X2NvbW1v
...
ZW5naW5lKTsKQEAgLTgzNCw4ICs4NDYsNiBAQCB2b2lkIGludGVsX2VuZ2luZV9jbGVhbnVwX2Nv
...
KCZlbmdpbmUtPndoaXRlbGlzdCk7CkBAIC0xNDQxLDE2ICsxNDUxLDYgQEAgdm9pZCBpbnRlbF9l
...
dChtLCBycSwgIlx0XHRhY3RpdmUgIik7CkBAIC0xNTMxLDcgKzE1MzEsNyBAQCBpbnQgaW50ZWxf
...
dHMuZW5hYmxlZCA9PSB+MCkpIHsKQEAgLTE1NTcsNyArMTU1Nyw3IEBAIGludCBpbnRlbF9lbmFi
...
fQpAQCAtMTY0MiwyMiArMTY0MiwyMiBAQCBpbnRlbF9lbmdpbmVfZmluZF9hY3RpdmVfcmVxdWVz
...
ZXggZDNkNWE1MDVmNjIxLi5lMDA0NDNmNTNiNTkgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2d0L2ludGVsX2VuZ2luZV90eXBlcy5oCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1
L2d0L2ludGVsX2VuZ2luZV90eXBlcy5oCkBAIC0yODYsNyArMjg2LDExIEBAIHN0cnVjdCBpbnRl
...
ZWxfbHJjLmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYwppbmRleCAzMzFh
NjQwNjBjMzIuLmVjYTk5N2U4N2ZlNCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUv
...
X2VuZ2luZV9jcyAqZW5naW5lKQpAQCAtMzAwOSwxMiArMzAwOCwxOCBAQCBzdGF0aWMgaW50IGV4
...
LT5jb250ZXh0LmluZmxpZ2h0KTsKIApAQCAtMzAyNSwxMyArMzAzMCwxMyBAQCBzdGF0aWMgdm9p
...
dmUtPmJhc2UuZXhlY2xpc3RzLnRhc2tsZXQpKTsKIApAQCAtMzAzOSw4ICszMDQ0LDYgQEAgc3Rh
...
KTsKIH0KIApAQCAtMzE2MCwxNiArMzE2MywxNiBAQCBzdGF0aWMgdm9pZCB2aXJ0dWFsX3N1Ym1p
...
LT5yYikpIHsKIAkJCS8qCkBAIC0zMjEzLDcgKzMyMTYsNyBAQCBzdGF0aWMgdm9pZCB2aXJ0dWFs
...
dmUubG9jayk7CiAJfQogCWxvY2FsX2lycV9lbmFibGUoKTsKIH0KQEAgLTMyMzAsOSArMzIzMywx
...
OwogfQogCkBAIC0zMjk2LDEwICszMzAzLDcgQEAgaW50ZWxfZXhlY2xpc3RzX2NyZWF0ZV92aXJ0
...
aXN0cygmdmUtPmJhc2UpOwogCkBAIC0zMzEwLDYgKzMzMTQsNyBAQCBpbnRlbF9leGVjbGlzdHNf
...
ICAgdmlydHVhbF9zdWJtaXNzaW9uX3Rhc2tsZXQsCkBAIC0zNDY0LDExICszNDY5LDExIEBAIHZv
...
CQlzaG93X3JlcXVlc3QobSwgcnEsICJcdFx0RSAiKTsKIAkJZWxzZQpAQCAtMzUzMSw3ICszNTM2
...
YyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX3Jlc2V0LmMKaW5kZXggMDkxNjcxYzVi
YmI1Li5hYzViNzI3ZGU1MTQgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2lu
...
cm0vaTkxNS9ndC9pbnRlbF9yaW5nYnVmZmVyLmMKaW5kZXggZmM1OTZhZGM2MzdhLi45M2IwODkz
YzczNmIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX3JpbmdidWZm
...
dV9lcnJvci5jCmluZGV4IDcwNzgxMTI1NjUwMS4uNGNjOTAwZTQzMmUyIDEwMDY0NAotLS0gYS9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dwdV9lcnJvci5jCisrKyBiL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2k5MTVfZ3B1X2Vycm9yLmMKQEAgLTEyNjksNyArMTI2OSw3IEBAIHN0YXRpYyB2b2lk
...
bGluaykKIAkJY291bnQrKzsKIAlpZiAoIWNvdW50KQogCQlyZXR1cm47CkBAIC0xMjgyLDcgKzEy
ODIsOCBAQCBzdGF0aWMgdm9pZCBlbmdpbmVfcmVjb3JkX3JlcXVlc3RzKHN0cnVjdCBpbnRlbF9l
...
LmMgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3JlcXVlc3QuYwppbmRleCAxOTU5NTZhNzk2
YTEuLmE5OGU3ODFjYjE3OCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9y
...
dHMgYXMgc21wX21iKCkgKi8KQEAgLTExMzQsOSArMTExOSw3IEBAIF9faTkxNV9yZXF1ZXN0X2Fk
...
dmVycy9ncHUvZHJtL2k5MTUvaW50ZWxfZ3VjX3N1Ym1pc3Npb24uYwppbmRleCAzODlhOTEzMWQ0
MTMuLjI0MGM4YTJhYWJjMiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaW50ZWxf

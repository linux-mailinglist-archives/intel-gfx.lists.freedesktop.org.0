...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2837667ABA2
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 09:27:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 35E1010E74F;
...
Subject: [Intel-gfx] [PATCH v7 2/6] drm/i915/pxp: add device link between
 i915 and mei_pxp

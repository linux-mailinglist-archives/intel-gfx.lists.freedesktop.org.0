...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 499284895D3
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Jan 2022 10:57:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AB6712B6E4;
	Mon, 10 Jan 2022 09:57:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BE10612B6E0
 for <intel-gfx@lists.freedesktop.org>; Mon, 10 Jan 2022 09:57:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1641808672; x=1673344672;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=RPL9HTrBm5zw4z3Q7dE5hE5XnxIflJnTMEgWXZxn5F4=;
 b=T6snY8/TocagyH9y148U8BR2k5PvI2CIW3DhvMvcKg9E6OL/KfZR6Mwv
 /H22BuzVWmQgCcaa/rwS2wy1qPdtsNACrCw8/yLzD/mDt5ch35D+Qwgm3
 4VdNpI5tNBlRX3c9/zSJ4J9R5Xq4QAangujop67nZRzjlrR/bWBl3qb9Q
 FtoH58pJbi1q3fNMZZARNg7qM0dJymXYxFTWMwcXXJETydpl3n6FVuyGF
 A/y21rxEiOyb7scgrtoYmAORHL5wMXdqmmvuyVkCZ0my7KY2taB9ieHVO
 qLxJolaQcExCOJacuB2wgbBSl3dUJ2IaqeKevd4e8ZRqU1yBw2xKI5Vhp g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10222"; a="267520940"
X-IronPort-AV: E=Sophos;i="5.88,276,1635231600"; d="scan'208";a="267520940"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2022 01:57:52 -0800
X-IronPort-AV: E=Sophos;i="5.88,276,1635231600"; d="scan'208";a="472022034"
Received: from bdoyle2-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.26.184])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2022 01:57:49 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 10 Jan 2022 11:57:38 +0200
Message-Id: <20220110095740.166078-2-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915: split out vlv sideband registers
 from i915_reg.h

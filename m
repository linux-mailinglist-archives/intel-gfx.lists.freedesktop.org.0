...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2AB1019651D
	for <lists+intel-gfx@lfdr.de>; Sat, 28 Mar 2020 11:44:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12F636EAD0;
	Sat, 28 Mar 2020 10:43:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8C18D6EAD0
 for <intel-gfx@lists.freedesktop.org>; Sat, 28 Mar 2020 10:43:55 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20722932-1500050 
 for multiple; Sat, 28 Mar 2020 10:43:46 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sat, 28 Mar 2020 10:43:46 +0000
Message-Id: <20200328104346.28988-1-chris@chris-wilson.co.uk>
...
---
 drivers/gpu/drm/i915/gt/selftest_lrc.c | 181 +++++++++++++++++++++++++
 1 file changed, 181 insertions(+)

diff --git a/drivers/gpu/drm/i915/gt/selftest_lrc.c b/drivers/gpu/drm/i915/gt/selftest_lrc.c
index 6f06ba750a0a..ff3db405efe6 100644
--- a/drivers/gpu/drm/i915/gt/selftest_lrc.c
+++ b/drivers/gpu/drm/i915/gt/selftest_lrc.c
@@ -350,6 +350,186 @@ static int live_unlite_preempt(void *arg)
...
+			GEM_TRACE_ERR("%s: failed to start semaphore\n",
+				      engine->name);
+			err = -ETIME;
+			goto err_rq;
+		}
...
+
 ...
 {
 	struct intel_gt *gt = arg;
@@ -3954,6 +4134,7 @@ int intel_execlists_live_selftests(struct drm_i915_private *i915)

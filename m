...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC0E94D9BE1
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Mar 2022 14:12:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0777710E4C9;
	Tue, 15 Mar 2022 13:12:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BBCA610E4C9
 for <intel-gfx@lists.freedesktop.org>; Tue, 15 Mar 2022 13:12:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1647349970; x=1678885970;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WvA2zLMW+QJMshDWce0+VdVAYqhNlv23e2HivekA5QQ=;
 b=B97XQ5sH014ou8GJ+A7KVwWKtaKd8+hYe85BVqezf5/WO68UJ3V9kfnc
 XVhO2/U9inNaDpp5H0ZWahTIuMEZvIA/9MoHvmiXg1hwV+2bd0RixSjVU
 w3oRX8WWTKd9sq4WR4Mk9V5dDYF27q2ICDWOvapblBZhRP8C0vA7WQ5rN
 HnXi2gRaf9FcXsVGxBiKdtacJlG6i7eO9oysqBnu6sFDTwp5oL2gebwW0
 Q+R7ahmcztJXErGA3Amgy2nkow+edVgkZqVZzJnEQClxvApJVrzcbSf0W
 lgeDvayXKn1BhhUoy5LLw+r8XtpRjHP0443/vEKWWuqc8EOdBl/XRfPbL w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10286"; a="253853035"
X-IronPort-AV: E=Sophos;i="5.90,183,1643702400"; d="scan'208";a="253853035"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2022 06:12:50 -0700
X-IronPort-AV: E=Sophos;i="5.90,183,1643702400"; d="scan'208";a="556920051"
Received: from sannilnx.jer.intel.com ([10.12.231.73])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2022 06:12:47 -0700
...
Date: Tue, 15 Mar 2022 15:11:54 +0200
Message-Id: <20220315131157.3972238-3-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 2/5] mei: add support for graphics system

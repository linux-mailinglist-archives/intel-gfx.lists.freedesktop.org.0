...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 06944A5781
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Sep 2019 15:15:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 274F889B05;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/2] drm/edid: Have cea_db_offsets() zero

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 35D138118BB
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Dec 2023 17:08:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79F8E10E280;
	Wed, 13 Dec 2023 16:08:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AF6A510E280
 for <intel-gfx@lists.freedesktop.org>; Wed, 13 Dec 2023 16:08:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702483728; x=1734019728;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=APR6Uczfz3CW3GBrsFxyFY5QKLXGhBfewnFRMOV0qcI=;
 b=Vty3YBoKab6cVX/Yj1wMyDk0ZC4Pj6FGGJjoxUiJlJo8K0iFLag131DN
 xxEWYNyKpArJhPw7qiRYnEZ+uMv+ukQ7zKe+jL8Gb8xcgroUl9KtqX/fd
 hiFqauP9tBbjWRvB0p1x19JQwhevKo8GwAQsgboXtn+DWo8LkVoNjSH5N
 YsW+tJku7XvbGDvQNWQ1x/Pt/lhfvLlKJNmfh1NnBUfYvxNZgldUWS5qQ
 zpBGpYQ1b7BjByK3lt5LFTKT/fgCvaJZhV8QP/FSfFEVo/9JfUhOJWp27
 S0uXRK5R/y2M4rW8uDnZvO8oBsjCrBmlp1Bn/pwWvt20ZxMahasiVu2MZ A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10923"; a="374496159"
X-IronPort-AV: E=Sophos;i="6.04,273,1695711600"; d="scan'208";a="374496159"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Dec 2023 08:08:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10923"; a="767260614"
X-IronPort-AV: E=Sophos;i="6.04,273,1695711600"; d="scan'208";a="767260614"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga007.jf.intel.com with SMTP; 13 Dec 2023 08:08:45 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Wed, 13 Dec 2023 18:08:45 +0200
Date: Wed, 13 Dec 2023 18:08:45 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Andrzej Hajda <andrzej.hajda@intel.com>
Subject: Re: [PATCH 01/12] drm/i915: Use struct resource for memory region IO
 as well
Message-ID: <ZXnXDSRoXI71798e@intel.com>
References: <20231213004237.20375-1-ville.syrjala@linux.intel.com>
 <20231213004237.20375-2-ville.syrjala@linux.intel.com>
 <a2a9702d-4f1e-40eb-8d01-53ddc3eeb976@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <a2a9702d-4f1e-40eb-8d01-53ddc3eeb976@intel.com>

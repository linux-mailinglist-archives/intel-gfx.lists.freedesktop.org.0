...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DEB321FF7A
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:01:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 32D1E6EA1D;
...
Subject: [Intel-gfx] [PATCH v2 32/59] drm/kmb: Revert dsi_host back to a
 static variable

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E3542F5553
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jan 2021 00:55:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4690C6ECBB;
	Wed, 13 Jan 2021 23:54:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D05B96ECBA
 for <intel-gfx@lists.freedesktop.org>; Wed, 13 Jan 2021 23:54:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1610582095;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=qDD9hLXLMM22fDKgCJO+I7EFr6z3FOT8yQcshz6TylQ=;
 b=BFTW2UbOq/oqT+SNZ9rHOmTlRkbHCqHSI2GEUfSFpxpFXcUr02HEkpmwnkN2AUrUB1PPqz
 tB3AzBIuDOpJddnE8BnQJK5NpCkPwHIl/QlfZeM9dYuWRo91E4jxGX0wF/cvRIcJhUp2EN
 Tb5RHKo5eVHlJ23vnuUQBO4LDOc+IOk=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-517-jxDCDLtXMqyKCMLi6rNhBQ-1; Wed, 13 Jan 2021 18:54:48 -0500
X-MC-Unique: jxDCDLtXMqyKCMLi6rNhBQ-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id AA7578015D0;
 Wed, 13 Jan 2021 23:54:43 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-119-79.rdu2.redhat.com
 [10.10.119.79])
 by smtp.corp.redhat.com (Postfix) with ESMTP id CAC191001E73;
 Wed, 13 Jan 2021 23:54:40 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: dri-devel@lists.freedesktop.org,
	intel-gfx@lists.freedesktop.org
Date: Wed, 13 Jan 2021 18:54:23 -0500
Message-Id: <20210113235426.2190684-2-lyude@redhat.com>
In-Reply-To: <20210113235426.2190684-1-lyude@redhat.com>
References: <20210113235426.2190684-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.22
Subject: [Intel-gfx] [PATCH v6 1/4] drm/i915: Keep track of pwm-related

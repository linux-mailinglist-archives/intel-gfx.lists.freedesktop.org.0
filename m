...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D6135F1783
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Oct 2022 02:46:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 679A710E498;
	Sat,  1 Oct 2022 00:46:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 72B4E10E495;
 Sat,  1 Oct 2022 00:46:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664585182; x=1696121182;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=E88gVA9hqYe5JDzwGF6tdG2Vo+AMQtpf/zeW1Gk2FoM=;
 b=JJZAm9mOeqli6O3+J7DSwXjEGs3yicLjGsBDOD7acFeJkVPAzmz4THU7
 MlaSsFv2DVdHLWSmYLll5rYEuDLxlpdktzaJwhRSg3mXIEx8dohbQqrl0
 qGAN9BALjsbK1OtCTIV3OP964fAyxzbESvwDPkwPnQjZtLvGPuLONuHKg
 eE7FTioq+SRr39v2Lc39BzqkJSAVTg/Od2TLygm/LbtQeAD9Jgm8P/kXz
 rcKsWg3eRXJfcy9+csKdTXPNxSb4llXME141zJNpiN9LLHRy3rqSVZyiz
 JiurYoQ7GFr810T8w9PsF9/wzYWuiXppv8TVv6cu0DhfguNmo57HNvXdg A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="388607925"
X-IronPort-AV: E=Sophos;i="5.93,359,1654585200"; d="scan'208";a="388607925"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Sep 2022 17:46:12 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="685477616"
X-IronPort-AV: E=Sophos;i="5.93,359,1654585200"; d="scan'208";a="685477616"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Sep 2022 17:46:09 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 30 Sep 2022 17:45:38 -0700
Message-Id: <20221001004550.3031431-3-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 02/14] drm/i915/xehp: Create separate reg
...
index b31fe0fb013f..af5b98b56a49 100644
...
index ba4ce668042c..68f45a748712 100644
...
index 2eaeba14319e..5ce98c30728a 100644
...
@@ -493,6 +494,18 @@ static void tgl_setup_private_ppat(struct intel_uncore *uncore)
...
@@ -585,13 +598,16 @@ static void chv_setup_private_ppat(struct intel_uncore *uncore)
...
index 7a0f0146ee01..7c237eeeac85 100644

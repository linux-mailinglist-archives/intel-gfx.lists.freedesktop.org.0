...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7907552E8DD
	for <lists+intel-gfx@lfdr.de>; Fri, 20 May 2022 11:33:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB8BC10E4F0;
	Fri, 20 May 2022 09:33:04 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 4/6] drm/i915/sseu: Don't try to store EU
 mask internally in UAPI format

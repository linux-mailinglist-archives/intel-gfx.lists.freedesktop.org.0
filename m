...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A7CB3B859C
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 16:59:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E1AAB6E9FC;
...
Subject: [Intel-gfx] [PATCH v6 2/4] drm: avoid circular locks in

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 277E249AE9
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jun 2019 09:43:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 020046E10A;
	Tue, 18 Jun 2019 07:43:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 10DE16E10D
 for <intel-gfx@lists.freedesktop.org>; Tue, 18 Jun 2019 07:43:07 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16935658-1500050 
 for multiple; Tue, 18 Jun 2019 08:42:38 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 18 Jun 2019 08:41:44 +0100
Message-Id: <20190618074153.16055-17-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/26] drm/i915: Provide an i915_active.acquire
 callback
...
MTVfZ2VtX2NvbnRleHQuYwppbmRleCAzNTg3MWM4YTQyYTYuLjkxMWYzNTY0OTcyZCAxMDA2NDQK
...

...
cnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX3JpbmdidWZmZXIuYwppbmRleCAyNmYzM2EwOGEzMmYu
LjUyOTJkZGFjNGQ3NCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxf
...
aTkxNV9hY3RpdmUuYwppbmRleCBlNzE2YmFhYjI3NmYuLjMwNzBmY2NiYzA4YiAxMDA2NDQKLS0t
...
dmUuaAppbmRleCBjMTRlZWJmNmQwNzQuLjEzNDE2NmQzMTI1MSAxMDA2NDQKLS0tIGEvZHJpdmVy
...

...
X3ZtYS5jIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV92bWEuYwppbmRleCBhZmE2Mzk5MDY2
ZjUuLmVjZTUzOTJjNGYwNSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV92

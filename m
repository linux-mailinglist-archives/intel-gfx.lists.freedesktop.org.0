...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5ED2B7F3518
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Nov 2023 18:41:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6AC110E549;
	Tue, 21 Nov 2023 17:41:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 948DA10E540
 for <intel-gfx@lists.freedesktop.org>; Tue, 21 Nov 2023 17:41:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1700588488; x=1732124488;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/7LBWE4rJN3lBEyNuHoDArpCtEB3WrBWg+tah7vXvPM=;
 b=O5udYsPPPNXxF1h8Np79H6qYXSBK2K0hWeOxc67WPUerNiwR2s6WsxjT
 I4HB+YXpAXrr3TVUC1wKY7GiITkm3PQAVtH/5WhNjpH7MaF1M3jLDhS9K
 I5I8+wzXa1i9QZmWsXwJw0c1jmnjf7qjPBvHuMDuDjl0o/SozZHsunNyB
 I8FUVQtGxyjvj5VzzBkGeKl3rpeFvRrvLn5CyhVPN76oXfe1O9zHcjyvW
 HwxWHFWtWMKpbRml5k9ZbF/IBy07emtuNRG9QCLPJq6u0Ch0iyVtyuulE
 oW0hhS1ij8V5RzTyvg06r78sDskOhzGUAWgt/Fk++QAwFx2tbN2SKhJFR w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10901"; a="10559434"
X-IronPort-AV: E=Sophos;i="6.04,216,1695711600"; d="scan'208";a="10559434"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Nov 2023 09:40:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.04,216,1695711600"; d="scan'208";a="14584689"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orviesa001.jf.intel.com with ESMTP; 21 Nov 2023 09:40:44 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 21 Nov 2023 23:05:36 +0530
Message-Id: <20231121173536.4033657-4-mitulkumar.ajitkumar.golani@intel.com>
...
index 5bb36cadd44a..8e2382ff84d9 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -5314,6 +5314,7 @@ intel_pipe_config_compare(const struct intel_crtc_state *current_config,

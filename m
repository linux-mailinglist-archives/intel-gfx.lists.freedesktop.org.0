...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7140C2C6504
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:12:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4CAA6ECA3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 090/162] drm/i915/query: Expose memory

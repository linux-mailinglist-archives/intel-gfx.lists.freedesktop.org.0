...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D2F52D66F7
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 20:42:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56A5D6EB43;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch 22/30] net/mlx5: Replace irq_to_desc() abuse

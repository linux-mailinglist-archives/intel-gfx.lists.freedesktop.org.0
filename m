...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A801D1BDC50
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 14:33:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3678B6EE5F;
	Wed, 29 Apr 2020 12:33:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B1DA96EAA8
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 12:33:17 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 14:32:46 +0200
Message-Id: <20200429123307.1449297-4-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 04/25] drm/i915: Add an implementation for
...
@@ -16972,7 +16972,7 @@ static int intel_framebuffer_init(struct intel_framebuffer *intel_fb,
...
index ca1c1a7b90ae..20aa6789e693 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt.c
@@ -488,7 +488,7 @@ static int __engines_record_defaults(struct intel_gt *gt)
 		if (err)
 			goto out;

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F2318183EA
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Dec 2023 09:55:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AB54C10E435;
	Tue, 19 Dec 2023 08:55:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 046E310E448
 for <intel-gfx@lists.freedesktop.org>; Tue, 19 Dec 2023 08:55:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1702976142; x=1734512142;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=aVAAA/Ef/W7EuyRQ9MD1cqBaANDXuzMvqqmV2z/Kmfo=;
 b=A1kMZ6vQ8TJN5J6rzatBJDnVdt93MBPdP2gOKVHcq7rEomUrbj2S+cW6
 NN07+JW7g9bvnxHFUzazag/00Db3KD96oX6yrA4WhcDak3I08AUd9o6Qz
 lllShxlwSYCQ2CWrYRwijvVfW2MKy5w6kgs1zg+8lZQK2sXf1bSwxFbOM
 /8BXTBk2sxAM5t95JHLheY4sXUXzY0QQJ88BtqfTNRhq99nEjCicQwN/g
 ILiZi0C6ohKZetJ9Cl8+GfU9BwQmcZJgUAWCQUdcZRTFv/lYLSSCIY9cO
 pLkvaK14Y7p/cPbYYr8XzRozvjau9n7IJr3LGj6jOsGzGTXbYyZ74HGUo w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="399462039"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="399462039"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Dec 2023 00:55:42 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="846272341"
X-IronPort-AV: E=Sophos;i="6.04,287,1695711600"; d="scan'208";a="846272341"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmsmga004.fm.intel.com with ESMTP; 19 Dec 2023 00:55:41 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH 1/3] drm: Add Adaptive Sync SDP logging
Date: Tue, 19 Dec 2023 14:21:02 +0530
Message-Id: <20231219085104.1211388-2-mitulkumar.ajitkumar.golani@intel.com>

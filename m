...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFF08650FE2
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:08:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 14E1110E2DB;
...
Subject: [Intel-gfx] [PATCH 14/18] fbdev/simplefb: Do not use struct
 fb_info.apertures

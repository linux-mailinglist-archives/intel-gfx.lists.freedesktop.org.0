...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C26026871E5
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Feb 2023 00:27:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5C0810E1B2;
	Wed,  1 Feb 2023 23:27:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4A1D710E1B0
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 Feb 2023 23:27:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1675294058;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=sXoQvVrTzYsdEyLij+fdiknvHP5DRqaJ4e72GDsPbAA=;
 b=HoQQzsauV/RkY3Y7GLIC4b8IYOB6IOS5O0M7qD8vDLnYVMqEQhpsjooiC6EyL7xUCLLzwz
 1Atn+i95oNhCpdkG9jqCuvtzAUZbekIMArvKTzrGqfh0xDjW8vZvaCEREU6vBVnftjqSjw
 W9g1U33exC4i+p1mgDuzLH9u4t9ZuZg=
Received: from mail-il1-f200.google.com (mail-il1-f200.google.com
 [209.85.166.200]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_128_GCM_SHA256) id
 us-mta-213-MZB5su2rM1CFg6zuc9DSKA-1; Wed, 01 Feb 2023 18:27:35 -0500
X-MC-Unique: MZB5su2rM1CFg6zuc9DSKA-1
Received: by mail-il1-f200.google.com with SMTP id
 g1-20020a92cda1000000b0030c45d93884so169717ild.16
 for <intel-gfx@lists.freedesktop.org>; Wed, 01 Feb 2023 15:27:35 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=sXoQvVrTzYsdEyLij+fdiknvHP5DRqaJ4e72GDsPbAA=;
 b=
X-Gm-Message-State: AO0yUKVo6SnqaYao9KYKEAYJphe0gwMEzL4c1Yn7rbhjz00OXa+FhRny
 xREIuqAAPBrVGL9UY6+ntPYpp79THIGNp7ACqL4TC04CWzCtxUMKT+3nNvtY7Z/uMHjGLUerYsd
 wP0weUN+iSSr5DGrDxQwlZlpAR9rS
X-Received: by 2002:a92:1a49:0:b0:312:7a4e:e94d with SMTP id
 z9-20020a921a49000000b003127a4ee94dmr1722575ill.2.1675294054494; 

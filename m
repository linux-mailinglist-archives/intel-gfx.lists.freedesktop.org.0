...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C848949557A
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jan 2022 21:40:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CE5610E35E;
...
Subject: [Intel-gfx] [PATCH v3 0/5] discrete card 64K page support

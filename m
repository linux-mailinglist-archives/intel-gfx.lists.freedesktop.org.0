...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 69D974AAF5D
	for <lists+intel-gfx@lfdr.de>; Sun,  6 Feb 2022 14:13:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F5AC10E613;
	Sun,  6 Feb 2022 13:13:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 19B2E10E613
 for <intel-gfx@lists.freedesktop.org>; Sun,  6 Feb 2022 13:13:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644153225; x=1675689225;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=EKoP3ymBFowoLiYIS0xqrTIuAsin4prij790y32k2Js=;
 b=UADP9aVOCfVGrOMdHN/Rz/71CbQGm22aWDQKmdj7L9d7P+Ms4j4k29aE
 xOryEQ/hoTcyUeSsp2ITTTVE8Y6geyBTI6pCNdA+Ns9N9R6VoQ5Gm20CN
 nw34Bz8NIJ6JQUaJLv0dxmWTb6e2Zc+9NFtLsG4wUPoB9Vuuy0YMsdpBq
 xIrztCmhEx6ObZ1ZTXJgOzjs01LFkVKWiDj/9ayDc2NnvYxYmMT+9kM4G
 WoIPxEfTodMlMVENCCbOyvB6ouERYHMXaQIqmps+PVsSy6kiPX0R7IqT5
 JL68baarz1hcgwG4jrKy0QY7QBYp1jbFvJTHvpkDLwFVpaNeYQJAbWuc7 A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10249"; a="232145915"
X-IronPort-AV: E=Sophos;i="5.88,347,1635231600"; d="scan'208";a="232145915"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2022 05:13:44 -0800
X-IronPort-AV: E=Sophos;i="5.88,347,1635231600"; d="scan'208";a="539750858"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2022 05:13:41 -0800
...
Date: Sun,  6 Feb 2022 15:13:18 +0200
Message-Id: <20220206131322.3246403-2-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 1/5] drm/i915/gsc: add gsc as a mei auxiliary
 device
...
index e3dad0d898f5..1e65ff4f1d58 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -9792,6 +9792,7 @@ S:	Supported
...
index a26e6736bebb..f8606487b4da 100644
...
index e6f6bf7c3926..7f74a2eedbc2 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt.c
@@ -445,6 +445,8 @@ void intel_gt_chipset_flush(struct intel_gt *gt)
...
@@ -765,6 +767,7 @@ void intel_gt_driver_unregister(struct intel_gt *gt)
...
index 8c1706fd81f9..eb7d7f074c2f 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1504,6 +1504,14 @@ IS_SUBPLATFORM(const struct drm_i915_private *i915,
...
index 87c92314ee26..06dc89a7e4ee 100644

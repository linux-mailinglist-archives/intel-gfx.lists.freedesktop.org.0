...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8111A7F0191
	for <lists+intel-gfx@lfdr.de>; Sat, 18 Nov 2023 18:43:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79B2310E345;
...
Subject: [Intel-gfx] [PATCH v2 15/20] drivers/gpu/drm/i915/display: remove

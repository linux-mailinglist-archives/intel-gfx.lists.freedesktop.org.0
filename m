...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9706C753C44
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jul 2023 15:56:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DDD7710E88C;
...
Subject: Re: [Intel-gfx] [PATCH v14 17/26] vfio: Move device_del() before

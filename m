...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11E3C6C2071
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Mar 2023 19:54:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 50D6410E2EC;
...
Subject: Re: [Intel-gfx] [PATCH 2/7] vfio/pci: Only check ownership of

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EC7614AC34E
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Feb 2022 16:29:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F13D510E6B8;
	Mon,  7 Feb 2022 15:29:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A6F9110E450
 for <intel-gfx@lists.freedesktop.org>; Mon,  7 Feb 2022 15:29:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1644247761;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=ZWkaPZigKR8ZVYYpYKUmXEITXI5Ito7CWFDFszKolT0=;
 b=IWcAKGAHLRJBrF7CbbQotIpadLZKKwtBr4FpyQn7UR/AX0IIKfxlAzkLkyGJxzhj7SjNYx
 Kvj/MEpdJGevz5oMQjLc7DibpvX7sJdZDblk3EuL5bhjqizmx1UH0fUNKEXgRiRBXIszbU
 n0Mx1HSAl03G/OgSb9d2DnqhNzD/ZYw=
...
Subject: [Intel-gfx] [PATCH 02/30] KVM: x86: nSVM: fix potential NULL
 derefernce on nested migration

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D95D38207E
	for <lists+intel-gfx@lfdr.de>; Sun, 16 May 2021 20:59:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 458C76E84C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 0/3] drm: Remove some includes of drm_legacy.h

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9993C158AB0
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Feb 2020 08:47:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86FC86EDD6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 06/18] drm/i915/dp: Read out DP SDPs

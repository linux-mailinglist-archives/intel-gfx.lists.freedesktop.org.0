...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF7046BE080
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 06:15:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F0C010E064;
	Fri, 17 Mar 2023 05:14:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 328A210E064
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Mar 2023 05:14:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1679030094; x=1710566094;
 h=date:message-id:from:to:cc:subject:in-reply-to:
 references:mime-version;
 bh=TQ894GY4TthhrfndU4nUDJ4fUSk85njnO6mxJ58TJ3A=;
 b=I73E9JmVDcn147rhtLTgHBBioxFKgD4YWW+hgmdbW/z3AwVUwOsACtBx
 Web1juXTjps6uTTNpTFXkCA22cpm4/DAdCmhVPfnx8UTjrcMO+AYLbPqX
 SgWIZErMkoLbltFkMTF8N2KbGlDU42wiI95LHcH++Q/TDYnZC0Z3qIY0I
 n0/qCXwpGz+qzUITOHN+57e6rrjIGA7AscwKmxzj6YXzHCylbjbXUGSq9
 7jWJ0F9060PUJLTV/Tq2kyBA5h67cfXMQdpthBMS/kSOfdzB0F01601K1
 20sRhg2A8E9d7PJOvSUO7pbKtHRrErlwY/xTS7USJh7bMzQe60M1ADFBK g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="365879583"
X-IronPort-AV: E=Sophos;i="5.98,268,1673942400"; d="scan'208";a="365879583"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 22:14:53 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="790598039"
X-IronPort-AV: E=Sophos;i="5.98,267,1673942400"; d="scan'208";a="790598039"
Received: from adixit-mobl.amr.corp.intel.com (HELO adixit-arch.intel.com)
 ([10.209.119.150])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 22:14:53 -0700
Date: Thu, 16 Mar 2023 22:14:52 -0700
Message-ID: <87fsa4vu0j.wl-ashutosh.dixit@intel.com>

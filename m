...
Received: from mail.lfdr.de
	...
	id nV9lFUwbRmpgKAsAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 02 Jul 2026 10:03:24 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B788D6F48AF
	for <lists+intel-gfx@lfdr.de>; Thu, 02 Jul 2026 10:03:23 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=lankhorst.se header.s=default header.b="eZ6/Pf+Q";
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org;
	dmarc=pass (policy=none) header.from=lankhorst.se
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4FBC210F1EC;
	Thu,  2 Jul 2026 08:03:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (unknown [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 19D8210F1EC;
 Thu,  2 Jul 2026 08:03:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1782979395;
 bh=hCE2qawql+/X4/hi4TVNE5VWRZuVk9ys6MLP3hcNKBQ=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH 3/4] drm/i915/display: Use intel_de_write_fw in
 intel_pipe_fastset
Date: Thu,  2 Jul 2026 10:03:44 +0200
Message-ID: <20260702080346.431508-4-dev@lankhorst.se>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B87661EBB3
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Nov 2022 08:20:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E89810E213;
...
Subject: [Intel-gfx] [RFC 06/15] drm/drm_scdc_helper: Add SCDC helper funcs
 for HDMI2.1

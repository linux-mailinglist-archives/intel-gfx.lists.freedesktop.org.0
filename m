...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C56465C054B
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Sep 2022 19:30:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0D73210E499;
	Wed, 21 Sep 2022 17:30:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 41E5810E499
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Sep 2022 17:30:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663781431; x=1695317431;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=gB2AqgDNje8nfnJ3821qky9yDp2OOdwEGkZtnBgn+X4=;
 b=WCGUw+XvljTeEzXArdeQiT5PwsRM6GuR37biUPfhk69iQW7OKb0QEVUY
 gdbnDvOzcSCBTlr8V3OLTifHu72r/P/fMU2dpo8H3CG4S2AElxJDg+gLH
 w3AVOK8Ob2J/WTno62pIzKVyn2pCNjJrV8c1znMxpf2OdFYLEZ+rX+mqo
 BYPAzkmcyXPHrLi2UWNlFqDJ07c4Sqw5jZRPdDx98+dEL7q77v0PjUysu
 5eRsvYgYrXDilQKCsWyWsfVPwtZVfcla/c/Yt1fIZQet70kOrKMY62WEC
 awSPagKK0m86ElDxEgi2VnflPRDrE46qoCl8/hVZi/YK3b76Wq6B3FXpC Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10477"; a="364048512"
X-IronPort-AV: E=Sophos;i="5.93,333,1654585200"; d="scan'208";a="364048512"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Sep 2022 10:30:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,333,1654585200"; d="scan'208";a="723304009"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by fmsmga002.fm.intel.com with ESMTP; 21 Sep 2022 10:30:30 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 21 Sep 2022 10:32:19 -0700
Message-Id: <20220921173219.785199-2-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/1] drm/i915/guc: Delay disabling guc_id

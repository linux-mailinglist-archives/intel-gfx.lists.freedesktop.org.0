...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 863BD689991
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Feb 2023 14:18:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD69B10E796;
	Fri,  3 Feb 2023 13:18:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D4CF210E796
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 Feb 2023 13:18:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675430288; x=1706966288;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=nVt4sk1q3WHzejixJYiG2fcFIo0kWFM99oowauhgC8c=;
 b=eFgjPdPBDBbRvbPVDJPoMPoZz8nkEVJz9vFauvQdUvfB/J+VLMUkXmIB
 bJeRQpdgRRO0AqPvwVvNv1P605LzRssSaTrCGwe9FbgkC+4lEvP3K6pJa
 7B6tae7/WiAe9GH7znbWLuSVVaaGjizDbfDiq8xJG2jdy41TWBSMKmWXd
 yxRbXvRR124XHREuSlCV5oxefw3lwHpLwgnRARjf+lEy5fLzNfSt6qDkz
 Ho/sQQCozK2BxIXmTA/N03QZnHgVAxtd5O7HnCAPhPEcyBzcNgdZPQRqr
 AZt2IOHnIoUEDM3MW1HOKym1fKopeY+7tnN8X5gjT5nXiWQDdLbNYENGv A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10609"; a="327384562"
X-IronPort-AV: E=Sophos;i="5.97,270,1669104000"; d="scan'208";a="327384562"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Feb 2023 05:18:08 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10609"; a="665713623"
X-IronPort-AV: E=Sophos;i="5.97,270,1669104000"; d="scan'208";a="665713623"
Received: from srr4-3-linux-118-swatish2.iind.intel.com ([10.223.34.130])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Feb 2023 05:18:06 -0800
From: Swati Sharma <swati2.sharma@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 Feb 2023 18:50:23 +0530
Message-Id: <20230203132023.2133-1-swati2.sharma@intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH] drm/i915/dsc: Add debugfs entry to validate DSC
 output formats
...
index 32e8b2fc3cc6..5cd8bb08753a 100644
...
index 2ce2b3def669..90eb2236bfc1 100644
...
@@ -2049,6 +2050,16 @@ intel_dp_compute_output_format(struct intel_encoder *encoder,
 	bool ycbcr_420_only;
 	int ret;

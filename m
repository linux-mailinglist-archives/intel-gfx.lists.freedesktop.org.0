...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DF647A3DD5
	for <lists+intel-gfx@lfdr.de>; Sun, 17 Sep 2023 23:19:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A9C210E19D;
...
Subject: [Intel-gfx] [PATCH v7 3/3] drm/i915/lrc: User PXP contexts requires
 runalone bit in lrc

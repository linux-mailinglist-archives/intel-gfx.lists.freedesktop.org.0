...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1163544DD84
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Nov 2021 23:02:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 744F56E976;
...
Subject: [Intel-gfx] [PATCH v10 03/10] amdgpu: use dyndbg.BITGRPS to control
 existing pr_debugs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B845604EC1
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Oct 2022 19:33:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06F4E10F2A1;
	Wed, 19 Oct 2022 17:33:51 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 55E8C10EB44
 for <Intel-gfx@lists.freedesktop.org>; Wed, 19 Oct 2022 17:33:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666200817; x=1697736817;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=d4D/BlXX4NlKxFrkTxlp93219A7CroFmytaEV3UfKfI=;
 b=PnWvl2OSXLwq0ZrHl+NdCH/S3G2qD6Qtw+IXJjQa1tq+30LwhcF4JltJ
 BrMONOP1Pj8S95GSzShQMcgYCBRNPAYZG3tKbFv/416jStUnkYG0xZWiX
 OqP7rMyQxDqiT6l9bajM11V9Po4w5FJ86IjBLn5rANQzTEH6G54CLTEns
 afmOLvEZXSpF02nJPCB4qr5ty3a9aTMoDb7I+GaMLHkYlIHCcthk/PTTC
 J6bYxGsahYeiGL4iZgpcVlu8v+PZ8DfySPOX9BWzFVIlKh0K5wTgN7tXs
 66a7agRLQrIYgwfrKNnqMBJgDfTDVr4WZzSETM/D0jT8uTMdRRnj+QdLu w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="286201642"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="286201642"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Oct 2022 10:33:36 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10505"; a="607204741"
X-IronPort-AV: E=Sophos;i="5.95,196,1661842800"; d="scan'208";a="607204741"
...
Subject: [Intel-gfx] [RFC 05/17] drm: Connect priority updates to drm core

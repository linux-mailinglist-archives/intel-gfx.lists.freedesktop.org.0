...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4613B54BCAA
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jun 2022 23:17:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F2D44112F73;
	Tue, 14 Jun 2022 21:17:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B636B112F62
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Jun 2022 21:17:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655241423; x=1686777423;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=skfalgRftt5F3y1NGqmoGn+tECplD8pjBwYyhn0rmBo=;
 b=A6PTCJ4Ac2k8IutonZy8Eg8bdGEytm5OL4DOF2w0Y5SmJ5zdzqb3y/d6
 I1JcfwiUlZAdlz8/2uz6JBxqEaElR+NWvasGtC9WV1YiyIEUrhecW/2I3
 eaZm42FR6VP3Gb9SV4YH4iZlaIN+S96/oYpg81cT+K3/p3xkjViXwIBvz
 wpHJ/NkqXReJJIAv28nuBxp6pa+OtcRvc4O2f41RqU8drknZjwMXSsRFV
 twjKzDKlyMYGgOzpzIKsakLca0riS4SUH4CyfloAQLnEufNMPxtOsZQMW
 OxBI4uIdyC9OuHf+SexaFNIAZfv/wnZpzp9pmOE9xwFmCr685HqLbac95 g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10378"; a="261772941"
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; d="scan'208";a="261772941"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2022 14:16:46 -0700
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; d="scan'208";a="674111425"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2022 14:16:46 -0700
Date: Tue, 14 Jun 2022 14:16:45 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: "Vudum, Lakshminarayana" <lakshminarayana.vudum@intel.com>
Message-ID: <Yqj6vZ22664i/LYv@mdroper-desk1.amr.corp.intel.com>
...
In-Reply-To: <DM4PR11MB6213FA950D4F8CD7E19B3C91ECAA9@DM4PR11MB6213.namprd11.prod.outlook.com>
...
> I am unable to load both the failures? Is there any other way to get these failures?
> 
> -----Original Message-----
...
> Subject: Re: ✗ Fi.CI.IGT: failure for drm/i915/pvc: Adjust EU per SS according to HAS_ONE_EU_PER_FUSE_BIT()
> 

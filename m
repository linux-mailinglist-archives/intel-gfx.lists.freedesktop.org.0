...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 547EF570B82
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:26:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84DCC8B4B3;
...
Subject: [Intel-gfx] [PATCH 29/32] docs: gpu: i915.rst: GVT: add more
 kernel-doc markups

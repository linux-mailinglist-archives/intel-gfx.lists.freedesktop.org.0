...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B7EC7AF5DC
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Sep 2023 23:58:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5FBE610E445;
	Tue, 26 Sep 2023 21:58:16 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/mtl: Skip MCR ops for ring fault
 register

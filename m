...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96506375A9A
	for <lists+intel-gfx@lfdr.de>; Thu,  6 May 2021 20:58:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B8FBE6EDB2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 06/97] drm/i915/guc: enable only the user

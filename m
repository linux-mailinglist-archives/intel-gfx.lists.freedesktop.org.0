...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6463641B5C4
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Sep 2021 20:18:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 73C586E922;
...
Subject: Re: [Intel-gfx] [PATCH v2] drm/amd/display: Only define DP 2.0
 symbols if not already defined

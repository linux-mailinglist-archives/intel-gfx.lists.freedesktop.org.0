...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 574076258E9
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Nov 2022 11:57:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1146F10E7FE;
...
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915/gvt: switch from

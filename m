...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E4AF67C03D5
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Oct 2023 20:55:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC42D10E0E6;
	Tue, 10 Oct 2023 18:55:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 921CC10E0D3
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=PsQGu+aX5DPY1ASoN2NnVHJVb8/hLpC7I558R96et33IF2eSC+FvzixG
 U3MkCM3InjgNOX3F4iuNj3NzClNR7JfD2q5K9ZOSNup06ChfOz+iTRoZs
 azomo5AwDIvVc0SU49kV2OugAjn03kYlkswWl/OrkZX87EoI2+dNHYGFw
 54ohqaEZVf64LtJVeCaBxLfZAdy5z4BZIXj/8PBcT53cKZGia/p2f7NnI
 EEYyMwnXliKffROk431DtvZPqKh/jnrSGshraW60pb+VM+5F8uUV6OU+F
 wfYTv+s482NctMhSJEPIQ11fuK/PMw8ypz1gGwxnn4iUE4zJ2sF1cuIdF w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="364776788"
X-IronPort-AV: E=Sophos;i="6.03,213,1694761200"; d="scan'208";a="364776788"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 11:55:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="757234842"
X-IronPort-AV: E=Sophos;i="6.03,213,1694761200"; d="scan'208";a="757234842"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 11:55:05 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Oct 2023 11:44:11 -0700
Message-Id: <20231010184423.2118908-1-jonathan.cavitt@intel.com>

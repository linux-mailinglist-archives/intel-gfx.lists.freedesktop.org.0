...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80B40149F7B
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Jan 2020 09:09:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 246286EA1E;
	Mon, 27 Jan 2020 08:08:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 174296EA16;
 Mon, 27 Jan 2020 08:08:56 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga102.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 27 Jan 2020 00:08:55 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,369,1574150400"; 
 d="scan'208,217";a="304555096"
Received: from plaxmina-desktop.iind.intel.com ([10.145.162.62])
 by fmsmga001.fm.intel.com with ESMTP; 27 Jan 2020 00:08:47 -0800
...
Date: Mon, 27 Jan 2020 13:26:50 +0530
Message-Id: <20200127075653.8523-2-pankaj.laxminarayan.bharadiya@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 1/4] drm/i915/display: Make WARN* drm
...
index b1100950dd0d..6659e9aed6ff 100644
...
index 9c81576dc43e..07052f81b0d1 100644
...
@@ -2215,11 +2215,11 @@ intel_pin_and_fence_fb_obj(struct drm_framebuffer *fb,
 	unsigned int pinctl;
 	u32 alignment;
...
@@ -4809,7 +4809,7 @@ __intel_display_resume(struct drm_device *dev,
...
@@ -5840,7 +5840,7 @@ static void ilk_pch_enable(const struct intel_atomic_state *state,
...
+		drm_WARN_ON(dev, port < PORT_B || port > PORT_D);
 		...
 		I915_WRITE(reg, temp);
@@ -6255,11 +6255,14 @@ void hsw_enable_ips(const struct intel_crtc_state *crtc_state)
...
@@ -6288,7 +6291,9 @@ void hsw_disable_ips(const struct intel_crtc_state *crtc_state)
 		return;
...
@@ -9149,7 +9154,7 @@ i9xx_get_initial_plane_config(struct intel_crtc *crtc,
...
+	drm_WARN_ON(dev, pipe != crtc->pipe);
 	...
 	if (!intel_fb) {
@@ -10352,7 +10357,7 @@ skl_get_initial_plane_config(struct intel_crtc *crtc,
 	if (!plane->get_hw_state(plane, &pipe))
 		return;
...
+	drm_WARN_ON(dev, pipe != crtc->pipe);
 	...
 	intel_fb = kzalloc(sizeof(*intel_fb), GFP_KERNEL);
 	if (!intel_fb) {
@@ -10484,8 +10489,8 @@ static void ilk_get_pfit_config(struct intel_crtc *crtc,
...
@@ -10582,8 +10587,9 @@ static bool ilk_get_pipe_config(struct intel_crtc *crtc,
...
@@ -10808,8 +10814,9 @@ static bool hsw_get_transcoder_state(struct intel_crtc *crtc,
...
+				 transcoder_name(panel_transcoder));
 		...
 		case TRANS_DDI_EDP_INPUT_A_ONOFF:
 			force_thru = true;
@@ -10837,11 +10844,11 @@ static bool hsw_get_transcoder_state(struct intel_crtc *crtc,
 	/*
...
+	drm_WARN_ON(dev, *power_domain_mask & BIT_ULL(power_domain));
 	...
 	if (!wf)
@@ -10875,7 +10882,7 @@ static bool bxt_get_dsi_transcoder_state(struct intel_crtc *crtc,
...
+		drm_WARN_ON(dev, *power_domain_mask & BIT_ULL(power_domain));
 		...
 		wf = intel_display_power_get_if_enabled(dev_priv, power_domain);
 		if (!wf)
@@ -11783,7 +11790,7 @@ int intel_get_load_detect_pipe(struct drm_connector *connector,
...
@@ -13068,12 +13075,12 @@ static bool check_digital_port_conflicts(struct intel_atomic_state *state)
...
@@ -17489,12 +17496,12 @@ static void sanitize_watermarks(struct drm_device *dev)
 	if (ret == -EDEADLK) {
...
@@ -17520,7 +17527,8 @@ static void sanitize_watermarks(struct drm_device *dev)
...
@@ -18349,7 +18357,7 @@ static void intel_modeset_readout_hw_state(struct drm_device *dev)
...
@@ -18563,7 +18571,7 @@ intel_modeset_setup_hw_state(struct drm_device *dev,
 		u64 put_domains;
...
index a978d9f0f94c..a59c362d6c9c 100644
--- a/drivers/gpu/drm/i915/display/intel_dp.c
+++ b/drivers/gpu/drm/i915/display/intel_dp.c
@@ -7378,7 +7378,8 @@ static bool intel_edp_init_connector(struct intel_dp *intel_dp,
...
@@ -7512,10 +7513,10 @@ intel_dp_init_connector(struct intel_digital_port *intel_dig_port,
...
@@ -7533,7 +7534,7 @@ intel_dp_init_connector(struct intel_digital_port *intel_dig_port,
...
@@ -7551,9 +7552,10 @@ intel_dp_init_connector(struct intel_digital_port *intel_dig_port,

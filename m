...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E806D2C9FC9
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Dec 2020 11:37:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5779A6E86A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 19/20] drm/vmwgfx: Remove references to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CAD6B590C3C
	for <lists+intel-gfx@lfdr.de>; Fri, 12 Aug 2022 09:03:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0F9F18AEC0;
	Fri, 12 Aug 2022 07:03:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ADDDB8D2E1
 for <intel-gfx@lists.freedesktop.org>; Fri, 12 Aug 2022 07:03:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1660287814; x=1691823814;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=j8Pl8QEZZMDt2ZOueGzXtW4S3ekgmjRBfFjR94myzgU=;
 b=envSdeR4E7aK2biioGNaZ7HEl2/P4PyoO5ehEJCfJNXsuJGcg7LK3CPA
 /an745iTGBJYkDGHZBmlyBamD1unNi5sXOIHgon7+7RwHSAMOR4qBP6l2
 /00qshuwNBTqo5G3kBNpuvYw1rCinfjVqV0pl94JhJpMaiNNRIo1SquyK
 DJgQseLXavXuUYKjF0ABjtmfUpj3y03TucasokaTczHvFmenM++25iOOH
 6bkOiVPFQjqF/Y8fyPpZiSOeRbzOm6JpsgvKGEvu+45JPGOTUpPTllXbG
 /2T1sAfDCPMGz6hKb7QxC7XnBD70uV1KWme2jctQzxNbAMCkynV8IqgiS w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10436"; a="291538516"
X-IronPort-AV: E=Sophos;i="5.93,231,1654585200"; d="scan'208";a="291538516"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Aug 2022 00:03:32 -0700
X-IronPort-AV: E=Sophos;i="5.93,231,1654585200"; d="scan'208";a="665715659"
Received: from ebrazil-mobl1.amr.corp.intel.com (HELO localhost)
 ([10.252.37.174])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Aug 2022 00:03:31 -0700
...
Date: Fri, 12 Aug 2022 10:03:29 +0300
Message-ID: <87k07erlj2.fsf@intel.com>
MIME-Version: 1.0

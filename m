...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B7F39FBB6
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Aug 2019 09:29:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D853D89C3F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 1/6] drm/i915: mei_hdcp: I915 sends ddi
 index as per ME FW

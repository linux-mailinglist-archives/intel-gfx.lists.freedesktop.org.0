...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5A2A69513A
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Feb 2023 21:00:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D69C10E6FF;
	Mon, 13 Feb 2023 20:00:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0664510E6FC
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Feb 2023 20:00:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1676318427; x=1707854427;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=9B/cG80kEGbdNOm4UflbiTPSqeeobvKjau0LX7Wa2Gc=;
 b=j06FDtoWoQy/YqUmrmjEAPyIf28sBsys0PjMWvmxbnuDFccZatpEyyp0
 YF96bZE2YwVBIUTitnOnJrtDX3nd0k92U+a7sKFhhWk7zldO7tbbms4Ri
 6MsHaGvQh+CeIDz1vnw0RQRG0Fspycy/WfC8BKz2MuAJNcAMSR8hcCwY4
 NqdetqcDit9XECWeejUMrkWfrYKICfo76gpPOJTWj/ee3D7PQ+Po5hrL2
 KeJkhnA9bUVyy56/Yop0jKA9xn7FXZMKUi3Hxz7ayLGpUhChCYIonJKfb
 sSMsHwaGOTMIRvXO3MA7iXSm6rCGJ+IX3vFH/en1PYE9WtIzLf/SR/YHf A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10620"; a="319012221"
X-IronPort-AV: E=Sophos;i="5.97,294,1669104000"; d="scan'208";a="319012221"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2023 12:00:25 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10620"; a="732611838"
X-IronPort-AV: E=Sophos;i="5.97,294,1669104000"; d="scan'208";a="732611838"
Received: from tkatila-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.50.147])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2023 12:00:21 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 13 Feb 2023 21:59:57 +0200
Message-Id: <ddf04a07a37f0368b3fef85d4ebb924082fec6cd.1676317696.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 2/7] drm/i915/wm: move remaining watermark

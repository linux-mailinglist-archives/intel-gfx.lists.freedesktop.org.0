...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C45D8288632
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Oct 2020 11:42:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 229B36EC9D;
	Fri,  9 Oct 2020 09:42:33 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 11/12] drm/i915/gvt: GVTg support ggtt pv
 operations

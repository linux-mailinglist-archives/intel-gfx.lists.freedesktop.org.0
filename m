...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 933006318FB
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Nov 2022 04:39:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCD6110E11D;
	Mon, 21 Nov 2022 03:39:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 04DF610E11D
 for <intel-gfx@lists.freedesktop.org>; Mon, 21 Nov 2022 03:39:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669001985; x=1700537985;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=XTXgJB4iGi78YesyKtFZYGd86jj9Ij2+mOHgxJ6+Psg=;
 b=KqXRFm86SEd7YamD+3Ue+37jHbjQWTP/CeFDyX6W29gPV1tZcdyN5CJV
 wnJmmzqGGFIYLm96PWlQ9+/NV51jZHcqM/zB0J68LBIVBPN1dzcDJRPWZ
 Qbmu2++BW+Fv0jD3OC2FJDPBK3ubKgUP0hcsRQ5OwuujRgu7oMz49f58C
 Kt4imkJnuXb1S4TkSA3U1cEWr/w2EUaSqPYLJeNLTyPtZanhVv+VO8YSz
 xv0tLtRSh4ACR4r28qyxejTqxWhU2pUv1oCG/b/5r9GLam5LLT0h2YxPi
 SgucbuJr9J7tytqfKUu3wCyrDFnhriE/aRbY3//SBJEtYwjOx2Fmb/awL w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10537"; a="296823701"
X-IronPort-AV: E=Sophos;i="5.96,180,1665471600"; d="scan'208";a="296823701"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Nov 2022 19:39:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10537"; a="815567397"
X-IronPort-AV: E=Sophos;i="5.96,180,1665471600"; d="scan'208";a="815567397"
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230022)(136003)(366004)(39860400002)(376002)(346002)(396003)(451199015)(55236004)(478600001)(71200400001)(26005)(110136005)(53546011)(66476007)(66946007)(83380400001)(64756008)(9686003)(4326008)(76116006)(8676002)(2906002)(41300700001)(5660300002)(52536014)(186003)(66446008)(66556008)(8936002)(33656002)(7696005)(38070700005)(316002)(6506007)(38100700002)(122000001)(86362001)(55016003)(82960400001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 21 Nov 2022 03:39:42.6148 (UTC)

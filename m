...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DFBBA24C4F8
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Aug 2020 20:02:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38D516E9A6;
	Thu, 20 Aug 2020 18:02:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1FF166E9A7
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Aug 2020 18:02:07 +0000 (UTC)
IronPort-SDR: kakZ+98xCyTcCQ5UGd53h/lJ+zM46nQU/ztg1B0QfJRZu67+sfipAgvcs7wHzyzQ/5XofXuD6P
 KqmMJoCLxj2A==
X-IronPort-AV: E=McAfee;i="6000,8403,9718"; a="154638694"
X-IronPort-AV: E=Sophos;i="5.76,334,1592895600"; d="scan'208";a="154638694"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Aug 2020 11:02:06 -0700
IronPort-SDR: 7DmSmtqSg6wU6TCSKGsu1b6+YjpBjyA0Pfgz2ZuDU4az/Z9+SrHcFi7WvnSSYQE0Se2z06MdRt
 QsQzb/1+hnVA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.76,334,1592895600"; d="scan'208";a="442071385"
Received: from orsosgc001.ra.intel.com ([10.23.184.150])
 by orsmga004.jf.intel.com with ESMTP; 20 Aug 2020 11:02:00 -0700
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 20 Aug 2020 11:01:58 -0700
Message-Id: <20200820180200.68355-3-umesh.nerlige.ramappa@intel.com>
...
@@ -78,12 +78,23 @@ static void wa_init_start(struct i915_wa_list *wal, const char *name, const char
...
@@ -124,30 +175,23 @@ static void _wa_add(struct i915_wa_list *wal, const struct i915_wa *wa)
 		wal->list = list;
 	}
...
+		return;
 	...
 	wal->wa_count++;
@@ -1282,7 +1326,8 @@ void intel_gt_init_workarounds(struct drm_i915_private *i915)
 }
...
+	   unsigned int op)
 {
 	...
 	struct i915_wa *wa;
@@ -1291,8 +1336,7 @@ wal_get_fw_for_rmw(struct intel_uncore *uncore, const struct i915_wa_list *wal)
...
@@ -1322,7 +1366,7 @@ wa_list_apply(struct intel_uncore *uncore, const struct i915_wa_list *wal)
 	if (!wal->count)
 		return;
...
@@ -1634,25 +1678,32 @@ void intel_engine_init_whitelist(struct intel_engine_cs *engine)
...
+	spin_unlock_irqrestore(&uncore->lock, flags);
 ...
 static void
@@ -1972,6 +2023,36 @@ void intel_engine_init_workarounds(struct intel_engine_cs *engine)
 	wa_init_finish(wal);
 }

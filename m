...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCE526F1E66
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 20:58:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DEBE510EDA8;
...
Subject: [Intel-gfx] [PATCH v2 7/8] drm/i915/mtl/huc: Use the media gt for
 the HuC getparam

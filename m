...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id EGkcOPYB5mkvqQEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Apr 2026 12:37:42 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9216D42965B
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Apr 2026 12:37:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EF7F10E4E8;
	Mon, 20 Apr 2026 10:37:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="e9RoUoH1";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8C92C10E4E4;
 Mon, 20 Apr 2026 10:37:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1776681459; x=1808217459;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WpOHe4gqQyg0PeGVtkOdlg2QasofU1uFhUqvu7fU2dM=;
 b=e9RoUoH1MbNcm+wwyaaXuCpHNO6hEphPx8920EbWOpQC8wRbIx8oh2Lv
 AYczk3MGYQDeDnNFdlf2yYMBukCiLyU6sfWahBbSwdbhcIhCZucpgB1Zv
 A2l9216nOBLvZgzzv7Bh4wuMsVpLBarK0Ve/piMyJy0qhYYFz4ym3NfmK
 eF+hrqWWJYfHxl1r1nkPSf1bXsmi4KiDQJx0wEI/FihhOpyIIe8n3gtGI
 AZVmXJuYHwcPwjvC9Jy3+nUFmEWJAqcwK8XniLCa7wjb9qd55XlugDZz1
 N3CqAFlRvRf3Egqx8QpyzvKrunHP0udC/9NjvLeZ3D9TA+FJ0D9bl9T2D w==;
X-CSE-ConnectionGUID: Q3L4hsCYSxGXnb662qbOpg==
X-CSE-MsgGUID: D7kgAGDKS/utABVja3qfrA==
X-IronPort-AV: E=McAfee;i="6800,10657,11762"; a="81464760"
X-IronPort-AV: E=Sophos;i="6.23,189,1770624000"; d="scan'208";a="81464760"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Apr 2026 03:37:38 -0700
X-CSE-ConnectionGUID: J3wa5BweTxy4OWDZ9h15hQ==
X-CSE-MsgGUID: T3CQV/FvTsSlxqfn4B9cPQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,189,1770624000"; d="scan'208";a="231554586"
...
Subject: [PATCH v3 7/8] drm/i915/display: move pre-HSW clock gating init to
 display
Date: Mon, 20 Apr 2026 13:30:49 +0300
Message-ID: <20260420103705.3453499-8-luciano.coelho@intel.com>

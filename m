...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A659244EF9
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Aug 2020 21:51:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C9B46E31C;
	Fri, 14 Aug 2020 19:51:42 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/modeset-lock: Take the modeset BKL for
 legacy drivers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A2B0530B23
	for <lists+intel-gfx@lfdr.de>; Mon, 23 May 2022 10:55:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3508D10F0AD;
...
Subject: Re: [Intel-gfx] [PULL] drm-intel-next -> drm-intel-gt-next
 cross-merge sync

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 012027013B0
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 03:10:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8500010E03D;
	Sat, 13 May 2023 01:10:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 65C1810E03D
 for <intel-gfx@lists.freedesktop.org>; Sat, 13 May 2023 01:10:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683940216; x=1715476216;
 h=date:message-id:from:to:cc:subject:in-reply-to:
 references:mime-version;
 bh=bB3osiT7P9PoQ6OEEzjxhUnfiBXtsevkmaoBpojURRM=;
 b=bakPu6w/kV7sNE17UfiXXF3VojPbCNwfBXFOBYb9EyLzAzlVT9f1txrA
 WOGAlDgi4dqjYwEs9osArtmOqYHIyEI9rVp9xSsbbQnG5WRj58ewfnEy+
 PxBx69hrFd1govy90hV4efVD9BLQiDZdVYJ4ijyLOG3DjQQVH1F5hmgwW
 apx6V/RZNRFKkgdyDBygKLrob32ns7bqjvh0tTxZlB+8K7e39HbAbs+FX
 lqP8Zpww8tQIto9xliV4i2QtzlgHdea8GTRpORS8dyLzGE8NTKHz7GouA
 WEEr/bYgtTVJrjOUmBhWqu/XvycnxedVeXOMPO3zeRcpAKGN9KD4Mt2zf g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="354050576"
X-IronPort-AV: E=Sophos;i="5.99,271,1677571200"; d="scan'208";a="354050576"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 18:10:15 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10708"; a="769986876"
X-IronPort-AV: E=Sophos;i="5.99,271,1677571200"; d="scan'208";a="769986876"
Received: from adixit-mobl.amr.corp.intel.com (HELO adixit-arch.intel.com)
 ([10.212.239.47])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 18:10:15 -0700
Date: Fri, 12 May 2023 18:09:59 -0700
Message-ID: <87cz35dok8.wl-ashutosh.dixit@intel.com>

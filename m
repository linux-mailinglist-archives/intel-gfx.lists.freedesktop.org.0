...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EABB34BCC29
	for <lists+intel-gfx@lfdr.de>; Sun, 20 Feb 2022 05:28:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 949D110E144;
...
Subject: Re: [Intel-gfx] [PATCH v3 02/16] iosys-map: Add a few more helpers

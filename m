...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CB1A6AA617
	for <lists+intel-gfx@lfdr.de>; Sat,  4 Mar 2023 01:10:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46E9910E78B;
	Sat,  4 Mar 2023 00:10:29 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: Set wedged if enable guc

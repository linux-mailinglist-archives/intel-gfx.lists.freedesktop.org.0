...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D6D816CD308
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 09:25:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEF8510E500;
	Wed, 29 Mar 2023 07:25:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AB14C10E4FE;
 Wed, 29 Mar 2023 07:25:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680074721; x=1711610721;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=wekxBL3Af2q8y9quFzKvtT4g2gRPPIkVrs/xkdCSIB0=;
 b=QgiYBp8yg6bDrjfPCmNIwYuy96vbX3Og2D1O2mIkmY5VPGgundZqnOrj
 2fglA5HIGsbvrhZNSkF1uDXa5yFpW4v8IMNfSypIG3loqLb6eWenqBAuC
 IOzrsBJK+BVdgcyS+lrUh9SzTR5//39Z5iX5AuOo8Qt2JsXD1vNuYCe+9
 2e7MAoEhGDlRHg6QnPyQB3kNWcqL6kR1X5HTX47qXV1EsehAUS6kgFclH
 /qdSgDKfCVf21knS3phm5Uu5zrEueG/P7k5o1M+1L1JVBxZ3hIq0BmtLD
 P/lypFqOEkGSwiK+2SfEWelort2q2N3p8fyQHKda2BmioqDPnRH4JnUap g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="368569808"
X-IronPort-AV: E=Sophos;i="5.98,300,1673942400"; d="scan'208";a="368569808"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Mar 2023 00:24:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="827773001"
X-IronPort-AV: E=Sophos;i="5.98,300,1673942400"; d="scan'208";a="827773001"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Mar 2023 00:24:52 -0700
From: Andrzej Hajda <andrzej.hajda@intel.com>
Date: Wed, 29 Mar 2023 09:24:17 +0200
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230224-track_gt-v6-6-0dc8601fd02f@intel.com>
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v6 6/8] drm/i915: Replace custom intel
...
index 8dde3512d2d1cc..565a601fb6538b 100644
--- a/drivers/gpu/drm/i915/i915_driver.c
+++ b/drivers/gpu/drm/i915/i915_driver.c
@@ -1026,7 +1026,7 @@ void i915_driver_shutdown(struct drm_i915_private *i915)

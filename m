...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 947303F02AC
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Aug 2021 13:26:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC9C56E56A;
...
Subject: [Intel-gfx] [PATCH v3 4/9] drm: fix potential null ptr dereferences
 in drm_{auth, ioctl}

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D9D751BDC47
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 14:33:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F1D7E6ECF9;
	Wed, 29 Apr 2020 12:33:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4F2AD6EDFB
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 12:33:19 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 14:32:55 +0200
Message-Id: <20200429123307.1449297-13-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 13/25] drm/i915: Pin engine before pinning all
 objects, v3.
...
+
 	...
 	if (err)
 		goto err;
@@ -1878,14 +1911,47 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
 		}
 	}
...
+
 	...
 	if (err == -EAGAIN)
 		goto slow;
@@ -1918,7 +1984,7 @@ static int eb_relocate_parse(struct i915_execbuffer *eb)
 	return err;
...
@@ -2344,7 +2410,7 @@ static const enum intel_engine_id user_ring_map[] = {
...
@@ -2378,22 +2444,17 @@ static struct i915_request *eb_throttle(struct intel_context *ce)
...
@@ -2402,7 +2463,7 @@ static int __eb_pin_engine(struct i915_execbuffer *eb, struct intel_context *ce)
 	 */
...
@@ -2414,45 +2475,17 @@ static int __eb_pin_engine(struct i915_execbuffer *eb, struct intel_context *ce)
 	 */
...
+	return rq;
 ...
 static void eb_unpin_engine(struct i915_execbuffer *eb)
@@ -2460,6 +2493,11 @@ static void eb_unpin_engine(struct i915_execbuffer *eb)
 	struct intel_context *ce = eb->context;
 	struct intel_timeline *tl = ce->timeline;
...
@@ -2511,7 +2549,7 @@ eb_select_legacy_ring(struct i915_execbuffer *eb)
 }
...
+eb_select_engine(struct i915_execbuffer *eb)
 {
 	...
 	unsigned int idx;
@@ -2526,10 +2564,43 @@ eb_pin_engine(struct i915_execbuffer *eb)
 	if (IS_ERR(ce))
 		return PTR_ERR(ce);
...
+	intel_context_put(eb->context);
 ...
 static void
@@ -2819,7 +2890,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	if (unlikely(err))
 		goto err_destroy;
...
@@ -2959,7 +3030,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	if (eb.reloc_pool)

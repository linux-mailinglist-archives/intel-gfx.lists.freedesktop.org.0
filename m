...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A5DD3DC85B
	for <lists+intel-gfx@lfdr.de>; Sat, 31 Jul 2021 23:42:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E8A146E8F6;
	Sat, 31 Jul 2021 21:42:33 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 2/7] moduleparam: add data member to struct
 kernel_param

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 295804B0C79
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Feb 2022 12:38:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6520588EA7;
	Thu, 10 Feb 2022 11:38:55 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 08/19] fb: Delete fb_info->queue

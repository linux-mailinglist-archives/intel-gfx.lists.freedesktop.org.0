...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EA5E7D993
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Aug 2019 12:43:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D05D6E499;
...
Subject: Re: [Intel-gfx] [PATCH v10 6/6] drm/hdcp: reference for srm file
 format

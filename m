...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aOsUMzsHsGnNegIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Mar 2026 12:57:47 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8020F24BDE4
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Mar 2026 12:57:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B73B10E6C7;
	Tue, 10 Mar 2026 11:57:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=lankhorst.se header.i=@lankhorst.se header.b="ClFCEvCV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from lankhorst.se (unknown [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5CF5E10E6C4;
 Tue, 10 Mar 2026 11:57:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=lankhorst.se;
 s=default; t=1773143850;
 bh=xtcbqZBCXzv+JXsmy5j+qbxsDHsTTveOuhnZ87Hnp/s=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Subject: [PATCH v7 12/26] drm/i915/display: Use intel_de_read/write_fw in
 colorops
Date: Tue, 10 Mar 2026 12:56:54 +0100
Message-ID: <20260310115709.2276203-13-dev@lankhorst.se>

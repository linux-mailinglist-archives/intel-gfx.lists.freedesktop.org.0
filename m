...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 22C8E6D09F3
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Mar 2023 17:40:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89CFD10EEE6;
...
Subject: [Intel-gfx] [PATCH 03/12] drm/radeon: convert to using is_hdmi and

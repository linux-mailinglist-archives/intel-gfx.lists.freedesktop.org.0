...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEEBD6D2232
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Mar 2023 16:17:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9DCB210F25B;
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v2] drm/i915/gt: Hold a wakeref for the active VM

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C889E830562
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jan 2024 13:35:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA94910E68D;
	Wed, 17 Jan 2024 12:34:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
X-Greylist: delayed 426 seconds by postgrey-1.36 at gabe;
 Wed, 17 Jan 2024 12:34:29 UTC
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 10AE510E112;
 Wed, 17 Jan 2024 12:34:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1705494869; x=1737030869;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=gvLi5cJJ+s1orOefYuZNILYVv2/fVVDixX6ZSqk8r9k=;
 b=US716rzDsqh3jyNqP2ALM2ACLQIvkdp8NO4Eotk6DJ3QmTqVp9G8UF5C
 29LkChdGeMw9d540hNTtdjUSS236y8ai/AKg0kR7yvGFvssiOaB1Nx1vo
 ZbVm+nLfs+bC16kD6xnny1jdtp28dgyU1eioseKaAXpk4+iKuZNWeyegB
 AiCLMcLrhA5CzJc1DEmqlQ5N4HyaI7EKIxI46gA55Qdo4wlE5GO55XZkJ
 XGBuxnUAh8gQg3VwErCEvRUHXnzvKR7WF+HZuQhTeg3IxJ/Y+XBztoUzS
 SXDye6RQ3O347JXOTOtq1pLy+dIDZCwuXkjQYfhl45QYRH2uBAP834bCw A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10955"; a="44222"
X-IronPort-AV: E=Sophos;i="6.05,200,1701158400"; 
   d="scan'208";a="44222"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2024 04:27:22 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10955"; a="1115662852"
X-IronPort-AV: E=Sophos;i="6.05,200,1701158400"; d="scan'208";a="1115662852"
Received: from clanggaa-mobl.ger.corp.intel.com (HELO [10.249.254.57])
 ([10.249.254.57])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2024 04:27:20 -0800
Message-ID: <fe9875a1-1cd5-4b2d-bfbc-9d779e79823a@linux.intel.com>
Date: Wed, 17 Jan 2024 13:27:17 +0100
MIME-Version: 1.0
...
In-Reply-To: <0049f12e-ce96-4320-8158-c5a23164261f@linux.intel.com>
...
>>       int ret;
>>   -    hop_placement.num_placement = hop_placement.num_busy_placement 
>> = 1;
...
>> @@ -440,10 +440,9 @@ static int ttm_bo_evict(struct ttm_buffer_object 
>> *bo,
...
>> +++ b/drivers/gpu/drm/vmwgfx/vmwgfx_bo.c
>> @@ -742,9 +742,21 @@ void vmw_bo_move_notify(struct ttm_buffer_object 
>> *bo,

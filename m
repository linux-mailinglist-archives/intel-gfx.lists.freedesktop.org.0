...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A2294A8CE4
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Feb 2022 21:04:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E782110E303;
...
Subject: [Intel-gfx] [PATCH v4 3/4] drm/i915/gt: Re-work reset_csb

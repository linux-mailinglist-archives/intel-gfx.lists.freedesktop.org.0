...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C921225211E
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Aug 2020 21:51:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 387E16E999;
	Tue, 25 Aug 2020 19:51:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-2.mimecast.com
 [207.211.31.81])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0DF006E999
 for <intel-gfx@lists.freedesktop.org>; Tue, 25 Aug 2020 19:51:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 ...
 b=ZR6P2+X23oxkxfMw+zjjnlODug+MGgNQFHyerlbFYxkIdk+CC1A95A1OKv8v7R9NvYG23Q
 BPS1xrwYp6v0UvqewEZLx1RR1lll2/jKi3thTXV59FRv/fKm7IHtA1CEX2kC++rpS0V0jU
 qlTViQI3btn2x0kMfVlg5V+ZuFiLnXA=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-579-Wp5Hxt_rMCOswxYg4KWXlA-1; Tue, 25 Aug 2020 15:51:13 -0400
X-MC-Unique: Wp5Hxt_rMCOswxYg4KWXlA-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com
 [10.5.11.14])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 2251081F01D;
 Tue, 25 Aug 2020 19:51:11 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-120-227.rdu2.redhat.com
 [10.10.120.227])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 947445D9D3;
 Tue, 25 Aug 2020 19:51:09 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: dri-devel@lists.freedesktop.org, intel-gfx@lists.freedesktop.org,
 nouveau@lists.freedesktop.org
Date: Tue, 25 Aug 2020 15:50:15 -0400
Message-Id: <20200825195027.74681-9-lyude@redhat.com>
In-Reply-To: <20200825195027.74681-1-lyude@redhat.com>
References: <20200825195027.74681-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.14
Subject: [Intel-gfx] [RFC v4 08/20] drm/nouveau/kms/nv50-: Refactor and

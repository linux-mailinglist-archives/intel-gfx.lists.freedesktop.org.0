...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 06BA56CC5AF
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Mar 2023 17:16:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3C93810E934;
	Tue, 28 Mar 2023 15:16:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4296D10E8E2;
 Tue, 28 Mar 2023 15:16:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680016567; x=1711552567;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=tbt2zhreEQ/Xelj8U3ljiMX6uQQUfiNcA/9me15noEM=;
 b=H1pWx0qSDm+4EiTwHmowivSnFwtmw0PbezV7Gv8nWQ2dFE8UorMZDiZY
 Uh/lAWVVOf4J78Ji1itxSpLTuYSUcUPAps2lZjAr55oLCeVLVMUo7IfsI
 yhZofRYuKHxtmClEivLrR3VEEgRt2vjaRk+aJRy1ZaUl/5eZKzjv3E72u
 /g+m23cZ3krBGZJW7Vgecg/45gGY+d+BsCREjCmO/Xsv3+6m0xh4Sn6GJ
 yjaJhh8JVg5HZcVIhpZWOFqDz7lS72nHqEwgX0C4dp7TbBFDdSVOCrEyq
 gOsAbh7vK9jjRnGxQPzQrvz2KkJv2+BA9nuYA74Rbj56SYFdqTCyugRZe A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="403208738"
X-IronPort-AV: E=Sophos;i="5.98,297,1673942400"; d="scan'208";a="403208738"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Mar 2023 08:16:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10663"; a="773181772"
X-IronPort-AV: E=Sophos;i="5.98,297,1673942400"; d="scan'208";a="773181772"
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v5 6/8] drm/i915: Replace custom intel

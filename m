...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D311722A3BD
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jul 2020 02:36:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C52C76E111;
	Thu, 23 Jul 2020 00:36:33 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 2/2] drm/i915/dp: TPS4 PHY test pattern
 compliance support

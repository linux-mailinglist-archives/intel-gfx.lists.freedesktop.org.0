...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FFCEA1361
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Aug 2019 10:12:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 888DF6E06D;
	Thu, 29 Aug 2019 08:12:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 369206E044
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Aug 2019 08:12:08 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18299868-1500050 
 for multiple; Thu, 29 Aug 2019 09:11:55 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 29 Aug 2019 09:11:24 +0100
Message-Id: <20190829081150.10271-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/36] drm/i915: Only track bound elements of
 the GTT
...
bS9pOTE1L2k5MTVfZ2VtX2d0dC5jCmluZGV4IGQxYjg5NzE2NTUwNi4uYmQ1ZWVhYTM2NmEyIDEw
...
NS9pOTE1X2dlbV9ndHQuaAppbmRleCA2MTA5ODhiZTFjZWIuLjFkZjI1NDZhZjFhOCAxMDA2NDQK

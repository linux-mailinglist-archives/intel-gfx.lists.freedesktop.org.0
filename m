...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A1A8CC1792
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Dec 2025 09:08:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CD4B10E757;
	Tue, 16 Dec 2025 08:08:33 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="MaaIqgeZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pl1-f173.google.com (mail-pl1-f173.google.com
 [209.85.214.173])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8B0D310E758
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Dec 2025 08:08:32 +0000 (UTC)
Received: by mail-pl1-f173.google.com with SMTP id
 d9443c01a7336-2a09d981507so19865265ad.1
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Dec 2025 00:08:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1765872512; x=1766477312; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=gOLEpepy5SSffUgv88jdloEvBpMdhWt7epxR//WSpSY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1765872512; x=1766477312;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=gOLEpepy5SSffUgv88jdloEvBpMdhWt7epxR//WSpSY=;
 b=
X-Gm-Message-State: AOJu0YyZeQK3PHk/XG1pSQhc2s/KH9xJAkeL7BX0pJDSyH9dJdI9C24I
 KXvObGbvHo3LsS1gLqp0d+fqBkgK97S+PtLj5l+zHUFhuz5JNDu9kPh+sG1lFZRk960=
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IEUQ5uOKStzJlZ3rTL9B30yap5FDJqcYkxWQam525SZ0yGQDfaGPx27kmGvhyOb0byilULlCQ==
X-Received: by 2002:a17:903:f8d:b0:294:f6e5:b91a with SMTP id
 d9443c01a7336-29eeea26dadmr195127695ad.13.1765872511681; 
 Tue, 16 Dec 2025 00:08:31 -0800 (PST)
Received: from localhost ([134.134.139.75]) by smtp.gmail.com with ESMTPSA id
 d9443c01a7336-29eea016c6esm157499035ad.59.2025.12.16.00.08.29
...
Subject: [PATCH 1/2] drm/i915: switch to use kernel standard error injection
Date: Tue, 16 Dec 2025 10:07:53 +0200
Message-ID: <20251216080754.221974-2-juhapekka.heikkila@gmail.com>
...
---
 ...
 19 files changed, 17 insertions(+), 199 deletions(-)
...
index e282b533d5b6..e1d29aea0ddc 100644
...
index 9bc5ef988be7..e11189900c5a 100644
...
@@ -279,6 +276,7 @@ static int i915_driver_early_probe(struct drm_i915_private *dev_priv)
...
-
 	...
 	if (ret < 0)
 		return ret;
@@ -361,6 +356,7 @@ static int i915_driver_mmio_probe(struct drm_i915_private *dev_priv)
...
@@ -598,6 +591,7 @@ static int i915_driver_hw_probe(struct drm_i915_private *dev_priv)

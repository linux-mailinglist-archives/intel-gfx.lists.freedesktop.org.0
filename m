...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B373DAAF75D
	for <lists+intel-gfx@lfdr.de>; Thu,  8 May 2025 12:04:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 51AE810E8D6;
	Thu,  8 May 2025 10:04:12 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="bXMT5SjV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1897310E8D6;
 Thu,  8 May 2025 10:04:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1746698651; x=1778234651;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/Mmz93yI3oAq+z9xAX1Q9ndxTuUPFnsg5ZKOiUR7o7o=;
 b=bXMT5SjVwhosExo8eG9lD0uJifnn/VcQ2U2id61bxDKDHuJeO6GvjTId
 EJG/wOb7shq/5vjqfSXP2Hpo0SaXnx3HemrY01YRRPIvh7Q4dadL97QiL
 PceL3ygm9Rc2DHrehXbgD5r+rR/fT/sfFE820fiWsUNM9xcEp9xwleX0i
 VaCTN4XZpia6S+LsEtQbuPD8pABQwS9YXOb3+vLdlbtw56Cuw9zve1sPw
 dMXEtkgSOv18lzkztIr5qLXkgQ8j/kkuzGezeJ+HaSxx3CnzNdILETkwG
 Xki98vSvR/5bSeXu6wSDfWVD6K/di+FzGH0fMDRcWU1ZlFzsROqF02dgK A==;
X-CSE-ConnectionGUID: JN/hXK5zRbG35K5Q4cguPA==
X-CSE-MsgGUID: cIJZhP+0RTCHfwVxAO3+ZA==
X-IronPort-AV: E=McAfee;i="6700,10204,11426"; a="66003223"
X-IronPort-AV: E=Sophos;i="6.15,271,1739865600"; d="scan'208";a="66003223"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2025 03:04:11 -0700
X-CSE-ConnectionGUID: Zzw7Cu6KRBS6GAgETZTexA==
X-CSE-MsgGUID: NQmXrqLTTZSA1c3Djl1dqQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,271,1739865600"; d="scan'208";a="136634287"
Received: from slindbla-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.245.176])
 by fmviesa008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2025 03:04:08 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	ville.syrjala@linux.intel.com
Subject: [PATCH v2 6/8] drm/i915: convert VLV IOSF SB interface to struct
 drm_device
Date: Thu,  8 May 2025 13:03:40 +0300
Message-Id: <14e7d26529f88e0a4aaaae25702ac02afc883715.1746698410.git.jani.nikula@intel.com>
...
index 287110e4e435..0649737c7995 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8671A48728D
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jan 2022 06:31:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 451D3113268;
...
Subject: [Intel-gfx] [PATCH v11 15/19] drm_print: use

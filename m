...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C312E61EC49
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Nov 2022 08:41:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B9CCD10E251;
	Mon,  7 Nov 2022 07:40:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4FB7110E1F8
 for <intel-gfx@lists.freedesktop.org>; Mon,  7 Nov 2022 07:40:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667806834; x=1699342834;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=arqKwnUFkAFi1oAIJzdo+cxuTSGvz+pxWpVnyFwVzE8=;
 b=URdc1+mi+MajgV5l20cfFxC484Ue6d8Tfh6jacHjVJ2XzCRkqXDS9k7r
 lBOkrIV7vujsTYq39xBLZq2fch8i9r9hp/cWVYdbmqbcdxquOp8w9oh4B
 sSqCm8sw093AqvRoq/3KAZIetBYfZHeA16ZUKq4lYEJURnOILFG4Y/oFw
 L30mW/AJH4inXVgSYQbUVn4UXmiiz7+ewoxl2p9WuOxFUsU1gsKt1Anoj
 8EMlwZfgTPwezCOGWUPApray+BkGzXsG4GAELdQOtCu2ZEku6UICp/lll
 l8i1wpgNNoxV2bd65lKJPmGskGRkVIx8r910u3YdnOcKykyoz7LwpqO60 Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10523"; a="311482337"
X-IronPort-AV: E=Sophos;i="5.96,143,1665471600"; d="scan'208";a="311482337"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2022 23:40:34 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10523"; a="965051647"
X-IronPort-AV: E=Sophos;i="5.96,143,1665471600"; d="scan'208";a="965051647"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga005.fm.intel.com with ESMTP; 06 Nov 2022 23:40:31 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  7 Nov 2022 13:09:20 +0530
Message-Id: <20221107073923.1353049-6-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 41B9A684F1
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Jul 2019 10:11:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2759589856;
	Mon, 15 Jul 2019 08:11:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2DC1389856
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Jul 2019 08:11:44 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17303243-1500050 
 for multiple; Mon, 15 Jul 2019 09:09:51 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 15 Jul 2019 09:09:28 +0100
Message-Id: <20190715080946.15593-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/24] drm/i915: Lock the engine while dumping
 the active request
...
IDc1MDk5NTAwZDFlZC4uNWY4OTA5NTQ2ZDM2IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF9lbmdpbmVfY3MuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9p
bnRlbF9lbmdpbmVfY3MuYwpAQCAtMTQ3Miw2ICsxNDcyLDcgQEAgdm9pZCBpbnRlbF9lbmdpbmVf
...
ZyBmbGFnczsKIAogCWlmIChoZWFkZXIpIHsKIAkJdmFfbGlzdCBhcDsKQEAgLTE0OTEsMTAgKzE0
OTIsOSBAQCB2b2lkIGludGVsX2VuZ2luZV9kdW1wKHN0cnVjdCBpbnRlbF9lbmdpbmVfY3MgKmVu
...
dGl2ZSAiKTsKQEAgLTE1MTQsOCArMTUxNCw3IEBAIHZvaWQgaW50ZWxfZW5naW5lX2R1bXAoc3Ry
...
ZikgewpAQCAtMTY1NCw3ICsxNjUzLDYgQEAgc3RydWN0IGk5MTVfcmVxdWVzdCAqCiBpbnRlbF9l
...
Y2FwdHVyZSwgcmVzZXQgYW5kIHRvIGR1bXAgZW5naW5lCkBAIC0xNjY3LDcgKzE2NjUsNyBAQCBp
...
IAkJCWNvbnRpbnVlOwpAQCAtMTY4Miw3ICsxNjgwLDYgQEAgaW50ZWxfZW5naW5lX2ZpbmRfYWN0
...
NS9pOTE1X2dwdV9lcnJvci5jCmluZGV4IDc4ZTM4OGZhMDU5Yy4uYzViODliZjRkNjE2IDEwMDY0

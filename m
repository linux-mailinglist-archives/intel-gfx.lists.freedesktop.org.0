...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC1E338207C
	for <lists+intel-gfx@lfdr.de>; Sun, 16 May 2021 20:59:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D12FB6E848;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/3] drm/i915: Don't include drm_legacy.h

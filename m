...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04AB52E9051
	for <lists+intel-gfx@lfdr.de>; Mon,  4 Jan 2021 07:01:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79E7889AC0;
	Mon,  4 Jan 2021 06:01:40 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6303589613
 for <Intel-gfx@lists.freedesktop.org>; Mon,  4 Jan 2021 06:01:37 +0000 (UTC)
IronPort-SDR: k+EpBLKMQ61AKecoGR4Ta4261BEQXEtw2Ra1bal7z5ucYEdcPoP4M202uTZVJNeGBgVOsqAv2t
 2vMK6I7tIx9g==
X-IronPort-AV: E=McAfee;i="6000,8403,9853"; a="176135365"
X-IronPort-AV: E=Sophos;i="5.78,473,1599548400"; d="scan'208";a="176135365"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jan 2021 22:01:36 -0800
IronPort-SDR: PGmkLajmHB0QK+ln2hb0H/2bcMCgwiN/SECKja0w+vnJ830n7sJraNrCAJ9j8b2603nPEm79l3
 VT8bUW6I/RCA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,473,1599548400"; d="scan'208";a="461826930"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga001.fm.intel.com with ESMTP; 03 Jan 2021 22:01:35 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Sun,  3 Jan 2021 22:01:32 -0800
Message-Id: <20210104060135.3076-11-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210104060135.3076-1-sean.z.huang@intel.com>
References: <20210104060135.3076-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v18 10/13] mei: pxp: export pavp client to me
 client bus

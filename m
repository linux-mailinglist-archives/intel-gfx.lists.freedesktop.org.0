...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C8C625BF6F
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Sep 2020 12:51:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A0376E929;
	Thu,  3 Sep 2020 10:51:32 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-1.mimecast.com
 [207.211.31.81])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4559E6E1B8
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Sep 2020 10:51:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1599130289;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=Vz/DPJyK8Z7twHTt1MIA2s6MtCK9x+8KAwAMVF0PM/w=;
 b=hX/NNYndnKnLBBRGtWmLqQPCWupNedkEkCAnhoUTPMLMxNLwlJgU6STCYx3lhMb1LdTByT
 Y7u5uIRIis2xdcouJ4H810c33XBdfFOYFQd6tgzubOPuyRU6NMzPJT/ydjD8VjkK00RGMo
 maMBW3iCTAPsMyZFuZOxzhfce/v3IDw=
...
Subject: [Intel-gfx] [PATCH v9 02/17] ACPI / LPSS: Save Cherry Trail PWM ctx
 registers only once (at activation)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C9D3CD8BBF
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Oct 2019 10:52:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C8506E902;
	Wed, 16 Oct 2019 08:52:53 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH V3 4/7] mdev: introduce device specific ops

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1784C4FBEAA
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:15:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2EC2F10ED94;
...
Subject: [Intel-gfx] [PATCH 24/34] drm/i915/gvt: remove the extra

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DAB3458049A
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Jul 2022 21:41:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 122E08F40C;
	Mon, 25 Jul 2022 19:41:37 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: Use of BARs names instead of
 numbers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6173431737E
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Feb 2021 23:38:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFE5C6ED14;
	Wed, 10 Feb 2021 22:38:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B44806ED14
 for <intel-gfx@lists.freedesktop.org>; Wed, 10 Feb 2021 22:38:06 +0000 (UTC)
IronPort-SDR: FRS1ex/mZgQsP+oQIPCke6P1nQ7CbGHj8BVEnPtSt1mWRaDDePL7fDPSl4/rMpMZfHW7j5lvS9
 uP+HbNzQt5ew==
X-IronPort-AV: E=McAfee;i="6000,8403,9891"; a="169289372"
X-IronPort-AV: E=Sophos;i="5.81,169,1610438400"; d="scan'208";a="169289372"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Feb 2021 14:38:05 -0800
IronPort-SDR: 7aoXq9nHMZYUiDh079spULWeFZLMD0Th4dei5s7lGx6nA7As1hN7x+9zGN1J77FRzee9gvV2c4
 +Yn9Jq02h5Hw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,169,1610438400"; d="scan'208";a="421232242"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
 by fmsmga002.fm.intel.com with ESMTP; 10 Feb 2021 14:38:05 -0800
Received: from fmsmsx612.amr.corp.intel.com (10.18.126.92) by
 fmsmsx603.amr.corp.intel.com (10.18.126.83) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2106.2; Wed, 10 Feb 2021 14:38:05 -0800
Received: from fmsmsx611.amr.corp.intel.com (10.18.126.91) by
 fmsmsx612.amr.corp.intel.com (10.18.126.92) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2106.2; Wed, 10 Feb 2021 14:38:04 -0800
Received: from fmsmsx611.amr.corp.intel.com ([10.18.126.91]) by
 fmsmsx611.amr.corp.intel.com ([10.18.126.91]) with mapi id 15.01.2106.002;
 Wed, 10 Feb 2021 14:38:04 -0800
From: "Tang, CQ" <cq.tang@intel.com>
To: Chris Wilson <chris@chris-wilson.co.uk>, "intel-gfx@lists.freedesktop.org"
 <intel-gfx@lists.freedesktop.org>
Thread-Topic: [PATCH] drm/i915/gt: Ratelimit heartbeat completion probing
Thread-Index: AQHW+6yKrO5uexLbWkmbVzEQDnvyAKpKJi4AgAfaLFA=
Date: Wed, 10 Feb 2021 22:38:04 +0000
Message-ID: <dc7979b1848f4ab08717ecc6d0a2c4ad@intel.com>
References: <20210205104905.31414-1-chris@chris-wilson.co.uk>
 <20210205143220.18148-1-chris@chris-wilson.co.uk>
In-Reply-To: <20210205143220.18148-1-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH] drm/i915/gt: Ratelimit heartbeat completion
 probing

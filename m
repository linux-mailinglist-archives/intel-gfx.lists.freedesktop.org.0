...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6159079448F
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Sep 2023 22:30:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 27C8610E72C;
	Wed,  6 Sep 2023 20:30:12 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 3/5] drm/msm: add trailing newlines to
 drm_dbg msgs
...
Cc: freedreno@lists.freedesktop.org, jani.nikula@intel.com,
 daniel.vetter@ffwll.ch, seanpaul@chromium.org, daniel@ffwll.ch,

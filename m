...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A4EFE4EA7D9
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Mar 2022 08:27:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25B9F10F05B;
...
Subject: Re: [Intel-gfx] [PATCH v7 1/9] drm/i915/gt: use engine instance
 directly for offset

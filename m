...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6A2713DC63
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Jan 2020 14:52:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D6FA76ED15;
...
Subject: [Intel-gfx] [PATCH 3/4] drm/i915/display: conversion to new logging
 macros part 3

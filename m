...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB77226A821
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 17:01:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F5B56E8E8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 19/21] drm/xen: Introduce GEM object functions

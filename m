...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80CF24F6B32
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Apr 2022 22:19:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC41410E055;
	Wed,  6 Apr 2022 20:19:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E480210E040
 for <intel-gfx@lists.freedesktop.org>; Wed,  6 Apr 2022 20:19:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1649276364; x=1680812364;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=A9oWRkwAGfmEBsd8q8orCxn8RZKlX6MgSWAab/XKlcs=;
 b=ejbPO/ckUAPLFxUq4XbUjUuOfQHDpPpsJ9b0OfccekM1V2sm4DVnEDBI
 GeaGXo7utmuth6C5kpYUEgCx5fe29uafcg+NZ59dBQqfpAxRREzQ9QB9u
 /28ICCIBCh8NNvO7wIIeGIeX8dsHeC25ZAhqdIewvnNrmWSbQ4YrKno0R
 rxL8GesCpJht11ZsUIRio/A9jaDM/1W8VBRC7hIlAZbyLsqRRAd+t9LHs
 M7OWAgNeB4gtRzvbFEVqNKOc8hQneabWfFCQs5Kbe8PNX3hUW/IWlRApW
 WwZpbfQkwkTbT58Cg8Ff3m+cX60QRZw754qhs6ybduOupCQFGhv24Nt3H g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10309"; a="286119296"
X-IronPort-AV: E=Sophos;i="5.90,240,1643702400"; d="scan'208";a="286119296"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Apr 2022 13:19:20 -0700
X-IronPort-AV: E=Sophos;i="5.90,240,1643702400"; d="scan'208";a="505872344"
Received: from aclausch-mobl.amr.corp.intel.com (HELO ldmartin-desk2)
 ([10.209.8.158])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Apr 2022 13:19:20 -0700
Date: Wed, 6 Apr 2022 13:19:19 -0700
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: Casey Bowman <casey.g.bowman@intel.com>
Message-ID: <20220406201919.bywa7d2p3yvvrduz@ldmartin-desk2>
...
References: <20220330234809.1218210-1-casey.g.bowman@intel.com>
 ...
 <70b323ad-c672-35f7-f1f7-a520cf015665@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1; format=flowed
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <70b323ad-c672-35f7-f1f7-a520cf015665@intel.com>
...
Cc: thomas.hellstrom@linux.intel.com, intel-gfx@lists.freedesktop.org,
 chris@chris-wilson.co.uk, Rodrigo Vivi <rodrigo.vivi@intel.com>
...
>>>-
>>>  /**
>>>   * i915_ggtt_suspend_vm - Suspend the memory mappings for a GGTT 
>>>or DPT VM
...
>>>-    GEM_BUG_ON(gte > end);
>>>-
>>>-    /* Fill the allocated but "unused" space beyond the end of 
>>>the buffer */
>>>-    while (gte < end)
...
>>>- * reference offsets within the global GTT as well as accessible 
>>>by the GPU
...
>>>-}
>>>-
>>>-static void bxt_vtd_ggtt_insert_page__BKL(struct 
...
>>>@@ -725,10 +444,10 @@ static int init_aliasing_ppgtt(struct 
>>>i915_ggtt *ggtt)
>>>      ggtt->alias = ppgtt;
...
>>>@@ -751,8 +470,8 @@ static void fini_aliasing_ppgtt(struct 
>>>i915_ggtt *ggtt)
...
>>>-
>>>-    /*
>>>-     * On BXT+/ICL+ writes larger than 64 bit to the GTT 
>>>pagetable range
>>>-     * will be dropped. For WC mappings in general we have 64 
>>>byte burst
>>>-     * writes when the WC buffer is flushed, so we can't use it, 
>>>but have to
>>>-     * resort to an uncached mapping. The WC issue is easily 
>>>caught by the
...
>>>  {
>>>      return (struct 
>>>resource)DEFINE_RES_MEM(pci_resource_start(pdev, bar),
...
>>>          dma_resv_fini(&ggtt->vm._resv);
>>>          return ret;
>>>@@ -1267,10 +634,7 @@ int i915_ggtt_probe_hw(struct 
>>>drm_i915_private *i915)
...
>>>+#else
>>>+static inline void intel_gt_gmch_gen5_chipset_flush(struct 
>>>intel_gt *gt)
>>>+{
>>>+}
...
>>>+++ b/drivers/gpu/drm/i915/gt/intel_gtt.h
>>>@@ -549,6 +549,14 @@ i915_page_dir_dma_addr(const struct 
>>>i915_ppgtt *ppgtt, const unsigned int n)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 652535B7B85
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Sep 2022 21:42:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCB5E10E306;
...
Subject: Re: [Intel-gfx] [PATCH v5 2/5] drm/i915: Parse and set stepping for
 platforms with GMD

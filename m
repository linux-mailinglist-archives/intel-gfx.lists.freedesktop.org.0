...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34A4854E079
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Jun 2022 14:02:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5DD4A11A4D9;
...
Subject: [Intel-gfx] [PATCH v2 9/9] drm/i915/rpm: d3cold Policy

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB4793C94E7
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jul 2021 02:20:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B02F6E4F4;
...
Subject: [Intel-gfx] [PATCH 01/13] vfio/samples: Remove module get/put

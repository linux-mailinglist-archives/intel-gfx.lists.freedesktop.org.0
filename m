...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C807CD3AB5
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Oct 2019 10:18:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2AF8D6E069;
...
Subject: [Intel-gfx] [PATCH V3 3/7] modpost: add support for mdev class id

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 95F3C4429E2
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 09:52:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 089086FF14;
	Tue,  2 Nov 2021 08:52:41 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 1/2] drm/i915/ttm: Reorganize the ttm
 move code

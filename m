...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8MtJNgHmsmktQwAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Mar 2026 17:12:49 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 82ACF2754C4
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Mar 2026 17:12:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F9DE10EA64;
	Thu, 12 Mar 2026 16:12:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="hTXmDcsO";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0F69710EA5D;
 Thu, 12 Mar 2026 16:12:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1773331963; x=1804867963;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=5bFRno/x5CuND9g6xv0lanCw5CYbDU9w0cEWHBHlDpc=;
 b=hTXmDcsOdP6CGwvKTFEq3U6fqP4tVLELCSMIFTy8pHcWuvNt0AnH8oFC
 wgdGmGYOgllWT5R+OW4pomxF0bX4lwax1jcTVSzhuwflYpeYJqBcfYF46
 OenIU93lm0v8Nrh/wX+xE2Ka0yMJxs5beqSuhxZt0R+5VECbKxmr7if+h
 +uXZwmOp7gWD5p1u87WoEt2eqJ0a4sfgOU9gaTrs4nx8NGhl1y//qcFHr
 ip1OFB/IaqeQ5iMvLjjGesLNYaA2uam9M9ltOQPyzRE6CRxA++6hGesH5
 5DDqqYwx8HWpW3W5UcAvrRyl0SnGoZ9ac8xUI6cY2vrTRzT3NL2mQDfcx g==;
X-CSE-ConnectionGUID: vkrB9tyaQi2aVaetx3R6iA==
X-CSE-MsgGUID: bOpEXm84RXuFK73nWj83AA==
X-IronPort-AV: E=McAfee;i="6800,10657,11727"; a="85910025"
X-IronPort-AV: E=Sophos;i="6.23,116,1770624000"; d="scan'208";a="85910025"
...
X-Spamd-Result: default: False [1.19 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[przemyslaw.kitszel@intel.com,intel-gfx-bounces@lists.freedesktop.org];

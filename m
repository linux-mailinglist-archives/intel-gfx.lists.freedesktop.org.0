...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F3B26AB2CD
	for <lists+intel-gfx@lfdr.de>; Sun,  5 Mar 2023 23:11:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D24910E062;
	Sun,  5 Mar 2023 22:11:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from madras.collabora.co.uk (madras.collabora.co.uk
 [IPv6:2a00:1098:0:82:1000:25:2eeb:e5ab])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 206D010E013;
 Sun,  5 Mar 2023 22:11:30 +0000 (UTC)
Received: from workpc.. (unknown [109.252.117.89])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 (Authenticated sender: dmitry.osipenko)
 by madras.collabora.co.uk (Postfix) with ESMTPSA id 66AA3660209A;
 Sun,  5 Mar 2023 22:11:27 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
 s=mail; t=1678054289;
 bh=YfFhN78ea1T6xVkXbqPB80ijZO7EFGx6lRMs7RdDxiE=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Date: Mon,  6 Mar 2023 01:10:01 +0300
Message-Id: <20230305221011.1404672-2-dmitry.osipenko@collabora.com>
...
Subject: [Intel-gfx] [PATCH v12 01/11] drm/shmem-helper: Switch to
 reservation lock
...
index 5762806e4689..651ca7f380a2 100644

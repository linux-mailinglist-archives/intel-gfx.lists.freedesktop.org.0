...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A52421C8C42
	for <lists+intel-gfx@lfdr.de>; Thu,  7 May 2020 15:27:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0F2BF6E994;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 00/14] In order to readout DP SDPs,

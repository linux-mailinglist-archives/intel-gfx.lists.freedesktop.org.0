...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 136D99BE0C
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Aug 2019 15:38:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC5826E0C4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] dma-buf: Extend selftests to exercise
 dma-fence-array

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 452B977F246
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Aug 2023 10:37:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49E7310E419;
	Thu, 17 Aug 2023 08:37:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2C21210E413
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Aug 2023 08:37:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692261441; x=1723797441;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Cj0122m3w6h34RX4GbsWSdNktmmsjJcQv9SPe+Cg5UA=;
 b=cLA+mQr3xHZRNE9a9Z5WeHIOcrMml6lQpYSnb3Pbpt1pnudZpDKHwTLW
 id+uhYv0C2Q4ww9CXx8e2RzTGvVR/tg4GZIEiekC4eHwjRvrSPsEVwDWZ
 y5dMtGpaXzJYLfUmlW5MhoGpecLV4u11PbTT5UkwdHsG4PYDBBoIAkIkF
 kGnYTTN1YGMzKU82TufXVbL3cOaor+hMxaEsbaFUcyz8x25IwIUzRHSwy
 lzU4XN2/gdgREM/EEH1GQ/H6680B5/kNQr98EOIcUgv3AP1kEuE2u0Rjm
 /Xi/iy7Xy3jHkGw1aqT27NIZC3gntzYee1KAf23qMH5mX+HsbmXdT4RFc Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10803"; a="357715606"
X-IronPort-AV: E=Sophos;i="6.01,179,1684825200"; d="scan'208";a="357715606"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Aug 2023 01:37:20 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10803"; a="804549403"
X-IronPort-AV: E=Sophos;i="6.01,179,1684825200"; d="scan'208";a="804549403"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga004.fm.intel.com with ESMTP; 17 Aug 2023 01:37:18 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 17 Aug 2023 14:05:21 +0530
Message-Id: <20230817083524.296571-6-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 5/8] drm/i915/vdsc: Add function to write in
 PPS register

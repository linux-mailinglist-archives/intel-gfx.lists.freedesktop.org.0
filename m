...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C05CB66A323
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 20:31:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79FA110EAD8;
...
Subject: [Intel-gfx] [PATCH v2 07/20] dyndbg: reduce verbose/debug clutter

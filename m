...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A18D77D9E23
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Oct 2023 18:40:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C13BC10EA0F;
	Fri, 27 Oct 2023 16:40:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2F88910EA0E;
 Fri, 27 Oct 2023 16:40:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1698424807; x=1729960807;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=2gKJA15btztnAvx4BqjDLH0JXtSlIaJaRjsC/n0xkPE=;
 b=OeYAwYfrCgYwRALfnfF1nR5WKvRXxnWaqgDJS0ceYLFVffSPE4Ivlx/L
 SVT0VVl6u0336TYAXauQTu+xWMLqx+p20UXBCqrcBlbVkcxjPkQZZr/F0
 iuPfctxs28NFg35ivwqIN6AxcMV+1fCZYOCZoLSaZb2J3iZfE2DGTyvk/
 fKlvxlbwSICuiIrPbRg9cUxzCye+pCi2I5OxavAkxslzzjAC0l2wNwPuG
 WRasQRwDUApslr1QCQA/cLh3p/tMvPSV3Cm+7utmSrZ+jMy4HFNmqCjsU
 zb2F23AwgrPW0IW2oSqZ4x8Jx+ga/g4Lsf25Gp+L/EhnLQC0pNWsp7LE4 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10876"; a="418919448"
X-IronPort-AV: E=Sophos;i="6.03,256,1694761200"; d="scan'208";a="418919448"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2023 09:40:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10876"; a="825396632"
X-IronPort-AV: E=Sophos;i="6.03,256,1694761200"; d="scan'208";a="825396632"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2023 09:39:56 -0700
Date: Fri, 27 Oct 2023 19:40:26 +0300
From: Imre Deak <imre.deak@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <ZTvn2d3YWKpVWuHb@ideak-desk.fi.intel.com>
References: <20231024010925.3949910-9-imre.deak@intel.com>
 <20231024102219.4035939-2-imre.deak@intel.com>
 <ZTvb3F7vo3HRK5sA@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <ZTvb3F7vo3HRK5sA@intel.com>

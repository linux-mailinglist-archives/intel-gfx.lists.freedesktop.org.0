...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 31E236EF725
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Apr 2023 17:03:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C694E10E9F6;
...
Subject: [Intel-gfx] [PATCH v10 07/22] vfio: Block device access via device

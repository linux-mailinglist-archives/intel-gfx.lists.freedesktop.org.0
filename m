...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E10C66DB89
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Jan 2023 11:51:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C404910E474;
	Tue, 17 Jan 2023 10:51:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2935C10E474
 for <intel-gfx@lists.freedesktop.org>; Tue, 17 Jan 2023 10:51:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1673952694; x=1705488694;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=uf1uOcuH5mWSePcA7c9jd+GqiNxPn5mFfQKyOpzXa5k=;
 b=Gg4ueCRT6vDnQuj0NwGqewnMt4zDuvihD98CzucdkvwA2kZ++jU8K2+c
 gzef9iOAQPU72AWE1s1vW6YeUg19g7Ge56zn9JU0wRDu3PtYRIJ5aakMh
 sq7EKW1A9tygqp1SnUu9cYBK6vRyq//E0l6AXhwb7re9nwqVwUejDoMwy
 prHjDpJ+NzoWskm6dNH/mZ84TOuWBllmhTFc8YIzu2MLRqV0k9Y7t4XPf
 C+yGpo9IEwibqDUNMeqTUijcEQsi1IyGN7e9PUhGXwRT9L42braTnk8rM
 jlH0tjOKFZor0Y7PebAJATgYXoIirXkI4zU8DFI1FNSihSJ9JB0jgyIYf g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10592"; a="389164209"
X-IronPort-AV: E=Sophos;i="5.97,222,1669104000"; d="scan'208";a="389164209"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2023 02:51:31 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10592"; a="748009055"
X-IronPort-AV: E=Sophos;i="5.97,222,1669104000"; d="scan'208";a="748009055"
Received: from rdaly-mobl.ger.corp.intel.com (HELO [10.213.212.83])
 ([10.213.212.83])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2023 02:51:29 -0800
Message-ID: <bad960e2-1f0d-b42c-2856-33ae7e56c6a4@linux.intel.com>
Date: Tue, 17 Jan 2023 10:51:27 +0000
MIME-Version: 1.0

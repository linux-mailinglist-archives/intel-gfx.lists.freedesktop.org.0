...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BE28127E8B
	for <lists+intel-gfx@lfdr.de>; Thu, 23 May 2019 15:45:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA3D389F0A;
	Thu, 23 May 2019 13:45:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp.domeneshop.no (smtp.domeneshop.no
 [IPv6:2a01:5b40:0:3005::1])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6283A89E4C;
...
Received: from 211.81-166-168.customer.lyse.net ([81.166.168.211]:53376
 ...
 id 1hTo1N-0002si-8K; Thu, 23 May 2019 15:44:37 +0200
From: =?UTF-8?q?Noralf=20Tr=C3=B8nnes?= <noralf@tronnes.org>
To: dri-devel@lists.freedesktop.org
Date: Thu, 23 May 2019 15:44:12 +0200
Message-Id: <20190523134413.4210-8-noralf@tronnes.org>
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt;
 ...
 bh=Zw1CtnfdsswuCdIGzvMFk2cWMsESOmhoSwYV64OsfCI=; 
 b=;
Subject: [Intel-gfx] [PATCH v6 7/8] drm/fb-helper: Move out modeset config
 code
...
c2V0LmMgYi9kcml2ZXJzL2dwdS9kcm0vZHJtX2NsaWVudF9tb2Rlc2V0LmMKaW5kZXggYjJhZWRl
YzY1NjM3Li5lOGI1YzU0ZDZjMDUgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9kcm1fY2xp
...
ci5jCmluZGV4IDQ3ODhmNWEyODUxMy4uNmI5NTZiMGQyNzMwIDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vZHJtX2ZiX2hlbHBlci5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9kcm1fZmJfaGVs
cGVyLmMKQEAgLTQzLDEwICs0Myw2IEBACiAKICNpbmNsdWRlICJkcm1faW50ZXJuYWwuaCIKIAot
...
RVNDKGZiZGV2X2VtdWxhdGlvbiwKQEAgLTE2OTgsNjk0ICsxNjk0LDYgQEAgdm9pZCBkcm1fZmJf

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 429B15686F8
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Jul 2022 13:44:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F066511A0D3;
	Wed,  6 Jul 2022 11:44:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 377E311A0D6
 for <intel-gfx@lists.freedesktop.org>; Wed,  6 Jul 2022 11:44:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1657107862; x=1688643862;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lXgMuR8sPrajA+PKyAeEX+NjbEOER6A/JVw4GpN6+mc=;
 b=i8aHYuPxoYgOmOP6o1BlJYNe4BJfPUYrGZwSccTTPGyAIxmgt8dL4DVm
 FSX84Z2ctDqjFMwJc4l6U3WUgTnsOVRs3LHcDh1GzNYM+kdGnyNMjdFET
 sLkTI05REzeN2dUGZgGPm/uRO/DEHSQ8Iki9OFeqLH4OOO+S/MZ533ad4
 F0GpjJHzeaw06b5KryCi2SwaOmJp2zEiogbvMg1IH0UCPZJfOzAdRTGVA
 TdB0HRYXUVn8nlmV66sOlB/JeEkmY7GKF8dG7jls+1nBKqA2OMBH4gwFu
 iQ7aGHwuQrUX1+Dv/yss18rdHvG8vRly+9H3nP0httotufmEJ6Dpj+Xb9 w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10399"; a="284459535"
X-IronPort-AV: E=Sophos;i="5.92,249,1650956400"; d="scan'208";a="284459535"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jul 2022 04:44:21 -0700
X-IronPort-AV: E=Sophos;i="5.92,249,1650956400"; d="scan'208";a="650630186"
...
Date: Wed,  6 Jul 2022 14:43:38 +0300
Message-Id: <20220706114345.1128018-8-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 07/14] mei: extend timeouts on slow devices.

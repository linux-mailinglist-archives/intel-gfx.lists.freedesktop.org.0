...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 377855BED6F
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Sep 2022 21:17:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0140C10E75D;
	Tue, 20 Sep 2022 19:17:03 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 2/3] drm/i915: Split

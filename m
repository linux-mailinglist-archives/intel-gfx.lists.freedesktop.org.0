...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56DE159A8E2
	for <lists+intel-gfx@lfdr.de>; Sat, 20 Aug 2022 00:55:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBD0E10EA55;
	Fri, 19 Aug 2022 22:54:21 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 13/15] drm/i915/huc: better define HuC status

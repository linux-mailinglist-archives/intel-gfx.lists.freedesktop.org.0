...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 587DB7AC5F3
	for <lists+intel-gfx@lfdr.de>; Sun, 24 Sep 2023 02:05:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 291DE10E0B8;
...
Subject: [Intel-gfx] [drm-tip:drm-tip 4/6]
 arch/x86/include/asm/string_32.h:195:29: warning: '__builtin_memset'
 writing 16 bytes into a region of size 0 overflows the destination

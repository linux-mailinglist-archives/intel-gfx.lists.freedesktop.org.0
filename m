...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 89AE276E95B
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Aug 2023 15:05:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0374D10E609;
	Thu,  3 Aug 2023 13:05:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A241A10E60C
 for <intel-gfx@lists.freedesktop.org>; Thu,  3 Aug 2023 13:05:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1691067933; x=1722603933;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qIltKNvgz24P+gBubxQultK0eqgrwP3w0/occj+DCXQ=;
 b=EunoGSOR9Y2ZqW+ARMKkOuPaT/AZMRDmYyjRCJ4FGZNObsbouB5SrAUw
 AUBokp0xnHB4HgC5IfJmNa0HZFi26HNCgfTtTPtYbM/glN0HCWfbF8Gfl
 Y6z+Lfuqq7UWGhRim6w9wIOI4ERBu8pM9G1YhIIhxlF5WlMrxGE2SHXkj
 HElqvgmZlslMjtgFlYjsO+d8Ddz/a8xiPxpyx4eJm5yJniPVfOEPXuTVy
 mkNQ4s5UVUWESAHQF40U7gK2xTdKgg21Y43YlILQmZL53/ZVwkZHyek1u
 4HqRVcPoK8CxqqeoJWwGbHuVJxYkz9VHIMqeceblQonw7Z1dplKewBBQB w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10791"; a="359906497"
X-IronPort-AV: E=Sophos;i="6.01,252,1684825200"; d="scan'208";a="359906497"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Aug 2023 06:05:33 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10791"; a="843585824"
X-IronPort-AV: E=Sophos;i="6.01,252,1684825200"; d="scan'208";a="843585824"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga002.fm.intel.com with ESMTP; 03 Aug 2023 06:05:31 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  3 Aug 2023 18:33:36 +0530
Message-Id: <20230803130337.3784597-7-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 6/8] drm/i915/vdsc: Remove unused dsc
 registers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BA4858994D
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Aug 2022 10:30:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C4D349145A;
	Thu,  4 Aug 2022 08:30:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EA85F8B6DD
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Aug 2022 08:30:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1659601802; x=1691137802;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=d4cj1AWR+ph9WDZLstDz2ju+uQVg8U8AZY4MclTFbsk=;
 b=NNgmu+e1chsjxDx34qQomZU6j4Wtf/CzpbJ6TvX6h7tTb3Di0ChIBSsJ
 R7rwJw+qvKnb/QkJS/ydCoDUslWHhbdYv4cWtrtp3yI1ZJzJMMoopEKx6
 F3vnmV2Ym12pPzC0GACTXL07i045YVyy+jtREw0SKsqq8zyiCLYyhRrZv
 jTk1yZi80OJtIOdQT4O06bf7Uc1wiK4yESQJMpNee28/HYhNeZay6RBKb
 QJmESz4vtGELJeS39dsurqaBLF3dpKozeL/SeOSYQo2yxZwZuoi0XdHSQ
 YeZjx8T9dJvpVVv1mxyqub5zzYkRspCTxI6TBHM94OdGuT1Ot8jncLF5Z g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10428"; a="291094589"
X-IronPort-AV: E=Sophos;i="5.93,215,1654585200"; d="scan'208";a="291094589"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Aug 2022 01:30:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,215,1654585200"; d="scan'208";a="636010338"
Received: from kandpal.iind.intel.com ([10.190.239.32])
 by orsmga001.jf.intel.com with ESMTP; 04 Aug 2022 01:29:57 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  4 Aug 2022 13:58:39 +0530
Message-Id: <20220804082840.3468949-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/2] drm/i915: Define WD trancoder for i915

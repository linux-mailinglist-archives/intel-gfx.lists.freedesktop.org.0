...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C490D4E4868
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Mar 2022 22:41:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC7BB10E54B;
...
Subject: [Intel-gfx] [RFC 01/19] drm/edid: add

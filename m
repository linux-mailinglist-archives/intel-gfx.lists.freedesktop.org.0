...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CE498526908
	for <lists+intel-gfx@lfdr.de>; Fri, 13 May 2022 20:11:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4978010E3AD;
	Fri, 13 May 2022 18:11:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8563D10E138
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 May 2022 18:11:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1652465491; x=1684001491;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=ienZQaXWmrO3T1ySJFRA5BFFiLTtL0nqZP0BQngquY4=;
 b=JFCXL4nqT0F97y5TzoLbEoOK56wsMnoN9mWFayE4bYBz1L392RDdP4W0
 kS9v1/OJh0BoYU117yJ6yQPcU8NNX+d9tokk5RuGMzInC39MGLaeuCtiC
 v7cO8lFo0lvNov1H9CcbLFTySwb/To7QYNWwmTADyWI+nYaWSVld/0u/2
 GB4jgHGF8DDuvL/IcZlRwf46lRuF4k4f5/zLUxWx8rzwHnIeX0PV3gAEm
 z4YLCNONvJVNKpvo8E+rOy/qyAkZoMH20HKDYvFZyyeavwIZECN4J+6vu
 Iwx8fQu6LtklpObdBSKE30HxmhDdXFf8tjoix1Q6q95bbpW9Edz2cs0Uo w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10346"; a="252421279"
X-IronPort-AV: E=Sophos;i="5.91,223,1647327600"; d="scan'208";a="252421279"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2022 11:11:30 -0700
X-IronPort-AV: E=Sophos;i="5.91,223,1647327600"; d="scan'208";a="896326786"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 May 2022 11:11:30 -0700
Date: Fri, 13 May 2022 11:11:29 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: Nirmoy Das <nirmoy.das@intel.com>
Message-ID: <Yn6fUXoih5wjrz3p@mdroper-desk1.amr.corp.intel.com>

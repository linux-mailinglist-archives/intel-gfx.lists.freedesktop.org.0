...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A32D5100F34
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Nov 2019 00:03:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAE5E6E84C;
	Mon, 18 Nov 2019 23:03:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DC0E46E072
 for <intel-gfx@lists.freedesktop.org>; Mon, 18 Nov 2019 23:03:09 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19248363-1500050 
 for multiple; Mon, 18 Nov 2019 23:02:56 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 18 Nov 2019 23:02:42 +0000
Message-Id: <20191118230254.2615942-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/19] drm/i915: Mark up the calling context for
 intel_wakeref_put()
...
Yy5jCmluZGV4IGY3YzhmZWM0MzZhOS4uZmVjNDZhZmI5MjY0IDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9scmMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9n
dC9pbnRlbF9scmMuYwpAQCAtMTE3Myw3ICsxMTczLDcgQEAgX19leGVjbGlzdHNfc2NoZWR1bGVf

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C0606592FF
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Dec 2022 00:01:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAB5C10E425;
	Thu, 29 Dec 2022 23:01:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F1CFD10E425;
 Thu, 29 Dec 2022 23:01:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672354911; x=1703890911;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=Hu1TS48EoSZAG0ptwDwT9ed9Iq+roxmTa/VUEhBQr5k=;
 b=G/yric8ClgfGDAbLjX8rlhz8fsGwGDGjmAo7GF8A0IEG9BlbmnMNmT3b
 OTuvMXvLV4nDwV42Fsvbhx1LSaBZT+y1n/3wo70b6YHERwZ1x+vFIB9dr
 Ht36D/ApDfyh/aqlXwsqcjgiGFt0okBmE/I/s/M9DjiV2I1UA0D7pKXmU
 7KGfhhM8jBEHu4PoAOpo+fN6Fu7wfngkjR7OrP6/zG/AhwgEXlufoJ1Qh
 TKq+9ViCRJfGvqipjXNhIpptf2rWTRDem5oQixc3kDwDvFy6NoCEKREpA
 KzOfIlixJAuSHhmkHiVeemsfPYQ2OIdlhGQl8onDeAfWNGZ396hZ35m5T Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10575"; a="321196842"
X-IronPort-AV: E=Sophos;i="5.96,285,1665471600"; d="scan'208";a="321196842"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Dec 2022 15:01:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10575"; a="631379572"
X-IronPort-AV: E=Sophos;i="5.96,285,1665471600"; d="scan'208";a="631379572"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
 by orsmga006.jf.intel.com with ESMTP; 29 Dec 2022 15:01:39 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1pB1u6-000HAj-2J;
 Thu, 29 Dec 2022 23:01:38 +0000
...
References: <20221229113338.2436892-1-andrzej.hajda@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="11Wfy2ZpRHnrONje"
Content-Disposition: inline
In-Reply-To: <20221229113338.2436892-1-andrzej.hajda@intel.com>
Subject: Re: [Intel-gfx] [PATCH v2] arch: rename all internal names __xchg
 to __arch_xchg
...
Cc: Mark Rutland <mark.rutland@arm.com>, Arnd Bergmann <arnd@arndb.de>,
 ...
 Andrzej Hajda <andrzej.hajda@intel.com>, oe-kbuild-all@lists.linux.dev,
...
# Linux/alpha 6.1.0-rc3 Kernel Configuration
#

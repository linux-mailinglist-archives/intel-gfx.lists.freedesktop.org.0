...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 439D97055B7
	for <lists+intel-gfx@lfdr.de>; Tue, 16 May 2023 20:11:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A98A310E35B;
...
Subject: [Intel-gfx] [PATCH v9 1/2] drm/i915/mtl: end support for set
 caching ioctl

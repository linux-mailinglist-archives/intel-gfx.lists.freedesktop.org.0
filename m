...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B82A9168884
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Feb 2020 22:03:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 345BB6F516;
	Fri, 21 Feb 2020 21:03:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x443.google.com (mail-wr1-x443.google.com
 [IPv6:2a00:1450:4864:20::443])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 73FD06F513
 for <intel-gfx@lists.freedesktop.org>; Fri, 21 Feb 2020 21:03:33 +0000 (UTC)
Received: by mail-wr1-x443.google.com with SMTP id m16so3508680wrx.11
 for <intel-gfx@lists.freedesktop.org>; Fri, 21 Feb 2020 13:03:33 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=6U9YnUAy0H1QEWxkVE1BNWRexHF1a5IK40Fp7mWEcSs=;
 b=XGX4Wb95dDv5VzuFJfdWS8D+q3Q4NLX4Y/ZLrnS4YW2syR1VxLf5SA6G4weq9hvSAj
 CP0lzagFFdafCpcs1vNEy8n9PX6jdC1+GTvbgpyOeRy3tbynOZBvfvxaAwwDoA8RdtqK
 q74V8NU313sITa7ZbYQF1c7MQY92ybXDKU86k=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=6U9YnUAy0H1QEWxkVE1BNWRexHF1a5IK40Fp7mWEcSs=;
 b=
X-Gm-Message-State: APjAAAVvsYoCo7RAa321AYd+onF3Bv9ut5zEhR/Uac1eayDzAThsb9kG
 k0FNbd22sfA4jq8KK1y3JUv6kQ==
X-Google-Smtp-Source: APXvYqzRNNvP0KRmQivT70cKGXuqVTiIRkIk8OC2JrAYorfIU/CjLVPQH+SnMYSdQPPiaK5qdTR1zg==
X-Received: by 2002:adf:e641:: with SMTP id b1mr50324576wrn.34.1582319012090; 
 Fri, 21 Feb 2020 13:03:32 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id z6sm5483930wrw.36.2020.02.21.13.03.30
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 21 Feb 2020 13:03:31 -0800 (PST)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Fri, 21 Feb 2020 22:02:31 +0100
Message-Id: <20200221210319.2245170-4-daniel.vetter@ffwll.ch>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20200221210319.2245170-1-daniel.vetter@ffwll.ch>
References: <20200221210319.2245170-1-daniel.vetter@ffwll.ch>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/51] drm: add managed resources tied to
 drm_device

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25E7C5A8F49
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 09:07:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5473510E5EE;
...
Subject: Re: [Intel-gfx] [PATCH v4 16/21] dma-buf: Move dma_buf_attach() to

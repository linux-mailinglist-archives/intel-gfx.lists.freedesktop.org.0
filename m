...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 72F582A4252
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Nov 2020 11:34:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CFF816EC6D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch V3 32/37] drm/vmgfx: Replace kmap_atomic()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0617938F779
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 03:22:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C3FD6E4F1;
...
Subject: Re: [Intel-gfx] [RFC PATCH 23/97] drm/i915/guc: Support per context
 scheduling policies

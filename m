...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AAB5D75A8B0
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jul 2023 10:09:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F22710E578;
	Thu, 20 Jul 2023 08:09:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AAD5D10E577
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jul 2023 08:09:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689840557; x=1721376557;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=FK+As7b+C/HHi9NUpLavXvBUIviF0IGjVoZhDXylheM=;
 b=Axx2ExDT1EElyj50QDLvWGg6zcDq54YfqJM+EgvqFvB7hqVLKr1Pd/F9
 rPNYP0G8ovci+RENUCAIt+JULEg8E3NgP4TGFJQydtHMp+Ub0KSn6x8po
 WdJEE8zE9TpM8NwY8+p9d9Dqgwg9Gq70CugOZxNs+PzzLqgsk3y9zox7I
 8qzzraUsUcwGR3EhQWy1MQy7uajX7ZO15VjCtPK1ARqDVx5Yk6RmFPYhn
 teT6dT/uJizS6OyILTJn3Df2oBbsYBnP7cqocE79c6zAuXR2dS1gs4pwE
 zsvajKtXsiPuXY+P3xMAd0zkuGd49A+ds/ozQNIheq4A31PrRXOwA8Yl9 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="366700187"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="366700187"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 01:09:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="724305594"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="724305594"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga002.jf.intel.com with ESMTP; 20 Jul 2023 01:09:14 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 20 Jul 2023 13:37:09 +0530
Message-Id: <20230720080715.3063267-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 1/7] drm/i915/vdsc: Refactor dsc register
 field macro

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6BFC10D402
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Nov 2019 11:30:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0394B6E8B0;
	Fri, 29 Nov 2019 10:30:17 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 02/14] drm/fb-helper: don't preserve fb_ops

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A811C7C5295
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Oct 2023 13:55:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF5F410E73A;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Prevent potential UAF in
 engine_init_common

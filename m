...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D58F5522C01
	for <lists+intel-gfx@lfdr.de>; Wed, 11 May 2022 08:02:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4962B10E4BE;
...
Subject: [Intel-gfx] [PATCH v3 4/5] drm/i915/pvc: Add new BCS engines to GuC
 engine list

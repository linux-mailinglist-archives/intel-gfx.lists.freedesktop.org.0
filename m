...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 340B24C40FC
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 10:12:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD78310E76C;
...
Subject: Re: [Intel-gfx] [PATCH v6 1/2] drm/vrr: Set VRR capable prop only
 if it is attached to connector

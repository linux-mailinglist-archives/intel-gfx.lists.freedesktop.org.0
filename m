...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A47C7C7480
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Oct 2023 19:22:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B37510E565;
...
Subject: [Intel-gfx] [PATCH v7 15/25] dyndbg: add for_each_boxed_vector

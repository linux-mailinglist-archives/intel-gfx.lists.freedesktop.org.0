...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6FC456B08C9
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0C8910E5F4;
	Wed,  8 Mar 2023 13:29:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0244F10E5E1;
 Wed,  8 Mar 2023 13:29:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678282158; x=1709818158;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Xzsdz0GZ0x3LH67TtI4aQESYRlZwoGYHkjcQObdvaxo=;
 b=cD8+lHcY4TSd/DR1LFx1dXL/lcSrX0KqL/PdVEt1MZnioFGnkS8krjwy
 DRORd84Wm+NxMQ3QwjrRs03IfELrAgEDzkJR4eOhxnO3B+marI48O2prA
 8oyKwCmXA0srZPVDv86E6ZN0TcKsVWnuc87rSM2wERJ/bcdElpT0eRUCh
 0ODen5h7oyjagBljQEmzA3errR9+R4yDysAhTgyFGzxgETRyP6P6csPKV
 jo8rvOi1RTvVjJE32zeC7M4FEGxs2jasTha6AOuTmHBF006AjpU0HusX0
 ibTXpj8mn5In6I4yFGWN6WrYihXL5Rw5A/xElgEC+1yOhe03V5uvX/i/P g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10642"; a="336165156"
X-IronPort-AV: E=Sophos;i="5.98,244,1673942400"; d="scan'208";a="336165156"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Mar 2023 05:29:17 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10642"; a="922789318"
X-IronPort-AV: E=Sophos;i="5.98,244,1673942400"; d="scan'208";a="922789318"
...
Subject: [Intel-gfx] [PATCH v6 06/24] vfio: Pass struct vfio_device_file *

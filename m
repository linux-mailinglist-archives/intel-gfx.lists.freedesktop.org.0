...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1FD22466D7
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Aug 2020 15:02:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B60D6E506;
...
Subject: [Intel-gfx] [PATCH] input: serio: convert tasklets to use new
 tasklet_setup() API

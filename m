...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 164C6553EED
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 01:30:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43FE310E5B1;
...
Subject: [Intel-gfx] [PATCH] drm/i915/guc: ADL-N should use the same GuC FW
 as ADL-S

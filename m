...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mHzEHFg/F2qg9wcAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 27 May 2026 21:00:40 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CBB885E94B5
	for <lists+intel-gfx@lfdr.de>; Wed, 27 May 2026 21:00:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0906810E92F;
	Wed, 27 May 2026 19:00:38 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Dy9f5IbA";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ADEB910E92A;
 Wed, 27 May 2026 19:00:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1779908435; x=1811444435;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=WSNj3X28UNBLKniY6YDQbRVZdqHmUERR8getAgL4rT4=;
 b=Dy9f5IbAr6Qpg/pr2W0SnykyK/ZIUwtQaxVieLeoj79hW9KHliMuf3ZU
 7/RAHoKrc3ssUKuQVnfnr7D7RiD5u7R+jkwpDR2shG0zsIeGL+QgfGKwO
 jy4c3iYt3Ii5S7WXxwo4brr84HHveGn5TyOa0SiCz/iV/Grfkx0u9qYB2
 VQSjP0PdXXBlYmwtkMCLslVLASXYJZ+Sjqp0sSLqJzXYXuDOuOX9kRqEQ
 f+zK9HhRokTS4AoqjY7zbLLbL5FrqB6qT+eQH0bS2l/AYmod2BLLYt65G
 BSnV/vzuHE8UUb8Jk0c6455FLxRfjvB60vqkxk78d2aApGqCObPgsYxNa w==;
X-CSE-ConnectionGUID: v9OHcAdcQ0WHVdZ2BBLdrg==
X-CSE-MsgGUID: wUlkqxQQRMqs50iR/oXUfA==
X-IronPort-AV: E=McAfee;i="6800,10657,11799"; a="80602131"
X-IronPort-AV: E=Sophos;i="6.24,172,1774335600"; d="scan'208";a="80602131"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 May 2026 12:00:35 -0700
X-CSE-ConnectionGUID: stxs/bcmRNSZr2a3Hvb15A==
X-CSE-MsgGUID: nzreVbc0Tkqj5WYAFJFWlw==
X-ExtLoop1: 1
...
Subject: [CI 02/17] drm/i915/display: Remove TGL DC3CO support
Date: Thu, 28 May 2026 00:29:49 +0530
Message-ID: <20260527190004.118730-3-dibin.moolakadan.subrahmanian@intel.com>
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,intel.com:mid,intel.com:dkim,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,dc3co_work.work:url]
X-Rspamd-Queue-Id: CBB885E94B5
...
index 924f0b90d560..156e52aa1bab 100644
...
@@ -1780,9 +1779,7 @@ struct intel_psr {
...
-
 static bool intel_psr2_sel_fetch_config_valid(struct intel_dp *intel_dp,
 					      struct intel_crtc_state *crtc_state)
 {
@@ -1688,8 +1570,6 @@ static bool intel_psr2_config_valid(struct intel_dp *intel_dp,
 		return false;
 	}
...
@@ -2004,12 +1884,6 @@ void intel_psr_get_config(struct intel_encoder *encoder,
 	}
...
@@ -2137,16 +2011,6 @@ static void intel_psr_enable_source(struct intel_dp *intel_dp,
...
@@ -2246,7 +2110,6 @@ static void intel_psr_enable_locked(struct intel_dp *intel_dp,
...
@@ -2325,8 +2188,6 @@ static void intel_psr_exit(struct intel_dp *intel_dp)
...
-	cancel_delayed_work_sync(&psr->dc3co_work);
 ...
 /**
@@ -3650,34 +3509,6 @@ void intel_psr_invalidate(struct intel_display *display,
 		mutex_unlock(&intel_dp->psr.lock);
 	}
 }
-/*
...
-}
 ...
 {
@@ -3764,7 +3595,6 @@ void intel_psr_flush(struct intel_display *display,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D568118D8CF
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Mar 2020 21:07:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4710F6EB69;
	Fri, 20 Mar 2020 20:07:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C04536EB69
 for <intel-gfx@lists.freedesktop.org>; Fri, 20 Mar 2020 20:07:17 +0000 (UTC)
IronPort-SDR: Y8OtqDRQtHKvwPNZoXtDX5W6x66eIjGzRLgNYlZTXJl47Kku9xVXMdwG6LWNvChdHEZKX9KG6I
 ipJUO9tI1xhA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Mar 2020 13:07:17 -0700
IronPort-SDR: faSNMVJD6hWBPiImIjvMcLpOeP7XiusUBmwJTnPh1UsWcHRwvYH8L5VdepK7Cz8tgy67gYeeo+
 C4oImck6hOVA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,285,1580803200"; d="scan'208";a="445090319"
Received: from fmsmsx105.amr.corp.intel.com ([10.18.124.203])
 by fmsmga005.fm.intel.com with ESMTP; 20 Mar 2020 13:07:17 -0700
Received: from fmsmsx152.amr.corp.intel.com (10.18.125.5) by
 FMSMSX105.amr.corp.intel.com (10.18.124.203) with Microsoft SMTP Server (TLS)
 id 14.3.439.0; Fri, 20 Mar 2020 13:07:16 -0700
Received: from fmsmsx116.amr.corp.intel.com ([169.254.2.62]) by
 ...
 Fri, 20 Mar 2020 13:07:17 -0700
From: "Souza, Jose" <jose.souza@intel.com>
To: "intel-gfx@lists.freedesktop.org" <intel-gfx@lists.freedesktop.org>
Thread-Topic: =?utf-8?B?4pyXIEZpLkNJLklHVDogZmFpbHVyZSBmb3IgZHJtL2k5MTUvZGlzcGxheS9m?=
 =?utf-8?Q?bc:_Make_fences_a_nice-to-have_for_GEN9+?=
Thread-Index: AQHV/k1OPbczJBvhU0OaHzfaJR+diKhSX2YA
Date: Fri, 20 Mar 2020 20:07:16 +0000
Message-ID: <5ee3972d3dacf8aac2dd08d65fff58b1ac210b77.camel@intel.com>
References: <20200319211535.114625-1-jose.souza@intel.com>
 <158466360038.11036.18356039211210745057@emeril.freedesktop.org>
In-Reply-To: <158466360038.11036.18356039211210745057@emeril.freedesktop.org>
Accept-Language: en-US
Content-Language: en-US
X-MS-Has-Attach: 
X-MS-TNEF-Correlator: 
x-originating-ip: [10.24.15.8]
Content-ID: <F768D1557A758946ACE8DEC74A961636@intel.com>
MIME-Version: 1.0
...
>     - shard-iclb:         [PASS][24] -> [SKIP][25] ([fdo#112146]) +4
> similar issues
>    [24]: 
...
>     - shard-iclb:         [SKIP][56] ([fdo#112080]) -> [PASS][57] +12
> similar issues
>    [56]: 
...
>     - shard-iclb:         [SKIP][72] ([fdo#112146]) -> [PASS][73] +5
> similar issues
>    [72]: 
...
>     - shard-iclb:         [SKIP][94] ([fdo#109441]) -> [PASS][95] +1
> similar issue
>    [94]: 
...
> [i915#1402]) -> ([FAIL][107], [FAIL][108], [FAIL][109]) ([fdo#103927]
> / [i915#1402] / [i915#529])
>    [105]: 

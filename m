...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AE932E6491
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Dec 2020 16:53:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9165F899F2;
	Mon, 28 Dec 2020 15:52:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E006A899E7
 for <intel-gfx@lists.freedesktop.org>; Mon, 28 Dec 2020 15:52:49 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23448213-1500050 
 for multiple; Mon, 28 Dec 2020 15:52:38 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 28 Dec 2020 15:52:09 +0000
Message-Id: <20201228155229.9516-34-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 34/54] drm/i915: Fair low-latency scheduling
...
---
 ...
 drivers/gpu/drm/i915/i915_scheduler.c         | 429 +++++++++++++-----
 ...
 16 files changed, 632 insertions(+), 262 deletions(-)
...
index 27c26fde3021..cae29268ccea 100644
...
+	return rq_deadline(prev) <= rq_deadline(next);
 ...
 static inline void
@@ -565,9 +575,12 @@ static inline void __execlists_schedule_out(struct i915_request *rq)
...
@@ -681,14 +694,14 @@ dump_port(char *buf, int buflen, const char *prefix, struct i915_request *rq)
 	if (!rq)
 		return "";
...
@@ -1196,11 +1209,11 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
+				     rq_prio(last));
 			...
 			/*
@@ -1222,11 +1235,11 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 			last = NULL;
...
@@ -1282,7 +1295,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -1296,16 +1309,15 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 		}
...
@@ -1396,6 +1408,10 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -1432,24 +1448,6 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 	}
 done:
...
-	execlists->queue_priority_hint = queue_prio(&engine->active);
 	...
 	/*
@@ -2643,10 +2641,6 @@ static void execlists_reset_rewind(struct intel_engine_cs *engine, bool stalled)
...
@@ -2713,16 +2707,12 @@ static void execlists_reset_cancel(struct intel_engine_cs *engine)
 			rq->engine = engine;
...
@@ -3122,7 +3112,8 @@ static const struct intel_context_ops virtual_context_ops = {
...
@@ -3139,9 +3130,11 @@ static intel_engine_mask_t virtual_submission_mask(struct virtual_engine *ve)
...
@@ -3149,12 +3142,12 @@ static intel_engine_mask_t virtual_submission_mask(struct virtual_engine *ve)
...
+	mask = virtual_submission_mask(ve, &deadline);
 	...
 	if (unlikely(!mask))
 		return;
@@ -3187,7 +3180,8 @@ static void virtual_submission_tasklet(unsigned long data)
 			 */
...
@@ -3201,7 +3195,7 @@ static void virtual_submission_tasklet(unsigned long data)
...
+			if (deadline < other->deadline) {
 				...
 				parent = &rb->rb_right;
@@ -3216,8 +3210,8 @@ static void virtual_submission_tasklet(unsigned long data)
...
+		if (first)
 ...
 unlock_engine:
@@ -3253,7 +3247,9 @@ static void virtual_submit_request(struct i915_request *rq)
...
@@ -3356,7 +3352,6 @@ intel_execlists_create_virtual(struct intel_engine_cs **siblings,
...
-	ve->base.execlists.queue_priority_hint = INT_MIN;
 	tasklet_init(&ve->base.active.tasklet,
 		     ...
 		     (unsigned long)ve);
@@ -3540,10 +3535,6 @@ void intel_execlists_show_requests(struct intel_engine_cs *engine,
...
index fa6262f92afd..92c7cbf98302 100644
...
@@ -893,9 +1094,7 @@ void __intel_engine_unhold_request(struct intel_engine_cs *engine,
...
@@ -925,6 +1124,18 @@ void __intel_engine_unhold_request(struct intel_engine_cs *engine,
...
@@ -943,10 +1154,12 @@ void i915_sched_node_init(struct i915_sched_node *node)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D0D8D147552
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Jan 2020 01:16:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 37DC16FEA8;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] linux-next: Tree for Jan 23 (gpu/drm/panel/)
...
Content-Type: multipart/mixed; boundary="===============2074082111=="

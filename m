...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id kApdNWA3hWkd+QMAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 06 Feb 2026 01:35:44 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FA09F8AAC
	for <lists+intel-gfx@lfdr.de>; Fri, 06 Feb 2026 01:35:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 045F710E179;
	Fri,  6 Feb 2026 00:35:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=Nvidia.com header.i=@Nvidia.com header.b="aXGLMdRy";
	dkim-atps=neutral
...
Received: from CY7PR03CU001.outbound.protection.outlook.com
 ...
 [40.93.198.35])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 81B6E10E179;
 Fri,  6 Feb 2026 00:35:39 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=E12sER6/BHDFwDTpPOS3xMuDk8gNLRlkASpLMdAikRE=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=E12sER6/BHDFwDTpPOS3xMuDk8gNLRlkASpLMdAikRE=;
 b=
...
Subject: [PATCH -next] gpu: Move DRM buddy allocator one level up
Date: Thu,  5 Feb 2026 19:34:51 -0500
Message-Id: <20260206003451.1914130-1-joelagnelf@nvidia.com>
X-Mailer: git-send-email 2.34.1
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: 8bit
X-ClientProxiedBy: BL1P222CA0015.NAMP222.PROD.OUTLOOK.COM
 (2603:10b6:208:2c7::20) To DS0PR12MB6486.namprd12.prod.outlook.com
 (2603:10b6:8:c5::21)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: DS0PR12MB6486:EE_|SA1PR12MB8860:EE_
X-MS-Office365-Filtering-Correlation-Id: c77f04ec-1451-4ed7-9c29-08de651794d2
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230040|1800799024|366016|7416014|376014;
X-Microsoft-Antispam-Message-Info: =?utf-8?B?UXBJbDdvanIyMEY1SUk1Q1M1TS80eGp4N0gwS1FwOG4wcUljeDh3eURXV1ZZ?=
 =?utf-8?B?clBITkZVaHdzZEFKZVlTL0lla01CY2RMUkc1U0FpMmhIRjNhOGlVakczVXVn?=
 =?utf-8?B?dE5TRFBUc1hqQ1V4eVJhU0ZqdVdRRlQwSXNJTnNjR2EyK0pCb0FGUHFDVVZs?=
 =?utf-8?B?RkRrZnVqR3ZJVWJwWEdrTElxbEZTZ2hEQUJTZExSRG5zUEs0aTFRaURQRUpQ?=
 =?utf-8?B?RGc0YzVoR2c2a28wVThWd1FYOCtwdW5yS2dRQlRYaFpNSlhsY1RhcS9va3o2?=
 =?utf-8?B?U1JXZFQ0enhIa0s5dTRReUwvMkpPT3dCYlA0Mk5GZHN1clltNUdiK0pTbElD?=
 =?utf-8?B?c2ppOVRCOWJoeVFIUUlRMlZBVnl4bmVUWUF6QlRPWjd5VUYrNW43SGkvM0Js?=
 =?utf-8?B?WFpLeldXL2YvVXhJb08vbjcrY3FUOUc1a3FNenZOdGdYZ3JvWmNjcGNVZ2VL?=
 =?utf-8?B?ZDJhK2ttMU5UQVgyUVFjTHZtdStKOHJCMk0raXlSSjZmVEt4RllYWTJXWFRC?=
 =?utf-8?B?cmZseDFYTGw4cWNjUmJtNW1JbS9yVHlZcDZYMXdrS2hMVzhYNFFmb3hyTlc3?=
 =?utf-8?B?VFRzWjlDMFRXOTVUTkJyc0VPb0xPSE1BdjVnVXRqUmVaYUozT1BVU0tKa1ho?=
 =?utf-8?B?SDMreWF0MW4rVTFVZFpzd0lPL1ZGL2NycllsRFNJNVpjOUZjbWlYdDREc3Vt?=
 =?utf-8?B?ay9Xa3EwckNxZmp0NURVOGxHU2kyWlBqa25ORFJsVEVSenBsd1lSWDl2ZVN0?=
 =?utf-8?B?UHlxVEUzQ29ra3ZiMkQrb085dDllS2grT2FLeElHS0Z0K2lIcElyY3IvcG1N?=
 =?utf-8?B?aHJENUIvMDR2cTgwSVFFbW5LNVRaVHBwZE1CV1pEYW5ndytnamRUeHBGTGR6?=
 =?utf-8?B?QVE0WkdKK0tQT24vZlBtVlk3bnd5QkFnMXNaQVIwd0JMcVoxd3NXRUY4bEFR?=
 =?utf-8?B?c0x0a1Q0dVRlQnFEQkdBbEJjZ0lTSTdHUkc5NFh3TmdIcnVMYmFyYmNuZXBJ?=
 =?utf-8?B?bm54NEd1djFNK1JNRlNxaFlyOXpoZGJMOGs3MVp6NnVWTG81ajR4UVlNQXo2?=
 =?utf-8?B?MWFoS1VkaVdPUUFXUjVjdnpFbUdSeDUzcS8velJxbS9IdVRuL3dFRVFoZmlC?=
 =?utf-8?B?VEVFV3R2WXVTVTM2L3pzM3V4MVVpcHh6cHg3SDg3MVhUS3NINWxIbzJpaUpi?=
 =?utf-8?B?aWRUTm9Yd2JQSzNnSlhlb0hOTUJKRldTYlNCU240L2RESUErOHNEb0orQVVH?=
 =?utf-8?B?dlNmdHFnRzFBT1luNTA5OVk1WXYyNitBanNSZVV5MEx3YTU3SkpXdkR5VW5Q?=
 =?utf-8?B?aVZSVk5CYW9leXlwYjN3NGFYdHhPV010ZEYxN1FIeGZYbVoreEdwdnc3enor?=
 =?utf-8?B?TU1mMHZiRWFZSkRYNXBsWmVNcWVHYjlxcEhyNzRFWnI5UEFweXYxZVVPNkRY?=
 =?utf-8?B?ZmVCL1dSb2cvNG1ZZlF3b0ZDbzR5UjJ0MytWVUs4ZnhWMkhUeUNQdkNCTGhm?=
 =?utf-8?B?Mit0c1pjSXhwUGRLbEt0ajZLZExPZjFXRTNtdHpEZ1JXSVlEQmh2amtwV3BS?=
 =?utf-8?B?TUdHRitMSDFvMVBoRDRPZ2pXY2hWUHJydlZUODNWayttRUM2SUxHT3IrQUsv?=
 =?utf-8?B?REhlMVZIS2VuYVNkTGZ0L3p6MldXTmVwdXdHREU2cWpTVE9XVHBPTFljU1hG?=
 =?utf-8?B?bHR2eGJoMnV6VkRURUpOTHRiSmlQQXpiZC85dzBObktNaW85MEo5UGt6Umo4?=
 =?utf-8?B?amI5UlVDN2RGR1NMZmJTNzIzUktpYm9iRnd6QS81WFU0L3VsYzFHTnZMSzk5?=
 =?utf-8?B?NFRjYjlzWTRwQm1WNG5qdFdCcVQvaTlwRW1YN1M5SnpxUW84SVNpVzlIeEVT?=
 =?utf-8?B?TE5zYkhrVEJwa0RUTnpPR044UzJOdlBGbEtCYmFhYmRkSDZENkV0eVV0YUx3?=
 =?utf-8?B?RGYvT29WWFZmVXB6NHpLVE14Lys2RVB1QmczdlRnaFJzQzhrUm1MRkJzVllK?=
 =?utf-8?B?YVZRd2tlS0JXZUJ4VWR2VUFQK2UwY21FQjVRNVVxaUhUODhDWm5nVTVNZytG?=
 =?utf-8?B?ZWk4Q2xLb3NrNTZTRVB6cnRKQmlkWXJrUnREUkw0bjlsSU5uOHhzS29aZVBP?=
 =?utf-8?Q?fINw=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DS0PR12MB6486.namprd12.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(1800799024)(366016)(7416014)(376014); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?QVVBQVFTdzhHbWlodEJWQTdjdU50ZGQ0YjhaSzErRUU5Rjk4L3dwS2lLdUJB?=
 =?utf-8?B?bjE4eFpRMGlqT0dOWG1nWEFrU29sQWpIWm1ONEEyZ1pNKzgvTnhLWkh0OHN1?=
 =?utf-8?B?aWljOEQzZDFOb1lQV0dXVUFJM1B1eGNkOVU1TytGQ0hQVmVLNXZCWE5ZNGFy?=
 =?utf-8?B?UmxXUGNYck95cTNoQkxzMTIxMXBPZ1cwY0xXQ09hb3JKZzZtMnFIRDF6c1dy?=
 =?utf-8?B?Z3VwU0dTZVpVbCt2ZWpQeWs3RW5Jck8rQ251bGFPb2tuR3hIbEdDRTQzdVhD?=
 =?utf-8?B?QnkrMVhvVDRmZ0YrV3JiNFpxOGViQlliS3BhemhYYTd1cXoxQml0R1M1Umlj?=
 =?utf-8?B?WVNtY1U4amt5UFYvN3RINnFUNCt5RS9HdlZtb1F0Z1JzOXdlMFBHSlVwdjBl?=
 =?utf-8?B?cXU0Z2JzRkVKVmZ3WDZCYm56VDY3bUtNU240SVV3WTJFRHZpbHJza1hub1BS?=
 =?utf-8?B?bGpEOXR1V3BBV2NaeVZSYWZRS2czcGdoNTlQVHJCeUY2eWlja1dxSWlkZVJr?=
 =?utf-8?B?ajFIV1p6b0E4eHZFL3MrRWNPRWZjTmxuK0RZT1h4cGttOHRDVm5YcC9kUWFL?=
 =?utf-8?B?MGF6UHNTTHloZVdMR0EwOTIvcnhhVHFCVjFkeTlIZ3RPbXBRQ1QxZkVqazVZ?=
 =?utf-8?B?NmJyTGhoVlZ5Qzh0dGhFVUFxZ0N3QmZXTWRTOUxJSXJQRVRsNFByOHpwVUhQ?=
 =?utf-8?B?NW4rOUNyemdUejRaZWlMZFMxTjBXRmJTaEwvYUNJWStZbzBpUnE3MUtFUmcw?=
 =?utf-8?B?dGwvZ3pkbkpWR0ZmSXhsOFFVR081WjQ1SHJJSjJpc2JCUzBEM2hIaDFDUnFa?=
 =?utf-8?B?UzVCd3BENEcyZXhyWXk1clhXUDZqQWhqVHdPWHVkbXJ0a3FlOUlkTXg5SDIz?=
 =?utf-8?B?Uk51TjNPdEhuQzd6dCt1azk4bkFJd1ora2hITDRIZUIwejlXWmxPbE91SWNK?=
 =?utf-8?B?WXhDUmxZUUFJbGJaOGNnTXQwcTVrUDZvQXJwM3JsTm1UaHU4dTJLWUIrTFZa?=
 =?utf-8?B?bGVQeCsra0RDSEJnRHpYcmlGV1FtREpBNEtHamlTMCtoNWhJVDdJeG9pZVVS?=
 =?utf-8?B?emFiMGQwV25pUDI5UmFXWnN2ekdHZUZ3LzFaQWdwK2QwbnVVaTJKQkFMNEFM?=
 =?utf-8?B?a29NVEFRVGRPQ21pOENsSkU0TUN5N3Q1cGk5bXNyQmU1NWJRQ1lma0VsdzN5?=
 =?utf-8?B?RjBHeWMzTHpLUXhlVUxXcmdEb3ZXYWExS1ZuTWRtK2p4dDdyL0tKVVBlQlp2?=
 =?utf-8?B?WVNRTHQvUXczNkdqcUk0TmM2RC9HVE5NUHZJNDlMbWNrNTE1RlZmVzFxQXYz?=
 =?utf-8?B?YlpxZ3Z4ODFpeEVja1oyMWFvUHZhUFl6V1BMOHp6aWZtVThWaW95d2krRGtG?=
 =?utf-8?B?ZTFVcjZVU0E4Z3grTmdjcEJmQ29hWU90UzgwRGw5UStORXluQXVrRGpUYzdL?=
 =?utf-8?B?ZlNLbVAxVkRPT0UrQ2tkd2xiVDNCUGh6cG4yRVhRWFFMdFFrQS9Wbmg1SGhV?=
 =?utf-8?B?UDhJSlRtSzBNa3kzeHZFM0d4VkUydE11SGNVaXo4N281T0grWnEwVzdaZTNl?=
 =?utf-8?B?WWxrVnFpTGVINHVvQ1NTSFFIdzdvcTM5UTNhMVp1RGI3NGV3OHAxdUwzaWRl?=
 =?utf-8?B?WkFMZW9icVVDS2Z1c2QwYjU0cE4veDVoeFFnOFRObEl0MUtpU1hHdzR4cDhS?=
 =?utf-8?B?TGhRSnBJZms4VWF6S2dhcVJITC8rdmx3Umo3YnBtQmg3MFhZd2tDOGM3NVd3?=
 =?utf-8?B?WjhqcENsTHhaZ3lFUVpXVVNuMmFsV2VXa1dqZ2htR2x3YXh0YW4rN1RLRXhW?=
 =?utf-8?B?SnpLZGdld3owVHdRd3hISllwME83ZisyNUZ0cnR0ZjNVVmtGNS8vbE5PcWRW?=
 =?utf-8?B?K2x5Z3ZVbWU0UjFwMUw0cGZsaE5HeDk5MjhSbUtibWVJU3crNFJXVmVRbU80?=
 =?utf-8?B?aE9naWFzYzNrVXhWdG40bXVqYjZEVGNHYzVIa3BWZW9Xd0VjWnRvbHRpN21j?=
 =?utf-8?B?UlRoOG9pSm80RjVPUVZQZXZKN3JQZzRERjlhdTJSWUsyTzU2azc1dm53cXl1?=
 =?utf-8?B?MXhpU0d5WEN1bTFuNjRCQ1AxUlNSL2ZDazJWSm5FVUh4elpvSTVmWUZnTW8w?=
 =?utf-8?B?UGdEcmpwbzgzanlQYkFXcXgxVXZlenFOUFlsVnVDc21EdUJueWVnakIzYk15?=
 =?utf-8?B?czVrRW1WL25vWnFRTnFMMFlSRzY3b3lQdWEzKytOSTFwM1BiSEE1eEZYYzJm?=
 =?utf-8?B?Uit6OGFYdmZhenlpZC9oV2NFUzFhWGhuYWE0czVQZ0RraE9Hakd2TTdrRjhU?=
 =?utf-8?B?Mi83c0pSYXEzcUxGYkZ0RHZpUVM0Qmh1K3hCN3lZSmR0aUd5VjMwZz09?=
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-Network-Message-Id: c77f04ec-1451-4ed7-9c29-08de651794d2
X-MS-Exchange-CrossTenant-AuthSource: DS0PR12MB6486.namprd12.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Feb 2026 00:35:09.2991 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 43083d15-7273-40c1-b7db-39efd9ccc17a
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: p+KTGAINTzXTflipXHpl4R76G06WavzGygxRd578aQzt4ydp9EL4e9G27VeuqQUY4h1i7T/KRep2AtSJJgD7Tg==
...
---
Rebased on today's linux-next after discussing with Danilo.

 Documentation/gpu/drm-mm.rst                  |   10 +-
 drivers/gpu/Kconfig                           |   13 +
 drivers/gpu/Makefile                          |    2 +
 drivers/gpu/buddy.c                           | 1320 +++++++++++++++++
 ...
 drivers/gpu/drm/drm_buddy.c                   | 1294 +---------------
 ...
 33 files changed, 2018 insertions(+), 1822 deletions(-)
...
new file mode 100644
index 000000000000..239e62118f8d
--- /dev/null
...
index ac90f49e3a75..d1bf856e0b08 100644
...
index fd34d3755f7c..188b36054e59 100644
...
@@ -1277,18 +30,21 @@ EXPORT_SYMBOL(drm_buddy_block_print);
 /**
...
+		struct gpu_buddy_block *block, *tmp;
 		...
 		u64 count = 0, free;
 		unsigned int tree;
@@ -1296,8 +52,9 @@ void drm_buddy_print(struct drm_buddy *mm, struct drm_printer *p)
 		for_each_free_tree(tree) {
 			root = &mm->free_trees[tree][order];
...
@@ -1315,22 +72,5 @@ void drm_buddy_print(struct drm_buddy *mm, struct drm_printer *p)
 }
...
index 6d95447a989d..b6f90160b0f6 100644
...
index 4d7dcaff2b91..789baa0114e4 100644
...
index d6aa61e55f4d..4ebc0fd180d3 100644
...
+	struct gpu_buddy *mm = &mgr->mm;
 	...
 	unsigned long lpfn;
 	int err;
@@ -79,13 +80,13 @@ static int xe_ttm_vram_mgr_new(struct ttm_resource_manager *man,
 	INIT_LIST_HEAD(&vres->blocks);
...
+		vres->flags |= GPU_BUDDY_RANGE_ALLOCATION;
 	...
 	if (WARN_ON(!vres->base.size)) {
 		err = -EINVAL;
@@ -113,7 +114,7 @@ static int xe_ttm_vram_mgr_new(struct ttm_resource_manager *man,
 		goto error_unlock;
 	}
...
+	err = gpu_buddy_alloc_blocks(mm, (u64)place->fpfn << PAGE_SHIFT,
 	...
 	if (err)
@@ -122,13 +123,13 @@ static int xe_ttm_vram_mgr_new(struct ttm_resource_manager *man,
...
@@ -148,11 +149,11 @@ static int xe_ttm_vram_mgr_new(struct ttm_resource_manager *man,
 	 * the object.
 	 */
...
@@ -174,10 +175,10 @@ static void xe_ttm_vram_mgr_del(struct ttm_resource_manager *man,
 	struct xe_ttm_vram_mgr_resource *vres =
...
@@ -190,7 +191,7 @@ static void xe_ttm_vram_mgr_debug(struct ttm_resource_manager *man,
 				  struct drm_printer *printer)
 {
 	struct xe_ttm_vram_mgr *mgr = to_xe_ttm_vram_mgr(man);
-	struct drm_buddy *mm = &mgr->mm;
+	struct gpu_buddy *mm = &mgr->mm;
 	...
 	mutex_lock(&mgr->lock);
 	drm_printf(printer, "default_page_size: %lluKiB\n",
@@ -213,8 +214,8 @@ static bool xe_ttm_vram_mgr_intersects(struct ttm_resource_manager *man,
 	struct xe_ttm_vram_mgr *mgr = to_xe_ttm_vram_mgr(man);
 	struct xe_ttm_vram_mgr_resource *vres =
 		to_xe_ttm_vram_mgr_resource(res);
-	struct drm_buddy *mm = &mgr->mm;
...
+	struct gpu_buddy_block *block;
 	...
 	if (!place->fpfn && !place->lpfn)
 		return true;
@@ -224,9 +225,9 @@ static bool xe_ttm_vram_mgr_intersects(struct ttm_resource_manager *man,
...
+			(gpu_buddy_block_size(mm, block) >> PAGE_SHIFT);
 		...
 		if (place->fpfn < lpfn && place->lpfn > fpfn)
 			return true;
@@ -243,8 +244,8 @@ static bool xe_ttm_vram_mgr_compatible(struct ttm_resource_manager *man,
 	struct xe_ttm_vram_mgr *mgr = to_xe_ttm_vram_mgr(man);
 	struct xe_ttm_vram_mgr_resource *vres =
 		to_xe_ttm_vram_mgr_resource(res);
-	struct drm_buddy *mm = &mgr->mm;
...
+	struct gpu_buddy_block *block;
 	...
 	if (!place->fpfn && !place->lpfn)
 		return true;
@@ -254,9 +255,9 @@ static bool xe_ttm_vram_mgr_compatible(struct ttm_resource_manager *man,
...
+			(gpu_buddy_block_size(mm, block) >> PAGE_SHIFT);
 		...
 		if (fpfn < place->fpfn || lpfn > place->lpfn)
 			return false;
@@ -286,7 +287,7 @@ static void xe_ttm_vram_mgr_fini(struct drm_device *dev, void *arg)
...
@@ -317,7 +318,7 @@ int __xe_ttm_vram_mgr_init(struct xe_device *xe, struct xe_ttm_vram_mgr *mgr,
...
@@ -365,7 +366,7 @@ int xe_ttm_vram_mgr_alloc_sgt(struct xe_device *xe,
 	if (!*sgt)
 		return -ENOMEM;
...
+	/* Determine the number of GPU_BUDDY blocks to export */
 	...
 	while (cursor.remaining) {
 		num_entries++;
@@ -382,10 +383,10 @@ int xe_ttm_vram_mgr_alloc_sgt(struct xe_device *xe,
 		sg->length = 0;
...
index e6f8459c6c54..450e71deed90 100644
...
index 9884f003247d..8252a04c3f33 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D6BF91ADE8A
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 15:40:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4EA976EC05;
	Fri, 17 Apr 2020 13:40:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 608E86EBF1
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Apr 2020 13:39:44 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 17 Apr 2020 15:39:26 +0200
Message-Id: <20200417133937.1980239-13-maarten.lankhorst@linux.intel.com>
...
index 6fbad5e2343f..9e0c7fcb756e 100644
...
@@ -5000,13 +5008,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -5039,8 +5047,10 @@ static void virtual_context_exit(struct intel_context *ce)

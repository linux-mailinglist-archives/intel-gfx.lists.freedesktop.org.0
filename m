...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 16EC22CB60B
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Dec 2020 09:00:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BBF36EA03;
	Wed,  2 Dec 2020 08:00:05 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 01/20] drm/amdgpu: Fix trailing
 whitespaces
...
Content-Type: multipart/mixed; boundary="===============1174741605=="

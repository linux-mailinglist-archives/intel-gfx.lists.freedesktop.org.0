...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C9CEB4BCFED
	for <lists+intel-gfx@lfdr.de>; Sun, 20 Feb 2022 17:38:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D02D010E2A3;
	Sun, 20 Feb 2022 16:38:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E4EEB10E28B
 for <intel-gfx@lists.freedesktop.org>; Sun, 20 Feb 2022 16:38:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645375080; x=1676911080;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=3I26H68ekXM08ayKV0VwW2yxvnSiICRfDKqKV2HTGYE=;
 b=S9uUUjeOontEu2Z/j1v2wKbG53SSCdHuVs2HJM7Blua0cElkd9tVIvg/
 JmugOejmCWsQmwFRze+YpDpokCv+V0o+mZxXvHTBHJueGZo9nXUxa8vQy
 7l3Guy5FKWxXB4rWlfQUF2ODNFrqhAdOOR/xWvxE/el9BYyCxb9Z3awVt
 9gBp/P6g+J6yDnoF7eCUTCnAAYXJ0OvYEuBf8O4Jgy6nrlzQ6Q0C/Ub4p
 4uOfZuSS2LTwqVGg3xdYFb5/iN3sKXzx/OlSJTjtJPyX7CcDhUj1G10ZD
 n7KtDmUreXCb+8pLudcfA3gvNf6W7JRUJeGqHlNgHjp/iXxjtSVmcs5/U A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10264"; a="314650650"
X-IronPort-AV: E=Sophos;i="5.88,383,1635231600"; d="scan'208";a="314650650"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Feb 2022 08:38:00 -0800
X-IronPort-AV: E=Sophos;i="5.88,383,1635231600"; d="scan'208";a="490199540"
Received: from srr4-3-linux-105-anshuma1.iind.intel.com ([10.223.74.179])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Feb 2022 08:37:57 -0800
From: Anshuman Gupta <anshuman.gupta@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 20 Feb 2022 22:07:29 +0530
Message-Id: <20220220163730.5021-6-anshuman.gupta@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 5/6] drm/i915/dgfx: OPROM OpRegion Setup
...
index 562161a929d6..ea201c602755 100644
...
@@ -1315,9 +1554,69 @@ static const struct i915_opregion_func igfx_opregion_func = {
...
@@ -1331,6 +1630,12 @@ static void intel_dgfx_free_rvda(struct drm_i915_private *i915)

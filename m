...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2AEC3F29D8
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Aug 2021 12:04:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B3346EA5A;
	Fri, 20 Aug 2021 10:04:13 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 5/5] drm: remove drm_file.master_lookup_lock

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AD7852375F
	for <lists+intel-gfx@lfdr.de>; Wed, 11 May 2022 17:33:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE23D10E78D;
	Wed, 11 May 2022 15:33:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [IPv6:2610:10:20:722:a800:ff:feee:56cf])
 by gabe.freedesktop.org (Postfix) with ESMTP id ED19E10E78D;
 Wed, 11 May 2022 15:33:40 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id E417AAA3D8;
 Wed, 11 May 2022 15:33:40 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============1080970175320016771=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Matt Roper" <matthew.d.roper@intel.com>
Date: Wed, 11 May 2022 15:33:40 -0000
Message-ID: <165228322090.2700.7999962018478823478@emeril.freedesktop.org>
...
#### Issues hit ####
  ...
  * igt@gem_huc_copy@huc-copy:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/fi-rkl-11600/igt@gem_huc_copy@huc-copy.html

  * igt@gem_lmem_swapping@basic:
    - fi-rkl-11600:       NOTRUN -> [SKIP][2] ([i915#4613]) +3 similar issues
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/fi-rkl-11600/igt@gem_lmem_swapping@basic.html
    - bat-adlp-4:         NOTRUN -> [SKIP][3] ([i915#4613]) +3 similar issues
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/bat-adlp-4/igt@gem_lmem_swapping@basic.html

  * igt@gem_tiled_pread_basic:
    - bat-adlp-4:         NOTRUN -> [SKIP][4] ([i915#3282])
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/bat-adlp-4/igt@gem_tiled_pread_basic.html
    - fi-rkl-11600:       NOTRUN -> [SKIP][5] ([i915#3282])
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/fi-rkl-11600/igt@gem_tiled_pread_basic.html

  * igt@i915_pm_backlight@basic-brightness:
    - fi-rkl-11600:       NOTRUN -> [SKIP][6] ([i915#3012])
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/fi-rkl-11600/igt@i915_pm_backlight@basic-brightness.html

  * igt@i915_selftest@live@hangcheck:
    - fi-bdw-5557u:       NOTRUN -> [INCOMPLETE][7] ([i915#3921])
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/fi-bdw-5557u/igt@i915_selftest@live@hangcheck.html

  * igt@kms_addfb_basic@invalid-get-prop:
    - fi-kbl-soraka:      [PASS][8] -> [INCOMPLETE][9] ([i915#5974])
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11632/fi-kbl-soraka/igt@kms_addfb_basic@invalid-get-prop.html
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/fi-kbl-soraka/igt@kms_addfb_basic@invalid-get-prop.html
...
<ul>
<li>fi-kbl-soraka:      <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_11632/fi-kbl-soraka/igt@kms_addfb_basic@invalid-get-prop.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_103443v4/fi-kbl-soraka/igt@kms_addfb_basic@invalid-get-prop.html">INCOMPLETE</a> (<a href="https://gitlab.freedesktop.org/drm/intel/issues/5974">i915#5974</a>)</li>
</ul>
</li>
<li>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A32DC524777
	for <lists+intel-gfx@lfdr.de>; Thu, 12 May 2022 09:56:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 337F310FA19;
	Thu, 12 May 2022 07:56:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EAEF810FA10
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 May 2022 07:56:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1652342164; x=1683878164;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=3FEVXka9C8KIotVqz7CV6fZOlasr49DgH+cjkgDu6SI=;
 b=P13QgS84R7/+wmdf3O6uHOKZ4qi1RBfTllNQiEULMz0uBvcYJfJQz26c
 o93QsLaQe18+aEIVItbWr0Dy/MJZEq+7VZiZOV4UTltDFSWkvaoVU5/7Q
 /Ssb3Zp2V9UdvPN3qx0HcAY/vxJr9UdUFjvy5kR5hU46Oyy+P8jiLyYjN
 YkjXxXVwESN9I2SnB3P7K7OiyekR8885THJDiUCnEbeWU3ZzFWyhECzem
 ncBHkiphG+O/ygIVR/Ma2xI6YKvhBeYvI/f1SHq4zC+bYILCkit0VIz8w
 4iWkhPqQMQHKgeBMY/gZnd/Wcb7rLJKPpAw+aZTV8TP8EPz042nIJlWN5 w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10344"; a="249821885"
X-IronPort-AV: E=Sophos;i="5.91,219,1647327600"; d="scan'208";a="249821885"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2022 00:56:04 -0700
X-IronPort-AV: E=Sophos;i="5.91,219,1647327600"; d="scan'208";a="697930958"
Received: from khamid-mobl1.ger.corp.intel.com (HELO [10.213.211.21])
 ([10.213.211.21])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2022 00:56:03 -0700
Message-ID: <1a354079-cb4a-8021-6932-ae2e7f5a2086@linux.intel.com>
Date: Thu, 12 May 2022 08:56:01 +0100
MIME-Version: 1.0

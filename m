...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4293DA3BDA9
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Feb 2025 12:59:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8930410E7CA;
	Wed, 19 Feb 2025 11:59:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="TJDLNTcO";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 18E3210E7BF;
 Wed, 19 Feb 2025 11:59:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739966389; x=1771502389;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=4vWWWgjIjjYjvnVFaoc1T5ul6wsuOpBnkT5KWPpfLHw=;
 b=TJDLNTcOKJ1yoX3WdlFTGLsj/MxOEYN9bVreUs44+FxWT1hKT/J8N+Ix
 jW0ytixCkF51UveeMzokL+f+B6HF/DEovYyaYaATLMrnjp30+OfE8hVwN
 lh8tYO+dvJl0TylBNdOf8lw/gaKt/JWzGQWdQ9fz1tPVXIOOlKCXDquQW
 cRjbtrG4Pdl2FzBxC6oJYWt/LpsEJDPnsviY9CA+ifWCsjj6XQ8xgdXVO
 xGOM1WLe+qX9ARmpcypT/ixgHZsA0CE6NryxnW6+F1cnMDkPgeSuJWWji
 TX1WeWx+xmZOqwWXOyqKKeBibhf89AbSB0cZkxKsNd0fLkKQLMlGf4WMT A==;
X-CSE-ConnectionGUID: KrrKl58+QyyzXMUKBjQJ8w==
X-CSE-MsgGUID: piqErR97Q0it6GcsaMuvTQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11348"; a="52103105"
X-IronPort-AV: E=Sophos;i="6.13,298,1732608000"; d="scan'208";a="52103105"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Feb 2025 03:59:48 -0800
X-CSE-ConnectionGUID: pNsLcdnzTrOvYac8SjpY8Q==
X-CSE-MsgGUID: IhgSDUBGRxOasCpOl0YYNg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,298,1732608000"; d="scan'208";a="114545034"
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by fmviesa006.fm.intel.com with ESMTP; 19 Feb 2025 03:59:46 -0800
...
Subject: [PATCH v8 5/6] drm/i915/display: Add registers and compute the
 strength
Date: Wed, 19 Feb 2025 17:23:58 +0530
Message-Id: <20250219115359.2320992-6-nemesa.garg@intel.com>

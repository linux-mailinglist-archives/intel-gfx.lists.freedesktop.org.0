...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 60CB9532516
	for <lists+intel-gfx@lfdr.de>; Tue, 24 May 2022 10:16:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5897210E565;
	Tue, 24 May 2022 08:16:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0811910E565
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 May 2022 08:16:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1653380194; x=1684916194;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=ljAWIyZD6D/5X4hbNhaWzIaCckzb+Kt8ukpASZlwMwM=;
 b=MBPqnzGXdqgqTQfyWypPynTnO+lgtX8GJ8321haXdLR2ydH8mwiJrGdW
 greIZ4XG7NKTnbBtB02Q3d3OueDU83S6E7U3Tt5hLE9kVCele5l6C/8hp
 j9ZP6bqO8k/+8qrgML1FrjpMnFOwTrC8291oQCiSoNGd/WTOudlbGGHjK
 bSO7LPnpRqVYH3iqNPTq04EIr/CGrbMWXtIhPiywz0XWpwHs1g/Kbks2M
 LclGA3TpK0UBJJ9ncJiEh3l46PWoL8WNVAiHXkUanGywfZGSlBlDLRNjx
 kinYepdAyzdXQ0CUT4+lp+TlhcRE+MT5Ca4ZokZehzBCEa03vpviECHGG A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10356"; a="253965821"
X-IronPort-AV: E=Sophos;i="5.91,248,1647327600"; d="scan'208";a="253965821"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2022 01:16:33 -0700
X-IronPort-AV: E=Sophos;i="5.91,248,1647327600"; d="scan'208";a="572515730"
Received: from mcypersx-mobl.ger.corp.intel.com (HELO localhost)
 ([10.213.10.223])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 May 2022 01:16:31 -0700
Date: Tue, 24 May 2022 10:16:28 +0200
From: Zbigniew =?utf-8?Q?Kempczy=C5=84ski?= <zbigniew.kempczynski@intel.com>
To: Nirmoy Das <nirmoy.das@intel.com>
Message-ID: <YoyUXF/Hy+b+zJQ2@zkempczy-mobl2>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EC024065F4
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 05:18:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6D3276E95C;
	Fri, 10 Sep 2021 03:18:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [205.139.111.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F0CC26E95C
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Sep 2021 03:18:05 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-152-4YKhu_zfMHmFOmHOr_qkDQ-1; Thu, 09 Sep 2021 23:18:03 -0400
X-MC-Unique: 4YKhu_zfMHmFOmHOr_qkDQ-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id D0C9C108468A;
 Fri, 10 Sep 2021 03:18:02 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 86E0D100EBC1;
 Fri, 10 Sep 2021 03:17:58 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Fri, 10 Sep 2021 13:17:22 +1000
Message-Id: <20210910031741.3292388-7-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 06/25] drm/i915: add wrappers around cdclk
 vtable funcs.

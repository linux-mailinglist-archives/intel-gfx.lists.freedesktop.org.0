...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DB19797AA4
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Sep 2023 19:48:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7829210E813;
	Thu,  7 Sep 2023 17:47:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3523410E811
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=pEC8d9Q/0KG6cR5T5hMfUgu+CSKJqAA5siNFpUa+1I0=;
 b=PbVhJS+OIdcSsZguoazzNeGZErU3WpAsdKiOFASgfDapt6B4+h8NMpFM
 BiOgZvTpPOJkI90RrjGlZIzicAfd/IW+7j4Jqc+mNY9bgs7hsLaCWuyFk
 UbCW30fek7Kss52SSZ3PcoMzM3U+Us49rL+VdJojV8S01DyaF8+jBr8rw
 Ov2b4FfGRCYkNVG6gW+YJwl7bjyL9x9xJvUBtS7mDGkunlW0fpEFGOyFw
 vD8Bv1ULE8YmIB239/H38kIo5x0y8APK3rVjKwr+wIZorRcc7Mq2zD0pD
 fNAandRMmBsGo+7fsjQ4VCHguXLpab+LodYMMYagudjCBEJzrkmPpetkj g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10826"; a="463814864"
X-IronPort-AV: E=Sophos;i="6.02,235,1688454000"; d="scan'208";a="463814864"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2023 10:47:52 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10826"; a="1072957994"
X-IronPort-AV: E=Sophos;i="6.02,235,1688454000"; d="scan'208";a="1072957994"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2023 10:47:51 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  7 Sep 2023 10:37:09 -0700
Message-Id: <20230907173710.1574458-2-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 1/2] drm/i915: Add WABB blit for
...
index 967fe4d77a874..e8cf0a46f636e 100644
...
@@ -1370,12 +1390,87 @@ gen12_emit_indirect_ctx_xcs(const struct intel_context *ce, u32 *cs)
...
+	u32 * const start = context_wabb(ce, false);
 	...
 	cs = emit(ce, start);
@@ -1474,6 +1569,7 @@ u32 lrc_update_regs(const struct intel_context *ce,

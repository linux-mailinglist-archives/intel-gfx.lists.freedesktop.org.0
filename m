...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 691A71512EA
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Feb 2020 00:20:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 109B66ED2A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 04/17] drm/i915/dp: Add writing of DP SDPs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C7236334A6
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Nov 2022 06:16:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B1F410E14F;
	Tue, 22 Nov 2022 05:16:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 530F410E14F
 for <intel-gfx@lists.freedesktop.org>; Tue, 22 Nov 2022 05:16:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669094193; x=1700630193;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=9+FckzFbPaNym2IjhhgKL6qkXOEOgKhG4Tqj/ZUAOQ4=;
 b=Uip825mzGPB7cxUmlH3nDUQWxKHBbTzgPNnK0kUiAHd2SUxSv2clWIdl
 0vr73twgrKztodypywPURixEH19tfmG8oo8FhWWpoBSOKRwXJWdmFxi3x
 zInwwif2p7KFIooqUOCkwYYw7pLAw1JCUjnM9cY2d7uN6Wva5S805czeh
 k3qlLCgY2sVEg+gxHmmAUTogjjSHfFwd2uCfLkunyLR2iH4OKec/g/EJB
 KaZzp3OEB2ercdiCYRC57WXJ11ZWIDEXsqvJeX0xQV7a8VIFbLqCdUGxL
 6DzjphVIBDkzB/OVUnOarsqQD+jPmqrJq+t+sRZYGCnNbRr/bCQ8Q7nYm Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10538"; a="301282764"
X-IronPort-AV: E=Sophos;i="5.96,182,1665471600"; d="scan'208";a="301282764"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Nov 2022 21:16:00 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10538"; a="641287903"
X-IronPort-AV: E=Sophos;i="5.96,182,1665471600"; d="scan'208";a="641287903"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
 by orsmga002.jf.intel.com with ESMTP; 21 Nov 2022 21:15:57 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1oxLdU-00016N-2V;
 Tue, 22 Nov 2022 05:15:56 +0000
Date: Tue, 22 Nov 2022 13:15:02 +0800
From: kernel test robot <lkp@intel.com>
To: Gustavo Sousa <gustavo.sousa@intel.com>,
	intel-gfx@lists.freedesktop.org
Message-ID: <202211221316.mxf8Fddz-lkp@intel.com>
References: <20221121211815.30950-1-gustavo.sousa@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="bKbYPbgW8Yxq4s+x"

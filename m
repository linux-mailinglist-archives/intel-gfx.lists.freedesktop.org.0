...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C5B7353C15C
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Jun 2022 01:40:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5CC5610E3E5;
...
Subject: [Intel-gfx] [PATCH] drm/i915/pvc: Add Wa_16015675438:pvc

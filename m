...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F2401C0AD6
	for <lists+intel-gfx@lfdr.de>; Fri,  1 May 2020 01:08:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C9BE26EA41;
	Thu, 30 Apr 2020 23:08:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5283F6EA42
 for <intel-gfx@lists.freedesktop.org>; Thu, 30 Apr 2020 23:08:32 +0000 (UTC)
IronPort-SDR: UHpOZjaLoTCHuCIsJgkALnEXPHZt/H9O9fzkrvcT/Bevfui0CQTiipYpt3O4yL69ogrVblM14M
 V99MQnjQyc2A==
...
IronPort-SDR: L/n1A4VDAUE038+EaH3W6ji0jg52AYGohTG0QoNFyyxTcJdN4S78TTl2ojUFMf9141Kd7kFRv7
 8kBBTwPPrjvw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,337,1583222400"; d="scan'208";a="405581167"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga004.jf.intel.com with ESMTP; 30 Apr 2020 16:08:30 -0700
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 30 Apr 2020 16:09:46 -0700
Message-Id: <20200430230951.2508-7-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 06/11] drm/i915: Enable big joiner support in
...
---
 ...
 7 files changed, 421 insertions(+), 252 deletions(-)

diff --git a/drivers/gpu/drm/i915/display/icl_dsi.c b/drivers/gpu/drm/i915/display/icl_dsi.c
index 4fec5bd64920..b5cd64b759a9 100644
...
index 5601673c3f30..dc97f1169f57 100644
...
@@ -1965,12 +1966,6 @@ static void intel_ddi_get_power_domains(struct intel_encoder *encoder,
...
@@ -3243,7 +3238,8 @@ static void tgl_ddi_pre_enable_dp(struct intel_atomic_state *state,
...
@@ -3314,7 +3310,8 @@ static void hsw_ddi_pre_enable_dp(struct intel_atomic_state *state,
 	if (!is_mst)
...
@@ -3566,6 +3563,21 @@ static void intel_ddi_post_disable(struct intel_atomic_state *state,
...
@@ -3781,7 +3793,8 @@ static void intel_enable_ddi(struct intel_atomic_state *state,
 {
...
@@ -4138,27 +4151,18 @@ static void bdw_get_trans_port_sync_config(struct intel_crtc_state *crtc_state)
...
@@ -4251,6 +4255,36 @@ void intel_ddi_get_config(struct intel_encoder *encoder,
 		break;
 	}
...
@@ -4275,7 +4309,8 @@ void intel_ddi_get_config(struct intel_encoder *encoder,
...
index 75aa621e85c1..93ac3c1af3e9 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -7005,6 +7005,45 @@ static void hsw_set_frame_start_delay(const struct intel_crtc_state *crtc_state)
...
+
 ...
 {
@@ -7018,34 +7057,39 @@ static void hsw_crtc_enable(struct intel_atomic_state *state,
...
@@ -7081,6 +7125,11 @@ static void hsw_crtc_enable(struct intel_atomic_state *state,
...
+
 	...
 	if (psl_clkgate_wa) {
@@ -7360,6 +7409,9 @@ static u64 get_crtc_power_domains(struct intel_crtc_state *crtc_state)
...
@@ -7970,6 +8022,30 @@ static u32 ilk_pipe_pixel_rate(const struct intel_crtc_state *crtc_state)
 		       pfit_w * pfit_h);
 }
...
@@ -8881,20 +8957,22 @@ static void intel_get_pipe_src_size(struct intel_crtc *crtc,
...
@@ -11056,6 +11134,9 @@ static void hsw_get_ddi_port_state(struct intel_crtc *crtc,
 	} else {
...
@@ -11128,12 +11209,20 @@ static bool hsw_get_pipe_config(struct intel_crtc *crtc,
...
@@ -11219,8 +11308,11 @@ static bool hsw_get_pipe_config(struct intel_crtc *crtc,
 		}
 	}
...
@@ -12235,7 +12327,7 @@ intel_encoder_current_mode(struct intel_encoder *encoder)
 		return NULL;
 	}
...
@@ -13198,10 +13290,12 @@ intel_crtc_copy_uapi_to_hw_state(struct intel_atomic_state *state,
...
@@ -13806,21 +13900,42 @@ intel_pipe_config_compare(const struct intel_crtc_state *current_config,
...
@@ -13830,24 +13945,11 @@ intel_pipe_config_compare(const struct intel_crtc_state *current_config,
...
@@ -13873,7 +13975,8 @@ intel_pipe_config_compare(const struct intel_crtc_state *current_config,
 		}
...
@@ -13894,48 +13997,51 @@ intel_pipe_config_compare(const struct intel_crtc_state *current_config,
...
@@ -13946,11 +14052,12 @@ intel_pipe_config_compare(const struct intel_crtc_state *current_config,
...
@@ -14213,6 +14320,7 @@ verify_crtc_state(struct intel_crtc *crtc,
...
@@ -14239,7 +14347,10 @@ verify_crtc_state(struct intel_crtc *crtc,
 			"(expected %i, found %i)\n",
...
@@ -14248,12 +14359,12 @@ verify_crtc_state(struct intel_crtc *crtc,
...
@@ -15216,7 +15327,12 @@ static void intel_old_crtc_state_disables(struct intel_atomic_state *state,
 {
...
@@ -15246,7 +15362,7 @@ static void intel_commit_modeset_disables(struct intel_atomic_state *state)
...
@@ -15261,7 +15377,6 @@ static void intel_commit_modeset_disables(struct intel_atomic_state *state)
...
@@ -15271,10 +15386,18 @@ static void intel_commit_modeset_disables(struct intel_atomic_state *state)
 	for_each_oldnew_intel_crtc_in_state(state, crtc, old_crtc_state,
 					    new_crtc_state, i) {
 		if (!needs_modeset(new_crtc_state) ||
-		    (handled & BIT(crtc->pipe)))
...
+
 		if (old_crtc_state->hw.active)
 			intel_old_crtc_state_disables(state, old_crtc_state,
 						      new_crtc_state, crtc);
@@ -17869,7 +17992,7 @@ int intel_modeset_init(struct drm_i915_private *i915)
...
+		if (!to_intel_crtc_state(crtc->base.state)->uapi.active)
 		...
 		/*
@@ -18365,7 +18488,17 @@ static void intel_modeset_readout_hw_state(struct drm_device *dev)
...
index 4b85ded0ddea..a180a4809c44 100644
...
index 422dc1c61b79..1c00caeabc68 100644
--- a/drivers/gpu/drm/i915/display/intel_dp.c
+++ b/drivers/gpu/drm/i915/display/intel_dp.c
@@ -1988,12 +1988,10 @@ static bool intel_dp_supports_fec(struct intel_dp *intel_dp,
...
index 95ad87d4ccb3..d90b1ecc8f28 100644

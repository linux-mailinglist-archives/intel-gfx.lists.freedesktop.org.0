...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E9C00577B37
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:38:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E0E93A9C80;
...
Subject: [Intel-gfx] [PATCH v3 05/41] dyndbg: reverse module.callsite walk
 in cat control

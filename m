...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8D7EC1EC66
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Oct 2025 08:34:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3779610E8A2;
	Thu, 30 Oct 2025 07:34:54 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VU2kP3+x";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 18F3A10E8C3;
 Thu, 30 Oct 2025 07:34:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761809691; x=1793345691;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ci/ZcukuKTtOkiB/VTkhVoRTOh6l0oTL1gqmad8Ngh8=;
 b=VU2kP3+xfdu6htDbMqvT8zaCE3jb9d//8Vco/BoNik3aUfnk3vLbCWZi
 hPOy0La+vKkOMcW023/EtzvACEpXmqpQzs+LFmvEeBNcfZAWOhQojuxjn
 TCCG5RWb8hNqUgjwFVc+NMyfRFyqxdwY3Odm/aIq5sU5O0CKg5Pxq6zww
 +ot0yNHSDuAh8XQKBqdODY2fKACFYMUL4/2U2Sql0IwA6HzdgLWX7woPL
 +GNkW2/oircfuLPZvJedlTdd6Kf2exXvcrFZvI7AZ5hJn5gTAAAX/Es86
 9q5r9gJjYc/EWkMygmQdmnA6dAJ5oa+NT4ZmSuxL14YMc/U4IAVNrvaCt g==;
X-CSE-ConnectionGUID: xcCQPsI2Ta6L3GSoSNcSjQ==
X-CSE-MsgGUID: IimpyEjuSFWCJJ5ZSMuYcw==
X-IronPort-AV: E=McAfee;i="6800,10657,11597"; a="75063370"
X-IronPort-AV: E=Sophos;i="6.19,266,1754982000"; d="scan'208";a="75063370"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Oct 2025 00:34:50 -0700
X-CSE-ConnectionGUID: BfrtzNfJSNelID+b1kNiZA==
X-CSE-MsgGUID: HUvkStixREmj2IC6yyf83w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,266,1754982000"; d="scan'208";a="185075332"
Received: from display-adls.igk.intel.com ([10.211.131.198])
 by orviesa006.jf.intel.com with ESMTP; 30 Oct 2025 00:34:49 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Imre Deak <imre.deak@intel.com>,
	Mika Kahola <mika.kahola@intel.com>
Subject: [PATCH 08/32] drm/i915/display: Track the Cx0 PHY enabled lane count
 in the PLL state
Date: Thu, 30 Oct 2025 09:22:25 +0200
Message-Id: <20251030072249.155095-9-mika.kahola@intel.com>

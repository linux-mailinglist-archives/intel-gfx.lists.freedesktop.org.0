...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3350C1ED2C5
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jun 2020 16:57:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 680A589C8F;
	Wed,  3 Jun 2020 14:57:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 519C789BFE
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jun 2020 14:57:18 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 Jun 2020 16:57:01 +0200
Message-Id: <20200603145713.3835124-12-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/24] drm/i915: Rework intel_context pinning to
...
index 6fc0966b75ff..3d6a82b6648e 100644
...
@@ -5398,13 +5406,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -5437,8 +5445,10 @@ static void virtual_context_exit(struct intel_context *ce)
...
index d9c1701061b9..f9ef34a489ec 100644

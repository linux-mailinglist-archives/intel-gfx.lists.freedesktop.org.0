...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90DC28969D0
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Apr 2024 11:00:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 163621128EA;
	Wed,  3 Apr 2024 09:00:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="VEMVvccT";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 20BB81128EA
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Apr 2024 09:00:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1712134844; x=1743670844;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Wyfc3s0k6vfL5iP0yCS2LVBhJf6N8j5/FVoBCCJcLIg=;
 b=VEMVvccTNIWwMFUdV5m+qeMDJV+CpDcina6N46Nz8qbTQgMf53CI0tOZ
 j/biOv5/ZZbxwf9WskkZ3PA3Eh83duZIOWum/ZFPOwVWsYOisWrQ5Hmd+
 yQPKgVDaSYtiicc7O/jE+lzsQKBUh7+uTwixeTP5+swlbrOGBVhxHD0p1
 rJfgt1vaDPIpvetKoL+gitAv/jyXiUsoGmhiBaKLGHnKgcr1ES7XRe0kN
 Y3zwlP2c0jsUwFsp/6sfgVcBG1t1Pi/oeUEH1kkGwlyuvUNDnMyHGXMZj
 bbEua5BrbnQCFKDXXOsQd38fr1JsFu6N4/gDUGW6fR1rgMe5NBGISKd+9 A==;
X-CSE-ConnectionGUID: vvUtryavToyNulepHWmR/w==
X-CSE-MsgGUID: fz8W7pdNS4ehmc/ilnGuyg==
X-IronPort-AV: E=McAfee;i="6600,9927,11032"; a="7472481"
X-IronPort-AV: E=Sophos;i="6.07,177,1708416000"; 
   d="scan'208";a="7472481"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2024 02:00:42 -0700
X-CSE-ConnectionGUID: RMIW9lToRi6Z/veZLmbfQQ==
X-CSE-MsgGUID: oaZ+F7I1RjKJe74jLujz8Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,177,1708416000"; d="scan'208";a="18453165"
Received: from esavax-mobl.ger.corp.intel.com (HELO jhogande-mobl1.intel.com)
 ([10.249.35.175])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2024 02:00:41 -0700
From: =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Animesh Manna <animesh.manna@intel.com>,
 =?UTF-8?q?Jouni=20H=C3=B6gander?= <jouni.hogander@intel.com>
Subject: [PATCH v5 11/19] drm/i915/psr: Rename psr2_enabled as
 sel_update_enabled
Date: Wed,  3 Apr 2024 12:00:05 +0300
Message-Id: <20240403090013.54296-12-jouni.hogander@intel.com>
...
index 28b087d009ea..63097b10bc4d 100644
--- a/drivers/gpu/drm/i915/display/intel_display_types.h
+++ b/drivers/gpu/drm/i915/display/intel_display_types.h
@@ -1734,7 +1734,7 @@ struct intel_psr {

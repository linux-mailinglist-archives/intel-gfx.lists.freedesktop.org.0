...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 584636BCDFB
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 12:19:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94DE610ECD2;
	Thu, 16 Mar 2023 11:19:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B821B10ECBE
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Mar 2023 11:19:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678965561; x=1710501561;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=x4e+2/Oyzy+lnLQ6oxhp0qfr/5kaAhprC11zJLGJ9kE=;
 b=UeRg9X8j8I/2f3bcNtiHA2E0PnZYSa8QOW7V4dXS2ONPoxeqdF8XGjAH
 TSWWesvqqABSqdcWdD8oB8Fa62QzPXkGB5m6XVVvtT44m0rVPCuMGNg+O
 AoQtDScQUGXs6yjNLHdBEBGM22/sCnteaEYmfUkAVm240bZaMr1GEIoF1
 EA+wO0kaFhuJdWbD4P/vmqfwV2atyDpQC6bgFS6GHrlSvtTKdVxpFKa9M
 ItnG9/SXa8eNTRsGasGxrAUIzyCXdUZU8crP8ogmvnpIkCbP/ZTBsGOPV
 N1vij1o6kcBvWo9muywYHyZdedRveW7ww9u+6WFBCA8fGoNIFBLRkH10k w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="339485964"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="339485964"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 04:19:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10650"; a="744083292"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="744083292"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by fmsmga008.fm.intel.com with ESMTP; 16 Mar 2023 04:19:19 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 16 Mar 2023 13:13:31 +0200
Message-Id: <20230316111335.66915-19-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 18/22] drm/i915/mtl: MTL PICA hotplug
 detection
...
@@ -2044,6 +2103,34 @@ u32 gen8_de_pipe_underrun_mask(struct drm_i915_private *dev_priv)
 	return mask;
 }
...
+
 ...
 {
@@ -2168,16 +2255,20 @@ gen8_de_irq_handler(struct drm_i915_private *dev_priv, u32 master_ctl)
...
@@ -2755,7 +2846,11 @@ static void gen11_display_irq_reset(struct drm_i915_private *dev_priv)
...
@@ -3046,6 +3141,127 @@ static void gen11_hpd_irq_setup(struct drm_i915_private *dev_priv)
...
+
 ...
 {
 	switch (encoder->hpd_pin) {
@@ -3381,7 +3597,7 @@ static void gen8_de_irq_postinstall(struct drm_i915_private *dev_priv)
...
@@ -3391,6 +3607,20 @@ static void gen8_de_irq_postinstall(struct drm_i915_private *dev_priv)
 	}
 }
...
+
 ...
 {
 	struct intel_uncore *uncore = &dev_priv->uncore;
@@ -3452,7 +3682,11 @@ static void dg1_irq_postinstall(struct drm_i915_private *dev_priv)
...
@@ -3938,6 +4172,7 @@ static const struct intel_hotplug_funcs platform##_hpd_funcs = { \
 }
...
+HPD_FUNCS(xelpdp);
 ...
 HPD_FUNCS(gen11);
 HPD_FUNCS(bxt);
@@ -3998,6 +4233,8 @@ void intel_irq_init(struct drm_i915_private *dev_priv)
...
index 214654642d12..f75f6fa9ff31 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7190234FDE7
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Mar 2021 12:19:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29CA56EA3F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/pmu: Check actual RC6 status

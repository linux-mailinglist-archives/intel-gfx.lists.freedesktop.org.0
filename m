...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E7EA5E0DD
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jul 2019 11:19:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 195DF891D7;
	Wed,  3 Jul 2019 09:19:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5FF57895B5
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jul 2019 09:19:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17110513-1500050 
 for multiple; Wed, 03 Jul 2019 10:17:30 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 Jul 2019 10:17:22 +0100
Message-Id: <20190703091726.11690-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/15] drm/i915/gt: Track timeline activeness in
 enter/exit
...
IGYwOGFmYTI2YmE0Mi4uNzJjMjJiOTVjZDljIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9ndC9pbnRlbF9scmMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9s
cmMuYwpAQCAtMzE5MSw2ICszMTkxLDggQEAgc3RhdGljIHZvaWQgdmlydHVhbF9jb250ZXh0X2Vu
...
LTMxOTgsNiArMzIwMCw4IEBAIHN0YXRpYyB2b2lkIHZpcnR1YWxfY29udGV4dF9leGl0KHN0cnVj

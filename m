...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B0FC5756020
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jul 2023 12:11:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F3B0A10E223;
	Mon, 17 Jul 2023 10:11:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DCBF010E222
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=FuYwFBo6Ig02IzCijnJTOkqzd5weK8W1i7iK8I2hplNnRoKR/B9jo86r
 bBqAsrAPMDH0Y7j87S0PkKssDUbR6nVPIqWypwreJOYico3Y0kVvG+6Si
 vBflsgW0QihiRGqfvw4a4jpQWwREdDPV0OPxPl5IVEwcosIsiTlPo8zUN
 lfqF90jRthkZea9fFJSys9EUJzt+Ww+VbQWPCFupExZ8kXu4Wy2X4Vk4E
 8AjBmTES8kLZIvR8pBvBQPM2RH5xU5BErK6k2NMMPcW/xXsUu7ABghu1R
 ygJL3nf5PziqBijZqeYRDu/2vsQoPW/xb5MYdE1snjrDoOvbs9zl40MbG g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10773"; a="369445962"
X-IronPort-AV: E=Sophos;i="6.01,211,1684825200"; d="scan'208";a="369445962"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jul 2023 03:11:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10773"; a="836832458"
X-IronPort-AV: E=Sophos;i="6.01,211,1684825200"; d="scan'208";a="836832458"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga002.fm.intel.com with ESMTP; 17 Jul 2023 03:11:19 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 17 Jul 2023 15:39:25 +0530
Message-Id: <20230717100931.2989980-2-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/7] drm/i915/vdsc: Refactor dsc register
 field macro

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3BE17DD9E8
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Nov 2023 01:27:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9542D10E605;
...
Subject: [Intel-gfx] [PATCH v7d 08/23] dyndbg: reduce verbose/debug clutter

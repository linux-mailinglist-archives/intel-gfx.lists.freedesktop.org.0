...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 721C782980A
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Jan 2024 11:53:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0FB910E5A0;
	Wed, 10 Jan 2024 10:53:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8FA9510E5A0
 for <intel-gfx@lists.freedesktop.org>; Wed, 10 Jan 2024 10:53:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1704884010; x=1736420010;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=dBT5C+biz/IO83B0sbRURxOb+RQXLY6UPR6/oOteMD0=;
 b=f1FRTYkK/e3cz64ekFtswmGbyTWaR5aBZpcajjYNED9pX5wM7YHnsHXn
 skfZYf+2qh/lZjvt/f21rmSy7jtK6FI0zuQMqvgApfyhBVLOeQufFKhw7
 diCsI2V66OimFTaJtITSnoyc95OCzV7lXgfVliuma59TgJnzOoyYGwaob
 Bpc1FlZdjO0cnydLwycwu4WouKJGvtzoqLrAq7dFN7yOd6L7w3SzjFObQ
 ah0imE+474eQt0qOcG55enFKeUZjgc+JPxWgAbqcQWQ0c7wX6+nBsiW1v
 eeLJFwY9v/VbL5RZnTUPPU5nkeOmWheaCjrAHdvOuvG6XMKojq49gUN+1 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10947"; a="5564732"
X-IronPort-AV: E=Sophos;i="6.04,184,1695711600"; 
   d="scan'208";a="5564732"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2024 02:53:29 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10947"; a="731822058"
X-IronPort-AV: E=Sophos;i="6.04,184,1695711600"; d="scan'208";a="731822058"
Received: from joshikun-mobl.gar.corp.intel.com (HELO [10.213.110.152])
 ([10.213.110.152])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2024 02:53:28 -0800
Message-ID: <134f5e99-b829-4555-a5cb-5c9a8ac10c22@intel.com>
Date: Wed, 10 Jan 2024 16:23:24 +0530
MIME-Version: 1.0
User-Agent: Mozilla Thunderbird
Subject: Re: drm/i915: Add bigjoiner force enable option to debugfs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5322F75216A
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jul 2023 14:43:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E9AA10E681;
	Thu, 13 Jul 2023 12:43:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8893810E129
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Jul 2023 12:42:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689252179; x=1720788179;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=uiQClK3YfT7IO9qt0LPq8PQf3dwpl2H8QDgszYDXudU=;
 b=To9yeBQaswPKGiYTUo1EUCnnHl/We1v/Rl0XDrK194RFX8fAFAsg/uZC
 jv2u/wavHPpXba7Kg9XUsTK6FEC7ocVQHi1B+cX/P3W/Rmmeu93U1n179
 ObYOvupyN7JXkKo40A5HOql7h9MeAtQnecb87Y0hzF+pnYOP4noYEMQ1V
 r5Ryz6NweJ6v2TOFYKyLn4C4xB1cGziNqydcKvuXEXixU5DCIzx9FzgAC
 ZC6kaLbqv5EoU/95n+LsyVn/v7YXvvUFUHGBmFcyXqm11/6jI35O2m+WB
 uLMbJvPyRR9h+YmUsO4Ii9uZjBeY0xeQ0KQpanvU16yt2aaPS5T+qkwqs Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10770"; a="355087851"
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; d="scan'208";a="355087851"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jul 2023 05:42:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10770"; a="866532946"
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; d="scan'208";a="866532946"
Received: from atadj-mobl1.amr.corp.intel.com (HELO localhost) ([10.252.50.30])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jul 2023 05:42:56 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Suraj Kandpal <suraj.kandpal@intel.com>, intel-gfx@lists.freedesktop.org
In-Reply-To: <87pm4wf0l2.fsf@intel.com>
...
References: <20230713062924.2894736-1-suraj.kandpal@intel.com>
 ...
 <87pm4wf0l2.fsf@intel.com>
Date: Thu, 13 Jul 2023 15:42:54 +0300
Message-ID: <87jzv4f0dt.fsf@intel.com>
MIME-Version: 1.0

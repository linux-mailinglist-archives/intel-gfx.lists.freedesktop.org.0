...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5922FA71A9F
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Mar 2025 16:37:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B83C810E70E;
	Wed, 26 Mar 2025 15:37:42 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="bQcjGo+j";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3410D10E707;
 Wed, 26 Mar 2025 15:37:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1743003462; x=1774539462;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lVtZQbsxfX/iqDLELTpbrgDvP7eZNLkxpNu2nwCF3LE=;
 b=bQcjGo+jJpstqi4QZZzctS1nveN5MUYETp/XMhUsptZsYyRJTF+nG9zb
 r8aBMtOlJfQOAirGbEA7aa2y7ZpZuOQfmUWQ38TL/w7RJcqX28iDqOoPM
 gRuiyTlL0ygiLeQlG0nGPlgi32BVC6WuJKVlBkSqC7zHy4bSa97sYJ1/P
 I9Lm6E5Wu3wEuW6bHZVdUT8pjMJbcBnRT9mjNV/0e6Pk7C12MMaZWzHXk
 AxRxctzOOp/7mwFmqnMdJnpyshM9zaWZ+IpcsgcF9833ZeSWtjnYjc1qm
 RIjjw+D0MYfnElHhV2ysjEuGaxEQeh9OCVzdJMK5GofCkIlP+NnbiSCg/ Q==;
X-CSE-ConnectionGUID: 0eUNJVkQQROu4DiIAVjFFA==
X-CSE-MsgGUID: /vsauBOCRfaxnszp6gDb5Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11385"; a="55665496"
X-IronPort-AV: E=Sophos;i="6.14,278,1736841600"; d="scan'208";a="55665496"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Mar 2025 08:37:40 -0700
X-CSE-ConnectionGUID: V7wPeFwBS0iPn2PgQtB1tg==
X-CSE-MsgGUID: yLwhBhg1QwatSHJCN4XRag==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,278,1736841600"; d="scan'208";a="129923465"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Mar 2025 08:37:33 -0700

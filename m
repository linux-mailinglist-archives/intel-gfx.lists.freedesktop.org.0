...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CAF4610A50
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Oct 2022 08:27:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7F95A10E755;
	Fri, 28 Oct 2022 06:27:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4099210E755
 for <intel-gfx@lists.freedesktop.org>; Fri, 28 Oct 2022 06:27:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666938435; x=1698474435;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=RTC841e0CRuaY6V+svuNo6eUjyrv6bbnl0RMManKzWE=;
 b=D7aanufsCAoI7S3zxKbUJAy8IncESH/R7G2ftHWDDf6bVAwpf74C9XTE
 vKp0uXQ9aoAzeB9eTkThSMoSpbw6sebQ4llLhCdUiYhm3GT5W+rciyaPq
 Vs+40RfyGmw3Wr1x7Ym6YoTDmMrmHdSqZSLXUTTl5/+dLbdYFupNhxM0n
 uVGjVqwmqKg6yyTR9l3BKdzieecNfDt3KJq2mHpUvBycpgzNVOw7p4v11
 vkMRmQsgObnbEWc70fOa3y8mS5LtnfJ77XPY4QHiZjG/uiblIQt0gB4yi
 EybHlnGWTeL20EClNnnVjfU5A6WVw67Papfim4miTl0HRr3SCTKlLQ3IU Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="372636179"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="372636179"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Oct 2022 23:27:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="757979982"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="757979982"
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 28 Oct 2022 06:27:11.0161 (UTC)

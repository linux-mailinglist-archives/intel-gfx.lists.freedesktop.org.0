...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 706FC35BF7D
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Apr 2021 11:09:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77A3D6E072;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/19] drm/i915: Create stolen memory region
 from local memory

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2482F146A6E
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jan 2020 15:01:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 23B596FD4C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 15/22] drm/stm: Convert to CRTC VBLANK
 callbacks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 131DE616583
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Nov 2022 16:02:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A39AD10E49F;
...
Subject: [Intel-gfx] [PATCH v2 2/7] vfio/ccw: remove private->sch

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F6AB9ECE8D
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Dec 2024 15:28:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3230510EB63;
	Wed, 11 Dec 2024 14:28:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=collabora.com header.i=@collabora.com header.b="gr/89O6e";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from bali.collaboradmins.com (bali.collaboradmins.com
 [148.251.105.195])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 33F5E10E0FB;
 Wed, 11 Dec 2024 14:28:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
 s=mail; t=1733927302;
 bh=dKlFMnfnVGg1zt4zbn+TPa8rfp4Eqk5VLZByH5sPrdU=;
 h=From:To:Cc:Subject:Date:From;
 b=
Received: from localhost.localdomain (unknown [171.76.86.135])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested) (Authenticated sender: vignesh)
 by bali.collaboradmins.com (Postfix) with ESMTPSA id 8C8AD17E3766;
 Wed, 11 Dec 2024 15:28:16 +0100 (CET)
...
Subject: [PATCH v1] drm/ci: uprev IGT
Date: Wed, 11 Dec 2024 19:58:05 +0530
Message-ID: <20241211142806.1824961-1-vignesh.raman@collabora.com>

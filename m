...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 94CFF7D6EC8
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Oct 2023 16:36:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF5C510E67F;
...
Subject: [Intel-gfx] [PATCH v2 2/5] drm/i915/gt: Create the gt_to_guc()
 wrapper

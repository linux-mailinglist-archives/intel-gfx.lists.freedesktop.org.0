...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F4372A7B6A
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Nov 2020 11:12:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 71AD26EA4B;
	Thu,  5 Nov 2020 10:11:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B11E56EA04
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Nov 2020 10:11:47 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 22900147-1500050 
 for multiple; Thu, 05 Nov 2020 10:11:40 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Nov 2020 10:11:26 +0000
Message-Id: <20201105101134.19716-14-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/22] drm/i915/gt: Replace direct submit with
...
index 3fb52fac0d5d..e8d6c6398bd0 100644
--- a/drivers/gpu/drm/i915/gt/intel_engine_cs.c
+++ b/drivers/gpu/drm/i915/gt/intel_engine_cs.c
@@ -1001,32 +1001,39 @@ static unsigned long stop_timeout(const struct intel_engine_cs *engine)
...
index e53d0661ef2d..052953c82f69 100644
...
@@ -2081,8 +2079,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -2108,6 +2105,8 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -2135,10 +2134,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
+	 *
 	 ...
 	 *
@@ -2150,7 +2146,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 	 * completed and barf.
 	 */
...
@@ -2223,6 +2219,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -2258,6 +2255,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -2375,8 +2373,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
@@ -2395,8 +2392,9 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
+
 	 ...
 	 *
@@ -2414,36 +2412,43 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
+
 ...
 {
@@ -2781,16 +2786,6 @@ static void process_csb(struct intel_engine_cs *engine)
...
-
 ...
 {
 	LIST_HEAD(list);
@@ -3177,7 +3172,7 @@ static bool preempt_timeout(const struct intel_engine_cs *const engine)
 	if (!timer_expired(t))
 		return false;
...
+	return engine->execlists.pending[0];
 ...
 /*
@@ -3187,10 +3182,12 @@ static bool preempt_timeout(const struct intel_engine_cs *const engine)
...
@@ -3199,6 +3196,8 @@ static void execlists_submission_tasklet(unsigned long data)
...
@@ -3206,17 +3205,8 @@ static void execlists_submission_tasklet(unsigned long data)
...
@@ -3247,26 +3237,16 @@ static void queue_request(struct intel_engine_cs *engine,
...
@@ -3276,25 +3256,11 @@ static bool ancestor_on_hold(const struct intel_engine_cs *engine,
...
@@ -3308,7 +3274,8 @@ static void execlists_submit_request(struct i915_request *request)
...
+			__execlists_kick(&engine->execlists);
 	...
 	spin_unlock_irqrestore(&engine->active.lock, flags);
@@ -4222,7 +4189,6 @@ static int execlists_resume(struct intel_engine_cs *engine)
...
@@ -4239,10 +4205,6 @@ static void execlists_reset_prepare(struct intel_engine_cs *engine)
...
@@ -4487,12 +4449,12 @@ static void execlists_reset_finish(struct intel_engine_cs *engine)
...
index 0bfd58f4941f..427c720310df 100644
...
index 620b6fab2c5c..eb8304772346 100644
--- a/drivers/gpu/drm/i915/i915_request.h
+++ b/drivers/gpu/drm/i915/i915_request.h
@@ -314,6 +314,7 @@ void __i915_request_skip(struct i915_request *rq);
...
index 64bbb8288249..a97278bf1a1c 100644

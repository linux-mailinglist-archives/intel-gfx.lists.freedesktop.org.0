...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA7CA6D15CF
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Mar 2023 05:04:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4807510E302;
...
Subject: Re: [Intel-gfx] [PATCH v2 4/9] drm/i915: Use kmap_local_page() in

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A19C82C9F8E
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Dec 2020 11:36:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02DC26E5CC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 08/20] drm/hibmc: Remove references to struct
 drm_device.pdev

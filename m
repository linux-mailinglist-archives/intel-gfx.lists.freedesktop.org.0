...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F2A5F6EB1FC
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 21:02:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56BDC10E324;
...
Subject: [Intel-gfx] [PATCH v2 2/2] drm/i915/i915_drv: Use i915 instead of

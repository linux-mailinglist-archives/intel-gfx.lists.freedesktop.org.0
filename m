...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F0C33D43DD
	for <lists+intel-gfx@lfdr.de>; Sat, 24 Jul 2021 02:12:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F30EC6FD5B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 24/30] drm/i915: rename CNL references in
 intel_dram.c

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20B4E2C8301
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Nov 2020 12:16:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7CB4C6E462;
	Mon, 30 Nov 2020 11:16:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AFCF16E46B
 for <intel-gfx@lists.freedesktop.org>; Mon, 30 Nov 2020 11:16:40 +0000 (UTC)
IronPort-SDR: 30Gvm8Z2H5669Dy5oMJvWT8dDQ2tsxnzRPuHc8gu3KZLTFBr6hR6p49mD3KiDRMUL08JQRAaUy
 2Cmgu+8Gnffw==
X-IronPort-AV: E=McAfee;i="6000,8403,9820"; a="160389664"
X-IronPort-AV: E=Sophos;i="5.78,381,1599548400"; d="scan'208";a="160389664"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Nov 2020 03:16:39 -0800
IronPort-SDR: TK1gDzgS6fLIzskkHz9yr/hFx+I9sL7AYbOjfoaLZRPIjnKgWd8QbWxpazArodi7myQlGZnfIM
 OV6VoVCFJvBQ==
X-IronPort-AV: E=Sophos;i="5.78,381,1599548400"; d="scan'208";a="329549025"
Received: from cshanno1-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.44.44])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Nov 2020 03:16:37 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 30 Nov 2020 13:15:58 +0200
Message-Id: <20201130111601.2817-7-jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20201130111601.2817-1-jani.nikula@intel.com>
References: <20201130111601.2817-1-jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 07/10] drm/i915/pm: replace

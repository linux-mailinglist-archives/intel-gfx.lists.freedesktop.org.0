...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D0FAF1356
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Nov 2019 11:07:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DAF7B6ECA8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/3] drm/i915/selftests: Wrap vm_mmap() around
 GEM objects

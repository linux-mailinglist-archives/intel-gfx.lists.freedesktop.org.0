...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0747F87558
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:17:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC0266ED66;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 u84Q==
Subject: [Intel-gfx] [PATCH v2 26/34] mm/gup_benchmark.c: convert put_page()
 to put_user_page*()

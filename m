...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F3675210A6
	for <lists+intel-gfx@lfdr.de>; Tue, 10 May 2022 11:19:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1BB610E9A0;
...
Subject: Re: [Intel-gfx] [PATCH v2 13/25] drm/edid: convert drm_mode_std()
 and children to drm_edid

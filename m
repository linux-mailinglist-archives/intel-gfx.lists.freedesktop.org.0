...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D3038172839
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Feb 2020 19:59:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE96D6ED02;
...
Subject: Re: [Intel-gfx] [PATCH 14/51] drm/vkms: Use drmm_add_final_kfree
...
Content-Type: multipart/mixed; boundary="===============0286694418=="

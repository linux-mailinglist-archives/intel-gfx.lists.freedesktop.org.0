...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AE7506F1E5E
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 20:58:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CEA5810E16A;
...
Subject: [Intel-gfx] [PATCH v2 0/8] drm/i915: HuC loading and authentication
 for MTL

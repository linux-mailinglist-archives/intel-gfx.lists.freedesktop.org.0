...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B028A3D02CD
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 22:40:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60BAF6E526;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 04/42] drm/i915/guc: Don't return -EAGAIN to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45C984DEA77
	for <lists+intel-gfx@lfdr.de>; Sat, 19 Mar 2022 20:42:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E389210EE43;
...
Subject: [Intel-gfx] [PATCH 3/4] i915/gem: Revert i915_gem_freeze to
 previous logic

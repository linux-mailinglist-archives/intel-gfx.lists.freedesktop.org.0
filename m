...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 57071220A7C
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jul 2020 12:50:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A7C6F6EAA0;
	Wed, 15 Jul 2020 10:49:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A66F46EAA0
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Jul 2020 10:49:57 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 15 Jul 2020 12:49:52 +0200
Message-Id: <20200715104952.3642413-1-maarten.lankhorst@linux.intel.com>
X-Mailer: git-send-email 2.27.0
In-Reply-To: <20200714144048.3274609-1-maarten.lankhorst@linux.intel.com>
References: <20200714144048.3274609-1-maarten.lankhorst@linux.intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915: Move i915_vma_lock in the selftests
 to avoid lock inversion, v3.

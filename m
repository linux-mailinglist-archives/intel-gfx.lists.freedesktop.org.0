...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9AD9F76BA98
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 19:04:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33D6810E453;
	Tue,  1 Aug 2023 17:03:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-xd2a.google.com (mail-io1-xd2a.google.com
 [IPv6:2607:f8b0:4864:20::d2a])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4C4CB10E42E;
 Tue,  1 Aug 2023 17:03:36 +0000 (UTC)
Received: by mail-io1-xd2a.google.com with SMTP id
 ca18e2360f4ac-785d738d3feso912039f.0; 
 Tue, 01 Aug 2023 10:03:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20221208; t=1690909415; x=1691514215;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=srxDaWlfwjVdxYShICUHrCzev9B/ekFUum+PoiXdszg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1690909415; x=1691514215;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=srxDaWlfwjVdxYShICUHrCzev9B/ekFUum+PoiXdszg=;
 b=
X-Gm-Message-State: ABy/qLYVpY3jjEHTl8OKDnyVxmg1xDhye6zH7kBGz7brjFffacNu8xgA
 nXZhLVnQ7o+Ix9QLD/tEToQ=
X-Google-Smtp-Source: APBJJlFvfXyJpZGc0YyAYmv6D6fEn8DLQHuhDtT5IJe+7Aj40bkzLmtydVFM1HrjyOPZjX+Cy11YGA==
X-Received: by 2002:a05:6602:2559:b0:785:cac9:2d49 with SMTP id
 cg25-20020a056602255900b00785cac92d49mr10971971iob.1.1690909415306; 
 Tue, 01 Aug 2023 10:03:35 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 o20-20020a02c6b4000000b0042b144abf71sm3768577jan.179.2023.08.01.10.03.34
...
Date: Tue,  1 Aug 2023 11:02:47 -0600
Message-ID: <20230801170255.163237-16-jim.cromie@gmail.com>
...
Subject: [Intel-gfx] [PATCH v5 14/22] dyndbg-API: fix
 CONFIG_DRM_USE_DYNAMIC_DEBUG regression
...
Cc: jani.nikula@intel.com, linux@rasmusvillemoes.dk,
 Luis Chamberlain <mcgrof@kernel.org>, Jim Cromie <jim.cromie@gmail.com>,
...
index 42320689e283..d78e48d3af1c 100644
 ...
 */
 ...
 {
@@ -682,12 +703,12 @@ static int param_set_dyndbg_module_classes(const char *instr,
 	return 0;
 }
 /**
...
@@ -1029,12 +1050,17 @@ static void *ddebug_proc_next(struct seq_file *m, void *p, loff_t *pos)
...
@@ -1115,31 +1141,129 @@ static const struct proc_ops proc_fops = {
...
+	vpr_dt_info(dt, "attach-client-module: ");
 ...
 /*
@@ -1150,7 +1274,8 @@ static int ddebug_add_module(struct _ddebug_info *di, const char *modname)
 {
...
+		  di->num_classes, di->num_class_users);
 	if (!di->num_descs) {
 		v3pr_info(" skip %s\n", modname);
 		return 0;
@@ -1173,13 +1298,16 @@ static int ddebug_add_module(struct _ddebug_info *di, const char *modname)
...
@@ -1329,8 +1457,10 @@ static int __init dynamic_debug_init(void)

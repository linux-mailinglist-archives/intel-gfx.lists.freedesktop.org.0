...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 72B28225DE1
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jul 2020 13:54:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE3EB6E37F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 0/5] Asynchronous flip implementation for i915

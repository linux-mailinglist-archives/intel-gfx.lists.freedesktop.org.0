...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B1C5E3910A0
	for <lists+intel-gfx@lfdr.de>; Wed, 26 May 2021 08:25:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 123DD6EC01;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/18] drm/i915/guc: Update sizes of CTB buffers

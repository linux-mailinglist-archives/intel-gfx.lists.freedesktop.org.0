...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 642F276BA56
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 19:03:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCA4410E423;
...
Subject: [Intel-gfx] [PATCH v5 06/22] dyndbg: split param_set_dyndbg_classes

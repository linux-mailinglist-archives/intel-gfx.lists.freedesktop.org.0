...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D5F9A3A3BB
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Feb 2025 18:11:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA4B710E738;
	Tue, 18 Feb 2025 17:10:52 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="LIoRfMq2";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 640A910E737;
 Tue, 18 Feb 2025 17:10:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739898651; x=1771434651;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=3MhPmb+c17SkGXj3/Je9R/UCQwLd5OVCmDgEe0BkXFY=;
 b=LIoRfMq2fJ+LSTiAsyDTzkfV+VefZ5LFpsNx0YLEs9H7xSBK+T1BDaKq
 geRrq7xHQqos7LwKI5csf5dpXc485jvzKSaXWyyfK50cwfGqMndWRNras
 ZD6Vl2crSR2VZAspmum0hWSCmI9TQDDT0+4Rhskc1d13qaYqo28kWHqMQ
 WILRROTHh2UoNxr3Hvorlovre/FvgGHAXm17DBGjdi/kgveCqLMF1BxQX
 Q76pr847kpVqqr929YMjKZwM4gWM1j2DpbB/32jVwBsFIlViyW6IyzxmF
 cfAMuo5o6dP9GDX3mLYTKIC2upqYa45hLLZ6IRy/m3irGVYfwl05zRte5 w==;
X-CSE-ConnectionGUID: LQk23IsFRN23fCBoHmV3nQ==
X-CSE-MsgGUID: Z3Lho7KLRuOf3I0BslMHwA==
X-IronPort-AV: E=McAfee;i="6700,10204,11348"; a="28207576"
X-IronPort-AV: E=Sophos;i="6.13,296,1732608000"; d="scan'208";a="28207576"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Feb 2025 09:10:51 -0800
X-CSE-ConnectionGUID: Ay01NPIZR1+UBC4BVpE5Yg==
X-CSE-MsgGUID: Xk/rNqNASte0Ng7N/kXRYw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,296,1732608000"; d="scan'208";a="119544176"
Received: from vbelgaum-ubuntu.fm.intel.com ([10.1.39.141])
 by fmviesa004.fm.intel.com with ESMTP; 18 Feb 2025 09:10:51 -0800
From: Vinay Belgaumkar <vinay.belgaumkar@intel.com>
To: intel-gfx@lists.freedesktop.org,
	igt-dev@lists.freedesktop.org
Cc: Vinay Belgaumkar <vinay.belgaumkar@intel.com>,
 Riana Tauro <riana.tauro@intel.com>
Subject: [PATCH i-g-t v10 1/3] lib/igt_core: Add tolerance and measured_usleep
 utils
Date: Tue, 18 Feb 2025 09:06:55 -0800
Message-Id: <20250218170657.214076-2-vinay.belgaumkar@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF3011AEC38
	for <lists+intel-gfx@lfdr.de>; Sat, 18 Apr 2020 13:51:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83F126E454;
	Sat, 18 Apr 2020 11:51:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F16066E454
 for <intel-gfx@lists.freedesktop.org>; Sat, 18 Apr 2020 11:51:33 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20942998-1500050 
 for <intel-gfx@lists.freedesktop.org>; Sat, 18 Apr 2020 12:51:30 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sat, 18 Apr 2020 12:51:28 +0100
Message-Id: <20200418115129.28200-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 1/2] drm/i915/selftests: Verify frequency scaling
 with RPS
...
---
 ...
 drivers/gpu/drm/i915/gt/selftest_rps.c   | 241 +++++++++++++++++++++--
...
index 360f56aa4b82..0e82e91f17bb 100644
...
@@ -17,6 +18,234 @@ static void dummy_rps_work(struct work_struct *wrk)
 {
 }
...
+
+		pr_info("%s: min:%lluKHz @ %uMHz, max:%lluKHz @ %uMHz\n",
+			engine->name,
+			min.count, intel_gpu_freq(rps, min.freq),
+			max.count, intel_gpu_freq(rps, max.freq));
+
+		if (3 * max.freq * min.count > 4 * min.freq * max.count ||
+		    4 * max.freq * min.count < 3 * min.freq * max.count) {
...
@@ -248,18 +477,6 @@ static u64 __measure_power(int duration_ms)

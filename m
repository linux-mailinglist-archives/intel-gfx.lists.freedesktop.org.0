...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 014F3619963
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Nov 2022 15:20:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA03E10E817;
...
Subject: [Intel-gfx] [PATCH v3 6/7] vfio/ccw: replace vfio_init_device with
 _alloc_

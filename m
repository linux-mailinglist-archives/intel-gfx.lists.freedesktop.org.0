...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C33743B3FB6
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Jun 2021 10:47:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3279E6ECEC;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915: Drop all references to DRM IRQ
 midlayer

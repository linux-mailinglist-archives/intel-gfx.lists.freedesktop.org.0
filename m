...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5854361801A
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Nov 2022 15:52:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F2D310E62B;
	Thu,  3 Nov 2022 14:52:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CDA9B10E606;
 Thu,  3 Nov 2022 14:51:45 +0000 (UTC)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by dfw.source.kernel.org (Postfix) with ESMTPS id 2A03061F14;
 Thu,  3 Nov 2022 14:51:45 +0000 (UTC)
...
Received: from mchehab by mail.kernel.org with local (Exim 4.96)
 (envelope-from <mchehab@kernel.org>) id 1oqbZE-0076as-04;
...
Subject: [Intel-gfx] [PATCH RFC v2 1/8] drm/i915: export all selftest
 functions
...
Cc: "Jason A. Donenfeld" <Jason@zx2c4.com>, Dan Carpenter <error27@gmail.com>,
 "Darrick J. Wong" <djwong@kernel.org>, Daniel Latypov <dlatypov@google.com>,
 Jason Wang <wangborong@cdjrlc.com>, Chris Wilson <chris@chris-wilson.co.uk>,
 Andrzej Hajda <andrzej.hajda@intel.com>, David Airlie <airlied@gmail.com>,
 Isabella Basso <isabbasso@riseup.net>, Kees Cook <keescook@chromium.org>,
 igt-dev@lists.freedesktop.org, Rahul Kumar Singh <rahul.kumar.singh@intel.com>,
 Matthew Auld <matthew.auld@intel.com>, Ramalingam C <ramalingam.c@intel.com>,
 Bommu Krishnaiah <krishnaiah.bommu@intel.com>,
 =?UTF-8?q?Thomas=20Hellstr=C3=B6m?= <thomas.hellstrom@linux.intel.com>,
 skhan@linuxfoundation.org, Dmitry Osipenko <dmitry.osipenko@collabora.com>,
 Alan Previn <alan.previn.teres.alexis@intel.com>,
 Arunpravin <Arunpravin.PaneerSelvam@amd.com>, intel-gfx@lists.freedesktop.org,
 Lucas De Marchi <lucas.demarchi@intel.com>, dri-devel@lists.freedesktop.org,
 Rodrigo Vivi <rodrigo.vivi@intel.com>,
 Mauro Carvalho Chehab <mchehab@kernel.org>, linux-kselftest@vger.kernel.org,

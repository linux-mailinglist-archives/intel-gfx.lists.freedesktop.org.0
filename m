...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0120F6FFD2E
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 01:18:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B40D10E61F;
	Thu, 11 May 2023 23:18:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D969510E612
 for <intel-gfx@lists.freedesktop.org>; Thu, 11 May 2023 23:18:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683847101; x=1715383101;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Yra9iSZEM19zjsAhLcx3XrFqawT2d30qchr2HEKZrBw=;
 b=U2wjb5GY4b1KYbiaImZ64kq53JqKsZKKujALnTikjipvGHc8+65xPkzC
 nvNL57gxocadAHdvYxZBDKnrgiD+HFhUk6ZyXjYPrWLwiqwHXTl4csIlp
 +oRASKYx5SGkvcuDtdKTJn4VFMLHVmLIlPZz84B/uhsJFsBshvhsvn/XZ
 o9qtqKp3ch3cguZbo8TSVqFhnZ1Pd+pQZDKJsK5jnT8R+N5N5670qpLgw
 QmesgF5ZxXoBNAvmq86X0Pgp8glFST9iJvxYVT5rL9Vcsew2s6t4Eo0Bl
 jLA8Ms8M5+y+iHqupWDm3TCJjYEQeOYtKBV1y8FUxbp72ElYOo8IOccsS w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="352897297"
X-IronPort-AV: E=Sophos;i="5.99,268,1677571200"; d="scan'208";a="352897297"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2023 16:18:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="694012900"
X-IronPort-AV: E=Sophos;i="5.99,268,1677571200"; d="scan'208";a="694012900"
Received: from ptorre-mobl1.ger.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.252.61.205])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2023 16:18:18 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 12 May 2023 02:17:46 +0300
Message-Id: <20230511231750.313467-5-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 4/8] drm/i915: extract

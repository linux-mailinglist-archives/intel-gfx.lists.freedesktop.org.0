...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 35E07A2A0FF
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Feb 2025 07:34:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8101910E43D;
	Thu,  6 Feb 2025 06:34:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=chromium.org header.i=@chromium.org header.b="nuqeze3c";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pl1-f173.google.com (mail-pl1-f173.google.com
 [209.85.214.173])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9817310E43D
 for <intel-gfx@lists.freedesktop.org>; Thu,  6 Feb 2025 06:34:38 +0000 (UTC)
Received: by mail-pl1-f173.google.com with SMTP id
 d9443c01a7336-219f8263ae0so11713175ad.0
 for <intel-gfx@lists.freedesktop.org>; Wed, 05 Feb 2025 22:34:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1738823678; x=1739428478;
 darn=lists.freedesktop.org; 
 h=in-reply-to:content-disposition:mime-version:references:message-id
 :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
 bh=a7ECNJBXu40RP2Clx2OxfF2Lbt/uQreXDitoikmAYNM=;
 b=nuqeze3cvWjDZhyMcJmsOoupQJiFT7Tls5siVbe/Cqq40BZTItlmJNAkjLPEM7TTYG
 mleiX6ZCG5Iu5MHOrw1EXhezmN8UraeVuYOPJ2UCS/PrLbJGLZFk0jIj0A/g+1tBVjoz
 h/jb+vuRmLSPIafhEU1eSzaPfIZyeuR2yakrI=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :message-id:reply-to;
 bh=a7ECNJBXu40RP2Clx2OxfF2Lbt/uQreXDitoikmAYNM=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCU21une05Tf0wlKqguU+TvPyOoX9Xg/EnMFt+gEILFUOmZtMA+tRkaV9O8oftHVN8flmgeyuuQGJKM=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YwYYLYlB/zi7q49dcN2Xz089Bn/uIW8/vSzXnrtW2TiYlGnF4Du
 0AR8QGIPpEtZzqGRv6y/41fpQ93tu2WrqgaMstIPGLYZTnAaZn72nOIN86izpg==
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IH2hs1CTPH8ai63DHl8Dw9B7d0EhYu7JD/3b18TSz8mXtvbx2qi1AzsEls4nrBxaiYiKzflpA==
X-Received: by 2002:a17:902:d583:b0:211:8404:a957 with SMTP id
 d9443c01a7336-21f17edda50mr105723575ad.41.1738823677923; 
 Wed, 05 Feb 2025 22:34:37 -0800 (PST)
Received: from google.com ([2401:fa00:8f:203:28ab:cea4:aa8a:127a])
 by smtp.gmail.com with ESMTPSA id
 d9443c01a7336-21f3687c4c6sm4667755ad.176.2025.02.05.22.34.29

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F02781D2731
	for <lists+intel-gfx@lfdr.de>; Thu, 14 May 2020 08:08:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C7806EAA8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 10/14] drm/i915: Fix enabled infoframe
 states of lspcon

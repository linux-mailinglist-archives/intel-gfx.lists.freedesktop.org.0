...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E6FA6A8EE
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Jul 2019 14:51:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8789E6E11A;
	Tue, 16 Jul 2019 12:51:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7289C6E119
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 Jul 2019 12:51:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17342696-1500050 
 for multiple; Tue, 16 Jul 2019 13:49:31 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 16 Jul 2019 13:49:31 +0100
Message-Id: <20190716124931.5870-5-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/5] drm/i915: Hide unshrinkable context objects
 from the shrinker
...
YzhmNjU3YS4uZjAxMmVjODk4YWJhIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9n
...
L2ludGVsX3JpbmdidWZmZXIuYwppbmRleCAyMTNkZjE0NGJlMTUuLjdiYjBiOTcxYWFlYSAxMDA2
...
dS9kcm0vaTkxNS9pOTE1X3ZtYS5jCmluZGV4IGVlNzNiYWYyOTQxNS4uMWQwMDNlYzlkYTE5IDEw

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF59B39AC50
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jun 2021 23:09:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E005C6EEAE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 9/9] drm/i915/doc: Add kernel doc for
 i915_sched_engine

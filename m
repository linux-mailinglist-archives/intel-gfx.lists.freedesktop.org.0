...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD69259A8CD
	for <lists+intel-gfx@lfdr.de>; Sat, 20 Aug 2022 00:54:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33E6110E657;
...
Subject: [Intel-gfx] [PATCH v3 02/15] mei: add support to GSC extended header

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB4307F3AAB
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Nov 2023 01:26:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD5EA10E5B5;
...
Subject: Re: [Intel-gfx] [PATCH 1/1] drm/i915/pxp: Add missing tag for
 Wa_14019159160

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6E82546D44
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 21:29:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 522BE11380E;
...
Subject: Re: [Intel-gfx] [PATCH v2 11/15] drm/i915/bios: convert

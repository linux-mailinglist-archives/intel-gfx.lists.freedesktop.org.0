...
Received: from mail.lfdr.de
	...
	id KuvvI5LrS2qncwEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 06 Jul 2026 19:53:22 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6991714220
	for <lists+intel-gfx@lfdr.de>; Mon, 06 Jul 2026 19:53:21 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=intel.com header.s=Intel header.b=A+uZQNEY;
	dmarc=pass (policy=none) header.from=intel.com;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 55D3110EA20;
	Mon,  6 Jul 2026 17:53:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6D6D110EA1B;
 Mon,  6 Jul 2026 17:53:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1783360400; x=1814896400;
 h=message-id:subject:from:to:cc:date:in-reply-to:
 references:content-transfer-encoding:mime-version;
 bh=7lc6iM/sRN3uwdnNuqMyqaWlEk834/dhU5SIA/0F+uM=;
 b=A+uZQNEYHVrG3fBM5lvtaBmW65aTdkpTj1HkZDBGxgdK++G1ERAH9ozQ
 53/o5HO+zJ+DwtFUwL6Mn8f9c5iF5rke0JVgkXE8HQgGNioQexCxjYi+z
 XI4LPMgi96NrQgwvz2P/8LNPPyQeJMq2y9wXvqfWFbmqMdLrXP4E8ZKxE
 sqMmFfYdtu7zF8JL7kb7gXQNv4A6TDH5cpac6n7b7MsIWiEbYr6WYmHI3
 5jalPyj3RwLtpVHg8mAtWh7yBRIJoFU1/7p1/AXqvDcW4qtZJ9w8DrOb8
 3CWbGYekJzGsCckaqWpz4HHpu12gxe7uC1JHZZHm4WEJfIsnYJhUWlV3/ w==;
X-CSE-ConnectionGUID: fJnU5iveSgqHfN04M+IGoQ==
X-CSE-MsgGUID: v/S4J6KzSX6eicSLJ3SiZA==
X-IronPort-AV: E=McAfee;i="6800,10657,11839"; a="95156419"
X-IronPort-AV: E=Sophos;i="6.25,151,1779174000"; d="scan'208";a="95156419"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jul 2026 10:53:19 -0700
X-CSE-ConnectionGUID: nh65zP/qRSm2ITTltY8HWA==
X-CSE-MsgGUID: SvXQx1RRSHuOAIeV42ghxA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.25,151,1779174000"; d="scan'208";a="258695843"
Received: from conormcd-mobl2.ger.corp.intel.com (HELO [10.245.244.132])
 ([10.245.244.132])
 by fmviesa005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jul 2026 10:53:14 -0700
Message-ID: <230890fdfb6c3e855636ad7731f60210a078e2c6.camel@linux.intel.com>
...
Date: Mon, 06 Jul 2026 19:53:12 +0200
...
X-Spamd-Result: default: False [-1.31 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gmx.de:email,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,lists.freedesktop.org:from_smtp,amd.com:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: C6991714220

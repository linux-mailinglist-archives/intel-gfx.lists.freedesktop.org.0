...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C5841329D5
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Jan 2020 16:18:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E52326E0DC;
...
Subject: [Intel-gfx] [PATCH 4/5] drm/i915: convert to using new struct

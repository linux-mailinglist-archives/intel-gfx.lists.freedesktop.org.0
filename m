...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E692055458E
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 13:00:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 17DE110EB5F;
...
Subject: [Intel-gfx] [PATCH v3 11/13] drm/edid: add HF-EEODB support to EDID
 read and allocation

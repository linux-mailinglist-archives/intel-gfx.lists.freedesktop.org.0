...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 183F464753F
	for <lists+intel-gfx@lfdr.de>; Thu,  8 Dec 2022 19:03:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DF47D10E4D2;
	Thu,  8 Dec 2022 18:02:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 17D2710E4D2;
 Thu,  8 Dec 2022 18:02:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670522574; x=1702058574;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=vD37ikKJD/FaGljLFSx9W0VZhJD+pkYRFIQ+yd1S5jE=;
 b=Tc5zFO052xUFH36lMtytEobZxcQ/ZqaTIjg7KJD9egSIRvJfJp1ZSGfj
 YvX6kyck7L2YtmTKMB2Fga+Ima3dMT/pacYWKLS5O6xq2TgDeik1JTNze
 K1e18MQI7QzCguh/Xcqcx3myzIxJrN8hJvO2aB08BZcR1hzLMYXlh9zsM
 zbhXRl6kGoaAlOeNtdha8+mwZUy11V6aBlE3tUgtYy17XiARfla95gLJ5
 Xa/YwvAsMMynzI8MwcqgOvVFMuBzbV0jLW/XedHt1q3+NuXUoPLLr6OkS
 05jg+rz7sLs6sS3odr5F4qb4Oh783Pdo4jmENcxX9ZYhYQG2xuC4j/mQb Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10555"; a="296932984"
X-IronPort-AV: E=Sophos;i="5.96,227,1665471600"; d="scan'208";a="296932984"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2022 10:02:51 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10555"; a="735901700"
X-IronPort-AV: E=Sophos;i="5.96,227,1665471600"; d="scan'208";a="735901700"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by FMSMGA003.fm.intel.com with ESMTP; 08 Dec 2022 10:02:51 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  8 Dec 2022 10:05:42 -0800
Message-Id: <20221208180542.998148-1-alan.previn.teres.alexis@intel.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v12 1/1] drm/i915/pxp: Promote pxp subsystem to
 top-level of i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AEEA863BA8B
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Nov 2022 08:26:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7966610E372;
...
Subject: [Intel-gfx] [PATCH v8 00/22] drm/i915/vm_bind: Add VM_BIND
 functionality

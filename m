...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B813C672061
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 16:00:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDDAD10E6F6;
	Wed, 18 Jan 2023 15:00:48 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v7 02/22] drm/edid: fix parsing of 3D modes
 from HDMI VSDB

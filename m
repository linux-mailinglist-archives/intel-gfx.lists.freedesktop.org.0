...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7AF74BC157
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Feb 2022 21:45:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE7CC10E1C3;
...
Subject: Re: [Intel-gfx] [PATCH v3 11/16] drm/i915/guc: Replace check for
 golden context size

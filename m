...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 735A05A539E
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 19:56:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33A0510EB35;
	Mon, 29 Aug 2022 17:55:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C61D110EAB7;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=Nc+vwdLtVetVnfse0lR4Ok2NIQJyP9sMliYTm61LljE=;
 b=G2bK5R/rfUuMHJYdFPCcOQuH7/HrlmXA0HhqgvWAHZ3v3QrULUI5C2hZ
 ltQM8sv6BWTO1W7NDPt5ooc844bpa6tQVunTcHRQpwkaG26QWE1ywO03R
 cDZNAu36fAET49TPkSASORBFXEEYe2Hf4P9TWqN8qP6pxiTnNcsL6FrAZ
 CkqE295bcjbl6rqXido6LmAnShbh8xRjk+MrH/7XCdMqVQ/3EojP0uUAm
 x5sR2EXAPGwFhZKH1yQY/ZvWCEqL03msFKLtUVDvhjhgB/PSB93bI1k63
 FmwcuvMoo8inyfK6nUslyAcHygTky8xV5sQvwhxcnfjzRmusB9+qOzbr5 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10454"; a="381246667"
X-IronPort-AV: E=Sophos;i="5.93,273,1654585200"; d="scan'208";a="381246667"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 10:02:45 -0700
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="562297227"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 10:02:44 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 29 Aug 2022 10:02:37 -0700
Message-Id: <20220829170238.969875-8-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH 7/8] drm/i915/mtl: Use primary GT's irq lock for
 media GT

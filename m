...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0393AA5CB11
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Mar 2025 17:46:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0153010E030;
	Tue, 11 Mar 2025 16:46:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="GKQ10OYZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D163910E030;
 Tue, 11 Mar 2025 16:46:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1741711590; x=1773247590;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=TZwSoboz/0gdJNdAkYhYCSdhAkeCESdGdlCRHUj3wp8=;
 b=GKQ10OYZmWRiLgq7D/PfvTycnit36zWOx7dNxeUT0GmMYqVOZLDCt7CW
 LhJqstoO9JN+ZV+Afp/6RdyA8DY3SM22Zt5h0UYxcXbHj5VTVfjodpgbF
 YZsM9euhhRMsxgFzx9dAxijB6vDm9k7AWLf6rVSJFJvbx5h/YkxSZ+YLt
 e6iUXC8Ekatzx7d4FzW9PlILxa77mFJO0gaUXUuhaqZAoWTJunX+RonPt
 fRisBjtFU0nHBDfaeh+J9IdAIxrfuWEQGN1tqDt7OTVxIzguxG+qNM8K8
 VvAF0Jd9NtKPHXTuWyBZAAQywu5F5tCVXrKgVBTrZaafgf4KJc3sEk4DV g==;
X-CSE-ConnectionGUID: ALTWsSWkTFWVEaZwywzXxQ==
X-CSE-MsgGUID: GV5TY48FQjSdUxkuNT/FtQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11370"; a="42638492"
X-IronPort-AV: E=Sophos;i="6.14,239,1736841600"; d="scan'208";a="42638492"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2025 09:46:30 -0700
X-CSE-ConnectionGUID: mDY/H3oFQmiS8sgMeurZTA==
X-CSE-MsgGUID: ifwci8aDSHamBdSuiEg6aQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,239,1736841600"; d="scan'208";a="125578921"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orviesa005.jf.intel.com with SMTP; 11 Mar 2025 09:46:26 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 11 Mar 2025 18:46:25 +0200
Date: Tue, 11 Mar 2025 18:46:25 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Gustavo Sousa <gustavo.sousa@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org,
 Matt Roper <matthew.d.roper@intel.com>,
 Jani Nikula <jani.nikula@linux.intel.com>
Subject: Re: [PATCH v4 1/3] drm/i915/display: Convert intel_bw.c internally
 to intel_display
Message-ID: <Z9Bo4RVkY5mnYsmo@intel.com>
...
In-Reply-To: <20250310-xe3lpd-bandwidth-update-v4-1-4191964b034d@intel.com>
...
> index 048be287224774110d94fe2944daa580d8dc20a6..633b3ad4b6b50b6ff56483eb836ee31d5dfdecbf 100644
...
> @@ -54,18 +56,18 @@ static int dg1_mchbar_read_qgv_point_info(struct drm_i915_private *dev_priv,
...
>  
> @@ -74,22 +76,23 @@ static int dg1_mchbar_read_qgv_point_info(struct drm_i915_private *dev_priv,
>  	return 0;
>  }
>  
...
> @@ -102,14 +105,15 @@ static int icl_pcode_read_qgv_point_info(struct drm_i915_private *dev_priv,
>  	return 0;
>  }
>  
...
>  	if (ret)
>  		return ret;
> @@ -122,10 +126,10 @@ static int adls_pcode_read_psf_gv_point_info(struct drm_i915_private *dev_priv,
>  	return 0;
>  }
>  
...
>  
>  	/*
> @@ -142,18 +146,19 @@ static u16 icl_qgv_points_mask(struct drm_i915_private *i915)
...
> @@ -164,27 +169,28 @@ int icl_pcode_restrict_qgv_points(struct drm_i915_private *dev_priv,
>  				1);
>  
>  	if (ret < 0) {
...
> @@ -200,29 +206,30 @@ static int mtl_read_qgv_point_info(struct drm_i915_private *dev_priv,
>  }
>  
>  static int
...
>  			qi->t_bl = 4;
> @@ -250,7 +257,7 @@ static int icl_get_qgv_points(struct drm_i915_private *dev_priv,
...
>  		return ret;
>  	}
> @@ -422,7 +430,7 @@ static int icl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
...
>  		int j;
>  
> @@ -449,7 +457,7 @@ static int icl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
...
>  		}
> @@ -460,44 +468,45 @@ static int icl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
...
>  
> @@ -514,7 +523,7 @@ static int tgl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
...
>  		int clpchgroup;
>  		int j;
> @@ -522,7 +531,7 @@ static int tgl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
...
> @@ -554,7 +563,7 @@ static int tgl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
>  							  num_channels *
>  							  qi.channel_width, 8);
>  
> -			drm_dbg_kms(&dev_priv->drm,
...
>  				    i, j, bi->num_planes, bi->deratedbw[j],
>  				    bi->peakbw[j]);
> @@ -565,7 +574,7 @@ static int tgl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
>  
...
>  		}
> @@ -577,17 +586,17 @@ static int tgl_get_bw_info(struct drm_i915_private *dev_priv, const struct intel
>  	 * as it will fail and pointless anyway.
>  	 */
>  	if (qi.num_points == 1)
> -		dev_priv->display.sagv.status = I915_SAGV_NOT_CONTROLLED;
...
>  
>  	/*
> @@ -598,7 +607,7 @@ static void dg2_get_bw_info(struct drm_i915_private *i915)
...
> @@ -606,20 +615,21 @@ static void dg2_get_bw_info(struct drm_i915_private *i915)
...
>  		return ret;
>  	}
> @@ -631,33 +641,33 @@ static int xe2_hpd_get_bw_info(struct drm_i915_private *i915,
...
>  {
>  	int i;
> @@ -667,9 +677,9 @@ static unsigned int icl_max_bw_index(struct drm_i915_private *dev_priv,
>  	 */
...
> @@ -685,7 +695,7 @@ static unsigned int icl_max_bw_index(struct drm_i915_private *dev_priv,
>  	return UINT_MAX;
>  }
>  
...
>  {
>  	int i;
> @@ -695,9 +705,9 @@ static unsigned int tgl_max_bw_index(struct drm_i915_private *dev_priv,
>  	 */
>  	num_planes = max(1, num_planes);
>  
...
>  		/*
>  		 * Pcode will not expose all QGV points when
> @@ -713,52 +723,54 @@ static unsigned int tgl_max_bw_index(struct drm_i915_private *dev_priv,
>  	return 0;
>  }
>  
...
> @@ -772,8 +784,8 @@ static unsigned int intel_bw_crtc_num_active_planes(const struct intel_crtc_stat
>  
...
>  
> @@ -787,7 +799,7 @@ static unsigned int intel_bw_crtc_data_rate(const struct intel_crtc_state *crtc_
>  
...
>  	}
>  
> @@ -797,37 +809,37 @@ static unsigned int intel_bw_crtc_data_rate(const struct intel_crtc_state *crtc_
...
>  
>  	return data_rate;
> @@ -836,10 +848,10 @@ static unsigned int intel_bw_data_rate(struct drm_i915_private *dev_priv,
...
>  }
> @@ -847,10 +859,10 @@ intel_atomic_get_old_bw_state(struct intel_atomic_state *state)
>  struct intel_bw_state *
...
>  	return to_intel_bw_state(bw_state);
>  }
> @@ -858,27 +870,27 @@ intel_atomic_get_new_bw_state(struct intel_atomic_state *state)
>  struct intel_bw_state *
...
> @@ -897,23 +909,23 @@ static unsigned int icl_max_bw_qgv_point_mask(struct drm_i915_private *i915,
>  	return max_bw_point;
>  }
>  
...
> @@ -926,29 +938,31 @@ static unsigned int icl_max_bw_psf_gv_point_mask(struct drm_i915_private *i915)
...
>  	int i;
>  	int ret;
> @@ -964,7 +978,7 @@ static int mtl_find_qgv_points(struct drm_i915_private *i915,
>  	 */
...
>  	}
>  
> @@ -974,27 +988,27 @@ static int mtl_find_qgv_points(struct drm_i915_private *i915,
>  	 */
>  	for (i = 0; i < num_qgv_points; i++) {
...
>  
>  	/*
> @@ -1002,7 +1016,7 @@ static int mtl_find_qgv_points(struct drm_i915_private *i915,
...
>  		return -EINVAL;
>  	}
> @@ -1013,14 +1027,15 @@ static int mtl_find_qgv_points(struct drm_i915_private *i915,
>  	return 0;
>  }
>  
...
>  	u16 qgv_points = 0;
>  	int i;
> @@ -1031,22 +1046,22 @@ static int icl_find_qgv_points(struct drm_i915_private *i915,
>  		return ret;
>  
>  	for (i = 0; i < num_qgv_points; i++) {
...
>  			    i, max_data_rate, data_rate);
>  	}
> @@ -1057,14 +1072,14 @@ static int icl_find_qgv_points(struct drm_i915_private *i915,
>  	 * reasons.
>  	 */
>  	if (qgv_points == 0) {
...
>  			    data_rate, num_active_planes);
>  		return -EINVAL;
> @@ -1076,8 +1091,8 @@ static int icl_find_qgv_points(struct drm_i915_private *i915,
>  	 * cause.
>  	 */
>  	if (!intel_can_enable_sagv(i915, new_bw_state)) {
...
>  	}
>  
> @@ -1085,7 +1100,7 @@ static int icl_find_qgv_points(struct drm_i915_private *i915,
...
>  								    psf_points);
>  	/*
> @@ -1101,38 +1116,38 @@ static int icl_find_qgv_points(struct drm_i915_private *i915,
>  	return 0;
>  }
>  
...
>  				return true;
> @@ -1151,7 +1166,8 @@ static void skl_plane_calc_dbuf_bw(struct intel_bw_state *bw_state,
...
>  	enum dbuf_slice slice;
> @@ -1160,7 +1176,7 @@ static void skl_plane_calc_dbuf_bw(struct intel_bw_state *bw_state,
...
>  	}
> @@ -1169,8 +1185,8 @@ static void skl_plane_calc_dbuf_bw(struct intel_bw_state *bw_state,
...
>  	enum plane_id plane_id;
>  
> @@ -1191,7 +1207,7 @@ static void skl_crtc_calc_dbuf_bw(struct intel_bw_state *bw_state,
...
>  					       crtc_state->data_rate[plane_id]);
> @@ -1200,13 +1216,13 @@ static void skl_crtc_calc_dbuf_bw(struct intel_bw_state *bw_state,
>  
...
>  		unsigned int max_bw = 0;
>  		enum pipe pipe;
> @@ -1215,7 +1231,7 @@ intel_bw_dbuf_min_cdclk(struct drm_i915_private *i915,
>  		 * The arbiter can only really guarantee an
>  		 * equal share of the total bw to each plane.
>  		 */
> -		for_each_pipe(i915, pipe) {
...
> @@ -1232,12 +1248,13 @@ intel_bw_dbuf_min_cdclk(struct drm_i915_private *i915,
...
>  
>  	return min_cdclk;
> @@ -1246,6 +1263,7 @@ int intel_bw_min_cdclk(struct drm_i915_private *i915,
...
> @@ -1255,7 +1273,7 @@ int intel_bw_calc_min_cdclk(struct intel_atomic_state *state,
...
> @@ -1274,7 +1292,7 @@ int intel_bw_calc_min_cdclk(struct intel_atomic_state *state,
>  	if (!old_bw_state)
>  		return 0;
>  
...
>  		if (ret)
>  			return ret;
> @@ -1309,7 +1327,7 @@ int intel_bw_calc_min_cdclk(struct intel_atomic_state *state,
...
> @@ -1319,7 +1337,7 @@ int intel_bw_calc_min_cdclk(struct intel_atomic_state *state,
>  
...
>  	struct intel_crtc *crtc;
>  	int i;
> @@ -1353,7 +1371,7 @@ static int intel_bw_check_data_rate(struct intel_atomic_state *state, bool *chan
>  
>  		*changed = true;
>  
> -		drm_dbg_kms(&i915->drm,
...
> @@ -1365,14 +1383,15 @@ static int intel_bw_check_data_rate(struct intel_atomic_state *state, bool *chan
>  
...
> @@ -1395,7 +1414,7 @@ int intel_bw_atomic_check(struct intel_atomic_state *state)
>  	if (!changed)
>  		return 0;
>  
...
>  		return ret;
>  
> @@ -1407,8 +1426,8 @@ int intel_bw_atomic_check(struct intel_atomic_state *state)
...
> @@ -1416,7 +1435,7 @@ static void intel_bw_crtc_update(struct intel_bw_state *bw_state,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 389104CF7B4
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Mar 2022 10:47:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C531110ED60;
...
Subject: Re: [Intel-gfx] [PATCH v2 2/2] drm/i915/dg2: Add debugfs to control

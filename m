...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 12EF86E8586
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Apr 2023 01:00:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94D6710EB4E;
	Wed, 19 Apr 2023 22:59:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D07A710EB3B;
 Wed, 19 Apr 2023 22:59:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1681945187; x=1713481187;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Q4qLgrfIZMifp6emi7QD+F1I2DuXqK9PWqZB2qd8nKY=;
 b=Ct9iFmcIvs7uf0u78+ddbAXff59HVJnGlUoTEwmbnvMukZqm9qfbPVtu
 1MLj7OInGjvLY5s07djGfxs6E5xAhYnrJ/m80adOggnEFALifSkOwG9pO
 FQBlMWa+3lo75Qvq0ECsuyVw8BOpG/kwY6bOLCbyndUy9Q4JeXkAr5usT
 rN100JIEFZH8cEda5FuMlSaRrg0wuE0Lcc8Hs+TaMUWY4skANvsWnKLT6
 +xDYJrpbI6JYPo+X6lGtdbiAhyUXTU415QaZZOXTqipsK5ZHxHlNs6Bql
 eG5rYWYh1Gi2cFkeRzGIA7VAJXRRZdQcfaGX+gcAv7byOp6UkQfxhXb5F A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="431858540"
X-IronPort-AV: E=Sophos;i="5.99,210,1677571200"; d="scan'208";a="431858540"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2023 15:59:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10685"; a="815787141"
X-IronPort-AV: E=Sophos;i="5.99,210,1677571200"; d="scan'208";a="815787141"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Apr 2023 15:59:46 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Wed, 19 Apr 2023 16:00:57 -0700
Message-Id: <20230419230058.2659455-8-fei.yang@intel.com>

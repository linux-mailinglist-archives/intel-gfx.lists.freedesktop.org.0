...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 043A938CE80
	for <lists+intel-gfx@lfdr.de>; Fri, 21 May 2021 22:02:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0240F6F8DD;
	Fri, 21 May 2021 20:02:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 37EEC6F8D0;
 Fri, 21 May 2021 20:02:14 +0000 (UTC)
IronPort-SDR: Izkt1g0cdGuJB0c6hWnFkKgmOK6DqrvMjMHPNEPFZY/F7CeF/Dxi6bbbAR1VfYGjP6HEsutpeB
 mxqNC2yTClxg==
X-IronPort-AV: E=McAfee;i="6200,9189,9991"; a="181853892"
X-IronPort-AV: E=Sophos;i="5.82,319,1613462400"; d="scan'208";a="181853892"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 May 2021 13:02:13 -0700
IronPort-SDR: 5f+XRBvxSjUNYfUvQaXc4R4JnI7xKE3JntqZqeOe/34RGWkKFCt1Lbck8q8BHjtT2XC4+CsMQK
 y+4wM9ywwgfA==
X-IronPort-AV: E=Sophos;i="5.82,319,1613462400"; d="scan'208";a="462615355"
Received: from dweeratu-mobl1.amr.corp.intel.com (HELO intel.com)
 ([10.254.1.200])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 May 2021 13:02:11 -0700
Date: Fri, 21 May 2021 16:02:10 -0400
From: Rodrigo Vivi <rodrigo.vivi@intel.com>
To: Lyude Paul <lyude@redhat.com>
Message-ID: <YKgRwsnNiaJg7Sad@intel.com>
References: <20210514181504.565252-1-lyude@redhat.com>
 <20210514181504.565252-9-lyude@redhat.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20210514181504.565252-9-lyude@redhat.com>
Subject: Re: [Intel-gfx] [PATCH v6 8/9] drm/dp: Extract i915's eDP backlight

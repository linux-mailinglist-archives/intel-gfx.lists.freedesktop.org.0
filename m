...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 863B7172DF4
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Feb 2020 02:06:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A98F06EDA8;
	Fri, 28 Feb 2020 01:06:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ECD336EDA8
 for <intel-gfx@lists.freedesktop.org>; Fri, 28 Feb 2020 01:06:14 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20378421-1500050 
 for multiple; Fri, 28 Feb 2020 01:05:57 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 28 Feb 2020 01:05:55 +0000
Message-Id: <20200228010555.2400074-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20200228003958.2347965-4-chris@chris-wilson.co.uk>
References: <20200228003958.2347965-4-chris@chris-wilson.co.uk>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/i915/perf: Schedule oa_config after
...
---
I forgot to force the uninterruptible wait on activation.
---
...
index 39902df0cc11..4cb4418d501f 100644
--- a/drivers/gpu/drm/i915/i915_active.c
+++ b/drivers/gpu/drm/i915/i915_active.c
@@ -493,7 +493,7 @@ static int flush_lazy_signals(struct i915_active *ref)
 	return err;
 }
...
@@ -508,7 +508,9 @@ int i915_active_wait(struct i915_active *ref)
 	if (err)
 		return err;
...
index 79391d92ab7e..72cde83de3d0 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 887B6765684
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jul 2023 16:55:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5929010E5B5;
...
Subject: [Intel-gfx] [RFC 7/8] drm/i915: Lift the user PAT restriction from
 use_cpu_reloc

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 805193F8123
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Aug 2021 05:30:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E3EA6E523;
	Thu, 26 Aug 2021 03:29:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ACDEE6E4E3;
 Thu, 26 Aug 2021 03:28:42 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10087"; a="215811078"
X-IronPort-AV: E=Sophos;i="5.84,352,1620716400"; d="scan'208";a="215811078"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Aug 2021 20:28:40 -0700
X-IronPort-AV: E=Sophos;i="5.84,352,1620716400"; d="scan'208";a="684738576"
...
Date: Wed, 25 Aug 2021 20:23:20 -0700
Message-Id: <20210826032327.18078-21-matthew.brost@intel.com>
...
Subject: [Intel-gfx] [PATCH 20/27] drm/i915/guc: Rework and simplify locking
...
@@ -1131,7 +1119,11 @@ static int steal_guc_id(struct intel_guc *guc)
...
@@ -1167,6 +1159,8 @@ static int pin_guc_id(struct intel_guc *guc, struct intel_context *ce)
 try_again:
...
+
 	if (context_guc_id_invalid(ce)) {
 		...
 		if (ret)
@@ -1246,8 +1240,13 @@ static int register_context(struct intel_context *ce, bool loop)

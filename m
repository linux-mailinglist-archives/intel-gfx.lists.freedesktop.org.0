...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9381B6044A8
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Oct 2022 14:11:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A9BA10E084;
...
Subject: [Intel-gfx] [PATCH 0/2] Selftest fixes for 6.1

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20C5D6FBB10
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 00:28:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1AE2510E314;
	Mon,  8 May 2023 22:28:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C61EB10E312;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=Ncs1QS0DVLxokSbrDKEiUnmIiZlu6Sotkt0TdWUMx7Y=;
 b=h0lmF8C3rpU5B89QS4BojxE2GXXANJMtUpU0N+j9JMAu6MX2JKmC7X40
 pw2MG34RSHNMmbSZ/+AfQtQjCMuWWHK3bQP1T1RGcKe29vkx77REslYae
 +oF1uGJ+wtPVtwz6peIPKk+pvbidR0/fnwU1uU8aYCC105URmlWKHetzv
 MOagDJ4Y/+lukhPUGs7VnYZH00nSVYdzjdUkRboQZ3RFJNA+LjPiamt/9
 usWZMj+kHHjRBTMnID+MQz7Cqu2TokquB5/6JTZ68FAvpQk9+GRrvbtEv
 PybiX4fogevKfDXA+W2wNOfB3yZpPAR6lACvDtItRn9M05SXLOHIMVdkI A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="413032812"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="413032812"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 15:28:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="872947008"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; d="scan'208";a="872947008"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 May 2023 15:28:18 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  8 May 2023 15:29:13 -0700
Message-Id: <20230508222913.3946355-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 2/2] drm/i915: use pat_index instead of
 cache_level

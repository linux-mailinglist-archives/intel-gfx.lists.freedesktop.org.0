...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BEA5E178518
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Mar 2020 22:53:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA9C66E0F1;
	Tue,  3 Mar 2020 21:53:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
 [207.211.31.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0E77C6E0F1
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Mar 2020 21:53:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1583272420;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=PpaQSlL5pSAj9nf+y2H0OTdGptVUNf4Y09OND/PZJgQ=;
 b=ZxcdDpEsZ2wGzcW7jbrEt1lHhxiVLpAw7ahKWacIhVnEyKUYoys2gyTPxkA8Q8CPHocUr3
 aLnUQap/WWvcWOUllwtJb09RbwrwjsBfsdyDOiaujTFoJOKGR9m0d0wCwM3bvBKTUP/z9e
 U5kdY5SPujwdUIwObh1OKY6zmKa/25M=
...
Subject: [Intel-gfx] [PATCH v3] drm/i915: Force DPCD backlight mode on X1
...
Cc: Jani Nikula <jani.nikula@intel.com>, linux-kernel@vger.kernel.org,
 ...
 Adam Jackson <ajax@redhat.com>, Thomas Zimmermann <tzimmermann@suse.de>

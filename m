...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FEFA654876
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Dec 2022 23:30:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E83610E5C1;
...
Subject: [Intel-gfx] [RFC PATCH 13/20] drm/i915/display: Add more macros to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 129E82F627E
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jan 2021 14:56:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 444F86E3A0;
	Thu, 14 Jan 2021 13:56:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E51D16E3A0
 for <intel-gfx@lists.freedesktop.org>; Thu, 14 Jan 2021 13:56:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23595524-1500050 
 for <intel-gfx@lists.freedesktop.org>; Thu, 14 Jan 2021 13:56:14 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 14 Jan 2021 13:56:12 +0000
Message-Id: <20210114135612.13210-5-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 5/5] drm/i915: Reduce test_and_set_bit to set_bit
 in i915_request_submit()

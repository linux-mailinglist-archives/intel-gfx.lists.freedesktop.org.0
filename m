...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D3F3C7CE3D0
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:07:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D7CF10E413;
	Wed, 18 Oct 2023 17:06:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-xd2a.google.com (mail-io1-xd2a.google.com
 [IPv6:2607:f8b0:4864:20::d2a])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B78D210E426;
 Wed, 18 Oct 2023 17:06:27 +0000 (UTC)
Received: by mail-io1-xd2a.google.com with SMTP id
 ca18e2360f4ac-79f9acc857cso255512439f.2; 
 Wed, 18 Oct 2023 10:06:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1697648787; x=1698253587; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=/Yhpu/EmJXVB5W3QC/33O9eGZOX/EYePa54RrfXExsg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1697648787; x=1698253587;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=/Yhpu/EmJXVB5W3QC/33O9eGZOX/EYePa54RrfXExsg=;
 b=
X-Gm-Message-State: AOJu0YxpGLysESIXBtZBmtGPuuOnEmc2Ax2nuf06MRiM/VXBDx6sVSQM
 ixhaUg1SDUaqOVpKXQIcWkM=
X-Google-Smtp-Source: AGHT+IFhGn8GQbNIliwlcyoc0uXhzIf9xGtTlgEC8SXm2xIMuOB1Cx7deRobYWM2u5lLZqZEAiybJw==
X-Received: by 2002:a05:6602:3412:b0:790:fab3:2047 with SMTP id
 n18-20020a056602341200b00790fab32047mr6672563ioz.4.1697648786806; 
 Wed, 18 Oct 2023 10:06:26 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 n4-20020a5d8244000000b0079fa1a7cd36sm1228944ioo.30.2023.10.18.10.06.25
...
Date: Wed, 18 Oct 2023 11:05:54 -0600
Message-ID: <20231018170604.569042-15-jim.cromie@gmail.com>
...
Subject: [Intel-gfx] [PATCH v7c 14/24] dyndbg-API: fix
...
Cc: lb@semihalf.com, groeck@google.com, linux-doc@vger.kernel.org,
 ...
 rostedt@goodmis.org, Jim Cromie <jim.cromie@gmail.com>, mcgrof@kernel.org,
...
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -7320,7 +7320,7 @@ M:	Jim Cromie <jim.cromie@gmail.com>
 S:	Maintained
...
index fa307f93fa2e..afca34ca9da9 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
...
index 91c8b67fd8f8..c9517d403e06 100644

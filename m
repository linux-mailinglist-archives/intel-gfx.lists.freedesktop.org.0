...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A99814C426
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jan 2020 01:47:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8BDB6E184;
	Wed, 29 Jan 2020 00:47:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id 94ECE6E17C;
 Wed, 29 Jan 2020 00:47:30 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id 8673BA0088;
 Wed, 29 Jan 2020 00:47:30 +0000 (UTC)
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Chris Wilson" <chris@chris-wilson.co.uk>
Date: Wed, 29 Jan 2020 00:47:30 -0000
Message-ID: <158025885052.5463.17315321663903736711@emeril.freedesktop.org>
...
-------
  ...
  **SUCCESS**
  ...
  External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/index.html

Known issues
------------

  Here are the changes found in Patchwork_16303 that come from known issues:
...
#### Issues hit ####
  ...
  * igt@gem_exec_parallel@fds:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-byt-n2820/igt@gem_exec_parallel@fds.html
  ...
  * igt@i915_selftest@live_blt:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-ivb-3770/igt@i915_selftest@live_blt.html
...
#### Possible fixes ####
  ...
  * igt@gem_close_race@basic-threads:
   ...
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-hsw-peppy/igt@gem_close_race@basic-threads.html
  ...
  * igt@gem_exec_suspend@basic-s3:
   ...
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-icl-u2/igt@gem_exec_suspend@basic-s3.html
  ...
  * igt@gem_exec_suspend@basic-s4-devices:
   ...
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-icl-u2/igt@gem_exec_suspend@basic-s4-devices.html
  ...
  * igt@i915_selftest@live_gem_contexts:
   ...
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-icl-guc/igt@i915_selftest@live_gem_contexts.html

  
#### Warnings ####

  * igt@gem_close_race@basic-threads:
    - fi-byt-j1900:       [INCOMPLETE][13] ([i915#45]) -> [TIMEOUT][14] ([fdo#112271] / [i915#816])
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_7833/fi-byt-j1900/igt@gem_close_race@basic-threads.html
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-byt-j1900/igt@gem_close_race@basic-threads.html
  ...
  * igt@gem_exec_parallel@contexts:
   ...
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-byt-n2820/igt@gem_exec_parallel@contexts.html
  ...
  * igt@i915_pm_rpm@basic-rte:
   ...
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-kbl-guc/igt@i915_pm_rpm@basic-rte.html

  * igt@i915_selftest@live_blt:
    - fi-hsw-4770:        [DMESG-FAIL][19] ([i915#725]) -> [DMESG-FAIL][20] ([i915#553] / [i915#725])
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_7833/fi-hsw-4770/igt@i915_selftest@live_blt.html
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-hsw-4770/igt@i915_selftest@live_blt.html
  ...
  * igt@kms_chamelium@common-hpd-after-suspend:
   ...
   [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_16303/fi-icl-u2/igt@kms_chamelium@common-hpd-after-suspend.html
...
3b94abedd874 drm/i915/execlist: Mark up racy read of execlists->pending[0]

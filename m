...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7BA9F2DE914
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Dec 2020 19:45:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6810C898C0;
	Fri, 18 Dec 2020 18:45:31 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F3604898C0
 for <Intel-gfx@lists.freedesktop.org>; Fri, 18 Dec 2020 18:45:28 +0000 (UTC)
IronPort-SDR: bBSAA3Ap0WTWO8/9fg/F4Zi2iLcbqS9Rw/EPK5R1YwWZmr368+H8/EKVprQp5+nrP8eA40fyKB
 ZznAckYqqSqw==
X-IronPort-AV: E=McAfee;i="6000,8403,9839"; a="193894746"
X-IronPort-AV: E=Sophos;i="5.78,431,1599548400"; d="scan'208";a="193894746"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Dec 2020 10:45:20 -0800
IronPort-SDR: Fg6gEGdbH3KaJW5MleGG4D/L//dSz3TNQT5GmcI+oqNm/ToDyY4vQfdQ/LoGyKNIZcufR33Epq
 4TS52hOuQz9A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,431,1599548400"; d="scan'208";a="340645780"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga008.fm.intel.com with ESMTP; 18 Dec 2020 10:45:20 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Fri, 18 Dec 2020 10:45:08 -0800
Message-Id: <20201218184520.8697-2-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201218184520.8697-1-sean.z.huang@intel.com>
References: <20201218184520.8697-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v13 01/13] drm/i915/pxp: Introduce Intel PXP
 component

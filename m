...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF378B4452
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Sep 2019 00:56:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FE2B6EAA6;
	Mon, 16 Sep 2019 22:56:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EF70E6EAA6
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Sep 2019 22:56:45 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 16 Sep 2019 15:56:45 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,514,1559545200"; d="scan'208";a="337806379"
Received: from rmfosha-dev-1.fm.intel.com ([10.19.83.123])
 by orsmga004.jf.intel.com with ESMTP; 16 Sep 2019 15:56:45 -0700
From: "Robert M. Fosha" <robert.m.fosha@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 16 Sep 2019 15:50:18 -0700
Message-Id: <20190916225018.14566-1-robert.m.fosha@intel.com>
X-Mailer: git-send-email 2.21.0.5.gaeb582a983
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2] drm/i915/guc: Enable guc logging on guc log
 relay write
...
bS9pOTE1L2k5MTVfZGVidWdmcy5jCmluZGV4IDQzZGI1MDA5NTI1Ny4uM2Y4NmYyYjYwYjkyIDEw
MDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2RlYnVnZnMuYworKysgYi9kcml2
ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2RlYnVnZnMuYwpAQCAtMTg3MSw4ICsxODcxLDggQEAgc3Rh
...
dUMgbG9nIHJlbGF5IG5vdCBjcmVhdGVkXG4iKTsKIAkJcmV0dXJuOwogCX0KIApAQCAtMjA1OSw5
ICsyMDU5LDIzIEBAIGk5MTVfZ3VjX2xvZ19yZWxheV93cml0ZShzdHJ1Y3QgZmlsZSAqZmlscCwK

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8EFCEA789F3
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Apr 2025 10:32:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 10E8510E6F1;
	Wed,  2 Apr 2025 08:32:11 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aCbl1fyf";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2183310E6F1;
 Wed,  2 Apr 2025 08:32:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1743582731; x=1775118731;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=z/eAS5py7D4IhSq1OwwMlPnO/Q3L8ZTOM4DbUV3jTKM=;
 b=aCbl1fyfnwalDrhAke5xo8q+RNo0dcHQ6sG3mymfB58tl1IjEPhsErl9
 2h/cTMHROz+dnxOl/V911PCPJUCfm00zrF1gEfRcroFWgt1kvyPhnBcVP
 2QSgz3iHRpdPK9e8gEmIk6UbA99n8HOeSFajCm/gROvXXPumAE9znBNnU
 PooWkJ48UCVzIlIc6ClISO1yU5HDBwldtJQf5Axa90OthRI3uV7s9DjJ1
 peMsAQxiKaifUM1MvSSnOBfrwcbq8xFo0zZKuGx3wq4QAAEuro287P4Gu
 8RUf3nIyk4KY7DlITmLv3R5Pal6ImlMKDuL7nl7i38PEHBFvNlpPpwTl+ w==;
X-CSE-ConnectionGUID: je/VK8D8RYSc1Xrm+fy3/g==
X-CSE-MsgGUID: tR5PrWQ5SSKUFuF4di966A==
X-IronPort-AV: E=McAfee;i="6700,10204,11391"; a="44828668"
X-IronPort-AV: E=Sophos;i="6.14,295,1736841600"; d="scan'208";a="44828668"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2025 01:32:10 -0700
X-CSE-ConnectionGUID: 725RGRN/ReqcYcehaNMBIg==
X-CSE-MsgGUID: +ABR5pAST0GI5cCO+KVzSQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,295,1736841600"; d="scan'208";a="126612339"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa007.fm.intel.com with ESMTP; 02 Apr 2025 01:32:06 -0700
...
Subject: [PATCH 04/16] drm/i915/dpll: Rename intel_shared_dpll
Date: Wed,  2 Apr 2025 14:01:52 +0530
Message-Id: <20250402083204.1523470-5-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B49956A845
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Jul 2022 18:37:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 93B2A1128FD;
...
Subject: [Intel-gfx] [PATCH v9 10/11] drm/i915/selftest: wait for requests

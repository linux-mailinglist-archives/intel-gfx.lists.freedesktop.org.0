...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F19656F8480
	for <lists+intel-gfx@lfdr.de>; Fri,  5 May 2023 16:06:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7BB5810E60B;
	Fri,  5 May 2023 14:06:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 30D2010E60B
 for <intel-gfx@lists.freedesktop.org>; Fri,  5 May 2023 14:06:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683295564; x=1714831564;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=qXjK2CcTA35hKIAVE2Dr80h1DRvmy+0EjztzisNXqag=;
 b=DjNYU9hSoc9xqjOkdysLeLlDliniUc6fI0gFRc9ibr7e9IplyMlp5KL3
 eKcNLOrrD9Pk2CWPFXgcVkvJmo84mNAaWPzYMkTdnxuL6u/Ss+bUv7KXt
 INQ0RdemLPB8x1837F0dQnzS7/l0Sx9MWl7C534aSXhJB/eYoyXt5Pjud
 d+LmejR4suNCFAl8D371nJH7x5ZGO143smb95/gu2hi1jE4XvtN33kaOt
 dkhh3p6pFRX2GkGNbOepUj3pi9RsA2CQqL4KvDo9fAZRtsQvUtxX4O/u7
 td1aRyHV9tgOKrzjR4OUWzQN0f7IiQ5EZSebXKLj3nCZ65J1lBwdwSWs8 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10701"; a="329570343"
X-IronPort-AV: E=Sophos;i="5.99,252,1677571200"; d="scan'208";a="329570343"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2023 07:06:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10701"; a="647876677"
X-IronPort-AV: E=Sophos;i="5.99,252,1677571200"; d="scan'208";a="647876677"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2023 07:06:02 -0700
Date: Fri, 5 May 2023 17:05:55 +0300
From: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <ZFUNQ8bauuRmMnVh@intel.com>
References: <ZFTrZEUKcuyPmlh4@intel.com> <ZFTx3esk/Jlcnpjj@intel.com>
...
In-Reply-To: <ZFULYgF1jBv4dTjq@intel.com>

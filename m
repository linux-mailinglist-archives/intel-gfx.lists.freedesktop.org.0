...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59A644B91E2
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Feb 2022 20:56:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60044892BC;
	Wed, 16 Feb 2022 19:56:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3CBA08966C
 for <intel-gfx@lists.freedesktop.org>; Wed, 16 Feb 2022 19:56:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645041362; x=1676577362;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=NFyNtQKWDp3IIFDAVEo3H6lES2jCE7CpykVW6rQ2YFg=;
 b=QFuPSbGmtdGkC6jQP+tRhq6rl/ambqyLUnQptmod/z/YM6MQCYGsb3FW
 mpeNBc+MtrX7277qL8AZEjEy7L2eAvhqZ3Raj5CLNjdnJ1Vp5RF6IXTcI
 mZ1nTGka5xqph6Mkw7zF1NNSBpcfSqi87+AQbp7zVNCSaUI9wqNRkp0tO
 cxWw4yd1pRqjTsSerQaT2V+DI+2S54yKTc4DIcsfARgQAXr7s76c6EYKa
 Oz6c4UfsqLZUfejgZoI9f/TairBPIxVONdPP+yR0JUZDlrQH8nTvm+bGx
 QRWSitnoQaR6ZFlIh9DkkkEMfVwA+gl2jUBEZSl3VYnDbWnxbtNpusmsu A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10260"; a="249544657"
X-IronPort-AV: E=Sophos;i="5.88,374,1635231600"; d="scan'208";a="249544657"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Feb 2022 11:55:45 -0800
X-IronPort-AV: E=Sophos;i="5.88,374,1635231600"; d="scan'208";a="545140497"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Feb 2022 11:55:41 -0800
...
Subject: [Intel-gfx] [PATCH v8 5/5] mei: gsc: retrieve the firmware version

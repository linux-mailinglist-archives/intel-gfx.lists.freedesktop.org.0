...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 94E025FF689
	for <lists+intel-gfx@lfdr.de>; Sat, 15 Oct 2022 01:04:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AE2610E16B;
	Fri, 14 Oct 2022 23:03:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CEA7910E13F;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=FD2jnQjfI6Sl9rfEr7qs0HwCbiBLF231KFHNNSStBEk=;
 b=l0s5TmZzThi3WncL6NyAPlJ3UebFgsVwiRFf9mKiWQq3v1VzIpvQHvnD
 CWb+iDQNyBZPkx7gZ208gJnjEK62K1f5GH1WnFFW7vim57V9QcDJ9mQ+O
 A7J9+q2hVgKBO/mPIuBjmEOnflzcTTBMO81AhfK8mkTZo1GH4bhrnEyHG
 9qUqEjdF0N1UtGIJgl6CNIytmTt1l1qNqhEVed+5DwJtTrrYesyBHaVr5
 inyzVIXf9VMcc7UM+ADTQQKIWq7GMlvVRxuK0UEZ4x1u1oK8wRO0YsB/B
 xiOptk6bv1/l5BtEMD+KZukdLN13cJw/G171WL/KVM2/U/cwUph11PTK+ g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10500"; a="285216974"
X-IronPort-AV: E=Sophos;i="5.95,185,1661842800"; d="scan'208";a="285216974"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2022 16:03:03 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10500"; a="696471722"
X-IronPort-AV: E=Sophos;i="5.95,185,1661842800"; d="scan'208";a="696471722"
...
Message-Id: <20221014230239.1023689-12-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 11/14] drm/i915/gt: Add MCR-specific

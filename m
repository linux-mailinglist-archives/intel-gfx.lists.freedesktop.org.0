...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F270620FB3
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Nov 2022 13:01:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D13610E403;
	Tue,  8 Nov 2022 12:01:54 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A7D9E10E27B;
 Tue,  8 Nov 2022 12:01:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667908909; x=1699444909;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=X5La+J/sd0reAoZ6UeRqI51PA5iJPgpEV7jI2fyTqfI=;
 b=QTPG+KyDIUzGMI9ZtcPX5JagtGHm0LecOe2btNI0FNOf78/Wwa05F+kF
 W2NRK7Tb/XHqUjyXkmAL2Z+Hd6Vj0plDK2gwWvdifX14YnJAn1uS622PL
 ajFi7+ZyNOfpk63N9JuVJBq9Kw3DAwaygopLzAdt4z4CPf1+RvdnnjaS8
 pPRlbPBtkUyJRlkJwoYwgnQsjwyQ41JoYC71Sd1nXZsuMUSak3Kbpy7ac
 YC00PBhMkMa9dn6GyuEIao7/OV7E8I5uiO64u+3VfYZaMqOiHELhUrSnR
 TvFeE944mPv+18BJSZJxUcLZP9oygecxhPKfR+ZHCIh9SKwyFfXY6tSmp w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="396971555"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="396971555"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Nov 2022 04:01:49 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="630850060"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="630850060"
Received: from smoriord-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.16.110])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Nov 2022 04:01:46 -0800
...
Date: Tue, 08 Nov 2022 14:01:44 +0200
Message-ID: <87r0yd8xjr.fsf@intel.com>
MIME-Version: 1.0

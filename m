...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1CC5B63362E
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Nov 2022 08:47:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E677D10E38C;
	Tue, 22 Nov 2022 07:47:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4160810E38C
 for <intel-gfx@lists.freedesktop.org>; Tue, 22 Nov 2022 07:46:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669103164; x=1700639164;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/gFI1DCU9aIY60KAwbAuLEzGI/a9jg2/9psupgc4a5M=;
 b=hmfk79CT1g0UvyAfoGgYWxQ5qKV7Bl+021PL2EBoyT712uk9grDZ29Sj
 FDHI8FjlLqlm6kVrBkLva4o0RjJUiDyohrPb+mqTHmGQ3u7/+NThNZmgg
 Hp4AnwBQBLxyTADrIjfqb28f4tzNjfB09SazOJ4tEs3o6SZ05fEAFnnKC
 vs2ogrHcKtWrbt5LNnDWeaKzyjIufZAxk6v46QW5wfLvDAZUhHfikC6XV
 cwwtbDtTAAS2/axHJxH/6jcH2v3QW6tVFDgykS8uE+7EcFCZlYeHoQnmW
 ImZZsID0Dpg04iKr2+atu/AzYwYK3voSWOL3Q16lddLLTJEpqkykq45Rp Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10538"; a="378015374"
X-IronPort-AV: E=Sophos;i="5.96,183,1665471600"; d="scan'208";a="378015374"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Nov 2022 23:46:04 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10538"; a="783756314"
X-IronPort-AV: E=Sophos;i="5.96,183,1665471600"; d="scan'208";a="783756314"
Received: from srr4-3-linux-103-aknautiy.iind.intel.com ([10.223.34.160])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Nov 2022 23:46:02 -0800
From: Ankit Nautiyal <ankit.k.nautiyal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 22 Nov 2022 13:16:39 +0530
Message-Id: <20221122074644.2969553-6-ankit.k.nautiyal@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 05/10] drm/i915/display: Use sink_format
...
index 44227a1a4676..dc9b1bf44967 100644

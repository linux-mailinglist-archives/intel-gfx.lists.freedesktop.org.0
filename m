...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF1BD5ED4B2
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Sep 2022 08:21:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89E6B10E29A;
	Wed, 28 Sep 2022 06:20:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 25CFA10E275;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=P+0CXDDhJACihqT8ZpoPx+69jR4jOhtPeoq4tUOHbQI=;
 ...
 8MpwFeOw+Q5kEaRwfzE9TCS9ELCWpv3lDXyefbUvGMH73JxqXHeyXPvwU
 NwaYNPLxesQjPCaFQ3qDLhS0JrbKlOnHFAZV7yUke10hWQs4YlLWG6FN4 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10483"; a="299115512"
X-IronPort-AV: E=Sophos;i="5.93,351,1654585200"; d="scan'208";a="299115512"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Sep 2022 23:19:47 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10483"; a="866849208"
X-IronPort-AV: E=Sophos;i="5.93,351,1654585200"; d="scan'208";a="866849208"
...
Date: Tue, 27 Sep 2022 23:19:13 -0700
Message-Id: <20220928061918.6340-12-niranjana.vishwanathapura@intel.com>
X-Mailer: git-send-email 2.21.0.rc0.32.g243a4c7e27
In-Reply-To: <20220928061918.6340-1-niranjana.vishwanathapura@intel.com>
References: <20220928061918.6340-1-niranjana.vishwanathapura@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 11/16] drm/i915/vm_bind: Use common execbuf
...
index 33d989a20227..2b935d6ae1ee 100644
...
@@ -2949,65 +2706,6 @@ static int add_fence_array(struct i915_execbuffer *eb)
 	return 0;
 }
...
-
 ...
 {
@@ -3020,80 +2718,6 @@ parse_timeline_fences(struct i915_user_extension __user *ext, void *data)
...
@@ -3120,73 +2744,26 @@ parse_execbuf2_extensions(struct drm_i915_gem_execbuffer2 *args,
 				    eb);
 }
...
@@ -3218,7 +2795,7 @@ eb_fences_add(struct i915_execbuffer *eb, struct i915_request *rq,
 	}
...
@@ -3236,23 +2813,6 @@ eb_fences_add(struct i915_execbuffer *eb, struct i915_request *rq,
 	return out_fence;
 }
...
-
 ...
 eb_requests_create(struct i915_execbuffer *eb, struct dma_fence *in_fence,
 		   int out_fence_fd)
@@ -3262,7 +2822,9 @@ eb_requests_create(struct i915_execbuffer *eb, struct dma_fence *in_fence,
...
+								 i));
 		if (IS_ERR(eb->requests[i])) {
 			...
 			eb->requests[i] = NULL;
@@ -3442,13 +3004,15 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	err = eb_submit(&eb);
...
+					   &eb.requests[0]->fence);
 	...
 	if (out_fence) {
 		if (err == 0) {
@@ -3471,7 +3035,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -3492,7 +3056,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 err_in_fence:

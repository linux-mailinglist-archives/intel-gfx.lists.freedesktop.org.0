...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9725614256A
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2020 09:25:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC2576E844;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 21/22] drm: Clean-up VBLANK-related callbacks

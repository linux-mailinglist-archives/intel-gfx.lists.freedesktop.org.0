...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 967CAB84EAA
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Sep 2025 15:53:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 132A710E8C5;
	Thu, 18 Sep 2025 13:53:30 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="TWuKfEel";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 39D2210E1CF;
 Thu, 18 Sep 2025 13:53:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1758203609; x=1789739609; h=date:from:to:subject:message-id:
 content-transfer-encoding:mime-version;
 bh=3Vo9oK2ouAGZ+fiKkMGqTAsbExffsOVS+uqgUZT4eyQ=;
 b=TWuKfEel64vAjll/5qPmA3HS5sYlmANlDAPkSt/NLCtCiWtwY+ogkk7O
 GtA1sSLpX3j2zHewSKIMtyz8JRY+KoCwYtNBNqV7CS/YV8pnVHKQ+f/PX
 hckYFvA5S4C05iExRKhFZ7K2Vaq5gnUCVUo1hTXVgLm6LfjEIZejiUXDo
 UWVcartAHQxMdxcvkzRKny3D98sGXnOh2W3sX/9Fvx3e17emXRRIoorla
 Z/aboz8FfJp+VyuAxWO5Oop2kPjyUeMEJDQ30WA2SftewcJDKMwPPqSMJ
 9WzIA2AShEt6zFefVhW49ulqj7k7ULMAQiCNsVMpSgYagKhFWXumKX7Z2 w==;
X-CSE-ConnectionGUID: Lr1ripbvQ9mH3PubsCG7kA==
X-CSE-MsgGUID: t2gnUjbvRUeU8zew46M5tQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11557"; a="71959887"
X-IronPort-AV: E=Sophos;i="6.18,275,1751266800"; d="scan'208";a="71959887"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2025 06:53:27 -0700
X-CSE-ConnectionGUID: UzWXZVsGQdCe6xoh+WkmTw==
X-CSE-MsgGUID: ZktnMgceT1WjYtuwQCcXFQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,275,1751266800"; d="scan'208";a="175147463"
Received: from orsmsx902.amr.corp.intel.com ([10.22.229.24])
 by fmviesa007.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Sep 2025 06:53:24 -0700
Received: from ORSMSX903.amr.corp.intel.com (10.22.229.25) by
 ORSMSX902.amr.corp.intel.com (10.22.229.24) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17; Thu, 18 Sep 2025 06:53:23 -0700
Received: from ORSEDG903.ED.cps.intel.com (10.7.248.13) by
 ORSMSX903.amr.corp.intel.com (10.22.229.25) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17 via Frontend Transport; Thu, 18 Sep 2025 06:53:23 -0700
Received: from CH4PR04CU002.outbound.protection.outlook.com (40.107.201.28) by
 edgegateway.intel.com (134.134.137.113) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.17; Thu, 18 Sep 2025 06:53:20 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=/qRhGknb5ri4UwXrDm2Hycb0+dDo4v+rj0kKYKMNYBQ=;
 b=
...
Received: from CYYPR11MB8430.namprd11.prod.outlook.com
 ...
 13:53:13 +0000
Date: Thu, 18 Sep 2025 09:53:09 -0400
From: Rodrigo Vivi <rodrigo.vivi@intel.com>
To: Dave Airlie <airlied@gmail.com>, Simona Vetter <simona.vetter@ffwll.ch>,
 <dri-devel@lists.freedesktop.org>, <intel-gfx@lists.freedesktop.org>,
 <intel-xe@lists.freedesktop.org>, <dim-tools@lists.freedesktop.org>
Subject: [PULL] drm-intel-next
Message-ID: <aMwOxf_Elv7UE1yW@intel.com>
Content-Type: text/plain; charset="iso-8859-1"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
X-ClientProxiedBy: BY5PR17CA0017.namprd17.prod.outlook.com
 (2603:10b6:a03:1b8::30) To CYYPR11MB8430.namprd11.prod.outlook.com
 (2603:10b6:930:c6::19)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: CYYPR11MB8430:EE_|CH0PR11MB5297:EE_
X-MS-Office365-Filtering-Correlation-Id: b84949eb-1420-4359-68d9-08ddf6bab597
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230040|1800799024|366016|376014;
X-Microsoft-Antispam-Message-Info: =?iso-8859-1?Q?HDUDxLVD9CD3Njr+beeCYZbd2omAGTmKBEQDXnQZCW8h/QQsVfa43VUrxQ?=
 =?iso-8859-1?Q?ogYkQEpZX4SuMHi4XJpMlpxrJmG0cORAPh7AtQlDt0oFSz6zn3V/i087cb?=
 =?iso-8859-1?Q?zJ3Nvapgwn3QpPeucmowwVoF7RR2UgJFTqX6Xt5BADNiVTvL9o/BTS+/mb?=
 =?iso-8859-1?Q?AOR37SQzCKn4bD1yzaISv+aiKLVMOru1tMotn3QxDL24sApMHQr8kEItcY?=
 =?iso-8859-1?Q?lWY12jz0EzNfEpWvNd8ACDbuHoFgiPBXHhWAUuAnDJYv7Ffw7hb8ohqw3t?=
 =?iso-8859-1?Q?YY8O1WrF7MrZTU1ZTEdXrXOjZVXL3xfE/EqlnFYftNqK7TcJyW87jIax24?=
 =?iso-8859-1?Q?WJ5G7nMtyaoVEJLQMKCneRfsbQ7VH0XAcw/ibKxB2QvXq5n/q0ahg0PBIe?=
 =?iso-8859-1?Q?cgdIdDtIn3d6cRRYsgTudlMM9OuWjKoIFV6rRbwJuhZGT31BCFyPq2yALO?=
 =?iso-8859-1?Q?0hYpT11gvfbZYnVbp+MbIdByIntSV4yzV/Qna2P+5VUDOUDErrVJgCk/4L?=
 =?iso-8859-1?Q?pC3daGGFMnYMOwv2JHESpLINywlc9/blZ0NNjLzcZgth82GiU9wSw0g2Fl?=
 =?iso-8859-1?Q?J3feha2QnRKywQHD6n8jtAm3ZGu4wMVCx4uDUEcDfP1AUwqtaOys/NeAqc?=
 =?iso-8859-1?Q?vYZ0WKGTsusYV6RmAK6MRxx4zL+viBEPK1exG1gysIV4FDbRlkGS9YMzKP?=
 =?iso-8859-1?Q?jquCGKo3PPfPT0wB4ENfpy3s/EnN/5DgcLKCayACRUozcFs8D12xs3IEn2?=
 =?iso-8859-1?Q?PrzuWHscVgPYaQ0Vs6ecMB7OZeJcnPu+aJz9BQKI3zgPZr5oZRYD3rHPT6?=
 =?iso-8859-1?Q?Z5IiZY/LZl1KROxtRjrcisO/rB9N+9sQ1GeYQcYlc1VmDOtF+kc6OIHbFQ?=
 =?iso-8859-1?Q?5yVXvh4pk9aZw1g+E8lM2Ot8pLQfdQZ91YVb14GNG5uSiA8Xyd+WwyViBY?=
 =?iso-8859-1?Q?KpcxbWdEk+axw0j4fv2ZqqirBLkUOFytyolSaBf2tsj4ly9o426wCRn9pp?=
 =?iso-8859-1?Q?zJsa62s4ZOKmv1AdhzozkoeqmxCSeF7r0COXN9Q7pRgMCEHMLom4nu3m4P?=
 =?iso-8859-1?Q?qGQumo4jnz68+6PNa75/85py4kA0v3pOKHC8Ous14OE9KN7UZNNhK41MXj?=
 =?iso-8859-1?Q?RnOtWqPhQQFEFmjlEL6Oo8xZdME8bk9bEwrEohMccQRnL3s3OClAp75EIP?=
 =?iso-8859-1?Q?28xsmAOVVpFqLq0DWcwdHtnH1jGrW9r/PiRrSACX6H+Z3yjnFTQGReKuL7?=
 =?iso-8859-1?Q?h37rKSYJ7AIf0uYFMNdZIbQb/eLymCcwT9NcyoVa88ob8Q/tYL8/Fr6gS8?=
 =?iso-8859-1?Q?LIrtBPleIIk8M02afBA5ffiTeF6tA3yRcc0JRZcJXDHehhnUL8/diP3HjV?=
 =?iso-8859-1?Q?uNf3gTJY84D6Km68LHycYY5fTLuRdqfL/VXEKXABR5RC8vWKh65N4=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:CYYPR11MB8430.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(1800799024)(366016)(376014); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?G8oVF6kf6ZIhGhPEWUZCR7l9cKRbnMwm2plvyulPdkqmxN4x2ft6XqQk7D?=
 =?iso-8859-1?Q?+EAxVqzmaVuoji59T/wp6y3p0gsAC9/ltlT7Lor3UNyrug+nrfBMMA7WAV?=
 =?iso-8859-1?Q?Z5CliakxU+8XO8bYvyqH0Mn6gMINyWaEOlf9mIuDVLD1XzCx0B9UkJHTSV?=
 =?iso-8859-1?Q?+P50sXVIb6odhe983q0yqsg3fUb/JrP6IF5JmwQkKRtREt1EQremwgKMz3?=
 =?iso-8859-1?Q?gmSjx0YL0oMtoGWbfolRmz1BCVup3vYSDq2qMJ4CX/FHMMGuYxdrsl/S6W?=
 =?iso-8859-1?Q?Uxf8XsAOL+z9ROeCOo634y5RQKgnoaVu8s7Er6fB2dOWgkUlNioyL7PTyi?=
 =?iso-8859-1?Q?bSllCw1jhtmxpXUmQCxC6npF4n0uETceoRQrfrNJEJ+H/FQcjcBYqHZebY?=
 =?iso-8859-1?Q?ldVYi7a5UVK3Q7ySVpJAAT8p+gYOSdLhaBDETlwv05fjbhrdfTfqpVaGgp?=
 =?iso-8859-1?Q?UVubsXnCZ5zt/KOPnr3tuQ4pbJYeWrcKWFNV2Vqleur+ut05NGt5IUrrsG?=
 =?iso-8859-1?Q?Tb//w/a6pIOLG8SHwCfCCkfhPPvTUivtbXrkOElXylDFqoiBS1VrvQwCCi?=
 =?iso-8859-1?Q?NrdJal3xcE9Qb7PewPbw7qQ/oqBNsVdDi6Jatqf5yTvB5ulXvbcF1RvLX8?=
 =?iso-8859-1?Q?cFDkVIA8qUoZf+BThW77WCfrwWtlTXmXcfNRtsxBg/+bVESRYBiRNbULDP?=
 =?iso-8859-1?Q?x5tJsnIygS/iyL+F6Tu5nInFKCPS36pz1jrtYyjzddH14gelhC3rWgSxR/?=
 =?iso-8859-1?Q?ZPdAl7X8ywCptMzFkwvXPWb0yKZm8ZL55l765ILWCGWRKVJv+OPEnQzAG5?=
 =?iso-8859-1?Q?4KABhCdjYmsul65DdTIci8CnIsWTTK1sijtdkEBOgEjvD8RuvMlRRqjTNP?=
 =?iso-8859-1?Q?no99noWYZ/JHfxUDnBI2kT56N2R9ZgtSnH9ciIyv77RKxD0qlR8KxuJIa5?=
 =?iso-8859-1?Q?WDap/WgWdKUneQkBjdn1rVAe5Otmfs/YwDQJOz8rHqUATqRE7BEr9HU5VH?=
 =?iso-8859-1?Q?ywFMgtPXTYfemRbPu1xfLlXTRFcCkVSSRTnQMSOOsFg6ydms6djU3wLGuv?=
 =?iso-8859-1?Q?meVUeJDTPYhGoW488lZ5uCyBOPfJH/NgQ5gY/5iEZ8SBUCxcbldDezTDxd?=
 =?iso-8859-1?Q?s6uWG3espixCYC1LcfAEDAT7CNFC8kRW67C1/tpSyGah6Wq2qFKPiEG8E7?=
 =?iso-8859-1?Q?r5DBkY2wZDxrntK3TpLIyCCoAvy4LT8+6dEyoty3t7Zrxm8KtTcnnr0Rma?=
 =?iso-8859-1?Q?fEbnhFGY4XE5MfJiVVi3vlZ6ccPD539y5v0a5kU8TiRuR5O2FERveJnNJh?=
 =?iso-8859-1?Q?kHXCtPD+WOMs6gJcIiaCj9qRFrQIDxjJf3/7cc58GXOLW3u+ajSq6QxZzT?=
 =?iso-8859-1?Q?b67gvYPomRYT1xqZfW5wYQEtQ38WBrx7c4FPV7jMiZNOXkke1zq1c4C7PQ?=
 =?iso-8859-1?Q?BCiJuisdxW26u3XoeuegpgycwSphaDDg1b1C3sExQFbvkzbKE586m2ootK?=
 =?iso-8859-1?Q?eMkeHrwr51VGxHafexSn7qVK/Q/xy1UlLicHhB8Ue1kSWq+bdYgnYKFhw2?=
 =?iso-8859-1?Q?hn7Qrc6KMWMUVC8NRGay7w2/5lWXFUjxvcg8Fulhv2YWDUsrSRoBRDCqSp?=
 =?iso-8859-1?Q?e3B8l4UGjr98OpTltKgfQ54agyUy7UYkXR+ZQ9z86SVgvRAzf3IRA3ow?=
 =?iso-8859-1?Q?=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: b84949eb-1420-4359-68d9-08ddf6bab597
X-MS-Exchange-CrossTenant-AuthSource: CYYPR11MB8430.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Sep 2025 13:53:13.4690 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: yTJTAOzlCbyfG5sqczQDfhwg3wbf7LfWPorL7zLhc8Tc3hy3gFY0wBA7Q0UhbriF4uF61BS3sdkB/NYiS/oh9w==

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B32D4B48D1
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Feb 2022 11:01:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5DFD110E2F8;
...
Subject: [Intel-gfx] [RFC v2 3/5] drm/hdmi21: Add helpers to verify non-dsc
 DFM requirements

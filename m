...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0341E129093
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Dec 2019 02:07:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59D106E12D;
	Mon, 23 Dec 2019 01:07:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 380F86E12E
 for <intel-gfx@lists.freedesktop.org>; Mon, 23 Dec 2019 01:07:17 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 22 Dec 2019 17:07:16 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,345,1571727600"; d="scan'208";a="219359030"
Received: from dtbingha-mobl.amr.corp.intel.com (HELO
 josouza-MOBL.amr.corp.intel.com) ([10.252.135.10])
 by orsmga003.jf.intel.com with ESMTP; 22 Dec 2019 17:07:13 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 22 Dec 2019 17:06:52 -0800
Message-Id: <20191223010654.67037-5-jose.souza@intel.com>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20191223010654.67037-1-jose.souza@intel.com>
References: <20191223010654.67037-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 rebased 5/7] drm/i915/display: Prepare for
 fastset external dependencies check
...
ZGlzcGxheS9pbnRlbF9kaXNwbGF5LmMKaW5kZXggYTVkNmQzYTY5MzU1Li4zYzVjZjI2MjMxODIg

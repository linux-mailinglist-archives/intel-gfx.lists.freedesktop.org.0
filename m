...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 14F623A5F7E
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Jun 2021 11:53:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C23B789DAB;
	Mon, 14 Jun 2021 09:53:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2A7C389D8A;
 Mon, 14 Jun 2021 09:53:13 +0000 (UTC)
IronPort-SDR: KuOtn4k0qG26i5n02hS4LYGtiEBIVgxMBea0juwyl0d9yxpjEMhd1yABkDsaKiCzzj02lVxDT+
 5/+L/+Z0getg==
X-IronPort-AV: E=McAfee;i="6200,9189,10014"; a="269634179"
X-IronPort-AV: E=Sophos;i="5.83,273,1616482800"; d="scan'208";a="269634179"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2021 02:53:12 -0700
IronPort-SDR: 4GlsQrpewAO6hJZuKVitF1LLCaRJ/W5CcxYg/nH7cXiudHwc8F1jd67mWBFrhtiiY442zrDkMZ
 XHhM3L41o/1w==
X-IronPort-AV: E=Sophos;i="5.83,273,1616482800"; d="scan'208";a="449839027"
Received: from janlundk-mobl1.ger.corp.intel.com (HELO
 thellst-mobl1.intel.com) ([10.249.254.32])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2021 02:53:11 -0700
From: =?UTF-8?q?Thomas=20Hellstr=C3=B6m?= <thomas.hellstrom@linux.intel.com>
To: intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Mon, 14 Jun 2021 11:52:30 +0200
Message-Id: <20210614095230.126284-5-thomas.hellstrom@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 4/4] drm/i915/ttm: Use TTM for system memory
...


...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A08B64AB4A
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Dec 2022 00:16:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6AAF10E2B5;
...
Subject: [Intel-gfx] [PATCH v9 10/23] drm/i915/vm_bind: Add out fence support

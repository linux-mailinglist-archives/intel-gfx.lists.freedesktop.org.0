...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 54763AADA6
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Sep 2019 23:12:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82B5B6E069;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2.1] drm/connector: Allow max possible encoders

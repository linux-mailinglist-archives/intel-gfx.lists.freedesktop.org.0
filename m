...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 80E3C4B221D
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Feb 2022 10:37:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C306110EA54;
	Fri, 11 Feb 2022 09:37:40 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 11/15] drm/i915/selftests: handle
 allocation failures

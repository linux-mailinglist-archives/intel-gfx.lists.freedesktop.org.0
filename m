...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0A4198D3BF
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Oct 2024 14:55:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA45810E348;
	Wed,  2 Oct 2024 12:55:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SyTgv2BX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C54EC10E335;
 Wed,  2 Oct 2024 12:55:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1727873703; x=1759409703;
 h=message-id:subject:from:to:cc:date:in-reply-to:
 references:content-transfer-encoding:mime-version;
 bh=84h9mnKHSL53Sb7MEowMtOXI4WItEz3r5PhXuXM9IVo=;
 b=SyTgv2BX49kpZl1aQEyIuLoxKWXh/Ny7ka6/BLLGqbdwNDtIl7RvbPwx
 di0pPWRu40o4b5vbxA/CLHvuk2erbc8k8IkWER2x8eUi68iRvEXp2GKSj
 LPxOxZEYiU/DaIoIeXz2DZwBSKfuZn/hBfk+2gg/QuO1yBdq+TxB7BHhq
 cy8ID0gSFbOaqUMVV0BKh2u9BJfC4yb+9zFdgoe1zoaN5B/4mWoaCPTcg
 mbUE9LH+3TimD9+is/gOV+3/yE1+0kOTdHUKPmboiDz5f9g2JWj+zYlpF
 YSTVV1rIpOCuaEkegtqrUXLl3dH+kTr5PRL6blo29gH3rec5gn//fbm7K g==;
X-CSE-ConnectionGUID: sczyVkhuSdqvnxGUDjysVg==
X-CSE-MsgGUID: OiXNOY2GRTKaqCuoljtqkA==
X-IronPort-AV: E=McAfee;i="6700,10204,11213"; a="26909351"
X-IronPort-AV: E=Sophos;i="6.11,171,1725346800"; d="scan'208";a="26909351"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Oct 2024 05:55:02 -0700
X-CSE-ConnectionGUID: B/+uGZjaRaWXx/I3aJxL7w==
X-CSE-MsgGUID: X1bkdhCWQMuSWN4B1pxXJQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,171,1725346800"; d="scan'208";a="78410846"
Received: from oandoniu-mobl3.ger.corp.intel.com (HELO [10.245.244.67])
 ([10.245.244.67])
 by fmviesa005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Oct 2024 05:54:59 -0700
Message-ID: <761343773c9e1f5f0cc348a1ec953fb3194194e1.camel@linux.intel.com>
...
Date: Wed, 02 Oct 2024 14:54:56 +0200
In-Reply-To: <6c0387d0-1979-48ae-b9ff-49e00a459438@amd.com>
...
> >=20
> > Instead use a struct with multiple single-bit flags. This addresses
> > both
...
> > checking.
>=20
> Ok, that style is new to me. I've mostly seen defined parameter flags
> in=20
> the kernel.
>=20
...
I've used the same style in some of the shrinker series patches, since
using multiple bools in the prototype severely reduces readability and
...
>=20
> >=20
> > This is in preparation of adding yet another bool flag parameter to
> > the
> > function.
> >=20
...
=C2=A0=C2=A0 |=C2=A0 6 ++++--
> > =C2=A0 drivers/gpu/drm/drm_gem_vram_helper.c=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0 |=C2=A0 7 ++++---
> > =C2=A0 drivers/gpu/drm/i915/intel_region_ttm.c=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 |=C2=A0 3 ++-
> > =C2=A0 drivers/gpu/drm/loongson/lsdc_ttm.c=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 |=C2=A0 5 ++++-
> > =C2=A0 drivers/gpu/drm/nouveau/nouveau_ttm.c=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0 |=C2=A0 7 +++++--
...
> > =C2=A0 drivers/gpu/drm/ttm/tests/ttm_bo_test.c=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 | 16 +++++++-------
> > -
...
> > *adev)
> > =C2=A0=C2=A0	r =3D ttm_device_init(&adev->mman.bdev, &amdgpu_bo_driver,
> > adev->dev,
...
> > -			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 dma_addressing_limited(adev->d=
ev));
> > +			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 (struct ttm_device_init_flags)=
{
...
> > +++ b/drivers/gpu/drm/drm_gem_vram_helper.c
> > @@ -931,9 +931,10 @@ static int drm_vram_mm_init(struct drm_vram_mm
...
> > =C2=A0=20
> > =C2=A0=C2=A0	return ttm_device_init(&dev_priv->bdev, i915_ttm_driver(),
> > =C2=A0=C2=A0			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 drm->dev, drm->anon=
_inode-
> > >i_mapping,
...
> > =C2=A0=20
> > =C2=A0=C2=A0	ret =3D ttm_device_init(&ldev->bdev, &lsdc_bo_driver, ddev=
-
> > >dev,
> > =C2=A0=C2=A0			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ddev->anon_inode->i_mappi=
ng,
...
> > =C2=A0=C2=A0	ret =3D ttm_device_init(&drm->ttm.bdev, &nouveau_bo_driver=
,
> > drm->dev->dev,
...
> > +				=C2=A0 (struct ttm_device_init_flags){
...
> > *rdev)
> > =C2=A0=C2=A0	r =3D ttm_device_init(&rdev->mman.bdev, &radeon_bo_driver,
> > rdev->dev,
...
> > =C2=A0=C2=A0	priv->ttm_dev =3D ttm_dev;
> > =C2=A0=20
> > @@ -437,7 +437,7 @@ static void ttm_bo_put_shared_resv(struct kunit
> > *test)
> > =C2=A0=C2=A0	ttm_dev =3D kunit_kzalloc(test, sizeof(*ttm_dev),
> > GFP_KERNEL);
> > =C2=A0=C2=A0	KUNIT_ASSERT_NOT_NULL(test, ttm_dev);
...
> > =C2=A0=C2=A0	KUNIT_ASSERT_EQ(test, err, 0);
> > =C2=A0=20
> > =C2=A0=C2=A0	KUNIT_EXPECT_PTR_EQ(test, ttm_dev->funcs, &ttm_dev_funcs);
> > @@ -55,7 +55,8 @@ static void ttm_device_init_multiple(struct kunit
> > *test)
...
> > =C2=A0=C2=A0		KUNIT_ASSERT_EQ(test, err, 0);
> > =C2=A0=20
> > =C2=A0=C2=A0		KUNIT_EXPECT_PTR_EQ(test, ttm_devs[i].dev_mapping,
...
> > @@ -162,9 +163,10 @@ static void ttm_device_init_pools(struct kunit
> > *test)
> > =C2=A0=C2=A0	ttm_dev =3D kunit_kzalloc(test, sizeof(*ttm_dev),
> > GFP_KERNEL);
> > =C2=A0=C2=A0	KUNIT_ASSERT_NOT_NULL(test, ttm_dev);
...
> > =C2=A0=C2=A0			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 drm->anon_inode->i_mappin=
g,
...
> > =C2=A0=C2=A0 * @dev: The core kernel device pointer for DMA mappings an=
d
> > allocations.
...
> > ttm_device_funcs *funcs,
> > =C2=A0=C2=A0		=C2=A0=C2=A0=C2=A0 struct device *dev, struct address_spa=
ce
> > *mapping,
> > =C2=A0=C2=A0		=C2=A0=C2=A0=C2=A0 struct drm_vma_offset_manager *vma_man=
ager,
...
> > use_dma32);
> > +	ttm_pool_init(&bdev->pool, dev, nid, flags.use_dma_alloc,
> > flags.use_dma32);
> > =C2=A0=20
...
> > +++ b/drivers/gpu/drm/vmwgfx/vmwgfx_drv.c
> > @@ -1049,8 +1049,8 @@ static int vmw_driver_load(struct vmw_private
> > *dev_priv, u32 pci_id)
> > =C2=A0=C2=A0			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 dev_priv->drm.dev,
> > =C2=A0=C2=A0			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 dev_priv->drm.anon_inode-=
>i_mapping,
> > =C2=A0=C2=A0			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 dev_priv->drm.vma_offset_=
manager,
...
> > >drm.dev,
> > =C2=A0=C2=A0			=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 xe->drm.anon_inode->i_map=
ping,

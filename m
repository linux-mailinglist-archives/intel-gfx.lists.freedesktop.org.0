...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 034E25EF3AF
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 12:49:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB1C310E5A0;
	Thu, 29 Sep 2022 10:49:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4320310E59D;
 Thu, 29 Sep 2022 10:49:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664448576; x=1695984576;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=aoIDZYCxDbFAE58/fAqR+NC4FTzjmuwNq8sQw2whJ0w=;
 b=Eomhy+03hNL6cok7HVpNQYt9um65d5EsvGJGHA0iikxTnhlHydbxB0s+
 WkkKKAX3JLYY0X+fR51Xbe2VEYbmP2MqUKl5pTKAlOQfdeHYauftcuP1u
 lnws8v2oRNwNpGqR4nfE+bW/pIyt/09WNt6qx4u4ArDNYVRt1qn/kkzgh
 9c92uKuUR1tmyMmOshMcfovqe4cBFFeCmvyZXGfbBqGBWyX9II9JkpHti
 etG1NJSz0BaUhb2RI+7mImujHj3Yz4uN6Gx37gX9826elkeUPmNOQqleb
 pUbIEcNBNpO/GiOmTFHugQcCkv4+agKoOrX6ExeStbNLsnZ/iDQjI51to A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="289022416"
X-IronPort-AV: E=Sophos;i="5.93,354,1654585200"; d="scan'208";a="289022416"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2022 03:49:35 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="747789596"
X-IronPort-AV: E=Sophos;i="5.93,354,1654585200"; d="scan'208";a="747789596"
Received: from bpingot-mobl1.ger.corp.intel.com (HELO [10.252.6.106])
 ([10.252.6.106])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2022 03:49:32 -0700
Message-ID: <c76337af-73b2-4aef-278e-fa5f665daa97@intel.com>
Date: Thu, 29 Sep 2022 11:49:30 +0100
MIME-Version: 1.0
...
and then object_lock, before calling the bind_remove()? And then on lock 
error userspace can just call this again? Sorry if I'm misunderstanding 
something here.
...
va->start for sure needs some sanity checking first. Evil user could be 
setting the low bits here (0-11), which would cause havoc with our vma 
flags.

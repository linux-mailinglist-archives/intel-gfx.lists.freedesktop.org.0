...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6CB743D9A57
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 02:49:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 98CAD6E9E0;
...
Subject: [Intel-gfx] [PATCH v3 07/14] vfio/platform: Use open_device()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B9774EB389
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Mar 2022 20:43:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0302B10E6E9;
...
Subject: [Intel-gfx] [PATCH 06/12] drm/edid: split out edid_header_fix()

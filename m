...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32B204EE0E7
	for <lists+intel-gfx@lfdr.de>; Thu, 31 Mar 2022 20:45:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 755BE10F46F;
...
Subject: [Intel-gfx] [PATCH v2 03/12] drm/edid: add edid_block_tag() helper
 to get the EDID extension tag

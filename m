...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6035C62D6F8
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Nov 2022 10:30:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BE2EA10E5CB;
...
Subject: [Intel-gfx] [PATCH v10 12/19] drm/probe-helper: Provide a TV
 get_modes helper

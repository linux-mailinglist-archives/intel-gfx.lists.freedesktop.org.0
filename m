...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CE044BEDB6
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:18:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5CD5F10E51E;
	Mon, 21 Feb 2022 23:18:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EE82410E525;
 Mon, 21 Feb 2022 23:18:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485483; x=1677021483;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=mmpDbho6EFBReIp+UJ+Rf409yBMByOTa3FwPx9dN22o=;
 b=YTe+eGn30J5ivAimI/ncFbQv5aj1/Pr0dj2InYT0d44RMJz7wb3mTav/
 v3/yzJ1+ZwjN6G7YCmryTgQqbHmVFPi7v5UeI8Xup2W9s9SNQ7HzO2+Fg
 ak6Svwb1bmW9CKkaYEv3yUEcybuXr3RmZN0Xedj8B3cGf3F7t3mBKsmxD
 OZNIbBaGBpV1Xwv51/vdkLNV0LEHmsFuF/h0Oskh2oClVrIPNWsciBBU+
 57AJae6zzVhMiPHDEt0qB7NSAyZoG4P1giUShs/xO1oVhrDQcBVSV3L5z
 e9LyLgWnFZ/mlou+k42uVD2lbRGgVp46XTqU2J79QByZoL0uQYDvQHgBj w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="238996024"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="238996024"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:18:02 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="638694532"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:17:59 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: linux-kernel@vger.kernel.org, intel-gfx@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org, netdev <netdev@vger.kernel.org>
Date: Tue, 22 Feb 2022 00:16:56 +0100
Message-Id: <20220221231705.1481059-15-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 6/9] drm/i915: Separate wakeref tracking

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D76052D55AE
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 09:52:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 432F66EA46;
	Thu, 10 Dec 2020 08:52:41 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 24B976EA2E
 for <Intel-gfx@lists.freedesktop.org>; Thu, 10 Dec 2020 08:52:39 +0000 (UTC)
IronPort-SDR: OhpK9ZYWy6ohTogc9p/A0n0SjNA3Gmaxr29I1uafqfUBQ//5tTiyks2rrEz2jpAM9j0xHNM/tR
 T6cneQXxfjHA==
X-IronPort-AV: E=McAfee;i="6000,8403,9830"; a="171653235"
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; d="scan'208";a="171653235"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2020 00:52:38 -0800
IronPort-SDR: KcOvLTBsmhksF+BCmom/bzydD2VP1zAu6ulgKE4gayYe5JaxQbVNt4bnHcs9rM54No3s+Pmds3
 N9bZewyoedqw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; d="scan'208";a="318931530"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga008.fm.intel.com with ESMTP; 10 Dec 2020 00:52:36 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 10 Dec 2020 00:51:45 -0800
Message-Id: <20201210085203.14422-4-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201210085203.14422-1-sean.z.huang@intel.com>
References: <20201210085203.14422-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v5 03/21] drm/i915/pxp: Implement funcs to create
 the TEE channel
...
di5oCmluZGV4IGZjMTA5MGM2ODg5Yy4uNjZmOTFkOGE1NzViIDEwMDY0NAotLS0gYS9kcml2ZXJz
L2dwdS9kcm0vaTkxNS9pOTE1X2Rydi5oCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVf
ZHJ2LmgKQEAgLTEyMTYsNiArMTIxNiwxMiBAQCBzdHJ1Y3QgZHJtX2k5MTVfcHJpdmF0ZSB7CiAJ

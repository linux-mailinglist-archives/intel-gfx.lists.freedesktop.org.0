...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E270DA0BFAD
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Jan 2025 19:21:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D50A10E796;
	Mon, 13 Jan 2025 18:21:47 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="TFXo4MMm";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 252F110E796
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Jan 2025 18:21:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1736792506; x=1768328506;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=7a5VHzhOEeLZDgk0F5uniN1pWAKCDCvzHS3Js188MOs=;
 b=TFXo4MMmWq9lcRQuuK0DNwauK7JyWsykxXvc9h9JRDz1q9/vji/IAsHv
 hh/iCNUoCFcYjhQr4BPngfuR6G+ZZxnZz1yWPbU8vKCTFVKCjo3tm/2k9
 UPEvO1ySeaNaQG9SrYEDQxENLJ3TasLCljnbPfZBgf0xdhD7KcXLLWNTy
 awkwBizLYOLUI5lEslNISUcqhi6TDJ0XiyZwWbyvTuUuQinDFPpT2ImKK
 5kysqtXjTmW+d4Ox8bWBkDtY1uPshNjB9Cb2fH8J2PZe8k+zO8hh4C3Dy
 oY6kQD3aYO0bHPnIR962gityzWerkFtXkXRou0jQx6PQxMNW85h/vUwEG Q==;
X-CSE-ConnectionGUID: 2U4UAWqrTeu9iWyOuml2Ew==
X-CSE-MsgGUID: 8ceLqvqFQH2zBoDybCr1fQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11314"; a="37299012"
X-IronPort-AV: E=Sophos;i="6.12,310,1728975600"; d="scan'208";a="37299012"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jan 2025 10:21:46 -0800
X-CSE-ConnectionGUID: feXkHYIySeuZRcRQir2n9g==
X-CSE-MsgGUID: Svc7PoOSTrS13fIFY2l+aw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,310,1728975600"; d="scan'208";a="105078484"
Received: from nitin-super-server.iind.intel.com ([10.145.169.70])
 by fmviesa010.fm.intel.com with ESMTP; 13 Jan 2025 10:21:43 -0800
From: Nitin Gote <nitin.r.gote@intel.com>
To: andi.shyti@intel.com, jani.nikula@linux.intel.com,
 intel-gfx@lists.freedesktop.org
Cc: nitin.r.gote@intel.com
Subject: [PATCH v3 1/8] drm/i915/gt: fix typos in i915/gt files.
Date: Tue, 14 Jan 2025 00:13:11 +0530
Message-Id: <20250113184318.2549653-2-nitin.r.gote@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DAE9F279F02
	for <lists+intel-gfx@lfdr.de>; Sun, 27 Sep 2020 08:47:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C2666E23B;
	Sun, 27 Sep 2020 06:46:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9A3B36E235;
 Sun, 27 Sep 2020 06:46:56 +0000 (UTC)
Received: from localhost (unknown [213.57.247.131])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id BBE322388B;
 Sun, 27 Sep 2020 06:46:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1601189216;
 bh=GAgn+WZWa4MNM+n0BFaqb9rGJcAh0Jx45BwItwd2qgA=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=NB2AZXIvfjvhIR++VlW7Mg6tSCqfhzYaQR6nSnSteBV4qfOq4cPa4fpyrPGBFw1Su
 gC8LbDyjp0Gp2SsIUmzXld3bhc1eh0IS4DSYlDKFbVLccjcbZBi+C305a3mxGmgSws
 60795+SERdlKMcI6yj1lKsKpURFronDk9dfJhuv8=
From: Leon Romanovsky <leon@kernel.org>
To: Doug Ledford <dledford@redhat.com>,
	Jason Gunthorpe <jgg@nvidia.com>
Date: Sun, 27 Sep 2020 09:46:44 +0300
Message-Id: <20200927064647.3106737-2-leon@kernel.org>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20200927064647.3106737-1-leon@kernel.org>
References: <20200927064647.3106737-1-leon@kernel.org>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH rdma-next v4 1/4] lib/scatterlist: Add support
...
index 5d63a8857f36..c200d3442f47 100644
--- a/lib/scatterlist.c
+++ b/lib/scatterlist.c
...
@@ -425,19 +480,41 @@ int __sg_alloc_table_from_pages(struct sg_table *sgt, struct page **pages,
 			seg_len += PAGE_SIZE;
...
@@ -465,8 +542,9 @@ int sg_alloc_table_from_pages(struct sg_table *sgt, struct page **pages,
 			      unsigned int n_pages, unsigned int offset,
 			      unsigned long size, gfp_t gfp_mask)
 {

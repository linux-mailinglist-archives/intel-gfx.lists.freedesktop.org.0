...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF0523B9461
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 17:56:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 61DB56EB47;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/4] drm/i915/guc: Move and improve error

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 540DACB0B1
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Oct 2019 23:01:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD3DB6E177;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/5] drm/mm: Convert drm_mm_node booleans to
 bitops

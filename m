...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DB60A2F5F95
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Jan 2021 12:14:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DCB36E215;
	Thu, 14 Jan 2021 11:14:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3D4646E215
 for <intel-gfx@lists.freedesktop.org>; Thu, 14 Jan 2021 11:14:38 +0000 (UTC)
IronPort-SDR: pLMiCqJePuAXYxWOeHQ8XmccSut8ZVaanI1Zk6S5Mw0paB9QjcDrvS5wYC80PT9EJxp84S0gNp
 J2dRtU7CHIJw==
X-IronPort-AV: E=McAfee;i="6000,8403,9863"; a="239893303"
X-IronPort-AV: E=Sophos;i="5.79,347,1602572400"; d="scan'208";a="239893303"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jan 2021 03:14:37 -0800
IronPort-SDR: ZQHC7pu82DotmBkuYwtxlygb2iqEsYjFdn+NIXMMyadzrImg3C+Rt3Bnp1wcfiSpyyGt9DHphG
 QK/FHDjG4kqA==
X-IronPort-AV: E=Sophos;i="5.79,347,1602572400"; d="scan'208";a="465220957"
Received: from dforourk-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.213.254.146])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jan 2021 03:14:34 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 14 Jan 2021 13:13:49 +0200
Message-Id: <ecaa0ad261fff8ab8a20f72249f3a3f37c2dfa2b.1610622609.git.jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <cover.1610622609.git.jani.nikula@intel.com>
References: <cover.1610622609.git.jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/11] drm/i915: migrate hsw fdi code to new
 file.
...
dS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2RkaS5jCmluZGV4IDFjYWY2NDNlNjQwMC4uNjFhYzFl
MWI3YjU1IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rk
...
ICJpbnRlbF9oZGNwLmgiCkBAIC05MCw4ICs5MSw4IEBAIHN0YXRpYyBpbnQgaW50ZWxfZGRpX2hk
...
b29zdF9iaXQgPSAwOwpAQCAtMTUzLDggKzE1NCw4IEBAIHN0YXRpYyB2b2lkIGludGVsX3ByZXBh
...
CiB7CiAJaWYgKElTX0JST1hUT04oZGV2X3ByaXYpKSB7CiAJCXVkZWxheSgxNik7CkBAIC0xODIs
NyArMTgzLDcgQEAgc3RhdGljIHZvaWQgaW50ZWxfd2FpdF9kZGlfYnVmX2FjdGl2ZShzdHJ1Y3Qg
...
IERQTExfSURfV1JQTEwxOgpAQCAtMjQyLDE0NCArMjQzLDYgQEAgc3RhdGljIHUzMiBpY2xfcGxs
...
ZXggYTRkZDgxNWMwMDAwLi5mOWE5MTZjYWQ3ZTcgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
...
dGNfc3RhdGUgKmNydGNfc3RhdGUpOwogCiAjZW5kaWYKLS0gCjIuMjAuMQoKX19fX19fX19fX19f

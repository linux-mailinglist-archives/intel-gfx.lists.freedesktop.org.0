...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7341271598E
	for <lists+intel-gfx@lfdr.de>; Tue, 30 May 2023 11:09:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 833C710E38F;
	Tue, 30 May 2023 09:09:45 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 13/13] drm/i915/display: switch the rest of

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3EB243592
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jun 2019 13:39:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0206898E8;
	Thu, 13 Jun 2019 11:39:41 +0000 (UTC)
...
X-Mailman-Approved-At: Thu, 13 Jun 2019 11:39:40 +0000
Subject: Re: [Intel-gfx] [PATCH v4 18/28] docs: convert docs to ReST and
 rename to *.rst

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 82A356A5114
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Feb 2023 03:22:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 63F2E10E498;
...
Subject: [Intel-gfx] [PATCH v6 4/8] drm/i915/pxp: Add GSC-CS backend to send
 GSC fw messages

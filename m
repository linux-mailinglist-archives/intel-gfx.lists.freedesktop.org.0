...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EA354FC255
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 18:29:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 644F810E9DB;
...
Subject: Re: [Intel-gfx] [PATCH 18/34] drm/i915/gvt: devirtualize
 ->is_valid_gfn

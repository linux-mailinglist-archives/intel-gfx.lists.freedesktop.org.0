...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 158DC2C9831
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Dec 2020 08:34:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C79466E4AF;
	Tue,  1 Dec 2020 07:34:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 94FD56E4AD
 for <intel-gfx@lists.freedesktop.org>; Tue,  1 Dec 2020 07:34:00 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23171029-1500050 
 for <intel-gfx@lists.freedesktop.org>; Tue, 01 Dec 2020 07:33:57 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  1 Dec 2020 07:33:55 +0000
Message-Id: <20201201073356.18968-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 1/2] drm/i915/gt: Replace direct submit with direct
 call to tasklet
...
index 43703efb36d1..de4794ecde36 100644
...
+
 	 ...
 	 *
@@ -2404,36 +2402,45 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
+
 ...
 {
@@ -2771,16 +2778,6 @@ static void process_csb(struct intel_engine_cs *engine)
...
-
 ...
 {
 	LIST_HEAD(list);
@@ -3169,7 +3166,7 @@ static bool preempt_timeout(const struct intel_engine_cs *const engine)
 	if (!timer_expired(t))
 		return false;
...
+	return engine->execlists.pending[0];
 ...
 /*
@@ -3179,10 +3176,12 @@ static bool preempt_timeout(const struct intel_engine_cs *const engine)
...
@@ -3191,6 +3190,8 @@ static void execlists_submission_tasklet(unsigned long data)
...
@@ -3198,17 +3199,8 @@ static void execlists_submission_tasklet(unsigned long data)
...
@@ -3239,26 +3231,16 @@ static void queue_request(struct intel_engine_cs *engine,
...
@@ -3268,25 +3250,11 @@ static bool ancestor_on_hold(const struct intel_engine_cs *engine,
...
@@ -3300,7 +3268,8 @@ static void execlists_submit_request(struct i915_request *request)
...
+			__execlists_kick(&engine->execlists);
 	...
 	spin_unlock_irqrestore(&engine->active.lock, flags);
@@ -4214,7 +4183,6 @@ static int execlists_resume(struct intel_engine_cs *engine)
...
@@ -4231,10 +4199,6 @@ static void execlists_reset_prepare(struct intel_engine_cs *engine)
...
@@ -4479,12 +4443,12 @@ static void execlists_reset_finish(struct intel_engine_cs *engine)

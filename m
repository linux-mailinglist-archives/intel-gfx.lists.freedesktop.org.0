...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 88658573A9A
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 17:54:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DFDE8EB3D;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915: Correct ss -> steering

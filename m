...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0E717DBD24
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Oct 2023 16:58:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9E7010E31C;
...
Subject: [Intel-gfx] [PATCH v4 06/30] drm/dp_mst: Allow DSC in any Synaptics
 last branch device

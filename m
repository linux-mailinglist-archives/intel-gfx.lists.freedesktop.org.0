...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EB2FF1D0A20
	for <lists+intel-gfx@lfdr.de>; Wed, 13 May 2020 09:48:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A1306E988;
	Wed, 13 May 2020 07:48:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 31CA06E980
 for <intel-gfx@lists.freedesktop.org>; Wed, 13 May 2020 07:48:33 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21182462-1500050 
 for multiple; Wed, 13 May 2020 08:48:17 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 13 May 2020 08:48:07 +0100
Message-Id: <20200513074809.18194-22-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 22/24] drm/i915/gem: Asynchronous GTT unbinding
...
index 812d306092e7..11aa6dfefe8a 100644
...
@@ -2758,7 +3414,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2778,6 +3434,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 			goto err_parse;
 		}
...
@@ -2856,6 +3513,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 err_parse:
 	if (batch->private)

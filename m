...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17C0661CCE
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 12:16:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 21E8689C93;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 in9w==
Subject: Re: [Intel-gfx] [PATCH v8 6/6] drm/hdcp: reference for srm file
 format
...
Content-Type: multipart/mixed; boundary="===============1224818093=="

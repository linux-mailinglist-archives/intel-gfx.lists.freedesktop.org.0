...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B6CF11B70F
	for <lists+intel-gfx@lfdr.de>; Mon, 13 May 2019 15:32:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3806889CD3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm/hdcp: drm_hdcp_request_srm() as static

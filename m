...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BABF33B3EFA
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Jun 2021 10:23:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E12E6ED8D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 17/27] drm/rockchip: Don't set struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5517B6BE177
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 07:45:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C387910E127;
	Fri, 17 Mar 2023 06:44:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BC8C210E096;
 Fri, 17 Mar 2023 06:44:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 Tv+UCJiBd5uqLlQ/3dwHRx5tA/1iZFTm4y/pVwm5HrixG+Oft1LF+Powf Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="339735900"
X-IronPort-AV: E=Sophos;i="5.98,268,1673942400"; d="scan'208";a="339735900"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 23:44:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="710401424"
X-IronPort-AV: E=Sophos;i="5.98,268,1673942400"; d="scan'208";a="710401424"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230025)(39860400002)(346002)(366004)(136003)(396003)(376002)(451199018)(5660300002)(8936002)(2906002)(41300700001)(3450700001)(316002)(8676002)(66476007)(66556008)(54906003)(478600001)(6486002)(6916009)(6666004)(83380400001)(186003)(26005)(6512007)(6506007)(4326008)(66946007)(86362001)(82960400001)(38100700002)(67856001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 17 Mar 2023 06:44:52.7128 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 09/27] drm/i915/gvt: Drop unused helper

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F31B3C8A2D
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Jul 2021 19:52:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 386EF6E479;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 3/5] drm/print: RFC add choice to use dynamic
 debug in drm-debug

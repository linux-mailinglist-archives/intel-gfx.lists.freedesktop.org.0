...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A83076B364
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 13:37:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84EC410E3E0;
...
Subject: Re: [Intel-gfx] [PATCH v4 17/29] drm/i915/gvt: Don't bother

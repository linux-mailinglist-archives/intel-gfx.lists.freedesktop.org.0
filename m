...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C737D554587
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 13:00:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF98810EADE;
	Wed, 22 Jun 2022 11:00:03 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 07/13] drm/edid: add drm_edid_raw() to access
 the raw EDID data

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21793879918
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Mar 2024 17:37:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 71EFF10EF9D;
	Tue, 12 Mar 2024 16:37:16 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aRja4V6z";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 398E6112F0E;
 Tue, 12 Mar 2024 16:37:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1710261431; x=1741797431;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=JwwrlAGXc6qlOOGhg4Rx++SNM4sEcRxRlAFCFLQDetw=;
 b=aRja4V6zp/oDfvw5S3m696HebE4MPCiPH17uXPMTBzxetvE1hFz200w6
 S4Cagr/+LZHxJCuxVN8BSr+ouqX8HIH9VtxEnfMG9lm7DcTyDDVJzsONJ
 c1tX5vS/0FNeD6tbrlIOVTGsUFgQRwudo3HxS7PCa5aW3fHSz1sL1lyl9
 pmiTGMO4upYWMMM9cCawlLOcgNzT3c3y1gksN/ws94SQ3bh1rjWHPkrjo
 oXyYopTMXJSScuPLLL0AabChLMZcTRVX1SfVUCPmxz1ZDsWJYo+IlzcfF
 iQ3YypIQw/mppcPomRR5yJzFHZxDj6ifF6Rg2vB28SYSFJ2VhHrOHg49x g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="27458085"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="27458085"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 09:37:11 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="16245857"
Received: from ticela-or-524.amr.corp.intel.com (HELO gjsousa-mobl2.intel.com)
 ([10.255.33.238])
 by ORVIESA003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 09:37:09 -0700
...
Subject: [PATCH v2 6/8] drm/i915/xe2lpd: Support MDCLK:CDCLK ratio changes
Date: Tue, 12 Mar 2024 13:36:37 -0300
Message-ID: <20240312163639.172321-7-gustavo.sousa@intel.com>
...
@@ -2088,6 +2102,9 @@ static void bxt_set_cdclk(struct drm_i915_private *dev_priv,
...
@@ -3170,6 +3187,20 @@ int intel_cdclk_atomic_check(struct intel_atomic_state *state,
 	return 0;
 }

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D930040CAB8
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 18:41:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8624D6E9A9;
...
Subject: [Intel-gfx] [PATCH v8 07/16] dyndbg-doc: fix bootparam usage example

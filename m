...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A12E2FAA3C
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jan 2021 20:33:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 646B06E56D;
...
Subject: Re: [Intel-gfx] [PATCH v4 5/6] drm/vmwgfx: Remove reference to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C469E1983B2
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Mar 2020 20:48:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A4836E483;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 4/5] drm/i915/display: Add Nearest-neighbor

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A4B61BDC59
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 14:34:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8317C6EAA8;
	Wed, 29 Apr 2020 12:34:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C138A6EAA8
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 12:33:19 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 14:32:57 +0200
Message-Id: <20200429123307.1449297-15-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 15/25] drm/i915: Make sure execbuffer always
...
@@ -2111,7 +2118,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2122,7 +2130,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2234,16 +2242,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2271,7 +2296,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2282,7 +2307,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2294,19 +2319,34 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2461,7 +2501,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -2917,33 +2957,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2952,7 +2966,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
+		goto err_vma;
 	...
 	if (in_fence) {
@@ -3015,9 +3029,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	}
...
-		i915_vma_unpin(batch);
 err_vma:
 	...
 	if (eb.trampoline)
@@ -3103,7 +3114,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3181,8 +3194,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index 78aacb58d918..206078485301 100644
...
index 25137a840804..d9b4797e5de8 100644
--- a/drivers/gpu/drm/i915/gt/intel_gt.c
+++ b/drivers/gpu/drm/i915/gt/intel_gt.c
@@ -347,7 +347,7 @@ static int intel_gt_init_scratch(struct intel_gt *gt, unsigned int size)
 		goto err_unref;
 	}
...
index d9823fb2582c..8548452a5362 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3455,7 +3455,8 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3817,7 +3818,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index d3fa91aed7de..22a26482a33c 100644
...
index b00f0845cbc3..53929620f28f 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D2D04B5536
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Feb 2022 16:49:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DAAA10E237;
...
Subject: [Intel-gfx] [PATCH V2 11/13] media: tda8083: use

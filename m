...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11FDD3F7308
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Aug 2021 12:26:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AABE78999A;
...
Subject: [Intel-gfx] [PATCH v6 3/7] drm: lock drm_global_mutex earlier in
 the ioctl handler

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 88ECB43F563
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Oct 2021 05:28:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CCACD6E9BA;
...
Subject: [Intel-gfx] [PATCH v3 03/10] drm/i915: Restructure probe to handle

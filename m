...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EAE353F2F6
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Jun 2022 02:34:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2593D10FBCF;
...
Subject: [Intel-gfx] [PATCH 0/2] Remove the VFIO_IOMMU_NOTIFY_DMA_UNMAP
 notifier

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gJIlNhmBlGniFAIAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Feb 2026 15:54:17 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8E3014D52D
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Feb 2026 15:54:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BB2C10E09E;
	Tue, 17 Feb 2026 14:54:14 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=fail reason="signature verification failed" (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ns0tpWHY";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2C7B510E09E;
 Tue, 17 Feb 2026 14:54:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1771340053; x=1802876053;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 in-reply-to:mime-version;
 bh=HPrgQuV80sbt2rBHfCarh71wrPBvCuCfmqG9JNXECow=;
 b=ns0tpWHYpUudW3o5L7Zn4OfohJRareLbnZIjc/mbcboSzteLXmOZNiCA
 qgoNsD3EpGgWX8xYQ9Cd8BKgZZ8PO01bCHPzT8iSyJ/uVxUAb6XfrYkV2
 nnzT7cOH19g4d5ZgkJn3A2Swh+rXkrs93esAlH4wPAYLT2j+/Y+JXUCzV
 ZjZrroeLgA9I03CKBaeS5KrTNLuIY/03scAvHWaJ/5AUFZeeyswb/0K25
 ulQZy0kWAftuD2PahS/f4QgJrgTqxeV7J6o3+57bGG6psTX0ivSjVAx+A
 S8hED/Szgg7b6dLVVcFBAAH1okhkzMJvSD83bCS3ghR0rfTV1+fuyaCHA Q==;
X-CSE-ConnectionGUID: 8y9TlzcWSwy+8uBZFLZBeA==
X-CSE-MsgGUID: VpEjsWwyTk6f9kVR5sob0g==
X-IronPort-AV: E=McAfee;i="6800,10657,11703"; a="71429650"
X-IronPort-AV: E=Sophos;i="6.21,296,1763452800"; d="scan'208";a="71429650"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2026 06:54:11 -0800
X-CSE-ConnectionGUID: IwQi4eITTO6/EYiQ1wYpYw==
X-CSE-MsgGUID: 7tGDhxjcRhuN25VsbLsCLQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,296,1763452800"; d="scan'208";a="212790720"
Received: from orsmsx901.amr.corp.intel.com ([10.22.229.23])
 by fmviesa010.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2026 06:54:10 -0800
Received: from ORSMSX902.amr.corp.intel.com (10.22.229.24) by
 ORSMSX901.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.35; Tue, 17 Feb 2026 06:54:10 -0800
Received: from ORSEDG903.ED.cps.intel.com (10.7.248.13) by
 ORSMSX902.amr.corp.intel.com (10.22.229.24) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.35 via Frontend Transport; Tue, 17 Feb 2026 06:54:10 -0800
Received: from BN1PR04CU002.outbound.protection.outlook.com (52.101.56.57) by
 edgegateway.intel.com (134.134.137.113) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.2562.35; Tue, 17 Feb 2026 06:54:09 -0800
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=yvBwnsxfr1DjoL9H5ocQ+zxtTAdgCZD1hpcY+YStcs4=;
 b=
...
Received: from PH0PR11MB4840.namprd11.prod.outlook.com
 ...
 ([fe80::fa90:e665:4a25:58a7%6]) with mapi id 15.20.9632.010; Tue, 17 Feb 2026
 14:54:04 +0000
Date: Tue, 17 Feb 2026 16:53:58 +0200
...
Subject: Re: =?utf-8?B?4pyXIGk5MTUuQ0kuRnVsbDogZmFp?=
 =?utf-8?Q?lure_for_drm=2Fi915=2Fdp=5Fmst?= =?utf-8?Q?=3A?= Allow DSC
 passthrough modes during validation (rev2)
Message-ID: <aZSBBvs4Ngrnuccy@ideak-desk.lan>
References: <20260216070421.714884-1-imre.deak@intel.com>
 <177124153752.255575.8297575274235967755@a3b018990fe9>
Content-Type: text/plain; charset="us-ascii"
Content-Disposition: inline
In-Reply-To: <177124153752.255575.8297575274235967755@a3b018990fe9>
Organization: Intel Finland Oy - BIC 0357606-4 - c/o Alberga Business Park, 6
 krs Bertel Jungin Aukio 5, 02600 Espoo, Finland
X-ClientProxiedBy: GVZP280CA0027.SWEP280.PROD.OUTLOOK.COM
 (2603:10a6:150:276::13) To PH0PR11MB4840.namprd11.prod.outlook.com
 (2603:10b6:510:43::16)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: PH0PR11MB4840:EE_|SN7PR11MB7511:EE_
X-MS-Office365-Filtering-Correlation-Id: e9d945ad-b960-4976-9866-08de6e34646e
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230040|376014|1800799024|366016;
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?8EA7VQ6oxS0gZTpx8rk3xWFhTGlA6w6Zs9lLwl2XWOLazrXFHxYKbdShG23F?=
 =?us-ascii?Q?2pVrK2nragO8rnUMo9JRbKHlJTepjzTPTiiTo8ZgY7qpB3MPg6R5msacu+aE?=
 =?us-ascii?Q?vtW9Z/dkbDNm1PlmzuN8aEQRas3FZkekTHMNLTNuBodJkvHwKSq7tnrDaeIE?=
 =?us-ascii?Q?dosZuxpWHS+dMzJGW7L/urhBub/aySKr8mfl0KOx3aGC9YjTbKg4CcQ28n48?=
 =?us-ascii?Q?XW+BWYsClczqKLUZ3Fzt/sgIDndvq8LqwcoelnP+NhJYF+uEV1Aryn3v2cYh?=
 =?us-ascii?Q?i41k3IeEvJM0JMYwzwyTlXSXWod4yQyX1Rwm8eHMkbspUioh/xfa/96ZcrqV?=
 =?us-ascii?Q?KeohZHjtUL10/X0eVOOGvSTUfr1Sid9gLMB8bcMziu3FzyOTGEkApKWugiaq?=
 =?us-ascii?Q?XkLgtxuZYXXG2EuXaOxPSs5a4hkFqL1MpJ+3uTjHRN4tFOINoL7+RlkQYmdc?=
 =?us-ascii?Q?rL7jPSg4qoox7QKX+MN2HlAvAV5JiqeIBYppBkdGJ2oSOBDXoqz3Rhqs16Oo?=
 =?us-ascii?Q?EL9f9n0KAYwHZQlwP+doWBCbU192wi+6lZe6uey2WktfipWEMjQ3uNunwCuQ?=
 =?us-ascii?Q?4kjvXUB8MZxEQtpV7WUaTuBZ5zEAJlogOAlFAlsj8ZMtrpdqrQ7xb4J826gv?=
 =?us-ascii?Q?aqrzY4IQCBpbt9aExd90bwdBfxZAGUTx5rFkyjPHKzkDDxwixInHNG9r1YsZ?=
 =?us-ascii?Q?+58Gd8yPn0NJgwQfFg0gBus/UsX6EwLFrNMk2dJ+25SkZoUx0lvKF0cyQ8Nb?=
 =?us-ascii?Q?3DFuyxbddDCK4dNtj2Xn9qMCL145w9pgZy/SYFXMUlCahkXqtFhgmfHc8QwJ?=
 =?us-ascii?Q?HD6Pd78GbeiSj30Y9L1G6ROudNFOlypmiLcA9mQW/w+vDzupCMtwPnb/08D+?=
 =?us-ascii?Q?hCOFVkZ74OSA1qzEW0W77VXnDuV1BvZNn8bgj1AlK5ECDG9Lk3CCCI6C5uQ9?=
 =?us-ascii?Q?zwkNNDclRTxVexorpOgzjXzpIlYG30ZWR/iNa8eUVBXQdfCuTmtY6tYeiORj?=
 =?us-ascii?Q?7WV3jfeIL3AM1GuwGnJDJHwePXdukbfM35GP3xKG43c2p5CM7WCwloje15Ht?=
 =?us-ascii?Q?DKBigX8kmRRhcMsBbC+yo22+kuZfxX/uSsFambpagHAn/ExclFRVBCIldy/l?=
 =?us-ascii?Q?4jjveysKaTkS0Y4yVCpgkuZtbfj2/ccicy2gz8wQVQj/TBndhYX6QiawxDmL?=
 =?us-ascii?Q?i372tCsE5Rs17qAxcomrnivjL7pTevat+R5jq4U5vrY17OXRU2D4IFurzDN0?=
 =?us-ascii?Q?ni124MkUr44UeyMBWkQphrAKbgCZGct3LwCM5Wft2EazOwnSngeEgdY7wCgw?=
 =?us-ascii?Q?RjcuPHPTYbxYXeAIcG1KER+UZDXpIAevvyn7ccIU5qOhawfVmZ7DS7JKDb88?=
 =?us-ascii?Q?Q8PWMhpnMqI90vH0YNwUHJlwxcS+Bv7hQcQ9qN8LOFFvj5IvX3f4pxHY1AHp?=
 =?us-ascii?Q?7sqCpkcUeYv1TpDNhoOat+5VmuDhUj1C1b34rFk6BhsKVhnJQ/AQeay6KnSg?=
 =?us-ascii?Q?xVlqqrhRjbMHb5I=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:PH0PR11MB4840.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(376014)(1800799024)(366016); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?cdzemQ6QU5upFUH7ZVnhBq2+5xLak2LEOX7E1eAqmX28cvhXOyy3gcYwPx5a?=
 =?us-ascii?Q?eTmIwdF3s/hiYw/G4BiUZGQUfnFaBGKi1NBXUv2XzJZa9vmaQK6VTQvR2+tB?=
 =?us-ascii?Q?jaaJmDvkAAbrH44rpHUBG85ctaZA3ZFMRWyog1RA9D7bSfoGZQL63cxlD7yu?=
 =?us-ascii?Q?b5eYj+7WWbcXbkFvDNdvXKH7EYAvvSruzGKepddynu7tbhSQkHqguG9GLDI9?=
 =?us-ascii?Q?zWrLC05CeVA8slWPYoDhFAgk8LF/2zrdhzvNeHb6ylGuSUZmv5NyXGmozTCD?=
 =?us-ascii?Q?ALU93IDOxg1EVl/Xg1IbCd5l7Ji714/oFsNS/vJWxvA/agq8tUsXCDNMo8Yd?=
 =?us-ascii?Q?MM4mJMJJkqVuWZNEOtg55n0aT7Zo/hr9giAIrb0ZF8gwdNCxkRIuIH/+ZI9v?=
 =?us-ascii?Q?OylnUIQY/lwgMvVkklruzp3f+i/jeaot10JtO3z4mAU1hs/UWz9Be/NcX7zZ?=
 =?us-ascii?Q?TihrXk3hmdvl1Y8ECkp0X4sz4Q0we/bsybnL8vprGPAmgOfNP9Nt5iZMT27x?=
 =?us-ascii?Q?HV6ZDO+xBK0xcJzoVDSjMj3uyD9ug8nKLSgA7hlLjT072V0/+b638PZZpP1a?=
 =?us-ascii?Q?hVsWx9mbDcy9dZwLUOHGeBmR9sDYE/U6CnJuMMB4ojlKpLRuC0Mtr89DsYTG?=
 =?us-ascii?Q?xQtOuxfy8+k21cWG+dnsz32qnswbVfV6U3ekvEpJiEdWr8yDqCp4TRkP7mhy?=
 =?us-ascii?Q?6/B7NdIUKhj+opD9RFI0iOMBbzER8vJN0bM+3VytDHW9lQqjy3wZS79Hz7U2?=
 =?us-ascii?Q?rJ9MHRzYQwn0vbdH64q5s1n6itZITpP8xxTOXtwoZtKWjvS5zfZb/58npR2I?=
 =?us-ascii?Q?i+VtmUpkRfEOFHbeaV82wu/+8C0mjRdZ7ESoZlyQEyCjwv3AP901UgVzxlBC?=
 =?us-ascii?Q?EB4yugrXnXCvBLdqorgnZP+5YYYCSeeZH4WN61ENG2vNUNBTNpP3ZOnCMEJX?=
 =?us-ascii?Q?TbP1RGjn0mi6FnsJFy1jwxtfpGYSttemuJKlJKrvSauGTUPcg49F9l5hroPm?=
 =?us-ascii?Q?WHTXnRR5Lq7a0Os+ilO1jfBkupp2gSkiolA1rQ1+o+kj3WGk0EBvnzYVWtD5?=
 =?us-ascii?Q?zQYX0xm/qyznC2DanNmA/z36eAaCqASgiCnzC7uba8p4MKkOV10n0HjjdIwS?=
 =?us-ascii?Q?yTMXrYjwRVkXZw1Qp/dP8ARbfdPXve/ICpH6OKHVu6alV9I5Od91IpylkRh2?=
 =?us-ascii?Q?Swtv7cANvWGmR6INxNlEUNSMDNPAZxESSfhYg0/xWezaaFih1gLqAUIy3adJ?=
 =?us-ascii?Q?XaGxDS0PPgHZDx970554PabD87me7W0p9emw2Q3oTD+hSbYHBS624+AJ/Znt?=
 =?us-ascii?Q?8MYoH3rvsu442jUfFi0x/KodeIkcBXyT0aIXM2+OK2Uf0CDBWB2AMiyJCmbs?=
 =?us-ascii?Q?ypfbs0ROvvjFfJMLpD9uaABuU5woqwt/uKr58Ud/L2+ozsRJd+9gYHalWooY?=
 =?us-ascii?Q?b5UoWAiFqnNTTkvQtE5OgVzn7tY2wgVOsJ8l2vGmj2+0oyTf82D9RnkaRmc0?=
 =?us-ascii?Q?1+2kevqiw+JT02D2XbU9yX5dKcIxogTRsfQ8qphBy3MT7nf/78WuYvY8zm6W?=
 =?us-ascii?Q?I9rxGQ/X+qLMR7HQkkVsfRBq0q0PsvI2qOXqUBUM1GZCHq/ohppQdrguMx8O?=
 =?us-ascii?Q?psejrTFvJY4fFeo85K4xZgEEDpnTpZbNGUfGznN6YVf3DW8+JYy2Js3Zlz4r?=
 =?us-ascii?Q?66NQ4lYtxhMACj8SfCXlQZneW50zuaHMXdgolsJ+X2MY4WnqXZVNkXJcum17?=
 =?us-ascii?Q?x3Ao/WnUhQ=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: e9d945ad-b960-4976-9866-08de6e34646e
X-MS-Exchange-CrossTenant-AuthSource: PH0PR11MB4840.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 17 Feb 2026 14:54:04.0877 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: jQkx4qrQ94hKEZM3kr76G2O4HOCRd57CMngR8A9Gs0riSdeNUx3yGTCjKiufOBAgBCMurRo6EjyGA92DY6r2cQ==
...
X-Rspamd-Queue-Id: C8E3014D52D
X-Rspamd-Action: no action

On Mon, Feb 16, 2026 at 11:32:17AM +0000, Patchwork wrote:
> == Series Details ==
> 
...
There's no DP outputs on the above systems, so the DP specific changes
in the patchset are unrelated to the failure.

The failure is due to DP AUX timeouts, which could be related to both DP
and HDMI being enabled by VBT on the port, but only an HDMI sink being
connected.

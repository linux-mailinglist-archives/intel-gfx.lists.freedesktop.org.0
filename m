...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18F8C2B27B3
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Nov 2020 23:04:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 615D86E860;
	Fri, 13 Nov 2020 22:04:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EC1F86E860
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Nov 2020 22:04:09 +0000 (UTC)
IronPort-SDR: QjV90NK8Lw8LaV2wjdzaKXl2lI+tWO240gqHESBW8Er50iqbyvU05K0ea1h4mFDVZQp+FQoSdS
 YpvaZoW7Bf9Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9804"; a="158316185"
X-IronPort-AV: E=Sophos;i="5.77,476,1596524400"; d="scan'208";a="158316185"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Nov 2020 14:04:09 -0800
IronPort-SDR: zQSREhs7NlDdrDMUeyYvnCiPbkSrBvz3jMWtbL5JowUA3QtcG1GUNQUyrjhY5C8vEcafcTFA7c
 omFYvtEwkbaA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,476,1596524400"; d="scan'208";a="329011575"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 13 Nov 2020 14:04:07 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Sat, 14 Nov 2020 00:04:06 +0200
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sat, 14 Nov 2020 00:03:38 +0200
Message-Id: <20201113220358.24794-4-ville.syrjala@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/23] drm/i915: Nuke
...
aXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGlzcGxheV90eXBlcy5oCmluZGV4IDM1
YWI1OTQ0YTNmNy4uM2Q5MWIxMTZhYWRjIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkx
...
ZWxfcG0uYwppbmRleCAyNDgxM2JkMzg0N2UuLjVhMDRiZTU4ZTBiOSAxMDA2NDQKLS0tIGEvZHJp

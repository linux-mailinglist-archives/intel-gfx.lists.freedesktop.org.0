...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D59E0399984
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jun 2021 06:59:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E81EB6F3AA;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/20] drm/i915/guc: enable only the user

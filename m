...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EA09A2DBAC1
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Dec 2020 06:38:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 35FE189D6C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 11/15] drm/i915: Add support for enabling

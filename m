...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFD34688C50
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Feb 2023 02:10:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2893B10E6E0;
...
Subject: [Intel-gfx] [PATCH 2/3] drm/i915/guc: Clean up of register capture
 search

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 78CBE3DF767
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Aug 2021 00:12:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1A916E929;
...
Subject: [Intel-gfx] [PATCH 22/46] drm/i915/guc: Implement multi-lrc
 submission

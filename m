...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7493466691B
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Jan 2023 03:53:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94C0E10E850;
...
Subject: [Intel-gfx] [PATCH 1/4] drm/i915: Allow error capture without a
 request

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0CA565EE3E6
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Sep 2022 20:08:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFC2010E551;
	Wed, 28 Sep 2022 18:08:03 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 7/7] drm/i915/guc: handle interrupts from
 media GuC

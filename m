...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DA663E5605
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Aug 2021 10:53:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3FDF989F1B;
	Tue, 10 Aug 2021 08:53:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x433.google.com (mail-wr1-x433.google.com
 [IPv6:2a00:1450:4864:20::433])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AAD0289F53
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 Aug 2021 08:53:41 +0000 (UTC)
Received: by mail-wr1-x433.google.com with SMTP id h13so25197415wrp.1
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 Aug 2021 01:53:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=sIdtP8ynYzhdpowi3XKfqRIf3qsW0WPTyNTB6luGJ10=;
 b=AjOmIPVI1amBlLZ8wasgv35t23kte8feXHUIHZAzhqbcCvZ4ejKw4SO1XaJGoCptUF
 2T14jUjCs1KbhU6pwZRHDk6oaABGhLbV1cXNfgNfSdLfjXgCbEGpCWrBfDUL0y25OzS0
 BaCaUibKDrlYa/yM0hGgoZFoblUv+oTSQPfmY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=sIdtP8ynYzhdpowi3XKfqRIf3qsW0WPTyNTB6luGJ10=;
 b=
X-Gm-Message-State: AOAM530jqCsRVS0/3z9PXxw7QhzXsN9J5cCDS2abMq6BNyJUDw8GDoGC
 +XGL5NnvNELtXmhLkGWkCOjhWA==
X-Google-Smtp-Source: ABdhPJzpzXXijvgikcY2oNKG8+dwEnenWYIzcoxHTTzTzWgQPRP36gNX3GXVHTbsk/Q9lVK47nWRyw==
X-Received: by 2002:a5d:4611:: with SMTP id t17mr7633559wrq.139.1628585619961; 
 Tue, 10 Aug 2021 01:53:39 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id u15sm13227888wmq.33.2021.08.10.01.53.39
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 10 Aug 2021 01:53:39 -0700 (PDT)
Date: Tue, 10 Aug 2021 10:53:37 +0200
From: Daniel Vetter <daniel@ffwll.ch>
To: Matthew Brost <matthew.brost@intel.com>
Cc: Daniel Vetter <daniel@ffwll.ch>, intel-gfx@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org
Message-ID: <YRI+kfRFSIG30uBQ@phenom.ffwll.local>
...
In-Reply-To: <20210809185823.GA123728@DUT151-ICLU.fm.intel.com>

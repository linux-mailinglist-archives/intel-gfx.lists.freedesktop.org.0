...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D3DAF5E5F7D
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Sep 2022 12:11:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5F59610EA94;
	Thu, 22 Sep 2022 10:11:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7174510EA94
 for <intel-gfx@lists.freedesktop.org>; Thu, 22 Sep 2022 10:11:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663841510; x=1695377510;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=Ynn5TAJpEL245cJocyfiXJWJE7ojU1moeAVWvhHCItE=;
 b=DNRlFa6qbmyFCKuFNoLxvDe9T1kg2tSmq6Jw2OlIB2ViAo41SrcNrZ8h
 fJJ8hKiKft8eYVCaVKRcbB9OzlLRoxdTo2T3YAwBjcm42drPlvuFVIJjy
 A5YJY9+BXaWPDNhIa8RvDxWUUFQPLzW6BMo6S2O0Ju12NMSYFdGs4Wb+v
 mojG1RAze2tqbF2snH4w1MRuL5hsf6PUaB+DDVkBksfT24Tp6F8jLcmq/
 IlQjqt91oR17Jx4UdOo8gS7zfjHeLPuOdvGbGEryM+i5GG5zNp9nD5AOp
 L7nMC5ZlotfHqjqTc+e9kaAablHf8e3dxFZ7mK22QtW62ULbZQO1TNC7x w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10477"; a="326576911"
X-IronPort-AV: E=Sophos;i="5.93,335,1654585200"; d="scan'208";a="326576911"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Sep 2022 03:11:40 -0700
X-IronPort-AV: E=Sophos;i="5.93,335,1654585200"; d="scan'208";a="708820515"
Received: from jkrzyszt-mobl1.ger.corp.intel.com (HELO
 jkrzyszt-mobl1.intranet) ([10.213.3.25])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Sep 2022 03:11:35 -0700
...
Subject: [Intel-gfx] [core-for-CI][PATCH] iommu: Remove iova cpu hotplugging
 flushing

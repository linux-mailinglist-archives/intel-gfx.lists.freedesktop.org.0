...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B7E25AA3DB
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Sep 2022 01:42:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BDA710E39C;
...
Subject: Re: [Intel-gfx] [PATCH 8/8] drm/i915/mtl: Hook up interrupts for
 standalone media

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6827EC4E4E0
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Nov 2025 15:10:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82E4410E5D4;
	Tue, 11 Nov 2025 14:10:38 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 10055242dc62 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4E50010E2EF;
 Tue, 11 Nov 2025 14:10:37 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============9039106131150906861=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=97_i915=2ECI=2EBAT=3A_failure_for_drm/i915/fbc=3A_Apply_wa?=
 =?utf-8?q?=5F15018326506_=28rev2=29?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Vinod Govindapillai" <vinod.govindapillai@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Tue, 11 Nov 2025 14:10:37 -0000
Message-ID: <176287023731.41437.4923404640079503662@10055242dc62>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_157212v2 absolutely need to be
  verified manually.
  
  If you think the reported changes have nothing to do with the changes
  introduced in Patchwork_157212v2, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_157212v2:
...
#### Possible regressions ####
  ...
  * igt@vgem_basic@unload:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17527/bat-rpls-4/igt@vgem_basic@unload.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_157212v2/bat-rpls-4/igt@vgem_basic@unload.html
...
#### Issues hit ####
  ...
  * igt@i915_selftest@live@workarounds:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17527/bat-arlh-3/igt@i915_selftest@live@workarounds.html
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_157212v2/bat-arlh-3/igt@i915_selftest@live@workarounds.html
    - bat-dg2-9:          [PASS][5] -> [DMESG-FAIL][6] ([i915#12061]) +1 other test dmesg-fail
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17527/bat-dg2-9/igt@i915_selftest@live@workarounds.html
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_157212v2/bat-dg2-9/igt@i915_selftest@live@workarounds.html
    - bat-dg2-11:         [PASS][7] -> [DMESG-FAIL][8] ([i915#12061]) +1 other test dmesg-fail
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17527/bat-dg2-11/igt@i915_selftest@live@workarounds.html
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_157212v2/bat-dg2-11/igt@i915_selftest@live@workarounds.html
...
<p>Serious unknown changes coming with Patchwork_157212v2 absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_157212v2, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them<br />
...
<p>Here are the unknown changes that may have been introduced in Patchwork_157212v2:</p>
<h3>IGT changes</h3>
<h4>Possible regressions</h4>
<ul>
<li>igt@vgem_basic@unload:<ul>
<li>bat-rpls-4:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17527/bat-rpls-4/igt@vgem_basic@unload.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_157212v2/bat-rpls-4/igt@vgem_basic@unload.html">INCOMPLETE</a></li>
</ul>
</li>
</ul>
<h2>Known issues</h2>
...
<ul>
<li>bat-arlh-2:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_17527/bat-arlh-2/igt@i915_selftest@live@gt_tlb.html">INCOMPLETE</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_157212v2/bat-arlh-2/igt@i915_selftest@live@gt_tlb.html">PASS</a></li>
</ul>
</li>
<li>

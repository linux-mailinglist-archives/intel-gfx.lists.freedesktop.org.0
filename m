...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C79E9AB88F2
	for <lists+intel-gfx@lfdr.de>; Thu, 15 May 2025 16:10:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DBC6F10E8B9;
	Thu, 15 May 2025 14:10:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="iukHH4l2";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8C3FD10E8B9
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 May 2025 14:10:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1747318242;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=+lcYxqOygs7CrsNUkbbofsVji7C7nAqeA5usDI/rqf4=;
 b=iukHH4l26C+HMs0UAsvN6Ydnmvk7GsAeXUcfFjTEJkPawn8e/vwasKb0/qGHNcX6DBtN3z
 8te0WwjM/Vgf6et5FEW3uWPWWnmKr4Z6eQwLI8978CrlHOW6LlRHk3S4ryP6+M5eqzbU7k
 h0pRZrdsPRIAE6C3tx8ng7zjKeGr3gE=
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 [209.85.128.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-589-Nf3KLkRKMXut3TTY-PSnHg-1; Thu, 15 May 2025 10:10:38 -0400
X-MC-Unique: Nf3KLkRKMXut3TTY-PSnHg-1
X-Mimecast-MFC-AGG-ID: Nf3KLkRKMXut3TTY-PSnHg_1747318237
Received: by mail-wm1-f70.google.com with SMTP id
 5b1f17b1804b1-442f90418b0so3557735e9.2
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 May 2025 07:10:38 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :message-id:reply-to;
 bh=+lcYxqOygs7CrsNUkbbofsVji7C7nAqeA5usDI/rqf4=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCUoqgjKQ9bs8HDo5vcCHsxEewNisMoUrwqwSlHuNF7N9M1ZG/iAuG8TFqXCybZ4tbForpkkOBAriBY=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YxGhsfkJjXZzRXvTgYTarGWQJa0POHn0RL323/i+zfr2V4GPE+G
 +pub8H0XRMKuLow9YW+RKuSODnN/4OEUIbxAFlcyP/yTeTdcfQr78RhaQAzihb4RYN9/cSmPj9M
 plEH9STm7tY74BJR+ACBqmIQ9S2PaZttOthxgm0wWyueNa2FO2dSn20pWeLNU8TS7Hg==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:a378:b0:43c:f050:fed3 with SMTP id
 5b1f17b1804b1-442f20d9d37mr71948215e9.11.1747318237189; 
...
X-Mimecast-MFC-PROC-ID: mQGQK7GMFltM72Tg97FA0e4zowj0t75JgBjRS8nstSk_1747318237

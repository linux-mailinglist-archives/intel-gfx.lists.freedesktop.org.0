...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B5AFE701748
	for <lists+intel-gfx@lfdr.de>; Sat, 13 May 2023 15:29:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 206F610E0ED;
...
Subject: [Intel-gfx] [PATCH v11 22/23] vfio: Compile vfio_group

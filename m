...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F5C5956C4
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Aug 2019 07:41:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC1CE6E5D9;
...
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: Don't deballoon unused ggtt

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9202A11ED7D
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Dec 2019 23:08:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D5BE86EDF7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC v2 09/12] drm/i915/svm: Add functions to blitter
 copy SVM buffers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 826EB675E20
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Jan 2023 20:35:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89CD110EAFF;
...
Subject: [Intel-gfx] [PATCH v2 2/8] drm/i915: Fix coding style on

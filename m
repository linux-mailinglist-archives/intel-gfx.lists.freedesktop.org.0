...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83E3F925711
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jul 2024 11:41:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D953610E77F;
	Wed,  3 Jul 2024 09:41:37 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="i17faHdX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5403E10E777;
 Wed,  3 Jul 2024 09:41:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1719999696; x=1751535696;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=+jP85H8kxozrhg94zOHcbPE4J+4xpp0OjsT6CgcLaaY=;
 b=i17faHdXrYUm5ugtf6qgdTytO0QI6UbbUA0FUp8I34kQSNbRjc8ttkS1
 L1XSz2snovK21bCCS7S3wlTS45RWlRV37k5qayL8s3p4hGNdYgslxZdV3
 +TGyX7eV2ik2q36SrX/H0sgtD/okIt9IhvYn+DQiK+HPU2crIJOdWFqlz
 HLOzNuHnTnw2GilJfYZHcSPD2ECq6ia4CsUepd11E0AWFkHXHBWJvhh3b
 lUmBCqcIomJIQdbB6D099up4ROjA94TU/0/ZYS3kwkkBxgKodUPnoEUzO
 p1+3JMbfDHmIialfiW4EIHfRZSixr444WL7cLQ0Kx3v+CKXykTnQSV1+E w==;
X-CSE-ConnectionGUID: Fdl3IZrdR22EO2EvxGsaqQ==
X-CSE-MsgGUID: AkYe+9QZTUa0B7LTsK5xuw==
X-IronPort-AV: E=McAfee;i="6700,10204,11121"; a="27822916"
X-IronPort-AV: E=Sophos;i="6.09,181,1716274800"; d="scan'208";a="27822916"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jul 2024 02:41:36 -0700
X-CSE-ConnectionGUID: /iTOBSTrRHO29PUfLqngYw==
X-CSE-MsgGUID: yteakF27T+CoFQ1FbEa6Ig==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,181,1716274800"; d="scan'208";a="46261789"
Received: from oandoniu-mobl3.ger.corp.intel.com (HELO [10.245.244.224])
 ([10.245.244.224])
 by fmviesa010-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jul 2024 02:41:34 -0700
Message-ID: <6b075bf8-6599-4741-9845-d049c41f0f31@intel.com>
Date: Wed, 3 Jul 2024 10:41:31 +0100
MIME-Version: 1.0
...
References: <20240702150609.155245-3-matthew.auld@intel.com>
 <fd9d17462ad3aef9c4b5477a1a5ae7140842f105.camel@linux.intel.com>
Content-Language: en-GB
From: Matthew Auld <matthew.auld@intel.com>
In-Reply-To: <fd9d17462ad3aef9c4b5477a1a5ae7140842f105.camel@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D4D8D3A331
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Jan 2026 10:38:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEFAF10E3D4;
	Mon, 19 Jan 2026 09:38:11 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="XkwEc+B6";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A5F7310E3D3;
 Mon, 19 Jan 2026 09:38:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1768815489; x=1800351489;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WLVS8RjbpkZ+rASa4rOHbeQsVhdArAawTbPQTQT1Jzo=;
 b=XkwEc+B675N8leprVptLcQWmjfESyiIn2l+D5OJCAPoO1XceDrkwVgSz
 ebbsuc/say7TalHv0yGEf0OS+PgC9mBqQOTMYOBVCqJat78SWgu+7pHvr
 EXECaV06kyAhVDWndMm64lPZHZfkvze75AkRl7/rd7Pi6P2dcMBY8dKS/
 5DEppv0Zn45Bwt6SUeGPyFlh/yG2byy5L+wpqk3S1Gq+mIcw/jJQam/aV
 fOYUEx7vyS2V8MyHpCY2Kp3s0sdLflYaoTwByYWQu0bq381MhCnoAdKQt
 y9wML/wIgYuI9opgKd+HehqA63st+ZBevTEo3pNN31yf15THz4pcyB+f9 g==;
X-CSE-ConnectionGUID: vmD5BrNzStmVJ+0pZvphOA==
X-CSE-MsgGUID: vigVNzbPQr2AY27LewirLQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11675"; a="69224285"
X-IronPort-AV: E=Sophos;i="6.21,237,1763452800"; d="scan'208";a="69224285"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jan 2026 01:38:09 -0800
X-CSE-ConnectionGUID: Pqk24BVaSRKL0SrslBIZJw==
X-CSE-MsgGUID: fcu5HC5pTESmI33JCcin4A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,237,1763452800"; d="scan'208";a="210838392"
Received: from display-adls.igk.intel.com ([10.211.131.198])
 by orviesa005.jf.intel.com with ESMTP; 19 Jan 2026 01:38:08 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Mika Kahola <mika.kahola@intel.com>,
 Suraj Kandpal <suraj.kandpal@intel.com>
Subject: [CI 06/15] drm/i915/cx0: Create macro around PLL tables
Date: Mon, 19 Jan 2026 09:37:47 +0000
Message-ID: <20260119093757.2850233-7-mika.kahola@intel.com>

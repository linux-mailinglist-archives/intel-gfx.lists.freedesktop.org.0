...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BC732437B6C
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Oct 2021 19:05:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C66AE6EDB9;
...
Subject: Re: [Intel-gfx] [PATCH v2 06/17] drm/i915/xehpsdv: support 64K GTT
 pages

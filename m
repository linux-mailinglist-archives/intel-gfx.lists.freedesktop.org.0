...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6093881E74
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Aug 2019 16:02:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 128A46E4A5;
...
Subject: [Intel-gfx] [PATCH v6 15/17] drm/qxl: switch driver from bo->resv
 to bo->base.resv

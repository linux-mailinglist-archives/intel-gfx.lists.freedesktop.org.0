...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 749B86DD0D4
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Apr 2023 06:25:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2183910E49D;
	Tue, 11 Apr 2023 04:25:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7690910E480;
 Tue, 11 Apr 2023 04:24:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1681187096; x=1712723096;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=uWG4A5byZGVE8Uz/AAl63PysH6oGvkPM8lUknTdyTmk=;
 b=I9G7z3zEuekSsAjlkzSDQN8nw/uGPGHzQi6OdX5aXi0F+r9ugUPKr4PZ
 khh/4qcA6CCVDtVAuz49kKvYizmX4+cO1AVuGkfsxhEd0lY/sn2hWPXUt
 7RiMMSDbX6BrBd+angl/sc7mtLPqH6plYmq0GJVr4dMmrNrwj8aODHnMp
 4JOmT2Hwn8dEbYEe1eop2kviDrTJmnnPC+THgNpWoBKczf+dAXgskVKgj
 EO3H1Jpad+yhMGGQf+nzmsJVhNXyNtVYQeHF3O2f5j5osAZrhpaLwzFr4
 4W/mImTVkWDXc+HxqPb6OG266Ci5ZW5diIBF1CdqJSeYEnCZu4bcsn7rW g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10676"; a="343524165"
X-IronPort-AV: E=Sophos;i="5.98,335,1673942400"; d="scan'208";a="343524165"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Apr 2023 21:24:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10676"; a="777763926"
X-IronPort-AV: E=Sophos;i="5.98,335,1673942400"; d="scan'208";a="777763926"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Apr 2023 21:24:54 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon, 10 Apr 2023 21:26:11 -0700
Message-Id: <20230411042613.3178711-8-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH 7/9] drm/i915: use pat_index instead of
 cache_level
...
index 7a4b1d1afce9..f76ec2cb29ef 100644
...
index 1ac6f9f340e3..7db58a7e2101 100644
--- a/drivers/gpu/drm/i915/gt/uc/intel_uc_fw.c
+++ b/drivers/gpu/drm/i915/gt/uc/intel_uc_fw.c
@@ -877,9 +877,15 @@ static void uc_fw_bind_ggtt(struct intel_uc_fw *uc_fw)
 		pte_flags |= PTE_LM;
...
index 0a78bdbd36b1..f95fc134d71e 100644

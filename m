...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A89CC56904E
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Jul 2022 19:06:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87BD911A16D;
...
Subject: Re: [Intel-gfx] [RFT][PATCH v2 3/9] vfio/ccw: Only pass in
 contiguous pages

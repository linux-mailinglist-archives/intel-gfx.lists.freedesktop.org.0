...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9161E145986
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jan 2020 17:11:20 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD2C06F5C8;
...
Subject: Re: [Intel-gfx] [PATCH v3 1/2] drm: add
 drm_core_check_all_features() to check for a mask of features
...
Content-Type: multipart/mixed; boundary="===============1296441615=="

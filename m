...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02C176B7C10
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Mar 2023 16:37:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D06E10E0FE;
	Mon, 13 Mar 2023 15:37:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2437310E0FE;
 Mon, 13 Mar 2023 15:37:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678721829; x=1710257829;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=MTVTHVJ/jz8v56j5qWlFje7/kwXxBxhmiU8ER1vfN2c=;
 b=V9vQ3bt2pduavmx8eIwu6O9t9iXPeAvdBsHoXJUCNmcO/o7g4HPz95Jf
 YmhyQZ5yEica39PQRb7uVygRKN+tMID6BI/FKLvHodnKKAUBbhP8H3AWB
 +Op/Zde0l5mdMbkXjWxdPBjs+FErH65Z6NPROe9OTgRSKqSxm5QMPvKLI
 AC6Y41GYNpYcPOBcjqZvj9S7E+sX85h4S+GxeZGpATy4c4vixYb9ppmn8
 rYCy9l8Few4qwF8HNWtGWn4wHANyFgS85C1gW3TBBF7HaxFwTMIoAC06r
 +IQ4izHI+OB6TywKRb3b29v1ICg0adiX/VWAF1NaYCxMkq9ILBiy3Rc+J w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10648"; a="334652771"
X-IronPort-AV: E=Sophos;i="5.98,257,1673942400"; d="scan'208";a="334652771"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Mar 2023 08:37:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10648"; a="681074906"
X-IronPort-AV: E=Sophos;i="5.98,257,1673942400"; d="scan'208";a="681074906"
...
Received: from DS0PR11MB6373.namprd11.prod.outlook.com (2603:10b6:8:cb::20) by
 CY5PR11MB6461.namprd11.prod.outlook.com (2603:10b6:930:33::17) with
 Microsoft
...
To: "Christopherson,, Sean" <seanjc@google.com>, Paolo Bonzini
 <pbonzini@redhat.com>, Zhenyu Wang <zhenyuw@linux.intel.com>, "Wang, Zhi A"
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 13 Mar 2023 15:37:05.1551 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 02/27] KVM: x86/mmu: Factor out helper to
 get max mapping size of a memslot

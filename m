...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A50916BA71
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Feb 2020 08:16:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F2AAF6E9E8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC][PATCH 4/5] drm/i915: Introduce scaling filter

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 520C45EFA8D
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 18:31:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64DB610EACB;
	Thu, 29 Sep 2022 16:31:24 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 04/30] drm/atomic-helper: Rename

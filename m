...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63B3C5573EB
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jun 2022 09:28:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2AAFE113DEC;
	Thu, 23 Jun 2022 07:28:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0044B113DDF;
 Thu, 23 Jun 2022 07:28:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655969288; x=1687505288;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=SjxqH80cBDgjzPkHWeYts9zrrNLZ48+0pVTXImuLtBg=;
 b=kIKLEmXfPhfWNXU7DnWNx2tZK6kMW2oGnNZAC8Q41xpZWuZIhEjSlDbA
 SecBGJrejEmi+i3CaAXiuXb2br09r4MizzlYhV/5ukYOmu+jymSWSE3dg
 vDhQiPsDPQFRrXzo4zeYDkU0Wyp9CLMPLNXPBaykn6/lRERj7stsDhOqk
 mnE05ka3pCaW7vqY6V6fZuyQEy8Kc3EwVChiUT8ivefo58yE10uXQ5Dkw
 jIiTjzp92GmW24Z5FaQcaw4u+xAVc5UwNkugEQ/wN+LYnnZlRc7TVpd2T
 IZnTsHo4ychp2odH/vhm9i0udMvBSoq3rLan1UywRwVP1gluGG25i7CGl Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10386"; a="342333718"
X-IronPort-AV: E=Sophos;i="5.92,215,1650956400"; d="scan'208";a="342333718"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jun 2022 00:28:07 -0700
X-IronPort-AV: E=Sophos;i="5.92,215,1650956400"; d="scan'208";a="592582362"
Received: from gknielse-mobl.amr.corp.intel.com (HELO localhost)
 ([10.252.61.112])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jun 2022 00:28:05 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: Jani Nikula <jani.nikula@intel.com>,
	dri-devel@lists.freedesktop.org
Date: Thu, 23 Jun 2022 10:27:56 +0300
Message-Id: <20220623072756.1828069-1-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH] drm/i915/edid: convert DP,

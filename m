...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0389693E564
	for <lists+intel-gfx@lfdr.de>; Sun, 28 Jul 2024 15:15:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A761489F4F;
	Sun, 28 Jul 2024 13:15:22 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="groFh6fM";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A926410E19D;
 Sun, 28 Jul 2024 13:15:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1722172522; x=1753708522;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=t8/zR6wZpeIic8DqQVjxZX/IQw1gAwaQkNY4aBe1tn4=;
 b=groFh6fMdBLp2y6gAAQyO27NI4fWWyxhAcpLDzb09ac8US32L3M5v/yX
 P9yI89ccyo6HYc9yWM58QeWYPvg8ASIrbupLlk7oCIWj9az+mGd0hA+E6
 SwRTf7BxvL+CTyqHh2B3V0RR7YNV9+AGeEgXg0XRJSDKyHfrUtUcCA3th
 1i27rThjYZ1hsNFbPjRVGdM29QDkoCAeYHIHHw66+0MmD2F8Jf5D1euCn
 2ZNDG0zh9W43TDT7oujL4JJgwkHqo0XtYftwENwCHaKuSpDOmRkl8HThH
 /4cyIl9GVqQJZSrz90lmaQO96f5YYuMjhwNRXalWs3o7XJW1v7GQFhBQz w==;
X-CSE-ConnectionGUID: P62xn6V2SLO8BuUiWKMDjQ==
X-CSE-MsgGUID: UEaYUe61Q3a3Goim9r3tXA==
X-IronPort-AV: E=McAfee;i="6700,10204,11147"; a="23713415"
X-IronPort-AV: E=Sophos;i="6.09,243,1716274800"; d="scan'208";a="23713415"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2024 06:15:21 -0700
X-CSE-ConnectionGUID: L4ECNgH+TZSY7PznDVzvMA==
X-CSE-MsgGUID: +yMq9DfWTZ+JN5HAQioEtQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,243,1716274800"; d="scan'208";a="53389175"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2024 06:15:15 -0700
...
Subject: [PATCH v4 03/12] spi: intel-dg: implement spi access functions
Date: Sun, 28 Jul 2024 16:06:29 +0300
Message-Id: <20240728130638.1930463-4-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 967966082BF
	for <lists+intel-gfx@lfdr.de>; Sat, 22 Oct 2022 02:09:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89E0410E613;
	Sat, 22 Oct 2022 00:08:13 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 3/7] drm/i915/uc: use different ggtt pin

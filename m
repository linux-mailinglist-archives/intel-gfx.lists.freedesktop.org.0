...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C967F511C5D
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Apr 2022 18:29:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBD6710F468;
...
Subject: Re: [Intel-gfx] [PATCH v2 3/4] drm/i915/gt: Document the eviction
 of the Flat-CCS objects

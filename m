...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62DA41BCEB8
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Apr 2020 23:32:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5EFFD6EC0E;
	Tue, 28 Apr 2020 21:32:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EF1CE6E9D6
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Apr 2020 21:32:03 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21052153-1500050 
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Apr 2020 22:31:58 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 28 Apr 2020 22:31:55 +0100
Message-Id: <20200428213157.4683-4-chris@chris-wilson.co.uk>
...
index 52151001d7ab..a51cf5430264 100644
--- a/drivers/gpu/drm/i915/gt/intel_rps.c
+++ b/drivers/gpu/drm/i915/gt/intel_rps.c
@@ -45,6 +45,63 @@ static inline void set(struct intel_uncore *uncore, i915_reg_t reg, u32 val)
...
+
 ...
 {
 	u32 mask = 0;
@@ -742,8 +799,11 @@ void intel_rps_unpark(struct intel_rps *rps)
...
+		rps_start_timer(rps);
 	...
 	if (IS_GEN(rps_to_i915(rps), 5))
 		gen5_rps_update(rps);
@@ -754,6 +814,8 @@ void intel_rps_park(struct intel_rps *rps)
...
@@ -1211,6 +1273,19 @@ static unsigned long __ips_gfx_val(struct intel_ips *ips)
...
@@ -1255,7 +1330,9 @@ void intel_rps_enable(struct intel_rps *rps)
...
@@ -1274,6 +1351,7 @@ void intel_rps_disable(struct intel_rps *rps)
...
@@ -1689,6 +1767,7 @@ void intel_rps_init_early(struct intel_rps *rps)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 651F52322D3
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jul 2020 18:42:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C51BA6E584;
	Wed, 29 Jul 2020 16:42:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9BE8A6E581
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Jul 2020 16:42:24 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21971539-1500050 
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Jul 2020 17:42:18 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Jul 2020 17:42:18 +0100
Message-Id: <20200729164219.5737-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 2/3] drm/i915/gt: Switch to object allocations for
 page directories
...
index 4e6c1f7f48ef..fb702e1de739 100644
...
index a5f58ed219fe..8b9bd929ba45 100644
...
index cb848ee6a19d..05a2624116a1 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -586,11 +586,6 @@ struct i915_gem_mm {
 	 */
 	atomic_t free_count;

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D5EB7AC6E0E
	for <lists+intel-gfx@lfdr.de>; Wed, 28 May 2025 18:31:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 720E910E2B8;
	Wed, 28 May 2025 16:31:20 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=qsc.com header.i=@qsc.com header.b="KEcfV6YS";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-160.mimecast.com
 (us-smtp-delivery-160.mimecast.com [170.10.133.160])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 675FD10E616
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 May 2025 16:31:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=qsc.com;
 s=mimecast20190503; t=1748449878;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 in-reply-to:in-reply-to:references:references;
 bh=Mnbc5otDI4kGUoWjlJTYHFtL/ubNnYmoguEcndv5ioY=;
 b=KEcfV6YSwLyhaaMQJZVFeT37as08DbYkS/rZqU++RG6V1qU35GtKxCmSOQV23uOELNbU0w
 0JwTGzKT7zebhLygS4d2hI5j8AEycavPnmQvc9B4Gviopgb4zFAnBS7aDidJPEVQLGr7B4
 s5qeetMmBokokBy5fVEPdKYfAp7OsWs=
...
X-Mimecast-MFC-PROC-ID: LVpPNAdKS3PmjYpy90hlR4FPEYjXMFHPp5trZCvi2U0_1748449876

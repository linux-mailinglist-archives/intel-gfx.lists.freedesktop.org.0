...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id iGUUK20EAmo3nQEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 11 May 2026 18:31:41 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FC115122F6
	for <lists+intel-gfx@lfdr.de>; Mon, 11 May 2026 18:31:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7624110E811;
	Mon, 11 May 2026 16:31:39 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="JOsfAdU5";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5650810E811;
 Mon, 11 May 2026 16:31:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1778517098; x=1810053098;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=qypee8o4OnhatyoJVuVqh738NW8Qq1Z5e+5C/PD0lkY=;
 b=JOsfAdU5X9O0APZSXVwCxRsXP/fy0nQ8kJz4qSFMFgoctzVsz+kZaXcc
 0kKX8UprNpW6Qgdl0B71eYXjGm8TOtfO+yutiTTPhM9ugjL0qYzJeGuH6
 e3RR7WURthMKjRwm3NOOYnsRotc0g3vpGB/ZJvS9Mvpqe5TPUqdLl8be7
 q3W+gSnRso3LzGmz9csSJrOXyYgJaV3OTBYvB9FmILwcnFDTPpvyr8iiT
 W393g5ByVapK6kcBuVbRHZ31PTU6VKq8cuLA0BGR2oRTcZSPWhHyitSJA
 J/91frONOPqi9ZyT7IGD64WggThkZtnz/aMPEqKHLM4Ky+HstQBVLBFvg g==;
X-CSE-ConnectionGUID: iaYGmsTpQpuntobwiI6Jvg==
X-CSE-MsgGUID: yS5OhvtORwyOaG9d5D25Hg==
X-IronPort-AV: E=McAfee;i="6800,10657,11783"; a="83024174"
X-IronPort-AV: E=Sophos;i="6.23,229,1770624000"; d="scan'208";a="83024174"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2026 09:31:38 -0700
X-CSE-ConnectionGUID: JJotOjCkT5KO2xSriGaiqg==
X-CSE-MsgGUID: EL7ipZ2kQmWZJi5cMzqeLA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,229,1770624000"; d="scan'208";a="267858150"
Received: from khuang2-desk.gar.corp.intel.com (HELO [192.168.1.16])
 ([10.124.220.192])
 by orviesa002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2026 09:31:37 -0700
From: Gustavo Sousa <gustavo.sousa@intel.com>
Date: Mon, 11 May 2026 13:30:57 -0300
Subject: [PATCH v2 2/4] drm/i915/bw: Deduplicate intel_sa_info instances
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260511-separate-platform-from-diplay-ip-specific-bw-params-v2-2-e762cb8662da@intel.com>

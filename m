...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D7CAA67B0BF
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 12:11:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49CE510E790;
...
Subject: [Intel-gfx] [CI v8 3/4] drm/i915/opregion: convert

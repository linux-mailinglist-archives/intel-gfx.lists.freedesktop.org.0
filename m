...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25BB32D95F5
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Dec 2020 11:10:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D1F426E176;
	Mon, 14 Dec 2020 10:10:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F0AE86E171
 for <intel-gfx@lists.freedesktop.org>; Mon, 14 Dec 2020 10:10:03 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23317859-1500050 
 for multiple; Mon, 14 Dec 2020 10:09:59 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 14 Dec 2020 10:09:41 +0000
Message-Id: <20201214100949.11387-61-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 61/69] drm/i915/gt: Support creation of
 'internal' rings
...
@@ -1309,7 +1309,7 @@ static int print_ring(char *buf, int sz, struct i915_request *rq)
...
@@ -1718,13 +1718,6 @@ ktime_t intel_engine_get_busy_time(struct intel_engine_cs *engine, ktime_t *now)
 	return total;
 }
...
-
 ...
 {
@@ -1764,11 +1757,7 @@ intel_engine_find_active_request(struct intel_engine_cs *engine)
 			continue;
...
@@ -97,10 +106,12 @@ void intel_ring_unpin(struct intel_ring *ring)
...
@@ -108,8 +119,10 @@ static struct i915_vma *create_ring_vma(struct i915_ggtt *ggtt, int size)
 	struct i915_vma *vma;
...
+	}
 	...
 	if (IS_ERR(obj))
@@ -134,12 +147,14 @@ static struct i915_vma *create_ring_vma(struct i915_ggtt *ggtt, int size)
 }
...
@@ -148,8 +163,10 @@ intel_engine_create_ring(struct intel_engine_cs *engine, int size)
...
@@ -162,11 +179,12 @@ intel_engine_create_ring(struct intel_engine_cs *engine, int size)

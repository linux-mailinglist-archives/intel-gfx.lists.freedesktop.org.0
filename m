...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E5A9554583
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 12:59:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9FB310EA15;
...
Subject: [Intel-gfx] [PATCH v3 05/13] drm/edid: add

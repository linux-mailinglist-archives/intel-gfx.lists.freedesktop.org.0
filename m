...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B307570B7A
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:26:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 561828B372;
...
Subject: [Intel-gfx] [PATCH 26/32] docs: gpu: i915.rst: display: add
 kernel-doc markups

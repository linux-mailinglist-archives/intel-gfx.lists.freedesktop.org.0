...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C6221ADE78
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Apr 2020 15:39:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7BA5E6EBF2;
	Fri, 17 Apr 2020 13:39:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8ACA56EBE6
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Apr 2020 13:39:43 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 17 Apr 2020 15:39:19 +0200
Message-Id: <20200417133937.1980239-6-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/24] drm/i915: Parse command buffer earlier in
 eb_relocate(slow)
...
@@ -1737,7 +1759,7 @@ static int eb_prefault_relocations(const struct i915_execbuffer *eb)
 	return 0;
 }
...
+static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
 {
 	...
 	struct eb_vma *ev;
@@ -1788,6 +1810,11 @@ static noinline int eb_relocate_slow(struct i915_execbuffer *eb)
 		}
 	}
...
@@ -1820,7 +1847,7 @@ static noinline int eb_relocate_slow(struct i915_execbuffer *eb)
 	return err;
 }
...
@@ -2828,13 +2832,15 @@ i915_gem_do_execbuffer(struct drm_device *dev,

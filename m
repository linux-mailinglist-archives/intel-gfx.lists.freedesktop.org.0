...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BE1AE874081
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Mar 2024 20:36:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BBFCA11245D;
	Wed,  6 Mar 2024 19:36:25 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UFX6ckQK";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 87BD01133ED;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=BnzCTjp+yOwdDFzx3NxY9BptyCar9ndUvQKucjg0qvM=;
 b=UFX6ckQKSSY12xuQ+ooNKyi3MtvzIUC8kPpH/xsaoZPuG2NP4btsAXMx
 3uO2u27cYrT98mtVi9P92w1hFiyzmxrWxgph4SAvotTwhGrhngJilZ6OS
 D83A7YJjzaoTzZaRqTX7uGGydM0byJm1HP1LbFAXewVS/D1D+dtiG1Ttc
 0qUJGpNJ7ylJyDRN5TXTyjt1jKHM+XhOinqUGO2bTsCsZi+ujKzhqWbyK
 T/L+O8+W9jXCjMR8BB3LPH2OhTTbTaSERb/Zwi8y8tkxsCRqdHProYOds
 oQteUlFsrLzH72SZvgI0iIEaxMPCIUofrD6JLMBA3kBzOhidwGuIwmmes Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11005"; a="4246873"
X-IronPort-AV: E=Sophos;i="6.06,209,1705392000"; 
   d="scan'208";a="4246873"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Mar 2024 11:36:22 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,209,1705392000"; 
   d="scan'208";a="9841805"
...
Subject: [PATCH 2/5] drm/i915: Drop dead code for xehpsdv
Date: Wed,  6 Mar 2024 11:36:40 -0800
Message-ID: <20240306193643.1897026-3-lucas.demarchi@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CACE2A3797
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Nov 2020 01:17:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D6E066E563;
	Tue,  3 Nov 2020 00:17:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9236E6E59D
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Nov 2020 00:17:34 +0000 (UTC)
IronPort-SDR: ysd7xb2BuPMVJv0LM3EotXlpVuX1PDYgq47s5x44EkP6cYhJaH7FBiRDWNbOgObr0g97uD6E9U
 T1JUiNFbhNrg==
X-IronPort-AV: E=McAfee;i="6000,8403,9793"; a="155962136"
X-IronPort-AV: E=Sophos;i="5.77,446,1596524400"; d="scan'208";a="155962136"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Nov 2020 16:17:33 -0800
IronPort-SDR: i2zrWfIRw+QPnZiEkNQccFcfV12nGk6mVasc8JtTDlUI1trNpu4pSBKU2HmKiE58B9xTDWKkuc
 7PPF+iMEbvQw==
X-IronPort-AV: E=Sophos;i="5.77,446,1596524400"; d="scan'208";a="470573475"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 02 Nov 2020 16:17:32 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  2 Nov 2020 16:19:30 -0800
Message-Id: <20201103001932.11286-12-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v14 11/13] drm/i915: Link planes in a bigjoiner
 configuration, v3.
...
index 739ccbe0d8dc..71140494d728 100644
...
@@ -12803,26 +12803,180 @@ static bool check_single_encoder_cloning(struct intel_atomic_state *state,
 	return true;
 }
...
+		}
 	...
 	return 0;
@@ -12862,6 +13016,7 @@ static int icl_check_nv12_planes(struct intel_crtc_state *crtc_state)
...
@@ -12905,7 +13060,14 @@ static int icl_check_nv12_planes(struct intel_crtc_state *crtc_state)
...
@@ -15258,6 +15420,7 @@ static int intel_atomic_check_bigjoiner(struct intel_atomic_state *state,
 	struct drm_i915_private *dev_priv = to_i915(state->base.dev);
...
@@ -15268,6 +15431,12 @@ static int intel_atomic_check_bigjoiner(struct intel_atomic_state *state,
 			goto claimed;
 	}
...
@@ -15292,7 +15461,11 @@ static int intel_atomic_check_bigjoiner(struct intel_atomic_state *state,
...
@@ -16905,7 +17078,7 @@ intel_legacy_cursor_update(struct drm_plane *_plane,
...
index d24077df1711..edac4c249f5c 100644
...
index 9898c257d3e0..ae3ae2227260 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2AA58A135C
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Aug 2019 10:12:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 609306E043;
	Thu, 29 Aug 2019 08:12:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 34C7F6E043
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Aug 2019 08:12:08 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18299872-1500050 
 for multiple; Thu, 29 Aug 2019 09:11:56 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 29 Aug 2019 09:11:28 +0100
Message-Id: <20190829081150.10271-15-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/36] drm/i915: Push the i915_active.retire
 into a worker
...
dmUuYyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfYWN0aXZlLmMKaW5kZXggODk0OGY1NjMz
OTFhLi40NWNjYTZjOTdjOTcgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVf
...
bGUocmVmKSkKIAkJcmV0dXJuIC1FQlVTWTsKIApAQCAtNTQ3LDggKzU3Miw5IEBAIGludCBpOTE1
...
YS5jCmluZGV4IDZlNGQ4ODViMmNlMi4uYTVkNzBlZmJlOTdkIDEwMDY0NAotLS0gYS9kcml2ZXJz
...
X3ZtYV9wdXQoYWN0aXZlX3RvX3ZtYShyZWYpKTsKQEAgLTExNDAsNiArMTE0MSw3IEBAIGludCBp

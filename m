...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DA3D82E9C
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2019 11:23:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D843E6E33A;
	Tue,  6 Aug 2019 09:23:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 918FF6E33D
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Aug 2019 09:23:40 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17901479-1500050 
 for multiple; Tue, 06 Aug 2019 10:05:40 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Aug 2019 10:05:34 +0100
Message-Id: <20190806090535.14807-21-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 21/22] drm/i915: Extract intel_frontbuffer
 active tracking
...
X2Rpc3BsYXkuYwppbmRleCA5ZTRlZTI5ZmQwZmMuLmMxMWRjMTI3NDYxYSAxMDA2NDQKLS0tIGEv
...
bmVfd2lkdGgoY29uc3Qgc3RydWN0IGRybV9mcmFtZWJ1ZmZlciAqZmIsCkBAIC0xNDEzMyw5ICsx
NDEzNyw5IEBAIHN0YXRpYyB2b2lkIGludGVsX2F0b21pY190cmFja19mYnMoc3RydWN0IGludGVs
...
b21taXQoc3RydWN0IGRybV9kZXZpY2UgKmRldiwKQEAgLTE0NDE5LDcgKzE0NDIzLDcgQEAgaW50
...
LTE0NjgyLDEzICsxNDY4NiwxMiBAQCBpbnRlbF9sZWdhY3lfY3Vyc29yX3VwZGF0ZShzdHJ1Y3Qg
...
dGhlcmUgaXMgYSBtb2Rlc2V0IHBlbmRpbmcsCkBAIC0xNDc1NiwxMSArMTQ3NTksMTAgQEAgaW50
...
ZXdfcGxhbmVfc3RhdGU7CkBAIC0xNTU0MCwxNSArMTU1NDIsOSBAQCBzdGF0aWMgdm9pZCBpbnRl
...
ZXIpOwogCiAJa2ZyZWUoaW50ZWxfZmIpOwogfQpAQCAtMTU1NzYsNyArMTU1NzIsNyBAQCBzdGF0
...
OwogfQpAQCAtMTU1OTgsOCArMTU1OTQsMTEgQEAgc3RhdGljIGludCBpbnRlbF9mcmFtZWJ1ZmZl
...
YmplY3RfdW5sb2NrKG9iaik7CkBAIC0xNTcxNiw5ICsxNTcxNSw3IEBAIHN0YXRpYyBpbnQgaW50
...
dDsKIH0KIApAQCAtMTU3MzYsOCArMTU3MzMsNyBAQCBpbnRlbF91c2VyX2ZyYW1lYnVmZmVyX2Ny
...
bV9tbWFuLmMKaW5kZXggZGZhNTI1ZTM3ZWI4Li5hNmJhNzZiMDZjZDIgMTAwNjQ0Ci0tLSBhL2Ry
...
L2RybS9pOTE1L2dlbS9pOTE1X2dlbV9vYmplY3QuYwppbmRleCAwOWYxODQzZjkyNzQuLjI3ZTY2
MzNhNjRjZCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ2VtL2k5MTVfZ2VtX29i
...
CiAJCWF0b21pY19zZXQoJm9iai0+bW0ucGFnZXNfcGluX2NvdW50LCAwKTsKQEAgLTIyOSw2ICsy
MTQsOCBAQCB2b2lkIGk5MTVfZ2VtX2ZyZWVfb2JqZWN0KHN0cnVjdCBkcm1fZ2VtX29iamVjdCAq
...
cGxldGUsIGUuZy4KQEAgLTI2MCwxMyArMjQ3LDYgQEAgdm9pZCBpOTE1X2dlbV9mcmVlX29iamVj
...
RV9OT05FIHx8CkBAIC0yODksOCArMjY5LDcgQEAgaTkxNV9nZW1fb2JqZWN0X2ZsdXNoX3dyaXRl
...
L2k5MTUvaTkxNV9kZWJ1Z2ZzLmMKaW5kZXggMjNhYTk3ZTA5MWQ1Li5jOTI2ZWUyMmJkZDUgMTAw
NjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZGVidWdmcy5jCisrKyBiL2RyaXZl
cnMvZ3B1L2RybS9pOTE1L2k5MTVfZGVidWdmcy5jCkBAIC0xMzcsNyArMTM3LDYgQEAgZGVzY3Jp
...
JXMlcyVzIiwKQEAgLTIyNywxMCArMjI2LDYgQEAgZGVzY3JpYmVfb2JqKHN0cnVjdCBzZXFfZmls
...
ZXggMGQ5Y2NhZmQ5YThiLi42OGY3YzNkNDk5ZTIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2k5MTVfZHJ2LmgKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9kcnYuaApA
QCAtMjQ4MCwxMCArMjQ4MCw2IEBAIGludCBpOTE1X2dlbV9tbWFwX2d0dChzdHJ1Y3QgZHJtX2Zp
...
L2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCmluZGV4IDI3ZTBiNzdjMTUzMi4uYTYzM2EyMjg3ZWIz
IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCisrKyBiL2RyaXZl
cnMvZ3B1L2RybS9pOTE1L2k5MTVfZ2VtLmMKQEAgLTE0MCwxNyArMTQwLDE5IEBAIGk5MTVfZ2Vt
...
IAlyZXR1cm4gMDsKIH0KIApAQCAtNTk1LDcgKzU5Nyw3IEBAIGk5MTVfZ2VtX2d0dF9wd3JpdGVf
...
Y3RfdW5sb2NrX2ZlbmNlKG9iaiwgZmVuY2UpOwogCiAJcmV0dXJuIHJldDsKQEAgLTE3NDcsMzkg
KzE3NDksNiBAQCBpbnQgaTkxNV9nZW1fb3BlbihzdHJ1Y3QgZHJtX2k5MTVfcHJpdmF0ZSAqaTkx
...


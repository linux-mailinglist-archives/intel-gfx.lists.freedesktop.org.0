...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C33318BA71F
	for <lists+intel-gfx@lfdr.de>; Fri,  3 May 2024 08:34:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C90E91122C1;
	Fri,  3 May 2024 06:34:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="T3cHkfa2";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A8B631122C1
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 May 2024 06:34:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1714718071; x=1746254071;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=wjFS1+NbG2Vvr7sQVgcyDtGvUeFHdIugMx1Q11+bLFs=;
 b=T3cHkfa27O0VgPM0lnMNXaYpBNgVoWKa6CD3SBoCboGqoP0f9UcF2M0I
 EwLTF7250GPcNArYXtnlt/fd2u/BVRoIJJ0DupFsTQVwcNN4af5vUdg5J
 auMyiIah5nFOvWX71qpscnegEeqONnT9K9BRIfVCmjeRatHeG4FCc055X
 JlkLIrFnn9F4bXyOLvDoaVTjTi0fEAcmxXgzmF/ok9hIMF7Gue0NoXOYC
 /uR/EHBJgeUafOOYzorInJbeNFm8nmrSQl53zbisreXl8MAMSED2dYuh+
 bFozU10LyYLL4BYzWfdw4FLykBiwMboLdfckmRRtaxbcBmixAVyVF7l9p g==;
X-CSE-ConnectionGUID: XGYMJADSTUKbXu1bEsBHHA==
X-CSE-MsgGUID: c/UGAdPuQ+6aRwweowuD8Q==
X-IronPort-AV: E=McAfee;i="6600,9927,11062"; a="14302308"
X-IronPort-AV: E=Sophos;i="6.07,247,1708416000"; d="scan'208";a="14302308"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 May 2024 23:34:31 -0700
X-CSE-ConnectionGUID: 52KteBUaR0+hvMg4Ud6CSQ==
X-CSE-MsgGUID: T7FvAO9GR1GsMvl84cAu4g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,247,1708416000"; d="scan'208";a="50558693"
...
Subject: [PATCH v9 04/12] drm/i915/psr: Rename psr2_enabled as
 sel_update_enabled
Date: Fri,  3 May 2024 09:34:05 +0300
Message-Id: <20240503063413.1008135-5-jouni.hogander@intel.com>

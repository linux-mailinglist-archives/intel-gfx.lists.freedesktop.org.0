...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9ACA3153435
	for <lists+intel-gfx@lfdr.de>; Wed,  5 Feb 2020 16:41:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8D6E06F628;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 03/17] drm/i915/dp: Add compute routine for

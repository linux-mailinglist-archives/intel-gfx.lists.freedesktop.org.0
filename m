...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DB4B49ADB
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jun 2019 09:42:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CC7D6E10B;
	Tue, 18 Jun 2019 07:42:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EC4AC6E110
 for <intel-gfx@lists.freedesktop.org>; Tue, 18 Jun 2019 07:42:20 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16935629-1500050 
 for multiple; Tue, 18 Jun 2019 08:41:53 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 18 Jun 2019 08:41:29 +0100
Message-Id: <20190618074153.16055-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/26] drm/i915: Skip shrinking already freed
 pages
...

...
ZWVkKQogewpAQCAtMjI1LDggKzE5OCw3IEBAIHN0YXRpYyB2b2lkIF9faTkxNV9nZW1fZnJlZV9v
...
IC0zMjQsMjMgKzI5Niw2IEBAIHZvaWQgaTkxNV9nZW1fZnJlZV9vYmplY3Qoc3RydWN0IGRybV9n

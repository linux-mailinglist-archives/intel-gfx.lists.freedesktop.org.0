...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B0B173B9AA
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Jun 2023 16:16:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1B6910E642;
...
Subject: Re: [Intel-gfx] [PATCH v12 15/24] vfio-iommufd: Add detach_ioas

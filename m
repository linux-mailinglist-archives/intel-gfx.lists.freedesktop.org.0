...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F293E76BA5F
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Aug 2023 19:03:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 709C810E421;
...
Subject: [Intel-gfx] [PATCH v5 07/22] dyndbg: drop NUM_TYPE_ARRAY

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B7A47C90DE
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 00:49:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4461410E07D;
	Fri, 13 Oct 2023 22:48:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-il1-x12c.google.com (mail-il1-x12c.google.com
 [IPv6:2607:f8b0:4864:20::12c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EAAF710E664;
 Fri, 13 Oct 2023 22:48:47 +0000 (UTC)
Received: by mail-il1-x12c.google.com with SMTP id
 e9e14a558f8ab-3576e74ae9dso1716985ab.3; 
 Fri, 13 Oct 2023 15:48:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1697237327; x=1697842127; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=FJf8nz9XCWOdOBXn4gJwyy156oD7o8iJaWtn/j63gOE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1697237327; x=1697842127;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=FJf8nz9XCWOdOBXn4gJwyy156oD7o8iJaWtn/j63gOE=;
 b=
X-Gm-Message-State: AOJu0YweQbcvWee3bpzFTW34Nu2XDyd0H1V9XdIQm4yJ5cwmjB8fSdvz
 kV3mFfdr7WV5PsNMybE+/Hs=
X-Google-Smtp-Source: AGHT+IH31fIU2qtXKbkbcJz0sIbMlBk+W72IDTxHWJMYtYcu5NUBaKivSy2q80srnDve7UR9Y6WhjA==
X-Received: by 2002:a05:6e02:1a6f:b0:34f:bac9:f53d with SMTP id
 w15-20020a056e021a6f00b0034fbac9f53dmr35513554ilv.17.1697237326832; 
 Fri, 13 Oct 2023 15:48:46 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 t10-20020a92dc0a000000b003512c3e8809sm1683071iln.71.2023.10.13.15.48.45
...
Date: Fri, 13 Oct 2023 16:48:06 -0600
Message-ID: <20231013224818.3456409-15-jim.cromie@gmail.com>
...
Subject: [Intel-gfx] [PATCH v7b 14/25] dyndbg-API: fix
...
Cc: lb@semihalf.com, groeck@google.com, linux-doc@vger.kernel.org,
 ...
 Jim Cromie <jim.cromie@gmail.com>, mcgrof@kernel.org, seanpaul@chromium.org,
 joe@perches.com, bleung@google.com, yanivt@google.com

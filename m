...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 63D4A9C0741
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2024 14:26:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B8C310E836;
	Thu,  7 Nov 2024 13:26:16 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="foid3+VH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A13BF10E836;
 Thu,  7 Nov 2024 13:26:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1730985975; x=1762521975;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ojfmSwGGwRW1zwD4P7gOfq83jOalGiVuNgB7MGwny4g=;
 b=foid3+VHSsR/Tyj4kkdrwomyJLQNYokPQURL/SJVBNh/d5PblxNhelyh
 QXw03dISS4koV0DHwA9rMZpUGrsgyDLImvY3z0MV6q0VWWASI7Hj5L4Sa
 231CiMoofqhpQeO2cg7ViaGUkMYS4+IbFd5TB407VQdy4kjEWGbtgQyWM
 q9j4rZOTTZQdssfXnaTYCtEKpxFclTDpUgAwt2YW1a5Y8Wx0MgS5Ko3Ur
 8iRz3Q78em70jWbhBakNtbYpfpZCV3AlPx+m5ivqXvbTTAlMWpphLV7yh
 v0vXQf0IsWfvmdRNq36amPgK21DZdQt+hjUB/uO6ML3mzf6imZge8rk4L Q==;
X-CSE-ConnectionGUID: YR6IzYI8Ruqx3hCFLU7Tsg==
X-CSE-MsgGUID: mM3UDIpcSBOSn4rscq4NpA==
X-IronPort-AV: E=McAfee;i="6700,10204,11249"; a="34750750"
X-IronPort-AV: E=Sophos;i="6.12,266,1728975600"; d="scan'208";a="34750750"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 05:26:15 -0800
X-CSE-ConnectionGUID: RAoSQK65ROWmCpYMnB34nw==
X-CSE-MsgGUID: NBJ0YsCcQXWYs5oN7P3kbw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,266,1728975600"; d="scan'208";a="89921702"
Received: from sannilnx-dsk.jer.intel.com ([10.12.231.107])
 by orviesa005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 05:26:10 -0800
...
Subject: [PATCH v2 04/10] mtd: intel-dg: register with mtd
Date: Thu,  7 Nov 2024 15:13:50 +0200
Message-ID: <20241107131356.2796969-5-alexander.usyskin@intel.com>

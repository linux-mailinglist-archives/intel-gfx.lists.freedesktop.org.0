...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC22E18F7A1
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2020 15:52:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0BCCB6E26C;
	Mon, 23 Mar 2020 14:51:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x441.google.com (mail-wr1-x441.google.com
 [IPv6:2a00:1450:4864:20::441])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3439C6E23D
 for <intel-gfx@lists.freedesktop.org>; Mon, 23 Mar 2020 14:51:01 +0000 (UTC)
Received: by mail-wr1-x441.google.com with SMTP id p10so5022068wrt.6
 for <intel-gfx@lists.freedesktop.org>; Mon, 23 Mar 2020 07:51:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=ajR5dLK7zd/3v+8WpXJOKAdFiX9ApzmWPRFvMp354LA=;
 b=WmfhBL5ys3NyyQuAdm11b/euZ39Gs0CnPc5/SxrCpFLw3p1wFVzYoMdO5O096lYEP3
 ne7ChOrbi2de+rmneIyi4gQh67Sza75lnOx+kXuP3boMyaDTcwfaJ5VkRm5k8zdwYw5u
 HziiGGegbFXPOwmZeOU2NWhSJdn2VPB/hAXPk=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=ajR5dLK7zd/3v+8WpXJOKAdFiX9ApzmWPRFvMp354LA=;
 b=
X-Gm-Message-State: ANhLgQ3/XAgbxXYgOLHEo9cDza7+Y18Nm5adsoQ4HUjRaeB2G8xAeNdP
 Yl00zL4z+MDhd37wImqAaLH6YA==
X-Google-Smtp-Source: ADFU+vte+tHSyajzX9vNfo8THTb6CmeLw/x3L8SzuamX0cOO8NMrLEsza9y75FajLGH4xvoUu6cbaQ==
X-Received: by 2002:a5d:540c:: with SMTP id g12mr25693149wrv.178.1584975059739; 
 Mon, 23 Mar 2020 07:50:59 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id s22sm20376522wmc.16.2020.03.23.07.50.58
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 23 Mar 2020 07:50:59 -0700 (PDT)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Mon, 23 Mar 2020 15:49:44 +0100
Message-Id: <20200323144950.3018436-46-daniel.vetter@ffwll.ch>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20200323144950.3018436-1-daniel.vetter@ffwll.ch>
References: <20200323144950.3018436-1-daniel.vetter@ffwll.ch>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 45/51] drm/gm12u320: Simplify upload work

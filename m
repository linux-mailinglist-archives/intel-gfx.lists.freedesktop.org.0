...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C19A2436A3
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Aug 2020 10:37:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3EA96E9B2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/20] drm/pl111: Introduce GEM object functions

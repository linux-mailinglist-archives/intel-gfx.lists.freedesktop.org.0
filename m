...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E4A5A05FD2
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jan 2025 16:18:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A99FB10EBEA;
	Wed,  8 Jan 2025 15:18:32 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Fo/TNjzO";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AD3CC10EBE3
 for <intel-gfx@lists.freedesktop.org>; Wed,  8 Jan 2025 15:18:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1736349509; x=1767885509;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=NCSDE/OAOMTzOJm08SPkKbndPV21bMQR1KELcfbePXM=;
 b=Fo/TNjzOSTC0dEr/xnLS+GzgH8d1SQhZRTf4jUNHpwg+k9XhEVG7ZSsV
 WHlaJjI/PW1OyyjkRkI/1Y21stiLpdXlWJu5OEt6trdzDSl6pbf/jkt/N
 NcFEVqOoNQavKeH0z1L+z7a3NYOTHhpqcnlo+yt0QXXFuMYNfZxh1uI8e
 HdqkRu23kEmUnWH/N6D0QShXE4hFucMZHWO/wSq2IfYf/zjNt82ycNUiF
 gmoiwhbv4vYqv2e2NJMjbiERtUBg4I4MPNLORy5eTxLrvlcKMbJvmuD+3
 oicbOJx+MVs63vqOoKPAVrUOsGn6RLeOAFXVjiRtCBAWycreAqipkmtk6 A==;
X-CSE-ConnectionGUID: e1Sg7Z3DQm2RtsQ9cPjuCQ==
X-CSE-MsgGUID: 1BlTvPwRRTqmbZicsnfpPw==
X-IronPort-AV: E=McAfee;i="6700,10204,11309"; a="36694389"
X-IronPort-AV: E=Sophos;i="6.12,298,1728975600"; d="scan'208";a="36694389"
Received: from fmviesa009.fm.intel.com ([10.60.135.149])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jan 2025 07:18:29 -0800
X-CSE-ConnectionGUID: UACvWxgJRwG1mAzQN6MnDQ==
X-CSE-MsgGUID: s6N2tSwyRYCQbxSFXmIXmA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,298,1728975600"; d="scan'208";a="103626816"
...
Subject: [PATCH 2/5] drm/i915/dp_mst: Use intel_connector vs. drm_connector
 pointer in intel_dp_mst.c
Date: Wed,  8 Jan 2025 17:19:13 +0200
Message-ID: <20250108151916.491113-3-imre.deak@intel.com>
...
index 7ecd639d6f25b..a7bfedc5945ea 100644

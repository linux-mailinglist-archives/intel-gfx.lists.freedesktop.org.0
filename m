...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E2046AF800
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Mar 2023 22:50:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C928C10E14B;
...
Subject: Re: [Intel-gfx] [PATCH 2/2] drm/i915/gsc: Fix race between HW init
 and GSC FW load

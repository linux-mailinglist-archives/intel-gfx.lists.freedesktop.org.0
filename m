...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7B57517177
	for <lists+intel-gfx@lfdr.de>; Mon,  2 May 2022 16:25:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A450810EB10;
...
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915/gt: optimize the ccs_sz

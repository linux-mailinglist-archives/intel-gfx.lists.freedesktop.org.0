...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1990AD22F24
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jan 2026 08:51:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8E6FD10E705;
	Thu, 15 Jan 2026 07:51:30 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="B5pq4ZQa";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9987A10E6EF;
 Thu, 15 Jan 2026 07:51:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1768463488; x=1799999488;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=YKMp8XAVUuaw4AUS5dVMdmCHgpB9kjZ+n2qw49iSswc=;
 b=B5pq4ZQaNdkH/zkYotWBjYSFEHiNIz658Ss6Rgo/U+e3fT2up/qTgGoN
 ciaBcWn0sBcsXc0//5L5cuxkwCn0I07amuhbtETXwCdL8S2xo4fLLyYnO
 Ap0JC+CGiwLdyjNn3QeXydn426aOXE9T5V7YuNVjpNjqimaoV6+kcTQAV
 DLmnV42O7OCS+PylvvU7ngm42MQIp3l1M7EdYoa92uIuSvqSvxG+m25jI
 JjLrPvUVfiPoGvCcu4xpmSlwVEpbsQMFo0iw9xHz+XjsOTutryJtcbgOV
 T5tdQTpjHx1ERotM2VMBdCGMfzhQKF4eH2ipl04zyBD2sfdoVge+//Df8 g==;
X-CSE-ConnectionGUID: Fhbpvmm2Sk670xCBb0A03w==
X-CSE-MsgGUID: qC2jwaqrSkCfBMyaony9LQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11671"; a="92436234"
X-IronPort-AV: E=Sophos;i="6.21,226,1763452800"; d="scan'208";a="92436234"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jan 2026 23:51:28 -0800
X-CSE-ConnectionGUID: r296c971Q+ejZZcpf2fxqg==
X-CSE-MsgGUID: SjzjGDJBRyGr1COkfQdzYA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.21,226,1763452800"; d="scan'208";a="204101789"
Received: from display-adls.igk.intel.com ([10.211.131.198])
 by orviesa010.jf.intel.com with ESMTP; 14 Jan 2026 23:51:26 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Mika Kahola <mika.kahola@intel.com>,
 Suraj Kandpal <suraj.kandpal@intel.com>
Subject: [PATCH v3 15/15] drm/i915/display: Remove .clock member from
 eDP/DP/HDMI pll tables
Date: Thu, 15 Jan 2026 07:51:01 +0000
Message-ID: <20260115075101.2214842-16-mika.kahola@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1BFD34BACC9
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 23:40:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A25F10E8B6;
	Thu, 17 Feb 2022 22:40:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9825B10E8B6
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Feb 2022 22:40:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645137640; x=1676673640;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qiABUX2kM9crANppYT/eDgJRWa14D2eTDagC3FkwBYQ=;
 b=oDmj/mFUcpqy0z3n9Ac10eLMu6g17mtv0ZCglu+L61H5xtbZGK4oXNsj
 dhwjNPGNvfN4D2lGJ0Kh2+NJ2WGtpdPXtVD+RZ809YGIloT4c3d/lcBUP
 nHgOYNWUl3d3+dbHa9+K/29ENxn6IVhV9qFIH77xGJLH7XVJKOvGV5YJo
 uq40tHWT+AZeEquyCDbQHNAuAK6q6f/C1Ddgk0JlnJNBj/bXZhLU+y/Cc
 SUdLkrBnSAmXyhp5UH+q8WonL7WbNVesj9ZwDSOCrd3PPV9+z/IFK5nw5
 LwxgM5wJDZpvjYWkAY4LfZF++VViY/W/yF7rcdsD/jPas5BEG3RTTGWhy Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10261"; a="250744383"
X-IronPort-AV: E=Sophos;i="5.88,377,1635231600"; d="scan'208";a="250744383"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 14:40:40 -0800
X-IronPort-AV: E=Sophos;i="5.88,377,1635231600"; d="scan'208";a="545926195"
Received: from acushion-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.21.45])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 14:40:38 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 18 Feb 2022 00:40:22 +0200
Message-Id: <20220217224023.3994777-3-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [CI 3/4] drm/i915/reg: split out vlv_dsi_regs.h and
 vlv_dsi_pll_regs.h
...
index 1fe4be8d475c..0ef1d520987e 100644
...
-
 ...
 /*
@@ -8389,20 +8386,9 @@ enum skl_power_gate {
...
@@ -8491,125 +8477,6 @@ enum skl_power_gate {
...
@@ -8666,335 +8533,6 @@ enum skl_power_gate {
...
@@ -9234,118 +8772,6 @@ enum skl_power_gate {

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C06321FF1E
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9FDE76E9C0;
...
Subject: [Intel-gfx] [PATCH v2 10/59] drm/kmb: Part 2 of Mipi Tx
 Initialization

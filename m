...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7005A64239E
	for <lists+intel-gfx@lfdr.de>; Mon,  5 Dec 2022 08:32:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E538510E0FA;
	Mon,  5 Dec 2022 07:32:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from emeril.freedesktop.org (emeril.freedesktop.org
 [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTP id E56AF10E0FA;
 Mon,  5 Dec 2022 07:32:21 +0000 (UTC)
Received: from emeril.freedesktop.org (localhost [127.0.0.1])
 by emeril.freedesktop.org (Postfix) with ESMTP id DF321AA917;
 Mon,  5 Dec 2022 07:32:21 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============1301920918100834755=="
MIME-Version: 1.0
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Ankit Nautiyal" <ankit.k.nautiyal@intel.com>
Date: Mon, 05 Dec 2022 07:32:21 -0000
Message-ID: <167022554190.24406.12906635804703859096@emeril.freedesktop.org>
...
Subject: [Intel-gfx] =?utf-8?b?4pyXIEZpLkNJLklHVDogZmFpbHVyZSBmb3IgQWxp?=
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_111373v4_full absolutely need to be
  verified manually.
...
#### Possible regressions ####
  ...
  * igt@kms_big_fb@x-tiled-max-hw-stride-32bpp-rotate-180-async-flip:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-skl7/igt@kms_big_fb@x-tiled-max-hw-stride-32bpp-rotate-180-async-flip.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-skl9/igt@kms_big_fb@x-tiled-max-hw-stride-32bpp-rotate-180-async-flip.html
...
#### Warnings ####
  ...
  * igt@kms_ccs@pipe-d-bad-aux-stride-y_tiled_gen12_rc_ccs_cc:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-skl6/igt@kms_ccs@pipe-d-bad-aux-stride-y_tiled_gen12_rc_ccs_cc.html
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-skl6/igt@kms_ccs@pipe-d-bad-aux-stride-y_tiled_gen12_rc_ccs_cc.html

  * igt@kms_cursor_legacy@flip-vs-cursor@atomic-transitions:
    - shard-glk:          [FAIL][5] ([i915#2346]) -> [FAIL][6]
   [5]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-glk3/igt@kms_cursor_legacy@flip-vs-cursor@atomic-transitions.html
   [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-glk8/igt@kms_cursor_legacy@flip-vs-cursor@atomic-transitions.html
...
#### Suppressed ####
  ...
  * igt@i915_suspend@basic-s3-without-i915:
    - {shard-tglu-10}:    NOTRUN -> [INCOMPLETE][7]
   [7]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-tglu-10/igt@i915_suspend@basic-s3-without-i915.html

  * igt@kms_vblank@pipe-c-ts-continuation-idle-hang:
    - {shard-tglu-9}:     NOTRUN -> [SKIP][8] +42 similar issues
   [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-tglu-9/igt@kms_vblank@pipe-c-ts-continuation-idle-hang.html
...
#### Issues hit ####
  ...
  * igt@feature_discovery@psr2:
   ...
   [9]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-iclb2/igt@feature_discovery@psr2.html
   [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-iclb7/igt@feature_discovery@psr2.html

  * igt@gem_create@create-massive:
    - shard-skl:          NOTRUN -> [DMESG-WARN][11] ([i915#4991])
   [11]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-skl1/igt@gem_create@create-massive.html

  * igt@gem_exec_balancer@parallel-contexts:
    - shard-iclb:         [PASS][12] -> [SKIP][13] ([i915#4525]) +1 similar issue
   [12]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-iclb2/igt@gem_exec_balancer@parallel-contexts.html
   [13]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-iclb6/igt@gem_exec_balancer@parallel-contexts.html

  * igt@gem_exec_fair@basic-pace-share@rcs0:
    - shard-glk:          [PASS][14] -> [FAIL][15] ([i915#2842]) +1 similar issue
   [14]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-glk8/igt@gem_exec_fair@basic-pace-share@rcs0.html
   [15]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-glk5/igt@gem_exec_fair@basic-pace-share@rcs0.html

  * igt@gem_lmem_swapping@heavy-multi:
    - shard-glk:          NOTRUN -> [SKIP][16] ([fdo#109271] / [i915#4613]) +1 similar issue
   [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-glk4/igt@gem_lmem_swapping@heavy-multi.html

  * igt@gem_lmem_swapping@heavy-verify-multi:
    - shard-skl:          NOTRUN -> [SKIP][17] ([fdo#109271] / [i915#4613])
   [17]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-skl6/igt@gem_lmem_swapping@heavy-verify-multi.html

  * igt@gem_spin_batch@legacy@default:
    - shard-apl:          [PASS][18] -> [FAIL][19] ([i915#2898])
   [18]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-apl3/igt@gem_spin_batch@legacy@default.html
   [19]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-apl3/igt@gem_spin_batch@legacy@default.html

  * igt@i915_pm_rc6_residency@rc6-idle@vcs0:
    - shard-skl:          [PASS][20] -> [WARN][21] ([i915#1804])
   [20]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_12465/shard-skl10/igt@i915_pm_rc6_residency@rc6-idle@vcs0.html
   [21]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_111373v4/shard-skl10/igt@i915_pm_rc6_residency@rc6-idle@vcs0.html
...
<p>Serious unknown changes coming with Patchwork_111373v4_full absolutely n=
eed to be<br />
  verified manually.</p>
...
<ul>
<li>igt@kms_big_fb@x-tiled-max-hw-stride-32bpp-rotate-180-async-flip:<ul>
...
ride-32bpp-rotate-180-async-flip.html">INCOMPLETE</a></li>
</ul>
</li>
</ul>
<h4>Warnings</h4>

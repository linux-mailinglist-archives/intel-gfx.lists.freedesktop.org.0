...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9021A8FB6F4
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Jun 2024 17:26:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5465810E4CB;
	Tue,  4 Jun 2024 15:26:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Hecb7yaz";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BB0F510E062;
 Mon,  3 Jun 2024 21:16:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1717449397; x=1748985397;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=tlqIk89T8jQQSVmtTnCrE2nqrUqZQzhWeOmNMFsrflE=;
 b=Hecb7yazCNHb8IcJDVX+28qejfW+Nb08UvI0eH+6xJr8dshinN7AYBNa
 BTu/ZvS0guRI5IoOsvwg/+1IYD8SlO3a33BY7mHBiWvkbZsjl23PwXzGT
 5ohOwgCI/2zA5vGexitiTb0rTysracXxMluwImT6dqa5bxAgtyWhmBlqd
 0GGgO02h3/ssFOk8QtJrleZzeM1ikcNFLw/+/xapFnPtermJH1IgPhkTF
 4wxqOvNJ80lcVVsFjBAyYtADy+Io54sJGnUOo9j/DjXJd3iZFI8oVFVlC
 6V8WuoItNk2rk+lV6BMGWDpwrH7Yc50NNH8/oJ64YIZSUBrL6m7J0Tq4l Q==;
X-CSE-ConnectionGUID: QLGQvcfPQxme3UJtY6Pa3w==
X-CSE-MsgGUID: AbPjYmvBRYOH5mOAOjT2SQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11092"; a="16903780"
X-IronPort-AV: E=Sophos;i="6.08,212,1712646000"; d="scan'208";a="16903780"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Jun 2024 14:16:34 -0700
X-CSE-ConnectionGUID: VMFphpWmTXumsNt62gtWrg==
X-CSE-MsgGUID: 6qKPpYysQ5m7/AKdn3RuqA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,212,1712646000"; d="scan'208";a="36940494"
Received: from black.fi.intel.com ([10.237.72.28])
 by orviesa010.jf.intel.com with ESMTP; 03 Jun 2024 14:16:22 -0700
...
Cc: Michael Ellerman <mpe@ellerman.id.au>, Nicholas Piggin <npiggin@gmail.com>,
 ...
 Brian Foster <bfoster@redhat.com>, Zhihao Cheng <chengzhihao1@huawei.com>,
...
Subject: [PATCH v1 1/1] treewide: Align match_string() with
 sysfs_match_string()
...
X-Mailman-Approved-At: Tue, 04 Jun 2024 15:26:35 +0000

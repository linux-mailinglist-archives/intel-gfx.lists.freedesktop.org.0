...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 89DD91075DC
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Nov 2019 17:33:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5308F6E3D2;
...
Subject: Re: [Intel-gfx] [PATCH v2 1/2] drm: call drm_gem_object_funcs.mmap
 with fake offset

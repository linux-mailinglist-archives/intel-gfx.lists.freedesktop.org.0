...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 854913CBD02
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jul 2021 21:59:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A20E6E9D3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/51] drm/i915/guc: Remove GuC stage descriptor,
 add LRC descriptor

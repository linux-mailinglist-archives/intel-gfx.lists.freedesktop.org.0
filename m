...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 78FAF7B6527
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Oct 2023 11:13:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0FD710E2E3;
	Tue,  3 Oct 2023 09:13:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ABDAE10E2CB;
 Tue,  3 Oct 2023 09:13:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1696324420; x=1727860420;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=OA9403j95c2N0l87VPui951h12A66/k0Bih+qrZH7rI=;
 b=U483pLB4D+WBy+3oaM7TqGMrj9q+z8PT6yUoWwfZBKYInLj2LbVduWef
 AnETf7DOwPQfHzo9DshjTYQD+QQE58cUZFmQ/tV+ylNDG79oINjE/PA3D
 mb3kurWeSzxAMtSV2VkdjULtttwcldmJ5DuryoO3f8kDnQ/wcXEJwStYK
 F+tEFyrn1cgg7B11s70r2Py4oP9B0W6u1XfgCyeopdY6jNfhg1V+6JskO
 wyyfSz+HV/SGSPG1y66GGuSLNM12wM1nU+TOSIy2MrrAIXPvU551x89qF
 1c2jZIKpZ+BODGbRo5S2uOqjAzJf95WN6II6ejaX87tiFLYIWT1e25HVJ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10851"; a="1419754"
X-IronPort-AV: E=Sophos;i="6.03,196,1694761200"; 
   d="scan'208";a="1419754"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Oct 2023 02:13:40 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10851"; a="997935805"
X-IronPort-AV: E=Sophos;i="6.03,196,1694761200"; d="scan'208";a="997935805"
Received: from jkrzyszt-mobl2.ger.corp.intel.com (HELO
 jkrzyszt-mobl2.intranet) ([10.213.14.111])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Oct 2023 02:13:36 -0700
From: Janusz Krzysztofik <janusz.krzysztofik@linux.intel.com>
To: igt-dev@lists.freedesktop.org
Date: Tue,  3 Oct 2023 11:10:53 +0200
Message-ID: <20231003091044.407965-19-janusz.krzysztofik@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH i-g-t 8/9] lib/kunit: Fetch a list of test cases
 in advance

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7343060E4DF
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Oct 2022 17:36:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C50C610E366;
	Wed, 26 Oct 2022 15:35:29 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 22/23] drm/vc4: vec: Add support for more
 analog TV standards

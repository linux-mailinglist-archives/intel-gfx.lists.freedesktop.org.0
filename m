...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 304264BEDE3
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:26:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5DC0610E573;
	Mon, 21 Feb 2022 23:26:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C875210E567;
 Mon, 21 Feb 2022 23:26:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645485984; x=1677021984;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qlFqLRfrfrx4mNRF6vVIBqvEiaofH2gyPUSV1nRx1WA=;
 b=H2QlixSCCO/k0jeBbJRIVe91h/qu0mX9ipkzAbe1PJifYCkzwxtLTZ1F
 qjW0Pq6HZEtlmXPkShT63gYPTAvLMlzzIukzp8N4EDqd1UlmwwPP4dKlt
 c4gY9vb18INkO/XBoxNHawr+SwZmYML08jvljClFYFb2wgFZHaOj41tRt
 xIbn9qS+uC1l/2MIQlU2OETSE4Zz8/nbrkyOh5NGfgPqujqYRPW96uPUT
 DC2l54UOBxf9H3Gp3na2PadYAsn6IziEqnyq8L/nxkddaZS0dhW+dMkNC
 jWA8RvB+b5w5XMBt30g+fLXO/fj8q1IQyvUbE/Y/1XpSEyW9vVC+cwv0B w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10265"; a="235119462"
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="235119462"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2022 15:26:24 -0800
X-IronPort-AV: E=Sophos;i="5.88,386,1635231600"; d="scan'208";a="706397062"
...
Date: Tue, 22 Feb 2022 00:25:40 +0100
Message-Id: <20220221232542.1481315-10-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 09/11] drm/i915: Track leaked gt->wakerefs

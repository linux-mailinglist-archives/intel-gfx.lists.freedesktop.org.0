...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3375061177E
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Oct 2022 18:27:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3247010E86E;
	Fri, 28 Oct 2022 16:27:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9918310E86E
 for <intel-gfx@lists.freedesktop.org>; Fri, 28 Oct 2022 16:26:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666974419; x=1698510419;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=YHFWuoghLuJu9VRgIsP3jwvNl0xh+CXbEtMccja/akA=;
 b=VcEIAdSEmLCetedjDoIGM/25TXCP7ZspwCqtAVQsv3yR6ipLL/axThhK
 xI2k7tLdYhX2cx/L8m/staiIouu5iFCGnQFGffEL/9kX2kzvH3vULSogU
 8vfwZMMw9FaVQKsD8yZL/frVQOpuskgHOgfIfj5mRP6WRxhTB9I+ZyEMM
 MktAJXOK46/6g1yP1WM1lnGGdQzAGggp41FRsbfmD8tlYPydnllzGqHsT
 O32ZeIRybIqibKVYp0vsTaFo33kSxUMbMz0KTQ9p9Ls8pwmqgJfqPxApb
 KUU0okH4EWlLCrju/+WsirG4tAGx0qdDQcVs3DGRO5iFsWT9AqaBWOWfv g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10514"; a="310228327"
X-IronPort-AV: E=Sophos;i="5.95,221,1661842800"; d="scan'208";a="310228327"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2022 09:26:59 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10514"; a="666118056"
X-IronPort-AV: E=Sophos;i="5.95,221,1661842800"; d="scan'208";a="666118056"
Received: from ahamill-mobl2.ger.corp.intel.com (HELO [10.252.29.35])
 ([10.252.29.35])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2022 09:26:57 -0700
Message-ID: <ba4bd74b-5ef3-f2cf-c368-832b57e6d78a@intel.com>
Date: Fri, 28 Oct 2022 17:26:55 +0100
MIME-Version: 1.0
...
References: <20221028155029.494736-1-matthew.auld@intel.com>
 ...
 <DM5PR11MB1324A61D1E24A2E0C2F4DBE4C1329@DM5PR11MB1324.namprd11.prod.outlook.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DA764E0EE
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jun 2019 09:09:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 562F26E812;
	Fri, 21 Jun 2019 07:09:01 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9C2EF6E81D
 for <Intel-gfx@lists.freedesktop.org>; Fri, 21 Jun 2019 07:08:32 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 21 Jun 2019 00:08:32 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.63,399,1557212400"; d="scan'208";a="171133237"
Received: from yyosef-mobl.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.252.23.42])
 by orsmga002.jf.intel.com with ESMTP; 21 Jun 2019 00:08:31 -0700
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Fri, 21 Jun 2019 08:07:57 +0100
Message-Id: <20190621070811.7006-19-tvrtko.ursulin@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [CI 19/33] drm/i915: Compartmentalize i915_ggtt_init_hw
...
aW5kZXggNjI5NjgzYzUyZTUwLi42Zjg2YzhlMDUxZmUgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2k5MTVfZ2VtX2d0dC5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVf
Z2VtX2d0dC5jCkBAIC0zNTE2LDQ1ICszNTE2LDY1IEBAIGludCBpOTE1X2dndHRfcHJvYmVfaHco
...
IHRvIEtNUyB0cmFuc2l0aW9uLgpAQCAtMzU2Niw3ICszNTg2LDcgQEAgaW50IGk5MTVfZ2d0dF9p

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1780736C1EA
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Apr 2021 11:41:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 24E616E925;
...
Subject: [Intel-gfx] [PATCH v2 11/13] vfio/mdev: Remove mdev_parent_ops

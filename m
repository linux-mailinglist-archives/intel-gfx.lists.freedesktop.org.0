...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 02729227BC4
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Jul 2020 11:31:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 565F96E52F;
	Tue, 21 Jul 2020 09:30:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 482F76E52F
 for <intel-gfx@lists.freedesktop.org>; Tue, 21 Jul 2020 09:30:56 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21882540-1500050 
 for multiple; Tue, 21 Jul 2020 10:30:49 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 21 Jul 2020 10:30:49 +0100
Message-Id: <20200721093049.27798-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20200721091909.20671-1-chris@chris-wilson.co.uk>
References: <20200721091909.20671-1-chris@chris-wilson.co.uk>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] HAX sched/core: Paper over the ttwu() race
 [take two]
...
index 6148aa6ff26d..525229c4955b 100644
...
-
 	if (sched_feat(TTWU_QUEUE) && ttwu_queue_cond(cpu, wake_flags)) {
 		if (WARN_ON_ONCE(cpu == smp_processor_id()))
 			return false;
@@ -2641,8 +2638,10 @@ try_to_wake_up(struct task_struct *p, unsigned int state, int wake_flags)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47585B526C2
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Sep 2025 04:59:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D43FA10EA02;
	Thu, 11 Sep 2025 02:59:34 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="LT5Be3o6";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AE38B10EA00;
 Thu, 11 Sep 2025 02:59:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1757559573; x=1789095573;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=fnlY5kmK4MaxqyM/XkYUy0gBEVDatQp032/qApNgyS8=;
 b=LT5Be3o66CLHU3dGaWDU4m84rEM4dDO4FU9VrlVwmt5ueGzO4AxB3L9E
 Kz4ApOCWXThfN8Bxc+EjHmxJwcK8cFTG75796wGFxbtRJ07VvO8jIHnq6
 tSGZQFqw1z5kYa9i91vTLUEinxwUhN5Zh5lFflJ/zCaRr7Tug/1SaqzXK
 noizYtyuUt5JqNfGh9cDaViWkgkQnzWtuIgX/XGgU+d8m3Nv6QN7CkMQz
 3R55Wceng4hgN2fqXvJm2AQ34aqT8NhZmj5fShPtHTqWeTRgPsz6B/SbY
 F1ckppZgWve2/bAKh/U1NE4HxHp+/DVsZ4nvmNscb99E3yV4jKXA+u4Hw g==;
X-CSE-ConnectionGUID: bXmZqlAETD2qPgfT3vrJpg==
X-CSE-MsgGUID: qsXsGMFSSnamBsbBtZC+EQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11549"; a="85327059"
X-IronPort-AV: E=Sophos;i="6.18,256,1751266800"; d="scan'208";a="85327059"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2025 19:59:33 -0700
X-CSE-ConnectionGUID: ey5v2XuiSPCEP2EDfFSdcg==
X-CSE-MsgGUID: /QDvkE2JTAayZrubuTBoRA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,256,1751266800"; d="scan'208";a="173955507"
...
Subject: [PATCH 04/15] drm/i915/skl_scaler: Introduce helper for chroma
 downscale factor
Date: Thu, 11 Sep 2025 08:15:43 +0530
Message-ID: <20250911024554.692469-5-ankit.k.nautiyal@intel.com>

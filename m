...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DCC76418B
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Jul 2019 08:45:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2CB8E89A5D;
	Wed, 10 Jul 2019 06:45:27 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5F5348999C
 for <intel-gfx@lists.freedesktop.org>; Wed, 10 Jul 2019 06:45:16 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17193828-1500050 
 for multiple; Wed, 10 Jul 2019 07:45:05 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 10 Jul 2019 07:44:54 +0100
Message-Id: <20190710064454.682-14-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.22.0
In-Reply-To: <20190710064454.682-1-chris@chris-wilson.co.uk>
References: <20190710064454.682-1-chris@chris-wilson.co.uk>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/14] drm/i915/gt: Use intel_gt as the primary
...

...
IAl9CiAKIAkvKgpAQCAtNDMyMiw3ICs0MzIzLDcgQEAgdm9pZCBpbnRlbF9maW5pc2hfcmVzZXQo
...
dGUpOwpAQCAtNDM2Miw3ICs0MzYzLDcgQEAgdm9pZCBpbnRlbF9maW5pc2hfcmVzZXQoc3RydWN0
...
Y3J0YyAqY3J0YykKQEAgLTEzODQ3LDE4ICsxMzg0OCwyMSBAQCBzdGF0aWMgdm9pZCBpbnRlbF9h
...
ZXh0LmMKaW5kZXggNjAwMDE3NzQ3MmVlLi4wNWZjNzc5MWIyYzMgMTAwNjQ0Ci0tLSBhL2RyaXZl
...
cnMvZ3B1L2RybS9pOTE1L2dlbS9pOTE1X2dlbV9tbWFuLmMKaW5kZXggMzkxNjIxZWUzY2JiLi5h
NTY0YzFlNDIzMWIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2dlbS9pOTE1X2dl
...
cy5oIgpAQCAtMjQ2LDcgKzI0OCw3IEBAIHZtX2ZhdWx0X3QgaTkxNV9nZW1fZmF1bHQoc3RydWN0
...
OwogCQlnb3RvIGVycl9ycG07CkBAIC0zMjYsNyArMzI4LDcgQEAgdm1fZmF1bHRfdCBpOTE1X2dl
...
YmplY3RfdW5waW5fcGFnZXMob2JqKTsKQEAgLTMzOSw3ICszNDEsNyBAQCB2bV9mYXVsdF90IGk5
...
eCAzYWJlMTVhMDhiNmQuLjJlOTI3ZjQ1NjZkMyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJt
...
ZHJtL2k5MTUvZ3Qvc2VsZnRlc3RfdGltZWxpbmUuYwppbmRleCA5ZjMxMDAxMzU1OTAuLmQ1NDEx
MzY5Nzc0NSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3Qvc2VsZnRlc3RfdGlt
...
ZXN0LmgiCkBAIC04MzQsNyArODM1LDcgQEAgaW50IGludGVsX3RpbWVsaW5lX2xpdmVfc2VsZnRl
...
ZXggY2UxYjY1Njg1MTVlLi5jZjUxNTU2NDY5MjcgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2Ry
bS9pOTE1L2k5MTVfZGVidWdmcy5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZGVi
dWdmcy5jCkBAIC0xMDA3LDE1ICsxMDA3LDE2IEBAIHN0YXRpYyB2b2lkIGk5MTVfaW5zdGRvbmVf
...
KCFpOTE1X21vZHBhcmFtcy5lbmFibGVfaGFuZ2NoZWNrKSB7CkBAIC0xMDIzLDE5ICsxMDI0LDE5
...
LApAQCAtMTA1MCwxMCArMTA1MSwxMCBAQCBzdGF0aWMgaW50IGk5MTVfaGFuZ2NoZWNrX2luZm8o
...
bmUtPmhhbmdjaGVjay5pbnN0ZG9uZSk7CiAJCX0KIAl9CkBAIC0xMDYxLDIzICsxMDYyLDYgQEAg
...
cHJpdmF0ZSAqaTkxNSA9IG5vZGVfdG9faTkxNShtLT5wcml2YXRlKTsKQEAgLTM1NTQsNyArMzUz
OCw4IEBAIHN0YXRpYyBjb25zdCBzdHJ1Y3QgZmlsZV9vcGVyYXRpb25zIGk5MTVfY3VyX3dtX2xh
...
LUVJTzoKQEAgLTM1NzQsMTEgKzM1NTksMTEgQEAgaTkxNV93ZWRnZWRfc2V0KHZvaWQgKmRhdGEs
...
ZW5naW5lIG1hc2sgPSAlbGx4IiwgdmFsKTsKIAlyZXR1cm4gMDsKIH0KIApAQCAtMzYyMSw4ICsz
NjA2LDkgQEAgaTkxNV9kcm9wX2NhY2hlc19zZXQodm9pZCAqZGF0YSwgdTY0IHZhbCkKIAkJICB2
...
dXRvLXJlc3RhcnRzCiAJICogb24gaW9jdGxzIG9uIC1FQUdBSU4uICovCkBAIC0zNjU3LDggKzM2
NDMsOCBAQCBpOTE1X2Ryb3BfY2FjaGVzX3NldCh2b2lkICpkYXRhLCB1NjQgdmFsKQogCQltdXRl
...
RCkKQEAgLTQzMTIsNyArNDI5OCw2IEBAIHN0YXRpYyBjb25zdCBzdHJ1Y3QgZHJtX2luZm9fbGlz
...
ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2Rydi5oCmluZGV4IGY5ODc4Y2JlZjRkOS4uMTAzYjllZTc1
NTM3IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2Rydi5oCisrKyBiL2Ry
...

...

...


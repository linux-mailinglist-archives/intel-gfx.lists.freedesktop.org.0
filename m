...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4334D7A8E53
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Sep 2023 23:20:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 30E7210E565;
	Wed, 20 Sep 2023 21:20:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 61DF210E55E
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=+OrWhnj14E/eLd69FbKKfxbYzTNBSHAclwePQCnCdJk=;
 b=M+3UHIbHkl2UTA4SOX2kX9/EXrub+o7j8RLVtpxuaL03JOAZ6dx22itG
 T4ERhIJUU6NmOPMgv+UnRJc477FjUHrSX8gC9em1cKI6s9xlVNpdx3Nhn
 rcak4Uhok7/FcHy4KY8BEBAKUt4MRkLhVVmG7ifjAH/XzPIA9E4URnlnJ
 CJWz3CF56e8rOhSIRlWLdg3vr6FI3z/2kRy5vmgZEhnuooSxWfmWgi6J2
 +rueOX/n+x0wuEFq/ZXN6Zt1bkLVkSbfDoIu/7FlfsvOnauODbPg3rnaB
 qM/3h6GKQsIEiI5ahh1lwAater/D133gCmeUCys1pD+tH/IaDm6oShnoC A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10839"; a="359726909"
X-IronPort-AV: E=Sophos;i="6.03,162,1694761200"; d="scan'208";a="359726909"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Sep 2023 14:17:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10839"; a="812320027"
X-IronPort-AV: E=Sophos;i="6.03,162,1694761200"; d="scan'208";a="812320027"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Sep 2023 14:17:48 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 20 Sep 2023 14:07:03 -0700
Message-Id: <20230920210704.3624771-4-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 3/4] drm/i915: Add WABB blit for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1570E5B0974
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 18:00:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5634F10E7BE;
	Wed,  7 Sep 2022 16:00:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 71FCE10E7BC
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Sep 2022 16:00:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1662566410; x=1694102410;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=czKBK1I1t6IX3MrJeeUjnEh9lCUYn7EwGmpszO7xZsU=;
 b=XtHQ2qLil961TnCbVk9j8OA0hvqblnez28hp312CxKh43Kx3iCB1Yp8t
 qv2alFIB8Opmlfg1endgPE/t/X7729UjxQrSkqGGXF19miruckBEsTpz/
 3/D+drBgtUkrm1oxiozdEsk2c6POH3YA0Mb57dKych9KICnLyU9rwQ548
 fqCe1rA+cYVZHeVsbNwe0zKX9bPEtnpheUe+A5n/r4CMsFvt/zsPgrVJA
 HjWeaUcYrab6Cdr8a69mQda00V4Y78XCYzA7Kopdyt42rZTSXSGJIsD9I
 xIV/MEZabUXF6b0h4yBrK6N40du3XK5VU8kMmyNFh1hwDdIB0ODu0lX9Q w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10463"; a="297701734"
X-IronPort-AV: E=Sophos;i="5.93,297,1654585200"; d="scan'208";a="297701734"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2022 08:59:45 -0700
X-IronPort-AV: E=Sophos;i="5.93,297,1654585200"; d="scan'208";a="676248308"
...
Date: Wed,  7 Sep 2022 18:58:12 +0300
Message-Id: <20220907155813.1427526-16-tomas.winkler@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 15/16] drm/i915/gsc: allocate extended

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 88FB41369BC
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18BD66E9D2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/23] drm/radeon: Convert to struct

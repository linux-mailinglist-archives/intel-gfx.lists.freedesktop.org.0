...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A93AD29A429
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Oct 2020 06:34:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 89C2F6EACF;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v3 02/16] drm/i915/hdcp: Get conn while

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D8731628011
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Nov 2022 14:03:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BBFB10E2D2;
	Mon, 14 Nov 2022 13:01:47 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v9 24/25] drm/vc4: vec: Add support for more
 analog TV standards

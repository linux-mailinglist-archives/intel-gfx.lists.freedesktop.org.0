...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 43CC71916EA
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Mar 2020 17:52:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 372EE6E4D2;
	Tue, 24 Mar 2020 16:51:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 80D206E4B7
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Mar 2020 16:51:50 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 24 Mar 2020 17:51:28 +0100
Message-Id: <20200324165146.1032624-3-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/21] drm/i915: Remove locking from
...
index e0ea3e48f2b0..a9b149d60737 100644
...
index dd2961715fe1..322aff9e0668 100644
--- a/drivers/gpu/drm/i915/gvt/cmd_parser.c
+++ b/drivers/gpu/drm/i915/gvt/cmd_parser.c
@@ -1870,10 +1870,14 @@ static int perform_bb_shadow(struct parser_exec_state *s)
 		goto err_free_bb;
 	}
...
+
 	...
 	if (IS_ERR(bb->va)) {
 		ret = PTR_ERR(bb->va);
@@ -1898,6 +1902,7 @@ static int perform_bb_shadow(struct parser_exec_state *s)
 	if (ret)
 		goto err_unmap;
...
@@ -1924,6 +1929,8 @@ static int perform_bb_shadow(struct parser_exec_state *s)
...
index cb311a6349cc..1effd4b96459 100644
--- a/drivers/gpu/drm/i915/i915_gem.c
+++ b/drivers/gpu/drm/i915/i915_gem.c
@@ -330,12 +330,20 @@ i915_gem_shmem_pread(struct drm_i915_gem_object *obj,
 	u64 remain;
 	int ret;
...
@@ -729,12 +737,20 @@ i915_gem_shmem_pwrite(struct drm_i915_gem_object *obj,
 	u64 remain;
 	int ret;

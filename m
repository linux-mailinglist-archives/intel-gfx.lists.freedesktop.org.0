...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EDDF23A727
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Aug 2020 15:04:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79DB26E27A;
...
Subject: [Intel-gfx] [RFC PATCH 00/17] Drop uses of pci_read_config_*()
 return value

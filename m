...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 296F1621EB4
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Nov 2022 22:51:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2A6A10E064;
	Tue,  8 Nov 2022 21:51:49 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [Nouveau] [PATCH v7 06/23] drm/modes: Add a
 function to generate analog display modes

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB4CD2C4FB9
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Nov 2020 08:51:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 824B76E843;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 03/18] drm/i915/hotplug: Handle CP_IRQ for
 DP-MST

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 329AB77F900
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Aug 2023 16:31:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FD1910E4B9;
...
Subject: [Intel-gfx] [PATCH 09/18] drm/i915/dp: Add functions to get min/max

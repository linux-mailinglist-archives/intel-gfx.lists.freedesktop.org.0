...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 879F754287C
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 09:51:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C95E10EF34;
	Wed,  8 Jun 2022 07:51:51 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 13/15] drm/edid: add HF-EEODB support to EDID
 read and allocation

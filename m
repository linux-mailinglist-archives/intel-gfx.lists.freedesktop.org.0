...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D1D0C46BE0
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jun 2019 23:30:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E7AD8999E;
	Fri, 14 Jun 2019 21:30:02 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 16/59] drm/hisilicon: Drop

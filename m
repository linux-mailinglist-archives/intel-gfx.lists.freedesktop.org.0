...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6017B30ACBC
	for <lists+intel-gfx@lfdr.de>; Mon,  1 Feb 2021 17:37:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAE1B89CDE;
	Mon,  1 Feb 2021 16:37:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 004B489CDE
 for <intel-gfx@lists.freedesktop.org>; Mon,  1 Feb 2021 16:37:13 +0000 (UTC)
IronPort-SDR: TAgnFpHMjdu2MwmOTe4UymN7FKLlFj51HuYKqBR5KPMJtjcAzkuspYLZyQa9C1B90uJj6kcHX5
 iGtuD6Nllv3g==
X-IronPort-AV: E=McAfee;i="6000,8403,9882"; a="168394461"
X-IronPort-AV: E=Sophos;i="5.79,392,1602572400"; d="scan'208";a="168394461"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2021 08:37:12 -0800
IronPort-SDR: WGl23/NbBD7XGhvYz7wOMa9p/g3QZ4Ppx5wUI754k5Cmr9PpCG5wGhodhrXuELaxjWveZ4g1O/
 mw4WSC3WPEOg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.79,392,1602572400"; d="scan'208";a="577878533"
Received: from gaia.fi.intel.com ([10.237.72.192])
 by fmsmga006.fm.intel.com with ESMTP; 01 Feb 2021 08:37:11 -0800
Received: by gaia.fi.intel.com (Postfix, from userid 1000)
 id 6BAD35C1F82; Mon,  1 Feb 2021 18:37:06 +0200 (EET)
From: Mika Kuoppala <mika.kuoppala@linux.intel.com>
To: Chris Wilson <chris@chris-wilson.co.uk>, intel-gfx@lists.freedesktop.org
In-Reply-To: <20210201085715.27435-3-chris@chris-wilson.co.uk>
References: <20210201085715.27435-1-chris@chris-wilson.co.uk>
 <20210201085715.27435-3-chris@chris-wilson.co.uk>
Date: Mon, 01 Feb 2021 18:37:06 +0200
Message-ID: <87czxj218t.fsf@gaia.fi.intel.com>
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH 03/57] drm/i915/selftests: Exercise

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AC4F3B958E
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 19:36:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C1DC6EB71;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 0/2] drm/i915: IRQ fixes

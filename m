...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02D30546FF6
	for <lists+intel-gfx@lfdr.de>; Sat, 11 Jun 2022 01:21:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D142B11AFAD;
...
Subject: [Intel-gfx] [PATCH 1/3] iosys-map: Add per-word read

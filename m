...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 55C8C43679E
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Oct 2021 18:24:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFECC6ECCB;
...
Subject: Re: [Intel-gfx] [PATCH v3 02/10] vfio/ccw: Use functions for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AD384140A6C
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jan 2020 14:08:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC3EB6E4FE;
	Fri, 17 Jan 2020 13:08:53 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 54C5F6E4FE
 for <intel-gfx@lists.freedesktop.org>; Fri, 17 Jan 2020 13:08:52 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 19916239-1500050 for multiple; Fri, 17 Jan 2020 13:08:50 +0000
MIME-Version: 1.0
To: Matthew Auld <matthew.william.auld@gmail.com>
From: Chris Wilson <chris@chris-wilson.co.uk>
In-Reply-To: <157926305863.2389.1610916410403647851@skylake-alporthouse-com>
References: <20200116203150.923826-1-matthew.auld@intel.com>
 ...
 <157926305863.2389.1610916410403647851@skylake-alporthouse-com>
Message-ID: <157926652734.2389.11661018962198755251@skylake-alporthouse-com>
User-Agent: alot/0.6
Date: Fri, 17 Jan 2020 13:08:47 +0000

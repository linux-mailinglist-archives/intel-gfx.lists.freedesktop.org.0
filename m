...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C5B939711D
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Jun 2021 12:16:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E6ACB6E9E7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/21] drm/i915/xelpd: Add color capabilities of
 SDR planes

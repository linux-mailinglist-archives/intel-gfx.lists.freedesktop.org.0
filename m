...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 203E33EE715
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Aug 2021 09:22:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C7C8891CB;
...
Subject: Re: [Intel-gfx] [PATCH 12/22] drm/i915/guc: Don't touch

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 521841C0ADA
	for <lists+intel-gfx@lfdr.de>; Fri,  1 May 2020 01:08:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F0BAB6EA2E;
	Thu, 30 Apr 2020 23:08:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 230276EA3B
 for <intel-gfx@lists.freedesktop.org>; Thu, 30 Apr 2020 23:08:32 +0000 (UTC)
IronPort-SDR: yTv+gOLlyU6Vf1zJ51qOOQyfsseOe1PBHkTEpdlPsfz/reODNdyBOyhqWwXcJXbCMb520pckoM
 hmOcH7yJx91w==
...
IronPort-SDR: 2fzzQDzTKv+Z45blAuGoSqji4j5SBlN2/u4C3t1LGyH8ZKpS1HUEq86yInPHkpvlX1qW2kDdPl
 6VU55dNktVmQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,337,1583222400"; d="scan'208";a="405581161"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by orsmga004.jf.intel.com with ESMTP; 30 Apr 2020 16:08:30 -0700
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 30 Apr 2020 16:09:45 -0700
Message-Id: <20200430230951.2508-6-manasi.d.navare@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 05/11] drm/i915: Try to make bigjoiner work
 in atomic check
...
index d043057d2fa0..be41268c962e 100644
--- a/drivers/gpu/drm/i915/display/intel_atomic.c
+++ b/drivers/gpu/drm/i915/display/intel_atomic.c
@@ -268,14 +268,15 @@ void intel_crtc_free_hw_state(struct intel_crtc_state *crtc_state)
...
index 3269b3f4691d..75aa621e85c1 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -7987,9 +7987,24 @@ static int intel_crtc_compute_config(struct intel_crtc *crtc,
...
@@ -8050,7 +8065,7 @@ static int intel_crtc_compute_config(struct intel_crtc *crtc,
...
@@ -12408,7 +12423,7 @@ static bool encoders_cloneable(const struct intel_encoder *a,
...
+static bool check_single_encoder_cloning(struct intel_atomic_state *state,
 ...
 {
@@ -12417,7 +12432,7 @@ static bool check_single_encoder_cloning(struct drm_atomic_state *state,
...
@@ -12647,6 +12662,7 @@ static int intel_crtc_atomic_check(struct intel_atomic_state *state,
...
+	    !crtc_state->bigjoiner_slave &&
 		...
 		if (ret)
@@ -13152,18 +13168,31 @@ static bool check_digital_port_conflicts(struct intel_atomic_state *state)
 }
...
@@ -13186,7 +13215,49 @@ static void intel_crtc_copy_hw_to_uapi_state(struct intel_crtc_state *crtc_state
 }
...
+				 struct intel_crtc_state *crtc_state)
 {
 	struct intel_crtc *crtc = to_intel_crtc(crtc_state->uapi.crtc);
 	struct drm_i915_private *dev_priv = to_i915(crtc->base.dev);
@@ -13222,16 +13293,16 @@ intel_crtc_prepare_cleared_state(struct intel_crtc_state *crtc_state)
...
-	struct drm_atomic_state *state = pipe_config->uapi.state;
 	...
 	struct drm_connector_state *connector_state;
@@ -13273,7 +13344,7 @@ intel_modeset_pipe_config(struct intel_crtc_state *pipe_config)
...
@@ -13311,7 +13382,7 @@ intel_modeset_pipe_config(struct intel_crtc_state *pipe_config)
...
@@ -13368,8 +13439,6 @@ intel_modeset_pipe_config(struct intel_crtc_state *pipe_config)
...
@@ -14681,6 +14750,75 @@ static bool intel_cpu_transcoders_need_modeset(struct intel_atomic_state *state,
 	return false;
 }
...
+
  ...
  * @dev: drm device
@@ -14713,19 +14851,36 @@ static int intel_atomic_check(struct drm_device *dev,
 					    new_crtc_state, i) {
...
@@ -15033,7 +15188,9 @@ static void intel_update_crtc(struct intel_atomic_state *state,
...
index c9bc1dd63f79..4b85ded0ddea 100644
--- a/drivers/gpu/drm/i915/display/intel_display_types.h
+++ b/drivers/gpu/drm/i915/display/intel_display_types.h
@@ -1061,6 +1061,15 @@ struct intel_crtc_state {
 	/* enable pipe csc? */
 	bool csc_enable;
...
index bca1f1547c74..422dc1c61b79 100644
--- a/drivers/gpu/drm/i915/display/intel_dp.c
+++ b/drivers/gpu/drm/i915/display/intel_dp.c
@@ -2231,6 +2231,15 @@ static int intel_dp_dsc_compute_config(struct intel_dp *intel_dp,
...
@@ -2248,12 +2257,12 @@ static int intel_dp_dsc_compute_config(struct intel_dp *intel_dp,
...
@@ -2269,14 +2278,15 @@ static int intel_dp_dsc_compute_config(struct intel_dp *intel_dp,

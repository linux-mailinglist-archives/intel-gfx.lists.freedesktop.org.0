...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 175E113C04E
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 13:18:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D8966E99C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 14/21] drm/stm: Convert to struct

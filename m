...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D23539163B
	for <lists+intel-gfx@lfdr.de>; Wed, 26 May 2021 13:33:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B3D506EC97;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 03/15] drm/i915: Fix i915_sg_page_sizes to

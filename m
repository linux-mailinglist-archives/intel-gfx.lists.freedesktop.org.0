...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A47832C9F77
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Dec 2020 11:36:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E0916E560;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 03/20] drm/ast: Remove references to struct
 drm_device.pdev

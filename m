...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C55375A1F3
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jul 2023 00:32:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D70E10E131;
	Wed, 19 Jul 2023 22:31:59 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 980B110E131;
 Wed, 19 Jul 2023 22:31:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689805917; x=1721341917;
 h=date:from:to:cc:subject:message-id:references:
 content-transfer-encoding:in-reply-to:mime-version;
 bh=iSgUXay9sZyjqgyEGcd3mDzHb2OvOGoXVGwHtqSigko=;
 b=lWZPvuy2AiN50qG1SOu+KH4u2tsXB8ZlSAM64hPiTHWrOIFApg7nNfq+
 FQIIaKHGTZsDKpJsvbbDBP88ZGubs/YZB9l6XxsNV/xr1SuhFjhxsosdT
 jQbDV5erqOpZ9ryaHpEuUWq1RNw+D3Ot95gshPt9P6WyMKngzdEUJhmHr
 yMrJ+HyEgtjgZfHEOrUY+aACdt+NN2dObOtggLXShOwEXmoYOBFGhtCMg
 cypA899BlFzKL1/FQhdpzB9ztVBZAcEfRty0ONJT4XyczGCwQVD/lbbxs
 l0wEC9J/anl7ZEwZjkfcmDL+fBB9l7AZR6MM8v6IX1spxgA4bINeGNA91 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="452959318"
X-IronPort-AV: E=Sophos;i="6.01,216,1684825200"; d="scan'208";a="452959318"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Jul 2023 15:31:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="898077151"
X-IronPort-AV: E=Sophos;i="6.01,216,1684825200"; d="scan'208";a="898077151"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
 by orsmga005.jf.intel.com with ESMTP; 19 Jul 2023 15:31:56 -0700
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 fmsmsx603.amr.corp.intel.com (10.18.126.83) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27; Wed, 19 Jul 2023 15:31:55 -0700
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
...
Received: from fmsedg602.ED.cps.intel.com (10.1.192.136) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27 via Frontend Transport; Wed, 19 Jul 2023 15:31:55 -0700
Received: from NAM10-BN7-obe.outbound.protection.outlook.com (104.47.70.107)
 by edgegateway.intel.com (192.55.55.71) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.27; Wed, 19 Jul 2023 15:31:54 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=jHvL/cNWTf/HADOIbzcTa3pFuLVq4b3fCwtUg2Va/NE=;
 b=
...
Received: from DS7PR11MB7859.namprd11.prod.outlook.com
 ...
 22:31:48 +0000
Date: Wed, 19 Jul 2023 15:31:43 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Message-ID: <20230719223143.GP138014@mdroper-desk1.amr.corp.intel.com>
...
X-MS-TrafficTypeDiagnostic: DS7PR11MB7859:EE_|SN7PR11MB8284:EE_
X-MS-Office365-Filtering-Correlation-Id: 660d9785-d3f0-41fd-4afc-08db88a7efe2
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DS7PR11MB7859.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230028)(39860400002)(376002)(396003)(366004)(346002)(136003)(451199021)(6486002)(478600001)(6666004)(54906003)(1076003)(186003)(26005)(6506007)(6512007)(30864003)(2906002)(6916009)(5660300002)(8676002)(316002)(66476007)(41300700001)(4326008)(66946007)(8936002)(66556008)(38100700002)(82960400001)(33656002)(86362001)(83380400001)(66899021)(559001)(579004);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?wIhWvvrSGf1KcjMpsENEEdI9Gzmmv1pKYSnMFk1PwZ+V4WHFLzcUMw6Vh0?=
 =?iso-8859-1?Q?JUiaTyQhCigJy7/rF5U1olGzomDaLTxEKqUT1pWaO+gzydpAOD+K9dyr/L?=
 =?iso-8859-1?Q?mOL15344UE3NFRJYx2brir+35nWt5wcwvD5Lo7jIFYdzcCkeXR1ajaZlFs?=
 =?iso-8859-1?Q?A/4GtNPbZtplMccL2DSzM+HeZgi9fN6t3aOPxaNj+KlGbnq5c9TEq4sAk6?=
 =?iso-8859-1?Q?KL1m1024PSIaNmjLN7lq5j5seP28HoruZOO5nHDMvMWVVEvOwkk8S22fu4?=
 =?iso-8859-1?Q?xgHjytEDi4OuU52Q/MrbdmmVnhGE98+pWa29dMZq0hm+PTdXQy1vtR8Xk0?=
 =?iso-8859-1?Q?nr/a+bbX3Y16sciafFSiNBEKujSWWggBOJSKneDv/Q5e0pVlgslLofhV5M?=
 =?iso-8859-1?Q?VGQA4EJ9J2yvmwQWZJ86IBQYcFNHEN5d/Ez/BGloihpj1Fr7mv5T1kTWjT?=
 =?iso-8859-1?Q?uDhVn8s526CkQPdh8bYr5Msbiq/jCwLIzKPrDMIo9U4Xndv84tXaIT/ppz?=
 =?iso-8859-1?Q?6ppsCxcdS0mApHAhNYeJ49gqNyFrneZCtAFveM/8WpbTXGIDhOkwRwDtay?=
 =?iso-8859-1?Q?yyJA/VZ4bp9n79jLd3hRb6hxdyLshxqOUV6GEi1kXK2F+77T+bU5XXw5Mm?=
 =?iso-8859-1?Q?8Npe4rTiiforuCnOQrW/orHO2RHyZmrTDKbD8ck3KOQLXinU/vBU4i0c0T?=
 =?iso-8859-1?Q?k4n2tyCVBSC2mBluxb0c7vLFue0gIbcotiaiLRZ059enMGCe4UsbXfE7KP?=
 =?iso-8859-1?Q?U1gYI10XeqJRr0JzW8fVzr3ID/Ao1RleL4HrBpq8NP/eZYAj+tD2Lz8NAs?=
 =?iso-8859-1?Q?5FMjc7vcOW6OrOQAABm3aCsXlxd/o23/ZOwUv/I2nTUFuteWQzHFfUksJ7?=
 =?iso-8859-1?Q?Ex2bb6og4tr4QGvJZuHYKV+/XtwPFqQKuzXuOG/5xDnlImOSAV53DSt5wN?=
 =?iso-8859-1?Q?rIUc+7x7+wRycR3isXiO+EQoIeHfCuCG3xBg5kOUbPCzUo2nXuCZARrueb?=
 =?iso-8859-1?Q?LdMRK7kJHXlDFpBV7Vs5V9fIn0vblwgzKzaLJB2hvcgBfHK3Dmfiqh8sW7?=
 =?iso-8859-1?Q?ZAPL2A73qx5tZjwKh8O6CzAnY5vnstx9neMT9niyeZ/33kJUu4Mw+wdcDX?=
 =?iso-8859-1?Q?efU0+z1buHGaEFPnWgaH3ykkKMAE8I2s02xcYpaUajLrFR8AurSxaVWgwY?=
 =?iso-8859-1?Q?KhYkLVDxx+oNj/OD+qdGxHrf5ZxVmnbqz+N+rlDL4T5P81ZmO4Y9rM7frB?=
 =?iso-8859-1?Q?wY/EULgvNOCJwmFmipIuIQi9ywxEvnNG2IbK1osL+y45B2H927+YFSwUm7?=
 =?iso-8859-1?Q?u7Hn3sRML1B4yxRpxOXpwRiLM2FJCmKTThpZp+fAglXJGTF9ej0NDV/6Gt?=
 =?iso-8859-1?Q?71ATDqQ29QPsL/RJRNgfTwKrQfJFGyTHgzySfTL++4HgjRWwjPFAGED5ve?=
 =?iso-8859-1?Q?ggFc1odXn/fifudkz/Mxl7e3rxWqYUUTxq2u1Sxo0jocy8Ecu89pHW2zz4?=
 =?iso-8859-1?Q?u7YMNfszCISOIENNC/F2YYnXupFnjih3bkmzfhwxpAVQNC8e2ECVX4u5IQ?=
 =?iso-8859-1?Q?jLT7/SR4aSqurFQdb2kdbj3f7jkK4DzMyeJrpktHu5LQoTFPaqhoDRbkWZ?=
 =?iso-8859-1?Q?IxBTnhXZJFJgKnZ0cS5bVbAHvKr8N1nCcZbWzvQ8dy2ACrY3kiS4a2sg?=
 =?iso-8859-1?Q?=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 660d9785-d3f0-41fd-4afc-08db88a7efe2
X-MS-Exchange-CrossTenant-AuthSource: DS7PR11MB7859.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 19 Jul 2023 22:31:47.7663 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: C8BgfgDIkZco8CEk13I6SjLWA4Vo32VSp4rDBV77Z1wlYPOq/iPrXPa0/kFIODw1MDTE50CU/ZoXGIsY7yFZHodL8k/2jKfQILoWwrcZcNw=
X-MS-Exchange-Transport-CrossTenantHeadersStamped: SN7PR11MB8284
X-OriginatorOrg: intel.com
Subject: Re: [Intel-gfx] [PATCH v3] drm/i915: Refactor PAT/object cache
 handling
...
>  49 files changed, 468 insertions(+), 488 deletions(-)
...
snooping platforms (like MTL) as the commit states?  My understanding
...
would only hurt performance (flushing more often than we truly need to)
...
> index 97ac6fb37958..f8e2b570dc42 100644
...
It's going to get confusing about what exactly I915_CACHE_MODE refers to
as the PAT meaning becomes more detailed and complicated on future
platforms (e.g., bspec 71582).  But I guess that's something to figure
out in the Xe driver; it works okay on the platforms i915 supports
today.
...
Not a dealbreaker, but the -1/0/1 return feels a bit ugly and I worry
that it's easy for people to forget that it isn't just a simple boolean
when adding new calls to this function.

What if we just make this return a boolean, but add an extra parameter
that's a "return this if you can't tell" value?
...
> +	i915_cache_t cache = INTEL_INFO(i915)->cache_modes[obj->pat_index];
> +
> +	if (I915_CACHE_FLAGS(cache) & BIT(flag))
> +		return 1;
> +	else if (obj->pat_set_by_user)
> +		return -1; /* Unknown, callers should assume no. */
> +	else
...
>  
>  /**
> @@ -177,29 +204,24 @@ void i915_gem_object_set_cache_coherency(struct drm_i915_gem_object *obj,
...
> +	 *
> +	 * (Also treat unknown PAT as potential risk.)
> +	 */
> +	has_wb_mode = i915_gem_object_has_cache_mode(obj, I915_CACHE_MODE_WB);
> +	if (has_wb_mode == -1 ||
> +	    (has_wb_mode == 1 &&
...
> +	     i915_gem_object_has_cache_flag(obj, I915_CACHE_FLAG_COH1W) == 0))
> +		return true;
> +
> +	return false;
>  }
...
For all these modern PTE / PDE encoding functions, I think we could
handle encoding of the PAT better if we replaced these switch statements
with something like
...
(and using the GGTT bit numbers instead of PPGTT numbers when
appropriate).  All of that could then be separated out into vfuncs and
initialized properly according to platform + GTT type.

But that's work for a different series; no need to worry about it for
this review.
...
> index 000000000000..07b99ef929d4
> --- /dev/null
...
It feels like these should technically be in intel_gt, not the i915
device.  Current platforms (and the upcoming ones in the near future)
happen to use identical PAT settings for both primary and media GTs but
that isn't technically guaranteed to continue forever.  Even if a
platform plans to have identical behavior for both GTs, it's also
possible that one GT can have hardware defects/workarounds that change
coherency behavior of that GT without impacting the other one.

Maybe it doesn't matter too much for i915 at this point since we'll be
moving to a new driver soon, but something to think about when working
on this stuff for Xe at least.
...
> new file mode 100644
> index 000000000000..d3c4b0dbce1a
> --- /dev/null
...
> +
> +#define I915_CACHE(mode) ((i915_cache_t)(I915_CACHE_MODE_##mode))
> +
...
Where does the [9] come from?  Xe_LPG and Xe_LPM+ technically have 16,
although we only use 5 of them at the moment and don't let userspace
request the higher ones.  I think PVC is the platform where we use the
most so far, but it still only has 8 (0..7).


Anyway, this patch looks good overall to me; the only feedback I gave
that might be a blocker is the one in i915_gem_object_can_bypass_llc if
I'm not overlooking something there.  The rest of the feedback you can
take or ignore as you see fit.

It's a pretty long, complicated patch, so you might want to get a
detailed review from someone with more domain-specific expertise in this
area, but assuming there's either a fix or justification for the
i915_gem_object_can_bypass_llc note, the rest is
...
> index 12aa7fbb0748..c94582efb8d8 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D806577BBF
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:41:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D0E27A9DF8;
	Mon, 18 Jul 2022 06:39:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 39/41] nouveau-dbg: add 2 verbose-classmaps
 for CLI, SUBDEV

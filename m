...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D85A5F98C7
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Oct 2022 09:00:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3953310E666;
	Mon, 10 Oct 2022 06:59:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 72CF310E642;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=9aKiRXtZ/Wp32nTzYVxCUCrqexdr0gN93Mx2buZDaVs=;
 b=NoI9pESFw19YOOnJJzf4RzcopfM0iK6X9aSzz9tOIMrxga7E6cUnbujp
 LIR07rHZb8jjpDwpCr7eE2UTt9kxfrTNYitbW3ZacgrHSRDsCjXm9pGP0
 UsiiXp33zyGpO3z8ONcRqh6oKkO/qCG9yxuATFuuag0v+7mKUv8jBwlPF
 XcqzhfSIO62NClC7OnX61JK1+dVl+lK4C9Yryt3RiiZnc46AYv6ea4uPr
 dgQ8entc9KahKnfJfB3+LH+OLiMnj5hwFRLQvMVQBnwvl3t7nwBswIR4k
 WKV5frXBVBJTWrgzTFPKXFnFRK0jSQdIHhTqrBdj/TBik732Q+WW5S0b1 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10495"; a="305753006"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="305753006"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2022 23:58:55 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10495"; a="576947152"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="576947152"
...
Date: Sun,  9 Oct 2022 23:58:17 -0700
Message-Id: <20221010065826.32037-9-niranjana.vishwanathapura@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 08/17] drm/i915/vm_bind: Support persistent
...
@@ -2096,6 +2116,14 @@ static struct dma_fence *__i915_vma_unbind_async(struct i915_vma *vma)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BF9540378D
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Sep 2021 12:09:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBA3A6E17E;
...
Subject: Re: [Intel-gfx] [PATCH 3/8] drm/i915/xehp: Add Compute CS IRQ
 handlers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F2085AC73A
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:46:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C52110E271;
...
Subject: [Intel-gfx] [PATCH v6 17/57] dyndbg: validate class FOO by checking
 with module

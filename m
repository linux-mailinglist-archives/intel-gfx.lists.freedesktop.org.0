...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFCF337BFC3
	for <lists+intel-gfx@lfdr.de>; Wed, 12 May 2021 16:20:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A9556EC11;
 ...
 * drm/aperture: Add helpers for aperture ownership and convert drivers, re=
places rsp fbdev helpers

 * drm/agp: Mark DRM AGP code as legacy and convert legacy drivers

 * drm/atomic-helpers: Cleanups

 * drm/dp: Handle downstream port counts of 0 correctly; AUX channel fixes;=
 Use
   drm_err_*/drm_dbg_*(); Cleanups

 * drm/dp_dual_mode: Use drm_err_*/drm_dbg_*()

 * drm/dp_mst: Use drm_err_*/drm_dbg_*(); Use Extended Base Receiver Capabi=
lity DPCD space

 * drm/gem-ttm-helper: Provide helper for dumb_map_offset and convert drive=
rs
 ...
 * drm/ttm: Don't count SG BOs against pages_limit; Warn about freeing pinn=
ed
            BOs; Fix error handling if no BO can be swapped out; Move speci=
al
            handling of non-GEM drivers into vmwgfx; Move page_alignment in=
to
...
for you to fetch changes up to 66079522883603d08a1b7f4153400d8c60705dcf:
  ...
  MAINTAINERS: Add Xinhui Pan as another AMDGPU contact (2021-05-12 14:52:5=
7 +0200)
...
/ prepare
      ...
      drm/bridge: ti-sn65dsi86: Break GPIO and MIPI-to-eDP bridge into sub-=
drivers
...
le
      drm/panel: panel-simple: Remove extra call: drm_connector_update_edid=
_property()
...
Lyude Paul (20):
      ...
      drm/nouveau/kms/nv50-: Move AUX adapter reg to connector late registe=
r/early unregister
...
()
      ...
      drm/dp_dual_mode: Convert drm_dp_dual_mode_helper.c to using drm_err/=
drm_dbg_kms()
      ...
      drm/dp: Drop open-coded drm_dp_is_branch() in drm_dp_read_downstream_=
info()

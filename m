...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 32459723DC3
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Jun 2023 11:36:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7BCDC10E327;
	Tue,  6 Jun 2023 09:36:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0D3C910E324
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Jun 2023 09:36:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686044164; x=1717580164;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=9Ix1RmU1y3dyiL97OOGUWM5maE1KlZpWRsF04JyeN4M=;
 b=mmEoN9Soz5OGTd6z9qD/njvAfDnMxCUhLp7VKudzO6j1j1qJ2RjRZCF0
 mwm1nbVWYOLJkxvsMlDCIbBQnz0gNNCMQZ9BJdUv+A7Q2WFdrybyskZqm
 77/hLwJMFOJjQ5uICIjhLUBrI2AzrP4pyNosSih1X+Njru+sDQe2zObqU
 HG1I74dcXm9VA7H8F+/IumQwQZm3U7/Su6fmzU36xfGBwQT0zPTYvSh+S
 EQNDh3NOODjRm/oRAhqvAOBLh8di0orcn8ICiPqJPPacH4N8ZEaunAimt
 17fbTxBTIkSsbK5AC1yraVLOEwiy6GiwrDC0BMk/2CEdYaCmyJTtvOfDj w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="336974371"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="336974371"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2023 02:35:45 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="955684283"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="955684283"
Received: from mgmohiud-mobl2.gar.corp.intel.com (HELO
 vgovind2-mobl3.intel.com) ([10.249.42.181])
 by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jun 2023 02:35:43 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Jun 2023 12:35:09 +0300
Message-Id: <20230606093509.221709-8-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v14 7/7] drm/i915/mtl: Add support for PM DEMAND

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EECE545754F
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Nov 2021 18:19:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 200E66EADF;
	Fri, 19 Nov 2021 17:19:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id F080C6EADF;
 Fri, 19 Nov 2021 17:19:18 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10173"; a="320668531"
X-IronPort-AV: E=Sophos;i="5.87,248,1631602800"; d="scan'208";a="320668531"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Nov 2021 09:19:15 -0800
X-IronPort-AV: E=Sophos;i="5.87,248,1631602800"; d="scan'208";a="455505331"
Received: from wchopkin-mobl1.ger.corp.intel.com (HELO [10.252.22.53])
 ([10.252.22.53])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Nov 2021 09:18:41 -0800
Message-ID: <3e0f37c2-9504-2f1c-4b58-d19a66a355d4@intel.com>
Date: Fri, 19 Nov 2021 17:18:35 +0000
MIME-Version: 1.0
...
References: <20211118130230.154988-1-thomas.hellstrom@linux.intel.com>
 <20211118130230.154988-6-thomas.hellstrom@linux.intel.com>
From: Matthew Auld <matthew.auld@intel.com>
In-Reply-To: <20211118130230.154988-6-thomas.hellstrom@linux.intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
Subject: Re: [Intel-gfx] [PATCH v4 5/6] drm/i915/ttm: Implement asynchronous
 TTM moves

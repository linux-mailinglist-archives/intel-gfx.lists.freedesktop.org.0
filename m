...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C9F739BEF4
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Jun 2021 19:38:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1104F6E154;
	Fri,  4 Jun 2021 17:38:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-xd36.google.com (mail-io1-xd36.google.com
 [IPv6:2607:f8b0:4864:20::d36])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A3AB16F875
 for <intel-gfx@lists.freedesktop.org>; Fri,  4 Jun 2021 17:38:35 +0000 (UTC)
Received: by mail-io1-xd36.google.com with SMTP id v9so10879226ion.11
 for <intel-gfx@lists.freedesktop.org>; Fri, 04 Jun 2021 10:38:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=jlekstrand-net.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=VLlH0BysjeuRdE+LSNLASplpS5FTgm3MORUO68YZib8=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=VLlH0BysjeuRdE+LSNLASplpS5FTgm3MORUO68YZib8=;
 b=
X-Gm-Message-State: AOAM531g5C9nKyf2EGbn6Pt8rss8PXSP94y/oLk2RKpYbve64z+1hp71
 +DXM0iFTI/o1SXfD49oQG8nNILODSABH/EQD6XPjAg==
X-Google-Smtp-Source: ABdhPJxBM1LObVp2iuGquFTpt25rfbEG6OlMzSehabjHPxlWIDESCRA4+e1vpWC1Tfx4Skq3rmdtugnbZAKPYbsgbw4=
X-Received: by 2002:a02:3304:: with SMTP id c4mr5104962jae.68.1622828313504;
 Fri, 04 Jun 2021 10:38:33 -0700 (PDT)
MIME-Version: 1.0
References: <20210603212722.59719-1-matthew.brost@intel.com>
 <20210603212722.59719-2-matthew.brost@intel.com>
In-Reply-To: <20210603212722.59719-2-matthew.brost@intel.com>
From: Jason Ekstrand <jason@jlekstrand.net>
Date: Fri, 4 Jun 2021 12:38:22 -0500
Message-ID: <CAOFGe964fTFG7f04Z9ktvu4bahHaPMP_gdvKjUpfC3+kwDc_og@mail.gmail.com>

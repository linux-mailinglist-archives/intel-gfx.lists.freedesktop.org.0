...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E9BC76F3CA0
	for <lists+intel-gfx@lfdr.de>; Tue,  2 May 2023 06:14:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 098A810E48B;
	Tue,  2 May 2023 04:14:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D1A2D10E365;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=m/ktw3gph1XubqWd9s+CFYZHk2L05ZaqMMXmm+wo6SVDLKGip/KjYveW
 mojMSqu2SelE2ZlVh2AlZXRcoIn303+xvK+GLpCNWCWn7UfqQOxRj0Pbe
 eodPUSQAQjsFMAqg1l7ijzAjDr3m5KJ4Ob3x4IKZWxDD69Ww1mlrB/Eez
 32f4rznpMirJ7DZclr4E0kdeyfqC/0puVDqi7TKuiMq2uLgYu+vSi/CIX
 ayN/UeDqwbTzB6LJ/otYGxVaKMQdzWUNivZj9pRHwVW4JdvZC8bB8sg/9
 Um4zCXBCesnyRbL0uYmwXUMryQkmsjZ3hZviNs91y5ohTiwhMC1hfr8xZ Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="347116759"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="347116759"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:14:25 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10697"; a="726593801"
X-IronPort-AV: E=Sophos;i="5.99,243,1677571200"; d="scan'208";a="726593801"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 May 2023 21:14:25 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Mon,  1 May 2023 21:15:23 -0700
Message-Id: <20230502041526.2170497-3-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 2/5] drm/i915: use pat_index instead of
 cache_level

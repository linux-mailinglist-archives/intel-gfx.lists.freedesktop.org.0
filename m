...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E1D7B5FB02D
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Oct 2022 12:09:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6A0410E51D;
	Tue, 11 Oct 2022 10:09:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7954C10E51D
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Oct 2022 10:09:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665482965; x=1697018965;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=VG+bHgHvqLFy0CN8LKF+3gov0KEShDQ87MBeQlBrRzM=;
 b=mHrVx6mgvLwkTcFggD/JVmv///mZm57lXiNCLCuftcwDNTfvnzPw/DdB
 Gx53Rgo1mj1UyXm0roVRS6GQa0KvW4O72iN8TPApHKA2XVqRpp2Nb9ueX
 8cOe+12qv0E68HeS96KiSFZ7T8qg9ZtnzAVKRBLktmRsaGiaEz+8Z9NOW
 pQF+TbZTLCyANyqVWlAcWECKQcslQSOYISQRpc7dkBkoxbIXPjx/mexDR
 giF4EBeU+UTfg1om8EtXf+KoZSu51oK4zTR3T+/N5kC8AtEKg1csVytDW
 y2iXB7erlenTZR90RMGQvt8CQSM62v/i/Ac8kmyWzYHIAQZ+aZs6JghG3 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="305518802"
X-IronPort-AV: E=Sophos;i="5.95,176,1661842800"; d="scan'208";a="305518802"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Oct 2022 03:09:20 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="768743650"
X-IronPort-AV: E=Sophos;i="5.95,176,1661842800"; d="scan'208";a="768743650"
Received: from ashyti-mobl2.igk.intel.com (HELO intel.com) ([172.28.182.106])
 by fmsmga001-auth.fm.intel.com with
 ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Oct 2022 03:09:17 -0700
Date: Tue, 11 Oct 2022 12:09:14 +0200
From: Andi Shyti <andi.shyti@linux.intel.com>
To: Andi Shyti <andi.shyti@linux.intel.com>
Message-ID: <Y0VAyikdFVTl0YhX@ashyti-mobl2.lan>
...
In-Reply-To: <Y0QswEzRwwv9Vops@ashyti-mobl2.lan>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A41042B8B73
	for <lists+intel-gfx@lfdr.de>; Thu, 19 Nov 2020 07:15:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA7F06E4E8;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v2 02/13] drm/edid: Parse MAX_FRL field from
 HFVSDB block

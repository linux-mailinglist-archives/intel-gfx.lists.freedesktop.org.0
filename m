...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A351EBE3C5F
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Oct 2025 15:44:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA88110E307;
	Thu, 16 Oct 2025 13:44:39 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="BoHrxydQ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9406D10E9E7
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Oct 2025 13:44:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1760622278; x=1792158278;
 h=date:from:to:subject:message-id:references:mime-version:
 content-transfer-encoding:in-reply-to;
 bh=hwuExsBcnaxEeV15M2Xujdm8KgQeqKj4wPU/F7krHPU=;
 b=BoHrxydQa2Vt1Lt46zanBKPa9EafyRxt5RZHCv+32U/ahsuU/tYbwgw9
 o3BfwDNCRNYYNVK//rH5yQ2EkpsEHYC3bNUPnQjLrUmajiuuqlnX8YPrq
 sz5EStW2Ysi0aEF59e0gyP15OtvKZUs2Wb0P6Y5XcH1KrMEatfUUUvY4R
 tt437wBWba6bqL5fbkDEo1mMA+OFpSnStq3HIc/UhAO6zmbt00J5zraqq
 X3Ovxn0LqYh9fxiGlnVJ1BcTzuA3eyZIvsO49mEHOI4o7W0VW+qRO32pf
 XgDrGx/sd1E8+LuSJxgFEWbd6P4GuKS6MR2EqYQt7pl/ZBtaJvRtXBR6A A==;
X-CSE-ConnectionGUID: H08CKtIGSNS1ngdZ3tXwOw==
X-CSE-MsgGUID: 9s9PqzrAScy4D6SUJr2A6g==
X-IronPort-AV: E=McAfee;i="6800,10657,11584"; a="62713111"
X-IronPort-AV: E=Sophos;i="6.19,234,1754982000"; d="scan'208";a="62713111"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Oct 2025 06:44:37 -0700
X-CSE-ConnectionGUID: cf3O9JHNTi+y6UvMwHTzSQ==
X-CSE-MsgGUID: DmV8jFwXRAKJhItAhQKqYw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,234,1754982000"; d="scan'208";a="182436966"
Received: from kniemiec-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.244.12])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Oct 2025 06:44:35 -0700
Date: Thu, 16 Oct 2025 16:44:31 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: Re: =?utf-8?B?4pyXIGk5MTUuQ0kuRnVsbDogZmFp?=
 =?utf-8?Q?lure_for_drm=2Fi915=2Fprefill?= =?utf-8?Q?=3A?= Introduce helpers
 for prefill latency calculations (rev3)
Message-ID: <aPD2v1v-chUAY9D2@intel.com>
References: <20251014191808.12326-1-ville.syrjala@linux.intel.com>
 <176055462996.19067.15153459965697527496@97596180aaec>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <176055462996.19067.15153459965697527496@97596180aaec>
...
On Wed, Oct 15, 2025 at 06:57:09PM -0000, Patchwork wrote:
> == Series Details ==
> 
...
<3> [655.285611] Freezing user space processes aborted after 0.000 seconds (42 tasks refusing to freeze, wq_busy=0):

Seems to be some kind of regression already visible on drm-tip runs.
But since it first appeared on some igt test run so I guess it might

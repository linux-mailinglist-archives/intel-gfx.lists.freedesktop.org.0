...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACD324D8C73
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Mar 2022 20:32:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59BA110E1D3;
...
Subject: [Intel-gfx] [PATCH] drm/i915: round_up the size to the alignment
 value

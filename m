...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AFA23672834
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 20:30:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFE7B10E810;
	Wed, 18 Jan 2023 19:30:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qt1-x834.google.com (mail-qt1-x834.google.com
 [IPv6:2607:f8b0:4864:20::834])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 446B010E813
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Jan 2023 19:30:27 +0000 (UTC)
Received: by mail-qt1-x834.google.com with SMTP id a25so23516056qto.10
 for <intel-gfx@lists.freedesktop.org>; Wed, 18 Jan 2023 11:30:27 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=chromium.org; s=google;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=lGNSPzzSlQ7Cmk3uC4P5XqNxGhhTlTCNQNLmepTTTX8=;
 b=cU6SX8oySfDtjGJgtJ/OhcwRh50jLrQfLeeCO1pjtwZ2/69zlXkhpECcQQ5l8H6Hia
 MA0/bcHDqMH7/fuerQh/0yOYO41VRrxUeogXhQK06ksxPFzCENz0MoEck4SevMtP9T/d
 R5qIZ35FjiQaX9aKMsjoHHnZeZA511VfX/UX8=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=lGNSPzzSlQ7Cmk3uC4P5XqNxGhhTlTCNQNLmepTTTX8=;
 b=
X-Gm-Message-State: AFqh2koLmPkli++DHZk2tTuqtym0JkgFrOo0d5CndiETpDk74IehlC43
 O6BOqNGUV06APN1sBlf8ps5ENg==
X-Google-Smtp-Source: AMrXdXtj0gVSviy+AKBSO9sWYWYIn+GznFmytqwi7weIYKfQFOiS8JGhIcEKXASU1CiiIv0twD/F7A==
X-Received: by 2002:a05:622a:1827:b0:3b6:3c95:735a with SMTP id
 t39-20020a05622a182700b003b63c95735amr11668557qtc.52.1674070226845; 
 Wed, 18 Jan 2023 11:30:26 -0800 (PST)
Received: from localhost (29.46.245.35.bc.googleusercontent.com.
 [35.245.46.29]) by smtp.gmail.com with UTF8SMTPSA id
 g25-20020ac870d9000000b003b63238615fsm4654973qtp.46.2023.01.18.11.30.25
...
Date: Wed, 18 Jan 2023 19:30:06 +0000
Message-Id: <20230118193015.911074-2-markyacoub@google.com>
X-Mailer: git-send-email 2.39.0.246.g2a6d74b583-goog
In-Reply-To: <20230118193015.911074-1-markyacoub@google.com>
References: <20230118193015.911074-1-markyacoub@google.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v6 01/10] drm/hdcp: Add drm_hdcp_atomic_check()

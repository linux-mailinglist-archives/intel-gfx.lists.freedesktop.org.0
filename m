...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AEF11534BA2
	for <lists+intel-gfx@lfdr.de>; Thu, 26 May 2022 10:21:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE1F210F5FB;
	Thu, 26 May 2022 08:21:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C0A3810F56C
 for <intel-gfx@lists.freedesktop.org>; Thu, 26 May 2022 08:21:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1653553313; x=1685089313;
 h=date:message-id:from:to:cc:subject:in-reply-to:
 references:mime-version;
 bh=SwrfCslnydx6lsKYQVq0vaFIwyg8AoKosLsGE2HkmyY=;
 b=Iwqe0UWvafXW1Pxa/o2pfyvDK3NdFzfcc3qEvgA5SJpGmoM/UIyK8wHc
 RGK1t/lwPAriI61AcLOKX06Jdqc+dS/uFpgjNP2z0ON7nLUi/rTKW6vKD
 3LWUjiXbW3gpAs0zUjNyJtTeLC5X6I1ACIbrissr1U7sTHIxAqObzWxVW
 U6ZgfpjmUjNhc2hyjjKDPDoDWwqbK0I6Z8wOVgbDC9sPLi22UoE8c21Bv
 5C14Ntj2lfkmMNDHxZiEcxfGhL38npDOS8KreLfAOHXwWeK5lKFUDCUdz
 j58rjwPLMPa2rJ3JPJDHvtIbqsTxEpt36jdJADx033Sje4s3ZixjtHyRZ w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10358"; a="299416597"
X-IronPort-AV: E=Sophos;i="5.91,252,1647327600"; d="scan'208";a="299416597"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2022 01:21:53 -0700
X-IronPort-AV: E=Sophos;i="5.91,252,1647327600"; d="scan'208";a="630783156"
Received: from adixit-mobl1.amr.corp.intel.com (HELO adixit-arch.intel.com)
 ([10.212.199.107])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2022 01:21:53 -0700
Date: Thu, 26 May 2022 01:12:27 -0700
Message-ID: <87v8ts7lw4.wl-ashutosh.dixit@intel.com>
From: "Dixit, Ashutosh" <ashutosh.dixit@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
In-Reply-To: <877d6ahvkd.wl-ashutosh.dixit@intel.com>

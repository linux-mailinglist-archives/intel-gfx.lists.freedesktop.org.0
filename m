...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2ACE1516E8C
	for <lists+intel-gfx@lfdr.de>; Mon,  2 May 2022 13:09:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EFA2A10E2DB;
...
Subject: [Intel-gfx] [PATCH v4 2/4] drm/i915/selftests: Check for incomplete

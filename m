...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A1B517DCD7E
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Oct 2023 14:05:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BC0A10E4B1;
	Tue, 31 Oct 2023 13:05:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 97CC010E4B1
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Oct 2023 13:04:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1698757498; x=1730293498;
 h=message-id:date:mime-version:subject:to:references:from:
 in-reply-to:content-transfer-encoding;
 bh=LcDgp3VHO6R1vMFjSNTQ0z5weqigZREfWoVN8op7YJo=;
 b=TM8rASEg7/noPbWlybAJettAcUJpqlOmU6K0u2ZXLPRcwlG8zEMX2xYp
 9VzzNJfpv5dp7y+Hf/oSukbEXzbQ4k6oEhoSEqm2EFL2OeEu/3GIuAAW1
 ++K2wy4dVD6WmJS8UkDzZROvplG76RVwBQq2teyKoRmCrijFikPg/h5Zu
 Z1M3pUFWVrRmrt/J4BYq3r1Wf7sbnmLasxKuxS/3XDzb9CYADgEJ+AhFa
 /yoo1hUUv60DODDgmmpv9XKDZTAUNLrG5o6igt5CEm0xcGfcDSwSl93X0
 IF+6xolWX8WT6epZvAuGSVUuWtQKvc1POMQetCEePxHUmOyDEek+E1Ed5 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10879"; a="9812919"
X-IronPort-AV: E=Sophos;i="6.03,265,1694761200"; 
   d="scan'208";a="9812919"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2023 06:04:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10879"; a="760609359"
X-IronPort-AV: E=Sophos;i="6.03,265,1694761200"; d="scan'208";a="760609359"
Received: from nirmoyda-mobl.ger.corp.intel.com (HELO [10.252.33.135])
 ([10.252.33.135])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2023 06:04:56 -0700
Message-ID: <cf78d61e-c0c5-491f-12a0-22c8eac11656@linux.intel.com>
Date: Tue, 31 Oct 2023 14:04:54 +0100
MIME-Version: 1.0
...
References: <20231031124502.1772160-1-jani.nikula@intel.com>
 <20231031124502.1772160-3-jani.nikula@intel.com>
From: Nirmoy Das <nirmoy.das@linux.intel.com>
In-Reply-To: <20231031124502.1772160-3-jani.nikula@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit
Subject: Re: [Intel-gfx] [PATCH RESEND 3/3] drm/i915: move gpu error sysfs
 to i915_gpu_error.c

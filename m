...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DEAFDE7A3E
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Oct 2019 21:38:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DEC116EA0A;
	Mon, 28 Oct 2019 20:38:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0A7016EA15
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,241,1569308400"; d="scan'208";a="202622112"
...
Date: Mon, 28 Oct 2019 13:40:33 -0700
Message-Id: <20191028204041.13507-3-radhakrishna.sripada@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 02/10] drm/i915: Use intel_tile_height()
...
OWRjZTJlOWU1Mzc2Li4zNzk2NTQ3YmEwMTggMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9p
OTE1L2Rpc3BsYXkvaW50ZWxfZGlzcGxheS5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rp
c3BsYXkvaW50ZWxfZGlzcGxheS5jCkBAIC0xOTgyLDcgKzE5ODIsNyBAQCBzdGF0aWMgdm9pZCBp

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D2627380F9E
	for <lists+intel-gfx@lfdr.de>; Fri, 14 May 2021 20:16:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C27166F407;
	Fri, 14 May 2021 18:16:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 32F1E6F403
 for <intel-gfx@lists.freedesktop.org>; Fri, 14 May 2021 18:16:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1621016182;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=XP5EwBKzHOPLUaDT2DVS8SCZ69+Fn1flFoJGEs1jg5c=;
 b=CCxlYgZNRfBTNabezIskxrhuwLzLl2rT8obTw14gBXRrKjnoKkOjt9NwuqgW06PdhSulrn
 vaqu+ex90tIQSC97bcb1uj/+PusGQctc/CwxHk/7B+Lr10+GdrcbCPiz3gQ+FdlpgB56i3
 87VNDLq9OR4eCs3Y/Zo9P0Y664XRYaY=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-411-x0HWTbxdP1GSYdiWu3Udmg-1; Fri, 14 May 2021 14:16:18 -0400
X-MC-Unique: x0HWTbxdP1GSYdiWu3Udmg-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com
 [10.5.11.23])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 67F0A801B12;
 Fri, 14 May 2021 18:16:15 +0000 (UTC)
Received: from Whitewolf.redhat.com (ovpn-118-140.rdu2.redhat.com
 [10.10.118.140])
 by smtp.corp.redhat.com (Postfix) with ESMTP id E0D5319D9B;
 Fri, 14 May 2021 18:16:12 +0000 (UTC)
From: Lyude Paul <lyude@redhat.com>
To: intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org,
 nouveau@lists.freedesktop.org
Date: Fri, 14 May 2021 14:15:02 -0400
Message-Id: <20210514181504.565252-9-lyude@redhat.com>
In-Reply-To: <20210514181504.565252-1-lyude@redhat.com>
References: <20210514181504.565252-1-lyude@redhat.com>
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.23
Subject: [Intel-gfx] [PATCH v6 8/9] drm/dp: Extract i915's eDP backlight
...
Cc: David Airlie <airlied@linux.ie>, Jani Nikula <jani.nikula@intel.com>,
 Dave Airlie <airlied@redhat.com>, Thomas Zimmermann <tzimmermann@suse.de>,
 greg.depoire@gmail.com, Lucas De Marchi <lucas.demarchi@intel.com>,

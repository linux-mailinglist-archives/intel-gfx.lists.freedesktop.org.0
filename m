...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B849957C31
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jun 2019 08:31:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C64CE6E5AD;
	Thu, 27 Jun 2019 06:31:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E3EBF89CAF
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Jun 2019 06:31:11 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17038746-1500050 
 for multiple; Thu, 27 Jun 2019 07:30:48 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Jun 2019 07:30:40 +0100
Message-Id: <20190627063044.11858-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/7] drm/i915/gt: Convert timeline tracking to
 spinlock
...
L2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCmluZGV4IGI3ZjI5MGI3N2Y4Zi4uNGQyY2YxNDlmZmU2

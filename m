...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 552433A2469
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Jun 2021 08:22:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 849EC6E479;
	Thu, 10 Jun 2021 06:22:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D9EBD6E479
 for <intel-gfx@lists.freedesktop.org>; Thu, 10 Jun 2021 06:22:17 +0000 (UTC)
IronPort-SDR: 0ljKDnJoue1onqSwviX8xtsHXHUJCxjbNUHdN1d3qFLyzTdOEVtQ7rgJC5W02oCNHP8om8Ijo0
 942GwDMNuD4w==
X-IronPort-AV: E=McAfee;i="6200,9189,10010"; a="290865227"
X-IronPort-AV: E=Sophos;i="5.83,262,1616482800"; d="scan'208";a="290865227"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2021 23:22:14 -0700
IronPort-SDR: HGB2oP6LqarHNRlYTMacbV6uCbuP+XZW8zfdQWmXiHewycDrqlJ/+4tfk93/CetUIF5wVud81F
 J22Fsy+SJVKg==
X-IronPort-AV: E=Sophos;i="5.83,262,1616482800"; d="scan'208";a="552933937"
Received: from lfbrown-mobl.amr.corp.intel.com (HELO ldmartin-desk2)
 ([10.254.4.44])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2021 23:22:13 -0700
Date: Wed, 9 Jun 2021 23:22:13 -0700
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: Anusha Srivatsa <anusha.srivatsa@intel.com>
Message-ID: <20210610062213.3rwexl7cgyhaftus@ldmartin-desk2>
X-Patchwork-Hint: comment
References: <20210604190128.24151-1-anusha.srivatsa@intel.com>
 <20210604190128.24151-3-anusha.srivatsa@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20210604190128.24151-3-anusha.srivatsa@intel.com>
...
checking fw_info[i].dmc_id < DMC_FW_MAIN doesn't make sense as dmc_id is
unsigned and DMC_FW_MAIN is 0.
...
Thinking about the upgradability of the firmware, as can be seen above
I'd downgrade the message to drm_dbg(). We are doing the check even
before checking fw_info_matches_stepping() anyway.
...
version, instead of have removed the sanity check in patch 1, you could
use this field for the sanity check.

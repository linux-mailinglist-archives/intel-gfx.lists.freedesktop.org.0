...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OO5sITeweGlasAEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jan 2026 13:31:51 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE87F945A0
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Jan 2026 13:31:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA93110E55A;
	Tue, 27 Jan 2026 12:31:48 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=qualcomm.com header.i=@qualcomm.com header.b="LbHn4boB";
	dkim=pass (2048-bit key; unprotected) header.d=oss.qualcomm.com header.i=@oss.qualcomm.com header.b="UyNDgq64";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com
 [205.220.180.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B269D10E55A
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Jan 2026 12:31:47 +0000 (UTC)
Received: from pps.filterd (m0279869.ppops.net [127.0.0.1])
 by mx0a-0031df01.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id
 60RAXubh1268864
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Jan 2026 12:31:46 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=qualcomm.com; h=
 cc:content-type:date:from:in-reply-to:message-id:mime-version
 :references:subject:to; s=qcppdkim1; bh=VU0slBhDTl0S174Qk8MliQmr
 xR524AGN4lDFOKup56M=; b=LbHn4boBqay4ax3hhzappSaG3LD0i9iMRyTM/A7E
 
Received: from mail-ua1-f70.google.com (mail-ua1-f70.google.com
 [209.85.222.70])
 by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 4bxnyasn6v-1
 (version=TLSv1.3 cipher=TLS_AES_128_GCM_SHA256 bits=128 verify=NOT)
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Jan 2026 12:31:46 +0000 (GMT)
Received: by mail-ua1-f70.google.com with SMTP id
 a1e0cc1a2514c-93f57cdeb11so8119512241.0
 for <intel-gfx@lists.freedesktop.org>; Tue, 27 Jan 2026 04:31:46 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=oss.qualcomm.com; s=google; t=1769517106; x=1770121906;
 darn=lists.freedesktop.org; 
 h=in-reply-to:content-disposition:mime-version:references:message-id
 :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
 bh=VU0slBhDTl0S174Qk8MliQmrxR524AGN4lDFOKup56M=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1769517106; x=1770121906;
 h=in-reply-to:content-disposition:mime-version:references:message-id
 :subject:cc:to:from:date:x-gm-gg:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=VU0slBhDTl0S174Qk8MliQmrxR524AGN4lDFOKup56M=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXt7Q+bXj+Q9FZcl+R6TlUB/4edmSVh1iQInqu1OmjREUJOGGCy5f8XFhShlYIkQmBFQB8LtLKM3WA=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YzwVivJ44hlT5VqjT11KoElaQW8vc2bbvnuR296ec7PHHAsc3du
 ZytThrrjyZ3h//ltG+1/aYb1PU+xQKcM/Ab+k/B2bTH89zmg0+NSEQZXL/NiUYszauudk2x15I1
 6ExTdDqVssdDxJJEBXTiS1BQFTei0peO6ngFTs7NQ7O5x4WDHbaW7V35DDonVxFfgwowYiMQ=
X-Gm-Gg: 
X-Received: by 2002:a05:6102:2ac2:b0:5ee:a53e:d3d with SMTP id
 ada2fe7eead31-5f723835c01mr532566137.45.1769517105424; 
 Tue, 27 Jan 2026 04:31:45 -0800 (PST)
X-Received: by 2002:a05:6102:2ac2:b0:5ee:a53e:d3d with SMTP id
 ada2fe7eead31-5f723835c01mr532542137.45.1769517104332; 
 Tue, 27 Jan 2026 04:31:44 -0800 (PST)
Received: from umbar.lan
 (2001-14ba-a073-af00-264b-feff-fe8b-be8a.rev.dnainternet.fi.
 [2001:14ba:a073:af00:264b:feff:fe8b:be8a])
 by smtp.gmail.com with ESMTPSA id
 2adb3069b0e04-59de48df5b3sm3433918e87.6.2026.01.27.04.31.41
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 27 Jan 2026 04:31:42 -0800 (PST)
Date: Tue, 27 Jan 2026 14:31:40 +0200
...
Message-ID: <zi7frtnecrzyei4fl4nmwmth3icnsyycxxobbrcwovbqfsfq4z@eh25dyfrjkqz>
...
In-Reply-To: <20260127104406.200505-7-vignesh.raman@collabora.com>
X-Proofpoint-GUID: DZv4K9Di_tMmXw3xeAYzkPLU3ZI7S2-8
X-Authority-Analysis: v=2.4 cv=JZqxbEKV c=1 sm=1 tr=0 ts=6978b032 cx=c_pps
 a=R6oCqFB+Yf/t2GF8e0/dFg==:117 a=xqWC_Br6kY4A:10 a=kj9zAlcOel0A:10
 a=vUbySO9Y5rIA:10 a=s4-Qcg_JpJYA:10 a=VkNPw1HP01LnGYTKEx00:22
 a=e5mUnYsNAAAA:8 a=VwQbUJbxAAAA:8 a=QX4gbG5DAAAA:8 a=EUspDBNiAAAA:8
 a=4AkOIPojv3IjqZCSUwoA:9 a=CjuIK1q_8ugA:10 a=TD8TdBvy0hsOASGTdmB-:22
 a=Vxmtnl_E_bksehYqCbjh:22 a=AbAUZ8qAyYyZVLSsDulk:22
X-Proofpoint-ORIG-GUID: DZv4K9Di_tMmXw3xeAYzkPLU3ZI7S2-8
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwMTI3MDEwMSBTYWx0ZWRfX6rDuOvqafM89
 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C86A4F8274
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Apr 2022 17:07:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F97310EAB1;
...
Subject: [Intel-gfx] [PATCH v2] drm/edid: add EDID block count and size
 helpers

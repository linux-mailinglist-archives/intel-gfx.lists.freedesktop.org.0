...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2805A1568C5
	for <lists+intel-gfx@lfdr.de>; Sun,  9 Feb 2020 04:54:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 046C46EB46;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 14/18] drm/i915: Disable DIPs when LSPCON is
 used

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21E9752CEF5
	for <lists+intel-gfx@lfdr.de>; Thu, 19 May 2022 11:08:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 61C3511B112;
...
Subject: [Intel-gfx] [PATCH 2/7] Revert "drm/i915: Drop has_dp_mst from
 device info"

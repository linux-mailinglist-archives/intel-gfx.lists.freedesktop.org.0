...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 702A419659
	for <lists+intel-gfx@lfdr.de>; Fri, 10 May 2019 03:54:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 814AF89C93;
	Fri, 10 May 2019 01:54:07 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 4/6] drm/i915/dp: Add a support of YCBCR
 4:2:0 to DP MSA

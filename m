...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8CF18710948
	for <lists+intel-gfx@lfdr.de>; Thu, 25 May 2023 11:54:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D85C10E87F;
...
Subject: Re: [Intel-gfx] [PATCH 10/11] drm/i915: Drop some redundant eDP
 checks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC9B84B2739
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Feb 2022 14:33:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C925610EC2F;
	Fri, 11 Feb 2022 13:33:44 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v1 1/1] drm/i915/gt: Move wbvind_on_all_cpus
 #define

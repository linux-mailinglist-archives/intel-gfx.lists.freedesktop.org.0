...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C2013FED86
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Sep 2021 14:11:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 51DF16E51C;
	Thu,  2 Sep 2021 12:11:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 939496E51A
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Sep 2021 12:11:20 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10094"; a="206217989"
X-IronPort-AV: E=Sophos;i="5.84,372,1620716400"; d="scan'208";a="206217989"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Sep 2021 05:11:20 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.84,372,1620716400"; d="scan'208";a="461627517"
Received: from shawnle1-build-machine.itwn.intel.com ([10.5.253.12])
 by fmsmga007.fm.intel.com with ESMTP; 02 Sep 2021 05:11:18 -0700
...
Date: Thu,  2 Sep 2021 20:14:25 +0800
Message-Id: <20210902121429.27606-2-shawn.c.lee@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210902121429.27606-1-shawn.c.lee@intel.com>
References: <20210902121429.27606-1-shawn.c.lee@intel.com>
Subject: [Intel-gfx] [v3 1/5] drm/i915/dsi: wait for header and payload
 credit available

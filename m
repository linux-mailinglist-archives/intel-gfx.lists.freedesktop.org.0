...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B31B35A4DC7
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:21:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 241E310F2A1;
...
Subject: [Intel-gfx] [PATCH v2 08/41] drm/connector: Rename

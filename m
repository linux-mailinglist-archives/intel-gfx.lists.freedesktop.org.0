...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 05D8C75C803
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Jul 2023 15:39:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C082710E68A;
...
Subject: Re: [Intel-gfx] [v7,
 9/9] drm/i915/gt: Support aux invalidation on all engines

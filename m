...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E6697DA7E
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Aug 2019 13:41:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5AF5C6E513;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 5/6] drm/i915: update the hdcp state with
 uevent

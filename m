...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AFFE54B548
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jun 2022 18:05:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5949910FF2E;
	Tue, 14 Jun 2022 16:05:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2831F10E488;
 Tue, 14 Jun 2022 16:05:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1655222701; x=1686758701;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=oGBjztZbq9cOMPe49f2dnumX6yJWNNk36wEYTkk2fYk=;
 b=SxgDPO9D4ZbFfyReL/RrK2iscbSoVYIkyyu8M5m9toA0LUlf8MNxMjvq
 d8IinImR8k5/FQxzcV/X4nSBRiYTueK+8YpHd0d2m1zkmxeQW4VHuV9I8
 wZUQRGEdpJmr4BTMN67x0JMUoBdTwZmI8l2Dc5TbpQKBOy56m8y7Kq3Zl
 tLihaUU4HLkPsCesdKoyl2iQRG2jr46EI6znouvTd4gpet9r/zdA16POX
 ZVJKjIMIq4XGLShLfDuAFfKAuXrDbVfdrj/2PWB3ceYB6scAv4RamnPlF
 C3bNUTvcn7BncdP8rfLU1+4t/sKbvkeflNKbwXi5hYubqkUaAbBLmxCOF Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10378"; a="277447962"
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; d="scan'208";a="277447962"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2022 09:02:56 -0700
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; d="scan'208";a="640449901"
Received: from snkalval-mobl2.amr.corp.intel.com (HELO [10.212.46.198])
 ([10.212.46.198])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2022 09:02:53 -0700
Message-ID: <ca635918-018e-db86-8ece-23f4fc4e2032@linux.intel.com>
Date: Tue, 14 Jun 2022 17:02:52 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220614154341.GK376@nvishwa1-DESK>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BCA2A2E23EF
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Dec 2020 04:10:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97C4D6E8C4;
	Thu, 24 Dec 2020 03:10:34 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 50F2E89FD9
 for <Intel-gfx@lists.freedesktop.org>; Thu, 24 Dec 2020 03:10:29 +0000 (UTC)
IronPort-SDR: DbnibmORB2ytNgYErlolBXu4vlHrLP4nwHZ9GiaM5lahdCbEzZTKN2JY+K1rdIiFhrZPFsvoxc
 HG3cIqWPb63w==
X-IronPort-AV: E=McAfee;i="6000,8403,9844"; a="155893685"
X-IronPort-AV: E=Sophos;i="5.78,444,1599548400"; d="scan'208";a="155893685"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Dec 2020 19:10:29 -0800
IronPort-SDR: u/No0D8mMF806Rs9vhC1SXvnBhmvAn9KBZWb4jXXAALZRB+k7ScKPWOU4F0K5jjKP/wVZfcfPT
 GwI0ix7/Chlg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,444,1599548400"; d="scan'208";a="342496798"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga003.jf.intel.com with ESMTP; 23 Dec 2020 19:10:28 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed, 23 Dec 2020 19:10:23 -0800
Message-Id: <20201224031026.7360-11-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201224031026.7360-1-sean.z.huang@intel.com>
References: <20201224031026.7360-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v15 10/13] mei: pxp: export pavp client to me
 client bus

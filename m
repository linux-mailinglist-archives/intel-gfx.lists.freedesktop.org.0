...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E0DF474052
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Dec 2021 11:21:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 478B110E3C3;
...
Subject: Re: [Intel-gfx] [PATCH v4 05/16] drm/i915/lmem: Enable lmem for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A2A90610570
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Oct 2022 00:13:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8BD3610E381;
	Thu, 27 Oct 2022 22:13:29 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 2/5] drm/i915/mtl: pass the GSC CS info to the
 GuC

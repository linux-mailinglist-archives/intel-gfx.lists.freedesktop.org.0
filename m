...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 732AC7B1D2C
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Sep 2023 15:00:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CBD8D10E641;
...
Subject: [Intel-gfx] [PATCH v7 2/4] drm/i915: Introduce the

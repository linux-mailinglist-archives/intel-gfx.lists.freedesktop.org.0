...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C2C396F7DE
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Sep 2024 17:10:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C82B310EA85;
	Fri,  6 Sep 2024 15:10:10 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="kvGnTtBx";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1533510EA85;
 Fri,  6 Sep 2024 15:10:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1725635409; x=1757171409;
 h=date:from:to:cc:subject:message-id:references:
 content-transfer-encoding:in-reply-to:mime-version;
 bh=b2kIkMmSuAeR+I4uswqH3BG1aVOOngIbooBaiEQig+M=;
 b=kvGnTtBxP8isuXloI3LYvHRAt6ZqihPcFuYwcjD0YGtkSiwcJODQGK5q
 D6ehGfW2xmaRgtfIfdfTN6I2TBNSTCWfmCROPjQnmT2JGPOlL1Z91bPfk
 u5aA/eM64VOkScahMehn4seqwXEuF60eCrhMgmLaIDH5fc66bijAyZS3M
 qPH66uc2XEG7Q8mtPQeOhqRpOaNRalhoOinhgxizRlxYwHsbPSx8A7ijn
 x/1K3gzaF7j+RwJtPpR3mW6VJsQzs1jzmySqXv5um1YZge8mfMtX+UfI7
 6Bvx/PfD7+SaBSy2AUIsaMMWLZ9emjhXMD1Matg1e6OaHeoWmGIqQSY9A Q==;
X-CSE-ConnectionGUID: 80pwfye3SpqPkk8knOos3w==
X-CSE-MsgGUID: 0C9D9rxURFyp4kao3LrA6w==
X-IronPort-AV: E=McAfee;i="6700,10204,11187"; a="13411812"
X-IronPort-AV: E=Sophos;i="6.10,208,1719903600"; d="scan'208";a="13411812"
Received: from fmviesa009.fm.intel.com ([10.60.135.149])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Sep 2024 08:10:09 -0700
X-CSE-ConnectionGUID: rl0skia1RF2e2HL6PFWscA==
X-CSE-MsgGUID: wVfM20y5SEWSaYdwcOQL+Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,208,1719903600"; d="scan'208";a="65967704"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
 by fmviesa009.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384;
 06 Sep 2024 08:10:08 -0700
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 fmsmsx603.amr.corp.intel.com (10.18.126.83) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.39; Fri, 6 Sep 2024 08:10:08 -0700
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.39; Fri, 6 Sep 2024 08:10:07 -0700
Received: from fmsedg601.ED.cps.intel.com (10.1.192.135) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.39 via Frontend Transport; Fri, 6 Sep 2024 08:10:07 -0700
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (104.47.59.172)
 by edgegateway.intel.com (192.55.55.70) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.39; Fri, 6 Sep 2024 08:10:07 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=PVAwu1O6dgA4p7UbeE18MsnrylRRpIO3jciGDuFp4fA=;
 b=
...
X-ClientProxiedBy: MW4PR04CA0342.namprd04.prod.outlook.com
 (2603:10b6:303:8a::17) To BYAPR11MB2854.namprd11.prod.outlook.com
 (2603:10b6:a02:c9::12)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: BYAPR11MB2854:EE_|SJ2PR11MB7502:EE_
X-MS-Office365-Filtering-Correlation-Id: 49679e81-53c8-4f2a-8ee4-08dcce85f7c1
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230040|366016|1800799024|376014;
X-Microsoft-Antispam-Message-Info: =?iso-8859-1?Q?oya/IL6fGtrVNixuAq/dyV4BTW+a2pXA5vEkz/olhv3zNeyPKOL/NAqs/Z?=
 =?iso-8859-1?Q?AdL4rdIQ80YxLlr+03EoXhagL+w2iBwfhpEfwCIhFLkeRpOw/l9lMQG2iz?=
 =?iso-8859-1?Q?yNVUDGgJkxWBoyoLlKduzBUYyE4UywbH34/mj/PzFGPq6AbjYJSLIZoatI?=
 =?iso-8859-1?Q?vhKTzrLtPp6TAKh8EXwioX6owrjttYi7j+mExr/fcmDEhz6gy1Ds42Pt3W?=
 =?iso-8859-1?Q?aMU4XLADL5VLNC0zlL4fYW8M5uw7q6z6vgdK7DFeWOEAGRS/GuplVbGPR5?=
 =?iso-8859-1?Q?gkwBww0OKIBStf1PjTBsqCLOWYNN+GqDun1ojiC3Sq9Yi3Knq6sTuqlvF2?=
 =?iso-8859-1?Q?Gx4GuTPqfrbMlG45x/AT+e3yvpLDTH0gA3TjVSDFZCUdYSENCbttuE2Dt0?=
 =?iso-8859-1?Q?CF/L2TB1PuQe5qi8444LtLR9LpdjuJemvpExpwaZO+pBanlUzE8+w3hft6?=
 =?iso-8859-1?Q?QpUHnvrAI8fieZjgZ1jDaX0zdXvhT/uN3c1GZoZ0PUAY7klFoEB982mC6A?=
 =?iso-8859-1?Q?B+iDsjs/fYiGIDiM9k3YSKPPM7DHzyT3t1WH8kSgKtKjPgRvULbF6Mbef4?=
 =?iso-8859-1?Q?gZoVmuxrbvAGYDnm2uB7Q8o6g2cYf0/dgZVdjI4nvcGMgG0kAnso9cDig6?=
 =?iso-8859-1?Q?GF+xPviDyCVw5sTFIEMasCjnxKia3lSNGjSTFitPHUW5F5t0plQjx4ISq5?=
 =?iso-8859-1?Q?dVkNr6g8UO1v09w4noult1d2nP9g+iOSCaLx/H6EoxyNi0lEV+RujOm0T0?=
 =?iso-8859-1?Q?s6vXiaoISYPPj/makixkh2dcaFAinGP0+ImDhOfflKNrhXQuF0Pj/v2gVw?=
 =?iso-8859-1?Q?76fi98GgoDX/uHuW7mj+Moau5IUtVTFUoeYM6gBlou3+ilsGTIeI7ES6+C?=
 =?iso-8859-1?Q?PYTwbFy7ZmyjR4j035+bWqzpxSzkkVwCNyLBisCAIP5to+9RXNB6xCUGFr?=
 =?iso-8859-1?Q?RBXkgaHqSoN6/+yTn+nLpYLmGwapPMCNAK8WU+hDLaPu7Bs8eLJhSqv/bP?=
 =?iso-8859-1?Q?BcTg1aakwPkfOArCXNeqeqq6M28rUfqIXw79I3+QojTjWntP/DKUF/9jtR?=
 =?iso-8859-1?Q?gEn8iLYJgpIMRXAyZy8V02r1JhLlehxLpLQAXOU4K7M2iKzn+oNIjIWFFJ?=
 =?iso-8859-1?Q?tKDp9h4+0EABnIgIJkD7k+mHMN5KY4ZmsveigNDOlC8J9x5D0hSOZgSuXM?=
 =?iso-8859-1?Q?+JzdBzz+bmTDcu9dLzrB3IbUJpcNtPoLXxReKBahYE8dh+QDBaWiE47zdQ?=
 =?iso-8859-1?Q?ba8IGuIOPXYb6F5xdfsoWxUtcOw8OiERS1yClRFhXjteSyZScmsrrXgY27?=
 =?iso-8859-1?Q?GCChUJjShTL85crQh3KibjsSs8r/ryDA3pjc1t4d1P3BUEoiIHf3WzFy+x?=
 =?iso-8859-1?Q?1crbKET6QzGDkSoOIF+LGFDrFknLUMzw=3D=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:BYAPR11MB2854.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230040)(366016)(1800799024)(376014); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?mXM3lBuEyvzJzBSLgESmt7o9flAbCDJ0bkH0TTwXZIKO6CgrPjDqEBYuPj?=
 =?iso-8859-1?Q?4qkPdeBoGn0qntluf3GsttImcwmEeiTcTLFSJlnfLblT4+zpdQdGbr1Z+L?=
 =?iso-8859-1?Q?mZ5uEghJ/puQxfaoT7TxyBm2PIGtDZeNKEa7lLdBVV31m0DioDhYjudd0g?=
 =?iso-8859-1?Q?13FY0Gc0trEbm7NXitM8SNFMEqZINdDdnkqcX7RxocNhif1c83dcCtqJCL?=
 =?iso-8859-1?Q?Vrk04zxsOwn8wyaGTOwfcmzrs++X8jO6gISoVfVU+xxdMnFDox5VzubyjP?=
 =?iso-8859-1?Q?bpmWKkcUPjEMbjOWYZwMd6AjT89gcK/Y1xFREZ7OmKJLCCkbP6qUoJHD6W?=
 =?iso-8859-1?Q?+FoUOH/04pN+BWsmIX+ROHGyfmUBpzakWQsUksFvsd1Zarycxde+gm5FNZ?=
 =?iso-8859-1?Q?gAm+xpSU7tDR01xbf/5l+Wn+8+35jXNqTYRHKCvA7kODDvy3DHJ7dp8skY?=
 =?iso-8859-1?Q?+MNL40gFuvtq1ohkD7Sd3qeISuQWlVIzgA3CHHQtG0SQ6Si+IPPdkjhBQO?=
 =?iso-8859-1?Q?7odQc26sib+Slz62RNtSqAJ0PPoXWoOD1zwhfHheRLSSv3RZgy/3AIjI1m?=
 =?iso-8859-1?Q?RTVfN6kHamxzK7li6IcHvYa8mKvLRv4bbjJlNfPddBXolOhkLI5AFSd+ld?=
 =?iso-8859-1?Q?clO25WEiR7+NLrRdOp6aPFPM0VcXj+EgmskgCGAgt2XRcxUylsecwM4hRA?=
 =?iso-8859-1?Q?7a7wlLJfrq/sPm4rV0WKA0rz6ZqsxrqdrUOsZqi0NmWnIPCrdlh/GIfaNI?=
 =?iso-8859-1?Q?TXqGqWzwTILdZ1NXnYfH2kvkjj72B8FeAovHAvwgNtfdPTeTKxZn8ZmXH+?=
 =?iso-8859-1?Q?46AIDSkS2kQ8pqGmZrwVU/S6q/e5BBlMLzDmg75ta11tRKYJdc8xHr4pVd?=
 =?iso-8859-1?Q?u6CQysdT9oepGKUGDfTjYZvO8JXJa7JtMarupGtHkyKlpYGLuBAFbKKkSt?=
 =?iso-8859-1?Q?kf/9rm27qs/3yFsFAt5a3GbDAJG5WT8banPhqDArnSZj2aeclsUddIPRGZ?=
 =?iso-8859-1?Q?ODhN+4fkDtY4Rgdf1OAVi+0LA9GTItaDCocuoDw9GKM+ks9wL+mPsrnMaL?=
 =?iso-8859-1?Q?JSu4NVuSKXwlBlU5oWqYlWOfgpCWjY7OXK928Angdve8jooPHVhoWb+BdM?=
 =?iso-8859-1?Q?E0u8dE43Q+mqVmqkBG6l0MG1opm3jqIE8lwZkbFBJjYRZzz0kqyxLfeum0?=
 =?iso-8859-1?Q?f8PH9DQZSxZk5QhtHTBdAI7kaxa5dIOVso8WZ0wWv80cIWtTeiMbhzKFTo?=
 =?iso-8859-1?Q?nOriwHC8SrSt0WsFDNplafVddDUlSzwJ3Zo09hZcg1PDX8q+pkltcm7vgi?=
 =?iso-8859-1?Q?lGOuVAwLxqX6gxkhknCfM7w2wh4F8oB77wQdpDdb19C5tcaQB3khNjgWCA?=
 =?iso-8859-1?Q?6//wGxJYrK1TbIXo2LBRN7FUmL917FxczGnB+DyITDCpdhLNcCQAtrdMip?=
 =?iso-8859-1?Q?nxTPA2vXRPfaziKKuL0jlMkUXZ0pv9+SjN/hMZ9WxX2Vyg9181QWebFCGS?=
 =?iso-8859-1?Q?ec5R/eclKl+7gW+xJMgnkQ7c1EZa1dVLTpUalmrS7HPs8k8LGkkigLDaXa?=
 =?iso-8859-1?Q?rzQV2vYMfRh4Jt2G/PuCtAcoX3WJKly3aRRIPtyyJyqJhRGAgY/49daD2M?=
 =?iso-8859-1?Q?vKg832Qak3HbHhNvXWIx1R2y8FlWvAZQ9RIOG1SxIQOfFgqf8+iOujBg?=
 =?iso-8859-1?Q?=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 49679e81-53c8-4f2a-8ee4-08dcce85f7c1
X-MS-Exchange-CrossTenant-AuthSource: BYAPR11MB2854.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Sep 2024 15:10:02.8620 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: xD0RikI6f8tcFjfTJKcZbiv3aS+tjGLZBMleCtn9TmfDv0tP5OU9cKxuHJTqhV4CUhutkrzuq1herDeGzTOH4w==

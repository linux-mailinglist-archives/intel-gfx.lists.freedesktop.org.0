...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 71D2A2E1B9D
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Dec 2020 12:12:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 901CA6E945;
	Wed, 23 Dec 2020 11:12:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E26D16E90B
 for <intel-gfx@lists.freedesktop.org>; Wed, 23 Dec 2020 11:11:49 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23412232-1500050 
 for multiple; Wed, 23 Dec 2020 11:11:35 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 23 Dec 2020 11:11:10 +0000
Message-Id: <20201223111126.3338-46-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 46/62] drm/i915: Move saturated workload
...
index b48ab6dab738..a0b01b6d475c 100644
--- a/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
@@ -3308,21 +3308,6 @@ intel_execlists_create_virtual(struct intel_engine_cs **siblings,
...
index e636c68d4776..8fd69631b1b6 100644
--- a/drivers/gpu/drm/i915/i915_request.c
+++ b/drivers/gpu/drm/i915/i915_request.c
@@ -572,7 +572,7 @@ bool __i915_request_submit(struct i915_request *request)
 	 */
...
@@ -1033,7 +1033,7 @@ already_busywaiting(struct i915_request *rq)
 	 *

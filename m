...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA9F11ED2BE
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jun 2020 16:57:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56BD389C97;
	Wed,  3 Jun 2020 14:57:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6020389C82
 for <intel-gfx@lists.freedesktop.org>; Wed,  3 Jun 2020 14:57:18 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  3 Jun 2020 16:57:02 +0200
Message-Id: <20200603145713.3835124-13-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 13/24] drm/i915: Make sure execbuffer always
...
index afa4328c3f54..1aead8e0d3de 100644
...
index 9aa9b70a8ecb..2048b21ac8b2 100644
...
index 0b012abbdad5..ff9f20e3f4d4 100644
...
+	err = i915_vma_pin_ww(vma, &eb->ww,
 	...
 	if (err)
@@ -1052,7 +1053,7 @@ static int reloc_gpu_chain(struct i915_execbuffer *eb, struct reloc_cache *cache
 		goto out_pool;
 	}
...
@@ -1222,9 +1223,10 @@ static void *reloc_kmap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	void *vaddr;
@@ -1246,10 +1248,13 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 		if (err)
 			return ERR_PTR(err);
...
@@ -1285,9 +1290,10 @@ static void *reloc_iomap(struct drm_i915_gem_object *obj,
 }
...
+	struct reloc_cache *cache = &eb->reloc_cache;
 	...
 	if (cache->page == page) {
@@ -1295,7 +1301,7 @@ static void *reloc_vaddr(struct drm_i915_gem_object *obj,
 	} else {
 		vaddr = NULL;
...
@@ -1381,7 +1387,7 @@ static int __reloc_gpu_alloc(struct i915_execbuffer *eb,
 		goto err_unmap;
 	}
...
@@ -1627,8 +1633,7 @@ relocate_entry(struct i915_vma *vma,
 		void *vaddr;
...
@@ -2044,6 +2049,7 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb,
...
@@ -2334,7 +2340,8 @@ static int i915_reset_gen7_sol_offsets(struct i915_request *rq)
 }
...
+		 struct drm_i915_gem_object *obj,
 		 ...
 		 unsigned int flags)
 {
@@ -2345,7 +2352,7 @@ shadow_batch_pin(struct drm_i915_gem_object *obj,
 	if (IS_ERR(vma))
 		return vma;
...
@@ -2457,16 +2464,33 @@ static int eb_parse_pipeline(struct i915_execbuffer *eb,
 	return err;
 }
...
@@ -2494,7 +2518,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (err)
 		goto err;
...
+	shadow = shadow_batch_pin(eb, pool->obj, eb->context->vm, PIN_USER);
 	if (IS_ERR(shadow)) {
 		err = PTR_ERR(shadow);
 		goto err;
@@ -2505,7 +2529,7 @@ static int eb_parse(struct i915_execbuffer *eb)
 	if (CMDPARSER_USES_GGTT(eb->i915)) {
 		trampoline = shadow;
...
+		shadow = shadow_batch_pin(eb, pool->obj,
 					  ...
 					  PIN_GLOBAL);
 		if (IS_ERR(shadow)) {
@@ -2517,19 +2541,34 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2684,7 +2723,7 @@ static struct i915_request *eb_pin_engine(struct i915_execbuffer *eb, bool throt
...
@@ -3107,33 +3146,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -3142,7 +3155,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
+		goto err_vma;
 	...
 	if (in_fence) {
@@ -3204,9 +3217,6 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	}
...
-		i915_vma_unpin(batch);
 err_vma:
 	...
 	if (eb.trampoline)
@@ -3290,7 +3300,9 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 2, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3368,8 +3380,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;
...
index c8c14981eb5d..d967debba28d 100644
...
index 3d6a82b6648e..4948368062b2 100644
...
@@ -3853,7 +3854,7 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		goto err;
 	}
...
index f9ef34a489ec..d714737f3f7f 100644
...
index 3e35a45d6218..46379df7b52d 100644
--- a/drivers/gpu/drm/i915/gt/selftest_lrc.c
+++ b/drivers/gpu/drm/i915/gt/selftest_lrc.c
@@ -2989,7 +2989,7 @@ static struct i915_vma *create_global(struct intel_gt *gt, size_t sz)
 		return vma;
 	}
...
index 98f2c448cd92..3dea3df34532 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1757,11 +1757,18 @@ static inline void i915_gem_drain_workqueue(struct drm_i915_private *i915)
 }
...
index 9b30ddc49e4b..1e81b368c792 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B40F10790
	for <lists+intel-gfx@lfdr.de>; Wed,  1 May 2019 13:46:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AE6BA89198;
	Wed,  1 May 2019 11:45:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8A73D890D3
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 May 2019 11:45:54 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16415740-1500050 
 for multiple; Wed, 01 May 2019 12:45:43 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  1 May 2019 12:45:37 +0100
Message-Id: <20190501114541.10077-10-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/14] drm/i915/execlists: Don't apply priority
 boost for resets
...
Yy5jCmluZGV4IDM1YWFlN2I1YzZiOS4uYWEwM2RkMDc2MGU5IDEwMDY0NAotLS0gYS9kcml2ZXJz

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7672A4A9C2C
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Feb 2022 16:44:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 786DF89EB1;
	Fri,  4 Feb 2022 15:44:03 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 6/6] drm/amdgpu: use

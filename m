...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D0514FE48B
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 17:19:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D09110E6D8;
...
Subject: [Intel-gfx] [PATCH v2 4/5] drm/i915: ttm backend dont provide

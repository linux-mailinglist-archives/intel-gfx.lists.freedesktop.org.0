...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE3FB4B5541
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Feb 2022 16:49:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5599A10E288;
...
Subject: [Intel-gfx] [PATCH V2 2/13] clk: mvebu: use

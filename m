...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D11364BEDA6
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 00:17:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70D2410E4C2;
...
Subject: [Intel-gfx] [PATCH v2 2/9] lib/ref_tracker: compact stacktraces
 before printing

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8EB133B27C5
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C7FE6EA2E;
	Thu, 24 Jun 2021 06:47:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 77BF66E848;
 Thu, 24 Jun 2021 06:47:29 +0000 (UTC)
IronPort-SDR: qjpK7oJt3BjvE+XJEXSdYuXuSd484XBWzixXqRgDHJE01vJGQNHdesCCpqieQr/5K+3lXfzZ6E
 Vja1+J8tGCSg==
X-IronPort-AV: E=McAfee;i="6200,9189,10024"; a="207346747"
X-IronPort-AV: E=Sophos;i="5.83,295,1616482800"; d="scan'208";a="207346747"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Jun 2021 23:47:25 -0700
IronPort-SDR: foBt5rRR+Cm4UQKmO2U7lew+t2dwoeSv/AXTVyN06oXaMF7UY33+GzyFNECABi2xSBnUuAgA1/
 M3pLslesDloQ==
X-IronPort-AV: E=Sophos;i="5.83,295,1616482800"; d="scan'208";a="556390890"
...
Date: Thu, 24 Jun 2021 00:04:38 -0700
Message-Id: <20210624070516.21893-10-matthew.brost@intel.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <20210624070516.21893-1-matthew.brost@intel.com>
References: <20210624070516.21893-1-matthew.brost@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/47] drm/i915/guc: Remove GuC stage descriptor,
 add lrc descriptor

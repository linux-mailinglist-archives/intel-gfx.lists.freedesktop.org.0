...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id iAtgDN+35mlJ0AEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Apr 2026 01:33:51 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D4EF5434D8D
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Apr 2026 01:33:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 37AEF10E7C9;
	Mon, 20 Apr 2026 23:33:49 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=qualcomm.com header.i=@qualcomm.com header.b="RB4BV8q3";
	dkim=pass (2048-bit key; unprotected) header.d=oss.qualcomm.com header.i=@oss.qualcomm.com header.b="TXOnYtDZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com
 [205.220.180.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AF37A10E7C9
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2026 23:33:47 +0000 (UTC)
Received: from pps.filterd (m0279871.ppops.net [127.0.0.1])
 by mx0a-0031df01.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id
 63KFpLAe2281651
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2026 23:33:46 GMT
...
Received: from mail-qt1-f198.google.com (mail-qt1-f198.google.com
 [209.85.160.198])
 by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 4dnh59axc1-1
 (version=TLSv1.3 cipher=TLS_AES_128_GCM_SHA256 bits=128 verify=NOT)
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2026 23:33:46 +0000 (GMT)
Received: by mail-qt1-f198.google.com with SMTP id
 d75a77b69052e-50b220c72bbso95718221cf.1
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 Apr 2026 16:33:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=oss.qualcomm.com; s=google; t=1776728026; x=1777332826;
 darn=lists.freedesktop.org; 
 h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
 :mime-version:subject:date:from:from:to:cc:subject:date:message-id
 :reply-to; bh=5tD1CybSiFSGx/tKPVz/twlIrgCEvULY+FLI3aHZuz4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 b=
X-Forwarded-Encrypted: i=1;
 AFNElJ+OyApVVZINU5Te2y5iRE8UOrMAHIV7m5AGNuRxd+6ahomTOHawZx6mgAFSqzAtpuiFfAIGWefC7vQ=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YyM3Fqcwscba2zGGMqSnYvHdtWZ3w1KtsRpkm3p+WEUb7xq4di8
 38EH69m73t2KbYQdm2mV/B2Tqu1mnbCFhLRgC4JkLIhWF12CC1p9L2QEv83L6Eyq0eTL4jJ3mWl
 /OAefuzyQv4rYft6RrQQ88XVQkrK2S0CmD3VWIRJAZR3tD0vN08WzNAvS4llZoOood+qPJ/I=
X-Gm-Gg: 
X-Received: by 2002:a05:622a:4189:b0:50d:8b60:ff13 with SMTP id
 d75a77b69052e-50e3694038amr241879481cf.14.1776728025613; 
 Mon, 20 Apr 2026 16:33:45 -0700 (PDT)
X-Received: by 2002:a05:622a:4189:b0:50d:8b60:ff13 with SMTP id
 d75a77b69052e-50e3694038amr241878721cf.14.1776728025097; 
 Mon, 20 Apr 2026 16:33:45 -0700 (PDT)
Received: from umbar.lan
 (2001-14ba-a073-af00-264b-feff-fe8b-be8a.rev.dnainternet.fi.
 [2001:14ba:a073:af00:264b:feff:fe8b:be8a])
 by smtp.gmail.com with ESMTPSA id
 2adb3069b0e04-5a4185bc627sm3320714e87.29.2026.04.20.16.33.41
...
X-Proofpoint-ORIG-GUID: 8gWxhc-aDoTyHATT45S7EZXL-VMaRMKm
X-Proofpoint-GUID: 8gWxhc-aDoTyHATT45S7EZXL-VMaRMKm
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwNDIwMDIzMCBTYWx0ZWRfXwU3SmiOmQKf6
 
X-Authority-Analysis: v=2.4 cv=HNrz0Itv c=1 sm=1 tr=0 ts=69e6b7da cx=c_pps
 a=mPf7EqFMSY9/WdsSgAYMbA==:117 a=xqWC_Br6kY4A:10 a=IkcTkHD0fZMA:10
 a=A5OVakUREuEA:10 a=s4-Qcg_JpJYA:10 a=VkNPw1HP01LnGYTKEx00:22
 a=u7WPNUs3qKkmUXheDGA7:22 a=3WHJM1ZQz_JShphwDgj5:22 a=EUspDBNiAAAA:8
 a=-CExsNOmisbVDtTgQd4A:9 a=QEXdDO2ut3YA:10 a=dawVfQjAaf238kedN5IG:22

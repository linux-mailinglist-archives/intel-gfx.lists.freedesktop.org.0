...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A00DA7A29DD
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Sep 2023 23:57:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C682510E6A0;
...
Subject: [Intel-gfx] [PATCH 2/4] drm/i915: Enable Wa_16019325821

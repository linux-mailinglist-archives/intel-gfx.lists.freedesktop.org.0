...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0A337570A7
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 01:49:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 51D5110E00D;
	Mon, 17 Jul 2023 23:49:19 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/huc: check HuC and GuC version

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 31D84667C1E
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Jan 2023 17:58:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E63C10E317;
...
Subject: [Intel-gfx] [RFC 11/12] drm/i915: Wire up with drm controller GPU
 time query

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8458F17C661
	for <lists+intel-gfx@lfdr.de>; Fri,  6 Mar 2020 20:38:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BAB5C6ED56;
...
Subject: Re: [Intel-gfx] [PATCH] drm: add managed resources tied to
 drm_device

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C169C6ACF84
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Mar 2023 21:50:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 863FF10E233;
...
Subject: [Intel-gfx] [PATCH 3/3] drm/i915/dg1: Move Wa_1806527549 to the
 right function

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6E2D4844774
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Jan 2024 19:49:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E210910FC3B;
	Wed, 31 Jan 2024 18:49:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5D0F710FC39;
 Wed, 31 Jan 2024 18:49:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1706726941; x=1738262941;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=g14cgVTPMlcp9v1pcAgKwu+U36joiyJAOeQ9eAUY/sM=;
 b=HKqJ61Hu/elJxE2WbmHDLuQZm/1X9GxRtDsLUh3NC9H4/6kTyRAgBJlP
 vNpe8lkm0r7HL7dzsz3+aEmFYlyizQnQEWdpsjcDYfWYG7M8xn9RTBSiJ
 ClxDZD8PuUGXwl9SssWXtpdOmmgZitNAZFxwLFW+tHz7OPlxyhHlSa+tV
 X7DgyvgiYggLhBzEw6Wu3qyrpPvsF5fWvFGLHycucdr9gD7tXQr/nNkCH
 AGIzTZl1+QGNegmGF8/fJxZ8YPhWYFvWZJS+S1l6AD2JFNRByEY1g9IDc
 s3q1lc8dOuR6h2FUjabGFZsip6jMiZGcx6oIgSQohH2NV8CJ+tOwqnfuB w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10969"; a="17075394"
X-IronPort-AV: E=Sophos;i="6.05,231,1701158400"; d="scan'208";a="17075394"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jan 2024 10:49:01 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10969"; a="961675139"
X-IronPort-AV: E=Sophos;i="6.05,231,1701158400"; d="scan'208";a="961675139"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jan 2024 10:48:59 -0800
Date: Wed, 31 Jan 2024 20:49:16 +0200
From: Imre Deak <imre.deak@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Subject: Re: [PATCH 02/19] drm/dp: Add support for DP tunneling
Message-ID: <ZbqWLMLHMHpj+SLX@ideak-desk.fi.intel.com>
...
In-Reply-To: <ZbpwoA1gXI_dnZAr@intel.com>

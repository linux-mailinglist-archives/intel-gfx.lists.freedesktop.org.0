...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D1516DE4C8
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Apr 2023 21:22:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1465C10E642;
	Tue, 11 Apr 2023 19:21:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yb1-xb2d.google.com (mail-yb1-xb2d.google.com
 [IPv6:2607:f8b0:4864:20::b2d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5A3D110E61D
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Apr 2023 19:21:48 +0000 (UTC)
Received: by mail-yb1-xb2d.google.com with SMTP id q5so12199855ybk.7
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Apr 2023 12:21:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1681240907; x=1683832907;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=eRpn68FgI1hY0kejzCxPGD1bOOlJ0s37GCU7vMBkaEw=;
 b=C940RjgcLxNrTvSdi5+dctGkLiHdDocSs7NqVbl8/zYahOEwNEgqxTTbJ2cLaln36d
 74JG3fOqcll3VE+EJRd8jg6jOV0kWqTmtnXgzo4CUrggwmCZLTgP88vHGmBIOOc0V4od
 y+JOfjIbYdTrlKm1zJcgLyE1U4Z9wLDt8AU8Q=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1681240907; x=1683832907;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=eRpn68FgI1hY0kejzCxPGD1bOOlJ0s37GCU7vMBkaEw=;
 b=
X-Gm-Message-State: AAQBX9f6YyLb03H6zvwDTBfDpKpwBYwfSo01PjnIW7VtAlnJr/pMfu6/
 MR/Lhdc01jlgU8UwkwIcbcFXiQ==
X-Google-Smtp-Source: AKy350Y0/oB259pFlNDEhcscirsZpUk67cQGuNKH4AGLJrBvmW5AHq3SzWt2M613zyHLM/wQAy9cYQ==
X-Received: by 2002:a25:b199:0:b0:afe:e13e:6379 with SMTP id
 h25-20020a25b199000000b00afee13e6379mr12771123ybj.13.1681240906886; 
 Tue, 11 Apr 2023 12:21:46 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:2991:9b76:4e62:65bf])
 by smtp.gmail.com with UTF8SMTPSA id
 x13-20020a056902138d00b00b8ed4e15acbsm2359272ybu.63.2023.04.11.12.21.45
...
Date: Tue, 11 Apr 2023 15:21:28 -0400
Message-Id: <20230411192134.508113-5-markyacoub@google.com>
...
Subject: [Intel-gfx] [PATCH v9 04/10] drm/hdcp: Expand HDCP helper library

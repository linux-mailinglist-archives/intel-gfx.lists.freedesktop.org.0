...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 57EA621FF70
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49D1D6EA12;
...
Subject: [Intel-gfx] [PATCH v2 25/59] drm/kmb: Display clock enable/disable

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 019A19C0FC9
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2024 21:33:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9250310E8E0;
	Thu,  7 Nov 2024 20:33:01 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="UTV+H8rk";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 93EA510E8DD;
 Thu,  7 Nov 2024 20:33:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1731011580; x=1762547580;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=H6REj+nBPB9pgu9eYXMn5/fN+CUlfMV4tdn2VX6TcNA=;
 b=UTV+H8rkkV1Ci0m3AQR9Z0mPT78AhjvPAev+h60xDsZn/cxU9Bii15I2
 aLBKwrPAjekJk57ctIkG78Rfrqy8rUPgNOq1rQEgsrdq+c9LUYuChmdWk
 NGICcEba7BGnW9+h7ziL7FE7bTwsJm9A/SlFcL5UCRFm2FwGnXTdqhq15
 9NG3tgu0xThvU6xJTUBVPLbDWHZ5AMurRSrCGR3uWobnDW6owjZRSx9i4
 yXvYi10Cbly7pRqjHwftV3zsdjXYsrnu4N1Kqv1k/yq5mFd7KXoADTqXq
 jSXDf8+2TfdQpiGfW0feCTMTbsT5moNfOk0I8R3YPcO1k5ifcBsCdzEpH A==;
X-CSE-ConnectionGUID: eNNSxJacTly80RLlcOJEOQ==
X-CSE-MsgGUID: 05JSdN2aSYSDUVPsn8wSGQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11249"; a="30298090"
X-IronPort-AV: E=Sophos;i="6.12,136,1728975600"; d="scan'208";a="30298090"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 12:33:00 -0800
X-CSE-ConnectionGUID: z5HSz9HiTrKo/6s7VJ6u+A==
X-CSE-MsgGUID: tG0JYvrJSSCxxfFym2iK4Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,136,1728975600"; d="scan'208";a="108493864"
Received: from klitkey1-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.233])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2024 12:32:58 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com, imre.deak@intel.com, ville.syrjala@linux.intel.com
Subject: [PATCH 6/8] drm/i915/mst: convert to struct intel_display
Date: Thu,  7 Nov 2024 22:32:19 +0200
Message-Id: <66578195d58c9b0925e0e3d06b86cf98ef0c8bc8.1731011435.git.jani.nikula@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5553C211D08
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Jul 2020 09:31:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B26A6EA63;
	Thu,  2 Jul 2020 07:31:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 447796EA64
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Jul 2020 07:31:09 +0000 (UTC)
IronPort-SDR: t8nTgUxHfUskUh5x0BLdrVnMBiTzDJS4lBQcA5W0GYsgYcLuhuTAVJ3GBAxmMH5+a7fOgP6esh
 oPUjT15lB8Ug==
X-IronPort-AV: E=McAfee;i="6000,8403,9669"; a="164875051"
X-IronPort-AV: E=Sophos;i="5.75,303,1589266800"; d="scan'208";a="164875051"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jul 2020 00:31:08 -0700
IronPort-SDR: 2nX0+nVt7UDyQysIqR1wNxHOfGDBwCaD7k5kFsREG3rL8iheyaZaIK3wXz2WYfyHplvy2uz+mt
 bGWZ6665MHtg==
X-IronPort-AV: E=Sophos;i="5.75,303,1589266800"; d="scan'208";a="455422057"
Received: from ideak-desk.fi.intel.com ([10.237.72.183])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jul 2020 00:31:06 -0700
Date: Thu, 2 Jul 2020 10:31:01 +0300
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Message-ID: <20200702073101.GA21810@ideak-desk.fi.intel.com>
References: <20200701180001.15857-1-imre.deak@intel.com>
 <159364948499.5656.9724558548136365129@emeril.freedesktop.org>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <159364948499.5656.9724558548136365129@emeril.freedesktop.org>
...
On Thu, Jul 02, 2020 at 12:24:44AM +0000, Patchwork wrote:
> == Series Details ==
> 
...
>   **FAILURE**
> 
>   Serious unknown changes coming with Patchwork_18060_full absolutely need to be
>   verified manually.
>   
...
>    [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-snb4/igt@perf_pmu@busy-double-start@rcs0.html

(perf_pmu:2212) WARNING: Spinner not running after 2000.00ms
(perf_pmu:2212) CRITICAL: Test assertion failure function __spin_wait, file ../tests/perf_pmu.c:205:
(perf_pmu:2212) CRITICAL: Failed assertion: t < 2e9

Looks like 
https://gitlab.freedesktop.org/drm/intel/-/issues/2037

> #### Warnings ####
> 
>   * igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-shrfb-draw-blt:
>     - shard-hsw:          [SKIP][3] ([fdo#109271]) -> [INCOMPLETE][4]
>    [3]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-hsw1/igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-shrfb-draw-blt.html
>    [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-hsw8/igt@kms_frontbuffer_tracking@psr-1p-primscrn-pri-shrfb-draw-blt.html

The machine hangs in the middle of the test, no idea why. The patch is a
fix for a hotplug detection logic, but I can't see any detection
happening around the hang. I saw earlier unexplained hangs on HSW, I'd
suggest a new ticket for these.
...
>    [5]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-kbl1/igt@gem_eio@in-flight-suspend.html
>    [6]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-kbl7/igt@gem_eio@in-flight-suspend.html
> 
>   * igt@gem_exec_reloc@basic-wc-read:
>     - shard-apl:          [PASS][7] -> [DMESG-WARN][8] ([i915#1635] / [i915#95]) +26 similar issues
>    [7]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-apl8/igt@gem_exec_reloc@basic-wc-read.html
>    [8]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-apl1/igt@gem_exec_reloc@basic-wc-read.html
> 
>   * igt@gem_mmap_gtt@cpuset-basic-small-copy:
>     - shard-snb:          [PASS][9] -> [TIMEOUT][10] ([i915#1958] / [i915#2119])
>    [9]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-snb5/igt@gem_mmap_gtt@cpuset-basic-small-copy.html
>    [10]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-snb4/igt@gem_mmap_gtt@cpuset-basic-small-copy.html
> 
>   * igt@i915_suspend@fence-restore-untiled:
>     - shard-skl:          [PASS][11] -> [INCOMPLETE][12] ([i915#69])
>    [11]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-skl4/igt@i915_suspend@fence-restore-untiled.html
>    [12]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-skl8/igt@i915_suspend@fence-restore-untiled.html
> 
>   * igt@kms_big_fb@y-tiled-32bpp-rotate-0:
>     - shard-kbl:          [PASS][13] -> [DMESG-WARN][14] ([i915#93] / [i915#95]) +3 similar issues
>    [13]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-kbl1/igt@kms_big_fb@y-tiled-32bpp-rotate-0.html
>    [14]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-kbl7/igt@kms_big_fb@y-tiled-32bpp-rotate-0.html
> 
>   * igt@kms_big_fb@y-tiled-64bpp-rotate-0:
>     - shard-glk:          [PASS][15] -> [DMESG-FAIL][16] ([i915#118] / [i915#95])
>    [15]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-glk9/igt@kms_big_fb@y-tiled-64bpp-rotate-0.html
>    [16]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-glk8/igt@kms_big_fb@y-tiled-64bpp-rotate-0.html
> 
>   * igt@kms_color@pipe-b-ctm-negative:
>     - shard-skl:          [PASS][17] -> [DMESG-WARN][18] ([i915#1982]) +13 similar issues
>    [17]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-skl9/igt@kms_color@pipe-b-ctm-negative.html
>    [18]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-skl6/igt@kms_color@pipe-b-ctm-negative.html
> 
>   * igt@kms_cursor_crc@pipe-a-cursor-suspend:
>     - shard-kbl:          [PASS][19] -> [DMESG-WARN][20] ([i915#180] / [i915#93] / [i915#95])
>    [19]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-kbl7/igt@kms_cursor_crc@pipe-a-cursor-suspend.html
>    [20]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-kbl2/igt@kms_cursor_crc@pipe-a-cursor-suspend.html
> 
>   * igt@kms_cursor_crc@pipe-b-cursor-128x42-sliding:
>     - shard-skl:          [PASS][21] -> [FAIL][22] ([i915#54])
>    [21]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-skl10/igt@kms_cursor_crc@pipe-b-cursor-128x42-sliding.html
>    [22]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-skl8/igt@kms_cursor_crc@pipe-b-cursor-128x42-sliding.html
> 
>   * igt@kms_draw_crc@draw-method-xrgb2101010-mmap-cpu-untiled:
>     - shard-skl:          [PASS][23] -> [FAIL][24] ([i915#52] / [i915#54])
>    [23]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-skl8/igt@kms_draw_crc@draw-method-xrgb2101010-mmap-cpu-untiled.html
>    [24]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-skl2/igt@kms_draw_crc@draw-method-xrgb2101010-mmap-cpu-untiled.html
> 
>   * igt@kms_flip@flip-vs-expired-vblank-interruptible@b-edp1:
>     - shard-skl:          [PASS][25] -> [FAIL][26] ([i915#79])
>    [25]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-skl2/igt@kms_flip@flip-vs-expired-vblank-interruptible@b-edp1.html
>    [26]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-skl6/igt@kms_flip@flip-vs-expired-vblank-interruptible@b-edp1.html
> 
>   * igt@kms_frontbuffer_tracking@fbc-1p-indfb-fliptrack:
>     - shard-kbl:          [PASS][27] -> [DMESG-WARN][28] ([i915#1982])
>    [27]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-kbl6/igt@kms_frontbuffer_tracking@fbc-1p-indfb-fliptrack.html
>    [28]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-kbl6/igt@kms_frontbuffer_tracking@fbc-1p-indfb-fliptrack.html
> 
>   * igt@kms_frontbuffer_tracking@fbc-rgb565-draw-mmap-cpu:
>     - shard-tglb:         [PASS][29] -> [DMESG-WARN][30] ([i915#1982])
>    [29]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-tglb8/igt@kms_frontbuffer_tracking@fbc-rgb565-draw-mmap-cpu.html
>    [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-tglb3/igt@kms_frontbuffer_tracking@fbc-rgb565-draw-mmap-cpu.html
> 
>   * igt@kms_plane_alpha_blend@pipe-b-coverage-7efc:
>     - shard-skl:          [PASS][31] -> [FAIL][32] ([fdo#108145] / [i915#265]) +1 similar issue
>    [31]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-skl10/igt@kms_plane_alpha_blend@pipe-b-coverage-7efc.html
>    [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-skl8/igt@kms_plane_alpha_blend@pipe-b-coverage-7efc.html
> 
>   * igt@kms_psr@psr2_cursor_mmap_cpu:
>     - shard-iclb:         [PASS][33] -> [SKIP][34] ([fdo#109441]) +1 similar issue
>    [33]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_8688/shard-iclb2/igt@kms_psr@psr2_cursor_mmap_cpu.html
>    [34]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_18060/shard-iclb6/igt@kms_psr@psr2_cursor_mmap_cpu.html
> 

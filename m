...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D1A209F3ABB
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Dec 2024 21:25:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 19B0F10E79E;
	Mon, 16 Dec 2024 20:25:56 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="hynNwA/j";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D36FD10E40B
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Dec 2024 20:25:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1734380753;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=P4jF4BBxwsMDDgthPRz+icZRZMETvUL/RE5NysxXwKo=;
 b=hynNwA/j7+xnNknOvLixxp4S3l2yFNTFMoOmBSmWpdRLk4riZX63NPf+GLrP675YFu+Lae
 4ubz61Z0mVSN6FZAA14WoZi0bcNsev/6A0aTGNQGijYlNtoRBcZbM9J2A8TLgSD9fUIWO4
 wRqxXynf1aes1A818qbazftFT3X6aRQ=
Received: from mail-qv1-f72.google.com (mail-qv1-f72.google.com
 [209.85.219.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-63-k9NhkBkzPeKJ8_zdP3ksiw-1; Mon, 16 Dec 2024 15:25:51 -0500
X-MC-Unique: k9NhkBkzPeKJ8_zdP3ksiw-1
X-Mimecast-MFC-AGG-ID: k9NhkBkzPeKJ8_zdP3ksiw
Received: by mail-qv1-f72.google.com with SMTP id
 6a1803df08f44-6d8f8b9d43aso95479606d6.0
 for <intel-gfx@lists.freedesktop.org>; Mon, 16 Dec 2024 12:25:51 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1734380751; x=1734985551;
 h=mime-version:user-agent:content-transfer-encoding:organization
 :references:in-reply-to:date:cc:to:from:subject:message-id
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=L+SMiJp1JV3F9E+EIFjNdp/qflVWJw+RYqFYKaE8kS0=;
 b=
X-Gm-Message-State: AOJu0YziLgz06aH969OJQz27qQlG+PB818PdUPLYnJcKm/CUGs951lgV
 QiJrDy8yULiGM6w4bcqTP4COx3Bv4CoKlXOf9/SLSaXnILn+d/37/c7P0iPKFaR+zf4FZwpKDhg
 Jsnrv5XNQni/YvL78yDzSJZR1W5mNk2YpActHToJz8JJKxbmPUTQnFC5KvIG1d+0dww==
X-Gm-Gg: 
X-Received: by 2002:a05:6214:300e:b0:6d4:238e:35b0 with SMTP id
 6a1803df08f44-6dc8ca57023mr252660106d6.17.1734380750332; 
...
X-Mimecast-MFC-PROC-ID: wsMcoTxKiat0OriIJG1ynsk33MLcikgcOgPdIkKEf6Q_1734380751

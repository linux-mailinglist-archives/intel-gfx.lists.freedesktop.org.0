...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 099A449C75D
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jan 2022 11:23:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BEE610E7C9;
	Wed, 26 Jan 2022 10:23:25 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 00/11] lib/string_helpers: Add a few
 string helpers

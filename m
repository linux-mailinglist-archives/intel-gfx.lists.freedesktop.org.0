...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AA52F51E1C0
	for <lists+intel-gfx@lfdr.de>; Sat,  7 May 2022 01:34:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90C4510E4F4;
	Fri,  6 May 2022 23:34:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A4D3810E4F0;
 Fri,  6 May 2022 23:34:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1651880092; x=1683416092;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=4T5zeTRNzTPsMvkKgW7XxstDpJYvMLKQFMiZrTKYIcg=;
 b=Gp1EcTh529pO75jcWucAMpExBMFyWw1NuLYkve54jIyDOn4gK/wezXWP
 WY8xVXbSVpVzk6DapNSA8c/qHDOIL8Gm2kEC4x5dVW4zbkZOd1PylowXH
 fz6t0wA2zYSNKB0N6f72TVYPdjWD6oXAhI99Ad5AtU5UQ5E5DNFXCoSaH
 iyi6CrbcYthAl9o9DA5hcvsxLo3qZEux4GuucLo8NuSoTBENxFi171WTf
 fXYcJfcbnCWjn4QpYtbCsLn0zY78Mm4szgHD1QeuQFsPymNQ0s1GY/KY+
 A+C9F15i9ahPe+uJPmeu3V7F8dWllZ7vOrnsm5Z3JEoOcDyDUUuhqkU3B Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10339"; a="355038709"
X-IronPort-AV: E=Sophos;i="5.91,205,1647327600"; d="scan'208";a="355038709"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 May 2022 16:34:51 -0700
X-IronPort-AV: E=Sophos;i="5.91,205,1647327600"; d="scan'208";a="735976446"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 May 2022 16:34:51 -0700
Date: Fri, 6 May 2022 16:34:49 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
Message-ID: <YnWwmfJs90Faarme@mdroper-desk1.amr.corp.intel.com>
...
In-Reply-To: <7b7f2128-7dd8-ae5a-be61-e450dec1e917@linux.intel.com>

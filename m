...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 06C7713BFF9
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 13:17:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 312A36E942;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 04/21] drm/amdgpu: Convert to struct

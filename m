...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 964CC3D980E
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Jul 2021 00:00:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B7FFD6EB24;
	Wed, 28 Jul 2021 22:00:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 22E256EA5F
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 Jul 2021 22:00:07 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10059"; a="199937024"
X-IronPort-AV: E=Sophos;i="5.84,276,1620716400"; d="scan'208";a="199937024"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jul 2021 15:00:05 -0700
X-IronPort-AV: E=Sophos;i="5.84,276,1620716400"; d="scan'208";a="663663226"
...
Message-Id: <20210728215946.1573015-7-lucas.demarchi@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/25] drm/i915/display: remove explicit CNL
...
@@ -3479,8 +3301,6 @@ void intel_ddi_compute_min_voltage_level(struct drm_i915_private *dev_priv,
...
@@ -3821,13 +3641,6 @@ static void icl_ddi_tc_get_config(struct intel_encoder *encoder,
...
-
 static void bxt_ddi_get_config(struct intel_encoder *encoder,
 			       struct intel_crtc_state *crtc_state)
 {
@@ -4078,8 +3891,6 @@ intel_ddi_init_dp_connector(struct intel_digital_port *dig_port)
...
@@ -4326,15 +4137,6 @@ static bool intel_ddi_a_force_4_lanes(struct intel_digital_port *dig_port)
...
@@ -4439,15 +4241,6 @@ static enum hpd_pin ehl_hpd_pin(struct drm_i915_private *dev_priv,
...
@@ -4655,11 +4448,6 @@ void intel_ddi_init(struct drm_i915_private *dev_priv, enum port port)
...
@@ -4689,8 +4477,6 @@ void intel_ddi_init(struct drm_i915_private *dev_priv, enum port port)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 619A313C035
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 13:18:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 492F96E986;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 11/21] drm/radeon: Convert to CRTC VBLANK
 callbacks

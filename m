...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 471E2732C18
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 11:40:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF8E610E5DA;
	Fri, 16 Jun 2023 09:40:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A80EC10E5D6;
 Fri, 16 Jun 2023 09:40:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686908426; x=1718444426;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=NNIIXz+C7qHNWm1seHZ8X0fNP4FYEKUC/PmwbYoJq7M=;
 b=XMx8eX+j1PmQ+SRGNgU0AvOyQU6uosA4FcweTJEXYVp6K5JlcRU7R49D
 ORvq6T0SreUfpw5bcD7Enh1afq+QcOTAeETcMhZoTIxv0Q3I7KIJWOgme
 mEzcL9YHqUV1VLnOOyKfOFPAemtFwNT8K5ShEkbnPWBW8UiPPpMcpXJAv
 w9fp0RUT4/ICu4jU2rqm+ed3weAD0uTTvQUOUItjDQe9b53YziKW66bM5
 uiJP19s53iAfJUER1Sz02P3Lem9eKxJV7aWhuuDBDc+A2ch8i6EZZtsd6
 bXTVopSiMTV81AxPKV3j4YP+bDkBes5+h6Pd3hVnsFWLp8/MH7gtRN8FX w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="361700422"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="361700422"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2023 02:40:26 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10742"; a="715951240"
X-IronPort-AV: E=Sophos;i="6.00,247,1681196400"; d="scan'208";a="715951240"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga007.fm.intel.com with ESMTP; 16 Jun 2023 02:40:24 -0700
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Fri, 16 Jun 2023 02:39:41 -0700
Message-Id: <20230616093946.68711-18-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230616093946.68711-1-yi.l.liu@intel.com>
References: <20230616093946.68711-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v13 17/22] vfio: Add cdev for vfio_device
...
index 6d45caa1f9a0..8a9ebcc6980b 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D34EB144301
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Jan 2020 18:20:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A1C36EDE5;
...
Subject: [Intel-gfx] [PATCH v2 5/5] drm/i915/cdclk: use new struct

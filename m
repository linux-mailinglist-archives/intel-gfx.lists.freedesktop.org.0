...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 07975A71A98
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Mar 2025 16:37:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C7CD10E70A;
	Wed, 26 Mar 2025 15:37:34 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SxkReU6k";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C0AC810E709;
 Wed, 26 Mar 2025 15:37:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1743003454; x=1774539454;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=a0B7fMkJxt2Wb7bBeMVZwsKjEvvl5x89e9KqNreoDzc=;
 b=SxkReU6kSKcyMYxm0KkXtJKtCi7H3oHXoAXZOX/nlxnQj+hgjq3Sb2jP
 SYr5b6r977vCTuWPLj18TXKaoc0lSRfFqjQmskavSkPt0tkaJIXnQ1MHv
 y5vSluD4zV/vfGWGmDCKLinnQcSYd4hT/Y/EWqLAFxspqrOKQjtiLEq2q
 xCMjTDGuilNijD8YV4958gVjEnHmkfw4yl7z98Yf6Gh1ykTYmrJFwiA2l
 BG/oUAtRLqEpeWt7ZVUbxALFHHqmoRwPzJXK+pmvXdvnW/ZVRl4oivfi7
 vhqRlcQ1Ja9D+wHIS4DtyfNduudqh1chxfcbeGZC1AK4vNLoxwRYHYQrP Q==;
X-CSE-ConnectionGUID: aRw7l+Z3TRSqY32MCOWPzQ==
X-CSE-MsgGUID: cgePbL2xRJ6EtIIgAw0i5A==
X-IronPort-AV: E=McAfee;i="6700,10204,11385"; a="55665467"
X-IronPort-AV: E=Sophos;i="6.14,278,1736841600"; d="scan'208";a="55665467"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Mar 2025 08:37:34 -0700
X-CSE-ConnectionGUID: RZBONXYVRCGe23F7ODszrw==
X-CSE-MsgGUID: GWV/PHCrRA6GpfuUZsM3KQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,278,1736841600"; d="scan'208";a="129923442"
...
Subject: [PATCH v7 03/12] mtd: intel-dg: implement region enumeration
Date: Wed, 26 Mar 2025 17:26:14 +0200
Message-ID: <20250326152623.3897204-4-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AAF1F3970DC
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Jun 2021 12:06:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D83F6E9C2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/9] drm/i915/xelpd: Add support for Logarithmic
 gamma mode

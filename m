...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B22BE61E248
	for <lists+intel-gfx@lfdr.de>; Sun,  6 Nov 2022 14:11:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9418810E177;
...
Subject: Re: [Intel-gfx] [PATCH v6 13/23] drm/modes: Introduce the tv_mode

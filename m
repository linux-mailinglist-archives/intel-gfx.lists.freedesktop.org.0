...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EE2A492407
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jan 2022 11:46:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1AD0D1123FC;
	Tue, 18 Jan 2022 10:46:01 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v9 3/6] drm: implement top-down allocation method

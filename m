...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D3FE54D9BDF
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Mar 2022 14:12:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D96FD10E4A6;
	Tue, 15 Mar 2022 13:12:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E764710E4A6
 for <intel-gfx@lists.freedesktop.org>; Tue, 15 Mar 2022 13:12:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1647349966; x=1678885966;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=O3uXL5TswLNW2JZ/w8CwYeaOdMpI/n5Cr0w/hvk0Njs=;
 b=RMUmKallPMihRZEjIIvWX/mvTjlcbmA5sGIMAuNgDOCGG9DJReGGVt8T
 ct4gf5EA7gy2rpP9YMDEeGX/cCzVDDkV1VytbY4ZqCPJCJ3DeEMAfSjLP
 dHMDikW4TrhhJWf51KVl92wISCJzjQhahZ2F63nDnuTQwBfg2K/EXVfhw
 EY9lZXvQMEM+Tn8RwaKsC5NvL+u6AduK1k2Oj0mUTIZGeAdm23PvOPsD8
 wG5zqYCEiDnM2hG7j4ph5MLD0U4qxtcCNg/DhcUhYRH8i/Lo5qED3N0xN
 KHtQEF7yedpEI67FeUma4jtjGMzgM4TD9c/rXudm/BjXq1w095CoplUM2 A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10286"; a="253853008"
X-IronPort-AV: E=Sophos;i="5.90,183,1643702400"; d="scan'208";a="253853008"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2022 06:12:46 -0700
X-IronPort-AV: E=Sophos;i="5.90,183,1643702400"; d="scan'208";a="556920031"
Received: from sannilnx.jer.intel.com ([10.12.231.73])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Mar 2022 06:12:42 -0700
...
Date: Tue, 15 Mar 2022 15:11:53 +0200
Message-Id: <20220315131157.3972238-2-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 1/5] drm/i915/gsc: add gsc as a mei
 auxiliary device

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E7085BCD42
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Sep 2022 15:30:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B3EA10E65B;
...
Subject: [Intel-gfx] [PATCH 4/6] drm/gma500: remove unused declarations in
 psb_intel_drv.h

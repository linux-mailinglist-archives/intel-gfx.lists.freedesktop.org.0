...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BC2E732C2C
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 11:40:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BB0FD10E592;
	Fri, 16 Jun 2023 09:40:39 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v13 22/22] docs: vfio: Add vfio device cdev
 description

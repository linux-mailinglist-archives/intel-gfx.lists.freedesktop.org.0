...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DE37751D6F
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jul 2023 11:39:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BAF0A10E669;
	Thu, 13 Jul 2023 09:39:26 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0C72C10E008
 for <intel-gfx@lists.freedesktop.org>; Thu, 13 Jul 2023 09:39:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689241165; x=1720777165;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=xqJYu+3hMtirOCUBicjqcdVfUYq35g8VoqxRPQ+REdQ=;
 b=QCexiMqRvVibNztHQkF7h4D32fBSWDOZzNx7GLOBATEHwnnFWEmIsYXl
 56aZC4W4J5OhnG+qSa4gio7Y1EHJ0gRcJAE2siEe2XH9grIGCrFpFvbtb
 80ldm3cqqxkHU5DUlIOaYdf3mPnI5gSsUWknNGQKe9D9a9hwOE7JsAoee
 sY8y5VLf2LKLOYKlr46KMZcFzPuc98V8qwrM1PRGRYAtgu4NM7d9y+Q0Y
 BMHNQwpxY5Z7gs9sVr9fOzMPJf7/21bCUFK98knB38Jw/i79SgB3OQT/V
 zdRL4PNkLpEnJj9VibJ6HwizytTCZpcnW4N3FmrWdAKpUWEEg9z3gbFxy A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10769"; a="364007376"
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; d="scan'208";a="364007376"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jul 2023 02:39:23 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10769"; a="787396741"
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; d="scan'208";a="787396741"
Received: from atadj-mobl1.amr.corp.intel.com (HELO localhost) ([10.252.50.30])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Jul 2023 02:39:21 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>, "Bhadane, Dnyaneshwar"
 <dnyaneshwar.bhadane@intel.com>, "intel-gfx@lists.freedesktop.org"
 <intel-gfx@lists.freedesktop.org>, "Ursulin, Tvrtko"
 <tvrtko.ursulin@intel.com>
In-Reply-To: <de17473e-09fa-9346-daf4-96bf12fa580c@linux.intel.com>
...
Date: Thu, 13 Jul 2023 12:39:19 +0300
Message-ID: <871qhcgng8.fsf@intel.com>
MIME-Version: 1.0

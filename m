...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 70A3620409B
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Jun 2020 21:39:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2B276E841;
	Mon, 22 Jun 2020 19:39:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2295E6E841
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Jun 2020 19:39:28 +0000 (UTC)
IronPort-SDR: c0eDw6poVzlvMBvTx8RgF5qNyXt80DqRBMkqYw26jTJRT7NQcgUnSy4hNLdSEo+SbdWbdAc/bM
 79hbL3OdjVJA==
X-IronPort-AV: E=McAfee;i="6000,8403,9660"; a="205349042"
X-IronPort-AV: E=Sophos;i="5.75,268,1589266800"; d="scan'208";a="205349042"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Jun 2020 12:39:27 -0700
IronPort-SDR: yNqJSytE4wS1orcOKAlVAjBQeB/ESNCOAIalo0GYUYdB2kRYxHuU8qNS9JOrlPsQSeiQ/c1CbS
 SAByoK1bKgOA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,268,1589266800"; d="scan'208";a="281743271"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga007.jf.intel.com with SMTP; 22 Jun 2020 12:39:24 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Mon, 22 Jun 2020 22:39:23 +0300
Date: Mon, 22 Jun 2020 22:39:23 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Shankar, Uma" <uma.shankar@intel.com>
Message-ID: <20200622193923.GT6112@intel.com>
...
In-Reply-To: <E7C9878FBA1C6D42A1CA3F62AEB6945F8256D2D4@BGSMSX104.gar.corp.intel.com>
...
> > > > > > > > > > +	struct intel_lspcon *lspcon =3D enc_to_intel_lspcon(e=
ncoder);
...
> > What I meant is that if we continue to use the existing values and bitm=
ask, we
> > can have lspcon infoframes_enabled return the appropriate type of infof=
rame
> > which is active (as you suggested) and later with intel_dump_pipe_confi=
g when it
...
> > > >
> > > > Will fix this accordingly and send the next version. Hope this is o=
k.
> > > >
> > > > > > > Sure,  will fix this and resend the next version.
> > > > > > >
> > > > > > > > >
> > > > > > > > > Also my question "how do we turn off infoframes once enab=
led?"
> > > > > > > > > from
> > > > > > > > > https://patchwork.freedesktop.org/patch/351719/?series=3D=
729
> > > > > > > > > 28
> > > > > > > > > &rev
> > > > > > > > > =3D1
...
> > > > >
> > > > > With your fix, we won't be enabling or setting the infoframe on D=
VI sinks.
...
> Oh ok, but it seems we don't have an option to disable them on LSPCON. Th=
ey have not

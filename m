...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DFE1620F7D
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Nov 2022 12:50:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67FFC10E3F6;
	Tue,  8 Nov 2022 11:50:05 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD6C510E3F2;
 Tue,  8 Nov 2022 11:49:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667908199; x=1699444199;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=YS/mRtP5aLvFchvtJFvwqr1Xl7NNE0/aLIEBX/nAsNg=;
 b=daOffxMrhPwSsCD3D0qMpKxBguRFtGj5T4azxI/8kaG6/I64WLBbPWkQ
 YJel21fxUHoGqoDsddPIjWCVBhxhznYXhzIQs2Pfpqdao23ebtB+30A3A
 2HqlN+7UXnFVA1Zq9pPWIcj0WphI57oov7xvAzZENhlureXPcso3LGKOF
 NilqwoFCHhvTBJkw/Oy18S57VZ1COAtsMjD4kpR+nZXCkP/luFGE4KFzF
 ZWsNkCNLCUmmXW7Ium55t3TqlFI0KZNtGSoruuTfl81nHzxGwiEarIJCX
 gY3ccF/A0KppPcwD6MIICrZaWoLc6bO6R6pBY5zlmhLTKsRhDeDrXXCP9 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="311829539"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="311829539"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Nov 2022 03:49:59 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="705268771"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="705268771"
Received: from shylandx-mobl2.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.213.210.50])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Nov 2022 03:49:57 -0800
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Tue,  8 Nov 2022 11:49:49 +0000
Message-Id: <20221108114950.2017869-1-tvrtko.ursulin@linux.intel.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH] drm/i915: Partial abandonment of legacy DRM
 logging macros

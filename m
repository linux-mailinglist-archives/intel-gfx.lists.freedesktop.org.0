...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 36FCD131B10
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Jan 2020 23:07:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 01B576E56D;
	Mon,  6 Jan 2020 22:07:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 50E116E563
 for <intel-gfx@lists.freedesktop.org>; Mon,  6 Jan 2020 22:07:44 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19789546-1500050 
 for multiple; Mon, 06 Jan 2020 22:07:16 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  6 Jan 2020 22:07:15 +0000
Message-Id: <20200106220715.2708760-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/gt: Allow temporary suspension of
 inflight requests
...
index e6086a4e93a5..ccfa50d7aa15 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -2357,6 +2357,75 @@ static void __execlists_submission_tasklet(struct intel_engine_cs *const engine)
 	}
 }
...
@@ -2468,6 +2537,29 @@ static void submit_queue(struct intel_engine_cs *engine,
...
@@ -2476,13 +2568,18 @@ static void execlists_submit_request(struct i915_request *request)

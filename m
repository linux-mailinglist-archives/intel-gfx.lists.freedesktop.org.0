...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E60157B9FE
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 17:34:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 930958F2AD;
...
Subject: [Intel-gfx] [PATCH v4 16/41] dyndbg: add drm.debug style bitmap
 support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A12B2607264
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Oct 2022 10:34:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0B0C10E51C;
	Fri, 21 Oct 2022 08:34:27 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4] overflow: Introduce overflows_type() and
 castable_to_type()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2344F3C9509
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jul 2021 02:21:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76FA66E519;
...
Subject: [Intel-gfx] [PATCH 13/13] vfio: Remove struct vfio_device_ops
 open/release

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 50D326FCC17
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 18:59:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE78510E3B7;
	Tue,  9 May 2023 16:58:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 830E810E3A7;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=mr2zgJPAWLABoixHX714ZHegjsvW5+MGEI8I04l+SGVH6h8mWL47wQwF
 TBus50c37dfwD1e3dADVlAClkj+lSOkz0cTXIuYSxTF+sZNM1fV2+0vGJ
 omKuduH1jmvre+FEtI6UkPv9CmZrl+N4VdIY/vR+oZ7CbBMzQSV5ldXah
 1W0KiHSim74gECNuVfqv1DutHJCvAzzanbEUzf9BzaK8m4GQBGDQjqDmQ
 wbHhitO/hYp39XrO0qPhvEzLhHlh5UMA/aIUQytLysRIoG2zck/euILbZ
 mHZkfC8JisYY/si1xWRfh0HonOvfCMy+GJRtfwWx0rWykq0P1n1bYEz+b w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="350021122"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="350021122"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:58:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10705"; a="649408817"
X-IronPort-AV: E=Sophos;i="5.99,262,1677571200"; d="scan'208";a="649408817"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 May 2023 09:58:47 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Tue,  9 May 2023 09:59:42 -0700
Message-Id: <20230509165942.2155-5-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230509165942.2155-1-fei.yang@intel.com>
References: <20230509165942.2155-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v7 4/4] drm/i915: Allow user to set cache at BO
 creation

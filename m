...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B522D1BD7D5
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 11:03:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D981F6EDCC;
	Wed, 29 Apr 2020 09:03:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B63146ED21
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 09:02:51 +0000 (UTC)
IronPort-SDR: rl1N9shvcFYlM8Cw2IP9yFS2w0iMn44tSfjMT7SPnyybVJZocoMu5iQlcHK86a4xDZde+BjCvM
 W53uN+UKz0bQ==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Apr 2020 02:02:51 -0700
IronPort-SDR: S0mUTihc2aZKcOwVaCObseISoAchm6UNm3ZS/b/75Kw5ELPuCJAVGkPgJjqH5jGI96i7OSv+T3
 6Bk0UfgeqV2w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,331,1583222400"; d="scan'208";a="246784855"
Received: from unknown (HELO delly.ger.corp.intel.com) ([10.252.38.205])
 by orsmga007.jf.intel.com with ESMTP; 29 Apr 2020 02:02:49 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 12:02:41 +0300
Message-Id: <20200429090242.978170-4-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 3/4] drm/i915/perf: prepare driver to receive

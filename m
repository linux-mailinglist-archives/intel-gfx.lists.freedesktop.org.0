...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A1BA41F3E1
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Oct 2021 19:53:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F6696EE8E;
...
Subject: [Intel-gfx] [PATCH v3 08/10] vfio/ccw: Remove private->mdev

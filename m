...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF5E265D02B
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Jan 2023 11:05:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C637B10E530;
	Wed,  4 Jan 2023 10:05:49 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v7 00/22] drm/edid: info & modes parsing and
 drm_edid refactors

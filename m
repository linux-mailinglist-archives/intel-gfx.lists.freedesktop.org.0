...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 00C7E5B0F84
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 23:52:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 573B310E8DA;
	Wed,  7 Sep 2022 21:52:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EFC3210E8DB
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Sep 2022 21:52:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1662587522; x=1694123522;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Tg2jWZylF/rYrsbIYbAet+v5CssMWEJf3/t00bXShb0=;
 b=GK+7fYFCWJchvm6IaNFC5waikn9d5qd+fEf3dQ4RJ7jZ8Tk7ARY3t5dc
 /ARvpvWfqEFdFYSgS/rMdfHuek7yH9GPhR8/G/KCceM9lkGpRENlEx7fh
 ahrT1Hjm1UyIcYNpAfEUKr+Ti7sO3PWok+c9Hy5n9xRvuWcxH7C9FKyhs
 ct8lWqVgQ9xdch8v/ayiEch3vt43zyPt+S8TLzeD7bk2hI9S2XdEtOrGn
 VlSlboapzK/sjOzE/u4fzmUBath6tM/OPMeRSywkd59wAnpJ7xosB6NOu
 lS6wK2pF2jtv50p9DnA3PE0rKrSeF59hP6Dx298oSgbNYPzZdI5IIGjcS A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10463"; a="323193669"
X-IronPort-AV: E=Sophos;i="5.93,298,1654585200"; d="scan'208";a="323193669"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2022 14:52:01 -0700
X-IronPort-AV: E=Sophos;i="5.93,298,1654585200"; d="scan'208";a="790207947"
...
Date: Thu,  8 Sep 2022 00:51:05 +0300
Message-Id: <20220907215113.1596567-9-tomas.winkler@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 08/16] mei: extend timeouts on slow devices

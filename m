...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 01E3C6AE12F
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Mar 2023 14:49:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCD4510E4B3;
	Tue,  7 Mar 2023 13:49:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-lj1-x235.google.com (mail-lj1-x235.google.com
 [IPv6:2a00:1450:4864:20::235])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2116110E4A6
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Mar 2023 13:49:07 +0000 (UTC)
Received: by mail-lj1-x235.google.com with SMTP id z5so13208829ljc.8
 for <intel-gfx@lists.freedesktop.org>; Tue, 07 Mar 2023 05:49:06 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1678196946;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=BmEGwl1dtwXNhBVAE3u5X5GcBU4ls7eYTmNONq4yQ1A=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1678196946;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=BmEGwl1dtwXNhBVAE3u5X5GcBU4ls7eYTmNONq4yQ1A=;
 b=
X-Gm-Message-State: AO0yUKUR8VO2pq/LWEJLn0zrNQcLm++lXQPBwhwVPFVWYa6V29RjHHDQ
 kgd82dQECut0H7ehOhxDdtUZ8A==
X-Google-Smtp-Source: AK7set/ZN+8+LHE07Wpe9TNi2U54z+JqVgQWeyO8QCbinRfGZTtVbrpFVIn6mZhgCjntQSrhUcTnLg==
X-Received: by 2002:a2e:95c6:0:b0:295:ac00:2f2d with SMTP id
 y6-20020a2e95c6000000b00295ac002f2dmr4431255ljh.10.1678196946562; 
 Tue, 07 Mar 2023 05:49:06 -0800 (PST)
...
Date: Tue,  7 Mar 2023 15:48:56 +0200
Message-Id: <20230307134901.322560-6-dmitry.baryshkov@linaro.org>
...
Subject: [Intel-gfx] [PATCH v2 05/10] drm/display/dsc: use flat array for

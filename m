...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5828D6D4E81
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Apr 2023 18:57:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 62FA410E54F;
	Mon,  3 Apr 2023 16:57:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AC76510E519;
 Mon,  3 Apr 2023 16:57:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680541057; x=1712077057;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=H6RRhmByNKU7AWup8i5URobIzwVWiaqUVTuYC4lDVU4=;
 b=gvYh8eQEhQmoRyh0q/N3vVJbLESowbtn1N8S8v37HD1keZ7Tz3Rtgks9
 EUBarg65pujSUwIMmcoHV7k9jTJ4di70TWSslFkMJ5G9vZ24EGiGJRhAl
 Oqtom3iEjTpNqGDFaThaBkykcsiUDzevm9k0sLxf7wx8BCFXoRiN+udLu
 AcrUYbwLDMVCF3SuIGfV5rB/m+ocVVU4hY1LD7zlomasnmBNfNb8Nh3Cn
 9z7JZ/I9FqICqxU/a9/0tjQtnGUF2REpKT/I15kTyLtyCTRV73/yhRVNz
 4NYdCBxsJUieVV8WjVbgnR7RdATFxPBZNeOZ3DcnNbH8hUSOhPePm047x A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10669"; a="330527635"
X-IronPort-AV: E=Sophos;i="5.98,315,1673942400"; d="scan'208";a="330527635"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2023 09:57:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10669"; a="797135361"
X-IronPort-AV: E=Sophos;i="5.98,315,1673942400"; d="scan'208";a="797135361"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
 by fmsmga002.fm.intel.com with ESMTP; 03 Apr 2023 09:57:27 -0700
Received: from orsmsx610.amr.corp.intel.com (10.22.229.23) by
 ORSMSX602.amr.corp.intel.com (10.22.229.15) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.21; Mon, 3 Apr 2023 09:57:27 -0700
Received: from orsmsx610.amr.corp.intel.com (10.22.229.23) by
 ORSMSX610.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.21; Mon, 3 Apr 2023 09:57:26 -0700
Received: from orsedg603.ED.cps.intel.com (10.7.248.4) by
 orsmsx610.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.21 via Frontend Transport; Mon, 3 Apr 2023 09:57:26 -0700
Received: from NAM11-DM6-obe.outbound.protection.outlook.com (104.47.57.169)
 by edgegateway.intel.com (134.134.137.100) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.21; Mon, 3 Apr 2023 09:57:26 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=gIQv4iRh6nmtWUgbKeMzMNTzF/Ar+sG6cKQf/1JEwc8=;
 b=
...
Thread-Index: AQHZZGRhzCzjM8mcJUyzrl8CnRb2/a8ZrnkAgAAix+A=
Date: Mon, 3 Apr 2023 16:57:21 +0000
Message-ID: <BYAPR11MB25675C7C3491973BB79379E29A929@BYAPR11MB2567.namprd11.prod.outlook.com>
...
In-Reply-To: <ZCrntC9f1E0MZlXa@intel.com>
...
x-ms-traffictypediagnostic: BYAPR11MB2567:EE_|CY5PR11MB6186:EE_
x-ms-office365-filtering-correlation-id: 2e3e7d44-48c6-4bcf-f3f6-08db34647e21
x-ms-exchange-senderadcheck: 1
x-ms-exchange-antispam-relay: 0
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:BYAPR11MB2567.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230028)(39860400002)(396003)(366004)(346002)(136003)(376002)(451199021)(9686003)(186003)(26005)(6506007)(66574015)(83380400001)(55016003)(33656002)(38100700002)(38070700005)(86362001)(122000001)(82960400001)(478600001)(2906002)(5660300002)(52536014)(41300700001)(8936002)(54906003)(30864003)(316002)(71200400001)(6916009)(8676002)(66556008)(66946007)(66476007)(76116006)(64756008)(66899021)(66446008)(7696005)(4326008)(559001)(579004);
 DIR:OUT; SFP:1102; 
x-ms-exchange-antispam-messagedata-chunkcount: 1
x-ms-exchange-antispam-messagedata-0: =?iso-8859-1?Q?0/V/9pjSCyIzj3sSC7V4xb668FGoX+J/eDJ3AGE3rjtQ92s5Gy+sGTX+J5?=
 =?iso-8859-1?Q?JBPwM84pJ2pJvneejPokTu8Yl8u+UzAOaL067t0hIu6+vmWVIkenXLN4nX?=
 =?iso-8859-1?Q?FaCSzXSv3LwFJT904enFeJ7PFY3BLoBoUdNwpdwR7d2tqqfUX2pfMGeQga?=
 =?iso-8859-1?Q?RNatyVi6STBkdFmFivuhhvmsN+q4MBi5iz/6ztCTPW44/lTA31Axb8rDv3?=
 =?iso-8859-1?Q?qJ0ABifqakxqZZW7R2a57lJgrgFcZbOngEPlY2MT9I654VK9Hdgqj5Ysfj?=
 =?iso-8859-1?Q?ZHUDNnf9Uee3EcN2O3Lc1pOQvADZ9iqWoTy+2AsPO0Dkv1LL1tHpzT9MGf?=
 =?iso-8859-1?Q?TzlvE3EI6wo47AHuFEtVNI+RtvDuSV7Hpr4qQiRa43vZzcIqCUarS659Gw?=
 =?iso-8859-1?Q?A5hOHbtKH8w+61o9kSpeHs56BILaNouHmRKsOwSwhjl4Uk6hfxTVSlGfi1?=
 =?iso-8859-1?Q?Vjs93eWJlecftjgGjLYCDZLL4CLPmm3zrSSLr4dfIqnQuY9jOd+cvqspIb?=
 =?iso-8859-1?Q?sCRss4VUGy8rVq3vF2I8VwvEDu9T6VktRmAv2/xd/2r+i2wAcLtByczrzz?=
 =?iso-8859-1?Q?mtlaB5tOHd36+szCYqw6c+3OL6BD47+0Eg5sXhaIwJUByFXhOxhrzLX817?=
 =?iso-8859-1?Q?crERWYxb7u/NvzTVpS07DjSnu5QrkzSTDkoWSpzZ1Uhzksr8m9RGNdyox3?=
 =?iso-8859-1?Q?l5nPbDT0h13sqnNY45aLRKij1cs6TR8FCYVftbMTtWi4Q/pg8fNWgOaHFR?=
 =?iso-8859-1?Q?sptHFlXOMTEjNk+6UUjo5uQmidT3Am/366ORF9zExWN0fB5sPpkt9lUxcJ?=
 =?iso-8859-1?Q?BE2LL/tBjOSEse6FshAXUIVivLUEp2EXCHw5EWdR3USKv6W8UAwQpE6qNo?=
 =?iso-8859-1?Q?QhMJWn7b3XpgVuTFTmI4gNVd5bnBb6gb2ajHTksZk/Tnv+un8KN2IaJ4rs?=
 =?iso-8859-1?Q?fg9pJ16QzKii0eHqTGV0O+RGIQgn36o/5JwS8TOrNwjUKLpJA2ePW2hNaN?=
 =?iso-8859-1?Q?aX7aosoN7PGcDoAlIQWezzxdu+HXbHhML6lHeDR4Wlc5q0p6zJFSuyRQRc?=
 =?iso-8859-1?Q?C11JNuTgF/YQsXHrcFKLNGleTnd/nCDmXY3AMzMYMDu7adef5hraF8s4QV?=
 =?iso-8859-1?Q?Je3E3F7FPgffnOnrxrJ3AVcp7rnULeklJNnE0FBLLiGSgUj/Iq4kDng2bO?=
 =?iso-8859-1?Q?Tir2MYC5UUORzxFnkzECqnbCBl2+QPB9i1GtgbM434mH0LJOYpEwGYgjRd?=
 =?iso-8859-1?Q?SegKvzoTcpOj6utpHbTNb8sCCiFy+ziIYvpaCzGpp7yO5FHyrdihTX3kmR?=
 =?iso-8859-1?Q?An6ggdJqAxK7JQA+RcjOUUG7VIt8FINdXsoUfcY8TeBqiK6ghJ3lSCvZR/?=
 =?iso-8859-1?Q?AEemFAgUaPbNnLmWI8ch6uEmrRD07xOtaN6qBa6Hu99Esw8vDoT4RJiLDx?=
 =?iso-8859-1?Q?X6ZYk+8tWYzAAeoikAeuA4zbarXD31B/94E4x2FCV9e3ZCkiut63FhuYkw?=
 =?iso-8859-1?Q?V2c/hZImF1FBhepR/x4eeVT11kDE0KPs+wW56xzZ6AO3NAwPjnhGK9G8tF?=
 =?iso-8859-1?Q?kddjXvRtsJW/+aYKrZ9mEFcs5s64UAKawaZtiCwZ11Qd/VEBA/Xtb0ZxH7?=
 =?iso-8859-1?Q?ukK0wlhvMSr3Q=3D?=
Content-Type: text/plain; charset="iso-8859-1"
Content-Transfer-Encoding: quoted-printable
MIME-Version: 1.0
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-AuthSource: BYAPR11MB2567.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 2e3e7d44-48c6-4bcf-f3f6-08db34647e21
X-MS-Exchange-CrossTenant-originalarrivaltime: 03 Apr 2023 16:57:22.0225 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: qvC+JPU1l3z0jHVpS5/DW2w1MPSXG1omCrLfkP9CAlwmIkgYkWxUoY/1/aWjcA7Wl2aO7lvmNWL695w8MNtmqA==
...
That would be really messy because PAT index is platform dependent, you wou=
ld
...
.
>> Haivng the abstracted i915_cache_level sitting in between would only cau=
se
>> more ambiguity.
>>=20
...
as
>> cached, uncached, or writethrough. For these simple cases, using cache_l=
evel
...
>> @@ -27,8 +27,8 @@ static bool gpu_write_needs_clflush(struct drm_i915_ge=
m_object *obj)
>>  	if (IS_DGFX(i915))
>>  		return false;
>> =20
...
>> @@ -265,7 +265,7 @@ int i915_gem_object_set_cache_level(struct drm_i915_=
gem_object *obj,
>>  {
>>  	int ret;
>> =20
...
>> @@ -276,10 +276,8 @@ int i915_gem_object_set_cache_level(struct drm_i915=
_gem_object *obj,
>>  		return ret;
>> =20
...
>> @@ -304,20 +302,13 @@ int i915_gem_get_caching_ioctl(struct drm_device *=
dev, void *data,
>>  		goto out;
>>  	}
>> =20
...
>> @@ -642,7 +642,7 @@ static inline int use_cpu_reloc(const struct reloc_c=
ache *cache,
>> =20
...
>> @@ -54,6 +54,12 @@ unsigned int i915_gem_get_pat_index(struct drm_i915_p=
rivate *i915,
...
>> +{
>> +	return obj->pat_index =3D=3D i915_gem_get_pat_index(obj_to_i915(obj), =
lvl);
>> +}
>> +
...
>> @@ -133,7 +139,7 @@ void i915_gem_object_set_cache_coherency(struct drm_=
i915_gem_object *obj,
>>  {
...
>> @@ -148,6 +154,37 @@ void i915_gem_object_set_cache_coherency(struct drm=
...
15_gem_object *obj);
>> =20
>>  void i915_gem_object_set_cache_coherency(struct drm_i915_gem_object *ob=
j,
...
>>  void i915_gem_object_flush_if_display_locked(struct drm_i915_gem_object=
 *obj);
...
>>  #define I915_BO_FLAG_STRUCT_PAGE BIT(0) /* Object backed by struct page=
s */
...
>>  		ret =3D intel_context_migrate_clear(to_gt(i915)->migrate.context, dep=
s,
...
>>  						  0, &rq);
>>  	} else {
>> @@ -227,12 +228,13 @@ static struct dma_fence *i915_ttm_accel_move(struc=
t ttm_buffer_object *bo,
>>  		src_level =3D i915_ttm_cache_level(i915, bo->resource, src_ttm);
>>  		intel_engine_pm_get(to_gt(i915)->migrate.context->engine);
>>  		ret =3D intel_context_migrate_copy(to_gt(i915)->migrate.context,
...
>>  	}
>> =20
>>  	err =3D intel_context_migrate_clear(to_gt(i915)->migrate.context, NULL=
,
>> -					  obj->mm.pages->sgl, obj->cache_level,
>> +					  obj->mm.pages->sgl, obj->pat_index,
>>  					  i915_gem_object_is_lmem(obj),
...
>> =20
>> +/**
>> + * For pre-gen12 platforms pat_index is the same as enum i915_cache_lev=
el,
...
>> -	const gen8_pte_t pte_encode =3D ppgtt->vm.pte_encode(0, cache_level, f=
lags);
>> +	const gen8_pte_t pte_encode =3D ppgtt->vm.pte_encode(0, pat_index, fla=
gs);
>>  	gen8_pte_t *vaddr;
>> =20
...
>>  			  u32 flags)
>>  {
>> -	const gen8_pte_t pte_encode =3D vm->pte_encode(0, cache_level, flags);
>> +	const gen8_pte_t pte_encode =3D vm->pte_encode(0, pat_index, flags);
>>  	unsigned int rem =3D sg_dma_len(iter->sg);
>>  	u64 start =3D vma_res->start;
>>  	u64 end =3D start + vma_res->vma_size;
>> @@ -611,10 +609,10 @@ xehpsdv_ppgtt_insert_huge(struct i915_address_spac=
e *vm,
...
>>  	u64 start =3D vma_res->start;
>> =20
>> @@ -734,7 +732,7 @@ static void gen8_ppgtt_insert_huge(struct i915_addre=
ss_space *vm,
>> =20
...
>> @@ -742,9 +740,9 @@ static void gen8_ppgtt_insert(struct i915_address_sp=
ace *vm,
>> =20
...
>> =20
>> @@ -753,7 +751,7 @@ static void gen8_ppgtt_insert(struct i915_address_sp=
ace *vm,
>>  				gen8_pdp_for_page_index(vm, idx);
>> =20
>>  			idx =3D gen8_ppgtt_insert_pte(ppgtt, pdp, &iter, idx,
>> -						    cache_level, flags);
>> +						    pat_index, flags);
>>  		} while (idx);
>> =20
>>  		vma_res->page_sizes_gtt =3D I915_GTT_PAGE_SIZE;
>> @@ -763,7 +761,7 @@ static void gen8_ppgtt_insert(struct i915_address_sp=
ace *vm,
...
>> @@ -777,14 +775,14 @@ static void gen8_ppgtt_insert_entry(struct i915_ad=
dress_space *vm,
>>  	GEM_BUG_ON(pt->is_compact);
>> =20
>>  	vaddr =3D px_vaddr(pt);
>> -	vaddr[gen8_pd_index(idx, 0)] =3D vm->pte_encode(addr, level, flags);
>> +	vaddr[gen8_pd_index(idx, 0)] =3D vm->pte_encode(addr, pat_index, flags=
);
...
>>  {
>>  	u64 idx =3D offset >> GEN8_PTE_SHIFT;
>> @@ -807,20 +805,20 @@ static void __xehpsdv_ppgtt_insert_entry_lm(struct=
 i915_address_space *vm,
>>  	}
>> =20
>>  	vaddr =3D px_vaddr(pt);
>> -	vaddr[gen8_pd_index(idx, 0) / 16] =3D vm->pte_encode(addr, level, flag=
s);
>> +	vaddr[gen8_pd_index(idx, 0) / 16] =3D vm->pte_encode(addr, pat_index, =
flags);
>>  }
>> =20
...
>> @@ -855,7 +853,9 @@ static int gen8_init_scratch(struct i915_address_spa=
ce *vm)
>> =20
>>  	vm->scratch[0]->encode =3D
>>  		vm->pte_encode(px_dma(vm->scratch[0]),
...
>>  		struct drm_i915_gem_object *obj;
>> @@ -873,7 +873,9 @@ static int gen8_init_scratch(struct i915_address_spa=
ce *vm)
>>  		}
>> =20
>>  		fill_px(obj, vm->scratch[i - 1]->encode);
>> -		obj->encode =3D gen8_pde_encode(px_dma(obj), I915_CACHE_NONE);
>> +		obj->encode =3D gen8_pde_encode(px_dma(obj),
>> +					      i915_gem_get_pat_index(vm->i915,
>> +							I915_CACHE_NONE));
>> =20
>>  		vm->scratch[i] =3D obj;
...
>> +	const gen8_pte_t pte_encode =3D ggtt->vm.pte_encode(0, pat_index, flag=
s);
...
>> =20
>> @@ -581,7 +579,7 @@ void ppgtt_init(struct i915_ppgtt *ppgtt, struct int=
el_gt *gt,
>>  void intel_ggtt_bind_vma(struct i915_address_space *vm,
>>  			 struct i915_vm_pt_stash *stash,
>>  			 struct i915_vma_resource *vma_res,
...
>>  {
>>  	struct sgt_dma it_src =3D sg_sgt(src), it_dst =3D sg_sgt(dst), it_ccs;
...
>> -			err =3D emit_pte(rq, &it_ccs, ccs_cache_level, false,
...
>>  			goto out_rq;
>> =20
>> -		len =3D emit_pte(rq, &it, cache_level, is_lmem, offset, CHUNK_SZ);
...
>>  		t0 =3D ktime_get();
>> =20
>> -		err =3D intel_context_migrate_clear(ce, NULL, sg, cache_level,
>> +		err =3D intel_context_migrate_clear(ce, NULL, sg, pat_index,
>>  						  is_lmem, 0, &rq);
>>  		if (rq) {
...
>> -	i915_gem_object_set_cache_coherency(obj, tl->hwsp_ggtt->obj->cache_lev=
el);
...
>> @@ -876,9 +876,15 @@ static void uc_fw_bind_ggtt(struct intel_uc_fw *uc_=
fw)
>>  		pte_flags |=3D PTE_LM;
>> =20
>>  	if (ggtt->vm.raw_insert_entries)
>> -		ggtt->vm.raw_insert_entries(&ggtt->vm, dummy, I915_CACHE_NONE, pte_fl=
ags);
...
>> @@ -138,21 +138,56 @@ static const char *stringify_vma_type(const struct=
 i915_vma *vma)
>>  	return "ppgtt";
>>  }
>> =20
...
>> =20
>>  void
>>  i915_debugfs_describe_obj(struct seq_file *m, struct drm_i915_gem_objec=
t *obj)
>>  {
...
>>  	int pin_count =3D 0;
>> =20
>> @@ -164,7 +199,7 @@ i915_debugfs_describe_obj(struct seq_file *m, struct=
...
>>  		page_length =3D remain < page_length ? remain : page_length;
...
>>  		}
>> @@ -598,8 +602,12 @@ i915_gem_gtt_pwrite_fast(struct drm_i915_gem_object=
 *obj,
...
>>  			mb();
>> =20
>>  			s =3D io_mapping_map_wc(&ggtt->iomap, slot, PAGE_SIZE);
...
urce *vma_res,
>>  /**
>>   * i915_vma_bind - Sets up PTEs for an VMA in it's corresponding addres=
s space.
>>   * @vma: VMA to map
...
>>   * @vma_res: pointer to a preallocated vma resource. The resource is ei=
ther
>> @@ -437,7 +437,7 @@ i915_vma_resource_init_from_vma(struct i915_vma_reso=
urce *vma_res,
>>   * Note that DMA addresses are also the only part of the SG table we ca=
re about.
>>   */
...
>>  	}
>> =20
>> @@ -813,7 +813,7 @@ i915_vma_insert(struct i915_vma *vma, struct i915_ge=
m_ww_ctx *ww,
>>  	color =3D 0;
>> =20
...
>> @@ -1517,7 +1517,7 @@ int i915_vma_pin_ww(struct i915_vma *vma, struct i=
915_gem_ww_ctx *ww,
>> =20
...
>> +	target.color =3D i915_gem_get_pat_index(gt->i915, I915_CACHE_L3_LLC);
>> =20
...
>> @@ -133,7 +133,7 @@ fake_dma_object(struct drm_i915_private *i915, u64 s=
ize)
>> =20
>>  	obj->write_domain =3D I915_GEM_DOMAIN_CPU;
>>  	obj->read_domains =3D I915_GEM_DOMAIN_CPU;
...
>> @@ -357,7 +357,9 @@ static int lowlevel_hole(struct i915_address_space *=
vm,
>> =20
...
>> @@ -1508,7 +1513,7 @@ static int reserve_gtt_with_resource(struct i915_v=
ma *vma, u64 offset)
>>  	mutex_lock(&vm->mutex);
...
>> @@ -1688,7 +1693,7 @@ static int insert_gtt_with_resource(struct i915_vm=
a *vma)
>> =20
>>  	mutex_lock(&vm->mutex);
>>  	err =3D i915_gem_gtt_insert(vm, NULL, &vma->node, obj->base.size, 0,

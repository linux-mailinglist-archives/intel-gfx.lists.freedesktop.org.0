...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CD113395A60
	for <lists+intel-gfx@lfdr.de>; Mon, 31 May 2021 14:20:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6A516E907;
	Mon, 31 May 2021 12:20:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2F5AD6E8FD;
 Mon, 31 May 2021 12:20:15 +0000 (UTC)
IronPort-SDR: xEdy3U42quTHO0OUOdCViPRhN5zy3VkIKfkYRYMSq/f1x/zhIlJzqXtMWsPDWqjZpHTyPKa9nf
 gOYhTePaPkWg==
X-IronPort-AV: E=McAfee;i="6200,9189,10000"; a="183027511"
X-IronPort-AV: E=Sophos;i="5.83,237,1616482800"; d="scan'208";a="183027511"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2021 05:20:15 -0700
IronPort-SDR: 38KxX0xjwk4kEDEb0rRcQaODpxQNm9cZOpmEOPffLwJzS9HvFFPiTHaPgGPpCNiZmHhlYBiBBN
 mVpd6XzpMLTA==
X-IronPort-AV: E=Sophos;i="5.83,237,1616482800"; d="scan'208";a="473903982"
...
Message-Id: <20210531121940.267032-10-thomas.hellstrom@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 09/15] drm/ttm: Document and optimize

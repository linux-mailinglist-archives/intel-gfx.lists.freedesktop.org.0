...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 37A7A4DD4CB
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Mar 2022 07:41:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2B8710E971;
...
Subject: [Intel-gfx] [PATCH v12 09/13] drm/i915/guc: Check sizing of
 guc_capture output

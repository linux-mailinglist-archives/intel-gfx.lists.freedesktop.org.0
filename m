...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DD5C4718F3C
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 01:54:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90F0710E1F1;
	Wed, 31 May 2023 23:54:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 27FE410E1EB;
 Wed, 31 May 2023 23:54:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685577269; x=1717113269;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=g9/89UgIYcJuIjpPM9mDVG6lMLNhDfkz3B33RgQ/+VQ=;
 b=kNtcSSmFbg3tCGvpgvuMx0enzDcDn++4Mu2TcRG5RtZbV4fs/kBrYeC4
 h0tVdG7HdOFPCI81tKsqUAT546/qcvMkH9am8cxYi29cuN//tEEA+5Jzg
 7RB5yE2Tu4tYoVcTpzLS2xCoqfArJOufR+Et18lvbqNNUczU8ERwHD/S6
 wturslQBshtJTQdnwtaKDgbGyd/uInpSMVPLic+95Y+Qr1gwsDJHunCW4
 BEEupMdlyFhRimzGIrLWVkn7E1BG6rHKdowBlezC3CxpfyDr4KYqhGkGV
 cCa/RKBE9yqp9YQj+TTZrR/TT647VQG5umbmwXtrHFphrbCmPudQY7rn5 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="335747054"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; d="scan'208";a="335747054"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2023 16:54:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="707109961"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; d="scan'208";a="707109961"
...
Message-Id: <20230531235415.1467475-6-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 5/7] drm/i915/mtl/huc: auth HuC via GSC

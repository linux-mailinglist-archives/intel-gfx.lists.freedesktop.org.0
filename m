...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26CE2605D9B
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Oct 2022 12:40:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 76CFB10EB59;
...
Subject: [Intel-gfx] [PATCH 15/21] drm/fb-helper: Disconnect damage worker
 from update logic

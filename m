...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 241FC4B1FE4
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Feb 2022 09:07:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 35B9210EA16;
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/dg2: Don't try to process TBT
 interrupts

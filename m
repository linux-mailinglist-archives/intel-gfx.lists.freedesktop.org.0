...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC84671FEF6
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Jun 2023 12:22:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 370A310E64E;
	Fri,  2 Jun 2023 10:22:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A1E0610E64E;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 Rdl92rvhUVTUfvwfMmA9Erv87/SALLoJvgExIZWunzMjEqfHP0AhhtXyw w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10728"; a="358267625"
X-IronPort-AV: E=Sophos;i="6.00,212,1681196400"; d="scan'208";a="358267625"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jun 2023 03:22:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10728"; a="707804972"
X-IronPort-AV: E=Sophos;i="6.00,212,1681196400"; d="scan'208";a="707804972"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jun 2023 03:21:59 -0700
...
X-Mailer: b4 0.12.2
Subject: [Intel-gfx] [PATCH v9 2/4] lib/ref_tracker: improve printing stats

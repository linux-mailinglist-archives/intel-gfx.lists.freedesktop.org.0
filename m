...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 36139D3A9E
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Oct 2019 10:17:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2072C6E405;
...
Subject: [Intel-gfx] [PATCH V3 0/7] mdev based hardware virtio offloading
 support

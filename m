...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 029582C8ECD
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Nov 2020 21:14:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A144B6E831;
	Mon, 30 Nov 2020 20:14:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9EDC06E82E
 for <intel-gfx@lists.freedesktop.org>; Mon, 30 Nov 2020 20:14:05 +0000 (UTC)
IronPort-SDR: NG3P2z1oWvIdeo53W7iTe1A64cguZY869g0P6tIJbHj4hbLa4eAB8v5VD2Syj2erWsG6jlXh2X
 PHdkf5EXxVNw==
X-IronPort-AV: E=McAfee;i="6000,8403,9821"; a="190892918"
X-IronPort-AV: E=Sophos;i="5.78,382,1599548400"; d="scan'208";a="190892918"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Nov 2020 12:14:05 -0800
IronPort-SDR: A85z0enY1bfkeFO0V+wHvI5fr7zNsreL5Veb/gKVqKXVn6OrhavAEKG/mSdCsVYrcKC5osTzvF
 bUIg/tfQKIfg==
X-IronPort-AV: E=Sophos;i="5.78,382,1599548400"; d="scan'208";a="372472302"
...
Message-Id: <20201130204738.2443-3-uma.shankar@intel.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20201130204738.2443-1-uma.shankar@intel.com>
References: <20201130204738.2443-1-uma.shankar@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [v14 02/15] drm/i915/display: Enable HDR on gen9

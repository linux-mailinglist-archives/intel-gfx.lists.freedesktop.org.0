...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AFBB64BC029
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Feb 2022 20:15:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4197C10E7D9;
...
Subject: Re: [Intel-gfx] [PATCH 01/15] drm/i915/dg2: Define GuC firmware
 version for DG2

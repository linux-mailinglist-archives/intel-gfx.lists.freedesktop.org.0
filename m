...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C81C813B513
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jan 2020 23:07:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D1AF9895A8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 0/2] Security mitigation for Intel Gen7 and
 Gen7.5

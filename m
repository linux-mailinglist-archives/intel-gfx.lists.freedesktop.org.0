...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A12164AE8B8
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Feb 2022 06:12:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4C2D10E2AA;
	Wed,  9 Feb 2022 05:12:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0BB4E10E1C7
 for <intel-gfx@lists.freedesktop.org>; Wed,  9 Feb 2022 05:12:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644383523; x=1675919523;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=g9cfBk4znRTpuqSSCGRyhnU7SRA1DNqICXqw3xvmhdo=;
 b=Iw+neHPuVedwPp6TfnAHagMcTLcudU0j2RYblpMy6+BRPUdYQOv29UZW
 g79MWJ3XtPssp0ZeX5YKBhfjO1vh8ORmFSl2X8S1nZ+Hllq4pdYTmWbue
 PF6S2ICT4IPNqvAw+j98366kaTxoUCwyViFheYmptZcEVfTEQDXXH5B9H
 08zDX1iqMKdMQK3P6W7/gvpKt3yjvmVH2WKk3fUs0DRQdSksIVDs76S3/
 bI2XGMIYnUqMXUbAan5PhB3o6Iz/Fzcn2NZDyaB9gReWwPvcffjwvcDzt
 yRHZCdnOMcQ7Stv/18eGuqdvms7/MixMo6qkNry8YHwO4mSs6qOYBKXx+ Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10252"; a="232686906"
X-IronPort-AV: E=Sophos;i="5.88,354,1635231600"; d="scan'208";a="232686906"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 21:11:47 -0800
X-IronPort-AV: E=Sophos;i="5.88,354,1635231600"; d="scan'208";a="482206710"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 21:11:46 -0800
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  8 Feb 2022 21:11:40 -0800
Message-Id: <20220209051140.1599643-7-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH 6/6] drm/i915/gt: Order GT registers by MMIO
 offset

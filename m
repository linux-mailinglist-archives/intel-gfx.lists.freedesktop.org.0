...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E6A2943E1C1
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Oct 2021 15:13:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 702456E937;
	Thu, 28 Oct 2021 13:13:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3A7636E090;
 Thu, 28 Oct 2021 13:13:50 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10150"; a="227852775"
X-IronPort-AV: E=Sophos;i="5.87,189,1631602800"; d="scan'208";a="227852775"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2021 06:01:13 -0700
X-IronPort-AV: E=Sophos;i="5.87,189,1631602800"; d="scan'208";a="665406504"
...
Date: Thu, 28 Oct 2021 13:58:48 +0100
Message-Id: <20211028125855.3281674-4-matthew.auld@intel.com>
...
Subject: [Intel-gfx] [PATCH 04/11] drm/i915: Create a dummy object for gen6
 ppgtt
...
index ae693bf88ef0..904c048953d6 100644
...
index 19e6700a4315..57f2f8da931e 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -1932,6 +1932,10 @@ int i915_gem_evict_vm(struct i915_address_space *vm);
 struct drm_i915_gem_object *

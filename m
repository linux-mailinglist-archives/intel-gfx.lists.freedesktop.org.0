...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BD093AFD43
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Jun 2021 08:49:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1554689C03;
	Tue, 22 Jun 2021 06:49:01 +0000 (UTC)
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v4 06/17] drm/uAPI: Add "active color
 format" drm property as feedback for userspace
...
Content-Type: multipart/mixed; boundary="===============0361015548=="

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DB871534C
	for <lists+intel-gfx@lfdr.de>; Mon,  6 May 2019 20:02:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1341F89B9E;
	Mon,  6 May 2019 18:02:16 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 04/11] drm/fb-helper: Remove
 drm_fb_helper_crtc->{x, y, desired_mode}

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E3709348281
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Mar 2021 21:05:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 264866EA81;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/4] drm/i915: Move Wa_16011163337 to

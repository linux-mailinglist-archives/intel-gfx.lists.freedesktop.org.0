...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C11667FAA5
	for <lists+intel-gfx@lfdr.de>; Sat, 28 Jan 2023 20:59:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8460810E23C;
...
Subject: [Intel-gfx] [PATCH v3 4/8] drm/i915/guc: Update GuC messages in
 intel_guc_ct.c

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E67AA2D023B
	for <lists+intel-gfx@lfdr.de>; Sun,  6 Dec 2020 10:22:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 297A36E06B;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [ANNOUNCE] upcoming mandated dim upgrade due to

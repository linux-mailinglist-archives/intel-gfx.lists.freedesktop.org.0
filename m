...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 713CA4889D6
	for <lists+intel-gfx@lfdr.de>; Sun,  9 Jan 2022 15:20:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2118310EED4;
...
Subject: [Intel-gfx] [PATCH v7 6/6] drm/amdgpu: add drm buddy support to
 amdgpu

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F29D7B3278
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Sep 2023 14:25:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 71AED10E702;
	Fri, 29 Sep 2023 12:25:33 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 971D810E6FD;
 Fri, 29 Sep 2023 12:25:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1695990329; x=1727526329;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=PRebmyDH50utciPFwqa7O3shuhf57IGoHhVfz8Wwcuw=;
 b=C873gftfc3LL5kYZ1BDzMQR859EnSKCFTUjrgQkBDMfwKbpSBZ2iKfk/
 CBU46tfukxIfmaIjn4CICFtij5TyvXeyONayUtOUuvzbgSfa4WOKd7XYE
 l4BfNb9oaIB0+zT25AToE1f9hhtGy1C04xiyZnS/95sHAmdU7/+WLxADS
 RHlu0/SGxFqXDcL9nrc/3cN4JKDunBaXTU5PvLtGBHZ79XtLL/yxH2MA+
 Xv+uxcONNjL5wup7JPXNZBXNt8Q4O2CcWDdsQwdCtEuwXfPSXpOcKXAdu
 fF14W4tUY4dBuMP+TvAxQhmj7ZrMJp6iYpuFgSQ7lKQfSk5CeC5GBZmL7 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10847"; a="446443764"
X-IronPort-AV: E=Sophos;i="6.03,187,1694761200"; d="scan'208";a="446443764"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2023 05:25:29 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10847"; a="726577144"
...
Date: Fri, 29 Sep 2023 13:25:08 +0100
Message-Id: <20230929122517.349348-4-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [PATCH i-g-t 03/12] tests/i915/drm_fdinfo: Add some
 memory info tests

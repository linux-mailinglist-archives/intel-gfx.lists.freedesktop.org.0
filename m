...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACE9EB2BFF
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Sep 2019 17:46:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 705616F526;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 9P5Q==
Subject: Re: [Intel-gfx] [PATCH 6/9] drm/msm: use drm_debug_enabled() to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 04ACE5297D9
	for <lists+intel-gfx@lfdr.de>; Tue, 17 May 2022 05:20:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8F3A310F088;
...
Subject: [Intel-gfx] [PATCH v2 4/6] drm/i915/sseu: Don't try to store EU

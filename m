...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 87E1C67DAD0
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Jan 2023 01:29:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B926210E2C2;
	Fri, 27 Jan 2023 00:29:25 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 8/8] drm/i915/guc: Rename GuC register state

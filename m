...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D9744B5549
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Feb 2022 16:49:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1516910E2F2;
...
Subject: [Intel-gfx] [PATCH V2 12/13] media: wl128x: use

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C296C3F7712
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Aug 2021 16:23:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 524666E239;
	Wed, 25 Aug 2021 14:23:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pj1-x1030.google.com (mail-pj1-x1030.google.com
 [IPv6:2607:f8b0:4864:20::1030])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C63756E231;
 Wed, 25 Aug 2021 14:23:22 +0000 (UTC)
Received: by mail-pj1-x1030.google.com with SMTP id
 ot2-20020a17090b3b4200b0019127f8ed87so4034355pjb.1; 
 Wed, 25 Aug 2021 07:23:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=rtuBBmsJ+FZGp2Lavog/mblfNKKX32jG6r2O7uMrLj0=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=rtuBBmsJ+FZGp2Lavog/mblfNKKX32jG6r2O7uMrLj0=;
 b=
X-Gm-Message-State: AOAM531hAbIbG/1nIUs20qDa5veYpTtT/dacJv5u6FX9uDm3G0AABaFa
 g271HMms6dpY3bC0SREX7wc=
X-Google-Smtp-Source: ABdhPJzCGv7ZxrRKobcqA9yqERd+ZhmrthNjIh7qXRu/K8fjieo8BatSKDJaNlQyDjTM8nMq/1rQvw==
X-Received: by 2002:a17:90a:19c2:: with SMTP id
 2mr10757539pjj.17.1629901402398; 
 Wed, 25 Aug 2021 07:23:22 -0700 (PDT)
Received: from localhost.localdomain ([118.200.190.93])
 by smtp.gmail.com with ESMTPSA id n3sm54431pfo.101.2021.08.25.07.23.15
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 25 Aug 2021 07:23:21 -0700 (PDT)
...
Date: Wed, 25 Aug 2021 22:22:02 +0800
Message-Id: <20210825142205.1376789-5-desmondcheongzx@gmail.com>
...
Subject: [Intel-gfx] [PATCH v7 4/7] drm: avoid races with modesetting rights

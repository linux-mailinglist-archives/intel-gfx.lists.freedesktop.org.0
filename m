...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CNZrKfQ6q2mAbQEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 06 Mar 2026 21:37:08 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 09D8A2278D6
	for <lists+intel-gfx@lfdr.de>; Fri, 06 Mar 2026 21:37:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8282210E40E;
...
X-Spamd-Result: default: False [0.69 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[nvidia.com:mid,nvidia.com:email,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,Nvidia.com:dkim,collabora.com:email,garyguo.net:email]

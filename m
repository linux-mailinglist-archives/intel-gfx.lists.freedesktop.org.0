...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wDeDB1Y/F2qg9wcAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 27 May 2026 21:00:38 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8EBEE5E94A5
	for <lists+intel-gfx@lfdr.de>; Wed, 27 May 2026 21:00:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5B57410E92A;
	Wed, 27 May 2026 19:00:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="baV6dmZU";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 76A0710E929;
 Wed, 27 May 2026 19:00:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1779908433; x=1811444433;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=RnptA5IppWnMXYcV9/WoNBQfTGZj3FVAwFeNqGoNccI=;
 b=baV6dmZUkpiltr5yTVXb9vIP509m+mE0NlWKd4nf2GjYUS2iuyrQoJBM
 QfQNfGlsAgUkSN2HooIt3uyXe7TT1WBJGuR8YEm8l9yiaY4Be0HXyKJuw
 IfFRFNiV7cn3rL2N1dO9M13mFvPA0/0F4SoWXoGKc4v+e0w4Osw4M+104
 VhgiNG/bqPf9x16vYUBRiq4KUVz4hXscF+WLiM53xHkn2WIebPplOq9Ui
 qYN1+BeqSsXK26y5cj6srT7kxaVbrNi+92ojnNQE4SrCVO4PjizqIQVPQ
 ABHoyvkl/kkKf6hLymt7JwQv9PQRK5ISqrQXpd+YusWovIZgL4kYbxF8N A==;
X-CSE-ConnectionGUID: JssFpInIQEGUB6uX7ccphA==
X-CSE-MsgGUID: CG5xMjAASc6bRCK9q22onQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11799"; a="80602126"
X-IronPort-AV: E=Sophos;i="6.24,172,1774335600"; d="scan'208";a="80602126"
Received: from fmviesa003.fm.intel.com ([10.60.135.143])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 May 2026 12:00:33 -0700
X-CSE-ConnectionGUID: 6O8xR8q5TDmRff08yUjYGA==
X-CSE-MsgGUID: Uknp0zqPTRCPXLVDbP/XLA==
X-ExtLoop1: 1
Received: from dibin-nuc7i7bnh.iind.intel.com ([10.190.239.19])
 by fmviesa003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 May 2026 12:00:31 -0700
From: Dibin Moolakadan Subrahmanian <dibin.moolakadan.subrahmanian@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Subject: [CI 01/17] drm/i915/cmtg: Enable CMTG
Date: Thu, 28 May 2026 00:29:48 +0530
Message-ID: <20260527190004.118730-2-dibin.moolakadan.subrahmanian@intel.com>
...
---
 ...
 14 files changed, 482 insertions(+), 12 deletions(-)

diff --git a/drivers/gpu/drm/i915/display/intel_cmtg.c b/drivers/gpu/drm/i915/display/intel_cmtg.c
index e1fdc6fe9762..c1f4fa50f688 100644
...
+
  ...
  * a modeset, do it.
@@ -183,5 +231,302 @@ void intel_cmtg_sanitize(struct intel_display *display)
...
index 757a78c75bbf..209a92f8ff15 100644
...
+#include "intel_cmtg.h"
 ...
 #include "intel_crt.h"
 #include "intel_crtc.h"
@@ -1614,6 +1615,7 @@ static void hsw_configure_cpu_transcoder(const struct intel_crtc_state *crtc_sta
 					       &crtc_state->dp_m2_n2);
 	}
...
@@ -1769,6 +1771,11 @@ static void hsw_crtc_disable(struct intel_atomic_state *state,
...
@@ -2753,6 +2760,8 @@ static void intel_set_transcoder_timings(const struct intel_crtc_state *crtc_sta
...
@@ -2814,6 +2823,7 @@ static void intel_set_transcoder_timings_lrr(const struct intel_crtc_state *crtc
 		       VACTIVE(crtc_vdisplay - 1) |
 		       VTOTAL(crtc_vtotal - 1));
...
@@ -6653,9 +6663,11 @@ static void intel_pipe_fastset(const struct intel_crtc_state *old_crtc_state,
...
@@ -6856,6 +6868,13 @@ static void intel_update_crtc(struct intel_atomic_state *state,
...
index f44be5c689ae..924f0b90d560 100644
--- a/drivers/gpu/drm/i915/display/intel_display_types.h
+++ b/drivers/gpu/drm/i915/display/intel_display_types.h
@@ -1572,6 +1572,10 @@ struct intel_crtc {
 #endif

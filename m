...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 36FFA663EC6
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Jan 2023 11:58:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 070E010E59A;
	Tue, 10 Jan 2023 10:58:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8311C10E59A
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 Jan 2023 10:58:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1673348332; x=1704884332;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=8YYge88SYFeICo/AE5n3Ck/Y1EPxxilHWdFqQgHpjSQ=;
 b=izUU+cuMhjsx/iI82YFAUuFSEl06BgmvZjyi8JdI8jL+CyCnJKMz+Ddt
 jSezoR6RWK4f+j+6VPWO7UC2Fay8ANr6LYx+T/yptJAEhib9Ui81WoonM
 gOS/1Tt20EILeyzPgZzwA1/HxUaExTR/ReDgLV1fC7sA9DE6UKzqHqZOe
 Iftxj5/37DH7sxqTEBL2vORqvd9tZBySF4brEGo6BawjDBsfF0YATFR6g
 ZC/LTB4iWzy1B0AKxkgln2Aqnp2cD/CRDeV2mdEwAWA4NzYcDs7tzM3BJ
 kShPVzX8aUP3Y5DFZeqDaJt5C8Pgxibtj0v88Bfib1ZG7ULFgrN/Z+mZh Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="385421860"
X-IronPort-AV: E=Sophos;i="5.96,315,1665471600"; d="scan'208";a="385421860"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jan 2023 02:58:52 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="650322879"
X-IronPort-AV: E=Sophos;i="5.96,315,1665471600"; d="scan'208";a="650322879"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga007.jf.intel.com with ESMTP; 10 Jan 2023 02:58:48 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Jan 2023 16:27:28 +0530
Message-Id: <20230110105732.1390596-3-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 2/6] drm/i915/hdcp: Keep hdcp agonstic naming
 convention

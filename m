...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6641625D840
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Sep 2020 14:00:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 677516EB7F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 4/7] drm/i915: Do not call

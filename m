...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C207E3183EC
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Feb 2021 04:24:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 85DB96EDD5;
	Thu, 11 Feb 2021 03:24:02 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 4/4] drm/i915/gen9_bc: Add W/A for
 missing STRAP config on TGP PCH + CML combos

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B12AC616099
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Nov 2022 11:09:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 97C2610E48B;
	Wed,  2 Nov 2022 10:09:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 263BA10E489
 for <intel-gfx@lists.freedesktop.org>; Wed,  2 Nov 2022 10:09:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667383768; x=1698919768;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=tTfsLnZ66u33Qh8HAoYvhM5se8uprUZqpFj8Wya3PCQ=;
 b=DX9gnhgIKxDd5aMLSmraF0zgYFzQ22Mg+3PSw2QOnyStgz1DknLQUNOV
 ViMNu9U3kgFZzRq9aUGR9a+muwKai1hGlOJZtQEjfibPe6g7PW1iGI1uM
 IeZUSjcVoLdAZaXmLE78qgOQiZJmyhNKazQhwy76UYD1unOR2YQwOBs+U
 GljXWjoxsu996yWiiDrDxR04aT4SpAaRdGqu8V8fn3lCektumeTsiKpUt
 bXMfQVQ0ECN/Ybh+QSzCDBfUoKUGiQEU/mw3PE72Mqi7ay5DLexccToEo
 w4MV3kn32z1n7vS394woLaEjo7CXFjMkvwEHAATH4CMhA5vmm43NnH0hk A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10518"; a="292677786"
X-IronPort-AV: E=Sophos;i="5.95,232,1661842800"; d="scan'208";a="292677786"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Nov 2022 03:09:27 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10518"; a="634204543"
X-IronPort-AV: E=Sophos;i="5.95,232,1661842800"; d="scan'208";a="634204543"
Received: from cjokeeff-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.15.91])
 by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Nov 2022 03:09:25 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed,  2 Nov 2022 12:08:23 +0200
Message-Id: <d8062ad30fdaf6915dd770dcddd5a3ad5ec3c6dd.1667383630.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 15/16] drm/i915: stop including i915_irq.h
 from i915_trace.h

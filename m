...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A01E56CA011
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Mar 2023 11:41:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5268910E346;
	Mon, 27 Mar 2023 09:40:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E9E5010E338;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=UITTu38wDwhu6GxA/5oJJyl89GgA/1YrrtIdxB8DoFpGG/4Z9icXPzUp
 OBw90EKleCWt5EsBqEgPgxCyj11mbDsFW2XTSknYcvYET/7orRR+yAr/5
 2+zx70ZaK77LR2pAzCar0ZwU7mUJ/rkUI3HRwPvN6O4ABNyyDD441Ocmd
 txSi5TfPDeJbrFUG81/CDzvkjPsZvCUBYIhGGyw7vSY2fY3uZj74s8Tx0
 USm8Vy90JlmR6aZIYKZudaFXObOT48Ph/aQqDvQlA9/ts2KxvCui4SRhi
 pnbW2JssE04Ug337Ds1zodk2nsz98aCpYARTS+zsISfVeNoB6NpzFWm5T g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="426485292"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="426485292"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Mar 2023 02:40:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="660775693"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="660775693"
...
Date: Mon, 27 Mar 2023 02:40:30 -0700
Message-Id: <20230327094047.47215-8-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230327094047.47215-1-yi.l.liu@intel.com>
References: <20230327094047.47215-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v8 07/24] vfio: Pass struct vfio_device_file *

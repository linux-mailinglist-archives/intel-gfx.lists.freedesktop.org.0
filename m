...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3D9963D724
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Nov 2022 14:49:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 93C2210E459;
...
Subject: [Intel-gfx] [PATCH v5 2/4] usb: gadget: hid: Convert to use
 list_count_nodes()

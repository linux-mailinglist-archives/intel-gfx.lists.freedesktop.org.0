...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BD3B3E462B
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Aug 2021 15:09:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CFBA989B3B;
...
Subject: Re: [Intel-gfx] [PATCH v4 13/27] drm/mediatek: Don't set struct

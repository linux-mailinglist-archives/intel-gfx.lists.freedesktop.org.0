...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E267611A117
	for <lists+intel-gfx@lfdr.de>; Wed, 11 Dec 2019 03:09:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 018F86EA46;
	Wed, 11 Dec 2019 02:09:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AA97D6EA38
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,301,1571727600"; d="scan'208";a="210618390"
Received: from josouza-mobl.jf.intel.com (HELO josouza-MOBL.intel.com)
 ([10.98.40.69])
 by fmsmga008.fm.intel.com with ESMTP; 10 Dec 2019 18:09:01 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Dec 2019 18:08:55 -0800
Message-Id: <20191211020858.423049-8-jose.souza@intel.com>
X-Mailer: git-send-email 2.24.0
In-Reply-To: <20191211020858.423049-1-jose.souza@intel.com>
References: <20191211020858.423049-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 08/11] drm/i915/display: Always enables MST
 master pipe first
...
L2dwdS9kcm0vaTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYwppbmRleCBkMDU5OTQ4ZWVjOWEu
LjZhODE1YzExYzgzYyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9p
...
dl9wcml2LCByZXF1aXJlZF9zbGljZXMpOwotLSAKMi4yNC4wCgpfX19fX19fX19fX19fX19fX19f

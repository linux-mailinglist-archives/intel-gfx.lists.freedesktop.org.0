...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59D4E86DF80
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Mar 2024 11:43:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECCED10EC7E;
	Fri,  1 Mar 2024 10:43:51 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="SK8o7x2U";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 12E6410EC7E
 for <intel-gfx@lists.freedesktop.org>; Fri,  1 Mar 2024 10:43:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709289831; x=1740825831;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=KixRWNo906gyJAXXZ15ofiENqQ/a8g1rj6NkS75DIaE=;
 b=SK8o7x2Us/IPU4KRAjaB+pM7puqJs9QHibeAYpzwy8qJvfj+a9xPJQ1o
 +lk/6KwBsRMFhbwLowWWl0qJfkS5luOUa2xy8MCt2WL1eR+RxiitK7l/3
 95/yEBhzUDjoHwAZ4CkyIe/xjRDtpBEQzjO01HCksGzRAwNLJwirwFXcn
 2Usq9pxu7kNAeBR2O6BL859z5pV0YoRmuBbGFHxEwyIyp6YdW4vfC9hlI
 RKT6mqC/C+k/5igoLaehBogR8cGrL//3Az7XXDf/JKHqAO6PMaaRR7kci
 1F175aMYnxRMcIEE1+xpVeStmObiKawTnzEz0WriH+3GeMJ9WxcKS1ppn w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10999"; a="7635508"
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; 
   d="scan'208";a="7635508"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Mar 2024 02:43:50 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10999"; a="827771907"
X-IronPort-AV: E=Sophos;i="6.06,196,1705392000"; d="scan'208";a="827771907"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga001.jf.intel.com with SMTP; 01 Mar 2024 02:43:47 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Fri, 01 Mar 2024 12:43:46 +0200
Date: Fri, 1 Mar 2024 12:43:46 +0200
...
Message-ID: <ZeGxYpFS-HWZG-gh@intel.com>
...
In-Reply-To: <ZeGthkBNfj6AbtF9@intel.com>

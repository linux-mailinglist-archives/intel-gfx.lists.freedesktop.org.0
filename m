...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 94C9C705BB7
	for <lists+intel-gfx@lfdr.de>; Wed, 17 May 2023 02:08:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3EEB10E38F;
	Wed, 17 May 2023 00:07:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-lj1-x22f.google.com (mail-lj1-x22f.google.com
 [IPv6:2a00:1450:4864:20::22f])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 81C1210E38A
 for <intel-gfx@lists.freedesktop.org>; Wed, 17 May 2023 00:07:45 +0000 (UTC)
Received: by mail-lj1-x22f.google.com with SMTP id
 38308e7fff4ca-2acb6571922so476951fa.0
 for <intel-gfx@lists.freedesktop.org>; Tue, 16 May 2023 17:07:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=linaro.org; s=google; t=1684282065; x=1686874065;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=Dr+52mGsT+6t14CI69EisPIcQF6p4tUnT/YjnwEkL/4=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20221208; t=1684282065; x=1686874065;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=Dr+52mGsT+6t14CI69EisPIcQF6p4tUnT/YjnwEkL/4=;
 b=
X-Gm-Message-State: AC+VfDw4aZGJhmP5jgneZRFZyCFgnku5gmc9802bN6wu0g8bwuDdR22U
 pUMKwmXJ9xTzkej6D4uuiHqaCw==
X-Google-Smtp-Source: ACHHUZ5193QggvFqddPneZHVGn0rvbjnnISlBJWXO1VofTSSLDxj4OxJHtntfEAmuFUD8O9hvmH4Aw==
X-Received: by 2002:a2e:9456:0:b0:2a8:b262:35ee with SMTP id
 o22-20020a2e9456000000b002a8b26235eemr8992061ljh.31.1684282064894; 
 Tue, 16 May 2023 17:07:44 -0700 (PDT)
Received: from eriador.lan (dzdqv0yyyyyyyyyyybcwt-3.rev.dnainternet.fi.
 [2001:14ba:a0db:1f00::8a5]) by smtp.gmail.com with ESMTPSA id
 y22-20020a2e9d56000000b002ac71095b61sm4214858ljj.64.2023.05.16.17.07.44
...
Date: Wed, 17 May 2023 03:07:35 +0300
Message-Id: <20230517000740.2102599-4-dmitry.baryshkov@linaro.org>
...
Subject: [Intel-gfx] [PATCH v6 3/8] drm/i915/dsc: move DSC tables to DRM DSC
 helper

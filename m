...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27EBA93B24C
	for <lists+intel-gfx@lfdr.de>; Wed, 24 Jul 2024 16:09:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 58BB410E6D6;
	Wed, 24 Jul 2024 14:09:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="HhN07hZS";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E99AD10E6DF;
 Wed, 24 Jul 2024 14:08:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1721830134; x=1753366134;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=gA14zLLi9b8+u0fO0AwBvXMUmragaKJIlZtkidHrRdU=;
 b=HhN07hZSuzrCvf/mH+bCd24F4OEmWOj4u8VNutwuaQvHevnD/nbAdzAL
 pvvhDM6iV/qsuCpeQzR1FWMIoO25LKYVJXxrQqsQ4psBJ8OSzo6WPvs4U
 MTC5/muGX8qj501jQv3mhO4z9BmMhw1H0VrOqL32D/rRDOXwECmqC2ZZH
 PKKSUtoCuLtIra169bzIHvxS35nyNXsSip14XQ2hm1ihVNdobNP3UTdL4
 G9wJ5CqMZuV58/AYJ8naOLHWNV2jDUGX71uqXuwWSN7dQBVHBY6WpI5BH
 ymhqlf52xx8zh+ZVxyk4dzcSKybtKIvm1vdsgwJStYzcfDeMP+ugUuwLl g==;
X-CSE-ConnectionGUID: LRYd/fXeS0mWI/ZIgYE8pw==
X-CSE-MsgGUID: tb6gpp6bQlyG1s3tpSBMMw==
X-IronPort-AV: E=McAfee;i="6700,10204,11143"; a="30173703"
X-IronPort-AV: E=Sophos;i="6.09,233,1716274800"; d="scan'208";a="30173703"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Jul 2024 07:08:53 -0700
X-CSE-ConnectionGUID: scTBKM7sREi7hFKTZ8t4Nw==
X-CSE-MsgGUID: qMWrf9DATQq0nbqj+6lQsQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,233,1716274800"; d="scan'208";a="83211354"

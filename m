...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 29B4D7208E0
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Jun 2023 20:15:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3CC2F10E0C4;
	Fri,  2 Jun 2023 18:14:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EEF0A10E0E4
 for <intel-gfx@lists.freedesktop.org>; Fri,  2 Jun 2023 18:14:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685729696; x=1717265696;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=q1PIIa5KeWsb2rY+S99fJQlwxkcRSCeGjNNqpYBK9/0=;
 b=ho9L+GoIU5e4EqtiNIF36Du9Bt4p2ylEu8TQKrzlzrUokvKto9h3SOqE
 sPYfGD7avVkkzJ+NZo2JMhjEh8+Yrl7zRl8fxrq66j1usIlzeNUbmhrPL
 EJlLsSEubCuCzjvUkeXJKfcQgqDPdYnfeANXEc0/b9lTFyjDrQb/Yn88x
 d97sPq/mURM/JqzoiFgpOziD0CaC9Ymo3D8VNTY4nQLb13Zooj4amKpKL
 4gQERF+zgvQnBFf139UZbVRws8gkYY4x33PHiHD4EYspp7xRYXjr/f65i
 QaHB1ZdtCFKfZKF5155R/ZNE+d+zQ8C+2Ab2A56HlWDEjgwEBlAQQyBut Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10729"; a="419466957"
X-IronPort-AV: E=Sophos;i="6.00,213,1681196400"; d="scan'208";a="419466957"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Jun 2023 11:14:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10729"; a="954588389"
X-IronPort-AV: E=Sophos;i="6.00,213,1681196400"; d="scan'208";a="954588389"
...
Message-Id: <20230602181450.1151368-1-matthew.d.roper@intel.com>
X-Mailer: git-send-email 2.40.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2] drm/i915/display: Extract display init from

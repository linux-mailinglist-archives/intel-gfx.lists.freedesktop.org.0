...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E93367945E
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 10:42:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9BA9310E63A;
	Tue, 24 Jan 2023 09:42:11 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 2/3] drm/connector: move HDR sink metadata to
 display info

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 67B564BA26E
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Feb 2022 15:05:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED36210EBA1;
	Thu, 17 Feb 2022 14:05:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7E30610EB84;
 Thu, 17 Feb 2022 14:05:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1645106716; x=1676642716;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=mmpDbho6EFBReIp+UJ+Rf409yBMByOTa3FwPx9dN22o=;
 b=Cm+FhNqNEmmKqrTF4Ay4kCIyy13AOVBgBEIKonbLWuvKwH8U//1bTQKF
 xd82+fclM+Oi+G/wL4URBlIEaHsABRHIsWcpa/MxX1Zvt96TaQmfOImoq
 1hwk4f5r2iH9AI7dZy0DFBkbh2zwTqYMk5NRwCAi6V4kWlFo2UtFDbRlN
 /+xxQbrnkTjcTf7LgiWIFI7bvqusP9Lm5wKr3J6HzygHJrziQoD4Rx+6G
 yGpGLoVJL0O4t0ZDI9OD9Kp+riP/BDX0c2EkOAEmNnwOAYuAAx/3qTkeN
 QUhLxpJ/vBIcWfiCTPPdOo+78pc7oGF3w5eLbi30AA7oSWlb/04evzL26 A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10260"; a="230840863"
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="230840863"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Feb 2022 06:05:16 -0800
X-IronPort-AV: E=Sophos;i="5.88,376,1635231600"; d="scan'208";a="530241317"
...
Date: Thu, 17 Feb 2022 15:04:38 +0100
Message-Id: <20220217140441.1218045-7-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH 6/9] drm/i915: Separate wakeref tracking

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 396A33CF0D2
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 02:34:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5B7C89919;
...
Subject: Re: [Intel-gfx] [PATCH 13/51] drm/i915/guc: Disable semaphores when

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20C2C21FF2F
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF2DF6E9B2;
...
Subject: [Intel-gfx] [PATCH v2 28/59] drm/kmb: Changed MMIO size

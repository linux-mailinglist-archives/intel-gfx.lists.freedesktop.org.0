...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18C3E3F29D2
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Aug 2021 12:04:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BFD676EA58;
...
Subject: [Intel-gfx] [PATCH v4 4/5] drm: avoid races with modesetting rights

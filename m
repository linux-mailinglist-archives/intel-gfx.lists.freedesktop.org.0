...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D8E3A4C4608
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Feb 2022 14:22:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AC1910E4D2;
	Fri, 25 Feb 2022 13:22:22 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 3/3] drm/prime: Update docs

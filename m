...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8C3D3C35ED
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Jul 2021 19:52:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E97636EB4D;
	Sat, 10 Jul 2021 17:52:38 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 09/16] drm/i915/guc/slpc: Add get max/min
 freq hooks

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10A26794364
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Sep 2023 21:02:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B218110E064;
...
Subject: [Intel-gfx] [PATCH v3 0/5] drm/drm_dbg: add trailing newlines where
 missing

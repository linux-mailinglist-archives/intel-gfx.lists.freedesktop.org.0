...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B8AD59EAE4D
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Dec 2024 11:47:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C1ED910E0DF;
	Tue, 10 Dec 2024 10:46:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="XPzFCaZD";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2E67A88784;
 Tue, 10 Dec 2024 10:46:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1733827611; x=1765363611;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=94SIDsjIbphJBO6NBx8Rao1JZZNqmkLraZV2aWYy5qM=;
 b=XPzFCaZDVz2ag2DsyUrayUaDiyqzDfu4TsU9k55ONKqKfiY2sowboCmR
 L6qiqdPWRAq8NDhWd3ixAE0QkAL3RRUpBy3f0cfr7pHbL3NMspMNpvf5W
 QnioVdMOcORekvm+HwgJbnQ865X8QIqqRNKSs5vNTijv9R6owzNNfFDWO
 HD263FM/xPDzsbby8UjV9WK60X65eKZWVAhE3QofM0gsh0dg0mWxqc/DP
 u3iHTjTR4OMBqQOHJRyKXiJ770JcnV4D3Gcy5QFCjskprxV16wphg2tB2
 zzSJ6nkXe/SfC13feGaAbKmcn9v4MEQu18ZZJWbJYbOtqn9qpuSw8BXfh A==;
X-CSE-ConnectionGUID: K2oUd9JHTkGYd63RxE5pjQ==
X-CSE-MsgGUID: sDzgo/PSSn2dixwHVza06Q==
X-IronPort-AV: E=McAfee;i="6700,10204,11281"; a="37949425"
X-IronPort-AV: E=Sophos;i="6.12,222,1728975600"; d="scan'208";a="37949425"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2024 02:46:50 -0800
X-CSE-ConnectionGUID: jXNFQeQIQv+8d99ddzqWGw==
X-CSE-MsgGUID: vRDH3JkURXqP5FyeA0aGIg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,222,1728975600"; d="scan'208";a="96177429"
Received: from mjarzebo-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.242])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2024 02:46:47 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH v2 3/5] drm/i915/dp: convert to struct intel_display
Date: Tue, 10 Dec 2024 12:46:28 +0200
Message-Id: <682fb4caec2ef524efc6a9f377e16513dd1241c5.1733827537.git.jani.nikula@intel.com>

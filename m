...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C266471B55
	for <lists+intel-gfx@lfdr.de>; Sun, 12 Dec 2021 16:22:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6AB5510F5C0;
...
Subject: [Intel-gfx] [PATCH RESEND v7 12/12] drm/i915: Move the GGTT from
 i915 private data to the GT

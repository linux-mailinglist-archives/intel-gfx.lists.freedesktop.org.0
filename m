...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 83357686B30
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Feb 2023 17:10:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 085D810E423;
	Wed,  1 Feb 2023 16:10:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 68B1010E424
 for <intel-gfx@lists.freedesktop.org>; Wed,  1 Feb 2023 16:10:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675267817; x=1706803817;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=LvkZfe1/1SxJfFEAfId7fC1L4EFgB9eEStczFQIL8OI=;
 b=bKAA1HjvMCoflneBuTJTQIe3chxln+la9QYJpfpYmdwaV9n/RfWhpBfC
 h7GAX4QukkUuLaGbIUBi1TpPFTgWiZ3xZDrEgmNwnyRdzCF8WW8Dw/KL5
 1P3PDkuD8IbToU/c739LwGcerpOzi+VtKB4NawvNLYvy0Z6anQt617wWg
 SUWJ+GtTv8+2dEBGjHFkgK66w1fuf9ZRXK8MMHDsNrTZ8o/+B/D4iqvDD
 ZWocD2CVu+rV5VJqbQ1iDD6khe1U0P/KSFtWWFGWRaPpokAKYlRQXmqfN
 y8sVuKA4PGeZBdLfRr2BqkV6pQHgun+oFmNti/6++qOmT1gx4tJrlsLhK w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="330319773"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="330319773"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 08:10:15 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="728461327"
X-IronPort-AV: E=Sophos;i="5.97,263,1669104000"; d="scan'208";a="728461327"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.2.220])
 ([10.213.2.220])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2023 08:10:13 -0800
Message-ID: <ff20ac62-8e2a-0cb6-4e06-f95f95731b85@intel.com>
Date: Wed, 1 Feb 2023 17:10:11 +0100
MIME-Version: 1.0

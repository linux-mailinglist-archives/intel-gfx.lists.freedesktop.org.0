...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 94E06851BDC
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Feb 2024 18:43:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AFD9010EC7D;
	Mon, 12 Feb 2024 17:43:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="jw+Ps8sq";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 061AC10EE75
 for <intel-gfx@lists.freedesktop.org>; Mon, 12 Feb 2024 17:43:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1707759805; x=1739295805;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=HPA8tTVn5n2Qxo6s3qu6iU/Pqtal2RNGDzvLEp2Fyvo=;
 b=jw+Ps8sqBJMFoihPfCgrRLxvdbIT7dagVIoOZWo72OnZk5vdh/LPduSi
 dr9ChO55UCT8S+lbOkyv00ekP3RUnsSjE26KWNS43aKUkwFMEBFBSGNuv
 aymdkTkkP2DKEpXqxsFmer0u55hPRLptnsAGYeY68K1juxATTe4U2YzPc
 OMBouk178uCO0GSJweybgn1/Scv/umfqBfEEGQ8+G/g/aSk62/KPZdF5l
 t/DCqsNfsV8fsK+tjWqT7zdLdXqHlsf2YHXVLQckykvdqij599/UuCaav
 Und92UwGmyhQQZ15LuD4W9U55HN//VNeGaPQoonpmfUaECrjfWCMOL8Go A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10982"; a="1872000"
X-IronPort-AV: E=Sophos;i="6.06,155,1705392000"; 
   d="scan'208";a="1872000"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Feb 2024 09:43:25 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,155,1705392000"; 
   d="scan'208";a="2595389"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmviesa007.fm.intel.com with ESMTP; 12 Feb 2024 09:43:24 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: ankit.k.nautiyal@intel.com,
 Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
Subject: [PATCH 2/4] drm: Add Adaptive Sync SDP logging
Date: Mon, 12 Feb 2024 23:06:21 +0530
Message-Id: <20240212173623.1464540-3-mitulkumar.ajitkumar.golani@intel.com>

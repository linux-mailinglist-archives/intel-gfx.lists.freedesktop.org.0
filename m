...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E6BA668AF9
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Jan 2023 05:42:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C0A9D10E987;
...
Subject: [Intel-gfx] [PATCH 1/2] drm: Add SDP Error Detection Configuration
 Register

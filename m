...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 37282197E8A
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Mar 2020 16:36:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F0C096E408;
	Mon, 30 Mar 2020 14:36:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4B6016E402
 for <intel-gfx@lists.freedesktop.org>; Mon, 30 Mar 2020 14:35:50 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 30 Mar 2020 16:35:34 +0200
Message-Id: <20200330143545.4371-11-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/22] drm/i915: Rework intel_context pinning to
...
index 9104796673dc..4000eaf414fb 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3023,7 +3023,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3053,20 +3056,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3074,9 +3080,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3102,8 +3108,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -4880,13 +4888,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -4919,8 +4927,10 @@ static void virtual_context_exit(struct intel_context *ce)

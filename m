...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AF99175A8B9
	for <lists+intel-gfx@lfdr.de>; Thu, 20 Jul 2023 10:09:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CC3410E581;
	Thu, 20 Jul 2023 08:09:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 051FE10E580
 for <intel-gfx@lists.freedesktop.org>; Thu, 20 Jul 2023 08:09:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1689840566; x=1721376566;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=qIltKNvgz24P+gBubxQultK0eqgrwP3w0/occj+DCXQ=;
 b=J/ArQY/bupub2pkrKXn2Na0yn/FOJ4b7FptaI4y8MR7R5CAgrFGo+PAf
 4NLez6i38o87uDyZ+B8eZJ16W+qzCALqocVBqrs9LbAOh0j74LROZmUCb
 4W0ZlPwrLNiUiPMhvkCUmERYbrRuzS6cmseuWUZp764C9GmbmtbOrVGgZ
 sKLXsjkILNZdpv+hNIMhwftU/sWnHIU9D7CbrySslcgCDUebzPqROeqdx
 6q87mK0Gdv/eppDplZN0Biqbh371ee8Fjqbcrry7Ckr7GKHHZGBcmZGgH
 I6lQd2R276lcj3T/nNqaRGcaVmIAkC9lEhebMuV9ASXHygiw/X9G/sKDT g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="366700208"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="366700208"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Jul 2023 01:09:26 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10776"; a="724305676"
X-IronPort-AV: E=Sophos;i="6.01,218,1684825200"; d="scan'208";a="724305676"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga002.jf.intel.com with ESMTP; 20 Jul 2023 01:09:24 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 20 Jul 2023 13:37:13 +0530
Message-Id: <20230720080715.3063267-6-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 5/7] drm/i915/vdsc: Remove unused dsc
 registers

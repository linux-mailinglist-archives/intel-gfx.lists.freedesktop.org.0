...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE6A6AE1A1C
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Jun 2025 13:38:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7149710EB4B;
	Fri, 20 Jun 2025 11:38:09 +0000 (UTC)

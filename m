...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D21FE5B304D
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:38:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED91A10EC48;
...
Subject: [Intel-gfx] [PATCH v3 28/37] docs: gpu: i915.rst: GuC: add more
 kernel-doc markups

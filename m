...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FBA246FC77
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 09:12:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3E1310E2FF;
...
Subject: Re: [Intel-gfx] [PATCH 6/9] drm/i915/gvt: Constify

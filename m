...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3ACC957B9FC
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 17:34:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 045338F414;
...
Subject: [Intel-gfx] [PATCH v4 08/41] dyndbg: add test_dynamic_debug module

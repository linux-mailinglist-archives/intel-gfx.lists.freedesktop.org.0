...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BC7A2DA540
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Dec 2020 02:08:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 941486E196;
	Tue, 15 Dec 2020 01:08:22 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 514496E150
 for <Intel-gfx@lists.freedesktop.org>; Tue, 15 Dec 2020 01:08:03 +0000 (UTC)
IronPort-SDR: 4dRhTrfJ6jvfoltbBXoOOR6iffD8xFFc8ipE/dMkLbTM2SGNWwPfiBT8t0GiUAJ41CD6VlK+1V
 Kr2Iu1HZIAJQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9835"; a="171297999"
X-IronPort-AV: E=Sophos;i="5.78,420,1599548400"; d="scan'208";a="171297999"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Dec 2020 17:08:01 -0800
IronPort-SDR: rucDW8HkLzHvekC3YeTadrdrJodmp2l0hjhCw0jNtieJoukA+RoaEf1NCHwZxymF2yz0S0wLLO
 qrHHru+o6rTg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,420,1599548400"; d="scan'208";a="331861147"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga007.fm.intel.com with ESMTP; 14 Dec 2020 17:08:01 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Mon, 14 Dec 2020 17:07:19 -0800
Message-Id: <20201215010726.15898-17-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201215010726.15898-1-sean.z.huang@intel.com>
References: <20201215010726.15898-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v9 16/23] drm/i915/pxp: Implement ioctl action to
...
index d304c704c943..e38a8c36753e 100644
...
@@ -273,3 +274,58 @@ int intel_pxp_cmd_add_inline_termination(u32 *cmd)

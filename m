...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A71AAC48525
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Nov 2025 18:28:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DDD610E466;
	Mon, 10 Nov 2025 17:28:14 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="D2GGZeWJ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 79A4310E463;
 Mon, 10 Nov 2025 17:28:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1762795694; x=1794331694;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=AUBo+ENIyluwRaQ2uNJF47sSgfg6FUlAv5CTSR+yBjY=;
 b=D2GGZeWJ9bd8vgG1FtwQ/8LsAiCChKS9SJMoxNq8/SxkPFD7LCVObRCh
 TI6C7NQIJ7SNO4FD5+77byxMJzdZuoB8STdg4lsGOrJgI12+LUDP0GQcG
 5GYhvASiYk+mEeVhfVflolu+7Z7/VBtKaraXGAF6RmgKae4btAqHJP0y7
 y3ETbUNwQKwZAttg8XxSA7tByGCKLWcI6bI5a8IxKyB/8XwgRxFgN4jxI
 Q3uHw+q9gBOD68+lD0wWICPRaVJVXYMFKUQYGJOXP2jcY1mYBsZG1sBZn
 q0azbJuru/+hRQfYQ6dB+FWAzFVnClc02jnVuTxKOzK9KKAl5EfEuLnAc A==;
X-CSE-ConnectionGUID: ez9tHAntS3uFud623cRCiw==
X-CSE-MsgGUID: z/g7ICkrQxOyjkjT/Z5xqA==
X-IronPort-AV: E=McAfee;i="6800,10657,11609"; a="64759006"
X-IronPort-AV: E=Sophos;i="6.19,294,1754982000"; d="scan'208";a="64759006"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2025 09:28:13 -0800
X-CSE-ConnectionGUID: rpYXu/pSQGqkb5+kphidlg==
X-CSE-MsgGUID: IguYyMTERiGwvB6lu5HLww==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,294,1754982000"; d="scan'208";a="188035903"
Received: from bergbenj-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.244.30])
 by orviesa010-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2025 09:28:11 -0800
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: intel-xe@lists.freedesktop.org
Subject: [PATCH 03/16] drm/i915/de: Include units in intel_de_wait*() function
 names
Date: Mon, 10 Nov 2025 19:27:42 +0200
Message-ID: <20251110172756.2132-4-ville.syrjala@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5930EAA2A0
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Sep 2019 14:05:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DE5D6E0A1;
	Thu,  5 Sep 2019 12:05:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DBFDE6E098
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Sep 2019 12:05:14 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga105.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 05 Sep 2019 05:05:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,470,1559545200"; d="scan'208";a="190474679"
Received: from aandueza-mobl1.amr.corp.intel.com (HELO
 delly.ger.corp.intel.com) ([10.252.38.201])
 by FMSMGA003.fm.intel.com with ESMTP; 05 Sep 2019 05:05:13 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Sep 2019 15:04:50 +0300
Message-Id: <20190905120451.14327-12-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v14 11/12] drm/i915/perf: allow holding
...
ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X3BlcmYuYwppbmRleCA4ZTM1MzI1MTgxMzkuLjdhZGM1MTg5
MTJiYiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9wZXJmLmMKKysrIGIv
...
CS8qIE9BIHNhbXBsaW5nIHN0YXRlICovCkBAIC0yNjMyLDYgKzI2MzUsOCBAQCBzdGF0aWMgaW50
...
YV9mb3JtYXRzW3Byb3BzLT5vYV9mb3JtYXRdLmZvcm1hdDsKIApAQCAtMzE4Nyw2ICszMTkyLDE1
...
cmljcyBmb3IgdGhlCkBAIC0zMjAxLDggKzMyMTUsOSBAQCBpOTE1X3BlcmZfb3Blbl9pb2N0bF9s
...
cmVhbV9wYXJhbm9pZCBzeXNjdGwgb3B0aW9uCkBAIC0zMjExLDcgKzMyMjYsNyBAQCBpOTE1X3Bl
...
cmVhbVxuIik7CiAJCXJldCA9IC1FQUNDRVM7CiAJCWdvdG8gZXJyX2N0eDsKIAl9CkBAIC0zNDA4
LDYgKzM0MjMsOSBAQCBzdGF0aWMgaW50IHJlYWRfcHJvcGVydGllc191bmxvY2tlZChzdHJ1Y3Qg
...
X01BWDoKIAkJCU1JU1NJTkdfQ0FTRShpZCk7CiAJCQlyZXR1cm4gLUVJTlZBTDsKQEAgLTQxNzMs
NSArNDE5MSwxMiBAQCB2b2lkIGk5MTVfcGVyZl9maW5pKHN0cnVjdCBkcm1faTkxNV9wcml2YXRl

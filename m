...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF7F61641EC
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Feb 2020 11:23:56 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74A7F6EB5A;
	Wed, 19 Feb 2020 10:22:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x343.google.com (mail-wm1-x343.google.com
 [IPv6:2a00:1450:4864:20::343])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D1A16EB86
 for <intel-gfx@lists.freedesktop.org>; Wed, 19 Feb 2020 10:22:27 +0000 (UTC)
Received: by mail-wm1-x343.google.com with SMTP id n3so3668382wmk.4
 for <intel-gfx@lists.freedesktop.org>; Wed, 19 Feb 2020 02:22:27 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=tOUUVqY1CV1gMXd07njtAYuorsof/48pb4s0iJJf3ng=;
 b=NVhz6d1K+a8meJVkHcDdeAoaHzG/IRnilAEqbOCGdsbq8yxmqxvDAtrSK+js6XuuJi
 CRrNqllUOPw0E6lnFYtB15RibtDCdvdYQC2Gxu9khW5o+xesnAOTIu6wIA3aVjvvOvRe
 xVcwcxYIgS2ICPn/+40INlu+GcBhJNn973VuU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=tOUUVqY1CV1gMXd07njtAYuorsof/48pb4s0iJJf3ng=;
 b=
X-Gm-Message-State: APjAAAUZGNeVDYumTXbWm1Y1HwFYG9891dLvt+HZEO3g6JLeiChC6gpq
 /3YuWmNHM9ocel+qUO5DWXoCqQ==
X-Google-Smtp-Source: APXvYqzj7Z6grwHFdlq1lODPyq6ZDeOon+ksQE8GkLn/fs0Xzzm6/eUVN+NFXLmJHsye3bqyRyQn+Q==
X-Received: by 2002:a1c:7205:: with SMTP id n5mr9513019wmc.9.1582107745721;
 Wed, 19 Feb 2020 02:22:25 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id s23sm2370339wra.15.2020.02.19.02.22.24
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 19 Feb 2020 02:22:25 -0800 (PST)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Wed, 19 Feb 2020 11:21:16 +0100
Message-Id: <20200219102122.1607365-47-daniel.vetter@ffwll.ch>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20200219102122.1607365-1-daniel.vetter@ffwll.ch>
References: <20200219102122.1607365-1-daniel.vetter@ffwll.ch>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 46/52] drm/gm12u320: Simplify upload work

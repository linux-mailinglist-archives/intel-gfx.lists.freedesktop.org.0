...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 194C23B2934
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:30:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5882E6EACE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 20/27] drm/sun4i: Don't set struct

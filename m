...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2E92787916
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Aug 2023 22:07:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA95110E136;
	Thu, 24 Aug 2023 20:07:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3FFB510E5B6
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=Imkm3d8jczZDkfKfh+4GsURnGCIhqXfTc3zKb7vdQQ7zHWU60WFBZQQc
 5RoriBoQOA5Qk7dW8HXNNi8dRXkUUAZmG3vIK6tSp8ox39KlU6m5cEOmf
 AMOxWA6B87J30qQqOPvJWuZUY/5YTONMx3QwFPdqbpHKCZwwyuSga9gx2
 hOvajKUerDbBPZ+MOiwNJYBtQznIjDaN5bGQheXcmeyj7khY9mkqV9n8/
 jjGm/qds4oGT2YxWKm6URnfwIKweCoZHCEp5lsAiqNyNOfaVqdqeAMW++
 FMWg5Q4CgZpnG3of7ugbRYT9uz8YFbwI5OA6L8I5njc/Lu8TXMQVLO1Os A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10812"; a="354076121"
X-IronPort-AV: E=Sophos;i="6.02,195,1688454000"; d="scan'208";a="354076121"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2023 13:07:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10812"; a="827304305"
X-IronPort-AV: E=Sophos;i="6.02,195,1688454000"; d="scan'208";a="827304305"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Aug 2023 13:07:47 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 24 Aug 2023 12:57:06 -0700
Message-Id: <20230824195707.2126899-2-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH dii-client v3 1/2] drm/i915: Add WABB blit for

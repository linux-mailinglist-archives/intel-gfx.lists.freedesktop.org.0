...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B8A43F29D3
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Aug 2021 12:04:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B861C6EA55;
...
Subject: [Intel-gfx] [PATCH v4 3/5] drm: lock drm_global_mutex earlier in
 the ioctl handler

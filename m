...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB2DD70F27C
	for <lists+intel-gfx@lfdr.de>; Wed, 24 May 2023 11:22:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B2BAD10E640;
...
Subject: [Intel-gfx] [PATCH v4 10/13] drm/tegra: Use regular fbdev I/O
 helpers

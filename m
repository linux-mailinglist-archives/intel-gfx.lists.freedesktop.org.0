...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E95523DC86F
	for <lists+intel-gfx@lfdr.de>; Sat, 31 Jul 2021 23:43:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0167A6E916;
...
Subject: [Intel-gfx] [PATCH v4 6/7] drm/print: add choice to use dynamic
 debug in drm-debug

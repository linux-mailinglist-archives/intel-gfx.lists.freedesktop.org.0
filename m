...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 249D09CA1D
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Aug 2019 09:23:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 51E656E1D7;
	Mon, 26 Aug 2019 07:23:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CAC706E194
 for <intel-gfx@lists.freedesktop.org>; Mon, 26 Aug 2019 07:22:15 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18262692-1500050 
 for multiple; Mon, 26 Aug 2019 08:21:54 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 26 Aug 2019 08:21:38 +0100
Message-Id: <20190826072149.9447-17-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/28] drm/i915: Coordinate i915_active with its
 own mutex
...
ZWxfZnJvbnRidWZmZXIuYwppbmRleCA2NDI4YjhkZDcwZDMuLjg0YjE2NGYzMTg5NSAxMDA2NDQK
...
MjU3LDcgKzI1Nyw3IEBAIGludGVsX2Zyb250YnVmZmVyX2dldChzdHJ1Y3QgZHJtX2k5MTVfZ2Vt
...
YwppbmRleCBlOTAzZjBkOTkzZmQuLjkwYWVkNGQxNjNiMyAxMDA2NDQKLS0tIGEvZHJpdmVycy9n
cHUvZHJtL2k5MTUvZ2VtL2k5MTVfZ2VtX2NvbnRleHQuYworKysgYi9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9nZW0vaTkxNV9nZW1fY29udGV4dC5jCkBAIC04NjksMjAgKzg2OSwxOCBAQCBzdGF0aWMg
...
cmVlKGNiKTsKQEAgLTkxNCw3ICs5MTIsOSBAQCBzdGF0aWMgaW50IGNvbnRleHRfYmFycmllcl90
...

...
cy9ncHUvZHJtL2k5MTUvZ2VtL2k5MTVfZ2VtX29iamVjdF90eXBlcy5oCmluZGV4IGIwNTUwNzI3
ZTY5YS4uMDNlMWUzMjA2YWIzIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9nZW0v
...
aTkxNV9nZW0uYwppbmRleCBlMzA1NDJlNTQwOGQuLmFjODYxNjM4MmM2OSAxMDA2NDQKLS0tIGEv
ZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9nZW0uYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkx
NS9pOTE1X2dlbS5jCkBAIC04OTQsMjggKzg5NCwzOCBAQCB3YWl0X2Zvcl90aW1lbGluZXMoc3Ry
...

...
LTE4NjcsNyArMTg2Niw3IEBAIHN0YXRpYyBzdHJ1Y3QgaTkxNV92bWEgKnBkX3ZtYV9jcmVhdGUo
...

...
dm1hLT5hY3RpdmUpKSB7CiAJCWtmcmVlKGMpOwogCQlyZXR1cm4gbmV4dDsKIAl9CkBAIC0xNDMy
LDcgKzE0MzIsNyBAQCBnZW1fcmVjb3JkX3JpbmdzKHN0cnVjdCBpOTE1X2dwdV9zdGF0ZSAqZXJy
...
dmVycy9ncHUvZHJtL2k5MTUvaTkxNV9yZXF1ZXN0LmMKaW5kZXggNzU0YTc4MzY0YTYzLi40ZWNm
YWUxNDMyNzYgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfcmVxdWVzdC5j
CisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfcmVxdWVzdC5jCkBAIC0xOTcsOSArMTk3
...
KCFpOTE1X3JlcXVlc3RfY29tcGxldGVkKHJxKSkKIAkJcmV0dXJuIGZhbHNlOwogCkBAIC0yMjMs
MzUgKzIyMiw2IEBAIHN0YXRpYyBib29sIGk5MTVfcmVxdWVzdF9yZXRpcmUoc3RydWN0IGk5MTVf
...
QEAgLTY2NCw3ICs2MzQsNiBAQCBfX2k5MTVfcmVxdWVzdF9jcmVhdGUoc3RydWN0IGludGVsX2Nv
...
CUlOSVRfTElTVF9IRUFEKCZycS0+ZXhlY3V0ZV9jYik7CiAKIAkvKgpAQCAtNzAzLDcgKzY3Miw2
...
dF9lbXB0eSgmcnEtPnNjaGVkLndhaXRlcnNfbGlzdCkpOwogCkBAIC0xMDk2LDggKzEwNjQsOCBA
...
dWJtaXQsCkBAIC0xMTIyLDcgKzEwOTAsNiBAQCBfX2k5MTVfcmVxdWVzdF9hZGRfdG9fdGltZWxp
...
NS9pOTE1X3ZtYS5jIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV92bWEuYwppbmRleCA3MzBj
MDFjZmEzNmYuLjg1MmE4MzEzYzhjNyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUv
...


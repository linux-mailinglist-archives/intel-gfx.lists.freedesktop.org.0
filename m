...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C46B64F98EF
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Apr 2022 17:03:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A31B10E30E;
...
Subject: Re: [Intel-gfx] [PATCH 3/3] drm/amd/display: Move connector debugfs
 to drm

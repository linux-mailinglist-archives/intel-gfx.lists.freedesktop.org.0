...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A16E55108B7
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Apr 2022 21:11:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B245310E48C;
	Tue, 26 Apr 2022 19:11:23 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 06/19] drm/edid: clean up cea_db_is_*()
 functions

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 611E650EB2C
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Apr 2022 23:13:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A04D010E327;
...
Subject: [Intel-gfx] [PATCH v2 1/3] topic/core-for-CI: Revert DG2 and ATS-M
 device IDs

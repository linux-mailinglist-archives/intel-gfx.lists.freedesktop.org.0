...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C4498546A07
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 18:00:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7DEA610F71B;
...
Subject: [Intel-gfx] [PATCH v7] drm/i915/display: disable HPD workers before

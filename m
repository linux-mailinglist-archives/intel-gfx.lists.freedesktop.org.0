...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F2F0C4ED82
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Nov 2025 16:48:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4193A10E5FA;
	Tue, 11 Nov 2025 15:48:39 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="R/AJVd6x";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CE79B10E343;
 Tue, 11 Nov 2025 15:48:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1762876117; x=1794412117;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=CbpqNAVHnWxOyT0+VFB+OZAKKcTz1My2FECAzp66hks=;
 b=R/AJVd6xxbBXkwBLiqclv3rJS2a6bwkpz/rnav+3I0PhNSwxxka4s2kW
 ReZIwkngXvawfor7tx0U8PnRhrX0Hh722ynIA/GrphbXGlGFyAPt8yuma
 gAHPDMi/+mr0RqsPOZHiZicH0tQuATDhD4vzUXRV1dIuF3d1btg2EbXP+
 vnvHnq6IhnLAx/iC1PkZYZG71Oj2GBqiDlvq6hg67upzQtluWVJlO9hkH
 ss+aaRCt4v2thvWgOWXdUBoZy37rWUtcLgEtKpBNv1hu475QQlOtSNU4a
 iPCkXupiR8mJvD2BTSpuGxP9p4M0CDOTiHlQj89rITeMINK7lKyIwFReU A==;
X-CSE-ConnectionGUID: WmY1PrjoSke95WuU2ddomA==
X-CSE-MsgGUID: gcFxP4eMRk6OhfD54IGhtQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11610"; a="64978533"
X-IronPort-AV: E=Sophos;i="6.19,296,1754982000"; d="scan'208";a="64978533"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2025 07:48:35 -0800
X-CSE-ConnectionGUID: KfowMALoS4m5ADJbeNM98g==
X-CSE-MsgGUID: 9vMKywFgRQuWsaQorq+3BQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,296,1754982000"; d="scan'208";a="188636662"
Received: from bjrankin-mobl3.amr.corp.intel.com (HELO localhost)
 ([10.124.223.47])
 by fmviesa007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2025 07:48:34 -0800
Date: Tue, 11 Nov 2025 17:48:31 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jani Nikula <jani.nikula@intel.com>
Cc: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org
Subject: Re: [PATCH v2 1/3] drm/{i915,xe}/display: duplicate gen2 irq/error
 init/reset in display irq
Message-ID: <aRNaz6blAVHCPlgS@intel.com>
References: <cover.1762846363.git.jani.nikula@intel.com>
 <cf235460bbb11bde65cca4e65b7d6904adfe146c.1762846363.git.jani.nikula@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1C2B3B9773
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jul 2021 22:26:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B7E56EC00;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 20/53] drm/i915/xehpsdv: Define steering tables

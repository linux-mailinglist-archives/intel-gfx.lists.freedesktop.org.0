...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC9A885D7D3
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Feb 2024 13:20:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DB7710E71E;
	Wed, 21 Feb 2024 12:20:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="YbLn2rtN";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7029110E720
 for <intel-gfx@lists.freedesktop.org>; Wed, 21 Feb 2024 12:20:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1708518024; x=1740054024;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=BQ/eRLgSchQT12BmgqlLX+MFPTfIGvn7NMF6EVApFNo=;
 b=YbLn2rtNj0M+MNa+Tb2iwYoqXSKqiNUVjg9E7q7DF/YaMzTZgAhyeQKr
 k2wlgQegC8/rsmXhwTK7VvXXK3JMHeX5nwNFkrZUyliJSeF/cQRj0nNpQ
 TAESeRqg62bOC9d1muX8vacfL7NJOVul3Hvc2lm+VxhBGqDR4zVbDou1e
 8JQASBSq0O/+QZQ2YGtQKEczyqWnXVVZw1xjIohYZc93vPpuU9LCCROgP
 P2DTW73NaB1Jvk3O2rHL4W2ImV1JQj5GOpnCf3mrA0fGkPIl0oYOLsmua
 1phuK40UMW+lIsnDZdetVhjzEPYEUD8otVV6YT/chJdtrZfutCsmiAlsX w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10990"; a="6488811"
X-IronPort-AV: E=Sophos;i="6.06,175,1705392000"; 
   d="scan'208";a="6488811"
Received: from orviesa007.jf.intel.com ([10.64.159.147])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Feb 2024 04:20:24 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,175,1705392000"; 
   d="scan'208";a="5426137"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by orviesa007.jf.intel.com with ESMTP; 21 Feb 2024 04:20:21 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: ankit.k.nautiyal@intel.com,
 Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
Subject: [PATCH 5/6] drm/i915/display: Compute vrr_vsync params
Date: Wed, 21 Feb 2024 17:43:20 +0530
Message-Id: <20240221121321.2213128-6-mitulkumar.ajitkumar.golani@intel.com>

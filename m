...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 54E98C24940
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Oct 2025 11:48:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C622310EB60;
	Fri, 31 Oct 2025 10:48:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AfD8ayww";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9098810EB59;
 Fri, 31 Oct 2025 10:47:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761907676; x=1793443676;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=obaCEmc5n9xqTdoE7/a5rPu5RAzK4fpYKz0tOSthd54=;
 b=AfD8aywwASUnPQn80+US5VkT38JGM6mRukS+58lFE56/utrSNA7ER11X
 1HTMMaW1fXkFNZqETRAcBABEMzg8WeMsSSSuyvog/2Eugjgkgl3Kva5uN
 0j4C4kBFK6/HzQG2DsFuP4Bgp7ziFKvGLiBLpVh0KYU/mwrnj0i0DUkvV
 3fLj3Blm44IDexZ+Kl7UkqjAHoN6WIH4JukYaR9zOPuvTROePT4BxMPRm
 ARNciepnXOeNXLbHs01pISyQ0S1mb11AAljdoqDh07Vkx/RvL3S9gpNOw
 U1hrlhY+rJf09eBhJJ2BXPAQ5PucAKySP2bBJTbYRBmiFP2wlm2Dietku Q==;
X-CSE-ConnectionGUID: xrooWw/jT4qP3UWHCfw19Q==
X-CSE-MsgGUID: L+UUXun0SbGR+lDaUrDWjg==
X-IronPort-AV: E=McAfee;i="6800,10657,11598"; a="64217562"
X-IronPort-AV: E=Sophos;i="6.19,269,1754982000"; d="scan'208";a="64217562"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 03:47:56 -0700
X-CSE-ConnectionGUID: a2PadOMtSfuLixWLyM/8xQ==
X-CSE-MsgGUID: pS1nt2rRTCSdGExTlYZaMw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,269,1754982000"; d="scan'208";a="223441353"
Received: from display-adls.igk.intel.com ([10.211.131.198])
 by orviesa001.jf.intel.com with ESMTP; 31 Oct 2025 03:47:55 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: Imre Deak <imre.deak@intel.com>,
	Mika Kahola <mika.kahola@intel.com>
Subject: [CI 11/32] drm/i915/display: Determine Cx0 PLL DP mode from PLL state
Date: Fri, 31 Oct 2025 12:35:28 +0200
Message-Id: <20251031103549.173208-12-mika.kahola@intel.com>

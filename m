...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CD230342A97
	for <lists+intel-gfx@lfdr.de>; Sat, 20 Mar 2021 05:43:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5110B6EB36;
	Sat, 20 Mar 2021 04:42:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0045F6EB30
 for <intel-gfx@lists.freedesktop.org>; Sat, 20 Mar 2021 04:42:56 +0000 (UTC)
IronPort-SDR: lmSr4NbtzDztlNLBGI0BGWD2dzW0E9e3Rlk80bwyxS21ixU0+EkGK+Q4irXLlNOnh1IcLNt5BB
 af/AfGEir83Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9928"; a="275080364"
X-IronPort-AV: E=Sophos;i="5.81,263,1610438400"; d="scan'208";a="275080364"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Mar 2021 21:42:56 -0700
IronPort-SDR: j1kY/1IyBdQNqMZ34TtK1e3MjR4nhefk7fJTpBVCVGuD4UliMkkOI6/2SlE5sKIHeXuf3qJPFW
 hDRddqpdASWA==
X-IronPort-AV: E=Sophos;i="5.81,263,1610438400"; d="scan'208";a="440326963"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.168])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Mar 2021 21:42:56 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 19 Mar 2021 21:42:44 -0700
Message-Id: <20210320044245.3920043-6-matthew.d.roper@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/6] drm/i915: Convert INTEL_GEN() to
...
index 44aed4cbf894..e7850029776e 100644

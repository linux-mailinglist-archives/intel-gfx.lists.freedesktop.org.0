...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB2DF5214C8
	for <lists+intel-gfx@lfdr.de>; Tue, 10 May 2022 14:04:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6854D10E814;
...
Subject: Re: [Intel-gfx] [PATCH v2 24/25] drm/displayid: convert to drm_edid

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C866D7908AA
	for <lists+intel-gfx@lfdr.de>; Sat,  2 Sep 2023 18:22:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1DFD510E242;
...
Subject: [Intel-gfx] [REGRESSION] Panic in gen8_ggtt_insert_entries() with
 v6.5

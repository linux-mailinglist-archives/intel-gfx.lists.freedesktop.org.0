...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 24E23512375
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Apr 2022 22:04:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43AAA10E521;
	Wed, 27 Apr 2022 20:04:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 55B2A10E539
 for <intel-gfx@lists.freedesktop.org>; Wed, 27 Apr 2022 20:04:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1651089887;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=/AE6j2Z/VdUQtMtfyLiPPrZMPCCO8jp5Oj+E1IX+QYM=;
 b=PfBPzXUVNrumFp8xSvgKZsFpUWboTiWvIGf6SPdiONrgCqNYR/OkBlg7k9ZxBxtAt+6U6u
 GbYssdv/S+jbSCwcRVWo1eU4PPyVDWpQBSVFu+6OFtDShswo/vrXZISh3mqrrvBdt1FV5u
 8CnusXmqF20BUuyBaTq6c3GFUjukjZc=
...
Subject: [Intel-gfx] [RFC PATCH v3 12/19] KVM: x86: nSVM: make nested AVIC
 physid write tracking be aware of the host scheduling

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C05E7B210D
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Sep 2023 17:22:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03F5710E67D;
...
Subject: [Intel-gfx] [PATCH 04/15] tty: Remove now superfluous sentinel

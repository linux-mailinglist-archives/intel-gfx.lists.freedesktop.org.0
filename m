...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A7C187506
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 11:16:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 183416ED52;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 7cZw==
Subject: [Intel-gfx] [PATCH 21/34] fs/exec.c: convert put_page() to
 put_user_page*()

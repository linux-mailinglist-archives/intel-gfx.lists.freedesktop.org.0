...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AD8BB50127
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jun 2019 07:43:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4A5B8990D;
	Mon, 24 Jun 2019 05:43:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7E8E4898D9
 for <intel-gfx@lists.freedesktop.org>; Mon, 24 Jun 2019 05:43:36 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17000419-1500050 
 for multiple; Mon, 24 Jun 2019 06:43:21 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 24 Jun 2019 06:43:12 +0100
Message-Id: <20190624054315.18910-16-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 16/19] drm/i915/gt: Always call kref_init for
 the timeline
...
bmRleCBkMDU4NzVmZjIwNzEuLjAzMGJjZDIyNDllOSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUv

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 701233FE6E9
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Sep 2021 02:53:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D11A6E466;
...
Subject: [Intel-gfx] [PATCH v5 22/25] drm/i915/guc: Move GuC priority fields

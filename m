...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D17C75288A
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jul 2023 18:37:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3E5C10E71E;
...
Subject: [Intel-gfx] [PATCH v4 01/21] drm: use correct ccflags-y syntax

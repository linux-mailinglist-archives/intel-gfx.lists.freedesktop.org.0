...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 40E85128291
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Dec 2019 20:03:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B18E96EC97;
	Fri, 20 Dec 2019 19:03:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5BEF96EC97
 for <intel-gfx@lists.freedesktop.org>; Fri, 20 Dec 2019 19:03:56 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 20 Dec 2019 11:03:55 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,336,1571727600"; d="scan'208";a="213649550"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO intel.com) ([10.54.75.49])
 by fmsmga008.fm.intel.com with ESMTP; 20 Dec 2019 11:03:54 -0800
Date: Fri, 20 Dec 2019 11:05:31 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20191220190531.GA1329@intel.com>
References: <20191219215117.929-1-manasi.d.navare@intel.com>
 <20191220184112.GZ1208@intel.com>
MIME-Version: 1.0
...
> > @@ -13910,18 +13910,6 @@ static void intel_crtc_check_fastset(const str=
...
tate,
> > @@ -14032,6 +14020,105 @@ static int intel_atomic_check_crtcs(struct in=
...
And then if the crtcs in state are in sync mode and their cpu_trans matches=
 the master trans
...
> > +
> > +static int
> > +intel_dp_modeset_all_tiles(struct intel_atomic_state *state, int tile_=
grp_id)
> > +{
...
> >   * @dev: drm device
> > @@ -14059,6 +14146,12 @@ static int intel_atomic_check(struct drm_devic=
e *dev,
> >  	if (ret)
> >  		goto fail;
> >  =
...
Well we do need this for handling the hotplug cases correctly so that the c=
...
> > @@ -14089,6 +14182,32 @@ static int intel_atomic_check(struct drm_devic=
e *dev,
> >  			any_ms =3D true;
> >  	}
> >  =

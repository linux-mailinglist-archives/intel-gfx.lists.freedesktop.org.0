...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC14B4FBEBB
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:15:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECE2A10EDD7;
	Mon, 11 Apr 2022 14:15:48 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 33/34] vfio/mdev: Use the driver core to create
 the 'remove' file

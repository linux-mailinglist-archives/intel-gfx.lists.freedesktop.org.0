...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21F6F2B1BD6
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Nov 2020 14:25:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E4B06E4CB;
	Fri, 13 Nov 2020 13:25:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 223CC6E4D7
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Nov 2020 13:25:28 +0000 (UTC)
IronPort-SDR: RS+Lr0t/8IaJ+JjrrLvtUtPJ3OAEtr2WfYluhLtifjBGiFjEw75i8AbbZtCdBPPsARFaqjF0of
 YfQtE5CzX41A==
X-IronPort-AV: E=McAfee;i="6000,8403,9803"; a="169687472"
X-IronPort-AV: E=Sophos;i="5.77,475,1596524400"; d="scan'208";a="169687472"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Nov 2020 05:25:27 -0800
IronPort-SDR: EW7wwJn/2mWnnYp+7AXU9wdx+my6K7dmxTNKlzAEWZSl3afEe8vwwjSZrBgQV/oFu8OvX184UF
 wuwaI9wS9tsw==
X-IronPort-AV: E=Sophos;i="5.77,475,1596524400"; d="scan'208";a="323989201"
Received: from rbrenna-mobl.ger.corp.intel.com (HELO localhost)
 ([10.251.81.159])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Nov 2020 05:25:24 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 13 Nov 2020 15:24:38 +0200
Message-Id: <e056025a8166c1d2a3b69dac76a2e0739b303f3a.1605273766.git.jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <cover.1605273766.git.jani.nikula@intel.com>
References: <cover.1605273766.git.jani.nikula@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 8/9] drm/i915/irq: replace

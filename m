...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5274D570BB8
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:27:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D81691015;
...
Subject: [Intel-gfx] [PATCH 04/32] drm/i915: gvt: fix kernel-doc trivial
 warnings

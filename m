...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 18C035A367F
	for <lists+intel-gfx@lfdr.de>; Sat, 27 Aug 2022 11:50:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 60F9310EBA1;
...
Subject: [Intel-gfx] [PATCH 03/15] vfio/mlx5: Use the new device life cycle
 helpers

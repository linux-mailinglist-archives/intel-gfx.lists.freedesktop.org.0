...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7AE54CEE62
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Mar 2022 00:22:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF1AE10E058;
...
Subject: [Intel-gfx] [PATCH v7 0/2] GuC HWCONFIG with documentation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CB3EEB05463
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Jul 2025 10:14:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D358E10E576;
	Tue, 15 Jul 2025 08:14:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="DvyvG3M7";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="ariVvIs/";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="DvyvG3M7";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="ariVvIs/";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5BCEE10E56A
 for <intel-gfx@lists.freedesktop.org>; Tue, 15 Jul 2025 08:14:41 +0000 (UTC)
Received: from imap1.dmz-prg2.suse.org (unknown [10.150.64.97])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-out2.suse.de (Postfix) with ESMTPS id 16B341F7A1;
 Tue, 15 Jul 2025 08:14:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1752567274; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=csDCx/d8uPhDVjTf34nqbZcsH0a8KwfROhpv/JcVw5Y=;
 b=DvyvG3M7cMDZgTi/iEI0gqptLtY09za11wr+2sFhrdFl6xu95v/m6k1jSaxr0ZHNZ9fx9q
 CXybcUA/rW90dtrfrkQpd71+BVvq1InfzvCHz0pr2w8z/Z/MBAFtzML0fZV1UhQvMEnk8B
 Hqw/suZi0MPDSALgCpsBi4SW0yfYuEQ=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 s=susede2_ed25519; t=1752567274;
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=csDCx/d8uPhDVjTf34nqbZcsH0a8KwfROhpv/JcVw5Y=;
 b=ariVvIs/RgczUBcnpAv66udIRMDYHhiAxzA9O2Y9EXATzRVf05vcmCBnjOUn6F+CV6qWds
 /Yo9hviIWwjDYkCg==
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 84B9713A6C;
 Tue, 15 Jul 2025 08:14:33 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id qIs5H+kNdmgJUAAAD6G6ig
 (envelope-from <tzimmermann@suse.de>); Tue, 15 Jul 2025 08:14:33 +0000
...
Subject: [PATCH v2 5/7] Revert "drm/gem-framebuffer: Use dma_buf from GEM
 object instance"
Date: Tue, 15 Jul 2025 10:07:56 +0200
Message-ID: <20250715081121.34473-6-tzimmermann@suse.de>

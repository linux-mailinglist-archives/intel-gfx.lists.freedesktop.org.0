...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BC7628941B
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Oct 2020 21:53:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A02646EE00;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH RFC PKS/PMEM 47/58] drivers/mtd: Utilize new
 kmap_thread()

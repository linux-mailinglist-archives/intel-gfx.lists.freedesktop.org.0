...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WP3GM15kwWmaSgQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2026 17:03:42 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 55DCA2F75C8
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2026 17:03:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 98EF610E507;
	Mon, 23 Mar 2026 16:03:31 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=permerror (0-bit key) header.d=gmail.com header.i=@gmail.com header.b="ObfxuFVU";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-oi1-f170.google.com (mail-oi1-f170.google.com
 [209.85.167.170])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8F3C210EC04
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Mar 2026 13:23:45 +0000 (UTC)
Received: by mail-oi1-f170.google.com with SMTP id
 5614622812f47-4671cbce2feso975491b6e.3
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Mar 2026 06:23:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1773408225; x=1774013025; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=lB762FeEpTmiwe79svqmrJe7D/XsTTkp/IbU6vqNYr8=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20251104; t=1773408225; x=1774013025;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-gg:x-gm-message-state:from
 :to:cc:subject:date:message-id:reply-to;
 bh=lB762FeEpTmiwe79svqmrJe7D/XsTTkp/IbU6vqNYr8=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCUvv9/JFet6fpRjpCdgVrPmg1OE+2oc/Lx6ezgaWcVnMKreN64z/Gir1+h1On3Yb0udgVAREB5t2ZQ=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YxhnR6cWNrIBYJMqgl3KcDW9C93sI6aMmIHwOJ2SZbO9cmznZaz
 F74cAYD18gjN8Oh0wsNo9D7GPiKARUjKP1cT+rFsbBz5SkVk3V5zkEJF
X-Gm-Gg: 
X-Received: by 2002:a05:6808:1b14:b0:464:bb83:2761 with SMTP id
 5614622812f47-4675755e8e0mr1657630b6e.53.1773408224314; 
 Fri, 13 Mar 2026 06:23:44 -0700 (PDT)
Received: from frodo (c-98-38-17-99.hsd1.co.comcast.net. [98.38.17.99])
 by smtp.googlemail.com with ESMTPSA id
 5614622812f47-4673434a35csm4795987b6e.20.2026.03.13.06.23.42
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 13 Mar 2026 06:23:43 -0700 (PDT)
From: Jim Cromie <jim.cromie@gmail.com>
To: airlied@gmail.com, simona@ffwll.ch, jbaron@akamai.com,
 gregkh@linuxfoundation.org, Arnd Bergmann <arnd@arndb.de>,
 Jim Cromie <jim.cromie@gmail.com>, Luis Chamberlain <mcgrof@kernel.org>,
...
Subject: [PATCH v11 22/65] dyndbg-API: replace DECLARE_DYNDBG_CLASSMAP
Date: Fri, 13 Mar 2026 07:19:47 -0600
Message-ID: <20260313132103.2529746-23-jim.cromie@gmail.com>
...
X-Spamd-Result: default: False [2.49 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	FORGED_RECIPIENTS(0.00)[m:airlied@gmail.com,m:simona@ffwll.ch,m:jbaron@akamai.com,m:gregkh@linuxfoundation.org,m:arnd@arndb.de,m:jim.cromie@gmail.com,m:mcgrof@kernel.org,m:petr.pavlu@suse.com,m:da.gomez@kernel.org,m:samitolvanen@google.com,m:atomlin@atomlin.com,m:akpm@linux-foundation.org,m:linux-kernel@vger.kernel.org,m:linux-arch@vger.kernel.org,m:linux-modules@vger.kernel.org,m:mripard@kernel.org,m:tzimmermann@suse.de,m:maarten.lankhorst@linux.intel.com,m:jani.nikula@intel.com,m:ville.syrjala@linux.intel.com,m:christian.koenig@amd.com,m:matthew.auld@intel.com,m:arunpravin.paneerselvam@amd.com,m:louis.chauvet@bootlin.com,m:skhan@linuxfoundation.org,m:pmladek@suse.com,m:ukaszb@chromium.org,m:dri-devel@lists.freedesktop.org,m:amd-gfx@lists.freedesktop.org,m:linux-doc@vger.kernel.org,m:jimcromie@gmail.com,s:lists@lfdr.de];
	RCVD_TLS_LAST(0.00)[];

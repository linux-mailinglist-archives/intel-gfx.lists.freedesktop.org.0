...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1012542734F
	for <lists+intel-gfx@lfdr.de>; Fri,  8 Oct 2021 23:57:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBA9989C96;
...
Subject: [Intel-gfx] [PATCH 03/11] drm/i915: Restructure probe to handle

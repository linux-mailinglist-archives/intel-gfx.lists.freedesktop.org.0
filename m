...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 849BE5796E0
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Jul 2022 11:57:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D961C14B268;
...
Subject: [Intel-gfx] [PATCH v3 1/3] drm: New function to get luminance range
 based on static hdr metadata

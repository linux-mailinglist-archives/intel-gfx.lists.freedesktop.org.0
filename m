...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DE041E7715
	for <lists+intel-gfx@lfdr.de>; Fri, 29 May 2020 09:41:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 641196E877;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 02/13] cdrom: use new sysctl subdir helper

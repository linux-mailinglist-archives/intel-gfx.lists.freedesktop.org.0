...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 125E61688D7
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Feb 2020 22:05:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8CE826F549;
	Fri, 21 Feb 2020 21:04:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-x342.google.com (mail-wm1-x342.google.com
 [IPv6:2a00:1450:4864:20::342])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6153D6F540
 for <intel-gfx@lists.freedesktop.org>; Fri, 21 Feb 2020 21:04:35 +0000 (UTC)
Received: by mail-wm1-x342.google.com with SMTP id n3so3158952wmk.4
 for <intel-gfx@lists.freedesktop.org>; Fri, 21 Feb 2020 13:04:35 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=kYuk+RSrdYyx2ljfwFAYxRxEX1ztQoc/OhndA32oasM=;
 b=dhvcPMrC/xyaBwJ+yxT7T2PgYVzYs4cp5OJLs3GPYuIllzSCkoQsU1bAgXVdnTwi4b
 NS6YXto+khZLrcx4KfKYgB5MDdrbZE+kLO/J1KoaqH9v1rWLx5221UIK9o96rxN6b2fJ
 vVMvmkVV0HDedlkKK8JslYwpCvyrymPA67lWE=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=kYuk+RSrdYyx2ljfwFAYxRxEX1ztQoc/OhndA32oasM=;
 b=
X-Gm-Message-State: APjAAAVe87h+Bwm3Fit5dAxUCiudQISv5wu2BAEZ+nfFjZORlU2N3Up6
 m02pTWTecds5cq/l9indpYI/HQ==
X-Google-Smtp-Source: APXvYqzzvwMrvV4MnmTHhKjBosn4QYnBBYlCAvOcvwAqLtnNvL5b3TJQJimrQ/qHjJAWIcaBYfCorw==
X-Received: by 2002:a1c:1984:: with SMTP id 126mr5908562wmz.78.1582319073983; 
 Fri, 21 Feb 2020 13:04:33 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id z6sm5483930wrw.36.2020.02.21.13.04.32
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 21 Feb 2020 13:04:33 -0800 (PST)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Fri, 21 Feb 2020 22:03:19 +0100
Message-Id: <20200221210319.2245170-52-daniel.vetter@ffwll.ch>
...
index 684f884b6cea..38b043bbb39b 100644

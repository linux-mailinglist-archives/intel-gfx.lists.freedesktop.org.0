...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C9F13D02F3
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Jul 2021 22:41:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFE236E57A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 23/42] drm/i915/guc: Implement multi-lrc
 submission

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C25716A5913
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Feb 2023 13:33:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3392C10E1F6;
	Tue, 28 Feb 2023 12:33:04 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 11/19] vfio-iommufd: Add detach_ioas

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 58C7B4A6704
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Feb 2022 22:25:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D52D10E20C;
	Tue,  1 Feb 2022 21:25:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 75E9989D67;
 Tue,  1 Feb 2022 21:25:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643750707; x=1675286707;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=q5o4m4jIzqrT0sTRI30b9+k7eqGGqCGl6V3XQwGhPlA=;
 b=mMi0aod57OZkhAUCqaIYGopUCK2HJkyeVNSO6eWFmURguiGRUGgqN0fI
 0o/upUUHF0cr+FzpNfFnUVLjSzuVWTh3HOEzVW1lzcr7NHdKbQzuHRiFf
 LCSy9AJjDOrxcABUuiPaHQ+RXRTfUbLqFUY4FGUqDGzmAcJoWL+gUM1m/
 /3jqBiQF3P4/W3kt5+0xvW1FvKxMteS/8L7aKt0apG72taN72iTqpxzBw
 uvoG31PWe+y9AfVEjjR6bmubE5W9vGE2Mq2jLX2yNkneAyGk80kpBHMAF
 wf/I/L/enRZ00yvsRxZGz6LJVb9LF+BPzDUmKIwxfK2nqNOpcgUoAa6Fi g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10245"; a="235193200"
X-IronPort-AV: E=Sophos;i="5.88,334,1635231600"; d="scan'208";a="235193200"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2022 13:25:06 -0800
X-IronPort-AV: E=Sophos;i="5.88,334,1635231600"; d="scan'208";a="565736990"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Feb 2022 13:25:05 -0800
Date: Tue, 1 Feb 2022 13:25:02 -0800
From: Matt Roper <matthew.d.roper@intel.com>
To: Lucas De Marchi <lucas.demarchi@intel.com>
Message-ID: <YfmlLqDKK1HuYfxy@mdroper-desk1.amr.corp.intel.com>
References: <20220126093951.1470898-1-lucas.demarchi@intel.com>
 <20220126093951.1470898-4-lucas.demarchi@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20220126093951.1470898-4-lucas.demarchi@intel.com>
Subject: Re: [Intel-gfx] [PATCH v2 03/11] drm/i915: Use str_yes_no()
...
Cc: Emma Anholt <emma@anholt.net>, David Airlie <airlied@linux.ie>,
 ...
 Raju Rangoju <rajur@chelsio.com>, Steven Rostedt <rostedt@goodmis.org>,

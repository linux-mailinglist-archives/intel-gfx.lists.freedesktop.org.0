...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 499E239927B
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Jun 2021 20:23:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF4ED6ED10;
	Wed,  2 Jun 2021 18:23:24 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 15/17] drm/i915/pxp: Add plane decryption
 support
...
Cc: intel-gfx@lists.freedesktop.org, Huang Sean Z <sean.z.huang@intel.com>,
 dri-devel@lists.freedesktop.org, Gaurav Kumar <kumar.gaurav@intel.com>,
...
> @@ -383,6 +384,14 @@ intel_crtc_get_plane(struct intel_crtc *crtc, enum p=
lane_id plane_id)
>  	return NULL;
>  }
>  =
...
>  			     struct intel_plane *plane)
>  {
> @@ -397,6 +406,7 @@ int intel_plane_atomic_check(struct intel_atomic_stat=
e *state,
...
> @@ -413,6 +423,12 @@ int intel_plane_atomic_check(struct intel_atomic_sta=
te *state,
...
> @@ -9767,6 +9767,10 @@ static int intel_atomic_check_async(struct intel_a=
tomic_state *state)

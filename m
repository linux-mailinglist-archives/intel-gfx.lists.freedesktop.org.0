...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DAFD573A09
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 17:24:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D6CA9B09E;
...
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915/fbdev: suspend HPD before fbdev
 unregistration

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EBCA4C04AE
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Feb 2022 23:35:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 14C2410E5A8;
	Tue, 22 Feb 2022 22:35:40 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v10 4/6] drm/i915/gt: Re-work reset_csb

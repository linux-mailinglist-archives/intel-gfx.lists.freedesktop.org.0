...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 986912D2536
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Dec 2020 08:59:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6035B6E94E;
...
Subject: [Intel-gfx] [PATCH v4 16/16] drm/i915: Enable PCON configuration
 for Color Conversion for TGL

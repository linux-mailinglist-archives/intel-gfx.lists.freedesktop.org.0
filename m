...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 58193556EC2
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Jun 2022 01:01:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0DDC1134B9;
	Wed, 22 Jun 2022 23:00:56 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 1/2] agp/intel: Rename intel-gtt symbols

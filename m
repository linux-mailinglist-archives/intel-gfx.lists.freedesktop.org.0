...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 32AD83B005E
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Jun 2021 11:34:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 88D796E46B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 1/3] drm/i915: Update object placement flags
 to be mutable

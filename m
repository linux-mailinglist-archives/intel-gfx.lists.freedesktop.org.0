...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 45C1E4CC4C3
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Mar 2022 19:11:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 016C610E303;
...
Subject: [Intel-gfx] [PATCH v2 3/7] drm/i915: use the memcpy_from_wc call
 from the drm

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DC6C71A3A8
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 18:05:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E9E4410E588;
	Thu,  1 Jun 2023 16:05:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B479410E588
 for <intel-gfx@lists.freedesktop.org>; Thu,  1 Jun 2023 16:05:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685635514; x=1717171514;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=XPDwWIaXS7gitexGHnVtMNj92widGCCHY6N2HeSBtrA=;
 b=VUmyqUyVvcNzb4yDm2FKVArSwm6bPhBBHPeC85igRgupYK0tv4AEcVup
 sFCqRfUO5wPbdzOFqa/g1o87VJZWL4qGoTuC1/ngAkTEob9BMf8/hwzif
 p3Hsm11ZzOfxDZ3oCLH1GXoUiEI6JlRc27uLXlaoe29DnRysMy1kXVYiM
 jHJKMBk65f63Xo35ywWlE1Oq66rMRr2Zv3ZO+NARcGCb2MgS48+cQtT9Z
 ZuScdyOA+pxu2qYmYyAIvmKEHcjlsFjRGfGImWFEF+D/MhsyKXfAyXE9q
 cCnUycdCA203OQrnOcfVZEuLHNqBk5IPKVu9Gmb1t2J+8aGS3ujpjXCws A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10728"; a="358024936"
X-IronPort-AV: E=Sophos;i="6.00,210,1681196400"; d="scan'208";a="358024936"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2023 09:04:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10728"; a="701608542"
X-IronPort-AV: E=Sophos;i="6.00,210,1681196400"; d="scan'208";a="701608542"
Received: from unknown (HELO vgovind2-mobl3.fi.intel.com) ([10.237.66.43])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2023 09:04:17 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  1 Jun 2023 19:03:47 +0300
Message-Id: <20230601160350.43888-5-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 4/7] drm/i915: extract

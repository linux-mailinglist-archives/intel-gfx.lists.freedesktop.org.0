...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 121F25175D9
	for <lists+intel-gfx@lfdr.de>; Mon,  2 May 2022 19:31:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E59A710F293;
...
Subject: [Intel-gfx] [PATCH v3 4/7] vfio/mdev: Pass in a struct vfio_device
 * to vfio_dma_rw()

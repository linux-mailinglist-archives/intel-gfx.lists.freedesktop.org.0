...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D21C10D422
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Nov 2019 11:31:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D8A116E8C7;
	Fri, 29 Nov 2019 10:31:19 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 12/14] media: constify fb ops across all
 drivers

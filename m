...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 02D5B391A63
	for <lists+intel-gfx@lfdr.de>; Wed, 26 May 2021 16:37:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 72B886ED9E;
	Wed, 26 May 2021 14:37:20 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2FD206ED9B;
 Wed, 26 May 2021 14:37:18 +0000 (UTC)
IronPort-SDR: iaQqO2nvGBF+EHSgBBs9wi0/k3urErj1yGaIKdmgEbOOHYb1v3NrbTc8hHkqFLAcEMsK7JlRb3
 yL9zYTr3DISA==
X-IronPort-AV: E=McAfee;i="6200,9189,9996"; a="223666076"
X-IronPort-AV: E=Sophos;i="5.82,331,1613462400"; d="scan'208";a="223666076"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2021 07:37:18 -0700
IronPort-SDR: +E3EE9kX1I0gYmKgzZVmJ/HzPsltuJsp3KP2LHrBEd9+93wbYmCgH+UBVFqQKFQ2PyZ4uCw1LI
 QimWFk2wiuLQ==
X-IronPort-AV: E=Sophos;i="5.82,331,1613462400"; d="scan'208";a="476968617"
Received: from wardmich-mobl.ger.corp.intel.com (HELO tursulin-mobl2.home)
 ([10.213.209.181])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 May 2021 07:37:16 -0700
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed, 26 May 2021 15:37:11 +0100
Message-Id: <20210526143711.2349541-1-tvrtko.ursulin@linux.intel.com>
X-Mailer: git-send-email 2.30.2
In-Reply-To: <5aaf24d3-9171-ee1f-5b89-fd1a501afc01@intel.com>
References: <5aaf24d3-9171-ee1f-5b89-fd1a501afc01@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 12/12] drm/i915/gem: Manage all set-domain
 waits explicitly
...
index e937b6629019..6a5a7a7fbae2 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F0A414ACA29
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Feb 2022 21:11:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0AAD910F9AB;
...
Subject: [Intel-gfx] [PATCH v6 5/6] drm/i915/gt: replace cache_clflush_range

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FDB76EA940
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Apr 2023 13:35:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 72B5110EE01;
	Fri, 21 Apr 2023 11:35:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B337810EE00;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 SX3OVNkRQR7bewJLFB8iKrZNtPNqbXpXo4zXsQXEITN2z/RpWCBoIOU/x A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="432249950"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="432249950"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2023 04:35:40 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10686"; a="642489686"
X-IronPort-AV: E=Sophos;i="5.99,214,1677571200"; d="scan'208";a="642489686"
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH v7 6/7] drm/i915: Replace custom intel

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 75194A87C30
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Apr 2025 11:49:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9834C10E516;
	Mon, 14 Apr 2025 09:49:23 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Y9XPHfOe";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A6F9A10E516;
 Mon, 14 Apr 2025 09:49:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1744624162; x=1776160162;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ciby7S4K5tiBfPSBg+I9XMeCsqEGDlgG5DdkPfZhqGY=;
 b=Y9XPHfOeq4W6bADWhNtF+mkJ0t6tuooizsl7EE6if4BaVu3AKHl1mBfE
 qKAAZ+WfrVQUj13FhmZRo2Fi+374MBgprqDGHjYRQ921X6T+k6BxJoN3y
 +WzblM1kYUVDC4Wcy0BeunEJvlKGFYfSVrIn64vgOsprMfnQcLn1qeVJh
 W042NIesU5P8/hAb0pZ8GHIJ/zgrgYDuo70auaBQjBZN6qzhh58/igKWG
 AgSMdahzc+qG8DPHs6p+io5OQvkYORIO45kFY14MCUNxd5D83srsUgSBX
 b1zFaa5m3kYTrmmW7onaMed/aCDEM8lueN2rc8SgVXb9UcnDTVfckvMvV g==;
X-CSE-ConnectionGUID: kQGGEAvBQpS3Nfppjb82wg==
X-CSE-MsgGUID: V+m7YDxjQmiv9k7gsWlSBA==
X-IronPort-AV: E=McAfee;i="6700,10204,11402"; a="45222610"
X-IronPort-AV: E=Sophos;i="6.15,212,1739865600"; d="scan'208";a="45222610"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Apr 2025 02:49:21 -0700
X-CSE-ConnectionGUID: lyAGeSDtR02lWVx5lbOeFA==
X-CSE-MsgGUID: jAQ5oXuNQRC39sIEz22iAg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,212,1739865600"; d="scan'208";a="152954835"
...
Subject: [PATCH v8 01/12] mtd: core: always create master device
Date: Mon, 14 Apr 2025 12:37:52 +0300
Message-ID: <20250414093803.2133463-2-alexander.usyskin@intel.com>

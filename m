...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C45446F7B1
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Dec 2021 00:50:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC26C10E13C;
...
Subject: Re: [Intel-gfx] [PATCH v6 05/11] drm/i915/gem: Use to_gt() helper

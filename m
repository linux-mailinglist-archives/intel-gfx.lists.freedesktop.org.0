...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C10D19BD13
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Apr 2020 09:51:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 982B96E9FE;
	Thu,  2 Apr 2020 07:51:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 431116E9FE
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Apr 2020 07:51:41 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20772549-1500050 
 for multiple; Thu, 02 Apr 2020 08:50:57 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  2 Apr 2020 08:50:57 +0100
Message-Id: <20200402075057.19794-2-chris@chris-wilson.co.uk>
...
vm to all the vma we constructed. Although this may be described as a
userspace race, we have been tricked into using addresses in one VM with
another loaded, albeit both belong to the same user. Given the
constraint that we would only mix up user addresses within their own
ppGTT, could we regard this as a "safe" (from the perspective that no
cross-process or kernel information is leaked) user bug?
...
index 3479cda37fdc..ba24d67fb20d 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3135,7 +3135,7 @@ static int execlists_context_alloc(struct intel_context *ce)

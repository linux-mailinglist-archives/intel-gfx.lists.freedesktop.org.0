...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6662F4DE440
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Mar 2022 23:48:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8994D10E2F6;
	Fri, 18 Mar 2022 22:48:07 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5BD6710E2F6;
 Fri, 18 Mar 2022 22:48:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1647643686; x=1679179686;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+YkIJsNyhbfDvQb0HTJkVHt0ULbqBlwWHH5daHqoouY=;
 b=eNZbkL91MJoOt2/y5wfYPQeboQ9aSlnYZVETG07D6WWGV9eoOwkHD5aF
 41z/5vvDwvofhF3qs6kCVASzk6LoD1kyK8z8MwcZuQmmCzKOgaEIPGStN
 cofYwZrICVzDMjDiPl5gWj0PSwlqsgW6Kv7jpyEKdUFm4+Vo8KqD46tl/
 bWoAx4sFQ1YZYDO/eAV+LOEXCCSwXgLeXIs2fUpnDCRv76Tfa1P9K0+FH
 X4f2fp6xj44UD03we5LIxwUe1dNtx3Tr2o57c9JVhQlfuPFEmcWDbYQf3
 hB2qo4AEcN9FBZSEXjhEaruQPrf0rzJG6kZTaWjT0EOe7m7qqVpLHP+fZ A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10290"; a="244716443"
X-IronPort-AV: E=Sophos;i="5.90,192,1643702400"; d="scan'208";a="244716443"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Mar 2022 15:48:05 -0700
X-IronPort-AV: E=Sophos;i="5.90,192,1643702400"; d="scan'208";a="715685692"
Received: from mriahix-mobl2.ger.corp.intel.com (HELO intel.com)
 ([10.249.39.167])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Mar 2022 15:48:00 -0700
From: Andi Shyti <andi.shyti@linux.intel.com>
To: Intel GFX <intel-gfx@lists.freedesktop.org>,
 DRI Devel <dri-devel@lists.freedesktop.org>
Date: Sat, 19 Mar 2022 00:46:36 +0200
Message-Id: <20220318224640.61594-4-andi.shyti@linux.intel.com>

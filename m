...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3347D45390C
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Nov 2021 18:58:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DACBF6E0DF;
...
Subject: [Intel-gfx] [PATCH v3 2/5] drm/i915/dg2: Add Wa_14010547955

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF6B15FCF1C
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Oct 2022 02:02:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4B95810E278;
...
Subject: [Intel-gfx] [PATCH v2 3/7] drm/i915/uc: use different ggtt pin

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0026164117B
	for <lists+intel-gfx@lfdr.de>; Sat,  3 Dec 2022 00:26:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E22D210E73C;
	Fri,  2 Dec 2022 23:26:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E0BDE10E72C;
 Fri,  2 Dec 2022 23:26:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670023574; x=1701559574;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=chhbFvxn/7iHvolb5ADTVb5HUAvp2GkFMGKMubfC6Tk=;
 b=LdjzQEe+W/guAF4xal80G9C365RlUsGAJfAl18f4FIHuS8DDwmh+9V9H
 22qqQbbUnuB7gr78PpAVEcNEiq4jU1SmmV6RAhjegQvr4hTwtw6uQrlsK
 MS+WbCA1qwqoGJVZzeqYUo5uuwD1hGlf8/+0B3GY3ToC94PctaT03G/u2
 SqcQ+u6oSaHVg4rjlBmPVDrkIarjpTDysEdr1yM6PoHvKxnxtFL/M+KJT
 LymvP1Nto8CYsWeMUsBHvSR9QJROFvztnv3tw8OVtU2wVUGv3yATxXX82
 WcQNCCGGU9Yw8qn6vQrn70C7iYzYtg3HFRjv4RBo+UqsdJqLONbQBpGCE w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10549"; a="314773502"
X-IronPort-AV: E=Sophos;i="5.96,213,1665471600"; d="scan'208";a="314773502"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Dec 2022 15:25:53 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10549"; a="595609598"
X-IronPort-AV: E=Sophos;i="5.96,213,1665471600"; d="scan'208";a="595609598"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga003.jf.intel.com with ESMTP; 02 Dec 2022 15:25:52 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  2 Dec 2022 15:28:21 -0800
Message-Id: <20221202232821.4144884-1-alan.previn.teres.alexis@intel.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v8 1/1] drm/i915/pxp: Promote pxp subsystem to
 top-level of i915

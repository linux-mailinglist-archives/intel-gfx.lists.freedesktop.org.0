...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCD457322D6
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Jun 2023 00:43:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5FB2110E562;
...
Subject: [Intel-gfx] [PATCH] Remove incorrect hard coded cache coherrency
 setting

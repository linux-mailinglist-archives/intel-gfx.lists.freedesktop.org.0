...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B2A803B2908
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:29:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 620056EA73;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 06/27] drm/i915: Track IRQ state in local
 device state

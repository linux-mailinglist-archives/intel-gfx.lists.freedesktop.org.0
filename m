...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D5C836EFE2
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Apr 2021 21:03:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 79CE76F44C;
	Thu, 29 Apr 2021 19:03:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-pl1-x633.google.com (mail-pl1-x633.google.com
 [IPv6:2607:f8b0:4864:20::633])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C02F16F44C
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Apr 2021 19:03:46 +0000 (UTC)
Received: by mail-pl1-x633.google.com with SMTP id t21so4190369plo.2
 for <intel-gfx@lists.freedesktop.org>; Thu, 29 Apr 2021 12:03:46 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=I26nFk1GioOxpCA08KAlp5FxV9kKvoKs0psEEqnYpJ4=;
 b=
X-Gm-Message-State: AOAM531LBM5z27rYcIXC9iDl57F8DYu+QDegSNhZuGHcpPACZ1awMC5r
 ED+Pk605Yo9P/4V09eq4zeLP7JkhLuvMWQ==
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 00/25] drm/i915/gem: ioctl clean-ups (v4)

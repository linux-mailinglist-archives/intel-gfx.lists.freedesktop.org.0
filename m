...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A3913A8246
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Jun 2021 16:15:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC82D6E3EF;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 11/14] drm/i915/display: Add handling for new

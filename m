...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B24EE7F974
	for <lists+intel-gfx@lfdr.de>; Fri,  2 Aug 2019 15:28:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F0F66EE4C;
	Fri,  2 Aug 2019 13:28:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 705F66EE4C
 for <intel-gfx@lists.freedesktop.org>; Fri,  2 Aug 2019 13:28:45 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17817954-1500050 
 for multiple; Fri, 02 Aug 2019 14:28:37 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  2 Aug 2019 14:28:36 +0100
Message-Id: <20190802132836.6787-1-chris@chris-wilson.co.uk>
...
Yi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCmluZGV4IGU3NzlkYmEyZTVhMy4uZjg4
YWU2NTJlOTE5IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCisr
...
d29ya3F1ZXVlKGRldl9wcml2LT5ycSk7CisKIAlpOTE1X2dlbV9kcmFpbl9mcmVlZF9vYmplY3Rz

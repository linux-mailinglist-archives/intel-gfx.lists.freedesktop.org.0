...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A8F77653CF2
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Dec 2022 09:26:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 53F3810E518;
...
Subject: [Intel-gfx] [PATCH 3/4] drm/i915: Remove platform comments from
 workarounds

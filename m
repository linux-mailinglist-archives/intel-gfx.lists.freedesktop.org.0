...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF03E707B71
	for <lists+intel-gfx@lfdr.de>; Thu, 18 May 2023 09:56:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A25BF10E03E;
	Thu, 18 May 2023 07:56:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9449410E03E;
 Thu, 18 May 2023 07:56:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684396589; x=1715932589;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=qVVkkK11rRujJVSpWgYl59z+G3O1UH3nG2vUrBQWV4A=;
 b=C8LAv+9e5rkSOAjZAzYJLrCKE8pN8QNu0mFyFRcaIHybuKRzrVFpnI3h
 8VTvdPqNuqIW6qt6UBTakkIK+cvdAf0DT8gKyLqRKWgzoXP5jvWZoW6AC
 nrXqxtSKIT1Qlgf4cbAoEHo4hA27LrWiH+MDOCpk0vJZstUhsj/0pzCAF
 21FUMjwU1+HHHDbwxXEDgXcwfMh8T/Xs4P2dsXJuDqttkjPwqXKrzBvJs
 LEOeO+YsJK7m14sv3CnXJOvpPSQeSCqU4e5RcLG6qDCjeSwQe3mU3tpXM
 JbcOh1uFFnOZPC7OF5Mq9TIPJew/bCHUPlOWwMu3vJako7HBeOuMuyVl1 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10713"; a="352019033"
X-IronPort-AV: E=Sophos;i="5.99,284,1677571200"; d="scan'208";a="352019033"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 May 2023 00:56:11 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10713"; a="732776108"
X-IronPort-AV: E=Sophos;i="5.99,284,1677571200"; d="scan'208";a="732776108"
Received: from ahajda-mobl.ger.corp.intel.com (HELO [10.213.28.37])
 ([10.213.28.37])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 May 2023 00:56:09 -0700
Message-ID: <f1808a5d-ebb7-552a-0d0a-b08862861f92@intel.com>
Date: Thu, 18 May 2023 09:56:07 +0200
MIME-Version: 1.0
...
In-Reply-To: <20230518031804.3133486-4-matthew.d.roper@intel.com>

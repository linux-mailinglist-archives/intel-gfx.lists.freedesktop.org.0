...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0044B15097E
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Feb 2020 16:14:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4262B6EC38;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 20/26] drm/i915: Extract intel_hdmi_has_audio()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B75B2999B3
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Oct 2020 23:31:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 008AA6EA80;
	Mon, 26 Oct 2020 22:31:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 126CD6EA80
 for <intel-gfx@lists.freedesktop.org>; Mon, 26 Oct 2020 22:31:46 +0000 (UTC)
IronPort-SDR: 5WondrAj4wwji1tJzeE5Ba08vn2X74vxD1RZbVJUAhnEJHrrTUVeJNdvRhK8gAMa0CWSlmpa7W
 b9nPnQwub3tA==
X-IronPort-AV: E=McAfee;i="6000,8403,9786"; a="232184583"
X-IronPort-AV: E=Sophos;i="5.77,421,1596524400"; d="scan'208";a="232184583"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Oct 2020 15:31:45 -0700
IronPort-SDR: mIJIfPG/HzdF6XEhF3ijq8kx1v0/oh34N25wyVjfGNc9DfApl1wrnuL7WLxA+V/2M28W71ekzk
 QM9isYwK2PhQ==
X-IronPort-AV: E=Sophos;i="5.77,421,1596524400"; d="scan'208";a="525660028"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO labuser-Z97X-UD5H)
 ([10.165.21.211])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Oct 2020 15:31:44 -0700
Date: Mon, 26 Oct 2020 15:33:36 -0700
From: "Navare, Manasi" <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20201026223336.GD25941@labuser-Z97X-UD5H>
...
In-Reply-To: <20201023180025.GZ6112@intel.com>
...
> > @@ -1492,8 +1492,6 @@ static void gen11_dsi_get_config(struct intel_enc=
oder *encoder,
...
> > @@ -4408,20 +4408,14 @@ static void bdw_get_trans_port_sync_config(stru=
...
> > +
> > +		/* Our own transcoder needs to be disabled when reading it in intel_=
ddi_read_func_ctl() */
> > +		WARN_ON(pipe_config->output_types);
> > +		pipe_config->cpu_transcoder =3D (enum transcoder)pipe_config->bigjoi=
ner_linked_crtc->pipe;
> > +		intel_ddi_read_func_ctl(encoder, pipe_config);
...
> > @@ -4540,7 +4557,8 @@ void intel_ddi_get_config(struct intel_encoder *e=
ncoder,
...
> > @@ -3631,6 +3631,8 @@ intel_find_initial_plane_obj(struct intel_crtc *i=
ntel_crtc,
...
> > @@ -3653,7 +3655,7 @@ intel_find_initial_plane_obj(struct intel_crtc *i=
ntel_crtc,
...
> > @@ -8272,6 +8279,30 @@ static u32 ilk_pipe_pixel_rate(const struct inte=
...
dev);
> > @@ -9186,20 +9217,22 @@ static void intel_get_pipe_src_size(struct inte=
l_crtc *crtc,
...
May be just add this to Patch 2: drm/i915: Add hw.pipe_mode to allow bigjoi=
ner pipe/transcoder split
...
> > @@ -10876,6 +10910,13 @@ skl_get_initial_plane_config(struct intel_crtc=
 *crtc,
...
> > @@ -11366,6 +11407,8 @@ static void hsw_get_ddi_port_state(struct intel=
_crtc *crtc,
> >  	} else {
...
> >  		else
> > @@ -11439,10 +11482,19 @@ static bool hsw_get_pipe_config(struct intel_=
crtc *crtc,
> >  		active =3D true;
> >  	}
> >  =
...
> > @@ -11517,7 +11569,10 @@ static bool hsw_get_pipe_config(struct intel_c=
rtc *crtc,
> >  		}
> >  	}
> >  =
...
> > @@ -12536,7 +12591,7 @@ intel_encoder_current_mode(struct intel_encoder=
 *encoder)
> >  		return NULL;
> >  	}
> >  =
...
> > @@ -13540,13 +13595,15 @@ intel_crtc_copy_uapi_to_hw_state(struct intel=
_atomic_state *state,
...
> > -		    drm_atomic_set_mode_for_crtc(&crtc_state->uapi, &crtc_state->hw.=
mode) < 0);
> > -
...
> > @@ -14183,21 +14240,42 @@ intel_pipe_config_compare(const struct intel_=
...
> > @@ -14207,24 +14285,11 @@ intel_pipe_config_compare(const struct intel_=
crtc_state *current_config,
...
> > @@ -14250,7 +14315,8 @@ intel_pipe_config_compare(const struct intel_cr=
...
> > @@ -14271,48 +14337,50 @@ intel_pipe_config_compare(const struct intel_=
crtc_state *current_config,
...
> > @@ -14324,6 +14392,9 @@ intel_pipe_config_compare(const struct intel_cr=
tc_state *current_config,
> >  =
...
> > @@ -18543,7 +18618,7 @@ int intel_modeset_init_nogem(struct drm_i915_pr=
ivate *i915)
...
> >  		/*
> > @@ -18856,7 +18931,8 @@ static void intel_sanitize_crtc(struct intel_cr=
tc *crtc,
> >  =
...
> > @@ -19067,9 +19143,19 @@ static void intel_modeset_readout_hw_state(str=
uct drm_device *dev)
...
> >  		}
> > @@ -19125,16 +19211,15 @@ static void intel_modeset_readout_hw_state(st=
ruct drm_device *dev)
...
> > @@ -19149,11 +19234,18 @@ static void intel_modeset_readout_hw_state(st=
ruct drm_device *dev)
...
> > @@ -19199,6 +19291,39 @@ static void intel_modeset_readout_hw_state(str=
uct drm_device *dev)
...
> >  	 * accordingly.
> >  	 */
> >  #define PIPE_CONFIG_QUIRK_MODE_SYNC_FLAGS	(1<<0) /* unreliable sync mo=
de.flags */
> > +#define PIPE_CONFIG_QUIRK_BIGJOINER_SLAVE      (1<<1) /* bigjoiner sla=
ve, partial readout */

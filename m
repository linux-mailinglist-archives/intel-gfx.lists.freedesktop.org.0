...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F0DE20FEDD
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:29:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 840356E32D;
	Tue, 30 Jun 2020 21:29:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 330746E317;
 Tue, 30 Jun 2020 21:28:41 +0000 (UTC)
IronPort-SDR: bmMpp3ID0nkO/IE0Iu2uBwPnNgxj86uOjQXBTqdcA6BphxaUGfmvdaB5YeAATzOC15itGwk5DH
 U+8tY2yVeMTA==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="144554718"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="144554718"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2020 14:28:41 -0700
IronPort-SDR: MJNU6Tu866lLjWu31eFgjGAe5xvwSkj5yZuyc5mHlbOE9UutsPK3CiJsOV2yag5uoDLMkJTXub
 0Eu4/Pwx6KlA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="481066670"
Received: from hdwiyono-mobl.amr.corp.intel.com (HELO
 achrisan-DESK2.amr.corp.intel.com) ([10.254.176.225])
 by fmsmga006.fm.intel.com with ESMTP; 30 Jun 2020 14:28:40 -0700
From: Anitha Chrisanthus <anitha.chrisanthus@intel.com>
To: dri-devel@lists.freedesktop.org, anitha.chrisanthus@intel.com,
 bob.j.paauwe@intel.com, edmund.j.dea@intel.com
Date: Tue, 30 Jun 2020 14:27:28 -0700
Message-Id: <1593552491-23698-17-git-send-email-anitha.chrisanthus@intel.com>
X-Mailer: git-send-email 2.7.4
In-Reply-To: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
References: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
Subject: [Intel-gfx] [PATCH 16/59] drm/kmb: Part6 of Mipi Tx Initialization

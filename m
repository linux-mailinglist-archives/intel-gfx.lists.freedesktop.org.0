...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27AC15990DC
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Aug 2022 01:04:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7155910ECC1;
...
Subject: [Intel-gfx] [PATCH v2 09/15] drm/i915/pxp: add huc authentication
 and loading command

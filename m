...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0746B65994B
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Dec 2022 15:16:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC1C210E0E9;
	Fri, 30 Dec 2022 14:16:26 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3] arch: rename all internal names __xchg to
 __arch_xchg

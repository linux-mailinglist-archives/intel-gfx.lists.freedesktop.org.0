...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 895319B79FC
	for <lists+intel-gfx@lfdr.de>; Thu, 31 Oct 2024 12:49:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2A9CC10E863;
	Thu, 31 Oct 2024 11:49:13 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Wgm87yyh";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9C4D210E863
 for <intel-gfx@lists.freedesktop.org>; Thu, 31 Oct 2024 11:49:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1730375350; x=1761911350;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Ah5VQ7iw+7o5vqfDxCvP35nyGa+YkOldX358bcFRdwA=;
 b=Wgm87yyhM4amZheyEmG1Qt/yYvNOCyU3sVQeDITDEZCqnnGDEKSsm50y
 4CwS00hUCLTVm5Wb7gbXgVucunyX4Hv8FhP0iiAz1xSUCcHbdA+PYnltU
 AhF0K03V0ZgWkQk+N96wt9WFFeNzrFxUhod/4l2174gxydCpKeB8C8ufG
 j2RbP3aFfXuVBJH3Ud2XuwBW0AkNzjh/UxfOitJhzws5+0Ge7kRDYQSjf
 ygPgRUbwWY1/eqoTUX9efHQJeaVWaU+DZzpi8WWXXI42ENkID4S4Q9Wl3
 +jD9bD7wsRGK7Tw7uM931PGUQbW8Y0t5eC4mhG2JMSQcDOsvT5AGxhgHY A==;
X-CSE-ConnectionGUID: mMwOFwlyQ2W57u3mHwok8A==
X-CSE-MsgGUID: BygPsU83Q+yw0G6e+c1Sjg==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="40654016"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="40654016"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2024 04:49:10 -0700
X-CSE-ConnectionGUID: Ao25vi2uQwyydt406ndytw==
X-CSE-MsgGUID: eeaHzg3cQIqd8BR8hpdbjQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,247,1725346800"; d="scan'208";a="113451925"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by fmviesa001.fm.intel.com with ESMTP; 31 Oct 2024 04:49:09 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: raag.jadav@intel.com, gustavo.sousa@intel.com, jani.nikula@linux.intel.com,
 Mika Kahola <mika.kahola@intel.com>
Subject: [PATCH v3 1/2] drm/i915/xe3lpd: Power request asserting/deasserting
Date: Thu, 31 Oct 2024 13:40:26 +0200
Message-ID: <20241031114027.225217-2-mika.kahola@intel.com>
...
@@ -1022,6 +1047,13 @@ static void __xelpdp_tc_phy_enable_tcss_power(struct intel_tc_port *tc, bool ena

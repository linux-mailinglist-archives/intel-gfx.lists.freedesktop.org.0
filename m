...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1579D1369B0
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 86DDF6E9C0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/23] drm/stm: Convert to struct

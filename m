...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 171E668B81E
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Feb 2023 10:06:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F0B210E352;
	Mon,  6 Feb 2023 09:06:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A27F610E348;
 Mon,  6 Feb 2023 09:06:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675674367; x=1707210367;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=v6I4EZeoD/6CjXAdTmYi2jJRJwtVcJIY7HyYwH0QLKU=;
 b=CmaAITyhrP1N3xLBejMzt3edmxeOQbIeTfq2V4NNfERlC1cmnTDMaF8S
 ENxlyQlcmxPErp3Dfd354LDcceOGu/VSGJyTS1cbnC8ypcW6iTs31Q3ii
 GVZQI7o1RaRBC9urTdfU1wlOloOHyXHbWP1/rCOQVH0Fqu+ph+kbhtR4Q
 H1hcQwD+iX6YYs6ngMXoi32kSdpP8AepR9JIPiXMtYhgi1HB1TtOY5kcx
 HTuv/RGfYf4Ov1ar0lvHC+/L7b3jNcbghOnDdcMdAeLGzWLX5s7NnPQJQ
 TiBKAPVH4yscMnUnrw12XKMnDKwWriZALbqO5fvR90u4pcYl1nZotb4hB w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10612"; a="309495928"
X-IronPort-AV: E=Sophos;i="5.97,276,1669104000"; d="scan'208";a="309495928"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2023 01:06:07 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10612"; a="911862878"
X-IronPort-AV: E=Sophos;i="5.97,276,1669104000"; d="scan'208";a="911862878"
...
Subject: [Intel-gfx] [PATCH v2 13/14] vfio: Add ioctls for device cdev using
 iommufd

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6828912DC52
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Jan 2020 00:38:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 43FAF6E291;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 6/7] drm/fb: Extend format_info member arrays to
 handle four planes

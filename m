...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E12EF7130F7
	for <lists+intel-gfx@lfdr.de>; Sat, 27 May 2023 02:53:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F371E10E202;
...
Subject: [Intel-gfx] [PATCH v3 0/7] drm/i915: HuC loading and authentication
 for MTL

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E2869B3BDE2
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Aug 2025 16:35:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2EE2D10EBD5;
	Fri, 29 Aug 2025 14:35:03 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="Fk8yoWI4";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B572B10EBD5
 for <intel-gfx@lists.freedesktop.org>; Fri, 29 Aug 2025 14:35:01 +0000 (UTC)
...
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 ...
 us-mta-141-euhU6rfdPk2_grIMzS64Mw-1; Fri, 29 Aug 2025 10:34:59 -0400
X-MC-Unique: euhU6rfdPk2_grIMzS64Mw-1
X-Mimecast-MFC-AGG-ID: euhU6rfdPk2_grIMzS64Mw_1756478098
Received: by mail-wm1-f70.google.com with SMTP id
 5b1f17b1804b1-45a1b0bd6a9so12143855e9.2
 for <intel-gfx@lists.freedesktop.org>; Fri, 29 Aug 2025 07:34:59 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :reply-to;
 bh=hfIlMYGAPM5qq+lZD1SPgFCFfaNMq7ewyyxdxPY6Oa8=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXFLak/sm4C9qeyskKtmd+Xt9SOlyJ/80+6NF+rM0bO7xi6V6GancSsMBTOBKwUV72VqZAmKQC8Hvg=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YxsIlD08uqYhz6jJP7kcNfUXouzMtCwAWVJxxxzJCIj3H27TKwp
 LLYb9wCeKOeqmFKG19KsS0oV7K9JhVBra5OWaEUxuJAaOd8xHYRrRqqbO0XouhXlqe8Fsx+bxZy
 QiAHU4OSdgnWLykUklw+MaT2I0uRYGUav989TflOqmVEKO6jJiVl8NQBBxytHzrL0M+mbRw==
X-Gm-Gg: 
X-Received: by 2002:a05:600c:198f:b0:459:db7b:988e with SMTP id
 5b1f17b1804b1-45b517a0878mr226234045e9.13.1756478097776; 
...
X-Received: by 2002:a05:600c:198f:b0:459:db7b:988e with SMTP id
 5b1f17b1804b1-45b517a0878mr226233525e9.13.1756478097177; 
 Fri, 29 Aug 2025 07:34:57 -0700 (PDT)
Received: from ?IPV6:2003:d8:2f1d:100:4f8e:bb13:c3c7:f854?
 ...
 5b1f17b1804b1-45b6f0d32a2sm134907275e9.9.2025.08.29.07.34.55
...
X-Mimecast-MFC-PROC-ID: abA-S1iNyvjJRbYzROVhk8jlPwF68sjsIVwPWkGpOCU_1756478098

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 257DB8DC33
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Aug 2019 19:48:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3337989C8F;
	Wed, 14 Aug 2019 17:48:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ed1-x541.google.com (mail-ed1-x541.google.com
 [IPv6:2a00:1450:4864:20::541])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C1AD989C8F
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Aug 2019 17:48:32 +0000 (UTC)
Received: by mail-ed1-x541.google.com with SMTP id m44so7779364edd.9
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Aug 2019 10:48:32 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:sender:date:from:to:cc:subject:message-id
 :references:mime-version:content-disposition:in-reply-to:user-agent;
 bh=qwqWaeu+GhOdKofjdqb5LYI6e2TpebWGOHjix0xqdCI=;
 b=
X-Gm-Message-State: APjAAAXeP6OsEUprW3csCRSw/OU4wYEjZ4Rk1ASkUZwg+F7xm94cZOo1
 0NA+ZWpU0krPCsv+q7fqjmIDqA==
...
Subject: Re: [Intel-gfx] [PATCH 4/4] dma-buf: nuke reservation_object seq
 number

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE01874D40B
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Jul 2023 12:58:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F0E3910E26B;
	Mon, 10 Jul 2023 10:58:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 77CCF10E26B
 for <intel-gfx@lists.freedesktop.org>; Mon, 10 Jul 2023 10:58:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1688986702; x=1720522702;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=h7zCqKSYDtGCtC7Du1yUTQqZ40lAEpZJ4dAjqXR1r3s=;
 b=AuWKErdY/maA2kBqjkaJPiIIgLp6S2n6oA1Whj5EKQHClZZfg3Mz33g0
 UpR+hYNlP4FRz7XGz/tFlcrpCjuPdaGEvwyNbTjC3j7Fr3JqxtwUzo8bj
 gSmIw0rIAOeNMiRZxKaPvm/Qy0EJwLupF4lTdrZoUhKqGohoY0lT2FHq0
 zgB1anWI7JoxPlpeBAa1Pgupo1QvlN0T2Pbx9CeHBRmcvrZgewp/pLUcV
 nPnAyzJIPI8WKvLcwr/A8eQcN0aGAvQLpGCIVG/w9q84mkhBcRTqptD1N
 3pjq0SvXsSfGqbDi+ogBDTkC5aglVD+9b9IzvoWmGpUH7X2rVyMuLzXth A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10766"; a="367808888"
X-IronPort-AV: E=Sophos;i="6.01,194,1684825200"; d="scan'208";a="367808888"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Jul 2023 03:58:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10766"; a="1051319735"
X-IronPort-AV: E=Sophos;i="6.01,194,1684825200"; d="scan'208";a="1051319735"
Received: from pltuser2-ms-7d25.iind.intel.com ([10.190.239.58])
 by fmsmga005.fm.intel.com with ESMTP; 10 Jul 2023 03:58:19 -0700
From: Dnyaneshwar Bhadane <dnyaneshwar.bhadane@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 10 Jul 2023 16:28:15 +0530
Message-Id: <20230710105815.2056018-1-dnyaneshwar.bhadane@intel.com>
...
Subject: [Intel-gfx] [v3] drm/i915/mtl: s/MTL/METEORLAKE for

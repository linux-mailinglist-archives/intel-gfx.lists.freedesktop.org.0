...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 460CB4596FB
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Nov 2021 22:51:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A91589DD2;
...
Subject: [Intel-gfx] [PATCH v3 2/2] drm/i915: Use to_root_gt() to refer to
 the root tile

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 762FD1CFC68
	for <lists+intel-gfx@lfdr.de>; Tue, 12 May 2020 19:42:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D16FC6E94F;
	Tue, 12 May 2020 17:42:01 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 679DF6E94C
 for <intel-gfx@lists.freedesktop.org>; Tue, 12 May 2020 17:42:00 +0000 (UTC)
IronPort-SDR: 0+ElRPkx3EDYw9MJUGUvkjSOyUKwgn8UZDo5TZ1ofR1kvh7XHnKOXUGNwwecTPn2t3VaF4HK1C
 FI+JrXvBzSEg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2020 10:42:00 -0700
IronPort-SDR: 8LLgA/4f1k7tMvJvL0QVJq8VrhRzE+GIkGr9DwZoUqlF9MOQxP2l/rgdB8fiqPRC6DsThJwFmN
 3YYZisGVM8Tg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,384,1583222400"; d="scan'208";a="265582540"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by orsmga006.jf.intel.com with SMTP; 12 May 2020 10:41:58 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 12 May 2020 20:41:56 +0300
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 12 May 2020 20:41:42 +0300
Message-Id: <20200512174145.3186-5-ville.syrjala@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/7] drm/i915: Add {preemph,
 voltage}_max() vfuncs
...
Z3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxfZGRpLmMKaW5kZXggNzk4ODg5ZjcyNDk1Li5mODcz
ZmQwM2FjMTQgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2Rpc3BsYXkvaW50ZWxf
...
aTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXlfdHlwZXMuaAppbmRleCA4Nzg3NmZjZTkxYTUuLjQ2
ZTkxNTc0ZjE3OCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvZGlzcGxheS9pbnRl
...
OTUyOTE4ZDA5MDQuLjZkNzkwNjMzZTY2NyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5
...
c2V0X3NpZ25hbF9sZXZlbHMoc3RydWN0IGludGVsX2RwICppbnRlbF9kcCkKQEAgLTgzMjUsNiAr
ODI5MSwxNSBAQCBib29sIGludGVsX2RwX2luaXQoc3RydWN0IGRybV9pOTE1X3ByaXZhdGUgKmRl
...
TVBIQVNJU19SRUFDSEVEOwogCi0tIAoyLjI2LjIKCl9fX19fX19fX19fX19fX19fX19fX19fX19f

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E74171369A2
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C9346E9AB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 04/23] drm/nouveau: Convert to struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47A906132E4
	for <lists+intel-gfx@lfdr.de>; Mon, 31 Oct 2022 10:39:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B5D610E171;
...
Subject: Re: [Intel-gfx] [PATCH v1 2/7] vfio/ccw: remove private->sch

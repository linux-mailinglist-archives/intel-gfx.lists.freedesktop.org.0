...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B8D867A98B
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 05:13:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A81810E366;
	Wed, 25 Jan 2023 04:13:45 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 6/9] drm/i915/pxp: Add ARB session
 creation with new PXP API Ver4.3

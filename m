...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E2D14E9DB0
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 19:40:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 83BFA10E742;
...
Subject: Re: [Intel-gfx] [PATCH v3 10/12] drm/edid: constify struct edid
 passed around in callbacks and closure

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D39D3B2943
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 09:30:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 254F96EB0C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 23/27] drm/vc4: Don't set struct

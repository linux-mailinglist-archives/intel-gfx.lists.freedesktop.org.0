...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A6E9757DE0
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 15:39:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B7EDF10E34C;
...
Subject: [Intel-gfx] [PATCH v5 5/9] drm/i915/gt: Rename flags with

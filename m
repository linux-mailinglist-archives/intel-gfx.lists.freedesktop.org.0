...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B7EB88B09
	for <lists+intel-gfx@lfdr.de>; Sat, 10 Aug 2019 13:28:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 825656E379;
...
Subject: Re: [Intel-gfx] [PATCH v3 29/37] drm/i915: Allow i915 to manage the

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D6D18307AD7
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Jan 2021 17:27:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 779F26E9AF;
	Thu, 28 Jan 2021 16:27:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ACFC56E998
 for <intel-gfx@lists.freedesktop.org>; Thu, 28 Jan 2021 16:26:22 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 28 Jan 2021 17:25:20 +0100
Message-Id: <20210128162612.927917-12-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 11/63] drm/i915: Disable userptr pread/pwrite
 support.
...
OTE1X2dlbS5jCmluZGV4IGY3MTMyOTlkZDg0ZC4uOTkzZDI2NTk3NzA3IDEwMDY0NAotLS0gYS9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCisrKyBiL2RyaXZlcnMvZ3B1L2RybS9pOTE1
L2k5MTVfZ2VtLmMKQEAgLTQwMCw2ICs0MDAsMTEgQEAgaTkxNV9nZW1fcHJlYWRfaW9jdGwoc3Ry
...
RVY7CiAJaWYgKG9iai0+b3BzLT5wcmVhZCkKLS0gCjIuMzAuMAoKX19fX19fX19fX19fX19fX19f

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 802F94A80DE
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Feb 2022 10:04:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A42210E9CF;
...
Subject: [Intel-gfx] [PATCH v2 3/8] drm/dp: add some new DPCD macros from DP
 2.0 E11

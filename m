...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B30BBDF2EA
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Oct 2025 16:56:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE87210E821;
	Wed, 15 Oct 2025 14:56:32 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="GgTqYcy0";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A027D10E81E;
 Wed, 15 Oct 2025 14:56:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1760540190; x=1792076190;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=Jsijld0HCcmzHeyNrrPzpOL8hNoP4xsYnI/+09WsuAs=;
 b=GgTqYcy0vqZ4wPw/RU81xSNlMWoO+qn2PxBIb5SfaF+285jV3KMawSzT
 +mA4UuaUz+BL/ehkkxPEi4e8Zhe8d38FuW+wlAhSwrrm2Svq9y5yt0rRg
 R+fV2XTXHWzO8AaBFDfw4GDFMZBf8khovRDw8gVHN3GzVcOSMOQQ18bND
 o/co9hbzm1PIry2cdo9j/TkwAkQL3Y8AWzIt916qtinaeTpugKtTHA/RH
 hijRumnzEQ09aguokuTB4m/WhDKDaRVtzT7Yu1pmgngE9Dx4jOcGLgPIp
 dRpZf5UwcqVpptFSEeUXlsWy1GhNtfAf4f187ilW87E0zfZLE3Kwxmxuw w==;
X-CSE-ConnectionGUID: JxZR/jxzQBui0AHldSz2LA==
X-CSE-MsgGUID: sgED2IbFRk6AhT1TeOYjiw==
X-IronPort-AV: E=McAfee;i="6800,10657,11583"; a="50285060"
X-IronPort-AV: E=Sophos;i="6.19,231,1754982000"; d="scan'208";a="50285060"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Oct 2025 07:56:30 -0700
X-CSE-ConnectionGUID: 4W+A7xfTSruAkOMOTpOQSA==
X-CSE-MsgGUID: ZeWDhKt1RvyWmdCWJ5tXfg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,231,1754982000"; d="scan'208";a="187487237"
Received: from mjarzebo-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.100])
 by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Oct 2025 07:56:25 -0700
...
Date: Wed, 15 Oct 2025 17:56:22 +0300
Message-ID: <1b590289f8f24e4eb4da9b209503abe0eeba31dc@intel.com>
MIME-Version: 1.0

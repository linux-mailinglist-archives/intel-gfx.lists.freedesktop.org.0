...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B8ACE970F1
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Aug 2019 06:16:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33AA86E8F2;
	Wed, 21 Aug 2019 04:16:48 +0000 (UTC)
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 OiQblBcUnAQtg==
Subject: [Intel-gfx] linux-next: manual merge of the iommu tree with the
 drm-misc tree
...
Content-Type: multipart/mixed; boundary="===============0479161284=="

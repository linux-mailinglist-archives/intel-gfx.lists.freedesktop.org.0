...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41256375AD3
	for <lists+intel-gfx@lfdr.de>; Thu,  6 May 2021 20:59:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F074E6ED17;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 41/97] drm/i915/guc: Add new GuC interface

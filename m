...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CBFAC7EE9F8
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Nov 2023 00:28:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C27CE10E040;
	Thu, 16 Nov 2023 23:28:44 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v1 1/1] drm/i915/pxp: Bail early in pxp tee

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ABBDB510476
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Apr 2022 18:49:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF57110E1A2;
...
Subject: [Intel-gfx] [PATCH v3 0/7] drm/i915: Use the memcpy_from_wc
 function from drm

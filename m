...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CE8D16BCFCA
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 13:42:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E5A6D10E19F;
...
Subject: [Intel-gfx] [PATCH 7/7] vfio/pci: Accept device fd in

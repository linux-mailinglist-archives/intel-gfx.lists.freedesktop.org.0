...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB51BBDC6A1
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Oct 2025 06:09:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1803E10E722;
	Wed, 15 Oct 2025 04:09:02 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Yd138Jpj";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2CFB610E722;
 Wed, 15 Oct 2025 04:09:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1760501341; x=1792037341;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=YI+kuZHIdfg9DaDqy5xcUab0isXYX7L9wuDE3ZZS86U=;
 b=Yd138JpjQiQGiZDjJjQ2ATnszWBOFOIMEETFnmBy4eVHnYpJBpZjud/M
 oj9Ok5MgdwZgFprKuUWGENfEY68dagvZZif43/Qf+LyyOXPpuHAL9vBds
 Mg0TyiTPAhXEH1tGxbcV95q0cEP1rheN95N9Z6FZhgP0FIY77Ul4IXCDc
 oJtjqhWKMDo/NlI5Mh+a5NtTlIBviODRzGSUZLD2X4OQScGokHYJiJqqe
 IKsIT+3ljWFdft28Tetq0vEudRLgLQNwdj+mDoyQ1+0x0qRI4HzN5zVjH
 0++1woWuIPFUolVqPMBrSfrdzf+RR8MR2eT3BNuduZDu0IqhXqFXGHpQY A==;
X-CSE-ConnectionGUID: piPG+nSrSASmk78++A0qhQ==
X-CSE-MsgGUID: Naz+7DNnRpuo6S8BODOqIA==
X-IronPort-AV: E=McAfee;i="6800,10657,11582"; a="66318964"
X-IronPort-AV: E=Sophos;i="6.19,230,1754982000"; d="scan'208";a="66318964"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2025 21:09:01 -0700
X-CSE-ConnectionGUID: /OmZfZQ2S0arMkd4Z+7UrQ==
X-CSE-MsgGUID: 86XCTBSmRW2tQ59bU+aUVw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,230,1754982000"; d="scan'208";a="219196196"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa001.jf.intel.com with ESMTP; 14 Oct 2025 21:08:58 -0700
...
Subject: [PATCH 12/25] drm/i915/ltphy: Program the P2P Transaction flow for LT
 Phy
Date: Wed, 15 Oct 2025 09:38:04 +0530
Message-Id: <20251015040817.3431297-13-suraj.kandpal@intel.com>

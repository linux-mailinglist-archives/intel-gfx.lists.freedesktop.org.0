...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D04507C90B0
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 00:49:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C60C710E652;
...
Subject: [Intel-gfx] [PATCH v7b 06/25] dyndbg: split

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 55585758765
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Jul 2023 23:44:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 12EC510E3C6;
...
Subject: [Intel-gfx] [PATCH 1/2] drm/v3d: Avoid -Wconstant-logical-operand

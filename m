...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E4A51922E1
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2020 09:36:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E5CDA6E123;
	Wed, 25 Mar 2020 08:36:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x444.google.com (mail-wr1-x444.google.com
 [IPv6:2a00:1450:4864:20::444])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4AC5C6E123
 for <intel-gfx@lists.freedesktop.org>; Wed, 25 Mar 2020 08:36:47 +0000 (UTC)
Received: by mail-wr1-x444.google.com with SMTP id a25so1812861wrd.0
 for <intel-gfx@lists.freedesktop.org>; Wed, 25 Mar 2020 01:36:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:in-reply-to;
 bh=du8FavCiezIh7Md+8O2ZeLEpMu9AM0viDGmqdwzSym0=;
 b=BqbowrZYVcnaamwDf6rjc9TD+CaiwKx8+4093GU09tFxAAJnGGKIPwtw6WzDXnNi7K
 L39DMn4JLWhN7jr68gC9vTBUS2afCnpLuDbdst/EPT5X5Xm07/QNjwjBYDoHZsT0HKDe
 oTo4oZssJkfBOFf5A4Roh2hqWXI3uysiSUWrU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=du8FavCiezIh7Md+8O2ZeLEpMu9AM0viDGmqdwzSym0=;
 b=
X-Gm-Message-State: ANhLgQ0b/GP/SQfN0ddZkAyMwpY6jM0mih/pvIEAlF8zh4Ev89ierR64
 mk+ZLkNd60MlDnYT1r/p+fLvngu/XAmHzM17
X-Google-Smtp-Source: ADFU+vvTVvPBm90HwYy1aQNiw3BSGPEkskLGLKDh6z6UahTEf8KeZ/8HSfXYc+F4Sgt4eBVFtqYF5w==
X-Received: by 2002:a05:6000:10e:: with SMTP id
 o14mr2043222wrx.231.1585125405806; 
 Wed, 25 Mar 2020 01:36:45 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id q72sm8545782wme.31.2020.03.25.01.36.44
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 25 Mar 2020 01:36:45 -0700 (PDT)
Date: Wed, 25 Mar 2020 09:36:43 +0100
From: Daniel Vetter <daniel@ffwll.ch>
To: Jani Nikula <jani.nikula@intel.com>
Message-ID: <20200325083643.GM2363188@phenom.ffwll.local>
References: <cover.1584714939.git.jani.nikula@intel.com>
 <e09bb6e97b2fbc44303acce0523dc35e3e74a456.1584714939.git.jani.nikula@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <e09bb6e97b2fbc44303acce0523dc35e3e74a456.1584714939.git.jani.nikula@intel.com>
X-Operating-System: Linux phenom 5.3.0-3-amd64 
Subject: Re: [Intel-gfx] [PATCH 01/13] drm/i915/ddi: use struct drm_device
 based logging

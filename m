...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 27BF21649B
	for <lists+intel-gfx@lfdr.de>; Tue,  7 May 2019 15:33:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA8586E7D6;
...
Subject: Re: [Intel-gfx] [v8 02/10] drm: Parse HDR metadata info from EDID

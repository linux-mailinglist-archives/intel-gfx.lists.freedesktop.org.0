...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 97B5C60A66C
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Oct 2022 14:35:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF56D10E535;
...
Subject: [Intel-gfx] [PATCH v2 16/16] drm/edid: convert to device specific
 logging

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 59E5F542869
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 09:51:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C83310EEB6;
...
Subject: [Intel-gfx] [PATCH v2 04/15] drm/edid: keep track of alloc size in
 drm_do_get_edid()

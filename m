...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DF5004AD77E
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 12:37:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B83210E327;
	Tue,  8 Feb 2022 11:37:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EDCB110E605
 for <intel-gfx@lists.freedesktop.org>; Tue,  8 Feb 2022 11:37:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644320236; x=1675856236;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=C41OLJbxo1LB/F3ZrRVH4pa7R0wGfD4PhtpdfZc5G8E=;
 b=O1RiM3FLP5axVdFdgL0zsJ6BhylDlTrhaOA1rkGqGwb2pDAorEjYodWa
 12M+W50CIEq0UUF0QJ6U/UPHndr6UlERKhXjZon5I14SqOfSJUrR9b6yB
 /A2Zgafh36de4vmo/XcTevdEns/st0IQvgIisWLZNLvqlPsZC9JgWhn0L
 wszTwbN3hEhPtYjQfuOPJGgvKwB2MwxbY94rXuf/HrnfwIAgy9X7uTBSV
 vODGnRat24CNnI4hqzOXo8V1E7edtmDygZWqF+bEJJXeXvX/wlHV1XFXH
 /sHuy/VNOfnOcDZfgTBm7/9FymKPyvDcc+xhS9+ek+K8OW8Gg7J/sb4XZ A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10251"; a="232495985"
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="232495985"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:16 -0800
X-IronPort-AV: E=Sophos;i="5.88,352,1635231600"; d="scan'208";a="481915299"
Received: from ideak-desk.fi.intel.com ([10.237.68.141])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Feb 2022 03:37:15 -0800
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  8 Feb 2022 13:36:43 +0200
Message-Id: <20220208113656.179823-14-imre.deak@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 13/26] drm/i915: Move the HSW power well
...
index 18fa146fb761f..a098699d1c52c 100644
...
index b3d8baa2b7d41..f46d82f697678 100644

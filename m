...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C1ED41BD7D2
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 11:02:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 186326EC5C;
	Wed, 29 Apr 2020 09:02:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A967F6EC5C
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 09:02:47 +0000 (UTC)
IronPort-SDR: fxyF7nrXDyxof1tvyz9YVrhKegjtAyjxcXux+8xY0y+HLVYNT3upysjZ5FVeKqwtED/q0PciSO
 lb9VTlxYK4Lw==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Apr 2020 02:02:47 -0700
IronPort-SDR: szfxiElhX7O9KMsPJ76VNc/3RE5GMGeHsRo3L7wOSLYvjCjX2pni5kVH9Y7OGqokshcAXYmy/O
 UGsu+sQi6Rww==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,331,1583222400"; d="scan'208";a="246784827"
Received: from unknown (HELO delly.ger.corp.intel.com) ([10.252.38.205])
 by orsmga007.jf.intel.com with ESMTP; 29 Apr 2020 02:02:45 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 12:02:39 +0300
Message-Id: <20200429090242.978170-2-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 1/4] drm/i915/perf: break OA config buffer
 object in 2

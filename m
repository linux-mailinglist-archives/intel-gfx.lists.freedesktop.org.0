...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CEFC7AF91C
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Sep 2023 06:14:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 82DDB10E39C;
	Wed, 27 Sep 2023 04:14:42 +0000 (UTC)
...
Subject: [Intel-gfx] [Patch v1] drm/i915: Add uAPI to query micro-controller
 FW version

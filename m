...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BCCF8C8203
	for <lists+intel-gfx@lfdr.de>; Fri, 17 May 2024 10:01:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A909A10E1E4;
	Fri, 17 May 2024 08:01:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.b="QcrZCWcH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wm1-f48.google.com (mail-wm1-f48.google.com
 [209.85.128.48])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0923C10E1E4;
 Fri, 17 May 2024 08:01:38 +0000 (UTC)
Received: by mail-wm1-f48.google.com with SMTP id
 5b1f17b1804b1-42016c8daa7so37021775e9.2; 
 Fri, 17 May 2024 01:01:38 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1715932897; x=1716537697; darn=lists.freedesktop.org;
 h=content-transfer-encoding:in-reply-to:from:content-language
 :references:cc:to:subject:user-agent:mime-version:date:message-id
 :from:to:cc:subject:date:message-id:reply-to;
 bh=hGmRGbA5/EI8ZHmZPolNcQ2/a/w5qS7v+m4QkgfzB6E=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=hGmRGbA5/EI8ZHmZPolNcQ2/a/w5qS7v+m4QkgfzB6E=;
 b=
X-Forwarded-Encrypted: i=1;
 
X-Gm-Message-State: AOJu0Yx0Ej1N0DCIesKOk7orgdC3oV6V2T01kK26SzVY5XVk57R5KoiR
 T0kDtfPm6FkKOf6e4Q1moHKegaXLBNl+TG1YOKU+tyr/M++c1ETR1CG5K2cHAO8=
...
Am 16.05.24 um 19:34 schrieb Steven Rostedt:
...
We will try to not upstream any new trace points in 6.10.
...
>   .../hisilicon/hns3/hns3pf/hclge_trace.h       |  12 +-
>   .../hisilicon/hns3/hns3vf/hclgevf_trace.h     |  10 +-
...
>   147 files changed, 785 insertions(+), 799 deletions(-)
>
...
> @@ -2726,7 +2726,7 @@ DECLARE_EVENT_CLASS(xfs_defer_pending_item_class,
>   	),
>   	TP_fast_assign(
>   		__entry->dev = mp ? mp->m_super->s_dev : 0;
> -		__assign_str(name, dfp->dfp_ops->name);

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E9F744DDA3
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Nov 2021 23:03:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 810A16E990;
...
Subject: [Intel-gfx] [PATCH v10 07/10] drm_print: instrument
 drm_debug_enabled

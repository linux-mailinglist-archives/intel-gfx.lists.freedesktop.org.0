...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C8722DA538
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Dec 2020 02:08:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E3C96E160;
	Tue, 15 Dec 2020 01:08:10 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0A8626E045
 for <Intel-gfx@lists.freedesktop.org>; Tue, 15 Dec 2020 01:08:03 +0000 (UTC)
IronPort-SDR: 1o2hPnGR+Z61PqgknFEYER++S5X/AQYgpde2odH2N/URVZYt0tpCHaxgHZbUxCSy7jMMzmilu8
 mGGBcZkjRJqA==
X-IronPort-AV: E=McAfee;i="6000,8403,9835"; a="171297996"
X-IronPort-AV: E=Sophos;i="5.78,420,1599548400"; d="scan'208";a="171297996"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Dec 2020 17:08:01 -0800
IronPort-SDR: 3TdKcwJ2dUW4tFeY6xGAJRstKputoj8cGttliv/umXzrU7WfTg2utiCT3Xewg0UfFMoT+MeFoT
 uM1E1XpRo28w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,420,1599548400"; d="scan'208";a="331861140"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga007.fm.intel.com with ESMTP; 14 Dec 2020 17:08:01 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Mon, 14 Dec 2020 17:07:17 -0800
Message-Id: <20201215010726.15898-15-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201215010726.15898-1-sean.z.huang@intel.com>
References: <20201215010726.15898-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v9 14/23] drm/i915/pxp: Implement ioctl action to

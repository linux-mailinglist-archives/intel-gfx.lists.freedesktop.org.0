...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF2B99CA1A
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Aug 2019 09:22:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06A1F6E1E8;
	Mon, 26 Aug 2019 07:22:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 64C406E1B8
 for <intel-gfx@lists.freedesktop.org>; Mon, 26 Aug 2019 07:22:13 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18262683-1500050 
 for multiple; Mon, 26 Aug 2019 08:21:53 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 26 Aug 2019 08:21:29 +0100
Message-Id: <20190826072149.9447-8-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/28] drm/i915: Replace obj->pin_global with
 obj->frontbuffer
...
L2k5MTUvaTkxNV9kZWJ1Z2ZzLmMKaW5kZXggNWMxYTJiMWU3ZDM0Li4yN2FjZWRkODk3ODUgMTAw

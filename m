...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D9BDD7AB2FB
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Sep 2023 15:47:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1DBEB10E66B;
...
Subject: [Intel-gfx] [PATCH 4/6] drm/i915: Account ring buffer and context
 state storage

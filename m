...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 412065EDB9B
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Sep 2022 13:20:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2756010E452;
...
Subject: Re: [Intel-gfx] [PATCH] drm/display: Don't rewrite link config when

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 17F9036B0C6
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Apr 2021 11:40:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9DEE89F89;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/2] drm/i915/gvt: Move mdev attribute groups
 into kvmgt module

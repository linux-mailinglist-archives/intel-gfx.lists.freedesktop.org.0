...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id ABF6A230DE5
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Jul 2020 17:32:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C0D86E393;
	Tue, 28 Jul 2020 15:32:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 602336E379
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Jul 2020 15:32:09 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21959636-1500050 
 for multiple; Tue, 28 Jul 2020 16:31:57 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 28 Jul 2020 16:31:56 +0100
Message-Id: <20200728153157.27969-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/3] drm/i915/gt: Switch to object allocations
...
index 09056544bc29..ede6369a9092 100644
...
index 56dfc6d98caa..0be51f4eddc4 100644
...
index 70a6f55730f3..1fc657581c97 100644

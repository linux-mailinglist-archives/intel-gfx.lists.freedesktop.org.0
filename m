...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 78A532D3BDD
	for <lists+intel-gfx@lfdr.de>; Wed,  9 Dec 2020 08:03:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 11B0B6E10F;
	Wed,  9 Dec 2020 07:03:44 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 70F8A6E10D
 for <Intel-gfx@lists.freedesktop.org>; Wed,  9 Dec 2020 07:03:42 +0000 (UTC)
IronPort-SDR: aIG9elFw4FmttxhZ5t8f9nvekYWc3y4z1hNoumrzseskVl/AyUwYEMfFlrIh3GcJIAeylZTKGg
 udTm9UHwNMvw==
X-IronPort-AV: E=McAfee;i="6000,8403,9829"; a="238134531"
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="238134531"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2020 23:03:40 -0800
IronPort-SDR: hUnGx439Y1g08tpllSJRD9QhQ8sdhpXfS46R3KzKgfZGTMrIbgDTTjsh8aPgl//1M+jAgR+47Y
 rVPQ4fOh0OdQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="368074101"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga004.fm.intel.com with ESMTP; 08 Dec 2020 23:03:40 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Tue,  8 Dec 2020 23:02:58 -0800
Message-Id: <20201209070307.2304-5-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201209070307.2304-1-sean.z.huang@intel.com>
References: <20201209070307.2304-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v3 04/13] drm/i915/pxp: Create the arbitrary
 session after boot

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 310796F115F
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 07:38:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D563E10EC4A;
	Fri, 28 Apr 2023 05:38:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AF50B10EC30;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=RnMtvpAQ/pYQ/h8tj5ewKaf5v4kzTNzRdxA8q6x8pSUlU2VQyX5qGt44
 9U4S4uYk8duaCmsxC1fMPib0CLnVuQWg4SWiAYy9bUoCswLwNHUDynJtl
 BAc++cRLB+6TLPRLvKFliSPK5tcFRdJR50HmM7jscZcXb+snaFdwYAUd5
 GIRAGpEoMP5f87GGu+38gvt45UiF21lykPnLiCKz1w3bk3shRx6Q9QBGQ
 ebTOKYD0WgPwLhtYrvCpNUdDcqZVTw4AiNtNmubLCtRpBeTpNvKsjgSm0
 Xm1rK5aoALqntY8t26ciAwoK6JcDIbu9W4s5XDfxT//+EtLiW+QozgbB8 A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="345109196"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="345109196"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:38:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="838731993"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="838731993"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:38:13 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Apr 2023 22:39:15 -0700
Message-Id: <20230428053917.1765521-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/3] drm/i915: preparation for using PAT index

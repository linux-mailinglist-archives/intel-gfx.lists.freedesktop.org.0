...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 73DDFF6AF5
	for <lists+intel-gfx@lfdr.de>; Sun, 10 Nov 2019 19:58:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 172736E7AC;
	Sun, 10 Nov 2019 18:58:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E15A56E7B0
 for <intel-gfx@lists.freedesktop.org>; Sun, 10 Nov 2019 18:58:28 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 19151891-1500050 
 for multiple; Sun, 10 Nov 2019 18:58:11 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 10 Nov 2019 18:57:52 +0000
Message-Id: <20191110185806.17413-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/25] drm/i915/gem: Silence sparse for RCU
...
ZXh0LmMKaW5kZXggNzJkMzg5YWZhMjhhLi45MDdjMmVjMzBiOTggMTAwNjQ0Ci0tLSBhL2RyaXZl
cnMvZ3B1L2RybS9pOTE1L2dlbS9pOTE1X2dlbV9jb250ZXh0LmMKKysrIGIvZHJpdmVycy9ncHUv
ZHJtL2k5MTUvZ2VtL2k5MTVfZ2VtX2NvbnRleHQuYwpAQCAtMjAwMyw3ICsyMDAzLDggQEAgc3Rh
...
X3VzZXJfZW5naW5lcyhkc3QpOwpAQCAtMjAzOCw3ICsyMDM5LDggQEAgc3RhdGljIGludCBjbG9u

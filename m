...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DDB1B1369EF
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BD5856EA1D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 23/23] drm: Cleanup VBLANK callbacks in struct
 drm_driver

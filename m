...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 92E352E23E4
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Dec 2020 04:10:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C58589DCF;
	Thu, 24 Dec 2020 03:10:29 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1284989F5F
 for <Intel-gfx@lists.freedesktop.org>; Thu, 24 Dec 2020 03:10:28 +0000 (UTC)
IronPort-SDR: hvqS593Z/Qi7ikLscRnDCjnHQUErkj/vwhlvcGyuQK8TavB7ICdqtJoGbhWqPB7bQeuoHcC/Py
 d7bDY4ZPHS/g==
X-IronPort-AV: E=McAfee;i="6000,8403,9844"; a="155893680"
X-IronPort-AV: E=Sophos;i="5.78,444,1599548400"; d="scan'208";a="155893680"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Dec 2020 19:10:27 -0800
IronPort-SDR: oVPnVRUW3DNDW/WPgDWlyG96GpJpSoU/31Upi6xE04Dl9TcadxbYoAwaT7nWH7s3bKCkXMjtlI
 XtKNybL+xTAQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,444,1599548400"; d="scan'208";a="342496787"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga003.jf.intel.com with ESMTP; 23 Dec 2020 19:10:26 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed, 23 Dec 2020 19:10:16 -0800
Message-Id: <20201224031026.7360-4-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201224031026.7360-1-sean.z.huang@intel.com>
References: <20201224031026.7360-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v15 03/13] drm/i915/pxp: Implement funcs to create
 the TEE channel

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BEA7013D3F1
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Jan 2020 06:50:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 988266EBE4;
...
Subject: [Intel-gfx] [PATCH 2/5] drm/i915/audio: convert to new drm logging
 macros.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DECD5A8F99
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 09:17:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BE9A10E600;
	Thu,  1 Sep 2022 07:16:52 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 19/21] dma-buf: Document dynamic locking
 convention

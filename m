...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2258C5FA03E
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Oct 2022 16:32:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 15F6B10E620;
	Mon, 10 Oct 2022 14:31:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1C37010E625
 for <intel-gfx@lists.freedesktop.org>; Mon, 10 Oct 2022 14:31:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665412294; x=1696948294;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=Q/PMn6McbDbBmIdF769uJQXaE/E4PL2j9Rs3ikecVy8=;
 b=eMWkpd6zfDGpZlcWuEJMgLou38/cWbYFnb+Ta9qILyNTVC5Cu9Xmgavj
 jAkEITLY0fUfRjKTLjyLE4ZoXf2f+wV9xr+RDoW1mHhWyfA31pTizO4kX
 dol22uEHB5U4t+JQOHo9d88IEVwZ25G3RREt0Rw7NSVyWNAk7lQs1PpRv
 8ritX1nhxuEBcBMeuvNp2d/U1Iavn7zd3XQcrMULQXNDkji4q+QQ9KJUz
 AWBCcPxy7bHHz+kaE6xAXTH+aJ7sRf5A0Wvm5uVqUs/VHIWMFzYpp7XpF
 9R5q2bKGe96EXDJ6kpQb4NxgqR+J0Sz79XwnBvcplLtBRn3XRCDMHseeH w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="304225611"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="304225611"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2022 07:31:33 -0700
X-IronPort-AV: E=McAfee;i="6500,9779,10496"; a="628295345"
X-IronPort-AV: E=Sophos;i="5.95,173,1661842800"; d="scan'208";a="628295345"
Received: from ashyti-mobl2.igk.intel.com (HELO intel.com) ([172.28.182.93])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2022 07:31:31 -0700
Date: Mon, 10 Oct 2022 16:31:28 +0200
From: Andi Shyti <andi.shyti@linux.intel.com>
To: Andrzej Hajda <andrzej.hajda@intel.com>
Message-ID: <Y0QswEzRwwv9Vops@ashyti-mobl2.lan>
References: <Yz8FHapUF8BD7kkw@intel.com>
 <20221006204844.2831303-1-andrzej.hajda@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20221006204844.2831303-1-andrzej.hajda@intel.com>
...
Cc: Jani Nikula <jani.nikula@intel.com>,
 Ville Syrjala <ville.syrjala@intel.com>, intel-gfx@lists.freedesktop.org,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 46D4482E9E
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2019 11:23:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AD176E33F;
	Tue,  6 Aug 2019 09:23:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 927E66E33F
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Aug 2019 09:23:40 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17901472-1500050 
 for multiple; Tue, 06 Aug 2019 10:05:39 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Aug 2019 10:05:27 +0100
Message-Id: <20190806090535.14807-14-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/22] drm/i915/gt: Track timeline activeness in
 enter/exit
...

...
eGl0KHN0cnVjdCBpbnRlbF9jb250ZXh0ICpjZSkKQEAgLTMyMjYsNiArMzIyOCw4IEBAIHN0YXRp

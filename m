...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AF68F2C64C7
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:11:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9825B6EC54;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 064/162] drm/i915/selftests: Prepare ring

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2CFA3D1306
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Jul 2021 17:58:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2FA8A6E98C;
...
Subject: [Intel-gfx] [PATCH 11/21] drm/i915/gvt: devirtualize ->{read,
 write}_gpa

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DA253BC0393
	for <lists+intel-gfx@lfdr.de>; Tue, 07 Oct 2025 07:46:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9FFC310E528;
	Tue,  7 Oct 2025 05:46:01 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="R6Q2WSml";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 551AD10E508;
 Tue,  7 Oct 2025 05:46:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1759815961; x=1791351961;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=9nMEiIZ0OEhhZD946yRyJbx/b12RB6G17haSVziIFP8=;
 b=R6Q2WSmlcB4XBu9UyjJFArLN7Es0wgcfFGNscFTGP7BOVGJxTb+p+9O7
 wK2kBF6vlp+JJxf6SZwpMIzNn6ItwTFl5EDsid+Hf29KnanIzf/9OS2bb
 HGTuQWiAVnohywmQsyVIN4kiWuamWEsr42VVZu048iAO3gyThjBV0QKFn
 KrNGlvnC50+/FT8YhIlyJGrnsXJkcuPHvXb62pS1gRpM7+bFd6N3eEgCh
 tB7+fNU6aARWp7qRuncy9f8QEwZ2Rk+EwJs6EmeCqLiVOyKNgBWZgitW7
 v6HMDLBZjsl9jtELyOBa5UL+w3PJb+7Ocl+VoYMVLgRiMzNb8WEMCH4mf g==;
X-CSE-ConnectionGUID: JVEWxKkxSsixd1wEjiSOfg==
X-CSE-MsgGUID: wQP05a9tRCKZBautFYKWNw==
X-IronPort-AV: E=McAfee;i="6800,10657,11574"; a="61027913"
X-IronPort-AV: E=Sophos;i="6.18,321,1751266800"; d="scan'208";a="61027913"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Oct 2025 22:46:00 -0700
X-CSE-ConnectionGUID: BSN2Tk0ARw+NQLS6flnFIw==
X-CSE-MsgGUID: zgnEArzmQFOyn4WqsfqQ5Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,321,1751266800"; d="scan'208";a="180479363"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa008.fm.intel.com with ESMTP; 06 Oct 2025 22:45:50 -0700
...
Subject: [PATCH v2 1/7] drm: writeback: Refactor drm_writeback_connector
 structure
Date: Tue,  7 Oct 2025 11:15:23 +0530
Message-Id: <20251007054528.2900905-2-suraj.kandpal@intel.com>

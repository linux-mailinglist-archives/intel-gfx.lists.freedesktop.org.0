...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76E3150148
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Jun 2019 07:45:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 113C489913;
	Mon, 24 Jun 2019 05:45:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C1238893A4
 for <intel-gfx@lists.freedesktop.org>; Mon, 24 Jun 2019 05:45:05 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17000416-1500050 
 for multiple; Mon, 24 Jun 2019 06:43:21 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 24 Jun 2019 06:43:09 +0100
Message-Id: <20190624054315.18910-13-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 13/19] drm/i915/gt: Convert timeline tracking to
 spinlock
...
X3RpbWVsaW5lLmMKaW5kZXggYjZiZmJkZWZhZjdjLi42NzJiY2NiZmQ3OTcgMTAwNjQ0Ci0tLSBh
L2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX3RpbWVsaW5lLmMKKysrIGIvZHJpdmVycy9n
cHUvZHJtL2k5MTUvZ3QvaW50ZWxfdGltZWxpbmUuYwpAQCAtMjczLDcgKzI3Myw3IEBAIHN0YXRp
...
Y2tfaW5pdCgmdGltZWxpbmVzLT5od3NwX2xvY2spOwpAQCAtMzU0LDkgKzM1NCw5IEBAIHZvaWQg
...
ICp0bCkKQEAgLTM2Nyw5ICszNjcsOSBAQCB2b2lkIGludGVsX3RpbWVsaW5lX2V4aXQoc3RydWN0
...
ZSB3YWl0aW5nCkBAIC01NTcsOCArNTU3LDYgQEAgc3RhdGljIHZvaWQgdGltZWxpbmVzX2Zpbmko
...
L2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCmluZGV4IDVjYzNhNzVkNTIxYS4uN2UzOTBkNDZhZDJl
IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbS5jCisrKyBiL2RyaXZl
cnMvZ3B1L2RybS9pOTE1L2k5MTVfZ2VtLmMKQEAgLTkwNSwyMCArOTA1LDIwIEBAIHN0YXRpYyBp
...
aW5lcy0+bG9jayk7CiAKIAkJLyoKIAkJICogIlJhY2UtdG8taWRsZSIuCkBAIC05MjksMTkgKzky
OSwxOSBAQCB3YWl0X2Zvcl90aW1lbGluZXMoc3RydWN0IGRybV9pOTE1X3ByaXZhdGUgKmk5MTUs

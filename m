...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D67720FED8
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:29:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D610D6E357;
...
Subject: [Intel-gfx] [PATCH 08/59] drm/kmb: Added mipi_dsi_host
 initialization

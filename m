...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1974E30FADB
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Feb 2021 19:11:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6E0F06EE1A;
	Thu,  4 Feb 2021 18:11:25 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 339016EE20
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Feb 2021 18:11:24 +0000 (UTC)
IronPort-SDR: bpXAqL5wcQ2Jkt7hXhcfRqCr+9uEKUymftfa6A4egM9ou6+1bFGGBcqqcDFhBP9UvRL6ZaGPsx
 vvcPQ8XD07LA==
X-IronPort-AV: E=McAfee;i="6000,8403,9885"; a="181447768"
X-IronPort-AV: E=Sophos;i="5.81,153,1610438400"; d="scan'208";a="181447768"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Feb 2021 10:11:23 -0800
IronPort-SDR: fa44XzskmXWtUBIRPljlP2r54foxwJ8wP8eBOr2MXYqua2CqR/uV2HNxvbijgNeI6ZBfwhQ1HT
 TrwY1y6Au8Hw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,153,1610438400"; d="scan'208";a="415267672"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.171])
 by FMSMGA003.fm.intel.com with SMTP; 04 Feb 2021 10:11:21 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 04 Feb 2021 20:11:20 +0200
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  4 Feb 2021 20:10:44 +0200
Message-Id: <20210204181048.24202-11-ville.syrjala@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 10/14] drm/i915: Extract _cnl_ddi_{enable,
 disable}_clock()
...

...
ICFwbGwpKQpAQCAtMzE0NiwxNiArMzE3MiwxMCBAQCBzdGF0aWMgdm9pZCBkZzFfZGRpX2VuYWJs
...
ZGRpX2Rpc2FibGVfY2xvY2soc3RydWN0IGludGVsX2VuY29kZXIgKmVuY29kZXIpCkBAIC0zMTYz
LDE5ICszMTgzLDE1IEBAIHN0YXRpYyB2b2lkIGRnMV9kZGlfZGlzYWJsZV9jbG9jayhzdHJ1Y3Qg
...
QEAgLTMxOTcsMjQgKzMyMTMsOCBAQCBzdGF0aWMgdm9pZCBpY2xfZGRpX2NvbWJvX2VuYWJsZV9j
...
X2VuY29kZXIgKmVuY29kZXIpCkBAIC0zMjIzLDE5ICszMjIzLDEzIEBAIHN0YXRpYyB2b2lkIGlj
...
Y2xrX29mZihzdHJ1Y3QgZHJtX2k5MTVfcHJpdmF0ZSAqZGV2X3ByaXYsCkBAIC0zNDQyLDIwICsz
NDM2LDEwIEBAIHN0YXRpYyB2b2lkIGNubF9kZGlfZW5hYmxlX2Nsb2NrKHN0cnVjdCBpbnRlbF9l
...
ZV9jbG9jayhzdHJ1Y3QgaW50ZWxfZW5jb2RlciAqZW5jb2RlcikKQEAgLTM0NjMsMTIgKzM0NDcs

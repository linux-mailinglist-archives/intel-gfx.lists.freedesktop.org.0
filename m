...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB3E267BCEC
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:38:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6631110E892;
...
Subject: [Intel-gfx] [PATCH v3 11/19] dyndbg-API: specialize

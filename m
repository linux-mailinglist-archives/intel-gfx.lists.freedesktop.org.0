...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C746232FA3
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Jul 2020 11:38:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 662CF6E8B5;
	Thu, 30 Jul 2020 09:38:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AEAB56E169
 for <intel-gfx@lists.freedesktop.org>; Thu, 30 Jul 2020 09:38:09 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21979060-1500050 
 for multiple; Thu, 30 Jul 2020 10:38:01 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 30 Jul 2020 10:37:47 +0100
Message-Id: <20200730093756.16737-13-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/21] drm/i915/gt: Only transfer the virtual
...
Cc: "Nayana, Venkata Ramana" <venkata.ramana.nayana@intel.com>,
 thomas.hellstrom@intel.com, Chris Wilson <chris@chris-wilson.co.uk>

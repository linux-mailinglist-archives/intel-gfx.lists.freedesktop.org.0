...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E31659916E
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Aug 2022 01:44:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A356810ED2C;
...
Subject: [Intel-gfx] [PATCH v2 14/21] drm/i915/mtl: memory latency data from

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 43D976B08C6
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9FAB10E5F0;
	Wed,  8 Mar 2023 13:29:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1455910E5DC;
 Wed,  8 Mar 2023 13:29:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678282155; x=1709818155;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=z18H5rnG5rdWAosAE0Cknh0TC7WZCPg+Sxra/8Wu7Cg=;
 b=V71iFcOzXG9gRSCV2at5OBYo/NRDuEQceSk+nmMAvu+JBczQcDOw4RyM
 3H0CLfNeuH/YDuDUz0ww+p+zY+/fVPLRO0BBdRCgYBT2RXWXoM7/8sEkI
 9A1gLJjHsPHVlkrWg7BwlS5mgg/DUi0+oyCAX+HPFdh0bbxks1NCpfCSj
 sLCpY5JCA+efuFIkfqb8IPeyhRunB+x82eshANctGutjEk/+9s3u92N5V
 Q1M0G+eo46vwRqqFU7UQrRlhQtuz2Op6wN/gCzKEBHJCPHh2ZY7cRlYTU
 Se6UMUqt8KNVa/AOH7Go8Hp16GGJ+H8XygPCmt5GwfR871iS/UqMQeCiS Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10642"; a="336165130"
X-IronPort-AV: E=Sophos;i="5.98,244,1673942400"; d="scan'208";a="336165130"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Mar 2023 05:29:14 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10642"; a="922789298"
X-IronPort-AV: E=Sophos;i="5.98,244,1673942400"; d="scan'208";a="922789298"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
 by fmsmga006.fm.intel.com with ESMTP; 08 Mar 2023 05:29:12 -0800
From: Yi Liu <yi.l.liu@intel.com>
To: alex.williamson@redhat.com,
	jgg@nvidia.com,
	kevin.tian@intel.com
Date: Wed,  8 Mar 2023 05:28:43 -0800
Message-Id: <20230308132903.465159-5-yi.l.liu@intel.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230308132903.465159-1-yi.l.liu@intel.com>
References: <20230308132903.465159-1-yi.l.liu@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v6 04/24] kvm/vfio: Rename kvm_vfio_group to

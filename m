...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AB82340ADF
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Mar 2021 18:04:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E1CC16E0EB;
	Thu, 18 Mar 2021 17:04:28 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 05E1B6E92B;
 Thu, 18 Mar 2021 17:04:27 +0000 (UTC)
IronPort-SDR: o6XnlrfOahb7ObB50Quv3neW0BX+gQ+8s/jsePHt6Ua5MgQB+IrSrhhfPDMpvvtVl/JrdjIlCg
 pX7+C3bBDZBw==
X-IronPort-AV: E=McAfee;i="6000,8403,9927"; a="209733836"
X-IronPort-AV: E=Sophos;i="5.81,259,1610438400"; d="scan'208";a="209733836"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Mar 2021 10:04:27 -0700
IronPort-SDR: tNRowEcFsagdAjjexagMQ2sA+HQr4WRD5/gnUAkX+PIO1ZD/MPO+ZKcW2ZvSxwvkxyA7oY3GWf
 XhP9XGABeNDg==
X-IronPort-AV: E=Sophos;i="5.81,259,1610438400"; d="scan'208";a="413164893"
Received: from syeghiay-mobl.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.252.51.182])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Mar 2021 10:04:25 -0700
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 18 Mar 2021 17:04:14 +0000
Message-Id: <20210318170419.2107512-2-tvrtko.ursulin@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/6] drm/i915: Individual request cancellation

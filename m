...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 284B2ADCE84
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Jun 2025 15:59:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B281C10E711;
	Tue, 17 Jun 2025 13:59:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ZSNZkArC";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DC40210E702;
 Tue, 17 Jun 2025 13:59:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1750168764; x=1781704764;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=WvLWJRAv8idelb+wbiysTqm+mBTnrzkj5Bl282lOSrk=;
 b=ZSNZkArCJfph6hbnFLvRk8WcC5G+bvpMZUr9pRC3truUfyyBB0qv+6Jt
 ptWqiFNzZ4VX5tyLzi3NUpCgjLjjkrTmZOPSbveWZaq0ih4DKU9fviHLz
 rq5ypT8HV8IhvANz2Wa45FdBdLb3ZSZ3KvgRMcEjPB1CZDP/lxBfF5Kxu
 fBCjjl0Y8+d4FHWaY6bHBnHgZ5zALSVVxZM1NtVFoNxRPjhYpZlMuUyiC
 DEIiK0Ul61RNoGfGygiDcTdV79qQGpm+tvdD2k21JC7IY/ouj12f0a1ZE
 nwRYWcx9rv9c9yFDWH49QtFLGwWL2zrvObaSkMGM4Ec5bEaAMbQhqPPhb Q==;
X-CSE-ConnectionGUID: 4D/oTQBERWyXa+IGFY1zGQ==
X-CSE-MsgGUID: jEwHk0xeRqC8/yebdjOG/w==
X-IronPort-AV: E=McAfee;i="6800,10657,11467"; a="56026513"
X-IronPort-AV: E=Sophos;i="6.16,243,1744095600"; d="scan'208";a="56026513"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2025 06:59:23 -0700
X-CSE-ConnectionGUID: +TZD++AcRbmdfhPS3xwoHg==
X-CSE-MsgGUID: O1/1xVXgTTuOECAmH2hHRg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.16,243,1744095600"; d="scan'208";a="153739481"
...
Subject: [PATCH v13 03/10] mtd: intel-dg: implement access functions
Date: Tue, 17 Jun 2025 16:45:25 +0300
Message-ID: <20250617134532.3768283-4-alexander.usyskin@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 56EFF4CC930
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Mar 2022 23:37:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 31B7810E3AA;
...
Subject: [Intel-gfx] [PATCH v3 1/4] drm/i915/guc: Limit scheduling

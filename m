...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 151BE6DF3C9
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Apr 2023 13:34:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F12010E7A3;
...
Subject: [Intel-gfx] [PATCH v5 4/5] drm/i915: Throttle for ringspace prior

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8272983DC2
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2024 09:17:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B1D510E4FD;
	Tue, 24 Sep 2024 07:17:43 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="pADx7l97";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="hcOU1KdE";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="pADx7l97";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="hcOU1KdE";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1FEF610E4E7;
 Tue, 24 Sep 2024 07:17:41 +0000 (UTC)
Received: from imap1.dmz-prg2.suse.org (unknown [10.150.64.97])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-out2.suse.de (Postfix) with ESMTPS id D07901F788;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 ...
 b=pADx7l97xH5pGTHZbogyZoCNZcAClV+8FESDgLwIjuDCI2t7mN+C7O9ZLAPZOOa16E7S4R
 SxgN1PTB610tn+YxG0DNB+chpPRiL5jVYGv7tF+4aoRGpZdqPTGbjFGJ7rLgsBkNAwRdXG
 6RC4m3NZxObIO/3qLVF/kGgZJ/sUyjg=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 ...
 in-reply-to:in-reply-to:references:references;
 bh=XS+ckVVnRgJoRgkpzuBUKeGdZ3Genb5xJvB9E7pFLNo=;
 b=hcOU1KdEpAr3DfYZ98obvZqLZkqmiT6YQtv2H5fvcw+6kqVtnJChOR3uXogXJHY9Sx9XMm
 fE6hL8DhxD+wMpCQ==
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 92DE113AE2;
 Tue, 24 Sep 2024 07:17:39 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id 2FmrIpNn8mb3YAAAD6G6ig
...
Subject: [PATCH v5 03/80] drm/fbdev: Add memory-agnostic fbdev client
Date: Tue, 24 Sep 2024 09:12:01 +0200
Message-ID: <20240924071734.98201-4-tzimmermann@suse.de>

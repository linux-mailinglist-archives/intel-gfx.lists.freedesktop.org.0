...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 987EE21EFB0
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 13:45:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 186DB6E95A;
	Tue, 14 Jul 2020 11:45:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A2AF46E953
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Jul 2020 11:45:21 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Jul 2020 13:45:05 +0200
Message-Id: <20200714114516.3073222-12-maarten.lankhorst@linux.intel.com>
...
+static void eb_unpin_engine(struct i915_execbuffer *eb);
 ...
 {
@@ -924,7 +929,7 @@ eb_get_vma(const struct i915_execbuffer *eb, unsigned long handle)
 	}
 }
...
+static void eb_release_vmas(struct i915_execbuffer *eb, bool final)
 {
 	...
 	unsigned int i;
@@ -941,6 +946,8 @@ static void eb_release_vmas(const struct i915_execbuffer *eb, bool final)
 		if (final)
 			i915_vma_put(vma);
 	}
+
...
+		intel_context_unpin(ce);
 	...
 	if (IS_ERR(rq)) {
 		err = PTR_ERR(rq);
@@ -1860,7 +1874,8 @@ static int eb_prefault_relocations(const struct i915_execbuffer *eb)
 	return 0;
 }
...
+					   struct i915_request *rq)
 {
 	...
 	struct eb_vma *ev;
@@ -1876,6 +1891,21 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
...
+
 	 ...
 	 *
@@ -1899,14 +1929,25 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
 		err = 0;
 	}
...
+
 	...
 	if (err)
 		goto err;
@@ -1977,14 +2018,49 @@ static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
 		}
 	}
...
+
 	...
 	if (err == -EAGAIN)
 		goto slow;
@@ -2021,7 +2097,7 @@ static int eb_relocate_parse(struct i915_execbuffer *eb)
 	return err;
...
+
 ...
 {
@@ -2873,6 +2954,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -2928,7 +3010,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	if (unlikely(err))
 		goto err_destroy;
...
@@ -3066,8 +3148,10 @@ i915_gem_do_execbuffer(struct drm_device *dev,

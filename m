...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E539F48EF00
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jan 2022 18:08:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 62B6010E51C;
	Fri, 14 Jan 2022 17:08:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6AFB710E51C;
 Fri, 14 Jan 2022 17:08:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1642180120; x=1673716120;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=Qj/PIjSXTE/QXVu9bhw1Kb0pxhURHFrcCeR2KiXmZws=;
 b=goK9ZJSuZ1/Je5446utWe/8htpYz17HCwxHuSv1Dnz8gLI+C6FPaT4Zg
 D3v0h5ywui0rPOW78JJetZTxTvMQRXeTgZLd72/96bNgPtqrw1sFkSeSq
 5MtXatJq2y/8RoH3+QRz8LzYbkVc4tz2Im3bN+jInC95DIU29CjU4f21g
 7TojCdqtYoK1Vpq2qVMUWo6NcJfi3d1mZ1VAi00bwAlY7Rbe0y036CFew
 xjJO8PBHnouzJNulKAZt4Zcnfej/3VqeY8KCCx+8FKTdL8jYupeqiA562
 C2U4su9/3TxlyvJZJ+BpxHfMjR36C4h2TDiUExrmYCt71mbnPISApuDxs Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10227"; a="231636188"
X-IronPort-AV: E=Sophos;i="5.88,289,1635231600"; d="scan'208";a="231636188"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jan 2022 09:08:39 -0800
X-IronPort-AV: E=Sophos;i="5.88,289,1635231600"; d="scan'208";a="670912821"
Received: from mdroper-desk1.fm.intel.com (HELO
 mdroper-desk1.amr.corp.intel.com) ([10.1.27.134])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jan 2022 09:08:39 -0800
Date: Fri, 14 Jan 2022 09:08:38 -0800
From: Matt Roper <matthew.d.roper@intel.com>
To: Andi Shyti <andi.shyti@linux.intel.com>
Message-ID: <YeGuFsMLL5kxzTiu@mdroper-desk1.amr.corp.intel.com>
...
Subject: Re: [Intel-gfx] [PATCH v2 2/2] drm/i915/gt: make a gt sysfs group

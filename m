...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 756C771A3AB
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 18:05:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9E86F10E585;
	Thu,  1 Jun 2023 16:05:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A6BB110E585
 for <intel-gfx@lists.freedesktop.org>; Thu,  1 Jun 2023 16:05:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685635519; x=1717171519;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=i56j+AsLzARKA9u4bHAP9ta4xLf7fG6gYXB4gP9+8hs=;
 b=m8CePujes8lsJuxvq2z8IR8oxEC9O20Rdfr7VpqF8M70QxCHLZuDhypt
 4iTeWOQ3JhlgBQwIvq1L63D8oG9MW58J8C9zblhL6A99EzjKUhcm7qiW+
 vHrdKtjVXjlkE+mxTJX3RiN/pJ72ulmHHIIhxCuAid7DyJOsIdvNyaa/h
 U4PTkaLm3d36eB79i1QwKtDGWq0vJFN3a4C+5aPksoyTTV2Raur7B9+sd
 HzgpXo0zTzeH7VesUZb3/mJbeeVqywE0um8YOB+1uGky/gyKLsfYo79Z/
 FGGEqUI+bykIAZ9U0eMn2jIwlaB3FXpxzMdWpaRp/4B4d+z658ncoX2bd w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10728"; a="358024974"
X-IronPort-AV: E=Sophos;i="6.00,210,1681196400"; 
 d="scan'208,223";a="358024974"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2023 09:04:25 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10728"; a="701608562"
X-IronPort-AV: E=Sophos;i="6.00,210,1681196400"; 
 d="scan'208,223";a="701608562"
Received: from unknown (HELO vgovind2-mobl3.fi.intel.com) ([10.237.66.43])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Jun 2023 09:04:23 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  1 Jun 2023 19:03:49 +0300
Message-Id: <20230601160350.43888-7-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v12 6/7] drm/i915/mtl: find the best QGV point

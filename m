...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7CE314C97DA
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Mar 2022 22:37:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EB43010E2AE;
...
Subject: [Intel-gfx] [PATCH v6] drm/i915/gt: Clear compress metadata for
 Xe_HP platforms

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 318267839AB
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Aug 2023 08:04:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D1D5610E2D6;
	Tue, 22 Aug 2023 06:04:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7D56210E2D6
 for <intel-gfx@lists.freedesktop.org>; Tue, 22 Aug 2023 06:04:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692684258; x=1724220258;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=ILP+4X8YxVijxYCn9+aaLOKjzZZzRhQFBhlvL+YKIfY=;
 b=dWcIPWVtOsj4IPX+62DMEgh29PjT7NDrT2Nwxo0cy7IJLkMMowIN1AKE
 ECj0wzUYD2/q57XSn5m2LVdBkbQb+VsZFI+ZE+E5cNqLVW8a2RYHYIGXc
 IGCh810jWTkre0qvfWTJ+/h4Lg3q5dWm9UD8COHXbvliNsMAdDYJoVJZP
 6y7GCcLPyjsL3+gfSTGymaPltUspUDNQpptdkeUB5Qmvqqt+gJtZYuHGa
 lqbAcqeDOEe+VlvEyyozGKXHLA8Bt8xLCNCgntYtH6bYdFMWLzMSY82i0
 Qe55OaZVk5Hi9ddjvzU0d62zZPgNRO+5d+AxXdpI22kb+au9TfH/p1fDA A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10809"; a="354119303"
X-IronPort-AV: E=Sophos;i="6.01,192,1684825200"; d="scan'208";a="354119303"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Aug 2023 23:04:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10809"; a="806163011"
X-IronPort-AV: E=Sophos;i="6.01,192,1684825200"; d="scan'208";a="806163011"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga004.fm.intel.com with ESMTP; 21 Aug 2023 23:04:16 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 22 Aug 2023 11:32:33 +0530
Message-Id: <20230822060240.413101-1-suraj.kandpal@intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v9 0/8] Add DSC PPS readout

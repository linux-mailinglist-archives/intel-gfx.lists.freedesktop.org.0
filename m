...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E71B1512E3
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Feb 2020 00:20:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8AD096E45C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 00/17] In order to readout DP SDPs,

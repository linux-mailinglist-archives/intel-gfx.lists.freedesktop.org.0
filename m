...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B662553E4D
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jun 2022 00:07:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87AC010EBEF;
...
Subject: Re: [Intel-gfx] [PATCH v2 08/12] drm/i915/uapi: tweak error capture
 on recoverable contexts

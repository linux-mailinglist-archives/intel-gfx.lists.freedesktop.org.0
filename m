...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CCDE42CBFAE
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Dec 2020 15:31:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DD246EA46;
...
Subject: [Intel-gfx] [PATCH v3 02/13] drm/edid: Parse MAX_FRL field from
 HFVSDB block

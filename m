...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7CE7B25F13A
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Sep 2020 02:55:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B37E76E0C5;
...
Subject: [Intel-gfx] [PATCH v1 03/12] drm/i915: vgpu pv command buffer
 transport protocol

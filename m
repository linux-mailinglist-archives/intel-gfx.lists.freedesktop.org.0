...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B2D37CE382
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:06:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F03F310E412;
	Wed, 18 Oct 2023 17:06:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-xd2c.google.com (mail-io1-xd2c.google.com
 [IPv6:2607:f8b0:4864:20::d2c])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 375C610E405;
 Wed, 18 Oct 2023 17:06:16 +0000 (UTC)
Received: by mail-io1-xd2c.google.com with SMTP id
 ca18e2360f4ac-7a66ff282baso22445239f.0; 
 Wed, 18 Oct 2023 10:06:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1697648775; x=1698253575; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=nT2UcGPT6Cy6K92hgVjA+Vm5zzO1oFmjE5g1Jwvt+zM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=nT2UcGPT6Cy6K92hgVjA+Vm5zzO1oFmjE5g1Jwvt+zM=;
 b=
X-Gm-Message-State: AOJu0Yx4egPAQtg/RUs7LP6XYkz7C1cyqPp5OMGISh23nG83jhmY138r
 OLej/F06jryfd4DOL4UVZJA=
X-Google-Smtp-Source: AGHT+IEEFMNpCVSGXQqaTv+NE2rtvj56VUp3M8UELCu0RDnUkQIiP8gYA7Pe7Vwc7f27D2ZeuxSFGQ==
X-Received: by 2002:a05:6602:160a:b0:794:eb37:b0da with SMTP id
 x10-20020a056602160a00b00794eb37b0damr5194062iow.2.1697648775455; 
 Wed, 18 Oct 2023 10:06:15 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 n4-20020a5d8244000000b0079fa1a7cd36sm1228944ioo.30.2023.10.18.10.06.14
...
Subject: [Intel-gfx] [PATCH v7c 05/24] dyndbg: ddebug_apply_class_bitmap -

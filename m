...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 717C02E704F
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Dec 2020 13:02:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A605689319;
	Tue, 29 Dec 2020 12:02:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 61C30892FD
 for <intel-gfx@lists.freedesktop.org>; Tue, 29 Dec 2020 12:02:07 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 23455182-1500050 
 for multiple; Tue, 29 Dec 2020 12:01:51 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 29 Dec 2020 12:01:17 +0000
Message-Id: <20201229120145.26045-28-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 28/56] drm/i915: Extract request suspension from
...
index 4c96781cdb92..08af2fccbe9d 100644
--- a/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
+++ b/drivers/gpu/drm/i915/gt/intel_execlists_submission.c
@@ -1884,166 +1884,26 @@ static void post_process_csb(struct i915_request **port,
...
index 6b92523b9259..db31906ad9ec 100644

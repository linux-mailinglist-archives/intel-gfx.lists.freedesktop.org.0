...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DBC4890D5
	for <lists+intel-gfx@lfdr.de>; Sun, 11 Aug 2019 11:01:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D8D06E301;
...
Subject: Re: [Intel-gfx] [PATCH 4/4] dma-fence: Always execute signal
 callbacks

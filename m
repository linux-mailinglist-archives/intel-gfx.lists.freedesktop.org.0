...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF4881A6BB8
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Apr 2020 19:57:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 95C3F89FE8;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH] drm/i915/gvt: Use ARRAY_SIZE instead of
 hardcoded size

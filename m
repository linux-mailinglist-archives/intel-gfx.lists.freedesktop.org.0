...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 716BBADA9C0
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Jun 2025 09:44:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00A3C10E2A6;
	Mon, 16 Jun 2025 07:44:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 1538d3639d33 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5ABED10E2A6;
 Mon, 16 Jun 2025 07:44:17 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============8377984976215955846=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=93_i915=2ECI=2EBAT=3A_success_for_drm/i915/dsb=3A_DSB_fixed?=
 =?utf-8?q?_and_flip_queue_prep_work_=28rev3=29?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: =?utf-8?b?VmlsbGUgU3lyasOkbMOk?= <ville.syrjala@linux.intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Mon, 16 Jun 2025 07:44:17 -0000
Message-ID: <175005985736.80934.16120448115916820379@1538d3639d33>
...
#### Issues hit ####
  ...
  * igt@dmabuf@all-tests@dma_fence_chain:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_16704/fi-bsw-n3050/igt@dmabuf@all-tests@dma_fence_chain.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_150172v3/fi-bsw-n3050/igt@dmabuf@all-tests@dma_fence_chain.html

  * igt@i915_selftest@live:
    - bat-adlp-6:         [PASS][3] -> [ABORT][4] ([i915#14477])
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_16704/bat-adlp-6/igt@i915_selftest@live.html
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_150172v3/bat-adlp-6/igt@i915_selftest@live.html
...
#### Warnings ####
  ...
  * igt@i915_selftest@live@mman:
  ...
  [i915#14477]: https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/14477
...
<ul>
<li>bat-adlp-6:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_16704/bat-adlp-6/igt@i915_selftest@live.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_150172v3/bat-adlp-6/igt@i915_selftest@live.html">ABORT</a> (<a href="https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/14477">i915#14477</a>)</li>
</ul>
</li>
<li>

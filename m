...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5932A63D71B
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Nov 2022 14:48:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7B3AA10E454;
	Wed, 30 Nov 2022 13:48:25 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v5 4/4] xhci: Convert to use list_count_nodes()

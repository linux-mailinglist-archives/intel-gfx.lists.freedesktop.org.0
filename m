...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 23DC620FEF7
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:30:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3F0416E430;
...
Subject: [Intel-gfx] [PATCH 37/59] drm/kmb: Set MSS_CAM_RSTN_CTRL along with
 enable

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7294CC27629
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:05:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09FBD10E334;
	Sat,  1 Nov 2025 03:05:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="biXMG6Gf";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3397410E332;
 Sat,  1 Nov 2025 03:05:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761966303; x=1793502303;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GiZ0bRTYFaPnxCaETSoWl3NOfxSRELxEn/C7e8cx/20=;
 b=biXMG6GfR9L7uL0tVKKoFETLl06IZYDZdR5y18Tczv5TVvy7JXDgQ+j+
 EhbIwMam5i0CPlKf1+fDw1V0vM3saaO5cCs2ppXhehgKADfkfSm0zDcJQ
 3A3tW6P5aoVfTSu4KEyXoUVIapuflu1VLNygxhH6UGIrsM2yN+wFIszAR
 VcA6QAzGvo42jBAdI4XyZV3I71H51rZOUJ2y3JYV6M0FYHLVyBIqgBny/
 ju5EjfFL6QSiCTOrbqhOirc7DFCtCwf0+bugl3tCju/4tNK4nwhfcNsSQ
 I7nul+CE9ORBgzuWyb8uZtOMAhyS6cGunoESeEtpPzoX3h0TKWWgWuPnJ Q==;
X-CSE-ConnectionGUID: Q+SzSOUJRsyQQqpCDj2+qA==
X-CSE-MsgGUID: sq41HUEpRLqnwbwmi2I0EA==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="81759512"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="81759512"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:05:03 -0700
X-CSE-ConnectionGUID: PGBJ9hc3QeeAtx9SXDpX4Q==
X-CSE-MsgGUID: wiZqlV3jRBaydfRUXNNpbQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217222601"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa001.fm.intel.com with ESMTP; 31 Oct 2025 20:04:58 -0700
...
Subject: [PATCH v4 08/25] drm/i915/ltphy: Add LT Phy Programming recipe tables
Date: Sat,  1 Nov 2025 08:34:17 +0530
Message-Id: <20251101030434.4159839-9-suraj.kandpal@intel.com>

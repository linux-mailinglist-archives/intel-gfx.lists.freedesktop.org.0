...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D053547F952
	for <lists+intel-gfx@lfdr.de>; Sun, 26 Dec 2021 23:25:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2C10C10F5D6;
...
Subject: [Intel-gfx] [PATCH v6 4/6] drm: implement a method to free unused
 pages

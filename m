...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF76079F4DF
	for <lists+intel-gfx@lfdr.de>; Thu, 14 Sep 2023 00:21:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 25DA510E114;
...
Subject: Re: [Intel-gfx] [PATCH v1 1/1] drm/i915/pxp: Add drm_dbgs for
 critical PXP events.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C71E164B4D
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Feb 2020 18:00:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ABC4989056;
	Wed, 19 Feb 2020 17:00:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2F15188E45;
 Wed, 19 Feb 2020 17:00:50 +0000 (UTC)
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl
 [83.86.89.107])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id 84DA42464E;
 Wed, 19 Feb 2020 17:00:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1582131650;
 bh=u5ubNVSideiATrIpAfUyZXvo8LeEx5Hj94snLPs+yd4=;
 h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
 b=ib4uFl4HcJBYtdtbEYJrM6W0YzfwLrP8xiL5S6W91UPhuzhPj3DGVndVSvFkY6Fdh
 bLQgZQUyubTDZjIs9KIc60DSZwxxa2olw/kWJPhAQFuc2uQg8k0eTimCabc1UFgqgF
 GCKDFNmxBpR9SHZc79zbp67/B3+PT2yYftVtuZdQ=
Date: Wed, 19 Feb 2020 18:00:46 +0100
From: Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To: Daniel Vetter <daniel.vetter@ffwll.ch>
Message-ID: <20200219170046.GA2846129@kroah.com>

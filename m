...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 780553AF88
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Jun 2019 09:21:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5592389122;
	Mon, 10 Jun 2019 07:21:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0064C89130
 for <intel-gfx@lists.freedesktop.org>; Mon, 10 Jun 2019 07:21:50 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16848358-1500050 
 for multiple; Mon, 10 Jun 2019 08:21:28 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 10 Jun 2019 08:21:03 +0100
Message-Id: <20190610072126.6355-6-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/28] drm/i915: Make the semaphore saturation
 mask global
...
Z3QvaW50ZWxfbHJjLmMKaW5kZXggNDk3YWMwMzZjNGE5Li42MjIyMGNmOWQyODEgMTAwNjQ0Ci0t

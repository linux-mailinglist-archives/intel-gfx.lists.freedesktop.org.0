...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45B0A67BBFC
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:05:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A878D10E892;
...
Subject: [Intel-gfx] [PATCH v3 08/10] drm/fbdev-generic: Minimize client
 unregistering

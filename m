...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A9031B3328
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Apr 2020 01:31:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F284E6E33C;
	Tue, 21 Apr 2020 23:31:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D0D336E33C
 for <intel-gfx@lists.freedesktop.org>; Tue, 21 Apr 2020 23:30:59 +0000 (UTC)
IronPort-SDR: T5T1SQGYR5YYHxK0I1BxrNe4io135QaHZx9vah/wrnnjiQXA/gE7TEiE3e6UF11HMNIlzxen3o
 kG1yp4sm55UA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Apr 2020 16:30:59 -0700
IronPort-SDR: F4eUc/wis1pQ43wY4fEBuP+kvKo3KB+SJ8otM9KrJNXq6F9OSeoMYPrOhIVDBET188rDtRs/X4
 wWEDWkkzQ4kA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,411,1580803200"; d="scan'208";a="245815918"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO intel.com)
 ([10.165.21.211])
 by fmsmga007.fm.intel.com with ESMTP; 21 Apr 2020 16:30:59 -0700
Date: Tue, 21 Apr 2020 16:32:17 -0700
From: Manasi Navare <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20200421233216.GA24080@intel.com>
References: <20200212161738.28141-1-ville.syrjala@linux.intel.com>
 ...
 <20200402135506.GW13686@intel.com>
MIME-Version: 1.0
...
On Thu, Apr 02, 2020 at 04:55:06PM +0300, Ville Syrj=E4l=E4 wrote:
...
> > > @@ -6233,42 +6233,42 @@ static void skl_pfit_enable(const struct inte=
...
e)
> > > @@ -6277,22 +6277,23 @@ static void ilk_pfit_enable(const struct inte=
l_crtc_state *crtc_state)
...
Okay everything else flattening things in the functions make sense for read=
ability
...
> > > @@ -7107,11 +7108,12 @@ void ilk_pfit_disable(const struct intel_crtc=
_state *old_crtc_state)
> > >  =

> > >  	/* To avoid upsetting the power well on haswell only disable the pf=
it if
...
> > > @@ -7927,39 +7929,35 @@ static bool intel_crtc_supports_double_wide(c=
onst struct intel_crtc *crtc)
> > >  		(crtc->pipe =3D=3D PIPE_A || IS_I915G(dev_priv));
> > >  }
> > >  =

> > > -static u32 ilk_pipe_pixel_rate(const struct intel_crtc_state *pipe_c=
onfig)
...
rtc_state)
> > > @@ -9153,9 +9151,9 @@ static bool i9xx_has_pfit(struct drm_i915_priva=
te *dev_priv)
...
> > > @@ -9175,9 +9173,9 @@ static void i9xx_get_pfit_config(struct intel_c=
rtc *crtc,
> > >  			return;
> > >  	}
> > >  =
...
> > > @@ -9427,7 +9425,7 @@ static bool i9xx_get_pipe_config(struct intel_c=
rtc *crtc,
...
> > > @@ -10393,37 +10391,37 @@ static void ilk_get_fdi_m_n_config(struct i=
ntel_crtc *crtc,
...
> > > -	struct intel_crtc_scaler_state *scaler_state =3D &pipe_config->scal=
er_state;
> > > -	u32 ps_ctrl =3D 0;
> > > +	struct intel_crtc *crtc =3D to_intel_crtc(crtc_state->uapi.crtc);
> > > +	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
> > > +	struct intel_crtc_scaler_state *scaler_state =3D &crtc_state->scale=
r_state;
> > >  	int id =3D -1;
> > >  	int i;
> > >  =
...
> > >  static void
> > > @@ -10559,30 +10557,29 @@ skl_get_initial_plane_config(struct intel_c=
rtc *crtc,
> > >  	kfree(intel_fb);
> > >  }
> > >  =
...
> > > @@ -10694,7 +10691,7 @@ static bool ilk_get_pipe_config(struct intel_=
crtc *crtc,
> > >  	intel_get_pipe_timings(crtc, pipe_config);
> > >  	intel_get_pipe_src_size(crtc, pipe_config);
> > >  =
...
> > > @@ -11219,9 +11216,9 @@ static bool hsw_get_pipe_config(struct intel_=
crtc *crtc,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FDD570BDAC
	for <lists+intel-gfx@lfdr.de>; Mon, 22 May 2023 14:22:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 966FE10E32D;
...
Subject: [Intel-gfx] [PATCH v3 10/12] drm/fb-helper: Export helpers for

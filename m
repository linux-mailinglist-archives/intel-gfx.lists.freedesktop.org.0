...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A7F285A336C
	for <lists+intel-gfx@lfdr.de>; Sat, 27 Aug 2022 03:19:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9B5B10EAE9;
	Sat, 27 Aug 2022 01:19:39 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH][next] drm/i915/guc: Fix spelling mistake
 "heatbeat" -> "heartbeat"

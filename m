...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A0906A3C0D
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Feb 2023 09:12:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9B87E10E36B;
	Mon, 27 Feb 2023 08:12:46 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4 0/3] drm/helpers: Make the suballocation
 manager drm generic

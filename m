...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A16395A4DA1
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:19:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BA7510F277;
	Mon, 29 Aug 2022 13:19:04 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D094510F274
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Aug 2022 13:18:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661779133; x=1693315133;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=bOZb1+IZfHJocMWJRGduNRm03dMPb9AHZclnRntX9ug=;
 b=HsRl4BtTK7IRPdumv38y03rz5xHUZ/nWhh8c23setn3eEB7b0hUhrh4e
 CXvGgWY6/+ZAAl8+i1B/YUtyVs7b79fqt+WqiBPUtYu1HgNwwaDnGP+Mq
 8vPhVHE5Ne5reY7CSi2ZaWzgV4cYE3Wi40GBMtAKl5e0UocD/pztAKD/4
 egXCcAtqAtlFSB8+vo282vR9LqaikkrjWqtgHClj6n1z4mgs+dBpysi11
 UHtmllAyxo88ymMGG7JQ+1mDorfLwLrvzKrrLElt1d+mp/ZSWb7+2ZZ9I
 m0Uqdl14Xp5uml8535TZ3DagURCTGhcptuqQu1uJCCgRiYQOGKjjnN9VG g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10454"; a="281861660"
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="281861660"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:18:52 -0700
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="562215985"
Received: from idecesar-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.53.198])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:18:50 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 29 Aug 2022 16:18:11 +0300
Message-Id: <7df23655be5dc70fb1a2b43ce41e1682e40395d8.1661779055.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 04/18] drm/i915: move and group cdclk under
 display.cdclk
...
index 72e2091d9fcb..7f978612ddc6 100644
...
index b19a1bc26277..438a368ba358 100644
...
index 21a7d2d83703..2dd9233ebc63 100644

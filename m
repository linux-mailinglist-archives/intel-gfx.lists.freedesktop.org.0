...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 498AADE5D6
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Oct 2019 10:03:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7824D89B5F;
	Mon, 21 Oct 2019 08:02:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3BA2D89B06
 for <intel-gfx@lists.freedesktop.org>; Mon, 21 Oct 2019 08:02:47 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18908659-1500050 
 for multiple; Mon, 21 Oct 2019 09:02:31 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 21 Oct 2019 09:02:20 +0100
Message-Id: <20191021080226.537-10-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.24.0.rc0
In-Reply-To: <20191021080226.537-1-chris@chris-wilson.co.uk>
References: <20191021080226.537-1-chris@chris-wilson.co.uk>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 10/16] drm/i915/gt: Introduce barrier pulses
 along engines
...
ZmlsZQppbmRleCA3NjFkOWE3MGFmY2QuLjliMzI2ODAzODUzNSAxMDA2NDQKLS0tIGEvZHJpdmVy
...
SU9OIChJOTE1X1BSSU9SSVRZX1dBSVQpCiAKLS0gCjIuMjQuMC5yYzAKCl9fX19fX19fX19fX19f

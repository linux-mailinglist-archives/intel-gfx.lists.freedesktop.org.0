...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C8B86B0DE8
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Sep 2019 13:34:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B8DF6ECDE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 4/7] drm/i915/dp: Attach colorspace property

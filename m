...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC3FD6B58FF
	for <lists+intel-gfx@lfdr.de>; Sat, 11 Mar 2023 07:38:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D862810E09D;
	Sat, 11 Mar 2023 06:38:17 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 2/3] drm/i915/guc: Clean up of register
 capture search

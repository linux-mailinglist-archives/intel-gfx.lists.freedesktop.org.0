...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 66074DE5C5
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Oct 2019 10:02:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 785F789B0C;
	Mon, 21 Oct 2019 08:02:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EAD3B89B06
 for <intel-gfx@lists.freedesktop.org>; Mon, 21 Oct 2019 08:02:45 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18908657-1500050 
 for multiple; Mon, 21 Oct 2019 09:02:30 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 21 Oct 2019 09:02:18 +0100
Message-Id: <20191021080226.537-8-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.24.0.rc0
In-Reply-To: <20191021080226.537-1-chris@chris-wilson.co.uk>
References: <20191021080226.537-1-chris@chris-wilson.co.uk>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/16] drm/i915: Expose timeslice duration to
 sysfs
...
X2VuZ2luZS5oCmluZGV4IDkzZWEzNjdmZTYyNC4uMzkzNDgxMzc0Zjk2IDEwMDY0NAotLS0gYS9k
cml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9lbmdpbmUuaAorKysgYi9kcml2ZXJzL2dwdS9k
cm0vaTkxNS9ndC9pbnRlbF9lbmdpbmUuaApAQCAtNTI1LDQgKzUyNSwxMyBAQCB2b2lkIGludGVs
...
cnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2VuZ2luZV9jcy5jCmluZGV4IDA1MTczNGM5YjczMy4u
YjkzZGJlZDY3ZmU3IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9pbnRlbF9l
...
dC9zZWxmdGVzdF9scmMuYwppbmRleCAyYzljNzUxNjY1NzAuLjA0ODY0ZDc1ODhhMiAxMDA2NDQK

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19EBC84B2EE
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Feb 2024 11:58:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C9B910EB75;
	Tue,  6 Feb 2024 10:58:26 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="iPY0ZvqQ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9881D10E668
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Feb 2024 10:58:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1707217104; x=1738753104;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=EHXjSEm0Z1E7QGHbXnZ+d+I2WIEJacqBZZHZsTFJ5RE=;
 b=iPY0ZvqQJWVGCRtRPEXNEoZhDt0T4Qhq8sal235oJOlZxI/HS7d2Cdon
 ebkSgAREUQi8zksV8pYDGpDCCjhc19pO0we0MteTLx6+VVPUL416NqVwb
 jfVT+5526iy1DHiTR38ECOkgGjzl0lX+J58nkRWK6GzEpgeiSKws3Y5Aq
 MBeOdLwMVPlQWfecvFjsz4X2k8rYhvJ2Y3aRSwBrp4dcBH7Aj464subq+
 GIoMS7l9johyUFVIuHjv1euwHNbP3t06l8cBtvG3Vqjxe2zfwyIhmHwf5
 UeyhpNwPTyyWD6qBxY/eNibMo+K+5Ye9tXWFWKLWU+j7nL5fbdDwr/z0J Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10975"; a="26164534"
X-IronPort-AV: E=Sophos;i="6.05,247,1701158400"; d="scan'208";a="26164534"
Received: from orviesa010.jf.intel.com ([10.64.159.150])
 by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2024 02:58:24 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,247,1701158400"; 
   d="scan'208";a="1019181"
Received: from srr4-3-linux-106-armuthy.iind.intel.com ([10.190.238.56])
 by orviesa010.jf.intel.com with ESMTP; 06 Feb 2024 02:58:22 -0800
...
Subject: [RFC 3/4] drm/i915/dp: use link rate and lane count in intel_dp struct
Date: Tue,  6 Feb 2024 16:17:58 +0530
Message-Id: <20240206104759.2079133-4-arun.r.murthy@intel.com>

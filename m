...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sJiVHLu/t2n5UwEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Mar 2026 09:30:51 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E2002962D5
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Mar 2026 09:30:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7AC8210E37F;
	Mon, 16 Mar 2026 08:30:47 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="D7oF5AEc";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 779A610E344;
 Mon, 16 Mar 2026 08:30:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1773649847; x=1805185847;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=xd5ze48IKlFeoMCjfDxsDPfIrHOrmPevk6baou3x6dk=;
 b=D7oF5AEc+J2E0cY/ElOBXnC6OmLbtXvgZnbzXX/Bh653CdiPcu/fYzFh
 xk4nKF6Gan0N2ZKjMeu5RUJab5v+PpuB1wgWmjBWJ810IiqA19wf5NEHw
 o8KtEr9vy/qRtPNX5NZ4b30wFcdmd+US5o6N6P7ElEyOEIwyA0U9yum8v
 mqRcq4ApvzK4BOSq4UddWrmw7xyH3uRSgDl2Twi3V3wpLShrXrR+x5NA4
 c9RadYkx+yyc4r1lajvraS89/5Lfq1CsEtiXxFceIyZeyn26O9NpRsFi5
 pkog4SngGjt/WwcVSLeZy7hcaV+NOn0ZoRGn4nR3oJRtChUweD4YIW/qL Q==;
X-CSE-ConnectionGUID: ZpdiJF9STCqyACwzpDrJww==
X-CSE-MsgGUID: W1luoy3qSiGRtlSwyCagWg==
X-IronPort-AV: E=McAfee;i="6800,10657,11730"; a="77268204"
X-IronPort-AV: E=Sophos;i="6.23,123,1770624000"; d="scan'208";a="77268204"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by fmvoesa107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2026 01:30:45 -0700
X-CSE-ConnectionGUID: aabWqP9PRga7x1weWYKl9A==
X-CSE-MsgGUID: vVdgdwWJQyKOluZNJkDseg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,123,1770624000"; d="scan'208";a="220888986"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa006.jf.intel.com with ESMTP; 16 Mar 2026 01:30:36 -0700
...
Subject: [PATCH v3 1/7] drm: writeback: Refactor drm_writeback_connector
 structure
Date: Mon, 16 Mar 2026 14:00:03 +0530
Message-Id: <20260316083008.87466-2-suraj.kandpal@intel.com>
...
X-Spamd-Result: default: False [1.69 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[encoder.base:url,bootlin.com:email,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,intel.com:dkim,intel.com:email,intel.com:mid,arm.com:email]
X-Rspamd-Queue-Id: 1E2002962D5

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 619EEB1CA4
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Sep 2019 13:52:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0DE4F6EF39;
...
Subject: [Intel-gfx] [PATCH 9/9] drm/print: rename drm_debug to __drm_debug
 to discourage use

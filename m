...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D4DF719F4D9
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Apr 2020 13:38:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CFBF66E38A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/18] drm/i915/pm: Prefer drm_WARN_ON over
 WARN_ON

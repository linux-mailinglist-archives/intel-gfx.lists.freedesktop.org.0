...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 29B645594AB
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Jun 2022 10:05:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3832E112C1E;
...
Subject: [Intel-gfx] [PATCH 06/14] drm/gem: adjust per file RSS on handling
 buffers

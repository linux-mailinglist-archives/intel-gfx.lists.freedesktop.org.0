...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19D2C1369C1
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jan 2020 10:22:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6B4D6E9E2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/23] drm: Add get_vblank_timestamp() to struct
 drm_crtc_funcs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E28B5B2992
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 00:46:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5FFDD10E79D;
	Thu,  8 Sep 2022 22:46:00 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3.1 10/14] drm/i915/uncore: Add GSI offset to
 uncore

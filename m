...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E194794369
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Sep 2023 21:02:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E346110E704;
	Wed,  6 Sep 2023 19:02:33 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 1/5] drm/connector: add trailing newlines to
 drm_dbg msgs

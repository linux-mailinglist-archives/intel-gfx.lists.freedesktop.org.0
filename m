...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AB57612515
	for <lists+intel-gfx@lfdr.de>; Fri,  3 May 2019 01:27:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1CD6289453;
	Thu,  2 May 2019 23:27:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6939489453
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 May 2019 23:27:12 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga106.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 02 May 2019 16:27:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.60,423,1549958400"; d="scan'208";a="147715180"
Received: from ideak-desk.fi.intel.com ([10.237.72.204])
 by orsmga003.jf.intel.com with ESMTP; 02 May 2019 16:27:10 -0700
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 May 2019 02:26:45 +0300
Message-Id: <20190502232648.4450-8-imre.deak@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20190502232648.4450-1-imre.deak@intel.com>
References: <20190502232648.4450-1-imre.deak@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 07/10] drm/i915: Remove the unneeded AUX power
 ref from intel_dp_hpd_pulse()
...

...
RFApIHsKIAkJLyoKQEAgLTYzMzEsOSArNjMyOCw2IEBAIGludGVsX2RwX2hwZF9wdWxzZShzdHJ1
...
X3N0YXR1cyhpbnRlbF9kcCkgPT0gLUVJTlZBTCkgewogCQkJLyoKQEAgLTYzNDUsNyArNjMzOSw4
...
UlFfTk9ORTsKIAkJfQogCX0KIApAQCAtNjM1NSwxNyArNjM1MCwxMCBAQCBpbnRlbF9kcF9ocGRf

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D75B48AB0E
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Jan 2022 11:10:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7CC0C10F5C9;
...
Subject: [Intel-gfx] [PATCH 3/3] drm/vkms: change vkms driver to use

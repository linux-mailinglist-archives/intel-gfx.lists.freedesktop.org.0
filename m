...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 817A767CAA1
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Jan 2023 13:12:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F20C110E075;
	Thu, 26 Jan 2023 12:11:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from farmhouse.coelho.fi (paleale.coelho.fi [176.9.41.70])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C3FF110E075
 for <intel-gfx@lists.freedesktop.org>; Thu, 26 Jan 2023 12:11:56 +0000 (UTC)
Received: from 85-76-162-133-nat.elisa-mobile.fi ([85.76.162.133]
 helo=[192.168.127.197])
 by farmhouse.coelho.fi with esmtpsa (TLS1.3) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <luca@coelho.fi>) id 1pL16c-005x4X-CL;
 Thu, 26 Jan 2023 14:11:52 +0200
Message-ID: <e0fb44004a740f0bb676cde16d8cc3a247ac106b.camel@coelho.fi>
...
Date: Thu, 26 Jan 2023 14:11:49 +0200
...
> > > > @@ -1559,7 +1559,26 @@ void intel_psr2_disable_plane_sel_fetch(stru=
...
> > > > +void intel_psr2_program_plane_sel_fetch_arm(struct intel_plane *pl=
ane,

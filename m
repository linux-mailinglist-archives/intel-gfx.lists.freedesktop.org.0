...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0B1422D8B
	for <lists+intel-gfx@lfdr.de>; Mon, 20 May 2019 10:02:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D89F489241;
	Mon, 20 May 2019 08:02:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 21978891F2
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 May 2019 08:02:03 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16610888-1500050 
 for multiple; Mon, 20 May 2019 09:01:36 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 20 May 2019 09:01:26 +0100
Message-Id: <20190520080127.18255-32-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 32/33] drm/i915/execlists: Minimalistic
 timeslicing
...
OTE1L2d0L2ludGVsX2xyYy5jCmluZGV4IDEzNzk0ODkyN2M2My4uMTA5YjMyYzZhZWFkIDEwMDY0
...
L2RybS9pOTE1L2d0L3NlbGZ0ZXN0X2xyYy5jCmluZGV4IGQxNjJiMGQzZWM4ZS4uMmE1NGMwNzZh
NzY5IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9ndC9zZWxmdGVzdF9scmMuYwor

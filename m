...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B9C339A65C
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Jun 2021 18:55:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C9F06F4E0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 6/7] drm/i915: Add remaining conversions to
 GRAPHICS_VER

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EA959A36126
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Feb 2025 16:13:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 884D710ECD5;
	Fri, 14 Feb 2025 15:13:43 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="O7qb68CV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7A8DE10ECCC
 for <intel-gfx@lists.freedesktop.org>; Fri, 14 Feb 2025 15:13:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1739546022; x=1771082022;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=3U1F23nzA4BYTpacuUMx40ACJLFdSiW+WiU/pS4syOk=;
 b=O7qb68CVL1TSNrmY2hsq0UraiC4tErVXeWCGkcWoK7pgtRBkqAcl9t8h
 09tN4FwaPF5qiTPlY+vsHSuQAiwhZonom53uheZmrzGZssBe/W2G1Q41J
 uGne21bqSBTTHN84oCBd9gv7291tF05OBP2B4hn1bDrN4J6lhGXKqCeBU
 mCErFZV9Q3LXqkGWgfzT0FS78paUPLazjUqbCREEmwypc5lcRNlWvGnPe
 mJBGvPqagbiNwQQ4q34BZrm8ls0I8uXlcwDsUfV4WxzqUmbmDIjcAXSCj
 iHCzU3OZZehSRJGG30iZKl6h2q3TEDzLJ81DsPw3YDAeBzUaqBEpXoUmQ g==;
X-CSE-ConnectionGUID: HChji396Rj+NGinPVbEaTQ==
X-CSE-MsgGUID: JUZS+qaTROeH/TElvvIk3w==
X-IronPort-AV: E=McAfee;i="6700,10204,11345"; a="39482261"
X-IronPort-AV: E=Sophos;i="6.13,286,1732608000"; d="scan'208";a="39482261"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by fmvoesa113.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Feb 2025 07:13:41 -0800
X-CSE-ConnectionGUID: 6XRrnntnSBG0lHxPRo4FPQ==
X-CSE-MsgGUID: pIQAzRGNQx2+8mwtO28RgQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.13,286,1732608000"; d="scan'208";a="113675792"
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by fmviesa008.fm.intel.com with ESMTP; 14 Feb 2025 07:13:40 -0800
From: Nemesa Garg <nemesa.garg@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: Nemesa Garg <nemesa.garg@intel.com>
Subject: [PATCH 4/6] drm/i915/display: Configure the second scaler for
 sharpness
Date: Fri, 14 Feb 2025 20:39:22 +0530
Message-Id: <20250214150924.1811372-5-nemesa.garg@intel.com>

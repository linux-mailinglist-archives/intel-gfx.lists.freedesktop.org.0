...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 30A5250A578
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 18:29:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE68B10E6B8;
...
Subject: [Intel-gfx] [PATCH v2 7/7] vfio: Remove calls to

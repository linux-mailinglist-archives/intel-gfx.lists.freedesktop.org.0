...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 79A42C276AB
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:25:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0977310EC52;
	Sat,  1 Nov 2025 03:25:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="R+8tiWtV";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C2A8810EC58;
 Sat,  1 Nov 2025 03:25:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761967548; x=1793503548;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lYUtH056t18stnvlqgjcp2Or/6ngYBztKyVfrO0BGUw=;
 b=R+8tiWtVIY10P/fBwGbNr1ElODg10oCzkCVHGoq6FKFc2h8+D0A00li9
 qAnR+MZ8JT6rrVGWvgcEfzsacaT6IbsDp+nxdujHz+DO1TKTSoP2BdOMq
 tFlI+WKI9Fkj/VMLAAJiuGuPd6qk9YI/gfgxf6q64NMqquCzS7zEAZ9U/
 jjC5SMVJ3GQ7UaqqaOziKnV9+JtNP7tDUe8jHQ7xILiExj/5SSu7VaCRr
 JnwR++HhY//Kyd8QYu3tjD8M0tljV7tEG3KdI7MZ9oHE2KDzLLOfsM/xV
 Q+0b52ZqL4wcguFaVPNUGAiD8TnmS61w2Uy0luW3NjnwrSpJNAIUkgtLx Q==;
X-CSE-ConnectionGUID: QCtrPlwyRuGoWOZIqASmcQ==
X-CSE-MsgGUID: fJir3lTWSqKNgPPq12rVVA==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="64019872"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="64019872"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:25:48 -0700
X-CSE-ConnectionGUID: erKFEmm5QSGVo6Es+RIRJg==
X-CSE-MsgGUID: MQGsjgk4Rhe8LvrUJ4oY+g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217038026"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa002.jf.intel.com with ESMTP; 31 Oct 2025 20:25:47 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-xe@lists.freedesktop.org,
	intel-gfx@lists.freedesktop.org
Cc: Suraj Kandpal <suraj.kandpal@intel.com>,
 Arun R Murthy <arun.r.murthy@intel.com>
Subject: [PATCH v5 16/25] drm/i915/ltphy: Program LT Phy Non-TBT PLL disable
 sequence
Date: Sat,  1 Nov 2025 08:55:04 +0530
Message-Id: <20251101032513.4171255-17-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D495784042
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Aug 2023 14:02:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 31EFA10E330;
	Tue, 22 Aug 2023 12:02:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 0/4] drm/amd/display: stop using

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 758C8518732
	for <lists+intel-gfx@lfdr.de>; Tue,  3 May 2022 16:49:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F186A10E172;
...
Subject: [Intel-gfx] [CI] drm/i915: use IOMEM_ERR_PTR() directly

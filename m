...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A88FD48B282
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Jan 2022 17:45:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6815C10E260;
...
Subject: [Intel-gfx] [PATCH] drm/i915: Lock timeline mutex directly in error
 path of eb_pin_timeline

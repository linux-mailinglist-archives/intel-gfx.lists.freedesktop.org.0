...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D3E94A9FD7
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Feb 2022 20:15:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A87FD10E52C;
	Fri,  4 Feb 2022 19:15:17 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 04/19] drm/i915/gt: Add helper for shmem
 copy to iosys_map

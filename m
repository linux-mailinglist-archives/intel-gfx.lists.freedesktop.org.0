...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DAA91489810
	for <lists+intel-gfx@lfdr.de>; Mon, 10 Jan 2022 12:52:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 45A8814AC16;
...
Subject: [Intel-gfx] [PATCH v4 5/7] drm/i915: Remove

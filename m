...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C9BD51FBDD
	for <lists+intel-gfx@lfdr.de>; Mon,  9 May 2022 14:03:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8E39610EE35;
	Mon,  9 May 2022 12:03:36 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 01/25] drm/edid: use else-if in CTA extension
 parsing

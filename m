...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B8DC075069B
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Jul 2023 13:47:49 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B93AB10E4EA;
...
Subject: [Intel-gfx] [PATCH 01/17] drm/i915: Add ability for tracking buffer
 objects per client

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E7C325A8F5D
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Sep 2022 09:08:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 10ED910E5F0;
...
Subject: Re: [Intel-gfx] [PATCH v4 17/21] dma-buf: Move
 dma_buf_map_attachment() to dynamic locking specification

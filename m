...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7986024ED1
	for <lists+intel-gfx@lfdr.de>; Tue, 21 May 2019 14:17:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 10CD9893A8;
	Tue, 21 May 2019 12:17:38 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 4/6] drm/i915/dp: Add a support of YCBCR
 4:2:0 to DP MSA

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 54B6119C06B
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Apr 2020 13:49:05 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B53B06EA60;
	Thu,  2 Apr 2020 11:49:03 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A2F426EA5E
 for <intel-gfx@lists.freedesktop.org>; Thu,  2 Apr 2020 11:49:02 +0000 (UTC)
IronPort-SDR: 2TSmjZvKRAqTvMb7CK56Fjb2+kqsYTzjpUcxEhgBpmAMOVVODXTupSlA7EgwlbGiZJnfS7EtjU
 iBS88y2uu/kw==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2020 04:49:02 -0700
IronPort-SDR: wRq6OD1tcReoME77HDSPWwZI/8G86n+YwdmKLLytbmgxPpeEpkE8RsqNfUDqRUJYBFbx1rYTbk
 prt1u88Pb5lQ==
X-IronPort-AV: E=Sophos;i="5.72,335,1580803200"; d="scan'208";a="273532556"
Received: from assenmac-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.249.35.117])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2020 04:48:54 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  2 Apr 2020 14:48:06 +0300
Message-Id: <20200402114819.17232-4-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 04/17] drm/i915/dp: use struct drm_device based
 logging

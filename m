...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 403AE4EB380
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Mar 2022 20:42:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D23A10E5A1;
...
Subject: [Intel-gfx] [PATCH 02/12] drm/edid: clean up EDID block checksum
 functions

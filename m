...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C83570CFC4
	for <lists+intel-gfx@lfdr.de>; Tue, 23 May 2023 02:46:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5318810E3BC;
	Tue, 23 May 2023 00:46:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0775010E3B5
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 May 2023 00:46:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684802796; x=1716338796;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=lNZ3V97RjS5vliegYCHtKtBWHbuSRSNGEQmExz31bRk=;
 b=Bxfk6LbAX4NcQvidaT/BdZP47iTs4nqbPNJmka+SD+YxqZgw1y99nuvl
 cQSMg5qSL96UCAB2jR3YD/1Brsn5IQI8JyNijtTthTkANx4JjJxND7HAV
 sALSorq1l/xTSJ4j+mdlOqo0Eyale22ebYo1MPMGkqQICp9GAApFopnMx
 wkzmLbTFFy028A2cEa/+n8xgIXKPgTTIo4hfYo7/t1uEekragRf2BKQGa
 knZoILyhssyJoKowrHRmLpzE/3WP6kqoA4P8HTEUbIsgxQ1qlT/cwHH+u
 UAOA8b8S5jCBkemPXh587S1aJi3AI0Awsr4M0XwiLjNemt1aV2Jdq00hD Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="351932930"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="351932930"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 17:46:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="877985957"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="877985957"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga005.jf.intel.com with ESMTP; 22 May 2023 17:46:33 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 May 2023 06:14:54 +0530
Message-Id: <20230523004455.1206533-3-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915/hdcp: Move away from master
 naming to arbiter
...
@@ -30,7 +30,6 @@ struct drm_i915_private;
 struct drm_property;

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7534570785D
	for <lists+intel-gfx@lfdr.de>; Thu, 18 May 2023 05:18:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBB2610E4D3;
	Thu, 18 May 2023 03:18:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B0B8A10E4D3;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=ai1DBgXPTnF4qxsJ2j6FCtMKfs8hvszVUAbz5Bi3PYE=;
 b=YBcDDqTg3R+JUXUjlBPljOg+yM1sF3noPXIR8aBX4bjh0UEgvnmmMeos
 v94zL9w3Xop1hmBNIorcjQ93x/h+UoVKsaiCm6+cDR/7HlQJ5nrSFXeb9
 NeerYJErqwlnPikKRrWOD2aSImbCOpwowQ66pLlEF+6XOz+XO7XjtfBkt
 hBRplIzY8hHIanG2zzR7Z7YOe6HO45MpPVmgzE568spkkZxhPLETv1GWv
 W9xM/uL3Vpo9rxWRRxN/VBcqMLWOVasBTgGAAeKV9pozMSxBf20E27WcR
 EY/GB6gc3AIbOJd3ItcaPy0EBLMJEzzF69jwc5GzSPPOZqg9Lxz8w+uAo w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10713"; a="341348742"
X-IronPort-AV: E=Sophos;i="5.99,284,1677571200"; d="scan'208";a="341348742"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 May 2023 20:18:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10713"; a="652472429"
X-IronPort-AV: E=Sophos;i="5.99,284,1677571200"; d="scan'208";a="652472429"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 May 2023 20:18:10 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 17 May 2023 20:18:01 -0700
Message-Id: <20230518031804.3133486-3-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/5] drm/i915: Convert INTEL_INFO()->display to
 a pointer

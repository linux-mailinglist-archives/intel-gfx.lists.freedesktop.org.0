...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BA5520FEF6
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:30:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2BFCF6E42C;
	Tue, 30 Jun 2020 21:29:19 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A613D6E32A;
 Tue, 30 Jun 2020 21:28:49 +0000 (UTC)
IronPort-SDR: b6dj3mSzw3TpeHo6jMqc/ybX8ybWRmFY3paKdG3I7DgGlCB8SobmCAS4Udqg5BJXbUIHIJ9Wm4
 lU8WM0QbB6ww==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="126011552"
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="126011552"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jun 2020 14:28:48 -0700
IronPort-SDR: ebI4prhPBI5McwbMM5s6lUGYJXl2xxv1NxoDzeHL+oES7iZoIKFULwba5mn9HseFDxo3OZpFop
 Cka+JvDPhNAQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,298,1589266800"; d="scan'208";a="481066738"
...
Date: Tue, 30 Jun 2020 14:27:43 -0700
Message-Id: <1593552491-23698-32-git-send-email-anitha.chrisanthus@intel.com>
X-Mailer: git-send-email 2.7.4
In-Reply-To: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
References: <1593552491-23698-1-git-send-email-anitha.chrisanthus@intel.com>
Subject: [Intel-gfx] [PATCH 31/59] drm/kmb: Cleanup probe functions

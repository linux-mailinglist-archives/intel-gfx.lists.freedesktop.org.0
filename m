...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DCEB386B22D
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Feb 2024 15:45:24 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2EF1210E6A0;
	Wed, 28 Feb 2024 14:45:22 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="IfjvO9UB";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0892C10E985;
 Wed, 28 Feb 2024 14:45:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1709131517; x=1740667517;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=jfl/Dr+yXhJ0Waz4xUJfVIMEz84p9GfyBuFXRzTM+hU=;
 b=IfjvO9UBmODBx5HjrJ7OhBksdsgZw/kb/BOFQC7ZpJgv67LpJBz9+MFU
 HWpymE/XEIBM4ZTiRNRdGFoBsA4lFbyepz90RqK1f5nSQ/DR4ONo4R5LR
 xfm7qoPq5fltXI8Psd9p491Y3yZTC/eZF7X0+EpEf7GgeMCvaust2bC8p
 ya31VUabvpwkPG+DowyBGTCohBNXWT/6guovrmysDXJBWx3LqhL8NEOF9
 yHOw+uYhIvPzQ60mFroAd0lskz6XWOPN5Rk2UBpWfAbyp7EGGgXE8fWVV
 2H6PD7lmfB7YwXAHTm3KYU513us0nhRPjuq9OM553mzZ6y07iN6G4NLa/ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10998"; a="7356134"
X-IronPort-AV: E=Sophos;i="6.06,190,1705392000"; 
   d="scan'208";a="7356134"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Feb 2024 06:45:17 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,190,1705392000"; 
   d="scan'208";a="7663163"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmviesa006.fm.intel.com with ESMTP; 28 Feb 2024 06:45:14 -0800
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: dri-devel@lists.freedesktop.org, jani.nikula@intel.com,
 ankit.k.nautiyal@intel.com,
 Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
Subject: [PATCH v12 3/8] drm/i915/dp: Add Read/Write support for Adaptive Sync
 SDP
Date: Wed, 28 Feb 2024 20:08:18 +0530
Message-Id: <20240228143823.2762595-4-mitulkumar.ajitkumar.golani@intel.com>

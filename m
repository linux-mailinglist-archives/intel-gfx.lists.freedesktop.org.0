...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 367FC28862E
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Oct 2020 11:42:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D5C36EC9E;
...
Subject: [Intel-gfx] [PATCH v2 09/12] drm/i915/gvt: GVTg support vgpu pv CTB
 protocol

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8035064AEC9
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Dec 2022 05:57:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 243AC10E2D7;
	Tue, 13 Dec 2022 04:56:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 65E0710E1AD
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 Dec 2022 04:56:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670907393; x=1702443393;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=howt/dpTtDsfDX3fHTK5Co2gzQ4E1cLASFxqg+8Dwdg=;
 b=Ti39LZnB+An0JiE64hLzxCsB8TKHMdHn4RUx99hYcMF9bpwj32sg2tQ7
 pfsHgUOdfo7OpLjAWfCb+YYz2fvB1ynwagaSltLhfHXIQeJpTTVS0IZ1y
 lQ4fmnpHalN2au/Yuteogzh0pt5dl8sxwPBW2702xewKVam5limUW3rM3
 sZ0qqtDWyOhsUtBy06cWUJ7r36urhQDvrN1NuSnxuE6KFobnIGFD1UH+l
 dAF+zqKdG3AIqinIVYMRAJ8vDjX5NDneckkPffLl/tgZM1jhPsMPkWkBS
 VDmgnQR5ASl8HDObGlcVgLjW3gvYh0KNZ9s2yqpB4Bq7yvMEx9b+8kfKh g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10559"; a="315677992"
X-IronPort-AV: E=Sophos;i="5.96,240,1665471600"; d="scan'208";a="315677992"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Dec 2022 20:56:33 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10559"; a="822748167"
X-IronPort-AV: E=Sophos;i="5.96,240,1665471600"; d="scan'208";a="822748167"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga005.jf.intel.com with ESMTP; 12 Dec 2022 20:56:31 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 13 Dec 2022 10:25:14 +0530
Message-Id: <20221213045516.2609109-6-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH 5/7] drm/i915/hdcp: Fill wired_cmd_in structures
 at a single place
...
index fa06a6cb0bca..101231b897e6 100644
--- a/include/drm/i915_cp_fw_hdcp_interface.h
+++ b/include/drm/i915_cp_fw_hdcp_interface.h
@@ -535,4 +535,204 @@ struct wired_cmd_repeater_auth_stream_req_out {

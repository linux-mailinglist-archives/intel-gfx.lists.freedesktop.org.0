...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34ECF7BE85F
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Oct 2023 19:40:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4AB110E29C;
	Mon,  9 Oct 2023 17:40:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 69E8D10E0BA
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=pRiPY/OP2Xl/u2I8hDYM20WgvgXlWZ4THrL8N80UHLs=;
 b=QV75P+NXV428n9+56XxrthtbJ8qxRCS7uVKB7rHYqq9PJY0i7tIBRoIq
 sFuhgoclzEqxFHkhsKCf9Z/cmnxwJZxlrus4gOi9RFFkbIKt5XHWg4Jta
 nrudALlmqCfprPx2nasg5UvnGG+Jn732/QlwCaThfkm/saxU1nyw825or
 TNRrk6bDQJ2WrZjwsfewriNyzBoxb5hMmOpLJ9SYT6zWxxmdEpjLpZ9Xz
 I8Tdw+L8P4hyHJUpBpExmErxfUI4Qcu5ZW3fqzLpLktRqwQf7pVTdktHk
 vMzq1vy8sTha8fJ/ANuqF6s7fJ6VivxdLVdNsoHxTZv6L30/3CAQGkm3W Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="450705018"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="450705018"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2023 10:40:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="788251445"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="788251445"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2023 10:40:01 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  9 Oct 2023 10:29:15 -0700
Message-Id: <20231009172919.1769055-4-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 3/7] drm/i915: Define and use GuC and CTB TLB

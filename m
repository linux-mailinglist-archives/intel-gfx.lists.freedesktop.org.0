...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 60B88B0DE6
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Sep 2019 13:33:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 30DD46ECD8;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 3/7] drm: Add DisplayPort colorspace property

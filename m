...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CA5FE308C
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Oct 2019 13:40:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3239289BD2;
	Thu, 24 Oct 2019 11:40:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0185889BD2
 for <intel-gfx@lists.freedesktop.org>; Thu, 24 Oct 2019 11:40:32 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18948737-1500050 
 for multiple; Thu, 24 Oct 2019 12:40:31 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 24 Oct 2019 12:40:28 +0100
Message-Id: <20191024114028.6170-12-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/11] drm/i915/gem: Honour O_NONBLOCK before
...

...
LT5lbmdpbmUgPSBjZS0+ZW5naW5lOwotLSAKMi4yNC4wLnJjMAoKX19fX19fX19fX19fX19fX19f

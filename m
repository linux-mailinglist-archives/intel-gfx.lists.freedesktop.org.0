...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CC6F6E6BED
	for <lists+intel-gfx@lfdr.de>; Tue, 18 Apr 2023 20:18:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C124D10E844;
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915: Dump error capture to kernel
 log

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0942A6ACA1B
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Mar 2023 18:26:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ACF0E10E132;
	Mon,  6 Mar 2023 17:26:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4693710E132
 for <intel-gfx@lists.freedesktop.org>; Mon,  6 Mar 2023 17:26:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678123608; x=1709659608;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=AK/QAeHPuIVY2aliGdiSdgtzzM7ZTiQB7Stu4nI+oPs=;
 b=DBHcDtgwPzY3S0tNfjkuP5l6mDmxOVgWvuE5AjgEWwdZuODjmmS3H4oD
 eA5afo8dQMo3OJgSLRTRbRWpx7yylpuQSGekCPs57vwEzj+eteuy62jQZ
 t97aZLeWeTJVvUEKa6qT71l84+VoodDpDDlLb6L4wva2yZmv7acwB70Lr
 nge4zJa7tDqlQqXFtpWmzcM4La4usefj58KiEkGVj7UF3LzYPrnrY3Y2w
 Fl7uCdbA+iqx0kYz2S2A9a9w05Psiilit95Dc52b2bOw64PG4d6br9Je6
 QEy3ixI5CkkQDSgSm3dsMM10aAbQJghh5yFjGGkMYeimQXoVtXqzMBNN2 w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10641"; a="335640009"
X-IronPort-AV: E=Sophos;i="5.98,238,1673942400"; d="scan'208";a="335640009"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Mar 2023 09:26:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10641"; a="706514975"
X-IronPort-AV: E=Sophos;i="5.98,238,1673942400"; d="scan'208";a="706514975"
Received: from taverna-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.58.188])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Mar 2023 09:26:45 -0800
...
References: <20230301122944.1298929-1-jani.nikula@intel.com>
 ...
 <ZACJ80onyvv9/HX0@ideak-desk.fi.intel.com>
Date: Mon, 06 Mar 2023 19:26:43 +0200
Message-ID: <87cz5lu6y4.fsf@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2168F731816
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Jun 2023 14:04:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 26BFA10E4DD;
	Thu, 15 Jun 2023 12:04:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4AF1610E4DF
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Jun 2023 12:04:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1686830658;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=YwIfyNf00FOW0x5vEJdsiq6ILVcL+0Ebta7YS8RnVmI=;
 b=KiYEM2nNZ+/mxnX6uJELEtfrdvhwzvc6tT8l+4WLIWZKsU31xQSJhSmlXGpUJpgfUCDzq2
 fbhX/jsW1KllADxzM74i/25L2NQPssXKWJOzQ2Vu+16Ee5aPfD+ImupFPNsWC2OhQ8clTS
 yQ49qFEkeJr2A2IoLKQgskrWK8hbKTM=
Received: from mail-lj1-f197.google.com (mail-lj1-f197.google.com
 [209.85.208.197]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-616-_Aj6jJ-DPX-_90LOp4UXEg-1; Thu, 15 Jun 2023 08:04:15 -0400
X-MC-Unique: _Aj6jJ-DPX-_90LOp4UXEg-1
Received: by mail-lj1-f197.google.com with SMTP id
 38308e7fff4ca-2b1b8ec9343so11952991fa.1
 for <intel-gfx@lists.freedesktop.org>; Thu, 15 Jun 2023 05:04:14 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=YwIfyNf00FOW0x5vEJdsiq6ILVcL+0Ebta7YS8RnVmI=;
 b=
X-Gm-Message-State: AC+VfDzp+tl7GtvlUqFkhRXqt/tnroCdJdqkcMOe6xwLXg42lv7Y8X1x
 bgBRE5W+AYEoDQVQuh13HWsOfShy6GiHYnhjDizMgptqcMZMhBmGfie4xIJf97nNhR1kYZ3HgTT
 75WKBPkE2W6G/0i8VJatmyjf20bFai0+NQX8L1IGNwI57
X-Received: by 2002:a2e:8e27:0:b0:2b3:4c3e:a61d with SMTP id
 r7-20020a2e8e27000000b002b34c3ea61dmr2359394ljk.2.1686830652746; 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2BE267B3B9D
	for <lists+intel-gfx@lfdr.de>; Fri, 29 Sep 2023 22:51:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DBEE10E143;
	Fri, 29 Sep 2023 20:51:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DADD210E143
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=MwzL5wJujfBiL7HGLr2+LMCgRtuiH80LiV8IAMGohH52GFD/a5dLFLeC
 dECLzZ23MJQdEUddl+DEoRlRZMYqKVgUF+XNO4gEP9AkMBX0EiDU9K023
 s2drFgbfxiqnVSUBxMldmgjxp6fJdBuiJEZdb1kmfno6YhzgXC6paC6Dz
 69aMiNgQRHBaxvYG8l+CwT333cDqPRX+nv3QOmAfheD1y5T51wyeoFeeu
 ICxzlZbB75AWtr+KOclKU4qMkoxzeOxXv9arqWNsiBaD3/wUCESxaHImu
 psDkrdBkBq0DDhtdDYpDPEoV/MAO3j9ThMLcde5eepgv3VVVR0WFnj3Nq w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10848"; a="386241338"
X-IronPort-AV: E=Sophos;i="6.03,188,1694761200"; d="scan'208";a="386241338"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2023 13:29:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10848"; a="815699955"
X-IronPort-AV: E=Sophos;i="6.03,188,1694761200"; d="scan'208";a="815699955"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Sep 2023 13:29:19 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 29 Sep 2023 13:18:34 -0700
Message-Id: <20230929201837.849299-1-jonathan.cavitt@intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 1/4] drm/i915: Define and use GuC and CTB TLB

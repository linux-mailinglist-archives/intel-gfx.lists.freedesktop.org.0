...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D628F442CFA
	for <lists+intel-gfx@lfdr.de>; Tue,  2 Nov 2021 12:42:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3AD446E118;
	Tue,  2 Nov 2021 11:42:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8AC696E088
 for <intel-gfx@lists.freedesktop.org>; Tue,  2 Nov 2021 11:42:35 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10155"; a="218433851"
X-IronPort-AV: E=Sophos;i="5.87,202,1631602800"; d="scan'208";a="218433851"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Nov 2021 04:42:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.87,202,1631602800"; d="scan'208";a="577066681"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
 by FMSMGA003.fm.intel.com with ESMTP; 02 Nov 2021 04:42:34 -0700
Received: from fmsmsx612.amr.corp.intel.com (10.18.126.92) by
 fmsmsx602.amr.corp.intel.com (10.18.126.82) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2242.12; Tue, 2 Nov 2021 04:42:34 -0700
Received: from bgsmsx602.gar.corp.intel.com (10.109.78.81) by
 fmsmsx612.amr.corp.intel.com (10.18.126.92) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2242.12; Tue, 2 Nov 2021 04:42:32 -0700
Received: from bgsmsx602.gar.corp.intel.com ([10.109.78.81]) by
 BGSMSX602.gar.corp.intel.com ([10.109.78.81]) with mapi id 15.01.2242.012;
 Tue, 2 Nov 2021 17:12:30 +0530
From: "Kulkarni, Vandita" <vandita.kulkarni@intel.com>
To: "Nikula, Jani" <jani.nikula@intel.com>, "intel-gfx@lists.freedesktop.org"
 <intel-gfx@lists.freedesktop.org>
Thread-Topic: [V2 4/4] drm/i915/dsi: Ungate clock before enabling the phy
Thread-Index: AQHXxPwAQUMpbbYG1Uik7LX3npT2nqvn+8gAgABvkRD//8CjgIAAXPLggAXC0ICAAYoLAP//4AkAgAB8x9A=
Date: Tue, 2 Nov 2021 11:42:30 +0000
Message-ID: <d21e858e01f940b3adae84903d123f97@intel.com>
...
before,
> >> >> >> >        as per the older spec. This commit nullifies its effect=
 and
> makes
> >> >> >> >        sure that the clocks are not gated while we enable the =
DDI
> >> >> >> >        buffer.
...
> >>
> >> Where does it say for gen12+ that clocks should be ungated at any poin=
t?
> >>
...
>=20
> I think if you remove the call to gen11_dsi_ungate_clocks(encoder) from t=
his
...
Clock ungating is not mentioned anywhere, and we need to enable clocks befo=
re enabling

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9440D4A9FF8
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Feb 2022 20:23:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC5A210E95A;
...
Subject: Re: [Intel-gfx] [PATCH 09/19] drm/i915/guc: Convert engine record
 to iosys_map

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6982017662C
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Mar 2020 22:41:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5E65589C68;
...
Subject: Re: [Intel-gfx] [PATCH 2/9] drm/radeon: remove radeon_fb_{add,

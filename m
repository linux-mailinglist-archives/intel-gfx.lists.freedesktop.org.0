...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4091C6DA948
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Apr 2023 09:11:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 347A210EDBD;
	Fri,  7 Apr 2023 07:11:31 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 4/8] drm/i915/mtl: end support for set caching
 ioctl

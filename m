...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A0231195203
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Mar 2020 08:29:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 07C236E9AE;
	Fri, 27 Mar 2020 07:29:06 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v8 11/14] drm/i915: Program DP SDPs on pipe
 updates

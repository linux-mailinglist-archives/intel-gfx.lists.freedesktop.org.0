...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UDCLIbZkwWkjSwQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2026 17:05:10 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0328B2F785D
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Mar 2026 17:05:09 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0489910E5A0;
	Mon, 23 Mar 2026 16:05:08 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=permerror (0-bit key) header.d=gmail.com header.i=@gmail.com header.b="N5TtO+kJ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-oi1-f177.google.com (mail-oi1-f177.google.com
 [209.85.167.177])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5F50D10EC09
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Mar 2026 13:24:09 +0000 (UTC)
Received: by mail-oi1-f177.google.com with SMTP id
 5614622812f47-466f59dbe4bso564794b6e.0
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Mar 2026 06:24:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1773408248; x=1774013048; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=ZMVfUVm5fgbPd/qSnAtgDoNjTpRp4guFY8KxOPZIX64=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=ZMVfUVm5fgbPd/qSnAtgDoNjTpRp4guFY8KxOPZIX64=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXLDjvH6ffaMso5vNSibkar/s60fMOcKF9Y7JB+QdjeMh8a0y81SncPYGsBlOaH074zpDEexongUVo=@lists.freedesktop.org
X-Gm-Message-State: AOJu0Yxu8sWorpAJebab4NYwu4AHxcwypV6t5Vg2g87nGNA/+UECBb2X
 JKwtIgXOfcf3REtErDsv/rfK21HDzDIOYXRxwa7WdrpN+dmy1aaQblYb
X-Gm-Gg: 
X-Received: by 2002:a05:6808:152b:b0:467:2926:1228 with SMTP id
 5614622812f47-467575e9301mr1863785b6e.49.1773408248504; 
 Fri, 13 Mar 2026 06:24:08 -0700 (PDT)
Received: from frodo (c-98-38-17-99.hsd1.co.comcast.net. [98.38.17.99])
 by smtp.googlemail.com with ESMTPSA id
 5614622812f47-4673434a35csm4795987b6e.20.2026.03.13.06.24.07

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A4E95FBFF7
	for <lists+intel-gfx@lfdr.de>; Wed, 12 Oct 2022 06:51:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DEE1F10E31C;
	Wed, 12 Oct 2022 04:51:47 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 0/3] Add _PICK_EVEN_RANGES

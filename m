...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C6ABF1A6A12
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Apr 2020 18:43:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 33B2F89EAE;
	Mon, 13 Apr 2020 16:43:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CF84989EAE
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Apr 2020 16:43:41 +0000 (UTC)
IronPort-SDR: LyFdDznXaiPM2xEbbEpk+8GP3/KsPtem9GLYAKBCu6PS0r27WEnj6n9IRvwwfV2thjB7FpTABm
 gXk5vln2YdLA==
...
IronPort-SDR: pIe6mLxh/8Jkv1rgGiheGBbhSsIjvAzLSUj3ieQRFCuvSdb+LUepgsdm+D+B2iHTWlUtv46oi4
 iwZ7qm0CriLQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,378,1580803200"; d="scan'208";a="267485692"
...
Date: Mon, 13 Apr 2020 09:45:09 -0700
Message-Id: <20200413164515.13355-3-jose.souza@intel.com>
X-Mailer: git-send-email 2.26.0
In-Reply-To: <20200413164515.13355-1-jose.souza@intel.com>
References: <20200413164515.13355-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 3/9] drm/i915/display: Split

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C772954F42
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jun 2019 14:47:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A75D56E106;
	Tue, 25 Jun 2019 12:47:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x442.google.com (mail-wr1-x442.google.com
 [IPv6:2a00:1450:4864:20::442])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BFDC36E106;
 Tue, 25 Jun 2019 12:47:03 +0000 (UTC)
Received: by mail-wr1-x442.google.com with SMTP id d18so17744328wrs.5;
 Tue, 25 Jun 2019 05:47:03 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=N6DhTE6F9h7ziW5s8D3Yybth/pRfwB+8zOBFG4Aaoqk=;
 b=
X-Gm-Message-State: APjAAAV0ESZHWX4P3o2mOYvuFGSmkLWCWHMTw2PMxd4+3LOcSrN5gI8H
 cEZ4KGTtyDQDaiiJlNE0MZIBM9Tv
X-Google-Smtp-Source: APXvYqw5mgNeAN8bijwZK0DJZyrz5hJbb1BehN/slVMadRkf5P70DH2iAgfRb+l4JL4IMduVkrKPDg==
X-Received: by 2002:a5d:4810:: with SMTP id l16mr2504991wrq.48.1561466822027; 
 Tue, 25 Jun 2019 05:47:02 -0700 (PDT)
Received: from abel.fritz.box ([2a02:908:1252:fb60:2df2:5da:22f9:1506])
 by smtp.gmail.com with ESMTPSA id y184sm2334231wmg.14.2019.06.25.05.47.01
...
Date: Tue, 25 Jun 2019 14:46:54 +0200
Message-Id: <20190625124654.122364-6-christian.koenig@amd.com>
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=N6DhTE6F9h7ziW5s8D3Yybth/pRfwB+8zOBFG4Aaoqk=;
 b=
Subject: [Intel-gfx] [PATCH 6/6] drm/amdgpu: add independent DMA-buf import
 v7

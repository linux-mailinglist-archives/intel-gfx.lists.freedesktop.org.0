...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EA517A250F
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Sep 2023 19:47:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2987010E663;
	Fri, 15 Sep 2023 17:46:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CD54910E66A;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=0UAOPJG1IbyyNZoRjHtpOAGVjl4K11d1cc1AiKWJQyM=;
 b=SXSuTI9Y0UFlyMXtD20nI1RJnuFDioQ4anUKrF7ZwLj1M32HQdE+NySt
 iYFa2CcE41FAxa1iiL3qqrnnny5PTK/HtzlTwOsL1FdCeJY82Hvo8AJBY
 qHnq0qQCIU50vDBIgZ/n3cQswXnH+90eMYBDXX0VWufkJCPJZe34ku/vi
 IbPgT0Vv59063gMnCm3mj15iCP8xUAn7vTrdfIb696mttZwr51zsct7p7
 mCwmSK2kYlk8YVdKNKLxe8314BzIhPxn4nihWyWC7U2vDoc+1VvekTDtA
 w8eMB7/hHwVWEGFK9yVXZn/Px3NbcY0xFaioPx21q6KrBbWhnr+I29FTB Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10834"; a="445779272"
X-IronPort-AV: E=Sophos;i="6.02,149,1688454000"; d="scan'208";a="445779272"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Sep 2023 10:46:50 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10834"; a="868818269"
X-IronPort-AV: E=Sophos;i="6.02,149,1688454000"; d="scan'208";a="868818269"
Received: from lucas-s2600cw.jf.intel.com ([10.165.21.196])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Sep 2023 10:46:50 -0700
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 15 Sep 2023 10:46:34 -0700
Message-Id: <20230915174651.1928176-14-lucas.demarchi@intel.com>
...
Subject: [Intel-gfx] [PATCH v4 13/30] drm/i915/xe2lpd: Move registers to PICA

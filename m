...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 340CC1983B4
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Mar 2020 20:49:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 19B276E484;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 5/5] drm/i915: Enable scaling filter for
 plane and CRTC

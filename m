...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2436D17DF75
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Mar 2020 13:02:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C94A06E423;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH] drm: Mark up racy check of

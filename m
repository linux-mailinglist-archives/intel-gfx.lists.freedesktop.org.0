...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C4A961EEC
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 14:54:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 45BC789D7B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/19] drm/i915: Rework global state locking

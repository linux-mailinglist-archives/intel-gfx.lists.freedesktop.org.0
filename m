...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C3E564FC446
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 20:43:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D73BD10EBD0;
	Mon, 11 Apr 2022 18:43:12 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 06/34] drm/i915/gvt: move the gvt code into
 kvmgt.ko

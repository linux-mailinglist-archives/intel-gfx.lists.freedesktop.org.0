...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7291A5F040E
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Sep 2022 07:10:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D3D710EB53;
...
Subject: [Intel-gfx] [PATCH 0/3] drm/i915: Improve register state context
 init

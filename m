...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 827DC3A6BB2
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Jun 2021 18:27:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C812E89ED6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 10/12] drm/i915/ttm: accelerated move
 implementation

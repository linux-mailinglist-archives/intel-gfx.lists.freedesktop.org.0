...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EFD6E522F5A
	for <lists+intel-gfx@lfdr.de>; Wed, 11 May 2022 11:27:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94B2910F9D0;
...
Subject: [Intel-gfx] [PATCH v3] drm/edid: convert

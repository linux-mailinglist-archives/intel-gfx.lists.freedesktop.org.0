...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 391171534A
	for <lists+intel-gfx@lfdr.de>; Mon,  6 May 2019 20:02:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F1A7389B9A;
...
Subject: [Intel-gfx] [PATCH v5 05/11] drm/fb-helper: Remove
 drm_fb_helper_crtc

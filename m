...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6971272C4B0
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Jun 2023 14:44:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1BE5E10E22B;
	Mon, 12 Jun 2023 12:44:19 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915/gmch: avoid unused variable warning

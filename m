...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 115887CD361
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 07:11:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3204510E380;
...
Subject: [Intel-gfx] [PATCH v1 2/2] drm/i915/dsi: Replace poking of VLV

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 521D972958B
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Jun 2023 11:39:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 832A310E671;
	Fri,  9 Jun 2023 09:39:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9215110E671
 for <intel-gfx@lists.freedesktop.org>; Fri,  9 Jun 2023 09:39:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686303555; x=1717839555;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=3FBZvkoMaau3TW2jrbMWkoVOx/1z/FI5s1sCVAg7eI8=;
 b=cCXTWnuXH5FeHmMtZnRr0djI7T3E5MThYkFhgijQj7XDfOf2d3M97O/I
 rSiBALYU0Gok1/YgCGbSubwKI+oifb+IPkrDvkvjTu1OvYs65+tugpSm1
 JtNqtLApOuR3hSuvhXrWqDuYD5jAcO/xF8gCvxdD5wjxoWPOmAXYpDDOD
 t8b53RqSe00pSxdiLGFyopqQKoatWUFfaeZyvF/QvYB2vpFbT4v0kQUL4
 L24iBCFIasrXdnwmhtGWzJyfzrduOYDtukjInc3SBCbNkDftAuD3yhopf
 gltk2qRUOCHjlhi5EsuYlBI6x6OgrrNRUswcYOMIAytvy9XvT3tP6UQ6T A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10735"; a="423441075"
X-IronPort-AV: E=Sophos;i="6.00,228,1681196400"; d="scan'208";a="423441075"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2023 02:39:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10735"; a="687681242"
X-IronPort-AV: E=Sophos;i="6.00,228,1681196400"; d="scan'208";a="687681242"
Received: from skolhe-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.58.254])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jun 2023 02:39:13 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>,
 intel-gfx@lists.freedesktop.org
In-Reply-To: <20230609084504.1929424-3-mitulkumar.ajitkumar.golani@intel.com>
...
Date: Fri, 09 Jun 2023 12:39:08 +0300
Message-ID: <87fs71q8jn.fsf@intel.com>
MIME-Version: 1.0

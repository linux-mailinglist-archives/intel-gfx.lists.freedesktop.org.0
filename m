...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D50094083D3
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Sep 2021 07:33:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C481589CD3;
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v2 2/6] drm/displayid: add DisplayID v2.0
 data blocks and primary use cases

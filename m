...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E854532805
	for <lists+intel-gfx@lfdr.de>; Tue, 24 May 2022 12:41:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6291210F555;
...
Subject: [Intel-gfx] [PATCH v1 12/13] drm/edid: take HF-EEODB extension
 count into account

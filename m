...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A5CE30F83
	for <lists+intel-gfx@lfdr.de>; Fri, 31 May 2019 16:02:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B842893EC;
...
Subject: [Intel-gfx] [PATCH v7 3/8] drm/fb-helper: Prepare to move out
 commit code

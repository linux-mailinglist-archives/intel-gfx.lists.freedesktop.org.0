...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B533069144A
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Feb 2023 00:23:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3A56B10EBF8;
	Thu,  9 Feb 2023 23:23:49 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 4/8] drm/i915/pxp: Add GSC-CS backend to

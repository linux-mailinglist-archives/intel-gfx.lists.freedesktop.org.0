...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B0FCB275606
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:22:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4280C6E975;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 10/22] drm/nouveau: Introduce GEM object
 functions

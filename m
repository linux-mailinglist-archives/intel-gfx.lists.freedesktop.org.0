...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 747605BF492
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Sep 2022 05:28:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7F5FC10E80C;
	Wed, 21 Sep 2022 03:28:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5E58C10E80B;
 Wed, 21 Sep 2022 03:27:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663730874; x=1695266874;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=voXvV+TvCxvDe+YNBMVq0fqcfmfefLBKYnPfTwa/RVM=;
 b=Ypuk9aZY221Uyv9Pbt400MD/o99NtBGSDOtl9KjmO/AvWUzp+CrtWM24
 Bupm7Yl67bFs5kegKvG5/dtRFhCGMijK7sDDPcXAybXb6SuGH1APX7oXG
 U6pkDqBL4LT59/OmUie9+wG/L2khE6gFp08N79BpjNxuHw3pHZFynYepe
 MccwctrYiRy2DgVtTUW1rJEFDsXJm2G+fcSroomMYRLugITC/NyfZ9rbJ
 wGmer1ooSrLpO2me4Ta+GR1h4KOMlhemzMiFTEX94Irhl/XDJ3sutowiy
 XKusP12NZcOHwwjNyGZRijyh4o6he/kTAbppBQiq/OjjfngWervN+j8xS g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10476"; a="286957221"
X-IronPort-AV: E=Sophos;i="5.93,332,1654585200"; d="scan'208";a="286957221"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Sep 2022 20:27:53 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,332,1654585200"; d="scan'208";a="761574432"
...
Subject: [Intel-gfx] [PATCH v4 11/15] vfio/platform: Use the new device life
 cycle helpers

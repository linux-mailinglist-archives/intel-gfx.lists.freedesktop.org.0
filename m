...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 576CA77DD3C
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Aug 2023 11:26:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6680C10E310;
	Wed, 16 Aug 2023 09:26:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 51F9B10E310
 for <intel-gfx@lists.freedesktop.org>; Wed, 16 Aug 2023 09:26:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1692177968; x=1723713968;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=D3Q9KAUuZaKgNR1X2+jmMH7Wfcfi+BcZO7bPCOGddoM=;
 b=kENZxrrcS0PztNT+xN9GO7TqPGi6+VyvDR5v619zn17TR8+BOxU6EMnw
 qogx2CUQPvbKKx0SDbp6FQrboWueICU4/9tFBYvfL1rbnT72TuIYkzKfO
 qBQTSbUfrz1eO+AZfezljtylHSu+SuK6XjTZZBemai8GeKWTs/f/bG/bd
 qSd9cb1EQ5WYzSullFWmqBpbUkj1pjDa6evoIugngrMIa1QSxs72EL9SQ
 MJMfeRCUQibdzN3ovOKWFs4HhAC8RF/pZ3wb272HtB6Q68Vp+NvXwtWCt
 k9z11xNGCrwnomm0fPDdPBqitTBdgA8/oZMSLf8lAvQWBnmKJCHAVqjfE g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10803"; a="362639077"
X-IronPort-AV: E=Sophos;i="6.01,176,1684825200"; d="scan'208";a="362639077"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Aug 2023 02:26:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10803"; a="711051508"
X-IronPort-AV: E=Sophos;i="6.01,176,1684825200"; d="scan'208";a="711051508"
Received: from golubevv-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.252.52.134])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Aug 2023 02:26:05 -0700
...
Date: Wed, 16 Aug 2023 12:26:01 +0300
Message-ID: <87r0o39w46.fsf@intel.com>
MIME-Version: 1.0

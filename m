...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A6813283C
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Jun 2019 08:03:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8283B8994D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 4/8] drm/i915: vgpu context submission pv
 optimization

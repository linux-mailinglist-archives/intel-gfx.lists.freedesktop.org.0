...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 4L0kOBdV1mm8DQgAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 08 Apr 2026 15:16:07 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 43B1E3BCB49
	for <lists+intel-gfx@lfdr.de>; Wed, 08 Apr 2026 15:16:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB1EB10E645;
	Wed,  8 Apr 2026 13:16:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="nULT4G6q";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0CD0610E644;
 Wed,  8 Apr 2026 13:16:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1775654165; x=1807190165;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=s8eiGTp5fSvfse7iceou7EyGgrtGZ+Xjj8DIpT9+JZI=;
 b=nULT4G6qG4+YLGTnU0fY2G4YpHUcpkqm38KSBYTmIyiClj79pg5qTwl9
 gKdSYMWTVIvGB8J6NEtmTnCEGlidc9oeB6FBajfpk5mAT3HBzEEEXefQg
 iKbmXNN/AzvMNM1ByUbO6st8J0TNNltw+69SWrZphkmw2KuiBDuQhGq5N
 /hgRS+xuD1jWlOd4waK1ghxk8lX6drPbQRsoc9ntnUWoVARLB5m2389TF
 09YDzaxvcUOesMGmudSszEAsaqZ/ECV/YimXrO/0L6HFeuaBBWaF26Btu
 LiPVmVIWn178aa3OJ9rPTlG2S28CTdvyzYA58bo0OXy8LkpbMq5W/iqB9 g==;
X-CSE-ConnectionGUID: 33YV4J9uSpqc32Z2pdoKSg==
X-CSE-MsgGUID: y2zKZOtoQuiW1vucklOm+Q==
X-IronPort-AV: E=McAfee;i="6800,10657,11753"; a="94216437"
X-IronPort-AV: E=Sophos;i="6.23,167,1770624000"; d="scan'208";a="94216437"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Apr 2026 06:16:05 -0700
X-CSE-ConnectionGUID: MhlSWn8NQraIZLrFIktLKw==
X-CSE-MsgGUID: MGUFsC/vR7iwbLBRmyvfOA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,167,1770624000"; d="scan'208";a="266457367"
Received: from krybak-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.32])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Apr 2026 06:16:01 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	ville.syrjala@linux.intel.com
Subject: [PATCH 1/4] drm/i915/display: add typedef for intel_reg_t and use it
Date: Wed,  8 Apr 2026 16:15:48 +0300
Message-ID: <7f662cd4cc7dc8c40410fb67ea7ecaff406bb036.1775653994.git.jani.nikula@intel.com>

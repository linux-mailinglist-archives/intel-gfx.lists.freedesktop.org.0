...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CPCdGWxO82lnzQEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Apr 2026 14:43:24 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BE5FA4A2D97
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Apr 2026 14:43:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9C84C10E431;
	Thu, 30 Apr 2026 12:43:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 5ab824fced77 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1EFD510E431;
 Thu, 30 Apr 2026 12:43:20 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============1141456546167542670=="
MIME-Version: 1.0
...
Date: Thu, 30 Apr 2026 12:43:20 -0000
Message-ID: <177755300011.28203.9459108543872365513@5ab824fced77>
...
CI Bug Log - changes from CI_DRM_18388 -> Patchwork_165778v1
====================================================
...
-------
  ...
  **SUCCESS**
  ...
  External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_165778v1/index.html
...
------------
  ...
  Here are the changes found in Patchwork_165778v1 that come from known issues:
...
#### Issues hit ####
  ...
  * igt@i915_selftest@live@workarounds:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_165778v1/bat-arlh-3/igt@i915_selftest@live@workarounds.html
...
#### Possible fixes ####
  ...
  * igt@gem_exec_fence@basic-await@bcs0:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_165778v1/bat-twl-1/igt@gem_exec_fence@basic-await@bcs0.html
...
<tr><td><b>State:</b></td><td>success</td></tr>
    ...
    <h1>CI Bug Log - changes from CI_DRM_18388 -&gt; Patchwork_165778v1</h1>
<h2>Summary</h2>
<p><strong>SUCCESS</strong></p>
<p>No regressions found.</p>
<p>External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_165778v1/index.html</p>
<h2>Participating hosts (42 -&gt; 39)</h2>
<p>Missing    (3): bat-dg2-13 bat-arlh-2 fi-snb-2520m </p>
<h2>Known issues</h2>
<p>Here are the changes found in Patchwork_165778v1 that come from known issues:</p>
<h3>IGT changes</h3>
<h4>Issues hit</h4>
<ul>
<li>igt@i915_selftest@live@workarounds:<ul>
<li>bat-arlh-3:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18388/bat-arlh-3/igt@i915_selftest@live@workarounds.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_165778v1/bat-arlh-3/igt@i915_selftest@live@workarounds.html">DMESG-FAIL</a> (<a href="https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/12061">i915#12061</a>) +1 other test dmesg-fail</li>
</ul>
</li>
</ul>
...
<li>bat-twl-1:          <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18388/bat-twl-1/igt@gem_exec_fence@basic-await@bcs0.html">FAIL</a> (<a href="https://gitlab.freedesktop.org/drm/i915/kernel/-/issues/15263">i915#15263</a>) -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_165778v1/bat-twl-1/igt@gem_exec_fence@basic-await@bcs0.html">PASS</a> +1 other test pass</li>
</ul>
</li>
</ul>
<h2>Build changes</h2>
...
<p>CI-20190529: 20190529<br />
  ...
  Patchwork_165778v1: 3ac514cf64f272cc4d5143f4cc28fb18a8aba76d @ git://anongit.freedesktop.org/gfx-ci/linux</p>

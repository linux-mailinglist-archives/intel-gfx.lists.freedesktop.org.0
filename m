...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A1457193E46
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Mar 2020 12:49:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8383A6E8BD;
	Thu, 26 Mar 2020 11:49:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ADEB36E30E
 for <intel-gfx@lists.freedesktop.org>; Thu, 26 Mar 2020 11:49:29 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 26 Mar 2020 12:49:11 +0100
Message-Id: <20200326114922.1820274-10-maarten.lankhorst@linux.intel.com>
...
index b12355048501..c7f60fd89d3a 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3003,7 +3003,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3033,20 +3036,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3054,9 +3060,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3082,8 +3088,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -4860,13 +4868,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -4899,8 +4907,10 @@ static void virtual_context_exit(struct intel_context *ce)

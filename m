...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 16A591EE297
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Jun 2020 12:38:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4500F6E31E;
	Thu,  4 Jun 2020 10:38:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 344578999E
 for <intel-gfx@lists.freedesktop.org>; Thu,  4 Jun 2020 10:38:04 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21393758-1500050 
 for multiple; Thu, 04 Jun 2020 11:37:56 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  4 Jun 2020 11:37:41 +0100
Message-Id: <20200604103751.18816-12-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 12/22] drm/i915/gt: Implement ring scheduler for
 gen6/7
...
index 777cab6d9540..a3ba069f031e 100644
...
@@ -286,8 +290,258 @@ static void ring_copy(struct intel_ring *dst,
...
@@ -453,6 +707,33 @@ static void submission_unpark(struct intel_engine_cs *engine)
...
@@ -468,8 +749,30 @@ static void ring_context_destroy(struct kref *ref)
...
@@ -597,7 +900,7 @@ static int ring_context_alloc(struct intel_context *ce)
...
@@ -653,12 +956,19 @@ static void ring_release(struct intel_engine_cs *engine)
...
@@ -667,7 +977,7 @@ static void setup_common(struct intel_engine_cs *engine)
...
@@ -684,24 +994,62 @@ static void setup_common(struct intel_engine_cs *engine)
...
@@ -710,6 +1058,58 @@ static unsigned int global_ring_size(void)
...
@@ -753,6 +1153,12 @@ int intel_ring_scheduler_setup(struct intel_engine_cs *engine)
...
@@ -760,6 +1166,8 @@ int intel_ring_scheduler_setup(struct intel_engine_cs *engine)

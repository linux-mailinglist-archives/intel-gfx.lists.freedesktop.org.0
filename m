...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D1C5B1236
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Sep 2019 17:33:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A4C76EDAD;
	Thu, 12 Sep 2019 15:33:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7F11A6EDAB
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 Sep 2019 15:33:26 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 12 Sep 2019 08:33:26 -0700
X-IronPort-AV: E=Sophos;i="5.64,497,1559545200"; d="scan'208";a="184833575"
Received: from jnikula-mobl3.fi.intel.com (HELO localhost) ([10.237.66.161])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 12 Sep 2019 08:33:24 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 12 Sep 2019 18:33:19 +0300
Message-Id: <20190912153319.27942-1-jani.nikula@intel.com>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
Subject: [Intel-gfx] [CI RESEND] drm/i915: introduce INTEL_DISPLAY_ENABLED()
...
IGExOWY4YzczZjJlMC4uMmMwY2IzMjIzNWMwIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9kaXNwbGF5L2ludGVsX2Rpc3BsYXkuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9k
aXNwbGF5L2ludGVsX2Rpc3BsYXkuYwpAQCAtMTUzNjYsNyArMTUzNjYsNyBAQCBzdGF0aWMgdm9p
...
MikgewpAQCAtMTcyNzMsNyArMTcyNzMsNyBAQCBpbnRlbF9kaXNwbGF5X2NhcHR1cmVfZXJyb3Jf
...
MGRmY2I0MGYzMTYyLi45OTA0Zjc2MmY0YmIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9p
...
ZWxfZmJkZXZfaW5pdChkZXYpOwpAQCAtMTM3OCw3ICsxMzc4LDcgQEAgc3RhdGljIHZvaWQgaTkx
...
MDEsNyArMTQwMSw3IEBAIHN0YXRpYyB2b2lkIGk5MTVfZHJpdmVyX3JlZ2lzdGVyKHN0cnVjdCBk
...
L2k5MTVfZHJ2LmgKaW5kZXggYmY2MDA4ODhiM2YxLi40ZmFlYzJmOTRlMTkgMTAwNjQ0Ci0tLSBh
L2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZHJ2LmgKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvaTkxNV9kcnYuaApAQCAtMjE5Miw2ICsyMTkyLDkgQEAgSVNfU1VCUExBVEZPUk0oY29uc3Qg

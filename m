...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 700E96F1E64
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 20:58:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A17310EDB9;
	Fri, 28 Apr 2023 18:58:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A703010EDB6;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=N0BLeMADUmnWPmLGsO3RTXO9Z/vyIcXy88dcEptt6j0=;
 b=hfWkQJrdDiZ1tbDpu+/hiooYi5GN867nr5lr7r7udqMDKCn66h038PPa
 KHAC2VHNV8upLF5mxTSZqSv8ZUZ5aG9MrAb348sohJnmWtlB+x0dGgmU+
 q8InY/uQMJin7tAL5SAM8EFoVY7kbAYhpZPsFmt2s8DT3DyzwZ6mMSneb
 BRW6n2FeqgAUhRh02s75GPucuyvr52hg+8xINOuYmHHPErmoiNWdvk+jz
 meQkkzcQQdy+xElWyDItxvCfFQ8yA+47sVMkiGIS82ItcIjZoErI8Mue4
 sLm/8qXqXr1w1BFf0Oepu+iqw6AaRnsHQujC+ZZ4y3LsrxE/X2Njku0ys w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10694"; a="350747167"
X-IronPort-AV: E=Sophos;i="5.99,235,1677571200"; d="scan'208";a="350747167"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Apr 2023 11:58:27 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10694"; a="645254602"
X-IronPort-AV: E=Sophos;i="5.99,235,1677571200"; d="scan'208";a="645254602"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Apr 2023 11:58:26 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 28 Apr 2023 11:58:07 -0700
Message-Id: <20230428185810.4127234-6-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 5/8] drm/i915/huc: differentiate the 2 steps

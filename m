...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3269264651
	for <lists+intel-gfx@lfdr.de>; Wed, 10 Jul 2019 14:37:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F13F66E0D2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 6/6] drm/i915: Rename "inject_load_failure"
 module parameter

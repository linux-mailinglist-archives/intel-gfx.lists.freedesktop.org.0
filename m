...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A3A23AACA6
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Jun 2021 08:43:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 74B366E882;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 0/1] drm/i915/dg1: Add HWMON power sensor
 support

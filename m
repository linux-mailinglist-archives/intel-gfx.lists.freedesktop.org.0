...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EB0864B025
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Dec 2022 08:03:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4181B10E2E7;
	Tue, 13 Dec 2022 07:03:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7B9CF10E2C8
 for <intel-gfx@lists.freedesktop.org>; Tue, 13 Dec 2022 07:03:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670914996; x=1702450996;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=I6UhAvdVJHFIq49edK5V4QZpSKABf0YLHnLnUmPrPKE=;
 b=nF5Kxu8nmEE2TlcGLuQ0k3eMMHtP4yk5PjJmm9kPukmzEpFtgc5p6QgC
 QVvKkA/QsW7XKdRuE4m94ewKoWz+n4snNgchZqTO6+LHclB/d7NJeIQLn
 kOim1OOPFfAE3xM+r6sQRCBFQO2KzWp5tBpPLPFuIOBtYR1Wuvgg/IgIW
 Cllk5LvgU9XzSq68JisaQebRARJsHhvye9NULfLTQAEh8Sx+8jFWgP23C
 zatByfqDn89AH7+hs9pM+xIumD6+jyLdbqqDIlbC7RWPW6nmw2SdfyVFK
 ErFZQpmIk9ahMvhBmCxVClKAZhm3yJEVCJv0eV0MRUIzpCfbGvHassSOe Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10559"; a="404319202"
X-IronPort-AV: E=Sophos;i="5.96,240,1665471600"; d="scan'208";a="404319202"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Dec 2022 23:03:16 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10559"; a="977347076"
X-IronPort-AV: E=Sophos;i="5.96,240,1665471600"; d="scan'208";a="977347076"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga005.fm.intel.com with ESMTP; 12 Dec 2022 23:03:13 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 13 Dec 2022 12:31:58 +0530
Message-Id: <20221213070158.2621403-8-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 7/7] drm/i915/mtl: Add HDCP GSC interface

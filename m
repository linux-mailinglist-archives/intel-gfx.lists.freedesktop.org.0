...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE2444723C1
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Dec 2021 10:25:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 57CF610E643;
...
Subject: Re: [Intel-gfx] [PATCH v2] drm/i915: Don't disable interrupts and

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 289107C7485
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Oct 2023 19:22:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2348510E568;
...
Subject: [Intel-gfx] [PATCH v7 17/25] dyndbg-API: promote

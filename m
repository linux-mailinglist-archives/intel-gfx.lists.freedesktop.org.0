...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BE0CF21EFAA
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 13:45:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2AA2F6E418;
	Tue, 14 Jul 2020 11:45:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9E1376E952
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Jul 2020 11:45:21 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Jul 2020 13:45:06 +0200
Message-Id: <20200714114516.3073222-13-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 13/23] drm/i915: Rework intel_context pinning to
...
index e0280a672f1d..e5dd900d135b 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3309,7 +3309,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3471,20 +3474,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3492,9 +3498,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3520,8 +3526,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -5443,12 +5451,12 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -5476,8 +5484,10 @@ static void virtual_context_exit(struct intel_context *ce)
...
index 94915f668715..fa34f2cc4f98 100644

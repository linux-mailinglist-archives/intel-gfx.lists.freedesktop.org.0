...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC81D6DD0D9
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Apr 2023 06:25:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F46710E49A;
...
Subject: [Intel-gfx] [PATCH 0/9] drm/i915/mtl: Define MOCS and PAT tables
 for MTL

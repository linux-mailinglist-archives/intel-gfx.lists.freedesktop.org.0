...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 83D1C69B58C
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Feb 2023 23:34:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6FA7010E46F;
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915/guc: Improve clean up of

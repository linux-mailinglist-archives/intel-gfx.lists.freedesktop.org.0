...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 852D43D895B
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Jul 2021 10:05:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC8CE6E581;
...
Subject: [Intel-gfx] [PATCH] drm/i915/gt: Fix a lockdep warning with disable
 interrupts

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A5C07C90CF
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 00:49:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB7D410E675;
...
Subject: [Intel-gfx] [PATCH v7b 13/25] dyndbg-API: remove

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FD9538FA22
	for <lists+intel-gfx@lfdr.de>; Tue, 25 May 2021 07:48:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8E033890DF;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 03/17] drm/i915/pxp: define PXP device flag
 and kconfig

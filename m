...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6473B8AD65A
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Apr 2024 23:11:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 99AAA112D91;
	Mon, 22 Apr 2024 21:11:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="ZxPz5D6R";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.17])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9D255112D91
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 Apr 2024 21:11:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1713820264; x=1745356264;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=CuWVF1CuA0gbqhQIRuHEj1lliGKxaYtJwN0waVVny0w=;
 b=ZxPz5D6RmuolyLZy4304/nwtm0VtvH6hhNnkeRtry2lnaTUVVJI/ist4
 pFoH/tsxwEt+SKKsJ1cvwX5t0+b9Xlfy1H2NHoafhm0IiaEzg9k6hVyKR
 arvmyYejmjXWYOFR3EOSQroNFE47sq0WnCLN5Qz+ke6OTYRTnC8qz3lyu
 IvjMFnbK5q246jIMv97XZ3a6LgLbSEil/6gzR1OCoWZnvC0ueNoLG4Zag
 BgMZlBWv69OpesBIMeM1LSxZE9w+lKNMivHATNdC01/COaA4ufi0nLAuI
 iWjB/erTWsxEoX5CIr1I4A+4a209c2ghe2MIZiWri/+l3+r9xIzldEPQf w==;
X-CSE-ConnectionGUID: jiK8JDpbTVOGStH3RIXhYA==
X-CSE-MsgGUID: DnP0+cRuQHW6wHO7AGhAKg==
X-IronPort-AV: E=McAfee;i="6600,9927,11052"; a="9490282"
X-IronPort-AV: E=Sophos;i="6.07,221,1708416000"; 
   d="scan'208";a="9490282"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa109.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Apr 2024 14:11:04 -0700
X-CSE-ConnectionGUID: tANB4U3jQqqBOXnxawduFg==
X-CSE-MsgGUID: ha5czHFyS22zIGxrp8VicA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,221,1708416000"; d="scan'208";a="24761748"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
 by orviesa008.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384;
 22 Apr 2024 14:10:59 -0700
Received: from fmsmsx611.amr.corp.intel.com (10.18.126.91) by
 fmsmsx601.amr.corp.intel.com (10.18.126.81) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.35; Mon, 22 Apr 2024 14:10:58 -0700
...
Received: from fmsedg601.ED.cps.intel.com (10.1.192.135) by
 ...
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.35 via Frontend Transport; Mon, 22 Apr 2024 14:10:58 -0700
Received: from NAM04-BN8-obe.outbound.protection.outlook.com (104.47.74.40) by
 edgegateway.intel.com (192.55.55.70) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.35; Mon, 22 Apr 2024 14:10:57 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=U5Qz6MvBZs9dwqUrPlIvV/WUax0mvn8qZtiqS7/iGPo=;
 b=
...
In-Reply-To: <6dd52f3fce3527242479aadc276d05de74ceae5d.1713520813.git.jani.nikula@intel.com>
X-ClientProxiedBy: BY5PR20CA0002.namprd20.prod.outlook.com
 (2603:10b6:a03:1f4::15) To MN0PR11MB6059.namprd11.prod.outlook.com
 (2603:10b6:208:377::9)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: MN0PR11MB6059:EE_|PH8PR11MB6756:EE_
X-MS-Office365-Filtering-Correlation-Id: 75eab353-8760-46b4-6f50-08dc6310b1c1
X-LD-Processed: 46c98d88-e344-4ed4-8496-4ed7712e255d,ExtAddr
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;ARA:13230031|376005|1800799015|366007;
X-Microsoft-Antispam-Message-Info: =?us-ascii?Q?8upadsRggYdukGJI0cnJOJs5nsPmFOxoiDoI1NAiP1ch8u8HWIKxUc9XOOkj?=
 =?us-ascii?Q?48MCcCFaqaQXiLW9II/bJx7MDADMKkcIRFMgDGgU+lax2Y8ZSSB4WvAmGhvx?=
 =?us-ascii?Q?OJicIHYGDiYWVyXFwz8neD+y9Wf07H2iXAHU1uLq7Ri+Ept5c3POosJieBaE?=
 =?us-ascii?Q?wGIT/ZdQxzqjoZpIE/VNHn7pHN3gHM3Ma2OhFBphEhP+RZH90aSyM0/O9p6C?=
 =?us-ascii?Q?fafp97Q7Xoq0lgZZqlcrSotBsh4paXN96fhGfGzFNAkPmsGvnXeAUfaf1NiL?=
 =?us-ascii?Q?yz8Y/1QCh+Y3r0cVEEso3GT8Qy6iAtUdKr1wzegYCR6t0EWTF6dM+LL3QbSN?=
 =?us-ascii?Q?b4DsiZgsYm1px0LwUWy8FbEUwxbetrGVisBjVZRfU7OZmuLNlwXgEZqwZng3?=
 =?us-ascii?Q?qhLTRNHpBlZQhsaDSAzHLZfM1Pug52OKQwWrIk+kvqjN/MHOy/tB0uMg1WRh?=
 =?us-ascii?Q?xySg61s4LjQLeBU/UR57S/3pCHL5a/KGQS4TOLbSBvDMgGLRaRNEMq9NQjuR?=
 =?us-ascii?Q?kbmDTVYm2bmI/jarMIAMOhSRfGNd621PCBDoVML8BoHWDWI2O7U+rpMeW25A?=
 =?us-ascii?Q?04Gh7C/jAym8RBd3hFNKvC+2eda5AqUBE3VA8VYjZvHOwJH4GYlJa3x7Q6F+?=
 =?us-ascii?Q?c6ZDTRoH6uZ0i96PAN7+SbQukBv69fwgPnKmyuvh1/yTpNlc9DHPagYwhDY3?=
 =?us-ascii?Q?HS2D6p6d4AeQ99hymaEC+Z8omuIlm/2C4fRxDUMGbJp5s1wDfxeFIplOJHKS?=
 =?us-ascii?Q?NBCj/SUYBbW4RtJrfAVVsGfED10jz1k68pnR+Wt/HyAajvH0385tbACRSYES?=
 =?us-ascii?Q?SBTfS3yjWaNXuhG7CGkyx1K1h71S3ZMRGrrgiAsaVm9rgzSboMaF1MioyPnp?=
 =?us-ascii?Q?AxmhGlUKOt63CrD0isVm2b52oJgeXJ5xCiWtjVAz3QVZJJtndV5qiLyb72+o?=
 =?us-ascii?Q?ZkozacRH2LXn+FTirozfxuZhs9/V9nOJTGGFP7qANCD87viBp9kZMQULXfhI?=
 =?us-ascii?Q?0SVk6LT/Tfr6f8r4tZtbfYmSVTlzK6C1JjbxCYoRy/LQTkKYi/PL+UTPCLFA?=
 =?us-ascii?Q?msNdMg1NCZPMv0yFflhpLf89PUmi0+SjRPzcqXssfFK7hCtFKKeHGIfjc77i?=
 =?us-ascii?Q?YcD1G+O+E8saIObvQSb/KZMYqv7Y4ngMGmav/T5hOxTz8jUekvxk20Ntx3/+?=
 =?us-ascii?Q?emjxsJ+gJe7hGXwcb9tt+Vqfway5DkjnkEZFOL3oDiShc98WYk6EuQxxwHxi?=
 =?us-ascii?Q?xaLPtDjirkN35lm3z5MrzV4IpK+z5OPulPtGYiCSJA=3D=3D?=
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:MN0PR11MB6059.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230031)(376005)(1800799015)(366007); DIR:OUT; SFP:1101; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?v+GENh1gVD5qjDgJY4iJmg9L4foN4I1L5x6EJk5jY7iCD1zSmiqc/pACg6uc?=
 =?us-ascii?Q?Rr/abtMwWsSbE+P4v06nJ3+ZO9X9/vlPPZGkDqTXDgf5a85zHEyqNDHPICiE?=
 =?us-ascii?Q?Tw4trB6mMNR6IIhj/BkGnH3VNNrctqgeBK8LS0Amd+ZOn1w83PwSOXSpr2Wk?=
 =?us-ascii?Q?6dNmNZvUROaaEL9T5x6BAGEYRFRmo2Ki9PoIVSRh5GW+zLG+dl/FztwWI5Qf?=
 =?us-ascii?Q?jaiGbCfMd1SLQufF8fk8lW2F6sMLlfQmqYig+d+SsT0Umqj1PqGAvCbBE6xa?=
 =?us-ascii?Q?jp0Q07zrV8DaaIOB1hi2THDeFdvfRWjkWmi8WB1WQdBVIMI37AwCvCePbrrv?=
 =?us-ascii?Q?Vks10Jrm0YI+QPEJtGffmnpT7hkvCXU0MvQTnmdK9jtGQHb0JOXizDtstDvI?=
 =?us-ascii?Q?BEroy4A6RzLIcLMjTeNG/XlkzdoxaEZVKDepPYQUbD5uTURvdmnOKkpY/Nf+?=
 =?us-ascii?Q?nPAhoCg4uGdDB6DJ/MCLlTqfNc+ltFqna6Oat7ifyZF4mJnfltblZkRMjWYI?=
 =?us-ascii?Q?lkBE2SSafgbLXpx1R05jQH2ncJpFbAIadt1Rzq1c9OayXGCmkeUggyykmy/8?=
 =?us-ascii?Q?iIs25znEX2bxbKCvYpZXnYfn9ZYYaGUFrqEp59Ang+yCI6PsYaY50S8abCmB?=
 =?us-ascii?Q?F6E0HcDJrKoXa0ld7KNyXI3F8cQjxl/HKRr2Uv4E+WyJ425Dhmudn0fcf68D?=
 =?us-ascii?Q?cUSvNlZmoo2O6HyaUGQ4Mnq0XU4/GZv0fvl5oSJZXabMAh79Sm9qgqG/uyXG?=
 =?us-ascii?Q?NCFYY9laoZPe8R5QHUKKQ/9aGYaCag7aR0fLqgFhFeeQO0yVWVR6ozlZYqrr?=
 =?us-ascii?Q?YbtlcKP4nvVdFN0uzuDtJsQuh/SbVTMbGMaSNG0jFtbDBqxIjw8mYqKcHs+k?=
 =?us-ascii?Q?CWwPYU5wzfdyonxNi2pNtS1J6Tr2s8c321zkIt6dcHnKRmddPr2Phvm9dV7C?=
 =?us-ascii?Q?n9PMjsGshi2zEnb7ofJByiTXRl2DLH4e2Q5btf9WsNEnv2e7GDW8HiF/6RNu?=
 =?us-ascii?Q?t10XxpT7Yf8LxfAygOicJmdUbne+wi/84twbK1mpJz60J3+bIh72LlnJelKw?=
 =?us-ascii?Q?8vIQzmlgGNA5uhIFR+EVGbaX1rKMDhs6NUmmpzrDBvItD9CFyk0Al+gLZzRz?=
 =?us-ascii?Q?yBvbzYlCVKiFvRR9xKb4zm/b/4p/D+u2BaYC4pMfOxzKyugRVnJuIe42v0ZG?=
 =?us-ascii?Q?2KtnshyA6GECUswbNDtPExqyWF5V9kjSHsS95ApRecHdqh7DJ8k8l16l+oso?=
 =?us-ascii?Q?628r8xuS1n29Cw+b7G6SUvSXhLd9Tu1QENmLmpRHdq8t0dMVojutBna+xeQv?=
 =?us-ascii?Q?bPypUlP98YXd3FPpN9rOQPOmvVXLtT4p2z78ZzwwIcJj6Ryo4VrPqy9O1/AZ?=
 =?us-ascii?Q?Ab5CjObtnMuZ50VPYsMKBHNcH3Jv4fPrLfAhZKAKV2j6hrEd6ao9BZ4rglzc?=
 =?us-ascii?Q?Gsg9WswB2HhL3eZggHnlgEBmyqjz4qPK3OunXf2vfxCQsDzLEkHcpNEODx90?=
 =?us-ascii?Q?cAg26BGjAw9t6obFpuSj+eCWYe4U8M5ipiQ7UU7BqMUMhopRLzrEQbhove/R?=
 =?us-ascii?Q?Iwf+G1FKxr06Ew0cbjvO0VIaoldqf8S88dwqCBLCacP3U81+Apvzs88gP4jY?=
 =?us-ascii?Q?jA=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 75eab353-8760-46b4-6f50-08dc6310b1c1
X-MS-Exchange-CrossTenant-AuthSource: MN0PR11MB6059.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Apr 2024 21:10:53.6942 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: CJX4Uj2wyxs1XUK1rEeEio0q9+8nZinj4zYMK0Tdl5qTwlmgiAvssbqC28ML/uhzsCraFpy8a6/2oeYa20kyrA==

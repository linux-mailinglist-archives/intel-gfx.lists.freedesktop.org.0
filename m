...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 69EB26EB725
	for <lists+intel-gfx@lfdr.de>; Sat, 22 Apr 2023 05:41:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DE95610E1DB;
...
Subject: [Intel-gfx] [PATCH v2 0/4] drm/i915: Add support for MTL GSC SW
 Proxy

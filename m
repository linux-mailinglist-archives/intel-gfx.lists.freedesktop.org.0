...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 766F52CA960
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Dec 2020 18:17:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC95D6E560;
	Tue,  1 Dec 2020 17:17:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B96306E560
 for <intel-gfx@lists.freedesktop.org>; Tue,  1 Dec 2020 17:17:23 +0000 (UTC)
IronPort-SDR: 73pdnIXzCkZE1fQ+J+INzwDNqD7PFPcY2dD9ZHnkspjEGzpqYqxRP28YWGM1Narqat50eB4NsR
 PZGZM/GYwT2g==
X-IronPort-AV: E=McAfee;i="6000,8403,9822"; a="159924359"
X-IronPort-AV: E=Sophos;i="5.78,384,1599548400"; d="scan'208";a="159924359"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Dec 2020 09:17:21 -0800
IronPort-SDR: TX2GYlUviy9kds7aU+0DkYqVo6U6bdFyFwcbsO1gcj8H1eFimH6hwlhzDwy54vfA8XnwXs7aBb
 2EAykGeTK2tQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,384,1599548400"; d="scan'208";a="434740577"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by fmsmga001.fm.intel.com with SMTP; 01 Dec 2020 09:17:18 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 01 Dec 2020 19:17:17 +0200
Date: Tue, 1 Dec 2020 19:17:17 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: "Navare, Manasi" <manasi.d.navare@intel.com>
Message-ID: <20201201171717.GB6112@intel.com>
References: <20201124201156.17095-1-ville.syrjala@linux.intel.com>
 <20201130225358.GD17815@labuser-Z97X-UD5H>
MIME-Version: 1.0
...
> > @@ -312,10 +312,13 @@ int intel_plane_atomic_check_with_state(const str=
...
> Why not just add this a part of the intel_plane_set_invisible() function =
and may be rename that
...
> > @@ -3561,11 +3561,14 @@ static void fixup_active_planes(struct intel_cr=
tc_state *crtc_state)
...
> > @@ -3583,7 +3586,7 @@ static void intel_plane_disable_noatomic(struct i=
ntel_crtc *crtc,
...
> > @@ -12842,6 +12845,7 @@ static int icl_check_nv12_planes(struct intel_c=
...
> >  		}
> > @@ -12885,6 +12889,7 @@ static int icl_check_nv12_planes(struct intel_c=
rtc_state *crtc_state)
> >  =
...
> > @@ -19165,7 +19170,7 @@ static void readout_plane_state(struct drm_i915=
_private *dev_priv)

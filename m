...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 532761B28F9
	for <lists+intel-gfx@lfdr.de>; Tue, 21 Apr 2020 16:05:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E74BE6E995;
	Tue, 21 Apr 2020 14:05:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx2.suse.de (mx2.suse.de [195.135.220.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4AD7A6E991;
 Tue, 21 Apr 2020 14:05:42 +0000 (UTC)
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
 by mx2.suse.de (Postfix) with ESMTP id 9FCECADC8;
 Tue, 21 Apr 2020 14:05:39 +0000 (UTC)
To: Daniel Vetter <daniel.vetter@ffwll.ch>
References: <20200414090738.GA16827@linux-uq9g>
 <2f5f6131-0a57-a81d-5cdf-8f3144f2679f@suse.de>
 <CAKMK7uHL0mDX9oQx6Pe8yNc+jh2JTNFDx41mjWGChb2dXKB_HA@mail.gmail.com>
...
Autocrypt: addr=tzimmermann@suse.de; keydata=
 ...
 3H26qrE=
Message-ID: <eff902ff-cb98-aabe-2586-60a1863a8312@suse.de>
Date: Tue, 21 Apr 2020 16:05:39 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.6.0
MIME-Version: 1.0
In-Reply-To: <CAKMK7uHL0mDX9oQx6Pe8yNc+jh2JTNFDx41mjWGChb2dXKB_HA@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============1141486477=="
...
Content-Type: multipart/signed; micalg=pgp-sha256;
 ...
 boundary="qeDQn9586CA8ueNH7H7fGKJHt7umI5jUN"

This is an OpenPGP/MIME signed message (RFC 4880 and 3156)
--qeDQn9586CA8ueNH7H7fGKJHt7umI5jUN
Content-Type: multipart/mixed; boundary="DOipUuRB1yzkwc9vr76Di1q9r0U4nnTmh";
...
--DOipUuRB1yzkwc9vr76Di1q9r0U4nnTmh
...
> On Tue, Apr 21, 2020 at 2:46 PM Thomas Zimmermann <tzimmermann@suse.de>=
 wrote:
>>
>> Hi Dave, Daniel,
>>
...
>>> Hi Dave, Daniel,
>>>
>>> with 5.7-rc1 being tagged, here's the first PR for drm-next-misc for =
what will become Linux 5.8.
>>>
>>> Best regards
>>> Thomas
>>>
...
>>>   - Make various .debugfs functions return 0 unconditionally; ignore =
errors
...
>>>
>>> The following changes since commit c2556238120bce8be37670e145226c1287=
0a9e5a:
>>>
>>>   Merge branch 'feature/staging_sm5' of git://people.freedesktop.org/=
~sroland/linux into drm-next (2020-03-25 15:45:45 +1000)
>>>
>>> are available in the Git repository at:
>>>
>>>   git://anongit.freedesktop.org/drm/drm-misc tags/drm-misc-next-2020-=
04-14
>>>
>>> for you to fetch changes up to 14d0066b8477775971db7d0ef03c86fefe4d5b=
f2:
>>>
>>>   drm: kirin: Revert change to add register connect helper functions =
(2020-04-13 01:46:02 +0000)
>>>
>>> ----------------------------------------------------------------
>>> drm-misc-next for 5.8:
>>>
...
>>>       drm/core: Allow drivers allocate a subclass of struct drm_frame=
buffer
...
>>>       drm/mm: revert "Break long searches in fragmented address space=
s"
...
>>>
>>> David Lu (2):
>>>       dt-bindings: boe, tv101wum-n16: Add compatible for boe tv105wum=
-nw0.
...
>>>       drm/mipi-dbi: Make mipi_dbi_command_stackbuf() data parameter c=
onst
>>>
...
>>>
>>> Heiko Stuebner (2):
>>>       dt-bindings: display: panel: Add binding document for Leadtek L=
TK050H3146W
>>>       drm/panel: add panel driver for Leadtek LTK050H3146W
>>>
>>> Huacai Chen (1):
>>>       drm/qxl: Use correct notify port address when creating cursor r=
ing
>>>
>>> Huang Rui (1):
...
>>>
>>> Jagan Teki (3):
>>>       dt-bindings: display: panel: Convert feiyang,fy07024di26a30d to=
 DT schema
>>>       dt-bindings: display: panel: Convert sitronix,st7701 to DT sche=
ma
>>>       MAINTAINERS: Update feiyang,st7701 panel bindings converted as =
YAML
>>>
>>> Jason Yan (2):
>>>       video: fbdev: matroxfb: remove dead code and set but not used v=
ariable
>>>       video: fbdev: mb862xx: remove set but not used variable 'mdr'
>>>
>>> Jernej Skrabec (6):
>>>       drm/sun4i: de2: rgb field in de2 format struct is redundant
>>>       drm/sun4i: de2: csc_mode in de2 format struct is mostly redunda=
nt
...
>>>
>>> John Stultz (1):
>>>       drm: kirin: Revert change to add register connect helper functi=
ons
>>>
>>> Jonas Karlman (1):
...
>>>
>>> Lyude Paul (12):
>>>       drm/amd/amdgpu_dm/mst: Remove unneeded edid assignment when des=
troying connectors
>>>       drm/amd/amdgpu_dm/mst: Remove ->destroy_connector() callback
>>>       drm/amd/amdgpu_dm/mst: Stop printing extra messages in dm_dp_ad=
d_mst_connector()
...
>>>
>>> Marek Szyprowski (1):
>>>       drm/bridge: sii9234: silence warning about regulators during de=
ferred probe
>>>
>>> Markus Elfring (2):
...
>>>
>>> Sean Paul (3):
>>>       drm/mst: Separate sideband packet header parsing from message b=
uilding
...
>>>
>>> Takashi Iwai (3):
>>>       video: omapfb: Use scnprintf() for avoiding potential buffer ov=
erflow
>>>       video: omap2: Use scnprintf() for avoiding potential buffer ove=
rflow
>>>       video: uvesafb: Use scnprintf() for avoiding potential buffer o=
verflow
>>>
>>> Tang Bin (1):
>>>       video: fbdev: don't print error message on platform_get_irq() f=
ailure
>>>
...
>>>       drm/ast: Set up fbdev after registering device; remove error ch=
ecks
...
>>>       drm/mgag200: Set up fbdev after registering device; remove erro=
r checks
>>>       drm/tilcdc: Set up fbdev after fully registering device
>>>       drm/udl: Remove error check from fbdev setup
>>>       drm/vboxvideo: Set up fbdev after registering device; remove er=
ror checks
...
>>>
>>> Tian Tao (1):
>>>       drm/hisilicon: Enforce 128-byte stride alignment to fix the har=
dware limitation
>>>
>>> Tomi Valkeinen (1):
...
>>>       drm/edid: Remove idx=3D=3D1 assumptions from all over the DispI=
D parsing
>>>       drm/edid: Return DispID length from drm_find_displayid_extensio=
n()
>>>       drm/edid: Move validate_displayid() drm_find_displayid_extensio=
n()
...
>>>       drm/etnaviv: remove check for return value of drm_debugfs_creat=
e_files()
>>>       drm/msm: remove checks for return value of drm_debugfs_create_f=
iles()
...
>>>       drm/omap: remove checks for return value of drm_debugfs functio=
ns
>>>       drm/i915: have *_debugfs_init() functions return void.
>>>       drm: make various debugfs_init() functions return 0
>>>       drm/debugfs: remove checks for return value of drm_debugfs func=
tions.
...
nwl-dsi.yaml
>>>  delete mode 100644 Documentation/devicetree/bindings/display/panel/f=
eiyang,fy07024di26a30d.txt
>>>  create mode 100644 Documentation/devicetree/bindings/display/panel/f=
eiyang,fy07024di26a30d.yaml
>>>  create mode 100644 Documentation/devicetree/bindings/display/panel/l=
eadtek,ltk050h3146w.yaml
>>>  delete mode 100644 Documentation/devicetree/bindings/display/panel/s=
itronix,st7701.txt
>>>  create mode 100644 Documentation/devicetree/bindings/display/panel/s=
itronix,st7701.yaml
>>>  create mode 100644 Documentation/devicetree/bindings/display/panel/v=
isionox,rm69299.yaml
>>>  delete mode 100644 Documentation/devicetree/bindings/display/rockchi=
p/rockchip-vop.txt
...
>>>  create mode 100644 drivers/gpu/drm/panel/panel-leadtek-ltk050h3146w.=
c
...

=TcTs
-----END PGP SIGNATURE-----

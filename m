...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A9D7274267
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Sep 2020 14:51:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0C5296E073;
...
Subject: [Intel-gfx] [PATCH 0/7] drm/i915: Add support for LTTPR

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26A93341D52
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Mar 2021 13:49:41 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3CC826E9FB;
	Fri, 19 Mar 2021 12:49:34 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/3] drm/vc4: Add HDR metadata property to the
 VC5 HDMI connectors

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7AB319F4C6
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Apr 2020 13:37:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C4AA6E358;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/18] drm/i915/display/frontbuffer: Prefer

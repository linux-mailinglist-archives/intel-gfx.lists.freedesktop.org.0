...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 47096650FC5
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Dec 2022 17:06:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7468110E2C5;
...
Subject: [Intel-gfx] [PATCH 11/18] fbdev/efifb: Do not use struct
 fb_info.apertures

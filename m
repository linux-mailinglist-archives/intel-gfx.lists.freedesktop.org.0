...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FC4B6F8666
	for <lists+intel-gfx@lfdr.de>; Fri,  5 May 2023 18:08:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8B01710E63B;
...
Subject: [Intel-gfx] [PATCH 3/6] drm/i915/uc/gsc: extract release and

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7775F21FF0C
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:58:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6FE096E97D;
...
Subject: [Intel-gfx] [PATCH v2 08/59] drm/kmb: Added mipi_dsi_host
 initialization

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E69A416C33
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 08:51:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E403F6EDF8;
	Fri, 24 Sep 2021 06:50:57 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 05/17] drm/vmwgfx: cleanup:

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A68831F0FFC
	for <lists+intel-gfx@lfdr.de>; Sun,  7 Jun 2020 23:25:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CE0BB6E1C0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/3] drm/dp_mst: Fix the DDC I2C device

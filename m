...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE27128FDE2
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Oct 2020 07:59:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 56C158920A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 0/2] Enable GVT suspend/resume

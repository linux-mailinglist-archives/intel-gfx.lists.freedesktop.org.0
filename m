...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E615144AF4
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jun 2019 20:43:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 24E11897E3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC][PATCH 1/2] drm: Improve PATH prop docs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C9B3E4FBE14
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:01:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E72010F2C9;
	Mon, 11 Apr 2022 14:01:18 +0000 (UTC)
...
Subject: [Intel-gfx] [CI v3 06/12] drm/edid: add typedef for block read
 function

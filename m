...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3289C2ECB7E
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Jan 2021 09:08:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D38C56E41B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 0/8] drm: Move struct drm_device.pdev to
 legacy

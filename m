...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E75D71F4EE
	for <lists+intel-gfx@lfdr.de>; Wed, 15 May 2019 15:01:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1D5E189292;
	Wed, 15 May 2019 13:01:20 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ACF7A89289
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 May 2019 13:01:17 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 16564758-1500050 
 for multiple; Wed, 15 May 2019 14:00:52 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 15 May 2019 14:00:49 +0100
Message-Id: <20190515130052.4475-2-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 2/5] drm/i915: Truly bump ready tasks ahead of
 busywaits
...
aTkxNV9yZXF1ZXN0LmMKaW5kZXggMTE2NzA3NzRjZDI1Li4yYTEwNzllNDcyZTIgMTAwNjQ0Ci0t
LSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfcmVxdWVzdC5jCisrKyBiL2RyaXZlcnMvZ3B1
L2RybS9pOTE1L2k5MTVfcmVxdWVzdC5jCkBAIC01NzUsMTggKzU3NSw3IEBAIHNlbWFwaG9yZV9u
...
NTIsMTIgKzg0MSw2IEBAIGVtaXRfc2VtYXBob3JlX3dhaXQoc3RydWN0IGk5MTVfcmVxdWVzdCAq
...
IGdmcCk7CiAJaWYgKGVycikKQEAgLTkyMyw4ICs5MDYsMTggQEAgaTkxNV9yZXF1ZXN0X2F3YWl0

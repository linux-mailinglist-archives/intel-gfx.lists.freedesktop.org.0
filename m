...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 900648320F3
	for <lists+intel-gfx@lfdr.de>; Thu, 18 Jan 2024 22:40:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB3E010E8FA;
	Thu, 18 Jan 2024 21:40:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4F77710E8EC
 for <intel-gfx@lists.freedesktop.org>; Thu, 18 Jan 2024 21:40:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1705614022;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=xa92SUx0tviopJhDIWZGFz30fwUB0DJ3p+sWP4FEk+s=;
 b=YpP7roA+d0kj7xaddt4a+TV6lnQK8WiqdTWc0X+hnjfhDZOERVkNgpSMTsP+KHUaP0fPBN
 jMP8GbxcvFierIcIVnP8nWg6vLGZO2iouqYrplWRonYsXerqdGqKi8l6NhXBBReZMob5zV
 sJj//v2NsO+iVSOC5wsOzieMrjnQ8yc=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-571-LpiPtqrONJGLwUTDJDQgGg-1; Thu, 18 Jan 2024 16:40:19 -0500
X-MC-Unique: LpiPtqrONJGLwUTDJDQgGg-1
Received: by mail-wr1-f71.google.com with SMTP id
 ffacd0b85a97d-337d05db5bbso28726f8f.3
 for <intel-gfx@lists.freedesktop.org>; Thu, 18 Jan 2024 13:40:19 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=xa92SUx0tviopJhDIWZGFz30fwUB0DJ3p+sWP4FEk+s=;
 b=
X-Gm-Message-State: AOJu0YxOXtXRVXWeKplaKnBc90MPLwqIVCvlRiyjp6f9nxqagnwSRQ3m
 //Y+0ny/5B13rmRLWz/GfKKlbvlsAWzuqFFAoZihCBglk0qM0/OUzROompw9u4gjmdaOjzuZu4t
 JJKKD3ImbzuPII1McWk8RJ3rI6A3YAe6C17bkefuIb2RnbNC5MoqJY/tHDv/RVwD+Xw==
X-Received: by 2002:a05:600c:35d1:b0:40e:4806:7f9b with SMTP id
 r17-20020a05600c35d100b0040e48067f9bmr467114wmq.307.1705614018252; 

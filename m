...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A9FD4065F9
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Sep 2021 05:18:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DCED6E95F;
	Fri, 10 Sep 2021 03:18:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD01E6E95F
 for <intel-gfx@lists.freedesktop.org>; Fri, 10 Sep 2021 03:18:13 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-423-pjsgELUJMlOT8K3Ep-nNNA-1; Thu, 09 Sep 2021 23:18:09 -0400
X-MC-Unique: pjsgELUJMlOT8K3Ep-nNNA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com
 [10.5.11.22])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 6A4DB1006AA0;
 Fri, 10 Sep 2021 03:18:08 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 25521100EBC1;
 Fri, 10 Sep 2021 03:18:06 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Fri, 10 Sep 2021 13:17:25 +1000
Message-Id: <20210910031741.3292388-10-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 09/25] drm/i915: split watermark vfuncs from
 display vtable.
...
=20
@@ -179,20 +179,20 @@ static int intel_compute_intermediate_wm(struct intel=
_atomic_state *state,
...
+=09=09=09!dev_priv->wm_disp.compute_pipe_wm))
 =09=09return 0;
-=09return dev_priv->display.compute_intermediate_wm(state, crtc);
+=09return dev_priv->wm_disp.compute_intermediate_wm(state, crtc);
 }
=20

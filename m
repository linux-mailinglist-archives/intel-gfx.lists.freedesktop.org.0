...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF3564DEAB8
	for <lists+intel-gfx@lfdr.de>; Sat, 19 Mar 2022 21:42:11 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9215310ED11;
	Sat, 19 Mar 2022 20:42:01 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 2/8] drm/i915/gt: Clear compress metadata for
 Flat-ccs objects

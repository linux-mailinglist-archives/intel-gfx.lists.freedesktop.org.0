...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D9121316BE
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Jan 2020 18:28:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD53F6E4D7;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC 3/7] drm/i915: add helper functions to get device
 ptr

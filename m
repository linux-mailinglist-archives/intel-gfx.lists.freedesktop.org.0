...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9004E5627B8
	for <lists+intel-gfx@lfdr.de>; Fri,  1 Jul 2022 02:31:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A135310E16A;
...
Subject: [Intel-gfx] [PATCH v8 0/3] drm/doc/rfc: i915 VM_BIND feature design
 + uapi

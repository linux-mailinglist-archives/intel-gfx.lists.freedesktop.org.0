...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B95763B1AC
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Nov 2022 19:55:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 49AC310E226;
	Mon, 28 Nov 2022 18:55:08 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/huc: always init the delayed load
 fence

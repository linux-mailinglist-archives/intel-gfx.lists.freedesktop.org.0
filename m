...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B2E4B2755FB
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Sep 2020 12:22:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 08A806E922;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 08/22] drm/mediatek: Introduce GEM object
 functions

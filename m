...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 099546D4342
	for <lists+intel-gfx@lfdr.de>; Mon,  3 Apr 2023 13:18:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D34410E190;
	Mon,  3 Apr 2023 11:18:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CA26788A72
 for <intel-gfx@lists.freedesktop.org>; Mon,  3 Apr 2023 11:18:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1680520712; x=1712056712;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=OlWyMr4m0ayG2KxJchvil0i2f755AApOBiSiCQPKwc8=;
 b=NMrjMpGRaTcfJlI98TrRHAzXWNA2C3Ci477lD3WgU/vTiKKcwGbXJTI/
 msR4/QqXHS1jSMTZKqW+StIIkY+1Ow6pdZ1SVXxfry4sLGzi/aGfVEsOn
 zX217IxBFMZ8/cgiR2Qb5HTa/DT1c4qaCIiFfog6CrcCiTXkdLYaxHb+i
 EhMYulQ94/2YFVaQhrfTRqsoXfdt5XayhedWKUG4NvPb2F4Qa9R4fncQP
 ZW9GFb8ZWOcxGA/PLc1/EEFAOWaasMRC6Z3/Mk19AxXgXxdDKzwkvoKj8
 n8h1mm6TlGmgh2RGPoUYlol6yC1g1TsnzLM5gDhWjK+DPw//2XPA/QpjT Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10668"; a="428157966"
X-IronPort-AV: E=Sophos;i="5.98,314,1673942400"; d="scan'208";a="428157966"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2023 04:18:31 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10668"; a="755204426"
X-IronPort-AV: E=Sophos;i="5.98,314,1673942400"; d="scan'208";a="755204426"
Received: from ideak-desk.fi.intel.com ([10.237.72.58])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2023 04:18:29 -0700
Date: Mon, 3 Apr 2023 14:18:26 +0300
From: Imre Deak <imre.deak@intel.com>
To: Mika Kahola <mika.kahola@intel.com>
Message-ID: <ZCq2AvVwTFRWlxL/@ideak-desk.fi.intel.com>
References: <20230327123433.896216-1-mika.kahola@intel.com>
 <20230327123433.896216-7-mika.kahola@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20230327123433.896216-7-mika.kahola@intel.com>
Subject: Re: [Intel-gfx] [PATCH 6/7] drm/i915/mtl: Add vswing programming
 for C10 phys

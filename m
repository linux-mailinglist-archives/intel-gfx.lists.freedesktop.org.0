...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F033C1E591E
	for <lists+intel-gfx@lfdr.de>; Thu, 28 May 2020 09:41:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90BD36E3F7;
	Thu, 28 May 2020 07:41:57 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 561586E3DF
 for <intel-gfx@lists.freedesktop.org>; Thu, 28 May 2020 07:41:43 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21318025-1500050 
 for multiple; Thu, 28 May 2020 08:41:11 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 28 May 2020 08:41:03 +0100
Message-Id: <20200528074109.28235-5-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/11] drm/i915/gem: Separate reloc validation
...
---
 .../gpu/drm/i915/gem/i915_gem_execbuffer.c    | 176 +++++++++++++-----
 1 file changed, 131 insertions(+), 45 deletions(-)

diff --git a/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c b/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
index e840b2a85284..f50378699a19 100644
...
@@ -1516,9 +1593,18 @@ static int eb_relocate(struct i915_execbuffer *eb)
...
+			err = eb_reloc_vma_validate(eb, ev);
+			if (err < 0)
+				return err;
+
+			if (err == 0)

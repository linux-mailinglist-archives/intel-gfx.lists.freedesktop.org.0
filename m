...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A71D2C657D
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C3A996ED87;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 147/162] drm/i915/gt: Allocate default ctx
 objects in SMEM

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A83E32D659
	for <lists+intel-gfx@lfdr.de>; Thu,  4 Mar 2021 16:20:25 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD09A6EA0F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [patch 7/7] io-mapping: Remove

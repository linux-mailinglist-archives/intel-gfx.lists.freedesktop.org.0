...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 34C3DA445ED
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Feb 2025 17:25:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 67E2310E745;
	Tue, 25 Feb 2025 16:25:08 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="LkOWT3Bo";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8B86F10E744;
 Tue, 25 Feb 2025 16:25:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1740500707; x=1772036707;
 h=from:to:subject:in-reply-to:references:date:message-id:
 mime-version; bh=4LrAAScoeJLSiM9nR6g/cTeFfv1MNn+i41g2DkC+Lc4=;
 b=LkOWT3Bo5VxPUQ3SKjBg8Ov9AFkFDj8jGBmrHjCQZyI8wLb4EW/646Gx
 VRGkbezZkPLFW1G8nj7qu5E8J1+AelElek5ieqbJwbdvNRpIBosPqRlf5
 Y8llfRgQY3nSFGzacQZQVkZ3bEmeawPa3SnLdme206qEExpb3ND8I04EP
 +otLscVmH//sZV28sbDuTrtAK/bTH8O2fMOgBch4s/G47wiCqll98cw06
 nd/Cufr7xzBBPgykPGBORRctqpBdywih+96UqNN1z3yxtjV0EA0qV3n6O
 wMCRt/MAN/sfxgZDfOEFHIB6DVGtWbwL6ahlxGcDECPOPiXV1PNpiV0Wh Q==;
X-CSE-ConnectionGUID: x9mWg5awT+CiRKWJ0tU9ZQ==
X-CSE-MsgGUID: cqO+B74zRaelDk6Y0+QFXg==
X-IronPort-AV: E=McAfee;i="6700,10204,11356"; a="51949690"
X-IronPort-AV: E=Sophos;i="6.13,314,1732608000"; d="scan'208";a="51949690"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Feb 2025 08:25:06 -0800
X-CSE-ConnectionGUID: lLFLVcTsRCiMa9KHHbK5fA==
X-CSE-MsgGUID: 3Q6i1f7MSbyUMtD6CSWUuA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="147326701"
Received: from monicael-mobl3 (HELO localhost) ([10.245.246.246])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Feb 2025 08:25:04 -0800
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>, intel-gfx@lists.freedesktop.org,
 intel-xe@lists.freedesktop.org
Subject: Re: [PATCH v2 2/5] drm/i915/hpd: Add support for suspending the IRQ
 handling on an HPD pin
In-Reply-To: <20250225121536.2152940-1-imre.deak@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20250224193115.2058512-3-imre.deak@intel.com>
 <20250225121536.2152940-1-imre.deak@intel.com>
Date: Tue, 25 Feb 2025 18:25:01 +0200
Message-ID: <87bjuq56w2.fsf@intel.com>
MIME-Version: 1.0

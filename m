...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BDEC254BE9A
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jun 2022 02:10:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 22B58113706;
	Wed, 15 Jun 2022 00:10:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B1B0C11359C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=EykSaCF4jIqhyvyRGg6I0vn/h4J6W5eyonioH75b5Wg=;
 b=Bwjm9CHKlT9HzdbQsFxcdgEvQsZV4C2YhvSX0AbHCHPfSIXPeOE8CF6s
 ORVAwFCDnIS8w6XDWiOwQmLDUG9D/VeM5UoRceDUA39vACK9OgZkrPuPU
 vYyyaei0rCOdV8BrNjz+MUTvhBJjjEJ3H8S9UPjjv7G9vWOUU+1OrRjda
 Vn904TyFieTqGdF9EkPeRUHbVsoAD8s4YgzZGiONdvf0fmGhM7aRRNuK7
 M9juwS+vhecJOhJgVzhao0U/sfWwaQmTmy7NoolknEy396a6CmaETR8yY
 CBhk4y8Y73j2Dp8UU0WFO9N2Dj8lNi253FwwIEFUsGV0rU0cYp3oxIMzC g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10378"; a="304203762"
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; d="scan'208";a="304203762"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2022 17:10:27 -0700
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; d="scan'208";a="712699135"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2022 17:10:26 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Jun 2022 17:10:19 -0700
Message-Id: <20220615001019.1821989-3-matthew.d.roper@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 2/2] drm/i915/gt: Cleanup interface for MCR
 operations

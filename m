...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE42A9B0E6
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Aug 2019 15:27:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA05B6EC9D;
	Fri, 23 Aug 2019 13:27:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5319B6EC8D
 for <intel-gfx@lists.freedesktop.org>; Fri, 23 Aug 2019 13:27:11 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18240603-1500050 
 for multiple; Fri, 23 Aug 2019 14:27:04 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 23 Aug 2019 14:26:54 +0100
Message-Id: <20190823132700.25286-10-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/15] drm/i915: Mark up address spaces that may
 need to allocate
...

...
cl9yYW5nZSA9IGdlbjhfcHBndHRfY2xlYXI7CkBAIC0xOTUwLDYgKzE5NTEsNyBAQCBzdGF0aWMg
...
dF9pbnNlcnRfZW50cmllczsKQEAgLTI1ODEsNiArMjU4Myw3IEBAIHN0YXRpYyBpbnQgaW5pdF9h
...
Z3R0LmggYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbV9ndHQuaAppbmRleCA2MWJiYmZi
OTY0YjEuLjBmMTQ3MjJmZDE2MyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkx

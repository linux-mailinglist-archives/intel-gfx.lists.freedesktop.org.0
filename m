...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D12A0570BA7
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:27:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 90F9190FAA;
...
Subject: [Intel-gfx] [PATCH 10/32] drm/i915: i915_gpu_error.c: document
 dump_flags

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6089B5FDA7D
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Oct 2022 15:20:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 54C0D10E8DF;
...
Subject: [Intel-gfx] [PATCH v5 04/22] drm/connector: Rename

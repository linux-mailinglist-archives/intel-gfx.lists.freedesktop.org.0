...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C95C7634B20
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Nov 2022 00:34:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D73A210E495;
	Tue, 22 Nov 2022 23:33:42 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH] drm/i915/uc: Fix table order verification to
 check all FW types

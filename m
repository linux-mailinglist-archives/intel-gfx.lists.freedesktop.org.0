...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB10839CD43
	for <lists+intel-gfx@lfdr.de>; Sun,  6 Jun 2021 06:51:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8010B6E0D2;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 0/2] drm/i915: Finish conversion to
 GRAPHICS_VER

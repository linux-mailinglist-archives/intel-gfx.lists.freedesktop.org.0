...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 41F8F1B33DF
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Apr 2020 02:17:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9B7E46E0A2;
	Wed, 22 Apr 2020 00:17:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E65186E0A2
 for <intel-gfx@lists.freedesktop.org>; Wed, 22 Apr 2020 00:17:40 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20977453-1500050 
 for multiple; Wed, 22 Apr 2020 01:17:05 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 22 Apr 2020 01:17:03 +0100
Message-Id: <20200422001703.1697-3-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 3/3] drm/i915/gt: Use the RPM config register to
...

...
bmNsdWRlICJzZWxmdGVzdF9ycHMuaCIKQEAgLTc0OSw3ICs3NTAsOCBAQCBzdGF0aWMgaW50IF9f
...
NV9yZXF1ZXN0X2NvbXBsZXRlZChycSkpOwpAQCAtNzk2LDcgKzc5OCw4IEBAIHN0YXRpYyBpbnQg

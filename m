...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 88113BAF438
	for <lists+intel-gfx@lfdr.de>; Wed, 01 Oct 2025 08:39:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB3BA10E68B;
	Wed,  1 Oct 2025 06:39:42 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="AbIASxGr";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2218B10E684;
 Wed,  1 Oct 2025 06:39:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1759300781; x=1790836781;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Y3SQb1X0N+x9EOdjeDjvi3FHBR75aO1hpojzSXNnG9M=;
 b=AbIASxGrB+SmrNbZbPBzTOs7OuH4wiWUZxdY0y6hd1wLUn2Qgs2Am14j
 Owvduu0h60sagDaZ/4sDoxeEeQiXHc+VB3jo3sLg7V6/MjH/zvIZnAVCD
 pI4ZdkSQR921rygqiJlxpmzKOoK2GzBRqyiZD8DSYMNpUmI/M4hjAmctU
 1L6oBXCLBd9YAttrwtfNHk3MzIxhRIvf7aq7dJoiw4IyNilH6gZyB/J3D
 D03L2sPcqzligdAF2vPZeD+UkvkPA/g3G8txIVgRQ0DYCa6537FSOlxcQ
 XOv5pxHZv0slMcIpD6aS/vbkBKG0HNb/xSqXSKBZyGkMQhV4gB/I0x3B7 A==;
X-CSE-ConnectionGUID: q1LdRlq9Qr+oV+hgwqs3hQ==
X-CSE-MsgGUID: XnzKRIr9RsmcP49H6eUNmQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11569"; a="65422505"
X-IronPort-AV: E=Sophos;i="6.18,306,1751266800"; d="scan'208";a="65422505"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
 by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Sep 2025 23:39:41 -0700
X-CSE-ConnectionGUID: 3uVgMobaREK+65ABfrSvrA==
X-CSE-MsgGUID: qduyDrDMQBG08SnijoYcpQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,306,1751266800"; d="scan'208";a="177841930"
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by orviesa006.jf.intel.com with ESMTP; 30 Sep 2025 23:39:39 -0700
...
Date: Wed,  1 Oct 2025 12:04:57 +0530
Message-Id: <20251001063500.1259687-8-nemesa.garg@intel.com>

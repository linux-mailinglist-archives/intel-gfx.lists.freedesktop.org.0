...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 587537BDCE7
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Oct 2023 14:54:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A325F10E0DD;
	Mon,  9 Oct 2023 12:54:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EB28910E0DD
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Oct 2023 12:54:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1696856061; x=1728392061;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=uRIop0PzcPmj6+Uj+bZoFQst1usp38kKsukLMUeMPck=;
 b=PcpufjrqZO9TBCKFG2wJK40OPUzo8cOBfaZcSpiboVHVA2wTUoUKEnmQ
 tqZLlnpmo1Q2YHpol/S3O2VbRMq9Spgfv3KgyqZClPXpIX06BNIaC6zqn
 xOrRAntKpMl0JrJ9JZ3xUNK2meHOFpvjTMzm/r5f9OOGzhYJA3gQT9MLr
 yLbG/bjvxj1DuDlKxggr5H5SRj1G4r7longYYagQ3Jn5trpiJfYGXzeQD
 OpCGuOM2jdlPWfwX1rYlT47LUICRd+mf8RtHHW/ywQscb4pUw3TEnmjwR
 pTrstT2+CVxmZ+1H5+s2aGxHImnTyovg77gfxMk3JDrf+ZFIiaI4sdOZ/ A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="415123299"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="415123299"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2023 05:54:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="788156036"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="788156036"
Received: from mquirke-mobl.ger.corp.intel.com (HELO [10.213.207.90])
 ([10.213.207.90])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2023 05:54:11 -0700
Message-ID: <e149a000-f746-9ae3-4dfc-cfe565a836b0@linux.intel.com>
Date: Mon, 9 Oct 2023 13:54:09 +0100
MIME-Version: 1.0
...
In-Reply-To: <cfd08985-8fe5-1601-6cf4-92a29a111f8e@intel.com>
...
still remains. As I wrote before - give each invalidation a seqno, upon 
receiving the done h2g store the latest seqno in the driver and wake up 
all sleepers. They check the seqno and if their has passed exit, 
otherwise go back to sleep. No xarray needed. Put_pages() invalidations 
are already serialized so no ill-effect and GGTT invalidations are, or 
are not, performance sensitive for some reason?

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E1AF14C772
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jan 2020 09:26:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CA7096F4A4;
...
Subject: Re: [Intel-gfx] [PATCH v4 09/22] drm/nouveau: Convert to CRTC
 VBLANK callbacks

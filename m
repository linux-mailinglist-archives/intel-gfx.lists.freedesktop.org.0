...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 566D25175DF
	for <lists+intel-gfx@lfdr.de>; Mon,  2 May 2022 19:31:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8ACB110F2D9;
...
Subject: [Intel-gfx] [PATCH v3 7/7] vfio: Remove calls to

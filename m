...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D76314B7034
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Feb 2022 17:33:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D9BB910E6A6;
	Tue, 15 Feb 2022 16:33:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 44AB789E63
 for <intel-gfx@lists.freedesktop.org>; Tue, 15 Feb 2022 16:33:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644942809; x=1676478809;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=es1lASdkD6roXJACcdgtgweU418MS8TP7FQcAkotkbY=;
 b=lyUwbl1QnwKGEGqesHYEL45E5d31oRwW+L2FCAOqBFk3tmlknj9K4mmz
 VzC5B3sLv/C78H+2FpPOa418XOEq+5PrILGixPsitWISJLcNwq9HOxKPq
 D492C7S+9HKP88yOQ6fuXh0r5GWopFzY/iMEy0q02Jt8W6MuNOoSaF7If
 9W9UREvDZpgOBqw8i6bDMVk5nY7AuE0gqRXzAzXXgSh9/3tjJgNm18IjK
 PlyFGeRPNOqs4vk9ckhaNFx4zYYD6o5zsySoax9P2hAgYsUiw9LJ+w7x8
 XDUYipIMuA1Q3Cjyes64vwzQJWLrMOznZ4pykOmlDbR2LG9Tr3mRWxZTL A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10258"; a="250591937"
X-IronPort-AV: E=Sophos;i="5.88,371,1635231600"; d="scan'208";a="250591937"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Feb 2022 08:33:28 -0800
X-IronPort-AV: E=Sophos;i="5.88,371,1635231600"; d="scan'208";a="497284157"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Feb 2022 08:33:27 -0800

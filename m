...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 380E44360B1
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Oct 2021 13:46:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4DDE36EB34;
...
Subject: Re: [Intel-gfx] [PATCH 3/3] drm/i915/guc/slpc: Update boost sysfs
 hooks for SLPC

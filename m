...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CB1816EC473
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 06:42:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CB9E610E334;
	Mon, 24 Apr 2023 04:41:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 471C610E249;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=NcKdTGPmoMbpzKhZ6u1qerC4JzIb9pSzN/sYayHFkU3ktmPFiKDqAIC/
 kUHRikIHg3IETqAL4rMScEp9x/P79O6uOZRWm6ZSnts+GjrtSzAt49wXr
 YCjAxLGIRAZh+X4fbiXjS2S1gSlrm5D9zB7mm0u7IV8CMxYuDHX3Lqn5f
 OLZ6DAb6GMheCbIpaEzeFPKCIEQT2vhU+2YsrgNMfXOpegBfEmO2UgqHK
 alsnkrRaRA04bvXRBTwILf+kkMkkcakizzIFTZrht0CXszUpbNDax0oOn
 j8TjYawRPgjTMzf+zxeEBW6+JrxkxKEyuKX8qo9rerzgjE88rpYjklTyH g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="345115344"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="345115344"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 21:41:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="643211477"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="643211477"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 21:41:42 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Sun, 23 Apr 2023 21:42:46 -0700
Message-Id: <20230424044251.3390364-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 1/6] drm/i915/mtl: Add PTE encode function

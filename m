...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EAE4C3D57B0
	for <lists+intel-gfx@lfdr.de>; Mon, 26 Jul 2021 12:41:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 575596E3A0;
...
Subject: Re: [Intel-gfx] [PATCH 11/30] drm/i915/display: remove explicit CNL

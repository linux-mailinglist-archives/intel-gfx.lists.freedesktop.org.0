...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B9DE885BBF
	for <lists+intel-gfx@lfdr.de>; Thu,  8 Aug 2019 09:43:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1F7AA6E790;
	Thu,  8 Aug 2019 07:43:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A4E0B6E790
 for <intel-gfx@lists.freedesktop.org>; Thu,  8 Aug 2019 07:43:27 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17926060-1500050 
 for multiple; Thu, 08 Aug 2019 08:42:12 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  8 Aug 2019 08:42:05 +0100
Message-Id: <20190808074207.18274-17-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 17/19] drm/i915/overlay: Switch to using
...
ZXJsYXkuYwppbmRleCA0ZDNiMjA4NjU3MGUuLjRmNzg1ODZlZTA1ZSAxMDA2NDQKLS0tIGEvZHJp
...
NTY2MzM2Yzk5ZWQ3Li5mNmQ3MzBjZjJmZTYgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9p

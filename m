...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B3E9461EE8
	for <lists+intel-gfx@lfdr.de>; Mon,  8 Jul 2019 14:54:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A814A89D61;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 09/19] drm/i915: Add debugs to distingiush a

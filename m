...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BE1E191AB3
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Mar 2020 21:13:26 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 73CA86E532;
	Tue, 24 Mar 2020 20:13:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 68DEB6E22C
 for <intel-gfx@lists.freedesktop.org>; Tue, 24 Mar 2020 20:13:16 +0000 (UTC)
IronPort-SDR: U+JEhzAGGGjFbyYi7CHylCdp0W6jd/1TV4b0+GTL8qjRX9B4LUwIiBi3zJIhMfsqzrYw+Tl1lZ
 ADWpMGumBmVg==
...
IronPort-SDR: 7KxSNAfL2duMbOkmuuk6HHIkvd1VtZUzM6a6LDMp20WsGf9N19kJiR+uC7e+0P628E6yUDTz2x
 rjD8Wg43LhUQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,301,1580803200"; d="scan'208";a="235700550"
Received: from josouza-mobl2.jf.intel.com (HELO josouza-MOBL2.intel.com)
 ([10.24.15.8])
 by orsmga007.jf.intel.com with ESMTP; 24 Mar 2020 13:13:14 -0700
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 24 Mar 2020 13:14:25 -0700
Message-Id: <20200324201429.29153-2-jose.souza@intel.com>
X-Mailer: git-send-email 2.26.0
In-Reply-To: <20200324201429.29153-1-jose.souza@intel.com>
References: <20200324201429.29153-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 2/6] drm/i915/display: Add
...
ZW51bSBpbnRlbF9kaXNwbGF5X3Bvd2VyX2RvbWFpbiBkb21haW4pOwotLSAKMi4yNi4wCgpfX19f

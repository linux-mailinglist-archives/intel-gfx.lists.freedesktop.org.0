...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 51691694AA8
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Feb 2023 16:14:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5A7C510E60B;
	Mon, 13 Feb 2023 15:14:38 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 15/15] vfio: Compile group optionally

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 79F66573A05
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 17:24:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4649C98980;
...
Subject: [Intel-gfx] [PATCH v3 0/3] drm/i915/display: stop HPD workers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DFB6B19619
	for <lists+intel-gfx@lfdr.de>; Fri, 10 May 2019 03:13:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3511489BB2;
	Fri, 10 May 2019 01:13:47 +0000 (UTC)
...
MIME-Version: 1.0
Subject: Re: [Intel-gfx] [PATCH v6 2/6] drm: Add a VSC structure for
 handling Pixel Encoding/Colorimetry Formats

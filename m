...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DAC876C9F4F
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Mar 2023 11:25:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A785B10E338;
	Mon, 27 Mar 2023 09:25:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D50BD10E338
 for <intel-gfx@lists.freedesktop.org>; Mon, 27 Mar 2023 09:25:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1679909138; x=1711445138;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:in-reply-to;
 bh=BxBA27r8v0aFIMZCWkS4I/NwXmqKnK8fu1zSJZWuXMY=;
 b=h8F+UJ4ccsy8YNOX66FeOmVEjLx5nPkXLCgqLeHXlb+CU6vwV6gF9VFE
 b+gOBd5qJR/aZcaNgXg7vQfdOQ76S/SoiaHRFJinZc6uC2TBktzhrxzcf
 UyVK1JN2H/omtThqcn8jZDPiwJ1ub4X/+GqZUtmy+ADPICfHnxAhEl/vo
 nzNo1Ac40NpevUCaMmuy09wj+uwA+PBcwIIciZAxlspRNE/wecZpTQWhX
 A9oX/+vwteio+UGqnKZUrqBRBXJyGZhgTFwLagwlTGSD1UYhlXXeQRzlI
 6Xdpbh8dpPHOUMYjzSlH0HZYzz5BIsyNclhqyAKCw2hrKNePPiS8Y6dek A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="426482368"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="426482368"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Mar 2023 02:25:38 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10661"; a="660771555"
X-IronPort-AV: E=Sophos;i="5.98,294,1673942400"; d="scan'208";a="660771555"
Received: from ideak-desk.fi.intel.com ([10.237.72.58])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Mar 2023 02:25:36 -0700
Date: Mon, 27 Mar 2023 12:25:32 +0300
From: Imre Deak <imre.deak@intel.com>
To: Mika Kahola <mika.kahola@intel.com>
Message-ID: <ZCFhDJ/4iz4j+OYX@ideak-desk.fi.intel.com>
...
Could the formatting be here and elsewhere like:
...
The above should use tabs vs spaces.
...
Could you add functions/macros like

c20_tx_cntx_cfg_reg(cntx, idx)
c20_cmn_cntx_cfg_reg(cntx, idx)
c20_mpll_cntx_cfg_reg(cntx, pll, idx)

which would allow reading/writing the state without the if (cntx)
branches?
...
As discussed in the other thread I think this should check txX_mpllb_sel
in SRAM_GENERIC_<A/B>_TX_CNTX_CFG_0[7].

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E8649B0DF
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Aug 2019 15:27:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 812956EC99;
	Fri, 23 Aug 2019 13:27:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 71A8F6EC8D
 for <intel-gfx@lists.freedesktop.org>; Fri, 23 Aug 2019 13:27:10 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18240605-1500050 
 for multiple; Fri, 23 Aug 2019 14:27:04 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 23 Aug 2019 14:26:56 +0100
Message-Id: <20190823132700.25286-12-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/15] drm/i915: Push the i915_active.retire
 into a worker
...
NV9nZW1fY29udGV4dC5jCmluZGV4IDIzYzRhODg4MDQxZi4uNGRjMzBjNjQwMzgwIDEwMDY0NAot
...
YS5jCmluZGV4IGY3YjIwZmQ5NDVhOS4uOGYzNjU0MjE2YjI1IDEwMDY0NAotLS0gYS9kcml2ZXJz
...
X3ZtYV9wdXQoYWN0aXZlX3RvX3ZtYShyZWYpKTsKQEAgLTEwMzksNiArMTA0MCw3IEBAIGludCBp

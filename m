...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CE572575C5B
	for <lists+intel-gfx@lfdr.de>; Fri, 15 Jul 2022 09:31:30 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 08C7111AE84;
...
Subject: Re: [Intel-gfx] [PATCH v1 2/6] drm/gem: Take reservation lock for

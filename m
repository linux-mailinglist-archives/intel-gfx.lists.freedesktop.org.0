...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D8F8C27693
	for <lists+intel-gfx@lfdr.de>; Sat, 01 Nov 2025 04:25:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1474110EC48;
	Sat,  1 Nov 2025 03:25:35 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="X0xC0LYH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1BA8310EC44;
 Sat,  1 Nov 2025 03:25:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1761967533; x=1793503533;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=GiZ0bRTYFaPnxCaETSoWl3NOfxSRELxEn/C7e8cx/20=;
 b=X0xC0LYH8m75uNgHOhfjhN3oqi5pW5pP5GWeT61y12vgWhjCbyI2JNZF
 Mi98Ed2As3PaHdXqLfsP2kv0mjNeqREgYc3VN5b9f4JGY4vbaavcu4vhj
 YI2jL5pGHhGCPqd+UE3KZe3Mu0VRZqMBnJnsTODXDBjA3gzAOFWNGtvSr
 nZUbjCt8JwmsPVThCO6C9W70evyIE45bJhFG9CPx/o4AHAn9XIJ2O7E1l
 Diiin70johqwjqAzrYlsPgux98Y5SVrSGtfQaB5YWy18ji4Et3EgUMlii
 JZ+lYC0JSPdtLzZhg+WCvSFfPgBIr0I6L8O/glxCW1JjDIpmaC8fV5796 g==;
X-CSE-ConnectionGUID: JB0vIuv9Su6cXYhq3aUXcQ==
X-CSE-MsgGUID: TkHuFiSATeivxzDZ3JObVw==
X-IronPort-AV: E=McAfee;i="6800,10657,11599"; a="64019851"
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="64019851"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
 by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Oct 2025 20:25:33 -0700
X-CSE-ConnectionGUID: 9ARsvUpHSryCqbt5SU53kg==
X-CSE-MsgGUID: okhHGTqlSxOIYeHaN7j9bQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,271,1754982000"; d="scan'208";a="217037965"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa002.jf.intel.com with ESMTP; 31 Oct 2025 20:25:31 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-xe@lists.freedesktop.org,
	intel-gfx@lists.freedesktop.org
Cc: Suraj Kandpal <suraj.kandpal@intel.com>,
 Arun R Murthy <arun.r.murthy@intel.com>
Subject: [PATCH v5 08/25] drm/i915/ltphy: Add LT Phy Programming recipe tables
Date: Sat,  1 Nov 2025 08:54:56 +0530
Message-Id: <20251101032513.4171255-9-suraj.kandpal@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F930546E73
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 22:30:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 16AE7113BBB;
...
Subject: [Intel-gfx] DRM/KMS PWL API Thoughts and Questions
...
Cc: amd-gfx list <amd-gfx@lists.freedesktop.org>, Alex Hung <alex.hung@amd.com>,

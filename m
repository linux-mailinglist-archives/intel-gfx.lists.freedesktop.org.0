...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 14B3810F135
	for <lists+intel-gfx@lfdr.de>; Mon,  2 Dec 2019 20:59:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D7756E2C4;
...
X-Mailman-Original-Authentication-Results: spf=none (sender IP is
 ...
 header.from=amd.com;
Subject: [Intel-gfx] [RESEND 1/2] drm: Add support for DP 1.4 Compliance
 edid corruption test 4.2.2.6

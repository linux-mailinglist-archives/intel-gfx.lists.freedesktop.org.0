...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EA953646F6
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Apr 2021 17:19:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5C0FB6E409;
	Mon, 19 Apr 2021 15:19:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ed1-x533.google.com (mail-ed1-x533.google.com
 [IPv6:2a00:1450:4864:20::533])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 893A189D66
 for <intel-gfx@lists.freedesktop.org>; Mon, 19 Apr 2021 15:19:19 +0000 (UTC)
Received: by mail-ed1-x533.google.com with SMTP id j7so4279660eds.8
 for <intel-gfx@lists.freedesktop.org>; Mon, 19 Apr 2021 08:19:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=jlekstrand-net.20150623.gappssmtp.com; s=20150623;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=om6E/X+zhDv3ihM5nrrPcoYPhVnKOS3XF/BtgYufd1s=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=om6E/X+zhDv3ihM5nrrPcoYPhVnKOS3XF/BtgYufd1s=;
 b=
X-Gm-Message-State: AOAM532mS+giA7ZQAN0ohjd6+TFKrEREz85oB/Ff+CWAijeHKL6iNclO
 TaDFl1dYZrIVt1R5hP1U05oKs23Nc4rfAndj8EDIwg==
X-Google-Smtp-Source: ABdhPJxK2OGTPDB4S7P1zsFgaTbrFHOte9FAgGYWyJaroOUN6sckK848TLXzENVLXlE5raY/RrjNArYTgfd0Orq549A=
X-Received: by 2002:aa7:c049:: with SMTP id k9mr3831884edo.56.1618845558104;
 Mon, 19 Apr 2021 08:19:18 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <6cf790c7-84bf-4d35-c1c3-4cf826655faf@intel.com>
From: Jason Ekstrand <jason@jlekstrand.net>
Date: Mon, 19 Apr 2021 10:19:06 -0500
Message-ID: <CAOFGe95gMUuqXX=Yn_xMRVxQmcwiqNEN0m3PgyNACcm0iNTyKg@mail.gmail.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 98749546D49
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Jun 2022 21:30:33 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DCD1E113856;
...
Subject: Re: [Intel-gfx] [PATCH v2 13/15] drm/edid: add HF-EEODB support to

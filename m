...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 31E0B6EC474
	for <lists+intel-gfx@lfdr.de>; Mon, 24 Apr 2023 06:42:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42F0510E31A;
	Mon, 24 Apr 2023 04:41:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BC02C10E29F;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=hxOjz71vU+wPO6g3G1A2cxSl+uMfSWmj62SWW/7vEd2PNbk2sSUXFraQ
 g5MaxRKlPMebwspzFh7UnGPW06kCnU0mTa/q/nQUA0+JjlIqWyVlv56k+
 9IkSBVx6KsNynUJ/n8Yl6AhltDvaSJc6r1NcGZAX3unmXuqhRdHoYQ1H/
 8ZAn/ACA/lcTD0QQoq1OnFkU7BnnnglCKpMHNSqG4odYbJWYHoBOrpyXJ
 ntO/+eG0g7I73+gyheZwAQWbs+Yj8iVcrMeSnv11q+N0Tc2FCBo3kiwUf
 fTQggtpauqv9VBhlApRAA+ywD7p2SQgUpOBgXCH+NV6Wczf6r1wRyWwdn A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="345115349"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="345115349"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 21:41:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10689"; a="643211494"
X-IronPort-AV: E=Sophos;i="5.99,221,1677571200"; d="scan'208";a="643211494"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Apr 2023 21:41:42 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Sun, 23 Apr 2023 21:42:51 -0700
Message-Id: <20230424044251.3390364-7-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v1 6/6] drm/i915: Allow user to set cache at BO
 creation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DF4477A72E3
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Sep 2023 08:38:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1EC1F10E441;
	Wed, 20 Sep 2023 06:38:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C616810E159
 for <intel-gfx@lists.freedesktop.org>; Wed, 20 Sep 2023 06:38:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1695191889; x=1726727889;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=ZmyX+3hAg0jBI5CZM6RTooX8eB8kZeP6tjhRbpqVfOM=;
 b=f7pCHycqDAR3LJiDnJQcIaj7etr6To8/akC2rGxe7H83KQrRtRyhUT5Z
 2ajRwH2X5mRQomAvr7QVdvSeEah7q20YMWH4YdmQm6+mZmu4fgBXwAMEV
 CIAaTvKItxFz+gGCgF/Mtbg88KVIoQo+hCQbq1bwu6SqMl4VeRpyN1eWq
 DQxnKHnmxpIe8xN70/PmMk9+zck6gRPNWuzcF3BpntRF/XqVzjHCwQZsM
 T47dQBVk6oRqcUno1X2Svl/32LUms1XmnkSWeagjLCsishlGBg3AZE7cy
 izc7n0Y13e7xS1T4c1lccW8MiolYPAqR3QQuk8dueeFI5JIWxTULuMght g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="379028811"
X-IronPort-AV: E=Sophos;i="6.02,161,1688454000"; d="scan'208";a="379028811"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2023 23:38:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10838"; a="836728170"
X-IronPort-AV: E=Sophos;i="6.02,161,1688454000"; d="scan'208";a="836728170"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by FMSMGA003.fm.intel.com with ESMTP; 19 Sep 2023 23:38:07 -0700
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 20 Sep 2023 12:06:11 +0530
Message-Id: <20230920063611.242942-3-suraj.kandpal@intel.com>

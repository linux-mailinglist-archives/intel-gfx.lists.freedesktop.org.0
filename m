...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B23FC6B08CD
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F07B10E602;
...
Subject: [Intel-gfx] [PATCH v6 05/24] kvm/vfio: Accept vfio device file from
 userspace

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C04FE4E30C9
	for <lists+intel-gfx@lfdr.de>; Mon, 21 Mar 2022 20:29:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BBCA10E483;
...
Subject: Re: [Intel-gfx] [PATCH v2 2/7] drm: Add drm_memcpy_from_wc()

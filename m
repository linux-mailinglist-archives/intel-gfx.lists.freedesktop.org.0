...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 652E017D09D
	for <lists+intel-gfx@lfdr.de>; Sun,  8 Mar 2020 00:20:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 36C3A6E271;
	Sat,  7 Mar 2020 23:20:41 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v5 01/16] drm/i915: Fix sha_text population
 code

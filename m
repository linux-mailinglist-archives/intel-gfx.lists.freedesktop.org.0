...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 82B0EF35B0
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Nov 2019 18:29:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 54BD86E369;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 +v9A==
Subject: Re: [Intel-gfx] [PATCH v3 3/5] drm/i915/selftests: Replace
 mock_file hackery with drm's true fake

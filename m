...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EDC51626DF9
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Nov 2022 08:05:22 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 223F710E0E6;
	Sun, 13 Nov 2022 07:05:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 025FB10E0E6
 for <intel-gfx@lists.freedesktop.org>; Sun, 13 Nov 2022 07:05:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1668323114; x=1699859114;
 h=from:to:cc:subject:date:message-id:references:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=zRo1qSuBSfig79cqNgidC7KLzN43yhuZxxbdurNbX6M=;
 b=SM0pGZIkgjRays+gz67YrRe+IpeSvVBzHBZ1sZatH4eAJAecAD4aFetG
 EqW/xlauphwu4QvlWZhdGudOg/M57wBSSglD1pudvjTMH0waC/cn3iBYt
 wZdDc0sPrOMKs4isAeUBt7qaEo8dIClYjC8Nuj8DC43sH6W4ZTutargG/
 cX42aVimxWlYy8NVoI1clhhm2txp7aqAKQVTPXNgw5uXQWh5+V62UtJD9
 AH/VL/Ms7LT7HSX8WV0OeLr/YPA8srv3zyV8RBLHqWzU5/6/06/OPmnCm
 a1+ev4+aAPf9vSf6lwaKAZt06oHWPYlBp+aoiVpXRiEeXPyTR2FMouMkE w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10529"; a="295149126"
X-IronPort-AV: E=Sophos;i="5.96,161,1665471600"; d="scan'208";a="295149126"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Nov 2022 23:05:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10529"; a="640399695"
X-IronPort-AV: E=Sophos;i="5.96,161,1665471600"; d="scan'208";a="640399695"
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230022)(396003)(376002)(346002)(366004)(136003)(39860400002)(451199015)(26005)(122000001)(9686003)(4326008)(71200400001)(316002)(6916009)(86362001)(54906003)(55016003)(82960400001)(66446008)(66946007)(64756008)(66556008)(66476007)(2906002)(6506007)(76116006)(8676002)(7696005)(38100700002)(478600001)(33656002)(38070700005)(83380400001)(5660300002)(186003)(52536014)(8936002)(41300700001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 13 Nov 2022 07:05:10.3162 (UTC)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9130D67BD10
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Jan 2023 21:39:06 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E84CB10E8B8;
...
Subject: [Intel-gfx] [PATCH v3 15/19] test-dyndbg: build

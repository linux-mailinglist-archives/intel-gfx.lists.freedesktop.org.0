...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8IKbGYQmhmlSKAQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 06 Feb 2026 18:36:04 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EF9A910125E
	for <lists+intel-gfx@lfdr.de>; Fri, 06 Feb 2026 18:36:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5312910E877;
	Fri,  6 Feb 2026 17:36:00 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="1shQewP2";
...
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.223.130])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8FCC410E8A1
 for <intel-gfx@lists.freedesktop.org>; Fri,  6 Feb 2026 17:35:58 +0000 (UTC)
...
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id HOILOHYmhmm0CAAAD6G6ig
...
X-Spamd-Result: default: False [0.69 / 15.00];
	...
	FORGED_SENDER(0.00)[pfalcato@suse.de,intel-gfx-bounces@lists.freedesktop.org];
 ...
 nux-mm@kvack.org,m:ntfs3@lists.linux.dev,m:devel@lists.orangefs.org,m:linux-xfs@vger.kernel.org,m:keyrings@vger.kernel.org,m:linux-security-module@vger.kernel.org,m:jgg@nvidia.com,s:lists@lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[pfalcato@suse.de,intel-gfx-bounces@lists.freedesktop.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,suse.de:email,suse.de:dkim,oracle.com:email]
X-Rspamd-Queue-Id: EF9A910125E

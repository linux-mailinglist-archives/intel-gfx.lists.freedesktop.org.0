...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B49C12C6566
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A2366ECEE;
	Fri, 27 Nov 2020 12:11:53 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 136/162] drm/i915: create and destroy dummy
 vma

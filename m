...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3F9E454F07C
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jun 2022 07:15:19 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B58811AEEF;
...
Subject: [Intel-gfx] [PATCH v2 2/3] drm/i915: Update i915 uapi documentation

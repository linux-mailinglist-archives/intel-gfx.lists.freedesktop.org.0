...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FA6B344E35
	for <lists+intel-gfx@lfdr.de>; Mon, 22 Mar 2021 19:17:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0FCCF6E4EA;
...
Subject: [Intel-gfx] [PATCH 06/11] cgroup: fix -Wzero-length-bounds warnings

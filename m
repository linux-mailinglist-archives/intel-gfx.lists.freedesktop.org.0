...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C3EE74DD4C9
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Mar 2022 07:41:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D4B8410E90E;
...
Subject: [Intel-gfx] [PATCH v12 05/13] drm/i915/guc: Add Gen9 registers for

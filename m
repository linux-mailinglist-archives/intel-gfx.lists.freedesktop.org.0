...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B97E9663838
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Jan 2023 05:36:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA7CC10E530;
	Tue, 10 Jan 2023 04:36:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BC36610E530
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 Jan 2023 04:36:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1673325394; x=1704861394;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=8YYge88SYFeICo/AE5n3Ck/Y1EPxxilHWdFqQgHpjSQ=;
 b=YI9m2bNakN1VLBMV+vtjAJDAVq9tPwLCkDDILv2euxOW848fdG/cF7zt
 ZEwD7GfgImjiL/tWmj9x+gkeaGdoEfQj75xxghp9+qS/ongUxdQwS0WEA
 wxN+WA7Vecb3Lt6709xvmeJZgdchdnYoWbDwefIC65xkV10gbLlQPtns2
 0FIlNesgg7o5TZwXHh2Nf81N5H01V1VwK/UKxafaiVypHncsRiupnMgeW
 eqvhBlFeCAP2OfBbaD2vaDuNDHKU4HEDJAFYYtkuePKOkfvJUKh6seUK5
 IY2ePFqVWoNs10jWhuJxiEIdVstVjKmVBtD3TD/yxhu2qpDbhwDDh2ByU A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="350279696"
X-IronPort-AV: E=Sophos;i="5.96,314,1665471600"; d="scan'208";a="350279696"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jan 2023 20:36:34 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="650230568"
X-IronPort-AV: E=Sophos;i="5.96,314,1665471600"; d="scan'208";a="650230568"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga007.jf.intel.com with ESMTP; 09 Jan 2023 20:36:31 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Jan 2023 10:05:13 +0530
Message-Id: <20230110043517.1388837-3-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 2/6] drm/i915/hdcp: Keep hdcp agonstic naming
 convention

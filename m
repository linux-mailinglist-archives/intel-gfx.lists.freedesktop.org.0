...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F611568A2
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jun 2019 14:23:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A3BC6E3B7;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 OONA==
Subject: [Intel-gfx] [PATCH 1/6] dma-buf: add dynamic DMA-buf handling v13

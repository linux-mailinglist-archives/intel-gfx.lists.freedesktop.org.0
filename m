...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BECF96541E6
	for <lists+intel-gfx@lfdr.de>; Thu, 22 Dec 2022 14:31:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EAC1810E160;
	Thu, 22 Dec 2022 13:31:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7226D10E160
 for <intel-gfx@lists.freedesktop.org>; Thu, 22 Dec 2022 13:31:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671715881; x=1703251881;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=uiSVyamk7jgLqlHvIIK9DcDgzafWrPwH9QfXofhUB1o=;
 b=BwAQeB3kK+S8gIyPp0EyWXLAq3ObKmqZQ/i4QrL6WiOSHqwXRIcHLr4y
 62befuuETCDfiXjt0mk6kzlMCexn6v3qeYJLfhxXWiQa3FwdeeN/0De18
 79fgDqIgJq9nmcRrXaZwdBU3d36W8ygcHDHQ8K2j0376oSfOBrh2w2gev
 xsazfEJDbT1l6gxi8DWEkSzIiJHA1cHfyko0jQxU55drz2Nr28X7YkJF3
 2CAMgxNLRmZe9NalayKW4WBYTyMA8mpafCxsfEMM41OA+42NnE1isb5ub
 opxPiP0HPlMNydhyOzuhrNAtsS3KbcI/WJ9rT3C+vwts4ILqahXZo1DNV w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10568"; a="299795786"
X-IronPort-AV: E=Sophos;i="5.96,265,1665471600"; d="scan'208";a="299795786"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2022 05:31:20 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10568"; a="980598117"
X-IronPort-AV: E=Sophos;i="5.96,265,1665471600"; d="scan'208";a="980598117"
Received: from lab-ah.igk.intel.com ([10.91.215.196])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2022 05:31:18 -0800
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 22 Dec 2022 14:31:01 +0100
Message-Id: <20221222133102.1434965-1-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 1/2] drm/i915/display/core: use intel_de_rmw
 if possible

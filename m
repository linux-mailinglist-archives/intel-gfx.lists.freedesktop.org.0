...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B4B4C76416D
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Jul 2023 23:51:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E68F10E4C3;
	Wed, 26 Jul 2023 21:50:55 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v7] drm/i915/selftest/gsc: Ensure GSC Proxy

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 62567304BA6
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Jan 2021 22:44:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A77D56E499;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 4/9] drmcg: Add skeleton seq_show and write
 for drmcg files

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C6B87110288
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Dec 2019 17:39:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CC36D6E9F2;
...
Subject: [Intel-gfx] [PATCH v3 03/12] video: fbdev: nvidia: modify the

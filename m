...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 53AF1219F33
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Jul 2020 13:41:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B88D86E40B;
	Thu,  9 Jul 2020 11:41:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id ADF6E6E3F5
 for <intel-gfx@lists.freedesktop.org>; Thu,  9 Jul 2020 11:41:29 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21764330-1500050 
 for multiple; Thu, 09 Jul 2020 12:41:22 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  9 Jul 2020 12:41:17 +0100
Message-Id: <20200709114119.28122-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 4/6] drm/i915: Keep the most recently used
...
@@ -729,16 +742,16 @@ int i915_sw_fence_await_active(struct i915_sw_fence *fence,

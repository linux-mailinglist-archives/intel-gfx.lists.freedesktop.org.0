...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 78A40616A0E
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Nov 2022 18:09:02 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BF0BC10E515;
...
Subject: [Intel-gfx] [PATCH v2 4/5] drm/i915/mtl: add GSC CS reset support

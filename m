...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BEA112EC693
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Jan 2021 00:12:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E513D6E323;
	Wed,  6 Jan 2021 23:12:25 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4BA756E30D
 for <Intel-gfx@lists.freedesktop.org>; Wed,  6 Jan 2021 23:12:24 +0000 (UTC)
IronPort-SDR: jxETf6hcunXzxdZO7jdGY6pOzZzb/hmBeksTklo3Te+fAr4sW8HVF3foxho1tjBkcnXn58hDkw
 x3MSVju2JJdA==
X-IronPort-AV: E=McAfee;i="6000,8403,9856"; a="195900070"
X-IronPort-AV: E=Sophos;i="5.79,328,1602572400"; d="scan'208";a="195900070"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jan 2021 15:12:23 -0800
IronPort-SDR: R6IiyoWU3UByNum+7W2PbWhnl1zhWs2DxmIsBgzovZZNgqqlXpWaic6xLAB1IhYh8x1I/MlXkS
 ZNdpo3EwMYGg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.79,328,1602572400"; d="scan'208";a="567566123"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga006.fm.intel.com with ESMTP; 06 Jan 2021 15:12:23 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed,  6 Jan 2021 15:12:15 -0800
Message-Id: <20210106231223.8323-6-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210106231223.8323-1-sean.z.huang@intel.com>
References: <20210106231223.8323-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v19 05/13] drm/i915/pxp: Func to send hardware
 session termination

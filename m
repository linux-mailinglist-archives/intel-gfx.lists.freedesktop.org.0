...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C700234638
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Jul 2020 14:51:41 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0F6F16EA8A;
...
Subject: [Intel-gfx] [PATCH 6/6] drm/xen-front: Add support for EDID based
 configuration

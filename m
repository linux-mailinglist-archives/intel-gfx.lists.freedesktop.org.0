...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A97137BD712
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Oct 2023 11:31:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BDF410E255;
	Mon,  9 Oct 2023 09:31:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3CC9610E255
 for <intel-gfx@lists.freedesktop.org>; Mon,  9 Oct 2023 09:31:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1696843901; x=1728379901;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=k5gCf7Dk5TmYK3t9k6YZGFt4eS7M8S2pAF7ibyb13E4=;
 b=FjyRIESnBsoBi6NYMmt8Rx6TetSfuMbMXOToRdUiTVf/zSvigO9B+haG
 0JtsIDWmRjEk/PgPwlit9vrQ3UAYN5ejiZKLh0PwgXNj9ceegJ1CzRLvc
 L17o5BVClkkZbb9EpD4XNwEK4huXXNIVfscHcNbSUdYvm6e8YUw1zcxmV
 yQDqcETF0ATf5c4I7Uz8DT8yX+yD/brGMTq7dLZbRJcNPBdKuXDDKGRLL
 4Uu73KLhCbP+cT2XymAGU/wpbyD7dW/w+Vk2qPfR4ctUEyCwXKbVGHONp
 wDwoxmYo+zewwE6RWxNCjTU4sltyS1yvM080lbYw2wTMSkhuNJF0KhQgJ w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10857"; a="470369355"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="470369355"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2023 02:31:40 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10857"; a="746607820"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; d="scan'208";a="746607820"
Received: from eboyarsk-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.57.41])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Oct 2023 02:31:35 -0700
...
References: <20231006182051.1599923-1-jonathan.cavitt@intel.com>
 ...
 <53ab60cd-2517-356b-3c1f-db2f127f07fb@linux.intel.com>
Date: Mon, 09 Oct 2023 12:31:32 +0300
Message-ID: <87msws6t1n.fsf@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 474D1976AA8
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Sep 2024 15:32:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 623BF10EB7C;
	Thu, 12 Sep 2024 13:31:57 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="V9hfDS5k";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7DBB610EB7C
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 Sep 2024 13:31:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1726147917; x=1757683917;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=9tNQQnpzEktlJb/EwkTfuq+gqIwVTAO+xvIM3ygDVTY=;
 b=V9hfDS5kc/Tu+J3oerDTaKEyuZR/ookc5mVA4P+86A4U5uNih1v9LHSs
 Dot/4rlxqIAEF3BpeDu2GHxjqMvN+9gMb3GkmPqoZGWpfrVWDCMbkB+Zg
 ZSaDrJwIHr3Hb9AGXWsvu03KJfsNFIcgP8E3cqxWAG9OvQqpnqNJi76cW
 yI/f2OQKXUbfaKdbeLPUwBUcH4TwMVS8RCRN2KuJ2kiDI1zgRDMyGyRkO
 9qKu20tHWjwAlLmNhxU/zaxe1PByJ2h78rnmd08SdZWNjVBPOpjKl/Hsq
 FIGExVCfon+lMGKRYuRHQe0Fp16x30dHRfhyTKmSuZ4oJSgk4esS5sKdH g==;
X-CSE-ConnectionGUID: Jl/YDk6ASK+apV/uEEFUXA==
X-CSE-MsgGUID: RHn2FS3eTBmSqFsO3k3QAQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11192"; a="36137371"
X-IronPort-AV: E=Sophos;i="6.10,223,1719903600"; d="scan'208";a="36137371"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
 by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Sep 2024 06:31:56 -0700
X-CSE-ConnectionGUID: IIZMLZGpRqaSNR5Vee08IQ==
X-CSE-MsgGUID: t6kXhvWqTc6kgdp1GdRpyA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.10,223,1719903600"; d="scan'208";a="67785268"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by fmviesa008.fm.intel.com with SMTP; 12 Sep 2024 06:31:54 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 12 Sep 2024 16:31:53 +0300
Date: Thu, 12 Sep 2024 16:31:53 +0300
...
Message-ID: <ZuLtSTo6Y5k0fV9n@intel.com>

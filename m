...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 23A166EA0D
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Jul 2019 19:23:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3396E6E841;
...
Subject: Re: [Intel-gfx] [PATCH -next] drm/i915/dsi: remove set but not used

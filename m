...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE1EB4FBE0D
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 16:01:03 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7D44710F27E;
	Mon, 11 Apr 2022 14:01:01 +0000 (UTC)
...
Subject: [Intel-gfx] [CI v3 03/12] drm/edid: refactor EDID block status
 printing

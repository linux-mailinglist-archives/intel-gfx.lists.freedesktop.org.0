...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C24AD6B0D91
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 16:54:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9EE9510E63C;
...
Subject: [Intel-gfx] [PATCH v10 08/15] drm/scheduler: Add fence deadline
 support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE3B82C64E7
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:11:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 31F206ECA4;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 084/162] drm/i915: introduce kernel
 blitter_context

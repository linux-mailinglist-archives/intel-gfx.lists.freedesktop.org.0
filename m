...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F3154FC94B
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 02:35:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4D7910E297;
	Tue, 12 Apr 2022 00:35:49 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 2/3] drm/i915/guc: Update scheduling
 policies to new GuC API

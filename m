...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 51A83880AF6
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Mar 2024 07:05:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8383410EC10;
	Wed, 20 Mar 2024 06:05:19 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="A6QanQVN";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DBC5E10EC1F
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=PER1BREEp870OHFhrFCGbOlk8hEcBHVh4MWDBhrGHqM=;
 b=A6QanQVNjbaEmCSk8ruOsnUJ9j8foE/t28ih3I1wlUMDxOv1iTPOuPaS
 kk7m2l29plNERcK5mRviV6PecsmPycr/D2zsNu40eYvdWgXd1lhIpgFpt
 BqMrTipiDOVgK5MqMOzLb1Obp87QJgL07dcJ2pWx8pRwTg0FGVhRQFq8q
 5YxeQ2qM80bq2kESsMuZHkt4Hb5Se9y1TX1Z0qwD88zx/1YLFAoj7NyR7
 YmVk9NcafeE9QNKmySlAYFDFxQ2Wcy3EEB5+PzNjqXvaEEZ6Dcbf72Nvq
 2kOfskBhuvpy9Iauoz5oSmECRKV7zqmzGVjcKdp6Gyx3einY5Kx/bvsic w==;
X-IronPort-AV: E=McAfee;i="6600,9927,11018"; a="28295580"
X-IronPort-AV: E=Sophos;i="6.07,139,1708416000"; d="scan'208";a="28295580"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Mar 2024 23:05:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,139,1708416000"; d="scan'208";a="51485499"
Received: from lucas-s2600cw.jf.intel.com ([10.165.21.196])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Mar 2024 23:05:17 -0700
From: Lucas De Marchi <lucas.demarchi@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [CI 2/6] drm/i915: Remove XEHP_FWRANGES()
Date: Tue, 19 Mar 2024 23:02:59 -0700
Message-ID: <20240320060543.4034215-3-lucas.demarchi@intel.com>

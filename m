...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B52740CAAE
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Sep 2021 18:40:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5DD306E99C;
...
Subject: [Intel-gfx] [PATCH v8 06/16] dyndbg: no vpr-info on empty queries

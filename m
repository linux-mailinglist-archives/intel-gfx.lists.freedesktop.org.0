...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DBC04020F0
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Sep 2021 23:02:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46AC289D5C;
...
Subject: [Intel-gfx] [RFC v2 17/22] drm: Add Plane Gamma Mode property

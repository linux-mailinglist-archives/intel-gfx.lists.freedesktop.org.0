...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CFB51A15887
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jan 2025 21:28:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B12C310EB77;
	Fri, 17 Jan 2025 20:27:57 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Ih/HKVoi";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EBACE10E232;
 Fri, 17 Jan 2025 20:27:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1737145676; x=1768681676;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=/DgcznKjl/SFgJwzxOB8uc/8NPCfhSD2BK2UpU9C5Do=;
 b=Ih/HKVoiWklF3sLfy4YMlxx0+hpcWSNu6q+JqQWw7MaPTxXJeKxWln0P
 n7ZkX7AyT3rLCSybFWApm3Lb8mxwJW5WnIQx5aH3wGxVV+hKI6bEPBlB7
 /aMI4oWFYooGdJsFUlmBPp1VfGHIpz5MjQeZgWa61GRvN7bGgTtd+J6QZ
 5f9T8n8eKUSsiFYSKh+6+M/900Ila6aDzIpQd0ZX/lWZhHACtEQLnSTtR
 CjvoJ8s7LX/8veYuD7MlgIZ4i4/aDn7CRGV5EWb+pm0OKiZ8KEeoOSm/J
 DQg6NQ3wScouVLABZMgTv4xTAOlMX2AMY5c3LvLarnka/Oc3fGWWsy+eB g==;
X-CSE-ConnectionGUID: C7nCZS4kTrSd0Iw9vI6VgA==
X-CSE-MsgGUID: ER6gQE9hTm+FybZn/zju/g==
X-IronPort-AV: E=McAfee;i="6700,10204,11314"; a="49007106"
X-IronPort-AV: E=Sophos;i="6.12,310,1728975600"; d="scan'208";a="49007106"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jan 2025 12:27:55 -0800
X-CSE-ConnectionGUID: L5MSpXaHTE65MLeh92CTGQ==
X-CSE-MsgGUID: msBBtSIyRkCAb53Zgl2CqA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,224,1728975600"; d="scan'208";a="143185894"
Received: from vbelgaum-ubuntu.fm.intel.com ([10.1.39.141])
 by orviesa001.jf.intel.com with ESMTP; 17 Jan 2025 12:27:55 -0800
...
Subject: [PATCH v3] drm/i915/slpc: Add sysfs for SLPC power profiles
Date: Fri, 17 Jan 2025 12:24:14 -0800
Message-Id: <20250117202414.714469-1-vinay.belgaumkar@intel.com>

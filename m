...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDE8650A864
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 20:50:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 639F210E975;
...
Subject: [Intel-gfx] [PATCH v4 2/6] drm/i915: sanitize mem_flags for stolen
 buffers

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AECDE577B9F
	for <lists+intel-gfx@lfdr.de>; Mon, 18 Jul 2022 08:41:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 42AD5A9DA2;
	Mon, 18 Jul 2022 06:39:34 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 36/41] dyndbg/drm: POC add tracebits
 sysfs-knob

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C025EA6E2E
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Sep 2019 18:25:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A7AB896DD;
...
Subject: [Intel-gfx] [PATCH AUTOSEL 5.2 22/23] drm/i915: Add whitelist
 workarounds for ICL

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9AC0E66383C
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Jan 2023 05:36:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECCD210E539;
	Tue, 10 Jan 2023 04:36:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1939910E539
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 Jan 2023 04:36:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1673325407; x=1704861407;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=krEfeWv6qrBHwGeYoLMZA5PfCwBcnAm5K0i1vq30HVU=;
 b=YpVFc/pJZxAw8Gn8qQCY1+kvvS6NtnZdLAE2LUjMHFd+J2PZpDTKI0w/
 oIu+PNKDdOQWvdrP97Bd+sPvf3MiOhPgch5EMvoV/gkvCczAV4ufp8xUb
 hpVWkZbNsanHywr42nYi46mbGeHmbh2Ny5pVEwmZiBpiFeYTtC+pSBRpv
 orbUx7Cd1ZfCBMmvYDRngb5SzqKx7lzlWqtHogsFtwQxovqO8/dNSdd+2
 D5nsvUb6ZhzAHEeUuU4T3oIY0H1TziTS0lDLoq/wh2GAZJqEAK49bl6sM
 lShDsAEKsPn8dImMbY9zN900OvmnUMYzZn6/+3mCy5OS2colHwlA7FXRK A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="350279737"
X-IronPort-AV: E=Sophos;i="5.96,314,1665471600"; d="scan'208";a="350279737"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jan 2023 20:36:46 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="650230609"
X-IronPort-AV: E=Sophos;i="5.96,314,1665471600"; d="scan'208";a="650230609"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga007.jf.intel.com with ESMTP; 09 Jan 2023 20:36:43 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Jan 2023 10:05:17 +0530
Message-Id: <20230110043517.1388837-7-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 6/6] drm/i915/mtl: Add HDCP GSC interface

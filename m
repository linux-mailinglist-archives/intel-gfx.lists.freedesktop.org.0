...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE5FE36CA8F
	for <lists+intel-gfx@lfdr.de>; Tue, 27 Apr 2021 19:46:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0FE796E9AF;
	Tue, 27 Apr 2021 17:46:08 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH] drm/i915/gem: Remove reference to struct
 drm_device.pdev
...
Content-Type: multipart/mixed; boundary="===============1928248228=="

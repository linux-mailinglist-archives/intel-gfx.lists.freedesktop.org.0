...
Received: from mail.lfdr.de
	...
	id yvqRM39FMWo6fwUAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Jun 2026 14:45:51 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D06768F820
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Jun 2026 14:45:51 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=intel.com header.s=Intel header.b=OXgFgci5;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org;
	dmarc=pass (policy=none) header.from=intel.com
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B423E10EB1C;
	Tue, 16 Jun 2026 12:45:49 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8CE6510EB27;
 Tue, 16 Jun 2026 12:45:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1781613948; x=1813149948;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=goF0fKtalgAyyqHmTy+6CF+FPQtJ4Q+5h54riM0rOHU=;
 b=OXgFgci54IYNGv67qrKa9BpUajstzuv36C7zLzPfGnssFP2GED5TMrsA
 KEBbMZ5i0RVzDIYHBI+cwTeKcD7Sjk6EyAwmAXZUE89wXLVxKI+w5H+ai
 xfznCRpVEnlBBYcMuzEEzpOaweQE6NFRCt9flHLngMax45FmpJS95m4Vw
 es5HB38squJcycljDWU9VcBxMzk+KJ3dcCEDtNivrfGAkPjTyeomuth5k
 uITRrNNNbLm4aVXCGNUjKQnJ/zdKKi3GLTKHoOiEeM/NyydU9/c4NN4bo
 v4WGyt4YR2/8mB7QaGasBhePHenGXfV/yc5ouh/7k86VW9PoHHK/msz5u A==;
X-CSE-ConnectionGUID: PxlHERaiTm2o7YspdAM+OQ==
X-CSE-MsgGUID: hUpW+9/vRGWQDPqsBuC1MQ==
X-IronPort-AV: E=McAfee;i="6800,10657,11818"; a="81513262"
X-IronPort-AV: E=Sophos;i="6.24,208,1774335600"; d="scan'208";a="81513262"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2026 05:45:48 -0700
X-CSE-ConnectionGUID: 0zN7uX+dST+BfSlZtdBHdQ==
X-CSE-MsgGUID: tAYiA34WTpSv4XnRvnyOGQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.24,208,1774335600"; d="scan'208";a="244876336"
...
Subject: [CI v4 24/39] drm/i915/display: Switch DC3CO enable from standalone
 bit to DC level encoding
Date: Tue, 16 Jun 2026 18:14:00 +0530
Message-ID: <20260616124416.2442161-25-dibin.moolakadan.subrahmanian@intel.com>
...
+		DC_STATE_EN_UPTO_DC3CO,
 	...
 	int i;
@@ -341,7 +341,7 @@ void intel_display_power_set_target_dc_state(struct intel_display *display,
...
@@ -1022,10 +1022,10 @@ static u32 get_allowed_dc_mask(struct intel_display *display, int enable_dc)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E49C6A9CA05
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Apr 2025 15:20:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5418F10E2E7;
	Fri, 25 Apr 2025 13:20:05 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="cN+wx4ea";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 924A910E2E7;
 Fri, 25 Apr 2025 13:20:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1745587203; x=1777123203;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=8dQYFJEb4awNk2Wq4cqUJ8n1U5Is2sQtzLi1cwZWb+0=;
 b=cN+wx4ea1x1jLzUYWHz2Ehp6MrqYymzkI7bTkUmOrgNeJFN9gVxJQ61y
 ZkJeT6xWvWWVu6hpHQ/3kQOBzbwyVGZFLzbG4dcgzg5OLr4GIquP2dB+C
 Ecyh3+NObVScGpeQo3P5KigNMM7qY0QQu4axR8Mh1CUGwmtAOchG7kh76
 Mkk1FiJjK+bZchskqLtBbKIaXh2nOr8PBhFTqZnvGl8r5JyRe64y2Gw/Z
 dtIVcFl4D56EIc/29Vy+0kG5TiP2mlDZZEDgktvmh9NvfJ/Rb3ogw9Mta
 5eXTOYbofjn4Tp6+67bGC7oEDEuSr9Qas/afcyCgZnXolfY+lFl50SE8W g==;
X-CSE-ConnectionGUID: 8cWyHYi/RSS1bMvCT5HbWw==
X-CSE-MsgGUID: 7SU9McD7Sc+Sn6zmyp/nTQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11414"; a="47421258"
X-IronPort-AV: E=Sophos;i="6.15,238,1739865600"; d="scan'208";a="47421258"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
 by fmvoesa108.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2025 06:20:03 -0700
X-CSE-ConnectionGUID: u9S1sx5ES5OzeyjKHpkufw==
X-CSE-MsgGUID: 4efXVEItQ8WFGHR5XtdlbA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,238,1739865600"; d="scan'208";a="138067740"
Received: from kniemiec-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.246.83])
 by orviesa005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2025 06:20:00 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com,
	ville.syrjala@linux.intel.com
Subject: [PATCH 6/6] drm/i915: convert VLV IOSF SB interface to struct
 drm_device
Date: Fri, 25 Apr 2025 16:19:24 +0300
Message-Id: <51499cbc10030f67a5054201d2ba7dfde4856a02.1745587049.git.jani.nikula@intel.com>

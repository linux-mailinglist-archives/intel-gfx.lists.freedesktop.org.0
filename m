...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EDC120FED3
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jun 2020 23:29:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8877B6E334;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/59] drm/kmb: Initial check-in for Mipi DSI

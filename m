...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B2A9644DDB1
	for <lists+intel-gfx@lfdr.de>; Thu, 11 Nov 2021 23:03:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 13E586E9A2;
	Thu, 11 Nov 2021 22:02:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v10 09/10] dyndbg: create
 DEFINE_DYNAMIC_DEBUG_LOG|TRACE_GROUPS

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B17769FBB2
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Aug 2019 09:29:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1E05C89C25;
	Wed, 28 Aug 2019 07:29:04 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 0/6] drm/i915: Enable HDCP 1.4 and 2.2 on
 Gen12+

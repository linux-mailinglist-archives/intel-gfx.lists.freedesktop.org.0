...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 90D48512EB2
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Apr 2022 10:39:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8497810E5FA;
	Thu, 28 Apr 2022 08:39:10 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ej1-x62b.google.com (mail-ej1-x62b.google.com
 [IPv6:2a00:1450:4864:20::62b])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AC53D10EB2F;
 Wed, 27 Apr 2022 15:04:58 +0000 (UTC)
Received: by mail-ej1-x62b.google.com with SMTP id r13so4002348ejd.5;
 Wed, 27 Apr 2022 08:04:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=message-id:date:mime-version:user-agent:subject:content-language:to
 :cc:references:from:in-reply-to:content-transfer-encoding;
 bh=Bz+HSnTkV2/oergLVPYsODs9eXWORJvVCPcjZTd+MrU=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=Bz+HSnTkV2/oergLVPYsODs9eXWORJvVCPcjZTd+MrU=;
 b=
X-Gm-Message-State: AOAM530XOeox4EEbqYt2/K/ZGq5QWqPlL4+mtdYoqPsiHKuLk1aFwegF
 gVgjdPaviw6Uvs7DHb+bNAk=
X-Google-Smtp-Source: ABdhPJyVDDeQZu5rkSdJC6oqkfRoPoMs45DNgmZW1ngzsUvNqnUpXgiTiQhZB50jqQ8w/U0O3k7fpA==
X-Received: by 2002:a17:907:a429:b0:6f3:88cf:2e94 with SMTP id
 sg41-20020a170907a42900b006f388cf2e94mr18032456ejc.550.1651071896938; 
 Wed, 27 Apr 2022 08:04:56 -0700 (PDT)
Received: from ?IPV6:2a02:908:1256:79a0:7420:a21a:88a4:93c6?
 ([2a02:908:1256:79a0:7420:a21a:88a4:93c6])
 by smtp.gmail.com with ESMTPSA id
 jr16-20020a170906a99000b006e4c05e8919sm6949816ejb.35.2022.04.27.08.04.54
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Wed, 27 Apr 2022 08:04:55 -0700 (PDT)
Message-ID: <bec9e49d-e4ee-9fd2-a603-a1fdfaa7ea2e@gmail.com>
Date: Wed, 27 Apr 2022 17:04:52 +0200
MIME-Version: 1.0
...
References: <20220420171328.57253-1-matthew.auld@intel.com>
 ...
 <2b7b8193-a6ab-70a8-2102-3e7ac51548cb@intel.com>
From: =?UTF-8?Q?Christian_K=c3=b6nig?= <ckoenig.leichtzumerken@gmail.com>
In-Reply-To: <2b7b8193-a6ab-70a8-2102-3e7ac51548cb@intel.com>

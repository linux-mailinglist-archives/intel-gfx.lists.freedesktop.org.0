...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 89C9E6FC110
	for <lists+intel-gfx@lfdr.de>; Tue,  9 May 2023 09:57:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9760610E349;
...
Subject: Re: [Intel-gfx] [PATCH 3/3] drm/i915: Temporary conversion to new
 GENMASK/BIT macros

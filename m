...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AEFFD7BE9B8
	for <lists+intel-gfx@lfdr.de>; Mon,  9 Oct 2023 20:38:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18CF610E2C2;
...
Subject: [Intel-gfx] [PATCH 0/2] More print message helper updates

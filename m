...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 25EF06F116B
	for <lists+intel-gfx@lfdr.de>; Fri, 28 Apr 2023 07:46:48 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 77C1A10EC4A;
	Fri, 28 Apr 2023 05:46:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1F2EC10E390;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=eOz1jeoUXhyDItcnW7gmmHZ6f1qjR8OJPIzesIKVcec=;
 b=CD3euMlJyui6W+oJmK5Q4AL1JIVD8wvQ2+5Yi9ZXOQiUixDbrkxcFw54
 3GRQtQ8tIalNc7TCeL6tZpIxGbst55blpCkCi4ozwM4HIlz42PxEW/NaC
 CsWEy22cS0b/sGdhjTjWsEWug/xmh1Z3Jly556SgCBjvxsVHA81HryAwf
 R2SuzIgtmnM2ipvavHyTdG7LTxZguP9EnTGfNX+p4te+wQtt4PdrOp8fX
 w6uraPGl9YussaNaWkuX3pstcrOCxQaLcXfSqmB+PmBXC5MTes+HponN9
 mOLaeboQ94e/EqhSgXiBHg5XbRj8X9y3ZbBPsEV3fBzrBb2AVXdvvuKBg g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="413040411"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="413040411"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:46:31 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10693"; a="806251808"
X-IronPort-AV: E=Sophos;i="5.99,233,1677571200"; d="scan'208";a="806251808"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Apr 2023 22:46:31 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Thu, 27 Apr 2023 22:47:33 -0700
Message-Id: <20230428054737.1765778-2-fei.yang@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 1/5] drm/i915: preparation for using PAT index

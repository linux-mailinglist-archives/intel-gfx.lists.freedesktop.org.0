...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F13B59A616
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Aug 2022 21:17:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B73D110EB74;
	Fri, 19 Aug 2022 19:17:24 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 07/21] drm/i915/mtl: Add gmbus and gpio
 support

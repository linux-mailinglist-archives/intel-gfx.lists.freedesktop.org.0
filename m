...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9075F39FDFF
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Jun 2021 19:43:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C8C0B6E7F1;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 4/7] drm/i915/display: Add handling for new
 "active bpc" property

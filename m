...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BB0A13BCD5
	for <lists+intel-gfx@lfdr.de>; Wed, 15 Jan 2020 10:53:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E4D76E8E3;
	Wed, 15 Jan 2020 09:53:14 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D0AA6E8E3
 for <intel-gfx@lists.freedesktop.org>; Wed, 15 Jan 2020 09:53:11 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga106.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 15 Jan 2020 01:53:10 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,322,1574150400"; d="scan'208";a="273604533"
Received: from slisovsk-lenovo-ideapad-720s-13ikb.fi.intel.com ([10.237.72.89])
 by FMSMGA003.fm.intel.com with ESMTP; 15 Jan 2020 01:53:09 -0800
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 15 Jan 2020 11:50:50 +0200
Message-Id: <20200115095054.10660-2-stanislav.lisovskiy@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 1/5] drm/i915: Remove skl_ddl_allocation
 struct
...
index 19ea842cfd84..eaff62c2b043 100644
--- a/drivers/gpu/drm/i915/display/intel_display.c
+++ b/drivers/gpu/drm/i915/display/intel_display.c
@@ -13749,14 +13749,13 @@ static void verify_wm_state(struct intel_crtc *crtc,
 	struct skl_hw_state {
...
+	u8 hw_enabled_slices;
 	...
 	if (INTEL_GEN(dev_priv) < 9 || !new_crtc_state->hw.active)
 		return;
@@ -13770,14 +13769,13 @@ static void verify_wm_state(struct intel_crtc *crtc,
...
@@ -15122,8 +15120,8 @@ static void skl_commit_modeset_enables(struct intel_atomic_state *state)
...
index fdd943a17de3..6dca90ebca35 100644
...
index e7be4c3e43c6..120c9f1090c4 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -799,13 +799,8 @@ static inline bool skl_ddb_entry_equal(const struct skl_ddb_entry *e1,
 	return false;
 }
...
-	struct skl_ddb_allocation ddb;
 ...
 struct skl_wm_level {
@@ -1213,6 +1208,8 @@ struct drm_i915_private {
...
index bd2d30ecc030..8f6f6472626a 100644
...
+					   alloc, &num_active);
 	...
 	if (alloc_size == 0)
 		return 0;
@@ -5231,18 +5230,17 @@ skl_ddb_add_affected_planes(const struct intel_crtc_state *old_crtc_state,
 static int
...
@@ -5719,11 +5717,10 @@ void skl_pipe_wm_get_hw_state(struct intel_crtc *crtc,

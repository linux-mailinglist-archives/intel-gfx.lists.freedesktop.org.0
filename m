...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C8374FE235
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 15:20:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 847E910E9A7;
...
Subject: Re: [Intel-gfx] [PATCH v5 02/10] drm/hdcp: Avoid changing crtc

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A7196135AFD
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Jan 2020 15:06:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 94B206E40C;
...
Subject: [Intel-gfx] [PATCH 3/5] drm/i915: conversion to new logging macros
 in i915/intel_device_info.c

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E1F55BF489
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Sep 2022 05:27:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1DFB110E807;
...
Subject: [Intel-gfx] [PATCH v4 09/15] vfio/ap: Use the new device life cycle
 helpers

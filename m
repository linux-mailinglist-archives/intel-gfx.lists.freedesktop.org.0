...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C7B3F5A4DA7
	for <lists+intel-gfx@lfdr.de>; Mon, 29 Aug 2022 15:19:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0ECDE10F28F;
	Mon, 29 Aug 2022 13:19:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1449010F284
 for <intel-gfx@lists.freedesktop.org>; Mon, 29 Aug 2022 13:19:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1661779146; x=1693315146;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=DGO6H+eTNZrnb2aRSRTfqWSdaOV7FQh58wG3/DpBW/4=;
 b=YK75e0pnDHdlkNmiCAHvyrFHggpGWii3YLxkxH9cITixIkgYNM3IxX2S
 6v1lF9G6GSgXhZiTHxSaDsOrrjV3PcuEKMm0KWrXzS8zg6SVpiRvntwg4
 qWLU5BDcMImiH+Wp+mBk18Gfpogk2uIl+iKrd0v8W1ivp0ai/2e09pTGC
 O63AVcE/A60ZmlBQXGCLyMOICUk/jz8jOOBoYzkGttxoiKNY4bZoHixXu
 BlagIuHa54ZxpcOVjM30EDYFIhR7nFIZ5XL0lFjEJrBPUgpOlvbwwJX60
 ezZ/ayRm7CQFxnVJz0cZgEwxzJRWQt571kqCfzBS1kMdk+F7o2qTZFiEq A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10454"; a="296165182"
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="296165182"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:19:04 -0700
X-IronPort-AV: E=Sophos;i="5.93,272,1654585200"; d="scan'208";a="679621234"
Received: from idecesar-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.53.198])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 29 Aug 2022 06:19:02 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 29 Aug 2022 16:18:14 +0300
Message-Id: <db4b648b201ea0b79654fec2028120999a735db0.1661779055.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v3 07/18] drm/i915: move vbt to display.vbt
...
index 7f978612ddc6..b347165ac2cf 100644
...
index a8fc77a852b5..e3c7de286226 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EA8F633A42
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Nov 2022 11:40:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 812BD10E1CC;
	Tue, 22 Nov 2022 10:39:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 46DC510E1CC;
 Tue, 22 Nov 2022 10:39:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669113595; x=1700649595;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=LuCFfvuT4K8baBDciIYmbc3YYggxYcJzWoE4xTHrhHU=;
 b=YZ1+q9p4ZRu0TnIy+d1oHiZvcGdglF6GkDPwokBxdR3+hUe1Uod+3aoq
 lF3ADSsRDANgsIfFrZBh9DXrRUD5d3sqdt+1ASw7evA0B3mkezHHX/mv6
 pttIeJ0OWmy80Apdg04PBdt3ReaLQDlHlZEkLP6HNxPbLqbxXASp/I4ak
 BLge6ARni26I3Sf/nqwmMARiQIe+jDzBFDvRUD/uU+kt7e4lCrL08Yrao
 YvpnDW+wJpPX/T3+qMBtzrectJHEH44sTjvTXIkK0A7672wAXCtDgdAYk
 GUTg79EwiIxdxjAyVcgYgrFiWtJ/HhKsFm9HCoaOezIeG8fZHpgDYyAnS g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10538"; a="311415055"
X-IronPort-AV: E=Sophos;i="5.96,183,1665471600"; d="scan'208";a="311415055"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Nov 2022 02:39:54 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10538"; a="747301992"
X-IronPort-AV: E=Sophos;i="5.96,183,1665471600"; d="scan'208";a="747301992"
Received: from unknown (HELO intel.com) ([10.237.72.65])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Nov 2022 02:39:52 -0800
Date: Tue, 22 Nov 2022 12:39:45 +0200
From: "Lisovskiy, Stanislav" <stanislav.lisovskiy@intel.com>
To: "Navare, Manasi" <manasi.d.navare@intel.com>
Message-ID: <Y3ym8Ve4leqxKw3U@intel.com>
References: <20221101094222.22091-7-stanislav.lisovskiy@intel.com>
 <20221103132300.12805-1-stanislav.lisovskiy@intel.com>
 <Y215+cst5k5dCoBf@mdnavare-mobl9>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <Y215+cst5k5dCoBf@mdnavare-mobl9>
...
It was actually expecting a ratio timeslots/64, rather than the timeslots number.

For SST it didn't matter as timeslots were always 1, but for MST case if we multiply 
that by number number of timeslots, this formula will return some big bogus 
bits_per_pixel number(checked that). 
Of course we can pass a ratio timeslots/64 here, but it isn't very convenient and intuitive
to manipulate.
So I made it to use a "timeslots" parameter as timeslots number, 
so that the ratio is calculated as part of the formula i.e:

((link_clock * lane_count * 8) * (timeslots / 64)) /  intel_dp_mode_to_fec_clock(mode_clock);

which can be simplified as

((link_clock * lane_count * timeslots) / 8) / intel_dp_mode_to_fec_clock(mode_clock);

the whole formula comes from that
pipe_bpp * crtc_clock should be equal to link_total_bw * (timeslots / 64), i.e
timeslots/64 ratio defines, how much of the link_total_bw(link_clock * lane_count * 8)
we have for those pipe_bpp * crtc_clock, which we want to accomodate there.

Obviously if we just multiplied link_total_bw by timeslots, we would get a situation that
the more timeslots we allocate, the more total bw we get, which is wrong and will

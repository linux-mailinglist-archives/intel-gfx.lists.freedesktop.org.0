...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDC044B21CD
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Feb 2022 10:26:08 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6430210EA54;
	Fri, 11 Feb 2022 09:26:02 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 04/15] drm/i915/buddy: track available
 visible size

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2046736F813
	for <lists+intel-gfx@lfdr.de>; Fri, 30 Apr 2021 11:45:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E9C476F51E;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 3/5] drm/vc4: Add HDR metadata property to
 the VC5 HDMI connectors

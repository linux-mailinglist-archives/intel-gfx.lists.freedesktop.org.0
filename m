...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BDF3DAA8F
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Oct 2019 12:52:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 02CED6EA53;
...
Subject: [Intel-gfx] [PATCH V4 6/6] docs: sample driver to demonstrate how

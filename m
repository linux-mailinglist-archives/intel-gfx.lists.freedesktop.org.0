...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FF82879FD3
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Mar 2024 00:51:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 71CDA10F24B;
	Tue, 12 Mar 2024 23:51:15 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="FVabyGXH";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8F87E10F24B
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=p30XyqmqHcuaFhdn3nuZ5Svhi3UsDSI/hRC5WcZV2k0=;
 b=FVabyGXHxq15B/Q2LGeNRZboPkZHN2LlvgDecw9wNEfj/gvFVADFmoL1
 BhWAkIZoDQ92yBjRMpYF7g5UyX9aVKK5sjXe7IXU/ApmP9wv6lCyT5dPA
 BWOQrC3E+zqs/73a6KwfjR78Os4qjd+YnEQ97gJGKiORPbUdQzovwjPP9
 axJjEZ3FkQMfQYxUfqEH71gzWHZrJ31Rqx0tP10AKhLdrvITq5/UbSlkI
 Xi8ceTeL4WmNT0BuSojbVEj9mUD47VYDUa9idNxFqugUfjgoFDFVgFUgw
 sKF60nRxca6LLGI1J7bhkRMPsHXVXqPs7asLI7Pro37GUU5tpAfmxxTIz w==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="8848039"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="8848039"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Mar 2024 16:51:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; d="scan'208";a="42715872"
...
Subject: [PATCH v2 1/6] drm/i915: Drop dead code for xehpsdv
Date: Tue, 12 Mar 2024 16:51:40 -0700
Message-ID: <20240312235145.2443975-2-lucas.demarchi@intel.com>
...
index a929aa6e3c85..1788db4376e5 100644
...
index b079cbbc1897..cfe2f4b64f04 100644
...
index 8823531b8770..6c87be2684e6 100644

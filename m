...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D849A1C36F7
	for <lists+intel-gfx@lfdr.de>; Mon,  4 May 2020 12:31:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 678D96E362;
	Mon,  4 May 2020 10:31:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9D27F6E365
 for <intel-gfx@lists.freedesktop.org>; Mon,  4 May 2020 10:31:54 +0000 (UTC)
IronPort-SDR: SSPxhk6lDhguOwfNBET9oG9cEPi76Ra8pMaRJS6H3ilOe8dkYiNJyY+7T8E3ZAiuAkwqiCLXo3
 BQSmukOUoMsg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 May 2020 03:31:54 -0700
IronPort-SDR: F0lbKYRqInGCoGaxXbxQ3CqZh3aQo9fiRCs/uh0b4ifcTdI2rZqKG0vnF6S24/nAHyrhZq4hTu
 0K0Fjzlhw6pg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,351,1583222400"; d="scan'208";a="369054460"
Received: from flast-mobl2.ger.corp.intel.com (HELO delly.ger.corp.intel.com)
 ([10.249.47.245])
 by fmsmga001.fm.intel.com with ESMTP; 04 May 2020 03:31:52 -0700
From: Lionel Landwerlin <lionel.g.landwerlin@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon,  4 May 2020 13:31:45 +0300
Message-Id: <20200504103146.1359515-4-lionel.g.landwerlin@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v11 3/4] drm/i915/perf: prepare driver to
...
index 44148b705a5a..1ec724708a20 100644
...
+	return 0;
 ...
 /*
@@ -2586,11 +2661,9 @@ gen12_enable_metric_set(struct i915_perf_stream *stream,
...
@@ -2631,8 +2704,7 @@ static void gen12_disable_metric_set(struct i915_perf_stream *stream,
...
@@ -2641,8 +2713,7 @@ static void gen12_disable_metric_set(struct i915_perf_stream *stream,
...
@@ -2664,7 +2735,7 @@ static void gen7_oa_enable(struct i915_perf_stream *stream)
...
@@ -2881,7 +2952,7 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 	}
...
@@ -2929,12 +3000,10 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 	if (stream->periodic)
...
@@ -2971,21 +3040,14 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
...
-	stream->config_context->timeline = timeline;
 	...
 	if (ret)
@@ -3020,7 +3082,7 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 err_context_pin:
...
+err_context:
 ...
 err_oa_buf_alloc:
@@ -3033,8 +3095,7 @@ static int i915_oa_stream_init(struct i915_perf_stream *stream,
 	free_noa_wait(stream);
...
@@ -3227,8 +3288,12 @@ static void i915_perf_enable_locked(struct i915_perf_stream *stream)
...
+	}
 ...
 /**
@@ -3253,8 +3318,12 @@ static void i915_perf_disable_locked(struct i915_perf_stream *stream)
...
@@ -3272,7 +3341,7 @@ static long i915_perf_config_locked(struct i915_perf_stream *stream,
 		return -EINVAL;
...
+		int i;
 		...
 		if (!active) {
@@ -3280,28 +3349,29 @@ static long i915_perf_config_locked(struct i915_perf_stream *stream,
 			goto err_config;
 		}
...
@@ -3382,9 +3452,10 @@ static void i915_perf_destroy_locked(struct i915_perf_stream *stream)
...
@@ -3459,25 +3530,12 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
...
@@ -3498,17 +3556,16 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
...
@@ -3529,23 +3586,43 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
 	if (privileged_op &&
...
@@ -3580,12 +3657,11 @@ i915_perf_open_ioctl_locked(struct i915_perf *perf,
 err_flags:
 	if (stream->ops->destroy)
 		stream->ops->destroy(stream);
-err_alloc:
...
@@ -3617,7 +3693,7 @@ static int read_properties_unlocked(struct i915_perf *perf,
 {
...
@@ -3651,23 +3727,36 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+			props->n_ctx_handles = 1;
 		...
 		case DRM_I915_PERF_PROP_SAMPLE_OA:
 			if (value)
@@ -3676,7 +3765,8 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+				goto error;
 			...
 			break;
@@ -3684,12 +3774,14 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+				goto error;
 			...
 			break;
@@ -3697,7 +3789,8 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
@@ -3726,7 +3819,8 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
@@ -3742,13 +3836,14 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+				goto error;
 			...
 			props->has_sseu = true;
 			break;
@@ -3757,19 +3852,25 @@ static int read_properties_unlocked(struct i915_perf *perf,
...
+	return err;
 ...
 /**
@@ -3829,6 +3930,8 @@ int i915_perf_open_ioctl(struct drm_device *dev, void *data,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ACA1E79AC5B
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Sep 2023 01:09:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4F8BA10E377;
	Mon, 11 Sep 2023 23:09:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-xd33.google.com (mail-io1-xd33.google.com
 [IPv6:2607:f8b0:4864:20::d33])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2612210E35E;
 Mon, 11 Sep 2023 23:08:57 +0000 (UTC)
Received: by mail-io1-xd33.google.com with SMTP id
 ca18e2360f4ac-792726d3aeeso171725839f.0; 
 Mon, 11 Sep 2023 16:08:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20221208; t=1694473736; x=1695078536; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=fkFQKBHB4GG8/l3RECixev8OXAqa/tD0dG3NgASD47c=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1694473736; x=1695078536;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=fkFQKBHB4GG8/l3RECixev8OXAqa/tD0dG3NgASD47c=;
 b=
X-Gm-Message-State: AOJu0Yy73Klg4f4uIUny5+wLm9kYAusrYaUQVeJ+w9r7JIFywCRDb23w
 ePBeOf/y/rzqw9PsfA2716E=
X-Google-Smtp-Source: AGHT+IH56XG0z8gyyMNha3eeNUT3deNlrRmXu0OMEwcExOq4sOcn1DpFfvO+dr0oM8xVWEv1QCkkDg==
X-Received: by 2002:a05:6602:2e82:b0:792:8230:c17f with SMTP id
 m2-20020a0566022e8200b007928230c17fmr18279059iow.13.1694473736222; 
 Mon, 11 Sep 2023 16:08:56 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 z4-20020a029f04000000b00423240c7296sm2512607jal.69.2023.09.11.16.08.55
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 11 Sep 2023 16:08:55 -0700 (PDT)
From: Jim Cromie <jim.cromie@gmail.com>
To: jbaron@akamai.com, gregkh@linuxfoundation.org, mcgrof@kernel.org,
 daniel.vetter@ffwll.ch
Date: Mon, 11 Sep 2023 17:08:28 -0600
Message-ID: <20230911230838.14461-13-jim.cromie@gmail.com>
...
Subject: [Intel-gfx] [PATCH v6 12/22] dyndbg-API: fix
...
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -7253,7 +7253,7 @@ M:	Jim Cromie <jim.cromie@gmail.com>
 S:	Maintained

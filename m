...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 26FC86BE04D
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Mar 2023 05:51:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DE47510E043;
	Fri, 17 Mar 2023 04:51:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 607EE10E043;
 Fri, 17 Mar 2023 04:51:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 gQXorE4OaR6mTSLdWqNJzpHAs4IETcciDGqPHyVRHhKIRSmB2YkH1W31l w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="318575405"
X-IronPort-AV: E=Sophos;i="5.98,267,1673942400"; d="scan'208";a="318575405"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 21:51:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="712613050"
X-IronPort-AV: E=Sophos;i="5.98,267,1673942400"; d="scan'208";a="712613050"
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(13230025)(346002)(366004)(39860400002)(376002)(136003)(396003)(451199018)(6512007)(6506007)(6666004)(186003)(26005)(38100700002)(86362001)(2906002)(3450700001)(82960400001)(8936002)(41300700001)(5660300002)(8676002)(6916009)(66476007)(66946007)(4326008)(66556008)(6486002)(316002)(54906003)(83380400001)(478600001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 17 Mar 2023 04:51:04.6815 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 03/27] drm/i915/gvt: remove interface

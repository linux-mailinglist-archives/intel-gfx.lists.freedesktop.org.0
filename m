...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C819689490
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Feb 2023 11:00:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2287810E522;
	Fri,  3 Feb 2023 10:00:51 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 5/6] drm/i915/guc: More debug print updates
 - GuC SLPC

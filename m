...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 95DBE487291
	for <lists+intel-gfx@lfdr.de>; Fri,  7 Jan 2022 06:31:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 47C3A113276;
...
Subject: [Intel-gfx] [PATCH v11 17/19] drm_print: add struct _ddebug *desc
 to trace-drm-*() params

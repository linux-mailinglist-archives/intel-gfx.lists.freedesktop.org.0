...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 21A782D70EC
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Dec 2020 08:30:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03F2C6EC92;
	Fri, 11 Dec 2020 07:29:53 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C6F8D6EC80
 for <Intel-gfx@lists.freedesktop.org>; Fri, 11 Dec 2020 07:29:45 +0000 (UTC)
IronPort-SDR: n4ew7terJ98Ft41XZzyQTmdWQ17PqqVpau/t1wSn5EZxe01NJYDPxJsX1vWXTMyqb8ThsAcljc
 tHzDgZfaKLnA==
X-IronPort-AV: E=McAfee;i="6000,8403,9831"; a="174506397"
X-IronPort-AV: E=Sophos;i="5.78,410,1599548400"; d="scan'208";a="174506397"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2020 23:29:44 -0800
IronPort-SDR: Ps5cI4CUN/CuE+E9iSRenxr4sZ8P44+V6kL1rg9IN3I16OHPyzjrCyWgeiNbG/loeLVgQJn4Kb
 v9etRw6bTjCw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,410,1599548400"; d="scan'208";a="409063280"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga001.jf.intel.com with ESMTP; 10 Dec 2020 23:29:44 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Thu, 10 Dec 2020 23:28:54 -0800
Message-Id: <20201211072911.27403-5-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201211072911.27403-1-sean.z.huang@intel.com>
References: <20201211072911.27403-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v7 04/21] drm/i915/pxp: Create the arbitrary
 session after boot

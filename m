...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 192778FAD8F
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Jun 2024 10:29:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7BA7810E43D;
	Tue,  4 Jun 2024 08:28:56 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="gex4Rvqu";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.129.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6A18110E43F
 for <intel-gfx@lists.freedesktop.org>; Tue,  4 Jun 2024 08:28:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1717489732;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=uRxb4s91be8Z5K0PlcwW7xp4HZ8oD+zUX1ejruZ7C98=;
 b=gex4Rvqu9JwmbifBFGou3w6iPtjKoBvRE7RTD4rUXeNlLagJiOieWjWSYS9Ifk13ZIDu4/
 Ir3gkT3ejyfOYPYhH39Ow2pWw4RvbfJqkpPvkOazTe9LyE6q3GE2i1+S4Bn9VPqHuJZJM8
 pmzqYJXzlt/bHM6jlpflhj9MFR+wneU=
Received: from mail-ej1-f69.google.com (mail-ej1-f69.google.com
 [209.85.218.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-299-g7W48vryNTi9LqSYPaRocQ-1; Tue, 04 Jun 2024 04:28:49 -0400
X-MC-Unique: g7W48vryNTi9LqSYPaRocQ-1
Received: by mail-ej1-f69.google.com with SMTP id
 a640c23a62f3a-a68c5f8f523so123103366b.2
 for <intel-gfx@lists.freedesktop.org>; Tue, 04 Jun 2024 01:28:49 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1717489727; x=1718094527;
 h=content-transfer-encoding:in-reply-to:from:content-language
 :references:cc:to:subject:user-agent:mime-version:date:message-id
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=uRxb4s91be8Z5K0PlcwW7xp4HZ8oD+zUX1ejruZ7C98=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCWxZlRrtsX6WxHxYQH71H4ICOQLMuxzS5lihsd9enS0Ngpv8zgV+aFpUYqWffLFdA1CEBdm8Xrd6WSD/iVoVcz7HJI5X6lLn9aoVo+25xGh
X-Gm-Message-State: AOJu0Yww4QC+poDTswitnbgCVtNWGRW3SW+HnOTgQVwQgYcy9CIBEpbL
 hXQ6XxipNPS64lcu4qy/KFXujasEgyOiPX5SsKeebfNzVPs1j+FJRPFlnhHcEDmPDAC7N4LawIz
 cVtFkgEQNXv9h8hN5HrvsjfrKsaSaTmIj3T/qAjMcfFMIH9dszGjGMhG0xQT657OY9w==
X-Received: by 2002:a17:906:a2d7:b0:a68:ecd5:6083 with SMTP id
 a640c23a62f3a-a68ece4a3a7mr568561466b.27.1717489726798; 
 Tue, 04 Jun 2024 01:28:46 -0700 (PDT)
X-Google-Smtp-Source: AGHT+IEJCGThciV1Q5Qxsl2EUI+nlN9ClnJqSijvNIkTmc8iQqBxdsvhjCkGRjTcttKuDpVjoWFw7A==
X-Received: by 2002:a17:906:a2d7:b0:a68:ecd5:6083 with SMTP id
 a640c23a62f3a-a68ece4a3a7mr568554866b.27.1717489725588; 
 Tue, 04 Jun 2024 01:28:45 -0700 (PDT)
Received: from ?IPV6:2001:1c00:c32:7800:5bfa:a036:83f0:f9ec?
 (2001-1c00-0c32-7800-5bfa-a036-83f0-f9ec.cable.dynamic.v6.ziggo.nl.
 [2001:1c00:c32:7800:5bfa:a036:83f0:f9ec])
 by smtp.gmail.com with ESMTPSA id
 a640c23a62f3a-a6900d7f6a3sm304055866b.90.2024.06.04.01.28.43
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Tue, 04 Jun 2024 01:28:45 -0700 (PDT)
Message-ID: <efbcf9d3-a506-4d4b-991f-6ce0a4cec644@redhat.com>
Date: Tue, 4 Jun 2024 10:28:42 +0200
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id AF315576F69
	for <lists+intel-gfx@lfdr.de>; Sat, 16 Jul 2022 16:43:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7EFE112C7F;
	Sat, 16 Jul 2022 14:37:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 81F3A10E0D8;
 Fri, 15 Jul 2022 22:55:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1657925702; x=1689461702;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=JmEEI4DAg2TSI73pg6BFPE2mSl0q9mDi9dtoD3YE65A=;
 b=IimTDuJ/W0XureJVIE2GCNJlu2v0NxbfF+PW2Fprw5BlJ8R1dAiIfIDu
 RN2FsfMSdxjQrGXgOsAkFfjy0P8bp981qh1UkND87B2VcBedNCNiKaAi0
 eydU2BbLQvqeiEeamulOl2O53vvugQkGectCuLyJarS/eyE5hwKs7kFPY
 B1hB59Q15iQK+fLaXBjaLcVxTlQRbq7rK4Pjhy17/g+9vfiUq+5RArwxg
 4qW/EJP63VDzGLSY2j9IEPcUH4qrn2Rlgd7tJUxXRZzoGFj/+1xPgYfor
 RzIHZBtxtdlZekTuND/66bYboLBK2kG/NfiV121ACRdipd3kDEhnAXvXZ g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10409"; a="283481693"
X-IronPort-AV: E=Sophos;i="5.92,275,1650956400"; d="scan'208";a="283481693"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Jul 2022 15:55:01 -0700
X-IronPort-AV: E=Sophos;i="5.92,275,1650956400"; d="scan'208";a="629278344"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Jul 2022 15:55:00 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 15 Jul 2022 15:54:51 -0700
Message-Id: <20220715225451.1294354-1-daniele.ceraolospurio@intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH] drm/i915/guc: support v69 in parallel to v70

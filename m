...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D4564375C9
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Oct 2021 13:00:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 228416ED15;
	Fri, 22 Oct 2021 10:59:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-qk1-x72d.google.com (mail-qk1-x72d.google.com
 [IPv6:2607:f8b0:4864:20::72d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8370D6ED10;
 Fri, 22 Oct 2021 10:59:56 +0000 (UTC)
Received: by mail-qk1-x72d.google.com with SMTP id r15so4145562qkp.8;
 Fri, 22 Oct 2021 03:59:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=cti3Q2HsTH7c+xglxYAIMkpXq3QR9b0SB2A4xahV1PI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=cti3Q2HsTH7c+xglxYAIMkpXq3QR9b0SB2A4xahV1PI=;
 b=
X-Gm-Message-State: AOAM530k30XrRJAUjHMomv/UUlvIq8fQO5vouQzbGapL5fo228yBJCY4
 ZmK+4o31n+us11hXw0Vz+u5nQoj4GP7Zjl+cAXduAgA9Ceg=
X-Google-Smtp-Source: ABdhPJyVFlhRRWVpI6JLXLJM/u2aAQE4FEvlamW1YQwg0fuhEbp6gR98df6muien/hEdcZjEM7NbAF/KvBntbCmnG8s=
X-Received: by 2002:a37:857:: with SMTP id 84mr9122042qki.342.1634900395295;
 Fri, 22 Oct 2021 03:59:55 -0700 (PDT)
MIME-Version: 1.0
References: <20211021103605.735002-1-maarten.lankhorst@linux.intel.com>
 <20211021103605.735002-13-maarten.lankhorst@linux.intel.com>
 <CAM0jSHOpC7OCQfXUse10h+MHQE06wHOgbkYaVov+g-z+s54j2w@mail.gmail.com>
In-Reply-To: <CAM0jSHOpC7OCQfXUse10h+MHQE06wHOgbkYaVov+g-z+s54j2w@mail.gmail.com>
From: Matthew Auld <matthew.william.auld@gmail.com>
Date: Fri, 22 Oct 2021 11:59:27 +0100
Message-ID: <CAM0jSHPsCANK0kCFeTZr8xAusLWkucg9vHdb6Nhn-o52UUccSA@mail.gmail.com>

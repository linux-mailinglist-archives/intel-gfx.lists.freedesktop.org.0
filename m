...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EA9762C648B
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:09:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9572A6EC49;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 042/162] drm/i915: Add igt_spinner_pin() to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F02A64AB006
	for <lists+intel-gfx@lfdr.de>; Sun,  6 Feb 2022 15:43:37 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B24CD10E65D;
	Sun,  6 Feb 2022 14:43:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5BA4C10E65D
 for <intel-gfx@lists.freedesktop.org>; Sun,  6 Feb 2022 14:43:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644158614; x=1675694614;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=at8WmnRwCHj79L5fw9m8vgSJmZ7oW9Ag7FB2evd3ncU=;
 b=htFuZW40rsL7At/15sygedIQHJFlbpYy1yTN9RjcF9NAkCrp/mSGzKdX
 fjVzR6eyHpQSj0m6mW7UZqFlfE4YLO2SOSB69MEJBelDxMtKy0YhfGWzL
 1vOgcQJZDQRaq1UxekSnRJ6v+smcNWoAqx5hrZXvYR54qLLGOSwR/5Yn4
 sLHHDO6fDbUjL6y0e8z7AROojS4S0+FLlBFAsR+9rTTbSslcceVfZswpl
 72vdgcY5uJ3EXP72pKBMCpSMyA5qkfFokGBPcY+T8qG8B3B2NbwPHqlrG
 3Ja2KRXbJQmrvqi6t+Tvr2M5hIFyiGGcDtFTJz5gxUeza5qs2kRlbxuSG Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10249"; a="334987569"
X-IronPort-AV: E=Sophos;i="5.88,347,1635231600"; d="scan'208";a="334987569"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2022 06:43:34 -0800
X-IronPort-AV: E=Sophos;i="5.88,347,1635231600"; d="scan'208";a="700183739"
Received: from srr4-3-linux-105-anshuma1.iind.intel.com ([10.223.74.179])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Feb 2022 06:43:31 -0800
From: Anshuman Gupta <anshuman.gupta@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sun,  6 Feb 2022 20:13:10 +0530
Message-Id: <20220206144311.5053-4-anshuman.gupta@intel.com>
...
Subject: [Intel-gfx] [PATCH 3/4] drm/i915/dgfx: OPROM OpRegion Setup

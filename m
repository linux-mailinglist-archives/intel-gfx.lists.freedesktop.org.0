...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F2E6C81F4A4
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Dec 2023 05:56:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A582310E1D6;
	Thu, 28 Dec 2023 04:56:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 64B1810E054;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=oH8dgCetHJZt2AHWnbnqZHDrZZ6XR7J4WLB+HTKs8rtsW+KR8pxlZQCd
 i7+tB01nFNV13EQwEqLVmWdKlyrvDC/xb4yg70qp2zFgCsE/DGLg4g+mf
 iltTmDy0CKzSj2rMCD3V6niTCt8ryKRxo7adny8sWQsTWHa9N+WUYqpvJ
 biE8RSmz/GhWxwab3/rhXxKb21yQU+DMUkad7lcUuYQYy0qdTHMzp17F6
 48hjcwfXRqTxFm7bxhDJj5gpirWVyoiO0op1vJpW3iXMUEDJfZb5EidQ/
 SMR6Lok0CcmQt/EZ/SBTID6kMHYYgd4KkoKMGd6CUZkQZW506u8hqV231 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10936"; a="460836825"
X-IronPort-AV: E=Sophos;i="6.04,311,1695711600"; d="scan'208";a="460836825"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Dec 2023 20:56:01 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10936"; a="728213015"
X-IronPort-AV: E=Sophos;i="6.04,311,1695711600"; d="scan'208";a="728213015"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga003.jf.intel.com with ESMTP; 27 Dec 2023 20:56:01 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH v9 2/2] drm/i915/guc: Close deregister-context race against
 CT-loss
Date: Wed, 27 Dec 2023 20:55:58 -0800
Message-Id: <20231228045558.536585-3-alan.previn.teres.alexis@intel.com>

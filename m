...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F28333AA84E
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Jun 2021 02:56:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 206066E192;
	Thu, 17 Jun 2021 00:55:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9A8CE6E192
 for <intel-gfx@lists.freedesktop.org>; Thu, 17 Jun 2021 00:55:56 +0000 (UTC)
IronPort-SDR: qG/Ra2jcBaH3lDm4Fcd45iMg5txFGDKhaPSd2mwz4w8UYuA4efxI7Puj2OPmZAo8XbvdOuAyH+
 gCCkh5ed+DRw==
X-IronPort-AV: E=McAfee;i="6200,9189,10017"; a="185973073"
X-IronPort-AV: E=Sophos;i="5.83,278,1616482800"; d="scan'208";a="185973073"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2021 17:55:35 -0700
IronPort-SDR: mzpodmWoCVDPKy+Z7aWo7rHC0y8l0kFHFvzQDKtXJAvqhNSp63XN9Xr2D/wkOo8JfAf2SXMfAm
 Bb10PdawwIlw==
X-IronPort-AV: E=Sophos;i="5.83,278,1616482800"; d="scan'208";a="452582584"
Received: from mdroper-desk1.fm.intel.com ([10.1.27.134])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Jun 2021 17:55:27 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 16 Jun 2021 17:55:16 -0700
Message-Id: <20210617005516.1866085-1-matthew.d.roper@intel.com>
X-Mailer: git-send-email 2.25.4
In-Reply-To: <20210616004213.1705079-4-matthew.d.roper@intel.com>
References: <20210616004213.1705079-4-matthew.d.roper@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 3/3] drm/i915: Add support for explicit
 L3BANK steering
...
index 80badc54b19d..3128ea476a98 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 718CF1B7605
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Apr 2020 14:54:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 983F889D86;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/5] drm/amdgpu: utilize subconnector property
 for DP through DisplayManager

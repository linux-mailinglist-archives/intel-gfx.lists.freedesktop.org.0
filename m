...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 548416EF732
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Apr 2023 17:03:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 98C4B10E9FD;
...
Subject: [Intel-gfx] [PATCH v10 09/22] vfio: Make vfio_device_open() single

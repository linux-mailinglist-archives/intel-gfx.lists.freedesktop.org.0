...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 050FC6D5E54
	for <lists+intel-gfx@lfdr.de>; Tue,  4 Apr 2023 12:55:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87CD210E201;
...
Subject: Re: [Intel-gfx] [PATCH v3 00/12] Introduce new methods for

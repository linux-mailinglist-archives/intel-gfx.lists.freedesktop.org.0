...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D2B194C5B43
	for <lists+intel-gfx@lfdr.de>; Sun, 27 Feb 2022 13:54:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9D53310E364;
...
Subject: Re: [Intel-gfx] [PATCH v6 1/4] drm/i915/guc: Add fetch of hwconfig
 table

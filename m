...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 96EFC4FE55F
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 17:54:07 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D965210E6C5;
...
Subject: [Intel-gfx] [PATCH 5/9] vfio: Pass in a struct vfio_device * to
 vfio_dma_rw()

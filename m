...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AC51E21FFFA
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:24:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D38246E9DB;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 1/3] dma-buf/sw_sync: Avoid recursive lock
 during fence signal.

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0C547B9BF4
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Oct 2023 10:55:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E801010E3D5;
	Thu,  5 Oct 2023 08:55:22 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 85E2610E3D5
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Oct 2023 08:55:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1696496121; x=1728032121;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=1R+nlMUdAXVOj0UznhIsIEjr6KZGq706aXqZQl1HjEc=;
 b=IRhkWdnYVPjFQsKD5P+DjQjr28Mr33esOUX1P0aO6RsX6wrx5sEV+XIC
 96AKxXopM8Oj8Vn5ghXc0sQxkJ09kVvbTJqDynOAchm0ZKoisqw0lNJEA
 GD/u+28tRnAcXIqs82XbkaKBQt5G62UbGiy6hrdYCLQ87kFrj/XQdRouX
 OFgafPFm5gFrsaBZyskUBPUnV9SA00BcheA9+ISZmVT+L7Zq/gLyX/EIE
 DBnpWU5OWVk3eaHy5J0g6Vwj89KKDLxcjZaZnFmTp5feFoXqlaMPgMXS3
 O8GW5XKRwp1eUCiatHW0yYEsSiNq39SW5VJqenoCNTso8V8nIyNGOYk/4 w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10853"; a="362810746"
X-IronPort-AV: E=Sophos;i="6.03,202,1694761200"; d="scan'208";a="362810746"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2023 01:55:20 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10853"; a="1082938751"
X-IronPort-AV: E=Sophos;i="6.03,202,1694761200"; d="scan'208";a="1082938751"
Received: from ijbeckin-mobl2.ger.corp.intel.com (HELO [10.213.192.200])
 ([10.213.192.200])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Oct 2023 01:55:00 -0700
Message-ID: <614711f0-f57d-2125-bc03-8708c86347f2@linux.intel.com>
Date: Thu, 5 Oct 2023 09:54:52 +0100
MIME-Version: 1.0
...
In-Reply-To: <20231004183625.1307100-2-jonathan.cavitt@intel.com>
...
> index 2cce5ec1ff00d..12f79abd889ce 100644
...
> +	 * any/all messages in the CT channel.  Ergo, keep a larger timeout that accounts

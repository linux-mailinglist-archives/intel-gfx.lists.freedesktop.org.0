...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC9EF425C24
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Oct 2021 21:39:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B13BE6F4E0;
...
Subject: [Intel-gfx] [PATCH v3 14/20] drm/i915: cleanup:

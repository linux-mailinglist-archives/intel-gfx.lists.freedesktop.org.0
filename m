...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02BC67C03DF
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Oct 2023 20:55:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 46F5F10E3BE;
	Tue, 10 Oct 2023 18:55:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 50CD110E3B4
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=mPilF+Or4CdU97qTD2bOatXUa9uq2aDeAH48Ie5aBuGbQf4jzLWMf9dy
 LylXnBQvuZl4EbdqLlJPpF/kLMaP7XcBaqRwS11bBK9hszfQaeTNbsdKS
 x0Ix8cpNCiw6arsnvbpNU+mMNDgiKg44J4pCtdAXFCx88Z9alEsUY7siV
 /1CPsqPCDlCr/dcujewm2bbFbgxtHB8PgckKIu5MiO6oe/pZlbjyzl8TU
 Dwyxxeed9nmKTjO89zZBlFExBvWzXIOlt/NBqYnhcUastGxslAJgEz/hT
 ZjxgtpJ+QIEi2grjBI7EH7DP+LvoXrm6SkfglXc4Z0TP8tQBDlzNi5ORx g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="364776804"
X-IronPort-AV: E=Sophos;i="6.03,213,1694761200"; d="scan'208";a="364776804"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 11:55:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10859"; a="757234878"
X-IronPort-AV: E=Sophos;i="6.03,213,1694761200"; d="scan'208";a="757234878"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Oct 2023 11:55:08 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Oct 2023 11:44:21 -0700
Message-Id: <20231010184423.2118908-11-jonathan.cavitt@intel.com>

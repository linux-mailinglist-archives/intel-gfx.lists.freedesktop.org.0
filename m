...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 334E98D284E
	for <lists+intel-gfx@lfdr.de>; Wed, 29 May 2024 00:53:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EFC6910E08F;
	Tue, 28 May 2024 22:53:18 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Ap1AbAgu";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E030310E6E2
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 May 2024 22:53:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 DfmFTJKpRaPO4wdelw5cvkqPLxnvnwH0JtPaGi+bXnXqBN19DH8Xbxkeu A==;
X-CSE-ConnectionGUID: aOKUrLwBRWuWQHxvL9dICg==
X-CSE-MsgGUID: z3qaOzPBQk2RNeDP2czpnw==
X-IronPort-AV: E=McAfee;i="6600,9927,11085"; a="17103890"
X-IronPort-AV: E=Sophos;i="6.08,196,1712646000"; d="scan'208";a="17103890"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 May 2024 15:53:16 -0700
X-CSE-ConnectionGUID: NB4h/+CDSMGRPlbu6gJ2fQ==
X-CSE-MsgGUID: 05V37d4xQ3eI9MAffiWS3w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,196,1712646000"; d="scan'208";a="58409729"
Received: from patelni-desk.amr.corp.intel.com (HELO localhost)
 ([10.2.132.135])
 by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 May 2024 15:53:14 -0700

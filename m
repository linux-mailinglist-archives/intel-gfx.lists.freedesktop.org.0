...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F71A6B08EE
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C941710E677;
...
Subject: [Intel-gfx] [PATCH v6 18/24] vfio-iommufd: Add detach_ioas support

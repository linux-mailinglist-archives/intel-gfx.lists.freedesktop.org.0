...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B728B37ADB4
	for <lists+intel-gfx@lfdr.de>; Tue, 11 May 2021 20:03:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B0A326EAAB;
	Tue, 11 May 2021 18:03:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7F5616EAAA;
 Tue, 11 May 2021 18:03:49 +0000 (UTC)
IronPort-SDR: EPMbiUWeJTINMONOl8ASKmcdSnjklrt5MiJYcWkgCID9q448F/hNK5d+XYc3xgPYya17eZ6wPK
 paC+MmNUpUtg==
X-IronPort-AV: E=McAfee;i="6200,9189,9981"; a="199189246"
X-IronPort-AV: E=Sophos;i="5.82,291,1613462400"; d="scan'208";a="199189246"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2021 11:03:48 -0700
IronPort-SDR: PXwxM95IqMkswP+d0T0uNDgeJyj5oGyTGseNDjCxXZQWW3vTOKOdHb0wlb/qi1dZE1Nv+e79t+
 9MrNSWu7ZiGg==
X-IronPort-AV: E=Sophos;i="5.82,291,1613462400"; d="scan'208";a="537128082"
Received: from unknown (HELO sdutt-i7) ([10.165.21.147])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 May 2021 11:03:47 -0700
Date: Tue, 11 May 2021 10:56:28 -0700
From: Matthew Brost <matthew.brost@intel.com>
To: Daniel Vetter <daniel@ffwll.ch>
Message-ID: <20210511175628.GA6561@sdutt-i7>
References: <20210506191451.77768-1-matthew.brost@intel.com>
 <20210506191451.77768-33-matthew.brost@intel.com>
 <YJqgPtRSISxZzHlw@phenom.ffwll.local>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <YJqgPtRSISxZzHlw@phenom.ffwll.local>

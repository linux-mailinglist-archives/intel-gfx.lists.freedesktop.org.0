...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id EE8742B3923
	for <lists+intel-gfx@lfdr.de>; Sun, 15 Nov 2020 21:24:19 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2CAA66E9C8;
	Sun, 15 Nov 2020 20:24:17 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1F44289F2D
 for <Intel-gfx@lists.freedesktop.org>; Sun, 15 Nov 2020 20:23:49 +0000 (UTC)
IronPort-SDR: VmFRtXmE/enF25/+TUXu/w+m5FSyc4yCXKX/R3E76NxCpSuDWzvH/2UrMXMKPLz6379f2Ybiwv
 Esz0+kOBkAYQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9806"; a="167165307"
X-IronPort-AV: E=Sophos;i="5.77,481,1596524400"; d="scan'208";a="167165307"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Nov 2020 12:23:48 -0800
IronPort-SDR: S5rB+2KM52CScj+8w0bVFKH1SvbYe4lBdhxd+A4+ug+WCPcSeRFxswZ1y54+g08pTLCnYlyhn9
 LAV0yVcwZwkw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,481,1596524400"; d="scan'208";a="430005348"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga001.fm.intel.com with ESMTP; 15 Nov 2020 12:23:47 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Sun, 15 Nov 2020 12:23:32 -0800
Message-Id: <20201115202347.29224-12-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201115202347.29224-1-sean.z.huang@intel.com>
References: <20201115202347.29224-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [PATCH 12/27] drm/i915/pxp: Func to send hardware
 session termination

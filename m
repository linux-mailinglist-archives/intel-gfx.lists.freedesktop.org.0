...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EDC22675D09
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Jan 2023 19:49:23 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 21B9C10EAF8;
	Fri, 20 Jan 2023 18:49:22 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v8 7/8] drm/i915/opregion: convert

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D4C1D68247C
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Jan 2023 07:36:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7238B10E32C;
	Tue, 31 Jan 2023 06:36:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 435AF10E32B
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Jan 2023 06:36:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675146973; x=1706682973;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=G31hQ2nFzNwYp6smpqLKDViSiI5w1ex36495uWHfpDE=;
 b=DiADc8YPaCVGFgulIpx0ZkzZkzbALCwY3w+xOAHH+Z/3qjd0j1mAyPYD
 l65FZB2EAxX23XqPT5/tHyJuSCRtiUDAr75jCvOEMiTJiTr0fjffFwPlW
 FOHbpEtEFfAgFoWYvhhGGQOF2ihSCdLLU0jRunOBEPRfQkHtbQXsOoFpt
 YtBm7u+vHgJlotlwgdWDLBpibcIC/TInJ//k6mCtNzzJcD5A9jYrh+V5b
 TKADuZHjI6x/M2oMdxScSl5D4A8KK3um+iB+cBZkqbAUWJmbQ3m14CSVT
 4AiBBcoyVbQ7RTDsW5dqlclvxkIUfg9s/LPO10nt9TkAJGXvwKWBXngx6 A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10606"; a="390126827"
X-IronPort-AV: E=Sophos;i="5.97,259,1669104000"; d="scan'208";a="390126827"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Jan 2023 22:36:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10606"; a="838248506"
X-IronPort-AV: E=Sophos;i="5.97,259,1669104000"; d="scan'208";a="838248506"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga005.jf.intel.com with ESMTP; 30 Jan 2023 22:36:09 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 31 Jan 2023 12:03:40 +0530
Message-Id: <20230131063342.2811275-5-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 4/6] drm/i915/hdcp: Refactor HDCP API
 structures

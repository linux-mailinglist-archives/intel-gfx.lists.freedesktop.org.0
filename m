...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F2E5417D00
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Sep 2021 23:29:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C13D6EE84;
	Fri, 24 Sep 2021 21:29:38 +0000 (UTC)
...
X-Mailman-Approved-At: Fri, 24 Sep 2021 21:29:37 +0000
Subject: Re: [Intel-gfx] [PATCH v2 3/9] vfio/ccw: Convert to use

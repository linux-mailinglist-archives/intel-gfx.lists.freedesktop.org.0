...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 059A91DB46F
	for <lists+intel-gfx@lfdr.de>; Wed, 20 May 2020 15:01:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7C3D16E82B;
	Wed, 20 May 2020 13:00:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C508889DFE
 for <intel-gfx@lists.freedesktop.org>; Wed, 20 May 2020 13:00:46 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 20 May 2020 15:00:19 +0200
Message-Id: <20200520130030.1014994-12-maarten.lankhorst@linux.intel.com>
...
@@ -3263,7 +3263,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3425,20 +3428,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3446,9 +3452,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3474,8 +3480,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -5392,13 +5400,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -5431,8 +5439,10 @@ static void virtual_context_exit(struct intel_context *ce)

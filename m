...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B27F950E58C
	for <lists+intel-gfx@lfdr.de>; Mon, 25 Apr 2022 18:23:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EC28310E57C;
	Mon, 25 Apr 2022 16:23:35 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 0/4] Flat-CCS eviction enhancements

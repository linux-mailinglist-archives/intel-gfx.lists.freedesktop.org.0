...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B86021EFAB
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 13:45:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A55566E959;
	Tue, 14 Jul 2020 11:45:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 76CC46E8B5
 for <intel-gfx@lists.freedesktop.org>; Tue, 14 Jul 2020 11:45:21 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 14 Jul 2020 13:45:00 +0200
Message-Id: <20200714114516.3073222-7-maarten.lankhorst@linux.intel.com>
...
@@ -2047,12 +2024,9 @@ static int eb_move_to_gpu(struct i915_execbuffer *eb)
...
@@ -2348,7 +2322,6 @@ static int eb_parse(struct i915_execbuffer *eb)
...
@@ -2845,6 +2818,8 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -3021,6 +2996,8 @@ i915_gem_do_execbuffer(struct drm_device *dev,
 	if (batch->private)
...
+		eb_release_vmas(&eb);
 	...
 	eb_unpin_engine(&eb);
@@ -3038,7 +3015,7 @@ i915_gem_do_execbuffer(struct drm_device *dev,
...
@@ -3094,7 +3071,7 @@ i915_gem_execbuffer_ioctl(struct drm_device *dev, void *data,
...
+	exec2_list = kvmalloc_array(count + 1, eb_element_size(),
 	...
 	if (exec_list == NULL || exec2_list == NULL) {
 		drm_dbg(&i915->drm,
@@ -3172,7 +3149,8 @@ i915_gem_execbuffer2_ioctl(struct drm_device *dev, void *data,
 	if (err)
 		return err;

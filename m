...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BEEB91641DF
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Feb 2020 11:23:48 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 78C076EB9E;
	Wed, 19 Feb 2020 10:22:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-wr1-x443.google.com (mail-wr1-x443.google.com
 [IPv6:2a00:1450:4864:20::443])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 71DAD6EB86
 for <intel-gfx@lists.freedesktop.org>; Wed, 19 Feb 2020 10:22:34 +0000 (UTC)
Received: by mail-wr1-x443.google.com with SMTP id c9so27557544wrw.8
 for <intel-gfx@lists.freedesktop.org>; Wed, 19 Feb 2020 02:22:34 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=B12jRCkGMmiSosRXSdc1RZTltXwvvK59ZEjFRkrQsBw=;
 b=konApcpiwrBYsvI2Wlns2QKjm+liakXMAxblTvOumDnJfcADXqxvvoQkw1ar8+bn0T
 SFvHtnONGw3L/HFbrF3+4worsMfNcwmtUV25r0W/qfrgFanFq9iYxdhXJH6H4JaQ/WA1
 MdmCtO23sQ0qMbAJw5PAvuj6ADMcK+tCEIayA=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references:mime-version:content-transfer-encoding;
 bh=B12jRCkGMmiSosRXSdc1RZTltXwvvK59ZEjFRkrQsBw=;
 b=
X-Gm-Message-State: APjAAAVvdO4dzHtym26aLySJGw6sgebQjqjpN5ArxJdXD4OWGXIRbhRH
 kMuSYf/57X4WObKkv6ZmA6zc0A==
X-Google-Smtp-Source: APXvYqx1ITjkuYDaCPWuMniZDEEoVfPPH7veifiI3QUjCL/2PiVa6GDf/md33mO2rNuZ6a94pfV0Mg==
X-Received: by 2002:a5d:66cc:: with SMTP id k12mr34157902wrw.72.1582107752481; 
 Wed, 19 Feb 2020 02:22:32 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id s23sm2370339wra.15.2020.02.19.02.22.31
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 19 Feb 2020 02:22:31 -0800 (PST)
From: Daniel Vetter <daniel.vetter@ffwll.ch>
To: DRI Development <dri-devel@lists.freedesktop.org>
Date: Wed, 19 Feb 2020 11:21:22 +0100
Message-Id: <20200219102122.1607365-53-daniel.vetter@ffwll.ch>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20200219102122.1607365-1-daniel.vetter@ffwll.ch>
References: <20200219102122.1607365-1-daniel.vetter@ffwll.ch>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 52/52] drm: Add docs for managed resources

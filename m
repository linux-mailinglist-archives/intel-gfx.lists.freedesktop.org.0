...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A68B5607BBD
	for <lists+intel-gfx@lfdr.de>; Fri, 21 Oct 2022 18:06:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BDF8E10E1E3;
	Fri, 21 Oct 2022 16:06:23 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v4] overflow: Introduce overflows_type() and
 castable_to_type()

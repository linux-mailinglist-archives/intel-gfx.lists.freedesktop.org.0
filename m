...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 188735FEE35
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Oct 2022 14:53:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BEBB110EAD9;
	Fri, 14 Oct 2022 12:53:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 62FF610EADE
 for <intel-gfx@lists.freedesktop.org>; Fri, 14 Oct 2022 12:52:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665751938; x=1697287938;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=eJW0uvmpDM6QcbL76N4Ngy8sZwhWAvdqzN2DXSycXUQ=;
 b=S4mBM8QG90CLG96IyEJPto0AqRcDYDPPb8yEJuDkNhClus/GEj+3fkmX
 YocwL0s3q2JgcA6wXQP5z2VWPumnRUiu2L11BaMXt4PKPuYcmQuvh4wz9
 BzftPTpHs0h/UVHcCz2J3jF6Azf39vGq7xgVxlUJ493dRqX2PxYlmT60u
 SJFx7MCHBKIlAqksKFbGDC0abdXCL1Jk6vy/IeXZq2wUGSl2cM5jsCZDa
 S2HPy7dKJyl+6OX1RmXugjWRIdA6GQoPD1pW7TlHmJ6mWE/Wn3PgpG4N1
 kYqVt2xSBup/c/zpBCaisDRwkEw2N96ICBDMctfd3i5dcFEuTYrpiiOCa g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10500"; a="304104682"
X-IronPort-AV: E=Sophos;i="5.95,184,1661842800"; d="scan'208";a="304104682"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2022 05:52:18 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10500"; a="716739816"
X-IronPort-AV: E=Sophos;i="5.95,184,1661842800"; d="scan'208";a="716739816"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by FMSMGA003.fm.intel.com with ESMTP; 14 Oct 2022 05:52:16 -0700
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 14 Oct 2022 15:47:37 +0300
Message-Id: <20221014124740.774835-18-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH 17/20] drm/i915/mtl: MTL PICA hotplug detection

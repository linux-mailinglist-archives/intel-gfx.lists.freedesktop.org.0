...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C2A1620A06
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Nov 2022 08:22:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AAC9410E223;
	Tue,  8 Nov 2022 07:21:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C121010E20B
 for <intel-gfx@lists.freedesktop.org>; Tue,  8 Nov 2022 07:21:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1667892108; x=1699428108;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=XuH0Pk87J1MM5Caeae9SA5yVjFkwDPisPJxmNSjm5XA=;
 b=MeUWvjSb0O50jgpPVVk7+uyrqIoSJvj++1yDTPN+H9AfeiLs4Wcjfs0M
 nFqY8HchC6Bqhl59iEbUK+owWnfZbVmDq3l51Uc7QfE4NAlPmet1kabUr
 HsFZdkZNdL+U9MghkQydr1I9c9gXVG6ylR86f6sZ4DyFpFuQVIf18+8FC
 i0WLRjtTnOH/o9G6OSQB7BySCN+6uNvUvsHsUUibPqivSRaGOwlKm6TSG
 zAlESpuJD4SaGPN3wWCvr4JhttAcE1aQWW014URQouIZTIAj36Q/pGGi3
 +vORM6PrRvvTLx+RE3OmZ2fhP5RvbzdGg97KXGnmrW88Gswt9YbUxegYr g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="374899053"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="374899053"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Nov 2022 23:21:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="725462795"
X-IronPort-AV: E=Sophos;i="5.96,147,1665471600"; d="scan'208";a="725462795"
Received: from lkp-server01.sh.intel.com (HELO e783503266e8) ([10.239.97.150])
 by FMSMGA003.fm.intel.com with ESMTP; 07 Nov 2022 23:21:44 -0800
Received: from kbuild by e783503266e8 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1osIvX-000084-37;
 Tue, 08 Nov 2022 07:21:44 +0000
Date: Tue, 8 Nov 2022 15:21:27 +0800
From: kernel test robot <lkp@intel.com>
To: Matthew Auld <matthew.auld@intel.com>, intel-gfx@lists.freedesktop.org
Message-ID: <202211081158.sdHdAOBv-lkp@intel.com>
References: <20221107173435.68116-1-matthew.auld@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="CFQHL+YFPnQwL6CN"
...
204129a211fc48 Michał Winiarski  2022-01-05   75  	gtt_entries = (gen8_pte_t __iomem *)to_gt(dev_priv)->ggtt->gsm +
...
9f674c811740b5 Tina Zhang        2019-12-13   79  			GEN8_DECODE_PTE(readq(&gtt_entries[i]));

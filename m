...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A55F3910A7
	for <lists+intel-gfx@lfdr.de>; Wed, 26 May 2021 08:25:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BCB326EC0F;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/18] drm/i915/guc: Replace CTB array with
 explicit members

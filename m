...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FCB455FBE5
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Jun 2022 11:28:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5592D11A408;
...
Subject: [Intel-gfx] [CI RESEND 01/10] drm/edid: move

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C64083B27A6
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Jun 2021 08:48:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 091566EA1B;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 08/47] drm/i915/guc: Add new GuC interface

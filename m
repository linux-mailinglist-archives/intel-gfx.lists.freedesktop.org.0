...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 26258A2A411
	for <lists+intel-gfx@lfdr.de>; Thu,  6 Feb 2025 10:20:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EB8510E148;
	Thu,  6 Feb 2025 09:20:40 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="GIDA5aMh";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CE71910E23E
 for <intel-gfx@lists.freedesktop.org>; Thu,  6 Feb 2025 09:20:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1738833355;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type;
 bh=cBpkQqMp21fLUhKTK5jGY7lbW4XpJn/i1fWLlJEEw4E=;
 b=GIDA5aMhapeMHOCgOicOl5WkbkpdVRu6eMCr9y/OIMpiyyYtkCFCCOt7oIiX2IfCqH2piF
 XvmPYpI8wVY34eiBKXkfUVf1G4txzKGRSMq3Mvv4fkhyhidRaaDW148JmYY9RPuwL8dPRB
 jDZjzXZlDOH3+eNeBLw/k8IGjEYXY7A=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-426-EsamD4FOM8-c9AKUMoDQ_w-1; Thu, 06 Feb 2025 04:15:47 -0500
X-MC-Unique: EsamD4FOM8-c9AKUMoDQ_w-1
X-Mimecast-MFC-AGG-ID: EsamD4FOM8-c9AKUMoDQ_w
Received: by mail-wr1-f71.google.com with SMTP id
 ffacd0b85a97d-38db47fd683so450628f8f.0
 for <intel-gfx@lists.freedesktop.org>; Thu, 06 Feb 2025 01:15:47 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1738833346; x=1739438146;
 h=content-disposition:mime-version:message-id:subject:cc:to:from:date
 :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
 bh=cBpkQqMp21fLUhKTK5jGY7lbW4XpJn/i1fWLlJEEw4E=;
 b=
X-Forwarded-Encrypted: i=1;
 AJvYcCUWiYb13d62WqIIZ7oMXu7SzBtoOwwdLsKY4RwrbcN0rhXD3clUv8IXA0QIs3gYqaRxrso71vVVlD8=@lists.freedesktop.org
X-Gm-Message-State: AOJu0YwzHvYdKjdQ70fkKyp2nuGKBUH+HLWreT0Ckzw0QkZkDiO/HBAK
 chO17QYhCd5HQlxljGryRW0ehAbEC/dYbWWVQahQmwo6C0+HI82QN8JWndQLCrNujIfQJSEoGgO
 MKWoks5JIwKdRTqegAbS2K8dpLvMTf7RcerBk2AL6+O/7cKwWto/hkbQ6a+RtwXkP8XjgGNgKpg
 ==
X-Gm-Gg: ASbGncuvoFdTZeGTy3exGg9GBSIA+vZwg3c34/TpEpy8ZDggRqtkCwzxp5x75VYRRkr
 a/VoKcUt7THzbAiUBp/x5Y/nGbuTikZ5sD9HqGa7x+yhIXeBtz0hv7+G/NuGD+1WpsXokBDFv1J
 FHt5hsYYdoulCttFctvesmMGIzxEXfEgJlRRBl+r08V6mBcqfxbYvb7YXRiZAzSGDudsunWPk7I
 P1KFQ3Ggm3Z5ta3rm4KszJNgHm1qOR78KOv9H5iqsBssgoAliaKZ6bH
X-Received: by 2002:a5d:53ce:0:b0:38d:a713:8e4e with SMTP id
 ffacd0b85a97d-38db48fde8bmr3480949f8f.47.1738833344686; 

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB3764C0C5C
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Feb 2022 06:59:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B3A3C10E9E6;
	Wed, 23 Feb 2022 05:59:21 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v11 6/6] drm/i915/gt: replace cache_clflush_range

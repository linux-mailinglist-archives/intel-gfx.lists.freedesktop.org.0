...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ECC4C618CCA
	for <lists+intel-gfx@lfdr.de>; Fri,  4 Nov 2022 00:32:31 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6BB3810E6E9;
...
Subject: Re: [Intel-gfx] [PATCH v2 6/7] vfio/ccw: replace vfio_init_device
 with _alloc_

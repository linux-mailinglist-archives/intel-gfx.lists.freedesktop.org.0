...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84F906B08D1
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Mar 2023 14:29:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6924410E60B;
...
Subject: [Intel-gfx] [PATCH v6 09/24] vfio/pci: Only need to check opened
 devices in the dev_set for hot reset

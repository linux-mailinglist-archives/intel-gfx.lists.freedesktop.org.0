...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C2589BE520B
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Oct 2025 20:54:53 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDBA510EA6A;
	Thu, 16 Oct 2025 18:54:51 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PauZe8oG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5D8C710EA63;
 Thu, 16 Oct 2025 18:54:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1760640890; x=1792176890;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=gexOUJ666U6xjWegQhQyWwDIxZhioRJe5k+J7TeBw9Y=;
 b=PauZe8oGaD3N8i0/j7enyuTSiEislbgyw8oi3j6ehQ7VJLl85RGVIl7M
 g9Mg8oIEAG8CJMbhdZ3ZLFjkhEhcWQFwLNaxY2Mbij1gOjYRZ8aObePJw
 +ZgTwHqCUXi95ElmviZ9enIWCfnCrBnDPhpe6l5xvkwFM8deupGVURIrZ
 NDJ/0ZbgSTof1Gcx7lzHVwKScCzDL2JSxkGbEYjd/x0cBocqxrUklNCy+
 KPKRmEmIUxxz/8Cvxgja6+CxstHlWpY2yvIXb5FB2ejTYiP1ma1/W2gw9
 M3u9yqVfWTmPjgjk9tSiC95iB5fVOBtHbO4NpCd5BEk/dADt/tjdHJGOu g==;
X-CSE-ConnectionGUID: Af3hBrjQTImkJoqkGaAABg==
X-CSE-MsgGUID: zxO6+q+YTi6Ig64kWDN37Q==
X-IronPort-AV: E=McAfee;i="6800,10657,11531"; a="62755600"
X-IronPort-AV: E=Sophos;i="6.17,312,1747724400"; d="scan'208";a="62755600"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
 by orvoesa113.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Oct 2025 11:54:50 -0700
X-CSE-ConnectionGUID: 5lUkkJFSQbqu6gdCjwH0lA==
X-CSE-MsgGUID: /l3Fql7XQJKvDMsQyA7qOg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.19,234,1754982000"; d="scan'208";a="219687982"
Received: from kniemiec-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.244.12])
 by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Oct 2025 11:54:48 -0700
From: Ville Syrjala <ville.syrjala@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Cc: intel-xe@lists.freedesktop.org,
	Jani Nikula <jani.nikula@intel.com>
Subject: [PATCH v2 09/10] drm/i915/frontbuffer: Fix intel_frontbuffer lifetime
 handling
Date: Thu, 16 Oct 2025 21:54:07 +0300
Message-ID: <20251016185408.22735-10-ville.syrjala@linux.intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A9F1687778
	for <lists+intel-gfx@lfdr.de>; Thu,  2 Feb 2023 09:32:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DB07889E69;
	Thu,  2 Feb 2023 08:32:26 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DD3CE89E69;
 Thu,  2 Feb 2023 08:32:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1675326744; x=1706862744;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=7YBsARknMAn5FiQbORHxOfSxxICT/rfTozsHhHd+WuU=;
 b=fNaO6LYWmyEKOPDIcbrWV1w5dTQY6HYIwDffiDNnXkChZirVoU06GpHw
 EMBe59dCJsH1T4oiApINQipDdEJpxLVEx5Qdm8K/VA6X2NMT+GLTfSRpx
 06KNhi2U4CdyWNXOFvEn6CSdF4ZPyQyXQuDp8IhQejhZpdMiDJClOvlx5
 RhQ/DKrOsmxEa2FuUfCYf+HaoUkwFxx5k9yt6ZSLvcuo/t2Mc0DccZEL9
 cOeiFktzVQayz7wXPnUKCQeO7JWBBcu0LfAlMyqL1bO1dmuuJtHcbwyGU
 U98daUSBs0QskgDWz3bb0HWYTbQ7Gq7WW591RFFfFO18hA49zT6ooW3eS A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="308731242"
X-IronPort-AV: E=Sophos;i="5.97,266,1669104000"; d="scan'208";a="308731242"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Feb 2023 00:32:24 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10608"; a="993996077"
X-IronPort-AV: E=Sophos;i="5.97,266,1669104000"; d="scan'208";a="993996077"
Received: from stirulak-mobl3.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.213.219.106])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Feb 2023 00:32:22 -0800
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org,
	dri-devel@lists.freedesktop.org
Date: Thu,  2 Feb 2023 08:32:18 +0000
Message-Id: <20230202083218.4100760-1-tvrtko.ursulin@linux.intel.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v4] drm/i915: Consolidate TLB invalidation flow
...
index d4e29da74612..0d932d943257 100644

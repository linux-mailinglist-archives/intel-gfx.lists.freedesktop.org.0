...
Received: from mail.lfdr.de
	...
	id Cv+qLVG2RWrsEAsAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 02 Jul 2026 02:52:33 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDF016F2B1F
	for <lists+intel-gfx@lfdr.de>; Thu, 02 Jul 2026 02:52:32 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=none;
	dmarc=none;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CDCD110EF99;
	Thu,  2 Jul 2026 00:52:30 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 6beec6c84f66 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6922710F13D;
 Thu,  2 Jul 2026 00:52:29 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============5790847591918927503=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=93_i915=2ECI=2EBAT=3A_success_for_drm/i915/display=3A_Handl?=
 =?utf-8?q?e_struct_drm=5Fplane=5Fstate=2Eignore=5Fdamage=5Fclips?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Thomas Zimmermann" <tzimmermann@suse.de>
Cc: intel-gfx@lists.freedesktop.org
Date: Thu, 02 Jul 2026 00:52:29 -0000
Message-ID: <178295354940.140995.4857723705107442591@6beec6c84f66>
...
X-Spamd-Result: default: False [5.89 / 15.00];
	...
	MISSING_XM_UA(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.freedesktop.org:replyto,lists.freedesktop.org:from_smtp,gabe.freedesktop.org:rdns,gabe.freedesktop.org:helo,6beec6c84f66:mid,01.org:url,patchwork.freedesktop.org:url]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: CDF016F2B1F
...
CI Bug Log - changes from CI_DRM_18747 -> Patchwork_169627v1
====================================================
...
-------
  ...
  **SUCCESS**
  ...
  External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169627v1/index.html
...
------------
  ...
  Here are the changes found in Patchwork_169627v1 that come from known issues:
...
#### Possible fixes ####
  ...
  * igt@i915_selftest@live@sanitycheck:
   ...
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169627v1/bat-apl-1/igt@i915_selftest@live@sanitycheck.html
  ...
  * igt@kms_pm_rpm@basic-pci-d3-state:
   ...
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169627v1/bat-apl-1/igt@kms_pm_rpm@basic-pci-d3-state.html
...
<tr><td><b>State:</b></td><td>success</td></tr>
    ...
    <h1>CI Bug Log - changes from CI_DRM_18747 -&gt; Patchwork_169627v1</h1>
<h2>Summary</h2>
<p><strong>SUCCESS</strong></p>
<p>No regressions found.</p>
<p>External URL: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169627v1/index.html</p>
<h2>Participating hosts (42 -&gt; 39)</h2>
<p>Missing    (3): bat-dg2-13 fi-glk-j4005 fi-snb-2520m </p>
<h2>Known issues</h2>
<p>Here are the changes found in Patchwork_169627v1 that come from known issues:</p>
<h3>IGT changes</h3>
...
<p>CI-20190529: 20190529<br />
  ...
  Patchwork_169627v1: 5394116badd62f96fbe40313704b555dac73379d @ git://anongit.freedesktop.org/gfx-ci/linux</p>

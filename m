...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 58FD150ED89
	for <lists+intel-gfx@lfdr.de>; Tue, 26 Apr 2022 02:21:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 07EA110EF37;
	Tue, 26 Apr 2022 00:21:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 61B8E10EEF3
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=FTXeKwcryNUAypG3e+rDtrhmeY0JxBmGN7sXBCyr0w0=;
 b=H1glc0nf8nukv0+Yyvh1ufddYTgV90Fw1pxgYfNzcm1Vsu96ks1OKQNT
 aw6WhukW+f+jkT12ruMc+N0IiGbkYKau34jKWGQAW5PG17RiI4BGJeQe+
 XJKOg6MqG4Kq5nf8unePMvCrEBTo0xfSDJc8pflSACNE6Jpbb8sjC8whC
 jvBF4lMbaHZHYLbtQ5/fHqPwSgCMw67WuPriSW3GvAZ+hn1ayyh0iTJhy
 Wpgtama1w0csLdqLU4lDjJxm7h1scmxiC77ADWQCAfE+1+vEtdWqULiq1
 tYh07nDDiujV5R+HgjIXispAJqXQ9AF8JYW0ddOPuhu3vpm1ZjjhIv8kc A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10328"; a="262997459"
X-IronPort-AV: E=Sophos;i="5.90,289,1643702400"; d="scan'208";a="262997459"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2022 17:21:04 -0700
X-IronPort-AV: E=Sophos;i="5.90,289,1643702400"; d="scan'208";a="564318296"
...
Date: Mon, 25 Apr 2022 17:20:56 -0700
Message-Id: <998e98a30d4369dbc4625a79cce91ead27093d80.1650931855.git.ashutosh.dixit@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/2] drm/i915/gt: Add media freq factor to
 per-gt sysfs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 99A7569513D
	for <lists+intel-gfx@lfdr.de>; Mon, 13 Feb 2023 21:00:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F26E410E6FE;
	Mon, 13 Feb 2023 20:00:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8FB7310E704
 for <intel-gfx@lists.freedesktop.org>; Mon, 13 Feb 2023 20:00:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1676318435; x=1707854435;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=L51fUTRGFPdRer6qCDwv74puDN/5ZGJaM/bfx+GlF0E=;
 b=mb84TvpmfwgAjwaOTUKw706w41JIVRaKCw4tlOWfuJc8eaKG2uWH96V7
 9eyVIFFtOfRAjfozReMPuAc0Kb/BwK39B860bpvh3f4v7Ntldtwdue1Uv
 iuFcLw++dj6Xhr4Jwie/QyTUa96HilX3kW3uTnhyIFupLsDcw7uoZu1ME
 vJTeekwbAC1Mtr2w8AffL8GYtQ4N4xmCbG2cXZi6QPNzGf6BFaaAYzWI9
 xgOBfRvQt+fis05GPBRg//et4U/wVWiyDddvyngVgKI3xUcHUwDacm4xv
 k4I/hyNGBw0bRerKLzYm5xeax+xqhy+8b7Fn4vEtFg8qOuIR0c7xfvxN+ w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10620"; a="319012257"
X-IronPort-AV: E=Sophos;i="5.97,294,1669104000"; d="scan'208";a="319012257"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2023 12:00:35 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10620"; a="732611888"
X-IronPort-AV: E=Sophos;i="5.97,294,1669104000"; d="scan'208";a="732611888"
Received: from tkatila-mobl.ger.corp.intel.com (HELO localhost)
 ([10.252.50.147])
 by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2023 12:00:33 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 13 Feb 2023 21:59:59 +0200
Message-Id: <6da32831e40606cc8b90491b83196917f2ce36ab.1676317696.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 4/7] drm/i915/wm: add .get_hw_state to
 watermark funcs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C10178B9F4
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Aug 2023 23:06:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00C0210E35D;
	Mon, 28 Aug 2023 21:06:48 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 2/3] drm/i915/guc: Close

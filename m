...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 20903219F9A
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Jul 2020 14:07:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6A4356EA51;
	Thu,  9 Jul 2020 12:07:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 641C46E0B8
 for <intel-gfx@lists.freedesktop.org>; Thu,  9 Jul 2020 12:07:04 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 21764670-1500050 for multiple; Thu, 09 Jul 2020 13:07:03 +0100
MIME-Version: 1.0
...
Date: Thu, 09 Jul 2020 13:07:00 +0100
Message-ID: <159429642039.22162.913189691410719231@build.alporthouse.com>
User-Agent: alot/0.9

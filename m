...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2789EAB4BE3
	for <lists+intel-gfx@lfdr.de>; Tue, 13 May 2025 08:26:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED22C10E32D;
	Tue, 13 May 2025 06:26:09 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from c664b1dc75d1 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 19BC410E2E4;
 Tue, 13 May 2025 06:26:08 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============9211017833901226045=="
MIME-Version: 1.0
...
Date: Tue, 13 May 2025 06:26:08 -0000
Message-ID: <174711756808.72432.4660504646424770691@c664b1dc75d1>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_147799v5 absolutely need to be
  verified manually.
  
  If you think the reported changes have nothing to do with the changes
  introduced in Patchwork_147799v5, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_147799v5:
...
#### Possible regressions ####
  ...
  * igt@i915_selftest@live:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_16537/bat-arls-5/igt@i915_selftest@live.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_147799v5/bat-arls-5/igt@i915_selftest@live.html
...
#### Issues hit ####
  ...
  * igt@i915_selftest@live:
   ...
   [3]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_16537/bat-mtlp-8/igt@i915_selftest@live.html
   [4]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_147799v5/bat-mtlp-8/igt@i915_selftest@live.html
...
<p>Serious unknown changes coming with Patchwork_147799v5 absolutely need to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br />
  introduced in Patchwork_147799v5, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them<br />
...
<p>Here are the unknown changes that may have been introduced in Patchwork_147799v5:</p>
<h3>IGT changes</h3>
<h4>Possible regressions</h4>
<ul>
<li>igt@i915_selftest@live:<ul>
<li>bat-arls-5:         <a href="https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_16537/bat-arls-5/igt@i915_selftest@live.html">PASS</a> -&gt; <a href="https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_147799v5/bat-arls-5/igt@i915_selftest@live.html">INCOMPLETE</a> +1 other test incomplete</li>
</ul>
</li>
</ul>
<h2>New tests</h2>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 80BB76D2B09
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 00:12:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AD3B610F315;
	Fri, 31 Mar 2023 22:12:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yw1-x112d.google.com (mail-yw1-x112d.google.com
 [IPv6:2607:f8b0:4864:20::112d])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 97B6E10F322
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Mar 2023 22:12:34 +0000 (UTC)
Received: by mail-yw1-x112d.google.com with SMTP id
 00721157ae682-5445009c26bso440865517b3.8
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Mar 2023 15:12:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1680300753;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=KGWBW0N4NonXKaIWSKFcT4WomZXqyg0VzoGbzGAYyBo=;
 b=fbMEd53sK6q7KjE6JD4ndvalxfBIi1nbGLrEhaIPBebqxs5N8pT149DYwCkrdOScnL
 Dvgf5IA9xsZcm9DP19J/sZv1wsXI3vQk4jwbicUE4SbP6tozZFV2A4LnhSKk9y71EF4g
 +uYy3PREh0OyUwf175+MdCHfVjG8YJkK0bvkE=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1680300753;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=KGWBW0N4NonXKaIWSKFcT4WomZXqyg0VzoGbzGAYyBo=;
 b=
X-Gm-Message-State: AAQBX9cioUt6aYEJ+zFhV2pweYr0iWUEr1Mbwwk2WThrqPkBaSRlbJ30
 fV/7WZ4lDVnQIgYiQ25cMLCjww==
X-Google-Smtp-Source: AKy350aMgTKj6DQocCDet4ZW0/pB7v+o3fhf/4ZpkXBF8K7uEmPufEdyBuZ8oQ8pFhhGNsljk0g8vg==
X-Received: by 2002:a0d:db49:0:b0:541:85ea:588b with SMTP id
 d70-20020a0ddb49000000b0054185ea588bmr28003160ywe.26.1680300752641; 
 Fri, 31 Mar 2023 15:12:32 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:a8f6:869a:3ef5:e1d])
 by smtp.gmail.com with UTF8SMTPSA id
 x36-20020a81af64000000b00546213438d6sm787588ywj.120.2023.03.31.15.12.31
...
Date: Fri, 31 Mar 2023 18:12:09 -0400
Message-Id: <20230331221213.1691997-8-markyacoub@google.com>
...
Subject: [Intel-gfx] [PATCH v8 07/10] drm/i915/hdcp: Use HDCP helpers for
 i915

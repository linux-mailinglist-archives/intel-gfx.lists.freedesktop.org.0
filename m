...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 061891AF556
	for <lists+intel-gfx@lfdr.de>; Sun, 19 Apr 2020 00:23:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5333C6E10B;
	Sat, 18 Apr 2020 22:23:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 05E076E02E
 for <intel-gfx@lists.freedesktop.org>; Sat, 18 Apr 2020 22:23:31 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20946478-1500050 
 for <intel-gfx@lists.freedesktop.org>; Sat, 18 Apr 2020 23:23:27 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Sat, 18 Apr 2020 23:23:26 +0100
Message-Id: <20200418222327.23199-2-chris@chris-wilson.co.uk>
...
index a5b139076e06..680296407874 100644
--- a/drivers/gpu/drm/i915/gt/selftest_rps.c
+++ b/drivers/gpu/drm/i915/gt/selftest_rps.c
@@ -482,26 +482,21 @@ static u64 __measure_power(int duration_ms)
...
@@ -539,7 +534,10 @@ int live_rps_power(void *arg)
...
+		} min, max;
 		...
 		if (!intel_engine_can_store_dword(engine))
 			continue;
@@ -562,16 +560,27 @@ int live_rps_power(void *arg)
 			break;
 		}

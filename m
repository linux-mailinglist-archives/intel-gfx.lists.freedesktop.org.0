...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DB5E345ECE2
	for <lists+intel-gfx@lfdr.de>; Fri, 26 Nov 2021 12:46:45 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A9FFE6E849;
...
Subject: [Intel-gfx] [PATCH v3 2/2] i915/gvt: save the MMIO snapshot in the
 early init of GVT-g

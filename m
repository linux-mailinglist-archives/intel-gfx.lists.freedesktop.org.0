...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 104BC9E3CC5
	for <lists+intel-gfx@lfdr.de>; Wed,  4 Dec 2024 15:31:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9E31D10ED45;
	Wed,  4 Dec 2024 14:31:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="PPJD9Ifq";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3119210E53E;
 Wed,  4 Dec 2024 14:31:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1733322704; x=1764858704;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=HTWO312KR4C6cq2PyX6O42TCk5OSpo8Ejn1R3BrxEG0=;
 b=PPJD9IfqxHGWB560lrHeLoekqBofZRIZaMAZrKNrSpHoA80Q+mCK47eO
 y8YsA7/HkZU8hJKKjr0hB5PoxrM+X3p0EK8q1Idpu/eIAKMkiBvdnW2QA
 vWZ66MmLa0ANB+UE/naZ/7Je8vGUBVYnIcMnIMOsTd+M7k48NL0BL52BX
 MV/L4tP8yDULF+oZC5ZzDZIQP/idF2jFc/lk2mOwDWguwVlP0LyOnk+Ci
 4IzBtvww1QnRzumSyA3gKE0V2OZerG4IvrSz2LSUfpn5c6Xcj2mH2AABv
 rXDfRj2VF5+cX/kJTOCMscfxc84iQ2IBiEHCPqTdsm/XwoBmd6A0zeguv Q==;
X-CSE-ConnectionGUID: DT6gNWEfSZ2/cahDL5hedg==
X-CSE-MsgGUID: 3bqGn835R4u189kiaEO6nA==
X-IronPort-AV: E=McAfee;i="6700,10204,11276"; a="44255602"
X-IronPort-AV: E=Sophos;i="6.12,207,1728975600"; d="scan'208";a="44255602"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,207,1728975600"; d="scan'208";a="93963445"

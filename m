...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DE3087E2E86
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Nov 2023 22:02:40 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 91B5210E41A;
	Mon,  6 Nov 2023 21:02:37 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B597310E41A
 for <intel-gfx@lists.freedesktop.org>; Mon,  6 Nov 2023 21:02:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699304556; x=1730840556;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=2X9RNTAa2744N+Szz2u2Eqn6qLvPstQaW0Tz8QhDLDo=;
 b=J9FNQIHS4V5LsZKJxOIYUOuXO9GOdzMnqZkXjn6d/gqLkYGfpqCZ5+ws
 U23AkTa2lP3VbFTYuBOeeo3U8ONg+Y94qgdtq2M29FizWVxOIadZTHU0K
 uc18iHgX4ys5ehfj1mOcpADtptVsXojC/3O6b6NebB4JN/1OVMbNzPwQw
 qIGVA5jidPLsxEDbiqzGCMzchuRa82Cn3gJBePNs+GVe+lzJFfW7GRld+
 T98QA3EvTFpB0Sg4nkxDMjbr3aj+bYsWamGVHkJwIShaz4/2nkNTk4VUb
 az0r6LuL88x0ZNqh98ZrPJIl8ID9DYnKRokx/C0JmXryoV1DKhzHUdOwH A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10886"; a="453677020"
X-IronPort-AV: E=Sophos;i="6.03,282,1694761200"; d="scan'208";a="453677020"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 13:02:35 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10886"; a="738894521"
X-IronPort-AV: E=Sophos;i="6.03,282,1694761200"; d="scan'208";a="738894521"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 13:02:34 -0800
Date: Mon, 6 Nov 2023 23:02:32 +0200
From: Imre Deak <imre.deak@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <ZUlUaLBJSiOGU4bb@ideak-desk.fi.intel.com>

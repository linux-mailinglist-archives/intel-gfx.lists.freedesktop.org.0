...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 670B558B1A0
	for <lists+intel-gfx@lfdr.de>; Fri,  5 Aug 2022 23:55:52 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2806B12BAF9;
...
Subject: [Intel-gfx] [PATCH v5 07/33] dyndbg: let query-modname override
 actual module name

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 291FC4A5A4A
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Feb 2022 11:42:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3795810EC05;
...
Subject: [Intel-gfx] [PATCH v5 12/19] drm/i915/gt: Clear compress metadata
 for Xe_HP platforms

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 94A6579A2B3
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Sep 2023 07:11:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B532610E111;
	Mon, 11 Sep 2023 05:11:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9369110E104
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=JreR+UlkITtglEaSTCa+hf2KL8VoeQhMTIzcY0/Ad8c=;
 b=lItpPdIbip9/7T8PJ3bS3/i73SSTc0sEv8vuQV3aoo2DeAhYlvFzvEKo
 HI4eXluSOBxtYOdAWpJ/ZmyU00uzBFD6TZarY0hxiJq0FWwzwQ+BvCJpp
 GDLLoM9aKRMYiHH3iz6S8OcXV1+Wwp67y17JVwY1Rr+l8ia0V2pdtZWga
 pzLqIsWpvFGmqzuXgtWdOPu3kcVQ+8A1ICK1Klku+0DwZGhIMHy6TqsVx
 qu1+f8NR4X3Yg2SiyFH2j/QPg01GoUm1ecwDRwGj2P4bLS8ynlDJawCRj
 EyT4eyQHOLdhDdOpZgDTsLFtpLQ/j6euHvsW5eRpRC8C4Jdzp/n+xL8cU w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10829"; a="377911992"
X-IronPort-AV: E=Sophos;i="6.02,243,1688454000"; d="scan'208";a="377911992"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Sep 2023 22:11:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10829"; a="808692862"
X-IronPort-AV: E=Sophos;i="6.02,243,1688454000"; d="scan'208";a="808692862"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmsmga008.fm.intel.com with ESMTP; 10 Sep 2023 22:11:14 -0700
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 11 Sep 2023 10:35:43 +0530
Message-Id: <20230911050549.763538-3-mitulkumar.ajitkumar.golani@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/8] drm/i915/display: Store compressed bpp in
 U6.4 format

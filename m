...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E26A6672584
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 18:51:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E7BD710E7D0;
	Wed, 18 Jan 2023 17:51:23 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 1/9] drm/i915/pxp: Add MTL PXP GSC-CS
 back-end skeleton

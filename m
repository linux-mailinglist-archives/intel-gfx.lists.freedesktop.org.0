...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA0DA36E7BB
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Apr 2021 11:13:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6EF026EDC3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 5/6] drm/i915/icl: Stop conflating mask and
 readback verify

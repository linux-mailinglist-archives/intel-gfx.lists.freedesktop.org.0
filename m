...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7664145064E
	for <lists+intel-gfx@lfdr.de>; Mon, 15 Nov 2021 15:09:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1749F6E147;
	Mon, 15 Nov 2021 14:08:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-ed1-x531.google.com (mail-ed1-x531.google.com
 [IPv6:2a00:1450:4864:20::531])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 98FAC6E0E5
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Nov 2021 14:08:53 +0000 (UTC)
Received: by mail-ed1-x531.google.com with SMTP id w1so6393218edc.6
 for <intel-gfx@lists.freedesktop.org>; Mon, 15 Nov 2021 06:08:53 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ffwll.ch; s=google;
 h=date:from:to:cc:subject:message-id:references:mime-version
 :content-disposition:content-transfer-encoding:in-reply-to;
 bh=iQJjbILxyWgxSgOraLEEzmMOSvawkV1EEVehuytHngQ=;
 b=lx5GF89QMlRGYtDFcPSKEdBRiJefHXXQaaHOF6RrQcLl7t+KnRP5Pt6CDRDngcwaZ7
 S/bnxtE7n0VplKzj5y5EiwUS9DbI4UxyDCo4j5rx/927yCgwdgQYruyD5sqyzK1eUOWf
 DhYyCuVJVtMHo0guQdanTWuIgZ+hWGg+cqWMY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :in-reply-to;
 bh=iQJjbILxyWgxSgOraLEEzmMOSvawkV1EEVehuytHngQ=;
 b=
X-Gm-Message-State: AOAM530bPVuLqxZXXg3On14XLYjm3XcdnW2m7Umvw+MTDhKbveDAS0aP
 3pbceDfLSbbo4a6BZfGBS6nXeg==
X-Google-Smtp-Source: ABdhPJxvjnsRe/WfXQ0iMmsi9C9GJCF8apkRDiD6b8cmPipjYf0nMPCMJtCVHZHernJ5ad4vHa1iQw==
X-Received: by 2002:a17:906:478e:: with SMTP id
 cw14mr48984529ejc.46.1636985331671; 
 Mon, 15 Nov 2021 06:08:51 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
 by smtp.gmail.com with ESMTPSA id e7sm7783429edk.3.2021.11.15.06.08.50
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 15 Nov 2021 06:08:50 -0800 (PST)
Date: Mon, 15 Nov 2021 15:08:49 +0100
From: Daniel Vetter <daniel@ffwll.ch>
To: Sascha Hauer <sha@pengutronix.de>
Message-ID: <YZJp8Uj4NpeP+zui@phenom.ffwll.local>
...
In-Reply-To: <20211115140353.GC6556@pengutronix.de>
X-Operating-System: Linux phenom 5.10.0-8-amd64 
Subject: Re: [Intel-gfx] [PATCH 12/26] drm/scheduler: use new iterator in

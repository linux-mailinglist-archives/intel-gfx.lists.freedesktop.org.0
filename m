...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A318E3AC043
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Jun 2021 02:49:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3122A6E858;
	Fri, 18 Jun 2021 00:48:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8860F6E425;
 Fri, 18 Jun 2021 00:48:48 +0000 (UTC)
IronPort-SDR: WI3F6wiYhvqBAcjHeapEqp0F+j0iPpePMDuMxOeA6Uphjfmy37ARbl9UN/msHILnjsbjIS3pjA
 NFid+Ytxm3tg==
X-IronPort-AV: E=McAfee;i="6200,9189,10018"; a="186853034"
X-IronPort-AV: E=Sophos;i="5.83,281,1616482800"; d="scan'208";a="186853034"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Jun 2021 17:48:47 -0700
IronPort-SDR: 20MLJ3lh0JMe2+32nzXe2f/tEW7sfXjekYe95fpxZUjl4iOXA1goCn2Xyx8ScBQreT//hP9GGF
 3puv19s1I1xQ==
X-IronPort-AV: E=Sophos;i="5.83,281,1616482800"; d="scan'208";a="405127007"
...
Message-Id: <20210618010638.98941-5-matthew.brost@intel.com>
...
@@ -1362,7 +1339,7 @@ static struct intel_timeline *get_timeline(struct i915_request *rq)
...
@@ -1740,8 +1717,9 @@ void intel_engine_dump(struct intel_engine_cs *engine,
...
@@ -1821,7 +1799,7 @@ intel_engine_find_active_request(struct intel_engine_cs *engine)
...
@@ -1839,7 +1817,8 @@ intel_engine_find_active_request(struct intel_engine_cs *engine)
 	if (active)
 		return active;

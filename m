...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 881ECAA5332
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Apr 2025 20:03:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DFC0810E12F;
	Wed, 30 Apr 2025 18:03:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=mark.filion@collabora.com header.b="Sc2wJ4nJ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-op-o16.zoho.com (sender4-op-o16.zoho.com
 [136.143.188.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C211510E12F
 for <intel-gfx@lists.freedesktop.org>; Wed, 30 Apr 2025 18:03:40 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1746036219; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=acRO3p8NkE02QeMTdL+hEyNEx0QZyK9uGCGC2HbJiNFRCtqRlPYtt6/aF8zTdUj9kMSeS9JRX87uyLxFcWOXKsgtfGx1njibnwlffD0lzIRfykBpbC38GWA0CVpYGBebLO5aHmbkC/kcDIX4yWjgbcGt4orL2AQeeMthvTZi5Ic=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1746036219;
 h=Content-Type:Date:Date:From:From:MIME-Version:Message-ID:Subject:Subject:To:To:Message-Id:Reply-To:Cc;
 bh=NLJ5dyzI/DtKMG3cnsCe+NLdXtmWMTM2bvniHeaQ5Ng=; 
 b=YPjVQZsjVyrGsAeRNCQdYPdLPk9COVDvC7JzIO1A3F63iAfCJJ/6uU4e7tktVTgTdRm/AHz7xj/yH0kARTlhz8/sO1tMvx9Tgmy9rBx+3Xi5dpyP3HKlW0cqIqF2XlJ6ZJ3aaW/auuPkAYJBrBmCKoXMBcmBH42VYsm0924vmyo=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=mark.filion@collabora.com;
 dmarc=pass header.from=<mark.filion@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1746036219; 
 s=zohomail; d=collabora.com; i=mark.filion@collabora.com;
 h=Message-ID:Subject:Subject:From:From:To:To:Date:Date:Content-Type:MIME-Version:Message-Id:Reply-To:Cc;
 bh=NLJ5dyzI/DtKMG3cnsCe+NLdXtmWMTM2bvniHeaQ5Ng=;
 b=Sc2wJ4nJDxWikDcHIOYgeWfgRqbGQR0GQrOrBOv2voZNKT/wGNblwmnWNpTj4j2m
 Ibrg02yrvhYlth5yUZCynMS/MD11NmEh3QKbrCEJARIUseQ/9MNCsbjnZac4RpYBDwa
 FTqfdzRlTQ5+G1FgQJjmxglQ3MWNemC3earxS0mo=
Received: by mx.zohomail.com with SMTPS id 1746036216962705.4030467072095;
 Wed, 30 Apr 2025 11:03:36 -0700 (PDT)
Message-ID: <30749eb2f07252855737e5003ff9e64f7d56fac0.camel@collabora.com>
Subject: Announcement: 2025 X.Org Foundation Election voting OPEN
From: Mark Filion <mark.filion@collabora.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 30 Apr 2025 14:03:35 -0400
Content-Type: multipart/alternative; boundary="=-HzTvKko9FF4/82fL94JK"

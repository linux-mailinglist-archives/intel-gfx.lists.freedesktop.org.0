...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A8D6850A7
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Aug 2019 18:07:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 927956E733;
	Wed,  7 Aug 2019 16:07:40 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 1/4] dma-buf: add reservation_object_fences
 helper

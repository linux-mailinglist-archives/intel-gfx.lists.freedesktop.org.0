...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9F5C97603E0
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Jul 2023 02:21:17 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A1A2B10E17F;
	Tue, 25 Jul 2023 00:21:13 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v9 7/7] drm/i915/gt: Support aux invalidation on
 all engines

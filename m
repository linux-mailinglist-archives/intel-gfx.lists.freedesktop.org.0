...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 48B3E1980FD
	for <lists+intel-gfx@lfdr.de>; Mon, 30 Mar 2020 18:23:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2D61F6E447;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v9 00/14] In order to readout DP SDPs,

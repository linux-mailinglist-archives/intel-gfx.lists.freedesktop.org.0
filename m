...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 53621184C58
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Mar 2020 17:21:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1C1286EC1C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 7/9] drm/edid: Don't include ext block csum in
 DispID size

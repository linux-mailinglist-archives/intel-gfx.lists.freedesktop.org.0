...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 374E819DA77
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Apr 2020 17:45:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A36276EC13;
	Fri,  3 Apr 2020 15:45:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 61F446EC13
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 Apr 2020 15:45:23 +0000 (UTC)
IronPort-SDR: 057Hiw76Fb/b3wmrm/eRFQEeAgWZwGXBG6Oh4yBNb5HleVOnll2W4F+b/mIufdRzljOH2OFxmY
 fKwxyFHRx89g==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2020 08:45:22 -0700
IronPort-SDR: qgenfgRELW6g2eSYRS3qgRWGxwmf76F8WnqOLj744QlR6drfTBQSbdAc9DYnMt/F6DBj9f4Lly
 IV0i6SeTbv9w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,340,1580803200"; d="scan'208";a="329199651"
Received: from unknown (HELO slisovsk-Lenovo-ideapad-720S-13IKB.fi.intel.com)
 ([10.237.72.89])
 by orsmga001.jf.intel.com with ESMTP; 03 Apr 2020 08:45:19 -0700
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 Apr 2020 18:41:44 +0300
Message-Id: <20200403154144.10043-1-stanislav.lisovskiy@intel.com>
X-Mailer: git-send-email 2.24.1.485.gad05a3d8e5
In-Reply-To: <20200326181005.11775-3-stanislav.lisovskiy@intel.com>
References: <20200326181005.11775-3-stanislav.lisovskiy@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v21 02/10] drm/i915: Eliminate magic numbers "0"

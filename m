...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D30F46DD5C5
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Apr 2023 10:39:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 392F410E0EE;
	Tue, 11 Apr 2023 08:39:55 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 001F610E0EE;
 Tue, 11 Apr 2023 08:39:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1681202393; x=1712738393;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=8mDlLdydeg3i4Xc/LU8nlsRQAZjCVzWAC8gmjQPeseE=;
 b=U6Mv11EXuikoy8por5V2fhMrWcBhaMSoWKLDPloL7v2oai/eWhAXnCGd
 LmdCsQjoWYGZBGlzVcon4wFu4mLM/rRbL0idssg3OxDpuuaWTDSApPts+
 oSZD0C9p+JupPWIF6dcjncorXCUN+Mou6peYPkKYMxBsX5fokThjdWM+x
 /W9z/2AUE61mGEvnBq/MPeBk5N0N6CZKtf1kHt8TNrBijwHPKJib1Tdpi
 22DctDIIn9UnNDqvDmPsI9JDQzbBY5SD59rgyZTieJlCpvR/79mRqBT0/
 nsGlmtk8wzGXr/4kmhQDAVgfZtOAsSTkvTb0NGP9dXCt0NOHl65fi+CY6 Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10676"; a="406384917"
X-IronPort-AV: E=Sophos;i="5.98,336,1673942400"; d="scan'208";a="406384917"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Apr 2023 01:39:52 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10676"; a="799829334"
X-IronPort-AV: E=Sophos;i="5.98,336,1673942400"; d="scan'208";a="799829334"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.70])
 by fmsmga002.fm.intel.com with SMTP; 11 Apr 2023 01:39:49 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 11 Apr 2023 11:39:49 +0300
Date: Tue, 11 Apr 2023 11:39:49 +0300
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: =?iso-8859-1?Q?Jos=E9?= Roberto de Souza <jose.souza@intel.com>
Message-ID: <ZDUc1Ya/ybwjo4DC@intel.com>
...
Subject: Re: [Intel-gfx] [PATCH v3 1/6] drm/i915: Initialize dkl_phy spin

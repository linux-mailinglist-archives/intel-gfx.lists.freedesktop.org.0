...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 97916793005
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Sep 2023 22:30:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 55E2F10E507;
	Tue,  5 Sep 2023 20:30:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 36B8210E50B
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=OtgFSfPTU/n9jMhc/wjyPUJdv280HjltbESapcJVtEw=;
 b=ZOJKO0JI2kCWHr643t8qhbaUOjDRpXwKzbyNghQpia9Ihim1Rqo+y9BD
 eXxogt9x3VQVathSo3tgWLhc2ujVGwAKJyoUsLa6ROevQKAyaixbnn1GA
 B2fkmmkiWBAJms0ZAtO56FyYNqa+7WEOxfHxNgggyyVF8zEttOJxnjVR7
 NZkFRDZQxYMiPqzFGj9Ef/E0vvlgHW90z4SCtJ4pwMClC6CXws3ValaLq
 gqP5wTpDfxO61lWiGuJzkBtp/oHqcMXE9jQGyKiJ0C2YWBEeT2suegm36
 x0WVmD1U2RrR3yyj8DBZfWH5gaAR3IFFj3QtY3Lp4JWabnm7vFlSNABVf w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10824"; a="440869907"
X-IronPort-AV: E=Sophos;i="6.02,230,1688454000"; d="scan'208";a="440869907"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Sep 2023 13:30:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10824"; a="811380842"
X-IronPort-AV: E=Sophos;i="6.02,230,1688454000"; d="scan'208";a="811380842"
Received: from dut-internal-9dd7.jf.intel.com ([10.165.21.194])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Sep 2023 13:30:28 -0700
From: Jonathan Cavitt <jonathan.cavitt@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  5 Sep 2023 13:19:46 -0700
Message-Id: <20230905201947.1299112-2-jonathan.cavitt@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 1/2] drm/i915: Add WABB blit for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F41238C07F9
	for <lists+intel-gfx@lfdr.de>; Thu,  9 May 2024 01:45:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 036B210ED4D;
	Wed,  8 May 2024 23:45:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=linux.microsoft.com header.i=@linux.microsoft.com header.b="fPLZDG0t";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
 by gabe.freedesktop.org (Postfix) with ESMTP id EEF8410ED1F;
 Wed,  8 May 2024 23:45:04 +0000 (UTC)
Received: from rrs24-12-35.corp.microsoft.com (unknown [131.107.1.144])
 by linux.microsoft.com (Postfix) with ESMTPSA id 311FF2083CB5;
 Wed,  8 May 2024 16:45:04 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 311FF2083CB5
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
 s=default; t=1715211904;
 bh=TSq7PFRKGsH2Md/WVgJBosLH3Kviz+7Ck04fi0pQfvs=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=fPLZDG0tO6Acb81EPSteZDeghFELu/x3sVfBubWwDnI/4QKooefKhUt8JteJno5XU
 psAAzKFmst2o90wOTiBu8PhQ8XZyrFPKli01W6i2jYB9xgHiIlex9wjQeoDszDfh9d
 4yOwmKBmJPvqBy6fMw+q+7TE28RDIyPz+qmbOnFY=
...
To: Alex Deucher <alexander.deucher@amd.com>,
 ...
 Lijo Lazar <lijo.lazar@amd.com>, Ran Sun <sunran001@208suo.com>,
 ...
 Alvin Lee <alvin.lee2@amd.com>, Sohaib Nadeem <sohaib.nadeem@amd.com>,
 Charlene Liu <charlene.liu@amd.com>, PeiChen Huang <peichen.huang@amd.com>,
 Meenakshikumar Somasundaram <meenakshikumar.somasundaram@amd.com>,
 George Shen <george.shen@amd.com>, Tom Chung <chiahsuan.chung@amd.com>,
 Bhawanpreet Lakha <Bhawanpreet.Lakha@amd.com>, Aric Cyr <aric.cyr@amd.com>,
 ...
 Ma Jun <Jun.Ma2@amd.com>, Yang Wang <kevinyang.wang@amd.com>,
...
Subject: [PATCH v3 1/6] drm/amdgpu,
 drm/radeon: Make I2C terminology more inclusive
Date: Wed,  8 May 2024 23:43:37 +0000
Message-Id: <20240508234342.2927398-2-eahariha@linux.microsoft.com>
...
index 6450853fea94e..51aa72e4eba46 100644
...
index ab31643b10969..90abab6bd00a2 100644
...
index ee8453bf958fb..21608f42879f5 100644
...
index af3eebb4c9bcb..0b76c3655df71 100644
...
index 0c2d04f978ac9..e2c6a4806e5c3 100644
...
index 1f18b61884f3f..eec4b9b9598c0 100644

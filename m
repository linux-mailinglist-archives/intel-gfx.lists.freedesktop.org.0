...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 24E6E509AE5
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 10:45:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6028A10F933;
...
Subject: Re: [Intel-gfx] [CI 4/4] drm/i915/selftests: tweak the
 misaligned_case

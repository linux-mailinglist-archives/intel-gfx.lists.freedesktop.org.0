...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A895937060D
	for <lists+intel-gfx@lfdr.de>; Sat,  1 May 2021 08:55:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A04546F89C;
...
Subject: Re: [Intel-gfx] [PATCH 3/6] drm/i915: Add a separate low-level
 helper for masked workarounds

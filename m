...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E73FE718F34
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 01:54:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7807910E0F9;
...
Subject: [Intel-gfx] [PATCH v5 3/7] drm/i915/huc: Load GSC-enabled HuC via

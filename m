...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 690A41F0890
	for <lists+intel-gfx@lfdr.de>; Sat,  6 Jun 2020 22:26:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECD5A6E203;
	Sat,  6 Jun 2020 20:26:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com
 [205.139.110.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 466116E1EC
 for <intel-gfx@lists.freedesktop.org>; Sat,  6 Jun 2020 20:26:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1591475172;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=HFSbgw+jMLXkeGeVQko9oA8LjxZw2ty0U8jf3NzNvyw=;
 b=RP5HNaByCipuD+He3UJmnOOaUXur1VM+Zp0W7pZS+VT0tfQwHEcvXIdPurz2c49VRzqpmW
 qU+/jHM7IIJqag9HKujoOwOjTYGf+tBXPHz1qdMl+Cc5zRLvDPXhK5wmZo8ewXE50GwzUx
 /AZC9hvx05sNuTfYc4h/ALnwjhsNDgg=
...
Subject: [Intel-gfx] [PATCH 01/16] ACPI / LPSS: Resume Cherry Trail PWM

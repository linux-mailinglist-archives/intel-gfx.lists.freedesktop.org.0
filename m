...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3717B3B859B
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 16:59:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7A1046E9FA;
	Wed, 30 Jun 2021 14:59:40 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v6 4/4] drm: protect drm_master pointers in
 drm_lease.c

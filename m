...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D8D5D2E7D3E
	for <lists+intel-gfx@lfdr.de>; Thu, 31 Dec 2020 00:41:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CE20898A7;
	Wed, 30 Dec 2020 23:41:07 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B079989624
 for <Intel-gfx@lists.freedesktop.org>; Wed, 30 Dec 2020 23:41:03 +0000 (UTC)
IronPort-SDR: HERicSlfAZaAL2aNfs0KErsayb9dO6RfUGzgY3gFEjAVfRkq8tj/4C8f9gswRBwYnbcjlEsEaa
 9oqEZ92W9PcA==
X-IronPort-AV: E=McAfee;i="6000,8403,9850"; a="164362545"
X-IronPort-AV: E=Sophos;i="5.78,462,1599548400"; d="scan'208";a="164362545"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 30 Dec 2020 15:41:03 -0800
IronPort-SDR: KOwdE3KN7QpjLg7BvayR1vLp2DLLZTCEQ9pHA+S9kB/K3gMo+w2qvddsRB+z+C2iRpfY/bCLnc
 PNRHoKQfZr6g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,462,1599548400"; d="scan'208";a="385323046"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga007.jf.intel.com with ESMTP; 30 Dec 2020 15:41:02 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed, 30 Dec 2020 15:40:59 -0800
Message-Id: <20201230234100.30104-13-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201230234100.30104-1-sean.z.huang@intel.com>
References: <20201230234100.30104-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v16 12/13] drm/i915/pxp: User interface for
 Protected buffer

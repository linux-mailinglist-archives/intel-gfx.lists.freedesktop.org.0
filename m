...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C2319ACFC8
	for <lists+intel-gfx@lfdr.de>; Wed, 23 Oct 2024 18:11:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E12C10E81D;
	Wed, 23 Oct 2024 16:11:24 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="Wi4OiJzo";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2B11B10E81C;
 Wed, 23 Oct 2024 16:11:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1729699883; x=1761235883;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=gnHhq6rJNr1mxIWCk4bWKW7aoRwI1tsZWp4Y4OJwvpM=;
 b=Wi4OiJzot52plMlmOleMNovqo3cvscrU1bNmNbrW8/EMAgsInm8qTNGa
 sCoR0BM8BcVx6qE70Eq8WQF+gFTNjMsp7eJNAhCiHxZmy5/diLvCyKqD1
 6GwvW0kEFi80PIv0ikvLpoRQA7zXKaZF8OHGMb6qmlTNOiP1N7ngp1G6g
 kfJGt0R+XRRLZvMtct/FFYoeo1fmKk8glvC0RVIpZ2GOAm3yfSBuSXgIw
 Z+RQ1ECmyRaKvhTBM5qOYu0W4d9h8MJ5Shmm+uFk4JhcuO93gGjEAtIv3
 AscUZJT/ODNib6tt2i0IMwYhKLPKDgwhmALyCWsTKeSbigNP7FRQnSNe/ g==;
X-CSE-ConnectionGUID: qlKxI53fRtiabfzM56E2UQ==
X-CSE-MsgGUID: Y6j/dQxmQIiA4VU+hB8bhw==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="39847529"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="39847529"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
 by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Oct 2024 09:11:23 -0700
X-CSE-ConnectionGUID: 0u9YOUNFS4WX4GSKHDOM5w==
X-CSE-MsgGUID: viPMFIMTQjamKkltmclclA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,226,1725346800"; d="scan'208";a="79941173"
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by fmviesa007.fm.intel.com with ESMTP; 23 Oct 2024 09:11:21 -0700
From: Nemesa Garg <nemesa.garg@intel.com>
To: intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org,
 intel-xe@lists.freedesktop.org
Cc: Nemesa Garg <nemesa.garg@intel.com>
Subject: [PATCH 1/5] drm: Introduce sharpness strength property
Date: Wed, 23 Oct 2024 21:42:02 +0530
Message-Id: <20241023161206.1113519-2-nemesa.garg@intel.com>

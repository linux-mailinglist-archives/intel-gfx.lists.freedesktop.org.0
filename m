...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E10A56C5A1
	for <lists+intel-gfx@lfdr.de>; Sat,  9 Jul 2022 03:15:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C38710E0AD;
...
Subject: Re: [Intel-gfx] [RFC] drm/i915/huc: better define HuC status
...
Cc: dri-devel@lists.freedesktop.org, "Zhang, Carl" <carl.zhang@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E9225BF77F
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Sep 2022 09:20:20 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E6A4910E895;
	Wed, 21 Sep 2022 07:20:17 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9117810E895;
 Wed, 21 Sep 2022 07:20:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1663744815; x=1695280815;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=fmK1h7XAM+u25zPQCHqS0RCVXaYDCn9xwyAOuoYh84o=;
 b=HVjkDaYON9QJNHvOkweoTuXcpJ5YS7re0XpF7sTr8YFLrp1s1NliAHtf
 qFwUaUhT+PINe6vs9tt/w4mHM7N3nU0QI0q7ro8dtAwfOcRBGJaffuENN
 aa7tVs356SEYHCZXJv5ZFCDiOyCP5UXFfALjNsYIXLfPVjEcpB2KzB8sR
 iFMuap6nE4gwQdjcuikcfAR12aTDRO2pmxsuK+NQCWzup7cjm5FYYqvxF
 Eg73b5q+c47RAFYjZUHDwjVx9bqwhn2jALPuqN48I2iRXGaKrMFmgGCHC
 0KM5QnXQbl7KKgNZ0WgtaiRDYu/oCNUCrS7pR63Oi7rYIwuyVvuSimNOY Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10476"; a="280299357"
X-IronPort-AV: E=Sophos;i="5.93,332,1654585200"; d="scan'208";a="280299357"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Sep 2022 00:20:15 -0700
X-IronPort-AV: E=Sophos;i="5.93,332,1654585200"; d="scan'208";a="649937237"
Received: from nvishwa1-desk.sc.intel.com (HELO nvishwa1-DESK) ([172.25.29.76])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Sep 2022 00:20:14 -0700
Date: Wed, 21 Sep 2022 00:19:53 -0700
From: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>
To: Jani Nikula <jani.nikula@linux.intel.com>
Message-ID: <20220921071953.GZ10283@nvishwa1-DESK>
References: <20220827194403.6495-1-andi.shyti@linux.intel.com>
 <20220827194403.6495-5-andi.shyti@linux.intel.com>
 <874jxc68kl.fsf@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1; format=flowed
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <874jxc68kl.fsf@intel.com>

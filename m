...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BC4781FC944
	for <lists+intel-gfx@lfdr.de>; Wed, 17 Jun 2020 10:52:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C6A186E31D;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH][next] drm/i915/selftests: fix spelling mistake
 "submited" -> "submitted"

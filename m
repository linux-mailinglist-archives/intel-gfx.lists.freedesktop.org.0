...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 959B4B3E866
	for <lists+intel-gfx@lfdr.de>; Mon,  1 Sep 2025 17:07:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EE9E710E492;
	Mon,  1 Sep 2025 15:07:10 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=redhat.com header.i=@redhat.com header.b="dxbX+pY6";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 512A810E496
 for <intel-gfx@lists.freedesktop.org>; Mon,  1 Sep 2025 15:07:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1756739228;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=R4lKJy8SBWSrsm7Vh+zb8hrnJCJALrpbQ5NruWVxUgs=;
 b=dxbX+pY6uty5I4V7OnWCQdGulpa67Gnrq4+kuTrrBalw8IUXy8s1WiM6o+DCkqWiBXe2Ek
 SPzUE45fabWM2SZao4I+bFNWHCRm8yNBTplq+fq7lv8ZIVXeRoX5rgGvZUgUdqxBsLKLQC
 dZueP5YSoItDuGKEEGhHn6KU9UJc7Qs=
...
Received: from mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com
 ...
 id 331CF195C27E; Mon,  1 Sep 2025 15:07:01 +0000 (UTC)
Received: from t14s.fritz.box (unknown [10.22.88.45])
 by mx-prod-int-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP
 id 3B7921800447; Mon,  1 Sep 2025 15:06:47 +0000 (UTC)
...
Subject: [PATCH v2 09/37] mm/mm_init: make memmap_init_compound() look more

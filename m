...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C9F0E293DA2
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Oct 2020 15:49:42 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B04796ECA3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 00/15] HDCP 2.2 DP MST Support

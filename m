...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 301D77A9B1
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jul 2019 15:32:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 20AB56E50E;
	Tue, 30 Jul 2019 13:32:36 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6FB746E50C
 for <intel-gfx@lists.freedesktop.org>; Tue, 30 Jul 2019 13:32:34 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17730641-1500050 
 for multiple; Tue, 30 Jul 2019 14:30:38 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 30 Jul 2019 14:30:24 +0100
Message-Id: <20190730133035.1977-7-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 06/17] drm/i915: Move aliasing_ppgtt underneath
 its i915_ggtt
...

...
KTsKIH0KIAogc3RhdGljIHN0cnVjdCBpOTE1X3ZtYSAqCkBAIC0xNDkzLDcgKzE1MDQsNyBAQCBz
...
IAkJZ290byBlcnJfYWN0aXZlOwogCkBAIC0xNjg1LDcgKzE2OTYsNyBAQCBzdGF0aWMgaW5saW5l
...
NS0+bDNfcGFyaXR5LnJlbWFwX2luZm9bc2xpY2VdOwogCWludCBpOwpAQCAtMTcxMywxNSArMTcy
NCwzNCBAQCBzdGF0aWMgaW50IHJlbWFwX2wzKHN0cnVjdCBpOTE1X3JlcXVlc3QgKnJxLCBpbnQg
...
dCByZXQ7CiAKIAlHRU1fQlVHX09OKEhBU19FWEVDTElTVFMocnEtPmk5MTUpKTsKIApAQCAtMTc2
NSw3ICsxNzk1LDcgQEAgc3RhdGljIGludCBzd2l0Y2hfY29udGV4dChzdHJ1Y3QgaTkxNV9yZXF1
...
IGh3X2ZsYWdzKTsKQEAgLTE3OTksMTggKzE4MjksOSBAQCBzdGF0aWMgaW50IHN3aXRjaF9jb250
...
NS9pOTE1X2Rydi5oCmluZGV4IGI1MTZlNmEwMmI2MS4uM2RkZWJhNWM3YjhkIDEwMDY0NAotLS0g
...
cml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2dlbV9ndHQuYwppbmRleCA0MjNjODkwZDAzYmYuLmMz
MDI4NzIyZDRlMyAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvaTkxNV9nZW1fZ3R0
...
bnVwX2luaXRfZ2d0dCgmaTkxNS0+Z2d0dCk7CiAJfQpAQCAtMjc1NSw3ICsyNzU1LDcgQEAgdm9p
...
KCZpOTE1LT5nZ3R0KTsKIApAQCAtMzU4OCw3ICszNTg4LDcgQEAgaW50IGk5MTVfZ2VtX2d0dF9y
...
bm9kZSkpOwogCiAJbm9kZS0+c2l6ZSA9IHNpemU7CkBAIC0zNjg1LDcgKzM2ODUsNyBAQCBpbnQg

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B613266383A
	for <lists+intel-gfx@lfdr.de>; Tue, 10 Jan 2023 05:36:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 07D6510E537;
	Tue, 10 Jan 2023 04:36:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A670410E537
 for <intel-gfx@lists.freedesktop.org>; Tue, 10 Jan 2023 04:36:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1673325400; x=1704861400;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6d/cxNZWSXnEPwQypt5ioFi3OGHCwX+eLNG0ZS61j38=;
 b=VN06NlmEAB6i4CT2SC2oBCDeU+2CzoT0gQbR/ESkDW/dEjq19Sgb9cf6
 +ETcCxu69neT9WoQAdKo3OAUdQG3w063aAIrl5TdkuxGy4jJ9tYlJ80tN
 vWeNU2hA3Pe69pilAlF2VerYJVl7sQcgQ+RVYxjkKx/ME64TeSTXmvkYP
 XqHkd9TmmnVHawcesVC20h9J5neMWNMPhjN1vCO7fpZa6bJ0v94QDrLCt
 LIT753OTkwRVTc10WAVxxdhUj5uPDzCqQK0FbdzBdVTqmuXwaqDiBixF+
 +atPj5y7B8rcmpiDGFn/wl3+lW9C8c88Flf8SpGoPbZ7Y3eBKfZahttTz A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="350279709"
X-IronPort-AV: E=Sophos;i="5.96,314,1665471600"; d="scan'208";a="350279709"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Jan 2023 20:36:40 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10585"; a="650230583"
X-IronPort-AV: E=Sophos;i="5.96,314,1665471600"; d="scan'208";a="650230583"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by orsmga007.jf.intel.com with ESMTP; 09 Jan 2023 20:36:37 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 10 Jan 2023 10:05:15 +0530
Message-Id: <20230110043517.1388837-5-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 4/6] drm/i915/hdcp: Refactor HDCP API
 structures

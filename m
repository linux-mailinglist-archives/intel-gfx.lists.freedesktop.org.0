...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 177A06CF000
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Mar 2023 18:57:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1916710EBA6;
...
Subject: [Intel-gfx] [PATCH 1/4] drm/i915/mtl: Define GSC Proxy component
 interface

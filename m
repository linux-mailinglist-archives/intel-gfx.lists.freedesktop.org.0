...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1BEE54A6CA5
	for <lists+intel-gfx@lfdr.de>; Wed,  2 Feb 2022 09:08:28 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ED2C810F9A5;
	Wed,  2 Feb 2022 08:08:25 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 1/6] drm: add writeback pointers to
 drm_connector

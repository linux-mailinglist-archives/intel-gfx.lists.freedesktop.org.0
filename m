...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 861E719D04C
	for <lists+intel-gfx@lfdr.de>; Fri,  3 Apr 2020 08:37:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D3F5C6EAF7;
	Fri,  3 Apr 2020 06:37:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4B3306EAF6
 for <intel-gfx@lists.freedesktop.org>; Fri,  3 Apr 2020 06:37:53 +0000 (UTC)
IronPort-SDR: hH/56dyHHrg8igt0TGxxZispu6jkiYjLtdCtkct0KV+AFwBt6ge5V+ga9bZWGnSJEbH9QycFvU
 95DJO84Et3Eg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 02 Apr 2020 23:37:52 -0700
IronPort-SDR: f/+SZxQA0xv/swev2o2o4EnyfnTKo4G6PXiMHVJ78bEK7eoFNg7ISYTPv3X1GjjVWiN9+BiDbC
 /zJjlfhWar5g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,338,1580803200"; d="scan'208";a="242731790"
Received: from unknown (HELO slisovsk-Lenovo-ideapad-720S-13IKB.fi.intel.com)
 ([10.237.72.89])
 by fmsmga008.fm.intel.com with ESMTP; 02 Apr 2020 23:37:51 -0700
From: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri,  3 Apr 2020 09:34:15 +0300
Message-Id: <20200403063415.12398-1-stanislav.lisovskiy@intel.com>
X-Mailer: git-send-email 2.24.1.485.gad05a3d8e5
In-Reply-To: <20200326181005.11775-9-stanislav.lisovskiy@intel.com>
References: <20200326181005.11775-9-stanislav.lisovskiy@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v21 08/10] drm/i915: Rename bw_state to
 new_bw_state
...

...
LTQ0NiwyOSArNDQ2LDI5IEBAIGludCBpbnRlbF9id19hdG9taWNfY2hlY2soc3RydWN0IGludGVs

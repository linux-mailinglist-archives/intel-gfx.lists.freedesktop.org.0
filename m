...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 669506A39F7
	for <lists+intel-gfx@lfdr.de>; Mon, 27 Feb 2023 05:06:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4186E10E162;
	Mon, 27 Feb 2023 04:06:15 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5111010E15A
 for <intel-gfx@lists.freedesktop.org>; Mon, 27 Feb 2023 04:06:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1677470765; x=1709006765;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Xp8GUUIYelW2XYT/dx5B8IqgXayVQukhnl1DxUpjdFk=;
 b=Rww+WtPPdzCwJfxUSEP5sISfWvvK/VR7r2MMqmsMb0QDvJFZJGVGd3Mb
 muJwmoAXlkoCch8z7OJwqFuRT9V8RRAG6HbVmGNIG4636ER56smfokSHL
 I1ggORBRAW+kAiqACg9FrhGK5J73VG00LjPCysZ34uEsPWIkM7ALp3Rsz
 N1/+DzpSA+JgOD9kiaDUNObbiVSFp/cWPE4b4uhqPft/bD46RLFThD0/r
 f9EOJj8dfS0w9wYDwLivBeo7vZTIeVoqTegk/f2bvYe5Za+6z+3i+nP0V
 POKRkqGv/S4rUugjBIvhVC8vhH9WcHUnOXd6ezbp53f7efbr0QT/N1Xks w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10633"; a="335251375"
X-IronPort-AV: E=Sophos;i="5.97,330,1669104000"; d="scan'208";a="335251375"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Feb 2023 20:06:05 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10633"; a="783146997"
X-IronPort-AV: E=Sophos;i="5.97,330,1669104000"; d="scan'208";a="783146997"
Received: from srr4-3-linux-103-aknautiy.iind.intel.com ([10.223.34.160])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Feb 2023 20:06:03 -0800
From: Ankit Nautiyal <ankit.k.nautiyal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 27 Feb 2023 09:33:15 +0530
Message-Id: <20230227040324.130811-5-ankit.k.nautiyal@intel.com>
...
Subject: [Intel-gfx] [PATCH v10 04/13] drm/i915/dp: Replace intel_dp.dfp

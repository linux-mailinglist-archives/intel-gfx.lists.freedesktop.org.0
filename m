...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CDDE24B3AD1
	for <lists+intel-gfx@lfdr.de>; Sun, 13 Feb 2022 11:32:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1A9EC10F1C1;
	Sun, 13 Feb 2022 10:32:43 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A146E10F1B1
 for <intel-gfx@lists.freedesktop.org>; Sun, 13 Feb 2022 10:32:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1644748361; x=1676284361;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=TXkMgLsZq0yFzQrLuzMSXuiXiKK/i02mAvqPVwdjark=;
 b=T6DX2wN5jmJ6hjhPlvyw9oUurAb5IWYly5Mldw8UaA23+nIpVqGxEB1o
 gZzs1NbcIRpgtuBo0bWRYNE4vZht6+Q7/+pmaHHvLwlqK7z7CuubalGpk
 lEYfZx5S0sVoj7QGrH4A9wMcRrdsUZZO5IqMvdXm2PnfFVrhm36wosUcV
 ZDzXHFZ7sLMV65fXoEtnfKPXnkMucrBKUad8oNJgBByla8AOdx/kR2trJ
 Dg7Jf1lQVOKIa8pQHRVYqKsornhaJrMWqB3jcpRyPfbnFhjIjnH9YNumJ
 e3bWAdeLozbvOiAmpedqvRPEJM04tX99fA01mNO5Sg1wV0YP3YAYFeT7A g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10256"; a="336363636"
X-IronPort-AV: E=Sophos;i="5.88,365,1635231600"; d="scan'208";a="336363636"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2022 02:32:41 -0800
X-IronPort-AV: E=Sophos;i="5.88,365,1635231600"; d="scan'208";a="527474307"
Received: from sannilnx.jer.intel.com ([10.12.231.79])
 by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 13 Feb 2022 02:32:38 -0800
...
Date: Sun, 13 Feb 2022 12:32:12 +0200
Message-Id: <20220213103215.2440248-3-alexander.usyskin@intel.com>
...
Subject: [Intel-gfx] [PATCH v7 2/5] mei: add support for graphics system

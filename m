...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E543C7C90BD
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 00:49:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C7F6610E66D;
...
Subject: [Intel-gfx] [PATCH v7b 07/25] dyndbg: drop NUM_TYPE_ARRAY

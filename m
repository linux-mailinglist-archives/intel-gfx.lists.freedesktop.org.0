...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 675B570CE79
	for <lists+intel-gfx@lfdr.de>; Tue, 23 May 2023 01:08:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BA4F310E3B2;
	Mon, 22 May 2023 23:08:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A37AA10E3B2
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 May 2023 23:08:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684796910; x=1716332910;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=7oYac8rA3P8ThyL289V2x2h6M2jTXbbKqKR1ssIxEpo=;
 b=dATxjHCYXkAMPNCQ/kBjrirdLza1gsH9+BtqpTkKHjHldmv79X/SQHVy
 wA7TrN2psP4hoPuziZaBWwcLAYRMNWD+sZzrMpMTw3DhBopdfcBsigakz
 a8V5nEqOZUFXLGNP6pZmDzYRsrA7/HCH2XMW2k7BCwFB5CLbLJClQl4PP
 /Np1nNy7JS+dOWwg2Fzq+hp5w7OPmD8RRtgT/Xo3SunJu3Qz8KZ1oVD3c
 nc6oiXsVhWaDpyUr8lXC1UlQBLi8X8OkjgrcpBK1ND8hx/nhgVcZWxogf
 1WqB42wtz6ARtTXRxLZ1ni/CE3OJX8v2bQwyUdqXvZlPnFS82b6RJEbCo Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="353093864"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="353093864"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 16:08:30 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="773542636"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="773542636"
Received: from cavram-mobl1.ger.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.251.220.199])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 16:08:27 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 May 2023 02:07:56 +0300
Message-Id: <20230522230759.153112-5-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 4/7] drm/i915: extract

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 635354AD5CE
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Feb 2022 11:49:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 87B0A10E71A;
...
Subject: [Intel-gfx] [PATCH v2 3/4] drm/i915/uapi: Add struct

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 38C405946F2
	for <lists+intel-gfx@lfdr.de>; Tue, 16 Aug 2022 01:22:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BE74D10EE;
	Mon, 15 Aug 2022 23:22:35 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2] drm/i915/guc/slpc: Allow SLPC to use
 efficient frequency

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 702257DA76
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Aug 2019 13:41:34 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8008D6E4F3;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v12 1/6] drm: Add Content protection type
 property

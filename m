...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 161DD5A886E
	for <lists+intel-gfx@lfdr.de>; Wed, 31 Aug 2022 23:51:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5D35D10E4F3;
...
Subject: [Intel-gfx] [PATCH v3 02/11] drm/i915: Read graphics/media/display

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 97DE335BF7A
	for <lists+intel-gfx@lfdr.de>; Mon, 12 Apr 2021 11:09:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8C0EE89DF9;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 01/19] drm/i915/gt: Skip aperture remapping

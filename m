...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 177AF7CE3C1
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Oct 2023 19:07:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CCD0810E440;
	Wed, 18 Oct 2023 17:06:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-io1-xd2b.google.com (mail-io1-xd2b.google.com
 [IPv6:2607:f8b0:4864:20::d2b])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E0FDF10E429;
 Wed, 18 Oct 2023 17:06:29 +0000 (UTC)
Received: by mail-io1-xd2b.google.com with SMTP id
 ca18e2360f4ac-7a66bbb6c1dso41068739f.0; 
 Wed, 18 Oct 2023 10:06:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=gmail.com; s=20230601; t=1697648789; x=1698253589; darn=lists.freedesktop.org;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=90MeBmrujadbrZ21BkJC2FT5bTEFegB1BADGNRwi/xM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20230601; t=1697648789; x=1698253589;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=90MeBmrujadbrZ21BkJC2FT5bTEFegB1BADGNRwi/xM=;
 b=
X-Gm-Message-State: AOJu0Yyn3rfp/Pm8qmkL6Z0PXSzW3EW77vNs7EK7iX5+VJnYnLpX+MoG
 psXu1DcNjSJF6CyruDhYPGs=
X-Google-Smtp-Source: AGHT+IEu583y+gJRLvQ2V0nujF/vWEsn20vKmpfcna0khyQiT7w5V5qo73jGNxT36zKfZErrXqTwyQ==
X-Received: by 2002:a05:6602:2c91:b0:795:1a7c:486f with SMTP id
 i17-20020a0566022c9100b007951a7c486fmr7405347iow.14.1697648789035; 
 Wed, 18 Oct 2023 10:06:29 -0700 (PDT)
Received: from frodo.. (c-73-78-62-130.hsd1.co.comcast.net. [73.78.62.130])
 by smtp.googlemail.com with ESMTPSA id
 n4-20020a5d8244000000b0079fa1a7cd36sm1228944ioo.30.2023.10.18.10.06.28
...
Date: Wed, 18 Oct 2023 11:05:56 -0600
Message-ID: <20231018170604.569042-17-jim.cromie@gmail.com>
...
Subject: [Intel-gfx] [PATCH v7c 16/24] dyndbg-API: promote
 DYNDBG_CLASSMAP_PARAM to API

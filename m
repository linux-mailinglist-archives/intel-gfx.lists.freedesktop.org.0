...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FEB866E881
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Jan 2023 22:36:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 748E210E5D5;
...
Subject: [Intel-gfx] [PATCH v2 0/5] Allow error capture without a request /
 on reset failure

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7617D3FC279
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Aug 2021 08:15:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 66F0389B84;
...
Subject: [Intel-gfx] [PATCH v9 3/4] drm: lock drm_global_mutex earlier in
 the ioctl handler

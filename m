...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6029D638A83
	for <lists+intel-gfx@lfdr.de>; Fri, 25 Nov 2022 13:44:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0E5C410E76B;
	Fri, 25 Nov 2022 12:44:33 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DB79A10E74C;
 Fri, 25 Nov 2022 12:44:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669380265; x=1700916265;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=i5ptwAnO3kfarIPrnmjcgDLJzDjgM5jKfQtANE/edJs=;
 b=V7Z+zS5G7L09cX2qpQ9DvlOlFNYAg89+lEN3yQe+WX+1nxi5y15Ude/O
 uExr9n4FrzETwNtR6rOoV+ndGQ/300sYPSZ7xk81twA6LTvI5DqVqm3mu
 msgqA446eSnJ54nOJ+HUDfRv21E7+TyQ7ZTlMEfyuwNUYY3bLiyC0MT15
 2Lpv5/48nu5x1FHiGNN+54qcUk9TqnZXG7lVeC7E5KsmMqDIChKS5rFtz
 v6zF+IUS36Gc/LRIva44Pv2YXTWnEdGeMFQC6I7LbQQ/Ax7SyyLQowFPk
 9oGMCSodjnsNyiKIoykzVRoDZSDPy5lcuT20oLgeVmx7yQO+qIKTe0Hxf w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="313174459"
X-IronPort-AV: E=Sophos;i="5.96,193,1665471600"; d="scan'208";a="313174459"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2022 04:44:24 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="706058571"
X-IronPort-AV: E=Sophos;i="5.96,193,1665471600"; d="scan'208";a="706058571"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
 by fmsmga008.fm.intel.com with ESMTP; 25 Nov 2022 04:44:22 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1oyY45-00058x-1Z;
 Fri, 25 Nov 2022 12:44:21 +0000
Date: Fri, 25 Nov 2022 20:43:45 +0800
From: kernel test robot <lkp@intel.com>
To: Christian =?iso-8859-1?Q?K=F6nig?= <ckoenig.leichtzumerken@gmail.com>,
 Intel Graphics Development <intel-gfx@lists.freedesktop.org>,
 dri-devel@lists.freedesktop.org, amd-gfx@lists.freedesktop.org
Message-ID: <202211252058.982dp5ke-lkp@intel.com>
References: <20221125102137.1801-4-christian.koenig@amd.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="LNrhY3jJCYQbKZaL"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20221125102137.1801-4-christian.koenig@amd.com>
Subject: Re: [Intel-gfx] [PATCH 4/9] drm/ttm: merge ttm_bo_api.h and
 ttm_bo_driver.h
...
url:    https://github.com/intel-lab-lkp/linux/commits/Christian-K-nig/drm-amdgpu-generally-allow-over-commit-during-BO-allocation/20221125-182408
base:   git://anongit.freedesktop.org/drm/drm-tip drm-tip
patch link:    https://lore.kernel.org/r/20221125102137.1801-4-christian.koenig%40amd.com
patch subject: [PATCH 4/9] drm/ttm: merge ttm_bo_api.h and ttm_bo_driver.h
config: mips-allyesconfig
compiler: mips-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/a21274229ca31424e4dbd33b32a8e064c7541c32
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Christian-K-nig/drm-amdgpu-generally-allow-over-commit-during-BO-allocation/20221125-182408
        git checkout a21274229ca31424e4dbd33b32a8e064c7541c32
...
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  328  static int ttm_bo_kmap_ttm(struct ttm_buffer_object *bo,
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  329  			   unsigned long start_page,
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  330  			   unsigned long num_pages,
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  331  			   struct ttm_bo_kmap_obj *map)
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  332  {
d3116756a710e3 Christian König    2021-04-12  333  	struct ttm_resource *mem = bo->resource;
d0cef9fa4411eb Roger He           2017-12-21  334  	struct ttm_operation_ctx ctx = {
d0cef9fa4411eb Roger He           2017-12-21  335  		.interruptible = false,
d0cef9fa4411eb Roger He           2017-12-21  336  		.no_wait_gpu = false
d0cef9fa4411eb Roger He           2017-12-21  337  	};
62975d27d647a4 Christian König    2020-08-12  338  	struct ttm_tt *ttm = bo->ttm;
d0cef9fa4411eb Roger He           2017-12-21  339  	pgprot_t prot;
b1e5f172325547 Jerome Glisse      2011-11-02  340  	int ret;
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  341  
62975d27d647a4 Christian König    2020-08-12  342  	BUG_ON(!ttm);
b1e5f172325547 Jerome Glisse      2011-11-02  343  
0a667b500703db Dave Airlie        2020-08-25  344  	ret = ttm_tt_populate(bo->bdev, ttm, &ctx);
b1e5f172325547 Jerome Glisse      2011-11-02  345  	if (ret)
b1e5f172325547 Jerome Glisse      2011-11-02  346  		return ret;
b1e5f172325547 Jerome Glisse      2011-11-02  347  
ce65b874001d75 Christian König    2020-09-30  348  	if (num_pages == 1 && ttm->caching == ttm_cached) {
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  349  		/*
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  350  		 * We're mapping a single page, and the desired
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  351  		 * page protection is consistent with the bo.
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  352  		 */
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  353  
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  354  		map->bo_kmap_type = ttm_bo_map_kmap;
b1e5f172325547 Jerome Glisse      2011-11-02  355  		map->page = ttm->pages[start_page];
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  356  		map->virtual = kmap(map->page);
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  357  	} else {
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  358  		/*
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  359  		 * We need to use vmap to get the desired page protection
af901ca181d92a André Goddard Rosa 2009-11-14  360  		 * or to make the buffer object look contiguous.
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  361  		 */
867bcecd6ae463 Christian König    2020-09-30  362  		prot = ttm_io_prot(bo, mem, PAGE_KERNEL);
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  363  		map->bo_kmap_type = ttm_bo_map_vmap;
ba4e7d973dd09b Thomas Hellstrom   2009-06-10 @364  		map->virtual = vmap(ttm->pages + start_page, num_pages,
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  365  				    0, prot);
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  366  	}
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  367  	return (!map->virtual) ? -ENOMEM : 0;
ba4e7d973dd09b Thomas Hellstrom   2009-06-10  368  }
...
CONFIG_MIPS_CPS_NS16550_BOOL=y
CONFIG_MIPS_CPS_NS16550_BASE=0
CONFIG_MIPS_CPS_NS16550_SHIFT=0
CONFIG_MIPS_CPS_NS16550_WIDTH=1

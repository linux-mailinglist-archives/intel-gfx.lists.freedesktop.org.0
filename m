...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A958752879
	for <lists+intel-gfx@lfdr.de>; Thu, 13 Jul 2023 18:36:51 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A37410E060;
...
Subject: [Intel-gfx] [PATCH v4 00/21] fix DRM_USE_DYNAMIC_DEBUG regression

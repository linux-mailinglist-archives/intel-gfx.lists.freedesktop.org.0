...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C29021FF5F
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A13D46E9F5;
...
Subject: [Intel-gfx] [PATCH v2 53/59] drm/kmb: disable the LCD layer in EOF
 irq handler

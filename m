...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C2655990CF
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Aug 2022 01:03:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CD1A810E29F;
	Thu, 18 Aug 2022 23:03:23 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C5AF310E174;
 Thu, 18 Aug 2022 23:03:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1660863790; x=1692399790;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=p1x3IgBHWtd5qb5tu+O8LsJWLsXZC0Yxj39GLIal2ME=;
 b=GbBAUQdYB53/akXkE9dNuKP95CM7pxu6g3bUZi4uon4IHcp6Anf61wIq
 j3H+ipX65nd3ojqPsIEEh1st6fbsCyHVse/aFvZVJrCVD79ZZkkFfSC4B
 HBhwCzbBmoZd4koJnmIGaOE0rmsLgq2j/Lfx6JkDjJ02efiF3zKPlEEW0
 x0TYZR1H7f3YfE5YxzI+VTqqltgqFWG854DHk2+SqPzvM1TyGGAYVs/t1
 pDGpKBvbv6NgwCFLSu+FZhy5r4i8AucMU1rytK2S9UnWLAMR9YUYm7GLo
 ZRoP2bpR/3S6jVnBIIObsavRgXtNE/3NpaeP89R+jOQeqPSXiu8Zl+zqM w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10443"; a="293677522"
X-IronPort-AV: E=Sophos;i="5.93,247,1654585200"; d="scan'208";a="293677522"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Aug 2022 16:03:10 -0700
X-IronPort-AV: E=Sophos;i="5.93,247,1654585200"; d="scan'208";a="641042815"
Received: from valcore-skull-1.fm.intel.com ([10.1.27.19])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Aug 2022 16:03:10 -0700
From: Daniele Ceraolo Spurio <daniele.ceraolospurio@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 18 Aug 2022 16:02:29 -0700
Message-Id: <20220818230243.3921066-2-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 01/15] HAX: mei: GSC support for XeHP SDV and
 DG2 platform

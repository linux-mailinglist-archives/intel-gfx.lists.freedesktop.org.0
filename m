...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E4664E9F6C
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Mar 2022 21:07:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3121910EC6D;
	Mon, 28 Mar 2022 19:07:04 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v7 2/9] drm/i915/gt: Use XY_FAST_COLOR_BLT to

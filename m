...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E83E091E6C
	for <lists+intel-gfx@lfdr.de>; Mon, 19 Aug 2019 09:58:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A86C6E0BD;
	Mon, 19 Aug 2019 07:58:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BCD326E0AF
 for <intel-gfx@lists.freedesktop.org>; Mon, 19 Aug 2019 07:58:48 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18185108-1500050 
 for multiple; Mon, 19 Aug 2019 08:58:40 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Mon, 19 Aug 2019 08:58:32 +0100
Message-Id: <20190819075835.20065-16-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 15/18] drm/i915: Push the i915_active.retire
 into a worker
...
CiA4IGZpbGVzIGNoYW5nZWQsIDUyIGluc2VydGlvbnMoKyksIDYgZGVsZXRpb25zKC0pCgpkaWZm
...
IDcxOTM3OTc3NGZhNS4uZDYyODEwYzEyNTZhIDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
...
ciAqZnJvbnQgPQpAQCAtMjUwLDcgKzI1MSw4IEBAIGludGVsX2Zyb250YnVmZmVyX2dldChzdHJ1
...
NV9nZW1fY29udGV4dC5jCmluZGV4IGNkMWZkMmU1NDIzYS4uOGM5ZTRmOTc4ZDkxIDEwMDY0NAot
LS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9nZW0vaTkxNV9nZW1fY29udGV4dC5jCisrKyBiL2Ry
aXZlcnMvZ3B1L2RybS9pOTE1L2dlbS9pOTE1X2dlbV9jb250ZXh0LmMKQEAgLTg0NCw2ICs4NDQs
...
ZS5jIGIvZHJpdmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfdGltZWxpbmUuYwppbmRleCAwMmZi
ZTExYjY3MWIuLjIzMDFhMGZmZGZiZCAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUv
...


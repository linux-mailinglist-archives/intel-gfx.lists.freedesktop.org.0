...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E3F56BD0D9
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Mar 2023 14:29:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D94F110E19F;
	Thu, 16 Mar 2023 13:29:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EFC0010E19F
 for <intel-gfx@lists.freedesktop.org>; Thu, 16 Mar 2023 13:29:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678973390; x=1710509390;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=F9CfNkfVGwfw5AhGERoH7yh0sN4D8VqV43mYudM1z04=;
 b=A6XRLs1Hz7M4cX1IbXRMyjCVzGrMv2N679LAG3z1rUkEnW1ns5KtfiwC
 R1JsSrptR2W1PTlDYg+LjDdyf7ZAtRp0oF/X8/jhkVzMqlHQXiNNPQyAG
 pTi4Qb3XkJjf1Suxznn9RI+nm9DYx2XTYSSAAOf2g+O/3Qraq7EiT1TAI
 U1BUX7h3prXWrMdzAiRfLIGsdXawFlDvWyiZAIjWPnwiJT18XwzpFT3X6
 TAU5Uoam7FBS5rSEWUNViAPXv4vN0LUlm7+t1saLMQWKT/mB+HPJm6eVw
 1GYwNCemKcXJDTxJPfkZlOtrQpgm8Wzt/FsUi72qeKFR58cjtlYA8Nqhw Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="338004168"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="338004168"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 06:29:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10651"; a="710113549"
X-IronPort-AV: E=Sophos;i="5.98,265,1673942400"; d="scan'208";a="710113549"
Received: from jnikula-mobl4.fi.intel.com (HELO localhost) ([10.237.66.158])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Mar 2023 06:29:48 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 16 Mar 2023 15:29:31 +0200
Message-Id: <be4a946a7772f5b4483ad9e078cb62158849683e.1678973282.git.jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 2/7] drm/i915/tv: split out TV regs to a
 separate file
...
index 744d3bc92390..30e745762424 100644

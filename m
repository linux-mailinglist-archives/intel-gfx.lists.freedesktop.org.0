...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 287E66AD7BA
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Mar 2023 07:55:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8DA8E10E38F;
	Tue,  7 Mar 2023 06:55:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3751810E38F
 for <intel-gfx@lists.freedesktop.org>; Tue,  7 Mar 2023 06:55:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1678172104; x=1709708104;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=/ZQebeMHG0EmYK32RWPYwsgmRGGno8OT0C22zU0F9Ns=;
 b=DeRZDqMIDRl+5tQDRpUJWx2+yezA37PN5fyaq9d8ivBKtiOY7nHGkCT8
 Bx/wxqBUq3SlQGkoIL2Oyv8LomREhY6Up60N9wKBjyF/GasXofdQEu7Fu
 VBQIYNhOgIR+U1y4qM8yvCNWRpXNxpjd0Jm3Nx6sobE9hz5rDWlPgDtGb
 K0fU7MN56SfgH8poe+1/bgFvX1J3585wmDhqt0cyHtEUFVw6zqATARL5z
 TBhEWwti2q9sKgez7kQZv4ljzThDliaw19EM2q8KyWOkefEHrElYOuZgp
 DCmWx9gu626naUuYUvBap+6BmsK6DtSky+iUrDJyIxFkSOxigHUgH6A9O A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10641"; a="319609577"
X-IronPort-AV: E=Sophos;i="5.98,240,1673942400"; d="scan'208";a="319609577"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Mar 2023 22:55:03 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10641"; a="786579657"
X-IronPort-AV: E=Sophos;i="5.98,240,1673942400"; d="scan'208";a="786579657"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.32])
 by fmsmga002.fm.intel.com with ESMTP; 06 Mar 2023 22:55:00 -0800
From: Suraj Kandpal <suraj.kandpal@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  7 Mar 2023 12:23:56 +0530
Message-Id: <20230307065356.181278-7-suraj.kandpal@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 6/6] drm/i915/mtl: Add HDCP GSC interface
...
index b0e8bba90833..597c9e073c84 100644
...
@@ -2232,6 +2240,9 @@ static int initialize_hdcp_port_data(struct intel_connector *connector,
...
@@ -2253,10 +2264,14 @@ void intel_hdcp_component_init(struct drm_i915_private *dev_priv)
...
@@ -2483,7 +2498,10 @@ void intel_hdcp_component_fini(struct drm_i915_private *dev_priv)
 	dev_priv->display.hdcp.comp_added = false;
 	mutex_unlock(&dev_priv->display.hdcp.comp_mutex);

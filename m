...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE063C4C687
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Nov 2025 09:32:46 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 698FB10E137;
	Tue, 11 Nov 2025 08:32:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.b="MUQC5zna";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="ZuJypq8M";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="MUQC5zna";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="ZuJypq8M";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.223.130])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3E65010E4FF
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Nov 2025 08:32:44 +0000 (UTC)
Received: from imap1.dmz-prg2.suse.org (imap1.dmz-prg2.suse.org
 [IPv6:2a07:de40:b281:104:10:150:64:97])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by smtp-out1.suse.de (Postfix) with ESMTPS id C812521261;
 Tue, 11 Nov 2025 08:32:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1762849962; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=xgEV7V0fMCqTmDqHBpt7OR6gjghmqbSJMu2OeMLr9uA=;
 b=MUQC5znaCtFay5ByPDE+Kkl6SHFVyewI8WQ1MFqP98Df8ikE1gmMa0CUeew51uN+GjsLFL
 vXjNuX4Kud1oE8We3AhM9zTSpmPA2X+0YgPHSErlQheXCBb/M3y9SZzRW3ZHdfn373MxYQ
 drAVBeLzXnL/hIaLXZFlv89jbofU8QE=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 s=susede2_ed25519; t=1762849962;
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
 bh=xgEV7V0fMCqTmDqHBpt7OR6gjghmqbSJMu2OeMLr9uA=;
 b=ZuJypq8MkRBNTIz0K5vVtOWjeMk1eOFku+jgrM40IvvkAFhOiOM8mRT2NF/CKC1Z79YZgH
 Hw0fB5foHpWBxNDQ==
Authentication-Results: smtp-out1.suse.de;
 dkim=pass header.d=suse.de header.s=susede2_rsa header.b=MUQC5zna;
 dkim=pass header.d=suse.de header.s=susede2_ed25519 header.b=ZuJypq8M
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 t=1762849962; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
 mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
...
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
 ...
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 9AFF714874;
 Tue, 11 Nov 2025 08:32:42 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
 by imap1.dmz-prg2.suse.org with ESMTPSA id UChtJKr0Eml5NgAAD6G6ig
 (envelope-from <tzimmermann@suse.de>); Tue, 11 Nov 2025 08:32:42 +0000
Message-ID: <6845f801-2105-4500-b088-3f53bbab63ba@suse.de>
Date: Tue, 11 Nov 2025 09:32:42 +0100
MIME-Version: 1.0
...
In-Reply-To: <0bc4fa981f31122651abc13e5b6b8d92bbc9585a.1762791343.git.jani.nikula@intel.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
X-Spam-Level: 
X-Spam-Flag: NO
X-Rspamd-Queue-Id: C812521261
...
X-Spamd-Result: default: False [-4.51 / 50.00]; BAYES_HAM(-3.00)[100.00%];
 ...
 DBL_BLOCKED_OPENRESOLVER(0.00)[imap1.dmz-prg2.suse.org:rdns,imap1.dmz-prg2.suse.org:helo,suse.com:url,suse.de:dkim,suse.de:mid,intel.com:email];

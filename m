...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 71DB2647704
	for <lists+intel-gfx@lfdr.de>; Thu,  8 Dec 2022 21:13:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 516D910E4CC;
	Thu,  8 Dec 2022 20:12:50 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2872510E4CC;
 Thu,  8 Dec 2022 20:12:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670530364; x=1702066364;
 h=message-id:date:subject:to:cc:references:from:
 in-reply-to:content-transfer-encoding:mime-version;
 bh=L338AEYAN7wsHZcpesTWqsqV2TxnQxL7DbYT/NfsuvU=;
 b=XVo/Z+fvVHsBty9+KUSmJDPZyg63nDhhTKDzx/irbgJ7nvTIw23doRp/
 FQ8F0PhvxaCQNWYPMWTtsh/M+6YHg5P3xEE4xfK3Ql7dH3xdF3a4RGJbj
 POecEhBPMa3oYrN/vXws7mlEHdkhkMIhpgLakUrJiUI0g2djBWamO2B6b
 DJSd3+9REepCekP+1r/Y/FMFpW35OukLQLNmZURBRnYVd+m7dW/QieHT3
 5enA11GURThdJSkEoqlOyj8Xp7ModKF/0X+pOlc9zN+dcYeT2CryjPYMe
 XUvPt5S7JFTWyUaLOXoFMs+zx1Ri/RJjX19i6vmcltohtAL7wRrE3I1H3 g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10555"; a="318442042"
X-IronPort-AV: E=Sophos;i="5.96,227,1665471600"; d="scan'208";a="318442042"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2022 12:12:42 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10555"; a="735951636"
X-IronPort-AV: E=Sophos;i="5.96,227,1665471600"; d="scan'208";a="735951636"
Received: from orsmsx603.amr.corp.intel.com ([10.22.229.16])
 by FMSMGA003.fm.intel.com with ESMTP; 08 Dec 2022 12:12:41 -0800
Received: from orsmsx610.amr.corp.intel.com (10.22.229.23) by
 ORSMSX603.amr.corp.intel.com (10.22.229.16) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.16; Thu, 8 Dec 2022 12:12:39 -0800
Received: from orsedg603.ED.cps.intel.com (10.7.248.4) by
 orsmsx610.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.16 via Frontend Transport; Thu, 8 Dec 2022 12:12:39 -0800
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (104.47.59.174)
 by edgegateway.intel.com (134.134.137.100) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.16; Thu, 8 Dec 2022 12:12:39 -0800
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=Tf0tuaUfJasKyGRYa53JpKuwXIORZwcTKjFRXsSwn9A=;
 b=
...
Received: from DM4PR11MB5488.namprd11.prod.outlook.com (2603:10b6:5:39d::5) by
 DM4PR11MB6478.namprd11.prod.outlook.com (2603:10b6:8:89::18) with
 Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.5880.14; Thu, 8 Dec 2022 20:12:37 +0000
Received: from DM4PR11MB5488.namprd11.prod.outlook.com
 ([fe80::f7a8:6d03:2464:2afd]) by DM4PR11MB5488.namprd11.prod.outlook.com
 ([fe80::f7a8:6d03:2464:2afd%6]) with mapi id 15.20.5880.016; Thu, 8 Dec 2022
 20:12:37 +0000
Message-ID: <49e4d18e-1e0a-152d-6540-aff83e0873a1@intel.com>
Date: Thu, 8 Dec 2022 12:12:34 -0800
...
X-MS-TrafficTypeDiagnostic: DM4PR11MB5488:EE_|DM4PR11MB6478:EE_
X-MS-Office365-Filtering-Correlation-Id: d2dba032-96e0-4c01-047a-08dad9588cc0
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DM4PR11MB5488.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230022)(136003)(396003)(376002)(366004)(346002)(39860400002)(451199015)(83380400001)(31696002)(8676002)(41300700001)(5660300002)(4326008)(82960400001)(2906002)(30864003)(86362001)(8936002)(966005)(53546011)(6512007)(26005)(6506007)(186003)(6666004)(316002)(66476007)(478600001)(66556008)(54906003)(2616005)(6486002)(66946007)(31686004)(38100700002)(36756003)(43740500002)(45980500001)(579004);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?utf-8?B?U2grcUlHMzF6anVtQW5MVytSSkJWUFJQcFBLTEN2T2tQb09mYnFyQzBGSGFv?=
 =?utf-8?B?K1VoTWFHazVJT2x0YWR0SmUwUzViNmErTFY3eTR6QzAxWFAvMGNKRE9LalBC?=
 =?utf-8?B?ZHh0RkhqZVB6YkFwdG9mQWxueE1DQnJvRGp6SUcwUjduZkkyVm5MbGpsZ1hT?=
 =?utf-8?B?UU9SYWMrVU5IRFVwMFM1b3p0a1pTMkR6azY4OTJTeUFYam5BajU1ZjNGTDRB?=
 =?utf-8?B?dG50aDU5ZFY3ekIxSHhHRmcveTk1Rmt0OVV3OW8ydlFjUXBVbkVLSHRIVm9C?=
 =?utf-8?B?SmFNTWUxV1d3U0VSeURZdE5OWVMzanhZeVZTNi84WHZIa0lVek5iOHplK1Jn?=
 =?utf-8?B?YXkvanNUNFNxRmJNdHZtWnd3eDNJOHF6YmdHbFVZT2lzSGFTaUVLM0cvR3Yy?=
 =?utf-8?B?WE9qVGdEMWREQ0hzc0c3S3d4aW14cVNpNWpHTmdqK1VrTGdPV2JsaHhEZVRJ?=
 =?utf-8?B?ZHRZNmswcko4SUhmVTMwcnhrZld2TUoybDlEY2VlOXBSVFhXSzVpejRrdlJz?=
 =?utf-8?B?TmFkNU9DcG8xL1Y1bFpoSTZLYjVLd244UHpXVGN6Y0lYQkdhMVMvajg4RzM4?=
 =?utf-8?B?djU2TTIxbGVVOEdBcVlqcDRjWnN5MEU3WjlveUJHbG1LRWhoMUxJUUVpbVFC?=
 =?utf-8?B?QkxITUI1L2VMVXdwUFpPM2wvNmU2QzVrN3FBWW1tMTFFbWs3L2Z5ak92R3Fa?=
 =?utf-8?B?ZGx3aWxGbzdMZ0RhcmhsNUxwSUFHem5KMXhhOTdCUERIcURiMHdJeTZ3ejJv?=
 =?utf-8?B?L0NVM29Eb2YzclEzOFhsOFVoSFNIQmFlU1BzMXlRNHhTd01rWFNNd2tuYU5p?=
 =?utf-8?B?dTRONGVSQlN4ejNPZDZGdno0TkUrdTkrNGlpUExFZHIxWFZoRnZVcDF6bE8y?=
 =?utf-8?B?QXQvS0tWYkZVNFROa05pUTZYZU5vdTVkSE82VS9mN2tnL20wc1hBNk03dVph?=
 =?utf-8?B?Tll6OGo1c3dmaWE3QlJtZi9oTGFldkdTcDUxL2RUQXRxSlpTNkFYSmoweGtM?=
 =?utf-8?B?L0ptN3ErYXVvbDE4Z0lFSGVmTVV4WVhuakxqRkJFKzJlbVEwTWtFZGtpQUJS?=
 =?utf-8?B?cHVUdzJ0b1U5UGVOUGNBaWFuKzdwK0FqSGI4Zi9UeWdieFVOWUVXYVBLZVBF?=
 =?utf-8?B?cWc3b3ZLQkZpbUc4YXNUNENLdzVvZEpEMFNLR3V6bzRqQzNHRGFTWXpPaS9l?=
 =?utf-8?B?bFBvMmZ1bTBuUDVuSnk2cHB1c2VIcDlQRWhXbDNKYXNCWGdhdWp5cE56cXNw?=
 =?utf-8?B?YW96SkpLLzc5ZHRPamlZWnhxZVQrdTlucGkya3R4SDZvMWFkNzZBdjd0Y2sx?=
 =?utf-8?B?RkhlU255bmRGTlFBYy8yblJDTm9wNzhBNnRWdHFWK29Ud29NeFNDb0pOYVpT?=
 =?utf-8?B?ZzZMdy96VWJLNElZODM0R2xLdUppVTZvUW1xWTVNWXBncW81SUZMd3ZzYVJz?=
 =?utf-8?B?Q3o3SU81QWM3Zm1ZVWNHQWtNNjVjTEx2VUtzRitxZUM2bEV1YUY5aHFZNGl3?=
 =?utf-8?B?L1gzK2lYRHkvVDBnZkVVb3VmMWRkRUcvRmsvUndqWWppTmovdEF1UmE5UGQ2?=
 =?utf-8?B?eGlXcUNwOHpyLy9YZExZUFplQi90ejBwR25wV3Z4cWFZQ2JWK3dDY2NZU1ow?=
 =?utf-8?B?L3hQSGdTenp6RUE5K2tIbmsrMWpUTm9WWnFsayt4Zk55SElBQkg3WDhhbnpL?=
 =?utf-8?B?TzJRL3NKWTQ2UnVPYVlTWHZIWlhWc3BLcm45QWpveVh4ODVlb3owVWd1d1VV?=
 =?utf-8?B?MDlOcGhHQWQ4d1hya1VJSTA5SXVSS1cyaFcrVUJwTWZUR0VJQXhtTXYzZDcw?=
 =?utf-8?B?UHZXazFJWTR4aXdHT1ZtV3BzaE1sb1pkN05qWEFjbms1TTRxY0padEZ1Wng2?=
 =?utf-8?B?aXdWTHl3QnVzYkFjMHJnYXQ4RWEyT1hvVVhlUXhDaEptamRqdW9GcjI4SUF4?=
 =?utf-8?B?ZXpzcm15ejdYeGtoc1VraHNUNFVhRmdNQ0FRdnRnMjd2RDd3OGJ2dUZ5TUpq?=
 =?utf-8?B?VFdZRmd3QkNUZ2I4ay9PQlNuaWFTN3MxMlh6aDhlejBVaURnR1BHcHBZd0xP?=
 =?utf-8?B?S0N5eTNBZ29oSnh4b3dMeE8wdTFrT0Q1dUs3Y1dLYkpYUFlXMk5pb2dKcVNJ?=
 =?utf-8?B?UHg2aTRzR2V6VkdLVnVuSEhOV1l1bkZ6bzBUNkIxMm44bE9IR3hqV09jY0Q4?=
 =?utf-8?Q?NVtO2C5zos6lvUjjXojwKbU=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: d2dba032-96e0-4c01-047a-08dad9588cc0
X-MS-Exchange-CrossTenant-AuthSource: DM4PR11MB5488.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Dec 2022 20:12:37.0433 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: OshA8k9fOjrE84KMtqMOXb5+1V+l3+z3WOPVwnYk7+BUfsQs1xeLvUtnpV2WVLTQppNF2vWqhIdZq84j+z84mmMU9hqxbwOgTxrrzMVA+pQ=
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DM4PR11MB6478
X-OriginatorOrg: intel.com
Subject: Re: [Intel-gfx] [PATCH v12 1/1] drm/i915/pxp: Promote pxp subsystem
...
I've checked the updates compared to the version I've reviewed (v9) and 
didn't spot any issues, so my r-b stands
...
> index 86956b902c97..192bb3f10733 100644
> --- a/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
> +++ b/drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
> @@ -872,7 +872,7 @@ static struct i915_vma *eb_lookup_vma(struct i915_execbuffer *eb, u32 handle)
>   		 */
...
> index 4e7af9bc73ad..63f95c5f3614 100644
...
>
> base-commit: 77e03ccd7fc350435bb8b82cb5d5126bea437113

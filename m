...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CACE740EC87
	for <lists+intel-gfx@lfdr.de>; Thu, 16 Sep 2021 23:26:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D94C96EA09;
...
Subject: [Intel-gfx] [PATCH 05/15] drm/vmwgfx: cleanup:

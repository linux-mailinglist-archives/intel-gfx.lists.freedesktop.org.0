...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 0HRhE7Jrw2kqqwQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 05:59:30 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A875831FC1D
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 05:59:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2211A10E757;
	Wed, 25 Mar 2026 04:59:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="E2QaNnwz";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5720C10E757;
 Wed, 25 Mar 2026 04:59:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1774414767; x=1805950767;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=CP65R/IEQZzag0vKgwfPJXBmQGHeywX1xcBkDgECdy4=;
 b=E2QaNnwzp2oIdSFWjDQg6ZeZlvZobcG/lO0em+kVa9zEfbwCzAVeEwhd
 fYT87+8/JbdVNlXHnIohirTsM67K3jvxntvod0hjrbIVHE+Xt8k7WrLWj
 zl11ZDCx3dZdMDTr0bx15dovsYi5hI25fzNZLcOgAmxhl/fUBkooBiNpe
 NGRs9tX7GzMjD14jd1VBUGsG4QWiOasVYntMBvzRigERpu1Qyn7dtECkV
 P7TQoYG1z0D8F4Nmu3/9KrlVprwPnfdGzK4rJiSGMTzikzA73dO2v6OTS
 SVDyDJI0GU2jE8W/k+pq3AhCa0Lak46z84NS+UTEwHLqhtXOKPoNBV4vj Q==;
X-CSE-ConnectionGUID: TVdu0FvrQLmN+4aQtdsl4A==
X-CSE-MsgGUID: uEaYJsOlRdmB51MLjArKlg==
X-IronPort-AV: E=McAfee;i="6800,10657,11739"; a="86922204"
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; d="scan'208";a="86922204"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Mar 2026 21:59:27 -0700
X-CSE-ConnectionGUID: kNLUx8cHRFSvvf/5NL5zUA==
X-CSE-MsgGUID: 1l9ZEHhOS0G1fvMaaBhC0Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,139,1770624000"; d="scan'208";a="224580480"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by orviesa008.jf.intel.com with ESMTP; 24 Mar 2026 21:59:24 -0700
...
Subject: [PATCH v2 DO NOT REVIEW 01/26] drm: writeback: rename
 drm_writeback_connector_init_with_encoder()
Date: Wed, 25 Mar 2026 10:28:51 +0530
Message-Id: <20260325045916.984243-2-suraj.kandpal@intel.com>
...
X-Spamd-Result: default: False [0.19 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:dkim,intel.com:email,intel.com:mid,gabe.freedesktop.org:helo,gabe.freedesktop.org:rdns,qualcomm.com:email,bootlin.com:email]
X-Rspamd-Queue-Id: A875831FC1D
...
index dfe95c9b8746..2f2b1b115bf2 100644

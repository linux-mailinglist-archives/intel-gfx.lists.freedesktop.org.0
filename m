...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B79CE194209
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Mar 2020 15:52:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 143916E8D9;
	Thu, 26 Mar 2020 14:52:28 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8B5906E8DC
 for <intel-gfx@lists.freedesktop.org>; Thu, 26 Mar 2020 14:52:22 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 20701708-1500050 
 for multiple; Thu, 26 Mar 2020 14:52:03 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 26 Mar 2020 14:51:58 +0000
Message-Id: <20200326145159.27431-11-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 11/12] drm/i915/gt: Yield the timeslice if
...
index b12355048501..13466073b92d 100644
...
@@ -1768,6 +1769,31 @@ need_timeslice(struct intel_engine_cs *engine, const struct i915_request *rq)
...
+
 ...
 {
@@ -1783,8 +1809,7 @@ timeslice(const struct intel_engine_cs *engine)
...
@@ -1946,13 +1971,14 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
...
+				     yesno(timeslice_yield(execlists, last)));
 			...
 			defer_active(engine);
@@ -2213,6 +2239,7 @@ static void execlists_dequeue(struct intel_engine_cs *engine)
 		}
...
@@ -4455,6 +4482,7 @@ logical_ring_default_irqs(struct intel_engine_cs *engine)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 171046C0E43
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Mar 2023 11:09:27 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id ECA3910E2D4;
	Mon, 20 Mar 2023 10:09:15 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 2/3] drm/i915/display: Add helper func to get

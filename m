...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0E74796DF5
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Sep 2023 02:20:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEAE010E73C;
...
Subject: [Intel-gfx] [PATCH v1 1/1] drm/i915/pxp: Add drm_dbgs for critical
 PXP events.

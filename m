...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC68E2DBAB3
	for <lists+intel-gfx@lfdr.de>; Wed, 16 Dec 2020 06:37:49 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AEB2C89CFA;
...
Subject: [Intel-gfx] [PATCH v5 03/15] drm/edid: Parse DSC1.2 cap fields from
 HFVSDB block

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DC962878C5
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Aug 2019 13:38:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 466216EDB2;
	Fri,  9 Aug 2019 11:38:39 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 20/41] fbdev/pvr2fb: convert put_page()
 to put_user_page*()

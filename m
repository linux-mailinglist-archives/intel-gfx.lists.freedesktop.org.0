...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CA79B78C92D
	for <lists+intel-gfx@lfdr.de>; Tue, 29 Aug 2023 18:01:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D927A10E429;
...
Subject: [Intel-gfx] [RFC 21/33] drm/i915/color: Create and attach set color
 pipeline property

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D7BB21FF50
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C93946E9EF;
...
Subject: [Intel-gfx] [PATCH v2 34/59] drm/kmb: Enable MSS_CAM_CLK_CTRL for
 LCD and MIPI

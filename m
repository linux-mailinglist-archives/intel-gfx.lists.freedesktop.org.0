...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 438022C5CF6
	for <lists+intel-gfx@lfdr.de>; Thu, 26 Nov 2020 21:29:50 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 708A56E9EF;
	Thu, 26 Nov 2020 20:29:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CBD686E9EF
 for <intel-gfx@lists.freedesktop.org>; Thu, 26 Nov 2020 20:29:46 +0000 (UTC)
IronPort-SDR: byVXWIu2mZlSipCUSQwepY6wK06C9U+/bjKy/xjhT6uyPzD+JaQnBIKUAABLa5WXYZIT+wNGFZ
 feBiqxYkDZGw==
X-IronPort-AV: E=McAfee;i="6000,8403,9817"; a="171543131"
X-IronPort-AV: E=Sophos;i="5.78,373,1599548400"; d="scan'208";a="171543131"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Nov 2020 12:29:46 -0800
IronPort-SDR: LB2YE9lHIoESo8Z/cbLIZR8Sw/1pVO/mXwp3A4Majp+bB1VlDRXv1k/pRc8vmNeKgwdjIS6ay1
 /kfhfherLaxQ==
X-IronPort-AV: E=Sophos;i="5.78,373,1599548400"; d="scan'208";a="479459498"
Received: from linux-desktop.iind.intel.com ([10.223.34.173])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 26 Nov 2020 12:29:45 -0800
From: Uma Shankar <uma.shankar@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 27 Nov 2020 02:33:02 +0530
Message-Id: <20201126210314.7882-4-uma.shankar@intel.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20201126210314.7882-1-uma.shankar@intel.com>
References: <20201126210314.7882-1-uma.shankar@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [v12 03/15] drm/i915/display: Attach HDR property for

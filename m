...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mMfeIAjCw2n6twQAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 12:07:52 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E303D323853
	for <lists+intel-gfx@lfdr.de>; Wed, 25 Mar 2026 12:07:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70D9F10E845;
	Wed, 25 Mar 2026 11:07:50 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="S3Vlmm6p";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CC19710E6C7;
 Wed, 25 Mar 2026 11:07:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1774436869; x=1805972869;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=EbzFn6FEYRGvb0N51MoOPHw2yIQ2QC6YxptM48GzyAg=;
 b=S3Vlmm6pWYcGpenmT5SAZ0wfLR6b6PUXSdRcqhqyxVbcENgAvGXlzDWP
 WfLacy+2EG89hLgkAfWD8yvLp3vmS0CWkNNP2brFaK6K/cssn/6+aGVbJ
 QgBlwPGhK2G3OfzWbkkWyew4Tg410dc0gy8Hrw0PH6KTugacNh1nM24kf
 GQz/zmDkKb425NlD9D8aBrF+PlZQpnRwThD8V9TN7cyeXfJ7AatTQ/+mH
 /pboyjV81NIcWGhSV0MfqWoVDTBEFRQw9v4a2rP+dAuXo2RP31CDUpgI7
 jyO86saTP3A/Aln3ZL/Yfpp8zOzRCH84O0RiJ31OGVpUVkfU1Q+95t6VP Q==;
X-CSE-ConnectionGUID: r6aX2mLEQzq6H+s7EWTcPA==
X-CSE-MsgGUID: YxNeOnlfQ4+TeT2ygsMe7w==
X-IronPort-AV: E=McAfee;i="6800,10657,11739"; a="93047480"
X-IronPort-AV: E=Sophos;i="6.23,140,1770624000"; d="scan'208";a="93047480"
Received: from fmviesa006.fm.intel.com ([10.60.135.146])
 by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Mar 2026 04:07:48 -0700
X-CSE-ConnectionGUID: CQrhTM9MRW6fivPJEsWV1Q==
X-CSE-MsgGUID: rkMZw1H7TJ2hzCzmzhVhrA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.23,140,1770624000"; d="scan'208";a="219798240"
Received: from kandpal-x299-ud4-pro.iind.intel.com ([10.190.239.10])
 by fmviesa006.fm.intel.com with ESMTP; 25 Mar 2026 04:07:46 -0700
...
Subject: [PATCH v3 00/26] Enable Pipe writeback  
Date: Wed, 25 Mar 2026 16:37:18 +0530
Message-Id: <20260325110744.1096786-1-suraj.kandpal@intel.com>
...
Suraj Kandpal (25):
 ...
 .../gpu/drm/i915/display/intel_writeback.c    | 651 ++++++++++++++++++
 ...
 47 files changed, 1288 insertions(+), 336 deletions(-)

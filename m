...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1793928FDE7
	for <lists+intel-gfx@lfdr.de>; Fri, 16 Oct 2020 08:00:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 539776E9AB;
	Fri, 16 Oct 2020 06:00:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 493F96E9AB;
 Fri, 16 Oct 2020 06:00:05 +0000 (UTC)
IronPort-SDR: A1NXnv0oidAmnbdIXg8TT8CTY4sTtjsSa4KAZQCW/+AhVBbCph23+DqydVnz+bo/W4uUrzUlFb
 6e1+IJb02UFQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9775"; a="146395997"
X-IronPort-AV: E=Sophos;i="5.77,381,1596524400"; d="scan'208";a="146395997"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Oct 2020 23:00:04 -0700
IronPort-SDR: S6s8DQlDpN0CBcvRiTlsOX+9UbxLb42rdF6RWcLQumKx0UmY+lYw/UB1+okRUDZR5VlGRffXxX
 EpC1y6GkaHUw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,381,1596524400"; d="scan'208";a="346428636"
Received: from unknown (HELO coxu-arch-shz.sh.intel.com) ([10.239.160.24])
 by fmsmga004.fm.intel.com with ESMTP; 15 Oct 2020 23:00:02 -0700
From: Colin Xu <colin.xu@intel.com>
To: intel-gvt-dev@lists.freedesktop.org, intel-gfx@lists.freedesktop.org,
 zhenyuw@linux.intel.com
Date: Fri, 16 Oct 2020 13:59:59 +0800
Message-Id: <20201016055959.295529-1-colin.xu@intel.com>
X-Mailer: git-send-email 2.28.0
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 1/2] drm/i915/gvt: Save/restore HW status for
 GVT during suspend/resume

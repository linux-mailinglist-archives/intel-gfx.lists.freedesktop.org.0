...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C9D782E56
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2019 11:06:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 24CB86E33E;
	Tue,  6 Aug 2019 09:06:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0A58C6E33A
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Aug 2019 09:05:58 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17901477-1500050 
 for multiple; Tue, 06 Aug 2019 10:05:40 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Aug 2019 10:05:32 +0100
Message-Id: <20190806090535.14807-19-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 19/22] drm/i915: Forgo last_fence active request
 tracking
...
IDVlZGRmNTRkZGRiOS4uMjNhYTk3ZTA5MWQ1IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0v
aTkxNS9pOTE1X2RlYnVnZnMuYworKysgYi9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2RlYnVn
ZnMuYwpAQCAtMjExLDkgKzIxMSw3IEBAIGRlc2NyaWJlX29iaihzdHJ1Y3Qgc2VxX2ZpbGUgKm0s
...
dmVycy9ncHUvZHJtL2k5MTUvaTkxNV9nZW1fZ3R0LmMKaW5kZXggYzMwMjg3MjJkNGUzLi41Mzky
NjlkMmRiMWIgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfZ2VtX2d0dC5j
...
MDFhMmJiNDE2YTYuLjIwNzBmOWIwMGJjNiAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5
...
CkBAIC05MjcsOSArOTI0LDYgQEAgaW50IGk5MTVfdm1hX21vdmVfdG9fYWN0aXZlKHN0cnVjdCBp
...
OwogfQpAQCAtOTYwLDE0ICs5NTQsNyBAQCBpbnQgaTkxNV92bWFfdW5iaW5kKHN0cnVjdCBpOTE1

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 11C53570BA5
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:27:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8836911BE36;
...
Subject: [Intel-gfx] [PATCH 03/32] drm/i915: gt: fix some Kernel-doc issues

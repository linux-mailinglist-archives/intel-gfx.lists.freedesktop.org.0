...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F4072E030E
	for <lists+intel-gfx@lfdr.de>; Tue, 22 Dec 2020 00:52:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DADCC6E042;
	Mon, 21 Dec 2020 23:52:11 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B2F9589CF5
 for <Intel-gfx@lists.freedesktop.org>; Mon, 21 Dec 2020 23:52:06 +0000 (UTC)
IronPort-SDR: L1HFc69kXy0T34lR489S3UbAjT0pHIDYxCF+E+baKF105+g+4qKyHfJXgvieuJHByfjyGJEmjB
 SMVo2loHjDVQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9842"; a="194230609"
X-IronPort-AV: E=Sophos;i="5.78,437,1599548400"; d="scan'208";a="194230609"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 21 Dec 2020 15:52:04 -0800
IronPort-SDR: dmNH5Udh7QZbA4/YvdM13CXrRAK5QtlYGL8SkA2fWbeI7HTkWpRB7oPfb92eDPH8jZ7+yh58Zm
 VZffEXX4aBkA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,437,1599548400"; d="scan'208";a="416109400"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by orsmga001.jf.intel.com with ESMTP; 21 Dec 2020 15:52:04 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Mon, 21 Dec 2020 15:51:54 -0800
Message-Id: <20201221235204.1977-4-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201221235204.1977-1-sean.z.huang@intel.com>
References: <20201221235204.1977-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v14 03/13] drm/i915/pxp: Implement funcs to create
 the TEE channel

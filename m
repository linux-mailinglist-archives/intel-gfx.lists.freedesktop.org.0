...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C9BCB741613
	for <lists+intel-gfx@lfdr.de>; Wed, 28 Jun 2023 18:12:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0968C10E12E;
	Wed, 28 Jun 2023 16:12:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 79E7810E379
 for <intel-gfx@lists.freedesktop.org>; Wed, 28 Jun 2023 16:12:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1687968738; x=1719504738;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=zV5Y0+OYTNNiyA8UzfcxVz+oSKIEhkp/7iZYGZb3zfY=;
 b=O5XVFVfsY8bbcqUziAsAZTH3P1z69wDa5+IiJmCL9bK5br/iq/TtwUlg
 7cTtpHcOZe9HEaHPmYEmYx4lgM2GMTSj5BXjLBXi+ge/AOqbhq8F3Bndq
 zzObMJx6Vod4sLWPuegJ3c3QYb6FqPlUyw3FUV87A1FwSIxfZ+5gCUx1+
 HDQiuJKLj+bSaLtrtCUCu484cBNV5pVXBBYyJa9yoVpMySs+JuFy+Gy0K
 y3OVGgcQ1o0jdqg9IHvQbOKVLs73W02aXP2VXKOR6kZMx2+1P+YSZ6M0J
 YRgI8KFO7J0IvnIEvcvi2v/ZQNdyf4xL4MCcuQnVj7BcvXXRnrITc5qVX w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10755"; a="392613376"
X-IronPort-AV: E=Sophos;i="6.01,165,1684825200"; d="scan'208";a="392613376"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Jun 2023 09:09:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10755"; a="830180695"
X-IronPort-AV: E=Sophos;i="6.01,165,1684825200"; d="scan'208";a="830180695"
Received: from mgolanimitul-x299-ud4-pro.iind.intel.com ([10.190.239.114])
 by fmsmga002.fm.intel.com with ESMTP; 28 Jun 2023 09:09:47 -0700
From: Mitul Golani <mitulkumar.ajitkumar.golani@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 28 Jun 2023 21:41:01 +0530
Message-Id: <20230628161103.2877959-2-mitulkumar.ajitkumar.golani@intel.com>
...
Subject: [Intel-gfx] [RFC 1/3] drm/i915: Add has_audio to separate audio

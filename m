...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id C679B2D547C
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Dec 2020 08:25:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8A6D86E528;
	Thu, 10 Dec 2020 07:25:10 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A81536E3E3
 for <Intel-gfx@lists.freedesktop.org>; Thu, 10 Dec 2020 07:25:09 +0000 (UTC)
IronPort-SDR: 3mvEENk88WKLeR2oyDnGpA/xgqe0/qtPWkLUWCo/JuBFrbGbsnMFYuNE+cl3aE2BdfXwn+WjtM
 diFmKHvmfPwQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9830"; a="170701300"
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; d="scan'208";a="170701300"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 09 Dec 2020 23:25:08 -0800
IronPort-SDR: l3BRy2EbpNI+8UBMFiDRJ3jHBAed5xecEEvAEURQQUM+ctgBCr1yralMXO0yVU94e9wxI3F4Ff
 gLaWdZTLDRaA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; d="scan'208";a="318867190"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga008.fm.intel.com with ESMTP; 09 Dec 2020 23:25:08 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed,  9 Dec 2020 23:24:18 -0800
Message-Id: <20201210072435.24066-5-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20201210072435.24066-1-sean.z.huang@intel.com>
References: <20201210072435.24066-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v4 04/21] drm/i915/pxp: Create the arbitrary
 session after boot

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F62954286C
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 09:51:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF56B10EE41;
...
Subject: [Intel-gfx] [PATCH v2 05/15] drm/edid: add new interfaces around
 struct drm_edid

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 690F84FB819
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Apr 2022 11:48:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C81FE10F329;
...
Subject: [Intel-gfx] [CI v2 09/12] drm/edid: convert extension block read to

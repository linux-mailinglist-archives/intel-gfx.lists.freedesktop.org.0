...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6844F7C90D2
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 00:49:28 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DF2810E659;
...
Subject: [Intel-gfx] [PATCH v7b 10/25] dyndbg: tighten ddebug_class_name()
 1st arg type

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A3F64F3882
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Apr 2022 16:34:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC70210E8DD;
...
Subject: [Intel-gfx] [PATCH v8 7/9] drm/i915/selftest_migrate: Check CCS
 meta data clear

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D109F7F5B33
	for <lists+intel-gfx@lfdr.de>; Thu, 23 Nov 2023 10:40:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8EC6810E034;
...
Subject: [Intel-gfx] [PATCH v5 00/20] remove I2C_CLASS_DDC support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DCD52C653F
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:13:17 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B08B76EC90;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 118/162] drm/i915/dg1: Reserve first 1MB of
 local memory

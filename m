...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 49D732B1882
	for <lists+intel-gfx@lfdr.de>; Fri, 13 Nov 2020 10:41:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1ECE26E49B;
	Fri, 13 Nov 2020 09:41:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (unknown [77.68.26.236])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4230F6E47A
 for <intel-gfx@lists.freedesktop.org>; Fri, 13 Nov 2020 09:41:42 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 22980370-1500050 
 for multiple; Fri, 13 Nov 2020 09:41:35 +0000
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 13 Nov 2020 09:41:24 +0000
Message-Id: <20201113094128.8740-29-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 29/33] drm/i915/gt: Track timeline GGTT offset
...
index 8ba731694a4f..9cf6e001ce51 100644
--- a/drivers/gpu/drm/i915/gt/intel_engine_cs.c
+++ b/drivers/gpu/drm/i915/gt/intel_engine_cs.c
@@ -1332,7 +1332,7 @@ static int print_ring(char *buf, int sz, struct i915_request *rq)
...
index 9a9cc29c8ffd..cf767b503a1c 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3565,7 +3565,7 @@ static u32 hwsp_offset(const struct i915_request *rq)
 	if (cl)
...
index 85937f41cf8d..eb34a39fee5f 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 58A6021FF23
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 22:59:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 06CAE6E9BB;
...
Subject: [Intel-gfx] [PATCH v2 20/59] drm/kmb: Register IRQ for LCD

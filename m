...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E8846DE4D4
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Apr 2023 21:22:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2EC310E64B;
	Tue, 11 Apr 2023 19:21:59 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mail-yw1-x112e.google.com (mail-yw1-x112e.google.com
 [IPv6:2607:f8b0:4864:20::112e])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EC1B610E64B
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Apr 2023 19:21:56 +0000 (UTC)
Received: by mail-yw1-x112e.google.com with SMTP id
 00721157ae682-54f64b29207so69053727b3.8
 for <intel-gfx@lists.freedesktop.org>; Tue, 11 Apr 2023 12:21:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=chromium.org; s=google; t=1681240915; x=1683832915;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:from:to:cc:subject:date
 :message-id:reply-to;
 bh=oue/HYlfovppqgzzbdjv9DnjrBnK5EoV43Qm6LSjyBQ=;
 b=jG72sufKMVw5mPEM4PnEYYKuF3oXSgrOGeiLxkellM1QlMBEtJl0+hPnSfm97cSRGi
 TuTclBzDXPq0Z6J0PnUhfic7FATOV65ZLrHWBJr2tORhUHm5yLLAB4HZyFl3VBu3CzQW
 rge1fkb7sTC+N7h0U9vBLjkwCpl6I54RuLZAs=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112; t=1681240915; x=1683832915;
 h=content-transfer-encoding:mime-version:references:in-reply-to
 :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
 :subject:date:message-id:reply-to;
 bh=oue/HYlfovppqgzzbdjv9DnjrBnK5EoV43Qm6LSjyBQ=;
 b=
X-Gm-Message-State: AAQBX9eHARE7o5SHqXh3XYpPc2K94Ig/P28MzAWLSkttjTfB4jkqcIAI
 qRrcdUJM0ZanqlYsW00KZQFUwQ==
X-Google-Smtp-Source: AKy350ZjUKusj+b4Am6DLLWCGHcl3mPSTynls3PQKx3/jo453wVPzWz6n9CSVRIMLUCM5V57RdCYvg==
X-Received: by 2002:a0d:d694:0:b0:54f:8860:8d0f with SMTP id
 y142-20020a0dd694000000b0054f88608d0fmr709364ywd.32.1681240915047; 
 Tue, 11 Apr 2023 12:21:55 -0700 (PDT)
Received: from localhost ([2620:0:1035:15:2991:9b76:4e62:65bf])
 by smtp.gmail.com with UTF8SMTPSA id
 eh25-20020a05690c299900b0054f6f65f258sm685881ywb.16.2023.04.11.12.21.53
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Tue, 11 Apr 2023 12:21:54 -0700 (PDT)
...
Date: Tue, 11 Apr 2023 15:21:31 -0400
Message-Id: <20230411192134.508113-8-markyacoub@google.com>
...
Subject: [Intel-gfx] [PATCH v9 07/10] drm/i915/hdcp: Use HDCP helpers for
 i915

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 38DDF360FC7
	for <lists+intel-gfx@lfdr.de>; Thu, 15 Apr 2021 18:04:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F0CBF6EA95;
	Thu, 15 Apr 2021 16:04:31 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 221D06EA93;
 Thu, 15 Apr 2021 16:04:30 +0000 (UTC)
IronPort-SDR: aKNnfpll0ZVXW9QyK+aL8GmBTDu4EmJ3uKAtSJs72gjmxl00kIjli6f/tvy/PLFwX8d0scvWSb
 llNqoIyTB7zw==
X-IronPort-AV: E=McAfee;i="6200,9189,9955"; a="182377720"
X-IronPort-AV: E=Sophos;i="5.82,225,1613462400"; d="scan'208";a="182377720"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2021 09:04:29 -0700
IronPort-SDR: 4dV6p3cyKm1mmtZVX665JUKSpoj/WXm2TjymV4SMpHxYgF4/LSCWgFmexqaPrMjV6hrCt9D4Fa
 ka8oghKOAU9Q==
X-IronPort-AV: E=Sophos;i="5.82,225,1613462400"; d="scan'208";a="425231314"
Received: from nmarjano-mobl2.ger.corp.intel.com (HELO
 mwauld-desk1.ger.corp.intel.com) ([10.252.7.25])
 by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Apr 2021 09:04:27 -0700
From: Matthew Auld <matthew.auld@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 15 Apr 2021 16:59:58 +0100
Message-Id: <20210415155958.391624-4-matthew.auld@intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 4/4] drm/doc/rfc: i915 DG1 uAPI

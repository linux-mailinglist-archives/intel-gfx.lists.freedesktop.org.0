...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 441172339ED
	for <lists+intel-gfx@lfdr.de>; Thu, 30 Jul 2020 22:45:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C2F986E09E;
...
Subject: [Intel-gfx] [PATCH v4] Add support for KeemBay DRM driver

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 882A26D13CB
	for <lists+intel-gfx@lfdr.de>; Fri, 31 Mar 2023 01:56:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DADDE10E301;
...
Subject: Re: [Intel-gfx] [PATCH v8 11/24] vfio: Make

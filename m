...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E6BE7E21C9
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Nov 2023 13:35:34 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F138710E2DF;
	Mon,  6 Nov 2023 12:35:31 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DEB1510E2DA;
 Mon,  6 Nov 2023 12:35:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699274127; x=1730810127;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=5TNdQ7mr6MKjnaLacAPP1RjPSfW1L915Xg78mE2tK9c=;
 b=hkhn3qrRnZ1C+EhXbHAD6ohuhvhwwOqOcipL6J/OkJEn3qyzDR37O/4o
 JkcIJpYfqKWxYsNuzhL/GTXl5BCiE8URIP9QZ0S81KV4OlxLLCH+18KrU
 TvBvLw9MAINE82WQYRFBdk2mGDRcZzu95FSxRaKp12d/whbtgTKuLuDwA
 tmqjDvaglP/M0Nl8EyJ8a7YSbSr/h6HlsTl4KtJVrDr5B3B897Ow3die0
 3wXChT04tBR7xTWEps7rsci+eUOp8NktaGjt5Tijmk3OMBjSoLmYG/Hxv
 bnsZQ8nYKmGTQweqZcCJ+uV7B/VABkNyKLh9lAO+qTqugOaxbT41gwKYZ Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="393159550"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="393159550"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 04:35:27 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="712188472"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="712188472"
...
Date: Mon,  6 Nov 2023 12:35:12 +0000
Message-Id: <20231106123518.588528-3-tvrtko.ursulin@linux.intel.com>
...
Subject: [Intel-gfx] [CI 3/9] tests/i915/drm_fdinfo: Add some memory info
 tests

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BAA1D471B3B
	for <lists+intel-gfx@lfdr.de>; Sun, 12 Dec 2021 16:21:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 08AB110F4A4;
	Sun, 12 Dec 2021 15:21:00 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v7 00/12] More preparation for multi gt
 patches

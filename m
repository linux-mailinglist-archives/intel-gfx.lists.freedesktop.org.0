...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A4D7B9492FD
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Aug 2024 16:28:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4C3C610E38A;
	Tue,  6 Aug 2024 14:28:45 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="QczqZ8y0";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1327F10E38A
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Aug 2024 14:28:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1722954524; x=1754490524;
 h=date:from:to:cc:subject:message-id:mime-version;
 bh=guJXt5hLs/k6Gy5qqQbEgBY5K6l41GRJp9C7qXsr19U=;
 b=QczqZ8y0MAz1j90EC5IpekPtRJ3HBHdh1bqQg3xKZ7j7MhZ6U+TcIjcX
 GH8ak65/6nfDtbDduVhDblBOrxinRuC2E0y88L3qYuOYTsVkZ1eflGyFZ
 r0Ka1iguUE4k6BDLc2fRxzr17t6ZXrD5HBke51Vsf4mxHCLmJc+VXeYUa
 BjMTOyEReavhGs2ghIsrFx29Nd+WttsbQoXM7c3a2f7hCPJVWWD2gh14C
 VGkpt984ApiCwZzUaw2HWbZU0da6j2XFW5hl5j4pPf/2fYmwTpXy1/97N
 s60QJbe+0TGQ1a37pVbgEgP+hhe8kStRgV/QWoOP0s29VoAZsWKCsc+oP Q==;
X-CSE-ConnectionGUID: 2wga/gGvSw2qdXxBC7mBLw==
X-CSE-MsgGUID: Qa4LkkXEREqcftlM73GdxA==
X-IronPort-AV: E=McAfee;i="6700,10204,11156"; a="21124742"
X-IronPort-AV: E=Sophos;i="6.09,268,1716274800"; d="scan'208";a="21124742"

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B9BB5AC6E4
	for <lists+intel-gfx@lfdr.de>; Sun,  4 Sep 2022 23:44:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BC13A10E23C;
...
Subject: [Intel-gfx] [PATCH v6 11/57] dyndbg: gather __dyndbg[] state into
 struct _ddebug_info
...
Cc: Jim Cromie <jim.cromie@gmail.com>, daniel.vetter@ffwll.ch,
 linux@rasmusvillemoes.dk, Luis Chamberlain <mcgrof@kernel.org>,

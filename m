...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B6E97522C04
	for <lists+intel-gfx@lfdr.de>; Wed, 11 May 2022 08:02:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A70210E509;
	Wed, 11 May 2022 06:02:40 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 1/5] drm/i915/uncore: Reorganize and document
 shadow and forcewake tables

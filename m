...
Received: from mail.lfdr.de
	...
	id gTNVIqooR2pfTwAAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Fri, 03 Jul 2026 05:12:42 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E5126FE1F6
	for <lists+intel-gfx@lfdr.de>; Fri, 03 Jul 2026 05:12:41 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=none;
	dmarc=none;
	spf=pass (mail.lfdr.de: domain of intel-gfx-bounces@lists.freedesktop.org designates 131.252.210.177 as permitted sender) smtp.mailfrom=intel-gfx-bounces@lists.freedesktop.org
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A16BA10F614;
	Fri,  3 Jul 2026 03:12:39 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from 6beec6c84f66 (emeril.freedesktop.org [131.252.210.167])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C38F410F614;
 Fri,  3 Jul 2026 03:12:38 +0000 (UTC)
Content-Type: multipart/alternative;
 boundary="===============3725523186773869199=="
MIME-Version: 1.0
Subject: =?utf-8?q?=E2=9C=97_i915=2ECI=2EFull=3A_failure_for_drm/i915/display/psr=3A_?=
 =?utf-8?q?PSR2_DC3CO_fix_=28rev3=29?=
From: Patchwork <patchwork@emeril.freedesktop.org>
To: "Dibin Moolakadan Subrahmanian" <dibin.moolakadan.subrahmanian@intel.com>
Cc: intel-gfx@lists.freedesktop.org
Date: Fri, 03 Jul 2026 03:12:38 -0000
Message-ID: <178304835878.146722.11733649581913487434@6beec6c84f66>
...
-------
  ...
  **FAILURE**
  ...
  Serious unknown changes coming with Patchwork_169492v3_full absolutely need to be
  verified manually.
  
  If you think the reported changes have nothing to do with the changes
  introduced in Patchwork_169492v3_full, please notify your bug team (I915-ci-infra@lists.freedesktop.org) to allow them
...
-------------------
  ...
  Here are the unknown changes that may have been introduced in Patchwork_169492v3_full:
...
#### Possible regressions ####
  ...
  * igt@gem_lmem_swapping@smem-oom@lmem0:
   ...
   [1]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18749/shard-dg1-18/igt@gem_lmem_swapping@smem-oom@lmem0.html
   [2]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg1-14/igt@gem_lmem_swapping@smem-oom@lmem0.html
...
#### Possible fixes ####
  ...
  * boot:
   ...
   [27]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-4/boot.html
   ...
   [30]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-3/boot.html
   [31]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-3/boot.html
   [32]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-1/boot.html
   [33]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-1/boot.html
   [34]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/boot.html
   [35]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/boot.html
   [36]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/boot.html
   [37]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-7/boot.html
   [38]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-7/boot.html
   [39]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-7/boot.html
   [40]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-1/boot.html
   ...
   [43]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-6/boot.html
   [44]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-6/boot.html
   [45]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-5/boot.html
   [46]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-5/boot.html
   [47]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-5/boot.html
   [48]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-4/boot.html
   [49]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-4/boot.html
...
#### Issues hit ####
  ...
  * igt@api_intel_bb@blit-reloc-purge-cache:
   ...
   [50]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-rkl-4/igt@api_intel_bb@blit-reloc-purge-cache.html

  * igt@device_reset@cold-reset-bound:
    - shard-rkl:          NOTRUN -> [SKIP][51] ([i915#11078])
   [51]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-rkl-2/igt@device_reset@cold-reset-bound.html

  * igt@dmabuf@all-tests:
    - shard-dg2:          NOTRUN -> [SKIP][52] ([i915#15931])
   [52]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/igt@dmabuf@all-tests.html

  * igt@gem_ccs@block-multicopy-compressed:
    - shard-tglu:         NOTRUN -> [SKIP][53] ([i915#9323])
   [53]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-tglu-2/igt@gem_ccs@block-multicopy-compressed.html

  * igt@gem_ccs@ctrl-surf-copy:
    - shard-tglu:         NOTRUN -> [SKIP][54] ([i915#3555] / [i915#9323])
   [54]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-tglu-4/igt@gem_ccs@ctrl-surf-copy.html

  * igt@gem_ctx_persistence@saturated-hostile-nopreempt:
    - shard-dg2:          NOTRUN -> [SKIP][55] ([i915#5882]) +7 other tests skip
   [55]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/igt@gem_ctx_persistence@saturated-hostile-nopreempt.html

  * igt@gem_ctx_sseu@mmap-args:
    - shard-tglu:         NOTRUN -> [SKIP][56] ([i915#280])
   [56]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-tglu-4/igt@gem_ctx_sseu@mmap-args.html

  * igt@gem_eio@in-flight-suspend:
    - shard-rkl:          [PASS][57] -> [INCOMPLETE][58] ([i915#13390])
   [57]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18749/shard-rkl-7/igt@gem_eio@in-flight-suspend.html
   [58]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-rkl-6/igt@gem_eio@in-flight-suspend.html

  * igt@gem_exec_balancer@bonded-semaphore:
    - shard-dg2:          NOTRUN -> [SKIP][59] ([i915#4812])
   [59]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/igt@gem_exec_balancer@bonded-semaphore.html

  * igt@gem_exec_balancer@parallel-keep-submit-fence:
    - shard-rkl:          NOTRUN -> [SKIP][60] ([i915#4525])
   [60]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-rkl-5/igt@gem_exec_balancer@parallel-keep-submit-fence.html

  * igt@gem_exec_big@single:
    - shard-tglu-1:       NOTRUN -> [FAIL][61] ([i915#15816])
   [61]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-tglu-1/igt@gem_exec_big@single.html
    - shard-mtlp:         [PASS][62] -> [FAIL][63] ([i915#15871])
   [62]: https://intel-gfx-ci.01.org/tree/drm-tip/CI_DRM_18749/shard-mtlp-7/igt@gem_exec_big@single.html
   [63]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-mtlp-4/igt@gem_exec_big@single.html

  * igt@gem_exec_reloc@basic-cpu-noreloc:
    - shard-rkl:          NOTRUN -> [SKIP][64] ([i915#3281]) +7 other tests skip
   [64]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-rkl-5/igt@gem_exec_reloc@basic-cpu-noreloc.html

  * igt@gem_exec_reloc@basic-wc-cpu:
    - shard-dg2:          NOTRUN -> [SKIP][65] ([i915#3281]) +3 other tests skip
   [65]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/igt@gem_exec_reloc@basic-wc-cpu.html

  * igt@gem_exec_schedule@preempt-queue:
    - shard-dg2:          NOTRUN -> [SKIP][66] ([i915#4537] / [i915#4812])
   [66]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-dg2-8/igt@gem_exec_schedule@preempt-queue.html

  * igt@gem_huc_copy@huc-copy:
    - shard-rkl:          NOTRUN -> [SKIP][67] ([i915#2190])
   [67]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-rkl-5/igt@gem_huc_copy@huc-copy.html

  * igt@gem_lmem_swapping@random-engines:
    - shard-tglu:         NOTRUN -> [SKIP][68] ([i915#4613]) +3 other tests skip
   [68]: https://intel-gfx-ci.01.org/tree/drm-tip/Patchwork_169492v3/shard-tglu-2/igt@gem_lmem_swapping@random-engines.html
...
<p>Serious unknown changes coming with Patchwork_169492v3_full absolutely n=
eed to be<br />
  verified manually.</p>
<p>If you think the reported changes have nothing to do with the changes<br=
 />
  introduced in Patchwork_169492v3_full, please notify your bug team (I915-=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 1BE8F172634
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Feb 2020 19:13:38 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id E55276E054;
	Thu, 27 Feb 2020 18:13:34 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D97636E054
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Feb 2020 18:13:33 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga102.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 27 Feb 2020 10:13:33 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,492,1574150400"; d="scan'208";a="350733893"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.174])
 by fmsmga001.fm.intel.com with SMTP; 27 Feb 2020 10:13:30 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 27 Feb 2020 20:13:29 +0200
Date: Thu, 27 Feb 2020 20:13:29 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Imre Deak <imre.deak@intel.com>
Message-ID: <20200227181329.GY13686@intel.com>
...
> @@ -920,6 +920,11 @@ static int i915_shared_dplls_info(struct seq_file *m=
, void *unused)
>  	int i;
>  =
...
>  };
> @@ -886,16 +887,9 @@ static int hsw_ddi_wrpll_get_freq(struct drm_i915_pr=
ivate *dev_priv,
>  =
...
>  		}
>  		/* fall through */
> @@ -905,10 +899,10 @@ static int hsw_ddi_wrpll_get_freq(struct drm_i915_p=
rivate *dev_priv,
...
>  	default:
>  		MISSING_CASE(wrpll);
> @@ -920,7 +914,7 @@ static int hsw_ddi_wrpll_get_freq(struct drm_i915_pri=
vate *dev_priv,
...
>  			      const struct intel_dpll_hw_state *hw_state)
>  {
> @@ -1108,6 +1112,7 @@ static const struct intel_dpll_mgr hsw_pll_mgr =3D {
...
> @@ -1534,7 +1540,8 @@ static bool skl_ddi_hdmi_pll_dividers(struct intel_=
...
> @@ -1561,7 +1568,7 @@ static int skl_ddi_wrpll_get_freq(struct drm_i915_p=
rivate *i915,
...
> @@ -1751,6 +1758,12 @@ static int skl_ddi_pll_get_freq(struct drm_i915_pr=
ivate *i915,
...
>  			      const struct intel_dpll_hw_state *hw_state)
>  {
> @@ -1787,6 +1800,7 @@ static const struct intel_dpll_mgr skl_pll_mgr =3D {
...
> @@ -2192,7 +2206,7 @@ static int bxt_ddi_pll_get_freq(struct drm_i915_pri=
vate *i915,
...
> @@ -2228,6 +2242,13 @@ static bool bxt_get_dpll(struct intel_atomic_state=
 *state,
>  	return true;
>  }
>  =
...
>  			      const struct intel_dpll_hw_state *hw_state)
>  {
> @@ -2265,6 +2286,7 @@ static const struct intel_dpll_mgr bxt_pll_mgr =3D {
...
> @@ -2508,27 +2530,13 @@ static void cnl_wrpll_params_populate(struct skl_=
wrpll_params *params,
...
> @@ -2560,9 +2568,6 @@ cnl_ddi_calculate_wrpll(struct intel_crtc_state *cr=
tc_state,
>  		return false;
>  =
...
> @@ -2596,11 +2601,12 @@ static bool cnl_ddi_hdmi_pll_dividers(struct inte=
...
> @@ -2639,8 +2645,6 @@ static int cnl_ddi_wrpll_get_freq(struct drm_i915_p=
rivate *dev_priv,
>  		break;
>  	}
>  =
...
> @@ -2653,6 +2657,12 @@ static int cnl_ddi_wrpll_get_freq(struct drm_i915_=
private *dev_priv,
...
>  {
> @@ -2794,6 +2804,12 @@ static int cnl_ddi_pll_get_freq(struct drm_i915_pr=
ivate *i915,
...
>  			      const struct intel_dpll_hw_state *hw_state)
>  {
> @@ -2821,6 +2837,7 @@ static const struct intel_dpll_mgr cnl_pll_mgr =3D {
...
> @@ -2916,7 +2933,7 @@ static bool icl_calc_dp_combo_pll(struct intel_crtc=
_state *crtc_state,
>  {
>  	struct drm_i915_private *dev_priv =3D to_i915(crtc_state->uapi.crtc->de=
v);
...
> @@ -2939,9 +2956,9 @@ static bool icl_calc_tbt_pll(struct intel_crtc_stat=
e *crtc_state,
>  	struct drm_i915_private *dev_priv =3D to_i915(crtc_state->uapi.crtc->de=
v);
>  =
...
>  		case 19200:
>  		case 38400:
> @@ -2952,9 +2969,9 @@ static bool icl_calc_tbt_pll(struct intel_crtc_stat=
e *crtc_state,
>  			break;
>  		}
>  	} else {
...
>  		case 19200:
>  		case 38400:
> @@ -3118,7 +3135,7 @@ static bool icl_calc_mg_pll_state(struct intel_crtc=
_state *crtc_state,
...
> @@ -3326,7 +3343,7 @@ static int icl_ddi_mg_pll_get_freq(struct drm_i915_=
private *dev_priv,
...
> @@ -3478,7 +3495,16 @@ static bool icl_get_combo_phy_dpll(struct intel_at=
omic_state *state,
...
> @@ -3629,7 +3655,7 @@ static bool mg_pll_get_hw_state(struct drm_i915_pri=
vate *dev_priv,
...
>  		hw_state->mg_pll_tdc_coldst_bias_mask =3D MG_PLL_TDC_COLDST_COLDSTART;
>  		hw_state->mg_pll_bias_mask =3D 0;
>  	} else {
> @@ -4110,6 +4136,12 @@ static void mg_pll_disable(struct drm_i915_private=
 *dev_priv,
...
>  			      const struct intel_dpll_hw_state *hw_state)
>  {
> @@ -4170,6 +4202,7 @@ static const struct intel_dpll_mgr icl_pll_mgr =3D {
...
> @@ -4184,6 +4217,7 @@ static const struct intel_dpll_mgr ehl_pll_mgr =3D {
...
> @@ -4212,6 +4246,7 @@ static const struct intel_dpll_mgr tgl_pll_mgr =3D {
>  	.get_dplls =3D icl_get_dplls,
>  	.put_dplls =3D icl_put_dplls,
>  	.update_active_dpll =3D icl_update_active_dpll,
> +	.update_ref_clks =3D icl_update_dpll_ref_clks,
...
> @@ -4390,6 +4425,9 @@ void intel_dpll_readout_hw_state(struct drm_i915_pr=
ivate *i915)
>  {
>  	int i;
>  =

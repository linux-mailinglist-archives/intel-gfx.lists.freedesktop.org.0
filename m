...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E3BB2FB360
	for <lists+intel-gfx@lfdr.de>; Tue, 19 Jan 2021 08:43:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DE246E830;
	Tue, 19 Jan 2021 07:43:27 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3BC3B6E82C
 for <Intel-gfx@lists.freedesktop.org>; Tue, 19 Jan 2021 07:43:25 +0000 (UTC)
IronPort-SDR: KcAvsAvJGFI4FMg4n3+5L6pBzymdlILsna1X9PahIku0Nt8gDvRy5H6+cEjGkhovOtbY2uVdpO
 amtXr7FGG0bQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9868"; a="197592809"
X-IronPort-AV: E=Sophos;i="5.79,358,1602572400"; d="scan'208";a="197592809"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Jan 2021 23:43:23 -0800
IronPort-SDR: wSE/9nJGlU+0UhM5IkWRRZFUdhhP1bKh039zWgonEH3Ob2g7xB3SLMtFYzd4hi180IkzVwDXuf
 pGYgkwC2OFIw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.79,358,1602572400"; d="scan'208";a="466592737"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga001.fm.intel.com with ESMTP; 18 Jan 2021 23:43:23 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Mon, 18 Jan 2021 23:43:13 -0800
Message-Id: <20210119074320.28768-7-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210119074320.28768-1-sean.z.huang@intel.com>
References: <20210119074320.28768-1-sean.z.huang@intel.com>
Subject: [Intel-gfx] [RFC-v23 06/13] drm/i915/pxp: Enable PXP irq worker and
 callback stub

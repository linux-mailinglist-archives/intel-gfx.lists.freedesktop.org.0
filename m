...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C31B64AB73
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Dec 2022 00:18:13 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9092C10E2D8;
	Mon, 12 Dec 2022 23:16:02 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v9 12/23] drm/i915/vm_bind: Use common execbuf

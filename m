...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E49249C4434
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Nov 2024 18:53:57 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 702DA10E4FE;
	Mon, 11 Nov 2024 17:53:56 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="O/3fEiK6";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.16])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 079DC10E4FE;
 Mon, 11 Nov 2024 17:53:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1731347635; x=1762883635;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=dZZOXZPVkOAIogIxbl5MpsowhrZhaeuXRRI3/rAtOxU=;
 b=O/3fEiK6Hzo16iKiuaFAndSKlgZP3YebOPB3G8mGB2C4YdOsfnPqSjki
 MbvAJFVYgATq0syYNiGERZ482W2lj5nZM0lUisA42E5K3TWMCph2hxGKr
 0Vpt4i2gmoqW9l6l/PbT4DBobN5zrby93Q1fH5UFcMO79Ih2w89fQspXu
 LTu3ZVXiGIe9KFwVgAZxZUbZLyKkvxVeixk14pJBqkl6NS1R7HlQqcVMl
 3Pq5i/7qx8uUHjJ5T981n7l8Sw11cfh8ajm//enGGTmesYqmpa2Qbcn4R
 uSRxhnZNW7mLb7jubAs92vr3lPIsYPh3/2imsHnVvobYLUNcyLSbMH7v/ g==;
X-CSE-ConnectionGUID: WD5TgswyRA+QChDrRoRjyA==
X-CSE-MsgGUID: O6ACGsXjT1Kd7EScNN9fJw==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="31317361"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; d="scan'208";a="31317361"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa108.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2024 09:53:55 -0800
X-CSE-ConnectionGUID: 4nCynFTgQrm60L0PdM5Avw==
X-CSE-MsgGUID: e64746b0R8Onawh/L7YKnw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.12,145,1728975600"; d="scan'208";a="86985839"
Received: from carterle-desk.ger.corp.intel.com (HELO localhost)
 ([10.245.246.75])
 by orviesa009-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2024 09:53:53 -0800
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: jani.nikula@intel.com
Subject: [PATCH 3/5] drm/i915/plane: convert initial plane setup to struct
 intel_display
Date: Mon, 11 Nov 2024 19:53:32 +0200
Message-Id: <360fc078c5204f9199d31c207abc3ac3d9f918ed.1731347547.git.jani.nikula@intel.com>

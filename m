...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A6EB13EAA6B
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Aug 2021 20:44:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 457596E44E;
	Thu, 12 Aug 2021 18:44:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EA8106E44B
 for <intel-gfx@lists.freedesktop.org>; Thu, 12 Aug 2021 18:44:46 +0000 (UTC)
X-IronPort-AV: E=McAfee;i="6200,9189,10074"; a="301009249"
X-IronPort-AV: E=Sophos;i="5.84,316,1620716400"; d="scan'208";a="301009249"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 Aug 2021 11:44:45 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.84,316,1620716400"; d="scan'208";a="461167988"
Received: from jhli-desk1.jf.intel.com ([10.54.74.156])
 by orsmga007.jf.intel.com with ESMTP; 12 Aug 2021 11:44:45 -0700
...
Date: Thu, 12 Aug 2021 11:44:27 -0700
Message-Id: <20210812184427.167689-4-juston.li@intel.com>
...
@@ -1876,6 +1888,14 @@ static int hdcp2_authenticate_and_encrypt(struct intel_connector *connector)
 	for (i = 0; i < tries && !dig_port->hdcp_auth_status; i++) {
 		...
 		if (!ret) {
+			ret = intel_set_stream_type(connector);
+			if (ret) {
+				drm_dbg_kms(&i915->drm,

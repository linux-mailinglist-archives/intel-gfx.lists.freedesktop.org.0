...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 85C7565EB72
	for <lists+intel-gfx@lfdr.de>; Thu,  5 Jan 2023 14:00:00 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF83C10E71E;
	Thu,  5 Jan 2023 12:59:58 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 40B1410E71E
 for <intel-gfx@lists.freedesktop.org>; Thu,  5 Jan 2023 12:59:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672923596; x=1704459596;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=2xu2rxqHGAps1JgKmUvJTjiWG+xH440XJB6N0Xc3yPs=;
 b=eo+fbT4ATbOSQtZiEKGI5mQy7mv6HWTckGH7bKU2UY14A+6KCJRwRQ/W
 rern5/ahlpXFUDC8EmFjJB56aq2kr/Gesiy8eCNbkHg8Kp37E46/vLHYn
 e0thWOevdAUCnQLBRHKv7vUy0pYJuTW57i456Z2X7p9ovyXBb86xLY9/z
 fH8suriVhv01i3kqaM7FKxMLaTBqcgt57fUPEXhqRb0cPb3dEFcpXRI65
 7Nxxk1RYa6/guWB858ESZQvZgwEQLi6TyqGHyeyLGoLLZnzzgtJ0smmCt
 chO3a9vYVQhp5hIrUAWgSctzxeRdoRMx7mDmOsGHFJDpnFrlT590ctRUc w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="305697789"
X-IronPort-AV: E=Sophos;i="5.96,303,1665471600"; d="scan'208";a="305697789"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jan 2023 04:59:56 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="829540981"
X-IronPort-AV: E=Sophos;i="5.96,303,1665471600"; d="scan'208";a="829540981"
Received: from sorvi2.fi.intel.com ([10.237.72.194])
 by orsmga005.jf.intel.com with ESMTP; 05 Jan 2023 04:59:54 -0800
From: Mika Kahola <mika.kahola@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu,  5 Jan 2023 14:54:34 +0200
Message-Id: <20230105125446.960504-10-mika.kahola@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 09/21] drm/i915/mtl: C20 HW readout

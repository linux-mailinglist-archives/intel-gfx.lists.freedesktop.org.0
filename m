...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 10B7E7EACD7
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Nov 2023 10:17:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 586D810E1E6;
...
Subject: Re: [Intel-gfx] [PATCH 03/11] drm/i915/display: Consider fractional

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E6E728E6E5
	for <lists+intel-gfx@lfdr.de>; Wed, 14 Oct 2020 21:07:44 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 708F46EAD6;
	Wed, 14 Oct 2020 19:07:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B4E066EAD6
 for <intel-gfx@lists.freedesktop.org>; Wed, 14 Oct 2020 19:07:40 +0000 (UTC)
IronPort-SDR: eIedkEfTYXeiF5iudrijg5fi7SlK4gJCLAjm/jI/0a/MDDUiRrLEN3ZbliNtn5L2QddrymoK3C
 3EEivwVJZjhQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9774"; a="166234140"
X-IronPort-AV: E=Sophos;i="5.77,375,1596524400"; d="scan'208";a="166234140"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2020 12:07:37 -0700
IronPort-SDR: 9oqivoSqjFLwIKYNInzb9zhbxJxj1p4wPltkKHT82SBPQEQa98u+cMycllGsQM8QAo+86TDDMV
 FHTCLGyY9kzA==
X-IronPort-AV: E=Sophos;i="5.77,375,1596524400"; d="scan'208";a="521533542"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO labuser-Z97X-UD5H)
 ([10.165.21.211])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Oct 2020 12:07:36 -0700
Date: Wed, 14 Oct 2020 12:09:07 -0700
From: "Navare, Manasi" <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20201014190906.GA22971@labuser-Z97X-UD5H>
References: <20201008214535.22942-1-manasi.d.navare@intel.com>
 <20201008214535.22942-5-manasi.d.navare@intel.com>
 <20201014113315.GH6112@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20201014113315.GH6112@intel.com>
...
On Wed, Oct 14, 2020 at 02:33:15PM +0300, Ville Syrj=E4l=E4 wrote:
...
> > @@ -8130,9 +8130,24 @@ static int intel_crtc_compute_config(struct inte=
l_crtc *crtc,
...
> > @@ -8193,7 +8208,7 @@ static int intel_crtc_compute_config(struct intel=
_crtc *crtc,
...
> > @@ -12559,7 +12574,7 @@ static bool encoders_cloneable(const struct int=
el_encoder *a,
...
So split out changing drm_atomic_state to intel_atomic_state in a separate =
patch?
...
> > @@ -12568,7 +12583,7 @@ static bool check_single_encoder_cloning(struct=
...
> > @@ -12808,6 +12823,7 @@ static int intel_crtc_atomic_check(struct intel=
_atomic_state *state,
> >  =
...
> >  		if (ret)
> > @@ -13341,19 +13357,32 @@ static bool check_digital_port_conflicts(stru=
...
crtc_state)
> > @@ -13375,7 +13404,49 @@ static void intel_crtc_copy_hw_to_uapi_state(s=
...
> >  	struct intel_crtc *crtc =3D to_intel_crtc(crtc_state->uapi.crtc);
> >  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
> > @@ -13407,16 +13478,16 @@ intel_crtc_prepare_cleared_state(struct intel=
...
> >  	struct drm_connector_state *connector_state;
> > @@ -13458,7 +13529,7 @@ intel_modeset_pipe_config(struct intel_crtc_sta=
te *pipe_config)
...
> > @@ -13496,7 +13567,7 @@ intel_modeset_pipe_config(struct intel_crtc_sta=
te *pipe_config)
...
> > @@ -13548,9 +13619,6 @@ intel_modeset_pipe_config(struct intel_crtc_sta=
te *pipe_config)
...
> > @@ -14946,6 +15014,75 @@ static bool intel_cpu_transcoders_need_modeset=
...
> >   *
> > @@ -15108,19 +15245,36 @@ static int intel_atomic_check(struct drm_devi=
ce *dev,
> >  					    new_crtc_state, i) {
...
> >  			goto fail;
> >  	}
> > @@ -15458,7 +15612,9 @@ static void intel_update_crtc(struct intel_atom=
ic_state *state,
> >  =
...
> > @@ -2386,6 +2386,15 @@ static int intel_dp_dsc_compute_config(struct in=
tel_dp *intel_dp,
...
> > @@ -2403,12 +2412,12 @@ static int intel_dp_dsc_compute_config(struct i=
ntel_dp *intel_dp,
...
> > @@ -2424,14 +2433,15 @@ static int intel_dp_dsc_compute_config(struct i=
ntel_dp *intel_dp,

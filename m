...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E98FF674AF7
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Jan 2023 05:42:29 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5C2E10EA27;
	Fri, 20 Jan 2023 04:42:15 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH 07/16] drm/i915/dp: Get optimal link config to

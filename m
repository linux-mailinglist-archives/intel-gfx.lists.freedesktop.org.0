...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C94D49091DE
	for <lists+intel-gfx@lfdr.de>; Fri, 14 Jun 2024 19:39:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 09BD410EE0D;
	Fri, 14 Jun 2024 17:39:44 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="a5na8smt";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 307E710EE04;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=J/Tpf2zbduiAbdBzcNa0j3yw2Pl5tc25+U7GPvzo4tA=;
 b=a5na8smtx5APuLTKBBhXYBBD1hLplBtJ0sOQ+zAhghE6lRwKMIvMyyWN
 4u3YC827wNNiEp8KgGiVq5bfZ5+9QjpoTk1EmLkTOzVZtslEc+CuUjuLv
 mJn8hphGErGSfXRcI8uM+6ZQBW+ulL2iURMKdg4v5Zw5Bn58O2rfd/vPd
 w4AzvxWP60jdf945aS2ho0CQATKxNeCFWtFXzqXeOemNiKCi5BYle01eL
 FLzp8FKYntQ6LaVCGqmOhMrZ1VA9HQYpgAF6lHhCe1aRViOk/WIoZF1rR
 2etqXmpewD3H7QDwWd46AZYamlU/U4zwQKclLR12u19cz+GZl114K5SDh w==;
X-CSE-ConnectionGUID: GG7A5OKsQh62rwvXGBhqDA==
X-CSE-MsgGUID: rjESVp4mRQGpPmiClYuD5A==
X-IronPort-AV: E=McAfee;i="6700,10204,11103"; a="19069361"
X-IronPort-AV: E=Sophos;i="6.08,238,1712646000"; d="scan'208";a="19069361"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Jun 2024 10:39:14 -0700
X-CSE-ConnectionGUID: nU7REPqBRkmiUuT7XYOlXA==
X-CSE-MsgGUID: PiloOOkDQoSCeXdb1mIK9w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,238,1712646000"; d="scan'208";a="40712493"
...
Subject: [PATCH 9/9] drm/i915: Remove DSC register dump
Date: Fri, 14 Jun 2024 20:39:09 +0300
Message-ID: <20240614173911.3743172-10-imre.deak@intel.com>
...
index ca1d8be659195..e55c87cbf4ee4 100644

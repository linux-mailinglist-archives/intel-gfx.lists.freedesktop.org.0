...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B55C307ABB
	for <lists+intel-gfx@lfdr.de>; Thu, 28 Jan 2021 17:26:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0CC046E9A9;
	Thu, 28 Jan 2021 16:26:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 392C26E98F
 for <intel-gfx@lists.freedesktop.org>; Thu, 28 Jan 2021 16:26:21 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 28 Jan 2021 17:25:12 +0100
Message-Id: <20210128162612.927917-4-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v7 03/63] drm/i915: Move cmd parser pinning to
 execbuffer
...
cml2ZXJzL2dwdS9kcm0vaTkxNS9nZW0vaTkxNV9nZW1fb2JqZWN0LmgKaW5kZXggMzQxMWFkMTk3
ZmE2Li4xYWJmYzEzNDI1MGUgMTAwNjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2dlbS9p
...
bnRlbF9nZ3R0LmMKaW5kZXggYzdmODAyMzgwNWUyLi4yYjI3MzY1MmIwZjAgMTAwNjQ0Ci0tLSBh
L2RyaXZlcnMvZ3B1L2RybS9pOTE1L2d0L2ludGVsX2dndHQuYworKysgYi9kcml2ZXJzL2dwdS9k
cm0vaTkxNS9ndC9pbnRlbF9nZ3R0LmMKQEAgLTE0MjAsNyArMTQyMCw3IEBAIGludGVsX3BhcnRp
...
MTUvaTkxNV9jbWRfcGFyc2VyLmMKaW5kZXggY2VkOWE5NmQ3YzM0Li43MmExYWNhZjViYjAgMTAw
NjQ0Ci0tLSBhL2RyaXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfY21kX3BhcnNlci5jCisrKyBiL2Ry
aXZlcnMvZ3B1L2RybS9pOTE1L2k5MTVfY21kX3BhcnNlci5jCkBAIC0xMTM3LDM4ICsxMTM3LDIw
...
bCBjYWNoZWxpbmVzIGJlZm9yZSB0aGUgd3JpdGUKQEAgLTExODUsMjMgKzExNjcsMzEgQEAgc3Rh
...
dm1hcCBwaW5uZWQgKi8KQEAgLTEzNjMsOSArMTM1Myw2IEBAIHN0YXRpYyBpbnQgY2hlY2tfYmJz
...
IGp1bXBfdGFyZ2V0KTsKQEAgLTEzNzUsMTAgKzEzNjIsMTQgQEAgc3RhdGljIGludCBjaGVja19i
...
IGFsbG9jYXRpb24gd2hpY2ggc2hvdWxkIGJlCkBAIC0xNDE2LDE0ICsxNDA3LDE2IEBAIGludCBp
...
IUlTX0FMSUdORUQoYmF0Y2hfbGVuZ3RoLCBzaXplb2YoKmNtZCkpKTsKQEAgLTE0MzEsMTYgKzE0
MjQsOCBAQCBpbnQgaW50ZWxfZW5naW5lX2NtZF9wYXJzZXIoc3RydWN0IGludGVsX2VuZ2luZV9j
...
YXRjaC0+bm9kZS5zdGFydCArIGJhdGNoX29mZnNldCk7CkBAIC0xNTQxLDkgKzE1MjYsNiBAQCBp
...
L2dwdS9kcm0vaTkxNS9pOTE1X2Rydi5oCmluZGV4IDNlZGM5YzRmMmQyMS4uNGQ4NzM4ZDkxNjhh
IDEwMDY0NAotLS0gYS9kcml2ZXJzL2dwdS9kcm0vaTkxNS9pOTE1X2Rydi5oCisrKyBiL2RyaXZl
cnMvZ3B1L2RybS9pOTE1L2k5MTVfZHJ2LmgKQEAgLTE5ODQsMTIgKzE5ODQsMTcgQEAgY29uc3Qg
...


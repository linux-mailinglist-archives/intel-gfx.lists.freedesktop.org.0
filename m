...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 577921079D3
	for <lists+intel-gfx@lfdr.de>; Fri, 22 Nov 2019 22:09:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7F5B46F58A;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC 12/13] drm/i915/svm: Add support to en/disable SVM

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76C24E6FBB
	for <lists+intel-gfx@lfdr.de>; Mon, 28 Oct 2019 11:38:52 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A4D486E563;
	Mon, 28 Oct 2019 10:38:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH RESEND 2/8] drm/nouveau: use drm_debug_enabled()

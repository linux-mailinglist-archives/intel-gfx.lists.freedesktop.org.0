...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 12C65700647
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 13:05:10 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 527AC10E67F;
	Fri, 12 May 2023 11:05:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 05A8410E67F
 for <intel-gfx@lists.freedesktop.org>; Fri, 12 May 2023 11:05:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683889505; x=1715425505;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=6Rr0Cb5OjRs08E2vLG58yLkPhl0y9ZyWcR33fmwO5f0=;
 b=hjoLF0hMzm9qus1OZadA9lCWzbwYbnHvvV3B5hzZXC4pSfdL9y2iAFiG
 tkZYjbp/UR51qAPGOluWh/Ol/pJNwiKvgW0Lv6NOxTZe43CWnfWT2T6l8
 blqb9xax5eqtTCmKFLmEf6tjZXPHstz8cDgGrFHVlPqqLkRcEBl+xHBwh
 hoW6etqQu+yqojIgmffx8H0G0h04yy/HTAHGF7ayruLAkU3ivXMcfvy6K
 YfF56tfFuiNyB4BpZys17kwefsnEJA3Su2YkXesMVOFv5HDsg9ExttHDE
 m+MLpdkcWPnMdDN3rBxlnfXGpIP33wDmY1lQ6Wt84Lvst2WukCrUEKgg7 g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="331129577"
X-IronPort-AV: E=Sophos;i="5.99,269,1677571200"; d="scan'208";a="331129577"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 04:05:05 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10707"; a="677625735"
X-IronPort-AV: E=Sophos;i="5.99,269,1677571200"; d="scan'208";a="677625735"
Received: from tsavina-mobl2.ger.corp.intel.com (HELO localhost)
 ([10.252.63.51])
 by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2023 04:05:04 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 12 May 2023 14:04:44 +0300
Message-Id: <20230512110444.1448231-4-jani.nikula@intel.com>
...
Subject: [Intel-gfx] [PATCH 4/4] drm/i915/display: add i915 parameter to
 I915_STATE_WARN()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 512F28C9B1E
	for <lists+intel-gfx@lfdr.de>; Mon, 20 May 2024 12:21:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 84A9C10E5CA;
	Mon, 20 May 2024 10:20:57 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="W2jw6aS9";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B5F0610E5CE
 for <intel-gfx@lists.freedesktop.org>; Mon, 20 May 2024 10:20:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1716200456; x=1747736456;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=m2yVBWCE4t9dyJNU5T1gzN3zeRQZoDbqDINogldaJQA=;
 b=W2jw6aS9L5IhLWWZF3fu9uw/EY4afzEDPM86Q8kaqo7vBl1cQ4Vhx1d3
 6mN+MMPqkSQD06YYCWnx1eq9Q2O5QPJ1NVpyCs77QvKenaZ7SEeaknT5V
 sVDES1TfM5oFrQxuHC9DuxEPzbuBCI/pnVbU6l2dMrrlqEmEOdsEmdi5r
 S/y+zO8gbDew4L+Y8jGe4bSJsxMBLvGuUqT+JqCmng5AmD4Ej4APgfkyy
 3cxCrFPN8FX/5WO82f26K9nkvccAytWy8wS2DCbVqxonZRWndTZAX201Z
 uUSFXbErcu7DbE/OUOU8SsvYNZuwAORsUHJHpCL6J6MxQOLoItk/mNbsv g==;
X-CSE-ConnectionGUID: yDYDgaMCSDiWpzbWinioFg==
X-CSE-MsgGUID: nDbQ5oRJTkWM+MvAG0ZiUw==
X-IronPort-AV: E=McAfee;i="6600,9927,11077"; a="16145824"
X-IronPort-AV: E=Sophos;i="6.08,174,1712646000"; d="scan'208";a="16145824"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
 by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 May 2024 03:20:55 -0700
X-CSE-ConnectionGUID: YVHxdIoRRPqd8iDdkasLtg==
X-CSE-MsgGUID: CxI3JFVbS8Kc+rydbD2ong==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,174,1712646000"; d="scan'208";a="37429197"
Received: from unknown (HELO localhost) ([10.245.246.99])
 by orviesa004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 May 2024 03:20:53 -0700
From: Jani Nikula <jani.nikula@linux.intel.com>
To: Stanislav Lisovskiy <stanislav.lisovskiy@intel.com>,
 intel-gfx@lists.freedesktop.org
Cc: jani.saarinen@intel.com, ville.syrjala@linux.intel.com
Subject: Re: [PATCH 1/5] drm/i915: Rename all bigjoiner to joiner
In-Reply-To: <20240520073839.23881-2-stanislav.lisovskiy@intel.com>
Organization: Intel Finland Oy - BIC 0357606-4 - Westendinkatu 7, 02160 Espoo
References: <20240520073839.23881-1-stanislav.lisovskiy@intel.com>
 <20240520073839.23881-2-stanislav.lisovskiy@intel.com>
Date: Mon, 20 May 2024 13:20:49 +0300
Message-ID: <87r0dwu6m6.fsf@intel.com>
MIME-Version: 1.0

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 541FE7002DD
	for <lists+intel-gfx@lfdr.de>; Fri, 12 May 2023 10:42:39 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3D52910E655;
...
Subject: [Intel-gfx] [PATCH 08/11] drm/tegra: Use regular fbdev I/O helpers

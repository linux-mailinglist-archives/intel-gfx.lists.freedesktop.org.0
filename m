...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C4B16F76B3
	for <lists+intel-gfx@lfdr.de>; Thu,  4 May 2023 22:12:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3DB8D10E520;
	Thu,  4 May 2023 20:12:18 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7FCCF10E522;
 Thu,  4 May 2023 20:12:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1683231135; x=1714767135;
 h=date:from:to:cc:subject:message-id:references:
 in-reply-to:mime-version;
 bh=br9/h2O5jdFTXZKs+G0lIKEJqZiNzhmSyNIrmp4K2Uk=;
 b=iMdHVSCjyptRICAxtFVeTUEan79bmuH+/p1hQyKeEkhSFbJXa8heWNN7
 AilxVGKiaqjPLAxxRRgrPJJh+Yf2Sd8lcRUUrSrdbIXUkrmtZDMOhXU8O
 i1ZC5lhPON8Q08vVUw6dTIgXmrUHsEbvhy7FtkkCgRQNU75lTAFevyzVV
 bouIMT0w7M73nUhg18njs1RxXdFmZN3/XurHFbLzIMzFZV2m51p3M2SHj
 GW8GtZyP4w5QR5piA4Li8RoERtlAmvRoMgiUKSee+4d/D7bg5JI7fjJQC
 LREtYZDnw9+8jcw2PWm6ZpfZ5Xk87pEQJFq0Z+hQd+HH2tkGGrnwMWWLY g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10700"; a="377120967"
X-IronPort-AV: E=Sophos;i="5.99,250,1677571200"; d="scan'208";a="377120967"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 May 2023 13:12:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10700"; a="766728874"
X-IronPort-AV: E=Sophos;i="5.99,250,1677571200"; d="scan'208";a="766728874"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
 by fmsmga004.fm.intel.com with ESMTP; 04 May 2023 13:12:14 -0700
Received: from fmsmsx611.amr.corp.intel.com (10.18.126.91) by
 fmsmsx602.amr.corp.intel.com (10.18.126.82) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.23; Thu, 4 May 2023 13:12:14 -0700
Received: from fmsedg601.ED.cps.intel.com (10.1.192.135) by
 fmsmsx611.amr.corp.intel.com (10.18.126.91) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.23 via Frontend Transport; Thu, 4 May 2023 13:12:14 -0700
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (104.47.58.169)
 by edgegateway.intel.com (192.55.55.70) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.23; Thu, 4 May 2023 13:12:13 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=ya8gDqNquY+G2kvkrHsmrYWiUVOh1izXCmAM5PzbwwE=;
 b=
...
Received: from DS7PR11MB7859.namprd11.prod.outlook.com
 ...
 20:12:09 +0000
Date: Thu, 4 May 2023 13:12:05 -0700
From: Matt Roper <matthew.d.roper@intel.com>
To: <fei.yang@intel.com>
Message-ID: <20230504201205.GQ10045@mdroper-desk1.amr.corp.intel.com>
References: <20230503225100.2834222-1-fei.yang@intel.com>
 <20230503225100.2834222-3-fei.yang@intel.com>
Content-Type: text/plain; charset="us-ascii"
Content-Disposition: inline
In-Reply-To: <20230503225100.2834222-3-fei.yang@intel.com>
X-ClientProxiedBy: BYAPR01CA0056.prod.exchangelabs.com (2603:10b6:a03:94::33)
 To DS7PR11MB7859.namprd11.prod.outlook.com
 (2603:10b6:8:da::22)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: DS7PR11MB7859:EE_|BL1PR11MB5366:EE_
X-MS-Office365-Filtering-Correlation-Id: 09ece64f-d8d1-4cb4-d333-08db4cdbd6cf
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 IPV:NLI; SFV:NSPM; H:DS7PR11MB7859.namprd11.prod.outlook.com; PTR:; CAT:NONE;
 SFS:(13230028)(376002)(39860400002)(346002)(136003)(366004)(396003)(451199021)(38100700002)(8676002)(8936002)(33656002)(6512007)(6506007)(1076003)(26005)(66899021)(34206002)(478600001)(6486002)(54906003)(41300700001)(2906002)(5660300002)(6666004)(86362001)(30864003)(66946007)(66476007)(66556008)(186003)(83380400001)(6636002)(4326008)(82960400001)(316002)(559001)(579004);
 DIR:OUT; SFP:1102; 
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?QnEH3mLg1ljVaRBzIWqsMC+84q1SmZCwZwxVkynwDi7E3isJ2V52ATcKcmXE?=
 =?us-ascii?Q?xYzi6STEsrlKvtMKHg/ZXcioMMsXY4Pw+E2HqCUTFra7RCia44IOhB9yWwys?=
 =?us-ascii?Q?GItBd5n37dZdrD5TtjSdZoPMNtl93QoWw1HRZANMulIbNoA86FM9FcNIjq7Z?=
 =?us-ascii?Q?PBeSyLI3MEpOS0vNwK56leCa8SMYmUDZernSBJiGX8g5fynunpRnSPVMSwlE?=
 =?us-ascii?Q?a+10UAT2pwJqE1rIs54OHpIx1wjgMgukJFEp3xEeGD7jq84cxPHezd8GoU1O?=
 =?us-ascii?Q?PeM1R3tr7VEZJkH7LMzkCWMFniZcwd9Y5Ll6A9WWaXG8i39bhLOc93d1e/RQ?=
 =?us-ascii?Q?9OPeXgj9hv3MawjIaVmCoqvcwKlYcyymOehNcX5gLHAUzaLhMjd1c4eNKHoH?=
 =?us-ascii?Q?YPTKbX4y8OYEmfYG1mwoHaKpfKjj2B89QKyt+RuQ4gKR9/98Ilv8NiRIKScv?=
 =?us-ascii?Q?vufe2xi+i3KTB8Ag5h5DoRkZmPSM7bHSjpHe1KaPYASiAfYQvx8UzkKe+TU3?=
 =?us-ascii?Q?9W+KtpAATkzGTBKqxoBc185yBMRDbJcNx65L2PKM1C1OIUY1M6Ww9lwLzl0G?=
 =?us-ascii?Q?jHisJ88qeY37SXaofgy5GDMqrDT5dM6xVAQ2T3QX5gBE3JJBn/uhWA5qwmH7?=
 =?us-ascii?Q?r2BtKDh2daPoUHsCi9/t6CR7KDjihdDH+lAvtYKaWc+IU25NJBk8PqZmwsSd?=
 =?us-ascii?Q?Bn+id6UEihy3jswU5R+dLBBUf4mTqLTmcMYNARAnyZCdLhGlkrccmuN+P+e0?=
 =?us-ascii?Q?bshbYEF49V/7ovUZTO7eF1qihV6uwuCiANoVTdsVJv5Y5Y4jQLZSPLGYvkFI?=
 =?us-ascii?Q?jt2ZzbbcBGIkZnr6H95s/FqlhMTmRmsjO4KFXCxifR8j8urjOFyMJ+1Gt9Ai?=
 =?us-ascii?Q?PSqk+DU8orAgzU44LNSKwp2CbmS8hdTrB4hEwOhsrDfvw/Q6ygWvg8UA6I+v?=
 =?us-ascii?Q?5+Cl6keuUKxdgEwrBelBEEdjEMoHN/qeMrKnSnBQVsZ8eQQtZX/6xHfIAtW1?=
 =?us-ascii?Q?T7+5D9rdzuqJxrrpiHxijVAlGqOPaQiEQllO2CfMBUj2xredRyRieq2jthhP?=
 =?us-ascii?Q?vhlvR2kPQFah3EAp9x7RaDhqVtBb+gLEC5bHn5ocbDBmIa2LALz+YoOKOt6D?=
 =?us-ascii?Q?h4Jlkf3oBvRHFGjdlcumXVC1RPZDUSvKP+ZeSSpwyoKv0UhkfST25Wg8R77v?=
 =?us-ascii?Q?Nk+ePP6cC9ItQoJww9Yt7hPHKQnP13DYUqXiOUcXtfjc5XD4tpDbRLNXrCif?=
 =?us-ascii?Q?+7rRCyvll4AxVOqwZsHtkndH2eX8m8/740UdNVk9NtCHYgdHt4lDD+95VbIA?=
 =?us-ascii?Q?FqmP09aXPqTqwtrfE1Mns1CUfbCAqATSDc/MbmA+HPwBqdTDtzlh99Tb6XuS?=
 =?us-ascii?Q?1XIR5/cze15Vg4bn+ix2CDmxqOntEJ4JBq5XGm6afBHB5d8gKa1hy0X/1Phq?=
 =?us-ascii?Q?v9rdDt/87UiOUZRjNEILDSfBAWzewE4FGznK/DqPDrRMF+VHMi/5Jy2hS0Ts?=
 =?us-ascii?Q?1N59eyItrOuP6hkXItkvQAnOvaWBFb+BB7FONljBQMoV3w8KhQJz7ungqQi3?=
 =?us-ascii?Q?6l09KcqHU47sSolGTZdzkYvAo7oYaQ/75ItMMn4xfajEaFQz8FACB3WZ7foC?=
 =?us-ascii?Q?xA=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 09ece64f-d8d1-4cb4-d333-08db4cdbd6cf
X-MS-Exchange-CrossTenant-AuthSource: DS7PR11MB7859.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 04 May 2023 20:12:09.1666 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: JBcSyAtuJnDENSXE4ry/0fKOMyE19mM7Of0PKIV/sAG6hP068jFkSuti0/9KXZnMLURDVL12IL9+Jyi/geVlyU1DyN/T+atHSRzvZhziQnU=
...
> @@ -612,10 +605,10 @@ xehpsdv_ppgtt_insert_huge(struct i915_address_space *vm,
...
>  	u64 start = vma_res->start;
>  
> @@ -735,7 +728,7 @@ static void gen8_ppgtt_insert_huge(struct i915_address_space *vm,
>  
...
> @@ -743,9 +736,9 @@ static void gen8_ppgtt_insert(struct i915_address_space *vm,
>  
...
>  
> @@ -754,7 +747,7 @@ static void gen8_ppgtt_insert(struct i915_address_space *vm,
...
>  
>  		vma_res->page_sizes_gtt = I915_GTT_PAGE_SIZE;
> @@ -764,7 +757,7 @@ static void gen8_ppgtt_insert(struct i915_address_space *vm,
...
> @@ -778,14 +771,14 @@ static void gen8_ppgtt_insert_entry(struct i915_address_space *vm,
...
>  {
>  	u64 idx = offset >> GEN8_PTE_SHIFT;
> @@ -808,20 +801,20 @@ static void __xehpsdv_ppgtt_insert_entry_lm(struct i915_address_space *vm,
>  	}
>  
>  	vaddr = px_vaddr(pt);
...
> @@ -856,7 +849,9 @@ static int gen8_init_scratch(struct i915_address_space *vm)
>  
>  	vm->scratch[0]->encode =
>  		vm->pte_encode(px_dma(vm->scratch[0]),
...
>  	for (i = 1; i <= vm->top; i++) {
>  		struct drm_i915_gem_object *obj;
> @@ -874,7 +869,9 @@ static int gen8_init_scratch(struct i915_address_space *vm)
>  		}
>  
...
> @@ -894,9 +894,15 @@ static void uc_fw_bind_ggtt(struct intel_uc_fw *uc_fw)
>  		pte_flags |= PTE_LM;
>  
...
> @@ -139,21 +139,53 @@ static const char *stringify_vma_type(const struct i915_vma *vma)
>  	return "ppgtt";
>  }
>  
...
>  	int pin_count = 0;
>  
> @@ -165,7 +197,7 @@ i915_debugfs_describe_obj(struct seq_file *m, struct drm_i915_gem_object *obj)
>  		   obj->base.size / 1024,
>  		   obj->read_domains,
>  		   obj->write_domain,

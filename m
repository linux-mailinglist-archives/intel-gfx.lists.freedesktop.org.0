...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BA32A678FE0
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Jan 2023 06:32:03 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7DE5C10E5F2;
...
Subject: [Intel-gfx] [PATCH v6 2/6] drm/i915/pxp: add device link between
 i915 and mei_pxp

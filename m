...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 78F04AB3B77
	for <lists+intel-gfx@lfdr.de>; Mon, 12 May 2025 16:57:29 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B4C910E435;
	Mon, 12 May 2025 14:57:28 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="O4CyHr8D";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 985F310E433;
 Mon, 12 May 2025 14:57:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1747061848; x=1778597848;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=xNiLs0lF3dtmk8vLqJaHbUwh88klB2R1gRwhee/aY+g=;
 b=O4CyHr8DEOepuovZ74tx+jjQtp7bjQff7TIvHoAJdl1bzV1LX0F9ttCy
 PfXtiQr+ITc7hxD49y9ydNfXfvXLOavoboThvm8fNyKm1Ybd6pzpyLeAy
 ycRDkbh/r4vh+79AnKuE+RzDeNL8I7uzyBTkxs2uB7iySaZrY7pggh8Oh
 InApnJ+I/Bh/VtS3XnsgYPyX33wBUatYzVJdb31mT3aP6HNe58RQ+BIEh
 OQJjJOr85OeZCNpAw2CJMSihfGSnYdsAOptUJypluFBicTEd0mfWc+DYK
 4P9UtWb6XOG+WQninJPNeHnl5MiFAuahqmPYNAzuF0xq/6pGNO1iSx9Rk A==;
X-CSE-ConnectionGUID: 5TnwjyOGTnyHI4OO2C3VsQ==
X-CSE-MsgGUID: 4DhiSLPTSf+qpRRrEjVKdg==
X-IronPort-AV: E=McAfee;i="6700,10204,11431"; a="60264680"
X-IronPort-AV: E=Sophos;i="6.15,282,1739865600"; d="scan'208";a="60264680"
Received: from fmviesa010.fm.intel.com ([10.60.135.150])
 by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2025 07:57:28 -0700
X-CSE-ConnectionGUID: XMf7NqOQRYKi9q4d97h1iA==
X-CSE-MsgGUID: dbuehjk2Rm6HEgLMCGgUsQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,282,1739865600"; d="scan'208";a="137857514"
Received: from smoticic-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.245.245.186])
 by fmviesa010-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 12 May 2025 07:57:25 -0700
From: Jani Nikula <jani.nikula@intel.com>
To: intel-gfx@lists.freedesktop.org,
	intel-xe@lists.freedesktop.org
Cc: ville.syrjala@linux.intel.com,
	jani.nikula@intel.com
Subject: [PATCH v3 5/8] drm/i915: move VLV IOSF SB unit specific helpers under
 display
Date: Mon, 12 May 2025 17:56:56 +0300
Message-Id: <e86c2498c9f1c1d30f8e83fa5f1c23526b87b9ab.1747061743.git.jani.nikula@intel.com>
...
index 6f364db27e21..abf1db22fafe 100644
...
index 6772ac0c3f84..0a3d302f9d1b 100644
...
index dce4fdf091f6..29c920983413 100644
...
new file mode 100644
index 000000000000..beac69157d24
--- /dev/null
...
index efb5ee39dbbb..c6418d54dae9 100644
...
index 66f8918d4974..f4fb7213fe37 100644

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 493722C6513
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:12:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 1B0C56ECB0;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 097/162] drm/i915: Distinction of memory
 regions

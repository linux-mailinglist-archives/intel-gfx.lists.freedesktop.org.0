...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B61DA2ECB8D
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Jan 2021 09:08:30 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B9626E436;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 7/8] drm/nouveau: Remove references to struct
 drm_device.pdev

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D5BD62D6E1
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Nov 2022 10:30:01 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5596D10E5B0;
...
Subject: [Intel-gfx] [PATCH v10 07/19] drm/connector: Add a function to

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id DE1DD401553
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Sep 2021 05:51:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0B890899F3;
	Mon,  6 Sep 2021 03:51:06 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-44.mimecast.com
 (us-smtp-delivery-44.mimecast.com [207.211.30.44])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 7AAF4899E8
 for <intel-gfx@lists.freedesktop.org>; Mon,  6 Sep 2021 03:51:04 +0000 (UTC)
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-177-akWq-SHANbCtDT7ICUPSGw-1; Sun, 05 Sep 2021 23:44:17 -0400
X-MC-Unique: akWq-SHANbCtDT7ICUPSGw-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com
 [10.5.11.14])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 16D69107ACC7;
 Mon,  6 Sep 2021 03:44:16 +0000 (UTC)
Received: from dreadlord-bne-redhat-com.bne.redhat.com (unknown [10.64.0.157])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 9E82E5D9DE;
 Mon,  6 Sep 2021 03:44:14 +0000 (UTC)
From: Dave Airlie <airlied@gmail.com>
To: intel-gfx@lists.freedesktop.org
Cc: jani.nikula@linux.intel.com,
	Dave Airlie <airlied@redhat.com>
Date: Mon,  6 Sep 2021 13:43:51 +1000
Message-Id: <20210906034356.2946530-6-airlied@gmail.com>
...
Subject: [Intel-gfx] [PATCH 05/10] drm/i915/display: move intel_dmc into
 display struct
...
oaddr, 0)),
+=09=09=09=09     DMC_PROGRAM(dev_priv->display.dmc.dmc_info[DMC_FW_MAIN].s=
tart_mmioaddr, 0)),
...
;
+=09struct drm_i915_private *i915 =3D container_of(dmc, typeof(*i915), disp=
lay.dmc);
=20
...
-=09dmc =3D &dev_priv->dmc;
+=09dev_priv =3D container_of(work, typeof(*dev_priv), display.dmc.work);
+=09dmc =3D &dev_priv->display.dmc;
=20

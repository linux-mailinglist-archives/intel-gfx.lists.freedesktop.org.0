...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4666C2C6462
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:08:44 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 38BFD6EC25;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 017/162] drm/i915: Rework struct phys
 attachment handling

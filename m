...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 535115B0F8F
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 23:52:38 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 509D810E8DE;
	Wed,  7 Sep 2022 21:52:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B7EBC10E8DE
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Sep 2022 21:52:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1662587549; x=1694123549;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=CjfDUeUXEEM0UEJOM8qNDNPrMsXkN+4zeKYb+3xpo6g=;
 b=ixTfM5WFVv9cDMapslcj9S6v0Lg0E6XYBAFmb/0aqqF9Ope9cqhSO2zD
 Z6P3LSJYeTEXiUN1lV4taiAPUNB0MLhOQmAF12UZTYeLYwqK2AXag7Ayf
 +CYQPVG0Hf0pO1RKR8dyMJ0v7Xplh5FsTckBhzxTrHxE2waFOlkFBWSK/
 lBxWY40PqfaVA9TfJyt44KDeQqHrCXO3qu2cNbomwkmX6y8Lp44B526Xs
 KknrGyTdYe71QdBaZZdiTsyS4ZZdlaRTsNcp55RXDhQk0i2xP0L66h89z
 Z6Zaf5pVIPZihyt2W2NRzZuZpkkQVzlvOaTQamZOjlZIo9kLehsWEHKZI A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10463"; a="358738988"
X-IronPort-AV: E=Sophos;i="5.93,298,1654585200"; d="scan'208";a="358738988"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2022 14:52:29 -0700
X-IronPort-AV: E=Sophos;i="5.93,298,1654585200"; d="scan'208";a="790208085"
...
Message-Id: <20220907215113.1596567-16-tomas.winkler@intel.com>
...
Subject: [Intel-gfx] [PATCH v9 15/16] drm/i915/gsc: allocate extended

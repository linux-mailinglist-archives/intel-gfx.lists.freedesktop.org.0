...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7789F643A44
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Dec 2022 01:36:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 574C610E30E;
...
Subject: [Intel-gfx] [RFC PATCH 15/17] dyndbg: ddebug_sanity()

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BB987142560
	for <lists+intel-gfx@lfdr.de>; Mon, 20 Jan 2020 09:24:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 000E36E843;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v3 18/22] drm/vc4: Convert to CRTC VBLANK
 callbacks

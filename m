...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 91EE82D2533
	for <lists+intel-gfx@lfdr.de>; Tue,  8 Dec 2020 08:58:54 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 59BC96E96A;
...
Subject: [Intel-gfx] [PATCH v4 15/16] drm/i915: Let PCON convert from RGB to
 YUV if it can

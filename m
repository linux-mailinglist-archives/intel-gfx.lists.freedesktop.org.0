...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B09B6EEE1F
	for <lists+intel-gfx@lfdr.de>; Wed, 26 Apr 2023 08:14:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F06A10E8B2;
	Wed, 26 Apr 2023 06:13:52 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 482CA10E8AF;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=iz0mTBrZRVh3cw2ECzFB6o1ZQsR2c3gkl9cdZTuOc+M=;
 b=NKhaFBvTmCcciXkY4fEG22ob0NSiJgelhx8XqRW+a48n//cgxtga76oK
 73BtjEdzTOn0haFXcn5GV8KJGgOoZz+jiMD5eL4xtyev+SJgykD9HpWja
 cAIMTH1m5hoMbgxECFKA9ouaicRMZ3/p6wH67uNJTTgjiHbj6EVAGm3SP
 mXplBTzYHsYsXjiLb+yNjGRrYJQtkY04PlNjJ4wHQfWg0f++Ie64b/Vi5
 AG6VSpBgPRxN86e0vksPrfzzdhpS5+WWe5IQ2bD5/r697AZrBtn17lEfC
 xdWNUdRMd/Hedm8nDjI8h6Ikp81zsEPStlSqvqKpqPLosCcT9u0ELxWzN Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="331234660"
X-IronPort-AV: E=Sophos;i="5.99,227,1677571200"; d="scan'208";a="331234660"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 23:13:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10691"; a="837767305"
X-IronPort-AV: E=Sophos;i="5.99,227,1677571200"; d="scan'208";a="837767305"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Apr 2023 23:13:47 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Tue, 25 Apr 2023 23:14:50 -0700
Message-Id: <20230426061452.320390-2-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230426061452.320390-1-fei.yang@intel.com>
References: <20230426061452.320390-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH v2 1/3] drm/i915: preparation for using PAT index

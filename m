...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B08B454278F
	for <lists+intel-gfx@lfdr.de>; Wed,  8 Jun 2022 09:17:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9E4E110E6F5;
	Wed,  8 Jun 2022 07:17:21 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A7ABF10E620;
 Wed,  8 Jun 2022 07:17:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1654672640; x=1686208640;
 h=message-id:date:mime-version:subject:to:cc:references:
 from:in-reply-to:content-transfer-encoding;
 bh=8YPRTmlZKv/OgZo7+pxfQ/fkxf++/7jcoV0XY5mYrCY=;
 b=lKswlI7INZ/KoSobLwz9GkVbqNpHgd5dfKGumyXGy19hR7Hzopa9BVPt
 H9UwVBRcQF+wlaNcjUlT0VGJrSS7rJT0y/wMdfJ9VGplq9Z/P7Vu4DXyF
 5r/Dx7hgDy1XIlH1CIdlbPMAhHr4N8Cq6/+bakf2nut9T6Ko3qntkc2hn
 i/ib94cde21NN03kVIkPKzYglrz/hUpyMowDdrxcCrIqkq7PjgPLMjdQt
 Kvj2nni7FEsy/pnTkMskVGEDGr3Y4Ry/hEVNpF9la6dsXBybFPSidH2FB
 oD1mBCtlCYwzh/FilhDloSmeya+FHt/Yq36J67pamN5I/SQzFMC3KSeug w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10371"; a="302162299"
X-IronPort-AV: E=Sophos;i="5.91,285,1647327600"; d="scan'208";a="302162299"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jun 2022 00:17:20 -0700
X-IronPort-AV: E=Sophos;i="5.91,285,1647327600"; d="scan'208";a="907515045"
Received: from jking17-mobl.ger.corp.intel.com (HELO [10.213.193.156])
 ([10.213.193.156])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Jun 2022 00:17:17 -0700
Message-ID: <78882100-e597-52e2-b05e-30c80863a2bb@linux.intel.com>
Date: Wed, 8 Jun 2022 08:17:15 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220607193702.GW4461@nvishwa1-DESK>

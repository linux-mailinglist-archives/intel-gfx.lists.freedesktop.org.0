...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 323427A99D
	for <lists+intel-gfx@lfdr.de>; Tue, 30 Jul 2019 15:31:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 709CA6E514;
	Tue, 30 Jul 2019 13:31:08 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id EFD276E511
 for <intel-gfx@lists.freedesktop.org>; Tue, 30 Jul 2019 13:30:55 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 17730638-1500050 
 for multiple; Tue, 30 Jul 2019 14:30:37 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 30 Jul 2019 14:30:21 +0100
Message-Id: <20190730133035.1977-4-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 03/17] drm/i915: Flush extra hard after writing
...
bS9pOTE1X2dlbV9leGVjYnVmZmVyLmMKaW5kZXggOGEyMDQ3YzRlN2MzLi4wMTkwMWRhZDMzZjcg
...
QCAtMTAxOSwxMSArMTAxOSwxMiBAQCBzdGF0aWMgdm9pZCByZWxvY19jYWNoZV9yZXNldChzdHJ1
...
MTA3OCw2ICsxMDc5LDcgQEAgc3RhdGljIHZvaWQgKnJlbG9jX2lvbWFwKHN0cnVjdCBkcm1faTkx
...
LT52YWRkcikpOwogCX0gZWxzZSB7CiAJCXN0cnVjdCBpOTE1X3ZtYSAqdm1hOwpAQCAtMTExOSw3
ICsxMTIxLDYgQEAgc3RhdGljIHZvaWQgKnJlbG9jX2lvbWFwKHN0cnVjdCBkcm1faTkxNV9nZW1f

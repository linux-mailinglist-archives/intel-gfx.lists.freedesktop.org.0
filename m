...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E82657B632
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Jul 2022 14:16:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9A2E712A436;
	Wed, 20 Jul 2022 12:15:51 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 3/3] drm/i915/display: add hotplug.suspended
 flag

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C871F5B3007
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:36:32 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 424C110EC1F;
...
Subject: [Intel-gfx] [PATCH v3 26/37] docs: gpu: i915.rst: display: add
 kernel-doc markups

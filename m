...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C51984BD7F
	for <lists+intel-gfx@lfdr.de>; Wed, 19 Jun 2019 18:06:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B6B076E439;
...
X-Mailman-Original-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 B87Q==
Subject: [Intel-gfx] [RFC] Exposing plane type mask and handling 'all' planes

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BC647C91F6
	for <lists+intel-gfx@lfdr.de>; Sat, 14 Oct 2023 03:04:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DAB5310E07F;
...
Subject: [Intel-gfx] [PATCH v5 1/3] drm/i915/guc: Flush context destruction
 worker at suspend

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E74274D013A
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Mar 2022 15:29:36 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 40ED610E13C;
	Mon,  7 Mar 2022 14:29:31 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v3 1/6] drm/i915/gt: Use XY_FASR_COLOR_BLT

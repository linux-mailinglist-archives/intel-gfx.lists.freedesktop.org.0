...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 45CFA5EFA8F
	for <lists+intel-gfx@lfdr.de>; Thu, 29 Sep 2022 18:31:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0584010EACC;
	Thu, 29 Sep 2022 16:31:26 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v4 05/30] drm/connector: Rename subconnector
 state variable

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BA135FB3C5
	for <lists+intel-gfx@lfdr.de>; Tue, 11 Oct 2022 15:50:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2F23110E807;
...
Subject: [Intel-gfx] [PATCH 08/15] drm/edid: add function for checking
 drm_edid validity

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C3EF2EC696
	for <lists+intel-gfx@lfdr.de>; Thu,  7 Jan 2021 00:12:35 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 5933D6E334;
	Wed,  6 Jan 2021 23:12:26 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id B0E646E30D
 for <Intel-gfx@lists.freedesktop.org>; Wed,  6 Jan 2021 23:12:24 +0000 (UTC)
IronPort-SDR: d81SvLGspdAy9mz+QbeQjSJVZqg0j3AbSHjN8OZXWFSCnFf9KnA3Ff4YW7yHgiGsJ+ZVy3EqJo
 E/JHpq3R8IDg==
X-IronPort-AV: E=McAfee;i="6000,8403,9856"; a="195900075"
X-IronPort-AV: E=Sophos;i="5.79,328,1602572400"; d="scan'208";a="195900075"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Jan 2021 15:12:23 -0800
IronPort-SDR: O05kaSFabEjOxTg4VpR5P3HDpCD3KhdLDEUuYCYQ+2f4PidUTRc5kkX8pW4Kj9DjYpqlqB616s
 MPKd+9fCUcXA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.79,328,1602572400"; d="scan'208";a="567566131"
Received: from sean-virtualbox.fm.intel.com ([10.105.158.96])
 by fmsmga006.fm.intel.com with ESMTP; 06 Jan 2021 15:12:23 -0800
From: "Huang, Sean Z" <sean.z.huang@intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Wed,  6 Jan 2021 15:12:20 -0800
Message-Id: <20210106231223.8323-11-sean.z.huang@intel.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20210106231223.8323-1-sean.z.huang@intel.com>
References: <20210106231223.8323-1-sean.z.huang@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC-v19 10/13] mei: pxp: export pavp client to me
 client bus

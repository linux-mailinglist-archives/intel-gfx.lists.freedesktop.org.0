...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B87154D6B59
	for <lists+intel-gfx@lfdr.de>; Sat, 12 Mar 2022 01:11:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AC66E10E7FC;
	Sat, 12 Mar 2022 00:11:24 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A33C210E069
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=WQmswBmMIAksNQOk8bn4V0QZ565/MV+dwlwp4Q2Pgh0=;
 b=UuzafNed22ekQpLrlX2MFXKqdCv388XDxW2o/+b5Fdtm92knMebHW27a
 iVZrtFK0/Kqj7+obtHZfNb26wkefH3QQulGdFaebbaiTFZX+0+sO2ZOaw
 g4ZiCUzkIO+xS+IdJynOYXJU2/xYfM3zuBBS5FHTs91YP40vvt8lbUBtX
 avQmfjRl/LgYHg62YLkRfZf2GPcbzhpDkBYd5STxwFrGHNGpSmzTrbCXc
 sCR66Ou4shKNfRykYUUSZY0du85nUhcWh1+3RwHGeHZhHauGo9JPc8yrQ
 D4iXsZkwetLF1SObr2WiJWDjuSBmVYr4gNlQWvioZORaBsjgWppaKDISg Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10283"; a="316399861"
X-IronPort-AV: E=Sophos;i="5.90,175,1643702400"; d="scan'208";a="316399861"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Mar 2022 16:11:21 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,175,1643702400"; d="scan'208";a="514681592"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga006.jf.intel.com with ESMTP; 11 Mar 2022 16:11:21 -0800
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 11 Mar 2022 16:13:42 -0800
Message-Id: <20220312001344.1314090-13-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 12/13] drm/i915/guc: Plumb GuC-capture into
 gpu_coredump
...
index 1c602d4ae297..07f65b6ab881 100644
...
index 40d03649ef65..9e33f9c9201a 100644
...
index 6925ce101332..27c52aa5f132 100644
--- a/drivers/gpu/drm/i915/gt/uc/intel_guc_submission.c
+++ b/drivers/gpu/drm/i915/gt/uc/intel_guc_submission.c
@@ -4006,7 +4006,7 @@ static void capture_error_state(struct intel_guc *guc,
...
index 5e09a4e4b01a..ffd268ad153a 100644

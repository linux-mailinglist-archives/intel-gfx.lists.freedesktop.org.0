...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 6544A434E42
	for <lists+intel-gfx@lfdr.de>; Wed, 20 Oct 2021 16:52:37 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2957A89EA9;
...
Subject: Re: [Intel-gfx] [PATCH 5/9] drm/i915/userptr: add paranoid
 flush-on-acquire

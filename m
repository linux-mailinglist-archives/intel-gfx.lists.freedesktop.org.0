...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CF8112A1D27
	for <lists+intel-gfx@lfdr.de>; Sun,  1 Nov 2020 11:14:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 320AE6EA99;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 10/13] drm/i915: Add support for enabling

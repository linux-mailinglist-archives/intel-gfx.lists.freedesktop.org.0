...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B16BC509AAF
	for <lists+intel-gfx@lfdr.de>; Thu, 21 Apr 2022 10:31:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D90C110F84C;
...
Subject: Re: [Intel-gfx] [CI 3/4] drm/i915/selftests: fixup min_alignment
 usage

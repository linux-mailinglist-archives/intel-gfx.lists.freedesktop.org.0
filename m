...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id D19FA423605
	for <lists+intel-gfx@lfdr.de>; Wed,  6 Oct 2021 04:41:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6CDB66ECD2;
	Wed,  6 Oct 2021 02:41:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E40D56ECCC
 for <intel-gfx@lists.freedesktop.org>; Wed,  6 Oct 2021 02:41:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1633488101;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=VRuibAzD4usxTf8vGq2IshPiQf0ZGBrLjbZl7aosdOQ=;
 b=Q+YmxOquNs1TuXUyth8XDVl/D6cp9gFl4FKx8HtVaDQw56R/HwSnAv4c45xBx58SW0QqrF
 HDdyEXnrKhCy5ecyWBKZB5lIxs2TWb1Ocd6egPJVhEOKHQXsXGmxRDoTvT05ojIgdoY3mU
 DRfWmUPnNO2jKmi+V0fVEihI0RS/pB4=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-212-TsyCj4yHPCe0F15gYLyScg-1; Tue, 05 Oct 2021 22:41:39 -0400
X-MC-Unique: TsyCj4yHPCe0F15gYLyScg-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com
 [10.5.11.16])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 4AF88802C88;
 Wed,  6 Oct 2021 02:41:38 +0000 (UTC)
Received: from Ruby.lyude.net (unknown [10.22.16.47])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 511799AA2E;
 Wed,  6 Oct 2021 02:41:36 +0000 (UTC)

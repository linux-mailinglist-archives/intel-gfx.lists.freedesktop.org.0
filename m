...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 99970671C80
	for <lists+intel-gfx@lfdr.de>; Wed, 18 Jan 2023 13:46:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3150010E73E;
	Wed, 18 Jan 2023 12:46:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id A2A0710E734;
 Wed, 18 Jan 2023 12:46:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1674046010; x=1705582010;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=+ZZEAv9K+ZT/3fNPwRnKz19BoW4nYzemjNyBzXFEB4g=;
 b=RchTCQ6AoTbP/GTUO12LkFch+DP+e7VOEA/dJpniMIu138LUklSuIjbt
 WFu8fxYIOFvuZBeOzaQO1K1y1005QJyCewl9R2oBG/cDst0WNmvmkroaD
 fK6uMo9OBTG3TXOMCI/omaqUpUXxq5qCvDE2DRayJy37GiRAu93Uq/GZL
 As6Adj5Bwf/TIRH1eoRqIyB4qLhZ+XNrY58Y2TW+CnJJMK64hfmqdTHZ5
 a14anfWQJrTGO3Gx5zKVaDEbMgBlo4GCkrnw+WFASYa1pbEbab0eIlzkc
 sahEqLl7ZlzHN/1/6JtqTBAuyiB0TBguyi79zkAA7Yyu0HHc255Ym7PEF w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10593"; a="326243646"
X-IronPort-AV: E=Sophos;i="5.97,226,1669104000"; d="scan'208";a="326243646"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 18 Jan 2023 04:46:49 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10593"; a="659787927"
X-IronPort-AV: E=Sophos;i="5.97,226,1669104000"; d="scan'208";a="659787927"
Received: from lkp-server01.sh.intel.com (HELO 5646d64e7320) ([10.239.97.150])
 by orsmga002.jf.intel.com with ESMTP; 18 Jan 2023 04:46:45 -0800
Received: from kbuild by 5646d64e7320 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1pI7q1-0000He-09;
 Wed, 18 Jan 2023 12:46:45 +0000
Date: Wed, 18 Jan 2023 20:46:23 +0800
From: kernel test robot <lkp@intel.com>
To: Niranjana Vishwanathapura <niranjana.vishwanathapura@intel.com>,
 intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org
Message-ID: <202301182041.DwUH6Zow-lkp@intel.com>
References: <20230118071609.17572-24-niranjana.vishwanathapura@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Zbhj99bEIrLuEUS8"
...
Cc: paulo.r.zanoni@intel.com, jani.nikula@intel.com, thomas.hellstrom@intel.com,
 matthew.auld@intel.com, oe-kbuild-all@lists.linux.dev, daniel.vetter@intel.com,
...
config: i386-randconfig-a016-20230116
...
All errors (new ones prefixed by >>):
   ...
   drivers/gpu/drm/i915/i915_gem.c: In function 'i915_gem_object_unbind':
>> drivers/gpu/drm/i915/i915_gem.c:181:55: error: 'struct i915_address_space' has no member named 'vm_capture_lock'
   ...
   include/linux/mutex.h:188:72: note: in definition of macro 'mutex_lock_interruptible'
     188 | #define mutex_lock_interruptible(lock) mutex_lock_interruptible_nested(lock, 0)
         |                                                                        ^~~~
>> drivers/gpu/drm/i915/i915_gem.c:182:55: error: 'struct i915_vma' has no member named 'vm_capture_link'
     182 |                         sync_unbind = !list_empty(&vma->vm_capture_link);
         |                                                       ^~
   drivers/gpu/drm/i915/i915_gem.c:183:46: error: 'struct i915_address_space' has no member named 'vm_capture_lock'

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C6B8718F3D
	for <lists+intel-gfx@lfdr.de>; Thu,  1 Jun 2023 01:54:57 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EA35F10E1FA;
	Wed, 31 May 2023 23:54:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 59D5410E0F9;
 Wed, 31 May 2023 23:54:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1685577268; x=1717113268;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=+ztP8igmaMYPj9wa+3/6YesKPU88eGl8vIbj3OI22MA=;
 b=E4OpL/2biqhDvfLlvlD2uyNn41I72oz7/Llz92fkAGUgVvwEAvEqnEr9
 EJI0sktlJTWDfMob9+WrfmbMHiU7pkHT5eAYzAE3I9qJnk7AhZjgKVmCj
 dr9Mqo1x9iVsIrw6D2IpMm8WjCaiFIiD6MpbPWIOUBzdpIHtRn6Tpyn4n
 RfWUB9BGx1Hsi5MiuR/jONmYrVObJWRGz8naMrwREUMu/e42Ft+0agx3K
 ElA1m4E+K4UNu0Nrfrp0MrlK9a1JKStTFgqbHKvqQMvaHYsL8lUu6KQnd
 wf8B5OKICxlubGgC88Eg806b1bum63TU6F5LVAcmmYNd6tREW4RzPjL9X Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="335747045"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; d="scan'208";a="335747045"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 May 2023 16:54:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10727"; a="707109950"
X-IronPort-AV: E=Sophos;i="6.00,207,1681196400"; d="scan'208";a="707109950"
...
Message-Id: <20230531235415.1467475-5-daniele.ceraolospurio@intel.com>
...
Subject: [Intel-gfx] [PATCH v5 4/7] drm/i915/huc: differentiate the 2 steps
 of the MTL HuC auth flow

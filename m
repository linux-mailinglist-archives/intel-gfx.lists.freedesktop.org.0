...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id ABB3A7D0F6A
	for <lists+intel-gfx@lfdr.de>; Fri, 20 Oct 2023 14:09:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 73F3810E5B7;
	Fri, 20 Oct 2023 12:09:44 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D01610E5B5
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=YdG2tzSbjETF26rcHGmfDPlUGYjVB72pK084q4uaM8c=;
 b=hflqDzquEhQfDSKzpzTBYfxw90QsJ9k2QdxM8Gm5B+Hwt7uiIYRJwQba
 YkQYpiyytM0qo3zAItsFV859yG0/tg0FjyK3V7oiWYuznjQ+RG178VAKD
 97FEL7KJNgYiZ1maBWiYuzd2hRoyOPNbQqgRan/lpvMU0TNL7EEV9yO48
 kQjR7LJl73w7VOG383cjwy1epTSuk4LhqARqiXVEaFPzzQfHQhifkKfR9
 Z8xNnE+bnY7NiyXOZTtwBNgqN6rH8Nvp4b7OfXjeosJfG0PT5ogDAY2+E
 ZySHsxLtmYkc8bO/6g9obcVZz5DsaLvgjuLdRlWAJj67WgaAwPQjySMRR w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10868"; a="383699505"
X-IronPort-AV: E=Sophos;i="6.03,238,1694761200"; d="scan'208";a="383699505"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Oct 2023 05:09:38 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10868"; a="881058681"
X-IronPort-AV: E=Sophos;i="6.03,238,1694761200"; d="scan'208";a="881058681"
Received: from lab-ah.igk.intel.com ([10.102.138.202])
 by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Oct 2023 05:09:36 -0700
From: Andrzej Hajda <andrzej.hajda@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 20 Oct 2023 14:09:11 +0200
Message-Id: <20231020120912.1888023-4-andrzej.hajda@intel.com>
...
Subject: [Intel-gfx] [PATCH v2 3/4] drm/i915: Add WABB blit for

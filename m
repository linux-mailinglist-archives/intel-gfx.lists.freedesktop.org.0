...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F16EDAFB3B8
	for <lists+intel-gfx@lfdr.de>; Mon,  7 Jul 2025 14:59:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 03A7B10E464;
	Mon,  7 Jul 2025 12:59:57 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=didiglobal.com header.i=@didiglobal.com header.b="MHSNTkBp";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mx10.didiglobal.com (mx10.didiglobal.com [111.202.70.125])
 by gabe.freedesktop.org (Postfix) with SMTP id 48A9D10E41F;
 Mon,  7 Jul 2025 07:00:55 +0000 (UTC)
Received: from mail.didiglobal.com (unknown [10.79.65.20])
 by mx10.didiglobal.com (MailData Gateway V2.8.8) with ESMTPS id 1D08B188C7420B;
 Mon,  7 Jul 2025 14:59:48 +0800 (CST)
Received: from BJ01-ACTMBX-08.didichuxing.com (10.79.64.15) by
 ...
 15.2.1748.10; Mon, 7 Jul 2025 15:00:32 +0800
Received: from BJ03-ACTMBX-07.didichuxing.com (10.79.71.34) by
 BJ01-ACTMBX-08.didichuxing.com (10.79.64.15) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1748.10; Mon, 7 Jul 2025 15:00:31 +0800
Received: from BJ03-ACTMBX-07.didichuxing.com ([fe80::2e1a:dd47:6d25:287e]) by
 ...
 mapi id 15.02.1748.010; Mon, 7 Jul 2025 15:00:31 +0800
...
Subject: [PATCH v4 3/5] fs: change write_begin/write_end interface to take
 struct kiocb *
Thread-Topic: [PATCH v4 3/5] fs: change write_begin/write_end interface to
 take struct kiocb *
Thread-Index: AQHb7wzUUGw9/J/Qtkacdil7kTEC9Q==
Date: Mon, 7 Jul 2025 07:00:31 +0000
Message-ID: <20250707070023.206725-4-chentaotao@didiglobal.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=didiglobal.com;
 s=2025; t=1751871610;
 bh=+BnBZohDYzZ0PODCWnc97Jb9o/Oil+99vYu6K6eb+Ag=;
 h=From:To:CC:Subject:Date:Message-ID:Content-Type;
 b=MHSNTkBpA9S7xGQLAO4mQrbxEusxWOHMFvsdHGXv7dQeQvw7q+5cf7SdxszV/OxsX
 /wyrwccqocXA+lG+OLbohBc3anKWGW80+6qPoJP7qvC6AOy4+CYXpQ+5Ke7D6naqQb
 Rsr0DKCO4hOt8PUPHHF8g96BzEp5jrDbxx+rEQus=
...
ZGUvbGludXgvZnMuaCBiL2luY2x1ZGUvbGludXgvZnMuaA0KaW5kZXggNDNhODVjZmFmYzNmLi4y
MWJmNWVmOGY2ZTggMTAwNjQ0DQotLS0gYS9pbmNsdWRlL2xpbnV4L2ZzLmgNCisrKyBiL2luY2x1

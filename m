...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CC2D32A4A7D
	for <lists+intel-gfx@lfdr.de>; Tue,  3 Nov 2020 16:58:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DD4BF6ECBA;
	Tue,  3 Nov 2020 15:58:40 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3F2896ECBA
 for <intel-gfx@lists.freedesktop.org>; Tue,  3 Nov 2020 15:58:39 +0000 (UTC)
IronPort-SDR: 4pUhJPQx92qPPt82yKRcPRBy2dF1wV3nK9CRL386AQyTojtFU4IzFy8EORrDuytiDFPmVChieG
 aaJStkR5ED3w==
X-IronPort-AV: E=McAfee;i="6000,8403,9794"; a="186922319"
X-IronPort-AV: E=Sophos;i="5.77,448,1596524400"; d="scan'208";a="186922319"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Nov 2020 07:58:38 -0800
IronPort-SDR: Har1X9qVsVnUXMg8kCCEHbqjg9A7kIXmnYDOxLGNHjwW8eWH9DL/sySk36t+UYvva/YDOdHctK
 z8d7BRubk9DA==
X-IronPort-AV: E=Sophos;i="5.77,448,1596524400"; d="scan'208";a="357723789"
Received: from labuser-z97x-ud5h.jf.intel.com ([10.165.21.211])
 by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-SHA;
 03 Nov 2020 07:58:38 -0800
From: Manasi Navare <manasi.d.navare@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  3 Nov 2020 08:00:40 -0800
Message-Id: <20201103160040.10013-1-manasi.d.navare@intel.com>
X-Mailer: git-send-email 2.19.1
In-Reply-To: <20201102211906.4893-6-manasi.d.navare@intel.com>
References: <20201102211906.4893-6-manasi.d.navare@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 6/6] drm/i915/dp: Allow big joiner modes in

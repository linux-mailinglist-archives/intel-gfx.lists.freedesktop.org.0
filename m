...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E9C012354B
	for <lists+intel-gfx@lfdr.de>; Tue, 17 Dec 2019 19:56:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C744C6E0DA;
	Tue, 17 Dec 2019 18:56:36 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH 3/8] drm/fb-helper: convert to drm device
 based logging

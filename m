...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A8436A1FA0
	for <lists+intel-gfx@lfdr.de>; Fri, 24 Feb 2023 17:26:58 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6837410EC8E;
	Fri, 24 Feb 2023 16:26:44 +0000 (UTC)
...
X-Mailer: b4 0.11.1
Subject: [Intel-gfx] [PATCH 3/3] drm/i915: Correct type of wakeref variable

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B466021FF4E
	for <lists+intel-gfx@lfdr.de>; Tue, 14 Jul 2020 23:00:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B5A046E9F2;
...
Subject: [Intel-gfx] [PATCH v2 50/59] drm/kmb: Do the layer initializations
 only once

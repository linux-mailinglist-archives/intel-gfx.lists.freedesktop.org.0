...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 45FE34DCE25
	for <lists+intel-gfx@lfdr.de>; Thu, 17 Mar 2022 19:54:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 871B510E69F;
	Thu, 17 Mar 2022 18:54:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 47E5F10E660
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 b=XMgNmKYh9mmWnmhu0Ihn1u4qUyaGIrAXm2gd/+np205t+Unro9QWtXVs
 AfcFfnSQbY9bKn2Yh+v0HcGoBFMchqDJJwPyi08XEkGB8dHl6ZF/2Egd6
 TowYcQQsUDteT5SxRrogMgVFgE1iqjcaOWc1J9ugdxg0mYu4KZDDm2m08
 MvADy5Tm9/jEuVO5D6z1aqQnTlilx9t40lKHWL7c0zP4Mf0L93jkEx048
 RqFdtGdzRSk1XG4UraU1j0BXGqsrG0m7x02siMHG6RPQVVpIBgLj+1g3u
 5h41G1IKOm/FlRZ49TZnA+xGvwR/uvz1r9TURSJLuRw7341ROEiI4UcVc w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10289"; a="281749736"
X-IronPort-AV: E=Sophos;i="5.90,188,1643702400"; d="scan'208";a="281749736"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Mar 2022 11:54:28 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,188,1643702400"; d="scan'208";a="581405090"
Received: from aalteres-desk.fm.intel.com ([10.80.57.53])
 by orsmga001.jf.intel.com with ESMTP; 17 Mar 2022 11:54:28 -0700
From: Alan Previn <alan.previn.teres.alexis@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 17 Mar 2022 11:56:54 -0700
Message-Id: <20220317185655.1786958-13-alan.previn.teres.alexis@intel.com>
...
Subject: [Intel-gfx] [PATCH v11 12/13] drm/i915/guc: Plumb GuC-capture into
 gpu_coredump

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E25B53AC70B
	for <lists+intel-gfx@lfdr.de>; Fri, 18 Jun 2021 11:12:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDBFE6E9DE;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v4 15/17] drm/uAPI: Move "Broadcast RGB"

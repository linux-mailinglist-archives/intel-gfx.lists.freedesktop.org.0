...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F2E311993B9
	for <lists+intel-gfx@lfdr.de>; Tue, 31 Mar 2020 12:42:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B4EA26E7DD;
	Tue, 31 Mar 2020 10:42:41 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1BF266E7D4
 for <intel-gfx@lists.freedesktop.org>; Tue, 31 Mar 2020 10:42:13 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 31 Mar 2020 12:41:51 +0200
Message-Id: <20200331104209.432176-5-maarten.lankhorst@linux.intel.com>
...
@@ -855,6 +857,7 @@ static struct i915_vma *eb_lookup_vma(struct i915_execbuffer *eb, u32 handle)
...
@@ -1711,7 +1733,7 @@ static int eb_prefault_relocations(const struct i915_execbuffer *eb)
 	return 0;
 }
...
+static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
 {
 	...
 	struct eb_vma *ev;
@@ -1762,6 +1784,11 @@ static noinline int eb_relocate_slow(struct i915_execbuffer *eb)
 		}
 	}
...
@@ -1794,7 +1821,7 @@ static noinline int eb_relocate_slow(struct i915_execbuffer *eb)
 	return err;
 }
...
@@ -2802,13 +2806,15 @@ i915_gem_do_execbuffer(struct drm_device *dev,

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4ECF7B8A037
	for <lists+intel-gfx@lfdr.de>; Fri, 19 Sep 2025 16:39:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6C02B10EA17;
	Fri, 19 Sep 2025 14:39:07 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="bNWnJjpG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.18])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D176710EA0D;
 Fri, 19 Sep 2025 14:39:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1758292746; x=1789828746;
 h=from:to:cc:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=P5tRFMrHAZr7h74YAJgZK0I/WP32IFzfu+wh0IGbuqU=;
 b=bNWnJjpGyLLIheApcwPnouK51y6Gy9LoVKL/zHJdDlDzusCueU/EwzbX
 stRqQU9gLusarvj4GDmpDtZQed/DMNoT9Hc9m5qzqNTqdHXziZleZGQQ5
 FOTkitawl2CaVZBUnsQWaE7m+DtJUOm/QO6w//khvd3ms2BBnsdYxheKT
 m3HAodXN/EnphVBhkbpdTG9hde7uQIdWuv8Z86h5CHLS5IayAS/2IAkM7
 T/QcNpEFq7cv9+9YY30JioqqGXPA0cwfRTCQZAMj6A4O0+uJ8qRCFeB8t
 l9xlMKzs8hb7X6nKW0GmAiyQlaaNYBHfgQd/oH0MYTbcCj/PMsrq5VvDs w==;
X-CSE-ConnectionGUID: rNfU/lRFT82Rs6wXGnsfOQ==
X-CSE-MsgGUID: TOIosRPaTAa31M73m/fAjw==
X-IronPort-AV: E=McAfee;i="6800,10657,11557"; a="59858240"
X-IronPort-AV: E=Sophos;i="6.18,278,1751266800"; d="scan'208";a="59858240"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
 by fmvoesa112.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 19 Sep 2025 07:39:05 -0700
X-CSE-ConnectionGUID: nkrrLmTTREyoAG28OLkkEg==
X-CSE-MsgGUID: SFzRf6tRSqmEuLBOPlAkIQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.18,278,1751266800"; d="scan'208";a="199553125"
Received: from nemesa.iind.intel.com ([10.190.239.22])
 by fmviesa002.fm.intel.com with ESMTP; 19 Sep 2025 07:39:04 -0700
From: Nemesa Garg <nemesa.garg@intel.com>
To: intel-gfx@lists.freedesktop.org, intel-xe@lists.freedesktop.org,
 dri-devel@lists.freedesktop.org
Cc: Nemesa Garg <nemesa.garg@intel.com>
Subject: [PATCH 00/10]  Introduce drm sharpness property
Date: Fri, 19 Sep 2025 20:04:08 +0530
Message-Id: <20250919143418.3102605-1-nemesa.garg@intel.com>

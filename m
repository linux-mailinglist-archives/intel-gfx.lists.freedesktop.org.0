...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KGvzFPAlA2oF1AEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Tue, 12 May 2026 15:06:56 +0200
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id DD68D520B83
	for <lists+intel-gfx@lfdr.de>; Tue, 12 May 2026 15:06:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6050C10EAC4;
	Tue, 12 May 2026 13:06:54 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=kernel.org header.i=@kernel.org header.b="pQeL45EG";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sea.source.kernel.org (sea.source.kernel.org [172.234.252.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9222F10EAC4;
 Tue, 12 May 2026 13:06:51 +0000 (UTC)
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
 by sea.source.kernel.org (Postfix) with ESMTP id 75E8F4439C;
 Tue, 12 May 2026 13:06:51 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id BDB89C2BCF7;
 Tue, 12 May 2026 13:06:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1778591211;
 bh=qaSP70ZhrUcMPjOf7+v4uq6SslBv0gdUuCOqJYZwmRw=;
 h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
 b=
From: Maxime Ripard <mripard@kernel.org>
Date: Tue, 12 May 2026 15:06:11 +0200
Subject: [PATCH v4 13/20] drm/atomic-state-helper: Rename
 __drm_atomic_helper_connector_state_reset()
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260512-drm-mode-config-init-v4-13-591dfdcc1bf9@kernel.org>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=4078; i=mripard@kernel.org;
 ...
 b=

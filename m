...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 310AA6D2EA7
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 08:37:27 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F8D710F3AF;
	Sat,  1 Apr 2023 06:37:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CC8B510E09C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 ...
 bh=bjKC3RZKEFdsqr3dDu+jFzjPAsjmpMD7XsXkzROEGa4=;
 b=kgz9JR1th8+hur5QmGl6nW9Ty4vgr8CHTkqI6gosojN5QuTQm9e6cFdQ
 1se+zTFeuEAdF0dFA0YnrYjmYNIs3WfAGzSu0v3PMdpnLe5Fpv1kw6KU2
 +OFm2jY0SFu3WN44/dS0gskpyTtICLdkT7mDmM5BB6g/CG2KngPMxxT0M
 PMzrZrYgQYIwLuLxuEa5wdSyXheKv4qauzGBF0MDqn0hYeTUxNkqEloVv
 xd68XFYMR/GXAL+U5fZmlhIBsgtkpMUsIZFzkN7jDEj1QJDZQJlBYyCBq
 U4pgzP3kKSSAfNMtWKya8FwfctGX/PmyFOt9FKjjgvD1Urlgk0uU2rDor A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10666"; a="340349506"
X-IronPort-AV: E=Sophos;i="5.98,308,1673942400"; d="scan'208";a="340349506"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2023 23:37:01 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10666"; a="635539621"
X-IronPort-AV: E=Sophos;i="5.98,308,1673942400"; d="scan'208";a="635539621"
Received: from fyang16-desk.jf.intel.com ([10.24.96.243])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Mar 2023 23:37:00 -0700
From: fei.yang@intel.com
To: intel-gfx@lists.freedesktop.org
Date: Fri, 31 Mar 2023 23:38:24 -0700
Message-Id: <20230401063830.438127-2-fei.yang@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20230401063830.438127-1-fei.yang@intel.com>
References: <20230401063830.438127-1-fei.yang@intel.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [PATCH 1/7] drm/i915/mtl: Define MOCS and PAT tables
 for MTL

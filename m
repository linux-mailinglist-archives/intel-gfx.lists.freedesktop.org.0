...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A08B70BCA5
	for <lists+intel-gfx@lfdr.de>; Mon, 22 May 2023 13:58:16 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B7B8010E309;
...
Subject: [Intel-gfx] [PATCH v6 08/10] vfio: Add helper to search vfio_device
 in a dev_set

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C1F034663B
	for <lists+intel-gfx@lfdr.de>; Tue, 23 Mar 2021 18:26:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A6CFC6EA5D;
	Tue, 23 Mar 2021 17:26:02 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4FB2B6EA5D
 for <intel-gfx@lists.freedesktop.org>; Tue, 23 Mar 2021 17:26:01 +0000 (UTC)
IronPort-SDR: IIRSa6JnwVFsmW7buFq52X7FwIzdGNflxNSn1LtRtuMaQB4nxD1y5AbAhieoDzCW7P06mN/J9w
 iZpKFT7eCHkA==
X-IronPort-AV: E=McAfee;i="6000,8403,9932"; a="177651310"
X-IronPort-AV: E=Sophos;i="5.81,272,1610438400"; d="scan'208";a="177651310"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 23 Mar 2021 10:26:00 -0700
IronPort-SDR: zePujLtm3Uch38JoQBUDMtub/u39MUPf69iEJQDzohagf6yZim6o+OLjbx4/0xXCfRR33rZ21i
 gnhlIgQi2YKw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.81,272,1610438400"; d="scan'208";a="390967027"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.171])
 by orsmga002.jf.intel.com with SMTP; 23 Mar 2021 10:25:57 -0700
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 23 Mar 2021 19:25:57 +0200
Date: Tue, 23 Mar 2021 19:25:57 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Matt Roper <matthew.d.roper@intel.com>
Message-ID: <YFokpaRM8yCqRJlF@intel.com>
References: <YFkJLCzqK65y5Vfl@intel.com>
 <20210322233840.4056851-1-matthew.d.roper@intel.com>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20210322233840.4056851-1-matthew.d.roper@intel.com>
...
> @@ -3660,7 +3660,7 @@ static bool skl_needs_memory_bw_wa(struct drm_i915_=
private *dev_priv)
>  static bool
>  intel_has_sagv(struct drm_i915_private *dev_priv)
>  {
> -	return (IS_GEN9_BC(dev_priv) || DISPLAY_VER(dev_priv) >=3D 10) &&
> +	return (IS_GEN9_BC(dev_priv) || DISPLAY_VER(dev_priv) >=3D 11 || IS_CAN=
NONLAKE(dev_priv)) &&
>  		dev_priv->sagv_status !=3D I915_SAGV_NOT_CONTROLLED;
>  }
>  =

> @@ -5030,7 +5030,7 @@ skl_wm_method1(const struct drm_i915_private *dev_p=
riv, u32 pixel_rate,
...
>  	return ret;
> @@ -5144,7 +5144,7 @@ skl_compute_wm_params(const struct intel_crtc_state=
 *crtc_state,
>  					   wp->y_min_scanlines,
>  					   wp->dbuf_block_size);
>  =
...
> @@ -5153,8 +5153,7 @@ skl_compute_wm_params(const struct intel_crtc_state=
 *crtc_state,
...
> @@ -5193,7 +5192,7 @@ skl_compute_plane_wm_params(const struct intel_crtc=
_state *crtc_state,
>  =
...
> @@ -5246,8 +5245,7 @@ static void skl_compute_plane_wm(const struct intel=
_crtc_state *crtc_state,
...
>  			else
>  				selected_result =3D method2;
> @@ -5386,7 +5384,7 @@ static void skl_compute_transition_wm(struct drm_i9=
15_private *dev_priv,
>  		trans_min =3D 14;
>  =

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 624F8520DD6
	for <lists+intel-gfx@lfdr.de>; Tue, 10 May 2022 08:24:12 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 64DD910E681;
...
Subject: Re: [Intel-gfx] [PATCH v2 04/25] drm/edid: start propagating
 drm_edid to lower levels

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 1731A54F073
	for <lists+intel-gfx@lfdr.de>; Fri, 17 Jun 2022 07:15:11 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C12C911AEE9;
...
Subject: [Intel-gfx] [PATCH v2 0/3] drm/doc/rfc: i915 VM_BIND feature design
 + uapi

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B4013BC958
	for <lists+intel-gfx@lfdr.de>; Tue, 24 Sep 2019 15:55:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8FD9A89D8E;
...
Subject: [Intel-gfx] [PATCH V2 3/8] mdev: bus uevent support

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EEF26B389F
	for <lists+intel-gfx@lfdr.de>; Fri, 10 Mar 2023 09:30:21 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6DA1010E978;
...
Subject: Re: [Intel-gfx] [PATCH v6 16/24] vfio: Make
 vfio_device_first_open() to cover the noiommu mode in cdev path

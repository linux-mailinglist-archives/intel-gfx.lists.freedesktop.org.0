...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A1E1A1EC578
	for <lists+intel-gfx@lfdr.de>; Wed,  3 Jun 2020 01:08:26 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 064D66E484;
...
MIME-Version: 1.0
Subject: [Intel-gfx] linux-next: manual merge of the drm-intel-fixes tree
 with Linus' tree
...
Content-Type: multipart/mixed; boundary="===============0244360935=="

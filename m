...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 82ABA16EDE3
	for <lists+intel-gfx@lfdr.de>; Tue, 25 Feb 2020 19:22:15 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C5F616EB84;
	Tue, 25 Feb 2020 18:22:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 0A30A6EB82;
 Tue, 25 Feb 2020 18:22:11 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from localhost (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP (TLS) id
 20348849-1500050 for multiple; Tue, 25 Feb 2020 18:22:08 +0000
MIME-Version: 1.0
To: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>,
 intel-gfx@lists.freedesktop.org
From: Chris Wilson <chris@chris-wilson.co.uk>
In-Reply-To: <836f0076-cc40-46dc-6e8f-97a70ee1c2e7@linux.intel.com>
References: <20200224215650.39624-1-chris@chris-wilson.co.uk>
 ...
 <836f0076-cc40-46dc-6e8f-97a70ee1c2e7@linux.intel.com>
Message-ID: <158265492696.3656.2504165860689786333@skylake-alporthouse-com>
User-Agent: alot/0.6
Date: Tue, 25 Feb 2020 18:22:07 +0000

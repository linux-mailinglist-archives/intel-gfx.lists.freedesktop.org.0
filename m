...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id EE2BE26A804
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Sep 2020 17:01:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2092D6E8D6;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v2 13/21] drm/rockchip: Convert to

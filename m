...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B0425B2C84
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 05:06:24 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 73D4E10EBB6;
	Fri,  9 Sep 2022 03:05:50 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 12/15] vfio/amba: Use the new device life
 cycle helpers

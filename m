...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id F04B1570B89
	for <lists+intel-gfx@lfdr.de>; Mon, 11 Jul 2022 22:26:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BADB790FA5;
...
Subject: [Intel-gfx] [PATCH 11/32] drm/i915: document kernel-doc trivial
 issues

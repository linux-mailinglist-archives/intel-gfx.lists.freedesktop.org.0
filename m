...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A59177FC462
	for <lists+intel-gfx@lfdr.de>; Tue, 28 Nov 2023 20:44:32 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id BAA6910E17D;
	Tue, 28 Nov 2023 19:44:29 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 9DCBD10E17D
 for <intel-gfx@lists.freedesktop.org>; Tue, 28 Nov 2023 19:44:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1701200667; x=1732736667;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=LT/QA9FJn769/Cs01PeB/xdRe3k8GebMgxZSyf4CM6w=;
 b=NSDkJKppEZB9h2ZJ3LnGKlKDO8v0DGOI3JDulC3NTfv9AcBkiH4Eg24E
 gtKQNklz9Ms/1ai4xWppFLMhOYLHrQxfozFEml3uYoQSwldlnBNAmMMUy
 qn6dC2dtP/BI0Kusn5pb/U8vNtgm1QfE0uKkek/CGQpRSgqjq3ry+G/Jf
 Ehl6uGzR3eBWgYjwTs1dWz+jraxrNA1lfKiTtjOkd21bxMIf0DKF+5eax
 t+56ub/Tpu4iMA/Ijr8P7S7K4Clb1AYMGJQQHIEthebfxm6u3AP1JSNQ3
 Nux2cATTtFTNAIwHhCjQQrKwcFzbRsgE5Wr+MpYG26FU4H3lKULaF2aeV A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10908"; a="457341902"
X-IronPort-AV: E=Sophos;i="6.04,234,1695711600"; d="scan'208";a="457341902"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Nov 2023 11:44:27 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10908"; a="762034539"
X-IronPort-AV: E=Sophos;i="6.04,234,1695711600"; d="scan'208";a="762034539"
Received: from stinkpipe.fi.intel.com (HELO stinkbox) ([10.237.72.74])
 by orsmga007.jf.intel.com with SMTP; 28 Nov 2023 11:44:24 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Tue, 28 Nov 2023 21:44:23 +0200
Date: Tue, 28 Nov 2023 21:44:23 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Jouni =?iso-8859-1?Q?H=F6gander?= <jouni.hogander@intel.com>
Message-ID: <ZWZDF7dgGPoe7jQG@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BB03B70CE7C
	for <lists+intel-gfx@lfdr.de>; Tue, 23 May 2023 01:08:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2DE1710E3B8;
	Mon, 22 May 2023 23:08:45 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 by gabe.freedesktop.org (Postfix) with ESMTPS id BD2D610E3B5
 for <intel-gfx@lists.freedesktop.org>; Mon, 22 May 2023 23:08:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1684796922; x=1716332922;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=Sbr4cZFM2s9w2JkHImZUkK8gmXmDf1fHXbRBN5vCoNo=;
 b=jdqsGDlqUntcnsFmLcz9N099yRWr7SIZpptkI75ou8lkIyvrV8FohPV0
 PKZa2F0VXtYjLpgPwa1n2cwJXfyHeOVoSpyIkXv/7CoTtxNKzXWM7xdUf
 X8Ei46VPjsGZi+ybZgah7ALFQIxYbuYqG3gND1iavt+o56/dqVI0R+NTz
 h2EbAy4xoWDpvTZl76/vUVfnbW+s4qCkmz+Hl4ocKS94kLCFuXdIgTbcp
 Boe1gysX6sGPl0FlGQL9xvPngES32Lsxgngsxs4vmjd9skuRM+vyZJHJq
 JdalWyThqHly+aSgRk2WNnH041U3FN8U7nywj4Fhki90Qt5lmpoidTJ4q w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="353093904"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="353093904"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 16:08:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10718"; a="773542653"
X-IronPort-AV: E=Sophos;i="6.00,184,1681196400"; d="scan'208";a="773542653"
Received: from cavram-mobl1.ger.corp.intel.com (HELO vgovind2-mobl3.intel.com)
 ([10.251.220.199])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 May 2023 16:08:39 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue, 23 May 2023 02:07:59 +0300
Message-Id: <20230522230759.153112-8-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v6 7/7] drm/i915/mtl: Add support for PM DEMAND

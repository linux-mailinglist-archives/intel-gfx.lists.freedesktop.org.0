...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 39D51234EC4
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Aug 2020 01:58:56 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6EF566E0FB;
	Fri, 31 Jul 2020 23:58:54 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5B6EE6E0FB
 for <intel-gfx@lists.freedesktop.org>; Fri, 31 Jul 2020 23:58:50 +0000 (UTC)
IronPort-SDR: 0UEavcRpZdIV7wfr2c6ahRUeX3aG19D/yqFJIl/YeOge0B9/STBkcbgC7E7avu9Rk+D335990F
 4mvRT8atk4IQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9699"; a="131458112"
X-IronPort-AV: E=Sophos;i="5.75,420,1589266800"; d="scan'208";a="131458112"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 31 Jul 2020 16:58:50 -0700
IronPort-SDR: FEU+GR7Jho5A0wpFQrjBLuQXLld81bCeYDpscWEK3apRjekyqYNQ225wB1UPmdDcHBPJObSGNc
 m138ZFsHpF8w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,420,1589266800"; d="scan'208";a="395475556"
Received: from orsosgc001.ra.intel.com ([10.23.184.150])
 by fmsmga001.fm.intel.com with ESMTP; 31 Jul 2020 16:58:49 -0700
From: Umesh Nerlige Ramappa <umesh.nerlige.ramappa@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 31 Jul 2020 16:58:48 -0700
Message-Id: <20200731235848.40971-5-umesh.nerlige.ramappa@intel.com>
...
@@ -3265,6 +3267,43 @@ static long i915_perf_config_locked(struct i915_perf_stream *stream,
 	return ret;
 }
...
+}
 ...
 static const struct file_operations fops = {
 	.owner		= THIS_MODULE,
@@ -3383,6 +3501,7 @@ static const struct file_operations fops = {
...
@@ -4527,8 +4646,12 @@ int i915_perf_ioctl_version(void)
 	 *
...
index 00546062e023..5a1cd8d2f6b0 100644
--- a/include/uapi/drm/i915_drm.h
+++ b/include/uapi/drm/i915_drm.h
@@ -2048,6 +2048,39 @@ struct drm_i915_perf_open_param {
  */

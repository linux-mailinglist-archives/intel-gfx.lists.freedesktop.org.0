...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 7840C4FE55B
	for <lists+intel-gfx@lfdr.de>; Tue, 12 Apr 2022 17:54:04 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A2A1310E725;
...
Subject: [Intel-gfx] [PATCH 8/9] vfio: Remove dead code

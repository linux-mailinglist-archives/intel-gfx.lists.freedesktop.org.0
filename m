...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 236D34B7024
	for <lists+intel-gfx@lfdr.de>; Tue, 15 Feb 2022 17:32:12 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A439610E6A2;
...
Subject: [Intel-gfx] [PATCH v1 1/1] drm/i915/selftests: Replace too verbose
 for-loop with simpler while

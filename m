...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id F2F6B129091
	for <lists+intel-gfx@lfdr.de>; Mon, 23 Dec 2019 02:07:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 602276E11E;
	Mon, 23 Dec 2019 01:07:13 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id C1DDC6E128
 for <intel-gfx@lists.freedesktop.org>; Mon, 23 Dec 2019 01:07:09 +0000 (UTC)
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 22 Dec 2019 17:07:09 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,345,1571727600"; d="scan'208";a="219359008"
Received: from dtbingha-mobl.amr.corp.intel.com (HELO
 josouza-MOBL.amr.corp.intel.com) ([10.252.135.10])
 by orsmga003.jf.intel.com with ESMTP; 22 Dec 2019 17:07:06 -0800
From: =?UTF-8?q?Jos=C3=A9=20Roberto=20de=20Souza?= <jose.souza@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Sun, 22 Dec 2019 17:06:50 -0800
Message-Id: <20191223010654.67037-3-jose.souza@intel.com>
X-Mailer: git-send-email 2.24.1
In-Reply-To: <20191223010654.67037-1-jose.souza@intel.com>
References: <20191223010654.67037-1-jose.souza@intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 rebased 3/7] drm/i915/display: Always enables
...
aXNwbGF5L2ludGVsX2Rpc3BsYXkuYwppbmRleCAyYjcwZmJmYWIyODcuLmE1ZDZkM2E2OTM1NSAx

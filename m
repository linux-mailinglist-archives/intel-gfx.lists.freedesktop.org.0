...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AF701BDC5A
	for <lists+intel-gfx@lfdr.de>; Wed, 29 Apr 2020 14:34:18 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A383B6ED05;
	Wed, 29 Apr 2020 12:34:16 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl [141.105.120.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 6F2856ECF9
 for <intel-gfx@lists.freedesktop.org>; Wed, 29 Apr 2020 12:33:19 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Wed, 29 Apr 2020 14:32:56 +0200
Message-Id: <20200429123307.1449297-14-maarten.lankhorst@linux.intel.com>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 14/25] drm/i915: Rework intel_context pinning to
...
index 90acc3d2440b..d9823fb2582c 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3290,7 +3290,10 @@ static void execlists_context_unpin(struct intel_context *ce)
 {
...
@@ -3452,20 +3455,23 @@ __execlists_update_reg_state(const struct intel_context *ce,
 }
...
@@ -3473,9 +3479,9 @@ __execlists_context_pin(struct intel_context *ce,
 	return 0;
 }
...
@@ -3501,8 +3507,10 @@ static void execlists_context_reset(struct intel_context *ce)
...
@@ -5281,13 +5289,13 @@ static int virtual_context_alloc(struct intel_context *ce)
...
@@ -5320,8 +5328,10 @@ static void virtual_context_exit(struct intel_context *ce)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E0300A9B245
	for <lists+intel-gfx@lfdr.de>; Thu, 24 Apr 2025 17:29:54 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 272B810E840;
	Thu, 24 Apr 2025 15:29:53 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="RlyESFdZ";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 72FD610E83C;
 Thu, 24 Apr 2025 15:29:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1745508589; x=1777044589;
 h=from:date:subject:mime-version:content-transfer-encoding:
 message-id:references:in-reply-to:to:cc;
 bh=DzMKeZqLdsML+GFY+qdYE8fILG99X5MlSUvNK7o8zqE=;
 b=RlyESFdZ6t6Voc23VbjUSArHB2WWpFyR4c22viubUCAWVo3OMh8ZcGKF
 JnjaP5VwRO+5I9zj+KjvGcySfDzZV/8MrpqnfsQshvQieMUj+/cHvYP94
 bNmQU9E2vyIE0s+h4EH35/WC9hJSw8A6I7W6rEIVCz5rBq5U7P+r1NwTk
 zOC66kKdSDdDbNtbTiPNfY8nAU7fVXdl62xC+bJo/KIAT0UV/TCrtdCZn
 Nx1FVubavPckj0733LJQu7rcRA+tWFsXNpeHX8IIcty5F8pTvwbKpcefU
 8Mlqi224SzBXtEbwlJ4kPnj7ex8vUEE+TCA6qqu+ffLAH0+D6Ppi3/VSD A==;
X-CSE-ConnectionGUID: UVlbamQVQfuftUY2AbgxsQ==
X-CSE-MsgGUID: GUyVUReyR+GW2U9jhrmklQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11413"; a="50816452"
X-IronPort-AV: E=Sophos;i="6.15,236,1739865600"; d="scan'208";a="50816452"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Apr 2025 08:29:49 -0700
X-CSE-ConnectionGUID: SIFOcZWCROaQmVTKChr9tw==
X-CSE-MsgGUID: mfUQjlbQTX6GpFzNkvNr6A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,236,1739865600"; d="scan'208";a="137748319"
Received: from srr4-3-linux-106-armuthy.iind.intel.com ([10.190.238.56])
 by fmviesa004.fm.intel.com with ESMTP; 24 Apr 2025 08:29:47 -0700
From: Arun R Murthy <arun.r.murthy@intel.com>
Date: Thu, 24 Apr 2025 20:45:15 +0530
Subject: [PATCH v7 2/2] drm/i915/display: move min_hblank from dp_mst.c to dp.c
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20250424-hblank-v7-2-8b002f1506cc@intel.com>

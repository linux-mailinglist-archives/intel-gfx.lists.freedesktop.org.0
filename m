...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 379D66ADC5A
	for <lists+intel-gfx@lfdr.de>; Tue,  7 Mar 2023 11:49:18 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3186910E49C;
...
Subject: [Intel-gfx] [RFC 09/12] drm/syncobj: Mark syncobj waits as external
 waiters

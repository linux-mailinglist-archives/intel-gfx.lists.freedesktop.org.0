...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 878286082BB
	for <lists+intel-gfx@lfdr.de>; Sat, 22 Oct 2022 02:09:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 8726910E4E4;
	Sat, 22 Oct 2022 00:08:10 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v3 6/7] drm/i915/guc: define media GT GuC send
 regs

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id A82E8369A29
	for <lists+intel-gfx@lfdr.de>; Fri, 23 Apr 2021 20:45:36 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 00FBA6EC31;
	Fri, 23 Apr 2021 18:45:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 2D85E6EC3E
 for <intel-gfx@lists.freedesktop.org>; Fri, 23 Apr 2021 18:45:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1619203533;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=s3xILF1G/BWWkGYxsN+ddfd7+1qnJ8Wx51GpkkVphNc=;
 b=W4hsjKrCSavOZz55Cl9lm4PVJLPghipM0B8KWKn6c9XtyoswcrV0A8mWfQFXs1wJxmZCW9
 +YlmSJymIMhigjLSGQf9we5PFRRvdo2QrEPDhI45SFmDhau4n/RcjRri4jSc4o/pp0gFIh
 m+RGkXzdxh43oGdbGdenytcJQ25L6tk=
...
Subject: [Intel-gfx] [PATCH v4 08/17] drm/dp_dual_mode: Pass drm_device to
...
Cc: Lucas De Marchi <lucas.demarchi@intel.com>, David Airlie <airlied@linux.ie>,
 ...
 Sean Paul <seanpaul@chromium.org>, Kai-Heng Feng <kai.heng.feng@canonical.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A0AC1DFA2B
	for <lists+intel-gfx@lfdr.de>; Sat, 23 May 2020 20:13:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4D5596E1D5;
...
Subject: [Intel-gfx] [PATCH v2 2/4] mm/gup: refactor and de-duplicate
 gup_fast() code

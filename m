...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 524AC7237F3
	for <lists+intel-gfx@lfdr.de>; Tue,  6 Jun 2023 08:43:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D8A4810E294;
	Tue,  6 Jun 2023 06:43:56 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DD0F710E294
 for <intel-gfx@lists.freedesktop.org>; Tue,  6 Jun 2023 06:43:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1686033834; x=1717569834;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=XPDwWIaXS7gitexGHnVtMNj92widGCCHY6N2HeSBtrA=;
 b=MEBiLNL+DxkJHDOBf/wOTt0C81jevSNjB7T39VudT6PKKkjxBAWUqosT
 nRIbhomjap9Bbk3Y/BfhfZ3KziQEDMoXZpT29tIQutKzmqWigOWH/Y5CH
 wxJrTS2DaWHjHPpS6tso0S2DBlIDCnbDhOv4h/wVLNFVpbi6ym7oO4McN
 61w4O3gjwKtC9sq07yMykgaLATPjASs56AHLZZDrxoUsstoEijZV7+Qi2
 gA0FLrMOEi3WymRrm64ZKlIb66ig0W7ZU9ameO2FGS8RYB2Q3lT91nhIj
 iofhqsqlD4n4DT43zMsgCBFW4euLJokiMEwOBnDBuDIOvr9L6vvkfWLrL Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="336940601"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="336940601"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jun 2023 23:43:54 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="778865607"
X-IronPort-AV: E=Sophos;i="6.00,219,1681196400"; d="scan'208";a="778865607"
Received: from mgmohiud-mobl2.gar.corp.intel.com (HELO
 vgovind2-mobl3.intel.com) ([10.249.42.181])
 by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 Jun 2023 23:43:52 -0700
From: Vinod Govindapillai <vinod.govindapillai@intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  6 Jun 2023 09:43:24 +0300
Message-Id: <20230606064327.188226-5-vinod.govindapillai@intel.com>
...
Subject: [Intel-gfx] [PATCH v13 4/7] drm/i915: extract

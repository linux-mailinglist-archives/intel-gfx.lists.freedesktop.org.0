...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 23CE7625EA2
	for <lists+intel-gfx@lfdr.de>; Fri, 11 Nov 2022 16:47:51 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 2B47610E196;
	Fri, 11 Nov 2022 15:47:46 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 by gabe.freedesktop.org (Postfix) with ESMTPS id D3D8410E196
 for <intel-gfx@lists.freedesktop.org>; Fri, 11 Nov 2022 15:47:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1668181662; x=1699717662;
 h=date:from:to:cc:subject:message-id:reply-to:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=LXSdSOIoY5anSN8vXryPoGlfX/Q5Rk+LwVAzgKlPV18=;
 b=iH/FSblZfK1u0iZc1KkDKKyy4UwrZyolHiSICg0wL/VdMrl9+Vsqm+Yj
 gdK5FUmR0U1Pp5E9n8K+oBcF7JkGZxOBxi/pdGdZ7wbXyyNl+SRvEjNZv
 uzOWbYn4oqA3p553+LHl3B58fP0gjwgj7TjaEaYshxMCBsILTEUtPGjwZ
 1ymNA1OYbSZZGdlTQnlX256Qm/gxT/hkfB9dWxb8gMYbRaIngj4ARzZdY
 Wdiu77r6Jg0BPAl9tQIMUMeEv3TWf51dDnaugtlhfcUDkQRzGFj2L/03f
 7yXLjGLeTdJQx599bBYp1f78DJttliKywDyy3y3BK1lUbP35KjUoA2Q6J g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="299133769"
X-IronPort-AV: E=Sophos;i="5.96,156,1665471600"; d="scan'208";a="299133769"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2022 07:47:12 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="588602362"
X-IronPort-AV: E=Sophos;i="5.96,156,1665471600"; d="scan'208";a="588602362"
Received: from ideak-desk.fi.intel.com ([10.237.68.144])
 by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 11 Nov 2022 07:47:10 -0800
Date: Fri, 11 Nov 2022 17:47:05 +0200
From: Imre Deak <imre.deak@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <Y25ueaWBbV9Njrgr@ideak-desk.fi.intel.com>
...
In-Reply-To: <Y25TiP/Lr3xjb5bk@intel.com>

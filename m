...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 25334145702
	for <lists+intel-gfx@lfdr.de>; Wed, 22 Jan 2020 14:45:47 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3E4616F510;
...
Subject: [Intel-gfx] [PATCH 3/7] drm/amd/display: use

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C57A2651D4F
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Dec 2022 10:27:07 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6F96710E35C;
	Tue, 20 Dec 2022 09:27:05 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 70C7D10E35C
 for <intel-gfx@lists.freedesktop.org>; Tue, 20 Dec 2022 09:26:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671528415; x=1703064415;
 h=from:to:cc:subject:in-reply-to:references:date:
 message-id:mime-version;
 bh=kqgg+jWM/zrrkagfAatPkXD4zG0EQTqSeLLtNkPXwIc=;
 b=XSiLubPTgV/I9ALQlAWbrwm+L2IqL1ca0MZREHZa6aTxoyJ+vfc9mKML
 lK1hvcpwS1st+typq/VGmCIy9cbCsxtVB2/+aRcoic3jitLNxbJRtFo1h
 0RBQmCgTnTUj95nuntDLdzldPmnVl/LdGB/FmUYy4oXVkymTQ0Pwl9P9Y
 6LOmA1+vYgX+xIr3slNm5Wm9naM1/v0KQ3G/GAa7xt6CoMHldmm+MQzY+
 7bB5Jw4BT4lTS1NOJPJGFqFJiPwMvYSoI1mj6AcXuZCpKPjEQVH016yUk
 S0tank+YQ0113qmmcBb6HFFN5HR7homthFnA7Ni18FhOUpczpX/QzDQqY A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10566"; a="405820270"
X-IronPort-AV: E=Sophos;i="5.96,259,1665471600"; d="scan'208";a="405820270"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Dec 2022 01:26:51 -0800
X-IronPort-AV: E=McAfee;i="6500,9779,10566"; a="683342576"
X-IronPort-AV: E=Sophos;i="5.96,259,1665471600"; d="scan'208";a="683342576"
Received: from spalapa-mobl1.ger.corp.intel.com (HELO localhost)
 ([10.252.60.249])
 by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Dec 2022 01:26:48 -0800
...
Date: Tue, 20 Dec 2022 11:26:45 +0200
Message-ID: <87359a4e96.fsf@intel.com>
MIME-Version: 1.0

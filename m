...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B33C56D3946
	for <lists+intel-gfx@lfdr.de>; Sun,  2 Apr 2023 18:49:46 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 18CB210E320;
	Sun,  2 Apr 2023 16:49:35 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from madras.collabora.co.uk (madras.collabora.co.uk [46.235.227.172])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 37E5110E30A;
 Sun,  2 Apr 2023 16:49:31 +0000 (UTC)
Received: from workpc.. (109-252-124-32.nat.spd-mgts.ru [109.252.124.32])
 (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
 (No client certificate requested)
 (Authenticated sender: dmitry.osipenko)
 by madras.collabora.co.uk (Postfix) with ESMTPSA id C0C9F66031A2;
 Sun,  2 Apr 2023 17:49:27 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
 s=mail; t=1680454169;
 bh=KZz1i5pHAtFpbfkfyURA6HRF/mHH8iwaCD4+giOfPa4=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
...
Date: Sun,  2 Apr 2023 19:48:26 +0300
Message-Id: <20230402164826.752842-8-dmitry.osipenko@collabora.com>
...
Subject: [Intel-gfx] [PATCH v1 7/7] drm/shmem-helper: Switch to reservation
 lock

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 2CB2IrORqWmvAAEAu9opvQ
	(envelope-from <intel-gfx-bounces@lists.freedesktop.org>)
	for <lists+intel-gfx@lfdr.de>; Thu, 05 Mar 2026 15:22:43 +0100
X-Original-To: lists+intel-gfx@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 169BF2133DB
	for <lists+intel-gfx@lfdr.de>; Thu, 05 Mar 2026 15:22:42 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 29F9B10EC26;
	Thu,  5 Mar 2026 14:22:41 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (1024-bit key; unprotected) header.d=collabora.com header.i=nicolas.frattaroli@collabora.com header.b="bB/U+QhF";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com
 [136.143.188.112])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 4AEAA10EC2C;
 Thu,  5 Mar 2026 14:22:40 +0000 (UTC)
ARC-Seal: i=1; a=rsa-sha256; t=1772720551; cv=none; 
 d=zohomail.com; s=zohoarc; 
 b=JdNkOxQgKVXMi9nnnMuJxH03G34BBVsGjXpbgDNzgvcTsErAf0b3rBok86QC+MbneIPY86w46IoI27r+mBcSMXtekpqQR4fbfWbQEwX+wO4zJDkd5k/t4uLeYKY53hU8/+9RZIoP/t3gqjPiwYvjCwy19/3WKjhn4eFNTSNIkNU=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com;
 s=zohoarc; t=1772720551;
 h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To;
 bh=Q6LewHLgG66mB+cKlrE6Jmde9yR3/vCwSuAKYYuzjYw=; 
 b=YxzN9YqB5bw46wSqZcx+eNn06FbOPiNifWf/MnoYNKIwQAf2Qsk3mU1ZvpEV4xtJRVE61rssIHGzmmREFOJ950shtSu6tQboP5PYlzYaBBDV/XEIRvh+VWd3Gymym7am4p9cREyYjMXZ14G0hkPkR3HtQsU+Z5UOvG7RVcUgpTA=
ARC-Authentication-Results: i=1; mx.zohomail.com;
 dkim=pass  header.i=collabora.com;
 spf=pass  smtp.mailfrom=nicolas.frattaroli@collabora.com;
 dmarc=pass header.from=<nicolas.frattaroli@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1772720551; 
 s=zohomail; d=collabora.com; i=nicolas.frattaroli@collabora.com;
 h=From:From:Date:Date:Subject:Subject:MIME-Version:Content-Type:Content-Transfer-Encoding:Message-Id:Message-Id:References:In-Reply-To:To:To:Cc:Cc:Reply-To;
 bh=Q6LewHLgG66mB+cKlrE6Jmde9yR3/vCwSuAKYYuzjYw=;
 b=bB/U+QhFW7+2XupfYOy37gg5pzAKW/hdHp4Vff41CuFP/nUXk1X+cKVE98GVCYCi
 MDsysIE9chDs9tMMkp/MIQ3HvE8VnrVrEBVODVucQOoF4c3pjsaMfk7OSkJftYVXsMA
 z3TE0CkCzSYR27OoH/fGA1VyAs/ZDpaRXvp8qoqc=
Received: by mx.zohomail.com with SMTPS id 1772720549803582.6482906920778;
 Thu, 5 Mar 2026 06:22:29 -0800 (PST)
From: Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
Date: Thu, 05 Mar 2026 15:19:46 +0100
Subject: [PATCH v10 20/22] drm/tests: bridge: Add KUnit tests for bridge
 chain format selection
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260305-color-format-v10-20-a58c68a11868@collabora.com>

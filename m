...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D576269523
	for <lists+intel-gfx@lfdr.de>; Mon, 14 Sep 2020 20:45:02 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 743B689B45;
	Mon, 14 Sep 2020 18:45:00 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 28BAE89B45
 for <intel-gfx@lists.freedesktop.org>; Mon, 14 Sep 2020 18:44:59 +0000 (UTC)
IronPort-SDR: 7zyQhW26jYSKE8H8RYiX+SCOvtjHKQY2mI2XfyQeg7tMSyCARCz5ViK6j1wf6O4Vg1t6fPHuFM
 PUz7nqVoQ3hQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9744"; a="156537281"
X-IronPort-AV: E=Sophos;i="5.76,427,1592895600"; d="scan'208";a="156537281"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2020 11:44:58 -0700
IronPort-SDR: JviBeNDqWs3rw+7Gz/Blnqzj5clGsDjeCvRqpUjJI0+yrvtTmTVAwRu0nC+o5VzV+s9mF8eqYN
 EQYVo6bponJw==
X-IronPort-AV: E=Sophos;i="5.76,427,1592895600"; d="scan'208";a="343217052"
Received: from labuser-z97x-ud5h.jf.intel.com (HELO labuser-Z97X-UD5H)
 ([10.165.21.211])
 by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 14 Sep 2020 11:44:58 -0700
Date: Mon, 14 Sep 2020 11:45:37 -0700
From: "Navare, Manasi" <manasi.d.navare@intel.com>
To: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
Message-ID: <20200914184536.GA28760@labuser-Z97X-UD5H>
...
In-Reply-To: <20200903175440.GX6112@intel.com>
...
> > @@ -152,7 +152,7 @@ static void ilk_pch_clock_get(struct intel_crtc *cr=
tc,
> >  static int intel_framebuffer_init(struct intel_framebuffer *ifb,
> >  				  struct drm_i915_gem_object *obj,
> >  				  struct drm_mode_fb_cmd2 *mode_cmd);
> > -static void intel_set_pipe_timings(const struct intel_crtc_state *crtc=
_state);
...
> > @@ -6110,18 +6110,16 @@ skl_update_scaler(struct intel_crtc_state *crtc=
...
> > @@ -6901,7 +6899,7 @@ static void ilk_crtc_enable(struct intel_atomic_s=
tate *state,
...
> > @@ -7046,7 +7044,7 @@ static void hsw_crtc_enable(struct intel_atomic_s=
tate *state,
...
> > @@ -7429,7 +7427,7 @@ static void valleyview_crtc_enable(struct intel_a=
tomic_state *state,
> >  	if (intel_crtc_has_dp_encoder(new_crtc_state))
> >  		intel_dp_set_m_n(new_crtc_state, M1_N1);
> >  =
...
> > @@ -7497,7 +7495,7 @@ static void i9xx_crtc_enable(struct intel_atomic_=
state *state,
> >  	if (intel_crtc_has_dp_encoder(new_crtc_state))
> >  		intel_dp_set_m_n(new_crtc_state, M1_N1);
> >  =
...
> > @@ -8018,7 +8016,7 @@ static int intel_crtc_compute_config(struct intel=
_crtc *crtc,
...
> > @@ -8029,16 +8027,16 @@ static int intel_crtc_compute_config(struct int=
el_crtc *crtc,
...
> >  		return -EINVAL;
> >  	}
> > @@ -8081,7 +8079,7 @@ static int intel_crtc_compute_config(struct intel=
_crtc *crtc,
...
> >  	struct drm_i915_private *dev_priv =3D to_i915(crtc->base.dev);
> > @@ -8837,8 +8835,8 @@ static bool intel_pipe_is_interlaced(const struct=
 intel_crtc_state *crtc_state)
> >  		return intel_de_read(dev_priv, PIPECONF(cpu_transcoder)) & PIPECONF_=
INTERLACE_MASK;
> >  }
> >  =
...
> > @@ -9458,7 +9456,7 @@ static bool i9xx_get_pipe_config(struct intel_crt=
c *crtc,
> >  	if (INTEL_GEN(dev_priv) < 4)
...
> > @@ -10739,7 +10737,7 @@ static bool ilk_get_pipe_config(struct intel_cr=
tc *crtc,
...
> > @@ -11147,7 +11145,7 @@ static bool hsw_get_pipe_config(struct intel_cr=
tc *crtc,
...
> >  	intel_get_pipe_src_size(crtc, pipe_config);
> > @@ -12593,15 +12591,15 @@ static bool c8_planes_changed(const struct in=
...
> >  }
> > @@ -13218,7 +13216,7 @@ intel_crtc_copy_uapi_to_hw_state(struct intel_c=
...
> > @@ -13325,7 +13323,7 @@ intel_modeset_pipe_config(struct intel_crtc_sta=
te *pipe_config)
...
> > @@ -13424,6 +13422,8 @@ intel_modeset_pipe_config(struct intel_crtc_sta=
te *pipe_config)
...
> >  	return 0;
> >  }
> > @@ -18478,6 +18478,9 @@ static void intel_modeset_readout_hw_state(stru=
ct drm_device *dev)
> >  			 */
...
> > @@ -905,12 +905,12 @@ static void pnv_update_wm(struct intel_crtc *unus=
ed_crtc)
> >  =
...
> > @@ -1141,8 +1141,8 @@ static u16 g4x_compute_wm(const struct intel_crtc=
_state *crtc_state,
> >  {
...
> > @@ -1169,8 +1169,8 @@ static u16 g4x_compute_wm(const struct intel_crtc=
_state *crtc_state,
...
> > @@ -1666,8 +1666,8 @@ static u16 vlv_compute_wm_level(const struct inte=
...
> > @@ -1677,8 +1677,8 @@ static u16 vlv_compute_wm_level(const struct inte=
l_crtc_state *crtc_state,
> >  		return 0;
> >  =
...
> > @@ -2267,12 +2267,12 @@ static void i965_update_wm(struct intel_crtc *u=
nused_crtc)
> >  	if (crtc) {
...
> >  		int cpp =3D fb->format->cpp[0];
> >  		int entries;
> > @@ -2351,8 +2351,8 @@ static void i9xx_update_wm(struct intel_crtc *unu=
sed_crtc)
...
> >  			crtc->base.primary->state->fb;
> >  		int cpp;
> > @@ -2362,7 +2362,7 @@ static void i9xx_update_wm(struct intel_crtc *unu=
sed_crtc)
> >  		else
...
> >  					       pessimal_latency_ns);
> >  		enabled =3D crtc;
> > @@ -2378,8 +2378,8 @@ static void i9xx_update_wm(struct intel_crtc *unu=
sed_crtc)
...
> >  			crtc->base.primary->state->fb;
> >  		int cpp;
> > @@ -2389,7 +2389,7 @@ static void i9xx_update_wm(struct intel_crtc *unu=
sed_crtc)
> >  		else
> >  			cpp =3D fb->format->cpp[0];
> >  =
...
> > @@ -2427,12 +2427,12 @@ static void i9xx_update_wm(struct intel_crtc *u=
nused_crtc)
...
> >  		int cpp;
> >  		int entries;
> > @@ -2480,7 +2480,7 @@ static void i845_update_wm(struct intel_crtc *unu=
sed_crtc)
> >  {
...
> > @@ -2488,8 +2488,8 @@ static void i845_update_wm(struct intel_crtc *unu=
sed_crtc)
> >  	if (crtc =3D=3D NULL)
> >  		return;
> >  =
...
> > @@ -2579,7 +2579,7 @@ static u32 ilk_compute_pri_wm(const struct intel_=
...
> > @@ -2607,7 +2607,7 @@ static u32 ilk_compute_spr_wm(const struct intel_=
crtc_state *crtc_state,
> >  =
...
> > @@ -2632,7 +2632,7 @@ static u32 ilk_compute_cur_wm(const struct intel_=
crtc_state *crtc_state,
> >  	cpp =3D plane_state->hw.fb->format->cpp[0];
> >  =
...
> >  			      cpp, mem_value);
> >  }
> > @@ -3889,7 +3889,7 @@ static bool skl_crtc_can_enable_sagv(const struct=
 intel_crtc_state *crtc_state)
...
_state) {
> > @@ -4180,8 +4180,8 @@ skl_ddb_get_pipe_allocation_limits(struct drm_i91=
5_private *dev_priv,
> >  	 */
...
> > @@ -4211,7 +4211,7 @@ skl_ddb_get_pipe_allocation_limits(struct drm_i91=
5_private *dev_priv,
...
> > @@ -5099,7 +5099,7 @@ intel_get_linetime_us(const struct intel_crtc_sta=
te *crtc_state)
...
> >  	return linetime_us;
> > @@ -5288,14 +5288,14 @@ static void skl_compute_plane_wm(const struct i=

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B80D13B85ED
	for <lists+intel-gfx@lfdr.de>; Wed, 30 Jun 2021 17:10:55 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id B36436EA1C;
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v5 05/17] drm/i915/display: Add handling for new
 "active bpc" property

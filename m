...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id BF8B37C7495
	for <lists+intel-gfx@lfdr.de>; Thu, 12 Oct 2023 19:22:59 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EDF9B10E56C;
...
Subject: [Intel-gfx] [PATCH v7 23/25] drm: use correct ccflags-y spelling

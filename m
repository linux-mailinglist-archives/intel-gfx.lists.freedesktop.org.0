...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5EBFD7E1D27
	for <lists+intel-gfx@lfdr.de>; Mon,  6 Nov 2023 10:26:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0EA0010E299;
	Mon,  6 Nov 2023 09:26:51 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5542C10E140
 for <Intel-gfx@lists.freedesktop.org>; Mon,  6 Nov 2023 09:26:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1699262809; x=1730798809;
 h=from:to:subject:date:message-id:mime-version:
 content-transfer-encoding;
 bh=Ad51QJttmgFXIAlqkH78PLjA3N2wNappN/l3IpaRY+4=;
 b=FZriElGWc+3XjLPUve+hAInc4zhaOBOkB4DYcx/XWaOxsf4mQzynmTwx
 v088xBqwrC0NNWO69JENjSd4B+DQnDwmf+DuCnI1mPM8Di1Zopbml0SeX
 1trOuRyOU2KxUcdIH/BnwFdhVHoVoj4bXeOl8UnCqBixyuiNU7pcqEORO
 gIdldJBFOhabtyTGPmte1uMo8zc0ZZ9fbqM9RZ/AGUH1nJrEBpTYDRztX
 rKNppq1t6gHBaD+tyb3ABrCUdVpzp7AoVeZIv8sTfJckD/ZqO7+GbWZuQ
 ZVw9Wbe+a8FpMR8lvvVKNre9oXcESh8ct76T5AeHpaMG3/hXXTpKciJlP A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="455722689"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="455722689"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 01:26:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="935747850"
X-IronPort-AV: E=Sophos;i="6.03,281,1694761200"; d="scan'208";a="935747850"
Received: from ajayshan-mobl.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.213.234.152])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 Nov 2023 01:26:47 -0800
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: Intel-gfx@lists.freedesktop.org
Date: Mon,  6 Nov 2023 09:26:33 +0000
Message-Id: <20231106092634.481749-1-tvrtko.ursulin@linux.intel.com>
X-Mailer: git-send-email 2.39.2
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Subject: [Intel-gfx] [CI 1/2] drm/i915: Remove incomplete PVC plumbing
...
index db99c2ef66db..3790bfd1983b 100644
...
index f3be9033a93f..ac1abf18eb99 100644
--- a/drivers/gpu/drm/i915/i915_drv.h
+++ b/drivers/gpu/drm/i915/i915_drv.h
@@ -554,7 +554,6 @@ IS_SUBPLATFORM(const struct drm_i915_private *i915,
...
@@ -632,14 +631,6 @@ IS_SUBPLATFORM(const struct drm_i915_private *i915,
...
index 4f98aa8a861e..c998f15d505c 100644
...
@@ -120,7 +119,6 @@ int intel_uncore_mock_selftests(void)

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id B9FE42EAF1A
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Jan 2021 16:46:16 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 961D06E14F;
	Tue,  5 Jan 2021 15:45:48 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mblankhorst.nl (mblankhorst.nl
 [IPv6:2a02:2308::216:3eff:fe92:dfa3])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8220C6E175
 for <intel-gfx@lists.freedesktop.org>; Tue,  5 Jan 2021 15:45:42 +0000 (UTC)
From: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
To: intel-gfx@lists.freedesktop.org
Date: Tue,  5 Jan 2021 16:35:52 +0100
Message-Id: <20210105153558.134272-59-maarten.lankhorst@linux.intel.com>
X-Mailer: git-send-email 2.30.0.rc1
In-Reply-To: <20210105153558.134272-1-maarten.lankhorst@linux.intel.com>
References: <20210105153558.134272-1-maarten.lankhorst@linux.intel.com>
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH v6 58/64] drm/i915/selftests: Prepare memory
...
c3RzL2ludGVsX21lbW9yeV9yZWdpb24uYwppbmRleCA3NTgzOWRiNjNiZWEuLjNiODg1MDRkNzA2
MSAxMDA2NDQKLS0tIGEvZHJpdmVycy9ncHUvZHJtL2k5MTUvc2VsZnRlc3RzL2ludGVsX21lbW9y
...
amVjdF9wdXQob2JqKTsKIH0KQEAgLTQzMyw3ICs0MzcsNyBAQCBzdGF0aWMgaW50IGlndF9jcHVf
...
VFJfRVJSKHB0cik7CiAKQEAgLTUzOCw3ICs1NDIsNyBAQCBzdGF0aWMgaW50IGlndF9sbWVtX2Ny
...
dF9wdXQ7CiAKQEAgLTU3Nyw3ICs1ODEsNyBAQCBzdGF0aWMgaW50IGlndF9sbWVtX3dyaXRlX2dw
...
b2NrZWQob2JqKTsKIAlpZiAoZXJyKQogCQlnb3RvIG91dF9wdXQ7CiAKQEAgLTY0OSw3ICs2NTMs
...
CiAJCWVyciA9IFBUUl9FUlIodmFkZHIpOwogCQlnb3RvIG91dF9wdXQ7CkBAIC03NTMsNyArNzU3
...
KQotLSAKMi4zMC4wLnJjMQoKX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19f

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C7B147DD9D4
	for <lists+intel-gfx@lfdr.de>; Wed,  1 Nov 2023 01:26:55 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 6AD6310E5FF;
...
Subject: [Intel-gfx] [PATCH v7d 04/23] dyndbg: replace classmap list with a
 vector

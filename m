...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 5166C6528C3
	for <lists+intel-gfx@lfdr.de>; Tue, 20 Dec 2022 23:10:59 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 96BA310E41C;
...
Subject: Re: [Intel-gfx] [PATCH 1/1] drm/i915/pxp: Use drm_dbg if arb

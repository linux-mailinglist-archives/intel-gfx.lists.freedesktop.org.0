...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id B6DC949E5FE
	for <lists+intel-gfx@lfdr.de>; Thu, 27 Jan 2022 16:25:53 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DE2FE10E24E;
	Thu, 27 Jan 2022 15:25:51 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 8AFC610E24E
 for <intel-gfx@lists.freedesktop.org>; Thu, 27 Jan 2022 15:25:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1643297150; x=1674833150;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:content-transfer-encoding:in-reply-to;
 bh=kASzJCLvt7eBeEvK9bI4nVDPFlMKmDkvyCoj6AlyuOA=;
 b=g0GjslGwFMxk+wr5koxWkCuAcp2ctBWL6Y3aZ2567aJ4TVixwdpcTeKn
 sqleEb4CKGH2+lIBxaytRSb0SJeE+a+ERUeuyodJOiWzvsEJpmA6HZ8rc
 QQvDqzkAFzcViy3VI3ZSukSuqnCzYmfcQOsnH5tRa4+HWTc8WwH+b4xRy
 ri1IlKTD4rr5sXsJ4lFvmgCdOn0eMYg4FNrUqhd3L5ccdNbTF3FD1+TOR
 9u5C5g5Ut0Hxus3V5BBLqQevkfNHpmH1wrgMx3bwzsXcv1D3e7ps1VU65
 m2Tpc79N2CDH4nZipTP/3A+pkAhedybOmCMC3aylSuecYD3vs7RUPV8fb w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10239"; a="245725930"
X-IronPort-AV: E=Sophos;i="5.88,321,1635231600"; d="scan'208";a="245725930"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Jan 2022 07:25:50 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,321,1635231600"; d="scan'208";a="533144146"
Received: from stinkbox.fi.intel.com (HELO stinkbox) ([10.237.72.147])
 by fmsmga007.fm.intel.com with SMTP; 27 Jan 2022 07:25:47 -0800
Received: by stinkbox (sSMTP sendmail emulation);
 Thu, 27 Jan 2022 17:25:46 +0200
Date: Thu, 27 Jan 2022 17:25:46 +0200
From: Ville =?iso-8859-1?Q?Syrj=E4l=E4?= <ville.syrjala@linux.intel.com>
To: Maarten Lankhorst <maarten.lankhorst@linux.intel.com>
Message-ID: <YfK5egof0oJXEmM5@intel.com>
...
I think at the very least we'd need something along the lines of
https://patchwork.freedesktop.org/series/70636/
to make intel ddx use dirtyfb when needed, and a bit of time to
let it spread before we pull the trigger.

Though the status quo is already broken (maybe with tearfree enabled
it works, not sure) if you enable fbc since wc mmaps don't trip the
hw gtt tracking and so you get all kinds of stale junk on screen.
So dirtyfb also very much needed before I can enable fbc across the
board (which I think we could now do otherwise).

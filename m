...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 927A8756335
	for <lists+intel-gfx@lfdr.de>; Mon, 17 Jul 2023 14:52:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 70AD310E241;
...
Subject: [Intel-gfx] [PATCH v3 4/5] drm/i915/gt: Poll aux invalidation

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A93FD2172
	for <lists+intel-gfx@lfdr.de>; Thu, 10 Oct 2019 09:14:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F12556EAA8;
	Thu, 10 Oct 2019 07:14:47 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 73CE06EAA8
 for <intel-gfx@lists.freedesktop.org>; Thu, 10 Oct 2019 07:14:46 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from haswell.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 18785783-1500050 
 for multiple; Thu, 10 Oct 2019 08:14:37 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Thu, 10 Oct 2019 08:14:29 +0100
Message-Id: <20191010071434.31195-5-chris@chris-wilson.co.uk>
...
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 05/10] drm/i915: Mark up "sentinel" requests
...
bF9scmMuYwppbmRleCBhYTUyZTVmMzRkYWIuLmViOTlmMWU4MDRmNyAxMDA2NDQKLS0tIGEvZHJp
dmVycy9ncHUvZHJtL2k5MTUvZ3QvaW50ZWxfbHJjLmMKKysrIGIvZHJpdmVycy9ncHUvZHJtL2k5
MTUvZ3QvaW50ZWxfbHJjLmMKQEAgLTEyNTMsNiArMTI1Myw5IEBAIHN0YXRpYyBib29sIGNhbl9t
...
IApAQCAtMTcyNCw2ICsxNzI3LDkgQEAgc3RhdGljIHZvaWQgZXhlY2xpc3RzX2RlcXVldWUoc3Ry

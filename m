...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E5462B4CAF
	for <lists+intel-gfx@lfdr.de>; Mon, 16 Nov 2020 18:27:05 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9ABAD89EB4;
	Mon, 16 Nov 2020 17:27:03 +0000 (UTC)
X-Original-To: Intel-gfx@lists.freedesktop.org
Delivered-To: Intel-gfx@lists.freedesktop.org
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 850A689EB4;
 Mon, 16 Nov 2020 17:27:02 +0000 (UTC)
IronPort-SDR: ktFgiUyp+x+wfUNYFYLp8D7ukD5gDIcdk6+cRJ8pfw6P6mxErJ3vx2F1pRtwSXdFXkg9W8/Ak3
 3UL+aYb/w8dg==
X-IronPort-AV: E=McAfee;i="6000,8403,9807"; a="168205749"
X-IronPort-AV: E=Sophos;i="5.77,483,1596524400"; d="scan'208";a="168205749"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Nov 2020 09:27:02 -0800
IronPort-SDR: aNxFiyunsPznY8EnxHACCSmZXyYHyByeY/kaQ4UWva5eloFGQ1buPjnCEYSiKWPdmGT9AWxrW7
 jYmDrqrI6vdg==
X-IronPort-AV: E=Sophos;i="5.77,483,1596524400"; d="scan'208";a="543681925"
Received: from abaldovi-mobl.ger.corp.intel.com (HELO localhost.localdomain)
 ([10.252.52.236])
 by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 16 Nov 2020 09:27:00 -0800
From: Tvrtko Ursulin <tvrtko.ursulin@linux.intel.com>
To: igt-dev@lists.freedesktop.org
Date: Mon, 16 Nov 2020 17:26:49 +0000
Message-Id: <20201116172653.4030093-1-tvrtko.ursulin@linux.intel.com>
X-Mailer: git-send-email 2.25.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH i-g-t 1/5] intel_gpu_top: User friendly device
 listing

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3554F6D2EAC
	for <lists+intel-gfx@lfdr.de>; Sat,  1 Apr 2023 08:37:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 98D5010F3B5;
...
Subject: [Intel-gfx] [PATCH 6/7] drm/i915: make sure correct pte encode is
 used

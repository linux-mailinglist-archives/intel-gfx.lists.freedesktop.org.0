...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A6942C657C
	for <lists+intel-gfx@lfdr.de>; Fri, 27 Nov 2020 13:14:33 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EF1FD6ED82;
	Fri, 27 Nov 2020 12:12:11 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] [RFC PATCH 146/162] drm/i915/pm: suspend and restore
 ppgtt mapping

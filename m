...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 02DE95AF899
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 01:51:21 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7974110E0D4;
...
Subject: [Intel-gfx] [PATCH v3 05/14] drm/i915: Prepare more multi-GT
 initialization

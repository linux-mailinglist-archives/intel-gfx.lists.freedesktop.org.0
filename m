...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D77164AB74
	for <lists+intel-gfx@lfdr.de>; Tue, 13 Dec 2022 00:18:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 80B7010E2C7;
...
Subject: [Intel-gfx] [PATCH v9 19/23] drm/i915/vm_bind: Add uapi for user to
 enable vm_bind_mode

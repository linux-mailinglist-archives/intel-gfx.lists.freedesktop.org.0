...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BB457B0DDB
	for <lists+intel-gfx@lfdr.de>; Wed, 27 Sep 2023 23:11:13 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AA54D10E0C5;
...
Subject: [Intel-gfx] [PATCH v6 1/4] drm/i915: Introduce

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id E62874CC4BC
	for <lists+intel-gfx@lfdr.de>; Thu,  3 Mar 2022 19:11:39 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id AF8E010E2F4;
	Thu,  3 Mar 2022 18:11:36 +0000 (UTC)
...
Subject: [Intel-gfx] [PATCH v2 4/7] drm/i915/guc: use the memcpy_from_wc
 call from the drm

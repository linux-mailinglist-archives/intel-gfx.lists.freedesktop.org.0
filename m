...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id C0B13573280
	for <lists+intel-gfx@lfdr.de>; Wed, 13 Jul 2022 11:30:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A138C98A78;
...
Subject: [Intel-gfx] [PATCH 02/21] drm/i915/gt: document

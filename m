...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 436D998BC1C
	for <lists+intel-gfx@lfdr.de>; Tue,  1 Oct 2024 14:32:40 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 9AA2B10E313;
	Tue,  1 Oct 2024 12:32:36 +0000 (UTC)
Authentication-Results: gabe.freedesktop.org;
	dkim=pass (2048-bit key; unprotected) header.d=intel.com header.i=@intel.com header.b="aUzBmpVX";
	dkim-atps=neutral
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 173D710E313
 for <intel-gfx@lists.freedesktop.org>; Tue,  1 Oct 2024 12:32:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1727785954; x=1759321954;
 h=from:to:subject:date:message-id:in-reply-to:references:
 mime-version:content-transfer-encoding;
 bh=OUzUneOZE6ixvgrrM9doxo2KZ5qea1pYrBlKfs4sQNg=;
 b=aUzBmpVX+or+/uGMbjI4zNf91wKpqD7TFY8/YxA9SmlLFycOHxi9Vv6L
 Q91lHj3jVrpNB+Ad1xKyXbn61igcmIBXtRxL+bHSFiOF41eXPAM4Aj6gl
 6Llafxf7mTWd2cpfLCgh+tM8He/gknrn9HyQDvm2YTBI4JhN3WEnxE1j2
 QZwY1+m4FoTlfvwQkoJktQeTu16S1MOUFmVYCSZLQLWHW1D51b4QnvVdD
 Lp9WlzjRPiZ5mviS+3wxHcCDGXUJwNKrtoSj/txmof01pdFP6/+4sAhlp
 nD7NHyGLDGBia/xbycClVZ4lApb7yF7/mtBoS4o+68/4oDq/S8dVQFyWS g==;
X-CSE-ConnectionGUID: QLFdZMQpT1yVPAFKZ8l2rw==
X-CSE-MsgGUID: /R7c2vSRRE6+MmfDY2eu2g==
X-IronPort-AV: E=McAfee;i="6700,10204,11212"; a="30624384"
X-IronPort-AV: E=Sophos;i="6.11,167,1725346800"; d="scan'208";a="30624384"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
 by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Oct 2024 05:32:34 -0700
X-CSE-ConnectionGUID: +Y2HR9NzSMyX4THmcdZ++g==
X-CSE-MsgGUID: dYN4QuHHTjWg7LEdbZx5vg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,167,1725346800"; d="scan'208";a="74448038"
Received: from ideak-desk.fi.intel.com ([10.237.72.78])
 by orviesa008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Oct 2024 05:32:33 -0700
From: Imre Deak <imre.deak@intel.com>
To: intel-gfx@lists.freedesktop.org
Subject: [PATCH v2 2/3] drm/i915/dp: Track source OUI validity explicitly
Date: Tue,  1 Oct 2024 15:32:58 +0300
Message-ID: <20241001123259.616486-2-imre.deak@intel.com>

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B7BF1E7C6E
	for <lists+intel-gfx@lfdr.de>; Fri, 29 May 2020 13:57:47 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 939F96E8D7;
	Fri, 29 May 2020 11:57:42 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from fireflyinternet.com (mail.fireflyinternet.com [109.228.58.192])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 53CD16E8E5
 for <intel-gfx@lists.freedesktop.org>; Fri, 29 May 2020 11:57:40 +0000 (UTC)
X-Default-Received-SPF: pass (skip=forwardok (res=PASS))
 x-ip-name=78.156.65.138; 
Received: from build.alporthouse.com (unverified [78.156.65.138]) 
 by fireflyinternet.com (Firefly Internet (M1)) with ESMTP id 21333767-1500050 
 for multiple; Fri, 29 May 2020 12:57:30 +0100
From: Chris Wilson <chris@chris-wilson.co.uk>
To: intel-gfx@lists.freedesktop.org
Date: Fri, 29 May 2020 12:57:30 +0100
Message-Id: <20200529115731.7666-1-chris@chris-wilson.co.uk>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Subject: [Intel-gfx] [PATCH 1/2] drm/i915: Track i915_vma with its own
 reference counter
...
---
 ...
 .../gpu/drm/i915/gem/selftests/huge_pages.c   | 126 +++----
 ...
 62 files changed, 1054 insertions(+), 1108 deletions(-)
...
index 9d306dc9849d..3a0894785a05 100644
...
index a0ed2fab0ff3..a6b5794d8fab 100644
...
@@ -741,6 +738,7 @@ static int igt_mock_ppgtt_huge_fill(void *arg)
...
@@ -749,6 +747,7 @@ static int igt_mock_ppgtt_huge_fill(void *arg)
 					I915_GTT_PAGE_SIZE_2M)) {
...
@@ -758,10 +757,13 @@ static int igt_mock_ppgtt_huge_fill(void *arg)
...
@@ -866,8 +868,10 @@ static int igt_mock_ppgtt_64K(void *arg)
 				return PTR_ERR(obj);
...
@@ -876,17 +880,16 @@ static int igt_mock_ppgtt_64K(void *arg)
...
+				goto out_vma_put;
 			...
 			err = igt_check_page_sizes(vma);
 			if (err)
@@ -919,9 +922,7 @@ static int igt_mock_ppgtt_64K(void *arg)
 			}
...
@@ -929,11 +930,8 @@ static int igt_mock_ppgtt_64K(void *arg)
...
@@ -1040,7 +1038,7 @@ static int __igt_write_huge(struct intel_context *ce,
...
+		goto out_vma;
 	...
 	if (err) {
@@ -1051,7 +1049,7 @@ static int __igt_write_huge(struct intel_context *ce,
...
+		goto out_vma;
 	...
 	err = igt_check_page_sizes(vma);
@@ -1072,6 +1070,8 @@ static int __igt_write_huge(struct intel_context *ce,
...
@@ -1452,11 +1452,13 @@ static int igt_tmpfs_fallback(void *arg)
...
+	i915_vma_put(vma);
 out_put:
 	i915_gem_object_put(obj);
 out_restore:
@@ -1503,7 +1505,7 @@ static int igt_shrink_thp(void *arg)
...
@@ -1527,7 +1529,7 @@ static int igt_shrink_thp(void *arg)
...
@@ -1537,18 +1539,18 @@ static int igt_shrink_thp(void *arg)
...
@@ -1558,6 +1560,8 @@ static int igt_shrink_thp(void *arg)
...
index 6fc0966b75ff..286620f78f0c 100644
--- a/drivers/gpu/drm/i915/gt/intel_lrc.c
+++ b/drivers/gpu/drm/i915/gt/intel_lrc.c
@@ -3840,21 +3840,18 @@ static int lrc_setup_wa_ctx(struct intel_engine_cs *engine)
 		return PTR_ERR(obj);
...
@@ -5270,10 +5267,9 @@ static int __execlists_context_alloc(struct intel_context *ce,
...
@@ -5290,7 +5286,7 @@ static int __execlists_context_alloc(struct intel_context *ce,
...
+			goto err_vma;
 		...
 		ce->timeline = tl;
@@ -5299,14 +5295,14 @@ static int __execlists_context_alloc(struct intel_context *ce,
...
+		goto err_ring;
 	...
 	ce->ring = ring;
@@ -5314,10 +5310,10 @@ static int __execlists_context_alloc(struct intel_context *ce,
...
index 9b30ddc49e4b..8252814837c4 100644
...
+	if (first)
+		queue_work(vm->i915->wq, &vm->release.work);
 }
...
@@ -1151,7 +1172,7 @@ void i915_vma_revoke_mmap(struct i915_vma *vma)
...
@@ -1164,9 +1185,10 @@ void i915_vma_revoke_mmap(struct i915_vma *vma)
 			    vma->size,
 			    1);
...
@@ -1354,6 +1376,23 @@ void i915_vma_make_purgeable(struct i915_vma *vma)

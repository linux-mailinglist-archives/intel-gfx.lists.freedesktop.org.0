...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CFDD81D8FDE
	for <lists+intel-gfx@lfdr.de>; Tue, 19 May 2020 08:17:00 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id D606E6E2D8;
	Tue, 19 May 2020 06:16:57 +0000 (UTC)
...
MIME-Version: 1.0
Subject: [Intel-gfx] linux-next: manual merge of the tip tree with the
 drm-misc tree
...
Content-Type: multipart/mixed; boundary="===============0611396251=="

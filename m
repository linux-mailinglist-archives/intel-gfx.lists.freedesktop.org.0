...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B4C65B0971
	for <lists+intel-gfx@lfdr.de>; Wed,  7 Sep 2022 18:00:14 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 176AD10E7B9;
	Wed,  7 Sep 2022 16:00:11 +0000 (UTC)
X-Original-To: intel-gfx@lists.freedesktop.org
Delivered-To: intel-gfx@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id CFEA410E7C4
 for <intel-gfx@lists.freedesktop.org>; Wed,  7 Sep 2022 15:59:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1662566388; x=1694102388;
 h=from:to:cc:subject:date:message-id:in-reply-to:
 references:mime-version:content-transfer-encoding;
 bh=akALbdp1bBC8erj1kUpBaA6ehDkMX5BY+p3XKMqXJ9k=;
 b=ctJYDp4HKHSL5qSeTgPVLn0DsSyc2QINs2t2gLa+QrfyVVyRZFMauX7v
 9enOgPzcz8ThuArMHUjY8t+fGIimHoRL2Se2L95QEowT1zAuu7zlaQwGf
 qygnjtuJLBu+E/cGUk/U05wtE9CohVnIaoeP78lTDFjSKpcnfFKr2V3fj
 5vmtPb9Yl5d2C58ELTxtltAa8owGsBdHRK52vb58CK3dSziQWuwIUAHaO
 gzhuNAmepAW1g1XxmP+BYBEdkuNa3/PmFGqruNj8aVPQA/8we5sWOljxH
 0T0tCVrErzfpofTx5p35YbCtta1cfdwGmqiql5VRSPzJ0FwfibTU3/UuX w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10463"; a="297701475"
X-IronPort-AV: E=Sophos;i="5.93,297,1654585200"; d="scan'208";a="297701475"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Sep 2022 08:59:26 -0700
X-IronPort-AV: E=Sophos;i="5.93,297,1654585200"; d="scan'208";a="676248143"
...
Date: Wed,  7 Sep 2022 18:58:08 +0300
Message-Id: <20220907155813.1427526-12-tomas.winkler@intel.com>
...
Subject: [Intel-gfx] [PATCH v8 11/16] mei: gsc: setup gsc extended
 operational memory

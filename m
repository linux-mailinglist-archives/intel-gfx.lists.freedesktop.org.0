...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id CF019366F01
	for <lists+intel-gfx@lfdr.de>; Wed, 21 Apr 2021 17:22:15 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 186556E0C5;
...
Subject: Re: [Intel-gfx] [PATCH v3 01/20] drm/amdgpu: Add error handling to
 amdgpu_dm_initialize_dp_connector()
...
Cc: "Wang, Chao-kai \(Stylon\)" <Stylon.Wang@amd.com>, "Park,
 ...
 Harry" <Harry.Wentland@amd.com>, Bas Nieuwenhuizen <bas@basnieuwenhuizen.nl>,
 "Siqueira, Rodrigo" <Rodrigo.Siqueira@amd.com>,
 open list <linux-kernel@vger.kernel.org>, "Cornij, 
 Nikola" <Nikola.Cornij@amd.com>, "Somasundaram,
...
Content-Type: multipart/mixed; boundary="===============0428487461=="

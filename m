...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 50D6551D562
	for <lists+intel-gfx@lfdr.de>; Fri,  6 May 2022 12:12:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 95DF710FBD8;
...
Subject: [Intel-gfx] [PATCH 19/25] drm/edid: add drm_edid helper for

...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id CD9815670E3
	for <lists+intel-gfx@lfdr.de>; Tue,  5 Jul 2022 16:23:31 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4E23111B38B;
	Tue,  5 Jul 2022 14:23:28 +0000 (UTC)
...
Subject: Re: [Intel-gfx] [PATCH v2 1/7] drm: Move and add a few utility

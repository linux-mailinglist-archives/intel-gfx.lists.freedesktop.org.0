...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id BF978405D72
	for <lists+intel-gfx@lfdr.de>; Thu,  9 Sep 2021 21:39:01 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id F39E76E902;
...
Subject: [Intel-gfx] [PATCH v2 1/9] vfio/ccw: Use functions for alloc/free

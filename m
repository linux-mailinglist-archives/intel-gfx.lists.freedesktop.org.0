...
Received: from gabe.freedesktop.org (unknown [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EFD15B301A
	for <lists+intel-gfx@lfdr.de>; Fri,  9 Sep 2022 09:37:08 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id CF87D10EC2B;
...
Subject: [Intel-gfx] [PATCH v3 29/37] docs: gpu: i915.rst: GVT: add more
 kernel-doc markups
